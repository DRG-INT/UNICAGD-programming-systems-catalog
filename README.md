...
[Language Server (29)](catalog/by-category/language-server.md) · [Language Specification (1423)](catalog/by-category/language-specification.md) · [Library (5527)](catalog/by-category/library.md) · [Lint Plugin (1)](catalog/by-category/lint-plugin.md)
...
| --- | ---: |
| Source records | 968 |
| Canonical identity pages | 26760 |
| Expansion records added | 8528 |
| Release checks attempted | 1200 |
| Known stable release fields | 10053 |
