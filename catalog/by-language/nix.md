...
| --- | --- | --- | --- |
| [NixOS Wiki](../records/nix-nixos-wiki-f6d0afa7.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Dependency Manager

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [Nix Flakes](../records/nix-nix-flakes-af10e9ae.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Documentation

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [Nix Reference Manual](../records/nix-nix-reference-manual-aa8d7868.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Framework

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [NixOS](../records/nix-nixos-ddb1f065.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Language Specification

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [Nix Language](../records/nix-nix-language-e3dd85e9.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Precommit Ci Quality

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [Hydra](../records/nix-hydra-12cd8ed3.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Registry Repository

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [Nix Source Route](../records/nix-nix-source-route-42c0577b.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [NixOS Options Search](../records/nix-nixos-options-search-c44129a3.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [NixOS Packages Search](../records/nix-nixos-packages-search-b6615046.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [Nixpkgs](../records/nix-nixpkgs-35786f68.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
