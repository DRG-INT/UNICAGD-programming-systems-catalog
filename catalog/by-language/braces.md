...
| --- | --- | --- | --- |
| [EditorConfig](../records/braces-editorconfig-7a632438.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Formatter

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [clang-format](../records/braces-clang-format-3926eef1.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [Prettier](../records/braces-prettier-2e738082.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [rustfmt](../records/braces-rustfmt-a6fda71d.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Ide Editor Integration

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [CodeMirror Bracket Matching](../records/braces-codemirror-bracket-matching-6cba71e1.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [Monaco Editor](../records/braces-monaco-editor-796af7c9.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [VS Code Bracket Pair Colorization](../records/braces-vs-code-bracket-pair-colorization-396c5b7e.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |

### Language Specification

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [ECMAScript Language Specification](../records/braces-ecmascript-language-specification-f5ea1fe4.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [GNU Bash Brace Expansion](../records/braces-gnu-bash-brace-expansion-5ed23f97.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [POSIX Shell Command Language](../records/braces-posix-shell-command-language-d36c7728.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [rewinfrey/tree-sitter-scope](../records/braces-rewinfrey-tree-sitter-scope-4d596b4d.md) | partial | 2023-08-03T15:22:12Z | registry-derived |

### Parser Lexer Ast

| Name | Release | Date | Source |
| --- | --- | --- | --- |
| [ANTLR grammars-v4](../records/braces-antlr-grammars-v4-d6d6e244.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [TextMate Grammars](../records/braces-textmate-grammars-8cc36d2e.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
| [tree-sitter](../records/braces-tree-sitter-f8e7beda.md) | unknown | curated_language_route_requires_source_specific_release_lookup | registry-derived |
