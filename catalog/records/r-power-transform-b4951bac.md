...
<!-- canonical: https://cran.r-project.org/web/packages/power.transform/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/power.transform/index.html](https://cran.r-project.org/web/packages/power.transform/index.html) |
| Source record ids | cran_packages_by_date-a087cd817d9692 |
...
For a systems engineer, power.transform belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-09-02 17:10:08 UTC | [https://cran.r-project.org/web/packages/power.transform/DESCRIPTION](https://cran.r-project.org/web/packages/power.transform/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/power.transform/DESCRIPTION` at `2026-09-02T17:18:40+00:00`.
...
- `cran_packages_by_date-a087cd817d9692` from `cran_packages_by_date` as `registry_expansion`
