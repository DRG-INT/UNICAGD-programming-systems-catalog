...
| Source record ids | lua-source-14 |

## System Engineer Summary

Utility Belts is tracked as an utility library record in the Lua family branch. The source did not
...
For a systems engineer, Utility Belts belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 14}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-14` from `master_json` as `source_list_item`
