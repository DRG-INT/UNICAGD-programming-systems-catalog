# beroca/sap-mission.cap-java-app
...
<!-- canonical: https://github.com/beroca/sap-mission.cap-java-app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/beroca/sap-mission.cap-java-app](https://github.com/beroca/sap-mission.cap-java-app) |
| Source record ids | github_search_sapjava-e6287ca6702e2b |

## System Engineer Summary

beroca/sap-mission.cap-java-app is tracked as a build system record in the SAPJava branch. The
...
For a systems engineer, beroca/sap-mission.cap-java-app belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-18T23:09:13Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-e6287ca6702e2b` from `github_search_sapjava` as `registry_expansion`
