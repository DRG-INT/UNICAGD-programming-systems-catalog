...
<!-- canonical: https://www.nuget.org/packages/Carbon.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Carbon.Json](https://www.nuget.org/packages/Carbon.Json) |
| Source record ids | nuget_search-748f371271eff7 |
...
For a systems engineer, Carbon.Json belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.5.2 | 2026-02-04T22:44:54.827+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/carbon.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/carbon.json/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Carbon.Json/6.5.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/carbon.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-748f371271eff7` from `nuget_search` as `registry_expansion`
