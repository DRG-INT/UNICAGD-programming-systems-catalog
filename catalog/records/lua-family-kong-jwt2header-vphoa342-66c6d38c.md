...
| Canonical URL | [https://luarocks.org/modules/vphoa34/kong-jwt2header-vphoa342](https://luarocks.org/modules/vphoa34/kong-jwt2header-vphoa342) |
| Source record ids | luarocks_root_manifest-385e3feae46de2 |

## System Engineer Summary

Converts JWT claims to Headers to allow for Routing by JWT Claim and/or upstream JWT Claim
consumption by header

## Operational Role

For a systems engineer, kong-jwt2header-vphoa342 belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-385e3feae46de2` from `luarocks_root_manifest` as `registry_expansion`
