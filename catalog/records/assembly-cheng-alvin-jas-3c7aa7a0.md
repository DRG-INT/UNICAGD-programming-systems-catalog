...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cheng-alvin/jas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cheng-alvin/jas](https://github.com/cheng-alvin/jas) |
| Source record ids | github_search_assembly-acb0cb6d1fb1e3 |

## System Engineer Summary

Official repository of the Jas assembler project - An assembler and library for generating code for
x86

## Operational Role

For a systems engineer, cheng-alvin/jas belongs in the Assembly inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T12:31:32Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-acb0cb6d1fb1e3` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashvardanian/NumKong | Ffi Bindings | [open](assembly-ashvardanian-numkong-bff1efd3.md) |
| awaescher/Fusion | Ffi Bindings | [open](assembly-awaescher-fusion-614ef7c1.md) |
| encounter/objdiff | Ffi Bindings | [open](assembly-encounter-objdiff-533f7383.md) |
| hugsy/bochscpu-python | Ffi Bindings | [open](assembly-hugsy-bochscpu-python-bba92484.md) |
| KolibriOS/kolibrios | Ffi Bindings | [open](assembly-kolibrios-kolibrios-ceca7961.md) |
