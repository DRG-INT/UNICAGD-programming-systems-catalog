...
<!-- canonical: https://hackage.haskell.org/package/stm-hamt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stm-hamt](https://hackage.haskell.org/package/stm-hamt) |
| Source record ids | hackage_top_downloads-f6093d77670ee4 |
...
For a systems engineer, stm-hamt belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2.1 | 2026-01-13T09:34:58Z | [https://hackage.haskell.org/package/stm-hamt](https://hackage.haskell.org/package/stm-hamt) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stm-hamt` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-f6093d77670ee4` from `hackage_top_downloads` as `registry_expansion`
