...
| Source record ids | corpus-62172ca7538d7a |

## System Engineer Summary

SDL is tracked as an image audio dsp record in the C++23 branch. The source did not provide a long
...
For a systems engineer, SDL belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-62172ca7538d7a` from `master_json` as `image_audio_dsp`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| FFTW | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-fftw-d2edb83c.md) |
| JUCE | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-juce-2472f7fa.md) |
| OpenAL Soft | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-openal-soft-c4375625.md) |
| OpenCV | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-opencv-aa6fe69d.md) |
| SFML | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-sfml-3b2429d1.md) |
