...
<!-- canonical: https://cran.r-project.org/web/packages/climenu/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/climenu/index.html](https://cran.r-project.org/web/packages/climenu/index.html) |
| Source record ids | cran_packages_by_date-cd4f603612cf18 |
...
For a systems engineer, climenu belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-31 17:00:28 UTC | [https://cran.r-project.org/web/packages/climenu/DESCRIPTION](https://cran.r-project.org/web/packages/climenu/DESCRIPTION) |  |
...
| Evidence | GPL-3; {"key": "", "name": "", "url": ""}; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/climenu/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cd4f603612cf18` from `cran_packages_by_date` as `registry_expansion`
