...
<!-- canonical: https://cran.r-project.org/web/packages/thamesmix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/thamesmix/index.html](https://cran.r-project.org/web/packages/thamesmix/index.html) |
| Source record ids | cran_packages_by_date-b03587b8b4a921 |
...
For a systems engineer, thamesmix belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-14 20:20:02 UTC | [https://cran.r-project.org/web/packages/thamesmix/DESCRIPTION](https://cran.r-project.org/web/packages/thamesmix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/thamesmix/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-b03587b8b4a921` from `cran_packages_by_date` as `registry_expansion`
