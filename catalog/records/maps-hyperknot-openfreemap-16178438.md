...
<!-- canonical: https://github.com/hyperknot/openfreemap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hyperknot/openfreemap](https://github.com/hyperknot/openfreemap) |
| Source record ids | github_search_maps-2ab61441ba4670 |

## System Engineer Summary

Free and open-source map hosting solution with custom styles for websites and apps, using
OpenStreetMap data

## Operational Role

For a systems engineer, hyperknot/openfreemap belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T23:31:16Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2ab61441ba4670` from `github_search_maps` as `registry_expansion`
