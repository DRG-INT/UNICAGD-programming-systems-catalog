...
<!-- canonical: https://luarocks.org/modules/freed-wu/beamer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/beamer](https://luarocks.org/modules/freed-wu/beamer) |
| Source record ids | luarocks_root_manifest-e0d45f561daa7e |
...
For a systems engineer, beamer belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e0d45f561daa7e` from `luarocks_root_manifest` as `registry_expansion`
