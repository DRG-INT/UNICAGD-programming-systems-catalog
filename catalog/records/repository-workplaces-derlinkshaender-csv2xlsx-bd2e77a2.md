...
<!-- canonical: https://gitlab.com/DerLinkshaender/csv2xlsx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/DerLinkshaender/csv2xlsx](https://gitlab.com/DerLinkshaender/csv2xlsx) |
| Source record ids | gitlab_projects_api-24f88191822e9a |

## System Engineer Summary

Finally: a simple, single file executable, no runtime libs command line tool to convert a CSV file
to XLSX, written in Go.

## Operational Role

For a systems engineer, DerLinkshaender/csv2xlsx belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-24f88191822e9a` from `gitlab_projects_api` as `registry_expansion`
