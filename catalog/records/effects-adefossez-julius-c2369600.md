...
<!-- canonical: https://github.com/adefossez/julius -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adefossez/julius](https://github.com/adefossez/julius) |
| Source record ids | github_search_effects-554f9da3d34620 |
...
For a systems engineer, adefossez/julius belongs in the Effects inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T15:55:19Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-554f9da3d34620` from `github_search_effects` as `registry_expansion`
