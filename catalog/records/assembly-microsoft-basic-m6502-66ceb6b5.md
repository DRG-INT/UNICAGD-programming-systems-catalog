...
<!-- canonical: https://github.com/microsoft/BASIC-M6502 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/BASIC-M6502](https://github.com/microsoft/BASIC-M6502) |
| Source record ids | github_search_assembly-3902764140208d |
...
For a systems engineer, microsoft/BASIC-M6502 belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-03T18:39:33Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-3902764140208d` from `github_search_assembly` as `registry_expansion`
