...
| Source record ids | corpus-c7b52113773611 |

## System Engineer Summary

lume is tracked as an utility library record in the Lua family branch. The source did not provide a
...
For a systems engineer, lume belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-c7b52113773611` from `master_json` as `utility_library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Lua Fun | Utility Library | [open](lua-family-lua-fun-eedafd2c.md) |
