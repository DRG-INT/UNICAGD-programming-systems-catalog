...
[Catalog index](../index.md) · [Language: Node.js/TypeScript](../by-language/node-js-typescript.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/@seamapi/http -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.28.0 | 2026-09-02T08:36:31.014Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-02T10:20:56+00:00`.
...
- `npm_registry-56be548b4114b5` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| @adobe/css-tools | Type Checker | [open](node-js-typescript-adobe-css-tools-f7566708.md) |
| @anthropic-ai/sdk | Type Checker | [open](node-js-typescript-anthropic-ai-sdk-505c8b05.md) |
| @apollo/cache-control-types | Type Checker | [open](node-js-typescript-apollo-cache-control-types-cf45fb41.md) |
| @apollo/protobufjs | Type Checker | [open](node-js-typescript-apollo-protobufjs-c29bf38c.md) |
| @apollo/utils.fetcher | Type Checker | [open](node-js-typescript-apollo-utils-fetcher-ef3d3e55.md) |
| @apollo/utils.withrequired | Type Checker | [open](node-js-typescript-apollo-utils-withrequired-3d97187a.md) |
| @ava/typescript | Type Checker | [open](node-js-typescript-ava-typescript-10335da0.md) |
| @aws-lambda-powertools/logger | Type Checker | [open](node-js-typescript-aws-lambda-powertools-logger-8438a23a.md) |
