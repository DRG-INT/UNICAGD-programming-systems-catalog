...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/stefanak-michal/bolt](https://luarocks.org/modules/stefanak-michal/bolt) |
| Source record ids | luarocks_root_manifest-6a6ef431c3a977 |
...
For a systems engineer, bolt belongs in the Lua family inventory as part of state persistence,
...
| Name | Category | Page |
| --- | --- | --- |
| amalg-redis | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amalg-redis-3d9cbd28.md) |
| api7-lua-resty-redis-connector | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-redis-connector-169e2330.md) |
| cache-redis | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cache-redis-f9ee7b24.md) |
| canny-redis | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-canny-redis-7ad6dd91.md) |
| casbin-adapter | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-casbin-adapter-4cf1f68b.md) |
| chameleon | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-chameleon-6be9ca08.md) |
| clutch | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-clutch-c0795e06.md) |
| cqueues-pgsql | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cqueues-pgsql-e4fbf108.md) |
