...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/stefanak-michal/bolt -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| luarocks_root_manifest | registry-derived | 2026-09-01 | `{"kind": "luarocks_root_manifest", "page": 7, "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `luarocks_root_manifest-6a6ef431c3a977` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amalg-redis | Database Datastore | [open](lua-family-amalg-redis-3d9cbd28.md) |
| api7-lua-resty-redis-connector | Database Datastore | [open](lua-family-api7-lua-resty-redis-connector-169e2330.md) |
| cache-redis | Database Datastore | [open](lua-family-cache-redis-f9ee7b24.md) |
| canny-redis | Database Datastore | [open](lua-family-canny-redis-7ad6dd91.md) |
| casbin-adapter | Database Datastore | [open](lua-family-casbin-adapter-4cf1f68b.md) |
| chameleon | Database Datastore | [open](lua-family-chameleon-6be9ca08.md) |
| clutch | Database Datastore | [open](lua-family-clutch-c0795e06.md) |
| cqueues-pgsql | Database Datastore | [open](lua-family-cqueues-pgsql-e4fbf108.md) |
