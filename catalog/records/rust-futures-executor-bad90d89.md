...
<!-- canonical: https://crates.io/crates/futures-executor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-executor](https://crates.io/crates/futures-executor) |
| Source record ids | crates_io-e4802335142691 |
...
For a systems engineer, futures-executor belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:23.714779Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-e4802335142691` from `crates_io` as `registry_expansion`
