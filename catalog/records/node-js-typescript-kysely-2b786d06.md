...
| Source record ids | corpus-e13c4b111d6cf6 |

## System Engineer Summary

Kysely is tracked as a database datastore record in the Node.js/TypeScript branch. The source did
...
For a systems engineer, Kysely belongs in the Node.js/TypeScript inventory as part of state
...
- `corpus-e13c4b111d6cf6` from `master_json` as `database_datastore`
