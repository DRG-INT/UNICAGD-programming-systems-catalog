...
| Canonical URL | [https://github.com/processing/processing4](https://github.com/processing/processing4) |
| Source record ids | curated_language_routes-9d2652871233b1 |

## System Engineer Summary

Creative-coding environment for visual arts, graphics programming, education, sketches, and export
workflows.

## Operational Role

For a systems engineer, Processing belongs in the Computer Graphics Software inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | processing-1434-4.5.6 | 2026-07-20T02:02:54Z | [https://api.github.com/repos/processing/processing4/releases/latest](https://api.github.com/repos/processing/processing4/releases/latest) |  |
| preview | known | processing-1314-4.5.3 | 2026-03-02T15:08:38Z | [https://api.github.com/repos/processing/processing4/releases?per_page=10](https://api.github.com/repos/processing/processing4/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/processing/processing4/releases/latest` at `2026-09-01T07:24:40+00:00`.
...
- `curated_language_routes-9d2652871233b1` from `curated_language_routes` as `registry_expansion`
