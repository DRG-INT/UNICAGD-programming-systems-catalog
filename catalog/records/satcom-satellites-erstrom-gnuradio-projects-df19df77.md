...
<!-- canonical: https://github.com/erstrom/gnuradio-projects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/erstrom/gnuradio-projects](https://github.com/erstrom/gnuradio-projects) |
| Source record ids | github_search_satcom_satellites-fdaea214aae2a4 |
...
For a systems engineer, erstrom/gnuradio-projects belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-04-03T15:52:59Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-fdaea214aae2a4` from `github_search_satcom_satellites` as `registry_expansion`
