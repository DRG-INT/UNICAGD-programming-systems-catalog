...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundaryLayerDynamics](https://github.com/JuliaRegistries/General/tree/master/B/BoundaryLayerDynamics) |
| Source record ids | julia_general-df52cdaff569bf |

## System Engineer Summary

Julia package registered in General at B/BoundaryLayerDynamics.

## Operational Role

For a systems engineer, BoundaryLayerDynamics belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundaryLayerDynamics", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-df52cdaff569bf` from `julia_general` as `registry_expansion`
