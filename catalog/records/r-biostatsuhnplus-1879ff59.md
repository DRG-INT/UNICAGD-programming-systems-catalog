...
<!-- canonical: https://cran.r-project.org/web/packages/BiostatsUHNplus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BiostatsUHNplus/index.html](https://cran.r-project.org/web/packages/BiostatsUHNplus/index.html) |
| Source record ids | cran_packages_by_date-26104562d84fce |

## System Engineer Summary

Nested Data Summary, Adverse Events and REDCap

## Operational Role

For a systems engineer, BiostatsUHNplus belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-09-07 18:30:26 UTC | [https://cran.r-project.org/web/packages/BiostatsUHNplus/DESCRIPTION](https://cran.r-project.org/web/packages/BiostatsUHNplus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BiostatsUHNplus/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-26104562d84fce` from `cran_packages_by_date` as `registry_expansion`
