...
<!-- canonical: https://github.com/brabadu/awesome-fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brabadu/awesome-fonts](https://github.com/brabadu/awesome-fonts) |
| Source record ids | github_search_icons_and_logos-7f070a7e6625fe |
...
For a systems engineer, brabadu/awesome-fonts belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T05:01:07Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7f070a7e6625fe` from `github_search_icons_and_logos` as `registry_expansion`
