...
| Source record ids | corpus-ab1f08d88e9140 |

## System Engineer Summary

C23 attributes is tracked as a language specification record in the C23 branch. The source did not
...
For a systems engineer, C23 attributes belongs in the C23 inventory as part of ecosystem capability
...
- `corpus-ab1f08d88e9140` from `master_json` as `language_specification`
