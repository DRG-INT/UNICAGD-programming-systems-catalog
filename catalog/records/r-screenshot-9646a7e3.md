...
<!-- canonical: https://cran.r-project.org/web/packages/screenshot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/screenshot/index.html](https://cran.r-project.org/web/packages/screenshot/index.html) |
| Source record ids | cran_packages_by_date-8f003ce1f5642e |
...
For a systems engineer, screenshot belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2026-08-22 09:20:02 UTC | [https://cran.r-project.org/web/packages/screenshot/DESCRIPTION](https://cran.r-project.org/web/packages/screenshot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/screenshot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8f003ce1f5642e` from `cran_packages_by_date` as `registry_expansion`
