...
<!-- canonical: https://packagist.org/packages/illuminate/redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/illuminate/redis](https://packagist.org/packages/illuminate/redis) |
| Source record ids | packagist_search-b0388ed50064c6 |
...
For a systems engineer, illuminate/redis belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-b0388ed50064c6` from `packagist_search` as `registry_expansion`
