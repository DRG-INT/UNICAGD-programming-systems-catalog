...
<!-- canonical: https://luarocks.org/modules/darkstalker/brain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/darkstalker/brain](https://luarocks.org/modules/darkstalker/brain) |
| Source record ids | luarocks_root_manifest-2d2f9cd3890db3 |
...
For a systems engineer, brain belongs in the Lua family inventory as part of model pipelines,
...
- `luarocks_root_manifest-2d2f9cd3890db3` from `luarocks_root_manifest` as `registry_expansion`
