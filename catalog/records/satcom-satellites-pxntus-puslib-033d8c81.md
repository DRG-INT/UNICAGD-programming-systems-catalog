...
<!-- canonical: https://github.com/pxntus/puslib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pxntus/puslib](https://github.com/pxntus/puslib) |
| Source record ids | github_search_satcom_satellites-45cdc32051092d |
...
For a systems engineer, pxntus/puslib belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-24T06:57:17Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-45cdc32051092d` from `github_search_satcom_satellites` as `registry_expansion`
