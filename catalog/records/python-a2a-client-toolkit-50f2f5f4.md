...
<!-- canonical: https://pypi.org/project/a2a-client-toolkit/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2a-client-toolkit/](https://pypi.org/project/a2a-client-toolkit/) |
| Source record ids | pypi_simple-d9dbdf43f29925 |
...
For a systems engineer, a2a-client-toolkit belongs in the Python inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2025-06-24T01:01:08.457232Z | [https://pypi.org/pypi/a2a-client-toolkit/json](https://pypi.org/pypi/a2a-client-toolkit/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2a-client-toolkit/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-d9dbdf43f29925` from `pypi_simple` as `registry_expansion`
