...
<!-- canonical: https://github.com/mongodb/node-mongodb-native -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mongodb/node-mongodb-native](https://github.com/mongodb/node-mongodb-native) |
| Source record ids | github_search_databases-ebb877cd525eb5 |
...
For a systems engineer, mongodb/node-mongodb-native belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:45:46Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ebb877cd525eb5` from `github_search_databases` as `registry_expansion`
