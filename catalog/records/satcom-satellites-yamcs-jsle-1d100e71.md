...
<!-- canonical: https://github.com/yamcs/jsle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yamcs/jsle](https://github.com/yamcs/jsle) |
| Source record ids | github_search_satcom_satellites-4750ac93e0505f |
...
For a systems engineer, yamcs/jsle belongs in the SatCom Satellites inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-25T09:03:01Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-4750ac93e0505f` from `github_search_satcom_satellites` as `registry_expansion`
