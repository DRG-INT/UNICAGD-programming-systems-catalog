...
<!-- canonical: https://github.com/ketoo/NoahGameFrame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ketoo/NoahGameFrame](https://github.com/ketoo/NoahGameFrame) |
| Source record ids | github_search_game_engines-83c34222b6b299 |

## System Engineer Summary

A fast, scalable, distributed game server engine/framework for C++, include the actor library,
network library, can be used as a real time multiplayer game engine ( MMO RPG/MOBA ), which support
C#/Lua script/ Unity3d, Cocos2dx and plan to support Unreal.

## Operational Role

For a systems engineer, ketoo/NoahGameFrame belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-25T06:55:21Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-83c34222b6b299` from `github_search_game_engines` as `registry_expansion`
