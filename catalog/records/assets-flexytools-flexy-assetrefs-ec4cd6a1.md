...
<!-- canonical: https://github.com/FlexyTools/Flexy.AssetRefs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FlexyTools/Flexy.AssetRefs](https://github.com/FlexyTools/Flexy.AssetRefs) |
| Source record ids | github_search_assets-b10075036f38aa |

## System Engineer Summary

Flexy.AssetRefs provides an efficient way to indirectly reference assets and scenes, offering
cleaner alternative to Unity Addressables. Designed for flexibility, it is easy to use right from
the prototyping stage.

## Operational Role

For a systems engineer, FlexyTools/Flexy.AssetRefs belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T15:36:54Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-b10075036f38aa` from `github_search_assets` as `registry_expansion`
