...
<!-- canonical: https://github.com/FWGS/xash3d-fwgs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FWGS/xash3d-fwgs](https://github.com/FWGS/xash3d-fwgs) |
| Source record ids | github_search_game_engines-bb84c33677481f |

## System Engineer Summary

FWGS/xash3d-fwgs is tracked as a game engine game dev record in the Game Engines branch. The source
...
For a systems engineer, FWGS/xash3d-fwgs belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:41:39Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-bb84c33677481f` from `github_search_game_engines` as `registry_expansion`
