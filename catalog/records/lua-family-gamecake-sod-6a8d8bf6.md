...
| Canonical URL | [https://luarocks.org/modules/xriss/gamecake-sod](https://luarocks.org/modules/xriss/gamecake-sod) |
| Source record ids | luarocks_root_manifest-3a1a0c16b6a4df |

## System Engineer Summary

gamecake-sod is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, gamecake-sod belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3a1a0c16b6a4df` from `luarocks_root_manifest` as `registry_expansion`
