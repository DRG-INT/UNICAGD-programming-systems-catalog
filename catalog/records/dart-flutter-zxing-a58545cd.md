...
<!-- canonical: https://pub.dev/packages/flutter_zxing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_zxing](https://pub.dev/packages/flutter_zxing) |
| Source record ids | pub_dev-f0fbdf9d260b4b |
...
For a systems engineer, flutter_zxing belongs in the Dart inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-09-02T15:25:47.933010Z | [https://pub.dev/api/packages/flutter_zxing](https://pub.dev/api/packages/flutter_zxing) |  |
| preview | known | 1.0.0-beta.9 | 2023-01-17T09:12:02.237251Z | [https://pub.dev/api/packages/flutter_zxing](https://pub.dev/api/packages/flutter_zxing) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_zxing` at `2026-09-02T17:18:44+00:00`.
...
- `pub_dev-f0fbdf9d260b4b` from `pub_dev` as `registry_expansion`
