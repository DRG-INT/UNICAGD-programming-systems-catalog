...
<!-- canonical: https://pub.dev/packages/scoped_model -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/scoped_model](https://pub.dev/packages/scoped_model) |
| Source record ids | pub_dev-7996ac767fb9ad |
...
For a systems engineer, scoped_model belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2022-08-24T10:24:04.702619Z | [https://pub.dev/api/packages/scoped_model](https://pub.dev/api/packages/scoped_model) |  |
| preview | known | 2.0.0-nullsafety.0 | 2020-12-09T10:35:37.438194Z | [https://pub.dev/api/packages/scoped_model](https://pub.dev/api/packages/scoped_model) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/scoped_model` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-7996ac767fb9ad` from `pub_dev` as `registry_expansion`
