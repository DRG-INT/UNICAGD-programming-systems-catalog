...
<!-- canonical: https://github.com/guokaigdg/animal-island-ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/guokaigdg/animal-island-ui](https://github.com/guokaigdg/animal-island-ui) |
| Source record ids | github_search_icons_and_logos-1f0ddbd7890af8 |

## System Engineer Summary

Animal Crossing-style React UI component library, inspired by Nintendo's game visuals Vue version
available. Animal 风格的 React 组件库 灵感来源于任天堂《集合啦！动物森友会》 Vue 版同步发布

## Operational Role

For a systems engineer, guokaigdg/animal-island-ui belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T15:14:37Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-1f0ddbd7890af8` from `github_search_icons_and_logos` as `registry_expansion`
