...
<!-- canonical: https://crates.io/crates/jiff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/jiff](https://crates.io/crates/jiff) |
| Source record ids | crates_io-daa4d6e3abfe3e |

## System Engineer Summary

A date-time library that encourages you to jump into the pit of success. This library is heavily
inspired by the Temporal project.

## Operational Role

For a systems engineer, jiff belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.37 | 2026-09-12T15:39:55.879487Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-12T16:19:19+00:00`.
...
- `crates_io-daa4d6e3abfe3e` from `crates_io` as `registry_expansion`
