...
<!-- canonical: https://github.com/lirios/shell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lirios/shell](https://github.com/lirios/shell) |
| Source record ids | github_search_effects-a040092700da5a |

## System Engineer Summary

:shell: Convergent shell for desktops, phones and tables built with QtQuick, Wayland and Material
Design

## Operational Role

For a systems engineer, lirios/shell belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-11T14:16:13Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a040092700da5a` from `github_search_effects` as `registry_expansion`
