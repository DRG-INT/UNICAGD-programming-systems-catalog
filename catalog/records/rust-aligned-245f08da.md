...
| Canonical URL | [https://crates.io/crates/aligned](https://crates.io/crates/aligned) |
| Source record ids | crates_io-e89acf345e8719 |
...
For a systems engineer, aligned belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2025-12-15T09:28:04.440984Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-e89acf345e8719` from `crates_io` as `registry_expansion`
