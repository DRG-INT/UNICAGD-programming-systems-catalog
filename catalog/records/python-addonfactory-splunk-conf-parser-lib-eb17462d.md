...
<!-- canonical: https://pypi.org/project/addonfactory_splunk_conf_parser_lib/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/addonfactory_splunk_conf_parser_lib/](https://pypi.org/project/addonfactory_splunk_conf_parser_lib/) |
| Source record ids | pypi_simple-967e0e97818769 |

## System Engineer Summary

Splunk .conf files parser

## Operational Role

For a systems engineer, addonfactory_splunk_conf_parser_lib belongs in the Python inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-08-21T10:29:08.265577Z | [https://pypi.org/pypi/addonfactory_splunk_conf_parser_lib/json](https://pypi.org/pypi/addonfactory_splunk_conf_parser_lib/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/addonfactory_splunk_conf_parser_lib/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-967e0e97818769` from `pypi_simple` as `registry_expansion`
