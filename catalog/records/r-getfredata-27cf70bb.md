...
<!-- canonical: https://cran.r-project.org/web/packages/GetFREData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GetFREData/index.html](https://cran.r-project.org/web/packages/GetFREData/index.html) |
| Source record ids | cran_packages_by_date-1b9f43fb99b42c |
...
For a systems engineer, GetFREData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-29 11:30:02 UTC | [https://cran.r-project.org/web/packages/GetFREData/DESCRIPTION](https://cran.r-project.org/web/packages/GetFREData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GetFREData/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1b9f43fb99b42c` from `cran_packages_by_date` as `registry_expansion`
