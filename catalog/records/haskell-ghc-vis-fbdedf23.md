...
<!-- canonical: https://hackage.haskell.org/package/ghc-vis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-vis](https://hackage.haskell.org/package/ghc-vis) |
| Source record ids | hackage_top_downloads-e5a0413642bc0e |
...
For a systems engineer, ghc-vis belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3.1 | 2024-01-07T23:29:13Z | [https://hackage.haskell.org/package/ghc-vis](https://hackage.haskell.org/package/ghc-vis) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-vis` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-e5a0413642bc0e` from `hackage_top_downloads` as `registry_expansion`
