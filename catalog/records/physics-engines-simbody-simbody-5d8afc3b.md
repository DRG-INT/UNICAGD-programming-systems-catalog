...
<!-- canonical: https://github.com/simbody/simbody -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/simbody/simbody](https://github.com/simbody/simbody) |
| Source record ids | github_search_physics_engines-f751b81601e19d |

## System Engineer Summary

High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and
mechanical systems like vehicles, robots, and the human skeleton.

## Operational Role

For a systems engineer, simbody/simbody belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:49:02Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f751b81601e19d` from `github_search_physics_engines` as `registry_expansion`
