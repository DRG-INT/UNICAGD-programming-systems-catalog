...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Canvas](https://github.com/JuliaRegistries/General/tree/master/C/Canvas) |
| Source record ids | julia_general-575c111634f3c2 |

## System Engineer Summary

Julia package registered in General at C/Canvas.

## Operational Role

For a systems engineer, Canvas belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Canvas", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-575c111634f3c2` from `julia_general` as `registry_expansion`
