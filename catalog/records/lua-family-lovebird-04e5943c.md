...
<!-- canonical: https://github.com/rxi/lovebird -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rxi/lovebird](https://github.com/rxi/lovebird) |
| Source record ids | lua-source-91 |

## System Engineer Summary

Browser-based debug console. Originally made for LÖVE, but works in any project with LuaSocket
support.

## Operational Role

For a systems engineer, lovebird belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 91}}` |
...
- `lua-source-91` from `master_json` as `source_list_item`
