# Gitea: dasdas/codebase-memory-mcp
...
<!-- canonical: https://gitea.com/dasdas/codebase-memory-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dasdas/codebase-memory-mcp](https://gitea.com/dasdas/codebase-memory-mcp) |
| Source record ids | gitea_repositories_api-3cd95565f5055d |

## System Engineer Summary

High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph —
average repo in milliseconds. 158 languages, sub-ms queries, 99% fewer tokens. Single static binary,
zero dependencies.

## Operational Role

For a systems engineer, Gitea: dasdas/codebase-memory-mcp belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-19T23:31:00Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-3cd95565f5055d` from `gitea_repositories_api` as `registry_expansion`
