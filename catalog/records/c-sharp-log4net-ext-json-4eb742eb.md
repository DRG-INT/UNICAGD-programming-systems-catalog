...
<!-- canonical: https://www.nuget.org/packages/log4net.Ext.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/log4net.Ext.Json](https://www.nuget.org/packages/log4net.Ext.Json) |
| Source record ids | nuget_search-11a8d785fe62a9 |
...
For a systems engineer, log4net.Ext.Json belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.3 | 2024-12-03T08:33:06.453+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/log4net.ext.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/log4net.ext.json/index.json) |  |
| preview | known | 3.0.3-develop2156055109 | 2025-11-13T07:06:46.403+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/log4net.ext.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/log4net.ext.json/index.json) |  |
...
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/log4net.Ext.Json/3.0.3/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/log4net.ext.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-11a8d785fe62a9` from `nuget_search` as `registry_expansion`
