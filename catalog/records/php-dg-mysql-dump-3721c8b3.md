...
| Canonical URL | [https://packagist.org/packages/dg/mysql-dump](https://packagist.org/packages/dg/mysql-dump) |
| Source record ids | packagist_search-4ef23a862e6fb2 |

## System Engineer Summary

dg/mysql-dump is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, dg/mysql-dump belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.7.1 | 2026-07-31T08:22:33+00:00 | [https://repo.packagist.org/p2/dg/mysql-dump.json](https://repo.packagist.org/p2/dg/mysql-dump.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dg/mysql-dump.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-4ef23a862e6fb2` from `packagist_search` as `registry_expansion`
