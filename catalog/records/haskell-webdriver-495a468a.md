...
<!-- canonical: https://hackage.haskell.org/package/webdriver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/webdriver](https://hackage.haskell.org/package/webdriver) |
| Source record ids | hackage_top_downloads-a87d9145274292 |
...
For a systems engineer, webdriver belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0.0 | 2026-06-03T00:17:00Z | [https://hackage.haskell.org/package/webdriver](https://hackage.haskell.org/package/webdriver) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/webdriver` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-a87d9145274292` from `hackage_top_downloads` as `registry_expansion`
