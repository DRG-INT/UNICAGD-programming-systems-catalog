...
| Canonical URL | [https://crates.io/crates/renderdoc-sys](https://crates.io/crates/renderdoc-sys) |
| Source record ids | crates_io-4b399c478cb0e9 |
...
For a systems engineer, renderdoc-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2024-03-02T02:20:53.768859Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-4b399c478cb0e9` from `crates_io` as `registry_expansion`
