...
<!-- canonical: https://cran.r-project.org/web/packages/mosclust/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mosclust/index.html](https://cran.r-project.org/web/packages/mosclust/index.html) |
| Source record ids | cran_packages_by_date-44795a34fb1c61 |
...
For a systems engineer, mosclust belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-10 14:30:10 UTC | [https://cran.r-project.org/web/packages/mosclust/DESCRIPTION](https://cran.r-project.org/web/packages/mosclust/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mosclust/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-44795a34fb1c61` from `cran_packages_by_date` as `registry_expansion`
