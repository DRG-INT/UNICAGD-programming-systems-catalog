...
| Canonical URL | [https://github.com/evidence-dev/evidence](https://github.com/evidence-dev/evidence) |
| Source record ids | github_search_webassembly-5fceda90f40185 |
...
For a systems engineer, evidence-dev/evidence belongs in the WebAssembly inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | @evidence-dev/evidence@40.1.8 | 2026-02-06T16:08:58Z | [https://api.github.com/repos/evidence-dev/evidence/releases/latest](https://api.github.com/repos/evidence-dev/evidence/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/evidence-dev/evidence/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-5fceda90f40185` from `github_search_webassembly` as `registry_expansion`
