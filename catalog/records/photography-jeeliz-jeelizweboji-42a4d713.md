...
<!-- canonical: https://github.com/jeeliz/jeelizWeboji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeeliz/jeelizWeboji](https://github.com/jeeliz/jeelizWeboji) |
| Source record ids | github_search_photography-d58b5234bd32c9 |

## System Engineer Summary

Real time WebGL and JavaScript library for face tracking, expression detection and animated
emoticons in the browser, with both SVG and Three.js demos included 😄

## Operational Role

For a systems engineer, jeeliz/jeelizWeboji belongs in the Photography inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-06T19:36:18Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-d58b5234bd32c9` from `github_search_photography` as `registry_expansion`
