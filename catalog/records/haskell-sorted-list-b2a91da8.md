...
<!-- canonical: https://hackage.haskell.org/package/sorted-list -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/sorted-list](https://hackage.haskell.org/package/sorted-list) |
| Source record ids | hackage_top_downloads-7923fa5f921771 |
...
For a systems engineer, sorted-list belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1.0 | 2025-03-25T12:39:13Z | [https://hackage.haskell.org/package/sorted-list](https://hackage.haskell.org/package/sorted-list) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/sorted-list` at `2026-09-11T00:31:36+00:00`.
...
- `hackage_top_downloads-7923fa5f921771` from `hackage_top_downloads` as `registry_expansion`
