...
<!-- canonical: https://cran.r-project.org/web/packages/shinydataviewer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinydataviewer/index.html](https://cran.r-project.org/web/packages/shinydataviewer/index.html) |
| Source record ids | cran_packages_by_date-638ebe9ddf15c6 |
...
For a systems engineer, shinydataviewer belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-05 02:20:02 UTC | [https://cran.r-project.org/web/packages/shinydataviewer/DESCRIPTION](https://cran.r-project.org/web/packages/shinydataviewer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinydataviewer/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-638ebe9ddf15c6` from `cran_packages_by_date` as `registry_expansion`
