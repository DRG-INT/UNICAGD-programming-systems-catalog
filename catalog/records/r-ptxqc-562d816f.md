...
<!-- canonical: https://cran.r-project.org/web/packages/PTXQC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PTXQC/index.html](https://cran.r-project.org/web/packages/PTXQC/index.html) |
| Source record ids | cran_packages_by_date-a58d63084a7f7a |
...
For a systems engineer, PTXQC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.6 | 2026-08-21 23:50:07 UTC | [https://cran.r-project.org/web/packages/PTXQC/DESCRIPTION](https://cran.r-project.org/web/packages/PTXQC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PTXQC/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a58d63084a7f7a` from `cran_packages_by_date` as `registry_expansion`
