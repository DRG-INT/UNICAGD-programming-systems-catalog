# harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator
...
<!-- canonical: https://github.com/harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator](https://github.com/harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator) |
| Source record ids | github_search_space_shuttles-b8ec327d2b024f |

## System Engineer Summary

harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator is tracked as a library record in
the Space Shuttles branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, harishsaranathan/SurveyorAutopilotForOrbiterSpaceFlightSimulator belongs in
the Space Shuttles inventory as part of ecosystem capability mapping, dependency review, release
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-31T16:32:17Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-b8ec327d2b024f` from `github_search_space_shuttles` as `registry_expansion`
