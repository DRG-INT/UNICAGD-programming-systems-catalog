...
<!-- canonical: https://crates.io/crates/glam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/glam](https://crates.io/crates/glam) |
| Source record ids | crates_io-e02ea86757d976 |
...
For a systems engineer, glam belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.33.7 | 2026-09-07T12:05:45.193922Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-07T12:26:30+00:00`.
...
- `crates_io-e02ea86757d976` from `crates_io` as `registry_expansion`
