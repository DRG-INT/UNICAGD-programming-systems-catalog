...
<!-- canonical: https://luarocks.org/modules/nymphium/eff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nymphium/eff](https://luarocks.org/modules/nymphium/eff) |
| Source record ids | luarocks_root_manifest-ba05d1d322cc5e |
...
For a systems engineer, eff belongs in the Lua family inventory as part of model pipelines,
...
- `luarocks_root_manifest-ba05d1d322cc5e` from `luarocks_root_manifest` as `registry_expansion`
