...
<!-- canonical: https://pypi.org/project/absorbing-machine/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/absorbing-machine/](https://pypi.org/project/absorbing-machine/) |
| Source record ids | pypi_simple-a4b4a2336ce258 |
...
For a systems engineer, absorbing-machine belongs in the Python inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-02-21T12:34:45.021301Z | [https://pypi.org/pypi/absorbing-machine/json](https://pypi.org/pypi/absorbing-machine/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/absorbing-machine/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-a4b4a2336ce258` from `pypi_simple` as `registry_expansion`
