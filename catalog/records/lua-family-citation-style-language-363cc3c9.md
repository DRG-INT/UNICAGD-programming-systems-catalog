...
<!-- canonical: https://luarocks.org/modules/freed-wu/citation-style-language -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/citation-style-language](https://luarocks.org/modules/freed-wu/citation-style-language) |
| Source record ids | luarocks_root_manifest-c8a18bde8de129 |
...
For a systems engineer, citation-style-language belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-c8a18bde8de129` from `luarocks_root_manifest` as `registry_expansion`
