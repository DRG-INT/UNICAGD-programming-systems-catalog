...
<!-- canonical: https://cran.r-project.org/web/packages/sfa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sfa/index.html](https://cran.r-project.org/web/packages/sfa/index.html) |
| Source record ids | cran_packages_by_date-261486fdd68bf1 |
...
For a systems engineer, sfa belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2026-08-23 18:30:02 UTC | [https://cran.r-project.org/web/packages/sfa/DESCRIPTION](https://cran.r-project.org/web/packages/sfa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sfa/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-261486fdd68bf1` from `cran_packages_by_date` as `registry_expansion`
