...
<!-- canonical: https://crates.io/crates/rand_xorshift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_xorshift](https://crates.io/crates/rand_xorshift) |
| Source record ids | crates_io-3b570b044ec4fb |
...
For a systems engineer, rand_xorshift belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-02-02T08:15:36.556285Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-3b570b044ec4fb` from `crates_io` as `registry_expansion`
