...
<!-- canonical: https://github.com/KonradIT/gopro-linux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KonradIT/gopro-linux](https://github.com/KonradIT/gopro-linux) |
| Source record ids | github_search_effects-d20052c7bd4acf |

## System Engineer Summary

Bash script which helps with post production for GoPro cameras in Linux, can be used as a
replacement for GoPro Studio

## Operational Role

For a systems engineer, KonradIT/gopro-linux belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-11T16:30:35Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d20052c7bd4acf` from `github_search_effects` as `registry_expansion`
