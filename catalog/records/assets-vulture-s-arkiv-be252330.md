...
<!-- canonical: https://github.com/vulture-s/arkiv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vulture-s/arkiv](https://github.com/vulture-s/arkiv) |
| Source record ids | github_search_assets-323b5e8d23cd93 |

## System Engineer Summary

Local-first media asset manager with AI semantic search — reads pro-camera metadata (Sony XAVC
sidecar, FX-series) and 360 footage (Insta360/GoPro Max) that consumer DAMs drop. FFmpeg + ChromaDB
+ local LLM.

## Operational Role

For a systems engineer, vulture-s/arkiv belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T10:40:12Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-323b5e8d23cd93` from `github_search_assets` as `registry_expansion`
