...
| Canonical URL | [https://luarocks.org/modules/geoffleyland/heaps](https://luarocks.org/modules/geoffleyland/heaps) |
| Source record ids | luarocks_root_manifest-b32765b020965e |

## System Engineer Summary

heaps is tracked as a memory analyzer record in the Lua family branch. The source did not provide a
...
For a systems engineer, heaps belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b32765b020965e` from `luarocks_root_manifest` as `registry_expansion`
