...
<!-- canonical: https://pub.dev/packages/chewie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/chewie](https://pub.dev/packages/chewie) |
| Source record ids | pub_dev-1d6f2e3f758e55 |
...
For a systems engineer, chewie belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.16.2 | 2026-09-02T14:53:35.297572Z | [https://pub.dev/api/packages/chewie](https://pub.dev/api/packages/chewie) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/chewie` at `2026-09-02T15:24:15+00:00`.
...
- `pub_dev-1d6f2e3f758e55` from `pub_dev` as `registry_expansion`
