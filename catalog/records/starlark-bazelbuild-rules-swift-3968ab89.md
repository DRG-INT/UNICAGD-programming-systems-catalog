...
<!-- canonical: https://github.com/bazelbuild/rules_swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/rules_swift](https://github.com/bazelbuild/rules_swift) |
| Source record ids | github_search_starlark-ac254f2f3fd631 |
...
For a systems engineer, bazelbuild/rules_swift belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:19:41Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-ac254f2f3fd631` from `github_search_starlark` as `registry_expansion`
