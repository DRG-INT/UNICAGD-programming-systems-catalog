...
| Canonical URL | [https://github.com/iv-org/invidious](https://github.com/iv-org/invidious) |
| Source record ids | github_search_video-44b2510061ede4 |
...
For a systems engineer, iv-org/invidious belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.20260804.1 | 2026-08-05T01:04:46Z | [https://api.github.com/repos/iv-org/invidious/releases/latest](https://api.github.com/repos/iv-org/invidious/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/iv-org/invidious/releases/latest` at `2026-09-01T09:23:24+00:00`.
...
- `github_search_video-44b2510061ede4` from `github_search_video` as `registry_expansion`
