...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundaryCrossingProbabilities](https://github.com/JuliaRegistries/General/tree/master/B/BoundaryCrossingProbabilities) |
| Source record ids | julia_general-60cebaa7a6c5e8 |

## System Engineer Summary

Julia package registered in General at B/BoundaryCrossingProbabilities.

## Operational Role

For a systems engineer, BoundaryCrossingProbabilities belongs in the Julia inventory as part of
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundaryCrossingProbabilities", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-60cebaa7a6c5e8` from `julia_general` as `registry_expansion`
