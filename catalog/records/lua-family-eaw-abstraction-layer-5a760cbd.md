...
<!-- canonical: https://luarocks.org/modules/svenmarcus/eaw-abstraction-layer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/svenmarcus/eaw-abstraction-layer](https://luarocks.org/modules/svenmarcus/eaw-abstraction-layer) |
| Source record ids | luarocks_root_manifest-dfa866eca02452 |

## System Engineer Summary

eaw-abstraction-layer is tracked as a library record in the Lua family branch. The source did not
...
For a systems engineer, eaw-abstraction-layer belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-dfa866eca02452` from `luarocks_root_manifest` as `registry_expansion`
