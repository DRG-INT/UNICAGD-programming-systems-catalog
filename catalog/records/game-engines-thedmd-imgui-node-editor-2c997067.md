...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/thedmd/imgui-node-editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thedmd/imgui-node-editor](https://github.com/thedmd/imgui-node-editor) |
| Source record ids | github_search_game_engines-9f994fffdaae7f |
...
For a systems engineer, thedmd/imgui-node-editor belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-29T08:34:57Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:game-development stars:>500", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_game_engines-9f994fffdaae7f` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CoplayDev/unity-mcp | Ide Editor Integration | [open](game-engines-coplaydev-unity-mcp-39755166.md) |
| deepnight/ldtk | Ide Editor Integration | [open](game-engines-deepnight-ldtk-09980ea4.md) |
| dfranx/SHADERed | Ide Editor Integration | [open](game-engines-dfranx-shadered-98539cf9.md) |
| donnemartin/awesome-aws | Ide Editor Integration | [open](game-engines-donnemartin-awesome-aws-e4f374ad.md) |
| gen2brain/raylib-go | Ide Editor Integration | [open](game-engines-gen2brain-raylib-go-a72c0456.md) |
| KaijuEngine/kaiju | Ide Editor Integration | [open](game-engines-kaijuengine-kaiju-b0e7a98f.md) |
| Kavex/GameDev-Resources | Ide Editor Integration | [open](game-engines-kavex-gamedev-resources-6c6ff6f7.md) |
| lettier/3d-game-shaders-for-beginners | Ide Editor Integration | [open](game-engines-lettier-3d-game-shaders-for-beginners-c97f2e28.md) |
