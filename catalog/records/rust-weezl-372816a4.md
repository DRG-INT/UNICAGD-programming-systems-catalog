...
<!-- canonical: https://crates.io/crates/weezl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/weezl](https://crates.io/crates/weezl) |
| Source record ids | crates_io-54eeee69039c03 |
...
For a systems engineer, weezl belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-05-15T22:35:10.230480Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-09T00:30:54+00:00`.
...
- `crates_io-54eeee69039c03` from `crates_io` as `registry_expansion`
