...
<!-- canonical: https://github.com/tree-sitter/tree-sitter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tree-sitter/tree-sitter](https://github.com/tree-sitter/tree-sitter) |
| Source record ids | github_search_webassembly-f611dad3232ec5 |
...
For a systems engineer, tree-sitter/tree-sitter belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T05:38:42Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-f611dad3232ec5` from `github_search_webassembly` as `registry_expansion`
