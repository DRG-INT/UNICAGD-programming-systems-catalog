...
<!-- canonical: https://cran.r-project.org/web/packages/tinycache/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinycache/index.html](https://cran.r-project.org/web/packages/tinycache/index.html) |
| Source record ids | cran_packages_by_date-aea33fea3520e4 |
...
For a systems engineer, tinycache belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2026-08-07 16:50:02 UTC | [https://cran.r-project.org/web/packages/tinycache/DESCRIPTION](https://cran.r-project.org/web/packages/tinycache/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinycache/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-aea33fea3520e4` from `cran_packages_by_date` as `registry_expansion`
