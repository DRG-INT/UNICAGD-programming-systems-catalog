...
<!-- canonical: https://crates.io/crates/sct -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sct](https://crates.io/crates/sct) |
| Source record ids | crates_io-9e5f9b87ae4016 |
...
For a systems engineer, sct belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2023-10-24T14:57:55.376462Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-9e5f9b87ae4016` from `crates_io` as `registry_expansion`
