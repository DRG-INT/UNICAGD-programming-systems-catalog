...
| Canonical URL | [https://crates.io/crates/android-activity](https://crates.io/crates/android-activity) |
| Source record ids | crates_io-4c27f017971477 |
...
For a systems engineer, android-activity belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-03-24T00:59:18.755650Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-4c27f017971477` from `crates_io` as `registry_expansion`
