# Moheeeetgupta/LadyBuddy-A-woman-safety-app
...
<!-- canonical: https://github.com/Moheeeetgupta/LadyBuddy-A-woman-safety-app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Moheeeetgupta/LadyBuddy-A-woman-safety-app](https://github.com/Moheeeetgupta/LadyBuddy-A-woman-safety-app) |
| Source record ids | github_search_electromagnetoscopes-69ab2d284e7d59 |

## System Engineer Summary

A complete women's safety app with various advanced features such as emergency SOS ,Software
simulation of electromagnetic waves detection using the magnetometer sensor, Women's news ,Siren
Alarm etc

## Operational Role

For a systems engineer, Moheeeetgupta/LadyBuddy-A-woman-safety-app belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-19T10:39:45Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-69ab2d284e7d59` from `github_search_electromagnetoscopes` as `registry_expansion`
