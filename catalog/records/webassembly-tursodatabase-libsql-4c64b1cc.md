...
| Canonical URL | [https://github.com/tursodatabase/libsql](https://github.com/tursodatabase/libsql) |
| Source record ids | github_search_webassembly-366b865fe95f64 |
...
For a systems engineer, tursodatabase/libsql belongs in the WebAssembly inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | libsql-server-v0.24.32 | 2025-02-14T12:59:35Z | [https://api.github.com/repos/tursodatabase/libsql/releases/latest](https://api.github.com/repos/tursodatabase/libsql/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tursodatabase/libsql/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-366b865fe95f64` from `github_search_webassembly` as `registry_expansion`
