...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://nix.dev/manual/nix/stable/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://nix.dev/manual/nix/stable/](https://nix.dev/manual/nix/stable/) |
| Source record ids | curated_language_routes-8ef77b58ff8831 |

## System Engineer Summary

Official Nix manual for commands, store operations, profiles, flakes, registries, and configuration.

## Operational Role

For a systems engineer, Nix Reference Manual belongs in the nix inventory as part of operator
...
- `curated_language_routes-8ef77b58ff8831` from `curated_language_routes` as `registry_expansion`
