...
<!-- canonical: https://github.com/yeliqseu/tcp-lte-sat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yeliqseu/tcp-lte-sat](https://github.com/yeliqseu/tcp-lte-sat) |
| Source record ids | github_search_satcom_satellites-5cc60fddc6ad62 |

## System Engineer Summary

TCP evaluation of using GEO satellite as a backhaul for LTE (ns-3)

## Operational Role

For a systems engineer, yeliqseu/tcp-lte-sat belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-27T09:05:23Z | gh search repos topic:satellite-communications stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-5cc60fddc6ad62` from `github_search_satcom_satellites` as `registry_expansion`
