...
<!-- canonical: https://pub.dev/packages/flutter_chat_types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_chat_types](https://pub.dev/packages/flutter_chat_types) |
| Source record ids | pub_dev-318611e935212e |

## System Engineer Summary

Utility library for the flutter_chat_ui and flutter_firebase_chat_core libraries which contains
shared type declarations.

## Operational Role

For a systems engineer, flutter_chat_types belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.2 | 2023-07-09T18:21:42.738589Z | [https://pub.dev/api/packages/flutter_chat_types](https://pub.dev/api/packages/flutter_chat_types) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_chat_types` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-318611e935212e` from `pub_dev` as `registry_expansion`
