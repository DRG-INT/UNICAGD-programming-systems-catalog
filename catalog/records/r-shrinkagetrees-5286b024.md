...
<!-- canonical: https://cran.r-project.org/web/packages/ShrinkageTrees/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ShrinkageTrees/index.html](https://cran.r-project.org/web/packages/ShrinkageTrees/index.html) |
| Source record ids | cran_packages_by_date-6195536ecf3843 |
...
For a systems engineer, ShrinkageTrees belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-09-02 14:00:02 UTC | [https://cran.r-project.org/web/packages/ShrinkageTrees/DESCRIPTION](https://cran.r-project.org/web/packages/ShrinkageTrees/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ShrinkageTrees/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-6195536ecf3843` from `cran_packages_by_date` as `registry_expansion`
