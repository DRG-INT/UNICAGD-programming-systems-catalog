...
<!-- canonical: https://pypi.org/project/adls2-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adls2-mcp-server/](https://pypi.org/project/adls2-mcp-server/) |
| Source record ids | pypi_simple-7b231598470939 |

## System Engineer Summary

Azure Data Lake Storage Gen2 Model Context Protocol (MCP) service

## Operational Role

For a systems engineer, adls2-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2025-04-07T01:15:26.727769Z | [https://pypi.org/pypi/adls2-mcp-server/json](https://pypi.org/pypi/adls2-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adls2-mcp-server/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-7b231598470939` from `pypi_simple` as `registry_expansion`
