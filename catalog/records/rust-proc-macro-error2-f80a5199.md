...
<!-- canonical: https://crates.io/crates/proc-macro-error2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/proc-macro-error2](https://crates.io/crates/proc-macro-error2) |
| Source record ids | crates_io-db1ae08811fd9f |
...
For a systems engineer, proc-macro-error2 belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2024-09-06T20:04:43.796942Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-db1ae08811fd9f` from `crates_io` as `registry_expansion`
