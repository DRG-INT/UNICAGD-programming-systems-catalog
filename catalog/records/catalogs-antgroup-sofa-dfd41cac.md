...
<!-- canonical: https://github.com/antgroup/sofa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/antgroup/sofa](https://github.com/antgroup/sofa) |
| Source record ids | github_search_catalogs-ac86438bd10a29 |

## System Engineer Summary

SOFAStack™ (Scalable Open Financial Architecture Stack) is a collection of cloud native middleware
components, which are designed to build distributed systems with high performance and reliability,
and have been fully validated by mission-critical financial business scenarios.

## Operational Role

For a systems engineer, antgroup/sofa belongs in the Catalogs inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-10T09:26:35Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ac86438bd10a29` from `github_search_catalogs` as `registry_expansion`
