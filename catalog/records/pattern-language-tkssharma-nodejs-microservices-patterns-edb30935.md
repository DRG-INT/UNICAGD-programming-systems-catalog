# tkssharma/nodejs-microservices-patterns
...
<!-- canonical: https://github.com/tkssharma/nodejs-microservices-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tkssharma/nodejs-microservices-patterns](https://github.com/tkssharma/nodejs-microservices-patterns) |
| Source record ids | github_search_pattern_language-bcbaae82e2418f |
...
For a systems engineer, tkssharma/nodejs-microservices-patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-02T17:23:41Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-bcbaae82e2418f` from `github_search_pattern_language` as `registry_expansion`
