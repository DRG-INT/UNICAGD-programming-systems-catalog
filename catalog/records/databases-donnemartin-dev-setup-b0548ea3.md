...
<!-- canonical: https://github.com/donnemartin/dev-setup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/donnemartin/dev-setup](https://github.com/donnemartin/dev-setup) |
| Source record ids | github_search_databases-c6a4cd5986470b |

## System Engineer Summary

macOS development environment setup: Easy-to-understand instructions with automated setup scripts
for developer tools like Vim, Sublime Text, Bash, iTerm, Python data analysis, Spark, Hadoop
MapReduce, AWS, Heroku, JavaScript web development, Android development, common data stores, and
dev-based OS X defaults.

## Operational Role

For a systems engineer, donnemartin/dev-setup belongs in the Databases inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-27T18:00:26Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c6a4cd5986470b` from `github_search_databases` as `registry_expansion`
