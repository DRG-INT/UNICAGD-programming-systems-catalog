...
<!-- canonical: https://cran.r-project.org/web/packages/RBesT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RBesT/index.html](https://cran.r-project.org/web/packages/RBesT/index.html) |
| Source record ids | cran_packages_by_date-68c6c9f54fafaf |
...
For a systems engineer, RBesT belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11-0 | 2026-08-04 16:40:09 UTC | [https://cran.r-project.org/web/packages/RBesT/DESCRIPTION](https://cran.r-project.org/web/packages/RBesT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RBesT/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-68c6c9f54fafaf` from `cran_packages_by_date` as `registry_expansion`
