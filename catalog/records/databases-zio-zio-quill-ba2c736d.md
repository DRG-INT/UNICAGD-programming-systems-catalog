...
<!-- canonical: https://github.com/zio/zio-quill -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zio/zio-quill](https://github.com/zio/zio-quill) |
| Source record ids | github_search_databases-250aea00bfd54c |
...
For a systems engineer, zio/zio-quill belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T01:30:21Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-250aea00bfd54c` from `github_search_databases` as `registry_expansion`
