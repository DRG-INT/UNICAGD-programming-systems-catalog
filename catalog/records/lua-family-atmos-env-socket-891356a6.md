...
<!-- canonical: https://luarocks.org/modules/fsantanna/atmos-env-socket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fsantanna/atmos-env-socket](https://luarocks.org/modules/fsantanna/atmos-env-socket) |
| Source record ids | luarocks_root_manifest-8c61c5dfffaa9e |

## System Engineer Summary

Socket environment for Atmos

## Operational Role

For a systems engineer, atmos-env-socket belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-8c61c5dfffaa9e` from `luarocks_root_manifest` as `registry_expansion`
