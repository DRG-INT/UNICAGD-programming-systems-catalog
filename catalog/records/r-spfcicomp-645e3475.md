...
<!-- canonical: https://cran.r-project.org/web/packages/spfcICOMP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spfcICOMP/index.html](https://cran.r-project.org/web/packages/spfcICOMP/index.html) |
| Source record ids | cran_packages_by_date-50f64344b78ec8 |

## System Engineer Summary

Shrinkage Principal Fitted Components with Information Complexity-Based Model Selection

## Operational Role

For a systems engineer, spfcICOMP belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 13:50:02 UTC | [https://cran.r-project.org/web/packages/spfcICOMP/DESCRIPTION](https://cran.r-project.org/web/packages/spfcICOMP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spfcICOMP/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-50f64344b78ec8` from `cran_packages_by_date` as `registry_expansion`
