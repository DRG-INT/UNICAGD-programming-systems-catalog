# gitlab-org/rust/knowledge-graph
...
<!-- canonical: https://gitlab.com/gitlab-org/rust/knowledge-graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/rust/knowledge-graph](https://gitlab.com/gitlab-org/rust/knowledge-graph) |
| Source record ids | gitlab_projects_api-caddedefe4391f |

## System Engineer Summary

The project aims to create a structured, queryable graph database from code repositories to power AI
features and enhance developer productivity. - -

## Operational Role

For a systems engineer, gitlab-org/rust/knowledge-graph belongs in the Repository Workplaces
...
- `gitlab_projects_api-caddedefe4391f` from `gitlab_projects_api` as `registry_expansion`
