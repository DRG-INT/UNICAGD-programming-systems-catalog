...
<!-- canonical: https://crates.io/crates/trust-dns-proto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/trust-dns-proto](https://crates.io/crates/trust-dns-proto) |
| Source record ids | crates_io-af0af509a3619b |

## System Engineer Summary

Trust-DNS is a safe and secure DNS library. This is the foundational DNS protocol library for all
Trust-DNS projects.

## Operational Role

For a systems engineer, trust-dns-proto belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.2 | 2023-10-23T16:03:22.585328Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-03T18:22:56+00:00`.
...
- `crates_io-af0af509a3619b` from `crates_io` as `registry_expansion`
