...
<!-- canonical: https://github.com/Red5/red5-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Red5/red5-server](https://github.com/Red5/red5-server) |
| Source record ids | github_search_video-6eefb65d2bd34e |

## System Engineer Summary

Red5/red5-server is tracked as a web framework record in the Video branch. The source did not
...
For a systems engineer, Red5/red5-server belongs in the Video inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T15:04:26Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-6eefb65d2bd34e` from `github_search_video` as `registry_expansion`
...
| fonoster/routr | Web Framework | [open](video-fonoster-routr-17234a69.md) |
