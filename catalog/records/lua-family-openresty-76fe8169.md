...
| Canonical URL | [http://openresty.org/en/](http://openresty.org/en/) |
| Source record ids | lua-source-154 |

## System Engineer Summary

A fast and scalable web application platform created by extending Nginx with Lua. Today's de-facto
Lua web platform, used heavily by Cloudflare, Taobao, Tencent, and others.

## Operational Role

For a systems engineer, OpenResty belongs in the Lua family inventory as part of language tooling,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 154}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-154` from `master_json` as `source_list_item`
...
| LuaExpat | Parser Lexer Ast | [open](lua-family-luaexpat-894b1a88.md) |
