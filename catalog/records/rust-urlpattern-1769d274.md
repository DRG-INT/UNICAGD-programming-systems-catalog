...
| Canonical URL | [https://crates.io/crates/urlpattern](https://crates.io/crates/urlpattern) |
| Source record ids | crates_io-285ba98ea5209e |
...
For a systems engineer, urlpattern belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-02-12T12:50:26.051688Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-285ba98ea5209e` from `crates_io` as `registry_expansion`
