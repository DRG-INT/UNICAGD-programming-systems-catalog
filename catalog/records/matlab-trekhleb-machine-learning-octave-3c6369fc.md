...
<!-- canonical: https://github.com/trekhleb/machine-learning-octave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/trekhleb/machine-learning-octave](https://github.com/trekhleb/machine-learning-octave) |
| Source record ids | github_search_matlab-aefd8e595710a0 |

## System Engineer Summary

🤖 MatLab/Octave examples of popular machine learning algorithms with code examples and mathematics
being explained

## Operational Role

For a systems engineer, trekhleb/machine-learning-octave belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-23T04:28:32Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-aefd8e595710a0` from `github_search_matlab` as `registry_expansion`
