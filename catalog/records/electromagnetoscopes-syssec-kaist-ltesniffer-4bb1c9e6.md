...
| Source record ids | github_search_electromagnetoscopes-ed8d24073ede54 |
...
For a systems engineer, SysSec-KAIST/LTESniffer belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | LTESniffer-v2.1.0 | 2024-01-14T07:49:47Z | [https://api.github.com/repos/SysSec-KAIST/LTESniffer/releases/latest](https://api.github.com/repos/SysSec-KAIST/LTESniffer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SysSec-KAIST/LTESniffer/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-ed8d24073ede54` from `github_search_electromagnetoscopes` as `registry_expansion`
