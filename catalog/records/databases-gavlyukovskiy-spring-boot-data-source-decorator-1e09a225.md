...
<!-- canonical: https://github.com/gavlyukovskiy/spring-boot-data-source-decorator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gavlyukovskiy/spring-boot-data-source-decorator](https://github.com/gavlyukovskiy/spring-boot-data-source-decorator) |
| Source record ids | github_search_databases-e1fe32ebf13599 |
...
For a systems engineer, gavlyukovskiy/spring-boot-data-source-decorator belongs in the Databases
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T21:23:16Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e1fe32ebf13599` from `github_search_databases` as `registry_expansion`
