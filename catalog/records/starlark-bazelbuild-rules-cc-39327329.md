...
<!-- canonical: https://github.com/bazelbuild/rules_cc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/rules_cc](https://github.com/bazelbuild/rules_cc) |
| Source record ids | github_search_starlark-78a403ee622304 |

## System Engineer Summary

bazelbuild/rules_cc is tracked as a build system record in the Starlark branch. The source did not
...
For a systems engineer, bazelbuild/rules_cc belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T16:35:19Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-78a403ee622304` from `github_search_starlark` as `registry_expansion`
