...
<!-- canonical: https://github.com/Refloow/Refloow-Geo-Forensics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Refloow/Refloow-Geo-Forensics](https://github.com/Refloow/Refloow-Geo-Forensics) |
| Source record ids | github_search_photography-62df56da0b7c4c |

## System Engineer Summary

❤️ Free batch image & video geolocation digital forensics tool. Automatically extract EXIF data,
visualize GPS coordinates on maps, and reconstruct event timelines for OSINT

## Operational Role

For a systems engineer, Refloow/Refloow-Geo-Forensics belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-07T22:09:25Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-62df56da0b7c4c` from `github_search_photography` as `registry_expansion`
