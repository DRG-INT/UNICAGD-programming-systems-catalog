...
| Source record ids | corpus-b2d2e80f210e1f |

## System Engineer Summary

Bazel is tracked as a build system record in the C99 branch. The source did not provide a long
...
For a systems engineer, Bazel belongs in the C99 inventory as part of build graph control, artifact
...
- `corpus-b2d2e80f210e1f` from `master_json` as `build_system`
