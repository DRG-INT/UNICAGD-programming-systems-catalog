...
<!-- canonical: https://pypi.org/project/abom-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abom-cli/](https://pypi.org/project/abom-cli/) |
| Source record ids | pypi_simple-4d4a05f7c44131 |
...
For a systems engineer, abom-cli belongs in the Python inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-07-22T15:43:38.207386Z | [https://pypi.org/pypi/abom-cli/json](https://pypi.org/pypi/abom-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abom-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-4d4a05f7c44131` from `pypi_simple` as `registry_expansion`
