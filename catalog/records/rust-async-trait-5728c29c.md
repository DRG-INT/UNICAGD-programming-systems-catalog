...
<!-- canonical: https://crates.io/crates/async-trait -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-trait](https://crates.io/crates/async-trait) |
| Source record ids | crates_io-98fa253933cd10 |
...
For a systems engineer, async-trait belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.92 | 2026-08-08T07:10:35.376083Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/System.IdentityModel.Tokens.Jwt/8.22.0/license |
...
- `crates_io-98fa253933cd10` from `crates_io` as `registry_expansion`
