...
<!-- canonical: https://cran.r-project.org/web/packages/discretes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/discretes/index.html](https://cran.r-project.org/web/packages/discretes/index.html) |
| Source record ids | cran_packages_by_date-2a65230aa987f6 |

## System Engineer Summary

discretes is tracked as a math numeric scientific record in the R branch. The source did not provide
...
For a systems engineer, discretes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-11 14:30:06 UTC | [https://cran.r-project.org/web/packages/discretes/DESCRIPTION](https://cran.r-project.org/web/packages/discretes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/discretes/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-2a65230aa987f6` from `cran_packages_by_date` as `registry_expansion`
