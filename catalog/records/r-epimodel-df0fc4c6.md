...
<!-- canonical: https://cran.r-project.org/web/packages/EpiModel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EpiModel/index.html](https://cran.r-project.org/web/packages/EpiModel/index.html) |
| Source record ids | cran_packages_by_date-ef6489dde59568 |
...
For a systems engineer, EpiModel belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.2 | 2026-09-16 05:40:09 UTC | [https://cran.r-project.org/web/packages/EpiModel/DESCRIPTION](https://cran.r-project.org/web/packages/EpiModel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EpiModel/DESCRIPTION` at `2026-09-16T06:26:24+00:00`.
...
- `cran_packages_by_date-ef6489dde59568` from `cran_packages_by_date` as `registry_expansion`
