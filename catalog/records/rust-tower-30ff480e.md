...
<!-- canonical: https://crates.io/crates/tower -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tower](https://crates.io/crates/tower) |
| Source record ids | crates_io-c66aac577fb9aa |
...
For a systems engineer, tower belongs in the Rust inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-01-12T18:43:05.227461Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-c66aac577fb9aa` from `crates_io` as `registry_expansion`
