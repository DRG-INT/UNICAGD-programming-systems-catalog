...
| Canonical URL | [https://luarocks.org/modules/jhitzke/keyauthvaluepass](https://luarocks.org/modules/jhitzke/keyauthvaluepass) |
| Source record ids | luarocks_root_manifest-a681f873ed37de |

## System Engineer Summary

Pass a value via custom_id using key-auth, using a given prefix

## Operational Role

For a systems engineer, key-auth-value-pass belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a681f873ed37de` from `luarocks_root_manifest` as `registry_expansion`
