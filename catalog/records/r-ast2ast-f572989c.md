...
<!-- canonical: https://cran.r-project.org/web/packages/ast2ast/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ast2ast/index.html](https://cran.r-project.org/web/packages/ast2ast/index.html) |
| Source record ids | cran_packages_by_date-21b05f4ad0ecca |
...
For a systems engineer, ast2ast belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-09-14 15:00:10 UTC | [https://cran.r-project.org/web/packages/ast2ast/DESCRIPTION](https://cran.r-project.org/web/packages/ast2ast/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ast2ast/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-21b05f4ad0ecca` from `cran_packages_by_date` as `registry_expansion`
