...
<!-- canonical: https://luarocks.org/modules/youxing/c-lua-package -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/youxing/c-lua-package](https://luarocks.org/modules/youxing/c-lua-package) |
| Source record ids | luarocks_root_manifest-b1f6ab5ec07a1f |

## System Engineer Summary

c-lua-package is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, c-lua-package belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b1f6ab5ec07a1f` from `luarocks_root_manifest` as `registry_expansion`
