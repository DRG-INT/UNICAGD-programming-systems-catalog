...
<!-- canonical: https://www.npmjs.com/package/@firebase/database-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@firebase/database-types](https://www.npmjs.com/package/@firebase/database-types) |
| Source record ids | npm_registry-4ceab0676ed28d |
...
For a systems engineer, @firebase/database-types belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.22 | 2026-08-19T20:19:20.004Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4ceab0676ed28d` from `npm_registry` as `registry_expansion`
