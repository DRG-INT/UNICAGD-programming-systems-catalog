...
<!-- canonical: https://luarocks.org/modules/mikejsavage/arc4random -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mikejsavage/arc4random](https://luarocks.org/modules/mikejsavage/arc4random) |
| Source record ids | luarocks_root_manifest-6800acca6e194d |
...
For a systems engineer, arc4random belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6800acca6e194d` from `luarocks_root_manifest` as `registry_expansion`
