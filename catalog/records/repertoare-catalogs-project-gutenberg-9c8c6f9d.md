...
<!-- canonical: https://www.gutenberg.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.gutenberg.org/](https://www.gutenberg.org/) |
| Source record ids | curated_language_routes-3658bcef36cd14 |

## System Engineer Summary

Public ebook catalog and corpus route for texts, metadata, formats, mirrors, and download workflows.

## Operational Role

For a systems engineer, Project Gutenberg belongs in the Repertoare Catalogs inventory as part of
...
- `curated_language_routes-3658bcef36cd14` from `curated_language_routes` as `registry_expansion`
