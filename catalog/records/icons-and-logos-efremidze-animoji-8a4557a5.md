...
<!-- canonical: https://github.com/efremidze/Animoji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/efremidze/Animoji](https://github.com/efremidze/Animoji) |
| Source record ids | github_search_icons_and_logos-c60ceda81da8e5 |

## System Engineer Summary

efremidze/Animoji is tracked as a library record in the Icons and Logos branch. The source did not
...
For a systems engineer, efremidze/Animoji belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-30T23:54:58Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-c60ceda81da8e5` from `github_search_icons_and_logos` as `registry_expansion`
