...
<!-- canonical: https://crates.io/crates/winapi-x86_64-pc-windows-gnu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/winapi-x86_64-pc-windows-gnu](https://crates.io/crates/winapi-x86_64-pc-windows-gnu) |
| Source record ids | crates_io-d528dfb290f0d7 |

## System Engineer Summary

Import libraries for the x86_64-pc-windows-gnu target. Please don't use this crate directly, depend
on winapi instead.

## Operational Role

For a systems engineer, winapi-x86_64-pc-windows-gnu belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2018-01-18T00:55:12.008307Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT; https://www.nuget.org/packages/StrawberryShake.Transport.Http/16.6.2/license |
...
- `crates_io-d528dfb290f0d7` from `crates_io` as `registry_expansion`
