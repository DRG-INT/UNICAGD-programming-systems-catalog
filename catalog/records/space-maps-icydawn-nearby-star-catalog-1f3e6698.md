...
<!-- canonical: https://github.com/IcyDawn/Nearby_Star_Catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IcyDawn/Nearby_Star_Catalog](https://github.com/IcyDawn/Nearby_Star_Catalog) |
| Source record ids | github_search_space_maps-79e04f46c36eea |

## System Engineer Summary

This catalog contains 2575 stars within 20 parsecs from the Earth, mainly based on the Gaia Catalog
of Nearby Stars (GCNS), with more completed parameters including stellar luminosity, effective
temperature, radius, and mass.

## Operational Role

For a systems engineer, IcyDawn/Nearby_Star_Catalog belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-28T10:00:22Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-79e04f46c36eea` from `github_search_space_maps` as `registry_expansion`
