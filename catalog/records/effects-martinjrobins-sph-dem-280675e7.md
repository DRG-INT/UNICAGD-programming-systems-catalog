# martinjrobins/SPH-DEM

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/martinjrobins/SPH-DEM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/martinjrobins/SPH-DEM](https://github.com/martinjrobins/SPH-DEM) |
| Source record ids | github_search_effects-ddd15b77a29afb |

## System Engineer Summary

An academic c++ code for numerical modelling of fluid-particle systems using Smoothed Particle
Hydrodynamics (SPH) and Discrete Element Modeling (DEM)

## Operational Role

For a systems engineer, martinjrobins/SPH-DEM belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-06-06T08:58:48Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ddd15b77a29afb` from `github_search_effects` as `registry_expansion`
