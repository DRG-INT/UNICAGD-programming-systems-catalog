...
<!-- canonical: https://cran.r-project.org/web/packages/trend/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/trend/index.html](https://cran.r-project.org/web/packages/trend/index.html) |
| Source record ids | cran_packages_by_date-7f73a39984502c |
...
For a systems engineer, trend belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.8 | 2026-09-03 14:40:02 UTC | [https://cran.r-project.org/web/packages/trend/DESCRIPTION](https://cran.r-project.org/web/packages/trend/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/trend/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-7f73a39984502c` from `cran_packages_by_date` as `registry_expansion`
