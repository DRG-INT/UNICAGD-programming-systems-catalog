...
<!-- canonical: https://cran.r-project.org/web/packages/BuSuCo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BuSuCo/index.html](https://cran.r-project.org/web/packages/BuSuCo/index.html) |
| Source record ids | cran_packages_by_date-b0d0845f4fccaf |

## System Engineer Summary

Coordinate Survey Samples for Businesses

## Operational Role

For a systems engineer, BuSuCo belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-08 13:40:29 UTC | [https://cran.r-project.org/web/packages/BuSuCo/DESCRIPTION](https://cran.r-project.org/web/packages/BuSuCo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BuSuCo/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-b0d0845f4fccaf` from `cran_packages_by_date` as `registry_expansion`
