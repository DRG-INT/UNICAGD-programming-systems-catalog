...
<!-- canonical: https://github.com/clawsoftware/clawPDF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/clawsoftware/clawPDF](https://github.com/clawsoftware/clawPDF) |
| Source record ids | github_search_photography-30e917c8c3b87c |

## System Engineer Summary

Open Source Virtual (Network) Printer for Windows that allows you to create PDFs, OCR text, and
print images, with advanced features usually available only in enterprise solutions.

## Operational Role

For a systems engineer, clawsoftware/clawPDF belongs in the Photography inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-16T14:55:21Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-30e917c8c3b87c` from `github_search_photography` as `registry_expansion`
