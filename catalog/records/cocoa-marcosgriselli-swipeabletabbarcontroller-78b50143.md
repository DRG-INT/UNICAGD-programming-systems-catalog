...
<!-- canonical: https://github.com/marcosgriselli/SwipeableTabBarController -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marcosgriselli/SwipeableTabBarController](https://github.com/marcosgriselli/SwipeableTabBarController) |
| Source record ids | github_search_cocoa-d1efd3f26fa1b8 |
...
For a systems engineer, marcosgriselli/SwipeableTabBarController belongs in the Cocoa inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-04T21:52:42Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-d1efd3f26fa1b8` from `github_search_cocoa` as `registry_expansion`
