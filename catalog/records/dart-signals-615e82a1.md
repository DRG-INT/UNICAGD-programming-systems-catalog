...
<!-- canonical: https://pub.dev/packages/signals -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/signals](https://pub.dev/packages/signals) |
| Source record ids | pub_dev-78ed97e15d24b5 |

## System Engineer Summary

Reactivity made simple. Do more by doing less. Supports Flutter and any Dart project including
HTML/JS, CLI, Shelf Server, VM and more.

## Operational Role

For a systems engineer, signals belongs in the Dart inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2026-05-29T06:27:09.278212Z | [https://pub.dev/api/packages/signals](https://pub.dev/api/packages/signals) |  |
| preview | known | 6.0.0-rc.5 | 2024-11-28T06:53:59.779923Z | [https://pub.dev/api/packages/signals](https://pub.dev/api/packages/signals) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/signals` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-78ed97e15d24b5` from `pub_dev` as `registry_expansion`
