...
<!-- canonical: https://crates.io/crates/wasm-bindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasm-bindgen](https://crates.io/crates/wasm-bindgen) |
| Source record ids | crates_io-d9cf925dba7159 |
...
For a systems engineer, wasm-bindgen belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.128 | 2026-09-04T23:58:10.332542Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-d9cf925dba7159` from `crates_io` as `registry_expansion`
