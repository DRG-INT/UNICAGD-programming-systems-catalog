...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/ruint](https://crates.io/crates/ruint) |
| Source record ids | crates_io-b110ba321b5729 |
...
For a systems engineer, ruint belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.20.0 | 2026-07-30T16:00:21.166231Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| anyhow | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-anyhow-cc216d40.md) |
| ascii | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ascii-d18e2693.md) |
| bstr | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bstr-dd1e73fc.md) |
| cpuid-bool | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cpuid-bool-fdcabe96.md) |
| criterion-plot | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-criterion-plot-7b9f5798.md) |
| dpi | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dpi-438777ef.md) |
| egui | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-egui-bbe081e8.md) |
| eyre | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-eyre-3ea5277e.md) |
