...
| Canonical URL | [https://macromates.com/manual/en/language_grammars](https://macromates.com/manual/en/language_grammars) |
| Source record ids | curated_language_routes-e1e530a37388df |

## System Engineer Summary

TextMate language grammar format used by editors to tokenize braces, scopes, strings, and embedded
languages.

## Operational Role

For a systems engineer, TextMate Grammars belongs in the Braces inventory as part of language
...
- `curated_language_routes-e1e530a37388df` from `curated_language_routes` as `registry_expansion`
...
| tree-sitter | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/braces-tree-sitter-f8e7beda.md) |
