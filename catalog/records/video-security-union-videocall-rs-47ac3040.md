...
<!-- canonical: https://github.com/security-union/videocall-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/security-union/videocall-rs](https://github.com/security-union/videocall-rs) |
| Source record ids | github_search_video-c14383e14b81ed |
...
For a systems engineer, security-union/videocall-rs belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:59:12Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-c14383e14b81ed` from `github_search_video` as `registry_expansion`
...
| rnchg/APT | Security Sast | [open](video-rnchg-apt-78655c38.md) |
