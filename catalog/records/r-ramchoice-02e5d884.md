...
<!-- canonical: https://cran.r-project.org/web/packages/ramchoice/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ramchoice/index.html](https://cran.r-project.org/web/packages/ramchoice/index.html) |
| Source record ids | cran_packages_by_date-88fb1165423502 |
...
For a systems engineer, ramchoice belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-09-04 06:40:10 UTC | [https://cran.r-project.org/web/packages/ramchoice/DESCRIPTION](https://cran.r-project.org/web/packages/ramchoice/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ramchoice/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-88fb1165423502` from `cran_packages_by_date` as `registry_expansion`
