...
<!-- canonical: https://github.com/netwide-assembler/nasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/netwide-assembler/nasm](https://github.com/netwide-assembler/nasm) |
| Source record ids | github_search_assembly-6abc7c3e9d0b71 |
...
For a systems engineer, netwide-assembler/nasm belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T23:47:10Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6abc7c3e9d0b71` from `github_search_assembly` as `registry_expansion`
