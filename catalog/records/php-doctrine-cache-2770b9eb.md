...
<!-- canonical: https://packagist.org/packages/doctrine/cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/doctrine/cache](https://packagist.org/packages/doctrine/cache) |
| Source record ids | packagist_search-ceb98d708b569b |

## System Engineer Summary

PHP Doctrine Cache library is a popular cache implementation that supports many different drivers
such as redis, memcache, apc, mongodb and others.

## Operational Role

For a systems engineer, doctrine/cache belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-ceb98d708b569b` from `packagist_search` as `registry_expansion`
