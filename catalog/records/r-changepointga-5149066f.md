...
<!-- canonical: https://cran.r-project.org/web/packages/changepointGA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/changepointGA/index.html](https://cran.r-project.org/web/packages/changepointGA/index.html) |
| Source record ids | cran_packages_by_date-b944859884da26 |

## System Engineer Summary

Changepoint Detection via Modified Genetic Algorithms

## Operational Role

For a systems engineer, changepointGA belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-09-13 03:50:02 UTC | [https://cran.r-project.org/web/packages/changepointGA/DESCRIPTION](https://cran.r-project.org/web/packages/changepointGA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/changepointGA/DESCRIPTION` at `2026-09-13T04:19:54+00:00`.
...
- `cran_packages_by_date-b944859884da26` from `cran_packages_by_date` as `registry_expansion`
