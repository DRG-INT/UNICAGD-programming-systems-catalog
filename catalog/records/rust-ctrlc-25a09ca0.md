...
<!-- canonical: https://crates.io/crates/ctrlc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ctrlc](https://crates.io/crates/ctrlc) |
| Source record ids | crates_io-7b0e4ad5cc40d1 |
...
For a systems engineer, ctrlc belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.2 | 2026-02-10T20:41:44.442750Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-7b0e4ad5cc40d1` from `crates_io` as `registry_expansion`
