...
| Source record ids | corpus-d60fba5d182a2e |

## System Engineer Summary

C23 decimal floating types is tracked as a language specification record in the C23 branch. The
...
For a systems engineer, C23 decimal floating types belongs in the C23 inventory as part of ecosystem
...
- `corpus-d60fba5d182a2e` from `master_json` as `language_specification`
