...
| Canonical URL | [https://luarocks.org/modules/siiky/gmi](https://luarocks.org/modules/siiky/gmi) |
| Source record ids | luarocks_root_manifest-453c1b6e32a1b2 |
...
For a systems engineer, gmi belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-453c1b6e32a1b2` from `luarocks_root_manifest` as `registry_expansion`
