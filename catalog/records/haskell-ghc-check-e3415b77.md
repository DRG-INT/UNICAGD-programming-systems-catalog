...
<!-- canonical: https://hackage.haskell.org/package/ghc-check -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-check](https://hackage.haskell.org/package/ghc-check) |
| Source record ids | hackage_top_downloads-0deaffd3641067 |
...
For a systems engineer, ghc-check belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.8 | 2022-08-14T07:10:59Z | [https://hackage.haskell.org/package/ghc-check](https://hackage.haskell.org/package/ghc-check) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/ghc-check](https://hackage.haskell.org/package/ghc-check) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-check` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-0deaffd3641067` from `hackage_top_downloads` as `registry_expansion`
