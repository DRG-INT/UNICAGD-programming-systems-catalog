...
<!-- canonical: https://github.com/Corne2Plum3/Giphurs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Corne2Plum3/Giphurs](https://github.com/Corne2Plum3/Giphurs) |
| Source record ids | github_search_font_briefcase-f65785682dd7e2 |

## System Engineer Summary

Giphurs is a néo-grotesque font inspired Helvetica and Arial for Latin, Greek and Cyrillic. The font
has variable weight, support for italics and font features including small caps.

## Operational Role

For a systems engineer, Corne2Plum3/Giphurs belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:15:10Z | gh search repos topic:fontforge stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | (UPL-1.0 OR Apache-2.0); MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `github_search_font_briefcase-f65785682dd7e2` from `github_search_font_briefcase` as `registry_expansion`
