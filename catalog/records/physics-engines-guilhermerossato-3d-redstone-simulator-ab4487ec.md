...
<!-- canonical: https://github.com/GuilhermeRossato/3D-Redstone-Simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GuilhermeRossato/3D-Redstone-Simulator](https://github.com/GuilhermeRossato/3D-Redstone-Simulator) |
| Source record ids | github_search_physics_engines-3d93b53adbca05 |
...
For a systems engineer, GuilhermeRossato/3D-Redstone-Simulator belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-29T20:37:27Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-3d93b53adbca05` from `github_search_physics_engines` as `registry_expansion`
