...
<!-- canonical: https://cran.r-project.org/web/packages/prevtoinc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prevtoinc/index.html](https://cran.r-project.org/web/packages/prevtoinc/index.html) |
| Source record ids | cran_packages_by_date-14c44d7129a8e4 |
...
For a systems engineer, prevtoinc belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.1 | 2026-09-03 10:10:11 UTC | [https://cran.r-project.org/web/packages/prevtoinc/DESCRIPTION](https://cran.r-project.org/web/packages/prevtoinc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prevtoinc/DESCRIPTION` at `2026-09-03T10:21:04+00:00`.
...
- `cran_packages_by_date-14c44d7129a8e4` from `cran_packages_by_date` as `registry_expansion`
