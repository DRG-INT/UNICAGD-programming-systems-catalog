...
<!-- canonical: https://cran.r-project.org/web/packages/Nestimate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Nestimate/index.html](https://cran.r-project.org/web/packages/Nestimate/index.html) |
| Source record ids | cran_packages_by_date-23ee291c113ec8 |
...
For a systems engineer, Nestimate belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.5 | 2026-08-21 22:01:48 UTC | [https://cran.r-project.org/web/packages/Nestimate/DESCRIPTION](https://cran.r-project.org/web/packages/Nestimate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Nestimate/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-23ee291c113ec8` from `cran_packages_by_date` as `registry_expansion`
