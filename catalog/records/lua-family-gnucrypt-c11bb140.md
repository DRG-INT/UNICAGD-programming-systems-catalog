...
| Canonical URL | [https://luarocks.org/modules/esno/gnucrypt](https://luarocks.org/modules/esno/gnucrypt) |
| Source record ids | luarocks_root_manifest-e5d25f79db102e |

## System Engineer Summary

gnucrypt is tracked as an interop bindings record in the Lua family branch. The source did not
...
For a systems engineer, gnucrypt belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e5d25f79db102e` from `luarocks_root_manifest` as `registry_expansion`
