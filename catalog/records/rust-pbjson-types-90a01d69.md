...
| Canonical URL | [https://crates.io/crates/pbjson-types](https://crates.io/crates/pbjson-types) |
| Source record ids | crates_io-b7702feeaeee11 |
...
For a systems engineer, pbjson-types belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2025-12-09T13:14:25.461405Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-b7702feeaeee11` from `crates_io` as `registry_expansion`
