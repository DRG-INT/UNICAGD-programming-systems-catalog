...
<!-- canonical: https://luarocks.org/modules/w-utter/buckshot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/w-utter/buckshot](https://luarocks.org/modules/w-utter/buckshot) |
| Source record ids | luarocks_root_manifest-2eefeadf7c5d2e |

## System Engineer Summary

a fast buffer symbol navigator

## Operational Role

For a systems engineer, buckshot belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-2eefeadf7c5d2e` from `luarocks_root_manifest` as `registry_expansion`
