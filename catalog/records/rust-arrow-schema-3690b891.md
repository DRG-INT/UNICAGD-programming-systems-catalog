...
<!-- canonical: https://crates.io/crates/arrow-schema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arrow-schema](https://crates.io/crates/arrow-schema) |
| Source record ids | crates_io-bac94251d39400 |
...
For a systems engineer, arrow-schema belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 59.3.0 | 2026-09-01T10:37:46.420301Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-01T12:25:15+00:00`.
...
- `crates_io-bac94251d39400` from `crates_io` as `registry_expansion`
