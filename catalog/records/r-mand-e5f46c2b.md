...
<!-- canonical: https://cran.r-project.org/web/packages/mand/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mand/index.html](https://cran.r-project.org/web/packages/mand/index.html) |
| Source record ids | cran_packages_by_date-c8776e021a7c19 |
...
For a systems engineer, mand belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0 | 2026-09-14 07:10:02 UTC | [https://cran.r-project.org/web/packages/mand/DESCRIPTION](https://cran.r-project.org/web/packages/mand/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mand/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-c8776e021a7c19` from `cran_packages_by_date` as `registry_expansion`
