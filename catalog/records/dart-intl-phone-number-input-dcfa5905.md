...
<!-- canonical: https://pub.dev/packages/intl_phone_number_input -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/intl_phone_number_input](https://pub.dev/packages/intl_phone_number_input) |
| Source record ids | pub_dev-927d7f9aaeeae5 |

## System Engineer Summary

A simple and customizable flutter package for inputting phone number in intl / international format
uses Google's libphonenumber.

## Operational Role

For a systems engineer, intl_phone_number_input belongs in the Dart inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.5 | 2025-09-19T10:02:48.979345Z | [https://pub.dev/api/packages/intl_phone_number_input](https://pub.dev/api/packages/intl_phone_number_input) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/intl_phone_number_input` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-927d7f9aaeeae5` from `pub_dev` as `registry_expansion`
