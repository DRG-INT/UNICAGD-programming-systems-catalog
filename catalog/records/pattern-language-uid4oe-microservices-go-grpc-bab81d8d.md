...
<!-- canonical: https://github.com/uid4oe/microservices-go-grpc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uid4oe/microservices-go-grpc](https://github.com/uid4oe/microservices-go-grpc) |
| Source record ids | github_search_pattern_language-8a8c7ec540946c |

## System Engineer Summary

Go microservices with REST, and gRPC for demonstrating the BFF pattern. This repository contains
backend services. Everything is dockerized and ready to "Go" :-)

## Operational Role

For a systems engineer, uid4oe/microservices-go-grpc belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-13T09:14:41Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-8a8c7ec540946c` from `github_search_pattern_language` as `registry_expansion`
