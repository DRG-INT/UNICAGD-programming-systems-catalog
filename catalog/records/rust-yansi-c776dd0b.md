...
<!-- canonical: https://crates.io/crates/yansi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/yansi](https://crates.io/crates/yansi) |
| Source record ids | crates_io-463ed245c332a8 |
...
For a systems engineer, yansi belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2024-03-13T07:48:07.624195Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-463ed245c332a8` from `crates_io` as `registry_expansion`
