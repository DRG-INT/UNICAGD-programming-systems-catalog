...
<!-- canonical: https://cran.r-project.org/web/packages/codriver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/codriver/index.html](https://cran.r-project.org/web/packages/codriver/index.html) |
| Source record ids | cran_packages_by_date-fb741d58179488 |
...
For a systems engineer, codriver belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-08 12:20:02 UTC | [https://cran.r-project.org/web/packages/codriver/DESCRIPTION](https://cran.r-project.org/web/packages/codriver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/codriver/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fb741d58179488` from `cran_packages_by_date` as `registry_expansion`
