...
<!-- canonical: https://cran.r-project.org/web/packages/getaca/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/getaca/index.html](https://cran.r-project.org/web/packages/getaca/index.html) |
| Source record ids | cran_packages_by_date-f9a2ef127f6945 |

## System Engineer Summary

Reproducible External Data Dependencies

## Operational Role

For a systems engineer, getaca belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-09-01 14:00:02 UTC | [https://cran.r-project.org/web/packages/getaca/DESCRIPTION](https://cran.r-project.org/web/packages/getaca/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/getaca/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f9a2ef127f6945` from `cran_packages_by_date` as `registry_expansion`
...
| crandep | Dependency Manager | [open](r-crandep-6374b415.md) |
