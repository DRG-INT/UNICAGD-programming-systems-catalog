...
<!-- canonical: https://cran.r-project.org/web/packages/causaldef/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/causaldef/index.html](https://cran.r-project.org/web/packages/causaldef/index.html) |
| Source record ids | cran_packages_by_date-9760acacbec5f8 |

## System Engineer Summary

Decision-Theoretic Causal Diagnostics via Experiment Deficiency

## Operational Role

For a systems engineer, causaldef belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-23 05:10:02 UTC | [https://cran.r-project.org/web/packages/causaldef/DESCRIPTION](https://cran.r-project.org/web/packages/causaldef/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/causaldef/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9760acacbec5f8` from `cran_packages_by_date` as `registry_expansion`
