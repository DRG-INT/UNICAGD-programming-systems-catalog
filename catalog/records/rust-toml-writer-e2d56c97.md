...
<!-- canonical: https://crates.io/crates/toml_writer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/toml_writer](https://crates.io/crates/toml_writer) |
| Source record ids | crates_io-af20638622b298 |
...
For a systems engineer, toml_writer belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2+spec-1.1.0 | 2026-07-14T13:09:46.208101Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-af20638622b298` from `crates_io` as `registry_expansion`
