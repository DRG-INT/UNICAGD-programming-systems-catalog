...
<!-- canonical: https://crates.io/crates/secp256k1-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/secp256k1-sys](https://crates.io/crates/secp256k1-sys) |
| Source record ids | crates_io-20fcaa12399238 |
...
For a systems engineer, secp256k1-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.1 | 2026-08-29T19:42:43.668620Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-20fcaa12399238` from `crates_io` as `registry_expansion`
