...
<!-- canonical: https://github.com/idsc-frazzoli/owl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/idsc-frazzoli/owl](https://github.com/idsc-frazzoli/owl) |
| Source record ids | github_search_space_maps-ffbda35602c806 |
...
For a systems engineer, idsc-frazzoli/owl belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-02-24T07:21:29Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ffbda35602c806` from `github_search_space_maps` as `registry_expansion`
