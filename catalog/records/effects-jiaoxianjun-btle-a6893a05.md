...
<!-- canonical: https://github.com/JiaoXianjun/BTLE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JiaoXianjun/BTLE](https://github.com/JiaoXianjun/BTLE) |
| Source record ids | github_search_effects-7d4e0e602694b9 |

## System Engineer Summary

Bluetooth Low Energy (BLE) packet sniffer and transmitter for both standard and non standard (raw
bit) based on Software Defined Radio (SDR).

## Operational Role

For a systems engineer, JiaoXianjun/BTLE belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-08T19:24:34Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-7d4e0e602694b9` from `github_search_effects` as `registry_expansion`
