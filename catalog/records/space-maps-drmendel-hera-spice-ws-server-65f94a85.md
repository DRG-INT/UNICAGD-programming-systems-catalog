...
<!-- canonical: https://github.com/drmendel/hera_spice_ws_server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drmendel/hera_spice_ws_server](https://github.com/drmendel/hera_spice_ws_server) |
| Source record ids | github_search_space_maps-f0cac8bca48179 |

## System Engineer Summary

A high-performance WebSocket server that streams real-time telemetry and orbital data based on ESA’s
HERA SPICE kernels. It uses a custom binary protocol and keeps its local kernel cache in sync with
ESA’s database, ensuring clients always receive accurate, up-to-date information.

## Operational Role

For a systems engineer, drmendel/hera_spice_ws_server belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-01T11:35:27Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f0cac8bca48179` from `github_search_space_maps` as `registry_expansion`
