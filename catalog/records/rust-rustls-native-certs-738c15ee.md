...
<!-- canonical: https://crates.io/crates/rustls-native-certs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustls-native-certs](https://crates.io/crates/rustls-native-certs) |
| Source record ids | crates_io-d77ab8f0b15c5d |
...
For a systems engineer, rustls-native-certs belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2026-06-01T12:16:09.573832Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-d77ab8f0b15c5d` from `crates_io` as `registry_expansion`
