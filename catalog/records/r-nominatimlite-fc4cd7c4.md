...
<!-- canonical: https://cran.r-project.org/web/packages/nominatimlite/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nominatimlite/index.html](https://cran.r-project.org/web/packages/nominatimlite/index.html) |
| Source record ids | cran_packages_by_date-82caa68363a62e |
...
For a systems engineer, nominatimlite belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-25 11:20:18 UTC | [https://cran.r-project.org/web/packages/nominatimlite/DESCRIPTION](https://cran.r-project.org/web/packages/nominatimlite/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nominatimlite/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-82caa68363a62e` from `cran_packages_by_date` as `registry_expansion`
