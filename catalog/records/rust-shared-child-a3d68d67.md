...
| Canonical URL | [https://crates.io/crates/shared_child](https://crates.io/crates/shared_child) |
| Source record ids | crates_io-0a8e185546cbca |
...
For a systems engineer, shared_child belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-07-04T20:27:30.948512Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-0a8e185546cbca` from `crates_io` as `registry_expansion`
