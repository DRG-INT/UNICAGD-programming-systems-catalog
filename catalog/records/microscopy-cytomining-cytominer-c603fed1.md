...
| Canonical URL | [https://github.com/cytomining/cytominer](https://github.com/cytomining/cytominer) |
| Source record ids | github_search_microscopy-bec9c9877c9f99 |
...
For a systems engineer, cytomining/cytominer belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.2 | 2020-05-09T11:16:56Z | [https://api.github.com/repos/cytomining/cytominer/releases/latest](https://api.github.com/repos/cytomining/cytominer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cytomining/cytominer/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-bec9c9877c9f99` from `github_search_microscopy` as `registry_expansion`
