...
<!-- canonical: https://pypi.org/project/aaiclick/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aaiclick/](https://pypi.org/project/aaiclick/) |
| Source record ids | pypi_simple-abd51394731df3 |
...
For a systems engineer, aaiclick belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.24 | 2026-08-28T20:47:23.579604Z | [https://pypi.org/pypi/aaiclick/json](https://pypi.org/pypi/aaiclick/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aaiclick/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-abd51394731df3` from `pypi_simple` as `registry_expansion`
