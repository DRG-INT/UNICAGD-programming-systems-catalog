...
<!-- canonical: https://packagist.org/packages/php-mock/php-mock-phpunit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-mock/php-mock-phpunit](https://packagist.org/packages/php-mock/php-mock-phpunit) |
| Source record ids | packagist_search-56e7b7c197a799 |

## System Engineer Summary

Mock built-in PHP functions (e.g. time()) with PHPUnit. This package relies on PHP's namespace
fallback policy. No further extension is needed.

## Operational Role

For a systems engineer, php-mock/php-mock-phpunit belongs in the PHP inventory as part of
...
- `packagist_search-56e7b7c197a799` from `packagist_search` as `registry_expansion`
