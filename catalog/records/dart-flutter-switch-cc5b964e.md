...
<!-- canonical: https://pub.dev/packages/flutter_switch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_switch](https://pub.dev/packages/flutter_switch) |
| Source record ids | pub_dev-9f0beaaad1dce4 |

## System Engineer Summary

A custom switch widget that can have a custom height and width, borders, border radius, colors,
toggle size, custom text and icons inside the toggle.

## Operational Role

For a systems engineer, flutter_switch belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2021-06-22T17:10:54.803912Z | [https://pub.dev/api/packages/flutter_switch](https://pub.dev/api/packages/flutter_switch) |  |
| preview | known | 0.3.0-nullsafety.0 | 2021-03-06T08:41:31.202434Z | [https://pub.dev/api/packages/flutter_switch](https://pub.dev/api/packages/flutter_switch) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_switch` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-9f0beaaad1dce4` from `pub_dev` as `registry_expansion`
