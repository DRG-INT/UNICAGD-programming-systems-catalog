...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AutoPrettyPrinting -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AutoPrettyPrinting", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-86b1b85bbd733b` from `julia_general` as `registry_expansion`
