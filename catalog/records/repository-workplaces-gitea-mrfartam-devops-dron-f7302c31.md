...
<!-- canonical: https://gitea.com/Mrfartam/devops_dron -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Mrfartam/devops_dron](https://gitea.com/Mrfartam/devops_dron) |
| Source record ids | gitea_repositories_api-ac92b99fa30472 |
...
For a systems engineer, Gitea: Mrfartam/devops_dron belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-11T13:09:14Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ac92b99fa30472` from `gitea_repositories_api` as `registry_expansion`
