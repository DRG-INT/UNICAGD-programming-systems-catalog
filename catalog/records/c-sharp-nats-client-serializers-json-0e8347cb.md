...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/NATS.Client.Serializers.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/NATS.Client.Serializers.Json](https://www.nuget.org/packages/NATS.Client.Serializers.Json) |
| Source record ids | nuget_search-9e46677a00040e |

## System Engineer Summary

JSON serializer for NATS .NET using System.Text.Json. Supports ad-hoc types for quick prototyping.
Not suitable for native AOT deployments.

## Operational Role

For a systems engineer, NATS.Client.Serializers.Json belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-08-29T00:18:27.363+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nats.client.serializers.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nats.client.serializers.json/index.json) |  |
| preview | known | 3.1.1-preview.1 | 2026-08-07T21:05:04.267+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nats.client.serializers.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nats.client.serializers.json/index.json) |  |
...
| Evidence | GPL-3; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/NATS.Client.Serializers.Json/3.2.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/nats.client.serializers.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-9e46677a00040e` from `nuget_search` as `registry_expansion`
