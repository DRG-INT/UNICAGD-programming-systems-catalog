...
<!-- canonical: https://github.com/O-X-L/ansible-opnsense -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/O-X-L/ansible-opnsense](https://github.com/O-X-L/ansible-opnsense) |
| Source record ids | github_search_maps-f05cd45b8cfd13 |
...
For a systems engineer, O-X-L/ansible-opnsense belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T10:08:37Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f05cd45b8cfd13` from `github_search_maps` as `registry_expansion`
