...
<!-- canonical: https://github.com/commenthol/astronomia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/commenthol/astronomia](https://github.com/commenthol/astronomia) |
| Source record ids | github_search_telescopes-1425933cb4e6da |

## System Engineer Summary

commenthol/astronomia is tracked as a parser lexer ast record in the Telescopes branch. The source
...
For a systems engineer, commenthol/astronomia belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-30T08:12:39Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-1425933cb4e6da` from `github_search_telescopes` as `registry_expansion`
