...
<!-- canonical: https://hackage.haskell.org/package/yesod-bin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yesod-bin](https://hackage.haskell.org/package/yesod-bin) |
| Source record ids | hackage_top_downloads-509c54956f7ef9 |
...
For a systems engineer, yesod-bin belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.2.4 | 2026-06-16T20:34:33Z | [https://hackage.haskell.org/package/yesod-bin](https://hackage.haskell.org/package/yesod-bin) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yesod-bin` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-509c54956f7ef9` from `hackage_top_downloads` as `registry_expansion`
