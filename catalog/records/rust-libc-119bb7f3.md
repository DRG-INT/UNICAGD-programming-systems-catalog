...
<!-- canonical: https://crates.io/crates/libc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libc](https://crates.io/crates/libc) |
| Source record ids | crates_io-a98421161457cf |
...
For a systems engineer, libc belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.189 | 2026-08-03T19:15:03.301727Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-a98421161457cf` from `crates_io` as `registry_expansion`
