...
<!-- canonical: https://cran.r-project.org/web/packages/GLSME/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GLSME/index.html](https://cran.r-project.org/web/packages/GLSME/index.html) |
| Source record ids | cran_packages_by_date-66d596f49b7261 |
...
For a systems engineer, GLSME belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2026-08-21 05:46:39 UTC | [https://cran.r-project.org/web/packages/GLSME/DESCRIPTION](https://cran.r-project.org/web/packages/GLSME/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GLSME/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-66d596f49b7261` from `cran_packages_by_date` as `registry_expansion`
