...
| Canonical URL | [https://github.com/TEN-framework/ten-framework](https://github.com/TEN-framework/ten-framework) |
| Source record ids | github_search_video-ad6ed71e1edc43 |
...
For a systems engineer, TEN-framework/ten-framework belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.71 | 2026-07-31T10:33:17Z | [https://api.github.com/repos/TEN-framework/ten-framework/releases/latest](https://api.github.com/repos/TEN-framework/ten-framework/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/TEN-framework/ten-framework/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-ad6ed71e1edc43` from `github_search_video` as `registry_expansion`
