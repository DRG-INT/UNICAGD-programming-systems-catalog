...
<!-- canonical: https://cran.r-project.org/web/packages/qrcm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qrcm/index.html](https://cran.r-project.org/web/packages/qrcm/index.html) |
| Source record ids | cran_packages_by_date-d5da00fde50926 |
...
For a systems engineer, qrcm belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4 | 2026-09-08 13:20:02 UTC | [https://cran.r-project.org/web/packages/qrcm/DESCRIPTION](https://cran.r-project.org/web/packages/qrcm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qrcm/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-d5da00fde50926` from `cran_packages_by_date` as `registry_expansion`
