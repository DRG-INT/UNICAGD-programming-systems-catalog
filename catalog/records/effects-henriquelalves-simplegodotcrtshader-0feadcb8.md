...
<!-- canonical: https://github.com/henriquelalves/SimpleGodotCRTShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/henriquelalves/SimpleGodotCRTShader](https://github.com/henriquelalves/SimpleGodotCRTShader) |
| Source record ids | github_search_effects-a70b7843912f75 |
...
For a systems engineer, henriquelalves/SimpleGodotCRTShader belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-02T21:57:23Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a70b7843912f75` from `github_search_effects` as `registry_expansion`
