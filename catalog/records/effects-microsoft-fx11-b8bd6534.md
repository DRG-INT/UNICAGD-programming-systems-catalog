...
<!-- canonical: https://github.com/microsoft/FX11 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/FX11](https://github.com/microsoft/FX11) |
| Source record ids | github_search_effects-6fc1cb3a2e1434 |

## System Engineer Summary

Effects for Direct3D 11 (FX11) is a management runtime for authoring HLSL shaders, render state, and
runtime variables together.

## Operational Role

For a systems engineer, microsoft/FX11 belongs in the Effects inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-19T00:06:55Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6fc1cb3a2e1434` from `github_search_effects` as `registry_expansion`
...
| Token-Gremlin/natural-disasters | Interpreter Runtime | [open](effects-token-gremlin-natural-disasters-2d908dd9.md) |
