...
<!-- canonical: https://crates.io/crates/borsh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/borsh](https://crates.io/crates/borsh) |
| Source record ids | crates_io-ee8e80ba3e2245 |
...
For a systems engineer, borsh belongs in the Rust inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.1 | 2026-08-26T20:58:11.161301Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-ee8e80ba3e2245` from `crates_io` as `registry_expansion`
