...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/pushery/sqlens-for-laravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pushery/sqlens-for-laravel](https://packagist.org/packages/pushery/sqlens-for-laravel) |
| Source record ids | packagist_search-d271339fd42e9f |

## System Engineer Summary

SQLens — database safety toolkit for Laravel. It lints pending migrations for lock and downtime risk
and audits the live schema, on PostgreSQL and MySQL.

## Operational Role

For a systems engineer, pushery/sqlens-for-laravel belongs in the PHP inventory as part of static
feedback, style policy, defect prevention, and local/CI quality gates.
...
- `packagist_search-d271339fd42e9f` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| seld/jsonlint | Linter | [open](php-seld-jsonlint-ca4a9cd2.md) |
