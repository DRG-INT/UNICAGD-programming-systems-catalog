...
| Source record ids | corpus-42dd47eb519176 |

## System Engineer Summary

yaml-cpp is tracked as a serialization record in the C++23 branch. The source did not provide a long
...
For a systems engineer, yaml-cpp belongs in the C++23 inventory as part of wire formats,
...
- `corpus-42dd47eb519176` from `master_json` as `serialization`
