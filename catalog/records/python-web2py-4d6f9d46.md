...
| Canonical URL | [https://pypi.org/project/web2py/](https://pypi.org/project/web2py/) |
| Source record ids | corpus-4f431dc9b448ae |

## System Engineer Summary

full-stack framework for rapid development and prototyping of secure database-driven web-based
applications, written and programmable in Python.

## Operational Role

For a systems engineer, web2py belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2012-10-15T19:44:28.753245Z | [https://pypi.org/pypi/web2py/json](https://pypi.org/pypi/web2py/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/web2py/json` at `2026-09-01T02:13:00+00:00`.
...
- `corpus-4f431dc9b448ae` from `master_json` as `web_framework`
