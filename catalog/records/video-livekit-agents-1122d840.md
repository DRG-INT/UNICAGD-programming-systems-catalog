...
| Canonical URL | [https://github.com/livekit/agents](https://github.com/livekit/agents) |
| Source record ids | github_search_video-090069cabcbd8f |
...
For a systems engineer, livekit/agents belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | livekit-agents@1.7.1 | 2026-08-27T03:42:44Z | [https://api.github.com/repos/livekit/agents/releases/latest](https://api.github.com/repos/livekit/agents/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/livekit/agents/releases/latest` at `2026-09-01T09:23:24+00:00`.
...
- `github_search_video-090069cabcbd8f` from `github_search_video` as `registry_expansion`
