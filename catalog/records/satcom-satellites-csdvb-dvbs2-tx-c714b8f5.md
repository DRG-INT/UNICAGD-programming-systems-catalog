...
<!-- canonical: https://github.com/csdvb/dvbs2_tx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/csdvb/dvbs2_tx](https://github.com/csdvb/dvbs2_tx) |
| Source record ids | github_search_satcom_satellites-608889f1f6f573 |

## System Engineer Summary

Nexø DVB-S2 transmitter application

## Operational Role

For a systems engineer, csdvb/dvbs2_tx belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-14T20:47:16Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-608889f1f6f573` from `github_search_satcom_satellites` as `registry_expansion`
