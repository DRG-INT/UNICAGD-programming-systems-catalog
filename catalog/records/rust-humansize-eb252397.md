...
<!-- canonical: https://crates.io/crates/humansize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/humansize](https://crates.io/crates/humansize) |
| Source record ids | crates_io-9c2cd159305d63 |
...
For a systems engineer, humansize belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2022-12-31T12:31:58.698587Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-9c2cd159305d63` from `crates_io` as `registry_expansion`
