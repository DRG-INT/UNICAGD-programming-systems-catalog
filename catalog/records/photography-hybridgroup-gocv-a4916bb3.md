...
<!-- canonical: https://github.com/hybridgroup/gocv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hybridgroup/gocv](https://github.com/hybridgroup/gocv) |
| Source record ids | github_search_photography-5fda20c259ad2a |

## System Engineer Summary

Go package for computer vision using OpenCV 4 and beyond. Includes support for DNN, CUDA, OpenCV
Contrib, and OpenVINO.

## Operational Role

For a systems engineer, hybridgroup/gocv belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T08:16:03Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-5fda20c259ad2a` from `github_search_photography` as `registry_expansion`
