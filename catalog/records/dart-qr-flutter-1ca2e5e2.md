...
<!-- canonical: https://pub.dev/packages/qr_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/qr_flutter](https://pub.dev/packages/qr_flutter) |
| Source record ids | pub_dev-a8644494ccf192 |
...
For a systems engineer, qr_flutter belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2023-05-14T17:48:40.350369Z | [https://pub.dev/api/packages/qr_flutter](https://pub.dev/api/packages/qr_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/qr_flutter` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-a8644494ccf192` from `pub_dev` as `registry_expansion`
