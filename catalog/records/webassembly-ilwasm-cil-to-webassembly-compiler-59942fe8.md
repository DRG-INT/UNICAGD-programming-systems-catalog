...
<!-- canonical: https://github.com/kg/ilwasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kg/ilwasm](https://github.com/kg/ilwasm) |
| Source record ids | awesome_list-3c19c8c836be11 |

## System Engineer Summary

ilwasm - CIL to WebAssembly compiler is tracked as a compiler record in the WebAssembly branch. The
...
For a systems engineer, ilwasm - CIL to WebAssembly compiler belongs in the WebAssembly inventory as
...
- `awesome_list-3c19c8c836be11` from `awesome_list` as `registry_expansion`
