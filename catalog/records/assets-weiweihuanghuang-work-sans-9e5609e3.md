...
| Source record ids | github_search_assets-106a269df0f38d |

## System Engineer Summary

weiweihuanghuang/Work-Sans is tracked as a library record in the Assets branch. The source did not
...
For a systems engineer, weiweihuanghuang/Work-Sans belongs in the Assets inventory as part of
...
- `github_search_assets-106a269df0f38d` from `github_search_assets` as `registry_expansion`
