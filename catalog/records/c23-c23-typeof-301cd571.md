...
| Source record ids | corpus-f909ba173170a8 |

## System Engineer Summary

C23 typeof is tracked as a language specification record in the C23 branch. The source did not
...
For a systems engineer, C23 typeof belongs in the C23 inventory as part of ecosystem capability
...
- `corpus-f909ba173170a8` from `master_json` as `language_specification`
