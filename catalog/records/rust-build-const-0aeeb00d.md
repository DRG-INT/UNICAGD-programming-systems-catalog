...
| Canonical URL | [https://crates.io/crates/build_const](https://crates.io/crates/build_const) |
| Source record ids | crates_io-d58cf10a08420a |
...
For a systems engineer, build_const belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2021-04-20T02:31:13.785806Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-d58cf10a08420a` from `crates_io` as `registry_expansion`
