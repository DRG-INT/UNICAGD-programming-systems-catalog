...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/delba/SwiftyOAuth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/delba/SwiftyOAuth](https://github.com/delba/SwiftyOAuth) |
| Source record ids | awesome_list-765d401e614bc8 |
...
For a systems engineer, SwiftyOAuth belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.3 | 2016-05-26T16:17:39Z | [https://api.github.com/repos/delba/SwiftyOAuth/releases/latest](https://api.github.com/repos/delba/SwiftyOAuth/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/delba/SwiftyOAuth/releases/latest` at `2026-09-01T07:24:07+00:00`.
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Authentication", "source_url": "https://raw.githubusercontent.com/vsouza/awesome-ios/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-765d401e614bc8` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Apple Review Guidelines | Ide Editor Integration | [open](cocoa-apple-review-guidelines-d06165e6.md) |
| ARVideoKit | Ide Editor Integration | [open](cocoa-arvideokit-9a0f973d.md) |
| AuroraEditor/AuroraEditor | Ide Editor Integration | [open](cocoa-auroraeditor-auroraeditor-43b28791.md) |
| coteditor/CotEditor | Ide Editor Integration | [open](cocoa-coteditor-coteditor-061a819f.md) |
| edgar-zigis/CocoaTextField | Ide Editor Integration | [open](cocoa-edgar-zigis-cocoatextfield-8587dd05.md) |
| Embrace | Ide Editor Integration | [open](cocoa-embrace-ced14cf1.md) |
| fespinoza/LinkedIdeas | Ide Editor Integration | [open](cocoa-fespinoza-linkedideas-cf83dabc.md) |
| Instabug | Ide Editor Integration | [open](cocoa-instabug-8cb52c94.md) |
