...
| Canonical URL | [https://luarocks.org/modules/danini-the-panini/kdlua](https://luarocks.org/modules/danini-the-panini/kdlua) |
| Source record ids | luarocks_root_manifest-dfc3d8c59671f1 |

## System Engineer Summary

kdlua is tracked as a language specification record in the Lua family branch. The source did not
...
For a systems engineer, kdlua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-dfc3d8c59671f1` from `luarocks_root_manifest` as `registry_expansion`
