...
<!-- canonical: https://gitlab.com/cznic/libc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/cznic/libc](https://gitlab.com/cznic/libc) |
| Source record ids | gitlab_projects_api-7b709023a7c4ab |

## System Engineer Summary

Package libc provides C-runtime services.

## Operational Role

For a systems engineer, cznic/libc belongs in the Repository Workplaces inventory as part of runtime
...
- `gitlab_projects_api-7b709023a7c4ab` from `gitlab_projects_api` as `registry_expansion`
