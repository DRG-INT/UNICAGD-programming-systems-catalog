...
<!-- canonical: https://pypi.org/project/ade-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ade-cli/](https://pypi.org/project/ade-cli/) |
| Source record ids | pypi_simple-108afba5fcb584 |
...
For a systems engineer, ade-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.1 | 2019-09-27T17:06:54.300292Z | [https://pypi.org/pypi/ade-cli/json](https://pypi.org/pypi/ade-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ade-cli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-108afba5fcb584` from `pypi_simple` as `registry_expansion`
