...
<!-- canonical: https://cran.r-project.org/web/packages/funcml/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/funcml/index.html](https://cran.r-project.org/web/packages/funcml/index.html) |
| Source record ids | cran_packages_by_date-56961ef2d4cb5b |
...
For a systems engineer, funcml belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-22 15:10:24 UTC | [https://cran.r-project.org/web/packages/funcml/DESCRIPTION](https://cran.r-project.org/web/packages/funcml/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/funcml/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-56961ef2d4cb5b` from `cran_packages_by_date` as `registry_expansion`
