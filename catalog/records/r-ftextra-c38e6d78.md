...
<!-- canonical: https://cran.r-project.org/web/packages/ftExtra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ftExtra/index.html](https://cran.r-project.org/web/packages/ftExtra/index.html) |
| Source record ids | cran_packages_by_date-fc76b2334d1089 |
...
For a systems engineer, ftExtra belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-09-16 02:30:13 UTC | [https://cran.r-project.org/web/packages/ftExtra/DESCRIPTION](https://cran.r-project.org/web/packages/ftExtra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ftExtra/DESCRIPTION` at `2026-09-16T03:20:38+00:00`.
...
- `cran_packages_by_date-fc76b2334d1089` from `cran_packages_by_date` as `registry_expansion`
