...
<!-- canonical: https://github.com/pckbls/pulseviz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pckbls/pulseviz](https://github.com/pckbls/pulseviz) |
| Source record ids | github_search_electromagnetoscopes-e08952914b00a3 |

## System Engineer Summary

Audio visualizer for PulseAudio written in C++11

## Operational Role

For a systems engineer, pckbls/pulseviz belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-06T20:37:17Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-e08952914b00a3` from `github_search_electromagnetoscopes` as `registry_expansion`
