...
<!-- canonical: https://github.com/manipuladordedados/pdiary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/manipuladordedados/pdiary](https://github.com/manipuladordedados/pdiary) |
| Source record ids | github_search_magazines-da0db831233fe6 |
...
For a systems engineer, manipuladordedados/pdiary belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-12T07:47:36Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-da0db831233fe6` from `github_search_magazines` as `registry_expansion`
