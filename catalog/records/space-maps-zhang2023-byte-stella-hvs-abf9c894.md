...
<!-- canonical: https://github.com/zhang2023-byte/stella-hvs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhang2023-byte/stella-hvs](https://github.com/zhang2023-byte/stella-hvs) |
| Source record ids | github_search_space_maps-b60548703bbb51 |

## System Engineer Summary

An AI-assisted research infrastructure for high-velocity star literature, catalog curation, and
dynamical analysis.

## Operational Role

For a systems engineer, zhang2023-byte/stella-hvs belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T15:24:23Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b60548703bbb51` from `github_search_space_maps` as `registry_expansion`
