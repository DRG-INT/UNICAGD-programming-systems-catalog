...
<!-- canonical: https://github.com/snwh/paper-icon-theme -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/snwh/paper-icon-theme](https://github.com/snwh/paper-icon-theme) |
| Source record ids | github_search_icons_and_logos-85b5e80e689733 |

## System Engineer Summary

snwh/paper-icon-theme is tracked as a library record in the Icons and Logos branch. The source did
...
For a systems engineer, snwh/paper-icon-theme belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-03-13T21:40:32Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-85b5e80e689733` from `github_search_icons_and_logos` as `registry_expansion`
