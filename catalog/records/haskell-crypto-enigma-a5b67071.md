...
<!-- canonical: https://hackage.haskell.org/package/crypto-enigma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/crypto-enigma](https://hackage.haskell.org/package/crypto-enigma) |
| Source record ids | hackage_top_downloads-3d37ff7faa6ac6 |
...
For a systems engineer, crypto-enigma belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.6 | 2019-10-09T15:08:31Z | [https://hackage.haskell.org/package/crypto-enigma](https://hackage.haskell.org/package/crypto-enigma) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/crypto-enigma` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-3d37ff7faa6ac6` from `hackage_top_downloads` as `registry_expansion`
