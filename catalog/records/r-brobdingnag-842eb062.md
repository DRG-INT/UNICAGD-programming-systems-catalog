...
<!-- canonical: https://cran.r-project.org/web/packages/Brobdingnag/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Brobdingnag/index.html](https://cran.r-project.org/web/packages/Brobdingnag/index.html) |
| Source record ids | cran_packages_by_date-17c1cc1b248f6b |

## System Engineer Summary

Brobdingnag is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, Brobdingnag belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3-1 | 2026-09-12 21:30:02 UTC | [https://cran.r-project.org/web/packages/Brobdingnag/DESCRIPTION](https://cran.r-project.org/web/packages/Brobdingnag/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Brobdingnag/DESCRIPTION` at `2026-09-12T23:18:05+00:00`.
...
- `cran_packages_by_date-17c1cc1b248f6b` from `cran_packages_by_date` as `registry_expansion`
