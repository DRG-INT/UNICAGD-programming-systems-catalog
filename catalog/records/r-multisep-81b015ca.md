...
<!-- canonical: https://cran.r-project.org/web/packages/MultiSEp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MultiSEp/index.html](https://cran.r-project.org/web/packages/MultiSEp/index.html) |
| Source record ids | cran_packages_by_date-4af3f999e33830 |

## System Engineer Summary

Predict Synthetic Lethality and Other Gene Dependency Relationships from Multiomics Data

## Operational Role

For a systems engineer, MultiSEp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.3 | 2026-08-27 10:30:02 UTC | [https://cran.r-project.org/web/packages/MultiSEp/DESCRIPTION](https://cran.r-project.org/web/packages/MultiSEp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MultiSEp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4af3f999e33830` from `cran_packages_by_date` as `registry_expansion`
