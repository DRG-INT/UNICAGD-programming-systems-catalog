...
<!-- canonical: https://github.com/threedle/text2mesh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/threedle/text2mesh](https://github.com/threedle/text2mesh) |
| Source record ids | github_search_computer_graphics_software-031bf0d167340a |
...
For a systems engineer, threedle/text2mesh belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-031bf0d167340a` from `github_search_computer_graphics_software` as `registry_expansion`
