...
| Canonical URL | [https://crates.io/crates/peg-runtime](https://crates.io/crates/peg-runtime) |
| Source record ids | crates_io-ab5761409ae652 |
...
For a systems engineer, peg-runtime belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.6 | 2026-05-04T21:03:45.816606Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-ab5761409ae652` from `crates_io` as `registry_expansion`
