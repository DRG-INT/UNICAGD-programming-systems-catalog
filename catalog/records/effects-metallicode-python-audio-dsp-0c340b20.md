...
<!-- canonical: https://github.com/Metallicode/python_audio_dsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Metallicode/python_audio_dsp](https://github.com/Metallicode/python_audio_dsp) |
| Source record ids | github_search_effects-c1eb8cd5376cca |
...
For a systems engineer, Metallicode/python_audio_dsp belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-20T15:57:53Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-c1eb8cd5376cca` from `github_search_effects` as `registry_expansion`
