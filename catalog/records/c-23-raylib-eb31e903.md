...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Game Engine Game Dev](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/game-engine-game-dev.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | game_engine_game_dev |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-c81f34143e3419 |

## System Engineer Summary

raylib is tracked as a game engine game dev record in the C++23 branch. The source did not provide a
...
For a systems engineer, raylib belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-c81f34143e3419` from `master_json` as `game_engine_game_dev`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bgfx | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-bgfx-c557d27d.md) |
| EnTT | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-entt-4da08a92.md) |
| Unreal Engine | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-unreal-engine-e87cdf5c.md) |
