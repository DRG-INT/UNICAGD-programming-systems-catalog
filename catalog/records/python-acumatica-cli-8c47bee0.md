...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/acumatica-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acumatica-cli/](https://pypi.org/project/acumatica-cli/) |
| Source record ids | pypi_simple-2f0d75089e42a3 |

## System Engineer Summary

Acumatica ERP Config-as-Code: tenant provisioning, baseline config, and reference data

## Operational Role

For a systems engineer, acumatica-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.2 | 2026-08-20T22:26:52.173855Z | [https://pypi.org/pypi/acumatica-cli/json](https://pypi.org/pypi/acumatica-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acumatica-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-2f0d75089e42a3` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0latency-cli | Cli | [open](python-0latency-cli-5fe7ae21.md) |
| 0xlog-cli | Cli | [open](python-0xlog-cli-3fed72d8.md) |
| 100cli | Cli | [open](python-100cli-b49971ec.md) |
| 10xscale-agentflow-cli | Cli | [open](python-10xscale-agentflow-cli-a2a4d2c3.md) |
| 1password-cli | Cli | [open](python-1password-cli-509376c1.md) |
| 2048-cli | Cli | [open](python-2048-cli-430abf2d.md) |
| 2cli | Cli | [open](python-2cli-94ee9a2f.md) |
| 32r4-cli-demo | Cli | [open](python-32r4-cli-demo-7bac3e2e.md) |
