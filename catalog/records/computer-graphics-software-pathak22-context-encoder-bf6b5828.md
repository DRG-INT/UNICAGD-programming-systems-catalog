...
<!-- canonical: https://github.com/pathak22/context-encoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pathak22/context-encoder](https://github.com/pathak22/context-encoder) |
| Source record ids | github_search_computer_graphics_software-0931a672e6a4fb |
...
For a systems engineer, pathak22/context-encoder belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-0931a672e6a4fb` from `github_search_computer_graphics_software` as `registry_expansion`
