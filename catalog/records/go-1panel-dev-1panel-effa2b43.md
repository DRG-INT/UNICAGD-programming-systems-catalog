...
<!-- canonical: https://github.com/1Panel-dev/1Panel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/1Panel-dev/1Panel](https://github.com/1Panel-dev/1Panel) |
| Source record ids | github_search_go-39c77863ee931f |

## System Engineer Summary

🔥 1Panel is a modern, open-source Linux server management panel and a lightweight AI management
platform.

## Operational Role

For a systems engineer, 1Panel-dev/1Panel belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T15:40:00Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-39c77863ee931f` from `github_search_go` as `registry_expansion`
