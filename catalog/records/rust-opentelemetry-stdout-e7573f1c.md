...
| Canonical URL | [https://crates.io/crates/opentelemetry-stdout](https://crates.io/crates/opentelemetry-stdout) |
| Source record ids | crates_io-8641032e057ec3 |
...
For a systems engineer, opentelemetry-stdout belongs in the Rust inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.0 | 2026-05-09T00:00:41.359312Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-8641032e057ec3` from `crates_io` as `registry_expansion`
