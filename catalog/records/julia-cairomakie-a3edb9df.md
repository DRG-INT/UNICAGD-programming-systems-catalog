...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CairoMakie](https://github.com/JuliaRegistries/General/tree/master/C/CairoMakie) |
| Source record ids | julia_general-d4b2a75f4190ee |

## System Engineer Summary

Julia package registered in General at C/CairoMakie.

## Operational Role

For a systems engineer, CairoMakie belongs in the Julia inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CairoMakie", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d4b2a75f4190ee` from `julia_general` as `registry_expansion`
