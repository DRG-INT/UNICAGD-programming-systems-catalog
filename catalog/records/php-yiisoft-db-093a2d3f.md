...
<!-- canonical: https://packagist.org/packages/yiisoft/db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yiisoft/db](https://packagist.org/packages/yiisoft/db) |
| Source record ids | packagist_search-8807658110f8a0 |
...
For a systems engineer, yiisoft/db belongs in the PHP inventory as part of build graph control,
...
- `packagist_search-8807658110f8a0` from `packagist_search` as `registry_expansion`
