...
<!-- canonical: https://github.com/weaviate/weaviate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/weaviate/weaviate](https://github.com/weaviate/weaviate) |
| Source record ids | github_search_databases-86771cb9bdd8e5 |
...
For a systems engineer, weaviate/weaviate belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:24:07Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-86771cb9bdd8e5` from `github_search_databases` as `registry_expansion`
