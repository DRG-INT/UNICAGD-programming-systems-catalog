...
| Canonical URL | [https://jsonlines.org/](https://jsonlines.org/) |
| Source record ids | curated_database_systems-f50e2f68b44052 |

## System Engineer Summary

Line-delimited JSON records for logs, streaming, and batch interchange.

## Operational Role

For a systems engineer, JSON Lines belongs in the Databases inventory as part of wire formats,
...
- `curated_database_systems-f50e2f68b44052` from `curated_database_systems` as `registry_expansion`
...
| CSV | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-csv-8eb9b7a8.md) |
