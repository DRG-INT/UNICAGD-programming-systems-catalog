...
| Canonical URL | [https://luarocks.org/modules/jonasgeiler/fenster](https://luarocks.org/modules/jonasgeiler/fenster) |
| Source record ids | luarocks_root_manifest-369c1a6a4a7ffd |
...
For a systems engineer, lua-fenster belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-369c1a6a4a7ffd` from `luarocks_root_manifest` as `registry_expansion`
