...
<!-- canonical: https://crates.io/crates/time-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/time-macros](https://crates.io/crates/time-macros) |
| Source record ids | crates_io-067484f74b101c |

## System Engineer Summary

Procedural macros for the time crate. This crate is an implementation detail and should not be
relied upon directly.

## Operational Role

For a systems engineer, time-macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.32 | 2026-07-20T08:27:37.909264Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-067484f74b101c` from `crates_io` as `registry_expansion`
