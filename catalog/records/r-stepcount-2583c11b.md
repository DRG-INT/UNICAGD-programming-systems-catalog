...
<!-- canonical: https://cran.r-project.org/web/packages/stepcount/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stepcount/index.html](https://cran.r-project.org/web/packages/stepcount/index.html) |
| Source record ids | cran_packages_by_date-84aba603066200 |
...
For a systems engineer, stepcount belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-21 16:00:02 UTC | [https://cran.r-project.org/web/packages/stepcount/DESCRIPTION](https://cran.r-project.org/web/packages/stepcount/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stepcount/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-84aba603066200` from `cran_packages_by_date` as `registry_expansion`
