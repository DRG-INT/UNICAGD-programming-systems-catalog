...
<!-- canonical: https://packagist.org/packages/kreait/laravel-firebase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kreait/laravel-firebase](https://packagist.org/packages/kreait/laravel-firebase) |
| Source record ids | packagist_search-73fdaac804ec09 |
...
For a systems engineer, kreait/laravel-firebase belongs in the PHP inventory as part of state
...
- `packagist_search-73fdaac804ec09` from `packagist_search` as `registry_expansion`
