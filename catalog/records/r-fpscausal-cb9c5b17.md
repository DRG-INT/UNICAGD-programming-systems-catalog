...
<!-- canonical: https://cran.r-project.org/web/packages/FPScausal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FPScausal/index.html](https://cran.r-project.org/web/packages/FPScausal/index.html) |
| Source record ids | cran_packages_by_date-82d48a54131552 |
...
For a systems engineer, FPScausal belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-23 10:20:02 UTC | [https://cran.r-project.org/web/packages/FPScausal/DESCRIPTION](https://cran.r-project.org/web/packages/FPScausal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FPScausal/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-82d48a54131552` from `cran_packages_by_date` as `registry_expansion`
