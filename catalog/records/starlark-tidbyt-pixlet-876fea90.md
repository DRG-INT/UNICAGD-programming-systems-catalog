...
| Canonical URL | [https://github.com/tidbyt/pixlet](https://github.com/tidbyt/pixlet) |
| Source record ids | github_search_starlark-e8fa749f3244f4 |
...
For a systems engineer, tidbyt/pixlet belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.34.0 | 2024-09-30T19:21:03Z | [https://api.github.com/repos/tidbyt/pixlet/releases/latest](https://api.github.com/repos/tidbyt/pixlet/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tidbyt/pixlet/releases/latest` at `2026-09-01T09:23:07+00:00`.
...
- `github_search_starlark-e8fa749f3244f4` from `github_search_starlark` as `registry_expansion`
