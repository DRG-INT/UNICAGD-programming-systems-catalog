...
<!-- canonical: https://cran.r-project.org/web/packages/favr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/favr/index.html](https://cran.r-project.org/web/packages/favr/index.html) |
| Source record ids | cran_packages_by_date-cace1416c0c2dd |
...
For a systems engineer, favr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-20 14:10:28 UTC | [https://cran.r-project.org/web/packages/favr/DESCRIPTION](https://cran.r-project.org/web/packages/favr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/favr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cace1416c0c2dd` from `cran_packages_by_date` as `registry_expansion`
...
| tesseract | Game Engine Game Dev | [open](r-tesseract-f9b18384.md) |
| transferegovr | Game Engine Game Dev | [open](r-transferegovr-48135f9d.md) |
| VancouvR | Game Engine Game Dev | [open](r-vancouvr-24ec8c20.md) |
