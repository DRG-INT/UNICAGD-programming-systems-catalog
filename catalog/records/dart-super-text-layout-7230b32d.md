...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/super_text_layout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/super_text_layout](https://pub.dev/packages/super_text_layout) |
| Source record ids | pub_dev-631be31e89e15c |
...
For a systems engineer, super_text_layout belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.21 | 2026-06-12T06:14:31.854892Z | [https://pub.dev/api/packages/super_text_layout](https://pub.dev/api/packages/super_text_layout) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/super_text_layout` at `2026-09-01T16:41:10+00:00`.
...
- `pub_dev-631be31e89e15c` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| app_settings | Configuration | [open](dart-app-settings-349b8e3c.md) |
| csv | Configuration | [open](dart-csv-ced97579.md) |
| firebase_remote_config | Configuration | [open](dart-firebase-remote-config-e1fb45c5.md) |
| flutter_dotenv | Configuration | [open](dart-flutter-dotenv-532a6d01.md) |
| open_settings_plus | Configuration | [open](dart-open-settings-plus-4bea84df.md) |
