...
<!-- canonical: https://github.com/marinho/godot-visual-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marinho/godot-visual-effects](https://github.com/marinho/godot-visual-effects) |
| Source record ids | github_search_effects-0ac2885f99561c |
...
For a systems engineer, marinho/godot-visual-effects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-01T12:51:46Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0ac2885f99561c` from `github_search_effects` as `registry_expansion`
