...
<!-- canonical: https://github.com/shangeth/wavencoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shangeth/wavencoder](https://github.com/shangeth/wavencoder) |
| Source record ids | github_search_audio-c9505a1ec329b8 |

## System Engineer Summary

WavEncoder is a Python library for encoding audio signals, transforms for audio augmentation, and
training audio classification models with PyTorch backend.

## Operational Role

For a systems engineer, shangeth/wavencoder belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-06-06T12:32:20Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-c9505a1ec329b8` from `github_search_audio` as `registry_expansion`
