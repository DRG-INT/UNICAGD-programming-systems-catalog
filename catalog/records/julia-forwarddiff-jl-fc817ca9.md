...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/F/ForwardDiff](https://github.com/JuliaRegistries/General/tree/master/F/ForwardDiff) |
| Source record ids | corpus-521efd10d9416a |

## System Engineer Summary

ForwardDiff.jl is tracked as a math numeric scientific record in the Julia branch. The source did
...
For a systems engineer, ForwardDiff.jl belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.4.5 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/F/ForwardDiff/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/F/ForwardDiff/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-521efd10d9416a` from `master_json` as `math_numeric_scientific`
