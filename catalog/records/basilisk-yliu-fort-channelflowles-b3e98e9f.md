...
<!-- canonical: https://github.com/yliu-fort/ChannelFlowLES -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yliu-fort/ChannelFlowLES](https://github.com/yliu-fort/ChannelFlowLES) |
| Source record ids | github_search_basilisk-087e3fa2c4bf3e |

## System Engineer Summary

Turbulent channel flow LES simulation in Basilisk.

## Operational Role

For a systems engineer, yliu-fort/ChannelFlowLES belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-21T00:34:37Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-087e3fa2c4bf3e` from `github_search_basilisk` as `registry_expansion`
