...
<!-- canonical: https://crates.io/crates/aws-smithy-types -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.3 | 2026-09-03T18:37:02.842212Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-03T20:18:32+00:00`.
...
- `crates_io-775f8f44724e6e` from `crates_io` as `registry_expansion`
