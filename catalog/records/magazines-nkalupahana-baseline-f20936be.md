...
<!-- canonical: https://github.com/nkalupahana/baseline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nkalupahana/baseline](https://github.com/nkalupahana/baseline) |
| Source record ids | github_search_magazines-3129b4177f2b12 |
...
For a systems engineer, nkalupahana/baseline belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T05:28:08Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-3129b4177f2b12` from `github_search_magazines` as `registry_expansion`
