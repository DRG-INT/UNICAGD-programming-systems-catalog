...
| Canonical URL | [https://github.com/katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) |
| Source record ids | github_search_audio-95b4abbbb7e0d8 |

## System Engineer Summary

katspaugh/wavesurfer.js is tracked as an image audio dsp record in the Audio branch. The source did
...
For a systems engineer, katspaugh/wavesurfer.js belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0-beta.3 | 2026-08-21T11:58:22Z | [https://api.github.com/repos/katspaugh/wavesurfer.js/releases/latest](https://api.github.com/repos/katspaugh/wavesurfer.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/katspaugh/wavesurfer.js/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-95b4abbbb7e0d8` from `github_search_audio` as `registry_expansion`
...
| cycfi/q | Image Audio Dsp | [open](audio-cycfi-q-42b5713b.md) |
| DISTRHO/Cardinal | Image Audio Dsp | [open](audio-distrho-cardinal-52b559a2.md) |
| DistroAV/DistroAV | Image Audio Dsp | [open](audio-distroav-distroav-0b30296c.md) |
| Faust | Image Audio Dsp | [open](audio-faust-5ea678fe.md) |
