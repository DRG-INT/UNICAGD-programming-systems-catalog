...
<!-- canonical: https://pub.dev/packages/mobx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mobx](https://pub.dev/packages/mobx) |
| Source record ids | pub_dev-9dc7a7eb0e440f |
...
For a systems engineer, mobx belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.1 | 2026-08-20T14:57:54.114670Z | [https://pub.dev/api/packages/mobx](https://pub.dev/api/packages/mobx) |  |
| preview | known | 2.0.0-nullsafety.6 | 2021-03-29T03:22:06.849481Z | [https://pub.dev/api/packages/mobx](https://pub.dev/api/packages/mobx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mobx` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-9dc7a7eb0e440f` from `pub_dev` as `registry_expansion`
