...
<!-- canonical: https://crates.io/crates/gix-date -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gix-date](https://crates.io/crates/gix-date) |
| Source record ids | crates_io-93e471de3042b8 |
...
For a systems engineer, gix-date belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-08-22T19:00:21.777907Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-93e471de3042b8` from `crates_io` as `registry_expansion`
