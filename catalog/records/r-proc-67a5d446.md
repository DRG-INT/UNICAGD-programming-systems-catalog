...
<!-- canonical: https://cran.r-project.org/web/packages/pROC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pROC/index.html](https://cran.r-project.org/web/packages/pROC/index.html) |
| Source record ids | cran_packages_by_date-df537f34a1ee78 |
...
For a systems engineer, pROC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.1 | 2026-08-27 10:00:02 UTC | [https://cran.r-project.org/web/packages/pROC/DESCRIPTION](https://cran.r-project.org/web/packages/pROC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pROC/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-df537f34a1ee78` from `cran_packages_by_date` as `registry_expansion`
