...
<!-- canonical: https://github.com/mgp25/RF-List -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mgp25/RF-List](https://github.com/mgp25/RF-List) |
| Source record ids | github_search_satcom_satellites-5a15e8d77b447c |

## System Engineer Summary

mgp25/RF-List is tracked as a library record in the SatCom Satellites branch. The source did not
...
For a systems engineer, mgp25/RF-List belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-23T08:14:21Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:gnuradio stars:>20", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_satcom_satellites-5a15e8d77b447c` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xcesium/HackRF-Gnu-Radio | Library | [open](satcom-satellites-0xcesium-hackrf-gnu-radio-5a24e21a.md) |
| 0xh4di/GSMDecryption | Library | [open](satcom-satellites-0xh4di-gsmdecryption-aab51ee8.md) |
...
| alexmrqt/fm-rds | Library | [open](satcom-satellites-alexmrqt-fm-rds-3539a182.md) |
| architek/ccsds-standalone | Library | [open](satcom-satellites-architek-ccsds-standalone-ec3b3382.md) |
| argilo/gr-nrsc5 | Library | [open](satcom-satellites-argilo-gr-nrsc5-574fa57b.md) |
| BitBangingBytes/gr-smart_meters | Library | [open](satcom-satellites-bitbangingbytes-gr-smart-meters-4a6e02bf.md) |
