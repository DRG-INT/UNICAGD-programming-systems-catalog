...
<!-- canonical: https://cran.r-project.org/web/packages/varPro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/varPro/index.html](https://cran.r-project.org/web/packages/varPro/index.html) |
| Source record ids | cran_packages_by_date-04291f5bc9a472 |
...
For a systems engineer, varPro belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-08-22 23:20:08 UTC | [https://cran.r-project.org/web/packages/varPro/DESCRIPTION](https://cran.r-project.org/web/packages/varPro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/varPro/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-04291f5bc9a472` from `cran_packages_by_date` as `registry_expansion`
