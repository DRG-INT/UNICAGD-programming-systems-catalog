...
<!-- canonical: https://crates.io/crates/unicode-segmentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-segmentation](https://crates.io/crates/unicode-segmentation) |
| Source record ids | crates_io-74db8ea6800749 |

## System Engineer Summary

This crate provides Grapheme Cluster, Word and Sentence boundaries according to Unicode Standard
Annex #29 rules.

## Operational Role

For a systems engineer, unicode-segmentation belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.3 | 2026-06-01T15:58:43.979474Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-74db8ea6800749` from `crates_io` as `registry_expansion`
