...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CausalGraphs](https://github.com/JuliaRegistries/General/tree/master/C/CausalGraphs) |
| Source record ids | julia_general-d910acc414e39c |

## System Engineer Summary

Julia package registered in General at C/CausalGraphs.

## Operational Role

For a systems engineer, CausalGraphs belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CausalGraphs", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d910acc414e39c` from `julia_general` as `registry_expansion`
