...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Compiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/eslint-plugin-react-compiler](https://www.npmjs.com/package/eslint-plugin-react-compiler) |
| Source record ids | npm_registry-aea414194b44d5 |
...
For a systems engineer, eslint-plugin-react-compiler belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 19.1.0-rc.2 | 2025-05-14T22:14:44.927Z | [https://registry.npmjs.org/-/v1/search?text=eslint&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=eslint&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @angular/compiler-cli | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-compiler-cli-2d6ddb22.md) |
| @fastify/ajv-compiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-fastify-ajv-compiler-9021b0f7.md) |
| @fastify/fast-json-stringify-compiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-fastify-fast-json-stringify-compiler-18d66322.md) |
| Babel | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-babel-cb3c7574.md) |
| hermes-compiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-hermes-compiler-8dbe74b2.md) |
| oc-server-compiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-oc-server-compiler-b414574c.md) |
