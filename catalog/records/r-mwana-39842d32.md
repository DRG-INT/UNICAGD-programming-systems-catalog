...
<!-- canonical: https://cran.r-project.org/web/packages/mwana/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mwana/index.html](https://cran.r-project.org/web/packages/mwana/index.html) |
| Source record ids | cran_packages_by_date-7e2aaae13addb6 |
...
For a systems engineer, mwana belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-09-02 12:20:02 UTC | [https://cran.r-project.org/web/packages/mwana/DESCRIPTION](https://cran.r-project.org/web/packages/mwana/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mwana/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-7e2aaae13addb6` from `cran_packages_by_date` as `registry_expansion`
