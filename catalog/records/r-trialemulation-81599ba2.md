...
<!-- canonical: https://cran.r-project.org/web/packages/TrialEmulation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TrialEmulation/index.html](https://cran.r-project.org/web/packages/TrialEmulation/index.html) |
| Source record ids | cran_packages_by_date-4f58dae3119276 |
...
For a systems engineer, TrialEmulation belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5 | 2026-08-25 10:50:13 UTC | [https://cran.r-project.org/web/packages/TrialEmulation/DESCRIPTION](https://cran.r-project.org/web/packages/TrialEmulation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TrialEmulation/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4f58dae3119276` from `cran_packages_by_date` as `registry_expansion`
