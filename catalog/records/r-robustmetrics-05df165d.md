...
<!-- canonical: https://cran.r-project.org/web/packages/RobustMetrics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RobustMetrics/index.html](https://cran.r-project.org/web/packages/RobustMetrics/index.html) |
| Source record ids | cran_packages_by_date-ba554ecacedb79 |
...
For a systems engineer, RobustMetrics belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-21 10:40:09 UTC | [https://cran.r-project.org/web/packages/RobustMetrics/DESCRIPTION](https://cran.r-project.org/web/packages/RobustMetrics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RobustMetrics/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ba554ecacedb79` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| drogonR | Benchmarking | [open](r-drogonr-b9bf7ce1.md) |
