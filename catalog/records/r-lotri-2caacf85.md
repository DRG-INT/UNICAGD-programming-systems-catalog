...
<!-- canonical: https://cran.r-project.org/web/packages/lotri/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lotri/index.html](https://cran.r-project.org/web/packages/lotri/index.html) |
| Source record ids | cran_packages_by_date-ce3c66fc493404 |
...
For a systems engineer, lotri belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-09-11 20:10:13 UTC | [https://cran.r-project.org/web/packages/lotri/DESCRIPTION](https://cran.r-project.org/web/packages/lotri/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lotri/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-ce3c66fc493404` from `cran_packages_by_date` as `registry_expansion`
