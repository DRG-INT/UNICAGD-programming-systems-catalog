...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/tablicious -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/tablicious](https://gnu-octave.github.io/packages/tablicious) |
| Source record ids | octave_packages_index-014cb492c8ecbb |

## System Engineer Summary

Matlab-compatible Octave table class for storing tabular/relational data. Similar to R and Python
Pandas DataFrames.

## Operational Role

For a systems engineer, tablicious belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.7 | 2026-02-28 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-014cb492c8ecbb` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dataframe | Data Science | [open](octave-dataframe-fea4795b.md) |
