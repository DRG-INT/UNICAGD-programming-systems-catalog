...
| Source record ids | github_search_computer_graphics_software-daaa60add72fe3 |

## System Engineer Summary

Konva.js is an HTML5 Canvas JavaScript framework for interactive graphics, design editors,
whiteboards, and diagrams. Scene graph with events, drag and drop, transforms, animations, and
export.
...
- `github_search_computer_graphics_software-daaa60add72fe3` from `github_search_computer_graphics_software` as `registry_expansion`
