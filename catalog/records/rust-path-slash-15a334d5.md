...
| Canonical URL | [https://crates.io/crates/path-slash](https://crates.io/crates/path-slash) |
| Source record ids | crates_io-74432768b301cc |
...
For a systems engineer, path-slash belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2022-08-06T12:13:44.928162Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-74432768b301cc` from `crates_io` as `registry_expansion`
