...
<!-- canonical: https://luarocks.org/modules/siffiejoe/compat53 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/siffiejoe/compat53](https://luarocks.org/modules/siffiejoe/compat53) |
| Source record ids | lua-source-109 |
...
For a systems engineer, compat53 belongs in the Lua family inventory as part of dependency
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 109}}` |
...
- `lua-source-109` from `master_json` as `source_list_item`
