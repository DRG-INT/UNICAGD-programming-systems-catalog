...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Databases](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/databases.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Databases |
| Category | Database Datastore |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/typesense/typesense](https://github.com/typesense/typesense) |
| Source record ids | curated_database_systems-ebd8b0bdc1581a |

## System Engineer Summary

Fast search engine for typo-tolerant application search.

## Operational Role

For a systems engineer, Typesense belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | unknown |  |  | unknown | curated_database_record_requires_source_specific_release_lookup |
| preview/nightly | unknown |  |  | unknown | curated_database_record_requires_source_specific_preview_lookup |
...
- Stable release is unknown because `curated_database_record_requires_source_specific_release_lookup`.
- Preview/nightly metadata is unknown because `curated_database_record_requires_source_specific_preview_lookup`.

## Provenance

| Kind | Status | Date | Detail |
| --- | --- | --- | --- |
| curated_database_systems | curated-extension-derived | 2026-09-01 | `{"kind": "curated_database_systems", "retrieved": "2026-09-01", "status": "curated-extension-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `curated_database_systems-ebd8b0bdc1581a` from `curated_database_systems` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Active Record | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-active-record-74ab791b.md) |
| ADO.NET | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-ado-net-ce3c5008.md) |
| Amazon Aurora | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-amazon-aurora-799ba9b2.md) |
| Amazon S3 | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-amazon-s3-8f95d7a8.md) |
| Apache Accumulo | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-accumulo-3214fc7e.md) |
| Apache Cassandra | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-cassandra-f1db05e4.md) |
| Apache Druid | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-druid-c9d1d6b0.md) |
| Apache HBase | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-hbase-3e3c4760.md) |
