...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/opensatelliteproject/OpenSatelliteProject -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opensatelliteproject/OpenSatelliteProject](https://github.com/opensatelliteproject/OpenSatelliteProject) |
| Source record ids | github_search_electromagnetoscopes-048e8dbd5f59a3 |
...
For a systems engineer, opensatelliteproject/OpenSatelliteProject belongs in the
Electromagnetoscopes inventory as part of low-noise code review, style consistency, and automation-
friendly editing.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-08T06:07:29Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-048e8dbd5f59a3` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| LITUATUI/M3UPT | Formatter | [open](electromagnetoscopes-lituatui-m3upt-35d7a202.md) |
| nicespoon/retro-adsb-radar | Formatter | [open](electromagnetoscopes-nicespoon-retro-adsb-radar-1e8ed8aa.md) |
| Ttl/torchbp | Formatter | [open](electromagnetoscopes-ttl-torchbp-22ba7be7.md) |
| XMLTV/xmltv | Formatter | [open](electromagnetoscopes-xmltv-xmltv-3f96decf.md) |
