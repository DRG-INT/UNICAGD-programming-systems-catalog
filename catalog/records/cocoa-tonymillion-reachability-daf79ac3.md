...
<!-- canonical: https://github.com/tonymillion/Reachability -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tonymillion/Reachability](https://github.com/tonymillion/Reachability) |
| Source record ids | github_search_cocoa-ea27b29e57ffef |

## System Engineer Summary

ARC and GCD Compatible Reachability Class for iOS and MacOS. Drop in replacement for Apple
Reachability

## Operational Role

For a systems engineer, tonymillion/Reachability belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-25T00:02:23Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-ea27b29e57ffef` from `github_search_cocoa` as `registry_expansion`
