...
<!-- canonical: https://github.com/zhaotianff/ImageViewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhaotianff/ImageViewer](https://github.com/zhaotianff/ImageViewer) |
| Source record ids | github_search_photography-d4c0f095c8b451 |

## System Engineer Summary

Dicom Image Viewer.A simple imgview control that can be used as a tool when exporting Dicom
images,full Implemented by C#.

## Operational Role

For a systems engineer, zhaotianff/ImageViewer belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-10T01:09:19Z | gh search repos topic:raw-image stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-d4c0f095c8b451` from `github_search_photography` as `registry_expansion`
