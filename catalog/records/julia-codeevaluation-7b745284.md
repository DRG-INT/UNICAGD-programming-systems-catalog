...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CodeEvaluation](https://github.com/JuliaRegistries/General/tree/master/C/CodeEvaluation) |
| Source record ids | julia_general-bc32bef787a948 |

## System Engineer Summary

Julia package registered in General at C/CodeEvaluation.

## Operational Role

For a systems engineer, CodeEvaluation belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CodeEvaluation", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-bc32bef787a948` from `julia_general` as `registry_expansion`
