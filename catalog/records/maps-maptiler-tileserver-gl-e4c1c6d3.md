...
<!-- canonical: https://github.com/maptiler/tileserver-gl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maptiler/tileserver-gl](https://github.com/maptiler/tileserver-gl) |
| Source record ids | github_search_maps-208d2c26edd7bd |

## System Engineer Summary

Vector and raster maps with GL styles. Server side rendering by MapLibre GL Native. Map tile server
for MapLibre GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.

## Operational Role

For a systems engineer, maptiler/tileserver-gl belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:20:59Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-208d2c26edd7bd` from `github_search_maps` as `registry_expansion`
