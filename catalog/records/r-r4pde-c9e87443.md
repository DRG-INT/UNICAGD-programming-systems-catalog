...
<!-- canonical: https://cran.r-project.org/web/packages/r4pde/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/r4pde/index.html](https://cran.r-project.org/web/packages/r4pde/index.html) |
| Source record ids | cran_packages_by_date-63aa4c529156bb |

## System Engineer Summary

Tools for Quantitative Plant Disease Epidemiology

## Operational Role

For a systems engineer, r4pde belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-07 17:50:02 UTC | [https://cran.r-project.org/web/packages/r4pde/DESCRIPTION](https://cran.r-project.org/web/packages/r4pde/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/r4pde/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-63aa4c529156bb` from `cran_packages_by_date` as `registry_expansion`
