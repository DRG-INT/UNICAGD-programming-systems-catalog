...
<!-- canonical: https://cran.r-project.org/web/packages/segmented/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/segmented/index.html](https://cran.r-project.org/web/packages/segmented/index.html) |
| Source record ids | cran_packages_by_date-ecaaa3ca5a4a03 |
...
For a systems engineer, segmented belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2-2 | 2026-09-11 12:00:02 UTC | [https://cran.r-project.org/web/packages/segmented/DESCRIPTION](https://cran.r-project.org/web/packages/segmented/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/segmented/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-ecaaa3ca5a4a03` from `cran_packages_by_date` as `registry_expansion`
