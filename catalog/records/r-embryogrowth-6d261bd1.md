...
<!-- canonical: https://cran.r-project.org/web/packages/embryogrowth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/embryogrowth/index.html](https://cran.r-project.org/web/packages/embryogrowth/index.html) |
| Source record ids | cran_packages_by_date-a0586b5eb1141c |
...
For a systems engineer, embryogrowth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.8.24 | 2026-08-24 15:50:02 UTC | [https://cran.r-project.org/web/packages/embryogrowth/DESCRIPTION](https://cran.r-project.org/web/packages/embryogrowth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/embryogrowth/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a0586b5eb1141c` from `cran_packages_by_date` as `registry_expansion`
