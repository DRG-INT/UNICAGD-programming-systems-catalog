...
<!-- canonical: https://github.com/donnemartin/awesome-aws -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/donnemartin/awesome-aws](https://github.com/donnemartin/awesome-aws) |
| Source record ids | github_search_game_engines-81603a37c8e693 |

## System Engineer Summary

A curated list of awesome Amazon Web Services (AWS) libraries, open source repos, guides, blogs, and
other resources. Featuring the Fiery Meter of AWSome.

## Operational Role

For a systems engineer, donnemartin/awesome-aws belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-12T09:29:54Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-81603a37c8e693` from `github_search_game_engines` as `registry_expansion`
