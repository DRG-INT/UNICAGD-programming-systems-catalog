...
<!-- canonical: https://pypi.org/project/adam-mcp-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adam-mcp-cli/](https://pypi.org/project/adam-mcp-cli/) |
| Source record ids | pypi_simple-cbe2182903cb30 |

## System Engineer Summary

Scaffold and audit MCP servers using the Adam MCP house style

## Operational Role

For a systems engineer, adam-mcp-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-07-17T18:30:57.106897Z | [https://pypi.org/pypi/adam-mcp-cli/json](https://pypi.org/pypi/adam-mcp-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adam-mcp-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-cbe2182903cb30` from `pypi_simple` as `registry_expansion`
...
| ab-sqlalchemy-fastapi-http-exceptions | Project Scaffolding | [open](python-ab-sqlalchemy-fastapi-http-exceptions-3795748a.md) |
