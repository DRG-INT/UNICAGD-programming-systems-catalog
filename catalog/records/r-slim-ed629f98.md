...
<!-- canonical: https://cran.r-project.org/web/packages/slim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/slim/index.html](https://cran.r-project.org/web/packages/slim/index.html) |
| Source record ids | cran_packages_by_date-15da2cee84d3dd |
...
For a systems engineer, slim belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-24 13:50:02 UTC | [https://cran.r-project.org/web/packages/slim/DESCRIPTION](https://cran.r-project.org/web/packages/slim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/slim/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-15da2cee84d3dd` from `cran_packages_by_date` as `registry_expansion`
