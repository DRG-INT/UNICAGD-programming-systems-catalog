...
| Canonical URL | [https://luarocks.org/modules/guoming/kong-plugin-abtesting](https://luarocks.org/modules/guoming/kong-plugin-abtesting) |
| Source record ids | luarocks_root_manifest-862f6e6f86ddc5 |

## System Engineer Summary

The Kong AbTesting plugin

## Operational Role

For a systems engineer, kong-plugin-Abtesting belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-862f6e6f86ddc5` from `luarocks_root_manifest` as `registry_expansion`
