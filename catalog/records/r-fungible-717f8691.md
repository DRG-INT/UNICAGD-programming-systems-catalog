...
<!-- canonical: https://cran.r-project.org/web/packages/fungible/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fungible/index.html](https://cran.r-project.org/web/packages/fungible/index.html) |
| Source record ids | cran_packages_by_date-0bd861c6b06759 |
...
For a systems engineer, fungible belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.8 | 2026-09-04 05:10:35 UTC | [https://cran.r-project.org/web/packages/fungible/DESCRIPTION](https://cran.r-project.org/web/packages/fungible/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fungible/DESCRIPTION` at `2026-09-04T06:24:31+00:00`.
...
- `cran_packages_by_date-0bd861c6b06759` from `cran_packages_by_date` as `registry_expansion`
