# NickCulbertson/Custom-DSP-AudioKit
...
<!-- canonical: https://github.com/NickCulbertson/Custom-DSP-AudioKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NickCulbertson/Custom-DSP-AudioKit](https://github.com/NickCulbertson/Custom-DSP-AudioKit) |
| Source record ids | github_search_effects-9433f135a1607c |
...
For a systems engineer, NickCulbertson/Custom-DSP-AudioKit belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-03T13:55:37Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9433f135a1607c` from `github_search_effects` as `registry_expansion`
