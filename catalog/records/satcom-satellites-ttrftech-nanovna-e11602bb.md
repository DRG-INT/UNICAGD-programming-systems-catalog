...
<!-- canonical: https://github.com/ttrftech/NanoVNA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ttrftech/NanoVNA](https://github.com/ttrftech/NanoVNA) |
| Source record ids | github_search_satcom_satellites-89098482dfdb3e |
...
For a systems engineer, ttrftech/NanoVNA belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-11T21:02:22Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-89098482dfdb3e` from `github_search_satcom_satellites` as `registry_expansion`
