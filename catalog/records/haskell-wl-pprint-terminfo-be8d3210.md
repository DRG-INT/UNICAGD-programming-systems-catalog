...
<!-- canonical: https://hackage.haskell.org/package/wl-pprint-terminfo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wl-pprint-terminfo](https://hackage.haskell.org/package/wl-pprint-terminfo) |
| Source record ids | hackage_top_downloads-6328fe51487708 |
...
For a systems engineer, wl-pprint-terminfo belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.1.4 | 2016-06-22T20:21:18Z | [https://hackage.haskell.org/package/wl-pprint-terminfo](https://hackage.haskell.org/package/wl-pprint-terminfo) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wl-pprint-terminfo` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-6328fe51487708` from `hackage_top_downloads` as `registry_expansion`
