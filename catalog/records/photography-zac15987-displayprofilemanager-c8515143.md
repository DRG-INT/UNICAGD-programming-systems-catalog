# zac15987/DisplayProfileManager
...
<!-- canonical: https://github.com/zac15987/DisplayProfileManager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zac15987/DisplayProfileManager](https://github.com/zac15987/DisplayProfileManager) |
| Source record ids | github_search_photography-80fd036e65874b |

## System Engineer Summary

Instantly switch display profiles on Windows. Save & restore resolution, refresh rate, HDR,
rotation, DPI, audio, and monitor layouts. Features staged application mode for complex setups,
hotkeys, system tray, auto-start, and themes. Perfect for multi-monitor users, gamers, and content
creators. Free & open-source.

## Operational Role

For a systems engineer, zac15987/DisplayProfileManager belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-23T14:10:57Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-80fd036e65874b` from `github_search_photography` as `registry_expansion`
