...
| Canonical URL | [https://luarocks.org/modules/jorj/getopt](https://luarocks.org/modules/jorj/getopt) |
| Source record ids | luarocks_root_manifest-bc2ce0fb6d7949 |

## System Engineer Summary

getopt lib wrapper for Lua 5.1 - 5.4

## Operational Role

For a systems engineer, getopt belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-bc2ce0fb6d7949` from `luarocks_root_manifest` as `registry_expansion`
...
| Gimple | Interop Bindings | [open](lua-family-gimple-685186bc.md) |
