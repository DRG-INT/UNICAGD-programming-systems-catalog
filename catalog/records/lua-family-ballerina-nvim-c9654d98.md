...
<!-- canonical: https://luarocks.org/modules/thisarug/ballerina.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thisarug/ballerina.nvim](https://luarocks.org/modules/thisarug/ballerina.nvim) |
| Source record ids | luarocks_root_manifest-901be46991ecfb |

## System Engineer Summary

Ballerina support for Neovim: LSP, format-on-save, DAP debugging, auto-indent, syntax highlighting

## Operational Role

For a systems engineer, ballerina.nvim belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-901be46991ecfb` from `luarocks_root_manifest` as `registry_expansion`
