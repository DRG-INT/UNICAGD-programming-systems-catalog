...
<!-- canonical: https://cran.r-project.org/web/packages/flextable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flextable/index.html](https://cran.r-project.org/web/packages/flextable/index.html) |
| Source record ids | cran_packages_by_date-61ccf8461e7ab9 |
...
For a systems engineer, flextable belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2026-09-10 14:30:16 UTC | [https://cran.r-project.org/web/packages/flextable/DESCRIPTION](https://cran.r-project.org/web/packages/flextable/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flextable/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-61ccf8461e7ab9` from `cran_packages_by_date` as `registry_expansion`
