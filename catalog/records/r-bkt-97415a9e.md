...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/BKT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BKT/index.html](https://cran.r-project.org/web/packages/BKT/index.html) |
| Source record ids | cran_packages_by_date-3b8159fcb1637c |
...
For a systems engineer, BKT belongs in the R inventory as part of hot-path discovery, allocation
analysis, latency control, and capacity planning.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-05 16:20:19 UTC | [https://cran.r-project.org/web/packages/BKT/DESCRIPTION](https://cran.r-project.org/web/packages/BKT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BKT/DESCRIPTION` at `2026-09-05T18:20:45+00:00`.
...
- `cran_packages_by_date-3b8159fcb1637c` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| datom | Profiler | [open](r-datom-465d8abc.md) |
| ErrorTracer | Profiler | [open](r-errortracer-430fdc33.md) |
| geoprofiler | Profiler | [open](r-geoprofiler-76565464.md) |
| HAPTRACE | Profiler | [open](r-haptrace-5674a8ae.md) |
| Tplyr | Profiler | [open](r-tplyr-6ac49fbf.md) |
| typetracer | Profiler | [open](r-typetracer-499d7b72.md) |
| wikiprofiler | Profiler | [open](r-wikiprofiler-c478bc70.md) |
