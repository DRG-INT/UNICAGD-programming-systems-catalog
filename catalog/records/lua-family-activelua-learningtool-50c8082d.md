...
<!-- canonical: https://luarocks.org/modules/seba/activelua-learningtool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/seba/activelua-learningtool](https://luarocks.org/modules/seba/activelua-learningtool) |
| Source record ids | luarocks_root_manifest-06cf2a5687b7e5 |
...
For a systems engineer, ActiveLua-LearningTool belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-06cf2a5687b7e5` from `luarocks_root_manifest` as `registry_expansion`
...
| add | Library | [open](lua-family-add-c5dc5a71.md) |
