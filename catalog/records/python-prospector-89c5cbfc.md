...
Prospector is tracked as a precommit ci quality record in the Python branch. The source did not
...
| Name | Category | Page |
| --- | --- | --- |
| pre-commit | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pre-commit-921eeac1.md) |
