...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dolphindb/DolphinDBPlugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dolphindb/DolphinDBPlugin](https://github.com/dolphindb/DolphinDBPlugin) |
| Source record ids | github_search_databases-60307d02b7acab |

## System Engineer Summary

dolphindb/DolphinDBPlugin is tracked as a library record in the Databases branch. The source did not
...
For a systems engineer, dolphindb/DolphinDBPlugin belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T04:17:42Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:odbc stars:>50", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_databases-60307d02b7acab` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| abhay-ramesh/pushduck | Library | [open](databases-abhay-ramesh-pushduck-a045aead.md) |
| anthonybudd/S4 | Library | [open](databases-anthonybudd-s4-cbdae55c.md) |
| apache/doris-flink-connector | Library | [open](databases-apache-doris-flink-connector-03be6ee5.md) |
| apache/drill | Library | [open](databases-apache-drill-5e3bde8a.md) |
| apache/flink-connector-jdbc | Library | [open](databases-apache-flink-connector-jdbc-5ab1a981.md) |
| apache/spark-website | Library | [open](databases-apache-spark-website-4546f531.md) |
| awslabs/amazon-s3-find-and-forget | Library | [open](databases-awslabs-amazon-s3-find-and-forget-6b9f17d6.md) |
| ByConity/ByConity | Library | [open](databases-byconity-byconity-c80e34b8.md) |
