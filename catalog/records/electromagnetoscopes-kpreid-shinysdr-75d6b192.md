...
<!-- canonical: https://github.com/kpreid/shinysdr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kpreid/shinysdr](https://github.com/kpreid/shinysdr) |
| Source record ids | github_search_electromagnetoscopes-b147ce39c2cd9b |

## System Engineer Summary

Software-defined radio receiver application built on GNU Radio with a web-based UI and plugins. In
development, usable but incomplete. Compatible with RTL-SDR.

## Operational Role

For a systems engineer, kpreid/shinysdr belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-17T04:34:50Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b147ce39c2cd9b` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| renanmav/pycst | Visualization Gui | [open](electromagnetoscopes-renanmav-pycst-f586fea1.md) |
| rsadsb/adsb_deku | Visualization Gui | [open](electromagnetoscopes-rsadsb-adsb-deku-b3cb2015.md) |
| SigDigger | Visualization Gui | [open](electromagnetoscopes-sigdigger-9dac6595.md) |
| tapparelj/gr-lora_sdr | Visualization Gui | [open](electromagnetoscopes-tapparelj-gr-lora-sdr-26e08518.md) |
