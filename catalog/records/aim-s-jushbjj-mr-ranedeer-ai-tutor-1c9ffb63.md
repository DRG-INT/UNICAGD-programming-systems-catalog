...
<!-- canonical: https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) |
| Source record ids | github_search_aims-3f836376292224 |
...
For a systems engineer, JushBJJ/Mr.-Ranedeer-AI-Tutor belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-30T08:08:00Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-3f836376292224` from `github_search_aims` as `registry_expansion`
