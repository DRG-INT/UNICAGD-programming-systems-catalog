...
<!-- canonical: https://github.com/ibireme/YYKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ibireme/YYKit](https://github.com/ibireme/YYKit) |
| Source record ids | github_search_cocoa-a2c453ea7228a2 |
...
For a systems engineer, ibireme/YYKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-25T08:23:28Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-a2c453ea7228a2` from `github_search_cocoa` as `registry_expansion`
