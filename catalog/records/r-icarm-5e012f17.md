...
<!-- canonical: https://cran.r-project.org/web/packages/icarm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/icarm/index.html](https://cran.r-project.org/web/packages/icarm/index.html) |
| Source record ids | cran_packages_by_date-35579408ffe2a8 |
...
For a systems engineer, icarm belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21 05:42:36 UTC | [https://cran.r-project.org/web/packages/icarm/DESCRIPTION](https://cran.r-project.org/web/packages/icarm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/icarm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-35579408ffe2a8` from `cran_packages_by_date` as `registry_expansion`
