...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CSV](https://github.com/JuliaRegistries/General/tree/master/C/CSV) |
| Source record ids | master-1545da427af9 |

## System Engineer Summary

CSV.jl is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, CSV.jl belongs in the Julia inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.10.17 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/C/CSV/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/C/CSV/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `master-1545da427af9` from `master_json` as `serialization`
