...
<!-- canonical: https://crates.io/crates/write16 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/write16](https://crates.io/crates/write16) |
| Source record ids | crates_io-17eeb28117bf59 |
...
For a systems engineer, write16 belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2022-07-18T13:23:21.837277Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-17eeb28117bf59` from `crates_io` as `registry_expansion`
