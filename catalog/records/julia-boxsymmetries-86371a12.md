...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoxSymmetries](https://github.com/JuliaRegistries/General/tree/master/B/BoxSymmetries) |
| Source record ids | julia_general-d13fe7c279cd6a |

## System Engineer Summary

Julia package registered in General at B/BoxSymmetries.

## Operational Role

For a systems engineer, BoxSymmetries belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoxSymmetries", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d13fe7c279cd6a` from `julia_general` as `registry_expansion`
