...
| Canonical URL | [https://github.com/libAudioFlux/audioFlux](https://github.com/libAudioFlux/audioFlux) |
| Source record ids | github_search_audio-024b7cc7ae04cd |
...
For a systems engineer, libAudioFlux/audioFlux belongs in the Audio inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.9 | 2024-05-24T09:49:30Z | [https://api.github.com/repos/libAudioFlux/audioFlux/releases/latest](https://api.github.com/repos/libAudioFlux/audioFlux/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/libAudioFlux/audioFlux/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-024b7cc7ae04cd` from `github_search_audio` as `registry_expansion`
