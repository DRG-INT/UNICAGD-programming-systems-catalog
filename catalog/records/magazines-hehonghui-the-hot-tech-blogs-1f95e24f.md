...
<!-- canonical: https://github.com/hehonghui/the-hot-tech-blogs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hehonghui/the-hot-tech-blogs](https://github.com/hehonghui/the-hot-tech-blogs) |
| Source record ids | github_search_magazines-3167e8349f02fb |

## System Engineer Summary

每周六会从掘金抓取7天内最热门Android、iOS、后端、前端各20篇技术文章, 然后制作成 mobi、epub 格式的电子书推送给订阅者, 支持推送到kindle
设备、kindle手机app、普通邮箱.

## Operational Role

For a systems engineer, hehonghui/the-hot-tech-blogs belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-27T10:32:10Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-3167e8349f02fb` from `github_search_magazines` as `registry_expansion`
