# sharan-space1/asint_chat_llama
...
<!-- canonical: https://github.com/sharan-space1/asint_chat_llama -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sharan-space1/asint_chat_llama](https://github.com/sharan-space1/asint_chat_llama) |
| Source record ids | github_search_sapjava-a6597dc446bf09 |

## System Engineer Summary

A RAG application built using SAP CAP Java, to augment prompts to Phi-3 using Ollama, deployed on
SAP AI Core.

## Operational Role

For a systems engineer, sharan-space1/asint_chat_llama belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-06T02:04:32Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-a6597dc446bf09` from `github_search_sapjava` as `registry_expansion`
