...
<!-- canonical: https://cocoapods.org/pods/Swinject -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Swinject](https://cocoapods.org/pods/Swinject) |
| Source record ids | cocoapods_cdn-ee1ef8922f5d39 |
...
For a systems engineer, Swinject belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.1 | 2024-06-07 19:25:57 UTC | [https://trunk.cocoapods.org/api/v1/pods/Swinject](https://trunk.cocoapods.org/api/v1/pods/Swinject) |  |
| preview | known | 2.0.0-beta.3 | 2016-12-10 11:34:51 UTC | [https://trunk.cocoapods.org/api/v1/pods/Swinject](https://trunk.cocoapods.org/api/v1/pods/Swinject) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Swinject` at `2026-09-01T07:21:27+00:00`.
...
- `cocoapods_cdn-ee1ef8922f5d39` from `cocoapods_cdn` as `registry_expansion`
