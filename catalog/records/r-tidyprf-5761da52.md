...
<!-- canonical: https://cran.r-project.org/web/packages/tidyprf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidyprf/index.html](https://cran.r-project.org/web/packages/tidyprf/index.html) |
| Source record ids | cran_packages_by_date-b0882bd12d6866 |
...
For a systems engineer, tidyprf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 02:10:02 UTC | [https://cran.r-project.org/web/packages/tidyprf/DESCRIPTION](https://cran.r-project.org/web/packages/tidyprf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidyprf/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-b0882bd12d6866` from `cran_packages_by_date` as `registry_expansion`
