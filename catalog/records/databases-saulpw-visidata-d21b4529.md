...
<!-- canonical: https://github.com/saulpw/visidata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/saulpw/visidata](https://github.com/saulpw/visidata) |
| Source record ids | github_search_databases-011a59a9f8db3a |
...
For a systems engineer, saulpw/visidata belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T00:09:56Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-011a59a9f8db3a` from `github_search_databases` as `registry_expansion`
