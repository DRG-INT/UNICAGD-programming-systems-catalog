...
<!-- canonical: https://github.com/demonixis/SSGI-URP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/demonixis/SSGI-URP](https://github.com/demonixis/SSGI-URP) |
| Source record ids | github_search_effects-80e7defdab2481 |
...
For a systems engineer, demonixis/SSGI-URP belongs in the Effects inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-03-11T06:40:26Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-80e7defdab2481` from `github_search_effects` as `registry_expansion`
