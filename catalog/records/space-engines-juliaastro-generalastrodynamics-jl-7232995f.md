...
| Canonical URL | [https://github.com/JuliaAstro/GeneralAstrodynamics.jl](https://github.com/JuliaAstro/GeneralAstrodynamics.jl) |
| Source record ids | github_search_space_engines-9bb2608a4f0fde |

## System Engineer Summary

Astrodynamics with units! Provides common astrodynamics calculations, plotting, and iterative Halo,
Kepler, and Lambert solvers.

## Operational Role

For a systems engineer, JuliaAstro/GeneralAstrodynamics.jl belongs in the Space Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | GeneralAstrodynamics-v0.11.0 | 2024-12-24T02:55:03Z | [https://api.github.com/repos/JuliaAstro/GeneralAstrodynamics.jl/releases/latest](https://api.github.com/repos/JuliaAstro/GeneralAstrodynamics.jl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/JuliaAstro/GeneralAstrodynamics.jl/releases/latest` at `2026-09-01T07:24:18+00:00`.
...
- `github_search_space_engines-9bb2608a4f0fde` from `github_search_space_engines` as `registry_expansion`
...
| Starainrt/astro | Ide Editor Integration | [open](space-engines-starainrt-astro-97e8d2a3.md) |
