...
| Canonical URL | [https://www.viewvc.org/](https://www.viewvc.org/) |
| Source record ids | curated_repository_workplace_routes-1039e3dbd3aa29 |

## System Engineer Summary

Repository browser for CVS and Subversion repositories.

## Operational Role

For a systems engineer, ViewVC belongs in the Repository Workplaces inventory as part of ecosystem
...
- `curated_repository_workplace_routes-1039e3dbd3aa29` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Gitiles | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-gitiles-360cac51.md) |
