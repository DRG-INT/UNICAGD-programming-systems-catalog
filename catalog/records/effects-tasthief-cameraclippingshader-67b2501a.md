...
<!-- canonical: https://github.com/TasThief/CameraClippingShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TasThief/CameraClippingShader](https://github.com/TasThief/CameraClippingShader) |
| Source record ids | github_search_effects-3740d4eb5bdbe0 |

## System Engineer Summary

A spherical post processed camera clipping shader for unity

## Operational Role

For a systems engineer, TasThief/CameraClippingShader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-09-22T10:57:31Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3740d4eb5bdbe0` from `github_search_effects` as `registry_expansion`
