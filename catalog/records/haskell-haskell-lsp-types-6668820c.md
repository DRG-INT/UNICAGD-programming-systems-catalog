...
<!-- canonical: https://hackage.haskell.org/package/haskell-lsp-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/haskell-lsp-types](https://hackage.haskell.org/package/haskell-lsp-types) |
| Source record ids | hackage_top_downloads-966b6d295757f5 |
...
For a systems engineer, haskell-lsp-types belongs in the Haskell inventory as part of editor
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0.0 | 2021-01-13T15:27:30Z | [https://hackage.haskell.org/package/haskell-lsp-types](https://hackage.haskell.org/package/haskell-lsp-types) |  |
| candidate | partial | 0.10.0.0 |  | [https://hackage.haskell.org/package/haskell-lsp-types](https://hackage.haskell.org/package/haskell-lsp-types) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haskell-lsp-types` at `2026-09-05T00:31:52+00:00`.
...
- `hackage_top_downloads-966b6d295757f5` from `hackage_top_downloads` as `registry_expansion`
