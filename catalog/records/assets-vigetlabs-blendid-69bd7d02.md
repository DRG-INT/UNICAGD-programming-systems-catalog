...
<!-- canonical: https://github.com/vigetlabs/blendid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vigetlabs/blendid](https://github.com/vigetlabs/blendid) |
| Source record ids | github_search_assets-d81212486ea9cd |
...
For a systems engineer, vigetlabs/blendid belongs in the Assets inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-14T03:49:31Z | gh search repos topic:asset-pipeline stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d81212486ea9cd` from `github_search_assets` as `registry_expansion`
