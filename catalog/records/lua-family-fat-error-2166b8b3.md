...
| Canonical URL | [https://luarocks.org/modules/henry4k/fat_error](https://luarocks.org/modules/henry4k/fat_error) |
| Source record ids | luarocks_root_manifest-d2e0875414be07 |
...
For a systems engineer, fat_error belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d2e0875414be07` from `luarocks_root_manifest` as `registry_expansion`
