...
<!-- canonical: https://pub.dev/packages/postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/postgres](https://pub.dev/packages/postgres) |
| Source record ids | pub_dev-abdb57ad04e7ed |
...
For a systems engineer, postgres belongs in the Dart inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.12 | 2026-06-11T15:02:50.869497Z | [https://pub.dev/api/packages/postgres](https://pub.dev/api/packages/postgres) |  |
| preview | known | 3.4.0-dev.2 | 2024-09-13T22:56:36.519130Z | [https://pub.dev/api/packages/postgres](https://pub.dev/api/packages/postgres) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/postgres` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-abdb57ad04e7ed` from `pub_dev` as `registry_expansion`
