...
| Canonical URL | [https://crates.io/crates/x509-cert](https://crates.io/crates/x509-cert) |
| Source record ids | crates_io-234f454a173450 |

## System Engineer Summary

Pure Rust implementation of the X.509 Public Key Infrastructure Certificate format as described in
RFC 5280

## Operational Role

For a systems engineer, x509-cert belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-07-09T05:36:14.335238Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-234f454a173450` from `crates_io` as `registry_expansion`
