...
<!-- canonical: https://cran.r-project.org/web/packages/osrm.backend/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/osrm.backend/index.html](https://cran.r-project.org/web/packages/osrm.backend/index.html) |
| Source record ids | cran_packages_by_date-e75a723e4fa08e |
...
For a systems engineer, osrm.backend belongs in the R inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-09-05 15:50:07 UTC | [https://cran.r-project.org/web/packages/osrm.backend/DESCRIPTION](https://cran.r-project.org/web/packages/osrm.backend/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/osrm.backend/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-e75a723e4fa08e` from `cran_packages_by_date` as `registry_expansion`
