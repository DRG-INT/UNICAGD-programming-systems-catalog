...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Debugger](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/debugger.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Debugger |
| Source type | debugger |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-131f050ca68b |
...
For a systems engineer, pdb belongs in the Python inventory as part of fault isolation, live
...
- `master-131f050ca68b` from `master_json` as `debugger`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| debugpy | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-debugpy-6c6441e3.md) |
