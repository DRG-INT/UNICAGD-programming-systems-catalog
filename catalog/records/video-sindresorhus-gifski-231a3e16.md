...
| Canonical URL | [https://github.com/sindresorhus/Gifski](https://github.com/sindresorhus/Gifski) |
| Source record ids | github_search_video-0e6d208baade3a |
...
For a systems engineer, sindresorhus/Gifski belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.4 | 2026-07-08T14:51:16Z | [https://api.github.com/repos/sindresorhus/Gifski/releases/latest](https://api.github.com/repos/sindresorhus/Gifski/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/sindresorhus/Gifski/releases/latest` at `2026-09-01T09:23:26+00:00`.
...
- `github_search_video-0e6d208baade3a` from `github_search_video` as `registry_expansion`
