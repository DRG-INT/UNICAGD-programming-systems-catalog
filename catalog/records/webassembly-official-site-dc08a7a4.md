...
<!-- canonical: http://webassembly.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://webassembly.org/](http://webassembly.org/) |
| Source record ids | awesome_list-14595f3f7d2d5f |

## System Engineer Summary

Official Site is tracked as a ffi bindings record in the WebAssembly branch. The source did not
...
For a systems engineer, Official Site belongs in the WebAssembly inventory as part of cross-language
...
- `awesome_list-14595f3f7d2d5f` from `awesome_list` as `registry_expansion`
