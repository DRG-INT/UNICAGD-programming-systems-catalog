...
<!-- canonical: https://crates.io/crates/colorchoice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/colorchoice](https://crates.io/crates/colorchoice) |
| Source record ids | crates_io-7c7dbef119b60d |
...
For a systems engineer, colorchoice belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-03-13T18:59:29.020348Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-7c7dbef119b60d` from `crates_io` as `registry_expansion`
