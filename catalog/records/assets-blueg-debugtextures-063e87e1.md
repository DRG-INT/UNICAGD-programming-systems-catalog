...
<!-- canonical: https://github.com/BlueG/DebugTextures -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BlueG/DebugTextures](https://github.com/BlueG/DebugTextures) |
| Source record ids | github_search_assets-186b5fa01e1044 |

## System Engineer Summary

A simple set of UV debugging textures and the code used to generate them. They are open source and
being released to the public domain to the maximum extent possible. The sRGB values in the images
range from 39 to 232, which should make the images suitable for use as the base-color of non-
metallic materials in most PBR scenes.

## Operational Role

For a systems engineer, BlueG/DebugTextures belongs in the Assets inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-06T17:11:36Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-186b5fa01e1044` from `github_search_assets` as `registry_expansion`
