...
| Canonical URL | [https://crates.io/crates/rustc_version_runtime](https://crates.io/crates/rustc_version_runtime) |
| Source record ids | crates_io-1747e71e6da89b |
...
For a systems engineer, rustc_version_runtime belongs in the Rust inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2023-10-25T13:28:58.663604Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-1747e71e6da89b` from `crates_io` as `registry_expansion`
