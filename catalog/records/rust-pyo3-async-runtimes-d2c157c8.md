...
| Canonical URL | [https://crates.io/crates/pyo3-async-runtimes](https://crates.io/crates/pyo3-async-runtimes) |
| Source record ids | crates_io-a8ba5083ffbcc1 |
...
For a systems engineer, pyo3-async-runtimes belongs in the Rust inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.0 | 2026-08-28T18:29:36.569442Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-a8ba5083ffbcc1` from `crates_io` as `registry_expansion`
