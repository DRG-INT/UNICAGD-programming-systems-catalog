...
<!-- canonical: https://luarocks.org/modules/dropkickx86/csv2lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dropkickx86/csv2lua](https://luarocks.org/modules/dropkickx86/csv2lua) |
| Source record ids | luarocks_root_manifest-dfc96f32d21c2a |

## System Engineer Summary

csv2lua is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, csv2lua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-dfc96f32d21c2a` from `luarocks_root_manifest` as `registry_expansion`
