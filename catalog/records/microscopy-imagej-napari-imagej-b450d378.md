...
<!-- canonical: https://github.com/imagej/napari-imagej -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/imagej/napari-imagej](https://github.com/imagej/napari-imagej) |
| Source record ids | github_search_microscopy-3d6daf29caf7e2 |
...
For a systems engineer, imagej/napari-imagej belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T19:20:25Z | gh search repos topic:imagej stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-3d6daf29caf7e2` from `github_search_microscopy` as `registry_expansion`
