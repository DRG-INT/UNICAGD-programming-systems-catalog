...
| Canonical URL | [https://crates.io/crates/datafusion-functions](https://crates.io/crates/datafusion-functions) |
| Source record ids | crates_io-968e4c50db45f5 |
...
For a systems engineer, datafusion-functions belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 55.0.0 | 2026-08-18T21:09:04.877590Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-968e4c50db45f5` from `crates_io` as `registry_expansion`
