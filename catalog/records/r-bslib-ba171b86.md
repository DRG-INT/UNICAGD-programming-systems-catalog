...
<!-- canonical: https://cran.r-project.org/web/packages/bslib/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bslib/index.html](https://cran.r-project.org/web/packages/bslib/index.html) |
| Source record ids | cran_packages_by_date-29d450d16cbb11 |
...
For a systems engineer, bslib belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-08-04 00:40:02 UTC | [https://cran.r-project.org/web/packages/bslib/DESCRIPTION](https://cran.r-project.org/web/packages/bslib/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bslib/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-29d450d16cbb11` from `cran_packages_by_date` as `registry_expansion`
