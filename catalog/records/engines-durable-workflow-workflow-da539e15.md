...
<!-- canonical: https://github.com/durable-workflow/workflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/durable-workflow/workflow](https://github.com/durable-workflow/workflow) |
| Source record ids | github_search_engines-f7797347aacd77 |

## System Engineer Summary

Core package for defining and running durable workflows and activities. Supports long-running
persistent workflows, retries, queues, parallel execution, workflow monitoring, dedicated storage
connections, and orchestration for microservices, data pipelines, sagas, agentic workflows, and
other complex business processes.

## Operational Role

For a systems engineer, durable-workflow/workflow belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T07:39:33Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-f7797347aacd77` from `github_search_engines` as `registry_expansion`
