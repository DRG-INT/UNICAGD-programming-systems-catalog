...
<!-- canonical: https://hackage.haskell.org/package/Color -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Color](https://hackage.haskell.org/package/Color) |
| Source record ids | hackage_top_downloads-e5e993cb391430 |
...
For a systems engineer, Color belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2025-10-20T20:47:01Z | [https://hackage.haskell.org/package/Color](https://hackage.haskell.org/package/Color) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Color` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-e5e993cb391430` from `hackage_top_downloads` as `registry_expansion`
