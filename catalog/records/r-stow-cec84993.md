...
<!-- canonical: https://cran.r-project.org/web/packages/stow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stow/index.html](https://cran.r-project.org/web/packages/stow/index.html) |
| Source record ids | cran_packages_by_date-2b4172edf26c46 |

## System Engineer Summary

Durable Managed Local Copies of Remote Files

## Operational Role

For a systems engineer, stow belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-30 10:00:02 UTC | [https://cran.r-project.org/web/packages/stow/DESCRIPTION](https://cran.r-project.org/web/packages/stow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stow/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2b4172edf26c46` from `cran_packages_by_date` as `registry_expansion`
