...
<!-- canonical: https://cran.r-project.org/web/packages/falsifyr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/falsifyr/index.html](https://cran.r-project.org/web/packages/falsifyr/index.html) |
| Source record ids | cran_packages_by_date-c6affaedc0fe5b |
...
For a systems engineer, falsifyr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-07 20:20:02 UTC | [https://cran.r-project.org/web/packages/falsifyr/DESCRIPTION](https://cran.r-project.org/web/packages/falsifyr/DESCRIPTION) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/falsifyr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c6affaedc0fe5b` from `cran_packages_by_date` as `registry_expansion`
