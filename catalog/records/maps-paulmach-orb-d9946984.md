...
<!-- canonical: https://github.com/paulmach/orb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paulmach/orb](https://github.com/paulmach/orb) |
| Source record ids | github_search_maps-75bedc9ffff4dd |
...
For a systems engineer, paulmach/orb belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-30T15:51:22Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-75bedc9ffff4dd` from `github_search_maps` as `registry_expansion`
