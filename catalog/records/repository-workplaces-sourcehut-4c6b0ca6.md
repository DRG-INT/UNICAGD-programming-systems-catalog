...
| Canonical URL | [https://sr.ht/](https://sr.ht/) |
| Source record ids | curated_repository_workplace_routes-1802ee4eed0ae4 |

## System Engineer Summary

Hosted software development workplace built around Git, Mercurial, mailing lists, builds, tickets,
and Unix-style tooling.

## Operational Role

For a systems engineer, sourcehut belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-1802ee4eed0ae4` from `curated_repository_workplace_routes` as `registry_expansion`
