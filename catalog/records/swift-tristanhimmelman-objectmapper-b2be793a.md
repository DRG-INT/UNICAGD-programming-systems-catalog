...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tristanhimmelman/ObjectMapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tristanhimmelman/ObjectMapper](https://github.com/tristanhimmelman/ObjectMapper) |
| Source record ids | github_search_swift-5e11843e156ab7 |
...
For a systems engineer, tristanhimmelman/ObjectMapper belongs in the Swift inventory as part of wire
...
- `github_search_swift-5e11843e156ab7` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Ranchero-Software/NetNewsWire | Serialization | [open](swift-ranchero-software-netnewswire-c617c7bf.md) |
| swift-extras/swift-extras-json | Serialization | [open](swift-swift-extras-swift-extras-json-d7e2b1de.md) |
