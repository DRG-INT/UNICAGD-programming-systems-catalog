...
<!-- canonical: https://github.com/AhmedAmrNabil/arena-rush -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AhmedAmrNabil/arena-rush](https://github.com/AhmedAmrNabil/arena-rush) |
| Source record ids | github_search_effects-2b60eab9ef4e35 |

## System Engineer Summary

C++ OpenGL wave-survival FPS built on a custom engine with ECS architecture, real-time lighting,
GLTF models, Bullet physics, OpenAL audio, shader-driven materials, and cinematic post-processing

## Operational Role

For a systems engineer, AhmedAmrNabil/arena-rush belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.1 | 2026-05-02T09:14:43Z | [https://api.github.com/repos/AhmedAmrNabil/arena-rush/releases/latest](https://api.github.com/repos/AhmedAmrNabil/arena-rush/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/AhmedAmrNabil/arena-rush/releases/latest` at `2026-09-01T09:23:08+00:00`.
...
- `github_search_effects-2b60eab9ef4e35` from `github_search_effects` as `registry_expansion`
