...
<!-- canonical: https://cran.r-project.org/web/packages/K4Rumah/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/K4Rumah/index.html](https://cran.r-project.org/web/packages/K4Rumah/index.html) |
| Source record ids | cran_packages_by_date-d62423951186ce |

## System Engineer Summary

Home Context Data Files for TIMSS 2023 Grade 4

## Operational Role

For a systems engineer, K4Rumah belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:30:23 UTC | [https://cran.r-project.org/web/packages/K4Rumah/DESCRIPTION](https://cran.r-project.org/web/packages/K4Rumah/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/K4Rumah/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d62423951186ce` from `cran_packages_by_date` as `registry_expansion`
