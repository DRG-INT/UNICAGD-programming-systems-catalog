...
<!-- canonical: https://luarocks.org/modules/heini/audiodataload -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/heini/audiodataload](https://luarocks.org/modules/heini/audiodataload) |
| Source record ids | luarocks_root_manifest-19f8870c4000bb |
...
For a systems engineer, audiodataload belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-19f8870c4000bb` from `luarocks_root_manifest` as `registry_expansion`
