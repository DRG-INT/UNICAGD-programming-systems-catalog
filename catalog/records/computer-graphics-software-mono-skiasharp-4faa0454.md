...
<!-- canonical: https://github.com/mono/SkiaSharp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mono/SkiaSharp](https://github.com/mono/SkiaSharp) |
| Source record ids | github_search_computer_graphics_software-7883d59aa6d914 |

## System Engineer Summary

SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics
Library. It provides a comprehensive 2D API that can be used across mobile, server and desktop
models to render images.

## Operational Role

For a systems engineer, mono/SkiaSharp belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-7883d59aa6d914` from `github_search_computer_graphics_software` as `registry_expansion`
