...
<!-- canonical: https://hackage.haskell.org/package/shakers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shakers](https://hackage.haskell.org/package/shakers) |
| Source record ids | hackage_top_downloads-f1a228c08aaa5e |
...
For a systems engineer, shakers belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.50 | 2018-10-11T04:39:59Z | [https://hackage.haskell.org/package/shakers](https://hackage.haskell.org/package/shakers) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/shakers` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-f1a228c08aaa5e` from `hackage_top_downloads` as `registry_expansion`
