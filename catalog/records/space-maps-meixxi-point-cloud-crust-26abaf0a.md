...
<!-- canonical: https://github.com/meiXXI/point-cloud-crust -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/meiXXI/point-cloud-crust](https://github.com/meiXXI/point-cloud-crust) |
| Source record ids | github_search_space_maps-72ad7fbbc8e3b0 |

## System Engineer Summary

Implementation of the Point Cloud Crust Algorithm ("The Cheese-Maker") for the visualization of
color spaces and other 3D models and objects.

## Operational Role

For a systems engineer, meiXXI/point-cloud-crust belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-01-31T11:34:03Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-72ad7fbbc8e3b0` from `github_search_space_maps` as `registry_expansion`
