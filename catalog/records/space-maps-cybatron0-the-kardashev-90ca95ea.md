...
<!-- canonical: https://github.com/cybatron0/the-kardashev -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cybatron0/the-kardashev](https://github.com/cybatron0/the-kardashev) |
| Source record ids | github_search_space_maps-dc89f10929a125 |

## System Engineer Summary

THE KARDASHEV — Global Energy Tracker. Interactive map of oil & energy production, pipelines,
plants, emissions. Planetary-scale intelligence system.

## Operational Role

For a systems engineer, cybatron0/the-kardashev belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T12:00:51Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-dc89f10929a125` from `github_search_space_maps` as `registry_expansion`
