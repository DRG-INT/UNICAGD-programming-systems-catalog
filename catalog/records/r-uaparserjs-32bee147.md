...
<!-- canonical: https://cran.r-project.org/web/packages/uaparserjs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/uaparserjs/index.html](https://cran.r-project.org/web/packages/uaparserjs/index.html) |
| Source record ids | cran_packages_by_date-45473be8d11b66 |
...
For a systems engineer, uaparserjs belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-28 10:00:02 UTC | [https://cran.r-project.org/web/packages/uaparserjs/DESCRIPTION](https://cran.r-project.org/web/packages/uaparserjs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/uaparserjs/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-45473be8d11b66` from `cran_packages_by_date` as `registry_expansion`
