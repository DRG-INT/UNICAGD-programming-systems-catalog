...
<!-- canonical: https://github.com/kamailio/kamailio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kamailio/kamailio](https://github.com/kamailio/kamailio) |
| Source record ids | github_search_video-09e80df0685ab9 |

## System Engineer Summary

Kamailio - The Open Source SIP Server for large VoIP and real-time communication platforms, focusing
on flexibility, security and scalability

## Operational Role

For a systems engineer, kamailio/kamailio belongs in the Video inventory as part of supply-chain
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:16:10Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-09e80df0685ab9` from `github_search_video` as `registry_expansion`
