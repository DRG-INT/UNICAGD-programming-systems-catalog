...
| Source record ids | corpus-897c2875460ca0 |

## System Engineer Summary

IPython is tracked as an ide editor integration record in the Python branch. The source did not
...
For a systems engineer, IPython belongs in the Python inventory as part of ecosystem capability
...
- `corpus-897c2875460ca0` from `master_json` as `ide_editor_integration`
...
| Spyder | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-spyder-356e40f4.md) |
