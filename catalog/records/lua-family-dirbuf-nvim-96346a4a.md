...
<!-- canonical: https://luarocks.org/modules/neorocks/dirbuf.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/dirbuf.nvim](https://luarocks.org/modules/neorocks/dirbuf.nvim) |
| Source record ids | luarocks_root_manifest-1719bee9840293 |
...
For a systems engineer, dirbuf.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1719bee9840293` from `luarocks_root_manifest` as `registry_expansion`
