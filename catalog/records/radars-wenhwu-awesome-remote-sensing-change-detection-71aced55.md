...
<!-- canonical: https://github.com/wenhwu/awesome-remote-sensing-change-detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wenhwu/awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) |
| Source record ids | github_search_radars-75ef9bb6847c9f |

## System Engineer Summary

A comprehensive and up-to-date compilation of datasets, tools, methods, review papers, and
competitions for remote sensing change detection.

## Operational Role

For a systems engineer, wenhwu/awesome-remote-sensing-change-detection belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-16T14:44:49Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-75ef9bb6847c9f` from `github_search_radars` as `registry_expansion`
