...
<!-- canonical: https://cran.r-project.org/web/packages/rmsBMA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rmsBMA/index.html](https://cran.r-project.org/web/packages/rmsBMA/index.html) |
| Source record ids | cran_packages_by_date-46525f40ba546f |
...
For a systems engineer, rmsBMA belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-07 06:50:02 UTC | [https://cran.r-project.org/web/packages/rmsBMA/DESCRIPTION](https://cran.r-project.org/web/packages/rmsBMA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rmsBMA/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-46525f40ba546f` from `cran_packages_by_date` as `registry_expansion`
