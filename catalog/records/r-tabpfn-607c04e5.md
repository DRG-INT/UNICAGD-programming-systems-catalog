...
<!-- canonical: https://cran.r-project.org/web/packages/tabpfn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tabpfn/index.html](https://cran.r-project.org/web/packages/tabpfn/index.html) |
| Source record ids | cran_packages_by_date-dbba65c3f4cdbc |
...
For a systems engineer, tabpfn belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-01 22:50:02 UTC | [https://cran.r-project.org/web/packages/tabpfn/DESCRIPTION](https://cran.r-project.org/web/packages/tabpfn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tabpfn/DESCRIPTION` at `2026-09-02T00:28:49+00:00`.
...
- `cran_packages_by_date-dbba65c3f4cdbc` from `cran_packages_by_date` as `registry_expansion`
