...
<!-- canonical: https://github.com/sh123/codec2_talkie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sh123/codec2_talkie](https://github.com/sh123/codec2_talkie) |
| Source record ids | github_search_electromagnetoscopes-b598a482b64f14 |

## System Engineer Summary

Turn your Android phone into Amateur Radio Codec2/OPUS APRS enabled DV handheld transceiver
(Bluetooth/BLE/USB/TCPIP KISS/Sound modem client for DV digital voice communication)

## Operational Role

For a systems engineer, sh123/codec2_talkie belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-24T18:32:54Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b598a482b64f14` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AzuraCast/AzuraCast | Package Manager | [open](electromagnetoscopes-azuracast-azuracast-24484a93.md) |
