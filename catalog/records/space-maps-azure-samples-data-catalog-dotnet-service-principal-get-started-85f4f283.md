# Azure-Samples/data-catalog-dotnet-service-principal-get-started
...
<!-- canonical: https://github.com/Azure-Samples/data-catalog-dotnet-service-principal-get-started -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Azure-Samples/data-catalog-dotnet-service-principal-get-started](https://github.com/Azure-Samples/data-catalog-dotnet-service-principal-get-started) |
| Source record ids | github_search_space_maps-07c599eb273884 |
...
For a systems engineer, Azure-Samples/data-catalog-dotnet-service-principal-get-started belongs in
the Space Maps inventory as part of diagnostics, metrics, auditability, tracing, and incident
response.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-12-03T03:49:37Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-07c599eb273884` from `github_search_space_maps` as `registry_expansion`
