...
<!-- canonical: https://cran.r-project.org/web/packages/obr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/obr/index.html](https://cran.r-project.org/web/packages/obr/index.html) |
| Source record ids | cran_packages_by_date-076e32df3ded19 |
...
For a systems engineer, obr belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2026-08-24 07:40:02 UTC | [https://cran.r-project.org/web/packages/obr/DESCRIPTION](https://cran.r-project.org/web/packages/obr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/obr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-076e32df3ded19` from `cran_packages_by_date` as `registry_expansion`
