...
<!-- canonical: https://luarocks.org/modules/romanaverin/charleston.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/romanaverin/charleston.nvim](https://luarocks.org/modules/romanaverin/charleston.nvim) |
| Source record ids | luarocks_root_manifest-df55e8be4c2c66 |

## System Engineer Summary

High contrast Neovim colorscheme with low saturation and smooth colors

## Operational Role

For a systems engineer, charleston.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-df55e8be4c2c66` from `luarocks_root_manifest` as `registry_expansion`
