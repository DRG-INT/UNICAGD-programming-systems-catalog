...
| Source record ids | corpus-b372b13d63bc75 |

## System Engineer Summary

Moses is tracked as an utility library record in the Lua family branch. The source did not provide a
...
For a systems engineer, Moses belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-b372b13d63bc75` from `master_json` as `utility_library`
