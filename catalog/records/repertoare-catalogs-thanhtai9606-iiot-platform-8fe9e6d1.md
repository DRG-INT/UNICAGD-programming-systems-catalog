...
<!-- canonical: https://github.com/thanhtai9606/iiot-platform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thanhtai9606/iiot-platform](https://github.com/thanhtai9606/iiot-platform) |
| Source record ids | github_search_repertoare_catalogs-ff1d836c7d20b1 |

## System Engineer Summary

Open-source Industrial IoT platform: multi-protocol edge ingest (HTTP/MQTT/gRPC/Modbus/OPC-UA),
Kafka event pipeline, TimescaleDB telemetry, Rust Z-Score anomaly detection, Keycloak + Cerbos RBAC,
Angular 19 smart-factory UI with asset catalog & dashboard builder.

## Operational Role

For a systems engineer, thanhtai9606/iiot-platform belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-01T09:03:48Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-ff1d836c7d20b1` from `github_search_repertoare_catalogs` as `registry_expansion`
