...
<!-- canonical: https://cran.r-project.org/web/packages/neuralnetwork/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/neuralnetwork/index.html](https://cran.r-project.org/web/packages/neuralnetwork/index.html) |
| Source record ids | cran_packages_by_date-72b2b581f8f53e |
...
For a systems engineer, neuralnetwork belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-07 03:20:02 UTC | [https://cran.r-project.org/web/packages/neuralnetwork/DESCRIPTION](https://cran.r-project.org/web/packages/neuralnetwork/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/neuralnetwork/DESCRIPTION` at `2026-09-07T05:19:46+00:00`.
...
- `cran_packages_by_date-72b2b581f8f53e` from `cran_packages_by_date` as `registry_expansion`
