...
<!-- canonical: https://pub.dev/packages/just_audio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/just_audio](https://pub.dev/packages/just_audio) |
| Source record ids | pub_dev-fdfd74da735cf5 |

## System Engineer Summary

A feature-rich audio player for Flutter. Loop, clip and sequence any sound from any source
(asset/file/URL/stream) in gapless playlists.

## Operational Role

For a systems engineer, just_audio belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.6 | 2026-06-29T13:36:46.318814Z | [https://pub.dev/api/packages/just_audio](https://pub.dev/api/packages/just_audio) |  |
| preview | known | 0.7.0-nullsafety.3 | 2021-03-03T04:34:20.630939Z | [https://pub.dev/api/packages/just_audio](https://pub.dev/api/packages/just_audio) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/just_audio` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-fdfd74da735cf5` from `pub_dev` as `registry_expansion`
