...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/OpenTelemetry.Instrumentation.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/OpenTelemetry.Instrumentation.Http](https://www.nuget.org/packages/OpenTelemetry.Instrumentation.Http) |
| Source record ids | nuget_search-68e5c531326f01 |
...
For a systems engineer, OpenTelemetry.Instrumentation.Http belongs in the C-Sharp inventory as part
of hot-path discovery, allocation analysis, latency control, and capacity planning.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.18.0 | 2026-08-21T17:06:05.73+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/opentelemetry.instrumentation.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/opentelemetry.instrumentation.http/index.json) |  |
| preview | known | 1.14.0-rc.1 | 2025-11-05T16:58:02.637+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/opentelemetry.instrumentation.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/opentelemetry.instrumentation.http/index.json) |  |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Apache-2.0; https://www.nuget.org/packages/OpenTelemetry.Instrumentation.Http/1.18.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/opentelemetry.instrumentation.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-68e5c531326f01` from `nuget_search` as `registry_expansion`
