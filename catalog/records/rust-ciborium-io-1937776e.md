...
<!-- canonical: https://crates.io/crates/ciborium-io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ciborium-io](https://crates.io/crates/ciborium-io) |
| Source record ids | crates_io-c51b4f3f041a62 |
...
For a systems engineer, ciborium-io belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2024-01-24T03:02:36.662214Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c51b4f3f041a62` from `crates_io` as `registry_expansion`
