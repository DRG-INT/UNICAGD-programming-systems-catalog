...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-profanity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-profanity](https://packagist.org/packages/pestphp/pest-plugin-profanity) |
| Source record ids | packagist_search-efd870d452c729 |
...
For a systems engineer, pestphp/pest-plugin-profanity belongs in the PHP inventory as part of
...
- `packagist_search-efd870d452c729` from `packagist_search` as `registry_expansion`
