...
| Canonical URL | [https://www.npmjs.com/package/lws-log](https://www.npmjs.com/package/lws-log) |
| Source record ids | npm_registry-52cd0609fbd81e |

## System Engineer Summary

lws-log is tracked as a logging observability record in the Node.js/JavaScript branch. The source
...
For a systems engineer, lws-log belongs in the Node.js/JavaScript inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-08-01T08:41:03.558Z | [https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-52cd0609fbd81e` from `npm_registry` as `registry_expansion`
