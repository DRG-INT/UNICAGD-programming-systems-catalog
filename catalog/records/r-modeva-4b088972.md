...
<!-- canonical: https://cran.r-project.org/web/packages/modEvA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modEvA/index.html](https://cran.r-project.org/web/packages/modEvA/index.html) |
| Source record ids | cran_packages_by_date-94fbf221fa236c |
...
For a systems engineer, modEvA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.46 | 2026-08-28 12:20:08 UTC | [https://cran.r-project.org/web/packages/modEvA/DESCRIPTION](https://cran.r-project.org/web/packages/modEvA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modEvA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-94fbf221fa236c` from `cran_packages_by_date` as `registry_expansion`
