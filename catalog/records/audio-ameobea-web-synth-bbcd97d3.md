...
<!-- canonical: https://github.com/Ameobea/web-synth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ameobea/web-synth](https://github.com/Ameobea/web-synth) |
| Source record ids | github_search_audio-e7f2e0a05c6237 |
...
For a systems engineer, Ameobea/web-synth belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T07:15:16Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-e7f2e0a05c6237` from `github_search_audio` as `registry_expansion`
