...
<!-- canonical: https://crates.io/crates/hybrid-array -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hybrid-array](https://crates.io/crates/hybrid-array) |
| Source record ids | crates_io-a25d85eed5d416 |

## System Engineer Summary

Hybrid typenum-based and const generic array types designed to provide the flexibility of typenum-
based expressions while also allowing interoperability and a transition path to const generics

## Operational Role

For a systems engineer, hybrid-array belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.15 | 2026-09-08T18:21:39.618460Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-10T12:26:05+00:00`.
...
- `crates_io-a25d85eed5d416` from `crates_io` as `registry_expansion`
