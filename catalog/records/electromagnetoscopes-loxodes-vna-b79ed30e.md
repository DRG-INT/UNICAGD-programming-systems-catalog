...
| Source record ids | github_search_electromagnetoscopes-b6ee5ea36ccd8e |
...
For a systems engineer, loxodes/vna belongs in the Electromagnetoscopes inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-31T22:19:55Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b6ee5ea36ccd8e` from `github_search_electromagnetoscopes` as `registry_expansion`
