...
<!-- canonical: https://cran.r-project.org/web/packages/afc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/afc/index.html](https://cran.r-project.org/web/packages/afc/index.html) |
| Source record ids | cran_packages_by_date-dad7aa57a7753c |
...
For a systems engineer, afc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-09-11 07:30:02 UTC | [https://cran.r-project.org/web/packages/afc/DESCRIPTION](https://cran.r-project.org/web/packages/afc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/afc/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-dad7aa57a7753c` from `cran_packages_by_date` as `registry_expansion`
