# Ariakim-Taiyo/GeoFS-Shaders-Repository
...
<!-- canonical: https://github.com/Ariakim-Taiyo/GeoFS-Shaders-Repository -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ariakim-Taiyo/GeoFS-Shaders-Repository](https://github.com/Ariakim-Taiyo/GeoFS-Shaders-Repository) |
| Source record ids | github_search_effects-b8db21e2cb5eea |

## System Engineer Summary

A collection of post processing shaders for GeoFS

## Operational Role

For a systems engineer, Ariakim-Taiyo/GeoFS-Shaders-Repository belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-08T07:01:04Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b8db21e2cb5eea` from `github_search_effects` as `registry_expansion`
