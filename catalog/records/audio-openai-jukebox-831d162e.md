...
<!-- canonical: https://github.com/openai/jukebox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openai/jukebox](https://github.com/openai/jukebox) |
| Source record ids | github_search_audio-45367ae5f7d461 |
...
For a systems engineer, openai/jukebox belongs in the Audio inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-19T05:14:24Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-45367ae5f7d461` from `github_search_audio` as `registry_expansion`
