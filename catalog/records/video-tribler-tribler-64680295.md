...
<!-- canonical: https://github.com/Tribler/tribler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tribler/tribler](https://github.com/Tribler/tribler) |
| Source record ids | github_search_video-90e06db8bd07db |
...
For a systems engineer, Tribler/tribler belongs in the Video inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:00:44Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_video-90e06db8bd07db` from `github_search_video` as `registry_expansion`
