...
<!-- canonical: https://cran.r-project.org/web/packages/gge/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gge/index.html](https://cran.r-project.org/web/packages/gge/index.html) |
| Source record ids | cran_packages_by_date-2d70d0cddb92ca |
...
For a systems engineer, gge belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11 | 2026-09-03 19:30:02 UTC | [https://cran.r-project.org/web/packages/gge/DESCRIPTION](https://cran.r-project.org/web/packages/gge/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gge/DESCRIPTION` at `2026-09-03T20:18:45+00:00`.
...
- `cran_packages_by_date-2d70d0cddb92ca` from `cran_packages_by_date` as `registry_expansion`
