...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/apache/incubator-kie-drools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/incubator-kie-drools](https://github.com/apache/incubator-kie-drools) |
| Source record ids | curated_language_routes-365c8506a2f382 |

## System Engineer Summary

Rules engine and decision automation platform for business rules, DMN, constraints, and runtime
evaluation.

## Operational Role

For a systems engineer, Drools belongs in the Engines inventory as part of runtime behavior,
...
- `curated_language_routes-365c8506a2f382` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alikon-art/DeterminFlow | Interpreter Runtime | [open](engines-alikon-art-determinflow-d2d4c788.md) |
| apache/incubator-kie-kogito-runtimes | Interpreter Runtime | [open](engines-apache-incubator-kie-kogito-runtimes-937f8450.md) |
| appcypher/awesome-wasm-runtimes | Interpreter Runtime | [open](engines-appcypher-awesome-wasm-runtimes-be7b7445.md) |
| commsor/titanoboa | Interpreter Runtime | [open](engines-commsor-titanoboa-1f3eaa07.md) |
| JiepengTan/LockstepEngine | Interpreter Runtime | [open](engines-jiepengtan-lockstepengine-fced748e.md) |
| Open Policy Agent | Interpreter Runtime | [open](engines-open-policy-agent-e7abb70e.md) |
| theMackabu/ant | Interpreter Runtime | [open](engines-themackabu-ant-48fb8dc3.md) |
| utopia-rise/godot-jvm | Interpreter Runtime | [open](engines-utopia-rise-godot-jvm-1d89ba9a.md) |
