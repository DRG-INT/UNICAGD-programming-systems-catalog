...
<!-- canonical: https://github.com/maziyarpanahi/openmed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maziyarpanahi/openmed](https://github.com/maziyarpanahi/openmed) |
| Source record ids | github_search_swift-2ecfb56ccc7742 |

## System Engineer Summary

Local-first healthcare AI: clinical NER & HIPAA PII de-identification that runs 100% on-device.
2,200+ medical models, 21 languages, Apple MLX + Python, no cloud, no patient data leaving your
network. Apache-2.0

## Operational Role

For a systems engineer, maziyarpanahi/openmed belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T21:10:32Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-2ecfb56ccc7742` from `github_search_swift` as `registry_expansion`
