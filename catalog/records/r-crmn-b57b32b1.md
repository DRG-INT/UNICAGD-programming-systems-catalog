...
<!-- canonical: https://cran.r-project.org/web/packages/crmn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crmn/index.html](https://cran.r-project.org/web/packages/crmn/index.html) |
| Source record ids | cran_packages_by_date-10b957f2abe265 |
...
For a systems engineer, crmn belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.22 | 2026-09-11 07:40:07 UTC | [https://cran.r-project.org/web/packages/crmn/DESCRIPTION](https://cran.r-project.org/web/packages/crmn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crmn/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-10b957f2abe265` from `cran_packages_by_date` as `registry_expansion`
