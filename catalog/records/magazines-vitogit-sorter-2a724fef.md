...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vitogit/sorter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vitogit/sorter](https://github.com/vitogit/sorter) |
| Source record ids | github_search_magazines-5add7227b0d886 |
...
For a systems engineer, vitogit/sorter belongs in the Magazines inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-12T20:33:13Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-5add7227b0d886` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crsh/papaja | Formatter | [open](magazines-crsh-papaja-c74bdec2.md) |
| goncalor/phrack-epub | Formatter | [open](magazines-goncalor-phrack-epub-6564d03c.md) |
| mondeja/hledger-fmt | Formatter | [open](magazines-mondeja-hledger-fmt-2c3b9c05.md) |
| systemd/systemd-netlogd | Formatter | [open](magazines-systemd-systemd-netlogd-8b0a1dd3.md) |
| unixwzrd/oobabooga-macOS | Formatter | [open](magazines-unixwzrd-oobabooga-macos-58b65075.md) |
