...
<!-- canonical: https://www.w3.org/TR/webrtc/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.w3.org/TR/webrtc/](https://www.w3.org/TR/webrtc/) |
| Source record ids | curated_language_routes-963c5cde7c8099 |

## System Engineer Summary

W3C WebRTC API specification for real-time media and data channel communication.

## Operational Role

For a systems engineer, WebRTC belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-963c5cde7c8099` from `curated_language_routes` as `registry_expansion`
