...
<!-- canonical: https://github.com/WebAssembly/simd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/simd](https://github.com/WebAssembly/simd) |
| Source record ids | github_search_webassembly-b20c4f42b4e4dc |
...
For a systems engineer, WebAssembly/simd belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-16T17:37:07Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b20c4f42b4e4dc` from `github_search_webassembly` as `registry_expansion`
