...
<!-- canonical: https://www.rfc-editor.org/rfc/rfc9110.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc9110.html](https://www.rfc-editor.org/rfc/rfc9110.html) |
| Source record ids | curated_language_routes-0cb1dd536cbecf |

## System Engineer Summary

HTTP semantics specification for methods, status codes, fields, content, caching model boundaries,
and intermediaries.

## Operational Role

For a systems engineer, HTTP Semantics belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-0cb1dd536cbecf` from `curated_language_routes` as `registry_expansion`
