...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_pattern_language-d4bbd008616a10 |

## System Engineer Summary

AngularJS in patterns - this repository provides different look into AngularJS. It contains
information where different design patterns are used inside the framework or any Angular
application.

## Operational Role

For a systems engineer, mgechev/angularjs-in-patterns belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-21T07:02:12Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-d4bbd008616a10` from `github_search_pattern_language` as `registry_expansion`
