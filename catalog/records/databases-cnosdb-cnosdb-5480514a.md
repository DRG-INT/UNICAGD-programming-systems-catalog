...
<!-- canonical: https://github.com/cnosdb/cnosdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cnosdb/cnosdb](https://github.com/cnosdb/cnosdb) |
| Source record ids | github_search_databases-6cae61838d1ce1 |

## System Engineer Summary

A cloud-native open source distributed time series database with high performance, high compression
ratio and high availability.

## Operational Role

For a systems engineer, cnosdb/cnosdb belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-26T07:27:53Z | gh search repos topic:time-series-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6cae61838d1ce1` from `github_search_databases` as `registry_expansion`
