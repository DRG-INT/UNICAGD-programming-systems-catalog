...
<!-- canonical: https://cran.r-project.org/web/packages/ggstats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggstats/index.html](https://cran.r-project.org/web/packages/ggstats/index.html) |
| Source record ids | cran_packages_by_date-430efa1382bdd8 |
...
For a systems engineer, ggstats belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-09-02 05:20:33 UTC | [https://cran.r-project.org/web/packages/ggstats/DESCRIPTION](https://cran.r-project.org/web/packages/ggstats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggstats/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-430efa1382bdd8` from `cran_packages_by_date` as `registry_expansion`
