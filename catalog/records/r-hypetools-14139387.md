...
<!-- canonical: https://cran.r-project.org/web/packages/HYPEtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HYPEtools/index.html](https://cran.r-project.org/web/packages/HYPEtools/index.html) |
| Source record ids | cran_packages_by_date-17da52e3218549 |
...
For a systems engineer, HYPEtools belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.8 | 2026-09-02 20:10:02 UTC | [https://cran.r-project.org/web/packages/HYPEtools/DESCRIPTION](https://cran.r-project.org/web/packages/HYPEtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HYPEtools/DESCRIPTION` at `2026-09-02T20:20:11+00:00`.
...
- `cran_packages_by_date-17da52e3218549` from `cran_packages_by_date` as `registry_expansion`
