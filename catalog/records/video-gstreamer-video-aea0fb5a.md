...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.freedesktop.org/gstreamer/gstreamer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.freedesktop.org/gstreamer/gstreamer](https://gitlab.freedesktop.org/gstreamer/gstreamer) |
| Source record ids | curated_language_routes-2d3374c8011499 |

## System Engineer Summary

Video pipeline framework for capture, playback, encoding, streaming, filters, hardware acceleration,
and plugins.

## Operational Role

For a systems engineer, GStreamer Video belongs in the Video inventory as part of ecosystem
...
- `curated_language_routes-2d3374c8011499` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| audiamus/AaxAudioConverter | Image Audio Dsp | [open](video-audiamus-aaxaudioconverter-4518a386.md) |
| FFmpeg Video | Image Audio Dsp | [open](video-ffmpeg-video-06a1210f.md) |
| GPAC | Image Audio Dsp | [open](video-gpac-0a032849.md) |
| readbeyond/aeneas | Image Audio Dsp | [open](video-readbeyond-aeneas-cbd140ea.md) |
