...
<!-- canonical: https://github.com/Arxhsz/Project-Orion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Arxhsz/Project-Orion](https://github.com/Arxhsz/Project-Orion) |
| Source record ids | github_search_space_maps-a540bd3d66ed76 |

## System Engineer Summary

Realtime planetary command map with Cesium, live weather maps, orbital tracking, CameraNet, and
device location.

## Operational Role

For a systems engineer, Arxhsz/Project-Orion belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T16:21:45Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-a540bd3d66ed76` from `github_search_space_maps` as `registry_expansion`
...
| Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator | Datetime | [open](space-maps-soldeusss-simulacrum-a-deep-learning-n-body-simulator-ce177271.md) |
