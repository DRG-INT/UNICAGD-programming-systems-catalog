...
| Canonical URL | [https://github.com/Refloow/Refloow-Photo-Studio](https://github.com/Refloow/Refloow-Photo-Studio) |
| Source record ids | github_search_photography-70ee3ea53404af |

## System Engineer Summary

Powerful local photo editor built for quick, professional results. No accounts, no ads, no
watermarks, no data collection - just editing, filtering, 1 click background removing, cropping &
layering

## Operational Role

For a systems engineer, Refloow/Refloow-Photo-Studio belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-06-23T13:10:30Z | [https://api.github.com/repos/Refloow/Refloow-Photo-Studio/releases/latest](https://api.github.com/repos/Refloow/Refloow-Photo-Studio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Refloow/Refloow-Photo-Studio/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-70ee3ea53404af` from `github_search_photography` as `registry_expansion`
