...
<!-- canonical: https://github.com/GeoscienceAustralia/dea-notebooks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GeoscienceAustralia/dea-notebooks](https://github.com/GeoscienceAustralia/dea-notebooks) |
| Source record ids | github_search_radars-ee4b99c76c8b6a |

## System Engineer Summary

Open-source Jupyter Notebooks and Python tools for geospatial analysis with Digital Earth Australia,
Open Data Cube, and Xarray

## Operational Role

For a systems engineer, GeoscienceAustralia/dea-notebooks belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:38:16Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-ee4b99c76c8b6a` from `github_search_radars` as `registry_expansion`
