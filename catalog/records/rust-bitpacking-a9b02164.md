...
| Canonical URL | [https://crates.io/crates/bitpacking](https://crates.io/crates/bitpacking) |
| Source record ids | crates_io-933674cef8c492 |
...
For a systems engineer, bitpacking belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2026-01-08T14:11:00.446528Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-933674cef8c492` from `crates_io` as `registry_expansion`
