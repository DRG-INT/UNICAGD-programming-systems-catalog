...
<!-- canonical: https://github.com/xaxaxa-dev/vna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xaxaxa-dev/vna](https://github.com/xaxaxa-dev/vna) |
| Source record ids | github_search_electromagnetoscopes-e844ec7463d909 |
...
For a systems engineer, xaxaxa-dev/vna belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-06T05:55:37Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-e844ec7463d909` from `github_search_electromagnetoscopes` as `registry_expansion`
