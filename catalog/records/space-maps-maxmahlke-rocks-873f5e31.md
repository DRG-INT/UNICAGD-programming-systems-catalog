...
<!-- canonical: https://github.com/maxmahlke/rocks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maxmahlke/rocks](https://github.com/maxmahlke/rocks) |
| Source record ids | github_search_space_maps-0a84230cdd25f9 |
...
For a systems engineer, maxmahlke/rocks belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-13T08:02:19Z | gh search repos topic:planetary-science stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0a84230cdd25f9` from `github_search_space_maps` as `registry_expansion`
