...
<!-- canonical: https://github.com/planetaryprobst/naif_spice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/planetaryprobst/naif_spice](https://github.com/planetaryprobst/naif_spice) |
| Source record ids | github_search_space_maps-d9a0b29b2f0d0e |

## System Engineer Summary

Contains the general kernels of the NAIF SPICE library

## Operational Role

For a systems engineer, planetaryprobst/naif_spice belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-22T23:38:10Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d9a0b29b2f0d0e` from `github_search_space_maps` as `registry_expansion`
