...
<!-- canonical: https://github.com/ngtcp2/ngtcp2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ngtcp2/ngtcp2](https://github.com/ngtcp2/ngtcp2) |
| Source record ids | curated_language_routes-0e4f6615f6c199 |

## System Engineer Summary

QUIC protocol implementation and tooling.

## Operational Role

For a systems engineer, ngtcp2 belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-0e4f6615f6c199` from `curated_language_routes` as `registry_expansion`
