...
<!-- canonical: https://cran.r-project.org/web/packages/hdcce/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hdcce/index.html](https://cran.r-project.org/web/packages/hdcce/index.html) |
| Source record ids | cran_packages_by_date-3211cc1f567e02 |
...
For a systems engineer, hdcce belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 14:20:02 UTC | [https://cran.r-project.org/web/packages/hdcce/DESCRIPTION](https://cran.r-project.org/web/packages/hdcce/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hdcce/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-3211cc1f567e02` from `cran_packages_by_date` as `registry_expansion`
