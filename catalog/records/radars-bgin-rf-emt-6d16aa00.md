...
<!-- canonical: https://github.com/bgin/RF-EMT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bgin/RF-EMT](https://github.com/bgin/RF-EMT) |
| Source record ids | github_search_radars-8644ebf1f2c707 |

## System Engineer Summary

Radio-Frequency Engineering Modeling Toolkit (RF-EMT). This project provides a high-fidelity
simulation framework for Radar,Telecommunication and the other Radio-frequency engineering systems.
The goal is to achieve realistic, design-level system modeling and simulation.

## Operational Role

For a systems engineer, bgin/RF-EMT belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T11:01:43Z | gh search repos topic:radar-signal-processing stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-8644ebf1f2c707` from `github_search_radars` as `registry_expansion`
...
| fitoprincipe/geetools-code-editor | Ide Editor Integration | [open](radars-fitoprincipe-geetools-code-editor-1080a1fa.md) |
