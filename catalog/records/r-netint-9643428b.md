...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/NetInt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NetInt/index.html](https://cran.r-project.org/web/packages/NetInt/index.html) |
| Source record ids | cran_packages_by_date-f3d8a2faf14571 |
...
For a systems engineer, NetInt belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-09 16:20:09 UTC | [https://cran.r-project.org/web/packages/NetInt/DESCRIPTION](https://cran.r-project.org/web/packages/NetInt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NetInt/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-f3d8a2faf14571` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AIGENIE | Networking Http | [open](r-aigenie-ec28de5c.md) |
| bbk | Networking Http | [open](r-bbk-04eaa929.md) |
| BBNI | Networking Http | [open](r-bbni-df3b78d7.md) |
| bioclients | Networking Http | [open](r-bioclients-282c6a0e.md) |
| biohttp | Networking Http | [open](r-biohttp-77935237.md) |
| bnviewer | Networking Http | [open](r-bnviewer-ce3ec8e3.md) |
| cloudosR | Networking Http | [open](r-cloudosr-247b423e.md) |
| corto | Networking Http | [open](r-corto-147ed29b.md) |
