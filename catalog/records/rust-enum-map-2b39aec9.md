...
| Canonical URL | [https://crates.io/crates/enum-map](https://crates.io/crates/enum-map) |
| Source record ids | crates_io-0ec47bb526823e |
...
For a systems engineer, enum-map belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-07-21T06:21:25.208591Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-0ec47bb526823e` from `crates_io` as `registry_expansion`
