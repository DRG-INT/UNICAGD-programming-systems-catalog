...
<!-- canonical: https://crates.io/crates/postgres-protocol -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/postgres-protocol](https://crates.io/crates/postgres-protocol) |
| Source record ids | crates_io-5cb5ea673e1e44 |
...
For a systems engineer, postgres-protocol belongs in the Rust inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.12 | 2026-06-12T15:34:01.163185Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-5cb5ea673e1e44` from `crates_io` as `registry_expansion`
