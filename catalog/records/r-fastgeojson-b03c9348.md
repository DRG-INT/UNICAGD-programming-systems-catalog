...
<!-- canonical: https://cran.r-project.org/web/packages/fastgeojson/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastgeojson/index.html](https://cran.r-project.org/web/packages/fastgeojson/index.html) |
| Source record ids | cran_packages_by_date-ed48a69b56f0f1 |
...
For a systems engineer, fastgeojson belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-15 01:50:02 UTC | [https://cran.r-project.org/web/packages/fastgeojson/DESCRIPTION](https://cran.r-project.org/web/packages/fastgeojson/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastgeojson/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-ed48a69b56f0f1` from `cran_packages_by_date` as `registry_expansion`
