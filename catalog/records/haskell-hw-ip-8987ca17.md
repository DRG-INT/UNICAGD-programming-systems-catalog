...
<!-- canonical: https://hackage.haskell.org/package/hw-ip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hw-ip](https://hackage.haskell.org/package/hw-ip) |
| Source record ids | hackage_top_downloads-80e023c8ae117b |
...
For a systems engineer, hw-ip belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.2.1 | 2022-03-19T10:00:36Z | [https://hackage.haskell.org/package/hw-ip](https://hackage.haskell.org/package/hw-ip) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/hw-ip](https://hackage.haskell.org/package/hw-ip) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hw-ip` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-80e023c8ae117b` from `hackage_top_downloads` as `registry_expansion`
