...
<!-- canonical: https://cran.r-project.org/web/packages/mapnhanespa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mapnhanespa/index.html](https://cran.r-project.org/web/packages/mapnhanespa/index.html) |
| Source record ids | cran_packages_by_date-52f13d9e314a40 |

## System Engineer Summary

Map Quantiles for Physical Activity from 'NHANES'

## Operational Role

For a systems engineer, mapnhanespa belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 21:00:27 UTC | [https://cran.r-project.org/web/packages/mapnhanespa/DESCRIPTION](https://cran.r-project.org/web/packages/mapnhanespa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mapnhanespa/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-52f13d9e314a40` from `cran_packages_by_date` as `registry_expansion`
