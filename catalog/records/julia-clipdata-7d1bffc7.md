...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClipData](https://github.com/JuliaRegistries/General/tree/master/C/ClipData) |
| Source record ids | julia_general-f1723530698695 |

## System Engineer Summary

Julia package registered in General at C/ClipData.

## Operational Role

For a systems engineer, ClipData belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClipData", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f1723530698695` from `julia_general` as `registry_expansion`
