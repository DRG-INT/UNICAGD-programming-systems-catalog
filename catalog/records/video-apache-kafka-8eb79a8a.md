...
<!-- canonical: https://github.com/apache/kafka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/kafka](https://github.com/apache/kafka) |
| Source record ids | github_search_video-a1388bb48a00e0 |
...
For a systems engineer, apache/kafka belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:36:45Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-a1388bb48a00e0` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| travisjeffery/jocko | Message Broker | [open](video-travisjeffery-jocko-c73a20ca.md) |
