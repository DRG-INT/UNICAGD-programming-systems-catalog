...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/HypoPG/hypopg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HypoPG/hypopg](https://github.com/HypoPG/hypopg) |
| Source record ids | github_search_catalogs-ca407a8c33e6ca |
...
For a systems engineer, HypoPG/hypopg belongs in the Catalogs inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T07:40:19Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:index stars:>100", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-ca407a8c33e6ca` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| lightcopy/parquet-index | Database Datastore | [open](catalogs-lightcopy-parquet-index-29380f23.md) |
| vitabaks/pg_auto_reindexer | Database Datastore | [open](catalogs-vitabaks-pg-auto-reindexer-5534086d.md) |
