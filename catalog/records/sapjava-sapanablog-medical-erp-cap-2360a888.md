...
<!-- canonical: https://github.com/sapanablog/Medical-ERP-CAP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sapanablog/Medical-ERP-CAP](https://github.com/sapanablog/Medical-ERP-CAP) |
| Source record ids | github_search_sapjava-b4a87be4dc2bfc |

## System Engineer Summary

SAP CAP Java + Spring Boot ERP for Medical Equipment Distribution with Fiori Elements, HANA, Draft,
Inventory, Orders, Packing, Billing and Logistics.

## Operational Role

For a systems engineer, sapanablog/Medical-ERP-CAP belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-12T14:42:34Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-b4a87be4dc2bfc` from `github_search_sapjava` as `registry_expansion`
