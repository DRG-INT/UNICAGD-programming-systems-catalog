...
<!-- canonical: https://cran.r-project.org/web/packages/icdGLM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/icdGLM/index.html](https://cran.r-project.org/web/packages/icdGLM/index.html) |
| Source record ids | cran_packages_by_date-ca27e486ac7805 |
...
For a systems engineer, icdGLM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-06 10:00:02 UTC | [https://cran.r-project.org/web/packages/icdGLM/DESCRIPTION](https://cran.r-project.org/web/packages/icdGLM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/icdGLM/DESCRIPTION` at `2026-09-06T10:18:56+00:00`.
...
- `cran_packages_by_date-ca27e486ac7805` from `cran_packages_by_date` as `registry_expansion`
