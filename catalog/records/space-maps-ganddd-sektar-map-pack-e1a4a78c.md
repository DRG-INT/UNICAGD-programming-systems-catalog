...
<!-- canonical: https://github.com/ganddd/Sektar-Map-Pack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ganddd/Sektar-Map-Pack](https://github.com/ganddd/Sektar-Map-Pack) |
| Source record ids | github_search_space_maps-05cf7f1e34cadd |

## System Engineer Summary

Map Pack for Planetary Annihilation

## Operational Role

For a systems engineer, ganddd/Sektar-Map-Pack belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-21T15:54:35Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-05cf7f1e34cadd` from `github_search_space_maps` as `registry_expansion`
