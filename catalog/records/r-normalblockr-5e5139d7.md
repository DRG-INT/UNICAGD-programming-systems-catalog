...
<!-- canonical: https://cran.r-project.org/web/packages/normalblockr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/normalblockr/index.html](https://cran.r-project.org/web/packages/normalblockr/index.html) |
| Source record ids | cran_packages_by_date-a58f10a0ab133e |

## System Engineer Summary

Gaussian Graphical Models with Latent Clustering Structure

## Operational Role

For a systems engineer, normalblockr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-03 12:00:02 UTC | [https://cran.r-project.org/web/packages/normalblockr/DESCRIPTION](https://cran.r-project.org/web/packages/normalblockr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/normalblockr/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-a58f10a0ab133e` from `cran_packages_by_date` as `registry_expansion`
