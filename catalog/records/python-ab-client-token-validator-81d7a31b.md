...
<!-- canonical: https://pypi.org/project/ab-client-token-validator/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-client-token-validator/](https://pypi.org/project/ab-client-token-validator/) |
| Source record ids | pypi_simple-0fa55fa5d3abb0 |
...
For a systems engineer, ab-client-token-validator belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-03-08T07:00:28.138571Z | [https://pypi.org/pypi/ab-client-token-validator/json](https://pypi.org/pypi/ab-client-token-validator/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-client-token-validator/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-0fa55fa5d3abb0` from `pypi_simple` as `registry_expansion`
