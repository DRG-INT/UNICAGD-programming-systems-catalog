...
<!-- canonical: https://packagist.org/packages/kdyby/redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kdyby/redis](https://packagist.org/packages/kdyby/redis) |
| Source record ids | packagist_search-7e5dad3f65cebf |
...
For a systems engineer, kdyby/redis belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-7e5dad3f65cebf` from `packagist_search` as `registry_expansion`
