...
| Name | Category | Page |
| --- | --- | --- |
| @aparajita/capacitor-biometric-auth | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aparajita-capacitor-biometric-auth-2db2e357.md) |
| @jitsi/logger | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-jitsi-logger-a6ac563c.md) |
