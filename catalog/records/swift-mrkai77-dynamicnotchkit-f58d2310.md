...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mrkai77/DynamicNotchKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mrkai77/DynamicNotchKit](https://github.com/mrkai77/DynamicNotchKit) |
| Source record ids | github_search_swift-997eeb245ab5be |
...
For a systems engineer, mrkai77/DynamicNotchKit belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T02:42:18Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-997eeb245ab5be` from `github_search_swift` as `registry_expansion`
