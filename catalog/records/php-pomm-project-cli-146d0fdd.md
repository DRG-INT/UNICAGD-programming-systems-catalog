...
<!-- canonical: https://packagist.org/packages/pomm-project/cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pomm-project/cli](https://packagist.org/packages/pomm-project/cli) |
| Source record ids | packagist_search-e091af5f945e79 |

## System Engineer Summary

pomm-project/cli is tracked as a cli record in the PHP branch. The source did not provide a long
...
For a systems engineer, pomm-project/cli belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-e091af5f945e79` from `packagist_search` as `registry_expansion`
...
| dekor/php-array-table | Cli | [open](php-dekor-php-array-table-39b979f5.md) |
