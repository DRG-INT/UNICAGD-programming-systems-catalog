...
| Canonical URL | [https://packagist.org/packages/friendsofsymfony/http-cache](https://packagist.org/packages/friendsofsymfony/http-cache) |
| Source record ids | packagist_search-d899c7239c5608 |
...
For a systems engineer, friendsofsymfony/http-cache belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-03-04T16:26:53+00:00 | [https://repo.packagist.org/p2/friendsofsymfony/http-cache.json](https://repo.packagist.org/p2/friendsofsymfony/http-cache.json) |  |
| preview | known | 2.0.0-beta3 | 2017-05-30T06:31:09+00:00 | [https://repo.packagist.org/p2/friendsofsymfony/http-cache.json](https://repo.packagist.org/p2/friendsofsymfony/http-cache.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/friendsofsymfony/http-cache.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-d899c7239c5608` from `packagist_search` as `registry_expansion`
