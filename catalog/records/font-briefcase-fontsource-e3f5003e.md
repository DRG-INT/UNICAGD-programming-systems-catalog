...
| Source record ids | curated_language_routes-103bf7b09cec13 |
...
For a systems engineer, Fontsource belongs in the Font Briefcase inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/fontsource/fontsource/releases/latest` at `2026-09-01T12:30:35+00:00`.
...
- `curated_language_routes-103bf7b09cec13` from `curated_language_routes` as `registry_expansion`
