...
<!-- canonical: https://github.com/apache/lucenenet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/lucenenet](https://github.com/apache/lucenenet) |
| Source record ids | github_search_catalogs-7094fa6c50ab6a |

## System Engineer Summary

Apache Lucene.NET is an open-source full-text search library written in C#, ported from the Apache
Lucene project.

## Operational Role

For a systems engineer, apache/lucenenet belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T16:48:27Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-7094fa6c50ab6a` from `github_search_catalogs` as `registry_expansion`
