...
<!-- canonical: https://github.com/sindresorhus/Gifski -->
<!-- crawl-delay: 10 -->
...
| Source record ids | github_search_swift-c3e3440afb5074 |
...
For a systems engineer, sindresorhus/Gifski belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-08T14:50:30Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-c3e3440afb5074` from `github_search_swift` as `registry_expansion`
