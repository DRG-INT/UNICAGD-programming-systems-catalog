...
<!-- canonical: https://pub.dev/packages/another_flushbar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/another_flushbar](https://pub.dev/packages/another_flushbar) |
| Source record ids | pub_dev-1c7ed88c044e6d |

## System Engineer Summary

A flexible widget for user notification. Customize your text, button, duration, animations and much
more. For Android devs, it is made to replace Snackbars and Toasts.

## Operational Role

For a systems engineer, another_flushbar belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.4 | 2026-05-15T19:20:40.831237Z | [https://pub.dev/api/packages/another_flushbar](https://pub.dev/api/packages/another_flushbar) |  |
| preview | known | 1.12.31-dev.1 | 2023-05-27T08:55:10.813640Z | [https://pub.dev/api/packages/another_flushbar](https://pub.dev/api/packages/another_flushbar) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/another_flushbar` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-1c7ed88c044e6d` from `pub_dev` as `registry_expansion`
