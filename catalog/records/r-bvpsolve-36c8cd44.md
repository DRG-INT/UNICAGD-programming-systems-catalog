...
<!-- canonical: https://cran.r-project.org/web/packages/bvpSolve/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bvpSolve/index.html](https://cran.r-project.org/web/packages/bvpSolve/index.html) |
| Source record ids | cran_packages_by_date-1899918975ef81 |
...
For a systems engineer, bvpSolve belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.4.2 | 2026-08-20 16:52:10 UTC | [https://cran.r-project.org/web/packages/bvpSolve/DESCRIPTION](https://cran.r-project.org/web/packages/bvpSolve/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bvpSolve/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-1899918975ef81` from `cran_packages_by_date` as `registry_expansion`
