# @agent-qofeno/security

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@agent-qofeno/security](https://www.npmjs.com/package/@agent-qofeno/security) |
| Source record ids | npm_registry-ab2fe8ce74dd43 |

## System Engineer Summary

@agent-qofeno/security is tracked as a security sast record in the Node.js/JavaScript branch. The
...
For a systems engineer, @agent-qofeno/security belongs in the Node.js/JavaScript inventory as part
of supply-chain review, vulnerability detection, and release gate enforcement.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-28T18:50:20.840Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T02:12:58+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| @aerogear/security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aerogear-security-3e4955aa.md) |
| @agentback/security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-agentback-security-0423f5a1.md) |
| @agentprodready/security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-agentprodready-security-946b1ea0.md) |
| @agentx-fast/security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-agentx-fast-security-197d4f6d.md) |
| @amaster.ai/pi-security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-amaster-ai-pi-security-58337460.md) |
| @andersmyrmel/vard | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-andersmyrmel-vard-40bc3faa.md) |
| @angular-helpers/security | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-helpers-security-6de6f357.md) |
| @api-components/api-security-documentation | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-api-components-api-security-documentation-df971aa6.md) |
