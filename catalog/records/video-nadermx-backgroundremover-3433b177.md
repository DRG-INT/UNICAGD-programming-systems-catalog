...
| Canonical URL | [https://github.com/nadermx/backgroundremover](https://github.com/nadermx/backgroundremover) |
| Source record ids | github_search_video-aec9ca56daf22e |

## System Engineer Summary

Background Remover lets you Remove Background from images and video using AI with a simple command
line interface that is free and open source.

## Operational Role

For a systems engineer, nadermx/backgroundremover belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.5 | 2026-07-10T01:23:27Z | [https://api.github.com/repos/nadermx/backgroundremover/releases/latest](https://api.github.com/repos/nadermx/backgroundremover/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nadermx/backgroundremover/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-aec9ca56daf22e` from `github_search_video` as `registry_expansion`
