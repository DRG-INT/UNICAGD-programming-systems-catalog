...
<!-- canonical: https://github.com/xandemon/developer-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xandemon/developer-icons](https://github.com/xandemon/developer-icons) |
| Source record ids | github_search_icons_and_logos-bffa53691f5d91 |

## System Engineer Summary

A collection of well-optimized SVG tech logos for developers and designers—customizable, scalable,
and free.

## Operational Role

For a systems engineer, xandemon/developer-icons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-08T12:33:35Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-bffa53691f5d91` from `github_search_icons_and_logos` as `registry_expansion`
