...
| Canonical URL | [https://packagist.org/packages/druidfi/mysqldump-php](https://packagist.org/packages/druidfi/mysqldump-php) |
| Source record ids | packagist_search-d688882d4cf7f0 |
...
For a systems engineer, druidfi/mysqldump-php belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-03-17T09:39:38+00:00 | [https://repo.packagist.org/p2/druidfi/mysqldump-php.json](https://repo.packagist.org/p2/druidfi/mysqldump-php.json) |  |
| preview | known | 2.0.0-rc1 | 2025-03-07T04:43:24+00:00 | [https://repo.packagist.org/p2/druidfi/mysqldump-php.json](https://repo.packagist.org/p2/druidfi/mysqldump-php.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/druidfi/mysqldump-php.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-d688882d4cf7f0` from `packagist_search` as `registry_expansion`
