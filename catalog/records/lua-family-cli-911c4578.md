...
<!-- canonical: https://luarocks.org/modules/gustavo-hms/cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gustavo-hms/cli](https://luarocks.org/modules/gustavo-hms/cli) |
| Source record ids | luarocks_root_manifest-69aae03ab32a25 |
...
For a systems engineer, cli belongs in the Lua family inventory as part of build graph control,
...
- `luarocks_root_manifest-69aae03ab32a25` from `luarocks_root_manifest` as `registry_expansion`
