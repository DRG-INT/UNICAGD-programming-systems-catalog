...
| Canonical URL | [https://luarocks.org/modules/pinbraerts/fnlfmt](https://luarocks.org/modules/pinbraerts/fnlfmt) |
| Source record ids | luarocks_root_manifest-bd6a03d0b2ec8e |

## System Engineer Summary

fnlfmt is tracked as a formatter record in the Lua family branch. The source did not provide a long
...
For a systems engineer, fnlfmt belongs in the Lua family inventory as part of low-noise code review,
...
- `luarocks_root_manifest-bd6a03d0b2ec8e` from `luarocks_root_manifest` as `registry_expansion`
