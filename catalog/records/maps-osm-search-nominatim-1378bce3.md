...
| Source record ids | github_search_maps-1ecbb978bae4b7 |
...
For a systems engineer, osm-search/Nominatim belongs in the Maps inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/osm-search/Nominatim/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-1ecbb978bae4b7` from `github_search_maps` as `registry_expansion`
