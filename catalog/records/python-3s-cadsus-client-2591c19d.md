...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/3s-cadsus-client/](https://pypi.org/project/3s-cadsus-client/) |
| Source record ids | pypi_simple-5b8da225e06004 |
...
For a systems engineer, 3s-cadsus-client belongs in the Python inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-04-22T01:17:48.024956Z | [https://pypi.org/pypi/3s-cadsus-client/json](https://pypi.org/pypi/3s-cadsus-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/3s-cadsus-client/json` at `2026-09-01T03:20:33+00:00`.
...
- `pypi_simple-5b8da225e06004` from `pypi_simple` as `registry_expansion`
