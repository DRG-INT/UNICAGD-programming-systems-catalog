...
<!-- canonical: https://github.com/WenjieDu/TSDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WenjieDu/TSDB](https://github.com/WenjieDu/TSDB) |
| Source record ids | github_search_databases-726c56e38474ef |

## System Engineer Summary

a Python toolbox loads 173 public time series datasets for machine/deep learning with a single line
of code. Datasets from multiple domains including healthcare, financial, power, traffic, weather,
and etc.

## Operational Role

For a systems engineer, WenjieDu/TSDB belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T08:00:15Z | gh search repos topic:time-series-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-726c56e38474ef` from `github_search_databases` as `registry_expansion`
