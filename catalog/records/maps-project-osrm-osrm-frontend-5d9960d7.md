...
<!-- canonical: https://github.com/Project-OSRM/osrm-frontend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Project-OSRM/osrm-frontend](https://github.com/Project-OSRM/osrm-frontend) |
| Source record ids | github_search_maps-8d10cf0a1bfdd2 |

## System Engineer Summary

Project-OSRM/osrm-frontend is tracked as a filesystem os record in the Maps branch. The source did
...
For a systems engineer, Project-OSRM/osrm-frontend belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T18:01:21Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-8d10cf0a1bfdd2` from `github_search_maps` as `registry_expansion`
