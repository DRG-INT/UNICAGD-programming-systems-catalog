...
| Canonical URL | [https://github.com/matlab/matlab-agentic-toolkit](https://github.com/matlab/matlab-agentic-toolkit) |
| Source record ids | github_search_matlab-b1757f0c5fd4c7 |

## System Engineer Summary

The MATLAB Agentic Toolkit brings trusted MATLAB capabilities to AI agents, making engineering and
scientific workflows agent-ready.

## Operational Role

For a systems engineer, matlab/matlab-agentic-toolkit belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.08.27 | 2026-08-27T15:36:03Z | [https://api.github.com/repos/matlab/matlab-agentic-toolkit/releases/latest](https://api.github.com/repos/matlab/matlab-agentic-toolkit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/matlab/matlab-agentic-toolkit/releases/latest` at `2026-09-01T07:24:11+00:00`.
...
- `github_search_matlab-b1757f0c5fd4c7` from `github_search_matlab` as `registry_expansion`
