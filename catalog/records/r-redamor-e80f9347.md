...
<!-- canonical: https://cran.r-project.org/web/packages/ReDaMoR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ReDaMoR/index.html](https://cran.r-project.org/web/packages/ReDaMoR/index.html) |
| Source record ids | cran_packages_by_date-79208007f40909 |

## System Engineer Summary

ReDaMoR is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, ReDaMoR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-21 05:45:49 UTC | [https://cran.r-project.org/web/packages/ReDaMoR/DESCRIPTION](https://cran.r-project.org/web/packages/ReDaMoR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ReDaMoR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-79208007f40909` from `cran_packages_by_date` as `registry_expansion`
