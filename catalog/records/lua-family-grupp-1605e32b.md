...
| Canonical URL | [https://luarocks.org/modules/shakna-israel/grupp](https://luarocks.org/modules/shakna-israel/grupp) |
| Source record ids | luarocks_root_manifest-372eef585be802 |

## System Engineer Summary

Grupp is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Grupp belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-372eef585be802` from `luarocks_root_manifest` as `registry_expansion`
