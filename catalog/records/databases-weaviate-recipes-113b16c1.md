...
<!-- canonical: https://github.com/weaviate/recipes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/weaviate/recipes](https://github.com/weaviate/recipes) |
| Source record ids | github_search_databases-95281be0ae614a |

## System Engineer Summary

This repository shares end-to-end notebooks on how to use various Weaviate features and
integrations!

## Operational Role

For a systems engineer, weaviate/recipes belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T18:00:42Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-95281be0ae614a` from `github_search_databases` as `registry_expansion`
