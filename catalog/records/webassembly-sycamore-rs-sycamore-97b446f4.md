...
<!-- canonical: https://github.com/sycamore-rs/sycamore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sycamore-rs/sycamore](https://github.com/sycamore-rs/sycamore) |
| Source record ids | github_search_webassembly-c07edacea99856 |
...
For a systems engineer, sycamore-rs/sycamore belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T03:52:01Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-c07edacea99856` from `github_search_webassembly` as `registry_expansion`
