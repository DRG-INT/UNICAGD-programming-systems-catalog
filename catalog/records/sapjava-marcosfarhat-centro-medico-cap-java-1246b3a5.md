# Marcosfarhat/centro-medico-cap-java
...
<!-- canonical: https://github.com/Marcosfarhat/centro-medico-cap-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Marcosfarhat/centro-medico-cap-java](https://github.com/Marcosfarhat/centro-medico-cap-java) |
| Source record ids | github_search_sapjava-c45f08a978f1aa |

## System Engineer Summary

)Centro médico CAP Java + Fiori Elements en SAP BTP — versión limpia siguiendo guía de errores

## Operational Role

For a systems engineer, Marcosfarhat/centro-medico-cap-java belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T02:22:28Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-c45f08a978f1aa` from `github_search_sapjava` as `registry_expansion`
