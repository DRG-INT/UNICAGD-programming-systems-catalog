...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaCoreVTK](https://github.com/JuliaRegistries/General/tree/master/C/ClimaCoreVTK) |
| Source record ids | julia_general-6f25164088a817 |

## System Engineer Summary

Julia package registered in General at C/ClimaCoreVTK.

## Operational Role

For a systems engineer, ClimaCoreVTK belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaCoreVTK", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-6f25164088a817` from `julia_general` as `registry_expansion`
