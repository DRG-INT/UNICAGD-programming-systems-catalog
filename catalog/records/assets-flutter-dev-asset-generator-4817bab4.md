...
<!-- canonical: https://github.com/flutter-dev/asset_generator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flutter-dev/asset_generator](https://github.com/flutter-dev/asset_generator) |
| Source record ids | github_search_assets-43ed24ec506ce3 |
...
For a systems engineer, flutter-dev/asset_generator belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-27T09:40:12Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-43ed24ec506ce3` from `github_search_assets` as `registry_expansion`
