...
<!-- canonical: https://github.com/pyscript/pyscript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pyscript/pyscript](https://github.com/pyscript/pyscript) |
| Source record ids | github_search_webassembly-dc79a195bbb0bc |

## System Engineer Summary

An open source platform for Python in the browser. Docs: Try it: Community:

## Operational Role

For a systems engineer, pyscript/pyscript belongs in the WebAssembly inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T19:33:48Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-dc79a195bbb0bc` from `github_search_webassembly` as `registry_expansion`
