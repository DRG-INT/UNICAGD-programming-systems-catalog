...
| Canonical URL | [https://github.com/bmachek/lrc-immich-plugin](https://github.com/bmachek/lrc-immich-plugin) |
| Source record ids | github_search_photography-4583e0a6c0e6b6 |

## System Engineer Summary

Lightroom Classic Plugin for Immich

## Operational Role

For a systems engineer, bmachek/lrc-immich-plugin belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.3.2 | 2026-07-11T05:32:05Z | [https://api.github.com/repos/bmachek/lrc-immich-plugin/releases/latest](https://api.github.com/repos/bmachek/lrc-immich-plugin/releases/latest) |  |
| preview | known | v5.0.0-alpha | 2026-07-25T04:48:02Z | [https://api.github.com/repos/bmachek/lrc-immich-plugin/releases?per_page=10](https://api.github.com/repos/bmachek/lrc-immich-plugin/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bmachek/lrc-immich-plugin/releases/latest` at `2026-09-01T09:23:29+00:00`.
...
- `github_search_photography-4583e0a6c0e6b6` from `github_search_photography` as `registry_expansion`
