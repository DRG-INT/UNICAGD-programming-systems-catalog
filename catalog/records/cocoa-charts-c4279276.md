...
<!-- canonical: https://cocoapods.org/pods/Charts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Charts](https://cocoapods.org/pods/Charts) |
| Source record ids | cocoapods_cdn-34e472a995da8d |
...
For a systems engineer, Charts belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2022-09-13 02:40:04 UTC | [https://trunk.cocoapods.org/api/v1/pods/Charts](https://trunk.cocoapods.org/api/v1/pods/Charts) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Charts` at `2026-09-01T07:21:27+00:00`.
...
- `cocoapods_cdn-34e472a995da8d` from `cocoapods_cdn` as `registry_expansion`
