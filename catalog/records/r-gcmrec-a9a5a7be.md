...
<!-- canonical: https://cran.r-project.org/web/packages/gcmrec/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gcmrec/index.html](https://cran.r-project.org/web/packages/gcmrec/index.html) |
| Source record ids | cran_packages_by_date-51e01a946cc120 |
...
For a systems engineer, gcmrec belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-12 14:10:22 UTC | [https://cran.r-project.org/web/packages/gcmrec/DESCRIPTION](https://cran.r-project.org/web/packages/gcmrec/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gcmrec/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-51e01a946cc120` from `cran_packages_by_date` as `registry_expansion`
