...
<!-- canonical: https://luarocks.org/modules/peterbillam/ecasound -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/peterbillam/ecasound](https://luarocks.org/modules/peterbillam/ecasound) |
| Source record ids | luarocks_root_manifest-4e6946cd85fc1e |
...
For a systems engineer, ecasound belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-4e6946cd85fc1e` from `luarocks_root_manifest` as `registry_expansion`
