...
| Source record ids | github_search_engines-9f3006c2c0f455 |

## System Engineer Summary

temporalio/temporal is tracked as a game engine game dev record in the Engines branch. The source
...
For a systems engineer, temporalio/temporal belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:21:46Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-9f3006c2c0f455` from `github_search_engines` as `registry_expansion`
