...
<!-- canonical: https://cran.r-project.org/web/packages/lucid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lucid/index.html](https://cran.r-project.org/web/packages/lucid/index.html) |
| Source record ids | cran_packages_by_date-8bc15054a65e2a |
...
For a systems engineer, lucid belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12 | 2026-09-03 16:20:08 UTC | [https://cran.r-project.org/web/packages/lucid/DESCRIPTION](https://cran.r-project.org/web/packages/lucid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lucid/DESCRIPTION` at `2026-09-03T17:18:57+00:00`.
...
- `cran_packages_by_date-8bc15054a65e2a` from `cran_packages_by_date` as `registry_expansion`
