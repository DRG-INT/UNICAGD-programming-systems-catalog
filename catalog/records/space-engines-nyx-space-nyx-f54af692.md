...
| Canonical URL | [https://github.com/nyx-space/nyx](https://github.com/nyx-space/nyx) |
| Source record ids | github_search_space_engines-4715c9f9845ebe |

## System Engineer Summary

Nyx is a high fidelity, fast, reliable and validated astrodynamics toolkit library written in Rust
and available in Python

## Operational Role

For a systems engineer, nyx-space/nyx belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.2 | 2026-08-30T20:35:15Z | [https://api.github.com/repos/nyx-space/nyx/releases/latest](https://api.github.com/repos/nyx-space/nyx/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nyx-space/nyx/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-4715c9f9845ebe` from `github_search_space_engines` as `registry_expansion`
