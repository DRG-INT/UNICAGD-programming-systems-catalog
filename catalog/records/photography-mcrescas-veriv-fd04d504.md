...
<!-- canonical: https://github.com/mcrescas/veriv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mcrescas/veriv](https://github.com/mcrescas/veriv) |
| Source record ids | github_search_photography-42b4983b659dda |

## System Engineer Summary

This extension provides you with a powerful viewer of LDR and HDR images (including animated), going
beyond the standard VS Code image preview. Optimize your remote workflows with seamless support,
eliminating file transfer hassles.

## Operational Role

For a systems engineer, mcrescas/veriv belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-29T12:24:44Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-42b4983b659dda` from `github_search_photography` as `registry_expansion`
