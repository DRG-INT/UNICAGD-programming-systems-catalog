...
<!-- canonical: https://gnu-octave.github.io/packages/mboct-numerical-pkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/mboct-numerical-pkg](https://gnu-octave.github.io/packages/mboct-numerical-pkg) |
| Source record ids | octave_packages_index-b035a2f3689ff8 |

## System Engineer Summary

This package belongs to a suite of packages which can be used for pre- and postprocessing of
flexible bodies in MBDyn (www.mbdyn.org) with GNU-Octave. It contains interfaces to several well
known numerical solvers.

## Operational Role

For a systems engineer, mboct-numerical-pkg belongs in the Octave inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2025-08-24 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-b035a2f3689ff8` from `octave_packages_index` as `registry_expansion`
