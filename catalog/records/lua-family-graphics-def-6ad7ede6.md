...
| Canonical URL | [https://luarocks.org/modules/freed-wu/graphics-def](https://luarocks.org/modules/freed-wu/graphics-def) |
| Source record ids | luarocks_root_manifest-096a5aa653ab9b |
...
For a systems engineer, graphics-def belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-096a5aa653ab9b` from `luarocks_root_manifest` as `registry_expansion`
