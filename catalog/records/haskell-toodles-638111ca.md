...
<!-- canonical: https://hackage.haskell.org/package/toodles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/toodles](https://hackage.haskell.org/package/toodles) |
| Source record ids | hackage_top_downloads-e1cd3a44c2788e |
...
For a systems engineer, toodles belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2019-07-19T17:37:52Z | [https://hackage.haskell.org/package/toodles](https://hackage.haskell.org/package/toodles) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/toodles` at `2026-09-05T00:32:06+00:00`.
...
- `hackage_top_downloads-e1cd3a44c2788e` from `hackage_top_downloads` as `registry_expansion`
