...
<!-- canonical: https://hackage.haskell.org/package/ppad-chacha -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ppad-chacha](https://hackage.haskell.org/package/ppad-chacha) |
| Source record ids | hackage_recent-9e119933c18e8c |
...
For a systems engineer, ppad-chacha belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-06T13:41:37Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-06T14:18:37+00:00`.
...
- `hackage_recent-9e119933c18e8c` from `hackage_recent` as `registry_expansion`
