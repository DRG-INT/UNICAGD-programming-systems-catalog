...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/christos42/CLDR_CLNER_models -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/christos42/CLDR_CLNER_models](https://github.com/christos42/CLDR_CLNER_models) |
| Source record ids | github_search_space_maps-ce0588d0f55817 |

## System Engineer Summary

Though language model text embeddings have revolutionized NLP research, their ability to capture
high-level semantic information, such as relations between entities in text, is limited. In this
paper, we propose a novel contrastive learning framework that trains sentence embeddings to encode
the relations in a graph structure. Given a sentence (unstructured text) and its graph, we use
contrastive learning to impose relation-related structure on the token level representations of the
sentence obtained with a CharacterBERT (El Boukkouri et al., 2020) model. The resulting relation-
aware sentence embeddings achieve state-of-the-art results on the relation extraction task using
only a simple KNN classifier, thereby demonstrating the success of the proposed method. Additional
visualization by a tSNE analysis shows the effectiveness of the learned representation space
compared to baselines. Furthermore, we show that we can learn a different space for named entity
recognition, again using a contrastive learning objective, and demonstrate how to successfully
combine both representation spaces in an entity-relation task.

## Operational Role

For a systems engineer, christos42/CLDR_CLNER_models belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-28T13:20:54Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-ce0588d0f55817` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| a7bdev/falak | Language Specification | [open](space-maps-a7bdev-falak-0cc64905.md) |
| ad-si/Woxi | Language Specification | [open](space-maps-ad-si-woxi-ece7dd2e.md) |
| arcsecond-io/standard-stars-catalogues | Language Specification | [open](space-maps-arcsecond-io-standard-stars-catalogues-92d84e53.md) |
| BASI-LABS/parseltongue | Language Specification | [open](space-maps-basi-labs-parseltongue-04dae62d.md) |
| biosshot/easyeda-copilot | Language Specification | [open](space-maps-biosshot-easyeda-copilot-429a5f5a.md) |
| clanker-lover/spicebridge | Language Specification | [open](space-maps-clanker-lover-spicebridge-3afc4a84.md) |
| electron-lang/electron | Language Specification | [open](space-maps-electron-lang-electron-98fd3718.md) |
| gnudatalanguage/gdl | Language Specification | [open](space-maps-gnudatalanguage-gdl-7750b9c1.md) |
