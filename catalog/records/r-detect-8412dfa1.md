...
<!-- canonical: https://cran.r-project.org/web/packages/detect/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/detect/index.html](https://cran.r-project.org/web/packages/detect/index.html) |
| Source record ids | cran_packages_by_date-4ef17bad833789 |
...
For a systems engineer, detect belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5-2 | 2026-09-01 07:30:02 UTC | [https://cran.r-project.org/web/packages/detect/DESCRIPTION](https://cran.r-project.org/web/packages/detect/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/detect/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-4ef17bad833789` from `cran_packages_by_date` as `registry_expansion`
