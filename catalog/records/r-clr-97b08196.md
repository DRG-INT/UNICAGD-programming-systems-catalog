...
<!-- canonical: https://cran.r-project.org/web/packages/clr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clr/index.html](https://cran.r-project.org/web/packages/clr/index.html) |
| Source record ids | cran_packages_by_date-4bae85a1dd724b |
...
For a systems engineer, clr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-31 20:50:03 UTC | [https://cran.r-project.org/web/packages/clr/DESCRIPTION](https://cran.r-project.org/web/packages/clr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4bae85a1dd724b` from `cran_packages_by_date` as `registry_expansion`
