...
<!-- canonical: https://github.com/tksuoran/erhe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tksuoran/erhe](https://github.com/tksuoran/erhe) |
| Source record ids | github_search_computer_graphics_software-9a5015639707a0 |

## System Engineer Summary

erhe is a C++ library and editor for 3D graphics with a graphics API abstraction loosely modeled
after Vulkan and Metal, with backends for OpenGL, Metal and Vulkan

## Operational Role

For a systems engineer, tksuoran/erhe belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-9a5015639707a0` from `github_search_computer_graphics_software` as `registry_expansion`
