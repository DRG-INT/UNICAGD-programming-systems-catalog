...
<!-- canonical: https://cran.r-project.org/web/packages/mapSpain/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mapSpain/index.html](https://cran.r-project.org/web/packages/mapSpain/index.html) |
| Source record ids | cran_packages_by_date-f1bf3c15f37d3d |
...
For a systems engineer, mapSpain belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-31 17:00:13 UTC | [https://cran.r-project.org/web/packages/mapSpain/DESCRIPTION](https://cran.r-project.org/web/packages/mapSpain/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mapSpain/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f1bf3c15f37d3d` from `cran_packages_by_date` as `registry_expansion`
