...
<!-- canonical: https://hackage.haskell.org/package/amazonka-iam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-iam](https://hackage.haskell.org/package/amazonka-iam) |
| Source record ids | hackage_top_downloads-68af58213ce205 |
...
For a systems engineer, amazonka-iam belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:36:45Z | [https://hackage.haskell.org/package/amazonka-iam](https://hackage.haskell.org/package/amazonka-iam) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-iam` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-68af58213ce205` from `hackage_top_downloads` as `registry_expansion`
