...
<!-- canonical: https://packagist.org/packages/nunomaduro/pao -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nunomaduro/pao](https://packagist.org/packages/nunomaduro/pao) |
| Source record ids | packagist_search-b5733c849d0f3d |
...
For a systems engineer, nunomaduro/pao belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-b5733c849d0f3d` from `packagist_search` as `registry_expansion`
