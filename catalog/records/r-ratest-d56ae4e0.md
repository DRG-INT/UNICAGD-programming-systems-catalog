...
<!-- canonical: https://cran.r-project.org/web/packages/RATest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RATest/index.html](https://cran.r-project.org/web/packages/RATest/index.html) |
| Source record ids | cran_packages_by_date-027b4ed6169839 |

## System Engineer Summary

RATest is tracked as a testing framework record in the R branch. The source did not provide a long
...
For a systems engineer, RATest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.11 | 2026-08-21 21:40:02 UTC | [https://cran.r-project.org/web/packages/RATest/DESCRIPTION](https://cran.r-project.org/web/packages/RATest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RATest/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-027b4ed6169839` from `cran_packages_by_date` as `registry_expansion`
