...
<!-- canonical: https://github.com/WebAssembly/stack-switching -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/stack-switching](https://github.com/WebAssembly/stack-switching) |
| Source record ids | github_search_webassembly-9e7ae79d25fb42 |
...
For a systems engineer, WebAssembly/stack-switching belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T15:55:21Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-9e7ae79d25fb42` from `github_search_webassembly` as `registry_expansion`
