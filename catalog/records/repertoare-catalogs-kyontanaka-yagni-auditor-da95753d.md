...
<!-- canonical: https://github.com/KyonTanaka/yagni-auditor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KyonTanaka/yagni-auditor](https://github.com/KyonTanaka/yagni-auditor) |
| Source record ids | github_search_repertoare_catalogs-43ec379c7ee5d2 |

## System Engineer Summary

Audit system for skills and configurations. Detects silent token tax, activation cascades, analysis
paralysis, and unnecessary catalogs via a 4-phase static analysis. Pure analysis (zero code
execution), 100% local, dependency-free. YAGNI score: 0–10 per architecture. Sistema de auditoría
para skills y configuraciones.

## Operational Role

For a systems engineer, KyonTanaka/yagni-auditor belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T14:59:48Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-43ec379c7ee5d2` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bolleta/tse-screener | Dependency Manager | [open](repertoare-catalogs-bolleta-tse-screener-3c1b0856.md) |
