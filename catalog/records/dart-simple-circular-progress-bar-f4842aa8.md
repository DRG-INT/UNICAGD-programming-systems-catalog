...
<!-- canonical: https://pub.dev/packages/simple_circular_progress_bar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/simple_circular_progress_bar](https://pub.dev/packages/simple_circular_progress_bar) |
| Source record ids | pub_dev-d80703643b1b55 |
...
For a systems engineer, simple_circular_progress_bar belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2022-07-06T12:58:21.282102Z | [https://pub.dev/api/packages/simple_circular_progress_bar](https://pub.dev/api/packages/simple_circular_progress_bar) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/simple_circular_progress_bar` at `2026-09-15T22:19:07+00:00`.
...
- `pub_dev-d80703643b1b55` from `pub_dev` as `registry_expansion`
...
| super_sliver_list | Precommit Ci Quality | [open](dart-super-sliver-list-c69de4d6.md) |
