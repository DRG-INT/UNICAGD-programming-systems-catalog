...
| Canonical URL | [https://crates.io/crates/gix-quote](https://crates.io/crates/gix-quote) |
| Source record ids | crates_io-ca661fe7df3030 |
...
For a systems engineer, gix-quote belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-22T19:00:53.776624Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-ca661fe7df3030` from `crates_io` as `registry_expansion`
