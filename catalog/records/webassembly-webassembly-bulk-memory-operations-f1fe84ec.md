...
<!-- canonical: https://github.com/WebAssembly/bulk-memory-operations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/bulk-memory-operations](https://github.com/WebAssembly/bulk-memory-operations) |
| Source record ids | github_search_webassembly-60c641e9ffc099 |

## System Engineer Summary

WebAssembly/bulk-memory-operations is tracked as a language specification record in the WebAssembly
...
For a systems engineer, WebAssembly/bulk-memory-operations belongs in the WebAssembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-31T19:39:05Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-60c641e9ffc099` from `github_search_webassembly` as `registry_expansion`
