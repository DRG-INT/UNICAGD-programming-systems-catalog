...
| Source record ids | master-d598fb1f10d8 |

## System Engineer Summary

GDB is tracked as a debugger record in the C99 branch. The source did not provide a long
...
For a systems engineer, GDB belongs in the C99 inventory as part of fault isolation, live
...
- `master-d598fb1f10d8` from `master_json` as `debugger`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| LLDB | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-lldb-08521702.md) |
