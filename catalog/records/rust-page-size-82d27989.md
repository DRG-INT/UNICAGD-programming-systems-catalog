...
<!-- canonical: https://crates.io/crates/page_size -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/page_size](https://crates.io/crates/page_size) |
| Source record ids | crates_io-1e9cba56f4b499 |
...
For a systems engineer, page_size belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2023-08-03T21:00:43.475697Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-1e9cba56f4b499` from `crates_io` as `registry_expansion`
