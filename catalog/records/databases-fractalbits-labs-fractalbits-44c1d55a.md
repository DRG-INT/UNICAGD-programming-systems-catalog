...
<!-- canonical: https://github.com/fractalbits-labs/fractalbits -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fractalbits-labs/fractalbits](https://github.com/fractalbits-labs/fractalbits) |
| Source record ids | github_search_databases-b4e01965c254ac |

## System Engineer Summary

Ultra-high performance distributed storage system in the AI era. Powered by Fractal ART engine,
Rust-native, io_uring, with multi-protocol (S3 object storage, POSIX FS, ...)

## Operational Role

For a systems engineer, fractalbits-labs/fractalbits belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T14:08:00Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b4e01965c254ac` from `github_search_databases` as `registry_expansion`
