...
<!-- canonical: https://github.com/maplibre/demotiles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/demotiles](https://github.com/maplibre/demotiles) |
| Source record ids | github_search_maps-f985be1da10a8c |
...
For a systems engineer, maplibre/demotiles belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T17:15:02Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f985be1da10a8c` from `github_search_maps` as `registry_expansion`
