...
<!-- canonical: https://crates.io/crates/objc2-foundation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2-foundation](https://crates.io/crates/objc2-foundation) |
| Source record ids | crates_io-5382276f4650e3 |
...
For a systems engineer, objc2-foundation belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T15:47:21.149969Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-5382276f4650e3` from `crates_io` as `registry_expansion`
