...
<!-- canonical: https://packagist.org/packages/symfony/http-client-contracts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/http-client-contracts](https://packagist.org/packages/symfony/http-client-contracts) |
| Source record ids | packagist_search-49d8efac214afe |
...
For a systems engineer, symfony/http-client-contracts belongs in the PHP inventory as part of
...
- `packagist_search-49d8efac214afe` from `packagist_search` as `registry_expansion`
