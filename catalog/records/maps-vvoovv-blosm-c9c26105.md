...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Coverage](../by-category/coverage.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vvoovv/blosm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vvoovv/blosm](https://github.com/vvoovv/blosm) |
| Source record ids | github_search_maps-831af40b9917a7 |

## System Engineer Summary

Blosm addon for Blender. A few clicks import of Google 3D cities, OpenStreetMap, terrain. Global
coverage. Source code is in the branch 'release'.

## Operational Role

For a systems engineer, vvoovv/blosm belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T12:10:53Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-831af40b9917a7` from `github_search_maps` as `registry_expansion`
