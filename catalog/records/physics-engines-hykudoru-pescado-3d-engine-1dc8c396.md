...
<!-- canonical: https://github.com/Hykudoru/Pescado-3D-Engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Hykudoru/Pescado-3D-Engine](https://github.com/Hykudoru/Pescado-3D-Engine) |
| Source record ids | github_search_physics_engines-db975ee2fedae2 |
...
For a systems engineer, Hykudoru/Pescado-3D-Engine belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-04T19:59:18Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-db975ee2fedae2` from `github_search_physics_engines` as `registry_expansion`
