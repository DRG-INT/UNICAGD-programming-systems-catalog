...
| Source record ids | github_search_font_briefcase-cc492b5e28265b |
...
For a systems engineer, nuxt/fonts belongs in the Font Briefcase inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:37:27Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-cc492b5e28265b` from `github_search_font_briefcase` as `registry_expansion`
