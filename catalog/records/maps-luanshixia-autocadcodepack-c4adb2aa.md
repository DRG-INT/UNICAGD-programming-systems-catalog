...
<!-- canonical: https://github.com/luanshixia/AutoCADCodePack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luanshixia/AutoCADCodePack](https://github.com/luanshixia/AutoCADCodePack) |
| Source record ids | github_search_maps-7f9ea210e53bb3 |

## System Engineer Summary

AutoCAD Code Pack: A powerful library that helps you to develop AutoCAD plugins using the AutoCAD
.NET API

## Operational Role

For a systems engineer, luanshixia/AutoCADCodePack belongs in the Maps inventory as part of
...
- `github_search_maps-7f9ea210e53bb3` from `github_search_maps` as `registry_expansion`
