...
<!-- canonical: https://github.com/Cr1ator/FontMuse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cr1ator/FontMuse](https://github.com/Cr1ator/FontMuse) |
| Source record ids | github_search_font_briefcase-d8ebdbc91da0d1 |

## System Engineer Summary

A sleek, modern font manager and preview tool for Windows, built with Rust, Tauri 2.0, and Next.js.
Features live clipboard monitoring and a beautiful UI.

## Operational Role

For a systems engineer, Cr1ator/FontMuse belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-22T20:39:31Z | gh search repos topic:font-manager stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-d8ebdbc91da0d1` from `github_search_font_briefcase` as `registry_expansion`
