...
<!-- canonical: https://github.com/mapeditor/tiled -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mapeditor/tiled](https://github.com/mapeditor/tiled) |
| Source record ids | github_search_game_engines-bfe0fd0851064d |

## System Engineer Summary

mapeditor/tiled is tracked as an ide editor integration record in the Game Engines branch. The
...
For a systems engineer, mapeditor/tiled belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:00:16Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-bfe0fd0851064d` from `github_search_game_engines` as `registry_expansion`
