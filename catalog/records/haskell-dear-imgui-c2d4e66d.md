...
<!-- canonical: https://hackage.haskell.org/package/dear-imgui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dear-imgui](https://hackage.haskell.org/package/dear-imgui) |
| Source record ids | hackage_top_downloads-263ae1e2d7f372 |
...
For a systems engineer, dear-imgui belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2026-08-22T13:36:21Z | [https://hackage.haskell.org/package/dear-imgui](https://hackage.haskell.org/package/dear-imgui) |  |
| candidate | partial | 2.3.0 |  | [https://hackage.haskell.org/package/dear-imgui](https://hackage.haskell.org/package/dear-imgui) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dear-imgui` at `2026-09-04T00:30:47+00:00`.
...
- `hackage_top_downloads-263ae1e2d7f372` from `hackage_top_downloads` as `registry_expansion`
