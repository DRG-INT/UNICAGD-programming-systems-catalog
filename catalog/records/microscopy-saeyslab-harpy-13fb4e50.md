...
| Canonical URL | [https://github.com/saeyslab/harpy](https://github.com/saeyslab/harpy) |
| Source record ids | github_search_microscopy-2f3b2d210ce8dc |
...
For a systems engineer, saeyslab/harpy belongs in the Microscopy inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.4 | 2026-07-06T13:45:20Z | [https://api.github.com/repos/saeyslab/harpy/releases/latest](https://api.github.com/repos/saeyslab/harpy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/saeyslab/harpy/releases/latest` at `2026-09-01T11:22:10+00:00`.
...
- `github_search_microscopy-2f3b2d210ce8dc` from `github_search_microscopy` as `registry_expansion`
...
| royerlab/napari-mcp | Build System | [open](microscopy-royerlab-napari-mcp-5804742f.md) |
