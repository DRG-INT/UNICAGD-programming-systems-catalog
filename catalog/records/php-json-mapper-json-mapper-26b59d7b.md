...
<!-- canonical: https://packagist.org/packages/json-mapper/json-mapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/json-mapper/json-mapper](https://packagist.org/packages/json-mapper/json-mapper) |
| Source record ids | packagist_search-0013087ed13bd5 |
...
For a systems engineer, json-mapper/json-mapper belongs in the PHP inventory as part of wire
...
| Evidence | MIT + file LICENSE; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `packagist_search-0013087ed13bd5` from `packagist_search` as `registry_expansion`
