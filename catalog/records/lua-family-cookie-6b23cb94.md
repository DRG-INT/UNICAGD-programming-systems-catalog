...
<!-- canonical: https://luarocks.org/modules/mah0x211/cookie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/cookie](https://luarocks.org/modules/mah0x211/cookie) |
| Source record ids | luarocks_root_manifest-4aeed20fb667ca |

## System Engineer Summary

cookie is tracked as a networking http record in the Lua family branch. The source did not provide a
...
For a systems engineer, cookie belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-4aeed20fb667ca` from `luarocks_root_manifest` as `registry_expansion`
