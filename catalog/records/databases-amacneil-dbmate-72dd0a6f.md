...
<!-- canonical: https://github.com/amacneil/dbmate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amacneil/dbmate](https://github.com/amacneil/dbmate) |
| Source record ids | github_search_databases-152da44a1a1326 |
...
For a systems engineer, amacneil/dbmate belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:28:09Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-152da44a1a1326` from `github_search_databases` as `registry_expansion`
