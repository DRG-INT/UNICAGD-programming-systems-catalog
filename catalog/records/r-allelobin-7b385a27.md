...
<!-- canonical: https://cran.r-project.org/web/packages/AlleloBin/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AlleloBin/index.html](https://cran.r-project.org/web/packages/AlleloBin/index.html) |
| Source record ids | cran_packages_by_date-719cb152bd1a54 |

## System Engineer Summary

A Shiny Application for Allele Binning in Microsatellite Markers

## Operational Role

For a systems engineer, AlleloBin belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-10 09:10:02 UTC | [https://cran.r-project.org/web/packages/AlleloBin/DESCRIPTION](https://cran.r-project.org/web/packages/AlleloBin/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AlleloBin/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-719cb152bd1a54` from `cran_packages_by_date` as `registry_expansion`
