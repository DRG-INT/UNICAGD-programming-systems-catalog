...
<!-- canonical: https://github.com/Tencent/WeKnora -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tencent/WeKnora](https://github.com/Tencent/WeKnora) |
| Source record ids | github_search_go-d38c502b39afd0 |

## System Engineer Summary

Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning
agent, and a self-maintaining Wiki.

## Operational Role

For a systems engineer, Tencent/WeKnora belongs in the Go inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:45:52Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-d38c502b39afd0` from `github_search_go` as `registry_expansion`
