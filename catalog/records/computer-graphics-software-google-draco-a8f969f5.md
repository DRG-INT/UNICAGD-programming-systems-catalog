...
<!-- canonical: https://github.com/google/draco -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/google/draco](https://github.com/google/draco) |
| Source record ids | github_search_computer_graphics_software-f3ed53d0d38e55 |

## System Engineer Summary

Draco is a library for compressing and decompressing 3D geometric meshes and point clouds. It is
intended to improve the storage and transmission of 3D graphics.

## Operational Role

For a systems engineer, google/draco belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-f3ed53d0d38e55` from `github_search_computer_graphics_software` as `registry_expansion`
