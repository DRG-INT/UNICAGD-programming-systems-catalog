...
<!-- canonical: https://cran.r-project.org/web/packages/MPCR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MPCR/index.html](https://cran.r-project.org/web/packages/MPCR/index.html) |
| Source record ids | cran_packages_by_date-7acde7a6d072fc |
...
For a systems engineer, MPCR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2026-08-23 15:40:02 UTC | [https://cran.r-project.org/web/packages/MPCR/DESCRIPTION](https://cran.r-project.org/web/packages/MPCR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MPCR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7acde7a6d072fc` from `cran_packages_by_date` as `registry_expansion`
