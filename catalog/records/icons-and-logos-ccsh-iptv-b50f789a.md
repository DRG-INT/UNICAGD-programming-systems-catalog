...
<!-- canonical: https://github.com/CCSH/IPTV -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CCSH/IPTV](https://github.com/CCSH/IPTV) |
| Source record ids | github_search_icons_and_logos-e8d46e83e66d12 |

## System Engineer Summary

一个免费、轻量、全自动化的直播源、台标 Logo 与 EPG 电子节目指南网络采集同步工具。自动拉取并整合互联网公开资源，格式化输出，适配 IPTV、电视盒子、手机直播 APP
等主流使用场景。（自动采集、测速、无广告）

## Operational Role

For a systems engineer, CCSH/IPTV belongs in the Icons and Logos inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T10:03:59Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-e8d46e83e66d12` from `github_search_icons_and_logos` as `registry_expansion`
