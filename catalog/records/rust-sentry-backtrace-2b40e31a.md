...
| Canonical URL | [https://crates.io/crates/sentry-backtrace](https://crates.io/crates/sentry-backtrace) |
| Source record ids | crates_io-a12ab8b0eb2578 |
...
For a systems engineer, sentry-backtrace belongs in the Rust inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.49.2 | 2026-08-26T14:42:30.865646Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-a12ab8b0eb2578` from `crates_io` as `registry_expansion`
