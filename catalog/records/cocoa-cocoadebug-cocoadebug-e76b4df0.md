...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/CocoaDebug/CocoaDebug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CocoaDebug/CocoaDebug](https://github.com/CocoaDebug/CocoaDebug) |
| Source record ids | github_search_cocoa-8d4dc44a4e4d03 |

## System Engineer Summary

CocoaDebug/CocoaDebug is tracked as a debugger record in the Cocoa branch. The source did not
...
For a systems engineer, CocoaDebug/CocoaDebug belongs in the Cocoa inventory as part of fault
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-11T12:45:10Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-8d4dc44a4e4d03` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kasketis/netfox | Debugger | [open](cocoa-kasketis-netfox-7a32f973.md) |
