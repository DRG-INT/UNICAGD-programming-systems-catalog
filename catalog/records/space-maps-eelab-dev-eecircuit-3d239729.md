...
<!-- canonical: https://github.com/eelab-dev/EEcircuit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eelab-dev/EEcircuit](https://github.com/eelab-dev/EEcircuit) |
| Source record ids | github_search_space_maps-ce8c447362bbcc |
...
For a systems engineer, eelab-dev/EEcircuit belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:09:58Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ce8c447362bbcc` from `github_search_space_maps` as `registry_expansion`
