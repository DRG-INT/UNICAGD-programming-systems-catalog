...
<!-- canonical: https://github.com/senthilrch/kube-fledged -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/senthilrch/kube-fledged](https://github.com/senthilrch/kube-fledged) |
| Source record ids | github_search_catalogs-1b78dd1fd155f3 |

## System Engineer Summary

A kubernetes operator for creating and managing a cache of container images directly on the cluster
worker nodes, so application pods start almost instantly

## Operational Role

For a systems engineer, senthilrch/kube-fledged belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-17T10:52:16Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-1b78dd1fd155f3` from `github_search_catalogs` as `registry_expansion`
