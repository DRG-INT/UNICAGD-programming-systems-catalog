...
<!-- canonical: https://github.com/siracalaks/vektra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/siracalaks/vektra](https://github.com/siracalaks/vektra) |
| Source record ids | github_search_repertoare_catalogs-c7acac0114c2b5 |

## System Engineer Summary

A VektraDev open-source product — a self-harvesting, AI-scored developer-tool intelligence library +
zero-install dashboard. Harvests the web daily, reads & scores each tool with an LLM, answers over
it, grows its own catalog. Self-hosted on n8n + Supabase + Claude + Gemini.

## Operational Role

For a systems engineer, siracalaks/vektra belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T07:00:10Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-c7acac0114c2b5` from `github_search_repertoare_catalogs` as `registry_expansion`
