...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/scienta/doctrine-json-functions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/scienta/doctrine-json-functions](https://packagist.org/packages/scienta/doctrine-json-functions) |
| Source record ids | packagist_search-1a12ef0e558218 |
...
For a systems engineer, scienta/doctrine-json-functions belongs in the PHP inventory as part of wire
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-03 | `{"kind": "packagist_search_and_p2_api", "query": "json", "retrieved": "2026-09-03", "status": "registry-derived"}` |
...
- `packagist_search-1a12ef0e558218` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adhocore/jwt | Serialization | [open](php-adhocore-jwt-2217f67d.md) |
| aimeos/ai-client-jsonapi | Serialization | [open](php-aimeos-ai-client-jsonapi-dc6c0b06.md) |
| api-platform/json-schema | Serialization | [open](php-api-platform-json-schema-12b34fe2.md) |
| api-platform/jsonld | Serialization | [open](php-api-platform-jsonld-6716bfbc.md) |
| apimatic/jsonmapper | Serialization | [open](php-apimatic-jsonmapper-826b756c.md) |
| artesaos/seotools | Serialization | [open](php-artesaos-seotools-69a21a5c.md) |
| auth0/auth0-php | Serialization | [open](php-auth0-auth0-php-ae8ab54a.md) |
| beste/json | Serialization | [open](php-beste-json-8432c87b.md) |
