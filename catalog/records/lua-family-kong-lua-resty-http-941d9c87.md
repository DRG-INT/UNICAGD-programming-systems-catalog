...
| Canonical URL | [https://luarocks.org/modules/kong/kong-lua-resty-http](https://luarocks.org/modules/kong/kong-lua-resty-http) |
| Source record ids | luarocks_root_manifest-417f7e7cd7bdec |
...
For a systems engineer, kong-lua-resty-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-417f7e7cd7bdec` from `luarocks_root_manifest` as `registry_expansion`
