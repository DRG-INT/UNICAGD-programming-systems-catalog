...
<!-- canonical: https://luarocks.org/modules/neorocks/animation.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/animation.nvim](https://luarocks.org/modules/neorocks/animation.nvim) |
| Source record ids | luarocks_root_manifest-54ddea588ad540 |

## System Engineer Summary

An OOP library to create animations in Neovim.

## Operational Role

For a systems engineer, animation.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-54ddea588ad540` from `luarocks_root_manifest` as `registry_expansion`
