...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/zephyo/2D-Unity-Experiments -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zephyo/2D-Unity-Experiments](https://github.com/zephyo/2D-Unity-Experiments) |
| Source record ids | github_search_effects-93925ceed239cf |
...
For a systems engineer, zephyo/2D-Unity-Experiments belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-23T22:46:48Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_effects-93925ceed239cf` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| canonical/wlcs | Testing Framework | [open](effects-canonical-wlcs-0e2f6e21.md) |
| greatest-ape/OctaSine | Testing Framework | [open](effects-greatest-ape-octasine-7fa71b9c.md) |
| keijiro/NNAOTest | Testing Framework | [open](effects-keijiro-nnaotest-9909441c.md) |
| keijiro/VfxGraphTestbed | Testing Framework | [open](effects-keijiro-vfxgraphtestbed-63ba4cd6.md) |
| simeonradivoev/ComputeStochasticReflections | Testing Framework | [open](effects-simeonradivoev-computestochasticreflections-5ef51cbb.md) |
