...
| Canonical URL | [https://github.com/SagerNet/sing-box](https://github.com/SagerNet/sing-box) |
| Source record ids | github_search_go-44c5e662338095 |
...
For a systems engineer, SagerNet/sing-box belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T06:21:06Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-44c5e662338095` from `github_search_go` as `registry_expansion`
