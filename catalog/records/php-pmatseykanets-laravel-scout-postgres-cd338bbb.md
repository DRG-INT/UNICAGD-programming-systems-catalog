...
<!-- canonical: https://packagist.org/packages/pmatseykanets/laravel-scout-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pmatseykanets/laravel-scout-postgres](https://packagist.org/packages/pmatseykanets/laravel-scout-postgres) |
| Source record ids | packagist_search-979576a7a2cda9 |
...
For a systems engineer, pmatseykanets/laravel-scout-postgres belongs in the PHP inventory as part of
...
- `packagist_search-979576a7a2cda9` from `packagist_search` as `registry_expansion`
