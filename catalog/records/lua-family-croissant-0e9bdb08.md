...
<!-- canonical: https://luarocks.org/modules/giann/croissant -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/giann/croissant](https://luarocks.org/modules/giann/croissant) |
| Source record ids | luarocks_root_manifest-8a21049e5212ad |
...
For a systems engineer, croissant belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-8a21049e5212ad` from `luarocks_root_manifest` as `registry_expansion`
