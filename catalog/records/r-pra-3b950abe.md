...
<!-- canonical: https://cran.r-project.org/web/packages/PRA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PRA/index.html](https://cran.r-project.org/web/packages/PRA/index.html) |
| Source record ids | cran_packages_by_date-25dc9a5189bc4c |

## System Engineer Summary

PRA is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, PRA belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-28 14:40:17 UTC | [https://cran.r-project.org/web/packages/PRA/DESCRIPTION](https://cran.r-project.org/web/packages/PRA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PRA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-25dc9a5189bc4c` from `cran_packages_by_date` as `registry_expansion`
