# Gitea: afzal/advocate-narsingdi
...
<!-- canonical: https://gitea.com/afzal/advocate-narsingdi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/afzal/advocate-narsingdi](https://gitea.com/afzal/advocate-narsingdi) |
| Source record ids | gitea_repositories_api-e3d99e4a22dfc9 |

## System Engineer Summary

Afzal Hosen Mandal - Advocate, Narsingdi Judge Court | Legal Services & Bangladesh Legal Research

## Operational Role

For a systems engineer, Gitea: afzal/advocate-narsingdi belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T20:28:48Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-e3d99e4a22dfc9` from `gitea_repositories_api` as `registry_expansion`
