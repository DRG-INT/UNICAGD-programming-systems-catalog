...
<!-- canonical: https://github.com/markyip/RAWviewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/markyip/RAWviewer](https://github.com/markyip/RAWviewer) |
| Source record ids | github_search_space_maps-9586024e29b6af |

## System Engineer Summary

Blazing-fast RAW culling for photographers: browse huge folders instantly, star-rate, compare, and
develop to XMP — no cloud, no catalog.

## Operational Role

For a systems engineer, markyip/RAWviewer belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T06:37:53Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9586024e29b6af` from `github_search_space_maps` as `registry_expansion`
