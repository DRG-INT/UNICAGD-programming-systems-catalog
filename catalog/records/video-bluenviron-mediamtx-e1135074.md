...
<!-- canonical: https://github.com/bluenviron/mediamtx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bluenviron/mediamtx](https://github.com/bluenviron/mediamtx) |
| Source record ids | github_search_video-eeabbcc6af17ed |

## System Engineer Summary

Ready-to-use Media-over-QUIC / SRT / WebRTC / RTSP / RTMP / LL-HLS / MPEG-TS / RTP live media server
and media proxy that allows to read, publish, proxy, record and playback real-time video and audio
streams.

## Operational Role

For a systems engineer, bluenviron/mediamtx belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:11:12Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-eeabbcc6af17ed` from `github_search_video` as `registry_expansion`
