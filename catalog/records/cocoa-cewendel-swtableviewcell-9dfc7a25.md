...
<!-- canonical: https://github.com/CEWendel/SWTableViewCell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CEWendel/SWTableViewCell](https://github.com/CEWendel/SWTableViewCell) |
| Source record ids | github_search_cocoa-070fba101b7d8b |

## System Engineer Summary

An easy-to-use UITableViewCell subclass that implements a swippable content view which exposes
utility buttons (similar to iOS 7 Mail Application)

## Operational Role

For a systems engineer, CEWendel/SWTableViewCell belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-20T14:43:51Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-070fba101b7d8b` from `github_search_cocoa` as `registry_expansion`
