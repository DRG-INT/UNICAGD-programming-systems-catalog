...
| Source record ids | github_search_icons_and_logos-00c30f7bc9aa8b |

## System Engineer Summary

Universal icon framework. One syntax for FontAwesome, Material Design Icons, DashIcons, Feather
Icons, EmojiOne, Noto Emoji and many other open source icon sets (over 200 icon sets and ~300k
icons). SVG framework, React, Vue and Svelte components!

## Operational Role

For a systems engineer, iconify/iconify belongs in the Icons and Logos inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T11:13:52Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-00c30f7bc9aa8b` from `github_search_icons_and_logos` as `registry_expansion`
