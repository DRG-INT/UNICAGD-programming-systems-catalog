...
<!-- canonical: https://cran.r-project.org/web/packages/tidyposterior/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidyposterior/index.html](https://cran.r-project.org/web/packages/tidyposterior/index.html) |
| Source record ids | cran_packages_by_date-d5d70b77a849df |
...
For a systems engineer, tidyposterior belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-02 13:30:03 UTC | [https://cran.r-project.org/web/packages/tidyposterior/DESCRIPTION](https://cran.r-project.org/web/packages/tidyposterior/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidyposterior/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-d5d70b77a849df` from `cran_packages_by_date` as `registry_expansion`
