...
<!-- canonical: https://pypi.org/project/ac-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ac-mcp-server/](https://pypi.org/project/ac-mcp-server/) |
| Source record ids | pypi_simple-5df43e96af8755 |
...
For a systems engineer, ac-mcp-server belongs in the Python inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2025-09-24T02:28:49.707564Z | [https://pypi.org/pypi/ac-mcp-server/json](https://pypi.org/pypi/ac-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ac-mcp-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-5df43e96af8755` from `pypi_simple` as `registry_expansion`
