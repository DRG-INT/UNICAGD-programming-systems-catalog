...
| Source record ids | corpus-ac8d7d09657901 |

## System Engineer Summary

lust is tracked as a testing framework record in the Lua family branch. The source did not provide a
...
For a systems engineer, lust belongs in the Lua family inventory as part of unit/integration
...
- `corpus-ac8d7d09657901` from `master_json` as `testing_framework`
