...
<!-- canonical: https://github.com/fleaflet/flutter_map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fleaflet/flutter_map](https://github.com/fleaflet/flutter_map) |
| Source record ids | github_search_maps-eda9b099dc4f6d |

## System Engineer Summary

Flutter's №1 non-commercially aimed map client: it's easy-to-use, versatile, vendor-free, fully
cross-platform, and 100% pure-Flutter

## Operational Role

For a systems engineer, fleaflet/flutter_map belongs in the Maps inventory as part of input-space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:20:29Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-eda9b099dc4f6d` from `github_search_maps` as `registry_expansion`
