...
<!-- canonical: https://github.com/knex/knex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/knex/knex](https://github.com/knex/knex) |
| Source record ids | github_search_databases-570b4322855e3a |

## System Engineer Summary

A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be
flexible, portable, and fun to use.

## Operational Role

For a systems engineer, knex/knex belongs in the Databases inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-26T15:02:12Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-570b4322855e3a` from `github_search_databases` as `registry_expansion`
