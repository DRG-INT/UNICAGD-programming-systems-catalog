...
<!-- canonical: https://www.npmjs.com/package/@eppo/node-server-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@eppo/node-server-sdk](https://www.npmjs.com/package/@eppo/node-server-sdk) |
| Source record ids | npm_registry-dab39086a874a3 |

## System Engineer Summary

@eppo/node-server-sdk is tracked as a web framework record in the Node.js/JavaScript branch. The
...
For a systems engineer, @eppo/node-server-sdk belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-01-28T00:02:05.606Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-dab39086a874a3` from `npm_registry` as `registry_expansion`
