...
<!-- canonical: https://crates.io/crates/pin-project-internal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pin-project-internal](https://crates.io/crates/pin-project-internal) |
| Source record ids | crates_io-759c54f39a822f |
...
For a systems engineer, pin-project-internal belongs in the Rust inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.13 | 2026-05-13T18:32:07.416866Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-759c54f39a822f` from `crates_io` as `registry_expansion`
