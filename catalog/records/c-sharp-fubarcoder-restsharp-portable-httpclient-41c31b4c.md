...
<!-- canonical: https://www.nuget.org/packages/FubarCoder.RestSharp.Portable.HttpClient -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/FubarCoder.RestSharp.Portable.HttpClient](https://www.nuget.org/packages/FubarCoder.RestSharp.Portable.HttpClient) |
| Source record ids | nuget_search-4afc196ed63e12 |

## System Engineer Summary

Some kind of a RestSharp port to PCL. This is not related to the RestSharp project at all! Supported
Platforms: - .NET Standard 1.1 - .NET Framework 4 - Silverlight 5 - Portable Class Libraries
(Profiles 259 and 328)

## Operational Role

For a systems engineer, FubarCoder.RestSharp.Portable.HttpClient belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.8 | 2017-03-06T14:30:56.033+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/fubarcoder.restsharp.portable.httpclient/index.json](https://api.nuget.org/v3/registration5-gz-semver2/fubarcoder.restsharp.portable.httpclient/index.json) |  |
| preview | known | 3.0.0-beta14 | 2015-11-26T10:15:56.66+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/fubarcoder.restsharp.portable.httpclient/index.json](https://api.nuget.org/v3/registration5-gz-semver2/fubarcoder.restsharp.portable.httpclient/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; http://choosealicense.com/licenses/bsd-2-clause/ |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/fubarcoder.restsharp.portable.httpclient/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-4afc196ed63e12` from `nuget_search` as `registry_expansion`
