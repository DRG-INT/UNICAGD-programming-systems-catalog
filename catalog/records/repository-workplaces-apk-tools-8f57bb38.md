...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Repository Workplaces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/repository-workplaces.md) · [Category: Package Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/package-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://gitlab.alpinelinux.org/alpine/apk-tools](https://gitlab.alpinelinux.org/alpine/apk-tools) |
| Source record ids | curated_repository_workplace_routes-c710ecf52c31d5 |

## System Engineer Summary

Alpine package manager tooling for package indexes, installation, upgrades, repositories,
signatures, and system package operations.

## Operational Role

For a systems engineer, apk-tools belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-c710ecf52c31d5` from `curated_repository_workplace_routes` as `registry_expansion`
