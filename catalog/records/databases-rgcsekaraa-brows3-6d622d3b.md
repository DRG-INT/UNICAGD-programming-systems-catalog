...
<!-- canonical: https://github.com/rgcsekaraa/brows3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rgcsekaraa/brows3](https://github.com/rgcsekaraa/brows3) |
| Source record ids | github_search_databases-cae436ec9b80c2 |

## System Engineer Summary

Super fast open-source S3 browser, S3 explorer, and desktop client for Amazon S3, MinIO, Cloudflare
R2, Wasabi, and other S3-compatible storage.

## Operational Role

For a systems engineer, rgcsekaraa/brows3 belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T11:48:25Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cae436ec9b80c2` from `github_search_databases` as `registry_expansion`
