...
<!-- canonical: https://cran.r-project.org/web/packages/scov/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scov/index.html](https://cran.r-project.org/web/packages/scov/index.html) |
| Source record ids | cran_packages_by_date-0bc35b7087dceb |
...
For a systems engineer, scov belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-28 12:20:02 UTC | [https://cran.r-project.org/web/packages/scov/DESCRIPTION](https://cran.r-project.org/web/packages/scov/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scov/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0bc35b7087dceb` from `cran_packages_by_date` as `registry_expansion`
