...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/martinber/noaa-apt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/martinber/noaa-apt](https://github.com/martinber/noaa-apt) |
| Source record ids | github_search_audio-f4cf6b0fc88ead |
...
For a systems engineer, martinber/noaa-apt belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-10T15:41:50Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_audio-f4cf6b0fc88ead` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| akunull/piloslib | Filesystem Os | [open](audio-akunull-piloslib-6084501c.md) |
| atsushieno/uapmd | Filesystem Os | [open](audio-atsushieno-uapmd-592e19c7.md) |
| AudioKit/AudioKitSynthOne | Filesystem Os | [open](audio-audiokit-audiokitsynthone-f3e02e66.md) |
| bartolsthoorn/NVDSP | Filesystem Os | [open](audio-bartolsthoorn-nvdsp-0a2b1682.md) |
| calf-studio-gear/calf | Filesystem Os | [open](audio-calf-studio-gear-calf-089316e7.md) |
| ceva-ip/DPDFNet | Filesystem Os | [open](audio-ceva-ip-dpdfnet-64adc0ae.md) |
| christofmuc/KnobKraft-orm | Filesystem Os | [open](audio-christofmuc-knobkraft-orm-c5ee3da6.md) |
| Conceptual-Machines/magda-core | Filesystem Os | [open](audio-conceptual-machines-magda-core-daf4c398.md) |
