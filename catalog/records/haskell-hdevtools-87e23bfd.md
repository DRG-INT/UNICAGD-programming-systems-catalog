...
<!-- canonical: https://hackage.haskell.org/package/hdevtools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hdevtools](https://hackage.haskell.org/package/hdevtools) |
| Source record ids | hackage_top_downloads-d114413aeb2497 |
...
For a systems engineer, hdevtools belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8.0 | 2019-03-10T21:15:36Z | [https://hackage.haskell.org/package/hdevtools](https://hackage.haskell.org/package/hdevtools) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hdevtools` at `2026-09-09T00:35:02+00:00`.
...
- `hackage_top_downloads-d114413aeb2497` from `hackage_top_downloads` as `registry_expansion`
