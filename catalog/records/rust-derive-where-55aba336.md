...
<!-- canonical: https://crates.io/crates/derive-where -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/derive-where](https://crates.io/crates/derive-where) |
| Source record ids | crates_io-167c0aa10eba11 |
...
For a systems engineer, derive-where belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-09-15T20:50:34.530354Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-15T22:18:53+00:00`.
...
- `crates_io-167c0aa10eba11` from `crates_io` as `registry_expansion`
