...
<!-- canonical: https://github.com/carloslack/KoviD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/carloslack/KoviD](https://github.com/carloslack/KoviD) |
| Source record ids | github_search_assembly-eb481738ae04c0 |

## System Engineer Summary

carloslack/KoviD is tracked as a filesystem os record in the Assembly branch. The source did not
...
For a systems engineer, carloslack/KoviD belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T15:05:07Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-eb481738ae04c0` from `github_search_assembly` as `registry_expansion`
