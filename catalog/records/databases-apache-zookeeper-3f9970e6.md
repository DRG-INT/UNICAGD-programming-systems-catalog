...
<!-- canonical: https://github.com/apache/zookeeper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/zookeeper](https://github.com/apache/zookeeper) |
| Source record ids | github_search_databases-f0bb295bbd0f33 |

## System Engineer Summary

apache/zookeeper is tracked as a database datastore record in the Databases branch. The source did
...
For a systems engineer, apache/zookeeper belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:14:50Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f0bb295bbd0f33` from `github_search_databases` as `registry_expansion`
