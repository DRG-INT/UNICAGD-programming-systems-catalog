...
<!-- canonical: https://pypi.org/project/a-a-chat-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a-a-chat-cli/](https://pypi.org/project/a-a-chat-cli/) |
| Source record ids | pypi_simple-b51af2a0c6cd38 |
...
For a systems engineer, a-a-chat-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-05-07T04:15:16.072339Z | [https://pypi.org/pypi/a-a-chat-cli/json](https://pypi.org/pypi/a-a-chat-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a-a-chat-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-b51af2a0c6cd38` from `pypi_simple` as `registry_expansion`
