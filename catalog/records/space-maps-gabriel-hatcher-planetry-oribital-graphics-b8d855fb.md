# Gabriel-Hatcher/Planetry_Oribital_Graphics
...
<!-- canonical: https://github.com/Gabriel-Hatcher/Planetry_Oribital_Graphics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Gabriel-Hatcher/Planetry_Oribital_Graphics](https://github.com/Gabriel-Hatcher/Planetry_Oribital_Graphics) |
| Source record ids | github_search_space_maps-f151c6eb5d1bb7 |

## System Engineer Summary

(POG) - A software using Python and Blender to visualize celestial bodies in real time from SPICE
kernels.

## Operational Role

For a systems engineer, Gabriel-Hatcher/Planetry_Oribital_Graphics belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-06T21:52:26Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f151c6eb5d1bb7` from `github_search_space_maps` as `registry_expansion`
