...
<!-- canonical: https://github.com/AcademySoftwareFoundation/OpenImageIO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AcademySoftwareFoundation/OpenImageIO](https://github.com/AcademySoftwareFoundation/OpenImageIO) |
| Source record ids | github_search_photography-cbd53b1bd73e4d |

## System Engineer Summary

Reading, writing, and processing images in a wide variety of file formats, using a format-agnostic
API, aimed at VFX applications.

## Operational Role

For a systems engineer, AcademySoftwareFoundation/OpenImageIO belongs in the Photography inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T17:50:19Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-cbd53b1bd73e4d` from `github_search_photography` as `registry_expansion`
