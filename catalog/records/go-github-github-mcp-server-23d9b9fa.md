...
<!-- canonical: https://github.com/github/github-mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/github/github-mcp-server](https://github.com/github/github-mcp-server) |
| Source record ids | github_search_go-600211e9dc0208 |
...
For a systems engineer, github/github-mcp-server belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T16:55:06Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-600211e9dc0208` from `github_search_go` as `registry_expansion`
