...
<!-- canonical: https://packagist.org/packages/php-jsonpatch/php-jsonpatch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-jsonpatch/php-jsonpatch](https://packagist.org/packages/php-jsonpatch/php-jsonpatch) |
| Source record ids | packagist_search-d58f7be3a0acc2 |
...
For a systems engineer, php-jsonpatch/php-jsonpatch belongs in the PHP inventory as part of wire
...
- `packagist_search-d58f7be3a0acc2` from `packagist_search` as `registry_expansion`
