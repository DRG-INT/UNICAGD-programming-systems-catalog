...
<!-- canonical: https://luarocks.org/modules/kristianjborgwarth/dendrite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kristianjborgwarth/dendrite](https://luarocks.org/modules/kristianjborgwarth/dendrite) |
| Source record ids | luarocks_root_manifest-18efec8f55eba7 |

## System Engineer Summary

A local, filesystem-based note engine for markdown vaults.

## Operational Role

For a systems engineer, dendrite belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-18efec8f55eba7` from `luarocks_root_manifest` as `registry_expansion`
