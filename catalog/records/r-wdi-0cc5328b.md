...
<!-- canonical: https://cran.r-project.org/web/packages/WDI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/WDI/index.html](https://cran.r-project.org/web/packages/WDI/index.html) |
| Source record ids | cran_packages_by_date-e06157ca133165 |
...
For a systems engineer, WDI belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0 | 2026-08-20 05:23:57 UTC | [https://cran.r-project.org/web/packages/WDI/DESCRIPTION](https://cran.r-project.org/web/packages/WDI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/WDI/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e06157ca133165` from `cran_packages_by_date` as `registry_expansion`
