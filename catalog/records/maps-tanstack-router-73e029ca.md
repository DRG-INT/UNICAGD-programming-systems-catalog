...
<!-- canonical: https://github.com/TanStack/router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TanStack/router](https://github.com/TanStack/router) |
| Source record ids | github_search_maps-dc1a928e22d070 |
...
For a systems engineer, TanStack/router belongs in the Maps inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | release-2026-08-26-2336 | 2026-08-26T23:36:44Z | [https://api.github.com/repos/TanStack/router/releases/latest](https://api.github.com/repos/TanStack/router/releases/latest) |  |
| preview | known | release-2026-08-29-0036 | 2026-08-29T00:36:32Z | [https://api.github.com/repos/TanStack/router/releases?per_page=10](https://api.github.com/repos/TanStack/router/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/TanStack/router/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-dc1a928e22d070` from `github_search_maps` as `registry_expansion`
...
| pelias/api | Networking Http | [open](maps-pelias-api-6b9020ab.md) |
| retroplasma/earth-reverse-engineering | Networking Http | [open](maps-retroplasma-earth-reverse-engineering-2b76b3bc.md) |
