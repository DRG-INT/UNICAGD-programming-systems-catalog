...
<!-- canonical: https://cran.r-project.org/web/packages/cantrends/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cantrends/index.html](https://cran.r-project.org/web/packages/cantrends/index.html) |
| Source record ids | cran_packages_by_date-c5ce8607f2eeb7 |

## System Engineer Summary

Fit Segmented Regression Models

## Operational Role

For a systems engineer, cantrends belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-26 20:00:08 UTC | [https://cran.r-project.org/web/packages/cantrends/DESCRIPTION](https://cran.r-project.org/web/packages/cantrends/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cantrends/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c5ce8607f2eeb7` from `cran_packages_by_date` as `registry_expansion`
