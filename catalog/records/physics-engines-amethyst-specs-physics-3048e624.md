...
<!-- canonical: https://github.com/amethyst/specs-physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amethyst/specs-physics](https://github.com/amethyst/specs-physics) |
| Source record ids | github_search_physics_engines-8ac2fe4b6acaac |
...
For a systems engineer, amethyst/specs-physics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-04T12:46:13Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8ac2fe4b6acaac` from `github_search_physics_engines` as `registry_expansion`
