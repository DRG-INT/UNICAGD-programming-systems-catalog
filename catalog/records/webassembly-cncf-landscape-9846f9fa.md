...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cncf/landscape -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cncf/landscape](https://github.com/cncf/landscape) |
| Source record ids | github_search_webassembly-855a50cada54ad |

## System Engineer Summary

🌄 The Cloud Native Interactive Landscape filters and sorts hundreds of projects and products, and
shows details including GitHub stars, funding, first and last commits, contributor counts and
headquarters location.

## Operational Role

For a systems engineer, cncf/landscape belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T22:59:05Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:wasm stars:>500", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_webassembly-855a50cada54ad` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| artichoke/artichoke | Undefined Behavior Analyzer | [open](webassembly-artichoke-artichoke-7b7d01c0.md) |
| deislabs/containerd-wasm-shims | Undefined Behavior Analyzer | [open](webassembly-deislabs-containerd-wasm-shims-81ef9764.md) |
| GitHub | Undefined Behavior Analyzer | [open](webassembly-github-2fedb258.md) |
| johnthagen/min-sized-rust | Undefined Behavior Analyzer | [open](webassembly-johnthagen-min-sized-rust-99ad1257.md) |
| krustlet/krustlet | Undefined Behavior Analyzer | [open](webassembly-krustlet-krustlet-5b1ab0fb.md) |
| meshery/meshery | Undefined Behavior Analyzer | [open](webassembly-meshery-meshery-7b46f863.md) |
| radzenhq/radzen-blazor | Undefined Behavior Analyzer | [open](webassembly-radzenhq-radzen-blazor-9ec846fe.md) |
| rollup/rollup-plugin-wasm | Undefined Behavior Analyzer | [open](webassembly-rollup-rollup-plugin-wasm-0bbe45cd.md) |
