...
<!-- canonical: https://github.com/headroomlabs-ai/headroom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) |
| Source record ids | github_search_aims-e03b427b5f88d5 |

## System Engineer Summary

Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20% fewer tokens for
coding agents, 60-95% fewer tokens for JSON, same answers. Library, proxy, MCP server.

## Operational Role

For a systems engineer, headroomlabs-ai/headroom belongs in the "aim's" inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T07:29:38Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-e03b427b5f88d5` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ONNX | Serialization | [open](aim-s-onnx-a7e4f39c.md) |
