...
| Canonical URL | [https://luarocks.org/modules/ubitransport/kong-plugin-acl-keycloak](https://luarocks.org/modules/ubitransport/kong-plugin-acl-keycloak) |
| Source record ids | luarocks_root_manifest-cb1a735cfd3193 |

## System Engineer Summary

A Kong ACL plugin for keycloak from old pravin-raha/kong-plugin-oidc-acl and fixed

## Operational Role

For a systems engineer, kong-plugin-acl-keycloak belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-cb1a735cfd3193` from `luarocks_root_manifest` as `registry_expansion`
