...
<!-- canonical: https://cran.r-project.org/web/packages/HaploVar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HaploVar/index.html](https://cran.r-project.org/web/packages/HaploVar/index.html) |
| Source record ids | cran_packages_by_date-b8415712554da9 |
...
For a systems engineer, HaploVar belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-07 06:40:36 UTC | [https://cran.r-project.org/web/packages/HaploVar/DESCRIPTION](https://cran.r-project.org/web/packages/HaploVar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HaploVar/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-b8415712554da9` from `cran_packages_by_date` as `registry_expansion`
