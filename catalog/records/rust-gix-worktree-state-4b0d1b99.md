...
| Canonical URL | [https://crates.io/crates/gix-worktree-state](https://crates.io/crates/gix-worktree-state) |
| Source record ids | crates_io-1d3001c9f14cac |
...
For a systems engineer, gix-worktree-state belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.34.1 | 2026-08-24T13:58:19.268992Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-1d3001c9f14cac` from `crates_io` as `registry_expansion`
