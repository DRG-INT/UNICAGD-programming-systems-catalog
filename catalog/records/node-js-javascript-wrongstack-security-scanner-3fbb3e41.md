...
| Canonical URL | [https://www.npmjs.com/package/@wrongstack/security-scanner](https://www.npmjs.com/package/@wrongstack/security-scanner) |
| Source record ids | npm_registry-36de2265ddbae2 |

## System Engineer Summary

WrongStack security scanner — standalone package extracted from @wrongstack/core. Tech-stack
detector, secret scanner, report generator, and interactive slash-command for on-demand security
scans.

## Operational Role

For a systems engineer, @wrongstack/security-scanner belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.317.2 | 2026-08-31T23:26:53.780Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| github-security-mcp | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-github-security-mcp-9086dace.md) |
