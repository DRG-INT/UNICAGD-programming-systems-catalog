...
<!-- canonical: https://github.com/CoplayDev/unity-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CoplayDev/unity-mcp](https://github.com/CoplayDev/unity-mcp) |
| Source record ids | github_search_game_engines-69ee3bd63c3df2 |

## System Engineer Summary

Unity MCP acts as a bridge between AI assistants and your Unity Editor. Give your LLM tools to
manage assets, control scenes, edit scripts, and automate tasks within Unity.

## Operational Role

For a systems engineer, CoplayDev/unity-mcp belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:25:12Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-69ee3bd63c3df2` from `github_search_game_engines` as `registry_expansion`
