...
<!-- canonical: https://luarocks.org/modules/freed-wu/cppjieba -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/cppjieba](https://luarocks.org/modules/freed-wu/cppjieba) |
| Source record ids | luarocks_root_manifest-2c8ed6efe7fac3 |

## System Engineer Summary

基于 cppjieba 的 neovim 中文词跳转

## Operational Role

For a systems engineer, cppjieba belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2c8ed6efe7fac3` from `luarocks_root_manifest` as `registry_expansion`
