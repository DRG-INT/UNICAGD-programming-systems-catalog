...
<!-- canonical: https://github.com/Mijick/Popups -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mijick/Popups](https://github.com/Mijick/Popups) |
| Source record ids | github_search_swift-df165e0f107cd0 |

## System Engineer Summary

Popups, popovers, sheets, alerts, toasts, banners, (...) presentation made simple. Written with and
for SwiftUI.

## Operational Role

For a systems engineer, Mijick/Popups belongs in the Swift inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-22T18:52:37Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-df165e0f107cd0` from `github_search_swift` as `registry_expansion`
