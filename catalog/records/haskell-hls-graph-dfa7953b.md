...
| Source record ids | hackage_top_downloads-9074f5a2bb9bbb |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.14.0.0 | 2026-04-27T06:48:02Z | [https://hackage.haskell.org/package/hls-graph](https://hackage.haskell.org/package/hls-graph) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hls-graph` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-9074f5a2bb9bbb` from `hackage_top_downloads` as `registry_expansion`
