...
<!-- canonical: https://hackage.haskell.org/package/hls-graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hls-graph](https://hackage.haskell.org/package/hls-graph) |
| Source record ids | hackage_recent-9074f5a2bb9bbb |

## System Engineer Summary

Hackage package recently uploaded by hls_team.

## Operational Role

For a systems engineer, hls-graph belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0.0 | 2026-09-04T10:38:08Z | [https://hackage.haskell.org/package/hls-graph](https://hackage.haskell.org/package/hls-graph) |  |
| candidate | partial | 1.7.0.0 |  | [https://hackage.haskell.org/package/hls-graph](https://hackage.haskell.org/package/hls-graph) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hls-graph` at `2026-09-04T13:25:56+00:00`.
...
- `hackage_recent-9074f5a2bb9bbb` from `hackage_recent` as `registry_expansion`
