...
<!-- canonical: https://github.com/ekzhang/inline-sql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ekzhang/inline-sql](https://github.com/ekzhang/inline-sql) |
| Source record ids | github_search_databases-4cbfec15a0ede7 |
...
For a systems engineer, ekzhang/inline-sql belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-17T00:50:09Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4cbfec15a0ede7` from `github_search_databases` as `registry_expansion`
