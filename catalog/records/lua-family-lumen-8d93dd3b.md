...
<!-- canonical: https://github.com/xopxe/Lumen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xopxe/Lumen](https://github.com/xopxe/Lumen) |
| Source record ids | lua-source-184 |
...
For a systems engineer, Lumen belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 184}}` |
...
- `lua-source-184` from `master_json` as `source_list_item`
