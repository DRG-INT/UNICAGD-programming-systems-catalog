...
<!-- canonical: https://pub.dev/packages/readmore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/readmore](https://pub.dev/packages/readmore) |
| Source record ids | pub_dev-2646f4acb382fe |

## System Engineer Summary

A Flutter package that allows for dynamic expansion and collapse of text, as well as interactions
with text patterns such as hashtags, URLs, and mentions.

## Operational Role

For a systems engineer, readmore belongs in the Dart inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-03-27T23:46:43.720438Z | [https://pub.dev/api/packages/readmore](https://pub.dev/api/packages/readmore) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/readmore` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-2646f4acb382fe` from `pub_dev` as `registry_expansion`
