...
<!-- canonical: https://cran.r-project.org/web/packages/Anthropometry/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Anthropometry/index.html](https://cran.r-project.org/web/packages/Anthropometry/index.html) |
| Source record ids | cran_packages_by_date-c4e42956899ed1 |
...
For a systems engineer, Anthropometry belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.22 | 2026-08-21 21:51:03 UTC | [https://cran.r-project.org/web/packages/Anthropometry/DESCRIPTION](https://cran.r-project.org/web/packages/Anthropometry/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Anthropometry/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c4e42956899ed1` from `cran_packages_by_date` as `registry_expansion`
