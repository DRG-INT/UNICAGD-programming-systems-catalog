...
<!-- canonical: https://luarocks.org/modules/tomasguisasola/cgilua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tomasguisasola/cgilua](https://luarocks.org/modules/tomasguisasola/cgilua) |
| Source record ids | luarocks_root_manifest-48bce00471d2a9 |
...
For a systems engineer, CGILua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-48bce00471d2a9` from `luarocks_root_manifest` as `registry_expansion`
