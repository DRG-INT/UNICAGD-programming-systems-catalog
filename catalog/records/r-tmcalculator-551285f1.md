...
<!-- canonical: https://cran.r-project.org/web/packages/TmCalculator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TmCalculator/index.html](https://cran.r-project.org/web/packages/TmCalculator/index.html) |
| Source record ids | cran_packages_by_date-8f5bc952b4918a |
...
For a systems engineer, TmCalculator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9 | 2026-08-28 14:10:02 UTC | [https://cran.r-project.org/web/packages/TmCalculator/DESCRIPTION](https://cran.r-project.org/web/packages/TmCalculator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TmCalculator/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8f5bc952b4918a` from `cran_packages_by_date` as `registry_expansion`
