...
<!-- canonical: https://cran.r-project.org/web/packages/evaluatellm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/evaluatellm/index.html](https://cran.r-project.org/web/packages/evaluatellm/index.html) |
| Source record ids | cran_packages_by_date-e2099827fb2027 |
...
For a systems engineer, evaluatellm belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 13:40:02 UTC | [https://cran.r-project.org/web/packages/evaluatellm/DESCRIPTION](https://cran.r-project.org/web/packages/evaluatellm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/evaluatellm/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-e2099827fb2027` from `cran_packages_by_date` as `registry_expansion`
