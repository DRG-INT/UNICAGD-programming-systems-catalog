...
<!-- canonical: https://cran.r-project.org/web/packages/DOEpro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DOEpro/index.html](https://cran.r-project.org/web/packages/DOEpro/index.html) |
| Source record ids | cran_packages_by_date-0328c9f123be93 |

## System Engineer Summary

Analysis of Designed Agricultural Experiments

## Operational Role

For a systems engineer, DOEpro belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-04 14:10:39 UTC | [https://cran.r-project.org/web/packages/DOEpro/DESCRIPTION](https://cran.r-project.org/web/packages/DOEpro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DOEpro/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0328c9f123be93` from `cran_packages_by_date` as `registry_expansion`
