...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sgoudelis/ground-station -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sgoudelis/ground-station](https://github.com/sgoudelis/ground-station) |
| Source record ids | github_search_satcom_satellites-97cc303c885c81 |

## System Engineer Summary

Browser-based ground station suite for satellite tracking, SDR reception, hardware control, and
telemetry decoding

## Operational Role

For a systems engineer, sgoudelis/ground-station belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T11:37:34Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-97cc303c885c81` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aboulogeorgos/Wireless-communication-systems-Lab | Logging Observability | [open](satcom-satellites-aboulogeorgos-wireless-communication-systems-lab-51897286.md) |
| analogdevicesinc/gr-iio | Logging Observability | [open](satcom-satellites-analogdevicesinc-gr-iio-e7f28c5e.md) |
| analogdevicesinc/plutosdr-fw | Logging Observability | [open](satcom-satellites-analogdevicesinc-plutosdr-fw-a29d6db0.md) |
| ANG13T/SatIntel | Logging Observability | [open](satcom-satellites-ang13t-satintel-b65eedb1.md) |
| mendhak/gpslogger | Logging Observability | [open](satcom-satellites-mendhak-gpslogger-84bde361.md) |
| sam210723/COMS-1 | Logging Observability | [open](satcom-satellites-sam210723-coms-1-fe0ec3b6.md) |
