...
| Canonical URL | [https://luarocks.org/modules/shevaha401/kong-oauth2-ext](https://luarocks.org/modules/shevaha401/kong-oauth2-ext) |
| Source record ids | luarocks_root_manifest-03cd8683661e83 |

## System Engineer Summary

kong-oauth2-ext is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, kong-oauth2-ext belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-03cd8683661e83` from `luarocks_root_manifest` as `registry_expansion`
