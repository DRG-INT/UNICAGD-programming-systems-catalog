# Showkath/cloud-cap-samples-java
...
<!-- canonical: https://github.com/Showkath/cloud-cap-samples-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Showkath/cloud-cap-samples-java](https://github.com/Showkath/cloud-cap-samples-java) |
| Source record ids | github_search_sapjava-d4fef36dec0dfd |

## System Engineer Summary

Sample Shopping cart application using SAP Cloud Application Programming Model(CAP) Java

## Operational Role

For a systems engineer, Showkath/cloud-cap-samples-java belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-20T12:52:49Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-d4fef36dec0dfd` from `github_search_sapjava` as `registry_expansion`
