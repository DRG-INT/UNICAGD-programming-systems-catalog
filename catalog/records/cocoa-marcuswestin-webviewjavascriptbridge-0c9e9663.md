...
<!-- canonical: https://github.com/marcuswestin/WebViewJavascriptBridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marcuswestin/WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) |
| Source record ids | github_search_cocoa-c071049f28f0b6 |
...
For a systems engineer, marcuswestin/WebViewJavascriptBridge belongs in the Cocoa inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-01T09:17:17Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-c071049f28f0b6` from `github_search_cocoa` as `registry_expansion`
