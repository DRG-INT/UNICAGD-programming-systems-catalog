...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/screen_protector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/screen_protector](https://pub.dev/packages/screen_protector) |
| Source record ids | pub_dev-b3c341e1a62ae5 |
...
For a systems engineer, screen_protector belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.3 | 2026-07-14T16:03:14.174293Z | [https://pub.dev/api/packages/screen_protector](https://pub.dev/api/packages/screen_protector) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/screen_protector` at `2026-09-01T16:41:10+00:00`.
...
- `pub_dev-b3c341e1a62ae5` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| file | Memory Analyzer | [open](dart-file-4190940c.md) |
| leak_tracker | Memory Analyzer | [open](dart-leak-tracker-9b65ce16.md) |
