...
<!-- canonical: https://github.com/piranna/wasmachine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/piranna/wasmachine](https://github.com/piranna/wasmachine) |
| Source record ids | awesome_list-879d1d543e0aba |

## System Engineer Summary

wasmachine - WebAssembly in a FPGA is tracked as a library record in the WebAssembly branch. The
...
For a systems engineer, wasmachine - WebAssembly in a FPGA belongs in the WebAssembly inventory as
...
- `awesome_list-879d1d543e0aba` from `awesome_list` as `registry_expansion`
