...
<!-- canonical: https://www.npmjs.com/package/mock-json-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mock-json-server](https://www.npmjs.com/package/mock-json-server) |
| Source record ids | npm_registry-9213933a4e4e6e |

## System Engineer Summary

mock-json-server is tracked as an assertion mocking record in the Node.js/JavaScript branch. The
...
For a systems engineer, mock-json-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.6 | 2020-07-14T20:41:39.080Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-9213933a4e4e6e` from `npm_registry` as `registry_expansion`
