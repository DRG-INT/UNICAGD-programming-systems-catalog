...
<!-- canonical: https://cran.r-project.org/web/packages/LiblineaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LiblineaR/index.html](https://cran.r-project.org/web/packages/LiblineaR/index.html) |
| Source record ids | cran_packages_by_date-d8418a8c0dcab8 |
...
For a systems engineer, LiblineaR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.10-25 | 2026-09-11 06:00:14 UTC | [https://cran.r-project.org/web/packages/LiblineaR/DESCRIPTION](https://cran.r-project.org/web/packages/LiblineaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LiblineaR/DESCRIPTION` at `2026-09-11T06:25:06+00:00`.
...
- `cran_packages_by_date-d8418a8c0dcab8` from `cran_packages_by_date` as `registry_expansion`
