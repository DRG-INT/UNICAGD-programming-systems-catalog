...
| Canonical URL | [https://github.com/firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) |
| Source record ids | github_search_aims-74a92d9c8e24bc |
...
For a systems engineer, firecrawl/firecrawl belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:40:24Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-74a92d9c8e24bc` from `github_search_aims` as `registry_expansion`
