...
<!-- canonical: https://gitea.com/ks/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/ks/devops](https://gitea.com/ks/devops) |
| Source record ids | gitea_repositories_api-07f9c7c2b63628 |
...
For a systems engineer, Gitea: ks/devops belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-25T08:45:30Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-07f9c7c2b63628` from `gitea_repositories_api` as `registry_expansion`
