...
<!-- canonical: https://github.com/burhanrashid52/WhatTodo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/burhanrashid52/WhatTodo](https://github.com/burhanrashid52/WhatTodo) |
| Source record ids | github_search_pattern_language-1a06f377d6c1bd |

## System Engineer Summary

A Simple Todo app design in Flutter to keep track of your task on daily basis. Its build on BLoC
Pattern. You can add a project, labels, and due-date to your task also you can sort your task on the
basis of project, label, and dates

## Operational Role

For a systems engineer, burhanrashid52/WhatTodo belongs in the Pattern language inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-12T14:45:30Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_pattern_language-1a06f377d6c1bd` from `github_search_pattern_language` as `registry_expansion`
