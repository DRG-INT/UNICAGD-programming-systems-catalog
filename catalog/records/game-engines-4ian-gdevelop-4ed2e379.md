...
<!-- canonical: https://github.com/4ian/GDevelop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/4ian/GDevelop](https://github.com/4ian/GDevelop) |
| Source record ids | github_search_game_engines-fad467b863c4ba |
...
For a systems engineer, 4ian/GDevelop belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:32:10Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-fad467b863c4ba` from `github_search_game_engines` as `registry_expansion`
