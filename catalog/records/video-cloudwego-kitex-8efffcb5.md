...
<!-- canonical: https://github.com/cloudwego/kitex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cloudwego/kitex](https://github.com/cloudwego/kitex) |
| Source record ids | github_search_video-e87afaa6c859a2 |
...
For a systems engineer, cloudwego/kitex belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T02:49:24Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-e87afaa6c859a2` from `github_search_video` as `registry_expansion`
...
| BrianDMG/conv2mp4-py | Build System | [open](video-briandmg-conv2mp4-py-42f1dfd6.md) |
