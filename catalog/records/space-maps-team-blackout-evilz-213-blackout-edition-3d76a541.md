...
<!-- canonical: https://github.com/Team-Blackout/EvilZ.213.BLACKOUT_edition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Team-Blackout/EvilZ.213.BLACKOUT_edition](https://github.com/Team-Blackout/EvilZ.213.BLACKOUT_edition) |
| Source record ids | github_search_space_maps-33e8bfaefe1d29 |

## System Engineer Summary

This is the 2.13 base from HTC with my own little spices and tweaks added in. This kernel has a
multitude of options and KILLER performance. The updates to this will move from my personal Github
to the teams page from now on

## Operational Role

For a systems engineer, Team-Blackout/EvilZ.213.BLACKOUT_edition belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2012-11-13T19:53:40Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-33e8bfaefe1d29` from `github_search_space_maps` as `registry_expansion`
