...
<!-- canonical: https://cran.r-project.org/web/packages/colleyRstats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/colleyRstats/index.html](https://cran.r-project.org/web/packages/colleyRstats/index.html) |
| Source record ids | cran_packages_by_date-7b0d8cf9fcd272 |
...
For a systems engineer, colleyRstats belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-02 12:50:02 UTC | [https://cran.r-project.org/web/packages/colleyRstats/DESCRIPTION](https://cran.r-project.org/web/packages/colleyRstats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/colleyRstats/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-7b0d8cf9fcd272` from `cran_packages_by_date` as `registry_expansion`
