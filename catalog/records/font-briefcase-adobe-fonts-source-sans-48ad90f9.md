...
| Source record ids | github_search_font_briefcase-9bd98583a9ecb6 |
...
For a systems engineer, adobe-fonts/source-sans belongs in the Font Briefcase inventory as part of
...
- `github_search_font_briefcase-9bd98583a9ecb6` from `github_search_font_briefcase` as `registry_expansion`
