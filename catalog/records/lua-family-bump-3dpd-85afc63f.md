...
<!-- canonical: https://luarocks.org/modules/shru/bump-3dpd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/shru/bump-3dpd](https://luarocks.org/modules/shru/bump-3dpd) |
| Source record ids | luarocks_root_manifest-28d3de4c02432f |
...
For a systems engineer, bump-3dpd belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-28d3de4c02432f` from `luarocks_root_manifest` as `registry_expansion`
