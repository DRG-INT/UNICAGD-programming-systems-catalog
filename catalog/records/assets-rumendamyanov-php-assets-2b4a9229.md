...
<!-- canonical: https://github.com/RumenDamyanov/php-assets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RumenDamyanov/php-assets](https://github.com/RumenDamyanov/php-assets) |
| Source record ids | github_search_assets-98cc958bcd4f00 |

## System Engineer Summary

Framework-agnostic PHP package to manage frontend assets in the backend. Works with plain PHP,
Laravel, and Symfony with no special configuration required.

## Operational Role

For a systems engineer, RumenDamyanov/php-assets belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-25T09:56:44Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-98cc958bcd4f00` from `github_search_assets` as `registry_expansion`
