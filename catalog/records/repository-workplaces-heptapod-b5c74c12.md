...
<!-- canonical: https://foss.heptapod.net/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://foss.heptapod.net/](https://foss.heptapod.net/) |
| Source record ids | curated_repository_workplace_routes-d29e79d7ce231c |

## System Engineer Summary

Mercurial-oriented forge based on GitLab concepts for repositories, merge requests, issues, and CI
workflows.

## Operational Role

For a systems engineer, Heptapod belongs in the Repository Workplaces inventory as part of ecosystem
...
- `curated_repository_workplace_routes-d29e79d7ce231c` from `curated_repository_workplace_routes` as `registry_expansion`
