...
<!-- canonical: https://pub.dev/packages/app_badge_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/app_badge_plus](https://pub.dev/packages/app_badge_plus) |
| Source record ids | pub_dev-a079d077e73a3f |
...
For a systems engineer, app_badge_plus belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2026-08-12T01:40:02.052592Z | [https://pub.dev/api/packages/app_badge_plus](https://pub.dev/api/packages/app_badge_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/app_badge_plus` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-a079d077e73a3f` from `pub_dev` as `registry_expansion`
