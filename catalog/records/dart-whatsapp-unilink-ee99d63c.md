...
<!-- canonical: https://pub.dev/packages/whatsapp_unilink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/whatsapp_unilink](https://pub.dev/packages/whatsapp_unilink) |
| Source record ids | pub_dev-3aa28a3ffb4cbe |

## System Engineer Summary

Dart package helping your app interact with WhatsApp via HTTP links (universal links). Works with
Flutter.

## Operational Role

For a systems engineer, whatsapp_unilink belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2022-11-20T16:10:39.084344Z | [https://pub.dev/api/packages/whatsapp_unilink](https://pub.dev/api/packages/whatsapp_unilink) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-01-11T17:07:08.009445Z | [https://pub.dev/api/packages/whatsapp_unilink](https://pub.dev/api/packages/whatsapp_unilink) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/whatsapp_unilink` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-3aa28a3ffb4cbe` from `pub_dev` as `registry_expansion`
