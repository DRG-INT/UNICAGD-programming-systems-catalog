...
<!-- canonical: https://github.com/vladmihalcea/db-util -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vladmihalcea/db-util](https://github.com/vladmihalcea/db-util) |
| Source record ids | github_search_databases-bc577937961b52 |
...
For a systems engineer, vladmihalcea/db-util belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-11T18:54:22Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-bc577937961b52` from `github_search_databases` as `registry_expansion`
