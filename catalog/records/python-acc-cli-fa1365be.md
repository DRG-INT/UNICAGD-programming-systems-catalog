...
<!-- canonical: https://pypi.org/project/acc-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acc-cli/](https://pypi.org/project/acc-cli/) |
| Source record ids | pypi_simple-5600bf40d4ae3b |
...
For a systems engineer, acc-cli belongs in the Python inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-05-18T11:52:35.819490Z | [https://pypi.org/pypi/acc-cli/json](https://pypi.org/pypi/acc-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acc-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-5600bf40d4ae3b` from `pypi_simple` as `registry_expansion`
