...
<!-- canonical: https://github.com/MKme/ResQ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MKme/ResQ](https://github.com/MKme/ResQ) |
| Source record ids | github_search_radars-c78595f8641e26 |

## System Engineer Summary

Open Source Search and Rescue Tool for ground tracking and air tracking cell phone signatures using
Espressif ESp32 and ESP8266 hardware.

## Operational Role

For a systems engineer, MKme/ResQ belongs in the Radars inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-14T16:46:00Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c78595f8641e26` from `github_search_radars` as `registry_expansion`
