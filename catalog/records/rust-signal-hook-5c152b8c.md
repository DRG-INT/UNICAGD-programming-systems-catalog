...
<!-- canonical: https://crates.io/crates/signal-hook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/signal-hook](https://crates.io/crates/signal-hook) |
| Source record ids | crates_io-c43a22674eb87d |

## System Engineer Summary

signal-hook is tracked as an image audio dsp record in the Rust branch. The source did not provide a
...
For a systems engineer, signal-hook belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.4 | 2026-04-04T08:08:58.259635Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c43a22674eb87d` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fax | Image Audio Dsp | [open](rust-fax-44bfc794.md) |
