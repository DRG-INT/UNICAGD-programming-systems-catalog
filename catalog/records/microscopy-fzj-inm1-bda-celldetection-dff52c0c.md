...
<!-- canonical: https://github.com/FZJ-INM1-BDA/celldetection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FZJ-INM1-BDA/celldetection](https://github.com/FZJ-INM1-BDA/celldetection) |
| Source record ids | github_search_microscopy-e71357c5b07092 |
...
For a systems engineer, FZJ-INM1-BDA/celldetection belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-22T15:50:43Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-e71357c5b07092` from `github_search_microscopy` as `registry_expansion`
