...
| Source record ids | gitlab_projects_api-699ca7f689af1c |

## System Engineer Summary

Conformance/certification suite for OIDF's specifications, including OpenID Connect, FAPI/FAPI2 &
FAPI-CIBA Profiles, including OpenBanking/OpenFinance security conformance certifications, AuthZen,
Shared Signals, ekyc-ida Production deployment:
...
- `gitlab_projects_api-699ca7f689af1c` from `gitlab_projects_api` as `registry_expansion`
