...
<!-- canonical: https://hackage.haskell.org/package/call -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/call](https://hackage.haskell.org/package/call) |
| Source record ids | hackage_top_downloads-c470d2cdc82b7b |
...
For a systems engineer, call belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4.2 | 2015-02-26T14:28:56Z | [https://hackage.haskell.org/package/call](https://hackage.haskell.org/package/call) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/call` at `2026-09-02T00:32:25+00:00`.
...
- `hackage_top_downloads-c470d2cdc82b7b` from `hackage_top_downloads` as `registry_expansion`
