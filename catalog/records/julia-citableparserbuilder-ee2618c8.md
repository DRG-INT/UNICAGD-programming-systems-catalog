...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Build System](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/build-system.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitableParserBuilder](https://github.com/JuliaRegistries/General/tree/master/C/CitableParserBuilder) |
| Source record ids | julia_general-27a1c0fe119207 |

## System Engineer Summary

Julia package registered in General at C/CitableParserBuilder.

## Operational Role

For a systems engineer, CitableParserBuilder belongs in the Julia inventory as part of build graph
...
| Name | Category | Page |
| --- | --- | --- |
| ApplicationBuilder | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-applicationbuilder-fa5c525d.md) |
| ApplicationBuilderAppUtils | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-applicationbuilderapputils-b59dc3af.md) |
| AtomsBuilder | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-atomsbuilder-9da9d392.md) |
| automake_jll | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-automake-jll-61242c51.md) |
| AWSBraket | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-awsbraket-92ca46a4.md) |
| Bazel_jll | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bazel-jll-edd223e4.md) |
| BinaryBuilder | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-binarybuilder-fdbf4572.md) |
| BinaryBuilder2 | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-binarybuilder2-59ec0844.md) |
