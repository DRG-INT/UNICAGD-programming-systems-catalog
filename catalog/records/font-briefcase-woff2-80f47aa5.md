...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Font Briefcase](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/font-briefcase.md) · [Category: Compression](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compression.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-33f26cb5cd8252 |

## System Engineer Summary

Web Open Font Format 2.0 specification for compressed web font delivery and browser font loading.

## Operational Role

For a systems engineer, WOFF2 belongs in the Font Briefcase inventory as part of ecosystem
...
- `curated_language_routes-33f26cb5cd8252` from `curated_language_routes` as `registry_expansion`
