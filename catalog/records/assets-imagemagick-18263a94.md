...
| Source record ids | curated_language_routes-fa65e867cb98bb |

## System Engineer Summary

Image processing and conversion toolkit for raster assets, automation, thumbnails, and format
normalization.

## Operational Role

For a systems engineer, ImageMagick belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-fa65e867cb98bb` from `curated_language_routes` as `registry_expansion`
