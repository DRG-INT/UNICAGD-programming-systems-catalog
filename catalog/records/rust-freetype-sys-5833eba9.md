...
| Canonical URL | [https://crates.io/crates/freetype-sys](https://crates.io/crates/freetype-sys) |
| Source record ids | crates_io-57da7dd165dd23 |
...
For a systems engineer, freetype-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.0 | 2024-10-20T13:17:28.409668Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-57da7dd165dd23` from `crates_io` as `registry_expansion`
