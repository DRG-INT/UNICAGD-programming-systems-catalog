...
<!-- canonical: https://github.com/mattatz/unity-gpu-particle-system -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mattatz/unity-gpu-particle-system](https://github.com/mattatz/unity-gpu-particle-system) |
| Source record ids | github_search_effects-2459d6e8da5f71 |
...
For a systems engineer, mattatz/unity-gpu-particle-system belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-12-02T04:36:09Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2459d6e8da5f71` from `github_search_effects` as `registry_expansion`
