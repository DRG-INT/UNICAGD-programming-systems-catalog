...
<!-- canonical: https://github.com/spice-framework/spice-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spice-framework/spice-agent](https://github.com/spice-framework/spice-agent) |
| Source record ids | github_search_space_maps-36ca3570ff2b35 |

## System Engineer Summary

Spice-native deterministic agent SDK, kernel, protocols, daemon, and runtime plugin host.

## Operational Role

For a systems engineer, spice-framework/spice-agent belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:05:59Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-36ca3570ff2b35` from `github_search_space_maps` as `registry_expansion`
