...
<!-- canonical: https://github.com/kantord/SeaGOAT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kantord/SeaGOAT](https://github.com/kantord/SeaGOAT) |
| Source record ids | github_search_databases-4a121cea92f8fd |
...
For a systems engineer, kantord/SeaGOAT belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T22:45:50Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4a121cea92f8fd` from `github_search_databases` as `registry_expansion`
