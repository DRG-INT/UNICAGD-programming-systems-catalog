...
<!-- canonical: https://github.com/liam-hq/liam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/liam-hq/liam](https://github.com/liam-hq/liam) |
| Source record ids | github_search_webassembly-c2aaebb3a43e7f |
...
For a systems engineer, liam-hq/liam belongs in the WebAssembly inventory as part of interface
...
- `github_search_webassembly-c2aaebb3a43e7f` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| thi-ng/umbrella | Type Checker | [open](webassembly-thi-ng-umbrella-b00549ee.md) |
