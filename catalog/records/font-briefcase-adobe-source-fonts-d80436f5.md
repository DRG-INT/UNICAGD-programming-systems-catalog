...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Font Briefcase](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/font-briefcase.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/adobe-fonts](https://github.com/adobe-fonts) |
| Source record ids | curated_language_routes-d44621bdb6bb15 |

## System Engineer Summary

Adobe open-source font repository route for source fonts, build files, releases, and licensing
metadata.

## Operational Role

For a systems engineer, Adobe Source Fonts belongs in the Font Briefcase inventory as part of
...
- `curated_language_routes-d44621bdb6bb15` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Fontsource | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/font-briefcase-fontsource-e3f5003e.md) |
| Google Fonts | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/font-briefcase-google-fonts-0f70f205.md) |
