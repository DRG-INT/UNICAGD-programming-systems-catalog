...
<!-- canonical: https://github.com/mushe/NiagaraFluid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mushe/NiagaraFluid](https://github.com/mushe/NiagaraFluid) |
| Source record ids | github_search_physics_engines-e62ccba7a40dad |
...
For a systems engineer, mushe/NiagaraFluid belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-30T04:03:42Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e62ccba7a40dad` from `github_search_physics_engines` as `registry_expansion`
