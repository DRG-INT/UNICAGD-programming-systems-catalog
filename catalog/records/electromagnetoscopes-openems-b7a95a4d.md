...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Electromagnetoscopes](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/electromagnetoscopes.md) · [Category: Math Numeric Scientific](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/math-numeric-scientific.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/thliebig/openEMS](https://github.com/thliebig/openEMS) |
| Source record ids | curated_language_routes-d2fbdae66df7bd |

## System Engineer Summary

Electromagnetic field solver using FDTD for RF, microwave, antenna, and field simulation workflows.

## Operational Role

For a systems engineer, openEMS belongs in the Electromagnetoscopes inventory as part of ecosystem
...
- `curated_language_routes-d2fbdae66df7bd` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Magpylib | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/electromagnetoscopes-magpylib-a6f89736.md) |
