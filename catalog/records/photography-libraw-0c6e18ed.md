...
| Canonical URL | [https://github.com/LibRaw/LibRaw](https://github.com/LibRaw/LibRaw) |
| Source record ids | curated_language_routes-30e9f9a8409fd9 |

## System Engineer Summary

RAW photo decoding library for camera formats, metadata, demosaicing, and image pipeline
integration.

## Operational Role

For a systems engineer, libraw belongs in the Photography inventory as part of ecosystem capability
...
- `curated_language_routes-30e9f9a8409fd9` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| dcraw | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/photography-dcraw-7355fc69.md) |
| OpenImageIO | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/photography-openimageio-1c46b5df.md) |
