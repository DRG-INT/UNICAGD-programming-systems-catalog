...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/rpsurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rpsurv/index.html](https://cran.r-project.org/web/packages/rpsurv/index.html) |
| Source record ids | cran_packages_by_date-3281711b13a9fa |

## System Engineer Summary

Fast Royston-Parmar Flexible Parametric Survival Models

## Operational Role

For a systems engineer, rpsurv belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-09-11 13:50:02 UTC | [https://cran.r-project.org/web/packages/rpsurv/DESCRIPTION](https://cran.r-project.org/web/packages/rpsurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rpsurv/DESCRIPTION` at `2026-09-11T14:23:14+00:00`.
...
- `cran_packages_by_date-3281711b13a9fa` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ast2ast | Parser Lexer Ast | [open](r-ast2ast-f572989c.md) |
| astgrepr | Parser Lexer Ast | [open](r-astgrepr-717ef2ee.md) |
| AstraeaDB | Parser Lexer Ast | [open](r-astraeadb-a63f29d0.md) |
| autotune | Parser Lexer Ast | [open](r-autotune-87ff0a0b.md) |
| AvatarTLA | Parser Lexer Ast | [open](r-avatartla-9df744dd.md) |
| bage | Parser Lexer Ast | [open](r-bage-1bc306ca.md) |
| Bayenet | Parser Lexer Ast | [open](r-bayenet-235e4c0f.md) |
| BigDataStatMeth | Parser Lexer Ast | [open](r-bigdatastatmeth-d0c47584.md) |
