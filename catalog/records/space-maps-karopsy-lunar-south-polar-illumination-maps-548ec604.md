# Karopsy/Lunar-South-Polar-illumination-maps-
...
<!-- canonical: https://github.com/Karopsy/Lunar-South-Polar-illumination-maps- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Karopsy/Lunar-South-Polar-illumination-maps-](https://github.com/Karopsy/Lunar-South-Polar-illumination-maps-) |
| Source record ids | github_search_space_maps-bb8373e64d7e30 |

## System Engineer Summary

These codes have been created in order to compute solar illumination maps for a research project at
the Lunar and Planetary Institute in Houston, TX. This work has implications for permanently
shadowed regions (PSRs) scientific studies in the context of the upcoming Artemis III mission.

## Operational Role

For a systems engineer, Karopsy/Lunar-South-Polar-illumination-maps- belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-27T16:48:23Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bb8373e64d7e30` from `github_search_space_maps` as `registry_expansion`
