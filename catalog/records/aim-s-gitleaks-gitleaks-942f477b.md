...
| Source record ids | github_search_aims-4a3e22fb01b687 |
...
For a systems engineer, gitleaks/gitleaks belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T04:17:05Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-4a3e22fb01b687` from `github_search_aims` as `registry_expansion`
