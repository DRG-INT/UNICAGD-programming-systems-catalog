...
<!-- canonical: https://github.com/dw5/Metropolis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dw5/Metropolis](https://github.com/dw5/Metropolis) |
| Source record ids | github_search_font_briefcase-0d6323fe2baaab |
...
For a systems engineer, dw5/Metropolis belongs in the Font Briefcase inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-02-27T09:58:51Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense |
...
- `github_search_font_briefcase-0d6323fe2baaab` from `github_search_font_briefcase` as `registry_expansion`
