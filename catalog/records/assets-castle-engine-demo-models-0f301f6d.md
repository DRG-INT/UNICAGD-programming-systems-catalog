...
<!-- canonical: https://github.com/castle-engine/demo-models -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/castle-engine/demo-models](https://github.com/castle-engine/demo-models) |
| Source record ids | github_search_assets-8af84d7e2c5a9e |

## System Engineer Summary

Demo 3D and 2D models of Castle Game Engine (glTF, X3D, VRML, Spine JSON, Blender and more)

## Operational Role

For a systems engineer, castle-engine/demo-models belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:50:45Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-8af84d7e2c5a9e` from `github_search_assets` as `registry_expansion`
