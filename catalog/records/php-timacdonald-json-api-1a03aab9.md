...
<!-- canonical: https://packagist.org/packages/timacdonald/json-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/timacdonald/json-api](https://packagist.org/packages/timacdonald/json-api) |
| Source record ids | packagist_search-acd170080cbeb9 |
...
For a systems engineer, timacdonald/json-api belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-acd170080cbeb9` from `packagist_search` as `registry_expansion`
