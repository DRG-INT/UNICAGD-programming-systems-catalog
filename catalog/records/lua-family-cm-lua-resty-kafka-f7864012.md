...
<!-- canonical: https://luarocks.org/modules/zhanghw0354/cm-lua-resty-kafka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/zhanghw0354/cm-lua-resty-kafka](https://luarocks.org/modules/zhanghw0354/cm-lua-resty-kafka) |
| Source record ids | luarocks_root_manifest-96102d0c4b5fe7 |
...
For a systems engineer, cm-lua-resty-kafka belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-96102d0c4b5fe7` from `luarocks_root_manifest` as `registry_expansion`
