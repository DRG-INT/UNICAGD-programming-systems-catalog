...
<!-- canonical: https://hackage.haskell.org/package/sets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/sets](https://hackage.haskell.org/package/sets) |
| Source record ids | hackage_top_downloads-db94dc9f0a8eef |
...
For a systems engineer, sets belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6.2 | 2019-10-27T17:59:41Z | [https://hackage.haskell.org/package/sets](https://hackage.haskell.org/package/sets) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/sets` at `2026-09-04T00:31:04+00:00`.
...
- `hackage_top_downloads-db94dc9f0a8eef` from `hackage_top_downloads` as `registry_expansion`
