...
<!-- canonical: https://github.com/Neopallium/lua-zmq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Neopallium/lua-zmq](https://github.com/Neopallium/lua-zmq) |
| Source record ids | lua-source-308 |

## System Engineer Summary

lua-zmq is tracked as an undefined behavior analyzer record in the Lua family branch. The source did
...
For a systems engineer, lua-zmq belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 308}}` |
...
- `lua-source-308` from `master_json` as `source_list_item`
