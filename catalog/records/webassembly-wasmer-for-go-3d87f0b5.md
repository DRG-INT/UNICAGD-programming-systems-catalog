...
| Canonical URL | [https://github.com/wasmerio/go-ext-wasm](https://github.com/wasmerio/go-ext-wasm) |
| Source record ids | awesome_list-99b930dbe7e0b5 |

## System Engineer Summary

Wasmer for Go is tracked as a library record in the WebAssembly branch. The source did not provide a
...
For a systems engineer, Wasmer for Go belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Non-Web Embeddings", "source_url": "https://raw.githubusercontent.com/mbasso/awesome-wasm/master/README.md", "status": "curated-list-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `awesome_list-99b930dbe7e0b5` from `awesome_list` as `registry_expansion`
...
| WebAssembly Explorer | Library | [open](webassembly-webassembly-explorer-1bf9c18f.md) |
