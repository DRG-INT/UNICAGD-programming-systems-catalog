...
| Canonical URL | [https://crates.io/crates/sodiumoxide](https://crates.io/crates/sodiumoxide) |
| Source record ids | corpus-351929dd21e9c8 |
...
For a systems engineer, sodiumoxide belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2021-06-24T08:34:09.003782Z | [https://crates.io/api/v1/crates/sodiumoxide](https://crates.io/api/v1/crates/sodiumoxide) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/sodiumoxide` at `2026-09-01T02:12:58+00:00`.
...
- `corpus-351929dd21e9c8` from `master_json` as `cryptography`
