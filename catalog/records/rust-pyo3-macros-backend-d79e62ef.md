...
<!-- canonical: https://crates.io/crates/pyo3-macros-backend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pyo3-macros-backend](https://crates.io/crates/pyo3-macros-backend) |
| Source record ids | crates_io-8c910be04e7ed7 |
...
For a systems engineer, pyo3-macros-backend belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.2 | 2026-08-28T18:29:05.175297Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-8c910be04e7ed7` from `crates_io` as `registry_expansion`
