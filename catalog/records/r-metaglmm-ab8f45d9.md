...
<!-- canonical: https://cran.r-project.org/web/packages/metaGLMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metaGLMM/index.html](https://cran.r-project.org/web/packages/metaGLMM/index.html) |
| Source record ids | cran_packages_by_date-fc1ef64646e71f |
...
For a systems engineer, metaGLMM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-12 13:40:02 UTC | [https://cran.r-project.org/web/packages/metaGLMM/DESCRIPTION](https://cran.r-project.org/web/packages/metaGLMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metaGLMM/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-fc1ef64646e71f` from `cran_packages_by_date` as `registry_expansion`
