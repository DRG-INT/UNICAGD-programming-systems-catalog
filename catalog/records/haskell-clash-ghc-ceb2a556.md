...
| Source record ids | hackage_recent-f21f89465fe715 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.2 | 2026-09-07T09:27:21Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-f21f89465fe715` from `hackage_recent` as `registry_expansion`
