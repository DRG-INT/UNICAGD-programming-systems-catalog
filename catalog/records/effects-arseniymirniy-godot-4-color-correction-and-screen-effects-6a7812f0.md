...
| Canonical URL | [https://github.com/ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects](https://github.com/ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects) |
| Source record ids | github_search_effects-a903e427b3610e |

## System Engineer Summary

Godot 4 color correction tools similar to Video Editing apps + Post Processing Screen Effects, made
with pure Visual Shaders in Godot 4.3, 4.4, and now 4.7

## Operational Role

For a systems engineer, ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2024-12-15T21:54:20Z | [https://api.github.com/repos/ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects/releases/latest](https://api.github.com/repos/ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects/releases/latest) |  |
...
| Evidence | MIT AND Apache-2.0; https://www.nuget.org/packages/Xamarin.Firebase.Encoders.JSON/118.0.1.18/license |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects/releases/latest` at `2026-09-01T09:23:08+00:00`.
...
- `github_search_effects-a903e427b3610e` from `github_search_effects` as `registry_expansion`
...
| IdeaSpaceVR/aframe-particle-system-component | Ide Editor Integration | [open](effects-ideaspacevr-aframe-particle-system-component-80cdc49c.md) |
| jacksoswag/Spectra | Ide Editor Integration | [open](effects-jacksoswag-spectra-220288fc.md) |
| mert-dev-acc/ThermalVisionPostProcessingShader | Ide Editor Integration | [open](effects-mert-dev-acc-thermalvisionpostprocessingshader-994cb08a.md) |
| mlt131220/Astral3D | Ide Editor Integration | [open](effects-mlt131220-astral3d-fe3d2c86.md) |
| RdenBlaauwen/RCAS-for-ReShade | Ide Editor Integration | [open](effects-rdenblaauwen-rcas-for-reshade-d195ca4b.md) |
| Samsy/Post-Processing-Hack-Editor | Ide Editor Integration | [open](effects-samsy-post-processing-hack-editor-ff1c3a5c.md) |
