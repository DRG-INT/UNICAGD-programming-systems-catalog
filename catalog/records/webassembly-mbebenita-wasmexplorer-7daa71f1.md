...
<!-- canonical: https://github.com/mbebenita/WasmExplorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbebenita/WasmExplorer](https://github.com/mbebenita/WasmExplorer) |
| Source record ids | github_search_webassembly-0031000b515b58 |

## System Engineer Summary

mbebenita/WasmExplorer is tracked as a language specification record in the WebAssembly branch. The
...
For a systems engineer, mbebenita/WasmExplorer belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-02T23:22:38Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-0031000b515b58` from `github_search_webassembly` as `registry_expansion`
