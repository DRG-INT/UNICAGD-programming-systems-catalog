...
<!-- canonical: https://crates.io/crates/fallible-streaming-iterator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fallible-streaming-iterator](https://crates.io/crates/fallible-streaming-iterator) |
| Source record ids | crates_io-991fee9a4bf243 |
...
For a systems engineer, fallible-streaming-iterator belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2018-05-02T20:02:49.746627Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `crates_io-991fee9a4bf243` from `crates_io` as `registry_expansion`
