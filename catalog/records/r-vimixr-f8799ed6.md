...
<!-- canonical: https://cran.r-project.org/web/packages/vimixr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vimixr/index.html](https://cran.r-project.org/web/packages/vimixr/index.html) |
| Source record ids | cran_packages_by_date-d991e9a5afdbc5 |
...
For a systems engineer, vimixr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-09 09:30:08 UTC | [https://cran.r-project.org/web/packages/vimixr/DESCRIPTION](https://cran.r-project.org/web/packages/vimixr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vimixr/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-d991e9a5afdbc5` from `cran_packages_by_date` as `registry_expansion`
