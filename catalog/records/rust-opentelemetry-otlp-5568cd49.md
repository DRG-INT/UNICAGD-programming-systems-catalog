...
<!-- canonical: https://crates.io/crates/opentelemetry-otlp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/opentelemetry-otlp](https://crates.io/crates/opentelemetry-otlp) |
| Source record ids | crates_io-d63495507ef052 |
...
For a systems engineer, opentelemetry-otlp belongs in the Rust inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.0 | 2026-05-08T23:43:23.837497Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-d63495507ef052` from `crates_io` as `registry_expansion`
