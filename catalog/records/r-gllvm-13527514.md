...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/gllvm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gllvm/index.html](https://cran.r-project.org/web/packages/gllvm/index.html) |
| Source record ids | cran_packages_by_date-521472e917aa51 |
...
For a systems engineer, gllvm belongs in the R inventory as part of compiler selection, diagnostics
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.15 | 2026-09-11 19:00:02 UTC | [https://cran.r-project.org/web/packages/gllvm/DESCRIPTION](https://cran.r-project.org/web/packages/gllvm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gllvm/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-521472e917aa51` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crbcc | Compiler | [open](r-crbcc-984c1e62.md) |
