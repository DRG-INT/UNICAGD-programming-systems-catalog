...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rebeccaeexu/Awesome-High-Dynamic-Range-Imaging -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rebeccaeexu/Awesome-High-Dynamic-Range-Imaging](https://github.com/rebeccaeexu/Awesome-High-Dynamic-Range-Imaging) |
| Source record ids | github_search_photography-5a0340deaac0bd |
...
For a systems engineer, rebeccaeexu/Awesome-High-Dynamic-Range-Imaging belongs in the Photography
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-08T16:33:46Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-5a0340deaac0bd` from `github_search_photography` as `registry_expansion`
