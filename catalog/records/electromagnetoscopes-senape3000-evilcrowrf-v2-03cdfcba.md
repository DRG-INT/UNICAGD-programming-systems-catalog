...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Senape3000/EvilCrowRF-V2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Senape3000/EvilCrowRF-V2](https://github.com/Senape3000/EvilCrowRF-V2) |
| Source record ids | github_search_electromagnetoscopes-1e1edac378d3e3 |

## System Engineer Summary

Complete firmware suite for EvilCrowRF-V2. Features SubGhz and nRF24 capabilities controlled through
a mobile app via BLE/USB serial. Multilanguage UI, wireless operation, and extensive RF toolkit for
security research and pentesting. Open-source and community-driven.

## Operational Role

For a systems engineer, Senape3000/EvilCrowRF-V2 belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-21T14:59:33Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-1e1edac378d3e3` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gotmc/ivi | Language Specification | [open](electromagnetoscopes-gotmc-ivi-f610f143.md) |
| JiaoXianjun/BTLE | Language Specification | [open](electromagnetoscopes-jiaoxianjun-btle-caed6e2e.md) |
| MarkSherstan/MPU-6050-9250-I2C-CompFilter | Language Specification | [open](electromagnetoscopes-marksherstan-mpu-6050-9250-i2c-compfilter-61e77b94.md) |
