...
<!-- canonical: https://pub.dev/packages/enum_to_string -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/enum_to_string](https://pub.dev/packages/enum_to_string) |
| Source record ids | pub_dev-b477cb72d73923 |

## System Engineer Summary

Better conversion of ENUMs to string. Dart has annoying EnumName.ValueName syntax when calling
enum.toString, this package fixes that.

## Operational Role

For a systems engineer, enum_to_string belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2025-03-16T05:58:29.652754Z | [https://pub.dev/api/packages/enum_to_string](https://pub.dev/api/packages/enum_to_string) |  |
| preview | known | 2.0.0-nullsafety.1 | 2021-02-23T00:47:43.242251Z | [https://pub.dev/api/packages/enum_to_string](https://pub.dev/api/packages/enum_to_string) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/enum_to_string` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-b477cb72d73923` from `pub_dev` as `registry_expansion`
