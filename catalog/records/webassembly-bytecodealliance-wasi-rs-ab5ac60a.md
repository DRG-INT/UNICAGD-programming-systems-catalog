...
<!-- canonical: https://github.com/bytecodealliance/wasi-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/wasi-rs](https://github.com/bytecodealliance/wasi-rs) |
| Source record ids | github_search_webassembly-fa490a6fe929fa |

## System Engineer Summary

bytecodealliance/wasi-rs is tracked as a ffi bindings record in the WebAssembly branch. The source
...
For a systems engineer, bytecodealliance/wasi-rs belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T19:47:59Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-fa490a6fe929fa` from `github_search_webassembly` as `registry_expansion`
