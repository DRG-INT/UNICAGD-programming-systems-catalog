# ameya-tries-coding/Night-Sky-Visibility-AI
...
<!-- canonical: https://github.com/ameya-tries-coding/Night-Sky-Visibility-AI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ameya-tries-coding/Night-Sky-Visibility-AI](https://github.com/ameya-tries-coding/Night-Sky-Visibility-AI) |
| Source record ids | github_search_space_maps-7aa61a64330728 |

## System Engineer Summary

AI-powered app that predicts night sky visibility using ML, real-time astronomy data, and weather
conditions—featuring sky maps, object rankings, and optimal stargazing times.

## Operational Role

For a systems engineer, ameya-tries-coding/Night-Sky-Visibility-AI belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-02T16:39:34Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-7aa61a64330728` from `github_search_space_maps` as `registry_expansion`
