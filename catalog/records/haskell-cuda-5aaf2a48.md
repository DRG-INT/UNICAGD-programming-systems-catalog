...
<!-- canonical: https://hackage.haskell.org/package/cuda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cuda](https://hackage.haskell.org/package/cuda) |
| Source record ids | hackage_top_downloads-2c7df215d9b72f |
...
For a systems engineer, cuda belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0.0 | 2026-03-30T10:00:24Z | [https://hackage.haskell.org/package/cuda](https://hackage.haskell.org/package/cuda) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cuda` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-2c7df215d9b72f` from `hackage_top_downloads` as `registry_expansion`
