# razacreative/Responsive-NavBar
...
<!-- canonical: https://github.com/razacreative/Responsive-NavBar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/razacreative/Responsive-NavBar](https://github.com/razacreative/Responsive-NavBar) |
| Source record ids | github_search_magazines-1f8d1ea57fe37d |

## System Engineer Summary

Hi thanks for choosing me for this service my name is Azhari Pedia and i am professional web-
developer It is fully responsive and easy to customize. It is the perfect template for simple
magazines, blogs, personal blogs, and others.

## Operational Role

For a systems engineer, razacreative/Responsive-NavBar belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-19T05:21:12Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-1f8d1ea57fe37d` from `github_search_magazines` as `registry_expansion`
