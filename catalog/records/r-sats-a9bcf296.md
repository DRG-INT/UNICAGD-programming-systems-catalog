...
<!-- canonical: https://cran.r-project.org/web/packages/SATS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SATS/index.html](https://cran.r-project.org/web/packages/SATS/index.html) |
| Source record ids | cran_packages_by_date-a2488a0b63b90f |
...
For a systems engineer, SATS belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.11 | 2026-09-15 21:40:08 UTC | [https://cran.r-project.org/web/packages/SATS/DESCRIPTION](https://cran.r-project.org/web/packages/SATS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SATS/DESCRIPTION` at `2026-09-15T22:19:01+00:00`.
...
- `cran_packages_by_date-a2488a0b63b90f` from `cran_packages_by_date` as `registry_expansion`
