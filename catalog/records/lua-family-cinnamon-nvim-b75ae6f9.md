...
<!-- canonical: https://luarocks.org/modules/declancm/cinnamon.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/declancm/cinnamon.nvim](https://luarocks.org/modules/declancm/cinnamon.nvim) |
| Source record ids | luarocks_root_manifest-b3cde20d248aaa |
...
For a systems engineer, cinnamon.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b3cde20d248aaa` from `luarocks_root_manifest` as `registry_expansion`
