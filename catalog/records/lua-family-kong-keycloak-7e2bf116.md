...
| Canonical URL | [https://luarocks.org/modules/numtech/kong-keycloak](https://luarocks.org/modules/numtech/kong-keycloak) |
| Source record ids | luarocks_root_manifest-32ada1180c440f |

## System Engineer Summary

kong-keycloak is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, kong-keycloak belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-32ada1180c440f` from `luarocks_root_manifest` as `registry_expansion`
