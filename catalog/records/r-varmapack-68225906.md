...
<!-- canonical: https://cran.r-project.org/web/packages/varmapack/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/varmapack/index.html](https://cran.r-project.org/web/packages/varmapack/index.html) |
| Source record ids | cran_packages_by_date-9921482b3a1856 |

## System Engineer Summary

Burn-in-Free Simulation and Analysis of Gaussian VARMA Models

## Operational Role

For a systems engineer, varmapack belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-12 07:10:03 UTC | [https://cran.r-project.org/web/packages/varmapack/DESCRIPTION](https://cran.r-project.org/web/packages/varmapack/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/varmapack/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-9921482b3a1856` from `cran_packages_by_date` as `registry_expansion`
