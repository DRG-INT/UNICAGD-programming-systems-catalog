...
| Canonical URL | [https://github.com/nasa/GMAT](https://github.com/nasa/GMAT) |
| Source record ids | github_search_space_engines-aeb1c1e98f5f71 |

## System Engineer Summary

The General Mission Analysis Tool (GMAT) is the world's leading enterprise, multi-mission, open
...
missions. NOTE: Non-release tagged commits are AS IS.

## Operational Role

For a systems engineer, nasa/GMAT belongs in the Space Engines inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | R2026a | 2026-05-06T18:17:23Z | [https://api.github.com/repos/nasa/GMAT/releases/latest](https://api.github.com/repos/nasa/GMAT/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nasa/GMAT/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-aeb1c1e98f5f71` from `github_search_space_engines` as `registry_expansion`
