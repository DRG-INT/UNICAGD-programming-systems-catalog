...
<!-- canonical: https://github.com/sjoerdvankreel/firefly-synth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sjoerdvankreel/firefly-synth](https://github.com/sjoerdvankreel/firefly-synth) |
| Source record ids | github_search_audio-8308c65781610c |
...
For a systems engineer, sjoerdvankreel/firefly-synth belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-08T21:28:44Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-8308c65781610c` from `github_search_audio` as `registry_expansion`
