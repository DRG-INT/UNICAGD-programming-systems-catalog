...
<!-- canonical: https://bitbucket.org/sylvanaar2/lua-for-idea/wiki/Home -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://bitbucket.org/sylvanaar2/lua-for-idea/wiki/Home](https://bitbucket.org/sylvanaar2/lua-for-idea/wiki/Home) |
| Source record ids | lua-source-96 |

## System Engineer Summary

IntelliJ IDEA plugin which, among other things, provides code completion, smart highlighting, and
experimental debugging.

## Operational Role

For a systems engineer, Lua for IDEA belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 96}}` |
...
- `lua-source-96` from `master_json` as `source_list_item`
