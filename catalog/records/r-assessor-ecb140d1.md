...
<!-- canonical: https://cran.r-project.org/web/packages/assessor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/assessor/index.html](https://cran.r-project.org/web/packages/assessor/index.html) |
| Source record ids | cran_packages_by_date-73dbc5074ffe09 |
...
For a systems engineer, assessor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2026-08-22 04:00:02 UTC | [https://cran.r-project.org/web/packages/assessor/DESCRIPTION](https://cran.r-project.org/web/packages/assessor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/assessor/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-73dbc5074ffe09` from `cran_packages_by_date` as `registry_expansion`
