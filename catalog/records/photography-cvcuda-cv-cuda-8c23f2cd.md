...
<!-- canonical: https://github.com/CVCUDA/CV-CUDA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CVCUDA/CV-CUDA](https://github.com/CVCUDA/CV-CUDA) |
| Source record ids | github_search_photography-a0c5626c1c845c |
...
For a systems engineer, CVCUDA/CV-CUDA belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T22:53:54Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a0c5626c1c845c` from `github_search_photography` as `registry_expansion`
