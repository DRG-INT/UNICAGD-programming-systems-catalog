...
<!-- canonical: https://gitlab.com/k3s_hetzner/k3s_hetzner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/k3s_hetzner/k3s_hetzner](https://gitlab.com/k3s_hetzner/k3s_hetzner) |
| Source record ids | gitlab_projects_api-79a430cf0b4cd4 |
...
For a systems engineer, k3s_hetzner/k3s_hetzner belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-79a430cf0b4cd4` from `gitlab_projects_api` as `registry_expansion`
