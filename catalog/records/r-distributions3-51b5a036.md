...
<!-- canonical: https://cran.r-project.org/web/packages/distributions3/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/distributions3/index.html](https://cran.r-project.org/web/packages/distributions3/index.html) |
| Source record ids | cran_packages_by_date-2f333d7b9d2a48 |
...
For a systems engineer, distributions3 belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-20 05:21:11 UTC | [https://cran.r-project.org/web/packages/distributions3/DESCRIPTION](https://cran.r-project.org/web/packages/distributions3/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/distributions3/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2f333d7b9d2a48` from `cran_packages_by_date` as `registry_expansion`
