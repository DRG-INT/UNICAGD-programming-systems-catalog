...
<!-- canonical: https://hackage.haskell.org/package/Rasterific -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Rasterific](https://hackage.haskell.org/package/Rasterific) |
| Source record ids | hackage_top_downloads-1b5b0c5d505188 |
...
For a systems engineer, Rasterific belongs in the Haskell inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.5.4 | 2021-05-26T21:28:13Z | [https://hackage.haskell.org/package/Rasterific](https://hackage.haskell.org/package/Rasterific) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Rasterific` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-1b5b0c5d505188` from `hackage_top_downloads` as `registry_expansion`
