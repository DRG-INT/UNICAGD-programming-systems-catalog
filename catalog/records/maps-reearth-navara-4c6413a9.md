...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/reearth/navara -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/reearth/navara](https://github.com/reearth/navara) |
| Source record ids | github_search_maps-f9edef6fe9db2a |

## System Engineer Summary

Navara is a highly extensible 3D map engine. Load a wide range of GIS data, from satellite imagery
and terrain to 3D city models and vector data, then freely layer your own visualizations on top.

## Operational Role

For a systems engineer, reearth/navara belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T03:05:33Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f9edef6fe9db2a` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/ofbiz-framework | Ide Editor Integration | [open](maps-apache-ofbiz-framework-6d8fd7d2.md) |
| bryceco/GoMap | Ide Editor Integration | [open](maps-bryceco-gomap-1140769c.md) |
| dimartarmizi/map-to-poster | Ide Editor Integration | [open](maps-dimartarmizi-map-to-poster-da1cffb2.md) |
| eli-labz/Third-Eye | Ide Editor Integration | [open](maps-eli-labz-third-eye-89c57d06.md) |
| Esri/geoservices-js | Ide Editor Integration | [open](maps-esri-geoservices-js-232427f9.md) |
| geocoder-php/GeocoderLaravel | Ide Editor Integration | [open](maps-geocoder-php-geocoderlaravel-e7cd9415.md) |
| gpxstudio/gpx.studio | Ide Editor Integration | [open](maps-gpxstudio-gpx-studio-b58d1c87.md) |
| ipverse/as-ip-blocks | Ide Editor Integration | [open](maps-ipverse-as-ip-blocks-7d14346a.md) |
