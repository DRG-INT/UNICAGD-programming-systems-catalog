...
<!-- canonical: https://github.com/kuzand/Computer-Vision-Video-Lectures -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kuzand/Computer-Vision-Video-Lectures](https://github.com/kuzand/Computer-Vision-Video-Lectures) |
| Source record ids | github_search_video-6a633a2ffc7621 |

## System Engineer Summary

A curated list of free, high-quality, university-level courses with video lectures related to the
field of Computer Vision.

## Operational Role

For a systems engineer, kuzand/Computer-Vision-Video-Lectures belongs in the Video inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-15T10:49:30Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-6a633a2ffc7621` from `github_search_video` as `registry_expansion`
