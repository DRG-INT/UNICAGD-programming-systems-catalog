...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Static Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/static-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/nord-secure](https://www.npmjs.com/package/nord-secure) |
| Source record ids | npm_registry-4fa8cce23163c6 |
...
For a systems engineer, nord-secure belongs in the Node.js/JavaScript inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-31T19:54:24.074Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @openclaw/clawscan | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-openclaw-clawscan-df9cdb25.md) |
| @posthog/warlock | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-posthog-warlock-dba18ac1.md) |
| @socketsecurity/bun-security-scanner | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-socketsecurity-bun-security-scanner-587b9763.md) |
| @sperax/tool-goplus-security | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-sperax-tool-goplus-security-660aa149.md) |
| @wrongstack/security-scanner | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-wrongstack-security-scanner-3fbb3e41.md) |
| aira-cyber-security-ai | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aira-cyber-security-ai-63b0da86.md) |
| circle-ir | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-circle-ir-b722af8a.md) |
| CodeQL JavaScript | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-codeql-javascript-df5619f1.md) |
