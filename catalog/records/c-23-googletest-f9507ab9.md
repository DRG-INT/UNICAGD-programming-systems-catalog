...
| Source record ids | master-51cf4779e9f2 |
...
For a systems engineer, GoogleTest belongs in the C++23 inventory as part of unit/integration
...
- `master-51cf4779e9f2` from `master_json` as `testing_framework`
