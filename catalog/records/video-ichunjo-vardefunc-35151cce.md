...
<!-- canonical: https://github.com/Ichunjo/vardefunc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ichunjo/vardefunc](https://github.com/Ichunjo/vardefunc) |
| Source record ids | github_search_video-526ceef2a75f45 |
...
For a systems engineer, Ichunjo/vardefunc belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T19:32:37Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-526ceef2a75f45` from `github_search_video` as `registry_expansion`
