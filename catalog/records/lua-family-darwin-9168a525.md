...
<!-- canonical: https://luarocks.org/modules/mistrza/darwin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mistrza/darwin](https://luarocks.org/modules/mistrza/darwin) |
| Source record ids | luarocks_root_manifest-43d5156c70ca88 |

## System Engineer Summary

A module for evolutionary algorithms in Lua

## Operational Role

For a systems engineer, darwin belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-43d5156c70ca88` from `luarocks_root_manifest` as `registry_expansion`
