...
<!-- canonical: https://github.com/AlmasB/FXGL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlmasB/FXGL](https://github.com/AlmasB/FXGL) |
| Source record ids | github_search_game_engines-796b8dc03f7111 |
...
For a systems engineer, AlmasB/FXGL belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-01T14:39:51Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-796b8dc03f7111` from `github_search_game_engines` as `registry_expansion`
