...
<!-- canonical: https://pypi.org/project/aas-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aas-mcp-server/](https://pypi.org/project/aas-mcp-server/) |
| Source record ids | pypi_simple-33cbd6e43f95de |

## System Engineer Summary

Open-source MCP server for AAS (Asset Administration Shell) APIs using OpenAPI

## Operational Role

For a systems engineer, aas-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-07-29T08:35:53.871133Z | [https://pypi.org/pypi/aas-mcp-server/json](https://pypi.org/pypi/aas-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aas-mcp-server/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-33cbd6e43f95de` from `pypi_simple` as `registry_expansion`
