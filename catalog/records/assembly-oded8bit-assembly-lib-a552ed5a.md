...
<!-- canonical: https://github.com/oded8bit/Assembly-Lib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oded8bit/Assembly-Lib](https://github.com/oded8bit/Assembly-Lib) |
| Source record ids | github_search_assembly-30c68a66cdf10f |

## System Engineer Summary

A 16-bits x86 DOS Assembly library that provides many useful functions for developing programs. It
has both VGA grapics functions as well as general purpose utilities. The main purpose of this
library was to be able to implement simple DOS games (in Assembly) using VGA (320x200, 256 colors)
display.

## Operational Role

For a systems engineer, oded8bit/Assembly-Lib belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-19T16:54:22Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-30c68a66cdf10f` from `github_search_assembly` as `registry_expansion`
