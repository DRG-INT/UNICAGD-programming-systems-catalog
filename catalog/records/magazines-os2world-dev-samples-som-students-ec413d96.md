# OS2World/DEV-SAMPLES-SOM-Students
...
<!-- canonical: https://github.com/OS2World/DEV-SAMPLES-SOM-Students -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OS2World/DEV-SAMPLES-SOM-Students](https://github.com/OS2World/DEV-SAMPLES-SOM-Students) |
| Source record ids | github_search_magazines-23a89ad5cd4e0f |

## System Engineer Summary

Source code for Method Resolution in SOM article. OS/2 Developer Magazine, Issue : Spring 93, page :
94-102

## Operational Role

For a systems engineer, OS2World/DEV-SAMPLES-SOM-Students belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-24T23:30:21Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-23a89ad5cd4e0f` from `github_search_magazines` as `registry_expansion`
