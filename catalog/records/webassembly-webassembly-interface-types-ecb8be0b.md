...
<!-- canonical: https://github.com/WebAssembly/interface-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/interface-types](https://github.com/WebAssembly/interface-types) |
| Source record ids | github_search_webassembly-342112b7fce4de |

## System Engineer Summary

WebAssembly/interface-types is tracked as a language specification record in the WebAssembly branch.
...
For a systems engineer, WebAssembly/interface-types belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-01T20:29:27Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-342112b7fce4de` from `github_search_webassembly` as `registry_expansion`
