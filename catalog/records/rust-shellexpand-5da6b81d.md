...
<!-- canonical: https://crates.io/crates/shellexpand -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/shellexpand](https://crates.io/crates/shellexpand) |
| Source record ids | crates_io-b86b1dffcbb724 |
...
For a systems engineer, shellexpand belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.2 | 2026-02-23T16:32:02.531452Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-b86b1dffcbb724` from `crates_io` as `registry_expansion`
