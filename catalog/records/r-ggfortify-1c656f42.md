...
<!-- canonical: https://cran.r-project.org/web/packages/ggfortify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggfortify/index.html](https://cran.r-project.org/web/packages/ggfortify/index.html) |
| Source record ids | cran_packages_by_date-0dfb2f8a1326a7 |
...
For a systems engineer, ggfortify belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.22 | 2026-08-24 08:30:20 UTC | [https://cran.r-project.org/web/packages/ggfortify/DESCRIPTION](https://cran.r-project.org/web/packages/ggfortify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggfortify/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0dfb2f8a1326a7` from `cran_packages_by_date` as `registry_expansion`
