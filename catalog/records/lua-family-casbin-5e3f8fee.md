...
<!-- canonical: https://luarocks.org/modules/hsluoyz/casbin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/hsluoyz/casbin](https://luarocks.org/modules/hsluoyz/casbin) |
| Source record ids | luarocks_root_manifest-e1559537991e1d |
...
For a systems engineer, casbin belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e1559537991e1d` from `luarocks_root_manifest` as `registry_expansion`
