...
<!-- canonical: https://github.com/mark-when/markwhen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mark-when/markwhen](https://github.com/mark-when/markwhen) |
| Source record ids | github_search_maps-26d16d1bf0e093 |

## System Engineer Summary

Make a cascading timeline from markdown-like text. Supports simple American/European date styles,
ISO8601, images, links, locations, and more.

## Operational Role

For a systems engineer, mark-when/markwhen belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-11T19:14:41Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-26d16d1bf0e093` from `github_search_maps` as `registry_expansion`
