...
<!-- canonical: https://github.com/henrysky/milkyway_plot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/henrysky/milkyway_plot](https://github.com/henrysky/milkyway_plot) |
| Source record ids | github_search_space_maps-e38e244e437715 |

## System Engineer Summary

A handy Python package for plotting face-on and all-sky maps of the Milky Way using Matplotlib and
Bokeh

## Operational Role

For a systems engineer, henrysky/milkyway_plot belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T15:23:03Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e38e244e437715` from `github_search_space_maps` as `registry_expansion`
