...
<!-- canonical: https://cran.r-project.org/web/packages/exametrika/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/exametrika/index.html](https://cran.r-project.org/web/packages/exametrika/index.html) |
| Source record ids | cran_packages_by_date-3992ece9759c9d |

## System Engineer Summary

exametrika is tracked as a testing framework record in the R branch. The source did not provide a
...
For a systems engineer, exametrika belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-20 10:50:02 UTC | [https://cran.r-project.org/web/packages/exametrika/DESCRIPTION](https://cran.r-project.org/web/packages/exametrika/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/exametrika/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3992ece9759c9d` from `cran_packages_by_date` as `registry_expansion`
