...
<!-- canonical: https://cran.r-project.org/web/packages/chiOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chiOpenData/index.html](https://cran.r-project.org/web/packages/chiOpenData/index.html) |
| Source record ids | cran_packages_by_date-6438d3b133a674 |

## System Engineer Summary

Convenient Access to Chicago Open Data API Endpoints

## Operational Role

For a systems engineer, chiOpenData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-21 21:01:10 UTC | [https://cran.r-project.org/web/packages/chiOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/chiOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chiOpenData/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6438d3b133a674` from `cran_packages_by_date` as `registry_expansion`
