...
<!-- canonical: https://packagist.org/packages/mevdschee/php-crud-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mevdschee/php-crud-api](https://packagist.org/packages/mevdschee/php-crud-api) |
| Source record ids | packagist_search-becccd70fe87c9 |
...
For a systems engineer, mevdschee/php-crud-api belongs in the PHP inventory as part of state
...
- `packagist_search-becccd70fe87c9` from `packagist_search` as `registry_expansion`
