...
<!-- canonical: https://github.com/tuhdo/sample-os -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tuhdo/sample-os](https://github.com/tuhdo/sample-os) |
| Source record ids | github_search_assembly-88687aa7f2e15c |
...
For a systems engineer, tuhdo/sample-os belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-09-12T04:54:16Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-88687aa7f2e15c` from `github_search_assembly` as `registry_expansion`
