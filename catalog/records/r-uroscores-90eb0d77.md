...
<!-- canonical: https://cran.r-project.org/web/packages/uroscores/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/uroscores/index.html](https://cran.r-project.org/web/packages/uroscores/index.html) |
| Source record ids | cran_packages_by_date-1d04046593c38a |
...
For a systems engineer, uroscores belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 13:00:02 UTC | [https://cran.r-project.org/web/packages/uroscores/DESCRIPTION](https://cran.r-project.org/web/packages/uroscores/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/uroscores/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-1d04046593c38a` from `cran_packages_by_date` as `registry_expansion`
