...
<!-- canonical: https://cran.r-project.org/web/packages/clidatajp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clidatajp/index.html](https://cran.r-project.org/web/packages/clidatajp/index.html) |
| Source record ids | cran_packages_by_date-7de727b243ae7e |
...
For a systems engineer, clidatajp belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-08-26 22:10:02 UTC | [https://cran.r-project.org/web/packages/clidatajp/DESCRIPTION](https://cran.r-project.org/web/packages/clidatajp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clidatajp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7de727b243ae7e` from `cran_packages_by_date` as `registry_expansion`
