...
| Source record ids | lua-source-21 |

## System Engineer Summary

Concurrency and Multithreading is tracked as a concurrency parallelism record in the Lua family
...
For a systems engineer, Concurrency and Multithreading belongs in the Lua family inventory as part
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 21}}` |
...
- `lua-source-21` from `master_json` as `source_list_item`
