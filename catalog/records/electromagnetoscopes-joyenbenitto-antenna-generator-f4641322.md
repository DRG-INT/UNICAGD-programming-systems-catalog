...
<!-- canonical: https://github.com/JoyenBenitto/Antenna_generator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JoyenBenitto/Antenna_generator](https://github.com/JoyenBenitto/Antenna_generator) |
| Source record ids | github_search_electromagnetoscopes-54075d186a3bbf |

## System Engineer Summary

antenna_generator is a python package that allows you to generate microstrip patch antenna in the
HFSS software, we have added support for optimizations like cut-out, slots and L slot.

## Operational Role

For a systems engineer, JoyenBenitto/Antenna_generator belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-26T14:29:14Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-54075d186a3bbf` from `github_search_electromagnetoscopes` as `registry_expansion`
