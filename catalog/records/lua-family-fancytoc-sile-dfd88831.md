...
| Canonical URL | [https://luarocks.org/modules/omikhleia/fancytoc.sile](https://luarocks.org/modules/omikhleia/fancytoc.sile) |
| Source record ids | luarocks_root_manifest-7762155466327d |

## System Engineer Summary

(DEPRECATED: now an integral part of resilient.sile) Some fancy table of contents for the SILE
typesetting system.

## Operational Role

For a systems engineer, fancytoc.sile belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7762155466327d` from `luarocks_root_manifest` as `registry_expansion`
