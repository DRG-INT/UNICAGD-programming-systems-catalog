...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sboehler/knut -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sboehler/knut](https://github.com/sboehler/knut) |
| Source record ids | github_search_magazines-1ae3835f442081 |
...
For a systems engineer, sboehler/knut belongs in the Magazines inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-03T22:22:06Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-1ae3835f442081` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| tomoTaka01/BindingExampleExercise | Ffi Bindings | [open](magazines-tomotaka01-bindingexampleexercise-770b6a16.md) |
