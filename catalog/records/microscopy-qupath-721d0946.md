...
| Source record ids | curated_language_routes-bd4744d33d87f9 |

## System Engineer Summary

Bioimage analysis application for pathology, whole-slide imaging, annotation, detection, and
measurement.

## Operational Role

For a systems engineer, QuPath belongs in the Microscopy inventory as part of ecosystem capability
...
- Latest stable metadata was observed from `https://api.github.com/repos/qupath/qupath/releases/latest` at `2026-09-01T07:24:45+00:00`.
...
- `curated_language_routes-bd4744d33d87f9` from `curated_language_routes` as `registry_expansion`
