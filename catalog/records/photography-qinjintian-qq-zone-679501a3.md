...
| Source record ids | github_search_photography-549e8a0613edab |

## System Engineer Summary

QQ空间备份：扫码登录，一键下载相册原图、原视频和实况图（保留EXIF），并备份自己和好友的说说与留言板（含评论/回复，生成本地网页）。支持增量续传与失败重试。QZone album +
shuoshuo + guestbook backup.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T13:30:39Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-549e8a0613edab` from `github_search_photography` as `registry_expansion`
