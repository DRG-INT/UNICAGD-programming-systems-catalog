...
<!-- canonical: https://cran.r-project.org/web/packages/BCodifSIS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BCodifSIS/index.html](https://cran.r-project.org/web/packages/BCodifSIS/index.html) |
| Source record ids | cran_packages_by_date-448ac52672e352 |
...
For a systems engineer, BCodifSIS belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-06 13:00:08 UTC | [https://cran.r-project.org/web/packages/BCodifSIS/DESCRIPTION](https://cran.r-project.org/web/packages/BCodifSIS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BCodifSIS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-448ac52672e352` from `cran_packages_by_date` as `registry_expansion`
