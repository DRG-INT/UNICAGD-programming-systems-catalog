...
| Canonical URL | [https://public.ccsds.org/default.aspx](https://public.ccsds.org/default.aspx) |
| Source record ids | curated_language_routes-40ca02e0b559b2 |

## System Engineer Summary

Consultative Committee for Space Data Systems standards route for spacecraft communication,
telemetry, telecommand, and data systems.

## Operational Role

For a systems engineer, CCSDS belongs in the SatCom Satellites inventory as part of ecosystem
...
- `curated_language_routes-40ca02e0b559b2` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| DVB-S2 | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/satcom-satellites-dvb-s2-cd7b5095.md) |
