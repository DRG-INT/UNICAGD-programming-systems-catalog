...
<!-- canonical: https://github.com/r-dbi/odbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/r-dbi/odbc](https://github.com/r-dbi/odbc) |
| Source record ids | github_search_databases-df70430da19ca4 |
...
For a systems engineer, r-dbi/odbc belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T13:25:02Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-df70430da19ca4` from `github_search_databases` as `registry_expansion`
