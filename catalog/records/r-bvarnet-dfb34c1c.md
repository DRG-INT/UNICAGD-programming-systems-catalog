...
<!-- canonical: https://cran.r-project.org/web/packages/bvarnet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bvarnet/index.html](https://cran.r-project.org/web/packages/bvarnet/index.html) |
| Source record ids | cran_packages_by_date-7d60264e802d1a |
...
For a systems engineer, bvarnet belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-31 20:20:02 UTC | [https://cran.r-project.org/web/packages/bvarnet/DESCRIPTION](https://cran.r-project.org/web/packages/bvarnet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bvarnet/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7d60264e802d1a` from `cran_packages_by_date` as `registry_expansion`
