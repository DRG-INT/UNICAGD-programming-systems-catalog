...
| Source record ids | corpus-399c145170bddf |

## System Engineer Summary

lyaml is tracked as a serialization record in the Lua family branch. The source did not provide a
...
For a systems engineer, lyaml belongs in the Lua family inventory as part of wire formats,
...
- `corpus-399c145170bddf` from `master_json` as `serialization`
