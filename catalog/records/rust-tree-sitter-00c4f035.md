...
| Source record ids | corpus-4f9b61c863190c |

## System Engineer Summary

tree-sitter is tracked as a parser lexer ast record in the Rust branch. The source did not provide a
...
For a systems engineer, tree-sitter belongs in the Rust inventory as part of language tooling, code
...
- `corpus-4f9b61c863190c` from `master_json` as `parser_lexer_ast`
