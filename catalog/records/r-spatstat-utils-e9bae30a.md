...
<!-- canonical: https://cran.r-project.org/web/packages/spatstat.utils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spatstat.utils/index.html](https://cran.r-project.org/web/packages/spatstat.utils/index.html) |
| Source record ids | cran_packages_by_date-53d0d2f805fddf |
...
For a systems engineer, spatstat.utils belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2-5 | 2026-09-11 07:20:02 UTC | [https://cran.r-project.org/web/packages/spatstat.utils/DESCRIPTION](https://cran.r-project.org/web/packages/spatstat.utils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spatstat.utils/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-53d0d2f805fddf` from `cran_packages_by_date` as `registry_expansion`
