# stephengold/LbjExamples

## Navigation

[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stephengold/LbjExamples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stephengold/LbjExamples](https://github.com/stephengold/LbjExamples) |
| Source record ids | github_search_physics_engines-f463407060d8f7 |

## System Engineer Summary

Documentation and example applications for the Libbulletjme physics-simulation library (code has New
BSD license)

## Operational Role

For a systems engineer, stephengold/LbjExamples belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T20:35:17Z | gh search repos topic:soft-body stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f463407060d8f7` from `github_search_physics_engines` as `registry_expansion`
