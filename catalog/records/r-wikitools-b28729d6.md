...
<!-- canonical: https://cran.r-project.org/web/packages/wikiTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wikiTools/index.html](https://cran.r-project.org/web/packages/wikiTools/index.html) |
| Source record ids | cran_packages_by_date-8f772790b46544 |
...
For a systems engineer, wikiTools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.26 | 2026-08-22 15:20:08 UTC | [https://cran.r-project.org/web/packages/wikiTools/DESCRIPTION](https://cran.r-project.org/web/packages/wikiTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wikiTools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8f772790b46544` from `cran_packages_by_date` as `registry_expansion`
