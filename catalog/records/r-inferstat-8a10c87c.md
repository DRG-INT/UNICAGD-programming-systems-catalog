...
<!-- canonical: https://cran.r-project.org/web/packages/inferstat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inferstat/index.html](https://cran.r-project.org/web/packages/inferstat/index.html) |
| Source record ids | cran_packages_by_date-53e647e8cc4977 |

## System Engineer Summary

Publication-Ready Inferential Statistics and Visualization

## Operational Role

For a systems engineer, inferstat belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-04 09:40:14 UTC | [https://cran.r-project.org/web/packages/inferstat/DESCRIPTION](https://cran.r-project.org/web/packages/inferstat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inferstat/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-53e647e8cc4977` from `cran_packages_by_date` as `registry_expansion`
