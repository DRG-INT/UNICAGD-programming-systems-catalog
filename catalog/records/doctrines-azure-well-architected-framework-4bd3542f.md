...
<!-- canonical: https://learn.microsoft.com/azure/well-architected/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://learn.microsoft.com/azure/well-architected/](https://learn.microsoft.com/azure/well-architected/) |
| Source record ids | curated_language_routes-1f6b5bc9668677 |

## System Engineer Summary

Azure architecture doctrine for reliability, security, cost, operations, and performance tradeoffs.

## Operational Role

For a systems engineer, Azure Well-Architected Framework belongs in the Doctrines inventory as part
...
- `curated_language_routes-1f6b5bc9668677` from `curated_language_routes` as `registry_expansion`
