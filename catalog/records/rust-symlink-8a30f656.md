...
| Canonical URL | [https://crates.io/crates/symlink](https://crates.io/crates/symlink) |
| Source record ids | crates_io-5186e9693cb5ef |
...
For a systems engineer, symlink belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2017-01-27T06:32:44.213617Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-5186e9693cb5ef` from `crates_io` as `registry_expansion`
