...
<!-- canonical: https://github.com/ruddyscent/gmes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ruddyscent/gmes](https://github.com/ruddyscent/gmes) |
| Source record ids | github_search_electromagnetoscopes-1eaea61e82ff28 |

## System Engineer Summary

PyTorch-based electromagnetic FDTD simulator in pure Python for 1D, 2D, and 3D domains, with CPU and
multi-GPU CUDA execution

## Operational Role

For a systems engineer, ruddyscent/gmes belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T13:44:41Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; The Unlicense; https://api.github.com/licenses/unlicense; Other |
...
- `github_search_electromagnetoscopes-1eaea61e82ff28` from `github_search_electromagnetoscopes` as `registry_expansion`
