...
<!-- canonical: https://cran.r-project.org/web/packages/childfree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/childfree/index.html](https://cran.r-project.org/web/packages/childfree/index.html) |
| Source record ids | cran_packages_by_date-5ca7c834b7eaf0 |
...
For a systems engineer, childfree belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-08-21 05:44:45 UTC | [https://cran.r-project.org/web/packages/childfree/DESCRIPTION](https://cran.r-project.org/web/packages/childfree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/childfree/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5ca7c834b7eaf0` from `cran_packages_by_date` as `registry_expansion`
