...
<!-- canonical: https://cran.r-project.org/web/packages/coinclp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/coinclp/index.html](https://cran.r-project.org/web/packages/coinclp/index.html) |
| Source record ids | cran_packages_by_date-6ed344cb56af12 |

## System Engineer Summary

R Interface to the 'COIN-OR' 'Clp' Linear Programming Solver

## Operational Role

For a systems engineer, coinclp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 11:10:02 UTC | [https://cran.r-project.org/web/packages/coinclp/DESCRIPTION](https://cran.r-project.org/web/packages/coinclp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/coinclp/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-6ed344cb56af12` from `cran_packages_by_date` as `registry_expansion`
