...
<!-- canonical: https://github.com/OpenOCL/OpenOCL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenOCL/OpenOCL](https://github.com/OpenOCL/OpenOCL) |
| Source record ids | github_search_matlab-64db30ae02533a |

## System Engineer Summary

Open Optimal Control Library for Matlab. Trajectory Optimization and non-linear Model Predictive
Control (MPC) toolbox.

## Operational Role

For a systems engineer, OpenOCL/OpenOCL belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-24T08:18:30Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-64db30ae02533a` from `github_search_matlab` as `registry_expansion`
