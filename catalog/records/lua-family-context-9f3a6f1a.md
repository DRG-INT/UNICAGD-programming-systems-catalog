...
<!-- canonical: https://luarocks.org/modules/mah0x211/context -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/context](https://luarocks.org/modules/mah0x211/context) |
| Source record ids | luarocks_root_manifest-9f54615ca5d3e9 |
...
For a systems engineer, context belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9f54615ca5d3e9` from `luarocks_root_manifest` as `registry_expansion`
