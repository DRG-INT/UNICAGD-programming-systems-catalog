...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wesbos/Advanced-React -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wesbos/Advanced-React](https://github.com/wesbos/Advanced-React) |
| Source record ids | github_search_telescopes-cb2fa4891f0d98 |
...
For a systems engineer, wesbos/Advanced-React belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-03T18:33:06Z | gh search repos topic:fits stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-06 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:fits stars:>20", "retrieved": "2026-09-06", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-cb2fa4891f0d98` from `github_search_telescopes` as `registry_expansion`
