...
<!-- canonical: https://github.com/dev-asterix/PgStudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dev-asterix/PgStudio](https://github.com/dev-asterix/PgStudio) |
| Source record ids | awesome_list-d92212e3048905 |

## System Engineer Summary

Open-source VS Code / Open VSX extension for PostgreSQL management with SQL notebooks, AI assistant,
Easy to use code snippets and Full-fledged DBMS with real-time monitoring dashboard.

## Operational Role

For a systems engineer, PgStudio belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-d92212e3048905` from `awesome_list` as `registry_expansion`
