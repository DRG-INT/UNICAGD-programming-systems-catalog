...
[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.basilisk-browser.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.basilisk-browser.org/](https://www.basilisk-browser.org/) |
| Source record ids | curated_language_routes-5f6876ac7e67ac |

## System Engineer Summary

Open-source desktop web browser named Basilisk; tracked separately because the project name overlaps
language/framework records.

## Operational Role

For a systems engineer, Basilisk Browser belongs in the Basilisk inventory as part of runtime
...
- `curated_language_routes-5f6876ac7e67ac` from `curated_language_routes` as `registry_expansion`
