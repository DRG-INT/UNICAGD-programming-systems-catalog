...
<!-- canonical: https://github.com/jedisct1/as-wasi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jedisct1/as-wasi](https://github.com/jedisct1/as-wasi) |
| Source record ids | github_search_webassembly-c74102a60ba55e |
...
For a systems engineer, jedisct1/as-wasi belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-27T10:52:19Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-c74102a60ba55e` from `github_search_webassembly` as `registry_expansion`
...
| pion/webrtc | Api Abi Checker | [open](webassembly-pion-webrtc-128d6b83.md) |
