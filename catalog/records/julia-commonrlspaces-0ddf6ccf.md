...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CommonRLSpaces](https://github.com/JuliaRegistries/General/tree/master/C/CommonRLSpaces) |
| Source record ids | julia_general-dbf496a2e7f3b2 |

## System Engineer Summary

Julia package registered in General at C/CommonRLSpaces.

## Operational Role

For a systems engineer, CommonRLSpaces belongs in the Julia inventory as part of editor
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CommonRLSpaces", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-dbf496a2e7f3b2` from `julia_general` as `registry_expansion`
