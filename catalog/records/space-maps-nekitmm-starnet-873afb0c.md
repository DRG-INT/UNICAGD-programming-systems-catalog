...
<!-- canonical: https://github.com/nekitmm/starnet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nekitmm/starnet](https://github.com/nekitmm/starnet) |
| Source record ids | github_search_space_maps-07ef177e391078 |

## System Engineer Summary

nekitmm/starnet is tracked as a parser lexer ast record in the Space Maps branch. The source did not
...
For a systems engineer, nekitmm/starnet belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-12T22:34:37Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-07ef177e391078` from `github_search_space_maps` as `registry_expansion`
