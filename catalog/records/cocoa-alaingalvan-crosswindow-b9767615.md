...
<!-- canonical: https://github.com/alaingalvan/CrossWindow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alaingalvan/CrossWindow](https://github.com/alaingalvan/CrossWindow) |
| Source record ids | github_search_cocoa-47bb8bc345355f |

## System Engineer Summary

💻📱 A cross platform system abstraction library written in C++ for managing windows and performing OS
tasks.

## Operational Role

For a systems engineer, alaingalvan/CrossWindow belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-15T22:17:52Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-47bb8bc345355f` from `github_search_cocoa` as `registry_expansion`
