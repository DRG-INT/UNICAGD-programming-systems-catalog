...
<!-- canonical: https://hackage.haskell.org/package/higher-leveldb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/higher-leveldb](https://hackage.haskell.org/package/higher-leveldb) |
| Source record ids | hackage_top_downloads-91e82a8ac9901a |
...
For a systems engineer, higher-leveldb belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2020-03-18T12:13:54Z | [https://hackage.haskell.org/package/higher-leveldb](https://hackage.haskell.org/package/higher-leveldb) |  |
| candidate | partial | 0.0.2.2 |  | [https://hackage.haskell.org/package/higher-leveldb](https://hackage.haskell.org/package/higher-leveldb) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/higher-leveldb` at `2026-09-10T01:21:05+00:00`.
...
- `hackage_top_downloads-91e82a8ac9901a` from `hackage_top_downloads` as `registry_expansion`
