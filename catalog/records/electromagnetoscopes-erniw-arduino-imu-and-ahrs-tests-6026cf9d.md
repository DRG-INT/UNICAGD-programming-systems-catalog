# ErniW/Arduino-IMU-and-AHRS-tests

## Navigation

[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ErniW/Arduino-IMU-and-AHRS-tests -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ErniW/Arduino-IMU-and-AHRS-tests](https://github.com/ErniW/Arduino-IMU-and-AHRS-tests) |
| Source record ids | github_search_electromagnetoscopes-94ced42f6534c7 |

## System Engineer Summary

Various 6-dof and 9-dof orientation sensors test for the purpose of Tangible Interaction Design
classes.

## Operational Role

For a systems engineer, ErniW/Arduino-IMU-and-AHRS-tests belongs in the Electromagnetoscopes
inventory as part of unit/integration validation, regression protection, and release confidence.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-10T12:10:07Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-94ced42f6534c7` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| abduznik/instrumation | Testing Framework | [open](electromagnetoscopes-abduznik-instrumation-46ef2281.md) |
| aradfarahani/awesome-geophysics | Testing Framework | [open](electromagnetoscopes-aradfarahani-awesome-geophysics-faed83f7.md) |
| IoT-PTv/IoT-PT-v1 | Testing Framework | [open](electromagnetoscopes-iot-ptv-iot-pt-v1-052c2efe.md) |
| meshtastic/antenna-reports | Testing Framework | [open](electromagnetoscopes-meshtastic-antenna-reports-d6148f51.md) |
