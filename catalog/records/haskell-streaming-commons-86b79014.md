...
<!-- canonical: https://hackage.haskell.org/package/streaming-commons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/streaming-commons](https://hackage.haskell.org/package/streaming-commons) |
| Source record ids | hackage_top_downloads-3151eaa3445ddd |
...
For a systems engineer, streaming-commons belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3.1 | 2025-10-28T07:24:15Z | [https://hackage.haskell.org/package/streaming-commons](https://hackage.haskell.org/package/streaming-commons) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/streaming-commons` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-3151eaa3445ddd` from `hackage_top_downloads` as `registry_expansion`
