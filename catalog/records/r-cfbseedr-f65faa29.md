...
<!-- canonical: https://cran.r-project.org/web/packages/cfbseedR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cfbseedR/index.html](https://cran.r-project.org/web/packages/cfbseedR/index.html) |
| Source record ids | cran_packages_by_date-9c411a75812ce1 |

## System Engineer Summary

Simulate and Evaluate College Football Seasons

## Operational Role

For a systems engineer, cfbseedR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-09 14:50:11 UTC | [https://cran.r-project.org/web/packages/cfbseedR/DESCRIPTION](https://cran.r-project.org/web/packages/cfbseedR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cfbseedR/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-9c411a75812ce1` from `cran_packages_by_date` as `registry_expansion`
