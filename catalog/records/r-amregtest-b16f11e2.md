...
<!-- canonical: https://cran.r-project.org/web/packages/amregtest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/amregtest/index.html](https://cran.r-project.org/web/packages/amregtest/index.html) |
| Source record ids | cran_packages_by_date-cb2bb5beb7faeb |
...
For a systems engineer, amregtest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2026-08-04 21:40:18 UTC | [https://cran.r-project.org/web/packages/amregtest/DESCRIPTION](https://cran.r-project.org/web/packages/amregtest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/amregtest/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cb2bb5beb7faeb` from `cran_packages_by_date` as `registry_expansion`
