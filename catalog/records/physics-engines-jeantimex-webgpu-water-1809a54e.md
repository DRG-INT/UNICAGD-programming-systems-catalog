...
<!-- canonical: https://github.com/jeantimex/webgpu-water -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeantimex/webgpu-water](https://github.com/jeantimex/webgpu-water) |
| Source record ids | github_search_physics_engines-571380037de022 |
...
For a systems engineer, jeantimex/webgpu-water belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-21T15:40:57Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-571380037de022` from `github_search_physics_engines` as `registry_expansion`
