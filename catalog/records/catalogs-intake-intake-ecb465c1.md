...
<!-- canonical: https://github.com/intake/intake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/intake/intake](https://github.com/intake/intake) |
| Source record ids | github_search_catalogs-58e23060cff519 |
...
For a systems engineer, intake/intake belongs in the Catalogs inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T20:13:02Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-58e23060cff519` from `github_search_catalogs` as `registry_expansion`
