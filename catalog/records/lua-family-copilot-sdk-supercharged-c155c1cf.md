...
<!-- canonical: https://luarocks.org/modules/jeremiahisaacson/copilot-sdk-supercharged -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jeremiahisaacson/copilot-sdk-supercharged](https://luarocks.org/modules/jeremiahisaacson/copilot-sdk-supercharged) |
| Source record ids | luarocks_root_manifest-5d3dbd53ef41c6 |

## System Engineer Summary

Lua Supercharged SDK for the GitHub Copilot CLI

## Operational Role

For a systems engineer, copilot-sdk-supercharged belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-5d3dbd53ef41c6` from `luarocks_root_manifest` as `registry_expansion`
