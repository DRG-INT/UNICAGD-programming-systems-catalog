...
<!-- canonical: https://cran.r-project.org/web/packages/datarobot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datarobot/index.html](https://cran.r-project.org/web/packages/datarobot/index.html) |
| Source record ids | cran_packages_by_date-f7930c4c3a4f87 |
...
For a systems engineer, datarobot belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.18.9 | 2026-09-09 22:00:02 UTC | [https://cran.r-project.org/web/packages/datarobot/DESCRIPTION](https://cran.r-project.org/web/packages/datarobot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datarobot/DESCRIPTION` at `2026-09-09T22:18:43+00:00`.
...
- `cran_packages_by_date-f7930c4c3a4f87` from `cran_packages_by_date` as `registry_expansion`
