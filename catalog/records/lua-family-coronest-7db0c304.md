...
<!-- canonical: https://luarocks.org/modules/saucisson/coronest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/saucisson/coronest](https://luarocks.org/modules/saucisson/coronest) |
| Source record ids | luarocks_root_manifest-0e4c6b1186131e |
...
For a systems engineer, coronest belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0e4c6b1186131e` from `luarocks_root_manifest` as `registry_expansion`
