...
<!-- canonical: https://cran.r-project.org/web/packages/pkgnet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pkgnet/index.html](https://cran.r-project.org/web/packages/pkgnet/index.html) |
| Source record ids | cran_packages_by_date-8bd8cbd4546c4f |
...
For a systems engineer, pkgnet belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-31 15:00:02 UTC | [https://cran.r-project.org/web/packages/pkgnet/DESCRIPTION](https://cran.r-project.org/web/packages/pkgnet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pkgnet/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8bd8cbd4546c4f` from `cran_packages_by_date` as `registry_expansion`
