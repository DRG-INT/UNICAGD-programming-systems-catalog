...
<!-- canonical: https://crates.io/crates/sdd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sdd](https://crates.io/crates/sdd) |
| Source record ids | crates_io-774603c1c5f8c5 |
...
For a systems engineer, sdd belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.10 | 2026-08-25T10:19:43.054111Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-774603c1c5f8c5` from `crates_io` as `registry_expansion`
