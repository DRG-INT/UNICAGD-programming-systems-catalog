...
<!-- canonical: https://github.com/subethaedit/SubEthaEdit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/subethaedit/SubEthaEdit](https://github.com/subethaedit/SubEthaEdit) |
| Source record ids | github_search_cocoa-d87da6e88967b8 |
...
For a systems engineer, subethaedit/SubEthaEdit belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-09T15:30:33Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-d87da6e88967b8` from `github_search_cocoa` as `registry_expansion`
