...
| Source record ids | corpus-b8e7a67b7e5ae1 |

## System Engineer Summary

Espree is tracked as a parser lexer ast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Espree belongs in the Node.js/JavaScript inventory as part of language
...
| Evidence | MIT + file LICENSE; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `corpus-b8e7a67b7e5ae1` from `master_json` as `parser_lexer_ast`
