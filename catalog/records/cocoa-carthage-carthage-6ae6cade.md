...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_cocoa-9986c3c11cc1c2 |
...
For a systems engineer, Carthage/Carthage belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-10T15:36:04Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-9986c3c11cc1c2` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CocoaPods/CocoaPods | Dependency Manager | [open](cocoa-cocoapods-cocoapods-b02abfdf.md) |
| googlesamples/unity-jar-resolver | Dependency Manager | [open](cocoa-googlesamples-unity-jar-resolver-c1f52085.md) |
