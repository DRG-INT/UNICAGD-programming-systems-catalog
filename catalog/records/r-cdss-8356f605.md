...
<!-- canonical: https://cran.r-project.org/web/packages/CDSS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CDSS/index.html](https://cran.r-project.org/web/packages/CDSS/index.html) |
| Source record ids | cran_packages_by_date-f4adb2c4c9ae00 |
...
For a systems engineer, CDSS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-0 | 2026-09-07 08:20:02 UTC | [https://cran.r-project.org/web/packages/CDSS/DESCRIPTION](https://cran.r-project.org/web/packages/CDSS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CDSS/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-f4adb2c4c9ae00` from `cran_packages_by_date` as `registry_expansion`
