...
<!-- canonical: https://cran.r-project.org/web/packages/moveEZ/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/moveEZ/index.html](https://cran.r-project.org/web/packages/moveEZ/index.html) |
| Source record ids | cran_packages_by_date-ea378002e74c64 |

## System Engineer Summary

moveEZ is tracked as a visualization gui record in the R branch. The source did not provide a long
...
For a systems engineer, moveEZ belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-26 21:20:02 UTC | [https://cran.r-project.org/web/packages/moveEZ/DESCRIPTION](https://cran.r-project.org/web/packages/moveEZ/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/moveEZ/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ea378002e74c64` from `cran_packages_by_date` as `registry_expansion`
