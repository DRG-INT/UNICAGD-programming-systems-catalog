...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/alexirae/unreal-audio-dsp-template-UE5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexirae/unreal-audio-dsp-template-UE5](https://github.com/alexirae/unreal-audio-dsp-template-UE5) |
| Source record ids | github_search_effects-b17e95e567b40d |

## System Engineer Summary

A simple Unreal 5 plugin with demo content that shows how audio DSP can be implemented as Metasound,
SourceEffect and SubmixEffect. The intention is to use it as a template to create more complex audio
DSP effects.

## Operational Role

For a systems engineer, alexirae/unreal-audio-dsp-template-UE5 belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-27T20:52:01Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b17e95e567b40d` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| egorshest/webgl-ascii-hero | Project Scaffolding | [open](effects-egorshest-webgl-ascii-hero-396764a5.md) |
| ektogamat/r3f-webgpu-starter | Project Scaffolding | [open](effects-ektogamat-r3f-webgpu-starter-019b1d3e.md) |
| ektogamat/threejs-particle-skull | Project Scaffolding | [open](effects-ektogamat-threejs-particle-skull-7f0c9f9b.md) |
| xrdevrob/QuestCameraKit | Project Scaffolding | [open](effects-xrdevrob-questcamerakit-eeb9dfe2.md) |
