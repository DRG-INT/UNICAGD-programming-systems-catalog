...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Container Deployment](../by-category/container-deployment.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/homebridge/docker-homebridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/homebridge/docker-homebridge](https://github.com/homebridge/docker-homebridge) |
| Source record ids | github_search_video-9cae897b8520c0 |

## System Engineer Summary

Homebridge Docker. HomeKit support for the impatient using Docker on x86_64, Raspberry Pi (ARM64).
Includes ffmpeg + libfdk-aac.

## Operational Role

For a systems engineer, homebridge/docker-homebridge belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T10:28:42Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- Treat category as `container_deployment` unless a later verified source gives a better classification.
...
- `github_search_video-9cae897b8520c0` from `github_search_video` as `registry_expansion`
