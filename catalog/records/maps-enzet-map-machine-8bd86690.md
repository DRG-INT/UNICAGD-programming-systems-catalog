...
<!-- canonical: https://github.com/enzet/map-machine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/enzet/map-machine](https://github.com/enzet/map-machine) |
| Source record ids | github_search_maps-e20c53a448ae82 |

## System Engineer Summary

Python renderer for OpenStreetMap with custom icons intended to display as many map features as
possible

## Operational Role

For a systems engineer, enzet/map-machine belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-26T09:58:32Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-e20c53a448ae82` from `github_search_maps` as `registry_expansion`
