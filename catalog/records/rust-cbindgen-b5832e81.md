...
<!-- canonical: https://crates.io/crates/cbindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cbindgen](https://crates.io/crates/cbindgen) |
| Source record ids | crates_io-9186481db4c73a |
...
For a systems engineer, cbindgen belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.4 | 2026-06-09T19:03:00.526368Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-9186481db4c73a` from `crates_io` as `registry_expansion`
