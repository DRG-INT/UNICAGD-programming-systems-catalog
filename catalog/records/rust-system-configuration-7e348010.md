...
<!-- canonical: https://crates.io/crates/system-configuration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/system-configuration](https://crates.io/crates/system-configuration) |
| Source record ids | crates_io-52db8b54f039ff |
...
For a systems engineer, system-configuration belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-11T14:28:09.786896Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-52db8b54f039ff` from `crates_io` as `registry_expansion`
