# Gitea: rickyboy1234567890/ascii-art
...
<!-- canonical: https://gitea.com/rickyboy1234567890/ascii-art -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/rickyboy1234567890/ascii-art](https://gitea.com/rickyboy1234567890/ascii-art) |
| Source record ids | gitea_repositories_api-3969c7028a1099 |
...
For a systems engineer, Gitea: rickyboy1234567890/ascii-art belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-06T11:55:57Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-3969c7028a1099` from `gitea_repositories_api` as `registry_expansion`
