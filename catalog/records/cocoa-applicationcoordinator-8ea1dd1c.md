...
<!-- canonical: https://github.com/AndreyPanov/ApplicationCoordinator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AndreyPanov/ApplicationCoordinator](https://github.com/AndreyPanov/ApplicationCoordinator) |
| Source record ids | awesome_list-11f979c03da8a5 |

## System Engineer Summary

Coordinator is an object that handles navigation flow and shares flow’s handling for the next
coordinator after switching on the next chain.

## Operational Role

For a systems engineer, ApplicationCoordinator belongs in the Cocoa inventory as part of model
...
- `awesome_list-11f979c03da8a5` from `awesome_list` as `registry_expansion`
