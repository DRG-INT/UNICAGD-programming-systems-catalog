...
<!-- canonical: https://cran.r-project.org/web/packages/rpanelauto/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rpanelauto/index.html](https://cran.r-project.org/web/packages/rpanelauto/index.html) |
| Source record ids | cran_packages_by_date-6da4576d7d4339 |
...
For a systems engineer, rpanelauto belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-05 07:10:02 UTC | [https://cran.r-project.org/web/packages/rpanelauto/DESCRIPTION](https://cran.r-project.org/web/packages/rpanelauto/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rpanelauto/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6da4576d7d4339` from `cran_packages_by_date` as `registry_expansion`
