...
<!-- canonical: https://crates.io/crates/bit-vec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bit-vec](https://crates.io/crates/bit-vec) |
| Source record ids | crates_io-18107450658b3e |

## System Engineer Summary

bit-vec is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, bit-vec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2026-07-10T12:48:24.191676Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-18107450658b3e` from `crates_io` as `registry_expansion`
