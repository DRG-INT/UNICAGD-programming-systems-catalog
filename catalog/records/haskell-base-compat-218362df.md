...
<!-- canonical: https://hackage.haskell.org/package/base-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/base-compat](https://hackage.haskell.org/package/base-compat) |
| Source record ids | hackage_top_downloads-7781143666df1a |
...
For a systems engineer, base-compat belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-01-11T03:01:40Z | [https://hackage.haskell.org/package/base-compat](https://hackage.haskell.org/package/base-compat) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/base-compat` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-7781143666df1a` from `hackage_top_downloads` as `registry_expansion`
