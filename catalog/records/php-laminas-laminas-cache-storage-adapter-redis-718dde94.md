...
<!-- canonical: https://packagist.org/packages/laminas/laminas-cache-storage-adapter-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laminas/laminas-cache-storage-adapter-redis](https://packagist.org/packages/laminas/laminas-cache-storage-adapter-redis) |
| Source record ids | packagist_search-fed32f93031564 |
...
For a systems engineer, laminas/laminas-cache-storage-adapter-redis belongs in the PHP inventory as
...
- `packagist_search-fed32f93031564` from `packagist_search` as `registry_expansion`
