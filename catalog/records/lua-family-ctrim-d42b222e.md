...
<!-- canonical: https://luarocks.org/modules/isavegas/ctrim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/isavegas/ctrim](https://luarocks.org/modules/isavegas/ctrim) |
| Source record ids | luarocks_root_manifest-83634a333da197 |

## System Engineer Summary

C implementation of a trim function.

## Operational Role

For a systems engineer, ctrim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-83634a333da197` from `luarocks_root_manifest` as `registry_expansion`
