...
<!-- canonical: https://hackage.haskell.org/package/stackctl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stackctl](https://hackage.haskell.org/package/stackctl) |
| Source record ids | hackage_top_downloads-88dbec929c0755 |
...
For a systems engineer, stackctl belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.3.7 | 2025-10-17T20:25:59Z | [https://hackage.haskell.org/package/stackctl](https://hackage.haskell.org/package/stackctl) |  |
| candidate | partial | 1.7.3.0 |  | [https://hackage.haskell.org/package/stackctl](https://hackage.haskell.org/package/stackctl) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stackctl` at `2026-09-02T15:26:32+00:00`.
...
- `hackage_top_downloads-88dbec929c0755` from `hackage_top_downloads` as `registry_expansion`
