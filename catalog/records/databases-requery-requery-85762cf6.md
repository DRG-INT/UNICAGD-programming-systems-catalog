...
<!-- canonical: https://github.com/requery/requery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/requery/requery](https://github.com/requery/requery) |
| Source record ids | github_search_databases-ebfb464e1815df |
...
For a systems engineer, requery/requery belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-09T08:58:28Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ebfb464e1815df` from `github_search_databases` as `registry_expansion`
