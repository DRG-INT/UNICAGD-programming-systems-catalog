...
| Canonical URL | [https://crates.io/crates/indent_write](https://crates.io/crates/indent_write) |
| Source record ids | crates_io-b643e60a9e7b6c |
...
For a systems engineer, indent_write belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2021-04-21T21:55:11.070742Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-b643e60a9e7b6c` from `crates_io` as `registry_expansion`
