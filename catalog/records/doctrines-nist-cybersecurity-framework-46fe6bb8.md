...
<!-- canonical: https://www.nist.gov/cyberframework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nist.gov/cyberframework](https://www.nist.gov/cyberframework) |
| Source record ids | curated_language_routes-b6bb1a01b37979 |

## System Engineer Summary

Cybersecurity risk-management doctrine used for identify, protect, detect, respond, and recover
functions.

## Operational Role

For a systems engineer, NIST Cybersecurity Framework belongs in the Doctrines inventory as part of
...
- `curated_language_routes-b6bb1a01b37979` from `curated_language_routes` as `registry_expansion`
