...
<!-- canonical: https://crates.io/crates/sqlx-macros-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlx-macros-core](https://crates.io/crates/sqlx-macros-core) |
| Source record ids | crates_io-4f5ca92a3a8b39 |
...
For a systems engineer, sqlx-macros-core belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-05-21T17:34:54.550730Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-4f5ca92a3a8b39` from `crates_io` as `registry_expansion`
