...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/UniPD-DII-ETCOMP/Half_Space_Green_A_Phi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UniPD-DII-ETCOMP/Half_Space_Green_A_Phi](https://github.com/UniPD-DII-ETCOMP/Half_Space_Green_A_Phi) |
| Source record ids | github_search_electromagnetoscopes-a083d6a09e4a64 |

## System Engineer Summary

This directory contains a simplified matlab and fortran version of the STRATA library for the
computation of the Green's function of an Half space background. It can be used for research and
academic purposes. In this MATLAB/Fortran version only the half space case (two semi-infinite
layers) is considered. Moreover, only the "integrate" technique is implemented and we only focus on
the components of the dyadic K(A), and the scalar term K(φ), as defined in formulation-C of 1 The
original C++ Strata library, instead, also implements the multi-layer version of the Green's
functions and other methods (DCIM, quasistatic) and features are provided. See for more details.

## Operational Role

For a systems engineer, UniPD-DII-ETCOMP/Half_Space_Green_A_Phi belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-04T09:32:14Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_electromagnetoscopes-a083d6a09e4a64` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 720kb/radiobox.css | Undefined Behavior Analyzer | [open](electromagnetoscopes-720kb-radiobox-css-3e1ebc91.md) |
| azlux/botamusique | Undefined Behavior Analyzer | [open](electromagnetoscopes-azlux-botamusique-8fc6bb3f.md) |
| cjcliffe/CubicSDR | Undefined Behavior Analyzer | [open](electromagnetoscopes-cjcliffe-cubicsdr-4d39607b.md) |
| dabana/TEM_dash | Undefined Behavior Analyzer | [open](electromagnetoscopes-dabana-tem-dash-d58d5144.md) |
| echristhuraj/CubeSatDetumblingSimulator | Undefined Behavior Analyzer | [open](electromagnetoscopes-echristhuraj-cubesatdetumblingsimulator-bb34a534.md) |
| f4exb/sdrangel | Undefined Behavior Analyzer | [open](electromagnetoscopes-f4exb-sdrangel-2939271b.md) |
| GeoBrain-Project/GeoBrain | Undefined Behavior Analyzer | [open](electromagnetoscopes-geobrain-project-geobrain-aeb85431.md) |
| greatscottgadgets/ubertooth | Undefined Behavior Analyzer | [open](electromagnetoscopes-greatscottgadgets-ubertooth-28bac228.md) |
