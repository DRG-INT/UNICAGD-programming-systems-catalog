...
<!-- canonical: https://github.com/SuomiKP31/JUCE_VST3_Mixer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SuomiKP31/JUCE_VST3_Mixer](https://github.com/SuomiKP31/JUCE_VST3_Mixer) |
| Source record ids | github_search_effects-0a21741b7d3ac3 |

## System Engineer Summary

A JUCE-made vst plugin with filters, effects and audio outputs. Project for UVic CSC561

## Operational Role

For a systems engineer, SuomiKP31/JUCE_VST3_Mixer belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-17T22:48:38Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0a21741b7d3ac3` from `github_search_effects` as `registry_expansion`
