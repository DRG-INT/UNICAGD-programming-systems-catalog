...
<!-- canonical: https://crates.io/crates/is_executable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/is_executable](https://crates.io/crates/is_executable) |
| Source record ids | crates_io-7e04fc5726dc7f |
...
For a systems engineer, is_executable belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2026-06-15T16:33:45.091228Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; The Unlicense; https://api.github.com/licenses/unlicense |
