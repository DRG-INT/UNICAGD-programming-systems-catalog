...
<!-- canonical: https://github.com/vespa-engine/vespa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vespa-engine/vespa](https://github.com/vespa-engine/vespa) |
| Source record ids | github_search_databases-97fa8a8c4e425c |

## System Engineer Summary

vespa-engine/vespa is tracked as a database datastore record in the Databases branch. The source did
...
For a systems engineer, vespa-engine/vespa belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:20:54Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-97fa8a8c4e425c` from `github_search_databases` as `registry_expansion`
