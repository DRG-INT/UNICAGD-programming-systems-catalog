...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Nuke.Utilities.Text.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Nuke.Utilities.Text.Json](https://www.nuget.org/packages/Nuke.Utilities.Text.Json) |
| Source record ids | nuget_search-dc9b29acf7df34 |

## System Engineer Summary

The AKEless Build System for C#/.NET Signed by signpath.io from repository ' commit
'8aaec258a7e00e5d98e013be025db1a42bc58d79' (see contained AppVeyorSettings.json file for build
settings).

## Operational Role

For a systems engineer, Nuke.Utilities.Text.Json belongs in the C-Sharp inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.1.0 | 2025-12-02T09:58:31.07+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nuke.utilities.text.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nuke.utilities.text.json/index.json) |  |
| preview | known | 6.4.0-alpha0161 | 2023-03-09T22:30:43.1+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nuke.utilities.text.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nuke.utilities.text.json/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; MIT; https://www.nuget.org/packages/Nuke.Utilities.Text.Json/10.1.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/nuke.utilities.text.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-dc9b29acf7df34` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Cake.Json | Build System | [open](c-sharp-cake-json-e461b46b.md) |
| Microsoft.AspNetCore.Http.Abstractions | Build System | [open](c-sharp-microsoft-aspnetcore-http-abstractions-32462ee9.md) |
| Microsoft.Extensions.Configuration.Json | Build System | [open](c-sharp-microsoft-extensions-configuration-json-0917f9b9.md) |
| Refit | Build System | [open](c-sharp-refit-26771c60.md) |
