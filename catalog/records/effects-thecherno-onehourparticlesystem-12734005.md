...
<!-- canonical: https://github.com/TheCherno/OneHourParticleSystem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheCherno/OneHourParticleSystem](https://github.com/TheCherno/OneHourParticleSystem) |
| Source record ids | github_search_effects-646453b922a3d0 |

## System Engineer Summary

Simple particle system made in one hour:

## Operational Role

For a systems engineer, TheCherno/OneHourParticleSystem belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-19T23:17:00Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-646453b922a3d0` from `github_search_effects` as `registry_expansion`
