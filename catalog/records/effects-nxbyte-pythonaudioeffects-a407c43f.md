...
<!-- canonical: https://github.com/nxbyte/PythonAudioEffects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nxbyte/PythonAudioEffects](https://github.com/nxbyte/PythonAudioEffects) |
| Source record ids | github_search_effects-a6913279b8937a |

## System Engineer Summary

A Python library that can apply: darth vader, echo, radio, robotic, and ghost effects to audio
samples.

## Operational Role

For a systems engineer, nxbyte/PythonAudioEffects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-16T16:58:25Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a6913279b8937a` from `github_search_effects` as `registry_expansion`
