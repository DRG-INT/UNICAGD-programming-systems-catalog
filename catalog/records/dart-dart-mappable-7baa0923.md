...
<!-- canonical: https://pub.dev/packages/dart_mappable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dart_mappable](https://pub.dev/packages/dart_mappable) |
| Source record ids | pub_dev-9ec8d37ff34b46 |

## System Engineer Summary

Improved json serialization and data classes with full support for generics, inheritance,
customization and more.

## Operational Role

For a systems engineer, dart_mappable belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.10.0 | 2026-09-07T18:27:34.185167Z | [https://pub.dev/api/packages/dart_mappable](https://pub.dev/api/packages/dart_mappable) |  |
| preview | known | 4.0.0-dev.1 | 2023-09-19T08:30:39.833892Z | [https://pub.dev/api/packages/dart_mappable](https://pub.dev/api/packages/dart_mappable) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dart_mappable` at `2026-09-07T20:19:55+00:00`.
...
- `pub_dev-9ec8d37ff34b46` from `pub_dev` as `registry_expansion`
