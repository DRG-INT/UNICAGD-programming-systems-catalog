...
<!-- canonical: https://github.com/DatanoiseTV/dsplab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DatanoiseTV/dsplab](https://github.com/DatanoiseTV/dsplab) |
| Source record ids | github_search_effects-fb76b6d5147925 |

## System Engineer Summary

A AI-assisted lab/livecoding IDE for Audio DSP. With audio scope, spectrum analyzer, audio analyzer,
agentic coding.

## Operational Role

For a systems engineer, DatanoiseTV/dsplab belongs in the Effects inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-30T11:51:24Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-fb76b6d5147925` from `github_search_effects` as `registry_expansion`
