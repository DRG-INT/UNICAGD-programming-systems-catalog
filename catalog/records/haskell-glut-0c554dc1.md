...
<!-- canonical: https://hackage.haskell.org/package/GLUT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/GLUT](https://hackage.haskell.org/package/GLUT) |
| Source record ids | hackage_top_downloads-5a0d9bb235277e |
...
For a systems engineer, GLUT belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0.16 | 2021-01-18T07:49:45Z | [https://hackage.haskell.org/package/GLUT](https://hackage.haskell.org/package/GLUT) |  |
| candidate | partial | 2.5.1.1 |  | [https://hackage.haskell.org/package/GLUT](https://hackage.haskell.org/package/GLUT) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/GLUT` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-5a0d9bb235277e` from `hackage_top_downloads` as `registry_expansion`
