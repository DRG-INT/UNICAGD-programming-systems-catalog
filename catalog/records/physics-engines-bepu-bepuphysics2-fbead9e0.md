...
<!-- canonical: https://github.com/bepu/bepuphysics2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bepu/bepuphysics2](https://github.com/bepu/bepuphysics2) |
| Source record ids | github_search_physics_engines-c2bd6b523c7674 |
...
For a systems engineer, bepu/bepuphysics2 belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T21:08:47Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-c2bd6b523c7674` from `github_search_physics_engines` as `registry_expansion`
