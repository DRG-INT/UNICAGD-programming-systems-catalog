...
<!-- canonical: https://hackage.haskell.org/package/digest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/digest](https://hackage.haskell.org/package/digest) |
| Source record ids | hackage_top_downloads-44fa2a32b21bd6 |
...
For a systems engineer, digest belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2.1 | 2024-02-10T14:26:08Z | [https://hackage.haskell.org/package/digest](https://hackage.haskell.org/package/digest) |  |
| candidate | partial | 0.0.1.3 |  | [https://hackage.haskell.org/package/digest](https://hackage.haskell.org/package/digest) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/digest` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-44fa2a32b21bd6` from `hackage_top_downloads` as `registry_expansion`
