...
<!-- canonical: https://github.com/xxczaki/oji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xxczaki/oji](https://github.com/xxczaki/oji) |
| Source record ids | github_search_icons_and_logos-790749c09bb2dd |
...
For a systems engineer, xxczaki/oji belongs in the Icons and Logos inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-30T03:52:50Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-790749c09bb2dd` from `github_search_icons_and_logos` as `registry_expansion`
