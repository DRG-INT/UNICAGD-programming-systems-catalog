...
<!-- canonical: https://github.com/vitorvilela/droplet-particle-collision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vitorvilela/droplet-particle-collision](https://github.com/vitorvilela/droplet-particle-collision) |
| Source record ids | github_search_basilisk-177ff253704d46 |

## System Engineer Summary

A series of droplet-particle impact simulation scenarios based on basilisk.fr CFD framework. It
includes: 1. Three-phase flow modeling; 2. Evaporation case in the gavaises-2016b directory; 3.
Design of Computer Experiment and Statistical Learning Methods Applied to model liquid film
interfacial area, amirfazli-2017 case.

## Operational Role

For a systems engineer, vitorvilela/droplet-particle-collision belongs in the Basilisk inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-22T22:00:38Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-177ff253704d46` from `github_search_basilisk` as `registry_expansion`
...
| VatsalSy/BasiliskVisualization | Networking Http | [open](basilisk-vatsalsy-basiliskvisualization-22421330.md) |
