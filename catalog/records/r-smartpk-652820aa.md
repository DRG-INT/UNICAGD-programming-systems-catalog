...
<!-- canonical: https://cran.r-project.org/web/packages/SmartPK/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SmartPK/index.html](https://cran.r-project.org/web/packages/SmartPK/index.html) |
| Source record ids | cran_packages_by_date-dfbd5e82eb77a2 |
...
For a systems engineer, SmartPK belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-24 14:40:02 UTC | [https://cran.r-project.org/web/packages/SmartPK/DESCRIPTION](https://cran.r-project.org/web/packages/SmartPK/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SmartPK/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dfbd5e82eb77a2` from `cran_packages_by_date` as `registry_expansion`
