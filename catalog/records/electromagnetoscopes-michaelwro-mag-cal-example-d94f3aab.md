...
<!-- canonical: https://github.com/michaelwro/mag-cal-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/michaelwro/mag-cal-example](https://github.com/michaelwro/mag-cal-example) |
| Source record ids | github_search_electromagnetoscopes-3850d30f8c1fce |
...
For a systems engineer, michaelwro/mag-cal-example belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-22T17:55:50Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-3850d30f8c1fce` from `github_search_electromagnetoscopes` as `registry_expansion`
