...
<!-- canonical: https://www.npmjs.com/package/start-server-and-test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/start-server-and-test](https://www.npmjs.com/package/start-server-and-test) |
| Source record ids | npm_registry-003e7aee40d351 |
...
For a systems engineer, start-server-and-test belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.12 | 2026-08-01T10:38:13.536Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-003e7aee40d351` from `npm_registry` as `registry_expansion`
