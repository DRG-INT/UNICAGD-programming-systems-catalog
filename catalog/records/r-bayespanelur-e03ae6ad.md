...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/BayesPanelUR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesPanelUR/index.html](https://cran.r-project.org/web/packages/BayesPanelUR/index.html) |
| Source record ids | cran_packages_by_date-650314bca5e9bf |
...
For a systems engineer, BayesPanelUR belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 13:30:07 UTC | [https://cran.r-project.org/web/packages/BayesPanelUR/DESCRIPTION](https://cran.r-project.org/web/packages/BayesPanelUR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesPanelUR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
| --- | --- | --- | --- |
| cran_available_packages_by_date | registry-derived | 2026-09-04 | `{"kind": "cran_available_packages_by_date", "retrieved": "2026-09-04", "status": "registry-derived"}` |
...
- `cran_packages_by_date-650314bca5e9bf` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amregtest | Testing Framework | [open](r-amregtest-b16f11e2.md) |
| autoFC | Testing Framework | [open](r-autofc-9a8250f6.md) |
| autotestR | Testing Framework | [open](r-autotestr-c5aa62f0.md) |
| BayesSplineUR | Testing Framework | [open](r-bayessplineur-7190359d.md) |
| BayesURTrend | Testing Framework | [open](r-bayesurtrend-bed6ca25.md) |
| citcdf | Testing Framework | [open](r-citcdf-34c124c6.md) |
| CompositionalMPT | Testing Framework | [open](r-compositionalmpt-fb68d530.md) |
| DAGassist | Testing Framework | [open](r-dagassist-b248a183.md) |
