...
<!-- canonical: https://github.com/liyupi/yu-ai-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/liyupi/yu-ai-agent](https://github.com/liyupi/yu-ai-agent) |
| Source record ids | github_search_databases-f16d331b79086f |

## System Engineer Summary

编程导航 AI 开发实战新项目，基于 Spring Boot 3 + Java 21 + Spring AI 构建 AI 恋爱大师应用和 ReAct 模式自主规划智能体YuManus，覆盖 AI
大模型接入、Spring AI 核心特性、Prompt 工程和优化、RAG 检索增强、向量数据库、Tool Calling 工具调用、MCP 模型上下文协议、AI Agent 开发（Manas
Java 实现）、Cursor AI 工具等核心知识。用一套教程将程序员必知必会的 AI 技术一网打尽，帮你成为 AI 时代企业的香饽饽，给你的简历和求职大幅增加竞争力。

## Operational Role

For a systems engineer, liyupi/yu-ai-agent belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-07T05:47:52Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f16d331b79086f` from `github_search_databases` as `registry_expansion`
