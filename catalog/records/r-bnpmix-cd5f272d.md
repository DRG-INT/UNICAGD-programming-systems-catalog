...
<!-- canonical: https://cran.r-project.org/web/packages/BNPmix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BNPmix/index.html](https://cran.r-project.org/web/packages/BNPmix/index.html) |
| Source record ids | cran_packages_by_date-217be1eae3050a |
...
For a systems engineer, BNPmix belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-08-04 20:40:02 UTC | [https://cran.r-project.org/web/packages/BNPmix/DESCRIPTION](https://cran.r-project.org/web/packages/BNPmix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BNPmix/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-217be1eae3050a` from `cran_packages_by_date` as `registry_expansion`
