...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@ksmithut/prettier-standard](https://www.npmjs.com/package/@ksmithut/prettier-standard) |
| Source record ids | npm_registry-54fe1412573bed |
...
For a systems engineer, @ksmithut/prettier-standard belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-10-17T02:41:25.662Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @angular/language-server | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-language-server-3e834c73.md) |
| @astrojs/language-server | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-astrojs-language-server-17f2a6f3.md) |
| @embroider/macros | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-embroider-macros-29a00721.md) |
| @eslint/js | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-eslint-js-c83f2528.md) |
| @eslint/markdown | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-eslint-markdown-397a0750.md) |
| @github/copilot-language-server-darwin-arm64 | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-github-copilot-language-server-darwin-arm64-20bcc86b.md) |
| @github/copilot-language-server-linux-x64 | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-github-copilot-language-server-linux-x64-02307b0b.md) |
| @locker/shared | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-locker-shared-c4a9bfa0.md) |
