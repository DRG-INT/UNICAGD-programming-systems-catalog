...
<!-- canonical: https://gitea.com/NSIS/language-data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/NSIS/language-data](https://gitea.com/NSIS/language-data) |
| Source record ids | gitea_repositories_api-5314c1a9e49c6f |
...
For a systems engineer, Gitea: NSIS/language-data belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-09T16:06:47Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-5314c1a9e49c6f` from `gitea_repositories_api` as `registry_expansion`
