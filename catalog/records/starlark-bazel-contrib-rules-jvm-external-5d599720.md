...
<!-- canonical: https://github.com/bazel-contrib/rules_jvm_external -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_jvm_external](https://github.com/bazel-contrib/rules_jvm_external) |
| Source record ids | github_search_starlark-6cc69cee5bfea2 |
...
For a systems engineer, bazel-contrib/rules_jvm_external belongs in the Starlark inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T15:53:58Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-6cc69cee5bfea2` from `github_search_starlark` as `registry_expansion`
...
| starlark-rust | Interpreter Runtime | [open](starlark-starlark-rust-9ce7042b.md) |
