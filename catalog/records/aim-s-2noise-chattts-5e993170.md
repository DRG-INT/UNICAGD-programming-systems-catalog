...
<!-- canonical: https://github.com/2noise/ChatTTS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2noise/ChatTTS](https://github.com/2noise/ChatTTS) |
| Source record ids | github_search_aims-c8917a3c8e7217 |
...
For a systems engineer, 2noise/ChatTTS belongs in the "aim's" inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T16:33:48Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-c8917a3c8e7217` from `github_search_aims` as `registry_expansion`
