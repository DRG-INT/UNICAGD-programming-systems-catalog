...
<!-- canonical: https://www.npmjs.com/package/@trackunit/graphql-build-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@trackunit/graphql-build-tools](https://www.npmjs.com/package/@trackunit/graphql-build-tools) |
| Source record ids | npm_registry-bbf03f3cc205b4 |

## System Engineer Summary

`@trackunit/graphql-build-tools` provides a CLI and reusable transformer helpers for producing
Manager-compatible GraphQL SDL in service build pipelines.

## Operational Role

For a systems engineer, @trackunit/graphql-build-tools belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.88 | 2026-08-31T14:06:16.617Z | [https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
