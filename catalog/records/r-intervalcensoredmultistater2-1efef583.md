...
<!-- canonical: https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/index.html](https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/index.html) |
| Source record ids | cran_packages_by_date-047c8acbcbb679 |
...
For a systems engineer, IntervalCensoredMultistateR2 belongs in the R inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-06 13:10:28 UTC | [https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/DESCRIPTION](https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IntervalCensoredMultistateR2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-047c8acbcbb679` from `cran_packages_by_date` as `registry_expansion`
