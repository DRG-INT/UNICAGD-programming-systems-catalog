...
| Canonical URL | [https://packagist.org/packages/doctrine/mongodb-odm](https://packagist.org/packages/doctrine/mongodb-odm) |
| Source record ids | packagist_search-abffc706162155 |

## System Engineer Summary

PHP Doctrine MongoDB Object Document Mapper (ODM) provides transparent persistence for PHP objects
to MongoDB.

## Operational Role

For a systems engineer, doctrine/mongodb-odm belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.17.0 | 2026-09-01T10:03:58+00:00 | [https://repo.packagist.org/p2/doctrine/mongodb-odm.json](https://repo.packagist.org/p2/doctrine/mongodb-odm.json) |  |
| preview | known | 2.0.0-RC2 | 2019-09-24T18:59:10+00:00 | [https://repo.packagist.org/p2/doctrine/mongodb-odm.json](https://repo.packagist.org/p2/doctrine/mongodb-odm.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/doctrine/mongodb-odm.json` at `2026-09-01T10:22:03+00:00`.
...
- `packagist_search-abffc706162155` from `packagist_search` as `registry_expansion`
