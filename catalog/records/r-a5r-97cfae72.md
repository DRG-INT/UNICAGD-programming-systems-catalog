...
<!-- canonical: https://cran.r-project.org/web/packages/a5R/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/a5R/index.html](https://cran.r-project.org/web/packages/a5R/index.html) |
| Source record ids | cran_packages_by_date-18cdc2186cc386 |
...
For a systems engineer, a5R belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-08 11:50:15 UTC | [https://cran.r-project.org/web/packages/a5R/DESCRIPTION](https://cran.r-project.org/web/packages/a5R/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/a5R/DESCRIPTION` at `2026-09-08T12:26:51+00:00`.
...
- `cran_packages_by_date-18cdc2186cc386` from `cran_packages_by_date` as `registry_expansion`
