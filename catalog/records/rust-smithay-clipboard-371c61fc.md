...
| Canonical URL | [https://crates.io/crates/smithay-clipboard](https://crates.io/crates/smithay-clipboard) |
| Source record ids | crates_io-e1fb478ac1b618 |
...
For a systems engineer, smithay-clipboard belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.3 | 2025-11-02T20:12:35.216592Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-e1fb478ac1b618` from `crates_io` as `registry_expansion`
