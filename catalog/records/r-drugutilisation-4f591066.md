...
<!-- canonical: https://cran.r-project.org/web/packages/DrugUtilisation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DrugUtilisation/index.html](https://cran.r-project.org/web/packages/DrugUtilisation/index.html) |
| Source record ids | cran_packages_by_date-a5ed0a421669ad |
...
For a systems engineer, DrugUtilisation belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-21 21:50:50 UTC | [https://cran.r-project.org/web/packages/DrugUtilisation/DESCRIPTION](https://cran.r-project.org/web/packages/DrugUtilisation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DrugUtilisation/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a5ed0a421669ad` from `cran_packages_by_date` as `registry_expansion`
