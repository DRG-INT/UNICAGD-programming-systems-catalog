...
<!-- canonical: https://cran.r-project.org/web/packages/ncdfgeom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ncdfgeom/index.html](https://cran.r-project.org/web/packages/ncdfgeom/index.html) |
| Source record ids | cran_packages_by_date-2462bbedb22dd7 |
...
For a systems engineer, ncdfgeom belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-09-09 05:20:24 UTC | [https://cran.r-project.org/web/packages/ncdfgeom/DESCRIPTION](https://cran.r-project.org/web/packages/ncdfgeom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ncdfgeom/DESCRIPTION` at `2026-09-09T06:26:10+00:00`.
...
- `cran_packages_by_date-2462bbedb22dd7` from `cran_packages_by_date` as `registry_expansion`
