...
<!-- canonical: https://pub.dev/packages/mesh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mesh](https://pub.dev/packages/mesh) |
| Source record ids | pub_dev-e24ec75e3d537f |

## System Engineer Summary

Fast and highly customizable animated Mesh Gradients for Flutter applications. Using Shaders and
vertices.

## Operational Role

For a systems engineer, mesh belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2025-05-17T21:42:43.111789Z | [https://pub.dev/api/packages/mesh](https://pub.dev/api/packages/mesh) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mesh` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-e24ec75e3d537f` from `pub_dev` as `registry_expansion`
