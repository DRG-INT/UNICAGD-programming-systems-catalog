...
<!-- canonical: https://github.com/python/cpython -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/python/cpython](https://github.com/python/cpython) |
| Source record ids | curated_repository_workplace_routes-d0f54093f40eb2 |

## System Engineer Summary

Official CPython source repository route.

## Operational Role

For a systems engineer, Python CPython Source belongs in the Repository Workplaces inventory as part
...
- `curated_repository_workplace_routes-d0f54093f40eb2` from `curated_repository_workplace_routes` as `registry_expansion`
