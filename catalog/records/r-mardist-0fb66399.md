...
<!-- canonical: https://cran.r-project.org/web/packages/mardist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mardist/index.html](https://cran.r-project.org/web/packages/mardist/index.html) |
| Source record ids | cran_packages_by_date-32e31707cc51d5 |
...
For a systems engineer, mardist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-14 15:30:02 UTC | [https://cran.r-project.org/web/packages/mardist/DESCRIPTION](https://cran.r-project.org/web/packages/mardist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mardist/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-32e31707cc51d5` from `cran_packages_by_date` as `registry_expansion`
