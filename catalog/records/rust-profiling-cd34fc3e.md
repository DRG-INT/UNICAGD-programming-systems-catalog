...
<!-- canonical: https://crates.io/crates/profiling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/profiling](https://crates.io/crates/profiling) |
| Source record ids | crates_io-e7e9c35fecb259 |
...
For a systems engineer, profiling belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.18 | 2026-05-04T03:33:15.842050Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-e7e9c35fecb259` from `crates_io` as `registry_expansion`
