...
<!-- canonical: https://github.com/couler-proj/couler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/couler-proj/couler](https://github.com/couler-proj/couler) |
| Source record ids | github_search_engines-379469d7fe50ed |

## System Engineer Summary

Unified Interface for Constructing and Managing Workflows on different workflow engines, such as
Argo Workflows, Tekton Pipelines, and Apache Airflow.

## Operational Role

For a systems engineer, couler-proj/couler belongs in the Engines inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-08T03:31:54Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_engines-379469d7fe50ed` from `github_search_engines` as `registry_expansion`
