...
<!-- canonical: https://hackage.haskell.org/package/Z-IO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Z-IO](https://hackage.haskell.org/package/Z-IO) |
| Source record ids | hackage_top_downloads-380593457b2182 |
...
For a systems engineer, Z-IO belongs in the Haskell inventory as part of ecosystem capability
...
- `hackage_top_downloads-380593457b2182` from `hackage_top_downloads` as `registry_expansion`
