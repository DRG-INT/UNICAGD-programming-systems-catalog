...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Video](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/video.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://webrtc.org/](https://webrtc.org/) |
| Source record ids | curated_language_routes-3a936302081cd3 |

## System Engineer Summary

Real-time media stack for audio/video capture, encoding, transport, data channels, and
browser/native communication.

## Operational Role

For a systems engineer, WebRTC belongs in the Video inventory as part of service communication,
...
- `curated_language_routes-3a936302081cd3` from `curated_language_routes` as `registry_expansion`
