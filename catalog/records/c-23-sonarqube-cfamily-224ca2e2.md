...
| Source record ids | corpus-a57ba23ce39ab6 |

## System Engineer Summary

SonarQube CFamily is tracked as a static analyzer record in the C++23 branch. The source did not
...
For a systems engineer, SonarQube CFamily belongs in the C++23 inventory as part of defect
...
- `corpus-a57ba23ce39ab6` from `master_json` as `static_analyzer`
