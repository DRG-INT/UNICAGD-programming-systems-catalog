...
<!-- canonical: https://github.com/CGrassin/rtl_power_scripts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CGrassin/rtl_power_scripts](https://github.com/CGrassin/rtl_power_scripts) |
| Source record ids | github_search_electromagnetoscopes-710c74dc119bbd |
...
For a systems engineer, CGrassin/rtl_power_scripts belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-15T18:30:02Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-710c74dc119bbd` from `github_search_electromagnetoscopes` as `registry_expansion`
