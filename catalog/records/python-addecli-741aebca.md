...
<!-- canonical: https://pypi.org/project/addecli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/addecli/](https://pypi.org/project/addecli/) |
| Source record ids | pypi_simple-86b3fbee7b8d7e |
...
For a systems engineer, addecli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2024-05-16T16:51:22.628007Z | [https://pypi.org/pypi/addecli/json](https://pypi.org/pypi/addecli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/addecli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-86b3fbee7b8d7e` from `pypi_simple` as `registry_expansion`
