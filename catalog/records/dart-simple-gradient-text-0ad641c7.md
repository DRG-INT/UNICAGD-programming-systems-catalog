...
<!-- canonical: https://pub.dev/packages/simple_gradient_text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/simple_gradient_text](https://pub.dev/packages/simple_gradient_text) |
| Source record ids | pub_dev-9b4cd65b920dfa |

## System Engineer Summary

Create fast and simple gradient texts, whether linear or radial, you just decide the colors and the
text to display, very easy.

## Operational Role

For a systems engineer, simple_gradient_text belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-01-03T18:27:12.162763Z | [https://pub.dev/api/packages/simple_gradient_text](https://pub.dev/api/packages/simple_gradient_text) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/simple_gradient_text` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-9b4cd65b920dfa` from `pub_dev` as `registry_expansion`
