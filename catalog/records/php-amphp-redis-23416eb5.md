...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/amphp/redis](https://packagist.org/packages/amphp/redis) |
| Source record ids | packagist_search-407c0d0b77c74d |

## System Engineer Summary

Efficient asynchronous communication with Redis servers, enabling scalable and responsive data
storage and retrieval.

## Operational Role

For a systems engineer, amphp/redis belongs in the PHP inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.4 | 2026-03-03T20:56:06+00:00 | [https://repo.packagist.org/p2/amphp/redis.json](https://repo.packagist.org/p2/amphp/redis.json) |  |
| preview | known | v2.0.0-beta.3 | 2022-11-07T22:45:48+00:00 | [https://repo.packagist.org/p2/amphp/redis.json](https://repo.packagist.org/p2/amphp/redis.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/amphp/redis.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-407c0d0b77c74d` from `packagist_search` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| amphp/http-client | Ffi Bindings | [open](php-amphp-http-client-81576c4b.md) |
| easyswoole/mysqli | Ffi Bindings | [open](php-easyswoole-mysqli-e0a059d6.md) |
