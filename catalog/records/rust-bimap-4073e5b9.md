...
| Canonical URL | [https://crates.io/crates/bimap](https://crates.io/crates/bimap) |
| Source record ids | crates_io-6eabd2d8105f88 |

## System Engineer Summary

bimap is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, bimap belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2023-03-19T03:46:32.359420Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-6eabd2d8105f88` from `crates_io` as `registry_expansion`
