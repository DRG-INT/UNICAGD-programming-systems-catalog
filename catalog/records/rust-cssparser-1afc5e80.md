...
<!-- canonical: https://crates.io/crates/cssparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cssparser](https://crates.io/crates/cssparser) |
| Source record ids | crates_io-e3d672982d7f06 |
...
For a systems engineer, cssparser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.38.0 | 2026-09-07T11:36:13.335039Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-07T12:26:32+00:00`.
...
- `crates_io-e3d672982d7f06` from `crates_io` as `registry_expansion`
