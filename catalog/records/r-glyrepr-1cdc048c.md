...
<!-- canonical: https://cran.r-project.org/web/packages/glyrepr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glyrepr/index.html](https://cran.r-project.org/web/packages/glyrepr/index.html) |
| Source record ids | cran_packages_by_date-140c1927ab835a |
...
For a systems engineer, glyrepr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-22 13:30:02 UTC | [https://cran.r-project.org/web/packages/glyrepr/DESCRIPTION](https://cran.r-project.org/web/packages/glyrepr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glyrepr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-140c1927ab835a` from `cran_packages_by_date` as `registry_expansion`
