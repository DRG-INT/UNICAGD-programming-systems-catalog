...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/scc -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.8.8 | 2026-09-01T07:10:33.557110Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; {"key": "", "name": "", "url": ""}; The Unlicense; https://api.github.com/licenses/unlicense |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-01T07:19:29+00:00`.
...
- `crates_io-892d600d129d5c` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ahash | Benchmarking | [open](rust-ahash-9735ee0b.md) |
| criterion | Benchmarking | [open](rust-criterion-b4f5eed6.md) |
| criterion.rs | Benchmarking | [open](rust-criterion-rs-15f7b06e.md) |
| html5ever | Benchmarking | [open](rust-html5ever-ab44a0ee.md) |
| iai-callgrind | Benchmarking | [open](rust-iai-callgrind-fbde3c5a.md) |
| imara-diff | Benchmarking | [open](rust-imara-diff-d059cc92.md) |
| inferno | Benchmarking | [open](rust-inferno-13a9b090.md) |
| lebe | Benchmarking | [open](rust-lebe-df3cdf73.md) |
