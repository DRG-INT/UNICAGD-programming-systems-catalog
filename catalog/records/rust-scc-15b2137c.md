...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Benchmarking](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/benchmarking.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/scc](https://crates.io/crates/scc) |
| Source record ids | crates_io-892d600d129d5c |

## System Engineer Summary

A collection of high-performance asynchronous/concurrent containers with both asynchronous and
synchronous interfaces

## Operational Role

For a systems engineer, scc belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.8.7 | 2026-08-29T07:07:38.233503Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| ahash | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ahash-9735ee0b.md) |
| criterion | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-criterion-b4f5eed6.md) |
| criterion.rs | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-criterion-rs-15f7b06e.md) |
| html5ever | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-html5ever-ab44a0ee.md) |
| iai-callgrind | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-iai-callgrind-fbde3c5a.md) |
| imara-diff | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-imara-diff-d059cc92.md) |
| inferno | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-inferno-13a9b090.md) |
| lebe | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-lebe-df3cdf73.md) |
