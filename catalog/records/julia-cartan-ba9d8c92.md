...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Cartan](https://github.com/JuliaRegistries/General/tree/master/C/Cartan) |
| Source record ids | julia_general-a4fb9bf3104459 |

## System Engineer Summary

Julia package registered in General at C/Cartan.

## Operational Role

For a systems engineer, Cartan belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Cartan", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-a4fb9bf3104459` from `julia_general` as `registry_expansion`
