...
<!-- canonical: https://cran.r-project.org/web/packages/EFAtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EFAtools/index.html](https://cran.r-project.org/web/packages/EFAtools/index.html) |
| Source record ids | cran_packages_by_date-ac7c6771908748 |
...
For a systems engineer, EFAtools belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 12:20:02 UTC | [https://cran.r-project.org/web/packages/EFAtools/DESCRIPTION](https://cran.r-project.org/web/packages/EFAtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EFAtools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ac7c6771908748` from `cran_packages_by_date` as `registry_expansion`
