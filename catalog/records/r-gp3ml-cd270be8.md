...
<!-- canonical: https://cran.r-project.org/web/packages/gp3ml/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gp3ml/index.html](https://cran.r-project.org/web/packages/gp3ml/index.html) |
| Source record ids | cran_packages_by_date-70ab96b911cce0 |
...
For a systems engineer, gp3ml belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-23 10:40:34 UTC | [https://cran.r-project.org/web/packages/gp3ml/DESCRIPTION](https://cran.r-project.org/web/packages/gp3ml/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gp3ml/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-70ab96b911cce0` from `cran_packages_by_date` as `registry_expansion`
