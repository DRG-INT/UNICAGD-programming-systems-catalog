...
<!-- canonical: https://luarocks.org/modules/nickstafford2/copy-diagnostics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nickstafford2/copy-diagnostics](https://luarocks.org/modules/nickstafford2/copy-diagnostics) |
| Source record ids | luarocks_root_manifest-7abaffdbbc3e3c |
...
For a systems engineer, copy-diagnostics belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7abaffdbbc3e3c` from `luarocks_root_manifest` as `registry_expansion`
