...
<!-- canonical: https://github.com/AES0P/Purchase_order -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AES0P/Purchase_order](https://github.com/AES0P/Purchase_order) |
| Source record ids | github_search_sapjava-024f48f19f284f |
...
For a systems engineer, AES0P/Purchase_order belongs in the SAPJava inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-07T07:10:30Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-024f48f19f284f` from `github_search_sapjava` as `registry_expansion`
