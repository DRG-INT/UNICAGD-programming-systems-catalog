...
<!-- canonical: https://hackage.haskell.org/package/amazonka-emr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-emr](https://hackage.haskell.org/package/amazonka-emr) |
| Source record ids | hackage_top_downloads-bf8a3fd61c831c |
...
For a systems engineer, amazonka-emr belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:12:08Z | [https://hackage.haskell.org/package/amazonka-emr](https://hackage.haskell.org/package/amazonka-emr) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-emr` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-bf8a3fd61c831c` from `hackage_top_downloads` as `registry_expansion`
