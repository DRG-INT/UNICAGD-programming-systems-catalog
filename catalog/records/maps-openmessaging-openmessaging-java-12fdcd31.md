...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/openmessaging/openmessaging-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openmessaging/openmessaging-java](https://github.com/openmessaging/openmessaging-java) |
| Source record ids | github_search_maps-16baea0ee70f80 |
...
For a systems engineer, openmessaging/openmessaging-java belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-26T21:33:00Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-16baea0ee70f80` from `github_search_maps` as `registry_expansion`
