...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/assimp/assimp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/assimp/assimp](https://github.com/assimp/assimp) |
| Source record ids | github_search_game_engines-21bd78af4e8454 |
...
For a systems engineer, assimp/assimp belongs in the Game Engines inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:17:19Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-21bd78af4e8454` from `github_search_game_engines` as `registry_expansion`
