...
<!-- canonical: https://pypi.org/project/accretion-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accretion-cli/](https://pypi.org/project/accretion-cli/) |
| Source record ids | pypi_simple-8de828ef6f2a61 |
...
For a systems engineer, accretion-cli belongs in the Python inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2019-06-18T07:51:09.839383Z | [https://pypi.org/pypi/accretion-cli/json](https://pypi.org/pypi/accretion-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accretion-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-8de828ef6f2a61` from `pypi_simple` as `registry_expansion`
