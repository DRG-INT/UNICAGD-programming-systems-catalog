...
<!-- canonical: https://cran.r-project.org/web/packages/CHNOSZ/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CHNOSZ/index.html](https://cran.r-project.org/web/packages/CHNOSZ/index.html) |
| Source record ids | cran_packages_by_date-75bf3474e73709 |
...
For a systems engineer, CHNOSZ belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-31 19:31:20 UTC | [https://cran.r-project.org/web/packages/CHNOSZ/DESCRIPTION](https://cran.r-project.org/web/packages/CHNOSZ/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CHNOSZ/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-75bf3474e73709` from `cran_packages_by_date` as `registry_expansion`
