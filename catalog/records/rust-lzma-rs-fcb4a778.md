...
| Canonical URL | [https://crates.io/crates/lzma-rs](https://crates.io/crates/lzma-rs) |
| Source record ids | crates_io-12faacdc1ac817 |
...
For a systems engineer, lzma-rs belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2023-01-04T00:34:47.136594Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-12faacdc1ac817` from `crates_io` as `registry_expansion`
