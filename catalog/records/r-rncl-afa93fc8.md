...
<!-- canonical: https://cran.r-project.org/web/packages/rncl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rncl/index.html](https://cran.r-project.org/web/packages/rncl/index.html) |
| Source record ids | cran_packages_by_date-8d926c02cb132b |
...
For a systems engineer, rncl belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.10 | 2026-08-04 17:00:02 UTC | [https://cran.r-project.org/web/packages/rncl/DESCRIPTION](https://cran.r-project.org/web/packages/rncl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rncl/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8d926c02cb132b` from `cran_packages_by_date` as `registry_expansion`
