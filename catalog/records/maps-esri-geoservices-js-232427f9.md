...
<!-- canonical: https://github.com/Esri/geoservices-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Esri/geoservices-js](https://github.com/Esri/geoservices-js) |
| Source record ids | github_search_maps-14e07bb7c64239 |
...
For a systems engineer, Esri/geoservices-js belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.1 | 2017-10-30T21:50:31Z | [https://api.github.com/repos/Esri/geoservices-js/releases/latest](https://api.github.com/repos/Esri/geoservices-js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Esri/geoservices-js/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-14e07bb7c64239` from `github_search_maps` as `registry_expansion`
