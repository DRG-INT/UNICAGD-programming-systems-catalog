...
<!-- canonical: https://pypi.org/project/acdh-django-archeutils/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-archeutils/](https://pypi.org/project/acdh-django-archeutils/) |
| Source record ids | pypi_simple-a14f34b75c8226 |
...
For a systems engineer, acdh-django-archeutils belongs in the Python inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2020-01-13T13:14:23.464955Z | [https://pypi.org/pypi/acdh-django-archeutils/json](https://pypi.org/pypi/acdh-django-archeutils/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-archeutils/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-a14f34b75c8226` from `pypi_simple` as `registry_expansion`
