...
<!-- canonical: https://packagist.org/packages/symfony/http-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/http-client](https://packagist.org/packages/symfony/http-client) |
| Source record ids | packagist_search-73a2d560056f63 |
...
For a systems engineer, symfony/http-client belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-73a2d560056f63` from `packagist_search` as `registry_expansion`
