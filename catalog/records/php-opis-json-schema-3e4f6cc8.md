...
<!-- canonical: https://packagist.org/packages/opis/json-schema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/opis/json-schema](https://packagist.org/packages/opis/json-schema) |
| Source record ids | packagist_search-41ed12d3835415 |
...
For a systems engineer, opis/json-schema belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-41ed12d3835415` from `packagist_search` as `registry_expansion`
