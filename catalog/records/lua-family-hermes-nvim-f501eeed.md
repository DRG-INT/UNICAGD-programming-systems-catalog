...
| Canonical URL | [https://luarocks.org/modules/ruddickmg/hermes.nvim](https://luarocks.org/modules/ruddickmg/hermes.nvim) |
| Source record ids | luarocks_root_manifest-aa12b7b40e0f1b |

## System Engineer Summary

ACP (Agent Client Protocol) client for Neovim

## Operational Role

For a systems engineer, hermes.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-aa12b7b40e0f1b` from `luarocks_root_manifest` as `registry_expansion`
