...
<!-- canonical: https://github.com/firtoz/Unity3D-Plane-Clipping -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/firtoz/Unity3D-Plane-Clipping](https://github.com/firtoz/Unity3D-Plane-Clipping) |
| Source record ids | github_search_effects-24c91ad41b24bb |

## System Engineer Summary

Unity standard shader extension for per-object plane clipping effects.

## Operational Role

For a systems engineer, firtoz/Unity3D-Plane-Clipping belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-22T19:13:44Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-24c91ad41b24bb` from `github_search_effects` as `registry_expansion`
