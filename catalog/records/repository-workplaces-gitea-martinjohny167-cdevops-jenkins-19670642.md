# Gitea: martinjohny167/cdevops-jenkins
...
<!-- canonical: https://gitea.com/martinjohny167/cdevops-jenkins -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/martinjohny167/cdevops-jenkins](https://gitea.com/martinjohny167/cdevops-jenkins) |
| Source record ids | gitea_repositories_api-9ea4ff87247a7a |

## System Engineer Summary

install Jenkins on a cluster and use it to build from github and gitea

## Operational Role

For a systems engineer, Gitea: martinjohny167/cdevops-jenkins belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-07T01:06:41Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-9ea4ff87247a7a` from `gitea_repositories_api` as `registry_expansion`
...
| HariSekhon/DevOps-Bash-tools | Build System | [open](repository-workplaces-harisekhon-devops-bash-tools-738fa927.md) |
