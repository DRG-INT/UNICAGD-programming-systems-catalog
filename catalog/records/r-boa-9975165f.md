...
<!-- canonical: https://cran.r-project.org/web/packages/boa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/boa/index.html](https://cran.r-project.org/web/packages/boa/index.html) |
| Source record ids | cran_packages_by_date-23320bd7883eab |
...
For a systems engineer, boa belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.9 | 2026-08-27 13:10:08 UTC | [https://cran.r-project.org/web/packages/boa/DESCRIPTION](https://cran.r-project.org/web/packages/boa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/boa/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-23320bd7883eab` from `cran_packages_by_date` as `registry_expansion`
