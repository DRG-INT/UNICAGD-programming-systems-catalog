...
<!-- canonical: https://gitea.com/lcark/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/lcark/gitea](https://gitea.com/lcark/gitea) |
| Source record ids | gitea_repositories_api-46248494522c2b |
...
For a systems engineer, Gitea: lcark/gitea belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-19T10:45:18Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-46248494522c2b` from `gitea_repositories_api` as `registry_expansion`
