# AES0P/cap_java_template_platform_frontend
...
<!-- canonical: https://github.com/AES0P/cap_java_template_platform_frontend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AES0P/cap_java_template_platform_frontend](https://github.com/AES0P/cap_java_template_platform_frontend) |
| Source record ids | github_search_sapjava-8c6689d827bd08 |

## System Engineer Summary

A simple implementation that allows you to better understand CAP Java projects based on SAP BTP step
by step.

## Operational Role

For a systems engineer, AES0P/cap_java_template_platform_frontend belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-17T09:40:18Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-8c6689d827bd08` from `github_search_sapjava` as `registry_expansion`
