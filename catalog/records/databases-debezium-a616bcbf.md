...
<!-- canonical: https://github.com/debezium/debezium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/debezium/debezium](https://github.com/debezium/debezium) |
| Source record ids | curated_database_systems-e182cf194eecdf |

## System Engineer Summary

Change data capture platform for database logs.

## Operational Role

For a systems engineer, Debezium belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-e182cf194eecdf` from `curated_database_systems` as `registry_expansion`
