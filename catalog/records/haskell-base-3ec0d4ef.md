...
<!-- canonical: https://hackage.haskell.org/package/base -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/base](https://hackage.haskell.org/package/base) |
| Source record ids | hackage_top_downloads-e0743cacd244e2 |

## System Engineer Summary

Hackage package with 397 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, base belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.22.0.0 | 2025-12-19T11:52:34Z | [https://hackage.haskell.org/package/base](https://hackage.haskell.org/package/base) |  |
| candidate | partial | 4.14.3.0 |  | [https://hackage.haskell.org/package/base](https://hackage.haskell.org/package/base) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/base` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-e0743cacd244e2` from `hackage_top_downloads` as `registry_expansion`
