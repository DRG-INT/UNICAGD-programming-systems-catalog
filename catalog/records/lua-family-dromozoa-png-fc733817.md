...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-png -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-png](https://luarocks.org/modules/moyu/dromozoa-png) |
| Source record ids | luarocks_root_manifest-bac0a3bc6f97fe |

## System Engineer Summary

dromozoa-png is tracked as a ffi bindings record in the Lua family branch. The source did not
...
For a systems engineer, dromozoa-png belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-bac0a3bc6f97fe` from `luarocks_root_manifest` as `registry_expansion`
