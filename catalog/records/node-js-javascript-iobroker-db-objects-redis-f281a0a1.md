...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@iobroker/db-objects-redis](https://www.npmjs.com/package/@iobroker/db-objects-redis) |
| Source record ids | npm_registry-65d39410958a44 |
...
For a systems engineer, @iobroker/db-objects-redis belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.2 | 2026-06-16T17:21:16.203Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @a2a-js/sdk | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-a2a-js-sdk-4257c158.md) |
| @actions/http-client | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-actions-http-client-850e0bf2.md) |
| @adonisjs/http-server | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-adonisjs-http-server-c6d0fa46.md) |
| @algolia/requester-node-http | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-algolia-requester-node-http-0ff5a2d6.md) |
| @aws-amplify/graphql-http-transformer | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aws-amplify-graphql-http-transformer-8ede633f.md) |
| @aws-sdk/client-database-migration-service | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aws-sdk-client-database-migration-service-058f4424.md) |
| @azure/core-http-compat | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-azure-core-http-compat-82cb36ba.md) |
| @cedarjs/api-server | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cedarjs-api-server-0ec0ed14.md) |
