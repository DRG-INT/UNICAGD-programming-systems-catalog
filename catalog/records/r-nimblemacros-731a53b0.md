...
<!-- canonical: https://cran.r-project.org/web/packages/nimbleMacros/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nimbleMacros/index.html](https://cran.r-project.org/web/packages/nimbleMacros/index.html) |
| Source record ids | cran_packages_by_date-f4e903eb3102a0 |
...
For a systems engineer, nimbleMacros belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-20 10:00:11 UTC | [https://cran.r-project.org/web/packages/nimbleMacros/DESCRIPTION](https://cran.r-project.org/web/packages/nimbleMacros/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nimbleMacros/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f4e903eb3102a0` from `cran_packages_by_date` as `registry_expansion`
