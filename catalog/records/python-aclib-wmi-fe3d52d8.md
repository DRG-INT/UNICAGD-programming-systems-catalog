...
<!-- canonical: https://pypi.org/project/aclib.wmi/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclib.wmi/](https://pypi.org/project/aclib.wmi/) |
| Source record ids | pypi_simple-127308ef1192da |

## System Engineer Summary

aclib.wmi is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, aclib.wmi belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2023-06-12T05:00:23.640166Z | [https://pypi.org/pypi/aclib.wmi/json](https://pypi.org/pypi/aclib.wmi/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclib.wmi/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-127308ef1192da` from `pypi_simple` as `registry_expansion`
