...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Profiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/profiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AbbreviatedStackTraces](https://github.com/JuliaRegistries/General/tree/master/A/AbbreviatedStackTraces) |
| Source record ids | julia_general-c18642bf5acbb5 |

## System Engineer Summary

Julia package registered in General at A/AbbreviatedStackTraces.

## Operational Role

For a systems engineer, AbbreviatedStackTraces belongs in the Julia inventory as part of hot-path
...
| Name | Category | Page |
| --- | --- | --- |
| AcousticRayTracers | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-acousticraytracers-20f43eeb.md) |
| AtmosphericProfilesLibrary | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-atmosphericprofileslibrary-66dd6cfe.md) |
| BenchmarkProfiles | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkprofiles-47721f23.md) |
| ClearStacktrace | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clearstacktrace-34c054a3.md) |
| CompileTraces | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-compiletraces-d3a947be.md) |
| Profile | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-profile-45ecfe2d.md) |
| ProfileView.jl | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-profileview-jl-801140a7.md) |
| StatProfilerHTML.jl | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-statprofilerhtml-jl-2787970a.md) |
