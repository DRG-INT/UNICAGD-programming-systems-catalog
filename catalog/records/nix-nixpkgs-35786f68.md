...
<!-- canonical: https://github.com/NixOS/nixpkgs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NixOS/nixpkgs](https://github.com/NixOS/nixpkgs) |
| Source record ids | curated_language_routes-fc319ab06e4912 |

## System Engineer Summary

Official Nix Packages collection and NixOS module source repository.

## Operational Role

For a systems engineer, Nixpkgs belongs in the nix inventory as part of ecosystem capability
...
- `curated_language_routes-fc319ab06e4912` from `curated_language_routes` as `registry_expansion`
...
| NixOS Packages Search | Registry Repository | [open](nix-nixos-packages-search-b6615046.md) |
