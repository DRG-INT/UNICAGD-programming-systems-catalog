# adityacodes30/catalog-scoring-ondc
...
<!-- canonical: https://github.com/adityacodes30/catalog-scoring-ondc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adityacodes30/catalog-scoring-ondc](https://github.com/adityacodes30/catalog-scoring-ondc) |
| Source record ids | github_search_repertoare_catalogs-aef77e60bd0eee |

## System Engineer Summary

Developed for ONDC workflows with a scalable microservices architecture. This project scores your
commercial catalog on demand with its proprietary ml algorithm

## Operational Role

For a systems engineer, adityacodes30/catalog-scoring-ondc belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-23T17:33:29Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-aef77e60bd0eee` from `github_search_repertoare_catalogs` as `registry_expansion`
