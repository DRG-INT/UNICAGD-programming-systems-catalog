...
| Source type | embedded_hardware |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-d2b1712ce7f8ee |

## System Engineer Summary

eLua is tracked as an embedded hardware record in the Lua family branch. The source did not provide
...
For a systems engineer, eLua belongs in the Lua family inventory as part of device constraints,
...
- `corpus-d2b1712ce7f8ee` from `master_json` as `embedded_hardware`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ads1015 | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ads1015-c12dbf22.md) |
| adxl345 | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-adxl345-376e5784.md) |
| Hardware and Embedded Systems | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-hardware-and-embedded-systems-bbe851ca.md) |
| NodeMCU Lua | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-nodemcu-lua-5be552d2.md) |
