...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Utility Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/utility-library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-9fb898e04f1034 |

## System Engineer Summary

tenacity is tracked as an utility library record in the Python branch. The source did not provide a
...
For a systems engineer, tenacity belongs in the Python inventory as part of ecosystem capability
...
- `corpus-9fb898e04f1034` from `master_json` as `utility_library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| attrs | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-attrs-3a89bc9d.md) |
| boltons | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-boltons-02b3b8d7.md) |
| cachetools | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-cachetools-8a984f8d.md) |
| dataclasses | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-dataclasses-391cb92d.md) |
| more-itertools | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-more-itertools-994c20be.md) |
| platformdirs | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-platformdirs-8ca0d541.md) |
| toolz | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-toolz-ddc8d7d3.md) |
