...
<!-- canonical: https://github.com/ArtSabintsev/Guitar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ArtSabintsev/Guitar](https://github.com/ArtSabintsev/Guitar) |
| Source record ids | github_search_swift-136a1c55bd34f3 |
...
For a systems engineer, ArtSabintsev/Guitar belongs in the Swift inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-20T02:03:44Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-136a1c55bd34f3` from `github_search_swift` as `registry_expansion`
