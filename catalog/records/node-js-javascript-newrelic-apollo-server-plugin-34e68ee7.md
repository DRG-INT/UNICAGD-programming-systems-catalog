...
<!-- canonical: https://www.npmjs.com/package/@newrelic/apollo-server-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@newrelic/apollo-server-plugin](https://www.npmjs.com/package/@newrelic/apollo-server-plugin) |
| Source record ids | npm_registry-32a2d59c5896aa |
...
For a systems engineer, @newrelic/apollo-server-plugin belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2025-07-22T20:03:48.217Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-32a2d59c5896aa` from `npm_registry` as `registry_expansion`
