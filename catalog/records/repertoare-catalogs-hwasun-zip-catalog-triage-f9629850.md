...
<!-- canonical: https://github.com/hwasun-zip/Catalog-Triage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hwasun-zip/Catalog-Triage](https://github.com/hwasun-zip/Catalog-Triage) |
| Source record ids | github_search_repertoare_catalogs-e5d82ddf6678b0 |

## System Engineer Summary

SQL 기반 배달 플랫폼 카탈로그 품질 이상탐지 및 운영 우선순위 분석 (Z-Score, Window Function, Health Score 설계)

## Operational Role

For a systems engineer, hwasun-zip/Catalog-Triage belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T15:03:01Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-e5d82ddf6678b0` from `github_search_repertoare_catalogs` as `registry_expansion`
