...
<!-- canonical: https://crates.io/crates/zerofrom-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zerofrom-derive](https://crates.io/crates/zerofrom-derive) |
| Source record ids | crates_io-a0b3006d297692 |
...
For a systems engineer, zerofrom-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-09-15T21:39:20.888453Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-15T22:18:52+00:00`.
...
- `crates_io-a0b3006d297692` from `crates_io` as `registry_expansion`
