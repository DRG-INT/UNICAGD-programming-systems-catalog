...
<!-- canonical: https://luarocks.org/modules/drkjeff16/boolean-toggle.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/drkjeff16/boolean-toggle.nvim](https://luarocks.org/modules/drkjeff16/boolean-toggle.nvim) |
| Source record ids | luarocks_root_manifest-bef0bad9298304 |
...
For a systems engineer, boolean-toggle.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bef0bad9298304` from `luarocks_root_manifest` as `registry_expansion`
