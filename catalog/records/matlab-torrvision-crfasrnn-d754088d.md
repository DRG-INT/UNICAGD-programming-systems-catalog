...
| Canonical URL | [https://github.com/torrvision/crfasrnn](https://github.com/torrvision/crfasrnn) |
| Source record ids | github_search_matlab-bbf8b59ed27f51 |

## System Engineer Summary

This repository contains the source code for the semantic image segmentation method described in the
ICCV 2015 paper: Conditional Random Fields as Recurrent Neural Networks.

## Operational Role

For a systems engineer, torrvision/crfasrnn belongs in the Matlab inventory as part of ecosystem
...
| preview | known | 0.2 | 2016-05-09T22:52:02Z | [https://api.github.com/repos/torrvision/crfasrnn/releases?per_page=10](https://api.github.com/repos/torrvision/crfasrnn/releases?per_page=10) |  |
...
- `github_search_matlab-bbf8b59ed27f51` from `github_search_matlab` as `registry_expansion`
