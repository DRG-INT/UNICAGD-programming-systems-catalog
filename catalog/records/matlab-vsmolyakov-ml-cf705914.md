...
<!-- canonical: https://github.com/vsmolyakov/ml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vsmolyakov/ml](https://github.com/vsmolyakov/ml) |
| Source record ids | github_search_matlab-7f6ecfa14b2a14 |

## System Engineer Summary

vsmolyakov/ml is tracked as a language specification record in the Matlab branch. The source did not
...
For a systems engineer, vsmolyakov/ml belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-31T03:44:05Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-7f6ecfa14b2a14` from `github_search_matlab` as `registry_expansion`
