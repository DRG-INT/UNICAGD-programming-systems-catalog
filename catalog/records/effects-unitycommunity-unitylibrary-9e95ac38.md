...
<!-- canonical: https://github.com/UnityCommunity/UnityLibrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UnityCommunity/UnityLibrary](https://github.com/UnityCommunity/UnityLibrary) |
| Source record ids | github_search_effects-f9baecb7d3951c |
...
For a systems engineer, UnityCommunity/UnityLibrary belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-27T10:47:24Z | gh search repos topic:shader-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f9baecb7d3951c` from `github_search_effects` as `registry_expansion`
