...
<!-- canonical: https://github.com/SAP-samples/ams-samples-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-samples/ams-samples-java](https://github.com/SAP-samples/ams-samples-java) |
| Source record ids | github_search_sapjava-a09df1d06299b9 |

## System Engineer Summary

These sample applications show how to build applications on SAP BTP with the SCI Authorization
Management Service in Java. The repository contains sample applications with and without the CAP
framework

## Operational Role

For a systems engineer, SAP-samples/ams-samples-java belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:29:32Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-a09df1d06299b9` from `github_search_sapjava` as `registry_expansion`
