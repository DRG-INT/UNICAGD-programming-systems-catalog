...
<!-- canonical: https://cran.r-project.org/web/packages/Orangutan/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Orangutan/index.html](https://cran.r-project.org/web/packages/Orangutan/index.html) |
| Source record ids | cran_packages_by_date-68902ed71e82a2 |

## System Engineer Summary

Automated Analysis of Phenotypic Data

## Operational Role

For a systems engineer, Orangutan belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-21 05:46:15 UTC | [https://cran.r-project.org/web/packages/Orangutan/DESCRIPTION](https://cran.r-project.org/web/packages/Orangutan/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Orangutan/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-68902ed71e82a2` from `cran_packages_by_date` as `registry_expansion`
