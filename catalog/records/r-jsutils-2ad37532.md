...
<!-- canonical: https://cran.r-project.org/web/packages/jsutils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jsutils/index.html](https://cran.r-project.org/web/packages/jsutils/index.html) |
| Source record ids | cran_packages_by_date-6a7fecd0551de7 |

## System Engineer Summary

'JavaScript' Utilities for 'R'

## Operational Role

For a systems engineer, jsutils belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-21 22:00:52 UTC | [https://cran.r-project.org/web/packages/jsutils/DESCRIPTION](https://cran.r-project.org/web/packages/jsutils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jsutils/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6a7fecd0551de7` from `cran_packages_by_date` as `registry_expansion`
