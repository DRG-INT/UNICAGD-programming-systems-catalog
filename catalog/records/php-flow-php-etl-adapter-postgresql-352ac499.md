...
| Canonical URL | [https://packagist.org/packages/flow-php/etl-adapter-postgresql](https://packagist.org/packages/flow-php/etl-adapter-postgresql) |
| Source record ids | packagist_search-313cdff81db815 |
...
For a systems engineer, flow-php/etl-adapter-postgresql belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.43.0 | 2026-08-10T13:42:54+00:00 | [https://repo.packagist.org/p2/flow-php/etl-adapter-postgresql.json](https://repo.packagist.org/p2/flow-php/etl-adapter-postgresql.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/flow-php/etl-adapter-postgresql.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-313cdff81db815` from `packagist_search` as `registry_expansion`
