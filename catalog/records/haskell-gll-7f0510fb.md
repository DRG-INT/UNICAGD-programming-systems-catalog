...
<!-- canonical: https://hackage.haskell.org/package/gll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gll](https://hackage.haskell.org/package/gll) |
| Source record ids | hackage_top_downloads-2234e49abaa76f |
...
For a systems engineer, gll belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.2 | 2026-03-19T20:25:22Z | [https://hackage.haskell.org/package/gll](https://hackage.haskell.org/package/gll) |  |
| candidate | partial | 0.4.0.13 |  | [https://hackage.haskell.org/package/gll](https://hackage.haskell.org/package/gll) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gll` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-2234e49abaa76f` from `hackage_top_downloads` as `registry_expansion`
