...
<!-- canonical: https://github.com/freds0/free-svc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/freds0/free-svc](https://github.com/freds0/free-svc) |
| Source record ids | github_search_audio-a355d7bb886955 |
...
For a systems engineer, freds0/free-svc belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-23T14:07:46Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-a355d7bb886955` from `github_search_audio` as `registry_expansion`
