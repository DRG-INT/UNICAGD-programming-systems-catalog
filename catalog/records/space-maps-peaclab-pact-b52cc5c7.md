...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/peaclab/PACT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peaclab/PACT](https://github.com/peaclab/PACT) |
| Source record ids | github_search_space_maps-969e0122d316b0 |
...
For a systems engineer, peaclab/PACT belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-16T19:51:24Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-969e0122d316b0` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| drvrjsh/PDB-Current-Sensing | Concurrency Parallelism | [open](space-maps-drvrjsh-pdb-current-sensing-8e8019a5.md) |
| Xyce/Xyce | Concurrency Parallelism | [open](space-maps-xyce-xyce-c2cc2219.md) |
