...
<!-- canonical: https://luarocks.org/modules/edubart/bint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/edubart/bint](https://luarocks.org/modules/edubart/bint) |
| Source record ids | luarocks_root_manifest-d3ccca6f2a3785 |
...
For a systems engineer, bint belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d3ccca6f2a3785` from `luarocks_root_manifest` as `registry_expansion`
