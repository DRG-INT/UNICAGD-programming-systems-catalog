...
<!-- canonical: https://packagist.org/packages/mmucklo/queue-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mmucklo/queue-bundle](https://packagist.org/packages/mmucklo/queue-bundle) |
| Source record ids | packagist_search-d35de4536f511d |

## System Engineer Summary

Symfony2/3/4/5 Queue Bundle (for background jobs) supporting Mongo (Doctrine ODM), Mysql (and any
Doctrine ORM), RabbitMQ, Beanstalkd, Redis, and ... {write your own}

## Operational Role

For a systems engineer, mmucklo/queue-bundle belongs in the PHP inventory as part of state
...
- `packagist_search-d35de4536f511d` from `packagist_search` as `registry_expansion`
