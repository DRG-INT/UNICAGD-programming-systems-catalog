...
<!-- canonical: https://github.com/Serge-X/Game_Catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Serge-X/Game_Catalog](https://github.com/Serge-X/Game_Catalog) |
| Source record ids | github_search_repertoare_catalogs-db25382f28593a |

## System Engineer Summary

A search for games with metacritic scores

## Operational Role

For a systems engineer, Serge-X/Game_Catalog belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-05T05:21:08Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_repertoare_catalogs-db25382f28593a` from `github_search_repertoare_catalogs` as `registry_expansion`
