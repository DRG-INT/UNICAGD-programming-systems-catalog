...
<!-- canonical: https://www.npmjs.com/package/webdav-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/webdav-server](https://www.npmjs.com/package/webdav-server) |
| Source record ids | npm_registry-06f79ec08bae8a |

## System Engineer Summary

webdav-server is tracked as a web framework record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, webdav-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.3 | 2026-08-04T08:14:55.977Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-06f79ec08bae8a` from `npm_registry` as `registry_expansion`
