...
<!-- canonical: https://github.com/mbasso/asm-dom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbasso/asm-dom](https://github.com/mbasso/asm-dom) |
| Source record ids | github_search_webassembly-8c92568d1a1988 |
...
For a systems engineer, mbasso/asm-dom belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-03T18:16:02Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-8c92568d1a1988` from `github_search_webassembly` as `registry_expansion`
