...
<!-- canonical: https://crates.io/crates/wit-bindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-bindgen](https://crates.io/crates/wit-bindgen) |
| Source record ids | crates_io-f24649a3900408 |

## System Engineer Summary

Rust bindings generator and runtime support for WIT and the component model. Used when compiling
Rust programs to the component model.

## Operational Role

For a systems engineer, wit-bindgen belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.62.0 | 2026-09-10T19:29:00.028388Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-10T20:18:28+00:00`.
...
- `crates_io-f24649a3900408` from `crates_io` as `registry_expansion`
