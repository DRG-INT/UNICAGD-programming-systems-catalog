...
<!-- canonical: https://cran.r-project.org/web/packages/rsurvstat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rsurvstat/index.html](https://cran.r-project.org/web/packages/rsurvstat/index.html) |
| Source record ids | cran_packages_by_date-3630412077a63d |
...
For a systems engineer, rsurvstat belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-07 18:30:08 UTC | [https://cran.r-project.org/web/packages/rsurvstat/DESCRIPTION](https://cran.r-project.org/web/packages/rsurvstat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rsurvstat/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-3630412077a63d` from `cran_packages_by_date` as `registry_expansion`
