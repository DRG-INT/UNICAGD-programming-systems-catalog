...
<!-- canonical: https://cran.r-project.org/web/packages/GPArotation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GPArotation/index.html](https://cran.r-project.org/web/packages/GPArotation/index.html) |
| Source record ids | cran_packages_by_date-0705645deb494b |
...
For a systems engineer, GPArotation belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.8-2 | 2026-08-22 15:40:09 UTC | [https://cran.r-project.org/web/packages/GPArotation/DESCRIPTION](https://cran.r-project.org/web/packages/GPArotation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GPArotation/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0705645deb494b` from `cran_packages_by_date` as `registry_expansion`
