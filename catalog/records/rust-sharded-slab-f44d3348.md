...
<!-- canonical: https://crates.io/crates/sharded-slab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sharded-slab](https://crates.io/crates/sharded-slab) |
| Source record ids | crates_io-056e7ca8268ede |
...
For a systems engineer, sharded-slab belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2023-10-04T19:37:55.401239Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-056e7ca8268ede` from `crates_io` as `registry_expansion`
