...
<!-- canonical: https://gitea.com/panda99/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/panda99/devops](https://gitea.com/panda99/devops) |
| Source record ids | gitea_repositories_api-a7df55b5d167d8 |
...
For a systems engineer, Gitea: panda99/devops belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-26T03:06:04Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-a7df55b5d167d8` from `gitea_repositories_api` as `registry_expansion`
