...
| Canonical URL | [https://github.com/hugsy/cemu](https://github.com/hugsy/cemu) |
| Source record ids | github_search_assembly-28b9a3d73b700e |
...
For a systems engineer, hugsy/cemu belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8 | 2024-08-02T14:50:12Z | [https://api.github.com/repos/hugsy/cemu/releases/latest](https://api.github.com/repos/hugsy/cemu/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/hugsy/cemu/releases/latest` at `2026-09-01T07:24:26+00:00`.
...
- `github_search_assembly-28b9a3d73b700e` from `github_search_assembly` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Captainarash/The_Holy_Book_of_X86 | Memory Analyzer | [open](assembly-captainarash-the-holy-book-of-x86-eca501f2.md) |
