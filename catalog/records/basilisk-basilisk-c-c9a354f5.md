...
| Canonical URL | [https://basilisk.fr/Basilisk%20C](https://basilisk.fr/Basilisk%20C) |
| Source record ids | curated_language_routes-c3dc78c1f7e650 |

## System Engineer Summary

Official Basilisk C language extension documentation for C-like constructs used in Cartesian-grid
discretisation schemes.

## Operational Role

For a systems engineer, Basilisk C belongs in the Basilisk inventory as part of ecosystem capability
...
- `curated_language_routes-c3dc78c1f7e650` from `curated_language_routes` as `registry_expansion`
