...
<!-- canonical: https://github.com/ssell/UnitySobelOutline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ssell/UnitySobelOutline](https://github.com/ssell/UnitySobelOutline) |
| Source record ids | github_search_effects-671ba9a3d005b0 |
...
For a systems engineer, ssell/UnitySobelOutline belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-23T21:16:00Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-671ba9a3d005b0` from `github_search_effects` as `registry_expansion`
