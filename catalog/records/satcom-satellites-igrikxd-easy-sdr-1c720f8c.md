...
<!-- canonical: https://github.com/IgrikXD/Easy-SDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IgrikXD/Easy-SDR](https://github.com/IgrikXD/Easy-SDR) |
| Source record ids | github_search_satcom_satellites-f45087d957d652 |

## System Engineer Summary

This project is about creation of affordable and easy-to-manufacture prototypes of PCBs which are
used to expand the capabilities of existing low-cost SDR receivers based on RTL2832U chip.

## Operational Role

For a systems engineer, IgrikXD/Easy-SDR belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-14T18:35:50Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-f45087d957d652` from `github_search_satcom_satellites` as `registry_expansion`
