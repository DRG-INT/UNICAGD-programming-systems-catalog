...
<!-- canonical: https://github.com/NJ108-cell/AstroView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NJ108-cell/AstroView](https://github.com/NJ108-cell/AstroView) |
| Source record ids | github_search_space_maps-f398cf95585d08 |

## System Engineer Summary

Astro View is a real-time AR astronomy app that shows the true live positions of stars, planets, the
Moon, satellites, and nebulae based on your exact location. Using astronomical calculations, device
sensors, and AR overlays, it maps the sky accurately to your camera view, letting you explore and
understand the universe from wherever you stand.

## Operational Role

For a systems engineer, NJ108-cell/AstroView belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-08T09:46:15Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f398cf95585d08` from `github_search_space_maps` as `registry_expansion`
