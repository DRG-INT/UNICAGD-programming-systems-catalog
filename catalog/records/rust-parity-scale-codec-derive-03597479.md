...
<!-- canonical: https://crates.io/crates/parity-scale-codec-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/parity-scale-codec-derive](https://crates.io/crates/parity-scale-codec-derive) |
| Source record ids | crates_io-08e72f1963bc70 |
...
For a systems engineer, parity-scale-codec-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.5 | 2025-05-20T11:07:20.198816Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-08e72f1963bc70` from `crates_io` as `registry_expansion`
