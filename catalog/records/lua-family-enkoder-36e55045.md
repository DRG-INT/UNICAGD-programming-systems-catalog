...
| Canonical URL | [https://luarocks.org/modules/gradientman/enkoder](https://luarocks.org/modules/gradientman/enkoder) |
| Source record ids | luarocks_root_manifest-2d87d91724f8a8 |

## System Engineer Summary

enkoder is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, enkoder belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2d87d91724f8a8` from `luarocks_root_manifest` as `registry_expansion`
