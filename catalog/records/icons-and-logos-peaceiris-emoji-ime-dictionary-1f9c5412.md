...
<!-- canonical: https://github.com/peaceiris/emoji-ime-dictionary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peaceiris/emoji-ime-dictionary](https://github.com/peaceiris/emoji-ime-dictionary) |
| Source record ids | github_search_icons_and_logos-d1737890a7d53a |
...
For a systems engineer, peaceiris/emoji-ime-dictionary belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T18:08:17Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-d1737890a7d53a` from `github_search_icons_and_logos` as `registry_expansion`
