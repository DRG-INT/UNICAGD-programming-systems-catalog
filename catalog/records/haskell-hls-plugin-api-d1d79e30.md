...
| Source record ids | hackage_recent-f1a7e3f517941f |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hls-plugin-api` at `2026-09-04T13:25:56+00:00`.
...
- `hackage_recent-f1a7e3f517941f` from `hackage_recent` as `registry_expansion`
