...
<!-- canonical: https://pub.dev/packages/drift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/drift](https://pub.dev/packages/drift) |
| Source record ids | pub_dev-e1be6af4068b5f |
...
For a systems engineer, drift belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.34.4 | 2026-09-02T14:42:34.292530Z | [https://pub.dev/api/packages/drift](https://pub.dev/api/packages/drift) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/drift` at `2026-09-02T15:24:13+00:00`.
...
- `pub_dev-e1be6af4068b5f` from `pub_dev` as `registry_expansion`
