...
| Canonical URL | [https://crates.io/crates/cmac](https://crates.io/crates/cmac) |
| Source record ids | crates_io-b7ac6c7b2e14ec |
...
For a systems engineer, cmac belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-04-10T17:36:17.736686Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-b7ac6c7b2e14ec` from `crates_io` as `registry_expansion`
