...
<!-- canonical: https://github.com/ts-backend-meetup-ts/meetup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ts-backend-meetup-ts/meetup](https://github.com/ts-backend-meetup-ts/meetup) |
| Source record ids | github_search_magazines-12469445eab4b5 |

## System Engineer Summary

ts-backend-meetup-ts/meetup is tracked as a library record in the Magazines branch. The source did
...
For a systems engineer, ts-backend-meetup-ts/meetup belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-26T12:06:49Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-12469445eab4b5` from `github_search_magazines` as `registry_expansion`
