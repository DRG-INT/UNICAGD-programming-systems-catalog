...
<!-- canonical: https://crates.io/crates/lexical-parse-float -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lexical-parse-float](https://crates.io/crates/lexical-parse-float) |
| Source record ids | crates_io-7bbe2843679e95 |
...
For a systems engineer, lexical-parse-float belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2025-09-21T03:35:27.221493Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-7bbe2843679e95` from `crates_io` as `registry_expansion`
