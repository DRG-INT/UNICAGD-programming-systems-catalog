...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AnyAscii -->
<!-- crawl-delay: 10 -->
...
| Evidence | Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AnyAscii", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-3e0f8314310d8b` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractSDRs_rx_ascii_art_dft | Precommit Ci Quality | [open](julia-abstractsdrs-rx-ascii-art-dft-9cb349ca.md) |
| ActuarialScience | Precommit Ci Quality | [open](julia-actuarialscience-6c21cee9.md) |
| Aqua.jl | Precommit Ci Quality | [open](julia-aqua-jl-cef5ce90.md) |
| ArtificialLandscapes | Precommit Ci Quality | [open](julia-artificiallandscapes-a3abcdf1.md) |
| Ascii85 | Precommit Ci Quality | [open](julia-ascii85-ff7966d6.md) |
| AsciinemaGenerator | Precommit Ci Quality | [open](julia-asciinemagenerator-cc5c64fa.md) |
| AsciiTranslit | Precommit Ci Quality | [open](julia-asciitranslit-bffd06db.md) |
| AssociatedLegendrePolynomials | Precommit Ci Quality | [open](julia-associatedlegendrepolynomials-a592acba.md) |
