...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Precommit Ci Quality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/precommit-ci-quality.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AnyAscii](https://github.com/JuliaRegistries/General/tree/master/A/AnyAscii) |
| Source record ids | julia_general-3e0f8314310d8b |

## System Engineer Summary

Julia package registered in General at A/AnyAscii.

## Operational Role

For a systems engineer, AnyAscii belongs in the Julia inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractSDRs_rx_ascii_art_dft | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractsdrs-rx-ascii-art-dft-9cb349ca.md) |
| ActuarialScience | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-actuarialscience-6c21cee9.md) |
| Aqua.jl | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-aqua-jl-cef5ce90.md) |
| ArtificialLandscapes | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-artificiallandscapes-a3abcdf1.md) |
| Ascii85 | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-ascii85-ff7966d6.md) |
| AsciinemaGenerator | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-asciinemagenerator-cc5c64fa.md) |
| AsciiTranslit | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-asciitranslit-bffd06db.md) |
| AssociatedLegendrePolynomials | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-associatedlegendrepolynomials-a592acba.md) |
