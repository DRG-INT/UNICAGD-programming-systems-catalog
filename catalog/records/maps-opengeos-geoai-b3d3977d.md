...
| Source record ids | github_search_maps-99063f2735f773 |
...
For a systems engineer, opengeos/geoai belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:16:42Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-99063f2735f773` from `github_search_maps` as `registry_expansion`
