...
<!-- canonical: https://github.com/prometheus/prometheus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/prometheus/prometheus](https://github.com/prometheus/prometheus) |
| Source record ids | github_search_go-98df708b5ce19c |
...
For a systems engineer, prometheus/prometheus belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:09:10Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-98df708b5ce19c` from `github_search_go` as `registry_expansion`
