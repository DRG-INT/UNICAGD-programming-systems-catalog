...
<!-- canonical: https://crates.io/crates/futures-timer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-timer](https://crates.io/crates/futures-timer) |
| Source record ids | crates_io-fd627ecfe72e78 |

## System Engineer Summary

futures-timer is tracked as a datetime record in the Rust branch. The source did not provide a long
...
For a systems engineer, futures-timer belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.4 | 2026-05-20T11:17:05.928899Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-fd627ecfe72e78` from `crates_io` as `registry_expansion`
...
| gix-validate | Datetime | [open](rust-gix-validate-52b7b1cc.md) |
