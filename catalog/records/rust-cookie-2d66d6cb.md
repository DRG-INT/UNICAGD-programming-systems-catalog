...
<!-- canonical: https://crates.io/crates/cookie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cookie](https://crates.io/crates/cookie) |
| Source record ids | crates_io-712093e02e9444 |

## System Engineer Summary

HTTP cookie parsing and cookie jar management. Supports signed and private (encrypted,
authenticated) jars.

## Operational Role

For a systems engineer, cookie belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.2 | 2026-08-08T23:05:00.166238Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-712093e02e9444` from `crates_io` as `registry_expansion`
