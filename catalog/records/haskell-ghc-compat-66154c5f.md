...
<!-- canonical: https://hackage.haskell.org/package/ghc-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-compat](https://hackage.haskell.org/package/ghc-compat) |
| Source record ids | hackage_top_downloads-b28ecf495550f2 |
...
For a systems engineer, ghc-compat belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.11.0 | 2026-06-16T14:07:51Z | [https://hackage.haskell.org/package/ghc-compat](https://hackage.haskell.org/package/ghc-compat) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-compat` at `2026-09-02T00:32:36+00:00`.
...
- `hackage_top_downloads-b28ecf495550f2` from `hackage_top_downloads` as `registry_expansion`
