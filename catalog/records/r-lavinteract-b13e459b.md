...
<!-- canonical: https://cran.r-project.org/web/packages/lavinteract/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lavinteract/index.html](https://cran.r-project.org/web/packages/lavinteract/index.html) |
| Source record ids | cran_packages_by_date-786b2a2943fb0d |
...
For a systems engineer, lavinteract belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-08-21 05:42:24 UTC | [https://cran.r-project.org/web/packages/lavinteract/DESCRIPTION](https://cran.r-project.org/web/packages/lavinteract/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lavinteract/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-786b2a2943fb0d` from `cran_packages_by_date` as `registry_expansion`
