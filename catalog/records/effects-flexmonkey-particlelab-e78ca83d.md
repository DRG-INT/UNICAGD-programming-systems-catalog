...
<!-- canonical: https://github.com/FlexMonkey/ParticleLab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FlexMonkey/ParticleLab](https://github.com/FlexMonkey/ParticleLab) |
| Source record ids | github_search_effects-29632adcbabd8a |
...
For a systems engineer, FlexMonkey/ParticleLab belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | CAMetalLayer | 2015-10-03T04:30:41Z | [https://api.github.com/repos/FlexMonkey/ParticleLab/releases/latest](https://api.github.com/repos/FlexMonkey/ParticleLab/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/FlexMonkey/ParticleLab/releases/latest` at `2026-09-01T09:23:10+00:00`.
...
- `github_search_effects-29632adcbabd8a` from `github_search_effects` as `registry_expansion`
