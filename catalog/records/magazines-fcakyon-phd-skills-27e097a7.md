...
| Source record ids | github_search_magazines-a1d28fb04768d7 |
...
For a systems engineer, fcakyon/phd-skills belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T12:57:37Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-a1d28fb04768d7` from `github_search_magazines` as `registry_expansion`
