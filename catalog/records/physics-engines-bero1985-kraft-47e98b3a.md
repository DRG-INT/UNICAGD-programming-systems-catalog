...
<!-- canonical: https://github.com/BeRo1985/kraft -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BeRo1985/kraft](https://github.com/BeRo1985/kraft) |
| Source record ids | github_search_physics_engines-892a0c12e0f2ff |

## System Engineer Summary

Kraft Physics Engine is an open source Object Pascal physics engine library that can be used in 3D
games.

## Operational Role

For a systems engineer, BeRo1985/kraft belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T05:39:02Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-892a0c12e0f2ff` from `github_search_physics_engines` as `registry_expansion`
