...
<!-- canonical: https://github.com/thebaselab/codeapp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thebaselab/codeapp](https://github.com/thebaselab/codeapp) |
| Source record ids | github_search_swift-bed376cc6d80ae |
...
For a systems engineer, thebaselab/codeapp belongs in the Swift inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T04:03:26Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-bed376cc6d80ae` from `github_search_swift` as `registry_expansion`
