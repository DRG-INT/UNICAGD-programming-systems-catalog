...
<!-- canonical: https://github.com/AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-detection](https://github.com/AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-detection) |
| Source record ids | github_search_effects-7c47a12fcc1f36 |

## System Engineer Summary

AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-detection is tracked as an ide
editor integration record in the Effects branch. The source did not provide a long description, so
this page keeps the identity, release state, provenance, and operational classification explicit for
later enrichment.

## Operational Role

For a systems engineer, AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-
detection belongs in the Effects inventory as part of ecosystem capability mapping, dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-03T13:29:41Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License (>= 2); {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-7c47a12fcc1f36` from `github_search_effects` as `registry_expansion`
