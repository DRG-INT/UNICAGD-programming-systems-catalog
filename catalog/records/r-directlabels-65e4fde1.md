...
<!-- canonical: https://cran.r-project.org/web/packages/directlabels/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/directlabels/index.html](https://cran.r-project.org/web/packages/directlabels/index.html) |
| Source record ids | cran_packages_by_date-0d0b4396e02517 |
...
For a systems engineer, directlabels belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.8.27 | 2026-08-28 08:20:02 UTC | [https://cran.r-project.org/web/packages/directlabels/DESCRIPTION](https://cran.r-project.org/web/packages/directlabels/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/directlabels/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0d0b4396e02517` from `cran_packages_by_date` as `registry_expansion`
