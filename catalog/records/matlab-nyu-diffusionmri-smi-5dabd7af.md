...
<!-- canonical: https://github.com/NYU-DiffusionMRI/SMI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NYU-DiffusionMRI/SMI](https://github.com/NYU-DiffusionMRI/SMI) |
| Source record ids | github_search_matlab-86032f19366310 |
...
For a systems engineer, NYU-DiffusionMRI/SMI belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-06T15:32:05Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-86032f19366310` from `github_search_matlab` as `registry_expansion`
