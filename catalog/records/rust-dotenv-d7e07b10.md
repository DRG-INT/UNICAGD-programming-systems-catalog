...
<!-- canonical: https://crates.io/crates/dotenv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dotenv](https://crates.io/crates/dotenv) |
| Source record ids | crates_io-cbf250108c3242 |
...
For a systems engineer, dotenv belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2019-10-21T16:51:12.672006Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-cbf250108c3242` from `crates_io` as `registry_expansion`
