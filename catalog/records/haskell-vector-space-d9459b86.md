...
<!-- canonical: https://hackage.haskell.org/package/vector-space -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vector-space](https://hackage.haskell.org/package/vector-space) |
| Source record ids | hackage_top_downloads-f8cbbce58f4bf2 |
...
For a systems engineer, vector-space belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19 | 2024-08-06T18:13:50Z | [https://hackage.haskell.org/package/vector-space](https://hackage.haskell.org/package/vector-space) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vector-space` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-f8cbbce58f4bf2` from `hackage_top_downloads` as `registry_expansion`
