...
<!-- canonical: https://github.com/avaneev/r8brain-free-src -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avaneev/r8brain-free-src](https://github.com/avaneev/r8brain-free-src) |
| Source record ids | github_search_audio-8cf4f0984f4a11 |

## System Engineer Summary

High-quality pro audio resampler / sample rate conversion header-only C++ library. Very fast, for
both audio resampling and time-series interpolation.

## Operational Role

For a systems engineer, avaneev/r8brain-free-src belongs in the Audio inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:58:46Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-8cf4f0984f4a11` from `github_search_audio` as `registry_expansion`
