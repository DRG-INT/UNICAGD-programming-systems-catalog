# davivc/gitlab-ci-google-cloud-kubernetes
...
<!-- canonical: https://gitlab.com/davivc/gitlab-ci-google-cloud-kubernetes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/davivc/gitlab-ci-google-cloud-kubernetes](https://gitlab.com/davivc/gitlab-ci-google-cloud-kubernetes) |
| Source record ids | gitlab_projects_api-bc76b19ff8b479 |

## System Engineer Summary

Demo structure for continuous integration, continuous, delivery, continuous deploy using Gitlab
CI/CD, Google Container Registry, Google Container Builder and Kubernetes Cluster.

## Operational Role

For a systems engineer, davivc/gitlab-ci-google-cloud-kubernetes belongs in the Repository
...
- `gitlab_projects_api-bc76b19ff8b479` from `gitlab_projects_api` as `registry_expansion`
