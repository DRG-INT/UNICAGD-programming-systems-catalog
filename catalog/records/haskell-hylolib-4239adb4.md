...
<!-- canonical: https://hackage.haskell.org/package/hylolib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hylolib](https://hackage.haskell.org/package/hylolib) |
| Source record ids | hackage_recent-82bc8074a430e2 |

## System Engineer Summary

Hackage package recently uploaded by GuillaumeHoffmann.

## Operational Role

For a systems engineer, hylolib belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.6 | 2026-09-07T12:40:03Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-07T14:20:47+00:00`.
...
- `hackage_recent-82bc8074a430e2` from `hackage_recent` as `registry_expansion`
