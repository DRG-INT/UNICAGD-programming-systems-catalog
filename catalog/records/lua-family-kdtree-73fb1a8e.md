...
<!-- canonical: https://luarocks.org/modules/geoffleyland/kdtree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/geoffleyland/kdtree](https://luarocks.org/modules/geoffleyland/kdtree) |
| Source record ids | luarocks_root_manifest-fd58767d954279 |

## System Engineer Summary

n-dimensional kdtree spatial index supporting boxes as well as points

## Operational Role

For a systems engineer, kdtree belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| cdata_table | Registry Repository | [open](lua-family-cdata-table-f6c45d0e.md) |
