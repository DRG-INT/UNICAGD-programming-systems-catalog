...
| Canonical URL | [https://luarocks.org/modules/siffiejoe/getsize](https://luarocks.org/modules/siffiejoe/getsize) |
| Source record ids | luarocks_root_manifest-9ca4ed5b7b58b4 |

## System Engineer Summary

Calculates the size of a Lua object.

## Operational Role

For a systems engineer, getsize belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9ca4ed5b7b58b4` from `luarocks_root_manifest` as `registry_expansion`
