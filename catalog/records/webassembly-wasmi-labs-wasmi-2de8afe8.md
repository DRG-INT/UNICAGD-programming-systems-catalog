...
<!-- canonical: https://github.com/wasmi-labs/wasmi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmi-labs/wasmi](https://github.com/wasmi-labs/wasmi) |
| Source record ids | github_search_webassembly-ff421f880f305b |
...
For a systems engineer, wasmi-labs/wasmi belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T11:50:21Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ff421f880f305b` from `github_search_webassembly` as `registry_expansion`
