...
| Source record ids | lua-source-10 |

## System Engineer Summary

Package Managers is tracked as a package manager record in the Lua family branch. The source did not
...
For a systems engineer, Package Managers belongs in the Lua family inventory as part of dependency
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 10}}` |
...
- `lua-source-10` from `master_json` as `source_list_item`
