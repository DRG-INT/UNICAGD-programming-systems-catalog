...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/spawnmason/randar-explanation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spawnmason/randar-explanation](https://github.com/spawnmason/randar-explanation) |
| Source record ids | github_search_radars-ead97731b4a932 |

## System Engineer Summary

"Randar" is an exploit for Minecraft which uses LLL lattice reduction to crack the internal state of
an incorrectly reused java.util.Random in the Minecraft server, then works backwards from that to
locate other players currently loaded into the world.

## Operational Role

For a systems engineer, spawnmason/randar-explanation belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T05:10:32Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-ead97731b4a932` from `github_search_radars` as `registry_expansion`
