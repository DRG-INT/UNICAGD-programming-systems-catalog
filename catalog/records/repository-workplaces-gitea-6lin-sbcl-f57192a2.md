...
<!-- canonical: https://gitea.com/6lin/sbcl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/6lin/sbcl](https://gitea.com/6lin/sbcl) |
| Source record ids | gitea_repositories_api-8f9c00798ee87c |
...
For a systems engineer, Gitea: 6lin/sbcl belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-16T23:40:41Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8f9c00798ee87c` from `gitea_repositories_api` as `registry_expansion`
...
| Gitea: EnderIce2/Fennix | Compiler | [open](repository-workplaces-gitea-enderice2-fennix-a295c30d.md) |
