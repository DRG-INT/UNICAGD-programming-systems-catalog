...
<!-- canonical: https://github.com/HuTianQi/SmartOpenCV -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HuTianQi/SmartOpenCV](https://github.com/HuTianQi/SmartOpenCV) |
| Source record ids | github_search_photography-a7ce3221617a05 |

## System Engineer Summary

:fire: :fire: :fire: SmartOpenCV是一个OpenCV在Android端的增强库，解决了OpenCV Android
SDK在图像预览方面存在的诸多问题，且无需修改OpenCV SDK源码，与OpenCV的SDK解耦

## Operational Role

For a systems engineer, HuTianQi/SmartOpenCV belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-28T12:34:36Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a7ce3221617a05` from `github_search_photography` as `registry_expansion`
