...
<!-- canonical: https://github.com/omriharel/deej -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/omriharel/deej](https://github.com/omriharel/deej) |
| Source record ids | github_search_audio-fc109f204ac428 |

## System Engineer Summary

Set app volumes with real sliders! deej is an Arduino & Go project to let you build your own
hardware mixer for Windows and Linux

## Operational Role

For a systems engineer, omriharel/deej belongs in the Audio inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-11T05:34:00Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-fc109f204ac428` from `github_search_audio` as `registry_expansion`
