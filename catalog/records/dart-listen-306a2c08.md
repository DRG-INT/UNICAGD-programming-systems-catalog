...
<!-- canonical: https://pub.dev/packages/listen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/listen](https://pub.dev/packages/listen) |
| Source record ids | pub_dev-cfd51ed3b74678 |
...
For a systems engineer, listen belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-07-31T22:54:06.127879Z | [https://pub.dev/api/packages/listen](https://pub.dev/api/packages/listen) |  |
| preview | known | 1.0.0-beta.4 | 2026-07-16T03:09:07.838416Z | [https://pub.dev/api/packages/listen](https://pub.dev/api/packages/listen) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/listen` at `2026-09-07T14:20:51+00:00`.
...
- `pub_dev-cfd51ed3b74678` from `pub_dev` as `registry_expansion`
