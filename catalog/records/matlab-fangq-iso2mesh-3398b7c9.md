...
| Canonical URL | [https://github.com/fangq/iso2mesh](https://github.com/fangq/iso2mesh) |
| Source record ids | github_search_matlab-2156821253387a |
...
For a systems engineer, fangq/iso2mesh belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.9.8 | 2024-10-23T14:11:20Z | [https://api.github.com/repos/fangq/iso2mesh/releases/latest](https://api.github.com/repos/fangq/iso2mesh/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fangq/iso2mesh/releases/latest` at `2026-09-01T07:24:10+00:00`.
...
- `github_search_matlab-2156821253387a` from `github_search_matlab` as `registry_expansion`
