...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Icons and Logos](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/icons-and-logos.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://fonts.google.com/icons](https://fonts.google.com/icons) |
| Source record ids | curated_language_routes-c15d1b08819282 |

## System Engineer Summary

Google Material icon and symbol catalog for UI systems, fonts, variable axes, and design assets.

## Operational Role

For a systems engineer, Material Symbols belongs in the Icons and Logos inventory as part of
...
- `curated_language_routes-c15d1b08819282` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bootstrap Icons | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-bootstrap-icons-4a264cc6.md) |
| Feather Icons | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-feather-icons-44e53569.md) |
| Font Awesome | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-font-awesome-8e4d33bb.md) |
| Heroicons | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-heroicons-54afea1f.md) |
| Iconify | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-iconify-fb7438a6.md) |
| Lucide | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-lucide-5fa96a35.md) |
| OpenMoji | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-openmoji-b9bb0f05.md) |
| Simple Icons | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-simple-icons-24b556a1.md) |
