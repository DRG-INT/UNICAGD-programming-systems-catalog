...
<!-- canonical: https://github.com/JKornev/hidden -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JKornev/hidden](https://github.com/JKornev/hidden) |
| Source record ids | github_search_catalogs-74d78ef4f6f78a |

## System Engineer Summary

🇺🇦 Windows driver with usermode interface which can hide processes, file-system and registry
objects, protect processes and etc

## Operational Role

For a systems engineer, JKornev/hidden belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-13T21:48:44Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-74d78ef4f6f78a` from `github_search_catalogs` as `registry_expansion`
