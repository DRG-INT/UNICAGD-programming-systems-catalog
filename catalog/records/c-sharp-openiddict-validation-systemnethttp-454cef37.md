...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/OpenIddict.Validation.SystemNetHttp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/OpenIddict.Validation.SystemNetHttp](https://www.nuget.org/packages/OpenIddict.Validation.SystemNetHttp) |
| Source record ids | nuget_search-aeb6de2962340d |
...
For a systems engineer, OpenIddict.Validation.SystemNetHttp belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.6.1 | 2026-08-27T07:22:48.943+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/openiddict.validation.systemnethttp/index.json](https://api.nuget.org/v3/registration5-gz-semver2/openiddict.validation.systemnethttp/index.json) |  |
| preview | known | 8.0.0-preview.3.26427.30 | 2026-08-27T07:38:27.31+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/openiddict.validation.systemnethttp/index.json](https://api.nuget.org/v3/registration5-gz-semver2/openiddict.validation.systemnethttp/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Other; Apache-2.0; https://www.nuget.org/packages/OpenIddict.Validation.SystemNetHttp/7.6.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/openiddict.validation.systemnethttp/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-aeb6de2962340d` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| OpenIddict.Client.SystemNetHttp | Security Sast | [open](c-sharp-openiddict-client-systemnethttp-2334d9e1.md) |
