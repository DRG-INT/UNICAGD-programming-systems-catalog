...
<!-- canonical: https://crates.io/crates/der-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/der-parser](https://crates.io/crates/der-parser) |
| Source record ids | crates_io-caed9110f93017 |
...
For a systems engineer, der-parser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.0 | 2025-01-21T09:43:38.524624Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-caed9110f93017` from `crates_io` as `registry_expansion`
