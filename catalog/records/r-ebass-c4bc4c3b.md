...
<!-- canonical: https://cran.r-project.org/web/packages/EBASS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EBASS/index.html](https://cran.r-project.org/web/packages/EBASS/index.html) |
| Source record ids | cran_packages_by_date-5975010b09b3c0 |

## System Engineer Summary

Expected Value of Information Based Sample Size Calculation

## Operational Role

For a systems engineer, EBASS belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-04 09:50:07 UTC | [https://cran.r-project.org/web/packages/EBASS/DESCRIPTION](https://cran.r-project.org/web/packages/EBASS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EBASS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5975010b09b3c0` from `cran_packages_by_date` as `registry_expansion`
