...
| Canonical URL | [https://github.com/neopallium/llvm-lua](https://github.com/neopallium/llvm-lua) |
| Source record ids | lua-source-61 |

## System Engineer Summary

LLVM-Lua is tracked as a compiler record in the Lua family branch. The source did not provide a long
...
For a systems engineer, LLVM-Lua belongs in the Lua family inventory as part of compiler selection,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 61}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-61` from `master_json` as `source_list_item`
...
| lua.vm.js | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-vm-js-e8ada39a.md) |
