...
<!-- canonical: https://github.com/stevemarple/AuroraWatchNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevemarple/AuroraWatchNet](https://github.com/stevemarple/AuroraWatchNet) |
| Source record ids | github_search_electromagnetoscopes-7e1284c035fb05 |
...
For a systems engineer, stevemarple/AuroraWatchNet belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-29T20:39:25Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-7e1284c035fb05` from `github_search_electromagnetoscopes` as `registry_expansion`
