...
<!-- canonical: https://luarocks.org/modules/vitiral/civ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vitiral/civ](https://luarocks.org/modules/vitiral/civ) |
| Source record ids | luarocks_root_manifest-1b6ab5ec1db508 |
...
For a systems engineer, civ belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1b6ab5ec1db508` from `luarocks_root_manifest` as `registry_expansion`
