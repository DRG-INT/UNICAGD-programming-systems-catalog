...
<!-- canonical: https://cran.r-project.org/web/packages/outcomerate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/outcomerate/index.html](https://cran.r-project.org/web/packages/outcomerate/index.html) |
| Source record ids | cran_packages_by_date-149a92b8913f6e |
...
For a systems engineer, outcomerate belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-01 07:10:03 UTC | [https://cran.r-project.org/web/packages/outcomerate/DESCRIPTION](https://cran.r-project.org/web/packages/outcomerate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/outcomerate/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-149a92b8913f6e` from `cran_packages_by_date` as `registry_expansion`
