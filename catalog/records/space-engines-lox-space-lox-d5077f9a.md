...
| Source record ids | github_search_space_engines-d686245eba52ef |

## System Engineer Summary

lox-space/lox is tracked as a parser lexer ast record in the Space Engines branch. The source did
...
For a systems engineer, lox-space/lox belongs in the Space Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | lox-space-v0.1.0-alpha.50 | 2026-08-25T09:27:56Z | [https://api.github.com/repos/lox-space/lox/releases/latest](https://api.github.com/repos/lox-space/lox/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lox-space/lox/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-d686245eba52ef` from `github_search_space_engines` as `registry_expansion`
