...
<!-- canonical: https://cran.r-project.org/web/packages/planr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/planr/index.html](https://cran.r-project.org/web/packages/planr/index.html) |
| Source record ids | cran_packages_by_date-096c30a32a17b9 |
...
For a systems engineer, planr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-08-23 09:30:08 UTC | [https://cran.r-project.org/web/packages/planr/DESCRIPTION](https://cran.r-project.org/web/packages/planr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/planr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-096c30a32a17b9` from `cran_packages_by_date` as `registry_expansion`
