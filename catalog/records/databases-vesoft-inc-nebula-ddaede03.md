...
<!-- canonical: https://github.com/vesoft-inc/nebula -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vesoft-inc/nebula](https://github.com/vesoft-inc/nebula) |
| Source record ids | github_search_databases-63fe4f0caa36fc |

## System Engineer Summary

A distributed, fast open-source graph database featuring horizontal scalability and high
availability

## Operational Role

For a systems engineer, vesoft-inc/nebula belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T06:42:15Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-63fe4f0caa36fc` from `github_search_databases` as `registry_expansion`
