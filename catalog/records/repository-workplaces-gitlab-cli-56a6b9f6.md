...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Repository Workplaces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/repository-workplaces.md) · [Category: Cli](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cli.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://gitlab.com/gitlab-org/cli](https://gitlab.com/gitlab-org/cli) |
| Source record ids | curated_repository_workplace_routes-fd8c5357b92387 |

## System Engineer Summary

Official GitLab command-line client for issues, merge requests, pipelines, releases, and repository
workflows.

## Operational Role

For a systems engineer, GitLab CLI belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-fd8c5357b92387` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| GitHub CLI | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-github-cli-3d665d5e.md) |
