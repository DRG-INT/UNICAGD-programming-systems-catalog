...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/feat-agency/vite-plugin-webfont-dl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/feat-agency/vite-plugin-webfont-dl](https://github.com/feat-agency/vite-plugin-webfont-dl) |
| Source record ids | github_search_assets-dcc5388329380a |

## System Engineer Summary

⚡ Webfont Download Vite Plugin - Effortlessly download and bundle webfonts in your Vite project.
Enjoy privacy-first - even offline - development with persistent caching and non-render blocking
font injection for optimal performance.

## Operational Role

For a systems engineer, feat-agency/vite-plugin-webfont-dl belongs in the Assets inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T06:54:54Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-dcc5388329380a` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| d3ward/toolz | Benchmarking | [open](assets-d3ward-toolz-1f9ecb7c.md) |
