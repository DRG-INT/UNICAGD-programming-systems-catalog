...
<!-- canonical: https://cran.r-project.org/web/packages/envnames/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/envnames/index.html](https://cran.r-project.org/web/packages/envnames/index.html) |
| Source record ids | cran_packages_by_date-2f11eac671a08d |
...
For a systems engineer, envnames belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-09-01 10:30:18 UTC | [https://cran.r-project.org/web/packages/envnames/DESCRIPTION](https://cran.r-project.org/web/packages/envnames/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/envnames/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-2f11eac671a08d` from `cran_packages_by_date` as `registry_expansion`
