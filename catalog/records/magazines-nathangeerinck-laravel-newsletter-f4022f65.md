...
<!-- canonical: https://github.com/NathanGeerinck/laravel-newsletter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NathanGeerinck/laravel-newsletter](https://github.com/NathanGeerinck/laravel-newsletter) |
| Source record ids | github_search_magazines-5c54d35515c089 |

## System Engineer Summary

This application gives you the ability to send a newsletter to multiple subscribers with use of SMTP
or an external driver like Mailgun

## Operational Role

For a systems engineer, NathanGeerinck/laravel-newsletter belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-09-26T13:41:42Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-5c54d35515c089` from `github_search_magazines` as `registry_expansion`
