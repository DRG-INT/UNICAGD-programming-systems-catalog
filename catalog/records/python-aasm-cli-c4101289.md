...
<!-- canonical: https://pypi.org/project/aasm-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aasm-cli/](https://pypi.org/project/aasm-cli/) |
| Source record ids | pypi_simple-17eaf919f6a916 |
...
For a systems engineer, aasm-cli belongs in the Python inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-06-28T14:07:17.405617Z | [https://pypi.org/pypi/aasm-cli/json](https://pypi.org/pypi/aasm-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aasm-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-17eaf919f6a916` from `pypi_simple` as `registry_expansion`
