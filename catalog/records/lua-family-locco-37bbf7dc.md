...
<!-- canonical: http://rgieseke.github.io/locco/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://rgieseke.github.io/locco/](http://rgieseke.github.io/locco/) |
| Source record ids | lua-source-204 |

## System Engineer Summary

Lua port of , the "quick-and-dirty, hundred-line-long, literate-programming-style documentation
generator".

## Operational Role

For a systems engineer, Locco belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 204}}` |
...
- `lua-source-204` from `master_json` as `source_list_item`
