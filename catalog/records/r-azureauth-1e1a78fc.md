...
| Canonical URL | [https://cran.r-project.org/web/packages/AzureAuth/index.html](https://cran.r-project.org/web/packages/AzureAuth/index.html) |
| Source record ids | cran_packages_by_date-828229619f8b4c |
...
For a systems engineer, AzureAuth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.5 | 2026-08-29 13:20:07 UTC | [https://cran.r-project.org/web/packages/AzureAuth/DESCRIPTION](https://cran.r-project.org/web/packages/AzureAuth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AzureAuth/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-828229619f8b4c` from `cran_packages_by_date` as `registry_expansion`
...
| CEC | Filesystem Os | [open](r-cec-6388c3fb.md) |
| CHNOSZ | Filesystem Os | [open](r-chnosz-4fa0342e.md) |
| coconots | Filesystem Os | [open](r-coconots-3c091498.md) |
| CohortCosts | Filesystem Os | [open](r-cohortcosts-048abf4b.md) |
| CopernicusDataspace | Filesystem Os | [open](r-copernicusdataspace-edb589c1.md) |
| cropwatMUL | Filesystem Os | [open](r-cropwatmul-97b344f9.md) |
