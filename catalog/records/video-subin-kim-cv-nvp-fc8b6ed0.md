...
<!-- canonical: https://github.com/subin-kim-cv/NVP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/subin-kim-cv/NVP](https://github.com/subin-kim-cv/NVP) |
| Source record ids | github_search_video-4065a5507aa641 |

## System Engineer Summary

Official PyTorch implementation of Scalable Neural Video Representations with Learnable Positional
Features (NeurIPS 2022).

## Operational Role

For a systems engineer, subin-kim-cv/NVP belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-03T05:12:07Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-4065a5507aa641` from `github_search_video` as `registry_expansion`
