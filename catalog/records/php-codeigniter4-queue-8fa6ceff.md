...
<!-- canonical: https://packagist.org/packages/codeigniter4/queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/codeigniter4/queue](https://packagist.org/packages/codeigniter4/queue) |
| Source record ids | packagist_search-4eb15f039e9561 |
...
For a systems engineer, codeigniter4/queue belongs in the PHP inventory as part of state
...
- `packagist_search-4eb15f039e9561` from `packagist_search` as `registry_expansion`
