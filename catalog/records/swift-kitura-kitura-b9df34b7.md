...
| Source record ids | github_search_swift-99b94a11429518 |
...
For a systems engineer, Kitura/Kitura belongs in the Swift inventory as part of ecosystem capability
...
- `github_search_swift-99b94a11429518` from `github_search_swift` as `registry_expansion`
