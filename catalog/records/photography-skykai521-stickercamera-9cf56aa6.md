...
<!-- canonical: https://github.com/Skykai521/StickerCamera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Skykai521/StickerCamera](https://github.com/Skykai521/StickerCamera) |
| Source record ids | github_search_photography-98df98d14be87f |

## System Engineer Summary

This is an Android application with camera,picture cropping,collage sticking and
tagging.贴纸标签相机,功能:拍照,相片裁剪,给图片贴贴纸,打标签。

## Operational Role

For a systems engineer, Skykai521/StickerCamera belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T11:59:06Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-98df98d14be87f` from `github_search_photography` as `registry_expansion`
