...
<!-- canonical: https://cran.r-project.org/web/packages/cauchyreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cauchyreg/index.html](https://cran.r-project.org/web/packages/cauchyreg/index.html) |
| Source record ids | cran_packages_by_date-4ea2b0b5bad52a |

## System Engineer Summary

cauchyreg is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, cauchyreg belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-09-12 15:00:07 UTC | [https://cran.r-project.org/web/packages/cauchyreg/DESCRIPTION](https://cran.r-project.org/web/packages/cauchyreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cauchyreg/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-4ea2b0b5bad52a` from `cran_packages_by_date` as `registry_expansion`
