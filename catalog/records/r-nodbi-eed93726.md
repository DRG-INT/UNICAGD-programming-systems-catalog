...
<!-- canonical: https://cran.r-project.org/web/packages/nodbi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nodbi/index.html](https://cran.r-project.org/web/packages/nodbi/index.html) |
| Source record ids | cran_packages_by_date-da555f6fab78f9 |
...
For a systems engineer, nodbi belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-08-25 09:50:02 UTC | [https://cran.r-project.org/web/packages/nodbi/DESCRIPTION](https://cran.r-project.org/web/packages/nodbi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nodbi/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-da555f6fab78f9` from `cran_packages_by_date` as `registry_expansion`
