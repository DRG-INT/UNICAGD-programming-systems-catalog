...
<!-- canonical: https://crates.io/crates/aws-credential-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-credential-types](https://crates.io/crates/aws-credential-types) |
| Source record ids | crates_io-8bf3514ef87b9e |
...
For a systems engineer, aws-credential-types belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-07-08T19:08:20.561050Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-8bf3514ef87b9e` from `crates_io` as `registry_expansion`
