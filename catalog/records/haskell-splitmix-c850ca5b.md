...
<!-- canonical: https://hackage.haskell.org/package/splitmix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/splitmix](https://hackage.haskell.org/package/splitmix) |
| Source record ids | hackage_top_downloads-7e4614451a6d74 |
...
For a systems engineer, splitmix belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3.2 | 2026-01-04T21:10:53Z | [https://hackage.haskell.org/package/splitmix](https://hackage.haskell.org/package/splitmix) |  |
| candidate | partial | 0.0.2 |  | [https://hackage.haskell.org/package/splitmix](https://hackage.haskell.org/package/splitmix) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/splitmix` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-7e4614451a6d74` from `hackage_top_downloads` as `registry_expansion`
