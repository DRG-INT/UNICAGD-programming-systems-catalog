...
| Source record ids | github_search_matlab-92f7e709bbd3cf |
...
For a systems engineer, precise-simulation/featool-multiphysics belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:25:07Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-92f7e709bbd3cf` from `github_search_matlab` as `registry_expansion`
