...
<!-- canonical: https://cran.r-project.org/web/packages/tikatuwq/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tikatuwq/index.html](https://cran.r-project.org/web/packages/tikatuwq/index.html) |
| Source record ids | cran_packages_by_date-91c31597e54e55 |
...
For a systems engineer, tikatuwq belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-08-31 23:10:02 UTC | [https://cran.r-project.org/web/packages/tikatuwq/DESCRIPTION](https://cran.r-project.org/web/packages/tikatuwq/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tikatuwq/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-91c31597e54e55` from `cran_packages_by_date` as `registry_expansion`
