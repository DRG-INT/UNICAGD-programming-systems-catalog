...
<!-- canonical: https://crates.io/crates/kube-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/kube-client](https://crates.io/crates/kube-client) |
| Source record ids | crates_io-9370fdde16a0bb |

## System Engineer Summary

kube-client is tracked as an undefined behavior analyzer record in the Rust branch. The source did
...
For a systems engineer, kube-client belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-07-22T08:41:30.306139Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-9370fdde16a0bb` from `crates_io` as `registry_expansion`
