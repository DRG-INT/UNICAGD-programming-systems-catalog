...
<!-- canonical: https://github.com/altic-dev/FluidVoice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/altic-dev/FluidVoice](https://github.com/altic-dev/FluidVoice) |
| Source record ids | github_search_swift-bb692f94c3c894 |

## System Engineer Summary

Fastest and only macOS Dictation app with on-device STT and custom trained AI enhancement model.
Windows pre-build available! A local Wispr Flow alternative. DM us on X for an easter egg 😉 -

## Operational Role

For a systems engineer, altic-dev/FluidVoice belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.9 | 2026-08-18T08:01:44Z | [https://api.github.com/repos/altic-dev/FluidVoice/releases/latest](https://api.github.com/repos/altic-dev/FluidVoice/releases/latest) |  |
| preview | known | windows-v0.0.9 | 2026-08-11T03:48:46Z | [https://api.github.com/repos/altic-dev/FluidVoice/releases?per_page=10](https://api.github.com/repos/altic-dev/FluidVoice/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/altic-dev/FluidVoice/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-bb692f94c3c894` from `github_search_swift` as `registry_expansion`
