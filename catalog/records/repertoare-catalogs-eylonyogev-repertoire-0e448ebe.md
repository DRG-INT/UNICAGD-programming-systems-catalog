...
<!-- canonical: https://github.com/eylonyogev/repertoire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eylonyogev/repertoire](https://github.com/eylonyogev/repertoire) |
| Source record ids | github_search_repertoare_catalogs-3861ab25b2fb94 |

## System Engineer Summary

Repertoire — a personal exercise library: browse, favorite, and build workouts from a GIF exercise
collection.

## Operational Role

For a systems engineer, eylonyogev/repertoire belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-19T05:03:26Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-3861ab25b2fb94` from `github_search_repertoare_catalogs` as `registry_expansion`
