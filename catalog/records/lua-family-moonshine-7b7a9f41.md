...
| Canonical URL | [https://github.com/gamesys/moonshine](https://github.com/gamesys/moonshine) |
| Source record ids | lua-source-63 |

## System Engineer Summary

A Lua VM implemented in JavaScript. Slower than lua.vm.js, but with better docs, examples, and JS
interfacing.

## Operational Role

For a systems engineer, Moonshine belongs in the Lua family inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2014-11-14T09:28:00Z | [https://api.github.com/repos/gamesys/moonshine/releases/latest](https://api.github.com/repos/gamesys/moonshine/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gamesys/moonshine/releases/latest` at `2026-09-01T02:14:39+00:00`.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 63}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-63` from `master_json` as `source_list_item`
