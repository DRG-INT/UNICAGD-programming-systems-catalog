...
<!-- canonical: https://github.com/microsoft/UniSpeech -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/UniSpeech](https://github.com/microsoft/UniSpeech) |
| Source record ids | github_search_audio-39222a36f5b0ef |
...
For a systems engineer, microsoft/UniSpeech belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-05T13:14:48Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-39222a36f5b0ef` from `github_search_audio` as `registry_expansion`
