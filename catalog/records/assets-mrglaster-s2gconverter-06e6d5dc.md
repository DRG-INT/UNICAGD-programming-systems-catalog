...
<!-- canonical: https://github.com/mrglaster/S2GConverter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mrglaster/S2GConverter](https://github.com/mrglaster/S2GConverter) |
| Source record ids | github_search_assets-ace492dd13ef7e |

## System Engineer Summary

Python utility converting models from Source engine to GoldSource engine. This utility can convert
models with any number of polygons.

## Operational Role

For a systems engineer, mrglaster/S2GConverter belongs in the Assets inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-20T16:41:09Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-ace492dd13ef7e` from `github_search_assets` as `registry_expansion`
