...
<!-- canonical: https://packagist.org/packages/laminas/laminas-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laminas/laminas-db](https://packagist.org/packages/laminas/laminas-db) |
| Source record ids | packagist_search-325a81ab125a68 |

## System Engineer Summary

Database abstraction layer, SQL abstraction, result set abstraction, and RowDataGateway and
TableDataGateway implementations

## Operational Role

For a systems engineer, laminas/laminas-db belongs in the PHP inventory as part of state
...
- `packagist_search-325a81ab125a68` from `packagist_search` as `registry_expansion`
