...
<!-- canonical: https://cran.r-project.org/web/packages/dawaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dawaR/index.html](https://cran.r-project.org/web/packages/dawaR/index.html) |
| Source record ids | cran_packages_by_date-829af9af62509a |
...
For a systems engineer, dawaR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-27 12:00:26 UTC | [https://cran.r-project.org/web/packages/dawaR/DESCRIPTION](https://cran.r-project.org/web/packages/dawaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dawaR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-829af9af62509a` from `cran_packages_by_date` as `registry_expansion`
