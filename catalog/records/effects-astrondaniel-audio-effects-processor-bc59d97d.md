# AstronDaniel/audio_effects_processor

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AstronDaniel/audio_effects_processor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AstronDaniel/audio_effects_processor](https://github.com/AstronDaniel/audio_effects_processor) |
| Source record ids | github_search_effects-054d969b8b064b |

## System Engineer Summary

An application designed to apply audio effects like reverb, echo, and modulation to audio signals.
Using Fourier Transform techniques and other digital signal processing (DSP) methods, this project
allows users to explore and modify audio in real-time or offline.

## Operational Role

For a systems engineer, AstronDaniel/audio_effects_processor belongs in the Effects inventory as
part of language tooling, code generation, static analysis, and source transformation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-29T06:28:20Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "audio effects dsp", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_effects-054d969b8b064b` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adefossez/julius | Parser Lexer Ast | [open](effects-adefossez-julius-c2369600.md) |
| avaneev/r8brain-free-src | Parser Lexer Ast | [open](effects-avaneev-r8brain-free-src-0726978b.md) |
| calebzulawski/fourier | Parser Lexer Ast | [open](effects-calebzulawski-fourier-33620126.md) |
| cirocosta/asciinema-edit | Parser Lexer Ast | [open](effects-cirocosta-asciinema-edit-04188dee.md) |
| iver56/torch-audiomentations | Parser Lexer Ast | [open](effects-iver56-torch-audiomentations-79b689a6.md) |
| kfrlib/kfr | Parser Lexer Ast | [open](effects-kfrlib-kfr-8c028bab.md) |
| marton78/pffft | Parser Lexer Ast | [open](effects-marton78-pffft-ac92569e.md) |
| metno/gridpp | Parser Lexer Ast | [open](effects-metno-gridpp-e2860702.md) |
