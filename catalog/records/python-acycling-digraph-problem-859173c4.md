...
<!-- canonical: https://pypi.org/project/acycling-digraph-problem/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acycling-digraph-problem/](https://pypi.org/project/acycling-digraph-problem/) |
| Source record ids | pypi_simple-37c2934ce429f3 |

## System Engineer Summary

acycling-digraph-problem is tracked as a cli record in the Python branch. The source did not provide
...
For a systems engineer, acycling-digraph-problem belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2022-11-25T14:11:33.719660Z | [https://pypi.org/pypi/acycling-digraph-problem/json](https://pypi.org/pypi/acycling-digraph-problem/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acycling-digraph-problem/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-37c2934ce429f3` from `pypi_simple` as `registry_expansion`
