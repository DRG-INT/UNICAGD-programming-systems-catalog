...
<!-- canonical: https://pub.dev/packages/xterm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/xterm](https://pub.dev/packages/xterm) |
| Source record ids | pub_dev-4d3d79e3c9fa87 |

## System Engineer Summary

xterm.dart is a fast and fully-featured terminal emulator for Flutter applications, with support for
mobile and desktop platforms.

## Operational Role

For a systems engineer, xterm belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2024-02-27T07:31:16.327352Z | [https://pub.dev/api/packages/xterm](https://pub.dev/api/packages/xterm) |  |
| preview | known | 3.6.1-pre | 2023-04-28T09:42:24.028828Z | [https://pub.dev/api/packages/xterm](https://pub.dev/api/packages/xterm) |  |
...
| Evidence | GPL-2 \| GPL-3; MIT License; https://api.github.com/licenses/mit; Other |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/xterm` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-4d3d79e3c9fa87` from `pub_dev` as `registry_expansion`
