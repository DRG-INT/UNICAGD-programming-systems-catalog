...
<!-- canonical: https://hackage.haskell.org/package/distributed-process -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/distributed-process](https://hackage.haskell.org/package/distributed-process) |
| Source record ids | hackage_top_downloads-34d0d9e41fb034 |
...
For a systems engineer, distributed-process belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.8 | 2025-02-05T01:53:43Z | [https://hackage.haskell.org/package/distributed-process](https://hackage.haskell.org/package/distributed-process) |  |
| candidate | partial | 0.5.0 |  | [https://hackage.haskell.org/package/distributed-process](https://hackage.haskell.org/package/distributed-process) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/distributed-process` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-34d0d9e41fb034` from `hackage_top_downloads` as `registry_expansion`
