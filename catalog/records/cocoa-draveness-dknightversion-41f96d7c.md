...
<!-- canonical: https://github.com/draveness/DKNightVersion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/draveness/DKNightVersion](https://github.com/draveness/DKNightVersion) |
| Source record ids | github_search_cocoa-ddcd3ccdf3b8ec |
...
For a systems engineer, draveness/DKNightVersion belongs in the Cocoa inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-09-03T10:59:06Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-ddcd3ccdf3b8ec` from `github_search_cocoa` as `registry_expansion`
