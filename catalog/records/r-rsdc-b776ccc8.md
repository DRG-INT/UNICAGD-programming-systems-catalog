...
<!-- canonical: https://cran.r-project.org/web/packages/RSDC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RSDC/index.html](https://cran.r-project.org/web/packages/RSDC/index.html) |
| Source record ids | cran_packages_by_date-8306879722c1f1 |
...
For a systems engineer, RSDC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7-0 | 2026-08-04 09:30:08 UTC | [https://cran.r-project.org/web/packages/RSDC/DESCRIPTION](https://cran.r-project.org/web/packages/RSDC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RSDC/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8306879722c1f1` from `cran_packages_by_date` as `registry_expansion`
