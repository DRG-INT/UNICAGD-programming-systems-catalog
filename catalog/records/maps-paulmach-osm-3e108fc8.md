...
<!-- canonical: https://github.com/paulmach/osm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paulmach/osm](https://github.com/paulmach/osm) |
| Source record ids | github_search_maps-9e0466ad4a5032 |
...
For a systems engineer, paulmach/osm belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T10:53:33Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9e0466ad4a5032` from `github_search_maps` as `registry_expansion`
