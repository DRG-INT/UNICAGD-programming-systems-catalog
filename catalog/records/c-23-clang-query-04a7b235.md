...
| Source record ids | corpus-d6f931e9603012 |

## System Engineer Summary

clang-query is tracked as a codegen codemod refactoring record in the C++23 branch. The source did
...
For a systems engineer, clang-query belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-d6f931e9603012` from `master_json` as `codegen_codemod_refactoring`
