...
<!-- canonical: https://crates.io/crates/getopts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/getopts](https://crates.io/crates/getopts) |
| Source record ids | crates_io-3c7f4eece8f0b2 |
...
For a systems engineer, getopts belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.24 | 2025-08-29T15:00:18.327189Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-3c7f4eece8f0b2` from `crates_io` as `registry_expansion`
