...
<!-- canonical: https://github.com/SnapDrop/snapdrop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SnapDrop/snapdrop](https://github.com/SnapDrop/snapdrop) |
| Source record ids | github_search_video-1ee4cabe4731af |
...
For a systems engineer, SnapDrop/snapdrop belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-10T10:35:43Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-1ee4cabe4731af` from `github_search_video` as `registry_expansion`
