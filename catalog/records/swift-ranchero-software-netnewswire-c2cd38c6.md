...
| Source record ids | github_search_swift-12184d9b98e990 |
...
For a systems engineer, Ranchero-Software/NetNewsWire belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:49:19Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-12184d9b98e990` from `github_search_swift` as `registry_expansion`
