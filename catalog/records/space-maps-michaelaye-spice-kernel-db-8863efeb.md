...
<!-- canonical: https://github.com/michaelaye/spice-kernel-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/michaelaye/spice-kernel-db](https://github.com/michaelaye/spice-kernel-db) |
| Source record ids | github_search_space_maps-c57a4deb07f48f |

## System Engineer Summary

A deduplicating SPICE kernel cross-mission database

## Operational Role

For a systems engineer, michaelaye/spice-kernel-db belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T16:13:11Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-c57a4deb07f48f` from `github_search_space_maps` as `registry_expansion`
