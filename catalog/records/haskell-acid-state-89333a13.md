...
<!-- canonical: https://hackage.haskell.org/package/acid-state -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/acid-state](https://hackage.haskell.org/package/acid-state) |
| Source record ids | hackage_top_downloads-ab8561ff50e5ef |
...
For a systems engineer, acid-state belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.1.4 | 2025-08-28T06:35:50Z | [https://hackage.haskell.org/package/acid-state](https://hackage.haskell.org/package/acid-state) |  |
| candidate | partial | 0.15.0 |  | [https://hackage.haskell.org/package/acid-state](https://hackage.haskell.org/package/acid-state) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/acid-state` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-ab8561ff50e5ef` from `hackage_top_downloads` as `registry_expansion`
