...
| Canonical URL | [https://crates.io/crates/gpu-alloc](https://crates.io/crates/gpu-alloc) |
| Source record ids | crates_io-4278a3397ef2cb |
...
For a systems engineer, gpu-alloc belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2026-06-29T19:34:15.087803Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-4278a3397ef2cb` from `crates_io` as `registry_expansion`
