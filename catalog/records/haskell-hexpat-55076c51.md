...
<!-- canonical: https://hackage.haskell.org/package/hexpat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hexpat](https://hackage.haskell.org/package/hexpat) |
| Source record ids | hackage_top_downloads-45d834d470044a |
...
For a systems engineer, hexpat belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.13 | 2017-06-21T23:58:54Z | [https://hackage.haskell.org/package/hexpat](https://hackage.haskell.org/package/hexpat) |  |
| candidate | partial | 0.20.4 |  | [https://hackage.haskell.org/package/hexpat](https://hackage.haskell.org/package/hexpat) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hexpat` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-45d834d470044a` from `hackage_top_downloads` as `registry_expansion`
