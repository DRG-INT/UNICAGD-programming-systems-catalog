...
<!-- canonical: https://cran.r-project.org/web/packages/RiskPortfolios/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RiskPortfolios/index.html](https://cran.r-project.org/web/packages/RiskPortfolios/index.html) |
| Source record ids | cran_packages_by_date-ed68854b58072f |
...
For a systems engineer, RiskPortfolios belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.8 | 2026-08-21 15:50:07 UTC | [https://cran.r-project.org/web/packages/RiskPortfolios/DESCRIPTION](https://cran.r-project.org/web/packages/RiskPortfolios/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RiskPortfolios/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ed68854b58072f` from `cran_packages_by_date` as `registry_expansion`
