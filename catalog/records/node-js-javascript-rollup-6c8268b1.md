...
| Source record ids | master-d9b61efdf506 |
...
For a systems engineer, Rollup belongs in the Node.js/JavaScript inventory as part of build graph
...
- `master-d9b61efdf506` from `master_json` as `build_system`
