...
<!-- canonical: https://pypi.org/project/aclimatise/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclimatise/](https://pypi.org/project/aclimatise/) |
| Source record ids | pypi_simple-deec9491cbb6c5 |

## System Engineer Summary

aCLImatise is a Python library and command-line utility for parsing the help output of a command-
line tool and then outputting a description of the tool in a more structured format

## Operational Role

For a systems engineer, aclimatise belongs in the Python inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2021-02-14T15:00:06.892865Z | [https://pypi.org/pypi/aclimatise/json](https://pypi.org/pypi/aclimatise/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclimatise/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-deec9491cbb6c5` from `pypi_simple` as `registry_expansion`
