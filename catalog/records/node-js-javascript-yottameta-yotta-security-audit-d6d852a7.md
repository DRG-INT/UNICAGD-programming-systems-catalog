...
<!-- canonical: https://www.npmjs.com/package/@yottameta/yotta-security-audit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@yottameta/yotta-security-audit](https://www.npmjs.com/package/@yottameta/yotta-security-audit) |
| Source record ids | npm_registry-30810bf86c875d |

## System Engineer Summary

Yuan'an (元安) — detects malicious patterns in AI skills (13 detector classes) and system security
baselines (Windows/Linux); purely read-only, zero-dependency and disciplined. Triggers on security
audit / skill security check / malicious detection / supply

## Operational Role

For a systems engineer, @yottameta/yotta-security-audit belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-30T02:03:33.276Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
