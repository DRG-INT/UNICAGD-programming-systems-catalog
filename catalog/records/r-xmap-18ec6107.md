...
<!-- canonical: https://cran.r-project.org/web/packages/xmap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xmap/index.html](https://cran.r-project.org/web/packages/xmap/index.html) |
| Source record ids | cran_packages_by_date-d1b6daeaf27d65 |
...
For a systems engineer, xmap belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-23 15:50:02 UTC | [https://cran.r-project.org/web/packages/xmap/DESCRIPTION](https://cran.r-project.org/web/packages/xmap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xmap/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d1b6daeaf27d65` from `cran_packages_by_date` as `registry_expansion`
