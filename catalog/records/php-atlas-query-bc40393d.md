...
| Canonical URL | [https://packagist.org/packages/atlas/query](https://packagist.org/packages/atlas/query) |
| Source record ids | packagist_search-07c3d71466ca95 |
...
For a systems engineer, atlas/query belongs in the PHP inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2021-10-02T14:54:15+00:00 | [https://repo.packagist.org/p2/atlas/query.json](https://repo.packagist.org/p2/atlas/query.json) |  |
| preview | known | 1.0.0-beta2 | 2018-05-08T11:55:44+00:00 | [https://repo.packagist.org/p2/atlas/query.json](https://repo.packagist.org/p2/atlas/query.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/atlas/query.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-07c3d71466ca95` from `packagist_search` as `registry_expansion`
