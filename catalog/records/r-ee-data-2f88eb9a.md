...
<!-- canonical: https://cran.r-project.org/web/packages/EE.Data/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EE.Data/index.html](https://cran.r-project.org/web/packages/EE.Data/index.html) |
| Source record ids | cran_packages_by_date-ce9b7892c635ed |
...
For a systems engineer, EE.Data belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 05:46:50 UTC | [https://cran.r-project.org/web/packages/EE.Data/DESCRIPTION](https://cran.r-project.org/web/packages/EE.Data/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EE.Data/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ce9b7892c635ed` from `cran_packages_by_date` as `registry_expansion`
