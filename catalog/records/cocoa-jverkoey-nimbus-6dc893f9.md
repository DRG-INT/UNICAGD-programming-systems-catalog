...
<!-- canonical: https://github.com/jverkoey/nimbus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jverkoey/nimbus](https://github.com/jverkoey/nimbus) |
| Source record ids | github_search_cocoa-649eff39ca8ded |
...
For a systems engineer, jverkoey/nimbus belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-25T21:23:31Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-649eff39ca8ded` from `github_search_cocoa` as `registry_expansion`
