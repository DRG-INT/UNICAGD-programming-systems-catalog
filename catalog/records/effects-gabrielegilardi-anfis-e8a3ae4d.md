...
<!-- canonical: https://github.com/gabrielegilardi/ANFIS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gabrielegilardi/ANFIS](https://github.com/gabrielegilardi/ANFIS) |
| Source record ids | github_search_effects-054ab4a461e279 |

## System Engineer Summary

Multivariate Regression and Classification Using an Adaptive Neuro-Fuzzy Inference System (Takagi-
Sugeno) and Particle Swarm Optimization.

## Operational Role

For a systems engineer, gabrielegilardi/ANFIS belongs in the Effects inventory as part of input-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-24T00:21:25Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-054ab4a461e279` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Jasonnor/Car-Simulator | Fuzzer | [open](effects-jasonnor-car-simulator-9e1c05c4.md) |
