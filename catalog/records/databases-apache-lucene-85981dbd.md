...
| Source record ids | github_search_databases-9681796475be3a |
...
For a systems engineer, apache/lucene belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:45:06Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9681796475be3a` from `github_search_databases` as `registry_expansion`
