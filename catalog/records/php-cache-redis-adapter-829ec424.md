...
<!-- canonical: https://packagist.org/packages/cache/redis-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/cache/redis-adapter](https://packagist.org/packages/cache/redis-adapter) |
| Source record ids | packagist_search-94b3f2dd253c3b |
...
For a systems engineer, cache/redis-adapter belongs in the PHP inventory as part of state
...
- `packagist_search-94b3f2dd253c3b` from `packagist_search` as `registry_expansion`
