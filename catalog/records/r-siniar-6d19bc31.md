...
<!-- canonical: https://cran.r-project.org/web/packages/siniaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/siniaR/index.html](https://cran.r-project.org/web/packages/siniaR/index.html) |
| Source record ids | cran_packages_by_date-a16372e3540343 |

## System Engineer Summary

Access to Peru's Environmental Statistics ('SINIA' / 'MINAM')

## Operational Role

For a systems engineer, siniaR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-11 16:00:02 UTC | [https://cran.r-project.org/web/packages/siniaR/DESCRIPTION](https://cran.r-project.org/web/packages/siniaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/siniaR/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-a16372e3540343` from `cran_packages_by_date` as `registry_expansion`
