...
<!-- canonical: https://github.com/utiasSTARS/gplanetary-nav -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/utiasSTARS/gplanetary-nav](https://github.com/utiasSTARS/gplanetary-nav) |
| Source record ids | github_search_space_maps-f78c0d2cad170a |

## System Engineer Summary

Python-based interface with georeferenced terrain and insolation maps of planetary surfaces, in
support of global navigation planning.

## Operational Role

For a systems engineer, utiasSTARS/gplanetary-nav belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-30T22:24:34Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f78c0d2cad170a` from `github_search_space_maps` as `registry_expansion`
