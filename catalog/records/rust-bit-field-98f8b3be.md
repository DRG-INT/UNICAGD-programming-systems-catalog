...
<!-- canonical: https://crates.io/crates/bit_field -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bit_field](https://crates.io/crates/bit_field) |
| Source record ids | crates_io-4c1b7e63bac302 |

## System Engineer Summary

Simple bit field trait providing get_bit, get_bits, set_bit, and set_bits methods for Rust's
integral types.

## Operational Role

For a systems engineer, bit_field belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.3 | 2025-08-26T14:49:40.629519Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-4c1b7e63bac302` from `crates_io` as `registry_expansion`
