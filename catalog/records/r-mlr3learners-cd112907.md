...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3learners/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3learners/index.html](https://cran.r-project.org/web/packages/mlr3learners/index.html) |
| Source record ids | cran_packages_by_date-5ead49e5e32764 |
...
For a systems engineer, mlr3learners belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-09-08 13:00:02 UTC | [https://cran.r-project.org/web/packages/mlr3learners/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3learners/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3learners/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-5ead49e5e32764` from `cran_packages_by_date` as `registry_expansion`
