...
<!-- canonical: https://cran.r-project.org/web/packages/photobiology/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/photobiology/index.html](https://cran.r-project.org/web/packages/photobiology/index.html) |
| Source record ids | cran_packages_by_date-48455d54315ab9 |
...
For a systems engineer, photobiology belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.3 | 2026-09-15 02:20:02 UTC | [https://cran.r-project.org/web/packages/photobiology/DESCRIPTION](https://cran.r-project.org/web/packages/photobiology/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/photobiology/DESCRIPTION` at `2026-09-15T03:22:13+00:00`.
...
- `cran_packages_by_date-48455d54315ab9` from `cran_packages_by_date` as `registry_expansion`
