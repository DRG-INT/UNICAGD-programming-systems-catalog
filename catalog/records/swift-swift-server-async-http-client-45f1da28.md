...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/swift-server/async-http-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/swift-server/async-http-client](https://github.com/swift-server/async-http-client) |
| Source record ids | github_search_swift-8b8c401bc53db5 |
...
For a systems engineer, swift-server/async-http-client belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T09:35:51Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-8b8c401bc53db5` from `github_search_swift` as `registry_expansion`
