...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-94e397e53f66d3 |

## System Engineer Summary

glib is tracked as a library record in the C99 branch. The source did not provide a long
...
For a systems engineer, glib belongs in the C99 inventory as part of ecosystem capability mapping,
...
- `corpus-94e397e53f66d3` from `master_json` as `library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| APR | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-apr-57e5c564.md) |
| dietlibc | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-dietlibc-4da0ceaf.md) |
| glibc | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-glibc-9131f0ec.md) |
| musl libc | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-musl-libc-5e25e4a2.md) |
| newlib | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-newlib-ae545120.md) |
