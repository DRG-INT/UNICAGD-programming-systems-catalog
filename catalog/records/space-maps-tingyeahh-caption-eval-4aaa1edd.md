# TingYeahh/caption_eval

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TingYeahh/caption_eval -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TingYeahh/caption_eval](https://github.com/TingYeahh/caption_eval) |
| Source record ids | github_search_space_maps-524c3f699c0f10 |

## System Engineer Summary

A python3 library for evaluating caption's BLEU, Meteor, CIDEr, SPICE，ROUGE_L，WMD score. Fork from

## Operational Role

For a systems engineer, TingYeahh/caption_eval belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-25T02:28:24Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:spice stars:>10", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_space_maps-524c3f699c0f10` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AbsurdePhoton/dominant-colors-3d-color-space | Undefined Behavior Analyzer | [open](space-maps-absurdephoton-dominant-colors-3d-color-space-8d9436bf.md) |
| ajsupplycollc/substrate-hub | Undefined Behavior Analyzer | [open](space-maps-ajsupplycollc-substrate-hub-fb814516.md) |
| alurubalakarthikeya/NASA-Space-Apps | Undefined Behavior Analyzer | [open](space-maps-alurubalakarthikeya-nasa-space-apps-03333f1e.md) |
| azizka/sampbias | Undefined Behavior Analyzer | [open](space-maps-azizka-sampbias-a65f497f.md) |
| czl9707/gh-space-shooter | Undefined Behavior Analyzer | [open](space-maps-czl9707-gh-space-shooter-fc533b97.md) |
| DAEDALUS-Modding/Flubbs-Map-Pack | Undefined Behavior Analyzer | [open](space-maps-daedalus-modding-flubbs-map-pack-dec5bfc7.md) |
| ghzgod/unraid-modern-appstore | Undefined Behavior Analyzer | [open](space-maps-ghzgod-unraid-modern-appstore-162cd9ad.md) |
| Howtoimagine/the_kaleidoscope_legacy_edition | Undefined Behavior Analyzer | [open](space-maps-howtoimagine-the-kaleidoscope-legacy-edition-0c64554a.md) |
