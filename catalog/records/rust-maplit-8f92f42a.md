...
<!-- canonical: https://crates.io/crates/maplit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/maplit](https://crates.io/crates/maplit) |
| Source record ids | crates_io-f96b380c284fb3 |
...
For a systems engineer, maplit belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2019-08-24T17:23:26.045525Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-f96b380c284fb3` from `crates_io` as `registry_expansion`
