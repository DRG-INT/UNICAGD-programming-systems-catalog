...
<!-- canonical: https://luarocks.org/modules/robertlzj/access_file_data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/robertlzj/access_file_data](https://luarocks.org/modules/robertlzj/access_file_data) |
| Source record ids | luarocks_root_manifest-8f752ae96f1691 |

## System Engineer Summary

access data from/to lua file.

## Operational Role

For a systems engineer, Access_File_Data belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-8f752ae96f1691` from `luarocks_root_manifest` as `registry_expansion`
