...
| Canonical URL | [https://crates.io/crates/unicode-script](https://crates.io/crates/unicode-script) |
| Source record ids | crates_io-43354dde71c0d2 |
...
For a systems engineer, unicode-script belongs in the Rust inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.8 | 2025-12-03T23:10:37.263018Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-43354dde71c0d2` from `crates_io` as `registry_expansion`
