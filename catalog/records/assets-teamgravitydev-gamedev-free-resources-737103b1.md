...
<!-- canonical: https://github.com/teamgravitydev/gamedev-free-resources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/teamgravitydev/gamedev-free-resources](https://github.com/teamgravitydev/gamedev-free-resources) |
| Source record ids | github_search_assets-b9cc9bac986428 |

## System Engineer Summary

This repository offers free assets for game developers, including 2D and 3D art, sound effects,
music, and more, all at no cost.

## Operational Role

For a systems engineer, teamgravitydev/gamedev-free-resources belongs in the Assets inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-05T01:08:15Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD Zero Clause License; https://api.github.com/licenses/0bsd; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_assets-b9cc9bac986428` from `github_search_assets` as `registry_expansion`
