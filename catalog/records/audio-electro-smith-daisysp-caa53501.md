...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/electro-smith/DaisySP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/electro-smith/DaisySP](https://github.com/electro-smith/DaisySP) |
| Source record ids | github_search_audio-f4cacbae140d03 |
...
For a systems engineer, electro-smith/DaisySP belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-29T04:37:29Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-f4cacbae140d03` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AIGC-Audio/AudioGPT | Machine Learning | [open](audio-aigc-audio-audiogpt-981ac143.md) |
| copych/AcidBox | Machine Learning | [open](audio-copych-acidbox-f1182e91.md) |
| DamRsn/NeuralNote | Machine Learning | [open](audio-damrsn-neuralnote-e9b5c736.md) |
| davemollen/dm-GrainDelay | Machine Learning | [open](audio-davemollen-dm-graindelay-2d66844f.md) |
| huggingface/transformers | Machine Learning | [open](audio-huggingface-transformers-9073c238.md) |
| ictnlp/StreamSpeech | Machine Learning | [open](audio-ictnlp-streamspeech-abc4c0a4.md) |
| iver56/audiomentations | Machine Learning | [open](audio-iver56-audiomentations-bf487b1d.md) |
| lanceylai/TSWeChat | Machine Learning | [open](audio-lanceylai-tswechat-3bd4bda0.md) |
