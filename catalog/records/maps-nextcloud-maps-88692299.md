...
<!-- canonical: https://github.com/nextcloud/maps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nextcloud/maps](https://github.com/nextcloud/maps) |
| Source record ids | github_search_maps-dad00de4890ea6 |
...
For a systems engineer, nextcloud/maps belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:57:57Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-dad00de4890ea6` from `github_search_maps` as `registry_expansion`
