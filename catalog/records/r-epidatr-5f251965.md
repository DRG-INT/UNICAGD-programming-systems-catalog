...
<!-- canonical: https://cran.r-project.org/web/packages/epidatr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epidatr/index.html](https://cran.r-project.org/web/packages/epidatr/index.html) |
| Source record ids | cran_packages_by_date-ffc19a13e3dda0 |
...
For a systems engineer, epidatr belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-28 14:40:02 UTC | [https://cran.r-project.org/web/packages/epidatr/DESCRIPTION](https://cran.r-project.org/web/packages/epidatr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epidatr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ffc19a13e3dda0` from `cran_packages_by_date` as `registry_expansion`
