...
<!-- canonical: https://github.com/jasync-sql/jasync-sql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jasync-sql/jasync-sql](https://github.com/jasync-sql/jasync-sql) |
| Source record ids | github_search_databases-3c6c1482746e65 |
...
For a systems engineer, jasync-sql/jasync-sql belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-15T22:52:28Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3c6c1482746e65` from `github_search_databases` as `registry_expansion`
