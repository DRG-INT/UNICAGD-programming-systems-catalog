...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Ffi Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ffi-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@blocksuite/data-view](https://www.npmjs.com/package/@blocksuite/data-view) |
| Source record ids | npm_registry-2c3323d7511f35 |

## System Engineer Summary

Views of database in affine

## Operational Role

For a systems engineer, @blocksuite/data-view belongs in the Node.js/JavaScript inventory as part of
cross-language integration, ABI ownership, memory safety, and runtime embedding.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.4 | 2025-07-01T05:43:33.867Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @axiomhq/logging | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-axiomhq-logging-1a778042.md) |
| @blocksuite/affine-block-database | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-blocksuite-affine-block-database-c0168ec8.md) |
| @browserstack/mcp-server | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-browserstack-mcp-server-28ee02d1.md) |
| @canva/cli | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-canva-cli-7d868b38.md) |
| @datadog/openfeature-node-server | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-datadog-openfeature-node-server-86bf2f8d.md) |
| @larksuite/cli | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-larksuite-cli-442a55c5.md) |
| @notionhq/notion-mcp-server | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-notionhq-notion-mcp-server-f7b2be7e.md) |
| @payloadcms/db-d1-sqlite | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-payloadcms-db-d1-sqlite-f0725d60.md) |
