...
<!-- canonical: https://github.com/tapeQz/Shine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tapeQz/Shine](https://github.com/tapeQz/Shine) |
| Source record ids | github_search_effects-0f566cbddf789a |

## System Engineer Summary

A Minecraft mod that adds bloom, colored lighting, and stylized effects, without shaders.

## Operational Role

For a systems engineer, tapeQz/Shine belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T15:02:52Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0f566cbddf789a` from `github_search_effects` as `registry_expansion`
