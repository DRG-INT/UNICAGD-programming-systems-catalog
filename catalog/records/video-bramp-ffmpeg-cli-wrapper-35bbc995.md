...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bramp/ffmpeg-cli-wrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bramp/ffmpeg-cli-wrapper](https://github.com/bramp/ffmpeg-cli-wrapper) |
| Source record ids | github_search_video-7c2adb640844a3 |
...
For a systems engineer, bramp/ffmpeg-cli-wrapper belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T08:42:42Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-7c2adb640844a3` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| asciinema/asciinema | Cli | [open](video-asciinema-asciinema-e004a995.md) |
| maxmcd/webtty | Cli | [open](video-maxmcd-webtty-7daeb64c.md) |
| rust-av/Av1an | Cli | [open](video-rust-av-av1an-3193ba93.md) |
