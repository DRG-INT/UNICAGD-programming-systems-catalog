...
<!-- canonical: https://github.com/SAP/java-integration-for-sap-mobile-services -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP/java-integration-for-sap-mobile-services](https://github.com/SAP/java-integration-for-sap-mobile-services) |
| Source record ids | github_search_sapjava-858f05cd53cb79 |

## System Engineer Summary

Java library that integrates to SAP Mobile Services Backend APIs. As a start this will only provide
the Notification Backend API to send notifications to mobile devices. Further APIs may be included
in the future.

## Operational Role

For a systems engineer, SAP/java-integration-for-sap-mobile-services belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.7.0 | 2023-08-07T08:54:14Z | [https://api.github.com/repos/SAP/java-integration-for-sap-mobile-services/releases/latest](https://api.github.com/repos/SAP/java-integration-for-sap-mobile-services/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SAP/java-integration-for-sap-mobile-services/releases/latest` at `2026-09-01T10:25:36+00:00`.
...
- `github_search_sapjava-858f05cd53cb79` from `github_search_sapjava` as `registry_expansion`
