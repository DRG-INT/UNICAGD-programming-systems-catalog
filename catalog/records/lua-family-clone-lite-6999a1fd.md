...
<!-- canonical: https://luarocks.org/modules/leaf-node/clone-lite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/leaf-node/clone-lite](https://luarocks.org/modules/leaf-node/clone-lite) |
| Source record ids | luarocks_root_manifest-14052f017ffb50 |

## System Engineer Summary

Cloning of simple tables, for Teal and Lua

## Operational Role

For a systems engineer, clone-lite belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-14052f017ffb50` from `luarocks_root_manifest` as `registry_expansion`
