...
<!-- canonical: https://pypi.org/project/acryl-datahub-airflow-plugin-patched/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acryl-datahub-airflow-plugin-patched/](https://pypi.org/project/acryl-datahub-airflow-plugin-patched/) |
| Source record ids | pypi_simple-e2ca6e5c7de234 |
...
For a systems engineer, acryl-datahub-airflow-plugin-patched belongs in the Python inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0.3.post6 | 2026-04-09T05:56:53.346582Z | [https://pypi.org/pypi/acryl-datahub-airflow-plugin-patched/json](https://pypi.org/pypi/acryl-datahub-airflow-plugin-patched/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acryl-datahub-airflow-plugin-patched/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-e2ca6e5c7de234` from `pypi_simple` as `registry_expansion`
