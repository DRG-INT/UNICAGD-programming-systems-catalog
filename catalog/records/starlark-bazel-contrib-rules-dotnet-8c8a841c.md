...
<!-- canonical: https://github.com/bazel-contrib/rules_dotnet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_dotnet](https://github.com/bazel-contrib/rules_dotnet) |
| Source record ids | github_search_starlark-2259ae24a40579 |

## System Engineer Summary

bazel-contrib/rules_dotnet is tracked as a build system record in the Starlark branch. The source
...
For a systems engineer, bazel-contrib/rules_dotnet belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:40:11Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-2259ae24a40579` from `github_search_starlark` as `registry_expansion`
