...
<!-- canonical: https://pub.dev/packages/flutter_contacts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_contacts](https://pub.dev/packages/flutter_contacts) |
| Source record ids | pub_dev-af9d91b39a8ae8 |

## System Engineer Summary

Fast, complete contact management for Android, iOS & macOS — all fields, groups, accounts, vCards,
native dialogs, listeners, SIM contacts, and number blocking.

## Operational Role

For a systems engineer, flutter_contacts belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-07-29T15:55:06.577144Z | [https://pub.dev/api/packages/flutter_contacts](https://pub.dev/api/packages/flutter_contacts) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_contacts` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-af9d91b39a8ae8` from `pub_dev` as `registry_expansion`
