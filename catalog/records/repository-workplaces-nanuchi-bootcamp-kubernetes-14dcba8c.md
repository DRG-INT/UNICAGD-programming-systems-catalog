...
| Canonical URL | [https://gitlab.com/nanuchi/bootcamp-kubernetes](https://gitlab.com/nanuchi/bootcamp-kubernetes) |
| Source record ids | gitlab_projects_api-9f287f0cce6138 |
...
For a systems engineer, nanuchi/bootcamp-kubernetes belongs in the Repository Workplaces inventory
...
- `gitlab_projects_api-9f287f0cce6138` from `gitlab_projects_api` as `registry_expansion`
...
| gitlab-examples/kubernetes-deploy | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-examples-kubernetes-deploy-9a43e04a.md) |
