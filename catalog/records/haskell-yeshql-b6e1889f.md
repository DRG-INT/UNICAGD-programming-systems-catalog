...
<!-- canonical: https://hackage.haskell.org/package/yeshql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yeshql](https://hackage.haskell.org/package/yeshql) |
| Source record ids | hackage_top_downloads-9ab9ed53eb9f9d |
...
For a systems engineer, yeshql belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0.0 | 2020-05-25T22:58:31Z | [https://hackage.haskell.org/package/yeshql](https://hackage.haskell.org/package/yeshql) |  |
| candidate | partial | 4.2.0.0 |  | [https://hackage.haskell.org/package/yeshql](https://hackage.haskell.org/package/yeshql) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yeshql` at `2026-09-10T01:21:10+00:00`.
...
- `hackage_top_downloads-9ab9ed53eb9f9d` from `hackage_top_downloads` as `registry_expansion`
