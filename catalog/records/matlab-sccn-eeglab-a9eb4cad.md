...
<!-- canonical: https://github.com/sccn/eeglab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sccn/eeglab](https://github.com/sccn/eeglab) |
| Source record ids | github_search_matlab-67fbcd11116e0b |

## System Engineer Summary

EEGLAB is an open source signal processing environment for electrophysiological signals running on
Matlab and developed at the SCCN/UCSD

## Operational Role

For a systems engineer, sccn/eeglab belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T15:49:49Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-67fbcd11116e0b` from `github_search_matlab` as `registry_expansion`
