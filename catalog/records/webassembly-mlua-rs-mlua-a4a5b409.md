...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Jit Vm](../by-category/jit-vm.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mlua-rs/mlua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mlua-rs/mlua](https://github.com/mlua-rs/mlua) |
| Source record ids | github_search_webassembly-4e84fc44197720 |

## System Engineer Summary

High level Lua 5.5/5.4/5.3/5.2/5.1 (including LuaJIT) and Luau bindings to Rust with async/await
support

## Operational Role

For a systems engineer, mlua-rs/mlua belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T21:34:38Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-4e84fc44197720` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| copy/v86 | Jit Vm | [open](webassembly-copy-v86-c7d092c3.md) |
