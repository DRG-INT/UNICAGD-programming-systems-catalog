...
<!-- canonical: https://github.com/phalladar/MacDirStat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/phalladar/MacDirStat](https://github.com/phalladar/MacDirStat) |
| Source record ids | github_search_space_maps-8201cb26fa43e8 |

## System Engineer Summary

Free, open-source disk space analyzer for macOS. WinDirStat for Mac in 2026. Interactive treemap
visualization, fast BSD-level scanning, native SwiftUI app. Find what's using your storage.

## Operational Role

For a systems engineer, phalladar/MacDirStat belongs in the Space Maps inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-16T17:02:11Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8201cb26fa43e8` from `github_search_space_maps` as `registry_expansion`
