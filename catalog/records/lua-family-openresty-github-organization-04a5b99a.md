...
<!-- canonical: https://github.com/openresty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openresty](https://github.com/openresty) |
| Source record ids | lua-source-164 |

## System Engineer Summary

Home of the repositories for ngx_lua, ngx_openresty, and many related modules.

## Operational Role

For a systems engineer, OpenResty GitHub Organization belongs in the Lua family inventory as part of
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 164}}` |
...
- `lua-source-164` from `master_json` as `source_list_item`
