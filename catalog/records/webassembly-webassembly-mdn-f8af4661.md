...
| Canonical URL | [https://developer.mozilla.org/en-US/docs/WebAssembly](https://developer.mozilla.org/en-US/docs/WebAssembly) |
| Source record ids | awesome_list-bfeeea357d057e |

## System Engineer Summary

WebAssembly MDN is tracked as a library record in the WebAssembly branch. The source did not provide
...
For a systems engineer, WebAssembly MDN belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "General Resources", "source_url": "https://raw.githubusercontent.com/mbasso/awesome-wasm/master/README.md", "status": "curated-list-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `awesome_list-bfeeea357d057e` from `awesome_list` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| jupyterlite/jupyterlite | Library | [open](webassembly-jupyterlite-jupyterlite-7833185c.md) |
| meshery/meshery | Library | [open](webassembly-meshery-meshery-19a90056.md) |
| svenstaro/genact | Library | [open](webassembly-svenstaro-genact-2670193d.md) |
| wac - WebAssembly in C (x86) | Library | [open](webassembly-wac-webassembly-in-c-x86-eec326ea.md) |
| WASI - The WebAssembly System Interface | Library | [open](webassembly-wasi-the-webassembly-system-interface-2e6928ab.md) |
| Wasm2Wat | Library | [open](webassembly-wasm2wat-593bb45c.md) |
| wasmachine - WebAssembly in a FPGA | Library | [open](webassembly-wasmachine-webassembly-in-a-fpga-19bc4c85.md) |
| Wasmer for Go | Library | [open](webassembly-wasmer-for-go-3d87f0b5.md) |
