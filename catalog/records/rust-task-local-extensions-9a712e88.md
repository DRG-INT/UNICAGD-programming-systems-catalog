...
| Canonical URL | [https://crates.io/crates/task-local-extensions](https://crates.io/crates/task-local-extensions) |
| Source record ids | crates_io-a59f5fab8ca9ba |
...
For a systems engineer, task-local-extensions belongs in the Rust inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2023-03-09T10:29:51.516244Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-a59f5fab8ca9ba` from `crates_io` as `registry_expansion`
