...
<!-- canonical: https://gitlab.com/glitchtip/glitchtip-helm-chart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/glitchtip/glitchtip-helm-chart](https://gitlab.com/glitchtip/glitchtip-helm-chart) |
| Source record ids | gitlab_projects_api-e8d05f7e8776e5 |

## System Engineer Summary

A helm chart for installing GlitchTip in Kubernetes

## Operational Role

For a systems engineer, glitchtip/glitchtip-helm-chart belongs in the Repository Workplaces
...
- `gitlab_projects_api-e8d05f7e8776e5` from `gitlab_projects_api` as `registry_expansion`
