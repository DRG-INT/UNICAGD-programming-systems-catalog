...
<!-- canonical: https://crates.io/crates/indexmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/indexmap](https://crates.io/crates/indexmap) |
| Source record ids | crates_io-a8731e9f4e4852 |
...
For a systems engineer, indexmap belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.14.2 | 2026-09-05T01:53:48.019655Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-05T02:18:17+00:00`.
...
- `crates_io-a8731e9f4e4852` from `crates_io` as `registry_expansion`
