...
<!-- canonical: https://pub.dev/packages/pdfrx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pdfrx](https://pub.dev/packages/pdfrx) |
| Source record ids | pub_dev-49e2b1b3da6efd |

## System Engineer Summary

pdfrx is a rich and fast PDF viewer and manipulation plugin built on the top of PDFium. Supports
viewing, editing, combining PDFs on Android, iOS, Windows, macOS, Linux, and Web.

## Operational Role

For a systems engineer, pdfrx belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2026-08-27T15:44:20.310240Z | [https://pub.dev/api/packages/pdfrx](https://pub.dev/api/packages/pdfrx) |  |
| preview | known | 2.0.0-beta7 | 2025-07-19T20:09:33.583233Z | [https://pub.dev/api/packages/pdfrx](https://pub.dev/api/packages/pdfrx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pdfrx` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-49e2b1b3da6efd` from `pub_dev` as `registry_expansion`
