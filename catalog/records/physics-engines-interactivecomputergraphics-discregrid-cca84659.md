...
<!-- canonical: https://github.com/InteractiveComputerGraphics/Discregrid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/InteractiveComputerGraphics/Discregrid](https://github.com/InteractiveComputerGraphics/Discregrid) |
| Source record ids | github_search_physics_engines-1b1e9cc06e3698 |

## System Engineer Summary

A static C++ library for the generation of discrete functions on a box-shaped domain. This is
especially suited for the discretization of signed distance fields.

## Operational Role

For a systems engineer, InteractiveComputerGraphics/Discregrid belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-31T10:30:00Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-1b1e9cc06e3698` from `github_search_physics_engines` as `registry_expansion`
...
| leggedrobotics/raisimLib | Machine Learning | [open](physics-engines-leggedrobotics-raisimlib-69e401fc.md) |
