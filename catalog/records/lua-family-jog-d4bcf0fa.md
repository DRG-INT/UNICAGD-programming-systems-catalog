...
| Canonical URL | [https://luarocks.org/modules/tarleb/jog](https://luarocks.org/modules/tarleb/jog) |
| Source record ids | luarocks_root_manifest-e1a6f4d5b1dde2 |
...
For a systems engineer, jog belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-e1a6f4d5b1dde2` from `luarocks_root_manifest` as `registry_expansion`
