...
| Source record ids | github_search_telescopes-dadcd283a97724 |
...
For a systems engineer, OpenSpace/OpenSpace belongs in the Telescopes inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | releases/v0.22.0 | 2026-06-12T17:28:19Z | [https://api.github.com/repos/OpenSpace/OpenSpace/releases/latest](https://api.github.com/repos/OpenSpace/OpenSpace/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OpenSpace/OpenSpace/releases/latest` at `2026-09-01T08:26:26+00:00`.
...
- `github_search_telescopes-dadcd283a97724` from `github_search_telescopes` as `registry_expansion`
