...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/developmentseed/label-maker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/developmentseed/label-maker](https://github.com/developmentseed/label-maker) |
| Source record ids | github_search_radars-0a0b1acee932b0 |
...
For a systems engineer, developmentseed/label-maker belongs in the Radars inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-03T21:56:39Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-0a0b1acee932b0` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aalling93/Custom-made-SAR-speckle-reduction | Build System | [open](radars-aalling93-custom-made-sar-speckle-reduction-99bb6550.md) |
| layumi/University1652-Baseline | Build System | [open](radars-layumi-university1652-baseline-6e7408e8.md) |
| malulleybovo/SymbolArtEditorOnline | Build System | [open](radars-malulleybovo-symbolarteditoronline-2ac65f75.md) |
| thoughtworks/build-your-own-radar | Build System | [open](radars-thoughtworks-build-your-own-radar-bf05fe36.md) |
| u-blox/ubxlib | Build System | [open](radars-u-blox-ubxlib-bb7371e1.md) |
| ya0-sun/PostEQ-SARopt-BuildingDamage | Build System | [open](radars-ya0-sun-posteq-saropt-buildingdamage-1c3b0c8f.md) |
