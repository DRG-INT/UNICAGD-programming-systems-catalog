...
<!-- canonical: https://cran.r-project.org/web/packages/alepe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/alepe/index.html](https://cran.r-project.org/web/packages/alepe/index.html) |
| Source record ids | cran_packages_by_date-ca55c516d187fd |
...
For a systems engineer, alepe belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-20 14:22:29 UTC | [https://cran.r-project.org/web/packages/alepe/DESCRIPTION](https://cran.r-project.org/web/packages/alepe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/alepe/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ca55c516d187fd` from `cran_packages_by_date` as `registry_expansion`
