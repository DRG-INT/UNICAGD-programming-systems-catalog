...
<!-- canonical: https://cran.r-project.org/web/packages/RcppExamples/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppExamples/index.html](https://cran.r-project.org/web/packages/RcppExamples/index.html) |
| Source record ids | cran_packages_by_date-8dd37ebe3b16a5 |
...
For a systems engineer, RcppExamples belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.11 | 2026-09-03 14:40:08 UTC | [https://cran.r-project.org/web/packages/RcppExamples/DESCRIPTION](https://cran.r-project.org/web/packages/RcppExamples/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppExamples/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-8dd37ebe3b16a5` from `cran_packages_by_date` as `registry_expansion`
