...
<!-- canonical: https://github.com/EQMG/Acid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EQMG/Acid](https://github.com/EQMG/Acid) |
| Source record ids | github_search_game_engines-e73efb2c2b74a9 |
...
For a systems engineer, EQMG/Acid belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-21T04:41:02Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e73efb2c2b74a9` from `github_search_game_engines` as `registry_expansion`
