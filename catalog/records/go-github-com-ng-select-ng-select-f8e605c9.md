...
<!-- canonical: https://pkg.go.dev/github.com/ng-select/ng-select -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pkg.go.dev/github.com/ng-select/ng-select](https://pkg.go.dev/github.com/ng-select/ng-select) |
| Source record ids | go_module_index-5015054c913713 |
...
For a systems engineer, github.com/ng-select/ng-select belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v24.0.4+incompatible | 2026-08-30T10:56:36.124726Z | [https://index.golang.org/index?since=2026-08-30T10%3A27%3A51.361401Z&limit=2000](https://index.golang.org/index?since=2026-08-30T10%3A27%3A51.361401Z&limit=2000) |  |
...
- `go_module_index-5015054c913713` from `go_module_index` as `registry_expansion`
