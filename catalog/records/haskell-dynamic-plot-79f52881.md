...
<!-- canonical: https://hackage.haskell.org/package/dynamic-plot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dynamic-plot](https://hackage.haskell.org/package/dynamic-plot) |
| Source record ids | hackage_top_downloads-1ebaef164047d1 |
...
For a systems engineer, dynamic-plot belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2.0 | 2022-04-17T08:56:14Z | [https://hackage.haskell.org/package/dynamic-plot](https://hackage.haskell.org/package/dynamic-plot) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dynamic-plot` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-1ebaef164047d1` from `hackage_top_downloads` as `registry_expansion`
