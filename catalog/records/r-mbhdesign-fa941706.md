...
<!-- canonical: https://cran.r-project.org/web/packages/MBHdesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MBHdesign/index.html](https://cran.r-project.org/web/packages/MBHdesign/index.html) |
| Source record ids | cran_packages_by_date-0b2a783f5a3ccf |
...
For a systems engineer, MBHdesign belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.22 | 2026-09-11 07:00:28 UTC | [https://cran.r-project.org/web/packages/MBHdesign/DESCRIPTION](https://cran.r-project.org/web/packages/MBHdesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MBHdesign/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-0b2a783f5a3ccf` from `cran_packages_by_date` as `registry_expansion`
