...
<!-- canonical: https://cran.r-project.org/web/packages/dlmtree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dlmtree/index.html](https://cran.r-project.org/web/packages/dlmtree/index.html) |
| Source record ids | cran_packages_by_date-489d73bb446159 |
...
For a systems engineer, dlmtree belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-04 22:20:02 UTC | [https://cran.r-project.org/web/packages/dlmtree/DESCRIPTION](https://cran.r-project.org/web/packages/dlmtree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dlmtree/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-489d73bb446159` from `cran_packages_by_date` as `registry_expansion`
