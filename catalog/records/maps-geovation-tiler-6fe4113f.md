...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Geovation/tiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Geovation/tiler](https://github.com/Geovation/tiler) |
| Source record ids | github_search_maps-66a5d18078d0e0 |
...
For a systems engineer, Geovation/tiler belongs in the Maps inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-09-21T20:56:41Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-66a5d18078d0e0` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| geotrellis/vectorpipe | Package Manager | [open](maps-geotrellis-vectorpipe-fd7bc4ed.md) |
| pathintegral-institute/mcpm.sh | Package Manager | [open](maps-pathintegral-institute-mcpm-sh-3ca68074.md) |
| smg-project/smg | Package Manager | [open](maps-smg-project-smg-842075fb.md) |
