...
<!-- canonical: https://hackage.haskell.org/package/Blammo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Blammo](https://hackage.haskell.org/package/Blammo) |
| Source record ids | hackage_top_downloads-e1f8db0ee8cdd3 |
...
For a systems engineer, Blammo belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.4.1 | 2026-07-30T17:19:44Z | [https://hackage.haskell.org/package/Blammo](https://hackage.haskell.org/package/Blammo) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Blammo` at `2026-09-07T00:34:16+00:00`.
...
- `hackage_top_downloads-e1f8db0ee8cdd3` from `hackage_top_downloads` as `registry_expansion`
