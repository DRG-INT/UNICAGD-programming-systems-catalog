...
| Canonical URL | [https://packagist.org/packages/aimeos/ai-client-jsonapi](https://packagist.org/packages/aimeos/ai-client-jsonapi) |
| Source record ids | packagist_search-bedcd55befd3c6 |
...
For a systems engineer, aimeos/ai-client-jsonapi belongs in the PHP inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2024.10.6 | 2026-06-15T10:22:45+00:00 | [https://repo.packagist.org/p2/aimeos/ai-client-jsonapi.json](https://repo.packagist.org/p2/aimeos/ai-client-jsonapi.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/aimeos/ai-client-jsonapi.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-bedcd55befd3c6` from `packagist_search` as `registry_expansion`
