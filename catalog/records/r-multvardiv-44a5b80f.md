...
<!-- canonical: https://cran.r-project.org/web/packages/multvardiv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multvardiv/index.html](https://cran.r-project.org/web/packages/multvardiv/index.html) |
| Source record ids | cran_packages_by_date-68bb8408db0a8e |

## System Engineer Summary

Multivariate Generalized Gaussian Distribution, Multivariate t Distribution, Multivariate Cauchy
Distribution, Statistical Divergence

## Operational Role

For a systems engineer, multvardiv belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.16 | 2026-09-08 11:50:02 UTC | [https://cran.r-project.org/web/packages/multvardiv/DESCRIPTION](https://cran.r-project.org/web/packages/multvardiv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multvardiv/DESCRIPTION` at `2026-09-08T12:26:51+00:00`.
...
- `cran_packages_by_date-68bb8408db0a8e` from `cran_packages_by_date` as `registry_expansion`
