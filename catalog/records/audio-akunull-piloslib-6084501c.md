...
<!-- canonical: https://github.com/akunull/piloslib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/akunull/piloslib](https://github.com/akunull/piloslib) |
| Source record ids | github_search_audio-3fa534bda76479 |

## System Engineer Summary

Multi-platform open-source set of audio and modulation tools that focus on synthesis, live
electronic music, interconnection, probability, unique sounds, and intuitive interfacing built by
Akunull in Pure Data starting in 2014

## Operational Role

For a systems engineer, akunull/piloslib belongs in the Audio inventory as part of ecosystem
...
- `github_search_audio-3fa534bda76479` from `github_search_audio` as `registry_expansion`
