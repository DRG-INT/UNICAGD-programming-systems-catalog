...
| Source record ids | github_search_maps-4b7dc718022a5e |
...
For a systems engineer, RediSearch/RediSearch belongs in the Maps inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T16:51:24Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-4b7dc718022a5e` from `github_search_maps` as `registry_expansion`
