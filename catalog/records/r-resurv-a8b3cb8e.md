...
<!-- canonical: https://cran.r-project.org/web/packages/ReSurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ReSurv/index.html](https://cran.r-project.org/web/packages/ReSurv/index.html) |
| Source record ids | cran_packages_by_date-828deaa4550190 |
...
For a systems engineer, ReSurv belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-15 08:50:02 UTC | [https://cran.r-project.org/web/packages/ReSurv/DESCRIPTION](https://cran.r-project.org/web/packages/ReSurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ReSurv/DESCRIPTION` at `2026-09-15T10:20:58+00:00`.
...
- `cran_packages_by_date-828deaa4550190` from `cran_packages_by_date` as `registry_expansion`
