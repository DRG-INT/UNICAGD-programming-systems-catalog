# chaosbuffalolabs/ParticlePanda
...
<!-- canonical: https://github.com/chaosbuffalolabs/ParticlePanda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chaosbuffalolabs/ParticlePanda](https://github.com/chaosbuffalolabs/ParticlePanda) |
| Source record ids | github_search_effects-5cdb8252734dc7 |

## System Engineer Summary

An extensible, open source particle system built in python using the Kivy framework

## Operational Role

For a systems engineer, chaosbuffalolabs/ParticlePanda belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-05-10T17:49:22Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5cdb8252734dc7` from `github_search_effects` as `registry_expansion`
