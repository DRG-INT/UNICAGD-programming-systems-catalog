...
<!-- canonical: https://pypi.org/project/aclib/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclib/](https://pypi.org/project/aclib/) |
| Source record ids | pypi_simple-6d862712a36e74 |
...
For a systems engineer, aclib belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2019-11-26T11:47:14.292275Z | [https://pypi.org/pypi/aclib/json](https://pypi.org/pypi/aclib/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclib/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-6d862712a36e74` from `pypi_simple` as `registry_expansion`
