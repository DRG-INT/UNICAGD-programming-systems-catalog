...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Concurrency Parallelism](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/concurrency-parallelism.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/gonapps/gonapps-jwt](https://luarocks.org/modules/gonapps/gonapps-jwt) |
| Source record ids | luarocks_root_manifest-10d3fa20fe545d |
...
For a systems engineer, gonapps-jwt belongs in the Lua family inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| atmos | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-atmos-8b547020.md) |
| Concurrency and Multithreading | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-concurrency-and-multithreading-fdfe1fcb.md) |
| ConcurrentLua | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-concurrentlua-035141ac.md) |
| coutil | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-coutil-3ad5af28.md) |
| cqueues | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cqueues-f3e8ae08.md) |
| dromozoa-multi | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-multi-1394ce23.md) |
| Filament | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-filament-67a45b30.md) |
| gamecake-wire | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gamecake-wire-15a0b788.md) |
