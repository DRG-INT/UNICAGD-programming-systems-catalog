...
| Canonical URL | [https://crates.io/crates/virtue](https://crates.io/crates/virtue) |
| Source record ids | crates_io-af5841fa1df902 |
...
For a systems engineer, virtue belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.19 | 2025-12-17T07:21:36.284862Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-af5841fa1df902` from `crates_io` as `registry_expansion`
