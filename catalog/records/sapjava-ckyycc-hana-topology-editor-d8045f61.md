...
<!-- canonical: https://github.com/ckyycc/hana-topology-editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ckyycc/hana-topology-editor](https://github.com/ckyycc/hana-topology-editor) |
| Source record ids | github_search_sapjava-d5117deea26ea2 |
...
For a systems engineer, ckyycc/hana-topology-editor belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | V1.00.00 | 2019-10-27T05:39:13Z | [https://api.github.com/repos/ckyycc/hana-topology-editor/releases/latest](https://api.github.com/repos/ckyycc/hana-topology-editor/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ckyycc/hana-topology-editor/releases/latest` at `2026-09-01T10:25:34+00:00`.
...
- `github_search_sapjava-d5117deea26ea2` from `github_search_sapjava` as `registry_expansion`
