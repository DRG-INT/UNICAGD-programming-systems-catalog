...
<!-- canonical: https://github.com/knightway8/chess4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/knightway8/chess4](https://github.com/knightway8/chess4) |
| Source record ids | github_search_repertoare_catalogs-cc94c957226f39 |

## System Engineer Summary

Chess library, part 1: opening course books, workbooks, a complete 1.d4/2.c4 repertoire, opening
PDFs and the main collection index.

## Operational Role

For a systems engineer, knightway8/chess4 belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T13:36:49Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-cc94c957226f39` from `github_search_repertoare_catalogs` as `registry_expansion`
