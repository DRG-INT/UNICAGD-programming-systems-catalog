...
| Canonical URL | [https://github.com/bazelbuild/bazel-skylib](https://github.com/bazelbuild/bazel-skylib) |
| Source record ids | github_search_starlark-8afd0e30f2784d |
...
For a systems engineer, bazelbuild/bazel-skylib belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.2 | 2026-07-17T18:38:51Z | [https://api.github.com/repos/bazelbuild/bazel-skylib/releases/latest](https://api.github.com/repos/bazelbuild/bazel-skylib/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazelbuild/bazel-skylib/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-8afd0e30f2784d` from `github_search_starlark` as `registry_expansion`
