...
<!-- canonical: https://cran.r-project.org/web/packages/metafor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metafor/index.html](https://cran.r-project.org/web/packages/metafor/index.html) |
| Source record ids | cran_packages_by_date-b5e55e6fbc1a41 |
...
For a systems engineer, metafor belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.2-1 | 2026-09-15 12:30:02 UTC | [https://cran.r-project.org/web/packages/metafor/DESCRIPTION](https://cran.r-project.org/web/packages/metafor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metafor/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-b5e55e6fbc1a41` from `cran_packages_by_date` as `registry_expansion`
