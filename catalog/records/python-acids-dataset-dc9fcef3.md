...
<!-- canonical: https://pypi.org/project/acids-dataset/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acids-dataset/](https://pypi.org/project/acids-dataset/) |
| Source record ids | pypi_simple-de28b3318a2ab8 |
...
For a systems engineer, acids-dataset belongs in the Python inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2025-05-22T07:37:22.686758Z | [https://pypi.org/pypi/acids-dataset/json](https://pypi.org/pypi/acids-dataset/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acids-dataset/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-de28b3318a2ab8` from `pypi_simple` as `registry_expansion`
