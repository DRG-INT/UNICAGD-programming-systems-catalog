...
<!-- canonical: https://hackage.haskell.org/package/resourcet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/resourcet](https://hackage.haskell.org/package/resourcet) |
| Source record ids | hackage_top_downloads-dd93edfd2fdbfd |
...
For a systems engineer, resourcet belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2022-10-23T07:13:07Z | [https://hackage.haskell.org/package/resourcet](https://hackage.haskell.org/package/resourcet) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/resourcet` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-dd93edfd2fdbfd` from `hackage_top_downloads` as `registry_expansion`
