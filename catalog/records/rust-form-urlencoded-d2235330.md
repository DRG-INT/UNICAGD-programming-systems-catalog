...
<!-- canonical: https://crates.io/crates/form_urlencoded -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/form_urlencoded](https://crates.io/crates/form_urlencoded) |
| Source record ids | crates_io-45f55898ce586c |
...
For a systems engineer, form_urlencoded belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2025-08-21T08:47:43.939560Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-45f55898ce586c` from `crates_io` as `registry_expansion`
