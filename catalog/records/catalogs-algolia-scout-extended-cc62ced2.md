...
<!-- canonical: https://github.com/algolia/scout-extended -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/algolia/scout-extended](https://github.com/algolia/scout-extended) |
| Source record ids | github_search_catalogs-b0f5121c3987a7 |
...
For a systems engineer, algolia/scout-extended belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T12:57:11Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-b0f5121c3987a7` from `github_search_catalogs` as `registry_expansion`
