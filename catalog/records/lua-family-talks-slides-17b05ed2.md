...
| Source record ids | lua-source-52 |

## System Engineer Summary

Talks & Slides is tracked as an ide editor integration record in the Lua family branch. The source
...
For a systems engineer, Talks & Slides belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 52}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-52` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| IDEs and Plugins | Ide Editor Integration | [open](lua-family-ides-and-plugins-9f37a137.md) |
| Lua Development Tools | Ide Editor Integration | [open](lua-family-lua-development-tools-cd865b7c.md) |
| Lua for IDEA | Ide Editor Integration | [open](lua-family-lua-for-idea-50248507.md) |
| Lua Workshop Talks | Ide Editor Integration | [open](lua-family-lua-workshop-talks-2dbf48e8.md) |
| Lua-users style guide | Ide Editor Integration | [open](lua-family-lua-users-style-guide-d10de992.md) |
| Roberto's Talks | Ide Editor Integration | [open](lua-family-roberto-s-talks-4054769c.md) |
| Style Guides | Ide Editor Integration | [open](lua-family-style-guides-5b345e4b.md) |
| Textadept | Ide Editor Integration | [open](lua-family-textadept-b9f0b7af.md) |
