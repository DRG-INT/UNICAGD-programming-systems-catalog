...
<!-- canonical: https://luarocks.org/modules/argparse/argparse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/argparse/argparse](https://luarocks.org/modules/argparse/argparse) |
| Source record ids | luarocks_root_manifest-8fc9d576d71722 |
...
For a systems engineer, argparse belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-8fc9d576d71722` from `luarocks_root_manifest` as `registry_expansion`
