...
<!-- canonical: https://github.com/epsilla-cloud/vectordb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/epsilla-cloud/vectordb](https://github.com/epsilla-cloud/vectordb) |
| Source record ids | github_search_databases-06ae1aad79e87f |
...
For a systems engineer, epsilla-cloud/vectordb belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-29T16:02:22Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-06ae1aad79e87f` from `github_search_databases` as `registry_expansion`
