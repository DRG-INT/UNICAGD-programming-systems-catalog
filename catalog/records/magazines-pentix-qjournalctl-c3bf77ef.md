...
<!-- canonical: https://github.com/pentix/qjournalctl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pentix/qjournalctl](https://github.com/pentix/qjournalctl) |
| Source record ids | github_search_magazines-8f2893dae892fd |

## System Engineer Summary

A multi-platform, Qt-based frontend for systemd's journalctl command. Accepting local as well as
remote (SSH) data sources.

## Operational Role

For a systems engineer, pentix/qjournalctl belongs in the Magazines inventory as part of
...
- `github_search_magazines-8f2893dae892fd` from `github_search_magazines` as `registry_expansion`
