...
<!-- canonical: https://crates.io/crates/primeorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/primeorder](https://crates.io/crates/primeorder) |
| Source record ids | crates_io-9b79d3ec3af7c4 |

## System Engineer Summary

Pure Rust implementation of complete addition formulas for prime order elliptic curves (Renes-
Costello-Batina 2015). Generic over field elements and curve equation coefficients

## Operational Role

For a systems engineer, primeorder belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-07-03T00:18:00.794603Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-9b79d3ec3af7c4` from `crates_io` as `registry_expansion`
