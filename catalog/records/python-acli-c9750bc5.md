...
<!-- canonical: https://pypi.org/project/acli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acli/](https://pypi.org/project/acli/) |
| Source record ids | pypi_simple-4d04115cb62a19 |
...
For a systems engineer, acli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.34 | 2018-04-19T09:40:54.257526Z | [https://pypi.org/pypi/acli/json](https://pypi.org/pypi/acli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-4d04115cb62a19` from `pypi_simple` as `registry_expansion`
