...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gabriel-brito/starwars-catalogue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gabriel-brito/starwars-catalogue](https://github.com/gabriel-brito/starwars-catalogue) |
| Source record ids | github_search_space_maps-24726b8623f9f8 |

## System Engineer Summary

gabriel-brito/starwars-catalogue is tracked as a logging observability record in the Space Maps
branch. The source did not provide a long description, so this page keeps the identity, release
state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, gabriel-brito/starwars-catalogue belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-09-18T04:11:24Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "star catalog", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_space_maps-24726b8623f9f8` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 339598u5uut/CatalogStarWars | Logging Observability | [open](space-maps-339598u5uut-catalogstarwars-942b196e.md) |
| AbdSalehh/Restaurant-Catalogue | Logging Observability | [open](space-maps-abdsalehh-restaurant-catalogue-bad8a0b6.md) |
| afrigeri/geologic-symbols-qgis | Logging Observability | [open](space-maps-afrigeri-geologic-symbols-qgis-802d1149.md) |
| AmeeJoshi-MCA/azure-databricks-end-to-end-retail-lakehouse | Logging Observability | [open](space-maps-ameejoshi-mca-azure-databricks-end-to-end-retail-lakehouse-3f5d8c5a.md) |
| appsilva/Starship-Catalogue | Logging Observability | [open](space-maps-appsilva-starship-catalogue-f6a2f944.md) |
| Arnav8452/galactic-star-catalogue | Logging Observability | [open](space-maps-arnav8452-galactic-star-catalogue-0eface0b.md) |
| atthecodeface/star-catalog-rs | Logging Observability | [open](space-maps-atthecodeface-star-catalog-rs-baf5fe7c.md) |
| Azure-Samples/data-catalog-dotnet-get-started | Logging Observability | [open](space-maps-azure-samples-data-catalog-dotnet-get-started-511df8fa.md) |
