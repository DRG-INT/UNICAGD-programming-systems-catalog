...
<!-- canonical: https://github.com/eminSerin/NBS-Predict -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eminSerin/NBS-Predict](https://github.com/eminSerin/NBS-Predict) |
| Source record ids | github_search_matlab-ce645c078b9bcd |
...
For a systems engineer, eminSerin/NBS-Predict belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-26T12:42:03Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ce645c078b9bcd` from `github_search_matlab` as `registry_expansion`
