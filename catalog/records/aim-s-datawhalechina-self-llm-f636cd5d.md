...
<!-- canonical: https://github.com/datawhalechina/self-llm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/datawhalechina/self-llm](https://github.com/datawhalechina/self-llm) |
| Source record ids | github_search_aims-f82a17f2e767ed |
...
For a systems engineer, datawhalechina/self-llm belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T06:33:41Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-f82a17f2e767ed` from `github_search_aims` as `registry_expansion`
