...
<!-- canonical: https://crates.io/crates/string_cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/string_cache](https://crates.io/crates/string_cache) |
| Source record ids | crates_io-09930f037adecb |
...
For a systems engineer, string_cache belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2026-08-21T19:28:20.892252Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-09T00:30:53+00:00`.
...
- `crates_io-09930f037adecb` from `crates_io` as `registry_expansion`
