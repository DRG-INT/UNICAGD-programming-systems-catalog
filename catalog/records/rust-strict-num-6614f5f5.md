...
| Canonical URL | [https://crates.io/crates/strict-num](https://crates.io/crates/strict-num) |
| Source record ids | crates_io-aba0a3df754cfb |
...
For a systems engineer, strict-num belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-12-23T08:50:07.257578Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-aba0a3df754cfb` from `crates_io` as `registry_expansion`
