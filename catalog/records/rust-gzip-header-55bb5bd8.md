...
| Canonical URL | [https://crates.io/crates/gzip-header](https://crates.io/crates/gzip-header) |
| Source record ids | crates_io-77e403fcc2430b |
...
For a systems engineer, gzip-header belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-04-15T23:11:04.580804Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-77e403fcc2430b` from `crates_io` as `registry_expansion`
