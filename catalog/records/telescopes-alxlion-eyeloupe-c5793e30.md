...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/alxlion/eyeloupe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alxlion/eyeloupe](https://github.com/alxlion/eyeloupe) |
| Source record ids | github_search_telescopes-deb5bf3d948ae9 |
...
For a systems engineer, alxlion/eyeloupe belongs in the Telescopes inventory as part of fault
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v.0.4.0 | 2023-10-20T08:41:34Z | [https://api.github.com/repos/alxlion/eyeloupe/releases/latest](https://api.github.com/repos/alxlion/eyeloupe/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/alxlion/eyeloupe/releases/latest` at `2026-09-01T11:22:12+00:00`.
...
- `github_search_telescopes-deb5bf3d948ae9` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mogretici/nestlens | Debugger | [open](telescopes-mogretici-nestlens-ca5e47cb.md) |
| omaralalwi/laravel-trash-cleaner | Debugger | [open](telescopes-omaralalwi-laravel-trash-cleaner-15ae296c.md) |
