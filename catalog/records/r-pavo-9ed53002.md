...
<!-- canonical: https://cran.r-project.org/web/packages/pavo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pavo/index.html](https://cran.r-project.org/web/packages/pavo/index.html) |
| Source record ids | cran_packages_by_date-b6c17e5bd026e5 |
...
For a systems engineer, pavo belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.10.0 | 2026-09-14 22:50:02 UTC | [https://cran.r-project.org/web/packages/pavo/DESCRIPTION](https://cran.r-project.org/web/packages/pavo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pavo/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-b6c17e5bd026e5` from `cran_packages_by_date` as `registry_expansion`
