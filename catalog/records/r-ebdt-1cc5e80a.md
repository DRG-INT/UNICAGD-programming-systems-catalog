...
<!-- canonical: https://cran.r-project.org/web/packages/ebdt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ebdt/index.html](https://cran.r-project.org/web/packages/ebdt/index.html) |
| Source record ids | cran_packages_by_date-a5a83ccfc0cdf1 |

## System Engineer Summary

Evaluation of Binary Diagnostic Test

## Operational Role

For a systems engineer, ebdt belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-24 13:40:14 UTC | [https://cran.r-project.org/web/packages/ebdt/DESCRIPTION](https://cran.r-project.org/web/packages/ebdt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ebdt/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a5a83ccfc0cdf1` from `cran_packages_by_date` as `registry_expansion`
