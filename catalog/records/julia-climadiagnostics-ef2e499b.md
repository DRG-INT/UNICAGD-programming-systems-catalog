...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Compiler Diagnostics](../by-category/compiler-diagnostics.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaDiagnostics](https://github.com/JuliaRegistries/General/tree/master/C/ClimaDiagnostics) |
| Source record ids | julia_general-e0b6a3ca76cb71 |

## System Engineer Summary

Julia package registered in General at C/ClimaDiagnostics.

## Operational Role

For a systems engineer, ClimaDiagnostics belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaDiagnostics", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e0b6a3ca76cb71` from `julia_general` as `registry_expansion`
