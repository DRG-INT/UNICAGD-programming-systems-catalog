...
<!-- canonical: https://cran.r-project.org/web/packages/nysOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nysOpenData/index.html](https://cran.r-project.org/web/packages/nysOpenData/index.html) |
| Source record ids | cran_packages_by_date-c1aa3d1c9cb712 |

## System Engineer Summary

Convenient Access to NYS Open Data API Endpoints

## Operational Role

For a systems engineer, nysOpenData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-24 08:30:14 UTC | [https://cran.r-project.org/web/packages/nysOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/nysOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nysOpenData/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c1aa3d1c9cb712` from `cran_packages_by_date` as `registry_expansion`
