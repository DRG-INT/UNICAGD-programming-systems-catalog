...
| Canonical URL | [https://github.com/benfulcher/hctsa](https://github.com/benfulcher/hctsa) |
| Source record ids | github_search_matlab-f4d9cc27c047f8 |
...
For a systems engineer, benfulcher/hctsa belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.0 | 2026-08-04T06:50:21Z | [https://api.github.com/repos/benfulcher/hctsa/releases/latest](https://api.github.com/repos/benfulcher/hctsa/releases/latest) |  |
| preview | known | v3.0.0-alpha | 2026-08-18T06:15:28Z | [https://api.github.com/repos/benfulcher/hctsa/releases?per_page=10](https://api.github.com/repos/benfulcher/hctsa/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/benfulcher/hctsa/releases/latest` at `2026-09-01T07:24:08+00:00`.
...
- `github_search_matlab-f4d9cc27c047f8` from `github_search_matlab` as `registry_expansion`
