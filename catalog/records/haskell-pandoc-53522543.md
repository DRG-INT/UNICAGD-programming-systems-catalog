...
<!-- canonical: https://hackage.haskell.org/package/pandoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pandoc](https://hackage.haskell.org/package/pandoc) |
| Source record ids | hackage_top_downloads-bfabed019c42c7 |

## System Engineer Summary

Hackage package with 1033 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, pandoc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.11 | 2026-08-29T00:42:25Z | [https://hackage.haskell.org/package/pandoc](https://hackage.haskell.org/package/pandoc) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pandoc` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-bfabed019c42c7` from `hackage_top_downloads` as `registry_expansion`
