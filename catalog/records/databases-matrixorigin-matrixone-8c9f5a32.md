...
<!-- canonical: https://github.com/matrixorigin/matrixone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matrixorigin/matrixone](https://github.com/matrixorigin/matrixone) |
| Source record ids | github_search_databases-0d08c2c56afb06 |

## System Engineer Summary

AI-native HTAP database with Git-for-Data and built-in vector search, serving as the data and memory
backbone for intelligent agents and applications.

## Operational Role

For a systems engineer, matrixorigin/matrixone belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:02:52Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0d08c2c56afb06` from `github_search_databases` as `registry_expansion`
