...
<!-- canonical: https://github.com/skyming/Trip-to-iOS-Design-Patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skyming/Trip-to-iOS-Design-Patterns](https://github.com/skyming/Trip-to-iOS-Design-Patterns) |
| Source record ids | github_search_pattern_language-de51a1696f8fd3 |

## System Engineer Summary

skyming/Trip-to-iOS-Design-Patterns is tracked as a filesystem os record in the Pattern language
...
For a systems engineer, skyming/Trip-to-iOS-Design-Patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-05-29T12:43:40Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-de51a1696f8fd3` from `github_search_pattern_language` as `registry_expansion`
