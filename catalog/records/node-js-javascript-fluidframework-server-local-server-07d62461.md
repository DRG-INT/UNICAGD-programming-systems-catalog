...
<!-- canonical: https://www.npmjs.com/package/@fluidframework/server-local-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@fluidframework/server-local-server](https://www.npmjs.com/package/@fluidframework/server-local-server) |
| Source record ids | npm_registry-2bab4895b15275 |
...
For a systems engineer, @fluidframework/server-local-server belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.1 | 2026-04-17T22:39:11.275Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-2bab4895b15275` from `npm_registry` as `registry_expansion`
