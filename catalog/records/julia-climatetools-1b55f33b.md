...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimateTools](https://github.com/JuliaRegistries/General/tree/master/C/ClimateTools) |
| Source record ids | julia_general-8ed4023005a1f2 |

## System Engineer Summary

Julia package registered in General at C/ClimateTools.

## Operational Role

For a systems engineer, ClimateTools belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimateTools", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8ed4023005a1f2` from `julia_general` as `registry_expansion`
