...
<!-- canonical: https://github.com/3d-morphable-models/curated-list-of-awesome-3D-Morphable-Model-software-and-data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/3d-morphable-models/curated-list-of-awesome-3D-Morphable-Model-software-and-data](https://github.com/3d-morphable-models/curated-list-of-awesome-3D-Morphable-Model-software-and-data) |
| Source record ids | github_search_computer_graphics_software-3b65138e63ad39 |

## System Engineer Summary

The idea of this list is to collect shared data and algorithms around 3D Morphable Models. You are
invited to contribute to this list by adding a pull request. The original list arised from the
Dagstuhl seminar on 3D Morphable Models in March 2019.

## Operational Role

For a systems engineer, 3d-morphable-models/curated-list-of-awesome-3D-Morphable-Model-software-and-
data belongs in the Computer Graphics Software inventory as part of ecosystem capability mapping,
...
- `github_search_computer_graphics_software-3b65138e63ad39` from `github_search_computer_graphics_software` as `registry_expansion`
