...
<!-- canonical: https://cran.r-project.org/web/packages/glmmEP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmmEP/index.html](https://cran.r-project.org/web/packages/glmmEP/index.html) |
| Source record ids | cran_packages_by_date-9899f3904fe73e |
...
For a systems engineer, glmmEP belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-4 | 2026-09-08 02:50:02 UTC | [https://cran.r-project.org/web/packages/glmmEP/DESCRIPTION](https://cran.r-project.org/web/packages/glmmEP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmmEP/DESCRIPTION` at `2026-09-08T03:20:57+00:00`.
...
- `cran_packages_by_date-9899f3904fe73e` from `cran_packages_by_date` as `registry_expansion`
