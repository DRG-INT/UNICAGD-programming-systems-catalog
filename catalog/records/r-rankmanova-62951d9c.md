...
<!-- canonical: https://cran.r-project.org/web/packages/rankMANOVA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rankMANOVA/index.html](https://cran.r-project.org/web/packages/rankMANOVA/index.html) |
| Source record ids | cran_packages_by_date-d077e69e9fea9f |
...
For a systems engineer, rankMANOVA belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-12 08:30:02 UTC | [https://cran.r-project.org/web/packages/rankMANOVA/DESCRIPTION](https://cran.r-project.org/web/packages/rankMANOVA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rankMANOVA/DESCRIPTION` at `2026-09-12T10:18:41+00:00`.
...
- `cran_packages_by_date-d077e69e9fea9f` from `cran_packages_by_date` as `registry_expansion`
