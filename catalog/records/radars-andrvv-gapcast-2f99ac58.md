...
<!-- canonical: https://github.com/ANDRVV/gapcast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ANDRVV/gapcast](https://github.com/ANDRVV/gapcast) |
| Source record ids | github_search_radars-b18fc3c48e6471 |
...
For a systems engineer, ANDRVV/gapcast belongs in the Radars inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.3 | 2024-07-26T14:23:04Z | [https://api.github.com/repos/ANDRVV/gapcast/releases/latest](https://api.github.com/repos/ANDRVV/gapcast/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ANDRVV/gapcast/releases/latest` at `2026-09-01T08:26:28+00:00`.
...
- `github_search_radars-b18fc3c48e6471` from `github_search_radars` as `registry_expansion`
