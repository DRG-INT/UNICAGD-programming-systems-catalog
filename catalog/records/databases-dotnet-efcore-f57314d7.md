...
| Source record ids | github_search_databases-26d1f2d37c102b |

## System Engineer Summary

EF Core is a modern object-database mapper for .NET. It supports LINQ queries, change tracking,
updates, and schema migrations.

## Operational Role

For a systems engineer, dotnet/efcore belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:57:19Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-26d1f2d37c102b` from `github_search_databases` as `registry_expansion`
