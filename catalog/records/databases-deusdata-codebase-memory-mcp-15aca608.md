...
<!-- canonical: https://github.com/DeusData/codebase-memory-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) |
| Source record ids | github_search_databases-b30986d1c3a373 |
...
For a systems engineer, DeusData/codebase-memory-mcp belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T07:35:01Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b30986d1c3a373` from `github_search_databases` as `registry_expansion`
