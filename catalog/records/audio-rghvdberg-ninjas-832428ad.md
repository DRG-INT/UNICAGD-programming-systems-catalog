...
<!-- canonical: https://github.com/rghvdberg/ninjas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rghvdberg/ninjas](https://github.com/rghvdberg/ninjas) |
| Source record ids | github_search_audio-a6aa7445951022 |
...
For a systems engineer, rghvdberg/ninjas belongs in the Audio inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-05T10:25:17Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-a6aa7445951022` from `github_search_audio` as `registry_expansion`
