...
<!-- canonical: https://www.nuget.org/packages/JsonPatch.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonPatch.Net](https://www.nuget.org/packages/JsonPatch.Net) |
| Source record ids | nuget_search-5de2e6af57a42a |
...
For a systems engineer, JsonPatch.Net belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.3 | 2026-06-30T23:47:38.91+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonpatch.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonpatch.net/index.json) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; https://www.nuget.org/packages/JsonPatch.Net/5.0.3/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonpatch.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-5de2e6af57a42a` from `nuget_search` as `registry_expansion`
