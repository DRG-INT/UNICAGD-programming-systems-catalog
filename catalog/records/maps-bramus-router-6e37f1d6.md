...
<!-- canonical: https://github.com/bramus/router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bramus/router](https://github.com/bramus/router) |
| Source record ids | github_search_maps-7ed36761b7a129 |
...
For a systems engineer, bramus/router belongs in the Maps inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-12T19:08:04Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7ed36761b7a129` from `github_search_maps` as `registry_expansion`
