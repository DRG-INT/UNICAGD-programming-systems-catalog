...
| Canonical URL | [https://crates.io/crates/cranelift-bitset](https://crates.io/crates/cranelift-bitset) |
| Source record ids | crates_io-ada7dd5875048b |
...
For a systems engineer, cranelift-bitset belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.135.1 | 2026-08-24T19:57:30.632611Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-ada7dd5875048b` from `crates_io` as `registry_expansion`
