...
<!-- canonical: https://cran.r-project.org/web/packages/clusterv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clusterv/index.html](https://cran.r-project.org/web/packages/clusterv/index.html) |
| Source record ids | cran_packages_by_date-e4c964c39cfcae |
...
For a systems engineer, clusterv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-09-10 17:50:08 UTC | [https://cran.r-project.org/web/packages/clusterv/DESCRIPTION](https://cran.r-project.org/web/packages/clusterv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clusterv/DESCRIPTION` at `2026-09-10T18:21:54+00:00`.
...
- `cran_packages_by_date-e4c964c39cfcae` from `cran_packages_by_date` as `registry_expansion`
