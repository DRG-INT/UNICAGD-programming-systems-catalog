...
<!-- canonical: https://github.com/stackb/rules_proto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stackb/rules_proto](https://github.com/stackb/rules_proto) |
| Source record ids | github_search_starlark-481e4505018e69 |
...
For a systems engineer, stackb/rules_proto belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T16:32:19Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-481e4505018e69` from `github_search_starlark` as `registry_expansion`
