...
<!-- canonical: https://cran.r-project.org/web/packages/competitiontoolbox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/competitiontoolbox/index.html](https://cran.r-project.org/web/packages/competitiontoolbox/index.html) |
| Source record ids | cran_packages_by_date-68a2b24e47af6b |
...
For a systems engineer, competitiontoolbox belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.4 | 2026-08-26 22:50:02 UTC | [https://cran.r-project.org/web/packages/competitiontoolbox/DESCRIPTION](https://cran.r-project.org/web/packages/competitiontoolbox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/competitiontoolbox/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-68a2b24e47af6b` from `cran_packages_by_date` as `registry_expansion`
