...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Linter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/linter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-0420557562fb51 |

## System Engineer Summary

oclint is tracked as a linter record in the C99 branch. The source did not provide a long
...
For a systems engineer, oclint belongs in the C99 inventory as part of static feedback, style
...
- `corpus-0420557562fb51` from `master_json` as `linter`
