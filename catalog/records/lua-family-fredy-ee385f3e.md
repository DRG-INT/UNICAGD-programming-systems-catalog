...
| Canonical URL | [https://luarocks.org/modules/marcosdanielr/fredy](https://luarocks.org/modules/marcosdanielr/fredy) |
| Source record ids | luarocks_root_manifest-efd61154ada670 |

## System Engineer Summary

SQL toolkit and ORM for Lua, powered by Rust (sqlx)

## Operational Role

For a systems engineer, fredy belongs in the Lua family inventory as part of state persistence,
...
- `luarocks_root_manifest-efd61154ada670` from `luarocks_root_manifest` as `registry_expansion`
