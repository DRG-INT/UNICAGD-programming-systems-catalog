...
<!-- canonical: https://hackage.haskell.org/package/hruby -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hruby](https://hackage.haskell.org/package/hruby) |
| Source record ids | hackage_top_downloads-3b2563b08675ea |
...
For a systems engineer, hruby belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1.0 | 2023-11-07T14:29:36Z | [https://hackage.haskell.org/package/hruby](https://hackage.haskell.org/package/hruby) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hruby` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-3b2563b08675ea` from `hackage_top_downloads` as `registry_expansion`
