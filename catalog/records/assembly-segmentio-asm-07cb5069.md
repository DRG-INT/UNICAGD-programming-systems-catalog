...
<!-- canonical: https://github.com/segmentio/asm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/segmentio/asm](https://github.com/segmentio/asm) |
| Source record ids | github_search_assembly-c0a009bf3a8ccd |
...
For a systems engineer, segmentio/asm belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-25T23:26:52Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-c0a009bf3a8ccd` from `github_search_assembly` as `registry_expansion`
