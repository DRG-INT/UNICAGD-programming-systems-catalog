...
<!-- canonical: https://cran.r-project.org/web/packages/skymodelr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/skymodelr/index.html](https://cran.r-project.org/web/packages/skymodelr/index.html) |
| Source record ids | cran_packages_by_date-4c39db2438d912 |

## System Engineer Summary

Generates and Samples Realistic Terrestrial Atmospheres

## Operational Role

For a systems engineer, skymodelr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-09-14 21:50:02 UTC | [https://cran.r-project.org/web/packages/skymodelr/DESCRIPTION](https://cran.r-project.org/web/packages/skymodelr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/skymodelr/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-4c39db2438d912` from `cran_packages_by_date` as `registry_expansion`
