...
<!-- canonical: https://github.com/microsoft/fluentui-system-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/fluentui-system-icons](https://github.com/microsoft/fluentui-system-icons) |
| Source record ids | github_search_icons_and_logos-7a27fb359bc53b |
...
For a systems engineer, microsoft/fluentui-system-icons belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T08:31:59Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7a27fb359bc53b` from `github_search_icons_and_logos` as `registry_expansion`
