...
<!-- canonical: https://cran.r-project.org/web/packages/greenSD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/greenSD/index.html](https://cran.r-project.org/web/packages/greenSD/index.html) |
| Source record ids | cran_packages_by_date-94bfc1f7a9a2c6 |

## System Engineer Summary

Access and Analyze Global GreenSpace Spatial Data

## Operational Role

For a systems engineer, greenSD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-23 03:50:02 UTC | [https://cran.r-project.org/web/packages/greenSD/DESCRIPTION](https://cran.r-project.org/web/packages/greenSD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/greenSD/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-94bfc1f7a9a2c6` from `cran_packages_by_date` as `registry_expansion`
