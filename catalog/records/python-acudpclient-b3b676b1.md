...
<!-- canonical: https://pypi.org/project/acudpclient/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acudpclient/](https://pypi.org/project/acudpclient/) |
| Source record ids | pypi_simple-2124184406f60b |
...
For a systems engineer, acudpclient belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2017-10-07T21:41:02.540141Z | [https://pypi.org/pypi/acudpclient/json](https://pypi.org/pypi/acudpclient/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acudpclient/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-2124184406f60b` from `pypi_simple` as `registry_expansion`
