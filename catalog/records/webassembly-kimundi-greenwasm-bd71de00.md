...
<!-- canonical: https://github.com/Kimundi/greenwasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kimundi/greenwasm](https://github.com/Kimundi/greenwasm) |
| Source record ids | github_search_webassembly-c4294ab91c5765 |
...
For a systems engineer, Kimundi/greenwasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-10T08:27:12Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-c4294ab91c5765` from `github_search_webassembly` as `registry_expansion`
