...
<!-- canonical: https://cran.r-project.org/web/packages/cSEM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cSEM/index.html](https://cran.r-project.org/web/packages/cSEM/index.html) |
| Source record ids | cran_packages_by_date-74d0a1a0307920 |
...
For a systems engineer, cSEM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-09-08 16:10:02 UTC | [https://cran.r-project.org/web/packages/cSEM/DESCRIPTION](https://cran.r-project.org/web/packages/cSEM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cSEM/DESCRIPTION` at `2026-09-08T16:22:20+00:00`.
...
- `cran_packages_by_date-74d0a1a0307920` from `cran_packages_by_date` as `registry_expansion`
