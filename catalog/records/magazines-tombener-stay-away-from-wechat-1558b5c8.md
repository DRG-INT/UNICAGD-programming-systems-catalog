# TomBener/stay-away-from-wechat
...
<!-- canonical: https://github.com/TomBener/stay-away-from-wechat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TomBener/stay-away-from-wechat](https://github.com/TomBener/stay-away-from-wechat) |
| Source record ids | github_search_magazines-be36433353226c |

## System Engineer Summary

TomBener/stay-away-from-wechat is tracked as a library record in the Magazines branch. The source
...
For a systems engineer, TomBener/stay-away-from-wechat belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-02T11:07:14Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-be36433353226c` from `github_search_magazines` as `registry_expansion`
