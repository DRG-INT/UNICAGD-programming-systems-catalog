...
<!-- canonical: https://github.com/james34602/JamesDSPManager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/james34602/JamesDSPManager](https://github.com/james34602/JamesDSPManager) |
| Source record ids | github_search_effects-2dfb7965075af3 |

## System Engineer Summary

Audio DSP effects build on Android system framework layer. This is a repository contains a pack of
high quality DSP algorithms specialized for audio processing.

## Operational Role

For a systems engineer, james34602/JamesDSPManager belongs in the Effects inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-18T14:08:35Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2dfb7965075af3` from `github_search_effects` as `registry_expansion`
