...
<!-- canonical: https://pub.dev/packages/image_gallery_saver_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/image_gallery_saver_plus](https://pub.dev/packages/image_gallery_saver_plus) |
| Source record ids | pub_dev-5b090b00cbd6d2 |

## System Engineer Summary

A Flutter plugin for saving images to the gallery. iOS needs to add the following keys to your
Info.plist file.

## Operational Role

For a systems engineer, image_gallery_saver_plus belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.1 | 2026-07-14T12:35:27.893431Z | [https://pub.dev/api/packages/image_gallery_saver_plus](https://pub.dev/api/packages/image_gallery_saver_plus) |  |
| preview | known | 4.0.0-0.alpha | 2024-11-19T11:51:25.585759Z | [https://pub.dev/api/packages/image_gallery_saver_plus](https://pub.dev/api/packages/image_gallery_saver_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/image_gallery_saver_plus` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-5b090b00cbd6d2` from `pub_dev` as `registry_expansion`
