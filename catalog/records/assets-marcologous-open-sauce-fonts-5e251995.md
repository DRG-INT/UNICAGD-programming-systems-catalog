...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/marcologous/Open-Sauce-Fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marcologous/Open-Sauce-Fonts](https://github.com/marcologous/Open-Sauce-Fonts) |
| Source record ids | github_search_assets-a3e64a44251278 |

## System Engineer Summary

Open Sauce Fonts is a font super family that I developed for Creative Sauce's internal type system.
It is a compact typeface that is optimised for better viewing small text on screen and print. Open
Sauce fonts (Sans, One and Two) are under the SIL Open Font License and is going to be actively
developed, improved and tested.

## Operational Role

For a systems engineer, marcologous/Open-Sauce-Fonts belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T21:22:36Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-a3e64a44251278` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| braver/programmingfonts | Testing Framework | [open](assets-braver-programmingfonts-fb0cf6c0.md) |
| fortitudo-tech/fortitudo.tech | Testing Framework | [open](assets-fortitudo-tech-fortitudo-tech-d827e5a7.md) |
| VanekPetr/investment-funnel | Testing Framework | [open](assets-vanekpetr-investment-funnel-c0d50ba2.md) |
