...
<!-- canonical: https://cran.r-project.org/web/packages/CLRtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CLRtools/index.html](https://cran.r-project.org/web/packages/CLRtools/index.html) |
| Source record ids | cran_packages_by_date-4dd9911ceaf9d7 |
...
For a systems engineer, CLRtools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-21 05:47:01 UTC | [https://cran.r-project.org/web/packages/CLRtools/DESCRIPTION](https://cran.r-project.org/web/packages/CLRtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CLRtools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4dd9911ceaf9d7` from `cran_packages_by_date` as `registry_expansion`
