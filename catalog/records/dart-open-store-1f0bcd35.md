...
<!-- canonical: https://pub.dev/packages/open_store -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/open_store](https://pub.dev/packages/open_store) |
| Source record ids | pub_dev-774cfeb316f1ae |
...
For a systems engineer, open_store belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2022-12-01T04:51:24.374481Z | [https://pub.dev/api/packages/open_store](https://pub.dev/api/packages/open_store) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/open_store` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-774cfeb316f1ae` from `pub_dev` as `registry_expansion`
