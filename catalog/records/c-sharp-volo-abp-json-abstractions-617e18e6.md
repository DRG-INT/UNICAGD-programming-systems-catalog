...
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Json.Abstractions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Json.Abstractions](https://www.nuget.org/packages/Volo.Abp.Json.Abstractions) |
| Source record ids | nuget_search-22dfe66e299baf |

## System Engineer Summary

Volo.Abp.Json.Abstractions is tracked as a project scaffolding record in the C-Sharp branch. The
...
For a systems engineer, Volo.Abp.Json.Abstractions belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:25.197+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.abstractions/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:45.917+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.abstractions/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Json.Abstractions/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.abstractions/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-22dfe66e299baf` from `nuget_search` as `registry_expansion`
