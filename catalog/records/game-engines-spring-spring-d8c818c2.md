...
<!-- canonical: https://github.com/spring/spring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spring/spring](https://github.com/spring/spring) |
| Source record ids | github_search_game_engines-28cf8bbc1cc8d0 |

## System Engineer Summary

A powerful free cross-platform RTS game engine. - Report issues at

## Operational Role

For a systems engineer, spring/spring belongs in the Game Engines inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-31T18:56:50Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-28cf8bbc1cc8d0` from `github_search_game_engines` as `registry_expansion`
...
| egametang/ET | Networking Http | [open](game-engines-egametang-et-bc0fa0fd.md) |
