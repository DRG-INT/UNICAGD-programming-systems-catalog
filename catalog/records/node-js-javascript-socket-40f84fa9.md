...
| Source record ids | corpus-14dbbf7c0cb678 |

## System Engineer Summary

Socket is tracked as a security sast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Socket belongs in the Node.js/JavaScript inventory as part of supply-chain
...
- `corpus-14dbbf7c0cb678` from `master_json` as `security_sast`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| npm audit | Security Sast | [open](node-js-javascript-npm-audit-000bd877.md) |
| Snyk | Security Sast | [open](node-js-javascript-snyk-774d8f96.md) |
