...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Package Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/package-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/lisa0802/ideogram](https://luarocks.org/modules/lisa0802/ideogram) |
| Source record ids | luarocks_root_manifest-0a012855677629 |

## System Engineer Summary

Minimal LuaRocks package for Ideogram tool page metadata.

## Operational Role

For a systems engineer, ideogram belongs in the Lua family inventory as part of dependency
...
| Name | Category | Page |
| --- | --- | --- |
| ai-image-upscaler | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ai-image-upscaler-11d70140.md) |
| background-remover | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-background-remover-d94a6376.md) |
| cargo | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cargo-6c106def.md) |
| command.nvim | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-command-nvim-6cc22083.md) |
| compat53 | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-compat53-74ccefdb.md) |
| copilot3d-org | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-copilot3d-org-b6f8d7b2.md) |
| dummy.lua | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dummy-lua-3b3063cf.md) |
| eagle-lua-package | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-eagle-lua-package-47dc0348.md) |
