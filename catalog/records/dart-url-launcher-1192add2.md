...
<!-- canonical: https://pub.dev/packages/url_launcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/url_launcher](https://pub.dev/packages/url_launcher) |
| Source record ids | pub_dev-b7b5ccde75be72 |
...
For a systems engineer, url_launcher belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.3.2 | 2025-07-10T19:46:46.051934Z | [https://pub.dev/api/packages/url_launcher](https://pub.dev/api/packages/url_launcher) |  |
| preview | known | 6.0.0-nullsafety.7 | 2021-02-17T01:38:10.478562Z | [https://pub.dev/api/packages/url_launcher](https://pub.dev/api/packages/url_launcher) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/url_launcher` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-b7b5ccde75be72` from `pub_dev` as `registry_expansion`
