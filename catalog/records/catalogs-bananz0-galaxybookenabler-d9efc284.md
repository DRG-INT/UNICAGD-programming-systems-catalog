...
<!-- canonical: https://github.com/Bananz0/GalaxyBookEnabler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Bananz0/GalaxyBookEnabler](https://github.com/Bananz0/GalaxyBookEnabler) |
| Source record ids | github_search_catalogs-711e17b6470331 |

## System Engineer Summary

Enable Samsung Galaxy Book features (Quick Share, Multi Control, Samsung Notes, Galaxy Buds) on any
Windows PC. Intelligent installer with 21 device profiles, package manager, Wi-Fi compatibility
detection & automated setup. No hardware required.

## Operational Role

For a systems engineer, Bananz0/GalaxyBookEnabler belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-09T12:37:05Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-711e17b6470331` from `github_search_catalogs` as `registry_expansion`
