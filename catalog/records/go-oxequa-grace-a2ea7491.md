...
<!-- canonical: https://github.com/oxequa/grace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oxequa/grace](https://github.com/oxequa/grace) |
| Source record ids | github_search_go-e4f8c4492bc218 |

## System Engineer Summary

Handle Go recover, panic, and errors in a graceful way. Multiple errors support, basic filters and
custom handlers.

## Operational Role

For a systems engineer, oxequa/grace belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-30T10:16:21Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-e4f8c4492bc218` from `github_search_go` as `registry_expansion`
