...
<!-- canonical: https://pypi.org/project/address-finder-data-p10/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-finder-data-p10/](https://pypi.org/project/address-finder-data-p10/) |
| Source record ids | pypi_simple-175cd163c9a3bd |

## System Engineer Summary

address-finder data chunk p10 - contains address_dictionary.dat part 1/1

## Operational Role

For a systems engineer, address-finder-data-p10 belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-03-20T17:41:16.716183Z | [https://pypi.org/pypi/address-finder-data-p10/json](https://pypi.org/pypi/address-finder-data-p10/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-finder-data-p10/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-175cd163c9a3bd` from `pypi_simple` as `registry_expansion`
