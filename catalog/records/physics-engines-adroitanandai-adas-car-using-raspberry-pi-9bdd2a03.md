...
<!-- canonical: https://github.com/AdroitAnandAI/ADAS-Car-using-Raspberry-Pi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AdroitAnandAI/ADAS-Car-using-Raspberry-Pi](https://github.com/AdroitAnandAI/ADAS-Car-using-Raspberry-Pi) |
| Source record ids | github_search_physics_engines-49a2329863cf96 |

## System Engineer Summary

ADAS Car - with Collision Avoidance System (CAS) - on Indian Roads using LIDAR-Camera Low-Level
Sensor Fusion. DIY Gadget built with Raspberry Pi, RP LIDAR A1, Pi Cam V2, LED SHIM, NCS 2 and
accessories like speaker, power bank etc

## Operational Role

For a systems engineer, AdroitAnandAI/ADAS-Car-using-Raspberry-Pi belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-03T06:25:04Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-49a2329863cf96` from `github_search_physics_engines` as `registry_expansion`
