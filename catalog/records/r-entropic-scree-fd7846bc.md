...
<!-- canonical: https://cran.r-project.org/web/packages/Entropic.Scree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Entropic.Scree/index.html](https://cran.r-project.org/web/packages/Entropic.Scree/index.html) |
| Source record ids | cran_packages_by_date-5fd2acaed5ef54 |

## System Engineer Summary

Information-Theoretic Dimensionality Estimation

## Operational Role

For a systems engineer, Entropic.Scree belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-15 14:00:02 UTC | [https://cran.r-project.org/web/packages/Entropic.Scree/DESCRIPTION](https://cran.r-project.org/web/packages/Entropic.Scree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Entropic.Scree/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-5fd2acaed5ef54` from `cran_packages_by_date` as `registry_expansion`
