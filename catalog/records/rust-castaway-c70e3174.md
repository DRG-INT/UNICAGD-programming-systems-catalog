...
<!-- canonical: https://crates.io/crates/castaway -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/castaway](https://crates.io/crates/castaway) |
| Source record ids | crates_io-60a2907e89e92f |
...
For a systems engineer, castaway belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2025-07-12T16:49:05.343219Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-60a2907e89e92f` from `crates_io` as `registry_expansion`
