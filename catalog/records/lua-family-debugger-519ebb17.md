...
<!-- canonical: https://luarocks.org/modules/3scale/debugger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/3scale/debugger](https://luarocks.org/modules/3scale/debugger) |
| Source record ids | luarocks_root_manifest-19ba6848df7f6a |
...
For a systems engineer, debugger belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-19ba6848df7f6a` from `luarocks_root_manifest` as `registry_expansion`
