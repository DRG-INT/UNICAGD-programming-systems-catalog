...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Type Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/type-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/siffiejoe/annotate](https://luarocks.org/modules/siffiejoe/annotate) |
| Source record ids | luarocks_root_manifest-6a49c92197c786 |
...
For a systems engineer, annotate belongs in the Lua family inventory as part of interface contracts,
migration safety, editor feedback, and large-codebase maintainability.
...
| Name | Category | Page |
| --- | --- | --- |
| better-escape.nvim | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-better-escape-nvim-15c883f5.md) |
| cc-teal | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cc-teal-10ac307d.md) |
| checks | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-checks-3e567ede.md) |
| deimos | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-deimos-107b742d.md) |
| dms | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dms-5c261f7c.md) |
| is | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-is-caf91e0b.md) |
| isa | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-isa-a4e249b9.md) |
