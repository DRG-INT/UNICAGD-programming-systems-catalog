...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/cpge/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cpge/index.html](https://cran.r-project.org/web/packages/cpge/index.html) |
| Source record ids | cran_packages_by_date-b60e308fe0dcb9 |

## System Engineer Summary

Interactive Clustered Graph for French Scientific Preparatory Classes

## Operational Role

For a systems engineer, cpge belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-21 08:50:15 UTC | [https://cran.r-project.org/web/packages/cpge/DESCRIPTION](https://cran.r-project.org/web/packages/cpge/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cpge/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b60e308fe0dcb9` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cudaverse | Math Numeric Scientific | [open](r-cudaverse-559b2677.md) |
| fntl | Math Numeric Scientific | [open](r-fntl-52bd3546.md) |
| gridmicrotex | Math Numeric Scientific | [open](r-gridmicrotex-b9af6165.md) |
| lifecontingencies | Math Numeric Scientific | [open](r-lifecontingencies-352fe6c5.md) |
| MALDIassist | Math Numeric Scientific | [open](r-maldiassist-091914ff.md) |
| nlist | Math Numeric Scientific | [open](r-nlist-178de862.md) |
| numops | Math Numeric Scientific | [open](r-numops-c3aa1a8a.md) |
| schoolmath | Math Numeric Scientific | [open](r-schoolmath-ef4d9089.md) |
