...
| Canonical URL | [https://crates.io/crates/annotate-snippets](https://crates.io/crates/annotate-snippets) |
| Source record ids | crates_io-b2b74b168fa233 |
...
For a systems engineer, annotate-snippets belongs in the Rust inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.16 | 2026-05-06T19:58:20.584705Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-b2b74b168fa233` from `crates_io` as `registry_expansion`
