...
<!-- canonical: https://cran.r-project.org/web/packages/TreeDist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TreeDist/index.html](https://cran.r-project.org/web/packages/TreeDist/index.html) |
| Source record ids | cran_packages_by_date-17313a78e0295d |
...
For a systems engineer, TreeDist belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0 | 2026-09-11 14:40:02 UTC | [https://cran.r-project.org/web/packages/TreeDist/DESCRIPTION](https://cran.r-project.org/web/packages/TreeDist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TreeDist/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-17313a78e0295d` from `cran_packages_by_date` as `registry_expansion`
