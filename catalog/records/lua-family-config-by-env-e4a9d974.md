...
<!-- canonical: https://luarocks.org/modules/dream11/config-by-env -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dream11/config-by-env](https://luarocks.org/modules/dream11/config-by-env) |
| Source record ids | luarocks_root_manifest-aa86c1a958d2a0 |
...
For a systems engineer, config-by-env belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-aa86c1a958d2a0` from `luarocks_root_manifest` as `registry_expansion`
