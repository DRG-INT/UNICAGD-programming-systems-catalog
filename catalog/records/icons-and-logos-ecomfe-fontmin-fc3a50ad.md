...
<!-- canonical: https://github.com/ecomfe/fontmin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ecomfe/fontmin](https://github.com/ecomfe/fontmin) |
| Source record ids | github_search_icons_and_logos-7b4835f565673c |

## System Engineer Summary

ecomfe/fontmin is tracked as a cryptography record in the Icons and Logos branch. The source did not
...
For a systems engineer, ecomfe/fontmin belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-13T07:03:41Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7b4835f565673c` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| spothq/cryptocurrency-icons | Cryptography | [open](icons-and-logos-spothq-cryptocurrency-icons-26d66241.md) |
