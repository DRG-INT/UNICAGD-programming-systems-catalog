...
<!-- canonical: https://luarocks.org/modules/mpeterv/alt-getopt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mpeterv/alt-getopt](https://luarocks.org/modules/mpeterv/alt-getopt) |
| Source record ids | luarocks_root_manifest-4d8b6c76402b28 |
...
For a systems engineer, alt-getopt belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4d8b6c76402b28` from `luarocks_root_manifest` as `registry_expansion`
