...
<!-- canonical: https://pypi.org/project/activitypub-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/activitypub-cli/](https://pypi.org/project/activitypub-cli/) |
| Source record ids | pypi_simple-75ef1a4b87c217 |
...
For a systems engineer, activitypub-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-03-11T02:30:39.445026Z | [https://pypi.org/pypi/activitypub-cli/json](https://pypi.org/pypi/activitypub-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/activitypub-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-75ef1a4b87c217` from `pypi_simple` as `registry_expansion`
