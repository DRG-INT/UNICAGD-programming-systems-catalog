...
<!-- canonical: https://cran.r-project.org/web/packages/eq5d/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/eq5d/index.html](https://cran.r-project.org/web/packages/eq5d/index.html) |
| Source record ids | cran_packages_by_date-8e96ff731683b9 |
...
For a systems engineer, eq5d belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.0 | 2026-08-28 21:20:12 UTC | [https://cran.r-project.org/web/packages/eq5d/DESCRIPTION](https://cran.r-project.org/web/packages/eq5d/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/eq5d/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8e96ff731683b9` from `cran_packages_by_date` as `registry_expansion`
