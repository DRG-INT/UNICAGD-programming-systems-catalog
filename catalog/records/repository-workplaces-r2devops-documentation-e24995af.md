...
<!-- canonical: https://gitlab.com/r2devops/documentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/r2devops/documentation](https://gitlab.com/r2devops/documentation) |
| Source record ids | gitlab_projects_api-09993bb1f4ce9a |

## System Engineer Summary

r2devops/documentation is tracked as a documentation record in the Repository Workplaces branch. The
...
For a systems engineer, r2devops/documentation belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-18T09:52:22.085Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-09993bb1f4ce9a` from `gitlab_projects_api` as `registry_expansion`
