...
<!-- canonical: https://github.com/fperrad/lua-MessagePack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fperrad/lua-MessagePack](https://github.com/fperrad/lua-MessagePack) |
| Source record ids | lua-source-255 |
...
For a systems engineer, lua-MessagePack belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 255}}` |
...
- `lua-source-255` from `master_json` as `source_list_item`
