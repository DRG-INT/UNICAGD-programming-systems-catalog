...
<!-- canonical: https://crates.io/crates/yaml-rust2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/yaml-rust2](https://crates.io/crates/yaml-rust2) |
| Source record ids | crates_io-6b12d034c3c17e |
...
For a systems engineer, yaml-rust2 belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-09-11T00:00:22.447567Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-11T00:27:20+00:00`.
...
- `crates_io-6b12d034c3c17e` from `crates_io` as `registry_expansion`
