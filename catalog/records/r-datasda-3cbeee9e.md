...
<!-- canonical: https://cran.r-project.org/web/packages/dataSDA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dataSDA/index.html](https://cran.r-project.org/web/packages/dataSDA/index.html) |
| Source record ids | cran_packages_by_date-cd84a8368ed331 |
...
For a systems engineer, dataSDA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2026-08-20 11:10:13 UTC | [https://cran.r-project.org/web/packages/dataSDA/DESCRIPTION](https://cran.r-project.org/web/packages/dataSDA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dataSDA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cd84a8368ed331` from `cran_packages_by_date` as `registry_expansion`
