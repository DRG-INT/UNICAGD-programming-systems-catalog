...
| Source record ids | github_search_webassembly-a5a6e2d30a18bc |
...
For a systems engineer, langhuihui/jessibuca belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T01:52:46Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a5a6e2d30a18bc` from `github_search_webassembly` as `registry_expansion`
