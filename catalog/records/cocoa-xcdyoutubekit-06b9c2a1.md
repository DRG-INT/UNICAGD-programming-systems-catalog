...
<!-- canonical: https://github.com/0xced/XCDYouTubeKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/0xced/XCDYouTubeKit](https://github.com/0xced/XCDYouTubeKit) |
| Source record ids | awesome_list-f74c17d95a1f6e |
...
For a systems engineer, XCDYouTubeKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.2 | 2020-12-08T20:28:58Z | [https://api.github.com/repos/0xced/XCDYouTubeKit/releases/latest](https://api.github.com/repos/0xced/XCDYouTubeKit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/0xced/XCDYouTubeKit/releases/latest` at `2026-09-01T07:24:07+00:00`.
...
- `awesome_list-f74c17d95a1f6e` from `awesome_list` as `registry_expansion`
