...
<!-- canonical: https://packagist.org/packages/fileeye/mimemap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/fileeye/mimemap](https://packagist.org/packages/fileeye/mimemap) |
| Source record ids | packagist_search-bf8a1af7ad689a |
...
For a systems engineer, fileeye/mimemap belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-bf8a1af7ad689a` from `packagist_search` as `registry_expansion`
