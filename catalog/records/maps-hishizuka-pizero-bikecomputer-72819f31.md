...
<!-- canonical: https://github.com/hishizuka/pizero_bikecomputer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hishizuka/pizero_bikecomputer](https://github.com/hishizuka/pizero_bikecomputer) |
| Source record ids | github_search_maps-3555d48735278f |

## System Engineer Summary

An open-source bike computer with GPS and ANT+ capabilities, based on the Raspberry Pi Zero (W, WH,
2 W) or the Compute Module Zero (CM0). It also includes offline maps and navigation.

## Operational Role

For a systems engineer, hishizuka/pizero_bikecomputer belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:20:58Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-3555d48735278f` from `github_search_maps` as `registry_expansion`
