# antoninadert/Radio-Garden-Client
...
| Canonical URL | [https://github.com/antoninadert/Radio-Garden-Client](https://github.com/antoninadert/Radio-Garden-Client) |
| Source record ids | curated_language_routes-b3f93c1aa4394c |

## System Engineer Summary

MIT Android WebView client route for Radio Garden; useful when testing APK-style wrapper paths.

## Operational Role

For a systems engineer, antoninadert/Radio-Garden-Client belongs in the Radio Garden Speciality
...
- `curated_language_routes-b3f93c1aa4394c` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| BttrDrgn/radio.garten | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-bttrdrgn-radio-garten-7f0c130c.md) |
