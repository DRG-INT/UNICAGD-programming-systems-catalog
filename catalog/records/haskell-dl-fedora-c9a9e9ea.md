...
<!-- canonical: https://hackage.haskell.org/package/dl-fedora -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dl-fedora](https://hackage.haskell.org/package/dl-fedora) |
| Source record ids | hackage_top_downloads-fce87ca3263390 |
...
For a systems engineer, dl-fedora belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2 | 2025-12-16T15:51:34Z | [https://hackage.haskell.org/package/dl-fedora](https://hackage.haskell.org/package/dl-fedora) |  |
| candidate | partial | 0.5 |  | [https://hackage.haskell.org/package/dl-fedora](https://hackage.haskell.org/package/dl-fedora) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dl-fedora` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-fce87ca3263390` from `hackage_top_downloads` as `registry_expansion`
