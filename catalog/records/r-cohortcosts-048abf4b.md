...
<!-- canonical: https://cran.r-project.org/web/packages/CohortCosts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CohortCosts/index.html](https://cran.r-project.org/web/packages/CohortCosts/index.html) |
| Source record ids | cran_packages_by_date-230fc0631c1a1d |

## System Engineer Summary

Direct Medical Cost Extraction and Health Economics Costing on OMOP CDM

## Operational Role

For a systems engineer, CohortCosts belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-30 09:00:07 UTC | [https://cran.r-project.org/web/packages/CohortCosts/DESCRIPTION](https://cran.r-project.org/web/packages/CohortCosts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CohortCosts/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-230fc0631c1a1d` from `cran_packages_by_date` as `registry_expansion`
