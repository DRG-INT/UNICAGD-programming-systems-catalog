...
<!-- canonical: https://crates.io/crates/clap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/clap](https://crates.io/crates/clap) |
| Source record ids | crates_io-55d59def9860b4 |
...
For a systems engineer, clap belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.6.6 | 2026-08-06T14:03:25.998957Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-55d59def9860b4` from `crates_io` as `registry_expansion`
