...
| Canonical URL | [https://luarocks.org/modules/kong/kong-luasec](https://luarocks.org/modules/kong/kong-luasec) |
| Source record ids | luarocks_root_manifest-3aa743155f4bd8 |
...
For a systems engineer, Kong-LuaSec belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3aa743155f4bd8` from `luarocks_root_manifest` as `registry_expansion`
