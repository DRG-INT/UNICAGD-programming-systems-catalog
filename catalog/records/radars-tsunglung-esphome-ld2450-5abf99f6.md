...
<!-- canonical: https://github.com/tsunglung/esphome-ld2450 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tsunglung/esphome-ld2450](https://github.com/tsunglung/esphome-ld2450) |
| Source record ids | github_search_radars-e0b10bfe7fb3eb |
...
For a systems engineer, tsunglung/esphome-ld2450 belongs in the Radars inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-07T07:41:46Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e0b10bfe7fb3eb` from `github_search_radars` as `registry_expansion`
