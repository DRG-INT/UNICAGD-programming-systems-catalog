...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CausalELM](https://github.com/JuliaRegistries/General/tree/master/C/CausalELM) |
| Source record ids | julia_general-6a1ae1a5a9f48a |

## System Engineer Summary

Julia package registered in General at C/CausalELM.

## Operational Role

For a systems engineer, CausalELM belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CausalELM", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-6a1ae1a5a9f48a` from `julia_general` as `registry_expansion`
