...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/coronalabs/corona -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coronalabs/corona](https://github.com/coronalabs/corona) |
| Source record ids | github_search_engines-5e253f7cb0f35f |
...
For a systems engineer, coronalabs/corona belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T20:33:31Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-5e253f7cb0f35f` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bkaradzic/bgfx | Filesystem Os | [open](engines-bkaradzic-bgfx-8a240dc1.md) |
| BlindMindStudios/StarRuler2-Source | Filesystem Os | [open](engines-blindmindstudios-starruler2-source-7a168908.md) |
| BobLChen/VulkanDemos | Filesystem Os | [open](engines-boblchen-vulkandemos-099f66de.md) |
| Budibase/budibase | Filesystem Os | [open](engines-budibase-budibase-6d86514f.md) |
| conductor-oss/conductor | Filesystem Os | [open](engines-conductor-oss-conductor-565c2282.md) |
| gameplay3d/gameplay | Filesystem Os | [open](engines-gameplay3d-gameplay-6dd44502.md) |
| gongminmin/KlayGE | Filesystem Os | [open](engines-gongminmin-klayge-034618e4.md) |
| jkuhlmann/gainput | Filesystem Os | [open](engines-jkuhlmann-gainput-00a0e49a.md) |
