...
<!-- canonical: https://luarocks.org/modules/desvelao/chalk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/desvelao/chalk](https://luarocks.org/modules/desvelao/chalk) |
| Source record ids | luarocks_root_manifest-e9f11b3050a678 |
...
For a systems engineer, chalk belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e9f11b3050a678` from `luarocks_root_manifest` as `registry_expansion`
