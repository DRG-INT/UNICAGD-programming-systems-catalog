...
<!-- canonical: https://pypi.org/project/abstract-framehub-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abstract-framehub-client/](https://pypi.org/project/abstract-framehub-client/) |
| Source record ids | pypi_simple-32eaaacab8a369 |
...
For a systems engineer, abstract-framehub-client belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2025-05-25T13:26:33.950219Z | [https://pypi.org/pypi/abstract-framehub-client/json](https://pypi.org/pypi/abstract-framehub-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abstract-framehub-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-32eaaacab8a369` from `pypi_simple` as `registry_expansion`
