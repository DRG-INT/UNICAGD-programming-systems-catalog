...
<!-- canonical: https://github.com/CGRU/cgru -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CGRU/cgru](https://github.com/CGRU/cgru) |
| Source record ids | github_search_effects-d051b3afb9fa3f |

## System Engineer Summary

CGRU/cgru is tracked as a library record in the Effects branch. The source did not provide a long
...
For a systems engineer, CGRU/cgru belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:16:10Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d051b3afb9fa3f` from `github_search_effects` as `registry_expansion`
