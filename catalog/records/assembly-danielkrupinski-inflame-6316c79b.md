...
<!-- canonical: https://github.com/danielkrupinski/Inflame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danielkrupinski/Inflame](https://github.com/danielkrupinski/Inflame) |
| Source record ids | github_search_assembly-15118297c76261 |
...
For a systems engineer, danielkrupinski/Inflame belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-29T19:31:47Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-15118297c76261` from `github_search_assembly` as `registry_expansion`
