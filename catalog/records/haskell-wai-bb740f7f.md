...
<!-- canonical: https://hackage.haskell.org/package/wai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wai](https://hackage.haskell.org/package/wai) |
| Source record ids | hackage_top_downloads-9e4ae033a5db19 |
...
For a systems engineer, wai belongs in the Haskell inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.5 | 2026-08-07T11:51:23Z | [https://hackage.haskell.org/package/wai](https://hackage.haskell.org/package/wai) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wai` at `2026-09-01T14:24:37+00:00`.
...
- `hackage_top_downloads-9e4ae033a5db19` from `hackage_top_downloads` as `registry_expansion`
