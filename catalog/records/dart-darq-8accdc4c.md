...
<!-- canonical: https://pub.dev/packages/darq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/darq](https://pub.dev/packages/darq) |
| Source record ids | pub_dev-0e57a6f0daed26 |

## System Engineer Summary

The power of lazy-evaluated enumerables in your hands! (A port of functional LINQ from the .NET
library.)

## Operational Role

For a systems engineer, darq belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2025-08-25T19:07:22.941857Z | [https://pub.dev/api/packages/darq](https://pub.dev/api/packages/darq) |  |
| preview | known | 1.0.0-dev.3 | 2021-03-12T22:52:55.856542Z | [https://pub.dev/api/packages/darq](https://pub.dev/api/packages/darq) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/darq` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-0e57a6f0daed26` from `pub_dev` as `registry_expansion`
