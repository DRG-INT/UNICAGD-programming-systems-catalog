...
<!-- canonical: https://cran.r-project.org/web/packages/TKCat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TKCat/index.html](https://cran.r-project.org/web/packages/TKCat/index.html) |
| Source record ids | cran_packages_by_date-30ff2348918348 |
...
For a systems engineer, TKCat belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-08-20 13:02:12 UTC | [https://cran.r-project.org/web/packages/TKCat/DESCRIPTION](https://cran.r-project.org/web/packages/TKCat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TKCat/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-30ff2348918348` from `cran_packages_by_date` as `registry_expansion`
