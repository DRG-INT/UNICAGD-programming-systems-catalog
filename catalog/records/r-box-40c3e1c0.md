...
<!-- canonical: https://cran.r-project.org/web/packages/box/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/box/index.html](https://cran.r-project.org/web/packages/box/index.html) |
| Source record ids | cran_packages_by_date-ba3630c5da2aed |
...
For a systems engineer, box belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-08-20 05:23:36 UTC | [https://cran.r-project.org/web/packages/box/DESCRIPTION](https://cran.r-project.org/web/packages/box/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/box/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ba3630c5da2aed` from `cran_packages_by_date` as `registry_expansion`
