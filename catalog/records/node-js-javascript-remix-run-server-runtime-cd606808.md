...
<!-- canonical: https://www.npmjs.com/package/@remix-run/server-runtime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@remix-run/server-runtime](https://www.npmjs.com/package/@remix-run/server-runtime) |
| Source record ids | npm_registry-54298a33f7101a |
...
For a systems engineer, @remix-run/server-runtime belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.17.5 | 2026-06-01T14:45:38.795Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-54298a33f7101a` from `npm_registry` as `registry_expansion`
