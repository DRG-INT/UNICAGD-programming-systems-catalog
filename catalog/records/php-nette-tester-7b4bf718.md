...
<!-- canonical: https://packagist.org/packages/nette/tester -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nette/tester](https://packagist.org/packages/nette/tester) |
| Source record ids | packagist_search-3bcccdc0e146b7 |
...
For a systems engineer, nette/tester belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-3bcccdc0e146b7` from `packagist_search` as `registry_expansion`
