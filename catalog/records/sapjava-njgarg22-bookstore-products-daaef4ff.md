...
<!-- canonical: https://github.com/njgarg22/bookstore-products -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/njgarg22/bookstore-products](https://github.com/njgarg22/bookstore-products) |
| Source record ids | github_search_sapjava-85f59b574fb3ec |

## System Engineer Summary

Build a business application using SAP Cloud Application Programming Model (CAP) for Java.

## Operational Role

For a systems engineer, njgarg22/bookstore-products belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-17T19:47:24Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-85f59b574fb3ec` from `github_search_sapjava` as `registry_expansion`
