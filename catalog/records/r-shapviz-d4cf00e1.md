...
<!-- canonical: https://cran.r-project.org/web/packages/shapviz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shapviz/index.html](https://cran.r-project.org/web/packages/shapviz/index.html) |
| Source record ids | cran_packages_by_date-4a0b364fd6458f |

## System Engineer Summary

shapviz is tracked as a visualization gui record in the R branch. The source did not provide a long
...
For a systems engineer, shapviz belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.4 | 2026-08-31 15:10:02 UTC | [https://cran.r-project.org/web/packages/shapviz/DESCRIPTION](https://cran.r-project.org/web/packages/shapviz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shapviz/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4a0b364fd6458f` from `cran_packages_by_date` as `registry_expansion`
