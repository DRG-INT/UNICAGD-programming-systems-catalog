# rcsc-group/LiquidBridge2D

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rcsc-group/LiquidBridge2D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rcsc-group/LiquidBridge2D](https://github.com/rcsc-group/LiquidBridge2D) |
| Source record ids | github_search_basilisk-6b8f353c9b418e |

## System Engineer Summary

Open-source software repository (based on Basilisk C) for the simulation of liquid film flow
dynamics and bridge formation around two cylindrical rods, supporting collaborative work with
colleagues at Loughborough University. Complements the preprint available at

## Operational Role

For a systems engineer, rcsc-group/LiquidBridge2D belongs in the Basilisk inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T13:16:23Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-6b8f353c9b418e` from `github_search_basilisk` as `registry_expansion`
