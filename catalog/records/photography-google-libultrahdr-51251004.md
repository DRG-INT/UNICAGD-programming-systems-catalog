...
<!-- canonical: https://github.com/google/libultrahdr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/google/libultrahdr](https://github.com/google/libultrahdr) |
| Source record ids | github_search_photography-53696bbfdc4cb7 |

## System Engineer Summary

Ultra HDR is a true HDR image format, and is backcompatible. libultrahdr is the reference codec for
the Ultra HDR format. The codecs that support the format can render the HDR intent of the image on
HDR displays; other codecs can still decode and display the SDR intent of the image.

## Operational Role

For a systems engineer, google/libultrahdr belongs in the Photography inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T20:45:54Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-53696bbfdc4cb7` from `github_search_photography` as `registry_expansion`
