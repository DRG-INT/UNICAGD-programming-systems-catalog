...
<!-- canonical: https://pub.dev/packages/json_annotation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/json_annotation](https://pub.dev/packages/json_annotation) |
| Source record ids | pub_dev-7458f40de5352b |
...
For a systems engineer, json_annotation belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.12.0 | 2026-05-15T18:27:32.045501Z | [https://pub.dev/api/packages/json_annotation](https://pub.dev/api/packages/json_annotation) |  |
| preview | known | 4.4.0-beta.0 | 2021-12-01T01:10:20.511865Z | [https://pub.dev/api/packages/json_annotation](https://pub.dev/api/packages/json_annotation) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/json_annotation` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-7458f40de5352b` from `pub_dev` as `registry_expansion`
