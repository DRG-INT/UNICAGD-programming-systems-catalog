...
<!-- canonical: https://cran.r-project.org/web/packages/typetracer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/typetracer/index.html](https://cran.r-project.org/web/packages/typetracer/index.html) |
| Source record ids | cran_packages_by_date-f706dd409c603d |
...
For a systems engineer, typetracer belongs in the R inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-27 13:00:02 UTC | [https://cran.r-project.org/web/packages/typetracer/DESCRIPTION](https://cran.r-project.org/web/packages/typetracer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/typetracer/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f706dd409c603d` from `cran_packages_by_date` as `registry_expansion`
