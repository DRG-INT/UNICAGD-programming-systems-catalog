...
| Canonical URL | [https://luarocks.org/modules/fsantanna/iuplua-im](https://luarocks.org/modules/fsantanna/iuplua-im) |
| Source record ids | luarocks_root_manifest-cc97f4092ce1de |

## System Engineer Summary

IM (Image) binding for Lua (Tecgraf/PUC-Rio)

## Operational Role

For a systems engineer, iuplua-im belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-cc97f4092ce1de` from `luarocks_root_manifest` as `registry_expansion`
