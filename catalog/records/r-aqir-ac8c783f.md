...
<!-- canonical: https://cran.r-project.org/web/packages/AQIR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AQIR/index.html](https://cran.r-project.org/web/packages/AQIR/index.html) |
| Source record ids | cran_packages_by_date-379511962c081d |
...
For a systems engineer, AQIR belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:40:35 UTC | [https://cran.r-project.org/web/packages/AQIR/DESCRIPTION](https://cran.r-project.org/web/packages/AQIR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AQIR/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-379511962c081d` from `cran_packages_by_date` as `registry_expansion`
