# christian-posta/envoy-microservices-patterns

## Navigation

[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/christian-posta/envoy-microservices-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/christian-posta/envoy-microservices-patterns](https://github.com/christian-posta/envoy-microservices-patterns) |
| Source record ids | github_search_pattern_language-2d245d8f4bd669 |
...
For a systems engineer, christian-posta/envoy-microservices-patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-06-04T01:00:56Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-2d245d8f4bd669` from `github_search_pattern_language` as `registry_expansion`
