...
<!-- canonical: https://cran.r-project.org/web/packages/geosmooth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geosmooth/index.html](https://cran.r-project.org/web/packages/geosmooth/index.html) |
| Source record ids | cran_packages_by_date-91aaa226f8d678 |

## System Engineer Summary

Geometric Smoothing and Conditional Expectation Methods

## Operational Role

For a systems engineer, geosmooth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:10:10 UTC | [https://cran.r-project.org/web/packages/geosmooth/DESCRIPTION](https://cran.r-project.org/web/packages/geosmooth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geosmooth/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-91aaa226f8d678` from `cran_packages_by_date` as `registry_expansion`
