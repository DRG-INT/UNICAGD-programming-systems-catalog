...
<!-- canonical: https://pub.dev/packages/firebase_analytics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/firebase_analytics](https://pub.dev/packages/firebase_analytics) |
| Source record ids | pub_dev-a59ab065f97198 |

## System Engineer Summary

Flutter plugin for Google Analytics for Firebase, an app measurement solution that provides insight
on app usage and user engagement on Android and iOS.

## Operational Role

For a systems engineer, firebase_analytics belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 12.5.0 | 2026-08-24T13:42:59.274507Z | [https://pub.dev/api/packages/firebase_analytics](https://pub.dev/api/packages/firebase_analytics) |  |
| preview | known | 9.0.0-dev.5 | 2021-12-07T23:10:41.597936Z | [https://pub.dev/api/packages/firebase_analytics](https://pub.dev/api/packages/firebase_analytics) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/firebase_analytics` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-a59ab065f97198` from `pub_dev` as `registry_expansion`
