...
<!-- canonical: https://cran.r-project.org/web/packages/stbl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stbl/index.html](https://cran.r-project.org/web/packages/stbl/index.html) |
| Source record ids | cran_packages_by_date-02a699ec7a9ccf |

## System Engineer Summary

stbl is tracked as an api abi checker record in the R branch. The source did not provide a long
...
For a systems engineer, stbl belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-13 16:20:02 UTC | [https://cran.r-project.org/web/packages/stbl/DESCRIPTION](https://cran.r-project.org/web/packages/stbl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stbl/DESCRIPTION` at `2026-09-13T18:21:36+00:00`.
...
- `cran_packages_by_date-02a699ec7a9ccf` from `cran_packages_by_date` as `registry_expansion`
