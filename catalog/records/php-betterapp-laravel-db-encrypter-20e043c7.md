...
<!-- canonical: https://packagist.org/packages/betterapp/laravel-db-encrypter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/betterapp/laravel-db-encrypter](https://packagist.org/packages/betterapp/laravel-db-encrypter) |
| Source record ids | packagist_search-51cc73b53840c7 |
...
For a systems engineer, betterapp/laravel-db-encrypter belongs in the PHP inventory as part of
...
- `packagist_search-51cc73b53840c7` from `packagist_search` as `registry_expansion`
