...
<!-- canonical: https://crates.io/crates/proc-macro-error -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/proc-macro-error](https://crates.io/crates/proc-macro-error) |
| Source record ids | crates_io-174d97d89b3ecb |
...
For a systems engineer, proc-macro-error belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2020-07-31T18:08:20.096247Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-174d97d89b3ecb` from `crates_io` as `registry_expansion`
