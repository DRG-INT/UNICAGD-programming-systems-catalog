...
<!-- canonical: https://cran.r-project.org/web/packages/autotest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autotest/index.html](https://cran.r-project.org/web/packages/autotest/index.html) |
| Source record ids | cran_packages_by_date-7d022ca83063b1 |
...
For a systems engineer, autotest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-12 13:10:09 UTC | [https://cran.r-project.org/web/packages/autotest/DESCRIPTION](https://cran.r-project.org/web/packages/autotest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autotest/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-7d022ca83063b1` from `cran_packages_by_date` as `registry_expansion`
