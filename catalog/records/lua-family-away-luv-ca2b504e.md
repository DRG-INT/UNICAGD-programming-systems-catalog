...
<!-- canonical: https://luarocks.org/modules/thislight/away-luv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thislight/away-luv](https://luarocks.org/modules/thislight/away-luv) |
| Source record ids | luarocks_root_manifest-40ab70d3018d43 |

## System Engineer Summary

away-luv is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, away-luv belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-40ab70d3018d43` from `luarocks_root_manifest` as `registry_expansion`
