...
<!-- canonical: https://cran.r-project.org/web/packages/rtdists/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rtdists/index.html](https://cran.r-project.org/web/packages/rtdists/index.html) |
| Source record ids | cran_packages_by_date-96c1dc410646d5 |
...
For a systems engineer, rtdists belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12-0 | 2026-09-09 08:00:02 UTC | [https://cran.r-project.org/web/packages/rtdists/DESCRIPTION](https://cran.r-project.org/web/packages/rtdists/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rtdists/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-96c1dc410646d5` from `cran_packages_by_date` as `registry_expansion`
