...
<!-- canonical: https://cran.r-project.org/web/packages/vecmatch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vecmatch/index.html](https://cran.r-project.org/web/packages/vecmatch/index.html) |
| Source record ids | cran_packages_by_date-0a10fcd62ab2e0 |
...
For a systems engineer, vecmatch belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-09-08 18:10:03 UTC | [https://cran.r-project.org/web/packages/vecmatch/DESCRIPTION](https://cran.r-project.org/web/packages/vecmatch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vecmatch/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-0a10fcd62ab2e0` from `cran_packages_by_date` as `registry_expansion`
