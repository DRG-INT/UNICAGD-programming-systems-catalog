...
<!-- canonical: https://cran.r-project.org/web/packages/httr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/httr/index.html](https://cran.r-project.org/web/packages/httr/index.html) |
| Source record ids | cran_packages_by_date-e46d4d4798e3f4 |
...
For a systems engineer, httr belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.9 | 2026-09-01 13:20:02 UTC | [https://cran.r-project.org/web/packages/httr/DESCRIPTION](https://cran.r-project.org/web/packages/httr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/httr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e46d4d4798e3f4` from `cran_packages_by_date` as `registry_expansion`
