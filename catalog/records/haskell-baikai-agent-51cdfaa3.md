...
<!-- canonical: https://hackage.haskell.org/package/baikai-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai-agent](https://hackage.haskell.org/package/baikai-agent) |
| Source record ids | hackage_recent-6d7aceee949008 |
...
For a systems engineer, baikai-agent belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.1 | 2026-09-08T14:58:50Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-6d7aceee949008` from `hackage_recent` as `registry_expansion`
