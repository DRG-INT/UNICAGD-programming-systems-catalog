...
<!-- canonical: https://github.com/JLospinoso/gargoyle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JLospinoso/gargoyle](https://github.com/JLospinoso/gargoyle) |
| Source record ids | github_search_assembly-1d0a21fe634f3d |

## System Engineer Summary

Historical Windows temporal memory-state research artifact for studying time-bound memory
observations, validation limits, and defensive visibility.

## Operational Role

For a systems engineer, JLospinoso/gargoyle belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-15T01:58:49Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_assembly-1d0a21fe634f3d` from `github_search_assembly` as `registry_expansion`
