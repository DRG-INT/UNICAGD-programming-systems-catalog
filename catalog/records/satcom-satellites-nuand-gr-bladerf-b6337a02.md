...
<!-- canonical: https://github.com/Nuand/gr-bladeRF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Nuand/gr-bladeRF](https://github.com/Nuand/gr-bladeRF) |
| Source record ids | github_search_satcom_satellites-32f85f43675a36 |
...
For a systems engineer, Nuand/gr-bladeRF belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-13T18:56:07Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-32f85f43675a36` from `github_search_satcom_satellites` as `registry_expansion`
