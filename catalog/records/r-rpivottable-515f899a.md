...
<!-- canonical: https://cran.r-project.org/web/packages/rpivotTable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rpivotTable/index.html](https://cran.r-project.org/web/packages/rpivotTable/index.html) |
| Source record ids | cran_packages_by_date-872dc47db4d4f5 |
...
For a systems engineer, rpivotTable belongs in the R inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-24 18:50:10 UTC | [https://cran.r-project.org/web/packages/rpivotTable/DESCRIPTION](https://cran.r-project.org/web/packages/rpivotTable/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rpivotTable/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-872dc47db4d4f5` from `cran_packages_by_date` as `registry_expansion`
