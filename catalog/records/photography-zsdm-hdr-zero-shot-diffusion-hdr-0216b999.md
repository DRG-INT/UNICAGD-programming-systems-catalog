# ZSDM-HDR/Zero-Shot-Diffusion-HDR
...
<!-- canonical: https://github.com/ZSDM-HDR/Zero-Shot-Diffusion-HDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZSDM-HDR/Zero-Shot-Diffusion-HDR](https://github.com/ZSDM-HDR/Zero-Shot-Diffusion-HDR) |
| Source record ids | github_search_photography-c8ba9bdca4a5af |

## System Engineer Summary

CVPR2024 Highlight Poster Zero-Shot Structure-Preserving Diffusion Model for High Dynamic Range Tone
Mapping

## Operational Role

For a systems engineer, ZSDM-HDR/Zero-Shot-Diffusion-HDR belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-25T07:36:28Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c8ba9bdca4a5af` from `github_search_photography` as `registry_expansion`
