...
<!-- canonical: https://github.com/kevinraymond/fosfora -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kevinraymond/fosfora](https://github.com/kevinraymond/fosfora) |
| Source record ids | github_search_effects-baa47fb5f62983 |

## System Engineer Summary

Free, open-source real-time audio & music visualizer / VJ engine, with audio-reactive GPU shaders,
particles, and layer compositing, driven by WGSL and controlled with MIDI, OSC, or your phone.
Cross-platform (Vulkan/Metal), with NDI, Spout, Syphon, and virtual-camera output.

## Operational Role

For a systems engineer, kevinraymond/fosfora belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T18:06:30Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-baa47fb5f62983` from `github_search_effects` as `registry_expansion`
