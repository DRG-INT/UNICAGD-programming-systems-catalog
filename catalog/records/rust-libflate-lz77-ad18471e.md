...
| Canonical URL | [https://crates.io/crates/libflate_lz77](https://crates.io/crates/libflate_lz77) |
| Source record ids | crates_io-af10a6aa32f76b |
...
For a systems engineer, libflate_lz77 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-04-16T22:46:34.210436Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-af10a6aa32f76b` from `crates_io` as `registry_expansion`
