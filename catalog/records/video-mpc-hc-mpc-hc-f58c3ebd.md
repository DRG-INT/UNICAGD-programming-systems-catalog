...
| Canonical URL | [https://github.com/mpc-hc/mpc-hc](https://github.com/mpc-hc/mpc-hc) |
| Source record ids | github_search_video-805c968fa4f2f1 |
...
For a systems engineer, mpc-hc/mpc-hc belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.13 | 2020-05-07T12:23:35Z | [https://api.github.com/repos/mpc-hc/mpc-hc/releases/latest](https://api.github.com/repos/mpc-hc/mpc-hc/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mpc-hc/mpc-hc/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-805c968fa4f2f1` from `github_search_video` as `registry_expansion`
