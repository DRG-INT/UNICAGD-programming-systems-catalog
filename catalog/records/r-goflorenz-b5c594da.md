...
<!-- canonical: https://cran.r-project.org/web/packages/gofLorenz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gofLorenz/index.html](https://cran.r-project.org/web/packages/gofLorenz/index.html) |
| Source record ids | cran_packages_by_date-56d1b94a982958 |

## System Engineer Summary

Goodness-of-Fit Tests for Location-Scale Distributions via Lorenz Curve

## Operational Role

For a systems engineer, gofLorenz belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:20:02 UTC | [https://cran.r-project.org/web/packages/gofLorenz/DESCRIPTION](https://cran.r-project.org/web/packages/gofLorenz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gofLorenz/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-56d1b94a982958` from `cran_packages_by_date` as `registry_expansion`
