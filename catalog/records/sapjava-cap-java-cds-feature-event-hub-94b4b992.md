# cap-java/cds-feature-event-hub
...
<!-- canonical: https://github.com/cap-java/cds-feature-event-hub -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cap-java/cds-feature-event-hub](https://github.com/cap-java/cds-feature-event-hub) |
| Source record ids | github_search_sapjava-e266624ffc2585 |
...
For a systems engineer, cap-java/cds-feature-event-hub belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-03-09T10:51:12Z | [https://api.github.com/repos/cap-java/cds-feature-event-hub/releases/latest](https://api.github.com/repos/cap-java/cds-feature-event-hub/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cap-java/cds-feature-event-hub/releases/latest` at `2026-09-01T10:25:33+00:00`.
...
- `github_search_sapjava-e266624ffc2585` from `github_search_sapjava` as `registry_expansion`
