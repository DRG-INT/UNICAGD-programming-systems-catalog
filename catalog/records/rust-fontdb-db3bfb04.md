...
| Canonical URL | [https://crates.io/crates/fontdb](https://crates.io/crates/fontdb) |
| Source record ids | crates_io-68b6ff2039c865 |
...
For a systems engineer, fontdb belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0 | 2026-07-29T18:12:54.329508Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-68b6ff2039c865` from `crates_io` as `registry_expansion`
