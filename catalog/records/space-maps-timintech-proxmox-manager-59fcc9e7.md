...
<!-- canonical: https://github.com/TimInTech/proxmox-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TimInTech/proxmox-manager](https://github.com/TimInTech/proxmox-manager) |
| Source record ids | github_search_space_maps-6eafb7d9ff868c |

## System Engineer Summary

Proxmox VM/CT Management Tool – A robust Bash TUI for managing Proxmox virtual machines and
containers. Features include listing, status, start/stop/restart, snapshot management, console
access, SPICE integration, and permission checks.

## Operational Role

For a systems engineer, TimInTech/proxmox-manager belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T23:16:30Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-6eafb7d9ff868c` from `github_search_space_maps` as `registry_expansion`
