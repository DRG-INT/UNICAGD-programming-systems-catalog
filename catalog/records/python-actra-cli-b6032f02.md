...
<!-- canonical: https://pypi.org/project/actra-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actra-cli/](https://pypi.org/project/actra-cli/) |
| Source record ids | pypi_simple-7daf79041547a4 |
...
For a systems engineer, actra-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-03-09T10:32:26.350450Z | [https://pypi.org/pypi/actra-cli/json](https://pypi.org/pypi/actra-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actra-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-7daf79041547a4` from `pypi_simple` as `registry_expansion`
