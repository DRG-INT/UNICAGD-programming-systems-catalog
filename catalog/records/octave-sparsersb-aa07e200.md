...
<!-- canonical: https://gnu-octave.github.io/packages/sparsersb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/sparsersb](https://gnu-octave.github.io/packages/sparsersb) |
| Source record ids | octave_packages_index-814de09ad9b415 |

## System Engineer Summary

Interface to the librsb package implementing the RSB sparse matrix format for fast shared-memory
sparse matrix computations.

## Operational Role

For a systems engineer, sparsersb belongs in the Octave inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9 | 2021-09-21 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-814de09ad9b415` from `octave_packages_index` as `registry_expansion`
