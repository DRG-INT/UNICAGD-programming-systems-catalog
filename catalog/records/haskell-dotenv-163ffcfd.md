...
<!-- canonical: https://hackage.haskell.org/package/dotenv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dotenv](https://hackage.haskell.org/package/dotenv) |
| Source record ids | hackage_top_downloads-9b6b68dddb08b3 |
...
For a systems engineer, dotenv belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0.0 | 2024-02-03T02:14:29Z | [https://hackage.haskell.org/package/dotenv](https://hackage.haskell.org/package/dotenv) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dotenv` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-9b6b68dddb08b3` from `hackage_top_downloads` as `registry_expansion`
