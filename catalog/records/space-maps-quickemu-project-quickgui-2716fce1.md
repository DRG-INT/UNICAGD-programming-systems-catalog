...
<!-- canonical: https://github.com/quickemu-project/quickgui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/quickemu-project/quickgui](https://github.com/quickemu-project/quickgui) |
| Source record ids | github_search_space_maps-8da5028b1b74bb |
...
For a systems engineer, quickemu-project/quickgui belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T17:41:01Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8da5028b1b74bb` from `github_search_space_maps` as `registry_expansion`
