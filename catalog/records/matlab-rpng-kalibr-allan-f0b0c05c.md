...
<!-- canonical: https://github.com/rpng/kalibr_allan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rpng/kalibr_allan](https://github.com/rpng/kalibr_allan) |
| Source record ids | github_search_matlab-9b9ef9a860513a |
...
For a systems engineer, rpng/kalibr_allan belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-21T16:54:04Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-9b9ef9a860513a` from `github_search_matlab` as `registry_expansion`
