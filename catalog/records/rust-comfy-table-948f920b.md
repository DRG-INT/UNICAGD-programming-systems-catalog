...
<!-- canonical: https://crates.io/crates/comfy-table -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/comfy-table](https://crates.io/crates/comfy-table) |
| Source record ids | crates_io-04a703c10f71f1 |
...
For a systems engineer, comfy-table belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-08-05T01:05:28.283438Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-04a703c10f71f1` from `crates_io` as `registry_expansion`
