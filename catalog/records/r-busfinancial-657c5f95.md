...
<!-- canonical: https://cran.r-project.org/web/packages/BUSfinancial/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BUSfinancial/index.html](https://cran.r-project.org/web/packages/BUSfinancial/index.html) |
| Source record ids | cran_packages_by_date-599bd2e923d72b |

## System Engineer Summary

Economic Analysis of Islamic Commercial Bank Financial Time Series in Indonesia

## Operational Role

For a systems engineer, BUSfinancial belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 13:20:02 UTC | [https://cran.r-project.org/web/packages/BUSfinancial/DESCRIPTION](https://cran.r-project.org/web/packages/BUSfinancial/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BUSfinancial/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-599bd2e923d72b` from `cran_packages_by_date` as `registry_expansion`
