# wuyichen24/microservices-patterns

## Navigation

[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wuyichen24/microservices-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wuyichen24/microservices-patterns](https://github.com/wuyichen24/microservices-patterns) |
| Source record ids | github_search_pattern_language-c6c2623ece81a2 |

## System Engineer Summary

The source code of the book "Microservices Patterns (Chris Richardson)" and the personal study note
of Eventuate Tram Framework (The whole solution of transactional messaging for Spring Boot
microservices).

## Operational Role

For a systems engineer, wuyichen24/microservices-patterns belongs in the Pattern language inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-02T06:24:04Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "microservices patterns stars:>100", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_pattern_language-c6c2623ece81a2` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ackintosh/ganesha | Filesystem Os | [open](pattern-language-ackintosh-ganesha-8efb6b76.md) |
| addyosmani/essential-js-design-patterns | Filesystem Os | [open](pattern-language-addyosmani-essential-js-design-patterns-55f97ad1.md) |
| adimiko/TransactionalBox | Filesystem Os | [open](pattern-language-adimiko-transactionalbox-3c62533f.md) |
| anton-liauchuk/java-interview | Filesystem Os | [open](pattern-language-anton-liauchuk-java-interview-8ff8af1a.md) |
| Armando1514/Event-Driven-Microservices-Advanced | Filesystem Os | [open](pattern-language-armando1514-event-driven-microservices-advanced-5fc6cb6d.md) |
| artembilan/microservices-patterns-spring-integration | Filesystem Os | [open](pattern-language-artembilan-microservices-patterns-spring-integration-5b5b4fe0.md) |
| charlessolar/eShopOnContainersDDD | Filesystem Os | [open](pattern-language-charlessolar-eshoponcontainersddd-8ba18aea.md) |
| daohainam/microservice-patterns | Filesystem Os | [open](pattern-language-daohainam-microservice-patterns-650b9c7c.md) |
