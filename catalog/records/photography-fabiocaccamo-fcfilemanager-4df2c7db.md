...
<!-- canonical: https://github.com/fabiocaccamo/FCFileManager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fabiocaccamo/FCFileManager](https://github.com/fabiocaccamo/FCFileManager) |
| Source record ids | github_search_photography-2e1c6d0e3303ec |

## System Engineer Summary

:iphone: :open_file_folder:  iOS file manager on top of NSFileManager for simplifying files
management.

## Operational Role

For a systems engineer, fabiocaccamo/FCFileManager belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-22T14:30:34Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-2e1c6d0e3303ec` from `github_search_photography` as `registry_expansion`
