...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ordo-one/benchmark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ordo-one/benchmark](https://github.com/ordo-one/benchmark) |
| Source record ids | github_search_swift-4697445544777d |
...
For a systems engineer, ordo-one/benchmark belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T09:37:23Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-4697445544777d` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apple/swift-nio | Benchmarking | [open](swift-apple-swift-nio-a7333055.md) |
| rarestype/swift-json | Benchmarking | [open](swift-rarestype-swift-json-07634c5a.md) |
