...
<!-- canonical: https://crates.io/crates/tracing-opentelemetry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tracing-opentelemetry](https://crates.io/crates/tracing-opentelemetry) |
| Source record ids | crates_io-f4f67adeab8976 |
...
For a systems engineer, tracing-opentelemetry belongs in the Rust inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.33.0 | 2026-05-18T22:41:35.490105Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-f4f67adeab8976` from `crates_io` as `registry_expansion`
