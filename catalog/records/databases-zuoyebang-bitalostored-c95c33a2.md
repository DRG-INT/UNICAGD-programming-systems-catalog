...
<!-- canonical: https://github.com/zuoyebang/bitalostored -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zuoyebang/bitalostored](https://github.com/zuoyebang/bitalostored) |
| Source record ids | github_search_databases-f2ae3710c28693 |

## System Engineer Summary

Bitalostored is a high-performance distributed storage system, core engine based on bitalosdb(self-
developed), compatible with Redis protocol.

## Operational Role

For a systems engineer, zuoyebang/bitalostored belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-03T02:54:24Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f2ae3710c28693` from `github_search_databases` as `registry_expansion`
