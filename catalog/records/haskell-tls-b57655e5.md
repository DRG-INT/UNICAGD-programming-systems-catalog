...
<!-- canonical: https://hackage.haskell.org/package/tls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tls](https://hackage.haskell.org/package/tls) |
| Source record ids | hackage_top_downloads-7dd95169741642 |

## System Engineer Summary

Hackage package with 391 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, tls belongs in the Haskell inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.3 | 2026-06-03T01:47:52Z | [https://hackage.haskell.org/package/tls](https://hackage.haskell.org/package/tls) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tls` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-7dd95169741642` from `hackage_top_downloads` as `registry_expansion`
