...
<!-- canonical: https://github.com/timotejroiko/sweph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/timotejroiko/sweph](https://github.com/timotejroiko/sweph) |
| Source record ids | github_search_telescopes-b56b0e7fe06b3e |
...
For a systems engineer, timotejroiko/sweph belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T00:53:31Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-b56b0e7fe06b3e` from `github_search_telescopes` as `registry_expansion`
