...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/SpecFlow.Internal.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/SpecFlow.Internal.Json](https://www.nuget.org/packages/SpecFlow.Internal.Json) |
| Source record ids | nuget_search-2dd411f43aa433 |
...
For a systems engineer, SpecFlow.Internal.Json belongs in the C-Sharp inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.8 | 2021-06-18T07:34:59.13+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/specflow.internal.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/specflow.internal.json/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/specflow.internal.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-2dd411f43aa433` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| GraphQL-Parser | Parser Lexer Ast | [open](c-sharp-graphql-parser-92568a0b.md) |
| HttpMultipartParser | Parser Lexer Ast | [open](c-sharp-httpmultipartparser-7291f394.md) |
| JmesPath.Net | Parser Lexer Ast | [open](c-sharp-jmespath-net-840b500d.md) |
| NEST.JsonNetSerializer | Parser Lexer Ast | [open](c-sharp-nest-jsonnetserializer-dc57908e.md) |
