...
<!-- canonical: https://hackage.haskell.org/package/ephemeral-pg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ephemeral-pg](https://hackage.haskell.org/package/ephemeral-pg) |
| Source record ids | hackage_recent-8f02f0b40516b7 |
...
For a systems engineer, ephemeral-pg belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.0 | 2026-09-06T17:01:28Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-8f02f0b40516b7` from `hackage_recent` as `registry_expansion`
