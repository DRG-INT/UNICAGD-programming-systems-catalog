...
<!-- canonical: https://luarocks.org/modules/types/busted-tl-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/types/busted-tl-type](https://luarocks.org/modules/types/busted-tl-type) |
| Source record ids | luarocks_root_manifest-d8394e8d055dfc |

## System Engineer Summary

Teal type definition files for busted

## Operational Role

For a systems engineer, busted-tl-type belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d8394e8d055dfc` from `luarocks_root_manifest` as `registry_expansion`
