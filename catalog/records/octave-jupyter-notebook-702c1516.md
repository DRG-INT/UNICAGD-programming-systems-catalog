...
<!-- canonical: https://gnu-octave.github.io/packages/jupyter-notebook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/jupyter-notebook](https://gnu-octave.github.io/packages/jupyter-notebook) |
| Source record ids | octave_packages_index-ddf55e5c610738 |

## System Engineer Summary

A package to run and fill Jupyter Notebooks within GNU Octave. Evaluate long-running Octave Jupyter
Notebooks on a computing server without permanent browser connection. Included in Octave core since
version 7.1.0. No need to install this package in recent Octave versions.

## Operational Role

For a systems engineer, jupyter-notebook belongs in the Octave inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2025-03-23 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-ddf55e5c610738` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| devtools | Web Framework | [open](octave-devtools-25d093fe.md) |
