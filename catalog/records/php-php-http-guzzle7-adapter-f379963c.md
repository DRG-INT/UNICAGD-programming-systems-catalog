...
<!-- canonical: https://packagist.org/packages/php-http/guzzle7-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/guzzle7-adapter](https://packagist.org/packages/php-http/guzzle7-adapter) |
| Source record ids | packagist_search-f4263c09164609 |

## System Engineer Summary

php-http/guzzle7-adapter is tracked as a networking http record in the PHP branch. The source did
...
For a systems engineer, php-http/guzzle7-adapter belongs in the PHP inventory as part of service
...
- `packagist_search-f4263c09164609` from `packagist_search` as `registry_expansion`
