...
<!-- canonical: https://cran.r-project.org/web/packages/gustave/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gustave/index.html](https://cran.r-project.org/web/packages/gustave/index.html) |
| Source record ids | cran_packages_by_date-0ffede23030ba9 |
...
For a systems engineer, gustave belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-05 15:40:14 UTC | [https://cran.r-project.org/web/packages/gustave/DESCRIPTION](https://cran.r-project.org/web/packages/gustave/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gustave/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-0ffede23030ba9` from `cran_packages_by_date` as `registry_expansion`
