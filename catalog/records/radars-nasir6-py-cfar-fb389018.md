...
<!-- canonical: https://github.com/nasir6/py_cfar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nasir6/py_cfar](https://github.com/nasir6/py_cfar) |
| Source record ids | github_search_radars-6d6d7301fd820f |
...
For a systems engineer, nasir6/py_cfar belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-18T14:49:15Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-6d6d7301fd820f` from `github_search_radars` as `registry_expansion`
