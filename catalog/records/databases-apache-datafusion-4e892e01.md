...
| Canonical URL | [https://github.com/apache/datafusion](https://github.com/apache/datafusion) |
| Source record ids | github_search_databases-43d76249653d05 |
...
For a systems engineer, apache/datafusion belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:09:53Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-43d76249653d05` from `github_search_databases` as `registry_expansion`
