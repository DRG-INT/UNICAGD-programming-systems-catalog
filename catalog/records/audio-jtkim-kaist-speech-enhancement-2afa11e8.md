...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jtkim-kaist/Speech-enhancement -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jtkim-kaist/Speech-enhancement](https://github.com/jtkim-kaist/Speech-enhancement) |
| Source record ids | github_search_audio-ef2abf5ffdc32d |
...
For a systems engineer, jtkim-kaist/Speech-enhancement belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-14T14:15:05Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:speech-processing stars:>50", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_audio-ef2abf5ffdc32d` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adobe-research/MetaAF | Networking Http | [open](audio-adobe-research-metaaf-25d2965d.md) |
| Anjok07/ultimatevocalremovergui | Networking Http | [open](audio-anjok07-ultimatevocalremovergui-7c0f051c.md) |
| apohl79/audiogridder | Networking Http | [open](audio-apohl79-audiogridder-b399a5d3.md) |
| cvqluu/TDNN | Networking Http | [open](audio-cvqluu-tdnn-fb6a7ffe.md) |
| drethage/speech-denoising-wavenet | Networking Http | [open](audio-drethage-speech-denoising-wavenet-dd81add3.md) |
| FFmpeg/FFmpeg | Networking Http | [open](audio-ffmpeg-ffmpeg-e29098d1.md) |
| hannesbraun/airwindows-lv2 | Networking Http | [open](audio-hannesbraun-airwindows-lv2-77a8604e.md) |
| huckiyang/QuantumSpeech-QCNN | Networking Http | [open](audio-huckiyang-quantumspeech-qcnn-75d646b8.md) |
