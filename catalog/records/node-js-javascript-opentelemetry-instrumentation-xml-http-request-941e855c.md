...
<!-- canonical: https://www.npmjs.com/package/@opentelemetry/instrumentation-xml-http-request -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@opentelemetry/instrumentation-xml-http-request](https://www.npmjs.com/package/@opentelemetry/instrumentation-xml-http-request) |
| Source record ids | npm_registry-d5e0eefcb6a2ad |
...
For a systems engineer, @opentelemetry/instrumentation-xml-http-request belongs in the
Node.js/JavaScript inventory as part of wire formats, persistence, interoperability, and
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.222.0 | 2026-08-31T16:43:46.899Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-d5e0eefcb6a2ad` from `npm_registry` as `registry_expansion`
