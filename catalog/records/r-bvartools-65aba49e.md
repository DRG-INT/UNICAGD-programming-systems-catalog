...
<!-- canonical: https://cran.r-project.org/web/packages/bvartools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bvartools/index.html](https://cran.r-project.org/web/packages/bvartools/index.html) |
| Source record ids | cran_packages_by_date-d039d0a1f1d3b4 |
...
For a systems engineer, bvartools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-11 18:50:02 UTC | [https://cran.r-project.org/web/packages/bvartools/DESCRIPTION](https://cran.r-project.org/web/packages/bvartools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bvartools/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-d039d0a1f1d3b4` from `cran_packages_by_date` as `registry_expansion`
