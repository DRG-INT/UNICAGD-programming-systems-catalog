...
<!-- canonical: https://github.com/streamdal/streamdal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/streamdal/streamdal](https://github.com/streamdal/streamdal) |
| Source record ids | github_search_webassembly-3ac92134f1d71a |
...
For a systems engineer, streamdal/streamdal belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-22T13:52:02Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-3ac92134f1d71a` from `github_search_webassembly` as `registry_expansion`
