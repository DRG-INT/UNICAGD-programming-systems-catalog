# OS2World/DEV-SAMPLES-C-PM-edctl1

## Navigation

[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/OS2World/DEV-SAMPLES-C-PM-edctl1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OS2World/DEV-SAMPLES-C-PM-edctl1](https://github.com/OS2World/DEV-SAMPLES-C-PM-edctl1) |
| Source record ids | github_search_magazines-54ca654d717fac |

## System Engineer Summary

OS/2 Developer Magazine, GUI Corner column, "The Forbidden Text" - July/August 1994 issue. Purpose:
Compilable 32-Bit edit control source code sample and test routine for various OS/2 compilers.

## Operational Role

For a systems engineer, OS2World/DEV-SAMPLES-C-PM-edctl1 belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.01 | 2023-06-11T01:51:04Z | [https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-edctl1/releases/latest](https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-edctl1/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-edctl1/releases/latest` at `2026-09-01T10:25:46+00:00`.
...
- `github_search_magazines-54ca654d717fac` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| shining1984/PL-Compiler-Resource | Compiler | [open](magazines-shining1984-pl-compiler-resource-a032e151.md) |
