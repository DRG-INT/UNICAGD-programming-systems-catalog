...
| Canonical URL | [https://luarocks.org/modules/membphis/grpc-client-nginx-module](https://luarocks.org/modules/membphis/grpc-client-nginx-module) |
| Source record ids | luarocks_root_manifest-3a771d9c8d8b0e |

## System Engineer Summary

Call gRPC service in Nginx

## Operational Role

For a systems engineer, grpc-client-nginx-module belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-3a771d9c8d8b0e` from `luarocks_root_manifest` as `registry_expansion`
