...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/asdf-format/asdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asdf-format/asdf](https://github.com/asdf-format/asdf) |
| Source record ids | github_search_telescopes-7a43e1d60b896a |
...
For a systems engineer, asdf-format/asdf belongs in the Telescopes inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T20:54:34Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_telescopes-7a43e1d60b896a` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bgmeulem/luminet | Formatter | [open](telescopes-bgmeulem-luminet-268f5eae.md) |
| dcf21/star-charter | Formatter | [open](telescopes-dcf21-star-charter-9c0209b9.md) |
| MattBlack85/astro_monitor | Formatter | [open](telescopes-mattblack85-astro-monitor-5e2ed47c.md) |
