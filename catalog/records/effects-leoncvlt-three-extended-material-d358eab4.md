# leoncvlt/three-extended-material
...
<!-- canonical: https://github.com/leoncvlt/three-extended-material -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leoncvlt/three-extended-material](https://github.com/leoncvlt/three-extended-material) |
| Source record ids | github_search_effects-98b5dd567ece36 |

## System Engineer Summary

🧱 Easily extend native three.js materials with modular and composable shader units and effects,
available as a vanilla or React component

## Operational Role

For a systems engineer, leoncvlt/three-extended-material belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-06T17:19:01Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-98b5dd567ece36` from `github_search_effects` as `registry_expansion`
