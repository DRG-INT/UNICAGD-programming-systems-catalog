...
| Canonical URL | [https://crates.io/crates/syn_derive](https://crates.io/crates/syn_derive) |
| Source record ids | crates_io-21802664bc1edc |
...
For a systems engineer, syn_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2024-11-06T17:13:52.782721Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-21802664bc1edc` from `crates_io` as `registry_expansion`
