...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Continuous-Collision-Detection/CCD-Wrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Continuous-Collision-Detection/CCD-Wrapper](https://github.com/Continuous-Collision-Detection/CCD-Wrapper) |
| Source record ids | github_search_physics_engines-eb938de64d4d9b |
...
For a systems engineer, Continuous-Collision-Detection/CCD-Wrapper belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-25T16:21:34Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-eb938de64d4d9b` from `github_search_physics_engines` as `registry_expansion`
