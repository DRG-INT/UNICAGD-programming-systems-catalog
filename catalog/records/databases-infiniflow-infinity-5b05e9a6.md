...
<!-- canonical: https://github.com/infiniflow/infinity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/infiniflow/infinity](https://github.com/infiniflow/infinity) |
| Source record ids | github_search_databases-14ab9b06e40e25 |

## System Engineer Summary

The AI-native database built for LLM applications, providing incredibly fast hybrid search of dense
vector, sparse vector, tensor (multi-vector), and full-text.

## Operational Role

For a systems engineer, infiniflow/infinity belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T02:55:23Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-14ab9b06e40e25` from `github_search_databases` as `registry_expansion`
