# palmapps/jwt-spring-security-demo
...
<!-- canonical: https://gitlab.com/palmapps/jwt-spring-security-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/palmapps/jwt-spring-security-demo](https://gitlab.com/palmapps/jwt-spring-security-demo) |
| Source record ids | gitlab_projects_api-4dbe2095507d60 |
...
For a systems engineer, palmapps/jwt-spring-security-demo belongs in the Repository Workplaces
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-09 | `{"kind": "gitlab_projects_api", "query": "security", "retrieved": "2026-09-09", "status": "forge-api-derived"}` |
...
- `gitlab_projects_api-4dbe2095507d60` from `gitlab_projects_api` as `registry_expansion`
