...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dbos-inc/dbos-transact-py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbos-inc/dbos-transact-py](https://github.com/dbos-inc/dbos-transact-py) |
| Source record ids | github_search_engines-0b72f4aa584838 |
...
For a systems engineer, dbos-inc/dbos-transact-py belongs in the Engines inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:02:23Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-0b72f4aa584838` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Apache Lucene | Database Datastore | [open](engines-apache-lucene-0055aa18.md) |
| dbos-inc/dbos-transact-golang | Database Datastore | [open](engines-dbos-inc-dbos-transact-golang-a20b0b9d.md) |
| RocksDB | Database Datastore | [open](engines-rocksdb-fabf3c33.md) |
