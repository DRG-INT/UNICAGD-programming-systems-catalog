...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Calendars](https://github.com/JuliaRegistries/General/tree/master/C/Calendars) |
| Source record ids | julia_general-f71c660272dc62 |

## System Engineer Summary

Julia package registered in General at C/Calendars.

## Operational Role

For a systems engineer, Calendars belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Calendars", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f71c660272dc62` from `julia_general` as `registry_expansion`
