...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tidalcycles/strudel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tidalcycles/strudel](https://github.com/tidalcycles/strudel) |
| Source record ids | github_search_audio-2ee2ffda88d90c |

## System Engineer Summary

MOVED TO CODEBERG - Web-based environment for live coding algorithmic patterns, incorporating a
faithful port of TidalCycles to JavaScript

## Operational Role

For a systems engineer, tidalcycles/strudel belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-19T15:56:31Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-2ee2ffda88d90c` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ooesili/sorceress | Configuration | [open](audio-ooesili-sorceress-48398234.md) |
