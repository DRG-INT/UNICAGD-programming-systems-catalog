...
<!-- canonical: https://cran.r-project.org/web/packages/MiCT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MiCT/index.html](https://cran.r-project.org/web/packages/MiCT/index.html) |
| Source record ids | cran_packages_by_date-b75707ab540270 |
...
For a systems engineer, MiCT belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-09 08:30:08 UTC | [https://cran.r-project.org/web/packages/MiCT/DESCRIPTION](https://cran.r-project.org/web/packages/MiCT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MiCT/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b75707ab540270` from `cran_packages_by_date` as `registry_expansion`
