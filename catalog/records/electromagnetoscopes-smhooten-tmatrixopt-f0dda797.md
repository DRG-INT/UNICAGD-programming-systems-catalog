...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/smhooten/TMatrixOpt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/smhooten/TMatrixOpt](https://github.com/smhooten/TMatrixOpt) |
| Source record ids | github_search_electromagnetoscopes-c4b19b31a99f01 |

## System Engineer Summary

An electromagnetic solver capable of simulating and optimizing 1D (thin-layer) structures via the
semi-analytical transfer matrix method. For example, one can simulate and optimize broadband
distributed Bragg reflectors, anti-reflection coatings, optical bandpass filters, and photovoltaic
devices.

## Operational Role

For a systems engineer, smhooten/TMatrixOpt belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-29T20:31:46Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c4b19b31a99f01` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 1ove9/antenna-forge | Machine Learning | [open](electromagnetoscopes-1ove9-antenna-forge-919a534b.md) |
| BigBodyCobain/Shadowbroker | Machine Learning | [open](electromagnetoscopes-bigbodycobain-shadowbroker-197c47b8.md) |
| Blaarkies/ksp-visual-calculator | Machine Learning | [open](electromagnetoscopes-blaarkies-ksp-visual-calculator-aabfb7be.md) |
| bsumlin/PyMieScatt | Machine Learning | [open](electromagnetoscopes-bsumlin-pymiescatt-d4db2fe9.md) |
| CaptainCodeman/svelte-headlessui | Machine Learning | [open](electromagnetoscopes-captaincodeman-svelte-headlessui-b148d1ce.md) |
| cheatsnake/airstation | Machine Learning | [open](electromagnetoscopes-cheatsnake-airstation-cd314b94.md) |
| chiaweihsu/RGF | Machine Learning | [open](electromagnetoscopes-chiaweihsu-rgf-a3cb2d12.md) |
| ClaudeMarais/FindEachOtherCompass_ESP32-C3 | Machine Learning | [open](electromagnetoscopes-claudemarais-findeachothercompass-esp32-c3-993050f7.md) |
