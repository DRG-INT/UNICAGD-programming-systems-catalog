...
<!-- canonical: https://hackage.haskell.org/package/functor-combinators -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/functor-combinators](https://hackage.haskell.org/package/functor-combinators) |
| Source record ids | hackage_top_downloads-96b3417cf2523f |
...
For a systems engineer, functor-combinators belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.4 | 2025-06-13T06:02:19Z | [https://hackage.haskell.org/package/functor-combinators](https://hackage.haskell.org/package/functor-combinators) |  |
| candidate | partial | 0.4.1.1 |  | [https://hackage.haskell.org/package/functor-combinators](https://hackage.haskell.org/package/functor-combinators) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/functor-combinators` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-96b3417cf2523f` from `hackage_top_downloads` as `registry_expansion`
