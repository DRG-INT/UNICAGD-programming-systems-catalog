...
<!-- canonical: https://github.com/samber/lo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/samber/lo](https://github.com/samber/lo) |
| Source record ids | github_search_go-ee15ed69a3a9df |
...
For a systems engineer, samber/lo belongs in the Go inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T16:05:25Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-ee15ed69a3a9df` from `github_search_go` as `registry_expansion`
