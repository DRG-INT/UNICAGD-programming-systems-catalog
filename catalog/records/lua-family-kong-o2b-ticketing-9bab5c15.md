...
| Canonical URL | [https://luarocks.org/modules/chalkan3/kong-o2b-ticketing](https://luarocks.org/modules/chalkan3/kong-o2b-ticketing) |
| Source record ids | luarocks_root_manifest-bfad1776ecfb9c |

## System Engineer Summary

ticketing is a plugin for save user data between request.

## Operational Role

For a systems engineer, kong-o2b-ticketing belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bfad1776ecfb9c` from `luarocks_root_manifest` as `registry_expansion`
