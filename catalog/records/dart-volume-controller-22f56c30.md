...
<!-- canonical: https://pub.dev/packages/volume_controller -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/volume_controller](https://pub.dev/packages/volume_controller) |
| Source record ids | pub_dev-8b869ab74e8b55 |
...
For a systems engineer, volume_controller belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.1 | 2026-08-23T14:44:28.376216Z | [https://pub.dev/api/packages/volume_controller](https://pub.dev/api/packages/volume_controller) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/volume_controller` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-8b869ab74e8b55` from `pub_dev` as `registry_expansion`
