...
<!-- canonical: https://github.com/star2dust/paper-simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/star2dust/paper-simulation](https://github.com/star2dust/paper-simulation) |
| Source record ids | github_search_matlab-4f1579aaa45114 |

## System Engineer Summary

Let's reproduce paper simulations of multi-robot systems, formation control, distributed
optimization and cooperative manipulation.

## Operational Role

For a systems engineer, star2dust/paper-simulation belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-21T09:58:05Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-4f1579aaa45114` from `github_search_matlab` as `registry_expansion`
