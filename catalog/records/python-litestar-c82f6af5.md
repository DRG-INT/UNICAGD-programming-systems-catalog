...
| Canonical URL | [https://pypi.org/project/litestar/](https://pypi.org/project/litestar/) |
| Source record ids | corpus-26e6064e825612 |
...
For a systems engineer, Litestar belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.24.0 | 2026-06-11T11:27:00.519124Z | [https://pypi.org/pypi/Litestar/json](https://pypi.org/pypi/Litestar/json) |  |
| preview | known | 2.0.0rc1 | 2023-08-05T15:13:25.650921Z | [https://pypi.org/pypi/Litestar/json](https://pypi.org/pypi/Litestar/json) |  |

## Engineering Notes

- Treat category as `web_framework` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://pypi.org/pypi/Litestar/json` at `2026-09-01T02:13:00+00:00`.
...
- `corpus-26e6064e825612` from `master_json` as `web_framework`
