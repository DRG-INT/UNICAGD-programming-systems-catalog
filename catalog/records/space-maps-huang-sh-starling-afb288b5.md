...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/huang-sh/Starling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/huang-sh/Starling](https://github.com/huang-sh/Starling) |
| Source record ids | github_search_space_maps-6e31b5350d892f |

## System Engineer Summary

Launch, switch, and organize Claude Code and Codex sessions with model profiles, catalogs, project
views, and VS Code integration.

## Operational Role

For a systems engineer, huang-sh/Starling belongs in the Space Maps inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T08:11:20Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-6e31b5350d892f` from `github_search_space_maps` as `registry_expansion`
