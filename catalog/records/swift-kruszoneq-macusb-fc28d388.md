...
<!-- canonical: https://github.com/Kruszoneq/macUSB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kruszoneq/macUSB](https://github.com/Kruszoneq/macUSB) |
| Source record ids | github_search_swift-e5a4f1bf879ecd |
...
For a systems engineer, Kruszoneq/macUSB belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T20:43:42Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-e5a4f1bf879ecd` from `github_search_swift` as `registry_expansion`
