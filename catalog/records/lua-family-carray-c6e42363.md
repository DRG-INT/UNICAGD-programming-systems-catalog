...
<!-- canonical: https://luarocks.org/modules/osch/carray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/osch/carray](https://luarocks.org/modules/osch/carray) |
| Source record ids | luarocks_root_manifest-8e1ce37139a427 |

## System Engineer Summary

Arrays for primitive numeric C data types

## Operational Role

For a systems engineer, carray belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-8e1ce37139a427` from `luarocks_root_manifest` as `registry_expansion`
