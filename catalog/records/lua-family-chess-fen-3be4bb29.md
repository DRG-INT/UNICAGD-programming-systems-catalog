...
<!-- canonical: https://luarocks.org/modules/peterbillam/chess-fen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/peterbillam/chess-fen](https://luarocks.org/modules/peterbillam/chess-fen) |
| Source record ids | luarocks_root_manifest-2f2526602ebfd1 |
...
For a systems engineer, chess-fen belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-2f2526602ebfd1` from `luarocks_root_manifest` as `registry_expansion`
