...
<!-- canonical: https://cran.r-project.org/web/packages/nmw/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nmw/index.html](https://cran.r-project.org/web/packages/nmw/index.html) |
| Source record ids | cran_packages_by_date-4b923f4e7571dd |
...
For a systems engineer, nmw belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-08-21 05:41:31 UTC | [https://cran.r-project.org/web/packages/nmw/DESCRIPTION](https://cran.r-project.org/web/packages/nmw/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nmw/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4b923f4e7571dd` from `cran_packages_by_date` as `registry_expansion`
