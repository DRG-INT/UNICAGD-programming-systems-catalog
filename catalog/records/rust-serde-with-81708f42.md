...
<!-- canonical: https://crates.io/crates/serde_with -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.23.0 | 2026-09-07T23:03:03.817937Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-08T00:30:40+00:00`.
...
- `crates_io-428de900054f92` from `crates_io` as `registry_expansion`
