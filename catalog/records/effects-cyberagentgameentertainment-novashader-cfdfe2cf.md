...
| Canonical URL | [https://github.com/CyberAgentGameEntertainment/NovaShader](https://github.com/CyberAgentGameEntertainment/NovaShader) |
| Source record ids | github_search_effects-c4daaac2d03eb4 |

## System Engineer Summary

Multi-functional shader for the Particle System that supports Universal Render Pipeline (URP) of
Unity.

## Operational Role

For a systems engineer, CyberAgentGameEntertainment/NovaShader belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.0 | 2026-04-08T01:21:34Z | [https://api.github.com/repos/CyberAgentGameEntertainment/NovaShader/releases/latest](https://api.github.com/repos/CyberAgentGameEntertainment/NovaShader/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CyberAgentGameEntertainment/NovaShader/releases/latest` at `2026-09-01T09:23:08+00:00`.
...
- `github_search_effects-c4daaac2d03eb4` from `github_search_effects` as `registry_expansion`
