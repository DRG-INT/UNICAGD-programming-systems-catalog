...
<!-- canonical: https://github.com/Audio-WestlakeU/FullSubNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Audio-WestlakeU/FullSubNet](https://github.com/Audio-WestlakeU/FullSubNet) |
| Source record ids | github_search_audio-90ab01e7ca19c4 |

## System Engineer Summary

PyTorch implementation of "FullSubNet: A Full-Band and Sub-Band Fusion Model for Real-Time Single-
Channel Speech Enhancement."

## Operational Role

For a systems engineer, Audio-WestlakeU/FullSubNet belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2 | 2021-01-16T00:14:39Z | [https://api.github.com/repos/Audio-WestlakeU/FullSubNet/releases/latest](https://api.github.com/repos/Audio-WestlakeU/FullSubNet/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Audio-WestlakeU/FullSubNet/releases/latest` at `2026-09-01T11:21:37+00:00`.
...
- `github_search_audio-90ab01e7ca19c4` from `github_search_audio` as `registry_expansion`
