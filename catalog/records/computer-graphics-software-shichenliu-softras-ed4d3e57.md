...
<!-- canonical: https://github.com/ShichenLiu/SoftRas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ShichenLiu/SoftRas](https://github.com/ShichenLiu/SoftRas) |
| Source record ids | github_search_computer_graphics_software-e45d5bd7f8a0e5 |
...
For a systems engineer, ShichenLiu/SoftRas belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-e45d5bd7f8a0e5` from `github_search_computer_graphics_software` as `registry_expansion`
