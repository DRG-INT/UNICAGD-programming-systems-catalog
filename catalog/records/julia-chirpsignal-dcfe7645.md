...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChirpSignal](https://github.com/JuliaRegistries/General/tree/master/C/ChirpSignal) |
| Source record ids | julia_general-330bc65d697792 |

## System Engineer Summary

Julia package registered in General at C/ChirpSignal.

## Operational Role

For a systems engineer, ChirpSignal belongs in the Julia inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractImageReconstruction | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractimagereconstruction-d0f365dc.md) |
| AlignedSpans | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-alignedspans-4093c2df.md) |
| AudioDB | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-audiodb-520db38a.md) |
| AudioReader | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-audioreader-bc418885.md) |
| BanyanImages | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-banyanimages-9a03fe00.md) |
| BatchedSPDMatrices | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-batchedspdmatrices-f8115add.md) |
| BioRecordsProcessing | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-biorecordsprocessing-77530e96.md) |
| CitableImage | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-citableimage-34f8fff8.md) |
