...
<!-- canonical: https://cran.r-project.org/web/packages/medicare/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/medicare/index.html](https://cran.r-project.org/web/packages/medicare/index.html) |
| Source record ids | cran_packages_by_date-b958ad8e6f22bb |
...
For a systems engineer, medicare belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-15 00:30:02 UTC | [https://cran.r-project.org/web/packages/medicare/DESCRIPTION](https://cran.r-project.org/web/packages/medicare/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/medicare/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-b958ad8e6f22bb` from `cran_packages_by_date` as `registry_expansion`
