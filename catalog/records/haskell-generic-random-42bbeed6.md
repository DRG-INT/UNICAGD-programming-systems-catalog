...
<!-- canonical: https://hackage.haskell.org/package/generic-random -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/generic-random](https://hackage.haskell.org/package/generic-random) |
| Source record ids | hackage_top_downloads-dbcd40e7fda251 |
...
For a systems engineer, generic-random belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0.1 | 2021-11-23T00:37:29Z | [https://hackage.haskell.org/package/generic-random](https://hackage.haskell.org/package/generic-random) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/generic-random` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-dbcd40e7fda251` from `hackage_top_downloads` as `registry_expansion`
