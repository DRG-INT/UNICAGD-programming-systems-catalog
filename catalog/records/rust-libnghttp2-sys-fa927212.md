...
| Canonical URL | [https://crates.io/crates/libnghttp2-sys](https://crates.io/crates/libnghttp2-sys) |
| Source record ids | crates_io-216ea606300482 |
...
For a systems engineer, libnghttp2-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.13+1.68.1 | 2026-03-31T18:40:22.320807Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-216ea606300482` from `crates_io` as `registry_expansion`
