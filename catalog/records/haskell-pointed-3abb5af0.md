...
<!-- canonical: https://hackage.haskell.org/package/pointed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pointed](https://hackage.haskell.org/package/pointed) |
| Source record ids | hackage_top_downloads-77b1d86f6dc859 |
...
For a systems engineer, pointed belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.5 | 2024-10-26T20:15:29Z | [https://hackage.haskell.org/package/pointed](https://hackage.haskell.org/package/pointed) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pointed` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-77b1d86f6dc859` from `hackage_top_downloads` as `registry_expansion`
