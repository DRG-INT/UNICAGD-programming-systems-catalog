...
<!-- canonical: https://github.com/apache/shardingsphere -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/shardingsphere](https://github.com/apache/shardingsphere) |
| Source record ids | github_search_databases-3271363c7ca79f |

## System Engineer Summary

Empowering Data Intelligence with Distributed SQL for Sharding, Scalability, and Security Across All
Databases.

## Operational Role

For a systems engineer, apache/shardingsphere belongs in the Databases inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T17:13:59Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3271363c7ca79f` from `github_search_databases` as `registry_expansion`
