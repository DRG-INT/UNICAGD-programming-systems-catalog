...
<!-- canonical: https://github.com/quickemu-project/quickemu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/quickemu-project/quickemu](https://github.com/quickemu-project/quickemu) |
| Source record ids | github_search_space_maps-b4fddd6e91b11d |
...
For a systems engineer, quickemu-project/quickemu belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T17:40:21Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b4fddd6e91b11d` from `github_search_space_maps` as `registry_expansion`
