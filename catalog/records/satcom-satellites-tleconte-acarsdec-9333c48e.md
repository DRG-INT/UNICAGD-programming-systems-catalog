...
| Source record ids | github_search_satcom_satellites-eaf212649b2548 |

## System Engineer Summary

TLeconte/acarsdec is tracked as a library record in the SatCom Satellites branch. The source did not
...
For a systems engineer, TLeconte/acarsdec belongs in the SatCom Satellites inventory as part of
...
- `github_search_satcom_satellites-eaf212649b2548` from `github_search_satcom_satellites` as `registry_expansion`
