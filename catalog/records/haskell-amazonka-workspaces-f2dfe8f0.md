...
<!-- canonical: https://hackage.haskell.org/package/amazonka-workspaces -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-workspaces](https://hackage.haskell.org/package/amazonka-workspaces) |
| Source record ids | hackage_top_downloads-ea2c6dc1cc25fb |
...
For a systems engineer, amazonka-workspaces belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:50:09Z | [https://hackage.haskell.org/package/amazonka-workspaces](https://hackage.haskell.org/package/amazonka-workspaces) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-workspaces` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-ea2c6dc1cc25fb` from `hackage_top_downloads` as `registry_expansion`
