...
<!-- canonical: https://github.com/opentracing-contrib/java-specialagent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opentracing-contrib/java-specialagent](https://github.com/opentracing-contrib/java-specialagent) |
| Source record ids | github_search_databases-34a093c7179baf |
...
For a systems engineer, opentracing-contrib/java-specialagent belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-10-11T22:14:25Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-34a093c7179baf` from `github_search_databases` as `registry_expansion`
