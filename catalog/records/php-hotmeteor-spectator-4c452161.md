...
<!-- canonical: https://packagist.org/packages/hotmeteor/spectator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/hotmeteor/spectator](https://packagist.org/packages/hotmeteor/spectator) |
| Source record ids | packagist_search-391f0bb36661fb |
...
For a systems engineer, hotmeteor/spectator belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-391f0bb36661fb` from `packagist_search` as `registry_expansion`
