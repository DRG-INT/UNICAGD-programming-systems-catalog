...
<!-- canonical: https://github.com/esheldon/fitsio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/esheldon/fitsio](https://github.com/esheldon/fitsio) |
| Source record ids | github_search_telescopes-6955bece8277fa |
...
For a systems engineer, esheldon/fitsio belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:44:37Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-6955bece8277fa` from `github_search_telescopes` as `registry_expansion`
