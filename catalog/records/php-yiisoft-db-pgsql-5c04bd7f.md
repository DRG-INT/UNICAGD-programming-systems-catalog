...
<!-- canonical: https://packagist.org/packages/yiisoft/db-pgsql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yiisoft/db-pgsql](https://packagist.org/packages/yiisoft/db-pgsql) |
| Source record ids | packagist_search-52ea0d9e574326 |
...
For a systems engineer, yiisoft/db-pgsql belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-52ea0d9e574326` from `packagist_search` as `registry_expansion`
