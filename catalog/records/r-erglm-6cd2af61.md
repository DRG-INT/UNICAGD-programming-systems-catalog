...
<!-- canonical: https://cran.r-project.org/web/packages/erglm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/erglm/index.html](https://cran.r-project.org/web/packages/erglm/index.html) |
| Source record ids | cran_packages_by_date-3ba129b553fa64 |

## System Engineer Summary

Exposure-Response Tools for GLM-Based Models

## Operational Role

For a systems engineer, erglm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-08 09:00:02 UTC | [https://cran.r-project.org/web/packages/erglm/DESCRIPTION](https://cran.r-project.org/web/packages/erglm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/erglm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3ba129b553fa64` from `cran_packages_by_date` as `registry_expansion`
