...
<!-- canonical: https://cran.r-project.org/web/packages/tinytable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinytable/index.html](https://cran.r-project.org/web/packages/tinytable/index.html) |
| Source record ids | cran_packages_by_date-026d9db1df191d |

## System Engineer Summary

Simple and Configurable Tables in 'HTML', 'LaTeX', 'Markdown', 'Word', 'PNG', 'PDF', and 'Typst'
Formats

## Operational Role

For a systems engineer, tinytable belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.0 | 2026-08-20 05:20:21 UTC | [https://cran.r-project.org/web/packages/tinytable/DESCRIPTION](https://cran.r-project.org/web/packages/tinytable/DESCRIPTION) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinytable/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-026d9db1df191d` from `cran_packages_by_date` as `registry_expansion`
...
| CopernicusMarine | Formatter | [open](r-copernicusmarine-99a19469.md) |
