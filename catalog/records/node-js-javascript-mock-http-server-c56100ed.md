...
<!-- canonical: https://www.npmjs.com/package/mock-http-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mock-http-server](https://www.npmjs.com/package/mock-http-server) |
| Source record ids | npm_registry-97f38b64caadee |
...
For a systems engineer, mock-http-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.5 | 2021-11-17T14:18:21.538Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-97f38b64caadee` from `npm_registry` as `registry_expansion`
