...
<!-- canonical: https://github.com/vlcn-io/cr-sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vlcn-io/cr-sqlite](https://github.com/vlcn-io/cr-sqlite) |
| Source record ids | github_search_databases-7d5af4477f254c |
...
For a systems engineer, vlcn-io/cr-sqlite belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T10:55:49Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7d5af4477f254c` from `github_search_databases` as `registry_expansion`
