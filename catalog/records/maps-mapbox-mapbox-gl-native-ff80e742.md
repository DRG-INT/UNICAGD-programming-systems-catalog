...
<!-- canonical: https://github.com/mapbox/mapbox-gl-native -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mapbox/mapbox-gl-native](https://github.com/mapbox/mapbox-gl-native) |
| Source record ids | github_search_maps-be6064725df72a |

## System Engineer Summary

Interactive, thoroughly customizable maps in native Android, iOS, macOS, Node.js, and Qt
applications, powered by vector tiles and OpenGL

## Operational Role

For a systems engineer, mapbox/mapbox-gl-native belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-27T10:31:03Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-be6064725df72a` from `github_search_maps` as `registry_expansion`
