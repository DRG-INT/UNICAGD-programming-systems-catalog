...
<!-- canonical: https://github.com/melonjs/melonJS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/melonjs/melonJS](https://github.com/melonjs/melonJS) |
| Source record ids | github_search_game_engines-5416442b46ba17 |
...
For a systems engineer, melonjs/melonJS belongs in the Game Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:09:48Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-5416442b46ba17` from `github_search_game_engines` as `registry_expansion`
