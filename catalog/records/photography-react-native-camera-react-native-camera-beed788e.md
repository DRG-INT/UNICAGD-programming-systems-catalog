...
| Canonical URL | [https://github.com/react-native-camera/react-native-camera](https://github.com/react-native-camera/react-native-camera) |
| Source record ids | github_search_photography-9e08d09acb5363 |
...
For a systems engineer, react-native-camera/react-native-camera belongs in the Photography inventory
as part of defect discovery, security review, undefined-state detection, and regression prevention.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.2.1 | 2021-09-21T19:40:03Z | [https://api.github.com/repos/react-native-camera/react-native-camera/releases/latest](https://api.github.com/repos/react-native-camera/react-native-camera/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/react-native-camera/react-native-camera/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-9e08d09acb5363` from `github_search_photography` as `registry_expansion`
...
| ncoevoet/facet | Static Analyzer | [open](photography-ncoevoet-facet-f48943dd.md) |
| petrobras/GeoSlicer | Static Analyzer | [open](photography-petrobras-geoslicer-d6192212.md) |
| photonixapp/photonix | Static Analyzer | [open](photography-photonixapp-photonix-0ee14fb2.md) |
| stongey/PhotoRestore | Static Analyzer | [open](photography-stongey-photorestore-e3bb2edb.md) |
| toonoumi/FreeCCR | Static Analyzer | [open](photography-toonoumi-freeccr-2918c356.md) |
