...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/ab-test-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-test-client/](https://pypi.org/project/ab-test-client/) |
| Source record ids | pypi_simple-fb55f9fd828d84 |

## System Engineer Summary

ab-test-client is tracked as a testing framework record in the Python branch. The source did not
...
For a systems engineer, ab-test-client belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1rc0 | 2021-03-30T07:53:44.293426Z | [https://pypi.org/pypi/ab-test-client/json](https://pypi.org/pypi/ab-test-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-test-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-fb55f9fd828d84` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 131228_pytest_1 | Testing Framework | [open](python-131228-pytest-1-48f3856a.md) |
| 5gasp-cli | Testing Framework | [open](python-5gasp-cli-e19869ba.md) |
| aarushtaskforcetestingvolt | Testing Framework | [open](python-aarushtaskforcetestingvolt-aae41f48.md) |
| ab-testing-kit | Testing Framework | [open](python-ab-testing-kit-ef48d271.md) |
| abc-test-ti-client | Testing Framework | [open](python-abc-test-ti-client-a81109e0.md) |
| abcd-divami-testing | Testing Framework | [open](python-abcd-divami-testing-673d9250.md) |
| abcdef-test-ti-client | Testing Framework | [open](python-abcdef-test-ti-client-426f2924.md) |
| abs-web-testing | Testing Framework | [open](python-abs-web-testing-a461fbc6.md) |
