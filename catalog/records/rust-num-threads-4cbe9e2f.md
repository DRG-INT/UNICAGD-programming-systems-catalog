...
<!-- canonical: https://crates.io/crates/num_threads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num_threads](https://crates.io/crates/num_threads) |
| Source record ids | crates_io-3701313c025622 |
...
For a systems engineer, num_threads belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2024-02-15T02:51:38.770784Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-3701313c025622` from `crates_io` as `registry_expansion`
