...
<!-- canonical: https://github.com/DISCOWER/bsk-ros2-bridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DISCOWER/bsk-ros2-bridge](https://github.com/DISCOWER/bsk-ros2-bridge) |
| Source record ids | github_search_basilisk-493344f91d1ca9 |

## System Engineer Summary

An open-source ROS 2 bridge for the Basilisk astrodynamics simulator enabling real-time spacecraft
simulation and reusable autonomy software across simulation and hardware setups.

## Operational Role

For a systems engineer, DISCOWER/bsk-ros2-bridge belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T16:24:45Z | gh search repos basilisk astrodynamics | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-493344f91d1ca9` from `github_search_basilisk` as `registry_expansion`
