...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoltzmannMachines](https://github.com/JuliaRegistries/General/tree/master/B/BoltzmannMachines) |
| Source record ids | julia_general-f2b700239276b3 |

## System Engineer Summary

Julia package registered in General at B/BoltzmannMachines.

## Operational Role

For a systems engineer, BoltzmannMachines belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoltzmannMachines", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f2b700239276b3` from `julia_general` as `registry_expansion`
