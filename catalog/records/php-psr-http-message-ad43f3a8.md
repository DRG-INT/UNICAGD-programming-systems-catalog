...
<!-- canonical: https://packagist.org/packages/psr/http-message -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/psr/http-message](https://packagist.org/packages/psr/http-message) |
| Source record ids | packagist_search-c025dcfabc3fde |
...
For a systems engineer, psr/http-message belongs in the PHP inventory as part of service
...
- `packagist_search-c025dcfabc3fde` from `packagist_search` as `registry_expansion`
