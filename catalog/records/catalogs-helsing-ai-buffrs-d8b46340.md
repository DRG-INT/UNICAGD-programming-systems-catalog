...
<!-- canonical: https://github.com/helsing-ai/buffrs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/helsing-ai/buffrs](https://github.com/helsing-ai/buffrs) |
| Source record ids | github_search_catalogs-88fa11a9e0f239 |
...
For a systems engineer, helsing-ai/buffrs belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-27T06:56:00Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-88fa11a9e0f239` from `github_search_catalogs` as `registry_expansion`
