...
<!-- canonical: https://github.com/gammasoft71/xtd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gammasoft71/xtd](https://github.com/gammasoft71/xtd) |
| Source record ids | awesome_list-309b842de2a0b6 |

## System Engineer Summary

Modern C++20 framework to create console (CLI), forms (GUI) and unit tests (xUnit) applications on
Windows, macOS, Linux, iOS, Android, FreeBSD and Haiku. MIT

## Operational Role

For a systems engineer, xtd belongs in the C++23 inventory as part of unit/integration validation,
...
- `awesome_list-309b842de2a0b6` from `awesome_list` as `registry_expansion`
