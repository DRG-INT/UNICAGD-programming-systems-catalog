...
<!-- canonical: https://gitlab.com/Shinobi-Systems/ShinobiCE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/Shinobi-Systems/ShinobiCE](https://gitlab.com/Shinobi-Systems/ShinobiCE) |
| Source record ids | gitlab_projects_api-bcaeefb393deac |

## System Engineer Summary

Shinobi Community Edition (CE) is a GPLv3+AGPLv3 release of Shinobi. The Free Open Source CCTV
platform written in Node.JS (Camera Recorder - Security Surveillance Software - Restreamer.

## Operational Role

For a systems engineer, Shinobi-Systems/ShinobiCE belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-bcaeefb393deac` from `gitlab_projects_api` as `registry_expansion`
