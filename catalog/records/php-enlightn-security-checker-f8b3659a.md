...
| Canonical URL | [https://packagist.org/packages/enlightn/security-checker](https://packagist.org/packages/enlightn/security-checker) |
| Source record ids | packagist_search-c74e6a7168e7d9 |
...
For a systems engineer, enlightn/security-checker belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.0 | 2023-12-10T07:20:45+00:00 | [https://repo.packagist.org/p2/enlightn/security-checker.json](https://repo.packagist.org/p2/enlightn/security-checker.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/enlightn/security-checker.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-c74e6a7168e7d9` from `packagist_search` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cerbero/json-parser | Dependency Manager | [open](php-cerbero-json-parser-38e82bf8.md) |
