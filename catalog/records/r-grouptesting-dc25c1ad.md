...
<!-- canonical: https://cran.r-project.org/web/packages/groupTesting/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/groupTesting/index.html](https://cran.r-project.org/web/packages/groupTesting/index.html) |
| Source record ids | cran_packages_by_date-2378ad52b07d9f |
...
For a systems engineer, groupTesting belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-09-08 07:00:02 UTC | [https://cran.r-project.org/web/packages/groupTesting/DESCRIPTION](https://cran.r-project.org/web/packages/groupTesting/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/groupTesting/DESCRIPTION` at `2026-09-08T08:22:37+00:00`.
...
- `cran_packages_by_date-2378ad52b07d9f` from `cran_packages_by_date` as `registry_expansion`
