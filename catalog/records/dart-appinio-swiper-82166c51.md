...
<!-- canonical: https://pub.dev/packages/appinio_swiper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/appinio_swiper](https://pub.dev/packages/appinio_swiper) |
| Source record ids | pub_dev-dd99cf9eb168a2 |

## System Engineer Summary

An awesome fully custamisable Tinder Card Swiper which allows swiping in all directions with any
Custom Widget (Stateless or Statefull).

## Operational Role

For a systems engineer, appinio_swiper belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2024-04-15T11:05:20.329795Z | [https://pub.dev/api/packages/appinio_swiper](https://pub.dev/api/packages/appinio_swiper) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/appinio_swiper` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-dd99cf9eb168a2` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| hive_ce | Community Reference | [open](dart-hive-ce-4ae295fe.md) |
