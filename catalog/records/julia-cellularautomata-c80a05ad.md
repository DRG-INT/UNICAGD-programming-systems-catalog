...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CellularAutomata](https://github.com/JuliaRegistries/General/tree/master/C/CellularAutomata) |
| Source record ids | julia_general-aac8e555c0c6fd |

## System Engineer Summary

Julia package registered in General at C/CellularAutomata.

## Operational Role

For a systems engineer, CellularAutomata belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CellularAutomata", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-aac8e555c0c6fd` from `julia_general` as `registry_expansion`
