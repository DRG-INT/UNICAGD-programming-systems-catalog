...
| Canonical URL | [https://github.com/Yonaba/30log](https://github.com/Yonaba/30log) |
| Source record ids | lua-source-209 |
...
For a systems engineer, 30log belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 30log-1.3.0-1 | 2016-10-24T13:56:07Z | [https://api.github.com/repos/Yonaba/30log/releases/latest](https://api.github.com/repos/Yonaba/30log/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Yonaba/30log/releases/latest` at `2026-09-01T03:21:50+00:00`.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 209}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-209` from `master_json` as `source_list_item`
