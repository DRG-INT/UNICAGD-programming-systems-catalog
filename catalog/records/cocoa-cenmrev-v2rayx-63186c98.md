...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Cenmrev/V2RayX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cenmrev/V2RayX](https://github.com/Cenmrev/V2RayX) |
| Source record ids | github_search_cocoa-437cf00915eec4 |
...
For a systems engineer, Cenmrev/V2RayX belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | unknown |  |  | unknown | not_a_cocoapods_name |
| preview/nightly | unknown |  |  | unknown | not_a_cocoapods_name |
...
- Stable release is unknown because `not_a_cocoapods_name`.
- Preview/nightly metadata is unknown because `not_a_cocoapods_name`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Objective-C stars:>1000", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_cocoa-437cf00915eec4` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AFNetworking/AFNetworking | Language Specification | [open](cocoa-afnetworking-afnetworking-b2e7cf91.md) |
| alcatraz/Alcatraz | Language Specification | [open](cocoa-alcatraz-alcatraz-32db9c72.md) |
| AloneMonkey/MonkeyDev | Language Specification | [open](cocoa-alonemonkey-monkeydev-a3ce0e4e.md) |
| Aufree/trip-to-iOS | Language Specification | [open](cocoa-aufree-trip-to-ios-ceb0e182.md) |
| banchichen/TZImagePickerController | Language Specification | [open](cocoa-banchichen-tzimagepickercontroller-5178e358.md) |
| bang590/JSPatch | Language Specification | [open](cocoa-bang590-jspatch-c190338f.md) |
| BlocksKit/BlocksKit | Language Specification | [open](cocoa-blockskit-blockskit-67f6ef55.md) |
| BradLarson/GPUImage | Language Specification | [open](cocoa-bradlarson-gpuimage-287e066a.md) |
