...
<!-- canonical: https://cran.r-project.org/web/packages/xxdi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xxdi/index.html](https://cran.r-project.org/web/packages/xxdi/index.html) |
| Source record ids | cran_packages_by_date-f3d77ee8923b9c |
...
For a systems engineer, xxdi belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.8 | 2026-08-22 15:20:02 UTC | [https://cran.r-project.org/web/packages/xxdi/DESCRIPTION](https://cran.r-project.org/web/packages/xxdi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xxdi/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f3d77ee8923b9c` from `cran_packages_by_date` as `registry_expansion`
