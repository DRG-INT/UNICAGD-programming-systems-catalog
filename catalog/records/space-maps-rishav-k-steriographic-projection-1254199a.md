# Rishav-k/Steriographic-Projection
...
<!-- canonical: https://github.com/Rishav-k/Steriographic-Projection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Rishav-k/Steriographic-Projection](https://github.com/Rishav-k/Steriographic-Projection) |
| Source record ids | github_search_space_maps-255aff02d423e9 |

## System Engineer Summary

JavaScript code for stereographic projection of planes . The stereographic is the only projection
that maps all circles on a sphere to circles on a plane. This property is valuable in planetary
mapping .

## Operational Role

For a systems engineer, Rishav-k/Steriographic-Projection belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-06T10:14:55Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-255aff02d423e9` from `github_search_space_maps` as `registry_expansion`
