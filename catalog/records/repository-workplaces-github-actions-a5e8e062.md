...
<!-- canonical: https://docs.github.com/actions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.github.com/actions](https://docs.github.com/actions) |
| Source record ids | curated_repository_workplace_routes-49b04a799fd505 |

## System Engineer Summary

GitHub workflow automation system for CI, release, deployment, security scanning, package
publication, and scheduled jobs.

## Operational Role

For a systems engineer, GitHub Actions belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-49b04a799fd505` from `curated_repository_workplace_routes` as `registry_expansion`
