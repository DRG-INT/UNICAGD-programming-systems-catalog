...
| Canonical URL | [https://github.com/rbgirshick/rcnn](https://github.com/rbgirshick/rcnn) |
| Source record ids | github_search_matlab-f5649a58db17a0 |
...
For a systems engineer, rbgirshick/rcnn belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | CVPR14 | 2014-05-23T18:05:15Z | [https://api.github.com/repos/rbgirshick/rcnn/releases/latest](https://api.github.com/repos/rbgirshick/rcnn/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rbgirshick/rcnn/releases/latest` at `2026-09-01T07:24:13+00:00`.
...
- `github_search_matlab-f5649a58db17a0` from `github_search_matlab` as `registry_expansion`
