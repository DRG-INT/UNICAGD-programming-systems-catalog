...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Data Science](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/data-science.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/chuanwen/dataframe](https://luarocks.org/modules/chuanwen/dataframe) |
| Source record ids | luarocks_root_manifest-02570e9b48014f |

## System Engineer Summary

A dataframe class for Lua/Torch

## Operational Role

For a systems engineer, dataframe belongs in the Lua family inventory as part of ecosystem
