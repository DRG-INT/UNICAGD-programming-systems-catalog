...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/chuanwen/dataframe -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-02570e9b48014f` from `luarocks_root_manifest` as `registry_expansion`
