...
<!-- canonical: https://github.com/SpecDriven/insurance-cap-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SpecDriven/insurance-cap-java](https://github.com/SpecDriven/insurance-cap-java) |
| Source record ids | github_search_sapjava-8e03b498d428a5 |

## System Engineer Summary

Spec-driven Example of an insurance company using SAP CAP Java framework.

## Operational Role

For a systems engineer, SpecDriven/insurance-cap-java belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T21:01:07Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-8e03b498d428a5` from `github_search_sapjava` as `registry_expansion`
...
| com.sap.cloud.sdk.frameworks:frameworks-parent | Framework | [open](sapjava-com-sap-cloud-sdk-frameworks-frameworks-parent-7c324073.md) |
