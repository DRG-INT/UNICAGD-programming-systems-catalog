...
<!-- canonical: https://github.com/KrauseFx/TSMessages -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KrauseFx/TSMessages](https://github.com/KrauseFx/TSMessages) |
| Source record ids | github_search_cocoa-2e2bb65cf8b67f |
...
For a systems engineer, KrauseFx/TSMessages belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-01T11:22:32Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-2e2bb65cf8b67f` from `github_search_cocoa` as `registry_expansion`
