...
| Source record ids | curated_language_routes-5de24d57ef5667 |

## System Engineer Summary

Self-hostable font package registry and package generation workflow for web font assets.

## Operational Role

For a systems engineer, Fontsource belongs in the Assets inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | core-v0.3.0 | 2026-07-26T04:40:33Z | [https://api.github.com/repos/fontsource/fontsource/releases/latest](https://api.github.com/repos/fontsource/fontsource/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fontsource/fontsource/releases/latest` at `2026-09-01T07:24:42+00:00`.
...
- `curated_language_routes-5de24d57ef5667` from `curated_language_routes` as `registry_expansion`
