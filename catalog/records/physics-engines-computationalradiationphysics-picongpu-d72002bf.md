...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ComputationalRadiationPhysics/picongpu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ComputationalRadiationPhysics/picongpu](https://github.com/ComputationalRadiationPhysics/picongpu) |
| Source record ids | github_search_physics_engines-b529aa7b00b822 |
...
For a systems engineer, ComputationalRadiationPhysics/picongpu belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:25:25Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Other |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:physics-simulation stars:>50", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_physics_engines-b529aa7b00b822` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| appsinacup/godot-rapier-physics | Benchmarking | [open](physics-engines-appsinacup-godot-rapier-physics-8b7bf348.md) |
| ARISE-Initiative/robosuite | Benchmarking | [open](physics-engines-arise-initiative-robosuite-9cb42fcd.md) |
| erizmr/SPH_Taichi | Benchmarking | [open](physics-engines-erizmr-sph-taichi-9e9af1c3.md) |
| Genbox/VelcroPhysics | Benchmarking | [open](physics-engines-genbox-velcrophysics-7229cf93.md) |
| jerry060599/YarnBall | Benchmarking | [open](physics-engines-jerry060599-yarnball-d2f475f3.md) |
| projectchrono/chrono | Benchmarking | [open](physics-engines-projectchrono-chrono-d6f1722c.md) |
| simbody/simbody | Benchmarking | [open](physics-engines-simbody-simbody-5d8afc3b.md) |
