...
<!-- canonical: https://github.com/Fourmilab/YourSky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Fourmilab/YourSky](https://github.com/Fourmilab/YourSky) |
| Source record ids | github_search_space_maps-fc6109ab059e9c |

## System Engineer Summary

Web pages, source code, databases, and resources for Fourmilab's Your Sky Web resource, which
produces custom sky maps, horizon views, and virtual telescope images for any location on Earth,
date, and time.

## Operational Role

For a systems engineer, Fourmilab/YourSky belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-26T16:19:43Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-fc6109ab059e9c` from `github_search_space_maps` as `registry_expansion`
