...
<!-- canonical: https://github.com/openeventdata/mordecai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openeventdata/mordecai](https://github.com/openeventdata/mordecai) |
| Source record ids | github_search_maps-d9695571691f28 |
...
For a systems engineer, openeventdata/mordecai belongs in the Maps inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.0 | 2020-07-16T21:37:57Z | [https://api.github.com/repos/openeventdata/mordecai/releases/latest](https://api.github.com/repos/openeventdata/mordecai/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/openeventdata/mordecai/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-d9695571691f28` from `github_search_maps` as `registry_expansion`
