...
<!-- canonical: https://pub.dev/packages/pay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pay](https://pub.dev/packages/pay) |
| Source record ids | pub_dev-04507ab6937239 |
...
For a systems engineer, pay belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2025-11-21T15:29:18.985777Z | [https://pub.dev/api/packages/pay](https://pub.dev/api/packages/pay) |  |
| preview | known | 3.0.0-beta.2 | 2024-10-10T14:59:21.685827Z | [https://pub.dev/api/packages/pay](https://pub.dev/api/packages/pay) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pay` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-04507ab6937239` from `pub_dev` as `registry_expansion`
