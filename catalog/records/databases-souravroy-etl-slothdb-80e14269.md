...
<!-- canonical: https://github.com/SouravRoy-ETL/slothdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SouravRoy-ETL/slothdb](https://github.com/SouravRoy-ETL/slothdb) |
| Source record ids | github_search_databases-3d7063f39b79f2 |

## System Engineer Summary

An experimental embedded SQL engine in C++20. Query Parquet, CSV, JSON, Arrow, Avro, SQLite, and
Excel files directly with SQL, in-process. Early-stage.

## Operational Role

For a systems engineer, SouravRoy-ETL/slothdb belongs in the Databases inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T08:55:27Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3d7063f39b79f2` from `github_search_databases` as `registry_expansion`
