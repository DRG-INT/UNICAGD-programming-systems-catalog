...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Yalantis/Persei -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Yalantis/Persei](https://github.com/Yalantis/Persei) |
| Source record ids | github_search_cocoa-0148f2d2024302 |
...
For a systems engineer, Yalantis/Persei belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-22T09:42:56Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0148f2d2024302` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BeauNouvelle/FaceAware | Visualization Gui | [open](cocoa-beaunouvelle-faceaware-a6b691c0.md) |
| BenEmdon/CenteredCollectionView | Visualization Gui | [open](cocoa-benemdon-centeredcollectionview-086c96b7.md) |
| Charts | Visualization Gui | [open](cocoa-charts-c4279276.md) |
| Clean Architecture for SwiftUI + Combine | Visualization Gui | [open](cocoa-clean-architecture-for-swiftui-combine-0c7b4e0d.md) |
| exyte/ConcentricOnboarding | Visualization Gui | [open](cocoa-exyte-concentriconboarding-c9203ac5.md) |
| fdzsergio/SFFocusViewLayout | Visualization Gui | [open](cocoa-fdzsergio-sffocusviewlayout-b221b24a.md) |
| fermoya/SwiftUIPager | Visualization Gui | [open](cocoa-fermoya-swiftuipager-eda23130.md) |
| gmarm/BetterSegmentedControl | Visualization Gui | [open](cocoa-gmarm-bettersegmentedcontrol-996fc5ef.md) |
