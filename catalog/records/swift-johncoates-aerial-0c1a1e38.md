...
<!-- canonical: https://github.com/JohnCoates/Aerial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JohnCoates/Aerial](https://github.com/JohnCoates/Aerial) |
| Source record ids | github_search_swift-1feb07ee37c24a |
...
For a systems engineer, JohnCoates/Aerial belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-1feb07ee37c24a` from `github_search_swift` as `registry_expansion`
...
| ReSwift/ReSwift | Library | [open](swift-reswift-reswift-732fe5d0.md) |
