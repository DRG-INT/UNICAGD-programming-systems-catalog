# kabincs9/areaterra-depin-colosseum-hackathon-2026

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kabincs9/areaterra-depin-colosseum-hackathon-2026 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kabincs9/areaterra-depin-colosseum-hackathon-2026](https://github.com/kabincs9/areaterra-depin-colosseum-hackathon-2026) |
| Source record ids | github_search_space_maps-d63dae85a3b0ea |

## System Engineer Summary

AREATERRA is a planetary-scale coordinate indexing protocol built on Solana using state compression
and Concurrent Merkle Trees. It demonstrates how to map, index, and verify 14.4 million sectors (100
km² each) of Martian terrain — with precise coordinates, resources, elevation, and environmental
data — for just ~$110 in total cost.

## Operational Role

For a systems engineer, kabincs9/areaterra-depin-colosseum-hackathon-2026 belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-12T00:25:55Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d63dae85a3b0ea` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ian-chuang/homestri-ur5e-rl | Configuration | [open](space-maps-ian-chuang-homestri-ur5e-rl-8c66cf57.md) |
| pedrohasselmann/shapeimager | Configuration | [open](space-maps-pedrohasselmann-shapeimager-0feb6d44.md) |
