...
| Canonical URL | [https://luarocks.org/modules/drmargarido/image_handler](https://luarocks.org/modules/drmargarido/image_handler) |
| Source record ids | luarocks_root_manifest-cff6a5f4c55afd |

## System Engineer Summary

Common code to handle images when submitted to an application

## Operational Role

For a systems engineer, image_handler belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-cff6a5f4c55afd` from `luarocks_root_manifest` as `registry_expansion`
