...
<!-- canonical: https://luarocks.org/modules/muniftanjim/dummy.lua -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-b80d2642dd1e3a` from `luarocks_root_manifest` as `registry_expansion`
...
| epstopdf-pkg | Package Manager | [open](lua-family-epstopdf-pkg-b654c55b.md) |
