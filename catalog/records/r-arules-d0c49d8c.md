...
<!-- canonical: https://cran.r-project.org/web/packages/arules/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/arules/index.html](https://cran.r-project.org/web/packages/arules/index.html) |
| Source record ids | cran_packages_by_date-3582e9e7e5bdf0 |
...
For a systems engineer, arules belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.15 | 2026-09-11 06:00:02 UTC | [https://cran.r-project.org/web/packages/arules/DESCRIPTION](https://cran.r-project.org/web/packages/arules/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/arules/DESCRIPTION` at `2026-09-11T06:25:06+00:00`.
...
- `cran_packages_by_date-3582e9e7e5bdf0` from `cran_packages_by_date` as `registry_expansion`
