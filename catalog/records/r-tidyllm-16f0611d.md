...
<!-- canonical: https://cran.r-project.org/web/packages/tidyllm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidyllm/index.html](https://cran.r-project.org/web/packages/tidyllm/index.html) |
| Source record ids | cran_packages_by_date-71168310cb6c2b |
...
For a systems engineer, tidyllm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-08 09:00:02 UTC | [https://cran.r-project.org/web/packages/tidyllm/DESCRIPTION](https://cran.r-project.org/web/packages/tidyllm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidyllm/DESCRIPTION` at `2026-09-08T10:21:44+00:00`.
...
- `cran_packages_by_date-71168310cb6c2b` from `cran_packages_by_date` as `registry_expansion`
