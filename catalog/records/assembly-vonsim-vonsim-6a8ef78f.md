...
<!-- canonical: https://github.com/vonsim/vonsim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vonsim/vonsim](https://github.com/vonsim/vonsim) |
| Source record ids | github_search_assembly-4decd4e92c1c2d |
...
For a systems engineer, vonsim/vonsim belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-29T02:08:00Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-4decd4e92c1c2d` from `github_search_assembly` as `registry_expansion`
