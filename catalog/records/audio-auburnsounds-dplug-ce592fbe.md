...
<!-- canonical: https://github.com/AuburnSounds/Dplug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AuburnSounds/Dplug](https://github.com/AuburnSounds/Dplug) |
| Source record ids | github_search_audio-246f8d90216982 |
...
For a systems engineer, AuburnSounds/Dplug belongs in the Audio inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T07:56:08Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-246f8d90216982` from `github_search_audio` as `registry_expansion`
