...
<!-- canonical: https://cran.r-project.org/web/packages/crs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crs/index.html](https://cran.r-project.org/web/packages/crs/index.html) |
| Source record ids | cran_packages_by_date-37cfc660912546 |
...
For a systems engineer, crs belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15-46 | 2026-08-19 16:40:02 UTC | [https://cran.r-project.org/web/packages/crs/DESCRIPTION](https://cran.r-project.org/web/packages/crs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crs/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-37cfc660912546` from `cran_packages_by_date` as `registry_expansion`
