...
<!-- canonical: https://cran.r-project.org/web/packages/BioGSP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BioGSP/index.html](https://cran.r-project.org/web/packages/BioGSP/index.html) |
| Source record ids | cran_packages_by_date-d3611ec12fd512 |
...
For a systems engineer, BioGSP belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-15 22:10:19 UTC | [https://cran.r-project.org/web/packages/BioGSP/DESCRIPTION](https://cran.r-project.org/web/packages/BioGSP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BioGSP/DESCRIPTION` at `2026-09-15T22:19:01+00:00`.
...
- `cran_packages_by_date-d3611ec12fd512` from `cran_packages_by_date` as `registry_expansion`
