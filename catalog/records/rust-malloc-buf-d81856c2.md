...
| Canonical URL | [https://crates.io/crates/malloc_buf](https://crates.io/crates/malloc_buf) |
| Source record ids | crates_io-c501ea61b865a6 |
...
For a systems engineer, malloc_buf belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2017-02-20T05:43:29.488400Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-c501ea61b865a6` from `crates_io` as `registry_expansion`
