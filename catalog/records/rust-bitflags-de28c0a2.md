...
<!-- canonical: https://crates.io/crates/bitflags -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bitflags](https://crates.io/crates/bitflags) |
| Source record ids | crates_io-9e1cec64089e75 |
...
For a systems engineer, bitflags belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.13.2 | 2026-09-10T01:11:38.500809Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-10T02:20:18+00:00`.
...
- `crates_io-9e1cec64089e75` from `crates_io` as `registry_expansion`
