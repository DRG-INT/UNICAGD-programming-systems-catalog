...
<!-- canonical: https://cran.r-project.org/web/packages/hydrodownloadR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hydrodownloadR/index.html](https://cran.r-project.org/web/packages/hydrodownloadR/index.html) |
| Source record ids | cran_packages_by_date-368044b16c7244 |

## System Engineer Summary

Hydrologic Station Catalogs and Time Series from Public APIs

## Operational Role

For a systems engineer, hydrodownloadR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-14 22:40:02 UTC | [https://cran.r-project.org/web/packages/hydrodownloadR/DESCRIPTION](https://cran.r-project.org/web/packages/hydrodownloadR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hydrodownloadR/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-368044b16c7244` from `cran_packages_by_date` as `registry_expansion`
