...
<!-- canonical: https://pypi.org/project/acceldata-o2a-lib/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acceldata-o2a-lib/](https://pypi.org/project/acceldata-o2a-lib/) |
| Source record ids | pypi_simple-0cc2397b80912d |

## System Engineer Summary

Additional library for Oozie To Airflow migration tool

## Operational Role

For a systems engineer, acceldata-o2a-lib belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-05-15T09:38:07.477710Z | [https://pypi.org/pypi/acceldata-o2a-lib/json](https://pypi.org/pypi/acceldata-o2a-lib/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acceldata-o2a-lib/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-0cc2397b80912d` from `pypi_simple` as `registry_expansion`
