...
<!-- canonical: https://github.com/yds12/x64-roadmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yds12/x64-roadmap](https://github.com/yds12/x64-roadmap) |
| Source record ids | github_search_assembly-31b60678cfda81 |
...
For a systems engineer, yds12/x64-roadmap belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-16T15:54:20Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-31b60678cfda81` from `github_search_assembly` as `registry_expansion`
