# AVISEngine/AVIS-Engine-Python-API
...
<!-- canonical: https://github.com/AVISEngine/AVIS-Engine-Python-API -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AVISEngine/AVIS-Engine-Python-API](https://github.com/AVISEngine/AVIS-Engine-Python-API) |
| Source record ids | github_search_engines-3ffc82d3e2a3a0 |

## System Engineer Summary

AVISEngine/AVIS-Engine-Python-API is tracked as a game engine game dev record in the Engines branch.
...
For a systems engineer, AVISEngine/AVIS-Engine-Python-API belongs in the Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-20T11:25:01Z | gh search repos topic:simulation-engine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-3ffc82d3e2a3a0` from `github_search_engines` as `registry_expansion`
