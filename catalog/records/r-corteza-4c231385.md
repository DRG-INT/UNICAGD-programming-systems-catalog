...
<!-- canonical: https://cran.r-project.org/web/packages/corteza/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/corteza/index.html](https://cran.r-project.org/web/packages/corteza/index.html) |
| Source record ids | cran_packages_by_date-6bf997d0da7d16 |

## System Engineer Summary

corteza is tracked as an interpreter runtime record in the R branch. The source did not provide a
...
For a systems engineer, corteza belongs in the R inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-08-05 09:20:22 UTC | [https://cran.r-project.org/web/packages/corteza/DESCRIPTION](https://cran.r-project.org/web/packages/corteza/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/corteza/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6bf997d0da7d16` from `cran_packages_by_date` as `registry_expansion`
