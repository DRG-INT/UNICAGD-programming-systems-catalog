...
<!-- canonical: https://github.com/jdbc-observations/datasource-proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jdbc-observations/datasource-proxy](https://github.com/jdbc-observations/datasource-proxy) |
| Source record ids | github_search_databases-0871bca7e74763 |
...
For a systems engineer, jdbc-observations/datasource-proxy belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-14T04:03:40Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0871bca7e74763` from `github_search_databases` as `registry_expansion`
