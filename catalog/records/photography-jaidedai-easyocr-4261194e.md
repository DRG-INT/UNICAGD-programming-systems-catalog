...
<!-- canonical: https://github.com/JaidedAI/EasyOCR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JaidedAI/EasyOCR](https://github.com/JaidedAI/EasyOCR) |
| Source record ids | github_search_photography-8093d1aa83d2ef |

## System Engineer Summary

Ready-to-use OCR with 80+ supported languages and all popular writing scripts including Latin,
Chinese, Arabic, Devanagari, Cyrillic and etc.

## Operational Role

For a systems engineer, JaidedAI/EasyOCR belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-05T12:23:12Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-8093d1aa83d2ef` from `github_search_photography` as `registry_expansion`
