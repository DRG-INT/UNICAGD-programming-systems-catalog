...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gwastro/pycbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gwastro/pycbc](https://github.com/gwastro/pycbc) |
| Source record ids | github_search_telescopes-e6de3e23825004 |

## System Engineer Summary

Core package to analyze gravitational-wave data, find signals, and study their parameters. This
package was used in the first direct detection of gravitational waves (GW150914), and is used in the
ongoing analysis of LIGO/Virgo data.

## Operational Role

For a systems engineer, gwastro/pycbc belongs in the Telescopes inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T08:59:30Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-e6de3e23825004` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Hrishikesh332/Astronomy_Analysis | Static Analyzer | [open](telescopes-hrishikesh332-astronomy-analysis-714231c8.md) |
| iraf-community/iraf | Static Analyzer | [open](telescopes-iraf-community-iraf-5c34feb3.md) |
| lightkurve/lightkurve | Static Analyzer | [open](telescopes-lightkurve-lightkurve-47762682.md) |
| mengchaoheng/PINDI | Static Analyzer | [open](telescopes-mengchaoheng-pindi-082f8769.md) |
| RononDex/Astrobot | Static Analyzer | [open](telescopes-ronondex-astrobot-cb92f0ee.md) |
