...
<!-- canonical: https://github.com/mozilla-mobile/firefox-ios -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mozilla-mobile/firefox-ios](https://github.com/mozilla-mobile/firefox-ios) |
| Source record ids | github_search_swift-a834c8c5569eb0 |

## System Engineer Summary

mozilla-mobile/firefox-ios is tracked as a filesystem os record in the Swift branch. The source did
...
For a systems engineer, mozilla-mobile/firefox-ios belongs in the Swift inventory as part of
...
- `github_search_swift-a834c8c5569eb0` from `github_search_swift` as `registry_expansion`
