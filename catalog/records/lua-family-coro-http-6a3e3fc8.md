...
<!-- canonical: https://luarocks.org/modules/code-nuage/coro-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/code-nuage/coro-http](https://luarocks.org/modules/code-nuage/coro-http) |
| Source record ids | luarocks_root_manifest-936fc91cab637c |

## System Engineer Summary

coro-http is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, coro-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-936fc91cab637c` from `luarocks_root_manifest` as `registry_expansion`
