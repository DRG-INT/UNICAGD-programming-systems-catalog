# denkywu/InSAR-Simulation-and-Studies
...
<!-- canonical: https://github.com/denkywu/InSAR-Simulation-and-Studies -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/denkywu/InSAR-Simulation-and-Studies](https://github.com/denkywu/InSAR-Simulation-and-Studies) |
| Source record ids | github_search_radars-b909f68db93587 |

## System Engineer Summary

干涉合成孔径雷达 相关。Some work I did during my graduate studies (Matlab Code) : (2) InSAR Simulation and
Studies.

## Operational Role

For a systems engineer, denkywu/InSAR-Simulation-and-Studies belongs in the Radars inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-03T03:51:40Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-b909f68db93587` from `github_search_radars` as `registry_expansion`
