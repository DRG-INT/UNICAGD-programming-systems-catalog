...
| Source record ids | curated_database_systems-dbf7723a890100 |

## System Engineer Summary

REST API server generated from PostgreSQL schemas.

## Operational Role

For a systems engineer, PostgREST belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-dbf7723a890100` from `curated_database_systems` as `registry_expansion`
