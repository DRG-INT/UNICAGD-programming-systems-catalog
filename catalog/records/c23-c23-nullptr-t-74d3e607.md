...
| Source record ids | corpus-7f48114c3f2eb5 |

## System Engineer Summary

C23 nullptr_t is tracked as a standard library record in the C23 branch. The source did not provide
...
For a systems engineer, C23 nullptr_t belongs in the C23 inventory as part of ecosystem capability
...
- `corpus-7f48114c3f2eb5` from `master_json` as `standard_library`
