...
<!-- canonical: https://github.com/streamlink/streamlink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/streamlink/streamlink](https://github.com/streamlink/streamlink) |
| Source record ids | github_search_video-34225b5798f947 |
...
For a systems engineer, streamlink/streamlink belongs in the Video inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:41:32Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-34225b5798f947` from `github_search_video` as `registry_expansion`
