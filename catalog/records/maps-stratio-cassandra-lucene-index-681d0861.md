...
| Source record ids | github_search_maps-ca0c2ff47d1aac |
...
For a systems engineer, Stratio/cassandra-lucene-index belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-27T11:21:14Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-ca0c2ff47d1aac` from `github_search_maps` as `registry_expansion`
