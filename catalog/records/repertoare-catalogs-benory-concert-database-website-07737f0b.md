# benory/Concert-database-website
...
<!-- canonical: https://github.com/benory/Concert-database-website -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/benory/Concert-database-website](https://github.com/benory/Concert-database-website) |
| Source record ids | github_search_repertoare_catalogs-2bf5d993a01eed |

## System Engineer Summary

A project tracking public performances of medieval and Renaissance music, 1915–60 in Europe and the
United States. Addresses questions of canon formation, scholarly networks, and the development of
narratives about early music repertoires.

## Operational Role

For a systems engineer, benory/Concert-database-website belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-06T20:26:03Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Other |
...
- `github_search_repertoare_catalogs-2bf5d993a01eed` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| calewolf/Repertoire_App | Formatter | [open](repertoare-catalogs-calewolf-repertoire-app-32ab141a.md) |
