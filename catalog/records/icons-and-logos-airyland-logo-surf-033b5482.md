...
<!-- canonical: https://github.com/airyland/logo.surf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/airyland/logo.surf](https://github.com/airyland/logo.surf) |
| Source record ids | github_search_icons_and_logos-2e2cad09765190 |
...
For a systems engineer, airyland/logo.surf belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T18:42:33Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-2e2cad09765190` from `github_search_icons_and_logos` as `registry_expansion`
