...
<!-- canonical: https://pub.dev/packages/meta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/meta](https://pub.dev/packages/meta) |
| Source record ids | pub_dev-7f581b264aa572 |

## System Engineer Summary

Annotations used to express developer intentions that can't otherwise be deduced by statically
analyzing source code.

## Operational Role

For a systems engineer, meta belongs in the Dart inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.0 | 2026-07-09T12:54:28.000531Z | [https://pub.dev/api/packages/meta](https://pub.dev/api/packages/meta) |  |
| preview | known | 1.3.0-nullsafety.6 | 2020-11-03T21:18:46.482935Z | [https://pub.dev/api/packages/meta](https://pub.dev/api/packages/meta) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/meta` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-7f581b264aa572` from `pub_dev` as `registry_expansion`
