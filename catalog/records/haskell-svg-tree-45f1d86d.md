...
<!-- canonical: https://hackage.haskell.org/package/svg-tree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/svg-tree](https://hackage.haskell.org/package/svg-tree) |
| Source record ids | hackage_top_downloads-922b0e77f7c39f |
...
For a systems engineer, svg-tree belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2.4 | 2019-06-19T19:19:17Z | [https://hackage.haskell.org/package/svg-tree](https://hackage.haskell.org/package/svg-tree) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/svg-tree` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-922b0e77f7c39f` from `hackage_top_downloads` as `registry_expansion`
