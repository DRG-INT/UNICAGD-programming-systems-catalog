...
<!-- canonical: https://github.com/temporalio/temporal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/temporalio/temporal](https://github.com/temporalio/temporal) |
| Source record ids | github_search_go-5816d24e793108 |

## System Engineer Summary

temporalio/temporal is tracked as a library record in the Go branch. The source did not provide a
...
For a systems engineer, temporalio/temporal belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T21:57:48Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-5816d24e793108` from `github_search_go` as `registry_expansion`
