...
| Canonical URL | [https://crates.io/crates/geo-types](https://crates.io/crates/geo-types) |
| Source record ids | crates_io-a5597a0a5c5f57 |
...
For a systems engineer, geo-types belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.20 | 2026-08-02T18:34:27.887055Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-a5597a0a5c5f57` from `crates_io` as `registry_expansion`
