...
<!-- canonical: https://www.nuget.org/packages/System.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/System.Json](https://www.nuget.org/packages/System.Json) |
| Source record ids | nuget_search-7bb9abfe6246a6 |

## System Engineer Summary

System.Json is tracked as a serialization record in the C-Sharp branch. The source did not provide a
...
For a systems engineer, System.Json belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.0 | 2024-11-12T23:07:02.403+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.json/index.json) |  |
| preview | known | 4.7.0-preview3.19551.4 | 2019-11-13T23:09:17.247+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.json/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | ISC; MIT; https://www.nuget.org/packages/System.Json/4.8.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/system.json/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-7bb9abfe6246a6` from `nuget_search` as `registry_expansion`
