...
<!-- canonical: https://github.com/haowg/GODOT-VFX-LIBRARY -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/haowg/GODOT-VFX-LIBRARY](https://github.com/haowg/GODOT-VFX-LIBRARY) |
| Source record ids | github_search_effects-baa1b296b45119 |

## System Engineer Summary

A comprehensive collection of particle effects and shaders for Godot 4, designed specifically for
action games

## Operational Role

For a systems engineer, haowg/GODOT-VFX-LIBRARY belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-25T08:35:17Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-baa1b296b45119` from `github_search_effects` as `registry_expansion`
