...
<!-- canonical: https://crates.io/crates/lru -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lru](https://crates.io/crates/lru) |
| Source record ids | crates_io-3eebce3f1a435d |
...
For a systems engineer, lru belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.4 | 2026-09-03T00:26:06.507992Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-03T00:30:37+00:00`.
...
- `crates_io-3eebce3f1a435d` from `crates_io` as `registry_expansion`
