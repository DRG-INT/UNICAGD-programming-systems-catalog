...
| Canonical URL | [https://luarocks.org/modules/girvel/girvel](https://luarocks.org/modules/girvel/girvel) |
| Source record ids | luarocks_root_manifest-90948178861eea |

## System Engineer Summary

girvel's own lua framework for pipes, decorators etc

## Operational Role

For a systems engineer, girvel belongs in the Lua family inventory as part of dependency
...
- `luarocks_root_manifest-90948178861eea` from `luarocks_root_manifest` as `registry_expansion`
