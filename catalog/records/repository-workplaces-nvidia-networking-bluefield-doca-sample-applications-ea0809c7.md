# nvidia/networking/bluefield/doca-sample-applications
...
<!-- canonical: https://gitlab.com/nvidia/networking/bluefield/doca-sample-applications -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/nvidia/networking/bluefield/doca-sample-applications](https://gitlab.com/nvidia/networking/bluefield/doca-sample-applications) |
| Source record ids | gitlab_projects_api-cd57c535850eca |

## System Engineer Summary

Applications and code samples showing off the capabilities of NVIDIA's DOCA libraries and runtime.

## Operational Role

For a systems engineer, nvidia/networking/bluefield/doca-sample-applications belongs in the
...
- `gitlab_projects_api-cd57c535850eca` from `gitlab_projects_api` as `registry_expansion`
