...
<!-- canonical: https://cran.r-project.org/web/packages/BOLDNODE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BOLDNODE/index.html](https://cran.r-project.org/web/packages/BOLDNODE/index.html) |
| Source record ids | cran_packages_by_date-49aa9055c127fc |

## System Engineer Summary

Search and Explore BOLD Data Packages Efficiently

## Operational Role

For a systems engineer, BOLDNODE belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-09 16:30:31 UTC | [https://cran.r-project.org/web/packages/BOLDNODE/DESCRIPTION](https://cran.r-project.org/web/packages/BOLDNODE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BOLDNODE/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-49aa9055c127fc` from `cran_packages_by_date` as `registry_expansion`
