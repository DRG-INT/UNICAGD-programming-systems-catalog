...
<!-- canonical: https://github.com/DispatchCode/x64-Instruction-Decoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DispatchCode/x64-Instruction-Decoder](https://github.com/DispatchCode/x64-Instruction-Decoder) |
| Source record ids | github_search_assembly-11a80a900ac39e |
...
For a systems engineer, DispatchCode/x64-Instruction-Decoder belongs in the Assembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T13:50:56Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-11a80a900ac39e` from `github_search_assembly` as `registry_expansion`
