...
<!-- canonical: https://github.com/zyegfryed/django-statici18n -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zyegfryed/django-statici18n](https://github.com/zyegfryed/django-statici18n) |
| Source record ids | github_search_catalogs-4159feebd74661 |
...
For a systems engineer, zyegfryed/django-statici18n belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:13:48Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-4159feebd74661` from `github_search_catalogs` as `registry_expansion`
