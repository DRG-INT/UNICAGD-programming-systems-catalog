...
<!-- canonical: https://github.com/starkdmi/BrightXDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/starkdmi/BrightXDR](https://github.com/starkdmi/BrightXDR) |
| Source record ids | github_search_photography-6856e7add3cf69 |

## System Engineer Summary

Free and Open Source alternative to Vivid macOS application to extend Apple XDR display brightness
from 500 up to 1600 nits.

## Operational Role

For a systems engineer, starkdmi/BrightXDR belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-17T12:16:04Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-6856e7add3cf69` from `github_search_photography` as `registry_expansion`
