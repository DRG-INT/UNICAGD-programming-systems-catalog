...
<!-- canonical: https://github.com/mindeng/nom-exif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mindeng/nom-exif](https://github.com/mindeng/nom-exif) |
| Source record ids | github_search_photography-39edef3cf7cfd8 |

## System Engineer Summary

Exif/metadata parsing library written in pure Rust, both image (JPEG, PNG, WebP, HEIC/HEIF, AVIF,
TIFF, Phase One IIQ, Fujifilm RAF, Canon CR3) and video/audio (MP4, MOV, 3GP, MKV, WEBM, MKA) files
are supported.

## Operational Role

For a systems engineer, mindeng/nom-exif belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T22:57:11Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-39edef3cf7cfd8` from `github_search_photography` as `registry_expansion`
