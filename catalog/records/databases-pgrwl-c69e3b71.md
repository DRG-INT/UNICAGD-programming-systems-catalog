...
<!-- canonical: https://github.com/hashmap-kz/pgrwl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hashmap-kz/pgrwl](https://github.com/hashmap-kz/pgrwl) |
| Source record ids | awesome_list-e28bbe4c866421 |

## System Engineer Summary

Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly
alternative to pg_receivewal.

## Operational Role

For a systems engineer, pgrwl belongs in the Databases inventory as part of request routing,
...
- `awesome_list-e28bbe4c866421` from `awesome_list` as `registry_expansion`
