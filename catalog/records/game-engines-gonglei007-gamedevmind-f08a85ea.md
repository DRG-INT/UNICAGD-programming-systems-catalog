...
<!-- canonical: https://github.com/gonglei007/GameDevMind -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gonglei007/GameDevMind](https://github.com/gonglei007/GameDevMind) |
| Source record ids | github_search_game_engines-e936c2285b5c2c |
...
For a systems engineer, gonglei007/GameDevMind belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T08:52:49Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e936c2285b5c2c` from `github_search_game_engines` as `registry_expansion`
