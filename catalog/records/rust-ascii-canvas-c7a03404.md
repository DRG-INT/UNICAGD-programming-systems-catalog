...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/ascii-canvas -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2024-09-30T16:34:10.453811Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-12T00:25:38+00:00`.
...
- `crates_io-10e0c511ae98df` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ansi_term | Cli | [open](rust-ansi-term-9eed1b9c.md) |
| anstream | Cli | [open](rust-anstream-ad049df3.md) |
| anstyle-wincon | Cli | [open](rust-anstyle-wincon-ea8721d8.md) |
| arboard | Cli | [open](rust-arboard-38a301f5.md) |
| Clap | Cli | [open](rust-clap-0bd402a9.md) |
| clap_complete | Cli | [open](rust-clap-complete-57361877.md) |
| colored | Cli | [open](rust-colored-10ab0e14.md) |
| console | Cli | [open](rust-console-9d3db335.md) |
