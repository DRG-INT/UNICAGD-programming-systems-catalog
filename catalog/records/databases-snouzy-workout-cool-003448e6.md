...
<!-- canonical: https://github.com/Snouzy/workout-cool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Snouzy/workout-cool](https://github.com/Snouzy/workout-cool) |
| Source record ids | github_search_databases-c2688513ad0d03 |

## System Engineer Summary

🏋 Modern open-source fitness coaching platform. Create workout plans, track progress, and access a
comprehensive exercise database.

## Operational Role

For a systems engineer, Snouzy/workout-cool belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T11:30:12Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c2688513ad0d03` from `github_search_databases` as `registry_expansion`
