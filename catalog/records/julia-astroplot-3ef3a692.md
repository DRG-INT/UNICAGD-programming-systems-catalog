...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AstroPlot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AstroPlot](https://github.com/JuliaRegistries/General/tree/master/A/AstroPlot) |
| Source record ids | julia_general-8c5aefd7bcff15 |

## System Engineer Summary

Julia package registered in General at A/AstroPlot.

## Operational Role

For a systems engineer, AstroPlot belongs in the Julia inventory as part of language tooling, code
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AstroPlot", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-8c5aefd7bcff15` from `julia_general` as `registry_expansion`
