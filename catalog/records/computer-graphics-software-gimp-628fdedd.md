...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Computer Graphics Software](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/computer-graphics-software.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Computer Graphics Software |
| Category | Visualization Gui |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://gitlab.gnome.org/GNOME/gimp](https://gitlab.gnome.org/GNOME/gimp) |
| Source record ids | curated_language_routes-37e6ff806901b8 |

## System Engineer Summary

Raster image editor and graphics processing application with plug-ins, scripting, color, layers, and
export workflows.

## Operational Role

For a systems engineer, GIMP belongs in the Computer Graphics Software inventory as part of
...
| --- | --- | --- | --- |
| official_language_route | curated-extension-derived | 2026-09-01 | `{"kind": "official_language_route", "retrieved": "2026-09-01", "status": "curated-extension-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `curated_language_routes-37e6ff806901b8` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Blender | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-blender-a8b961fc.md) |
| FreeCAD | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-freecad-57741bc1.md) |
| Inkscape | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-inkscape-64bf343c.md) |
| Krita | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-krita-acc75c47.md) |
| OpenSCAD | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-openscad-568f45c5.md) |
| OpenSceneGraph | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-openscenegraph-7ecc79d2.md) |
| ParaView | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-paraview-f1c3ead5.md) |
| Processing | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/computer-graphics-software-processing-f616a109.md) |
