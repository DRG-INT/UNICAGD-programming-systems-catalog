...
<!-- canonical: https://packagist.org/packages/swayok/alternative-laravel-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/swayok/alternative-laravel-cache](https://packagist.org/packages/swayok/alternative-laravel-cache) |
| Source record ids | packagist_search-9679e63bd9c902 |

## System Engineer Summary

Replacements for Laravel's redis and file cache stores that properly implement tagging idea. Powered
by cache pool implementations provided by

## Operational Role

For a systems engineer, swayok/alternative-laravel-cache belongs in the PHP inventory as part of
...
- `packagist_search-9679e63bd9c902` from `packagist_search` as `registry_expansion`
