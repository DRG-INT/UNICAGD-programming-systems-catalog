...
<!-- canonical: https://github.com/CoderMJLee/MJExtension -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CoderMJLee/MJExtension](https://github.com/CoderMJLee/MJExtension) |
| Source record ids | github_search_cocoa-740a08e109e47b |

## System Engineer Summary

A fast, convenient and nonintrusive conversion framework between JSON and model. Your model class
doesn't need to extend any base class. You don't need to modify any model file.

## Operational Role

For a systems engineer, CoderMJLee/MJExtension belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-13T05:26:26Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_cocoa-740a08e109e47b` from `github_search_cocoa` as `registry_expansion`
