...
<!-- canonical: https://crates.io/crates/object -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/object](https://crates.io/crates/object) |
| Source record ids | crates_io-c5748472ccb96c |
...
For a systems engineer, object belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.40.0 | 2026-08-01T08:06:55.680121Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-c5748472ccb96c` from `crates_io` as `registry_expansion`
