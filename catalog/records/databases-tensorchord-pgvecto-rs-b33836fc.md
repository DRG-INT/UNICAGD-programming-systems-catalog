...
<!-- canonical: https://github.com/tensorchord/pgvecto.rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tensorchord/pgvecto.rs](https://github.com/tensorchord/pgvecto.rs) |
| Source record ids | github_search_databases-e954e29e859c11 |

## System Engineer Summary

Scalable, Low-latency and Hybrid-enabled Vector Search in Postgres. Revolutionize Vector Search, not
Database.

## Operational Role

For a systems engineer, tensorchord/pgvecto.rs belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-26T14:11:43Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e954e29e859c11` from `github_search_databases` as `registry_expansion`
