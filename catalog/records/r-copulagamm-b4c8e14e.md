...
<!-- canonical: https://cran.r-project.org/web/packages/CopulaGAMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CopulaGAMM/index.html](https://cran.r-project.org/web/packages/CopulaGAMM/index.html) |
| Source record ids | cran_packages_by_date-4189101a5c73c1 |
...
For a systems engineer, CopulaGAMM belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.4 | 2026-09-13 15:00:02 UTC | [https://cran.r-project.org/web/packages/CopulaGAMM/DESCRIPTION](https://cran.r-project.org/web/packages/CopulaGAMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CopulaGAMM/DESCRIPTION` at `2026-09-13T16:19:40+00:00`.
...
- `cran_packages_by_date-4189101a5c73c1` from `cran_packages_by_date` as `registry_expansion`
