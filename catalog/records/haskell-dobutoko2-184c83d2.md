...
<!-- canonical: https://hackage.haskell.org/package/dobutokO2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dobutokO2](https://hackage.haskell.org/package/dobutokO2) |
| Source record ids | hackage_top_downloads-7a2b0b8fa399dd |
...
For a systems engineer, dobutokO2 belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.45.3.0 | 2025-05-28T20:35:06Z | [https://hackage.haskell.org/package/dobutokO2](https://hackage.haskell.org/package/dobutokO2) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dobutokO2` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-7a2b0b8fa399dd` from `hackage_top_downloads` as `registry_expansion`
