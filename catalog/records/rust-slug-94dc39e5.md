...
| Canonical URL | [https://crates.io/crates/slug](https://crates.io/crates/slug) |
| Source record ids | crates_io-fa788262082218 |
...
For a systems engineer, slug belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2024-08-15T20:04:40.170528Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-fa788262082218` from `crates_io` as `registry_expansion`
