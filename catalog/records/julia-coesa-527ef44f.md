...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/COESA](https://github.com/JuliaRegistries/General/tree/master/C/COESA) |
| Source record ids | julia_general-829931c91237d2 |

## System Engineer Summary

Julia package registered in General at C/COESA.

## Operational Role

For a systems engineer, COESA belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/COESA", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-829931c91237d2` from `julia_general` as `registry_expansion`
