...
| Canonical URL | [https://crates.io/crates/keyring](https://crates.io/crates/keyring) |
| Source record ids | crates_io-bae910c6dc95e2 |

## System Engineer Summary

keyring is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, keyring belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-08-29T23:48:56.175457Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-bae910c6dc95e2` from `crates_io` as `registry_expansion`
