...
<!-- canonical: https://cran.r-project.org/web/packages/minex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/minex/index.html](https://cran.r-project.org/web/packages/minex/index.html) |
| Source record ids | cran_packages_by_date-db0a3338b31684 |
...
For a systems engineer, minex belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-29 22:40:02 UTC | [https://cran.r-project.org/web/packages/minex/DESCRIPTION](https://cran.r-project.org/web/packages/minex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/minex/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-db0a3338b31684` from `cran_packages_by_date` as `registry_expansion`
