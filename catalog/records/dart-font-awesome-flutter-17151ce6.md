...
<!-- canonical: https://pub.dev/packages/font_awesome_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/font_awesome_flutter](https://pub.dev/packages/font_awesome_flutter) |
| Source record ids | pub_dev-3412d8e4fa8501 |

## System Engineer Summary

The Font Awesome Icon pack available as Flutter Icons. Provides 2000 additional icons to use in your
apps.

## Operational Role

For a systems engineer, font_awesome_flutter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-03-09T11:56:43.755686Z | [https://pub.dev/api/packages/font_awesome_flutter](https://pub.dev/api/packages/font_awesome_flutter) |  |
| preview | known | 10.0.0-beta | 2021-10-21T12:37:40.636772Z | [https://pub.dev/api/packages/font_awesome_flutter](https://pub.dev/api/packages/font_awesome_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/font_awesome_flutter` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-3412d8e4fa8501` from `pub_dev` as `registry_expansion`
