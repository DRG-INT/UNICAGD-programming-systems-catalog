...
<!-- canonical: https://www.nuget.org/packages/ZiggyCreatures.FusionCache.Serialization.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/ZiggyCreatures.FusionCache.Serialization.SystemTextJson](https://www.nuget.org/packages/ZiggyCreatures.FusionCache.Serialization.SystemTextJson) |
| Source record ids | nuget_search-a45601acba92de |
...
For a systems engineer, ZiggyCreatures.FusionCache.Serialization.SystemTextJson belongs in the
C-Sharp inventory as part of ecosystem capability mapping, dependency review, release awareness, and
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.2 | 2026-08-26T23:28:09.177+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/ziggycreatures.fusioncache.serialization.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/ziggycreatures.fusioncache.serialization.systemtextjson/index.json) |  |
| preview | known | 2.2.0-preview-1 | 2025-04-06T15:38:46.817+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/ziggycreatures.fusioncache.serialization.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/ziggycreatures.fusioncache.serialization.systemtextjson/index.json) |  |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT; https://www.nuget.org/packages/ZiggyCreatures.FusionCache.Serialization.SystemTextJson/2.7.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/ziggycreatures.fusioncache.serialization.systemtextjson/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-a45601acba92de` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Newtonsoft.Json | Benchmarking | [open](c-sharp-newtonsoft-json-e821fa86.md) |
