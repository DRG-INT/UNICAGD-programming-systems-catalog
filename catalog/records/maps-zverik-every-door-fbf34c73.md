...
<!-- canonical: https://github.com/Zverik/every_door -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zverik/every_door](https://github.com/Zverik/every_door) |
| Source record ids | github_search_maps-4a8efc359ff714 |
...
For a systems engineer, Zverik/every_door belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-19T19:33:31Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-4a8efc359ff714` from `github_search_maps` as `registry_expansion`
