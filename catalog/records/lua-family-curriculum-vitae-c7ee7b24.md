...
<!-- canonical: https://luarocks.org/modules/its-just-nans/curriculum_vitae -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/its-just-nans/curriculum_vitae](https://luarocks.org/modules/its-just-nans/curriculum_vitae) |
| Source record ids | luarocks_root_manifest-1cfaac7b9af729 |
...
For a systems engineer, curriculum_vitae belongs in the Lua family inventory as part of wire
...
- `luarocks_root_manifest-1cfaac7b9af729` from `luarocks_root_manifest` as `registry_expansion`
