...
<!-- canonical: https://pub.dev/packages/native_dio_adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/native_dio_adapter](https://pub.dev/packages/native_dio_adapter) |
| Source record ids | pub_dev-9dacb6061c792a |

## System Engineer Summary

A client for dio which makes use of cupertino_http and cronet_http to delegate HTTP requests to the
native platform.

## Operational Role

For a systems engineer, native_dio_adapter belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-07-29T07:09:44.700942Z | [https://pub.dev/api/packages/native_dio_adapter](https://pub.dev/api/packages/native_dio_adapter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/native_dio_adapter` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-9dacb6061c792a` from `pub_dev` as `registry_expansion`
