...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/suikabreaker/cdata_table -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/suikabreaker/cdata_table](https://luarocks.org/modules/suikabreaker/cdata_table) |
| Source record ids | luarocks_root_manifest-7bded1e7b5f9c2 |

## System Engineer Summary

table type which is able to use cdata as index

## Operational Role

For a systems engineer, cdata_table belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7bded1e7b5f9c2` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kdtree | Registry Repository | [open](lua-family-kdtree-73fb1a8e.md) |
