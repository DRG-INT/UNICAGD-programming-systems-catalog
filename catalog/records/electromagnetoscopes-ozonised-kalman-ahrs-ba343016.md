...
<!-- canonical: https://github.com/Ozonised/Kalman-AHRS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ozonised/Kalman-AHRS](https://github.com/Ozonised/Kalman-AHRS) |
| Source record ids | github_search_electromagnetoscopes-5c990299e9870d |

## System Engineer Summary

A quaternion based Extended Kalman Filter for Attitude Heading and Reference System (AHRS) written
in CPP.

## Operational Role

For a systems engineer, Ozonised/Kalman-AHRS belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-24T14:20:26Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-5c990299e9870d` from `github_search_electromagnetoscopes` as `registry_expansion`
