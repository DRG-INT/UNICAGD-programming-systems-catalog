...
<!-- canonical: https://packagist.org/packages/flow/jsonpath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/flow/jsonpath](https://packagist.org/packages/flow/jsonpath) |
| Source record ids | packagist_search-5c5880bc3b09ce |
...
For a systems engineer, flow/jsonpath belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-5c5880bc3b09ce` from `packagist_search` as `registry_expansion`
