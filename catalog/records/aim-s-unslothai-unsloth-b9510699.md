...
| Canonical URL | [https://github.com/unslothai/unsloth](https://github.com/unslothai/unsloth) |
| Source record ids | github_search_aims-76b76319a9c50a |

## System Engineer Summary

Local UI to run and train LLMs and diffusion models. Supports GGUF, MLX, Qwen3.8, DeepSeek-V4,
MiniMax-H3, Gemma 4, FLUX and more.

## Operational Role

For a systems engineer, unslothai/unsloth belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T20:57:47Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-76b76319a9c50a` from `github_search_aims` as `registry_expansion`
