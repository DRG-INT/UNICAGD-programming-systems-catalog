...
<!-- canonical: https://luarocks.org/modules/raoxiaoyan/canary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/raoxiaoyan/canary](https://luarocks.org/modules/raoxiaoyan/canary) |
| Source record ids | luarocks_root_manifest-86c629bcb4c719 |

## System Engineer Summary

canary is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, canary belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-86c629bcb4c719` from `luarocks_root_manifest` as `registry_expansion`
