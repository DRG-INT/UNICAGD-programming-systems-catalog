...
<!-- canonical: https://cran.r-project.org/web/packages/goldilocks/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/goldilocks/index.html](https://cran.r-project.org/web/packages/goldilocks/index.html) |
| Source record ids | cran_packages_by_date-6e02802aff93e4 |
...
For a systems engineer, goldilocks belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-09 14:40:02 UTC | [https://cran.r-project.org/web/packages/goldilocks/DESCRIPTION](https://cran.r-project.org/web/packages/goldilocks/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/goldilocks/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-6e02802aff93e4` from `cran_packages_by_date` as `registry_expansion`
