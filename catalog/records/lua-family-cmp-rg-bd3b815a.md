...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp-rg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp-rg](https://luarocks.org/modules/neorocks/cmp-rg) |
| Source record ids | luarocks_root_manifest-843e294b18c245 |
...
For a systems engineer, cmp-rg belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-843e294b18c245` from `luarocks_root_manifest` as `registry_expansion`
