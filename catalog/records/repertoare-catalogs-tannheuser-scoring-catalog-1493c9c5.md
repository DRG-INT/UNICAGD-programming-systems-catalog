# Tannheuser/scoring-catalog

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Tannheuser/scoring-catalog -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Repertoare Catalogs |
| Category | Logging Observability |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/Tannheuser/scoring-catalog](https://github.com/Tannheuser/scoring-catalog) |
| Source record ids | github_search_repertoare_catalogs-696987b511cc62 |
...
For a systems engineer, Tannheuser/scoring-catalog belongs in the Repertoare Catalogs inventory as
part of diagnostics, metrics, auditability, tracing, and incident response.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-17T13:03:45Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-02 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "score catalog", "retrieved": "2026-09-02", "status": "forge-cli-derived"}` |
...
- `github_search_repertoare_catalogs-696987b511cc62` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0razec/Dados-Catalogados | Logging Observability | [open](repertoare-catalogs-0razec-dados-catalogados-e2b354d8.md) |
| 2deva/catalog-score | Logging Observability | [open](repertoare-catalogs-2deva-catalog-score-34e64b09.md) |
| adityacodes30/catalog-scoring-ondc | Logging Observability | [open](repertoare-catalogs-adityacodes30-catalog-scoring-ondc-eed2618c.md) |
| AdityaLad2004/Catalog-Score | Logging Observability | [open](repertoare-catalogs-adityalad2004-catalog-score-1c228719.md) |
| alphaparkinc/genpark-catalog-enrichment-skill | Logging Observability | [open](repertoare-catalogs-alphaparkinc-genpark-catalog-enrichment-skill-9442da58.md) |
| Arnon-hs/open-source | Logging Observability | [open](repertoare-catalogs-arnon-hs-open-source-e137acf0.md) |
| CHagarty/scorecard-catalogue | Logging Observability | [open](repertoare-catalogs-chagarty-scorecard-catalogue-ac87b7bd.md) |
| Chistera-Scoring/services-catalog | Logging Observability | [open](repertoare-catalogs-chistera-scoring-services-catalog-59fbb312.md) |
