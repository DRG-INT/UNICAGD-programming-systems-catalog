...
<!-- canonical: https://cran.r-project.org/web/packages/survdnn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/survdnn/index.html](https://cran.r-project.org/web/packages/survdnn/index.html) |
| Source record ids | cran_packages_by_date-e05ffcf89c76fd |
...
For a systems engineer, survdnn belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-22 15:50:07 UTC | [https://cran.r-project.org/web/packages/survdnn/DESCRIPTION](https://cran.r-project.org/web/packages/survdnn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/survdnn/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e05ffcf89c76fd` from `cran_packages_by_date` as `registry_expansion`
