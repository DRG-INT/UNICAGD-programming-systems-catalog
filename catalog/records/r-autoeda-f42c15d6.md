...
<!-- canonical: https://cran.r-project.org/web/packages/AutoEDA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AutoEDA/index.html](https://cran.r-project.org/web/packages/AutoEDA/index.html) |
| Source record ids | cran_packages_by_date-38c03b236a295a |
...
For a systems engineer, AutoEDA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-12 14:50:15 UTC | [https://cran.r-project.org/web/packages/AutoEDA/DESCRIPTION](https://cran.r-project.org/web/packages/AutoEDA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AutoEDA/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-38c03b236a295a` from `cran_packages_by_date` as `registry_expansion`
