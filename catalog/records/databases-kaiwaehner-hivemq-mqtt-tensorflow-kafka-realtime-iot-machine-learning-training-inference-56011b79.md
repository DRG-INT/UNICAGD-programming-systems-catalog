...
<!-- canonical: https://github.com/kaiwaehner/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kaiwaehner/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference](https://github.com/kaiwaehner/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference) |
| Source record ids | github_search_databases-3a82ab4b977dd7 |

## System Engineer Summary

Real Time Big Data / IoT Machine Learning (Model Training and Inference) with HiveMQ (MQTT),
TensorFlow IO and Apache Kafka - no additional data store like S3, HDFS or Spark required

## Operational Role

For a systems engineer, kaiwaehner/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-
training-inference belongs in the Databases inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-05T10:13:40Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3a82ab4b977dd7` from `github_search_databases` as `registry_expansion`
...
| thingsboard/thingsboard-gateway | Message Broker | [open](databases-thingsboard-thingsboard-gateway-aa05e06b.md) |
