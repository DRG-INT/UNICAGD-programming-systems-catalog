...
<!-- canonical: https://github.com/yonie/WetDelay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yonie/WetDelay](https://github.com/yonie/WetDelay) |
| Source record ids | github_search_audio-95387e9f6b59c7 |

## System Engineer Summary

An open-source stereo delay with 80s rack-style character: 24 kHz internal rate, 12-bit
quantisation, channel crosstalk. Free, MIT, VST3 for Windows, macOS and Linux.

## Operational Role

For a systems engineer, yonie/WetDelay belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T10:28:14Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-95387e9f6b59c7` from `github_search_audio` as `registry_expansion`
