...
<!-- canonical: https://cran.r-project.org/web/packages/rhythm.metrics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rhythm.metrics/index.html](https://cran.r-project.org/web/packages/rhythm.metrics/index.html) |
| Source record ids | cran_packages_by_date-6b61c142e892a4 |

## System Engineer Summary

Analyse and Visualise Speech Rhythm and Timing Metrics

## Operational Role

For a systems engineer, rhythm.metrics belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-02 11:50:02 UTC | [https://cran.r-project.org/web/packages/rhythm.metrics/DESCRIPTION](https://cran.r-project.org/web/packages/rhythm.metrics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rhythm.metrics/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-6b61c142e892a4` from `cran_packages_by_date` as `registry_expansion`
