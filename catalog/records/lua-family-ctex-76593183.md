...
<!-- canonical: https://luarocks.org/modules/freed-wu/ctex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/ctex](https://luarocks.org/modules/freed-wu/ctex) |
| Source record ids | luarocks_root_manifest-b7e5becde6d659 |
...
For a systems engineer, ctex belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b7e5becde6d659` from `luarocks_root_manifest` as `registry_expansion`
