...
<!-- canonical: https://cran.r-project.org/web/packages/MDaRes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MDaRes/index.html](https://cran.r-project.org/web/packages/MDaRes/index.html) |
| Source record ids | cran_packages_by_date-58081418aca680 |
...
For a systems engineer, MDaRes belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-08-25 15:10:09 UTC | [https://cran.r-project.org/web/packages/MDaRes/DESCRIPTION](https://cran.r-project.org/web/packages/MDaRes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MDaRes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-58081418aca680` from `cran_packages_by_date` as `registry_expansion`
