...
| Source record ids | corpus-f4a3d334515267 |

## System Engineer Summary

ProFi is tracked as a profiler record in the Lua family branch. The source did not provide a long
...
For a systems engineer, ProFi belongs in the Lua family inventory as part of hot-path discovery,
...
- `corpus-f4a3d334515267` from `master_json` as `profiler`
