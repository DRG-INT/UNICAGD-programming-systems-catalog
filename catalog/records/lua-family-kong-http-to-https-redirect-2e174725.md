...
| Canonical URL | [https://luarocks.org/modules/stepbeek/kong-http-to-https-redirect](https://luarocks.org/modules/stepbeek/kong-http-to-https-redirect) |
| Source record ids | luarocks_root_manifest-feb7410b3cb7fd |

## System Engineer Summary

A Kong plugin for redirecting HTTP traffic to HTTPS.

## Operational Role

For a systems engineer, kong-http-to-https-redirect belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-feb7410b3cb7fd` from `luarocks_root_manifest` as `registry_expansion`
