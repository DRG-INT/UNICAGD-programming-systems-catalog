...
<!-- canonical: https://crates.io/crates/triomphe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/triomphe](https://crates.io/crates/triomphe) |
| Source record ids | crates_io-5d62dd42b4a249 |

## System Engineer Summary

A fork of std::sync::Arc with some extra functionality and without weak references (originally
servo_arc)

## Operational Role

For a systems engineer, triomphe belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.16 | 2026-06-29T13:38:49.119256Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-5d62dd42b4a249` from `crates_io` as `registry_expansion`
