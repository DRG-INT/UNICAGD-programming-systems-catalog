...
<!-- canonical: https://crates.io/crates/pxfm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pxfm](https://crates.io/crates/pxfm) |
| Source record ids | crates_io-3ba7d02704a53c |

## System Engineer Summary

pxfm is tracked as a parser lexer ast record in the Rust branch. The source did not provide a long
...
For a systems engineer, pxfm belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.30 | 2026-07-06T06:43:55.517978Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-3ba7d02704a53c` from `crates_io` as `registry_expansion`
