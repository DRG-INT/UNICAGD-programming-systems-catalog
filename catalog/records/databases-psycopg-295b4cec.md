...
<!-- canonical: https://github.com/psycopg/psycopg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psycopg/psycopg](https://github.com/psycopg/psycopg) |
| Source record ids | curated_database_systems-0d41cc11420320 |
...
For a systems engineer, psycopg belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-0d41cc11420320` from `curated_database_systems` as `registry_expansion`
