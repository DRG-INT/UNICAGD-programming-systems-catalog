...
<!-- canonical: https://pub.dev/packages/neat_periodic_task -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/neat_periodic_task](https://pub.dev/packages/neat_periodic_task) |
| Source record ids | pub_dev-7c2a0669fff111 |
...
For a systems engineer, neat_periodic_task belongs in the Dart inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2023-04-28T11:10:11.705986Z | [https://pub.dev/api/packages/neat_periodic_task](https://pub.dev/api/packages/neat_periodic_task) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/neat_periodic_task` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-7c2a0669fff111` from `pub_dev` as `registry_expansion`
