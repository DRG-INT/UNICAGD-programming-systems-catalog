...
<!-- canonical: https://cran.r-project.org/web/packages/adas.utils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/adas.utils/index.html](https://cran.r-project.org/web/packages/adas.utils/index.html) |
| Source record ids | cran_packages_by_date-9585222b3c10dd |
...
For a systems engineer, adas.utils belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2026-09-13 14:20:09 UTC | [https://cran.r-project.org/web/packages/adas.utils/DESCRIPTION](https://cran.r-project.org/web/packages/adas.utils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/adas.utils/DESCRIPTION` at `2026-09-13T16:19:40+00:00`.
...
- `cran_packages_by_date-9585222b3c10dd` from `cran_packages_by_date` as `registry_expansion`
