...
<!-- canonical: https://cran.r-project.org/web/packages/mxcc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mxcc/index.html](https://cran.r-project.org/web/packages/mxcc/index.html) |
| Source record ids | cran_packages_by_date-12a1dd47d4f589 |

## System Engineer Summary

mxcc is tracked as a visualization gui record in the R branch. The source did not provide a long
...
For a systems engineer, mxcc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-08-29 07:50:02 UTC | [https://cran.r-project.org/web/packages/mxcc/DESCRIPTION](https://cran.r-project.org/web/packages/mxcc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mxcc/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-12a1dd47d4f589` from `cran_packages_by_date` as `registry_expansion`
