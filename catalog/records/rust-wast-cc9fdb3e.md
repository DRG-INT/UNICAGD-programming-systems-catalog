...
<!-- canonical: https://crates.io/crates/wast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wast](https://crates.io/crates/wast) |
| Source record ids | crates_io-36705c8238eb63 |
...
For a systems engineer, wast belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 259.0.0 | 2026-09-10T17:56:41.804739Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-10T18:21:45+00:00`.
...
- `crates_io-36705c8238eb63` from `crates_io` as `registry_expansion`
