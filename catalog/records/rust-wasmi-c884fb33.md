...
| Canonical URL | [https://crates.io/crates/wasmi](https://crates.io/crates/wasmi) |
| Source record ids | crates_io-b1332a6af067d4 |

## System Engineer Summary

wasmi is tracked as an interpreter runtime record in the Rust branch. The source did not provide a
...
For a systems engineer, wasmi belongs in the Rust inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-10T12:51:06.597898Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-b1332a6af067d4` from `crates_io` as `registry_expansion`
