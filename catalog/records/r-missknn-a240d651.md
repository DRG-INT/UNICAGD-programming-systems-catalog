...
<!-- canonical: https://cran.r-project.org/web/packages/missknn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/missknn/index.html](https://cran.r-project.org/web/packages/missknn/index.html) |
| Source record ids | cran_packages_by_date-28d4c4f90e4d62 |
...
For a systems engineer, missknn belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-22 01:00:02 UTC | [https://cran.r-project.org/web/packages/missknn/DESCRIPTION](https://cran.r-project.org/web/packages/missknn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/missknn/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-28d4c4f90e4d62` from `cran_packages_by_date` as `registry_expansion`
