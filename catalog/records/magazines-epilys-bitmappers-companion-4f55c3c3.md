# epilys/bitmappers-companion

## Navigation

[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/epilys/bitmappers-companion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/epilys/bitmappers-companion](https://github.com/epilys/bitmappers-companion) |
| Source record ids | github_search_magazines-98a637c6ff2f2d |
...
For a systems engineer, epilys/bitmappers-companion belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-28T16:28:14Z | gh search repos topic:zine stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-98a637c6ff2f2d` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AnglyPascal/MO-Problem-Journal | Math Numeric Scientific | [open](magazines-anglypascal-mo-problem-journal-75e755ba.md) |
| appml/neutrinote | Math Numeric Scientific | [open](magazines-appml-neutrinote-33200361.md) |
