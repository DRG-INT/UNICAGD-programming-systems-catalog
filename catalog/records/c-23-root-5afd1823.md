...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://root.cern.ch/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://root.cern.ch/](https://root.cern.ch/) |
| Source record ids | awesome_list-8a99afed8123a7 |

## System Engineer Summary

A set of OO frameworks with all the functionality needed to handle and analyze large amounts of data
in a very efficient way. Used at CERN. LGPL

## Operational Role

For a systems engineer, ROOT belongs in the C++23 inventory as part of cross-language integration,
...
- `awesome_list-8a99afed8123a7` from `awesome_list` as `registry_expansion`
