...
| Source record ids | curated_language_routes-a7f1900d2c491d |

## System Engineer Summary

Python library for calculating magnetic fields of magnets, currents, and sensor arrangements.

## Operational Role

For a systems engineer, Magpylib belongs in the Electromagnetoscopes inventory as part of ecosystem
...
- `curated_language_routes-a7f1900d2c491d` from `curated_language_routes` as `registry_expansion`
