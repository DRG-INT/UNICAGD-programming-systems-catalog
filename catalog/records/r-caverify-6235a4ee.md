...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Coverage](../by-category/coverage.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/caverify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/caverify/index.html](https://cran.r-project.org/web/packages/caverify/index.html) |
| Source record ids | cran_packages_by_date-287c6e2caae460 |

## System Engineer Summary

Fast Strength-t Coverage Verification for Covering Arrays

## Operational Role

For a systems engineer, caverify belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-23 10:10:18 UTC | [https://cran.r-project.org/web/packages/caverify/DESCRIPTION](https://cran.r-project.org/web/packages/caverify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/caverify/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-287c6e2caae460` from `cran_packages_by_date` as `registry_expansion`
