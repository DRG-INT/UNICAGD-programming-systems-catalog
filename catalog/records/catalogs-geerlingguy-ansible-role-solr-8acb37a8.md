...
<!-- canonical: https://github.com/geerlingguy/ansible-role-solr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geerlingguy/ansible-role-solr](https://github.com/geerlingguy/ansible-role-solr) |
| Source record ids | github_search_catalogs-305962becfaec9 |
...
For a systems engineer, geerlingguy/ansible-role-solr belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T14:17:49Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-305962becfaec9` from `github_search_catalogs` as `registry_expansion`
