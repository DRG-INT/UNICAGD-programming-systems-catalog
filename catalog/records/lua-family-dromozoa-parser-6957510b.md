...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-parser](https://luarocks.org/modules/moyu/dromozoa-parser) |
| Source record ids | luarocks_root_manifest-b1807f115e1e35 |
...
For a systems engineer, dromozoa-parser belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-b1807f115e1e35` from `luarocks_root_manifest` as `registry_expansion`
