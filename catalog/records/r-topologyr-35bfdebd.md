...
<!-- canonical: https://cran.r-project.org/web/packages/topologyR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/topologyR/index.html](https://cran.r-project.org/web/packages/topologyR/index.html) |
| Source record ids | cran_packages_by_date-3f0334f8acb690 |
...
For a systems engineer, topologyR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-20 00:20:02 UTC | [https://cran.r-project.org/web/packages/topologyR/DESCRIPTION](https://cran.r-project.org/web/packages/topologyR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/topologyR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3f0334f8acb690` from `cran_packages_by_date` as `registry_expansion`
