...
<!-- canonical: https://crates.io/crates/dlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dlib](https://crates.io/crates/dlib) |
| Source record ids | crates_io-88689e835b1176 |
...
For a systems engineer, dlib belongs in the Rust inventory as part of operator onboarding, API
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-02-26T03:32:04.429182Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-88689e835b1176` from `crates_io` as `registry_expansion`
