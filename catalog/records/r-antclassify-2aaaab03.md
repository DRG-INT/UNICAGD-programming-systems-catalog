...
<!-- canonical: https://cran.r-project.org/web/packages/AntClassify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AntClassify/index.html](https://cran.r-project.org/web/packages/AntClassify/index.html) |
| Source record ids | cran_packages_by_date-03565bac89330c |
...
For a systems engineer, AntClassify belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-09-03 19:50:02 UTC | [https://cran.r-project.org/web/packages/AntClassify/DESCRIPTION](https://cran.r-project.org/web/packages/AntClassify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AntClassify/DESCRIPTION` at `2026-09-03T20:18:45+00:00`.
...
- `cran_packages_by_date-03565bac89330c` from `cran_packages_by_date` as `registry_expansion`
