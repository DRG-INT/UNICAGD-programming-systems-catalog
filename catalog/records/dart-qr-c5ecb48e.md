...
<!-- canonical: https://pub.dev/packages/qr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/qr](https://pub.dev/packages/qr) |
| Source record ids | pub_dev-0b7f013737fc64 |

## System Engineer Summary

A QR code generation library for Dart. Supports QR code version 1 through 40, error correction and
redundancy.

## Operational Role

For a systems engineer, qr belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-05-16T23:17:18.274423Z | [https://pub.dev/api/packages/qr](https://pub.dev/api/packages/qr) |  |
| preview | known | 2.0.0-nullsafety.1 | 2020-11-29T02:20:11.299473Z | [https://pub.dev/api/packages/qr](https://pub.dev/api/packages/qr) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/qr` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-0b7f013737fc64` from `pub_dev` as `registry_expansion`
