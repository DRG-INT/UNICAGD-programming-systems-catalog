...
<!-- canonical: https://crates.io/crates/uncased -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/uncased](https://crates.io/crates/uncased) |
| Source record ids | crates_io-5d7fc90f5ddf77 |
...
For a systems engineer, uncased belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.10 | 2024-01-22T23:58:04.575341Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-5d7fc90f5ddf77` from `crates_io` as `registry_expansion`
