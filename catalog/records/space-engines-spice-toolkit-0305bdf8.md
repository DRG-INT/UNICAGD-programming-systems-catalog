...
<!-- canonical: https://naif.jpl.nasa.gov/naif/toolkit.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://naif.jpl.nasa.gov/naif/toolkit.html](https://naif.jpl.nasa.gov/naif/toolkit.html) |
| Source record ids | curated_language_routes-9c3c64dacfedb3 |

## System Engineer Summary

NASA NAIF toolkit for spacecraft geometry, ephemerides, frames, kernels, and mission analysis.

## Operational Role

For a systems engineer, SPICE Toolkit belongs in the Space Engines inventory as part of ecosystem
...
- `curated_language_routes-9c3c64dacfedb3` from `curated_language_routes` as `registry_expansion`
