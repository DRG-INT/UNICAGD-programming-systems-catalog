...
<!-- canonical: https://pypi.org/project/acryl-datahub-actions/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acryl-datahub-actions/](https://pypi.org/project/acryl-datahub-actions/) |
| Source record ids | pypi_simple-506bc6973279e4 |

## System Engineer Summary

Event-driven action framework for DataHub — trigger automations and workflows in response to real-
time metadata changes

## Operational Role

For a systems engineer, acryl-datahub-actions belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0.7 | 2026-08-26T13:52:12.056974Z | [https://pypi.org/pypi/acryl-datahub-actions/json](https://pypi.org/pypi/acryl-datahub-actions/json) |  |
| preview | known | 1.7.0rc2 | 2026-08-04T17:05:56.839788Z | [https://pypi.org/pypi/acryl-datahub-actions/json](https://pypi.org/pypi/acryl-datahub-actions/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acryl-datahub-actions/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-506bc6973279e4` from `pypi_simple` as `registry_expansion`
