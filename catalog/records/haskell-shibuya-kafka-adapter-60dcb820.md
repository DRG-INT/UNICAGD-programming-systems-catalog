...
<!-- canonical: https://hackage.haskell.org/package/shibuya-kafka-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shibuya-kafka-adapter](https://hackage.haskell.org/package/shibuya-kafka-adapter) |
| Source record ids | hackage_recent-8e07d26cb3e288 |
...
For a systems engineer, shibuya-kafka-adapter belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.1 | 2026-09-16T04:03:48Z | [https://hackage.haskell.org/package/shibuya-kafka-adapter](https://hackage.haskell.org/package/shibuya-kafka-adapter) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/shibuya-kafka-adapter` at `2026-09-16T06:31:30+00:00`.
...
- `hackage_recent-8e07d26cb3e288` from `hackage_recent` as `registry_expansion`
