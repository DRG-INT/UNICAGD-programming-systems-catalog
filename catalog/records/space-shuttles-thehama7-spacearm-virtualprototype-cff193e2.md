# TheHama7/SpaceArm_VirtualPrototype
...
<!-- canonical: https://github.com/TheHama7/SpaceArm_VirtualPrototype -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheHama7/SpaceArm_VirtualPrototype](https://github.com/TheHama7/SpaceArm_VirtualPrototype) |
| Source record ids | github_search_space_shuttles-cf97337aabaf1e |

## System Engineer Summary

Group Project in Matlab and CAD software. Design of a robotic Space Arm for docking a space shuttle
to a space station. Designed in AutoDesk Inventor, PID control and Simulation done in Matlab.

## Operational Role

For a systems engineer, TheHama7/SpaceArm_VirtualPrototype belongs in the Space Shuttles inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T16:38:25Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-cf97337aabaf1e` from `github_search_space_shuttles` as `registry_expansion`
