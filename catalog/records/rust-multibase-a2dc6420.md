...
| Canonical URL | [https://crates.io/crates/multibase](https://crates.io/crates/multibase) |
| Source record ids | crates_io-8be151e636a77a |

## System Engineer Summary

multibase is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, multibase belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2026-06-29T09:44:21.163529Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-8be151e636a77a` from `crates_io` as `registry_expansion`
