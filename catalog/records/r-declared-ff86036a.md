...
<!-- canonical: https://cran.r-project.org/web/packages/declared/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/declared/index.html](https://cran.r-project.org/web/packages/declared/index.html) |
| Source record ids | cran_packages_by_date-4ed4005b205e91 |
...
For a systems engineer, declared belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27 | 2026-08-22 03:40:02 UTC | [https://cran.r-project.org/web/packages/declared/DESCRIPTION](https://cran.r-project.org/web/packages/declared/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/declared/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4ed4005b205e91` from `cran_packages_by_date` as `registry_expansion`
