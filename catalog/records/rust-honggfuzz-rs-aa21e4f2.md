...
| Source record ids | corpus-265d472b49968b |

## System Engineer Summary

honggfuzz-rs is tracked as a fuzzer record in the Rust branch. The source did not provide a long
...
For a systems engineer, honggfuzz-rs belongs in the Rust inventory as part of input-space
...
- `corpus-265d472b49968b` from `master_json` as `fuzzer`
