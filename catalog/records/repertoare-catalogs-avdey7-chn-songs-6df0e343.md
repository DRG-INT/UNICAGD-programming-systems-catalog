...
[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Avdey7/chn.songs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Avdey7/chn.songs](https://github.com/Avdey7/chn.songs) |
| Source record ids | github_search_repertoare_catalogs-a9cc877a7b3156 |

## System Engineer Summary

Worship songbook PWA - lyrics + chords, live transposition, offline guitar chord diagrams, per-
service set lists, bilingual songs, and a true-black stage mode. Vanilla JS, no build step, Supabase
catalog.

## Operational Role

For a systems engineer, Avdey7/chn.songs belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T14:29:59Z | gh search repos setlist catalog | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-06 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "setlist catalog", "retrieved": "2026-09-06", "status": "forge-cli-derived"}` |
...
- `github_search_repertoare_catalogs-a9cc877a7b3156` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| abajorek/repsmith | Build System | [open](repertoare-catalogs-abajorek-repsmith-b359f433.md) |
| apurvrdx1/tagore | Build System | [open](repertoare-catalogs-apurvrdx1-tagore-83e8f185.md) |
| Cristian-Ayala/band-blend | Build System | [open](repertoare-catalogs-cristian-ayala-band-blend-020b5aa8.md) |
| eylonyogev/repertoire | Build System | [open](repertoare-catalogs-eylonyogev-repertoire-0e448ebe.md) |
| NeilP211/runway | Build System | [open](repertoare-catalogs-neilp211-runway-cc0319ad.md) |
| PGScatalog/pgs-harmonizer | Build System | [open](repertoare-catalogs-pgscatalog-pgs-harmonizer-78877edd.md) |
| Resch17/repertoire | Build System | [open](repertoare-catalogs-resch17-repertoire-6a7569f8.md) |
| SEI-York/ROCKME-open-source | Build System | [open](repertoare-catalogs-sei-york-rockme-open-source-eeeda39c.md) |
