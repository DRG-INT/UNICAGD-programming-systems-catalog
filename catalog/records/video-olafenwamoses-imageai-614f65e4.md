...
| Canonical URL | [https://github.com/OlafenwaMoses/ImageAI](https://github.com/OlafenwaMoses/ImageAI) |
| Source record ids | github_search_video-45f93d358b8d5f |

## System Engineer Summary

A python library built to empower developers to build applications and systems with self-contained
Computer Vision capabilities

## Operational Role

For a systems engineer, OlafenwaMoses/ImageAI belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0-pretrained | 2022-11-10T19:41:27Z | [https://api.github.com/repos/OlafenwaMoses/ImageAI/releases/latest](https://api.github.com/repos/OlafenwaMoses/ImageAI/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OlafenwaMoses/ImageAI/releases/latest` at `2026-09-01T09:23:26+00:00`.
...
- `github_search_video-45f93d358b8d5f` from `github_search_video` as `registry_expansion`
...
| VideoFlint/Cabbage | Build System | [open](video-videoflint-cabbage-bf78fd50.md) |
