...
<!-- canonical: https://cran.r-project.org/web/packages/localIV/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/localIV/index.html](https://cran.r-project.org/web/packages/localIV/index.html) |
| Source record ids | cran_packages_by_date-d17c61fecaeb4b |
...
For a systems engineer, localIV belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-21 05:42:04 UTC | [https://cran.r-project.org/web/packages/localIV/DESCRIPTION](https://cran.r-project.org/web/packages/localIV/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/localIV/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d17c61fecaeb4b` from `cran_packages_by_date` as `registry_expansion`
