...
<!-- canonical: https://pub.dev/packages/flex_color_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flex_color_picker](https://pub.dev/packages/flex_color_picker) |
| Source record ids | pub_dev-dff40003c051f6 |

## System Engineer Summary

A customizable Flutter primary, accent and custom color picker. Includes an optional HSV wheel color
picker.

## Operational Role

For a systems engineer, flex_color_picker belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-08-30T20:23:31.695014Z | [https://pub.dev/api/packages/flex_color_picker](https://pub.dev/api/packages/flex_color_picker) |  |
| preview | known | 4.0.0-dev.1 | 2026-08-30T20:10:45.213493Z | [https://pub.dev/api/packages/flex_color_picker](https://pub.dev/api/packages/flex_color_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flex_color_picker` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-dff40003c051f6` from `pub_dev` as `registry_expansion`
