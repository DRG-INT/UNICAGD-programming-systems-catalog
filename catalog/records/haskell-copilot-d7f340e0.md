...
| Source record ids | hackage_recent-bcf829c6d56eac |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/copilot` at `2026-09-10T00:31:04+00:00`.
...
- `hackage_recent-bcf829c6d56eac` from `hackage_recent` as `registry_expansion`
