...
<!-- canonical: https://hackage.haskell.org/package/copilot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/copilot](https://hackage.haskell.org/package/copilot) |
| Source record ids | hackage_top_downloads-bcf829c6d56eac |
...
For a systems engineer, copilot belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:20:13Z | [https://hackage.haskell.org/package/copilot](https://hackage.haskell.org/package/copilot) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/copilot` at `2026-09-10T12:30:17+00:00`.
...
- `hackage_top_downloads-bcf829c6d56eac` from `hackage_top_downloads` as `registry_expansion`
