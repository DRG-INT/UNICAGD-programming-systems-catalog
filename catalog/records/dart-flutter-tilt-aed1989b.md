...
<!-- canonical: https://pub.dev/packages/flutter_tilt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_tilt](https://pub.dev/packages/flutter_tilt) |
| Source record ids | pub_dev-fa63fc3c7ee7dc |

## System Engineer Summary

Easily apply tilt parallax hover effects for Flutter, which supports tilt, light, shadow effects,
gyroscope sensors and many custom parameters.

## Operational Role

For a systems engineer, flutter_tilt belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-07-29T13:24:38.863077Z | [https://pub.dev/api/packages/flutter_tilt](https://pub.dev/api/packages/flutter_tilt) |  |
| preview | known | 4.0.0-rc.2 | 2026-05-11T16:30:31.857561Z | [https://pub.dev/api/packages/flutter_tilt](https://pub.dev/api/packages/flutter_tilt) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_tilt` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-fa63fc3c7ee7dc` from `pub_dev` as `registry_expansion`
