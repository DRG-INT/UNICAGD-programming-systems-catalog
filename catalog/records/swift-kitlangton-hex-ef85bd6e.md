...
<!-- canonical: https://github.com/kitlangton/Hex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kitlangton/Hex](https://github.com/kitlangton/Hex) |
| Source record ids | github_search_swift-dc22f604016e0e |

## System Engineer Summary

Legacy Swift Hex app. Try the Rust rewrite at hex.kitlangton.com; new source at
github.com/anomalyco/hex.

## Operational Role

For a systems engineer, kitlangton/Hex belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T03:47:11Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-dc22f604016e0e` from `github_search_swift` as `registry_expansion`
