...
<!-- canonical: https://packagist.org/packages/react/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/react/http](https://packagist.org/packages/react/http) |
| Source record ids | packagist_search-368a08b0ae18d5 |
...
For a systems engineer, react/http belongs in the PHP inventory as part of service communication,
...
- `packagist_search-368a08b0ae18d5` from `packagist_search` as `registry_expansion`
