# p7ayfu77/astro-csbdeep

## Navigation

[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/p7ayfu77/astro-csbdeep -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/p7ayfu77/astro-csbdeep](https://github.com/p7ayfu77/astro-csbdeep) |
| Source record ids | github_search_telescopes-27fa0a506b42e3 |

## System Engineer Summary

astro-csbdeep is an astronomical processing toolbox for building and using ai models to denoise your
astro images.

## Operational Role

For a systems engineer, p7ayfu77/astro-csbdeep belongs in the Telescopes inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-28T21:28:25Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:astrophotography stars:>10", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-27fa0a506b42e3` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| avarakin/AstroPiMaker4 | Build System | [open](telescopes-avarakin-astropimaker4-f79e5cbf.md) |
| OpenSpace/OpenSpace | Build System | [open](telescopes-openspace-openspace-9cf8076b.md) |
| Shatur/neovim-cmake | Build System | [open](telescopes-shatur-neovim-cmake-ad8d2155.md) |
