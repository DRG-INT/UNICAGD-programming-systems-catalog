...
<!-- canonical: https://gitlab.com/cznic/sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/cznic/sqlite](https://gitlab.com/cznic/sqlite) |
| Source record ids | gitlab_projects_api-aa9fca8a9bf53d |

## System Engineer Summary

Package sqlite is a CGo-free port of SQLite/SQLite3. SQLite is an in-process implementation of a
self-contained, serverless, zero-configuration, transactional SQL database engine.

## Operational Role

For a systems engineer, cznic/sqlite belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-aa9fca8a9bf53d` from `gitlab_projects_api` as `registry_expansion`
