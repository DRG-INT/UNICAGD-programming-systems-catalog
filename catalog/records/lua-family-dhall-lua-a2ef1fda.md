...
<!-- canonical: https://luarocks.org/modules/abhashs/dhall-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/abhashs/dhall-lua](https://luarocks.org/modules/abhashs/dhall-lua) |
| Source record ids | luarocks_root_manifest-44e3295cfcaf05 |

## System Engineer Summary

dhall-lua is tracked as a ffi bindings record in the Lua family branch. The source did not provide a
...
For a systems engineer, dhall-lua belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-44e3295cfcaf05` from `luarocks_root_manifest` as `registry_expansion`
