...
<!-- canonical: https://github.com/lanl/dfnWorks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lanl/dfnWorks](https://github.com/lanl/dfnWorks) |
| Source record ids | github_search_engines-23a339a6c5952c |

## System Engineer Summary

dfnWorks is a parallelized computational suite to generate three-dimensional discrete fracture
networks (DFN) and simulate flow and transport. If you download the software please fill out our
interest form to stay up to date on releases and join our google group . Precompiled Docker
Container

## Operational Role

For a systems engineer, lanl/dfnWorks belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T21:19:18Z | gh search repos topic:simulation-engine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-23a339a6c5952c` from `github_search_engines` as `registry_expansion`
