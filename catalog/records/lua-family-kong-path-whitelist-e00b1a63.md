...
| Canonical URL | [https://luarocks.org/modules/seifchen/kong-path-whitelist](https://luarocks.org/modules/seifchen/kong-path-whitelist) |
| Source record ids | luarocks_root_manifest-5714a60d0cef61 |
...
For a systems engineer, kong-path-whitelist belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5714a60d0cef61` from `luarocks_root_manifest` as `registry_expansion`
