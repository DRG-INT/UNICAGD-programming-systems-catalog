...
| Canonical URL | [https://crates.io/crates/svgtypes](https://crates.io/crates/svgtypes) |
| Source record ids | crates_io-1e26b1dbecaf87 |

## System Engineer Summary

svgtypes is tracked as a parser lexer ast record in the Rust branch. The source did not provide a
...
For a systems engineer, svgtypes belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.1 | 2026-01-09T17:52:13.943Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-1e26b1dbecaf87` from `crates_io` as `registry_expansion`
