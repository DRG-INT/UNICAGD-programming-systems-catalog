...
<!-- canonical: https://luarocks.org/modules/mah0x211/hmac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/hmac](https://luarocks.org/modules/mah0x211/hmac) |
| Source record ids | luarocks_root_manifest-1c0cbd533aa562 |

## System Engineer Summary

Compute the SHA-224, SHA-256, SHA-384, and SHA-512 message digests and the Hash-based Message
Authentication Code (HMAC).

## Operational Role

For a systems engineer, hmac belongs in the Lua family inventory as part of confidentiality,
