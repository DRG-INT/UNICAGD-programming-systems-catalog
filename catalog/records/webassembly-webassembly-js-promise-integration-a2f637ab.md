...
<!-- canonical: https://github.com/WebAssembly/js-promise-integration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/js-promise-integration](https://github.com/WebAssembly/js-promise-integration) |
| Source record ids | github_search_webassembly-7eced7f34ea2dd |
...
For a systems engineer, WebAssembly/js-promise-integration belongs in the WebAssembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-23T21:07:11Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-7eced7f34ea2dd` from `github_search_webassembly` as `registry_expansion`
