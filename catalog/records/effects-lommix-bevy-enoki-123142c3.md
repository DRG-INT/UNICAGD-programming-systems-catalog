...
<!-- canonical: https://github.com/Lommix/bevy_enoki -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Lommix/bevy_enoki](https://github.com/Lommix/bevy_enoki) |
| Source record ids | github_search_effects-38cd7ab82e8566 |
...
For a systems engineer, Lommix/bevy_enoki belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T07:55:18Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-38cd7ab82e8566` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| abnormalbrain/bevy_particle_systems | Machine Learning | [open](effects-abnormalbrain-bevy-particle-systems-1d9d59bd.md) |
