...
<!-- canonical: https://github.com/SamGinzburg/VectorVisor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SamGinzburg/VectorVisor](https://github.com/SamGinzburg/VectorVisor) |
| Source record ids | github_search_webassembly-88b339935eb76b |

## System Engineer Summary

VectorVisor is a vectorizing binary translator for GPUs, designed to make it easy to run many copies
of a single-threaded WebAssembly program in parallel using GPUs

## Operational Role

For a systems engineer, SamGinzburg/VectorVisor belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-26T00:49:00Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_webassembly-88b339935eb76b` from `github_search_webassembly` as `registry_expansion`
