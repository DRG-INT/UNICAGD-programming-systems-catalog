...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_charts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_charts](https://pub.dev/packages/syncfusion_flutter_charts) |
| Source record ids | pub_dev-dc92f4d9b096aa |

## System Engineer Summary

A Flutter Charts library which includes data visualization widgets such as cartesian and circular
charts, to create real-time, interactive, high-performance, animated charts.

## Operational Role

For a systems engineer, syncfusion_flutter_charts belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:27:22.023383Z | [https://pub.dev/api/packages/syncfusion_flutter_charts](https://pub.dev/api/packages/syncfusion_flutter_charts) |  |
| preview | known | 1.0.0-beta.5 | 2019-09-17T17:38:59.367534Z | [https://pub.dev/api/packages/syncfusion_flutter_charts](https://pub.dev/api/packages/syncfusion_flutter_charts) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_charts` at `2026-09-02T00:28:56+00:00`.
...
- `pub_dev-dc92f4d9b096aa` from `pub_dev` as `registry_expansion`
