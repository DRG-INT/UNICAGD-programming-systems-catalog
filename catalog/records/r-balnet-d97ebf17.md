...
<!-- canonical: https://cran.r-project.org/web/packages/balnet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/balnet/index.html](https://cran.r-project.org/web/packages/balnet/index.html) |
| Source record ids | cran_packages_by_date-1440e8182d4ab5 |
...
For a systems engineer, balnet belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-08-23 10:10:23 UTC | [https://cran.r-project.org/web/packages/balnet/DESCRIPTION](https://cran.r-project.org/web/packages/balnet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/balnet/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1440e8182d4ab5` from `cran_packages_by_date` as `registry_expansion`
