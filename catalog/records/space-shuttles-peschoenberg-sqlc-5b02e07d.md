...
| Canonical URL | [https://github.com/PESchoenberg/SQLC](https://github.com/PESchoenberg/SQLC) |
| Source record ids | github_search_space_shuttles-d76d6f3577b8d0 |

## System Engineer Summary

MFD designed to interact with the onboard expert system that runs the DGIIIAI Delta Glider for
Orbiter Space Flight Simulator.

## Operational Role

For a systems engineer, PESchoenberg/SQLC belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2020-07-31T16:29:18Z | [https://api.github.com/repos/PESchoenberg/SQLC/releases/latest](https://api.github.com/repos/PESchoenberg/SQLC/releases/latest) |  |
| preview | known | v.0.0.4 | 2020-04-11T15:30:52Z | [https://api.github.com/repos/PESchoenberg/SQLC/releases?per_page=10](https://api.github.com/repos/PESchoenberg/SQLC/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PESchoenberg/SQLC/releases/latest` at `2026-09-01T07:24:23+00:00`.
...
- `github_search_space_shuttles-d76d6f3577b8d0` from `github_search_space_shuttles` as `registry_expansion`
