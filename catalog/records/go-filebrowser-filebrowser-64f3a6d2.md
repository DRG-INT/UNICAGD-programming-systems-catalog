...
<!-- canonical: https://github.com/filebrowser/filebrowser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) |
| Source record ids | github_search_go-82916f16b290c7 |

## System Engineer Summary

File Browser provides a file managing interface within a specified directory and it can be used to
upload, delete, preview and edit your files.

## Operational Role

For a systems engineer, filebrowser/filebrowser belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T10:06:58Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-82916f16b290c7` from `github_search_go` as `registry_expansion`
