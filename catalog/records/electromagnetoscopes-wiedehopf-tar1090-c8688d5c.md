...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wiedehopf/tar1090 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) |
| Source record ids | github_search_electromagnetoscopes-a9840f6876d3cd |
...
For a systems engineer, wiedehopf/tar1090 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T19:20:39Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Artistic License 2.0; https://api.github.com/licenses/artistic-2.0; Other |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-13 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:sdr stars:>100", "retrieved": "2026-09-13", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-a9840f6876d3cd` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 777arc/PySDR | Ide Editor Integration | [open](electromagnetoscopes-777arc-pysdr-75b8d003.md) |
| aeyrium/aeyrium-sensor | Ide Editor Integration | [open](electromagnetoscopes-aeyrium-aeyrium-sensor-24163d58.md) |
| ARCEP-dev/Mon-Reseau-Mobile-v2 | Ide Editor Integration | [open](electromagnetoscopes-arcep-dev-mon-reseau-mobile-v2-1f3be799.md) |
| AresValley/Artemis | Ide Editor Integration | [open](electromagnetoscopes-aresvalley-artemis-b7d5042b.md) |
| Bio-Balance-Detector/bbd-p08-body-monitor | Ide Editor Integration | [open](electromagnetoscopes-bio-balance-detector-bbd-p08-body-monitor-d2a1a14b.md) |
| DavidEGrayson/minimu9-ahrs | Ide Editor Integration | [open](electromagnetoscopes-davidegrayson-minimu9-ahrs-604e208f.md) |
| HoBeZwe/SphericalScattering.jl | Ide Editor Integration | [open](electromagnetoscopes-hobezwe-sphericalscattering-jl-ba9079c6.md) |
| Huang-Chuan/MAINSvsMAGEKF | Ide Editor Integration | [open](electromagnetoscopes-huang-chuan-mainsvsmagekf-d65ea50f.md) |
