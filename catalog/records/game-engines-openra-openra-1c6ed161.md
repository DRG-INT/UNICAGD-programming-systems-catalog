...
<!-- canonical: https://github.com/OpenRA/OpenRA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenRA/OpenRA](https://github.com/OpenRA/OpenRA) |
| Source record ids | github_search_game_engines-2a44821defb88a |

## System Engineer Summary

Open Source real-time strategy game engine for early Westwood games such as Command & Conquer: Red
Alert written in C# using SDL and OpenGL. Runs on Windows, Linux, *BSD and Mac OS X.

## Operational Role

For a systems engineer, OpenRA/OpenRA belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T12:26:51Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-2a44821defb88a` from `github_search_game_engines` as `registry_expansion`
