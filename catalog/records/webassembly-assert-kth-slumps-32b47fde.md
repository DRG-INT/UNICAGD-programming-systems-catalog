...
<!-- canonical: https://github.com/ASSERT-KTH/slumps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ASSERT-KTH/slumps](https://github.com/ASSERT-KTH/slumps) |
| Source record ids | github_search_webassembly-a1b7cfdace16f1 |
...
For a systems engineer, ASSERT-KTH/slumps belongs in the WebAssembly inventory as part of defect
...
- `github_search_webassembly-a1b7cfdace16f1` from `github_search_webassembly` as `registry_expansion`
...
| danleh/wasabi | Static Analyzer | [open](webassembly-danleh-wasabi-20dc006b.md) |
