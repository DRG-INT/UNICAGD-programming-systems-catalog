...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/System.Runtime.Serialization.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/System.Runtime.Serialization.Json](https://www.nuget.org/packages/System.Runtime.Serialization.Json) |
| Source record ids | nuget_search-44732a5ef0c8b2 |

## System Engineer Summary

Provides classes for serializing objects to the JavaScript Object Notation (JSON) and deserializing
JSON data to objects. Commonly Used Types:
System.Runtime.Serialization.Json.DataContractJsonSerializer When using NuGet 3.x this package
requires at least version 3.4.

## Operational Role

For a systems engineer, System.Runtime.Serialization.Json belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2016-11-15T23:53:03.75+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.runtime.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.runtime.serialization.json/index.json) |  |
| preview | known | 4.3.0-preview1-24530-04 | 2016-10-24T16:48:22.593+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.runtime.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.runtime.serialization.json/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/system.runtime.serialization.json/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-44732a5ef0c8b2` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AWSCRT-HTTP | Interpreter Runtime | [open](c-sharp-awscrt-http-c0c038b2.md) |
| runtime.native.System.Net.Http | Interpreter Runtime | [open](c-sharp-runtime-native-system-net-http-d10423c8.md) |
| System.Text.Json | Interpreter Runtime | [open](c-sharp-system-text-json-57ce9b44.md) |
