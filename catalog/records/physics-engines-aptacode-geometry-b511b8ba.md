...
<!-- canonical: https://github.com/Aptacode/Geometry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Aptacode/Geometry](https://github.com/Aptacode/Geometry) |
| Source record ids | github_search_physics_engines-56618b667cc7a0 |
...
For a systems engineer, Aptacode/Geometry belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-16T15:05:34Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-56618b667cc7a0` from `github_search_physics_engines` as `registry_expansion`
