...
<!-- canonical: https://gitlab.com/alasca.cloud/tarook/tarook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/alasca.cloud/tarook/tarook](https://gitlab.com/alasca.cloud/tarook/tarook) |
| Source record ids | gitlab_projects_api-fa68513f2de019 |

## System Engineer Summary

Holistic life cycle management of Kubernetes clusters on bare metal or OpenStack. On an open source
basis. More information:

## Operational Role

For a systems engineer, alasca.cloud/tarook/tarook belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-fa68513f2de019` from `gitlab_projects_api` as `registry_expansion`
