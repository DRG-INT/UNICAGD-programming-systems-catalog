...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/abuz-solver-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abuz-solver-client/](https://pypi.org/project/abuz-solver-client/) |
| Source record ids | pypi_simple-e21fd5bf2c94a9 |

## System Engineer Summary

Client for remote task solver: async (solve, send_to_saved, get_saved_messages,
listen_and_save_telegram) and sync (solve_sync, send_to_saved_sync, etc.).

## Operational Role

For a systems engineer, abuz-solver-client belongs in the Python inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-02-07T18:24:49.432761Z | [https://pypi.org/pypi/abuz-solver-client/json](https://pypi.org/pypi/abuz-solver-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abuz-solver-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-e21fd5bf2c94a9` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 2captcha-python-async | Async Runtime | [open](python-2captcha-python-async-60dc26a4.md) |
| 3s-cadsus-client | Async Runtime | [open](python-3s-cadsus-client-2591c19d.md) |
| AaioAsync | Async Runtime | [open](python-aaioasync-56a17fed.md) |
| access-control-async | Async Runtime | [open](python-access-control-async-993a4946.md) |
| accuweather-client | Async Runtime | [open](python-accuweather-client-e7f2854e.md) |
| acme-client-lib | Async Runtime | [open](python-acme-client-lib-0613199c.md) |
| acmeasync | Async Runtime | [open](python-acmeasync-1b5be5c0.md) |
| acob-client | Async Runtime | [open](python-acob-client-690dd041.md) |
