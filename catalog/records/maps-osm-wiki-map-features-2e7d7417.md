...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/maps.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://wiki.openstreetmap.org/wiki/Map_features](https://wiki.openstreetmap.org/wiki/Map_features) |
| Source record ids | curated_language_routes-f5029f2d051887 |

## System Engineer Summary

OpenStreetMap tagging reference for map objects, keys, values, conventions, and data modeling.

## Operational Role

For a systems engineer, OSM Wiki Map Features belongs in the Maps inventory as part of operator
...
- `curated_language_routes-f5029f2d051887` from `curated_language_routes` as `registry_expansion`
