...
[Catalog index](../index.md) · [Language: Starlark](../by-language/starlark.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/bazel-contrib/rules_foreign_cc](https://github.com/bazel-contrib/rules_foreign_cc) |
| Source record ids | github_search_starlark-668eda6eb223f5 |

## System Engineer Summary

Build rules for interfacing with "foreign" (non-Bazel) build systems (CMake, configure-make, GNU
Make, boost, ninja, Meson)

## Operational Role

For a systems engineer, bazel-contrib/rules_foreign_cc belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.1 | 2025-06-24T20:18:52Z | [https://api.github.com/repos/bazel-contrib/rules_foreign_cc/releases/latest](https://api.github.com/repos/bazel-contrib/rules_foreign_cc/releases/latest) |  |
| preview | known | 0.10.0 | 2023-10-25T19:54:43Z | [https://api.github.com/repos/bazel-contrib/rules_foreign_cc/releases?per_page=10](https://api.github.com/repos/bazel-contrib/rules_foreign_cc/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazel-contrib/rules_foreign_cc/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Starlark stars:>500", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_starlark-668eda6eb223f5` from `github_search_starlark` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bazel-contrib/rules_nodejs | Language Specification | [open](starlark-bazel-contrib-rules-nodejs-6ba164bc.md) |
| bazel-contrib/rules_python | Language Specification | [open](starlark-bazel-contrib-rules-python-3138da4d.md) |
| bazelbuild/examples | Language Specification | [open](starlark-bazelbuild-examples-aa7ebe53.md) |
| bazelbuild/rules_apple | Language Specification | [open](starlark-bazelbuild-rules-apple-9bc4356d.md) |
| bazelbuild/rules_docker | Language Specification | [open](starlark-bazelbuild-rules-docker-9df12e7c.md) |
| bazelbuild/rules_rust | Language Specification | [open](starlark-bazelbuild-rules-rust-3c62960b.md) |
| cel-expr/cel-spec | Language Specification | [open](starlark-cel-expr-cel-spec-b2658dd8.md) |
| envoyproxy/data-plane-api | Language Specification | [open](starlark-envoyproxy-data-plane-api-7610f6c0.md) |
