...
| Canonical URL | [https://github.com/ybouane/LibRaw-Wasm](https://github.com/ybouane/LibRaw-Wasm) |
| Source record ids | github_search_photography-d3cdc1b19a2cf6 |

## System Engineer Summary

LibRaw WASM bindings to be able to use it in the browser.

## Operational Role

For a systems engineer, ybouane/LibRaw-Wasm belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.0 | 2026-07-02T06:23:35Z | [https://api.github.com/repos/ybouane/LibRaw-Wasm/releases/latest](https://api.github.com/repos/ybouane/LibRaw-Wasm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ybouane/LibRaw-Wasm/releases/latest` at `2026-09-01T09:23:35+00:00`.
...
- `github_search_photography-d3cdc1b19a2cf6` from `github_search_photography` as `registry_expansion`
