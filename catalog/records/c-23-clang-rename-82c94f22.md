...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Codegen Codemod Refactoring](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/codegen-codemod-refactoring.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | codegen_codemod_refactoring |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-73f7f417614840 |

## System Engineer Summary

clang-rename is tracked as a codegen codemod refactoring record in the C++23 branch. The source did
...
For a systems engineer, clang-rename belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-73f7f417614840` from `master_json` as `codegen_codemod_refactoring`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Clang LibTooling | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-clang-libtooling-92e88670.md) |
| clang-query | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-clang-query-04a7b235.md) |
