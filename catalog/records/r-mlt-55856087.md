...
<!-- canonical: https://cran.r-project.org/web/packages/mlt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlt/index.html](https://cran.r-project.org/web/packages/mlt/index.html) |
| Source record ids | cran_packages_by_date-159aa383c461db |
...
For a systems engineer, mlt belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8-2 | 2026-08-21 15:00:02 UTC | [https://cran.r-project.org/web/packages/mlt/DESCRIPTION](https://cran.r-project.org/web/packages/mlt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlt/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-159aa383c461db` from `cran_packages_by_date` as `registry_expansion`
