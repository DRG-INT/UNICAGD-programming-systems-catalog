...
<!-- canonical: https://pub.dev/packages/sentry_dio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sentry_dio](https://pub.dev/packages/sentry_dio) |
| Source record ids | pub_dev-00013e43e11853 |
...
For a systems engineer, sentry_dio belongs in the Dart inventory as part of hot-path discovery,
...
- `pub_dev-00013e43e11853` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| firebase_performance | Profiler | [open](dart-firebase-performance-92ff4c46.md) |
