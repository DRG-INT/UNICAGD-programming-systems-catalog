...
| Canonical URL | [https://cli.github.com/manual/](https://cli.github.com/manual/) |
| Source record ids | curated_repository_workplace_routes-f6eeb0bb25d173 |

## System Engineer Summary

Official gh command-line client for repository search, issues, pull requests, releases, workflows,
authentication, and developer automation.

## Operational Role

For a systems engineer, GitHub CLI belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-f6eeb0bb25d173` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| GitLab CLI | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-gitlab-cli-56a6b9f6.md) |
