...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Assets](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/assets.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/google/fonts](https://github.com/google/fonts) |
| Source record ids | curated_language_routes-7bfa392796ffbb |

## System Engineer Summary

Font catalog and source repository for font-family metadata, binaries, licenses, and delivery
workflows.

## Operational Role

For a systems engineer, Google Fonts belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-7bfa392796ffbb` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Fontsource | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-fontsource-c7b01bc4.md) |
| OpenGameArt | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-opengameart-b3f0aa07.md) |
| Poly Haven | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-poly-haven-9f29b6e3.md) |
