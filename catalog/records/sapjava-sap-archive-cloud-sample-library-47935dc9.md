# SAP-archive/cloud-sample-library
...
<!-- canonical: https://github.com/SAP-archive/cloud-sample-library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-archive/cloud-sample-library](https://github.com/SAP-archive/cloud-sample-library) |
| Source record ids | github_search_sapjava-1cecd0e18113c0 |

## System Engineer Summary

The library is a sample Java application that runs on SAP HANA Cloud Platform, Java Web runtime, and
uses various platform services.

## Operational Role

For a systems engineer, SAP-archive/cloud-sample-library belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-17T00:24:57Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-1cecd0e18113c0` from `github_search_sapjava` as `registry_expansion`
