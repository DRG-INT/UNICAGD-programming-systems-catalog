...
<!-- canonical: https://github.com/SuperMap/iClient-JavaScript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SuperMap/iClient-JavaScript](https://github.com/SuperMap/iClient-JavaScript) |
| Source record ids | github_search_maps-dd22ac24e3e6f6 |

## System Engineer Summary

Modern GIS Web Client for JavaScript, based on Leaflet\OpenLayers\MapboxGL-JS\Classic(iClient8C),
enhanced with ECharts\D3\MapV etc. Contributed by SuperMap & community.

## Operational Role

For a systems engineer, SuperMap/iClient-JavaScript belongs in the Maps inventory as part of input-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T02:47:42Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-dd22ac24e3e6f6` from `github_search_maps` as `registry_expansion`
