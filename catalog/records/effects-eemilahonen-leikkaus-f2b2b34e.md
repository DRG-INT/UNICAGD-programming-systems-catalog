# EemilAhonen/leikkaus

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/EemilAhonen/leikkaus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EemilAhonen/leikkaus](https://github.com/EemilAhonen/leikkaus) |
| Source record ids | github_search_effects-1e9f15ed78aa8f |

## System Engineer Summary

EemilAhonen/leikkaus is tracked as a cli record in the Effects branch. The source did not provide a
...
For a systems engineer, EemilAhonen/leikkaus belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-04T22:16:25Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-1e9f15ed78aa8f` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| c8r/lab-cli | Cli | [open](effects-c8r-lab-cli-d2cc5cac.md) |
| CanYuzbey/Cpp-Audio-Bitcrusher | Cli | [open](effects-canyuzbey-cpp-audio-bitcrusher-d7defebc.md) |
| denialwm/denial | Cli | [open](effects-denialwm-denial-38ee513d.md) |
| ha7ilm/csdr | Cli | [open](effects-ha7ilm-csdr-5d56336a.md) |
| jmstajim/Particlized | Cli | [open](effects-jmstajim-particlized-6bb3d995.md) |
| kosa12/CRTty | Cli | [open](effects-kosa12-crtty-860c32b6.md) |
| lirios/shell | Cli | [open](effects-lirios-shell-c71c6048.md) |
| rwxrob/bonzai | Cli | [open](effects-rwxrob-bonzai-674c9c09.md) |
