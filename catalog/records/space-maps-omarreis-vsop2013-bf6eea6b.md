...
<!-- canonical: https://github.com/omarreis/vsop2013 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/omarreis/vsop2013](https://github.com/omarreis/vsop2013) |
| Source record ids | github_search_space_maps-82c96e2a3a2ce8 |

## System Engineer Summary

Astronomy. VSOP2013 planetary positions. PlanetFun App: Solar system model in 3D. LeapFrog Gravity
Integration. Stars, Moon and planets. The discovery of Neptune

## Operational Role

For a systems engineer, omarreis/vsop2013 belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-14T13:28:29Z | gh search repos topic:planetary-science stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-82c96e2a3a2ce8` from `github_search_space_maps` as `registry_expansion`
