...
<!-- canonical: https://cran.r-project.org/web/packages/TaxicabCA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TaxicabCA/index.html](https://cran.r-project.org/web/packages/TaxicabCA/index.html) |
| Source record ids | cran_packages_by_date-2e9b8a175ae41f |
...
For a systems engineer, TaxicabCA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-07 16:50:10 UTC | [https://cran.r-project.org/web/packages/TaxicabCA/DESCRIPTION](https://cran.r-project.org/web/packages/TaxicabCA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TaxicabCA/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-2e9b8a175ae41f` from `cran_packages_by_date` as `registry_expansion`
