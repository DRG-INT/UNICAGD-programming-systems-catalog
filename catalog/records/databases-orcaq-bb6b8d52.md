...
<!-- canonical: https://github.com/cin12211/orca-q -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cin12211/orca-q](https://github.com/cin12211/orca-q) |
| Source record ids | awesome_list-b81bf86fdc81e2 |

## System Engineer Summary

A modern, open-source database editor for PostgreSQL, MySQL, Redis, and more. Features an AI
assistant, ERD visualizer, schema diff, and visual role management.

## Operational Role

For a systems engineer, OrcaQ belongs in the Databases inventory as part of ecosystem capability
...
- `awesome_list-b81bf86fdc81e2` from `awesome_list` as `registry_expansion`
