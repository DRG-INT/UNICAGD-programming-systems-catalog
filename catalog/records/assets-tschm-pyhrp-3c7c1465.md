...
<!-- canonical: https://github.com/tschm/pyhrp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tschm/pyhrp](https://github.com/tschm/pyhrp) |
| Source record ids | github_search_assets-7e6e9adf085602 |

## System Engineer Summary

Cluster-based portfolio allocation on an explicit, inspectable tree: hierarchical risk parity, Schur
complementary allocation and hierarchical 1/N

## Operational Role

For a systems engineer, tschm/pyhrp belongs in the Assets inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T05:22:57Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-7e6e9adf085602` from `github_search_assets` as `registry_expansion`
