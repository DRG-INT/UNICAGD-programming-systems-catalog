...
<!-- canonical: https://wiki.gnome.org/Projects/GLib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://wiki.gnome.org/Projects/GLib](https://wiki.gnome.org/Projects/GLib) |
| Source record ids | awesome_list-887b59ae24561f |
...
For a systems engineer, GLib belongs in the C++23 inventory as part of build graph control, artifact
...
- `awesome_list-887b59ae24561f` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| libPhenom | Build System | [open](c-23-libphenom-ee350c2d.md) |
