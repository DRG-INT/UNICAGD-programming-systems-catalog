...
| Canonical URL | [https://luarocks.org/modules/heroeyad/flare](https://luarocks.org/modules/heroeyad/flare) |
| Source record ids | luarocks_root_manifest-7a24a460fbd769 |

## System Engineer Summary

A 2D game engine for LÖVE2D that gives you everything you need in one place!

## Operational Role

For a systems engineer, flare belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7a24a460fbd769` from `luarocks_root_manifest` as `registry_expansion`
