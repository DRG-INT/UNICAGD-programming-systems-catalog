...
<!-- canonical: https://crates.io/crates/tracing-attributes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tracing-attributes](https://crates.io/crates/tracing-attributes) |
| Source record ids | crates_io-2fa1422547b4d4 |
...
For a systems engineer, tracing-attributes belongs in the Rust inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.31 | 2025-11-26T11:23:01.809940Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-2fa1422547b4d4` from `crates_io` as `registry_expansion`
