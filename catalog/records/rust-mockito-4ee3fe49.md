...
<!-- canonical: https://crates.io/crates/mockito -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/mockito](https://crates.io/crates/mockito) |
| Source record ids | crates_io-abc4b37ba07991 |

## System Engineer Summary

mockito is tracked as an assertion mocking record in the Rust branch. The source did not provide a
...
For a systems engineer, mockito belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.2 | 2026-02-02T13:53:09.441223Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-abc4b37ba07991` from `crates_io` as `registry_expansion`
