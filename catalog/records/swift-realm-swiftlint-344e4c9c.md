...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/realm/SwiftLint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realm/SwiftLint](https://github.com/realm/SwiftLint) |
| Source record ids | github_search_swift-fb18eb0b68a93b |
...
For a systems engineer, realm/SwiftLint belongs in the Swift inventory as part of static feedback,
...
- `github_search_swift-fb18eb0b68a93b` from `github_search_swift` as `registry_expansion`
