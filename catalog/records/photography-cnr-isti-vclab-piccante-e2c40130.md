...
<!-- canonical: https://github.com/cnr-isti-vclab/piccante -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cnr-isti-vclab/piccante](https://github.com/cnr-isti-vclab/piccante) |
| Source record ids | github_search_photography-957c71912bd790 |
...
For a systems engineer, cnr-isti-vclab/piccante belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T20:36:31Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-957c71912bd790` from `github_search_photography` as `registry_expansion`
