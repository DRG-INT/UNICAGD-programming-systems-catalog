...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/microservices-demo/microservices-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microservices-demo/microservices-demo](https://github.com/microservices-demo/microservices-demo) |
| Source record ids | github_search_game_engines-9f979bbbaa141a |
...
For a systems engineer, microservices-demo/microservices-demo belongs in the Game Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-05T14:11:58Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-9f979bbbaa141a` from `github_search_game_engines` as `registry_expansion`
