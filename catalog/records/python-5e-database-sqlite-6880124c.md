...
<!-- canonical: https://pypi.org/project/5e-database-sqlite/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/5e-database-sqlite/](https://pypi.org/project/5e-database-sqlite/) |
| Source record ids | pypi_simple-3b3eb2958a8ced |

## System Engineer Summary

D&D 5e SRD data as a single SQLite file, plus a typed Python read API

## Operational Role

For a systems engineer, 5e-database-sqlite belongs in the Python inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.10.0.post5 | 2026-08-19T06:45:32.902044Z | [https://pypi.org/pypi/5e-database-sqlite/json](https://pypi.org/pypi/5e-database-sqlite/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/5e-database-sqlite/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-3b3eb2958a8ced` from `pypi_simple` as `registry_expansion`
