# ADSWNJ/On_Station_Ops

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ADSWNJ/On_Station_Ops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ADSWNJ/On_Station_Ops](https://github.com/ADSWNJ/On_Station_Ops) |
| Source record ids | github_search_space_shuttles-da1d3f64839727 |

## System Engineer Summary

On Station Ops: Orbiter Space Flight Simulator Open Source MFD AddOn for manipulating space station
building blocks

## Operational Role

For a systems engineer, ADSWNJ/On_Station_Ops belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-05-29T15:27:24Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-da1d3f64839727` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fredenigma/VesselBuilder | Build System | [open](space-shuttles-fredenigma-vesselbuilder-d1cb3bde.md) |
| tigerstigers2024-creator/space-simulator-game | Build System | [open](space-shuttles-tigerstigers2024-creator-space-simulator-game-63cffc0b.md) |
