...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Coverage](../by-category/coverage.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | corpus-0abb8ca49c9b78 |

## System Engineer Summary

Coverage.jl is tracked as a coverage record in the Julia branch. The source did not provide a long
...
For a systems engineer, Coverage.jl belongs in the Julia inventory as part of ecosystem capability
...
- `corpus-0abb8ca49c9b78` from `master_json` as `coverage`
