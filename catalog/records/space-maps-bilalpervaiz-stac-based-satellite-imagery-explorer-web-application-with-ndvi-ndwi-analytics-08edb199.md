# bilalpervaiz/STAC-based-Satellite-Imagery-Explorer-Web-Application-with-NDVI-NDWI-Analytics
...
<!-- canonical: https://github.com/bilalpervaiz/STAC-based-Satellite-Imagery-Explorer-Web-Application-with-NDVI-NDWI-Analytics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bilalpervaiz/STAC-based-Satellite-Imagery-Explorer-Web-Application-with-NDVI-NDWI-Analytics](https://github.com/bilalpervaiz/STAC-based-Satellite-Imagery-Explorer-Web-Application-with-NDVI-NDWI-Analytics) |
| Source record ids | github_search_space_maps-e26cfeacabfd16 |

## System Engineer Summary

A Streamlit based web application for searching, visualizing, and analyzing satellite imagery from
STAC catalogs. Features interactive maps, scene analytics (NDVI/NDWI), and direct access to asset
URLs via Planetary Computer.

## Operational Role

For a systems engineer, bilalpervaiz/STAC-based-Satellite-Imagery-Explorer-Web-Application-with-
NDVI-NDWI-Analytics belongs in the Space Maps inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-15T14:34:43Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e26cfeacabfd16` from `github_search_space_maps` as `registry_expansion`
