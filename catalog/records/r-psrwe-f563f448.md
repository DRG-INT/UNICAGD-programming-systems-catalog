...
<!-- canonical: https://cran.r-project.org/web/packages/psrwe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/psrwe/index.html](https://cran.r-project.org/web/packages/psrwe/index.html) |
| Source record ids | cran_packages_by_date-afab57309cc450 |
...
For a systems engineer, psrwe belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2-2 | 2026-08-21 05:41:12 UTC | [https://cran.r-project.org/web/packages/psrwe/DESCRIPTION](https://cran.r-project.org/web/packages/psrwe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/psrwe/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-afab57309cc450` from `cran_packages_by_date` as `registry_expansion`
