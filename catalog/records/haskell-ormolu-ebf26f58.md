...
<!-- canonical: https://hackage.haskell.org/package/ormolu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ormolu](https://hackage.haskell.org/package/ormolu) |
| Source record ids | hackage_top_downloads-e660e1c3e99a35 |
...
For a systems engineer, ormolu belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.0 | 2026-08-18T23:11:44Z | [https://hackage.haskell.org/package/ormolu](https://hackage.haskell.org/package/ormolu) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ormolu` at `2026-09-05T00:31:59+00:00`.
...
- `hackage_top_downloads-e660e1c3e99a35` from `hackage_top_downloads` as `registry_expansion`
