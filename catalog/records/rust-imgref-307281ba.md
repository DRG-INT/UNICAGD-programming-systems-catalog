...
<!-- canonical: https://crates.io/crates/imgref -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/imgref](https://crates.io/crates/imgref) |
| Source record ids | crates_io-8226524416d5a1 |

## System Engineer Summary

A basic 2-dimensional slice for safe and convenient handling of pixel buffers with width, height &
stride

## Operational Role

For a systems engineer, imgref belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12.3 | 2026-08-26T16:59:29.900111Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
