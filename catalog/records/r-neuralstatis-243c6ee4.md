...
<!-- canonical: https://cran.r-project.org/web/packages/NeuralSTATIS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NeuralSTATIS/index.html](https://cran.r-project.org/web/packages/NeuralSTATIS/index.html) |
| Source record ids | cran_packages_by_date-7e24f78f1d0647 |
...
For a systems engineer, NeuralSTATIS belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 12:30:15 UTC | [https://cran.r-project.org/web/packages/NeuralSTATIS/DESCRIPTION](https://cran.r-project.org/web/packages/NeuralSTATIS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NeuralSTATIS/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-7e24f78f1d0647` from `cran_packages_by_date` as `registry_expansion`
