...
<!-- canonical: https://cran.r-project.org/web/packages/icio/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/icio/index.html](https://cran.r-project.org/web/packages/icio/index.html) |
| Source record ids | cran_packages_by_date-e2f5c8c1f6a9c2 |
...
For a systems engineer, icio belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-07 10:20:02 UTC | [https://cran.r-project.org/web/packages/icio/DESCRIPTION](https://cran.r-project.org/web/packages/icio/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/icio/DESCRIPTION` at `2026-09-07T12:26:42+00:00`.
...
- `cran_packages_by_date-e2f5c8c1f6a9c2` from `cran_packages_by_date` as `registry_expansion`
