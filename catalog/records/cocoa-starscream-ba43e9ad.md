...
<!-- canonical: https://cocoapods.org/pods/Starscream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Starscream](https://cocoapods.org/pods/Starscream) |
| Source record ids | cocoapods_cdn-e010b138c3b623 |
...
For a systems engineer, Starscream belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.8 | 2024-03-07 19:03:52 UTC | [https://trunk.cocoapods.org/api/v1/pods/Starscream](https://trunk.cocoapods.org/api/v1/pods/Starscream) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Starscream` at `2026-09-01T07:21:37+00:00`.
...
- `cocoapods_cdn-e010b138c3b623` from `cocoapods_cdn` as `registry_expansion`
