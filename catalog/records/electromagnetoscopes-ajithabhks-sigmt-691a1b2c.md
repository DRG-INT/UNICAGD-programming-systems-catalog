...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Jit Vm](../by-category/jit-vm.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ajithabhks/sigmt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ajithabhks/sigmt](https://github.com/ajithabhks/sigmt) |
| Source record ids | github_search_electromagnetoscopes-494829f0d7b140 |

## System Engineer Summary

An open-source Python package for magnetotelluric time series data processing

## Operational Role

For a systems engineer, ajithabhks/sigmt belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T05:07:52Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-494829f0d7b140` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| vsergeev/luaradio | Jit Vm | [open](electromagnetoscopes-vsergeev-luaradio-d9cd45c1.md) |
