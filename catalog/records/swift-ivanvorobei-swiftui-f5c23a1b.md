...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ivanvorobei/SwiftUI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ivanvorobei/SwiftUI](https://github.com/ivanvorobei/SwiftUI) |
| Source record ids | github_search_swift-ecfad4aedde08c |

## System Engineer Summary

Examples projects using SwiftUI released by WWDC2019. Include Layout, UI, Animations, Gestures, Draw
and Data.

## Operational Role

For a systems engineer, ivanvorobei/SwiftUI belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-07T14:10:03Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-ecfad4aedde08c` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aheze/Popovers | Visualization Gui | [open](swift-aheze-popovers-2d58237a.md) |
| alin23/Lunar | Visualization Gui | [open](swift-alin23-lunar-a7569222.md) |
| AppPear/ChartView | Visualization Gui | [open](swift-apppear-chartview-2edf1090.md) |
| chris-swift-dev/AdvancedList | Visualization Gui | [open](swift-chris-swift-dev-advancedlist-cb3a259f.md) |
| CombineCommunity/rxswift-to-combine-cheatsheet | Visualization Gui | [open](swift-combinecommunity-rxswift-to-combine-cheatsheet-f838fd01.md) |
| daprice/Variablur | Visualization Gui | [open](swift-daprice-variablur-d07bc4f2.md) |
| EmergeTools/Pow | Visualization Gui | [open](swift-emergetools-pow-7350bd32.md) |
| hackiftekhar/IQKeyboardManager | Visualization Gui | [open](swift-hackiftekhar-iqkeyboardmanager-270f7036.md) |
