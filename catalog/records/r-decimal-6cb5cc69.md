...
<!-- canonical: https://cran.r-project.org/web/packages/decimal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/decimal/index.html](https://cran.r-project.org/web/packages/decimal/index.html) |
| Source record ids | cran_packages_by_date-5e05ab28b6f5d1 |
...
For a systems engineer, decimal belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-24 12:40:09 UTC | [https://cran.r-project.org/web/packages/decimal/DESCRIPTION](https://cran.r-project.org/web/packages/decimal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/decimal/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5e05ab28b6f5d1` from `cran_packages_by_date` as `registry_expansion`
