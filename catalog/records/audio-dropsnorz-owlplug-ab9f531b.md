...
<!-- canonical: https://github.com/DropSnorz/OwlPlug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DropSnorz/OwlPlug](https://github.com/DropSnorz/OwlPlug) |
| Source record ids | github_search_audio-7d447083b8e6d1 |

## System Engineer Summary

Audio plugin manager. Desktop application to manage VST / AU / LV2 plugins on Windows, MacOS and
Linux.

## Operational Role

For a systems engineer, DropSnorz/OwlPlug belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:40:43Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-7d447083b8e6d1` from `github_search_audio` as `registry_expansion`
