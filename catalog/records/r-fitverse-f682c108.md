...
<!-- canonical: https://cran.r-project.org/web/packages/FitVerse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FitVerse/index.html](https://cran.r-project.org/web/packages/FitVerse/index.html) |
| Source record ids | cran_packages_by_date-20ecc6c66839ef |
...
For a systems engineer, FitVerse belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-2 | 2026-09-06 22:40:14 UTC | [https://cran.r-project.org/web/packages/FitVerse/DESCRIPTION](https://cran.r-project.org/web/packages/FitVerse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FitVerse/DESCRIPTION` at `2026-09-07T00:31:41+00:00`.
...
- `cran_packages_by_date-20ecc6c66839ef` from `cran_packages_by_date` as `registry_expansion`
