...
<!-- canonical: https://github.com/FlorianBruniaux/starmapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FlorianBruniaux/starmapper](https://github.com/FlorianBruniaux/starmapper) |
| Source record ids | github_search_maps-25d97fa7e82b73 |

## System Engineer Summary

Paste a GitHub repo URL and see where your stargazers live on an interactive world map. Free, no
login.

## Operational Role

For a systems engineer, FlorianBruniaux/starmapper belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.9 | 2026-06-18T19:13:08Z | [https://api.github.com/repos/FlorianBruniaux/starmapper/releases/latest](https://api.github.com/repos/FlorianBruniaux/starmapper/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/FlorianBruniaux/starmapper/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-25d97fa7e82b73` from `github_search_maps` as `registry_expansion`
