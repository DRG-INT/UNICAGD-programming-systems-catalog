...
<!-- canonical: https://crates.io/crates/kube -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/kube](https://crates.io/crates/kube) |
| Source record ids | crates_io-72a84c60c5a672 |
...
For a systems engineer, kube belongs in the Rust inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-07-22T08:43:01.071129Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-72a84c60c5a672` from `crates_io` as `registry_expansion`
