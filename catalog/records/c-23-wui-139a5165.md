...
<!-- canonical: https://github.com/intent-garden/wui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/intent-garden/wui](https://github.com/intent-garden/wui) |
| Source record ids | awesome_list-674acad72de414 |

## System Engineer Summary

WUI (Window User Interface Library) is a cross-platform library for creating graphical user
interfaces in C++17+ Boost

## Operational Role

For a systems engineer, WUI belongs in the C++23 inventory as part of service communication,
...
- `awesome_list-674acad72de414` from `awesome_list` as `registry_expansion`
