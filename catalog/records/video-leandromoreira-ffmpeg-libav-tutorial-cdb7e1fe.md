...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/leandromoreira/ffmpeg-libav-tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leandromoreira/ffmpeg-libav-tutorial](https://github.com/leandromoreira/ffmpeg-libav-tutorial) |
| Source record ids | github_search_video-d9df2e191111a6 |
...
For a systems engineer, leandromoreira/ffmpeg-libav-tutorial belongs in the Video inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T14:18:13Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d9df2e191111a6` from `github_search_video` as `registry_expansion`
