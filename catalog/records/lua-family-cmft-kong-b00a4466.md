...
<!-- canonical: https://luarocks.org/modules/annexxb/cmft-kong -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/annexxb/cmft-kong](https://luarocks.org/modules/annexxb/cmft-kong) |
| Source record ids | luarocks_root_manifest-94cc8614b9c16f |

## System Engineer Summary

cmft-kong is tracked as a container deployment record in the Lua family branch. The source did not
...
For a systems engineer, cmft-kong belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-94cc8614b9c16f` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cmft-base-kong | Container Deployment | [open](lua-family-cmft-base-kong-a8a81810.md) |
