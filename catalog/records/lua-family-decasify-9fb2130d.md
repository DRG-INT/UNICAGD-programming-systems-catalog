...
<!-- canonical: https://luarocks.org/modules/alerque/decasify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alerque/decasify](https://luarocks.org/modules/alerque/decasify) |
| Source record ids | luarocks_root_manifest-ccb9344428ecbb |

## System Engineer Summary

Lua C module built from the Rust decasify crate to cast strings to title-case according to locale
specific style guides including Turkish support

## Operational Role

For a systems engineer, decasify belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ccb9344428ecbb` from `luarocks_root_manifest` as `registry_expansion`
