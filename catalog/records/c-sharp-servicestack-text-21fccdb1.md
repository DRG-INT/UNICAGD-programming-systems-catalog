...
<!-- canonical: https://www.nuget.org/packages/ServiceStack.Text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/ServiceStack.Text](https://www.nuget.org/packages/ServiceStack.Text) |
| Source record ids | nuget_search-ab35c7e40f8a46 |

## System Engineer Summary

.NET's fastest JSON, JSV and CSV Text Serializers. Fast, Light, Resilient. Contains ServiceStack's
high-performance text-processing powers, for more info see:

## Operational Role

For a systems engineer, ServiceStack.Text belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.1.4 | 2026-08-18T15:54:48.937+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/servicestack.text/index.json](https://api.nuget.org/v3/registration5-gz-semver2/servicestack.text/index.json) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; https://servicestack.net/terms |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/servicestack.text/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-ab35c7e40f8a46` from `nuget_search` as `registry_expansion`
