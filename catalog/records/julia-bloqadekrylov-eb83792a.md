...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BloqadeKrylov -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BloqadeKrylov](https://github.com/JuliaRegistries/General/tree/master/B/BloqadeKrylov) |
| Source record ids | julia_general-8a60cbaed0e1d0 |

## System Engineer Summary

Julia package registered in General at B/BloqadeKrylov.

## Operational Role

For a systems engineer, BloqadeKrylov belongs in the Julia inventory as part of ecosystem capability
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BloqadeKrylov", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-8a60cbaed0e1d0` from `julia_general` as `registry_expansion`
