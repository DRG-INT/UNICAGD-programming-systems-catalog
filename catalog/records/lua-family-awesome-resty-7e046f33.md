...
<!-- canonical: https://github.com/bungle/awesome-resty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bungle/awesome-resty](https://github.com/bungle/awesome-resty) |
| Source record ids | lua-source-161, lua-source-415 |
...
For a systems engineer, awesome-resty belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 161}}` |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 415}}` |
...
- `lua-source-161` from `master_json` as `source_list_item`
- `lua-source-415` from `master_json` as `source_list_item`
