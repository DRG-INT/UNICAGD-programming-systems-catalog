...
<!-- canonical: https://pub.dev/packages/soft_edge_blur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/soft_edge_blur](https://pub.dev/packages/soft_edge_blur) |
| Source record ids | pub_dev-3bedf1ba28e16c |

## System Engineer Summary

A customizable Flutter widget that applies a soft progressive blur effect to one or more edges of
its child widget.

## Operational Role

For a systems engineer, soft_edge_blur belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2024-09-28T15:22:06.400166Z | [https://pub.dev/api/packages/soft_edge_blur](https://pub.dev/api/packages/soft_edge_blur) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/soft_edge_blur` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-3bedf1ba28e16c` from `pub_dev` as `registry_expansion`
