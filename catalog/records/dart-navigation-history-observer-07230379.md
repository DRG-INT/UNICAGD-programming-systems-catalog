...
<!-- canonical: https://pub.dev/packages/navigation_history_observer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/navigation_history_observer](https://pub.dev/packages/navigation_history_observer) |
| Source record ids | pub_dev-6f23923f659503 |

## System Engineer Summary

A Flutter NavigatorObserver that stores a collection of pushed routes history, as well as the popped
history.

## Operational Role

For a systems engineer, navigation_history_observer belongs in the Dart inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2024-04-17T08:27:30.593848Z | [https://pub.dev/api/packages/navigation_history_observer](https://pub.dev/api/packages/navigation_history_observer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/navigation_history_observer` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-6f23923f659503` from `pub_dev` as `registry_expansion`
