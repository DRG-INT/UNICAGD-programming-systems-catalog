...
<!-- canonical: https://github.com/arnaudroger/SimpleFlatMapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arnaudroger/SimpleFlatMapper](https://github.com/arnaudroger/SimpleFlatMapper) |
| Source record ids | github_search_databases-7c228b36c9a8c4 |

## System Engineer Summary

Fast and Easy mapping from database and csv to POJO. A java micro ORM, lightweight alternative to
iBatis and Hibernate. Fast Csv Parser and Csv Mapper

## Operational Role

For a systems engineer, arnaudroger/SimpleFlatMapper belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-21T07:23:46Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7c228b36c9a8c4` from `github_search_databases` as `registry_expansion`
