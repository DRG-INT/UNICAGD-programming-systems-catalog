...
<!-- canonical: https://github.com/ermig1979/Simd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ermig1979/Simd](https://github.com/ermig1979/Simd) |
| Source record ids | github_search_photography-8fab923976912b |

## System Engineer Summary

C++ image processing and machine learning library with using of SIMD: SSE, AVX, AVX-512, AMX for
x86/x64, NEON, SVE for ARM, HVX for Hexagon

## Operational Role

For a systems engineer, ermig1979/Simd belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:18:56Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-8fab923976912b` from `github_search_photography` as `registry_expansion`
