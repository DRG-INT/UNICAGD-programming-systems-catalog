...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sophiapoirier/destroyfx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sophiapoirier/destroyfx](https://github.com/sophiapoirier/destroyfx) |
| Source record ids | github_search_audio-daff501db28fc8 |

## System Engineer Summary

Destroy FX is a music software project of Sophia Poirier and Tom Murphy 7. Mostly we make audio
effect plugins that destroy your sound. Supported plugin APIs include Audio Unit and VST. Includes
the DfxPlugin and DFX GUI frameworks.

## Operational Role

For a systems engineer, sophiapoirier/destroyfx belongs in the Audio inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T05:11:10Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_audio-daff501db28fc8` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| anthonyalfimov/JUCE-CMake-Plugin-Template | Build System | [open](audio-anthonyalfimov-juce-cmake-plugin-template-de566887.md) |
| AuburnSounds/Dplug | Build System | [open](audio-auburnsounds-dplug-ce592fbe.md) |
| DatanoiseTV/PicoADK-Firmware-Template | Build System | [open](audio-datanoisetv-picoadk-firmware-template-0a582266.md) |
| DatanoiseTV/PicoADK-Hardware | Build System | [open](audio-datanoisetv-picoadk-hardware-6bb2962f.md) |
| gmoe/vst-cmake | Build System | [open](audio-gmoe-vst-cmake-371adc63.md) |
| google/oboe | Build System | [open](audio-google-oboe-35d1f11e.md) |
| HaveAGitGat/Tdarr | Build System | [open](audio-haveagitgat-tdarr-25ea9a0b.md) |
| ijnekenamay/M8HeadlessStaging | Build System | [open](audio-ijnekenamay-m8headlessstaging-af5b7ae5.md) |
