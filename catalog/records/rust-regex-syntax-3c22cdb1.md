...
<!-- canonical: https://crates.io/crates/regex-syntax -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/regex-syntax](https://crates.io/crates/regex-syntax) |
| Source record ids | crates_io-2b5b203967b6a1 |
...
For a systems engineer, regex-syntax belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.11 | 2026-06-09T15:00:25.566550Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-2b5b203967b6a1` from `crates_io` as `registry_expansion`
