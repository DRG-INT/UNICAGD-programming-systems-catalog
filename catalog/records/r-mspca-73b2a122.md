...
<!-- canonical: https://cran.r-project.org/web/packages/msPCA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/msPCA/index.html](https://cran.r-project.org/web/packages/msPCA/index.html) |
| Source record ids | cran_packages_by_date-56e00a8f173ffb |
...
For a systems engineer, msPCA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-08-25 10:40:08 UTC | [https://cran.r-project.org/web/packages/msPCA/DESCRIPTION](https://cran.r-project.org/web/packages/msPCA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/msPCA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-56e00a8f173ffb` from `cran_packages_by_date` as `registry_expansion`
