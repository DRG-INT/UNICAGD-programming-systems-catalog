...
| Canonical URL | [https://crates.io/crates/uuid-simd](https://crates.io/crates/uuid-simd) |
| Source record ids | crates_io-d539f9bd2d6970 |
...
For a systems engineer, uuid-simd belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2022-12-28T03:07:07.231984Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-d539f9bd2d6970` from `crates_io` as `registry_expansion`
