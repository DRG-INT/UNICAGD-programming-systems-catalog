...
<!-- canonical: https://github.com/subframe7536/maple-font -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/subframe7536/maple-font](https://github.com/subframe7536/maple-font) |
| Source record ids | github_search_font_briefcase-964bc00752b01d |

## System Engineer Summary

Maple Mono: Open source monospace font with round corner, ligatures and Nerd-Font icons for IDE and
terminal, fine-grained customization options. 带连字和控制台图标的圆角等宽字体，中英文宽度完美2:1，细粒度的自定义选项

## Operational Role

For a systems engineer, subframe7536/maple-font belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:22:35Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-964bc00752b01d` from `github_search_font_briefcase` as `registry_expansion`
