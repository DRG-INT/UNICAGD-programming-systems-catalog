...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BrillouinZoneMeshes](https://github.com/JuliaRegistries/General/tree/master/B/BrillouinZoneMeshes) |
| Source record ids | julia_general-58de6336f83101 |

## System Engineer Summary

Julia package registered in General at B/BrillouinZoneMeshes.

## Operational Role

For a systems engineer, BrillouinZoneMeshes belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BrillouinZoneMeshes", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-58de6336f83101` from `julia_general` as `registry_expansion`
