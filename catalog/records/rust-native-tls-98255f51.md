...
<!-- canonical: https://crates.io/crates/native-tls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/native-tls](https://crates.io/crates/native-tls) |
| Source record ids | crates_io-fbc4d9caf0785a |
...
For a systems engineer, native-tls belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.18 | 2026-02-18T17:46:54.517554Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-fbc4d9caf0785a` from `crates_io` as `registry_expansion`
