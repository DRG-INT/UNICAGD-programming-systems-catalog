...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_webassembly-bdb53fa3c440a7 |

## System Engineer Summary

WebAssembly/wasi-threads is tracked as a concurrency parallelism record in the WebAssembly branch.
...
- `github_search_webassembly-bdb53fa3c440a7` from `github_search_webassembly` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| WebAssembly threads in Firefox (2020) | Concurrency Parallelism | [open](webassembly-webassembly-threads-in-firefox-2020-8d1230b4.md) |
