...
| Canonical URL | [https://crates.io/crates/regress](https://crates.io/crates/regress) |
| Source record ids | crates_io-d0c70701883318 |
...
For a systems engineer, regress belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-08-23T22:32:55.828904Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-d0c70701883318` from `crates_io` as `registry_expansion`
