...
<!-- canonical: https://gitlab.com/librespacefoundation/satnogs/satnogs-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/librespacefoundation/satnogs/satnogs-client](https://gitlab.com/librespacefoundation/satnogs/satnogs-client) |
| Source record ids | curated_language_routes-d7dce9efa03547 |

## System Engineer Summary

Ground-station client software for satellite observation automation and data forwarding.

## Operational Role

For a systems engineer, SatNOGS Client belongs in the SatCom Satellites inventory as part of service
...
- `curated_language_routes-d7dce9efa03547` from `curated_language_routes` as `registry_expansion`
...
| SatCom-TELMA/MA-DRL_Routing_Simulator | Networking Http | [open](satcom-satellites-satcom-telma-ma-drl-routing-simulator-149f4099.md) |
