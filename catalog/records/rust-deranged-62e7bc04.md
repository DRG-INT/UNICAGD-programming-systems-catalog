...
<!-- canonical: https://crates.io/crates/deranged -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/deranged](https://crates.io/crates/deranged) |
| Source record ids | crates_io-7347a5b58a76da |

## System Engineer Summary

deranged is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, deranged belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.8 | 2026-02-21T21:37:43.676837Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-7347a5b58a76da` from `crates_io` as `registry_expansion`
