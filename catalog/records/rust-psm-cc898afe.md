...
<!-- canonical: https://crates.io/crates/psm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/psm](https://crates.io/crates/psm) |
| Source record ids | crates_io-7be6aeecfc837a |
...
For a systems engineer, psm belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.32 | 2026-08-02T09:30:52.432582Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-7be6aeecfc837a` from `crates_io` as `registry_expansion`
