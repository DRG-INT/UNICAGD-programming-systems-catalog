...
<!-- canonical: https://pypi.org/project/abox-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abox-cli/](https://pypi.org/project/abox-cli/) |
| Source record ids | pypi_simple-f64646e9915657 |

## System Engineer Summary

Sandboxed, network-restricted Claude Code environments with MCP access via Docker MCP Gateway

## Operational Role

For a systems engineer, abox-cli belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-07-25T15:35:53.649591Z | [https://pypi.org/pypi/abox-cli/json](https://pypi.org/pypi/abox-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abox-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-f64646e9915657` from `pypi_simple` as `registry_expansion`
