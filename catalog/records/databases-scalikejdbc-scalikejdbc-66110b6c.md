...
<!-- canonical: https://github.com/scalikejdbc/scalikejdbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scalikejdbc/scalikejdbc](https://github.com/scalikejdbc/scalikejdbc) |
| Source record ids | github_search_databases-4c31cb45ed39fd |

## System Engineer Summary

A tidy SQL-based DB access library for Scala developers. This library naturally wraps JDBC APIs and
provides you easy-to-use APIs.

## Operational Role

For a systems engineer, scalikejdbc/scalikejdbc belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T05:47:24Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4c31cb45ed39fd` from `github_search_databases` as `registry_expansion`
