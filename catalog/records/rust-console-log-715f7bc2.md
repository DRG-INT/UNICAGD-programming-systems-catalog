...
| Canonical URL | [https://crates.io/crates/console_log](https://crates.io/crates/console_log) |
| Source record ids | crates_io-5ff970571a28a1 |
...
For a systems engineer, console_log belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-07-15T05:30:41.225105Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-5ff970571a28a1` from `crates_io` as `registry_expansion`
