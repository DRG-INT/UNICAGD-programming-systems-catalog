...
<!-- canonical: https://github.com/cs-chan/Total-Text-Dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cs-chan/Total-Text-Dataset](https://github.com/cs-chan/Total-Text-Dataset) |
| Source record ids | github_search_matlab-8020061d211839 |

## System Engineer Summary

Total Text Dataset. It consists of 1555 images with more than 3 different text orientations:
Horizontal, Multi-Oriented, and Curved, one of a kind.

## Operational Role

For a systems engineer, cs-chan/Total-Text-Dataset belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T06:16:29Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-8020061d211839` from `github_search_matlab` as `registry_expansion`
