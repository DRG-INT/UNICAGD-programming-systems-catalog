...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Type Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/type-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | type_checker |
| Verification | web_verified_this_pass |
| Canonical URL | [https://pyrefly.org/](https://pyrefly.org/) |
| Source record ids | web-verified-0006 |

## System Engineer Summary

pyrefly is tracked as a type checker record in the Python branch. The source did not provide a long
...
For a systems engineer, pyrefly belongs in the Python inventory as part of interface contracts,
...
| --- | --- | --- | --- |
| web_research |  |  | `{"kind": "web_research", "source": {"kind": "web_research", "retrieved": "2026-09-01"}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `web-verified-0006` from `master_json` as `type_checker`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| mypy | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-mypy-843396a3.md) |
| pyright | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pyright-6e199d5e.md) |
| ty | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-ty-0d00060d.md) |
| Zuban | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-zuban-b597053a.md) |
