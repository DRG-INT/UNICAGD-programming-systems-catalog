...
<!-- canonical: https://github.com/mob-sakai/UIEffect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mob-sakai/UIEffect](https://github.com/mob-sakai/UIEffect) |
| Source record ids | github_search_effects-e3682c9452b78a |

## System Engineer Summary

UIEffect is an open-source package that allows you to intuitively apply rich UI effects directly
from the Inspector or via code. Combine various filters, such as grayscale, blur, and dissolve, to
decorate your UI with a unique visual style!

## Operational Role

For a systems engineer, mob-sakai/UIEffect belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T08:14:38Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e3682c9452b78a` from `github_search_effects` as `registry_expansion`
