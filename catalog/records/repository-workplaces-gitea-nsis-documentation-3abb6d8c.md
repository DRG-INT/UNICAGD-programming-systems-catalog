...
<!-- canonical: https://gitea.com/NSIS/Documentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/NSIS/Documentation](https://gitea.com/NSIS/Documentation) |
| Source record ids | gitea_repositories_api-a32bd443569edc |
...
For a systems engineer, Gitea: NSIS/Documentation belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-25T08:43:59Z | [https://gitea.com/api/v1/repos/search?q=documentation&limit=50](https://gitea.com/api/v1/repos/search?q=documentation&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-a32bd443569edc` from `gitea_repositories_api` as `registry_expansion`
