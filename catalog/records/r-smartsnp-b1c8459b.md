...
<!-- canonical: https://cran.r-project.org/web/packages/smartsnp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smartsnp/index.html](https://cran.r-project.org/web/packages/smartsnp/index.html) |
| Source record ids | cran_packages_by_date-4a6fd3ab1bfc32 |
...
For a systems engineer, smartsnp belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-09 22:50:02 UTC | [https://cran.r-project.org/web/packages/smartsnp/DESCRIPTION](https://cran.r-project.org/web/packages/smartsnp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smartsnp/DESCRIPTION` at `2026-09-10T00:26:07+00:00`.
...
- `cran_packages_by_date-4a6fd3ab1bfc32` from `cran_packages_by_date` as `registry_expansion`
