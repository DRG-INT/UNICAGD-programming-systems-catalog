...
| Source record ids | corpus-3d09e301874a21 |

## System Engineer Summary

musl libc is tracked as a library record in the C99 branch. The source did not provide a long
...
For a systems engineer, musl libc belongs in the C99 inventory as part of ecosystem capability
...
- `corpus-3d09e301874a21` from `master_json` as `library`
