...
| Canonical URL | [https://crates.io/crates/gtk](https://crates.io/crates/gtk) |
| Source record ids | crates_io-7251b7b35ba459 |
...
For a systems engineer, gtk belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.2 | 2024-12-09T11:46:31.974872Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-7251b7b35ba459` from `crates_io` as `registry_expansion`
