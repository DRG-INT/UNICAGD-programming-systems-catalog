...
<!-- canonical: https://github.com/Neopallium/lualogging -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Neopallium/lualogging](https://github.com/Neopallium/lualogging) |
| Source record ids | lua-source-149 |
...
For a systems engineer, LuaLogging belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 149}}` |
...
- `lua-source-149` from `master_json` as `source_list_item`
