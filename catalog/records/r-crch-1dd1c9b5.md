...
<!-- canonical: https://cran.r-project.org/web/packages/crch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crch/index.html](https://cran.r-project.org/web/packages/crch/index.html) |
| Source record ids | cran_packages_by_date-70f986d3914e73 |
...
For a systems engineer, crch belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2-3 | 2026-08-27 10:50:07 UTC | [https://cran.r-project.org/web/packages/crch/DESCRIPTION](https://cran.r-project.org/web/packages/crch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crch/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-70f986d3914e73` from `cran_packages_by_date` as `registry_expansion`
