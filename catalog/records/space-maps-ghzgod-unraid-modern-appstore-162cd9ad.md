...
<!-- canonical: https://github.com/ghzgod/unraid-modern-appstore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ghzgod/unraid-modern-appstore](https://github.com/ghzgod/unraid-modern-appstore) |
| Source record ids | github_search_space_maps-6e5cd868106149 |

## System Engineer Summary

Unraid Modern App Store: a modern front-end for the Community Applications page with a card grid,
GitHub star counts, trending and full-catalog sorting. Never modifies Community Applications.

## Operational Role

For a systems engineer, ghzgod/unraid-modern-appstore belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T19:59:06Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-6e5cd868106149` from `github_search_space_maps` as `registry_expansion`
