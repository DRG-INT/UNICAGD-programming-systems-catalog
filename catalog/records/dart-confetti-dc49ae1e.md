...
<!-- canonical: https://pub.dev/packages/confetti -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/confetti](https://pub.dev/packages/confetti) |
| Source record ids | pub_dev-413280794b3424 |

## System Engineer Summary

Blast colorful confetti all over the screen. Celebrate in app achievements with style. Control the
velocity, angle, gravity and amount of confetti.

## Operational Role

For a systems engineer, confetti belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2024-09-28T21:47:44.167789Z | [https://pub.dev/api/packages/confetti](https://pub.dev/api/packages/confetti) |  |
| preview | known | 0.6.0-nullsafety | 2021-03-06T21:57:57.653096Z | [https://pub.dev/api/packages/confetti](https://pub.dev/api/packages/confetti) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/confetti` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-413280794b3424` from `pub_dev` as `registry_expansion`
