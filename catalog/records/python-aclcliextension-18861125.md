...
<!-- canonical: https://pypi.org/project/aclcliextension/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclcliextension/](https://pypi.org/project/aclcliextension/) |
| Source record ids | pypi_simple-c1f828deadae04 |

## System Engineer Summary

aclcliextension is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, aclcliextension belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2020-03-13T09:19:10.380671Z | [https://pypi.org/pypi/aclcliextension/json](https://pypi.org/pypi/aclcliextension/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclcliextension/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-c1f828deadae04` from `pypi_simple` as `registry_expansion`
