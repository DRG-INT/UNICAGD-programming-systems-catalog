...
<!-- canonical: https://crates.io/crates/tokio-native-tls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-native-tls](https://crates.io/crates/tokio-native-tls) |
| Source record ids | crates_io-63a39796a18e53 |

## System Engineer Summary

An implementation of TLS/SSL streams for Tokio using native-tls giving an implementation of TLS for
nonblocking I/O streams.

## Operational Role

For a systems engineer, tokio-native-tls belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2023-02-07T17:08:45.567482Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-63a39796a18e53` from `crates_io` as `registry_expansion`
