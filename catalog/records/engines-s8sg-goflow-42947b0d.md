...
<!-- canonical: https://github.com/s8sg/goflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/s8sg/goflow](https://github.com/s8sg/goflow) |
| Source record ids | github_search_engines-bcd532e1b79f4e |
...
For a systems engineer, s8sg/goflow belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-18T02:34:29Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-bcd532e1b79f4e` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cocos/cocos-engine | Benchmarking | [open](engines-cocos-cocos-engine-0071cceb.md) |
