...
<!-- canonical: https://pub.dev/packages/camera_web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/camera_web](https://pub.dev/packages/camera_web) |
| Source record ids | pub_dev-d75c1b6d6032c0 |
...
For a systems engineer, camera_web belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.5+5 | 2026-08-07T00:23:32.452605Z | [https://pub.dev/api/packages/camera_web](https://pub.dev/api/packages/camera_web) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/camera_web` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-d75c1b6d6032c0` from `pub_dev` as `registry_expansion`
