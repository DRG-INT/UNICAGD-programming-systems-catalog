...
<!-- canonical: https://github.com/tonsky/AnyBar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tonsky/AnyBar](https://github.com/tonsky/AnyBar) |
| Source record ids | github_search_cocoa-72a2342f31a9db |
...
For a systems engineer, tonsky/AnyBar belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-21T12:54:03Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; MIT License; https://api.github.com/licenses/mit; Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0 |
...
- `github_search_cocoa-72a2342f31a9db` from `github_search_cocoa` as `registry_expansion`
