...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Renderers](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/renderers.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.chromium.org/developers/design-documents/gpu-accelerated-compositing-in-chrome/](https://www.chromium.org/developers/design-documents/gpu-accelerated-compositing-in-chrome/) |
| Source record ids | curated_language_routes-c146c54512b3e5 |

## System Engineer Summary

Chromium renderer/compositor architecture route for browser GPU acceleration, compositing, and
surfaces.

## Operational Role

For a systems engineer, Chromium Rendering Architecture belongs in the Renderers inventory as part
...
- `curated_language_routes-c146c54512b3e5` from `curated_language_routes` as `registry_expansion`
