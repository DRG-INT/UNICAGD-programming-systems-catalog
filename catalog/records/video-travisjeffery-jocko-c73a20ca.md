...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/travisjeffery/jocko -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/travisjeffery/jocko](https://github.com/travisjeffery/jocko) |
| Source record ids | github_search_video-4a6a6a8e092c96 |

## System Engineer Summary

Kafka implemented in Golang with built-in coordination (No ZK dep, single binary install, Cloud
Native)

## Operational Role

For a systems engineer, travisjeffery/jocko belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-20T05:16:03Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-4a6a6a8e092c96` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/kafka | Message Broker | [open](video-apache-kafka-8eb79a8a.md) |
