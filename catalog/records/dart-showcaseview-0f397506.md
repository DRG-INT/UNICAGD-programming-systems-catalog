...
<!-- canonical: https://pub.dev/packages/showcaseview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/showcaseview](https://pub.dev/packages/showcaseview) |
| Source record ids | pub_dev-d06c231494fcd3 |
...
For a systems engineer, showcaseview belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.0 | 2026-06-17T12:20:38.152717Z | [https://pub.dev/api/packages/showcaseview](https://pub.dev/api/packages/showcaseview) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/showcaseview` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-d06c231494fcd3` from `pub_dev` as `registry_expansion`
