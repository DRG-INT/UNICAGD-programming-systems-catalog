...
<!-- canonical: https://github.com/cybergalactic/MSS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cybergalactic/MSS](https://github.com/cybergalactic/MSS) |
| Source record ids | github_search_matlab-f60dcc980d55a5 |

## System Engineer Summary

The Marine Systems Simulator (MSS) is software that supplements the textbook "Handbook of Marine
Craft Hydrodynamics and Motion Control," 2nd Edition, by T. I. Fossen, published in 2021 by John
Wiley & Sons Ltd.

## Operational Role

For a systems engineer, cybergalactic/MSS belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T12:36:13Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-f60dcc980d55a5` from `github_search_matlab` as `registry_expansion`
