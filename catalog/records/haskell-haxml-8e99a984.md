...
<!-- canonical: https://hackage.haskell.org/package/HaXml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HaXml](https://hackage.haskell.org/package/HaXml) |
| Source record ids | hackage_top_downloads-983316259f9716 |

## System Engineer Summary

Hackage package with 82 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, HaXml belongs in the Haskell inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.25.14 | 2024-12-12T12:36:15Z | [https://hackage.haskell.org/package/HaXml](https://hackage.haskell.org/package/HaXml) |  |
| candidate | partial | 1.25.5 |  | [https://hackage.haskell.org/package/HaXml](https://hackage.haskell.org/package/HaXml) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HaXml` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-983316259f9716` from `hackage_top_downloads` as `registry_expansion`
...
| json-feed | Serialization | [open](haskell-json-feed-b77272e1.md) |
