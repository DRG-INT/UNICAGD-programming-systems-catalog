...
<!-- canonical: https://github.com/jd-alexander/LikeButton -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jd-alexander/LikeButton](https://github.com/jd-alexander/LikeButton) |
| Source record ids | github_search_icons_and_logos-60b349d38d2c3a |
...
For a systems engineer, jd-alexander/LikeButton belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-26T16:26:58Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-60b349d38d2c3a` from `github_search_icons_and_logos` as `registry_expansion`
