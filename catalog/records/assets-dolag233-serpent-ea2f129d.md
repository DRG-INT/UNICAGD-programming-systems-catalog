...
<!-- canonical: https://github.com/dolag233/Serpent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dolag233/Serpent](https://github.com/dolag233/Serpent) |
| Source record ids | github_search_assets-d9487243817ddb |

## System Engineer Summary

Cross-platform digital asset management software for game artists, VFX professionals, and graphic
and motion designers.

## Operational Role

For a systems engineer, dolag233/Serpent belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:04:24Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d9487243817ddb` from `github_search_assets` as `registry_expansion`
