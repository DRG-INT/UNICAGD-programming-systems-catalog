...
| Canonical URL | [https://luarocks.org/modules/simantakaushik/kong-jwt-firebase](https://luarocks.org/modules/simantakaushik/kong-jwt-firebase) |
| Source record ids | luarocks_root_manifest-65fa224c02af05 |

## System Engineer Summary

This plugin allows Kong 2.0+ to verify JWT Firebase Token.

## Operational Role

For a systems engineer, kong-jwt-firebase belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-65fa224c02af05` from `luarocks_root_manifest` as `registry_expansion`
