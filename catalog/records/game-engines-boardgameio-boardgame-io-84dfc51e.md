...
<!-- canonical: https://github.com/boardgameio/boardgame.io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/boardgameio/boardgame.io](https://github.com/boardgameio/boardgame.io) |
| Source record ids | github_search_game_engines-1286e9b1134051 |
...
For a systems engineer, boardgameio/boardgame.io belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T21:25:56Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-1286e9b1134051` from `github_search_game_engines` as `registry_expansion`
