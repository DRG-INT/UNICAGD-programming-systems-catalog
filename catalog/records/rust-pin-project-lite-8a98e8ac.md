...
<!-- canonical: https://crates.io/crates/pin-project-lite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pin-project-lite](https://crates.io/crates/pin-project-lite) |
| Source record ids | crates_io-eec0a4545dc332 |
...
For a systems engineer, pin-project-lite belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.17 | 2026-02-27T15:19:08.132543Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-eec0a4545dc332` from `crates_io` as `registry_expansion`
