...
<!-- canonical: https://packagist.org/packages/thingengineer/mysqli-database-class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/thingengineer/mysqli-database-class](https://packagist.org/packages/thingengineer/mysqli-database-class) |
| Source record ids | packagist_search-2f75573cf1cc0d |
...
For a systems engineer, thingengineer/mysqli-database-class belongs in the PHP inventory as part of
...
- `packagist_search-2f75573cf1cc0d` from `packagist_search` as `registry_expansion`
