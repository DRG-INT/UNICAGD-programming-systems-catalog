...
<!-- canonical: https://cran.r-project.org/web/packages/yrnd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/yrnd/index.html](https://cran.r-project.org/web/packages/yrnd/index.html) |
| Source record ids | cran_packages_by_date-3ab9fa34bfd7e8 |

## System Engineer Summary

Extracts Risk Neutral Densities of Prices, Money Market Rates and Government Bond Yields from
Interest Rates Futures Options Prices

## Operational Role

For a systems engineer, yrnd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-28 21:20:02 UTC | [https://cran.r-project.org/web/packages/yrnd/DESCRIPTION](https://cran.r-project.org/web/packages/yrnd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/yrnd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3ab9fa34bfd7e8` from `cran_packages_by_date` as `registry_expansion`
