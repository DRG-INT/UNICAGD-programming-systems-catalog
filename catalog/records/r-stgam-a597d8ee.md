...
<!-- canonical: https://cran.r-project.org/web/packages/stgam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stgam/index.html](https://cran.r-project.org/web/packages/stgam/index.html) |
| Source record ids | cran_packages_by_date-b003ce6b6b09b6 |
...
For a systems engineer, stgam belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-19 22:10:02 UTC | [https://cran.r-project.org/web/packages/stgam/DESCRIPTION](https://cran.r-project.org/web/packages/stgam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stgam/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b003ce6b6b09b6` from `cran_packages_by_date` as `registry_expansion`
