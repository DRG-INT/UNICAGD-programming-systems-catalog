...
<!-- canonical: https://crates.io/crates/windows-targets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-targets](https://crates.io/crates/windows-targets) |
| Source record ids | crates_io-351999be3093e3 |

## System Engineer Summary

windows-targets is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, windows-targets belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.53.5 | 2025-10-06T19:18:45.726277Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-351999be3093e3` from `crates_io` as `registry_expansion`
