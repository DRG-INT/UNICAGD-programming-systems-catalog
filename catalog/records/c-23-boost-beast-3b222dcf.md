...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-74b38016147972 |

## System Engineer Summary

Boost.Beast is tracked as a networking http record in the C++23 branch. The source did not provide a
...
For a systems engineer, Boost.Beast belongs in the C++23 inventory as part of service communication,
...
- `corpus-74b38016147972` from `master_json` as `networking_http`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Boost.Asio | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-boost-asio-2d8f542b.md) |
| cpp-httplib | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-cpp-httplib-b7f4509d.md) |
| cpr | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-cpr-7dec27db.md) |
| Drogon | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-drogon-0adaa9e7.md) |
| Restinio | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-restinio-d4c823eb.md) |
