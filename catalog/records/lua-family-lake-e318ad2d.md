...
<!-- canonical: https://github.com/stevedonovan/Lake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevedonovan/Lake](https://github.com/stevedonovan/Lake) |
| Source record ids | lua-source-80 |
...
For a systems engineer, Lake belongs in the Lua family inventory as part of build graph control,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 80}}` |
...
- `lua-source-80` from `master_json` as `source_list_item`
