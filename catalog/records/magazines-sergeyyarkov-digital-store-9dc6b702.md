...
<!-- canonical: https://github.com/sergeyyarkov/digital-store -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sergeyyarkov/digital-store](https://github.com/sergeyyarkov/digital-store) |
| Source record ids | github_search_magazines-abc21179d7a798 |
...
For a systems engineer, sergeyyarkov/digital-store belongs in the Magazines inventory as part of
...
- `github_search_magazines-abc21179d7a798` from `github_search_magazines` as `registry_expansion`
...
| DenserMeerkat/June | Web Framework | [open](magazines-densermeerkat-june-9f006367.md) |
