...
<!-- canonical: https://github.com/Ziptastic/ziptastic-jquery-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ziptastic/ziptastic-jquery-plugin](https://github.com/Ziptastic/ziptastic-jquery-plugin) |
| Source record ids | github_search_maps-54c0b3344f1958 |
...
For a systems engineer, Ziptastic/ziptastic-jquery-plugin belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.0 | 2016-07-17T19:52:06Z | [https://api.github.com/repos/Ziptastic/ziptastic-jquery-plugin/releases/latest](https://api.github.com/repos/Ziptastic/ziptastic-jquery-plugin/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Ziptastic/ziptastic-jquery-plugin/releases/latest` at `2026-09-01T12:30:06+00:00`.
...
- `github_search_maps-54c0b3344f1958` from `github_search_maps` as `registry_expansion`
