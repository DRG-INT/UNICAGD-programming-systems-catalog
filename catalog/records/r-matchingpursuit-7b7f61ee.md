...
<!-- canonical: https://cran.r-project.org/web/packages/MatchingPursuit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MatchingPursuit/index.html](https://cran.r-project.org/web/packages/MatchingPursuit/index.html) |
| Source record ids | cran_packages_by_date-36a16afc1b6978 |
...
For a systems engineer, MatchingPursuit belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-19 15:10:02 UTC | [https://cran.r-project.org/web/packages/MatchingPursuit/DESCRIPTION](https://cran.r-project.org/web/packages/MatchingPursuit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MatchingPursuit/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-36a16afc1b6978` from `cran_packages_by_date` as `registry_expansion`
