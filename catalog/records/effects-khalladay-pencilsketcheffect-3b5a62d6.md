...
<!-- canonical: https://github.com/khalladay/PencilSketchEffect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/khalladay/PencilSketchEffect](https://github.com/khalladay/PencilSketchEffect) |
| Source record ids | github_search_effects-97c0118c11f4b0 |
...
For a systems engineer, khalladay/PencilSketchEffect belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-18T11:13:47Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-97c0118c11f4b0` from `github_search_effects` as `registry_expansion`
