...
| Canonical URL | [https://crates.io/crates/memmem](https://crates.io/crates/memmem) |
| Source record ids | crates_io-def9582a01ff36 |

## System Engineer Summary

memmem is tracked as an undefined behavior analyzer record in the Rust branch. The source did not
...
For a systems engineer, memmem belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2016-05-01T10:15:48.015488Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-def9582a01ff36` from `crates_io` as `registry_expansion`
