...
| Canonical URL | [https://crates.io/crates/libdbus-sys](https://crates.io/crates/libdbus-sys) |
| Source record ids | crates_io-6686e3bf07b6c4 |
...
For a systems engineer, libdbus-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2025-12-11T07:27:13.286122Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-6686e3bf07b6c4` from `crates_io` as `registry_expansion`
