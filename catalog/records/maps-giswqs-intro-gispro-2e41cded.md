...
<!-- canonical: https://github.com/giswqs/intro-gispro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giswqs/intro-gispro](https://github.com/giswqs/intro-gispro) |
| Source record ids | github_search_maps-45f2cd777ba93b |
...
For a systems engineer, giswqs/intro-gispro belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T19:53:05Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-45f2cd777ba93b` from `github_search_maps` as `registry_expansion`
