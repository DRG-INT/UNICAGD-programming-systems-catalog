...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitablePhysicalText](https://github.com/JuliaRegistries/General/tree/master/C/CitablePhysicalText) |
| Source record ids | julia_general-622249d1ea3b2b |

## System Engineer Summary

Julia package registered in General at C/CitablePhysicalText.

## Operational Role

For a systems engineer, CitablePhysicalText belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CitablePhysicalText", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-622249d1ea3b2b` from `julia_general` as `registry_expansion`
