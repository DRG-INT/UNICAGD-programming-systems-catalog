...
<!-- canonical: https://pgmagic.app/?ref=awesomepostgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pgmagic.app/?ref=awesomepostgres](https://pgmagic.app/?ref=awesomepostgres) |
| Source record ids | awesome_list-b1ae3f2b09ce2e |

## System Engineer Summary

Chat to Postgres in Natural Language (Commercial Software).

## Operational Role

For a systems engineer, pgMagic🪄 belongs in the Databases inventory as part of ecosystem capability
...
- `awesome_list-b1ae3f2b09ce2e` from `awesome_list` as `registry_expansion`
