...
<!-- canonical: https://github.com/matrix-org/pinecone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matrix-org/pinecone](https://github.com/matrix-org/pinecone) |
| Source record ids | github_search_maps-6625fe7933c062 |
...
For a systems engineer, matrix-org/pinecone belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-04T15:56:00Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-6625fe7933c062` from `github_search_maps` as `registry_expansion`
