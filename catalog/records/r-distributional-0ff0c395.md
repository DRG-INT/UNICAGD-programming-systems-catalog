...
<!-- canonical: https://cran.r-project.org/web/packages/distributional/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/distributional/index.html](https://cran.r-project.org/web/packages/distributional/index.html) |
| Source record ids | cran_packages_by_date-3bed4ccfb72c67 |
...
For a systems engineer, distributional belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-09-08 05:20:24 UTC | [https://cran.r-project.org/web/packages/distributional/DESCRIPTION](https://cran.r-project.org/web/packages/distributional/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/distributional/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-3bed4ccfb72c67` from `cran_packages_by_date` as `registry_expansion`
