...
<!-- canonical: https://cran.r-project.org/web/packages/SimDesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SimDesign/index.html](https://cran.r-project.org/web/packages/SimDesign/index.html) |
| Source record ids | cran_packages_by_date-d148d88951c90a |
...
For a systems engineer, SimDesign belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.27 | 2026-08-30 05:10:45 UTC | [https://cran.r-project.org/web/packages/SimDesign/DESCRIPTION](https://cran.r-project.org/web/packages/SimDesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SimDesign/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d148d88951c90a` from `cran_packages_by_date` as `registry_expansion`
