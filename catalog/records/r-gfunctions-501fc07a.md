...
<!-- canonical: https://cran.r-project.org/web/packages/gfunctions/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gfunctions/index.html](https://cran.r-project.org/web/packages/gfunctions/index.html) |
| Source record ids | cran_packages_by_date-328b8153886626 |

## System Engineer Summary

gfunctions is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, gfunctions belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-08-21 05:43:46 UTC | [https://cran.r-project.org/web/packages/gfunctions/DESCRIPTION](https://cran.r-project.org/web/packages/gfunctions/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gfunctions/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-328b8153886626` from `cran_packages_by_date` as `registry_expansion`
