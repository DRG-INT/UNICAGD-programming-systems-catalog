...
<!-- canonical: https://cran.r-project.org/web/packages/carbondata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/carbondata/index.html](https://cran.r-project.org/web/packages/carbondata/index.html) |
| Source record ids | cran_packages_by_date-9d4bda528e4743 |
...
For a systems engineer, carbondata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-09 10:40:26 UTC | [https://cran.r-project.org/web/packages/carbondata/DESCRIPTION](https://cran.r-project.org/web/packages/carbondata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/carbondata/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-9d4bda528e4743` from `cran_packages_by_date` as `registry_expansion`
