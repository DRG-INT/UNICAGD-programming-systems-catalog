...
<!-- canonical: https://github.com/lefcha/concurrentlua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lefcha/concurrentlua](https://github.com/lefcha/concurrentlua) |
| Source record ids | lua-source-185 |
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 185}}` |
...
- `lua-source-185` from `master_json` as `source_list_item`
