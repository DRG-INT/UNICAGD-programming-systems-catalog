...
<!-- canonical: https://cran.r-project.org/web/packages/BayesSplineUR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesSplineUR/index.html](https://cran.r-project.org/web/packages/BayesSplineUR/index.html) |
| Source record ids | cran_packages_by_date-18e5d12f3795d2 |
...
For a systems engineer, BayesSplineUR belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 13:30:02 UTC | [https://cran.r-project.org/web/packages/BayesSplineUR/DESCRIPTION](https://cran.r-project.org/web/packages/BayesSplineUR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesSplineUR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-18e5d12f3795d2` from `cran_packages_by_date` as `registry_expansion`
