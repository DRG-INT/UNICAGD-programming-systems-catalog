# diego-izurieta/address-manager
...
<!-- canonical: https://github.com/diego-izurieta/address-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diego-izurieta/address-manager](https://github.com/diego-izurieta/address-manager) |
| Source record ids | github_search_sapjava-142755e3d5f374 |

## System Engineer Summary

SAP Cloud SDK (Java) sample app — from my early SAP Cloud Platform experiments (2019)

## Operational Role

For a systems engineer, diego-izurieta/address-manager belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-31T21:21:50Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-142755e3d5f374` from `github_search_sapjava` as `registry_expansion`
