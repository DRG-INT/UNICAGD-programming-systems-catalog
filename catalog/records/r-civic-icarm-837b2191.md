...
<!-- canonical: https://cran.r-project.org/web/packages/civic.icarm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/civic.icarm/index.html](https://cran.r-project.org/web/packages/civic.icarm/index.html) |
| Source record ids | cran_packages_by_date-94f84fa772d274 |
...
For a systems engineer, civic.icarm belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-21 05:44:39 UTC | [https://cran.r-project.org/web/packages/civic.icarm/DESCRIPTION](https://cran.r-project.org/web/packages/civic.icarm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/civic.icarm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-94f84fa772d274` from `cran_packages_by_date` as `registry_expansion`
