...
<!-- canonical: https://pub.dev/packages/introduction_screen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/introduction_screen](https://pub.dev/packages/introduction_screen) |
| Source record ids | pub_dev-d9ae67a188745e |
...
For a systems engineer, introduction_screen belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2025-08-27T11:12:05.255637Z | [https://pub.dev/api/packages/introduction_screen](https://pub.dev/api/packages/introduction_screen) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/introduction_screen` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-d9ae67a188745e` from `pub_dev` as `registry_expansion`
