...
<!-- canonical: https://github.com/loliri/Starshot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/loliri/Starshot](https://github.com/loliri/Starshot) |
| Source record ids | github_search_photography-624ebc14daa6d6 |

## System Engineer Summary

Next-generation Windows-native HDR screenshot tool — full 16-bit HDR pipeline, region snipping /
clipboard history / OCR / AVIF·JXL·PNGv3 encoding / color management, natively built on WinUI 3. /
新一代 Windows HDR 截图工具，16bit 全链路捕获，区域截图 / 剪贴板历史 / 文字识别 / AVIF·JXL·PNGv3 编码 / 色彩管理，基于 WinUI 3 原生构建。

## Operational Role

For a systems engineer, loliri/Starshot belongs in the Photography inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T10:15:55Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-624ebc14daa6d6` from `github_search_photography` as `registry_expansion`
