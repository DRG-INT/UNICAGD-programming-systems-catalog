...
<!-- canonical: https://cran.r-project.org/web/packages/TopDom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TopDom/index.html](https://cran.r-project.org/web/packages/TopDom/index.html) |
| Source record ids | cran_packages_by_date-9667740d95ff20 |
...
For a systems engineer, TopDom belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2 | 2026-08-31 15:40:31 UTC | [https://cran.r-project.org/web/packages/TopDom/DESCRIPTION](https://cran.r-project.org/web/packages/TopDom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TopDom/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9667740d95ff20` from `cran_packages_by_date` as `registry_expansion`
