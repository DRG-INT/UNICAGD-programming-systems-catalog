...
<!-- canonical: https://github.com/elodin-sys/elodin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elodin-sys/elodin](https://github.com/elodin-sys/elodin) |
| Source record ids | github_search_physics_engines-9ca822a2af75eb |
...
For a systems engineer, elodin-sys/elodin belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:02:29Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-9ca822a2af75eb` from `github_search_physics_engines` as `registry_expansion`
