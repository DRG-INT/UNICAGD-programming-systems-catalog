...
<!-- canonical: https://hackage.haskell.org/package/hspec-junit-formatter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hspec-junit-formatter](https://hackage.haskell.org/package/hspec-junit-formatter) |
| Source record ids | hackage_top_downloads-23de510bd5dfd2 |
...
For a systems engineer, hspec-junit-formatter belongs in the Haskell inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1.1 | 2026-07-22T19:16:46Z | [https://hackage.haskell.org/package/hspec-junit-formatter](https://hackage.haskell.org/package/hspec-junit-formatter) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hspec-junit-formatter` at `2026-09-10T01:21:05+00:00`.
...
- `hackage_top_downloads-23de510bd5dfd2` from `hackage_top_downloads` as `registry_expansion`
