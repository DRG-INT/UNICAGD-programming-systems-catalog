# cloud-versity/rancher-k3s-first-steps
...
<!-- canonical: https://gitlab.com/cloud-versity/rancher-k3s-first-steps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/cloud-versity/rancher-k3s-first-steps](https://gitlab.com/cloud-versity/rancher-k3s-first-steps) |
| Source record ids | gitlab_projects_api-1c6414ef15dd8b |

## System Engineer Summary

Rancher's k3s in action. A lightweight kubernetes distribution.

## Operational Role

For a systems engineer, cloud-versity/rancher-k3s-first-steps belongs in the Repository Workplaces
...
- `gitlab_projects_api-1c6414ef15dd8b` from `gitlab_projects_api` as `registry_expansion`
