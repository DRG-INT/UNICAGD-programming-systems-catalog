...
<!-- canonical: https://github.com/clojurewasm/ClojureWasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/clojurewasm/ClojureWasm](https://github.com/clojurewasm/ClojureWasm) |
| Source record ids | github_search_webassembly-21f043505cf6df |

## System Engineer Summary

A JVM-free Clojure runtime in Zig — call WebAssembly from Clojure to use libraries written in any
language.

## Operational Role

For a systems engineer, clojurewasm/ClojureWasm belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T17:12:28Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-21f043505cf6df` from `github_search_webassembly` as `registry_expansion`
