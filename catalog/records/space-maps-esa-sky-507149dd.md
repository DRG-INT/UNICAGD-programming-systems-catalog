...
| Canonical URL | [https://sky.esa.int/](https://sky.esa.int/) |
| Source record ids | curated_language_routes-8feedfc80b63b5 |

## System Engineer Summary

ESA astronomy sky exploration portal for missions, surveys, catalogs, and visual data discovery.

## Operational Role

For a systems engineer, ESA Sky belongs in the Space Maps inventory as part of ecosystem capability
...
- `curated_language_routes-8feedfc80b63b5` from `curated_language_routes` as `registry_expansion`
