...
<!-- canonical: https://github.com/chenwj1989/pafx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chenwj1989/pafx](https://github.com/chenwj1989/pafx) |
| Source record ids | github_search_effects-22f474bd5d74f7 |

## System Engineer Summary

chenwj1989/pafx is tracked as an image audio dsp record in the Effects branch. The source did not
...
For a systems engineer, chenwj1989/pafx belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T09:49:35Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-22f474bd5d74f7` from `github_search_effects` as `registry_expansion`
