...
<!-- canonical: https://luarocks.org/modules/teto/avante.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/teto/avante.nvim](https://luarocks.org/modules/teto/avante.nvim) |
| Source record ids | luarocks_root_manifest-a09d4a1a305d9c |
...
For a systems engineer, avante.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a09d4a1a305d9c` from `luarocks_root_manifest` as `registry_expansion`
