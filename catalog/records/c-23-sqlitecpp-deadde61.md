...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-0a2a99cf3fbdcc |

## System Engineer Summary

SQLiteCpp is tracked as a database datastore record in the C++23 branch. The source did not provide
...
For a systems engineer, SQLiteCpp belongs in the C++23 inventory as part of state persistence,
...
- `corpus-0a2a99cf3fbdcc` from `master_json` as `database_datastore`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| LevelDB | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-leveldb-00651b69.md) |
| libpqxx | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-libpqxx-93956a69.md) |
| LMDB | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-lmdb-e2ed42f0.md) |
| ODB | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-odb-eba706d5.md) |
| RocksDB | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-rocksdb-42f30746.md) |
| SOCI | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-soci-8cb90865.md) |
