...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/keeferrourke/la-capitaine-icon-theme -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keeferrourke/la-capitaine-icon-theme](https://github.com/keeferrourke/la-capitaine-icon-theme) |
| Source record ids | github_search_icons_and_logos-62687bbefeceb6 |

## System Engineer Summary

La Capitaine is an icon pack designed to integrate with most desktop environments. The set of icons
takes inspiration from the latest iterations of macOS and Google's Material Design.

## Operational Role

For a systems engineer, keeferrourke/la-capitaine-icon-theme belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-25T05:43:53Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-62687bbefeceb6` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| markmead/hyperui | Testing Framework | [open](icons-and-logos-markmead-hyperui-8349bb5c.md) |
