# XanderXu/RealityShaderExtension
...
<!-- canonical: https://github.com/XanderXu/RealityShaderExtension -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/XanderXu/RealityShaderExtension](https://github.com/XanderXu/RealityShaderExtension) |
| Source record ids | github_search_effects-deffe52c0dca1b |

## System Engineer Summary

RealityShaderExtension reproduce 80+ Shader Graph nodes from Unity, and Unreal. It will be very
useful if you convert shader effects from Unity or Unreal to visionOS.

## Operational Role

For a systems engineer, XanderXu/RealityShaderExtension belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-15T09:43:04Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-deffe52c0dca1b` from `github_search_effects` as `registry_expansion`
