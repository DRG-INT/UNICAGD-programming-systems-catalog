...
<!-- canonical: https://pub.dev/packages/dotted_line -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dotted_line](https://pub.dev/packages/dotted_line) |
| Source record ids | pub_dev-7039a19fbcbd7e |
...
For a systems engineer, dotted_line belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2026-05-30T08:12:25.149789Z | [https://pub.dev/api/packages/dotted_line](https://pub.dev/api/packages/dotted_line) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dotted_line` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-7039a19fbcbd7e` from `pub_dev` as `registry_expansion`
