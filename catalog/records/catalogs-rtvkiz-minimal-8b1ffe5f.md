...
<!-- canonical: https://github.com/rtvkiz/minimal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rtvkiz/minimal](https://github.com/rtvkiz/minimal) |
| Source record ids | github_search_catalogs-14f40354c4632e |
...
For a systems engineer, rtvkiz/minimal belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:05:26Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-14f40354c4632e` from `github_search_catalogs` as `registry_expansion`
