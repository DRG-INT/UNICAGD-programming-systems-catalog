...
| Source record ids | lua-source-134 |

## System Engineer Summary

lua-source-134 is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, lua-source-134 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 134}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-134` from `master_json` as `source_list_item`
