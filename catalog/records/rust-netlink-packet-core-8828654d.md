...
| Canonical URL | [https://crates.io/crates/netlink-packet-core](https://crates.io/crates/netlink-packet-core) |
| Source record ids | crates_io-2249356f259ef4 |

## System Engineer Summary

netlink-packet-core is tracked as a library record in the Rust branch. The source did not provide a
...
For a systems engineer, netlink-packet-core belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-18T05:39:32.413266Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-2249356f259ef4` from `crates_io` as `registry_expansion`
