...
<!-- canonical: https://github.com/FiloSottile/mkcert -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) |
| Source record ids | github_search_go-7157f8b71b076b |

## System Engineer Summary

A simple zero-config tool to make locally trusted development certificates with any names you'd
like.

## Operational Role

For a systems engineer, FiloSottile/mkcert belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-13T13:37:46Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-7157f8b71b076b` from `github_search_go` as `registry_expansion`
