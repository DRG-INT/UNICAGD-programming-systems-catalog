...
<!-- canonical: https://github.com/YashBansod/Robotics-Planning-Dynamics-and-Control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/YashBansod/Robotics-Planning-Dynamics-and-Control](https://github.com/YashBansod/Robotics-Planning-Dynamics-and-Control) |
| Source record ids | github_search_matlab-ca95f5a6818b0d |

## System Engineer Summary

RPDC : This contains all my MATLAB codes for the Robotics, Planning, Dynamics and Control . The
implementations model various kinds of manipulators and mobile robots for position control,
trajectory planning and path planning problems.

## Operational Role

For a systems engineer, YashBansod/Robotics-Planning-Dynamics-and-Control belongs in the Matlab
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-18T01:15:18Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ca95f5a6818b0d` from `github_search_matlab` as `registry_expansion`
