...
<!-- canonical: https://github.com/Unsigned-Long/iKalibr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Unsigned-Long/iKalibr](https://github.com/Unsigned-Long/iKalibr) |
| Source record ids | github_search_radars-e4e8eae1531558 |
...
For a systems engineer, Unsigned-Long/iKalibr belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.2 | 2025-03-23T13:00:09Z | [https://api.github.com/repos/Unsigned-Long/iKalibr/releases/latest](https://api.github.com/repos/Unsigned-Long/iKalibr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Unsigned-Long/iKalibr/releases/latest` at `2026-09-01T08:26:32+00:00`.
...
- `github_search_radars-e4e8eae1531558` from `github_search_radars` as `registry_expansion`
