...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChangesOfVariables](https://github.com/JuliaRegistries/General/tree/master/C/ChangesOfVariables) |
| Source record ids | julia_general-e5002d288ce779 |

## System Engineer Summary

Julia package registered in General at C/ChangesOfVariables.

## Operational Role

For a systems engineer, ChangesOfVariables belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChangesOfVariables", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e5002d288ce779` from `julia_general` as `registry_expansion`
