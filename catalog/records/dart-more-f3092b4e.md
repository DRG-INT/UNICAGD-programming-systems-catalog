...
<!-- canonical: https://pub.dev/packages/more -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/more](https://pub.dev/packages/more) |
| Source record ids | pub_dev-9e8eb42303c307 |

## System Engineer Summary

More Dart — Literally. Collecting, iterating, caching, mathematics, matching, ordering, and
formatting easily.

## Operational Role

For a systems engineer, more belongs in the Dart inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.7.0 | 2025-12-12T20:22:36.280772Z | [https://pub.dev/api/packages/more](https://pub.dev/api/packages/more) |  |
| preview | known | 3.0.0-nullsafety.6 | 2020-12-25T10:47:11.655752Z | [https://pub.dev/api/packages/more](https://pub.dev/api/packages/more) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/more` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-9e8eb42303c307` from `pub_dev` as `registry_expansion`
