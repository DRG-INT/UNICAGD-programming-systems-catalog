...
| Source record ids | github_search_effects-45803f6200f135 |
...
For a systems engineer, AcademySoftwareFoundation/OpenPBR belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-22T11:26:32Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-45803f6200f135` from `github_search_effects` as `registry_expansion`
