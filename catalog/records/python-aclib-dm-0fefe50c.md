...
<!-- canonical: https://pypi.org/project/aclib.dm/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclib.dm/](https://pypi.org/project/aclib.dm/) |
| Source record ids | pypi_simple-391c7eabf0e15b |
...
For a systems engineer, aclib.dm belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2023-09-11T16:06:21.803797Z | [https://pypi.org/pypi/aclib.dm/json](https://pypi.org/pypi/aclib.dm/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclib.dm/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-391c7eabf0e15b` from `pypi_simple` as `registry_expansion`
