...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Coefplots](https://github.com/JuliaRegistries/General/tree/master/C/Coefplots) |
| Source record ids | julia_general-d67c4c70cbe3a7 |

## System Engineer Summary

Julia package registered in General at C/Coefplots.

## Operational Role

For a systems engineer, Coefplots belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Coefplots", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d67c4c70cbe3a7` from `julia_general` as `registry_expansion`
