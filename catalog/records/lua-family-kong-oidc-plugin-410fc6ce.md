...
| Canonical URL | [https://luarocks.org/modules/mrnim94/kong-oidc-plugin](https://luarocks.org/modules/mrnim94/kong-oidc-plugin) |
| Source record ids | luarocks_root_manifest-6106e584828a6d |

## System Engineer Summary

A Kong plugin for implementing OpenID Connect Relying Party (RP) functionality for Kong CE / 3.x /
4.x

## Operational Role

For a systems engineer, kong-oidc-plugin belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6106e584828a6d` from `luarocks_root_manifest` as `registry_expansion`
