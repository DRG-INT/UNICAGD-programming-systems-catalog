...
| Canonical URL | [https://crates.io/crates/dtor](https://crates.io/crates/dtor) |
| Source record ids | crates_io-fd42d4a228a626 |

## System Engineer Summary

Global, no_std-compatible destructors for all platforms that run after main (like C/C++
__attribute__((destructor)))

## Operational Role

For a systems engineer, dtor belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2026-08-09T22:01:12.258812Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-fd42d4a228a626` from `crates_io` as `registry_expansion`
