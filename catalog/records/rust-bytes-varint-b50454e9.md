...
| Canonical URL | [https://crates.io/crates/bytes-varint](https://crates.io/crates/bytes-varint) |
| Source record ids | crates_io-c73db7fe6cd0d5 |
...
For a systems engineer, bytes-varint belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2024-10-21T10:40:51.907271Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
...
- `crates_io-c73db7fe6cd0d5` from `crates_io` as `registry_expansion`
