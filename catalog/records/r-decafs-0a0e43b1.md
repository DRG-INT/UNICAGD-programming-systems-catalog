...
<!-- canonical: https://cran.r-project.org/web/packages/DeCAFS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DeCAFS/index.html](https://cran.r-project.org/web/packages/DeCAFS/index.html) |
| Source record ids | cran_packages_by_date-c83a7918c055d1 |
...
For a systems engineer, DeCAFS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.6 | 2026-09-16 01:20:02 UTC | [https://cran.r-project.org/web/packages/DeCAFS/DESCRIPTION](https://cran.r-project.org/web/packages/DeCAFS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DeCAFS/DESCRIPTION` at `2026-09-16T02:20:28+00:00`.
...
- `cran_packages_by_date-c83a7918c055d1` from `cran_packages_by_date` as `registry_expansion`
