...
| Source record ids | lua-source-301 |

## System Engineer Summary

lua-source-301 is tracked as a database datastore record in the Lua family branch. The source did
...
For a systems engineer, lua-source-301 belongs in the Lua family inventory as part of state
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 301}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-301` from `master_json` as `source_list_item`
