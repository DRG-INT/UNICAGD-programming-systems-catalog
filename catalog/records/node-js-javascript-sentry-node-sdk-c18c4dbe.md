...
| Source record ids | corpus-eccf0e2cc3dd94 |

## System Engineer Summary

Sentry Node SDK is tracked as a logging observability record in the Node.js/JavaScript branch. The
...
For a systems engineer, Sentry Node SDK belongs in the Node.js/JavaScript inventory as part of
...
- `corpus-eccf0e2cc3dd94` from `master_json` as `logging_observability`
