...
<!-- canonical: https://github.com/averagenative/0xFX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/averagenative/0xFX](https://github.com/averagenative/0xFX) |
| Source record ids | github_search_effects-3ef731fdfe7df6 |

## System Engineer Summary

Guitar amp simulator & effects pedalboard — open source, cross-platform (CLAP/VST3)

## Operational Role

For a systems engineer, averagenative/0xFX belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-20T13:59:04Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3ef731fdfe7df6` from `github_search_effects` as `registry_expansion`
