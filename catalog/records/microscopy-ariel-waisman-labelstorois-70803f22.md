...
| Canonical URL | [https://github.com/ariel-waisman/LabelsToROIs](https://github.com/ariel-waisman/LabelsToROIs) |
| Source record ids | github_search_microscopy-e372278a6e24b0 |
...
For a systems engineer, ariel-waisman/LabelsToROIs belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | V1.0 | 2020-12-27T00:52:19Z | [https://api.github.com/repos/ariel-waisman/LabelsToROIs/releases/latest](https://api.github.com/repos/ariel-waisman/LabelsToROIs/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ariel-waisman/LabelsToROIs/releases/latest` at `2026-09-01T08:26:16+00:00`.
...
- `github_search_microscopy-e372278a6e24b0` from `github_search_microscopy` as `registry_expansion`
