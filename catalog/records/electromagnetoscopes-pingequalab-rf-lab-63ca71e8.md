...
<!-- canonical: https://github.com/pingequalab/rf-lab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pingequalab/rf-lab](https://github.com/pingequalab/rf-lab) |
| Source record ids | github_search_electromagnetoscopes-04a03b244953b8 |

## System Engineer Summary

Open-source 2.4 GHz spectrum analyzer + NRF24 Jammer for Flipper Zero. Plug-and-play across every
firmware. Built for the PINGEQUA 2-in-1 RF Devboard.

## Operational Role

For a systems engineer, pingequalab/rf-lab belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-25T09:15:55Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-04a03b244953b8` from `github_search_electromagnetoscopes` as `registry_expansion`
