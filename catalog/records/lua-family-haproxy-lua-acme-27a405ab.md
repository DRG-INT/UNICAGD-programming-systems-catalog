...
| Canonical URL | [https://luarocks.org/modules/elfranne/haproxy-lua-acme](https://luarocks.org/modules/elfranne/haproxy-lua-acme) |
| Source record ids | luarocks_root_manifest-05ff451616bb29 |

## System Engineer Summary

haproxy-lua-acme is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, haproxy-lua-acme belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-05ff451616bb29` from `luarocks_root_manifest` as `registry_expansion`
