...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ScanMountGoat/image_dds -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ScanMountGoat/image_dds](https://github.com/ScanMountGoat/image_dds) |
| Source record ids | github_search_assets-12489681175f00 |

## System Engineer Summary

Convert images to and from DDS formats

## Operational Role

For a systems engineer, ScanMountGoat/image_dds belongs in the Assets inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-28T21:42:29Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-12489681175f00` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ArturSepp/QuantInvestStrats | Static Analyzer | [open](assets-artursepp-quantinveststrats-a7a51697.md) |
| letianzj/QuantResearch | Static Analyzer | [open](assets-letianzj-quantresearch-61864c0e.md) |
| Samukashvili/LUMEN-PS | Static Analyzer | [open](assets-samukashvili-lumen-ps-760ce575.md) |
| ScanMountGoat/Smush-Material-Research | Static Analyzer | [open](assets-scanmountgoat-smush-material-research-1ee7ce91.md) |
