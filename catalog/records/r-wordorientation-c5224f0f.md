...
<!-- canonical: https://cran.r-project.org/web/packages/wordorientation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wordorientation/index.html](https://cran.r-project.org/web/packages/wordorientation/index.html) |
| Source record ids | cran_packages_by_date-5c085ffa80e08d |
...
For a systems engineer, wordorientation belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 14:40:02 UTC | [https://cran.r-project.org/web/packages/wordorientation/DESCRIPTION](https://cran.r-project.org/web/packages/wordorientation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wordorientation/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5c085ffa80e08d` from `cran_packages_by_date` as `registry_expansion`
