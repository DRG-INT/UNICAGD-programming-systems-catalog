...
<!-- canonical: https://cran.r-project.org/web/packages/surveytable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/surveytable/index.html](https://cran.r-project.org/web/packages/surveytable/index.html) |
| Source record ids | cran_packages_by_date-6ff85b32585e94 |
...
For a systems engineer, surveytable belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-08-19 20:10:03 UTC | [https://cran.r-project.org/web/packages/surveytable/DESCRIPTION](https://cran.r-project.org/web/packages/surveytable/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/surveytable/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6ff85b32585e94` from `cran_packages_by_date` as `registry_expansion`
