...
<!-- canonical: https://cran.r-project.org/web/packages/validann/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/validann/index.html](https://cran.r-project.org/web/packages/validann/index.html) |
| Source record ids | cran_packages_by_date-e24cd5f4e9529a |
...
For a systems engineer, validann belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3 | 2026-08-19 22:30:02 UTC | [https://cran.r-project.org/web/packages/validann/DESCRIPTION](https://cran.r-project.org/web/packages/validann/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/validann/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e24cd5f4e9529a` from `cran_packages_by_date` as `registry_expansion`
