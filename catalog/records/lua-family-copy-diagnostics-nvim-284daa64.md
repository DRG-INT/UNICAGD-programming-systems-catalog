...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Compiler Diagnostics](../by-category/compiler-diagnostics.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/nickstafford2/copy-diagnostics.nvim -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-ff3ae4067ba90d` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| copy-diagnostics | Compiler Diagnostics | [open](lua-family-copy-diagnostics-d2022385.md) |
| ewd | Compiler Diagnostics | [open](lua-family-ewd-dfc8cd6b.md) |
