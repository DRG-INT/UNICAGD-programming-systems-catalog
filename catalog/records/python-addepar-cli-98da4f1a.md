...
<!-- canonical: https://pypi.org/project/addepar-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/addepar-cli/](https://pypi.org/project/addepar-cli/) |
| Source record ids | pypi_simple-1df9046e9ec868 |

## System Engineer Summary

addepar-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, addepar-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0 | 2026-08-18T15:04:52.819270Z | [https://pypi.org/pypi/addepar-cli/json](https://pypi.org/pypi/addepar-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/addepar-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-1df9046e9ec868` from `pypi_simple` as `registry_expansion`
