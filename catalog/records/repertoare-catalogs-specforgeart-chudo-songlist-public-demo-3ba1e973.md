# specforgeart/chudo-songlist-public-demo
...
<!-- canonical: https://github.com/specforgeart/chudo-songlist-public-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/specforgeart/chudo-songlist-public-demo](https://github.com/specforgeart/chudo-songlist-public-demo) |
| Source record ids | github_search_repertoare_catalogs-bb4012fba0e516 |

## System Engineer Summary

Public portfolio demo: offline-first song catalog and setlist management application.

## Operational Role

For a systems engineer, specforgeart/chudo-songlist-public-demo belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T19:52:07Z | gh search repos setlist catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-bb4012fba0e516` from `github_search_repertoare_catalogs` as `registry_expansion`
