...
<!-- canonical: https://pub.dev/packages/custom_lint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/custom_lint](https://pub.dev/packages/custom_lint) |
| Source record ids | pub_dev-1c614a13b87ff1 |

## System Engineer Summary

Lint rules are a powerful way to improve the maintainability of a project. Custom Lint allows
package authors and developers to easily write custom lint rules.

## Operational Role

For a systems engineer, custom_lint belongs in the Dart inventory as part of static feedback, style
policy, defect prevention, and local/CI quality gates.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2025-09-09T14:08:31.029924Z | [https://pub.dev/api/packages/custom_lint](https://pub.dev/api/packages/custom_lint) |  |
| preview | known | 0.1.2-dev | 2023-01-10T09:53:09.414769Z | [https://pub.dev/api/packages/custom_lint](https://pub.dev/api/packages/custom_lint) |  |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; Other; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/custom_lint` at `2026-09-02T00:28:57+00:00`.
...
- `pub_dev-1c614a13b87ff1` from `pub_dev` as `registry_expansion`
...
| very_good_analysis | Linter | [open](dart-very-good-analysis-8f0f073a.md) |
