...
<!-- canonical: https://crates.io/crates/serde-untagged -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde-untagged](https://crates.io/crates/serde-untagged) |
| Source record ids | crates_io-6c138c8ff4408f |
...
For a systems engineer, serde-untagged belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2025-09-14T16:02:35.620500Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-14T00:28:00+00:00`.
...
- `crates_io-6c138c8ff4408f` from `crates_io` as `registry_expansion`
