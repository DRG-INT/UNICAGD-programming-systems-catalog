...
<!-- canonical: https://pub.dev/packages/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/http](https://pub.dev/packages/http) |
| Source record ids | pub_dev-fc8de7fdc52e6e |
...
For a systems engineer, http belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2025-11-10T18:27:56.434747Z | [https://pub.dev/api/packages/http](https://pub.dev/api/packages/http) |  |
| preview | known | 1.5.0-beta.2 | 2025-07-15T23:37:56.942822Z | [https://pub.dev/api/packages/http](https://pub.dev/api/packages/http) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/http` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-fc8de7fdc52e6e` from `pub_dev` as `registry_expansion`
