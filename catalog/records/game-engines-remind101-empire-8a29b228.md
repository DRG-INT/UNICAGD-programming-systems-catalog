...
<!-- canonical: https://github.com/remind101/empire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/remind101/empire](https://github.com/remind101/empire) |
| Source record ids | github_search_game_engines-4cde9f4e6af3ff |
...
For a systems engineer, remind101/empire belongs in the Game Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-25T17:16:08Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-4cde9f4e6af3ff` from `github_search_game_engines` as `registry_expansion`
