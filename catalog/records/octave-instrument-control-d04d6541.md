...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/instrument-control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/instrument-control](https://gnu-octave.github.io/packages/instrument-control) |
| Source record ids | octave_packages_index-dac4e4f7e4b486 |

## System Engineer Summary

Low level I/O functions for serial, i2c, parallel, tcp, gpib, vxi11, udp, visa and usbtmc
interfaces.

## Operational Role

For a systems engineer, instrument-control belongs in the Octave inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2026-05-24 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-dac4e4f7e4b486` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ocl | Concurrency Parallelism | [open](octave-ocl-5d26948b.md) |
| parallel | Concurrency Parallelism | [open](octave-parallel-d76c440c.md) |
