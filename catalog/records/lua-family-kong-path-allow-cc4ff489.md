...
| Canonical URL | [https://luarocks.org/modules/seifchen/kong-path-allow](https://luarocks.org/modules/seifchen/kong-path-allow) |
| Source record ids | luarocks_root_manifest-eede6adde54d09 |

## System Engineer Summary

This plugin enables allow path for route, support regex

## Operational Role

For a systems engineer, kong-path-allow belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-eede6adde54d09` from `luarocks_root_manifest` as `registry_expansion`
