...
<!-- canonical: https://github.com/RedisGraph/RedisGraph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RedisGraph/RedisGraph](https://github.com/RedisGraph/RedisGraph) |
| Source record ids | github_search_databases-f7f2c1a88c277c |
...
For a systems engineer, RedisGraph/RedisGraph belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-21T11:58:04Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f7f2c1a88c277c` from `github_search_databases` as `registry_expansion`
