...
<!-- canonical: https://gitea.com/EnderIce2/Fennix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/EnderIce2/Fennix](https://gitea.com/EnderIce2/Fennix) |
| Source record ids | gitea_repositories_api-689893e01f544b |
...
For a systems engineer, Gitea: EnderIce2/Fennix belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-14T01:21:22Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-689893e01f544b` from `gitea_repositories_api` as `registry_expansion`
