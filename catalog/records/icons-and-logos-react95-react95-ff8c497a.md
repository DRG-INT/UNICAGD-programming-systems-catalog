...
<!-- canonical: https://github.com/React95/React95 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/React95/React95](https://github.com/React95/React95) |
| Source record ids | github_search_icons_and_logos-d9ca1f74c4b6db |
...
For a systems engineer, React95/React95 belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:02:28Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-d9ca1f74c4b6db` from `github_search_icons_and_logos` as `registry_expansion`
