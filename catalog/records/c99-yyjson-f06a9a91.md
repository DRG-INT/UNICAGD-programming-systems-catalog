...
| Source record ids | corpus-89fd9875d39277 |

## System Engineer Summary

yyjson is tracked as a serialization record in the C99 branch. The source did not provide a long
...
For a systems engineer, yyjson belongs in the C99 inventory as part of wire formats, persistence,
...
- `corpus-89fd9875d39277` from `master_json` as `serialization`
