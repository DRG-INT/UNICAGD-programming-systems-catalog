...
<!-- canonical: https://hackage.haskell.org/package/language-ats -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/language-ats](https://hackage.haskell.org/package/language-ats) |
| Source record ids | hackage_top_downloads-c68d119370a175 |
...
For a systems engineer, language-ats belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.10.3 | 2021-01-18T22:55:30Z | [https://hackage.haskell.org/package/language-ats](https://hackage.haskell.org/package/language-ats) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/language-ats` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-c68d119370a175` from `hackage_top_downloads` as `registry_expansion`
