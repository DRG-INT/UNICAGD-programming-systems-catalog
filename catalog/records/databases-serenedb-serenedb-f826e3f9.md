...
<!-- canonical: https://github.com/serenedb/serenedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/serenedb/serenedb](https://github.com/serenedb/serenedb) |
| Source record ids | github_search_databases-3b2325ba63fceb |
...
For a systems engineer, serenedb/serenedb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T06:15:16Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3b2325ba63fceb` from `github_search_databases` as `registry_expansion`
