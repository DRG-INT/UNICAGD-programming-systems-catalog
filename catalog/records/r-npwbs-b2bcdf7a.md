...
<!-- canonical: https://cran.r-project.org/web/packages/npwbs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/npwbs/index.html](https://cran.r-project.org/web/packages/npwbs/index.html) |
| Source record ids | cran_packages_by_date-c53e89ca89d662 |
...
For a systems engineer, npwbs belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-04 08:50:07 UTC | [https://cran.r-project.org/web/packages/npwbs/DESCRIPTION](https://cran.r-project.org/web/packages/npwbs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/npwbs/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c53e89ca89d662` from `cran_packages_by_date` as `registry_expansion`
