...
<!-- canonical: https://hackage.haskell.org/package/cairo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cairo](https://hackage.haskell.org/package/cairo) |
| Source record ids | hackage_top_downloads-2ec4155e1f6064 |
...
For a systems engineer, cairo belongs in the Haskell inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.12.0 | 2025-03-20T08:43:33Z | [https://hackage.haskell.org/package/cairo](https://hackage.haskell.org/package/cairo) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cairo` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-2ec4155e1f6064` from `hackage_top_downloads` as `registry_expansion`
