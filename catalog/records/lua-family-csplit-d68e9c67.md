...
<!-- canonical: https://luarocks.org/modules/isavegas/csplit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/isavegas/csplit](https://luarocks.org/modules/isavegas/csplit) |
| Source record ids | luarocks_root_manifest-d9f0bc618b2ba4 |

## System Engineer Summary

C implementation of a split function.

## Operational Role

For a systems engineer, csplit belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| luarocks_root_manifest | registry-derived | 2026-09-01 | `{"kind": "luarocks_root_manifest", "page": 13, "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `luarocks_root_manifest-d9f0bc618b2ba4` from `luarocks_root_manifest` as `registry_expansion`
