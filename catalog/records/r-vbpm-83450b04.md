...
<!-- canonical: https://cran.r-project.org/web/packages/vbpm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vbpm/index.html](https://cran.r-project.org/web/packages/vbpm/index.html) |
| Source record ids | cran_packages_by_date-cac3d7a8fbb601 |
...
For a systems engineer, vbpm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2026-09-05 14:00:02 UTC | [https://cran.r-project.org/web/packages/vbpm/DESCRIPTION](https://cran.r-project.org/web/packages/vbpm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vbpm/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-cac3d7a8fbb601` from `cran_packages_by_date` as `registry_expansion`
