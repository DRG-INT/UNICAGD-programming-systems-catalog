...
<!-- canonical: https://pub.dev/packages/flutter_form_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_form_builder](https://pub.dev/packages/flutter_form_builder) |
| Source record ids | pub_dev-eabb90f22ffeac |

## System Engineer Summary

This package helps in creation of forms in Flutter by removing the boilerplate code, reusing
validation, react to changes, and collect final user input.

## Operational Role

For a systems engineer, flutter_form_builder belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-08-15T15:15:47.329577Z | [https://pub.dev/api/packages/flutter_form_builder](https://pub.dev/api/packages/flutter_form_builder) |  |
| preview | known | 10.1.0-beta | 2025-05-13T08:32:36.282835Z | [https://pub.dev/api/packages/flutter_form_builder](https://pub.dev/api/packages/flutter_form_builder) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_form_builder` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-eabb90f22ffeac` from `pub_dev` as `registry_expansion`
