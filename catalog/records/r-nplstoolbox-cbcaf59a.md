...
<!-- canonical: https://cran.r-project.org/web/packages/NPLStoolbox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NPLStoolbox/index.html](https://cran.r-project.org/web/packages/NPLStoolbox/index.html) |
| Source record ids | cran_packages_by_date-0bd0cffdf8fcd1 |
...
For a systems engineer, NPLStoolbox belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-21 06:30:09 UTC | [https://cran.r-project.org/web/packages/NPLStoolbox/DESCRIPTION](https://cran.r-project.org/web/packages/NPLStoolbox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NPLStoolbox/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0bd0cffdf8fcd1` from `cran_packages_by_date` as `registry_expansion`
