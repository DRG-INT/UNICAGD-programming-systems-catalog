...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Message Broker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/message-broker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/unera/dr.tap](https://luarocks.org/modules/unera/dr.tap) |
| Source record ids | luarocks_root_manifest-09dd74a507d0c9 |

## System Engineer Summary

dr.tap is tracked as a message broker record in the Lua family branch. The source did not provide a
...
For a systems engineer, dr.tap belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| circle | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-circle-fb564990.md) |
| diskqueue | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-diskqueue-a67e6ec5.md) |
| homie | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-homie-a368172e.md) |
| Message Brokers | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-message-brokers-ef5c8b44.md) |
