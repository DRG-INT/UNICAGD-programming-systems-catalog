...
<!-- canonical: https://crates.io/crates/pico-args -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pico-args](https://crates.io/crates/pico-args) |
| Source record ids | crates_io-7a6000f0bd1283 |
...
For a systems engineer, pico-args belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2022-06-04T12:11:35.198777Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-7a6000f0bd1283` from `crates_io` as `registry_expansion`
