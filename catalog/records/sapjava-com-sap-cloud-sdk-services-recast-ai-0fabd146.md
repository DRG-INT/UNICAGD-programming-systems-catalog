...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/recast-ai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/recast-ai](https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/recast-ai) |
| Source record ids | maven_central_search-e47bf5d5b1bc53 |
...
For a systems engineer, com.sap.cloud.sdk.services:recast-ai belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.78.0 | 2022-12-19T12:44:13+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json) |  |
...
- `maven_central_search-e47bf5d5b1bc53` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| SAP/sailing-analytics | Parser Lexer Ast | [open](sapjava-sap-sailing-analytics-18e68ac1.md) |
