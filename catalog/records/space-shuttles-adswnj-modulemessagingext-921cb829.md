...
<!-- canonical: https://github.com/ADSWNJ/ModuleMessagingExt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ADSWNJ/ModuleMessagingExt](https://github.com/ADSWNJ/ModuleMessagingExt) |
| Source record ids | github_search_space_shuttles-c51890725050f1 |

## System Engineer Summary

ModuleMessagingExt: Orbiter Space Flight Simulator Open Source data communications channel for
inter-MFD communication

## Operational Role

For a systems engineer, ADSWNJ/ModuleMessagingExt belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-04-02T20:03:16Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-c51890725050f1` from `github_search_space_shuttles` as `registry_expansion`
