...
<!-- canonical: https://github.com/Barre/ZeroFS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Barre/ZeroFS](https://github.com/Barre/ZeroFS) |
| Source record ids | github_search_databases-673df22a2b33db |

## System Engineer Summary

ZeroFS: A log-structured filesystem for S3. ZeroFS serves S3-compatible buckets as POSIX filesystems
over NFS and 9P, or as raw block devices over NBD.

## Operational Role

For a systems engineer, Barre/ZeroFS belongs in the Databases inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:37:05Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-673df22a2b33db` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Teradata/kylo | Logging Observability | [open](databases-teradata-kylo-b03a4cc2.md) |
