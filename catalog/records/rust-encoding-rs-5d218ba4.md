...
<!-- canonical: https://crates.io/crates/encoding_rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/encoding_rs](https://crates.io/crates/encoding_rs) |
| Source record ids | crates_io-650bfe9c40f4ad |
...
For a systems engineer, encoding_rs belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.40 | 2026-09-07T09:50:30.533651Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-07T10:20:37+00:00`.
...
- `crates_io-650bfe9c40f4ad` from `crates_io` as `registry_expansion`
