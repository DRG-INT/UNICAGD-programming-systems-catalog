...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.12.7 | 2026-08-05T08:23:36.804191Z | [https://pub.dev/api/packages/built_value_generator](https://pub.dev/api/packages/built_value_generator) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/built_value_generator` at `2026-09-01T07:20:12+00:00`.
