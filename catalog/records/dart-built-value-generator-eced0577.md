...
<!-- canonical: https://pub.dev/packages/built_value_generator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/built_value_generator](https://pub.dev/packages/built_value_generator) |
| Source record ids | pub_dev-58c0a06578f6f0 |

## System Engineer Summary

Value types with builders, Dart classes as enums, and serialization. This library is the dev
dependency.

## Operational Role

For a systems engineer, built_value_generator belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.13.0 | 2026-09-02T07:27:27.864981Z | [https://pub.dev/api/packages/built_value_generator](https://pub.dev/api/packages/built_value_generator) |  |
| preview | known | 8.11.0-dev | 2025-07-08T07:56:15.184563Z | [https://pub.dev/api/packages/built_value_generator](https://pub.dev/api/packages/built_value_generator) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/built_value_generator` at `2026-09-02T08:21:56+00:00`.
...
- `pub_dev-58c0a06578f6f0` from `pub_dev` as `registry_expansion`
