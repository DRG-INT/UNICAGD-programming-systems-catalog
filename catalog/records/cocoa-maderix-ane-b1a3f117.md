...
<!-- canonical: https://github.com/maderix/ANE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maderix/ANE](https://github.com/maderix/ANE) |
| Source record ids | github_search_cocoa-e3427898f435e3 |
...
For a systems engineer, maderix/ANE belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-10T10:21:05Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_cocoa-e3427898f435e3` from `github_search_cocoa` as `registry_expansion`
