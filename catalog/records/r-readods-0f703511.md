...
<!-- canonical: https://cran.r-project.org/web/packages/readODS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/readODS/index.html](https://cran.r-project.org/web/packages/readODS/index.html) |
| Source record ids | cran_packages_by_date-18691f9495ebb7 |
...
For a systems engineer, readODS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.6 | 2026-09-02 05:20:13 UTC | [https://cran.r-project.org/web/packages/readODS/DESCRIPTION](https://cran.r-project.org/web/packages/readODS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/readODS/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-18691f9495ebb7` from `cran_packages_by_date` as `registry_expansion`
