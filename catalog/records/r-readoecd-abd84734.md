...
<!-- canonical: https://cran.r-project.org/web/packages/readoecd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/readoecd/index.html](https://cran.r-project.org/web/packages/readoecd/index.html) |
| Source record ids | cran_packages_by_date-80fb77eabf7f92 |
...
For a systems engineer, readoecd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4 | 2026-09-09 10:40:02 UTC | [https://cran.r-project.org/web/packages/readoecd/DESCRIPTION](https://cran.r-project.org/web/packages/readoecd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/readoecd/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-80fb77eabf7f92` from `cran_packages_by_date` as `registry_expansion`
