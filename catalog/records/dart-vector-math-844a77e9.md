...
<!-- canonical: https://pub.dev/packages/vector_math -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/vector_math](https://pub.dev/packages/vector_math) |
| Source record ids | pub_dev-96262c79378bf0 |
...
For a systems engineer, vector_math belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.2 | 2026-07-29T23:23:00.464489Z | [https://pub.dev/api/packages/vector_math](https://pub.dev/api/packages/vector_math) |  |
| preview | known | 2.1.0-nullsafety.5 | 2020-11-03T22:11:26.048199Z | [https://pub.dev/api/packages/vector_math](https://pub.dev/api/packages/vector_math) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/vector_math` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-96262c79378bf0` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| random_string | Math Numeric Scientific | [open](dart-random-string-25ebde51.md) |
