...
<!-- canonical: https://github.com/zoebear/Radia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zoebear/Radia](https://github.com/zoebear/Radia) |
| Source record ids | github_search_space_maps-e54a8dc245037c |

## System Engineer Summary

Radia is a tool designed to create an interactive and immerse environment to visualize code, and to
augment the task of reverse engineering binaries. The tool takes decompiled binaries extracted
through IDA Pro, and visualizes the call graph in 3D space as a force directed graph. Radia tags
functions that could be potential problems, as well as giving the user specific insight into
individual nodes and their contents and relationships to other functions. In the end, the hope is to
improve the available tools for auditing code to readily identify and remediate problems, and
ultimately, to make code less vulnerable to exploitation by malware.

## Operational Role

For a systems engineer, zoebear/Radia belongs in the Space Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-08-23T02:16:37Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e54a8dc245037c` from `github_search_space_maps` as `registry_expansion`
