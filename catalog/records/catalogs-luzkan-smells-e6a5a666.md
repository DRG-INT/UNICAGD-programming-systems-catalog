...
<!-- canonical: https://github.com/Luzkan/smells -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Luzkan/smells](https://github.com/Luzkan/smells) |
| Source record ids | github_search_catalogs-4d7cda127b1a4e |
...
For a systems engineer, Luzkan/smells belongs in the Catalogs inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-01T03:33:51Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-4d7cda127b1a4e` from `github_search_catalogs` as `registry_expansion`
