...
<!-- canonical: https://hackage.haskell.org/package/unbound-generics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/unbound-generics](https://hackage.haskell.org/package/unbound-generics) |
| Source record ids | hackage_top_downloads-4ff60295f80d4d |
...
For a systems engineer, unbound-generics belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.5 | 2026-07-08T00:54:56Z | [https://hackage.haskell.org/package/unbound-generics](https://hackage.haskell.org/package/unbound-generics) |  |
| candidate | partial | 0.3.3 |  | [https://hackage.haskell.org/package/unbound-generics](https://hackage.haskell.org/package/unbound-generics) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/unbound-generics` at `2026-09-03T00:34:46+00:00`.
...
- `hackage_top_downloads-4ff60295f80d4d` from `hackage_top_downloads` as `registry_expansion`
