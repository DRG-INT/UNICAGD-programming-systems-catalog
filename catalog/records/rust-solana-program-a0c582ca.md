...
| Canonical URL | [https://crates.io/crates/solana-program](https://crates.io/crates/solana-program) |
| Source record ids | crates_io-90142aaba39a1a |

## System Engineer Summary

solana-program is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, solana-program belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-07-28T22:20:54.755560Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
...
- `crates_io-90142aaba39a1a` from `crates_io` as `registry_expansion`
