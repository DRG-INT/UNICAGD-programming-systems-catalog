...
<!-- canonical: https://crates.io/crates/crypto-mac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crypto-mac](https://crates.io/crates/crypto-mac) |
| Source record ids | crates_io-e0a21e7e053374 |
...
For a systems engineer, crypto-mac belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1 | 2021-07-20T13:10:34.870407Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-e0a21e7e053374` from `crates_io` as `registry_expansion`
