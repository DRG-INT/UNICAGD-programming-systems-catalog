...
<!-- canonical: https://github.com/framework7io/framework7-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/framework7io/framework7-icons](https://github.com/framework7io/framework7-icons) |
| Source record ids | github_search_icons_and_logos-5848e2f8ad8b6e |
...
For a systems engineer, framework7io/framework7-icons belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-03T23:39:58Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-5848e2f8ad8b6e` from `github_search_icons_and_logos` as `registry_expansion`
