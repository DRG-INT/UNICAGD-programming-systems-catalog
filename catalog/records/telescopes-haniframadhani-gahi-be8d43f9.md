...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/haniframadhani/gahi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/haniframadhani/gahi](https://github.com/haniframadhani/gahi) |
| Source record ids | github_search_telescopes-7e5eaa98bfcd28 |

## System Engineer Summary

Jelajahi alam semesta dengan gambar dan video astronomi yang luar biasa berbeda setiap harinya
dengan penjelasan dari para pakar astronomi.

## Operational Role

For a systems engineer, haniframadhani/gahi belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-29T09:50:19Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-7e5eaa98bfcd28` from `github_search_telescopes` as `registry_expansion`
