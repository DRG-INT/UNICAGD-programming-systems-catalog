...
<!-- canonical: https://luarocks.org/modules/moteus/bgcrypto-pbkdf2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moteus/bgcrypto-pbkdf2](https://luarocks.org/modules/moteus/bgcrypto-pbkdf2) |
| Source record ids | luarocks_root_manifest-949b9ecb608913 |
...
For a systems engineer, bgcrypto-pbkdf2 belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-949b9ecb608913` from `luarocks_root_manifest` as `registry_expansion`
