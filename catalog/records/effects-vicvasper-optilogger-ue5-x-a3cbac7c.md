# vicvasper/Optilogger_UE5.x

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vicvasper/Optilogger_UE5.x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vicvasper/Optilogger_UE5.x](https://github.com/vicvasper/Optilogger_UE5.x) |
| Source record ids | github_search_effects-5c40b5cea211e0 |

## System Engineer Summary

Editor plugin that audits a whole Unreal level in one pass: meshes, textures, materials, animations,
audio, lighting and post-process. Memory estimation, shader instruction counts and JSON export.

## Operational Role

For a systems engineer, vicvasper/Optilogger_UE5.x belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T18:59:48Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5c40b5cea211e0` from `github_search_effects` as `registry_expansion`
