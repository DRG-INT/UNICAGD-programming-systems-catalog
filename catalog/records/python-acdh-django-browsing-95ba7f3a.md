...
<!-- canonical: https://pypi.org/project/acdh-django-browsing/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-browsing/](https://pypi.org/project/acdh-django-browsing/) |
| Source record ids | pypi_simple-2bca0b8f0ccaee |
...
For a systems engineer, acdh-django-browsing belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.1 | 2026-04-20T10:07:08.420444Z | [https://pypi.org/pypi/acdh-django-browsing/json](https://pypi.org/pypi/acdh-django-browsing/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-browsing/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-2bca0b8f0ccaee` from `pypi_simple` as `registry_expansion`
