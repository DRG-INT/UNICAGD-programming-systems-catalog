...
<!-- canonical: https://github.com/itflow-org/itflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/itflow-org/itflow](https://github.com/itflow-org/itflow) |
| Source record ids | github_search_assets-2986da8897f0eb |

## System Engineer Summary

All in One PSA for MSPs, which Unifies client, contact, vendor, asset, license, domain, ssl
certificate, password, documentation, file, network and location management with ticketing and
billing capabilities, with a client portal on the side.

## Operational Role

For a systems engineer, itflow-org/itflow belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:47:17Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-2986da8897f0eb` from `github_search_assets` as `registry_expansion`
