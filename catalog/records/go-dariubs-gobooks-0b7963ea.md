...
<!-- canonical: https://github.com/dariubs/GoBooks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dariubs/GoBooks](https://github.com/dariubs/GoBooks) |
| Source record ids | github_search_go-17baead8657702 |

## System Engineer Summary

dariubs/GoBooks is tracked as an undefined behavior analyzer record in the Go branch. The source did
...
For a systems engineer, dariubs/GoBooks belongs in the Go inventory as part of ecosystem capability
...
- `github_search_go-17baead8657702` from `github_search_go` as `registry_expansion`
