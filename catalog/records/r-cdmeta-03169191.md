...
<!-- canonical: https://cran.r-project.org/web/packages/cdmeta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cdmeta/index.html](https://cran.r-project.org/web/packages/cdmeta/index.html) |
| Source record ids | cran_packages_by_date-818d11376116dd |
...
For a systems engineer, cdmeta belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-1 | 2026-09-15 11:50:13 UTC | [https://cran.r-project.org/web/packages/cdmeta/DESCRIPTION](https://cran.r-project.org/web/packages/cdmeta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cdmeta/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-818d11376116dd` from `cran_packages_by_date` as `registry_expansion`
