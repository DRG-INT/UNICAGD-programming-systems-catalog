...
<!-- canonical: https://cran.r-project.org/web/packages/marcxmlr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/marcxmlr/index.html](https://cran.r-project.org/web/packages/marcxmlr/index.html) |
| Source record ids | cran_packages_by_date-5e7e06033ed49e |

## System Engineer Summary

Faithful and Scalable MARCXML Parsing

## Operational Role

For a systems engineer, marcxmlr belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:30:02 UTC | [https://cran.r-project.org/web/packages/marcxmlr/DESCRIPTION](https://cran.r-project.org/web/packages/marcxmlr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/marcxmlr/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-5e7e06033ed49e` from `cran_packages_by_date` as `registry_expansion`
