...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundedDegreeGraphs](https://github.com/JuliaRegistries/General/tree/master/B/BoundedDegreeGraphs) |
| Source record ids | julia_general-74f8505c7a412d |

## System Engineer Summary

Julia package registered in General at B/BoundedDegreeGraphs.

## Operational Role

For a systems engineer, BoundedDegreeGraphs belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundedDegreeGraphs", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-74f8505c7a412d` from `julia_general` as `registry_expansion`
