...
<!-- canonical: https://github.com/letoram/arcan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/letoram/arcan](https://github.com/letoram/arcan) |
| Source record ids | github_search_video-f4fd7f695bd0a9 |
...
For a systems engineer, letoram/arcan belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T00:15:26Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-f4fd7f695bd0a9` from `github_search_video` as `registry_expansion`
