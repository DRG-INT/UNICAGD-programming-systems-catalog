...
<!-- canonical: https://cran.r-project.org/web/packages/mcptools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mcptools/index.html](https://cran.r-project.org/web/packages/mcptools/index.html) |
| Source record ids | cran_packages_by_date-49ee5f0762a881 |
...
For a systems engineer, mcptools belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-22 16:50:09 UTC | [https://cran.r-project.org/web/packages/mcptools/DESCRIPTION](https://cran.r-project.org/web/packages/mcptools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mcptools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-49ee5f0762a881` from `cran_packages_by_date` as `registry_expansion`
