...
<!-- canonical: https://github.com/SPlayer-Dev/SPlayer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SPlayer-Dev/SPlayer](https://github.com/SPlayer-Dev/SPlayer) |
| Source record ids | github_search_video-9e5b3a5b6ba2c8 |

## System Engineer Summary

🎵 A cross-platform music player with Jellyfin / Navidrome / Emby media server support, word-by-word
lyrics, desktop & taskbar lyrics, cloud music drive, local library management, audio spectrum
visualization and mobile-friendly UI. 简约的跨平台音乐播放器，支持逐字歌词、桌面歌词、任务栏歌词、云盘音乐、本地音乐管理及流媒体播放

## Operational Role

For a systems engineer, SPlayer-Dev/SPlayer belongs in the Video inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T03:56:42Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-9e5b3a5b6ba2c8` from `github_search_video` as `registry_expansion`
