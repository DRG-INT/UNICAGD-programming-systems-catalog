...
| Canonical URL | [https://crates.io/crates/minijinja](https://crates.io/crates/minijinja) |
| Source record ids | crates_io-4428dc57061ef2 |
...
For a systems engineer, minijinja belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.24.0 | 2026-08-12T17:57:07.996399Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-4428dc57061ef2` from `crates_io` as `registry_expansion`
