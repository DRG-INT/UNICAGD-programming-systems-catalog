...
| Canonical URL | [https://hackage.haskell.org/package/tricorder-mcp](https://hackage.haskell.org/package/tricorder-mcp) |
| Source record ids | hackage_recent-85b70f81457859 |
...
For a systems engineer, tricorder-mcp belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-01T08:57:38Z | [https://hackage.haskell.org/package/tricorder-mcp](https://hackage.haskell.org/package/tricorder-mcp) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tricorder-mcp` at `2026-09-01T10:25:40+00:00`.
...
- `hackage_recent-85b70f81457859` from `hackage_recent` as `registry_expansion`
