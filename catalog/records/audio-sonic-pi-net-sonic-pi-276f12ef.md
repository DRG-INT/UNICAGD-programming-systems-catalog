...
| Source record ids | github_search_audio-94ae2aa1ac4638 |

## System Engineer Summary

sonic-pi-net/sonic-pi is tracked as an image audio dsp record in the Audio branch. The source did
...
- Latest stable metadata was observed from `https://api.github.com/repos/sonic-pi-net/sonic-pi/releases/latest` at `2026-09-01T09:23:20+00:00`.
...
- `github_search_audio-94ae2aa1ac4638` from `github_search_audio` as `registry_expansion`
