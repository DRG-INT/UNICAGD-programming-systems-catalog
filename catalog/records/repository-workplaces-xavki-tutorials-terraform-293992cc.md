...
<!-- canonical: https://gitlab.com/xavki/tutorials-terraform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/xavki/tutorials-terraform](https://gitlab.com/xavki/tutorials-terraform) |
| Source record ids | gitlab_projects_api-2094a8debbcc17 |

## System Engineer Summary

Terraform from scratch: install, modules, Docker provider, networking, volumes, WordPress,
Kubernetes provider, ingress. Xavki tutorials —

## Operational Role

For a systems engineer, xavki/tutorials-terraform belongs in the Repository Workplaces inventory as
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; MIT License; https://api.github.com/licenses/mit |
...
- `gitlab_projects_api-2094a8debbcc17` from `gitlab_projects_api` as `registry_expansion`
