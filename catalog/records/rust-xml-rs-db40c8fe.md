...
| Canonical URL | [https://crates.io/crates/xml-rs](https://crates.io/crates/xml-rs) |
| Source record ids | crates_io-984faaee6780a5 |
...
For a systems engineer, xml-rs belongs in the Rust inventory as part of wire formats, persistence,
interoperability, and compatibility boundaries.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-06T16:08:01.866097Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-01T02:12:58+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| ark-serialize | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-serialize-ac27303d.md) |
| ark-serialize-derive | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-serialize-derive-482765a8.md) |
| avif-serialize | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-avif-serialize-a997b5d4.md) |
| aws-smithy-xml | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-smithy-xml-7dcd2b51.md) |
| bincode | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bincode-fd4a5141.md) |
| borsh | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-borsh-7d427bae.md) |
| borsh-derive | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-borsh-derive-dc36be21.md) |
| borsh-derive-internal | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-borsh-derive-internal-d1391b06.md) |
