...
<!-- canonical: https://www.nuget.org/packages/Cake.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Cake.Json](https://www.nuget.org/packages/Cake.Json) |
| Source record ids | nuget_search-b4aa84b3b5f4b0 |
...
For a systems engineer, Cake.Json belongs in the C-Sharp inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-08-20T13:18:22.12+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/cake.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/cake.json/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/Cake.Json/11.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/cake.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-b4aa84b3b5f4b0` from `nuget_search` as `registry_expansion`
