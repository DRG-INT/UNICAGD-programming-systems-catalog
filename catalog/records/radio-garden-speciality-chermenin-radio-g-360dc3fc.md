...
| Source record ids | curated_language_routes-9a86758619ebf4 |

## System Engineer Summary

Open MIT Electron desktop client for Radio Garden with a downloadable GitHub release route;
candidate for macOS/Linux-style desktop packaging checks.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2020-04-30T07:14:59Z | [https://api.github.com/repos/chermenin/radio.G/releases/latest](https://api.github.com/repos/chermenin/radio.G/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/chermenin/radio.G/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-9a86758619ebf4` from `curated_language_routes` as `registry_expansion`
