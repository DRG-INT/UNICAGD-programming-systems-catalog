...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-fuse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-fuse](https://luarocks.org/modules/moyu/dromozoa-fuse) |
| Source record ids | luarocks_root_manifest-4a5c73ebabb522 |

## System Engineer Summary

Lua bindings for libfuse

## Operational Role

For a systems engineer, dromozoa-fuse belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-4a5c73ebabb522` from `luarocks_root_manifest` as `registry_expansion`
