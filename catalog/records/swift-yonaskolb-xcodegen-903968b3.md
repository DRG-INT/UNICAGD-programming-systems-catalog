...
<!-- canonical: https://github.com/yonaskolb/XcodeGen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yonaskolb/XcodeGen](https://github.com/yonaskolb/XcodeGen) |
| Source record ids | github_search_swift-8303cc96b9b9a4 |
...
For a systems engineer, yonaskolb/XcodeGen belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-16T06:42:48Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-8303cc96b9b9a4` from `github_search_swift` as `registry_expansion`
