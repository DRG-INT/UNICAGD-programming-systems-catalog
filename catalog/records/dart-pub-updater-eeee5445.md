...
<!-- canonical: https://pub.dev/packages/pub_updater -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pub_updater](https://pub.dev/packages/pub_updater) |
| Source record ids | pub_dev-2c67ddbfb0a1d9 |
...
For a systems engineer, pub_updater belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-10T12:08:52.057791Z | [https://pub.dev/api/packages/pub_updater](https://pub.dev/api/packages/pub_updater) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pub_updater` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-2c67ddbfb0a1d9` from `pub_dev` as `registry_expansion`
