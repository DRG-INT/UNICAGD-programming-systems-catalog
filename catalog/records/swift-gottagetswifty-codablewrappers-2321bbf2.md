...
| Canonical URL | [https://github.com/GottaGetSwifty/CodableWrappers](https://github.com/GottaGetSwifty/CodableWrappers) |
| Source record ids | github_search_swift-63e655a866a882 |
...
For a systems engineer, GottaGetSwifty/CodableWrappers belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2025-01-07T06:47:41Z | [https://api.github.com/repos/GottaGetSwifty/CodableWrappers/releases/latest](https://api.github.com/repos/GottaGetSwifty/CodableWrappers/releases/latest) |  |
| preview | known | 3.0.0-alpha-release-2 | 2024-02-27T03:07:19Z | [https://api.github.com/repos/GottaGetSwifty/CodableWrappers/releases?per_page=10](https://api.github.com/repos/GottaGetSwifty/CodableWrappers/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GottaGetSwifty/CodableWrappers/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-63e655a866a882` from `github_search_swift` as `registry_expansion`
...
| The Composable Architecture | Build System | [open](swift-the-composable-architecture-5acdfac1.md) |
