...
| Canonical URL | [https://crates.io/crates/boxcar](https://crates.io/crates/boxcar) |
| Source record ids | crates_io-d5646bc737702c |
...
For a systems engineer, boxcar belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.14 | 2025-08-13T05:27:15.623055Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-d5646bc737702c` from `crates_io` as `registry_expansion`
