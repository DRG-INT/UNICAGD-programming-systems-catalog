...
<!-- canonical: https://github.com/zfile-dev/zfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zfile-dev/zfile](https://github.com/zfile-dev/zfile) |
| Source record ids | github_search_databases-634c8606766eb6 |
...
For a systems engineer, zfile-dev/zfile belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T12:29:29Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-634c8606766eb6` from `github_search_databases` as `registry_expansion`
