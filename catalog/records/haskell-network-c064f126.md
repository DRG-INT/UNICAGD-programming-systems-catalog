...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/network -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network](https://hackage.haskell.org/package/network) |
| Source record ids | hackage_top_downloads-293f1215764631 |
...
For a systems engineer, network belongs in the Haskell inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.9.0 | 2026-08-21T04:56:53Z | [https://hackage.haskell.org/package/network](https://hackage.haskell.org/package/network) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-293f1215764631` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apiary-websockets | Networking Http | [open](haskell-apiary-websockets-263436c5.md) |
| cayley-client | Networking Http | [open](haskell-cayley-client-c8d534c3.md) |
| clientsession | Networking Http | [open](haskell-clientsession-76b61ea8.md) |
| freckle-http | Networking Http | [open](haskell-freckle-http-ec27c9f6.md) |
| ghc-tcplugin-api | Networking Http | [open](haskell-ghc-tcplugin-api-7a5e533e.md) |
| HTTP | Networking Http | [open](haskell-http-72423048.md) |
| http-api-data | Networking Http | [open](haskell-http-api-data-0a92e255.md) |
| http-client | Networking Http | [open](haskell-http-client-33254f6a.md) |
