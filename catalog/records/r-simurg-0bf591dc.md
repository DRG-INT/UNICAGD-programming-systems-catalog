...
<!-- canonical: https://cran.r-project.org/web/packages/SimuRg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SimuRg/index.html](https://cran.r-project.org/web/packages/SimuRg/index.html) |
| Source record ids | cran_packages_by_date-f891fe3362af87 |

## System Engineer Summary

Building, Fitting and Evaluating PK/PD Modeles

## Operational Role

For a systems engineer, SimuRg belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-24 12:50:08 UTC | [https://cran.r-project.org/web/packages/SimuRg/DESCRIPTION](https://cran.r-project.org/web/packages/SimuRg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SimuRg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f891fe3362af87` from `cran_packages_by_date` as `registry_expansion`
