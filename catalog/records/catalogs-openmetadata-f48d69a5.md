...
| Source record ids | curated_language_routes-cc46b2cfd621bc |

## System Engineer Summary

Data catalog and metadata management platform for discovery, lineage, quality, governance, and
collaboration.

## Operational Role

For a systems engineer, OpenMetadata belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0-release | 2026-08-24T05:22:27Z | [https://api.github.com/repos/open-metadata/OpenMetadata/releases/latest](https://api.github.com/repos/open-metadata/OpenMetadata/releases/latest) |  |
| preview | known | 2.0.0-rc2-release | 2026-08-13T08:08:39Z | [https://api.github.com/repos/open-metadata/OpenMetadata/releases?per_page=10](https://api.github.com/repos/open-metadata/OpenMetadata/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/open-metadata/OpenMetadata/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-cc46b2cfd621bc` from `curated_language_routes` as `registry_expansion`
