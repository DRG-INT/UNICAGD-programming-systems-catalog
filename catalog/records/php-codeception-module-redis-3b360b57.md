...
<!-- canonical: https://packagist.org/packages/codeception/module-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/codeception/module-redis](https://packagist.org/packages/codeception/module-redis) |
| Source record ids | packagist_search-782d4a2e4f82fd |
...
For a systems engineer, codeception/module-redis belongs in the PHP inventory as part of state
...
- `packagist_search-782d4a2e4f82fd` from `packagist_search` as `registry_expansion`
