...
<!-- canonical: https://github.com/WebAssembly/memory64 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/memory64](https://github.com/WebAssembly/memory64) |
| Source record ids | github_search_webassembly-6252d3fd1ac882 |
...
For a systems engineer, WebAssembly/memory64 belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-15T17:12:02Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6252d3fd1ac882` from `github_search_webassembly` as `registry_expansion`
