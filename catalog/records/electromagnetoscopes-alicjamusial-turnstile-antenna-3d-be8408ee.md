# alicjamusial/turnstile-antenna-3D
...
<!-- canonical: https://github.com/alicjamusial/turnstile-antenna-3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alicjamusial/turnstile-antenna-3D](https://github.com/alicjamusial/turnstile-antenna-3D) |
| Source record ids | github_search_electromagnetoscopes-e46cf20e3cbd0a |

## System Engineer Summary

3D designs for turnstile antenna components.

## Operational Role

For a systems engineer, alicjamusial/turnstile-antenna-3D belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-18T07:49:03Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-e46cf20e3cbd0a` from `github_search_electromagnetoscopes` as `registry_expansion`
