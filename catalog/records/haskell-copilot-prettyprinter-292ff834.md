...
<!-- canonical: https://hackage.haskell.org/package/copilot-prettyprinter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/copilot-prettyprinter](https://hackage.haskell.org/package/copilot-prettyprinter) |
| Source record ids | hackage_recent-13780d91e8ee2d |
...
For a systems engineer, copilot-prettyprinter belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:19:56Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-13780d91e8ee2d` from `hackage_recent` as `registry_expansion`
