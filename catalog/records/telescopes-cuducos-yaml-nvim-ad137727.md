...
<!-- canonical: https://github.com/cuducos/yaml.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cuducos/yaml.nvim](https://github.com/cuducos/yaml.nvim) |
| Source record ids | github_search_telescopes-b9cf9cea4e1e2a |
...
For a systems engineer, cuducos/yaml.nvim belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-04T21:12:19Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-b9cf9cea4e1e2a` from `github_search_telescopes` as `registry_expansion`
