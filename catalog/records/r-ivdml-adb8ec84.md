...
<!-- canonical: https://cran.r-project.org/web/packages/IVDML/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IVDML/index.html](https://cran.r-project.org/web/packages/IVDML/index.html) |
| Source record ids | cran_packages_by_date-ce0ba6d22c413a |
...
For a systems engineer, IVDML belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-04 12:00:31 UTC | [https://cran.r-project.org/web/packages/IVDML/DESCRIPTION](https://cran.r-project.org/web/packages/IVDML/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IVDML/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-ce0ba6d22c413a` from `cran_packages_by_date` as `registry_expansion`
