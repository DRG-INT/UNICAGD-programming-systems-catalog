...
| Canonical URL | [https://luarocks.org/modules/emartech/kong-plugin-api-key-access-control](https://luarocks.org/modules/emartech/kong-plugin-api-key-access-control) |
| Source record ids | luarocks_root_manifest-f84fecec55dec7 |

## System Engineer Summary

Api key access control plugin for Kong. - DEPRECATED - TO BE REMOVED

## Operational Role

For a systems engineer, kong-plugin-api-key-access-control belongs in the Lua family inventory as
...
- `luarocks_root_manifest-f84fecec55dec7` from `luarocks_root_manifest` as `registry_expansion`
