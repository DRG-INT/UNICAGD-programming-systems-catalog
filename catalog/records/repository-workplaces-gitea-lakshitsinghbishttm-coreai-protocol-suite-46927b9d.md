# Gitea: LakshitSinghBishtTM/CoreAI-Protocol-Suite
...
<!-- canonical: https://gitea.com/LakshitSinghBishtTM/CoreAI-Protocol-Suite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/LakshitSinghBishtTM/CoreAI-Protocol-Suite](https://gitea.com/LakshitSinghBishtTM/CoreAI-Protocol-Suite) |
| Source record ids | gitea_repositories_api-da92660375538a |
...
For a systems engineer, Gitea: LakshitSinghBishtTM/CoreAI-Protocol-Suite belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T06:20:56Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-da92660375538a` from `gitea_repositories_api` as `registry_expansion`
