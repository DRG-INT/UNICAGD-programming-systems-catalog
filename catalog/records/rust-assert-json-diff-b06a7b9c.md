...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Assertion Mocking](../by-category/assertion-mocking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/assert-json-diff -->
<!-- crawl-delay: 10 -->
...
| --- | --- |
| Detected family | MIT |
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT; https://www.nuget.org/packages/System.ServiceModel.Http/10.0.652802/license |
...
- `crates_io-cbc42e20087cde` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| approx | Assertion Mocking | [open](rust-approx-eb5ade15.md) |
| assert_matches | Assertion Mocking | [open](rust-assert-matches-2a77239e.md) |
| difference | Assertion Mocking | [open](rust-difference-f54dfafb.md) |
| equator | Assertion Mocking | [open](rust-equator-ed270323.md) |
| equator-macro | Assertion Mocking | [open](rust-equator-macro-163ed78b.md) |
| httpmock | Assertion Mocking | [open](rust-httpmock-b00ed6a7.md) |
| mockall | Assertion Mocking | [open](rust-mockall-38e7929d.md) |
| mockall_derive | Assertion Mocking | [open](rust-mockall-derive-2fc6e053.md) |
