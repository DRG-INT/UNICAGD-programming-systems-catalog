...
| Canonical URL | [https://crates.io/crates/assert-json-diff](https://crates.io/crates/assert-json-diff) |
| Source record ids | crates_io-cbc42e20087cde |
...
For a systems engineer, assert-json-diff belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2022-06-29T21:40:34.607604Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| approx | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-approx-eb5ade15.md) |
| assert_matches | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-assert-matches-2a77239e.md) |
| difference | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-difference-f54dfafb.md) |
| equator | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-equator-ed270323.md) |
| equator-macro | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-equator-macro-163ed78b.md) |
| httpmock | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-httpmock-b00ed6a7.md) |
| mockall | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-mockall-38e7929d.md) |
| mockall_derive | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-mockall-derive-2fc6e053.md) |
