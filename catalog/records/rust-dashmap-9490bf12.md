...
<!-- canonical: https://crates.io/crates/dashmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dashmap](https://crates.io/crates/dashmap) |
| Source record ids | crates_io-c45f40a9e96f3f |
...
For a systems engineer, dashmap belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.2.1 | 2026-05-17T21:28:34.356251Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-c45f40a9e96f3f` from `crates_io` as `registry_expansion`
