...
<!-- canonical: https://pub.dev/packages/patrol_cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/patrol_cli](https://pub.dev/packages/patrol_cli) |
| Source record ids | pub_dev-487ef8ea718321 |
...
For a systems engineer, patrol_cli belongs in the Dart inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.0 | 2026-09-15T10:05:25.714141Z | [https://pub.dev/api/packages/patrol_cli](https://pub.dev/api/packages/patrol_cli) |  |
| preview | known | 4.7.0-dev.1 | 2026-08-10T07:35:38.603384Z | [https://pub.dev/api/packages/patrol_cli](https://pub.dev/api/packages/patrol_cli) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/patrol_cli` at `2026-09-15T22:19:06+00:00`.
...
- `pub_dev-487ef8ea718321` from `pub_dev` as `registry_expansion`
