...
<!-- canonical: https://github.com/exokitxr/exokit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/exokitxr/exokit](https://github.com/exokitxr/exokit) |
| Source record ids | github_search_engines-c07984996f1aef |
...
For a systems engineer, exokitxr/exokit belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-06T20:59:00Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-c07984996f1aef` from `github_search_engines` as `registry_expansion`
