...
<!-- canonical: https://github.com/ChangbaDevs/KTVHTTPCache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChangbaDevs/KTVHTTPCache](https://github.com/ChangbaDevs/KTVHTTPCache) |
| Source record ids | github_search_cocoa-4a72f61ef2fdd8 |
...
For a systems engineer, ChangbaDevs/KTVHTTPCache belongs in the Cocoa inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-04T06:54:40Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-4a72f61ef2fdd8` from `github_search_cocoa` as `registry_expansion`
