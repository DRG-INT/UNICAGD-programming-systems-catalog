...
<!-- canonical: https://github.com/ggwhite/go-masker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ggwhite/go-masker](https://github.com/ggwhite/go-masker) |
| Source record ids | github_search_go-164fc663beea45 |

## System Engineer Summary

Go library for masking sensitive data via struct tags — passwords, emails, IDs, credit cards, and
more

## Operational Role

For a systems engineer, ggwhite/go-masker belongs in the Go inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-07T14:47:27Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-164fc663beea45` from `github_search_go` as `registry_expansion`
