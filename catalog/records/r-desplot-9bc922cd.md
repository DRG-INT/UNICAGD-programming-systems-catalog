...
<!-- canonical: https://cran.r-project.org/web/packages/desplot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/desplot/index.html](https://cran.r-project.org/web/packages/desplot/index.html) |
| Source record ids | cran_packages_by_date-e6dd391519191a |
...
For a systems engineer, desplot belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11 | 2026-08-21 12:00:08 UTC | [https://cran.r-project.org/web/packages/desplot/DESCRIPTION](https://cran.r-project.org/web/packages/desplot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/desplot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e6dd391519191a` from `cran_packages_by_date` as `registry_expansion`
