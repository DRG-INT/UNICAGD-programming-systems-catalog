...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-rector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-rector](https://packagist.org/packages/pestphp/pest-plugin-rector) |
| Source record ids | packagist_search-d6cf7ffdf35894 |

## System Engineer Summary

pestphp/pest-plugin-rector is tracked as a testing framework record in the PHP branch. The source
...
For a systems engineer, pestphp/pest-plugin-rector belongs in the PHP inventory as part of
...
- `packagist_search-d6cf7ffdf35894` from `packagist_search` as `registry_expansion`
