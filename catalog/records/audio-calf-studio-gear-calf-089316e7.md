...
<!-- canonical: https://github.com/calf-studio-gear/calf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/calf-studio-gear/calf](https://github.com/calf-studio-gear/calf) |
| Source record ids | github_search_audio-7a5e30eb4283de |
...
For a systems engineer, calf-studio-gear/calf belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T15:17:16Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-7a5e30eb4283de` from `github_search_audio` as `registry_expansion`
...
| DropSnorz/OwlPlug | Filesystem Os | [open](audio-dropsnorz-owlplug-ab9f531b.md) |
