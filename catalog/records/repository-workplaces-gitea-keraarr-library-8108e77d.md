...
<!-- canonical: https://gitea.com/keraarr/Library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/keraarr/Library](https://gitea.com/keraarr/Library) |
| Source record ids | gitea_repositories_api-f9df116997e030 |

## System Engineer Summary

Проект: Библиотека — учебная работа

## Operational Role

For a systems engineer, Gitea: keraarr/Library belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-28T08:50:03Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f9df116997e030` from `gitea_repositories_api` as `registry_expansion`
