...
<!-- canonical: https://pub.dev/packages/hooks_riverpod -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/hooks_riverpod](https://pub.dev/packages/hooks_riverpod) |
| Source record ids | pub_dev-e8a473d191779e |
...
For a systems engineer, hooks_riverpod belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.2 | 2026-07-28T19:54:43.370401Z | [https://pub.dev/api/packages/hooks_riverpod](https://pub.dev/api/packages/hooks_riverpod) |  |
| preview | known | 3.3.2-dev.2 | 2026-05-06T12:35:00.029014Z | [https://pub.dev/api/packages/hooks_riverpod](https://pub.dev/api/packages/hooks_riverpod) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/hooks_riverpod` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-e8a473d191779e` from `pub_dev` as `registry_expansion`
