...
<!-- canonical: https://github.com/rspatial/terra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rspatial/terra](https://github.com/rspatial/terra) |
| Source record ids | github_search_maps-5efdc5c27ac6a8 |
...
For a systems engineer, rspatial/terra belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T15:31:18Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5efdc5c27ac6a8` from `github_search_maps` as `registry_expansion`
