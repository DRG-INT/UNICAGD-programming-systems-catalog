...
<!-- canonical: https://github.com/jina-ai/vectordb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jina-ai/vectordb](https://github.com/jina-ai/vectordb) |
| Source record ids | github_search_databases-e152edfc6d30e3 |
...
For a systems engineer, jina-ai/vectordb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-04T17:10:06Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e152edfc6d30e3` from `github_search_databases` as `registry_expansion`
