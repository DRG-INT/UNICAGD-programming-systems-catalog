...
| Canonical URL | [https://luarocks.org/modules/gx/gxid-param](https://luarocks.org/modules/gx/gxid-param) |
| Source record ids | luarocks_root_manifest-6e2d984cea594d |

## System Engineer Summary

gxid-param is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, gxid-param belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6e2d984cea594d` from `luarocks_root_manifest` as `registry_expansion`
