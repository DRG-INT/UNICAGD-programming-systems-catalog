...
<!-- canonical: https://github.com/MarkSherstan/MPU-6050-9250-I2C-CompFilter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MarkSherstan/MPU-6050-9250-I2C-CompFilter](https://github.com/MarkSherstan/MPU-6050-9250-I2C-CompFilter) |
| Source record ids | github_search_electromagnetoscopes-82c1fd6c927f7a |

## System Engineer Summary

MPU6050/9250 I2C and SPI interface. Sensor fusion using a complementary filter yields sensor Euler
angles and is implemented in five different languages.

## Operational Role

For a systems engineer, MarkSherstan/MPU-6050-9250-I2C-CompFilter belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-28T23:01:25Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-82c1fd6c927f7a` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Senape3000/EvilCrowRF-V2 | Language Specification | [open](electromagnetoscopes-senape3000-evilcrowrf-v2-03cdfcba.md) |
