...
<!-- canonical: https://cran.r-project.org/web/packages/pks/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pks/index.html](https://cran.r-project.org/web/packages/pks/index.html) |
| Source record ids | cran_packages_by_date-243d2a7717c614 |
...
For a systems engineer, pks belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8-0 | 2026-09-16 02:40:02 UTC | [https://cran.r-project.org/web/packages/pks/DESCRIPTION](https://cran.r-project.org/web/packages/pks/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pks/DESCRIPTION` at `2026-09-16T03:20:38+00:00`.
...
- `cran_packages_by_date-243d2a7717c614` from `cran_packages_by_date` as `registry_expansion`
