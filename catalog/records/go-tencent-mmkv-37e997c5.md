...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Tencent/MMKV -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tencent/MMKV](https://github.com/Tencent/MMKV) |
| Source record ids | github_search_go-db1ce679bfc105 |

## System Engineer Summary

An efficient, small mobile key-value storage framework developed by WeChat. Works on Android, iOS,
macOS, Windows, POSIX, and OHOS.

## Operational Role

For a systems engineer, Tencent/MMKV belongs in the Go inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T11:03:49Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
- `github_search_go-db1ce679bfc105` from `github_search_go` as `registry_expansion`
