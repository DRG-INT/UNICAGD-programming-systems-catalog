...
<!-- canonical: https://github.com/SiEPIC/gds_fdtd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SiEPIC/gds_fdtd](https://github.com/SiEPIC/gds_fdtd) |
| Source record ids | github_search_electromagnetoscopes-84bdc8d6c28332 |

## System Engineer Summary

EDA-agnostic and Solver-agnostic 3D FDTD simulations execution framework for photonic layouts: GDS
in, results out (S-parameters, visualization tools, compact models) - tidy3d, Lumerical, or beamz
behind one API.

## Operational Role

For a systems engineer, SiEPIC/gds_fdtd belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T21:32:50Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-84bdc8d6c28332` from `github_search_electromagnetoscopes` as `registry_expansion`
