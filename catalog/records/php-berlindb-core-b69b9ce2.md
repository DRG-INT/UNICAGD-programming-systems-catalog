...
| Canonical URL | [https://packagist.org/packages/berlindb/core](https://packagist.org/packages/berlindb/core) |
| Source record ids | packagist_search-e09337e0d52127 |

## System Engineer Summary

A collection of PHP classes and functions that aims to provide an ORM-like experience and interface
to WordPress database tables.

## Operational Role

For a systems engineer, berlindb/core belongs in the PHP inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-05-28T15:34:50+00:00 | [https://repo.packagist.org/p2/berlindb/core.json](https://repo.packagist.org/p2/berlindb/core.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/berlindb/core.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-e09337e0d52127` from `packagist_search` as `registry_expansion`
...
| ergebnis/json | Ide Editor Integration | [open](php-ergebnis-json-08febff2.md) |
