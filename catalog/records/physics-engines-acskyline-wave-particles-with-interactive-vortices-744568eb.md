...
<!-- canonical: https://github.com/ACskyline/Wave-Particles-with-Interactive-Vortices -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ACskyline/Wave-Particles-with-Interactive-Vortices](https://github.com/ACskyline/Wave-Particles-with-Interactive-Vortices) |
| Source record ids | github_search_physics_engines-bfe497608b0d2f |
...
For a systems engineer, ACskyline/Wave-Particles-with-Interactive-Vortices belongs in the Physics
Engines inventory as part of ecosystem capability mapping, dependency review, release awareness, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-09-23T03:36:19Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-bfe497608b0d2f` from `github_search_physics_engines` as `registry_expansion`
...
| hamaluik/headbutt | Visualization Gui | [open](physics-engines-hamaluik-headbutt-d9245287.md) |
