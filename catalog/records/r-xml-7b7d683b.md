...
<!-- canonical: https://cran.r-project.org/web/packages/XML/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/XML/index.html](https://cran.r-project.org/web/packages/XML/index.html) |
| Source record ids | cran_packages_by_date-152087a46b787d |
...
For a systems engineer, XML belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.99-0.24 | 2026-08-21 22:00:58 UTC | [https://cran.r-project.org/web/packages/XML/DESCRIPTION](https://cran.r-project.org/web/packages/XML/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/XML/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-152087a46b787d` from `cran_packages_by_date` as `registry_expansion`
