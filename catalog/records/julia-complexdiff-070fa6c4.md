...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ComplexDiff](https://github.com/JuliaRegistries/General/tree/master/C/ComplexDiff) |
| Source record ids | julia_general-37d6dda0ddd6eb |

## System Engineer Summary

Julia package registered in General at C/ComplexDiff.

## Operational Role

For a systems engineer, ComplexDiff belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ComplexDiff", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-37d6dda0ddd6eb` from `julia_general` as `registry_expansion`
