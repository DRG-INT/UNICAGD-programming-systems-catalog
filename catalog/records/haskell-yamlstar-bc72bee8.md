...
<!-- canonical: https://hackage.haskell.org/package/yamlstar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yamlstar](https://hackage.haskell.org/package/yamlstar) |
| Source record ids | hackage_recent-1c62771ff44deb |

## System Engineer Summary

Hackage package recently uploaded by ingy.

## Operational Role

For a systems engineer, yamlstar belongs in the Haskell inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.19.0 | 2026-09-02T19:17:00Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-1c62771ff44deb` from `hackage_recent` as `registry_expansion`
