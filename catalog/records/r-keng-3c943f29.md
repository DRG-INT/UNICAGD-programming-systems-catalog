...
<!-- canonical: https://cran.r-project.org/web/packages/Keng/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Keng/index.html](https://cran.r-project.org/web/packages/Keng/index.html) |
| Source record ids | cran_packages_by_date-ba02a6104d3441 |
...
For a systems engineer, Keng belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.9.0 | 2026-09-01 11:40:23 UTC | [https://cran.r-project.org/web/packages/Keng/DESCRIPTION](https://cran.r-project.org/web/packages/Keng/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Keng/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-ba02a6104d3441` from `cran_packages_by_date` as `registry_expansion`
