# ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-Pointing-Stability-Proposal-Workshop

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-Pointing-Stability-Proposal-Workshop -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Basilisk |
| Category | Language Specification |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-Pointing-Stability-Proposal-Workshop](https://github.com/ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-Pointing-Stability-Proposal-Workshop) |
| Source record ids | github_search_basilisk-54cc36ebb0f77f |

## System Engineer Summary

Basilisk simulation for closed-loop coronagraphic pointing stability. 500-run Monte Carlo: 0.28 mas
jitter, 1.00e-10 contrast. RWA to plant to MEKF to H-infinity to beamwalk.

## Operational Role

For a systems engineer, ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-
Pointing-Stability-Proposal-Workshop belongs in the Basilisk inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-14T16:38:08Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "basilisk c simulation", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_basilisk-54cc36ebb0f77f` from `github_search_basilisk` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Basilisk C | Language Specification | [open](basilisk-basilisk-c-c9a354f5.md) |
| sdfeer-collab/Ember | Language Specification | [open](basilisk-sdfeer-collab-ember-24183f02.md) |
| viper-org/basilisk | Language Specification | [open](basilisk-viper-org-basilisk-0b41716c.md) |
