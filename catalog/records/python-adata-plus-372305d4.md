...
<!-- canonical: https://pypi.org/project/adata-plus/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adata-plus/](https://pypi.org/project/adata-plus/) |
| Source record ids | pypi_simple-f9665519e7908f |

## System Engineer Summary

AData plus, A Stock, ETF, Bond, Quant, Stock Market, K Line

## Operational Role

For a systems engineer, adata-plus belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.8 | 2026-08-04T07:44:56.559805Z | [https://pypi.org/pypi/adata-plus/json](https://pypi.org/pypi/adata-plus/json) |  |
...
| Evidence | Apache License; License :: OSI Approved :: Apache Software License |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adata-plus/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-f9665519e7908f` from `pypi_simple` as `registry_expansion`
