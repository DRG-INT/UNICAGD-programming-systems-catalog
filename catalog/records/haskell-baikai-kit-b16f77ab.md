...
<!-- canonical: https://hackage.haskell.org/package/baikai-kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai-kit](https://hackage.haskell.org/package/baikai-kit) |
| Source record ids | hackage_recent-d01ba8c5e3370f |
...
For a systems engineer, baikai-kit belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.1 | 2026-09-08T14:57:17Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-08T16:22:20+00:00`.
...
- `hackage_recent-d01ba8c5e3370f` from `hackage_recent` as `registry_expansion`
