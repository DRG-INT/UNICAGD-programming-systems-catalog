...
<!-- canonical: https://cran.r-project.org/web/packages/baseballr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/baseballr/index.html](https://cran.r-project.org/web/packages/baseballr/index.html) |
| Source record ids | cran_packages_by_date-79e652c40d5312 |
...
For a systems engineer, baseballr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-26 21:50:02 UTC | [https://cran.r-project.org/web/packages/baseballr/DESCRIPTION](https://cran.r-project.org/web/packages/baseballr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/baseballr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-79e652c40d5312` from `cran_packages_by_date` as `registry_expansion`
