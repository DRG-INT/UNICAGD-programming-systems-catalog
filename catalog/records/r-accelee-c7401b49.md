...
<!-- canonical: https://cran.r-project.org/web/packages/accelEE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/accelEE/index.html](https://cran.r-project.org/web/packages/accelEE/index.html) |
| Source record ids | cran_packages_by_date-8c367979bb31c7 |

## System Engineer Summary

Predict Energy Expenditure from Accelerometry Data

## Operational Role

For a systems engineer, accelEE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-28 21:40:08 UTC | [https://cran.r-project.org/web/packages/accelEE/DESCRIPTION](https://cran.r-project.org/web/packages/accelEE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/accelEE/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8c367979bb31c7` from `cran_packages_by_date` as `registry_expansion`
