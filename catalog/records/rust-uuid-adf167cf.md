...
<!-- canonical: https://crates.io/crates/uuid -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-08a8a0fc1f4ed4 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.1 | 2026-09-10T00:30:44.938530Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-10T02:20:18+00:00`.
...
- `crates_io-08a8a0fc1f4ed4` from `crates_io` as `registry_expansion`
