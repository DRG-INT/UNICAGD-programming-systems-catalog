...
<!-- canonical: https://cran.r-project.org/web/packages/causalDT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/causalDT/index.html](https://cran.r-project.org/web/packages/causalDT/index.html) |
| Source record ids | cran_packages_by_date-3916314f5f34b5 |
...
For a systems engineer, causalDT belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-28 20:00:08 UTC | [https://cran.r-project.org/web/packages/causalDT/DESCRIPTION](https://cran.r-project.org/web/packages/causalDT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/causalDT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3916314f5f34b5` from `cran_packages_by_date` as `registry_expansion`
