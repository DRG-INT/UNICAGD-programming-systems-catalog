...
<!-- canonical: https://crates.io/crates/xxhash-rust -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/xxhash-rust](https://crates.io/crates/xxhash-rust) |
| Source record ids | crates_io-9cb13467b0d813 |
...
For a systems engineer, xxhash-rust belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.18 | 2026-07-21T10:54:28.375103Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-9cb13467b0d813` from `crates_io` as `registry_expansion`
