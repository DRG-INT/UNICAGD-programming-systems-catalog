...
<!-- canonical: https://cran.r-project.org/web/packages/oddsapiio/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/oddsapiio/index.html](https://cran.r-project.org/web/packages/oddsapiio/index.html) |
| Source record ids | cran_packages_by_date-492d1c44dfa76e |

## System Engineer Summary

Client for the 'Odds-API.io' Sports Betting Odds API

## Operational Role

For a systems engineer, oddsapiio belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-05 09:20:13 UTC | [https://cran.r-project.org/web/packages/oddsapiio/DESCRIPTION](https://cran.r-project.org/web/packages/oddsapiio/DESCRIPTION) |  |
...
| Evidence | GPL (>= 3); {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/oddsapiio/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-492d1c44dfa76e` from `cran_packages_by_date` as `registry_expansion`
