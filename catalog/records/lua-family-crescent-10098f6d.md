...
<!-- canonical: https://luarocks.org/modules/kingdaro/crescent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kingdaro/crescent](https://luarocks.org/modules/kingdaro/crescent) |
| Source record ids | luarocks_root_manifest-35df94f66df503 |

## System Engineer Summary

a command-line program for moonscript - with pretty colors!

## Operational Role

For a systems engineer, crescent belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-35df94f66df503` from `luarocks_root_manifest` as `registry_expansion`
