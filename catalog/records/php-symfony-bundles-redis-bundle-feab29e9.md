...
<!-- canonical: https://packagist.org/packages/symfony-bundles/redis-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony-bundles/redis-bundle](https://packagist.org/packages/symfony-bundles/redis-bundle) |
| Source record ids | packagist_search-bd2632a523f871 |

## System Engineer Summary

symfony-bundles/redis-bundle is tracked as a database datastore record in the PHP branch. The source
...
For a systems engineer, symfony-bundles/redis-bundle belongs in the PHP inventory as part of state
...
- `packagist_search-bd2632a523f871` from `packagist_search` as `registry_expansion`
