...
<!-- canonical: https://www.npmjs.com/package/redis-memory-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/redis-memory-server](https://www.npmjs.com/package/redis-memory-server) |
| Source record ids | npm_registry-0c66049585c4a4 |

## System Engineer Summary

Redis Server for testing. The server will allow you to connect your favorite client library to the
Redis Server and run parallel integration tests isolated from each other.

## Operational Role

For a systems engineer, redis-memory-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.1 | 2026-07-30T18:39:11.058Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-0c66049585c4a4` from `npm_registry` as `registry_expansion`
