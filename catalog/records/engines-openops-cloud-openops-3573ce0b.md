...
<!-- canonical: https://github.com/openops-cloud/openops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openops-cloud/openops](https://github.com/openops-cloud/openops) |
| Source record ids | github_search_engines-5c353482001dee |
...
For a systems engineer, openops-cloud/openops belongs in the Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:31:51Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-5c353482001dee` from `github_search_engines` as `registry_expansion`
