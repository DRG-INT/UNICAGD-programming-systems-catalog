...
<!-- canonical: https://pub.dev/packages/supabase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/supabase](https://pub.dev/packages/supabase) |
| Source record ids | pub_dev-0976965b50aea0 |

## System Engineer Summary

A dart client for Supabase. This client makes it simple for developers to build secure and scalable
products.

## Operational Role

For a systems engineer, supabase belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.16.1 | 2026-08-14T15:46:30.001690Z | [https://pub.dev/api/packages/supabase](https://pub.dev/api/packages/supabase) |  |
| preview | known | 3.0.0-dev.2 | 2026-09-01T13:45:10.535587Z | [https://pub.dev/api/packages/supabase](https://pub.dev/api/packages/supabase) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/supabase` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-0976965b50aea0` from `pub_dev` as `registry_expansion`
