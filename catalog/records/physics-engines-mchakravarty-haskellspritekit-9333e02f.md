...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mchakravarty/HaskellSpriteKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mchakravarty/HaskellSpriteKit](https://github.com/mchakravarty/HaskellSpriteKit) |
| Source record ids | github_search_physics_engines-7fcf4d2efc8c2d |
...
For a systems engineer, mchakravarty/HaskellSpriteKit belongs in the Physics Engines inventory as
part of editor intelligence, refactoring assistance, diagnostics, and navigation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-16T15:54:44Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7fcf4d2efc8c2d` from `github_search_physics_engines` as `registry_expansion`
