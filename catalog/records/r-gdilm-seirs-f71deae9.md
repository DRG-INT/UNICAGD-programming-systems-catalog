...
<!-- canonical: https://cran.r-project.org/web/packages/GDILM.SEIRS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GDILM.SEIRS/index.html](https://cran.r-project.org/web/packages/GDILM.SEIRS/index.html) |
| Source record ids | cran_packages_by_date-eefe429541eb22 |
...
For a systems engineer, GDILM.SEIRS belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7 | 2026-09-06 22:50:19 UTC | [https://cran.r-project.org/web/packages/GDILM.SEIRS/DESCRIPTION](https://cran.r-project.org/web/packages/GDILM.SEIRS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GDILM.SEIRS/DESCRIPTION` at `2026-09-07T00:31:41+00:00`.
...
- `cran_packages_by_date-eefe429541eb22` from `cran_packages_by_date` as `registry_expansion`
