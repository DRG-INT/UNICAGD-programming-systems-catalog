...
<!-- canonical: https://github.com/dromara/easy-query -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dromara/easy-query](https://github.com/dromara/easy-query) |
| Source record ids | github_search_databases-bac4a2ab297483 |

## System Engineer Summary

java/kotlin high performance lightweight solution for jdbc query,support oltp and olap
query,一款java下面支持强类型、轻量级、高性能的ORM,致力于解决jdbc查询,拥有对象模型筛选、隐式子查询、隐式join

## Operational Role

For a systems engineer, dromara/easy-query belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T09:21:23Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-bac4a2ab297483` from `github_search_databases` as `registry_expansion`
