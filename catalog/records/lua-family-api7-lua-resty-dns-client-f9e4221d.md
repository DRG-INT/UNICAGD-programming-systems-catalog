...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-dns-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-resty-dns-client](https://luarocks.org/modules/membphis/api7-lua-resty-dns-client) |
| Source record ids | luarocks_root_manifest-333c6609da38a1 |

## System Engineer Summary

api7-lua-resty-dns-client is tracked as a networking http record in the Lua family branch. The
...
For a systems engineer, api7-lua-resty-dns-client belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-333c6609da38a1` from `luarocks_root_manifest` as `registry_expansion`
