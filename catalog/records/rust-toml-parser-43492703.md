...
<!-- canonical: https://crates.io/crates/toml_parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/toml_parser](https://crates.io/crates/toml_parser) |
| Source record ids | crates_io-9fe100aa3c95b5 |
...
For a systems engineer, toml_parser belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3+spec-1.1.0 | 2026-07-27T14:53:02.089853Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-08T18:23:33+00:00`.
...
- `crates_io-9fe100aa3c95b5` from `crates_io` as `registry_expansion`
