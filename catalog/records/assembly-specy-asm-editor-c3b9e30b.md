...
<!-- canonical: https://github.com/Specy/asm-editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Specy/asm-editor](https://github.com/Specy/asm-editor) |
| Source record ids | github_search_assembly-6d0f9978d829e0 |
...
For a systems engineer, Specy/asm-editor belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T20:50:10Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6d0f9978d829e0` from `github_search_assembly` as `registry_expansion`
