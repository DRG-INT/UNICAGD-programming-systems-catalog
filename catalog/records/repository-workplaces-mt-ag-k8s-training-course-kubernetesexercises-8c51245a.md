# mt-ag-k8s-training-course/kubernetesexercises
...
<!-- canonical: https://gitlab.com/mt-ag-k8s-training-course/kubernetesexercises -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/mt-ag-k8s-training-course/kubernetesexercises](https://gitlab.com/mt-ag-k8s-training-course/kubernetesexercises) |
| Source record ids | gitlab_projects_api-a971ca697c0559 |
...
For a systems engineer, mt-ag-k8s-training-course/kubernetesexercises belongs in the Repository
...
- `gitlab_projects_api-a971ca697c0559` from `gitlab_projects_api` as `registry_expansion`
