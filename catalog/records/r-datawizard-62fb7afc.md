...
<!-- canonical: https://cran.r-project.org/web/packages/datawizard/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datawizard/index.html](https://cran.r-project.org/web/packages/datawizard/index.html) |
| Source record ids | cran_packages_by_date-40bf5e149432e3 |
...
For a systems engineer, datawizard belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-09-10 12:40:02 UTC | [https://cran.r-project.org/web/packages/datawizard/DESCRIPTION](https://cran.r-project.org/web/packages/datawizard/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datawizard/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-40bf5e149432e3` from `cran_packages_by_date` as `registry_expansion`
