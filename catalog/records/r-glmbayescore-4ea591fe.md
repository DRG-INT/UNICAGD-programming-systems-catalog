...
<!-- canonical: https://cran.r-project.org/web/packages/glmbayesCore/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmbayesCore/index.html](https://cran.r-project.org/web/packages/glmbayesCore/index.html) |
| Source record ids | cran_packages_by_date-e50a5f57e2bc5e |
...
For a systems engineer, glmbayesCore belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-08-05 07:30:02 UTC | [https://cran.r-project.org/web/packages/glmbayesCore/DESCRIPTION](https://cran.r-project.org/web/packages/glmbayesCore/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmbayesCore/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e50a5f57e2bc5e` from `cran_packages_by_date` as `registry_expansion`
