...
<!-- canonical: https://gitlab.com/postgres-ai/joe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/postgres-ai/joe](https://gitlab.com/postgres-ai/joe) |
| Source record ids | gitlab_projects_api-957bc9edc5eb83 |

## System Engineer Summary

Joe helps backend engineers and DBAs troubleshoot and optimize SQL, moving really quickly. Joe works
on top of Database Lab

## Operational Role

For a systems engineer, postgres-ai/joe belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-957bc9edc5eb83` from `gitlab_projects_api` as `registry_expansion`
