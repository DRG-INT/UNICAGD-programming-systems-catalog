...
<!-- canonical: https://github.com/magicpatterns/catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/magicpatterns/catalog](https://github.com/magicpatterns/catalog) |
| Source record ids | github_search_icons_and_logos-d0112254054318 |

## System Engineer Summary

The Magic Patterns Catalog is an open-source website that lists the most popular React component
libraries, helping you find the perfect component.

## Operational Role

For a systems engineer, magicpatterns/catalog belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-03T20:23:35Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-d0112254054318` from `github_search_icons_and_logos` as `registry_expansion`
