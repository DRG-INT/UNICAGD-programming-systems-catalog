...
<!-- canonical: https://github.com/sozercan/kaset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sozercan/kaset](https://github.com/sozercan/kaset) |
| Source record ids | github_search_swift-ade4a14603867f |
...
For a systems engineer, sozercan/kaset belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T18:15:12Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-ade4a14603867f` from `github_search_swift` as `registry_expansion`
