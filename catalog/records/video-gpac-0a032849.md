...
| Source record ids | curated_language_routes-1cb6d85a7a69e5 |

## System Engineer Summary

Multimedia framework for packaging, streaming, MP4, DASH, HLS, scene formats, and media inspection.

## Operational Role

For a systems engineer, GPAC belongs in the Video inventory as part of ecosystem capability mapping,
...
- `curated_language_routes-1cb6d85a7a69e5` from `curated_language_routes` as `registry_expansion`
