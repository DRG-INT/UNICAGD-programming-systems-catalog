...
| Canonical URL | [https://luarocks.org/modules/syhily/header-transfer](https://luarocks.org/modules/syhily/header-transfer) |
| Source record ids | luarocks_root_manifest-fde919467b346a |
...
For a systems engineer, header-transfer belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-fde919467b346a` from `luarocks_root_manifest` as `registry_expansion`
