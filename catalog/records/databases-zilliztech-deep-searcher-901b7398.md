...
<!-- canonical: https://github.com/zilliztech/deep-searcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zilliztech/deep-searcher](https://github.com/zilliztech/deep-searcher) |
| Source record ids | github_search_databases-db120c85c7a85c |
...
For a systems engineer, zilliztech/deep-searcher belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-19T06:04:16Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-db120c85c7a85c` from `github_search_databases` as `registry_expansion`
