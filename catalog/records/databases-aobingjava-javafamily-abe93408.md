...
<!-- canonical: https://github.com/AobingJava/JavaFamily -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AobingJava/JavaFamily](https://github.com/AobingJava/JavaFamily) |
| Source record ids | github_search_databases-e5888177abdbbf |
...
For a systems engineer, AobingJava/JavaFamily belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-03T12:37:27Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e5888177abdbbf` from `github_search_databases` as `registry_expansion`
