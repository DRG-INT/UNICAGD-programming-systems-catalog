...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Interop Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interop-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/vrld/imap4](https://luarocks.org/modules/vrld/imap4) |
| Source record ids | luarocks_root_manifest-9546b11ce5f623 |

## System Engineer Summary

Simple IMAP4 protocol wrapper.

## Operational Role

For a systems engineer, imap4 belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| arc4random | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-arc4random-bd6f0f4e.md) |
| bcrypt | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bcrypt-65ed75a6.md) |
| chaboksms | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-chaboksms-792ea10c.md) |
| cmark | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cmark-5bba1753.md) |
| coro-wrapper | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-coro-wrapper-58dfe1db.md) |
| cppjwt | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cppjwt-7a97f1c9.md) |
| elfutils | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-elfutils-d2a81a28.md) |
| getopt | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-getopt-2f7f40f3.md) |
