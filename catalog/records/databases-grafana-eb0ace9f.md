...
| Canonical URL | [https://github.com/grafana/grafana](https://github.com/grafana/grafana) |
| Source record ids | curated_database_systems-acd6e57bf860ab |

## System Engineer Summary

Dashboarding and observability UI with database and time-series data sources.

## Operational Role

For a systems engineer, Grafana belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v13.2.0 | 2026-08-18T12:48:13Z | [https://api.github.com/repos/grafana/grafana/releases/latest](https://api.github.com/repos/grafana/grafana/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/grafana/grafana/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-acd6e57bf860ab` from `curated_database_systems` as `registry_expansion`
