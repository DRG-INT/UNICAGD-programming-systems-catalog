...
<!-- canonical: https://github.com/STMicroelectronics/st-mems-machine-learning-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/STMicroelectronics/st-mems-machine-learning-core](https://github.com/STMicroelectronics/st-mems-machine-learning-core) |
| Source record ids | github_search_matlab-1273760e42c774 |

## System Engineer Summary

Examples, tutorials, and tools for the MLC, a dedicated core for machine learning processing
embedded in STMicroelectronics MEMS sensors.

## Operational Role

For a systems engineer, STMicroelectronics/st-mems-machine-learning-core belongs in the Matlab
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T13:13:01Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-1273760e42c774` from `github_search_matlab` as `registry_expansion`
