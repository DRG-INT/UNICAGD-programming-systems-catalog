...
<!-- canonical: https://gitlab.com/andreyorst/fenneldoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/andreyorst/fenneldoc](https://gitlab.com/andreyorst/fenneldoc) |
| Source record ids | gitlab_projects_api-154c6fcebd260c |

## System Engineer Summary

Generate documentation files for Fennel projects based on runtime info.

## Operational Role

For a systems engineer, andreyorst/fenneldoc belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-154c6fcebd260c` from `gitlab_projects_api` as `registry_expansion`
