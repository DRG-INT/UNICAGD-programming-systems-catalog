...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bastibl/gr-sched -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bastibl/gr-sched](https://github.com/bastibl/gr-sched) |
| Source record ids | github_search_satcom_satellites-20e54ee4f11fc2 |

## System Engineer Summary

GNU Radio Runtime Performance Measurement Tools

## Operational Role

For a systems engineer, bastibl/gr-sched belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-13T07:29:51Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-20e54ee4f11fc2` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bastibl/instant-gnuradio | Interpreter Runtime | [open](satcom-satellites-bastibl-instant-gnuradio-60127528.md) |
| FutureSDR/FutureSDR | Interpreter Runtime | [open](satcom-satellites-futuresdr-futuresdr-f779205c.md) |
| gnuradio/gnuradio4 | Interpreter Runtime | [open](satcom-satellites-gnuradio-gnuradio4-529b0c5b.md) |
| gnuradio/newsched | Interpreter Runtime | [open](satcom-satellites-gnuradio-newsched-67890692.md) |
| Mictronics/ais-simulator | Interpreter Runtime | [open](satcom-satellites-mictronics-ais-simulator-6fef2544.md) |
