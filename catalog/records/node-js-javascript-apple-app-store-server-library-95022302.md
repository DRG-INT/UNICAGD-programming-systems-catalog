...
<!-- canonical: https://www.npmjs.com/package/@apple/app-store-server-library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@apple/app-store-server-library](https://www.npmjs.com/package/@apple/app-store-server-library) |
| Source record ids | npm_registry-bcec5d9b3b65fb |
...
For a systems engineer, @apple/app-store-server-library belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-05-06T01:14:11.509Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-bcec5d9b3b65fb` from `npm_registry` as `registry_expansion`
