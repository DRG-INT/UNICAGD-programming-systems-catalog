...
<!-- canonical: https://github.com/douban/gobeansdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/douban/gobeansdb](https://github.com/douban/gobeansdb) |
| Source record ids | github_search_databases-89272d99169c1b |
...
For a systems engineer, douban/gobeansdb belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T03:02:19Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-89272d99169c1b` from `github_search_databases` as `registry_expansion`
