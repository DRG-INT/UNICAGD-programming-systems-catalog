...
| Source record ids | corpus-1f3094986550ff |

## System Engineer Summary

SonarJS is tracked as a static analyzer record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, SonarJS belongs in the Node.js/JavaScript inventory as part of defect
...
- `corpus-1f3094986550ff` from `master_json` as `static_analyzer`
