...
<!-- canonical: https://cran.r-project.org/web/packages/calba/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/calba/index.html](https://cran.r-project.org/web/packages/calba/index.html) |
| Source record ids | cran_packages_by_date-9100e362782608 |

## System Engineer Summary

Efficient Neighborhood Basal Area Metrics for Trees

## Operational Role

For a systems engineer, calba belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-24 09:30:02 UTC | [https://cran.r-project.org/web/packages/calba/DESCRIPTION](https://cran.r-project.org/web/packages/calba/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/calba/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9100e362782608` from `cran_packages_by_date` as `registry_expansion`
