...
<!-- canonical: https://github.com/shrugs/partyparrot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shrugs/partyparrot](https://github.com/shrugs/partyparrot) |
| Source record ids | github_search_icons_and_logos-be6983dea85cfb |
...
For a systems engineer, shrugs/partyparrot belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-16T20:33:30Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-be6983dea85cfb` from `github_search_icons_and_logos` as `registry_expansion`
