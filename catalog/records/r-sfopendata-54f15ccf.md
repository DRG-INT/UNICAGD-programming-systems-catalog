...
<!-- canonical: https://cran.r-project.org/web/packages/sfOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sfOpenData/index.html](https://cran.r-project.org/web/packages/sfOpenData/index.html) |
| Source record ids | cran_packages_by_date-7fd38496456260 |

## System Engineer Summary

A Lightweight Interface to San Francisco Open Data APIs

## Operational Role

For a systems engineer, sfOpenData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-08 12:30:11 UTC | [https://cran.r-project.org/web/packages/sfOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/sfOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sfOpenData/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-7fd38496456260` from `cran_packages_by_date` as `registry_expansion`
