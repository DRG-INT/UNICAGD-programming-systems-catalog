...
<!-- canonical: https://crates.io/crates/compression-codecs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/compression-codecs](https://crates.io/crates/compression-codecs) |
| Source record ids | crates_io-aa66e7c6c60ade |
...
For a systems engineer, compression-codecs belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.42 | 2026-09-14T11:16:11.274506Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | Other; {"key": "", "name": "", "url": ""}; https://servicestack.net/terms |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-14T12:26:01+00:00`.
...
- `crates_io-aa66e7c6c60ade` from `crates_io` as `registry_expansion`
