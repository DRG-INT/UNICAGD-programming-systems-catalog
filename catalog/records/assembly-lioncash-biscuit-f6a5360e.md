...
<!-- canonical: https://github.com/lioncash/biscuit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lioncash/biscuit](https://github.com/lioncash/biscuit) |
| Source record ids | github_search_assembly-6f7a47970d7c09 |
...
For a systems engineer, lioncash/biscuit belongs in the Assembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:57:45Z | gh search repos topic:riscv topic:assembly | gh_search_reports_activity_not_release_version |
...
| Evidence | Boost Software License 1.0; https://api.github.com/licenses/bsl-1.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:riscv topic:assembly", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-6f7a47970d7c09` from `github_search_assembly` as `registry_expansion`
...
| snowsnowsnows/EagleVM | Interpreter Runtime | [open](assembly-snowsnowsnows-eaglevm-dafb0015.md) |
