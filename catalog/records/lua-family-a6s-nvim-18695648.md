...
<!-- canonical: https://luarocks.org/modules/theautonoma/a6s.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/theautonoma/a6s.nvim](https://luarocks.org/modules/theautonoma/a6s.nvim) |
| Source record ids | luarocks_root_manifest-de9624a21c990d |

## System Engineer Summary

Neovim client for the A6s Code daemon

## Operational Role

For a systems engineer, a6s.nvim belongs in the Lua family inventory as part of ecosystem capability
...
| Evidence | Other; {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `luarocks_root_manifest-de9624a21c990d` from `luarocks_root_manifest` as `registry_expansion`
...
| alpha-nvim | Ide Editor Integration | [open](lua-family-alpha-nvim-abade896.md) |
