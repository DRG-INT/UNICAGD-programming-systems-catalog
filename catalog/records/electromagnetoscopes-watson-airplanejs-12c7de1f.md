...
<!-- canonical: https://github.com/watson/airplanejs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/watson/airplanejs](https://github.com/watson/airplanejs) |
| Source record ids | github_search_electromagnetoscopes-00e1a9d357d385 |

## System Engineer Summary

📡 ✈️ App that picks up ADS-B radio signals from airplanes and plots them in real time on a map in
your browser

## Operational Role

For a systems engineer, watson/airplanejs belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-28T13:57:11Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-00e1a9d357d385` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 30hours/blah2 | Datetime | [open](electromagnetoscopes-30hours-blah2-83893ba5.md) |
