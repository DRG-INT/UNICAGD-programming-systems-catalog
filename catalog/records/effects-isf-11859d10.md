...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://isf.video/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://isf.video/](https://isf.video/) |
| Source record ids | curated_language_routes-cbea7fdd662573 |

## System Engineer Summary

Interactive Shader Format for video generators and effects described with GLSL and JSON metadata.

## Operational Role

For a systems engineer, ISF belongs in the Effects inventory as part of ecosystem capability
...
- `curated_language_routes-cbea7fdd662573` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AcademySoftwareFoundation/MaterialX | Language Specification | [open](effects-academysoftwarefoundation-materialx-1f8662c9.md) |
| AcademySoftwareFoundation/openexr | Language Specification | [open](effects-academysoftwarefoundation-openexr-76904ac6.md) |
| AcademySoftwareFoundation/OpenPBR | Language Specification | [open](effects-academysoftwarefoundation-openpbr-358a3a7c.md) |
| AcademySoftwareFoundation/OpenShadingLanguage | Language Specification | [open](effects-academysoftwarefoundation-openshadinglanguage-cb82500e.md) |
| ALH477/ai-faust-dsp-effects | Language Specification | [open](effects-alh477-ai-faust-dsp-effects-6881f2de.md) |
| chaosprint/glicol | Language Specification | [open](effects-chaosprint-glicol-1504c11d.md) |
| firtoz/Unity3D-Plane-Clipping | Language Specification | [open](effects-firtoz-unity3d-plane-clipping-41a0b721.md) |
| grame-cncm/faust | Language Specification | [open](effects-grame-cncm-faust-4bda97dc.md) |
