...
| Canonical URL | [https://crates.io/crates/javascriptcore-rs-sys](https://crates.io/crates/javascriptcore-rs-sys) |
| Source record ids | crates_io-7ab949c412909d |
...
For a systems engineer, javascriptcore-rs-sys belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2023-10-26T05:57:39.577430Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-7ab949c412909d` from `crates_io` as `registry_expansion`
