...
<!-- canonical: https://github.com/teslamate-org/teslamate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/teslamate-org/teslamate](https://github.com/teslamate-org/teslamate) |
| Source record ids | github_search_maps-dfc4b844fa356d |
...
For a systems engineer, teslamate-org/teslamate belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:27:01Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-dfc4b844fa356d` from `github_search_maps` as `registry_expansion`
