...
<!-- canonical: https://github.com/opengeos/lidar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opengeos/lidar](https://github.com/opengeos/lidar) |
| Source record ids | github_search_radars-5e93345ccdeb2a |
...
For a systems engineer, opengeos/lidar belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T20:31:17Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-5e93345ccdeb2a` from `github_search_radars` as `registry_expansion`
...
| ChunmingHe/awesome-diffusion-models-in-low-level-vision | Filesystem Os | [open](radars-chunminghe-awesome-diffusion-models-in-low-level-vision-da2920b8.md) |
