...
<!-- canonical: https://hackage.haskell.org/package/TCache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/TCache](https://hackage.haskell.org/package/TCache) |
| Source record ids | hackage_top_downloads-ac17d776db5da9 |
...
For a systems engineer, TCache belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.3 | 2023-02-12T19:41:50Z | [https://hackage.haskell.org/package/TCache](https://hackage.haskell.org/package/TCache) |  |
| candidate | partial | 0.13.2 |  | [https://hackage.haskell.org/package/TCache](https://hackage.haskell.org/package/TCache) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/TCache` at `2026-09-03T00:34:45+00:00`.
...
- `hackage_top_downloads-ac17d776db5da9` from `hackage_top_downloads` as `registry_expansion`
