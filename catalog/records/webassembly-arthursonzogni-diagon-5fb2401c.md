...
<!-- canonical: https://github.com/ArthurSonzogni/Diagon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ArthurSonzogni/Diagon](https://github.com/ArthurSonzogni/Diagon) |
| Source record ids | github_search_webassembly-81453069168c1c |
...
For a systems engineer, ArthurSonzogni/Diagon belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-16T09:50:58Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-81453069168c1c` from `github_search_webassembly` as `registry_expansion`
...
| wasm-bindgen/wasm-bindgen | Precommit Ci Quality | [open](webassembly-wasm-bindgen-wasm-bindgen-bc554e09.md) |
