...
<!-- canonical: https://crates.io/crates/crossbeam-utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crossbeam-utils](https://crates.io/crates/crossbeam-utils) |
| Source record ids | crates_io-3e8ac1f17d985f |
...
For a systems engineer, crossbeam-utils belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.23 | 2026-09-05T17:46:14.665751Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-05T18:20:32+00:00`.
...
- `crates_io-3e8ac1f17d985f` from `crates_io` as `registry_expansion`
