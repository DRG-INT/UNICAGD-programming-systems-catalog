...
| Canonical URL | [https://crates.io/crates/rustc-literal-escaper](https://crates.io/crates/rustc-literal-escaper) |
| Source record ids | crates_io-c6b6fdfc7b17f3 |
...
For a systems engineer, rustc-literal-escaper belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.8 | 2026-06-23T15:19:53.978623Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-c6b6fdfc7b17f3` from `crates_io` as `registry_expansion`
