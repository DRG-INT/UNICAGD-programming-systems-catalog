...
<!-- canonical: https://github.com/pentaho/mondrian -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pentaho/mondrian](https://github.com/pentaho/mondrian) |
| Source record ids | github_search_databases-844b79a4b39add |

## System Engineer Summary

Mondrian is an Online Analytical Processing (OLAP) server that enables business users to analyze
large quantities of data in real-time.

## Operational Role

For a systems engineer, pentaho/mondrian belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T02:03:29Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-844b79a4b39add` from `github_search_databases` as `registry_expansion`
