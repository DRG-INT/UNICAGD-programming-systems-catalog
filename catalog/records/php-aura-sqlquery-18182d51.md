...
| Canonical URL | [https://packagist.org/packages/aura/sqlquery](https://packagist.org/packages/aura/sqlquery) |
| Source record ids | packagist_search-9fb735d66c5eb9 |

## System Engineer Summary

Object-oriented query builders for MySQL, Postgres, SQLite, and SQLServer; can be used with any
database connection library.

## Operational Role

For a systems engineer, aura/sqlquery belongs in the PHP inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2023-04-25T13:31:43+00:00 | [https://repo.packagist.org/p2/aura/sqlquery.json](https://repo.packagist.org/p2/aura/sqlquery.json) |  |
| preview | known | 3.0.0-alpha.1 | 2022-05-21T12:26:50+00:00 | [https://repo.packagist.org/p2/aura/sqlquery.json](https://repo.packagist.org/p2/aura/sqlquery.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/aura/sqlquery.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-9fb735d66c5eb9` from `packagist_search` as `registry_expansion`
