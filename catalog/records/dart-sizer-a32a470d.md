...
<!-- canonical: https://pub.dev/packages/sizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sizer](https://pub.dev/packages/sizer) |
| Source record ids | pub_dev-fcb29b6e2640f6 |
...
For a systems engineer, sizer belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.3 | 2025-08-26T09:28:34.030481Z | [https://pub.dev/api/packages/sizer](https://pub.dev/api/packages/sizer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sizer` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-fcb29b6e2640f6` from `pub_dev` as `registry_expansion`
