...
| Canonical URL | [https://luarocks.org/modules/xriss/gamecake-al](https://luarocks.org/modules/xriss/gamecake-al) |
| Source record ids | luarocks_root_manifest-ac86bbec2a761a |

## System Engineer Summary

gamecake-al is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, gamecake-al belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ac86bbec2a761a` from `luarocks_root_manifest` as `registry_expansion`
