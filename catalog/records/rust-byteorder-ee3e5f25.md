...
<!-- canonical: https://crates.io/crates/byteorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/byteorder](https://crates.io/crates/byteorder) |
| Source record ids | crates_io-19c78821993d4e |
...
For a systems engineer, byteorder belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2023-10-06T00:45:57.877036Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-07T00:31:27+00:00`.
...
- `crates_io-19c78821993d4e` from `crates_io` as `registry_expansion`
