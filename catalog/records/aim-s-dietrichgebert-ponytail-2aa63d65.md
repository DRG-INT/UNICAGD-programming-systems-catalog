...
| Canonical URL | [https://github.com/DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) |
| Source record ids | github_search_aims-34c6f340a54a1d |

## System Engineer Summary

Makes your AI agent think like the laziest senior dev in the room. The best code is the code you
never wrote.

## Operational Role

For a systems engineer, DietrichGebert/ponytail belongs in the "aim's" inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-07T21:44:01Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-34c6f340a54a1d` from `github_search_aims` as `registry_expansion`
