...
<!-- canonical: https://github.com/WebAssembly/relaxed-simd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/relaxed-simd](https://github.com/WebAssembly/relaxed-simd) |
| Source record ids | github_search_webassembly-31b1d66b074924 |
...
For a systems engineer, WebAssembly/relaxed-simd belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-19T16:46:40Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other |
...
- `github_search_webassembly-31b1d66b074924` from `github_search_webassembly` as `registry_expansion`
