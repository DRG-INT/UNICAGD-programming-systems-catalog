...
<!-- canonical: https://cran.r-project.org/web/packages/BKVerify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BKVerify/index.html](https://cran.r-project.org/web/packages/BKVerify/index.html) |
| Source record ids | cran_packages_by_date-fcdddb71927d36 |
...
For a systems engineer, BKVerify belongs in the R inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-02 11:40:08 UTC | [https://cran.r-project.org/web/packages/BKVerify/DESCRIPTION](https://cran.r-project.org/web/packages/BKVerify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BKVerify/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-fcdddb71927d36` from `cran_packages_by_date` as `registry_expansion`
...
| statfidelity | Security Sast | [open](r-statfidelity-488b5066.md) |
