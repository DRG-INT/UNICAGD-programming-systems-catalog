...
| Canonical URL | [https://github.com/cgohlke/roifile](https://github.com/cgohlke/roifile) |
| Source record ids | github_search_microscopy-142dc34aa5580a |
...
For a systems engineer, cgohlke/roifile belongs in the Microscopy inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2026.7.30 | 2026-07-30T01:49:20Z | [https://api.github.com/repos/cgohlke/roifile/releases/latest](https://api.github.com/repos/cgohlke/roifile/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cgohlke/roifile/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-142dc34aa5580a` from `github_search_microscopy` as `registry_expansion`
