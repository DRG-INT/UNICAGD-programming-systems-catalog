...
<!-- canonical: https://cran.r-project.org/web/packages/epoxy/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epoxy/index.html](https://cran.r-project.org/web/packages/epoxy/index.html) |
| Source record ids | cran_packages_by_date-7c6427163a52ac |
...
For a systems engineer, epoxy belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-31 18:40:13 UTC | [https://cran.r-project.org/web/packages/epoxy/DESCRIPTION](https://cran.r-project.org/web/packages/epoxy/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epoxy/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7c6427163a52ac` from `cran_packages_by_date` as `registry_expansion`
