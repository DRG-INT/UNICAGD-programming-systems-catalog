...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/1c-format/](https://pypi.org/project/1c-format/) |
| Source record ids | pypi_simple-f02c03f89e5832 |

## System Engineer Summary

1c-format is tracked as a formatter record in the Python branch. The source did not provide a long
...
For a systems engineer, 1c-format belongs in the Python inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2021-04-07T21:00:03.169351Z | [https://pypi.org/pypi/1c-format/json](https://pypi.org/pypi/1c-format/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/1c-format/json` at `2026-09-01T03:20:32+00:00`.
...
- `pypi_simple-f02c03f89e5832` from `pypi_simple` as `registry_expansion`
...
| black | Formatter | [open](python-black-c618db75.md) |
| isort | Formatter | [open](python-isort-988c50fa.md) |
