...
<!-- canonical: https://github.com/papermark/papermark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/papermark/papermark](https://github.com/papermark/papermark) |
| Source record ids | github_search_databases-37257e5759077d |

## System Engineer Summary

Papermark is the open-source DocSend alternative and secure data rooms with built-in analytics and
custom domains.

## Operational Role

For a systems engineer, papermark/papermark belongs in the Databases inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T15:58:25Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | zlib License; https://api.github.com/licenses/zlib; Other |
...
- `github_search_databases-37257e5759077d` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Azure/AzureDataLake | Documentation | [open](databases-azure-azuredatalake-03fa006c.md) |
