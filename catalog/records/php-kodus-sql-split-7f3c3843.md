...
<!-- canonical: https://packagist.org/packages/kodus/sql-split -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kodus/sql-split](https://packagist.org/packages/kodus/sql-split) |
| Source record ids | packagist_search-5830d390c510c5 |
...
For a systems engineer, kodus/sql-split belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-5830d390c510c5` from `packagist_search` as `registry_expansion`
