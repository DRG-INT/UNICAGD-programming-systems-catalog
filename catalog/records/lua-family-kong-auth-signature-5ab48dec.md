...
| Canonical URL | [https://luarocks.org/modules/thanhdongnguyen/kong-auth-signature](https://luarocks.org/modules/thanhdongnguyen/kong-auth-signature) |
| Source record ids | luarocks_root_manifest-d98bc204e6ca23 |
...
For a systems engineer, kong-auth-signature belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d98bc204e6ca23` from `luarocks_root_manifest` as `registry_expansion`
