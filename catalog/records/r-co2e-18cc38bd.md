...
<!-- canonical: https://cran.r-project.org/web/packages/co2e/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/co2e/index.html](https://cran.r-project.org/web/packages/co2e/index.html) |
| Source record ids | cran_packages_by_date-7f60b4862c4317 |

## System Engineer Summary

Global Warming Potential Lookups and CO2-Equivalent Conversion

## Operational Role

For a systems engineer, co2e belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 14:10:02 UTC | [https://cran.r-project.org/web/packages/co2e/DESCRIPTION](https://cran.r-project.org/web/packages/co2e/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/co2e/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-7f60b4862c4317` from `cran_packages_by_date` as `registry_expansion`
