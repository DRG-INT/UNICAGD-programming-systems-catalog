...
<!-- canonical: https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/index.html](https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/index.html) |
| Source record ids | cran_packages_by_date-99691bf2d05614 |
...
For a systems engineer, NeutroBasicDesignsAnalysis belongs in the R inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-08-09 08:40:13 UTC | [https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/DESCRIPTION](https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NeutroBasicDesignsAnalysis/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-99691bf2d05614` from `cran_packages_by_date` as `registry_expansion`
