...
<!-- canonical: https://pub.dev/packages/macos_window_utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/macos_window_utils](https://pub.dev/packages/macos_window_utils) |
| Source record ids | pub_dev-45db70a92a8304 |

## System Engineer Summary

macos_window_utils is a Flutter package that provides a set of methods for modifying the NSWindow of
a Flutter application on macOS.

## Operational Role

For a systems engineer, macos_window_utils belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.1 | 2026-01-05T13:04:10.582842Z | [https://pub.dev/api/packages/macos_window_utils](https://pub.dev/api/packages/macos_window_utils) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/macos_window_utils` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-45db70a92a8304` from `pub_dev` as `registry_expansion`
