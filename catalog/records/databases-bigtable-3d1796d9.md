...
<!-- canonical: https://cloud.google.com/bigtable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cloud.google.com/bigtable](https://cloud.google.com/bigtable) |
| Source record ids | curated_database_systems-f8a1feadc58ffb |

## System Engineer Summary

Managed wide-column database service.

## Operational Role

For a systems engineer, Bigtable belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-f8a1feadc58ffb` from `curated_database_systems` as `registry_expansion`
