...
<!-- canonical: https://github.com/EutropicAI/Final2x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EutropicAI/Final2x](https://github.com/EutropicAI/Final2x) |
| Source record ids | github_search_photography-9b58ea8887b123 |
...
For a systems engineer, EutropicAI/Final2x belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T18:16:39Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | ISC License; https://api.github.com/licenses/isc; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_photography-9b58ea8887b123` from `github_search_photography` as `registry_expansion`
