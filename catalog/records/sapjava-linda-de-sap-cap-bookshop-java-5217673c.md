# Linda-DE/sap-cap-bookshop-java
...
<!-- canonical: https://github.com/Linda-DE/sap-cap-bookshop-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Linda-DE/sap-cap-bookshop-java](https://github.com/Linda-DE/sap-cap-bookshop-java) |
| Source record ids | github_search_sapjava-e0a28c91c1150f |

## System Engineer Summary

Linda-DE/sap-cap-bookshop-java is tracked as a tutorial book styleguide record in the SAPJava
...
For a systems engineer, Linda-DE/sap-cap-bookshop-java belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T16:33:39Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT No Attribution; https://api.github.com/licenses/mit-0; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_sapjava-e0a28c91c1150f` from `github_search_sapjava` as `registry_expansion`
