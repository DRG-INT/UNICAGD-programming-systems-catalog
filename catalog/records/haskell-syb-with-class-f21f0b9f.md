...
<!-- canonical: https://hackage.haskell.org/package/syb-with-class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/syb-with-class](https://hackage.haskell.org/package/syb-with-class) |
| Source record ids | hackage_top_downloads-3ca536e2c9f7be |
...
For a systems engineer, syb-with-class belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1.14 | 2022-04-20T19:21:15Z | [https://hackage.haskell.org/package/syb-with-class](https://hackage.haskell.org/package/syb-with-class) |  |
| candidate | partial | 0.6.1.10 |  | [https://hackage.haskell.org/package/syb-with-class](https://hackage.haskell.org/package/syb-with-class) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/syb-with-class` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-3ca536e2c9f7be` from `hackage_top_downloads` as `registry_expansion`
