...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/qr_code_scanner_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/qr_code_scanner_plus](https://pub.dev/packages/qr_code_scanner_plus) |
| Source record ids | pub_dev-73601e8aecbb7d |

## System Engineer Summary

QR code scanner that can be embedded inside flutter. It uses zxing in Android and AVFoundation in
iOS.

## Operational Role

For a systems engineer, qr_code_scanner_plus belongs in the Dart inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-09-15T10:55:55.095601Z | [https://pub.dev/api/packages/qr_code_scanner_plus](https://pub.dev/api/packages/qr_code_scanner_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/qr_code_scanner_plus` at `2026-09-15T22:19:05+00:00`.
...
- `pub_dev-73601e8aecbb7d` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ai_barcode_scanner | Static Analyzer | [open](dart-ai-barcode-scanner-b66d3773.md) |
| barcode_scan2 | Static Analyzer | [open](dart-barcode-scan2-37eae369.md) |
| cunning_document_scanner | Static Analyzer | [open](dart-cunning-document-scanner-b98260f4.md) |
| flutter_zxing | Static Analyzer | [open](dart-flutter-zxing-a58545cd.md) |
| mobile_scanner | Static Analyzer | [open](dart-mobile-scanner-cd355124.md) |
| string_scanner | Static Analyzer | [open](dart-string-scanner-05017d50.md) |
