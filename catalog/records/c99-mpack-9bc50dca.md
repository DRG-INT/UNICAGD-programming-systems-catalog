...
| Source record ids | corpus-dc5cf74d926521 |

## System Engineer Summary

mpack is tracked as a serialization record in the C99 branch. The source did not provide a long
...
For a systems engineer, mpack belongs in the C99 inventory as part of wire formats, persistence,
...
- `corpus-dc5cf74d926521` from `master_json` as `serialization`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cJSON | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-cjson-2767cc8d.md) |
| jansson | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-jansson-2d5cb140.md) |
| json-c | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-json-c-e2e5c30e.md) |
| libyaml | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libyaml-9d81b324.md) |
| protobuf-c | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-protobuf-c-e9772a26.md) |
| yyjson | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-yyjson-f06a9a91.md) |
