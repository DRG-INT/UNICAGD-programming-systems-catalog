...
<!-- canonical: https://github.com/epidrome/cover-card -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/epidrome/cover-card](https://github.com/epidrome/cover-card) |
| Source record ids | github_search_icons_and_logos-a4f6a4cf8f59ca |

## System Engineer Summary

:necktie: Online business card with a minimal landing page theme for any social media or online
presence account: fork, edit, and go!

## Operational Role

For a systems engineer, epidrome/cover-card belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-05T09:46:00Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-a4f6a4cf8f59ca` from `github_search_icons_and_logos` as `registry_expansion`
