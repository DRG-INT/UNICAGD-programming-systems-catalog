...
<!-- canonical: https://gitlab.com/xavki/tutorials-kubernetes-v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/xavki/tutorials-kubernetes-v2](https://gitlab.com/xavki/tutorials-kubernetes-v2) |
| Source record ids | gitlab_projects_api-4ff22db30a3e93 |

## System Engineer Summary

Modern Kubernetes course: clusters, kubectl, pods, deployments, services, configmaps, volumes,
ingress. Updated edition. Xavki tutorials in French.

## Operational Role

For a systems engineer, xavki/tutorials-kubernetes-v2 belongs in the Repository Workplaces inventory
...
- `gitlab_projects_api-4ff22db30a3e93` from `gitlab_projects_api` as `registry_expansion`
