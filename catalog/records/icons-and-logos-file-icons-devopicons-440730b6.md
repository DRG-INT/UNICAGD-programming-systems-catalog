...
<!-- canonical: https://github.com/file-icons/DevOpicons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/file-icons/DevOpicons](https://github.com/file-icons/DevOpicons) |
| Source record ids | github_search_icons_and_logos-c4b05015896a5d |
...
For a systems engineer, file-icons/DevOpicons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-18T17:59:15Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-c4b05015896a5d` from `github_search_icons_and_logos` as `registry_expansion`
