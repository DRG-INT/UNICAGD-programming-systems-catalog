...
<!-- canonical: https://pub.dev/packages/device_preview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/device_preview](https://pub.dev/packages/device_preview) |
| Source record ids | pub_dev-39c977c782fe59 |

## System Engineer Summary

A custom WidgetsBinding that simulates device characteristics at the engine-abstraction level. No
in-app UI — driven programmatically and by a DevTools extension.

## Operational Role

For a systems engineer, device_preview belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-25T13:49:17.235487Z | [https://pub.dev/api/packages/device_preview](https://pub.dev/api/packages/device_preview) |  |
| preview | known | 3.0.0-prerelease7 | 2026-08-21T21:24:25.616058Z | [https://pub.dev/api/packages/device_preview](https://pub.dev/api/packages/device_preview) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/device_preview` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-39c977c782fe59` from `pub_dev` as `registry_expansion`
