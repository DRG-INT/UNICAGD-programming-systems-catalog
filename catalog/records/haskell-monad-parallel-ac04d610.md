...
<!-- canonical: https://hackage.haskell.org/package/monad-parallel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/monad-parallel](https://hackage.haskell.org/package/monad-parallel) |
| Source record ids | hackage_top_downloads-ee27957ba4c687 |
...
For a systems engineer, monad-parallel belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0.1 | 2026-01-11T13:39:41Z | [https://hackage.haskell.org/package/monad-parallel](https://hackage.haskell.org/package/monad-parallel) |  |
| candidate | partial | 0.7.1.3 |  | [https://hackage.haskell.org/package/monad-parallel](https://hackage.haskell.org/package/monad-parallel) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/monad-parallel` at `2026-09-08T00:34:46+00:00`.
...
- `hackage_top_downloads-ee27957ba4c687` from `hackage_top_downloads` as `registry_expansion`
...
| thread-utils-context | Concurrency Parallelism | [open](haskell-thread-utils-context-4cff1f57.md) |
