...
<!-- canonical: https://pypi.org/project/acryl-datahub-hcc-patched/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acryl-datahub-hcc-patched/](https://pypi.org/project/acryl-datahub-hcc-patched/) |
| Source record ids | pypi_simple-e373efc5830c0f |
...
For a systems engineer, acryl-datahub-hcc-patched belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0.9.post2 | 2026-04-15T04:46:49.551818Z | [https://pypi.org/pypi/acryl-datahub-hcc-patched/json](https://pypi.org/pypi/acryl-datahub-hcc-patched/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acryl-datahub-hcc-patched/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-e373efc5830c0f` from `pypi_simple` as `registry_expansion`
