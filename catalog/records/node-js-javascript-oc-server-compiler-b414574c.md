...
<!-- canonical: https://www.npmjs.com/package/oc-server-compiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/oc-server-compiler](https://www.npmjs.com/package/oc-server-compiler) |
| Source record ids | npm_registry-80a43c93ecbff5 |

## System Engineer Summary

oc-server-compiler is tracked as a compiler record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, oc-server-compiler belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2025-02-05T09:07:16.986Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-80a43c93ecbff5` from `npm_registry` as `registry_expansion`
