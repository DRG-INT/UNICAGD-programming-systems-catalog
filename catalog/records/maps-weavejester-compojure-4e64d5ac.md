...
<!-- canonical: https://github.com/weavejester/compojure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/weavejester/compojure](https://github.com/weavejester/compojure) |
| Source record ids | github_search_maps-40ec209693b4ba |
...
For a systems engineer, weavejester/compojure belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-15T14:44:43Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | (UPL-1.0 OR Apache-2.0); Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0 |
...
- `github_search_maps-40ec209693b4ba` from `github_search_maps` as `registry_expansion`
