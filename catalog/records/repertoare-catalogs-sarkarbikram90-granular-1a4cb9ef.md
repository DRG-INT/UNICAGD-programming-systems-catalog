...
<!-- canonical: https://github.com/sarkarbikram90/Granular -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sarkarbikram90/Granular](https://github.com/sarkarbikram90/Granular) |
| Source record ids | github_search_repertoare_catalogs-7dfce00eb9336b |

## System Engineer Summary

AI-Native Engineering Control Plane (ECP) — Unifying service catalog, engineering graph, change risk
scoring, causal incident correlation, and autonomous AI agents.

## Operational Role

For a systems engineer, sarkarbikram90/Granular belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T09:23:14Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-7dfce00eb9336b` from `github_search_repertoare_catalogs` as `registry_expansion`
