...
<!-- canonical: https://github.com/neural-maze/ava-whatsapp-agent-course -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neural-maze/ava-whatsapp-agent-course](https://github.com/neural-maze/ava-whatsapp-agent-course) |
| Source record ids | github_search_databases-5065e520314b54 |
...
For a systems engineer, neural-maze/ava-whatsapp-agent-course belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-20T19:12:20Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5065e520314b54` from `github_search_databases` as `registry_expansion`
