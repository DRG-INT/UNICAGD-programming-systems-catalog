...
<!-- canonical: https://github.com/sudoariel/dsp-audio-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sudoariel/dsp-audio-effects](https://github.com/sudoariel/dsp-audio-effects) |
| Source record ids | github_search_effects-46a3096e0f364e |

## System Engineer Summary

Digital Signal Processing techniques applied in audio signals. Delay, chorus, flanger, tremolo,
overdrive and distortion effects systems implemented using Python.

## Operational Role

For a systems engineer, sudoariel/dsp-audio-effects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-13T18:43:55Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
| Evidence | LGPL-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_effects-46a3096e0f364e` from `github_search_effects` as `registry_expansion`
