...
<!-- canonical: https://hackage.haskell.org/package/email-validate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/email-validate](https://hackage.haskell.org/package/email-validate) |
| Source record ids | hackage_top_downloads-73b00445db0b3e |
...
For a systems engineer, email-validate belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2.21 | 2024-09-21T20:46:10Z | [https://hackage.haskell.org/package/email-validate](https://hackage.haskell.org/package/email-validate) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/email-validate` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-73b00445db0b3e` from `hackage_top_downloads` as `registry_expansion`
...
| polysemy-time | Datetime | [open](haskell-polysemy-time-9dc77c4a.md) |
