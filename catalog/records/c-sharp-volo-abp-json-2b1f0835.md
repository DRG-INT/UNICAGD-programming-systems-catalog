...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Json](https://www.nuget.org/packages/Volo.Abp.Json) |
| Source record ids | nuget_search-60a65cb0704db1 |

## System Engineer Summary

Volo.Abp.Json is tracked as a project scaffolding record in the C-Sharp branch. The source did not
...
For a systems engineer, Volo.Abp.Json belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:23.79+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:44.177+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json/index.json) |  |
...
| Evidence | LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Json/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-60a65cb0704db1` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Volo.Abp.Http | Project Scaffolding | [open](c-sharp-volo-abp-http-0026b564.md) |
| Volo.Abp.Http.Abstractions | Project Scaffolding | [open](c-sharp-volo-abp-http-abstractions-8101fd1f.md) |
| Volo.Abp.Http.Client | Project Scaffolding | [open](c-sharp-volo-abp-http-client-66a6f386.md) |
| Volo.Abp.Json.Abstractions | Project Scaffolding | [open](c-sharp-volo-abp-json-abstractions-617e18e6.md) |
| Volo.Abp.Json.SystemTextJson | Project Scaffolding | [open](c-sharp-volo-abp-json-systemtextjson-3c4368d8.md) |
