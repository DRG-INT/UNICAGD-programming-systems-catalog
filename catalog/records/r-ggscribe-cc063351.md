...
<!-- canonical: https://cran.r-project.org/web/packages/ggscribe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggscribe/index.html](https://cran.r-project.org/web/packages/ggscribe/index.html) |
| Source record ids | cran_packages_by_date-27c3304f553b3d |
...
For a systems engineer, ggscribe belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-11 06:20:02 UTC | [https://cran.r-project.org/web/packages/ggscribe/DESCRIPTION](https://cran.r-project.org/web/packages/ggscribe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggscribe/DESCRIPTION` at `2026-09-11T06:25:06+00:00`.
...
- `cran_packages_by_date-27c3304f553b3d` from `cran_packages_by_date` as `registry_expansion`
