...
<!-- canonical: https://github.com/wasmerio/php-ext-wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmerio/php-ext-wasm](https://github.com/wasmerio/php-ext-wasm) |
| Source record ids | awesome_list-8a36bd4372afa3 |

## System Engineer Summary

Wasmer for PHP is tracked as a library record in the WebAssembly branch. The source did not provide
...
For a systems engineer, Wasmer for PHP belongs in the WebAssembly inventory as part of ecosystem
...
- `awesome_list-8a36bd4372afa3` from `awesome_list` as `registry_expansion`
