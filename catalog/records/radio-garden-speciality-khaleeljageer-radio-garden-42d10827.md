...
<!-- canonical: https://github.com/khaleeljageer/radio_garden -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/khaleeljageer/radio_garden](https://github.com/khaleeljageer/radio_garden) |
| Source record ids | github_search_radio_garden_speciality-b13d5176e7e7b8 |

## System Engineer Summary

Python script to get radio list details from data.

## Operational Role

For a systems engineer, khaleeljageer/radio_garden belongs in the Radio Garden Speciality inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-26T00:00:14Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-b13d5176e7e7b8` from `github_search_radio_garden_speciality` as `registry_expansion`
