...
<!-- canonical: https://cran.r-project.org/web/packages/RDHonest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RDHonest/index.html](https://cran.r-project.org/web/packages/RDHonest/index.html) |
| Source record ids | cran_packages_by_date-e5d77809216b55 |
...
For a systems engineer, RDHonest belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-15 06:30:10 UTC | [https://cran.r-project.org/web/packages/RDHonest/DESCRIPTION](https://cran.r-project.org/web/packages/RDHonest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RDHonest/DESCRIPTION` at `2026-09-15T08:23:18+00:00`.
...
- `cran_packages_by_date-e5d77809216b55` from `cran_packages_by_date` as `registry_expansion`
