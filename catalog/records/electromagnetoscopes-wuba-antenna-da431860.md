...
<!-- canonical: https://github.com/wuba/Antenna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wuba/Antenna](https://github.com/wuba/Antenna) |
| Source record ids | github_search_electromagnetoscopes-cbe6b06efe81cf |

## System Engineer Summary

Antenna是58同城安全团队打造的一款辅助安全从业人员验证网络中多种漏洞是否存在以及可利用性的工具。其基于带外应用安全测试(OAST)通过任务的形式，将不同漏洞场景检测能力通过插件的形式进行集合，
通过与目标进行out-bind的数据通信方式进行辅助检测。

## Operational Role

For a systems engineer, wuba/Antenna belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-06T10:04:37Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-cbe6b06efe81cf` from `github_search_electromagnetoscopes` as `registry_expansion`
