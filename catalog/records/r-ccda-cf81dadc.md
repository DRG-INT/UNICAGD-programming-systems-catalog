...
<!-- canonical: https://cran.r-project.org/web/packages/ccda/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ccda/index.html](https://cran.r-project.org/web/packages/ccda/index.html) |
| Source record ids | cran_packages_by_date-e9c55f4087ef91 |
...
For a systems engineer, ccda belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-09-09 14:10:19 UTC | [https://cran.r-project.org/web/packages/ccda/DESCRIPTION](https://cran.r-project.org/web/packages/ccda/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ccda/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-e9c55f4087ef91` from `cran_packages_by_date` as `registry_expansion`
