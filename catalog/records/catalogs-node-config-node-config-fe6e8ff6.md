...
<!-- canonical: https://github.com/node-config/node-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/node-config/node-config](https://github.com/node-config/node-config) |
| Source record ids | github_search_catalogs-842191fdf1916c |
...
For a systems engineer, node-config/node-config belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T23:45:21Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-842191fdf1916c` from `github_search_catalogs` as `registry_expansion`
