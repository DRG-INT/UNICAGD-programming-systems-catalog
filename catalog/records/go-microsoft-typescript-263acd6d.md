...
<!-- canonical: https://github.com/microsoft/TypeScript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/TypeScript](https://github.com/microsoft/TypeScript) |
| Source record ids | github_search_go-90515c921698b7 |
...
For a systems engineer, microsoft/TypeScript belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T17:57:58Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-90515c921698b7` from `github_search_go` as `registry_expansion`
