...
<!-- canonical: https://crates.io/crates/exr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/exr](https://crates.io/crates/exr) |
| Source record ids | crates_io-acacfab29fba31 |
...
For a systems engineer, exr belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.74.2 | 2026-07-10T22:56:25.796302Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-acacfab29fba31` from `crates_io` as `registry_expansion`
