...
<!-- canonical: https://cran.r-project.org/web/packages/pharmr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pharmr/index.html](https://cran.r-project.org/web/packages/pharmr/index.html) |
| Source record ids | cran_packages_by_date-d81111c5f1812f |
...
For a systems engineer, pharmr belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-31 18:30:02 UTC | [https://cran.r-project.org/web/packages/pharmr/DESCRIPTION](https://cran.r-project.org/web/packages/pharmr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pharmr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d81111c5f1812f` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| actisensorlog | Logging Observability | [open](r-actisensorlog-39c7fd58.md) |
...
| dataRetrieval | Logging Observability | [open](r-dataretrieval-6237bbef.md) |
