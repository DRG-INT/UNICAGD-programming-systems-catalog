...
<!-- canonical: https://github.com/AlexanderGrom/go-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlexanderGrom/go-patterns](https://github.com/AlexanderGrom/go-patterns) |
| Source record ids | github_search_pattern_language-51f6ebdebf394e |
...
For a systems engineer, AlexanderGrom/go-patterns belongs in the Pattern language inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-15T17:42:30Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-51f6ebdebf394e` from `github_search_pattern_language` as `registry_expansion`
