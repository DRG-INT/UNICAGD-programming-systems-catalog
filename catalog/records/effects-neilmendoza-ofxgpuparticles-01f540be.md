...
<!-- canonical: https://github.com/neilmendoza/ofxGpuParticles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neilmendoza/ofxGpuParticles](https://github.com/neilmendoza/ofxGpuParticles) |
| Source record ids | github_search_effects-e499046cd01d26 |
...
For a systems engineer, neilmendoza/ofxGpuParticles belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-18T17:02:35Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e499046cd01d26` from `github_search_effects` as `registry_expansion`
