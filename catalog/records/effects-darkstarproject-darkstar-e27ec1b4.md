...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DarkstarProject/darkstar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DarkstarProject/darkstar](https://github.com/DarkstarProject/darkstar) |
| Source record ids | github_search_effects-f21d3d246c3933 |
...
For a systems engineer, DarkstarProject/darkstar belongs in the Effects inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-26T03:14:52Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f21d3d246c3933` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| FORARTfe/ayemux | Web Framework | [open](effects-forartfe-ayemux-7c57b163.md) |
| white-shiro-bai/ghost_sa | Web Framework | [open](effects-white-shiro-bai-ghost-sa-7fb9c363.md) |
