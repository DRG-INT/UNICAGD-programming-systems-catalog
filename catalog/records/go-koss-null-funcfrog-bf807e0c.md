...
<!-- canonical: https://github.com/koss-null/FuncFrog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/koss-null/FuncFrog](https://github.com/koss-null/FuncFrog) |
| Source record ids | github_search_go-f1eec01c43288d |

## System Engineer Summary

Stream api (kind of) implementation for go, other useful functions and packages to use go in a
functional way

## Operational Role

For a systems engineer, koss-null/FuncFrog belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-25T18:37:25Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-f1eec01c43288d` from `github_search_go` as `registry_expansion`
