...
<!-- canonical: https://github.com/webrtcHacks/adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/webrtcHacks/adapter](https://github.com/webrtcHacks/adapter) |
| Source record ids | github_search_video-4b48feedfba24d |
...
For a systems engineer, webrtcHacks/adapter belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T10:09:15Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-4b48feedfba24d` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adaltas/node-csv | Testing Framework | [open](video-adaltas-node-csv-399fce31.md) |
