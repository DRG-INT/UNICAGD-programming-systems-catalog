...
<!-- canonical: https://luarocks.org/modules/luamod/ansify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luamod/ansify](https://luarocks.org/modules/luamod/ansify) |
| Source record ids | luarocks_root_manifest-c889ff203ae6a2 |

## System Engineer Summary

ANSI styling and text helpers

## Operational Role

For a systems engineer, ansify belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-c889ff203ae6a2` from `luarocks_root_manifest` as `registry_expansion`
