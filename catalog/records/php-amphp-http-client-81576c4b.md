...
| Canonical URL | [https://packagist.org/packages/amphp/http-client](https://packagist.org/packages/amphp/http-client) |
| Source record ids | packagist_search-5148d72bba75b8 |

## System Engineer Summary

An advanced async HTTP client library for PHP, enabling efficient, non-blocking, and concurrent
requests and responses.

## Operational Role

For a systems engineer, amphp/http-client belongs in the PHP inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.3.6 | 2026-05-16T18:20:20+00:00 | [https://repo.packagist.org/p2/amphp/http-client.json](https://repo.packagist.org/p2/amphp/http-client.json) |  |
| preview | known | v5.0.0-beta.17 | 2023-09-05T21:00:53+00:00 | [https://repo.packagist.org/p2/amphp/http-client.json](https://repo.packagist.org/p2/amphp/http-client.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/amphp/http-client.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-5148d72bba75b8` from `packagist_search` as `registry_expansion`
