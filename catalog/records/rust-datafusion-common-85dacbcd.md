...
| Canonical URL | [https://crates.io/crates/datafusion-common](https://crates.io/crates/datafusion-common) |
| Source record ids | crates_io-587c1e148afc65 |
...
For a systems engineer, datafusion-common belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 55.0.0 | 2026-08-18T21:03:48.503941Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-587c1e148afc65` from `crates_io` as `registry_expansion`
