...
<!-- canonical: https://github.com/ZhgChgLi/ZMarkupParser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZhgChgLi/ZMarkupParser](https://github.com/ZhgChgLi/ZMarkupParser) |
| Source record ids | github_search_swift-1340d380ef19d2 |

## System Engineer Summary

ZMarkupParser is a pure-Swift library that helps you convert HTML strings into NSAttributedString
with customized styles and tags.

## Operational Role

For a systems engineer, ZhgChgLi/ZMarkupParser belongs in the Swift inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T11:54:08Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-1340d380ef19d2` from `github_search_swift` as `registry_expansion`
