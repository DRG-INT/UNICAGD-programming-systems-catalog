...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/io](https://pub.dev/packages/io) |
| Source record ids | pub_dev-c6559a56f26f42 |

## System Engineer Summary

Utilities for the Dart VM Runtime including support for ANSI colors, file copying, and standard exit
code values.

## Operational Role

For a systems engineer, io belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-28T20:42:26.818695Z | [https://pub.dev/api/packages/io](https://pub.dev/api/packages/io) |  |
| preview | known | 0.1.0-git | 2014-01-31T16:10:59.148830Z | [https://pub.dev/api/packages/io](https://pub.dev/api/packages/io) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/io` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-c6559a56f26f42` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| barcode_widget | Language Specification | [open](dart-barcode-widget-99e20af5.md) |
| dart_console | Language Specification | [open](dart-dart-console-3d82288d.md) |
| extension | Language Specification | [open](dart-extension-a7f99b0c.md) |
| haptic_feedback | Language Specification | [open](dart-haptic-feedback-8728a0cb.md) |
| logging | Language Specification | [open](dart-logging-d435eb63.md) |
| macos_ui | Language Specification | [open](dart-macos-ui-eb5ff8b4.md) |
| source_span | Language Specification | [open](dart-source-span-6c147716.md) |
| yaml | Language Specification | [open](dart-yaml-c12cbf97.md) |
