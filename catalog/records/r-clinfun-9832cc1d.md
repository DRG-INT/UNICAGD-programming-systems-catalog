...
<!-- canonical: https://cran.r-project.org/web/packages/clinfun/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clinfun/index.html](https://cran.r-project.org/web/packages/clinfun/index.html) |
| Source record ids | cran_packages_by_date-d5f8f20e14f3a4 |
...
For a systems engineer, clinfun belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.6 | 2026-08-29 12:30:12 UTC | [https://cran.r-project.org/web/packages/clinfun/DESCRIPTION](https://cran.r-project.org/web/packages/clinfun/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clinfun/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d5f8f20e14f3a4` from `cran_packages_by_date` as `registry_expansion`
