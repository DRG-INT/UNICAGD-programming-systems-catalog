...
| Source record ids | curated_database_systems-f441f69321e145 |

## System Engineer Summary

Distributed SQL database with serializable transactions and horizontal scaling.

## Operational Role

For a systems engineer, CockroachDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-f441f69321e145` from `curated_database_systems` as `registry_expansion`
