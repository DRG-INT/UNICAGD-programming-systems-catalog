# Zerek-Cheng/Simple-Assets-Platform

## Navigation

[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Zerek-Cheng/Simple-Assets-Platform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zerek-Cheng/Simple-Assets-Platform](https://github.com/Zerek-Cheng/Simple-Assets-Platform) |
| Source record ids | github_search_assets-82af7cac9f77cb |

## System Engineer Summary

简单图床托管系统/静态资源托管系统 - A simple assets platform powered by spring (spring boot / spring security) & vue
2 & element ui & Casdoor(For Authenication)

## Operational Role

For a systems engineer, Zerek-Cheng/Simple-Assets-Platform belongs in the Assets inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-13T17:21:10Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-82af7cac9f77cb` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jonrau1/ElectricEye | Security Sast | [open](assets-jonrau1-electriceye-8cc6fea7.md) |
| simonphillips-1010/jimi | Security Sast | [open](assets-simonphillips-1010-jimi-138dd6d5.md) |
