...
<!-- canonical: https://pub.dev/packages/country_flags -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/country_flags](https://pub.dev/packages/country_flags) |
| Source record ids | pub_dev-da25849d269a8f |
...
For a systems engineer, country_flags belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.2 | 2026-01-26T05:57:46.211625Z | [https://pub.dev/api/packages/country_flags](https://pub.dev/api/packages/country_flags) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/country_flags` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-da25849d269a8f` from `pub_dev` as `registry_expansion`
