...
<!-- canonical: https://luarocks.org/modules/wprayudo/bhttp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wprayudo/bhttp](https://luarocks.org/modules/wprayudo/bhttp) |
| Source record ids | luarocks_root_manifest-fe8218509151fd |
...
For a systems engineer, bhttp belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-fe8218509151fd` from `luarocks_root_manifest` as `registry_expansion`
