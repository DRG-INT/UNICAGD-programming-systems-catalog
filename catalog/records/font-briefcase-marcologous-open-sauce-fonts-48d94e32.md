...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_font_briefcase-c754664faad2e1 |
...
For a systems engineer, marcologous/Open-Sauce-Fonts belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T21:22:36Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-c754664faad2e1` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| braver/programmingfonts | Testing Framework | [open](font-briefcase-braver-programmingfonts-8e2ed3d9.md) |
| PaulleDemon/font-tester-chrome | Testing Framework | [open](font-briefcase-paulledemon-font-tester-chrome-7dc25451.md) |
