...
<!-- canonical: https://cran.r-project.org/web/packages/hdf5r/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hdf5r/index.html](https://cran.r-project.org/web/packages/hdf5r/index.html) |
| Source record ids | cran_packages_by_date-6394aea1f52471 |
...
For a systems engineer, hdf5r belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.15 | 2026-09-07 05:30:02 UTC | [https://cran.r-project.org/web/packages/hdf5r/DESCRIPTION](https://cran.r-project.org/web/packages/hdf5r/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hdf5r/DESCRIPTION` at `2026-09-07T06:28:13+00:00`.
...
- `cran_packages_by_date-6394aea1f52471` from `cran_packages_by_date` as `registry_expansion`
