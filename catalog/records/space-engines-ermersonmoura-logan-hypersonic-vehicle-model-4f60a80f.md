# ermersonmoura/LOGAN-Hypersonic-Vehicle-Model

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/ermersonmoura/LOGAN-Hypersonic-Vehicle-Model](https://github.com/ermersonmoura/LOGAN-Hypersonic-Vehicle-Model) |
| Source record ids | github_search_space_engines-76f173168a103c |

## System Engineer Summary

6-DoF hypersonic vehicle flight dynamics model coupled with a one-dimensional scramjet thermodynamic
engine, including integrated guidance, navigation, and control.

## Operational Role

For a systems engineer, ermersonmoura/LOGAN-Hypersonic-Vehicle-Model belongs in the Space Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | known | Logan_v1.0 | 2026-08-12T01:26:09Z | [https://api.github.com/repos/ermersonmoura/LOGAN-Hypersonic-Vehicle-Model/releases/latest](https://api.github.com/repos/ermersonmoura/LOGAN-Hypersonic-Vehicle-Model/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ermersonmoura/LOGAN-Hypersonic-Vehicle-Model/releases/latest` at `2026-09-01T07:24:17+00:00`.
...
- `github_search_space_engines-76f173168a103c` from `github_search_space_engines` as `registry_expansion`
