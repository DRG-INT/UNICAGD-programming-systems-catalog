...
<!-- canonical: https://github.com/bookshelf/bookshelf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bookshelf/bookshelf](https://github.com/bookshelf/bookshelf) |
| Source record ids | github_search_databases-add97ad18c0912 |
...
For a systems engineer, bookshelf/bookshelf belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-10T14:12:20Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-add97ad18c0912` from `github_search_databases` as `registry_expansion`
