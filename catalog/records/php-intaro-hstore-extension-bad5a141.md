...
<!-- canonical: https://packagist.org/packages/intaro/hstore-extension -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/intaro/hstore-extension](https://packagist.org/packages/intaro/hstore-extension) |
| Source record ids | packagist_search-4561322119e9f3 |
...
For a systems engineer, intaro/hstore-extension belongs in the PHP inventory as part of state
...
- `packagist_search-4561322119e9f3` from `packagist_search` as `registry_expansion`
