...
| Source record ids | github_search_telescopes-d95c8c9828dd48 |
...
For a systems engineer, 0xCoto/Virgo belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.8.9 | 2022-08-30T20:47:13Z | [https://api.github.com/repos/0xCoto/Virgo/releases/latest](https://api.github.com/repos/0xCoto/Virgo/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/0xCoto/Virgo/releases/latest` at `2026-09-01T11:22:12+00:00`.
...
- `github_search_telescopes-d95c8c9828dd48` from `github_search_telescopes` as `registry_expansion`
