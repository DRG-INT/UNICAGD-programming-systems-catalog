...
<!-- canonical: https://github.com/rogerxujiang/dstl_unet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rogerxujiang/dstl_unet](https://github.com/rogerxujiang/dstl_unet) |
| Source record ids | github_search_satcom_satellites-f9b25be212dc3c |
...
For a systems engineer, rogerxujiang/dstl_unet belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-18T23:29:27Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-f9b25be212dc3c` from `github_search_satcom_satellites` as `registry_expansion`
