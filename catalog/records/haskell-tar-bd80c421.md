...
<!-- canonical: https://hackage.haskell.org/package/tar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tar](https://hackage.haskell.org/package/tar) |
| Source record ids | hackage_top_downloads-ceff2681fcbc7b |
...
For a systems engineer, tar belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2.0 | 2026-07-15T23:37:24Z | [https://hackage.haskell.org/package/tar](https://hackage.haskell.org/package/tar) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tar` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-ceff2681fcbc7b` from `hackage_top_downloads` as `registry_expansion`
