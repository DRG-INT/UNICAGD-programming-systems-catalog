...
<!-- canonical: https://cocoapods.org/pods/Kingfisher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Kingfisher](https://cocoapods.org/pods/Kingfisher) |
| Source record ids | cocoapods_cdn-8bfdf089573f55 |
...
For a systems engineer, Kingfisher belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.12.0 | 2026-08-25 15:23:12 UTC | [https://trunk.cocoapods.org/api/v1/pods/Kingfisher](https://trunk.cocoapods.org/api/v1/pods/Kingfisher) |  |
| preview | known | 7.0.0-beta.4 | 2021-09-15 15:30:28 UTC | [https://trunk.cocoapods.org/api/v1/pods/Kingfisher](https://trunk.cocoapods.org/api/v1/pods/Kingfisher) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Kingfisher` at `2026-09-01T07:21:28+00:00`.
...
- `cocoapods_cdn-8bfdf089573f55` from `cocoapods_cdn` as `registry_expansion`
