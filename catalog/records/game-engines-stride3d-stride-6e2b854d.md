...
| Source record ids | github_search_game_engines-e55fb2f4cd56a0 |
...
For a systems engineer, stride3d/stride belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:16:03Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e55fb2f4cd56a0` from `github_search_game_engines` as `registry_expansion`
