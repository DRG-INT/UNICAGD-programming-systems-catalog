...
<!-- canonical: https://github.com/gluestack/gluestack-ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gluestack/gluestack-ui](https://github.com/gluestack/gluestack-ui) |
| Source record ids | github_search_icons_and_logos-6ca2974930a09f |

## System Engineer Summary

React & React Native Components & Patterns (copy-paste components & patterns crafted with Tailwind
CSS (NativeWind))

## Operational Role

For a systems engineer, gluestack/gluestack-ui belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:49:00Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-6ca2974930a09f` from `github_search_icons_and_logos` as `registry_expansion`
