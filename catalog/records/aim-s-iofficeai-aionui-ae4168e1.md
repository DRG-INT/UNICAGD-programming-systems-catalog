...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/iOfficeAI/AionUi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iOfficeAI/AionUi](https://github.com/iOfficeAI/AionUi) |
| Source record ids | github_search_aims-c8180ae726117c |

## System Engineer Summary

Open-source 24/7 Cowork app for OpenClaw, Hermes, Claude Code, Codex, OpenCode and 20+ more CLI
Agent | Customize your assistants | Team them up｜Star if you like it!

## Operational Role

For a systems engineer, iOfficeAI/AionUi belongs in the "aim's" inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:01:43Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-c8180ae726117c` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| hiyouga/LlamaFactory | Ffi Bindings | [open](aim-s-hiyouga-llamafactory-ad4fa468.md) |
