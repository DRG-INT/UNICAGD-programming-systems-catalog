...
<!-- canonical: https://gitlab.com/gitlab-org/cloud-native/gitlab-operator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/cloud-native/gitlab-operator](https://gitlab.com/gitlab-org/cloud-native/gitlab-operator) |
| Source record ids | gitlab_projects_api-8abc3ef83fda3b |
...
For a systems engineer, gitlab-org/cloud-native/gitlab-operator belongs in the Repository Workplaces
...
- `gitlab_projects_api-8abc3ef83fda3b` from `gitlab_projects_api` as `registry_expansion`
