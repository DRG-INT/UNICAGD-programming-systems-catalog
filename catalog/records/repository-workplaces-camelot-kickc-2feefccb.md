...
<!-- canonical: https://gitlab.com/camelot/kickc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/camelot/kickc](https://gitlab.com/camelot/kickc) |
| Source record ids | gitlab_projects_api-da7ccf9812cf2a |

## System Engineer Summary

KickC is a C-compiler for 6502-based platforms creating optimized and readable assembler code. The
language is 95% standard C with a few limitations and a few extensions. Download Releases here

## Operational Role

For a systems engineer, camelot/kickc belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-da7ccf9812cf2a` from `gitlab_projects_api` as `registry_expansion`
