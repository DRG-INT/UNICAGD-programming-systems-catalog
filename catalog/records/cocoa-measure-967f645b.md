...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://measure.sh/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://measure.sh/](https://measure.sh/) |
| Source record ids | awesome_list-5550ba0e304edd |

## System Engineer Summary

Open source, self-hostable mobile app monitoring with error tracking, performance tracing and full
session timelines to spend less time stitching context and fix issues faster.

## Operational Role

For a systems engineer, Measure belongs in the Cocoa inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2020-08-06 12:13:16 UTC | [https://trunk.cocoapods.org/api/v1/pods/Measure](https://trunk.cocoapods.org/api/v1/pods/Measure) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Measure` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-5550ba0e304edd` from `awesome_list` as `registry_expansion`
