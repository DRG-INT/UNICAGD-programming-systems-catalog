...
<!-- canonical: https://github.com/odhondt/ndsar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/odhondt/ndsar](https://github.com/odhondt/ndsar) |
| Source record ids | github_search_radars-cf90604512c92c |

## System Engineer Summary

NDSAR speckle filtering for multidimensional and single-channel SAR images

## Operational Role

For a systems engineer, odhondt/ndsar belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-05T08:22:21Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-cf90604512c92c` from `github_search_radars` as `registry_expansion`
