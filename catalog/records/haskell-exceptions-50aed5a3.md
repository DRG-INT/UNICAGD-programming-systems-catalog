...
<!-- canonical: https://hackage.haskell.org/package/exceptions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/exceptions](https://hackage.haskell.org/package/exceptions) |
| Source record ids | hackage_top_downloads-569594a8a59d35 |
...
For a systems engineer, exceptions belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.12 | 2026-01-10T20:26:13Z | [https://hackage.haskell.org/package/exceptions](https://hackage.haskell.org/package/exceptions) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/exceptions` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-569594a8a59d35` from `hackage_top_downloads` as `registry_expansion`
