...
<!-- canonical: https://github.com/MIERUNE/plateau-gis-converter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MIERUNE/plateau-gis-converter](https://github.com/MIERUNE/plateau-gis-converter) |
| Source record ids | github_search_maps-399814fe54f2aa |

## System Engineer Summary

A "proof-of-concept" tool for converting PLATEAU's 3D city models (CityGML) of Japan into various
geospatial formats like 3D Tiles 1.1, MVT, and GeoPackage.

## Operational Role

For a systems engineer, MIERUNE/plateau-gis-converter belongs in the Maps inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T05:43:42Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-399814fe54f2aa` from `github_search_maps` as `registry_expansion`
