...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/CloudNative.CloudEvents.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/CloudNative.CloudEvents.SystemTextJson](https://www.nuget.org/packages/CloudNative.CloudEvents.SystemTextJson) |
| Source record ids | nuget_search-9ee65845bec82e |
...
For a systems engineer, CloudNative.CloudEvents.SystemTextJson belongs in the C-Sharp inventory as
part of wire formats, persistence, interoperability, and compatibility boundaries.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.0 | 2026-07-04T14:28:01.19+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/cloudnative.cloudevents.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/cloudnative.cloudevents.systemtextjson/index.json) |  |
| preview | known | 2.0.0-rc.1 | 2021-06-07T08:30:52.567+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/cloudnative.cloudevents.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/cloudnative.cloudevents.systemtextjson/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/CloudNative.CloudEvents.SystemTextJson/2.9.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/cloudnative.cloudevents.systemtextjson/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-9ee65845bec82e` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Amazon.Lambda.Serialization.Json | Serialization | [open](c-sharp-amazon-lambda-serialization-json-e0680527.md) |
| Amazon.Lambda.Serialization.SystemTextJson | Serialization | [open](c-sharp-amazon-lambda-serialization-systemtextjson-2c9a73f4.md) |
| Argon | Serialization | [open](c-sharp-argon-914a355e.md) |
| Carbon.Json | Serialization | [open](c-sharp-carbon-json-50e019e2.md) |
| Chr.Avro.Json | Serialization | [open](c-sharp-chr-avro-json-4de0c40d.md) |
| CloudNative.CloudEvents.NewtonsoftJson | Serialization | [open](c-sharp-cloudnative-cloudevents-newtonsoftjson-ecdf1b5a.md) |
| Destructurama.JsonNet | Serialization | [open](c-sharp-destructurama-jsonnet-df566599.md) |
| Ecng.Collections | Serialization | [open](c-sharp-ecng-collections-07fce51d.md) |
