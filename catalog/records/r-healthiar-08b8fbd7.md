...
<!-- canonical: https://cran.r-project.org/web/packages/healthiar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/healthiar/index.html](https://cran.r-project.org/web/packages/healthiar/index.html) |
| Source record ids | cran_packages_by_date-ef8f7311eef0e8 |
...
For a systems engineer, healthiar belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-21 12:30:02 UTC | [https://cran.r-project.org/web/packages/healthiar/DESCRIPTION](https://cran.r-project.org/web/packages/healthiar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/healthiar/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ef8f7311eef0e8` from `cran_packages_by_date` as `registry_expansion`
