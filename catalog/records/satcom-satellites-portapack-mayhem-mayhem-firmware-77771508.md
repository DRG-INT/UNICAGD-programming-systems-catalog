...
| Source record ids | github_search_satcom_satellites-1451b093d88dbb |
...
For a systems engineer, portapack-mayhem/mayhem-firmware belongs in the SatCom Satellites inventory
...
| Evidence | Other; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_satcom_satellites-1451b093d88dbb` from `github_search_satcom_satellites` as `registry_expansion`
