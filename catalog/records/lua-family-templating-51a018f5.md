...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Templating](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/templating.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | lua-source-22 |

## System Engineer Summary

Templating is tracked as a templating record in the Lua family branch. The source did not provide a
...
For a systems engineer, Templating belongs in the Lua family inventory as part of ecosystem
...
- Treat category as `templating` unless a later verified source gives a better classification.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 22}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-22` from `master_json` as `source_list_item`
