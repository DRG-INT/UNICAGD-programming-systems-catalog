...
<!-- canonical: https://github.com/WebAssembly/binaryen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/binaryen](https://github.com/WebAssembly/binaryen) |
| Source record ids | awesome_list-d2aaafe1dc8bc8 |

## System Engineer Summary

Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in
C++ is tracked as a compiler record in the WebAssembly branch. The source did not provide a long
...
For a systems engineer, Binaryen - Binaryen is a compiler and toolchain infrastructure library for
WebAssembly, written in C++ belongs in the WebAssembly inventory as part of compiler selection,
...
- `awesome_list-d2aaafe1dc8bc8` from `awesome_list` as `registry_expansion`
