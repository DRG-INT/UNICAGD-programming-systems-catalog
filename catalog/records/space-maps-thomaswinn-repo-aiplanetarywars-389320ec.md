# ThomasWinn/repo-AiPlanetaryWars

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ThomasWinn/repo-AiPlanetaryWars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ThomasWinn/repo-AiPlanetaryWars](https://github.com/ThomasWinn/repo-AiPlanetaryWars) |
| Source record ids | github_search_space_maps-edc97483fbe4fb |

## System Engineer Summary

Class Project for Algorithms and Data Structures class. I created Ai's which would go up with other
Ai's in different maps. First to conquer all of the other player's planets wins!

## Operational Role

For a systems engineer, ThomasWinn/repo-AiPlanetaryWars belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-24T06:59:38Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-edc97483fbe4fb` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ArturSchuetz/Spherical-Wavelets-for-Globe-Rendering | Machine Learning | [open](space-maps-arturschuetz-spherical-wavelets-for-globe-rendering-5fcb8b61.md) |
| BeckaDesignsCartographyCats/planetary-panthers- | Machine Learning | [open](space-maps-beckadesignscartographycats-planetary-panthers-b9440ac4.md) |
| GregoireHENRY/rust-spice | Machine Learning | [open](space-maps-gregoirehenry-rust-spice-cc677ccb.md) |
| JustinLove/section_of_foreign_intelligence | Machine Learning | [open](space-maps-justinlove-section-of-foreign-intelligence-47c06873.md) |
| lukas-tr/pain | Machine Learning | [open](space-maps-lukas-tr-pain-55aa2b81.md) |
| mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers | Machine Learning | [open](space-maps-mdrstudiogroup-ai-mdr-studio-world-map-for-developers-a5cbce0e.md) |
| oaslananka/kicad-studio-kit | Machine Learning | [open](space-maps-oaslananka-kicad-studio-kit-b96a6649.md) |
| utiasSTARS/gplanetary-nav | Machine Learning | [open](space-maps-utiasstars-gplanetary-nav-f467147d.md) |
