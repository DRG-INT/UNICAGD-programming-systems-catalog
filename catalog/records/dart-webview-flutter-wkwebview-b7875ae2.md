...
<!-- canonical: https://pub.dev/packages/webview_flutter_wkwebview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/webview_flutter_wkwebview](https://pub.dev/packages/webview_flutter_wkwebview) |
| Source record ids | pub_dev-d260f45c29afca |
...
For a systems engineer, webview_flutter_wkwebview belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.26.1 | 2026-08-28T04:12:02.898242Z | [https://pub.dev/api/packages/webview_flutter_wkwebview](https://pub.dev/api/packages/webview_flutter_wkwebview) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/webview_flutter_wkwebview` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-d260f45c29afca` from `pub_dev` as `registry_expansion`
