...
<!-- canonical: https://luarocks.org/modules/ej-shafran/delog.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ej-shafran/delog.nvim](https://luarocks.org/modules/ej-shafran/delog.nvim) |
| Source record ids | luarocks_root_manifest-2b46583adf84e6 |

## System Engineer Summary

A plugin for handling debug logs for any language.

## Operational Role

For a systems engineer, delog.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-2b46583adf84e6` from `luarocks_root_manifest` as `registry_expansion`
