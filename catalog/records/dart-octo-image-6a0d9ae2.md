...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/octo_image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/octo_image](https://pub.dev/packages/octo_image) |
| Source record ids | pub_dev-377285f82e8edb |

## System Engineer Summary

A multifunctional Flutter image widget. Supports placeholders, error widgets and image transformers
with fading.

## Operational Role

For a systems engineer, octo_image belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2024-08-01T17:30:56.265130Z | [https://pub.dev/api/packages/octo_image](https://pub.dev/api/packages/octo_image) |  |
| preview | known | 1.0.0-nullsafety.1 | 2021-01-15T08:20:12.167531Z | [https://pub.dev/api/packages/octo_image](https://pub.dev/api/packages/octo_image) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/octo_image` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-377285f82e8edb` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| audio_waveforms | Image Audio Dsp | [open](dart-audio-waveforms-57440b11.md) |
| audioplayers | Image Audio Dsp | [open](dart-audioplayers-9d09bcb1.md) |
| crop_image | Image Audio Dsp | [open](dart-crop-image-8c48b5bf.md) |
| crop_your_image | Image Audio Dsp | [open](dart-crop-your-image-b15fdf42.md) |
| flutter_native_splash | Image Audio Dsp | [open](dart-flutter-native-splash-9bf23954.md) |
| image_picker_for_web | Image Audio Dsp | [open](dart-image-picker-for-web-9e267aa4.md) |
| image_size_getter | Image Audio Dsp | [open](dart-image-size-getter-9f40d0ef.md) |
| record | Image Audio Dsp | [open](dart-record-1756f10d.md) |
