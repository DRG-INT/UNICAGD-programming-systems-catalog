...
<!-- canonical: https://github.com/KelvinJin/AnimatedCollectionViewLayout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KelvinJin/AnimatedCollectionViewLayout](https://github.com/KelvinJin/AnimatedCollectionViewLayout) |
| Source record ids | github_search_cocoa-969304876e6f0e |

## System Engineer Summary

A UICollectionViewLayout subclass that adds custom transitions/animations to the UICollectionView
without effecting your existing code.

## Operational Role

For a systems engineer, KelvinJin/AnimatedCollectionViewLayout belongs in the Cocoa inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-20T07:09:55Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_cocoa-969304876e6f0e` from `github_search_cocoa` as `registry_expansion`
