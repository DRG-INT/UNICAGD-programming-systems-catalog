...
| Source record ids | master-607b201d1acd |

## System Engineer Summary

Lua 5.1 language/reference line

## Operational Role

For a systems engineer, Lua 5.1 belongs in the Lua family inventory as part of ecosystem capability
...
- `master-607b201d1acd` from `master_json` as `language_specification`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ada_ls.nvim | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ada-ls-nvim-64f31d8a.md) |
