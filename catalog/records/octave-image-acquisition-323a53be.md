...
<!-- canonical: https://gnu-octave.github.io/packages/image-acquisition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/image-acquisition](https://gnu-octave.github.io/packages/image-acquisition) |
| Source record ids | octave_packages_index-fdbc4b84ab0ded |

## System Engineer Summary

Capture images using Video4Linux2 or Media Foundation.

## Operational Role

For a systems engineer, image-acquisition belongs in the Octave inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2025-04-19 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-fdbc4b84ab0ded` from `octave_packages_index` as `registry_expansion`
