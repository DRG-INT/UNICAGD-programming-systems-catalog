...
<!-- canonical: https://docs.gitlab.com/user/packages/package_registry/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.gitlab.com/user/packages/package_registry/](https://docs.gitlab.com/user/packages/package_registry/) |
| Source record ids | curated_repository_workplace_routes-82ff1b62d1cd85 |

## System Engineer Summary

GitLab package registry for package publication, dependency workflows, and project-scoped package
metadata.

## Operational Role

For a systems engineer, GitLab Package Registry belongs in the Repository Workplaces inventory as
...
- `curated_repository_workplace_routes-82ff1b62d1cd85` from `curated_repository_workplace_routes` as `registry_expansion`
