...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/ArarForecast -->
<!-- crawl-delay: 10 -->
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/ArarForecast", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-39b3b4785cdaef` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractFastHartleyTransforms | Parser Lexer Ast | [open](julia-abstractfasthartleytransforms-47102490.md) |
| AdaStress | Parser Lexer Ast | [open](julia-adastress-a781306c.md) |
| AliasTables | Parser Lexer Ast | [open](julia-aliastables-f1ba6228.md) |
| AlphaStableDistributions | Parser Lexer Ast | [open](julia-alphastabledistributions-1e5bbd33.md) |
| AnytimeWeightedAStar | Parser Lexer Ast | [open](julia-anytimeweightedastar-de434846.md) |
| AppleHealthParser | Parser Lexer Ast | [open](julia-applehealthparser-e201e3fe.md) |
| ApproxMasterEqs | Parser Lexer Ast | [open](julia-approxmastereqs-28a5b3d6.md) |
| Asciicast | Parser Lexer Ast | [open](julia-asciicast-8bbfdf03.md) |
