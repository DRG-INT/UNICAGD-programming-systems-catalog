...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/ArarForecast](https://github.com/JuliaRegistries/General/tree/master/A/ArarForecast) |
| Source record ids | julia_general-39b3b4785cdaef |

## System Engineer Summary

Julia package registered in General at A/ArarForecast.

## Operational Role

For a systems engineer, ArarForecast belongs in the Julia inventory as part of language tooling,
code generation, static analysis, and source transformation.
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractFastHartleyTransforms | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractfasthartleytransforms-47102490.md) |
| AdaStress | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-adastress-a781306c.md) |
| AliasTables | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-aliastables-f1ba6228.md) |
| AlphaStableDistributions | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-alphastabledistributions-1e5bbd33.md) |
| AnytimeWeightedAStar | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-anytimeweightedastar-de434846.md) |
| AppleHealthParser | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-applehealthparser-e201e3fe.md) |
| ApproxMasterEqs | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-approxmastereqs-28a5b3d6.md) |
| Asciicast | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-asciicast-8bbfdf03.md) |
