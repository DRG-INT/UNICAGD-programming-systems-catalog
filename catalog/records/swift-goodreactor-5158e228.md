...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GoodRequest/GoodReactor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GoodRequest/GoodReactor](https://github.com/GoodRequest/GoodReactor) |
| Source record ids | awesome_list-aec25bed6e8139 |

## System Engineer Summary

⚛️ GoodReactor is a Redux-inspired Reactor framework for communication between the View Model, View
Controller, and Coordinator.

## Operational Role

For a systems engineer, GoodReactor belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Patterns", "source_url": "https://raw.githubusercontent.com/matteocrippa/awesome-swift/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-aec25bed6e8139` from `awesome_list` as `registry_expansion`
