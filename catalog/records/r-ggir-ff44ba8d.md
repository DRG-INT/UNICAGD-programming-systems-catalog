...
<!-- canonical: https://cran.r-project.org/web/packages/GGIR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GGIR/index.html](https://cran.r-project.org/web/packages/GGIR/index.html) |
| Source record ids | cran_packages_by_date-789dc95b3f724a |
...
For a systems engineer, GGIR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3-9 | 2026-09-12 10:20:02 UTC | [https://cran.r-project.org/web/packages/GGIR/DESCRIPTION](https://cran.r-project.org/web/packages/GGIR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GGIR/DESCRIPTION` at `2026-09-12T12:23:41+00:00`.
...
- `cran_packages_by_date-789dc95b3f724a` from `cran_packages_by_date` as `registry_expansion`
