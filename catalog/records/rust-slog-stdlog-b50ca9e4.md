...
| Canonical URL | [https://crates.io/crates/slog-stdlog](https://crates.io/crates/slog-stdlog) |
| Source record ids | crates_io-12dc20798ccba2 |
...
For a systems engineer, slog-stdlog belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.1 | 2022-03-23T07:51:22.137176Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-12dc20798ccba2` from `crates_io` as `registry_expansion`
