...
<!-- canonical: https://github.com/JuliaComputing/Multibody.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaComputing/Multibody.jl](https://github.com/JuliaComputing/Multibody.jl) |
| Source record ids | github_search_physics_engines-1904d32c2213ac |
...
For a systems engineer, JuliaComputing/Multibody.jl belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T12:14:17Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-1904d32c2213ac` from `github_search_physics_engines` as `registry_expansion`
