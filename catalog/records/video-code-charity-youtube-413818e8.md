...
| Canonical URL | [https://github.com/code-charity/youtube](https://github.com/code-charity/youtube) |
| Source record ids | github_search_video-73ebb0ea7dcc1a |

## System Engineer Summary

YouTube / Video Browser-Extension. Top1 FOSS. Enrich your experience & choice! 🧰Smart features📌set &
forget📌300+ tweaks. Longest-standing. Join🧩us?👨‍👩‍👧‍👧 ⋮ {playback|discovery|extra player
buttons|quality|codec|full tab|full screen|no distraction|shorts}

## Operational Role

For a systems engineer, code-charity/youtube belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.2027 | 2026-05-30T00:34:51Z | [https://api.github.com/repos/code-charity/youtube/releases/latest](https://api.github.com/repos/code-charity/youtube/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/code-charity/youtube/releases/latest` at `2026-09-01T09:23:22+00:00`.
...
- `github_search_video-73ebb0ea7dcc1a` from `github_search_video` as `registry_expansion`
