...
<!-- canonical: https://github.com/FoggedLens/deflock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FoggedLens/deflock](https://github.com/FoggedLens/deflock) |
| Source record ids | github_search_maps-cce8edbb2051b4 |
...
For a systems engineer, FoggedLens/deflock belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T03:46:46Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-cce8edbb2051b4` from `github_search_maps` as `registry_expansion`
