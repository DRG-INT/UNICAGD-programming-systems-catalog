...
<!-- canonical: https://hackage.haskell.org/package/holeyexp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/holeyexp](https://hackage.haskell.org/package/holeyexp) |
| Source record ids | hackage_recent-f8bae12dc2caa9 |

## System Engineer Summary

Hackage package recently uploaded by heades.

## Operational Role

For a systems engineer, holeyexp belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.1 | 2026-09-04T13:09:46Z | [https://hackage.haskell.org/package/holeyexp](https://hackage.haskell.org/package/holeyexp) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/holeyexp` at `2026-09-04T17:20:31+00:00`.
...
- `hackage_recent-f8bae12dc2caa9` from `hackage_recent` as `registry_expansion`
