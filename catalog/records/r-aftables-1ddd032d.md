...
<!-- canonical: https://cran.r-project.org/web/packages/aftables/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aftables/index.html](https://cran.r-project.org/web/packages/aftables/index.html) |
| Source record ids | cran_packages_by_date-aa1f714a1692d6 |
...
For a systems engineer, aftables belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-24 08:40:27 UTC | [https://cran.r-project.org/web/packages/aftables/DESCRIPTION](https://cran.r-project.org/web/packages/aftables/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aftables/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-aa1f714a1692d6` from `cran_packages_by_date` as `registry_expansion`
