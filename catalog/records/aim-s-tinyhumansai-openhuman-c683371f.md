...
OpenHuman is an open source agent harness with local-first memory, agent orchestration, and
workflows
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T03:06:12Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
