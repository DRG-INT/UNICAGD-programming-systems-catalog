...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tinyhumansai/openhuman -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) |
| Source record ids | github_search_aims-41c1202344df7f |

## System Engineer Summary

OpenHuman is an open source personal AI for Mac, Windows and Linux — local-first memory, agent
orchestration, and deep research.

## Operational Role

For a systems engineer, tinyhumansai/openhuman belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:36:48Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-41c1202344df7f` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| asgeirtj/system_prompts_leaks | Memory Analyzer | [open](aim-s-asgeirtj-system-prompts-leaks-c743049d.md) |
| gitleaks/gitleaks | Memory Analyzer | [open](aim-s-gitleaks-gitleaks-942f477b.md) |
| mem0ai/mem0 | Memory Analyzer | [open](aim-s-mem0ai-mem0-1e2f6f8a.md) |
| MemPalace/mempalace | Memory Analyzer | [open](aim-s-mempalace-mempalace-24dc978a.md) |
| vllm-project/vllm | Memory Analyzer | [open](aim-s-vllm-project-vllm-5af67423.md) |
| zhayujie/CowAgent | Memory Analyzer | [open](aim-s-zhayujie-cowagent-fa45ff55.md) |
