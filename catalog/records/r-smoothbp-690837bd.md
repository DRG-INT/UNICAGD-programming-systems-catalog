...
<!-- canonical: https://cran.r-project.org/web/packages/smoothbp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smoothbp/index.html](https://cran.r-project.org/web/packages/smoothbp/index.html) |
| Source record ids | cran_packages_by_date-42f970f9267816 |
...
For a systems engineer, smoothbp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8 | 2026-08-28 21:30:02 UTC | [https://cran.r-project.org/web/packages/smoothbp/DESCRIPTION](https://cran.r-project.org/web/packages/smoothbp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smoothbp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-42f970f9267816` from `cran_packages_by_date` as `registry_expansion`
