...
<!-- canonical: https://cran.r-project.org/web/packages/phonics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/phonics/index.html](https://cran.r-project.org/web/packages/phonics/index.html) |
| Source record ids | cran_packages_by_date-26ddaa6138d7d4 |
...
For a systems engineer, phonics belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-23 11:20:08 UTC | [https://cran.r-project.org/web/packages/phonics/DESCRIPTION](https://cran.r-project.org/web/packages/phonics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/phonics/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-26ddaa6138d7d4` from `cran_packages_by_date` as `registry_expansion`
