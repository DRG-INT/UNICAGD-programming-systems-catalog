...
| Source record ids | curated_language_routes-88a614772209c5 |

## System Engineer Summary

Audio decoding, encoding, filtering, streaming, container, and batch processing toolkit.

## Operational Role

For a systems engineer, FFmpeg Audio belongs in the Audio inventory as part of ecosystem capability
...
- `curated_language_routes-88a614772209c5` from `curated_language_routes` as `registry_expansion`
