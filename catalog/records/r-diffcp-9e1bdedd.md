...
<!-- canonical: https://cran.r-project.org/web/packages/diffcp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/diffcp/index.html](https://cran.r-project.org/web/packages/diffcp/index.html) |
| Source record ids | cran_packages_by_date-edf61f1a494e03 |
...
For a systems engineer, diffcp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-22 23:20:24 UTC | [https://cran.r-project.org/web/packages/diffcp/DESCRIPTION](https://cran.r-project.org/web/packages/diffcp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/diffcp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-edf61f1a494e03` from `cran_packages_by_date` as `registry_expansion`
