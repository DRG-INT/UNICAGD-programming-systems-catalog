...
<!-- canonical: https://hackage.haskell.org/package/pgmq-hasql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pgmq-hasql](https://hackage.haskell.org/package/pgmq-hasql) |
| Source record ids | hackage_recent-c1580d40a1ff57 |
...
For a systems engineer, pgmq-hasql belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2026-09-10T19:39:13Z | [https://hackage.haskell.org/package/pgmq-hasql](https://hackage.haskell.org/package/pgmq-hasql) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pgmq-hasql` at `2026-09-11T01:22:35+00:00`.
...
- `hackage_recent-c1580d40a1ff57` from `hackage_recent` as `registry_expansion`
