...
<!-- canonical: https://hackage.haskell.org/package/dbus-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dbus-core](https://hackage.haskell.org/package/dbus-core) |
| Source record ids | hackage_top_downloads-8903aecef7278c |
...
For a systems engineer, dbus-core belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2012-06-23T15:47:36Z | [https://hackage.haskell.org/package/dbus-core](https://hackage.haskell.org/package/dbus-core) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dbus-core` at `2026-09-12T00:29:14+00:00`.
...
- `hackage_top_downloads-8903aecef7278c` from `hackage_top_downloads` as `registry_expansion`
