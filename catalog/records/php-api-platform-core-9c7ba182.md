...
| Canonical URL | [https://packagist.org/packages/api-platform/core](https://packagist.org/packages/api-platform/core) |
| Source record ids | packagist_search-0beec5a9cc0414 |
...
For a systems engineer, api-platform/core belongs in the PHP inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.3.17 | 2026-07-12T06:11:31+00:00 | [https://repo.packagist.org/p2/api-platform/core.json](https://repo.packagist.org/p2/api-platform/core.json) |  |
| preview | known | v5.0.0-alpha.2 | 2026-07-12T13:20:14+00:00 | [https://repo.packagist.org/p2/api-platform/core.json](https://repo.packagist.org/p2/api-platform/core.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/api-platform/core.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-0beec5a9cc0414` from `packagist_search` as `registry_expansion`
