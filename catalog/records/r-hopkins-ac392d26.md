...
<!-- canonical: https://cran.r-project.org/web/packages/hopkins/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hopkins/index.html](https://cran.r-project.org/web/packages/hopkins/index.html) |
| Source record ids | cran_packages_by_date-257dc3b63eaafa |
...
For a systems engineer, hopkins belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-09-09 16:10:01 UTC | [https://cran.r-project.org/web/packages/hopkins/DESCRIPTION](https://cran.r-project.org/web/packages/hopkins/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hopkins/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-257dc3b63eaafa` from `cran_packages_by_date` as `registry_expansion`
