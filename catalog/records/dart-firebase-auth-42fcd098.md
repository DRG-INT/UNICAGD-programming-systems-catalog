...
<!-- canonical: https://pub.dev/packages/firebase_auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/firebase_auth](https://pub.dev/packages/firebase_auth) |
| Source record ids | pub_dev-05508b2804b5c0 |

## System Engineer Summary

Flutter plugin for Firebase Auth, enabling authentication using passwords, phone numbers and
identity providers like Google, Facebook and Twitter.

## Operational Role

For a systems engineer, firebase_auth belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.6.1 | 2026-08-27T08:12:34.649733Z | [https://pub.dev/api/packages/firebase_auth](https://pub.dev/api/packages/firebase_auth) |  |
| preview | known | 1.0.0-1.0.nullsafety.0 | 2021-02-22T12:41:05.994946Z | [https://pub.dev/api/packages/firebase_auth](https://pub.dev/api/packages/firebase_auth) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/firebase_auth` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-05508b2804b5c0` from `pub_dev` as `registry_expansion`
