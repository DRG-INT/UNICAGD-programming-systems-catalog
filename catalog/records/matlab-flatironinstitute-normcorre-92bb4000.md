...
<!-- canonical: https://github.com/flatironinstitute/NoRMCorre -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flatironinstitute/NoRMCorre](https://github.com/flatironinstitute/NoRMCorre) |
| Source record ids | github_search_matlab-dd28a2ccfc986a |
...
For a systems engineer, flatironinstitute/NoRMCorre belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-29T15:19:21Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:MATLAB topic:matlab", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_matlab-dd28a2ccfc986a` from `github_search_matlab` as `registry_expansion`
