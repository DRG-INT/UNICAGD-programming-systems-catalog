...
<!-- canonical: https://cran.r-project.org/web/packages/deOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/deOpenData/index.html](https://cran.r-project.org/web/packages/deOpenData/index.html) |
| Source record ids | cran_packages_by_date-269216635b3ab4 |

## System Engineer Summary

A Lightweight Interface to Delaware Open Data APIs

## Operational Role

For a systems engineer, deOpenData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-01 08:40:02 UTC | [https://cran.r-project.org/web/packages/deOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/deOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/deOpenData/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-269216635b3ab4` from `cran_packages_by_date` as `registry_expansion`
