...
<!-- canonical: https://cran.r-project.org/web/packages/deltabreedquery/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/deltabreedquery/index.html](https://cran.r-project.org/web/packages/deltabreedquery/index.html) |
| Source record ids | cran_packages_by_date-7f21e8ec80854e |

## System Engineer Summary

Fast, Simple API Tools for Retrieving Data from 'DeltaBreed'

## Operational Role

For a systems engineer, deltabreedquery belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-25 14:50:09 UTC | [https://cran.r-project.org/web/packages/deltabreedquery/DESCRIPTION](https://cran.r-project.org/web/packages/deltabreedquery/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/deltabreedquery/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7f21e8ec80854e` from `cran_packages_by_date` as `registry_expansion`
