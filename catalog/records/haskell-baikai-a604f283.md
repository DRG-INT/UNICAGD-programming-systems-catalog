...
<!-- canonical: https://hackage.haskell.org/package/baikai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai](https://hackage.haskell.org/package/baikai) |
| Source record ids | hackage_recent-08efc48cf33993 |
...
For a systems engineer, baikai belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.0 | 2026-09-08T14:44:10Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-08efc48cf33993` from `hackage_recent` as `registry_expansion`
