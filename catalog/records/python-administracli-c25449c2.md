...
<!-- canonical: https://pypi.org/project/administracli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/administracli/](https://pypi.org/project/administracli/) |
| Source record ids | pypi_simple-cfd96ca288565e |
...
For a systems engineer, administracli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0 | 2026-02-26T21:17:44.698388Z | [https://pypi.org/pypi/administracli/json](https://pypi.org/pypi/administracli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/administracli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-cfd96ca288565e` from `pypi_simple` as `registry_expansion`
