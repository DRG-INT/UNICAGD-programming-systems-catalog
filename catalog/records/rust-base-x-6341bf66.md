...
| Canonical URL | [https://crates.io/crates/base-x](https://crates.io/crates/base-x) |
| Source record ids | crates_io-0b9ef90723d831 |

## System Engineer Summary

base-x is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, base-x belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21T17:34:50.108549Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-0b9ef90723d831` from `crates_io` as `registry_expansion`
