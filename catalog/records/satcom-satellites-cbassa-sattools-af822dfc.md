...
<!-- canonical: https://github.com/cbassa/sattools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cbassa/sattools](https://github.com/cbassa/sattools) |
| Source record ids | github_search_satcom_satellites-f1af745b6d2d6c |
...
For a systems engineer, cbassa/sattools belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-28T19:02:08Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-f1af745b6d2d6c` from `github_search_satcom_satellites` as `registry_expansion`
