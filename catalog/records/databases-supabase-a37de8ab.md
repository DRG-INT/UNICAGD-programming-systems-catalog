...
<!-- canonical: https://github.com/supabase/supabase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/supabase/supabase](https://github.com/supabase/supabase) |
| Source record ids | curated_database_systems-b2165ad08084d3 |

## System Engineer Summary

Postgres application platform with auth, storage, realtime, edge functions, and APIs.

## Operational Role

For a systems engineer, Supabase belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-b2165ad08084d3` from `curated_database_systems` as `registry_expansion`
