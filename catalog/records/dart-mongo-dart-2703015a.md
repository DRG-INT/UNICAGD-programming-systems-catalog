...
<!-- canonical: https://pub.dev/packages/mongo_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mongo_dart](https://pub.dev/packages/mongo_dart) |
| Source record ids | pub_dev-de962477f61546 |
...
For a systems engineer, mongo_dart belongs in the Dart inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.9 | 2026-06-21T12:45:25.361011Z | [https://pub.dev/api/packages/mongo_dart](https://pub.dev/api/packages/mongo_dart) |  |
| preview | known | 0.8.0-1.0.beta | 2022-04-29T06:01:57.571409Z | [https://pub.dev/api/packages/mongo_dart](https://pub.dev/api/packages/mongo_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mongo_dart` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-de962477f61546` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| win32_registry | Package Manager | [open](dart-win32-registry-ea72a820.md) |
