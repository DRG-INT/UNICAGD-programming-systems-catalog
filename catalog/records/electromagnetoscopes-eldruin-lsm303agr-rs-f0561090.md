...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/eldruin/lsm303agr-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eldruin/lsm303agr-rs](https://github.com/eldruin/lsm303agr-rs) |
| Source record ids | github_search_electromagnetoscopes-edded1d5bb59b5 |

## System Engineer Summary

Platform agnostic Rust driver for the LSM303AGR ultra-compact high-performance eCompass module:
ultra-low-power 3D accelerometer and 3D magnetometer

## Operational Role

For a systems engineer, eldruin/lsm303agr-rs belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-24T20:22:44Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-edded1d5bb59b5` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| google/ceviche-challenges | Benchmarking | [open](electromagnetoscopes-google-ceviche-challenges-32054f63.md) |
| KJ7LNW/xnec2c | Benchmarking | [open](electromagnetoscopes-kj7lnw-xnec2c-b0133631.md) |
| luigifcruz/CyberEther | Benchmarking | [open](electromagnetoscopes-luigifcruz-cyberether-9a732794.md) |
