...
<!-- canonical: https://pub.dev/packages/desktop_multi_window -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/desktop_multi_window](https://pub.dev/packages/desktop_multi_window) |
| Source record ids | pub_dev-f56ea092ba213a |
...
For a systems engineer, desktop_multi_window belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-26T06:49:31.717877Z | [https://pub.dev/api/packages/desktop_multi_window](https://pub.dev/api/packages/desktop_multi_window) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/desktop_multi_window` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-f56ea092ba213a` from `pub_dev` as `registry_expansion`
