...
<!-- canonical: https://crates.io/crates/structopt-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/structopt-derive](https://crates.io/crates/structopt-derive) |
| Source record ids | crates_io-3756f908c60481 |
...
For a systems engineer, structopt-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.18 | 2021-10-18T07:06:20.504665Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-10T06:26:05+00:00`.
...
- `crates_io-3756f908c60481` from `crates_io` as `registry_expansion`
