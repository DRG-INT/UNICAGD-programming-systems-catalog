...
<!-- canonical: https://hackage.haskell.org/package/log-domain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/log-domain](https://hackage.haskell.org/package/log-domain) |
| Source record ids | hackage_top_downloads-d2082a458fb820 |
...
For a systems engineer, log-domain belongs in the Haskell inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.2 | 2021-11-16T01:43:03Z | [https://hackage.haskell.org/package/log-domain](https://hackage.haskell.org/package/log-domain) |  |
| candidate | partial | 0.11.2 |  | [https://hackage.haskell.org/package/log-domain](https://hackage.haskell.org/package/log-domain) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/log-domain` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-d2082a458fb820` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amazonka-cloudwatch-logs | Logging Observability | [open](haskell-amazonka-cloudwatch-logs-0f3cd488.md) |
