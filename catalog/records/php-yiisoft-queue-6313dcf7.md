...
<!-- canonical: https://packagist.org/packages/yiisoft/queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yiisoft/queue](https://packagist.org/packages/yiisoft/queue) |
| Source record ids | packagist_search-e401cfb488ac17 |
...
For a systems engineer, yiisoft/queue belongs in the PHP inventory as part of concurrency
...
- `packagist_search-e401cfb488ac17` from `packagist_search` as `registry_expansion`
