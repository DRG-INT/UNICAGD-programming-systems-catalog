...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/googleapis_auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/googleapis_auth](https://pub.dev/packages/googleapis_auth) |
| Source record ids | pub_dev-fa22c71a1a8168 |
...
For a systems engineer, googleapis_auth belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.3 | 2026-07-08T19:06:06.929826Z | [https://pub.dev/api/packages/googleapis_auth](https://pub.dev/api/packages/googleapis_auth) |  |
| preview | known | 2.1.0-beta.1 | 2026-02-11T12:43:35.319383Z | [https://pub.dev/api/packages/googleapis_auth](https://pub.dev/api/packages/googleapis_auth) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/googleapis_auth` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-fa22c71a1a8168` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| animated_text_kit | Machine Learning | [open](dart-animated-text-kit-23439ecd.md) |
| basics | Machine Learning | [open](dart-basics-67691afc.md) |
| diffutil_dart | Machine Learning | [open](dart-diffutil-dart-8eb45b04.md) |
| email_validator | Machine Learning | [open](dart-email-validator-7199344b.md) |
| floating | Machine Learning | [open](dart-floating-77544969.md) |
| flutter_chat_types | Machine Learning | [open](dart-flutter-chat-types-ec6976cf.md) |
| flutter_email_sender | Machine Learning | [open](dart-flutter-email-sender-6c7e45e3.md) |
| flutter_soloud | Machine Learning | [open](dart-flutter-soloud-5770bd43.md) |
