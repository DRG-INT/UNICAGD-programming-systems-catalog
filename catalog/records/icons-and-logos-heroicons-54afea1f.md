...
| Canonical URL | [https://github.com/tailwindlabs/heroicons](https://github.com/tailwindlabs/heroicons) |
| Source record ids | curated_language_routes-1f2b6efb80e978 |

## System Engineer Summary

SVG icon set used with Tailwind-style application UI systems.

## Operational Role

For a systems engineer, Heroicons belongs in the Icons and Logos inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.0 | 2024-11-18T15:32:49Z | [https://api.github.com/repos/tailwindlabs/heroicons/releases/latest](https://api.github.com/repos/tailwindlabs/heroicons/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tailwindlabs/heroicons/releases/latest` at `2026-09-01T12:30:35+00:00`.
...
- `curated_language_routes-1f2b6efb80e978` from `curated_language_routes` as `registry_expansion`
