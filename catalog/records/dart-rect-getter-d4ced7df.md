...
<!-- canonical: https://pub.dev/packages/rect_getter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/rect_getter](https://pub.dev/packages/rect_getter) |
| Source record ids | pub_dev-42d3e04bdccea0 |
...
For a systems engineer, rect_getter belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2021-11-17T06:13:24.303927Z | [https://pub.dev/api/packages/rect_getter](https://pub.dev/api/packages/rect_getter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/rect_getter` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-42d3e04bdccea0` from `pub_dev` as `registry_expansion`
