...
<!-- canonical: https://luarocks.org/modules/colinkennedy/deadcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/colinkennedy/deadcode](https://luarocks.org/modules/colinkennedy/deadcode) |
| Source record ids | luarocks_root_manifest-550fcb28c18226 |
...
For a systems engineer, deadcode belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-550fcb28c18226` from `luarocks_root_manifest` as `registry_expansion`
