...
<!-- canonical: https://cran.r-project.org/web/packages/RcppPlanc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppPlanc/index.html](https://cran.r-project.org/web/packages/RcppPlanc/index.html) |
| Source record ids | cran_packages_by_date-ac16744f24ca1e |
...
For a systems engineer, RcppPlanc belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.16 | 2026-09-09 07:30:22 UTC | [https://cran.r-project.org/web/packages/RcppPlanc/DESCRIPTION](https://cran.r-project.org/web/packages/RcppPlanc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppPlanc/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-ac16744f24ca1e` from `cran_packages_by_date` as `registry_expansion`
