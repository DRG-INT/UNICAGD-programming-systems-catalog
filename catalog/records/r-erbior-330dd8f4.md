...
<!-- canonical: https://cran.r-project.org/web/packages/ERBioR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ERBioR/index.html](https://cran.r-project.org/web/packages/ERBioR/index.html) |
| Source record ids | cran_packages_by_date-7ea70cfb95989e |
...
For a systems engineer, ERBioR belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-09-09 14:50:26 UTC | [https://cran.r-project.org/web/packages/ERBioR/DESCRIPTION](https://cran.r-project.org/web/packages/ERBioR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ERBioR/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-7ea70cfb95989e` from `cran_packages_by_date` as `registry_expansion`
