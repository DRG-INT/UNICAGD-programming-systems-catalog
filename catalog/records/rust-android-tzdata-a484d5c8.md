...
<!-- canonical: https://crates.io/crates/android-tzdata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/android-tzdata](https://crates.io/crates/android-tzdata) |
| Source record ids | crates_io-0d7d386e56631b |
...
For a systems engineer, android-tzdata belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2023-03-05T09:25:18.541477Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-02T00:28:36+00:00`.
...
- `crates_io-0d7d386e56631b` from `crates_io` as `registry_expansion`
