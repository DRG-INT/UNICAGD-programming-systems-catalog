...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rhysd/vim.wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rhysd/vim.wasm](https://github.com/rhysd/vim.wasm) |
| Source record ids | github_search_webassembly-8a94415b7d2d57 |
...
For a systems engineer, rhysd/vim.wasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-25T16:49:20Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-8a94415b7d2d57` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Compiling Rust to WebAssembly Guide (2017) | Ide Editor Integration | [open](webassembly-compiling-rust-to-webassembly-guide-2017-e1bb57b7.md) |
| deislabs/spiderlightning | Ide Editor Integration | [open](webassembly-deislabs-spiderlightning-806ab4a3.md) |
| Developer's Guide | Ide Editor Integration | [open](webassembly-developer-s-guide-17601a2c.md) |
| Evil0ctal/WeChat-Channels-Video-File-Decryption | Ide Editor Integration | [open](webassembly-evil0ctal-wechat-channels-video-file-decryption-48e9aa68.md) |
| iRath96/webNBT | Ide Editor Integration | [open](webassembly-irath96-webnbt-c7890bae.md) |
| jupyterlite/jupyterlite | Ide Editor Integration | [open](webassembly-jupyterlite-jupyterlite-647ef8ae.md) |
| kowasm/kowasm | Ide Editor Integration | [open](webassembly-kowasm-kowasm-d5a360db.md) |
| mitchellh/libxev | Ide Editor Integration | [open](webassembly-mitchellh-libxev-2da389e7.md) |
