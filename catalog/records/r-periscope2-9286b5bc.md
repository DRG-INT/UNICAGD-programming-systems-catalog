...
<!-- canonical: https://cran.r-project.org/web/packages/periscope2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/periscope2/index.html](https://cran.r-project.org/web/packages/periscope2/index.html) |
| Source record ids | cran_packages_by_date-03043a4edb07d4 |
...
For a systems engineer, periscope2 belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-19 16:10:02 UTC | [https://cran.r-project.org/web/packages/periscope2/DESCRIPTION](https://cran.r-project.org/web/packages/periscope2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/periscope2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-03043a4edb07d4` from `cran_packages_by_date` as `registry_expansion`
