...
| Canonical URL | [https://crates.io/crates/roaring](https://crates.io/crates/roaring) |
| Source record ids | crates_io-155a67e4aa346f |
...
For a systems engineer, roaring belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.5 | 2026-08-12T17:04:50.228344Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-155a67e4aa346f` from `crates_io` as `registry_expansion`
