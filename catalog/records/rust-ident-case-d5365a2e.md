...
<!-- canonical: https://crates.io/crates/ident_case -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ident_case](https://crates.io/crates/ident_case) |
| Source record ids | crates_io-2437eaf63253b3 |
...
For a systems engineer, ident_case belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2019-03-18T20:07:20.426691Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `crates_io-2437eaf63253b3` from `crates_io` as `registry_expansion`
