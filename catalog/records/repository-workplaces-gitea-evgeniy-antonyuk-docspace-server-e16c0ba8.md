# Gitea: evgeniy-antonyuk/DocSpace-server
...
<!-- canonical: https://gitea.com/evgeniy-antonyuk/DocSpace-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/evgeniy-antonyuk/DocSpace-server](https://gitea.com/evgeniy-antonyuk/DocSpace-server) |
| Source record ids | gitea_repositories_api-f6a90dd0095731 |
...
For a systems engineer, Gitea: evgeniy-antonyuk/DocSpace-server belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-13T12:26:53Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f6a90dd0095731` from `gitea_repositories_api` as `registry_expansion`
