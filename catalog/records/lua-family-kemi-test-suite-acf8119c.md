...
| Canonical URL | [https://luarocks.org/modules/ovoshlook/kemi-test-suite](https://luarocks.org/modules/ovoshlook/kemi-test-suite) |
| Source record ids | luarocks_root_manifest-484f12fa4470cf |

## System Engineer Summary

test suite for the kamailio KEMI Lua engine

## Operational Role

For a systems engineer, kemi-test-suite belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-484f12fa4470cf` from `luarocks_root_manifest` as `registry_expansion`
