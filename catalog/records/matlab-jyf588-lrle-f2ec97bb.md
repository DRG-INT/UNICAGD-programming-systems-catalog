...
<!-- canonical: https://github.com/jyf588/lrle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jyf588/lrle](https://github.com/jyf588/lrle) |
| Source record ids | github_search_matlab-7c8fdacaf867e8 |

## System Engineer Summary

Code for "Synthesis of Biologically Realistic Human Motion Using Joint Torque Actuation", SIGGRAPH
2019

## Operational Role

For a systems engineer, jyf588/lrle belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-15T02:57:36Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-7c8fdacaf867e8` from `github_search_matlab` as `registry_expansion`
