...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_assembly-7da289a334d514 |
...
For a systems engineer, reworkd/AgentGPT belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-29T01:19:32Z | gh search repos assembler stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_assembly-7da289a334d514` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mytechnotalent/Hacking-Windows | Configuration | [open](assembly-mytechnotalent-hacking-windows-8a5a66d0.md) |
