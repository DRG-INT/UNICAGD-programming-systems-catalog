...
<!-- canonical: https://crates.io/crates/plist -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.1 | 2026-09-06T11:48:22.356707Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-09T18:23:52+00:00`.
...
- `crates_io-49679cee2a2369` from `crates_io` as `registry_expansion`
