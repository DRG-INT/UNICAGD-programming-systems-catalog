...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NeLy-EPFL/flygym -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NeLy-EPFL/flygym](https://github.com/NeLy-EPFL/flygym) |
| Source record ids | github_search_physics_engines-bba59d3de8d7c2 |
...
For a systems engineer, NeLy-EPFL/flygym belongs in the Physics Engines inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T11:57:38Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-bba59d3de8d7c2` from `github_search_physics_engines` as `registry_expansion`
