...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/hashtable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hashtable/index.html](https://cran.r-project.org/web/packages/hashtable/index.html) |
| Source record ids | cran_packages_by_date-14d8ec07614aa3 |

## System Engineer Summary

hashtable is tracked as a cryptography record in the R branch. The source did not provide a long
...
For a systems engineer, hashtable belongs in the R inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-20 11:10:09 UTC | [https://cran.r-project.org/web/packages/hashtable/DESCRIPTION](https://cran.r-project.org/web/packages/hashtable/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hashtable/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-14d8ec07614aa3` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mx.crypto | Cryptography | [open](r-mx-crypto-b14a1d72.md) |
| openfhe.R | Cryptography | [open](r-openfhe-r-3744e327.md) |
| RcppFarmHash | Cryptography | [open](r-rcppfarmhash-9f38b81a.md) |
| safer | Cryptography | [open](r-safer-2f54e742.md) |
| SSLfmm | Cryptography | [open](r-sslfmm-522a5740.md) |
