...
<!-- canonical: https://cran.r-project.org/web/packages/gpciEMprogII/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpciEMprogII/index.html](https://cran.r-project.org/web/packages/gpciEMprogII/index.html) |
| Source record ids | cran_packages_by_date-9858673dc5e3a7 |

## System Engineer Summary

Generalized Process Capability Indices via EM Algorithm under Progressive Type-II Censoring

## Operational Role

For a systems engineer, gpciEMprogII belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:50:02 UTC | [https://cran.r-project.org/web/packages/gpciEMprogII/DESCRIPTION](https://cran.r-project.org/web/packages/gpciEMprogII/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpciEMprogII/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9858673dc5e3a7` from `cran_packages_by_date` as `registry_expansion`
