# SAP-samples/cloud-cap-with-javascript-basics

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SAP-samples/cloud-cap-with-javascript-basics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-samples/cloud-cap-with-javascript-basics](https://github.com/SAP-samples/cloud-cap-with-javascript-basics) |
| Source record ids | github_search_sapjava-36a3e5fdc29db9 |

## System Engineer Summary

This is an SAP Cloud Application Programming Model project that demonstrates how to integrate and
use standard JavaScript within your CAP application. It also teaches basic JavaScript techniques and
language elements that will be helpful in CAP development.

## Operational Role

For a systems engineer, SAP-samples/cloud-cap-with-javascript-basics belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-12T17:46:40Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-36a3e5fdc29db9` from `github_search_sapjava` as `registry_expansion`
