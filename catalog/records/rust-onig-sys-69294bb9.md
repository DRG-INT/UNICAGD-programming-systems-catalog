...
<!-- canonical: https://crates.io/crates/onig_sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/onig_sys](https://crates.io/crates/onig_sys) |
| Source record ids | crates_io-9b7cb9a22ebdd8 |

## System Engineer Summary

The `onig_sys` crate contains raw rust bindings to the oniguruma library. This crate exposes a set
of unsafe functions which can then be used by other crates to create safe wrappers around Oniguruma.
You probably don't want to link to this crate directly; instead check out the `onig` crate.

## Operational Role

For a systems engineer, onig_sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 69.9.3 | 2026-04-27T06:46:34.575546Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
| Evidence | Apache-2.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `crates_io-9b7cb9a22ebdd8` from `crates_io` as `registry_expansion`
