...
| Canonical URL | [https://crates.io/crates/gl_generator](https://crates.io/crates/gl_generator) |
| Source record ids | crates_io-b3b4244e91e7a4 |
...
For a systems engineer, gl_generator belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2019-10-03T10:44:28.795911Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-b3b4244e91e7a4` from `crates_io` as `registry_expansion`
