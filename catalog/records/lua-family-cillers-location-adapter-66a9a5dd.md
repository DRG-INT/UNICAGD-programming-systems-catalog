...
<!-- canonical: https://luarocks.org/modules/pederbl/cillers-location-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/pederbl/cillers-location-adapter](https://luarocks.org/modules/pederbl/cillers-location-adapter) |
| Source record ids | luarocks_root_manifest-5bce9523a3c768 |

## System Engineer Summary

Kong plugin to rewrite domain and base path in Location header of 301/302 responses, handling both
absolute and relative URLs.

## Operational Role

For a systems engineer, cillers-location-adapter belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-5bce9523a3c768` from `luarocks_root_manifest` as `registry_expansion`
