...
| Canonical URL | [https://crates.io/crates/async-graphql-derive](https://crates.io/crates/async-graphql-derive) |
| Source record ids | crates_io-c75a8bc0dddc65 |
...
For a systems engineer, async-graphql-derive belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.1 | 2026-04-21T22:45:20.573211Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-c75a8bc0dddc65` from `crates_io` as `registry_expansion`
