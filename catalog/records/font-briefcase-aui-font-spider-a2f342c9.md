...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aui/font-spider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aui/font-spider](https://github.com/aui/font-spider) |
| Source record ids | github_search_font_briefcase-e214d918b40fcd |
...
For a systems engineer, aui/font-spider belongs in the Font Briefcase inventory as part of low-noise
code review, style consistency, and automation-friendly editing.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-30T18:18:29Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:woff2 stars:>10", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_font_briefcase-e214d918b40fcd` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aMarCruz/react-native-text-size | Formatter | [open](font-briefcase-amarcruz-react-native-text-size-2c4b2ae8.md) |
| awesometoolbox/otf2ttf | Formatter | [open](font-briefcase-awesometoolbox-otf2ttf-ccda9c3a.md) |
| BlackFoundryCom/InriaFonts | Formatter | [open](font-briefcase-blackfoundrycom-inriafonts-807e09e2.md) |
| johanmattssonm/birdfont | Formatter | [open](font-briefcase-johanmattssonm-birdfont-d2d1ca46.md) |
| kokokuo/scraper-fourone-jobs | Formatter | [open](font-briefcase-kokokuo-scraper-fourone-jobs-469cbe70.md) |
| KonghaYao/chinese-free-web-font-storage | Formatter | [open](font-briefcase-konghayao-chinese-free-web-font-storage-7df90ad6.md) |
| rbanffy/3270font | Formatter | [open](font-briefcase-rbanffy-3270font-bb4cce98.md) |
| SixLabors/Fonts | Formatter | [open](font-briefcase-sixlabors-fonts-14452040.md) |
