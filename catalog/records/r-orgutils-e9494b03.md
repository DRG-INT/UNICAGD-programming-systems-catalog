...
<!-- canonical: https://cran.r-project.org/web/packages/orgutils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/orgutils/index.html](https://cran.r-project.org/web/packages/orgutils/index.html) |
| Source record ids | cran_packages_by_date-97170fe8a9b94c |
...
For a systems engineer, orgutils belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5-4 | 2026-08-21 05:41:26 UTC | [https://cran.r-project.org/web/packages/orgutils/DESCRIPTION](https://cran.r-project.org/web/packages/orgutils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/orgutils/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-97170fe8a9b94c` from `cran_packages_by_date` as `registry_expansion`
