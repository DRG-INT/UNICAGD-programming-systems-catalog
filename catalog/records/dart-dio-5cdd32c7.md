...
<!-- canonical: https://pub.dev/packages/dio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dio](https://pub.dev/packages/dio) |
| Source record ids | pub_dev-b7eb562fdcc7a4 |

## System Engineer Summary

A powerful HTTP networking package, supports Interceptors, Aborting and canceling a request, Custom
adapters, Transformers, etc.

## Operational Role

For a systems engineer, dio belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.11.1 | 2026-09-04T02:46:21.721502Z | [https://pub.dev/api/packages/dio](https://pub.dev/api/packages/dio) |  |
| preview | known | 4.0.5-beta1 | 2021-11-28T09:11:57.047556Z | [https://pub.dev/api/packages/dio](https://pub.dev/api/packages/dio) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dio` at `2026-09-04T03:19:45+00:00`.
...
- `pub_dev-b7eb562fdcc7a4` from `pub_dev` as `registry_expansion`
