...
<!-- canonical: https://cran.r-project.org/web/packages/fastgbm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastgbm/index.html](https://cran.r-project.org/web/packages/fastgbm/index.html) |
| Source record ids | cran_packages_by_date-29b48f4811b2c8 |
...
For a systems engineer, fastgbm belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-09-01 11:50:12 UTC | [https://cran.r-project.org/web/packages/fastgbm/DESCRIPTION](https://cran.r-project.org/web/packages/fastgbm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastgbm/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-29b48f4811b2c8` from `cran_packages_by_date` as `registry_expansion`
