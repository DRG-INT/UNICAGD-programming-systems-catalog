...
| Canonical URL | [https://crates.io/crates/compiler_builtins](https://crates.io/crates/compiler_builtins) |
| Source record ids | crates_io-a3ec9ec82f02c8 |
...
For a systems engineer, compiler_builtins belongs in the Rust inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.160 | 2025-05-30T16:00:57.034414Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-a3ec9ec82f02c8` from `crates_io` as `registry_expansion`
