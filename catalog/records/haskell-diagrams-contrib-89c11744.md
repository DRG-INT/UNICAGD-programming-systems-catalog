...
<!-- canonical: https://hackage.haskell.org/package/diagrams-contrib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/diagrams-contrib](https://hackage.haskell.org/package/diagrams-contrib) |
| Source record ids | hackage_top_downloads-3a7130cce4ea55 |
...
For a systems engineer, diagrams-contrib belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.6 | 2024-10-29T18:11:54Z | [https://hackage.haskell.org/package/diagrams-contrib](https://hackage.haskell.org/package/diagrams-contrib) |  |
| candidate | partial | 1.1.1.2 |  | [https://hackage.haskell.org/package/diagrams-contrib](https://hackage.haskell.org/package/diagrams-contrib) | hackage_candidate_date_missing |
...
| --- | --- |
| Detected family | MIT |
| Evidence | SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; The Unlicense; https://api.github.com/licenses/unlicense; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/diagrams-contrib` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-3a7130cce4ea55` from `hackage_top_downloads` as `registry_expansion`
