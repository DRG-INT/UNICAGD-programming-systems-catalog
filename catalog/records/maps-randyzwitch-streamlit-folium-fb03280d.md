...
<!-- canonical: https://github.com/randyzwitch/streamlit-folium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/randyzwitch/streamlit-folium](https://github.com/randyzwitch/streamlit-folium) |
| Source record ids | github_search_maps-0168275f9945ed |
...
For a systems engineer, randyzwitch/streamlit-folium belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T16:53:53Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0168275f9945ed` from `github_search_maps` as `registry_expansion`
