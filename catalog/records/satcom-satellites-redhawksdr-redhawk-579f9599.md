...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/RedhawkSDR/redhawk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RedhawkSDR/redhawk](https://github.com/RedhawkSDR/redhawk) |
| Source record ids | github_search_satcom_satellites-6c1706e1390f37 |

## System Engineer Summary

A submodule repository for distributing REDHAWK artifacts and the latest REDHAWK source code. Use
'git clone --recurse-submodules git@github.com:RedhawkSDR/redhawk.git' to also clone all submodules.

## Operational Role

For a systems engineer, RedhawkSDR/redhawk belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-12T19:01:24Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-6c1706e1390f37` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alanbjohnston/CubeSatSim | Undefined Behavior Analyzer | [open](satcom-satellites-alanbjohnston-cubesatsim-60b47603.md) |
| cjcliffe/CubicSDR | Undefined Behavior Analyzer | [open](satcom-satellites-cjcliffe-cubicsdr-45606659.md) |
| f4exb/sdrangel | Undefined Behavior Analyzer | [open](satcom-satellites-f4exb-sdrangel-2094320b.md) |
| jvde-github/AIS-catcher | Undefined Behavior Analyzer | [open](satcom-satellites-jvde-github-ais-catcher-a66fcf35.md) |
| kismetwireless/kismet | Undefined Behavior Analyzer | [open](satcom-satellites-kismetwireless-kismet-f1e1e53d.md) |
| KubOS-Preservation-Group/ccsds-spacepacket | Undefined Behavior Analyzer | [open](satcom-satellites-kubos-preservation-group-ccsds-spacepacket-4cff5034.md) |
| libcsp/libcsp | Undefined Behavior Analyzer | [open](satcom-satellites-libcsp-libcsp-abe29c50.md) |
| Mejiro-McQueen/Bifrost | Undefined Behavior Analyzer | [open](satcom-satellites-mejiro-mcqueen-bifrost-545d8ca0.md) |
