...
| Canonical URL | [https://github.com/kfrlib/kfr](https://github.com/kfrlib/kfr) |
| Source record ids | github_search_audio-02c194b4f65388 |

## System Engineer Summary

Fast, modern C++ DSP framework, FFT, Sample Rate Conversion, FIR/IIR/Biquad Filters (SSE, AVX,
AVX-512, ARM NEON, RISC-V RVV)

## Operational Role

For a systems engineer, kfrlib/kfr belongs in the Audio inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2026-08-18T13:31:45Z | [https://api.github.com/repos/kfrlib/kfr/releases/latest](https://api.github.com/repos/kfrlib/kfr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/kfrlib/kfr/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-02c194b4f65388` from `github_search_audio` as `registry_expansion`
