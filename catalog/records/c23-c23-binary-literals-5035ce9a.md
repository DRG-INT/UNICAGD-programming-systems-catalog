...
| Source record ids | corpus-3e0dd8bff4e251 |

## System Engineer Summary

C23 binary literals is tracked as a language specification record in the C23 branch. The source did
...
For a systems engineer, C23 binary literals belongs in the C23 inventory as part of ecosystem
...
- `corpus-3e0dd8bff4e251` from `master_json` as `language_specification`
