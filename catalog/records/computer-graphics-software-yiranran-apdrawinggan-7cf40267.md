...
<!-- canonical: https://github.com/yiranran/APDrawingGAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yiranran/APDrawingGAN](https://github.com/yiranran/APDrawingGAN) |
| Source record ids | github_search_computer_graphics_software-7f47208e6533fb |

## System Engineer Summary

Code for APDrawingGAN: Generating Artistic Portrait Drawings from Face Photos with Hierarchical GANs
(CVPR 2019 Oral)

## Operational Role

For a systems engineer, yiranran/APDrawingGAN belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-7f47208e6533fb` from `github_search_computer_graphics_software` as `registry_expansion`
