...
<!-- canonical: https://cran.r-project.org/web/packages/CopulaSCR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CopulaSCR/index.html](https://cran.r-project.org/web/packages/CopulaSCR/index.html) |
| Source record ids | cran_packages_by_date-16106d3f9420d6 |

## System Engineer Summary

Analysis of Semi-Competing Risks Data Using Copula-Based Models

## Operational Role

For a systems engineer, CopulaSCR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-21 06:50:13 UTC | [https://cran.r-project.org/web/packages/CopulaSCR/DESCRIPTION](https://cran.r-project.org/web/packages/CopulaSCR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CopulaSCR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-16106d3f9420d6` from `cran_packages_by_date` as `registry_expansion`
