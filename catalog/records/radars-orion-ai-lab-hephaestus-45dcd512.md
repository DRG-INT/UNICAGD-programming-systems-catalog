...
<!-- canonical: https://github.com/Orion-AI-Lab/Hephaestus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Orion-AI-Lab/Hephaestus](https://github.com/Orion-AI-Lab/Hephaestus) |
| Source record ids | github_search_radars-c601db81a16d63 |
...
For a systems engineer, Orion-AI-Lab/Hephaestus belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-03T13:31:50Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:synthetic-aperture-radar stars:>10", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_radars-c601db81a16d63` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adugnag/deSpeckNet | Machine Learning | [open](radars-adugnag-despecknet-1dbca38a.md) |
| AIRCentre/SARProcessing.jl | Machine Learning | [open](radars-aircentre-sarprocessing-jl-e4affcda.md) |
| aisari/AutofocusSAR | Machine Learning | [open](radars-aisari-autofocussar-2db12203.md) |
| chrieke/awesome-satellite-imagery-datasets | Machine Learning | [open](radars-chrieke-awesome-satellite-imagery-datasets-a1e3d23a.md) |
| commaai/laika | Machine Learning | [open](radars-commaai-laika-8070befa.md) |
| davemlz/eemont | Machine Learning | [open](radars-davemlz-eemont-70a2fd1c.md) |
| denkywu/PolSAR-Calibration | Machine Learning | [open](radars-denkywu-polsar-calibration-3583ff0d.md) |
