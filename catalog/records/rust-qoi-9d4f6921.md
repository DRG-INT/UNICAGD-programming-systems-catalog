...
<!-- canonical: https://crates.io/crates/qoi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/qoi](https://crates.io/crates/qoi) |
| Source record ids | crates_io-e1c4a9b0d067ba |
...
For a systems engineer, qoi belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2022-10-16T23:52:56.288067Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `crates_io-e1c4a9b0d067ba` from `crates_io` as `registry_expansion`
