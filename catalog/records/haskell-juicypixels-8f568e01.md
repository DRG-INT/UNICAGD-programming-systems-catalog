...
<!-- canonical: https://hackage.haskell.org/package/JuicyPixels -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/JuicyPixels](https://hackage.haskell.org/package/JuicyPixels) |
| Source record ids | hackage_top_downloads-d264010946302e |
...
For a systems engineer, JuicyPixels belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.9 | 2024-06-06T18:35:17Z | [https://hackage.haskell.org/package/JuicyPixels](https://hackage.haskell.org/package/JuicyPixels) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/JuicyPixels` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-d264010946302e` from `hackage_top_downloads` as `registry_expansion`
