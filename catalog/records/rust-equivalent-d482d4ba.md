...
<!-- canonical: https://crates.io/crates/equivalent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/equivalent](https://crates.io/crates/equivalent) |
| Source record ids | crates_io-0f9a34d898f898 |
...
For a systems engineer, equivalent belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2025-02-14T22:14:18.212755Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-0f9a34d898f898` from `crates_io` as `registry_expansion`
