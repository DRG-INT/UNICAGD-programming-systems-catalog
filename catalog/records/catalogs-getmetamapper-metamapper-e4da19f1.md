...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/getmetamapper/metamapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/getmetamapper/metamapper](https://github.com/getmetamapper/metamapper) |
| Source record ids | github_search_catalogs-f5114a05f86198 |

## System Engineer Summary

Metamapper is a data discovery and documentation platform for improving how teams understand and
interact with their data.

## Operational Role

For a systems engineer, getmetamapper/metamapper belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-15T15:30:22Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-f5114a05f86198` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| docglow/docglow | Documentation | [open](catalogs-docglow-docglow-c732b78c.md) |
| jscoach/support | Documentation | [open](catalogs-jscoach-support-5dd01b25.md) |
