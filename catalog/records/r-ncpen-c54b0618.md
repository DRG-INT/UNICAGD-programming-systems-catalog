...
<!-- canonical: https://cran.r-project.org/web/packages/ncpen/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ncpen/index.html](https://cran.r-project.org/web/packages/ncpen/index.html) |
| Source record ids | cran_packages_by_date-e8bab8b7432354 |
...
For a systems engineer, ncpen belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-20 09:20:10 UTC | [https://cran.r-project.org/web/packages/ncpen/DESCRIPTION](https://cran.r-project.org/web/packages/ncpen/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ncpen/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e8bab8b7432354` from `cran_packages_by_date` as `registry_expansion`
