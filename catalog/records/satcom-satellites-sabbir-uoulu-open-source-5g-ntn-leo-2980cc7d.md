...
<!-- canonical: https://github.com/sabbir-uoulu/open-source-5g-ntn-leo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sabbir-uoulu/open-source-5g-ntn-leo](https://github.com/sabbir-uoulu/open-source-5g-ntn-leo) |
| Source record ids | github_search_satcom_satellites-a90deba10a781a |

## System Engineer Summary

LEO extension of the open-source 5G NR NTN testbed: full satellite pass with live propagation delay
and Doppler tracking, 600 km orbit. Companion to open-source-5g-ntn.

## Operational Role

For a systems engineer, sabbir-uoulu/open-source-5g-ntn-leo belongs in the SatCom Satellites
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T20:32:54Z | gh search repos topic:satellite-communications stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-a90deba10a781a` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| avinashbot/satellite | Testing Framework | [open](satcom-satellites-avinashbot-satellite-fad7a270.md) |
