...
| Source record ids | corpus-116b5d20fdad21 |

## System Engineer Summary

MariaDB Connector/C is tracked as a database datastore record in the C99 branch. The source did not
...
For a systems engineer, MariaDB Connector/C belongs in the C99 inventory as part of state
...
- `corpus-116b5d20fdad21` from `master_json` as `database_datastore`
