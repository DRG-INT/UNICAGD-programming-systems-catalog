...
| Source record ids | corpus-1af0585acd9b0d |

## System Engineer Summary

cattrs is tracked as a serialization record in the Python branch. The source did not provide a long
...
For a systems engineer, cattrs belongs in the Python inventory as part of wire formats, persistence,
...
- `corpus-1af0585acd9b0d` from `master_json` as `serialization`
...
| orjson | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-orjson-ee3532c8.md) |
