...
<!-- canonical: https://github.com/be5invis/Iosevka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/be5invis/Iosevka](https://github.com/be5invis/Iosevka) |
| Source record ids | github_search_font_briefcase-80a5f66c9efafc |
...
For a systems engineer, be5invis/Iosevka belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T03:39:33Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-80a5f66c9efafc` from `github_search_font_briefcase` as `registry_expansion`
