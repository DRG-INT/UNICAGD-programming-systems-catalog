...
<!-- canonical: https://pub.dev/packages/searchable_listview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/searchable_listview](https://pub.dev/packages/searchable_listview) |
| Source record ids | pub_dev-ca77706eb3da96 |

## System Engineer Summary

A new easy way to filter listview with simple implementation with possibilty to customize search
field and empty widget

## Operational Role

For a systems engineer, searchable_listview belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.19.5 | 2026-05-30T11:19:25.055881Z | [https://pub.dev/api/packages/searchable_listview](https://pub.dev/api/packages/searchable_listview) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/searchable_listview` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-ca77706eb3da96` from `pub_dev` as `registry_expansion`
