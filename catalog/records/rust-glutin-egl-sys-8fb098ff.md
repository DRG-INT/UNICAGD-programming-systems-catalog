...
<!-- canonical: https://crates.io/crates/glutin_egl_sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/glutin_egl_sys](https://crates.io/crates/glutin_egl_sys) |
| Source record ids | crates_io-b36d37df20ecfd |
...
For a systems engineer, glutin_egl_sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2025-01-12T09:53:13.771937Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
