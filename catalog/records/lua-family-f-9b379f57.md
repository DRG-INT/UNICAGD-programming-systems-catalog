...
| Canonical URL | [https://luarocks.org/modules/desvelao/f](https://luarocks.org/modules/desvelao/f) |
| Source record ids | luarocks_root_manifest-799ac646538f04 |
...
For a systems engineer, f belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-799ac646538f04` from `luarocks_root_manifest` as `registry_expansion`
