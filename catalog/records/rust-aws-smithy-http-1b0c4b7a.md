...
<!-- canonical: https://crates.io/crates/aws-smithy-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-smithy-http](https://crates.io/crates/aws-smithy-http) |
| Source record ids | crates_io-77e43037b10c02 |
...
For a systems engineer, aws-smithy-http belongs in the Rust inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.64.0 | 2026-07-07T18:17:21.128942Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-77e43037b10c02` from `crates_io` as `registry_expansion`
