...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/thi-ng/umbrella -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thi-ng/umbrella](https://github.com/thi-ng/umbrella) |
| Source record ids | github_search_webassembly-693dd2fe4e9e9c |

## System Engineer Summary

⛱ Broadly scoped ecosystem & mono-repository of 215 TypeScript projects (and ~185 examples) for
general purpose, functional, data driven development

## Operational Role

For a systems engineer, thi-ng/umbrella belongs in the WebAssembly inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T10:59:30Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:webassembly stars:>500", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_webassembly-693dd2fe4e9e9c` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| liam-hq/liam | Type Checker | [open](webassembly-liam-hq-liam-88219c45.md) |
