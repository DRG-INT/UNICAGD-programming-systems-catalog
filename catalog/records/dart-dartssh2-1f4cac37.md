...
<!-- canonical: https://pub.dev/packages/dartssh2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dartssh2](https://pub.dev/packages/dartssh2) |
| Source record ids | pub_dev-33391971128f73 |
...
For a systems engineer, dartssh2 belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-09-04T07:50:09.533996Z | [https://pub.dev/api/packages/dartssh2](https://pub.dev/api/packages/dartssh2) |  |
| preview | known | 2.9.1-pre | 2023-04-02T16:14:20.492321Z | [https://pub.dev/api/packages/dartssh2](https://pub.dev/api/packages/dartssh2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dartssh2` at `2026-09-04T08:21:51+00:00`.
...
- `pub_dev-33391971128f73` from `pub_dev` as `registry_expansion`
