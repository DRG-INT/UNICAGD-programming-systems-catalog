...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://count.ly -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Cocoa |
| Category | Filesystem Os |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://count.ly](https://count.ly) |
| Source record ids | awesome_list-4d105f8d3a8c72 |

## System Engineer Summary

Open source, mobile & web analytics, crash reports and push notifications platform for iOS &
Android.

## Operational Role

For a systems engineer, Countly belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.1.0 | 2026-02-18 14:12:24 UTC | [https://trunk.cocoapods.org/api/v1/pods/Countly](https://trunk.cocoapods.org/api/v1/pods/Countly) |  |
| preview/nightly | unknown |  |  | unknown | cocoapods_preview_version_missing |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Countly` at `2026-09-01T07:24:05+00:00`.
- Preview/nightly metadata is unknown because `cocoapods_preview_version_missing`.
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Analytics", "source_url": "https://raw.githubusercontent.com/vsouza/awesome-ios/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-4d105f8d3a8c72` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alaingalvan/CrossWindow | Filesystem Os | [open](cocoa-alaingalvan-crosswindow-b9767615.md) |
| armadsen/ORSSerialPort | Filesystem Os | [open](cocoa-armadsen-orsserialport-ea69ce4d.md) |
| bradjasper/RadialMenu | Filesystem Os | [open](cocoa-bradjasper-radialmenu-22394b23.md) |
| CleanArchitectureRxSwift | Filesystem Os | [open](cocoa-cleanarchitecturerxswift-cd79b32d.md) |
| codam-coding-college/MLX42 | Filesystem Os | [open](cocoa-codam-coding-college-mlx42-9cfc2f7b.md) |
| coding/Coding-iOS | Filesystem Os | [open](cocoa-coding-coding-ios-dbb20773.md) |
| ColleagueRiley/RGFW | Filesystem Os | [open](cocoa-colleagueriley-rgfw-e967884f.md) |
| Danie1s/Tiercel | Filesystem Os | [open](cocoa-danie1s-tiercel-5ed21306.md) |
