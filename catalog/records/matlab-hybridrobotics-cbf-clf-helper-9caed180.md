...
<!-- canonical: https://github.com/HybridRobotics/CBF-CLF-Helper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HybridRobotics/CBF-CLF-Helper](https://github.com/HybridRobotics/CBF-CLF-Helper) |
| Source record ids | github_search_matlab-1d8f87f93b7032 |

## System Engineer Summary

Matlab Interface for Control Barrier Function (CBF) and Control Lyapunov Function (CLF) based
control methods.

## Operational Role

For a systems engineer, HybridRobotics/CBF-CLF-Helper belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-30T23:09:51Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-1d8f87f93b7032` from `github_search_matlab` as `registry_expansion`
