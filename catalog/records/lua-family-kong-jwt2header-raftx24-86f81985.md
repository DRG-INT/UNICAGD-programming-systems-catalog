...
| Canonical URL | [https://luarocks.org/modules/raftx24/kong-jwt2header-raftx24](https://luarocks.org/modules/raftx24/kong-jwt2header-raftx24) |
| Source record ids | luarocks_root_manifest-f0faabb174841e |
...
For a systems engineer, kong-jwt2header-raftx24 belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-f0faabb174841e` from `luarocks_root_manifest` as `registry_expansion`
