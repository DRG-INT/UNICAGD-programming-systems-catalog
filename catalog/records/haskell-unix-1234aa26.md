...
<!-- canonical: https://hackage.haskell.org/package/unix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/unix](https://hackage.haskell.org/package/unix) |
| Source record ids | hackage_top_downloads-d9d94c61cddda5 |
...
For a systems engineer, unix belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.8.0 | 2025-09-23T08:10:23Z | [https://hackage.haskell.org/package/unix](https://hackage.haskell.org/package/unix) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/unix` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-d9d94c61cddda5` from `hackage_top_downloads` as `registry_expansion`
