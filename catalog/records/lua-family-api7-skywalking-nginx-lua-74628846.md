...
<!-- canonical: https://luarocks.org/modules/membphis/api7-skywalking-nginx-lua -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-8885b96357d40c` from `luarocks_root_manifest` as `registry_expansion`
