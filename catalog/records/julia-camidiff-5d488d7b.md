...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CamiDiff](https://github.com/JuliaRegistries/General/tree/master/C/CamiDiff) |
| Source record ids | julia_general-fdb0fc095ef3d3 |

## System Engineer Summary

Julia package registered in General at C/CamiDiff.

## Operational Role

For a systems engineer, CamiDiff belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CamiDiff", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-fdb0fc095ef3d3` from `julia_general` as `registry_expansion`
