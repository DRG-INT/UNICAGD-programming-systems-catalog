...
<!-- canonical: https://cran.r-project.org/web/packages/immunaut/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/immunaut/index.html](https://cran.r-project.org/web/packages/immunaut/index.html) |
| Source record ids | cran_packages_by_date-2cb9dc93bc79b9 |
...
For a systems engineer, immunaut belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-10 13:10:02 UTC | [https://cran.r-project.org/web/packages/immunaut/DESCRIPTION](https://cran.r-project.org/web/packages/immunaut/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/immunaut/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-2cb9dc93bc79b9` from `cran_packages_by_date` as `registry_expansion`
