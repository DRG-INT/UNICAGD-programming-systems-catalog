...
<!-- canonical: https://github.com/rabbitmq/rabbitmq-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rabbitmq/rabbitmq-server](https://github.com/rabbitmq/rabbitmq-server) |
| Source record ids | github_search_video-1e696d8874f7bd |
...
For a systems engineer, rabbitmq/rabbitmq-server belongs in the Video inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:11:19Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-1e696d8874f7bd` from `github_search_video` as `registry_expansion`
