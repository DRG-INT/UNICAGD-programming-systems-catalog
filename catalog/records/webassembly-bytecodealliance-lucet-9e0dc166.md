...
<!-- canonical: https://github.com/bytecodealliance/lucet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/lucet](https://github.com/bytecodealliance/lucet) |
| Source record ids | github_search_webassembly-3707256bd79002 |
...
For a systems engineer, bytecodealliance/lucet belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-23T22:18:15Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_webassembly-3707256bd79002` from `github_search_webassembly` as `registry_expansion`
