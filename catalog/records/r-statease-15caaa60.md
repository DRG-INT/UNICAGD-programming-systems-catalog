...
<!-- canonical: https://cran.r-project.org/web/packages/statease/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/statease/index.html](https://cran.r-project.org/web/packages/statease/index.html) |
| Source record ids | cran_packages_by_date-6d0d68da8d9a6f |
...
For a systems engineer, statease belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-20 11:00:02 UTC | [https://cran.r-project.org/web/packages/statease/DESCRIPTION](https://cran.r-project.org/web/packages/statease/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/statease/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6d0d68da8d9a6f` from `cran_packages_by_date` as `registry_expansion`
