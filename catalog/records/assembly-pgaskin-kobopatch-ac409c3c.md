...
<!-- canonical: https://github.com/pgaskin/kobopatch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pgaskin/kobopatch](https://github.com/pgaskin/kobopatch) |
| Source record ids | github_search_assembly-bfe50e96363d9b |
...
For a systems engineer, pgaskin/kobopatch belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-17T19:44:48Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-bfe50e96363d9b` from `github_search_assembly` as `registry_expansion`
