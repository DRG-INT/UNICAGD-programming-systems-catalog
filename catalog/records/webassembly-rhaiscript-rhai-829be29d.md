...
| Canonical URL | [https://github.com/rhaiscript/rhai](https://github.com/rhaiscript/rhai) |
| Source record ids | github_search_webassembly-d8cd7c49ec85de |
...
For a systems engineer, rhaiscript/rhai belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.26.0 | 2026-08-25T03:08:49Z | [https://api.github.com/repos/rhaiscript/rhai/releases/latest](https://api.github.com/repos/rhaiscript/rhai/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rhaiscript/rhai/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-d8cd7c49ec85de` from `github_search_webassembly` as `registry_expansion`
