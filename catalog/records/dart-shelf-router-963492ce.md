...
<!-- canonical: https://pub.dev/packages/shelf_router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_router](https://pub.dev/packages/shelf_router) |
| Source record ids | pub_dev-c7ff5a000b7746 |

## System Engineer Summary

A convenient request router for the shelf web-framework, with support for URL-parameters, nested
routers and routers generated from source annotations.

## Operational Role

For a systems engineer, shelf_router belongs in the Dart inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2023-05-03T19:25:10.348546Z | [https://pub.dev/api/packages/shelf_router](https://pub.dev/api/packages/shelf_router) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_router` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-c7ff5a000b7746` from `pub_dev` as `registry_expansion`
