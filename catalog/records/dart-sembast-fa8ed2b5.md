...
<!-- canonical: https://pub.dev/packages/sembast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sembast](https://pub.dev/packages/sembast) |
| Source record ids | pub_dev-656efa4d9c52e8 |

## System Engineer Summary

NoSQL persistent embedded file system document-based database for Dart VM and Flutter with
encryption support.

## Operational Role

For a systems engineer, sembast belongs in the Dart inventory as part of runtime behavior,
...
| preview | known | 3.8.10-1 | 2026-07-02T10:49:11.605435Z | [https://pub.dev/api/packages/sembast](https://pub.dev/api/packages/sembast) |  |
...
- `pub_dev-656efa4d9c52e8` from `pub_dev` as `registry_expansion`
