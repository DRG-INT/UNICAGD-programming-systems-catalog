# alxspiker/avbd-demo3d

## Navigation

[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/alxspiker/avbd-demo3d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alxspiker/avbd-demo3d](https://github.com/alxspiker/avbd-demo3d) |
| Source record ids | github_search_physics_engines-aaf6046d143f2d |

## System Engineer Summary

It implements the Augmented Vertex Block Descendent (AVBD) algorithm, bringing the concepts from the
original 2D demo into a fully 3D environment.

## Operational Role

For a systems engineer, alxspiker/avbd-demo3d belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-06T06:52:19Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:rigid-body-dynamics stars:>20", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_physics_engines-aaf6046d143f2d` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AshenvaleZX/ZXEngine | Configuration | [open](physics-engines-ashenvalezx-zxengine-87dcfc00.md) |
| FLAIROx/Kinetix | Configuration | [open](physics-engines-flairox-kinetix-5731856e.md) |
| google-deepmind/dm_control | Configuration | [open](physics-engines-google-deepmind-dm-control-4b6c3d97.md) |
