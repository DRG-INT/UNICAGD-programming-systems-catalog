...
| Canonical URL | [https://luarocks.org/modules/neorocks/go.nvim](https://luarocks.org/modules/neorocks/go.nvim) |
| Source record ids | luarocks_root_manifest-7501bc771c5cc4 |

## System Engineer Summary

A feature-rich Go development plugin, leveraging gopls, treesitter AST, Dap, and various Go tools to
enhance the dev experience.

## Operational Role

For a systems engineer, go.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7501bc771c5cc4` from `luarocks_root_manifest` as `registry_expansion`
