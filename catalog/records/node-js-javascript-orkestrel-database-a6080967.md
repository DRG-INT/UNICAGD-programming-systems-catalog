...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@orkestrel/database](https://www.npmjs.com/package/@orkestrel/database) |
| Source record ids | npm_registry-bd55859aff8d7e |

## System Engineer Summary

A typed database abstraction for the @orkestrel line — a single core engine over pluggable storage
drivers. Part of the @orkestrel line.

## Operational Role

For a systems engineer, @orkestrel/database belongs in the Node.js/JavaScript inventory as part of
state persistence, migrations, performance, and operational recovery.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.12 | 2026-08-23T01:10:55.362Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @accounts/database-manager | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-accounts-database-manager-5fb3adc6.md) |
| @antelopejs/database-decorators | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-antelopejs-database-decorators-90f7241b.md) |
| @antelopejs/interface-database | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-antelopejs-interface-database-3edcd00b.md) |
| @arkecosystem/core-database | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-arkecosystem-core-database-6184a8b1.md) |
| @arkstack/database | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-arkstack-database-828f146a.md) |
| @athenna/database | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-athenna-database-561068b6.md) |
| @atlantjs/database | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-atlantjs-database-9077aca2.md) |
| @bemi-io/drizzle | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-bemi-io-drizzle-decc4ae9.md) |
