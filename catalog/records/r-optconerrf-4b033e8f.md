...
<!-- canonical: https://cran.r-project.org/web/packages/optconerrf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/optconerrf/index.html](https://cran.r-project.org/web/packages/optconerrf/index.html) |
| Source record ids | cran_packages_by_date-1e029c53d9217f |
...
For a systems engineer, optconerrf belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-03 20:10:03 UTC | [https://cran.r-project.org/web/packages/optconerrf/DESCRIPTION](https://cran.r-project.org/web/packages/optconerrf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/optconerrf/DESCRIPTION` at `2026-09-03T20:18:45+00:00`.
...
- `cran_packages_by_date-1e029c53d9217f` from `cran_packages_by_date` as `registry_expansion`
