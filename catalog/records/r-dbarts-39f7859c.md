...
<!-- canonical: https://cran.r-project.org/web/packages/dbarts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dbarts/index.html](https://cran.r-project.org/web/packages/dbarts/index.html) |
| Source record ids | cran_packages_by_date-ba2ca97b30f3ac |
...
For a systems engineer, dbarts belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9-34 | 2026-08-21 17:30:16 UTC | [https://cran.r-project.org/web/packages/dbarts/DESCRIPTION](https://cran.r-project.org/web/packages/dbarts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dbarts/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ba2ca97b30f3ac` from `cran_packages_by_date` as `registry_expansion`
