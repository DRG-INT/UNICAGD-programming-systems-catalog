...
<!-- canonical: https://cran.r-project.org/web/packages/Rothermel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rothermel/index.html](https://cran.r-project.org/web/packages/Rothermel/index.html) |
| Source record ids | cran_packages_by_date-01571d9d83782a |
...
For a systems engineer, Rothermel belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2026-09-10 16:50:13 UTC | [https://cran.r-project.org/web/packages/Rothermel/DESCRIPTION](https://cran.r-project.org/web/packages/Rothermel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rothermel/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-01571d9d83782a` from `cran_packages_by_date` as `registry_expansion`
