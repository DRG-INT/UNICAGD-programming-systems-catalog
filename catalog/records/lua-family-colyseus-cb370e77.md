...
<!-- canonical: https://luarocks.org/modules/endel/colyseus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/endel/colyseus](https://luarocks.org/modules/endel/colyseus) |
| Source record ids | luarocks_root_manifest-0a27100dd4972a |
...
For a systems engineer, colyseus belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-0a27100dd4972a` from `luarocks_root_manifest` as `registry_expansion`
