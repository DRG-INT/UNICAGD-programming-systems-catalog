...
<!-- canonical: https://github.com/chatchat-space/Langchain-Chatchat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chatchat-space/Langchain-Chatchat](https://github.com/chatchat-space/Langchain-Chatchat) |
| Source record ids | github_search_aims-57f4316ff188ec |

## System Engineer Summary

Langchain-Chatchat（原Langchain-ChatGLM）基于 Langchain 与 ChatGLM, Qwen 与 Llama 等语言模型的 RAG 与 Agent 应用 |
Langchain-Chatchat (formerly langchain-ChatGLM), local knowledge based LLM (like ChatGLM, Qwen and
Llama) RAG and Agent app with langchain

## Operational Role

For a systems engineer, chatchat-space/Langchain-Chatchat belongs in the "aim's" inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-10T09:27:42Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-57f4316ff188ec` from `github_search_aims` as `registry_expansion`
