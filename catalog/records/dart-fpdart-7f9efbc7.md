...
<!-- canonical: https://pub.dev/packages/fpdart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fpdart](https://pub.dev/packages/fpdart) |
| Source record ids | pub_dev-c1ab3e74ac602d |
...
For a systems engineer, fpdart belongs in the Dart inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2025-10-29T11:51:54.287015Z | [https://pub.dev/api/packages/fpdart](https://pub.dev/api/packages/fpdart) |  |
| preview | known | 2.0.0-dev.3 | 2024-04-03T21:32:17.309082Z | [https://pub.dev/api/packages/fpdart](https://pub.dev/api/packages/fpdart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fpdart` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-c1ab3e74ac602d` from `pub_dev` as `registry_expansion`
