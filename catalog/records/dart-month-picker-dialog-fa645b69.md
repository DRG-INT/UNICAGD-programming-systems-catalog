...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.7.3 | 2026-09-10T23:21:19.443401Z | [https://pub.dev/api/packages/month_picker_dialog](https://pub.dev/api/packages/month_picker_dialog) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/month_picker_dialog` at `2026-09-11T00:27:32+00:00`.
