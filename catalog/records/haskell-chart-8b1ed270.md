...
<!-- canonical: https://hackage.haskell.org/package/Chart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Chart](https://hackage.haskell.org/package/Chart) |
| Source record ids | hackage_top_downloads-769eb1815cc949 |
...
For a systems engineer, Chart belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.5 | 2023-10-22T05:17:20Z | [https://hackage.haskell.org/package/Chart](https://hackage.haskell.org/package/Chart) |  |
| candidate | partial | 1.1 |  | [https://hackage.haskell.org/package/Chart](https://hackage.haskell.org/package/Chart) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Chart` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-769eb1815cc949` from `hackage_top_downloads` as `registry_expansion`
