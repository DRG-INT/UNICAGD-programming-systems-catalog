...
<!-- canonical: https://github.com/browser-use/browser-use -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/browser-use/browser-use](https://github.com/browser-use/browser-use) |
| Source record ids | github_search_aims-a7514dccd7ea6d |
...
For a systems engineer, browser-use/browser-use belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T07:39:39Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-a7514dccd7ea6d` from `github_search_aims` as `registry_expansion`
