...
<!-- canonical: https://hackage.haskell.org/package/extensible -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/extensible](https://hackage.haskell.org/package/extensible) |
| Source record ids | hackage_top_downloads-180e9544ec5bcb |
...
For a systems engineer, extensible belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.2 | 2024-12-05T00:57:58Z | [https://hackage.haskell.org/package/extensible](https://hackage.haskell.org/package/extensible) |  |
| candidate | partial | 0.5 |  | [https://hackage.haskell.org/package/extensible](https://hackage.haskell.org/package/extensible) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/extensible` at `2026-09-08T00:34:37+00:00`.
...
- `hackage_top_downloads-180e9544ec5bcb` from `hackage_top_downloads` as `registry_expansion`
