...
| Canonical URL | [https://luarocks.org/modules/numtech/kong-enhanced-http-log](https://luarocks.org/modules/numtech/kong-enhanced-http-log) |
| Source record ids | luarocks_root_manifest-4f0e6b0f2b5291 |

## System Engineer Summary

kong-enhanced-http-log is tracked as a networking http record in the Lua family branch. The source
...
For a systems engineer, kong-enhanced-http-log belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-4f0e6b0f2b5291` from `luarocks_root_manifest` as `registry_expansion`
