...
<!-- canonical: https://github.com/giacomo-folli/asmlings -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giacomo-folli/asmlings](https://github.com/giacomo-folli/asmlings) |
| Source record ids | github_search_assembly-5fe95f7e897f9e |

## System Engineer Summary

Learn x86 assembly through interactive exercises.

## Operational Role

For a systems engineer, giacomo-folli/asmlings belongs in the Assembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T12:52:18Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-5fe95f7e897f9e` from `github_search_assembly` as `registry_expansion`
