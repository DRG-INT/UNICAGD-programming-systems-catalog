...
<!-- canonical: https://pub.dev/packages/desktop_webview_window -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/desktop_webview_window](https://pub.dev/packages/desktop_webview_window) |
| Source record ids | pub_dev-e20fad69ed9451 |
...
For a systems engineer, desktop_webview_window belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-05-27T04:26:21.120995Z | [https://pub.dev/api/packages/desktop_webview_window](https://pub.dev/api/packages/desktop_webview_window) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/desktop_webview_window` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-e20fad69ed9451` from `pub_dev` as `registry_expansion`
