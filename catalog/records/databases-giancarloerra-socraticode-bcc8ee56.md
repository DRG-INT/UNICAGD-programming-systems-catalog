...
<!-- canonical: https://github.com/giancarloerra/SocratiCode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giancarloerra/SocratiCode](https://github.com/giancarloerra/SocratiCode) |
| Source record ids | github_search_databases-70e14464ccc5b2 |

## System Engineer Summary

Enterprise-grade (40m+ LOC) codebase intelligence, zero-setup, local & private
Plugin/Skill/Extension or MCP: hybrid semantic search, polyglot dependency graphs, symbol-level
impact analysis & call-flow, interactive HTML viewer, cross-project & branch-aware search,
DB/API/infra knowledge. 61% less tokens, 84% fewer calls, 37x faster. Cloud in beta.

## Operational Role

For a systems engineer, giancarloerra/SocratiCode belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T23:05:44Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-70e14464ccc5b2` from `github_search_databases` as `registry_expansion`
