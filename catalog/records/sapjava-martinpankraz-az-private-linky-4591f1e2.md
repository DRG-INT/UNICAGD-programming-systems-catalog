...
<!-- canonical: https://github.com/MartinPankraz/az-private-linky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MartinPankraz/az-private-linky](https://github.com/MartinPankraz/az-private-linky) |
| Source record ids | github_search_sapjava-82f26d5ede5209 |

## System Engineer Summary

Java Project to get you started with SAP BTP Private Link Service for Azure with SAP Cloud SDK

## Operational Role

For a systems engineer, MartinPankraz/az-private-linky belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-11T06:13:36Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-82f26d5ede5209` from `github_search_sapjava` as `registry_expansion`
