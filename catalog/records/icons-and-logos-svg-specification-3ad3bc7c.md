...
| Canonical URL | [https://www.w3.org/TR/SVG2/](https://www.w3.org/TR/SVG2/) |
| Source record ids | curated_language_routes-7e2e5129f44388 |

## System Engineer Summary

Scalable Vector Graphics specification used for icon systems, logos, accessibility metadata, and
rendering pipelines.

## Operational Role

For a systems engineer, SVG Specification belongs in the Icons and Logos inventory as part of
...
- `curated_language_routes-7e2e5129f44388` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Emoji Unicode Charts | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-emoji-unicode-charts-5084290a.md) |
