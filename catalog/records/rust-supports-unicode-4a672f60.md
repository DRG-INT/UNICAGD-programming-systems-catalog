...
| Canonical URL | [https://crates.io/crates/supports-unicode](https://crates.io/crates/supports-unicode) |
| Source record ids | crates_io-24ca8582b08df4 |
...
For a systems engineer, supports-unicode belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-02-04T03:00:37.144466Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-24ca8582b08df4` from `crates_io` as `registry_expansion`
