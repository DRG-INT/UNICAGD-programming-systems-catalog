...
<!-- canonical: https://pypi.org/project/aclib.winlib/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclib.winlib/](https://pypi.org/project/aclib.winlib/) |
| Source record ids | pypi_simple-cdafdb5e2c2017 |

## System Engineer Summary

aclib.winlib is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, aclib.winlib belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2025-08-05T01:36:52.201677Z | [https://pypi.org/pypi/aclib.winlib/json](https://pypi.org/pypi/aclib.winlib/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclib.winlib/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-cdafdb5e2c2017` from `pypi_simple` as `registry_expansion`
