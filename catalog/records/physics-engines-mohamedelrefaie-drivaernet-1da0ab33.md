...
<!-- canonical: https://github.com/Mohamedelrefaie/DrivAerNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mohamedelrefaie/DrivAerNet](https://github.com/Mohamedelrefaie/DrivAerNet) |
| Source record ids | github_search_physics_engines-f5aab8ff656398 |

## System Engineer Summary

A Large-Scale Multimodal Car Dataset with Computational Fluid Dynamics Simulations and Deep Learning
Benchmarks

## Operational Role

For a systems engineer, Mohamedelrefaie/DrivAerNet belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-14T01:58:41Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f5aab8ff656398` from `github_search_physics_engines` as `registry_expansion`
