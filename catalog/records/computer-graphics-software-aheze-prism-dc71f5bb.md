...
<!-- canonical: https://github.com/aheze/Prism -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aheze/Prism](https://github.com/aheze/Prism) |
| Source record ids | github_search_computer_graphics_software-e9c140c8e8bebb |
...
For a systems engineer, aheze/Prism belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-e9c140c8e8bebb` from `github_search_computer_graphics_software` as `registry_expansion`
