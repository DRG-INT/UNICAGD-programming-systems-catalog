...
<!-- canonical: https://cran.r-project.org/web/packages/RcppCGAL/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppCGAL/index.html](https://cran.r-project.org/web/packages/RcppCGAL/index.html) |
| Source record ids | cran_packages_by_date-795110c7ea4dd1 |
...
For a systems engineer, RcppCGAL belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.2.1 | 2026-09-05 05:10:13 UTC | [https://cran.r-project.org/web/packages/RcppCGAL/DESCRIPTION](https://cran.r-project.org/web/packages/RcppCGAL/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppCGAL/DESCRIPTION` at `2026-09-05T06:22:48+00:00`.
...
- `cran_packages_by_date-795110c7ea4dd1` from `cran_packages_by_date` as `registry_expansion`
