...
| Canonical URL | [https://pypi.org/project/catboost/](https://pypi.org/project/catboost/) |
| Source record ids | corpus-b7f054edf329ff |

## System Engineer Summary

CatBoost is tracked as a machine learning record in the Python branch. The source did not provide a
...
For a systems engineer, CatBoost belongs in the Python inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.10 | 2026-02-18T16:13:29.092923Z | [https://pypi.org/pypi/CatBoost/json](https://pypi.org/pypi/CatBoost/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/CatBoost/json` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-b7f054edf329ff` from `master_json` as `machine_learning`
