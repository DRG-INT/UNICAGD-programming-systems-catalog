...
<!-- canonical: https://cran.r-project.org/web/packages/IP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IP/index.html](https://cran.r-project.org/web/packages/IP/index.html) |
| Source record ids | cran_packages_by_date-4c68163f9f150d |
...
For a systems engineer, IP belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-09-02 12:20:16 UTC | [https://cran.r-project.org/web/packages/IP/DESCRIPTION](https://cran.r-project.org/web/packages/IP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IP/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-4c68163f9f150d` from `cran_packages_by_date` as `registry_expansion`
