...
<!-- canonical: https://github.com/ohmybahgosh/FONTS_DOT_COM_RIPPER -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ohmybahgosh/FONTS_DOT_COM_RIPPER](https://github.com/ohmybahgosh/FONTS_DOT_COM_RIPPER) |
| Source record ids | github_search_font_briefcase-ff9d209a248751 |

## System Engineer Summary

Script to extract entire font families from Fonts.com, rips them as woff2 and final output includes
woff2 and ttf files

## Operational Role

For a systems engineer, ohmybahgosh/FONTS_DOT_COM_RIPPER belongs in the Font Briefcase inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-02T01:30:38Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-ff9d209a248751` from `github_search_font_briefcase` as `registry_expansion`
