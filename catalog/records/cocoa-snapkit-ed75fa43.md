...
<!-- canonical: https://cocoapods.org/pods/SnapKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/SnapKit](https://cocoapods.org/pods/SnapKit) |
| Source record ids | cocoapods_cdn-cf3b7a00ae4dea |
...
For a systems engineer, SnapKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.7.1 | 2024-02-18 08:39:39 UTC | [https://trunk.cocoapods.org/api/v1/pods/SnapKit](https://trunk.cocoapods.org/api/v1/pods/SnapKit) |  |
| preview | known | 0.30.0.beta2 | 2016-06-23 22:11:33 UTC | [https://trunk.cocoapods.org/api/v1/pods/SnapKit](https://trunk.cocoapods.org/api/v1/pods/SnapKit) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/SnapKit` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-cf3b7a00ae4dea` from `cocoapods_cdn` as `registry_expansion`
