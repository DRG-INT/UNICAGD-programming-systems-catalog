...
<!-- canonical: https://pub.dev/packages/split_view -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/split_view](https://pub.dev/packages/split_view) |
| Source record ids | pub_dev-93e686fd0cf434 |
...
For a systems engineer, split_view belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2026-02-16T15:09:21.065428Z | [https://pub.dev/api/packages/split_view](https://pub.dev/api/packages/split_view) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/split_view` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-93e686fd0cf434` from `pub_dev` as `registry_expansion`
