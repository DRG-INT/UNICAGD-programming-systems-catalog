...
<!-- canonical: https://github.com/mustache-dev/Three-VFX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mustache-dev/Three-VFX](https://github.com/mustache-dev/Three-VFX) |
| Source record ids | github_search_effects-996087718990d7 |

## System Engineer Summary

High-performance particle system for Three.js WebGPU, with support for React Three Fiber, TresJS,
and Threlte

## Operational Role

For a systems engineer, mustache-dev/Three-VFX belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-24T12:35:31Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-996087718990d7` from `github_search_effects` as `registry_expansion`
