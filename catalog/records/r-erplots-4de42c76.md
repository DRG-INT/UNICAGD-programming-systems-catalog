...
<!-- canonical: https://cran.r-project.org/web/packages/erplots/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/erplots/index.html](https://cran.r-project.org/web/packages/erplots/index.html) |
| Source record ids | cran_packages_by_date-af14aa698a7339 |

## System Engineer Summary

Model-Agnostic Exposure-Response Plots

## Operational Role

For a systems engineer, erplots belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-09 15:00:02 UTC | [https://cran.r-project.org/web/packages/erplots/DESCRIPTION](https://cran.r-project.org/web/packages/erplots/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/erplots/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-af14aa698a7339` from `cran_packages_by_date` as `registry_expansion`
