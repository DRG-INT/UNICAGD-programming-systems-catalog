...
<!-- canonical: https://hackage.haskell.org/package/copilot-theorem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/copilot-theorem](https://hackage.haskell.org/package/copilot-theorem) |
| Source record ids | hackage_top_downloads-d66fbc1f53055b |
...
For a systems engineer, copilot-theorem belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:20:00Z | [https://hackage.haskell.org/package/copilot-theorem](https://hackage.haskell.org/package/copilot-theorem) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/copilot-theorem` at `2026-09-12T00:29:13+00:00`.
...
- `hackage_top_downloads-d66fbc1f53055b` from `hackage_top_downloads` as `registry_expansion`
