...
<!-- canonical: https://cran.r-project.org/web/packages/plugdensity/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/plugdensity/index.html](https://cran.r-project.org/web/packages/plugdensity/index.html) |
| Source record ids | cran_packages_by_date-c2802a93b234eb |
...
For a systems engineer, plugdensity belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8-6 | 2026-09-04 22:10:02 UTC | [https://cran.r-project.org/web/packages/plugdensity/DESCRIPTION](https://cran.r-project.org/web/packages/plugdensity/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/plugdensity/DESCRIPTION` at `2026-09-04T22:18:17+00:00`.
...
- `cran_packages_by_date-c2802a93b234eb` from `cran_packages_by_date` as `registry_expansion`
