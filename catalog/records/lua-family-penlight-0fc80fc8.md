...
<!-- canonical: https://github.com/stevedonovan/Penlight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevedonovan/Penlight](https://github.com/stevedonovan/Penlight) |
| Source record ids | lua-source-106 |

## System Engineer Summary

Broad, heavyweight utility library, inspired by Python's standard libs. Provides the batteries that
Lua doesn't.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 106}}` |
...
- `lua-source-106` from `master_json` as `source_list_item`
