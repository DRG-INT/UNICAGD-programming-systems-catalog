...
<!-- canonical: https://github.com/felangel/flow_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/felangel/flow_builder](https://github.com/felangel/flow_builder) |
| Source record ids | github_search_maps-2b4b5e78704090 |

## System Engineer Summary

Flutter Flows made easy! A Flutter package which simplifies navigation flows with a flexible,
declarative API.

## Operational Role

For a systems engineer, felangel/flow_builder belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-27T20:02:20Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2b4b5e78704090` from `github_search_maps` as `registry_expansion`
