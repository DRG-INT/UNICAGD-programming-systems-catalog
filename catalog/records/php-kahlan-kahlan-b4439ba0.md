...
<!-- canonical: https://packagist.org/packages/kahlan/kahlan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kahlan/kahlan](https://packagist.org/packages/kahlan/kahlan) |
| Source record ids | packagist_search-dff2b521be4f01 |
...
For a systems engineer, kahlan/kahlan belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-dff2b521be4f01` from `packagist_search` as `registry_expansion`
