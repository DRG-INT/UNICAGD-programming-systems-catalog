...
<!-- canonical: https://github.com/bazelbuild/rules_typescript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/rules_typescript](https://github.com/bazelbuild/rules_typescript) |
| Source record ids | github_search_starlark-efafacd2b5ea6e |

## System Engineer Summary

bazelbuild/rules_typescript is tracked as a build system record in the Starlark branch. The source
...
For a systems engineer, bazelbuild/rules_typescript belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-23T14:44:49Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-efafacd2b5ea6e` from `github_search_starlark` as `registry_expansion`
