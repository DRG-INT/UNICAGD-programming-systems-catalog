...
| Canonical URL | [https://packagist.org/packages/contributte/redis](https://packagist.org/packages/contributte/redis) |
| Source record ids | packagist_search-9197155b191bef |
...
For a systems engineer, contributte/redis belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.2 | 2025-11-24T20:12:24+00:00 | [https://repo.packagist.org/p2/contributte/redis.json](https://repo.packagist.org/p2/contributte/redis.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/contributte/redis.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-9197155b191bef` from `packagist_search` as `registry_expansion`
