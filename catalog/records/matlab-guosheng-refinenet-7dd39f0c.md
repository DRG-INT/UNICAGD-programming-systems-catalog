...
<!-- canonical: https://github.com/guosheng/refinenet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/guosheng/refinenet](https://github.com/guosheng/refinenet) |
| Source record ids | github_search_matlab-d0c20099a43f03 |
...
For a systems engineer, guosheng/refinenet belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-01T05:40:49Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-d0c20099a43f03` from `github_search_matlab` as `registry_expansion`
