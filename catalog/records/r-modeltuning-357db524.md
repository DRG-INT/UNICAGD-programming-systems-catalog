...
<!-- canonical: https://cran.r-project.org/web/packages/modeltuning/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modeltuning/index.html](https://cran.r-project.org/web/packages/modeltuning/index.html) |
| Source record ids | cran_packages_by_date-fbac2a97a7167e |
...
For a systems engineer, modeltuning belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-14 06:50:08 UTC | [https://cran.r-project.org/web/packages/modeltuning/DESCRIPTION](https://cran.r-project.org/web/packages/modeltuning/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modeltuning/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-fbac2a97a7167e` from `cran_packages_by_date` as `registry_expansion`
