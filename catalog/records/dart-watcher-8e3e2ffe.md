...
<!-- canonical: https://pub.dev/packages/watcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/watcher](https://pub.dev/packages/watcher) |
| Source record ids | pub_dev-b72b729f141623 |

## System Engineer Summary

A file system watcher. It monitors changes to contents of directories and sends notifications when
files have been added, removed, or modified.

## Operational Role

For a systems engineer, watcher belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-01-08T07:30:04.790936Z | [https://pub.dev/api/packages/watcher](https://pub.dev/api/packages/watcher) |  |
| preview | known | 1.0.0-nullsafety.0 | 2021-01-13T23:24:50.124563Z | [https://pub.dev/api/packages/watcher](https://pub.dev/api/packages/watcher) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/watcher` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-b72b729f141623` from `pub_dev` as `registry_expansion`
