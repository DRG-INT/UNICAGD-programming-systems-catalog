...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CloseOpenIntervals](https://github.com/JuliaRegistries/General/tree/master/C/CloseOpenIntervals) |
| Source record ids | julia_general-1d1a6545eeeba2 |

## System Engineer Summary

Julia package registered in General at C/CloseOpenIntervals.

## Operational Role

For a systems engineer, CloseOpenIntervals belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CloseOpenIntervals", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-1d1a6545eeeba2` from `julia_general` as `registry_expansion`
