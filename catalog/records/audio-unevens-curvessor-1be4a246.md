...
<!-- canonical: https://github.com/unevens/Curvessor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unevens/Curvessor](https://github.com/unevens/Curvessor) |
| Source record ids | github_search_audio-492e491ac01264 |

## System Engineer Summary

An audio plug-in that implements a dynamic range processor in which the response curve of each
channel is an automatable spline.

## Operational Role

For a systems engineer, unevens/Curvessor belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T04:30:13Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-492e491ac01264` from `github_search_audio` as `registry_expansion`
