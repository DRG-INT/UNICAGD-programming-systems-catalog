...
<!-- canonical: https://luarocks.org/modules/wsdjeg/calendar.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/calendar.nvim](https://luarocks.org/modules/wsdjeg/calendar.nvim) |
| Source record ids | luarocks_root_manifest-0bf13fefb8317c |

## System Engineer Summary

calendar.nvim is tracked as an ide editor integration record in the Lua family branch. The source
...
For a systems engineer, calendar.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0bf13fefb8317c` from `luarocks_root_manifest` as `registry_expansion`
