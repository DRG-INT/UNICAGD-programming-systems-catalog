...
<!-- canonical: https://cran.r-project.org/web/packages/BigDataStatMeth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BigDataStatMeth/index.html](https://cran.r-project.org/web/packages/BigDataStatMeth/index.html) |
| Source record ids | cran_packages_by_date-b1aaf8880227d6 |
...
For a systems engineer, BigDataStatMeth belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.5 | 2026-09-14 20:20:08 UTC | [https://cran.r-project.org/web/packages/BigDataStatMeth/DESCRIPTION](https://cran.r-project.org/web/packages/BigDataStatMeth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BigDataStatMeth/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-b1aaf8880227d6` from `cran_packages_by_date` as `registry_expansion`
