# Gitea: ericLemanissier/conan-center-index
...
<!-- canonical: https://gitea.com/ericLemanissier/conan-center-index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/ericLemanissier/conan-center-index](https://gitea.com/ericLemanissier/conan-center-index) |
| Source record ids | gitea_repositories_api-6d7cd5d8a807dd |
...
For a systems engineer, Gitea: ericLemanissier/conan-center-index belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-11T11:38:41Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6d7cd5d8a807dd` from `gitea_repositories_api` as `registry_expansion`
