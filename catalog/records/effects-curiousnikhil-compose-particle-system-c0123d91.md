...
<!-- canonical: https://github.com/CuriousNikhil/compose-particle-system -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CuriousNikhil/compose-particle-system](https://github.com/CuriousNikhil/compose-particle-system) |
| Source record ids | github_search_effects-e8f140b4d28aaf |
...
For a systems engineer, CuriousNikhil/compose-particle-system belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-11T01:44:48Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e8f140b4d28aaf` from `github_search_effects` as `registry_expansion`
