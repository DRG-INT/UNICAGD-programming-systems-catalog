...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Classes](https://github.com/JuliaRegistries/General/tree/master/C/Classes) |
| Source record ids | julia_general-bc651d385352cd |

## System Engineer Summary

Julia package registered in General at C/Classes.

## Operational Role

For a systems engineer, Classes belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Classes", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-bc651d385352cd` from `julia_general` as `registry_expansion`
