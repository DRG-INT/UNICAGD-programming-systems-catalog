...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ICIJ/extract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ICIJ/extract](https://github.com/ICIJ/extract) |
| Source record ids | github_search_catalogs-867140af14372c |
...
For a systems engineer, ICIJ/extract belongs in the Catalogs inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T07:53:49Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-867140af14372c` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| tokern/piicatcher | Static Analyzer | [open](catalogs-tokern-piicatcher-e98309f5.md) |
