# RENEGADE-ANDROiD/SuperShadersSuite-UZDoom

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/RENEGADE-ANDROiD/SuperShadersSuite-UZDoom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RENEGADE-ANDROiD/SuperShadersSuite-UZDoom](https://github.com/RENEGADE-ANDROiD/SuperShadersSuite-UZDoom) |
| Source record ids | github_search_effects-5e72900a0211dd |

## System Engineer Summary

A universal post-processing and material enhancement addon for Doom/Doom 2/Heretic/Hexen running on
GZDoom or UZDoom which introduces RayTrace-lite effects and bundles MariFX, Screen-M, ACES tonemap,
VHS/CRT, fisheye, BodyCam Visual, SoftShade, filmic LUTs, ReLite-inspired enhanced lighting,
integrated DarkDoomZ, and unified Visual Presets

## Operational Role

For a systems engineer, RENEGADE-ANDROiD/SuperShadersSuite-UZDoom belongs in the Effects inventory
as part of hot-path discovery, allocation analysis, latency control, and capacity planning.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T04:44:01Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5e72900a0211dd` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| NullTale/GiLight2D | Profiler | [open](effects-nulltale-gilight2d-763ee010.md) |
