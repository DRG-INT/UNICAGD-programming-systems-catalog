...
<!-- canonical: https://cran.r-project.org/web/packages/dracor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dracor/index.html](https://cran.r-project.org/web/packages/dracor/index.html) |
| Source record ids | cran_packages_by_date-6ac175f63eb74b |
...
For a systems engineer, dracor belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2026-08-24 05:10:02 UTC | [https://cran.r-project.org/web/packages/dracor/DESCRIPTION](https://cran.r-project.org/web/packages/dracor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dracor/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6ac175f63eb74b` from `cran_packages_by_date` as `registry_expansion`
