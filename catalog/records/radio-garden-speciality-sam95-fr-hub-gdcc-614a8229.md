...
<!-- canonical: https://github.com/sam95-fr-hub/GDCC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sam95-fr-hub/GDCC](https://github.com/sam95-fr-hub/GDCC) |
| Source record ids | github_search_radio_garden_speciality-133a33ae18a468 |

## System Engineer Summary

Garden Train lookalike DCC radio controller

## Operational Role

For a systems engineer, sam95-fr-hub/GDCC belongs in the Radio Garden Speciality inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T16:19:32Z | gh search repos "radio.garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-133a33ae18a468` from `github_search_radio_garden_speciality` as `registry_expansion`
