...
<!-- canonical: https://luarocks.org/modules/aire-one/awesome-slot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aire-one/awesome-slot](https://luarocks.org/modules/aire-one/awesome-slot) |
| Source record ids | luarocks_root_manifest-0b7666cf905bd2 |
...
For a systems engineer, awesome-slot belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0b7666cf905bd2` from `luarocks_root_manifest` as `registry_expansion`
