...
<!-- canonical: https://hackage.haskell.org/package/waterfall-cad -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/waterfall-cad](https://hackage.haskell.org/package/waterfall-cad) |
| Source record ids | hackage_top_downloads-ec96919e860c4f |
...
For a systems engineer, waterfall-cad belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3.2 | 2026-08-21T20:50:46Z | [https://hackage.haskell.org/package/waterfall-cad](https://hackage.haskell.org/package/waterfall-cad) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/waterfall-cad` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-ec96919e860c4f` from `hackage_top_downloads` as `registry_expansion`
