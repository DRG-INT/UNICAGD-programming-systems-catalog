...
<!-- canonical: https://cran.r-project.org/web/packages/reproresearchR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/reproresearchR/index.html](https://cran.r-project.org/web/packages/reproresearchR/index.html) |
| Source record ids | cran_packages_by_date-45c4217429ffbd |
...
For a systems engineer, reproresearchR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-07 02:30:02 UTC | [https://cran.r-project.org/web/packages/reproresearchR/DESCRIPTION](https://cran.r-project.org/web/packages/reproresearchR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/reproresearchR/DESCRIPTION` at `2026-09-07T03:21:14+00:00`.
...
- `cran_packages_by_date-45c4217429ffbd` from `cran_packages_by_date` as `registry_expansion`
