...
<!-- canonical: https://github.com/nickschoey/starwars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nickschoey/starwars](https://github.com/nickschoey/starwars) |
| Source record ids | github_search_space_maps-4159945c5788b2 |
...
For a systems engineer, nickschoey/starwars belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-05T20:21:45Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4159945c5788b2` from `github_search_space_maps` as `registry_expansion`
