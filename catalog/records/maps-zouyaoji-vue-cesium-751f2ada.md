...
| Source record ids | github_search_maps-7267587d6f878d |
...
For a systems engineer, zouyaoji/vue-cesium belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T16:59:10Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7267587d6f878d` from `github_search_maps` as `registry_expansion`
