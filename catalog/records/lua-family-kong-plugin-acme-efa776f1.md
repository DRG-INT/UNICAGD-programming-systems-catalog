...
| Canonical URL | [https://luarocks.org/modules/kong/kong-plugin-acme](https://luarocks.org/modules/kong/kong-plugin-acme) |
| Source record ids | luarocks_root_manifest-cb29d81f2f337c |
...
For a systems engineer, kong-plugin-acme belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-cb29d81f2f337c` from `luarocks_root_manifest` as `registry_expansion`
