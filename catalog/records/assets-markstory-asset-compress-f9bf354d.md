...
<!-- canonical: https://github.com/markstory/asset_compress -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/markstory/asset_compress](https://github.com/markstory/asset_compress) |
| Source record ids | github_search_assets-10145d3c5e38b2 |

## System Engineer Summary

An asset compression plugin for CakePHP. Provides file concatenation and a flexible filter system
for preprocessing and minification.

## Operational Role

For a systems engineer, markstory/asset_compress belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-20T16:25:26Z | gh search repos topic:asset-pipeline stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-10145d3c5e38b2` from `github_search_assets` as `registry_expansion`
