...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Loyalsoldier/v2ray-rules-dat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Loyalsoldier/v2ray-rules-dat](https://github.com/Loyalsoldier/v2ray-rules-dat) |
| Source record ids | github_search_maps-32531072a9d936 |

## System Engineer Summary

🦄 🎃 👻 V2Ray 路由规则文件加强版，可代替 V2Ray 官方 geoip.dat 和 geosite.dat，适用于 V2Ray、Xray-core、mihomo(Clash-
Meta)、hysteria、Trojan-Go 和 leaf。Enhanced edition of V2Ray rules dat files, applicable to V2Ray,
Xray-core, mihomo(Clash-Meta), hysteria, Trojan-Go and leaf.

## Operational Role

For a systems engineer, Loyalsoldier/v2ray-rules-dat belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 202609010056 | 2026-09-01T00:56:42Z | [https://api.github.com/repos/Loyalsoldier/v2ray-rules-dat/releases/latest](https://api.github.com/repos/Loyalsoldier/v2ray-rules-dat/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Loyalsoldier/v2ray-rules-dat/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-32531072a9d936` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Loyalsoldier/clash-rules | Lint Rule Pack | [open](maps-loyalsoldier-clash-rules-35bed208.md) |
| Loyalsoldier/geoip | Lint Rule Pack | [open](maps-loyalsoldier-geoip-2bef8369.md) |
| Loyalsoldier/surge-rules | Lint Rule Pack | [open](maps-loyalsoldier-surge-rules-7d51c30a.md) |
