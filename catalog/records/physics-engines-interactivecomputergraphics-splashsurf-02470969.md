...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/InteractiveComputerGraphics/splashsurf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/InteractiveComputerGraphics/splashsurf](https://github.com/InteractiveComputerGraphics/splashsurf) |
| Source record ids | github_search_physics_engines-15e2a22f593729 |
...
For a systems engineer, InteractiveComputerGraphics/splashsurf belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:13:19Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-15e2a22f593729` from `github_search_physics_engines` as `registry_expansion`
