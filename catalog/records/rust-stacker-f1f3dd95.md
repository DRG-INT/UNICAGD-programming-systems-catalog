...
<!-- canonical: https://crates.io/crates/stacker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/stacker](https://crates.io/crates/stacker) |
| Source record ids | crates_io-a084b6ec729ea2 |
...
For a systems engineer, stacker belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.25 | 2026-08-02T09:31:06.457261Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-a084b6ec729ea2` from `crates_io` as `registry_expansion`
