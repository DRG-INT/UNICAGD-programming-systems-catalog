...
<!-- canonical: https://github.com/wanmeihuali/taichi_3d_gaussian_splatting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wanmeihuali/taichi_3d_gaussian_splatting](https://github.com/wanmeihuali/taichi_3d_gaussian_splatting) |
| Source record ids | github_search_computer_graphics_software-14a7d7ea4fe9ff |

## System Engineer Summary

An unofficial implementation of paper 3D Gaussian Splatting for Real-Time Radiance Field Rendering
by taichi lang.

## Operational Role

For a systems engineer, wanmeihuali/taichi_3d_gaussian_splatting belongs in the Computer Graphics
Software inventory as part of cross-language integration, ABI ownership, memory safety, and runtime
embedding.
...
- `github_search_computer_graphics_software-14a7d7ea4fe9ff` from `github_search_computer_graphics_software` as `registry_expansion`
