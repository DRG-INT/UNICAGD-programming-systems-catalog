...
| Canonical URL | [https://github.com/Doikki/DKVideoPlayer](https://github.com/Doikki/DKVideoPlayer) |
| Source record ids | github_search_video-555b7e6c342449 |

## System Engineer Summary

Android Video Player.
安卓视频播放器，封装MediaPlayer、ExoPlayer、IjkPlayer。模仿抖音并实现预加载，列表播放，悬浮播放，广告播放，弹幕，视频水印，视频滤镜

## Operational Role

For a systems engineer, Doikki/DKVideoPlayer belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.7 | 2022-07-25T02:15:36Z | [https://api.github.com/repos/Doikki/DKVideoPlayer/releases/latest](https://api.github.com/repos/Doikki/DKVideoPlayer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Doikki/DKVideoPlayer/releases/latest` at `2026-09-01T09:23:23+00:00`.
...
- `github_search_video-555b7e6c342449` from `github_search_video` as `registry_expansion`
