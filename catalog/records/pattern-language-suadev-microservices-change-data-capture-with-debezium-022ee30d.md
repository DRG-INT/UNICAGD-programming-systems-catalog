...
<!-- canonical: https://github.com/suadev/microservices-change-data-capture-with-debezium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/suadev/microservices-change-data-capture-with-debezium](https://github.com/suadev/microservices-change-data-capture-with-debezium) |
| Source record ids | github_search_pattern_language-770ddda5544273 |
...
For a systems engineer, suadev/microservices-change-data-capture-with-debezium belongs in the
Pattern language inventory as part of ecosystem capability mapping, dependency review, release
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-07T19:50:46Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-770ddda5544273` from `github_search_pattern_language` as `registry_expansion`
