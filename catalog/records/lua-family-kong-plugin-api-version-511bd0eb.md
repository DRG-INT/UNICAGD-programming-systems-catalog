...
| Canonical URL | [https://luarocks.org/modules/kumarso/kong-plugin-api-version](https://luarocks.org/modules/kumarso/kong-plugin-api-version) |
| Source record ids | luarocks_root_manifest-46cddf85fbe4e1 |
...
For a systems engineer, kong-plugin-api-version belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-46cddf85fbe4e1` from `luarocks_root_manifest` as `registry_expansion`
