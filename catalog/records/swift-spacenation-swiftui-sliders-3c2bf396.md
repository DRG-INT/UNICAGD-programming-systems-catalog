...
<!-- canonical: https://github.com/spacenation/swiftui-sliders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spacenation/swiftui-sliders](https://github.com/spacenation/swiftui-sliders) |
| Source record ids | github_search_swift-40253a453eaf4d |
...
For a systems engineer, spacenation/swiftui-sliders belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-01T18:08:20Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-40253a453eaf4d` from `github_search_swift` as `registry_expansion`
