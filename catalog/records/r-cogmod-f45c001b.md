...
<!-- canonical: https://cran.r-project.org/web/packages/cogmod/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cogmod/index.html](https://cran.r-project.org/web/packages/cogmod/index.html) |
| Source record ids | cran_packages_by_date-e2688a60031bfe |
...
For a systems engineer, cogmod belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-12 08:10:02 UTC | [https://cran.r-project.org/web/packages/cogmod/DESCRIPTION](https://cran.r-project.org/web/packages/cogmod/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cogmod/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
| --- | --- | --- | --- |
| cran_available_packages_by_date | registry-derived | 2026-09-14 | `{"kind": "cran_available_packages_by_date", "retrieved": "2026-09-14", "status": "registry-derived"}` |
...
- `cran_packages_by_date-e2688a60031bfe` from `cran_packages_by_date` as `registry_expansion`
...
| datasus | Undefined Behavior Analyzer | [open](r-datasus-3882b811.md) |
