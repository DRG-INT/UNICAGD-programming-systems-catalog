...
<!-- canonical: https://github.com/g-nitin/solar-system-geology -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/g-nitin/solar-system-geology](https://github.com/g-nitin/solar-system-geology) |
| Source record ids | github_search_space_maps-7a7c993ee5d572 |

## System Engineer Summary

Explore planetary geology with interactive maps showcasing elevation data and geological units on
celestial bodies in our solar system.

## Operational Role

For a systems engineer, g-nitin/solar-system-geology belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-06T22:14:48Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-7a7c993ee5d572` from `github_search_space_maps` as `registry_expansion`
