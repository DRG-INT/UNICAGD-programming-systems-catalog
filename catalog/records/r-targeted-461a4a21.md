...
<!-- canonical: https://cran.r-project.org/web/packages/targeted/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/targeted/index.html](https://cran.r-project.org/web/packages/targeted/index.html) |
| Source record ids | cran_packages_by_date-e4341fc6d26389 |

## System Engineer Summary

targeted is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, targeted belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-21 09:50:02 UTC | [https://cran.r-project.org/web/packages/targeted/DESCRIPTION](https://cran.r-project.org/web/packages/targeted/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/targeted/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e4341fc6d26389` from `cran_packages_by_date` as `registry_expansion`
