...
<!-- canonical: https://cran.r-project.org/web/packages/openNCAI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/openNCAI/index.html](https://cran.r-project.org/web/packages/openNCAI/index.html) |
| Source record ids | cran_packages_by_date-bf18defa0d0eab |
...
For a systems engineer, openNCAI belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-03 14:30:02 UTC | [https://cran.r-project.org/web/packages/openNCAI/DESCRIPTION](https://cran.r-project.org/web/packages/openNCAI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/openNCAI/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-bf18defa0d0eab` from `cran_packages_by_date` as `registry_expansion`
