...
| Canonical URL | [http://luaconf.com/](http://luaconf.com/) |
| Source record ids | lua-source-368 |
...
For a systems engineer, Lua Conf belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 368}}` |
...
- `lua-source-368` from `master_json` as `source_list_item`
