...
| Source record ids | corpus-b2fcc82cb29eca |

## System Engineer Summary

nlohmann/json is tracked as a serialization record in the C++23 branch. The source did not provide a
...
For a systems engineer, nlohmann/json belongs in the C++23 inventory as part of wire formats,
...
- `corpus-b2fcc82cb29eca` from `master_json` as `serialization`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Cap'n Proto | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-cap-n-proto-a2fe13e0.md) |
| FlatBuffers | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-flatbuffers-45b1b217.md) |
| protobuf | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-protobuf-618a7be6.md) |
| RapidJSON | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-rapidjson-144ef914.md) |
| simdjson | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-simdjson-589d5787.md) |
| yaml-cpp | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-yaml-cpp-514696cd.md) |
