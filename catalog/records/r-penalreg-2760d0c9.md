...
<!-- canonical: https://cran.r-project.org/web/packages/PenalReg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PenalReg/index.html](https://cran.r-project.org/web/packages/PenalReg/index.html) |
| Source record ids | cran_packages_by_date-508d8263eded95 |
...
For a systems engineer, PenalReg belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-24 14:40:07 UTC | [https://cran.r-project.org/web/packages/PenalReg/DESCRIPTION](https://cran.r-project.org/web/packages/PenalReg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PenalReg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-508d8263eded95` from `cran_packages_by_date` as `registry_expansion`
