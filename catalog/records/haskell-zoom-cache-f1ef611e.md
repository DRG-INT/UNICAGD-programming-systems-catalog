...
<!-- canonical: https://hackage.haskell.org/package/zoom-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zoom-cache](https://hackage.haskell.org/package/zoom-cache) |
| Source record ids | hackage_top_downloads-72c59c077300fb |
...
For a systems engineer, zoom-cache belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1.6 | 2012-12-07T00:08:12Z | [https://hackage.haskell.org/package/zoom-cache](https://hackage.haskell.org/package/zoom-cache) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/zoom-cache` at `2026-09-02T14:24:31+00:00`.
...
- `hackage_top_downloads-72c59c077300fb` from `hackage_top_downloads` as `registry_expansion`
