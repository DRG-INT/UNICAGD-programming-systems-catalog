...
<!-- canonical: https://www.npmjs.com/package/app-store-server-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/app-store-server-api](https://www.npmjs.com/package/app-store-server-api) |
| Source record ids | npm_registry-4a5549a43f3189 |
...
For a systems engineer, app-store-server-api belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-06-14T10:35:00.962Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4a5549a43f3189` from `npm_registry` as `registry_expansion`
