...
<!-- canonical: https://pub.dev/packages/multi_select_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/multi_select_flutter](https://pub.dev/packages/multi_select_flutter) |
| Source record ids | pub_dev-32f0b8b89d2013 |
...
For a systems engineer, multi_select_flutter belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.3 | 2022-11-27T19:41:52.274110Z | [https://pub.dev/api/packages/multi_select_flutter](https://pub.dev/api/packages/multi_select_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/multi_select_flutter` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-32f0b8b89d2013` from `pub_dev` as `registry_expansion`
