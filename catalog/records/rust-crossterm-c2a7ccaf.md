...
<!-- canonical: https://crates.io/crates/crossterm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crossterm](https://crates.io/crates/crossterm) |
| Source record ids | crates_io-cadf1cfc9a8aa0 |
...
For a systems engineer, crossterm belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.0 | 2025-04-05T15:21:48.500601Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
| Evidence | GPL (>= 2); MIT; https://www.nuget.org/packages/ZiggyCreatures.FusionCache.Serialization.SystemTextJson/2.7.2/license |
...
- `crates_io-cadf1cfc9a8aa0` from `crates_io` as `registry_expansion`
