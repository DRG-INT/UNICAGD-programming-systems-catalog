...
(Bifactor) ESEM with Continuous (MLR) or Ordinal (WLSMV) Data
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-09 12:30:09 UTC | [https://cran.r-project.org/web/packages/bifactory/DESCRIPTION](https://cran.r-project.org/web/packages/bifactory/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bifactory/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
