...
<!-- canonical: https://cran.r-project.org/web/packages/bifactory/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bifactory/index.html](https://cran.r-project.org/web/packages/bifactory/index.html) |
| Source record ids | cran_packages_by_date-1924c9aa93af7e |

## System Engineer Summary

(Bifactor) ESEM with Continuous (MLR) or Ordered (WLSMV) Data

## Operational Role

For a systems engineer, bifactory belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-08-28 11:40:02 UTC | [https://cran.r-project.org/web/packages/bifactory/DESCRIPTION](https://cran.r-project.org/web/packages/bifactory/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bifactory/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1924c9aa93af7e` from `cran_packages_by_date` as `registry_expansion`
