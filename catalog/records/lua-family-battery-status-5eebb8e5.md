...
<!-- canonical: https://luarocks.org/modules/svarog/battery_status -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/svarog/battery_status](https://luarocks.org/modules/svarog/battery_status) |
| Source record ids | luarocks_root_manifest-749755390740a2 |
...
For a systems engineer, Battery Status belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-749755390740a2` from `luarocks_root_manifest` as `registry_expansion`
