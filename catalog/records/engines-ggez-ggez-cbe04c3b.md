...
| Source record ids | github_search_engines-6137a004e677ac |
...
For a systems engineer, ggez/ggez belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T21:20:24Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-6137a004e677ac` from `github_search_engines` as `registry_expansion`
