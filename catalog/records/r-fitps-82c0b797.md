...
<!-- canonical: https://cran.r-project.org/web/packages/fitPS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fitPS/index.html](https://cran.r-project.org/web/packages/fitPS/index.html) |
| Source record ids | cran_packages_by_date-e8f7ce7dba608b |
...
For a systems engineer, fitPS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-08-27 03:10:02 UTC | [https://cran.r-project.org/web/packages/fitPS/DESCRIPTION](https://cran.r-project.org/web/packages/fitPS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fitPS/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e8f7ce7dba608b` from `cran_packages_by_date` as `registry_expansion`
