...
<!-- canonical: https://pub.dev/packages/file -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/file](https://pub.dev/packages/file) |
| Source record ids | pub_dev-50aeaecd3b8f21 |

## System Engineer Summary

A pluggable, mockable file system abstraction for Dart. Supports local file system access, as well
as in-memory file systems, record-replay file systems, and chroot file systems.

## Operational Role

For a systems engineer, file belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.1 | 2024-10-08T15:54:11.380188Z | [https://pub.dev/api/packages/file](https://pub.dev/api/packages/file) |  |
| preview | known | 6.0.0-nullsafety.4 | 2020-11-04T18:50:31.881928Z | [https://pub.dev/api/packages/file](https://pub.dev/api/packages/file) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/file` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-50aeaecd3b8f21` from `pub_dev` as `registry_expansion`
...
| screen_protector | Memory Analyzer | [open](dart-screen-protector-172ebf39.md) |
