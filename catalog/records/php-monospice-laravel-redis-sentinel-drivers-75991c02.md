...
<!-- canonical: https://packagist.org/packages/monospice/laravel-redis-sentinel-drivers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/monospice/laravel-redis-sentinel-drivers](https://packagist.org/packages/monospice/laravel-redis-sentinel-drivers) |
| Source record ids | packagist_search-3729020562229b |
...
For a systems engineer, monospice/laravel-redis-sentinel-drivers belongs in the PHP inventory as
...
- `packagist_search-3729020562229b` from `packagist_search` as `registry_expansion`
