...
| Canonical URL | [https://luarocks.org/modules/davidgrldo/kong-egress-proxy](https://luarocks.org/modules/davidgrldo/kong-egress-proxy) |
| Source record ids | luarocks_root_manifest-c483981d04f0a2 |
...
For a systems engineer, kong-egress-proxy belongs in the Lua family inventory as part of cross-
...
- `luarocks_root_manifest-c483981d04f0a2` from `luarocks_root_manifest` as `registry_expansion`
