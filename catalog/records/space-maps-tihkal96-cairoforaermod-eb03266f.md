...
<!-- canonical: https://github.com/Tihkal96/CAIROforAERMOD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tihkal96/CAIROforAERMOD](https://github.com/Tihkal96/CAIROforAERMOD) |
| Source record ids | github_search_space_maps-a840876d232291 |

## System Engineer Summary

Compile AERMAP, AERMOD and AERPLOT Input and Run Output. Live visualisation of polygon and point
sources and automatic conversion (lon, lat to UTM) and input of coordinates via map. Steady-state
air dispersion model based on planetary boundary layer turbulence with terrain model and conversion
of .plt files to .kml files by MSc Dominik Subotić

## Operational Role

For a systems engineer, Tihkal96/CAIROforAERMOD belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-17T22:14:28Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a840876d232291` from `github_search_space_maps` as `registry_expansion`
