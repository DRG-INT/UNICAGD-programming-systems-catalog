...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BandedMatrices -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BandedMatrices", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-0a41f070393d8e` from `julia_general` as `registry_expansion`
