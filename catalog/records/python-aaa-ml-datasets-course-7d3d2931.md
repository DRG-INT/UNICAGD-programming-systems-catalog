...
<!-- canonical: https://pypi.org/project/aaa-ml-datasets-course/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aaa-ml-datasets-course/](https://pypi.org/project/aaa-ml-datasets-course/) |
| Source record ids | pypi_simple-638cc019b7fe6b |
...
For a systems engineer, aaa-ml-datasets-course belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-02-12T15:22:16.825476Z | [https://pypi.org/pypi/aaa-ml-datasets-course/json](https://pypi.org/pypi/aaa-ml-datasets-course/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aaa-ml-datasets-course/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-638cc019b7fe6b` from `pypi_simple` as `registry_expansion`
