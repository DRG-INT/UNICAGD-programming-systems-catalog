...
<!-- canonical: https://github.com/Gornhoth/Unity-Smoothed-Particle-Hydrodynamics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Gornhoth/Unity-Smoothed-Particle-Hydrodynamics](https://github.com/Gornhoth/Unity-Smoothed-Particle-Hydrodynamics) |
| Source record ids | github_search_effects-5ce980f9de5105 |

## System Engineer Summary

SPH in the Unity engine implemented in three different ways using MonoBehaviour, Entity-Component-
System, and ComputeShader

## Operational Role

For a systems engineer, Gornhoth/Unity-Smoothed-Particle-Hydrodynamics belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-05T17:48:09Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5ce980f9de5105` from `github_search_effects` as `registry_expansion`
