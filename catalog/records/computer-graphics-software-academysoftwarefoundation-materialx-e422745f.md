...
| Source record ids | github_search_computer_graphics_software-db131e2474f682 |
...
For a systems engineer, AcademySoftwareFoundation/MaterialX belongs in the Computer Graphics
...
- `github_search_computer_graphics_software-db131e2474f682` from `github_search_computer_graphics_software` as `registry_expansion`
