...
| Canonical URL | [https://www.bestpractices.dev/](https://www.bestpractices.dev/) |
| Source record ids | curated_language_routes-0eece1a94acc8c |

## System Engineer Summary

OpenSSF best-practices checklist and badge route for project governance, security, and quality
practices.

## Operational Role

For a systems engineer, OpenSSF Best Practices Badge belongs in the Doctrines inventory as part of
...
- `curated_language_routes-0eece1a94acc8c` from `curated_language_routes` as `registry_expansion`
...
| OWASP ASVS | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-owasp-asvs-e2d3d8b7.md) |
