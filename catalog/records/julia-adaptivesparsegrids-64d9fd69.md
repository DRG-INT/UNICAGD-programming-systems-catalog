...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AdaptiveSparseGrids -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AdaptiveSparseGrids", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-9aa1616834363a` from `julia_general` as `registry_expansion`
