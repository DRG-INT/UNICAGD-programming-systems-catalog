...
<!-- canonical: https://packagist.org/packages/phpbu/phpbu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpbu/phpbu](https://packagist.org/packages/phpbu/phpbu) |
| Source record ids | packagist_search-0ca601d1ee9423 |

## System Engineer Summary

phpbu/phpbu is tracked as a database datastore record in the PHP branch. The source did not provide
...
For a systems engineer, phpbu/phpbu belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-0ca601d1ee9423` from `packagist_search` as `registry_expansion`
