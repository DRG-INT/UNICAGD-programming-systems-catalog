...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stephendpmurphy/icm20948 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stephendpmurphy/icm20948](https://github.com/stephendpmurphy/icm20948) |
| Source record ids | github_search_electromagnetoscopes-45af50161e224e |
...
For a systems engineer, stephendpmurphy/icm20948 belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-16T20:36:06Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-45af50161e224e` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| analogcode/Swift-Radio-Pro | Logging Observability | [open](electromagnetoscopes-analogcode-swift-radio-pro-46d0d487.md) |
| analogdevicesinc/plutosdr-fw | Logging Observability | [open](electromagnetoscopes-analogdevicesinc-plutosdr-fw-c02de597.md) |
| davigmacode/flutter_smart_select | Logging Observability | [open](electromagnetoscopes-davigmacode-flutter-smart-select-fdc8fd87.md) |
| sgoudelis/ground-station | Logging Observability | [open](electromagnetoscopes-sgoudelis-ground-station-36e5d6db.md) |
| Varvrar/ios_logger | Logging Observability | [open](electromagnetoscopes-varvrar-ios-logger-a2f9d628.md) |
