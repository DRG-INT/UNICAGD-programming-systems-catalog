...
<!-- canonical: https://github.com/runabol/tork -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/runabol/tork](https://github.com/runabol/tork) |
| Source record ids | github_search_engines-e5208b45532054 |

## System Engineer Summary

Tork is a lightweight, distributed workflow engine that runs tasks as simple scripts within Docker
containers.

## Operational Role

For a systems engineer, runabol/tork belongs in the Engines inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T21:16:57Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-e5208b45532054` from `github_search_engines` as `registry_expansion`
