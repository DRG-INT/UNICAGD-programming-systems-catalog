...
<!-- canonical: https://github.com/harishrithish7/Fall-Detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/harishrithish7/Fall-Detection](https://github.com/harishrithish7/Fall-Detection) |
| Source record ids | github_search_matlab-232259dd930995 |
...
For a systems engineer, harishrithish7/Fall-Detection belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-08-19T01:53:28Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-232259dd930995` from `github_search_matlab` as `registry_expansion`
