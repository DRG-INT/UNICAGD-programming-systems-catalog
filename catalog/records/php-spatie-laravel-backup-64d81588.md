...
<!-- canonical: https://packagist.org/packages/spatie/laravel-backup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spatie/laravel-backup](https://packagist.org/packages/spatie/laravel-backup) |
| Source record ids | packagist_search-d5d7bd2c63d7a3 |
...
For a systems engineer, spatie/laravel-backup belongs in the PHP inventory as part of state
...
- `packagist_search-d5d7bd2c63d7a3` from `packagist_search` as `registry_expansion`
