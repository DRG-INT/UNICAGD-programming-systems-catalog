...
<!-- canonical: https://cran.r-project.org/web/packages/castor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/castor/index.html](https://cran.r-project.org/web/packages/castor/index.html) |
| Source record ids | cran_packages_by_date-1451ef27d5c3c4 |
...
For a systems engineer, castor belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.7 | 2026-08-04 21:40:02 UTC | [https://cran.r-project.org/web/packages/castor/DESCRIPTION](https://cran.r-project.org/web/packages/castor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/castor/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-1451ef27d5c3c4` from `cran_packages_by_date` as `registry_expansion`
