...
<!-- canonical: https://github.com/Microservice-API-Patterns/LakesideMutual -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Microservice-API-Patterns/LakesideMutual](https://github.com/Microservice-API-Patterns/LakesideMutual) |
| Source record ids | github_search_pattern_language-ec9b18d72d0082 |
...
For a systems engineer, Microservice-API-Patterns/LakesideMutual belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-13T18:11:28Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0 |
...
- `github_search_pattern_language-ec9b18d72d0082` from `github_search_pattern_language` as `registry_expansion`
