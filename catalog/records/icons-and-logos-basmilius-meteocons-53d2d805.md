...
<!-- canonical: https://github.com/basmilius/meteocons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/basmilius/meteocons](https://github.com/basmilius/meteocons) |
| Source record ids | github_search_icons_and_logos-f4dab5f6095a01 |
...
For a systems engineer, basmilius/meteocons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-12T19:52:41Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-f4dab5f6095a01` from `github_search_icons_and_logos` as `registry_expansion`
