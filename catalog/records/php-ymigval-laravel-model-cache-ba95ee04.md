...
<!-- canonical: https://packagist.org/packages/ymigval/laravel-model-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ymigval/laravel-model-cache](https://packagist.org/packages/ymigval/laravel-model-cache) |
| Source record ids | packagist_search-62c82d10138bda |
...
For a systems engineer, ymigval/laravel-model-cache belongs in the PHP inventory as part of state
...
- `packagist_search-62c82d10138bda` from `packagist_search` as `registry_expansion`
