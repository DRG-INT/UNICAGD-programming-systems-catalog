...
| Canonical URL | [https://crates.io/crates/swc_visit](https://crates.io/crates/swc_visit) |
| Source record ids | crates_io-3f2defd8be9607 |
...
For a systems engineer, swc_visit belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-26T03:12:32.697651Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-3f2defd8be9607` from `crates_io` as `registry_expansion`
