...
<!-- canonical: https://hackage.haskell.org/package/hspec-expectations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hspec-expectations](https://hackage.haskell.org/package/hspec-expectations) |
| Source record ids | hackage_top_downloads-a097930e8f8715 |
...
For a systems engineer, hspec-expectations belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2023-07-19T08:23:27Z | [https://hackage.haskell.org/package/hspec-expectations](https://hackage.haskell.org/package/hspec-expectations) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hspec-expectations` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-a097930e8f8715` from `hackage_top_downloads` as `registry_expansion`
