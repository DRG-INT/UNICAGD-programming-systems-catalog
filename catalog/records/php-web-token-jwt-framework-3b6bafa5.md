...
<!-- canonical: https://packagist.org/packages/web-token/jwt-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/web-token/jwt-framework](https://packagist.org/packages/web-token/jwt-framework) |
| Source record ids | packagist_search-8414a70a6b21d2 |
...
For a systems engineer, web-token/jwt-framework belongs in the PHP inventory as part of wire
...
- `packagist_search-8414a70a6b21d2` from `packagist_search` as `registry_expansion`
