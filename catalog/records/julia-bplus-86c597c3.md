...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/Bplus](https://github.com/JuliaRegistries/General/tree/master/B/Bplus) |
| Source record ids | julia_general-ead70f07970637 |

## System Engineer Summary

Julia package registered in General at B/Bplus.

## Operational Role

For a systems engineer, Bplus belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/Bplus", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ead70f07970637` from `julia_general` as `registry_expansion`
