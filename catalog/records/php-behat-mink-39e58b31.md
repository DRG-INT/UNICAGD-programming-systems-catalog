...
<!-- canonical: https://packagist.org/packages/behat/mink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/behat/mink](https://packagist.org/packages/behat/mink) |
| Source record ids | packagist_search-d32231796cf315 |
...
For a systems engineer, behat/mink belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-d32231796cf315` from `packagist_search` as `registry_expansion`
