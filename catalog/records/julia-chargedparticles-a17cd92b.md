...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChargedParticles](https://github.com/JuliaRegistries/General/tree/master/C/ChargedParticles) |
| Source record ids | julia_general-07cacfa6288050 |

## System Engineer Summary

Julia package registered in General at C/ChargedParticles.

## Operational Role

For a systems engineer, ChargedParticles belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChargedParticles", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-07cacfa6288050` from `julia_general` as `registry_expansion`
