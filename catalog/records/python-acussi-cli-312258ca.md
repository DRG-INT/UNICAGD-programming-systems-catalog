...
<!-- canonical: https://pypi.org/project/acussi-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acussi-cli/](https://pypi.org/project/acussi-cli/) |
| Source record ids | pypi_simple-678ecccefac858 |
...
For a systems engineer, acussi-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-01-28T23:58:13.149599Z | [https://pypi.org/pypi/acussi-cli/json](https://pypi.org/pypi/acussi-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acussi-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-678ecccefac858` from `pypi_simple` as `registry_expansion`
