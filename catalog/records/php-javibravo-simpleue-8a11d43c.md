...
<!-- canonical: https://packagist.org/packages/javibravo/simpleue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/javibravo/simpleue](https://packagist.org/packages/javibravo/simpleue) |
| Source record ids | packagist_search-42d4ac59754958 |
...
For a systems engineer, javibravo/simpleue belongs in the PHP inventory as part of state
...
- `packagist_search-42d4ac59754958` from `packagist_search` as `registry_expansion`
