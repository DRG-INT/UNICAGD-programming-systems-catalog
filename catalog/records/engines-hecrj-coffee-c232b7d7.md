...
<!-- canonical: https://github.com/hecrj/coffee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hecrj/coffee](https://github.com/hecrj/coffee) |
| Source record ids | github_search_engines-8555389d1d9a20 |
...
For a systems engineer, hecrj/coffee belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-03T11:30:40Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-8555389d1d9a20` from `github_search_engines` as `registry_expansion`
