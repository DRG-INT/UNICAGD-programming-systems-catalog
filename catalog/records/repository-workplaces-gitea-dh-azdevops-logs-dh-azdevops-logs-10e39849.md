# Gitea: dh.azdevops.logs/dh.azdevops.logs

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/dh.azdevops.logs/dh.azdevops.logs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dh.azdevops.logs/dh.azdevops.logs](https://gitea.com/dh.azdevops.logs/dh.azdevops.logs) |
| Source record ids | gitea_repositories_api-5d0beb0a822522 |
...
For a systems engineer, Gitea: dh.azdevops.logs/dh.azdevops.logs belongs in the Repository
Workplaces inventory as part of diagnostics, metrics, auditability, tracing, and incident response.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T00:05:57Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-5d0beb0a822522` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: Code-Technologies/shared-library | Logging Observability | [open](repository-workplaces-gitea-code-technologies-shared-library-0ebeb069.md) |
