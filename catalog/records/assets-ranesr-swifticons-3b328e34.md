...
<!-- canonical: https://github.com/ranesr/SwiftIcons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ranesr/SwiftIcons](https://github.com/ranesr/SwiftIcons) |
| Source record ids | github_search_assets-123b1a14211dad |
...
For a systems engineer, ranesr/SwiftIcons belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-05T10:53:17Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-123b1a14211dad` from `github_search_assets` as `registry_expansion`
