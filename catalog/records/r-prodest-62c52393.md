...
<!-- canonical: https://cran.r-project.org/web/packages/prodest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prodest/index.html](https://cran.r-project.org/web/packages/prodest/index.html) |
| Source record ids | cran_packages_by_date-97a0ab14a99675 |
...
For a systems engineer, prodest belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-01 15:20:02 UTC | [https://cran.r-project.org/web/packages/prodest/DESCRIPTION](https://cran.r-project.org/web/packages/prodest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prodest/DESCRIPTION` at `2026-09-01T15:35:52+00:00`.
...
- `cran_packages_by_date-97a0ab14a99675` from `cran_packages_by_date` as `registry_expansion`
