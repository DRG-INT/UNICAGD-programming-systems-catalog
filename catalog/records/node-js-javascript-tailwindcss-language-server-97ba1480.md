...
<!-- canonical: https://www.npmjs.com/package/@tailwindcss/language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@tailwindcss/language-server](https://www.npmjs.com/package/@tailwindcss/language-server) |
| Source record ids | npm_registry-64590681b6716c |
...
For a systems engineer, @tailwindcss/language-server belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-07-17T15:29:14.288Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-64590681b6716c` from `npm_registry` as `registry_expansion`
