...
<!-- canonical: https://github.com/Eric-Bradford/TS-EMO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Eric-Bradford/TS-EMO](https://github.com/Eric-Bradford/TS-EMO) |
| Source record ids | github_search_matlab-b25983973c8b36 |

## System Engineer Summary

This repository contains the source code for “Thompson sampling efficient multiobjective
optimization” (TSEMO).

## Operational Role

For a systems engineer, Eric-Bradford/TS-EMO belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-19T15:03:41Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-b25983973c8b36` from `github_search_matlab` as `registry_expansion`
