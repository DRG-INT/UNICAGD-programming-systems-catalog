...
<!-- canonical: https://cran.r-project.org/web/packages/mritc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mritc/index.html](https://cran.r-project.org/web/packages/mritc/index.html) |
| Source record ids | cran_packages_by_date-e794c1d5e54ed1 |
...
For a systems engineer, mritc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2026-08-20 05:50:02 UTC | [https://cran.r-project.org/web/packages/mritc/DESCRIPTION](https://cran.r-project.org/web/packages/mritc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mritc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e794c1d5e54ed1` from `cran_packages_by_date` as `registry_expansion`
