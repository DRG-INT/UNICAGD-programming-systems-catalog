...
<!-- canonical: https://github.com/MatthewSRC/native-springs-shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MatthewSRC/native-springs-shaders](https://github.com/MatthewSRC/native-springs-shaders) |
| Source record ids | github_search_effects-f1d0e6d2cde988 |
...
For a systems engineer, MatthewSRC/native-springs-shaders belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T16:04:21Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f1d0e6d2cde988` from `github_search_effects` as `registry_expansion`
