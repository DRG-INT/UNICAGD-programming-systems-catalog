...
<!-- canonical: https://cran.r-project.org/web/packages/smartcor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smartcor/index.html](https://cran.r-project.org/web/packages/smartcor/index.html) |
| Source record ids | cran_packages_by_date-ffc5c5d59efa6f |
...
For a systems engineer, smartcor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-09 07:30:02 UTC | [https://cran.r-project.org/web/packages/smartcor/DESCRIPTION](https://cran.r-project.org/web/packages/smartcor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smartcor/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ffc5c5d59efa6f` from `cran_packages_by_date` as `registry_expansion`
