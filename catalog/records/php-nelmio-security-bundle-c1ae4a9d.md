...
<!-- canonical: https://packagist.org/packages/nelmio/security-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nelmio/security-bundle](https://packagist.org/packages/nelmio/security-bundle) |
| Source record ids | packagist_search-8913b1ce5bcc58 |

## System Engineer Summary

Extra security-related features for Symfony: signed/encrypted cookies, HTTPS/SSL/HSTS handling,
cookie session storage, ...

## Operational Role

For a systems engineer, nelmio/security-bundle belongs in the PHP inventory as part of supply-chain
...
- `packagist_search-8913b1ce5bcc58` from `packagist_search` as `registry_expansion`
