...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/2u-enterprise-data/](https://pypi.org/project/2u-enterprise-data/) |
| Source record ids | pypi_simple-cc91cea8912474 |

## System Engineer Summary

2u-enterprise-data is tracked as a library record in the Python branch. The source did not provide a
...
For a systems engineer, 2u-enterprise-data belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.22.2 | 2026-08-20T06:34:16.255509Z | [https://pypi.org/pypi/2u-enterprise-data/json](https://pypi.org/pypi/2u-enterprise-data/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/2u-enterprise-data/json` at `2026-09-01T03:20:32+00:00`.
...
- `pypi_simple-cc91cea8912474` from `pypi_simple` as `registry_expansion`
...
| Pydantic | Library | [open](python-pydantic-1ce7a0b2.md) |
