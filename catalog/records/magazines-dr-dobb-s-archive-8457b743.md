...
| Canonical URL | [https://www.drdobbs.com/](https://www.drdobbs.com/) |
| Source record ids | curated_language_routes-58ad08f9a76aed |

## System Engineer Summary

Historical programming magazine route for language, compiler, systems, algorithms, and software
engineering articles.

## Operational Role

For a systems engineer, Dr. Dobb's Archive belongs in the Magazines inventory as part of ecosystem
...
- `curated_language_routes-58ad08f9a76aed` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| 2600 Magazine | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-2600-magazine-bee86c1a.md) |
| ACM Queue | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-acm-queue-c34a7ec9.md) |
| Communications of the ACM | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-communications-of-the-acm-8173fb46.md) |
| Computer History Museum Publications | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-computer-history-museum-publications-586a884f.md) |
| IEEE Software | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-ieee-software-25c5dcaa.md) |
| Linux Gazette | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-linux-gazette-ed96e5b5.md) |
| LWN.net | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-lwn-net-4bb132a5.md) |
| USENIX ;login: | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/magazines-usenix-login-64bf4375.md) |
