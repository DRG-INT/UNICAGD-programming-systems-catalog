...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/MaKiPL/OpenVIII-monogame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MaKiPL/OpenVIII-monogame](https://github.com/MaKiPL/OpenVIII-monogame) |
| Source record ids | github_search_engines-296931d957c07c |

## System Engineer Summary

Open source Final Fantasy VIII engine implementation in C# working on Windows and Linux (Android and
iOS planned too!) Monogame

## Operational Role

For a systems engineer, MaKiPL/OpenVIII-monogame belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-15T22:12:00Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-296931d957c07c` from `github_search_engines` as `registry_expansion`
