...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/timeago -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/timeago](https://pub.dev/packages/timeago) |
| Source record ids | pub_dev-1e15e166b2fc71 |
...
For a systems engineer, timeago belongs in the Dart inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.1 | 2025-05-10T20:32:33.655704Z | [https://pub.dev/api/packages/timeago](https://pub.dev/api/packages/timeago) |  |
| preview | known | 3.0.0-nullsafety.0 | 2021-01-23T19:49:17.217604Z | [https://pub.dev/api/packages/timeago](https://pub.dev/api/packages/timeago) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/timeago` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-1e15e166b2fc71` from `pub_dev` as `registry_expansion`
