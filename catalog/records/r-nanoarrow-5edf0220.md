...
<!-- canonical: https://cran.r-project.org/web/packages/nanoarrow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nanoarrow/index.html](https://cran.r-project.org/web/packages/nanoarrow/index.html) |
| Source record ids | cran_packages_by_date-e8383f9a3bb42e |
...
For a systems engineer, nanoarrow belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-04 23:50:08 UTC | [https://cran.r-project.org/web/packages/nanoarrow/DESCRIPTION](https://cran.r-project.org/web/packages/nanoarrow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nanoarrow/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e8383f9a3bb42e` from `cran_packages_by_date` as `registry_expansion`
