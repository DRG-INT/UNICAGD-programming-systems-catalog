...
<!-- canonical: https://crates.io/crates/rustc-hash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustc-hash](https://crates.io/crates/rustc-hash) |
| Source record ids | crates_io-70afc7a6e0b60d |
...
For a systems engineer, rustc-hash belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2026-07-03T11:55:08.028059Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `crates_io-70afc7a6e0b60d` from `crates_io` as `registry_expansion`
