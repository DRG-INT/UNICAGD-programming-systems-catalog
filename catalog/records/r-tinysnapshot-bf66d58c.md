...
<!-- canonical: https://cran.r-project.org/web/packages/tinysnapshot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinysnapshot/index.html](https://cran.r-project.org/web/packages/tinysnapshot/index.html) |
| Source record ids | cran_packages_by_date-7cb6d4bbe1b2dc |
...
For a systems engineer, tinysnapshot belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21 06:50:02 UTC | [https://cran.r-project.org/web/packages/tinysnapshot/DESCRIPTION](https://cran.r-project.org/web/packages/tinysnapshot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinysnapshot/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7cb6d4bbe1b2dc` from `cran_packages_by_date` as `registry_expansion`
