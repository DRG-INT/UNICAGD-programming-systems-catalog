...
<!-- canonical: https://cran.r-project.org/web/packages/SimpleUpset/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SimpleUpset/index.html](https://cran.r-project.org/web/packages/SimpleUpset/index.html) |
| Source record ids | cran_packages_by_date-28512217134303 |

## System Engineer Summary

SimpleUpset is tracked as a visualization gui record in the R branch. The source did not provide a
...
For a systems engineer, SimpleUpset belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-09-01 15:50:02 UTC | [https://cran.r-project.org/web/packages/SimpleUpset/DESCRIPTION](https://cran.r-project.org/web/packages/SimpleUpset/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SimpleUpset/DESCRIPTION` at `2026-09-01T16:41:04+00:00`.
...
- `cran_packages_by_date-28512217134303` from `cran_packages_by_date` as `registry_expansion`
