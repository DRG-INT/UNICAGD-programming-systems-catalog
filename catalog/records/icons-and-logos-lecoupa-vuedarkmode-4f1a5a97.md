...
<!-- canonical: https://github.com/LeCoupa/vuedarkmode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LeCoupa/vuedarkmode](https://github.com/LeCoupa/vuedarkmode) |
| Source record ids | github_search_icons_and_logos-7be309d9343e7f |

## System Engineer Summary

👩‍🎨👨‍🎨 A minimalist dark design system for Vue.js. Based components designed for the insomniacs who
enjoy dark interfaces as much as we do.

## Operational Role

For a systems engineer, LeCoupa/vuedarkmode belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-30T19:31:48Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7be309d9343e7f` from `github_search_icons_and_logos` as `registry_expansion`
