...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/acquire_movie_data/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acquire_movie_data/](https://pypi.org/project/acquire_movie_data/) |
| Source record ids | pypi_simple-5e9deb6962aafc |

## System Engineer Summary

acquire_movie_data is tracked as a visualization gui record in the Python branch. The source did not
...
For a systems engineer, acquire_movie_data belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2024-08-14T10:21:34.070930Z | [https://pypi.org/pypi/acquire_movie_data/json](https://pypi.org/pypi/acquire_movie_data/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acquire_movie_data/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-5e9deb6962aafc` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Matplotlib | Visualization Gui | [open](python-matplotlib-2f42646e.md) |
