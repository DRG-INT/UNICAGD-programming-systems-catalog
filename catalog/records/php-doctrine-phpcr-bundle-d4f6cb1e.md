...
| Canonical URL | [https://packagist.org/packages/doctrine/phpcr-bundle](https://packagist.org/packages/doctrine/phpcr-bundle) |
| Source record ids | packagist_search-1b06f94eb67f5f |
...
For a systems engineer, doctrine/phpcr-bundle belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-03-24T14:34:25+00:00 | [https://repo.packagist.org/p2/doctrine/phpcr-bundle.json](https://repo.packagist.org/p2/doctrine/phpcr-bundle.json) |  |
| preview | known | 3.0.0-beta2 | 2024-02-05T10:25:09+00:00 | [https://repo.packagist.org/p2/doctrine/phpcr-bundle.json](https://repo.packagist.org/p2/doctrine/phpcr-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/doctrine/phpcr-bundle.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-1b06f94eb67f5f` from `packagist_search` as `registry_expansion`
