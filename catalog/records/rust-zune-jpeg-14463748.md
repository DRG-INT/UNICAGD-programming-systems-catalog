...
<!-- canonical: https://crates.io/crates/zune-jpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zune-jpeg](https://crates.io/crates/zune-jpeg) |
| Source record ids | crates_io-ef05de985836a8 |
...
For a systems engineer, zune-jpeg belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.15 | 2026-09-08T16:56:45.297862Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-08T18:23:35+00:00`.
...
- `crates_io-ef05de985836a8` from `crates_io` as `registry_expansion`
