...
<!-- canonical: https://github.com/magpylib/magpylib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/magpylib/magpylib](https://github.com/magpylib/magpylib) |
| Source record ids | github_search_physics_engines-3efb4997d22be8 |
...
For a systems engineer, magpylib/magpylib belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:43:29Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-3efb4997d22be8` from `github_search_physics_engines` as `registry_expansion`
