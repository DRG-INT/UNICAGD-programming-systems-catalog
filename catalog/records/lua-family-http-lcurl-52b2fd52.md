...
| Canonical URL | [https://luarocks.org/modules/saspivey98/http-lcurl](https://luarocks.org/modules/saspivey98/http-lcurl) |
| Source record ids | luarocks_root_manifest-d5158f1a2f1ae0 |
...
For a systems engineer, http-lcurl belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-d5158f1a2f1ae0` from `luarocks_root_manifest` as `registry_expansion`
