...
<!-- canonical: https://luarocks.org/modules/heinrichhartmann/basics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/heinrichhartmann/basics](https://luarocks.org/modules/heinrichhartmann/basics) |
| Source record ids | luarocks_root_manifest-8b7f33f31a343d |

## System Engineer Summary

basics is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, basics belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-8b7f33f31a343d` from `luarocks_root_manifest` as `registry_expansion`
