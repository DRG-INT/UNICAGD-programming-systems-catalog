...
| Canonical URL | [https://github.com/MatthewPeterKelly/OptimTraj](https://github.com/MatthewPeterKelly/OptimTraj) |
| Source record ids | github_search_matlab-27c75c4e454e93 |
...
For a systems engineer, MatthewPeterKelly/OptimTraj belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.7 | 2022-12-13T00:55:00Z | [https://api.github.com/repos/MatthewPeterKelly/OptimTraj/releases/latest](https://api.github.com/repos/MatthewPeterKelly/OptimTraj/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/MatthewPeterKelly/OptimTraj/releases/latest` at `2026-09-01T07:24:11+00:00`.
...
- `github_search_matlab-27c75c4e454e93` from `github_search_matlab` as `registry_expansion`
