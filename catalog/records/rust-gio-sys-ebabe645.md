...
| Canonical URL | [https://crates.io/crates/gio-sys](https://crates.io/crates/gio-sys) |
| Source record ids | crates_io-b1d3d05ce1c1da |
...
For a systems engineer, gio-sys belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.9 | 2026-08-30T17:39:30.769168Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-b1d3d05ce1c1da` from `crates_io` as `registry_expansion`
