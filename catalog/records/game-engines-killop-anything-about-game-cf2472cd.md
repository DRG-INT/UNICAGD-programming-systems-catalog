...
<!-- canonical: https://github.com/killop/anything_about_game -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/killop/anything_about_game](https://github.com/killop/anything_about_game) |
| Source record ids | github_search_game_engines-eaec0069dc9929 |
...
For a systems engineer, killop/anything_about_game belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T03:38:38Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-eaec0069dc9929` from `github_search_game_engines` as `registry_expansion`
