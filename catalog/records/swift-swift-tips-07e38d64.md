...
<!-- canonical: https://github.com/vincent-pradeilles/swift-tips -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vincent-pradeilles/swift-tips](https://github.com/vincent-pradeilles/swift-tips) |
| Source record ids | awesome_list-a0cce3e128827d, awesome_list-84552287d148fe |
...
For a systems engineer, swift-tips belongs in the Swift inventory as part of ecosystem capability
...
- `awesome_list-a0cce3e128827d` from `awesome_list` as `registry_expansion`
- `awesome_list-84552287d148fe` from `awesome_list` as `registry_expansion`
