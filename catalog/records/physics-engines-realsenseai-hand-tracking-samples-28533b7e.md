...
<!-- canonical: https://github.com/realsenseai/hand_tracking_samples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realsenseai/hand_tracking_samples](https://github.com/realsenseai/hand_tracking_samples) |
| Source record ids | github_search_physics_engines-e093e0658c532b |

## System Engineer Summary

:wave: :ok_hand: research codebase for depth-based hand pose estimation using dynamics based
tracking and CNNs

## Operational Role

For a systems engineer, realsenseai/hand_tracking_samples belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-25T20:11:35Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e093e0658c532b` from `github_search_physics_engines` as `registry_expansion`
