...
<!-- canonical: https://hackage.haskell.org/package/comonad -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/comonad](https://hackage.haskell.org/package/comonad) |
| Source record ids | hackage_top_downloads-19187cfd2b93aa |
...
For a systems engineer, comonad belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.10 | 2026-01-10T19:53:23Z | [https://hackage.haskell.org/package/comonad](https://hackage.haskell.org/package/comonad) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/comonad` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-19187cfd2b93aa` from `hackage_top_downloads` as `registry_expansion`
