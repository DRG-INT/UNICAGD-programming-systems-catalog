...
| Canonical URL | [https://crates.io/crates/tracing-subscriber](https://crates.io/crates/tracing-subscriber) |
| Source record ids | corpus-c65495e0572c2a |
...
For a systems engineer, tracing-subscriber belongs in the Rust inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.23 | 2026-03-13T10:04:15.571048Z | [https://crates.io/api/v1/crates/tracing-subscriber](https://crates.io/api/v1/crates/tracing-subscriber) |  |
| preview | known | 0.2.0-alpha.6 | 2020-02-03T22:23:51.369146Z | [https://crates.io/api/v1/crates/tracing-subscriber](https://crates.io/api/v1/crates/tracing-subscriber) |  |

## Engineering Notes

- Treat category as `logging_observability` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/tracing-subscriber` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-c65495e0572c2a` from `master_json` as `logging_observability`
