...
<!-- canonical: https://cran.r-project.org/web/packages/MMAD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MMAD/index.html](https://cran.r-project.org/web/packages/MMAD/index.html) |
| Source record ids | cran_packages_by_date-dd37e9a0d1823b |
...
For a systems engineer, MMAD belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-08-31 21:20:09 UTC | [https://cran.r-project.org/web/packages/MMAD/DESCRIPTION](https://cran.r-project.org/web/packages/MMAD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MMAD/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dd37e9a0d1823b` from `cran_packages_by_date` as `registry_expansion`
