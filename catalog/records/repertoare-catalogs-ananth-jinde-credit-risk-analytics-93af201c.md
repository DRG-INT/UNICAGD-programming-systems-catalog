# Ananth-Jinde/Credit-Risk-Analytics
...
<!-- canonical: https://github.com/Ananth-Jinde/Credit-Risk-Analytics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ananth-Jinde/Credit-Risk-Analytics](https://github.com/Ananth-Jinde/Credit-Risk-Analytics) |
| Source record ids | github_search_repertoare_catalogs-53a8d5e91f92ba |

## System Engineer Summary

An end-to-end data engineering pipeline on Azure Databricks that processes 2.2M+ consumer loan
records through the Medallion Architecture using PySpark, Delta Lake, and Unity Catalog, producing
credit risk scores for every borrower.

## Operational Role

For a systems engineer, Ananth-Jinde/Credit-Risk-Analytics belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-29T07:09:33Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-53a8d5e91f92ba` from `github_search_repertoare_catalogs` as `registry_expansion`
