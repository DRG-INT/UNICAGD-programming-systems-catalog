...
<!-- canonical: https://luarocks.org/modules/xshower/async-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/xshower/async-framework](https://luarocks.org/modules/xshower/async-framework) |
| Source record ids | luarocks_root_manifest-b04d53f7be8d2d |
...
For a systems engineer, async-framework belongs in the Lua family inventory as part of concurrency
...
- `luarocks_root_manifest-b04d53f7be8d2d` from `luarocks_root_manifest` as `registry_expansion`
