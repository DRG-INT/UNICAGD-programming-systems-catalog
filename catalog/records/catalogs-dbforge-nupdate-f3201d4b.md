...
<!-- canonical: https://github.com/dbforge/nUpdate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbforge/nUpdate](https://github.com/dbforge/nUpdate) |
| Source record ids | github_search_catalogs-3782e8f9db534c |
...
For a systems engineer, dbforge/nUpdate belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-18T08:17:16Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-3782e8f9db534c` from `github_search_catalogs` as `registry_expansion`
