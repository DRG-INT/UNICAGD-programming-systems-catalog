...
<!-- canonical: https://github.com/astaxie/build-web-application-with-golang -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/astaxie/build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) |
| Source record ids | github_search_go-74b1a2db615792 |
...
For a systems engineer, astaxie/build-web-application-with-golang belongs in the Go inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-12T00:47:46Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-74b1a2db615792` from `github_search_go` as `registry_expansion`
...
| beego/beego | Language Specification | [open](go-beego-beego-e98bc924.md) |
