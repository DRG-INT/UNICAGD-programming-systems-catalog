...
<!-- canonical: https://cran.r-project.org/web/packages/tmbstan/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tmbstan/index.html](https://cran.r-project.org/web/packages/tmbstan/index.html) |
| Source record ids | cran_packages_by_date-c302a0afb24220 |
...
For a systems engineer, tmbstan belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-11 17:00:02 UTC | [https://cran.r-project.org/web/packages/tmbstan/DESCRIPTION](https://cran.r-project.org/web/packages/tmbstan/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tmbstan/DESCRIPTION` at `2026-09-11T18:22:54+00:00`.
...
- `cran_packages_by_date-c302a0afb24220` from `cran_packages_by_date` as `registry_expansion`
