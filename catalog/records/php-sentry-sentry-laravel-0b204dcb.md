...
<!-- canonical: https://packagist.org/packages/sentry/sentry-laravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sentry/sentry-laravel](https://packagist.org/packages/sentry/sentry-laravel) |
| Source record ids | packagist_search-94e995fee2c6f4 |

## System Engineer Summary

sentry/sentry-laravel is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, sentry/sentry-laravel belongs in the PHP inventory as part of service
...
- `packagist_search-94e995fee2c6f4` from `packagist_search` as `registry_expansion`
