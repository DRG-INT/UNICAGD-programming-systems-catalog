...
<!-- canonical: https://github.com/ultralytics/functions-matlab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ultralytics/functions-matlab](https://github.com/ultralytics/functions-matlab) |
| Source record ids | github_search_matlab-ae279c58e7abcb |

## System Engineer Summary

Shared MATLAB utility functions for Ultralytics scientific computing, machine learning, data
analysis, geometry, visualization, and reusable research workflows.

## Operational Role

For a systems engineer, ultralytics/functions-matlab belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T10:25:16Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ae279c58e7abcb` from `github_search_matlab` as `registry_expansion`
