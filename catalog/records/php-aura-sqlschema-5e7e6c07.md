...
| Canonical URL | [https://packagist.org/packages/aura/sqlschema](https://packagist.org/packages/aura/sqlschema) |
| Source record ids | packagist_search-f055a9653d9380 |
...
For a systems engineer, aura/sqlschema belongs in the PHP inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2016-04-29T13:49:00+00:00 | [https://repo.packagist.org/p2/aura/sqlschema.json](https://repo.packagist.org/p2/aura/sqlschema.json) |  |
| preview | known | 2.0.0-beta1 | 2014-01-10T15:29:50+00:00 | [https://repo.packagist.org/p2/aura/sqlschema.json](https://repo.packagist.org/p2/aura/sqlschema.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/aura/sqlschema.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-f055a9653d9380` from `packagist_search` as `registry_expansion`
