...
<!-- canonical: https://packagist.org/packages/typo3/testing-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/typo3/testing-framework](https://packagist.org/packages/typo3/testing-framework) |
| Source record ids | packagist_search-6d691ed7bcf3d8 |
...
For a systems engineer, typo3/testing-framework belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-6d691ed7bcf3d8` from `packagist_search` as `registry_expansion`
