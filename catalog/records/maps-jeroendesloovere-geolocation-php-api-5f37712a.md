...
<!-- canonical: https://github.com/jeroendesloovere/geolocation-php-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeroendesloovere/geolocation-php-api](https://github.com/jeroendesloovere/geolocation-php-api) |
| Source record ids | github_search_maps-f45389b5e0fb01 |

## System Engineer Summary

This Geolocation PHP class connects to Google Geocoding API to find latitude/longitude or the
address.

## Operational Role

For a systems engineer, jeroendesloovere/geolocation-php-api belongs in the Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2023-07-16T04:55:54Z | [https://api.github.com/repos/jeroendesloovere/geolocation-php-api/releases/latest](https://api.github.com/repos/jeroendesloovere/geolocation-php-api/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jeroendesloovere/geolocation-php-api/releases/latest` at `2026-09-01T12:30:01+00:00`.
...
- `github_search_maps-f45389b5e0fb01` from `github_search_maps` as `registry_expansion`
