...
<!-- canonical: https://github.com/patroni/patroni -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/patroni/patroni](https://github.com/patroni/patroni) |
| Source record ids | github_search_databases-845f838bde09cd |
...
For a systems engineer, patroni/patroni belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T07:11:11Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-845f838bde09cd` from `github_search_databases` as `registry_expansion`
