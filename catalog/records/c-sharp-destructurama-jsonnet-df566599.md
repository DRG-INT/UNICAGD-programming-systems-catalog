...
<!-- canonical: https://www.nuget.org/packages/Destructurama.JsonNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Destructurama.JsonNet](https://www.nuget.org/packages/Destructurama.JsonNet) |
| Source record ids | nuget_search-90cc6317064da1 |
...
For a systems engineer, Destructurama.JsonNet belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2025-02-16T14:41:50.52+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/destructurama.jsonnet/index.json](https://api.nuget.org/v3/registration5-gz-semver2/destructurama.jsonnet/index.json) |  |
| preview | known | 2.0.1-dev-00038 | 2023-10-31T06:34:49.453+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/destructurama.jsonnet/index.json](https://api.nuget.org/v3/registration5-gz-semver2/destructurama.jsonnet/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Apache-2.0; https://www.nuget.org/packages/Destructurama.JsonNet/4.0.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/destructurama.jsonnet/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-90cc6317064da1` from `nuget_search` as `registry_expansion`
