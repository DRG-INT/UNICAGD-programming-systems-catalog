...
<!-- canonical: https://crates.io/crates/zvariant_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zvariant_derive](https://crates.io/crates/zvariant_derive) |
| Source record ids | crates_io-d6a76a044e38a5 |
...
For a systems engineer, zvariant_derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.15.0 | 2026-08-18T11:46:04.962442Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-d6a76a044e38a5` from `crates_io` as `registry_expansion`
