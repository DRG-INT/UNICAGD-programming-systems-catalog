...
<!-- canonical: https://github.com/koel/koel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/koel/koel](https://github.com/koel/koel) |
| Source record ids | github_search_video-9645b2a7a4e05f |
...
For a systems engineer, koel/koel belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T01:14:32Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-9645b2a7a4e05f` from `github_search_video` as `registry_expansion`
