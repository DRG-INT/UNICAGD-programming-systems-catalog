...
<!-- canonical: https://cran.r-project.org/web/packages/rmarkdown/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rmarkdown/index.html](https://cran.r-project.org/web/packages/rmarkdown/index.html) |
| Source record ids | cran_packages_by_date-5a494a2c8c3b63 |

## System Engineer Summary

rmarkdown is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, rmarkdown belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.32 | 2026-09-01 13:10:02 UTC | [https://cran.r-project.org/web/packages/rmarkdown/DESCRIPTION](https://cran.r-project.org/web/packages/rmarkdown/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rmarkdown/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5a494a2c8c3b63` from `cran_packages_by_date` as `registry_expansion`
