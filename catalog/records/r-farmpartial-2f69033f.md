...
<!-- canonical: https://cran.r-project.org/web/packages/farmPartial/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/farmPartial/index.html](https://cran.r-project.org/web/packages/farmPartial/index.html) |
| Source record ids | cran_packages_by_date-bc8c927667aa84 |

## System Engineer Summary

Tools for Farm Partial-Budget Analysis

## Operational Role

For a systems engineer, farmPartial belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 14:40:10 UTC | [https://cran.r-project.org/web/packages/farmPartial/DESCRIPTION](https://cran.r-project.org/web/packages/farmPartial/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/farmPartial/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-bc8c927667aa84` from `cran_packages_by_date` as `registry_expansion`
