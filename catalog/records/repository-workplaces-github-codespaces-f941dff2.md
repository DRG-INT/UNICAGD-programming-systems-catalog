...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Repository Workplaces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/repository-workplaces.md) · [Category: Ide Editor Integration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ide-editor-integration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://docs.github.com/codespaces](https://docs.github.com/codespaces) |
| Source record ids | curated_repository_workplace_routes-b3b8ea8d31eba4 |

## System Engineer Summary

Hosted development environment connected to GitHub repositories and developer workflows.

## Operational Role

For a systems engineer, GitHub Codespaces belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-b3b8ea8d31eba4` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| TortoiseSVN | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-tortoisesvn-4a41fae3.md) |
