...
| Canonical URL | [https://crates.io/crates/gix-path](https://crates.io/crates/gix-path) |
| Source record ids | crates_io-8772fc489cab2d |
...
For a systems engineer, gix-path belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.6 | 2026-09-01T03:13:56.290562Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-01T03:20:08+00:00`.
...
- `crates_io-8772fc489cab2d` from `crates_io` as `registry_expansion`
