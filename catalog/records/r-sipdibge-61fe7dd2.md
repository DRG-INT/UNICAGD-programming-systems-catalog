...
<!-- canonical: https://cran.r-project.org/web/packages/SIPDIBGE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SIPDIBGE/index.html](https://cran.r-project.org/web/packages/SIPDIBGE/index.html) |
| Source record ids | cran_packages_by_date-36aab2e29f8f74 |
...
For a systems engineer, SIPDIBGE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-12 14:10:28 UTC | [https://cran.r-project.org/web/packages/SIPDIBGE/DESCRIPTION](https://cran.r-project.org/web/packages/SIPDIBGE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SIPDIBGE/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-36aab2e29f8f74` from `cran_packages_by_date` as `registry_expansion`
