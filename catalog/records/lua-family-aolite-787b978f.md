...
<!-- canonical: https://luarocks.org/modules/perplex/aolite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/perplex/aolite](https://luarocks.org/modules/perplex/aolite) |
| Source record ids | luarocks_root_manifest-8a30f879ab88e7 |

## System Engineer Summary

A local, concurrent emulation of the AO protocol for testing Lua processes.

## Operational Role

For a systems engineer, aolite belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-8a30f879ab88e7` from `luarocks_root_manifest` as `registry_expansion`
