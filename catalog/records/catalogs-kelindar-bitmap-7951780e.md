...
<!-- canonical: https://github.com/kelindar/bitmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kelindar/bitmap](https://github.com/kelindar/bitmap) |
| Source record ids | github_search_catalogs-c9088adf7f984b |
...
For a systems engineer, kelindar/bitmap belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-07T13:18:26Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c9088adf7f984b` from `github_search_catalogs` as `registry_expansion`
