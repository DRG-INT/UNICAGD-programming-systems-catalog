...
<!-- canonical: https://github.com/indutny/spectrum-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/indutny/spectrum-analyzer](https://github.com/indutny/spectrum-analyzer) |
| Source record ids | github_search_electromagnetoscopes-6f94cd3e9e13a1 |
...
For a systems engineer, indutny/spectrum-analyzer belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-03-10T13:36:03Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6f94cd3e9e13a1` from `github_search_electromagnetoscopes` as `registry_expansion`
