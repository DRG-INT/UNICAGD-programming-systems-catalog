...
| Source record ids | master-f497187900b6 |

## System Engineer Summary

ThreadSanitizer is tracked as a sanitizer record in the C99 branch. The source did not provide a
...
For a systems engineer, ThreadSanitizer belongs in the C99 inventory as part of ecosystem capability
...
- `master-f497187900b6` from `master_json` as `sanitizer`
