...
| Canonical URL | [https://github.com/namidaco/namida](https://github.com/namidaco/namida) |
| Source record ids | github_search_video-9b2e9f8b16401f |
...
For a systems engineer, namidaco/namida belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.0.1 | 2026-04-18T15:01:33Z | [https://api.github.com/repos/namidaco/namida/releases/latest](https://api.github.com/repos/namidaco/namida/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/namidaco/namida/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-9b2e9f8b16401f` from `github_search_video` as `registry_expansion`
