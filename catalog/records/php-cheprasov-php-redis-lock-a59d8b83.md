...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/cheprasov/php-redis-lock](https://packagist.org/packages/cheprasov/php-redis-lock) |
| Source record ids | packagist_search-883a4fddf94ea5 |

## System Engineer Summary

RedisLock for PHP is a synchronization mechanism for enforcing limits on access to a resource in an
environment where there are many threads of execution. A lock is designed to enforce a mutual
exclusion concurrency control policy.

## Operational Role

For a systems engineer, cheprasov/php-redis-lock belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2017-10-08T15:59:51+00:00 | [https://repo.packagist.org/p2/cheprasov/php-redis-lock.json](https://repo.packagist.org/p2/cheprasov/php-redis-lock.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cheprasov/php-redis-lock.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-883a4fddf94ea5` from `packagist_search` as `registry_expansion`
