...
<!-- canonical: https://github.com/miniflux/v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/miniflux/v2](https://github.com/miniflux/v2) |
| Source record ids | github_search_databases-bb0176a7ff1478 |
...
For a systems engineer, miniflux/v2 belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T22:32:31Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-bb0176a7ff1478` from `github_search_databases` as `registry_expansion`
