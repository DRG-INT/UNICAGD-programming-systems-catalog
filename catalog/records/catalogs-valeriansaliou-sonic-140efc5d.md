...
<!-- canonical: https://github.com/valeriansaliou/sonic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/valeriansaliou/sonic](https://github.com/valeriansaliou/sonic) |
| Source record ids | github_search_catalogs-de80c9ddcbe574 |

## System Engineer Summary

🦔 Fast, lightweight & schema-less search backend. An alternative to Elasticsearch that runs on a few
MBs of RAM.

## Operational Role

For a systems engineer, valeriansaliou/sonic belongs in the Catalogs inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T15:43:58Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:index stars:>100", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-de80c9ddcbe574` from `github_search_catalogs` as `registry_expansion`
