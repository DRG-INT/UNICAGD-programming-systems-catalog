...
<!-- canonical: https://subversion.apache.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://subversion.apache.org/](https://subversion.apache.org/) |
| Source record ids | curated_repository_workplace_routes-de38b543bdbb4b |

## System Engineer Summary

Centralized version control system with working copies, commits, branches, tags, externals, hooks,
and repository administration.

## Operational Role

For a systems engineer, Apache Subversion belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-de38b543bdbb4b` from `curated_repository_workplace_routes` as `registry_expansion`
