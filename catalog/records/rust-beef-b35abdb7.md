...
<!-- canonical: https://crates.io/crates/beef -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/beef](https://crates.io/crates/beef) |
| Source record ids | crates_io-38a450c8134679 |

## System Engineer Summary

beef is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, beef belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2022-05-27T09:55:49.490487Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-38a450c8134679` from `crates_io` as `registry_expansion`
