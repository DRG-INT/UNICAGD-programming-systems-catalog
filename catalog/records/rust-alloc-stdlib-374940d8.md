...
<!-- canonical: https://crates.io/crates/alloc-stdlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/alloc-stdlib](https://crates.io/crates/alloc-stdlib) |
| Source record ids | crates_io-4352b5d89372e3 |
...
For a systems engineer, alloc-stdlib belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-06-14T18:42:03.107883Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-4352b5d89372e3` from `crates_io` as `registry_expansion`
