# ytann/ML-Projects-Repertoire

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ytann/ML-Projects-Repertoire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ytann/ML-Projects-Repertoire](https://github.com/ytann/ML-Projects-Repertoire) |
| Source record ids | github_search_repertoare_catalogs-e4bb0a980260e4 |

## System Engineer Summary

Collection of ML Projects based on Infinite Codes YT Channel Video (mostly because we're all bored
and learning is never bad)

## Operational Role

For a systems engineer, ytann/ML-Projects-Repertoire belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-14T13:35:38Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-e4bb0a980260e4` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| abhiramAjay/Self-Healing-Repertoire-Engine | Ide Editor Integration | [open](repertoare-catalogs-abhiramajay-self-healing-repertoire-engine-afff2269.md) |
| gastroph/Rock-Band-DLC---Leaderboards-App-for-Android | Ide Editor Integration | [open](repertoare-catalogs-gastroph-rock-band-dlc-leaderboards-app-for-android-35abaa1b.md) |
| heylabs-co/dev-tools-portal | Ide Editor Integration | [open](repertoare-catalogs-heylabs-co-dev-tools-portal-7c271bc4.md) |
| jasondentler/wild-catalog | Ide Editor Integration | [open](repertoare-catalogs-jasondentler-wild-catalog-f314f00b.md) |
| pesnik/flask-repertoire | Ide Editor Integration | [open](repertoare-catalogs-pesnik-flask-repertoire-569c53ed.md) |
| pesnik/gin-repertoire | Ide Editor Integration | [open](repertoare-catalogs-pesnik-gin-repertoire-59474943.md) |
| punyamodi/catalog-quality-scorer | Ide Editor Integration | [open](repertoare-catalogs-punyamodi-catalog-quality-scorer-78773128.md) |
| pythymcpyface/lichess-analyser | Ide Editor Integration | [open](repertoare-catalogs-pythymcpyface-lichess-analyser-18beb8d5.md) |
