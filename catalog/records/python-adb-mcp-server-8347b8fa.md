...
<!-- canonical: https://pypi.org/project/adb-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adb-mcp-server/](https://pypi.org/project/adb-mcp-server/) |
| Source record ids | pypi_simple-12be538012b11a |

## System Engineer Summary

A server implementation for handling ADB (Android Debug Bridge) communications using the Message
Control Protocol (MCP)

## Operational Role

For a systems engineer, adb-mcp-server belongs in the Python inventory as part of fault isolation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-05-12T03:28:15.294094Z | [https://pypi.org/pypi/adb-mcp-server/json](https://pypi.org/pypi/adb-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adb-mcp-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-12be538012b11a` from `pypi_simple` as `registry_expansion`
