...
<!-- canonical: https://hackage.haskell.org/package/functor-apply -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/functor-apply](https://hackage.haskell.org/package/functor-apply) |
| Source record ids | hackage_top_downloads-0b1842bd1baac1 |
...
For a systems engineer, functor-apply belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11 | 2011-01-30T12:19:53Z | [https://hackage.haskell.org/package/functor-apply](https://hackage.haskell.org/package/functor-apply) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/functor-apply` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-0b1842bd1baac1` from `hackage_top_downloads` as `registry_expansion`
