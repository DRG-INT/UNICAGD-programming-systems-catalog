...
<!-- canonical: https://cran.r-project.org/web/packages/vitae/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vitae/index.html](https://cran.r-project.org/web/packages/vitae/index.html) |
| Source record ids | cran_packages_by_date-7d675288995bc9 |
...
For a systems engineer, vitae belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-21 07:50:02 UTC | [https://cran.r-project.org/web/packages/vitae/DESCRIPTION](https://cran.r-project.org/web/packages/vitae/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vitae/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7d675288995bc9` from `cran_packages_by_date` as `registry_expansion`
