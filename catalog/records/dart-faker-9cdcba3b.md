...
<!-- canonical: https://pub.dev/packages/faker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/faker](https://pub.dev/packages/faker) |
| Source record ids | pub_dev-bd7a3191ed0059 |

## System Engineer Summary

A library for generating fake data. faker is heavily inspired by the Python package faker and, the
Ruby package ffaker.

## Operational Role

For a systems engineer, faker belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2024-08-21T20:38:51.395732Z | [https://pub.dev/api/packages/faker](https://pub.dev/api/packages/faker) |  |
| preview | known | 2.0.0-rc.2 | 2021-03-13T13:19:09.204928Z | [https://pub.dev/api/packages/faker](https://pub.dev/api/packages/faker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/faker` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-bd7a3191ed0059` from `pub_dev` as `registry_expansion`
