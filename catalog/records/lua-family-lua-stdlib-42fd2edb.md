...
| Source record ids | corpus-b841aac0b7010f |

## System Engineer Summary

lua-stdlib is tracked as an utility library record in the Lua family branch. The source did not
...
- `corpus-b841aac0b7010f` from `master_json` as `utility_library`
