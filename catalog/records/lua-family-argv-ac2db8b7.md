...
<!-- canonical: https://luarocks.org/modules/mah0x211/argv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/argv](https://luarocks.org/modules/mah0x211/argv) |
| Source record ids | luarocks_root_manifest-9a619582ec6a5a |
...
For a systems engineer, argv belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9a619582ec6a5a` from `luarocks_root_manifest` as `registry_expansion`
