...
<!-- canonical: https://crates.io/crates/atomic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/atomic](https://crates.io/crates/atomic) |
| Source record ids | crates_io-463563c353a8e8 |
...
For a systems engineer, atomic belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2025-06-20T07:00:18.336083Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-463563c353a8e8` from `crates_io` as `registry_expansion`
