...
<!-- canonical: https://cran.r-project.org/web/packages/bibliometrix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bibliometrix/index.html](https://cran.r-project.org/web/packages/bibliometrix/index.html) |
| Source record ids | cran_packages_by_date-1a160d0932cb5f |
...
For a systems engineer, bibliometrix belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.5.0 | 2026-08-29 12:40:02 UTC | [https://cran.r-project.org/web/packages/bibliometrix/DESCRIPTION](https://cran.r-project.org/web/packages/bibliometrix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bibliometrix/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1a160d0932cb5f` from `cran_packages_by_date` as `registry_expansion`
