...
<!-- canonical: https://gitlab.com/yaook/operator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/yaook/operator](https://gitlab.com/yaook/operator) |
| Source record ids | gitlab_projects_api-44c87b9188d943 |
...
For a systems engineer, yaook/operator belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-44c87b9188d943` from `gitlab_projects_api` as `registry_expansion`
