...
<!-- canonical: https://cran.r-project.org/web/packages/Rhobots/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rhobots/index.html](https://cran.r-project.org/web/packages/Rhobots/index.html) |
| Source record ids | cran_packages_by_date-7772e8cf06ee52 |
...
For a systems engineer, Rhobots belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.10 | 2026-08-08 14:30:02 UTC | [https://cran.r-project.org/web/packages/Rhobots/DESCRIPTION](https://cran.r-project.org/web/packages/Rhobots/DESCRIPTION) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT + file LICENSE; ISC License; https://api.github.com/licenses/isc; Other |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rhobots/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7772e8cf06ee52` from `cran_packages_by_date` as `registry_expansion`
