...
| Canonical URL | [https://luarocks.org/modules/fffonion/fffonion-lua-resty-kafka](https://luarocks.org/modules/fffonion/fffonion-lua-resty-kafka) |
| Source record ids | luarocks_root_manifest-aa9a73cc569ac9 |
...
For a systems engineer, fffonion-lua-resty-kafka belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-aa9a73cc569ac9` from `luarocks_root_manifest` as `registry_expansion`
