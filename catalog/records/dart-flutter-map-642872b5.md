...
<!-- canonical: https://pub.dev/packages/flutter_map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_map](https://pub.dev/packages/flutter_map) |
| Source record ids | pub_dev-b9bdd2a7de9e0d |
...
For a systems engineer, flutter_map belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.3.2 | 2026-08-27T21:34:57.558084Z | [https://pub.dev/api/packages/flutter_map](https://pub.dev/api/packages/flutter_map) |  |
| preview | known | 7.0.0-dev.1 | 2024-04-02T15:08:19.210614Z | [https://pub.dev/api/packages/flutter_map](https://pub.dev/api/packages/flutter_map) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_map` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-b9bdd2a7de9e0d` from `pub_dev` as `registry_expansion`
