...
<!-- canonical: https://cran.r-project.org/web/packages/openscoring/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/openscoring/index.html](https://cran.r-project.org/web/packages/openscoring/index.html) |
| Source record ids | cran_packages_by_date-6c5d554d5c1330 |
...
For a systems engineer, openscoring belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-22 15:50:13 UTC | [https://cran.r-project.org/web/packages/openscoring/DESCRIPTION](https://cran.r-project.org/web/packages/openscoring/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/openscoring/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6c5d554d5c1330` from `cran_packages_by_date` as `registry_expansion`
