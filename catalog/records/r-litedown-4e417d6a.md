...
<!-- canonical: https://cran.r-project.org/web/packages/litedown/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/litedown/index.html](https://cran.r-project.org/web/packages/litedown/index.html) |
| Source record ids | cran_packages_by_date-4b2f604198b477 |
...
For a systems engineer, litedown belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11 | 2026-08-26 17:00:10 UTC | [https://cran.r-project.org/web/packages/litedown/DESCRIPTION](https://cran.r-project.org/web/packages/litedown/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/litedown/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4b2f604198b477` from `cran_packages_by_date` as `registry_expansion`
