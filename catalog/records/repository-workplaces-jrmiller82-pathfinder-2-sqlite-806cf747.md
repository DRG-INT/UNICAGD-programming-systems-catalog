...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/jrmiller82/pathfinder-2-sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/jrmiller82/pathfinder-2-sqlite](https://gitlab.com/jrmiller82/pathfinder-2-sqlite) |
| Source record ids | gitlab_projects_api-0ec32849aa549d |

## System Engineer Summary

This will be a repository for the code necessary to generate a sqlite database containing the open
gaming content for the Pathfinder 2 table-top role-playing-game system that is available under the
Open Gaming License.

## Operational Role

For a systems engineer, jrmiller82/pathfinder-2-sqlite belongs in the Repository Workplaces
...
- `gitlab_projects_api-0ec32849aa549d` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dalibo/pg_migrate | Networking Http | [open](repository-workplaces-dalibo-pg-migrate-f66a654f.md) |
| Gitea: AaronFiore/btcpayserver-docker | Networking Http | [open](repository-workplaces-gitea-aaronfiore-btcpayserver-docker-65536044.md) |
| Gitea: ks2515/codecrafters-http-server-go | Networking Http | [open](repository-workplaces-gitea-ks2515-codecrafters-http-server-go-a645fafb.md) |
| Gitea: Opsdff/RiviLib | Networking Http | [open](repository-workplaces-gitea-opsdff-rivilib-b63af9b3.md) |
| grownetics/devops | Networking Http | [open](repository-workplaces-grownetics-devops-bfb0955b.md) |
| LondonAppDev/recipe-app-api-devops-starting-code | Networking Http | [open](repository-workplaces-londonappdev-recipe-app-api-devops-starting-code-ab68f6f2.md) |
| lu-ci/sigma/apex-sigma | Networking Http | [open](repository-workplaces-lu-ci-sigma-apex-sigma-c11a60ff.md) |
| xavki/tutorials-postgresql | Networking Http | [open](repository-workplaces-xavki-tutorials-postgresql-a1210284.md) |
