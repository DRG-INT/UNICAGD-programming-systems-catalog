...
<!-- canonical: https://github.com/milos-agathon/esa-land-cover -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/milos-agathon/esa-land-cover](https://github.com/milos-agathon/esa-land-cover) |
| Source record ids | github_search_space_maps-566411628b63e5 |

## System Engineer Summary

Harnessing the power of ESA’s satellite data and Microsoft’s Planetary Computer STAC API, we’re
crafting detailed maps of land cover using R. Whether you’re a nature enthusiast or a city lover,
our tutorial will guide you through the fascinating process of visualizing our planet’s diverse
terrains

## Operational Role

For a systems engineer, milos-agathon/esa-land-cover belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-30T19:23:37Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-566411628b63e5` from `github_search_space_maps` as `registry_expansion`
