...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/datawhalechina/hello-agents -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | "aim's" |
| Category | Machine Learning |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) |
| Source record ids | github_search_aims-1e1d71cb04ab89 |
...
For a systems engineer, datawhalechina/hello-agents belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:03:14Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-16 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:llm stars:>500", "retrieved": "2026-09-16", "status": "forge-cli-derived"}` |
...
- `github_search_aims-1e1d71cb04ab89` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ahujasid/blender-mcp | Machine Learning | [open](aim-s-ahujasid-blender-mcp-814a3c64.md) |
| ahujasid/mcp-for-blender | Machine Learning | [open](aim-s-ahujasid-mcp-for-blender-9bb13dcb.md) |
| bojieli/ai-agent-book | Machine Learning | [open](aim-s-bojieli-ai-agent-book-5a1d8804.md) |
| browser-use/browser-use | Machine Learning | [open](aim-s-browser-use-browser-use-09b3f053.md) |
| chatchat-space/Langchain-Chatchat | Machine Learning | [open](aim-s-chatchat-space-langchain-chatchat-074047ac.md) |
| datawhalechina/happy-llm | Machine Learning | [open](aim-s-datawhalechina-happy-llm-00d4ee33.md) |
| datawhalechina/self-llm | Machine Learning | [open](aim-s-datawhalechina-self-llm-f636cd5d.md) |
| firecrawl/firecrawl | Machine Learning | [open](aim-s-firecrawl-firecrawl-e23e3125.md) |
