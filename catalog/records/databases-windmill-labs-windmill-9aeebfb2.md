...
<!-- canonical: https://github.com/windmill-labs/windmill -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/windmill-labs/windmill](https://github.com/windmill-labs/windmill) |
| Source record ids | github_search_databases-85a74bbaf01a52 |

## System Engineer Summary

Open-source developer platform to power your entire infra and turn scripts into webhooks, workflows
and UIs. Fastest workflow engine (13x vs Airflow). Open-source alternative to Retool and Temporal.

## Operational Role

For a systems engineer, windmill-labs/windmill belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T23:49:56Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-85a74bbaf01a52` from `github_search_databases` as `registry_expansion`
