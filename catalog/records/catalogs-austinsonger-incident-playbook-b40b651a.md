...
<!-- canonical: https://github.com/austinsonger/Incident-Playbook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/austinsonger/Incident-Playbook](https://github.com/austinsonger/Incident-Playbook) |
| Source record ids | github_search_catalogs-1b95ee5444c062 |

## System Engineer Summary

GOAL: Incident Response Playbooks Mapped to MITRE Attack Tactics and Techniques. Contributors
Friendly

## Operational Role

For a systems engineer, austinsonger/Incident-Playbook belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-28T04:19:40Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-1b95ee5444c062` from `github_search_catalogs` as `registry_expansion`
