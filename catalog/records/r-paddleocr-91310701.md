...
<!-- canonical: https://cran.r-project.org/web/packages/PaddleOCR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PaddleOCR/index.html](https://cran.r-project.org/web/packages/PaddleOCR/index.html) |
| Source record ids | cran_packages_by_date-45daa965ce1280 |

## System Engineer Summary

R Client for the 'PaddleOCR' Cloud API

## Operational Role

For a systems engineer, PaddleOCR belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-30 09:50:02 UTC | [https://cran.r-project.org/web/packages/PaddleOCR/DESCRIPTION](https://cran.r-project.org/web/packages/PaddleOCR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PaddleOCR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-45daa965ce1280` from `cran_packages_by_date` as `registry_expansion`
