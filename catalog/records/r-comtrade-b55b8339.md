...
<!-- canonical: https://cran.r-project.org/web/packages/comtrade/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/comtrade/index.html](https://cran.r-project.org/web/packages/comtrade/index.html) |
| Source record ids | cran_packages_by_date-157e68934a05de |
...
For a systems engineer, comtrade belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-09 13:00:08 UTC | [https://cran.r-project.org/web/packages/comtrade/DESCRIPTION](https://cran.r-project.org/web/packages/comtrade/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/comtrade/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-157e68934a05de` from `cran_packages_by_date` as `registry_expansion`
