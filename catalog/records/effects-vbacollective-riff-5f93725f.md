...
<!-- canonical: https://github.com/vbacollective/riff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vbacollective/riff](https://github.com/vbacollective/riff) |
| Source record ids | github_search_effects-aff78afd0a8d23 |

## System Engineer Summary

A complete audio engine for VBA. Load and play audio files, synthesize waveforms and apply real-time
DSP effects like reverb, chorus, delay and compressor, with zero dependencies.

## Operational Role

For a systems engineer, vbacollective/riff belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T14:31:29Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-aff78afd0a8d23` from `github_search_effects` as `registry_expansion`
