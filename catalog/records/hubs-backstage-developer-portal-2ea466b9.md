...
| Canonical URL | [https://backstage.io/](https://backstage.io/) |
| Source record ids | curated_language_routes-4b35910439da82 |

## System Engineer Summary

Developer portal and software catalog hub for components, APIs, resources, templates, documentation,
and ownership.

## Operational Role

For a systems engineer, Backstage Developer Portal belongs in the Hubs inventory as part of
...
- `curated_language_routes-4b35910439da82` from `curated_language_routes` as `registry_expansion`
