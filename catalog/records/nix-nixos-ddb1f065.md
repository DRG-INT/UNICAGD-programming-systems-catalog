...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://nixos.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://nixos.org/](https://nixos.org/) |
| Source record ids | curated_language_routes-e1297f4686338a |

## System Engineer Summary

NixOS operating system project built around declarative system configuration and Nix packages.

## Operational Role

For a systems engineer, NixOS belongs in the nix inventory as part of ecosystem capability mapping,
...
- `curated_language_routes-e1297f4686338a` from `curated_language_routes` as `registry_expansion`
