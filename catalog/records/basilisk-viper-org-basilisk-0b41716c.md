...
<!-- canonical: https://github.com/viper-org/basilisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/viper-org/basilisk](https://github.com/viper-org/basilisk) |
| Source record ids | github_search_basilisk-f68fb60525d60b |

## System Engineer Summary

Compiler for the basilisk programming language

## Operational Role

For a systems engineer, viper-org/basilisk belongs in the Basilisk inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-15T17:47:48Z | gh search repos Basilisk language compiler | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_basilisk-f68fb60525d60b` from `github_search_basilisk` as `registry_expansion`
