...
<!-- canonical: https://hackage.haskell.org/package/format-heavy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/format-heavy](https://hackage.haskell.org/package/format-heavy) |
| Source record ids | hackage_recent-3456aa39c97965 |

## System Engineer Summary

Hackage package recently uploaded by l3o6.

## Operational Role

For a systems engineer, format-heavy belongs in the Haskell inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0.2 | 2026-09-11T16:04:15Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-11T16:21:15+00:00`.
...
- `hackage_recent-3456aa39c97965` from `hackage_recent` as `registry_expansion`
...
| formatting | Formatter | [open](haskell-formatting-265fd9f8.md) |
