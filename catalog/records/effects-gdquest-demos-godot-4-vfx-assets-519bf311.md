...
<!-- canonical: https://github.com/gdquest-demos/godot-4-VFX-assets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gdquest-demos/godot-4-VFX-assets](https://github.com/gdquest-demos/godot-4-VFX-assets) |
| Source record ids | github_search_effects-aa7cbfc9cc2eef |

## System Engineer Summary

Collection of free and open-source Godot 4 VFX assets. Includes particle examples, shaders, and
more.

## Operational Role

For a systems engineer, gdquest-demos/godot-4-VFX-assets belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-16T07:28:05Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-aa7cbfc9cc2eef` from `github_search_effects` as `registry_expansion`
