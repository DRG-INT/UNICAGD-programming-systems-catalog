...
<!-- canonical: https://github.com/danirod/jacqueline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danirod/jacqueline](https://github.com/danirod/jacqueline) |
| Source record ids | github_search_assembly-ca35968a44cd62 |
...
For a systems engineer, danirod/jacqueline belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-27T13:08:51Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-ca35968a44cd62` from `github_search_assembly` as `registry_expansion`
