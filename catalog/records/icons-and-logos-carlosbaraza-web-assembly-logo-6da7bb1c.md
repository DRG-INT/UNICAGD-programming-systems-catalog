...
<!-- canonical: https://github.com/carlosbaraza/web-assembly-logo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/carlosbaraza/web-assembly-logo](https://github.com/carlosbaraza/web-assembly-logo) |
| Source record ids | github_search_icons_and_logos-492a6266a9f539 |

## System Engineer Summary

Web Assembly (WASM) official logo

## Operational Role

For a systems engineer, carlosbaraza/web-assembly-logo belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-08T11:45:06Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-492a6266a9f539` from `github_search_icons_and_logos` as `registry_expansion`
