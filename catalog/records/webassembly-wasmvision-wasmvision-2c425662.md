...
<!-- canonical: https://github.com/wasmvision/wasmvision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmvision/wasmvision](https://github.com/wasmvision/wasmvision) |
| Source record ids | github_search_webassembly-c216bc043c96ac |
...
For a systems engineer, wasmvision/wasmvision belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-16T10:21:03Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_webassembly-c216bc043c96ac` from `github_search_webassembly` as `registry_expansion`
