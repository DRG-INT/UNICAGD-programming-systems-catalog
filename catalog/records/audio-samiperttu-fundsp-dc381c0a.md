...
| Source record ids | github_search_audio-14d6f5e4d6f21e |
...
For a systems engineer, SamiPerttu/fundsp belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-03T15:41:09Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-14d6f5e4d6f21e` from `github_search_audio` as `registry_expansion`
