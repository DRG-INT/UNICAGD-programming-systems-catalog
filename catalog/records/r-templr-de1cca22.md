...
<!-- canonical: https://cran.r-project.org/web/packages/templr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/templr/index.html](https://cran.r-project.org/web/packages/templr/index.html) |
| Source record ids | cran_packages_by_date-fcfcc6a857f3ae |
...
For a systems engineer, templr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2-4 | 2026-08-26 12:30:02 UTC | [https://cran.r-project.org/web/packages/templr/DESCRIPTION](https://cran.r-project.org/web/packages/templr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/templr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fcfcc6a857f3ae` from `cran_packages_by_date` as `registry_expansion`
