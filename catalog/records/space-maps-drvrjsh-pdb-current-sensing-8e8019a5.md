...
<!-- canonical: https://github.com/drvrjsh/PDB-Current-Sensing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drvrjsh/PDB-Current-Sensing](https://github.com/drvrjsh/PDB-Current-Sensing) |
| Source record ids | github_search_space_maps-40385d8d279617 |

## System Engineer Summary

Multithreaded current monitoring system for the Carleton Planetary Robotics Team (CPRT) 2024 Power
Distribution Board. Uses an Arduino to read amperage from TI sensors over I2C, maps values to a
voltage range, and applies a moving average filter.

## Operational Role

For a systems engineer, drvrjsh/PDB-Current-Sensing belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-21T20:53:26Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-40385d8d279617` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| peaclab/PACT | Concurrency Parallelism | [open](space-maps-peaclab-pact-b52cc5c7.md) |
