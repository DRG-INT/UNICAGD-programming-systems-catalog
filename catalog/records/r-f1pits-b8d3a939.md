...
<!-- canonical: https://cran.r-project.org/web/packages/f1pits/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/f1pits/index.html](https://cran.r-project.org/web/packages/f1pits/index.html) |
| Source record ids | cran_packages_by_date-612b9ed26f9d50 |

## System Engineer Summary

f1pits is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, f1pits belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2026-08-24 18:10:02 UTC | [https://cran.r-project.org/web/packages/f1pits/DESCRIPTION](https://cran.r-project.org/web/packages/f1pits/DESCRIPTION) |  |
...
| Evidence | GPL (>= 3); MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/f1pits/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-612b9ed26f9d50` from `cran_packages_by_date` as `registry_expansion`
