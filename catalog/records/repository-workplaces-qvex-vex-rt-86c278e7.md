...
<!-- canonical: https://gitlab.com/qvex/vex-rt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/qvex/vex-rt](https://gitlab.com/qvex/vex-rt) |
| Source record ids | gitlab_projects_api-139d76b2348214 |

## System Engineer Summary

A Rust runtime for the Vex V5 built on top of PROS. Not affiliated with Innovation First, Inc.

## Operational Role

For a systems engineer, qvex/vex-rt belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-139d76b2348214` from `gitlab_projects_api` as `registry_expansion`
