...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DovAmir/awesome-design-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DovAmir/awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) |
| Source record ids | github_search_pattern_language-ebe2df3019b80c |
...
For a systems engineer, DovAmir/awesome-design-patterns belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-25T19:57:00Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-ebe2df3019b80c` from `github_search_pattern_language` as `registry_expansion`
