...
<!-- canonical: https://luarocks.org/modules/mah0x211/chdir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/chdir](https://luarocks.org/modules/mah0x211/chdir) |
| Source record ids | luarocks_root_manifest-7c3f3f6fd10a2e |
...
For a systems engineer, chdir belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7c3f3f6fd10a2e` from `luarocks_root_manifest` as `registry_expansion`
