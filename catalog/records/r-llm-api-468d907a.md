...
<!-- canonical: https://cran.r-project.org/web/packages/llm.api/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/llm.api/index.html](https://cran.r-project.org/web/packages/llm.api/index.html) |
| Source record ids | cran_packages_by_date-20ef3938575430 |
...
For a systems engineer, llm.api belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-08-04 21:50:02 UTC | [https://cran.r-project.org/web/packages/llm.api/DESCRIPTION](https://cran.r-project.org/web/packages/llm.api/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/llm.api/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-20ef3938575430` from `cran_packages_by_date` as `registry_expansion`
