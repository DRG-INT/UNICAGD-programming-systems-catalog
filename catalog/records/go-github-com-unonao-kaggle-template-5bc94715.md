# github.com/unonao/kaggle-template

## Navigation

[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pkg.go.dev/github.com/unonao/kaggle-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pkg.go.dev/github.com/unonao/kaggle-template](https://pkg.go.dev/github.com/unonao/kaggle-template) |
| Source record ids | go_module_index-7e6e4c953c9a4e |
...
For a systems engineer, github.com/unonao/kaggle-template belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.2+incompatible | 2026-08-30T14:07:56.203318Z | [https://index.golang.org/index?since=2026-08-30T13%3A32%3A16.143755Z&limit=2000](https://index.golang.org/index?since=2026-08-30T13%3A32%3A16.143755Z&limit=2000) |  |
...
- `go_module_index-7e6e4c953c9a4e` from `go_module_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| codoworks/go-boilerplate | Project Scaffolding | [open](go-codoworks-go-boilerplate-64f37da7.md) |
| confetti-framework/confetti | Project Scaffolding | [open](go-confetti-framework-confetti-741312c7.md) |
| github.com/continew-org/continew-starter | Project Scaffolding | [open](go-github-com-continew-org-continew-starter-7691250b.md) |
| github.com/micronaut-projects/micronaut-starter | Project Scaffolding | [open](go-github-com-micronaut-projects-micronaut-starter-0b6baca4.md) |
