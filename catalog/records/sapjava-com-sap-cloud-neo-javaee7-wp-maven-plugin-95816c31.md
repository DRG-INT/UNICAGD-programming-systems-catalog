# com.sap.cloud:neo-javaee7-wp-maven-plugin
...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud/neo-javaee7-wp-maven-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud/neo-javaee7-wp-maven-plugin](https://central.sonatype.com/artifact/com.sap.cloud/neo-javaee7-wp-maven-plugin) |
| Source record ids | maven_central_search-7b675863245006 |
...
For a systems engineer, com.sap.cloud:neo-javaee7-wp-maven-plugin belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.202.2 | 2025-06-11T13:48:34+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json) |  |
...
- Latest stable metadata was observed from `https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json` at `2026-09-01T11:19:07+00:00`.
...
| --- | --- | --- | --- |
| maven_central_search | registry-derived | 2026-09-02 | `{"kind": "maven_central_search", "query": "g:\"com.sap.cloud\"", "retrieved": "2026-09-02", "status": "registry-derived"}` |
...
- `maven_central_search-7b675863245006` from `maven_central_search` as `registry_expansion`
