...
<!-- canonical: https://cran.r-project.org/web/packages/TreeMineR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TreeMineR/index.html](https://cran.r-project.org/web/packages/TreeMineR/index.html) |
| Source record ids | cran_packages_by_date-2ee570a2b89bb4 |
...
For a systems engineer, TreeMineR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-28 13:30:27 UTC | [https://cran.r-project.org/web/packages/TreeMineR/DESCRIPTION](https://cran.r-project.org/web/packages/TreeMineR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TreeMineR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2ee570a2b89bb4` from `cran_packages_by_date` as `registry_expansion`
