...
<!-- canonical: https://cran.r-project.org/web/packages/cvar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cvar/index.html](https://cran.r-project.org/web/packages/cvar/index.html) |
| Source record ids | cran_packages_by_date-001da9fcc15d41 |
...
For a systems engineer, cvar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-21 15:00:08 UTC | [https://cran.r-project.org/web/packages/cvar/DESCRIPTION](https://cran.r-project.org/web/packages/cvar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cvar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-001da9fcc15d41` from `cran_packages_by_date` as `registry_expansion`
