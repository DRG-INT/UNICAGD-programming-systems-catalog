...
| Canonical URL | [https://luarocks.org/modules/polarmutex/git-worktree.nvim](https://luarocks.org/modules/polarmutex/git-worktree.nvim) |
| Source record ids | luarocks_root_manifest-73b8ed741bfc05 |
...
For a systems engineer, git-worktree.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-73b8ed741bfc05` from `luarocks_root_manifest` as `registry_expansion`
