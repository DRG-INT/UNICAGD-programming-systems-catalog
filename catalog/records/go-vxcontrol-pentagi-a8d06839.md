...
<!-- canonical: https://github.com/vxcontrol/pentagi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vxcontrol/pentagi](https://github.com/vxcontrol/pentagi) |
| Source record ids | github_search_go-29ea4a7a727d3f |
...
For a systems engineer, vxcontrol/pentagi belongs in the Go inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T20:28:29Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-29ea4a7a727d3f` from `github_search_go` as `registry_expansion`
