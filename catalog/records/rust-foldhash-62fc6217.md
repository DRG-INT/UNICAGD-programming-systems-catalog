...
<!-- canonical: https://crates.io/crates/foldhash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/foldhash](https://crates.io/crates/foldhash) |
| Source record ids | crates_io-b741a74e96da38 |
...
For a systems engineer, foldhash belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2025-08-23T19:14:01.103482Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-10T06:26:04+00:00`.
...
- `crates_io-b741a74e96da38` from `crates_io` as `registry_expansion`
