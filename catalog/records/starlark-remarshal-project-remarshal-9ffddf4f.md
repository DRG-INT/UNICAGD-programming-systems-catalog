...
| Canonical URL | [https://github.com/remarshal-project/remarshal](https://github.com/remarshal-project/remarshal) |
| Source record ids | github_search_starlark-506fab02e79425 |
...
For a systems engineer, remarshal-project/remarshal belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.4 | 2026-08-01T07:24:52Z | [https://api.github.com/repos/remarshal-project/remarshal/releases/latest](https://api.github.com/repos/remarshal-project/remarshal/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/remarshal-project/remarshal/releases/latest` at `2026-09-01T09:23:07+00:00`.
...
- `github_search_starlark-506fab02e79425` from `github_search_starlark` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| protoconf/protoconf | Serialization | [open](starlark-protoconf-protoconf-2d2b3184.md) |
