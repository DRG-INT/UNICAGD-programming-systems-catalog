...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/IBAX-io/go-ibax -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Assets |
| Category | Filesystem Os |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/IBAX-io/go-ibax](https://github.com/IBAX-io/go-ibax) |
| Source record ids | github_search_assets-7fde97bcd662bd |

## System Engineer Summary

An innovative Blockchain Protocol Platform, which everyone can deploy their own applications quickly
and easily, such as Dapp, DeFi, DAO, Cross-Blockchain transactions, etc.

## Operational Role

For a systems engineer, IBAX-io/go-ibax belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-05T01:23:24Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:assets stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_assets-7fde97bcd662bd` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adrische/quant-jobs-zurich | Filesystem Os | [open](assets-adrische-quant-jobs-zurich-97eab795.md) |
| alexmyczko/fnt | Filesystem Os | [open](assets-alexmyczko-fnt-c8afcb60.md) |
| Anmol-Baranwal/Awesome-Illustrations-4Projects | Filesystem Os | [open](assets-anmol-baranwal-awesome-illustrations-4projects-38c87dd7.md) |
| brunomikoski/ScriptableObjectCollection | Filesystem Os | [open](assets-brunomikoski-scriptableobjectcollection-2d789cfa.md) |
| caosdoar/Fornos | Filesystem Os | [open](assets-caosdoar-fornos-dc7540bd.md) |
| cormullion/juliamono | Filesystem Os | [open](assets-cormullion-juliamono-bec7c369.md) |
| creosB/Game-Asset-Auto-Redeemer | Filesystem Os | [open](assets-creosb-game-asset-auto-redeemer-74c8f79f.md) |
| didiatworkz/screenly-ose-monitoring | Filesystem Os | [open](assets-didiatworkz-screenly-ose-monitoring-f088cdd0.md) |
