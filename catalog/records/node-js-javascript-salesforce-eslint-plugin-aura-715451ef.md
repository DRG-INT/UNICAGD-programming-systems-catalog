...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Linter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/linter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@salesforce/eslint-plugin-aura](https://www.npmjs.com/package/@salesforce/eslint-plugin-aura) |
| Source record ids | npm_registry-d80b0ecc87a9b5 |

## System Engineer Summary

@salesforce/eslint-plugin-aura is tracked as a linter record in the Node.js/JavaScript branch. The
...
For a systems engineer, @salesforce/eslint-plugin-aura belongs in the Node.js/JavaScript inventory
as part of static feedback, style policy, defect prevention, and local/CI quality gates.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-05-09T18:56:32.218Z | [https://registry.npmjs.org/-/v1/search?text=eslint&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=eslint&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=eslint&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T02:12:58+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| @angular-eslint/eslint-plugin | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-eslint-plugin-eac8712f.md) |
| @angular-eslint/schematics | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-schematics-a7992b2f.md) |
| @angular-eslint/utils | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-utils-4029044f.md) |
| @antfu/eslint-config | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-antfu-eslint-config-acdc37fc.md) |
| @babel/eslint-parser | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-babel-eslint-parser-46e9d469.md) |
| @babel/eslint-plugin | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-babel-eslint-plugin-dd8364f5.md) |
| @backstage/cli-module-lint | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-backstage-cli-module-lint-334bd0fc.md) |
| @backstage/eslint-plugin | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-backstage-eslint-plugin-1393138f.md) |
