...
<!-- canonical: https://pub.dev/packages/native_device_orientation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/native_device_orientation](https://pub.dev/packages/native_device_orientation) |
| Source record ids | pub_dev-d7b527d51f36ad |
...
For a systems engineer, native_device_orientation belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2026-09-06T21:06:14.200391Z | [https://pub.dev/api/packages/native_device_orientation](https://pub.dev/api/packages/native_device_orientation) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/native_device_orientation` at `2026-09-06T22:18:53+00:00`.
...
- `pub_dev-d7b527d51f36ad` from `pub_dev` as `registry_expansion`
