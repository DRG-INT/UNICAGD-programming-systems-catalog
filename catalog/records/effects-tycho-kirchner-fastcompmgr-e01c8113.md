...
<!-- canonical: https://github.com/tycho-kirchner/fastcompmgr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tycho-kirchner/fastcompmgr](https://github.com/tycho-kirchner/fastcompmgr) |
| Source record ids | github_search_effects-b094f57f0b15ca |
...
For a systems engineer, tycho-kirchner/fastcompmgr belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T21:47:26Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b094f57f0b15ca` from `github_search_effects` as `registry_expansion`
