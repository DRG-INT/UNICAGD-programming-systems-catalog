...
<!-- canonical: https://docs.gitea.com/usage/actions/overview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.gitea.com/usage/actions/overview](https://docs.gitea.com/usage/actions/overview) |
| Source record ids | curated_repository_workplace_routes-15033e3f9acdb2 |

## System Engineer Summary

Gitea integrated CI/CD workflow engine compatible with common action-style automation patterns.

## Operational Role

For a systems engineer, Gitea Actions belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-15033e3f9acdb2` from `curated_repository_workplace_routes` as `registry_expansion`
