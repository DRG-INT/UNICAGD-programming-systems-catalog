...
<!-- canonical: https://gitea.com/avevlad/act -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/avevlad/act](https://gitea.com/avevlad/act) |
| Source record ids | gitea_repositories_api-f67693e30cd14f |
...
For a systems engineer, Gitea: avevlad/act belongs in the Repository Workplaces inventory as part of
...
- `gitea_repositories_api-f67693e30cd14f` from `gitea_repositories_api` as `registry_expansion`
