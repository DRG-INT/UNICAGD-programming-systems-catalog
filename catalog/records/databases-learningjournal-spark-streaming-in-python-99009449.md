...
<!-- canonical: https://github.com/LearningJournal/Spark-Streaming-In-Python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LearningJournal/Spark-Streaming-In-Python](https://github.com/LearningJournal/Spark-Streaming-In-Python) |
| Source record ids | github_search_databases-72264ce49dca7a |
...
For a systems engineer, LearningJournal/Spark-Streaming-In-Python belongs in the Databases inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-19T11:44:44Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-72264ce49dca7a` from `github_search_databases` as `registry_expansion`
