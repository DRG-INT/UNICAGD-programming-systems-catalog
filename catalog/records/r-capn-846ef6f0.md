...
<!-- canonical: https://cran.r-project.org/web/packages/capn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/capn/index.html](https://cran.r-project.org/web/packages/capn/index.html) |
| Source record ids | cran_packages_by_date-90bed298001ec5 |
...
For a systems engineer, capn belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-22 15:10:46 UTC | [https://cran.r-project.org/web/packages/capn/DESCRIPTION](https://cran.r-project.org/web/packages/capn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/capn/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-90bed298001ec5` from `cran_packages_by_date` as `registry_expansion`
