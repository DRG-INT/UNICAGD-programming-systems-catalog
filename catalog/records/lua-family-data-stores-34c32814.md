...
| Source record ids | lua-source-36 |

## System Engineer Summary

Data Stores is tracked as an other record in the Lua family branch. The source did not provide a
...
For a systems engineer, Data Stores belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 36}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-36` from `master_json` as `source_list_item`
