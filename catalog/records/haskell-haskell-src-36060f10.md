...
<!-- canonical: https://hackage.haskell.org/package/haskell-src -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/haskell-src](https://hackage.haskell.org/package/haskell-src) |
| Source record ids | hackage_top_downloads-1996f8efc142ed |
...
For a systems engineer, haskell-src belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4.2 | 2025-08-29T05:59:52Z | [https://hackage.haskell.org/package/haskell-src](https://hackage.haskell.org/package/haskell-src) |  |
| candidate | partial | 1.0.2.0 |  | [https://hackage.haskell.org/package/haskell-src](https://hackage.haskell.org/package/haskell-src) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haskell-src` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-1996f8efc142ed` from `hackage_top_downloads` as `registry_expansion`
