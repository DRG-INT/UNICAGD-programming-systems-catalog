...
<!-- canonical: https://github.com/doocs/leetcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doocs/leetcode](https://github.com/doocs/leetcode) |
| Source record ids | github_search_go-c60b2b955e81de |

## System Engineer Summary

🔥LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6
版）》题解

## Operational Role

For a systems engineer, doocs/leetcode belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T11:04:06Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-c60b2b955e81de` from `github_search_go` as `registry_expansion`
