...
| Canonical URL | [https://packagist.org/packages/ergebnis/json-normalizer](https://packagist.org/packages/ergebnis/json-normalizer) |
| Source record ids | packagist_search-be4a266f92c688 |
...
For a systems engineer, ergebnis/json-normalizer belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.10.1 | 2025-09-06T09:18:29+00:00 | [https://repo.packagist.org/p2/ergebnis/json-normalizer.json](https://repo.packagist.org/p2/ergebnis/json-normalizer.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ergebnis/json-normalizer.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-be4a266f92c688` from `packagist_search` as `registry_expansion`
