...
<!-- canonical: https://github.com/boilingdata/boilstream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/boilingdata/boilstream](https://github.com/boilingdata/boilstream) |
| Source record ids | github_search_databases-3bfe7c71e8eb67 |

## System Engineer Summary

Rust based DuckDB Server with 1st class Postgres interface for BI Tools like Power BI and Tableau.
Streaming interfaces like Web, Kafka, and FlightSQL/RPC.

## Operational Role

For a systems engineer, boilingdata/boilstream belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T11:38:01Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3bfe7c71e8eb67` from `github_search_databases` as `registry_expansion`
