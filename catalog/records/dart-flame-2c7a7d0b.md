...
<!-- canonical: https://pub.dev/packages/flame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flame](https://pub.dev/packages/flame) |
| Source record ids | pub_dev-a2a65808ae3588 |

## System Engineer Summary

A minimalist Flutter game engine, provides a nice set of somewhat independent modules you can choose
from.

## Operational Role

For a systems engineer, flame belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.38.2 | 2026-08-27T14:42:32.485514Z | [https://pub.dev/api/packages/flame](https://pub.dev/api/packages/flame) |  |
| preview | known | 1.1.0-releasecandidate.6 | 2022-03-22T13:39:26.166640Z | [https://pub.dev/api/packages/flame](https://pub.dev/api/packages/flame) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flame` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-a2a65808ae3588` from `pub_dev` as `registry_expansion`
