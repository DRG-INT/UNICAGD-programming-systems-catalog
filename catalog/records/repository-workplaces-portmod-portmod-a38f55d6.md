...
<!-- canonical: https://gitlab.com/portmod/portmod -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/portmod/portmod](https://gitlab.com/portmod/portmod) |
| Source record ids | gitlab_projects_api-648b80bb78cc21 |

## System Engineer Summary

A cross-platform CLI package manager for mods.

## Operational Role

For a systems engineer, portmod/portmod belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-648b80bb78cc21` from `gitlab_projects_api` as `registry_expansion`
