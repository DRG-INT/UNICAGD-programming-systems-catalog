...
<!-- canonical: https://github.com/gin-gonic/gin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gin-gonic/gin](https://github.com/gin-gonic/gin) |
| Source record ids | github_search_go-9d6480ab02caeb |

## System Engineer Summary

Gin is a high-performance HTTP web framework written in Go. It provides a Martini-like API but with
significantly better performance—up to 40 times faster—thanks to httprouter. Gin is designed for
building REST APIs, web applications, and microservices.

## Operational Role

For a systems engineer, gin-gonic/gin belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T05:44:19Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_go-9d6480ab02caeb` from `github_search_go` as `registry_expansion`
