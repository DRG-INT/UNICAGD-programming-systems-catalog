...
<!-- canonical: https://cran.r-project.org/web/packages/PoultryEconR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PoultryEconR/index.html](https://cran.r-project.org/web/packages/PoultryEconR/index.html) |
| Source record ids | cran_packages_by_date-68ac49c0d17567 |

## System Engineer Summary

Poultry Economic Analysis Tools

## Operational Role

For a systems engineer, PoultryEconR belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 21:40:02 UTC | [https://cran.r-project.org/web/packages/PoultryEconR/DESCRIPTION](https://cran.r-project.org/web/packages/PoultryEconR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PoultryEconR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-68ac49c0d17567` from `cran_packages_by_date` as `registry_expansion`
