...
<!-- canonical: https://crates.io/crates/wyz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wyz](https://crates.io/crates/wyz) |
| Source record ids | crates_io-76fc3a4c2d4ed8 |
...
For a systems engineer, wyz belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2022-11-16T04:54:37.181940Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-76fc3a4c2d4ed8` from `crates_io` as `registry_expansion`
