...
<!-- canonical: https://cran.r-project.org/web/packages/expm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/expm/index.html](https://cran.r-project.org/web/packages/expm/index.html) |
| Source record ids | cran_packages_by_date-218734f0002cf8 |
...
For a systems engineer, expm belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-1 | 2026-08-23 04:40:02 UTC | [https://cran.r-project.org/web/packages/expm/DESCRIPTION](https://cran.r-project.org/web/packages/expm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/expm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-218734f0002cf8` from `cran_packages_by_date` as `registry_expansion`
