...
<!-- canonical: https://crates.io/crates/serial_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serial_test](https://crates.io/crates/serial_test) |
| Source record ids | crates_io-09a38507557f17 |
...
For a systems engineer, serial_test belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-07-25T20:27:56.054089Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-09a38507557f17` from `crates_io` as `registry_expansion`
