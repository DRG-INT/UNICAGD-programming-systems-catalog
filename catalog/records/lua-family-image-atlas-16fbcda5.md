...
| Canonical URL | [https://luarocks.org/modules/leaf-node/image-atlas](https://luarocks.org/modules/leaf-node/image-atlas) |
| Source record ids | luarocks_root_manifest-e0594893ccdd0b |

## System Engineer Summary

Read image atlases for Lua and Teal

## Operational Role

For a systems engineer, image-atlas belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e0594893ccdd0b` from `luarocks_root_manifest` as `registry_expansion`
