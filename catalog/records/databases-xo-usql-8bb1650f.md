...
<!-- canonical: https://github.com/xo/usql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xo/usql](https://github.com/xo/usql) |
| Source record ids | github_search_databases-3ab207b507c752 |
...
For a systems engineer, xo/usql belongs in the Databases inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-19T14:42:20Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3ab207b507c752` from `github_search_databases` as `registry_expansion`
