...
<!-- canonical: https://pypi.org/project/5gasp-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/5gasp-cli/](https://pypi.org/project/5gasp-cli/) |
| Source record ids | pypi_simple-bbd860bd0aab4f |

## System Engineer Summary

5GASP CLI to create testing descriptors.

## Operational Role

For a systems engineer, 5gasp-cli belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2023-05-18T17:00:14.723463Z | [https://pypi.org/pypi/5gasp-cli/json](https://pypi.org/pypi/5gasp-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/5gasp-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-bbd860bd0aab4f` from `pypi_simple` as `registry_expansion`
