...
<!-- canonical: https://cran.r-project.org/web/packages/mvrsquared/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mvrsquared/index.html](https://cran.r-project.org/web/packages/mvrsquared/index.html) |
| Source record ids | cran_packages_by_date-326b2c4a945e2e |
...
For a systems engineer, mvrsquared belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-31 22:20:08 UTC | [https://cran.r-project.org/web/packages/mvrsquared/DESCRIPTION](https://cran.r-project.org/web/packages/mvrsquared/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mvrsquared/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-326b2c4a945e2e` from `cran_packages_by_date` as `registry_expansion`
...
| MazamaRollUtils | Ffi Bindings | [open](r-mazamarollutils-30bfe534.md) |
| obr | Ffi Bindings | [open](r-obr-f807cecb.md) |
| qol | Ffi Bindings | [open](r-qol-8fc0d82a.md) |
