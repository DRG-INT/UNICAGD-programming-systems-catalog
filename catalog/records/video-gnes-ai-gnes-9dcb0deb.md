...
<!-- canonical: https://github.com/gnes-ai/gnes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gnes-ai/gnes](https://github.com/gnes-ai/gnes) |
| Source record ids | github_search_video-852da74e108a45 |

## System Engineer Summary

GNES is Generic Neural Elastic Search, a cloud-native semantic search system based on deep neural
network.

## Operational Role

For a systems engineer, gnes-ai/gnes belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-31T11:36:15Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-852da74e108a45` from `github_search_video` as `registry_expansion`
