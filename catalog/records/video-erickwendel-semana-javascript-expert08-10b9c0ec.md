...
<!-- canonical: https://github.com/ErickWendel/semana-javascript-expert08 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ErickWendel/semana-javascript-expert08](https://github.com/ErickWendel/semana-javascript-expert08) |
| Source record ids | github_search_video-d8e7f84f75ff90 |
...
For a systems engineer, ErickWendel/semana-javascript-expert08 belongs in the Video inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-07T14:32:57Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d8e7f84f75ff90` from `github_search_video` as `registry_expansion`
