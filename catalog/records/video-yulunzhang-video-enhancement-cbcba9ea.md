...
<!-- canonical: https://github.com/yulunzhang/video-enhancement -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yulunzhang/video-enhancement](https://github.com/yulunzhang/video-enhancement) |
| Source record ids | github_search_video-faf853537b4896 |

## System Engineer Summary

A list of resources for video enhancement, including video super-resolutio, interpolation,
denoising, compression artifact removal et al..

## Operational Role

For a systems engineer, yulunzhang/video-enhancement belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-22T19:54:01Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-faf853537b4896` from `github_search_video` as `registry_expansion`
