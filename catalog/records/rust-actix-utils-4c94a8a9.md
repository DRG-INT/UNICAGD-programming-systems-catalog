...
<!-- canonical: https://crates.io/crates/actix-utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-utils](https://crates.io/crates/actix-utils) |
| Source record ids | crates_io-17bda9abf856b7 |
...
For a systems engineer, actix-utils belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-09-15T07:35:29.537726Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-15T08:23:08+00:00`.
...
- `crates_io-17bda9abf856b7` from `crates_io` as `registry_expansion`
