...
<!-- canonical: https://cran.r-project.org/web/packages/bbssr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bbssr/index.html](https://cran.r-project.org/web/packages/bbssr/index.html) |
| Source record ids | cran_packages_by_date-963687da30a1ad |
...
For a systems engineer, bbssr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-20 11:02:11 UTC | [https://cran.r-project.org/web/packages/bbssr/DESCRIPTION](https://cran.r-project.org/web/packages/bbssr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bbssr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-963687da30a1ad` from `cran_packages_by_date` as `registry_expansion`
