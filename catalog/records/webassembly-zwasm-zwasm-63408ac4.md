...
<!-- canonical: https://github.com/zwasm/zwasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zwasm/zwasm](https://github.com/zwasm/zwasm) |
| Source record ids | github_search_webassembly-a5f7966115355e |
...
For a systems engineer, zwasm/zwasm belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T13:20:05Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a5f7966115355e` from `github_search_webassembly` as `registry_expansion`
