...
| Canonical URL | [https://crates.io/crates/tauri-utils](https://crates.io/crates/tauri-utils) |
| Source record ids | crates_io-ed63182d096fd5 |

## System Engineer Summary

tauri-utils is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, tauri-utils belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.3 | 2026-06-17T13:41:56.300179Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-ed63182d096fd5` from `crates_io` as `registry_expansion`
