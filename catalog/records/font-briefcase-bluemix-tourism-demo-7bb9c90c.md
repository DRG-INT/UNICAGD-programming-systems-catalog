...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bluemix/Tourism-Demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bluemix/Tourism-Demo](https://github.com/bluemix/Tourism-Demo) |
| Source record ids | github_search_font_briefcase-a9bdc7b0a4f902 |

## System Engineer Summary

Flutter app backed by Redux, shows animations, internationalization (i18n), ClipPath, fonts and
others...

## Operational Role

For a systems engineer, bluemix/Tourism-Demo belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-10-25T17:59:13Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_font_briefcase-a9bdc7b0a4f902` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Cr1ator/FontMuse | Cli | [open](font-briefcase-cr1ator-fontmuse-4f98baf1.md) |
| danilo-znamerovszkij/draw-your-font | Cli | [open](font-briefcase-danilo-znamerovszkij-draw-your-font-80b1695b.md) |
| pixel-point/fontpie | Cli | [open](font-briefcase-pixel-point-fontpie-f3eba26d.md) |
