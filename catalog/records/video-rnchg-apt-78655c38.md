...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rnchg/APT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rnchg/APT](https://github.com/rnchg/APT) |
| Source record ids | github_search_video-44ff4c9acab7b0 |

## System Engineer Summary

AI Productivity Tool - Free and open source, improve user productivity, and protect privacy and data
security. Including but not limited to: built-in local exclusive ChatGPT, DeepSeek, Phi, Qwen and
other models, one-click batch intelligent processing of pictures, videos, audio, etc.

## Operational Role

For a systems engineer, rnchg/APT belongs in the Video inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-13T15:06:37Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-44ff4c9acab7b0` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kamailio/kamailio | Security Sast | [open](video-kamailio-kamailio-c8f3ab23.md) |
| security-union/videocall-rs | Security Sast | [open](video-security-union-videocall-rs-47ac3040.md) |
