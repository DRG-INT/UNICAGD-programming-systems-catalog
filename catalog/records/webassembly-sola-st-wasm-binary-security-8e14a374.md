...
<!-- canonical: https://github.com/sola-st/wasm-binary-security -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sola-st/wasm-binary-security](https://github.com/sola-st/wasm-binary-security) |
| Source record ids | github_search_webassembly-7d71326dcfc356 |

## System Engineer Summary

sola-st/wasm-binary-security is tracked as a language specification record in the WebAssembly
...
For a systems engineer, sola-st/wasm-binary-security belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-13T10:34:25Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-7d71326dcfc356` from `github_search_webassembly` as `registry_expansion`
