...
<!-- canonical: https://cran.r-project.org/web/packages/rjd3qr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rjd3qr/index.html](https://cran.r-project.org/web/packages/rjd3qr/index.html) |
| Source record ids | cran_packages_by_date-811772b0f11935 |

## System Engineer Summary

'JDemetra+' Quality Report Generator

## Operational Role

For a systems engineer, rjd3qr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-08-07 15:40:02 UTC | [https://cran.r-project.org/web/packages/rjd3qr/DESCRIPTION](https://cran.r-project.org/web/packages/rjd3qr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rjd3qr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-811772b0f11935` from `cran_packages_by_date` as `registry_expansion`
