...
<!-- canonical: https://hackage.haskell.org/package/log-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/log-postgres](https://hackage.haskell.org/package/log-postgres) |
| Source record ids | hackage_top_downloads-00c111b163d635 |
...
For a systems engineer, log-postgres belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.1 | 2023-03-14T18:42:10Z | [https://hackage.haskell.org/package/log-postgres](https://hackage.haskell.org/package/log-postgres) |  |
| candidate | partial | 0.7.0.2 |  | [https://hackage.haskell.org/package/log-postgres](https://hackage.haskell.org/package/log-postgres) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/log-postgres` at `2026-09-08T00:34:45+00:00`.
...
- `hackage_top_downloads-00c111b163d635` from `hackage_top_downloads` as `registry_expansion`
