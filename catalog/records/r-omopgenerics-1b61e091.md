...
<!-- canonical: https://cran.r-project.org/web/packages/omopgenerics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/omopgenerics/index.html](https://cran.r-project.org/web/packages/omopgenerics/index.html) |
| Source record ids | cran_packages_by_date-cf7d9b4f4a605c |
...
For a systems engineer, omopgenerics belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2026-09-08 05:20:13 UTC | [https://cran.r-project.org/web/packages/omopgenerics/DESCRIPTION](https://cran.r-project.org/web/packages/omopgenerics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/omopgenerics/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-cf7d9b4f4a605c` from `cran_packages_by_date` as `registry_expansion`
