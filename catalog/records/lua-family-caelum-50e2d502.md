...
<!-- canonical: https://luarocks.org/modules/inluiz/caelum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/inluiz/caelum](https://luarocks.org/modules/inluiz/caelum) |
| Source record ids | luarocks_root_manifest-78c529e8c5eb8a |

## System Engineer Summary

Caelum adds Classes, Structs, Enums, Complex-Data-Structures, validators, type-checking system, and
a easy to use reflection system

## Operational Role

For a systems engineer, Caelum belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-78c529e8c5eb8a` from `luarocks_root_manifest` as `registry_expansion`
