...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/nasa/vira](https://github.com/nasa/vira) |
| Source record ids | github_search_space_engines-05dd7c287636c8 |

## System Engineer Summary

Vira is a rendering and ray tracing library for space exploration and mission design purposes.

## Operational Role

For a systems engineer, nasa/vira belongs in the Space Engines inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.8.4 | 2025-11-24T18:49:25Z | [https://api.github.com/repos/nasa/vira/releases/latest](https://api.github.com/repos/nasa/vira/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nasa/vira/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-05dd7c287636c8` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| open-space-collective/open-space-toolkit-astrodynamics | Profiler | [open](space-engines-open-space-collective-open-space-toolkit-astrodynamics-f31e8cec.md) |
