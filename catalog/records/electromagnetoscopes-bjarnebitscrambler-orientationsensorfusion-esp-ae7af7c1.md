...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/BjarneBitscrambler/OrientationSensorFusion-ESP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BjarneBitscrambler/OrientationSensorFusion-ESP](https://github.com/BjarneBitscrambler/OrientationSensorFusion-ESP) |
| Source record ids | github_search_electromagnetoscopes-7a8fe4673eb082 |

## System Engineer Summary

Files for performing orientation sensor fusion using NXP version 7 algorithm, ported to Espressif
platforms.

## Operational Role

For a systems engineer, BjarneBitscrambler/OrientationSensorFusion-ESP belongs in the
Electromagnetoscopes inventory as part of device constraints, cross-compilation, driver behavior,
and field upgrades.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-03T06:04:11Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-7a8fe4673eb082` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| brian09088/NB-IoT-support-for-NTN | Embedded Hardware | [open](electromagnetoscopes-brian09088-nb-iot-support-for-ntn-2bc70179.md) |
| FARLY7/si7210-driver | Embedded Hardware | [open](electromagnetoscopes-farly7-si7210-driver-fb1603bb.md) |
| fulldecent/system-bus-radio | Embedded Hardware | [open](electromagnetoscopes-fulldecent-system-bus-radio-4aafaaaf.md) |
| jremington/LSM9DS1-AHRS | Embedded Hardware | [open](electromagnetoscopes-jremington-lsm9ds1-ahrs-8887a17e.md) |
| open-sdr/openwifi-hw | Embedded Hardware | [open](electromagnetoscopes-open-sdr-openwifi-hw-23742265.md) |
| react-native-sensors/react-native-sensors | Embedded Hardware | [open](electromagnetoscopes-react-native-sensors-react-native-sensors-af79e7ca.md) |
| rtl-sdr | Embedded Hardware | [open](electromagnetoscopes-rtl-sdr-7229b2c8.md) |
| the-risk-taker/matlab-magnetometer-hard-and-soft-iron-compensation-algorithm | Embedded Hardware | [open](electromagnetoscopes-the-risk-taker-matlab-magnetometer-hard-and-soft-iron-compensation-algorithm-0046e691.md) |
