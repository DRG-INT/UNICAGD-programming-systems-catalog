...
<!-- canonical: https://github.com/svpcom/wfb-ng -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/svpcom/wfb-ng](https://github.com/svpcom/wfb-ng) |
| Source record ids | github_search_photography-d48052be3c193d |
...
For a systems engineer, svpcom/wfb-ng belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T14:22:39Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-d48052be3c193d` from `github_search_photography` as `registry_expansion`
