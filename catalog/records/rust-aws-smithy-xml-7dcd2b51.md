...
<!-- canonical: https://crates.io/crates/aws-smithy-xml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-smithy-xml](https://crates.io/crates/aws-smithy-xml) |
| Source record ids | crates_io-d3645493efebad |
...
For a systems engineer, aws-smithy-xml belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.62.0 | 2026-07-14T17:39:32.220040Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-d3645493efebad` from `crates_io` as `registry_expansion`
