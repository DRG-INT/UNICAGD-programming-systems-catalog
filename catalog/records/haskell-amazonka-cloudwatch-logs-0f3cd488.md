...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/amazonka-cloudwatch-logs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-cloudwatch-logs](https://hackage.haskell.org/package/amazonka-cloudwatch-logs) |
| Source record ids | hackage_top_downloads-990d0b9553340d |
...
For a systems engineer, amazonka-cloudwatch-logs belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:07:43Z | [https://hackage.haskell.org/package/amazonka-cloudwatch-logs](https://hackage.haskell.org/package/amazonka-cloudwatch-logs) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-cloudwatch-logs` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-990d0b9553340d` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BlogLiterately | Logging Observability | [open](haskell-blogliterately-a6e8e65e.md) |
| casr-logbook | Logging Observability | [open](haskell-casr-logbook-9fe3c9ac.md) |
| co-log | Logging Observability | [open](haskell-co-log-55f5df31.md) |
| co-log-core | Logging Observability | [open](haskell-co-log-core-a63fd83a.md) |
| hslogger | Logging Observability | [open](haskell-hslogger-134b1e63.md) |
| hyperloglog | Logging Observability | [open](haskell-hyperloglog-056eb282.md) |
| log-domain | Logging Observability | [open](haskell-log-domain-0b40df0a.md) |
| log-warper | Logging Observability | [open](haskell-log-warper-e0ca6ea7.md) |
