...
<!-- canonical: https://github.com/upper/db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/upper/db](https://github.com/upper/db) |
| Source record ids | github_search_databases-bae78ed88b4131 |

## System Engineer Summary

Data Access Layer (DAL) for PostgreSQL, CockroachDB, MySQL, SQLite and MongoDB with ORM-like
features.

## Operational Role

For a systems engineer, upper/db belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-06T13:39:47Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-bae78ed88b4131` from `github_search_databases` as `registry_expansion`
