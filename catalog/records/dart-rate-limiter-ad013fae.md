...
<!-- canonical: https://pub.dev/packages/rate_limiter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/rate_limiter](https://pub.dev/packages/rate_limiter) |
| Source record ids | pub_dev-69171d5c265e4c |
...
For a systems engineer, rate_limiter belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-14T13:08:09.683382Z | [https://pub.dev/api/packages/rate_limiter](https://pub.dev/api/packages/rate_limiter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/rate_limiter` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-69171d5c265e4c` from `pub_dev` as `registry_expansion`
