...
<!-- canonical: https://cran.r-project.org/web/packages/icebergr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/icebergr/index.html](https://cran.r-project.org/web/packages/icebergr/index.html) |
| Source record ids | cran_packages_by_date-0e034392191751 |
...
For a systems engineer, icebergr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 15:30:16 UTC | [https://cran.r-project.org/web/packages/icebergr/DESCRIPTION](https://cran.r-project.org/web/packages/icebergr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/icebergr/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-0e034392191751` from `cran_packages_by_date` as `registry_expansion`
