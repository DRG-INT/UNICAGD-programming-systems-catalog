...
<!-- canonical: https://github.com/uthylearncode/Radio-world -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uthylearncode/Radio-world](https://github.com/uthylearncode/Radio-world) |
| Source record ids | github_search_radio_garden_speciality-91e80cc5a857c9 |

## System Engineer Summary

A Progressive Web Application (PWA) radio garden with worldwide radio stations, featuring 3D
Neumorphism style & HUD, data visualization with three.js, framer & Gsap.

## Operational Role

For a systems engineer, uthylearncode/Radio-world belongs in the Radio Garden Speciality inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-18T04:55:01Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-91e80cc5a857c9` from `github_search_radio_garden_speciality` as `registry_expansion`
