...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tumic0/QtPBFImagePlugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tumic0/QtPBFImagePlugin](https://github.com/tumic0/QtPBFImagePlugin) |
| Source record ids | github_search_maps-76e68d8ba87d74 |
...
For a systems engineer, tumic0/QtPBFImagePlugin belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-27T05:08:04Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-76e68d8ba87d74` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| flopp/go-staticmaps | Image Audio Dsp | [open](maps-flopp-go-staticmaps-8d384bfe.md) |
| kscottz/PythonFromSpace | Image Audio Dsp | [open](maps-kscottz-pythonfromspace-1ee0124e.md) |
| nasa-gibs/worldview | Image Audio Dsp | [open](maps-nasa-gibs-worldview-895a3baa.md) |
| plant99/felicette | Image Audio Dsp | [open](maps-plant99-felicette-bd213c8f.md) |
| TomSchimansky/TkinterMapView | Image Audio Dsp | [open](maps-tomschimansky-tkintermapview-b6ce4dd7.md) |
| WebODM/WebODM | Image Audio Dsp | [open](maps-webodm-webodm-07b5e298.md) |
