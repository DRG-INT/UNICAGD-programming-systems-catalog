...
<!-- canonical: https://crates.io/crates/quanta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quanta](https://crates.io/crates/quanta) |
| Source record ids | crates_io-dcfc97a604eaf9 |
...
For a systems engineer, quanta belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.6 | 2025-06-10T13:24:11.771310Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-dcfc97a604eaf9` from `crates_io` as `registry_expansion`
