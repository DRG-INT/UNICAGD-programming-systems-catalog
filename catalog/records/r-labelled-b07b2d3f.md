...
<!-- canonical: https://cran.r-project.org/web/packages/labelled/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/labelled/index.html](https://cran.r-project.org/web/packages/labelled/index.html) |
| Source record ids | cran_packages_by_date-3e04e013df7c06 |
...
For a systems engineer, labelled belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.16.1 | 2026-08-20 14:30:07 UTC | [https://cran.r-project.org/web/packages/labelled/DESCRIPTION](https://cran.r-project.org/web/packages/labelled/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/labelled/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3e04e013df7c06` from `cran_packages_by_date` as `registry_expansion`
