...
<!-- canonical: https://cran.r-project.org/web/packages/cochranSize/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cochranSize/index.html](https://cran.r-project.org/web/packages/cochranSize/index.html) |
| Source record ids | cran_packages_by_date-00381d7199cc07 |
...
For a systems engineer, cochranSize belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:30:07 UTC | [https://cran.r-project.org/web/packages/cochranSize/DESCRIPTION](https://cran.r-project.org/web/packages/cochranSize/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cochranSize/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-00381d7199cc07` from `cran_packages_by_date` as `registry_expansion`
