...
<!-- canonical: https://github.com/grafana/k6 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grafana/k6](https://github.com/grafana/k6) |
| Source record ids | github_search_go-4927dd20d249f0 |
...
For a systems engineer, grafana/k6 belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:04:29Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-4927dd20d249f0` from `github_search_go` as `registry_expansion`
