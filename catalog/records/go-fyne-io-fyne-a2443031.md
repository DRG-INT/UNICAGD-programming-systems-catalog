...
<!-- canonical: https://github.com/fyne-io/fyne -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fyne-io/fyne](https://github.com/fyne-io/fyne) |
| Source record ids | github_search_go-54a16693234cc2 |
...
For a systems engineer, fyne-io/fyne belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:20:45Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-54a16693234cc2` from `github_search_go` as `registry_expansion`
