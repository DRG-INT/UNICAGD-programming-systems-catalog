...
<!-- canonical: https://crates.io/crates/ryu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ryu](https://crates.io/crates/ryu) |
| Source record ids | crates_io-7c40d1560d30fc |
...
For a systems engineer, ryu belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.23 | 2026-02-08T20:34:03.456199Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-7c40d1560d30fc` from `crates_io` as `registry_expansion`
