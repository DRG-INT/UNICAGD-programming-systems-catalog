...
<!-- canonical: https://github.com/fabiocaccamo/FCIPAddressGeocoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fabiocaccamo/FCIPAddressGeocoder](https://github.com/fabiocaccamo/FCIPAddressGeocoder) |
| Source record ids | github_search_maps-87459b4ad1938e |

## System Engineer Summary

:iphone: :earth_africa:  iOS geocoder for geocode device IP Address location using GeoIP service(s)
and a block-based syntax.

## Operational Role

For a systems engineer, fabiocaccamo/FCIPAddressGeocoder belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2022-04-13T15:19:38Z | [https://api.github.com/repos/fabiocaccamo/FCIPAddressGeocoder/releases/latest](https://api.github.com/repos/fabiocaccamo/FCIPAddressGeocoder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fabiocaccamo/FCIPAddressGeocoder/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-87459b4ad1938e` from `github_search_maps` as `registry_expansion`
