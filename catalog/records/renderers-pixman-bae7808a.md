...
<!-- canonical: https://www.pixman.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.pixman.org/](https://www.pixman.org/) |
| Source record ids | curated_language_routes-77bd61eabd59c7 |

## System Engineer Summary

Pixel-manipulation library used under Cairo and related raster rendering paths.

## Operational Role

For a systems engineer, Pixman belongs in the Renderers inventory as part of ecosystem capability
...
- `curated_language_routes-77bd61eabd59c7` from `curated_language_routes` as `registry_expansion`
