...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/choefele/swift-lambda-app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/choefele/swift-lambda-app](https://github.com/choefele/swift-lambda-app) |
| Source record ids | github_search_swift-1517089b3ecb80 |
...
For a systems engineer, choefele/swift-lambda-app belongs in the Swift inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-02-06T17:30:30Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-08 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:swift-server stars:>100", "retrieved": "2026-09-08", "status": "forge-cli-derived"}` |
...
- `github_search_swift-1517089b3ecb80` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alchemy-swift/alchemy | Web Framework | [open](swift-alchemy-swift-alchemy-6ca3c9b1.md) |
| apple/swift-log | Web Framework | [open](swift-apple-swift-log-9120ca11.md) |
| apple/swift-metrics | Web Framework | [open](swift-apple-swift-metrics-38873b0e.md) |
| ArtSabintsev/Guitar | Web Framework | [open](swift-artsabintsev-guitar-edf44630.md) |
| brokenhandsio/swift-webauthn | Web Framework | [open](swift-brokenhandsio-swift-webauthn-17084b06.md) |
| choefele/AlexaSkillsKit | Web Framework | [open](swift-choefele-alexaskillskit-239f89f5.md) |
| jakeheis/Shout | Web Framework | [open](swift-jakeheis-shout-67672dd3.md) |
| ReactiveX/RxSwift | Web Framework | [open](swift-reactivex-rxswift-c67a8309.md) |
