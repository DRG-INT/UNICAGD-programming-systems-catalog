# Gitea: toafubi/python-getting-started
...
<!-- canonical: https://gitea.com/toafubi/python-getting-started -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/toafubi/python-getting-started](https://gitea.com/toafubi/python-getting-started) |
| Source record ids | gitea_repositories_api-d2ead82c1fbc80 |
...
For a systems engineer, Gitea: toafubi/python-getting-started belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T21:50:08Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-d2ead82c1fbc80` from `gitea_repositories_api` as `registry_expansion`
