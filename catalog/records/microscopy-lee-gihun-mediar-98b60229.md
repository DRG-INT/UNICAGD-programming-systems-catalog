...
<!-- canonical: https://github.com/Lee-Gihun/MEDIAR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Lee-Gihun/MEDIAR](https://github.com/Lee-Gihun/MEDIAR) |
| Source record ids | github_search_microscopy-8adcbcbef0f8fa |

## System Engineer Summary

(NeurIPS 2022 CellSeg Challenge - 1st Winner) Open source code for "MEDIAR: Harmony of Data-Centric
and Model-Centric for Multi-Modality Microscopy"

## Operational Role

For a systems engineer, Lee-Gihun/MEDIAR belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-01T13:35:07Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-8adcbcbef0f8fa` from `github_search_microscopy` as `registry_expansion`
