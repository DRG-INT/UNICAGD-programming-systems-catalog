...
<!-- canonical: https://cran.r-project.org/web/packages/AHTauDesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AHTauDesign/index.html](https://cran.r-project.org/web/packages/AHTauDesign/index.html) |
| Source record ids | cran_packages_by_date-9c1a33d1d1e069 |

## System Engineer Summary

Truncation Time Selection for Average Hazard Analyses

## Operational Role

For a systems engineer, AHTauDesign belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 08:40:08 UTC | [https://cran.r-project.org/web/packages/AHTauDesign/DESCRIPTION](https://cran.r-project.org/web/packages/AHTauDesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AHTauDesign/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-9c1a33d1d1e069` from `cran_packages_by_date` as `registry_expansion`
