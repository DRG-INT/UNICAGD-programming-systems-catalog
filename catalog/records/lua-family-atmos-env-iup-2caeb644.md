...
<!-- canonical: https://luarocks.org/modules/fsantanna/atmos-env-iup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fsantanna/atmos-env-iup](https://luarocks.org/modules/fsantanna/atmos-env-iup) |
| Source record ids | luarocks_root_manifest-9d9af0a450c221 |

## System Engineer Summary

IUP environment for Atmos

## Operational Role

For a systems engineer, atmos-env-iup belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-9d9af0a450c221` from `luarocks_root_manifest` as `registry_expansion`
