...
<!-- canonical: https://github.com/WebAssembly/wasi-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-http](https://github.com/WebAssembly/wasi-http) |
| Source record ids | github_search_webassembly-f85a92d3b23fdb |

## System Engineer Summary

A collection of interfaces for sending and receiving HTTP requests and responses

## Operational Role

For a systems engineer, WebAssembly/wasi-http belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T22:56:11Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-f85a92d3b23fdb` from `github_search_webassembly` as `registry_expansion`
