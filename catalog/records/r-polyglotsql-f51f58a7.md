...
<!-- canonical: https://cran.r-project.org/web/packages/polyglotSQL/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/polyglotSQL/index.html](https://cran.r-project.org/web/packages/polyglotSQL/index.html) |
| Source record ids | cran_packages_by_date-e9e41992275970 |

## System Engineer Summary

SQL Parsing, Analysis and Dialect Translation

## Operational Role

For a systems engineer, polyglotSQL belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 16:20:07 UTC | [https://cran.r-project.org/web/packages/polyglotSQL/DESCRIPTION](https://cran.r-project.org/web/packages/polyglotSQL/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/polyglotSQL/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e9e41992275970` from `cran_packages_by_date` as `registry_expansion`
