...
<!-- canonical: https://luarocks.org/modules/michalhajek/call -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/michalhajek/call](https://luarocks.org/modules/michalhajek/call) |
| Source record ids | luarocks_root_manifest-eedf11d53efd05 |

## System Engineer Summary

call is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, call belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-eedf11d53efd05` from `luarocks_root_manifest` as `registry_expansion`
