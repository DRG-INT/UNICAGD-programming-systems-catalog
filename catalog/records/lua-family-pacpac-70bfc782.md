...
<!-- canonical: https://github.com/tylerneylon/pacpac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tylerneylon/pacpac](https://github.com/tylerneylon/pacpac) |
| Source record ids | lua-source-142 |
...
For a systems engineer, PacPac belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 142}}` |
...
- `lua-source-142` from `master_json` as `source_list_item`
