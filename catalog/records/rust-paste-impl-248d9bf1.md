...
| Canonical URL | [https://crates.io/crates/paste-impl](https://crates.io/crates/paste-impl) |
| Source record ids | crates_io-e5883a2b98d038 |
...
For a systems engineer, paste-impl belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.18 | 2020-06-21T01:15:54.327585Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-e5883a2b98d038` from `crates_io` as `registry_expansion`
