...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Build System](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/build-system.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-9207bfdf4cbd |

## System Engineer Summary

GNU Autoconf/Automake/Libtool toolchain

## Operational Role

For a systems engineer, Autotools belongs in the C99 inventory as part of build graph control,
...
- `master-9207bfdf4cbd` from `master_json` as `build_system`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bazel | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-bazel-b1b7c106.md) |
| CMake | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-cmake-9046aa8a.md) |
| Make | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-make-80a1319f.md) |
| Meson | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-meson-c58d3eb1.md) |
| Ninja | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-ninja-2469248b.md) |
| Premake | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-premake-c1769fe0.md) |
| xmake | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-xmake-5cb11ae7.md) |
