...
<!-- canonical: https://luarocks.org/modules/ambaradan/bamboo.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ambaradan/bamboo.nvim](https://luarocks.org/modules/ambaradan/bamboo.nvim) |
| Source record ids | luarocks_root_manifest-f12bb9dde2b3aa |
...
For a systems engineer, bamboo.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f12bb9dde2b3aa` from `luarocks_root_manifest` as `registry_expansion`
