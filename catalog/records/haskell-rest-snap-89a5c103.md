...
<!-- canonical: https://hackage.haskell.org/package/rest-snap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/rest-snap](https://hackage.haskell.org/package/rest-snap) |
| Source record ids | hackage_top_downloads-fac8db23943a96 |
...
For a systems engineer, rest-snap belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.0 | 2017-10-31T18:55:16Z | [https://hackage.haskell.org/package/rest-snap](https://hackage.haskell.org/package/rest-snap) |  |
| candidate | partial | 0.3.0.0 |  | [https://hackage.haskell.org/package/rest-snap](https://hackage.haskell.org/package/rest-snap) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/rest-snap` at `2026-09-02T00:32:50+00:00`.
...
- `hackage_top_downloads-fac8db23943a96` from `hackage_top_downloads` as `registry_expansion`
