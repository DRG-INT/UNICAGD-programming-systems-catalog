...
| Source record ids | curated_language_routes-1a5c670a8f3b0d |

## System Engineer Summary

3D creation suite for modeling, animation, rendering, compositing, simulation, scripting, and asset
pipelines.

## Operational Role

For a systems engineer, Blender belongs in the Computer Graphics Software inventory as part of
...
- `curated_language_routes-1a5c670a8f3b0d` from `curated_language_routes` as `registry_expansion`
