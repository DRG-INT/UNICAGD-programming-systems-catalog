...
<!-- canonical: https://www.npmjs.com/package/devicetree-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/devicetree-language-server](https://www.npmjs.com/package/devicetree-language-server) |
| Source record ids | npm_registry-4ae3402046a5a3 |
...
For a systems engineer, devicetree-language-server belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-08-30T10:01:47.503Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4ae3402046a5a3` from `npm_registry` as `registry_expansion`
