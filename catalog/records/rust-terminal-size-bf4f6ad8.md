...
<!-- canonical: https://crates.io/crates/terminal_size -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/terminal_size](https://crates.io/crates/terminal_size) |
| Source record ids | crates_io-3f38135fbae647 |
...
For a systems engineer, terminal_size belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.4 | 2026-03-23T16:39:14.510986Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-3f38135fbae647` from `crates_io` as `registry_expansion`
