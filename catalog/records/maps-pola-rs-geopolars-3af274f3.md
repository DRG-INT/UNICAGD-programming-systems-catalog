...
<!-- canonical: https://github.com/pola-rs/geopolars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pola-rs/geopolars](https://github.com/pola-rs/geopolars) |
| Source record ids | github_search_maps-b6783ad7a3e185 |
...
For a systems engineer, pola-rs/geopolars belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-10T21:37:24Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b6783ad7a3e185` from `github_search_maps` as `registry_expansion`
