...
<!-- canonical: https://github.com/igradeca/Unity-Shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/igradeca/Unity-Shaders](https://github.com/igradeca/Unity-Shaders) |
| Source record ids | github_search_effects-fff7f04d11d989 |
...
For a systems engineer, igradeca/Unity-Shaders belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-13T14:23:23Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-fff7f04d11d989` from `github_search_effects` as `registry_expansion`
