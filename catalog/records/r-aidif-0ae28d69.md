...
<!-- canonical: https://cran.r-project.org/web/packages/aiDIF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aiDIF/index.html](https://cran.r-project.org/web/packages/aiDIF/index.html) |
| Source record ids | cran_packages_by_date-767782ce06acd6 |
...
For a systems engineer, aiDIF belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-05 16:00:10 UTC | [https://cran.r-project.org/web/packages/aiDIF/DESCRIPTION](https://cran.r-project.org/web/packages/aiDIF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aiDIF/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-767782ce06acd6` from `cran_packages_by_date` as `registry_expansion`
