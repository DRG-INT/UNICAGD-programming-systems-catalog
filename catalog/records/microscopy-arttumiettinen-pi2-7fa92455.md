...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/arttumiettinen/pi2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arttumiettinen/pi2](https://github.com/arttumiettinen/pi2) |
| Source record ids | github_search_microscopy-ee1f32137fcfa3 |

## System Engineer Summary

C++ library and command-line software for processing and analysis of terabyte-scale volume images
locally or on a computing cluster.

## Operational Role

For a systems engineer, arttumiettinen/pi2 belongs in the Microscopy inventory as part of defect
discovery, security review, undefined-state detection, and regression prevention.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-25T12:23:36Z | gh search repos topic:bioimaging stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:bioimaging stars:>20", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_microscopy-ee1f32137fcfa3` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AICONSlab/MIRACL | Static Analyzer | [open](microscopy-aiconslab-miracl-cf8be60e.md) |
| bonej-org/BoneJ2 | Static Analyzer | [open](microscopy-bonej-org-bonej2-7a23494e.md) |
| clEsperanto/pyclesperanto_prototype | Static Analyzer | [open](microscopy-clesperanto-pyclesperanto-prototype-3fd5a628.md) |
| imjoy-team/imagej.js | Static Analyzer | [open](microscopy-imjoy-team-imagej-js-ab4ae7b8.md) |
| jherkenhoff/STM | Static Analyzer | [open](microscopy-jherkenhoff-stm-3928a3ac.md) |
| NIGMS/Biomedical-Imaging-Analysis-using-AI-ML-Approaches | Static Analyzer | [open](microscopy-nigms-biomedical-imaging-analysis-using-ai-ml-approaches-8ffdae01.md) |
| NL-BioImaging/biomero | Static Analyzer | [open](microscopy-nl-bioimaging-biomero-e59c8222.md) |
| ome/EMBO-Practical-Course-2023 | Static Analyzer | [open](microscopy-ome-embo-practical-course-2023-0359e30c.md) |
