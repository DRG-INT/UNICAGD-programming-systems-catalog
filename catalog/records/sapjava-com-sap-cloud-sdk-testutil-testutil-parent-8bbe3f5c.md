...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.sdk.testutil/testutil-parent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.sdk.testutil/testutil-parent](https://central.sonatype.com/artifact/com.sap.cloud.sdk.testutil/testutil-parent) |
| Source record ids | maven_central_search-649c4775f2f33d |
...
For a systems engineer, com.sap.cloud.sdk.testutil:testutil-parent belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.78.0 | 2022-12-19T12:43:30+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json) |  |
...
- `maven_central_search-649c4775f2f33d` from `maven_central_search` as `registry_expansion`
...
| pakunz/persistence-with-ejb | Testing Framework | [open](sapjava-pakunz-persistence-with-ejb-6ebcac52.md) |
