...
<!-- canonical: https://github.com/cool-japan/oxiaudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cool-japan/oxiaudio](https://github.com/cool-japan/oxiaudio) |
| Source record ids | github_search_effects-1d4e47b7dcb8da |

## System Engineer Summary

OxiAudio is Pure-Rust audio processing workspace: decode, encode, DSP effects, and spectral
analysis.

## Operational Role

For a systems engineer, cool-japan/oxiaudio belongs in the Effects inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T05:37:05Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1d4e47b7dcb8da` from `github_search_effects` as `registry_expansion`
