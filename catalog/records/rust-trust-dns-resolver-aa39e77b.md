...
<!-- canonical: https://crates.io/crates/trust-dns-resolver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/trust-dns-resolver](https://crates.io/crates/trust-dns-resolver) |
| Source record ids | crates_io-1c825a36802f7d |

## System Engineer Summary

Trust-DNS is a safe and secure DNS library. This Resolver library uses the Client library to perform
all DNS queries. The Resolver is intended to be a high-level library for any DNS record resolution
see Resolver and AsyncResolver for supported resolution types. The Client can be used for other
queries.

## Operational Role

For a systems engineer, trust-dns-resolver belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.2 | 2023-10-23T16:03:53.732289Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-1c825a36802f7d` from `crates_io` as `registry_expansion`
