...
<!-- canonical: https://crates.io/crates/slotmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/slotmap](https://crates.io/crates/slotmap) |
| Source record ids | crates_io-cc5ecfad8f0554 |

## System Engineer Summary

slotmap is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, slotmap belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-12-06T12:30:22.308199Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-cc5ecfad8f0554` from `crates_io` as `registry_expansion`
