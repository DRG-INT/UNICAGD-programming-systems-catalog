...
<!-- canonical: https://github.com/gberrante/map_3d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gberrante/map_3d](https://github.com/gberrante/map_3d) |
| Source record ids | github_search_space_engines-bddad756507348 |

## System Engineer Summary

Rust library for geographic coordinate system conversion

## Operational Role

For a systems engineer, gberrante/map_3d belongs in the Space Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T06:50:37Z | gh search repos topic:astrodynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-bddad756507348` from `github_search_space_engines` as `registry_expansion`
