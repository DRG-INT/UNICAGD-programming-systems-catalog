...
<!-- canonical: https://github.com/styx-emulator/styx-emulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/styx-emulator/styx-emulator](https://github.com/styx-emulator/styx-emulator) |
| Source record ids | github_search_effects-bd52dcbb6e5be5 |
...
For a systems engineer, styx-emulator/styx-emulator belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T20:47:32Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-bd52dcbb6e5be5` from `github_search_effects` as `registry_expansion`
