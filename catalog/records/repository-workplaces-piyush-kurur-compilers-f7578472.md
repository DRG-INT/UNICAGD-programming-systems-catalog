...
<!-- canonical: https://gitlab.com/piyush-kurur/compilers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/piyush-kurur/compilers](https://gitlab.com/piyush-kurur/compilers) |
| Source record ids | gitlab_projects_api-7e6146e4dcee58 |
...
For a systems engineer, piyush-kurur/compilers belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-06T08:37:15.222Z | [https://gitlab.com/api/v4/projects?search=compiler&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=compiler&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-07 | `{"kind": "gitlab_projects_api", "query": "compiler", "retrieved": "2026-09-07", "status": "forge-api-derived"}` |
...
- `gitlab_projects_api-7e6146e4dcee58` from `gitlab_projects_api` as `registry_expansion`
