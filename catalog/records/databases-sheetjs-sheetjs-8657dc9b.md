...
<!-- canonical: https://github.com/SheetJS/sheetjs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) |
| Source record ids | github_search_databases-24873960b9a5b3 |
...
For a systems engineer, SheetJS/sheetjs belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-18T08:06:46Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-24873960b9a5b3` from `github_search_databases` as `registry_expansion`
