...
<!-- canonical: https://gnu-octave.github.io/packages/csg-dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/csg-dataset](https://gnu-octave.github.io/packages/csg-dataset) |
| Source record ids | octave_packages_index-fe8817ae34d1eb |

## System Engineer Summary

A large dataset of diaphyseal cross sectional geometric properties and relevant measurements from
human long bones.

## Operational Role

For a systems engineer, csg-dataset belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-05-19 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-fe8817ae34d1eb` from `octave_packages_index` as `registry_expansion`
