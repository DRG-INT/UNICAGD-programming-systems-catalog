...
<!-- canonical: https://github.com/MaterializeInc/materialize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MaterializeInc/materialize](https://github.com/MaterializeInc/materialize) |
| Source record ids | github_search_databases-524a56883e6bf4 |

## System Engineer Summary

The live data layer for apps and AI agents. Create up-to-the-second views into your business, just
using SQL

## Operational Role

For a systems engineer, MaterializeInc/materialize belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T06:19:25Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-524a56883e6bf4` from `github_search_databases` as `registry_expansion`
