...
<!-- canonical: https://github.com/symerio/pgeocode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/symerio/pgeocode](https://github.com/symerio/pgeocode) |
| Source record ids | github_search_maps-a32d12b8a1dbb3 |
...
For a systems engineer, symerio/pgeocode belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.0 | 2022-12-13T23:38:50Z | [https://api.github.com/repos/symerio/pgeocode/releases/latest](https://api.github.com/repos/symerio/pgeocode/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/symerio/pgeocode/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-a32d12b8a1dbb3` from `github_search_maps` as `registry_expansion`
