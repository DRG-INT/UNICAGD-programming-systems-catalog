...
<!-- canonical: https://pypi.org/project/00-renjing-mcp-server-pypi/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/00-renjing-mcp-server-pypi/](https://pypi.org/project/00-renjing-mcp-server-pypi/) |
| Source record ids | pypi_simple-dab3f85129732b |
...
For a systems engineer, 00-renjing-mcp-server-pypi belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-05-22T08:37:17.259671Z | [https://pypi.org/pypi/00-renjing-mcp-server-pypi/json](https://pypi.org/pypi/00-renjing-mcp-server-pypi/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/00-renjing-mcp-server-pypi/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-dab3f85129732b` from `pypi_simple` as `registry_expansion`
