# Zarnya/Global-Radio-Garden

## Navigation

[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Zarnya/Global-Radio-Garden -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zarnya/Global-Radio-Garden](https://github.com/Zarnya/Global-Radio-Garden) |
| Source record ids | github_search_radio_garden_speciality-b9db693e0f9fe2 |

## System Engineer Summary

Interactive global radio web app with crowdsourced station curation, Leaflet glowing map, resilient
audio player, and persistent backend

## Operational Role

For a systems engineer, Zarnya/Global-Radio-Garden belongs in the Radio Garden Speciality inventory
as part of input-space exploration, parser hardening, and unsafe edge-case discovery.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T18:10:33Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-b9db693e0f9fe2` from `github_search_radio_garden_speciality` as `registry_expansion`
