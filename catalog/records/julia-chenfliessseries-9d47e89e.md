...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChenFliessSeries](https://github.com/JuliaRegistries/General/tree/master/C/ChenFliessSeries) |
| Source record ids | julia_general-f0f77cfa55bde9 |

## System Engineer Summary

Julia package registered in General at C/ChenFliessSeries.

## Operational Role

For a systems engineer, ChenFliessSeries belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChenFliessSeries", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f0f77cfa55bde9` from `julia_general` as `registry_expansion`
