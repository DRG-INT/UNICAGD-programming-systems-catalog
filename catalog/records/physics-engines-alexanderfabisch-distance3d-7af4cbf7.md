...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AlexanderFabisch/distance3d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlexanderFabisch/distance3d](https://github.com/AlexanderFabisch/distance3d) |
| Source record ids | github_search_physics_engines-895673d758f356 |
...
For a systems engineer, AlexanderFabisch/distance3d belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-27T13:55:59Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-895673d758f356` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| nlbucki/RapidQuadcopterCollisionDetection | Api Abi Checker | [open](physics-engines-nlbucki-rapidquadcoptercollisiondetection-f686d229.md) |
