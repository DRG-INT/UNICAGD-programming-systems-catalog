...
<!-- canonical: https://hackage.haskell.org/package/langchain-hs-graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/langchain-hs-graph](https://hackage.haskell.org/package/langchain-hs-graph) |
| Source record ids | hackage_recent-d69891506510de |
...
For a systems engineer, langchain-hs-graph belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5.0 | 2026-09-12T13:14:10Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-d69891506510de` from `hackage_recent` as `registry_expansion`
