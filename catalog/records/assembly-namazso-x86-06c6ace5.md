...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/namazso/x86 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/namazso/x86](https://github.com/namazso/x86) |
| Source record ids | github_search_assembly-4a881e7efee3dd |
...
For a systems engineer, namazso/x86 belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-20T23:14:04Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:x86 topic:assembly", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-4a881e7efee3dd` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| GregoryComer/x86-csv | Community Reference | [open](assembly-gregorycomer-x86-csv-fcf99fd6.md) |
