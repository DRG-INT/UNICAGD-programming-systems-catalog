...
<!-- canonical: https://luarocks.org/modules/akojo/clutch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/akojo/clutch](https://luarocks.org/modules/akojo/clutch) |
| Source record ids | luarocks_root_manifest-e7e5e14b585400 |
...
For a systems engineer, clutch belongs in the Lua family inventory as part of state persistence,
...
- `luarocks_root_manifest-e7e5e14b585400` from `luarocks_root_manifest` as `registry_expansion`
