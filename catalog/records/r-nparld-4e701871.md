...
<!-- canonical: https://cran.r-project.org/web/packages/nparLD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nparLD/index.html](https://cran.r-project.org/web/packages/nparLD/index.html) |
| Source record ids | cran_packages_by_date-f15ce820693878 |
...
For a systems engineer, nparLD belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-08-28 15:10:02 UTC | [https://cran.r-project.org/web/packages/nparLD/DESCRIPTION](https://cran.r-project.org/web/packages/nparLD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nparLD/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f15ce820693878` from `cran_packages_by_date` as `registry_expansion`
