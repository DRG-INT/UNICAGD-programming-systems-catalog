# perdlespedales/OrbiterIntegratedMotionController

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/perdlespedales/OrbiterIntegratedMotionController -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/perdlespedales/OrbiterIntegratedMotionController](https://github.com/perdlespedales/OrbiterIntegratedMotionController) |
| Source record ids | github_search_space_shuttles-ed2ab83711fe5c |

## System Engineer Summary

This repository collects all development artefacts produced for the Orbiter Integrated Motion
Controller Project. Artefacts include: Arduino sketches; KiCAD schematics; Android Development Kit
source code; 3D CAD drawings (CAD tool TBD). For more information about the Orbiter Space Flight
Simulator, visit:

## Operational Role

For a systems engineer, perdlespedales/OrbiterIntegratedMotionController belongs in the Space
Shuttles inventory as part of low-noise code review, style consistency, and automation-friendly
editing.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-09-04T19:24:08Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-ed2ab83711fe5c` from `github_search_space_shuttles` as `registry_expansion`
