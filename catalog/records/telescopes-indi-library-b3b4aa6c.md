...
| Canonical URL | [https://github.com/indilib/indi](https://github.com/indilib/indi) |
| Source record ids | curated_language_routes-9ead8114558b55 |

## System Engineer Summary

Distributed control protocol and driver ecosystem for astronomical instruments, telescopes, cameras,
focusers, and observatories.

## Operational Role

For a systems engineer, INDI Library belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.4.2 | 2026-08-05T10:28:06Z | [https://api.github.com/repos/indilib/indi/releases/latest](https://api.github.com/repos/indilib/indi/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/indilib/indi/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-9ead8114558b55` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ASCOM Initiative | Interop Bindings | [open](telescopes-ascom-initiative-25cfb743.md) |
