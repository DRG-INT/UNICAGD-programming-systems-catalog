...
[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/forbiddenlink/trace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/forbiddenlink/trace](https://github.com/forbiddenlink/trace) |
| Source record ids | github_search_repertoare_catalogs-006278bfacb00d |

## System Engineer Summary

Trace turns any UI screenshot into a live, editable React component. Gemini vision detection mapped
to your design-system catalog, rendered in-browser and scored for accessibility.

## Operational Role

For a systems engineer, forbiddenlink/trace belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:51:57Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-006278bfacb00d` from `github_search_repertoare_catalogs` as `registry_expansion`
