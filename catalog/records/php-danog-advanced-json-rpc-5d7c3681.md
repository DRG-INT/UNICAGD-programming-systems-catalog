...
| Canonical URL | [https://packagist.org/packages/danog/advanced-json-rpc](https://packagist.org/packages/danog/advanced-json-rpc) |
| Source record ids | packagist_search-79e4a9366098dd |
...
For a systems engineer, danog/advanced-json-rpc belongs in the PHP inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.2.3 | 2026-01-12T21:08:03+00:00 | [https://repo.packagist.org/p2/danog/advanced-json-rpc.json](https://repo.packagist.org/p2/danog/advanced-json-rpc.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/danog/advanced-json-rpc.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-79e4a9366098dd` from `packagist_search` as `registry_expansion`
