...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Newtonsoft.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Newtonsoft.Json](https://www.nuget.org/packages/Newtonsoft.Json) |
| Source record ids | nuget_search-4a32600274afe5 |
...
For a systems engineer, Newtonsoft.Json belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.0.4 | 2025-09-16T08:13:09.313+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json) |  |
| preview | known | 13.0.5-beta1 | 2025-12-30T05:27:02.473+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | ISC; MIT; https://www.nuget.org/packages/Newtonsoft.Json/13.0.4/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-4a32600274afe5` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ZiggyCreatures.FusionCache.Serialization.NewtonsoftJson | Benchmarking | [open](c-sharp-ziggycreatures-fusioncache-serialization-newtonsoftjson-44f156d3.md) |
| ZiggyCreatures.FusionCache.Serialization.SystemTextJson | Benchmarking | [open](c-sharp-ziggycreatures-fusioncache-serialization-systemtextjson-004a2a37.md) |
