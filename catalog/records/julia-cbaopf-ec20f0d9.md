...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CbaOPF](https://github.com/JuliaRegistries/General/tree/master/C/CbaOPF) |
| Source record ids | julia_general-f519774849afc5 |

## System Engineer Summary

Julia package registered in General at C/CbaOPF.

## Operational Role

For a systems engineer, CbaOPF belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CbaOPF", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f519774849afc5` from `julia_general` as `registry_expansion`
