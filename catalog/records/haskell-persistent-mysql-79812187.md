...
<!-- canonical: https://hackage.haskell.org/package/persistent-mysql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/persistent-mysql](https://hackage.haskell.org/package/persistent-mysql) |
| Source record ids | hackage_top_downloads-bdeb76bae5e8c6 |
...
For a systems engineer, persistent-mysql belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.13.1.6 | 2025-12-02T15:59:30Z | [https://hackage.haskell.org/package/persistent-mysql](https://hackage.haskell.org/package/persistent-mysql) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/persistent-mysql` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-bdeb76bae5e8c6` from `hackage_top_downloads` as `registry_expansion`
