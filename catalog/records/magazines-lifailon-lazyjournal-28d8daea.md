...
<!-- canonical: https://github.com/Lifailon/lazyjournal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Lifailon/lazyjournal](https://github.com/Lifailon/lazyjournal) |
| Source record ids | github_search_magazines-1dcef4c41139bb |

## System Engineer Summary

TUI for viewing logs from journald, auditd, file system, Docker and Podman containers, Compose
stacks and Kubernetes pods with support for log highlighting and several filtering modes.

## Operational Role

For a systems engineer, Lifailon/lazyjournal belongs in the Magazines inventory as part of defect
...
- `github_search_magazines-1dcef4c41139bb` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| emanemad-dev/ux-review-website | Static Analyzer | [open](magazines-emanemad-dev-ux-review-website-030b8c54.md) |
