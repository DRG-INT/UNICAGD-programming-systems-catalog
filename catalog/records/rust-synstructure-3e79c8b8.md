...
<!-- canonical: https://crates.io/crates/synstructure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/synstructure](https://crates.io/crates/synstructure) |
| Source record ids | crates_io-6b8abb5e37e164 |
...
For a systems engineer, synstructure belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-07-30T19:43:04.804397Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-6b8abb5e37e164` from `crates_io` as `registry_expansion`
