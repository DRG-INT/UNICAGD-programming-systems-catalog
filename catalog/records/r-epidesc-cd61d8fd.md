...
<!-- canonical: https://cran.r-project.org/web/packages/epidesc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epidesc/index.html](https://cran.r-project.org/web/packages/epidesc/index.html) |
| Source record ids | cran_packages_by_date-699defee90dc4e |

## System Engineer Summary

Calculation of Epidemiological Descriptors

## Operational Role

For a systems engineer, epidesc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 22:00:09 UTC | [https://cran.r-project.org/web/packages/epidesc/DESCRIPTION](https://cran.r-project.org/web/packages/epidesc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epidesc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-699defee90dc4e` from `cran_packages_by_date` as `registry_expansion`
