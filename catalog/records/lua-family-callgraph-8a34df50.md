...
<!-- canonical: https://luarocks.org/modules/gs/callgraph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gs/callgraph](https://luarocks.org/modules/gs/callgraph) |
| Source record ids | luarocks_root_manifest-267adf81fc3b9b |

## System Engineer Summary

Generate the call graph of a Lua program

## Operational Role

For a systems engineer, callgraph belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-267adf81fc3b9b` from `luarocks_root_manifest` as `registry_expansion`
