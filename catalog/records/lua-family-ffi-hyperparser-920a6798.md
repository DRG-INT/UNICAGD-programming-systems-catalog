...
| Canonical URL | [https://luarocks.org/modules/lalawue/ffi-hyperparser](https://luarocks.org/modules/lalawue/ffi-hyperparser) |
| Source record ids | luarocks_root_manifest-32f64c1eeac4de |

## System Engineer Summary

ffi-hyperparser is tracked as a parser lexer ast record in the Lua family branch. The source did not
...
For a systems engineer, ffi-hyperparser belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-32f64c1eeac4de` from `luarocks_root_manifest` as `registry_expansion`
