...
| Source record ids | github_search_assets-efbd5f80db4331 |
...
For a systems engineer, jenskutilek/FiraSystemFontReplacement belongs in the Assets inventory as
...
- `github_search_assets-efbd5f80db4331` from `github_search_assets` as `registry_expansion`
