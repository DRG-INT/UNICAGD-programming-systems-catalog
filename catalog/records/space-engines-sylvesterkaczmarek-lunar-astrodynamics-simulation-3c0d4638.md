# sylvesterkaczmarek/lunar-astrodynamics-simulation
...
<!-- canonical: https://github.com/sylvesterkaczmarek/lunar-astrodynamics-simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sylvesterkaczmarek/lunar-astrodynamics-simulation](https://github.com/sylvesterkaczmarek/lunar-astrodynamics-simulation) |
| Source record ids | github_search_space_engines-846f89734e5eb1 |

## System Engineer Summary

Lunar orbit propagation and preliminary mission analysis with high-fidelity gravity, perturbations,
terrain, stability, targeting and coverage.

## Operational Role

For a systems engineer, sylvesterkaczmarek/lunar-astrodynamics-simulation belongs in the Space
Engines inventory as part of defect discovery, security review, undefined-state detection, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T21:01:29Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-846f89734e5eb1` from `github_search_space_engines` as `registry_expansion`
