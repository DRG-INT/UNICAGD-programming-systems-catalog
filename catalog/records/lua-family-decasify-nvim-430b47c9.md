...
<!-- canonical: https://luarocks.org/modules/alerque/decasify.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alerque/decasify.nvim](https://luarocks.org/modules/alerque/decasify.nvim) |
| Source record ids | luarocks_root_manifest-a90858e8ed11fb |

## System Engineer Summary

NeoVIM plugin wrapping decasify crate to cast strings to title-case according to locale specific
style guides including Turkish support

## Operational Role

For a systems engineer, decasify.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a90858e8ed11fb` from `luarocks_root_manifest` as `registry_expansion`
