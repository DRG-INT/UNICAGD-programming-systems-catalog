...
<!-- canonical: https://cran.r-project.org/web/packages/normality/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/normality/index.html](https://cran.r-project.org/web/packages/normality/index.html) |
| Source record ids | cran_packages_by_date-26980acdaf704b |
...
For a systems engineer, normality belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-08-22 17:40:02 UTC | [https://cran.r-project.org/web/packages/normality/DESCRIPTION](https://cran.r-project.org/web/packages/normality/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/normality/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-26980acdaf704b` from `cran_packages_by_date` as `registry_expansion`
