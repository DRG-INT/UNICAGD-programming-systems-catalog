...
<!-- canonical: https://github.com/orneryd/NornicDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/orneryd/NornicDB](https://github.com/orneryd/NornicDB) |
| Source record ids | github_search_databases-7c30e54364a301 |

## System Engineer Summary

Nornicdb is a distributed low-latency, Graph+Vector, Temporal MVCC with all sub-ms HNSW search,
graph traversal, and writes. Using Neo4j Bolt/Cypher and qdrant's gRPC means you can switch with no
changes while adding intelligent features like schemas, managed embeddings, reranking+llm, GPU
accel, Auto-TLP, Policy-based Memory Decay, and MCP server.

## Operational Role

For a systems engineer, orneryd/NornicDB belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:17:20Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7c30e54364a301` from `github_search_databases` as `registry_expansion`
