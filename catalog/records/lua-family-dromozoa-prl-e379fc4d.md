...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-prl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-prl](https://luarocks.org/modules/moyu/dromozoa-prl) |
| Source record ids | luarocks_root_manifest-ac7b5b7e4711ac |
...
For a systems engineer, dromozoa-prl belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-ac7b5b7e4711ac` from `luarocks_root_manifest` as `registry_expansion`
