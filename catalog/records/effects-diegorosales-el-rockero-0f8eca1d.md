...
<!-- canonical: https://github.com/DiegoRosales/El_Rockero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DiegoRosales/El_Rockero](https://github.com/DiegoRosales/El_Rockero) |
| Source record ids | github_search_effects-694e0adb1419a8 |

## System Engineer Summary

Open Source Programmable Audio Effects DSP

## Operational Role

For a systems engineer, DiegoRosales/El_Rockero belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-03-26T19:49:17Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-694e0adb1419a8` from `github_search_effects` as `registry_expansion`
