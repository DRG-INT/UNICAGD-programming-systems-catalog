...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: "aim's"](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/aim-s.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-af05dcec3ef487 |

## System Engineer Summary

Model, dataset, and space registry used for discovery, versioning, hosting, inference, and
collaboration.

## Operational Role

For a systems engineer, Hugging Face Hub belongs in the "aim's" inventory as part of ecosystem
...
- `curated_language_routes-af05dcec3ef487` from `curated_language_routes` as `registry_expansion`
