...
<!-- canonical: https://gitea.com/imzbf/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/imzbf/gitea](https://gitea.com/imzbf/gitea) |
| Source record ids | gitea_repositories_api-8c8bb382ecd17e |
...
For a systems engineer, Gitea: imzbf/gitea belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-13T01:36:35Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8c8bb382ecd17e` from `gitea_repositories_api` as `registry_expansion`
