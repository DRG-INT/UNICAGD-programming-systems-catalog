...
<!-- canonical: https://github.com/typedb/bazel-distribution -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/typedb/bazel-distribution](https://github.com/typedb/bazel-distribution) |
| Source record ids | github_search_starlark-92ddcc56d39eb5 |

## System Engineer Summary

Bazel rules for assembling and deploying software distributions (see @typedb for usage example)

## Operational Role

For a systems engineer, typedb/bazel-distribution belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:54:08Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-92ddcc56d39eb5` from `github_search_starlark` as `registry_expansion`
