...
<!-- canonical: https://cran.r-project.org/web/packages/PEAXAI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PEAXAI/index.html](https://cran.r-project.org/web/packages/PEAXAI/index.html) |
| Source record ids | cran_packages_by_date-b5be8cbb11e68d |
...
For a systems engineer, PEAXAI belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-23 10:41:14 UTC | [https://cran.r-project.org/web/packages/PEAXAI/DESCRIPTION](https://cran.r-project.org/web/packages/PEAXAI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PEAXAI/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b5be8cbb11e68d` from `cran_packages_by_date` as `registry_expansion`
