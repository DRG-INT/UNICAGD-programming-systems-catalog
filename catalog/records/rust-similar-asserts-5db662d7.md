...
| Canonical URL | [https://crates.io/crates/similar-asserts](https://crates.io/crates/similar-asserts) |
| Source record ids | crates_io-2f27687700a8c0 |
...
For a systems engineer, similar-asserts belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-04-01T21:08:05.463916Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-2f27687700a8c0` from `crates_io` as `registry_expansion`
