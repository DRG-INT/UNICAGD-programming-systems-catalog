...
| Canonical URL | [https://crates.io/crates/monostate](https://crates.io/crates/monostate) |
| Source record ids | crates_io-59d62627ac0d57 |
...
For a systems engineer, monostate belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-07-18T21:40:32.713202Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-59d62627ac0d57` from `crates_io` as `registry_expansion`
