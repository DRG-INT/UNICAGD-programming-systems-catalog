...
<!-- canonical: https://pypi.org/project/aac-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aac-cli/](https://pypi.org/project/aac-cli/) |
| Source record ids | pypi_simple-1f47c30b3dcc5d |

## System Engineer Summary

The aac platform CLI — headless operator interface to the AAC control plane (tenant registration,
chain audit).

## Operational Role

For a systems engineer, aac-cli belongs in the Python inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-11T08:20:45.719378Z | [https://pypi.org/pypi/aac-cli/json](https://pypi.org/pypi/aac-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aac-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-1f47c30b3dcc5d` from `pypi_simple` as `registry_expansion`
