...
<!-- canonical: https://crates.io/crates/libm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libm](https://crates.io/crates/libm) |
| Source record ids | crates_io-8a0bd89c5efc88 |

## System Engineer Summary

libm is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, libm belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.16 | 2026-03-17T09:19:16.815251Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-8a0bd89c5efc88` from `crates_io` as `registry_expansion`
