...
<!-- canonical: https://cran.r-project.org/web/packages/rfacebookstat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rfacebookstat/index.html](https://cran.r-project.org/web/packages/rfacebookstat/index.html) |
| Source record ids | cran_packages_by_date-98069c170cf5b5 |
...
For a systems engineer, rfacebookstat belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.16.1 | 2026-08-25 11:10:02 UTC | [https://cran.r-project.org/web/packages/rfacebookstat/DESCRIPTION](https://cran.r-project.org/web/packages/rfacebookstat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rfacebookstat/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-98069c170cf5b5` from `cran_packages_by_date` as `registry_expansion`
