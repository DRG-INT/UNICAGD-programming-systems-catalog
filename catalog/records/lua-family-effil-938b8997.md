...
<!-- canonical: https://luarocks.org/modules/mihacooper/effil -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mihacooper/effil](https://luarocks.org/modules/mihacooper/effil) |
| Source record ids | luarocks_root_manifest-81bda983444030 |
...
For a systems engineer, effil belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-81bda983444030` from `luarocks_root_manifest` as `registry_expansion`
