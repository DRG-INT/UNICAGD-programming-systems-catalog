...
| Canonical URL | [https://crates.io/crates/unic-ucd-ident](https://crates.io/crates/unic-ucd-ident) |
| Source record ids | crates_io-c08fd42e0ee372 |
...
For a systems engineer, unic-ucd-ident belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2019-03-03T05:11:39.054438Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-c08fd42e0ee372` from `crates_io` as `registry_expansion`
