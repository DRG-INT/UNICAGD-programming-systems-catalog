# Michael-A-Kuykendall/auxide-dsp
...
<!-- canonical: https://github.com/Michael-A-Kuykendall/auxide-dsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Michael-A-Kuykendall/auxide-dsp](https://github.com/Michael-A-Kuykendall/auxide-dsp) |
| Source record ids | github_search_effects-bf01f78a862afd |

## System Engineer Summary

Comprehensive DSP node library for 🎤Auxide🎧 audio graphs. Includes oscillators, filters, effects,
envelopes, and modulators for real-time audio synthesis.

## Operational Role

For a systems engineer, Michael-A-Kuykendall/auxide-dsp belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T14:57:10Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-bf01f78a862afd` from `github_search_effects` as `registry_expansion`
