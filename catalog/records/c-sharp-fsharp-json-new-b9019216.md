...
<!-- canonical: https://www.nuget.org/packages/FSharp.Json.New -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/FSharp.Json.New](https://www.nuget.org/packages/FSharp.Json.New) |
| Source record ids | nuget_search-1b79e3b64da6e5 |
...
For a systems engineer, FSharp.Json.New belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2024-12-27T14:42:33.03+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/fsharp.json.new/index.json](https://api.nuget.org/v3/registration5-gz-semver2/fsharp.json.new/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/fsharp.json.new/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-1b79e3b64da6e5` from `nuget_search` as `registry_expansion`
