...
<!-- canonical: https://github.com/backlundtransform/ExoPlanetService -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/backlundtransform/ExoPlanetService](https://github.com/backlundtransform/ExoPlanetService) |
| Source record ids | github_search_space_maps-5ce62c94ad130e |

## System Engineer Summary

Exoplanet hunter single page React app for the web. Catalog where it is possible to browse all
confirmed Exoplanets. A star map of all the 88 modern constellations. 3d simulation of solar system
with habitable exoplanets. A Hertzsprung-Russell diagram the bubble chart is a plot of luminosity
against the temperature of the star for all stars that have exoplanets. Swagger Api for exoplanet
data from PHL that support Odata. Blog build with mvc .Net core

## Operational Role

For a systems engineer, backlundtransform/ExoPlanetService belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-14T15:56:01Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5ce62c94ad130e` from `github_search_space_maps` as `registry_expansion`
