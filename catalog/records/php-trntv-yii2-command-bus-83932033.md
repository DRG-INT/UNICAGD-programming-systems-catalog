...
<!-- canonical: https://packagist.org/packages/trntv/yii2-command-bus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/trntv/yii2-command-bus](https://packagist.org/packages/trntv/yii2-command-bus) |
| Source record ids | packagist_search-1311570b669d08 |
...
For a systems engineer, trntv/yii2-command-bus belongs in the PHP inventory as part of state
...
- `packagist_search-1311570b669d08` from `packagist_search` as `registry_expansion`
