...
<!-- canonical: https://github.com/RustPython/RustPython -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RustPython/RustPython](https://github.com/RustPython/RustPython) |
| Source record ids | github_search_webassembly-99c5cd17dc7247 |
...
For a systems engineer, RustPython/RustPython belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T00:54:59Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-99c5cd17dc7247` from `github_search_webassembly` as `registry_expansion`
