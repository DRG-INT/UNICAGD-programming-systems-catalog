...
<!-- canonical: https://packagist.org/packages/cmsig/seal-symfony-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/cmsig/seal-symfony-bundle](https://packagist.org/packages/cmsig/seal-symfony-bundle) |
| Source record ids | packagist_search-9db5a54bc450a8 |
...
For a systems engineer, cmsig/seal-symfony-bundle belongs in the PHP inventory as part of state
...
- `packagist_search-9db5a54bc450a8` from `packagist_search` as `registry_expansion`
