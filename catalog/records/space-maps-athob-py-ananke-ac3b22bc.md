...
<!-- canonical: https://github.com/athob/py-ananke -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/athob/py-ananke](https://github.com/athob/py-ananke) |
| Source record ids | github_search_space_maps-de9b4a94c27dac |

## System Engineer Summary

Python pipeline to generate mock astrometric and photometric catalogs of synthetic stars derived
from particle-based simulated star populations

## Operational Role

For a systems engineer, athob/py-ananke belongs in the Space Maps inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T23:30:51Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-de9b4a94c27dac` from `github_search_space_maps` as `registry_expansion`
