...
<!-- canonical: https://github.com/openstreetmap/iD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openstreetmap/iD](https://github.com/openstreetmap/iD) |
| Source record ids | github_search_maps-db1833c341e0b8 |
...
For a systems engineer, openstreetmap/iD belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:11:18Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-db1833c341e0b8` from `github_search_maps` as `registry_expansion`
