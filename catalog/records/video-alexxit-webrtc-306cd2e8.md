...
<!-- canonical: https://github.com/AlexxIT/WebRTC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlexxIT/WebRTC](https://github.com/AlexxIT/WebRTC) |
| Source record ids | github_search_video-fc16251f024222 |

## System Engineer Summary

Home Assistant custom component for real-time viewing of almost any camera stream using WebRTC and
other technologies.

## Operational Role

For a systems engineer, AlexxIT/WebRTC belongs in the Video inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-26T10:15:48Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-fc16251f024222` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| yangkun19921001/Blog | Logging Observability | [open](video-yangkun19921001-blog-8bc97048.md) |
