...
<!-- canonical: https://cran.r-project.org/web/packages/guideR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/guideR/index.html](https://cran.r-project.org/web/packages/guideR/index.html) |
| Source record ids | cran_packages_by_date-2d33e01e34a6d6 |
...
For a systems engineer, guideR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-08-20 14:10:15 UTC | [https://cran.r-project.org/web/packages/guideR/DESCRIPTION](https://cran.r-project.org/web/packages/guideR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/guideR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2d33e01e34a6d6` from `cran_packages_by_date` as `registry_expansion`
