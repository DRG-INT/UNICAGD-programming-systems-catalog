...
| Source record ids | master-9ce7267e2f15 |

## System Engineer Summary

GNU C++ standard library implementation

## Operational Role

For a systems engineer, libstdc++ belongs in the C++23 inventory as part of ecosystem capability
...
- `master-9ce7267e2f15` from `master_json` as `standard_library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| libc++ | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-libc-691c05de.md) |
