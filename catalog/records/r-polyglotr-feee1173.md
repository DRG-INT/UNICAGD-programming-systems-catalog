...
<!-- canonical: https://cran.r-project.org/web/packages/polyglotr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/polyglotr/index.html](https://cran.r-project.org/web/packages/polyglotr/index.html) |
| Source record ids | cran_packages_by_date-5caa7fad8d1af1 |

## System Engineer Summary

polyglotr is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, polyglotr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.5 | 2026-09-15 09:20:02 UTC | [https://cran.r-project.org/web/packages/polyglotr/DESCRIPTION](https://cran.r-project.org/web/packages/polyglotr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/polyglotr/DESCRIPTION` at `2026-09-15T10:20:58+00:00`.
...
- `cran_packages_by_date-5caa7fad8d1af1` from `cran_packages_by_date` as `registry_expansion`
