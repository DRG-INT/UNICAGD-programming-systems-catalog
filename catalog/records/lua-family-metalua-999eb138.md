...
<!-- canonical: https://github.com/fab13n/metalua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fab13n/metalua](https://github.com/fab13n/metalua) |
| Source record ids | lua-source-331 |

## System Engineer Summary

Pure Lua parser and compiler, used for generating ASTs. A number of other tools make use of the
Metalua parser in this way.

## Operational Role

For a systems engineer, Metalua belongs in the Lua family inventory as part of compiler selection,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 331}}` |
...
- `lua-source-331` from `master_json` as `source_list_item`
