...
<!-- canonical: https://github.com/IgrikXD/Antenna-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IgrikXD/Antenna-analyzer](https://github.com/IgrikXD/Antenna-analyzer) |
| Source record ids | github_search_electromagnetoscopes-f3be61ec91cedf |

## System Engineer Summary

Creating a public prototype of the "SWR-mouse" antenna analyzer PCB compatible with the G403 (Gainta
Industries) ready-made case.

## Operational Role

For a systems engineer, IgrikXD/Antenna-analyzer belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-15T10:24:17Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-f3be61ec91cedf` from `github_search_electromagnetoscopes` as `registry_expansion`
