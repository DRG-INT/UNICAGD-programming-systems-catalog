...
<!-- canonical: https://cran.r-project.org/web/packages/sov/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sov/index.html](https://cran.r-project.org/web/packages/sov/index.html) |
| Source record ids | cran_packages_by_date-a0fd960eff5318 |
...
For a systems engineer, sov belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-21 05:40:36 UTC | [https://cran.r-project.org/web/packages/sov/DESCRIPTION](https://cran.r-project.org/web/packages/sov/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sov/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a0fd960eff5318` from `cran_packages_by_date` as `registry_expansion`
