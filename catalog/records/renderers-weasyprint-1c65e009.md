...
[Catalog index](../index.md) · [Language: Renderers](../by-language/renderers.md) · [Category: Api Doc Generator](../by-category/api-doc-generator.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/Kozea/WeasyPrint](https://github.com/Kozea/WeasyPrint) |
| Source record ids | curated_language_routes-cba92b60915ac3 |

## System Engineer Summary

HTML and CSS to PDF renderer used for document generation and print-output pipelines.

## Operational Role

For a systems engineer, WeasyPrint belongs in the Renderers inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v69.0 | 2026-06-02T14:42:23Z | [https://api.github.com/repos/Kozea/WeasyPrint/releases/latest](https://api.github.com/repos/Kozea/WeasyPrint/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Kozea/WeasyPrint/releases/latest` at `2026-09-01T12:30:32+00:00`.
...
- `curated_language_routes-cba92b60915ac3` from `curated_language_routes` as `registry_expansion`
