...
| Canonical URL | [https://github.com/octopuscinema/raw-player](https://github.com/octopuscinema/raw-player) |
| Source record ids | github_search_photography-a5fbe128bceaf9 |
...
For a systems engineer, octopuscinema/raw-player belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.0 | 2025-03-20T19:42:41Z | [https://api.github.com/repos/octopuscinema/raw-player/releases/latest](https://api.github.com/repos/octopuscinema/raw-player/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/octopuscinema/raw-player/releases/latest` at `2026-09-01T09:23:32+00:00`.
...
- `github_search_photography-a5fbe128bceaf9` from `github_search_photography` as `registry_expansion`
