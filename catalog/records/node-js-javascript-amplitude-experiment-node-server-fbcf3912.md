...
<!-- canonical: https://www.npmjs.com/package/@amplitude/experiment-node-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@amplitude/experiment-node-server](https://www.npmjs.com/package/@amplitude/experiment-node-server) |
| Source record ids | npm_registry-182b6b03f8d1f7 |
...
For a systems engineer, @amplitude/experiment-node-server belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.6 | 2026-05-08T03:59:36.082Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-182b6b03f8d1f7` from `npm_registry` as `registry_expansion`
