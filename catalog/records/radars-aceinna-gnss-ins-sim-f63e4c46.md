...
<!-- canonical: https://github.com/Aceinna/gnss-ins-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Aceinna/gnss-ins-sim](https://github.com/Aceinna/gnss-ins-sim) |
| Source record ids | github_search_radars-23882de9c91474 |

## System Engineer Summary

Open-source GNSS + inertial navigation, sensor fusion simulator. Motion trajectory generator, sensor
models, and navigation

## Operational Role

For a systems engineer, Aceinna/gnss-ins-sim belongs in the Radars inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-27T07:06:45Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-23882de9c91474` from `github_search_radars` as `registry_expansion`
