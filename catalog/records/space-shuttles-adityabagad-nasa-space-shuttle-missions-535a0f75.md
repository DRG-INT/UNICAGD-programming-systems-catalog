# AdityaBagad/NASA-Space-Shuttle-Missions

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AdityaBagad/NASA-Space-Shuttle-Missions -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Space Shuttles |
| Category | Library |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/AdityaBagad/NASA-Space-Shuttle-Missions](https://github.com/AdityaBagad/NASA-Space-Shuttle-Missions) |
| Source record ids | github_search_space_shuttles-758d133cf76289 |
...
For a systems engineer, AdityaBagad/NASA-Space-Shuttle-Missions belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-18T09:22:16Z | gh search repos NASA space shuttle data | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "NASA space shuttle data", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_space_shuttles-758d133cf76289` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aashishaj/SpaceShuttle-Simulation | Library | [open](space-shuttles-aashishaj-spaceshuttle-simulation-d347939e.md) |
| ADSWNJ/BaseSyncMFD | Library | [open](space-shuttles-adswnj-basesyncmfd-a2293921.md) |
| ADSWNJ/LagrangeMFD | Library | [open](space-shuttles-adswnj-lagrangemfd-fca2d7b9.md) |
| ADSWNJ/ModuleMessagingExt | Library | [open](space-shuttles-adswnj-modulemessagingext-921cb829.md) |
| blue42shade/remap | Library | [open](space-shuttles-blue42shade-remap-5101e269.md) |
| chalcrow/Atlantis | Library | [open](space-shuttles-chalcrow-atlantis-14d85d6a.md) |
| dbeachy1/XRVessels | Library | [open](space-shuttles-dbeachy1-xrvessels-95a76ccd.md) |
| emgre/projectmercury | Library | [open](space-shuttles-emgre-projectmercury-4f40d27f.md) |
