...
| Canonical URL | [https://github.com/davidvarga/MBeautifier](https://github.com/davidvarga/MBeautifier) |
| Source record ids | github_search_matlab-2d28ea87f523bd |

## System Engineer Summary

MBeautifier is a MATLAB source code formatter, beautifier. It can be used directly in the MATLAB
Editor and it is configurable.

## Operational Role

For a systems engineer, davidvarga/MBeautifier belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.4.0 | 2025-04-17T09:40:43Z | [https://api.github.com/repos/davidvarga/MBeautifier/releases/latest](https://api.github.com/repos/davidvarga/MBeautifier/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/davidvarga/MBeautifier/releases/latest` at `2026-09-01T07:24:09+00:00`.
...
- `github_search_matlab-2d28ea87f523bd` from `github_search_matlab` as `registry_expansion`
