...
| Canonical URL | [https://crates.io/crates/clru](https://crates.io/crates/clru) |
| Source record ids | crates_io-ebdd08c33e48c3 |
...
For a systems engineer, clru belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2026-03-02T10:57:19.408108Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-ebdd08c33e48c3` from `crates_io` as `registry_expansion`
