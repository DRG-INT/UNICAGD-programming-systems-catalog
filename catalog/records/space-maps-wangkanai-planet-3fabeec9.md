...
<!-- canonical: https://github.com/wangkanai/planet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wangkanai/planet](https://github.com/wangkanai/planet) |
| Source record ids | github_search_space_maps-bd826ce41e7e9d |

## System Engineer Summary

Planetary distributed map service server cross-platform built with C#.NET. Lightweight and easy to
use to serve raster and vector map tiles through the browser. Also supports map service protocols
like WMTS, WMS, and XYZ Tiles.

## Operational Role

For a systems engineer, wangkanai/planet belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-14T11:00:42Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bd826ce41e7e9d` from `github_search_space_maps` as `registry_expansion`
