...
<!-- canonical: https://luarocks.org/modules/dnsrobot/dnsrobot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dnsrobot/dnsrobot](https://luarocks.org/modules/dnsrobot/dnsrobot) |
| Source record ids | luarocks_root_manifest-f26e16bc400ba4 |

## System Engineer Summary

Official Lua client for DNS Robot (dnsrobot.net) — DNS lookups, WHOIS, SSL checks, and network
tools.

## Operational Role

For a systems engineer, dnsrobot belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-f26e16bc400ba4` from `luarocks_root_manifest` as `registry_expansion`
