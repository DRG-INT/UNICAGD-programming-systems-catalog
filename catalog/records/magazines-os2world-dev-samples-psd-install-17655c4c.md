# OS2World/DEV-SAMPLES-PSD-Install
...
<!-- canonical: https://github.com/OS2World/DEV-SAMPLES-PSD-Install -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OS2World/DEV-SAMPLES-PSD-Install](https://github.com/OS2World/DEV-SAMPLES-PSD-Install) |
| Source record ids | github_search_magazines-d4a524f984fcc7 |

## System Engineer Summary

Example of a Presentation Manager Installation progmra. y John Ferris and Kerry Ortega from the
Winter 1990 issue of the IBM Personal Systems Developer magazine. (G362-0001-04)

## Operational Role

For a systems engineer, OS2World/DEV-SAMPLES-PSD-Install belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-12T02:59:20Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-d4a524f984fcc7` from `github_search_magazines` as `registry_expansion`
