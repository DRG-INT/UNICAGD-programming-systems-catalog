...
<!-- canonical: https://github.com/NewKrok/nape-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NewKrok/nape-js](https://github.com/NewKrok/nape-js) |
| Source record ids | github_search_physics_engines-d182caaef9182d |

## System Engineer Summary

A fully typed TypeScript 2D physics engine — modernized rewrite of the original Haxe engine.

## Operational Role

For a systems engineer, NewKrok/nape-js belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T22:02:54Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-d182caaef9182d` from `github_search_physics_engines` as `registry_expansion`
