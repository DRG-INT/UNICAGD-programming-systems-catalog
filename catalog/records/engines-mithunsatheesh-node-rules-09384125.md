...
<!-- canonical: https://github.com/mithunsatheesh/node-rules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mithunsatheesh/node-rules](https://github.com/mithunsatheesh/node-rules) |
| Source record ids | github_search_engines-9a6c1e71022408 |

## System Engineer Summary

Node-rules is a light weight forward chaining rule engine that can be used in JavaScript and
TypeScript based projects.

## Operational Role

For a systems engineer, mithunsatheesh/node-rules belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T23:07:06Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | CERN Open Hardware Licence Version 2 - Weakly Reciprocal; https://api.github.com/licenses/cern-ohl-w-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_engines-9a6c1e71022408` from `github_search_engines` as `registry_expansion`
...
| microsoft/RulesEngine | Lint Rule Pack | [open](engines-microsoft-rulesengine-6770ef5c.md) |
