...
<!-- canonical: https://github.com/exiftool/exiftool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/exiftool/exiftool](https://github.com/exiftool/exiftool) |
| Source record ids | github_search_photography-c23a3f9061de1c |
...
For a systems engineer, exiftool/exiftool belongs in the Photography inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T16:45:01Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c23a3f9061de1c` from `github_search_photography` as `registry_expansion`
