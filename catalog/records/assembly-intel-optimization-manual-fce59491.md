...
<!-- canonical: https://github.com/intel/optimization-manual -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/intel/optimization-manual](https://github.com/intel/optimization-manual) |
| Source record ids | github_search_assembly-29e6d02647d274 |

## System Engineer Summary

Contains the source code examples described in the "Intel® 64 and IA-32 Architectures Optimization
Reference Manual"

## Operational Role

For a systems engineer, intel/optimization-manual belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-03T22:09:10Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-29e6d02647d274` from `github_search_assembly` as `registry_expansion`
