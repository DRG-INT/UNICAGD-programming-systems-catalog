...
<!-- canonical: https://crates.io/crates/scroll_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/scroll_derive](https://crates.io/crates/scroll_derive) |
| Source record ids | crates_io-06af48948d2942 |
...
For a systems engineer, scroll_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.2 | 2026-08-30T18:05:12.476712Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-09T06:25:58+00:00`.
...
- `crates_io-06af48948d2942` from `crates_io` as `registry_expansion`
