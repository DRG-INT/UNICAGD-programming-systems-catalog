...
<!-- canonical: https://pub.dev/packages/package_info_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/package_info_plus](https://pub.dev/packages/package_info_plus) |
| Source record ids | pub_dev-0d1381496b20be |

## System Engineer Summary

Flutter plugin for querying information about the application package, such as CFBundleVersion on
iOS or versionCode on Android.

## Operational Role

For a systems engineer, package_info_plus belongs in the Dart inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.2.1 | 2026-07-15T11:32:06.321024Z | [https://pub.dev/api/packages/package_info_plus](https://pub.dev/api/packages/package_info_plus) |  |
| preview | known | 1.0.0-nullsafety.1 | 2021-02-25T17:44:20.446695Z | [https://pub.dev/api/packages/package_info_plus](https://pub.dev/api/packages/package_info_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/package_info_plus` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-0d1381496b20be` from `pub_dev` as `registry_expansion`
