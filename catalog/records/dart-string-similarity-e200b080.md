...
<!-- canonical: https://pub.dev/packages/string_similarity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/string_similarity](https://pub.dev/packages/string_similarity) |
| Source record ids | pub_dev-6b5aa36243dfd4 |

## System Engineer Summary

Finds degree of similarity between two strings, based on Dice's Coefficient, which is mostly better
than Levenshtein distance.

## Operational Role

For a systems engineer, string_similarity belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-04-04T12:14:43.947682Z | [https://pub.dev/api/packages/string_similarity](https://pub.dev/api/packages/string_similarity) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/string_similarity` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-6b5aa36243dfd4` from `pub_dev` as `registry_expansion`
