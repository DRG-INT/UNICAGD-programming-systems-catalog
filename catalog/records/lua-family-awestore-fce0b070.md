...
<!-- canonical: https://luarocks.org/modules/k4rakara/awestore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/k4rakara/awestore](https://luarocks.org/modules/k4rakara/awestore) |
| Source record ids | luarocks_root_manifest-bbb6d5f9ecd270 |
...
For a systems engineer, awestore belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-bbb6d5f9ecd270` from `luarocks_root_manifest` as `registry_expansion`
