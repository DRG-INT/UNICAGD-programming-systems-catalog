...
<!-- canonical: https://cran.r-project.org/web/packages/FeNEU/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FeNEU/index.html](https://cran.r-project.org/web/packages/FeNEU/index.html) |
| Source record ids | cran_packages_by_date-9e5063c91eaca4 |

## System Engineer Summary

Routines for Evaluating Forest Inventory Data

## Operational Role

For a systems engineer, FeNEU belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-09-09 15:00:10 UTC | [https://cran.r-project.org/web/packages/FeNEU/DESCRIPTION](https://cran.r-project.org/web/packages/FeNEU/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FeNEU/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-9e5063c91eaca4` from `cran_packages_by_date` as `registry_expansion`
