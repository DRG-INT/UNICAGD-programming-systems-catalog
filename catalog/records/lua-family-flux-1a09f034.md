...
<!-- canonical: https://github.com/rxi/flux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rxi/flux](https://github.com/rxi/flux) |
| Source record ids | lua-source-138 |

## System Engineer Summary

A fast, lightweight tweening library for Lua with easing functions and the ability to group tweens
together.

## Operational Role

For a systems engineer, flux belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 138}}` |
...
- `lua-source-138` from `master_json` as `source_list_item`
