...
<!-- canonical: https://luarocks.org/modules/jo-link-noir/cpp-compiler-pretty-output -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jo-link-noir/cpp-compiler-pretty-output](https://luarocks.org/modules/jo-link-noir/cpp-compiler-pretty-output) |
| Source record ids | luarocks_root_manifest-5d88fdc96349db |
...
For a systems engineer, cpp-compiler-pretty-output belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-5d88fdc96349db` from `luarocks_root_manifest` as `registry_expansion`
