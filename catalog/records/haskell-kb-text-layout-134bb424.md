...
<!-- canonical: https://hackage.haskell.org/package/kb-text-layout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/kb-text-layout](https://hackage.haskell.org/package/kb-text-layout) |
| Source record ids | hackage_recent-7b9b3700445a16 |

## System Engineer Summary

Hackage package recently uploaded by AlexanderBondarenko.

## Operational Role

For a systems engineer, kb-text-layout belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2.0 | 2026-09-04T20:55:14Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-7b9b3700445a16` from `hackage_recent` as `registry_expansion`
