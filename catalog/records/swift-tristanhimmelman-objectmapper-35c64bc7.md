...
| Source record ids | github_search_swift-d50bde47133963 |
...
For a systems engineer, tristanhimmelman/ObjectMapper belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-02T13:32:48Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-d50bde47133963` from `github_search_swift` as `registry_expansion`
