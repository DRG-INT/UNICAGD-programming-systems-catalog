...
<!-- canonical: https://cran.r-project.org/web/packages/tarpolyglot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tarpolyglot/index.html](https://cran.r-project.org/web/packages/tarpolyglot/index.html) |
| Source record ids | cran_packages_by_date-2fd28ab861d29a |
...
For a systems engineer, tarpolyglot belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-08 10:50:02 UTC | [https://cran.r-project.org/web/packages/tarpolyglot/DESCRIPTION](https://cran.r-project.org/web/packages/tarpolyglot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tarpolyglot/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2fd28ab861d29a` from `cran_packages_by_date` as `registry_expansion`
