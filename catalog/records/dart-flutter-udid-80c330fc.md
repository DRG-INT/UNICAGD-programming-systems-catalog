...
<!-- canonical: https://pub.dev/packages/flutter_udid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_udid](https://pub.dev/packages/flutter_udid) |
| Source record ids | pub_dev-fc2f574a578dda |
...
For a systems engineer, flutter_udid belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.6 | 2026-07-14T09:56:51.543948Z | [https://pub.dev/api/packages/flutter_udid](https://pub.dev/api/packages/flutter_udid) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_udid` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-fc2f574a578dda` from `pub_dev` as `registry_expansion`
