...
<!-- canonical: https://hackage.haskell.org/package/nova-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/nova-cache](https://hackage.haskell.org/package/nova-cache) |
| Source record ids | hackage_top_downloads-1618ddf1b0ba8f |
...
For a systems engineer, nova-cache belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1.1 | 2026-08-27T02:02:24Z | [https://hackage.haskell.org/package/nova-cache](https://hackage.haskell.org/package/nova-cache) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/nova-cache` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-1618ddf1b0ba8f` from `hackage_top_downloads` as `registry_expansion`
