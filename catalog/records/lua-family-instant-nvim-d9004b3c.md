...
| Canonical URL | [https://luarocks.org/modules/neorocks/instant.nvim](https://luarocks.org/modules/neorocks/instant.nvim) |
| Source record ids | luarocks_root_manifest-6d1b39f8f5a2fb |
...
For a systems engineer, instant.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6d1b39f8f5a2fb` from `luarocks_root_manifest` as `registry_expansion`
