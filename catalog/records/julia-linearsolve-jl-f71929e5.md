...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/L/LinearSolve](https://github.com/JuliaRegistries/General/tree/master/L/LinearSolve) |
| Source record ids | corpus-d3a6f767c17d68 |

## System Engineer Summary

LinearSolve.jl is tracked as a math numeric scientific record in the Julia branch. The source did
...
For a systems engineer, LinearSolve.jl belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 5.15.1 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/L/LinearSolve/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/L/LinearSolve/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-d3a6f767c17d68` from `master_json` as `math_numeric_scientific`
