...
<!-- canonical: https://cran.r-project.org/web/packages/confidenceSim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/confidenceSim/index.html](https://cran.r-project.org/web/packages/confidenceSim/index.html) |
| Source record ids | cran_packages_by_date-e20a0dd8bd90a9 |
...
For a systems engineer, confidenceSim belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-01 08:00:03 UTC | [https://cran.r-project.org/web/packages/confidenceSim/DESCRIPTION](https://cran.r-project.org/web/packages/confidenceSim/DESCRIPTION) |  |
...
| Evidence | GPL (>= 2); Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/confidenceSim/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-e20a0dd8bd90a9` from `cran_packages_by_date` as `registry_expansion`
