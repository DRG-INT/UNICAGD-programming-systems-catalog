...
<!-- canonical: https://github.com/exyte/PopupView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/exyte/PopupView](https://github.com/exyte/PopupView) |
| Source record ids | github_search_swift-a489b6b3d2dfd4 |
...
For a systems engineer, exyte/PopupView belongs in the Swift inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T06:44:34Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-a489b6b3d2dfd4` from `github_search_swift` as `registry_expansion`
