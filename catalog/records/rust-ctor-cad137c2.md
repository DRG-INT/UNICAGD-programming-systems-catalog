...
<!-- canonical: https://crates.io/crates/ctor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ctor](https://crates.io/crates/ctor) |
| Source record ids | crates_io-0656d447d6eab0 |

## System Engineer Summary

Global, no_std-compatible constructors for all platforms that run before main (like C/C++
__attribute__((constructor)))

## Operational Role

For a systems engineer, ctor belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.13 | 2026-08-09T22:01:14.164381Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-0656d447d6eab0` from `crates_io` as `registry_expansion`
