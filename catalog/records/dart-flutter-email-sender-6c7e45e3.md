...
<!-- canonical: https://pub.dev/packages/flutter_email_sender -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_email_sender](https://pub.dev/packages/flutter_email_sender) |
| Source record ids | pub_dev-0b52a7fdd35685 |
...
For a systems engineer, flutter_email_sender belongs in the Dart inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.1 | 2026-06-15T11:45:20.454046Z | [https://pub.dev/api/packages/flutter_email_sender](https://pub.dev/api/packages/flutter_email_sender) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_email_sender` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-0b52a7fdd35685` from `pub_dev` as `registry_expansion`
