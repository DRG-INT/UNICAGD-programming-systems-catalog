# contao-catalog/fieldtype_ajaxrating
...
<!-- canonical: https://github.com/contao-catalog/fieldtype_ajaxrating -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/contao-catalog/fieldtype_ajaxrating](https://github.com/contao-catalog/fieldtype_ajaxrating) |
| Source record ids | github_search_space_maps-9175475cfec517 |

## System Engineer Summary

A catalog fieldtype to provide ajax "star rating"

## Operational Role

For a systems engineer, contao-catalog/fieldtype_ajaxrating belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2012-04-03T16:05:44Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9175475cfec517` from `github_search_space_maps` as `registry_expansion`
