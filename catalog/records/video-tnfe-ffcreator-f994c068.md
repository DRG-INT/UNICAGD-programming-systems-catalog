...
| Canonical URL | [https://github.com/tnfe/FFCreator](https://github.com/tnfe/FFCreator) |
| Source record ids | github_search_video-fbf8e5ae6f239c |
...
For a systems engineer, tnfe/FFCreator belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.8.1 | 2023-02-09T07:51:04Z | [https://api.github.com/repos/tnfe/FFCreator/releases/latest](https://api.github.com/repos/tnfe/FFCreator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tnfe/FFCreator/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-fbf8e5ae6f239c` from `github_search_video` as `registry_expansion`
