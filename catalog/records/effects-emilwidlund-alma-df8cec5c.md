...
<!-- canonical: https://github.com/emilwidlund/alma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/emilwidlund/alma](https://github.com/emilwidlund/alma) |
| Source record ids | github_search_effects-5a67af0a37f20b |

## System Engineer Summary

An interactive playground for generative graphics. Combine nodes & logic into WebGL shaders - all
through an intuitive no-code interface.

## Operational Role

For a systems engineer, emilwidlund/alma belongs in the Effects inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-27T12:24:25Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5a67af0a37f20b` from `github_search_effects` as `registry_expansion`
