...
<!-- canonical: https://pub.dev/packages/extended_masked_text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/extended_masked_text](https://pub.dev/packages/extended_masked_text) |
| Source record ids | pub_dev-d02b56907849cb |
...
For a systems engineer, extended_masked_text belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2024-05-23T14:24:06.507350Z | [https://pub.dev/api/packages/extended_masked_text](https://pub.dev/api/packages/extended_masked_text) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/extended_masked_text` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-d02b56907849cb` from `pub_dev` as `registry_expansion`
