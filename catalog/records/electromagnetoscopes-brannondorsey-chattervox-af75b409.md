...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/brannondorsey/chattervox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brannondorsey/chattervox](https://github.com/brannondorsey/chattervox) |
| Source record ids | github_search_electromagnetoscopes-61c0e6a0ceac4d |

## System Engineer Summary

📡 An AX.25 packet radio chat protocol with support for digital signatures and binary compression.
Like IRC over radio waves.

## Operational Role

For a systems engineer, brannondorsey/chattervox belongs in the Electromagnetoscopes inventory as
...
| preview | known | v0.7.0 | 2019-03-17T19:39:14Z | [https://api.github.com/repos/brannondorsey/chattervox/releases?per_page=10](https://api.github.com/repos/brannondorsey/chattervox/releases?per_page=10) |  |
...
- `github_search_electromagnetoscopes-61c0e6a0ceac4d` from `github_search_electromagnetoscopes` as `registry_expansion`
