...
<!-- canonical: https://cran.r-project.org/web/packages/BDPTobitQR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BDPTobitQR/index.html](https://cran.r-project.org/web/packages/BDPTobitQR/index.html) |
| Source record ids | cran_packages_by_date-3c8c683bcb81cd |
...
For a systems engineer, BDPTobitQR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 07:00:08 UTC | [https://cran.r-project.org/web/packages/BDPTobitQR/DESCRIPTION](https://cran.r-project.org/web/packages/BDPTobitQR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BDPTobitQR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3c8c683bcb81cd` from `cran_packages_by_date` as `registry_expansion`
