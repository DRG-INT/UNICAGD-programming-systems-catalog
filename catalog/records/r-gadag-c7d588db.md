...
<!-- canonical: https://cran.r-project.org/web/packages/GADAG/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GADAG/index.html](https://cran.r-project.org/web/packages/GADAG/index.html) |
| Source record ids | cran_packages_by_date-814e031c54d0c8 |
...
For a systems engineer, GADAG belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.99.1 | 2026-09-10 14:20:27 UTC | [https://cran.r-project.org/web/packages/GADAG/DESCRIPTION](https://cran.r-project.org/web/packages/GADAG/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GADAG/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-814e031c54d0c8` from `cran_packages_by_date` as `registry_expansion`
