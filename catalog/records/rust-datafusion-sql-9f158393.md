...
| Canonical URL | [https://crates.io/crates/datafusion-sql](https://crates.io/crates/datafusion-sql) |
| Source record ids | crates_io-e836d404a95e65 |
...
For a systems engineer, datafusion-sql belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 55.0.0 | 2026-08-18T21:10:56.434487Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-e836d404a95e65` from `crates_io` as `registry_expansion`
