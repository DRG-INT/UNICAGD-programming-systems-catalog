...
<!-- canonical: https://github.com/cnpm/cnpmcore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cnpm/cnpmcore](https://github.com/cnpm/cnpmcore) |
| Source record ids | github_search_catalogs-c0b4d7e624308a |

## System Engineer Summary

Private NPM Registry for self-host. Example, npm registry Mirror on China

## Operational Role

For a systems engineer, cnpm/cnpmcore belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T06:12:19Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c0b4d7e624308a` from `github_search_catalogs` as `registry_expansion`
