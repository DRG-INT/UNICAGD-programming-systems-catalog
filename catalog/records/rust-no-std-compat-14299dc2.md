...
<!-- canonical: https://crates.io/crates/no-std-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/no-std-compat](https://crates.io/crates/no-std-compat) |
| Source record ids | crates_io-035156bd5b1361 |
...
For a systems engineer, no-std-compat belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2020-08-09T08:39:42.206558Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-035156bd5b1361` from `crates_io` as `registry_expansion`
