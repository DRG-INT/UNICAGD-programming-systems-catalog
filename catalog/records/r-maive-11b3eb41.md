...
<!-- canonical: https://cran.r-project.org/web/packages/MAIVE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MAIVE/index.html](https://cran.r-project.org/web/packages/MAIVE/index.html) |
| Source record ids | cran_packages_by_date-795506c547fb4b |
...
For a systems engineer, MAIVE belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-03 14:30:22 UTC | [https://cran.r-project.org/web/packages/MAIVE/DESCRIPTION](https://cran.r-project.org/web/packages/MAIVE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MAIVE/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-795506c547fb4b` from `cran_packages_by_date` as `registry_expansion`
