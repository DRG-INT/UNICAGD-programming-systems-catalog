...
<!-- canonical: https://cran.r-project.org/web/packages/gSeg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gSeg/index.html](https://cran.r-project.org/web/packages/gSeg/index.html) |
| Source record ids | cran_packages_by_date-a7ee3a4f39f9b9 |
...
For a systems engineer, gSeg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-09-09 14:10:13 UTC | [https://cran.r-project.org/web/packages/gSeg/DESCRIPTION](https://cran.r-project.org/web/packages/gSeg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gSeg/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-a7ee3a4f39f9b9` from `cran_packages_by_date` as `registry_expansion`
