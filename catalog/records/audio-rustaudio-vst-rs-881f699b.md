...
| Canonical URL | [https://github.com/RustAudio/vst-rs](https://github.com/RustAudio/vst-rs) |
| Source record ids | github_search_audio-ed245f7cbf65d7 |

## System Engineer Summary

VST 2.4 API implementation in rust. Create plugins or hosts. Previously rust-vst on the RustDSP
group.

## Operational Role

For a systems engineer, RustAudio/vst-rs belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.3.0 | 2022-02-27T03:30:53Z | [https://api.github.com/repos/RustAudio/vst-rs/releases/latest](https://api.github.com/repos/RustAudio/vst-rs/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/RustAudio/vst-rs/releases/latest` at `2026-09-01T09:23:20+00:00`.
...
- `github_search_audio-ed245f7cbf65d7` from `github_search_audio` as `registry_expansion`
