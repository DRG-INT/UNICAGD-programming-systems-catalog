...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Codegen Codemod Refactoring](../by-category/codegen-codemod-refactoring.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://go-review.googlesource.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://go-review.googlesource.com/](https://go-review.googlesource.com/) |
| Source record ids | curated_repository_workplace_routes-c6ef3e8bd6577e |

## System Engineer Summary

Official Go Gerrit code review route for Go project changes.

## Operational Role

For a systems engineer, Go Review Route belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-c6ef3e8bd6577e` from `curated_repository_workplace_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gerrit Code Review | Codegen Codemod Refactoring | [open](repository-workplaces-gerrit-code-review-eb4dd8f3.md) |
