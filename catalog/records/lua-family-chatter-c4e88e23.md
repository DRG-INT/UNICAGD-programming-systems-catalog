...
<!-- canonical: https://luarocks.org/modules/jtbx/chatter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jtbx/chatter](https://luarocks.org/modules/jtbx/chatter) |
| Source record ids | luarocks_root_manifest-5e9cc20e8b5ba8 |
...
For a systems engineer, chatter belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5e9cc20e8b5ba8` from `luarocks_root_manifest` as `registry_expansion`
