...
<!-- canonical: https://github.com/bazel-contrib/rules_scala -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_scala](https://github.com/bazel-contrib/rules_scala) |
| Source record ids | github_search_starlark-5d2925ef9d5463 |

## System Engineer Summary

bazel-contrib/rules_scala is tracked as a build system record in the Starlark branch. The source did
...
For a systems engineer, bazel-contrib/rules_scala belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T08:28:08Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:bazel rules stars:>100", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_starlark-5d2925ef9d5463` from `github_search_starlark` as `registry_expansion`
