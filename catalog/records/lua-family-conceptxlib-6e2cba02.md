...
<!-- canonical: https://luarocks.org/modules/thomasnosimp/conceptxlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thomasnosimp/conceptxlib](https://luarocks.org/modules/thomasnosimp/conceptxlib) |
| Source record ids | luarocks_root_manifest-9ca8955bc64c6e |

## System Engineer Summary

Student Data Management Library for Lua

## Operational Role

For a systems engineer, conceptxlib belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-9ca8955bc64c6e` from `luarocks_root_manifest` as `registry_expansion`
