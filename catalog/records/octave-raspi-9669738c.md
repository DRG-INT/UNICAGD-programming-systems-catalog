...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/raspi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/raspi](https://gnu-octave.github.io/packages/raspi) |
| Source record ids | octave_packages_index-7e59ae19dd53dc |

## System Engineer Summary

Basic Octave implementation of the matlab raspi extension, allowing communication to a Raspberry Pi
board to control its hardware.

## Operational Role

For a systems engineer, raspi belongs in the Octave inventory as part of device constraints, cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.3 | 2022-03-21 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-7e59ae19dd53dc` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rtree | Embedded Hardware | [open](octave-rtree-65539ec3.md) |
