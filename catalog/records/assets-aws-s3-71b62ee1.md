...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Assets](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/assets.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-c50d199a7d3f3a |

## System Engineer Summary

Object storage service used for binary assets, media, data lakes, archives, backups, and static
delivery.

## Operational Role

For a systems engineer, AWS S3 belongs in the Assets inventory as part of state persistence,
...
- `curated_language_routes-c50d199a7d3f3a` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Cloudflare R2 | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-cloudflare-r2-5b3731f1.md) |
