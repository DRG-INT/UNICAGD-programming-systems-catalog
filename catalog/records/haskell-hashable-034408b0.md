...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/hashable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hashable](https://hackage.haskell.org/package/hashable) |
| Source record ids | hackage_top_downloads-5ad0b89d39c588 |

## System Engineer Summary

Hackage package with 210 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, hashable belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1.0 | 2026-01-02T17:45:37Z | [https://hackage.haskell.org/package/hashable](https://hackage.haskell.org/package/hashable) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hashable` at `2026-09-01T07:24:02+00:00`.
...
- `hackage_top_downloads-5ad0b89d39c588` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crypto-api | Cryptography | [open](haskell-crypto-api-b5bf9680.md) |
| crypto-enigma | Cryptography | [open](haskell-crypto-enigma-a5b67071.md) |
| cryptocipher | Cryptography | [open](haskell-cryptocipher-aabf56fb.md) |
| cryptohash | Cryptography | [open](haskell-cryptohash-969b670d.md) |
| cryptol | Cryptography | [open](haskell-cryptol-f32fd08e.md) |
| crypton | Cryptography | [open](haskell-crypton-7cba2161.md) |
| cryptonite | Cryptography | [open](haskell-cryptonite-c167855c.md) |
| hashabler | Cryptography | [open](haskell-hashabler-3b9bbc7e.md) |
