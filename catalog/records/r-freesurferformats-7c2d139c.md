...
<!-- canonical: https://cran.r-project.org/web/packages/freesurferformats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/freesurferformats/index.html](https://cran.r-project.org/web/packages/freesurferformats/index.html) |
| Source record ids | cran_packages_by_date-9aab15c4a86218 |
...
For a systems engineer, freesurferformats belongs in the R inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-08 09:50:02 UTC | [https://cran.r-project.org/web/packages/freesurferformats/DESCRIPTION](https://cran.r-project.org/web/packages/freesurferformats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/freesurferformats/DESCRIPTION` at `2026-09-08T10:21:44+00:00`.
...
- `cran_packages_by_date-9aab15c4a86218` from `cran_packages_by_date` as `registry_expansion`
