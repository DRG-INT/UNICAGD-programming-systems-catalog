...
<!-- canonical: https://github.com/osmocom/osmocom-bb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osmocom/osmocom-bb](https://github.com/osmocom/osmocom-bb) |
| Source record ids | github_search_electromagnetoscopes-d119347d3a98db |

## System Engineer Summary

Mobile Station side GSM implementation; mirrored from

## Operational Role

For a systems engineer, osmocom/osmocom-bb belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T20:09:42Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-d119347d3a98db` from `github_search_electromagnetoscopes` as `registry_expansion`
