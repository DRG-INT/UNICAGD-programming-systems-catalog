...
<!-- canonical: https://github.com/wolf96/shader_for_unity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wolf96/shader_for_unity](https://github.com/wolf96/shader_for_unity) |
| Source record ids | github_search_effects-6e16695bfca5cd |
...
For a systems engineer, wolf96/shader_for_unity belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-08-07T01:16:56Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6e16695bfca5cd` from `github_search_effects` as `registry_expansion`
