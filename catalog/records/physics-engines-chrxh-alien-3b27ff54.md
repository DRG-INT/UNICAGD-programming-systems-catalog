...
<!-- canonical: https://github.com/chrxh/alien -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chrxh/alien](https://github.com/chrxh/alien) |
| Source record ids | github_search_physics_engines-76b7047c553c5a |
...
For a systems engineer, chrxh/alien belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T06:28:40Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-76b7047c553c5a` from `github_search_physics_engines` as `registry_expansion`
