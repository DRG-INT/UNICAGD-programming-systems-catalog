...
<!-- canonical: https://github.com/taichi-dev/soft2d-release -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/taichi-dev/soft2d-release](https://github.com/taichi-dev/soft2d-release) |
| Source record ids | github_search_physics_engines-8eff7b688a365d |
...
For a systems engineer, taichi-dev/soft2d-release belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-21T09:58:22Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8eff7b688a365d` from `github_search_physics_engines` as `registry_expansion`
