...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/115cli/](https://pypi.org/project/115cli/) |
| Source record ids | pypi_simple-566389a3812e0c |
...
For a systems engineer, 115cli belongs in the Python inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-05-18T11:49:24.990266Z | [https://pypi.org/pypi/115cli/json](https://pypi.org/pypi/115cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/115cli/json` at `2026-09-01T03:20:32+00:00`.
...
- `pypi_simple-566389a3812e0c` from `pypi_simple` as `registry_expansion`
