...
<!-- canonical: https://github.com/lukas-blecher/LaTeX-OCR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lukas-blecher/LaTeX-OCR](https://github.com/lukas-blecher/LaTeX-OCR) |
| Source record ids | github_search_photography-2e3291fc422198 |
...
For a systems engineer, lukas-blecher/LaTeX-OCR belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-18T15:23:58Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-2e3291fc422198` from `github_search_photography` as `registry_expansion`
