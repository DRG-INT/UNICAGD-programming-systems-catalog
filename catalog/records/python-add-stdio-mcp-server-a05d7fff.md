...
<!-- canonical: https://pypi.org/project/add-stdio-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/add-stdio-mcp-server/](https://pypi.org/project/add-stdio-mcp-server/) |
| Source record ids | pypi_simple-e05113cd755f26 |
...
For a systems engineer, add-stdio-mcp-server belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2025-08-05T08:07:19.858035Z | [https://pypi.org/pypi/add-stdio-mcp-server/json](https://pypi.org/pypi/add-stdio-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/add-stdio-mcp-server/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-e05113cd755f26` from `pypi_simple` as `registry_expansion`
