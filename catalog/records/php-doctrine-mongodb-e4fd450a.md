...
<!-- canonical: https://packagist.org/packages/doctrine/mongodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/doctrine/mongodb](https://packagist.org/packages/doctrine/mongodb) |
| Source record ids | packagist_search-f48a8a24e573cb |

## System Engineer Summary

PHP Doctrine MongoDB project is a library that provides a wrapper around the native PHP Mongo PECL
extension to provide additional functionality.

## Operational Role

For a systems engineer, doctrine/mongodb belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-f48a8a24e573cb` from `packagist_search` as `registry_expansion`
