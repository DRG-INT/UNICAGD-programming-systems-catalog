...
| Canonical URL | [https://crates.io/crates/async-nats](https://crates.io/crates/async-nats) |
| Source record ids | crates_io-fd33084289ed94 |
...
For a systems engineer, async-nats belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.50.0 | 2026-07-20T13:33:50.495802Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-fd33084289ed94` from `crates_io` as `registry_expansion`
