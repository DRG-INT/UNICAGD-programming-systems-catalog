...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-rapidjson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-rapidjson](https://luarocks.org/modules/membphis/api7-lua-rapidjson) |
| Source record ids | luarocks_root_manifest-e93b96920847d0 |
...
For a systems engineer, api7-lua-rapidjson belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-e93b96920847d0` from `luarocks_root_manifest` as `registry_expansion`
