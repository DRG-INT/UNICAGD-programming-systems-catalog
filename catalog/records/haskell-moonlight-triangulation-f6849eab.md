...
<!-- canonical: https://hackage.haskell.org/package/moonlight-triangulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/moonlight-triangulation](https://hackage.haskell.org/package/moonlight-triangulation) |
| Source record ids | hackage_top_downloads-49e1add6f7539f |
...
For a systems engineer, moonlight-triangulation belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0.0 | 2026-08-31T04:55:19Z | [https://hackage.haskell.org/package/moonlight-triangulation](https://hackage.haskell.org/package/moonlight-triangulation) |  |
| candidate | partial | 0.2.0.0 |  | [https://hackage.haskell.org/package/moonlight-triangulation](https://hackage.haskell.org/package/moonlight-triangulation) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/moonlight-triangulation` at `2026-09-10T01:21:07+00:00`.
...
- `hackage_top_downloads-49e1add6f7539f` from `hackage_top_downloads` as `registry_expansion`
