...
<!-- canonical: https://cran.r-project.org/web/packages/exactGMH/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/exactGMH/index.html](https://cran.r-project.org/web/packages/exactGMH/index.html) |
| Source record ids | cran_packages_by_date-09a16232285b90 |

## System Engineer Summary

Exact and Permutation-Based Mantel Tests for Differential Item Functioning in Dichotomous and
Polytomous Items

## Operational Role

For a systems engineer, exactGMH belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:10:06 UTC | [https://cran.r-project.org/web/packages/exactGMH/DESCRIPTION](https://cran.r-project.org/web/packages/exactGMH/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/exactGMH/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-09a16232285b90` from `cran_packages_by_date` as `registry_expansion`
