...
<!-- canonical: https://github.com/kenangundogan/fontisto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kenangundogan/fontisto](https://github.com/kenangundogan/fontisto) |
| Source record ids | github_search_icons_and_logos-3ce73225e29e09 |

## System Engineer Summary

The iconic font and CSS toolkit. Fontisto gives you scalable vector icons that can instantly be
customized: size, color, drop shadow and anything that can be done with the power of CSS.

## Operational Role

For a systems engineer, kenangundogan/fontisto belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-18T09:54:11Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3ce73225e29e09` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| basscss/basscss | Utility Library | [open](icons-and-logos-basscss-basscss-f63e156e.md) |
