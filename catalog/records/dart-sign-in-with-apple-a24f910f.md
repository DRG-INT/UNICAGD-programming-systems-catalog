...
<!-- canonical: https://pub.dev/packages/sign_in_with_apple -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sign_in_with_apple](https://pub.dev/packages/sign_in_with_apple) |
| Source record ids | pub_dev-a164d15975fc1a |

## System Engineer Summary

Flutter bridge to initiate Sign in with Apple (on iOS, macOS, and Android). Includes support for
keychain entries as well as signing in with an Apple ID.

## Operational Role

For a systems engineer, sign_in_with_apple belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.2.0 | 2026-08-27T11:42:37.872720Z | [https://pub.dev/api/packages/sign_in_with_apple](https://pub.dev/api/packages/sign_in_with_apple) |  |
| preview | known | 8.0.0-spm.1 | 2025-06-22T08:34:43.797953Z | [https://pub.dev/api/packages/sign_in_with_apple](https://pub.dev/api/packages/sign_in_with_apple) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sign_in_with_apple` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-a164d15975fc1a` from `pub_dev` as `registry_expansion`
