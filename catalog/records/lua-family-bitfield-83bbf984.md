...
<!-- canonical: https://luarocks.org/modules/luarocks/bitfield -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/bitfield](https://luarocks.org/modules/luarocks/bitfield) |
| Source record ids | luarocks_root_manifest-a875428a5680f7 |
...
For a systems engineer, Bitfield belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a875428a5680f7` from `luarocks_root_manifest` as `registry_expansion`
