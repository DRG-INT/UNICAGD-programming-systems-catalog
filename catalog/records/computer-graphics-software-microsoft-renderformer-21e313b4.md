...
<!-- canonical: https://github.com/microsoft/renderformer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/renderformer](https://github.com/microsoft/renderformer) |
| Source record ids | github_search_computer_graphics_software-bf6467172c1a51 |

## System Engineer Summary

Official Code Release for SIGGRAPH 2025 RenderFormer: Transformer-based Neural Rendering of Triangle
Meshes with Global Illumination

## Operational Role

For a systems engineer, microsoft/renderformer belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-bf6467172c1a51` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| blender/blender | Ffi Bindings | [open](computer-graphics-software-blender-blender-6dca92f3.md) |
