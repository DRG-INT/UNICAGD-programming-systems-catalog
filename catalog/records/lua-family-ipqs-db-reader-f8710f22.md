...
| Canonical URL | [https://luarocks.org/modules/ipqualityscore/ipqs-db-reader](https://luarocks.org/modules/ipqualityscore/ipqs-db-reader) |
| Source record ids | luarocks_root_manifest-c65bf2d8e8691b |
...
For a systems engineer, ipqs-db-reader belongs in the Lua family inventory as part of state
...
- `luarocks_root_manifest-c65bf2d8e8691b` from `luarocks_root_manifest` as `registry_expansion`
