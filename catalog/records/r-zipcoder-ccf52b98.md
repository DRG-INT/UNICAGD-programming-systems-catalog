...
<!-- canonical: https://cran.r-project.org/web/packages/zipcodeR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/zipcodeR/index.html](https://cran.r-project.org/web/packages/zipcodeR/index.html) |
| Source record ids | cran_packages_by_date-dc0562e81a725f |
...
For a systems engineer, zipcodeR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-07 16:00:02 UTC | [https://cran.r-project.org/web/packages/zipcodeR/DESCRIPTION](https://cran.r-project.org/web/packages/zipcodeR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/zipcodeR/DESCRIPTION` at `2026-09-07T16:20:18+00:00`.
...
- `cran_packages_by_date-dc0562e81a725f` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| resmush | Compression | [open](r-resmush-f4d0c58e.md) |
