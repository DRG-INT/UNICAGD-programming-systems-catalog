...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BcubeGmsh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BcubeGmsh](https://github.com/JuliaRegistries/General/tree/master/B/BcubeGmsh) |
| Source record ids | julia_general-32134d9f5288c9 |

## System Engineer Summary

Julia package registered in General at B/BcubeGmsh.

## Operational Role

For a systems engineer, BcubeGmsh belongs in the Julia inventory as part of ecosystem capability
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BcubeGmsh", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-32134d9f5288c9` from `julia_general` as `registry_expansion`
