...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Dead Code Dependency Analysis](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/dead-code-dependency-analysis.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-a115d5181ee3 |
...
For a systems engineer, include-what-you-use belongs in the C99 inventory as part of ecosystem
...
- `master-a115d5181ee3` from `master_json` as `dead_code_dependency_analysis`
