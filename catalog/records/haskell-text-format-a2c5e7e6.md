...
<!-- canonical: https://hackage.haskell.org/package/text-format -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/text-format](https://hackage.haskell.org/package/text-format) |
| Source record ids | hackage_top_downloads-d2820144ace83b |
...
For a systems engineer, text-format belongs in the Haskell inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2.1 | 2022-11-21T22:42:32Z | [https://hackage.haskell.org/package/text-format](https://hackage.haskell.org/package/text-format) |  |
| candidate | partial | 0.3.2 |  | [https://hackage.haskell.org/package/text-format](https://hackage.haskell.org/package/text-format) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/text-format` at `2026-09-03T00:34:45+00:00`.
...
- `hackage_top_downloads-d2820144ace83b` from `hackage_top_downloads` as `registry_expansion`
