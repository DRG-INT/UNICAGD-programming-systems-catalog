...
| Canonical URL | [https://packagist.org/packages/amphp/http](https://packagist.org/packages/amphp/http) |
| Source record ids | packagist_search-4bfc23c8bc2cee |
...
For a systems engineer, amphp/http belongs in the PHP inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.2 | 2024-11-23T14:59:51+00:00 | [https://repo.packagist.org/p2/amphp/http.json](https://repo.packagist.org/p2/amphp/http.json) |  |
| preview | known | v2.0.0-beta.3 | 2023-04-09T13:57:44+00:00 | [https://repo.packagist.org/p2/amphp/http.json](https://repo.packagist.org/p2/amphp/http.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/amphp/http.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-4bfc23c8bc2cee` from `packagist_search` as `registry_expansion`
