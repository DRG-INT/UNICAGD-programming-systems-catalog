...
<!-- canonical: https://cran.r-project.org/web/packages/RESI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RESI/index.html](https://cran.r-project.org/web/packages/RESI/index.html) |
| Source record ids | cran_packages_by_date-87537960fbe62c |
...
For a systems engineer, RESI belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2026-08-21 05:45:56 UTC | [https://cran.r-project.org/web/packages/RESI/DESCRIPTION](https://cran.r-project.org/web/packages/RESI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RESI/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-87537960fbe62c` from `cran_packages_by_date` as `registry_expansion`
