...
<!-- canonical: https://github.com/segevl/dynamic_scheduler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/segevl/dynamic_scheduler](https://github.com/segevl/dynamic_scheduler) |
| Source record ids | github_search_space_maps-d738caed34a389 |

## System Engineer Summary

The framework for a dynamic, cloud-aware scheduler for astronomy all-sky surveys, geared towards
Rubin. Includes DREAM cloud extinction map generation, atmospheric motion tracking via cross-
correlation, Rubin scheduler integration, and survey performance evaluation

## Operational Role

For a systems engineer, segevl/dynamic_scheduler belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T10:46:19Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d738caed34a389` from `github_search_space_maps` as `registry_expansion`
