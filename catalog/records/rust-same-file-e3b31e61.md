...
<!-- canonical: https://crates.io/crates/same-file -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/same-file](https://crates.io/crates/same-file) |
| Source record ids | crates_io-96b4f75852964f |
...
For a systems engineer, same-file belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2020-01-11T17:02:30.960838Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-96b4f75852964f` from `crates_io` as `registry_expansion`
