...
<!-- canonical: https://cran.r-project.org/web/packages/miic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/miic/index.html](https://cran.r-project.org/web/packages/miic/index.html) |
| Source record ids | cran_packages_by_date-6019381f82f6ab |
...
For a systems engineer, miic belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.4 | 2026-09-14 20:50:02 UTC | [https://cran.r-project.org/web/packages/miic/DESCRIPTION](https://cran.r-project.org/web/packages/miic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/miic/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-6019381f82f6ab` from `cran_packages_by_date` as `registry_expansion`
