...
| Source record ids | github_search_webassembly-21979846178645 |

## System Engineer Summary

dy/jz is tracked as a compiler record in the WebAssembly branch. The source did not provide a long
...
For a systems engineer, dy/jz belongs in the WebAssembly inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:30:03Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-21979846178645` from `github_search_webassembly` as `registry_expansion`
