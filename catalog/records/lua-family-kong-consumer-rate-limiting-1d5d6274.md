...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/trojan295/kong-consumer-rate-limiting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/trojan295/kong-consumer-rate-limiting](https://luarocks.org/modules/trojan295/kong-consumer-rate-limiting) |
| Source record ids | luarocks_root_manifest-3cecbe36e6bf30 |

## System Engineer Summary

Consumer Rate Limiting is a Kong plugin, which allows to define request limiting rules

## Operational Role

For a systems engineer, kong-consumer-rate-limiting belongs in the Lua family inventory as part of
...
| Name | Category | Page |
| --- | --- | --- |
| kong-authz-proxy | Lint Rule Pack | [open](lua-family-kong-authz-proxy-a72c03ea.md) |
