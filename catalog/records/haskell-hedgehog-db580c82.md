...
<!-- canonical: https://hackage.haskell.org/package/hedgehog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hedgehog](https://hackage.haskell.org/package/hedgehog) |
| Source record ids | hackage_top_downloads-a1d53452957ced |
...
For a systems engineer, hedgehog belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7 | 2025-09-22T20:47:44Z | [https://hackage.haskell.org/package/hedgehog](https://hackage.haskell.org/package/hedgehog) |  |
| candidate | partial | 0.5.2 |  | [https://hackage.haskell.org/package/hedgehog](https://hackage.haskell.org/package/hedgehog) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hedgehog` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-a1d53452957ced` from `hackage_top_downloads` as `registry_expansion`
