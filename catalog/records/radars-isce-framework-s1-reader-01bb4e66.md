...
<!-- canonical: https://github.com/isce-framework/s1-reader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/isce-framework/s1-reader](https://github.com/isce-framework/s1-reader) |
| Source record ids | github_search_radars-69ff8dc5bc2346 |

## System Engineer Summary

isce-framework/s1-reader is tracked as a framework record in the Radars branch. The source did not
...
For a systems engineer, isce-framework/s1-reader belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.6 | 2026-07-09T20:22:51Z | [https://api.github.com/repos/isce-framework/s1-reader/releases/latest](https://api.github.com/repos/isce-framework/s1-reader/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/isce-framework/s1-reader/releases/latest` at `2026-09-01T08:26:29+00:00`.
...
- `github_search_radars-69ff8dc5bc2346` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| isce-framework/tophu | Framework | [open](radars-isce-framework-tophu-4a798fb0.md) |
