...
<!-- canonical: https://github.com/jellyfin/Swiftfin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jellyfin/Swiftfin](https://github.com/jellyfin/Swiftfin) |
| Source record ids | github_search_swift-dd67ae78ad0f94 |
...
For a systems engineer, jellyfin/Swiftfin belongs in the Swift inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T20:06:20Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-dd67ae78ad0f94` from `github_search_swift` as `registry_expansion`
