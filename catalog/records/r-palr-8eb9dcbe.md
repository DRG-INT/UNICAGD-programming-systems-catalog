...
<!-- canonical: https://cran.r-project.org/web/packages/palr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/palr/index.html](https://cran.r-project.org/web/packages/palr/index.html) |
| Source record ids | cran_packages_by_date-05daa962deb4fd |
...
For a systems engineer, palr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-05 05:30:02 UTC | [https://cran.r-project.org/web/packages/palr/DESCRIPTION](https://cran.r-project.org/web/packages/palr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/palr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-05daa962deb4fd` from `cran_packages_by_date` as `registry_expansion`
