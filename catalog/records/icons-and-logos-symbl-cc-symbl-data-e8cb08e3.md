...
<!-- canonical: https://github.com/symbl-cc/symbl-data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/symbl-cc/symbl-data](https://github.com/symbl-cc/symbl-data) |
| Source record ids | github_search_icons_and_logos-4924bfada28ccc |
...
For a systems engineer, symbl-cc/symbl-data belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-19T11:08:19Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-4924bfada28ccc` from `github_search_icons_and_logos` as `registry_expansion`
