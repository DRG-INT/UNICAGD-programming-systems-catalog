...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Basekick-Labs/arc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Basekick-Labs/arc](https://github.com/Basekick-Labs/arc) |
| Source record ids | github_search_databases-9b88278d77e5b0 |

## System Engineer Summary

Open, SQL-native time-series database for telemetry you need to keep. 34M+ records/sec ingestion,
8M+ rows/sec queries. InfluxDB Line Protocol and Telegraf compatible. Open Parquet on your storage.
Single binary. S3/Azure native. Air-gap ready. AGPL-3.0.

## Operational Role

For a systems engineer, Basekick-Labs/arc belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T23:51:45Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; MIT License; https://api.github.com/licenses/mit; Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-08 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:olap stars:>200", "retrieved": "2026-09-08", "status": "forge-cli-derived"}` |
...
- `github_search_databases-9b88278d77e5b0` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0voice/interview_internal_reference | Database Datastore | [open](databases-0voice-interview-internal-reference-f3eddea9.md) |
| aarondl/sqlboiler | Database Datastore | [open](databases-aarondl-sqlboiler-02990502.md) |
| Active Record | Database Datastore | [open](databases-active-record-74ab791b.md) |
| Adarsh9616/Electricity_Billing_System | Database Datastore | [open](databases-adarsh9616-electricity-billing-system-1402a818.md) |
| Adminer | Database Datastore | [open](databases-adminer-4a67591d.md) |
| ADO.NET | Database Datastore | [open](databases-ado-net-ce3c5008.md) |
| akumuli/Akumuli | Database Datastore | [open](databases-akumuli-akumuli-8025ea92.md) |
| alash3al/redix | Database Datastore | [open](databases-alash3al-redix-0b1086db.md) |
