...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lucemia/typed-ffmpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lucemia/typed-ffmpeg](https://github.com/lucemia/typed-ffmpeg) |
| Source record ids | github_search_assets-e48ceb3e9c0646 |
...
For a systems engineer, lucemia/typed-ffmpeg belongs in the Assets inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T02:53:38Z | gh search repos topic:media-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; The Unlicense; https://api.github.com/licenses/unlicense; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:media-processing stars:>100", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_assets-e48ceb3e9c0646` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| FlexyTools/Flexy.AssetRefs | Type Checker | [open](assets-flexytools-flexy-assetrefs-ec4cd6a1.md) |
| KayKit-Game-Assets/KayKit-Prototype-Bits-1.0 | Type Checker | [open](assets-kaykit-game-assets-kaykit-prototype-bits-1-0-9dbdb869.md) |
| sinclairzx81/typescript-bundle | Type Checker | [open](assets-sinclairzx81-typescript-bundle-f3078d7e.md) |
| VadimDez/Counter-Strike-JS | Type Checker | [open](assets-vadimdez-counter-strike-js-c9d5b005.md) |
| zigurous/unity-prototyping-kit | Type Checker | [open](assets-zigurous-unity-prototyping-kit-8d68caac.md) |
