...
<!-- canonical: https://github.com/varunchitre15/android_kernel_mediatek_sprout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/varunchitre15/android_kernel_mediatek_sprout](https://github.com/varunchitre15/android_kernel_mediatek_sprout) |
| Source record ids | github_search_space_maps-09d2b8934fd54b |

## System Engineer Summary

Common Linux kernel source for Micromax A1, Spice Uno and Karbonn Sparkle V

## Operational Role

For a systems engineer, varunchitre15/android_kernel_mediatek_sprout belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-02-14T16:18:02Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-09d2b8934fd54b` from `github_search_space_maps` as `registry_expansion`
