...
<!-- canonical: https://hackage.haskell.org/package/diagrams-rasterific -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/diagrams-rasterific](https://hackage.haskell.org/package/diagrams-rasterific) |
| Source record ids | hackage_top_downloads-e6266c0f236bfd |
...
For a systems engineer, diagrams-rasterific belongs in the Haskell inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5 | 2025-03-28T20:34:55Z | [https://hackage.haskell.org/package/diagrams-rasterific](https://hackage.haskell.org/package/diagrams-rasterific) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/diagrams-rasterific` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-e6266c0f236bfd` from `hackage_top_downloads` as `registry_expansion`
