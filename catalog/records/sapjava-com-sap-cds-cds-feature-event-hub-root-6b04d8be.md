# com.sap.cds:cds-feature-event-hub-root

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cds/cds-feature-event-hub-root -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cds/cds-feature-event-hub-root](https://central.sonatype.com/artifact/com.sap.cds/cds-feature-event-hub-root) |
| Source record ids | maven_central_search-57f753b14ac276 |

## System Engineer Summary

Maven Central artifact for SAP/Java ecosystem work with packaging `pom`.

## Operational Role

For a systems engineer, com.sap.cds:cds-feature-event-hub-root belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2025-05-20T10:50:10+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json) |  |
...
- `maven_central_search-57f753b14ac276` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cap-java/cds-feature-event-hub | Undefined Behavior Analyzer | [open](sapjava-cap-java-cds-feature-event-hub-94b4b992.md) |
| com.sap.cds:cds-feature-event-hub | Undefined Behavior Analyzer | [open](sapjava-com-sap-cds-cds-feature-event-hub-68d1b4fe.md) |
| h-issue/odata-draft-conflict-with-aggregation | Undefined Behavior Analyzer | [open](sapjava-h-issue-odata-draft-conflict-with-aggregation-0099c2d6.md) |
| SAP/cf-cli-java-plugin | Undefined Behavior Analyzer | [open](sapjava-sap-cf-cli-java-plugin-eac1051f.md) |
| sorimdevs-tech/cap-sflight-migrated-java17-20260127-080309 | Undefined Behavior Analyzer | [open](sapjava-sorimdevs-tech-cap-sflight-migrated-java17-20260127-080309-9463e525.md) |
| sorimdevs-tech/cap-sflight-migrated-java17-20260127-082407 | Undefined Behavior Analyzer | [open](sapjava-sorimdevs-tech-cap-sflight-migrated-java17-20260127-082407-6e4d8ee5.md) |
| sorimdevs-tech/cap-sflight-migrated-java21-20260130-095443 | Undefined Behavior Analyzer | [open](sapjava-sorimdevs-tech-cap-sflight-migrated-java21-20260130-095443-6e76fa26.md) |
| SuvabrataChowdhury/cap-bookshop-mini-sample | Undefined Behavior Analyzer | [open](sapjava-suvabratachowdhury-cap-bookshop-mini-sample-b3a8fea1.md) |
