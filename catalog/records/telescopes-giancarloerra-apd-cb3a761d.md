...
<!-- canonical: https://github.com/giancarloerra/APD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giancarloerra/APD](https://github.com/giancarloerra/APD) |
| Source record ids | github_search_telescopes-f647ed279f755e |

## System Engineer Summary

Astrophotography Planning Dashboard: plan your astrophotography nights with multi-source weather
forecasts, an interactive sky chart for real-sky preview and framing, and AI-ready forecast
summaries.

## Operational Role

For a systems engineer, giancarloerra/APD belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T10:59:15Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-f647ed279f755e` from `github_search_telescopes` as `registry_expansion`
