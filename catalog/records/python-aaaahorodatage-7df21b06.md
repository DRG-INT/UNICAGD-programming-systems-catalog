...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/aaaahorodatage/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aaaahorodatage/](https://pypi.org/project/aaaahorodatage/) |
| Source record ids | pypi_simple-c6268f3cf2a05a |

## System Engineer Summary

Module python 3 de gestion d'horodatages. Chaque horodatage embarque son époque de référence et son
fuseau horaire. L'époque de référence est configurable et peut être différente de l'époque Unix
(1970-01-01T00:00:00) .

## Operational Role

For a systems engineer, aaaahorodatage belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2019-05-04T13:31:51.999514Z | [https://pypi.org/pypi/aaaahorodatage/json](https://pypi.org/pypi/aaaahorodatage/json) |  |
...
| Evidence | GNU GPL; License :: OSI Approved :: GNU General Public License (GPL) |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aaaahorodatage/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-c6268f3cf2a05a` from `pypi_simple` as `registry_expansion`
