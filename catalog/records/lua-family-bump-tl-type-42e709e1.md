...
<!-- canonical: https://luarocks.org/modules/types/bump-tl-type -->
<!-- crawl-delay: 10 -->
...
| --- | --- |
| Detected family | MIT |
| Evidence | CC0; MIT License; https://api.github.com/licenses/mit |
...
- `luarocks_root_manifest-7392f978cd54e5` from `luarocks_root_manifest` as `registry_expansion`
