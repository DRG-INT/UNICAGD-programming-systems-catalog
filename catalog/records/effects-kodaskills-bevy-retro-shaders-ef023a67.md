...
<!-- canonical: https://github.com/Kodaskills/bevy_retro_shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kodaskills/bevy_retro_shaders](https://github.com/Kodaskills/bevy_retro_shaders) |
| Source record ids | github_search_effects-724996b1e2ad56 |

## System Engineer Summary

Retro post-processing shaders for Bevy 0.19+ — CRT curvature, scanlines, chromatic aberration,
vignette, and glitch effects

## Operational Role

For a systems engineer, Kodaskills/bevy_retro_shaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | bevy_retro_shaders-v0.2.0 | 2026-06-26T16:15:57Z | [https://api.github.com/repos/Kodaskills/bevy_retro_shaders/releases/latest](https://api.github.com/repos/Kodaskills/bevy_retro_shaders/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Kodaskills/bevy_retro_shaders/releases/latest` at `2026-09-01T09:23:11+00:00`.
...
- `github_search_effects-724996b1e2ad56` from `github_search_effects` as `registry_expansion`
