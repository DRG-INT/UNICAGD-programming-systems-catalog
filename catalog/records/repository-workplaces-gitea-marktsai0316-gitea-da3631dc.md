# Gitea: marktsai0316/gitea

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/marktsai0316/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/marktsai0316/gitea](https://gitea.com/marktsai0316/gitea) |
| Source record ids | gitea_repositories_api-8e64351f2f4dd9 |
...
For a systems engineer, Gitea: marktsai0316/gitea belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-25T03:17:53Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8e64351f2f4dd9` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bg-utp-repository/devops-y-control-de-versiones-git | Filesystem Os | [open](repository-workplaces-bg-utp-repository-devops-y-control-de-versiones-git-1435df7e.md) |
| Gitea: afzal/advocate-narsingdi | Filesystem Os | [open](repository-workplaces-gitea-afzal-advocate-narsingdi-1c730665.md) |
| Gitea: afzal/bangladesh-struggle-for-independence | Filesystem Os | [open](repository-workplaces-gitea-afzal-bangladesh-struggle-for-independence-572a75c0.md) |
| Gitea: ericLemanissier/conan-center-index | Filesystem Os | [open](repository-workplaces-gitea-ericlemanissier-conan-center-index-4400d1d7.md) |
| Gitea: lcark/gitea | Filesystem Os | [open](repository-workplaces-gitea-lcark-gitea-ab4a7bf0.md) |
| Gitea: sivajothi/DevOpsDemo | Filesystem Os | [open](repository-workplaces-gitea-sivajothi-devopsdemo-8506bea8.md) |
| gitlab-accelerates-embedded/learning/embedded-devops-workshop-refactoring-to-ci | Filesystem Os | [open](repository-workplaces-gitlab-accelerates-embedded-learning-embedded-devops-workshop-refactoring-to-ci-8b9a2cc9.md) |
