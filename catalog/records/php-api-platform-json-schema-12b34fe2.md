...
<!-- canonical: https://packagist.org/packages/api-platform/json-schema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/api-platform/json-schema](https://packagist.org/packages/api-platform/json-schema) |
| Source record ids | packagist_search-a5300629148445 |
...
For a systems engineer, api-platform/json-schema belongs in the PHP inventory as part of wire
...
- `packagist_search-a5300629148445` from `packagist_search` as `registry_expansion`
...
| boldtrn/jsonb-bundle | Serialization | [open](php-boldtrn-jsonb-bundle-0bb02785.md) |
