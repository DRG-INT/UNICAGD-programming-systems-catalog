...
<!-- canonical: https://hackage.haskell.org/package/polysemy-log -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/polysemy-log](https://hackage.haskell.org/package/polysemy-log) |
| Source record ids | hackage_top_downloads-86769caaea2128 |
...
For a systems engineer, polysemy-log belongs in the Haskell inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.2.0 | 2026-05-03T11:32:32Z | [https://hackage.haskell.org/package/polysemy-log](https://hackage.haskell.org/package/polysemy-log) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/polysemy-log](https://hackage.haskell.org/package/polysemy-log) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/polysemy-log` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-86769caaea2128` from `hackage_top_downloads` as `registry_expansion`
