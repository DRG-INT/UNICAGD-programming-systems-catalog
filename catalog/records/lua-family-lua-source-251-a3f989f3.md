...
| Source record ids | lua-source-251 |

## System Engineer Summary

lua-source-251 is tracked as a serialization record in the Lua family branch. The source did not
...
For a systems engineer, lua-source-251 belongs in the Lua family inventory as part of wire formats,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 251}}` |
...
- `lua-source-251` from `master_json` as `source_list_item`
