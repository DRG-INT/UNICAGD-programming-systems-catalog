...
<!-- canonical: https://github.com/huxingyi/dust3d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/huxingyi/dust3d](https://github.com/huxingyi/dust3d) |
| Source record ids | github_search_game_engines-77e2612955746e |

## System Engineer Summary

Dust3D is a cross-platform 3D modeling software that makes it easy to create low poly 3D models for
video games, 3D printing, and more.

## Operational Role

For a systems engineer, huxingyi/dust3d belongs in the Game Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T13:40:09Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-77e2612955746e` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aframevr/aframe | Build System | [open](game-engines-aframevr-aframe-e25fc3c7.md) |
