...
<!-- canonical: https://github.com/peremartra/Large-Language-Model-Notebooks-Course -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peremartra/Large-Language-Model-Notebooks-Course](https://github.com/peremartra/Large-Language-Model-Notebooks-Course) |
| Source record ids | github_search_databases-980e5126b56f3d |
...
For a systems engineer, peremartra/Large-Language-Model-Notebooks-Course belongs in the Databases
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T06:32:56Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-980e5126b56f3d` from `github_search_databases` as `registry_expansion`
...
| huihut/interview | Language Specification | [open](databases-huihut-interview-1cd5b39c.md) |
| LeCoupa/awesome-cheatsheets | Language Specification | [open](databases-lecoupa-awesome-cheatsheets-7dac10f2.md) |
| neuml/txtai | Language Specification | [open](databases-neuml-txtai-68c30186.md) |
| olric-data/olric | Language Specification | [open](databases-olric-data-olric-b5a4b5e3.md) |
