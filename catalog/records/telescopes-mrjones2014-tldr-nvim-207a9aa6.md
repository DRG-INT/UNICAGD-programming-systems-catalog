...
<!-- canonical: https://github.com/mrjones2014/tldr.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mrjones2014/tldr.nvim](https://github.com/mrjones2014/tldr.nvim) |
| Source record ids | github_search_telescopes-aaeffbbba1d15f |
...
For a systems engineer, mrjones2014/tldr.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-02T13:18:05Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-aaeffbbba1d15f` from `github_search_telescopes` as `registry_expansion`
