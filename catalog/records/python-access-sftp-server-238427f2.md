...
<!-- canonical: https://pypi.org/project/access-sftp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/access-sftp-server/](https://pypi.org/project/access-sftp-server/) |
| Source record ids | pypi_simple-1536c2fe74a79d |

## System Engineer Summary

access-sftp-server is tracked as a web framework record in the Python branch. The source did not
...
For a systems engineer, access-sftp-server belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2022-01-18T08:04:48.488029Z | [https://pypi.org/pypi/access-sftp-server/json](https://pypi.org/pypi/access-sftp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/access-sftp-server/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-1536c2fe74a79d` from `pypi_simple` as `registry_expansion`
