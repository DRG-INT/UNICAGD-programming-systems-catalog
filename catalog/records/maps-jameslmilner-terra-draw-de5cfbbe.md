...
<!-- canonical: https://github.com/JamesLMilner/terra-draw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JamesLMilner/terra-draw](https://github.com/JamesLMilner/terra-draw) |
| Source record ids | github_search_maps-06172309bddcc5 |

## System Engineer Summary

A library for drawing on maps that supports Mapbox, MapLibre, Google Maps, OpenLayers and Leaflet
out the box

## Operational Role

For a systems engineer, JamesLMilner/terra-draw belongs in the Maps inventory as part of input-space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T12:15:18Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-06172309bddcc5` from `github_search_maps` as `registry_expansion`
