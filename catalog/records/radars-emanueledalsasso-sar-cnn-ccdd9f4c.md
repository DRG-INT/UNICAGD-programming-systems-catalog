...
<!-- canonical: https://github.com/emanueledalsasso/SAR-CNN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/emanueledalsasso/SAR-CNN](https://github.com/emanueledalsasso/SAR-CNN) |
| Source record ids | github_search_radars-d8d6a0fd3ac06f |

## System Engineer Summary

SAR Image Despeckling by Deep Neural Networks: from a pre-trained model to an end-to-end training
strategy - Notebook implementation usable on Google Colaboratory

## Operational Role

For a systems engineer, emanueledalsasso/SAR-CNN belongs in the Radars inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-06T12:24:57Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-d8d6a0fd3ac06f` from `github_search_radars` as `registry_expansion`
