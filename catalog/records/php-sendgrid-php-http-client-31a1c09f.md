...
<!-- canonical: https://packagist.org/packages/sendgrid/php-http-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sendgrid/php-http-client](https://packagist.org/packages/sendgrid/php-http-client) |
| Source record ids | packagist_search-fb9fea82016f5f |
...
For a systems engineer, sendgrid/php-http-client belongs in the PHP inventory as part of service
...
- `packagist_search-fb9fea82016f5f` from `packagist_search` as `registry_expansion`
