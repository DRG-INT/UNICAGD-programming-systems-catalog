...
<!-- canonical: https://github.com/bazel-contrib/rules_img -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_img](https://github.com/bazel-contrib/rules_img) |
| Source record ids | github_search_starlark-3ae176434bdd25 |
...
For a systems engineer, bazel-contrib/rules_img belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T11:50:47Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License (>= 2); MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_starlark-3ae176434bdd25` from `github_search_starlark` as `registry_expansion`
