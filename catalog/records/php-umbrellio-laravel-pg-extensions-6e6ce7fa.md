...
<!-- canonical: https://packagist.org/packages/umbrellio/laravel-pg-extensions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/umbrellio/laravel-pg-extensions](https://packagist.org/packages/umbrellio/laravel-pg-extensions) |
| Source record ids | packagist_search-feeecd56a59091 |
...
For a systems engineer, umbrellio/laravel-pg-extensions belongs in the PHP inventory as part of
...
- `packagist_search-feeecd56a59091` from `packagist_search` as `registry_expansion`
