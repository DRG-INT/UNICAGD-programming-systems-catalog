...
<!-- canonical: https://github.com/cockroachdb/cockroach -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) |
| Source record ids | github_search_go-4a39f2828d2733 |

## System Engineer Summary

CockroachDB — the cloud native, distributed SQL database designed for high availability, effortless
scale, and control over data placement.

## Operational Role

For a systems engineer, cockroachdb/cockroach belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:32:56Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-4a39f2828d2733` from `github_search_go` as `registry_expansion`
