...
<!-- canonical: https://pub.dev/packages/pedometer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pedometer](https://pub.dev/packages/pedometer) |
| Source record ids | pub_dev-167924fd26c12c |

## System Engineer Summary

A Pedometer and Step Detection package for Android and iOS. Step count is streamed as the platform
updates it.

## Operational Role

For a systems engineer, pedometer belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-02-24T07:47:02.538286Z | [https://pub.dev/api/packages/pedometer](https://pub.dev/api/packages/pedometer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pedometer` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-167924fd26c12c` from `pub_dev` as `registry_expansion`
