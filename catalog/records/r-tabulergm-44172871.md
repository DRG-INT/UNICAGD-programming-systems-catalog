...
<!-- canonical: https://cran.r-project.org/web/packages/tabulergm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tabulergm/index.html](https://cran.r-project.org/web/packages/tabulergm/index.html) |
| Source record ids | cran_packages_by_date-675a1a1c9acbb0 |

## System Engineer Summary

Publication-Ready Tables and Summaries for Exponential-Family Random Graph Models

## Operational Role

For a systems engineer, tabulergm belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 13:50:02 UTC | [https://cran.r-project.org/web/packages/tabulergm/DESCRIPTION](https://cran.r-project.org/web/packages/tabulergm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tabulergm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-675a1a1c9acbb0` from `cran_packages_by_date` as `registry_expansion`
