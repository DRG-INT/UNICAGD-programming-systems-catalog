...
<!-- canonical: https://cran.r-project.org/web/packages/nhdR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nhdR/index.html](https://cran.r-project.org/web/packages/nhdR/index.html) |
| Source record ids | cran_packages_by_date-794f6caa72c47d |
...
For a systems engineer, nhdR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2026-09-09 07:40:14 UTC | [https://cran.r-project.org/web/packages/nhdR/DESCRIPTION](https://cran.r-project.org/web/packages/nhdR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nhdR/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-794f6caa72c47d` from `cran_packages_by_date` as `registry_expansion`
