...
<!-- canonical: https://gitlab.com/BuildGrid/recc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/BuildGrid/recc](https://gitlab.com/BuildGrid/recc) |
| Source record ids | gitlab_projects_api-4e9246080591bb |

## System Engineer Summary

(Obsolete, merged into buildbox) Compiler wrapper client for the Remote Execution API.

## Operational Role

For a systems engineer, BuildGrid/recc belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-4e9246080591bb` from `gitlab_projects_api` as `registry_expansion`
