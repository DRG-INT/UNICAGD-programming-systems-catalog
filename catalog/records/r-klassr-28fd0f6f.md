...
<!-- canonical: https://cran.r-project.org/web/packages/klassR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/klassR/index.html](https://cran.r-project.org/web/packages/klassR/index.html) |
| Source record ids | cran_packages_by_date-a0da6c16699a13 |
...
For a systems engineer, klassR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2026-08-21 12:00:02 UTC | [https://cran.r-project.org/web/packages/klassR/DESCRIPTION](https://cran.r-project.org/web/packages/klassR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/klassR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a0da6c16699a13` from `cran_packages_by_date` as `registry_expansion`
