...
<!-- canonical: https://crates.io/crates/selectors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/selectors](https://crates.io/crates/selectors) |
| Source record ids | crates_io-0cfdf9d6f31f7a |
...
For a systems engineer, selectors belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.40.0 | 2026-08-04T10:05:59.248956Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-0cfdf9d6f31f7a` from `crates_io` as `registry_expansion`
