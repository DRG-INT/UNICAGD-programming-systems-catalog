...
<!-- canonical: https://cran.r-project.org/web/packages/RougeLM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RougeLM/index.html](https://cran.r-project.org/web/packages/RougeLM/index.html) |
| Source record ids | cran_packages_by_date-033c28a67f2951 |
...
For a systems engineer, RougeLM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-07 16:10:17 UTC | [https://cran.r-project.org/web/packages/RougeLM/DESCRIPTION](https://cran.r-project.org/web/packages/RougeLM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RougeLM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-033c28a67f2951` from `cran_packages_by_date` as `registry_expansion`
