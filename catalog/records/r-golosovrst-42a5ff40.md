...
<!-- canonical: https://cran.r-project.org/web/packages/golosovRST/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/golosovRST/index.html](https://cran.r-project.org/web/packages/golosovRST/index.html) |
| Source record ids | cran_packages_by_date-ca68b6951ae39f |

## System Engineer Summary

Golosov Relative Size Triangle Classification and Plotting

## Operational Role

For a systems engineer, golosovRST belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-09-03 11:50:37 UTC | [https://cran.r-project.org/web/packages/golosovRST/DESCRIPTION](https://cran.r-project.org/web/packages/golosovRST/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/golosovRST/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-ca68b6951ae39f` from `cran_packages_by_date` as `registry_expansion`
...
| Argentum | Filesystem Os | [open](r-argentum-3c048222.md) |
| autoCovariateSelection | Filesystem Os | [open](r-autocovariateselection-c436e771.md) |
