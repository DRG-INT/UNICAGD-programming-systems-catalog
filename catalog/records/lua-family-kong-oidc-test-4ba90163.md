...
| Canonical URL | [https://luarocks.org/modules/grizzlyblitz/kong-oidc-test](https://luarocks.org/modules/grizzlyblitz/kong-oidc-test) |
| Source record ids | luarocks_root_manifest-ce42d80a84f4b2 |

## System Engineer Summary

kong-oidc-test is tracked as a testing framework record in the Lua family branch. The source did not
...
For a systems engineer, kong-oidc-test belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-ce42d80a84f4b2` from `luarocks_root_manifest` as `registry_expansion`
