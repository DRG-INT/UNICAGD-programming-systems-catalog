...
<!-- canonical: https://github.com/hibernate/hibernate-orm -->
<!-- crawl-delay: 10 -->
...
| Source record ids | github_search_databases-0128a6b2a879ab |
...
For a systems engineer, hibernate/hibernate-orm belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:36:51Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0128a6b2a879ab` from `github_search_databases` as `registry_expansion`
