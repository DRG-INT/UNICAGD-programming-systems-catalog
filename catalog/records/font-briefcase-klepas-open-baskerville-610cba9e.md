...
<!-- canonical: https://github.com/klepas/open-baskerville -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/klepas/open-baskerville](https://github.com/klepas/open-baskerville) |
| Source record ids | github_search_font_briefcase-f0fc0ec49d4fad |
...
For a systems engineer, klepas/open-baskerville belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-12T16:08:49Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD_3_clause + file LICENSE; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_font_briefcase-f0fc0ec49d4fad` from `github_search_font_briefcase` as `registry_expansion`
