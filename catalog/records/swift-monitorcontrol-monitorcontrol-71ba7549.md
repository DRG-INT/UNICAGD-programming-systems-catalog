...
<!-- canonical: https://github.com/MonitorControl/MonitorControl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MonitorControl/MonitorControl](https://github.com/MonitorControl/MonitorControl) |
| Source record ids | github_search_swift-1578f4edf85248 |

## System Engineer Summary

🖥 Control your display's brightness & volume on your Mac as if it was a native Apple Display. Use
Apple Keyboard keys or custom shortcuts. Shows the native macOS OSDs.

## Operational Role

For a systems engineer, MonitorControl/MonitorControl belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T16:37:52Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-1578f4edf85248` from `github_search_swift` as `registry_expansion`
