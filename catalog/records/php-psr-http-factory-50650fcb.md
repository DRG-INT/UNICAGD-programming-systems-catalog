...
<!-- canonical: https://packagist.org/packages/psr/http-factory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/psr/http-factory](https://packagist.org/packages/psr/http-factory) |
| Source record ids | packagist_search-4aeda49299bc97 |
...
For a systems engineer, psr/http-factory belongs in the PHP inventory as part of service
...
- `packagist_search-4aeda49299bc97` from `packagist_search` as `registry_expansion`
