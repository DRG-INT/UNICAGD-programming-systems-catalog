...
<!-- canonical: https://github.com/FluidSynth/fluidsynth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FluidSynth/fluidsynth](https://github.com/FluidSynth/fluidsynth) |
| Source record ids | github_search_audio-f2e25c3cb7d89c |
...
For a systems engineer, FluidSynth/fluidsynth belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.6.0 | 2026-08-11T17:29:05Z | [https://api.github.com/repos/FluidSynth/fluidsynth/releases/latest](https://api.github.com/repos/FluidSynth/fluidsynth/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/FluidSynth/fluidsynth/releases/latest` at `2026-09-01T11:21:38+00:00`.
...
- `github_search_audio-f2e25c3cb7d89c` from `github_search_audio` as `registry_expansion`
