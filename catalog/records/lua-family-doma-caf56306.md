...
<!-- canonical: https://luarocks.org/modules/apconduct/doma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/apconduct/doma](https://luarocks.org/modules/apconduct/doma) |
| Source record ids | luarocks_root_manifest-31529a06acbd2d |

## System Engineer Summary

doma is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, doma belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-31529a06acbd2d` from `luarocks_root_manifest` as `registry_expansion`
