...
<!-- canonical: https://github.com/opensearch-project/OpenSearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opensearch-project/OpenSearch](https://github.com/opensearch-project/OpenSearch) |
| Source record ids | curated_database_systems-fbf88e6e3b791d |

## System Engineer Summary

Search and analytics engine derived from Elasticsearch.

## Operational Role

For a systems engineer, OpenSearch belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-fbf88e6e3b791d` from `curated_database_systems` as `registry_expansion`
