...
<!-- canonical: https://cran.r-project.org/web/packages/coconots/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/coconots/index.html](https://cran.r-project.org/web/packages/coconots/index.html) |
| Source record ids | cran_packages_by_date-a0fcf8d2253c13 |
...
For a systems engineer, coconots belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.4 | 2026-08-23 15:20:02 UTC | [https://cran.r-project.org/web/packages/coconots/DESCRIPTION](https://cran.r-project.org/web/packages/coconots/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/coconots/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a0fcf8d2253c13` from `cran_packages_by_date` as `registry_expansion`
