...
<!-- canonical: https://pub.dev/packages/get_it -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/get_it](https://pub.dev/packages/get_it) |
| Source record ids | pub_dev-de0db61de8b348 |
...
For a systems engineer, get_it belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.2.1 | 2026-02-20T00:30:44.678929Z | [https://pub.dev/api/packages/get_it](https://pub.dev/api/packages/get_it) |  |
| preview | known | 8.0.0-pre-7 | 2024-08-12T14:29:51.066607Z | [https://pub.dev/api/packages/get_it](https://pub.dev/api/packages/get_it) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/get_it` at `2026-09-02T00:28:55+00:00`.
...
- `pub_dev-de0db61de8b348` from `pub_dev` as `registry_expansion`
