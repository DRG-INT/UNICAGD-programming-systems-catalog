...
<!-- canonical: https://luarocks.org/modules/sayan-shankhari/colordot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/sayan-shankhari/colordot](https://luarocks.org/modules/sayan-shankhari/colordot) |
| Source record ids | luarocks_root_manifest-726531a1fc9198 |

## System Engineer Summary

A custom Lua nvim plugin to display known formats color codes as dot (⬤)

## Operational Role

For a systems engineer, colordot belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-726531a1fc9198` from `luarocks_root_manifest` as `registry_expansion`
