...
<!-- canonical: https://github.com/pothosware/SoapyHackRF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pothosware/SoapyHackRF](https://github.com/pothosware/SoapyHackRF) |
| Source record ids | github_search_satcom_satellites-02685a494393a8 |

## System Engineer Summary

pothosware/SoapyHackRF is tracked as a filesystem os record in the SatCom Satellites branch. The
...
For a systems engineer, pothosware/SoapyHackRF belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-09T16:13:57Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-02685a494393a8` from `github_search_satcom_satellites` as `registry_expansion`
