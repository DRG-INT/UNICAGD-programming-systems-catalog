...
| Source record ids | corpus-631b30a99d388a |

## System Engineer Summary

Unreal Engine is tracked as a game engine game dev record in the C++23 branch. The source did not
...
For a systems engineer, Unreal Engine belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-631b30a99d388a` from `master_json` as `game_engine_game_dev`
