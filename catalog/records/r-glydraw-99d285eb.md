...
<!-- canonical: https://cran.r-project.org/web/packages/glydraw/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glydraw/index.html](https://cran.r-project.org/web/packages/glydraw/index.html) |
| Source record ids | cran_packages_by_date-5aff92eb51e388 |
...
For a systems engineer, glydraw belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-26 09:30:02 UTC | [https://cran.r-project.org/web/packages/glydraw/DESCRIPTION](https://cran.r-project.org/web/packages/glydraw/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glydraw/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5aff92eb51e388` from `cran_packages_by_date` as `registry_expansion`
