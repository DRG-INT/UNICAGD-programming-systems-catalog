...
<!-- canonical: https://github.com/linkdd/sdl-game-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/linkdd/sdl-game-engine](https://github.com/linkdd/sdl-game-engine) |
| Source record ids | github_search_physics_engines-878dcc812bd215 |
...
For a systems engineer, linkdd/sdl-game-engine belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-14T07:48:20Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-878dcc812bd215` from `github_search_physics_engines` as `registry_expansion`
