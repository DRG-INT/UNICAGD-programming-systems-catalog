...
<!-- canonical: https://github.com/carbon-design-system/carbon-icons-svelte -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/carbon-design-system/carbon-icons-svelte](https://github.com/carbon-design-system/carbon-icons-svelte) |
| Source record ids | github_search_icons_and_logos-47274f8e326232 |
...
For a systems engineer, carbon-design-system/carbon-icons-svelte belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T21:48:28Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-47274f8e326232` from `github_search_icons_and_logos` as `registry_expansion`
