...
<!-- canonical: https://pypi.org/project/ab-testing-module/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-testing-module/](https://pypi.org/project/ab-testing-module/) |
| Source record ids | pypi_simple-40239f8cc8e933 |

## System Engineer Summary

The AB Testing Module is a comprehensive suite designed for analyzing and reporting A/B test
experiments, featuring functions for statistical analysis, advanced modeling, and data visualization
to transform experimental results into actionable insights.

## Operational Role

For a systems engineer, ab-testing-module belongs in the Python inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.7 | 2024-03-18T08:25:19.155229Z | [https://pypi.org/pypi/ab-testing-module/json](https://pypi.org/pypi/ab-testing-module/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-testing-module/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-40239f8cc8e933` from `pypi_simple` as `registry_expansion`
...
| acti-data-analyzer | Static Analyzer | [open](python-acti-data-analyzer-ae5c7411.md) |
