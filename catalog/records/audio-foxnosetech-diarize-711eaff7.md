...
<!-- canonical: https://github.com/FoxNoseTech/diarize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FoxNoseTech/diarize](https://github.com/FoxNoseTech/diarize) |
| Source record ids | github_search_audio-aa772743b46eac |

## System Engineer Summary

Speaker diarization for Python — "who spoke when?" CPU-only, no API keys, Apache 2.0. ~10.8% DER on
VoxConverse, 8x faster than real-time.

## Operational Role

For a systems engineer, FoxNoseTech/diarize belongs in the Audio inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-06T10:03:41Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-aa772743b46eac` from `github_search_audio` as `registry_expansion`
