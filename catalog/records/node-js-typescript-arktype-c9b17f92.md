...
| Source record ids | corpus-f2da0c437e2478 |

## System Engineer Summary

ArkType is tracked as a serialization record in the Node.js/TypeScript branch. The source did not
...
For a systems engineer, ArkType belongs in the Node.js/TypeScript inventory as part of wire formats,
...
- `corpus-f2da0c437e2478` from `master_json` as `serialization`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| class-transformer | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-class-transformer-04167632.md) |
| class-validator | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-class-validator-8fdb1dfb.md) |
| io-ts | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-io-ts-c7cc2364.md) |
| Valibot | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-valibot-a0076f63.md) |
