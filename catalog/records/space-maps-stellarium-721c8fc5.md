...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-maps.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-b92c64aea9ef53 |

## System Engineer Summary

Open-source planetarium and sky map software with catalogs, simulations, plugins, and visualization.

## Operational Role

For a systems engineer, Stellarium belongs in the Space Maps inventory as part of ecosystem
...
- `curated_language_routes-b92c64aea9ef53` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CesiumJS | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-maps-cesiumjs-2b9855f8.md) |
| ESA Sky | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-maps-esa-sky-507149dd.md) |
| NASA Solar System Treks | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-maps-nasa-solar-system-treks-66e2186c.md) |
| NASA WorldWind | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-maps-nasa-worldwind-a55955ab.md) |
