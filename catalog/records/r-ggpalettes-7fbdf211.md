...
<!-- canonical: https://cran.r-project.org/web/packages/ggpalettes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggpalettes/index.html](https://cran.r-project.org/web/packages/ggpalettes/index.html) |
| Source record ids | cran_packages_by_date-9df6169ba5f544 |

## System Engineer Summary

Curated Colour Palettes and Scales for 'ggplot2'

## Operational Role

For a systems engineer, ggpalettes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-04 16:30:17 UTC | [https://cran.r-project.org/web/packages/ggpalettes/DESCRIPTION](https://cran.r-project.org/web/packages/ggpalettes/DESCRIPTION) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggpalettes/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9df6169ba5f544` from `cran_packages_by_date` as `registry_expansion`
