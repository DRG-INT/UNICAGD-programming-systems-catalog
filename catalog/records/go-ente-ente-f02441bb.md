...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ente/ente -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ente/ente](https://github.com/ente/ente) |
| Source record ids | github_search_go-db83433660ed62 |
...
For a systems engineer, ente/ente belongs in the Go inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T16:04:16Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_go-db83433660ed62` from `github_search_go` as `registry_expansion`
