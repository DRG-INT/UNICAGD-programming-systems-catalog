...
<!-- canonical: https://luarocks.org/modules/hisham/datafile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/hisham/datafile](https://luarocks.org/modules/hisham/datafile) |
| Source record ids | luarocks_root_manifest-482e9f885c1570 |
...
For a systems engineer, datafile belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-482e9f885c1570` from `luarocks_root_manifest` as `registry_expansion`
