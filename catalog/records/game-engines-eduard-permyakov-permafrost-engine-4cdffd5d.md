...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/eduard-permyakov/permafrost-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eduard-permyakov/permafrost-engine](https://github.com/eduard-permyakov/permafrost-engine) |
| Source record ids | github_search_game_engines-c8cb4a610b5315 |
...
For a systems engineer, eduard-permyakov/permafrost-engine belongs in the Game Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T10:19:34Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-c8cb4a610b5315` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 4ian/GDevelop | Filesystem Os | [open](game-engines-4ian-gdevelop-4ed2e379.md) |
| cocos2d/cocos2d-x | Filesystem Os | [open](game-engines-cocos2d-cocos2d-x-90febff2.md) |
| coronalabs/corona | Filesystem Os | [open](game-engines-coronalabs-corona-d8bd96ea.md) |
| dhewm/dhewm3 | Filesystem Os | [open](game-engines-dhewm-dhewm3-e66077c2.md) |
| Donchitos/Claude-Code-Game-Studios | Filesystem Os | [open](game-engines-donchitos-claude-code-game-studios-d1775992.md) |
| GodotSteam/GodotSteam | Filesystem Os | [open](game-engines-godotsteam-godotsteam-b02eef72.md) |
| gongminmin/KlayGE | Filesystem Os | [open](game-engines-gongminmin-klayge-d6276657.md) |
| hajimehoshi/ebiten | Filesystem Os | [open](game-engines-hajimehoshi-ebiten-e5319afc.md) |
