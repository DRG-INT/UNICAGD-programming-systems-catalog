...
<!-- canonical: https://github.com/antvis/L7 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/antvis/L7](https://github.com/antvis/L7) |
| Source record ids | github_search_maps-2b7b1599facfd6 |
...
For a systems engineer, antvis/L7 belongs in the Maps inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T10:03:41Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2b7b1599facfd6` from `github_search_maps` as `registry_expansion`
