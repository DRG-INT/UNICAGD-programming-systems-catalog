...
<!-- canonical: https://packagist.org/packages/tymon/jwt-auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/tymon/jwt-auth](https://packagist.org/packages/tymon/jwt-auth) |
| Source record ids | packagist_search-ce75affb6bdee4 |
...
For a systems engineer, tymon/jwt-auth belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-ce75affb6bdee4` from `packagist_search` as `registry_expansion`
