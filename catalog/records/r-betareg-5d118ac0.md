...
<!-- canonical: https://cran.r-project.org/web/packages/betareg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/betareg/index.html](https://cran.r-project.org/web/packages/betareg/index.html) |
| Source record ids | cran_packages_by_date-bf8aa9e19e8e1c |

## System Engineer Summary

betareg is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, betareg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2-6 | 2026-08-26 09:20:02 UTC | [https://cran.r-project.org/web/packages/betareg/DESCRIPTION](https://cran.r-project.org/web/packages/betareg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/betareg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bf8aa9e19e8e1c` from `cran_packages_by_date` as `registry_expansion`
