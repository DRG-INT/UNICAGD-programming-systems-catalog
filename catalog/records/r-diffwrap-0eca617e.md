...
<!-- canonical: https://cran.r-project.org/web/packages/diffwrap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/diffwrap/index.html](https://cran.r-project.org/web/packages/diffwrap/index.html) |
| Source record ids | cran_packages_by_date-3f5f1d5a4d9a9f |
...
For a systems engineer, diffwrap belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6-3 | 2026-08-30 09:10:19 UTC | [https://cran.r-project.org/web/packages/diffwrap/DESCRIPTION](https://cran.r-project.org/web/packages/diffwrap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/diffwrap/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3f5f1d5a4d9a9f` from `cran_packages_by_date` as `registry_expansion`
