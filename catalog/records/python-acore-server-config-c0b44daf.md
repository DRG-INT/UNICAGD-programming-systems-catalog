...
<!-- canonical: https://pypi.org/project/acore-server-config/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acore-server-config/](https://pypi.org/project/acore-server-config/) |
| Source record ids | pypi_simple-35a407b2520c36 |
...
For a systems engineer, acore-server-config belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2024-07-26T20:54:58.407360Z | [https://pypi.org/pypi/acore-server-config/json](https://pypi.org/pypi/acore-server-config/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acore-server-config/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-35a407b2520c36` from `pypi_simple` as `registry_expansion`
