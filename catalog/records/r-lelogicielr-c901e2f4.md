...
<!-- canonical: https://cran.r-project.org/web/packages/LeLogicielR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LeLogicielR/index.html](https://cran.r-project.org/web/packages/LeLogicielR/index.html) |
| Source record ids | cran_packages_by_date-3f48f8a90712e1 |

## System Engineer Summary

Companion to the Book Le Logiciel R

## Operational Role

For a systems engineer, LeLogicielR belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-08-23 10:50:02 UTC | [https://cran.r-project.org/web/packages/LeLogicielR/DESCRIPTION](https://cran.r-project.org/web/packages/LeLogicielR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LeLogicielR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3f48f8a90712e1` from `cran_packages_by_date` as `registry_expansion`
