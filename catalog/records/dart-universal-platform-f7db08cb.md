...
<!-- canonical: https://pub.dev/packages/universal_platform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/universal_platform](https://pub.dev/packages/universal_platform) |
| Source record ids | pub_dev-bdd0fcad24d699 |

## System Engineer Summary

Replacement for dart.io.Platform class which works on Web as well as Desktop and Mobile. Allows
platform checks in your view/model layer easily.

## Operational Role

For a systems engineer, universal_platform belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2024-05-23T03:19:31.244187Z | [https://pub.dev/api/packages/universal_platform](https://pub.dev/api/packages/universal_platform) |  |
| preview | known | 1.0.0-nullsafety | 2021-03-05T06:26:55.208491Z | [https://pub.dev/api/packages/universal_platform](https://pub.dev/api/packages/universal_platform) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/universal_platform` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-bdd0fcad24d699` from `pub_dev` as `registry_expansion`
