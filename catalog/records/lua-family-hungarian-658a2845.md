...
| Canonical URL | [https://luarocks.org/modules/arvahsu/hungarian](https://luarocks.org/modules/arvahsu/hungarian) |
| Source record ids | luarocks_root_manifest-af1fbf3d8b3db2 |

## System Engineer Summary

hungarian is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, hungarian belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-af1fbf3d8b3db2` from `luarocks_root_manifest` as `registry_expansion`
