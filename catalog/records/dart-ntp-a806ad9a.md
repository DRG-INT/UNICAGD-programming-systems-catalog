...
<!-- canonical: https://pub.dev/packages/ntp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ntp](https://pub.dev/packages/ntp) |
| Source record ids | pub_dev-fc7b1d66357578 |
...
For a systems engineer, ntp belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2021-03-29T13:14:17.095317Z | [https://pub.dev/api/packages/ntp](https://pub.dev/api/packages/ntp) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ntp` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-fc7b1d66357578` from `pub_dev` as `registry_expansion`
