...
<!-- canonical: https://github.com/pokepetter/ursina -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pokepetter/ursina](https://github.com/pokepetter/ursina) |
| Source record ids | github_search_game_engines-8c63baba3de3f1 |
...
For a systems engineer, pokepetter/ursina belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:02:54Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-8c63baba3de3f1` from `github_search_game_engines` as `registry_expansion`
