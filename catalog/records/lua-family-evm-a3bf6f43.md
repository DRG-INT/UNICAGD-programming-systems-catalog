...
| Canonical URL | [https://luarocks.org/modules/mah0x211/evm](https://luarocks.org/modules/mah0x211/evm) |
| Source record ids | luarocks_root_manifest-5bd8f4163bcc46 |
...
For a systems engineer, evm belongs in the Lua family inventory as part of runtime behavior,
...
- `luarocks_root_manifest-5bd8f4163bcc46` from `luarocks_root_manifest` as `registry_expansion`
