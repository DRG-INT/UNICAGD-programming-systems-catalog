...
<!-- canonical: https://github.com/mkleehammer/pyodbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mkleehammer/pyodbc](https://github.com/mkleehammer/pyodbc) |
| Source record ids | github_search_databases-5bd08c810457ff |

## System Engineer Summary

mkleehammer/pyodbc is tracked as an interop bindings record in the Databases branch. The source did
...
For a systems engineer, mkleehammer/pyodbc belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-06T22:06:03Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5bd08c810457ff` from `github_search_databases` as `registry_expansion`
