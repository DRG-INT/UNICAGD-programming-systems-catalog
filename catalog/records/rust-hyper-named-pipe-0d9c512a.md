...
| Canonical URL | [https://crates.io/crates/hyper-named-pipe](https://crates.io/crates/hyper-named-pipe) |
| Source record ids | crates_io-d9415c0dff78a3 |
...
For a systems engineer, hyper-named-pipe belongs in the Rust inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-07-20T17:16:46.064696Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-d9415c0dff78a3` from `crates_io` as `registry_expansion`
