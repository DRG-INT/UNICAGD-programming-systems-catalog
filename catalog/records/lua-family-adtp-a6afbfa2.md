...
<!-- canonical: https://luarocks.org/modules/alula/adtp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alula/adtp](https://luarocks.org/modules/alula/adtp) |
| Source record ids | luarocks_root_manifest-1c225244c97a36 |

## System Engineer Summary

adtp is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, adtp belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1c225244c97a36` from `luarocks_root_manifest` as `registry_expansion`
