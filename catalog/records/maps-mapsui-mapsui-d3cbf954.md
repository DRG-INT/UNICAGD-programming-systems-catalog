...
<!-- canonical: https://github.com/Mapsui/Mapsui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mapsui/Mapsui](https://github.com/Mapsui/Mapsui) |
| Source record ids | github_search_maps-c3bcd0ab5ba966 |

## System Engineer Summary

Mapsui is a .NET Map component for: MAUI, Avalonia, Uno Platform, Blazor, WPF, WinUI, Windows Forms,
Eto Forms, .NET for Android and .NET for iOS

## Operational Role

For a systems engineer, Mapsui/Mapsui belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T15:33:11Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-c3bcd0ab5ba966` from `github_search_maps` as `registry_expansion`
