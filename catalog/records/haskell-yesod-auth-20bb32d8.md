...
<!-- canonical: https://hackage.haskell.org/package/yesod-auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yesod-auth](https://hackage.haskell.org/package/yesod-auth) |
| Source record ids | hackage_top_downloads-485bec533255a3 |

## System Engineer Summary

Hackage package with 322 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, yesod-auth belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.12.1 | 2026-06-16T20:34:31Z | [https://hackage.haskell.org/package/yesod-auth](https://hackage.haskell.org/package/yesod-auth) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yesod-auth` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-485bec533255a3` from `hackage_top_downloads` as `registry_expansion`
