...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Machine Learning](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/machine-learning.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/bbwdadfg/facialharmonyai-site-kit](https://luarocks.org/modules/bbwdadfg/facialharmonyai-site-kit) |
| Source record ids | luarocks_root_manifest-62ec3ac6e66e84 |

## System Engineer Summary

URL helpers and metadata utilities for FacialHarmonyAI

## Operational Role

For a systems engineer, facialharmonyai-site-kit belongs in the Lua family inventory as part of
model pipelines, numerical runtime constraints, and data/deployment interfaces.
...
| Name | Category | Page |
| --- | --- | --- |
| adt.lua | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-adt-lua-7a019900.md) |
| ai | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ai-402e5a12.md) |
| aiagentskills-site-kit | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aiagentskills-site-kit-fa3a48df.md) |
| argus-redact-bridge | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argus-redact-bridge-c295dde4.md) |
| autohydraz | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-autohydraz-95a1ea4a.md) |
| babel-base | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-babel-base-9b30c0b9.md) |
| brain | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-brain-d840e33e.md) |
| budoux | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-budoux-701fba9b.md) |
