...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BrainVisionDataFormat](https://github.com/JuliaRegistries/General/tree/master/B/BrainVisionDataFormat) |
| Source record ids | julia_general-f796a2a913b865 |

## System Engineer Summary

Julia package registered in General at B/BrainVisionDataFormat.

## Operational Role

For a systems engineer, BrainVisionDataFormat belongs in the Julia inventory as part of low-noise
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BrainVisionDataFormat", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f796a2a913b865` from `julia_general` as `registry_expansion`
