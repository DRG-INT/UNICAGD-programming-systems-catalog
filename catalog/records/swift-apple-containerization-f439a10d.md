...
<!-- canonical: https://github.com/apple/containerization -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apple/containerization](https://github.com/apple/containerization) |
| Source record ids | github_search_swift-73d4a137b027d4 |
...
For a systems engineer, apple/containerization belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-73d4a137b027d4` from `github_search_swift` as `registry_expansion`
...
| CleanArchitectureRxSwift | Filesystem Os | [open](swift-cleanarchitecturerxswift-25af9dfb.md) |
