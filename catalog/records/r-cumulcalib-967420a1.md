...
<!-- canonical: https://cran.r-project.org/web/packages/cumulcalib/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cumulcalib/index.html](https://cran.r-project.org/web/packages/cumulcalib/index.html) |
| Source record ids | cran_packages_by_date-130b188f120a4f |
...
For a systems engineer, cumulcalib belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 03:00:09 UTC | [https://cran.r-project.org/web/packages/cumulcalib/DESCRIPTION](https://cran.r-project.org/web/packages/cumulcalib/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cumulcalib/DESCRIPTION` at `2026-09-15T03:22:13+00:00`.
...
- `cran_packages_by_date-130b188f120a4f` from `cran_packages_by_date` as `registry_expansion`
