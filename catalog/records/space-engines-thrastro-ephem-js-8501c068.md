...
<!-- canonical: https://github.com/THRASTRO/ephem.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/THRASTRO/ephem.js](https://github.com/THRASTRO/ephem.js) |
| Source record ids | github_search_space_engines-bf1d449a63597b |

## System Engineer Summary

JavaScript library to get Positions for Astronomical Bodies, including VSOP2013, VSOP2010, VSOP87,
TOP2013, TOP2010, ELP2000-MPP02, ELP2000-82b, EPHASTER ephemerides and some home-grown ones
(mgstat2023). Optimized for speed and size.

## Operational Role

For a systems engineer, THRASTRO/ephem.js belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-07T23:54:45Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- `github_search_space_engines-bf1d449a63597b` from `github_search_space_engines` as `registry_expansion`
