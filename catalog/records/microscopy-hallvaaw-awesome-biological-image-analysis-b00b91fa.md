...
<!-- canonical: https://github.com/hallvaaw/awesome-biological-image-analysis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hallvaaw/awesome-biological-image-analysis](https://github.com/hallvaaw/awesome-biological-image-analysis) |
| Source record ids | github_search_microscopy-5d7ab269e9bb5a |

## System Engineer Summary

A curated list of software, tools, pipelines, plugins etc. for image analysis related to biological
questions.

## Operational Role

For a systems engineer, hallvaaw/awesome-biological-image-analysis belongs in the Microscopy
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T08:44:58Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- `github_search_microscopy-5d7ab269e9bb5a` from `github_search_microscopy` as `registry_expansion`
