# innermost47/beatcrafter

## Navigation

[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/innermost47/beatcrafter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/innermost47/beatcrafter](https://github.com/innermost47/beatcrafter) |
| Source record ids | github_search_audio-9d7648f88c7348 |

## System Engineer Summary

Intelligent MIDI drum pattern generator VST3 designed for live performance with foot controllers.
Generate authentic patterns across multiple styles with dynamic intensity control.

## Operational Role

For a systems engineer, innermost47/beatcrafter belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T16:26:10Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-9d7648f88c7348` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ossrs/srs | Benchmarking | [open](audio-ossrs-srs-47dbade0.md) |
| pliang279/MultiBench | Benchmarking | [open](audio-pliang279-multibench-5d5b2fb4.md) |
| smu160/PhastFT | Benchmarking | [open](audio-smu160-phastft-ad3fafee.md) |
| TEN-framework/ten-vad | Benchmarking | [open](audio-ten-framework-ten-vad-921e1403.md) |
