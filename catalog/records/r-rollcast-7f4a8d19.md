...
<!-- canonical: https://cran.r-project.org/web/packages/rollcast/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rollcast/index.html](https://cran.r-project.org/web/packages/rollcast/index.html) |
| Source record ids | cran_packages_by_date-8c500bce9c8409 |

## System Engineer Summary

Probabilistic Forecasting with Adaptive Mixtures of Rolling Statistics

## Operational Role

For a systems engineer, rollcast belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-02 12:30:02 UTC | [https://cran.r-project.org/web/packages/rollcast/DESCRIPTION](https://cran.r-project.org/web/packages/rollcast/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rollcast/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-8c500bce9c8409` from `cran_packages_by_date` as `registry_expansion`
