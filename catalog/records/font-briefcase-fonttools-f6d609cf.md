...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Font Briefcase](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/font-briefcase.md) · [Category: Utility Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/utility-library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-94415b9aaf0f1b |

## System Engineer Summary

Python font engineering toolkit for OpenType, TrueType, UFO, variable fonts, subsetting, and
inspection.

## Operational Role

For a systems engineer, fontTools belongs in the Font Briefcase inventory as part of ecosystem
...
- `curated_language_routes-94415b9aaf0f1b` from `curated_language_routes` as `registry_expansion`
