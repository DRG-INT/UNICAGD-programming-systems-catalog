...
<!-- canonical: https://hackage.haskell.org/package/parseargs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/parseargs](https://hackage.haskell.org/package/parseargs) |
| Source record ids | hackage_top_downloads-35c8682f269846 |

## System Engineer Summary

Hackage package with 70 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, parseargs belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.9 | 2019-02-07T09:27:02Z | [https://hackage.haskell.org/package/parseargs](https://hackage.haskell.org/package/parseargs) |  |
| candidate | partial | 0.2.0.8 |  | [https://hackage.haskell.org/package/parseargs](https://hackage.haskell.org/package/parseargs) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/parseargs` at `2026-09-04T12:28:58+00:00`.
...
- `hackage_top_downloads-35c8682f269846` from `hackage_top_downloads` as `registry_expansion`
