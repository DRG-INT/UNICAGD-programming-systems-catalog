...
<!-- canonical: https://luarocks.org/modules/cabra-lat/awesome-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cabra-lat/awesome-config](https://luarocks.org/modules/cabra-lat/awesome-config) |
| Source record ids | luarocks_root_manifest-ca4b8970449c7f |

## System Engineer Summary

cabra.lat's AwesomeWM configuration

## Operational Role

For a systems engineer, awesome-config belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ca4b8970449c7f` from `luarocks_root_manifest` as `registry_expansion`
