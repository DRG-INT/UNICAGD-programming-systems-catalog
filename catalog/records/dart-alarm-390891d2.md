...
<!-- canonical: https://pub.dev/packages/alarm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/alarm](https://pub.dev/packages/alarm) |
| Source record ids | pub_dev-94d8d64f8e7d32 |
...
For a systems engineer, alarm belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.12.0 | 2026-08-24T12:36:17.383839Z | [https://pub.dev/api/packages/alarm](https://pub.dev/api/packages/alarm) |  |
| preview | known | 5.0.0-dev.11 | 2025-01-30T11:19:29.247344Z | [https://pub.dev/api/packages/alarm](https://pub.dev/api/packages/alarm) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/alarm` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-94d8d64f8e7d32` from `pub_dev` as `registry_expansion`
