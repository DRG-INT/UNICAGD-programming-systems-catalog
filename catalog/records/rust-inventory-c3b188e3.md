...
<!-- canonical: https://crates.io/crates/inventory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/inventory](https://crates.io/crates/inventory) |
| Source record ids | crates_io-1e2ff26d21a77a |
...
For a systems engineer, inventory belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.24 | 2026-03-30T23:14:21.008253Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-1e2ff26d21a77a` from `crates_io` as `registry_expansion`
