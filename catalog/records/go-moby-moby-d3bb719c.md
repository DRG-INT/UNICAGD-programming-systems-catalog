...
| Source record ids | github_search_go-86937c382cedcc |
...
For a systems engineer, moby/moby belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T13:39:58Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-86937c382cedcc` from `github_search_go` as `registry_expansion`
