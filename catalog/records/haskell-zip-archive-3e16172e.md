...
<!-- canonical: https://hackage.haskell.org/package/zip-archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zip-archive](https://hackage.haskell.org/package/zip-archive) |
| Source record ids | hackage_top_downloads-af61344b5e4129 |
...
For a systems engineer, zip-archive belongs in the Haskell inventory as part of ecosystem capability
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/zip-archive` at `2026-09-02T14:24:31+00:00`.
...
- `hackage_top_downloads-af61344b5e4129` from `hackage_top_downloads` as `registry_expansion`
