...
<!-- canonical: https://crates.io/crates/hex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hex](https://crates.io/crates/hex) |
| Source record ids | crates_io-311b7f5ca6571a |
...
For a systems engineer, hex belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2021-03-03T10:48:58.682837Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-311b7f5ca6571a` from `crates_io` as `registry_expansion`
