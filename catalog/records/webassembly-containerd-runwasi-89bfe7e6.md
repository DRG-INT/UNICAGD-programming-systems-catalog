...
<!-- canonical: https://github.com/containerd/runwasi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/containerd/runwasi](https://github.com/containerd/runwasi) |
| Source record ids | github_search_webassembly-7cdd49a9a23319 |
...
For a systems engineer, containerd/runwasi belongs in the WebAssembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T00:33:50Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-7cdd49a9a23319` from `github_search_webassembly` as `registry_expansion`
