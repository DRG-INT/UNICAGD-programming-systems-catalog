...
<!-- canonical: https://github.com/lexrus/LTMorphingLabel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lexrus/LTMorphingLabel](https://github.com/lexrus/LTMorphingLabel) |
| Source record ids | github_search_swift-d52a1a1833e324 |
...
For a systems engineer, lexrus/LTMorphingLabel belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-d52a1a1833e324` from `github_search_swift` as `registry_expansion`
