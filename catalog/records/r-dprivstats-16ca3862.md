...
<!-- canonical: https://cran.r-project.org/web/packages/DPrivStats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DPrivStats/index.html](https://cran.r-project.org/web/packages/DPrivStats/index.html) |
| Source record ids | cran_packages_by_date-3e6db67aac1009 |
...
For a systems engineer, DPrivStats belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:30:29 UTC | [https://cran.r-project.org/web/packages/DPrivStats/DESCRIPTION](https://cran.r-project.org/web/packages/DPrivStats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DPrivStats/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-3e6db67aac1009` from `cran_packages_by_date` as `registry_expansion`
