...
<!-- canonical: https://github.com/leggedrobotics/graph_msf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leggedrobotics/graph_msf](https://github.com/leggedrobotics/graph_msf) |
| Source record ids | github_search_radars-1b7387398c185e |

## System Engineer Summary

A graph-based multi-sensor fusion framework. It can be used to fuse various relative or absolute
measurments with IMU readings in real-time.

## Operational Role

For a systems engineer, leggedrobotics/graph_msf belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-04T15:33:32Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-1b7387398c185e` from `github_search_radars` as `registry_expansion`
