...
<!-- canonical: https://cran.r-project.org/web/packages/Qindex.data/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Qindex.data/index.html](https://cran.r-project.org/web/packages/Qindex.data/index.html) |
| Source record ids | cran_packages_by_date-b17bc61a9ab498 |

## System Engineer Summary

Data for (Legacy) Package 'Qindex'

## Operational Role

For a systems engineer, Qindex.data belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-26 02:50:02 UTC | [https://cran.r-project.org/web/packages/Qindex.data/DESCRIPTION](https://cran.r-project.org/web/packages/Qindex.data/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Qindex.data/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b17bc61a9ab498` from `cran_packages_by_date` as `registry_expansion`
...
| rsmatrix | Registry Repository | [open](r-rsmatrix-2518f19b.md) |
