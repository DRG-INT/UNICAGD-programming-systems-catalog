...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Microsoft.AspNetCore.HttpOverrides -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.AspNetCore.HttpOverrides](https://www.nuget.org/packages/Microsoft.AspNetCore.HttpOverrides) |
| Source record ids | nuget_search-569dc9827db974 |

## System Engineer Summary

ASP.NET Core basic middleware for supporting HTTP method overrides. Includes: * X-Forwarded-*
headers to forward headers from a proxy. * HTTP method override header.

## Operational Role

For a systems engineer, Microsoft.AspNetCore.HttpOverrides belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.12 | 2026-08-11T17:16:14.657+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.httpoverrides/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.httpoverrides/index.json) |  |
| preview | known | 2.2.0-preview3-35497 | 2018-10-17T15:17:24.2+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.httpoverrides/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.httpoverrides/index.json) |  |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; https://raw.githubusercontent.com/aspnet/AspNetCore/2.0.0/LICENSE.txt |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.httpoverrides/index.json` at `2026-09-01T07:23:57+00:00`.
...
| --- | --- | --- | --- |
| nuget_search_api | registry-derived | 2026-09-01 | `{"kind": "nuget_search_api", "query": "http", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `nuget_search-569dc9827db974` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Json.More.Net | Ide Editor Integration | [open](c-sharp-json-more-net-8d267cb6.md) |
| JsonSchema.Net.Generation | Ide Editor Integration | [open](c-sharp-jsonschema-net-generation-5dce69df.md) |
| Macross.Json.Extensions | Ide Editor Integration | [open](c-sharp-macross-json-extensions-50ac23a8.md) |
| Microsoft.Extensions.Configuration.Binder | Ide Editor Integration | [open](c-sharp-microsoft-extensions-configuration-binder-a536e247.md) |
| Microsoft.IdentityModel.JsonWebTokens | Ide Editor Integration | [open](c-sharp-microsoft-identitymodel-jsonwebtokens-5ea5b0ed.md) |
| Microsoft.Kiota.Http.HttpClientLibrary | Ide Editor Integration | [open](c-sharp-microsoft-kiota-http-httpclientlibrary-6d2c59d4.md) |
| Microsoft.Kiota.Serialization.Json | Ide Editor Integration | [open](c-sharp-microsoft-kiota-serialization-json-ebb35bc0.md) |
| Nethereum.JsonRpc.RpcClient | Ide Editor Integration | [open](c-sharp-nethereum-jsonrpc-rpcclient-52884f24.md) |
