...
<!-- canonical: https://github.com/breizhn/DTLN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/breizhn/DTLN](https://github.com/breizhn/DTLN) |
| Source record ids | github_search_audio-55049f1a4e7de1 |

## System Engineer Summary

Tensorflow 2.x implementation of the DTLN real time speech denoising model. With TF-lite, ONNX and
real-time audio processing support.

## Operational Role

For a systems engineer, breizhn/DTLN belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-28T09:47:18Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-55049f1a4e7de1` from `github_search_audio` as `registry_expansion`
