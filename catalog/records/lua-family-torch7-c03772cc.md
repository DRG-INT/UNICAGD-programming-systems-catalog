...
| Canonical URL | [http://torch.ch/](http://torch.ch/) |
| Source record ids | lua-source-241 |

## System Engineer Summary

Scientific computing framework with wide support for machine learning algorithms, used by Facebook,
Google, and more.

## Operational Role

For a systems engineer, Torch7 belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 241}}` |
...
- `lua-source-241` from `master_json` as `source_list_item`
