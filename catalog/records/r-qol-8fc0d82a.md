...
<!-- canonical: https://cran.r-project.org/web/packages/qol/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qol/index.html](https://cran.r-project.org/web/packages/qol/index.html) |
| Source record ids | cran_packages_by_date-788aff4d390438 |
...
For a systems engineer, qol belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2026-08-21 05:41:02 UTC | [https://cran.r-project.org/web/packages/qol/DESCRIPTION](https://cran.r-project.org/web/packages/qol/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qol/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-788aff4d390438` from `cran_packages_by_date` as `registry_expansion`
