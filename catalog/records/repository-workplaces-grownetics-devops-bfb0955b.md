...
<!-- canonical: https://gitlab.com/grownetics/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/grownetics/devops](https://gitlab.com/grownetics/devops) |
| Source record ids | gitlab_projects_api-eedde6e087f712 |

## System Engineer Summary

grownetics/devops is tracked as a networking http record in the Repository Workplaces branch. The
...
For a systems engineer, grownetics/devops belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-04T13:41:12.472Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-eedde6e087f712` from `gitlab_projects_api` as `registry_expansion`
