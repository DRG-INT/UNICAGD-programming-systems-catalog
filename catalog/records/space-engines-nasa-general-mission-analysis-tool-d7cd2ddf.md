...
<!-- canonical: https://github.com/ChristopherRabotin/GMAT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChristopherRabotin/GMAT](https://github.com/ChristopherRabotin/GMAT) |
| Source record ids | curated_language_routes-f28daf247e317e |

## System Engineer Summary

Mission analysis and trajectory design system for spacecraft, orbital mechanics, and astrodynamics
workflows.

## Operational Role

For a systems engineer, NASA General Mission Analysis Tool belongs in the Space Engines inventory as
...
- `curated_language_routes-f28daf247e317e` from `curated_language_routes` as `registry_expansion`
