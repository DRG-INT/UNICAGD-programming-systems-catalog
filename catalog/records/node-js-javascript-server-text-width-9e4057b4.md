...
<!-- canonical: https://www.npmjs.com/package/server-text-width -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/server-text-width](https://www.npmjs.com/package/server-text-width) |
| Source record ids | npm_registry-352c4e0c104225 |
...
For a systems engineer, server-text-width belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2021-01-05T22:26:01.659Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-352c4e0c104225` from `npm_registry` as `registry_expansion`
