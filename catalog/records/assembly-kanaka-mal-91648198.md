...
| Source record ids | github_search_assembly-a33671b3bbcaa3 |

## System Engineer Summary

kanaka/mal is tracked as a language specification record in the Assembly branch. The source did not
...
For a systems engineer, kanaka/mal belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-22T16:42:57Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-a33671b3bbcaa3` from `github_search_assembly` as `registry_expansion`
