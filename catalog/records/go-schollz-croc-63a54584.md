...
<!-- canonical: https://github.com/schollz/croc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/schollz/croc](https://github.com/schollz/croc) |
| Source record ids | github_search_go-0fc6644f2c311a |
...
For a systems engineer, schollz/croc belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:12:41Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-0fc6644f2c311a` from `github_search_go` as `registry_expansion`
