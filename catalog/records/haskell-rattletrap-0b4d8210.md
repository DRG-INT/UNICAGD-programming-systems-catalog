...
<!-- canonical: https://hackage.haskell.org/package/rattletrap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/rattletrap](https://hackage.haskell.org/package/rattletrap) |
| Source record ids | hackage_top_downloads-1a7d6e1111d807 |
...
For a systems engineer, rattletrap belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 14.1.4 | 2025-08-06T02:51:58Z | [https://hackage.haskell.org/package/rattletrap](https://hackage.haskell.org/package/rattletrap) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/rattletrap` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-1a7d6e1111d807` from `hackage_top_downloads` as `registry_expansion`
