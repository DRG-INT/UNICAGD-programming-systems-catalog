...
<!-- canonical: https://crates.io/crates/blake2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/blake2](https://crates.io/crates/blake2) |
| Source record ids | crates_io-aa43e853f7e813 |

## System Engineer Summary

blake2 is tracked as a cryptography record in the Rust branch. The source did not provide a long
...
For a systems engineer, blake2 belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2026-08-26T13:23:38.306906Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-aa43e853f7e813` from `crates_io` as `registry_expansion`
