...
<!-- canonical: https://github.com/Jounce/Surge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jounce/Surge](https://github.com/Jounce/Surge) |
| Source record ids | github_search_effects-af926d50a13cb5 |

## System Engineer Summary

A Swift library that uses the Accelerate framework to provide high-performance functions for matrix
math, digital signal processing, and image manipulation.

## Operational Role

For a systems engineer, Jounce/Surge belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-20T14:04:23Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 3); MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-af926d50a13cb5` from `github_search_effects` as `registry_expansion`
