...
<!-- canonical: https://hackage.haskell.org/package/contiguous -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/contiguous](https://hackage.haskell.org/package/contiguous) |
| Source record ids | hackage_top_downloads-05e136b5d7007d |
...
For a systems engineer, contiguous belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5.0 | 2025-04-07T14:23:05Z | [https://hackage.haskell.org/package/contiguous](https://hackage.haskell.org/package/contiguous) |  |
| candidate | partial | 0.3.0.0 |  | [https://hackage.haskell.org/package/contiguous](https://hackage.haskell.org/package/contiguous) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/contiguous` at `2026-09-02T00:32:31+00:00`.
...
- `hackage_top_downloads-05e136b5d7007d` from `hackage_top_downloads` as `registry_expansion`
