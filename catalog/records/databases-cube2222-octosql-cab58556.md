...
<!-- canonical: https://github.com/cube2222/octosql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cube2222/octosql](https://github.com/cube2222/octosql) |
| Source record ids | github_search_databases-02da7dfc2aa1f3 |

## System Engineer Summary

OctoSQL is a query tool that allows you to join, analyse and transform data from multiple databases
and file formats using SQL.

## Operational Role

For a systems engineer, cube2222/octosql belongs in the Databases inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-26T15:16:53Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-02da7dfc2aa1f3` from `github_search_databases` as `registry_expansion`
