...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jpcima/ADLplug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jpcima/ADLplug](https://github.com/jpcima/ADLplug) |
| Source record ids | github_search_audio-41de621aee2a39 |
...
For a systems engineer, jpcima/ADLplug belongs in the Audio inventory as part of ecosystem
...
- `github_search_audio-41de621aee2a39` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| albertaparicio/tfg-voice-conversion | Precommit Ci Quality | [open](audio-albertaparicio-tfg-voice-conversion-85e47393.md) |
