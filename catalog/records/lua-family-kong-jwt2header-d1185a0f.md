...
| Canonical URL | [https://luarocks.org/modules/nickong/kong-jwt2header](https://luarocks.org/modules/nickong/kong-jwt2header) |
| Source record ids | luarocks_root_manifest-3e2f9a1a8a44a7 |
...
For a systems engineer, kong-jwt2header belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-3e2f9a1a8a44a7` from `luarocks_root_manifest` as `registry_expansion`
