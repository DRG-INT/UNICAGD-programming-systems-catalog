...
<!-- canonical: https://packagist.org/packages/orptech/laravel-migration-partition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/orptech/laravel-migration-partition](https://packagist.org/packages/orptech/laravel-migration-partition) |
| Source record ids | packagist_search-c5fa1ddcc1e6eb |

## System Engineer Summary

Laravel extensions that extends Illuminate to enable partitioned table creation within Laravel
migrations.

## Operational Role

For a systems engineer, orptech/laravel-migration-partition belongs in the PHP inventory as part of
...
- `packagist_search-c5fa1ddcc1e6eb` from `packagist_search` as `registry_expansion`
