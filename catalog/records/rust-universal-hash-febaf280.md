...
<!-- canonical: https://crates.io/crates/universal-hash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/universal-hash](https://crates.io/crates/universal-hash) |
| Source record ids | crates_io-e747ee06bb00db |
...
For a systems engineer, universal-hash belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-02-27T16:05:55.037699Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-e747ee06bb00db` from `crates_io` as `registry_expansion`
