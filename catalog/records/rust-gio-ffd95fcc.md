...
| Canonical URL | [https://crates.io/crates/gio](https://crates.io/crates/gio) |
| Source record ids | crates_io-0d9f950bdc16d3 |
...
For a systems engineer, gio belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.9 | 2026-08-30T17:44:56.748049Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-0d9f950bdc16d3` from `crates_io` as `registry_expansion`
