...
| Source record ids | github_search_computer_graphics_software-46f63a98fee9af |
...
For a systems engineer, AcademySoftwareFoundation/OpenShadingLanguage belongs in the Computer
...
| --- | --- |
| Detected family | MIT |
| Evidence | Open Data Commons Open Database License v1.0; https://api.github.com/licenses/odbl-1.0; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_computer_graphics_software-46f63a98fee9af` from `github_search_computer_graphics_software` as `registry_expansion`
