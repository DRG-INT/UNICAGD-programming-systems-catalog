...
<!-- canonical: https://cran.r-project.org/web/packages/yulab.utils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/yulab.utils/index.html](https://cran.r-project.org/web/packages/yulab.utils/index.html) |
| Source record ids | cran_packages_by_date-98e4bbfae11e9b |
...
For a systems engineer, yulab.utils belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-29 15:30:01 UTC | [https://cran.r-project.org/web/packages/yulab.utils/DESCRIPTION](https://cran.r-project.org/web/packages/yulab.utils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/yulab.utils/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-98e4bbfae11e9b` from `cran_packages_by_date` as `registry_expansion`
