...
<!-- canonical: https://cran.r-project.org/web/packages/StealLikeBayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/StealLikeBayes/index.html](https://cran.r-project.org/web/packages/StealLikeBayes/index.html) |
| Source record ids | cran_packages_by_date-2fd26ac7f44b1d |
...
For a systems engineer, StealLikeBayes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-08-31 17:20:08 UTC | [https://cran.r-project.org/web/packages/StealLikeBayes/DESCRIPTION](https://cran.r-project.org/web/packages/StealLikeBayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/StealLikeBayes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2fd26ac7f44b1d` from `cran_packages_by_date` as `registry_expansion`
