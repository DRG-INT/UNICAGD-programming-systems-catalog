...
<!-- canonical: https://packagist.org/packages/nicolaslopezj/searchable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nicolaslopezj/searchable](https://packagist.org/packages/nicolaslopezj/searchable) |
| Source record ids | packagist_search-5276c7498bc541 |
...
For a systems engineer, nicolaslopezj/searchable belongs in the PHP inventory as part of state
...
- `packagist_search-5276c7498bc541` from `packagist_search` as `registry_expansion`
