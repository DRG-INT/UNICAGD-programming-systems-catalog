...
<!-- canonical: https://luarocks.org/modules/ubaldo/eja -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ubaldo/eja](https://luarocks.org/modules/ubaldo/eja) |
| Source record ids | luarocks_root_manifest-866da231911298 |
...
For a systems engineer, eja belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-866da231911298` from `luarocks_root_manifest` as `registry_expansion`
