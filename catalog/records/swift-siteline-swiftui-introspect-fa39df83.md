...
<!-- canonical: https://github.com/siteline/swiftui-introspect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/siteline/swiftui-introspect](https://github.com/siteline/swiftui-introspect) |
| Source record ids | github_search_swift-05047fabb0432a |
...
For a systems engineer, siteline/swiftui-introspect belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:26:20Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-05047fabb0432a` from `github_search_swift` as `registry_expansion`
