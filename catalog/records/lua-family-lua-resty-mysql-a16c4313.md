...
<!-- canonical: https://github.com/openresty/lua-resty-mysql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openresty/lua-resty-mysql](https://github.com/openresty/lua-resty-mysql) |
| Source record ids | lua-source-299 |
...
For a systems engineer, lua-resty-mysql belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 299}}` |
...
- `lua-source-299` from `master_json` as `source_list_item`
