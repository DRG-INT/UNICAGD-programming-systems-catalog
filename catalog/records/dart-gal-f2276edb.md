...
<!-- canonical: https://pub.dev/packages/gal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/gal](https://pub.dev/packages/gal) |
| Source record ids | pub_dev-83da6b3cf76fcd |
...
For a systems engineer, gal belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.3 | 2026-07-25T08:08:10.589086Z | [https://pub.dev/api/packages/gal](https://pub.dev/api/packages/gal) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/gal` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-83da6b3cf76fcd` from `pub_dev` as `registry_expansion`
