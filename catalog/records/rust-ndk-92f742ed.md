...
<!-- canonical: https://crates.io/crates/ndk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ndk](https://crates.io/crates/ndk) |
| Source record ids | crates_io-4dd275e398a45a |
...
For a systems engineer, ndk belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2024-04-26T15:15:21.991128Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-4dd275e398a45a` from `crates_io` as `registry_expansion`
