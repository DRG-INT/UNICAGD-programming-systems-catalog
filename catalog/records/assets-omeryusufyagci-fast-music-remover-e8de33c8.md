...
<!-- canonical: https://github.com/omeryusufyagci/fast-music-remover -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/omeryusufyagci/fast-music-remover](https://github.com/omeryusufyagci/fast-music-remover) |
| Source record ids | github_search_assets-2efa73fa40f893 |

## System Engineer Summary

A C++ based, lightweight music and noise remover for YouTube and other internet media, using
DeepFilterNet for audio enhancement.

## Operational Role

For a systems engineer, omeryusufyagci/fast-music-remover belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-15T19:11:56Z | gh search repos topic:media-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | ISC License; https://api.github.com/licenses/isc; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_assets-2efa73fa40f893` from `github_search_assets` as `registry_expansion`
