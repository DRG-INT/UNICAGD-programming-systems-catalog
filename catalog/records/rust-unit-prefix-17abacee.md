...
<!-- canonical: https://crates.io/crates/unit-prefix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unit-prefix](https://crates.io/crates/unit-prefix) |
| Source record ids | crates_io-013fc8f6c4a746 |
...
For a systems engineer, unit-prefix belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2025-11-16T23:46:07.469023Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-013fc8f6c4a746` from `crates_io` as `registry_expansion`
