...
<!-- canonical: https://hackage.haskell.org/package/citeproc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/citeproc](https://hackage.haskell.org/package/citeproc) |
| Source record ids | hackage_top_downloads-c6a99f25db336e |
...
For a systems engineer, citeproc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0.1 | 2026-06-01T09:03:38Z | [https://hackage.haskell.org/package/citeproc](https://hackage.haskell.org/package/citeproc) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/citeproc` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-c6a99f25db336e` from `hackage_top_downloads` as `registry_expansion`
