...
<!-- canonical: https://luarocks.org/modules/darkwiiplayer/arrr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/darkwiiplayer/arrr](https://luarocks.org/modules/darkwiiplayer/arrr) |
| Source record ids | luarocks_root_manifest-f5d7698cf4700a |
...
For a systems engineer, arrr belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-f5d7698cf4700a` from `luarocks_root_manifest` as `registry_expansion`
