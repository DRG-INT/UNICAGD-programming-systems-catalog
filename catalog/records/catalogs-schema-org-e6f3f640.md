...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Catalogs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/catalogs.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://schema.org/](https://schema.org/) |
| Source record ids | curated_language_routes-cfe7e8a38920e5 |

## System Engineer Summary

Structured-data vocabulary catalog for entities, properties, schemas, linked metadata, and
search/discovery integration.

## Operational Role

For a systems engineer, Schema.org belongs in the Catalogs inventory as part of ecosystem capability
...
- `curated_language_routes-cfe7e8a38920e5` from `curated_language_routes` as `registry_expansion`
