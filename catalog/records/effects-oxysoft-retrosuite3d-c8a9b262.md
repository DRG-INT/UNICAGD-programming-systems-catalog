...
<!-- canonical: https://github.com/oxysoft/RetroSuite3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oxysoft/RetroSuite3D](https://github.com/oxysoft/RetroSuite3D) |
| Source record ids | github_search_effects-252d37f6836f82 |
...
For a systems engineer, oxysoft/RetroSuite3D belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-25T16:25:09Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-252d37f6836f82` from `github_search_effects` as `registry_expansion`
