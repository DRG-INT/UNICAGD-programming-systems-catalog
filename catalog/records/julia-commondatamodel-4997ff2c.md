...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CommonDataModel](https://github.com/JuliaRegistries/General/tree/master/C/CommonDataModel) |
| Source record ids | julia_general-fbc219175480bf |

## System Engineer Summary

Julia package registered in General at C/CommonDataModel.

## Operational Role

For a systems engineer, CommonDataModel belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CommonDataModel", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-fbc219175480bf` from `julia_general` as `registry_expansion`
