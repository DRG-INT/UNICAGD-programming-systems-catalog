...
<!-- canonical: https://crates.io/crates/libgit2-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libgit2-sys](https://crates.io/crates/libgit2-sys) |
| Source record ids | crates_io-b0b8f12fcceb65 |
...
For a systems engineer, libgit2-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.8+1.9.7 | 2026-08-21T20:27:18.625135Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-b0b8f12fcceb65` from `crates_io` as `registry_expansion`
