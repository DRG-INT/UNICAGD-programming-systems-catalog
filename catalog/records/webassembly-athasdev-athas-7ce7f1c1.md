...
<!-- canonical: https://github.com/athasdev/athas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/athasdev/athas](https://github.com/athasdev/athas) |
| Source record ids | github_search_webassembly-6eac0e4dfa2b46 |

## System Engineer Summary

A lightweight, cross-platform code editor, built with Tauri (Rust and React) with Git support, AI
agents, vim keybindings.

## Operational Role

For a systems engineer, athasdev/athas belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T23:12:56Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6eac0e4dfa2b46` from `github_search_webassembly` as `registry_expansion`
