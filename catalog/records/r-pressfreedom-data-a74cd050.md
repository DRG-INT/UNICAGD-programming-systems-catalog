...
<!-- canonical: https://cran.r-project.org/web/packages/pressfreedom.data/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pressfreedom.data/index.html](https://cran.r-project.org/web/packages/pressfreedom.data/index.html) |
| Source record ids | cran_packages_by_date-9ce76008f62a91 |
...
For a systems engineer, pressfreedom.data belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-24 12:40:02 UTC | [https://cran.r-project.org/web/packages/pressfreedom.data/DESCRIPTION](https://cran.r-project.org/web/packages/pressfreedom.data/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pressfreedom.data/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9ce76008f62a91` from `cran_packages_by_date` as `registry_expansion`
