...
<!-- canonical: https://github.com/bytecodealliance/wasm-micro-runtime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) |
| Source record ids | awesome_list-0498b6e0586d88 |

## System Engineer Summary

wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint is
tracked as an interpreter runtime record in the WebAssembly branch. The source did not provide a
...
For a systems engineer, wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing
on small footprint belongs in the WebAssembly inventory as part of runtime behavior, deployment
...
- `awesome_list-0498b6e0586d88` from `awesome_list` as `registry_expansion`
