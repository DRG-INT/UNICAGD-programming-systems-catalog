...
<!-- canonical: https://hackage.haskell.org/package/cpsa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cpsa](https://hackage.haskell.org/package/cpsa) |
| Source record ids | hackage_top_downloads-5098301a7ef568 |
...
For a systems engineer, cpsa belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.9 | 2026-05-24T16:08:07Z | [https://hackage.haskell.org/package/cpsa](https://hackage.haskell.org/package/cpsa) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cpsa` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-5098301a7ef568` from `hackage_top_downloads` as `registry_expansion`
