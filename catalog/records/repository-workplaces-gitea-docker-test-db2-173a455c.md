...
<!-- canonical: https://gitea.com/docker_test/db2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/docker_test/db2](https://gitea.com/docker_test/db2) |
| Source record ids | gitea_repositories_api-3e330316d94bac |

## System Engineer Summary

Gitea: docker_test/db2 is tracked as a testing framework record in the Repository Workplaces branch.
...
For a systems engineer, Gitea: docker_test/db2 belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-09-27T06:38:22Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-01 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "database", "retrieved": "2026-09-01", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-3e330316d94bac` from `gitea_repositories_api` as `registry_expansion`
