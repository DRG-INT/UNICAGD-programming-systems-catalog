...
<!-- canonical: https://github.com/armadsen/ORSSerialPort -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/armadsen/ORSSerialPort](https://github.com/armadsen/ORSSerialPort) |
| Source record ids | github_search_cocoa-765c2aca1b3a12 |
...
For a systems engineer, armadsen/ORSSerialPort belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-03T14:19:49Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-765c2aca1b3a12` from `github_search_cocoa` as `registry_expansion`
