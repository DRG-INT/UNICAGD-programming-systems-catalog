...
<!-- canonical: https://github.com/Healthcare-Robotics/assistive-gym -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Healthcare-Robotics/assistive-gym](https://github.com/Healthcare-Robotics/assistive-gym) |
| Source record ids | github_search_physics_engines-9c4534d4e8f7d1 |

## System Engineer Summary

Assistive Gym, a physics-based simulation framework for physical human-robot interaction and robotic
assistance.

## Operational Role

For a systems engineer, Healthcare-Robotics/assistive-gym belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-26T08:40:16Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-9c4534d4e8f7d1` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| unitaryfoundation/qrack | Framework | [open](physics-engines-unitaryfoundation-qrack-537006d0.md) |
