...
<!-- canonical: https://github.com/jdc-pub/SPICEBodies.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jdc-pub/SPICEBodies.jl](https://github.com/jdc-pub/SPICEBodies.jl) |
| Source record ids | github_search_space_maps-d9b9fc728fa350 |
...
For a systems engineer, jdc-pub/SPICEBodies.jl belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-09T15:15:00Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d9b9fc728fa350` from `github_search_space_maps` as `registry_expansion`
