...
| Source record ids | github_search_electromagnetoscopes-d2875e0dabf9fc |
...
For a systems engineer, pbkhrv/rtl_433-hass-addons belongs in the Electromagnetoscopes inventory as
...
- `github_search_electromagnetoscopes-d2875e0dabf9fc` from `github_search_electromagnetoscopes` as `registry_expansion`
