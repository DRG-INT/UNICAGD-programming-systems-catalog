...
<!-- canonical: https://www.npmjs.com/package/@socketsecurity/cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@socketsecurity/cli](https://www.npmjs.com/package/@socketsecurity/cli) |
| Source record ids | npm_registry-f6b5b72e1e1efc |

## System Engineer Summary

@socketsecurity/cli is tracked as a security sast record in the Node.js/JavaScript branch. The
...
For a systems engineer, @socketsecurity/cli belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.163 | 2026-09-01T06:12:19.930Z | [https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-f6b5b72e1e1efc` from `npm_registry` as `registry_expansion`
