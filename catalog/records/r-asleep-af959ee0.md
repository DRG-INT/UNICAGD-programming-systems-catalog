...
<!-- canonical: https://cran.r-project.org/web/packages/asleep/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/asleep/index.html](https://cran.r-project.org/web/packages/asleep/index.html) |
| Source record ids | cran_packages_by_date-34c945f56ab99d |

## System Engineer Summary

Estimate Sleep from 'Accelerometry' Data

## Operational Role

For a systems engineer, asleep belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21 05:45:23 UTC | [https://cran.r-project.org/web/packages/asleep/DESCRIPTION](https://cran.r-project.org/web/packages/asleep/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/asleep/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-34c945f56ab99d` from `cran_packages_by_date` as `registry_expansion`
