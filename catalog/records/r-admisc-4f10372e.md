...
<!-- canonical: https://cran.r-project.org/web/packages/admisc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/admisc/index.html](https://cran.r-project.org/web/packages/admisc/index.html) |
| Source record ids | cran_packages_by_date-3c59722edee5f1 |
...
For a systems engineer, admisc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.41 | 2026-08-22 03:50:02 UTC | [https://cran.r-project.org/web/packages/admisc/DESCRIPTION](https://cran.r-project.org/web/packages/admisc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/admisc/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3c59722edee5f1` from `cran_packages_by_date` as `registry_expansion`
