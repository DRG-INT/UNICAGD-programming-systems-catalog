# Gitea: kalkabena/ASCIIlery-game
...
<!-- canonical: https://gitea.com/kalkabena/ASCIIlery-game -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/kalkabena/ASCIIlery-game](https://gitea.com/kalkabena/ASCIIlery-game) |
| Source record ids | gitea_repositories_api-c6a9b132a8074b |
...
For a systems engineer, Gitea: kalkabena/ASCIIlery-game belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-01T09:06:11Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-c6a9b132a8074b` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: vallu/ascii_eng | Game Engine Game Dev | [open](repository-workplaces-gitea-vallu-ascii-eng-13c4106a.md) |
