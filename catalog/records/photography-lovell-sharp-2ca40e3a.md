...
<!-- canonical: https://github.com/lovell/sharp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lovell/sharp](https://github.com/lovell/sharp) |
| Source record ids | github_search_photography-a40aee02e68326 |

## System Engineer Summary

High performance Node.js image processing, the fastest module to resize JPEG, PNG, WebP, AVIF and
TIFF images. Uses the libvips library.

## Operational Role

For a systems engineer, lovell/sharp belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T10:43:41Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a40aee02e68326` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| evanoberholster/imagemeta | Benchmarking | [open](photography-evanoberholster-imagemeta-c9cdf7ac.md) |
