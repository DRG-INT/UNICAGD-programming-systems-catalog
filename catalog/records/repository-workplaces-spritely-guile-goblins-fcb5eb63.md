...
<!-- canonical: https://gitlab.com/spritely/guile-goblins -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/spritely/guile-goblins](https://gitlab.com/spritely/guile-goblins) |
| Source record ids | gitlab_projects_api-23f0b42c9ae860 |

## System Engineer Summary

MOVED TO This is the implementation of , a distributed object programming environment. Goblins
provides an intuitive security model, automatic local transactions for locally synchronous
operations, and an easy to use and efficient asynchronous programming for encapsulated objects which
can live anywhere on the network.

## Operational Role

For a systems engineer, spritely/guile-goblins belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-23f0b42c9ae860` from `gitlab_projects_api` as `registry_expansion`
