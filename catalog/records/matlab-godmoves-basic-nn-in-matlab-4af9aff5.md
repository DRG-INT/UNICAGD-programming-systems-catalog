...
<!-- canonical: https://github.com/godmoves/basic_nn_in_matlab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/godmoves/basic_nn_in_matlab](https://github.com/godmoves/basic_nn_in_matlab) |
| Source record ids | github_search_matlab-7db8d4e87d980f |
...
For a systems engineer, godmoves/basic_nn_in_matlab belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-06T15:30:11Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-7db8d4e87d980f` from `github_search_matlab` as `registry_expansion`
