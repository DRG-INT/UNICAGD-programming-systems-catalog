...
<!-- canonical: https://foicica.com/textadept/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://foicica.com/textadept/](https://foicica.com/textadept/) |
| Source record ids | lua-source-350 |

## System Engineer Summary

Extremely lightweight, customizable, cross-platform editor, written (mostly) in (and scripted by)
Lua.

## Operational Role

For a systems engineer, Textadept belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 350}}` |
...
- `lua-source-350` from `master_json` as `source_list_item`
