...
<!-- canonical: https://crates.io/crates/fs4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fs4](https://crates.io/crates/fs4) |
| Source record ids | crates_io-72b0ccd2ab7b99 |

## System Engineer Summary

No libc, pure Rust cross-platform file locks. Original fs2, now supports async and replace libc by
rustix.

## Operational Role

For a systems engineer, fs4 belongs in the Rust inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-04-28T05:30:17.691355Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-72b0ccd2ab7b99` from `crates_io` as `registry_expansion`
