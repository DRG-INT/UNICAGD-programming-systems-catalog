...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/perspective-dev/perspective -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/perspective-dev/perspective](https://github.com/perspective-dev/perspective) |
| Source record ids | github_search_webassembly-61828496482733 |

## System Engineer Summary

A data visualization and analytics component, especially well-suited for large and/or streaming
datasets.

## Operational Role

For a systems engineer, perspective-dev/perspective belongs in the WebAssembly inventory as part of
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_webassembly-61828496482733` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| plotters-rs/plotters | Datetime | [open](webassembly-plotters-rs-plotters-3cdf5bbe.md) |
