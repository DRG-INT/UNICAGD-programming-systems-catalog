...
<!-- canonical: https://cran.r-project.org/web/packages/bigbang/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bigbang/index.html](https://cran.r-project.org/web/packages/bigbang/index.html) |
| Source record ids | cran_packages_by_date-2a21aacf2d3279 |
...
For a systems engineer, bigbang belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-19 18:00:02 UTC | [https://cran.r-project.org/web/packages/bigbang/DESCRIPTION](https://cran.r-project.org/web/packages/bigbang/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bigbang/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2a21aacf2d3279` from `cran_packages_by_date` as `registry_expansion`
