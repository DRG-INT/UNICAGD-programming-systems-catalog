...
<!-- canonical: https://hackage.haskell.org/package/primitive-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/primitive-extras](https://hackage.haskell.org/package/primitive-extras) |
| Source record ids | hackage_top_downloads-b967728cca413b |
...
For a systems engineer, primitive-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2.2 | 2025-02-13T10:12:11Z | [https://hackage.haskell.org/package/primitive-extras](https://hackage.haskell.org/package/primitive-extras) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/primitive-extras` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-b967728cca413b` from `hackage_top_downloads` as `registry_expansion`
