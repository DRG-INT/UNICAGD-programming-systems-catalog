...
<!-- canonical: https://crates.io/crates/errno -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/errno](https://crates.io/crates/errno) |
| Source record ids | crates_io-56999d76bbae54 |
...
For a systems engineer, errno belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.14 | 2025-09-09T04:35:15.362504Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-56999d76bbae54` from `crates_io` as `registry_expansion`
