...
<!-- canonical: https://crates.io/crates/ghash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ghash](https://crates.io/crates/ghash) |
| Source record ids | crates_io-0b5a9f50791ed7 |

## System Engineer Summary

Universal hash over GF(2^128) useful for constructing a Message Authentication Code (MAC), as in the
AES-GCM authenticated encryption cipher.

## Operational Role

For a systems engineer, ghash belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-02-28T19:17:45.938113Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; {"key": "", "name": "", "url": ""}; zlib License; https://api.github.com/licenses/zlib |
...
- `crates_io-0b5a9f50791ed7` from `crates_io` as `registry_expansion`
