...
<!-- canonical: https://pypi.org/project/adafruit-circuitpython-httpserver/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adafruit-circuitpython-httpserver/](https://pypi.org/project/adafruit-circuitpython-httpserver/) |
| Source record ids | pypi_simple-d1f908e6ec8cd2 |
...
For a systems engineer, adafruit-circuitpython-httpserver belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.2 | 2026-04-23T21:21:07.821502Z | [https://pypi.org/pypi/adafruit-circuitpython-httpserver/json](https://pypi.org/pypi/adafruit-circuitpython-httpserver/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adafruit-circuitpython-httpserver/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-d1f908e6ec8cd2` from `pypi_simple` as `registry_expansion`
