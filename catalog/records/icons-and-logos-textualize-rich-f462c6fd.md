...
<!-- canonical: https://github.com/Textualize/rich -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Textualize/rich](https://github.com/Textualize/rich) |
| Source record ids | github_search_icons_and_logos-4866b44d7b3fa6 |
...
For a systems engineer, Textualize/rich belongs in the Icons and Logos inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-23T03:10:19Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-4866b44d7b3fa6` from `github_search_icons_and_logos` as `registry_expansion`
