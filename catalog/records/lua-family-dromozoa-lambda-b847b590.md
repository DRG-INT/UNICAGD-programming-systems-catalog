...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-lambda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-lambda](https://luarocks.org/modules/moyu/dromozoa-lambda) |
| Source record ids | luarocks_root_manifest-4ce693491f90ac |
...
For a systems engineer, dromozoa-lambda belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4ce693491f90ac` from `luarocks_root_manifest` as `registry_expansion`
