...
<!-- canonical: https://www.npmjs.com/package/hexo-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/hexo-server](https://www.npmjs.com/package/hexo-server) |
| Source record ids | npm_registry-52e39fa5e62721 |

## System Engineer Summary

hexo-server is tracked as a web framework record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, hexo-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2022-01-03T05:07:25.018Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-52e39fa5e62721` from `npm_registry` as `registry_expansion`
