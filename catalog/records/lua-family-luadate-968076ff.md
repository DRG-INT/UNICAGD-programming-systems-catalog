...
<!-- canonical: https://github.com/Tieske/date -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tieske/date](https://github.com/Tieske/date) |
| Source record ids | lua-source-221 |

## System Engineer Summary

Date and time module with parsing, formatting, addition/subtraction, localization, and ISO 8601
support.

## Operational Role

For a systems engineer, LuaDate belongs in the Lua family inventory as part of low-noise code
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 221}}` |
...
- `lua-source-221` from `master_json` as `source_list_item`
