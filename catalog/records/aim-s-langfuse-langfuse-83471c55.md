...
<!-- canonical: https://github.com/langfuse/langfuse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/langfuse/langfuse](https://github.com/langfuse/langfuse) |
| Source record ids | github_search_aims-4caaabd7e9059e |

## System Engineer Summary

🪢 Open source AI engineering platform: LLM evals, observability, metrics, prompt management,
playground, datasets. Integrates with OpenTelemetry, LangChain, OpenAI SDK, LiteLLM, and more. 🍊YC
W23

## Operational Role

For a systems engineer, langfuse/langfuse belongs in the "aim's" inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T18:16:38Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-4caaabd7e9059e` from `github_search_aims` as `registry_expansion`
