...
<!-- canonical: https://cran.r-project.org/web/packages/NSC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NSC/index.html](https://cran.r-project.org/web/packages/NSC/index.html) |
| Source record ids | cran_packages_by_date-72aaa054115210 |

## System Engineer Summary

Format Student Data for the National Student Clearinghouse

## Operational Role

For a systems engineer, NSC belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.8 | 2026-09-15 12:00:18 UTC | [https://cran.r-project.org/web/packages/NSC/DESCRIPTION](https://cran.r-project.org/web/packages/NSC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NSC/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-72aaa054115210` from `cran_packages_by_date` as `registry_expansion`
