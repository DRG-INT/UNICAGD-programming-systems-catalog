...
<!-- canonical: https://crates.io/crates/const_format -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/const_format](https://crates.io/crates/const_format) |
| Source record ids | crates_io-a1ef239cfab91c |
...
For a systems engineer, const_format belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.36 | 2026-04-17T06:16:19.071058Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-a1ef239cfab91c` from `crates_io` as `registry_expansion`
