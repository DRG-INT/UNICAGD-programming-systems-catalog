...
<!-- canonical: https://cran.r-project.org/web/packages/lgspline/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lgspline/index.html](https://cran.r-project.org/web/packages/lgspline/index.html) |
| Source record ids | cran_packages_by_date-5fa268a548fbeb |
...
For a systems engineer, lgspline belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-04 20:30:02 UTC | [https://cran.r-project.org/web/packages/lgspline/DESCRIPTION](https://cran.r-project.org/web/packages/lgspline/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lgspline/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5fa268a548fbeb` from `cran_packages_by_date` as `registry_expansion`
