...
<!-- canonical: https://github.com/postgres/postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/postgres/postgres](https://github.com/postgres/postgres) |
| Source record ids | curated_database_systems-f603dbb9599812 |

## System Engineer Summary

Relational database system with SQL, extensions, replication, logical decoding, and operational
tooling.

## Operational Role

For a systems engineer, PostgreSQL belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-f603dbb9599812` from `curated_database_systems` as `registry_expansion`
