...
| Canonical URL | [https://luarocks.org/modules/jessieh/ezenv](https://luarocks.org/modules/jessieh/ezenv) |
| Source record ids | luarocks_root_manifest-86599789a80700 |

## System Engineer Summary

Easily load config values from environment variables.

## Operational Role

For a systems engineer, ezenv belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-86599789a80700` from `luarocks_root_manifest` as `registry_expansion`
