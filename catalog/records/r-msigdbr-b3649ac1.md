...
<!-- canonical: https://cran.r-project.org/web/packages/msigdbr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/msigdbr/index.html](https://cran.r-project.org/web/packages/msigdbr/index.html) |
| Source record ids | cran_packages_by_date-8a023253e92b95 |
...
For a systems engineer, msigdbr belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.1.1 | 2026-08-20 05:21:05 UTC | [https://cran.r-project.org/web/packages/msigdbr/DESCRIPTION](https://cran.r-project.org/web/packages/msigdbr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/msigdbr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8a023253e92b95` from `cran_packages_by_date` as `registry_expansion`
