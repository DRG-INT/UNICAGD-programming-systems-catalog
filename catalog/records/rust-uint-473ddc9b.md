...
<!-- canonical: https://crates.io/crates/uint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/uint](https://crates.io/crates/uint) |
| Source record ids | crates_io-050c154251ca61 |
...
For a systems engineer, uint belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2026-08-08T15:16:15.201900Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-050c154251ca61` from `crates_io` as `registry_expansion`
