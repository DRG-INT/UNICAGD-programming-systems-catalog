...
<!-- canonical: https://cran.r-project.org/web/packages/openxlsx2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/openxlsx2/index.html](https://cran.r-project.org/web/packages/openxlsx2/index.html) |
| Source record ids | cran_packages_by_date-0744683ef5169c |
...
For a systems engineer, openxlsx2 belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.29 | 2026-08-20 13:20:31 UTC | [https://cran.r-project.org/web/packages/openxlsx2/DESCRIPTION](https://cran.r-project.org/web/packages/openxlsx2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/openxlsx2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0744683ef5169c` from `cran_packages_by_date` as `registry_expansion`
