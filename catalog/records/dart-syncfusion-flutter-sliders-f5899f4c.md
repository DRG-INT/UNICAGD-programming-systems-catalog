...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_sliders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_sliders](https://pub.dev/packages/syncfusion_flutter_sliders) |
| Source record ids | pub_dev-cf517115e7abaf |

## System Engineer Summary

A Flutter Sliders library for creating highly customizable and UI-rich slider, range slider, and
range selector widgets for filtering purposes.

## Operational Role

For a systems engineer, syncfusion_flutter_sliders belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:35:18.044483Z | [https://pub.dev/api/packages/syncfusion_flutter_sliders](https://pub.dev/api/packages/syncfusion_flutter_sliders) |  |
| preview | known | 19.1.69-beta | 2021-06-15T04:09:59.497671Z | [https://pub.dev/api/packages/syncfusion_flutter_sliders](https://pub.dev/api/packages/syncfusion_flutter_sliders) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_sliders` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-cf517115e7abaf` from `pub_dev` as `registry_expansion`
