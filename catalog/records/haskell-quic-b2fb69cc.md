...
<!-- canonical: https://hackage.haskell.org/package/quic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/quic](https://hackage.haskell.org/package/quic) |
| Source record ids | hackage_top_downloads-328bdc6203e4e8 |
...
For a systems engineer, quic belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-10T09:27:47Z | [https://hackage.haskell.org/package/quic](https://hackage.haskell.org/package/quic) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/quic` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-328bdc6203e4e8` from `hackage_top_downloads` as `registry_expansion`
