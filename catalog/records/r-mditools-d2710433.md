...
<!-- canonical: https://cran.r-project.org/web/packages/mditools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mditools/index.html](https://cran.r-project.org/web/packages/mditools/index.html) |
| Source record ids | cran_packages_by_date-417f046279fe25 |
...
For a systems engineer, mditools belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-20 14:50:02 UTC | [https://cran.r-project.org/web/packages/mditools/DESCRIPTION](https://cran.r-project.org/web/packages/mditools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mditools/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-417f046279fe25` from `cran_packages_by_date` as `registry_expansion`
