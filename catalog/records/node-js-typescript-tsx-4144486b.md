...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/TypeScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-typescript.md) · [Category: Interpreter Runtime](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interpreter-runtime.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-2dc7671a8ae2 |

## System Engineer Summary

TypeScript/ESM execution tool

## Operational Role

For a systems engineer, tsx belongs in the Node.js/TypeScript inventory as part of runtime behavior,
...
- `master-2dc7671a8ae2` from `master_json` as `interpreter_runtime`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| @nuxt/typescript-runtime | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-nuxt-typescript-runtime-769438e4.md) |
| arcjet | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-arcjet-fc5a6ba9.md) |
| jiti | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-jiti-ca2d06b1.md) |
| ts-interface-checker | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-ts-interface-checker-c50f15a6.md) |
| ts-node | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-ts-node-18b32a4a.md) |
| tslib | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-tslib-ec418a7b.md) |
