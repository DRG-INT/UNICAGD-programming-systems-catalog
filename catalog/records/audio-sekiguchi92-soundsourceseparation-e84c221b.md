...
<!-- canonical: https://github.com/sekiguchi92/SoundSourceSeparation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sekiguchi92/SoundSourceSeparation](https://github.com/sekiguchi92/SoundSourceSeparation) |
| Source record ids | github_search_audio-aaee334086eb8f |

## System Engineer Summary

The code for multi-channel source separation and dereverberation such as FastMNMF1, FastMNMF2, and
AR-FastMNMF2.

## Operational Role

For a systems engineer, sekiguchi92/SoundSourceSeparation belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-16T15:11:43Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-aaee334086eb8f` from `github_search_audio` as `registry_expansion`
...
| calebzulawski/fourier | Parser Lexer Ast | [open](audio-calebzulawski-fourier-0106a099.md) |
