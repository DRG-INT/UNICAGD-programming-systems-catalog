...
<!-- canonical: https://pypi.org/project/accounting-subject-analysis-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accounting-subject-analysis-mcp-server/](https://pypi.org/project/accounting-subject-analysis-mcp-server/) |
| Source record ids | pypi_simple-25a3fd4d93de7f |
...
For a systems engineer, accounting-subject-analysis-mcp-server belongs in the Python inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-01-22T09:06:45.739361Z | [https://pypi.org/pypi/accounting-subject-analysis-mcp-server/json](https://pypi.org/pypi/accounting-subject-analysis-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accounting-subject-analysis-mcp-server/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-25a3fd4d93de7f` from `pypi_simple` as `registry_expansion`
