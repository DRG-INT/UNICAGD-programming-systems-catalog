...
| Canonical URL | [https://crates.io/crates/as-slice](https://crates.io/crates/as-slice) |
| Source record ids | crates_io-99c52e265f310a |
...
For a systems engineer, as-slice belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2021-03-25T15:44:11.216011Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-99c52e265f310a` from `crates_io` as `registry_expansion`
