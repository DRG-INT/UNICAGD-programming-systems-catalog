...
| Canonical URL | [https://github.com/jorgepiloto/lamberthub](https://github.com/jorgepiloto/lamberthub) |
| Source record ids | github_search_space_engines-1959add08a9221 |
...
For a systems engineer, jorgepiloto/lamberthub belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2024-09-16T10:35:08Z | [https://api.github.com/repos/jorgepiloto/lamberthub/releases/latest](https://api.github.com/repos/jorgepiloto/lamberthub/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jorgepiloto/lamberthub/releases/latest` at `2026-09-01T07:24:18+00:00`.
...
- `github_search_space_engines-1959add08a9221` from `github_search_space_engines` as `registry_expansion`
