...
<!-- canonical: https://cran.r-project.org/web/packages/CNVScope/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CNVScope/index.html](https://cran.r-project.org/web/packages/CNVScope/index.html) |
| Source record ids | cran_packages_by_date-ed3ac1a88f0d19 |
...
For a systems engineer, CNVScope belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.7 | 2026-09-10 19:10:02 UTC | [https://cran.r-project.org/web/packages/CNVScope/DESCRIPTION](https://cran.r-project.org/web/packages/CNVScope/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CNVScope/DESCRIPTION` at `2026-09-10T20:18:42+00:00`.
...
- `cran_packages_by_date-ed3ac1a88f0d19` from `cran_packages_by_date` as `registry_expansion`
