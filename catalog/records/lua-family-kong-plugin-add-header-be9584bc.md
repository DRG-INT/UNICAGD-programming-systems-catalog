...
| Canonical URL | [https://luarocks.org/modules/emartech/kong-plugin-add-header](https://luarocks.org/modules/emartech/kong-plugin-add-header) |
| Source record ids | luarocks_root_manifest-d6e4b525790d46 |

## System Engineer Summary

Header setter for Kong API gateway plugins. - DEPRECATED - TO BE REMOVED

## Operational Role

For a systems engineer, kong-plugin-add-header belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-d6e4b525790d46` from `luarocks_root_manifest` as `registry_expansion`
