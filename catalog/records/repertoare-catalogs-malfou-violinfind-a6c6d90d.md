...
<!-- canonical: https://github.com/Malfou/Violinfind -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Malfou/Violinfind](https://github.com/Malfou/Violinfind) |
| Source record ids | github_search_repertoare_catalogs-b816224fd3c7a9 |

## System Engineer Summary

ViolinFind 🎻 is an easy-to-use tool for finding violin recordings fast. Search any piece, explore
RCM Levels 1–10, browse repertoire and études, save favorites, and discover performances—all in one
place. Perfect for practicing, learning new pieces, and preparing for RCM exams!

## Operational Role

For a systems engineer, Malfou/Violinfind belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:49:02Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-b816224fd3c7a9` from `github_search_repertoare_catalogs` as `registry_expansion`
