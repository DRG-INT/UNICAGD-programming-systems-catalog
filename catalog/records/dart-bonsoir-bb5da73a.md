...
<!-- canonical: https://pub.dev/packages/bonsoir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/bonsoir](https://pub.dev/packages/bonsoir) |
| Source record ids | pub_dev-4cdeaaa2ce2d11 |

## System Engineer Summary

A Zeroconf library that allows you to discover network services and to broadcast your own. Based on
Apple Bonjour and Android NSD.

## Operational Role

For a systems engineer, bonsoir belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.5 | 2026-08-11T22:26:28.487293Z | [https://pub.dev/api/packages/bonsoir](https://pub.dev/api/packages/bonsoir) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/bonsoir` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-4cdeaaa2ce2d11` from `pub_dev` as `registry_expansion`
