...
<!-- canonical: https://packagist.org/packages/sentry/sentry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sentry/sentry](https://packagist.org/packages/sentry/sentry) |
| Source record ids | packagist_search-058c4b07532687 |

## System Engineer Summary

sentry/sentry is tracked as a networking http record in the PHP branch. The source did not provide a
...
For a systems engineer, sentry/sentry belongs in the PHP inventory as part of service communication,
...
- `packagist_search-058c4b07532687` from `packagist_search` as `registry_expansion`
