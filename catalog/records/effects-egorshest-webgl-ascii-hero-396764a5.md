...
<!-- canonical: https://github.com/egorshest/webgl-ascii-hero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/egorshest/webgl-ascii-hero](https://github.com/egorshest/webgl-ascii-hero) |
| Source record ids | github_search_effects-2a6b99a595e657 |

## System Engineer Summary

Next.js boilerplate with a cool hero block 3d Ascii Animation. 3D GLTF model rendered with React
Three Fiber, post-processed into ASCII art using custom GLSL shaders.

## Operational Role

For a systems engineer, egorshest/webgl-ascii-hero belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-27T13:12:09Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2a6b99a595e657` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alexirae/unreal-audio-dsp-template-UE5 | Project Scaffolding | [open](effects-alexirae-unreal-audio-dsp-template-ue5-e7b9e84d.md) |
