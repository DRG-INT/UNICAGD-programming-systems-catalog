...
<!-- canonical: https://cran.r-project.org/web/packages/mnirs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mnirs/index.html](https://cran.r-project.org/web/packages/mnirs/index.html) |
| Source record ids | cran_packages_by_date-5f973a7f6e8ff0 |
...
For a systems engineer, mnirs belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-09-13 00:00:02 UTC | [https://cran.r-project.org/web/packages/mnirs/DESCRIPTION](https://cran.r-project.org/web/packages/mnirs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mnirs/DESCRIPTION` at `2026-09-13T00:27:51+00:00`.
...
- `cran_packages_by_date-5f973a7f6e8ff0` from `cran_packages_by_date` as `registry_expansion`
