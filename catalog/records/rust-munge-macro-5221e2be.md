...
| Canonical URL | [https://crates.io/crates/munge_macro](https://crates.io/crates/munge_macro) |
| Source record ids | crates_io-eb8add7c232ddd |
...
For a systems engineer, munge_macro belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.7 | 2025-09-29T14:59:27.961746Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-eb8add7c232ddd` from `crates_io` as `registry_expansion`
