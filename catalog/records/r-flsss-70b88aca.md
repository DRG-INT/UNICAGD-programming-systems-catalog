...
<!-- canonical: https://cran.r-project.org/web/packages/FLSSS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FLSSS/index.html](https://cran.r-project.org/web/packages/FLSSS/index.html) |
| Source record ids | cran_packages_by_date-c4d958df5afca9 |
...
For a systems engineer, FLSSS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.3.0 | 2026-08-29 10:30:02 UTC | [https://cran.r-project.org/web/packages/FLSSS/DESCRIPTION](https://cran.r-project.org/web/packages/FLSSS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FLSSS/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c4d958df5afca9` from `cran_packages_by_date` as `registry_expansion`
