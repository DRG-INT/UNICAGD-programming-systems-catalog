...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-d811546864e5a2 |

## System Engineer Summary

Astrodynamics simulation framework with spacecraft dynamics, messaging, visualization, and GN&C
workflows.

## Operational Role

For a systems engineer, Basilisk belongs in the Space Engines inventory as part of ecosystem
...
- `curated_language_routes-d811546864e5a2` from `curated_language_routes` as `registry_expansion`
