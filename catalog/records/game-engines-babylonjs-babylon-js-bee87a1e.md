...
<!-- canonical: https://github.com/BabylonJS/Babylon.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BabylonJS/Babylon.js](https://github.com/BabylonJS/Babylon.js) |
| Source record ids | github_search_game_engines-276603dc1b71e6 |

## System Engineer Summary

Babylon.js is a powerful, beautiful, simple, and open game and rendering engine packed into a
friendly JavaScript framework.

## Operational Role

For a systems engineer, BabylonJS/Babylon.js belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:45:04Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-276603dc1b71e6` from `github_search_game_engines` as `registry_expansion`
