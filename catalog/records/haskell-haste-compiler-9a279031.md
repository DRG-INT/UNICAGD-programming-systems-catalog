...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/haste-compiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/haste-compiler](https://hackage.haskell.org/package/haste-compiler) |
| Source record ids | hackage_top_downloads-79ba8acb8d4b1e |
...
For a systems engineer, haste-compiler belongs in the Haskell inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2017-09-08T15:28:40Z | [https://hackage.haskell.org/package/haste-compiler](https://hackage.haskell.org/package/haste-compiler) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haste-compiler` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-79ba8acb8d4b1e` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crucible-llvm | Compiler | [open](haskell-crucible-llvm-efdef801.md) |
| crux-llvm | Compiler | [open](haskell-crux-llvm-491a04aa.md) |
| llvm | Compiler | [open](haskell-llvm-0ada120e.md) |
| llvm-extra | Compiler | [open](haskell-llvm-extra-04a2c8df.md) |
| llvm-ffi | Compiler | [open](haskell-llvm-ffi-67c78302.md) |
| llvm-general | Compiler | [open](haskell-llvm-general-3fe39286.md) |
| llvm-general-pure | Compiler | [open](haskell-llvm-general-pure-1186d5e4.md) |
| llvm-hs | Compiler | [open](haskell-llvm-hs-29f904c8.md) |
