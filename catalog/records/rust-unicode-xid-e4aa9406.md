...
<!-- canonical: https://crates.io/crates/unicode-xid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-xid](https://crates.io/crates/unicode-xid) |
| Source record ids | crates_io-de36fb5f2a7918 |
...
For a systems engineer, unicode-xid belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2024-09-19T15:55:24.420864Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-de36fb5f2a7918` from `crates_io` as `registry_expansion`
