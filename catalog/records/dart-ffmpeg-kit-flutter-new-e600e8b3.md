...
<!-- canonical: https://pub.dev/packages/ffmpeg_kit_flutter_new -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ffmpeg_kit_flutter_new](https://pub.dev/packages/ffmpeg_kit_flutter_new) |
| Source record ids | pub_dev-17a09c72abbe64 |

## System Engineer Summary

FFmpeg Kit for Flutter with Full GPL and updated bindings. Supports Android, iOS, macOS and Windows
platforms.

## Operational Role

For a systems engineer, ffmpeg_kit_flutter_new belongs in the Dart inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.6.2 | 2026-07-30T13:23:19.770535Z | [https://pub.dev/api/packages/ffmpeg_kit_flutter_new](https://pub.dev/api/packages/ffmpeg_kit_flutter_new) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ffmpeg_kit_flutter_new` at `2026-09-02T00:28:54+00:00`.
...
- `pub_dev-17a09c72abbe64` from `pub_dev` as `registry_expansion`
