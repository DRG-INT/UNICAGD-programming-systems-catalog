...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GalSim-developers/GalSim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GalSim-developers/GalSim](https://github.com/GalSim-developers/GalSim) |
| Source record ids | github_search_space_maps-43e7bedc0e5de5 |
...
For a systems engineer, GalSim-developers/GalSim belongs in the Space Maps inventory as part of
operator onboarding, API understanding, and upgrade review.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T03:03:20Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-43e7bedc0e5de5` from `github_search_space_maps` as `registry_expansion`
