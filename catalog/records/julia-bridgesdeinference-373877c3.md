...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Interop Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interop-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BridgeSDEInference](https://github.com/JuliaRegistries/General/tree/master/B/BridgeSDEInference) |
| Source record ids | julia_general-327aae4f3e45c7 |

## System Engineer Summary

Julia package registered in General at B/BridgeSDEInference.

## Operational Role

For a systems engineer, BridgeSDEInference belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| algoimWrapper_jll | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-algoimwrapper-jll-d678cba7.md) |
| AlphaMolWrapper_jll | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-alphamolwrapper-jll-ada8dda8.md) |
| ArtifactWrappers | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-artifactwrappers-676bec18.md) |
| BinaryWrappers | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-binarywrappers-4888997d.md) |
| Bridge | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bridge-cd287a8f.md) |
| BridgeDiffEq | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bridgediffeq-2b236a13.md) |
| BridgeLandmarks | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bridgelandmarks-fea4f912.md) |
| BridgeStan | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bridgestan-7577fb13.md) |
