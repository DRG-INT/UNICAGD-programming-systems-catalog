...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AbstractCircuitComponentRounding -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AbstractCircuitComponentRounding", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-b0ba5debf0d0d0` from `julia_general` as `registry_expansion`
