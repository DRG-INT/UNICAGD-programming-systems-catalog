...
<!-- canonical: https://pub.dev/packages/barcode_scan2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/barcode_scan2](https://pub.dev/packages/barcode_scan2) |
| Source record ids | pub_dev-834ce9bbc5f0fd |
...
For a systems engineer, barcode_scan2 belongs in the Dart inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-08-13T02:21:15.413108Z | [https://pub.dev/api/packages/barcode_scan2](https://pub.dev/api/packages/barcode_scan2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/barcode_scan2` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-834ce9bbc5f0fd` from `pub_dev` as `registry_expansion`
