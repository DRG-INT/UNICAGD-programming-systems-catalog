...
<!-- canonical: https://github.com/makalin/skypin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makalin/skypin](https://github.com/makalin/skypin) |
| Source record ids | github_search_space_maps-7fc0f0b04744c3 |

## System Engineer Summary

SkyPin reads sun position & shadows in a photo, flips Skyfield astronomy equations and spits out a
world heat-map of where the snap was taken—accuracy a few hundred km, enough to confirm or debunk a
claimed location.

## Operational Role

For a systems engineer, makalin/skypin belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-06T15:02:00Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-7fc0f0b04744c3` from `github_search_space_maps` as `registry_expansion`
