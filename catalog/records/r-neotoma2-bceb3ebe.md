...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/neotoma2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/neotoma2/index.html](https://cran.r-project.org/web/packages/neotoma2/index.html) |
| Source record ids | cran_packages_by_date-4a321d9a1748aa |
...
For a systems engineer, neotoma2 belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-15 01:00:02 UTC | [https://cran.r-project.org/web/packages/neotoma2/DESCRIPTION](https://cran.r-project.org/web/packages/neotoma2/DESCRIPTION) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; Other |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/neotoma2/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-4a321d9a1748aa` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adbcdrivermanager | Database Datastore | [open](r-adbcdrivermanager-43c75ca4.md) |
| adbcsqlite | Database Datastore | [open](r-adbcsqlite-e4ff39e1.md) |
| autodb | Database Datastore | [open](r-autodb-5e6d39a0.md) |
| awdb | Database Datastore | [open](r-awdb-7e4076b0.md) |
| DBmaps | Database Datastore | [open](r-dbmaps-09f1ce62.md) |
| EWAScaller | Database Datastore | [open](r-ewascaller-60601916.md) |
| faunabr | Database Datastore | [open](r-faunabr-1deb8fbf.md) |
| finlex | Database Datastore | [open](r-finlex-1c0ce3f7.md) |
