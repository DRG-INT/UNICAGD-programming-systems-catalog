...
<!-- canonical: https://cran.r-project.org/web/packages/acro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/acro/index.html](https://cran.r-project.org/web/packages/acro/index.html) |
| Source record ids | cran_packages_by_date-be901cf4384a2b |
...
For a systems engineer, acro belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-09 07:30:16 UTC | [https://cran.r-project.org/web/packages/acro/DESCRIPTION](https://cran.r-project.org/web/packages/acro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/acro/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-be901cf4384a2b` from `cran_packages_by_date` as `registry_expansion`
