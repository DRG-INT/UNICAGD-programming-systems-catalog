...
<!-- canonical: https://github.com/numberwolf/FFmpeg-PlusPlus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/numberwolf/FFmpeg-PlusPlus](https://github.com/numberwolf/FFmpeg-PlusPlus) |
| Source record ids | github_search_effects-58b4b67f14b03b |

## System Engineer Summary

🔥 FFmpeg扩展版本，1.支持OpenGL图形渲染,自定义着色器 滤镜、特效、转场。2.支持FLV+HEVC/AV1/Opus编码解码 🔥 FFmpeg Extension: 1.Support
GLSL OpenGL(Filter/Effect/Transition/Shaders); 2. And Transcode FLV with HEVC/AV1/Opus Codec

## Operational Role

For a systems engineer, numberwolf/FFmpeg-PlusPlus belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-11T05:58:57Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-58b4b67f14b03b` from `github_search_effects` as `registry_expansion`
