...
| Canonical URL | [http://leafo.net/lapis/](http://leafo.net/lapis/) |
| Source record ids | lua-source-168 |
...
For a systems engineer, Lapis belongs in the Lua family inventory as part of service communication,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 168}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-168` from `master_json` as `source_list_item`
...
| Learning Lua from JS | Networking Http | [open](lua-family-learning-lua-from-js-a97195df.md) |
