# Arystos/Advanced-Outline-Shader-UE5
...
<!-- canonical: https://github.com/Arystos/Advanced-Outline-Shader-UE5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Arystos/Advanced-Outline-Shader-UE5](https://github.com/Arystos/Advanced-Outline-Shader-UE5) |
| Source record ids | github_search_effects-a65fdabf303ac7 |

## System Engineer Summary

Advanced outline / edge-detection post-process shader built in Unreal Engine 5 with custom HLSL
materials. Full write-up on aristidesessa.com.

## Operational Role

For a systems engineer, Arystos/Advanced-Outline-Shader-UE5 belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-12T13:43:19Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a65fdabf303ac7` from `github_search_effects` as `registry_expansion`
