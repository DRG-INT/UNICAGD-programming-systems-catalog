...
| Canonical URL | [https://github.com/pytorch/pytorch](https://github.com/pytorch/pytorch) |
| Source record ids | curated_language_routes-bc5c83759b85ed |

## System Engineer Summary

Tensor, autograd, compiler, distributed, and deployment framework used across AI training and
inference stacks.

## Operational Role

For a systems engineer, PyTorch belongs in the "aim's" inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.13.0 | 2026-07-08T17:39:58Z | [https://api.github.com/repos/pytorch/pytorch/releases/latest](https://api.github.com/repos/pytorch/pytorch/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/pytorch/pytorch/releases/latest` at `2026-09-01T07:24:39+00:00`.
...
- `curated_language_routes-bc5c83759b85ed` from `curated_language_routes` as `registry_expansion`
