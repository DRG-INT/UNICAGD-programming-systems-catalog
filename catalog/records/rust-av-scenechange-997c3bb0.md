...
<!-- canonical: https://crates.io/crates/av-scenechange -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/av-scenechange](https://crates.io/crates/av-scenechange) |
| Source record ids | crates_io-58a4df9199450d |
...
For a systems engineer, av-scenechange belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.1 | 2026-06-22T17:23:47.339782Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other |
