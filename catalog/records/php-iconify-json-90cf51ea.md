...
<!-- canonical: https://packagist.org/packages/iconify/json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/iconify/json](https://packagist.org/packages/iconify/json) |
| Source record ids | packagist_search-42609f53eba458 |
...
For a systems engineer, iconify/json belongs in the PHP inventory as part of low-noise code review,
...
- `packagist_search-42609f53eba458` from `packagist_search` as `registry_expansion`
