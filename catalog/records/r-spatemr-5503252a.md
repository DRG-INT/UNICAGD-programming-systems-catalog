...
<!-- canonical: https://cran.r-project.org/web/packages/spatemR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spatemR/index.html](https://cran.r-project.org/web/packages/spatemR/index.html) |
| Source record ids | cran_packages_by_date-0530298b9ad9dd |
...
For a systems engineer, spatemR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-09-07 15:50:02 UTC | [https://cran.r-project.org/web/packages/spatemR/DESCRIPTION](https://cran.r-project.org/web/packages/spatemR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spatemR/DESCRIPTION` at `2026-09-07T16:20:18+00:00`.
...
- `cran_packages_by_date-0530298b9ad9dd` from `cran_packages_by_date` as `registry_expansion`
