...
| Source record ids | github_search_game_engines-a96fcfda4b1b5d |

## System Engineer Summary

Defold is a completely free to use game engine for development of desktop, console, mobile and web
games.

## Operational Role

For a systems engineer, defold/defold belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:21:30Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-a96fcfda4b1b5d` from `github_search_game_engines` as `registry_expansion`
