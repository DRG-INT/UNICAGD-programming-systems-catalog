...
<!-- canonical: https://cran.r-project.org/web/packages/fitVARMxID/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fitVARMxID/index.html](https://cran.r-project.org/web/packages/fitVARMxID/index.html) |
| Source record ids | cran_packages_by_date-99308681e69c2a |
...
For a systems engineer, fitVARMxID belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2026-09-05 05:10:07 UTC | [https://cran.r-project.org/web/packages/fitVARMxID/DESCRIPTION](https://cran.r-project.org/web/packages/fitVARMxID/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fitVARMxID/DESCRIPTION` at `2026-09-05T06:22:48+00:00`.
...
- `cran_packages_by_date-99308681e69c2a` from `cran_packages_by_date` as `registry_expansion`
