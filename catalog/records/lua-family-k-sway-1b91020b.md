...
| Canonical URL | [https://luarocks.org/modules/ashkankiani/k-sway](https://luarocks.org/modules/ashkankiani/k-sway) |
| Source record ids | luarocks_root_manifest-bda598bd695c64 |

## System Engineer Summary

k-sway is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, k-sway belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-bda598bd695c64` from `luarocks_root_manifest` as `registry_expansion`
