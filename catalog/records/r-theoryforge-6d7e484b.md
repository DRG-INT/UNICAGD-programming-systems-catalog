...
<!-- canonical: https://cran.r-project.org/web/packages/theoryforge/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/theoryforge/index.html](https://cran.r-project.org/web/packages/theoryforge/index.html) |
| Source record ids | cran_packages_by_date-84633e3a332dae |
...
For a systems engineer, theoryforge belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-01 08:30:02 UTC | [https://cran.r-project.org/web/packages/theoryforge/DESCRIPTION](https://cran.r-project.org/web/packages/theoryforge/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/theoryforge/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-84633e3a332dae` from `cran_packages_by_date` as `registry_expansion`
