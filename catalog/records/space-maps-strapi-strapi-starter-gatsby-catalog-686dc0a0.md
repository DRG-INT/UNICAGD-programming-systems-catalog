...
<!-- canonical: https://github.com/strapi/strapi-starter-gatsby-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/strapi/strapi-starter-gatsby-catalog](https://github.com/strapi/strapi-starter-gatsby-catalog) |
| Source record ids | github_search_space_maps-7227b92dc040fa |
...
For a systems engineer, strapi/strapi-starter-gatsby-catalog belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-28T16:02:17Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-7227b92dc040fa` from `github_search_space_maps` as `registry_expansion`
