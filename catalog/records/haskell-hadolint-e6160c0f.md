...
<!-- canonical: https://hackage.haskell.org/package/hadolint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hadolint](https://hackage.haskell.org/package/hadolint) |
| Source record ids | hackage_top_downloads-db6400548951d5 |
...
For a systems engineer, hadolint belongs in the Haskell inventory as part of static feedback, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.1 | 2026-07-31T10:12:56Z | [https://hackage.haskell.org/package/hadolint](https://hackage.haskell.org/package/hadolint) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hadolint` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-db6400548951d5` from `hackage_top_downloads` as `registry_expansion`
