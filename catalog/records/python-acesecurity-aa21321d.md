...
<!-- canonical: https://pypi.org/project/acesecurity/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acesecurity/](https://pypi.org/project/acesecurity/) |
| Source record ids | pypi_simple-0315672e231aef |

## System Engineer Summary

acesecurity is tracked as a security sast record in the Python branch. The source did not provide a
...
For a systems engineer, acesecurity belongs in the Python inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1.1 | 2026-04-13T17:19:12.092614Z | [https://pypi.org/pypi/acesecurity/json](https://pypi.org/pypi/acesecurity/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acesecurity/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-0315672e231aef` from `pypi_simple` as `registry_expansion`
