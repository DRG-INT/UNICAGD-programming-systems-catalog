...
<!-- canonical: https://cran.r-project.org/web/packages/margEVT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/margEVT/index.html](https://cran.r-project.org/web/packages/margEVT/index.html) |
| Source record ids | cran_packages_by_date-554e30f1105ba8 |
...
For a systems engineer, margEVT belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-26 12:00:02 UTC | [https://cran.r-project.org/web/packages/margEVT/DESCRIPTION](https://cran.r-project.org/web/packages/margEVT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/margEVT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-554e30f1105ba8` from `cran_packages_by_date` as `registry_expansion`
