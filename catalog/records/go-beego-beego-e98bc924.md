...
<!-- canonical: https://github.com/beego/beego -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/beego/beego](https://github.com/beego/beego) |
| Source record ids | github_search_go-331262a1bce93c |
...
For a systems engineer, beego/beego belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:21:06Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-331262a1bce93c` from `github_search_go` as `registry_expansion`
