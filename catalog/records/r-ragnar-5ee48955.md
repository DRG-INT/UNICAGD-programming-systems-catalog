...
<!-- canonical: https://cran.r-project.org/web/packages/ragnar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ragnar/index.html](https://cran.r-project.org/web/packages/ragnar/index.html) |
| Source record ids | cran_packages_by_date-74c3a92bb031b6 |
...
For a systems engineer, ragnar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-09-10 17:10:02 UTC | [https://cran.r-project.org/web/packages/ragnar/DESCRIPTION](https://cran.r-project.org/web/packages/ragnar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ragnar/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-74c3a92bb031b6` from `cran_packages_by_date` as `registry_expansion`
