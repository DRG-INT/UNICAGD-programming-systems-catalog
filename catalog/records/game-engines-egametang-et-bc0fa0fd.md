...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/egametang/ET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/egametang/ET](https://github.com/egametang/ET) |
| Source record ids | github_search_game_engines-cb4a0af76ecf0c |
...
For a systems engineer, egametang/ET belongs in the Game Engines inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T13:25:42Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other |
...
- `github_search_game_engines-cb4a0af76ecf0c` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xFA11/MultiplayerNetworkingResources | Networking Http | [open](game-engines-0xfa11-multiplayernetworkingresources-8380de20.md) |
| boardgameio/boardgame.io | Networking Http | [open](game-engines-boardgameio-boardgame-io-84dfc51e.md) |
| g3n/engine | Networking Http | [open](game-engines-g3n-engine-472de869.md) |
| hexops/mach | Networking Http | [open](game-engines-hexops-mach-72d27255.md) |
| spring/spring | Networking Http | [open](game-engines-spring-spring-d8c818c2.md) |
| ValveSoftware/GameNetworkingSockets | Networking Http | [open](game-engines-valvesoftware-gamenetworkingsockets-68bdcb6e.md) |
