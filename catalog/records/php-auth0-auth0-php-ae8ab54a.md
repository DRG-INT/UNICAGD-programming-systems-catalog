...
| Canonical URL | [https://packagist.org/packages/auth0/auth0-php](https://packagist.org/packages/auth0/auth0-php) |
| Source record ids | packagist_search-ab7520e29ee76d |
...
For a systems engineer, auth0/auth0-php belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.0.0 | 2026-08-12T13:26:16+00:00 | [https://repo.packagist.org/p2/auth0/auth0-php.json](https://repo.packagist.org/p2/auth0/auth0-php.json) |  |
| preview | known | 9.0.0-beta.6 | 2026-08-05T10:57:05+00:00 | [https://repo.packagist.org/p2/auth0/auth0-php.json](https://repo.packagist.org/p2/auth0/auth0-php.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/auth0/auth0-php.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-ab7520e29ee76d` from `packagist_search` as `registry_expansion`
