...
| Canonical URL | [https://packagist.org/packages/ergebnis/json-pointer](https://packagist.org/packages/ergebnis/json-pointer) |
| Source record ids | packagist_search-63034f50fba387 |
...
For a systems engineer, ergebnis/json-pointer belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.8.0 | 2026-04-07T14:52:30+00:00 | [https://repo.packagist.org/p2/ergebnis/json-pointer.json](https://repo.packagist.org/p2/ergebnis/json-pointer.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ergebnis/json-pointer.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-63034f50fba387` from `packagist_search` as `registry_expansion`
