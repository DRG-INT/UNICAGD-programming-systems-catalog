...
<!-- canonical: https://cran.r-project.org/web/packages/shinychat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinychat/index.html](https://cran.r-project.org/web/packages/shinychat/index.html) |
| Source record ids | cran_packages_by_date-fdfe0de465af55 |
...
For a systems engineer, shinychat belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-09 18:50:02 UTC | [https://cran.r-project.org/web/packages/shinychat/DESCRIPTION](https://cran.r-project.org/web/packages/shinychat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinychat/DESCRIPTION` at `2026-09-09T20:20:33+00:00`.
...
- `cran_packages_by_date-fdfe0de465af55` from `cran_packages_by_date` as `registry_expansion`
