...
<!-- canonical: https://github.com/krkrz/krkrz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krkrz/krkrz](https://github.com/krkrz/krkrz) |
| Source record ids | github_search_engines-453eb1f08dbcfa |

## System Engineer Summary

krkrz/krkrz is tracked as a game engine game dev record in the Engines branch. The source did not
...
For a systems engineer, krkrz/krkrz belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-24T04:27:17Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-453eb1f08dbcfa` from `github_search_engines` as `registry_expansion`
