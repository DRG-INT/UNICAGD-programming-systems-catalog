...
<!-- canonical: https://cran.r-project.org/web/packages/featR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/featR/index.html](https://cran.r-project.org/web/packages/featR/index.html) |
| Source record ids | cran_packages_by_date-34a10a957d9ccc |
...
For a systems engineer, featR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-14 15:40:02 UTC | [https://cran.r-project.org/web/packages/featR/DESCRIPTION](https://cran.r-project.org/web/packages/featR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/featR/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-34a10a957d9ccc` from `cran_packages_by_date` as `registry_expansion`
