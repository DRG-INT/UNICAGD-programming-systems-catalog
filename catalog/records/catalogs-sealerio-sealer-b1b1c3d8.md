...
<!-- canonical: https://github.com/sealerio/sealer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sealerio/sealer](https://github.com/sealerio/sealer) |
| Source record ids | github_search_catalogs-ac226802a748ef |
...
For a systems engineer, sealerio/sealer belongs in the Catalogs inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-03T08:29:24Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ac226802a748ef` from `github_search_catalogs` as `registry_expansion`
