...
<!-- canonical: https://pub.dev/packages/saver_gallery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/saver_gallery](https://pub.dev/packages/saver_gallery) |
| Source record ids | pub_dev-271e288b8dcde4 |
...
For a systems engineer, saver_gallery belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.0 | 2026-05-29T08:05:20.881418Z | [https://pub.dev/api/packages/saver_gallery](https://pub.dev/api/packages/saver_gallery) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/saver_gallery` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-271e288b8dcde4` from `pub_dev` as `registry_expansion`
