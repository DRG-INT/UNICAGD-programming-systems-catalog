...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: APIs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/apis.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://spec.openapis.org/oas/latest.html](https://spec.openapis.org/oas/latest.html) |
| Source record ids | curated_language_routes-f152def579cd2a |

## System Engineer Summary

Official OpenAPI Specification for describing HTTP APIs, operations, schemas, parameters, responses,
security, and documents.

## Operational Role

For a systems engineer, OpenAPI Specification belongs in the APIs inventory as part of ecosystem
...
- `curated_language_routes-f152def579cd2a` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AsyncAPI Specification | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-asyncapi-specification-946c83c1.md) |
| GraphQL Specification | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-graphql-specification-e49d6697.md) |
| JSON Schema | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-json-schema-3079472a.md) |
