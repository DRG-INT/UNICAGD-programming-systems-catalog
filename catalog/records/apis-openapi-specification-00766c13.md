...
[Catalog index](../index.md) · [Language: APIs](../by-language/apis.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://spec.openapis.org/oas/latest.html -->
<!-- crawl-delay: 10 -->
...
| Name | Category | Page |
| --- | --- | --- |
| AsyncAPI Specification | Language Specification | [open](apis-asyncapi-specification-946c83c1.md) |
| GraphQL Specification | Language Specification | [open](apis-graphql-specification-e49d6697.md) |
| JSON Schema | Language Specification | [open](apis-json-schema-3079472a.md) |
