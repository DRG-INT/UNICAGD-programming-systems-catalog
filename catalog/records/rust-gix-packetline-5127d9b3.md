...
| Canonical URL | [https://crates.io/crates/gix-packetline](https://crates.io/crates/gix-packetline) |
| Source record ids | crates_io-e6706f4e71698a |
...
For a systems engineer, gix-packetline belongs in the Rust inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.2 | 2026-08-24T13:56:03.052650Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-e6706f4e71698a` from `crates_io` as `registry_expansion`
