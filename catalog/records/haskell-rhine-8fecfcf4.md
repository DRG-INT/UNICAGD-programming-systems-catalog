...
<!-- canonical: https://hackage.haskell.org/package/rhine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/rhine](https://hackage.haskell.org/package/rhine) |
| Source record ids | hackage_top_downloads-062269298ce3cf |
...
For a systems engineer, rhine belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8 | 2026-06-07T22:07:57Z | [https://hackage.haskell.org/package/rhine](https://hackage.haskell.org/package/rhine) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/rhine](https://hackage.haskell.org/package/rhine) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/rhine` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-062269298ce3cf` from `hackage_top_downloads` as `registry_expansion`
