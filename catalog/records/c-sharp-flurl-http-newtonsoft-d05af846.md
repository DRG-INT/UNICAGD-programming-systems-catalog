...
<!-- canonical: https://www.nuget.org/packages/Flurl.Http.Newtonsoft -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Flurl.Http.Newtonsoft](https://www.nuget.org/packages/Flurl.Http.Newtonsoft) |
| Source record ids | nuget_search-04d4b47e3711f2 |
...
For a systems engineer, Flurl.Http.Newtonsoft belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2024-01-10T02:20:09.923+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/flurl.http.newtonsoft/index.json](https://api.nuget.org/v3/registration5-gz-semver2/flurl.http.newtonsoft/index.json) |  |
| preview | known | 0.9.0-pre3 | 2023-12-08T23:02:50.82+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/flurl.http.newtonsoft/index.json](https://api.nuget.org/v3/registration5-gz-semver2/flurl.http.newtonsoft/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; https://www.nuget.org/packages/Flurl.Http.Newtonsoft/0.9.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/flurl.http.newtonsoft/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-04d4b47e3711f2` from `nuget_search` as `registry_expansion`
