...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Profiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/profiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/tracing-core](https://crates.io/crates/tracing-core) |
| Source record ids | crates_io-a7d637179c6e7d |
...
For a systems engineer, tracing-core belongs in the Rust inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.36 | 2025-12-18T14:13:04.171045Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| backtrace-ext | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-backtrace-ext-c5bc093e.md) |
| color-spantrace | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-color-spantrace-96dba6ba.md) |
| flamegraph | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-flamegraph-27cbc597.md) |
| opentelemetry_api | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-opentelemetry-api-879f3d0b.md) |
| opentelemetry_sdk | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-opentelemetry-sdk-568a410d.md) |
| reqwest-tracing | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-reqwest-tracing-a9c9d39c.md) |
| samply | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-samply-515906c6.md) |
| sentry-backtrace | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-sentry-backtrace-2b40e31a.md) |
