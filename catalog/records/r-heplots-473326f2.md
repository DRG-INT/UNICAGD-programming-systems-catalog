...
<!-- canonical: https://cran.r-project.org/web/packages/heplots/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/heplots/index.html](https://cran.r-project.org/web/packages/heplots/index.html) |
| Source record ids | cran_packages_by_date-54c731eff2d844 |
...
For a systems engineer, heplots belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.4 | 2026-08-23 16:20:02 UTC | [https://cran.r-project.org/web/packages/heplots/DESCRIPTION](https://cran.r-project.org/web/packages/heplots/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/heplots/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-54c731eff2d844` from `cran_packages_by_date` as `registry_expansion`
