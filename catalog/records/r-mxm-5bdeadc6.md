...
<!-- canonical: https://cran.r-project.org/web/packages/MXM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MXM/index.html](https://cran.r-project.org/web/packages/MXM/index.html) |
| Source record ids | cran_packages_by_date-20fb6ef0b7e947 |
...
For a systems engineer, MXM belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.8 | 2026-09-01 14:00:15 UTC | [https://cran.r-project.org/web/packages/MXM/DESCRIPTION](https://cran.r-project.org/web/packages/MXM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MXM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-20fb6ef0b7e947` from `cran_packages_by_date` as `registry_expansion`
