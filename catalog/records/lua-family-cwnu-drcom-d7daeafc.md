...
<!-- canonical: https://luarocks.org/modules/leetking/cwnu-drcom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/leetking/cwnu-drcom](https://luarocks.org/modules/leetking/cwnu-drcom) |
| Source record ids | luarocks_root_manifest-386f397840961a |

## System Engineer Summary

cwnu-drcom is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, cwnu-drcom belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-386f397840961a` from `luarocks_root_manifest` as `registry_expansion`
