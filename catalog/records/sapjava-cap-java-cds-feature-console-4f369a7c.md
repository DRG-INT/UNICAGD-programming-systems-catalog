...
<!-- canonical: https://github.com/cap-java/cds-feature-console -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cap-java/cds-feature-console](https://github.com/cap-java/cds-feature-console) |
| Source record ids | github_search_sapjava-b66c95763de0d6 |

## System Engineer Summary

Plugin that allows CAP Java applications to communicate with the the SAP Cloud Application
Programming Model console.

## Operational Role

For a systems engineer, cap-java/cds-feature-console belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2025-10-30T10:26:19Z | [https://api.github.com/repos/cap-java/cds-feature-console/releases/latest](https://api.github.com/repos/cap-java/cds-feature-console/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cap-java/cds-feature-console/releases/latest` at `2026-09-01T10:25:33+00:00`.
...
- `github_search_sapjava-b66c95763de0d6` from `github_search_sapjava` as `registry_expansion`
