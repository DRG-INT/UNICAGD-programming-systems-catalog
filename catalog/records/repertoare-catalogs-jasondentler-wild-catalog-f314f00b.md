...
<!-- canonical: https://github.com/jasondentler/wild-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jasondentler/wild-catalog](https://github.com/jasondentler/wild-catalog) |
| Source record ids | github_search_repertoare_catalogs-8600240be2c74d |

## System Engineer Summary

WildCatalog is an open-source taxonomy & computer vision backend for wildlife photography. It maps
raw media uploads to detailed biological lineage data streams, localization properties, and
confidence score layers. Built to support plugin workflows like crush-catalog, it operates as a
fast, standalone API for ecological tracking.

## Operational Role

For a systems engineer, jasondentler/wild-catalog belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T03:54:55Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-8600240be2c74d` from `github_search_repertoare_catalogs` as `registry_expansion`
