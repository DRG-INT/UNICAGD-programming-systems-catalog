...
| Canonical URL | [https://crates.io/crates/cranelift-codegen](https://crates.io/crates/cranelift-codegen) |
| Source record ids | crates_io-2628f40610c2ee |
...
For a systems engineer, cranelift-codegen belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.135.1 | 2026-08-24T19:58:03.457027Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-2628f40610c2ee` from `crates_io` as `registry_expansion`
