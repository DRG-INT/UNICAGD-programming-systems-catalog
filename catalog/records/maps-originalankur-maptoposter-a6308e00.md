...
<!-- canonical: https://github.com/originalankur/maptoposter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/originalankur/maptoposter](https://github.com/originalankur/maptoposter) |
| Source record ids | github_search_maps-9aef9422ab6629 |

## System Engineer Summary

Transform your favorite cities into beautiful, minimalist designs. MapToPoster lets you create and
export visually striking map posters with code.

## Operational Role

For a systems engineer, originalankur/maptoposter belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T07:57:04Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9aef9422ab6629` from `github_search_maps` as `registry_expansion`
