...
<!-- canonical: https://packagist.org/packages/lcobucci/jwt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/lcobucci/jwt](https://packagist.org/packages/lcobucci/jwt) |
| Source record ids | packagist_search-e64061d509e8fc |
...
For a systems engineer, lcobucci/jwt belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-e64061d509e8fc` from `packagist_search` as `registry_expansion`
