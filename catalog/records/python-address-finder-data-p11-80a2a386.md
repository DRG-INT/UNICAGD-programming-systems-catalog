...
<!-- canonical: https://pypi.org/project/address-finder-data-p11/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-finder-data-p11/](https://pypi.org/project/address-finder-data-p11/) |
| Source record ids | pypi_simple-e03bd2917f26c0 |

## System Engineer Summary

address-finder data chunk p11 - contains numex.dat part 1/1

## Operational Role

For a systems engineer, address-finder-data-p11 belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-03-20T17:41:33.090763Z | [https://pypi.org/pypi/address-finder-data-p11/json](https://pypi.org/pypi/address-finder-data-p11/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-finder-data-p11/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-e03bd2917f26c0` from `pypi_simple` as `registry_expansion`
...
| address-finder-data-p09 | Machine Learning | [open](python-address-finder-data-p09-abb4d7c4.md) |
