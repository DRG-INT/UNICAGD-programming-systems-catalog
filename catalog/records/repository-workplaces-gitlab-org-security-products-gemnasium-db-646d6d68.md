...
<!-- canonical: https://gitlab.com/gitlab-org/security-products/gemnasium-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/security-products/gemnasium-db](https://gitlab.com/gitlab-org/security-products/gemnasium-db) |
| Source record ids | gitlab_projects_api-a993c2906073b0 |

## System Engineer Summary

The GitLab Advisory Database (GLAD), used in GitLab Ultimate and . Search the database at

## Operational Role

For a systems engineer, gitlab-org/security-products/gemnasium-db belongs in the Repository
...
- `gitlab_projects_api-a993c2906073b0` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: RiceField-Plugins/LibraryDependencies | Dependency Manager | [open](repository-workplaces-gitea-ricefield-plugins-librarydependencies-4aaea462.md) |
