...
| Canonical URL | [https://crates.io/crates/simple_logger](https://crates.io/crates/simple_logger) |
| Source record ids | crates_io-09e06cd4074971 |
...
For a systems engineer, simple_logger belongs in the Rust inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.2.0 | 2026-02-18T02:58:32.838086Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-09e06cd4074971` from `crates_io` as `registry_expansion`
