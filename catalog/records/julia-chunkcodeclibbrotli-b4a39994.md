...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Cli](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cli.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChunkCodecLibBrotli](https://github.com/JuliaRegistries/General/tree/master/C/ChunkCodecLibBrotli) |
| Source record ids | julia_general-ee864b891ee965 |

## System Engineer Summary

Julia package registered in General at C/ChunkCodecLibBrotli.

## Operational Role

For a systems engineer, ChunkCodecLibBrotli belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| AutocorrelationShell | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-autocorrelationshell-8bdb0c63.md) |
| battery_cli_jll | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-battery-cli-jll-330bc3cb.md) |
| bitwarden_cli_jll | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bitwarden-cli-jll-f5a9f2b5.md) |
| CanadianClimateData | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-canadianclimatedata-bdefe83a.md) |
| Cclib | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cclib-c58e3aa5.md) |
| ChunkCodecLibAec | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chunkcodeclibaec-e660404d.md) |
| ChunkCodecLibBlosc | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chunkcodeclibblosc-f52c441a.md) |
| ChunkCodecLibBzip2 | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chunkcodeclibbzip2-63f11079.md) |
