...
| Source record ids | github_search_electromagnetoscopes-583c47bda64373 |

## System Engineer Summary

osmocom/gr-osmosdr is tracked as a networking http record in the Electromagnetoscopes branch. The
...
For a systems engineer, osmocom/gr-osmosdr belongs in the Electromagnetoscopes inventory as part of
...
- `github_search_electromagnetoscopes-583c47bda64373` from `github_search_electromagnetoscopes` as `registry_expansion`
