...
<!-- canonical: https://pypi.org/project/a-data-processing/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a-data-processing/](https://pypi.org/project/a-data-processing/) |
| Source record ids | pypi_simple-bbd25910f2e26c |
...
For a systems engineer, a-data-processing belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2024-02-02T06:44:32.767492Z | [https://pypi.org/pypi/a-data-processing/json](https://pypi.org/pypi/a-data-processing/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a-data-processing/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-bbd25910f2e26c` from `pypi_simple` as `registry_expansion`
