...
<!-- canonical: https://github.com/JetBrains/xodus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JetBrains/xodus](https://github.com/JetBrains/xodus) |
| Source record ids | github_search_databases-9987ef22c0832f |
...
For a systems engineer, JetBrains/xodus belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-09T12:00:26Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9987ef22c0832f` from `github_search_databases` as `registry_expansion`
