...
<!-- canonical: https://github.com/caereforge/tempo-scores -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/caereforge/tempo-scores](https://github.com/caereforge/tempo-scores) |
| Source record ids | github_search_repertoare_catalogs-f532fe56406b8a |

## System Engineer Summary

Public catalog of scores for Tempo. For tinkerers, from a Mac to a rack.

## Operational Role

For a systems engineer, caereforge/tempo-scores belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-08T15:58:49Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-f532fe56406b8a` from `github_search_repertoare_catalogs` as `registry_expansion`
