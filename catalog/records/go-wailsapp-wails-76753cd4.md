...
<!-- canonical: https://github.com/wailsapp/wails -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wailsapp/wails](https://github.com/wailsapp/wails) |
| Source record ids | github_search_go-d15df68250527a |
...
For a systems engineer, wailsapp/wails belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T00:27:04Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-d15df68250527a` from `github_search_go` as `registry_expansion`
