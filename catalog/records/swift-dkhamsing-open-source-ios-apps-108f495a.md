...
<!-- canonical: https://github.com/dkhamsing/open-source-ios-apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dkhamsing/open-source-ios-apps](https://github.com/dkhamsing/open-source-ios-apps) |
| Source record ids | github_search_swift-4abfd29125a608 |
...
For a systems engineer, dkhamsing/open-source-ios-apps belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T12:46:48Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-4abfd29125a608` from `github_search_swift` as `registry_expansion`
