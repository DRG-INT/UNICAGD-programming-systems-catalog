...
<!-- canonical: https://cran.r-project.org/web/packages/mggd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mggd/index.html](https://cran.r-project.org/web/packages/mggd/index.html) |
| Source record ids | cran_packages_by_date-a45b3042473dd7 |
...
For a systems engineer, mggd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.7 | 2026-08-25 09:50:07 UTC | [https://cran.r-project.org/web/packages/mggd/DESCRIPTION](https://cran.r-project.org/web/packages/mggd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mggd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a45b3042473dd7` from `cran_packages_by_date` as `registry_expansion`
