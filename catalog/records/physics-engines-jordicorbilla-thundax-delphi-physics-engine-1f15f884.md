...
<!-- canonical: https://github.com/JordiCorbilla/thundax-delphi-physics-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JordiCorbilla/thundax-delphi-physics-engine](https://github.com/JordiCorbilla/thundax-delphi-physics-engine) |
| Source record ids | github_search_physics_engines-5c67ee5e6fd63f |

## System Engineer Summary

🛴 "Thundax Delphi Physics Engine" is a Delphi-based 2D physics engine for simulations and
visualizations. It employs Pascal and is ideal for learning and experimenting with 2D physics
concepts.

## Operational Role

For a systems engineer, JordiCorbilla/thundax-delphi-physics-engine belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-09T19:10:27Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-5c67ee5e6fd63f` from `github_search_physics_engines` as `registry_expansion`
