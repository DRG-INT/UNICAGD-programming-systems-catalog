...
<!-- canonical: https://crates.io/crates/toml_edit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/toml_edit](https://crates.io/crates/toml_edit) |
| Source record ids | crates_io-e94dd22afe3b3e |
...
For a systems engineer, toml_edit belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.15+spec-1.1.0 | 2026-09-11T01:44:08.521316Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-11T02:20:05+00:00`.
...
- `crates_io-e94dd22afe3b3e` from `crates_io` as `registry_expansion`
