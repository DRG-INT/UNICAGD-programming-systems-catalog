...
<!-- canonical: https://cran.r-project.org/web/packages/SpaDES.core/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SpaDES.core/index.html](https://cran.r-project.org/web/packages/SpaDES.core/index.html) |
| Source record ids | cran_packages_by_date-5d596722f1dedd |
...
For a systems engineer, SpaDES.core belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.1 | 2026-08-29 10:20:09 UTC | [https://cran.r-project.org/web/packages/SpaDES.core/DESCRIPTION](https://cran.r-project.org/web/packages/SpaDES.core/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SpaDES.core/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5d596722f1dedd` from `cran_packages_by_date` as `registry_expansion`
