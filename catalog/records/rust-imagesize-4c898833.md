...
| Canonical URL | [https://crates.io/crates/imagesize](https://crates.io/crates/imagesize) |
| Source record ids | crates_io-1fdbe06bf2615e |
...
For a systems engineer, imagesize belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-07-09T17:07:45.885379Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-1fdbe06bf2615e` from `crates_io` as `registry_expansion`
