...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cottsay/arm_asm_emu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cottsay/arm_asm_emu](https://github.com/cottsay/arm_asm_emu) |
| Source record ids | github_search_assembly-8aa918472a7464 |
...
For a systems engineer, cottsay/arm_asm_emu belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-07T00:51:12Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:arm topic:assembly", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-8aa918472a7464` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| decompme/decomp.me | Game Engine Game Dev | [open](assembly-decompme-decomp-me-72e4eec1.md) |
| dethrace-labs/dethrace | Game Engine Game Dev | [open](assembly-dethrace-labs-dethrace-0d609365.md) |
| io12/BootMine | Game Engine Game Dev | [open](assembly-io12-bootmine-85e26922.md) |
| tgrysztar/fasmg | Game Engine Game Dev | [open](assembly-tgrysztar-fasmg-1281abcb.md) |
