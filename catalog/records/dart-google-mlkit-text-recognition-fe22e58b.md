...
<!-- canonical: https://pub.dev/packages/google_mlkit_text_recognition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_mlkit_text_recognition](https://pub.dev/packages/google_mlkit_text_recognition) |
| Source record ids | pub_dev-a7b9bed029e195 |

## System Engineer Summary

A Flutter plugin to use Google's ML Kit Text Recognition to recognize text in any Chinese,
Devanagari, Japanese, Korean and Latin character set.

## Operational Role

For a systems engineer, google_mlkit_text_recognition belongs in the Dart inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.1 | 2026-08-17T20:46:30.141172Z | [https://pub.dev/api/packages/google_mlkit_text_recognition](https://pub.dev/api/packages/google_mlkit_text_recognition) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_mlkit_text_recognition` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-a7b9bed029e195` from `pub_dev` as `registry_expansion`
