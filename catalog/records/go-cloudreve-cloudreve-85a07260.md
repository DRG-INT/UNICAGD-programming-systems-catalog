...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cloudreve/cloudreve -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) |
| Source record ids | github_search_go-d0858a2515b60e |
...
For a systems engineer, cloudreve/cloudreve belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T21:49:55Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-d0858a2515b60e` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AdguardTeam/AdGuardHome | Ide Editor Integration | [open](go-adguardteam-adguardhome-7d76b56d.md) |
| gorilla/websocket | Ide Editor Integration | [open](go-gorilla-websocket-b72dd879.md) |
