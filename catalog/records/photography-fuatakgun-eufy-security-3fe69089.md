...
<!-- canonical: https://github.com/fuatakgun/eufy_security -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fuatakgun/eufy_security](https://github.com/fuatakgun/eufy_security) |
| Source record ids | github_search_photography-6f67d1fa66343a |

## System Engineer Summary

Home Assistant integration to manage Eufy Security devices as cameras, home base stations,
doorbells, motion and contact sensors.

## Operational Role

For a systems engineer, fuatakgun/eufy_security belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T06:22:26Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-6f67d1fa66343a` from `github_search_photography` as `registry_expansion`
