...
<!-- canonical: https://crates.io/crates/rand_core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_core](https://crates.io/crates/rand_core) |
| Source record ids | crates_io-655f969d171b01 |
...
For a systems engineer, rand_core belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2026-09-02T08:19:33.285884Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-02T08:21:38+00:00`.
...
- `crates_io-655f969d171b01` from `crates_io` as `registry_expansion`
