...
<!-- canonical: https://packagist.org/packages/phpunit/phpunit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpunit/phpunit](https://packagist.org/packages/phpunit/phpunit) |
| Source record ids | packagist_search-3a0d8ef5243031 |
...
For a systems engineer, phpunit/phpunit belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-3a0d8ef5243031` from `packagist_search` as `registry_expansion`
