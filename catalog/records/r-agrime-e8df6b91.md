...
<!-- canonical: https://cran.r-project.org/web/packages/agriME/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/agriME/index.html](https://cran.r-project.org/web/packages/agriME/index.html) |
| Source record ids | cran_packages_by_date-02623907b6ddef |
...
For a systems engineer, agriME belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 14:20:08 UTC | [https://cran.r-project.org/web/packages/agriME/DESCRIPTION](https://cran.r-project.org/web/packages/agriME/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/agriME/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-02623907b6ddef` from `cran_packages_by_date` as `registry_expansion`
