...
<!-- canonical: https://hackage.haskell.org/package/freckle-otel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/freckle-otel](https://hackage.haskell.org/package/freckle-otel) |
| Source record ids | hackage_recent-4c746b3da5448e |
...
For a systems engineer, freckle-otel belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0.0 | 2026-09-03T16:35:14Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-4c746b3da5448e` from `hackage_recent` as `registry_expansion`
