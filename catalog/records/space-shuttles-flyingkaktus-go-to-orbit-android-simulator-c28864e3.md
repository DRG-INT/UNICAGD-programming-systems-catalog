# flyingkaktus/go-to-orbit-android-simulator
...
<!-- canonical: https://github.com/flyingkaktus/go-to-orbit-android-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flyingkaktus/go-to-orbit-android-simulator](https://github.com/flyingkaktus/go-to-orbit-android-simulator) |
| Source record ids | github_search_space_shuttles-bf04f0a50d4192 |

## System Engineer Summary

As the name of the application implies "Go To Orbit", the goal is to get into an orbital space
flight. The player controls a satellite with the help of thrusters. Other objects of the game world
are three small spheres, symbolic of moons, with which collusion can occur. All three moons orbit a
larger object on stable orbits.

## Operational Role

For a systems engineer, flyingkaktus/go-to-orbit-android-simulator belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-18T21:40:21Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-bf04f0a50d4192` from `github_search_space_shuttles` as `registry_expansion`
