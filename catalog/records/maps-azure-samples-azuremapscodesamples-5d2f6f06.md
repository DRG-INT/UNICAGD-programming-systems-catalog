...
<!-- canonical: https://github.com/Azure-Samples/AzureMapsCodeSamples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Azure-Samples/AzureMapsCodeSamples](https://github.com/Azure-Samples/AzureMapsCodeSamples) |
| Source record ids | github_search_maps-9bd0871e86f823 |
...
For a systems engineer, Azure-Samples/AzureMapsCodeSamples belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 252537 | 2020-12-16T00:55:05Z | [https://api.github.com/repos/Azure-Samples/AzureMapsCodeSamples/releases/latest](https://api.github.com/repos/Azure-Samples/AzureMapsCodeSamples/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Azure-Samples/AzureMapsCodeSamples/releases/latest` at `2026-09-01T12:29:59+00:00`.
...
- `github_search_maps-9bd0871e86f823` from `github_search_maps` as `registry_expansion`
