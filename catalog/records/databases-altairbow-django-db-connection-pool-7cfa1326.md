...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/altairbow/django-db-connection-pool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/altairbow/django-db-connection-pool](https://github.com/altairbow/django-db-connection-pool) |
| Source record ids | github_search_databases-6e53c675dcc1bf |
...
For a systems engineer, altairbow/django-db-connection-pool belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-05T03:44:39Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6e53c675dcc1bf` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 4ra1n/mysql-fake-server | Web Framework | [open](databases-4ra1n-mysql-fake-server-c9a98cb5.md) |
| apache/doris-mcp-server | Web Framework | [open](databases-apache-doris-mcp-server-111c3250.md) |
| apecloud/myduckserver | Web Framework | [open](databases-apecloud-myduckserver-58eb334b.md) |
| atomikos/transactions-essentials | Web Framework | [open](databases-atomikos-transactions-essentials-768d3463.md) |
| aws-solutions-library-samples/data-lakes-on-aws | Web Framework | [open](databases-aws-solutions-library-samples-data-lakes-on-aws-a6898912.md) |
| boilingdata/boilstream | Web Framework | [open](databases-boilingdata-boilstream-8489b4c0.md) |
| borisdj/EFCore.BulkExtensions | Web Framework | [open](databases-borisdj-efcore-bulkextensions-221ede9a.md) |
| coollabsio/coolify | Web Framework | [open](databases-coollabsio-coolify-1bdaf4b8.md) |
