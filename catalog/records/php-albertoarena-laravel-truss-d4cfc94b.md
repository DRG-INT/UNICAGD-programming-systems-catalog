...
<!-- canonical: https://packagist.org/packages/albertoarena/laravel-truss -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/albertoarena/laravel-truss](https://packagist.org/packages/albertoarena/laravel-truss) |
| Source record ids | packagist_search-183b25a04ec69f |

## System Engineer Summary

A live database structure viewer for Laravel. Renders your schema (never data) as a scrollable,
zoomable ER diagram.

## Operational Role

For a systems engineer, albertoarena/laravel-truss belongs in the PHP inventory as part of state
...
- `packagist_search-183b25a04ec69f` from `packagist_search` as `registry_expansion`
