...
| Canonical URL | [https://luarocks.org/modules/summer-boythink/first_lua](https://luarocks.org/modules/summer-boythink/first_lua) |
| Source record ids | luarocks_root_manifest-7de090fbb64630 |

## System Engineer Summary

first_lua is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, first_lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7de090fbb64630` from `luarocks_root_manifest` as `registry_expansion`
