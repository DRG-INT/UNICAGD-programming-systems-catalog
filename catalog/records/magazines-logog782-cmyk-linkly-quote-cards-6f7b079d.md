# logog782-cmyk/linkly-quote-cards
...
<!-- canonical: https://github.com/logog782-cmyk/linkly-quote-cards -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/logog782-cmyk/linkly-quote-cards](https://github.com/logog782-cmyk/linkly-quote-cards) |
| Source record ids | github_search_magazines-04441090f6b817 |

## System Engineer Summary

Linkly 金句卡 — turn knowledge-base notes into numbered zine-style quote cards. Claude Code skill:
Seedream backend, halftone portraits, verbatim CJK text check. 把知识库笔记里的金句变成编号 zine 卡片

## Operational Role

For a systems engineer, logog782-cmyk/linkly-quote-cards belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T05:42:07Z | gh search repos topic:zine stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-04441090f6b817` from `github_search_magazines` as `registry_expansion`
