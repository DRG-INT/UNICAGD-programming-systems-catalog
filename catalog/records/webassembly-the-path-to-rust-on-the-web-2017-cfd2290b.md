...
<!-- canonical: https://hoverbear.org/2017/04/06/the-path-to-rust-on-the-web/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hoverbear.org/2017/04/06/the-path-to-rust-on-the-web/](https://hoverbear.org/2017/04/06/the-path-to-rust-on-the-web/) |
| Source record ids | awesome_list-529c03b4b2e3de |

## System Engineer Summary

The Path to Rust on the Web (2017) is tracked as a filesystem os record in the WebAssembly branch.
...
For a systems engineer, The Path to Rust on the Web (2017) belongs in the WebAssembly inventory as
...
- `awesome_list-529c03b4b2e3de` from `awesome_list` as `registry_expansion`
