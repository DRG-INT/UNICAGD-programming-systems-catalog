...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/glumpy/glumpy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/glumpy/glumpy](https://github.com/glumpy/glumpy) |
| Source record ids | github_search_engines-ba32a964799c58 |
...
For a systems engineer, glumpy/glumpy belongs in the Engines inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-15T09:44:18Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-ba32a964799c58` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bludit/bludit | Parser Lexer Ast | [open](engines-bludit-bludit-8295a6ea.md) |
| oracle/opengrok | Parser Lexer Ast | [open](engines-oracle-opengrok-ebcea996.md) |
| ssloy/tinyraycaster | Parser Lexer Ast | [open](engines-ssloy-tinyraycaster-e16eca51.md) |
