...
<!-- canonical: https://github.com/appbaseio/dejavu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/appbaseio/dejavu](https://github.com/appbaseio/dejavu) |
| Source record ids | github_search_databases-a801408fdb5395 |

## System Engineer Summary

A Web UI for Elasticsearch and OpenSearch: Import, browse and edit data with rich filters and query
views, create reference search UIs.

## Operational Role

For a systems engineer, appbaseio/dejavu belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T11:08:58Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a801408fdb5395` from `github_search_databases` as `registry_expansion`
