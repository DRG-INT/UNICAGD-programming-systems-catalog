...
<!-- canonical: https://github.com/nextorbitlabs/spice-kernels -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nextorbitlabs/spice-kernels](https://github.com/nextorbitlabs/spice-kernels) |
| Source record ids | github_search_space_maps-2fdebf5d35e19a |

## System Engineer Summary

nextorbitlabs/spice-kernels is tracked as a library record in the Space Maps branch. The source did
...
For a systems engineer, nextorbitlabs/spice-kernels belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-06T18:18:18Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2fdebf5d35e19a` from `github_search_space_maps` as `registry_expansion`
