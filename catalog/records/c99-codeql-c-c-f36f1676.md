...
| Source record ids | corpus-01c3c441226af2 |

## System Engineer Summary

CodeQL C/C++ is tracked as a static analyzer record in the C99 branch. The source did not provide a
...
For a systems engineer, CodeQL C/C++ belongs in the C99 inventory as part of defect discovery,
...
- `corpus-01c3c441226af2` from `master_json` as `static_analyzer`
...
| PC-lint Plus | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-pc-lint-plus-f00f3f1a.md) |
