...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/donutTheJedi/Rocket-Launch-Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/donutTheJedi/Rocket-Launch-Simulation](https://github.com/donutTheJedi/Rocket-Launch-Simulation) |
| Source record ids | github_search_space_engines-e011806ef650c5 |
...
For a systems engineer, donutTheJedi/Rocket-Launch-Simulation belongs in the Space Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T19:58:52Z | gh search repos topic:rocket-simulation stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:rocket-simulation stars:>10", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_space_engines-e011806ef650c5` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 1manprojects/one_Sgp4 | Library | [open](space-engines-1manprojects-one-sgp4-75a7c09c.md) |
| allista/ThrottleControlledAvionics | Library | [open](space-engines-allista-throttlecontrolledavionics-80f1f478.md) |
| arasgungore/rocket-flight-simulator | Library | [open](space-engines-arasgungore-rocket-flight-simulator-786e98e4.md) |
| debanjan06/SatelliteRL | Library | [open](space-engines-debanjan06-satelliterl-217a5bf9.md) |
| egemenimre/ccsds-ndm | Library | [open](space-engines-egemenimre-ccsds-ndm-313104bb.md) |
| FlorentF9/SatelliteSimulator | Library | [open](space-engines-florentf9-satellitesimulator-543a7902.md) |
| gunvirranu/perturb | Library | [open](space-engines-gunvirranu-perturb-a3eb7945.md) |
| handong1979/orbitdynamics | Library | [open](space-engines-handong1979-orbitdynamics-4e599bd0.md) |
