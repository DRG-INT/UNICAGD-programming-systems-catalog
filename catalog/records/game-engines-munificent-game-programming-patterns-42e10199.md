...
<!-- canonical: https://github.com/munificent/game-programming-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/munificent/game-programming-patterns](https://github.com/munificent/game-programming-patterns) |
| Source record ids | github_search_game_engines-b9d4d49b2e0075 |
...
For a systems engineer, munificent/game-programming-patterns belongs in the Game Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-21T23:27:15Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-b9d4d49b2e0075` from `github_search_game_engines` as `registry_expansion`
