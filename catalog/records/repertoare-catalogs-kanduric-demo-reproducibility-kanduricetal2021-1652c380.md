# KanduriC/demo_reproducibility_kanduricetal2021
...
<!-- canonical: https://github.com/KanduriC/demo_reproducibility_kanduricetal2021 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KanduriC/demo_reproducibility_kanduricetal2021](https://github.com/KanduriC/demo_reproducibility_kanduricetal2021) |
| Source record ids | github_search_repertoare_catalogs-a490dbf7489c76 |

## System Engineer Summary

Demonstration of reproducibility and deployability of the computational workflow of the article
"Profiling the baseline performance and limits of machine learning models for adaptive immune
receptor repertoire classification"

## Operational Role

For a systems engineer, KanduriC/demo_reproducibility_kanduricetal2021 belongs in the Repertoare
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-25T11:27:35Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_repertoare_catalogs-a490dbf7489c76` from `github_search_repertoare_catalogs` as `registry_expansion`
