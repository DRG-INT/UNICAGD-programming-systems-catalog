...
<!-- canonical: https://github.com/yshui/runa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yshui/runa](https://github.com/yshui/runa) |
| Source record ids | github_search_effects-53a88c0b3a036c |
...
For a systems engineer, yshui/runa belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-11T01:43:20Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-53a88c0b3a036c` from `github_search_effects` as `registry_expansion`
