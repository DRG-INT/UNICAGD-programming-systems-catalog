...
<!-- canonical: https://crates.io/crates/unicode-properties -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-properties](https://crates.io/crates/unicode-properties) |
| Source record ids | crates_io-14f44516eedad8 |
...
For a systems engineer, unicode-properties belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2025-10-30T16:34:55.538672Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-14f44516eedad8` from `crates_io` as `registry_expansion`
