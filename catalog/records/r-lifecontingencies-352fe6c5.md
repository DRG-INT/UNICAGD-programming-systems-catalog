...
<!-- canonical: https://cran.r-project.org/web/packages/lifecontingencies/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lifecontingencies/index.html](https://cran.r-project.org/web/packages/lifecontingencies/index.html) |
| Source record ids | cran_packages_by_date-bcf9484b594c72 |
...
For a systems engineer, lifecontingencies belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2026-08-23 19:20:02 UTC | [https://cran.r-project.org/web/packages/lifecontingencies/DESCRIPTION](https://cran.r-project.org/web/packages/lifecontingencies/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lifecontingencies/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bcf9484b594c72` from `cran_packages_by_date` as `registry_expansion`
