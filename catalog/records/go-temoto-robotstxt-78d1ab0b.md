...
<!-- canonical: https://github.com/temoto/robotstxt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/temoto/robotstxt](https://github.com/temoto/robotstxt) |
| Source record ids | github_search_go-95135a9015a9de |
...
For a systems engineer, temoto/robotstxt belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T08:52:49Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:go-library stars:>100", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_go-95135a9015a9de` from `github_search_go` as `registry_expansion`
