...
| Canonical URL | [https://github.com/elastic/elasticsearch](https://github.com/elastic/elasticsearch) |
| Source record ids | curated_database_systems-d98974f4b3ef24 |

## System Engineer Summary

Distributed search, log, document, and analytics engine.

## Operational Role

For a systems engineer, Elasticsearch belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v9.5.2 | 2026-08-20T16:44:04Z | [https://api.github.com/repos/elastic/elasticsearch/releases/latest](https://api.github.com/repos/elastic/elasticsearch/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/elastic/elasticsearch/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-d98974f4b3ef24` from `curated_database_systems` as `registry_expansion`
