...
<!-- canonical: https://cran.r-project.org/web/packages/ggChinaFlag/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggChinaFlag/index.html](https://cran.r-project.org/web/packages/ggChinaFlag/index.html) |
| Source record ids | cran_packages_by_date-0cc136605ff62b |

## System Engineer Summary

Drawing Chinese National and Historical Flags with 'ggplot2'

## Operational Role

For a systems engineer, ggChinaFlag belongs in the R inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-14 09:30:02 UTC | [https://cran.r-project.org/web/packages/ggChinaFlag/DESCRIPTION](https://cran.r-project.org/web/packages/ggChinaFlag/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggChinaFlag/DESCRIPTION` at `2026-09-14T10:20:50+00:00`.
...
- `cran_packages_by_date-0cc136605ff62b` from `cran_packages_by_date` as `registry_expansion`
