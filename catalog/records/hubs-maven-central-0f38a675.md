...
<!-- canonical: https://central.sonatype.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/](https://central.sonatype.com/) |
| Source record ids | curated_language_routes-761268748ff165 |

## System Engineer Summary

Java/JVM artifact hub for Maven coordinates, versions, POM metadata, and dependency resolution.

## Operational Role

For a systems engineer, Maven Central belongs in the Hubs inventory as part of ecosystem capability
...
- `curated_language_routes-761268748ff165` from `curated_language_routes` as `registry_expansion`
