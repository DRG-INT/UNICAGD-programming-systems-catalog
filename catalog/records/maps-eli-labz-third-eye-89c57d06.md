...
<!-- canonical: https://github.com/eli-labz/Third-Eye -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eli-labz/Third-Eye](https://github.com/eli-labz/Third-Eye) |
| Source record ids | github_search_maps-f49354795a34ef |

## System Engineer Summary

A production-grade OSINT platform that provides situational awareness across multiple intelligence
domains.

## Operational Role

For a systems engineer, eli-labz/Third-Eye belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-13T06:29:56Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f49354795a34ef` from `github_search_maps` as `registry_expansion`
