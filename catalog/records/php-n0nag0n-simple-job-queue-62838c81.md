...
<!-- canonical: https://packagist.org/packages/n0nag0n/simple-job-queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/n0nag0n/simple-job-queue](https://packagist.org/packages/n0nag0n/simple-job-queue) |
| Source record ids | packagist_search-1b16a2bc405457 |

## System Engineer Summary

A simple library for interfacing with other job queue providers that gives you plenty of
flexibility. Supports MySQL, PostgreSQL, SQLite, and Beanstalkd.

## Operational Role

For a systems engineer, n0nag0n/simple-job-queue belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-1b16a2bc405457` from `packagist_search` as `registry_expansion`
