...
<!-- canonical: https://cran.r-project.org/web/packages/sglssnal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sglssnal/index.html](https://cran.r-project.org/web/packages/sglssnal/index.html) |
| Source record ids | cran_packages_by_date-0da469191df55c |
...
For a systems engineer, sglssnal belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-11 15:30:02 UTC | [https://cran.r-project.org/web/packages/sglssnal/DESCRIPTION](https://cran.r-project.org/web/packages/sglssnal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sglssnal/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-0da469191df55c` from `cran_packages_by_date` as `registry_expansion`
