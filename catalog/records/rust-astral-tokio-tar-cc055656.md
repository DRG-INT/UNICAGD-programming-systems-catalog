...
| Canonical URL | [https://crates.io/crates/astral-tokio-tar](https://crates.io/crates/astral-tokio-tar) |
| Source record ids | crates_io-a6cd606592950f |

## System Engineer Summary

A Rust implementation of an async TAR file reader and writer. This library does not currently handle
compression, but it is abstract over all I/O readers and writers. Additionally, great lengths are
taken to ensure that the entire contents are never required to be entirely resident in memory all at
once.

## Operational Role

For a systems engineer, astral-tokio-tar belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-28T18:45:48.561950Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-a6cd606592950f` from `crates_io` as `registry_expansion`
