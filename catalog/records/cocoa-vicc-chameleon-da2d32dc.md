...
<!-- canonical: https://github.com/vicc/chameleon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vicc/chameleon](https://github.com/vicc/chameleon) |
| Source record ids | github_search_cocoa-b6304528c05f1f |

## System Engineer Summary

Color framework for Swift & Objective-C (Gradient colors, hexcode support, colors from images &
more).

## Operational Role

For a systems engineer, vicc/chameleon belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-03T07:11:02Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-b6304528c05f1f` from `github_search_cocoa` as `registry_expansion`
