...
| Canonical URL | [https://github.com/xavierchanth/arbor.nvim](https://github.com/xavierchanth/arbor.nvim) |
| Source record ids | github_search_telescopes-28036e3145be3d |
...
For a systems engineer, xavierchanth/arbor.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2024-11-26T02:29:36Z | [https://api.github.com/repos/xavierchanth/arbor.nvim/releases/latest](https://api.github.com/repos/xavierchanth/arbor.nvim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/xavierchanth/arbor.nvim/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_telescopes-28036e3145be3d` from `github_search_telescopes` as `registry_expansion`
