...
<!-- canonical: https://pypi.org/project/acicli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acicli/](https://pypi.org/project/acicli/) |
| Source record ids | pypi_simple-61d0503790f541 |
...
For a systems engineer, acicli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2b1 | 2025-04-18T17:18:29.442697Z | [https://pypi.org/pypi/acicli/json](https://pypi.org/pypi/acicli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acicli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-61d0503790f541` from `pypi_simple` as `registry_expansion`
