...
<!-- canonical: https://cran.r-project.org/web/packages/bayesics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayesics/index.html](https://cran.r-project.org/web/packages/bayesics/index.html) |
| Source record ids | cran_packages_by_date-2920b328d8e999 |
...
For a systems engineer, bayesics belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-08-28 21:30:25 UTC | [https://cran.r-project.org/web/packages/bayesics/DESCRIPTION](https://cran.r-project.org/web/packages/bayesics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayesics/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2920b328d8e999` from `cran_packages_by_date` as `registry_expansion`
