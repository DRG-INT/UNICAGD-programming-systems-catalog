...
<!-- canonical: https://luarocks.org/modules/wsdjeg/chineselinter.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/chineselinter.nvim](https://luarocks.org/modules/wsdjeg/chineselinter.nvim) |
| Source record ids | luarocks_root_manifest-7004e35256ca36 |

## System Engineer Summary

chineselinter.nvim is tracked as a linter record in the Lua family branch. The source did not
...
For a systems engineer, chineselinter.nvim belongs in the Lua family inventory as part of static
...
- `luarocks_root_manifest-7004e35256ca36` from `luarocks_root_manifest` as `registry_expansion`
