...
<!-- canonical: https://crates.io/crates/rstest -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.0 | 2026-09-06T18:15:52.967458Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-06T18:20:44+00:00`.
...
- `crates_io-c1f7330ffd8c12` from `crates_io` as `registry_expansion`
