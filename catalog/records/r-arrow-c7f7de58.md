...
<!-- canonical: https://cran.r-project.org/web/packages/arrow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/arrow/index.html](https://cran.r-project.org/web/packages/arrow/index.html) |
| Source record ids | cran_packages_by_date-cc34a34eb9be15 |
...
For a systems engineer, arrow belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 25.0.1 | 2026-08-23 06:40:10 UTC | [https://cran.r-project.org/web/packages/arrow/DESCRIPTION](https://cran.r-project.org/web/packages/arrow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/arrow/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cc34a34eb9be15` from `cran_packages_by_date` as `registry_expansion`
