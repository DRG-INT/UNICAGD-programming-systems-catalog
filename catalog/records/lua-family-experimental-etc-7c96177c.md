...
| Source record ids | lua-source-41 |

## System Engineer Summary

Experimental, etc is tracked as an other record in the Lua family branch. The source did not provide
...
For a systems engineer, Experimental, etc belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 41}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-41` from `master_json` as `source_list_item`
