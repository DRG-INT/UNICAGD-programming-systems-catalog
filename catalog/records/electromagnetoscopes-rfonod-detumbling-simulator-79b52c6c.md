...
<!-- canonical: https://github.com/rfonod/detumbling-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rfonod/detumbling-simulator](https://github.com/rfonod/detumbling-simulator) |
| Source record ids | github_search_electromagnetoscopes-dc0d10de62ec37 |

## System Engineer Summary

🛰️ MATLAB simulator for pure magnetic detumbling of fast-tumbling picosatellites: B-dot control,
IGRF environment, realistic magnetorquers and magnetometers, and Monte Carlo campaigns. Code behind
the IAC-18 paper.

## Operational Role

For a systems engineer, rfonod/detumbling-simulator belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T04:06:01Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-dc0d10de62ec37` from `github_search_electromagnetoscopes` as `registry_expansion`
