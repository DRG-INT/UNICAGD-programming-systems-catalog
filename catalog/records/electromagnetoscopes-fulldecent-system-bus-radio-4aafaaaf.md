...
<!-- canonical: https://github.com/fulldecent/system-bus-radio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fulldecent/system-bus-radio](https://github.com/fulldecent/system-bus-radio) |
| Source record ids | github_search_electromagnetoscopes-21324d556e0a57 |
...
For a systems engineer, fulldecent/system-bus-radio belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2016-10-27T19:09:59Z | [https://api.github.com/repos/fulldecent/system-bus-radio/releases/latest](https://api.github.com/repos/fulldecent/system-bus-radio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fulldecent/system-bus-radio/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-21324d556e0a57` from `github_search_electromagnetoscopes` as `registry_expansion`
