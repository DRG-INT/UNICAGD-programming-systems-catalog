...
<!-- canonical: https://github.com/Conquer-Space/Conquer-Space -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Conquer-Space/Conquer-Space](https://github.com/Conquer-Space/Conquer-Space) |
| Source record ids | github_search_space_engines-3e384819e2d9e8 |

## System Engineer Summary

A space themed grand strategy set in the present to near future, with emphasis on economics,
politics, and society, with realistic orbital mechanics.

## Operational Role

For a systems engineer, Conquer-Space/Conquer-Space belongs in the Space Engines inventory as part
...
- `github_search_space_engines-3e384819e2d9e8` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| GH-X-ST/Aeronautical-Engineering-Imperial | Game Engine Game Dev | [open](space-engines-gh-x-st-aeronautical-engineering-imperial-c20bb23e.md) |
