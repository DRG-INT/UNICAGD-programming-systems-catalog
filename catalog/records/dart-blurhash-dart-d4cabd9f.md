...
<!-- canonical: https://pub.dev/packages/blurhash_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/blurhash_dart](https://pub.dev/packages/blurhash_dart) |
| Source record ids | pub_dev-96e9ae27cfec5b |

## System Engineer Summary

A pure dart implementation of the BlurHash algorithm. This package provides both an encoder and a
decoder, as well as some utility extensions.

## Operational Role

For a systems engineer, blurhash_dart belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2023-02-04T18:12:38.723765Z | [https://pub.dev/api/packages/blurhash_dart](https://pub.dev/api/packages/blurhash_dart) |  |
| preview | known | 1.0.0-nullsafety.0 | 2021-01-31T00:45:35.275070Z | [https://pub.dev/api/packages/blurhash_dart](https://pub.dev/api/packages/blurhash_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/blurhash_dart` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-96e9ae27cfec5b` from `pub_dev` as `registry_expansion`
