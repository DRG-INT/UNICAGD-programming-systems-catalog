...
<!-- canonical: https://github.com/rhnvrm/galaxy-image-classifier-tensorflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rhnvrm/galaxy-image-classifier-tensorflow](https://github.com/rhnvrm/galaxy-image-classifier-tensorflow) |
| Source record ids | github_search_space_maps-e3e67b04c38f70 |

## System Engineer Summary

Classify whether an image is of a Spiral or an Elliptical Galaxy using Transfer Learning
(Tensorflow)

## Operational Role

For a systems engineer, rhnvrm/galaxy-image-classifier-tensorflow belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-25T19:26:30Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e3e67b04c38f70` from `github_search_space_maps` as `registry_expansion`
