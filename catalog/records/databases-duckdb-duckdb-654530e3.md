...
<!-- canonical: https://github.com/duckdb/duckdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/duckdb/duckdb](https://github.com/duckdb/duckdb) |
| Source record ids | github_search_databases-6b1811228d817a |
...
For a systems engineer, duckdb/duckdb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:52:39Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6b1811228d817a` from `github_search_databases` as `registry_expansion`
