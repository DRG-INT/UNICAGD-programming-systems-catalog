...
| Source record ids | corpus-9b45deeb3a38f6 |

## System Engineer Summary

CodeQL JavaScript is tracked as a static analyzer record in the Node.js/JavaScript branch. The
...
For a systems engineer, CodeQL JavaScript belongs in the Node.js/JavaScript inventory as part of
...
- `corpus-9b45deeb3a38f6` from `master_json` as `static_analyzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Semgrep JavaScript | Static Analyzer | [open](node-js-javascript-semgrep-javascript-667d1d65.md) |
| SonarJS | Static Analyzer | [open](node-js-javascript-sonarjs-252d9793.md) |
