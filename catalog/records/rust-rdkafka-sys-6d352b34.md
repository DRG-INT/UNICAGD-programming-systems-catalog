...
| Canonical URL | [https://crates.io/crates/rdkafka-sys](https://crates.io/crates/rdkafka-sys) |
| Source record ids | crates_io-6c7750cc23155b |
...
For a systems engineer, rdkafka-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.10.0+2.12.1 | 2026-01-25T16:02:29.497604Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-6c7750cc23155b` from `crates_io` as `registry_expansion`
