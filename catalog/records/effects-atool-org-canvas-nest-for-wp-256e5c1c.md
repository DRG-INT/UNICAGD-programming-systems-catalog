...
<!-- canonical: https://github.com/aTool-org/canvas-nest-for-wp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aTool-org/canvas-nest-for-wp](https://github.com/aTool-org/canvas-nest-for-wp) |
| Source record ids | github_search_effects-078de44bc75253 |

## System Engineer Summary

:zap: A wordpress plugin of canvas-nest.js (Interactive Particle / Nest System With JavaScript and
Canvas, Do not Depends on jQuery)

## Operational Role

For a systems engineer, aTool-org/canvas-nest-for-wp belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-14T12:12:34Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-078de44bc75253` from `github_search_effects` as `registry_expansion`
