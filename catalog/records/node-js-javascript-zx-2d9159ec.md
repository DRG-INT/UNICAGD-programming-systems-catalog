...
| Source record ids | corpus-ff2c8566ebfad2 |

## System Engineer Summary

zx is tracked as a cli record in the Node.js/JavaScript branch. The source did not provide a long
...
For a systems engineer, zx belongs in the Node.js/JavaScript inventory as part of ecosystem
...
- `corpus-ff2c8566ebfad2` from `master_json` as `cli`
