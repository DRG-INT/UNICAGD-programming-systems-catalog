...
<!-- canonical: https://github.com/LambdaHack/LambdaHack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LambdaHack/LambdaHack](https://github.com/LambdaHack/LambdaHack) |
| Source record ids | github_search_engines-84b059df8026f0 |

## System Engineer Summary

Haskell game engine library for roguelike dungeon crawlers; please offer feedback, e.g., after
trying out the sample game with the web frontend at

## Operational Role

For a systems engineer, LambdaHack/LambdaHack belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:12:56Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-84b059df8026f0` from `github_search_engines` as `registry_expansion`
