...
<!-- canonical: https://cran.r-project.org/web/packages/persuasio/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/persuasio/index.html](https://cran.r-project.org/web/packages/persuasio/index.html) |
| Source record ids | cran_packages_by_date-13c984b5417c8e |
...
For a systems engineer, persuasio belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 17:30:08 UTC | [https://cran.r-project.org/web/packages/persuasio/DESCRIPTION](https://cran.r-project.org/web/packages/persuasio/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/persuasio/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-13c984b5417c8e` from `cran_packages_by_date` as `registry_expansion`
