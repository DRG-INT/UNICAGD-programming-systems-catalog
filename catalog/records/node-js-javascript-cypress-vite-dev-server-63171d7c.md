...
<!-- canonical: https://www.npmjs.com/package/@cypress/vite-dev-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@cypress/vite-dev-server](https://www.npmjs.com/package/@cypress/vite-dev-server) |
| Source record ids | npm_registry-550ea86cfb479a |
...
For a systems engineer, @cypress/vite-dev-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-08-26T23:22:42.326Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-550ea86cfb479a` from `npm_registry` as `registry_expansion`
