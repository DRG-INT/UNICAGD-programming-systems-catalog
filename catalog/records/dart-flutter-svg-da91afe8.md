...
<!-- canonical: https://pub.dev/packages/flutter_svg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_svg](https://pub.dev/packages/flutter_svg) |
| Source record ids | pub_dev-45c8432ba8043d |
...
For a systems engineer, flutter_svg belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-05-08T22:33:36.973597Z | [https://pub.dev/api/packages/flutter_svg](https://pub.dev/api/packages/flutter_svg) |  |
| preview | known | 2.0.0-dev.2 | 2023-01-20T19:14:34.678687Z | [https://pub.dev/api/packages/flutter_svg](https://pub.dev/api/packages/flutter_svg) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_svg` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-45c8432ba8043d` from `pub_dev` as `registry_expansion`
