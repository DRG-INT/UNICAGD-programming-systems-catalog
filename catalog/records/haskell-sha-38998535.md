...
<!-- canonical: https://hackage.haskell.org/package/SHA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/SHA](https://hackage.haskell.org/package/SHA) |
| Source record ids | hackage_top_downloads-846f39a40a1309 |
...
For a systems engineer, SHA belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.4.4 | 2018-03-15T00:38:32Z | [https://hackage.haskell.org/package/SHA](https://hackage.haskell.org/package/SHA) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/SHA` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-846f39a40a1309` from `hackage_top_downloads` as `registry_expansion`
