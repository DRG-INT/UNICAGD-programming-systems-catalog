...
<!-- canonical: https://cran.r-project.org/web/packages/gp3sequences/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gp3sequences/index.html](https://cran.r-project.org/web/packages/gp3sequences/index.html) |
| Source record ids | cran_packages_by_date-f398837cd5df35 |

## System Engineer Summary

Transparent Analysis of Ordered Categorical Sequences

## Operational Role

For a systems engineer, gp3sequences belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-23 10:40:25 UTC | [https://cran.r-project.org/web/packages/gp3sequences/DESCRIPTION](https://cran.r-project.org/web/packages/gp3sequences/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gp3sequences/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f398837cd5df35` from `cran_packages_by_date` as `registry_expansion`
