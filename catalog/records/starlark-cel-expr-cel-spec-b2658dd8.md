...
| Canonical URL | [https://github.com/cel-expr/cel-spec](https://github.com/cel-expr/cel-spec) |
| Source record ids | github_search_starlark-8d9a0adae62a86 |
...
For a systems engineer, cel-expr/cel-spec belongs in the Starlark inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.25.3 | 2026-08-13T21:27:23Z | [https://api.github.com/repos/cel-expr/cel-spec/releases/latest](https://api.github.com/repos/cel-expr/cel-spec/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cel-expr/cel-spec/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-8d9a0adae62a86` from `github_search_starlark` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bazel-contrib/rules_foreign_cc | Language Specification | [open](starlark-bazel-contrib-rules-foreign-cc-74f543fe.md) |
