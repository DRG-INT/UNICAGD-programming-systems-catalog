...
<!-- canonical: https://pub.dev/packages/localstorage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/localstorage](https://pub.dev/packages/localstorage) |
| Source record ids | pub_dev-9b29e169ed5b66 |
...
For a systems engineer, localstorage belongs in the Dart inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2025-03-18T11:06:50.301254Z | [https://pub.dev/api/packages/localstorage](https://pub.dev/api/packages/localstorage) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/localstorage` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-9b29e169ed5b66` from `pub_dev` as `registry_expansion`
