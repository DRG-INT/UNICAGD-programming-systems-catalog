...
<!-- canonical: https://crates.io/crates/x11rb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/x11rb](https://crates.io/crates/x11rb) |
| Source record ids | crates_io-5d8414154cce3d |

## System Engineer Summary

x11rb is tracked as a ffi bindings record in the Rust branch. The source did not provide a long
...
For a systems engineer, x11rb belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-07-16T16:11:43.417073Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-5d8414154cce3d` from `crates_io` as `registry_expansion`
