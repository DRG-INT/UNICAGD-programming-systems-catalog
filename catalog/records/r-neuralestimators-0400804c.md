...
<!-- canonical: https://cran.r-project.org/web/packages/NeuralEstimators/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NeuralEstimators/index.html](https://cran.r-project.org/web/packages/NeuralEstimators/index.html) |
| Source record ids | cran_packages_by_date-74805ad82d5085 |
...
For a systems engineer, NeuralEstimators belongs in the R inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-09 06:30:03 UTC | [https://cran.r-project.org/web/packages/NeuralEstimators/DESCRIPTION](https://cran.r-project.org/web/packages/NeuralEstimators/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NeuralEstimators/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-74805ad82d5085` from `cran_packages_by_date` as `registry_expansion`
