...
<!-- canonical: https://cran.r-project.org/web/packages/metaselection/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metaselection/index.html](https://cran.r-project.org/web/packages/metaselection/index.html) |
| Source record ids | cran_packages_by_date-07d12d4d957b3e |
...
For a systems engineer, metaselection belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-31 14:10:02 UTC | [https://cran.r-project.org/web/packages/metaselection/DESCRIPTION](https://cran.r-project.org/web/packages/metaselection/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metaselection/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-07d12d4d957b3e` from `cran_packages_by_date` as `registry_expansion`
