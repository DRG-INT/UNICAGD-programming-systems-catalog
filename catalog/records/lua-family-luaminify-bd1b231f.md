...
| Source record ids | corpus-2826e098ca7b6c |

## System Engineer Summary

LuaMinify is tracked as a parser lexer ast record in the Lua family branch. The source did not
...
For a systems engineer, LuaMinify belongs in the Lua family inventory as part of language tooling,
...
- `corpus-2826e098ca7b6c` from `master_json` as `parser_lexer_ast`
