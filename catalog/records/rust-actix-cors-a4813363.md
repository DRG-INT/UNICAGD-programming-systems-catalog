...
<!-- canonical: https://crates.io/crates/actix-cors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-cors](https://crates.io/crates/actix-cors) |
| Source record ids | crates_io-000444203d26ed |
...
For a systems engineer, actix-cors belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2026-08-24T14:19:03.269184Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; Other |
...
| attribute-derive | Filesystem Os | [open](rust-attribute-derive-bce29c52.md) |
