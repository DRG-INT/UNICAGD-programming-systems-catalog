...
<!-- canonical: https://pub.dev/packages/marquee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/marquee](https://pub.dev/packages/marquee) |
| Source record ids | pub_dev-267174f962628c |

## System Engineer Summary

A Flutter widget that scrolls text infinitely. Provides many customizations including custom scroll
directions, durations, curves as well as pauses after every round.

## Operational Role

For a systems engineer, marquee belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2024-10-10T10:26:12.302061Z | [https://pub.dev/api/packages/marquee](https://pub.dev/api/packages/marquee) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/marquee` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-267174f962628c` from `pub_dev` as `registry_expansion`
