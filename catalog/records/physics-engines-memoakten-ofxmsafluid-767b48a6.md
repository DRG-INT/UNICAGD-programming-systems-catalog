...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/memoakten/ofxMSAFluid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/memoakten/ofxMSAFluid](https://github.com/memoakten/ofxMSAFluid) |
| Source record ids | github_search_physics_engines-b2cb5db6b874d8 |

## System Engineer Summary

C++ openFrameworks addon for solving and drawing 2D fluid systems based on Navier-Stokes equations
and Jos Stam's paper "Real-Time Fluid Dynamics for Games"

## Operational Role

For a systems engineer, memoakten/ofxMSAFluid belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-03T11:50:52Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-b2cb5db6b874d8` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| MazeMap/Leaflet.LayerGroup.Collision | Fuzzer | [open](physics-engines-mazemap-leaflet-layergroup-collision-8bb51811.md) |
| mushe/NiagaraFluid | Fuzzer | [open](physics-engines-mushe-niagarafluid-38a74f5a.md) |
