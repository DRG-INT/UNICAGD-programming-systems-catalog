...
<!-- canonical: https://github.com/magefree/mage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/magefree/mage](https://github.com/magefree/mage) |
| Source record ids | github_search_game_engines-db5a5cdfddef6d |
...
For a systems engineer, magefree/mage belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:04:10Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-db5a5cdfddef6d` from `github_search_game_engines` as `registry_expansion`
