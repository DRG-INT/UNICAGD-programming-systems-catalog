# github.com/alexandremahdhaoui/forge-register-spec

## Navigation

[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pkg.go.dev/github.com/alexandremahdhaoui/forge-register-spec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pkg.go.dev/github.com/alexandremahdhaoui/forge-register-spec](https://pkg.go.dev/github.com/alexandremahdhaoui/forge-register-spec) |
| Source record ids | go_module_index-a06fbdd2cede59 |

## System Engineer Summary

Go module observed in the public Go module index with timestamped version metadata.

## Operational Role

For a systems engineer, github.com/alexandremahdhaoui/forge-register-spec belongs in the Go
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.45.5 | 2026-08-30T11:56:16.502522Z | [https://index.golang.org/index?since=2026-08-30T11%3A23%3A29.88054Z&limit=2000](https://index.golang.org/index?since=2026-08-30T11%3A23%3A29.88054Z&limit=2000) |  |
| preview/nightly | unknown |  |  | unknown | go_module_index_has_no_standard_nightly_channel |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://index.golang.org/index?since=2026-08-30T11%3A23%3A29.88054Z&limit=2000` at `2026-09-01T09:20:34+00:00`.
- Preview/nightly metadata is unknown because `go_module_index_has_no_standard_nightly_channel`.
...
| --- | --- | --- | --- |
| go_module_index | registry-derived | 2026-09-01 | `{"kind": "go_module_index", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `go_module_index-a06fbdd2cede59` from `go_module_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bluenviron/mediamtx | Undefined Behavior Analyzer | [open](go-bluenviron-mediamtx-aebc3b64.md) |
| dariubs/GoBooks | Undefined Behavior Analyzer | [open](go-dariubs-gobooks-0b7963ea.md) |
| eryajf/learning-weekly | Undefined Behavior Analyzer | [open](go-eryajf-learning-weekly-a4ad8741.md) |
| github.com/01org/isa-l | Undefined Behavior Analyzer | [open](go-github-com-01org-isa-l-8ef09eb2.md) |
| github.com/1panel-dev/1Panel/agent | Undefined Behavior Analyzer | [open](go-github-com-1panel-dev-1panel-agent-8df4b3a6.md) |
| github.com/2rumaki-playground/game-001-dungeon-cards | Undefined Behavior Analyzer | [open](go-github-com-2rumaki-playground-game-001-dungeon-cards-97fa2334.md) |
| github.com/521xueweihan/github520 | Undefined Behavior Analyzer | [open](go-github-com-521xueweihan-github520-7ec64a81.md) |
| github.com/aastarcommunity/aastar-sdk | Undefined Behavior Analyzer | [open](go-github-com-aastarcommunity-aastar-sdk-8eafde11.md) |
