...
<!-- canonical: https://pub.dev/packages/flutter_context_menu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_context_menu](https://pub.dev/packages/flutter_context_menu) |
| Source record ids | pub_dev-1e755c0e5e6f6e |
...
For a systems engineer, flutter_context_menu belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-02-26T06:36:32.563560Z | [https://pub.dev/api/packages/flutter_context_menu](https://pub.dev/api/packages/flutter_context_menu) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_context_menu` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-1e755c0e5e6f6e` from `pub_dev` as `registry_expansion`
