...
<!-- canonical: https://crates.io/crates/cbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cbc](https://crates.io/crates/cbc) |
| Source record ids | crates_io-0f9db5c91ba86e |
...
For a systems engineer, cbc belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-05-20T12:23:22.500181Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-0f9db5c91ba86e` from `crates_io` as `registry_expansion`
