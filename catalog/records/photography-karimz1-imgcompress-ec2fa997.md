...
| Canonical URL | [https://github.com/karimz1/imgcompress](https://github.com/karimz1/imgcompress) |
| Source record ids | github_search_photography-2233eb42bdd6cf |

## System Engineer Summary

Imgcompress is a self-hosted image processing toolbox that handles compression, format conversion,
and AI background removal in a single web interface. It supports over 70 input formats (including
PSD, HEIC, and RAW) and can output common formats or generate PDFs, all without sending files to
external services.

## Operational Role

For a systems engineer, karimz1/imgcompress belongs in the Photography inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | release_0.9.0 | 2026-08-21T23:05:12Z | [https://api.github.com/repos/karimz1/imgcompress/releases/latest](https://api.github.com/repos/karimz1/imgcompress/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/karimz1/imgcompress/releases/latest` at `2026-09-01T09:23:31+00:00`.
...
- `github_search_photography-2233eb42bdd6cf` from `github_search_photography` as `registry_expansion`
