...
<!-- canonical: https://www.npmjs.com/package/create-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/create-server](https://www.npmjs.com/package/create-server) |
| Source record ids | npm_registry-f6ac6300308608 |
...
For a systems engineer, create-server belongs in the Node.js/JavaScript inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2019-04-30T17:53:36.367Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-f6ac6300308608` from `npm_registry` as `registry_expansion`
