...
<!-- canonical: https://pypi.org/project/acrolint/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acrolint/](https://pypi.org/project/acrolint/) |
| Source record ids | pypi_simple-5325331539396a |
...
For a systems engineer, acrolint belongs in the Python inventory as part of static feedback, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-06-26T08:13:33.549901Z | [https://pypi.org/pypi/acrolint/json](https://pypi.org/pypi/acrolint/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acrolint/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-5325331539396a` from `pypi_simple` as `registry_expansion`
