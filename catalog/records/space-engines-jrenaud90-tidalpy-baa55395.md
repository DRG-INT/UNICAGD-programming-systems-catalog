...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_space_engines-02f22d1108ab7e |
...
For a systems engineer, jrenaud90/TidalPy belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.7.4 | 2026-03-27T21:39:55Z | [https://api.github.com/repos/jrenaud90/TidalPy/releases/latest](https://api.github.com/repos/jrenaud90/TidalPy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jrenaud90/TidalPy/releases/latest` at `2026-09-01T07:24:18+00:00`.
...
- `github_search_space_engines-02f22d1108ab7e` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| arasgungore/rocket-flight-simulator | Visualization Gui | [open](space-engines-arasgungore-rocket-flight-simulator-edf8af6f.md) |
| davidcalhoun/tle.js | Visualization Gui | [open](space-engines-davidcalhoun-tle-js-9c1d96d7.md) |
| ep2lab/dimagno | Visualization Gui | [open](space-engines-ep2lab-dimagno-ff2efe6b.md) |
