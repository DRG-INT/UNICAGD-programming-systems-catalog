...
<!-- canonical: https://github.com/Altanis/kinetics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Altanis/kinetics](https://github.com/Altanis/kinetics) |
| Source record ids | github_search_physics_engines-405d0c90add270 |
...
For a systems engineer, Altanis/kinetics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-11T19:31:03Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-405d0c90add270` from `github_search_physics_engines` as `registry_expansion`
...
| Sopiro/Physics | Type Checker | [open](physics-engines-sopiro-physics-c3dcc844.md) |
