...
<!-- canonical: https://luarocks.org/modules/mah0x211/cache-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/cache-redis](https://luarocks.org/modules/mah0x211/cache-redis) |
| Source record ids | luarocks_root_manifest-681ddbde16254c |
...
For a systems engineer, cache-redis belongs in the Lua family inventory as part of state
...
- `luarocks_root_manifest-681ddbde16254c` from `luarocks_root_manifest` as `registry_expansion`
