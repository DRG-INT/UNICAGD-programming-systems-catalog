...
<!-- canonical: https://github.com/leg234-png/Projet_Contact -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leg234-png/Projet_Contact](https://github.com/leg234-png/Projet_Contact) |
| Source record ids | github_search_repertoare_catalogs-f5675154972b8d |

## System Engineer Summary

On se propose de développer une application JAVA pour gérer le répertoire des contacts pour votre
établissement. Un Contact est un Etudiant, un Enseignant ou un Agent administratif. Les contacts
sont enregistrés dans le répertoire sous forme d’une collection.

## Operational Role

For a systems engineer, leg234-png/Projet_Contact belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-01T17:29:53Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-f5675154972b8d` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Waribiz/apps-collections | Filesystem Os | [open](repertoare-catalogs-waribiz-apps-collections-d259531c.md) |
