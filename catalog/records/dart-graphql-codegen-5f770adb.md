...
<!-- canonical: https://pub.dev/packages/graphql_codegen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/graphql_codegen](https://pub.dev/packages/graphql_codegen) |
| Source record ids | pub_dev-e2e88f5c82056a |

## System Engineer Summary

Simple, opinionated, codegen library for GraphQL. It allows you to generate serializers and client
helpers to easily call and parse your data.

## Operational Role

For a systems engineer, graphql_codegen belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-07-05T20:54:26.505804Z | [https://pub.dev/api/packages/graphql_codegen](https://pub.dev/api/packages/graphql_codegen) |  |
| preview | known | 0.12.0-beta.18 | 2023-03-30T07:01:21.948935Z | [https://pub.dev/api/packages/graphql_codegen](https://pub.dev/api/packages/graphql_codegen) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/graphql_codegen` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-e2e88f5c82056a` from `pub_dev` as `registry_expansion`
