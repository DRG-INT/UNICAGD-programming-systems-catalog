...
<!-- canonical: https://hackage.haskell.org/package/bishbosh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bishbosh](https://hackage.haskell.org/package/bishbosh) |
| Source record ids | hackage_top_downloads-37d015fb27930c |
...
For a systems engineer, bishbosh belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4.0 | 2021-12-26T16:25:52Z | [https://hackage.haskell.org/package/bishbosh](https://hackage.haskell.org/package/bishbosh) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bishbosh` at `2026-09-11T00:31:14+00:00`.
...
- `hackage_top_downloads-37d015fb27930c` from `hackage_top_downloads` as `registry_expansion`
