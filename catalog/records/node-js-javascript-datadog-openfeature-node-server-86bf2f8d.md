...
<!-- canonical: https://www.npmjs.com/package/@datadog/openfeature-node-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@datadog/openfeature-node-server](https://www.npmjs.com/package/@datadog/openfeature-node-server) |
| Source record ids | npm_registry-faf6d0673dbfab |
...
For a systems engineer, @datadog/openfeature-node-server belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-21T16:37:22.615Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-faf6d0673dbfab` from `npm_registry` as `registry_expansion`
