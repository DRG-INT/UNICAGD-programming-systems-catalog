...
<!-- canonical: https://go.dev/doc/contribute -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://go.dev/doc/contribute](https://go.dev/doc/contribute) |
| Source record ids | curated_repository_workplace_routes-614c9c317d42a1 |

## System Engineer Summary

Official Go contribution guide and source workflow entry point.

## Operational Role

For a systems engineer, Go Dev Source Guide belongs in the Repository Workplaces inventory as part
...
- `curated_repository_workplace_routes-614c9c317d42a1` from `curated_repository_workplace_routes` as `registry_expansion`
