...
<!-- canonical: https://cran.r-project.org/web/packages/shiftR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shiftR/index.html](https://cran.r-project.org/web/packages/shiftR/index.html) |
| Source record ids | cran_packages_by_date-4a46273c9e9162 |
...
For a systems engineer, shiftR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6 | 2026-09-01 19:20:02 UTC | [https://cran.r-project.org/web/packages/shiftR/DESCRIPTION](https://cran.r-project.org/web/packages/shiftR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shiftR/DESCRIPTION` at `2026-09-01T20:19:19+00:00`.
...
- `cran_packages_by_date-4a46273c9e9162` from `cran_packages_by_date` as `registry_expansion`
