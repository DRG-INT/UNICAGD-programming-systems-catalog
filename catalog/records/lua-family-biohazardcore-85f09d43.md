...
<!-- canonical: https://luarocks.org/modules/thewizardplusplus/biohazardcore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thewizardplusplus/biohazardcore](https://luarocks.org/modules/thewizardplusplus/biohazardcore) |
| Source record ids | luarocks_root_manifest-d0e0ce0dfe4400 |

## System Engineer Summary

biohazardcore is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, biohazardcore belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d0e0ce0dfe4400` from `luarocks_root_manifest` as `registry_expansion`
