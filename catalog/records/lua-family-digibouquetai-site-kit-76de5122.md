...
<!-- canonical: https://luarocks.org/modules/bbwdadfg/digibouquetai-site-kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bbwdadfg/digibouquetai-site-kit](https://luarocks.org/modules/bbwdadfg/digibouquetai-site-kit) |
| Source record ids | luarocks_root_manifest-88c5f9ee9e7fec |
...
For a systems engineer, digibouquetai-site-kit belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-88c5f9ee9e7fec` from `luarocks_root_manifest` as `registry_expansion`
