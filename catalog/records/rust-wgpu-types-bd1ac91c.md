...
| Canonical URL | [https://crates.io/crates/wgpu-types](https://crates.io/crates/wgpu-types) |
| Source record ids | crates_io-086a6eb8277586 |
...
For a systems engineer, wgpu-types belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 30.0.1 | 2026-08-22T02:53:27.172546Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-086a6eb8277586` from `crates_io` as `registry_expansion`
