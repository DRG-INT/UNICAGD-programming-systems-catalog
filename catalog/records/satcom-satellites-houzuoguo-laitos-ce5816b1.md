...
<!-- canonical: https://github.com/HouzuoGuo/laitos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HouzuoGuo/laitos](https://github.com/HouzuoGuo/laitos) |
| Source record ids | github_search_satcom_satellites-30707b4500e979 |

## System Engineer Summary

Top geek's chindogu - personal assistant over satellite/telephone/SMS/chatbot, plus web
infrastructure servers (web & mail, ad-free DNS, TCP-over-DNS, web proxy, etc)

## Operational Role

For a systems engineer, HouzuoGuo/laitos belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0 | 2024-09-10T07:58:58Z | [https://api.github.com/repos/HouzuoGuo/laitos/releases/latest](https://api.github.com/repos/HouzuoGuo/laitos/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/HouzuoGuo/laitos/releases/latest` at `2026-09-01T08:26:35+00:00`.
...
- `github_search_satcom_satellites-30707b4500e979` from `github_search_satcom_satellites` as `registry_expansion`
