...
<!-- canonical: https://docs.github.com/packages -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.github.com/packages](https://docs.github.com/packages) |
| Source record ids | curated_repository_workplace_routes-54af4770c2e7ae |

## System Engineer Summary

GitHub package registry for containers and language package ecosystems.

## Operational Role

For a systems engineer, GitHub Packages belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-54af4770c2e7ae` from `curated_repository_workplace_routes` as `registry_expansion`
