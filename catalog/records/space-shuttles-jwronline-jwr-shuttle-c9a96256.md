...
<!-- canonical: https://github.com/jwronline/jwr-shuttle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jwronline/jwr-shuttle](https://github.com/jwronline/jwr-shuttle) |
| Source record ids | github_search_space_shuttles-bedf7350a59c4b |

## System Engineer Summary

Space shuttle files of JWR

## Operational Role

For a systems engineer, jwronline/jwr-shuttle belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-11-01T14:43:05Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-bedf7350a59c4b` from `github_search_space_shuttles` as `registry_expansion`
