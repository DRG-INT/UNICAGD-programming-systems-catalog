...
<!-- canonical: https://github.com/doujiang24/lua-resty-kafka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doujiang24/lua-resty-kafka](https://github.com/doujiang24/lua-resty-kafka) |
| Source record ids | lua-source-310 |
...
For a systems engineer, lua-resty-kafka belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 310}}` |
...
- `lua-source-310` from `master_json` as `source_list_item`
