...
<!-- canonical: https://pub.dev/packages/flutter_portal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_portal](https://pub.dev/packages/flutter_portal) |
| Source record ids | pub_dev-b2e7df35072360 |
...
For a systems engineer, flutter_portal belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2023-05-24T12:29:13.655367Z | [https://pub.dev/api/packages/flutter_portal](https://pub.dev/api/packages/flutter_portal) |  |
| preview | known | 1.0.0-dev.2 | 2022-03-21T08:42:26.363880Z | [https://pub.dev/api/packages/flutter_portal](https://pub.dev/api/packages/flutter_portal) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_portal` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-b2e7df35072360` from `pub_dev` as `registry_expansion`
