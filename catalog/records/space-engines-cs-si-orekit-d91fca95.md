...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/CS-SI/Orekit](https://github.com/CS-SI/Orekit) |
| Source record ids | github_search_space_engines-f57a24243081cf |

## System Engineer Summary

OREKIT is a free low level space dynamics library written in Java. Please visit our Gitlab instance
for issues and contributions:

## Operational Role

For a systems engineer, CS-SI/Orekit belongs in the Space Engines inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.1.8 | 2026-08-30T20:36:43Z | [https://api.github.com/repos/CS-SI/Orekit/releases/latest](https://api.github.com/repos/CS-SI/Orekit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CS-SI/Orekit/releases/latest` at `2026-09-01T07:24:16+00:00`.
...
- `github_search_space_engines-f57a24243081cf` from `github_search_space_engines` as `registry_expansion`
