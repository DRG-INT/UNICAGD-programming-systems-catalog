...
| Canonical URL | [https://crates.io/crates/libsecp256k1-core](https://crates.io/crates/libsecp256k1-core) |
| Source record ids | crates_io-8db2161b9000da |
...
For a systems engineer, libsecp256k1-core belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2021-09-17T11:18:22.532527Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-8db2161b9000da` from `crates_io` as `registry_expansion`
