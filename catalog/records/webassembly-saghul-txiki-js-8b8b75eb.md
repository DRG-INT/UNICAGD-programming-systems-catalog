...
<!-- canonical: https://github.com/saghul/txiki.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/saghul/txiki.js](https://github.com/saghul/txiki.js) |
| Source record ids | github_search_webassembly-b8bf9b76166bbb |
...
For a systems engineer, saghul/txiki.js belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T09:17:08Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b8bf9b76166bbb` from `github_search_webassembly` as `registry_expansion`
