...
| Source record ids | master-3a471315a851 |

## System Engineer Summary

Lua 5.2 language/reference line

## Operational Role

For a systems engineer, Lua 5.2 belongs in the Lua family inventory as part of ecosystem capability
...
- `master-3a471315a851` from `master_json` as `language_specification`
