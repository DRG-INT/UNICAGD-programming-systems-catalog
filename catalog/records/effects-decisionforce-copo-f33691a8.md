...
<!-- canonical: https://github.com/decisionforce/CoPO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/decisionforce/CoPO](https://github.com/decisionforce/CoPO) |
| Source record ids | github_search_effects-994fe2336f570e |

## System Engineer Summary

NeurIPS 2021 Official implementation of paper "Learning to Simulate Self-driven Particles System
with Coordinated Policy Optimization".

## Operational Role

For a systems engineer, decisionforce/CoPO belongs in the Effects inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-29T20:57:35Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-994fe2336f570e` from `github_search_effects` as `registry_expansion`
