...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Microsoft.Extensions.Http.Resilience -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Extensions.Http.Resilience](https://www.nuget.org/packages/Microsoft.Extensions.Http.Resilience) |
| Source record ids | nuget_search-cbc29f8a3f0019 |
...
For a systems engineer, Microsoft.Extensions.Http.Resilience belongs in the C-Sharp inventory as
part of service communication, clients/servers, protocol handling, and edge integration.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.9.0 | 2026-08-11T23:33:44.407+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.resilience/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.resilience/index.json) |  |
| preview | known | 9.0.0-preview.9.24507.7 | 2024-10-08T15:05:59.183+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.resilience/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.resilience/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT; https://www.nuget.org/packages/Microsoft.Extensions.Http.Resilience/10.9.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.resilience/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-cbc29f8a3f0019` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Agoda.Frameworks.Http | Networking Http | [open](c-sharp-agoda-frameworks-http-9635f4f9.md) |
| Asp.Versioning.Http | Networking Http | [open](c-sharp-asp-versioning-http-879dc84d.md) |
| HotChocolate.Transport.Http | Networking Http | [open](c-sharp-hotchocolate-transport-http-99c9a830.md) |
| Microsoft.AspNetCore.Http | Networking Http | [open](c-sharp-microsoft-aspnetcore-http-7578d31f.md) |
| Microsoft.AspNetCore.Http.Connections | Networking Http | [open](c-sharp-microsoft-aspnetcore-http-connections-f55191b6.md) |
| Microsoft.AspNetCore.Http.Extensions | Networking Http | [open](c-sharp-microsoft-aspnetcore-http-extensions-3ffb3529.md) |
| Microsoft.AspNetCore.Server.HttpSys | Networking Http | [open](c-sharp-microsoft-aspnetcore-server-httpsys-6621333f.md) |
| Microsoft.Azure.Functions.Worker.Extensions.Http | Networking Http | [open](c-sharp-microsoft-azure-functions-worker-extensions-http-7397a241.md) |
