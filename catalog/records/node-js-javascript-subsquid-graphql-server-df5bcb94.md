...
<!-- canonical: https://www.npmjs.com/package/@subsquid/graphql-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@subsquid/graphql-server](https://www.npmjs.com/package/@subsquid/graphql-server) |
| Source record ids | npm_registry-c2b5f15171a2fb |

## System Engineer Summary

GraphQL server for squid project

## Operational Role

For a systems engineer, @subsquid/graphql-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.12.1 | 2026-07-10T07:12:01.996Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-c2b5f15171a2fb` from `npm_registry` as `registry_expansion`
