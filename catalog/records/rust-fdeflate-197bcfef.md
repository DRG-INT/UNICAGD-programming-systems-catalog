...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/fdeflate](https://crates.io/crates/fdeflate) |
| Source record ids | crates_io-d888cd1349e137 |
...
For a systems engineer, fdeflate belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7 | 2024-12-06T03:16:12.038530Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| ab_glyph | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ab-glyph-3c09fcfd.md) |
| accesskit | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-accesskit-a63f7c0f.md) |
| actix-web | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-actix-web-e495971a.md) |
| aligned | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aligned-245f08da.md) |
| android-tzdata | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-android-tzdata-a484d5c8.md) |
| arrow-cast | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-arrow-cast-3b73debe.md) |
| asn1-rs | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-asn1-rs-3c753ed8.md) |
| ast_node | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ast-node-354a9722.md) |
