...
<!-- canonical: https://cran.r-project.org/web/packages/stan4bart/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stan4bart/index.html](https://cran.r-project.org/web/packages/stan4bart/index.html) |
| Source record ids | cran_packages_by_date-abd188e78b8d29 |
...
For a systems engineer, stan4bart belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0-13 | 2026-08-21 23:20:02 UTC | [https://cran.r-project.org/web/packages/stan4bart/DESCRIPTION](https://cran.r-project.org/web/packages/stan4bart/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stan4bart/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-abd188e78b8d29` from `cran_packages_by_date` as `registry_expansion`
