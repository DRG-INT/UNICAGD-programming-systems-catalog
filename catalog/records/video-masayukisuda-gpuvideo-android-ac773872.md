...
<!-- canonical: https://github.com/MasayukiSuda/GPUVideo-android -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MasayukiSuda/GPUVideo-android](https://github.com/MasayukiSuda/GPUVideo-android) |
| Source record ids | github_search_video-e929faead0bd87 |

## System Engineer Summary

This library apply video filter on generate an Mp4 and on ExoPlayer video and Video Recording with
Camera2.

## Operational Role

For a systems engineer, MasayukiSuda/GPUVideo-android belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-25T07:14:37Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-e929faead0bd87` from `github_search_video` as `registry_expansion`
