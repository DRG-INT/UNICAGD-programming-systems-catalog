...
<!-- canonical: https://github.com/SamiPerttu/fundsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SamiPerttu/fundsp](https://github.com/SamiPerttu/fundsp) |
| Source record ids | github_search_effects-3fcc97fb8befb9 |
...
For a systems engineer, SamiPerttu/fundsp belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-03T15:41:09Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3fcc97fb8befb9` from `github_search_effects` as `registry_expansion`
