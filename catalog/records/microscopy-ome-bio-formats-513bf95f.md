...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/ome/bioformats](https://github.com/ome/bioformats) |
| Source record ids | curated_language_routes-f1336a3d17c4e7 |

## System Engineer Summary

Microscopy image format library for reading proprietary and open biological imaging data formats.

## Operational Role

For a systems engineer, OME Bio-Formats belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v8.5.0 | 2026-03-18T13:48:00Z | [https://api.github.com/repos/ome/bioformats/releases/latest](https://api.github.com/repos/ome/bioformats/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ome/bioformats/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-f1336a3d17c4e7` from `curated_language_routes` as `registry_expansion`
