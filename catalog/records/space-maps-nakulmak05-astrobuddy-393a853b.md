...
<!-- canonical: https://github.com/NAKULMAK05/AstroBuddy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NAKULMAK05/AstroBuddy](https://github.com/NAKULMAK05/AstroBuddy) |
| Source record ids | github_search_space_maps-e5b58e00d6353a |

## System Engineer Summary

AstroBuddy is an interactive tool that delivers real-time sky maps and updates on celestial events.
Experience a seamless fusion of intuitive visuals and educational insights to enhance your
stargazing journey.

## Operational Role

For a systems engineer, NAKULMAK05/AstroBuddy belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-23T17:53:30Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e5b58e00d6353a` from `github_search_space_maps` as `registry_expansion`
