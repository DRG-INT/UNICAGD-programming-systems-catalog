...
| Source record ids | github_search_electromagnetoscopes-82e29fe06c61ee |
...
For a systems engineer, gqrx-sdr/gqrx belongs in the Electromagnetoscopes inventory as part of
...
- Latest stable metadata was observed from `https://api.github.com/repos/gqrx-sdr/gqrx/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-82e29fe06c61ee` from `github_search_electromagnetoscopes` as `registry_expansion`
