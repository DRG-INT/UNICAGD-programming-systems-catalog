...
| Canonical URL | [https://crates.io/crates/data-url](https://crates.io/crates/data-url) |
| Source record ids | crates_io-8336ac000f46bb |
...
For a systems engineer, data-url belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-08-21T08:45:42.636371Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-8336ac000f46bb` from `crates_io` as `registry_expansion`
