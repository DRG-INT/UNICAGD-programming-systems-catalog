...
<!-- canonical: https://github.com/palubad/S1-BAP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/palubad/S1-BAP](https://github.com/palubad/S1-BAP) |
| Source record ids | github_search_radars-5a9d3fd4fa3855 |

## System Engineer Summary

A semi-automatic GEE tool to monitor burned area progression using Sentinel-1 SAR data. Attachment
for the article in the IEEE JSTARS by Paluba D. et al. (2024): Tracking burned area progression in
an unsupervised manner using Sentinel-1 SAR data in Google Earth Engine

## Operational Role

For a systems engineer, palubad/S1-BAP belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-05T14:57:40Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-5a9d3fd4fa3855` from `github_search_radars` as `registry_expansion`
