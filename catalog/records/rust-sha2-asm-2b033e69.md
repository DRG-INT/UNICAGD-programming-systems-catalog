...
| Canonical URL | [https://crates.io/crates/sha2-asm](https://crates.io/crates/sha2-asm) |
| Source record ids | crates_io-35427545661764 |
...
For a systems engineer, sha2-asm belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2024-05-07T16:24:37.057435Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-35427545661764` from `crates_io` as `registry_expansion`
