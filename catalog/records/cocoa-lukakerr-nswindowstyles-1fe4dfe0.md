...
<!-- canonical: https://github.com/lukakerr/NSWindowStyles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lukakerr/NSWindowStyles](https://github.com/lukakerr/NSWindowStyles) |
| Source record ids | github_search_cocoa-34ff255331d8e2 |
...
For a systems engineer, lukakerr/NSWindowStyles belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-30T23:29:35Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-34ff255331d8e2` from `github_search_cocoa` as `registry_expansion`
