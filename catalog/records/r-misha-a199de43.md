...
<!-- canonical: https://cran.r-project.org/web/packages/misha/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/misha/index.html](https://cran.r-project.org/web/packages/misha/index.html) |
| Source record ids | cran_packages_by_date-9abb008b001f86 |
...
For a systems engineer, misha belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.11.23 | 2026-08-24 13:30:02 UTC | [https://cran.r-project.org/web/packages/misha/DESCRIPTION](https://cran.r-project.org/web/packages/misha/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/misha/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9abb008b001f86` from `cran_packages_by_date` as `registry_expansion`
