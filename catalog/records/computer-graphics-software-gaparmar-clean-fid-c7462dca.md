...
<!-- canonical: https://github.com/GaParmar/clean-fid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GaParmar/clean-fid](https://github.com/GaParmar/clean-fid) |
| Source record ids | github_search_computer_graphics_software-cc70a36fe3e9f3 |
...
For a systems engineer, GaParmar/clean-fid belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-cc70a36fe3e9f3` from `github_search_computer_graphics_software` as `registry_expansion`
