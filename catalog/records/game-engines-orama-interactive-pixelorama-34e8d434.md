...
| Source record ids | github_search_game_engines-835e5aa8e86671 |
...
For a systems engineer, Orama-Interactive/Pixelorama belongs in the Game Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:35:09Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-835e5aa8e86671` from `github_search_game_engines` as `registry_expansion`
...
| recastnavigation/recastnavigation | Language Specification | [open](game-engines-recastnavigation-recastnavigation-2f97a34b.md) |
