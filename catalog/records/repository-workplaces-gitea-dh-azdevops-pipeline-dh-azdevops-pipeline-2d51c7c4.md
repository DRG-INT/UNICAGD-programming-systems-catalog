# Gitea: dh.azdevops.pipeline/dh.azdevops.pipeline
...
<!-- canonical: https://gitea.com/dh.azdevops.pipeline/dh.azdevops.pipeline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dh.azdevops.pipeline/dh.azdevops.pipeline](https://gitea.com/dh.azdevops.pipeline/dh.azdevops.pipeline) |
| Source record ids | gitea_repositories_api-c8710cd0c487b7 |
...
For a systems engineer, Gitea: dh.azdevops.pipeline/dh.azdevops.pipeline belongs in the Repository
Workplaces inventory as part of dependency acquisition, lockfile policy, provenance control, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-17T11:18:04Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-c8710cd0c487b7` from `gitea_repositories_api` as `registry_expansion`
