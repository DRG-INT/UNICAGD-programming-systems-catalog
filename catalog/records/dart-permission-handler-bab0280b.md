...
<!-- canonical: https://pub.dev/packages/permission_handler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/permission_handler](https://pub.dev/packages/permission_handler) |
| Source record ids | pub_dev-066fd30541934b |

## System Engineer Summary

Permission plugin for Flutter. This plugin provides a cross-platform (iOS, Android) API to request
and check permissions.

## Operational Role

For a systems engineer, permission_handler belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.0.1 | 2026-08-11T06:59:05.753483Z | [https://pub.dev/api/packages/permission_handler](https://pub.dev/api/packages/permission_handler) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/permission_handler` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-066fd30541934b` from `pub_dev` as `registry_expansion`
