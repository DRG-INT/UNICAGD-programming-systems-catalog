# Kai-Wen-Lee/DNS_of_Compound_Droplets

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Kai-Wen-Lee/DNS_of_Compound_Droplets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kai-Wen-Lee/DNS_of_Compound_Droplets](https://github.com/Kai-Wen-Lee/DNS_of_Compound_Droplets) |
| Source record ids | github_search_basilisk-4dec14f6014915 |

## System Engineer Summary

Repository for Basilisk C and Python script for Coaxial Flow Simulation for my 3rd Year Individual
Project.

## Operational Role

For a systems engineer, Kai-Wen-Lee/DNS_of_Compound_Droplets belongs in the Basilisk inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-28T01:37:39Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-4dec14f6014915` from `github_search_basilisk` as `registry_expansion`
