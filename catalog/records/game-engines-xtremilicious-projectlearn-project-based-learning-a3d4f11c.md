...
<!-- canonical: https://github.com/Xtremilicious/projectlearn-project-based-learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Xtremilicious/projectlearn-project-based-learning](https://github.com/Xtremilicious/projectlearn-project-based-learning) |
| Source record ids | github_search_game_engines-47109f9f416216 |
...
For a systems engineer, Xtremilicious/projectlearn-project-based-learning belongs in the Game
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-30T07:41:54Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-47109f9f416216` from `github_search_game_engines` as `registry_expansion`
