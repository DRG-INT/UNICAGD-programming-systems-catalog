...
| Source record ids | curated_database_systems-98db4a455165ac |

## System Engineer Summary

Community-developed relational database server derived from MySQL.

## Operational Role

For a systems engineer, MariaDB belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | mariadb-12.3.3 | 2026-08-24T22:31:19Z | [https://api.github.com/repos/MariaDB/server/releases/latest](https://api.github.com/repos/MariaDB/server/releases/latest) |  |
| preview | known | mariadb-13.0.1 | 2026-05-29T19:32:21Z | [https://api.github.com/repos/MariaDB/server/releases?per_page=10](https://api.github.com/repos/MariaDB/server/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/MariaDB/server/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-98db4a455165ac` from `curated_database_systems` as `registry_expansion`
