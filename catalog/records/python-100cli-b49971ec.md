...
<!-- canonical: https://pypi.org/project/100cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/100cli/](https://pypi.org/project/100cli/) |
| Source record ids | pypi_simple-610f9f7b1c9606 |
...
For a systems engineer, 100cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2025-07-23T09:58:31.140620Z | [https://pypi.org/pypi/100cli/json](https://pypi.org/pypi/100cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/100cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-610f9f7b1c9606` from `pypi_simple` as `registry_expansion`
