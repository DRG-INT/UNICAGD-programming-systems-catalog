...
[Catalog index](../index.md) · [Language: Starlark](../by-language/starlark.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/openrundev/openrun](https://github.com/openrundev/openrun) |
| Source record ids | github_search_starlark-73af40cd7b1b80 |

## System Engineer Summary

Deployment platform for teams to deploy internal tools. Deploy web apps declaratively, on a single-
node or on Kubernetes, with OIDC/SAML auth and RBAC.

## Operational Role

For a systems engineer, openrundev/openrun belongs in the Starlark inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.19.2 | 2026-08-26T01:47:42Z | [https://api.github.com/repos/openrundev/openrun/releases/latest](https://api.github.com/repos/openrundev/openrun/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/openrundev/openrun/releases/latest` at `2026-09-01T09:23:07+00:00`.
...
- `github_search_starlark-73af40cd7b1b80` from `github_search_starlark` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cruise-automation/isopod | Undefined Behavior Analyzer | [open](starlark-cruise-automation-isopod-0fd20340.md) |
| tidbyt/community | Undefined Behavior Analyzer | [open](starlark-tidbyt-community-62c4caad.md) |
