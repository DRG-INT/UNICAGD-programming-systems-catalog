...
<!-- canonical: https://crates.io/crates/prometheus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/prometheus](https://crates.io/crates/prometheus) |
| Source record ids | crates_io-1c8c13c2118d60 |
...
For a systems engineer, prometheus belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2025-03-27T08:38:33.984372Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-1c8c13c2118d60` from `crates_io` as `registry_expansion`
