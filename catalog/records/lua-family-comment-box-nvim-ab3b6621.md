...
<!-- canonical: https://luarocks.org/modules/neorocks/comment-box.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/comment-box.nvim](https://luarocks.org/modules/neorocks/comment-box.nvim) |
| Source record ids | luarocks_root_manifest-6de2b279125d6a |
...
For a systems engineer, comment-box.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6de2b279125d6a` from `luarocks_root_manifest` as `registry_expansion`
