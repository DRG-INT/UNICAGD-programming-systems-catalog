...
<!-- canonical: https://www.npmjs.com/package/rsocket-websocket-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/rsocket-websocket-server](https://www.npmjs.com/package/rsocket-websocket-server) |
| Source record ids | npm_registry-a6542187f5b2cf |
...
For a systems engineer, rsocket-websocket-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.29-alpha.0 | 2024-03-06T01:31:06.150Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a6542187f5b2cf` from `npm_registry` as `registry_expansion`
