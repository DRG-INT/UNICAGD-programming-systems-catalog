...
<!-- canonical: https://cran.r-project.org/web/packages/transDA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/transDA/index.html](https://cran.r-project.org/web/packages/transDA/index.html) |
| Source record ids | cran_packages_by_date-d68eb0a96a8848 |
...
For a systems engineer, transDA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-21 14:00:02 UTC | [https://cran.r-project.org/web/packages/transDA/DESCRIPTION](https://cran.r-project.org/web/packages/transDA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/transDA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d68eb0a96a8848` from `cran_packages_by_date` as `registry_expansion`
