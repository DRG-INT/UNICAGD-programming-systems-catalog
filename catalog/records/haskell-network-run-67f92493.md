...
<!-- canonical: https://hackage.haskell.org/package/network-run -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-run](https://hackage.haskell.org/package/network-run) |
| Source record ids | hackage_top_downloads-d4735c917b8431 |
...
For a systems engineer, network-run belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2025-11-19T05:14:49Z | [https://hackage.haskell.org/package/network-run](https://hackage.haskell.org/package/network-run) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-run` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-d4735c917b8431` from `hackage_top_downloads` as `registry_expansion`
