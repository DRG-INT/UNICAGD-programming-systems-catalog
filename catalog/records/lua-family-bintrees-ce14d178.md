...
<!-- canonical: https://luarocks.org/modules/guicaulada/bintrees -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/guicaulada/bintrees](https://luarocks.org/modules/guicaulada/bintrees) |
| Source record ids | luarocks_root_manifest-aa8a906d80b83f |

## System Engineer Summary

This package provides Binary and Red-Black Search Trees written in Lua.

## Operational Role

For a systems engineer, bintrees belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-aa8a906d80b83f` from `luarocks_root_manifest` as `registry_expansion`
