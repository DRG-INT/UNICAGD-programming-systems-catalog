...
<!-- canonical: https://crates.io/crates/smawk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/smawk](https://crates.io/crates/smawk) |
| Source record ids | crates_io-0b922de9cbd5ce |
...
For a systems engineer, smawk belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-06-16T07:57:57.903963Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-0b922de9cbd5ce` from `crates_io` as `registry_expansion`
