...
<!-- canonical: https://github.com/bulletphysics/bullet3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bulletphysics/bullet3](https://github.com/bulletphysics/bullet3) |
| Source record ids | github_search_game_engines-f0d0d627d8f505 |

## System Engineer Summary

Bullet Physics SDK: real-time collision detection and multi-physics simulation for VR, games, visual
effects, robotics, machine learning etc.

## Operational Role

For a systems engineer, bulletphysics/bullet3 belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-22T02:13:14Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-f0d0d627d8f505` from `github_search_game_engines` as `registry_expansion`
