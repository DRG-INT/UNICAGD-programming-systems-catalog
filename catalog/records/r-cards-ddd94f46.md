...
<!-- canonical: https://cran.r-project.org/web/packages/cards/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cards/index.html](https://cran.r-project.org/web/packages/cards/index.html) |
| Source record ids | cran_packages_by_date-e183fd65b862c5 |

## System Engineer Summary

cards is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, cards belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-21 13:40:18 UTC | [https://cran.r-project.org/web/packages/cards/DESCRIPTION](https://cran.r-project.org/web/packages/cards/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cards/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e183fd65b862c5` from `cran_packages_by_date` as `registry_expansion`
