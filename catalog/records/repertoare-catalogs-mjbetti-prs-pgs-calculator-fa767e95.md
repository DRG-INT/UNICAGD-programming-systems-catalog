...
<!-- canonical: https://github.com/mjbetti/prs-pgs-calculator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mjbetti/prs-pgs-calculator](https://github.com/mjbetti/prs-pgs-calculator) |
| Source record ids | github_search_repertoare_catalogs-9f8933fb4c626b |

## System Engineer Summary

A set of scripts and accompanying instruction for how to compute PRS across all scores in the PGS
Catalog and calculate risk percentile relative to gnomAD samples.

## Operational Role

For a systems engineer, mjbetti/prs-pgs-calculator belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-01T18:44:32Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-9f8933fb4c626b` from `github_search_repertoare_catalogs` as `registry_expansion`
