...
<!-- canonical: https://cran.r-project.org/web/packages/AutoViz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AutoViz/index.html](https://cran.r-project.org/web/packages/AutoViz/index.html) |
| Source record ids | cran_packages_by_date-47a0fbfaf49b17 |
...
For a systems engineer, AutoViz belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-14 14:50:02 UTC | [https://cran.r-project.org/web/packages/AutoViz/DESCRIPTION](https://cran.r-project.org/web/packages/AutoViz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AutoViz/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-47a0fbfaf49b17` from `cran_packages_by_date` as `registry_expansion`
