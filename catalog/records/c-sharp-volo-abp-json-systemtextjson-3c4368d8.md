...
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Json.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Json.SystemTextJson](https://www.nuget.org/packages/Volo.Abp.Json.SystemTextJson) |
| Source record ids | nuget_search-f1f80b7eb471fe |

## System Engineer Summary

Volo.Abp.Json.SystemTextJson is tracked as a project scaffolding record in the C-Sharp branch. The
...
For a systems engineer, Volo.Abp.Json.SystemTextJson belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:28.573+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.systemtextjson/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:49.363+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.systemtextjson/index.json) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Json.SystemTextJson/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.json.systemtextjson/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-f1f80b7eb471fe` from `nuget_search` as `registry_expansion`
...
| Volo.Abp.Json | Project Scaffolding | [open](c-sharp-volo-abp-json-2b1f0835.md) |
