...
<!-- canonical: https://github.com/SpiceSharp/SpiceSharp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SpiceSharp/SpiceSharp](https://github.com/SpiceSharp/SpiceSharp) |
| Source record ids | github_search_space_maps-df68eb34fdde39 |

## System Engineer Summary

Spice# is a cross-platform electronic circuit simulator based on Berkeley Spice - the mother of
commercial industry-standard circuit simulators.

## Operational Role

For a systems engineer, SpiceSharp/SpiceSharp belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T14:29:08Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-df68eb34fdde39` from `github_search_space_maps` as `registry_expansion`
