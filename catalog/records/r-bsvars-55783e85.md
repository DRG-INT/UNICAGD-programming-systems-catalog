...
<!-- canonical: https://cran.r-project.org/web/packages/bsvars/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bsvars/index.html](https://cran.r-project.org/web/packages/bsvars/index.html) |
| Source record ids | cran_packages_by_date-e2b303c082e907 |
...
For a systems engineer, bsvars belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0 | 2026-08-22 16:00:17 UTC | [https://cran.r-project.org/web/packages/bsvars/DESCRIPTION](https://cran.r-project.org/web/packages/bsvars/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bsvars/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e2b303c082e907` from `cran_packages_by_date` as `registry_expansion`
