# eupassarinho/sentinel-1-SAR-vegetation-indices
...
<!-- canonical: https://github.com/eupassarinho/sentinel-1-SAR-vegetation-indices -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eupassarinho/sentinel-1-SAR-vegetation-indices](https://github.com/eupassarinho/sentinel-1-SAR-vegetation-indices) |
| Source record ids | github_search_radars-536f07564043da |

## System Engineer Summary

This repository contains a pipeline blending Python and R features, first to: download, preprocess,
and compute Sentinel-1 SAR vegetation indices (all in Python); following for image sampling in R.

## Operational Role

For a systems engineer, eupassarinho/sentinel-1-SAR-vegetation-indices belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | known | Python | 2023-02-18T18:55:20Z | [https://api.github.com/repos/eupassarinho/sentinel-1-SAR-vegetation-indices/releases/latest](https://api.github.com/repos/eupassarinho/sentinel-1-SAR-vegetation-indices/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/eupassarinho/sentinel-1-SAR-vegetation-indices/releases/latest` at `2026-09-01T08:26:28+00:00`.
...
- `github_search_radars-536f07564043da` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| radar-lab/ti_mmwave_rospkg | Package Manager | [open](radars-radar-lab-ti-mmwave-rospkg-77356544.md) |
