...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/ArrayTools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/ArrayTools](https://github.com/JuliaRegistries/General/tree/master/A/ArrayTools) |
| Source record ids | julia_general-b56dfa12cb8cbc |

## System Engineer Summary

Julia package registered in General at A/ArrayTools.

## Operational Role

For a systems engineer, ArrayTools belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/ArrayTools", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-b56dfa12cb8cbc` from `julia_general` as `registry_expansion`
