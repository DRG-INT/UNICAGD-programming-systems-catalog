...
<!-- canonical: https://cran.r-project.org/web/packages/AugmentedPooledRCBD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AugmentedPooledRCBD/index.html](https://cran.r-project.org/web/packages/AugmentedPooledRCBD/index.html) |
| Source record ids | cran_packages_by_date-f39b90281f1d0c |

## System Engineer Summary

Augmented Pooled Randomized Complete Block Design Analysis

## Operational Role

For a systems engineer, AugmentedPooledRCBD belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-04 19:50:09 UTC | [https://cran.r-project.org/web/packages/AugmentedPooledRCBD/DESCRIPTION](https://cran.r-project.org/web/packages/AugmentedPooledRCBD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AugmentedPooledRCBD/DESCRIPTION` at `2026-09-04T20:19:05+00:00`.
...
- `cran_packages_by_date-f39b90281f1d0c` from `cran_packages_by_date` as `registry_expansion`
