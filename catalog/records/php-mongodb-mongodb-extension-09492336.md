...
<!-- canonical: https://packagist.org/packages/mongodb/mongodb-extension -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mongodb/mongodb-extension](https://packagist.org/packages/mongodb/mongodb-extension) |
| Source record ids | packagist_search-bedeaef22114ed |
...
For a systems engineer, mongodb/mongodb-extension belongs in the PHP inventory as part of state
...
- `packagist_search-bedeaef22114ed` from `packagist_search` as `registry_expansion`
