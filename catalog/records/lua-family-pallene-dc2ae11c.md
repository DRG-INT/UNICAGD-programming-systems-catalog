...
| Source record ids | corpus-dd7af51be68b83 |

## System Engineer Summary

Pallene is tracked as a static analyzer record in the Lua family branch. The source did not provide
...
For a systems engineer, Pallene belongs in the Lua family inventory as part of defect discovery,
...
- `corpus-dd7af51be68b83` from `master_json` as `static_analyzer`
