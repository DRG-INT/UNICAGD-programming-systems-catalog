...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bberak/react-native-game-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bberak/react-native-game-engine](https://github.com/bberak/react-native-game-engine) |
| Source record ids | github_search_game_engines-dc54ba0ad08fdc |
...
For a systems engineer, bberak/react-native-game-engine belongs in the Game Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-31T04:31:45Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:game-engine stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_game_engines-dc54ba0ad08fdc` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 00-Evan/shattered-pixel-dungeon | Game Engine Game Dev | [open](game-engines-00-evan-shattered-pixel-dungeon-29beff16.md) |
| AlmasB/FXGL | Game Engine Game Dev | [open](game-engines-almasb-fxgl-e7b4c225.md) |
| AmbientRun/Ambient | Game Engine Game Dev | [open](game-engines-ambientrun-ambient-ff6b0404.md) |
| amethyst/amethyst | Game Engine Game Dev | [open](game-engines-amethyst-amethyst-54a05aa3.md) |
| armory3d/armory | Game Engine Game Dev | [open](game-engines-armory3d-armory-8c64e938.md) |
| aws/lumberyard | Game Engine Game Dev | [open](game-engines-aws-lumberyard-09cafaf4.md) |
| BabylonJS/Babylon.js | Game Engine Game Dev | [open](game-engines-babylonjs-babylon-js-bee87a1e.md) |
| Bevy | Game Engine Game Dev | [open](game-engines-bevy-60c1e426.md) |
