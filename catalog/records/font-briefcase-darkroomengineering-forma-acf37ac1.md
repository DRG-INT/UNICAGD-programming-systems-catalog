...
<!-- canonical: https://github.com/darkroomengineering/forma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/darkroomengineering/forma](https://github.com/darkroomengineering/forma) |
| Source record ids | github_search_font_briefcase-1e0d7dba1f10ef |

## System Engineer Summary

Generate static font instances from a variable font (FontTools).

## Operational Role

For a systems engineer, darkroomengineering/forma belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-04T15:17:31Z | gh search repos topic:fonttools stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-1e0d7dba1f10ef` from `github_search_font_briefcase` as `registry_expansion`
