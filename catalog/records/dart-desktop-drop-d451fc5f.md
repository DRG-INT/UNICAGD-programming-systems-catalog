...
<!-- canonical: https://pub.dev/packages/desktop_drop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/desktop_drop](https://pub.dev/packages/desktop_drop) |
| Source record ids | pub_dev-35505e3e5a1c3a |
...
For a systems engineer, desktop_drop belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2026-09-01T13:39:54.345147Z | [https://pub.dev/api/packages/desktop_drop](https://pub.dev/api/packages/desktop_drop) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/desktop_drop` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-35505e3e5a1c3a` from `pub_dev` as `registry_expansion`
