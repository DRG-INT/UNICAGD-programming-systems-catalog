...
| Canonical URL | [https://pypi.org/project/lark/](https://pypi.org/project/lark/) |
| Source record ids | corpus-b8a56c70f30234 |
...
For a systems engineer, Lark belongs in the Python inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2025-10-27T18:25:56.653447Z | [https://pypi.org/pypi/Lark/json](https://pypi.org/pypi/Lark/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/Lark/json` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-b8a56c70f30234` from `master_json` as `parser_lexer_ast`
