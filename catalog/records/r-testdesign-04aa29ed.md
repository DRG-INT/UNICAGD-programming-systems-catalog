...
<!-- canonical: https://cran.r-project.org/web/packages/TestDesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TestDesign/index.html](https://cran.r-project.org/web/packages/TestDesign/index.html) |
| Source record ids | cran_packages_by_date-8e38aee8235e82 |
...
For a systems engineer, TestDesign belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-09-08 07:10:03 UTC | [https://cran.r-project.org/web/packages/TestDesign/DESCRIPTION](https://cran.r-project.org/web/packages/TestDesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TestDesign/DESCRIPTION` at `2026-09-08T08:22:37+00:00`.
...
- `cran_packages_by_date-8e38aee8235e82` from `cran_packages_by_date` as `registry_expansion`
