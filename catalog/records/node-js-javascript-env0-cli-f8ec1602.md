...
<!-- canonical: https://www.npmjs.com/package/@env0/cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@env0/cli](https://www.npmjs.com/package/@env0/cli) |
| Source record ids | npm_registry-4325341fce9afb |

## System Engineer Summary

@env0/cli is tracked as a cli record in the Node.js/JavaScript branch. The source did not provide a
...
For a systems engineer, @env0/cli belongs in the Node.js/JavaScript inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.25 | 2026-04-20T08:58:03.712Z | [https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4325341fce9afb` from `npm_registry` as `registry_expansion`
