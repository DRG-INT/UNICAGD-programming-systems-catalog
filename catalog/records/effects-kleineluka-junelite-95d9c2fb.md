...
| Canonical URL | [https://github.com/kleineluka/junelite](https://github.com/kleineluka/junelite) |
| Source record ids | github_search_effects-54cca82c333e8e |

## System Engineer Summary

Make Unity prettier ✨ A free, open-source, and redistributable post-processing stack for Unity and
VRChat. 🌈

## Operational Role

For a systems engineer, kleineluka/junelite belongs in the Effects inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-08-15T07:56:04Z | [https://api.github.com/repos/kleineluka/junelite/releases/latest](https://api.github.com/repos/kleineluka/junelite/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/kleineluka/junelite/releases/latest` at `2026-09-01T09:23:11+00:00`.
...
- `github_search_effects-54cca82c333e8e` from `github_search_effects` as `registry_expansion`
