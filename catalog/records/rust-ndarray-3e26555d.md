...
<!-- canonical: https://crates.io/crates/ndarray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ndarray](https://crates.io/crates/ndarray) |
| Source record ids | crates_io-256fd1999c6f36 |
...
For a systems engineer, ndarray belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.2 | 2026-01-10T23:19:18.256265Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-256fd1999c6f36` from `crates_io` as `registry_expansion`
