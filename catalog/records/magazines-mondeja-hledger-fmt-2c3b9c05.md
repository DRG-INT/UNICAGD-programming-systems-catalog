...
<!-- canonical: https://github.com/mondeja/hledger-fmt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mondeja/hledger-fmt](https://github.com/mondeja/hledger-fmt) |
| Source record ids | github_search_magazines-b9a22f698bbc4f |
...
For a systems engineer, mondeja/hledger-fmt belongs in the Magazines inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-15T16:08:44Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-b9a22f698bbc4f` from `github_search_magazines` as `registry_expansion`
