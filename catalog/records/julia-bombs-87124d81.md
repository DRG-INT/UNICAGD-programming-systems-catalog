...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BOMBs](https://github.com/JuliaRegistries/General/tree/master/B/BOMBs) |
| Source record ids | julia_general-d42edd922abb41 |

## System Engineer Summary

Julia package registered in General at B/BOMBs.

## Operational Role

For a systems engineer, BOMBs belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BOMBs", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d42edd922abb41` from `julia_general` as `registry_expansion`
