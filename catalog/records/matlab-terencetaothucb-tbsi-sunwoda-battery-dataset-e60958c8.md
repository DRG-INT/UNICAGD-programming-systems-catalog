...
<!-- canonical: https://github.com/terencetaothucb/TBSI-Sunwoda-Battery-Dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/terencetaothucb/TBSI-Sunwoda-Battery-Dataset](https://github.com/terencetaothucb/TBSI-Sunwoda-Battery-Dataset) |
| Source record ids | github_search_matlab-59284ec756018e |

## System Engineer Summary

Sunwoda Electronic Co., Ltd, and Tsinghua Berkeley Shenzhen Institute (TBSI) generate the TBSI
Sunwoda Battery Dataset. We open-source this dataset to inspire more data-driven novel material
verification, battery management research and applications.

## Operational Role

For a systems engineer, terencetaothucb/TBSI-Sunwoda-Battery-Dataset belongs in the Matlab inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-14T23:15:41Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; {"key": "", "name": "", "url": ""}; Other; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_matlab-59284ec756018e` from `github_search_matlab` as `registry_expansion`
