...
<!-- canonical: https://github.com/vercel/workflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vercel/workflow](https://github.com/vercel/workflow) |
| Source record ids | github_search_engines-205bdd762b9259 |
...
For a systems engineer, vercel/workflow belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T01:24:12Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-205bdd762b9259` from `github_search_engines` as `registry_expansion`
