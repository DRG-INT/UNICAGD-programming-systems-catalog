...
<!-- canonical: https://github.com/NyanCAD/Mosaic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NyanCAD/Mosaic](https://github.com/NyanCAD/Mosaic) |
| Source record ids | github_search_space_maps-125fb51bf9160b |
...
For a systems engineer, NyanCAD/Mosaic belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T14:23:54Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-125fb51bf9160b` from `github_search_space_maps` as `registry_expansion`
