...
<!-- canonical: https://github.com/JamesDavid/Overhead -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JamesDavid/Overhead](https://github.com/JamesDavid/Overhead) |
| Source record ids | github_search_space_maps-a909fc2b0f0503 |

## System Engineer Summary

Air-&-space situational-awareness dashboard for a $10 ESP32 touchscreen (CYD / CrowPanel):
satellites overhead, rocket launches, ADS-B aircraft, aviation & space weather, the solar system,
and a live star map — location-aware, with an Intelligent Focus director. Runs real HTTPS feeds on a
no-PSRAM board; flash it from your browser.

## Operational Role

For a systems engineer, JamesDavid/Overhead belongs in the Space Maps inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T04:41:21Z | gh search repos topic:star-map stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:star-map stars:>10", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_space_maps-a909fc2b0f0503` from `github_search_space_maps` as `registry_expansion`
