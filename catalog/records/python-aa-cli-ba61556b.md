...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/aa-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aa-cli/](https://pypi.org/project/aa-cli/) |
| Source record ids | pypi_simple-677ea6609e2224 |
...
For a systems engineer, aa-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2025-11-27T13:10:22.819923Z | [https://pypi.org/pypi/aa-cli/json](https://pypi.org/pypi/aa-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aa-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-677ea6609e2224` from `pypi_simple` as `registry_expansion`
