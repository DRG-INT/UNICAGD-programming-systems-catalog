...
<!-- canonical: https://cran.r-project.org/web/packages/bGMYC4/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bGMYC4/index.html](https://cran.r-project.org/web/packages/bGMYC4/index.html) |
| Source record ids | cran_packages_by_date-07bb1e2ccec669 |

## System Engineer Summary

Bayesian General Mixed Yule-Coalescent Model for Species Delimitation

## Operational Role

For a systems engineer, bGMYC4 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.6 | 2026-09-04 20:30:02 UTC | [https://cran.r-project.org/web/packages/bGMYC4/DESCRIPTION](https://cran.r-project.org/web/packages/bGMYC4/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bGMYC4/DESCRIPTION` at `2026-09-04T22:18:17+00:00`.
...
- `cran_packages_by_date-07bb1e2ccec669` from `cran_packages_by_date` as `registry_expansion`
