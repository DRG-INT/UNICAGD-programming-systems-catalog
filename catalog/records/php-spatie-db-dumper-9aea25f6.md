...
<!-- canonical: https://packagist.org/packages/spatie/db-dumper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spatie/db-dumper](https://packagist.org/packages/spatie/db-dumper) |
| Source record ids | packagist_search-a31020eaddab9c |

## System Engineer Summary

spatie/db-dumper is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, spatie/db-dumper belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-a31020eaddab9c` from `packagist_search` as `registry_expansion`
