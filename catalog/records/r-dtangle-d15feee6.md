...
<!-- canonical: https://cran.r-project.org/web/packages/dtangle/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dtangle/index.html](https://cran.r-project.org/web/packages/dtangle/index.html) |
| Source record ids | cran_packages_by_date-7e0d0ac09af4ba |
...
For a systems engineer, dtangle belongs in the R inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.10 | 2026-08-21 19:30:08 UTC | [https://cran.r-project.org/web/packages/dtangle/DESCRIPTION](https://cran.r-project.org/web/packages/dtangle/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dtangle/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7e0d0ac09af4ba` from `cran_packages_by_date` as `registry_expansion`
...
| routing | Web Framework | [open](r-routing-2f4a5f07.md) |
