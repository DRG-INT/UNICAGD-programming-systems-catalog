...
<!-- canonical: https://hackage.haskell.org/package/viewprof -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/viewprof](https://hackage.haskell.org/package/viewprof) |
| Source record ids | hackage_top_downloads-b10162a380c2ae |
...
For a systems engineer, viewprof belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0.33 | 2020-05-05T14:10:16Z | [https://hackage.haskell.org/package/viewprof](https://hackage.haskell.org/package/viewprof) |  |
| candidate | partial | 0.0.0.1 |  | [https://hackage.haskell.org/package/viewprof](https://hackage.haskell.org/package/viewprof) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/viewprof` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-b10162a380c2ae` from `hackage_top_downloads` as `registry_expansion`
