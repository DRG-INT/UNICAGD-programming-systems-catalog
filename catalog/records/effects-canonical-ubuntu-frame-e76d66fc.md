...
<!-- canonical: https://github.com/canonical/ubuntu-frame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/canonical/ubuntu-frame](https://github.com/canonical/ubuntu-frame) |
| Source record ids | github_search_effects-2118a745fd50a1 |
...
For a systems engineer, canonical/ubuntu-frame belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T04:34:54Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2118a745fd50a1` from `github_search_effects` as `registry_expansion`
