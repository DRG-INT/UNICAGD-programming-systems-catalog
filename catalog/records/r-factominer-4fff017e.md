...
<!-- canonical: https://cran.r-project.org/web/packages/FactoMineR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FactoMineR/index.html](https://cran.r-project.org/web/packages/FactoMineR/index.html) |
| Source record ids | cran_packages_by_date-6ca4972ced4342 |
...
For a systems engineer, FactoMineR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.17 | 2026-09-08 05:20:56 UTC | [https://cran.r-project.org/web/packages/FactoMineR/DESCRIPTION](https://cran.r-project.org/web/packages/FactoMineR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FactoMineR/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-6ca4972ced4342` from `cran_packages_by_date` as `registry_expansion`
