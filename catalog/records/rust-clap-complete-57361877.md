...
<!-- canonical: https://crates.io/crates/clap_complete -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/clap_complete](https://crates.io/crates/clap_complete) |
| Source record ids | crates_io-f631d94721a19e |
...
For a systems engineer, clap_complete belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.6.10 | 2026-09-14T18:40:30.821537Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-14T20:20:08+00:00`.
...
- `crates_io-f631d94721a19e` from `crates_io` as `registry_expansion`
