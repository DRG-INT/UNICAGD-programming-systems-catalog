...
<!-- canonical: https://github.com/realkushagrakhare/3D_Path_Planning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realkushagrakhare/3D_Path_Planning](https://github.com/realkushagrakhare/3D_Path_Planning) |
| Source record ids | github_search_physics_engines-50aa9e5a57162f |
...
For a systems engineer, realkushagrakhare/3D_Path_Planning belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-07T11:14:40Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-50aa9e5a57162f` from `github_search_physics_engines` as `registry_expansion`
