...
<!-- canonical: https://cran.r-project.org/web/packages/rasterDT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rasterDT/index.html](https://cran.r-project.org/web/packages/rasterDT/index.html) |
| Source record ids | cran_packages_by_date-1a6c4a7c320f68 |
...
For a systems engineer, rasterDT belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-29 13:20:02 UTC | [https://cran.r-project.org/web/packages/rasterDT/DESCRIPTION](https://cran.r-project.org/web/packages/rasterDT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rasterDT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1a6c4a7c320f68` from `cran_packages_by_date` as `registry_expansion`
