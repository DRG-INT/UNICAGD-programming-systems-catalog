...
<!-- canonical: https://github.com/ColinKennedy/USD-Cookbook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ColinKennedy/USD-Cookbook](https://github.com/ColinKennedy/USD-Cookbook) |
| Source record ids | github_search_effects-b654dcf404e525 |

## System Engineer Summary

ColinKennedy/USD-Cookbook is tracked as a tutorial book styleguide record in the Effects branch. The
...
For a systems engineer, ColinKennedy/USD-Cookbook belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-17T18:16:46Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b654dcf404e525` from `github_search_effects` as `registry_expansion`
...
| The Book of Shaders | Tutorial Book Styleguide | [open](effects-the-book-of-shaders-dac50f53.md) |
