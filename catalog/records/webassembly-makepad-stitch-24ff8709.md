...
<!-- canonical: https://github.com/makepad/stitch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makepad/stitch](https://github.com/makepad/stitch) |
| Source record ids | github_search_webassembly-1424ab3d92bf80 |

## System Engineer Summary

Stitch is an experimental Wasm interpreter written in Rust that is designed to be very fast and
lightweight.

## Operational Role

For a systems engineer, makepad/stitch belongs in the WebAssembly inventory as part of runtime
...
- `github_search_webassembly-1424ab3d92bf80` from `github_search_webassembly` as `registry_expansion`
