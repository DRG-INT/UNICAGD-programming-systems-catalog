...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/midas-research/audino -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/midas-research/audino](https://github.com/midas-research/audino) |
| Source record ids | github_search_audio-3636da2c7c16a6 |
...
For a systems engineer, midas-research/audino belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.0 | 2020-06-04T08:09:22Z | [https://api.github.com/repos/midas-research/audino/releases/latest](https://api.github.com/repos/midas-research/audino/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/midas-research/audino/releases/latest` at `2026-09-01T11:21:40+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:speech-processing stars:>50", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_audio-3636da2c7c16a6` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alyssaxuu/screenity | Image Audio Dsp | [open](audio-alyssaxuu-screenity-12b2e5cf.md) |
| Ameobea/web-synth | Image Audio Dsp | [open](audio-ameobea-web-synth-bbcd97d3.md) |
| amsynth/amsynth | Image Audio Dsp | [open](audio-amsynth-amsynth-d2f54c63.md) |
| andremichelle/openDAW | Image Audio Dsp | [open](audio-andremichelle-opendaw-ecd83ddd.md) |
| apfaudio/eurorack-pmod | Image Audio Dsp | [open](audio-apfaudio-eurorack-pmod-56004258.md) |
| ar1st0crat/NWaves | Image Audio Dsp | [open](audio-ar1st0crat-nwaves-3e35452a.md) |
| Ardour/ardour | Image Audio Dsp | [open](audio-ardour-ardour-2553c055.md) |
| AudioKit/ROMPlayer | Image Audio Dsp | [open](audio-audiokit-romplayer-2b98bcd6.md) |
