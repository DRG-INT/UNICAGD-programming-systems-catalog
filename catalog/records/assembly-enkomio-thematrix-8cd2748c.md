...
<!-- canonical: https://github.com/enkomio/thematrix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/enkomio/thematrix](https://github.com/enkomio/thematrix) |
| Source record ids | github_search_assembly-fd59d9d8467d5e |
...
For a systems engineer, enkomio/thematrix belongs in the Assembly inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-19T10:15:39Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-fd59d9d8467d5e` from `github_search_assembly` as `registry_expansion`
