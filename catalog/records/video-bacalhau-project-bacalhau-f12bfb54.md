...
<!-- canonical: https://github.com/bacalhau-project/bacalhau -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bacalhau-project/bacalhau](https://github.com/bacalhau-project/bacalhau) |
| Source record ids | github_search_video-369d1e5bc5ad4d |

## System Engineer Summary

Community-driven, simple, yet powerful framework for fast, cost-effective distributed Compute over
Data.

## Operational Role

For a systems engineer, bacalhau-project/bacalhau belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T07:19:06Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-369d1e5bc5ad4d` from `github_search_video` as `registry_expansion`
