...
<!-- canonical: https://github.com/Unity-Technologies/articulations-robot-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Unity-Technologies/articulations-robot-demo](https://github.com/Unity-Technologies/articulations-robot-demo) |
| Source record ids | github_search_physics_engines-2bf139d412736e |

## System Engineer Summary

Unity-Technologies/articulations-robot-demo is tracked as a logging observability record in the
Physics Engines branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, Unity-Technologies/articulations-robot-demo belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-13T23:53:46Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-2bf139d412736e` from `github_search_physics_engines` as `registry_expansion`
