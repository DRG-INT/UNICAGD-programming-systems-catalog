...
<!-- canonical: https://github.com/nsmryan/CCSDS-Router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nsmryan/CCSDS-Router](https://github.com/nsmryan/CCSDS-Router) |
| Source record ids | github_search_satcom_satellites-4260db3cfc5fbc |

## System Engineer Summary

A tool for transferring CCSDS packets from files/udp/tcp to file/tcp/udp, supporting a variety of
needs

## Operational Role

For a systems engineer, nsmryan/CCSDS-Router belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-27T18:01:08Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-4260db3cfc5fbc` from `github_search_satcom_satellites` as `registry_expansion`
