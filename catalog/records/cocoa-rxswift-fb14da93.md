...
<!-- canonical: https://cocoapods.org/pods/RxSwift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/RxSwift](https://cocoapods.org/pods/RxSwift) |
| Source record ids | cocoapods_cdn-fd33c9d40c49f8 |
...
For a systems engineer, RxSwift belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.9.0 | 2025-02-17 15:53:39 UTC | [https://trunk.cocoapods.org/api/v1/pods/RxSwift](https://trunk.cocoapods.org/api/v1/pods/RxSwift) |  |
| preview | known | 6.0.0-rc.2 | 2020-11-21 10:17:33 UTC | [https://trunk.cocoapods.org/api/v1/pods/RxSwift](https://trunk.cocoapods.org/api/v1/pods/RxSwift) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/RxSwift` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-fd33c9d40c49f8` from `cocoapods_cdn` as `registry_expansion`
