...
| Canonical URL | [https://luarocks.org/modules/thislight/hussar](https://luarocks.org/modules/thislight/hussar) |
| Source record ids | luarocks_root_manifest-fd9535531baefd |

## System Engineer Summary

hussar is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, hussar belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-fd9535531baefd` from `luarocks_root_manifest` as `registry_expansion`
