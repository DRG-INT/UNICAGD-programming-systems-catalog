# Azure-Samples/data-catalog-dotnet-get-started
...
<!-- canonical: https://github.com/Azure-Samples/data-catalog-dotnet-get-started -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Azure-Samples/data-catalog-dotnet-get-started](https://github.com/Azure-Samples/data-catalog-dotnet-get-started) |
| Source record ids | github_search_space_maps-9a1acddd678a4b |

## System Engineer Summary

A sample that shows you how to authenticate with Azure AD to Register, Search, and Delete a data
asset using the Data Catalog REST API.

## Operational Role

For a systems engineer, Azure-Samples/data-catalog-dotnet-get-started belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-09T21:16:47Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9a1acddd678a4b` from `github_search_space_maps` as `registry_expansion`
