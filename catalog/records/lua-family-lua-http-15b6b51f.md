...
| Source record ids | corpus-77d4d15954d1ab |

## System Engineer Summary

lua-http is tracked as a networking http record in the Lua family branch. The source did not provide
...
For a systems engineer, lua-http belongs in the Lua family inventory as part of service
...
- `corpus-77d4d15954d1ab` from `master_json` as `networking_http`
