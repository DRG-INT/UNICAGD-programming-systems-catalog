...
<!-- canonical: https://github.com/kauwelab/PolyRiskScore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kauwelab/PolyRiskScore](https://github.com/kauwelab/PolyRiskScore) |
| Source record ids | github_search_repertoare_catalogs-6b8527ea664d1f |

## System Engineer Summary

PRSKB is a website and command-line interface tool for calculating polygenic risk scores using GWA
studies from the NHGRI-EBI Catalog.

## Operational Role

For a systems engineer, kauwelab/PolyRiskScore belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-22T15:39:09Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-6b8527ea664d1f` from `github_search_repertoare_catalogs` as `registry_expansion`
