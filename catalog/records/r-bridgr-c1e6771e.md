...
<!-- canonical: https://cran.r-project.org/web/packages/bridgr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bridgr/index.html](https://cran.r-project.org/web/packages/bridgr/index.html) |
| Source record ids | cran_packages_by_date-ae1256e4c8eede |
...
For a systems engineer, bridgr belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-21 13:10:24 UTC | [https://cran.r-project.org/web/packages/bridgr/DESCRIPTION](https://cran.r-project.org/web/packages/bridgr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bridgr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ae1256e4c8eede` from `cran_packages_by_date` as `registry_expansion`
