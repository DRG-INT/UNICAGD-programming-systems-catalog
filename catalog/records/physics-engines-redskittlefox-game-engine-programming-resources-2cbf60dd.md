...
<!-- canonical: https://github.com/RedSkittleFox/Game-Engine-Programming-Resources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RedSkittleFox/Game-Engine-Programming-Resources](https://github.com/RedSkittleFox/Game-Engine-Programming-Resources) |
| Source record ids | github_search_physics_engines-f368af345a12a5 |
...
For a systems engineer, RedSkittleFox/Game-Engine-Programming-Resources belongs in the Physics
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-31T02:18:48Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f368af345a12a5` from `github_search_physics_engines` as `registry_expansion`
