...
<!-- canonical: https://github.com/sideeffects/SideFXLabs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sideeffects/SideFXLabs](https://github.com/sideeffects/SideFXLabs) |
| Source record ids | github_search_effects-5d366562d9c694 |

## System Engineer Summary

sideeffects/SideFXLabs is tracked as an ide editor integration record in the Effects branch. The
...
For a systems engineer, sideeffects/SideFXLabs belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:33:37Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5d366562d9c694` from `github_search_effects` as `registry_expansion`
