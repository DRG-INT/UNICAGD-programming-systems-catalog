...
<!-- canonical: https://crates.io/crates/kv-log-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/kv-log-macro](https://crates.io/crates/kv-log-macro) |
| Source record ids | crates_io-237951d87b22d7 |
...
For a systems engineer, kv-log-macro belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2020-07-06T09:42:00.776479Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-237951d87b22d7` from `crates_io` as `registry_expansion`
