...
<!-- canonical: https://packagist.org/packages/ta-tikoma/phpunit-architecture-test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ta-tikoma/phpunit-architecture-test](https://packagist.org/packages/ta-tikoma/phpunit-architecture-test) |
| Source record ids | packagist_search-9138be9feae468 |
...
For a systems engineer, ta-tikoma/phpunit-architecture-test belongs in the PHP inventory as part of
...
- `packagist_search-9138be9feae468` from `packagist_search` as `registry_expansion`
