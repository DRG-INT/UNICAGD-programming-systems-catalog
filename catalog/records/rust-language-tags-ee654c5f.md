...
<!-- canonical: https://crates.io/crates/language-tags -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/language-tags](https://crates.io/crates/language-tags) |
| Source record ids | crates_io-59ebf01f32034f |

## System Engineer Summary

language-tags is tracked as a language specification record in the Rust branch. The source did not
...
For a systems engineer, language-tags belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2021-05-24T17:56:55.679036Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `crates_io-59ebf01f32034f` from `crates_io` as `registry_expansion`
