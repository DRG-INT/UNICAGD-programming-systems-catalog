...
| Source record ids | github_search_effects-2aadb985a782e2 |
...
For a systems engineer, chaosprint/glicol belongs in the Effects inventory as part of ecosystem
...
- `github_search_effects-2aadb985a782e2` from `github_search_effects` as `registry_expansion`
