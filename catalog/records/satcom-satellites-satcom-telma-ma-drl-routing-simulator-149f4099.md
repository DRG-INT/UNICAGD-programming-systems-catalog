...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SatCom-TELMA/MA-DRL_Routing_Simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SatCom-TELMA/MA-DRL_Routing_Simulator](https://github.com/SatCom-TELMA/MA-DRL_Routing_Simulator) |
| Source record ids | github_search_satcom_satellites-1cbf72ee5ed000 |
...
For a systems engineer, SatCom-TELMA/MA-DRL_Routing_Simulator belongs in the SatCom Satellites
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T02:31:27Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-1cbf72ee5ed000` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| airframesio/xng | Networking Http | [open](satcom-satellites-airframesio-xng-5cd5b6f4.md) |
| ameraner/dsen2-cr | Networking Http | [open](satcom-satellites-ameraner-dsen2-cr-ac4429cc.md) |
| anfractuosity/ultrasonicnetworking | Networking Http | [open](satcom-satellites-anfractuosity-ultrasonicnetworking-009490a4.md) |
| dotchance/nodalarc | Networking Http | [open](satcom-satellites-dotchance-nodalarc-405a4881.md) |
| Muhammaduazir69/ns3-ntn-toolkit | Networking Http | [open](satcom-satellites-muhammaduazir69-ns3-ntn-toolkit-5e9691a1.md) |
| nsmryan/CCSDS-Router | Networking Http | [open](satcom-satellites-nsmryan-ccsds-router-0f662998.md) |
| osmocom/gr-osmosdr | Networking Http | [open](satcom-satellites-osmocom-gr-osmosdr-87d71d7c.md) |
| osmocom/rtl-sdr | Networking Http | [open](satcom-satellites-osmocom-rtl-sdr-676ddb1f.md) |
