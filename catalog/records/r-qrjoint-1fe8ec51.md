...
<!-- canonical: https://cran.r-project.org/web/packages/qrjoint/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qrjoint/index.html](https://cran.r-project.org/web/packages/qrjoint/index.html) |
| Source record ids | cran_packages_by_date-5aa29c01ff5bf6 |
...
For a systems engineer, qrjoint belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1-0 | 2026-09-11 15:50:08 UTC | [https://cran.r-project.org/web/packages/qrjoint/DESCRIPTION](https://cran.r-project.org/web/packages/qrjoint/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qrjoint/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-5aa29c01ff5bf6` from `cran_packages_by_date` as `registry_expansion`
