# open-product-data/digital-cameras
...
<!-- canonical: https://github.com/open-product-data/digital-cameras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-product-data/digital-cameras](https://github.com/open-product-data/digital-cameras) |
| Source record ids | github_search_photography-77eb435b8bc0a1 |

## System Engineer Summary

The most complete and accurate digital camera* data on the internet, assembled and maintained by the
community.

## Operational Role

For a systems engineer, open-product-data/digital-cameras belongs in the Photography inventory as
...
- `github_search_photography-77eb435b8bc0a1` from `github_search_photography` as `registry_expansion`
