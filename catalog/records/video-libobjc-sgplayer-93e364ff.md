...
<!-- canonical: https://github.com/libobjc/SGPlayer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libobjc/SGPlayer](https://github.com/libobjc/SGPlayer) |
| Source record ids | github_search_video-9b2210926a9f7f |
...
For a systems engineer, libobjc/SGPlayer belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-21T05:41:46Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-9b2210926a9f7f` from `github_search_video` as `registry_expansion`
