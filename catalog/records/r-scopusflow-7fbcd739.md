...
<!-- canonical: https://cran.r-project.org/web/packages/scopusflow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scopusflow/index.html](https://cran.r-project.org/web/packages/scopusflow/index.html) |
| Source record ids | cran_packages_by_date-203b452edf1b21 |

## System Engineer Summary

A Reproducible Workflow Layer for 'Scopus' Bibliographic Searches

## Operational Role

For a systems engineer, scopusflow belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-21 21:00:08 UTC | [https://cran.r-project.org/web/packages/scopusflow/DESCRIPTION](https://cran.r-project.org/web/packages/scopusflow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scopusflow/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-203b452edf1b21` from `cran_packages_by_date` as `registry_expansion`
