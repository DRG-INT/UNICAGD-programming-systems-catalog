...
<!-- canonical: https://cran.r-project.org/web/packages/wehoop/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wehoop/index.html](https://cran.r-project.org/web/packages/wehoop/index.html) |
| Source record ids | cran_packages_by_date-f654dcd474deb4 |
...
For a systems engineer, wehoop belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-24 18:40:02 UTC | [https://cran.r-project.org/web/packages/wehoop/DESCRIPTION](https://cran.r-project.org/web/packages/wehoop/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wehoop/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f654dcd474deb4` from `cran_packages_by_date` as `registry_expansion`
