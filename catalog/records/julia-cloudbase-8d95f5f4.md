...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CloudBase](https://github.com/JuliaRegistries/General/tree/master/C/CloudBase) |
| Source record ids | julia_general-d395daa909735b |

## System Engineer Summary

Julia package registered in General at C/CloudBase.

## Operational Role

For a systems engineer, CloudBase belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CloudBase", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d395daa909735b` from `julia_general` as `registry_expansion`
