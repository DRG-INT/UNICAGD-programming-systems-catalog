...
<!-- canonical: https://cocoapods.org/pods/IGListKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/IGListKit](https://cocoapods.org/pods/IGListKit) |
| Source record ids | cocoapods_cdn-cc24c9c16969c2 |
...
For a systems engineer, IGListKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.2.0 | 2026-02-17 11:15:47 UTC | [https://trunk.cocoapods.org/api/v1/pods/IGListKit](https://trunk.cocoapods.org/api/v1/pods/IGListKit) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/IGListKit` at `2026-09-01T07:21:28+00:00`.
...
- `cocoapods_cdn-cc24c9c16969c2` from `cocoapods_cdn` as `registry_expansion`
