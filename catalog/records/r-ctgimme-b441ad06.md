...
<!-- canonical: https://cran.r-project.org/web/packages/ctgimme/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ctgimme/index.html](https://cran.r-project.org/web/packages/ctgimme/index.html) |
| Source record ids | cran_packages_by_date-4bf891ff76e07d |
...
For a systems engineer, ctgimme belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-28 14:30:15 UTC | [https://cran.r-project.org/web/packages/ctgimme/DESCRIPTION](https://cran.r-project.org/web/packages/ctgimme/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ctgimme/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4bf891ff76e07d` from `cran_packages_by_date` as `registry_expansion`
