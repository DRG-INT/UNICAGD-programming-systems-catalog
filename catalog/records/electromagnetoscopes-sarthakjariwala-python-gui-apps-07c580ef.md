...
<!-- canonical: https://github.com/SarthakJariwala/Python_GUI_apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SarthakJariwala/Python_GUI_apps](https://github.com/SarthakJariwala/Python_GUI_apps) |
| Source record ids | github_search_electromagnetoscopes-2273a34d7e141e |

## System Engineer Summary

GLabViz - Interactive Analysis and Visualization Application for Scientific Data written in Python
using Qt and pyqtrgaph

## Operational Role

For a systems engineer, SarthakJariwala/Python_GUI_apps belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-08T06:20:54Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-2273a34d7e141e` from `github_search_electromagnetoscopes` as `registry_expansion`
