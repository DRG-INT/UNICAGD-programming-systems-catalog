...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Mathews-Tom/Agentic-Design-Patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mathews-Tom/Agentic-Design-Patterns](https://github.com/Mathews-Tom/Agentic-Design-Patterns) |
| Source record ids | github_search_pattern_language-cbcd2f0caf4b5d |

## System Engineer Summary

Mathews-Tom/Agentic-Design-Patterns is tracked as a math numeric scientific record in the Pattern
...
For a systems engineer, Mathews-Tom/Agentic-Design-Patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-05T17:57:11Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-cbcd2f0caf4b5d` from `github_search_pattern_language` as `registry_expansion`
