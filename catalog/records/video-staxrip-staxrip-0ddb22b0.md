...
| Canonical URL | [https://github.com/staxrip/staxrip](https://github.com/staxrip/staxrip) |
| Source record ids | github_search_video-3ec57e5dfebded |
...
For a systems engineer, staxrip/staxrip belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.52.5 | 2026-08-08T14:42:03Z | [https://api.github.com/repos/staxrip/staxrip/releases/latest](https://api.github.com/repos/staxrip/staxrip/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/staxrip/staxrip/releases/latest` at `2026-09-01T09:23:26+00:00`.
...
- `github_search_video-3ec57e5dfebded` from `github_search_video` as `registry_expansion`
