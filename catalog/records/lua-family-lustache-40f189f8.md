...
<!-- canonical: http://olivinelabs.com/lustache/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://olivinelabs.com/lustache/](http://olivinelabs.com/lustache/) |
| Source record ids | lua-source-197 |
...
For a systems engineer, lustache belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 197}}` |
...
- `lua-source-197` from `master_json` as `source_list_item`
