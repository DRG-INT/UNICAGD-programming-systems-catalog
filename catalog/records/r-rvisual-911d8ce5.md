...
<!-- canonical: https://cran.r-project.org/web/packages/rvisual/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rvisual/index.html](https://cran.r-project.org/web/packages/rvisual/index.html) |
| Source record ids | cran_packages_by_date-bf116be6817a77 |

## System Engineer Summary

Visual Data Analysis 'RStudio' 'Addin' with AI Copilot

## Operational Role

For a systems engineer, rvisual belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-09 16:50:02 UTC | [https://cran.r-project.org/web/packages/rvisual/DESCRIPTION](https://cran.r-project.org/web/packages/rvisual/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rvisual/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-bf116be6817a77` from `cran_packages_by_date` as `registry_expansion`
