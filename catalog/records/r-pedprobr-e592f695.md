...
<!-- canonical: https://cran.r-project.org/web/packages/pedprobr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pedprobr/index.html](https://cran.r-project.org/web/packages/pedprobr/index.html) |
| Source record ids | cran_packages_by_date-06b8321736c322 |
...
For a systems engineer, pedprobr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-11 09:00:02 UTC | [https://cran.r-project.org/web/packages/pedprobr/DESCRIPTION](https://cran.r-project.org/web/packages/pedprobr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pedprobr/DESCRIPTION` at `2026-09-11T10:20:52+00:00`.
...
- `cran_packages_by_date-06b8321736c322` from `cran_packages_by_date` as `registry_expansion`
