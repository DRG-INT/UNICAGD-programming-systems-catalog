...
<!-- canonical: https://hackage.haskell.org/package/hdf5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hdf5](https://hackage.haskell.org/package/hdf5) |
| Source record ids | hackage_recent-f6957e818cba3b |

## System Engineer Summary

Hackage package recently uploaded by picca.

## Operational Role

For a systems engineer, hdf5 belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.16 | 2026-09-02T12:54:01Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-f6957e818cba3b` from `hackage_recent` as `registry_expansion`
