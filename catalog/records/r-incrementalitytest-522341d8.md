...
<!-- canonical: https://cran.r-project.org/web/packages/IncrementalityTEST/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IncrementalityTEST/index.html](https://cran.r-project.org/web/packages/IncrementalityTEST/index.html) |
| Source record ids | cran_packages_by_date-4d31011e1b7e50 |

## System Engineer Summary

Analyze Incrementality Experiments

## Operational Role

For a systems engineer, IncrementalityTEST belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-07 16:30:25 UTC | [https://cran.r-project.org/web/packages/IncrementalityTEST/DESCRIPTION](https://cran.r-project.org/web/packages/IncrementalityTEST/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IncrementalityTEST/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4d31011e1b7e50` from `cran_packages_by_date` as `registry_expansion`
