...
<!-- canonical: https://luarocks.org/modules/luaindonesia/contoh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luaindonesia/contoh](https://luarocks.org/modules/luaindonesia/contoh) |
| Source record ids | luarocks_root_manifest-fa33edfc61c0d3 |

## System Engineer Summary

Contoh library/modul Lua sederhana.

## Operational Role

For a systems engineer, contoh belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-fa33edfc61c0d3` from `luarocks_root_manifest` as `registry_expansion`
