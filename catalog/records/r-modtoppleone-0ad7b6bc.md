...
<!-- canonical: https://cran.r-project.org/web/packages/ModToppLeone/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ModToppLeone/index.html](https://cran.r-project.org/web/packages/ModToppLeone/index.html) |
| Source record ids | cran_packages_by_date-098e1ecd9abea3 |
...
For a systems engineer, ModToppLeone belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:40:18 UTC | [https://cran.r-project.org/web/packages/ModToppLeone/DESCRIPTION](https://cran.r-project.org/web/packages/ModToppLeone/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ModToppLeone/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-098e1ecd9abea3` from `cran_packages_by_date` as `registry_expansion`
