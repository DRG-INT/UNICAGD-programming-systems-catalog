...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/shmoergh/moduleur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shmoergh/moduleur](https://github.com/shmoergh/moduleur) |
| Source record ids | github_search_audio-5148e2853fd8db |

## System Engineer Summary

Fully analog DIY-friendly modular synth

## Operational Role

For a systems engineer, shmoergh/moduleur belongs in the Audio inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.1 | 2026-03-08T19:34:18Z | [https://api.github.com/repos/shmoergh/moduleur/releases/latest](https://api.github.com/repos/shmoergh/moduleur/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/shmoergh/moduleur/releases/latest` at `2026-09-01T11:21:42+00:00`.
...
- `github_search_audio-5148e2853fd8db` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| analogcode/Swift-Radio-Pro | Logging Observability | [open](audio-analogcode-swift-radio-pro-6d9ae883.md) |
| coqui-ai/open-speech-corpora | Logging Observability | [open](audio-coqui-ai-open-speech-corpora-1c314385.md) |
| huawei-noah/Speech-Backbones | Logging Observability | [open](audio-huawei-noah-speech-backbones-ae7b134d.md) |
| mzuelch/CATs-Eurosynth | Logging Observability | [open](audio-mzuelch-cats-eurosynth-a6002844.md) |
| newdigate/teensy-eurorack | Logging Observability | [open](audio-newdigate-teensy-eurorack-52a4de61.md) |
| OpenMOSS/MOSS-TTS | Logging Observability | [open](audio-openmoss-moss-tts-9e9e0059.md) |
| reales/OB-Xd | Logging Observability | [open](audio-reales-ob-xd-4de1e164.md) |
| sevagh/pitch-detection | Logging Observability | [open](audio-sevagh-pitch-detection-26bd609d.md) |
