...
<!-- canonical: https://gitlab.com/riot.ai/NoteRiot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/riot.ai/NoteRiot](https://gitlab.com/riot.ai/NoteRiot) |
| Source record ids | gitlab_projects_api-33213a7358d0a7 |

## System Engineer Summary

NoteRiot is an easy to use decentralized app (dapp) built on Blockstack's blockchain-based self-
sovereign identity and bitcoin level security.

## Operational Role

For a systems engineer, riot.ai/NoteRiot belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-33213a7358d0a7` from `gitlab_projects_api` as `registry_expansion`
