...
<!-- canonical: https://luarocks.org/modules/wsdjeg/bufdel.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/bufdel.nvim](https://luarocks.org/modules/wsdjeg/bufdel.nvim) |
| Source record ids | luarocks_root_manifest-98bce8390e7a15 |

## System Engineer Summary

bufdel.nvim is tracked as an ide editor integration record in the Lua family branch. The source did
...
For a systems engineer, bufdel.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-98bce8390e7a15` from `luarocks_root_manifest` as `registry_expansion`
