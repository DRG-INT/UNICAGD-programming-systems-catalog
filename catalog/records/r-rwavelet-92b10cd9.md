...
<!-- canonical: https://cran.r-project.org/web/packages/rwavelet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rwavelet/index.html](https://cran.r-project.org/web/packages/rwavelet/index.html) |
| Source record ids | cran_packages_by_date-f1237e97a395fd |

## System Engineer Summary

rwavelet is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, rwavelet belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-08-28 17:10:02 UTC | [https://cran.r-project.org/web/packages/rwavelet/DESCRIPTION](https://cran.r-project.org/web/packages/rwavelet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rwavelet/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f1237e97a395fd` from `cran_packages_by_date` as `registry_expansion`
