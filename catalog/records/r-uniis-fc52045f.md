...
<!-- canonical: https://cran.r-project.org/web/packages/UniIS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/UniIS/index.html](https://cran.r-project.org/web/packages/UniIS/index.html) |
| Source record ids | cran_packages_by_date-1eef8791ee950c |
...
For a systems engineer, UniIS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 10:10:02 UTC | [https://cran.r-project.org/web/packages/UniIS/DESCRIPTION](https://cran.r-project.org/web/packages/UniIS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/UniIS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-1eef8791ee950c` from `cran_packages_by_date` as `registry_expansion`
