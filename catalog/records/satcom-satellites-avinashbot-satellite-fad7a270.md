...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/avinashbot/satellite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avinashbot/satellite](https://github.com/avinashbot/satellite) |
| Source record ids | github_search_satcom_satellites-5c45b68a2b0450 |
...
For a systems engineer, avinashbot/satellite belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-23T16:32:03Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-5c45b68a2b0450` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| handiko/gr-APRS | Testing Framework | [open](satcom-satellites-handiko-gr-aprs-74d6a81c.md) |
| sabbir-uoulu/open-source-5g-ntn-leo | Testing Framework | [open](satcom-satellites-sabbir-uoulu-open-source-5g-ntn-leo-2980cc7d.md) |
| ungoldman/himawari-bg | Testing Framework | [open](satcom-satellites-ungoldman-himawari-bg-83627cbe.md) |
