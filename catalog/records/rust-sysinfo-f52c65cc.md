...
| Canonical URL | [https://crates.io/crates/sysinfo](https://crates.io/crates/sysinfo) |
| Source record ids | crates_io-866421d21e056d, crates_io-5d58227b474404 |
...
For a systems engineer, sysinfo belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.39.6 | 2026-07-09T10:46:59.210840Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-866421d21e056d` from `crates_io` as `registry_expansion`
- `crates_io-5d58227b474404` from `crates_io` as `registry_expansion`
