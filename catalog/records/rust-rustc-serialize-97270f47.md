...
| Canonical URL | [https://crates.io/crates/rustc-serialize](https://crates.io/crates/rustc-serialize) |
| Source record ids | crates_io-66b79d56e4a2ec |

## System Engineer Summary

Generic serialization/deserialization support corresponding to the `derive(RustcEncodable,
RustcDecodable)` mode in the compiler. Also includes support for hex, base64, and json encoding and
decoding. This crate is deprecated in favor of serde.

## Operational Role

For a systems engineer, rustc-serialize belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.25 | 2023-12-01T09:52:20.384822Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-66b79d56e4a2ec` from `crates_io` as `registry_expansion`
