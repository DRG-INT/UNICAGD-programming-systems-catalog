...
<!-- canonical: https://luarocks.org/modules/dreamega/dreamega-ico-encoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dreamega/dreamega-ico-encoder](https://luarocks.org/modules/dreamega/dreamega-ico-encoder) |
| Source record ids | luarocks_root_manifest-45b546ea99020b |

## System Engineer Summary

Generate multi-size ICO favicon files from PNG images

## Operational Role

For a systems engineer, dreamega-ico-encoder belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-45b546ea99020b` from `luarocks_root_manifest` as `registry_expansion`
