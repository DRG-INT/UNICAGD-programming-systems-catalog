...
<!-- canonical: https://cran.r-project.org/web/packages/dobson/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dobson/index.html](https://cran.r-project.org/web/packages/dobson/index.html) |
| Source record ids | cran_packages_by_date-f83968297134e6 |
...
For a systems engineer, dobson belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-28 09:50:31 UTC | [https://cran.r-project.org/web/packages/dobson/DESCRIPTION](https://cran.r-project.org/web/packages/dobson/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dobson/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f83968297134e6` from `cran_packages_by_date` as `registry_expansion`
