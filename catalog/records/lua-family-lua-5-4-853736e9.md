...
| Source record ids | master-c6d2bd1a8de6 |

## System Engineer Summary

Lua 5.4 language/reference line

## Operational Role

For a systems engineer, Lua 5.4 belongs in the Lua family inventory as part of ecosystem capability
...
- `master-c6d2bd1a8de6` from `master_json` as `language_specification`
