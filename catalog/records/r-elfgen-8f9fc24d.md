...
<!-- canonical: https://cran.r-project.org/web/packages/elfgen/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/elfgen/index.html](https://cran.r-project.org/web/packages/elfgen/index.html) |
| Source record ids | cran_packages_by_date-fbcd2edbc044ed |
...
For a systems engineer, elfgen belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.6 | 2026-09-15 23:40:02 UTC | [https://cran.r-project.org/web/packages/elfgen/DESCRIPTION](https://cran.r-project.org/web/packages/elfgen/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/elfgen/DESCRIPTION` at `2026-09-16T00:25:59+00:00`.
...
- `cran_packages_by_date-fbcd2edbc044ed` from `cran_packages_by_date` as `registry_expansion`
