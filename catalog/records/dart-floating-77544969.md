...
<!-- canonical: https://pub.dev/packages/floating -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/floating](https://pub.dev/packages/floating) |
| Source record ids | pub_dev-ee3a6b8a1eebdf |
...
For a systems engineer, floating belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2025-02-14T19:30:57.061512Z | [https://pub.dev/api/packages/floating](https://pub.dev/api/packages/floating) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/floating` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-ee3a6b8a1eebdf` from `pub_dev` as `registry_expansion`
