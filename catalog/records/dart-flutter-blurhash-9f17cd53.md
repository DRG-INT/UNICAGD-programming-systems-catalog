...
<!-- canonical: https://pub.dev/packages/flutter_blurhash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_blurhash](https://pub.dev/packages/flutter_blurhash) |
| Source record ids | pub_dev-ad833d1f752c3f |

## System Engineer Summary

Compact representation of placeholder for an image. Encode a blurry image under 30 characters for
instant display like used by Medium

## Operational Role

For a systems engineer, flutter_blurhash belongs in the Dart inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2025-04-22T18:47:22.306471Z | [https://pub.dev/api/packages/flutter_blurhash](https://pub.dev/api/packages/flutter_blurhash) |  |
| preview | known | 0.5.4-nullsafety.0 | 2021-03-07T01:46:31.915619Z | [https://pub.dev/api/packages/flutter_blurhash](https://pub.dev/api/packages/flutter_blurhash) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; ISC License; https://api.github.com/licenses/isc; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_blurhash` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-ad833d1f752c3f` from `pub_dev` as `registry_expansion`
