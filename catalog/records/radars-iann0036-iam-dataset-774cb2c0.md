...
<!-- canonical: https://github.com/iann0036/iam-dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iann0036/iam-dataset](https://github.com/iann0036/iam-dataset) |
| Source record ids | github_search_radars-06e9f745d4d193 |

## System Engineer Summary

A consolidated series of structured data for cloud identity and access management systems, including
datasets for AWS, Azure, and Google Cloud

## Operational Role

For a systems engineer, iann0036/iam-dataset belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T16:04:46Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-06e9f745d4d193` from `github_search_radars` as `registry_expansion`
