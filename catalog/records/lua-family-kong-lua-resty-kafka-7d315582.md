...
| Canonical URL | [https://luarocks.org/modules/kong/kong-lua-resty-kafka](https://luarocks.org/modules/kong/kong-lua-resty-kafka) |
| Source record ids | luarocks_root_manifest-ba219a2a544c95 |
...
For a systems engineer, kong-lua-resty-kafka belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-ba219a2a544c95` from `luarocks_root_manifest` as `registry_expansion`
