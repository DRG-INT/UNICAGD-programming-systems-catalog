...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/biergaizi/project-diamond -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/biergaizi/project-diamond](https://github.com/biergaizi/project-diamond) |
| Source record ids | github_search_electromagnetoscopes-05e44236e7e39d |
...
For a systems engineer, biergaizi/project-diamond belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-26T18:19:46Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-05e44236e7e39d` from `github_search_electromagnetoscopes` as `registry_expansion`
