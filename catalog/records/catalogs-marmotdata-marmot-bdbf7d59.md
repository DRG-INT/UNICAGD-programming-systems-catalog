...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/marmotdata/marmot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marmotdata/marmot](https://github.com/marmotdata/marmot) |
| Source record ids | github_search_catalogs-31eeb24aaf3f7c |

## System Engineer Summary

The open-source context layer for your AI. Catalog your tables, topics, queues and APIs then expose
real metadata to your AI agents.

## Operational Role

For a systems engineer, marmotdata/marmot belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:59:48Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-31eeb24aaf3f7c` from `github_search_catalogs` as `registry_expansion`
