...
| Canonical URL | [https://luarocks.org/modules/p6/kong-event-pub](https://luarocks.org/modules/p6/kong-event-pub) |
| Source record ids | luarocks_root_manifest-b27eefe70f5a7f |

## System Engineer Summary

Turn Kong API logs into an event solurce

## Operational Role

For a systems engineer, kong-event-pub belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b27eefe70f5a7f` from `luarocks_root_manifest` as `registry_expansion`
