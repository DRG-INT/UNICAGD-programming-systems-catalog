...
<!-- canonical: https://www.npmjs.com/package/@apollo/server-gateway-interface -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@apollo/server-gateway-interface](https://www.npmjs.com/package/@apollo/server-gateway-interface) |
| Source record ids | npm_registry-1ebcbfe03428d6 |
...
For a systems engineer, @apollo/server-gateway-interface belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-07-17T16:58:17.056Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-1ebcbfe03428d6` from `npm_registry` as `registry_expansion`
