...
<!-- canonical: https://cran.r-project.org/web/packages/clipp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clipp/index.html](https://cran.r-project.org/web/packages/clipp/index.html) |
| Source record ids | cran_packages_by_date-2845a881918a43 |
...
For a systems engineer, clipp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-01 09:50:12 UTC | [https://cran.r-project.org/web/packages/clipp/DESCRIPTION](https://cran.r-project.org/web/packages/clipp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clipp/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-2845a881918a43` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| artoo | Cli | [open](r-artoo-b9a4660a.md) |
