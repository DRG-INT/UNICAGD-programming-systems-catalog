...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/mason -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mason](https://pub.dev/packages/mason) |
| Source record ids | pub_dev-be2768edcc2c43 |
...
For a systems engineer, mason belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2025-11-25T17:05:45.227333Z | [https://pub.dev/api/packages/mason](https://pub.dev/api/packages/mason) |  |
| preview | known | 0.1.0-dev.60 | 2024-09-05T04:39:50.452178Z | [https://pub.dev/api/packages/mason](https://pub.dev/api/packages/mason) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mason` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-be2768edcc2c43` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mason_cli | Project Scaffolding | [open](dart-mason-cli-a49cc7e6.md) |
