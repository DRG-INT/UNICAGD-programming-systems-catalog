...
<!-- canonical: https://github.com/PangzeCheung/OmniTransfer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PangzeCheung/OmniTransfer](https://github.com/PangzeCheung/OmniTransfer) |
| Source record ids | github_search_effects-3726df58f7a638 |
...
For a systems engineer, PangzeCheung/OmniTransfer belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-15T14:13:50Z | gh search repos topic:visual-effects stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3726df58f7a638` from `github_search_effects` as `registry_expansion`
