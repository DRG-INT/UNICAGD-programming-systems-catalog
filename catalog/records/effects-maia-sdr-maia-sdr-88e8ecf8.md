...
| Source record ids | github_search_effects-86b14337e9d540 |
...
For a systems engineer, maia-sdr/maia-sdr belongs in the Effects inventory as part of model
...
- `github_search_effects-86b14337e9d540` from `github_search_effects` as `registry_expansion`
