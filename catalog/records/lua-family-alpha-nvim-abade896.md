...
<!-- canonical: https://luarocks.org/modules/neorocks/alpha-nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/alpha-nvim](https://luarocks.org/modules/neorocks/alpha-nvim) |
| Source record ids | luarocks_root_manifest-dd7dce38dab331 |
...
For a systems engineer, alpha-nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-dd7dce38dab331` from `luarocks_root_manifest` as `registry_expansion`
