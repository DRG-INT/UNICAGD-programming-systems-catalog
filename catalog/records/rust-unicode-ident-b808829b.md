...
<!-- canonical: https://crates.io/crates/unicode-ident -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-ident](https://crates.io/crates/unicode-ident) |
| Source record ids | crates_io-21840d06c219d1 |

## System Engineer Summary

Determine whether characters have the XID_Start or XID_Continue properties according to Unicode
Standard Annex #31

## Operational Role

For a systems engineer, unicode-ident belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.24 | 2026-02-16T02:46:44.304053Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-21840d06c219d1` from `crates_io` as `registry_expansion`
