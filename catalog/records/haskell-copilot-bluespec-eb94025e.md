...
<!-- canonical: https://hackage.haskell.org/package/copilot-bluespec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/copilot-bluespec](https://hackage.haskell.org/package/copilot-bluespec) |
| Source record ids | hackage_recent-9e889950e5d958 |
...
For a systems engineer, copilot-bluespec belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:19:50Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-9e889950e5d958` from `hackage_recent` as `registry_expansion`
