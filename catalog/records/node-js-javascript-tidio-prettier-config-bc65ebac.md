...
| Canonical URL | [https://www.npmjs.com/package/@tidio/prettier-config](https://www.npmjs.com/package/@tidio/prettier-config) |
| Source record ids | npm_registry-628b66083db9e6 |

## System Engineer Summary

@tidio/prettier-config is tracked as a formatter record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @tidio/prettier-config belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2023-10-23T07:39:44.898Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-628b66083db9e6` from `npm_registry` as `registry_expansion`
