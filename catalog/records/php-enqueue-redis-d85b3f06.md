...
| Canonical URL | [https://packagist.org/packages/enqueue/redis](https://packagist.org/packages/enqueue/redis) |
| Source record ids | packagist_search-79e0e240f0503f |
...
For a systems engineer, enqueue/redis belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.27 | 2025-12-21T19:54:29+00:00 | [https://repo.packagist.org/p2/enqueue/redis.json](https://repo.packagist.org/p2/enqueue/redis.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/enqueue/redis.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-79e0e240f0503f` from `packagist_search` as `registry_expansion`
