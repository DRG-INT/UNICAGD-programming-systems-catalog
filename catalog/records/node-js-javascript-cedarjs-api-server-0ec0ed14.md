...
<!-- canonical: https://www.npmjs.com/package/@cedarjs/api-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@cedarjs/api-server](https://www.npmjs.com/package/@cedarjs/api-server) |
| Source record ids | npm_registry-86dfb80f641fcb |
...
For a systems engineer, @cedarjs/api-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.1 | 2026-08-29T05:33:02.047Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-86dfb80f641fcb` from `npm_registry` as `registry_expansion`
