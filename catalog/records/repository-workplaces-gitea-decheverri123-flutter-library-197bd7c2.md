# Gitea: decheverri123/flutter_library
...
<!-- canonical: https://gitea.com/decheverri123/flutter_library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/decheverri123/flutter_library](https://gitea.com/decheverri123/flutter_library) |
| Source record ids | gitea_repositories_api-a09ce26d589e93 |
...
For a systems engineer, Gitea: decheverri123/flutter_library belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-28T18:41:42Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-a09ce26d589e93` from `gitea_repositories_api` as `registry_expansion`
