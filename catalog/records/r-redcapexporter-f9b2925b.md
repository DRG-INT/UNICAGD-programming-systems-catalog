...
<!-- canonical: https://cran.r-project.org/web/packages/REDCapExporter/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/REDCapExporter/index.html](https://cran.r-project.org/web/packages/REDCapExporter/index.html) |
| Source record ids | cran_packages_by_date-19b108d1fff51a |
...
For a systems engineer, REDCapExporter belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2026-08-21 17:40:14 UTC | [https://cran.r-project.org/web/packages/REDCapExporter/DESCRIPTION](https://cran.r-project.org/web/packages/REDCapExporter/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/REDCapExporter/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-19b108d1fff51a` from `cran_packages_by_date` as `registry_expansion`
