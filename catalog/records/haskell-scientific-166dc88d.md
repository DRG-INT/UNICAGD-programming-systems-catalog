...
<!-- canonical: https://hackage.haskell.org/package/scientific -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/scientific](https://hackage.haskell.org/package/scientific) |
| Source record ids | hackage_top_downloads-9b797bd6d99740 |
...
For a systems engineer, scientific belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.8.1 | 2026-01-05T13:02:29Z | [https://hackage.haskell.org/package/scientific](https://hackage.haskell.org/package/scientific) |  |
| candidate | partial | 0.3.6.0 |  | [https://hackage.haskell.org/package/scientific](https://hackage.haskell.org/package/scientific) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/scientific` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-9b797bd6d99740` from `hackage_top_downloads` as `registry_expansion`
...
| numeric-prelude | Math Numeric Scientific | [open](haskell-numeric-prelude-eed0500b.md) |
