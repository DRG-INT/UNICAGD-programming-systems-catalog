...
<!-- canonical: https://cran.r-project.org/web/packages/texreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/texreg/index.html](https://cran.r-project.org/web/packages/texreg/index.html) |
| Source record ids | cran_packages_by_date-b4a5d270f4fd98 |
...
For a systems engineer, texreg belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.40 | 2026-08-25 05:20:02 UTC | [https://cran.r-project.org/web/packages/texreg/DESCRIPTION](https://cran.r-project.org/web/packages/texreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/texreg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b4a5d270f4fd98` from `cran_packages_by_date` as `registry_expansion`
