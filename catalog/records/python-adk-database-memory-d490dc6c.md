...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/adk-database-memory/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adk-database-memory/](https://pypi.org/project/adk-database-memory/) |
| Source record ids | pypi_simple-9ca8976a6af401 |

## System Engineer Summary

SQL-backed memory service for the Google Agent Development Kit (ADK). Supports SQLite, PostgreSQL,
MySQL/MariaDB and any async SQLAlchemy dialect.

## Operational Role

For a systems engineer, adk-database-memory belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-04-21T07:23:43.803437Z | [https://pypi.org/pypi/adk-database-memory/json](https://pypi.org/pypi/adk-database-memory/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adk-database-memory/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-9ca8976a6af401` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| a2a-server | Memory Analyzer | [open](python-a2a-server-7f6e9e7a.md) |
| aceflow-mcp-server | Memory Analyzer | [open](python-aceflow-mcp-server-c439298f.md) |
