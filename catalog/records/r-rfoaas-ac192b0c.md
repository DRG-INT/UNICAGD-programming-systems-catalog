...
<!-- canonical: https://cran.r-project.org/web/packages/rfoaas/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rfoaas/index.html](https://cran.r-project.org/web/packages/rfoaas/index.html) |
| Source record ids | cran_packages_by_date-56599bbfa3fb4d |

## System Engineer Summary

rfoaas is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, rfoaas belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.0 | 2026-09-05 15:40:02 UTC | [https://cran.r-project.org/web/packages/rfoaas/DESCRIPTION](https://cran.r-project.org/web/packages/rfoaas/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rfoaas/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-56599bbfa3fb4d` from `cran_packages_by_date` as `registry_expansion`
