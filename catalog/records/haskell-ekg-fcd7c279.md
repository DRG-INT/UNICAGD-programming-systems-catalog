...
<!-- canonical: https://hackage.haskell.org/package/ekg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ekg](https://hackage.haskell.org/package/ekg) |
| Source record ids | hackage_top_downloads-c9f53f6ba3cde3 |
...
For a systems engineer, ekg belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.2 | 2025-04-22T16:05:36Z | [https://hackage.haskell.org/package/ekg](https://hackage.haskell.org/package/ekg) |  |
| candidate | partial | 0.4.0.15 |  | [https://hackage.haskell.org/package/ekg](https://hackage.haskell.org/package/ekg) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ekg` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-c9f53f6ba3cde3` from `hackage_top_downloads` as `registry_expansion`
