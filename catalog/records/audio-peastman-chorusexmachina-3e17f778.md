# peastman/ChorusExMachina

## Navigation

[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/peastman/ChorusExMachina -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peastman/ChorusExMachina](https://github.com/peastman/ChorusExMachina) |
| Source record ids | github_search_audio-40e7c344c9a188 |

## System Engineer Summary

peastman/ChorusExMachina is tracked as a parser lexer ast record in the Audio branch. The source did
...
For a systems engineer, peastman/ChorusExMachina belongs in the Audio inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-05T22:14:43Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `github_search_audio-40e7c344c9a188` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adefossez/julius | Parser Lexer Ast | [open](audio-adefossez-julius-332f2bf3.md) |
| avaneev/r8brain-free-src | Parser Lexer Ast | [open](audio-avaneev-r8brain-free-src-df39a53a.md) |
| huggingface/distil-whisper | Parser Lexer Ast | [open](audio-huggingface-distil-whisper-4612ba97.md) |
| iver56/torch-audiomentations | Parser Lexer Ast | [open](audio-iver56-torch-audiomentations-c42fa5d3.md) |
| kayrockscreenprinting/ultramaster_kr106 | Parser Lexer Ast | [open](audio-kayrockscreenprinting-ultramaster-kr106-706fda18.md) |
| kfrlib/kfr | Parser Lexer Ast | [open](audio-kfrlib-kfr-16ccf88e.md) |
| lucianoiam/castello | Parser Lexer Ast | [open](audio-lucianoiam-castello-ed99de92.md) |
| m1ckc3s/procedural-sounds | Parser Lexer Ast | [open](audio-m1ckc3s-procedural-sounds-dbbd8e64.md) |
