...
<!-- canonical: https://cran.r-project.org/web/packages/npmv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/npmv/index.html](https://cran.r-project.org/web/packages/npmv/index.html) |
| Source record ids | cran_packages_by_date-c155d702ca3268 |
...
For a systems engineer, npmv belongs in the R inventory as part of dependency acquisition, lockfile
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2026-08-28 10:30:02 UTC | [https://cran.r-project.org/web/packages/npmv/DESCRIPTION](https://cran.r-project.org/web/packages/npmv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/npmv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c155d702ca3268` from `cran_packages_by_date` as `registry_expansion`
