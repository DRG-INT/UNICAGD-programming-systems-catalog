...
<!-- canonical: https://github.com/pouyaardehkhani/VCC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pouyaardehkhani/VCC](https://github.com/pouyaardehkhani/VCC) |
| Source record ids | github_search_video-8913bfcde0c596 |
...
For a systems engineer, pouyaardehkhani/VCC belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-24T21:02:02Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-8913bfcde0c596` from `github_search_video` as `registry_expansion`
