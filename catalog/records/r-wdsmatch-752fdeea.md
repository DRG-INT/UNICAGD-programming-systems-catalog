...
<!-- canonical: https://cran.r-project.org/web/packages/wdsmatch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wdsmatch/index.html](https://cran.r-project.org/web/packages/wdsmatch/index.html) |
| Source record ids | cran_packages_by_date-ec1764f1452eab |
...
For a systems engineer, wdsmatch belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-11 21:20:02 UTC | [https://cran.r-project.org/web/packages/wdsmatch/DESCRIPTION](https://cran.r-project.org/web/packages/wdsmatch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wdsmatch/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-ec1764f1452eab` from `cran_packages_by_date` as `registry_expansion`
