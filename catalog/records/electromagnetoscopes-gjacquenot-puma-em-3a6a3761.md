...
<!-- canonical: https://github.com/Gjacquenot/Puma-EM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Gjacquenot/Puma-EM](https://github.com/Gjacquenot/Puma-EM) |
| Source record ids | github_search_electromagnetoscopes-a703e11f816389 |

## System Engineer Summary

open source MLFMA (multi level fast multipole algorithm) or open source MLFMM (multi level fast
multipole method)

## Operational Role

For a systems engineer, Gjacquenot/Puma-EM belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-12T13:09:29Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-a703e11f816389` from `github_search_electromagnetoscopes` as `registry_expansion`
