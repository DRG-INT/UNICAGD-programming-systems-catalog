...
<!-- canonical: https://cran.r-project.org/web/packages/vntrs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vntrs/index.html](https://cran.r-project.org/web/packages/vntrs/index.html) |
| Source record ids | cran_packages_by_date-1bf24dd49cf929 |
...
For a systems engineer, vntrs belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-03 17:30:02 UTC | [https://cran.r-project.org/web/packages/vntrs/DESCRIPTION](https://cran.r-project.org/web/packages/vntrs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vntrs/DESCRIPTION` at `2026-09-03T18:23:06+00:00`.
...
- `cran_packages_by_date-1bf24dd49cf929` from `cran_packages_by_date` as `registry_expansion`
