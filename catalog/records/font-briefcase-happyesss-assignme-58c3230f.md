...
<!-- canonical: https://github.com/Happyesss/assignme -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Happyesss/assignme](https://github.com/Happyesss/assignme) |
| Source record ids | github_search_font_briefcase-5926e287a3b60b |

## System Engineer Summary

Assignme is an open source web application that helps students complete their assignments by
converting digital text into customizable handwritten-style documents.

## Operational Role

For a systems engineer, Happyesss/assignme belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-02T21:07:56Z | gh search repos topic:fontforge stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-5926e287a3b60b` from `github_search_font_briefcase` as `registry_expansion`
