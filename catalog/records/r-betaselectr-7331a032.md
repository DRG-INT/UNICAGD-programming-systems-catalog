...
<!-- canonical: https://cran.r-project.org/web/packages/betaselectr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/betaselectr/index.html](https://cran.r-project.org/web/packages/betaselectr/index.html) |
| Source record ids | cran_packages_by_date-d3b22c2f38d1a5 |
...
For a systems engineer, betaselectr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-08-23 09:20:02 UTC | [https://cran.r-project.org/web/packages/betaselectr/DESCRIPTION](https://cran.r-project.org/web/packages/betaselectr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/betaselectr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d3b22c2f38d1a5` from `cran_packages_by_date` as `registry_expansion`
