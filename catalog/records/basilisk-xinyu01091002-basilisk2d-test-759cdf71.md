# Xinyu01091002/Basilisk2D_test

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Xinyu01091002/Basilisk2D_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Xinyu01091002/Basilisk2D_test](https://github.com/Xinyu01091002/Basilisk2D_test) |
| Source record ids | github_search_basilisk-5cc20df09b69fc |

## System Engineer Summary

This is a code writtein in Basilisk C to simulation the water wave breaking with AMR

## Operational Role

For a systems engineer, Xinyu01091002/Basilisk2D_test belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-19T10:07:00Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-5cc20df09b69fc` from `github_search_basilisk` as `registry_expansion`
