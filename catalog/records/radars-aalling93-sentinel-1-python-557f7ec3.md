...
<!-- canonical: https://github.com/aalling93/Sentinel_1_python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aalling93/Sentinel_1_python](https://github.com/aalling93/Sentinel_1_python) |
| Source record ids | github_search_radars-44ba5598d05d33 |

## System Engineer Summary

Sentinel-1 SAR in Python. Work with Metadata, Download Images, Load image, Calibrate the images,
Speckle Filter the images. In short: Work with Sentinel 1 with only python...

## Operational Role

For a systems engineer, aalling93/Sentinel_1_python belongs in the Radars inventory as part of
...
| preview | known | v0.0.4 | 2022-10-16T20:07:34Z | [https://api.github.com/repos/aalling93/Sentinel_1_python/releases?per_page=10](https://api.github.com/repos/aalling93/Sentinel_1_python/releases?per_page=10) |  |
...
- `github_search_radars-44ba5598d05d33` from `github_search_radars` as `registry_expansion`
