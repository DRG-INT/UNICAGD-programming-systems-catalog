...
| Canonical URL | [https://github.com/moteus/lua-log](https://github.com/moteus/lua-log) |
| Source record ids | lua-source-148 |
...
For a systems engineer, lua-log belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.6 | 2016-09-15T13:47:16Z | [https://api.github.com/repos/moteus/lua-log/releases/latest](https://api.github.com/repos/moteus/lua-log/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/moteus/lua-log/releases/latest` at `2026-09-01T03:21:52+00:00`.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 148}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-148` from `master_json` as `source_list_item`
