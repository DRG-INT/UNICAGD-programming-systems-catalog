...
<!-- canonical: https://github.com/ArcadeData/arcadedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ArcadeData/arcadedb](https://github.com/ArcadeData/arcadedb) |
| Source record ids | github_search_databases-a0b7dc6fef3080 |

## System Engineer Summary

ArcadeDB Multi-Model Database, one DBMS that supports SQL, Cypher, Gremlin, HTTP/JSON, MongoDB and
Redis. ArcadeDB is a conceptual fork of OrientDB, the first Multi-Model DBMS. ArcadeDB supports
Vector Embeddings.

## Operational Role

For a systems engineer, ArcadeData/arcadedb belongs in the Databases inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:08:42Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a0b7dc6fef3080` from `github_search_databases` as `registry_expansion`
