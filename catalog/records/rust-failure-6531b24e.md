...
| Canonical URL | [https://crates.io/crates/failure](https://crates.io/crates/failure) |
| Source record ids | crates_io-c43376741850dd |
...
For a systems engineer, failure belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2020-05-02T18:13:11.746367Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-c43376741850dd` from `crates_io` as `registry_expansion`
