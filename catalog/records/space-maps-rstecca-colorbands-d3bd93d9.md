...
<!-- canonical: https://github.com/rstecca/ColorBands -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rstecca/ColorBands](https://github.com/rstecca/ColorBands) |
| Source record ids | github_search_space_maps-d9b7d38c05043a |

## System Engineer Summary

Unity 3D's Gradient is a handy data type but comes with some limitations: for example you cannot set
more than 8 color keys in its editor and RGB is the only color space available. ColorBand data type
offers an alternative with less limitations. Creating ColorBands is fun and easy; they are stored as
assets and can be accessed from code through an Evaluate method to get the color at time t, as for
Gradient. RGB (or HSV) values are described by individual curves, allowing a better control over how
the color function evolves between your points. Color bands are used in all kinds of applications
including games, data visualization and other fields.

## Operational Role

For a systems engineer, rstecca/ColorBands belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-06T16:06:39Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d9b7d38c05043a` from `github_search_space_maps` as `registry_expansion`
