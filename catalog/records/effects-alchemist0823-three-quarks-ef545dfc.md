...
<!-- canonical: https://github.com/Alchemist0823/three.quarks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Alchemist0823/three.quarks](https://github.com/Alchemist0823/three.quarks) |
| Source record ids | github_search_effects-46320a1415f0ed |
...
For a systems engineer, Alchemist0823/three.quarks belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-21T01:48:08Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-46320a1415f0ed` from `github_search_effects` as `registry_expansion`
