...
<!-- canonical: https://github.com/WZBSocialScienceCenter/pdftabextract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WZBSocialScienceCenter/pdftabextract](https://github.com/WZBSocialScienceCenter/pdftabextract) |
| Source record ids | github_search_photography-10243049a82c8c |
...
For a systems engineer, WZBSocialScienceCenter/pdftabextract belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-24T09:51:22Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-10243049a82c8c` from `github_search_photography` as `registry_expansion`
