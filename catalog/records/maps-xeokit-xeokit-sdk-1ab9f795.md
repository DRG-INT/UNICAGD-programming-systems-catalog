...
| Source record ids | github_search_maps-eb6e2a3e115878 |
...
For a systems engineer, xeokit/xeokit-sdk belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:32:58Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-eb6e2a3e115878` from `github_search_maps` as `registry_expansion`
