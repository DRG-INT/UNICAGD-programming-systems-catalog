...
| Canonical URL | [https://luarocks.org/modules/types/fenster-tl-type](https://luarocks.org/modules/types/fenster-tl-type) |
| Source record ids | luarocks_root_manifest-475bcf9dc99f5d |

## System Engineer Summary

Teal type definition files for fenster

## Operational Role

For a systems engineer, fenster-tl-type belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-475bcf9dc99f5d` from `luarocks_root_manifest` as `registry_expansion`
