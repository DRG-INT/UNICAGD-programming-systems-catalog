...
| Canonical URL | [https://github.com/CellProfiler/CellProfiler](https://github.com/CellProfiler/CellProfiler) |
| Source record ids | curated_language_routes-6a82b5a10ebac3 |

## System Engineer Summary

Image analysis software for quantitative microscopy, segmentation, measurement, and pipeline
automation.

## Operational Role

For a systems engineer, CellProfiler belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.2.8 | 2024-09-27T21:18:50Z | [https://api.github.com/repos/CellProfiler/CellProfiler/releases/latest](https://api.github.com/repos/CellProfiler/CellProfiler/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CellProfiler/CellProfiler/releases/latest` at `2026-09-01T07:24:45+00:00`.
...
- `curated_language_routes-6a82b5a10ebac3` from `curated_language_routes` as `registry_expansion`
