...
<!-- canonical: https://github.com/ToxSam/os3a-gallery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ToxSam/os3a-gallery](https://github.com/ToxSam/os3a-gallery) |
| Source record ids | github_search_assets-07489d289acb1c |

## System Engineer Summary

A curated discovery platform for high-quality, freely available 3D assets (GLB format). Browse
hundreds CC0 models with clear open source licensing. Built with Next.js, Three.js, and TailwindCSS.

## Operational Role

For a systems engineer, ToxSam/os3a-gallery belongs in the Assets inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-10T16:33:02Z | gh search repos topic:3d-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-07489d289acb1c` from `github_search_assets` as `registry_expansion`
