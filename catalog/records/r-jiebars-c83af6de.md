...
<!-- canonical: https://cran.r-project.org/web/packages/jiebaRS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jiebaRS/index.html](https://cran.r-project.org/web/packages/jiebaRS/index.html) |
| Source record ids | cran_packages_by_date-1b69ba44aa12ab |
...
For a systems engineer, jiebaRS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-26 11:40:02 UTC | [https://cran.r-project.org/web/packages/jiebaRS/DESCRIPTION](https://cran.r-project.org/web/packages/jiebaRS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jiebaRS/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1b69ba44aa12ab` from `cran_packages_by_date` as `registry_expansion`
