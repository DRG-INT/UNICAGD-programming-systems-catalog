...
<!-- canonical: https://gitlab.com/gitlab-org/advisories-community -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/advisories-community](https://gitlab.com/gitlab-org/advisories-community) |
| Source record ids | gitlab_projects_api-87d2636efea6ca |
...
For a systems engineer, gitlab-org/advisories-community belongs in the Repository Workplaces
...
- `gitlab_projects_api-87d2636efea6ca` from `gitlab_projects_api` as `registry_expansion`
