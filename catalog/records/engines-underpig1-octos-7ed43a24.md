...
<!-- canonical: https://github.com/underpig1/octos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/underpig1/octos](https://github.com/underpig1/octos) |
| Source record ids | github_search_engines-cb8c85278c7b86 |

## System Engineer Summary

Create and share web-based interactive, animated wallpapers on Windows :rocket: Available on the
Microsoft Store

## Operational Role

For a systems engineer, underpig1/octos belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-06T01:32:58Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-cb8c85278c7b86` from `github_search_engines` as `registry_expansion`
