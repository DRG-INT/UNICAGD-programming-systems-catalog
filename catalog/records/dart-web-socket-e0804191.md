...
<!-- canonical: https://pub.dev/packages/web_socket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/web_socket](https://pub.dev/packages/web_socket) |
| Source record ids | pub_dev-610757e2fc2c73 |
...
For a systems engineer, web_socket belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2025-05-06T00:19:01.236310Z | [https://pub.dev/api/packages/web_socket](https://pub.dev/api/packages/web_socket) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/web_socket` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-610757e2fc2c73` from `pub_dev` as `registry_expansion`
