...
<!-- canonical: https://github.com/alibaba/PhotonLibOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) |
| Source record ids | awesome_list-8090a773fef039 |

## System Engineer Summary

A comprehensive C++ framework featuring efficient user-space threading (coroutine with work-
stealing), I/O, networking, RPC, HTTP, etc., and used extensively in Alibaba. It is compatible with
C++ 14/17/20/23, Linux, MacOS, x86-64, ARM64, gcc and clang. Apache2

## Operational Role

For a systems engineer, PhotonLibOS belongs in the C++23 inventory as part of compiler selection,
...
- `awesome_list-8090a773fef039` from `awesome_list` as `registry_expansion`
