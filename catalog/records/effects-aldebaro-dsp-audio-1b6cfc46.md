...
<!-- canonical: https://github.com/aldebaro/dsp-audio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aldebaro/dsp-audio](https://github.com/aldebaro/dsp-audio) |
| Source record ids | github_search_effects-d02ad70093944b |
...
For a systems engineer, aldebaro/dsp-audio belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-01T19:20:23Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d02ad70093944b` from `github_search_effects` as `registry_expansion`
