...
<!-- canonical: https://www.npmjs.com/package/@types/server-destroy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@types/server-destroy](https://www.npmjs.com/package/@types/server-destroy) |
| Source record ids | npm_registry-6c75b974d6be9a |
...
For a systems engineer, @types/server-destroy belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2024-08-23T18:09:34.042Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-6c75b974d6be9a` from `npm_registry` as `registry_expansion`
