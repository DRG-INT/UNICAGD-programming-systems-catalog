...
<!-- canonical: https://github.com/qdrant/qdrant-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qdrant/qdrant-client](https://github.com/qdrant/qdrant-client) |
| Source record ids | github_search_databases-7bdbb82046532e |
...
For a systems engineer, qdrant/qdrant-client belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:20:12Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7bdbb82046532e` from `github_search_databases` as `registry_expansion`
