...
| Source type | precommit_ci_quality |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-9709bd9ac8d7fb |

## System Engineer Summary

PkgTemplates.jl is tracked as a precommit ci quality record in the Julia branch. The source did not
...
For a systems engineer, PkgTemplates.jl belongs in the Julia inventory as part of ecosystem
...
- `corpus-9709bd9ac8d7fb` from `master_json` as `precommit_ci_quality`
