...
<!-- canonical: https://luarocks.org/modules/dsisco11/dwarfspec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dsisco11/dwarfspec](https://luarocks.org/modules/dsisco11/dwarfspec) |
| Source record ids | luarocks_root_manifest-b03e5f03bcde13 |

## System Engineer Summary

In-process Busted automation for live DFHack interfaces.

## Operational Role

For a systems engineer, dwarfspec belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b03e5f03bcde13` from `luarocks_root_manifest` as `registry_expansion`
