...
| Source record ids | master-5567a8ee2b21 |

## System Engineer Summary

LLDB is tracked as a debugger record in the C99 branch. The source did not provide a long
...
For a systems engineer, LLDB belongs in the C99 inventory as part of fault isolation, live
...
- `master-5567a8ee2b21` from `master_json` as `debugger`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| GDB | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-gdb-bd75a62d.md) |
