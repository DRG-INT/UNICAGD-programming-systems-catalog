...
| Source record ids | lua-source-32 |

## System Engineer Summary

Humanize is tracked as an other record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Humanize belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 32}}` |
...
- `lua-source-32` from `master_json` as `source_list_item`
