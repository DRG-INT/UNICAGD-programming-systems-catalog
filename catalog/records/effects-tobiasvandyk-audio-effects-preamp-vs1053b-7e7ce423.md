...
<!-- canonical: https://github.com/TobiasVanDyk/Audio-Effects-Preamp-VS1053b -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TobiasVanDyk/Audio-Effects-Preamp-VS1053b](https://github.com/TobiasVanDyk/Audio-Effects-Preamp-VS1053b) |
| Source record ids | github_search_effects-ca7ab883d9c3c1 |

## System Engineer Summary

2017: Audio Effects VS1053 Preamp: Music effects box using the VLSI VS1053 Audio DSP with 5
adjustable effects parameters. It has 9 fixed effects and 1 customizable effect, where each effect
has five effects settings namely delay, decay-repeat, modulation speed and depth, and the mix-ratio
of the processed and direct audio. It includes adjustments for bass and treble boost, bass and
treble centre frequency, a selection of six input gain values, an option for saving or retrieving
the current/saved parameters to/from the Arduino Eeprom, and a basic/normal/advanced/edit menu
option that determines the number of functions that are cycled through

## Operational Role

For a systems engineer, TobiasVanDyk/Audio-Effects-Preamp-VS1053b belongs in the Effects inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-30T18:52:30Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ca7ab883d9c3c1` from `github_search_effects` as `registry_expansion`
...
| Southpaw-TACTIC/TACTIC | Configuration | [open](effects-southpaw-tactic-tactic-047258a6.md) |
