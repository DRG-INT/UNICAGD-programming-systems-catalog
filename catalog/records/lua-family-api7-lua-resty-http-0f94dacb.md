...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-resty-http](https://luarocks.org/modules/membphis/api7-lua-resty-http) |
| Source record ids | luarocks_root_manifest-126ed72c97d3a2 |
...
For a systems engineer, api7-lua-resty-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-126ed72c97d3a2` from `luarocks_root_manifest` as `registry_expansion`
