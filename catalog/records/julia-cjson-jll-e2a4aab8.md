...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/C/cJSON_jll](https://github.com/JuliaRegistries/General/tree/master/jll/C/cJSON_jll) |
| Source record ids | julia_general-83ceb1457cb553 |

## System Engineer Summary

Julia package registered in General at jll/C/cJSON_jll.

## Operational Role

For a systems engineer, cJSON_jll belongs in the Julia inventory as part of wire formats,
...
| Name | Category | Page |
| --- | --- | --- |
| BSON.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bson-jl-d161907c.md) |
| ChunkedJSONL | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chunkedjsonl-79682669.md) |
| CSV.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-csv-jl-0c4a8fd3.md) |
| JLD2.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-jld2-jl-d75482ee.md) |
| JSON.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-json-jl-c8a2d8c2.md) |
| JSON3.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-json3-jl-f23d0c8c.md) |
| TOML | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-toml-088a8dac.md) |
| YAML.jl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-yaml-jl-0cf91ada.md) |
