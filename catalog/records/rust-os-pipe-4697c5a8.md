...
<!-- canonical: https://crates.io/crates/os_pipe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/os_pipe](https://crates.io/crates/os_pipe) |
| Source record ids | crates_io-65ac51d41fc413 |
...
For a systems engineer, os_pipe belongs in the Rust inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2025-10-11T19:15:04.313994Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-65ac51d41fc413` from `crates_io` as `registry_expansion`
