...
<!-- canonical: https://github.com/jatinchowdhury18/CrossroadsEffects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jatinchowdhury18/CrossroadsEffects](https://github.com/jatinchowdhury18/CrossroadsEffects) |
| Source record ids | github_search_effects-eaac23f1b891b4 |

## System Engineer Summary

At the crossroads of programming your own audio effects, and letting your audio effects be
programmed for you.

## Operational Role

For a systems engineer, jatinchowdhury18/CrossroadsEffects belongs in the Effects inventory as part
...
| Evidence | MIT License; https://api.github.com/licenses/mit; ISC License; https://api.github.com/licenses/isc; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- `github_search_effects-eaac23f1b891b4` from `github_search_effects` as `registry_expansion`
