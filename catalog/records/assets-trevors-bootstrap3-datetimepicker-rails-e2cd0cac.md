...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TrevorS/bootstrap3-datetimepicker-rails -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TrevorS/bootstrap3-datetimepicker-rails](https://github.com/TrevorS/bootstrap3-datetimepicker-rails) |
| Source record ids | github_search_assets-d89a19e3a0b9af |
...
For a systems engineer, TrevorS/bootstrap3-datetimepicker-rails belongs in the Assets inventory as
part of dependency acquisition, lockfile policy, provenance control, and supply-chain monitoring.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-06-28T22:53:16Z | gh search repos topic:asset-pipeline stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:asset-pipeline stars:>50", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_assets-d89a19e3a0b9af` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AhmadHassan-BTed/EQAI | Package Manager | [open](assets-ahmadhassan-bted-eqai-ab6e6928.md) |
| assimp/assimp | Package Manager | [open](assets-assimp-assimp-d6a268c7.md) |
| bodrovis/jquery-slick-rails | Package Manager | [open](assets-bodrovis-jquery-slick-rails-19f66f84.md) |
| dbackowski/socket.io-rails | Package Manager | [open](assets-dbackowski-socket-io-rails-b6f71348.md) |
| envygeeks/jekyll-assets | Package Manager | [open](assets-envygeeks-jekyll-assets-ba6d3cdb.md) |
| fontsource/fontsource | Package Manager | [open](assets-fontsource-fontsource-6b3b00ba.md) |
| fxpio/composer-asset-plugin | Package Manager | [open](assets-fxpio-composer-asset-plugin-635834f8.md) |
| HurtzDonutStudios/ai-forge-mcp | Package Manager | [open](assets-hurtzdonutstudios-ai-forge-mcp-7ad47a86.md) |
