...
<!-- canonical: https://github.com/DouglasdeMoura/chroncal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DouglasdeMoura/chroncal](https://github.com/DouglasdeMoura/chroncal) |
| Source record ids | github_search_magazines-c4aae8858da252 |

## System Engineer Summary

Terminal-first calendar, todo, and journal manager with iCalendar (RFC 5545) support and CalDAV sync
— CLI + TUI, local SQLite storage

## Operational Role

For a systems engineer, DouglasdeMoura/chroncal belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T14:45:42Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-c4aae8858da252` from `github_search_magazines` as `registry_expansion`
...
| roniel-rhack/rondo | Cli | [open](magazines-roniel-rhack-rondo-5488e0be.md) |
