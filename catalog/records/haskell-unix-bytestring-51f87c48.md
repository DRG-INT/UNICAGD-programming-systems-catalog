...
<!-- canonical: https://hackage.haskell.org/package/unix-bytestring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/unix-bytestring](https://hackage.haskell.org/package/unix-bytestring) |
| Source record ids | hackage_top_downloads-fce357b3f65b4a |
...
For a systems engineer, unix-bytestring belongs in the Haskell inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0.4 | 2026-02-27T00:53:34Z | [https://hackage.haskell.org/package/unix-bytestring](https://hackage.haskell.org/package/unix-bytestring) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/unix-bytestring` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-fce357b3f65b4a` from `hackage_top_downloads` as `registry_expansion`
