...
<!-- canonical: https://cran.r-project.org/web/packages/mfrmr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mfrmr/index.html](https://cran.r-project.org/web/packages/mfrmr/index.html) |
| Source record ids | cran_packages_by_date-3c21ca436ce719 |

## System Engineer Summary

Estimation and Diagnostics for Many-Facet Measurement Models

## Operational Role

For a systems engineer, mfrmr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3.1 | 2026-08-25 12:40:02 UTC | [https://cran.r-project.org/web/packages/mfrmr/DESCRIPTION](https://cran.r-project.org/web/packages/mfrmr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mfrmr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3c21ca436ce719` from `cran_packages_by_date` as `registry_expansion`
