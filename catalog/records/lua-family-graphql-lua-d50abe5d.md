...
<!-- canonical: https://github.com/bjornbytes/graphql-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bjornbytes/graphql-lua](https://github.com/bjornbytes/graphql-lua) |
| Source record ids | lua-source-341 |

## System Engineer Summary

graphql-lua is tracked as an undefined behavior analyzer record in the Lua family branch. The source
...
For a systems engineer, graphql-lua belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 341}}` |
...
- `lua-source-341` from `master_json` as `source_list_item`
