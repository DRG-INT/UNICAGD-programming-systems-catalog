...
| Canonical URL | [https://crates.io/crates/defmt-macros](https://crates.io/crates/defmt-macros) |
| Source record ids | crates_io-38a5f1bc5ff89f |

## System Engineer Summary

defmt-macros is tracked as a filesystem os record in the Rust branch. The source did not provide a
...
For a systems engineer, defmt-macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-07-03T14:14:21.833924Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-38a5f1bc5ff89f` from `crates_io` as `registry_expansion`
