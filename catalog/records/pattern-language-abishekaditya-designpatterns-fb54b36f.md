...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/abishekaditya/DesignPatterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abishekaditya/DesignPatterns](https://github.com/abishekaditya/DesignPatterns) |
| Source record ids | github_search_pattern_language-5d274fdd0d7d7a |
...
For a systems engineer, abishekaditya/DesignPatterns belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-17T04:31:02Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-5d274fdd0d7d7a` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Devinterview-io/api-design-interview-questions | Api Abi Checker | [open](pattern-language-devinterview-io-api-design-interview-questions-02371ded.md) |
