...
<!-- canonical: https://github.com/cap-java/cds-ai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cap-java/cds-ai](https://github.com/cap-java/cds-ai) |
| Source record ids | github_search_sapjava-bdc9643096a7bd |

## System Engineer Summary

A CDS Java plugin that provides out-of-the box AI features, like recommendations in value helps
leveraging SAP-RPT-1. The corresponding Node plugin is @cap-js/ai.

## Operational Role

For a systems engineer, cap-java/cds-ai belongs in the SAPJava inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2-alpha | 2026-08-27T14:27:56Z | [https://api.github.com/repos/cap-java/cds-ai/releases/latest](https://api.github.com/repos/cap-java/cds-ai/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cap-java/cds-ai/releases/latest` at `2026-09-01T10:25:33+00:00`.
...
- `github_search_sapjava-bdc9643096a7bd` from `github_search_sapjava` as `registry_expansion`
