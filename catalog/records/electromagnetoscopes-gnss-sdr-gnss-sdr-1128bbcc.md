...
| Source record ids | github_search_electromagnetoscopes-e4f4fe15a38e4a |
...
For a systems engineer, gnss-sdr/gnss-sdr belongs in the Electromagnetoscopes inventory as part of
...
- Latest stable metadata was observed from `https://api.github.com/repos/gnss-sdr/gnss-sdr/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-e4f4fe15a38e4a` from `github_search_electromagnetoscopes` as `registry_expansion`
