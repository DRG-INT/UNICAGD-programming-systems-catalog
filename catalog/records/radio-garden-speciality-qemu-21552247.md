...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Radio Garden Speciality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/radio-garden-speciality.md) · [Category: Interpreter Runtime](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interpreter-runtime.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.qemu.org/](https://www.qemu.org/) |
| Source record ids | curated_language_routes-034f62cc8b833c |

## System Engineer Summary

Open machine emulator and virtualizer route for Android-x86 or other guest-based compatibility
experiments across host operating systems.

## Operational Role

For a systems engineer, QEMU belongs in the Radio Garden Speciality inventory as part of runtime
...
- `curated_language_routes-034f62cc8b833c` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Android-x86 | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-android-x86-f6b766d5.md) |
