...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CCOpt](https://github.com/JuliaRegistries/General/tree/master/C/CCOpt) |
| Source record ids | julia_general-b34549cdd5231d |

## System Engineer Summary

Julia package registered in General at C/CCOpt.

## Operational Role

For a systems engineer, CCOpt belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CCOpt", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b34549cdd5231d` from `julia_general` as `registry_expansion`
