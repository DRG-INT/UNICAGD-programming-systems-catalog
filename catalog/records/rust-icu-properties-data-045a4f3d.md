...
<!-- canonical: https://crates.io/crates/icu_properties_data -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-13T23:28:42.576523Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-07T18:22:54+00:00`.
...
- `crates_io-0a34c2d02f94fa` from `crates_io` as `registry_expansion`
