...
<!-- canonical: https://crates.io/crates/event-listener-strategy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/event-listener-strategy](https://crates.io/crates/event-listener-strategy) |
| Source record ids | crates_io-fb9a502d306bcb |
...
For a systems engineer, event-listener-strategy belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4 | 2025-03-27T17:31:33.741698Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-fb9a502d306bcb` from `crates_io` as `registry_expansion`
