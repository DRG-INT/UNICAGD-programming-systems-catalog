...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/composite-ekg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/composite-ekg](https://hackage.haskell.org/package/composite-ekg) |
| Source record ids | hackage_top_downloads-fcd56e1f7e07ed |

## System Engineer Summary

Hackage package with 78 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, composite-ekg belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2.2 | 2023-12-04T19:08:33Z | [https://hackage.haskell.org/package/composite-ekg](https://hackage.haskell.org/package/composite-ekg) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/composite-ekg` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-fcd56e1f7e07ed` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amazonka-autoscaling | Filesystem Os | [open](haskell-amazonka-autoscaling-8ee47bc5.md) |
| bishbosh | Filesystem Os | [open](haskell-bishbosh-88e04dd9.md) |
| blockfrost-api | Filesystem Os | [open](haskell-blockfrost-api-f40eb4a6.md) |
| cabal-macosx | Filesystem Os | [open](haskell-cabal-macosx-c2f02600.md) |
| chronos | Filesystem Os | [open](haskell-chronos-1ff53297.md) |
| composite-aeson | Filesystem Os | [open](haskell-composite-aeson-29a8e7c4.md) |
| composite-aeson-refined | Filesystem Os | [open](haskell-composite-aeson-refined-8d6d30dd.md) |
| composite-base | Filesystem Os | [open](haskell-composite-base-bea0530d.md) |
