...
<!-- canonical: https://github.com/priyankark/SensorStreamServer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/priyankark/SensorStreamServer](https://github.com/priyankark/SensorStreamServer) |
| Source record ids | github_search_electromagnetoscopes-9188047344b7a7 |

## System Engineer Summary

Companion servers for Sensor Stream App. Stream sensor data, audio and images from your phone to an
open source server running on your PC/Raspberry Pi in real-time over your local network.

## Operational Role

For a systems engineer, priyankark/SensorStreamServer belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T06:51:03Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_electromagnetoscopes-9188047344b7a7` from `github_search_electromagnetoscopes` as `registry_expansion`
