...
<!-- canonical: https://luarocks.org/modules/streetturtle/cpu-widget -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/streetturtle/cpu-widget](https://luarocks.org/modules/streetturtle/cpu-widget) |
| Source record ids | luarocks_root_manifest-776591723f5ebc |
...
For a systems engineer, cpu-widget belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-776591723f5ebc` from `luarocks_root_manifest` as `registry_expansion`
...
| awesome-viewport | Community Reference | [open](lua-family-awesome-viewport-a31dbf7b.md) |
