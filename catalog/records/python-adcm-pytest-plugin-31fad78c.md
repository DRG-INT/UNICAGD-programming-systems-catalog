...
<!-- canonical: https://pypi.org/project/adcm-pytest-plugin/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adcm-pytest-plugin/](https://pypi.org/project/adcm-pytest-plugin/) |
| Source record ids | pypi_simple-bacd468abcfbf8 |

## System Engineer Summary

The pytest plugin including a set of common tools for ADCM testing

## Operational Role

For a systems engineer, adcm-pytest-plugin belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.24.0 | 2023-01-16T05:16:23.072087Z | [https://pypi.org/pypi/adcm-pytest-plugin/json](https://pypi.org/pypi/adcm-pytest-plugin/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adcm-pytest-plugin/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-bacd468abcfbf8` from `pypi_simple` as `registry_expansion`
