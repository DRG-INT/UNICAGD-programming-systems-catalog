...
<!-- canonical: https://cran.r-project.org/web/packages/EDAForge/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EDAForge/index.html](https://cran.r-project.org/web/packages/EDAForge/index.html) |
| Source record ids | cran_packages_by_date-0214c7593a7013 |
...
For a systems engineer, EDAForge belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-08 11:30:20 UTC | [https://cran.r-project.org/web/packages/EDAForge/DESCRIPTION](https://cran.r-project.org/web/packages/EDAForge/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EDAForge/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0214c7593a7013` from `cran_packages_by_date` as `registry_expansion`
