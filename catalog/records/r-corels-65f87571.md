...
<!-- canonical: https://cran.r-project.org/web/packages/corels/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/corels/index.html](https://cran.r-project.org/web/packages/corels/index.html) |
| Source record ids | cran_packages_by_date-8ae314403b39bf |
...
For a systems engineer, corels belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-08-28 11:30:02 UTC | [https://cran.r-project.org/web/packages/corels/DESCRIPTION](https://cran.r-project.org/web/packages/corels/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/corels/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8ae314403b39bf` from `cran_packages_by_date` as `registry_expansion`
