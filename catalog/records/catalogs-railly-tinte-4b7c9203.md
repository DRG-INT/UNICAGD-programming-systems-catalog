...
<!-- canonical: https://github.com/Railly/tinte -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Railly/tinte](https://github.com/Railly/tinte) |
| Source record ids | github_search_catalogs-9964c4ffcb3847 |

## System Engineer Summary

Compile your design system into an Agent Plugin. Extract an identity from any reference, emit
SKILL.md + tokens.css, lint what bypasses your tokens.

## Operational Role

For a systems engineer, Railly/tinte belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-08T01:10:38Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-9964c4ffcb3847` from `github_search_catalogs` as `registry_expansion`
