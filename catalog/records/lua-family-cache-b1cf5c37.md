...
<!-- canonical: https://luarocks.org/modules/mah0x211/cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/cache](https://luarocks.org/modules/mah0x211/cache) |
| Source record ids | luarocks_root_manifest-77827118267fd0 |
...
For a systems engineer, cache belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-77827118267fd0` from `luarocks_root_manifest` as `registry_expansion`
