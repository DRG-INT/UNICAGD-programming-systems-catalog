...
<!-- canonical: https://github.com/tywalch/electrodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tywalch/electrodb](https://github.com/tywalch/electrodb) |
| Source record ids | github_search_databases-fa0ca90249e355 |

## System Engineer Summary

A DynamoDB library to ease the use of modeling complex hierarchical relationships and implementing a
Single Table Design while keeping your query code readable.

## Operational Role

For a systems engineer, tywalch/electrodb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T18:47:47Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fa0ca90249e355` from `github_search_databases` as `registry_expansion`
