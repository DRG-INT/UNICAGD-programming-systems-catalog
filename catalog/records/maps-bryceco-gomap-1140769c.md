...
<!-- canonical: https://github.com/bryceco/GoMap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bryceco/GoMap](https://github.com/bryceco/GoMap) |
| Source record ids | github_search_maps-55d620bdbc0505 |
...
For a systems engineer, bryceco/GoMap belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T18:25:24Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-55d620bdbc0505` from `github_search_maps` as `registry_expansion`
