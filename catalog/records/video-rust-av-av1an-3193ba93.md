...
<!-- canonical: https://github.com/rust-av/Av1an -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rust-av/Av1an](https://github.com/rust-av/Av1an) |
| Source record ids | github_search_video-ff8ef4dbf414b5 |

## System Engineer Summary

Cross-platform command-line AV1 / VP9 / HEVC / H264 encoding framework with per scene quality
encoding

## Operational Role

For a systems engineer, rust-av/Av1an belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T10:04:03Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ff8ef4dbf414b5` from `github_search_video` as `registry_expansion`
