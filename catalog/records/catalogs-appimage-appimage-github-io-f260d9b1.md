...
<!-- canonical: https://github.com/AppImage/appimage.github.io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AppImage/appimage.github.io](https://github.com/AppImage/appimage.github.io) |
| Source record ids | github_search_catalogs-84672ea37b0f82 |

## System Engineer Summary

Given an URL to an AppImage, the GitHub action in this project inspects the AppImage and puts it
into a community-maintained catalog

## Operational Role

For a systems engineer, AppImage/appimage.github.io belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T13:05:20Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-84672ea37b0f82` from `github_search_catalogs` as `registry_expansion`
