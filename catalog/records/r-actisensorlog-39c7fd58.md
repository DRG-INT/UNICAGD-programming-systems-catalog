...
<!-- canonical: https://cran.r-project.org/web/packages/actisensorlog/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/actisensorlog/index.html](https://cran.r-project.org/web/packages/actisensorlog/index.html) |
| Source record ids | cran_packages_by_date-2bf414c0e52475 |

## System Engineer Summary

Summarize 'SensorLog'/'SensorLogger' Activity Data

## Operational Role

For a systems engineer, actisensorlog belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-12 13:10:16 UTC | [https://cran.r-project.org/web/packages/actisensorlog/DESCRIPTION](https://cran.r-project.org/web/packages/actisensorlog/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/actisensorlog/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-2bf414c0e52475` from `cran_packages_by_date` as `registry_expansion`
