...
<!-- canonical: https://luarocks.org/modules/willem-j-an/adopure.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/willem-j-an/adopure.nvim](https://luarocks.org/modules/willem-j-an/adopure.nvim) |
| Source record ids | luarocks_root_manifest-0e7e7a68380288 |
...
For a systems engineer, adopure.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0e7e7a68380288` from `luarocks_root_manifest` as `registry_expansion`
