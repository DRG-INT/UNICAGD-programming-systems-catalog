...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Hubs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/hubs.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Hubs |
| Category | Registry Repository |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/explore](https://github.com/explore) |
| Source record ids | curated_language_routes-f52545eaef37bb |

## System Engineer Summary

Developer hub for repository discovery, topics, trending projects, organizations, releases,
packages, and open-source collaboration.

## Operational Role

For a systems engineer, GitHub Explore belongs in the Hubs inventory as part of ecosystem capability
...
- `curated_language_routes-f52545eaef37bb` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Artifact Hub | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-artifact-hub-40ccd1ca.md) |
| Backstage Developer Portal | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-backstage-developer-portal-2ea466b9.md) |
| crates.io | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-crates-io-28f2d38a.md) |
| DataHub | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-datahub-d9ca810a.md) |
| Docker Hub | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-docker-hub-f7df278c.md) |
| GitLab Explore | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-gitlab-explore-30d7c1a0.md) |
| Hugging Face Hub | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-hugging-face-hub-6f272e3e.md) |
| Maven Central | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/hubs-maven-central-0f38a675.md) |
