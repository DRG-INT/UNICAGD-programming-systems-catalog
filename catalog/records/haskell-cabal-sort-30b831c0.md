...
<!-- canonical: https://hackage.haskell.org/package/cabal-sort -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-sort](https://hackage.haskell.org/package/cabal-sort) |
| Source record ids | hackage_top_downloads-da457f1e617c45 |
...
For a systems engineer, cabal-sort belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2.3 | 2026-06-14T17:13:26Z | [https://hackage.haskell.org/package/cabal-sort](https://hackage.haskell.org/package/cabal-sort) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-sort` at `2026-09-09T00:34:54+00:00`.
...
- `hackage_top_downloads-da457f1e617c45` from `hackage_top_downloads` as `registry_expansion`
