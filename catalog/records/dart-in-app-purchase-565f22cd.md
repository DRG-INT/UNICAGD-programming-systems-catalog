...
<!-- canonical: https://pub.dev/packages/in_app_purchase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/in_app_purchase](https://pub.dev/packages/in_app_purchase) |
| Source record ids | pub_dev-113444e7d2c687 |

## System Engineer Summary

A Flutter plugin for in-app purchases. Exposes APIs for making in-app purchases through the App
Store and Google Play.

## Operational Role

For a systems engineer, in_app_purchase belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2026-06-03T17:38:36.573147Z | [https://pub.dev/api/packages/in_app_purchase](https://pub.dev/api/packages/in_app_purchase) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/in_app_purchase` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-113444e7d2c687` from `pub_dev` as `registry_expansion`
