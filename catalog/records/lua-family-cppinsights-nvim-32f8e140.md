...
<!-- canonical: https://luarocks.org/modules/freed-wu/cppinsights.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/cppinsights.nvim](https://luarocks.org/modules/freed-wu/cppinsights.nvim) |
| Source record ids | luarocks_root_manifest-fe2c76e2f36b1d |
...
For a systems engineer, cppinsights.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-fe2c76e2f36b1d` from `luarocks_root_manifest` as `registry_expansion`
