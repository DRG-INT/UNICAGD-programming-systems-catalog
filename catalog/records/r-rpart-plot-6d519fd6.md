...
<!-- canonical: https://cran.r-project.org/web/packages/rpart.plot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rpart.plot/index.html](https://cran.r-project.org/web/packages/rpart.plot/index.html) |
| Source record ids | cran_packages_by_date-8ae0de8e600ffd |
...
For a systems engineer, rpart.plot belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.5 | 2026-08-21 11:50:02 UTC | [https://cran.r-project.org/web/packages/rpart.plot/DESCRIPTION](https://cran.r-project.org/web/packages/rpart.plot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rpart.plot/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8ae0de8e600ffd` from `cran_packages_by_date` as `registry_expansion`
