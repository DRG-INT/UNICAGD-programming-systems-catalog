...
<!-- canonical: https://cran.r-project.org/web/packages/modMStates/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modMStates/index.html](https://cran.r-project.org/web/packages/modMStates/index.html) |
| Source record ids | cran_packages_by_date-cfe2ecc92b484a |

## System Engineer Summary

Simulation and Estimation of Continuous-Time Multi-State Markov Models for Panel Data

## Operational Role

For a systems engineer, modMStates belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-09-03 11:50:13 UTC | [https://cran.r-project.org/web/packages/modMStates/DESCRIPTION](https://cran.r-project.org/web/packages/modMStates/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modMStates/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-cfe2ecc92b484a` from `cran_packages_by_date` as `registry_expansion`
