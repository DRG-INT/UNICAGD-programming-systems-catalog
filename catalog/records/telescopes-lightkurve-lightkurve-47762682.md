...
| Source record ids | github_search_telescopes-8dba8c412e215b |
...
For a systems engineer, lightkurve/lightkurve belongs in the Telescopes inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.6.0 | 2026-04-16T18:20:04Z | [https://api.github.com/repos/lightkurve/lightkurve/releases/latest](https://api.github.com/repos/lightkurve/lightkurve/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lightkurve/lightkurve/releases/latest` at `2026-09-01T08:26:24+00:00`.
...
- `github_search_telescopes-8dba8c412e215b` from `github_search_telescopes` as `registry_expansion`
