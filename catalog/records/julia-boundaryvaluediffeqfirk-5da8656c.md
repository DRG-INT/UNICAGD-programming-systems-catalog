...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundaryValueDiffEqFIRK](https://github.com/JuliaRegistries/General/tree/master/B/BoundaryValueDiffEqFIRK) |
| Source record ids | julia_general-ac43258f8d4f7b |

## System Engineer Summary

Julia package registered in General at B/BoundaryValueDiffEqFIRK.

## Operational Role

For a systems engineer, BoundaryValueDiffEqFIRK belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundaryValueDiffEqFIRK", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ac43258f8d4f7b` from `julia_general` as `registry_expansion`
