...
<!-- canonical: https://github.com/timsainb/Tensorflow-MultiGPU-VAE-GAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/timsainb/Tensorflow-MultiGPU-VAE-GAN](https://github.com/timsainb/Tensorflow-MultiGPU-VAE-GAN) |
| Source record ids | github_search_space_maps-8f5ce8cb151665 |

## System Engineer Summary

A single jupyter notebook multi gpu VAE-GAN example with latent space algebra and receptive field
visualizations.

## Operational Role

For a systems engineer, timsainb/Tensorflow-MultiGPU-VAE-GAN belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-14T19:56:07Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8f5ce8cb151665` from `github_search_space_maps` as `registry_expansion`
