...
<!-- canonical: https://pypi.org/project/abb-robot-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abb-robot-client/](https://pypi.org/project/abb-robot-client/) |
| Source record ids | pypi_simple-6bff7c075d2a71 |

## System Engineer Summary

Python client library to access ABB robots using RWS and EGM

## Operational Role

For a systems engineer, abb-robot-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2024-07-12T19:38:48.146217Z | [https://pypi.org/pypi/abb-robot-client/json](https://pypi.org/pypi/abb-robot-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abb-robot-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-6bff7c075d2a71` from `pypi_simple` as `registry_expansion`
