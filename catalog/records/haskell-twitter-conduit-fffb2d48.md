...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/twitter-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/twitter-conduit](https://hackage.haskell.org/package/twitter-conduit) |
| Source record ids | hackage_top_downloads-adfddf3ef129d5 |

## System Engineer Summary

Hackage package with 67 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, twitter-conduit belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2021-11-27T17:36:55Z | [https://hackage.haskell.org/package/twitter-conduit](https://hackage.haskell.org/package/twitter-conduit) |  |
| candidate | partial | 0.2.2.2 |  | [https://hackage.haskell.org/package/twitter-conduit](https://hackage.haskell.org/package/twitter-conduit) | hackage_candidate_date_missing |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/twitter-conduit` at `2026-09-01T14:24:35+00:00`.
...
| --- | --- | --- | --- |
| hackage_top_downloads | registry-derived | 2026-09-15 | `{"kind": "hackage_top_downloads", "retrieved": "2026-09-15", "status": "registry-derived"}` |
...
- `hackage_top_downloads-adfddf3ef129d5` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| atom-conduit | Visualization Gui | [open](haskell-atom-conduit-26d17084.md) |
| bzlib-conduit | Visualization Gui | [open](haskell-bzlib-conduit-07300eee.md) |
| cassava-conduit | Visualization Gui | [open](haskell-cassava-conduit-f40936a8.md) |
| Chart | Visualization Gui | [open](haskell-chart-8b1ed270.md) |
| Chart-diagrams | Visualization Gui | [open](haskell-chart-diagrams-11ca5490.md) |
| chart-svg | Visualization Gui | [open](haskell-chart-svg-b8a3b184.md) |
| classy-prelude-conduit | Visualization Gui | [open](haskell-classy-prelude-conduit-4b67512e.md) |
| conduit | Visualization Gui | [open](haskell-conduit-fe86e77f.md) |
