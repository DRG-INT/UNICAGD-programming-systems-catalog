...
<!-- canonical: https://pub.dev/packages/sanitize_html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sanitize_html](https://pub.dev/packages/sanitize_html) |
| Source record ids | pub_dev-afdd6bd4278400 |

## System Engineer Summary

Function for sanitizing HTML to prevent XSS by restrict elements and attributes to a safe subset of
allowed values.

## Operational Role

For a systems engineer, sanitize_html belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-07-07T07:22:53.369966Z | [https://pub.dev/api/packages/sanitize_html](https://pub.dev/api/packages/sanitize_html) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sanitize_html` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-afdd6bd4278400` from `pub_dev` as `registry_expansion`
