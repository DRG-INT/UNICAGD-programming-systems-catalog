...
<!-- canonical: https://github.com/vinniefalco/LuaBridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vinniefalco/LuaBridge](https://github.com/vinniefalco/LuaBridge) |
| Source record ids | lua-source-70 |
...
For a systems engineer, LuaBridge belongs in the Lua family inventory as part of runtime behavior,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 70}}` |
...
- `lua-source-70` from `master_json` as `source_list_item`
