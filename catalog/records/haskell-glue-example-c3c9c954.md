...
<!-- canonical: https://hackage.haskell.org/package/glue-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/glue-example](https://hackage.haskell.org/package/glue-example) |
| Source record ids | hackage_top_downloads-90b9ece88c2269 |
...
For a systems engineer, glue-example belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2019-03-17T22:48:05Z | [https://hackage.haskell.org/package/glue-example](https://hackage.haskell.org/package/glue-example) |  |
| candidate | partial | 0.6 |  | [https://hackage.haskell.org/package/glue-example](https://hackage.haskell.org/package/glue-example) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/glue-example` at `2026-09-09T00:35:00+00:00`.
...
- `hackage_top_downloads-90b9ece88c2269` from `hackage_top_downloads` as `registry_expansion`
