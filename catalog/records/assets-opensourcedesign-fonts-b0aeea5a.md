...
<!-- canonical: https://github.com/opensourcedesign/fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opensourcedesign/fonts](https://github.com/opensourcedesign/fonts) |
| Source record ids | github_search_assets-677a91b42e6d53 |

## System Engineer Summary

Archived since there are many great open source font sites already, see

## Operational Role

For a systems engineer, opensourcedesign/fonts belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-31T04:08:37Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-677a91b42e6d53` from `github_search_assets` as `registry_expansion`
