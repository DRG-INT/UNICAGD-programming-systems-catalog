...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Assertion Mocking](../by-category/assertion-mocking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/FluentAssertions.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/FluentAssertions.Json](https://www.nuget.org/packages/FluentAssertions.Json) |
| Source record ids | nuget_search-1f9d4f627e1a89 |
...
For a systems engineer, FluentAssertions.Json belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2025-01-16T18:44:18.277+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions.json/index.json) |  |
| preview | known | 5.0.0-rc0002 | 2018-01-13T13:38:42.053+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions.json/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Apache-2.0; https://www.nuget.org/packages/FluentAssertions.Json/8.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-1f9d4f627e1a89` from `nuget_search` as `registry_expansion`
