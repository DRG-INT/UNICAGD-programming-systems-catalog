...
<!-- canonical: https://cran.r-project.org/web/packages/orbis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/orbis/index.html](https://cran.r-project.org/web/packages/orbis/index.html) |
| Source record ids | cran_packages_by_date-54a3cd5d9a8da6 |
...
For a systems engineer, orbis belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 07:40:02 UTC | [https://cran.r-project.org/web/packages/orbis/DESCRIPTION](https://cran.r-project.org/web/packages/orbis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/orbis/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-54a3cd5d9a8da6` from `cran_packages_by_date` as `registry_expansion`
