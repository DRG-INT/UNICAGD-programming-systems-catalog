...
| Canonical URL | [https://crates.io/crates/robust](https://crates.io/crates/robust) |
| Source record ids | crates_io-1fc73a7b39d29e |
...
For a systems engineer, robust belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2025-05-10T02:48:15.726894Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-1fc73a7b39d29e` from `crates_io` as `registry_expansion`
