...
| Canonical URL | [https://crates.io/crates/glutin_wgl_sys](https://crates.io/crates/glutin_wgl_sys) |
| Source record ids | crates_io-ab4713e6a36c47 |
...
For a systems engineer, glutin_wgl_sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2025-01-12T09:52:21.238564Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-ab4713e6a36c47` from `crates_io` as `registry_expansion`
