...
<!-- canonical: https://packagist.org/packages/swaggest/json-schema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/swaggest/json-schema](https://packagist.org/packages/swaggest/json-schema) |
| Source record ids | packagist_search-1b4538cabc666d |
...
For a systems engineer, swaggest/json-schema belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-1b4538cabc666d` from `packagist_search` as `registry_expansion`
