...
<!-- canonical: https://github.com/indigo-astronomy/indigo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/indigo-astronomy/indigo](https://github.com/indigo-astronomy/indigo) |
| Source record ids | github_search_space_maps-de376a3a1136b3 |

## System Engineer Summary

INDIGO is a system of standards and frameworks for multiplatform and distributed astronomy software
development designed to scale with your needs.

## Operational Role

For a systems engineer, indigo-astronomy/indigo belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T22:34:02Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-de376a3a1136b3` from `github_search_space_maps` as `registry_expansion`
