...
<!-- canonical: https://cran.r-project.org/web/packages/OneShotEM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OneShotEM/index.html](https://cran.r-project.org/web/packages/OneShotEM/index.html) |
| Source record ids | cran_packages_by_date-4b0c30a747812d |
...
For a systems engineer, OneShotEM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 12:41:11 UTC | [https://cran.r-project.org/web/packages/OneShotEM/DESCRIPTION](https://cran.r-project.org/web/packages/OneShotEM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OneShotEM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4b0c30a747812d` from `cran_packages_by_date` as `registry_expansion`
