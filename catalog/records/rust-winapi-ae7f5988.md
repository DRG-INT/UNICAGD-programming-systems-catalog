...
<!-- canonical: https://crates.io/crates/winapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/winapi](https://crates.io/crates/winapi) |
| Source record ids | crates_io-3f11faa927a423 |
...
For a systems engineer, winapi belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.9 | 2020-06-26T11:34:33.480855Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `crates_io-3f11faa927a423` from `crates_io` as `registry_expansion`
