...
<!-- canonical: https://packagist.org/packages/mtdowling/jmespath.php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mtdowling/jmespath.php](https://packagist.org/packages/mtdowling/jmespath.php) |
| Source record ids | packagist_search-498e8fb3e66b0c |
...
For a systems engineer, mtdowling/jmespath.php belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-498e8fb3e66b0c` from `packagist_search` as `registry_expansion`
