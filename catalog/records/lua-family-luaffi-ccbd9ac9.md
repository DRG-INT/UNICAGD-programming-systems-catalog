...
<!-- canonical: https://github.com/jmckaskill/luaffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jmckaskill/luaffi](https://github.com/jmckaskill/luaffi) |
| Source record ids | lua-source-323 |
...
For a systems engineer, luaffi belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 323}}` |
...
- `lua-source-323` from `master_json` as `source_list_item`
