...
<!-- canonical: https://crates.io/crates/windows-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-sys](https://crates.io/crates/windows-sys) |
| Source record ids | crates_io-e2dd5dc2c50edc |

## System Engineer Summary

windows-sys is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, windows-sys belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.61.2 | 2025-10-06T19:18:30.163595Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-e2dd5dc2c50edc` from `crates_io` as `registry_expansion`
