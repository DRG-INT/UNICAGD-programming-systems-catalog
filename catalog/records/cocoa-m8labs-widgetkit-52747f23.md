...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/m8labs/WidgetKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/m8labs/WidgetKit](https://github.com/m8labs/WidgetKit) |
| Source record ids | github_search_cocoa-0363d00e6be932 |

## System Engineer Summary

Compose native apps without a code using JSON and load them as NSBundle into another app dynamicly
from local or remote locations.

## Operational Role

For a systems engineer, m8labs/WidgetKit belongs in the Cocoa inventory as part of wire formats,
...
- `github_search_cocoa-0363d00e6be932` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 3breadt/dd-plist | Serialization | [open](cocoa-3breadt-dd-plist-2a35e6c5.md) |
| 3lvis/SwiftSync | Serialization | [open](cocoa-3lvis-swiftsync-b91bf583.md) |
| hhfa008/SwiftAI | Serialization | [open](cocoa-hhfa008-swiftai-dadec2ef.md) |
| SwiftyJSON/SwiftyJSON | Serialization | [open](cocoa-swiftyjson-swiftyjson-10f72bb1.md) |
