...
| Source record ids | hackage_recent-241a705140c820 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/copilot-language` at `2026-09-09T14:25:27+00:00`.
...
- `hackage_recent-241a705140c820` from `hackage_recent` as `registry_expansion`
