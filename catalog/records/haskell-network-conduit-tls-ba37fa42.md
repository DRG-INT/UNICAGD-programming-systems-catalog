...
<!-- canonical: https://hackage.haskell.org/package/network-conduit-tls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-conduit-tls](https://hackage.haskell.org/package/network-conduit-tls) |
| Source record ids | hackage_top_downloads-a8363c68063511 |
...
For a systems engineer, network-conduit-tls belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0.1 | 2024-06-30T05:41:06Z | [https://hackage.haskell.org/package/network-conduit-tls](https://hackage.haskell.org/package/network-conduit-tls) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-conduit-tls` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-a8363c68063511` from `hackage_top_downloads` as `registry_expansion`
