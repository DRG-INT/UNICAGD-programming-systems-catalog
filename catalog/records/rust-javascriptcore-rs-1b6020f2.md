...
| Canonical URL | [https://crates.io/crates/javascriptcore-rs](https://crates.io/crates/javascriptcore-rs) |
| Source record ids | crates_io-71e74976ce2f2e |
...
For a systems engineer, javascriptcore-rs belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2023-10-26T05:58:21.107594Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-71e74976ce2f2e` from `crates_io` as `registry_expansion`
