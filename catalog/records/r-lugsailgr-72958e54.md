...
<!-- canonical: https://cran.r-project.org/web/packages/LugsailGR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LugsailGR/index.html](https://cran.r-project.org/web/packages/LugsailGR/index.html) |
| Source record ids | cran_packages_by_date-3adfd1b7361556 |
...
For a systems engineer, LugsailGR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 07:40:09 UTC | [https://cran.r-project.org/web/packages/LugsailGR/DESCRIPTION](https://cran.r-project.org/web/packages/LugsailGR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LugsailGR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3adfd1b7361556` from `cran_packages_by_date` as `registry_expansion`
