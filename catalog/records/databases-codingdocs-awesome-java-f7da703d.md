...
<!-- canonical: https://github.com/CodingDocs/awesome-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodingDocs/awesome-java](https://github.com/CodingDocs/awesome-java) |
| Source record ids | github_search_databases-ea3cdf1a2cdf41 |
...
For a systems engineer, CodingDocs/awesome-java belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-10T08:34:42Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ea3cdf1a2cdf41` from `github_search_databases` as `registry_expansion`
