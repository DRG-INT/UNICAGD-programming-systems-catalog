# WissamAntoun/Circularly-Polarized-Patch-Antenna-HFSS
...
<!-- canonical: https://github.com/WissamAntoun/Circularly-Polarized-Patch-Antenna-HFSS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WissamAntoun/Circularly-Polarized-Patch-Antenna-HFSS](https://github.com/WissamAntoun/Circularly-Polarized-Patch-Antenna-HFSS) |
| Source record ids | github_search_electromagnetoscopes-82c600dad94c34 |

## System Engineer Summary

A microstrip patch antenna with circularly polarized matched to 50 Ω and operating at 2.4 GHz.
SImulation done on HFSS

## Operational Role

For a systems engineer, WissamAntoun/Circularly-Polarized-Patch-Antenna-HFSS belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-16T22:56:09Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-82c600dad94c34` from `github_search_electromagnetoscopes` as `registry_expansion`
