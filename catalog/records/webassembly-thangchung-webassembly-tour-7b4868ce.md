...
<!-- canonical: https://github.com/thangchung/webassembly-tour -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thangchung/webassembly-tour](https://github.com/thangchung/webassembly-tour) |
| Source record ids | github_search_webassembly-da6d25ed34cef7 |

## System Engineer Summary

⚙️ Take you through a tour of WebAssembly (WASM targets on WASI) with wasmCloud, Krustlet, WAGI,
etc. 🌟 Give it a star if you like it.

## Operational Role

For a systems engineer, thangchung/webassembly-tour belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-06-12T08:54:22Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-da6d25ed34cef7` from `github_search_webassembly` as `registry_expansion`
