...
<!-- canonical: https://github.com/apurvrdx1/tagore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apurvrdx1/tagore](https://github.com/apurvrdx1/tagore) |
| Source record ids | github_search_repertoare_catalogs-49776647c99e55 |

## System Engineer Summary

Make AI-generated prose sound human. 29-pattern catalog + 8-rule operating system + 8-dimension
scoring rubric. Works with Claude Code, OpenCode, Copilot CLI, Codex, Gemini, Goose and Hermes.

## Operational Role

For a systems engineer, apurvrdx1/tagore belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T13:17:46Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-49776647c99e55` from `github_search_repertoare_catalogs` as `registry_expansion`
