...
<!-- canonical: https://github.com/javierbyte/emoji-to-scale -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/javierbyte/emoji-to-scale](https://github.com/javierbyte/emoji-to-scale) |
| Source record ids | github_search_icons_and_logos-3d8eeb0757becc |
...
For a systems engineer, javierbyte/emoji-to-scale belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T06:31:21Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD_3_clause + file LICENSE; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_icons_and_logos-3d8eeb0757becc` from `github_search_icons_and_logos` as `registry_expansion`
