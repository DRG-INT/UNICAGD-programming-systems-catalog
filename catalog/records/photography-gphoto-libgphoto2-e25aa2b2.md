...
<!-- canonical: https://github.com/gphoto/libgphoto2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gphoto/libgphoto2](https://github.com/gphoto/libgphoto2) |
| Source record ids | github_search_photography-d03f7f8a15b72a |
...
For a systems engineer, gphoto/libgphoto2 belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:46:57Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-d03f7f8a15b72a` from `github_search_photography` as `registry_expansion`
