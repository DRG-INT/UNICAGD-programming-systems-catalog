...
<!-- canonical: https://cran.r-project.org/web/packages/fspls2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fspls2/index.html](https://cran.r-project.org/web/packages/fspls2/index.html) |
| Source record ids | cran_packages_by_date-7b52416f5dfdce |

## System Engineer Summary

A Package to Find Minimal Transcriptional Signatures

## Operational Role

For a systems engineer, fspls2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 12:30:02 UTC | [https://cran.r-project.org/web/packages/fspls2/DESCRIPTION](https://cran.r-project.org/web/packages/fspls2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fspls2/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-7b52416f5dfdce` from `cran_packages_by_date` as `registry_expansion`
