...
<!-- canonical: https://github.com/kossakovsky/selfhost-ai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kossakovsky/selfhost-ai](https://github.com/kossakovsky/selfhost-ai) |
| Source record ids | github_search_databases-c28940d75ddff0 |

## System Engineer Summary

🚀 Self-hosted AI automation platform. Deploy n8n, Ollama, Flowise, RAG, Supabase & 30+ tools with
one command. Auto HTTPS. Free Zapier/Make alternative.

## Operational Role

For a systems engineer, kossakovsky/selfhost-ai belongs in the Databases inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T23:09:19Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c28940d75ddff0` from `github_search_databases` as `registry_expansion`
