...
<!-- canonical: https://hackage.haskell.org/package/intervals -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/intervals](https://hackage.haskell.org/package/intervals) |
| Source record ids | hackage_top_downloads-7ffbbc85fd06fe |
...
For a systems engineer, intervals belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2024-12-04T12:40:51Z | [https://hackage.haskell.org/package/intervals](https://hackage.haskell.org/package/intervals) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/intervals` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-7ffbbc85fd06fe` from `hackage_top_downloads` as `registry_expansion`
