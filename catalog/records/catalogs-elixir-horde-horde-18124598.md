...
<!-- canonical: https://github.com/elixir-horde/horde -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elixir-horde/horde](https://github.com/elixir-horde/horde) |
| Source record ids | github_search_catalogs-a77a7adfe8c5d8 |
...
For a systems engineer, elixir-horde/horde belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T15:48:34Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-a77a7adfe8c5d8` from `github_search_catalogs` as `registry_expansion`
