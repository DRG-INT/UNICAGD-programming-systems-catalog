...
| Canonical URL | [https://packagist.org/packages/colinodell/json5](https://packagist.org/packages/colinodell/json5) |
| Source record ids | packagist_search-29c9cc7170a95c |
...
For a systems engineer, colinodell/json5 belongs in the PHP inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.0 | 2024-02-09T13:06:43+00:00 | [https://repo.packagist.org/p2/colinodell/json5.json](https://repo.packagist.org/p2/colinodell/json5.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/colinodell/json5.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-29c9cc7170a95c` from `packagist_search` as `registry_expansion`
