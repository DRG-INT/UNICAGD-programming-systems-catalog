...
<!-- canonical: https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson) |
| Source record ids | nuget_search-cb46d08503fd1b |

## System Engineer Summary

Implements the SignalR Hub Protocol using Newtonsoft.Json. This package was built from the source
code at

## Operational Role

For a systems engineer, Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson belongs in the C-Sharp
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.11 | 2026-08-11T16:54:44.8+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.signalr.protocols.newtonsoftjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.signalr.protocols.newtonsoftjson/index.json) |  |
| preview | known | 11.0.0-preview.7.26381.103 | 2026-08-11T16:20:23.263+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.signalr.protocols.newtonsoftjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.signalr.protocols.newtonsoftjson/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | SEE LICENSE IN LICENSE; MIT; https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson/10.0.11/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.signalr.protocols.newtonsoftjson/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-cb46d08503fd1b` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| JsonSubTypes | Undefined Behavior Analyzer | [open](c-sharp-jsonsubtypes-9107d4b5.md) |
