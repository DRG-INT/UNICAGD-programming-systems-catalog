...
| Canonical URL | [https://crates.io/crates/block-modes](https://crates.io/crates/block-modes) |
| Source record ids | crates_io-d5989ffdf0e2ee |

## System Engineer Summary

This crate is deprecated. Use crates from instead.

## Operational Role

For a systems engineer, block-modes belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2022-02-13T13:48:33.120358Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-d5989ffdf0e2ee` from `crates_io` as `registry_expansion`
