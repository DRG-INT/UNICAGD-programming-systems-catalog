# gtibo/VFX-sketchbook-Godot-4.x

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gtibo/VFX-sketchbook-Godot-4.x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gtibo/VFX-sketchbook-Godot-4.x](https://github.com/gtibo/VFX-sketchbook-Godot-4.x) |
| Source record ids | github_search_effects-e64e87e30a73a5 |
...
For a systems engineer, gtibo/VFX-sketchbook-Godot-4.x belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-28T22:18:49Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e64e87e30a73a5` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mobile-bungalow/tweak_shader_ae_plugin | Api Abi Checker | [open](effects-mobile-bungalow-tweak-shader-ae-plugin-fcc0a8d1.md) |
