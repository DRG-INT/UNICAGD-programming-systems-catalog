...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AntonPalmqvist/physically-based-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AntonPalmqvist/physically-based-api](https://github.com/AntonPalmqvist/physically-based-api) |
| Source record ids | github_search_effects-11b7b2624fb35b |
...
For a systems engineer, AntonPalmqvist/physically-based-api belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T15:55:49Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- `github_search_effects-11b7b2624fb35b` from `github_search_effects` as `registry_expansion`
