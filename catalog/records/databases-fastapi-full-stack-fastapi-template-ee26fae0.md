...
<!-- canonical: https://github.com/fastapi/full-stack-fastapi-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fastapi/full-stack-fastapi-template](https://github.com/fastapi/full-stack-fastapi-template) |
| Source record ids | github_search_databases-ccf43c173691a6 |

## System Engineer Summary

Full-stack web application template with FastAPI, React, SQLModel, PostgreSQL, Vite, Tailwind CSS,
shadcn/ui, FastAPI Cloud, and Docker Compose.

## Operational Role

For a systems engineer, fastapi/full-stack-fastapi-template belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T10:29:07Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ccf43c173691a6` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bwajtr/java-persistence-frameworks-comparison | Project Scaffolding | [open](databases-bwajtr-java-persistence-frameworks-comparison-74170125.md) |
