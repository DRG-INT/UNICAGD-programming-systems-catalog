...
<!-- canonical: https://github.com/paradedb/paradedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paradedb/paradedb](https://github.com/paradedb/paradedb) |
| Source record ids | github_search_databases-219ab282ddbf0a |

## System Engineer Summary

One Postgres for your application data, full-text search, vector retrieval, and aggregations. Home
of the pg_search extension.

## Operational Role

For a systems engineer, paradedb/paradedb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T07:19:21Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_databases-219ab282ddbf0a` from `github_search_databases` as `registry_expansion`
