...
<!-- canonical: https://github.com/Tomato6966/Musicium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tomato6966/Musicium](https://github.com/Tomato6966/Musicium) |
| Source record ids | github_search_electromagnetoscopes-b21fe1c2c1a562 |

## System Engineer Summary

An advanced Discord Music Bot with a Dashboard, using distube.js.org having an interactive button &
menu system and many features! Supported Features: Spotify • YouTube • SoundCloud • Live Stream •
Audio Filtering • DJ Roles • Autoplay • Autoresume • Dashboard + Live Queue • ...

## Operational Role

For a systems engineer, Tomato6966/Musicium belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-25T00:29:57Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b21fe1c2c1a562` from `github_search_electromagnetoscopes` as `registry_expansion`
