...
| Canonical URL | [https://luarocks.org/modules/bakhtinartem/faker2](https://luarocks.org/modules/bakhtinartem/faker2) |
| Source record ids | luarocks_root_manifest-b0e4e08afce66d |
...
For a systems engineer, faker2 belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b0e4e08afce66d` from `luarocks_root_manifest` as `registry_expansion`
