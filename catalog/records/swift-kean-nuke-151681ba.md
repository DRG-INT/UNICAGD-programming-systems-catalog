...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kean/Nuke -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kean/Nuke](https://github.com/kean/Nuke) |
| Source record ids | github_search_swift-942255c8f5d0a7 |

## System Engineer Summary

kean/Nuke is tracked as an image audio dsp record in the Swift branch. The source did not provide a
...
For a systems engineer, kean/Nuke belongs in the Swift inventory as part of ecosystem capability
...
- `github_search_swift-942255c8f5d0a7` from `github_search_swift` as `registry_expansion`
