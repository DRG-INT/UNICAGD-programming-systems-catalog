...
| Canonical URL | [https://crates.io/crates/dns-lookup](https://crates.io/crates/dns-lookup) |
| Source record ids | crates_io-b47fc3e8808f16 |

## System Engineer Summary

A simple dns resolving api, much like rust's unstable api. Also includes getaddrinfo and getnameinfo
wrappers for libc variants.

## Operational Role

For a systems engineer, dns-lookup belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-08-27T15:30:13.507837Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-b47fc3e8808f16` from `crates_io` as `registry_expansion`
