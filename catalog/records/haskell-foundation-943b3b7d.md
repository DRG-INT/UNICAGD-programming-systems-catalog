...
<!-- canonical: https://hackage.haskell.org/package/foundation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/foundation](https://hackage.haskell.org/package/foundation) |
| Source record ids | hackage_top_downloads-2426dcda55b72c |
...
For a systems engineer, foundation belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.30 | 2023-06-14T02:42:43Z | [https://hackage.haskell.org/package/foundation](https://hackage.haskell.org/package/foundation) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/foundation` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-2426dcda55b72c` from `hackage_top_downloads` as `registry_expansion`
