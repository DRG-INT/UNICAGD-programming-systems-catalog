...
| Source record ids | github_search_effects-ca519cf1d1c68a |

## System Engineer Summary

miek/inspectrum is tracked as an image audio dsp record in the Effects branch. The source did not
...
For a systems engineer, miek/inspectrum belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-06T15:44:29Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ca519cf1d1c68a` from `github_search_effects` as `registry_expansion`
