...
<!-- canonical: https://hackage.haskell.org/package/snap-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/snap-server](https://hackage.haskell.org/package/snap-server) |
| Source record ids | hackage_top_downloads-aaa4f1640ecb4e |

## System Engineer Summary

Hackage package with 300 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, snap-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2.1 | 2023-02-13T08:56:43Z | [https://hackage.haskell.org/package/snap-server](https://hackage.haskell.org/package/snap-server) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/snap-server` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-aaa4f1640ecb4e` from `hackage_top_downloads` as `registry_expansion`
