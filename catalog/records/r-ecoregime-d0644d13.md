...
<!-- canonical: https://cran.r-project.org/web/packages/ecoregime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ecoregime/index.html](https://cran.r-project.org/web/packages/ecoregime/index.html) |
| Source record ids | cran_packages_by_date-38d94906c59793 |
...
For a systems engineer, ecoregime belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-04 20:10:02 UTC | [https://cran.r-project.org/web/packages/ecoregime/DESCRIPTION](https://cran.r-project.org/web/packages/ecoregime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ecoregime/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-38d94906c59793` from `cran_packages_by_date` as `registry_expansion`
