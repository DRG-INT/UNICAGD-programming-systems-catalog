# baixingwang/devops-user-service
...
<!-- canonical: https://gitlab.com/baixingwang/devops-user-service -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/baixingwang/devops-user-service](https://gitlab.com/baixingwang/devops-user-service) |
| Source record ids | gitlab_projects_api-9730482f9cb1d7 |

## System Engineer Summary

baixingwang/devops-user-service is tracked as a machine learning record in the Repository Workplaces
...
For a systems engineer, baixingwang/devops-user-service belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-19T01:52:08.466Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-9730482f9cb1d7` from `gitlab_projects_api` as `registry_expansion`
