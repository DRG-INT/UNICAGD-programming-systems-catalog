...
| Canonical URL | [https://crates.io/crates/wasm-bindgen-test](https://crates.io/crates/wasm-bindgen-test) |
| Source record ids | crates_io-b859c199f8f6ad |
...
For a systems engineer, wasm-bindgen-test belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.77 | 2026-08-08T00:57:15.398175Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-b859c199f8f6ad` from `crates_io` as `registry_expansion`
