...
<!-- canonical: https://github.com/isbeorn/nina -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/isbeorn/nina](https://github.com/isbeorn/nina) |
| Source record ids | github_search_space_maps-1423d8d6bab713 |

## System Engineer Summary

N.I.N.A. - Advanced astrophotography sequencing software for Windows, supporting full automation of
imaging sessions.

## Operational Role

For a systems engineer, isbeorn/nina belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T15:12:52Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0 |
...
- `github_search_space_maps-1423d8d6bab713` from `github_search_space_maps` as `registry_expansion`
