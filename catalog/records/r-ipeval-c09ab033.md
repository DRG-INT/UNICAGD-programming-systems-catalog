...
<!-- canonical: https://cran.r-project.org/web/packages/ipeval/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ipeval/index.html](https://cran.r-project.org/web/packages/ipeval/index.html) |
| Source record ids | cran_packages_by_date-08bc9545cf6f23 |

## System Engineer Summary

Interventional Prediction Evaluation

## Operational Role

For a systems engineer, ipeval belongs in the R inventory as part of ecosystem capability mapping,
...
- `cran_packages_by_date-08bc9545cf6f23` from `cran_packages_by_date` as `registry_expansion`
