...
<!-- canonical: https://github.com/lucalista/shinestacker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lucalista/shinestacker](https://github.com/lucalista/shinestacker) |
| Source record ids | github_search_photography-47f26e2c5b8fd3 |

## System Engineer Summary

Focus stacking software with an interactive GUI and Python API for advanced image processing
workflows

## Operational Role

For a systems engineer, lucalista/shinestacker belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T16:25:19Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-47f26e2c5b8fd3` from `github_search_photography` as `registry_expansion`
