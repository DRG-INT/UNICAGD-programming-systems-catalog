...
<!-- canonical: https://github.com/stk-kriging/stk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stk-kriging/stk](https://github.com/stk-kriging/stk) |
| Source record ids | github_search_matlab-2560b733238c59 |

## System Engineer Summary

The STK is a (not so) Small Toolbox for Kriging. Its primary focus is on the
interpolation/regression technique known as kriging, which is very closely related to Splines and
Radial Basis Functions, and can be interpreted as a non-parametric Bayesian method using a Gaussian
Process (GP) prior.

## Operational Role

For a systems engineer, stk-kriging/stk belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-13T21:50:22Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-2560b733238c59` from `github_search_matlab` as `registry_expansion`
