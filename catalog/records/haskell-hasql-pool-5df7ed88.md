...
<!-- canonical: https://hackage.haskell.org/package/hasql-pool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hasql-pool](https://hackage.haskell.org/package/hasql-pool) |
| Source record ids | hackage_top_downloads-5c1dd0b2cec0f3 |
...
For a systems engineer, hasql-pool belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0.1 | 2026-08-06T16:42:53Z | [https://hackage.haskell.org/package/hasql-pool](https://hackage.haskell.org/package/hasql-pool) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hasql-pool` at `2026-09-01T07:24:01+00:00`.
...
- `hackage_top_downloads-5c1dd0b2cec0f3` from `hackage_top_downloads` as `registry_expansion`
