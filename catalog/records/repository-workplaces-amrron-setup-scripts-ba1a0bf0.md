...
| Canonical URL | [https://gitlab.com/amrron/setup-scripts](https://gitlab.com/amrron/setup-scripts) |
| Source record ids | gitlab_projects_api-c239b22e6b9fc5 |

## System Engineer Summary

This project will host tools to assist with setting up and configuring Debian based systems and
Raspberry Pi with ham radio tools and security software.

## Operational Role

For a systems engineer, amrron/setup-scripts belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-c239b22e6b9fc5` from `gitlab_projects_api` as `registry_expansion`
...
| gitlab-examples/security/security-reports | Security Sast | [open](repository-workplaces-gitlab-examples-security-security-reports-4aa4a872.md) |
| gitlab-org/security-products/dast | Security Sast | [open](repository-workplaces-gitlab-org-security-products-dast-90dd5672.md) |
| gitlab-org/security-products/sast | Security Sast | [open](repository-workplaces-gitlab-org-security-products-sast-f9f7c3e1.md) |
| guardianproject/tormobile/NetCipher | Security Sast | [open](repository-workplaces-guardianproject-tormobile-netcipher-11216d9e.md) |
