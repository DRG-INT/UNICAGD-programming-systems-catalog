# SkymanOne/SpaceShuttleSimulator

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/SkymanOne/SpaceShuttleSimulator](https://github.com/SkymanOne/SpaceShuttleSimulator) |
| Source record ids | github_search_space_shuttles-66b0ff86698115 |

## System Engineer Summary

Basic simulator of space-vehicle's re-entry into earth's atmosphere

## Operational Role

For a systems engineer, SkymanOne/SpaceShuttleSimulator belongs in the Space Shuttles inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | release/v1.0.0 | 2020-08-03T13:02:22Z | [https://api.github.com/repos/SkymanOne/SpaceShuttleSimulator/releases/latest](https://api.github.com/repos/SkymanOne/SpaceShuttleSimulator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SkymanOne/SpaceShuttleSimulator/releases/latest` at `2026-09-01T07:24:23+00:00`.
...
- `github_search_space_shuttles-66b0ff86698115` from `github_search_space_shuttles` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| orbitersim/orbiter | Filesystem Os | [open](space-shuttles-orbitersim-orbiter-1081cd8f.md) |
| Robert-Ramsayer/Apollo-s-path | Filesystem Os | [open](space-shuttles-robert-ramsayer-apollo-s-path-3851973c.md) |
| WeLoveKiraboshi/SIPRO-SpaceShuttle | Filesystem Os | [open](space-shuttles-welovekiraboshi-sipro-spaceshuttle-eb84746e.md) |
