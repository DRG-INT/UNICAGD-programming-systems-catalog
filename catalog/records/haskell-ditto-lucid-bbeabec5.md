...
| Source record ids | hackage_recent-5619b1b3b90ffa |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-05T00:17:56Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-5619b1b3b90ffa` from `hackage_recent` as `registry_expansion`
