...
<!-- canonical: https://github.com/yomotsu/camera-controls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yomotsu/camera-controls](https://github.com/yomotsu/camera-controls) |
| Source record ids | github_search_photography-eab29bd7e14f53 |

## System Engineer Summary

A camera control for three.js, similar to THREE.OrbitControls yet supports smooth transitions and
more features.

## Operational Role

For a systems engineer, yomotsu/camera-controls belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:20:43Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-eab29bd7e14f53` from `github_search_photography` as `registry_expansion`
