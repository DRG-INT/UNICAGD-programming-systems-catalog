...
<!-- canonical: https://crates.io/crates/png -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/png](https://crates.io/crates/png) |
| Source record ids | crates_io-1815eb7e2a327c |
...
For a systems engineer, png belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.1 | 2026-02-14T16:24:10.825565Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-1815eb7e2a327c` from `crates_io` as `registry_expansion`
