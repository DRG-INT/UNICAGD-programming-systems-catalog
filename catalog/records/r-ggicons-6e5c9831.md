...
<!-- canonical: https://cran.r-project.org/web/packages/ggicons/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggicons/index.html](https://cran.r-project.org/web/packages/ggicons/index.html) |
| Source record ids | cran_packages_by_date-6f9dde254af119 |
...
For a systems engineer, ggicons belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 13:10:02 UTC | [https://cran.r-project.org/web/packages/ggicons/DESCRIPTION](https://cran.r-project.org/web/packages/ggicons/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggicons/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-6f9dde254af119` from `cran_packages_by_date` as `registry_expansion`
