...
<!-- canonical: https://cran.r-project.org/web/packages/BLSM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BLSM/index.html](https://cran.r-project.org/web/packages/BLSM/index.html) |
| Source record ids | cran_packages_by_date-9d460e02d5af89 |
...
For a systems engineer, BLSM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-31 20:30:11 UTC | [https://cran.r-project.org/web/packages/BLSM/DESCRIPTION](https://cran.r-project.org/web/packages/BLSM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BLSM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9d460e02d5af89` from `cran_packages_by_date` as `registry_expansion`
