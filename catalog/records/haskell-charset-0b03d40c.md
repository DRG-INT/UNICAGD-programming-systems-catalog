...
<!-- canonical: https://hackage.haskell.org/package/charset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/charset](https://hackage.haskell.org/package/charset) |
| Source record ids | hackage_top_downloads-1db237be039620 |
...
For a systems engineer, charset belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.12 | 2025-03-03T11:19:56Z | [https://hackage.haskell.org/package/charset](https://hackage.haskell.org/package/charset) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/charset` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-1db237be039620` from `hackage_top_downloads` as `registry_expansion`
