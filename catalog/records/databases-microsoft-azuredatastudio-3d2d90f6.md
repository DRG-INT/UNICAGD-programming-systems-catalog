...
<!-- canonical: https://github.com/microsoft/azuredatastudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/azuredatastudio](https://github.com/microsoft/azuredatastudio) |
| Source record ids | github_search_databases-95dbef6df737cd |

## System Engineer Summary

Azure Data Studio is a data management and development tool with connectivity to popular cloud and
on-premises databases. Azure Data Studio supports Windows, macOS, and Linux, with immediate
capability to connect to Azure SQL and SQL Server. Browse the extension library for more database
support options including MySQL, PostgreSQL, and MongoDB.

## Operational Role

For a systems engineer, microsoft/azuredatastudio belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-28T16:30:21Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-95dbef6df737cd` from `github_search_databases` as `registry_expansion`
