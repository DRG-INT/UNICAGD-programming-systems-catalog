...
<!-- canonical: https://github.com/plugin87/ux-ui-agent-skills -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/plugin87/ux-ui-agent-skills](https://github.com/plugin87/ux-ui-agent-skills) |
| Source record ids | github_search_icons_and_logos-878c219ef3f40b |

## System Engineer Summary

Turn Claude into a Senior Design Architect — DTCG design tokens, 42 components, WCAG 2.2
accessibility, any-framework code, 138 design systems, and runnable skills.

## Operational Role

For a systems engineer, plugin87/ux-ui-agent-skills belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T15:24:54Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-878c219ef3f40b` from `github_search_icons_and_logos` as `registry_expansion`
