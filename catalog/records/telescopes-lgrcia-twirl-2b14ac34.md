...
<!-- canonical: https://github.com/lgrcia/twirl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lgrcia/twirl](https://github.com/lgrcia/twirl) |
| Source record ids | github_search_telescopes-f5dec0a03d067e |

## System Engineer Summary

Astrometric plate solving package for Python.

## Operational Role

For a systems engineer, lgrcia/twirl belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-07-21T07:23:09Z | [https://api.github.com/repos/lgrcia/twirl/releases/latest](https://api.github.com/repos/lgrcia/twirl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lgrcia/twirl/releases/latest` at `2026-09-01T11:22:15+00:00`.
...
- `github_search_telescopes-f5dec0a03d067e` from `github_search_telescopes` as `registry_expansion`
