...
<!-- canonical: https://cran.r-project.org/web/packages/melodi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/melodi/index.html](https://cran.r-project.org/web/packages/melodi/index.html) |
| Source record ids | cran_packages_by_date-6ee5f8f8f57371 |

## System Engineer Summary

Download Insee French Institute of Statistics Open Data

## Operational Role

For a systems engineer, melodi belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-28 16:50:02 UTC | [https://cran.r-project.org/web/packages/melodi/DESCRIPTION](https://cran.r-project.org/web/packages/melodi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/melodi/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6ee5f8f8f57371` from `cran_packages_by_date` as `registry_expansion`
