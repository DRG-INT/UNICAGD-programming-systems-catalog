...
<!-- canonical: https://cran.r-project.org/web/packages/glmtlp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmtlp/index.html](https://cran.r-project.org/web/packages/glmtlp/index.html) |
| Source record ids | cran_packages_by_date-0a83f43362229d |
...
For a systems engineer, glmtlp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-09-13 15:20:02 UTC | [https://cran.r-project.org/web/packages/glmtlp/DESCRIPTION](https://cran.r-project.org/web/packages/glmtlp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmtlp/DESCRIPTION` at `2026-09-13T16:19:40+00:00`.
...
- `cran_packages_by_date-0a83f43362229d` from `cran_packages_by_date` as `registry_expansion`
