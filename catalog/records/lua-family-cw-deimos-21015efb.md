...
<!-- canonical: https://luarocks.org/modules/forestbelton/cw-deimos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/forestbelton/cw-deimos](https://luarocks.org/modules/forestbelton/cw-deimos) |
| Source record ids | luarocks_root_manifest-8d4e062de5055c |

## System Engineer Summary

Lua implementation of MARS

## Operational Role

For a systems engineer, cw-deimos belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-8d4e062de5055c` from `luarocks_root_manifest` as `registry_expansion`
