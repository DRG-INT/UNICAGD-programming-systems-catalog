...
<!-- canonical: https://github.com/endee-io/endee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/endee-io/endee](https://github.com/endee-io/endee) |
| Source record ids | github_search_databases-d48ed7b461f424 |

## System Engineer Summary

Endee.io – A high-performance vector database, designed to handle up to 1B vectors on a single node,
delivering significant performance gains through optimized indexing and execution. Also available in
cloud

## Operational Role

For a systems engineer, endee-io/endee belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T09:56:00Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d48ed7b461f424` from `github_search_databases` as `registry_expansion`
