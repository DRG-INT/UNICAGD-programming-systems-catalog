...
<!-- canonical: https://pub.dev/packages/profanity_filter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/profanity_filter](https://pub.dev/packages/profanity_filter) |
| Source record ids | pub_dev-4055526aec69ab |

## System Engineer Summary

Simple filter to check and censor strings against profanity, obscene words. A default English words
list is provided (LDNOOBW).

## Operational Role

For a systems engineer, profanity_filter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2021-06-29T16:50:08.536195Z | [https://pub.dev/api/packages/profanity_filter](https://pub.dev/api/packages/profanity_filter) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-03-09T17:03:01.798561Z | [https://pub.dev/api/packages/profanity_filter](https://pub.dev/api/packages/profanity_filter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/profanity_filter` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-4055526aec69ab` from `pub_dev` as `registry_expansion`
