...
<!-- canonical: https://cran.r-project.org/web/packages/GetTDData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GetTDData/index.html](https://cran.r-project.org/web/packages/GetTDData/index.html) |
| Source record ids | cran_packages_by_date-29973eb4ce5df8 |
...
For a systems engineer, GetTDData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-08-29 16:50:02 UTC | [https://cran.r-project.org/web/packages/GetTDData/DESCRIPTION](https://cran.r-project.org/web/packages/GetTDData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GetTDData/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-29973eb4ce5df8` from `cran_packages_by_date` as `registry_expansion`
