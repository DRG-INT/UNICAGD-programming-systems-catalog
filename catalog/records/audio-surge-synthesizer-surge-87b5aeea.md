...
<!-- canonical: https://github.com/surge-synthesizer/surge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/surge-synthesizer/surge](https://github.com/surge-synthesizer/surge) |
| Source record ids | github_search_audio-ead0d5ee33e1d9 |
...
For a systems engineer, surge-synthesizer/surge belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | Nightly | 2024-08-07T14:35:52Z | [https://api.github.com/repos/surge-synthesizer/surge/releases/latest](https://api.github.com/repos/surge-synthesizer/surge/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/surge-synthesizer/surge/releases/latest` at `2026-09-01T11:21:43+00:00`.
...
- `github_search_audio-ead0d5ee33e1d9` from `github_search_audio` as `registry_expansion`
