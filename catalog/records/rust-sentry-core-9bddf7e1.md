...
| Canonical URL | [https://crates.io/crates/sentry-core](https://crates.io/crates/sentry-core) |
| Source record ids | crates_io-b471cc2f343c2a |
...
For a systems engineer, sentry-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.49.2 | 2026-08-26T14:42:26.602859Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-b471cc2f343c2a` from `crates_io` as `registry_expansion`
