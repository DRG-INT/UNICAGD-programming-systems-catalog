...
<!-- canonical: https://cran.r-project.org/web/packages/vitals/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vitals/index.html](https://cran.r-project.org/web/packages/vitals/index.html) |
| Source record ids | cran_packages_by_date-5b8b1da66d7f4a |
...
For a systems engineer, vitals belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-02 18:40:02 UTC | [https://cran.r-project.org/web/packages/vitals/DESCRIPTION](https://cran.r-project.org/web/packages/vitals/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vitals/DESCRIPTION` at `2026-09-02T20:20:11+00:00`.
...
- `cran_packages_by_date-5b8b1da66d7f4a` from `cran_packages_by_date` as `registry_expansion`
