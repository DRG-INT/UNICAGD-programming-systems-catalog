...
| Source record ids | master-b811e488a9b9 |

## System Engineer Summary

Microsoft C23/C implementation status

## Operational Role

For a systems engineer, MSVC C23 belongs in the C23 inventory as part of compiler selection,
...
- `master-b811e488a9b9` from `master_json` as `compiler`
