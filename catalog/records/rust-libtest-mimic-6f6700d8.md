...
<!-- canonical: https://crates.io/crates/libtest-mimic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libtest-mimic](https://crates.io/crates/libtest-mimic) |
| Source record ids | crates_io-04dba558292bb2 |

## System Engineer Summary

Write your own test harness that looks and behaves like the built-in test harness used by `rustc
--test`

## Operational Role

For a systems engineer, libtest-mimic belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-03-16T17:21:55.796974Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
