...
| Canonical URL | [https://gitlab.com/kara.moe/karaokebase](https://gitlab.com/kara.moe/karaokebase) |
| Source record ids | gitlab_projects_api-325d57d73e5bc2 |

## System Engineer Summary

kara.moe/karaokebase is tracked as a database datastore record in the Repository Workplaces branch.
...
For a systems engineer, kara.moe/karaokebase belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-325d57d73e5bc2` from `gitlab_projects_api` as `registry_expansion`
...
| ProfaneDB/ProfaneDB | Database Datastore | [open](repository-workplaces-profanedb-profanedb-135545c0.md) |
| radiobrowser/radio-database | Database Datastore | [open](repository-workplaces-radiobrowser-radio-database-bfa28291.md) |
