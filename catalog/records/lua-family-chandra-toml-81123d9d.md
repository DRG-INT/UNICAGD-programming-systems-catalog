...
<!-- canonical: https://luarocks.org/modules/veer66/chandra-toml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/veer66/chandra-toml](https://luarocks.org/modules/veer66/chandra-toml) |
| Source record ids | luarocks_root_manifest-45f80f8ea554b5 |
...
For a systems engineer, chandra-toml belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-45f80f8ea554b5` from `luarocks_root_manifest` as `registry_expansion`
...
| dkjson | Serialization | [open](lua-family-dkjson-9a13e976.md) |
