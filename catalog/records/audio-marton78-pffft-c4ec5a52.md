...
<!-- canonical: https://github.com/marton78/pffft -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marton78/pffft](https://github.com/marton78/pffft) |
| Source record ids | github_search_audio-acf3dcbb246517 |
...
For a systems engineer, marton78/pffft belongs in the Audio inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T11:44:51Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-acf3dcbb246517` from `github_search_audio` as `registry_expansion`
