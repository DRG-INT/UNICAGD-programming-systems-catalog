...
<!-- canonical: https://cran.r-project.org/web/packages/infometrics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/infometrics/index.html](https://cran.r-project.org/web/packages/infometrics/index.html) |
| Source record ids | cran_packages_by_date-e9fd5117ae4410 |
...
For a systems engineer, infometrics belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-10 13:00:02 UTC | [https://cran.r-project.org/web/packages/infometrics/DESCRIPTION](https://cran.r-project.org/web/packages/infometrics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/infometrics/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-e9fd5117ae4410` from `cran_packages_by_date` as `registry_expansion`
