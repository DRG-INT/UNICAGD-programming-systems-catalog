...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-drift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-drift](https://packagist.org/packages/pestphp/pest-plugin-drift) |
| Source record ids | packagist_search-5448cc6611fbaa |

## System Engineer Summary

pestphp/pest-plugin-drift is tracked as a testing framework record in the PHP branch. The source did
...
For a systems engineer, pestphp/pest-plugin-drift belongs in the PHP inventory as part of
...
- `packagist_search-5448cc6611fbaa` from `packagist_search` as `registry_expansion`
