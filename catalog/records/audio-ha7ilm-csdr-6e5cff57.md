...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_audio-32d72ca9cea1ea |
...
For a systems engineer, ha7ilm/csdr belongs in the Audio inventory as part of ecosystem capability
...
- `github_search_audio-32d72ca9cea1ea` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alshell7/vokaturi-android | Cli | [open](audio-alshell7-vokaturi-android-b35798f0.md) |
