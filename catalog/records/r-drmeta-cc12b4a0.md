...
<!-- canonical: https://cran.r-project.org/web/packages/drmeta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/drmeta/index.html](https://cran.r-project.org/web/packages/drmeta/index.html) |
| Source record ids | cran_packages_by_date-7cae10bba78a5d |
...
For a systems engineer, drmeta belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-24 19:10:02 UTC | [https://cran.r-project.org/web/packages/drmeta/DESCRIPTION](https://cran.r-project.org/web/packages/drmeta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/drmeta/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7cae10bba78a5d` from `cran_packages_by_date` as `registry_expansion`
