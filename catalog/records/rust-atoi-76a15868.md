...
<!-- canonical: https://crates.io/crates/atoi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/atoi](https://crates.io/crates/atoi) |
| Source record ids | crates_io-9c3c0ba5efa251 |
...
For a systems engineer, atoi belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-06-25T17:13:15.254833Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-9c3c0ba5efa251` from `crates_io` as `registry_expansion`
