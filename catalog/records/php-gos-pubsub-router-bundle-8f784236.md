...
<!-- canonical: https://packagist.org/packages/gos/pubsub-router-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/gos/pubsub-router-bundle](https://packagist.org/packages/gos/pubsub-router-bundle) |
| Source record ids | packagist_search-628ad58c449f5c |
...
For a systems engineer, gos/pubsub-router-bundle belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-628ad58c449f5c` from `packagist_search` as `registry_expansion`
