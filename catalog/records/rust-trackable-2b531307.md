...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Ide Editor Integration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ide-editor-integration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/trackable](https://crates.io/crates/trackable) |
| Source record ids | crates_io-ddbbab3b8a0b74 |

## System Engineer Summary

This library provides a way to track objects manually as an alternative to mechanisms like
backtracing

## Operational Role

For a systems engineer, trackable belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2023-05-05T02:23:47.610971Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| aead | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aead-347b82ec.md) |
| anes | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-anes-762d030e.md) |
| av-scenechange | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-av-scenechange-997c3bb0.md) |
| aws-config | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-config-b358cea5.md) |
| azure_identity | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-azure-identity-b4a332ee.md) |
| base16ct | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-base16ct-3eb32060.md) |
| base64ct | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-base64ct-2842b539.md) |
| bitfield | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bitfield-32529b01.md) |
