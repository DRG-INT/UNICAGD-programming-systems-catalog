...
<!-- canonical: https://github.com/ssabug/fxseq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ssabug/fxseq](https://github.com/ssabug/fxseq) |
| Source record ids | github_search_audio-a99b9c3932d07b |

## System Engineer Summary

A step sequencer based multi effect VST3 plugin using JUCE.

## Operational Role

For a systems engineer, ssabug/fxseq belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-28T00:28:31Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-a99b9c3932d07b` from `github_search_audio` as `registry_expansion`
