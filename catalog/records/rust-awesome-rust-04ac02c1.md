...
| Source type | community_reference |
| Verification | verified_this_pass |
| Canonical URL | [https://github.com/rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) |
| Source record ids | web-14f1a2874b22b9 |
...
For a systems engineer, Awesome Rust belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| web_search | verified_this_pass | 2026-09-01 | `{"kind": "web_search", "retrieved": "2026-09-01", "status": "verified_this_pass"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `web-14f1a2874b22b9` from `master_json` as `community_reference`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cranelift-entity | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cranelift-entity-af46f711.md) |
| gix-ref | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-gix-ref-e9d1e2bc.md) |
| inout | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-inout-df76f975.md) |
| outref | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-outref-6d840028.md) |
| owning_ref | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-owning-ref-bb3669e9.md) |
| servo_arc | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-servo-arc-0a4d1591.md) |
| sval_ref | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-sval-ref-9e9ee64e.md) |
| triomphe | Community Reference | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-triomphe-a738bb8e.md) |
