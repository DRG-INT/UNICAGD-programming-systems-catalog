...
| Canonical URL | [https://github.com/QQxiaoming/YUVviewer](https://github.com/QQxiaoming/YUVviewer) |
| Source record ids | github_search_photography-5aac1348027163 |

## System Engineer Summary

YUVviewer is a small tool for developers to view and preview various original image formats. It is
based on Qt and opencv frameworks and supports
windows/linux/macos.YUVviewer一款用于开发人员查看预览各种原始图像格式的小工具，其基于Qt和opencv的框架，支持windows/linux/macos。

## Operational Role

For a systems engineer, QQxiaoming/YUVviewer belongs in the Photography inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | V0.5.9 | 2025-04-02T06:26:00Z | [https://api.github.com/repos/QQxiaoming/YUVviewer/releases/latest](https://api.github.com/repos/QQxiaoming/YUVviewer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/QQxiaoming/YUVviewer/releases/latest` at `2026-09-01T09:23:33+00:00`.
...
- `github_search_photography-5aac1348027163` from `github_search_photography` as `registry_expansion`
...
| mz2/Carpaccio | Formatter | [open](photography-mz2-carpaccio-47bb21ca.md) |
