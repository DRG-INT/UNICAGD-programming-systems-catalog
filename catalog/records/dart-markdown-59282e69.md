...
<!-- canonical: https://pub.dev/packages/markdown -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/markdown](https://pub.dev/packages/markdown) |
| Source record ids | pub_dev-2dcd2a0d381aa7 |
...
For a systems engineer, markdown belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.1 | 2026-03-18T03:53:13.420141Z | [https://pub.dev/api/packages/markdown](https://pub.dev/api/packages/markdown) |  |
| preview | known | 4.0.0-nullsafety.0 | 2021-01-06T17:28:24.356073Z | [https://pub.dev/api/packages/markdown](https://pub.dev/api/packages/markdown) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/markdown` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-2dcd2a0d381aa7` from `pub_dev` as `registry_expansion`
