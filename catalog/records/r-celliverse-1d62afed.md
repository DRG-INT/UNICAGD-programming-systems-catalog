...
<!-- canonical: https://cran.r-project.org/web/packages/celliverse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/celliverse/index.html](https://cran.r-project.org/web/packages/celliverse/index.html) |
| Source record ids | cran_packages_by_date-6088029cc8df17 |
...
For a systems engineer, celliverse belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-09-12 13:40:14 UTC | [https://cran.r-project.org/web/packages/celliverse/DESCRIPTION](https://cran.r-project.org/web/packages/celliverse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/celliverse/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-6088029cc8df17` from `cran_packages_by_date` as `registry_expansion`
