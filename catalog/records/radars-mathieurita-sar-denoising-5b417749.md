...
<!-- canonical: https://github.com/MathieuRita/SAR_denoising -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MathieuRita/SAR_denoising](https://github.com/MathieuRita/SAR_denoising) |
| Source record ids | github_search_radars-9e41675ecfad3a |

## System Engineer Summary

Denoising framework for SAR images (Synthetic Aperture Radar) based on the FFDNet. Final project of
MVA course "Remote sensing data: from sensor to large-scale geospatial data exploitation"

## Operational Role

For a systems engineer, MathieuRita/SAR_denoising belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-22T01:48:31Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9e41675ecfad3a` from `github_search_radars` as `registry_expansion`
