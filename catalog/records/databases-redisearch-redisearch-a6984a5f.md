...
<!-- canonical: https://github.com/RediSearch/RediSearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RediSearch/RediSearch](https://github.com/RediSearch/RediSearch) |
| Source record ids | github_search_databases-cf94276d6e6b5e |
...
For a systems engineer, RediSearch/RediSearch belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:15:09Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cf94276d6e6b5e` from `github_search_databases` as `registry_expansion`
