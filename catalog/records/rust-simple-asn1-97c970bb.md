...
<!-- canonical: https://crates.io/crates/simple_asn1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/simple_asn1](https://crates.io/crates/simple_asn1) |
| Source record ids | crates_io-12423878a56da9 |
...
For a systems engineer, simple_asn1 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-02-12T17:09:18.366120Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-12423878a56da9` from `crates_io` as `registry_expansion`
