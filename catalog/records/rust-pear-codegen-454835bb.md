...
| Canonical URL | [https://crates.io/crates/pear_codegen](https://crates.io/crates/pear_codegen) |
| Source record ids | crates_io-69a36c5e862194 |
...
For a systems engineer, pear_codegen belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.9 | 2024-03-20T07:16:44.443260Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-69a36c5e862194` from `crates_io` as `registry_expansion`
