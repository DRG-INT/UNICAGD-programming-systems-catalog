...
<!-- canonical: https://github.com/labring/sealos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/labring/sealos](https://github.com/labring/sealos) |
| Source record ids | github_search_go-e71da90dcc42a0 |

## System Engineer Summary

Deploy real projects from GitHub or your AI coding agent, then keep them running with AI-powered
operations.

## Operational Role

For a systems engineer, labring/sealos belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T07:32:46Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-e71da90dcc42a0` from `github_search_go` as `registry_expansion`
