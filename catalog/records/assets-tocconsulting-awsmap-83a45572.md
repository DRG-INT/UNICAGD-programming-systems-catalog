...
<!-- canonical: https://github.com/TocConsulting/awsmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TocConsulting/awsmap](https://github.com/TocConsulting/awsmap) |
| Source record ids | github_search_assets-35edb2d92a276d |

## System Engineer Summary

A fast, comprehensive tool for mapping and inventorying AWS resources across 150+ services and all
regions.

## Operational Role

For a systems engineer, TocConsulting/awsmap belongs in the Assets inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T19:31:26Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-35edb2d92a276d` from `github_search_assets` as `registry_expansion`
