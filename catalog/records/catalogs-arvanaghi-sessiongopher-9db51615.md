...
<!-- canonical: https://github.com/Arvanaghi/SessionGopher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Arvanaghi/SessionGopher](https://github.com/Arvanaghi/SessionGopher) |
| Source record ids | github_search_catalogs-9b975e67079097 |

## System Engineer Summary

SessionGopher is a PowerShell tool that uses WMI to extract saved session information for remote
access tools such as WinSCP, PuTTY, SuperPuTTY, FileZilla, and Microsoft Remote Desktop. It can be
run remotely or locally.

## Operational Role

For a systems engineer, Arvanaghi/SessionGopher belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-22T21:33:23Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-9b975e67079097` from `github_search_catalogs` as `registry_expansion`
