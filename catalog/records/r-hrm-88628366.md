...
<!-- canonical: https://cran.r-project.org/web/packages/HRM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HRM/index.html](https://cran.r-project.org/web/packages/HRM/index.html) |
| Source record ids | cran_packages_by_date-3f18759df24023 |
...
For a systems engineer, HRM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-09-11 14:00:02 UTC | [https://cran.r-project.org/web/packages/HRM/DESCRIPTION](https://cran.r-project.org/web/packages/HRM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HRM/DESCRIPTION` at `2026-09-11T14:23:14+00:00`.
...
- `cran_packages_by_date-3f18759df24023` from `cran_packages_by_date` as `registry_expansion`
