...
<!-- canonical: https://cran.r-project.org/web/packages/VertexWiseR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/VertexWiseR/index.html](https://cran.r-project.org/web/packages/VertexWiseR/index.html) |
| Source record ids | cran_packages_by_date-c9bd1e1b25b285 |
...
For a systems engineer, VertexWiseR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.3 | 2026-09-03 02:30:02 UTC | [https://cran.r-project.org/web/packages/VertexWiseR/DESCRIPTION](https://cran.r-project.org/web/packages/VertexWiseR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/VertexWiseR/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-c9bd1e1b25b285` from `cran_packages_by_date` as `registry_expansion`
