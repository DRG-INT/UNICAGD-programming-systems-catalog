...
<!-- canonical: https://cran.r-project.org/web/packages/plotomics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/plotomics/index.html](https://cran.r-project.org/web/packages/plotomics/index.html) |
| Source record ids | cran_packages_by_date-918c643293a334 |

## System Engineer Summary

High-Performance Bioinformatics Visualizations

## Operational Role

For a systems engineer, plotomics belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-04 21:50:02 UTC | [https://cran.r-project.org/web/packages/plotomics/DESCRIPTION](https://cran.r-project.org/web/packages/plotomics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/plotomics/DESCRIPTION` at `2026-09-04T22:18:17+00:00`.
...
- `cran_packages_by_date-918c643293a334` from `cran_packages_by_date` as `registry_expansion`
