...
<!-- canonical: https://pub.dev/packages/firebase_messaging -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/firebase_messaging](https://pub.dev/packages/firebase_messaging) |
| Source record ids | pub_dev-816a8058acc28a |

## System Engineer Summary

Flutter plugin for Firebase Cloud Messaging, a cross-platform messaging solution that lets you
reliably deliver messages on Android and iOS.

## Operational Role

For a systems engineer, firebase_messaging belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 16.6.0 | 2026-08-24T13:41:52.500498Z | [https://pub.dev/api/packages/firebase_messaging](https://pub.dev/api/packages/firebase_messaging) |  |
| preview | known | 9.0.0-1.0.nullsafety.2 | 2021-02-22T11:42:26.729633Z | [https://pub.dev/api/packages/firebase_messaging](https://pub.dev/api/packages/firebase_messaging) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/firebase_messaging` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-816a8058acc28a` from `pub_dev` as `registry_expansion`
