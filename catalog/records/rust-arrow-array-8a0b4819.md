...
<!-- canonical: https://crates.io/crates/arrow-array -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arrow-array](https://crates.io/crates/arrow-array) |
| Source record ids | crates_io-4547bcc6c46907 |
...
For a systems engineer, arrow-array belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 59.3.0 | 2026-09-01T10:37:58.426209Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-4547bcc6c46907` from `crates_io` as `registry_expansion`
