...
<!-- canonical: https://crates.io/crates/unic-char-range -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unic-char-range](https://crates.io/crates/unic-char-range) |
| Source record ids | crates_io-e6a04ef2657695 |
...
For a systems engineer, unic-char-range belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2019-03-03T04:58:08.510025Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-e6a04ef2657695` from `crates_io` as `registry_expansion`
