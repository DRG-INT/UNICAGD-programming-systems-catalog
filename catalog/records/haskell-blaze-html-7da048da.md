...
<!-- canonical: https://hackage.haskell.org/package/blaze-html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/blaze-html](https://hackage.haskell.org/package/blaze-html) |
| Source record ids | hackage_top_downloads-ac8fa0664b4a81 |
...
For a systems engineer, blaze-html belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.2.0 | 2024-03-06T08:07:25Z | [https://hackage.haskell.org/package/blaze-html](https://hackage.haskell.org/package/blaze-html) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/blaze-html` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-ac8fa0664b4a81` from `hackage_top_downloads` as `registry_expansion`
