...
<!-- canonical: https://github.com/danielmiessler/Fabric -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danielmiessler/Fabric](https://github.com/danielmiessler/Fabric) |
| Source record ids | github_search_go-62f89c4d4cfaf5 |

## System Engineer Summary

Fabric is an open-source framework for augmenting humans using AI. It provides a modular system for
solving specific problems using a crowdsourced set of AI prompts that can be used anywhere.

## Operational Role

For a systems engineer, danielmiessler/Fabric belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:58:12Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-62f89c4d4cfaf5` from `github_search_go` as `registry_expansion`
