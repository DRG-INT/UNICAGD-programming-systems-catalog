...
| Canonical URL | [https://ecosyste.ms/](https://ecosyste.ms/) |
| Source record ids | curated_language_routes-241478d333520a |

## System Engineer Summary

Open package/repository metadata indexes for dependency, license, security, and supply-chain
analysis.

## Operational Role

For a systems engineer, Ecosyste.ms belongs in the Catalogs inventory as part of ecosystem
...
- `curated_language_routes-241478d333520a` from `curated_language_routes` as `registry_expansion`
