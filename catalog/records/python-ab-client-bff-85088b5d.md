...
<!-- canonical: https://pypi.org/project/ab-client-bff/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-client-bff/](https://pypi.org/project/ab-client-bff/) |
| Source record ids | pypi_simple-ac639ff0e6a588 |

## System Engineer Summary

Client package for auth broker bff service.

## Operational Role

For a systems engineer, ab-client-bff belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-03-01T03:18:04.836607Z | [https://pypi.org/pypi/ab-client-bff/json](https://pypi.org/pypi/ab-client-bff/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-client-bff/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-ac639ff0e6a588` from `pypi_simple` as `registry_expansion`
