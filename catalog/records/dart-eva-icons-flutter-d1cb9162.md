...
<!-- canonical: https://pub.dev/packages/eva_icons_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/eva_icons_flutter](https://pub.dev/packages/eva_icons_flutter) |
| Source record ids | pub_dev-994742c1686cf4 |

## System Engineer Summary

Flutter package for Eva Icons. Eva Icons is a pack of more than 480 beautifully crafted Open Source
icons for common actions and items.

## Operational Role

For a systems engineer, eva_icons_flutter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-07-29T05:33:06.269058Z | [https://pub.dev/api/packages/eva_icons_flutter](https://pub.dev/api/packages/eva_icons_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/eva_icons_flutter` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-994742c1686cf4` from `pub_dev` as `registry_expansion`
