...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JeffersonQin/YuzuMarker.FontDetection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JeffersonQin/YuzuMarker.FontDetection](https://github.com/JeffersonQin/YuzuMarker.FontDetection) |
| Source record ids | github_search_assets-28a0614bfaf168 |

## System Engineer Summary

✨ 首个CJK（中日韩）字体识别以及样式提取模型 YuzuMarker的字体识别模型与实现 / First-ever CJK (Chinese Japanese Korean) Font
Recognition and Style Extractor, side project of YuzuMarker

## Operational Role

For a systems engineer, JeffersonQin/YuzuMarker.FontDetection belongs in the Assets inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-22T22:38:43Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:fonts stars:>100", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_assets-28a0614bfaf168` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Aksel000/R2-Textures | Ide Editor Integration | [open](assets-aksel000-r2-textures-357371ac.md) |
| AlexeyPerov/Unity-Textures-Hunter | Ide Editor Integration | [open](assets-alexeyperov-unity-textures-hunter-3aee53ed.md) |
| darriagada/Retro-Noise | Ide Editor Integration | [open](assets-darriagada-retro-noise-dc8e59f0.md) |
| DragonCherry/AssetsPickerViewController | Ide Editor Integration | [open](assets-dragoncherry-assetspickerviewcontroller-291d781d.md) |
| epilys/gerb | Ide Editor Integration | [open](assets-epilys-gerb-11b0ad1a.md) |
| fontra/fontra | Ide Editor Integration | [open](assets-fontra-fontra-5752503b.md) |
| imadr/Unity-game-hacking | Ide Editor Integration | [open](assets-imadr-unity-game-hacking-14ce1631.md) |
| itflow-org/itflow | Ide Editor Integration | [open](assets-itflow-org-itflow-94ed9c35.md) |
