...
<!-- canonical: https://cran.r-project.org/web/packages/enderecobr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/enderecobr/index.html](https://cran.r-project.org/web/packages/enderecobr/index.html) |
| Source record ids | cran_packages_by_date-fbe95fa7a0137c |
...
For a systems engineer, enderecobr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-09-11 15:30:08 UTC | [https://cran.r-project.org/web/packages/enderecobr/DESCRIPTION](https://cran.r-project.org/web/packages/enderecobr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/enderecobr/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-fbe95fa7a0137c` from `cran_packages_by_date` as `registry_expansion`
...
| dccmidas | Language Specification | [open](r-dccmidas-9e59f289.md) |
