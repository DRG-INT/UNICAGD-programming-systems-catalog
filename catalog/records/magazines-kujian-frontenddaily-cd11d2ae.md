...
<!-- canonical: https://github.com/kujian/frontendDaily -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kujian/frontendDaily](https://github.com/kujian/frontendDaily) |
| Source record ids | github_search_magazines-7cb79477bd5d3a |
...
For a systems engineer, kujian/frontendDaily belongs in the Magazines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T13:28:03Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-7cb79477bd5d3a` from `github_search_magazines` as `registry_expansion`
