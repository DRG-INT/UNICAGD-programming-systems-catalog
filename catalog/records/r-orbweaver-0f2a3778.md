...
<!-- canonical: https://cran.r-project.org/web/packages/orbweaver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/orbweaver/index.html](https://cran.r-project.org/web/packages/orbweaver/index.html) |
| Source record ids | cran_packages_by_date-8f191235dd070e |
...
For a systems engineer, orbweaver belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.3 | 2026-09-02 23:30:02 UTC | [https://cran.r-project.org/web/packages/orbweaver/DESCRIPTION](https://cran.r-project.org/web/packages/orbweaver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/orbweaver/DESCRIPTION` at `2026-09-03T00:30:53+00:00`.
...
- `cran_packages_by_date-8f191235dd070e` from `cran_packages_by_date` as `registry_expansion`
...
| castor | Parser Lexer Ast | [open](r-castor-883d444a.md) |
