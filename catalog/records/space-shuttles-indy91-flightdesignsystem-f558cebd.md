...
| Canonical URL | [https://github.com/indy91/FlightDesignSystem](https://github.com/indy91/FlightDesignSystem) |
| Source record ids | github_search_space_shuttles-c1f138367858cd |

## System Engineer Summary

Mission planning tool for Earth orbit rendezvous missions using NASSP or SSV in the Orbiter Space
Flight Simulator

## Operational Role

For a systems engineer, indy91/FlightDesignSystem belongs in the Space Shuttles inventory as part of
...
| preview | known | 0.1.7 | 2026-05-11T17:45:00Z | [https://api.github.com/repos/indy91/FlightDesignSystem/releases?per_page=10](https://api.github.com/repos/indy91/FlightDesignSystem/releases?per_page=10) |  |
...
- `github_search_space_shuttles-c1f138367858cd` from `github_search_space_shuttles` as `registry_expansion`
