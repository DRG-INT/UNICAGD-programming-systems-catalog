...
<!-- canonical: https://cran.r-project.org/web/packages/subincomeR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/subincomeR/index.html](https://cran.r-project.org/web/packages/subincomeR/index.html) |
| Source record ids | cran_packages_by_date-a9e38990eb1f25 |
...
For a systems engineer, subincomeR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-21 21:00:02 UTC | [https://cran.r-project.org/web/packages/subincomeR/DESCRIPTION](https://cran.r-project.org/web/packages/subincomeR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/subincomeR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a9e38990eb1f25` from `cran_packages_by_date` as `registry_expansion`
