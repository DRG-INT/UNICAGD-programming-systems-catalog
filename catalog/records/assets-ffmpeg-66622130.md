...
| Source record ids | curated_language_routes-55d6b0f03999ed |

## System Engineer Summary

Media processing toolkit for audio/video decoding, encoding, conversion, streaming, metadata, and
asset pipelines.

## Operational Role

For a systems engineer, FFmpeg belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-55d6b0f03999ed` from `curated_language_routes` as `registry_expansion`
