...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kevinmehall/rtlsdr-433m-sensor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kevinmehall/rtlsdr-433m-sensor](https://github.com/kevinmehall/rtlsdr-433m-sensor) |
| Source record ids | github_search_satcom_satellites-04c4d87d7537e7 |
...
For a systems engineer, kevinmehall/rtlsdr-433m-sensor belongs in the SatCom Satellites inventory as
part of confidentiality, integrity, authentication, and key-management risk.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-03-25T21:37:24Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-04c4d87d7537e7` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| pothosware/SoapyRTLSDR | Cryptography | [open](satcom-satellites-pothosware-soapyrtlsdr-262e5cae.md) |
| rtl-airband/RTLSDR-Airband | Cryptography | [open](satcom-satellites-rtl-airband-rtlsdr-airband-1ad0c0a9.md) |
