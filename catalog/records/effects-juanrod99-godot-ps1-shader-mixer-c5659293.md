# Juanrod99/Godot-PS1-Shader-Mixer
...
<!-- canonical: https://github.com/Juanrod99/Godot-PS1-Shader-Mixer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Juanrod99/Godot-PS1-Shader-Mixer](https://github.com/Juanrod99/Godot-PS1-Shader-Mixer) |
| Source record ids | github_search_effects-f963e9239b5539 |

## System Engineer Summary

Visual post-process shader mixer plugin for Godot 4. Mix retro effects in real-time without touching
code.

## Operational Role

For a systems engineer, Juanrod99/Godot-PS1-Shader-Mixer belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T15:09:47Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f963e9239b5539` from `github_search_effects` as `registry_expansion`
