...
<!-- canonical: https://cran.r-project.org/web/packages/themescopeR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/themescopeR/index.html](https://cran.r-project.org/web/packages/themescopeR/index.html) |
| Source record ids | cran_packages_by_date-fccc07f7488fbb |
...
For a systems engineer, themescopeR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-20 14:10:02 UTC | [https://cran.r-project.org/web/packages/themescopeR/DESCRIPTION](https://cran.r-project.org/web/packages/themescopeR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/themescopeR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fccc07f7488fbb` from `cran_packages_by_date` as `registry_expansion`
