...
<!-- canonical: https://luarocks.org/modules/siffiejoe/classy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/siffiejoe/classy](https://luarocks.org/modules/siffiejoe/classy) |
| Source record ids | luarocks_root_manifest-5c7058a3dcfd8c |
...
For a systems engineer, classy belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5c7058a3dcfd8c` from `luarocks_root_manifest` as `registry_expansion`
