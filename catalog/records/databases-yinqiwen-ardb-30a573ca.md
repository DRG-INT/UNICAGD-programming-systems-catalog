...
<!-- canonical: https://github.com/yinqiwen/ardb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yinqiwen/ardb](https://github.com/yinqiwen/ardb) |
| Source record ids | github_search_databases-8959a663754788 |

## System Engineer Summary

A redis protocol compatible nosql, it support multiple storage engines as backend like Google's
LevelDB, Facebook's RocksDB, OpenLDAP's LMDB, PerconaFT, WiredTiger, ForestDB.

## Operational Role

For a systems engineer, yinqiwen/ardb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-12T01:20:52Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-8959a663754788` from `github_search_databases` as `registry_expansion`
