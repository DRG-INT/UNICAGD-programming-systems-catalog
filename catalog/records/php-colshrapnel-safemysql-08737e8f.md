...
| Canonical URL | [https://packagist.org/packages/colshrapnel/safemysql](https://packagist.org/packages/colshrapnel/safemysql) |
| Source record ids | packagist_search-65f02ba54f92c1 |
...
For a systems engineer, colshrapnel/safemysql belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2025-05-03T08:49:52+00:00 | [https://repo.packagist.org/p2/colshrapnel/safemysql.json](https://repo.packagist.org/p2/colshrapnel/safemysql.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/colshrapnel/safemysql.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-65f02ba54f92c1` from `packagist_search` as `registry_expansion`
