...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/illegalstudio/elephc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/illegalstudio/elephc](https://github.com/illegalstudio/elephc) |
| Source record ids | github_search_assembly-120f3a4181ce4c |

## System Engineer Summary

A PHP-to-native compiler. Takes a subset of PHP - including eval() - and compiles it directly to
native assembly, producing standalone binaries for macOS ARM64, Linux ARM64, and Linux x86_64. No
VM, no external runtime, no dependencies: dynamic eval falls back to an optional statically linked
interpreter.

## Operational Role

For a systems engineer, illegalstudio/elephc belongs in the Assembly inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T00:35:15Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-120f3a4181ce4c` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ClementTsang/rustcc | Compiler | [open](assembly-clementtsang-rustcc-81a87799.md) |
| compiler-explorer/compiler-explorer | Compiler | [open](assembly-compiler-explorer-compiler-explorer-99f6d9ce.md) |
| DQNEO/minigo | Compiler | [open](assembly-dqneo-minigo-2d87e4eb.md) |
| emproof-com/nyxstone | Compiler | [open](assembly-emproof-com-nyxstone-2e6c50f8.md) |
| Fedjmike/mini-c | Compiler | [open](assembly-fedjmike-mini-c-295a2fc0.md) |
| HexHive/retrowrite | Compiler | [open](assembly-hexhive-retrowrite-c7fefa2b.md) |
| joexbayer/RetrOS-32 | Compiler | [open](assembly-joexbayer-retros-32-b6c205a2.md) |
| JustasMasiulis/inline_syscall | Compiler | [open](assembly-justasmasiulis-inline-syscall-0c8a798a.md) |
