...
<!-- canonical: https://github.com/krustlet/krustlet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krustlet/krustlet](https://github.com/krustlet/krustlet) |
| Source record ids | github_search_webassembly-ca8b8e8c621184 |

## System Engineer Summary

krustlet/krustlet is tracked as an undefined behavior analyzer record in the WebAssembly branch. The
...
For a systems engineer, krustlet/krustlet belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-02T18:41:06Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ca8b8e8c621184` from `github_search_webassembly` as `registry_expansion`
...
| ruby/ruby.wasm | Undefined Behavior Analyzer | [open](webassembly-ruby-ruby-wasm-2e017805.md) |
| taubyte/tau | Undefined Behavior Analyzer | [open](webassembly-taubyte-tau-7d97265b.md) |
| therecipe/qt | Undefined Behavior Analyzer | [open](webassembly-therecipe-qt-fd9f7ce6.md) |
