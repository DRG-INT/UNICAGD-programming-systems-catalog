...
<!-- canonical: https://crates.io/crates/system-configuration-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/system-configuration-sys](https://crates.io/crates/system-configuration-sys) |
| Source record ids | crates_io-e3a91719806a71 |
...
For a systems engineer, system-configuration-sys belongs in the Rust inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2024-01-31T13:42:46.487586Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-e3a91719806a71` from `crates_io` as `registry_expansion`
