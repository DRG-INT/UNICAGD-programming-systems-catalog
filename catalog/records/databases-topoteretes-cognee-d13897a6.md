...
<!-- canonical: https://github.com/topoteretes/cognee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/topoteretes/cognee](https://github.com/topoteretes/cognee) |
| Source record ids | github_search_databases-ac2c8f01f5e01f |

## System Engineer Summary

Cognee is the open-source AI memory platform for agents. Give your AI agents persistent long-term
memory across sessions with a self-hosted knowledge graph engine.

## Operational Role

For a systems engineer, topoteretes/cognee belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:24:18Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ac2c8f01f5e01f` from `github_search_databases` as `registry_expansion`
