...
<!-- canonical: https://github.com/artichoke/artichoke -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/artichoke/artichoke](https://github.com/artichoke/artichoke) |
| Source record ids | github_search_webassembly-a301c8a7d6c25d |
...
For a systems engineer, artichoke/artichoke belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-03T02:43:08Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a301c8a7d6c25d` from `github_search_webassembly` as `registry_expansion`
