...
<!-- canonical: https://hackage.haskell.org/package/network-uri -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-uri](https://hackage.haskell.org/package/network-uri) |
| Source record ids | hackage_top_downloads-0997b911467b73 |
...
For a systems engineer, network-uri belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.4.2 | 2022-12-27T01:43:08Z | [https://hackage.haskell.org/package/network-uri](https://hackage.haskell.org/package/network-uri) |  |
| candidate | partial | 2.6.0.2 |  | [https://hackage.haskell.org/package/network-uri](https://hackage.haskell.org/package/network-uri) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-uri` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-0997b911467b73` from `hackage_top_downloads` as `registry_expansion`
