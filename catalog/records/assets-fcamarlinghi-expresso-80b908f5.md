...
<!-- canonical: https://github.com/fcamarlinghi/expresso -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fcamarlinghi/expresso](https://github.com/fcamarlinghi/expresso) |
| Source record ids | github_search_assets-f095f3ca7132bb |

## System Engineer Summary

A Photoshop plugin that lets you quickly channel pack and export textures to common file formats
such as TGA, PNG and TIFF.

## Operational Role

For a systems engineer, fcamarlinghi/expresso belongs in the Assets inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-04T13:44:15Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-f095f3ca7132bb` from `github_search_assets` as `registry_expansion`
