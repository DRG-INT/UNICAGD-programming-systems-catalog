...
<!-- canonical: https://hackage.haskell.org/package/exact-pi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/exact-pi](https://hackage.haskell.org/package/exact-pi) |
| Source record ids | hackage_top_downloads-1214560bac0faf |
...
For a systems engineer, exact-pi belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1.0 | 2026-06-04T23:15:22Z | [https://hackage.haskell.org/package/exact-pi](https://hackage.haskell.org/package/exact-pi) |  |
| candidate | partial | 0.1.2.0 |  | [https://hackage.haskell.org/package/exact-pi](https://hackage.haskell.org/package/exact-pi) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/exact-pi` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-1214560bac0faf` from `hackage_top_downloads` as `registry_expansion`
