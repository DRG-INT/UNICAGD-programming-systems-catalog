# DavidR-21/Space-Shuttle-Reentry-Analysis

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DavidR-21/Space-Shuttle-Reentry-Analysis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DavidR-21/Space-Shuttle-Reentry-Analysis](https://github.com/DavidR-21/Space-Shuttle-Reentry-Analysis) |
| Source record ids | github_search_space_shuttles-74c3651980cc8f |

## System Engineer Summary

ANSYS simulation of space shuttle aerodynamics during high-speed atmospheric reentry.

## Operational Role

For a systems engineer, DavidR-21/Space-Shuttle-Reentry-Analysis belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-17T00:39:17Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-74c3651980cc8f` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN | Static Analyzer | [open](space-shuttles-mizharrrrrhidi1818-outlierdetectionmethod-isolationforest-lof-dbscan-480fa68e.md) |
