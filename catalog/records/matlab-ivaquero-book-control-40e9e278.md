...
<!-- canonical: https://github.com/ivaquero/book-control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ivaquero/book-control](https://github.com/ivaquero/book-control) |
| Source record ids | github_search_matlab-4a4a1c48d2c283 |

## System Engineer Summary

ivaquero/book-control is tracked as a language specification record in the Matlab branch. The source
...
For a systems engineer, ivaquero/book-control belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T02:16:52Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-4a4a1c48d2c283` from `github_search_matlab` as `registry_expansion`
