...
<!-- canonical: https://cran.r-project.org/web/packages/FastHamming/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FastHamming/index.html](https://cran.r-project.org/web/packages/FastHamming/index.html) |
| Source record ids | cran_packages_by_date-1247659c9398eb |
...
For a systems engineer, FastHamming belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3 | 2026-08-21 14:50:07 UTC | [https://cran.r-project.org/web/packages/FastHamming/DESCRIPTION](https://cran.r-project.org/web/packages/FastHamming/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FastHamming/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1247659c9398eb` from `cran_packages_by_date` as `registry_expansion`
