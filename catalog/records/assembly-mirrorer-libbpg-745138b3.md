...
<!-- canonical: https://github.com/mirrorer/libbpg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mirrorer/libbpg](https://github.com/mirrorer/libbpg) |
| Source record ids | github_search_assembly-43f6ceeff5ae7d |
...
For a systems engineer, mirrorer/libbpg belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-30T03:10:24Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-43f6ceeff5ae7d` from `github_search_assembly` as `registry_expansion`
