...
<!-- canonical: http://lua-users.org/wiki/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://lua-users.org/wiki/](http://lua-users.org/wiki/) |
| Source record ids | lua-source-374 |

## System Engineer Summary

A large community-maintained collection of Lua information and resources, supplementing the official
website.

## Operational Role

For a systems engineer, lua-users wiki belongs in the Lua family inventory as part of low-noise code
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 374}}` |
...
- `lua-source-374` from `master_json` as `source_list_item`
