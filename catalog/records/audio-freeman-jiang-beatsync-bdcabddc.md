...
<!-- canonical: https://github.com/freeman-jiang/beatsync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/freeman-jiang/beatsync](https://github.com/freeman-jiang/beatsync) |
| Source record ids | github_search_audio-1d40817435a4c3 |
...
For a systems engineer, freeman-jiang/beatsync belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-12T18:53:27Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-1d40817435a4c3` from `github_search_audio` as `registry_expansion`
