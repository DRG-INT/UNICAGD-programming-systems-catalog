...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/conserto/pomm-symfony-bridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/conserto/pomm-symfony-bridge](https://packagist.org/packages/conserto/pomm-symfony-bridge) |
| Source record ids | packagist_search-669493334e9706 |

## System Engineer Summary

Pomm profiler for Symfony.

## Operational Role

For a systems engineer, conserto/pomm-symfony-bridge belongs in the PHP inventory as part of hot-
...
- `packagist_search-669493334e9706` from `packagist_search` as `registry_expansion`
