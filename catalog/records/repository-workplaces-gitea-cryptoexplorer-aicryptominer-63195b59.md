# Gitea: cryptoexplorer/AICRYPTOMINER
...
<!-- canonical: https://gitea.com/cryptoexplorer/AICRYPTOMINER -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/cryptoexplorer/AICRYPTOMINER](https://gitea.com/cryptoexplorer/AICRYPTOMINER) |
| Source record ids | gitea_repositories_api-e7b1f95c2ebf89 |

## System Engineer Summary

1 choose package 2 make payments 3 Recieve instantly AI CRYPTO MINING SOFTWARE Telegram

## Operational Role

For a systems engineer, Gitea: cryptoexplorer/AICRYPTOMINER belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T03:33:30Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-e7b1f95c2ebf89` from `gitea_repositories_api` as `registry_expansion`
