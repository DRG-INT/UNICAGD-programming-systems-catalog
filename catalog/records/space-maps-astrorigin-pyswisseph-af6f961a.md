...
<!-- canonical: https://github.com/astrorigin/pyswisseph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/astrorigin/pyswisseph](https://github.com/astrorigin/pyswisseph) |
| Source record ids | github_search_space_maps-b28efc0d824815 |
...
For a systems engineer, astrorigin/pyswisseph belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-01T08:19:24Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b28efc0d824815` from `github_search_space_maps` as `registry_expansion`
