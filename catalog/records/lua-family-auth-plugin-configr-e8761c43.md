...
<!-- canonical: https://luarocks.org/modules/fr4nca/auth-plugin-configr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fr4nca/auth-plugin-configr](https://luarocks.org/modules/fr4nca/auth-plugin-configr) |
| Source record ids | luarocks_root_manifest-f0d80fb67d838d |
...
For a systems engineer, auth-plugin-configr belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f0d80fb67d838d` from `luarocks_root_manifest` as `registry_expansion`
