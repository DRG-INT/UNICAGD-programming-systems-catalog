# commerce-agentic/agentic-commerce-tools
...
<!-- canonical: https://github.com/commerce-agentic/agentic-commerce-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/commerce-agentic/agentic-commerce-tools](https://github.com/commerce-agentic/agentic-commerce-tools) |
| Source record ids | github_search_repertoare_catalogs-c8d3df101a5741 |

## System Engineer Summary

CLI + SDK for the agentic-commerce spec: score any product/catalog, run audits, generate reports —
programmatically.

## Operational Role

For a systems engineer, commerce-agentic/agentic-commerce-tools belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T23:31:54Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-c8d3df101a5741` from `github_search_repertoare_catalogs` as `registry_expansion`
