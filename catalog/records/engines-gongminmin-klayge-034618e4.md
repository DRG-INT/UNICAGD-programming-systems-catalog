...
| Source record ids | github_search_engines-8aadd72a75e6c9 |
...
For a systems engineer, gongminmin/KlayGE belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-17T23:08:59Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-8aadd72a75e6c9` from `github_search_engines` as `registry_expansion`
