...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/octave_php_wrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/octave_php_wrapper](https://gnu-octave.github.io/packages/octave_php_wrapper) |
| Source record ids | octave_packages_index-4d7f89cb7ea813 |

## System Engineer Summary

The octave_php_wrapper package creates a PHP wrapper for Octave script, so that you can run the
Octave script by PHP, like modern Internet service.

## Operational Role

For a systems engineer, octave_php_wrapper belongs in the Octave inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-05-22 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-4d7f89cb7ea813` from `octave_packages_index` as `registry_expansion`
