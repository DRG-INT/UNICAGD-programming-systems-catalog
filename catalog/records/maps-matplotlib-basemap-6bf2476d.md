...
<!-- canonical: https://github.com/matplotlib/basemap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matplotlib/basemap](https://github.com/matplotlib/basemap) |
| Source record ids | github_search_maps-27cd3a59890f2f |
...
For a systems engineer, matplotlib/basemap belongs in the Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-04T11:17:03Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-27cd3a59890f2f` from `github_search_maps` as `registry_expansion`
