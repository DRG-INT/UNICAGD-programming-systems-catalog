...
<!-- canonical: https://cran.r-project.org/web/packages/RTMBdist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RTMBdist/index.html](https://cran.r-project.org/web/packages/RTMBdist/index.html) |
| Source record ids | cran_packages_by_date-34fa952d259f1f |
...
For a systems engineer, RTMBdist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2026-08-21 06:40:08 UTC | [https://cran.r-project.org/web/packages/RTMBdist/DESCRIPTION](https://cran.r-project.org/web/packages/RTMBdist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RTMBdist/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-34fa952d259f1f` from `cran_packages_by_date` as `registry_expansion`
