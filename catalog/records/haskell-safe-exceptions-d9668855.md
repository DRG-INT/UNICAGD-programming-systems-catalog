...
<!-- canonical: https://hackage.haskell.org/package/safe-exceptions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/safe-exceptions](https://hackage.haskell.org/package/safe-exceptions) |
| Source record ids | hackage_top_downloads-da2d230a306357 |
...
For a systems engineer, safe-exceptions belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7.4 | 2023-06-26T17:37:36Z | [https://hackage.haskell.org/package/safe-exceptions](https://hackage.haskell.org/package/safe-exceptions) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/safe-exceptions` at `2026-09-02T00:32:51+00:00`.
...
- `hackage_top_downloads-da2d230a306357` from `hackage_top_downloads` as `registry_expansion`
