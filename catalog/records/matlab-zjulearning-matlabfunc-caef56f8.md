...
<!-- canonical: https://github.com/ZJULearning/MatlabFunc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZJULearning/MatlabFunc](https://github.com/ZJULearning/MatlabFunc) |
| Source record ids | github_search_matlab-77a6e7207a39b2 |
...
For a systems engineer, ZJULearning/MatlabFunc belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-02T15:25:17Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-77a6e7207a39b2` from `github_search_matlab` as `registry_expansion`
