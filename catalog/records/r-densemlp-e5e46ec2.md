...
<!-- canonical: https://cran.r-project.org/web/packages/densemlp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/densemlp/index.html](https://cran.r-project.org/web/packages/densemlp/index.html) |
| Source record ids | cran_packages_by_date-b474b275da1efc |

## System Engineer Summary

Dense Neural Networks for Tabular Regression, Classification and Survival

## Operational Role

For a systems engineer, densemlp belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-09-01 08:30:19 UTC | [https://cran.r-project.org/web/packages/densemlp/DESCRIPTION](https://cran.r-project.org/web/packages/densemlp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/densemlp/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-b474b275da1efc` from `cran_packages_by_date` as `registry_expansion`
...
| dynamicmultiplex | Networking Http | [open](r-dynamicmultiplex-8f3db7f3.md) |
