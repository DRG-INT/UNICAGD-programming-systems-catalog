# sandro.lechner/aula-devops-fundamentals
...
| Canonical URL | [https://gitlab.com/sandro.lechner/aula-devops-fundamentals](https://gitlab.com/sandro.lechner/aula-devops-fundamentals) |
| Source record ids | gitlab_projects_api-403c4c21817a5d |
...
For a systems engineer, sandro.lechner/aula-devops-fundamentals belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T02:50:40.429Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-403c4c21817a5d` from `gitlab_projects_api` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| nb-tech-support/devops | Library | [open](repository-workplaces-nb-tech-support-devops-42f3c6a9.md) |
