...
<!-- canonical: https://pypi.org/project/acidcli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acidcli/](https://pypi.org/project/acidcli/) |
| Source record ids | pypi_simple-a34c23b54e6a59 |
...
For a systems engineer, acidcli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.14.0 | 2024-03-12T11:38:50.342646Z | [https://pypi.org/pypi/acidcli/json](https://pypi.org/pypi/acidcli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acidcli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-a34c23b54e6a59` from `pypi_simple` as `registry_expansion`
