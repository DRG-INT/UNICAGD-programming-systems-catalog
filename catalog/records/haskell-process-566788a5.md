...
<!-- canonical: https://hackage.haskell.org/package/process -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/process](https://hackage.haskell.org/package/process) |
| Source record ids | hackage_top_downloads-92668334a3c492 |
...
For a systems engineer, process belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.30.0 | 2026-06-11T10:14:20Z | [https://hackage.haskell.org/package/process](https://hackage.haskell.org/package/process) |  |
| candidate | partial | 1.2.1.0 |  | [https://hackage.haskell.org/package/process](https://hackage.haskell.org/package/process) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/process` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-92668334a3c492` from `hackage_top_downloads` as `registry_expansion`
