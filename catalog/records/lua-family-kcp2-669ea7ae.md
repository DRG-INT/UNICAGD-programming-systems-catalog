...
| Canonical URL | [https://luarocks.org/modules/chensoft/kcp2](https://luarocks.org/modules/chensoft/kcp2) |
| Source record ids | luarocks_root_manifest-0a9e28fe441619 |

## System Engineer Summary

Lua bindings for KCP (Dual channel version)

## Operational Role

For a systems engineer, kcp2 belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-0a9e28fe441619` from `luarocks_root_manifest` as `registry_expansion`
