...
<!-- canonical: https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Abstractions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Abstractions](https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Abstractions) |
| Source record ids | nuget_search-25874843088931 |

## System Engineer Summary

ASP.NET Core HTTP object model for HTTP requests and responses and also common extension methods for
registering middleware in an IApplicationBuilder. Commonly used types:
Microsoft.AspNetCore.Builder.IApplicationBuilder Microsoft.AspNetCore.Http.HttpContext
Microsoft.AspNetCore.Http.HttpRequest Microsoft.AspNetCore.Http.HttpResponse

## Operational Role

For a systems engineer, Microsoft.AspNetCore.Http.Abstractions belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.12 | 2026-08-11T17:15:54.63+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.abstractions/index.json) |  |
| preview | known | 2.2.0-preview3-35497 | 2018-10-17T15:16:53.527+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.abstractions/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.abstractions/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-25874843088931` from `nuget_search` as `registry_expansion`
