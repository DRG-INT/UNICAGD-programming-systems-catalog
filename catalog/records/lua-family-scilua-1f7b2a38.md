...
| Canonical URL | [http://scilua.org/](http://scilua.org/) |
| Source record ids | lua-source-240 |
...
For a systems engineer, SciLua belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 240}}` |
...
- `lua-source-240` from `master_json` as `source_list_item`
