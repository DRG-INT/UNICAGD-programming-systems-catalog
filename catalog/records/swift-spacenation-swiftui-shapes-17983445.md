...
<!-- canonical: https://github.com/spacenation/swiftui-shapes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spacenation/swiftui-shapes](https://github.com/spacenation/swiftui-shapes) |
| Source record ids | github_search_swift-924f1d36482bc8 |
...
For a systems engineer, spacenation/swiftui-shapes belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-01T06:53:07Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-924f1d36482bc8` from `github_search_swift` as `registry_expansion`
