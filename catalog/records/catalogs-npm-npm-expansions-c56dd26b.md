...
<!-- canonical: https://github.com/npm/npm-expansions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/npm/npm-expansions](https://github.com/npm/npm-expansions) |
| Source record ids | github_search_catalogs-d814278a43cf9e |
...
For a systems engineer, npm/npm-expansions belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-12T17:40:20Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-d814278a43cf9e` from `github_search_catalogs` as `registry_expansion`
