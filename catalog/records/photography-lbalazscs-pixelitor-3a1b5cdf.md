...
| Canonical URL | [https://github.com/lbalazscs/Pixelitor](https://github.com/lbalazscs/Pixelitor) |
| Source record ids | github_search_photography-193ef61febfa7a |

## System Engineer Summary

lbalazscs/Pixelitor is tracked as an ide editor integration record in the Photography branch. The
...
For a systems engineer, lbalazscs/Pixelitor belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.3.1 | 2023-09-06T12:09:31Z | [https://api.github.com/repos/lbalazscs/Pixelitor/releases/latest](https://api.github.com/repos/lbalazscs/Pixelitor/releases/latest) |  |
| preview | known | v4.3.0-beta4 | 2021-06-06T19:19:46Z | [https://api.github.com/repos/lbalazscs/Pixelitor/releases?per_page=10](https://api.github.com/repos/lbalazscs/Pixelitor/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lbalazscs/Pixelitor/releases/latest` at `2026-09-01T09:23:31+00:00`.
...
- `github_search_photography-193ef61febfa7a` from `github_search_photography` as `registry_expansion`
