...
<!-- canonical: https://github.com/ian-chuang/homestri-ur5e-rl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ian-chuang/homestri-ur5e-rl](https://github.com/ian-chuang/homestri-ur5e-rl) |
| Source record ids | github_search_space_maps-96f175b9243752 |

## System Engineer Summary

A Mujoco Gymnasium Environment for manipulating flexible objects with a UR5e robot arm and Robotiq
2F-85 gripper. Experiment with joint effort, velocity, position, and operational space controllers.
Teleoperate in task space and visualize in GUI. Note: Experimental, not actively maintained.

## Operational Role

For a systems engineer, ian-chuang/homestri-ur5e-rl belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-26T05:12:56Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-96f175b9243752` from `github_search_space_maps` as `registry_expansion`
