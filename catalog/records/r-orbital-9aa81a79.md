...
<!-- canonical: https://cran.r-project.org/web/packages/orbital/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/orbital/index.html](https://cran.r-project.org/web/packages/orbital/index.html) |
| Source record ids | cran_packages_by_date-c4eb0cf3f1241e |
...
For a systems engineer, orbital belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-09-04 18:40:02 UTC | [https://cran.r-project.org/web/packages/orbital/DESCRIPTION](https://cran.r-project.org/web/packages/orbital/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/orbital/DESCRIPTION` at `2026-09-04T20:19:05+00:00`.
...
- `cran_packages_by_date-c4eb0cf3f1241e` from `cran_packages_by_date` as `registry_expansion`
