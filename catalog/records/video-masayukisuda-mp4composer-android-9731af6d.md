...
| Canonical URL | [https://github.com/MasayukiSuda/Mp4Composer-android](https://github.com/MasayukiSuda/Mp4Composer-android) |
| Source record ids | github_search_video-4a6a6fd614918d |

## System Engineer Summary

This library generate an Mp4 movie using Android MediaCodec API and apply filter, scale, trim,
transcode, crop, timeScale, mute and rotate Mp4.

## Operational Role

For a systems engineer, MasayukiSuda/Mp4Composer-android belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.1 | 2020-11-25T15:32:02Z | [https://api.github.com/repos/MasayukiSuda/Mp4Composer-android/releases/latest](https://api.github.com/repos/MasayukiSuda/Mp4Composer-android/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/MasayukiSuda/Mp4Composer-android/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-4a6a6fd614918d` from `github_search_video` as `registry_expansion`
