...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Taiizor/Sucrose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Taiizor/Sucrose](https://github.com/Taiizor/Sucrose) |
| Source record ids | github_search_engines-7fae0dfb566da9 |

## System Engineer Summary

Sucrose is a versatile wallpaper engine that brings life to your desktop with a wide range of
interactive wallpapers.

## Operational Role

For a systems engineer, Taiizor/Sucrose belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:49:52Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-7fae0dfb566da9` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| angular/flex-layout | Ide Editor Integration | [open](engines-angular-flex-layout-0d4c34f1.md) |
| DCurrent/openbor | Ide Editor Integration | [open](engines-dcurrent-openbor-b2f937dc.md) |
| diffusionstudio/core | Ide Editor Integration | [open](engines-diffusionstudio-core-f4da22be.md) |
| Kavex/GameDev-Resources | Ide Editor Integration | [open](engines-kavex-gamedev-resources-4235373d.md) |
