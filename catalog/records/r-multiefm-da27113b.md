...
<!-- canonical: https://cran.r-project.org/web/packages/MultiEFM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MultiEFM/index.html](https://cran.r-project.org/web/packages/MultiEFM/index.html) |
| Source record ids | cran_packages_by_date-724bea9c0acd23 |

## System Engineer Summary

Robust Estimation for Multi-Study High-Dimensional Elliptical Factor Analytics

## Operational Role

For a systems engineer, MultiEFM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-04 14:00:14 UTC | [https://cran.r-project.org/web/packages/MultiEFM/DESCRIPTION](https://cran.r-project.org/web/packages/MultiEFM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MultiEFM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-724bea9c0acd23` from `cran_packages_by_date` as `registry_expansion`
