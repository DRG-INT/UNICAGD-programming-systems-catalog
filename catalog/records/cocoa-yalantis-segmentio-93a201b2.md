...
<!-- canonical: https://github.com/Yalantis/Segmentio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Yalantis/Segmentio](https://github.com/Yalantis/Segmentio) |
| Source record ids | github_search_cocoa-831441c987ea40 |
...
For a systems engineer, Yalantis/Segmentio belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-12T05:33:14Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-831441c987ea40` from `github_search_cocoa` as `registry_expansion`
