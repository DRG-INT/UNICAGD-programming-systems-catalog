...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/indeedeng/iwf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/indeedeng/iwf](https://github.com/indeedeng/iwf) |
| Source record ids | github_search_engines-2df64870089237 |

## System Engineer Summary

iWF is a Workflow-As-Code microservice orchestration platform offering an orchestration coding
framework and service for building resilient, fault-tolerant, scalable long-running processes

## Operational Role

For a systems engineer, indeedeng/iwf belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T20:35:58Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-2df64870089237` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/linkis | Build System | [open](engines-apache-linkis-1bb43df6.md) |
| coleam00/Archon | Build System | [open](engines-coleam00-archon-97afd7f0.md) |
| htrgouvea/nipe | Build System | [open](engines-htrgouvea-nipe-7b17d400.md) |
| iflytek/astron-agent | Build System | [open](engines-iflytek-astron-agent-1e4ac383.md) |
| openworkflowdev/openworkflow | Build System | [open](engines-openworkflowdev-openworkflow-a0dc9058.md) |
| PrefectHQ/prefect | Build System | [open](engines-prefecthq-prefect-f0cf37e4.md) |
| radek-sprta/awesome-game-remakes | Build System | [open](engines-radek-sprta-awesome-game-remakes-4efb542f.md) |
| restatedev/restate | Build System | [open](engines-restatedev-restate-d920b728.md) |
