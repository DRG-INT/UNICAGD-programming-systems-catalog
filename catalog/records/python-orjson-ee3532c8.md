...
| Source record ids | corpus-be0494c6d4dba6 |

## System Engineer Summary

orjson is tracked as a serialization record in the Python branch. The source did not provide a long
...
For a systems engineer, orjson belongs in the Python inventory as part of wire formats, persistence,
...
- `corpus-be0494c6d4dba6` from `master_json` as `serialization`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cattrs | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-cattrs-b47723ef.md) |
| marshmallow | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-marshmallow-54783186.md) |
| msgpack-python | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-msgpack-python-0137da9c.md) |
| PyYAML | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pyyaml-028b0d7f.md) |
| tomli | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-tomli-af5ddd21.md) |
| tomllib | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-tomllib-2881d496.md) |
