# gitlab-examples/ruby-autodeploy
...
<!-- canonical: https://gitlab.com/gitlab-examples/ruby-autodeploy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-examples/ruby-autodeploy](https://gitlab.com/gitlab-examples/ruby-autodeploy) |
| Source record ids | gitlab_projects_api-18669d7cc7c6d8 |

## System Engineer Summary

Ruby project configured to use GitLab Auto Deploy feature with Kubernetes

## Operational Role

For a systems engineer, gitlab-examples/ruby-autodeploy belongs in the Repository Workplaces
...
- `gitlab_projects_api-18669d7cc7c6d8` from `gitlab_projects_api` as `registry_expansion`
