...
<!-- canonical: https://crates.io/crates/js-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/js-sys](https://crates.io/crates/js-sys) |
| Source record ids | crates_io-8039900032387a |

## System Engineer Summary

Bindings for all JS global objects and functions in all JS environments like Node.js and browsers,
built on `#wasm_bindgen` using the `wasm-bindgen` crate.

## Operational Role

For a systems engineer, js-sys belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.104 | 2026-08-08T00:57:01.489848Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-8039900032387a` from `crates_io` as `registry_expansion`
