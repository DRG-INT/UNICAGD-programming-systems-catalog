...
<!-- canonical: https://cran.r-project.org/web/packages/schwabr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/schwabr/index.html](https://cran.r-project.org/web/packages/schwabr/index.html) |
| Source record ids | cran_packages_by_date-3c24b6b33b936f |

## System Engineer Summary

schwabr is tracked as an api abi checker record in the R branch. The source did not provide a long
...
For a systems engineer, schwabr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-21 15:30:02 UTC | [https://cran.r-project.org/web/packages/schwabr/DESCRIPTION](https://cran.r-project.org/web/packages/schwabr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/schwabr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3c24b6b33b936f` from `cran_packages_by_date` as `registry_expansion`
