...
<!-- canonical: https://github.com/ChillingVan/android-openGL-canvas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChillingVan/android-openGL-canvas](https://github.com/ChillingVan/android-openGL-canvas) |
| Source record ids | github_search_photography-cd2b1231822c16 |

## System Engineer Summary

An Android library that provides views using openGL canvas to draw things on SurfaceView or
TextureView.

## Operational Role

For a systems engineer, ChillingVan/android-openGL-canvas belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-02T19:55:50Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-cd2b1231822c16` from `github_search_photography` as `registry_expansion`
