...
<!-- canonical: https://github.com/AlexeyPechnikov/pygmtsar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlexeyPechnikov/pygmtsar](https://github.com/AlexeyPechnikov/pygmtsar) |
| Source record ids | github_search_radars-5a364a42eabde7 |
...
For a systems engineer, AlexeyPechnikov/pygmtsar belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T12:40:34Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-5a364a42eabde7` from `github_search_radars` as `registry_expansion`
