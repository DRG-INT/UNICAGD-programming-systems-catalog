...
<!-- canonical: https://github.com/ffAudio/Frequalizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ffAudio/Frequalizer](https://github.com/ffAudio/Frequalizer) |
| Source record ids | github_search_audio-3e66ad3e0d35c5 |
...
For a systems engineer, ffAudio/Frequalizer belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-07T15:34:00Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-3e66ad3e0d35c5` from `github_search_audio` as `registry_expansion`
