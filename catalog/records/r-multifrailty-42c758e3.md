...
<!-- canonical: https://cran.r-project.org/web/packages/MultiFrailty/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MultiFrailty/index.html](https://cran.r-project.org/web/packages/MultiFrailty/index.html) |
| Source record ids | cran_packages_by_date-ce666855ffcf66 |

## System Engineer Summary

Shared Frailty Regression Models with Inverse Gaussian, Generalized Lindley, and Gamma Frailty
Distributions

## Operational Role

For a systems engineer, MultiFrailty belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 19:40:06 UTC | [https://cran.r-project.org/web/packages/MultiFrailty/DESCRIPTION](https://cran.r-project.org/web/packages/MultiFrailty/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MultiFrailty/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ce666855ffcf66` from `cran_packages_by_date` as `registry_expansion`
