...
<!-- canonical: https://github.com/evgeny-nadymov/telegram-react -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/evgeny-nadymov/telegram-react](https://github.com/evgeny-nadymov/telegram-react) |
| Source record ids | github_search_webassembly-259f1fcbdb5e6e |
...
For a systems engineer, evgeny-nadymov/telegram-react belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-23T05:45:20Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-259f1fcbdb5e6e` from `github_search_webassembly` as `registry_expansion`
