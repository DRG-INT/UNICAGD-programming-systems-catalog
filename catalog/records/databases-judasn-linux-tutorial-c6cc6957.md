...
<!-- canonical: https://github.com/judasn/Linux-Tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/judasn/Linux-Tutorial](https://github.com/judasn/Linux-Tutorial) |
| Source record ids | github_search_databases-8387a6ef550db7 |

## System Engineer Summary

judasn/Linux-Tutorial is tracked as a database datastore record in the Databases branch. The source
...
For a systems engineer, judasn/Linux-Tutorial belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-11T07:40:03Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-8387a6ef550db7` from `github_search_databases` as `registry_expansion`
