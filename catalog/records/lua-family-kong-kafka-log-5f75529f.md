...
| Canonical URL | [https://luarocks.org/modules/optum-ross/kong-kafka-log](https://luarocks.org/modules/optum-ross/kong-kafka-log) |
| Source record ids | luarocks_root_manifest-f53b32ac2701a2 |
...
For a systems engineer, kong-kafka-log belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f53b32ac2701a2` from `luarocks_root_manifest` as `registry_expansion`
