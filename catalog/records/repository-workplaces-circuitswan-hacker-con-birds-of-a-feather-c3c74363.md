# CircuitSwan/hacker-con-birds-of-a-feather

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/CircuitSwan/hacker-con-birds-of-a-feather -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/CircuitSwan/hacker-con-birds-of-a-feather](https://gitlab.com/CircuitSwan/hacker-con-birds-of-a-feather) |
| Source record ids | gitlab_projects_api-d78c9554caafba |

## System Engineer Summary

This repository is mean to aggregate events for specific hacker conferences (also known as
information security conferences) and group them by interest based on activity, identity, or
experiences. This will hopefully enable people to find events.

## Operational Role

For a systems engineer, CircuitSwan/hacker-con-birds-of-a-feather belongs in the Repository
Workplaces inventory as part of low-noise code review, style consistency, and automation-friendly
editing.
...
- `gitlab_projects_api-d78c9554caafba` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alasca.cloud/tarook/tarook | Formatter | [open](repository-workplaces-alasca-cloud-tarook-tarook-a7045027.md) |
| Gitea: deathrashed/Icons | Formatter | [open](repository-workplaces-gitea-deathrashed-icons-f8903c51.md) |
| gitlab-org/cves | Formatter | [open](repository-workplaces-gitlab-org-cves-82f80fbe.md) |
| guided-explorations/aws/cloudformation/cloudformation-deploy | Formatter | [open](repository-workplaces-guided-explorations-aws-cloudformation-cloudformation-deploy-2aca98f3.md) |
| libosinfo/osinfo-db | Formatter | [open](repository-workplaces-libosinfo-osinfo-db-c5e44ee6.md) |
| Screwtapello/isa65xx | Formatter | [open](repository-workplaces-screwtapello-isa65xx-d8b56520.md) |
