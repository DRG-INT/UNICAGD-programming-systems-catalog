...
<!-- canonical: https://cran.r-project.org/web/packages/episensr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/episensr/index.html](https://cran.r-project.org/web/packages/episensr/index.html) |
| Source record ids | cran_packages_by_date-556aa4f6ba0e60 |
...
For a systems engineer, episensr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-28 13:30:02 UTC | [https://cran.r-project.org/web/packages/episensr/DESCRIPTION](https://cran.r-project.org/web/packages/episensr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/episensr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-556aa4f6ba0e60` from `cran_packages_by_date` as `registry_expansion`
