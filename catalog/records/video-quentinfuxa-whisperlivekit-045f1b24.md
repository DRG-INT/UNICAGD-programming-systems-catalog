...
<!-- canonical: https://github.com/QuentinFuxa/WhisperLiveKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/QuentinFuxa/WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit) |
| Source record ids | github_search_video-99cce96dc9cd12 |

## System Engineer Summary

Real-time, local speech-to-text with streaming ASR, speaker diarization, translation, and
OpenAI/Deepgram-compatible APIs.

## Operational Role

For a systems engineer, QuentinFuxa/WhisperLiveKit belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T04:27:43Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-99cce96dc9cd12` from `github_search_video` as `registry_expansion`
