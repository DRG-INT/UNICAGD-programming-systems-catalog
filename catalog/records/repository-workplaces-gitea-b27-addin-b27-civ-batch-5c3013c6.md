...
<!-- canonical: https://gitea.com/B27_ADDIN/B27_CIV_BATCH -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/B27_ADDIN/B27_CIV_BATCH](https://gitea.com/B27_ADDIN/B27_CIV_BATCH) |
| Source record ids | gitea_repositories_api-b6c8b7a61409cd |
...
For a systems engineer, Gitea: B27_ADDIN/B27_CIV_BATCH belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-24T15:59:54Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-b6c8b7a61409cd` from `gitea_repositories_api` as `registry_expansion`
