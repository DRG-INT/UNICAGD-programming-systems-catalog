...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Lint Rule Pack](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/lint-rule-pack.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChainRules](https://github.com/JuliaRegistries/General/tree/master/C/ChainRules) |
| Source record ids | julia_general-ee927baa119765 |

## System Engineer Summary

Julia package registered in General at C/ChainRules.

## Operational Role

For a systems engineer, ChainRules belongs in the Julia inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| ARules | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arules-2e2da57f.md) |
| ChainRulesCore | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chainrulescore-1171c427.md) |
| ChainRulesOverloadGeneration | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chainrulesoverloadgeneration-2a2b300c.md) |
| ChainRulesTestUtils | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chainrulestestutils-fa00223b.md) |
