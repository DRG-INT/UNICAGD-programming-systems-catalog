...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/C/ChainRules -->
<!-- crawl-delay: 10 -->
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; https://www.nuget.org/packages/Newtonsoft.Json.Schema/4.0.1/license |
...
| Name | Category | Page |
| --- | --- | --- |
| ARules | Lint Rule Pack | [open](julia-arules-2e2da57f.md) |
| ChainRulesCore | Lint Rule Pack | [open](julia-chainrulescore-1171c427.md) |
| ChainRulesOverloadGeneration | Lint Rule Pack | [open](julia-chainrulesoverloadgeneration-2a2b300c.md) |
| ChainRulesTestUtils | Lint Rule Pack | [open](julia-chainrulestestutils-fa00223b.md) |
