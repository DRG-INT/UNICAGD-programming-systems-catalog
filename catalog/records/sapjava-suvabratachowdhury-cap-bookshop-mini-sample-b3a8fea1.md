# SuvabrataChowdhury/cap-bookshop-mini-sample
...
<!-- canonical: https://github.com/SuvabrataChowdhury/cap-bookshop-mini-sample -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SuvabrataChowdhury/cap-bookshop-mini-sample](https://github.com/SuvabrataChowdhury/cap-bookshop-mini-sample) |
| Source record ids | github_search_sapjava-ce009155e0be6c |

## System Engineer Summary

Mini sample for cap bookshop application. It's a mini local forked copy of intended for training.

## Operational Role

For a systems engineer, SuvabrataChowdhury/cap-bookshop-mini-sample belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T12:08:17Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-ce009155e0be6c` from `github_search_sapjava` as `registry_expansion`
