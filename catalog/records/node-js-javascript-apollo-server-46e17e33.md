...
<!-- canonical: https://www.npmjs.com/package/@apollo/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@apollo/server](https://www.npmjs.com/package/@apollo/server) |
| Source record ids | npm_registry-ccd8ed98c0101f |
...
For a systems engineer, @apollo/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.5.1 | 2026-05-05T16:05:58.885Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-ccd8ed98c0101f` from `npm_registry` as `registry_expansion`
