...
<!-- canonical: https://cran.r-project.org/web/packages/casebase/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/casebase/index.html](https://cran.r-project.org/web/packages/casebase/index.html) |
| Source record ids | cran_packages_by_date-b1f16a10adb138 |
...
For a systems engineer, casebase belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.7 | 2026-09-03 17:50:02 UTC | [https://cran.r-project.org/web/packages/casebase/DESCRIPTION](https://cran.r-project.org/web/packages/casebase/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/casebase/DESCRIPTION` at `2026-09-03T18:23:06+00:00`.
...
- `cran_packages_by_date-b1f16a10adb138` from `cran_packages_by_date` as `registry_expansion`
