...
<!-- canonical: https://github.com/snstac/inrcot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/snstac/inrcot](https://github.com/snstac/inrcot) |
| Source record ids | github_search_radars-53921a9ad2195b |
...
For a systems engineer, snstac/inrcot belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-11T00:53:45Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-53921a9ad2195b` from `github_search_radars` as `registry_expansion`
