...
<!-- canonical: https://cran.r-project.org/web/packages/MuPETFlow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MuPETFlow/index.html](https://cran.r-project.org/web/packages/MuPETFlow/index.html) |
| Source record ids | cran_packages_by_date-9ff21189e9bb7d |
...
For a systems engineer, MuPETFlow belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-25 20:50:11 UTC | [https://cran.r-project.org/web/packages/MuPETFlow/DESCRIPTION](https://cran.r-project.org/web/packages/MuPETFlow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MuPETFlow/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9ff21189e9bb7d` from `cran_packages_by_date` as `registry_expansion`
