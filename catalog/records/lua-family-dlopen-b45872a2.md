...
<!-- canonical: https://luarocks.org/modules/mah0x211/dlopen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/dlopen](https://luarocks.org/modules/mah0x211/dlopen) |
| Source record ids | luarocks_root_manifest-b26d9dbe5966ce |
...
For a systems engineer, dlopen belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-b26d9dbe5966ce` from `luarocks_root_manifest` as `registry_expansion`
