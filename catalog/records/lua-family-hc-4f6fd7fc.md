...
| Canonical URL | [https://luarocks.org/modules/vrld/hc](https://luarocks.org/modules/vrld/hc) |
| Source record ids | luarocks_root_manifest-e5487343f4a1fa |
...
For a systems engineer, HC belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e5487343f4a1fa` from `luarocks_root_manifest` as `registry_expansion`
