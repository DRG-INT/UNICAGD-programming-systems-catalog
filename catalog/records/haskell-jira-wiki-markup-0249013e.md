...
<!-- canonical: https://hackage.haskell.org/package/jira-wiki-markup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/jira-wiki-markup](https://hackage.haskell.org/package/jira-wiki-markup) |
| Source record ids | hackage_top_downloads-e102474117fd8b |
...
For a systems engineer, jira-wiki-markup belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2023-03-13T16:43:59Z | [https://hackage.haskell.org/package/jira-wiki-markup](https://hackage.haskell.org/package/jira-wiki-markup) |  |
| candidate | partial | 0.1.1 |  | [https://hackage.haskell.org/package/jira-wiki-markup](https://hackage.haskell.org/package/jira-wiki-markup) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/jira-wiki-markup` at `2026-09-13T00:30:58+00:00`.
...
- `hackage_top_downloads-e102474117fd8b` from `hackage_top_downloads` as `registry_expansion`
