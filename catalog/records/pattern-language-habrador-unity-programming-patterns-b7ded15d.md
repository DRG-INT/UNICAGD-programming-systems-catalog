...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Habrador/Unity-Programming-Patterns -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Pattern language |
| Category | Library |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/Habrador/Unity-Programming-Patterns](https://github.com/Habrador/Unity-Programming-Patterns) |
| Source record ids | github_search_pattern_language-5061a46d43ed81 |
...
For a systems engineer, Habrador/Unity-Programming-Patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T12:37:06Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "design patterns stars:>1000", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_pattern_language-5061a46d43ed81` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 3lf/design-patterns-for-humans | Library | [open](pattern-language-3lf-design-patterns-for-humans-d62cf116.md) |
| AlexanderGrom/go-patterns | Library | [open](pattern-language-alexandergrom-go-patterns-9ab1886f.md) |
| aritraroy/PatternLockView | Library | [open](pattern-language-aritraroy-patternlockview-c5e3f915.md) |
| chuanxshi/javascript-patterns | Library | [open](pattern-language-chuanxshi-javascript-patterns-af9ba9d5.md) |
| DesignPatternsPHP/DesignPatternsPHP | Library | [open](pattern-language-designpatternsphp-designpatternsphp-d6c926d5.md) |
| Devinterview-io/software-architecture-interview-questions | Library | [open](pattern-language-devinterview-io-software-architecture-interview-questions-d0f17ef1.md) |
| dykyi-roman/architecture | Library | [open](pattern-language-dykyi-roman-architecture-981b8b74.md) |
| evoiz/Agentic-Design-Patterns | Library | [open](pattern-language-evoiz-agentic-design-patterns-01a7bf2b.md) |
