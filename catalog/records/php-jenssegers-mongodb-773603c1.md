...
<!-- canonical: https://packagist.org/packages/jenssegers/mongodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jenssegers/mongodb](https://packagist.org/packages/jenssegers/mongodb) |
| Source record ids | packagist_search-be09bd54396e5e |
...
For a systems engineer, jenssegers/mongodb belongs in the PHP inventory as part of build graph
...
- `packagist_search-be09bd54396e5e` from `packagist_search` as `registry_expansion`
