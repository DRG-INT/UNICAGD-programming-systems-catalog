...
<!-- canonical: https://cran.r-project.org/web/packages/epkde/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epkde/index.html](https://cran.r-project.org/web/packages/epkde/index.html) |
| Source record ids | cran_packages_by_date-8d0b9a3d85ec54 |
...
For a systems engineer, epkde belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 13:10:08 UTC | [https://cran.r-project.org/web/packages/epkde/DESCRIPTION](https://cran.r-project.org/web/packages/epkde/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epkde/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-8d0b9a3d85ec54` from `cran_packages_by_date` as `registry_expansion`
