...
| Canonical URL | [https://crates.io/crates/xml5ever](https://crates.io/crates/xml5ever) |
| Source record ids | crates_io-769bbbb0f613e4 |
...
For a systems engineer, xml5ever belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.39.0 | 2026-03-13T16:22:27.511073Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
...
- `crates_io-769bbbb0f613e4` from `crates_io` as `registry_expansion`
