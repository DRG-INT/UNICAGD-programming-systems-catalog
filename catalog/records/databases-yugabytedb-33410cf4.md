...
| Source record ids | curated_database_systems-743c5dd73567ee |

## System Engineer Summary

Distributed SQL database with PostgreSQL-compatible API surface.

## Operational Role

For a systems engineer, YugabyteDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-743c5dd73567ee` from `curated_database_systems` as `registry_expansion`
