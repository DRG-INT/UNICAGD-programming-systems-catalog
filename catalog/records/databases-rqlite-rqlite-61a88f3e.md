...
<!-- canonical: https://github.com/rqlite/rqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rqlite/rqlite](https://github.com/rqlite/rqlite) |
| Source record ids | github_search_databases-75ac936be8e9f6 |

## System Engineer Summary

The lightweight, fault-tolerant database built on SQLite. Designed to keep your data highly
available with minimal effort.

## Operational Role

For a systems engineer, rqlite/rqlite belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T02:39:05Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-75ac936be8e9f6` from `github_search_databases` as `registry_expansion`
