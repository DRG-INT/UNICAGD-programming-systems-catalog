...
<!-- canonical: https://github.com/artembobkin/ImmersiveMap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/artembobkin/ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) |
| Source record ids | github_search_maps-37f9acb79cb16e |

## System Engineer Summary

Native Swift 6 + Metal map rendering engine for SwiftUI. Globe and flat vector-tile maps with
labels, SwiftUI markers and avatars, on iOS and macOS.

## Operational Role

For a systems engineer, artembobkin/ImmersiveMap belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T08:18:05Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-37f9acb79cb16e` from `github_search_maps` as `registry_expansion`
