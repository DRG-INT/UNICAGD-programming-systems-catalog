...
<!-- canonical: https://github.com/Frikallo/SonicSynth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Frikallo/SonicSynth](https://github.com/Frikallo/SonicSynth) |
| Source record ids | github_search_effects-4f9827ebc110d1 |

## System Engineer Summary

SonicSynth is an audio synthesis library that provides a high-level interface for generating and
manipulating various types of sounds. It allows users to create custom sound waves, apply digital
signal processing (DSP) effects, and export the synthesized audio data to various audio file
formats.

## Operational Role

For a systems engineer, Frikallo/SonicSynth belongs in the Effects inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-19T05:38:57Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-4f9827ebc110d1` from `github_search_effects` as `registry_expansion`
