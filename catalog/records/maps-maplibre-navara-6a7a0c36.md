...
<!-- canonical: https://github.com/maplibre/navara -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/navara](https://github.com/maplibre/navara) |
| Source record ids | github_search_maps-b344de6319944a |
...
For a systems engineer, maplibre/navara belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T07:50:07Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b344de6319944a` from `github_search_maps` as `registry_expansion`
