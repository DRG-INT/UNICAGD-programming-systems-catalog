...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Jasonnor/Car-Simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jasonnor/Car-Simulator](https://github.com/Jasonnor/Car-Simulator) |
| Source record ids | github_search_effects-27f051aaeeca3f |

## System Engineer Summary

Autonomous car simulator (based on JavaScript & WebGL) implemented by fuzzy control system, genetic
algorithm and particle swarm optimization.

## Operational Role

For a systems engineer, Jasonnor/Car-Simulator belongs in the Effects inventory as part of input-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-06-27T11:41:55Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-27f051aaeeca3f` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gabrielegilardi/ANFIS | Fuzzer | [open](effects-gabrielegilardi-anfis-e8a3ae4d.md) |
