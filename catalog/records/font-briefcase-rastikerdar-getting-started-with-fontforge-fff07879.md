# rastikerdar/getting-started-with-fontforge
...
<!-- canonical: https://github.com/rastikerdar/getting-started-with-fontforge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rastikerdar/getting-started-with-fontforge](https://github.com/rastikerdar/getting-started-with-fontforge) |
| Source record ids | github_search_font_briefcase-613639b8a0dff4 |
...
For a systems engineer, rastikerdar/getting-started-with-fontforge belongs in the Font Briefcase
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-12T06:09:14Z | gh search repos topic:fontforge stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-613639b8a0dff4` from `github_search_font_briefcase` as `registry_expansion`
