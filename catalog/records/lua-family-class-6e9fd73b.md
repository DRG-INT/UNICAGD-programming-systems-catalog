...
<!-- canonical: https://luarocks.org/modules/javalikescript/class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/javalikescript/class](https://luarocks.org/modules/javalikescript/class) |
| Source record ids | luarocks_root_manifest-0a6a8128521b3e |
...
For a systems engineer, class belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0a6a8128521b3e` from `luarocks_root_manifest` as `registry_expansion`
