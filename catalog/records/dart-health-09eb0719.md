...
<!-- canonical: https://pub.dev/packages/health -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/health](https://pub.dev/packages/health) |
| Source record ids | pub_dev-5771ebfa6b48fe |
...
For a systems engineer, health belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.3.2 | 2026-08-14T13:04:10.425286Z | [https://pub.dev/api/packages/health](https://pub.dev/api/packages/health) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/health` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-5771ebfa6b48fe` from `pub_dev` as `registry_expansion`
