...
| Canonical URL | [https://github.com/computational-cell-analytics/micro-sam](https://github.com/computational-cell-analytics/micro-sam) |
| Source record ids | github_search_microscopy-a85f4155a266e7 |
...
For a systems engineer, computational-cell-analytics/micro-sam belongs in the Microscopy inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.8.12 | 2026-08-26T12:39:12Z | [https://api.github.com/repos/computational-cell-analytics/micro-sam/releases/latest](https://api.github.com/repos/computational-cell-analytics/micro-sam/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/computational-cell-analytics/micro-sam/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-a85f4155a266e7` from `github_search_microscopy` as `registry_expansion`
