...
| Source record ids | corpus-a781077fa73bd2 |

## System Engineer Summary

Luxon is tracked as an utility library record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Luxon belongs in the Node.js/JavaScript inventory as part of ecosystem
...
- `corpus-a781077fa73bd2` from `master_json` as `utility_library`
