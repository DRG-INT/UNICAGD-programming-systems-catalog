...
<!-- canonical: https://github.com/coltongriffith/fluenticons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coltongriffith/fluenticons](https://github.com/coltongriffith/fluenticons) |
| Source record ids | github_search_icons_and_logos-5d6416122ce56f |

## System Engineer Summary

Fluenticons is an icon viewer for Microsofts fluent icons, with over 4000 pixel perfect icons in
outlined and solid styles. Download the icons as SVG, PNG, WEBP, Vue component, React Component and
HTML Image.

## Operational Role

For a systems engineer, coltongriffith/fluenticons belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-26T15:25:19Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-5d6416122ce56f` from `github_search_icons_and_logos` as `registry_expansion`
