...
<!-- canonical: https://github.com/psviderski/unregistry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psviderski/unregistry](https://github.com/psviderski/unregistry) |
| Source record ids | github_search_catalogs-2dbe3a6381ef89 |
...
For a systems engineer, psviderski/unregistry belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T02:56:03Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-2dbe3a6381ef89` from `github_search_catalogs` as `registry_expansion`
