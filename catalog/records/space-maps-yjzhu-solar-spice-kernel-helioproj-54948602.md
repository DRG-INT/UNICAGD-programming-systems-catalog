# yjzhu-solar/spice_kernel_helioproj
...
<!-- canonical: https://github.com/yjzhu-solar/spice_kernel_helioproj -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yjzhu-solar/spice_kernel_helioproj](https://github.com/yjzhu-solar/spice_kernel_helioproj) |
| Source record ids | github_search_space_maps-bf58cb11b7c74c |

## System Engineer Summary

A SPICE Text Frame Kernel (`*.tf`) file for the Earth-centered mirrored helioprojective frame.
Modified from the Solar Orbiter-centered mirror helioprojective frame provided by .

## Operational Role

For a systems engineer, yjzhu-solar/spice_kernel_helioproj belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-30T09:25:39Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bf58cb11b7c74c` from `github_search_space_maps` as `registry_expansion`
