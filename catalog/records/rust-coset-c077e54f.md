...
| Canonical URL | [https://crates.io/crates/coset](https://crates.io/crates/coset) |
| Source record ids | crates_io-b621280fbba215 |
...
For a systems engineer, coset belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-03-02T07:16:55.404609Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-b621280fbba215` from `crates_io` as `registry_expansion`
