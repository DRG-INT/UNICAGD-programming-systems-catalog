...
<!-- canonical: https://www.nuget.org/packages/JsonFlatten -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonFlatten](https://www.nuget.org/packages/JsonFlatten) |
| Source record ids | nuget_search-b4b8dc43c91f39 |

## System Engineer Summary

Extension methods to flatten or unflatten a JSON.NET JObject to or from an IDictionary<string,
object>.

## Operational Role

For a systems engineer, JsonFlatten belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2024-11-21T22:24:31.813+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonflatten/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonflatten/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; https://opensource.org/licenses/MIT |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonflatten/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-b4b8dc43c91f39` from `nuget_search` as `registry_expansion`
