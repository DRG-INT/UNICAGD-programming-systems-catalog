...
<!-- canonical: https://cran.r-project.org/web/packages/tabxplor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tabxplor/index.html](https://cran.r-project.org/web/packages/tabxplor/index.html) |
| Source record ids | cran_packages_by_date-a2a5025afe2680 |
...
For a systems engineer, tabxplor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-29 15:30:08 UTC | [https://cran.r-project.org/web/packages/tabxplor/DESCRIPTION](https://cran.r-project.org/web/packages/tabxplor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tabxplor/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a2a5025afe2680` from `cran_packages_by_date` as `registry_expansion`
