...
<!-- canonical: https://github.com/HKUDS/Vibe-Trading -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) |
| Source record ids | github_search_aims-06064d6a3cab76 |
...
For a systems engineer, HKUDS/Vibe-Trading belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:32:29Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-06064d6a3cab76` from `github_search_aims` as `registry_expansion`
