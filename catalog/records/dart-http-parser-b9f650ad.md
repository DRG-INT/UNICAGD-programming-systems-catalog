...
<!-- canonical: https://pub.dev/packages/http_parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/http_parser](https://pub.dev/packages/http_parser) |
| Source record ids | pub_dev-a24b795856b364 |
...
For a systems engineer, http_parser belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.2 | 2025-01-02T18:37:12.729308Z | [https://pub.dev/api/packages/http_parser](https://pub.dev/api/packages/http_parser) |  |
| preview | known | 4.0.0-nullsafety | 2020-11-06T21:46:01.611836Z | [https://pub.dev/api/packages/http_parser](https://pub.dev/api/packages/http_parser) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/http_parser` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-a24b795856b364` from `pub_dev` as `registry_expansion`
