...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Assembly |
| Category | Language Specification |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/below/HelloSilicon](https://github.com/below/HelloSilicon) |
| Source record ids | github_search_assembly-4aeea5e75a80a1 |
...
For a systems engineer, below/HelloSilicon belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3 | 2022-03-17T13:09:30Z | [https://api.github.com/repos/below/HelloSilicon/releases/latest](https://api.github.com/repos/below/HelloSilicon/releases/latest) |  |
| preview | known | 0.9 | 2020-08-02T19:07:55Z | [https://api.github.com/repos/below/HelloSilicon/releases?per_page=10](https://api.github.com/repos/below/HelloSilicon/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/below/HelloSilicon/releases/latest` at `2026-09-01T12:30:17+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Assembly stars:>500", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_assembly-4aeea5e75a80a1` from `github_search_assembly` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| 100thCoin/AccuracyCoin | Language Specification | [open](assembly-100thcoin-accuracycoin-a8cc820c.md) |
| adriancable/8086tiny | Language Specification | [open](assembly-adriancable-8086tiny-c1d50ad4.md) |
| akkartik/mu | Language Specification | [open](assembly-akkartik-mu-02abed58.md) |
| alvin-tosh/Malware-Exhibit | Language Specification | [open](assembly-alvin-tosh-malware-exhibit-e411e5da.md) |
| apple/swift-crypto | Language Specification | [open](assembly-apple-swift-crypto-1f447802.md) |
| Apress/low-level-programming | Language Specification | [open](assembly-apress-low-level-programming-3b2dd27a.md) |
| aws/aws-lc | Language Specification | [open](assembly-aws-aws-lc-29f8be23.md) |
| bitdump/BLHeli | Language Specification | [open](assembly-bitdump-blheli-5d346476.md) |
