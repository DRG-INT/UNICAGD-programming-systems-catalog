...
<!-- canonical: https://github.com/rzfk2v/Cascade-SDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rzfk2v/Cascade-SDR](https://github.com/rzfk2v/Cascade-SDR) |
| Source record ids | github_search_electromagnetoscopes-70a288e7363af8 |

## System Engineer Summary

Cascade SDR — web SDR for RTL-SDR dongles: live spectrum/waterfall, FM/AM/SSB radio with RDS,
channel scanner, ADS-B, AIS, APRS, ACARS, DAB+, NOAA APT and ISM-band devices (315–915 MHz: weather
sensors, TPMS).

## Operational Role

For a systems engineer, rzfk2v/Cascade-SDR belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T16:08:57Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_electromagnetoscopes-70a288e7363af8` from `github_search_electromagnetoscopes` as `registry_expansion`
