...
| Canonical URL | [https://crates.io/crates/v_frame](https://crates.io/crates/v_frame) |
| Source record ids | crates_io-0285872338e249 |
...
For a systems engineer, v_frame belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-06-20T19:55:49.979294Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-0285872338e249` from `crates_io` as `registry_expansion`
