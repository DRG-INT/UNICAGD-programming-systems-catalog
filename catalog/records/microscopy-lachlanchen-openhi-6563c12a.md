...
<!-- canonical: https://github.com/lachlanchen/OpenHI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lachlanchen/OpenHI](https://github.com/lachlanchen/OpenHI) |
| Source record ids | github_search_microscopy-5015681a52d108 |

## System Engineer Summary

Self‑calibrated neuromorphic hyperspectral imaging pipeline for event cameras with diffractive
illumination. Includes end‑to‑end tools for RAW segmentation, multi‑window time‑warping
compensation, spectral visualization, and hardware control for synchronized event/frame capture and
scanning.

## Operational Role

For a systems engineer, lachlanchen/OpenHI belongs in the Microscopy inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-27T01:39:28Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-5015681a52d108` from `github_search_microscopy` as `registry_expansion`
