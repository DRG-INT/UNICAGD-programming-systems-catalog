# lemonspurple/DIY-Scanning-Tunneling-Microscope
...
| Canonical URL | [https://github.com/lemonspurple/DIY-Scanning-Tunneling-Microscope](https://github.com/lemonspurple/DIY-Scanning-Tunneling-Microscope) |
| Source record ids | github_search_microscopy-901a39a77f8a5c |

## System Engineer Summary

Guide on how to build your own scanning tunneling microscope based on John Alexander's piezo scanner
approach.

## Operational Role

For a systems engineer, lemonspurple/DIY-Scanning-Tunneling-Microscope belongs in the Microscopy
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v.1.0.2 | 2026-06-08T18:08:44Z | [https://api.github.com/repos/lemonspurple/DIY-Scanning-Tunneling-Microscope/releases/latest](https://api.github.com/repos/lemonspurple/DIY-Scanning-Tunneling-Microscope/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lemonspurple/DIY-Scanning-Tunneling-Microscope/releases/latest` at `2026-09-01T08:26:19+00:00`.
...
- `github_search_microscopy-901a39a77f8a5c` from `github_search_microscopy` as `registry_expansion`
