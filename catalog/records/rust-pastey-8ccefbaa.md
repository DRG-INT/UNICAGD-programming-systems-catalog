...
<!-- canonical: https://crates.io/crates/pastey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pastey](https://crates.io/crates/pastey) |
| Source record ids | crates_io-808548ca22d13d |
...
For a systems engineer, pastey belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-05-20T05:43:36.527579Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-808548ca22d13d` from `crates_io` as `registry_expansion`
