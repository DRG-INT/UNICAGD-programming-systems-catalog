...
<!-- canonical: https://crates.io/crates/arrow-arith -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arrow-arith](https://crates.io/crates/arrow-arith) |
| Source record ids | crates_io-f7e593ab173322 |
...
For a systems engineer, arrow-arith belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 59.3.0 | 2026-09-01T10:38:39.568446Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-f7e593ab173322` from `crates_io` as `registry_expansion`
