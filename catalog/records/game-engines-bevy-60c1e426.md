...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Game Engines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/game-engines.md) · [Category: Game Engine Game Dev](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/game-engine-game-dev.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Game Engines |
| Category | Game Engine Game Dev |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/bevyengine/bevy](https://github.com/bevyengine/bevy) |
| Source record ids | curated_language_routes-f0722f20d06a47 |

## System Engineer Summary

Rust ECS game engine with renderer, assets, scenes, input, UI, and plugin architecture.

## Operational Role

For a systems engineer, Bevy belongs in the Game Engines inventory as part of ecosystem capability
...
- Treat category as `game_engine_game_dev` unless a later verified source gives a better classification.
...
- `curated_language_routes-f0722f20d06a47` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Cocos2d-x | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-cocos2d-x-e1a83bf7.md) |
| Defold | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-defold-d45c4b4f.md) |
| Godot Engine | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-godot-engine-a4802128.md) |
| libGDX | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-libgdx-b036892d.md) |
| Love2D | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-love2d-7dc38d2c.md) |
| O3DE | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-o3de-5c2f5359.md) |
| Phaser | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-phaser-b29d3acb.md) |
| Ren'Py | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/game-engines-ren-py-e43fed33.md) |
