...
<!-- canonical: https://cran.r-project.org/web/packages/nmfkc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nmfkc/index.html](https://cran.r-project.org/web/packages/nmfkc/index.html) |
| Source record ids | cran_packages_by_date-0ac3b0a1844e36 |
...
For a systems engineer, nmfkc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.6 | 2026-08-25 11:00:24 UTC | [https://cran.r-project.org/web/packages/nmfkc/DESCRIPTION](https://cran.r-project.org/web/packages/nmfkc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nmfkc/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0ac3b0a1844e36` from `cran_packages_by_date` as `registry_expansion`
