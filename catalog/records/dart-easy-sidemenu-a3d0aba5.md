...
<!-- canonical: https://pub.dev/packages/easy_sidemenu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/easy_sidemenu](https://pub.dev/packages/easy_sidemenu) |
| Source record ids | pub_dev-b540ecb637b19d |
...
For a systems engineer, easy_sidemenu belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-05-21T12:51:28.082550Z | [https://pub.dev/api/packages/easy_sidemenu](https://pub.dev/api/packages/easy_sidemenu) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/easy_sidemenu` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-b540ecb637b19d` from `pub_dev` as `registry_expansion`
