...
<!-- canonical: https://github.com/eug/awesome-opengl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eug/awesome-opengl](https://github.com/eug/awesome-opengl) |
| Source record ids | github_search_computer_graphics_software-02f11e057dfe0e |
...
For a systems engineer, eug/awesome-opengl belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-02f11e057dfe0e` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| baldurk/renderdoc | Debugger | [open](computer-graphics-software-baldurk-renderdoc-af70ef90.md) |
