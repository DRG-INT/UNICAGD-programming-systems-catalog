...
<!-- canonical: https://github.com/dotnetcore/FreeSql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dotnetcore/FreeSql](https://github.com/dotnetcore/FreeSql) |
| Source record ids | github_search_databases-a8e2b72d0fcbf5 |

## System Engineer Summary

.NET aot orm, VB.NET/C# orm, Mysql/PostgreSQL/SqlServer/Oracle orm,
Sqlite/Firebird/Clickhouse/DuckDB orm, 达梦/金仓/虚谷/翰高/高斯 orm, 神通 orm, 南大通用 orm, 国产 orm, TDengine orm,
QuestDB orm, MsAccess orm.

## Operational Role

For a systems engineer, dotnetcore/FreeSql belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T17:52:16Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a8e2b72d0fcbf5` from `github_search_databases` as `registry_expansion`
