...
<!-- canonical: https://pub.dev/packages/flutter_gemma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_gemma](https://pub.dev/packages/flutter_gemma) |
| Source record ids | pub_dev-d105283c5f5ec6 |

## System Engineer Summary

Run Gemma and other LLMs on-device in Flutter (Android, iOS, Web, Desktop). Multimodal vision/audio,
function calling, thinking mode, GPU, embeddings, RAG.

## Operational Role

For a systems engineer, flutter_gemma belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.2 | 2026-09-06T06:54:53.445318Z | [https://pub.dev/api/packages/flutter_gemma](https://pub.dev/api/packages/flutter_gemma) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_gemma` at `2026-09-07T14:20:49+00:00`.
...
- `pub_dev-d105283c5f5ec6` from `pub_dev` as `registry_expansion`
