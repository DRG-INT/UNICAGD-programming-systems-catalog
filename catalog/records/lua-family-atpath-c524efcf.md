...
<!-- canonical: https://luarocks.org/modules/rinkaa/atpath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/rinkaa/atpath](https://luarocks.org/modules/rinkaa/atpath) |
| Source record ids | luarocks_root_manifest-5a6461e980208a |
...
For a systems engineer, atpath belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5a6461e980208a` from `luarocks_root_manifest` as `registry_expansion`
