...
<!-- canonical: https://www.npmjs.com/package/@fluidframework/server-services-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@fluidframework/server-services-client](https://www.npmjs.com/package/@fluidframework/server-services-client) |
| Source record ids | npm_registry-e62ad44010c227 |

## System Engineer Summary

Fluid server isomorphic services for communicating with Fluid

## Operational Role

For a systems engineer, @fluidframework/server-services-client belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.1 | 2026-04-17T22:38:54.870Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-e62ad44010c227` from `npm_registry` as `registry_expansion`
