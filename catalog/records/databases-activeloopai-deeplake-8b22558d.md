...
<!-- canonical: https://github.com/activeloopai/deeplake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/activeloopai/deeplake](https://github.com/activeloopai/deeplake) |
| Source record ids | github_search_databases-e2be7ff9c1d2bc |

## System Engineer Summary

Deeplake is AI Data Runtime for Agents. It provides serverless postgres with a multimodal datalake,
enabling scalable retrieval and training.

## Operational Role

For a systems engineer, activeloopai/deeplake belongs in the Databases inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-21T15:28:00Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e2be7ff9c1d2bc` from `github_search_databases` as `registry_expansion`
