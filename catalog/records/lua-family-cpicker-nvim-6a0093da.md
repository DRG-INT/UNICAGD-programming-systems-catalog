...
<!-- canonical: https://luarocks.org/modules/wsdjeg/cpicker.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/cpicker.nvim](https://luarocks.org/modules/wsdjeg/cpicker.nvim) |
| Source record ids | luarocks_root_manifest-5fec147cdce7b8 |
...
For a systems engineer, cpicker.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5fec147cdce7b8` from `luarocks_root_manifest` as `registry_expansion`
