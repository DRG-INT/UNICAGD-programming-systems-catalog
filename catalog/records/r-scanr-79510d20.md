...
<!-- canonical: https://cran.r-project.org/web/packages/scanr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scanr/index.html](https://cran.r-project.org/web/packages/scanr/index.html) |
| Source record ids | cran_packages_by_date-c9a8755d829586 |
...
For a systems engineer, scanr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-21 08:10:02 UTC | [https://cran.r-project.org/web/packages/scanr/DESCRIPTION](https://cran.r-project.org/web/packages/scanr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scanr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c9a8755d829586` from `cran_packages_by_date` as `registry_expansion`
