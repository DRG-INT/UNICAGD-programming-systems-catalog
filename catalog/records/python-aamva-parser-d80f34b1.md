...
<!-- canonical: https://pypi.org/project/aamva-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aamva-parser/](https://pypi.org/project/aamva-parser/) |
| Source record ids | pypi_simple-6a6b51ae412a47 |

## System Engineer Summary

Parse AAMVA PDF417 barcode data from US and Canadian driver's licenses and ID cards (Python port of
aamva-parser).

## Operational Role

For a systems engineer, aamva-parser belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-04-23T21:08:49.675637Z | [https://pypi.org/pypi/aamva-parser/json](https://pypi.org/pypi/aamva-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aamva-parser/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-6a6b51ae412a47` from `pypi_simple` as `registry_expansion`
