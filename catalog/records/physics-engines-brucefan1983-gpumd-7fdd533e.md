...
<!-- canonical: https://github.com/brucefan1983/GPUMD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brucefan1983/GPUMD](https://github.com/brucefan1983/GPUMD) |
| Source record ids | github_search_physics_engines-f3a5929a13b929 |
...
For a systems engineer, brucefan1983/GPUMD belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T07:54:17Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f3a5929a13b929` from `github_search_physics_engines` as `registry_expansion`
