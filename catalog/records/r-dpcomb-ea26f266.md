...
<!-- canonical: https://cran.r-project.org/web/packages/DPComb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DPComb/index.html](https://cran.r-project.org/web/packages/DPComb/index.html) |
| Source record ids | cran_packages_by_date-6205fb750fb58a |
...
For a systems engineer, DPComb belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-22 16:30:22 UTC | [https://cran.r-project.org/web/packages/DPComb/DESCRIPTION](https://cran.r-project.org/web/packages/DPComb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DPComb/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6205fb750fb58a` from `cran_packages_by_date` as `registry_expansion`
