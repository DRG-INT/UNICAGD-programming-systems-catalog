...
<!-- canonical: https://github.com/rbgirshick/voc-dpm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rbgirshick/voc-dpm](https://github.com/rbgirshick/voc-dpm) |
| Source record ids | github_search_matlab-94e214b3e87e46 |

## System Engineer Summary

Object detection system using deformable part models (DPMs) and latent SVM (voc-release5). You may
want to use the latest tarball on my website. The github code may include code changes that have not
been tested as thoroughly and will not necessarily reproduce the results on the website.

## Operational Role

For a systems engineer, rbgirshick/voc-dpm belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-04-03T16:06:41Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-94e214b3e87e46` from `github_search_matlab` as `registry_expansion`
