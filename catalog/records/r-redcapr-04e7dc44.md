...
<!-- canonical: https://cran.r-project.org/web/packages/REDCapR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/REDCapR/index.html](https://cran.r-project.org/web/packages/REDCapR/index.html) |
| Source record ids | cran_packages_by_date-7771d3eea598b9 |
...
For a systems engineer, REDCapR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-08-20 09:22:32 UTC | [https://cran.r-project.org/web/packages/REDCapR/DESCRIPTION](https://cran.r-project.org/web/packages/REDCapR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/REDCapR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7771d3eea598b9` from `cran_packages_by_date` as `registry_expansion`
