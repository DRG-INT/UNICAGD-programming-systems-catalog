...
<!-- canonical: https://github.com/toshiakit/MatGPT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/toshiakit/MatGPT](https://github.com/toshiakit/MatGPT) |
| Source record ids | github_search_matlab-4bd8171b44c18f |
...
For a systems engineer, toshiakit/MatGPT belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-31T03:08:06Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-4bd8171b44c18f` from `github_search_matlab` as `registry_expansion`
