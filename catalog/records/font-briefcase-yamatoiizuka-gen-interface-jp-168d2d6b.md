...
<!-- canonical: https://github.com/yamatoiizuka/gen-interface-jp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yamatoiizuka/gen-interface-jp](https://github.com/yamatoiizuka/gen-interface-jp) |
| Source record ids | github_search_font_briefcase-c1808c398caaa8 |

## System Engineer Summary

Typeface harmonizing Inter and Noto Sans JP

## Operational Role

For a systems engineer, yamatoiizuka/gen-interface-jp belongs in the Font Briefcase inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-23T01:54:13Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-c1808c398caaa8` from `github_search_font_briefcase` as `registry_expansion`
