...
<!-- canonical: https://pub.dev/packages/web3dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/web3dart](https://pub.dev/packages/web3dart) |
| Source record ids | pub_dev-91a49c11115772 |

## System Engineer Summary

A Celo compatible Dart library to connect to Ethereum clients. Send transactions and interact with
smart contracts! Pay transaction fees using `feeCurrencies` on Celo.

## Operational Role

For a systems engineer, web3dart belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.3 | 2026-06-28T11:17:58.886456Z | [https://pub.dev/api/packages/web3dart](https://pub.dev/api/packages/web3dart) |  |
| preview | known | 2.0.0-dev.9 | 2020-12-19T09:04:44.487325Z | [https://pub.dev/api/packages/web3dart](https://pub.dev/api/packages/web3dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/web3dart` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-91a49c11115772` from `pub_dev` as `registry_expansion`
