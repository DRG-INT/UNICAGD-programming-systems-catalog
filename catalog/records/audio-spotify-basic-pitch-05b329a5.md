...
| Canonical URL | [https://github.com/spotify/basic-pitch](https://github.com/spotify/basic-pitch) |
| Source record ids | github_search_audio-87642eb5926ff2 |
...
For a systems engineer, spotify/basic-pitch belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.0 | 2024-08-16T17:16:26Z | [https://api.github.com/repos/spotify/basic-pitch/releases/latest](https://api.github.com/repos/spotify/basic-pitch/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/spotify/basic-pitch/releases/latest` at `2026-09-01T09:23:20+00:00`.
...
- `github_search_audio-87642eb5926ff2` from `github_search_audio` as `registry_expansion`
