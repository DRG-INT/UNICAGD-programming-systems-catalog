# thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend
...
<!-- canonical: https://github.com/thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend](https://github.com/thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend) |
| Source record ids | github_search_sapjava-b5de9c6e7aa4eb |

## System Engineer Summary

This repository contains all the Java backend code to be deployed on the SAP Hana Cloud Platform for
the IoT Train

## Operational Role

For a systems engineer, thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-08-24T03:34:57Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-b5de9c6e7aa4eb` from `github_search_sapjava` as `registry_expansion`
