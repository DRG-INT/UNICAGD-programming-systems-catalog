...
<!-- canonical: https://hackage.haskell.org/package/cprng-aes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cprng-aes](https://hackage.haskell.org/package/cprng-aes) |
| Source record ids | hackage_top_downloads-5518ff18a3ba9d |
...
For a systems engineer, cprng-aes belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2014-11-13T11:27:54Z | [https://hackage.haskell.org/package/cprng-aes](https://hackage.haskell.org/package/cprng-aes) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cprng-aes` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-5518ff18a3ba9d` from `hackage_top_downloads` as `registry_expansion`
