...
| Canonical URL | [https://luarocks.org/modules/gtuk/kong-header-access-control](https://luarocks.org/modules/gtuk/kong-header-access-control) |
| Source record ids | luarocks_root_manifest-1f8d70ae373205 |
...
For a systems engineer, kong-header-access-control belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-1f8d70ae373205` from `luarocks_root_manifest` as `registry_expansion`
