...
<!-- canonical: https://packagist.org/packages/pomm-project/pomm-symfony-bridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pomm-project/pomm-symfony-bridge](https://packagist.org/packages/pomm-project/pomm-symfony-bridge) |
| Source record ids | packagist_search-234d6889979eef |
...
For a systems engineer, pomm-project/pomm-symfony-bridge belongs in the PHP inventory as part of
...
- `packagist_search-234d6889979eef` from `packagist_search` as `registry_expansion`
