...
<!-- canonical: https://cran.r-project.org/web/packages/hyper.gam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hyper.gam/index.html](https://cran.r-project.org/web/packages/hyper.gam/index.html) |
| Source record ids | cran_packages_by_date-cd7c7cb7d0e733 |
...
For a systems engineer, hyper.gam belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-25 22:10:02 UTC | [https://cran.r-project.org/web/packages/hyper.gam/DESCRIPTION](https://cran.r-project.org/web/packages/hyper.gam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hyper.gam/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cd7c7cb7d0e733` from `cran_packages_by_date` as `registry_expansion`
