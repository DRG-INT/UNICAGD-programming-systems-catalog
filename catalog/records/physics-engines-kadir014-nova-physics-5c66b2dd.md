...
<!-- canonical: https://github.com/kadir014/nova-physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kadir014/nova-physics](https://github.com/kadir014/nova-physics) |
| Source record ids | github_search_physics_engines-b0fdffada22ddc |
...
For a systems engineer, kadir014/nova-physics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-16T21:57:58Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-b0fdffada22ddc` from `github_search_physics_engines` as `registry_expansion`
