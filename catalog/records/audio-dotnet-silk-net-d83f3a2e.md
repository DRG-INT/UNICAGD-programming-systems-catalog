...
| Source record ids | github_search_audio-0af5faf739b8bc |
...
For a systems engineer, dotnet/Silk.NET belongs in the Audio inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.23.0 | 2026-01-22T19:45:39Z | [https://api.github.com/repos/dotnet/Silk.NET/releases/latest](https://api.github.com/repos/dotnet/Silk.NET/releases/latest) |  |
| preview | known | v2.17.0-preview | 2023-03-19T19:52:00Z | [https://api.github.com/repos/dotnet/Silk.NET/releases?per_page=10](https://api.github.com/repos/dotnet/Silk.NET/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dotnet/Silk.NET/releases/latest` at `2026-09-01T09:23:16+00:00`.
...
- `github_search_audio-0af5faf739b8bc` from `github_search_audio` as `registry_expansion`
