...
<!-- canonical: https://github.com/cr0hn/dockerscan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cr0hn/dockerscan](https://github.com/cr0hn/dockerscan) |
| Source record ids | github_search_catalogs-d7763dcc4efbba |
...
For a systems engineer, cr0hn/dockerscan belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T11:31:26Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-d7763dcc4efbba` from `github_search_catalogs` as `registry_expansion`
