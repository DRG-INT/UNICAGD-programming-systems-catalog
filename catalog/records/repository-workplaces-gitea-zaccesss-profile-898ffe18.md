...
<!-- canonical: https://gitea.com/zaccesss/.profile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/zaccesss/.profile](https://gitea.com/zaccesss/.profile) |
| Source record ids | gitea_repositories_api-1e7f3dd451cbce |

## System Engineer Summary

Animated GitHub profile README - monospace neofetch-style card with links at the top, an ASCII
portrait on the left with profile & live GitHub stats (commits, LOC, stars, PRs, followers, streaks)
on the right. Dark & light themed. Stats fetched via Python & GitHub GraphQL, auto-updated by
Actions.

## Operational Role

For a systems engineer, Gitea: zaccesss/.profile belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T22:02:55Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-1e7f3dd451cbce` from `gitea_repositories_api` as `registry_expansion`
