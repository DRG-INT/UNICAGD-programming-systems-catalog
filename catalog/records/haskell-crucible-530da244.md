...
<!-- canonical: https://hackage.haskell.org/package/crucible -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/crucible](https://hackage.haskell.org/package/crucible) |
| Source record ids | hackage_recent-ce71464320e096 |
...
For a systems engineer, crucible belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2026-09-11T16:16:28Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-ce71464320e096` from `hackage_recent` as `registry_expansion`
