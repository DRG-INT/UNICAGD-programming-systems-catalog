...
<!-- canonical: https://packagist.org/packages/nightowl/agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nightowl/agent](https://packagist.org/packages/nightowl/agent) |
| Source record ids | packagist_search-334995e1369f2d |
...
For a systems engineer, nightowl/agent belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-334995e1369f2d` from `packagist_search` as `registry_expansion`
