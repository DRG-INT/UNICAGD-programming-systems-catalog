...
<!-- canonical: https://cran.r-project.org/web/packages/RMVL/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RMVL/index.html](https://cran.r-project.org/web/packages/RMVL/index.html) |
| Source record ids | cran_packages_by_date-17c93fec537295 |
...
For a systems engineer, RMVL belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0.4 | 2026-08-28 17:30:02 UTC | [https://cran.r-project.org/web/packages/RMVL/DESCRIPTION](https://cran.r-project.org/web/packages/RMVL/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RMVL/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-17c93fec537295` from `cran_packages_by_date` as `registry_expansion`
