...
| Canonical URL | [https://crates.io/crates/wgpu-core](https://crates.io/crates/wgpu-core) |
| Source record ids | crates_io-ace899edb96452 |
...
For a systems engineer, wgpu-core belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 30.0.1 | 2026-08-22T02:53:36.028396Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-ace899edb96452` from `crates_io` as `registry_expansion`
