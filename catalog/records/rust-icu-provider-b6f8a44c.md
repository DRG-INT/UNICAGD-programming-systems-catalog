...
<!-- canonical: https://crates.io/crates/icu_provider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_provider](https://crates.io/crates/icu_provider) |
| Source record ids | crates_io-6b0a8b6140251f |
...
For a systems engineer, icu_provider belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-08-20T23:25:32.095205Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-6b0a8b6140251f` from `crates_io` as `registry_expansion`
