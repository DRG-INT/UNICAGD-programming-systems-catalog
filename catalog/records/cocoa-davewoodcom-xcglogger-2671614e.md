...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DaveWoodCom/XCGLogger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DaveWoodCom/XCGLogger](https://github.com/DaveWoodCom/XCGLogger) |
| Source record ids | github_search_cocoa-ea582f5c9c0de3 |

## System Engineer Summary

A debug log framework for use in Swift projects. Allows you to log details to the console (and
optionally a file), just like you would have with NSLog() or print(), but with additional
information, such as the date, function name, filename and line number.

## Operational Role

For a systems engineer, DaveWoodCom/XCGLogger belongs in the Cocoa inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-02T13:12:43Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-ea582f5c9c0de3` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Shake | Formatter | [open](cocoa-shake-6aaa6776.md) |
