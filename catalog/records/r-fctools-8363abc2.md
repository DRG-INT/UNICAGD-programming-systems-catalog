...
<!-- canonical: https://cran.r-project.org/web/packages/FCtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FCtools/index.html](https://cran.r-project.org/web/packages/FCtools/index.html) |
| Source record ids | cran_packages_by_date-eff6026e55dea1 |
...
For a systems engineer, FCtools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-09-15 13:10:08 UTC | [https://cran.r-project.org/web/packages/FCtools/DESCRIPTION](https://cran.r-project.org/web/packages/FCtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FCtools/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-eff6026e55dea1` from `cran_packages_by_date` as `registry_expansion`
