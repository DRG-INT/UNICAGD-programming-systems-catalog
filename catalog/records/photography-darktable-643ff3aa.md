...
<!-- canonical: https://github.com/darktable-org/darktable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/darktable-org/darktable](https://github.com/darktable-org/darktable) |
| Source record ids | curated_language_routes-5ecffe12ecb70f |

## System Engineer Summary

Photography workflow and RAW developer with non-destructive editing, color management, tethering,
and exports.

## Operational Role

For a systems engineer, darktable belongs in the Photography inventory as part of ecosystem
...
- `curated_language_routes-5ecffe12ecb70f` from `curated_language_routes` as `registry_expansion`
