...
<!-- canonical: https://github.com/gregorwolf/sap-cloud-sdk-rfc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gregorwolf/sap-cloud-sdk-rfc](https://github.com/gregorwolf/sap-cloud-sdk-rfc) |
| Source record ids | github_search_sapjava-24d3c0201990ca |
...
For a systems engineer, gregorwolf/sap-cloud-sdk-rfc belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-02T20:26:31Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-24d3c0201990ca` from `github_search_sapjava` as `registry_expansion`
