...
<!-- canonical: https://github.com/Shuichi346/DeepFilterNet3-VST3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Shuichi346/DeepFilterNet3-VST3](https://github.com/Shuichi346/DeepFilterNet3-VST3) |
| Source record ids | github_search_audio-ef466217a58c76 |

## System Engineer Summary

This is a VST3 plugin that uses the DeepFilterNet3 neural network for high-quality noise
suppression.

## Operational Role

For a systems engineer, Shuichi346/DeepFilterNet3-VST3 belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T12:45:11Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-ef466217a58c76` from `github_search_audio` as `registry_expansion`
