...
<!-- canonical: https://luarocks.org/modules/astra/astra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/astra/astra](https://luarocks.org/modules/astra/astra) |
| Source record ids | luarocks_root_manifest-bdae8ace46e8fe |
...
For a systems engineer, astra belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-bdae8ace46e8fe` from `luarocks_root_manifest` as `registry_expansion`
