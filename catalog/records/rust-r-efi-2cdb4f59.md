...
<!-- canonical: https://crates.io/crates/r-efi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/r-efi](https://crates.io/crates/r-efi) |
| Source record ids | crates_io-4e90d91aeb4ef7 |
...
For a systems engineer, r-efi belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2026-08-10T13:27:42.488376Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-4e90d91aeb4ef7` from `crates_io` as `registry_expansion`
