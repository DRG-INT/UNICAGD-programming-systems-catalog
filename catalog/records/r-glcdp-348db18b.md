...
<!-- canonical: https://cran.r-project.org/web/packages/glcdp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glcdp/index.html](https://cran.r-project.org/web/packages/glcdp/index.html) |
| Source record ids | cran_packages_by_date-0a71d6e93f3321 |
...
For a systems engineer, glcdp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-06 13:00:02 UTC | [https://cran.r-project.org/web/packages/glcdp/DESCRIPTION](https://cran.r-project.org/web/packages/glcdp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glcdp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0a71d6e93f3321` from `cran_packages_by_date` as `registry_expansion`
