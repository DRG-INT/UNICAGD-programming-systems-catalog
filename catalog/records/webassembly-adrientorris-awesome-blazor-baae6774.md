...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AdrienTorris/awesome-blazor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AdrienTorris/awesome-blazor](https://github.com/AdrienTorris/awesome-blazor) |
| Source record ids | github_search_webassembly-2922071b372dc6 |

## System Engineer Summary

Resources for Blazor, a .NET web framework using C#/Razor and HTML that runs in the browser with
WebAssembly.

## Operational Role

For a systems engineer, AdrienTorris/awesome-blazor belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- |
| github_repository_search | registry-derived | 2026-09-01 | `{"kind": "github_repository_search", "query": "topic:webassembly stars:>500", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `github_search_webassembly-2922071b372dc6` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Automattic/harper | Parser Lexer Ast | [open](webassembly-automattic-harper-ac075554.md) |
| drbh/wasm-fingerprint | Parser Lexer Ast | [open](webassembly-drbh-wasm-fingerprint-2d024b12.md) |
| esimov/pigo | Parser Lexer Ast | [open](webassembly-esimov-pigo-47c4c3e9.md) |
| jameslittle230/stork | Parser Lexer Ast | [open](webassembly-jameslittle230-stork-1024e297.md) |
| satabin/swam | Parser Lexer Ast | [open](webassembly-satabin-swam-0cad2eae.md) |
| unum-cloud/USearch | Parser Lexer Ast | [open](webassembly-unum-cloud-usearch-c7ae11cc.md) |
| wasmerio/wasmer | Parser Lexer Ast | [open](webassembly-wasmerio-wasmer-6c9ffa90.md) |
