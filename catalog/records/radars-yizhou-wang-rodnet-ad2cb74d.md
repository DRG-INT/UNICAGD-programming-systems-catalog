...
<!-- canonical: https://github.com/yizhou-wang/RODNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yizhou-wang/RODNet](https://github.com/yizhou-wang/RODNet) |
| Source record ids | github_search_radars-18f873bd3f56ad |
...
For a systems engineer, yizhou-wang/RODNet belongs in the Radars inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.3 | 2022-03-15T07:26:19Z | [https://api.github.com/repos/yizhou-wang/RODNet/releases/latest](https://api.github.com/repos/yizhou-wang/RODNet/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/yizhou-wang/RODNet/releases/latest` at `2026-09-01T08:26:33+00:00`.
...
- `github_search_radars-18f873bd3f56ad` from `github_search_radars` as `registry_expansion`
