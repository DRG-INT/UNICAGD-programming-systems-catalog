...
<!-- canonical: https://hackage.haskell.org/package/vector-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vector-builder](https://hackage.haskell.org/package/vector-builder) |
| Source record ids | hackage_top_downloads-aad13b8447cd7d |
...
For a systems engineer, vector-builder belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.8.7 | 2026-01-13T09:42:22Z | [https://hackage.haskell.org/package/vector-builder](https://hackage.haskell.org/package/vector-builder) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vector-builder` at `2026-09-08T00:34:57+00:00`.
...
- `hackage_top_downloads-aad13b8447cd7d` from `hackage_top_downloads` as `registry_expansion`
