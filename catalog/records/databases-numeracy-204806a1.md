...
| Canonical URL | [https://numeracy.co/](https://numeracy.co/) |
| Source record ids | awesome_list-8b250e4d6dee82 |
...
For a systems engineer, Numeracy belongs in the Databases inventory as part of ecosystem capability
...
- `awesome_list-8b250e4d6dee82` from `awesome_list` as `registry_expansion`
