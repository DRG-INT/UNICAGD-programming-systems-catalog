# Gitea: songjiahao/git-devops-lab
...
<!-- canonical: https://gitea.com/songjiahao/git-devops-lab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/songjiahao/git-devops-lab](https://gitea.com/songjiahao/git-devops-lab) |
| Source record ids | gitea_repositories_api-04590eebaf8955 |
...
For a systems engineer, Gitea: songjiahao/git-devops-lab belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T07:32:16Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-04590eebaf8955` from `gitea_repositories_api` as `registry_expansion`
