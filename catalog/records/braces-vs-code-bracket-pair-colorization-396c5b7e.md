...
<!-- canonical: https://code.visualstudio.com/blogs/2021/09/29/bracket-pair-colorization -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://code.visualstudio.com/blogs/2021/09/29/bracket-pair-colorization](https://code.visualstudio.com/blogs/2021/09/29/bracket-pair-colorization) |
| Source record ids | curated_language_routes-729a0a33b42a3c |

## System Engineer Summary

Visual Studio Code bracket-pair colorization route for brace matching and large-file editor
behavior.

## Operational Role

For a systems engineer, VS Code Bracket Pair Colorization belongs in the Braces inventory as part of
...
- `curated_language_routes-729a0a33b42a3c` from `curated_language_routes` as `registry_expansion`
