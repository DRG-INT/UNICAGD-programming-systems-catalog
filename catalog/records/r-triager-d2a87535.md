...
<!-- canonical: https://cran.r-project.org/web/packages/triageR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/triageR/index.html](https://cran.r-project.org/web/packages/triageR/index.html) |
| Source record ids | cran_packages_by_date-7ca87b5b12fa06 |
...
For a systems engineer, triageR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-05 02:20:02 UTC | [https://cran.r-project.org/web/packages/triageR/DESCRIPTION](https://cran.r-project.org/web/packages/triageR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/triageR/DESCRIPTION` at `2026-09-05T03:18:50+00:00`.
...
- `cran_packages_by_date-7ca87b5b12fa06` from `cran_packages_by_date` as `registry_expansion`
