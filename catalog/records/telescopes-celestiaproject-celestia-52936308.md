...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/CelestiaProject/Celestia -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Telescopes |
| Category | Parser Lexer Ast |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/CelestiaProject/Celestia](https://github.com/CelestiaProject/Celestia) |
| Source record ids | github_search_telescopes-f8ad3e9770457f |
...
For a systems engineer, CelestiaProject/Celestia belongs in the Telescopes inventory as part of
language tooling, code generation, static analysis, and source transformation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.4 | 2023-11-04T19:55:20Z | [https://api.github.com/repos/CelestiaProject/Celestia/releases/latest](https://api.github.com/repos/CelestiaProject/Celestia/releases/latest) |  |
| preview | known | 1.6.2-beta3 | 2020-06-10T07:54:10Z | [https://api.github.com/repos/CelestiaProject/Celestia/releases?per_page=10](https://api.github.com/repos/CelestiaProject/Celestia/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CelestiaProject/Celestia/releases/latest` at `2026-09-01T08:26:23+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:astronomy stars:>100", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-f8ad3e9770457f` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xCoto/Virgo | Parser Lexer Ast | [open](telescopes-0xcoto-virgo-8f75760a.md) |
| aaronwmorris/indi-allsky | Parser Lexer Ast | [open](telescopes-aaronwmorris-indi-allsky-aa5014e3.md) |
| AllskyTeam/allsky | Parser Lexer Ast | [open](telescopes-allskyteam-allsky-a37843a6.md) |
| art-den/astra_lite | Parser Lexer Ast | [open](telescopes-art-den-astra-lite-8f947ea9.md) |
| astropy-learn/astropy-tutorials | Parser Lexer Ast | [open](telescopes-astropy-learn-astropy-tutorials-c1f9e6d9.md) |
| astropy/astroquery | Parser Lexer Ast | [open](telescopes-astropy-astroquery-218a1107.md) |
| astropy/photutils | Parser Lexer Ast | [open](telescopes-astropy-photutils-5b2bafdc.md) |
| astrorigin/pyswisseph | Parser Lexer Ast | [open](telescopes-astrorigin-pyswisseph-f5236430.md) |
