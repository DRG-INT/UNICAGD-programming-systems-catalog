...
<!-- canonical: https://cran.r-project.org/web/packages/rankingQ/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rankingQ/index.html](https://cran.r-project.org/web/packages/rankingQ/index.html) |
| Source record ids | cran_packages_by_date-282de0117b0c48 |
...
For a systems engineer, rankingQ belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 13:50:14 UTC | [https://cran.r-project.org/web/packages/rankingQ/DESCRIPTION](https://cran.r-project.org/web/packages/rankingQ/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rankingQ/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-282de0117b0c48` from `cran_packages_by_date` as `registry_expansion`
