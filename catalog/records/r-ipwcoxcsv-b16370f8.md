...
<!-- canonical: https://cran.r-project.org/web/packages/ipwCoxCSV/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ipwCoxCSV/index.html](https://cran.r-project.org/web/packages/ipwCoxCSV/index.html) |
| Source record ids | cran_packages_by_date-078d615dc6e61c |

## System Engineer Summary

Corrected Sandwich Inference for Inverse Probability Weighted Cox Models

## Operational Role

For a systems engineer, ipwCoxCSV belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-08-19 21:30:02 UTC | [https://cran.r-project.org/web/packages/ipwCoxCSV/DESCRIPTION](https://cran.r-project.org/web/packages/ipwCoxCSV/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ipwCoxCSV/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-078d615dc6e61c` from `cran_packages_by_date` as `registry_expansion`
