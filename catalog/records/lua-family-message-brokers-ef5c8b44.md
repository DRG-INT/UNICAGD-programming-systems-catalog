...
| Source record ids | lua-source-37 |

## System Engineer Summary

Message Brokers is tracked as a message broker record in the Lua family branch. The source did not
...
For a systems engineer, Message Brokers belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 37}}` |
...
- `lua-source-37` from `master_json` as `source_list_item`
