...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CNPreferences](https://github.com/JuliaRegistries/General/tree/master/C/CNPreferences) |
| Source record ids | julia_general-ea0bd4783ef95d |

## System Engineer Summary

Julia package registered in General at C/CNPreferences.

## Operational Role

For a systems engineer, CNPreferences belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CNPreferences", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ea0bd4783ef95d` from `julia_general` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CommunityDetection | Community Reference | [open](julia-communitydetection-d9a1cb3e.md) |
