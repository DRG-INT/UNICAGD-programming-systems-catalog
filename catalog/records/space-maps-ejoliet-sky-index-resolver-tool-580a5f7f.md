# ejoliet/Sky-Index-Resolver-tool
...
<!-- canonical: https://github.com/ejoliet/Sky-Index-Resolver-tool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ejoliet/Sky-Index-Resolver-tool](https://github.com/ejoliet/Sky-Index-Resolver-tool) |
| Source record ids | github_search_space_maps-d9c10d8e1695c4 |

## System Engineer Summary

kind of astronomical name resolver web tool (simbad or ned) but for all existing tesselation sky
schemes

## Operational Role

For a systems engineer, ejoliet/Sky-Index-Resolver-tool belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-05-10T00:54:54Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d9c10d8e1695c4` from `github_search_space_maps` as `registry_expansion`
