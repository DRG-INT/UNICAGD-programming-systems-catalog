...
<!-- canonical: https://crates.io/crates/rkyv_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rkyv_derive](https://crates.io/crates/rkyv_derive) |
| Source record ids | crates_io-6b9a3cb0a88c3c |

## System Engineer Summary

rkyv_derive is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, rkyv_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.18 | 2026-08-05T12:01:39.666655Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-6b9a3cb0a88c3c` from `crates_io` as `registry_expansion`
