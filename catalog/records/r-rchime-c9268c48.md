...
<!-- canonical: https://cran.r-project.org/web/packages/rchime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rchime/index.html](https://cran.r-project.org/web/packages/rchime/index.html) |
| Source record ids | cran_packages_by_date-9b3e1846c4098f |

## System Engineer Summary

Detect and Remove Chimeras from Amplicon Sequence Analysis Data

## Operational Role

For a systems engineer, rchime belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-21 14:50:02 UTC | [https://cran.r-project.org/web/packages/rchime/DESCRIPTION](https://cran.r-project.org/web/packages/rchime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rchime/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9b3e1846c4098f` from `cran_packages_by_date` as `registry_expansion`
