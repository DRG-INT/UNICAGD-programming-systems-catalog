...
<!-- canonical: https://github.com/rj200/Glamarye_Fast_Effects_for_ReShade -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rj200/Glamarye_Fast_Effects_for_ReShade](https://github.com/rj200/Glamarye_Fast_Effects_for_ReShade) |
| Source record ids | github_search_effects-4b1f3520670580 |

## System Engineer Summary

Designed for speed, this shader for ReShade is for people who can't just run everything at max
settings but want good enough post-processing without costing much framerate. It combines 4 effects
in one - Fast FXAA, sharpening, depth of field and fast ambient occlusion

## Operational Role

For a systems engineer, rj200/Glamarye_Fast_Effects_for_ReShade belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.4.2 | 2023-08-07T23:17:19Z | [https://api.github.com/repos/rj200/Glamarye_Fast_Effects_for_ReShade/releases/latest](https://api.github.com/repos/rj200/Glamarye_Fast_Effects_for_ReShade/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rj200/Glamarye_Fast_Effects_for_ReShade/releases/latest` at `2026-09-01T09:23:13+00:00`.
...
- `github_search_effects-4b1f3520670580` from `github_search_effects` as `registry_expansion`
