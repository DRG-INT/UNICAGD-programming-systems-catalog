...
<!-- canonical: https://github.com/jdeokkim/ferox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jdeokkim/ferox](https://github.com/jdeokkim/ferox) |
| Source record ids | github_search_physics_engines-f63c36f7eae924 |
...
For a systems engineer, jdeokkim/ferox belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-08T05:09:46Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f63c36f7eae924` from `github_search_physics_engines` as `registry_expansion`
