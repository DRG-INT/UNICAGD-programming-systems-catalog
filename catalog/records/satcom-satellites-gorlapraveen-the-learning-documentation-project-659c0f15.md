...
<!-- canonical: https://github.com/gorlapraveen/The-Learning-Documentation-Project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gorlapraveen/The-Learning-Documentation-Project](https://github.com/gorlapraveen/The-Learning-Documentation-Project) |
| Source record ids | github_search_satcom_satellites-2357c1db09faba |

## System Engineer Summary

This documentation is archived. Updates are only available in

## Operational Role

For a systems engineer, gorlapraveen/The-Learning-Documentation-Project belongs in the SatCom
Satellites inventory as part of operator onboarding, API understanding, and upgrade review.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-11T13:33:35Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-2357c1db09faba` from `github_search_satcom_satellites` as `registry_expansion`
...
| srsran/srsRAN_Project | Documentation | [open](satcom-satellites-srsran-srsran-project-c60d2e9c.md) |
