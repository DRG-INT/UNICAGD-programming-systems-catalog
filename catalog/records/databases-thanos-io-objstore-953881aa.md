...
<!-- canonical: https://github.com/thanos-io/objstore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thanos-io/objstore](https://github.com/thanos-io/objstore) |
| Source record ids | github_search_databases-99ae90325c24ca |

## System Engineer Summary

Go module providing unified interface and efficient clients to work with various object storage
providers until like GCS, S3, Azure, SWIFT, COS and more.

## Operational Role

For a systems engineer, thanos-io/objstore belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:13:55Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-99ae90325c24ca` from `github_search_databases` as `registry_expansion`
