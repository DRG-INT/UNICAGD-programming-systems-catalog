...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BplusCore](https://github.com/JuliaRegistries/General/tree/master/B/BplusCore) |
| Source record ids | julia_general-91824711975a67 |

## System Engineer Summary

Julia package registered in General at B/BplusCore.

## Operational Role

For a systems engineer, BplusCore belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BplusCore", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-91824711975a67` from `julia_general` as `registry_expansion`
