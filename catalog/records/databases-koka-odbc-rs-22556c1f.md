...
<!-- canonical: https://github.com/Koka/odbc-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Koka/odbc-rs](https://github.com/Koka/odbc-rs) |
| Source record ids | github_search_databases-2c5a4540442bae |

## System Engineer Summary

Koka/odbc-rs is tracked as a ffi bindings record in the Databases branch. The source did not provide
...
For a systems engineer, Koka/odbc-rs belongs in the Databases inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-07T20:26:24Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-2c5a4540442bae` from `github_search_databases` as `registry_expansion`
