...
<!-- canonical: https://www.npmjs.com/package/@omega-edit/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@omega-edit/server](https://www.npmjs.com/package/@omega-edit/server) |
| Source record ids | npm_registry-439623b6abe409 |

## System Engineer Summary

@omega-edit/server is tracked as a web framework record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @omega-edit/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-04-17T15:47:21.322Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-439623b6abe409` from `npm_registry` as `registry_expansion`
