...
| Canonical URL | [https://github.com/organicmaps/organicmaps](https://github.com/organicmaps/organicmaps) |
| Source record ids | github_search_maps-23378a46ef26c8 |

## System Engineer Summary

🍃 Organic Maps is a free Android & iOS offline maps app for more than 6M travelers, tourists,
hikers, and cyclists. It uses crowd-sourced OpenStreetMap data and is developed with love by the
community. No ads, no tracking, no data collection, no crapware. Please donate to support the
development!

## Operational Role

For a systems engineer, organicmaps/organicmaps belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.08.27-18-android | 2026-08-27T14:05:31Z | [https://api.github.com/repos/organicmaps/organicmaps/releases/latest](https://api.github.com/repos/organicmaps/organicmaps/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/organicmaps/organicmaps/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-23378a46ef26c8` from `github_search_maps` as `registry_expansion`
