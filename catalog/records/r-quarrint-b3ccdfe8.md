...
<!-- canonical: https://cran.r-project.org/web/packages/quarrint/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/quarrint/index.html](https://cran.r-project.org/web/packages/quarrint/index.html) |
| Source record ids | cran_packages_by_date-8b080da7cc1990 |

## System Engineer Summary

Interaction Prediction Between Groundwater and Quarry Extension Using Discrete Choice Models and
Artificial Neural Networks

## Operational Role

For a systems engineer, quarrint belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-15 08:30:02 UTC | [https://cran.r-project.org/web/packages/quarrint/DESCRIPTION](https://cran.r-project.org/web/packages/quarrint/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/quarrint/DESCRIPTION` at `2026-09-15T10:20:58+00:00`.
...
- `cran_packages_by_date-8b080da7cc1990` from `cran_packages_by_date` as `registry_expansion`
