...
| Canonical URL | [https://luarocks.org/modules/andersenq/kong-plugin-api-transformer](https://luarocks.org/modules/andersenq/kong-plugin-api-transformer) |
| Source record ids | luarocks_root_manifest-159160d74b0b6f |

## System Engineer Summary

A Kong plugin that enables elastic request/response transforming by lua scripts

## Operational Role

For a systems engineer, kong-plugin-api-transformer belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-159160d74b0b6f` from `luarocks_root_manifest` as `registry_expansion`
