...
<!-- canonical: https://packagist.org/packages/zaber-dev/laravel-quota -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zaber-dev/laravel-quota](https://packagist.org/packages/zaber-dev/laravel-quota) |
| Source record ids | packagist_search-2e90307c4c2e7e |

## System Engineer Summary

Application-level quota management for Laravel with calendar periods, multiple storage backends, and
expressive APIs.

## Operational Role

For a systems engineer, zaber-dev/laravel-quota belongs in the PHP inventory as part of request
...
- `packagist_search-2e90307c4c2e7e` from `packagist_search` as `registry_expansion`
