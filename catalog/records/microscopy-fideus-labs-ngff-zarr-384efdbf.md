...
| Canonical URL | [https://github.com/fideus-labs/ngff-zarr](https://github.com/fideus-labs/ngff-zarr) |
| Source record ids | github_search_microscopy-5c1ee140ed0bd7 |

## System Engineer Summary

A lean and kind Open Microscopy Environment (OME) Next Generation File Format (NGFF) Zarr
implementation.

## Operational Role

For a systems engineer, fideus-labs/ngff-zarr belongs in the Microscopy inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | mcp-v0.14.0 | 2026-08-28T17:51:11Z | [https://api.github.com/repos/fideus-labs/ngff-zarr/releases/latest](https://api.github.com/repos/fideus-labs/ngff-zarr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fideus-labs/ngff-zarr/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
- `github_search_microscopy-5c1ee140ed0bd7` from `github_search_microscopy` as `registry_expansion`
