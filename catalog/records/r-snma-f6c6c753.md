...
<!-- canonical: https://cran.r-project.org/web/packages/SNMA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SNMA/index.html](https://cran.r-project.org/web/packages/SNMA/index.html) |
| Source record ids | cran_packages_by_date-f8fb2d818b0b97 |
...
For a systems engineer, SNMA belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-08-26 20:30:02 UTC | [https://cran.r-project.org/web/packages/SNMA/DESCRIPTION](https://cran.r-project.org/web/packages/SNMA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SNMA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f8fb2d818b0b97` from `cran_packages_by_date` as `registry_expansion`
