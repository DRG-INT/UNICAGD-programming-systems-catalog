...
<!-- canonical: https://github.com/AbsurdePhoton/dominant-colors-3d-color-space -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AbsurdePhoton/dominant-colors-3d-color-space](https://github.com/AbsurdePhoton/dominant-colors-3d-color-space) |
| Source record ids | github_search_space_maps-f6a5758f0e77b0 |

## System Engineer Summary

Find dominant colors in images with QT and OpenCV, with a nice GUI to show results in 3D color
spaces: RGB, HSV, HSL, HWB, CIE XYZ and L*A*B, and the recent OKLAB! Export results to images, .CSV
files and palettes for popular software like Photoshop, Paintshop Pro and Corel Draw. Visualize Cube
LUTs!

## Operational Role

For a systems engineer, AbsurdePhoton/dominant-colors-3d-color-space belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-22T01:01:21Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f6a5758f0e77b0` from `github_search_space_maps` as `registry_expansion`
