...
<!-- canonical: https://cran.r-project.org/web/packages/cheddar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cheddar/index.html](https://cran.r-project.org/web/packages/cheddar/index.html) |
| Source record ids | cran_packages_by_date-788968c9046281 |
...
For a systems engineer, cheddar belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-640 | 2026-08-20 14:32:27 UTC | [https://cran.r-project.org/web/packages/cheddar/DESCRIPTION](https://cran.r-project.org/web/packages/cheddar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cheddar/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-788968c9046281` from `cran_packages_by_date` as `registry_expansion`
