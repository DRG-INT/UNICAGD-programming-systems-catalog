...
| Source record ids | master-50d54793c041 |
...
For a systems engineer, HTTP.jl belongs in the Julia inventory as part of service communication,
...
- `master-50d54793c041` from `master_json` as `networking_http`
