...
<!-- canonical: https://github.com/cdnjs/brand -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cdnjs/brand](https://github.com/cdnjs/brand) |
| Source record ids | github_search_icons_and_logos-72beb0dacbaa1b |

## System Engineer Summary

🖌 Brand and design assets for cdnjs - The #1 free and open source CDN built to make life easier for
developers.

## Operational Role

For a systems engineer, cdnjs/brand belongs in the Icons and Logos inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-06-23T11:33:04Z | gh search repos topic:brand-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-72beb0dacbaa1b` from `github_search_icons_and_logos` as `registry_expansion`
