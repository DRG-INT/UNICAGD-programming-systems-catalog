...
<!-- canonical: https://github.com/anfractuosity/musicplayer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anfractuosity/musicplayer](https://github.com/anfractuosity/musicplayer) |
| Source record ids | github_search_electromagnetoscopes-236be2538ab571 |

## System Engineer Summary

Play audio files (.wav) via the system bus of your computer and pickup with an AM radio. See youtube
link for example.

## Operational Role

For a systems engineer, anfractuosity/musicplayer belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-05T19:45:57Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-236be2538ab571` from `github_search_electromagnetoscopes` as `registry_expansion`
