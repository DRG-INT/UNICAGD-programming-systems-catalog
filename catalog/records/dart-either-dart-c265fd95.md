...
<!-- canonical: https://pub.dev/packages/either_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/either_dart](https://pub.dev/packages/either_dart) |
| Source record ids | pub_dev-eaf997ab9b8e84 |

## System Engineer Summary

Error handler library for type-safe and easy work with errors on Dart and Flutter. Either is an
alternative to Nullable value and Exceptions.

## Operational Role

For a systems engineer, either_dart belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2023-06-10T18:35:51.281487Z | [https://pub.dev/api/packages/either_dart](https://pub.dev/api/packages/either_dart) |  |
| preview | known | 0.1.0-nullsafety.2 | 2021-04-19T19:28:02.731740Z | [https://pub.dev/api/packages/either_dart](https://pub.dev/api/packages/either_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/either_dart` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-eaf997ab9b8e84` from `pub_dev` as `registry_expansion`
