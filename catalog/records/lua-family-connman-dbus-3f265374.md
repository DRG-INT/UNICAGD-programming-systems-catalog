...
<!-- canonical: https://luarocks.org/modules/stefano-m/connman_dbus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/stefano-m/connman_dbus](https://luarocks.org/modules/stefano-m/connman_dbus) |
| Source record ids | luarocks_root_manifest-5dacb8e4bf9ce5 |
...
For a systems engineer, connman_dbus belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-5dacb8e4bf9ce5` from `luarocks_root_manifest` as `registry_expansion`
