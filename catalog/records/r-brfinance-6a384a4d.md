...
<!-- canonical: https://cran.r-project.org/web/packages/brfinance/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/brfinance/index.html](https://cran.r-project.org/web/packages/brfinance/index.html) |
| Source record ids | cran_packages_by_date-29aa907dd4bb2c |
...
For a systems engineer, brfinance belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-25 21:50:02 UTC | [https://cran.r-project.org/web/packages/brfinance/DESCRIPTION](https://cran.r-project.org/web/packages/brfinance/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/brfinance/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-29aa907dd4bb2c` from `cran_packages_by_date` as `registry_expansion`
