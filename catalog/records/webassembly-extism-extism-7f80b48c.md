...
| Canonical URL | [https://github.com/extism/extism](https://github.com/extism/extism) |
| Source record ids | github_search_webassembly-25fa4bae55562c |

## System Engineer Summary

The framework for building with WebAssembly (wasm). Easily & securely load wasm modules, move data,
call functions, and build extensible apps.

## Operational Role

For a systems engineer, extism/extism belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.30.0 | 2026-06-04T16:51:22Z | [https://api.github.com/repos/extism/extism/releases/latest](https://api.github.com/repos/extism/extism/releases/latest) |  |
| preview | known | latest | 2026-07-16T20:41:43Z | [https://api.github.com/repos/extism/extism/releases?per_page=10](https://api.github.com/repos/extism/extism/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/extism/extism/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-25fa4bae55562c` from `github_search_webassembly` as `registry_expansion`
