...
<!-- canonical: https://github.com/MLM2/planetary-flood-sar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MLM2/planetary-flood-sar](https://github.com/MLM2/planetary-flood-sar) |
| Source record ids | github_search_space_maps-bfdfe7fa7d7aa4 |

## System Engineer Summary

Cloud-independent flood detection using Sentinel-1 SAR data via Microsoft Planetary Computer.
Demonstrates before/after radar backscatter change analysis to map flood extent under all weather
conditions.

## Operational Role

For a systems engineer, MLM2/planetary-flood-sar belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-16T19:16:11Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
| Evidence | http://choosealicense.com/licenses/bsd-2-clause/; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-bfdfe7fa7d7aa4` from `github_search_space_maps` as `registry_expansion`
