...
<!-- canonical: https://cran.r-project.org/web/packages/ImpAdaptType2Censor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ImpAdaptType2Censor/index.html](https://cran.r-project.org/web/packages/ImpAdaptType2Censor/index.html) |
| Source record ids | cran_packages_by_date-42972581cf7efc |

## System Engineer Summary

Data Generation and Statistical Inference for Improved Adaptive Type-II Progressive Censoring
Schemes

## Operational Role

For a systems engineer, ImpAdaptType2Censor belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 15:30:02 UTC | [https://cran.r-project.org/web/packages/ImpAdaptType2Censor/DESCRIPTION](https://cran.r-project.org/web/packages/ImpAdaptType2Censor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ImpAdaptType2Censor/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-42972581cf7efc` from `cran_packages_by_date` as `registry_expansion`
