...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/HKUDS/LightRAG -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) |
| Source record ids | github_search_aims-4f295c23eb8a9f |
...
For a systems engineer, HKUDS/LightRAG belongs in the "aim's" inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:10:34Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-4f295c23eb8a9f` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AstrBotDevs/AstrBot | Parser Lexer Ast | [open](aim-s-astrbotdevs-astrbot-e6fbf943.md) |
| labring/FastGPT | Parser Lexer Ast | [open](aim-s-labring-fastgpt-678e4e69.md) |
