...
| Canonical URL | [https://luarocks.org/modules/kibadda/git.nvim](https://luarocks.org/modules/kibadda/git.nvim) |
| Source record ids | luarocks_root_manifest-20fb834ce6542b |

## System Engineer Summary

git.nvim is tracked as an ide editor integration record in the Lua family branch. The source did not
...
For a systems engineer, git.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-20fb834ce6542b` from `luarocks_root_manifest` as `registry_expansion`
