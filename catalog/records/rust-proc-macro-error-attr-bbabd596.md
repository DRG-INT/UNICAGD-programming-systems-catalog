...
<!-- canonical: https://crates.io/crates/proc-macro-error-attr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/proc-macro-error-attr](https://crates.io/crates/proc-macro-error-attr) |
| Source record ids | crates_io-5babb4bbfb2896 |
...
For a systems engineer, proc-macro-error-attr belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2020-07-31T18:06:37.966375Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-5babb4bbfb2896` from `crates_io` as `registry_expansion`
