...
<!-- canonical: https://luarocks.org/modules/vigoux/complementree.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vigoux/complementree.nvim](https://luarocks.org/modules/vigoux/complementree.nvim) |
| Source record ids | luarocks_root_manifest-39626cbee7511c |

## System Engineer Summary

Tree-sitter powered completion framework for neovim

## Operational Role

For a systems engineer, complementree.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-39626cbee7511c` from `luarocks_root_manifest` as `registry_expansion`
