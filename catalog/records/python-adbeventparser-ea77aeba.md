...
<!-- canonical: https://pypi.org/project/adbeventparser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adbeventparser/](https://pypi.org/project/adbeventparser/) |
| Source record ids | pypi_simple-58b7780a33dbb3 |

## System Engineer Summary

Parses the output from 'uiautomator events' in real time and converts it to a list of lists / pandas
DataFrame.

## Operational Role

For a systems engineer, adbeventparser belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2023-11-04T12:26:19.749864Z | [https://pypi.org/pypi/adbeventparser/json](https://pypi.org/pypi/adbeventparser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adbeventparser/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-58b7780a33dbb3` from `pypi_simple` as `registry_expansion`
