...
<!-- canonical: https://hackage.haskell.org/package/mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mcp-server](https://hackage.haskell.org/package/mcp-server) |
| Source record ids | hackage_recent-47efd10c48c5f2 |

## System Engineer Summary

Hackage package recently uploaded by drshade.

## Operational Role

For a systems engineer, mcp-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.2 | 2026-09-08T11:04:50Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-08T13:22:22+00:00`.
...
- `hackage_recent-47efd10c48c5f2` from `hackage_recent` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| csound-expression | Web Framework | [open](haskell-csound-expression-668aa49e.md) |
