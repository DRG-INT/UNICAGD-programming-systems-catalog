...
<!-- canonical: https://cran.r-project.org/web/packages/graphicalMCP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/graphicalMCP/index.html](https://cran.r-project.org/web/packages/graphicalMCP/index.html) |
| Source record ids | cran_packages_by_date-6a470687f31540 |
...
For a systems engineer, graphicalMCP belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-27 02:50:02 UTC | [https://cran.r-project.org/web/packages/graphicalMCP/DESCRIPTION](https://cran.r-project.org/web/packages/graphicalMCP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/graphicalMCP/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6a470687f31540` from `cran_packages_by_date` as `registry_expansion`
