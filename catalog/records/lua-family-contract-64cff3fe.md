...
<!-- canonical: https://luarocks.org/modules/mrogge/contract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mrogge/contract](https://luarocks.org/modules/mrogge/contract) |
| Source record ids | luarocks_root_manifest-329e2058396bc8 |
...
For a systems engineer, contract belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-329e2058396bc8` from `luarocks_root_manifest` as `registry_expansion`
