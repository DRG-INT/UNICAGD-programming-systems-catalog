# jupinter/DigitalAudioEffects

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jupinter/DigitalAudioEffects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jupinter/DigitalAudioEffects](https://github.com/jupinter/DigitalAudioEffects) |
| Source record ids | github_search_effects-917255adb452ae |
...
For a systems engineer, jupinter/DigitalAudioEffects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-04-01T10:25:22Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-917255adb452ae` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jagger2048/Dynamics-processor | Compression | [open](effects-jagger2048-dynamics-processor-ca1bb51c.md) |
