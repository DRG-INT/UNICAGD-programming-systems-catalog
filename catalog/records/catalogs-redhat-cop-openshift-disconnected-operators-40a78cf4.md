# redhat-cop/openshift-disconnected-operators

## Navigation

[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/redhat-cop/openshift-disconnected-operators -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Catalogs |
| Category | Logging Observability |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/redhat-cop/openshift-disconnected-operators](https://github.com/redhat-cop/openshift-disconnected-operators) |
| Source record ids | github_search_catalogs-3c012e3d44b28d |

## System Engineer Summary

redhat-cop/openshift-disconnected-operators is tracked as a logging observability record in the
Catalogs branch. The source did not provide a long description, so this page keeps the identity,
release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, redhat-cop/openshift-disconnected-operators belongs in the Catalogs
inventory as part of diagnostics, metrics, auditability, tracing, and incident response.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-05T23:15:39Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:catalog stars:>50", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-3c012e3d44b28d` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amundsen-io/amundsen | Logging Observability | [open](catalogs-amundsen-io-amundsen-34c1f00a.md) |
| apache/polaris | Logging Observability | [open](catalogs-apache-polaris-7eac00da.md) |
| aws-samples/aws-dbs-refarch-datalake | Logging Observability | [open](catalogs-aws-samples-aws-dbs-refarch-datalake-d639ef15.md) |
| CodeCavePro/revitless-toolkit | Logging Observability | [open](catalogs-codecavepro-revitless-toolkit-c3c016b5.md) |
| CS-SI/eodag | Logging Observability | [open](catalogs-cs-si-eodag-85e7685e.md) |
| danricho/where_the | Logging Observability | [open](catalogs-danricho-where-the-79411964.md) |
| Dansoftowner/Boomega | Logging Observability | [open](catalogs-dansoftowner-boomega-ec1e6e4d.md) |
| flyteorg/datacatalog | Logging Observability | [open](catalogs-flyteorg-datacatalog-d5667377.md) |
