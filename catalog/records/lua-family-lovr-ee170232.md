...
| Source record ids | master-cd6d00fec362 |

## System Engineer Summary

LÖVR is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, LÖVR belongs in the Lua family inventory as part of ecosystem capability
...
- `master-cd6d00fec362` from `master_json` as `game_engine_game_dev`
