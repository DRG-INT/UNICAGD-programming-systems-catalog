...
<!-- canonical: https://crates.io/crates/anstyle-query -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/anstyle-query](https://crates.io/crates/anstyle-query) |
| Source record ids | crates_io-899f68a9f60e57 |
...
For a systems engineer, anstyle-query belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2025-11-13T17:30:22.615151Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-899f68a9f60e57` from `crates_io` as `registry_expansion`
