...
| Canonical URL | [https://packagist.org/packages/davedevelopment/phpmig](https://packagist.org/packages/davedevelopment/phpmig) |
| Source record ids | packagist_search-44b7e7d40cb451 |
...
For a systems engineer, davedevelopment/phpmig belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.1 | 2020-07-09T09:38:17+00:00 | [https://repo.packagist.org/p2/davedevelopment/phpmig.json](https://repo.packagist.org/p2/davedevelopment/phpmig.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/davedevelopment/phpmig.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-44b7e7d40cb451` from `packagist_search` as `registry_expansion`
