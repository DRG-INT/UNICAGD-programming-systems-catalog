...
<!-- canonical: https://cran.r-project.org/web/packages/ClustBlock/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ClustBlock/index.html](https://cran.r-project.org/web/packages/ClustBlock/index.html) |
| Source record ids | cran_packages_by_date-5c9b5b2e468116 |

## System Engineer Summary

ClustBlock is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, ClustBlock belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.0 | 2026-09-05 15:40:27 UTC | [https://cran.r-project.org/web/packages/ClustBlock/DESCRIPTION](https://cran.r-project.org/web/packages/ClustBlock/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ClustBlock/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-5c9b5b2e468116` from `cran_packages_by_date` as `registry_expansion`
