...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Undefined Behavior Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/undefined-behavior-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [http://notebook.kulchenko.com/programming/lua-good-different-bad-and-ugly-parts](http://notebook.kulchenko.com/programming/lua-good-different-bad-and-ugly-parts) |
| Source record ids | lua-source-398 |

## System Engineer Summary

A thorough summary of the good, different, bad, and ugly aspects of Lua, including many subtle
quirks, by the author of ZeroBraneStudio.

## Operational Role

For a systems engineer, Lua: Good, bad, and ugly parts belongs in the Lua family inventory as part
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 398}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-398` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| 30log | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-30log-518c31f7.md) |
| AC-LuaServer | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ac-luaserver-5d9557a8.md) |
| aistemsplitter | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aistemsplitter-1c666ef2.md) |
| ansicolors | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ansicolors-f9d67df1.md) |
| api7-lua-tinyyaml | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-tinyyaml-bc999d3b.md) |
| apicast-cli | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-apicast-cli-6102ddfc.md) |
| argparse | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argparse-9c28f8ab.md) |
| awesome-love2d | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-love2d-b6a66dad.md) |
