...
| Source record ids | corpus-5edd11959546a7 |

## System Engineer Summary

Solar2D is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, Solar2D belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-5edd11959546a7` from `master_json` as `game_engine_game_dev`
