...
<!-- canonical: https://github.com/microsoft/auteur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/auteur](https://github.com/microsoft/auteur) |
| Source record ids | github_search_effects-cc64598184a69f |
...
For a systems engineer, microsoft/auteur belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-21T22:47:40Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-cc64598184a69f` from `github_search_effects` as `registry_expansion`
