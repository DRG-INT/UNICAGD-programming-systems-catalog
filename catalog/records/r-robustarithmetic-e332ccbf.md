...
<!-- canonical: https://cran.r-project.org/web/packages/RobustArithmetic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RobustArithmetic/index.html](https://cran.r-project.org/web/packages/RobustArithmetic/index.html) |
| Source record ids | cran_packages_by_date-ff1d1a75fadeb7 |
...
For a systems engineer, RobustArithmetic belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 09:00:07 UTC | [https://cran.r-project.org/web/packages/RobustArithmetic/DESCRIPTION](https://cran.r-project.org/web/packages/RobustArithmetic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RobustArithmetic/DESCRIPTION` at `2026-09-12T10:18:41+00:00`.
...
- `cran_packages_by_date-ff1d1a75fadeb7` from `cran_packages_by_date` as `registry_expansion`
