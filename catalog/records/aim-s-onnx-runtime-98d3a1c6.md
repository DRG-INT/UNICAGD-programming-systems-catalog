...
| Canonical URL | [https://github.com/microsoft/onnxruntime](https://github.com/microsoft/onnxruntime) |
| Source record ids | curated_language_routes-69b524139441e9 |

## System Engineer Summary

Inference runtime for ONNX models across CPU, GPU, browser, mobile, and server deployments.

## Operational Role

For a systems engineer, ONNX Runtime belongs in the "aim's" inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.29.0 | 2026-08-12T06:15:37Z | [https://api.github.com/repos/microsoft/onnxruntime/releases/latest](https://api.github.com/repos/microsoft/onnxruntime/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/microsoft/onnxruntime/releases/latest` at `2026-09-01T12:30:31+00:00`.
...
- `curated_language_routes-69b524139441e9` from `curated_language_routes` as `registry_expansion`
