...
<!-- canonical: https://pub.dev/packages/sqlite3_flutter_libs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sqlite3_flutter_libs](https://pub.dev/packages/sqlite3_flutter_libs) |
| Source record ids | pub_dev-5864a9b8e529de |
...
For a systems engineer, sqlite3_flutter_libs belongs in the Dart inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0+eol | 2026-02-15T18:55:45.668038Z | [https://pub.dev/api/packages/sqlite3_flutter_libs](https://pub.dev/api/packages/sqlite3_flutter_libs) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sqlite3_flutter_libs` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-5864a9b8e529de` from `pub_dev` as `registry_expansion`
