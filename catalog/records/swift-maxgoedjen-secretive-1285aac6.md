...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/maxgoedjen/secretive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maxgoedjen/secretive](https://github.com/maxgoedjen/secretive) |
| Source record ids | github_search_swift-115ff6aca1e134 |
...
For a systems engineer, maxgoedjen/secretive belongs in the Swift inventory as part of supply-chain
...
- `github_search_swift-115ff6aca1e134` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kishikawakatsumi/KeychainAccess | Security Sast | [open](swift-kishikawakatsumi-keychainaccess-2b061829.md) |
