...
<!-- canonical: https://hackage.haskell.org/package/pure-cdt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pure-cdt](https://hackage.haskell.org/package/pure-cdt) |
| Source record ids | hackage_recent-665acdb3037336 |

## System Engineer Summary

Hackage package recently uploaded by Elyukov.

## Operational Role

For a systems engineer, pure-cdt belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-09-04T14:23:34Z | [https://hackage.haskell.org/package/pure-cdt](https://hackage.haskell.org/package/pure-cdt) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pure-cdt` at `2026-09-04T17:20:31+00:00`.
...
- `hackage_recent-665acdb3037336` from `hackage_recent` as `registry_expansion`
