...
<!-- canonical: https://cran.r-project.org/web/packages/S3VS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/S3VS/index.html](https://cran.r-project.org/web/packages/S3VS/index.html) |
| Source record ids | cran_packages_by_date-2fdb000c155cb5 |
...
For a systems engineer, S3VS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-09-07 07:00:02 UTC | [https://cran.r-project.org/web/packages/S3VS/DESCRIPTION](https://cran.r-project.org/web/packages/S3VS/DESCRIPTION) |  |
...
| Evidence | Other; Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/S3VS/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-2fdb000c155cb5` from `cran_packages_by_date` as `registry_expansion`
