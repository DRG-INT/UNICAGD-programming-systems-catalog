...
<!-- canonical: https://github.com/aaronfagan/svg-credit-card-payment-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aaronfagan/svg-credit-card-payment-icons](https://github.com/aaronfagan/svg-credit-card-payment-icons) |
| Source record ids | github_search_icons_and_logos-6948a3a1e9f229 |
...
For a systems engineer, aaronfagan/svg-credit-card-payment-icons belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T18:09:11Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-6948a3a1e9f229` from `github_search_icons_and_logos` as `registry_expansion`
