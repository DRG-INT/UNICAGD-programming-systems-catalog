...
<!-- canonical: https://github.com/zenbones-theme/zenbones-mono -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zenbones-theme/zenbones-mono](https://github.com/zenbones-theme/zenbones-mono) |
| Source record ids | github_search_font_briefcase-da06871c6197c9 |
...
For a systems engineer, zenbones-theme/zenbones-mono belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-03T07:17:46Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; zlib License; https://api.github.com/licenses/zlib; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `github_search_font_briefcase-da06871c6197c9` from `github_search_font_briefcase` as `registry_expansion`
