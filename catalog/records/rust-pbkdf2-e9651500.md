...
<!-- canonical: https://crates.io/crates/pbkdf2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pbkdf2](https://crates.io/crates/pbkdf2) |
| Source record ids | crates_io-24167ef9e303e0 |
...
For a systems engineer, pbkdf2 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-04-21T13:26:45.248211Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-24167ef9e303e0` from `crates_io` as `registry_expansion`
