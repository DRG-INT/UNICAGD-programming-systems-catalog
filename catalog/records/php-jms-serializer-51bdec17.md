...
<!-- canonical: https://packagist.org/packages/jms/serializer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jms/serializer](https://packagist.org/packages/jms/serializer) |
| Source record ids | packagist_search-e6d3f56461bcfe |
...
For a systems engineer, jms/serializer belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-e6d3f56461bcfe` from `packagist_search` as `registry_expansion`
