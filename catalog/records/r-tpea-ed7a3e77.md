...
<!-- canonical: https://cran.r-project.org/web/packages/TPEA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TPEA/index.html](https://cran.r-project.org/web/packages/TPEA/index.html) |
| Source record ids | cran_packages_by_date-4999de5325ad93 |
...
For a systems engineer, TPEA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-09-02 09:30:11 UTC | [https://cran.r-project.org/web/packages/TPEA/DESCRIPTION](https://cran.r-project.org/web/packages/TPEA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TPEA/DESCRIPTION` at `2026-09-02T10:21:04+00:00`.
...
- `cran_packages_by_date-4999de5325ad93` from `cran_packages_by_date` as `registry_expansion`
