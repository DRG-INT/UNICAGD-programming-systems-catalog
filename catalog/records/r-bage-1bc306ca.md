...
<!-- canonical: https://cran.r-project.org/web/packages/bage/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bage/index.html](https://cran.r-project.org/web/packages/bage/index.html) |
| Source record ids | cran_packages_by_date-19629fe22ad509 |
...
For a systems engineer, bage belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.10 | 2026-08-21 23:10:02 UTC | [https://cran.r-project.org/web/packages/bage/DESCRIPTION](https://cran.r-project.org/web/packages/bage/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bage/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-19629fe22ad509` from `cran_packages_by_date` as `registry_expansion`
