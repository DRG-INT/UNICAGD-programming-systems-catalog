...
<!-- canonical: https://github.com/lipp/lua-websockets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lipp/lua-websockets](https://github.com/lipp/lua-websockets) |
| Source record ids | lua-source-291 |
...
For a systems engineer, lua-websockets belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 291}}` |
...
- `lua-source-291` from `master_json` as `source_list_item`
