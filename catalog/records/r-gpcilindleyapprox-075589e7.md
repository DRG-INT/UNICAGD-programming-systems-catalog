...
<!-- canonical: https://cran.r-project.org/web/packages/gpciLindleyApprox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpciLindleyApprox/index.html](https://cran.r-project.org/web/packages/gpciLindleyApprox/index.html) |
| Source record ids | cran_packages_by_date-d23e83ac33b9ba |
...
For a systems engineer, gpciLindleyApprox belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 12:50:25 UTC | [https://cran.r-project.org/web/packages/gpciLindleyApprox/DESCRIPTION](https://cran.r-project.org/web/packages/gpciLindleyApprox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpciLindleyApprox/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d23e83ac33b9ba` from `cran_packages_by_date` as `registry_expansion`
