...
<!-- canonical: https://luarocks.org/modules/neorocks/blink.lib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/blink.lib](https://luarocks.org/modules/neorocks/blink.lib) |
| Source record ids | luarocks_root_manifest-6331dbd6afa619 |
...
For a systems engineer, blink.lib belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6331dbd6afa619` from `luarocks_root_manifest` as `registry_expansion`
