...
| Source record ids | corpus-edd382df9fbef1 |

## System Engineer Summary

Pegasus.lua is tracked as a web framework record in the Lua family branch. The source did not
...
For a systems engineer, Pegasus.lua belongs in the Lua family inventory as part of request routing,
...
- `corpus-edd382df9fbef1` from `master_json` as `web_framework`
