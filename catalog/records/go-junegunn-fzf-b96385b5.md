...
<!-- canonical: https://github.com/junegunn/fzf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/junegunn/fzf](https://github.com/junegunn/fzf) |
| Source record ids | github_search_go-b2503069b2978d |
...
For a systems engineer, junegunn/fzf belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T01:07:45Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-b2503069b2978d` from `github_search_go` as `registry_expansion`
