...
<!-- canonical: https://cran.r-project.org/web/packages/TextAnalysisR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TextAnalysisR/index.html](https://cran.r-project.org/web/packages/TextAnalysisR/index.html) |
| Source record ids | cran_packages_by_date-b401fc63640aff |
...
For a systems engineer, TextAnalysisR belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-13 07:00:02 UTC | [https://cran.r-project.org/web/packages/TextAnalysisR/DESCRIPTION](https://cran.r-project.org/web/packages/TextAnalysisR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TextAnalysisR/DESCRIPTION` at `2026-09-13T08:20:51+00:00`.
...
- `cran_packages_by_date-b401fc63640aff` from `cran_packages_by_date` as `registry_expansion`
