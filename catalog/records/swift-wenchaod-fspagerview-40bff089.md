...
<!-- canonical: https://github.com/WenchaoD/FSPagerView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WenchaoD/FSPagerView](https://github.com/WenchaoD/FSPagerView) |
| Source record ids | github_search_swift-72602537da139b |

## System Engineer Summary

FSPagerView is an elegant Screen Slide Library. It is extremely helpful for making Banner
View、Product Show、Welcome/Guide Pages、Screen/ViewController Sliders.

## Operational Role

For a systems engineer, WenchaoD/FSPagerView belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-72602537da139b` from `github_search_swift` as `registry_expansion`
