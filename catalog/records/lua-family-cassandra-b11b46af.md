...
<!-- canonical: https://luarocks.org/modules/jbochi/cassandra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jbochi/cassandra](https://luarocks.org/modules/jbochi/cassandra) |
| Source record ids | luarocks_root_manifest-73489f0d5c7fe8 |
...
For a systems engineer, cassandra belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-73489f0d5c7fe8` from `luarocks_root_manifest` as `registry_expansion`
