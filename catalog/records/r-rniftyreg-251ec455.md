...
<!-- canonical: https://cran.r-project.org/web/packages/RNiftyReg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RNiftyReg/index.html](https://cran.r-project.org/web/packages/RNiftyReg/index.html) |
| Source record ids | cran_packages_by_date-29a1f40dc96f40 |
...
For a systems engineer, RNiftyReg belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.6 | 2026-08-21 10:30:10 UTC | [https://cran.r-project.org/web/packages/RNiftyReg/DESCRIPTION](https://cran.r-project.org/web/packages/RNiftyReg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RNiftyReg/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-29a1f40dc96f40` from `cran_packages_by_date` as `registry_expansion`
