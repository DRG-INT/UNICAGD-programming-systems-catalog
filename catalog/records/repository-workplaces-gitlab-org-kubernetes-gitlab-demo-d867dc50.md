# gitlab-org/kubernetes-gitlab-demo
...
<!-- canonical: https://gitlab.com/gitlab-org/kubernetes-gitlab-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/kubernetes-gitlab-demo](https://gitlab.com/gitlab-org/kubernetes-gitlab-demo) |
| Source record ids | gitlab_projects_api-e0313d270df322 |

## System Engineer Summary

DEPRECATED - Idea to Production GitLab Demo running on Kubernetes

## Operational Role

For a systems engineer, gitlab-org/kubernetes-gitlab-demo belongs in the Repository Workplaces
...
- `gitlab_projects_api-e0313d270df322` from `gitlab_projects_api` as `registry_expansion`
