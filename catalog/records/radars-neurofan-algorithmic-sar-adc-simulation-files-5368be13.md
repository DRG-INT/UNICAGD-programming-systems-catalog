...
| Source record ids | github_search_radars-17fea52fe5a922 |
...
For a systems engineer, NeuroFan/Algorithmic-SAR-ADC-simulation-files belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-29T10:51:12Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-17fea52fe5a922` from `github_search_radars` as `registry_expansion`
