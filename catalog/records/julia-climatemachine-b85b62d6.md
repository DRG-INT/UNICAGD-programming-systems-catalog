...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimateMachine](https://github.com/JuliaRegistries/General/tree/master/C/ClimateMachine) |
| Source record ids | julia_general-2fa1c68990c790 |

## System Engineer Summary

Julia package registered in General at C/ClimateMachine.

## Operational Role

For a systems engineer, ClimateMachine belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimateMachine", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-2fa1c68990c790` from `julia_general` as `registry_expansion`
