...
<!-- canonical: https://github.com/ShareDropio/sharedrop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ShareDropio/sharedrop](https://github.com/ShareDropio/sharedrop) |
| Source record ids | github_search_video-e1b1ca7dcb44ec |
...
For a systems engineer, ShareDropio/sharedrop belongs in the Video inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-10T10:47:15Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-e1b1ca7dcb44ec` from `github_search_video` as `registry_expansion`
