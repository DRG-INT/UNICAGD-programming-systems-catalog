...
<!-- canonical: https://cran.r-project.org/web/packages/bbqr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bbqr/index.html](https://cran.r-project.org/web/packages/bbqr/index.html) |
| Source record ids | cran_packages_by_date-0d9db9f8223825 |
...
For a systems engineer, bbqr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:00:13 UTC | [https://cran.r-project.org/web/packages/bbqr/DESCRIPTION](https://cran.r-project.org/web/packages/bbqr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bbqr/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-0d9db9f8223825` from `cran_packages_by_date` as `registry_expansion`
