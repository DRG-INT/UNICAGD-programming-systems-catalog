...
<!-- canonical: https://hackage.haskell.org/package/x509-store -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/x509-store](https://hackage.haskell.org/package/x509-store) |
| Source record ids | hackage_top_downloads-764cb04b12b900 |
...
For a systems engineer, x509-store belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.9 | 2022-01-18T04:06:41Z | [https://hackage.haskell.org/package/x509-store](https://hackage.haskell.org/package/x509-store) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/x509-store` at `2026-09-01T14:24:43+00:00`.
...
- `hackage_top_downloads-764cb04b12b900` from `hackage_top_downloads` as `registry_expansion`
