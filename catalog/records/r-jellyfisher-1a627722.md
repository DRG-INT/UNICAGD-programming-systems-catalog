...
<!-- canonical: https://cran.r-project.org/web/packages/jellyfisher/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jellyfisher/index.html](https://cran.r-project.org/web/packages/jellyfisher/index.html) |
| Source record ids | cran_packages_by_date-cd3a2a22bf36bf |
...
For a systems engineer, jellyfisher belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-21 08:50:02 UTC | [https://cran.r-project.org/web/packages/jellyfisher/DESCRIPTION](https://cran.r-project.org/web/packages/jellyfisher/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jellyfisher/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cd3a2a22bf36bf` from `cran_packages_by_date` as `registry_expansion`
