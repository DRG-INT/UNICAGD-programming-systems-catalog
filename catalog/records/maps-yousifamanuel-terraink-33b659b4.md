...
<!-- canonical: https://github.com/yousifamanuel/terraink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yousifamanuel/terraink](https://github.com/yousifamanuel/terraink) |
| Source record ids | github_search_maps-9ac3d0f613177a |
...
For a systems engineer, yousifamanuel/terraink belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T21:00:45Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9ac3d0f613177a` from `github_search_maps` as `registry_expansion`
