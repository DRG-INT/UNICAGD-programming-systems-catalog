...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Sanitizer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/sanitizer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-0230a4c0b8be |

## System Engineer Summary

AddressSanitizer is tracked as a sanitizer record in the C99 branch. The source did not provide a
...
For a systems engineer, AddressSanitizer belongs in the C99 inventory as part of ecosystem
...
- `master-0230a4c0b8be` from `master_json` as `sanitizer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| MemorySanitizer | Sanitizer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-memorysanitizer-faf626af.md) |
| ThreadSanitizer | Sanitizer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-threadsanitizer-faea2e9c.md) |
| UndefinedBehaviorSanitizer | Sanitizer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-undefinedbehaviorsanitizer-485893a0.md) |
