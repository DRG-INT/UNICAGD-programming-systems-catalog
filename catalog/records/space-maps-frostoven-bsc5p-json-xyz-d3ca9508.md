...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/frostoven/BSC5P-JSON-XYZ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/frostoven/BSC5P-JSON-XYZ](https://github.com/frostoven/BSC5P-JSON-XYZ) |
| Source record ids | github_search_space_maps-a1e523a91a0ccd |

## System Engineer Summary

Contains real Earth-visible stars and color data with 3D x,y,z coordinates

## Operational Role

For a systems engineer, frostoven/BSC5P-JSON-XYZ belongs in the Space Maps inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-15T01:30:08Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a1e523a91a0ccd` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jacobwilliams/jsonspice | Serialization | [open](space-maps-jacobwilliams-jsonspice-6c43fe1c.md) |
