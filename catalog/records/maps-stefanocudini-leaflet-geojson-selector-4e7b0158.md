...
<!-- canonical: https://github.com/stefanocudini/leaflet-geojson-selector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stefanocudini/leaflet-geojson-selector](https://github.com/stefanocudini/leaflet-geojson-selector) |
| Source record ids | github_search_maps-9066a817d3593c |
...
For a systems engineer, stefanocudini/leaflet-geojson-selector belongs in the Maps inventory as part
of input-space exploration, parser hardening, and unsafe edge-case discovery.
...
- `github_search_maps-9066a817d3593c` from `github_search_maps` as `registry_expansion`
