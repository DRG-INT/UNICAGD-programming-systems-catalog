...
<!-- canonical: https://github.com/dsoprea/go-jpeg-image-structure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dsoprea/go-jpeg-image-structure](https://github.com/dsoprea/go-jpeg-image-structure) |
| Source record ids | github_search_photography-2b923166a4b9e1 |

## System Engineer Summary

Parse JPEG data into segments via code or CLI from pure Go. Read/export/write EXIF data. Read XMP
and IPTC metadata.

## Operational Role

For a systems engineer, dsoprea/go-jpeg-image-structure belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-12T07:44:22Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-2b923166a4b9e1` from `github_search_photography` as `registry_expansion`
