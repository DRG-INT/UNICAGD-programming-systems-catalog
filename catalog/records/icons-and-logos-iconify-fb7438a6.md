...
<!-- canonical: https://github.com/iconify/iconify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iconify/iconify](https://github.com/iconify/iconify) |
| Source record ids | curated_language_routes-30cb7fa7fe16cd |

## System Engineer Summary

Unified icon framework and package ecosystem for many icon sets across web frameworks.

## Operational Role

For a systems engineer, Iconify belongs in the Icons and Logos inventory as part of ecosystem
...
- `curated_language_routes-30cb7fa7fe16cd` from `curated_language_routes` as `registry_expansion`
