...
<!-- canonical: https://luarocks.org/modules/kikito/bump -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kikito/bump](https://luarocks.org/modules/kikito/bump) |
| Source record ids | luarocks_root_manifest-b0495dcf8c2d3a |
...
For a systems engineer, bump belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b0495dcf8c2d3a` from `luarocks_root_manifest` as `registry_expansion`
