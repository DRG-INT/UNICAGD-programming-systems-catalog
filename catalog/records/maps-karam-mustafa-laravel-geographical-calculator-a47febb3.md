...
<!-- canonical: https://github.com/karam-mustafa/laravel-geographical-calculator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/karam-mustafa/laravel-geographical-calculator](https://github.com/karam-mustafa/laravel-geographical-calculator) |
| Source record ids | github_search_maps-b8e3769d13a876 |

## System Engineer Summary

laravel package helps you to implement geographical calculation, with several algorithms that help
you deal with coordinates and distances.

## Operational Role

For a systems engineer, karam-mustafa/laravel-geographical-calculator belongs in the Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.0 | 2022-02-08T20:08:17Z | [https://api.github.com/repos/karam-mustafa/laravel-geographical-calculator/releases/latest](https://api.github.com/repos/karam-mustafa/laravel-geographical-calculator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/karam-mustafa/laravel-geographical-calculator/releases/latest` at `2026-09-01T12:30:01+00:00`.
...
- `github_search_maps-b8e3769d13a876` from `github_search_maps` as `registry_expansion`
