...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: "aim's"](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/aim-s.md) · [Category: Tutorial Book Styleguide](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/tutorial-book-styleguide.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/openai/openai-cookbook](https://github.com/openai/openai-cookbook) |
| Source record ids | curated_language_routes-13e6f9d8e77f23 |

## System Engineer Summary

Example corpus for model calls, retrieval, evals, tool use, structured outputs, and applied AI
engineering workflows.

## Operational Role

For a systems engineer, OpenAI Cookbook belongs in the "aim's" inventory as part of ecosystem
...
- `curated_language_routes-13e6f9d8e77f23` from `curated_language_routes` as `registry_expansion`
