...
<!-- canonical: https://www.nuget.org/packages/App.Metrics.Formatters.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/App.Metrics.Formatters.Json](https://www.nuget.org/packages/App.Metrics.Formatters.Json) |
| Source record ids | nuget_search-8f83bcd9a24475 |
...
For a systems engineer, App.Metrics.Formatters.Json belongs in the C-Sharp inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2021-11-26T11:10:10.213+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.formatters.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.formatters.json/index.json) |  |
| preview | known | 4.4.0-preview.0.4 | 2021-11-26T11:52:17.57+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.formatters.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.formatters.json/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; Apache-2.0; https://www.nuget.org/packages/App.Metrics.Formatters.Json/4.3.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.formatters.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-8f83bcd9a24475` from `nuget_search` as `registry_expansion`
