...
<!-- canonical: https://pub.dev/packages/sensors_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sensors_plus](https://pub.dev/packages/sensors_plus) |
| Source record ids | pub_dev-729c1aed00b675 |
...
For a systems engineer, sensors_plus belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2026-06-26T12:35:16.768644Z | [https://pub.dev/api/packages/sensors_plus](https://pub.dev/api/packages/sensors_plus) |  |
| preview | known | 1.0.0-nullsafety.0 | 2021-02-22T17:43:06.183419Z | [https://pub.dev/api/packages/sensors_plus](https://pub.dev/api/packages/sensors_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sensors_plus` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-729c1aed00b675` from `pub_dev` as `registry_expansion`
