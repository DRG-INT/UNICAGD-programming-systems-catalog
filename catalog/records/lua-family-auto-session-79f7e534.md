...
<!-- canonical: https://luarocks.org/modules/neorocks/auto-session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/auto-session](https://luarocks.org/modules/neorocks/auto-session) |
| Source record ids | luarocks_root_manifest-8fb46f88865826 |
...
For a systems engineer, auto-session belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-8fb46f88865826` from `luarocks_root_manifest` as `registry_expansion`
