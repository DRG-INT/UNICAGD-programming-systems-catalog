...
| Source record ids | github_search_satcom_satellites-16e124380bf09c |
...
For a systems engineer, ATTron/astroz belongs in the SatCom Satellites inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T04:38:36Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-16e124380bf09c` from `github_search_satcom_satellites` as `registry_expansion`
