...
<!-- canonical: https://github.com/BASI-LABS/parseltongue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BASI-LABS/parseltongue](https://github.com/BASI-LABS/parseltongue) |
| Source record ids | github_search_space_maps-54f5c50aa03c5d |

## System Engineer Summary

Parseltongue is a powerful prompt hacking tool/browser extension for real-time tokenization
visualization and seamless text conversion, supporting formats like binary, base64, leetspeak,
special characters, and multiple languages. Perfect for red teamers, developers, linguists, and
latent space explorers.

## Operational Role

For a systems engineer, BASI-LABS/parseltongue belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-11T23:48:20Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-54f5c50aa03c5d` from `github_search_space_maps` as `registry_expansion`
