...
<!-- canonical: https://github.com/IMS-AS-LUH/sar-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IMS-AS-LUH/sar-sim](https://github.com/IMS-AS-LUH/sar-sim) |
| Source record ids | github_search_radars-b2757d9f5da1ed |

## System Engineer Summary

Python Based Simulation and Analysis tool for Synthetic Aperture Radar

## Operational Role

For a systems engineer, IMS-AS-LUH/sar-sim belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-19T15:39:59Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-b2757d9f5da1ed` from `github_search_radars` as `registry_expansion`
