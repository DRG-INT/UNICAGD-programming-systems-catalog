...
| Canonical URL | [https://github.com/mediaelement/mediaelement](https://github.com/mediaelement/mediaelement) |
| Source record ids | github_search_video-f833448a38727f |

## System Engineer Summary

HTML5 <audio> or <video> player with support for MP4, WebM, and MP3 as well as HLS, Dash, YouTube,
Facebook, SoundCloud and others with a common HTML5 MediaElement API, enabling a consistent UI in
all browsers.

## Operational Role

For a systems engineer, mediaelement/mediaelement belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2025-11-12T10:26:32Z | [https://api.github.com/repos/mediaelement/mediaelement/releases/latest](https://api.github.com/repos/mediaelement/mediaelement/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mediaelement/mediaelement/releases/latest` at `2026-09-01T09:23:24+00:00`.
...
- `github_search_video-f833448a38727f` from `github_search_video` as `registry_expansion`
