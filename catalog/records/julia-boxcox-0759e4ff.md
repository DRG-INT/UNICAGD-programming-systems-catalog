...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoxCox](https://github.com/JuliaRegistries/General/tree/master/B/BoxCox) |
| Source record ids | julia_general-18a98f50aaa4df |

## System Engineer Summary

Julia package registered in General at B/BoxCox.

## Operational Role

For a systems engineer, BoxCox belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoxCox", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-18a98f50aaa4df` from `julia_general` as `registry_expansion`
