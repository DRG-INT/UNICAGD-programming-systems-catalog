...
<!-- canonical: https://packagist.org/packages/league/factory-muffin-faker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/league/factory-muffin-faker](https://packagist.org/packages/league/factory-muffin-faker) |
| Source record ids | packagist_search-9a2dc3e28959e7 |
...
For a systems engineer, league/factory-muffin-faker belongs in the PHP inventory as part of build
...
- `packagist_search-9a2dc3e28959e7` from `packagist_search` as `registry_expansion`
