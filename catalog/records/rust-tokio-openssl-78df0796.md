...
| Canonical URL | [https://crates.io/crates/tokio-openssl](https://crates.io/crates/tokio-openssl) |
| Source record ids | crates_io-04eadd7cbbfb6c |
...
For a systems engineer, tokio-openssl belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2024-09-14T17:13:54.196612Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-04eadd7cbbfb6c` from `crates_io` as `registry_expansion`
