...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/bepsvpt/secure-headers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/bepsvpt/secure-headers](https://packagist.org/packages/bepsvpt/secure-headers) |
| Source record ids | packagist_search-8b9026f6dc8a3b |

## System Engineer Summary

Add security related headers to HTTP response. The package includes Service Providers for easy
Laravel integration.

## Operational Role

For a systems engineer, bepsvpt/secure-headers belongs in the PHP inventory as part of supply-chain
...
- `packagist_search-8b9026f6dc8a3b` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| nelmio/security-bundle | Security Sast | [open](php-nelmio-security-bundle-c1ae4a9d.md) |
| setbased/php-audit | Security Sast | [open](php-setbased-php-audit-a876d972.md) |
| simplethings/entity-audit-bundle | Security Sast | [open](php-simplethings-entity-audit-bundle-48023dbc.md) |
| sonata-project/entity-audit-bundle | Security Sast | [open](php-sonata-project-entity-audit-bundle-d317a63e.md) |
| stefangabos/zebra_session | Security Sast | [open](php-stefangabos-zebra-session-01f22254.md) |
| symfony/security-http | Security Sast | [open](php-symfony-security-http-c022bb52.md) |
