...
<!-- canonical: https://pub.dev/packages/async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/async](https://pub.dev/packages/async) |
| Source record ids | pub_dev-4b85d04a69a754 |
...
For a systems engineer, async belongs in the Dart inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.13.1 | 2026-03-26T00:53:13.853173Z | [https://pub.dev/api/packages/async](https://pub.dev/api/packages/async) |  |
| preview | known | 2.5.0-nullsafety.3 | 2020-11-03T22:12:25.228263Z | [https://pub.dev/api/packages/async](https://pub.dev/api/packages/async) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/async` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-4b85d04a69a754` from `pub_dev` as `registry_expansion`
...
| synchronized | Async Runtime | [open](dart-synchronized-efe2aca5.md) |
