...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/v-modal/vmodal_sdk_android -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/v-modal/vmodal_sdk_android](https://github.com/v-modal/vmodal_sdk_android) |
| Source record ids | github_search_video-0134bdd5fd43be |
...
For a systems engineer, v-modal/vmodal_sdk_android belongs in the Video inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T16:45:19Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_video-0134bdd5fd43be` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| redpanda-data/redpanda | Interpreter Runtime | [open](video-redpanda-data-redpanda-67d7afe6.md) |
