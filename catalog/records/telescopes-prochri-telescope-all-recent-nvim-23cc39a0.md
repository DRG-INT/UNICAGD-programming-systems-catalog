...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/prochri/telescope-all-recent.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/prochri/telescope-all-recent.nvim](https://github.com/prochri/telescope-all-recent.nvim) |
| Source record ids | github_search_telescopes-c7e5f206db24e6 |
...
For a systems engineer, prochri/telescope-all-recent.nvim belongs in the Telescopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T17:41:39Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-09 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:telescope stars:>10", "retrieved": "2026-09-09", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-c7e5f206db24e6` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xJohnnyboy/scretch.nvim | Ide Editor Integration | [open](telescopes-0xjohnnyboy-scretch-nvim-f6966b66.md) |
| 2KAbhishek/nerdy.nvim | Ide Editor Integration | [open](telescopes-2kabhishek-nerdy-nvim-defd76cd.md) |
| 2KAbhishek/pickme.nvim | Ide Editor Integration | [open](telescopes-2kabhishek-pickme-nvim-dc5f28fc.md) |
| alexpasmantier/tv.nvim | Ide Editor Integration | [open](telescopes-alexpasmantier-tv-nvim-6a62173d.md) |
| Allaman/emoji.nvim | Ide Editor Integration | [open](telescopes-allaman-emoji-nvim-992780a5.md) |
| AlphaTechnolog/pywal.nvim | Ide Editor Integration | [open](telescopes-alphatechnolog-pywal-nvim-15fcecb4.md) |
| archie-judd/telescope-words.nvim | Ide Editor Integration | [open](telescopes-archie-judd-telescope-words-nvim-225d2743.md) |
| axkirillov/easypick.nvim | Ide Editor Integration | [open](telescopes-axkirillov-easypick-nvim-8c09cea0.md) |
