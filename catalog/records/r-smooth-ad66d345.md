...
<!-- canonical: https://cran.r-project.org/web/packages/smooth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smooth/index.html](https://cran.r-project.org/web/packages/smooth/index.html) |
| Source record ids | cran_packages_by_date-3a17a2d20afa16 |
...
For a systems engineer, smooth belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.2 | 2026-09-04 12:30:02 UTC | [https://cran.r-project.org/web/packages/smooth/DESCRIPTION](https://cran.r-project.org/web/packages/smooth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smooth/DESCRIPTION` at `2026-09-04T14:19:07+00:00`.
...
- `cran_packages_by_date-3a17a2d20afa16` from `cran_packages_by_date` as `registry_expansion`
