...
<!-- canonical: https://github.com/JohnVV/MyCelestiaBuild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JohnVV/MyCelestiaBuild](https://github.com/JohnVV/MyCelestiaBuild) |
| Source record ids | github_search_space_maps-6db7cf75415837 |

## System Engineer Summary

The cpoy of the develipment Celestia code i use

## Operational Role

For a systems engineer, JohnVV/MyCelestiaBuild belongs in the Space Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-25T07:00:37Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-6db7cf75415837` from `github_search_space_maps` as `registry_expansion`
