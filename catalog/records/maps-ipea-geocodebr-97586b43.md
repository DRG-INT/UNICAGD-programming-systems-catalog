...
| Canonical URL | [https://github.com/ipea/geocodebr](https://github.com/ipea/geocodebr) |
| Source record ids | github_search_maps-b51e98486fb298 |
...
For a systems engineer, ipea/geocodebr belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.4 | 2026-07-22T16:51:47Z | [https://api.github.com/repos/ipea/geocodebr/releases/latest](https://api.github.com/repos/ipea/geocodebr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ipea/geocodebr/releases/latest` at `2026-09-01T12:30:01+00:00`.
...
- `github_search_maps-b51e98486fb298` from `github_search_maps` as `registry_expansion`
...
| headwaymaps/headway | Filesystem Os | [open](maps-headwaymaps-headway-f1c2ebfc.md) |
| HoshinoSuzumi/chronoframe | Filesystem Os | [open](maps-hoshinosuzumi-chronoframe-59aaa2ce.md) |
| joeldev/JLRoutes | Filesystem Os | [open](maps-joeldev-jlroutes-cbfb85d7.md) |
| lminhtm/LMGeocoder | Filesystem Os | [open](maps-lminhtm-lmgeocoder-ed80a908.md) |
| mapbox/MapboxGeocoder.swift | Filesystem Os | [open](maps-mapbox-mapboxgeocoder-swift-8e8212bc.md) |
| maptiler/qgis-maptiler-plugin | Filesystem Os | [open](maps-maptiler-qgis-maptiler-plugin-142df605.md) |
