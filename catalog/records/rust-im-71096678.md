...
| Canonical URL | [https://crates.io/crates/im](https://crates.io/crates/im) |
| Source record ids | crates_io-7e7852a24ddb22 |
...
For a systems engineer, im belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 15.1.0 | 2022-04-29T14:12:56.603719Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-7e7852a24ddb22` from `crates_io` as `registry_expansion`
