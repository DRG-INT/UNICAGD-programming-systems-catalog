...
<!-- canonical: https://pub.dev/packages/google_api_availability -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_api_availability](https://pub.dev/packages/google_api_availability) |
| Source record ids | pub_dev-8ed3ed38ea5b45 |
...
For a systems engineer, google_api_availability belongs in the Dart inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.1 | 2025-02-25T12:21:54.492989Z | [https://pub.dev/api/packages/google_api_availability](https://pub.dev/api/packages/google_api_availability) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_api_availability` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-8ed3ed38ea5b45` from `pub_dev` as `registry_expansion`
