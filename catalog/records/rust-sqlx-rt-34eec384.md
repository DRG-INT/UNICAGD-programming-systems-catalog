...
| Canonical URL | [https://crates.io/crates/sqlx-rt](https://crates.io/crates/sqlx-rt) |
| Source record ids | crates_io-d7d6ef2606629c |
...
For a systems engineer, sqlx-rt belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2023-03-21T21:25:28.988621Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-d7d6ef2606629c` from `crates_io` as `registry_expansion`
