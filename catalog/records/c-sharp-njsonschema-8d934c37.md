...
<!-- canonical: https://www.nuget.org/packages/NJsonSchema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/NJsonSchema](https://www.nuget.org/packages/NJsonSchema) |
| Source record ids | nuget_search-6e60b1bcce12c5 |
...
For a systems engineer, NJsonSchema belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.6.1 | 2026-04-20T17:47:42.607+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/njsonschema/index.json](https://api.nuget.org/v3/registration5-gz-semver2/njsonschema/index.json) |  |
| preview | known | 11.0.0-preview008 | 2023-12-08T15:19:25.227+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/njsonschema/index.json](https://api.nuget.org/v3/registration5-gz-semver2/njsonschema/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/njsonschema/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-6e60b1bcce12c5` from `nuget_search` as `registry_expansion`
