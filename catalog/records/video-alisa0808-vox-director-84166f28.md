...
<!-- canonical: https://github.com/Alisa0808/vox-director -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Alisa0808/vox-director](https://github.com/Alisa0808/vox-director) |
| Source record ids | github_search_video-a0cc2c9d9306ec |

## System Engineer Summary

Turn one topic into a finished Vox-style paper-collage explainer/ad video — automated end to end on
Atlas Cloud + ffmpeg. An agent skill.

## Operational Role

For a systems engineer, Alisa0808/vox-director belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T15:39:41Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-a0cc2c9d9306ec` from `github_search_video` as `registry_expansion`
