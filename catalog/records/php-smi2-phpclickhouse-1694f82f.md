...
<!-- canonical: https://packagist.org/packages/smi2/phpclickhouse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/smi2/phpclickhouse](https://packagist.org/packages/smi2/phpclickhouse) |
| Source record ids | packagist_search-41fc481ccc8150 |

## System Engineer Summary

smi2/phpclickhouse is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, smi2/phpclickhouse belongs in the PHP inventory as part of service
...
- `packagist_search-41fc481ccc8150` from `packagist_search` as `registry_expansion`
