...
<!-- canonical: https://github.com/hypernewbie/VEFontCache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hypernewbie/VEFontCache](https://github.com/hypernewbie/VEFontCache) |
| Source record ids | github_search_font_briefcase-6d0a106083779a |
...
For a systems engineer, hypernewbie/VEFontCache belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T07:42:18Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-6d0a106083779a` from `github_search_font_briefcase` as `registry_expansion`
