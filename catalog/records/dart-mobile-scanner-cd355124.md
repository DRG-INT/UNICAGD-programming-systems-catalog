...
<!-- canonical: https://pub.dev/packages/mobile_scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mobile_scanner](https://pub.dev/packages/mobile_scanner) |
| Source record ids | pub_dev-4ddc7d2ac7b3f1 |

## System Engineer Summary

A universal Flutter barcode and QR code scanner using CameraX/ML Kit for Android, AVFoundation/Apple
Vision for iOS & macOS, and ZXing for web.

## Operational Role

For a systems engineer, mobile_scanner belongs in the Dart inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.4.2 | 2026-09-14T07:04:45.019383Z | [https://pub.dev/api/packages/mobile_scanner](https://pub.dev/api/packages/mobile_scanner) |  |
| preview | known | 7.0.0-rc.2 | 2025-04-24T08:02:09.686133Z | [https://pub.dev/api/packages/mobile_scanner](https://pub.dev/api/packages/mobile_scanner) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mobile_scanner` at `2026-09-14T08:22:26+00:00`.
...
- `pub_dev-4ddc7d2ac7b3f1` from `pub_dev` as `registry_expansion`
...
| qr_code_scanner_plus | Static Analyzer | [open](dart-qr-code-scanner-plus-c3e9b0ca.md) |
