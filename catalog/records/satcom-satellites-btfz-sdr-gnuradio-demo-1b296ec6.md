...
<!-- canonical: https://github.com/btfz-sdr/gnuradio_demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/btfz-sdr/gnuradio_demo](https://github.com/btfz-sdr/gnuradio_demo) |
| Source record ids | github_search_satcom_satellites-1426fff12d6c6d |
...
For a systems engineer, btfz-sdr/gnuradio_demo belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T08:54:09Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-1426fff12d6c6d` from `github_search_satcom_satellites` as `registry_expansion`
