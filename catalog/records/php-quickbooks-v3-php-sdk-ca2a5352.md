...
<!-- canonical: https://packagist.org/packages/quickbooks/v3-php-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/quickbooks/v3-php-sdk](https://packagist.org/packages/quickbooks/v3-php-sdk) |
| Source record ids | packagist_search-f8e9f60b1bcd43 |
...
For a systems engineer, quickbooks/v3-php-sdk belongs in the PHP inventory as part of cross-language
...
- `packagist_search-f8e9f60b1bcd43` from `packagist_search` as `registry_expansion`
...
| amphp/redis | Ffi Bindings | [open](php-amphp-redis-23416eb5.md) |
