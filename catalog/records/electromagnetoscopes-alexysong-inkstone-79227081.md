...
<!-- canonical: https://github.com/alexysong/inkstone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexysong/inkstone](https://github.com/alexysong/inkstone) |
| Source record ids | github_search_electromagnetoscopes-6bd3842c5c5ca1 |

## System Engineer Summary

Efficient electromagnetic solver based on rigorous coupled-wave analysis for 3D and 2D multi-layered
structures with in-plane periodicity, such as gratings, photonic-crystal slabs, metasurfaces,
surface-emitting lasers, nano-antennas, and more.

## Operational Role

For a systems engineer, alexysong/inkstone belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-02T06:34:06Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6bd3842c5c5ca1` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| cjcliffe/CubicSDR | Static Analyzer | [open](electromagnetoscopes-cjcliffe-cubicsdr-993394d1.md) |
