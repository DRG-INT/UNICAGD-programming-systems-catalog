...
<!-- canonical: https://crates.io/crates/hyper-rustls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hyper-rustls](https://crates.io/crates/hyper-rustls) |
| Source record ids | crates_io-e524daa5aace0a |
...
For a systems engineer, hyper-rustls belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.9 | 2026-04-14T15:13:14.819824Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-e524daa5aace0a` from `crates_io` as `registry_expansion`
