...
<!-- canonical: https://cran.r-project.org/web/packages/rSPDE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rSPDE/index.html](https://cran.r-project.org/web/packages/rSPDE/index.html) |
| Source record ids | cran_packages_by_date-8b050952bbd6db |
...
For a systems engineer, rSPDE belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.0 | 2026-08-31 17:10:02 UTC | [https://cran.r-project.org/web/packages/rSPDE/DESCRIPTION](https://cran.r-project.org/web/packages/rSPDE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rSPDE/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8b050952bbd6db` from `cran_packages_by_date` as `registry_expansion`
