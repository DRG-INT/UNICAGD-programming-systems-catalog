# hh-hang/cesium-player-controller
...
<!-- canonical: https://github.com/hh-hang/cesium-player-controller -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hh-hang/cesium-player-controller](https://github.com/hh-hang/cesium-player-controller) |
| Source record ids | github_search_physics_engines-b06657985176a4 |

## System Engineer Summary

A first-person & third-person character controller for CesiumJS.

## Operational Role

For a systems engineer, hh-hang/cesium-player-controller belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T10:14:45Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-b06657985176a4` from `github_search_physics_engines` as `registry_expansion`
