...
<!-- canonical: https://luarocks.org/modules/types/brinevector-tl-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/types/brinevector-tl-type](https://luarocks.org/modules/types/brinevector-tl-type) |
| Source record ids | luarocks_root_manifest-a205343e0760dd |

## System Engineer Summary

Teal type definition files for brinevector

## Operational Role

For a systems engineer, brinevector-tl-type belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a205343e0760dd` from `luarocks_root_manifest` as `registry_expansion`
