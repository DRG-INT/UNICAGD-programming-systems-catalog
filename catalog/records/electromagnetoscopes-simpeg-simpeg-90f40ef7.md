...
<!-- canonical: https://github.com/simpeg/simpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/simpeg/simpeg](https://github.com/simpeg/simpeg) |
| Source record ids | github_search_electromagnetoscopes-6c2893cd08bb78 |
...
For a systems engineer, simpeg/simpeg belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T16:05:18Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6c2893cd08bb78` from `github_search_electromagnetoscopes` as `registry_expansion`
