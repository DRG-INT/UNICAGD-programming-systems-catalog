...
<!-- canonical: https://cran.r-project.org/web/packages/metalcor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metalcor/index.html](https://cran.r-project.org/web/packages/metalcor/index.html) |
| Source record ids | cran_packages_by_date-284af7f8c09c9c |
...
For a systems engineer, metalcor belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-14 23:40:13 UTC | [https://cran.r-project.org/web/packages/metalcor/DESCRIPTION](https://cran.r-project.org/web/packages/metalcor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metalcor/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-284af7f8c09c9c` from `cran_packages_by_date` as `registry_expansion`
