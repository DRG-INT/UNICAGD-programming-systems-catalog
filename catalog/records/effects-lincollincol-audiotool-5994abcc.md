...
<!-- canonical: https://github.com/lincollincol/AudioTool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lincollincol/AudioTool](https://github.com/lincollincol/AudioTool) |
| Source record ids | github_search_effects-954a3f56387ac5 |

## System Engineer Summary

Android library that provides audio manipulation functions like increase/decrease speed, pitch,
volume, bass, etc. Library also provides cut, noise remover, and other interesting and helpfull
functions

## Operational Role

For a systems engineer, lincollincol/AudioTool belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-26T16:59:45Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-954a3f56387ac5` from `github_search_effects` as `registry_expansion`
