...
<!-- canonical: https://packagist.org/packages/magento/magento2-functional-testing-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/magento/magento2-functional-testing-framework](https://packagist.org/packages/magento/magento2-functional-testing-framework) |
| Source record ids | packagist_search-37388795a370a3 |
...
For a systems engineer, magento/magento2-functional-testing-framework belongs in the PHP inventory
...
- `packagist_search-37388795a370a3` from `packagist_search` as `registry_expansion`
