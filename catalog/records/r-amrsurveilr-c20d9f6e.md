...
<!-- canonical: https://cran.r-project.org/web/packages/AMRsurveilR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AMRsurveilR/index.html](https://cran.r-project.org/web/packages/AMRsurveilR/index.html) |
| Source record ids | cran_packages_by_date-92af82ae7be1b8 |

## System Engineer Summary

Antimicrobial Resistance Surveillance, Epidemiology and Risk Analysis

## Operational Role

For a systems engineer, AMRsurveilR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 13:30:24 UTC | [https://cran.r-project.org/web/packages/AMRsurveilR/DESCRIPTION](https://cran.r-project.org/web/packages/AMRsurveilR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AMRsurveilR/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-92af82ae7be1b8` from `cran_packages_by_date` as `registry_expansion`
