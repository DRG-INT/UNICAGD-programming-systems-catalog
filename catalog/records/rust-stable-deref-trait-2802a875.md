...
<!-- canonical: https://crates.io/crates/stable_deref_trait -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/stable_deref_trait](https://crates.io/crates/stable_deref_trait) |
| Source record ids | crates_io-032cb4cb4fe0e0 |

## System Engineer Summary

An unsafe marker trait for types like Box and Rc that dereference to a stable address even when
moved, and hence can be used with libraries such as owning_ref and rental.

## Operational Role

For a systems engineer, stable_deref_trait belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2025-10-09T05:24:54.643083Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-032cb4cb4fe0e0` from `crates_io` as `registry_expansion`
