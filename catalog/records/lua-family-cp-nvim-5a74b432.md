...
<!-- canonical: https://luarocks.org/modules/barrett-ruth/cp.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/barrett-ruth/cp.nvim](https://luarocks.org/modules/barrett-ruth/cp.nvim) |
| Source record ids | luarocks_root_manifest-5db15053e297f3 |
...
For a systems engineer, cp.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5db15053e297f3` from `luarocks_root_manifest` as `registry_expansion`
