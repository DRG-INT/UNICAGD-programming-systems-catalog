...
<!-- canonical: https://crates.io/crates/idna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/idna](https://crates.io/crates/idna) |
| Source record ids | crates_io-d96e24d76bc0d6 |
...
For a systems engineer, idna belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2025-08-21T08:48:20.326736Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-d96e24d76bc0d6` from `crates_io` as `registry_expansion`
