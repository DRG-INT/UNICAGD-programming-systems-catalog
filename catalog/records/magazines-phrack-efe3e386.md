...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Magazines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/magazines.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [http://phrack.org/](http://phrack.org/) |
| Source record ids | curated_language_routes-6f30d2677dfca3 |

## System Engineer Summary

Long-running hacker zine and archive route for security research, systems internals, exploitation
history, and underground computing culture.

## Operational Role

For a systems engineer, Phrack belongs in the Magazines inventory as part of supply-chain review,
...
- `curated_language_routes-6f30d2677dfca3` from `curated_language_routes` as `registry_expansion`
