# Gitea: quxiaorui/action-send-mail
...
<!-- canonical: https://gitea.com/quxiaorui/action-send-mail -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/quxiaorui/action-send-mail](https://gitea.com/quxiaorui/action-send-mail) |
| Source record ids | gitea_repositories_api-74920c0b34d10b |
...
For a systems engineer, Gitea: quxiaorui/action-send-mail belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-26T12:43:08Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-74920c0b34d10b` from `gitea_repositories_api` as `registry_expansion`
