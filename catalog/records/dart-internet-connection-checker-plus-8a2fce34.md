...
<!-- canonical: https://pub.dev/packages/internet_connection_checker_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/internet_connection_checker_plus](https://pub.dev/packages/internet_connection_checker_plus) |
| Source record ids | pub_dev-7a4a8bcd535552 |

## System Engineer Summary

A pure Dart package to check your internet connection with subsecond response times, even on mobile
networks!

## Operational Role

For a systems engineer, internet_connection_checker_plus belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-07-01T13:37:28.990085Z | [https://pub.dev/api/packages/internet_connection_checker_plus](https://pub.dev/api/packages/internet_connection_checker_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/internet_connection_checker_plus` at `2026-09-02T00:28:53+00:00`.
...
- `pub_dev-7a4a8bcd535552` from `pub_dev` as `registry_expansion`
