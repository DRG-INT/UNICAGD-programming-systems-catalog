...
<!-- canonical: https://github.com/SlavaSexton/ComfyUI-OCIO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SlavaSexton/ComfyUI-OCIO](https://github.com/SlavaSexton/ComfyUI-OCIO) |
| Source record ids | github_search_photography-b3cfc009a1a497 |

## System Engineer Summary

Nuke-style OpenColorIO color management for ComfyUI: read and write EXR, ProRes, image sequences and
video, grade in ACES, and inspect the result in an on-node float viewer with live exposure. Runs on
ComfyUI's native VIDEO pipeline. By AI VFX NEWS.

## Operational Role

For a systems engineer, SlavaSexton/ComfyUI-OCIO belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T03:31:37Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-b3cfc009a1a497` from `github_search_photography` as `registry_expansion`
