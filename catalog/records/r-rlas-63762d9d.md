...
<!-- canonical: https://cran.r-project.org/web/packages/rlas/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rlas/index.html](https://cran.r-project.org/web/packages/rlas/index.html) |
| Source record ids | cran_packages_by_date-afa56d4e6c4f7f |
...
For a systems engineer, rlas belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.5 | 2026-09-04 12:00:09 UTC | [https://cran.r-project.org/web/packages/rlas/DESCRIPTION](https://cran.r-project.org/web/packages/rlas/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rlas/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-afa56d4e6c4f7f` from `cran_packages_by_date` as `registry_expansion`
