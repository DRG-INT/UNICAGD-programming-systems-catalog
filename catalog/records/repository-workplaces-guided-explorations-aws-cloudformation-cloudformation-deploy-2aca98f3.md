# guided-explorations/aws/cloudformation/cloudformation-deploy
...
<!-- canonical: https://gitlab.com/guided-explorations/aws/cloudformation/cloudformation-deploy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/guided-explorations/aws/cloudformation/cloudformation-deploy](https://gitlab.com/guided-explorations/aws/cloudformation/cloudformation-deploy) |
| Source record ids | gitlab_projects_api-50f304c398fa80 |

## System Engineer Summary

With Dynamic Review Environments Support

## Operational Role

For a systems engineer, guided-explorations/aws/cloudformation/cloudformation-deploy belongs in the
Repository Workplaces inventory as part of low-noise code review, style consistency, and automation-
friendly editing.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T13:33:11.462Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-50f304c398fa80` from `gitlab_projects_api` as `registry_expansion`
