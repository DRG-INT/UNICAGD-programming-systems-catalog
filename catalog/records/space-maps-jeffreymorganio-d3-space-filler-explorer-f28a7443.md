# jeffreymorganio/d3-space-filler-explorer
...
<!-- canonical: https://github.com/jeffreymorganio/d3-space-filler-explorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeffreymorganio/d3-space-filler-explorer](https://github.com/jeffreymorganio/d3-space-filler-explorer) |
| Source record ids | github_search_space_maps-b01d1ed684ca6c |

## System Engineer Summary

An Electron application that visualizes disk space use with multiple D3 layouts.

## Operational Role

For a systems engineer, jeffreymorganio/d3-space-filler-explorer belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-14T18:14:55Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b01d1ed684ca6c` from `github_search_space_maps` as `registry_expansion`
