...
<!-- canonical: https://github.com/ossimlabs/ossim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ossimlabs/ossim](https://github.com/ossimlabs/ossim) |
| Source record ids | github_search_satcom_satellites-ae776c0a6af137 |

## System Engineer Summary

Core OSSIM (Open Source Software Image Map) package including C++ code for OSSIM library, command-
line applications, tests, and build system

## Operational Role

For a systems engineer, ossimlabs/ossim belongs in the SatCom Satellites inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.12.0 | 2024-02-09T18:53:48Z | [https://api.github.com/repos/ossimlabs/ossim/releases/latest](https://api.github.com/repos/ossimlabs/ossim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ossimlabs/ossim/releases/latest` at `2026-09-01T08:26:37+00:00`.
...
- `github_search_satcom_satellites-ae776c0a6af137` from `github_search_satcom_satellites` as `registry_expansion`
