...
| Canonical URL | [https://www.w3.org/TR/webgpu/](https://www.w3.org/TR/webgpu/) |
| Source record ids | curated_language_routes-82b42b78f2407b |

## System Engineer Summary

WebGPU specification for modern browser and native GPU rendering and compute APIs.

## Operational Role

For a systems engineer, W3C WebGPU belongs in the Renderers inventory as part of ecosystem
...
- `curated_language_routes-82b42b78f2407b` from `curated_language_routes` as `registry_expansion`
...
| Khronos Vulkan Registry | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-khronos-vulkan-registry-8bb39426.md) |
