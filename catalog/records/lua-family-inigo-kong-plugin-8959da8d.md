...
| Canonical URL | [https://luarocks.org/modules/inigo/inigo-kong-plugin](https://luarocks.org/modules/inigo/inigo-kong-plugin) |
| Source record ids | luarocks_root_manifest-faacd03b791f81 |

## System Engineer Summary

inigo-kong-plugin is tracked as a library record in the Lua family branch. The source did not
...
For a systems engineer, inigo-kong-plugin belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-faacd03b791f81` from `luarocks_root_manifest` as `registry_expansion`
