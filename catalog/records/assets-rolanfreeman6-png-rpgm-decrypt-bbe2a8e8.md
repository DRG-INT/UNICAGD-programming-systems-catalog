# rolanfreeman6-png/rpgm-decrypt
...
<!-- canonical: https://github.com/rolanfreeman6-png/rpgm-decrypt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rolanfreeman6-png/rpgm-decrypt](https://github.com/rolanfreeman6-png/rpgm-decrypt) |
| Source record ids | github_search_assets-e25840482fa922 |

## System Engineer Summary

Decrypting RPG Maker game assets (XP / VX / VX Ace / MV / MZ).

## Operational Role

For a systems engineer, rolanfreeman6-png/rpgm-decrypt belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T23:13:03Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-e25840482fa922` from `github_search_assets` as `registry_expansion`
