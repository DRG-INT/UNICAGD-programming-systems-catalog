...
<!-- canonical: https://github.com/MissingDeadlines/iolite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MissingDeadlines/iolite](https://github.com/MissingDeadlines/iolite) |
| Source record ids | github_search_physics_engines-a7440d1e51a929 |

## System Engineer Summary

A highly flexible, voxel-powered game engine with an embedded editor. Create games using Lua, the
native C/C++ API, and assets authored in voxel editors like MagicaVoxel or Avoyd.

## Operational Role

For a systems engineer, MissingDeadlines/iolite belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-17T09:53:34Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a7440d1e51a929` from `github_search_physics_engines` as `registry_expansion`
