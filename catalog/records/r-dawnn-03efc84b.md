...
<!-- canonical: https://cran.r-project.org/web/packages/dawnn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dawnn/index.html](https://cran.r-project.org/web/packages/dawnn/index.html) |
| Source record ids | cran_packages_by_date-bc0d416abd346e |

## System Engineer Summary

Differential Abundance with Neural Networks

## Operational Role

For a systems engineer, dawnn belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2026-09-01 08:40:09 UTC | [https://cran.r-project.org/web/packages/dawnn/DESCRIPTION](https://cran.r-project.org/web/packages/dawnn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dawnn/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-bc0d416abd346e` from `cran_packages_by_date` as `registry_expansion`
