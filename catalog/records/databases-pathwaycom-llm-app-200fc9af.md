...
| Source record ids | github_search_databases-2862508aa97874 |
...
For a systems engineer, pathwaycom/llm-app belongs in the Databases inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T17:59:07Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-2862508aa97874` from `github_search_databases` as `registry_expansion`
