...
<!-- canonical: https://crates.io/crates/inotify-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/inotify-sys](https://crates.io/crates/inotify-sys) |
| Source record ids | crates_io-4e92ef50f3cadf |
...
For a systems engineer, inotify-sys belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-07-07T14:33:29.124505Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-4e92ef50f3cadf` from `crates_io` as `registry_expansion`
