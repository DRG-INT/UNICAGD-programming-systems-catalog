...
<!-- canonical: https://github.com/rcalixte/awesome-wayland -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rcalixte/awesome-wayland](https://github.com/rcalixte/awesome-wayland) |
| Source record ids | github_search_effects-b5ec739a99515d |
...
For a systems engineer, rcalixte/awesome-wayland belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T19:00:18Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b5ec739a99515d` from `github_search_effects` as `registry_expansion`
