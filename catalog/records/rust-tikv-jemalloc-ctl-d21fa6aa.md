...
<!-- canonical: https://crates.io/crates/tikv-jemalloc-ctl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tikv-jemalloc-ctl](https://crates.io/crates/tikv-jemalloc-ctl) |
| Source record ids | crates_io-d61727b5c080c9 |
...
For a systems engineer, tikv-jemalloc-ctl belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-05-25T17:14:49.962886Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-d61727b5c080c9` from `crates_io` as `registry_expansion`
