...
<!-- canonical: https://github.com/stretchr/testify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stretchr/testify](https://github.com/stretchr/testify) |
| Source record ids | github_search_go-229115fa090229 |
...
For a systems engineer, stretchr/testify belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:37:01Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-229115fa090229` from `github_search_go` as `registry_expansion`
