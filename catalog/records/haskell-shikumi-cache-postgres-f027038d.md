...
<!-- canonical: https://hackage.haskell.org/package/shikumi-cache-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-cache-postgres](https://hackage.haskell.org/package/shikumi-cache-postgres) |
| Source record ids | hackage_recent-2df1ee5ebe2744 |
...
For a systems engineer, shikumi-cache-postgres belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3.0 | 2026-09-08T19:34:49Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-2df1ee5ebe2744` from `hackage_recent` as `registry_expansion`
