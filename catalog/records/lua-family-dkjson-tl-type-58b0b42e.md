...
<!-- canonical: https://luarocks.org/modules/types/dkjson-tl-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/types/dkjson-tl-type](https://luarocks.org/modules/types/dkjson-tl-type) |
| Source record ids | luarocks_root_manifest-e6a4e9a7f2308d |

## System Engineer Summary

Teal type definition files for dkjson

## Operational Role

For a systems engineer, dkjson-tl-type belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-e6a4e9a7f2308d` from `luarocks_root_manifest` as `registry_expansion`
