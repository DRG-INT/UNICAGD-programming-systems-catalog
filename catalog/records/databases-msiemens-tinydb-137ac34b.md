...
<!-- canonical: https://github.com/msiemens/tinydb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/msiemens/tinydb](https://github.com/msiemens/tinydb) |
| Source record ids | github_search_databases-cd9aa6c1a4e5c5 |
...
For a systems engineer, msiemens/tinydb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T18:34:35Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cd9aa6c1a4e5c5` from `github_search_databases` as `registry_expansion`
