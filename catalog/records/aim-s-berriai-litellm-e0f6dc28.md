...
<!-- canonical: https://github.com/BerriAI/litellm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BerriAI/litellm](https://github.com/BerriAI/litellm) |
| Source record ids | github_search_aims-6e9dcef8dd1c1c |

## System Engineer Summary

The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native)
format with cost tracking, guardrails, load balancing, and logging Bedrock, Azure, OpenAI,
Anthropic, OpenAI, VertexAI, vLLM, Nvidia NIM

## Operational Role

For a systems engineer, BerriAI/litellm belongs in the "aim's" inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:18:55Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-6e9dcef8dd1c1c` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| google/langextract | Formatter | [open](aim-s-google-langextract-8fb0b488.md) |
