...
<!-- canonical: https://github.com/TIO-IKIM/CellViT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TIO-IKIM/CellViT](https://github.com/TIO-IKIM/CellViT) |
| Source record ids | github_search_microscopy-44ecbba91055fb |
...
For a systems engineer, TIO-IKIM/CellViT belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-23T06:10:25Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-44ecbba91055fb` from `github_search_microscopy` as `registry_expansion`
