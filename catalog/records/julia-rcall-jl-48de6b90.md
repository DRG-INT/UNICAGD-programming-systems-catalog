...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/R/RCall](https://github.com/JuliaRegistries/General/tree/master/R/RCall) |
| Source record ids | corpus-31db9442b94a5c |

## System Engineer Summary

RCall.jl is tracked as a ffi bindings record in the Julia branch. The source did not provide a long
...
For a systems engineer, RCall.jl belongs in the Julia inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.14.13 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/R/RCall/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/R/RCall/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-31db9442b94a5c` from `master_json` as `ffi_bindings`
