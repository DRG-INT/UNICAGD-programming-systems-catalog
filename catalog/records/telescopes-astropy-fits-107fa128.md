...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://docs.astropy.org/en/stable/io/fits/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.astropy.org/en/stable/io/fits/](https://docs.astropy.org/en/stable/io/fits/) |
| Source record ids | curated_language_routes-b3c24bff89bf97 |

## System Engineer Summary

FITS file handling route for astronomical image and table data used by observatory pipelines.

## Operational Role

For a systems engineer, Astropy FITS belongs in the Telescopes inventory as part of wire formats,
...
- `curated_language_routes-b3c24bff89bf97` from `curated_language_routes` as `registry_expansion`
