...
<!-- canonical: https://cran.r-project.org/web/packages/rapsimng/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rapsimng/index.html](https://cran.r-project.org/web/packages/rapsimng/index.html) |
| Source record ids | cran_packages_by_date-837d24297f7b2a |

## System Engineer Summary

rapsimng is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, rapsimng belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-24 06:30:02 UTC | [https://cran.r-project.org/web/packages/rapsimng/DESCRIPTION](https://cran.r-project.org/web/packages/rapsimng/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rapsimng/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-837d24297f7b2a` from `cran_packages_by_date` as `registry_expansion`
