...
<!-- canonical: https://github.com/alexpiti/Plot-Pattern -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexpiti/Plot-Pattern](https://github.com/alexpiti/Plot-Pattern) |
| Source record ids | github_search_electromagnetoscopes-159975fbf6662e |

## System Engineer Summary

MATLAB functions to plot 2D or 3D radiation & scattering patterns, intended for custom visualization
of the response of antennas & metasurfaces.

## Operational Role

For a systems engineer, alexpiti/Plot-Pattern belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-30T11:57:43Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-159975fbf6662e` from `github_search_electromagnetoscopes` as `registry_expansion`
