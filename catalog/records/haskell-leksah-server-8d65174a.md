...
<!-- canonical: https://hackage.haskell.org/package/leksah-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/leksah-server](https://hackage.haskell.org/package/leksah-server) |
| Source record ids | hackage_top_downloads-44114badd0e8c6 |
...
For a systems engineer, leksah-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.3.0 | 2017-11-04T08:17:51Z | [https://hackage.haskell.org/package/leksah-server](https://hackage.haskell.org/package/leksah-server) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/leksah-server` at `2026-09-16T00:28:48+00:00`.
...
- `hackage_top_downloads-44114badd0e8c6` from `hackage_top_downloads` as `registry_expansion`
