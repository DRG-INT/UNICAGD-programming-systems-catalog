# mujavidb/basiliskRobotsChallenge
...
<!-- canonical: https://github.com/mujavidb/basiliskRobotsChallenge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mujavidb/basiliskRobotsChallenge](https://github.com/mujavidb/basiliskRobotsChallenge) |
| Source record ids | github_search_basilisk-02c695021bcdbd |
...
For a systems engineer, mujavidb/basiliskRobotsChallenge belongs in the Basilisk inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-02-23T21:14:38Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-02c695021bcdbd` from `github_search_basilisk` as `registry_expansion`
