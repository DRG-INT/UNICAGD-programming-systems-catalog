...
<!-- canonical: https://github.com/hiroyuki-kasai/GDLibrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hiroyuki-kasai/GDLibrary](https://github.com/hiroyuki-kasai/GDLibrary) |
| Source record ids | github_search_matlab-3df6911039b936 |
...
For a systems engineer, hiroyuki-kasai/GDLibrary belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-02T02:15:19Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-3df6911039b936` from `github_search_matlab` as `registry_expansion`
