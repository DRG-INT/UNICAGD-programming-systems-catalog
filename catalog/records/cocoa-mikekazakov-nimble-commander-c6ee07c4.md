...
<!-- canonical: https://github.com/mikekazakov/nimble-commander -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mikekazakov/nimble-commander](https://github.com/mikekazakov/nimble-commander) |
| Source record ids | github_search_cocoa-ec6e2b3485ab64 |
...
For a systems engineer, mikekazakov/nimble-commander belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T23:14:57Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-ec6e2b3485ab64` from `github_search_cocoa` as `registry_expansion`
