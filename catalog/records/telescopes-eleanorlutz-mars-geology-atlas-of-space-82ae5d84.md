...
| Source record ids | github_search_telescopes-f63a7f0cdd7924 |
...
For a systems engineer, eleanorlutz/mars_geology_atlas_of_space belongs in the Telescopes inventory
...
- `github_search_telescopes-f63a7f0cdd7924` from `github_search_telescopes` as `registry_expansion`
