...
| Source record ids | github_search_databases-4702e98056875f |
...
For a systems engineer, memgraph/memgraph belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T17:34:21Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4702e98056875f` from `github_search_databases` as `registry_expansion`
