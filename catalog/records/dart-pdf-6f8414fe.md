...
<!-- canonical: https://pub.dev/packages/pdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pdf](https://pub.dev/packages/pdf) |
| Source record ids | pub_dev-160b9d72dedf8a |
...
For a systems engineer, pdf belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.13.0 | 2026-06-16T19:48:45.799992Z | [https://pub.dev/api/packages/pdf](https://pub.dev/api/packages/pdf) |  |
| preview | known | 3.0.0-nullsafety.1 | 2021-02-10T12:04:03.016789Z | [https://pub.dev/api/packages/pdf](https://pub.dev/api/packages/pdf) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pdf` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-160b9d72dedf8a` from `pub_dev` as `registry_expansion`
