...
<!-- canonical: https://github.com/newton-physics/newton -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/newton-physics/newton](https://github.com/newton-physics/newton) |
| Source record ids | github_search_physics_engines-cac134cd4dd8d3 |

## System Engineer Summary

An open-source, GPU-accelerated physics simulation engine built upon NVIDIA Warp, specifically
targeting roboticists and simulation researchers.

## Operational Role

For a systems engineer, newton-physics/newton belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:21:43Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-cac134cd4dd8d3` from `github_search_physics_engines` as `registry_expansion`
