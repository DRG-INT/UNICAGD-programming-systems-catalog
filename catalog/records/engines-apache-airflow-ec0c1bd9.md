...
<!-- canonical: https://github.com/apache/airflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/airflow](https://github.com/apache/airflow) |
| Source record ids | github_search_engines-3d4d3e286eb329 |
...
For a systems engineer, apache/airflow belongs in the Engines inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:47:41Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-3d4d3e286eb329` from `github_search_engines` as `registry_expansion`
