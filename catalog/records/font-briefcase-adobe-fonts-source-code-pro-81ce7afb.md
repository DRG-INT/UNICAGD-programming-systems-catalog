...
| Source record ids | github_search_font_briefcase-1e9069af29f682 |
...
For a systems engineer, adobe-fonts/source-code-pro belongs in the Font Briefcase inventory as part
...
- `github_search_font_briefcase-1e9069af29f682` from `github_search_font_briefcase` as `registry_expansion`
