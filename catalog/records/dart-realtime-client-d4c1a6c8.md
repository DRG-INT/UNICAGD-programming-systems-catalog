...
<!-- canonical: https://pub.dev/packages/realtime_client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/realtime_client](https://pub.dev/packages/realtime_client) |
| Source record ids | pub_dev-40911846278b68 |

## System Engineer Summary

Listens to changes in a PostgreSQL Database and via websockets. This is for usage with Supabase
Realtime server.

## Operational Role

For a systems engineer, realtime_client belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.13.0 | 2026-08-05T08:47:31.985422Z | [https://pub.dev/api/packages/realtime_client](https://pub.dev/api/packages/realtime_client) |  |
| preview | known | 2.0.0-dev.3 | 2023-12-05T12:06:40.518104Z | [https://pub.dev/api/packages/realtime_client](https://pub.dev/api/packages/realtime_client) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/realtime_client` at `2026-09-03T17:19:02+00:00`.
...
- `pub_dev-40911846278b68` from `pub_dev` as `registry_expansion`
