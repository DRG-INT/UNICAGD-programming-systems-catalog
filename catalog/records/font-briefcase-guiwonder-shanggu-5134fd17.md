...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GuiWonder/Shanggu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GuiWonder/Shanggu](https://github.com/GuiWonder/Shanggu) |
| Source record ids | github_search_font_briefcase-3bcadeb4bb80ae |

## System Engineer Summary

基於思源系列的傳承字形（舊字形）CJK 字體 Shanggu Fonts 尙古系列字體

## Operational Role

For a systems engineer, GuiWonder/Shanggu belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T09:05:16Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-3bcadeb4bb80ae` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Apple Font Book | Visualization Gui | [open](font-briefcase-apple-font-book-d4faa5da.md) |
| arrowtype/recursive | Visualization Gui | [open](font-briefcase-arrowtype-recursive-187edfa7.md) |
| calcom/sans-ui | Visualization Gui | [open](font-briefcase-calcom-sans-ui-d57df175.md) |
| FontForge | Visualization Gui | [open](font-briefcase-fontforge-052a7709.md) |
| FreeType | Visualization Gui | [open](font-briefcase-freetype-56ad1f3a.md) |
| HarfBuzz | Visualization Gui | [open](font-briefcase-harfbuzz-bff23c07.md) |
| quiple/galmuri | Visualization Gui | [open](font-briefcase-quiple-galmuri-91c62116.md) |
| sun-typeface/SUIT | Visualization Gui | [open](font-briefcase-sun-typeface-suit-6a105eda.md) |
