...
<!-- canonical: https://github.com/atomikos/transactions-essentials -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atomikos/transactions-essentials](https://github.com/atomikos/transactions-essentials) |
| Source record ids | github_search_databases-eb6c4692297f5e |

## System Engineer Summary

Atomikos TransactionsEssentials — the open-source JTA/XA transaction manager for Java: distributed
transactions across databases and message brokers, with automatic crash recovery. Embeddable, no
application server required.

## Operational Role

For a systems engineer, atomikos/transactions-essentials belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-18T15:31:35Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-eb6c4692297f5e` from `github_search_databases` as `registry_expansion`
