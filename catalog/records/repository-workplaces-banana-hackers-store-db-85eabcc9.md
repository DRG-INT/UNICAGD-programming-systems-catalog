...
<!-- canonical: https://gitlab.com/banana-hackers/store-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/banana-hackers/store-db](https://gitlab.com/banana-hackers/store-db) |
| Source record ids | gitlab_projects_api-fc91244fc3b8dd |

## System Engineer Summary

Database of all apps in the BananaHackers Store. This is where the app fetches its data from.

## Operational Role

For a systems engineer, banana-hackers/store-db belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-fc91244fc3b8dd` from `gitlab_projects_api` as `registry_expansion`
