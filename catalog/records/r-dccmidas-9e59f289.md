...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/dccmidas/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dccmidas/index.html](https://cran.r-project.org/web/packages/dccmidas/index.html) |
| Source record ids | cran_packages_by_date-06ef266e1cfe11 |

## System Engineer Summary

DCC Models with GARCH and GARCH-MIDAS Specifications in the Univariate Step, RiskMetrics, Moving
Covariance and Scalar and Diagonal BEKK Models

## Operational Role

For a systems engineer, dccmidas belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-09 15:20:10 UTC | [https://cran.r-project.org/web/packages/dccmidas/DESCRIPTION](https://cran.r-project.org/web/packages/dccmidas/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dccmidas/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-06ef266e1cfe11` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| baselinr | Language Specification | [open](r-baselinr-8b5c759c.md) |
| btw | Language Specification | [open](r-btw-e6fa9ede.md) |
| cdcanthro | Language Specification | [open](r-cdcanthro-3041967b.md) |
| chevron | Language Specification | [open](r-chevron-d0169416.md) |
| csbewma | Language Specification | [open](r-csbewma-51895b0b.md) |
| csemTools | Language Specification | [open](r-csemtools-c10814a5.md) |
| DasGuptR | Language Specification | [open](r-dasguptr-b4cca0fa.md) |
| edgemodelr | Language Specification | [open](r-edgemodelr-090006e4.md) |
