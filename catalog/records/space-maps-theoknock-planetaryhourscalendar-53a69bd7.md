# theoknock/PlanetaryHoursCalendar
...
<!-- canonical: https://github.com/theoknock/PlanetaryHoursCalendar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/theoknock/PlanetaryHoursCalendar](https://github.com/theoknock/PlanetaryHoursCalendar) |
| Source record ids | github_search_space_maps-6c5c806708f834 |

## System Engineer Summary

Calendars planetary hours for the current day and night (24 hours, total) in the Calendar app for
iOS; displays each planetary hour event in the standard Calendar event view in a page view
controller; marks the position of each planetary hour on a map view

## Operational Role

For a systems engineer, theoknock/PlanetaryHoursCalendar belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-30T02:30:58Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-6c5c806708f834` from `github_search_space_maps` as `registry_expansion`
