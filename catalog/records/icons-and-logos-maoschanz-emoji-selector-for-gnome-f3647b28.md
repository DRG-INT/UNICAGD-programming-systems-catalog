...
<!-- canonical: https://github.com/maoschanz/emoji-selector-for-gnome -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maoschanz/emoji-selector-for-gnome](https://github.com/maoschanz/emoji-selector-for-gnome) |
| Source record ids | github_search_icons_and_logos-b75b4eb00b583a |

## System Engineer Summary

This extension provide a popup menu with some emojis ; clicking on an emoji copies it to the
clipboard.

## Operational Role

For a systems engineer, maoschanz/emoji-selector-for-gnome belongs in the Icons and Logos inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-01T13:48:56Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-b75b4eb00b583a` from `github_search_icons_and_logos` as `registry_expansion`
