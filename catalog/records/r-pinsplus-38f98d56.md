...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/PINSPlus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PINSPlus/index.html](https://cran.r-project.org/web/packages/PINSPlus/index.html) |
| Source record ids | cran_packages_by_date-1b55cfdfef7f0e |
...
For a systems engineer, PINSPlus belongs in the R inventory as part of interface contracts,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.10 | 2026-09-02 05:20:42 UTC | [https://cran.r-project.org/web/packages/PINSPlus/DESCRIPTION](https://cran.r-project.org/web/packages/PINSPlus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PINSPlus/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-1b55cfdfef7f0e` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dataganger | Type Checker | [open](r-dataganger-087590ce.md) |
