...
<!-- canonical: https://github.com/bytecodealliance/wit-bindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/wit-bindgen](https://github.com/bytecodealliance/wit-bindgen) |
| Source record ids | github_search_webassembly-be9550692fca0c |
...
For a systems engineer, bytecodealliance/wit-bindgen belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T22:01:17Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-be9550692fca0c` from `github_search_webassembly` as `registry_expansion`
