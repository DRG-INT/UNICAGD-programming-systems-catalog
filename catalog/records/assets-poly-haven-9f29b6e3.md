...
| Canonical URL | [https://polyhaven.com/](https://polyhaven.com/) |
| Source record ids | curated_language_routes-ec1b8682a9279b |

## System Engineer Summary

Public-domain HDRIs, textures, and 3D models for rendering and game asset pipelines.

## Operational Role

For a systems engineer, Poly Haven belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-ec1b8682a9279b` from `curated_language_routes` as `registry_expansion`
