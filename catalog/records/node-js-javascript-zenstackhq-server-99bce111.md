...
<!-- canonical: https://www.npmjs.com/package/@zenstackhq/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@zenstackhq/server](https://www.npmjs.com/package/@zenstackhq/server) |
| Source record ids | npm_registry-bdc66451e4dadd |
...
For a systems engineer, @zenstackhq/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.9.3 | 2026-08-31T13:33:45.418Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-bdc66451e4dadd` from `npm_registry` as `registry_expansion`
