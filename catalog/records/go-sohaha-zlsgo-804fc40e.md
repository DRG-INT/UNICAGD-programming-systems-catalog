...
<!-- canonical: https://github.com/sohaha/zlsgo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sohaha/zlsgo](https://github.com/sohaha/zlsgo) |
| Source record ids | github_search_go-6b5010572c9a3c |
...
For a systems engineer, sohaha/zlsgo belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T07:16:38Z | gh search repos topic:go-framework stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-6b5010572c9a3c` from `github_search_go` as `registry_expansion`
