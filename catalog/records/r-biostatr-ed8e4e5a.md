...
<!-- canonical: https://cran.r-project.org/web/packages/BioStatR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BioStatR/index.html](https://cran.r-project.org/web/packages/BioStatR/index.html) |
| Source record ids | cran_packages_by_date-625d95898c2eb5 |
...
For a systems engineer, BioStatR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.2 | 2026-09-16 02:20:10 UTC | [https://cran.r-project.org/web/packages/BioStatR/DESCRIPTION](https://cran.r-project.org/web/packages/BioStatR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BioStatR/DESCRIPTION` at `2026-09-16T03:20:38+00:00`.
...
- `cran_packages_by_date-625d95898c2eb5` from `cran_packages_by_date` as `registry_expansion`
