...
<!-- canonical: https://packagist.org/packages/sunaoka/php-postgresql-errors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sunaoka/php-postgresql-errors](https://packagist.org/packages/sunaoka/php-postgresql-errors) |
| Source record ids | packagist_search-fc458f1be6203d |

## System Engineer Summary

sunaoka/php-postgresql-errors is tracked as a database datastore record in the PHP branch. The
...
For a systems engineer, sunaoka/php-postgresql-errors belongs in the PHP inventory as part of state
...
- `packagist_search-fc458f1be6203d` from `packagist_search` as `registry_expansion`
