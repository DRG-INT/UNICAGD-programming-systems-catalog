...
| Source record ids | master-f14861391a4f |

## System Engineer Summary

Serde is tracked as a serialization record in the Rust branch. The source did not provide a long
...
For a systems engineer, Serde belongs in the Rust inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.229 | 2026-07-18T23:05:13.266456Z | [https://crates.io/api/v1/crates/Serde](https://crates.io/api/v1/crates/Serde) |  |
| preview | known | 1.0.172-alpha.0 | 2023-07-19T21:03:53.726968Z | [https://crates.io/api/v1/crates/Serde](https://crates.io/api/v1/crates/Serde) |  |

## Engineering Notes

- Treat category as `serialization` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/Serde` at `2026-09-01T02:12:59+00:00`.
...
- `master-f14861391a4f` from `master_json` as `serialization`
