...
<!-- canonical: https://github.com/rivet-dev/agentos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rivet-dev/agentos](https://github.com/rivet-dev/agentos) |
| Source record ids | github_search_webassembly-08f337ac542b97 |

## System Engineer Summary

Give agents an operating system as a library. Runs in your existing backend – no sandboxes, VMs, or
SaaS. Powered by WebAssembly & V8 isolates.

## Operational Role

For a systems engineer, rivet-dev/agentos belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T21:17:09Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_webassembly-08f337ac542b97` from `github_search_webassembly` as `registry_expansion`
