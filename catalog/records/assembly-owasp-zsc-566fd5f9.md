...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/OWASP/ZSC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OWASP/ZSC](https://github.com/OWASP/ZSC) |
| Source record ids | github_search_assembly-446dd753906123 |
...
For a systems engineer, OWASP/ZSC belongs in the Assembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-14T22:19:20Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-446dd753906123` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashvardanian/less_slow.cpp | Networking Http | [open](assembly-ashvardanian-less-slow-cpp-50768d6c.md) |
| minio/highwayhash | Networking Http | [open](assembly-minio-highwayhash-5634a2cc.md) |
| nyxos-dev/nyx-os | Networking Http | [open](assembly-nyxos-dev-nyx-os-a701d2ff.md) |
| OpenMachine-ai/tinyfive | Networking Http | [open](assembly-openmachine-ai-tinyfive-d7147317.md) |
