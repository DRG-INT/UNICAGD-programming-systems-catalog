...
<!-- canonical: https://pypi.org/project/acfortformat/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acfortformat/](https://pypi.org/project/acfortformat/) |
| Source record ids | pypi_simple-cf29e6e9f0a485 |
...
For a systems engineer, acfortformat belongs in the Python inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2025-07-18T22:53:45.923687Z | [https://pypi.org/pypi/acfortformat/json](https://pypi.org/pypi/acfortformat/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acfortformat/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-cf29e6e9f0a485` from `pypi_simple` as `registry_expansion`
