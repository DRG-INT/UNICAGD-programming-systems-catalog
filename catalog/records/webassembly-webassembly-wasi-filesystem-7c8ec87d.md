...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/WebAssembly/wasi-filesystem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-filesystem](https://github.com/WebAssembly/wasi-filesystem) |
| Source record ids | github_search_webassembly-5b1a6398c70fb0 |

## System Engineer Summary

WebAssembly/wasi-filesystem is tracked as a filesystem os record in the WebAssembly branch. The
...
For a systems engineer, WebAssembly/wasi-filesystem belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T22:54:53Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-5b1a6398c70fb0` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Becavalier/Book-DISO-WebAssembly | Filesystem Os | [open](webassembly-becavalier-book-diso-webassembly-adda2eaf.md) |
| binji/raw-wasm | Filesystem Os | [open](webassembly-binji-raw-wasm-c2dcf640.md) |
| eoswindev/contract | Filesystem Os | [open](webassembly-eoswindev-contract-31970bee.md) |
| ericfish/EOS-Dev-Book | Filesystem Os | [open](webassembly-ericfish-eos-dev-book-ab3602a2.md) |
| HaliteChallenge/Halite-III | Filesystem Os | [open](webassembly-halitechallenge-halite-iii-d1e574a8.md) |
| kateinoigakukun/wasi-vfs | Filesystem Os | [open](webassembly-kateinoigakukun-wasi-vfs-380e4080.md) |
| lucasgelfond/exiftool-web | Filesystem Os | [open](webassembly-lucasgelfond-exiftool-web-6b2c4ba0.md) |
| mafintosh/blake2b-wasm | Filesystem Os | [open](webassembly-mafintosh-blake2b-wasm-6966696b.md) |
