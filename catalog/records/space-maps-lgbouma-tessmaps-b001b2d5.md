...
<!-- canonical: https://github.com/lgbouma/tessmaps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lgbouma/tessmaps](https://github.com/lgbouma/tessmaps) |
| Source record ids | github_search_space_maps-251438d28caebd |

## System Engineer Summary

Make sky-maps of objects that TESS sees.

## Operational Role

For a systems engineer, lgbouma/tessmaps belongs in the Space Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-30T22:22:13Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-251438d28caebd` from `github_search_space_maps` as `registry_expansion`
