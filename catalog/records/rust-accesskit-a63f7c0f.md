...
| Canonical URL | [https://crates.io/crates/accesskit](https://crates.io/crates/accesskit) |
| Source record ids | crates_io-6fea78e3656441 |
...
For a systems engineer, accesskit belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.0 | 2026-08-29T09:18:11.072230Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-6fea78e3656441` from `crates_io` as `registry_expansion`
