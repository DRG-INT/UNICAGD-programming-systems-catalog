...
<!-- canonical: https://github.com/HUANGCHIHHUNGLeo/claude-real-video -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HUANGCHIHHUNGLeo/claude-real-video](https://github.com/HUANGCHIHHUNGLeo/claude-real-video) |
| Source record ids | github_search_video-2c0f9486ff2276 |

## System Engineer Summary

Let Claude (or any LLM) actually watch a video — scene-aware, deduplicated frames + transcript, from
a URL or local file. Runs locally, MIT.

## Operational Role

For a systems engineer, HUANGCHIHHUNGLeo/claude-real-video belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T09:21:45Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-2c0f9486ff2276` from `github_search_video` as `registry_expansion`
