...
<!-- canonical: https://github.com/syu-tan/sar-python-book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/syu-tan/sar-python-book](https://github.com/syu-tan/sar-python-book) |
| Source record ids | github_search_radars-787805b4b0c5f0 |

## System Engineer Summary

書籍「SAR衛星データ解析入門 」Python のコード管理用レポジトリ

## Operational Role

For a systems engineer, syu-tan/sar-python-book belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-28T06:30:04Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-787805b4b0c5f0` from `github_search_radars` as `registry_expansion`
