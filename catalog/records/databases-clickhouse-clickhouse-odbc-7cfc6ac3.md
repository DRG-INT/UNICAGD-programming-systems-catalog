...
<!-- canonical: https://github.com/ClickHouse/clickhouse-odbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ClickHouse/clickhouse-odbc](https://github.com/ClickHouse/clickhouse-odbc) |
| Source record ids | github_search_databases-a961fd0c16274d |
...
For a systems engineer, ClickHouse/clickhouse-odbc belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T15:43:22Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a961fd0c16274d` from `github_search_databases` as `registry_expansion`
