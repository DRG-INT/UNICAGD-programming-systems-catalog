...
<!-- canonical: https://packagist.org/packages/luxifer/doctrine-functions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/luxifer/doctrine-functions](https://packagist.org/packages/luxifer/doctrine-functions) |
| Source record ids | packagist_search-235b445b81c7e9 |
...
For a systems engineer, luxifer/doctrine-functions belongs in the PHP inventory as part of state
...
- `packagist_search-235b445b81c7e9` from `packagist_search` as `registry_expansion`
