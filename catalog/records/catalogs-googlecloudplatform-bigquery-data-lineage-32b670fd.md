...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GoogleCloudPlatform/bigquery-data-lineage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GoogleCloudPlatform/bigquery-data-lineage](https://github.com/GoogleCloudPlatform/bigquery-data-lineage) |
| Source record ids | github_search_catalogs-20c6cd91adef93 |

## System Engineer Summary

Reference implementation for real-time Data Lineage tracking for BigQuery using Audit Logs, ZetaSQL
and Dataflow.

## Operational Role

For a systems engineer, GoogleCloudPlatform/bigquery-data-lineage belongs in the Catalogs inventory
as part of supply-chain review, vulnerability detection, and release gate enforcement.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-03T01:17:51Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-20c6cd91adef93` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| lakekeeper/lakekeeper | Security Sast | [open](catalogs-lakekeeper-lakekeeper-47299c16.md) |
| OpenSSF Scorecard | Security Sast | [open](catalogs-openssf-scorecard-808ecb37.md) |
