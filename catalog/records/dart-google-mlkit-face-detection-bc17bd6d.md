...
<!-- canonical: https://pub.dev/packages/google_mlkit_face_detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_mlkit_face_detection](https://pub.dev/packages/google_mlkit_face_detection) |
| Source record ids | pub_dev-367be197599ade |

## System Engineer Summary

A Flutter plugin to use Google's ML Kit Face Detection to detect faces in an image, identify key
facial features, and get the contours of detected faces.

## Operational Role

For a systems engineer, google_mlkit_face_detection belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.1 | 2026-08-17T20:45:47.793625Z | [https://pub.dev/api/packages/google_mlkit_face_detection](https://pub.dev/api/packages/google_mlkit_face_detection) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_mlkit_face_detection` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-367be197599ade` from `pub_dev` as `registry_expansion`
