...
<!-- canonical: https://pypi.org/project/aapt-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aapt-mcp-server/](https://pypi.org/project/aapt-mcp-server/) |
| Source record ids | pypi_simple-c50a1cc308d312 |
...
For a systems engineer, aapt-mcp-server belongs in the Python inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-05-16T06:17:18.578365Z | [https://pypi.org/pypi/aapt-mcp-server/json](https://pypi.org/pypi/aapt-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aapt-mcp-server/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-c50a1cc308d312` from `pypi_simple` as `registry_expansion`
