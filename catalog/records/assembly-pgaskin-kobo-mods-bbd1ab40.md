...
<!-- canonical: https://github.com/pgaskin/kobo-mods -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pgaskin/kobo-mods](https://github.com/pgaskin/kobo-mods) |
| Source record ids | github_search_assembly-be4ae0cfb7e622 |
...
For a systems engineer, pgaskin/kobo-mods belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T01:59:10Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-be4ae0cfb7e622` from `github_search_assembly` as `registry_expansion`
