...
<!-- canonical: https://github.com/MirzaBeig/Anime-Speed-Lines -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MirzaBeig/Anime-Speed-Lines](https://github.com/MirzaBeig/Anime-Speed-Lines) |
| Source record ids | github_search_effects-7db06a8ed787ec |

## System Engineer Summary

Post-processing effect to procedurally generate a anime/manga-style vignette of lines typically used
to portray speed or surprise.

## Operational Role

For a systems engineer, MirzaBeig/Anime-Speed-Lines belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-18T17:23:00Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-7db06a8ed787ec` from `github_search_effects` as `registry_expansion`
