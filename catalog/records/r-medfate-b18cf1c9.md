...
<!-- canonical: https://cran.r-project.org/web/packages/medfate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/medfate/index.html](https://cran.r-project.org/web/packages/medfate/index.html) |
| Source record ids | cran_packages_by_date-d300cfc68e6ae3 |
...
For a systems engineer, medfate belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.0 | 2026-09-03 05:20:19 UTC | [https://cran.r-project.org/web/packages/medfate/DESCRIPTION](https://cran.r-project.org/web/packages/medfate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/medfate/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-d300cfc68e6ae3` from `cran_packages_by_date` as `registry_expansion`
