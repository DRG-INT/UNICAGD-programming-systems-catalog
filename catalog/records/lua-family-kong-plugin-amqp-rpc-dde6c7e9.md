...
| Canonical URL | [https://luarocks.org/modules/helmutb/kong-plugin-amqp-rpc](https://luarocks.org/modules/helmutb/kong-plugin-amqp-rpc) |
| Source record ids | luarocks_root_manifest-216d4ca359debf |
...
For a systems engineer, kong-plugin-amqp-rpc belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-216d4ca359debf` from `luarocks_root_manifest` as `registry_expansion`
