...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/evolution-gaming/kafka-journal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/evolution-gaming/kafka-journal](https://github.com/evolution-gaming/kafka-journal) |
| Source record ids | github_search_magazines-bbd48ea2b84079 |
...
For a systems engineer, evolution-gaming/kafka-journal belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:51:46Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-bbd48ea2b84079` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| pmoskovi/kafka-learning-resources | Message Broker | [open](magazines-pmoskovi-kafka-learning-resources-bd3ddacf.md) |
