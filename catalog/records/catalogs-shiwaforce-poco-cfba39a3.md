...
<!-- canonical: https://github.com/shiwaforce/poco -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shiwaforce/poco](https://github.com/shiwaforce/poco) |
| Source record ids | github_search_catalogs-f70d3a6bcd521a |

## System Engineer Summary

Poco will help you to organise and manage Docker, Docker-Compose, Kubernetes, Openshift projects of
any complexity using simple YAML config files to shorten the route from finding your project to
initialising it in your local environment.

## Operational Role

For a systems engineer, shiwaforce/poco belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-30T08:55:36Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-f70d3a6bcd521a` from `github_search_catalogs` as `registry_expansion`
