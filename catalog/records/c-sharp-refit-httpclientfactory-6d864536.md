...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Refit.HttpClientFactory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Refit.HttpClientFactory](https://www.nuget.org/packages/Refit.HttpClientFactory) |
| Source record ids | nuget_search-507f3ffa079063 |

## System Engineer Summary

Microsoft.Extensions.Http integration for Refit, adding AddRefitClient support for typed
HttpClientFactory clients, dependency injection, handlers, and Polly-style HTTP pipelines.

## Operational Role

For a systems engineer, Refit.HttpClientFactory belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 15.2.0 | 2026-08-18T14:52:53.573+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit.httpclientfactory/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit.httpclientfactory/index.json) |  |
| preview | known | 15.0.0-beta.1 | 2026-08-03T08:34:48.68+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit.httpclientfactory/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit.httpclientfactory/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/refit.httpclientfactory/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-507f3ffa079063` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Confluent.SchemaRegistry.Serdes.Json | Package Manager | [open](c-sharp-confluent-schemaregistry-serdes-json-b13c41d5.md) |
