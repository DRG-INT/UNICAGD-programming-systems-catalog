...
| Canonical URL | [https://github.com/BinomialLLC/basis_universal](https://github.com/BinomialLLC/basis_universal) |
| Source record ids | curated_language_routes-e7e5c45c0ba621 |

## System Engineer Summary

Universal GPU texture compression system and transcoder for runtime asset delivery.

## Operational Role

For a systems engineer, Basis Universal belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2_50 | 2026-08-03T14:01:53Z | [https://api.github.com/repos/BinomialLLC/basis_universal/releases/latest](https://api.github.com/repos/BinomialLLC/basis_universal/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/BinomialLLC/basis_universal/releases/latest` at `2026-09-01T12:30:35+00:00`.
...
- `curated_language_routes-e7e5c45c0ba621` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| SVGO | Compression | [open](assets-svgo-ce984043.md) |
