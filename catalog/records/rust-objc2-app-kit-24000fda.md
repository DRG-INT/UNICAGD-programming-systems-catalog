...
<!-- canonical: https://crates.io/crates/objc2-app-kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2-app-kit](https://crates.io/crates/objc2-app-kit) |
| Source record ids | crates_io-7f503e72a82379 |
...
For a systems engineer, objc2-app-kit belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T16:16:50.311115Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-02T20:20:01+00:00`.
...
- `crates_io-7f503e72a82379` from `crates_io` as `registry_expansion`
