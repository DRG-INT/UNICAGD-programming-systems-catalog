...
<!-- canonical: https://github.com/bazelbuild/examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/examples](https://github.com/bazelbuild/examples) |
| Source record ids | github_search_starlark-79b59a48fb0830 |

## System Engineer Summary

bazelbuild/examples is tracked as a language specification record in the Starlark branch. The source
...
For a systems engineer, bazelbuild/examples belongs in the Starlark inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T14:21:32Z | gh search repos language:Starlark stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-79b59a48fb0830` from `github_search_starlark` as `registry_expansion`
