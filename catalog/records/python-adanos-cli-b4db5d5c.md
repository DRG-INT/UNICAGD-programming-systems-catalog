...
<!-- canonical: https://pypi.org/project/adanos-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adanos-cli/](https://pypi.org/project/adanos-cli/) |
| Source record ids | pypi_simple-3a826258e9ee71 |
...
For a systems engineer, adanos-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.33.0 | 2026-08-09T15:33:36.753356Z | [https://pypi.org/pypi/adanos-cli/json](https://pypi.org/pypi/adanos-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adanos-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-3a826258e9ee71` from `pypi_simple` as `registry_expansion`
