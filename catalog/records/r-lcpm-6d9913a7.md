...
<!-- canonical: https://cran.r-project.org/web/packages/lcpm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lcpm/index.html](https://cran.r-project.org/web/packages/lcpm/index.html) |
| Source record ids | cran_packages_by_date-2449c33820424f |
...
For a systems engineer, lcpm belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-14 04:50:11 UTC | [https://cran.r-project.org/web/packages/lcpm/DESCRIPTION](https://cran.r-project.org/web/packages/lcpm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lcpm/DESCRIPTION` at `2026-09-14T05:19:48+00:00`.
...
- `cran_packages_by_date-2449c33820424f` from `cran_packages_by_date` as `registry_expansion`
