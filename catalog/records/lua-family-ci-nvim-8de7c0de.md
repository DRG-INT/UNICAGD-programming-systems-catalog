...
<!-- canonical: https://luarocks.org/modules/barrettruth/ci.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/barrettruth/ci.nvim](https://luarocks.org/modules/barrettruth/ci.nvim) |
| Source record ids | luarocks_root_manifest-2f64a383144816 |

## System Engineer Summary

ci.nvim is tracked as an ide editor integration record in the Lua family branch. The source did not
...
For a systems engineer, ci.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2f64a383144816` from `luarocks_root_manifest` as `registry_expansion`
