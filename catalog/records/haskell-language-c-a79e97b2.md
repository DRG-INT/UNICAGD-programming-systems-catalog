...
<!-- canonical: https://hackage.haskell.org/package/language-c -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/language-c](https://hackage.haskell.org/package/language-c) |
| Source record ids | hackage_top_downloads-c62278901a58d9 |
...
For a systems engineer, language-c belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2 | 2026-03-11T20:44:36Z | [https://hackage.haskell.org/package/language-c](https://hackage.haskell.org/package/language-c) |  |
| candidate | partial | 0.9 |  | [https://hackage.haskell.org/package/language-c](https://hackage.haskell.org/package/language-c) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/language-c` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-c62278901a58d9` from `hackage_top_downloads` as `registry_expansion`
