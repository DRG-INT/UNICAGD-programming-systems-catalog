...
<!-- canonical: https://github.com/jordanbaird/Ice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jordanbaird/Ice](https://github.com/jordanbaird/Ice) |
| Source record ids | github_search_swift-123c5a0680be5b |
...
For a systems engineer, jordanbaird/Ice belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- |
| github_repository_search | registry-derived | 2026-09-01 | `{"kind": "github_repository_search", "query": "language:Swift stars:>1000", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `github_search_swift-123c5a0680be5b` from `github_search_swift` as `registry_expansion`
...
| Dimillian/IceCubesApp | Undefined Behavior Analyzer | [open](swift-dimillian-icecubesapp-9d130079.md) |
