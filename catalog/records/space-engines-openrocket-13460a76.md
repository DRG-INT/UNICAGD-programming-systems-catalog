...
| Canonical URL | [https://github.com/openrocket/openrocket](https://github.com/openrocket/openrocket) |
| Source record ids | curated_language_routes-a9c512d88db9f0 |

## System Engineer Summary

Rocket design and flight simulation application for airframes, motors, stability, aerodynamics, and
trajectories.

## Operational Role

For a systems engineer, OpenRocket belongs in the Space Engines inventory as part of ecosystem
...
- `curated_language_routes-a9c512d88db9f0` from `curated_language_routes` as `registry_expansion`
...
| Orekit | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-orekit-79c32d33.md) |
