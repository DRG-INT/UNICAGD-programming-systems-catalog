...
<!-- canonical: https://cran.r-project.org/web/packages/fedstatAPIr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fedstatAPIr/index.html](https://cran.r-project.org/web/packages/fedstatAPIr/index.html) |
| Source record ids | cran_packages_by_date-8274cf649a310d |
...
For a systems engineer, fedstatAPIr belongs in the R inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-04 02:30:02 UTC | [https://cran.r-project.org/web/packages/fedstatAPIr/DESCRIPTION](https://cran.r-project.org/web/packages/fedstatAPIr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fedstatAPIr/DESCRIPTION` at `2026-09-04T03:19:43+00:00`.
...
- `cran_packages_by_date-8274cf649a310d` from `cran_packages_by_date` as `registry_expansion`
