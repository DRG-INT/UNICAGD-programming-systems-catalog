...
<!-- canonical: https://www.nuget.org/packages/JWT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JWT](https://www.nuget.org/packages/JWT) |
| Source record ids | nuget_search-268c742a07bbff |
...
For a systems engineer, JWT belongs in the C-Sharp inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.1.0 | 2026-07-06T17:26:51.013+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jwt/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jwt/index.json) |  |
| preview | known | 11.1.0-beta1 | 2026-06-03T00:55:51.177+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jwt/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jwt/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jwt/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-268c742a07bbff` from `nuget_search` as `registry_expansion`
