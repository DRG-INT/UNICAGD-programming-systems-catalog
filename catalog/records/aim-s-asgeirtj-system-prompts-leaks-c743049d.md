...
<!-- canonical: https://github.com/asgeirtj/system_prompts_leaks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) |
| Source record ids | github_search_aims-f76a727d76a34c |

## System Engineer Summary

Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI
- ChatGPT GPT-5.6-Sol, Codex. Google - Gemini 3.5 Flash, 3.1 Pro, Antigravity. xAI - Grok, Cursor,
Copilot, VS Code, Perplexity, and more. Updated regularly.

## Operational Role

For a systems engineer, asgeirtj/system_prompts_leaks belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T11:14:45Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-f76a727d76a34c` from `github_search_aims` as `registry_expansion`
