...
| Canonical URL | [https://github.com/datarhei/restreamer](https://github.com/datarhei/restreamer) |
| Source record ids | github_search_video-564acf6ede9fef |

## System Engineer Summary

The Restreamer is a complete streaming server solution for self-hosting. It has a visually appealing
user interface and no ongoing license costs. Upload your live stream to YouTube, Twitch, Facebook,
Vimeo, or other streaming solutions like Wowza. Receive video data from OBS and publish it with the
RTMP and SRT server.

## Operational Role

For a systems engineer, datarhei/restreamer belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.12.0 | 2024-09-13T14:27:08Z | [https://api.github.com/repos/datarhei/restreamer/releases/latest](https://api.github.com/repos/datarhei/restreamer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/datarhei/restreamer/releases/latest` at `2026-09-01T09:23:23+00:00`.
...
- `github_search_video-564acf6ede9fef` from `github_search_video` as `registry_expansion`
