...
<!-- canonical: https://cran.r-project.org/web/packages/fpc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fpc/index.html](https://cran.r-project.org/web/packages/fpc/index.html) |
| Source record ids | cran_packages_by_date-15262b292d031c |
...
For a systems engineer, fpc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2-15 | 2026-08-19 16:00:02 UTC | [https://cran.r-project.org/web/packages/fpc/DESCRIPTION](https://cran.r-project.org/web/packages/fpc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fpc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-15262b292d031c` from `cran_packages_by_date` as `registry_expansion`
