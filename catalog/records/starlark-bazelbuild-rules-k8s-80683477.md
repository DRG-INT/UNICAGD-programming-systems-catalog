...
<!-- canonical: https://github.com/bazelbuild/rules_k8s -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/rules_k8s](https://github.com/bazelbuild/rules_k8s) |
| Source record ids | github_search_starlark-96df44e45f7058 |
...
For a systems engineer, bazelbuild/rules_k8s belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-12T13:44:37Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_starlark-96df44e45f7058` from `github_search_starlark` as `registry_expansion`
