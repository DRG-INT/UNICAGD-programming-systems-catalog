...
<!-- canonical: https://luarocks.org/modules/jcrd/awesome-ez -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jcrd/awesome-ez](https://luarocks.org/modules/jcrd/awesome-ez) |
| Source record ids | luarocks_root_manifest-9d2fe42568615c |
...
For a systems engineer, awesome-ez belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-9d2fe42568615c` from `luarocks_root_manifest` as `registry_expansion`
