...
<!-- canonical: https://cran.r-project.org/web/packages/ria.test/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ria.test/index.html](https://cran.r-project.org/web/packages/ria.test/index.html) |
| Source record ids | cran_packages_by_date-bec0b3969149bf |

## System Engineer Summary

Testing Equality of Natural Mediation Effects and Their Randomized Interventional Analogues

## Operational Role

For a systems engineer, ria.test belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-15 00:20:02 UTC | [https://cran.r-project.org/web/packages/ria.test/DESCRIPTION](https://cran.r-project.org/web/packages/ria.test/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ria.test/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-bec0b3969149bf` from `cran_packages_by_date` as `registry_expansion`
