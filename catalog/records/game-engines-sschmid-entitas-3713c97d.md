...
<!-- canonical: https://github.com/sschmid/Entitas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sschmid/Entitas](https://github.com/sschmid/Entitas) |
| Source record ids | github_search_game_engines-32a46a6917fcc9 |
...
For a systems engineer, sschmid/Entitas belongs in the Game Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-30T16:18:56Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-32a46a6917fcc9` from `github_search_game_engines` as `registry_expansion`
