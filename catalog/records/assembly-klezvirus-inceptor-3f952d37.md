...
<!-- canonical: https://github.com/klezVirus/inceptor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/klezVirus/inceptor](https://github.com/klezVirus/inceptor) |
| Source record ids | github_search_assembly-a5cf8933edf1ae |
...
For a systems engineer, klezVirus/inceptor belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-03T09:33:21Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-a5cf8933edf1ae` from `github_search_assembly` as `registry_expansion`
