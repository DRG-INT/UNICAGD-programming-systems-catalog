...
| Canonical URL | [https://crates.io/crates/diesel_migrations](https://crates.io/crates/diesel_migrations) |
| Source record ids | crates_io-547def63e6ca74 |
...
For a systems engineer, diesel_migrations belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-04-24T09:23:28.331933Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-547def63e6ca74` from `crates_io` as `registry_expansion`
