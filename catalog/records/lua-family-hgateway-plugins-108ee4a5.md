...
| Canonical URL | [https://luarocks.org/modules/liuhongtian/hgateway-plugins](https://luarocks.org/modules/liuhongtian/hgateway-plugins) |
| Source record ids | luarocks_root_manifest-7b5da6ff190774 |

## System Engineer Summary

hgateway-plugins is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, hgateway-plugins belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7b5da6ff190774` from `luarocks_root_manifest` as `registry_expansion`
