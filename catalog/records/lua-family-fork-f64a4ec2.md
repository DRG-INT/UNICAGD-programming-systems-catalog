...
| Canonical URL | [https://luarocks.org/modules/mah0x211/fork](https://luarocks.org/modules/mah0x211/fork) |
| Source record ids | luarocks_root_manifest-9a1b0cb5e87b14 |

## System Engineer Summary

fork is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, fork belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9a1b0cb5e87b14` from `luarocks_root_manifest` as `registry_expansion`
