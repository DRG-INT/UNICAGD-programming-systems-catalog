...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_datagrid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_datagrid](https://pub.dev/packages/syncfusion_flutter_datagrid) |
| Source record ids | pub_dev-036f808454c159 |

## System Engineer Summary

The Syncfusion Flutter DataGrid is used to display and manipulate data in a tabular view. Its rich
feature set includes different types of columns, selections, column sizing, etc.

## Operational Role

For a systems engineer, syncfusion_flutter_datagrid belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:37:07.784682Z | [https://pub.dev/api/packages/syncfusion_flutter_datagrid](https://pub.dev/api/packages/syncfusion_flutter_datagrid) |  |
| preview | known | 19.3.43-beta | 2021-09-30T13:00:32.035038Z | [https://pub.dev/api/packages/syncfusion_flutter_datagrid](https://pub.dev/api/packages/syncfusion_flutter_datagrid) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_datagrid` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-036f808454c159` from `pub_dev` as `registry_expansion`
