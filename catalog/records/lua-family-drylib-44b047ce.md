...
<!-- canonical: https://luarocks.org/modules/dryproject/drylib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dryproject/drylib](https://luarocks.org/modules/dryproject/drylib) |
| Source record ids | luarocks_root_manifest-77c7fbd1710a38 |

## System Engineer Summary

drylib is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, drylib belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-77c7fbd1710a38` from `luarocks_root_manifest` as `registry_expansion`
