...
<!-- canonical: https://github.com/spm/spm12 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spm/spm12](https://github.com/spm/spm12) |
| Source record ids | github_search_matlab-1589db615c4d98 |

## System Engineer Summary

Public Releases of SPM12 - see for the Development Version

## Operational Role

For a systems engineer, spm/spm12 belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-05T13:43:41Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 3); Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
- `github_search_matlab-1589db615c4d98` from `github_search_matlab` as `registry_expansion`
