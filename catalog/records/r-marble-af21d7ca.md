...
<!-- canonical: https://cran.r-project.org/web/packages/marble/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/marble/index.html](https://cran.r-project.org/web/packages/marble/index.html) |
| Source record ids | cran_packages_by_date-7d09fef182296c |
...
For a systems engineer, marble belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-09-10 16:50:02 UTC | [https://cran.r-project.org/web/packages/marble/DESCRIPTION](https://cran.r-project.org/web/packages/marble/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/marble/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-7d09fef182296c` from `cran_packages_by_date` as `registry_expansion`
