...
<!-- canonical: https://www.nuget.org/packages/Steeltoe.Common.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Steeltoe.Common.Http](https://www.nuget.org/packages/Steeltoe.Common.Http) |
| Source record ids | nuget_search-9bfa01d664eed5 |
...
For a systems engineer, Steeltoe.Common.Http belongs in the C-Sharp inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-05-28T15:44:17.53+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/steeltoe.common.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/steeltoe.common.http/index.json) |  |
| preview | known | 4.0.0-rc1 | 2025-07-21T14:56:56.51+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/steeltoe.common.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/steeltoe.common.http/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/steeltoe.common.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-9bfa01d664eed5` from `nuget_search` as `registry_expansion`
