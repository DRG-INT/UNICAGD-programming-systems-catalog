...
<!-- canonical: https://cran.r-project.org/web/packages/magentabook/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/magentabook/index.html](https://cran.r-project.org/web/packages/magentabook/index.html) |
| Source record ids | cran_packages_by_date-f7935a6e863ce5 |
...
For a systems engineer, magentabook belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-08 07:30:02 UTC | [https://cran.r-project.org/web/packages/magentabook/DESCRIPTION](https://cran.r-project.org/web/packages/magentabook/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/magentabook/DESCRIPTION` at `2026-09-08T08:22:37+00:00`.
...
- `cran_packages_by_date-f7935a6e863ce5` from `cran_packages_by_date` as `registry_expansion`
