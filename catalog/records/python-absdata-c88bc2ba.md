...
<!-- canonical: https://pypi.org/project/absdata/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/absdata/](https://pypi.org/project/absdata/) |
| Source record ids | pypi_simple-67e5e39cc1e575 |

## System Engineer Summary

Access to ABS data and correspondencies

## Operational Role

For a systems engineer, absdata belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4 | 2019-02-27T10:58:52.668789Z | [https://pypi.org/pypi/absdata/json](https://pypi.org/pypi/absdata/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/absdata/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-67e5e39cc1e575` from `pypi_simple` as `registry_expansion`
