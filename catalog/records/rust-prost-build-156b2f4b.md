...
<!-- canonical: https://crates.io/crates/prost-build -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/prost-build](https://crates.io/crates/prost-build) |
| Source record ids | crates_io-f08fe99ffbe27d |
...
For a systems engineer, prost-build belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.4 | 2026-06-07T10:14:03.681322Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT; https://www.nuget.org/packages/Refit.HttpClientFactory/15.2.0/license |
...
- `crates_io-f08fe99ffbe27d` from `crates_io` as `registry_expansion`
