...
<!-- canonical: https://github.com/wfh45678/radar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wfh45678/radar](https://github.com/wfh45678/radar) |
| Source record ids | github_search_radars-6bd8492dbcebf3 |

## System Engineer Summary

实时风控引擎(Risk Engine)，自定义规则引擎（Rule Script），完美支持中文，适用于反欺诈(Anti-fraud)应用场景，开箱即用！！！移动互联网时代的风险管理利器，你 Get
到了吗？

## Operational Role

For a systems engineer, wfh45678/radar belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.8 | 2021-03-12T11:15:21Z | [https://api.github.com/repos/wfh45678/radar/releases/latest](https://api.github.com/repos/wfh45678/radar/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wfh45678/radar/releases/latest` at `2026-09-01T08:26:33+00:00`.
...
- `github_search_radars-6bd8492dbcebf3` from `github_search_radars` as `registry_expansion`
