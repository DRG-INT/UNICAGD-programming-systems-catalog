# froehlicht/motion2midi

## Navigation

[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/froehlicht/motion2midi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/froehlicht/motion2midi](https://github.com/froehlicht/motion2midi) |
| Source record ids | github_search_audio-1ae0618f26d25e |

## System Engineer Summary

Control MIDI parameters with hand movements via webcam. Real-time motion tracking plugin for DAWs
(Ableton, FL Studio, ...).

## Operational Role

For a systems engineer, froehlicht/motion2midi belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-04T20:12:26Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-1ae0618f26d25e` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| breizhn/DTLN | Datetime | [open](audio-breizhn-dtln-2ae9e899.md) |
| calebj0seph/spectro | Datetime | [open](audio-calebj0seph-spectro-9a892655.md) |
| davemollen/dm-TimeWarp | Datetime | [open](audio-davemollen-dm-timewarp-c29516e9.md) |
| eegsynth/eegsynth | Datetime | [open](audio-eegsynth-eegsynth-119d0208.md) |
| hanifabd/voice-activity-detection-vad-realtime | Datetime | [open](audio-hanifabd-voice-activity-detection-vad-realtime-a0168f13.md) |
| monadgroup/axiom | Datetime | [open](audio-monadgroup-axiom-6c13a95f.md) |
| neodsp/neort | Datetime | [open](audio-neodsp-neort-24efdd30.md) |
| nyrahealth/CrisperWhisper | Datetime | [open](audio-nyrahealth-crisperwhisper-b827d51a.md) |
