...
<!-- canonical: https://cran.r-project.org/web/packages/multigraph/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multigraph/index.html](https://cran.r-project.org/web/packages/multigraph/index.html) |
| Source record ids | cran_packages_by_date-e90c3892fc25b9 |
...
For a systems engineer, multigraph belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-08-19 12:20:02 UTC | [https://cran.r-project.org/web/packages/multigraph/DESCRIPTION](https://cran.r-project.org/web/packages/multigraph/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multigraph/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e90c3892fc25b9` from `cran_packages_by_date` as `registry_expansion`
