...
<!-- canonical: https://github.com/3dcitydb/3dcitydb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/3dcitydb/3dcitydb](https://github.com/3dcitydb/3dcitydb) |
| Source record ids | github_search_maps-c5d1bcedf07716 |
...
For a systems engineer, 3dcitydb/3dcitydb belongs in the Maps inventory as part of state
...
- `github_search_maps-c5d1bcedf07716` from `github_search_maps` as `registry_expansion`
