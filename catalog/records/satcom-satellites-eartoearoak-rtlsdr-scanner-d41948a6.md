...
<!-- canonical: https://github.com/EarToEarOak/RTLSDR-Scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EarToEarOak/RTLSDR-Scanner](https://github.com/EarToEarOak/RTLSDR-Scanner) |
| Source record ids | github_search_satcom_satellites-1263cf13f766b5 |
...
For a systems engineer, EarToEarOak/RTLSDR-Scanner belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-05T21:57:35Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-1263cf13f766b5` from `github_search_satcom_satellites` as `registry_expansion`
