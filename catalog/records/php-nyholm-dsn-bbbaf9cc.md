...
<!-- canonical: https://packagist.org/packages/nyholm/dsn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nyholm/dsn](https://packagist.org/packages/nyholm/dsn) |
| Source record ids | packagist_search-98bc9bcae4fb69 |
...
For a systems engineer, nyholm/dsn belongs in the PHP inventory as part of state persistence,
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; {"key": "", "name": "", "url": ""}; The Unlicense; https://api.github.com/licenses/unlicense |
...
- `packagist_search-98bc9bcae4fb69` from `packagist_search` as `registry_expansion`
