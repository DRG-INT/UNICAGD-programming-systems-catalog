...
<!-- canonical: https://github.com/morriswmz/doa-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/morriswmz/doa-tools](https://github.com/morriswmz/doa-tools) |
| Source record ids | github_search_matlab-fa9faf22e07479 |
...
For a systems engineer, morriswmz/doa-tools belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-07T20:47:45Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-fa9faf22e07479` from `github_search_matlab` as `registry_expansion`
