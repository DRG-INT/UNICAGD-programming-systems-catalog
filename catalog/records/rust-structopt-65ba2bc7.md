...
| Source record ids | corpus-412c868c162b72 |

## System Engineer Summary

structopt is tracked as a cli record in the Rust branch. The source did not provide a long
...
- `corpus-412c868c162b72` from `master_json` as `cli`
