...
| Canonical URL | [https://luarocks.org/modules/har5hit/kong-external-auth-plugin](https://luarocks.org/modules/har5hit/kong-external-auth-plugin) |
| Source record ids | luarocks_root_manifest-d89b6cf03ded86 |

## System Engineer Summary

kong-external-auth-plugin is tracked as a library record in the Lua family branch. The source did
...
For a systems engineer, kong-external-auth-plugin belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-d89b6cf03ded86` from `luarocks_root_manifest` as `registry_expansion`
