...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/helm/helm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/helm/helm](https://github.com/helm/helm) |
| Source record ids | github_search_go-d424c73b8d6429 |
...
For a systems engineer, helm/helm belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T23:17:21Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Go stars:>3000", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_go-d424c73b8d6429` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 1Panel-dev/1Panel | Language Specification | [open](go-1panel-dev-1panel-effa2b43.md) |
| abiosoft/colima | Language Specification | [open](go-abiosoft-colima-0ac0ec4e.md) |
| AlistGo/alist | Language Specification | [open](go-alistgo-alist-0be2effe.md) |
| antlr/antlr4 | Language Specification | [open](go-antlr-antlr4-1390b066.md) |
| aquasecurity/trivy | Language Specification | [open](go-aquasecurity-trivy-a759b66b.md) |
| astaxie/build-web-application-with-golang | Language Specification | [open](go-astaxie-build-web-application-with-golang-30f88db6.md) |
| authelia/authelia | Language Specification | [open](go-authelia-authelia-bd98b68d.md) |
| avelino/awesome-go | Language Specification | [open](go-avelino-awesome-go-512e7dd9.md) |
