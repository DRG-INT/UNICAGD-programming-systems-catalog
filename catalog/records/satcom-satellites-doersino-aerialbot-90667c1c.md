...
<!-- canonical: https://github.com/doersino/aerialbot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doersino/aerialbot](https://github.com/doersino/aerialbot) |
| Source record ids | github_search_satcom_satellites-b23e8f22ebbbbd |

## System Engineer Summary

A simple yet highly configurable Mastodon bot that posts geotagged aerial imagery of a random
location in the world.

## Operational Role

For a systems engineer, doersino/aerialbot belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-02T07:23:23Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-b23e8f22ebbbbd` from `github_search_satcom_satellites` as `registry_expansion`
