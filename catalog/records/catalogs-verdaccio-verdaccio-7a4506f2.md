...
<!-- canonical: https://github.com/verdaccio/verdaccio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/verdaccio/verdaccio](https://github.com/verdaccio/verdaccio) |
| Source record ids | github_search_catalogs-2e8e304d80612b |
...
For a systems engineer, verdaccio/verdaccio belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:33:41Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-2e8e304d80612b` from `github_search_catalogs` as `registry_expansion`
