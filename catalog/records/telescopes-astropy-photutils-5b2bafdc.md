...
| Source record ids | github_search_telescopes-50c7e12aa09b2b |
...
For a systems engineer, astropy/photutils belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-04-17T22:24:55Z | [https://api.github.com/repos/astropy/photutils/releases/latest](https://api.github.com/repos/astropy/photutils/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/astropy/photutils/releases/latest` at `2026-09-01T08:26:22+00:00`.
...
- `github_search_telescopes-50c7e12aa09b2b` from `github_search_telescopes` as `registry_expansion`
