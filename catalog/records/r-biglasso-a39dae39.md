...
<!-- canonical: https://cran.r-project.org/web/packages/biglasso/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/biglasso/index.html](https://cran.r-project.org/web/packages/biglasso/index.html) |
| Source record ids | cran_packages_by_date-cb33da91e618c6 |
...
For a systems engineer, biglasso belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.2 | 2026-08-25 11:01:05 UTC | [https://cran.r-project.org/web/packages/biglasso/DESCRIPTION](https://cran.r-project.org/web/packages/biglasso/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/biglasso/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cb33da91e618c6` from `cran_packages_by_date` as `registry_expansion`
