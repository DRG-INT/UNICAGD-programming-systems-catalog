...
<!-- canonical: https://cran.r-project.org/web/packages/gamlss.dist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gamlss.dist/index.html](https://cran.r-project.org/web/packages/gamlss.dist/index.html) |
| Source record ids | cran_packages_by_date-5773c28392e3f7 |
...
For a systems engineer, gamlss.dist belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1-11 | 2026-09-10 09:00:02 UTC | [https://cran.r-project.org/web/packages/gamlss.dist/DESCRIPTION](https://cran.r-project.org/web/packages/gamlss.dist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gamlss.dist/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-5773c28392e3f7` from `cran_packages_by_date` as `registry_expansion`
