...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pointfreeco/swift-composable-architecture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pointfreeco/swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) |
| Source record ids | awesome_list-64d36011d7a36a |

## System Engineer Summary

The Composable Architecture is a library for building applications in a consistent and
understandable way, with composition, testing, and ergonomics in mind.

## Operational Role

For a systems engineer, The Composable Architecture belongs in the Cocoa inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.2 | 2026-08-28T21:10:35Z | [https://api.github.com/repos/pointfreeco/swift-composable-architecture/releases/latest](https://api.github.com/repos/pointfreeco/swift-composable-architecture/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/pointfreeco/swift-composable-architecture/releases/latest` at `2026-09-01T07:24:07+00:00`.
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Architecture Patterns", "source_url": "https://raw.githubusercontent.com/vsouza/awesome-ios/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-64d36011d7a36a` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| algolia/instantsearch-ios | Build System | [open](cocoa-algolia-instantsearch-ios-1ffc950c.md) |
| briskml/brisk | Build System | [open](cocoa-briskml-brisk-0a4a5d4e.md) |
| Composable Navigator | Build System | [open](cocoa-composable-navigator-4c5e22f7.md) |
| DebugSwift/DebugSwift | Build System | [open](cocoa-debugswift-debugswift-306cbf91.md) |
| frang75/nappgui_src | Build System | [open](cocoa-frang75-nappgui-src-9b6a7c6d.md) |
| mangerlahn/Latest | Build System | [open](cocoa-mangerlahn-latest-c5177e79.md) |
| microsoft/fluentui-apple | Build System | [open](cocoa-microsoft-fluentui-apple-c58d8099.md) |
| ninjaprox/NVActivityIndicatorView | Build System | [open](cocoa-ninjaprox-nvactivityindicatorview-be1309bd.md) |
