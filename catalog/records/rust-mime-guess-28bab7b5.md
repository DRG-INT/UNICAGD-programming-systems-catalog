...
<!-- canonical: https://crates.io/crates/mime_guess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/mime_guess](https://crates.io/crates/mime_guess) |
| Source record ids | crates_io-6315ec83efeada |
...
For a systems engineer, mime_guess belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.5 | 2024-06-29T07:32:21.605352Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-6315ec83efeada` from `crates_io` as `registry_expansion`
