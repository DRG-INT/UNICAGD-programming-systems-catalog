...
| Source record ids | github_search_electromagnetoscopes-a2bafe840414e5 |
...
For a systems engineer, f4exb/sdrangel belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.27.2 | 2026-08-19T18:33:00Z | [https://api.github.com/repos/f4exb/sdrangel/releases/latest](https://api.github.com/repos/f4exb/sdrangel/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/f4exb/sdrangel/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-a2bafe840414e5` from `github_search_electromagnetoscopes` as `registry_expansion`
