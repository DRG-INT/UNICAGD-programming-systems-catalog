...
<!-- canonical: https://crates.io/crates/siphasher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/siphasher](https://crates.io/crates/siphasher) |
| Source record ids | crates_io-96e721964c92aa |
...
For a systems engineer, siphasher belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-05-03T20:58:08.152539Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-96e721964c92aa` from `crates_io` as `registry_expansion`
