...
<!-- canonical: https://crates.io/crates/gix-lock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gix-lock](https://crates.io/crates/gix-lock) |
| Source record ids | crates_io-881746d2b21651 |
...
For a systems engineer, gix-lock belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 24.0.0 | 2026-07-23T13:17:00.539690Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-881746d2b21651` from `crates_io` as `registry_expansion`
