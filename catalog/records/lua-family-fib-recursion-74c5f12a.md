...
| Canonical URL | [https://luarocks.org/modules/ljf7/fib-recursion](https://luarocks.org/modules/ljf7/fib-recursion) |
| Source record ids | luarocks_root_manifest-bbfd5b223ab1d7 |

## System Engineer Summary

fib-recursion is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, fib-recursion belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bbfd5b223ab1d7` from `luarocks_root_manifest` as `registry_expansion`
