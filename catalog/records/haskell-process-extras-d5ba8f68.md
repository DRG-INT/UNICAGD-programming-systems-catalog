...
<!-- canonical: https://hackage.haskell.org/package/process-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/process-extras](https://hackage.haskell.org/package/process-extras) |
| Source record ids | hackage_top_downloads-739422feec85a3 |
...
For a systems engineer, process-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.4 | 2018-02-03T16:53:15Z | [https://hackage.haskell.org/package/process-extras](https://hackage.haskell.org/package/process-extras) |  |
| candidate | partial | 0.4.1.4 |  | [https://hackage.haskell.org/package/process-extras](https://hackage.haskell.org/package/process-extras) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/process-extras` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-739422feec85a3` from `hackage_top_downloads` as `registry_expansion`
