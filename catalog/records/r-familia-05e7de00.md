...
<!-- canonical: https://cran.r-project.org/web/packages/Familia/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Familia/index.html](https://cran.r-project.org/web/packages/Familia/index.html) |
| Source record ids | cran_packages_by_date-eb3685dca2dd98 |

## System Engineer Summary

'shiny' Application for Population Structure and Ancestry Assessments

## Operational Role

For a systems engineer, Familia belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-24 15:50:11 UTC | [https://cran.r-project.org/web/packages/Familia/DESCRIPTION](https://cran.r-project.org/web/packages/Familia/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Familia/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eb3685dca2dd98` from `cran_packages_by_date` as `registry_expansion`
