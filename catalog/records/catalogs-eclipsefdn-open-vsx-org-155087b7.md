...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/EclipseFdn/open-vsx.org -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EclipseFdn/open-vsx.org](https://github.com/EclipseFdn/open-vsx.org) |
| Source record ids | github_search_catalogs-2872a89855face |

## System Engineer Summary

EclipseFdn/open-vsx.org is tracked as a package manager record in the Catalogs branch. The source
...
For a systems engineer, EclipseFdn/open-vsx.org belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:08:35Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:registry stars:>100", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-2872a89855face` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0x6d69636b/windows_hardening | Package Manager | [open](catalogs-0x6d69636b-windows-hardening-800b6709.md) |
| 89luca89/lilipod | Package Manager | [open](catalogs-89luca89-lilipod-04b83b9a.md) |
| Aetherinox/pause-windows-updates | Package Manager | [open](catalogs-aetherinox-pause-windows-updates-950b61a1.md) |
| agentclientprotocol/registry | Package Manager | [open](catalogs-agentclientprotocol-registry-7431edbd.md) |
| agentic-community/mcp-gateway-registry | Package Manager | [open](catalogs-agentic-community-mcp-gateway-registry-642bbde2.md) |
| agentregistry-dev/agentregistry | Package Manager | [open](catalogs-agentregistry-dev-agentregistry-33204e4a.md) |
| ancel1x/Ancels-Performance-Batch | Package Manager | [open](catalogs-ancel1x-ancels-performance-batch-c6cc4451.md) |
| andrey-pohilko/registry-cli | Package Manager | [open](catalogs-andrey-pohilko-registry-cli-f5eec2cd.md) |
