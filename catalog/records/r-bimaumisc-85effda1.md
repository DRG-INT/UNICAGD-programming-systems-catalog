...
<!-- canonical: https://cran.r-project.org/web/packages/BiMaUmisc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BiMaUmisc/index.html](https://cran.r-project.org/web/packages/BiMaUmisc/index.html) |
| Source record ids | cran_packages_by_date-e29ea83533ce05 |

## System Engineer Summary

BiMaUmisc is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, BiMaUmisc belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 09:50:12 UTC | [https://cran.r-project.org/web/packages/BiMaUmisc/DESCRIPTION](https://cran.r-project.org/web/packages/BiMaUmisc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BiMaUmisc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e29ea83533ce05` from `cran_packages_by_date` as `registry_expansion`
