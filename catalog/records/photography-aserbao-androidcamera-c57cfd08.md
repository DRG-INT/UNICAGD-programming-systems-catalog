...
<!-- canonical: https://github.com/aserbao/AndroidCamera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aserbao/AndroidCamera](https://github.com/aserbao/AndroidCamera) |
| Source record ids | github_search_photography-ef2d1a42746733 |

## System Engineer Summary

🔥🔥🔥自定义Android相机(仿抖音 TikTok)，其中功能包括视频人脸识别贴纸，美颜，分段录制，视频裁剪，视频帧处理，获取视频关键帧，视频旋转，添加滤镜，添加水印，合成Gif到视频，文字转视频，
图片转视频，音视频合成，音频变声处理，SoundTouch，Fmod音频处理。 Android camera(imitation Tik Tok), which includes video
editor,audio editor,video face recognition stickers, segment recording,video cropping, video frame
processing, get the first video frame, key frame, video rotation, add filter Mirror ,add watermark
,add gif to video, add text to video, picture to video, audio and video synthesis, audio change
processing, SoundTouch, Fmod audio processing.

## Operational Role

For a systems engineer, aserbao/AndroidCamera belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-13T09:07:29Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-ef2d1a42746733` from `github_search_photography` as `registry_expansion`
