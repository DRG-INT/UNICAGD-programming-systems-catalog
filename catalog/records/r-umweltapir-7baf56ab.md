...
<!-- canonical: https://cran.r-project.org/web/packages/umweltapir/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/umweltapir/index.html](https://cran.r-project.org/web/packages/umweltapir/index.html) |
| Source record ids | cran_packages_by_date-be3eef176a89bb |

## System Engineer Summary

Access 'umwelt.info' API

## Operational Role

For a systems engineer, umweltapir belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-24 11:20:02 UTC | [https://cran.r-project.org/web/packages/umweltapir/DESCRIPTION](https://cran.r-project.org/web/packages/umweltapir/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/umweltapir/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-be3eef176a89bb` from `cran_packages_by_date` as `registry_expansion`
