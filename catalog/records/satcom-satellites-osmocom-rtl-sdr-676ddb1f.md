...
| Source record ids | github_search_satcom_satellites-4a644f0d042389 |

## System Engineer Summary

library for turning a RTL2832 based DVB dongle into a Software DefinedReceiver; mirror from

## Operational Role

For a systems engineer, osmocom/rtl-sdr belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T22:46:48Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-4a644f0d042389` from `github_search_satcom_satellites` as `registry_expansion`
