...
<!-- canonical: https://luarocks.org/modules/vitiral/civix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vitiral/civix](https://luarocks.org/modules/vitiral/civix) |
| Source record ids | luarocks_root_manifest-842a2c55a13f43 |
...
For a systems engineer, civix belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-842a2c55a13f43` from `luarocks_root_manifest` as `registry_expansion`
