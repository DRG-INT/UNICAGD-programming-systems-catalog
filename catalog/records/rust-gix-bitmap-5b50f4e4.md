...
| Canonical URL | [https://crates.io/crates/gix-bitmap](https://crates.io/crates/gix-bitmap) |
| Source record ids | crates_io-83a90443c4554d |
...
For a systems engineer, gix-bitmap belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-22T19:02:36.891615Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-83a90443c4554d` from `crates_io` as `registry_expansion`
