...
<!-- canonical: https://luarocks.org/modules/jcrd/awesome-dovetail -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jcrd/awesome-dovetail](https://luarocks.org/modules/jcrd/awesome-dovetail) |
| Source record ids | luarocks_root_manifest-55882d39eb0b3a |
...
For a systems engineer, awesome-dovetail belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-55882d39eb0b3a` from `luarocks_root_manifest` as `registry_expansion`
