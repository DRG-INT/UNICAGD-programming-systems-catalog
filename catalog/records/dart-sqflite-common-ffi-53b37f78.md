...
<!-- canonical: https://pub.dev/packages/sqflite_common_ffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sqflite_common_ffi](https://pub.dev/packages/sqflite_common_ffi) |
| Source record ids | pub_dev-51ebc52ee9f552 |
...
For a systems engineer, sqflite_common_ffi belongs in the Dart inventory as part of unit/integration
...
- `pub_dev-51ebc52ee9f552` from `pub_dev` as `registry_expansion`
...
| patrol_cli | Testing Framework | [open](dart-patrol-cli-d6121f5b.md) |
| test | Testing Framework | [open](dart-test-85687c3f.md) |
