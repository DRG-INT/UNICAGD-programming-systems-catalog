...
<!-- canonical: https://crates.io/crates/enum-ordinalize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enum-ordinalize](https://crates.io/crates/enum-ordinalize) |
| Source record ids | crates_io-825289296661c0 |

## System Engineer Summary

This library enables enums to not only obtain the ordinal values of their variants but also allows
for the construction of enums from an ordinal value.

## Operational Role

For a systems engineer, enum-ordinalize belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.2 | 2026-07-29T09:23:50.431714Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-825289296661c0` from `crates_io` as `registry_expansion`
