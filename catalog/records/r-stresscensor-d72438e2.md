...
<!-- canonical: https://cran.r-project.org/web/packages/StressCensoR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/StressCensoR/index.html](https://cran.r-project.org/web/packages/StressCensoR/index.html) |
| Source record ids | cran_packages_by_date-839d26254c61e9 |

## System Engineer Summary

Generalized Stress-Strength Reliability Estimation Under Censoring Schemes

## Operational Role

For a systems engineer, StressCensoR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:40:23 UTC | [https://cran.r-project.org/web/packages/StressCensoR/DESCRIPTION](https://cran.r-project.org/web/packages/StressCensoR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/StressCensoR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-839d26254c61e9` from `cran_packages_by_date` as `registry_expansion`
