...
| Canonical URL | [https://crates.io/crates/tray-icon](https://crates.io/crates/tray-icon) |
| Source record ids | crates_io-48c47723d4e327 |
...
For a systems engineer, tray-icon belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.2 | 2026-07-27T09:24:58.436123Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-48c47723d4e327` from `crates_io` as `registry_expansion`
