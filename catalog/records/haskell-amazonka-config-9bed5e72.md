...
<!-- canonical: https://hackage.haskell.org/package/amazonka-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-config](https://hackage.haskell.org/package/amazonka-config) |
| Source record ids | hackage_top_downloads-a4bf422d4f4e68 |
...
For a systems engineer, amazonka-config belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:08:57Z | [https://hackage.haskell.org/package/amazonka-config](https://hackage.haskell.org/package/amazonka-config) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-config` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-a4bf422d4f4e68` from `hackage_top_downloads` as `registry_expansion`
