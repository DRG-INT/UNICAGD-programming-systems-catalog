...
<!-- canonical: https://crates.io/crates/memchr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/memchr](https://crates.io/crates/memchr) |
| Source record ids | crates_io-4b382b1ad01df1 |

## System Engineer Summary

Provides extremely fast (uses SIMD on x86_64, aarch64 and wasm32) routines for 1, 2 or 3 byte search
and single substring search.

## Operational Role

For a systems engineer, memchr belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.3 | 2026-07-08T00:49:54.408285Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-4b382b1ad01df1` from `crates_io` as `registry_expansion`
