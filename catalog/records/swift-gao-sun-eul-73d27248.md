...
<!-- canonical: https://github.com/gao-sun/eul -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gao-sun/eul](https://github.com/gao-sun/eul) |
| Source record ids | github_search_swift-b2e5a69d2d6b47 |
...
For a systems engineer, gao-sun/eul belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-25T22:59:12Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-b2e5a69d2d6b47` from `github_search_swift` as `registry_expansion`
