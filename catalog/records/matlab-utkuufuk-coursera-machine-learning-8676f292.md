...
<!-- canonical: https://github.com/utkuufuk/coursera-machine-learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/utkuufuk/coursera-machine-learning](https://github.com/utkuufuk/coursera-machine-learning) |
| Source record ids | github_search_matlab-a4b830ee9c9e72 |

## System Engineer Summary

My lecture notes and assignment solutions for the Coursera machine learning class taught by Andrew
Ng.

## Operational Role

For a systems engineer, utkuufuk/coursera-machine-learning belongs in the Matlab inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-09-28T20:38:29Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-a4b830ee9c9e72` from `github_search_matlab` as `registry_expansion`
