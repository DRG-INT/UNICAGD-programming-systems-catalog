...
<!-- canonical: https://gitlab.com/mopsa/mopsa-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/mopsa/mopsa-analyzer](https://gitlab.com/mopsa/mopsa-analyzer) |
| Source record ids | gitlab_projects_api-81a212cb685483 |
...
For a systems engineer, mopsa/mopsa-analyzer belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T14:57:22.050Z | [https://gitlab.com/api/v4/projects?search=static%20analysis&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=static%20analysis&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-03 | `{"kind": "gitlab_projects_api", "query": "static analysis", "retrieved": "2026-09-03", "status": "forge-api-derived"}` |
...
- `gitlab_projects_api-81a212cb685483` from `gitlab_projects_api` as `registry_expansion`
