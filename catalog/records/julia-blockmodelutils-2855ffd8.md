...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BlockmodelUtils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BlockmodelUtils](https://github.com/JuliaRegistries/General/tree/master/B/BlockmodelUtils) |
| Source record ids | julia_general-cc5bed0dfb40bb |

## System Engineer Summary

Julia package registered in General at B/BlockmodelUtils.

## Operational Role

For a systems engineer, BlockmodelUtils belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BlockmodelUtils", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-cc5bed0dfb40bb` from `julia_general` as `registry_expansion`
