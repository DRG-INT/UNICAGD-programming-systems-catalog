...
<!-- canonical: https://pub.dev/packages/csv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/csv](https://pub.dev/packages/csv) |
| Source record ids | pub_dev-ce8e7ee0b72520 |

## System Engineer Summary

A high-quality CSV library. Encode and decode CSV strings, with stream support (one row per event),
auto-detection, and Excel compatibility. The string must be comma (configurable) separated values.

## Operational Role

For a systems engineer, csv belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-03-19T07:43:20.342449Z | [https://pub.dev/api/packages/csv](https://pub.dev/api/packages/csv) |  |
| preview | known | 5.0.0-nullsafety.0 | 2021-02-01T21:47:58.247920Z | [https://pub.dev/api/packages/csv](https://pub.dev/api/packages/csv) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/csv` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-ce8e7ee0b72520` from `pub_dev` as `registry_expansion`
...
| super_text_layout | Configuration | [open](dart-super-text-layout-7230b32d.md) |
