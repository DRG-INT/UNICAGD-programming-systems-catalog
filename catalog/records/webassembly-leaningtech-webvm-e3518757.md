...
| Canonical URL | [https://github.com/leaningtech/webvm](https://github.com/leaningtech/webvm) |
| Source record ids | github_search_webassembly-3b2807fde76545 |
...
For a systems engineer, leaningtech/webvm belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | known | ext2_image | 2023-05-16T13:17:38Z | [https://api.github.com/repos/leaningtech/webvm/releases/latest](https://api.github.com/repos/leaningtech/webvm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/leaningtech/webvm/releases/latest` at `2026-09-01T10:25:59+00:00`.
...
- `github_search_webassembly-3b2807fde76545` from `github_search_webassembly` as `registry_expansion`
