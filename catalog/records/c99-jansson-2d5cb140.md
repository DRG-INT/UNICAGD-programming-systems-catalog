...
| Source record ids | master-10cfc62130f5 |

## System Engineer Summary

jansson is tracked as a serialization record in the C99 branch. The source did not provide a long
...
For a systems engineer, jansson belongs in the C99 inventory as part of wire formats, persistence,
...
- `master-10cfc62130f5` from `master_json` as `serialization`
