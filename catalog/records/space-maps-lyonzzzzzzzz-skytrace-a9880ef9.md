...
<!-- canonical: https://github.com/LyonZZZZzzzz/SkyTrace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LyonZZZZzzzz/SkyTrace](https://github.com/LyonZZZZzzzz/SkyTrace) |
| Source record ids | github_search_space_maps-289864616f8bef |

## System Engineer Summary

Open-source native iOS and macOS star map with an offline astronomy engine.

## Operational Role

For a systems engineer, LyonZZZZzzzz/SkyTrace belongs in the Space Maps inventory as part of hot-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-16T07:14:32Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-289864616f8bef` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| huang-sh/Starling | Profiler | [open](space-maps-huang-sh-starling-afb288b5.md) |
