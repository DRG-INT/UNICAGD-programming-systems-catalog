...
<!-- canonical: https://cran.r-project.org/web/packages/lineager/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lineager/index.html](https://cran.r-project.org/web/packages/lineager/index.html) |
| Source record ids | cran_packages_by_date-645cbc3ec75725 |
...
For a systems engineer, lineager belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-20 14:20:20 UTC | [https://cran.r-project.org/web/packages/lineager/DESCRIPTION](https://cran.r-project.org/web/packages/lineager/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lineager/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-645cbc3ec75725` from `cran_packages_by_date` as `registry_expansion`
