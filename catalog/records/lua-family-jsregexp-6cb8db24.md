...
| Canonical URL | [https://luarocks.org/modules/kmarius/jsregexp](https://luarocks.org/modules/kmarius/jsregexp) |
| Source record ids | luarocks_root_manifest-7c100b3f8ebada |
...
For a systems engineer, jsregexp belongs in the Lua family inventory as part of request routing,
...
- `luarocks_root_manifest-7c100b3f8ebada` from `luarocks_root_manifest` as `registry_expansion`
