...
| Source record ids | github_search_assets-9d9aaf67fc74eb |
...
For a systems engineer, chrissimpkins/codeface belongs in the Assets inventory as part of ecosystem
...
- `github_search_assets-9d9aaf67fc74eb` from `github_search_assets` as `registry_expansion`
