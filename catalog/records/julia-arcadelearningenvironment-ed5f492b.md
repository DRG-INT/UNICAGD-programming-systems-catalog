...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/ArcadeLearningEnvironment -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/ArcadeLearningEnvironment](https://github.com/JuliaRegistries/General/tree/master/A/ArcadeLearningEnvironment) |
| Source record ids | julia_general-92a27350f0f8d5 |

## System Engineer Summary

Julia package registered in General at A/ArcadeLearningEnvironment.

## Operational Role

For a systems engineer, ArcadeLearningEnvironment belongs in the Julia inventory as part of
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/ArcadeLearningEnvironment", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-92a27350f0f8d5` from `julia_general` as `registry_expansion`
