...
<!-- canonical: https://gitlab.com/xavki/tutorials-kubernetes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/xavki/tutorials-kubernetes](https://gitlab.com/xavki/tutorials-kubernetes) |
| Source record ids | gitlab_projects_api-f865b75816c862 |

## System Engineer Summary

Original Kubernetes course: minikube, prerequisites, cluster install, kubectl basics, services,
scaling, YAML manifests, resources. Xavki tutorials —

## Operational Role

For a systems engineer, xavki/tutorials-kubernetes belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-f865b75816c862` from `gitlab_projects_api` as `registry_expansion`
