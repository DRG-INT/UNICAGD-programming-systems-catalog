...
<!-- canonical: https://github.com/keshto/tinywl_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keshto/tinywl_plus](https://github.com/keshto/tinywl_plus) |
| Source record ids | github_search_effects-a80d66adb9714f |
...
For a systems engineer, keshto/tinywl_plus belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-10T09:53:42Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a80d66adb9714f` from `github_search_effects` as `registry_expansion`
