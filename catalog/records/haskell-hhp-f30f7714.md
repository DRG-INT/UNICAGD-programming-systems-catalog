...
<!-- canonical: https://hackage.haskell.org/package/hhp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hhp](https://hackage.haskell.org/package/hhp) |
| Source record ids | hackage_recent-207f02f36f7529 |
...
For a systems engineer, hhp belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-09-06T22:13:38Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-06T22:18:48+00:00`.
...
- `hackage_recent-207f02f36f7529` from `hackage_recent` as `registry_expansion`
