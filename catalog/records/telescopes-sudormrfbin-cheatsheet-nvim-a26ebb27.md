...
<!-- canonical: https://github.com/sudormrfbin/cheatsheet.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sudormrfbin/cheatsheet.nvim](https://github.com/sudormrfbin/cheatsheet.nvim) |
| Source record ids | github_search_telescopes-24512529bf3a71 |

## System Engineer Summary

A cheatsheet plugin for neovim with bundled cheatsheets for the editor, multiple vim plugins, nerd-
fonts, regex, etc. with a Telescope fuzzy finder interface!

## Operational Role

For a systems engineer, sudormrfbin/cheatsheet.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-26T05:59:34Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-24512529bf3a71` from `github_search_telescopes` as `registry_expansion`
