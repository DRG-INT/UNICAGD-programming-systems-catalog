...
<!-- canonical: https://pub.dev/packages/kiwi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/kiwi](https://pub.dev/packages/kiwi) |
| Source record ids | pub_dev-954d6859f80d08 |

## System Engineer Summary

A simple yet efficient dependency injection container for Dart and Flutter (can be coupled with the
kiwi_generator package).

## Operational Role

For a systems engineer, kiwi belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.1 | 2024-07-22T00:54:19.866785Z | [https://pub.dev/api/packages/kiwi](https://pub.dev/api/packages/kiwi) |  |
| preview | known | 3.0.0-nullsafety.1 | 2021-03-19T17:34:04.763594Z | [https://pub.dev/api/packages/kiwi](https://pub.dev/api/packages/kiwi) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/kiwi` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-954d6859f80d08` from `pub_dev` as `registry_expansion`
...
| charset_converter | Dependency Manager | [open](dart-charset-converter-0bea2965.md) |
