...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/xds0112/5G_based_System_level_Integrated_Sensing_and_Communication_Simulator -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Radars |
| Category | Image Audio Dsp |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/xds0112/5G_based_System_level_Integrated_Sensing_and_Communication_Simulator](https://github.com/xds0112/5G_based_System_level_Integrated_Sensing_and_Communication_Simulator) |
| Source record ids | github_search_radars-5716905cf5f2ba |
...
For a systems engineer, xds0112/5G_based_System_level_Integrated_Sensing_and_Communication_Simulator
belongs in the Radars inventory as part of ecosystem capability mapping, dependency review, release
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-18T08:08:48Z | gh search repos topic:radar-signal-processing stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
| Alert | Backup plan: mixed expression or dual license detected; choose the permissive option only when the exact terms allow it. |

## Engineering Notes

- Treat category as `image_audio_dsp` unless a later verified source gives a better classification.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:radar-signal-processing stars:>5", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_radars-5716905cf5f2ba` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| a-ngo/radar-signal-processing | Image Audio Dsp | [open](radars-a-ngo-radar-signal-processing-688c740b.md) |
| aalling93/Sentinel_1_python | Image Audio Dsp | [open](radars-aalling93-sentinel-1-python-557f7ec3.md) |
| birgander2/RAT | Image Audio Dsp | [open](radars-birgander2-rat-e2881415.md) |
| emanueledalsasso/SAR2SAR | Image Audio Dsp | [open](radars-emanueledalsasso-sar2sar-83d7f039.md) |
| erdogant/findpeaks | Image Audio Dsp | [open](radars-erdogant-findpeaks-df6ebd11.md) |
| ESA SNAP | Image Audio Dsp | [open](radars-esa-snap-67cb51ab.md) |
| GNU Radio | Image Audio Dsp | [open](radars-gnu-radio-be3f3c2f.md) |
| jakee417/LS-SSDD-v1.0-ShipDetectionComputerVision | Image Audio Dsp | [open](radars-jakee417-ls-ssdd-v1-0-shipdetectioncomputervision-b22e4748.md) |
