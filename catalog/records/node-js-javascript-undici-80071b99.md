...
[Catalog index](../index.md) · [Language: Node.js/JavaScript](../by-language/node-js-javascript.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/undici -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/undici](https://www.npmjs.com/package/undici) |
| Source record ids | master-143e1197f69b, npm_registry-55c7b58c8c02ce |

## System Engineer Summary

Undici is tracked as a networking http record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Undici belongs in the Node.js/JavaScript inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.10.2 | 2026-09-04T14:00:54.766Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-04T14:18:59+00:00`.
...
| npm_registry_search | registry-derived | 2026-09-09 | `{"kind": "npm_registry_search", "query": "http", "retrieved": "2026-09-09", "status": "registry-derived"}` |
...
- `master-143e1197f69b` from `master_json` as `networking_http`
- `npm_registry-55c7b58c8c02ce` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| @a2a-js/sdk | Networking Http | [open](node-js-javascript-a2a-js-sdk-4257c158.md) |
| @actions/http-client | Networking Http | [open](node-js-javascript-actions-http-client-850e0bf2.md) |
| @adonisjs/http-server | Networking Http | [open](node-js-javascript-adonisjs-http-server-c6d0fa46.md) |
| @algolia/requester-node-http | Networking Http | [open](node-js-javascript-algolia-requester-node-http-0ff5a2d6.md) |
| @atproto/xrpc-server | Networking Http | [open](node-js-javascript-atproto-xrpc-server-eb024318.md) |
| @aws-amplify/graphql-http-transformer | Networking Http | [open](node-js-javascript-aws-amplify-graphql-http-transformer-8ede633f.md) |
| @aws-sdk/client-database-migration-service | Networking Http | [open](node-js-javascript-aws-sdk-client-database-migration-service-058f4424.md) |
| @azure/core-http-compat | Networking Http | [open](node-js-javascript-azure-core-http-compat-82cb36ba.md) |
