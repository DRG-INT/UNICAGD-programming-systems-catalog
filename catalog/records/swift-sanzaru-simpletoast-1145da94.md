...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/sanzaru/SimpleToast](https://github.com/sanzaru/SimpleToast) |
| Source record ids | github_search_swift-b551c1d664aceb |

## System Engineer Summary

SimpleToast is a simple, lightweight, flexible and easy to use library to show toasts / popup
notifications inside iOS or MacOS applications in SwiftUI. Because of the flexibility to show any
content it is also possible to use the library for showing simple modals.

## Operational Role

For a systems engineer, sanzaru/SimpleToast belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-14T17:26:06Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:swift-package stars:>200", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_swift-b551c1d664aceb` from `github_search_swift` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| 30 Days of Swift | Ide Editor Integration | [open](swift-30-days-of-swift-1b4418ad.md) |
| Airbnb | Ide Editor Integration | [open](swift-airbnb-7a02d1fa.md) |
| API Design Guidelines | Ide Editor Integration | [open](swift-api-design-guidelines-414cc7a0.md) |
| Apple eBook | Ide Editor Integration | [open](swift-apple-ebook-f37f8153.md) |
| Conferences.digital | Ide Editor Integration | [open](swift-conferences-digital-f87b2858.md) |
| daprice/iOS-Tactile-Slider | Ide Editor Integration | [open](swift-daprice-ios-tactile-slider-619cec50.md) |
| Developing iOS Apps with Swift | Ide Editor Integration | [open](swift-developing-ios-apps-with-swift-8b66c652.md) |
| Hacking With Swift | Ide Editor Integration | [open](swift-hacking-with-swift-4e5fda53.md) |
