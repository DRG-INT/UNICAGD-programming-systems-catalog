...
<!-- canonical: https://luarocks.org/modules/quiqueporta/adf2md -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/quiqueporta/adf2md](https://luarocks.org/modules/quiqueporta/adf2md) |
| Source record ids | luarocks_root_manifest-c0547079ab4328 |
...
For a systems engineer, adf2md belongs in the Lua family inventory as part of low-noise code review,
...
- `luarocks_root_manifest-c0547079ab4328` from `luarocks_root_manifest` as `registry_expansion`
