...
<!-- canonical: https://crates.io/crates/aws-smithy-runtime-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-smithy-runtime-api](https://crates.io/crates/aws-smithy-runtime-api) |
| Source record ids | crates_io-e801d684238b3c |

## System Engineer Summary

aws-smithy-runtime-api is tracked as an interpreter runtime record in the Rust branch. The source
...
For a systems engineer, aws-smithy-runtime-api belongs in the Rust inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.15.0 | 2026-08-19T17:12:10.210385Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-e801d684238b3c` from `crates_io` as `registry_expansion`
