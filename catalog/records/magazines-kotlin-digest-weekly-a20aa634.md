...
<!-- canonical: https://github.com/kotlin-digest/weekly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kotlin-digest/weekly](https://github.com/kotlin-digest/weekly) |
| Source record ids | github_search_magazines-6d8e2deb8c689a |

## System Engineer Summary

Kotlin Digest — weekly AI-assembled Android/Kotlin/KMP developer magazine

## Operational Role

For a systems engineer, kotlin-digest/weekly belongs in the Magazines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:17:15Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-6d8e2deb8c689a` from `github_search_magazines` as `registry_expansion`
