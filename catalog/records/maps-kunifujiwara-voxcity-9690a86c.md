...
<!-- canonical: https://github.com/kunifujiwara/VoxCity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kunifujiwara/VoxCity](https://github.com/kunifujiwara/VoxCity) |
| Source record ids | github_search_maps-2a7c9735f9756b |

## System Engineer Summary

Python framework for integrating geospatial data, 3D city modeling, and urban simulation.

## Operational Role

For a systems engineer, kunifujiwara/VoxCity belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:57:37Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2a7c9735f9756b` from `github_search_maps` as `registry_expansion`
