...
<!-- canonical: https://packagist.org/packages/rah/danpu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/rah/danpu](https://packagist.org/packages/rah/danpu) |
| Source record ids | packagist_search-99b379e1190de4 |
...
For a systems engineer, rah/danpu belongs in the PHP inventory as part of ecosystem capability
...
- `packagist_search-99b379e1190de4` from `packagist_search` as `registry_expansion`
