...
<!-- canonical: https://github.com/porsager/postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/porsager/postgres](https://github.com/porsager/postgres) |
| Source record ids | github_search_databases-0976ba8f72f370 |
...
For a systems engineer, porsager/postgres belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:02:08Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0976ba8f72f370` from `github_search_databases` as `registry_expansion`
