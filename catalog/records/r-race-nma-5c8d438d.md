...
<!-- canonical: https://cran.r-project.org/web/packages/RaCE.NMA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RaCE.NMA/index.html](https://cran.r-project.org/web/packages/RaCE.NMA/index.html) |
| Source record ids | cran_packages_by_date-859fdc5bcb7ee3 |

## System Engineer Summary

Rank-Clustered Estimation for Network Meta-Analysis

## Operational Role

For a systems engineer, RaCE.NMA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-05 09:10:02 UTC | [https://cran.r-project.org/web/packages/RaCE.NMA/DESCRIPTION](https://cran.r-project.org/web/packages/RaCE.NMA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RaCE.NMA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-859fdc5bcb7ee3` from `cran_packages_by_date` as `registry_expansion`
