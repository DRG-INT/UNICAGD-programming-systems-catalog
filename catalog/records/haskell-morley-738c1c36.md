...
<!-- canonical: https://hackage.haskell.org/package/morley -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/morley](https://hackage.haskell.org/package/morley) |
| Source record ids | hackage_top_downloads-a243d9c2917dfd |
...
For a systems engineer, morley belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.20.0 | 2023-07-31T17:42:21Z | [https://hackage.haskell.org/package/morley](https://hackage.haskell.org/package/morley) |  |
| candidate | partial | 0.1.0.3 |  | [https://hackage.haskell.org/package/morley](https://hackage.haskell.org/package/morley) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/morley` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-a243d9c2917dfd` from `hackage_top_downloads` as `registry_expansion`
