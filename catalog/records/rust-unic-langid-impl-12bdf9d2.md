...
| Canonical URL | [https://crates.io/crates/unic-langid-impl](https://crates.io/crates/unic-langid-impl) |
| Source record ids | crates_io-6efaa97e207c1f |
...
For a systems engineer, unic-langid-impl belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.6 | 2025-05-09T16:46:39.841202Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-6efaa97e207c1f` from `crates_io` as `registry_expansion`
