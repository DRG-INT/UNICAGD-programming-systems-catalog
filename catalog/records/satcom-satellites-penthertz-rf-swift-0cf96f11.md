...
| Source record ids | github_search_satcom_satellites-35abf4e4233c2b |
...
For a systems engineer, PentHertz/RF-Swift belongs in the SatCom Satellites inventory as part of
...
- `github_search_satcom_satellites-35abf4e4233c2b` from `github_search_satcom_satellites` as `registry_expansion`
