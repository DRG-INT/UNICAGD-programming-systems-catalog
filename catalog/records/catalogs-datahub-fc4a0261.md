...
| Canonical URL | [https://github.com/datahub-project/datahub](https://github.com/datahub-project/datahub) |
| Source record ids | curated_language_routes-fdf8cc15d88a99 |

## System Engineer Summary

Metadata catalog and governance platform for datasets, schemas, lineage, ownership, search, and
discovery.

## Operational Role

For a systems engineer, DataHub belongs in the Catalogs inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.7.0 | 2026-08-04T21:34:40Z | [https://api.github.com/repos/datahub-project/datahub/releases/latest](https://api.github.com/repos/datahub-project/datahub/releases/latest) |  |
| preview | known | v1.6.0.1rc5 | 2026-08-11T22:21:37Z | [https://api.github.com/repos/datahub-project/datahub/releases?per_page=10](https://api.github.com/repos/datahub-project/datahub/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/datahub-project/datahub/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-fdf8cc15d88a99` from `curated_language_routes` as `registry_expansion`
