...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/PapirusDevelopmentTeam/papirus-icon-theme -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PapirusDevelopmentTeam/papirus-icon-theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) |
| Source record ids | github_search_icons_and_logos-3c88b80d746cf4 |
...
For a systems engineer, PapirusDevelopmentTeam/papirus-icon-theme belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T14:42:16Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3c88b80d746cf4` from `github_search_icons_and_logos` as `registry_expansion`
