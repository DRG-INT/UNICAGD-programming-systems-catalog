...
<!-- canonical: https://pub.dev/packages/model_viewer_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/model_viewer_plus](https://pub.dev/packages/model_viewer_plus) |
| Source record ids | pub_dev-a15f9cbbadef1f |
...
For a systems engineer, model_viewer_plus belongs in the Dart inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2025-11-26T13:36:08.627947Z | [https://pub.dev/api/packages/model_viewer_plus](https://pub.dev/api/packages/model_viewer_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/model_viewer_plus` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-a15f9cbbadef1f` from `pub_dev` as `registry_expansion`
