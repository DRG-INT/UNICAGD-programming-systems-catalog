...
<!-- canonical: https://cran.r-project.org/web/packages/dynamicmultiplex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dynamicmultiplex/index.html](https://cran.r-project.org/web/packages/dynamicmultiplex/index.html) |
| Source record ids | cran_packages_by_date-e01acd52cae9f4 |
...
For a systems engineer, dynamicmultiplex belongs in the R inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-07 16:00:08 UTC | [https://cran.r-project.org/web/packages/dynamicmultiplex/DESCRIPTION](https://cran.r-project.org/web/packages/dynamicmultiplex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dynamicmultiplex/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e01acd52cae9f4` from `cran_packages_by_date` as `registry_expansion`
