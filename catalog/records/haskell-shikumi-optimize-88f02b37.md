...
<!-- canonical: https://hackage.haskell.org/package/shikumi-optimize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-optimize](https://hackage.haskell.org/package/shikumi-optimize) |
| Source record ids | hackage_recent-cb55b7d1e2bec0 |
...
For a systems engineer, shikumi-optimize belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.0 | 2026-09-08T19:35:20Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-08T20:19:49+00:00`.
...
- `hackage_recent-cb55b7d1e2bec0` from `hackage_recent` as `registry_expansion`
