...
<!-- canonical: https://github.com/JackJiang2011/MobileIMSDK -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JackJiang2011/MobileIMSDK](https://github.com/JackJiang2011/MobileIMSDK) |
| Source record ids | github_search_cocoa-de64e30452e5a6 |

## System Engineer Summary

原创全平台IM通信层框架，轻量级、高度提炼，历经10年、久经考验。可能是市面上唯一同时支持UDP+TCP+WebSocket三种协议的同类开源框架，支持
iOS、Android、Java、H5、小程序、Uniapp、鸿蒙Next，服务端基于Netty。

## Operational Role

For a systems engineer, JackJiang2011/MobileIMSDK belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T03:39:57Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-de64e30452e5a6` from `github_search_cocoa` as `registry_expansion`
