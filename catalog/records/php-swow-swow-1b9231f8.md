...
<!-- canonical: https://packagist.org/packages/swow/swow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/swow/swow](https://packagist.org/packages/swow/swow) |
| Source record ids | packagist_search-dced70e6bea325 |
...
For a systems engineer, swow/swow belongs in the PHP inventory as part of service communication,
...
- `packagist_search-dced70e6bea325` from `packagist_search` as `registry_expansion`
