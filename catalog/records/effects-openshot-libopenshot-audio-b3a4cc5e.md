...
<!-- canonical: https://github.com/OpenShot/libopenshot-audio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenShot/libopenshot-audio](https://github.com/OpenShot/libopenshot-audio) |
| Source record ids | github_search_effects-302f20af4e27f9 |

## System Engineer Summary

OpenShot Audio Library (libopenshot-audio) is a free, open-source project that enables high-quality
editing and playback of audio, and is based on the amazing JUCE library.

## Operational Role

For a systems engineer, OpenShot/libopenshot-audio belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T02:37:41Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-302f20af4e27f9` from `github_search_effects` as `registry_expansion`
