...
<!-- canonical: https://github.com/OSGeo/homebrew-osgeo4mac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OSGeo/homebrew-osgeo4mac](https://github.com/OSGeo/homebrew-osgeo4mac) |
| Source record ids | github_search_maps-399e844d288679 |
...
For a systems engineer, OSGeo/homebrew-osgeo4mac belongs in the Maps inventory as part of ecosystem
...
- `github_search_maps-399e844d288679` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| openvenues/lieu | Configuration | [open](maps-openvenues-lieu-1d7de22f.md) |
