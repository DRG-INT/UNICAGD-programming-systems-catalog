...
<!-- canonical: https://cran.r-project.org/web/packages/gwrf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gwrf/index.html](https://cran.r-project.org/web/packages/gwrf/index.html) |
| Source record ids | cran_packages_by_date-22d6d97eaeb740 |
...
For a systems engineer, gwrf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-24 14:50:08 UTC | [https://cran.r-project.org/web/packages/gwrf/DESCRIPTION](https://cran.r-project.org/web/packages/gwrf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gwrf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-22d6d97eaeb740` from `cran_packages_by_date` as `registry_expansion`
