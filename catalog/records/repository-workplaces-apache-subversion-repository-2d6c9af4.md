...
<!-- canonical: https://svn.apache.org/repos/asf/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://svn.apache.org/repos/asf/](https://svn.apache.org/repos/asf/) |
| Source record ids | curated_repository_workplace_routes-095aea50ed1e24 |

## System Engineer Summary

Apache Software Foundation Subversion repository root and browser for ASF-hosted projects.

## Operational Role

For a systems engineer, Apache Subversion Repository belongs in the Repository Workplaces inventory
...
- `curated_repository_workplace_routes-095aea50ed1e24` from `curated_repository_workplace_routes` as `registry_expansion`
