...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BVProblemLibrary](https://github.com/JuliaRegistries/General/tree/master/B/BVProblemLibrary) |
| Source record ids | julia_general-8a893daad435bc |

## System Engineer Summary

Julia package registered in General at B/BVProblemLibrary.

## Operational Role

For a systems engineer, BVProblemLibrary belongs in the Julia inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BVProblemLibrary", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8a893daad435bc` from `julia_general` as `registry_expansion`
