...
<!-- canonical: https://github.com/thehugh100/dsp-playground -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thehugh100/dsp-playground](https://github.com/thehugh100/dsp-playground) |
| Source record ids | github_search_effects-02d0617ee6d8b8 |

## System Engineer Summary

DSP Playground is a visual, browser-based digital signal processing playground for building and
testing real-time audio effects, reverbs, synthesizers, and DSP algorithms with an intuitive node
graph powered by the Web Audio API.

## Operational Role

For a systems engineer, thehugh100/dsp-playground belongs in the Effects inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-13T17:20:32Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-02d0617ee6d8b8` from `github_search_effects` as `registry_expansion`
