...
<!-- canonical: https://cran.r-project.org/web/packages/fastrda/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastrda/index.html](https://cran.r-project.org/web/packages/fastrda/index.html) |
| Source record ids | cran_packages_by_date-d481a9e19ebd81 |
...
For a systems engineer, fastrda belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 14:30:02 UTC | [https://cran.r-project.org/web/packages/fastrda/DESCRIPTION](https://cran.r-project.org/web/packages/fastrda/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastrda/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d481a9e19ebd81` from `cran_packages_by_date` as `registry_expansion`
