...
<!-- canonical: https://github.com/opencodewin/MediaEditor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opencodewin/MediaEditor](https://github.com/opencodewin/MediaEditor) |
| Source record ids | github_search_video-87fabe6d62110b |
...
For a systems engineer, opencodewin/MediaEditor belongs in the Video inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-04T10:46:14Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- `github_search_video-87fabe6d62110b` from `github_search_video` as `registry_expansion`
