...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Compiler Diagnostics](../by-category/compiler-diagnostics.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Microsoft.Extensions.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Extensions.Http](https://www.nuget.org/packages/Microsoft.Extensions.Http) |
| Source record ids | nuget_search-ecb273f33f3036 |

## System Engineer Summary

The HttpClient factory is a pattern for configuring and retrieving named HttpClients in a composable
way. The HttpClient factory provides extensibility to plug in DelegatingHandlers that address cross-
cutting concerns such as service location, load balancing, and reliability. The default HttpClient
factory provides built-in diagnostics and logging and manages the lifetimes of connections in a
performant way. Commonly Used Types: System.Net.Http.IHttpClientFactory

## Operational Role

For a systems engineer, Microsoft.Extensions.Http belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.11 | 2026-08-11T16:54:33.443+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http/index.json) |  |
| preview | known | 11.0.0-preview.7.26381.103 | 2026-08-11T16:20:09.41+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Microsoft.Extensions.Http/10.0.11/license |
| Alert | Backup plan: mixed expression or dual license detected; choose the permissive option only when the exact terms allow it. |

## Engineering Notes

- Treat category as `compiler_diagnostics` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-ecb273f33f3036` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Microsoft.Extensions.Http.Diagnostics | Compiler Diagnostics | [open](c-sharp-microsoft-extensions-http-diagnostics-e18f498c.md) |
