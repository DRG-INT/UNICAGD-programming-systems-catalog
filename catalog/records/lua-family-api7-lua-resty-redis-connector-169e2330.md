...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-redis-connector -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-ddb1f52caceb1e` from `luarocks_root_manifest` as `registry_expansion`
