...
<!-- canonical: https://cran.r-project.org/web/packages/phenology/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/phenology/index.html](https://cran.r-project.org/web/packages/phenology/index.html) |
| Source record ids | cran_packages_by_date-b11808f26d6166 |
...
For a systems engineer, phenology belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.8.24 | 2026-08-24 13:40:02 UTC | [https://cran.r-project.org/web/packages/phenology/DESCRIPTION](https://cran.r-project.org/web/packages/phenology/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/phenology/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b11808f26d6166` from `cran_packages_by_date` as `registry_expansion`
