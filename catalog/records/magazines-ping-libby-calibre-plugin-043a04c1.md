...
| Source record ids | github_search_magazines-2714a55c93286c |
...
- `github_search_magazines-2714a55c93286c` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Paul-Ladyman/LUD-go-tutorial | Tutorial Book Styleguide | [open](magazines-paul-ladyman-lud-go-tutorial-6097738c.md) |
