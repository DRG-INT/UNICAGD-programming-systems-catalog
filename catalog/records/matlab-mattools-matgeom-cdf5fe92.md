...
| Canonical URL | [https://github.com/mattools/matGeom](https://github.com/mattools/matGeom) |
| Source record ids | github_search_matlab-81d87d2efda08b |
...
For a systems engineer, mattools/matGeom belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.9 | 2026-02-19T13:50:36Z | [https://api.github.com/repos/mattools/matGeom/releases/latest](https://api.github.com/repos/mattools/matGeom/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mattools/matGeom/releases/latest` at `2026-09-01T07:24:11+00:00`.
...
- `github_search_matlab-81d87d2efda08b` from `github_search_matlab` as `registry_expansion`
