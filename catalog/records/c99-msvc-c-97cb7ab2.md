...
| Source record ids | master-2a1e6f3d032f |

## System Engineer Summary

Microsoft C compiler/toolchain

## Operational Role

For a systems engineer, MSVC C belongs in the C99 inventory as part of compiler selection,
...
- `master-2a1e6f3d032f` from `master_json` as `compiler`
