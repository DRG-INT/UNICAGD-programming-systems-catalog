...
<!-- canonical: https://cran.r-project.org/web/packages/uwot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/uwot/index.html](https://cran.r-project.org/web/packages/uwot/index.html) |
| Source record ids | cran_packages_by_date-3a3dbde8aba39e |
...
For a systems engineer, uwot belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-29 13:10:02 UTC | [https://cran.r-project.org/web/packages/uwot/DESCRIPTION](https://cran.r-project.org/web/packages/uwot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/uwot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3a3dbde8aba39e` from `cran_packages_by_date` as `registry_expansion`
