...
<!-- canonical: https://pypi.org/project/adacs-django-playwright/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adacs-django-playwright/](https://pypi.org/project/adacs-django-playwright/) |
| Source record ids | pypi_simple-389418f5f34dd4 |

## System Engineer Summary

adacs-django-playwright is tracked as a web framework record in the Python branch. The source did
...
For a systems engineer, adacs-django-playwright belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2025-05-14T00:47:28.879284Z | [https://pypi.org/pypi/adacs-django-playwright/json](https://pypi.org/pypi/adacs-django-playwright/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adacs-django-playwright/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-389418f5f34dd4` from `pypi_simple` as `registry_expansion`
