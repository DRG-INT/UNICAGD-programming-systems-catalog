...
<!-- canonical: https://hackage.haskell.org/package/wreq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wreq](https://hackage.haskell.org/package/wreq) |
| Source record ids | hackage_top_downloads-a9fdbec9957e31 |
...
For a systems engineer, wreq belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4.5 | 2026-04-07T15:20:37Z | [https://hackage.haskell.org/package/wreq](https://hackage.haskell.org/package/wreq) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wreq` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-a9fdbec9957e31` from `hackage_top_downloads` as `registry_expansion`
