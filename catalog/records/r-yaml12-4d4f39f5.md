...
<!-- canonical: https://cran.r-project.org/web/packages/yaml12/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/yaml12/index.html](https://cran.r-project.org/web/packages/yaml12/index.html) |
| Source record ids | cran_packages_by_date-38d121a73bba9f |
...
For a systems engineer, yaml12 belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-25 07:00:03 UTC | [https://cran.r-project.org/web/packages/yaml12/DESCRIPTION](https://cran.r-project.org/web/packages/yaml12/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/yaml12/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-38d121a73bba9f` from `cran_packages_by_date` as `registry_expansion`
