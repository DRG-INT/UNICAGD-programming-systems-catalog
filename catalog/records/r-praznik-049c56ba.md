...
<!-- canonical: https://cran.r-project.org/web/packages/praznik/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/praznik/index.html](https://cran.r-project.org/web/packages/praznik/index.html) |
| Source record ids | cran_packages_by_date-303452568e9590 |
...
For a systems engineer, praznik belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.0.0 | 2026-08-20 08:40:02 UTC | [https://cran.r-project.org/web/packages/praznik/DESCRIPTION](https://cran.r-project.org/web/packages/praznik/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/praznik/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-303452568e9590` from `cran_packages_by_date` as `registry_expansion`
