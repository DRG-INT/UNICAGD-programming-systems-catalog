...
<!-- canonical: https://luarocks.org/modules/nooo37/bling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nooo37/bling](https://luarocks.org/modules/nooo37/bling) |
| Source record ids | luarocks_root_manifest-0d749d860d3c2e |
...
For a systems engineer, bling belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0d749d860d3c2e` from `luarocks_root_manifest` as `registry_expansion`
