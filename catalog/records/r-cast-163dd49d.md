...
<!-- canonical: https://cran.r-project.org/web/packages/CAST/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CAST/index.html](https://cran.r-project.org/web/packages/CAST/index.html) |
| Source record ids | cran_packages_by_date-9de5360d281b1d |
...
For a systems engineer, CAST belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-09-09 12:40:30 UTC | [https://cran.r-project.org/web/packages/CAST/DESCRIPTION](https://cran.r-project.org/web/packages/CAST/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CAST/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-9de5360d281b1d` from `cran_packages_by_date` as `registry_expansion`
