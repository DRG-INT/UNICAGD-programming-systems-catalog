...
<!-- canonical: https://github.com/alexdrone/Render -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexdrone/Render](https://github.com/alexdrone/Render) |
| Source record ids | github_search_swift-8038ba29fca43b |
...
For a systems engineer, alexdrone/Render belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-13T14:45:11Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-8038ba29fca43b` from `github_search_swift` as `registry_expansion`
