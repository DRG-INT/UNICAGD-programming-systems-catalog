...
<!-- canonical: https://luarocks.org/modules/lalawue/balance-tree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lalawue/balance-tree](https://luarocks.org/modules/lalawue/balance-tree) |
| Source record ids | luarocks_root_manifest-4e8d4abe5fcbaf |
...
For a systems engineer, balance-tree belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4e8d4abe5fcbaf` from `luarocks_root_manifest` as `registry_expansion`
