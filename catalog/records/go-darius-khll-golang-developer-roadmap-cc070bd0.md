...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/darius-khll/golang-developer-roadmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/darius-khll/golang-developer-roadmap](https://github.com/darius-khll/golang-developer-roadmap) |
| Source record ids | github_search_go-0bc4b767c526e5 |
...
For a systems engineer, darius-khll/golang-developer-roadmap belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-13T08:08:20Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-0bc4b767c526e5` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bitbucket.org/itotcca/the-situation | Library | [open](go-bitbucket-org-itotcca-the-situation-6e1a8aba.md) |
| code.linenisgreat.com/madder | Library | [open](go-code-linenisgreat-com-madder-7481ec44.md) |
| code.linenisgreat.com/madder/go | Library | [open](go-code-linenisgreat-com-madder-go-69f64a7e.md) |
| codeberg.org/go-hep/hep.git | Library | [open](go-codeberg-org-go-hep-hep-git-29878e71.md) |
| codeberg.org/rimu/pyfedi | Library | [open](go-codeberg-org-rimu-pyfedi-53519dff.md) |
| CycloneDX/cyclonedx-gomod | Library | [open](go-cyclonedx-cyclonedx-gomod-24572c1d.md) |
| gbrlsnchs/jwt | Library | [open](go-gbrlsnchs-jwt-9cb26411.md) |
| gethugothemes/hugo-modules | Library | [open](go-gethugothemes-hugo-modules-1f48ce7f.md) |
