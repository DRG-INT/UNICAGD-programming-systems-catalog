...
<!-- canonical: https://github.com/eaydin/cr2fits -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eaydin/cr2fits](https://github.com/eaydin/cr2fits) |
| Source record ids | github_search_telescopes-87b6869429e0cd |
...
For a systems engineer, eaydin/cr2fits belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-07-26T20:42:59Z | gh search repos topic:fits stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-87b6869429e0cd` from `github_search_telescopes` as `registry_expansion`
