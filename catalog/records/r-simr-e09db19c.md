...
<!-- canonical: https://cran.r-project.org/web/packages/simr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/simr/index.html](https://cran.r-project.org/web/packages/simr/index.html) |
| Source record ids | cran_packages_by_date-853538102df245 |
...
For a systems engineer, simr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.11 | 2026-09-11 07:40:02 UTC | [https://cran.r-project.org/web/packages/simr/DESCRIPTION](https://cran.r-project.org/web/packages/simr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/simr/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-853538102df245` from `cran_packages_by_date` as `registry_expansion`
