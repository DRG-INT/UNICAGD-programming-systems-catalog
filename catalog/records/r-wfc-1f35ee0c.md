...
<!-- canonical: https://cran.r-project.org/web/packages/WFC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/WFC/index.html](https://cran.r-project.org/web/packages/WFC/index.html) |
| Source record ids | cran_packages_by_date-c6c25006e3a688 |
...
For a systems engineer, WFC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-06 13:50:06 UTC | [https://cran.r-project.org/web/packages/WFC/DESCRIPTION](https://cran.r-project.org/web/packages/WFC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/WFC/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c6c25006e3a688` from `cran_packages_by_date` as `registry_expansion`
