...
<!-- canonical: https://cran.r-project.org/web/packages/DiscreteTests/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DiscreteTests/index.html](https://cran.r-project.org/web/packages/DiscreteTests/index.html) |
| Source record ids | cran_packages_by_date-23dba3cb493425 |
...
For a systems engineer, DiscreteTests belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-26 15:10:02 UTC | [https://cran.r-project.org/web/packages/DiscreteTests/DESCRIPTION](https://cran.r-project.org/web/packages/DiscreteTests/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DiscreteTests/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-23dba3cb493425` from `cran_packages_by_date` as `registry_expansion`
