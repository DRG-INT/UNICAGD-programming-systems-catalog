...
<!-- canonical: https://github.com/objectbox/objectbox-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/objectbox/objectbox-java](https://github.com/objectbox/objectbox-java) |
| Source record ids | github_search_databases-fa29363fc1fb35 |
...
For a systems engineer, objectbox/objectbox-java belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T10:42:55Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fa29363fc1fb35` from `github_search_databases` as `registry_expansion`
