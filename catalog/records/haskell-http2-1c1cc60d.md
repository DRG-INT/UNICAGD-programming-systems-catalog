...
| Canonical URL | [https://hackage.haskell.org/package/http2](https://hackage.haskell.org/package/http2) |
| Source record ids | hackage_top_downloads-cc73027bcd72dc |

## System Engineer Summary

Hackage package with 378 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, http2 belongs in the Haskell inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.3 | 2026-07-17T01:21:33Z | [https://hackage.haskell.org/package/http2](https://hackage.haskell.org/package/http2) |  |
| candidate | partial | 1.6.4 |  | [https://hackage.haskell.org/package/http2](https://hackage.haskell.org/package/http2) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http2` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-cc73027bcd72dc` from `hackage_top_downloads` as `registry_expansion`
...
| network | Networking Http | [open](haskell-network-c064f126.md) |
