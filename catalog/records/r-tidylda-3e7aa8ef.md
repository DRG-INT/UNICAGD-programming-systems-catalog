...
<!-- canonical: https://cran.r-project.org/web/packages/tidylda/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidylda/index.html](https://cran.r-project.org/web/packages/tidylda/index.html) |
| Source record ids | cran_packages_by_date-5ff226f2077e26 |
...
For a systems engineer, tidylda belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-28 07:00:09 UTC | [https://cran.r-project.org/web/packages/tidylda/DESCRIPTION](https://cran.r-project.org/web/packages/tidylda/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidylda/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5ff226f2077e26` from `cran_packages_by_date` as `registry_expansion`
