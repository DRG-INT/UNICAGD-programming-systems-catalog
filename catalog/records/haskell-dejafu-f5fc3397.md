...
<!-- canonical: https://hackage.haskell.org/package/dejafu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dejafu](https://hackage.haskell.org/package/dejafu) |
| Source record ids | hackage_top_downloads-a271d1fa9f33f8 |
...
For a systems engineer, dejafu belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.0.8 | 2026-01-13T18:13:39Z | [https://hackage.haskell.org/package/dejafu](https://hackage.haskell.org/package/dejafu) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dejafu` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-a271d1fa9f33f8` from `hackage_top_downloads` as `registry_expansion`
