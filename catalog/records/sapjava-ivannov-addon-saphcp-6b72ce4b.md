...
<!-- canonical: https://github.com/ivannov/addon-saphcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ivannov/addon-saphcp](https://github.com/ivannov/addon-saphcp) |
| Source record ids | github_search_sapjava-dbc5e10b766dc9 |

## System Engineer Summary

This is an addon that helps deploying Java EE Web profile applications to the SAP HANA Cloud
Platform. You can deploy both to the local runtime and also to the cloud

## Operational Role

For a systems engineer, ivannov/addon-saphcp belongs in the SAPJava inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-03-11T23:36:46Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other; {"key": "", "name": "", "url": ""} |
...
- `github_search_sapjava-dbc5e10b766dc9` from `github_search_sapjava` as `registry_expansion`
