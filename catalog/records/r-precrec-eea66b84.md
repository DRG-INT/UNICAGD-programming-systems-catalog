...
<!-- canonical: https://cran.r-project.org/web/packages/precrec/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/precrec/index.html](https://cran.r-project.org/web/packages/precrec/index.html) |
| Source record ids | cran_packages_by_date-b34a353d306d83 |
...
For a systems engineer, precrec belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0 | 2026-09-15 11:40:02 UTC | [https://cran.r-project.org/web/packages/precrec/DESCRIPTION](https://cran.r-project.org/web/packages/precrec/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/precrec/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-b34a353d306d83` from `cran_packages_by_date` as `registry_expansion`
