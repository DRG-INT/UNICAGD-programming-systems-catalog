...
<!-- canonical: https://github.com/dbacinski/Design-Patterns-In-Kotlin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbacinski/Design-Patterns-In-Kotlin](https://github.com/dbacinski/Design-Patterns-In-Kotlin) |
| Source record ids | github_search_pattern_language-83dda3d79e9b8c |
...
For a systems engineer, dbacinski/Design-Patterns-In-Kotlin belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-11T06:11:21Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-83dda3d79e9b8c` from `github_search_pattern_language` as `registry_expansion`
