...
<!-- canonical: https://packagist.org/packages/zendframework/zend-json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zendframework/zend-json](https://packagist.org/packages/zendframework/zend-json) |
| Source record ids | packagist_search-b814316acc7dbb |
...
For a systems engineer, zendframework/zend-json belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-b814316acc7dbb` from `packagist_search` as `registry_expansion`
