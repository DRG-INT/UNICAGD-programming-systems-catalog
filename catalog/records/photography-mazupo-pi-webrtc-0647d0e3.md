...
<!-- canonical: https://github.com/mazupo/pi-webrtc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mazupo/pi-webrtc](https://github.com/mazupo/pi-webrtc) |
| Source record ids | github_search_photography-c2e732e8ee5c1e |

## System Engineer Summary

Real-time WebRTC streaming for Raspberry Pi and NVIDIA Jetson with 100–200 ms glass-to-glass
latency.

## Operational Role

For a systems engineer, mazupo/pi-webrtc belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:32:16Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c2e732e8ee5c1e` from `github_search_photography` as `registry_expansion`
