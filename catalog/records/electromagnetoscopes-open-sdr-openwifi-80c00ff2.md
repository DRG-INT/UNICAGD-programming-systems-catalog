...
<!-- canonical: https://github.com/open-sdr/openwifi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-sdr/openwifi](https://github.com/open-sdr/openwifi) |
| Source record ids | github_search_electromagnetoscopes-9a636b63f75259 |
...
For a systems engineer, open-sdr/openwifi belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T11:02:34Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-9a636b63f75259` from `github_search_electromagnetoscopes` as `registry_expansion`
