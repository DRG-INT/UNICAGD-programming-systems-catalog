...
| Canonical URL | [https://luarocks.org/modules/kong/kong-pgmoon](https://luarocks.org/modules/kong/kong-pgmoon) |
| Source record ids | luarocks_root_manifest-8fdd429c752582 |
...
For a systems engineer, kong-pgmoon belongs in the Lua family inventory as part of state
...
- `luarocks_root_manifest-8fdd429c752582` from `luarocks_root_manifest` as `registry_expansion`
