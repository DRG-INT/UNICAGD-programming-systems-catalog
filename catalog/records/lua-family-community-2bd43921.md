...
| Source record ids | lua-source-47 |

## System Engineer Summary

Community is tracked as a community reference record in the Lua family branch. The source did not
...
For a systems engineer, Community belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 47}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-47` from `master_json` as `source_list_item`
...
| References | Community Reference | [open](lua-family-references-6afc24bd.md) |
