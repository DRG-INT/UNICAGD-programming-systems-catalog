...
<!-- canonical: https://github.com/dbkangaroo/kangaroo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbkangaroo/kangaroo](https://github.com/dbkangaroo/kangaroo) |
| Source record ids | github_search_databases-4dd20374ce9b23 |

## System Engineer Summary

Kangaroo is an AI-powered SQL client and admin tool for popular databases (MariaDB / MySQL / Oracle
/ PostgreSQL / Redis / SQLite / SQL Server / ...) on Windows / MacOS / Linux, support table design,
query, model, sync, export/import etc, focus on comfortable, fun and developer friendly.

## Operational Role

For a systems engineer, dbkangaroo/kangaroo belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T06:42:25Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4dd20374ce9b23` from `github_search_databases` as `registry_expansion`
