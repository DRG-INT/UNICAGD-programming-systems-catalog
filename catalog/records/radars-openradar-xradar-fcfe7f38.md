...
<!-- canonical: https://github.com/openradar/xradar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openradar/xradar](https://github.com/openradar/xradar) |
| Source record ids | github_search_radars-d4b10bccf2f215 |
...
For a systems engineer, openradar/xradar belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.12.0 | 2026-04-21T12:52:39Z | [https://api.github.com/repos/openradar/xradar/releases/latest](https://api.github.com/repos/openradar/xradar/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/openradar/xradar/releases/latest` at `2026-09-01T08:26:31+00:00`.
...
- `github_search_radars-d4b10bccf2f215` from `github_search_radars` as `registry_expansion`
