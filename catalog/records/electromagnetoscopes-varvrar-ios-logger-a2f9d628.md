...
<!-- canonical: https://github.com/Varvrar/ios_logger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Varvrar/ios_logger](https://github.com/Varvrar/ios_logger) |
| Source record ids | github_search_electromagnetoscopes-d112b0e47e86ae |
...
For a systems engineer, Varvrar/ios_logger belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-07T10:59:44Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-d112b0e47e86ae` from `github_search_electromagnetoscopes` as `registry_expansion`
