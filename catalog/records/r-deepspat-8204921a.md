...
<!-- canonical: https://cran.r-project.org/web/packages/deepspat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/deepspat/index.html](https://cran.r-project.org/web/packages/deepspat/index.html) |
| Source record ids | cran_packages_by_date-2b0b9206c7cc3a |
...
For a systems engineer, deepspat belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-28 09:20:02 UTC | [https://cran.r-project.org/web/packages/deepspat/DESCRIPTION](https://cran.r-project.org/web/packages/deepspat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/deepspat/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2b0b9206c7cc3a` from `cran_packages_by_date` as `registry_expansion`
