...
| Canonical URL | [https://luarocks.org/modules/joao-feijao/jsonc](https://luarocks.org/modules/joao-feijao/jsonc) |
| Source record ids | luarocks_root_manifest-5a848ff24233fe |

## System Engineer Summary

A JSON engine made in pure Lua with file management, I/O management, utility functions and lexical
path query.

## Operational Role

For a systems engineer, jsonc belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-5a848ff24233fe` from `luarocks_root_manifest` as `registry_expansion`
