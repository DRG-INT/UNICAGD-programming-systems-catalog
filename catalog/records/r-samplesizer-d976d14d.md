...
<!-- canonical: https://cran.r-project.org/web/packages/SampleSizeR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SampleSizeR/index.html](https://cran.r-project.org/web/packages/SampleSizeR/index.html) |
| Source record ids | cran_packages_by_date-d4e9a873e0f434 |
...
For a systems engineer, SampleSizeR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:20:03 UTC | [https://cran.r-project.org/web/packages/SampleSizeR/DESCRIPTION](https://cran.r-project.org/web/packages/SampleSizeR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SampleSizeR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d4e9a873e0f434` from `cran_packages_by_date` as `registry_expansion`
