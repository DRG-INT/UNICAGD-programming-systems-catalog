...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-414b3a735b421b |

## System Engineer Summary

Geospatial data abstraction library for raster/vector formats, coordinate systems, reprojection, and
map data conversion.

## Operational Role

For a systems engineer, GDAL belongs in the Maps inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.13.3 | 2026-08-18T09:39:09Z | [https://api.github.com/repos/OSGeo/gdal/releases/latest](https://api.github.com/repos/OSGeo/gdal/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OSGeo/gdal/releases/latest` at `2026-09-01T07:24:43+00:00`.
...
- `curated_language_routes-414b3a735b421b` from `curated_language_routes` as `registry_expansion`
