...
<!-- canonical: https://github.com/intake/intake-esm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/intake/intake-esm](https://github.com/intake/intake-esm) |
| Source record ids | github_search_catalogs-16e5e59cc25c54 |

## System Engineer Summary

An intake plugin for parsing an Earth System Model (ESM) catalog and loading assets into xarray
datasets.

## Operational Role

For a systems engineer, intake/intake-esm belongs in the Catalogs inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T18:03:34Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-16e5e59cc25c54` from `github_search_catalogs` as `registry_expansion`
