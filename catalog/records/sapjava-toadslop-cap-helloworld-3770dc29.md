...
<!-- canonical: https://github.com/toadslop/cap-helloworld -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/toadslop/cap-helloworld](https://github.com/toadslop/cap-helloworld) |
| Source record ids | github_search_sapjava-2c9a8360953bb5 |

## System Engineer Summary

A simple hello world app made with SAP's CAP Java framework.

## Operational Role

For a systems engineer, toadslop/cap-helloworld belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-27T10:38:35Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-2c9a8360953bb5` from `github_search_sapjava` as `registry_expansion`
