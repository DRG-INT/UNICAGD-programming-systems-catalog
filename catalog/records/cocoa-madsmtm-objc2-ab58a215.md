...
<!-- canonical: https://github.com/madsmtm/objc2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/madsmtm/objc2](https://github.com/madsmtm/objc2) |
| Source record ids | github_search_cocoa-6b1fad1f7c4255 |
...
For a systems engineer, madsmtm/objc2 belongs in the Cocoa inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T16:09:33Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-6b1fad1f7c4255` from `github_search_cocoa` as `registry_expansion`
