...
<!-- canonical: https://github.com/game-icons/icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/game-icons/icons](https://github.com/game-icons/icons) |
| Source record ids | github_search_icons_and_logos-05bbdc78ec92b0 |
...
For a systems engineer, game-icons/icons belongs in the Icons and Logos inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T19:09:10Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-05bbdc78ec92b0` from `github_search_icons_and_logos` as `registry_expansion`
