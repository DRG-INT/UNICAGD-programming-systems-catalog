...
<!-- canonical: https://cran.r-project.org/web/packages/cureAssess/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cureAssess/index.html](https://cran.r-project.org/web/packages/cureAssess/index.html) |
| Source record ids | cran_packages_by_date-42f401e8a543f4 |

## System Engineer Summary

Assessing Cure Model Appropriateness for Survival Data

## Operational Role

For a systems engineer, cureAssess belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-14 15:50:02 UTC | [https://cran.r-project.org/web/packages/cureAssess/DESCRIPTION](https://cran.r-project.org/web/packages/cureAssess/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cureAssess/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-42f401e8a543f4` from `cran_packages_by_date` as `registry_expansion`
