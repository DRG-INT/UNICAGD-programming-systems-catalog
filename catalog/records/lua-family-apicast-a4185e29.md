...
<!-- canonical: https://luarocks.org/modules/3scale/apicast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/3scale/apicast](https://luarocks.org/modules/3scale/apicast) |
| Source record ids | luarocks_root_manifest-8c143fc153f297 |

## System Engineer Summary

APIcast is tracked as a parser lexer ast record in the Lua family branch. The source did not provide
...
For a systems engineer, APIcast belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-8c143fc153f297` from `luarocks_root_manifest` as `registry_expansion`
