...
<!-- canonical: https://github.com/fudanxu/SAR-Colorization -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fudanxu/SAR-Colorization](https://github.com/fudanxu/SAR-Colorization) |
| Source record ids | github_search_radars-a1dc6425ffb137 |
...
For a systems engineer, fudanxu/SAR-Colorization belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-04-23T10:29:38Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-a1dc6425ffb137` from `github_search_radars` as `registry_expansion`
