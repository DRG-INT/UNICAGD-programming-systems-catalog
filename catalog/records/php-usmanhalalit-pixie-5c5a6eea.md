...
<!-- canonical: https://packagist.org/packages/usmanhalalit/pixie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/usmanhalalit/pixie](https://packagist.org/packages/usmanhalalit/pixie) |
| Source record ids | packagist_search-c6d5744da68b4a |
...
For a systems engineer, usmanhalalit/pixie belongs in the PHP inventory as part of build graph
...
- `packagist_search-c6d5744da68b4a` from `packagist_search` as `registry_expansion`
