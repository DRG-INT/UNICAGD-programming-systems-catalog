...
| Canonical URL | [https://github.com/kanaka/mal](https://github.com/kanaka/mal) |
| Source record ids | github_search_webassembly-d7334da3efaa3e |

## System Engineer Summary

kanaka/mal is tracked as a build system record in the WebAssembly branch. The source did not provide
...
For a systems engineer, kanaka/mal belongs in the WebAssembly inventory as part of build graph
...
| preview | known | v0.1 | 2019-03-19T21:00:33Z | [https://api.github.com/repos/kanaka/mal/releases?per_page=10](https://api.github.com/repos/kanaka/mal/releases?per_page=10) |  |
...
- `github_search_webassembly-d7334da3efaa3e` from `github_search_webassembly` as `registry_expansion`
...
| leptos-rs/leptos | Build System | [open](webassembly-leptos-rs-leptos-831793ba.md) |
| slint-ui/slint | Build System | [open](webassembly-slint-ui-slint-1565f5f8.md) |
| spinframework/spin | Build System | [open](webassembly-spinframework-spin-bc703583.md) |
| unoplatform/uno | Build System | [open](webassembly-unoplatform-uno-0c5b85c2.md) |
