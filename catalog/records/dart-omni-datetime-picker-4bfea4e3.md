...
<!-- canonical: https://pub.dev/packages/omni_datetime_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/omni_datetime_picker](https://pub.dev/packages/omni_datetime_picker) |
| Source record ids | pub_dev-21ee8274bb05db |
...
For a systems engineer, omni_datetime_picker belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-05-19T06:46:06.901299Z | [https://pub.dev/api/packages/omni_datetime_picker](https://pub.dev/api/packages/omni_datetime_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/omni_datetime_picker` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-21ee8274bb05db` from `pub_dev` as `registry_expansion`
