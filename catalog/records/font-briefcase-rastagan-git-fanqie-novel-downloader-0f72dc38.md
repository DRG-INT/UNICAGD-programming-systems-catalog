...
<!-- canonical: https://github.com/rastagan-git/Fanqie-Novel-Downloader- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rastagan-git/Fanqie-Novel-Downloader-](https://github.com/rastagan-git/Fanqie-Novel-Downloader-) |
| Source record ids | github_search_font_briefcase-88fcb242825851 |

## System Engineer Summary

An educational Python downloader for Fanqie Novel chapters with browser login, custom-font decoding,
and TXT export.

## Operational Role

For a systems engineer, rastagan-git/Fanqie-Novel-Downloader- belongs in the Font Briefcase
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-19T15:34:02Z | gh search repos topic:fonttools stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-88fcb242825851` from `github_search_font_briefcase` as `registry_expansion`
