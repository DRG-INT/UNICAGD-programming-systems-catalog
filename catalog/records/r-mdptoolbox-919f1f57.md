...
<!-- canonical: https://cran.r-project.org/web/packages/MDPtoolbox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MDPtoolbox/index.html](https://cran.r-project.org/web/packages/MDPtoolbox/index.html) |
| Source record ids | cran_packages_by_date-0815cb80a49bf7 |
...
For a systems engineer, MDPtoolbox belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.4 | 2026-08-31 18:40:20 UTC | [https://cran.r-project.org/web/packages/MDPtoolbox/DESCRIPTION](https://cran.r-project.org/web/packages/MDPtoolbox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MDPtoolbox/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0815cb80a49bf7` from `cran_packages_by_date` as `registry_expansion`
