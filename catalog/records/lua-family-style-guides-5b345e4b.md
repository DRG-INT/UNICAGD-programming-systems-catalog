...
| Source record ids | lua-source-49 |

## System Engineer Summary

Style Guides is tracked as an ide editor integration record in the Lua family branch. The source did
...
For a systems engineer, Style Guides belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 49}}` |
...
- `lua-source-49` from `master_json` as `source_list_item`
