...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/arcgisutils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/arcgisutils/index.html](https://cran.r-project.org/web/packages/arcgisutils/index.html) |
| Source record ids | cran_packages_by_date-24bafb96f69fd5 |
...
For a systems engineer, arcgisutils belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-09-03 05:21:01 UTC | [https://cran.r-project.org/web/packages/arcgisutils/DESCRIPTION](https://cran.r-project.org/web/packages/arcgisutils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/arcgisutils/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-24bafb96f69fd5` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fz | Interop Bindings | [open](r-fz-65db3363.md) |
| kerasnip | Interop Bindings | [open](r-kerasnip-1cf976b9.md) |
| runExamplesWrapper | Interop Bindings | [open](r-runexampleswrapper-73dc6e8d.md) |
