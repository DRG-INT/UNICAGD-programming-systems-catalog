# Gitea: Azuma/ASCII-To-Hexadecimal
...
<!-- canonical: https://gitea.com/Azuma/ASCII-To-Hexadecimal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Azuma/ASCII-To-Hexadecimal](https://gitea.com/Azuma/ASCII-To-Hexadecimal) |
| Source record ids | gitea_repositories_api-06a7bea14e1822 |

## System Engineer Summary

A simple terminal app that displays the hex of ASCII text.

## Operational Role

For a systems engineer, Gitea: Azuma/ASCII-To-Hexadecimal belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-15T05:07:22Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-06a7bea14e1822` from `gitea_repositories_api` as `registry_expansion`
