...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/mlr3automl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3automl/index.html](https://cran.r-project.org/web/packages/mlr3automl/index.html) |
| Source record ids | cran_packages_by_date-010835aa89fa3d |

## System Engineer Summary

Automated Machine Learning for 'mlr3'

## Operational Role

For a systems engineer, mlr3automl belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 12:20:03 UTC | [https://cran.r-project.org/web/packages/mlr3automl/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3automl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3automl/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-010835aa89fa3d` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| datasetjson | Serialization | [open](r-datasetjson-816e7708.md) |
| encharter | Serialization | [open](r-encharter-caacc771.md) |
| llmjson | Serialization | [open](r-llmjson-7abee1f7.md) |
| lt | Serialization | [open](r-lt-213efbff.md) |
| qbr | Serialization | [open](r-qbr-bdd32b3a.md) |
| RcppMsgPack | Serialization | [open](r-rcppmsgpack-bf85e3d0.md) |
| RProtoBuf | Serialization | [open](r-rprotobuf-4170b44d.md) |
| S7schema | Serialization | [open](r-s7schema-da2b2603.md) |
