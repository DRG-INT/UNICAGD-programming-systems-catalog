...
<!-- canonical: https://github.com/openaddresses/openaddresses -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openaddresses/openaddresses](https://github.com/openaddresses/openaddresses) |
| Source record ids | github_search_maps-ed7d019a72999a |
...
For a systems engineer, openaddresses/openaddresses belongs in the Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:43:18Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_maps-ed7d019a72999a` from `github_search_maps` as `registry_expansion`
