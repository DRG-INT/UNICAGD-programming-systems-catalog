...
<!-- canonical: https://pypi.org/project/adafruit-circuitpython-ble-cycling-speed-and-cadence/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adafruit-circuitpython-ble-cycling-speed-and-cadence/](https://pypi.org/project/adafruit-circuitpython-ble-cycling-speed-and-cadence/) |
| Source record ids | pypi_simple-7159dd14d8db2a |
...
For a systems engineer, adafruit-circuitpython-ble-cycling-speed-and-cadence belongs in the Python
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.22 | 2026-04-23T21:17:16.028222Z | [https://pypi.org/pypi/adafruit-circuitpython-ble-cycling-speed-and-cadence/json](https://pypi.org/pypi/adafruit-circuitpython-ble-cycling-speed-and-cadence/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adafruit-circuitpython-ble-cycling-speed-and-cadence/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-7159dd14d8db2a` from `pypi_simple` as `registry_expansion`
