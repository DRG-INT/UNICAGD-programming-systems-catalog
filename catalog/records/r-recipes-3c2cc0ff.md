...
<!-- canonical: https://cran.r-project.org/web/packages/recipes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/recipes/index.html](https://cran.r-project.org/web/packages/recipes/index.html) |
| Source record ids | cran_packages_by_date-acf5f0c00157e3 |
...
For a systems engineer, recipes belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-24 08:20:02 UTC | [https://cran.r-project.org/web/packages/recipes/DESCRIPTION](https://cran.r-project.org/web/packages/recipes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/recipes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-acf5f0c00157e3` from `cran_packages_by_date` as `registry_expansion`
