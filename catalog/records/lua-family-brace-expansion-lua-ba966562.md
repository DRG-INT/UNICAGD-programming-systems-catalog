...
<!-- canonical: https://luarocks.org/modules/leonsilicon/brace-expansion-lua -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-91590f02b2702c` from `luarocks_root_manifest` as `registry_expansion`
