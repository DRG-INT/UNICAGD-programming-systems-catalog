...
<!-- canonical: https://luarocks.org/modules/kat/__gc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kat/__gc](https://luarocks.org/modules/kat/__gc) |
| Source record ids | luarocks_root_manifest-d0afc5426ec774 |
...
For a systems engineer, __gc belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d0afc5426ec774` from `luarocks_root_manifest` as `registry_expansion`
