...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rushindrasinha/youtube-shorts-pipeline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rushindrasinha/youtube-shorts-pipeline](https://github.com/rushindrasinha/youtube-shorts-pipeline) |
| Source record ids | github_search_video-dc00fdc0371884 |
...
For a systems engineer, rushindrasinha/youtube-shorts-pipeline belongs in the Video inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T23:55:00Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-dc00fdc0371884` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AzuraCast/AzuraCast | Package Manager | [open](video-azuracast-azuracast-d01011b2.md) |
| calesthio/OpenMontage | Package Manager | [open](video-calesthio-openmontage-675312f7.md) |
| google-ai-edge/mediapipe | Package Manager | [open](video-google-ai-edge-mediapipe-a0c51472.md) |
| kaltura/platform-install-packages | Package Manager | [open](video-kaltura-platform-install-packages-da4f9d30.md) |
| memvid/memvid | Package Manager | [open](video-memvid-memvid-bb0d9def.md) |
| pathwaycom/pathway | Package Manager | [open](video-pathwaycom-pathway-a50dba92.md) |
| snapotter-hq/SnapOtter | Package Manager | [open](video-snapotter-hq-snapotter-7f75c7aa.md) |
| streamlink/streamlink | Package Manager | [open](video-streamlink-streamlink-ff62fe99.md) |
