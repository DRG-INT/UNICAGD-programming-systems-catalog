...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/pkg-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/pkg-example](https://gnu-octave.github.io/packages/pkg-example) |
| Source record ids | octave_packages_index-05320134d760e3 |

## System Engineer Summary

Example package to demonstrate the creation process of an Octave package. Keep this description
brief. Describe the major features in the first two lines (160 characters). Multiple lines are
allowed. Each line may have maximal 80 characters. Exceptions are URLs. Paragraphs, blank lines, and
line breaks are ignored and replaced by spaces.

## Operational Role

For a systems engineer, pkg-example belongs in the Octave inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2021-04-06 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-05320134d760e3` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mboct-fem-pkg | Package Manager | [open](octave-mboct-fem-pkg-1596ca41.md) |
| mboct-mbdyn-pkg | Package Manager | [open](octave-mboct-mbdyn-pkg-225b3a13.md) |
| mboct-numerical-pkg | Package Manager | [open](octave-mboct-numerical-pkg-8b3a09e7.md) |
| mboct-octave-pkg | Package Manager | [open](octave-mboct-octave-pkg-26398612.md) |
| pkg | Package Manager | [open](octave-pkg-380b0b6e.md) |
| pkg-octave-doc | Package Manager | [open](octave-pkg-octave-doc-8d8fe953.md) |
