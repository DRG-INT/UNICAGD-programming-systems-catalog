...
<!-- canonical: https://github.com/dholzmueller/sfcpp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dholzmueller/sfcpp](https://github.com/dholzmueller/sfcpp) |
| Source record ids | github_search_space_maps-a1620864c66fa3 |

## System Engineer Summary

A library with space-filling curve algorithms (analysis, neighbor-finding, visualization) and other
utilities (math, geometry, image processing, LaTeX generation...)

## Operational Role

For a systems engineer, dholzmueller/sfcpp belongs in the Space Maps inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-18T08:29:43Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a1620864c66fa3` from `github_search_space_maps` as `registry_expansion`
