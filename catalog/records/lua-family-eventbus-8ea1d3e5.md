...
| Canonical URL | [https://luarocks.org/modules/prabirshrestha/eventbus](https://luarocks.org/modules/prabirshrestha/eventbus) |
| Source record ids | luarocks_root_manifest-1fd01cb3ab1d76 |

## System Engineer Summary

eventbus is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, eventbus belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1fd01cb3ab1d76` from `luarocks_root_manifest` as `registry_expansion`
