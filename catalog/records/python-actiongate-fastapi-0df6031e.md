...
<!-- canonical: https://pypi.org/project/actiongate-fastapi/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actiongate-fastapi/](https://pypi.org/project/actiongate-fastapi/) |
| Source record ids | pypi_simple-d05e3d18d06375 |
...
For a systems engineer, actiongate-fastapi belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-03-15T03:43:47.469016Z | [https://pypi.org/pypi/actiongate-fastapi/json](https://pypi.org/pypi/actiongate-fastapi/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actiongate-fastapi/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-d05e3d18d06375` from `pypi_simple` as `registry_expansion`
