...
| Source record ids | github_search_aims-39a10847ed4406 |
...
For a systems engineer, vllm-project/vllm belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T02:51:03Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-39a10847ed4406` from `github_search_aims` as `registry_expansion`
