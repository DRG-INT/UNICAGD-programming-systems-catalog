...
<!-- canonical: https://github.com/jacobwilliams/jsonspice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jacobwilliams/jsonspice](https://github.com/jacobwilliams/jsonspice) |
| Source record ids | github_search_space_maps-8e4902e0b35b35 |
...
For a systems engineer, jacobwilliams/jsonspice belongs in the Space Maps inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-04T13:49:32Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8e4902e0b35b35` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| frostoven/BSC5P-JSON-XYZ | Serialization | [open](space-maps-frostoven-bsc5p-json-xyz-d3ca9508.md) |
