...
<!-- canonical: https://cran.r-project.org/web/packages/fastRhockey/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastRhockey/index.html](https://cran.r-project.org/web/packages/fastRhockey/index.html) |
| Source record ids | cran_packages_by_date-57445c37e1c220 |

## System Engineer Summary

Functions to Access Professional Women's Hockey League and National Hockey League Play by Play Data

## Operational Role

For a systems engineer, fastRhockey belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-25 11:50:02 UTC | [https://cran.r-project.org/web/packages/fastRhockey/DESCRIPTION](https://cran.r-project.org/web/packages/fastRhockey/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastRhockey/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57445c37e1c220` from `cran_packages_by_date` as `registry_expansion`
