...
| Source record ids | github_search_game_engines-db261c87873466 |
...
For a systems engineer, SFTtech/openage belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T10:38:52Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-db261c87873466` from `github_search_game_engines` as `registry_expansion`
