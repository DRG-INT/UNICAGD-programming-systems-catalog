...
| Canonical URL | [https://packagist.org/packages/flow-php/postgresql](https://packagist.org/packages/flow-php/postgresql) |
| Source record ids | packagist_search-97fbead4a021eb |
...
For a systems engineer, flow-php/postgresql belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.43.0 | 2026-08-10T13:42:47+00:00 | [https://repo.packagist.org/p2/flow-php/postgresql.json](https://repo.packagist.org/p2/flow-php/postgresql.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/flow-php/postgresql.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-97fbead4a021eb` from `packagist_search` as `registry_expansion`
