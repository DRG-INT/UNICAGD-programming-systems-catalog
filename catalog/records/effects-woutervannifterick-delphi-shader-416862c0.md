# WouterVanNifterick/delphi-shader
...
<!-- canonical: https://github.com/WouterVanNifterick/delphi-shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WouterVanNifterick/delphi-shader](https://github.com/WouterVanNifterick/delphi-shader) |
| Source record ids | github_search_effects-827600511e2181 |
...
For a systems engineer, WouterVanNifterick/delphi-shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-08T07:59:48Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-827600511e2181` from `github_search_effects` as `registry_expansion`
