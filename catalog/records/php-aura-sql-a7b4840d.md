...
| Canonical URL | [https://packagist.org/packages/aura/sql](https://packagist.org/packages/aura/sql) |
| Source record ids | packagist_search-19441175157787 |

## System Engineer Summary

A PDO extension that provides lazy connections, array quoting, query profiling, value binding, and
convenience methods for common fetch styles. Because it extends PDO, existing code that uses PDO can
use this without any changes to the existing code.

## Operational Role

For a systems engineer, aura/sql belongs in the PHP inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.1 | 2026-01-05T05:22:47+00:00 | [https://repo.packagist.org/p2/aura/sql.json](https://repo.packagist.org/p2/aura/sql.json) |  |
| preview | known | 6.0.0-beta1 | 2025-01-22T06:45:21+00:00 | [https://repo.packagist.org/p2/aura/sql.json](https://repo.packagist.org/p2/aura/sql.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/aura/sql.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-19441175157787` from `packagist_search` as `registry_expansion`
