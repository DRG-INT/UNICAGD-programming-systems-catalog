...
<!-- canonical: https://github.com/productdevbook/port-killer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/productdevbook/port-killer](https://github.com/productdevbook/port-killer) |
| Source record ids | github_search_swift-5e4193addb4980 |

## System Engineer Summary

A powerful cross-platform port management tool for developers. Monitor ports, manage Kubernetes port
forwards, integrate Cloudflare Tunnels, and kill processes with one click.

## Operational Role

For a systems engineer, productdevbook/port-killer belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T21:10:20Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-5e4193addb4980` from `github_search_swift` as `registry_expansion`
