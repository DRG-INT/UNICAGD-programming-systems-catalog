...
<!-- canonical: https://packagist.org/packages/elastic/transport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/elastic/transport](https://packagist.org/packages/elastic/transport) |
| Source record ids | packagist_search-2ca93193f18cac |
...
For a systems engineer, elastic/transport belongs in the PHP inventory as part of language tooling,
...
- `packagist_search-2ca93193f18cac` from `packagist_search` as `registry_expansion`
