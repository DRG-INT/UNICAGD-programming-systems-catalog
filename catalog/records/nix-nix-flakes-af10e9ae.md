...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://nix.dev/concepts/flakes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://nix.dev/concepts/flakes](https://nix.dev/concepts/flakes) |
| Source record ids | curated_language_routes-bc87fbfd3fe5ba |

## System Engineer Summary

Official Nix flake concept documentation for locked inputs, reproducible outputs, and project
workflows.

## Operational Role

For a systems engineer, Nix Flakes belongs in the nix inventory as part of ecosystem capability
...
- `curated_language_routes-bc87fbfd3fe5ba` from `curated_language_routes` as `registry_expansion`
