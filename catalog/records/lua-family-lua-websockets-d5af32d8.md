...
| Source record ids | corpus-26fe8b6594fb6a |

## System Engineer Summary

lua-websockets is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, lua-websockets belongs in the Lua family inventory as part of service
...
- `corpus-26fe8b6594fb6a` from `master_json` as `networking_http`
