...
<!-- canonical: https://github.com/avoroshilov/physics_playground -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avoroshilov/physics_playground](https://github.com/avoroshilov/physics_playground) |
| Source record ids | github_search_physics_engines-2baa60c95a3c6d |

## System Engineer Summary

Improved version of real-time physics engine that couples FEM-based deformables and rigid body
dynamics

## Operational Role

For a systems engineer, avoroshilov/physics_playground belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-21T02:09:04Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-2baa60c95a3c6d` from `github_search_physics_engines` as `registry_expansion`
