...
<!-- canonical: https://github.com/attenlabs/saa-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/attenlabs/saa-sdk](https://github.com/attenlabs/saa-sdk) |
| Source record ids | github_search_audio-a14b9d6b0afb4c |

## System Engineer Summary

Addressee detection for voice agents: device-directed speech detection that runs before STT, so
background speech, side conversations, and the agent's own TTS echo never trigger it. No wake word,
model-agnostic, drop-in for LiveKit, Pipecat, ElevenLabs, Twilio, and OpenAI. The layer your VAD and
turn detection are missing.

## Operational Role

For a systems engineer, attenlabs/saa-sdk belongs in the Audio inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-15T20:52:27Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-a14b9d6b0afb4c` from `github_search_audio` as `registry_expansion`
