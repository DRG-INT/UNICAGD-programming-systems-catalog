...
<!-- canonical: https://luarocks.org/modules/cluadguard-waf/cloudguard-waf-kong-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cluadguard-waf/cloudguard-waf-kong-plugin](https://luarocks.org/modules/cluadguard-waf/cloudguard-waf-kong-plugin) |
| Source record ids | luarocks_root_manifest-36f5cfdefed50d |
...
For a systems engineer, cloudguard-waf-kong-plugin belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-36f5cfdefed50d` from `luarocks_root_manifest` as `registry_expansion`
