...
<!-- canonical: https://github.com/rjwalia/Navier-Stokes-Numerical-Solution-Using-FDM-FVM-LBM-Solver-Python-Scripting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rjwalia/Navier-Stokes-Numerical-Solution-Using-FDM-FVM-LBM-Solver-Python-Scripting](https://github.com/rjwalia/Navier-Stokes-Numerical-Solution-Using-FDM-FVM-LBM-Solver-Python-Scripting) |
| Source record ids | github_search_physics_engines-6e226156b5a7df |

## System Engineer Summary

Python script for Linear, Non-Linear Convection, Burger’s & Poisson Equation in 1D & 2D, 1D
Diffusion Equation using Standard Wall Function, 2D Heat Conduction Convection equation with
Dirichlet & Neumann BC, full Navier-Stokes Equation coupled with Poisson equation for Cavity and
Channel flow in 2D using Finite Difference Method & Finite Volume Method.

## Operational Role

For a systems engineer, rjwalia/Navier-Stokes-Numerical-Solution-Using-FDM-FVM-LBM-Solver-Python-
Scripting belongs in the Physics Engines inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-28T19:16:09Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-6e226156b5a7df` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| krABMaga/krABMaga | Language Specification | [open](physics-engines-krabmaga-krabmaga-17c6b1ec.md) |
