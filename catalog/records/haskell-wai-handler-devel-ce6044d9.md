...
<!-- canonical: https://hackage.haskell.org/package/wai-handler-devel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wai-handler-devel](https://hackage.haskell.org/package/wai-handler-devel) |
| Source record ids | hackage_top_downloads-8fd4be705da6c6 |
...
For a systems engineer, wai-handler-devel belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0.2 | 2014-03-26T12:06:05Z | [https://hackage.haskell.org/package/wai-handler-devel](https://hackage.haskell.org/package/wai-handler-devel) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wai-handler-devel` at `2026-09-02T00:32:56+00:00`.
...
- `hackage_top_downloads-8fd4be705da6c6` from `hackage_top_downloads` as `registry_expansion`
