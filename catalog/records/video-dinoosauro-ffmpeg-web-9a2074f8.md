...
<!-- canonical: https://github.com/dinoosauro/ffmpeg-web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dinoosauro/ffmpeg-web](https://github.com/dinoosauro/ffmpeg-web) |
| Source record ids | github_search_video-6f0490e8ed1c62 |

## System Engineer Summary

A Web and Native UI for ffmpeg-wasm: convert video, audio and images using the power of ffmpeg,
directly from your web browser or from your computer.

## Operational Role

For a systems engineer, dinoosauro/ffmpeg-web belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-02T12:22:38Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-6f0490e8ed1c62` from `github_search_video` as `registry_expansion`
