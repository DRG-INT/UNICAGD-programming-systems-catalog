...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.0 | 2025-11-13T19:27:52Z | [https://api.github.com/repos/cookpete/react-player/releases/latest](https://api.github.com/repos/cookpete/react-player/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cookpete/react-player/releases/latest` at `2026-09-01T09:23:22+00:00`.
...
| Chocobozzz/PeerTube | Undefined Behavior Analyzer | [open](video-chocobozzz-peertube-ff9a950e.md) |
| code-charity/youtube | Undefined Behavior Analyzer | [open](video-code-charity-youtube-413818e8.md) |
| datarhei/restreamer | Undefined Behavior Analyzer | [open](video-datarhei-restreamer-ebfeeaad.md) |
| FreeTubeApp/FreeTube | Undefined Behavior Analyzer | [open](video-freetubeapp-freetube-f7bd248f.md) |
| iv-org/invidious | Undefined Behavior Analyzer | [open](video-iv-org-invidious-b8d2acca.md) |
| mediaelement/mediaelement | Undefined Behavior Analyzer | [open](video-mediaelement-mediaelement-f79e452d.md) |
