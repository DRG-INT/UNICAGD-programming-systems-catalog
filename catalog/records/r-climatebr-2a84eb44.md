...
<!-- canonical: https://cran.r-project.org/web/packages/climateBR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/climateBR/index.html](https://cran.r-project.org/web/packages/climateBR/index.html) |
| Source record ids | cran_packages_by_date-34b0499725e255 |
...
For a systems engineer, climateBR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-19 13:40:09 UTC | [https://cran.r-project.org/web/packages/climateBR/DESCRIPTION](https://cran.r-project.org/web/packages/climateBR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/climateBR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-34b0499725e255` from `cran_packages_by_date` as `registry_expansion`
