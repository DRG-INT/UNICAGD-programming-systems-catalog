...
<!-- canonical: https://github.com/afichet/openexr-viewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/afichet/openexr-viewer](https://github.com/afichet/openexr-viewer) |
| Source record ids | github_search_photography-f451d56be890be |
...
For a systems engineer, afichet/openexr-viewer belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-11T13:18:47Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f451d56be890be` from `github_search_photography` as `registry_expansion`
