...
<!-- canonical: https://github.com/JuantAldea/Separating-Axis-Theorem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuantAldea/Separating-Axis-Theorem](https://github.com/JuantAldea/Separating-Axis-Theorem) |
| Source record ids | github_search_physics_engines-b814185872eccb |
...
For a systems engineer, JuantAldea/Separating-Axis-Theorem belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-18T13:19:33Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-b814185872eccb` from `github_search_physics_engines` as `registry_expansion`
