...
<!-- canonical: https://www.npmjs.com/package/server-only -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/server-only](https://www.npmjs.com/package/server-only) |
| Source record ids | npm_registry-e3ef55b27b4b74 |
...
For a systems engineer, server-only belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2022-09-03T01:07:26.139Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-e3ef55b27b4b74` from `npm_registry` as `registry_expansion`
