...
<!-- canonical: https://cran.r-project.org/web/packages/corto/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/corto/index.html](https://cran.r-project.org/web/packages/corto/index.html) |
| Source record ids | cran_packages_by_date-816f3b3ae96175 |
...
For a systems engineer, corto belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-21 05:44:25 UTC | [https://cran.r-project.org/web/packages/corto/DESCRIPTION](https://cran.r-project.org/web/packages/corto/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/corto/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-816f3b3ae96175` from `cran_packages_by_date` as `registry_expansion`
