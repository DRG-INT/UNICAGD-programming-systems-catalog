...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/deepjyoti30/ytmdl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deepjyoti30/ytmdl](https://github.com/deepjyoti30/ytmdl) |
| Source record ids | github_search_video-5cca316f2cc86e |

## System Engineer Summary

A simple app to get songs from YouTube in mp3 format with artist name, album name etc from sources
like iTunes, Spotify, LastFM, Deezer, Gaana etc.

## Operational Role

For a systems engineer, deepjyoti30/ytmdl belongs in the Video inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-15T09:11:15Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-5cca316f2cc86e` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| LaoFeng-mouse/flyingmouse-format | Formatter | [open](video-laofeng-mouse-flyingmouse-format-e28842e0.md) |
| robbyant-research/CoDeF | Formatter | [open](video-robbyant-research-codef-fd77a0b3.md) |
| signalwire/freeswitch | Formatter | [open](video-signalwire-freeswitch-a9bf73a8.md) |
