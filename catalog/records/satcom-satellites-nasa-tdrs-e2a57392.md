...
| Canonical URL | [https://www.nasa.gov/directorates/somd/space-communications-navigation-program/tdrs/](https://www.nasa.gov/directorates/somd/space-communications-navigation-program/tdrs/) |
| Source record ids | curated_language_routes-fda3e3010fec1d |

## System Engineer Summary

NASA Tracking and Data Relay Satellite system route for public satellite communications context.

## Operational Role

For a systems engineer, NASA TDRS belongs in the SatCom Satellites inventory as part of operator
...
- `curated_language_routes-fda3e3010fec1d` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ESA Estrack | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/satcom-satellites-esa-estrack-f10e6c42.md) |
