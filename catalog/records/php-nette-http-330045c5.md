...
<!-- canonical: https://packagist.org/packages/nette/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nette/http](https://packagist.org/packages/nette/http) |
| Source record ids | packagist_search-3200b66b3b44d4 |

## System Engineer Summary

🌐 Nette Http: abstraction for HTTP request, response and session. Provides careful data sanitization
and utility for URL and cookies manipulation.

## Operational Role

For a systems engineer, nette/http belongs in the PHP inventory as part of ecosystem capability
...
- `packagist_search-3200b66b3b44d4` from `packagist_search` as `registry_expansion`
