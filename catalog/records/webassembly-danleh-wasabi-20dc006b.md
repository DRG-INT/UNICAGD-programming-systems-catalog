...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/danleh/wasabi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danleh/wasabi](https://github.com/danleh/wasabi) |
| Source record ids | github_search_webassembly-cfa218d64af0de |
...
For a systems engineer, danleh/wasabi belongs in the WebAssembly inventory as part of defect
...
- `github_search_webassembly-cfa218d64af0de` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acieroid/wassail | Static Analyzer | [open](webassembly-acieroid-wassail-9938b412.md) |
| ASSERT-KTH/slumps | Static Analyzer | [open](webassembly-assert-kth-slumps-32b47fde.md) |
| Implex-ltd/hcaptcha-reverse | Static Analyzer | [open](webassembly-implex-ltd-hcaptcha-reverse-3ac23990.md) |
