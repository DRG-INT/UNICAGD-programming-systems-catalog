...
<!-- canonical: https://github.com/roboflow/supervision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/roboflow/supervision](https://github.com/roboflow/supervision) |
| Source record ids | github_search_video-f48089d344e7fe |
...
For a systems engineer, roboflow/supervision belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T11:39:04Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-f48089d344e7fe` from `github_search_video` as `registry_expansion`
