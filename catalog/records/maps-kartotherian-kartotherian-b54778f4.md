...
<!-- canonical: https://github.com/kartotherian/kartotherian -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kartotherian/kartotherian](https://github.com/kartotherian/kartotherian) |
| Source record ids | github_search_maps-d0ec290d9cdbe8 |

## System Engineer Summary

kartotherian/kartotherian is tracked as a web framework record in the Maps branch. The source did
...
For a systems engineer, kartotherian/kartotherian belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-08-11T04:00:27Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d0ec290d9cdbe8` from `github_search_maps` as `registry_expansion`
