...
<!-- canonical: https://cran.r-project.org/web/packages/ProMetaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ProMetaR/index.html](https://cran.r-project.org/web/packages/ProMetaR/index.html) |
| Source record ids | cran_packages_by_date-81725d9f1a20af |

## System Engineer Summary

Meta-Analysis of Proportions and Prevalence

## Operational Role

For a systems engineer, ProMetaR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-12 14:10:33 UTC | [https://cran.r-project.org/web/packages/ProMetaR/DESCRIPTION](https://cran.r-project.org/web/packages/ProMetaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ProMetaR/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-81725d9f1a20af` from `cran_packages_by_date` as `registry_expansion`
