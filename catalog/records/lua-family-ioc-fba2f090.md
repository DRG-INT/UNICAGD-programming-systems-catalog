...
| Canonical URL | [https://luarocks.org/modules/swarg/ioc](https://luarocks.org/modules/swarg/ioc) |
| Source record ids | luarocks_root_manifest-8ca1f889b9cea5 |

## System Engineer Summary

Invertion of Control. DI Container

## Operational Role

For a systems engineer, ioc belongs in the Lua family inventory as part of model pipelines,
...
- `luarocks_root_manifest-8ca1f889b9cea5` from `luarocks_root_manifest` as `registry_expansion`
