...
<!-- canonical: https://crates.io/crates/tinystr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tinystr](https://crates.io/crates/tinystr) |
| Source record ids | crates_io-ea54e37c00fd57 |
...
For a systems engineer, tinystr belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2026-08-13T23:28:07.485828Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-ea54e37c00fd57` from `crates_io` as `registry_expansion`
