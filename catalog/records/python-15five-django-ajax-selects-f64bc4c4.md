...
<!-- canonical: https://pypi.org/project/15five-django-ajax-selects/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/15five-django-ajax-selects/](https://pypi.org/project/15five-django-ajax-selects/) |
| Source record ids | pypi_simple-8fbd45dc18fcd4 |
...
For a systems engineer, 15five-django-ajax-selects belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.2.155 | 2017-05-15T22:37:10.777355Z | [https://pypi.org/pypi/15five-django-ajax-selects/json](https://pypi.org/pypi/15five-django-ajax-selects/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/15five-django-ajax-selects/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-8fbd45dc18fcd4` from `pypi_simple` as `registry_expansion`
