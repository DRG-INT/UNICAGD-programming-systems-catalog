...
<!-- canonical: https://github.com/mopsicus/uis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mopsicus/uis](https://github.com/mopsicus/uis) |
| Source record ids | github_search_assets-9e23f5a98f4816 |

## System Engineer Summary

Unity infinite scroller (UIS) is an extension allows you to use the ScrollRect control as an
infinite scroller/spinner

## Operational Role

For a systems engineer, mopsicus/uis belongs in the Assets inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-04T08:08:04Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-9e23f5a98f4816` from `github_search_assets` as `registry_expansion`
