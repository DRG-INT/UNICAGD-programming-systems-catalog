...
<!-- canonical: https://github.com/jens-maus/thinRoot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jens-maus/thinRoot](https://github.com/jens-maus/thinRoot) |
| Source record ids | github_search_space_maps-d407db77877fc5 |

## System Engineer Summary

thinRoot is a buildroot powered operating system environment to create lightweight user-defined
kiosk systems or ThinClients (e.g. using x86_64 hardware, RaspberryPi, etc.) to smoothly connect to
server-based desktop environments via ThinLinc, RDP, SPICE@ProxmoxVE, VNC or to create a simple web-
kiosk...

## Operational Role

For a systems engineer, jens-maus/thinRoot belongs in the Space Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T12:22:49Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_space_maps-d407db77877fc5` from `github_search_space_maps` as `registry_expansion`
