...
<!-- canonical: https://github.com/paulpacifico/shutter-encoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paulpacifico/shutter-encoder](https://github.com/paulpacifico/shutter-encoder) |
| Source record ids | github_search_video-a42d7a608d505d |
...
For a systems engineer, paulpacifico/shutter-encoder belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:49:17Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-a42d7a608d505d` from `github_search_video` as `registry_expansion`
