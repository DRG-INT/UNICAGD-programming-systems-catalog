...
<!-- canonical: https://cran.r-project.org/web/packages/clmplus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clmplus/index.html](https://cran.r-project.org/web/packages/clmplus/index.html) |
| Source record ids | cran_packages_by_date-954d496bb9f209 |
...
For a systems engineer, clmplus belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-14 22:10:08 UTC | [https://cran.r-project.org/web/packages/clmplus/DESCRIPTION](https://cran.r-project.org/web/packages/clmplus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clmplus/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-954d496bb9f209` from `cran_packages_by_date` as `registry_expansion`
