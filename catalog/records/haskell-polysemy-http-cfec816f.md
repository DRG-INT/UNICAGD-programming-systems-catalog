...
<!-- canonical: https://hackage.haskell.org/package/polysemy-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/polysemy-http](https://hackage.haskell.org/package/polysemy-http) |
| Source record ids | hackage_top_downloads-f4e80f7d8360f2 |
...
For a systems engineer, polysemy-http belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.1.0 | 2025-03-16T16:24:55Z | [https://hackage.haskell.org/package/polysemy-http](https://hackage.haskell.org/package/polysemy-http) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/polysemy-http` at `2026-09-07T00:34:32+00:00`.
...
- `hackage_top_downloads-f4e80f7d8360f2` from `hackage_top_downloads` as `registry_expansion`
