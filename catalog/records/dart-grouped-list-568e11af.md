...
<!-- canonical: https://pub.dev/packages/grouped_list -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/grouped_list](https://pub.dev/packages/grouped_list) |
| Source record ids | pub_dev-9f632b47232d2a |
...
For a systems engineer, grouped_list belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2024-06-27T14:35:22.518753Z | [https://pub.dev/api/packages/grouped_list](https://pub.dev/api/packages/grouped_list) |  |
| preview | known | 4.0.0-nullsafety.1 | 2020-11-20T17:20:46.372658Z | [https://pub.dev/api/packages/grouped_list](https://pub.dev/api/packages/grouped_list) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/grouped_list` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-9f632b47232d2a` from `pub_dev` as `registry_expansion`
