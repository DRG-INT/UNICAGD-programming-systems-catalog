...
<!-- canonical: https://hackage.haskell.org/package/rpmbuild-order -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/rpmbuild-order](https://hackage.haskell.org/package/rpmbuild-order) |
| Source record ids | hackage_top_downloads-7477573a04ba9e |
...
For a systems engineer, rpmbuild-order belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.13 | 2025-11-10T17:40:09Z | [https://hackage.haskell.org/package/rpmbuild-order](https://hackage.haskell.org/package/rpmbuild-order) |  |
| candidate | partial | 0.1 |  | [https://hackage.haskell.org/package/rpmbuild-order](https://hackage.haskell.org/package/rpmbuild-order) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/rpmbuild-order` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-7477573a04ba9e` from `hackage_top_downloads` as `registry_expansion`
