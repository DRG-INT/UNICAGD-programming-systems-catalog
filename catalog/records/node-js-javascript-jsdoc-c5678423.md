...
| Source record ids | corpus-43d9d95459147d |

## System Engineer Summary

JSDoc is tracked as a documentation record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, JSDoc belongs in the Node.js/JavaScript inventory as part of operator
...
- `corpus-43d9d95459147d` from `master_json` as `documentation`
