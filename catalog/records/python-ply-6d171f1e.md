...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-56c980a64297e2 |

## System Engineer Summary

PLY is tracked as a parser lexer ast record in the Python branch. The source did not provide a long
...
For a systems engineer, PLY belongs in the Python inventory as part of language tooling, code
...
- `corpus-56c980a64297e2` from `master_json` as `parser_lexer_ast`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ast | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-ast-08287a59.md) |
| Lark | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-lark-04cc3762.md) |
| LibCST | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-libcst-3e40009b.md) |
| parso | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-parso-8aea2d62.md) |
| Pygments | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pygments-653cfeec.md) |
| pyparsing | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pyparsing-57ca9205.md) |
| tree-sitter Python | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-tree-sitter-python-c6ae4540.md) |
