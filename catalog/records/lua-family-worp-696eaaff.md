...
<!-- canonical: http://worp.zevv.nl/about.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://worp.zevv.nl/about.html](http://worp.zevv.nl/about.html) |
| Source record ids | lua-source-232 |
...
For a systems engineer, Worp belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 232}}` |
...
- `lua-source-232` from `master_json` as `source_list_item`
