...
<!-- canonical: https://github.com/DanTheMan827/ios-app-signer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DanTheMan827/ios-app-signer](https://github.com/DanTheMan827/ios-app-signer) |
| Source record ids | github_search_cocoa-7d4e78a5b6caee |

## System Engineer Summary

This is an app for OS X that can (re)sign apps and bundle them into ipa files that are ready to be
installed on an iOS device.

## Operational Role

For a systems engineer, DanTheMan827/ios-app-signer belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-01T00:42:47Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-7d4e78a5b6caee` from `github_search_cocoa` as `registry_expansion`
