...
<!-- canonical: https://pub.dev/packages/jaspr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/jaspr](https://pub.dev/packages/jaspr) |
| Source record ids | pub_dev-566dbab51d2d2c |

## System Engineer Summary

A modern web framework for building websites in Dart that feels like Flutter but supports server-
side rendering.

## Operational Role

For a systems engineer, jaspr belongs in the Dart inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.4 | 2026-08-14T14:51:01.756126Z | [https://pub.dev/api/packages/jaspr](https://pub.dev/api/packages/jaspr) |  |
| preview | known | 0.22.0-beta.1 | 2025-12-05T14:33:19.758950Z | [https://pub.dev/api/packages/jaspr](https://pub.dev/api/packages/jaspr) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/jaspr` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-566dbab51d2d2c` from `pub_dev` as `registry_expansion`
