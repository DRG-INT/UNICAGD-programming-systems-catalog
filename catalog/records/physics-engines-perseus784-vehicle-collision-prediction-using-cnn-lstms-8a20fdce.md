...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/perseus784/Vehicle_Collision_Prediction_Using_CNN-LSTMs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/perseus784/Vehicle_Collision_Prediction_Using_CNN-LSTMs](https://github.com/perseus784/Vehicle_Collision_Prediction_Using_CNN-LSTMs) |
| Source record ids | github_search_physics_engines-7629d59e4ee805 |

## System Engineer Summary

Predict Vehicle collision moments before it happens in Carla!. CNN and LSTM hybrid architecture is
used to understand a series of images.

## Operational Role

For a systems engineer, perseus784/Vehicle_Collision_Prediction_Using_CNN-LSTMs belongs in the
Physics Engines inventory as part of ecosystem capability mapping, dependency review, release
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-26T14:19:09Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7629d59e4ee805` from `github_search_physics_engines` as `registry_expansion`
