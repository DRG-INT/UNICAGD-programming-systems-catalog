...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/adugnag/deSpeckNet-TF-GEE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adugnag/deSpeckNet-TF-GEE](https://github.com/adugnag/deSpeckNet-TF-GEE) |
| Source record ids | github_search_radars-6e00debed661eb |

## System Engineer Summary

This implementation uses python to seamlessly integrate Sentinel-1 SAR image preparation in GEE with
deep learning in Tensorflow for SAR image despeckling.

## Operational Role

For a systems engineer, adugnag/deSpeckNet-TF-GEE belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-24T17:38:58Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-6e00debed661eb` from `github_search_radars` as `registry_expansion`
