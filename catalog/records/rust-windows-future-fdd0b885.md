...
<!-- canonical: https://crates.io/crates/windows-future -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-future](https://crates.io/crates/windows-future) |
| Source record ids | crates_io-3a3ce55f8e66ec |

## System Engineer Summary

windows-future is tracked as an async runtime record in the Rust branch. The source did not provide
...
For a systems engineer, windows-future belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:44:03.555455Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Chr.Avro.Json/10.13.1/license |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-06T00:31:58+00:00`.
...
- `crates_io-3a3ce55f8e66ec` from `crates_io` as `registry_expansion`
