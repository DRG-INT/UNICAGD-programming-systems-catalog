...
<!-- canonical: https://github.com/HybridRobotics/NMPC-DCLF-DCBF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HybridRobotics/NMPC-DCLF-DCBF](https://github.com/HybridRobotics/NMPC-DCLF-DCBF) |
| Source record ids | github_search_matlab-f8053738810a31 |

## System Engineer Summary

A collection of work using nonlinear model predictive control (NMPC) with discrete-time control
Lyapunov functions (CLFs) and control barrier functions (CBFs)

## Operational Role

For a systems engineer, HybridRobotics/NMPC-DCLF-DCBF belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-09T10:49:58Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_matlab-f8053738810a31` from `github_search_matlab` as `registry_expansion`
