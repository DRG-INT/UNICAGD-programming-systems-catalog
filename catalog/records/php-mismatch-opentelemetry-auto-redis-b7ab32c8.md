...
<!-- canonical: https://packagist.org/packages/mismatch/opentelemetry-auto-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mismatch/opentelemetry-auto-redis](https://packagist.org/packages/mismatch/opentelemetry-auto-redis) |
| Source record ids | packagist_search-64ed678789e398 |
...
For a systems engineer, mismatch/opentelemetry-auto-redis belongs in the PHP inventory as part of
...
- `packagist_search-64ed678789e398` from `packagist_search` as `registry_expansion`
