...
<!-- canonical: https://github.com/avivbrook/Intel-Assembly-Language-Programming-Exercises -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avivbrook/Intel-Assembly-Language-Programming-Exercises](https://github.com/avivbrook/Intel-Assembly-Language-Programming-Exercises) |
| Source record ids | github_search_assembly-6f46d5579d00c2 |

## System Engineer Summary

Solutions to programming exercises from Assembly Language for x86 Processors (7th Edition) by Kip
Irvine.

## Operational Role

For a systems engineer, avivbrook/Intel-Assembly-Language-Programming-Exercises belongs in the
Assembly inventory as part of ecosystem capability mapping, dependency review, release awareness,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-26T01:29:32Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6f46d5579d00c2` from `github_search_assembly` as `registry_expansion`
