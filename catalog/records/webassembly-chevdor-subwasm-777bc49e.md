...
<!-- canonical: https://github.com/chevdor/subwasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chevdor/subwasm](https://github.com/chevdor/subwasm) |
| Source record ids | github_search_webassembly-2344041d78ebb5 |

## System Engineer Summary

Subwasm is a cli utility to look inside a Substrate WASM Runtime. It can inspect and compare the
metadata of Substrate based runtimes such as Polkadot or Kusama.

## Operational Role

For a systems engineer, chevdor/subwasm belongs in the WebAssembly inventory as part of runtime
...
- `github_search_webassembly-2344041d78ebb5` from `github_search_webassembly` as `registry_expansion`
