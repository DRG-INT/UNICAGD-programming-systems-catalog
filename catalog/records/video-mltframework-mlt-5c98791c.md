...
| Canonical URL | [https://github.com/mltframework/mlt](https://github.com/mltframework/mlt) |
| Source record ids | github_search_video-dc4274bf33cece |
...
For a systems engineer, mltframework/mlt belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.40.0 | 2026-06-25T00:45:34Z | [https://api.github.com/repos/mltframework/mlt/releases/latest](https://api.github.com/repos/mltframework/mlt/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mltframework/mlt/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-dc4274bf33cece` from `github_search_video` as `registry_expansion`
