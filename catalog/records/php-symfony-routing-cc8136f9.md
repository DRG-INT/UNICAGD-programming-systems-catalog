...
<!-- canonical: https://packagist.org/packages/symfony/routing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/routing](https://packagist.org/packages/symfony/routing) |
| Source record ids | packagist_search-5eee26d663a193 |
...
For a systems engineer, symfony/routing belongs in the PHP inventory as part of service
...
- `packagist_search-5eee26d663a193` from `packagist_search` as `registry_expansion`
