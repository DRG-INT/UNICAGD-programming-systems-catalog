...
<!-- canonical: https://pub.dev/packages/file_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/file_picker](https://pub.dev/packages/file_picker) |
| Source record ids | pub_dev-d1e0503e8ddb7b |

## System Engineer Summary

A package that allows you to use a native file explorer to pick single or multiple absolute file
paths, with extension filtering support.

## Operational Role

For a systems engineer, file_picker belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 12.2.0 | 2026-09-02T17:14:23.398551Z | [https://pub.dev/api/packages/file_picker](https://pub.dev/api/packages/file_picker) |  |
| preview | known | 12.0.0-beta.7 | 2026-06-17T13:17:25.440978Z | [https://pub.dev/api/packages/file_picker](https://pub.dev/api/packages/file_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/file_picker` at `2026-09-02T17:18:42+00:00`.
...
- `pub_dev-d1e0503e8ddb7b` from `pub_dev` as `registry_expansion`
