...
<!-- canonical: https://pub.dev/packages/location -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/location](https://pub.dev/packages/location) |
| Source record ids | pub_dev-54f93607a9bf2b |
...
For a systems engineer, location belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.2 | 2026-07-23T14:01:26.810867Z | [https://pub.dev/api/packages/location](https://pub.dev/api/packages/location) |  |
| preview | known | 5.0.0-dev.8 | 2022-06-24T13:29:07.696273Z | [https://pub.dev/api/packages/location](https://pub.dev/api/packages/location) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/location` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-54f93607a9bf2b` from `pub_dev` as `registry_expansion`
