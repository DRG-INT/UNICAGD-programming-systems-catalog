...
| Canonical URL | [https://github.com/bazelbuild/rules_docker](https://github.com/bazelbuild/rules_docker) |
| Source record ids | github_search_starlark-636389bdd89de3 |
...
For a systems engineer, bazelbuild/rules_docker belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.26.0 | 2025-12-22T00:24:32Z | [https://api.github.com/repos/bazelbuild/rules_docker/releases/latest](https://api.github.com/repos/bazelbuild/rules_docker/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazelbuild/rules_docker/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-636389bdd89de3` from `github_search_starlark` as `registry_expansion`
