# pnadig/cloud-hana-search-demo

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pnadig/cloud-hana-search-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pnadig/cloud-hana-search-demo](https://github.com/pnadig/cloud-hana-search-demo) |
| Source record ids | github_search_sapjava-869c627c24495e |

## System Engineer Summary

This sample web application demonstrates how-to use native SAP HANA search (fuzzy and linguistic) in
Java applications running on SAP HANA Cloud Platform. #cloud-sample

## Operational Role

For a systems engineer, pnadig/cloud-hana-search-demo belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-01-31T10:52:36Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-869c627c24495e` from `github_search_sapjava` as `registry_expansion`
