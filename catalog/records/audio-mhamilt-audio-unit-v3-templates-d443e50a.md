# mhamilt/Audio-Unit-V3-Templates

## Navigation

[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mhamilt/Audio-Unit-V3-Templates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mhamilt/Audio-Unit-V3-Templates](https://github.com/mhamilt/Audio-Unit-V3-Templates) |
| Source record ids | github_search_audio-a18623efcb4a1a |
...
For a systems engineer, mhamilt/Audio-Unit-V3-Templates belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-06T09:10:39Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-a18623efcb4a1a` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Torsion-Audio/nn-inference-template | Project Scaffolding | [open](audio-torsion-audio-nn-inference-template-e91ec016.md) |
