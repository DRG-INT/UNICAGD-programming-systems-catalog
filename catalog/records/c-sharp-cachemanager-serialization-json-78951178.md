...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Standard Library](../by-category/standard-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/CacheManager.Serialization.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/CacheManager.Serialization.Json](https://www.nuget.org/packages/CacheManager.Serialization.Json) |
| Source record ids | nuget_search-8b9512e33db86a |

## System Engineer Summary

CacheManager extension package providing JSON serialization for distributed caches. CacheManager is
an open source caching abstraction layer for .NET written in C#. It supports various cache providers
and implements many advanced features. The Core library contains a Newtonsoft.Json based serializer
implementation which can be used instead of the default binary serializer.

## Operational Role

For a systems engineer, CacheManager.Serialization.Json belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-02-18T08:16:57.697+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/cachemanager.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/cachemanager.serialization.json/index.json) |  |
| preview | known | 3.0.0-beta-20251110.1 | 2025-11-10T13:53:56.423+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/cachemanager.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/cachemanager.serialization.json/index.json) |  |
...
| Evidence | Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache-2.0; https://www.nuget.org/packages/CacheManager.Serialization.Json/3.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/cachemanager.serialization.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-8b9512e33db86a` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Nethereum.JsonRpc.Client | Standard Library | [open](c-sharp-nethereum-jsonrpc-client-3a917ae4.md) |
