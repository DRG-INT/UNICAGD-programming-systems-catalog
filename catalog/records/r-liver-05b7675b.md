...
<!-- canonical: https://cran.r-project.org/web/packages/liver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/liver/index.html](https://cran.r-project.org/web/packages/liver/index.html) |
| Source record ids | cran_packages_by_date-41809062c1876a |
...
For a systems engineer, liver belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.30 | 2026-09-10 13:50:02 UTC | [https://cran.r-project.org/web/packages/liver/DESCRIPTION](https://cran.r-project.org/web/packages/liver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/liver/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-41809062c1876a` from `cran_packages_by_date` as `registry_expansion`
...
| fozziejoin | Data Science | [open](r-fozziejoin-60790e9f.md) |
