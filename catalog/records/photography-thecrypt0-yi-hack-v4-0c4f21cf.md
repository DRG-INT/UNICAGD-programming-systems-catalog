...
<!-- canonical: https://github.com/TheCrypt0/yi-hack-v4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheCrypt0/yi-hack-v4](https://github.com/TheCrypt0/yi-hack-v4) |
| Source record ids | github_search_photography-e047e98325a0de |

## System Engineer Summary

New Custom Firmware for Xiaomi Cameras based on Hi3518e Chipset. It features RTSP, SSH, FTP and
more!

## Operational Role

For a systems engineer, TheCrypt0/yi-hack-v4 belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-16T13:12:08Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-e047e98325a0de` from `github_search_photography` as `registry_expansion`
