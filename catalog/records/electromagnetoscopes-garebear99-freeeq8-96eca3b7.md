...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GareBear99/FreeEQ8 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GareBear99/FreeEQ8](https://github.com/GareBear99/FreeEQ8) |
| Source record ids | github_search_electromagnetoscopes-b9f5b92d2476db |

## System Engineer Summary

FreeEQ8 is a professional-grade, free and open-source 8-band parametric EQ plugin for macOS, Linux,
and Windows. Linear phase, dynamic EQ, match EQ, per-band drive, band linking, M/S processing,
oversampling, and a real-time spectrum analyzer. FabFilter Pro-Q alternative for $0–$20

## Operational Role

For a systems engineer, GareBear99/FreeEQ8 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T07:51:58Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:spectrum-analyzer stars:>10", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-b9f5b92d2476db` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xastro/Cognitive-Radio-Network | Static Analyzer | [open](electromagnetoscopes-0xastro-cognitive-radio-network-9a5f6a5f.md) |
| 4321ba/MeloMIDI | Static Analyzer | [open](electromagnetoscopes-4321ba-melomidi-9221346a.md) |
| aguaviva/Spectrogrammer | Static Analyzer | [open](electromagnetoscopes-aguaviva-spectrogrammer-1d5bd0c2.md) |
| alexysong/inkstone | Static Analyzer | [open](electromagnetoscopes-alexysong-inkstone-79227081.md) |
| analogdevicesinc/m2k-fw | Static Analyzer | [open](electromagnetoscopes-analogdevicesinc-m2k-fw-abe3f0ff.md) |
| andremichelle/malachite | Static Analyzer | [open](electromagnetoscopes-andremichelle-malachite-8e6c9ad4.md) |
| baggepinnen/LPVSpectral.jl | Static Analyzer | [open](electromagnetoscopes-baggepinnen-lpvspectral-jl-535c57bf.md) |
| chuot/rdio-scanner | Static Analyzer | [open](electromagnetoscopes-chuot-rdio-scanner-3a797b17.md) |
