...
| Source record ids | github_search_telescopes-f36da9725184ad |

## System Engineer Summary

yt-project/yt is tracked as a parser lexer ast record in the Telescopes branch. The source did not
...
For a systems engineer, yt-project/yt belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | yt-4.4.2 | 2025-11-18T17:10:31Z | [https://api.github.com/repos/yt-project/yt/releases/latest](https://api.github.com/repos/yt-project/yt/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/yt-project/yt/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_telescopes-f36da9725184ad` from `github_search_telescopes` as `registry_expansion`
