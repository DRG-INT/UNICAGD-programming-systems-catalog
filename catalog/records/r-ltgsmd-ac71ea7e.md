...
<!-- canonical: https://cran.r-project.org/web/packages/ltgsmd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ltgsmd/index.html](https://cran.r-project.org/web/packages/ltgsmd/index.html) |
| Source record ids | cran_packages_by_date-fe03f7f2db84e7 |

## System Engineer Summary

Latent True-Score and Target-Population Anchored Geometric SMD

## Operational Role

For a systems engineer, ltgsmd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-02 11:30:09 UTC | [https://cran.r-project.org/web/packages/ltgsmd/DESCRIPTION](https://cran.r-project.org/web/packages/ltgsmd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ltgsmd/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-fe03f7f2db84e7` from `cran_packages_by_date` as `registry_expansion`
