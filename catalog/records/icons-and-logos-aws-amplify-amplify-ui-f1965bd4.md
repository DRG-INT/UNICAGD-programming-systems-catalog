...
<!-- canonical: https://github.com/aws-amplify/amplify-ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aws-amplify/amplify-ui](https://github.com/aws-amplify/amplify-ui) |
| Source record ids | github_search_icons_and_logos-9fb3b31015ae24 |

## System Engineer Summary

Amplify UI is a collection of accessible, themeable, performant React (and more!) components that
can connect directly to the cloud.

## Operational Role

For a systems engineer, aws-amplify/amplify-ui belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T00:45:41Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-9fb3b31015ae24` from `github_search_icons_and_logos` as `registry_expansion`
