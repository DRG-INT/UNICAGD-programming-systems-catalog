...
<!-- canonical: https://crates.io/crates/serde_core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_core](https://crates.io/crates/serde_core) |
| Source record ids | crates_io-473f58c46b4444 |
...
For a systems engineer, serde_core belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.229 | 2026-07-18T23:05:10.896830Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-10T20:18:27+00:00`.
...
- `crates_io-473f58c46b4444` from `crates_io` as `registry_expansion`
