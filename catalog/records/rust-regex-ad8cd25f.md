...
<!-- canonical: https://crates.io/crates/regex -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-5fabc21a0d658e |
...
For a systems engineer, regex belongs in the Rust inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.1 | 2026-07-15T20:19:35.162139Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-5fabc21a0d658e` from `crates_io` as `registry_expansion`
