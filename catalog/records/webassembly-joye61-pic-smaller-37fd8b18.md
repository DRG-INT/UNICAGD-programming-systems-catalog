...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/joye61/pic-smaller -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joye61/pic-smaller](https://github.com/joye61/pic-smaller) |
| Source record ids | github_search_webassembly-014321b3937706 |
...
For a systems engineer, joye61/pic-smaller belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T09:56:16Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-014321b3937706` from `github_search_webassembly` as `registry_expansion`
