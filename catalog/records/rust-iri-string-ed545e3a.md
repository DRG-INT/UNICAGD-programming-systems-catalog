...
<!-- canonical: https://crates.io/crates/iri-string -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/iri-string](https://crates.io/crates/iri-string) |
| Source record ids | crates_io-dfeb18aa82d24f |

## System Engineer Summary

iri-string is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, iri-string belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.14 | 2026-07-26T20:45:29.877603Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-dfeb18aa82d24f` from `crates_io` as `registry_expansion`
