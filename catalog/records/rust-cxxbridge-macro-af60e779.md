...
<!-- canonical: https://crates.io/crates/cxxbridge-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cxxbridge-macro](https://crates.io/crates/cxxbridge-macro) |
| Source record ids | crates_io-8cd5b53143e9dc |
...
For a systems engineer, cxxbridge-macro belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.199 | 2026-08-08T06:53:11.452744Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-8cd5b53143e9dc` from `crates_io` as `registry_expansion`
