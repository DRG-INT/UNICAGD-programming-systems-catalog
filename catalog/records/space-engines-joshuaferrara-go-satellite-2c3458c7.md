...
| Canonical URL | [https://github.com/joshuaferrara/go-satellite](https://github.com/joshuaferrara/go-satellite) |
| Source record ids | github_search_space_engines-fdbcacd4707dde |
...
For a systems engineer, joshuaferrara/go-satellite belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2022-06-11T18:08:22Z | [https://api.github.com/repos/joshuaferrara/go-satellite/releases/latest](https://api.github.com/repos/joshuaferrara/go-satellite/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/joshuaferrara/go-satellite/releases/latest` at `2026-09-01T07:24:18+00:00`.
...
- `github_search_space_engines-fdbcacd4707dde` from `github_search_space_engines` as `registry_expansion`
