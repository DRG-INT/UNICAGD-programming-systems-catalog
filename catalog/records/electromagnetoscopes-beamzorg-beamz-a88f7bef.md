...
<!-- canonical: https://github.com/beamzorg/beamz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/beamzorg/beamz](https://github.com/beamzorg/beamz) |
| Source record ids | github_search_electromagnetoscopes-c2d781742a12e1 |

## System Engineer Summary

GPU-accelerated electromagnetic FDTD for large-scale simulations, compact modeling and inverse
design / gradient-based optimization of nanophotonic devices with Python.

## Operational Role

For a systems engineer, beamzorg/beamz belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:34:31Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c2d781742a12e1` from `github_search_electromagnetoscopes` as `registry_expansion`
