...
<!-- canonical: https://cran.r-project.org/web/packages/pdynmc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pdynmc/index.html](https://cran.r-project.org/web/packages/pdynmc/index.html) |
| Source record ids | cran_packages_by_date-720c4cc74c07d6 |
...
For a systems engineer, pdynmc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.13 | 2026-09-14 21:40:02 UTC | [https://cran.r-project.org/web/packages/pdynmc/DESCRIPTION](https://cran.r-project.org/web/packages/pdynmc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pdynmc/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-720c4cc74c07d6` from `cran_packages_by_date` as `registry_expansion`
