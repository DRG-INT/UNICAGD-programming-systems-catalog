...
<!-- canonical: https://cran.r-project.org/web/packages/SimInf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SimInf/index.html](https://cran.r-project.org/web/packages/SimInf/index.html) |
| Source record ids | cran_packages_by_date-4de674b10e2bbd |
...
For a systems engineer, SimInf belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.1.0 | 2026-09-08 17:00:16 UTC | [https://cran.r-project.org/web/packages/SimInf/DESCRIPTION](https://cran.r-project.org/web/packages/SimInf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SimInf/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-4de674b10e2bbd` from `cran_packages_by_date` as `registry_expansion`
