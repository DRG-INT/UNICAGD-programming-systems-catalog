...
| Source record ids | curated_language_routes-fd34314fb931b4 |

## System Engineer Summary

Cross-platform game engine and framework for 2D games and native runtimes.

## Operational Role

For a systems engineer, Cocos2d-x belongs in the Game Engines inventory as part of ecosystem
...
- `curated_language_routes-fd34314fb931b4` from `curated_language_routes` as `registry_expansion`
