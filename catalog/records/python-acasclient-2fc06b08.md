...
<!-- canonical: https://pypi.org/project/acasclient/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acasclient/](https://pypi.org/project/acasclient/) |
| Source record ids | pypi_simple-fa8b0aa5f0c3c4 |

## System Engineer Summary

acasclient is tracked as a networking http record in the Python branch. The source did not provide a
...
For a systems engineer, acasclient belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.3.0 | 2026-07-30T22:22:11.506528Z | [https://pypi.org/pypi/acasclient/json](https://pypi.org/pypi/acasclient/json) |  |
...
| Evidence | GNU General Public License v3; License :: OSI Approved :: GNU General Public License v3 (GPLv3) |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acasclient/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-fa8b0aa5f0c3c4` from `pypi_simple` as `registry_expansion`
