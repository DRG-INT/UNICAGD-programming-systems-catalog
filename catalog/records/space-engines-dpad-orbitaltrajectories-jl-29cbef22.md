...
| Canonical URL | [https://github.com/dpad/OrbitalTrajectories.jl](https://github.com/dpad/OrbitalTrajectories.jl) |
| Source record ids | github_search_space_engines-6cc2963341148b |

## System Engineer Summary

OrbitalTrajectories.jl is a modern orbital trajectory design, optimisation, and analysis library for
Julia, providing methods and tools for designing spacecraft orbits and transfers via high-
performance simulations of astrodynamical models.

## Operational Role

For a systems engineer, dpad/OrbitalTrajectories.jl belongs in the Space Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.14 | 2021-06-28T14:28:50Z | [https://api.github.com/repos/dpad/OrbitalTrajectories.jl/releases/latest](https://api.github.com/repos/dpad/OrbitalTrajectories.jl/releases/latest) |  |
| preview | known | v0.2.0dev | 2021-08-03T05:30:48Z | [https://api.github.com/repos/dpad/OrbitalTrajectories.jl/releases?per_page=10](https://api.github.com/repos/dpad/OrbitalTrajectories.jl/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dpad/OrbitalTrajectories.jl/releases/latest` at `2026-09-01T07:24:17+00:00`.
...
- `github_search_space_engines-6cc2963341148b` from `github_search_space_engines` as `registry_expansion`
