...
<!-- canonical: https://gitea.com/deepim/flatbuffers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/deepim/flatbuffers](https://gitea.com/deepim/flatbuffers) |
| Source record ids | gitea_repositories_api-291b81494c2ec8 |
...
For a systems engineer, Gitea: deepim/flatbuffers belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-09T13:09:13Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-291b81494c2ec8` from `gitea_repositories_api` as `registry_expansion`
...
| mdkrush/openclaw-true-recall-base | Memory Analyzer | [open](repository-workplaces-mdkrush-openclaw-true-recall-base-5df5ba43.md) |
