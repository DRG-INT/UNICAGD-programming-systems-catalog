# MasterOgon/Aeroacoustic-Flying-Saucer-Oscillating-Resonator-CFD-Simulation-LBM-
...
<!-- canonical: https://github.com/MasterOgon/Aeroacoustic-Flying-Saucer-Oscillating-Resonator-CFD-Simulation-LBM- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MasterOgon/Aeroacoustic-Flying-Saucer-Oscillating-Resonator-CFD-Simulation-LBM-](https://github.com/MasterOgon/Aeroacoustic-Flying-Saucer-Oscillating-Resonator-CFD-Simulation-LBM-) |
| Source record ids | github_search_space_engines-8190089067491c |

## System Engineer Summary

CFD simulation of an aeroacoustic oscillating resonator using the Lattice Boltzmann Method (D2Q9).
Visualise thrust generation via dynamic boundary layer and asymmetric fluid resistance accumulation.

## Operational Role

For a systems engineer, MasterOgon/Aeroacoustic-Flying-Saucer-Oscillating-Resonator-CFD-Simulation-
LBM- belongs in the Space Engines inventory as part of language tooling, code generation, static
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T16:53:55Z | gh search repos topic:propulsion stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-8190089067491c` from `github_search_space_engines` as `registry_expansion`
