...
<!-- canonical: https://cran.r-project.org/web/packages/terra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/terra/index.html](https://cran.r-project.org/web/packages/terra/index.html) |
| Source record ids | cran_packages_by_date-fdc7476ec76205 |

## System Engineer Summary

terra is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, terra belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9-46 | 2026-08-22 16:30:02 UTC | [https://cran.r-project.org/web/packages/terra/DESCRIPTION](https://cran.r-project.org/web/packages/terra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/terra/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fdc7476ec76205` from `cran_packages_by_date` as `registry_expansion`
