...
| Canonical URL | [https://github.com/TheWand3rer/Universe](https://github.com/TheWand3rer/Universe) |
| Source record ids | github_search_space_engines-f4ac1b6beb3186 |

## System Engineer Summary

A Unity library of space-related methods for hard sci-fi games.

## Operational Role

For a systems engineer, TheWand3rer/Universe belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.3.0 | 2026-06-03T18:22:01Z | [https://api.github.com/repos/TheWand3rer/Universe/releases/latest](https://api.github.com/repos/TheWand3rer/Universe/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/TheWand3rer/Universe/releases/latest` at `2026-09-01T07:24:20+00:00`.
...
- `github_search_space_engines-f4ac1b6beb3186` from `github_search_space_engines` as `registry_expansion`
