...
<!-- canonical: https://gitlab.com/freepascal.org/fpc/source -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/freepascal.org/fpc/source](https://gitlab.com/freepascal.org/fpc/source) |
| Source record ids | gitlab_projects_api-e226aaea35e70e |

## System Engineer Summary

The sources of the Free Pascal compiler, RTL, packages and utilities. See for more info.

## Operational Role

For a systems engineer, freepascal.org/fpc/source belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-e226aaea35e70e` from `gitlab_projects_api` as `registry_expansion`
