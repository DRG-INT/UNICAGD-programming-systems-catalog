...
<!-- canonical: https://github.com/complexphoton/MESTI.m -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/complexphoton/MESTI.m](https://github.com/complexphoton/MESTI.m) |
| Source record ids | github_search_electromagnetoscopes-646ca826c82794 |

## System Engineer Summary

2D multi-source electromagnetic simulations in frequency domain, implementing the augmented partial
factorization (APF) and other methods.

## Operational Role

For a systems engineer, complexphoton/MESTI.m belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-09T06:41:07Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-646ca826c82794` from `github_search_electromagnetoscopes` as `registry_expansion`
