...
<!-- canonical: https://github.com/kubernetes/minikube -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kubernetes/minikube](https://github.com/kubernetes/minikube) |
| Source record ids | github_search_go-eb31201536cb73 |

## System Engineer Summary

kubernetes/minikube is tracked as a language specification record in the Go branch. The source did
...
For a systems engineer, kubernetes/minikube belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T10:33:52Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-eb31201536cb73` from `github_search_go` as `registry_expansion`
