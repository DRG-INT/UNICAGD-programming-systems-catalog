...
<!-- canonical: https://github.com/mapbox/tippecanoe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mapbox/tippecanoe](https://github.com/mapbox/tippecanoe) |
| Source record ids | github_search_maps-d667269cdab4b3 |
...
For a systems engineer, mapbox/tippecanoe belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T15:20:27Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2); Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_maps-d667269cdab4b3` from `github_search_maps` as `registry_expansion`
