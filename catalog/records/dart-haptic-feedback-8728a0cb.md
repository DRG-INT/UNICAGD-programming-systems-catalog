...
<!-- canonical: https://pub.dev/packages/haptic_feedback -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/haptic_feedback](https://pub.dev/packages/haptic_feedback) |
| Source record ids | pub_dev-8e9fad828c88cb |

## System Engineer Summary

A Flutter plugin for haptic feedback. While it utilizes standard iOS haptics, it aims to emulate
these same haptic patterns on Android for a consistent experience across platforms.

## Operational Role

For a systems engineer, haptic_feedback belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-07-10T00:35:01.748128Z | [https://pub.dev/api/packages/haptic_feedback](https://pub.dev/api/packages/haptic_feedback) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/haptic_feedback` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-8e9fad828c88cb` from `pub_dev` as `registry_expansion`
