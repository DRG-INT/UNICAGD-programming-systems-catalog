...
<!-- canonical: https://crates.io/crates/ctor-proc-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ctor-proc-macro](https://crates.io/crates/ctor-proc-macro) |
| Source record ids | crates_io-46e1a12393f235 |
...
For a systems engineer, ctor-proc-macro belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.13 | 2026-04-22T21:17:17.694455Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-05T12:22:41+00:00`.
...
- `crates_io-46e1a12393f235` from `crates_io` as `registry_expansion`
