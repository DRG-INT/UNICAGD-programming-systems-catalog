# alanjvano/ChessOpeningRepertoire
...
<!-- canonical: https://github.com/alanjvano/ChessOpeningRepertoire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alanjvano/ChessOpeningRepertoire](https://github.com/alanjvano/ChessOpeningRepertoire) |
| Source record ids | github_search_repertoare_catalogs-e8dc16ed3a69a0 |
...
For a systems engineer, alanjvano/ChessOpeningRepertoire belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-11-27T03:12:09Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-e8dc16ed3a69a0` from `github_search_repertoare_catalogs` as `registry_expansion`
