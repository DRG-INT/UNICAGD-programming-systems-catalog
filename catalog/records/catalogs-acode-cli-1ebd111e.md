...
<!-- canonical: https://github.com/acode/cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acode/cli](https://github.com/acode/cli) |
| Source record ids | github_search_catalogs-cc5ebad9452f21 |
...
For a systems engineer, acode/cli belongs in the Catalogs inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-21T07:08:12Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-cc5ebad9452f21` from `github_search_catalogs` as `registry_expansion`
