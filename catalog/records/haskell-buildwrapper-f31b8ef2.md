...
<!-- canonical: https://hackage.haskell.org/package/buildwrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/buildwrapper](https://hackage.haskell.org/package/buildwrapper) |
| Source record ids | hackage_top_downloads-0ffd346a0dbb1d |
...
For a systems engineer, buildwrapper belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2015-01-26T16:39:09Z | [https://hackage.haskell.org/package/buildwrapper](https://hackage.haskell.org/package/buildwrapper) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/buildwrapper` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-0ffd346a0dbb1d` from `hackage_top_downloads` as `registry_expansion`
