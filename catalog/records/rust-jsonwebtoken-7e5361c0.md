...
<!-- canonical: https://crates.io/crates/jsonwebtoken -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/jsonwebtoken](https://crates.io/crates/jsonwebtoken) |
| Source record ids | crates_io-13784c6d8da82f |
...
For a systems engineer, jsonwebtoken belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-07-24T10:59:32.987519Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-13784c6d8da82f` from `crates_io` as `registry_expansion`
