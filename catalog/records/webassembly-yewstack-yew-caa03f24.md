...
<!-- canonical: https://github.com/yewstack/yew -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yewstack/yew](https://github.com/yewstack/yew) |
| Source record ids | github_search_webassembly-8ef0cdd0f44609 |
...
For a systems engineer, yewstack/yew belongs in the WebAssembly inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T03:20:35Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-8ef0cdd0f44609` from `github_search_webassembly` as `registry_expansion`
...
| electric-sql/pglite | Ffi Bindings | [open](webassembly-electric-sql-pglite-3582082e.md) |
