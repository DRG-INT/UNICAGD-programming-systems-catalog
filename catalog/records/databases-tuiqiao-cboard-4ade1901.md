...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TuiQiao/CBoard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TuiQiao/CBoard](https://github.com/TuiQiao/CBoard) |
| Source record ids | github_search_databases-1a4efc41b1df8b |
...
For a systems engineer, TuiQiao/CBoard belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-06T02:29:12Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1a4efc41b1df8b` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| OElesin/querypal | Visualization Gui | [open](databases-oelesin-querypal-f4a469bb.md) |
| rootSunc/CNEquity | Visualization Gui | [open](databases-rootsunc-cnequity-120d106c.md) |
| slatedb/slatedb | Visualization Gui | [open](databases-slatedb-slatedb-840e5749.md) |
| zio/zio-protoquill | Visualization Gui | [open](databases-zio-zio-protoquill-4215be35.md) |
