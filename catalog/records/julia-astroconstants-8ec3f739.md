...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AstroConstants -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AstroConstants", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-887aae87b140bf` from `julia_general` as `registry_expansion`
