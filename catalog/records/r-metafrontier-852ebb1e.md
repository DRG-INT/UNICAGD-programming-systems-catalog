...
<!-- canonical: https://cran.r-project.org/web/packages/metafrontier/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metafrontier/index.html](https://cran.r-project.org/web/packages/metafrontier/index.html) |
| Source record ids | cran_packages_by_date-321261aa22934d |
...
For a systems engineer, metafrontier belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-19 11:40:02 UTC | [https://cran.r-project.org/web/packages/metafrontier/DESCRIPTION](https://cran.r-project.org/web/packages/metafrontier/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metafrontier/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-321261aa22934d` from `cran_packages_by_date` as `registry_expansion`
