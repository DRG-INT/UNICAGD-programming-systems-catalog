...
<!-- canonical: https://github.com/transact-rs/sqlx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/transact-rs/sqlx](https://github.com/transact-rs/sqlx) |
| Source record ids | github_search_databases-ea4e50a952f83b |
...
For a systems engineer, transact-rs/sqlx belongs in the Databases inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:52:47Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ea4e50a952f83b` from `github_search_databases` as `registry_expansion`
