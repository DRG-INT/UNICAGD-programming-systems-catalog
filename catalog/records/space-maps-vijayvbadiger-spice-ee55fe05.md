...
<!-- canonical: https://github.com/vijayvbadiger/spice- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vijayvbadiger/spice-](https://github.com/vijayvbadiger/spice-) |
| Source record ids | github_search_space_maps-b5cfe2119f78d7 |

## System Engineer Summary

my projects using spice kernel

## Operational Role

For a systems engineer, vijayvbadiger/spice- belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-21T20:22:39Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b5cfe2119f78d7` from `github_search_space_maps` as `registry_expansion`
