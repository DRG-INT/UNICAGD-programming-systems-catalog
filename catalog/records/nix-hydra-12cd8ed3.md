...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NixOS/hydra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NixOS/hydra](https://github.com/NixOS/hydra) |
| Source record ids | curated_language_routes-5ced717943d14c |

## System Engineer Summary

Nix-based continuous build system used for package and system build farms.

## Operational Role

For a systems engineer, Hydra belongs in the nix inventory as part of ecosystem capability mapping,
...
- `curated_language_routes-5ced717943d14c` from `curated_language_routes` as `registry_expansion`
