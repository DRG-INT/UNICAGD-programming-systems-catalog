...
<!-- canonical: https://github.com/Bauxitedev/godot-motion-blur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Bauxitedev/godot-motion-blur](https://github.com/Bauxitedev/godot-motion-blur) |
| Source record ids | github_search_effects-29affca2593aaa |
...
For a systems engineer, Bauxitedev/godot-motion-blur belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-01T10:41:57Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-29affca2593aaa` from `github_search_effects` as `registry_expansion`
