...
<!-- canonical: https://github.com/saschagrunert/git-journal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/saschagrunert/git-journal](https://github.com/saschagrunert/git-journal) |
| Source record ids | github_search_magazines-267b8f07ce8421 |
...
For a systems engineer, saschagrunert/git-journal belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-20T23:42:33Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-267b8f07ce8421` from `github_search_magazines` as `registry_expansion`
