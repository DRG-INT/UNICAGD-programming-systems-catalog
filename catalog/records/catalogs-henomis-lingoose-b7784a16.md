...
<!-- canonical: https://github.com/henomis/lingoose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/henomis/lingoose](https://github.com/henomis/lingoose) |
| Source record ids | github_search_catalogs-171d51dca8a490 |
...
For a systems engineer, henomis/lingoose belongs in the Catalogs inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-15T09:43:28Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-171d51dca8a490` from `github_search_catalogs` as `registry_expansion`
