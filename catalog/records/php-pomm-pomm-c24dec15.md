...
<!-- canonical: https://packagist.org/packages/pomm/pomm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pomm/pomm](https://packagist.org/packages/pomm/pomm) |
| Source record ids | packagist_search-715bdbf0626a3c |
...
For a systems engineer, pomm/pomm belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-715bdbf0626a3c` from `packagist_search` as `registry_expansion`
