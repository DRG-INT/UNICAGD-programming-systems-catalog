...
<!-- canonical: https://pub.dev/packages/youtube_player_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/youtube_player_flutter](https://pub.dev/packages/youtube_player_flutter) |
| Source record ids | pub_dev-98206e98368ae7 |

## System Engineer Summary

Flutter plugin for playing or streaming inline YouTube videos using the official iFrame player API.
Powered by youtube_player_iframe.

## Operational Role

For a systems engineer, youtube_player_flutter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.1 | 2026-05-30T19:55:50.265482Z | [https://pub.dev/api/packages/youtube_player_flutter](https://pub.dev/api/packages/youtube_player_flutter) |  |
| preview | known | 9.0.0-beta.0 | 2023-08-07T05:35:33.810880Z | [https://pub.dev/api/packages/youtube_player_flutter](https://pub.dev/api/packages/youtube_player_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/youtube_player_flutter` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-98206e98368ae7` from `pub_dev` as `registry_expansion`
