...
<!-- canonical: https://cran.r-project.org/web/packages/inti/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inti/index.html](https://cran.r-project.org/web/packages/inti/index.html) |
| Source record ids | cran_packages_by_date-c5473f2f0ba3a0 |
...
For a systems engineer, inti belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.3 | 2026-08-20 10:20:02 UTC | [https://cran.r-project.org/web/packages/inti/DESCRIPTION](https://cran.r-project.org/web/packages/inti/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inti/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c5473f2f0ba3a0` from `cran_packages_by_date` as `registry_expansion`
