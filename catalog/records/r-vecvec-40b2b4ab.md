...
<!-- canonical: https://cran.r-project.org/web/packages/vecvec/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vecvec/index.html](https://cran.r-project.org/web/packages/vecvec/index.html) |
| Source record ids | cran_packages_by_date-28b0939188f99c |
...
For a systems engineer, vecvec belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-20 14:20:08 UTC | [https://cran.r-project.org/web/packages/vecvec/DESCRIPTION](https://cran.r-project.org/web/packages/vecvec/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vecvec/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-28b0939188f99c` from `cran_packages_by_date` as `registry_expansion`
