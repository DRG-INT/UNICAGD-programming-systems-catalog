...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaComms](https://github.com/JuliaRegistries/General/tree/master/C/ClimaComms) |
| Source record ids | julia_general-c0259b68a78b21 |

## System Engineer Summary

Julia package registered in General at C/ClimaComms.

## Operational Role

For a systems engineer, ClimaComms belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaComms", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c0259b68a78b21` from `julia_general` as `registry_expansion`
