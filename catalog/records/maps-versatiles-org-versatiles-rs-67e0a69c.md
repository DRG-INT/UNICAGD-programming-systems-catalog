...
<!-- canonical: https://github.com/versatiles-org/versatiles-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/versatiles-org/versatiles-rs](https://github.com/versatiles-org/versatiles-rs) |
| Source record ids | github_search_maps-5bd2cddd2b5d74 |

## System Engineer Summary

Core Rust implementation of the VersaTiles toolkit for converting, validating, and serving map tiles
in multiple formats.

## Operational Role

For a systems engineer, versatiles-org/versatiles-rs belongs in the Maps inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:59:06Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5bd2cddd2b5d74` from `github_search_maps` as `registry_expansion`
