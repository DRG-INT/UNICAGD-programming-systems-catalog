...
| Canonical URL | [https://luarocks.org/modules/cosme12/haversine](https://luarocks.org/modules/cosme12/haversine) |
| Source record ids | luarocks_root_manifest-f8e4b7186779c3 |

## System Engineer Summary

Lua module for calculating the distance between two points on the Earth using the Haversine formula

## Operational Role

For a systems engineer, haversine belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f8e4b7186779c3` from `luarocks_root_manifest` as `registry_expansion`
