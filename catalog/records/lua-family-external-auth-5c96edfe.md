...
| Canonical URL | [https://luarocks.org/modules/pabloromanelli/external-auth](https://luarocks.org/modules/pabloromanelli/external-auth) |
| Source record ids | luarocks_root_manifest-4a1a687bafd8e4 |
...
For a systems engineer, external-auth belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-4a1a687bafd8e4` from `luarocks_root_manifest` as `registry_expansion`
