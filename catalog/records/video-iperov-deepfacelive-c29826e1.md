...
<!-- canonical: https://github.com/iperov/DeepFaceLive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iperov/DeepFaceLive](https://github.com/iperov/DeepFaceLive) |
| Source record ids | github_search_video-279ab025032a3f |
...
For a systems engineer, iperov/DeepFaceLive belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-08T03:07:42Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-279ab025032a3f` from `github_search_video` as `registry_expansion`
