...
| Canonical URL | [https://luarocks.org/modules/mirrexagon/irc-engine](https://luarocks.org/modules/mirrexagon/irc-engine) |
| Source record ids | luarocks_root_manifest-889e20beed01bf |
...
For a systems engineer, irc-engine belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-889e20beed01bf` from `luarocks_root_manifest` as `registry_expansion`
