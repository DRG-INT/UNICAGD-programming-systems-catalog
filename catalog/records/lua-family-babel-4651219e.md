...
<!-- canonical: https://luarocks.org/modules/damvgn/babel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/damvgn/babel](https://luarocks.org/modules/damvgn/babel) |
| Source record ids | luarocks_root_manifest-521c9df7cb16d7 |
...
For a systems engineer, babel belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-521c9df7cb16d7` from `luarocks_root_manifest` as `registry_expansion`
