...
<!-- canonical: https://github.com/aritchie/sensors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aritchie/sensors](https://github.com/aritchie/sensors) |
| Source record ids | github_search_electromagnetoscopes-c29aa225b5d767 |

## System Engineer Summary

Reactive mobile device sensors plugin for iOS, Android, & UWP. Support sensors - accelerometer,
ambient light, barometer, compass, gyroscope, magnetometer, pedometer, and proximity

## Operational Role

For a systems engineer, aritchie/sensors belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-12T15:37:19Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c29aa225b5d767` from `github_search_electromagnetoscopes` as `registry_expansion`
