...
<!-- canonical: https://hackage.haskell.org/package/network-transport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-transport](https://hackage.haskell.org/package/network-transport) |
| Source record ids | hackage_top_downloads-bc20690cf916ca |
...
For a systems engineer, network-transport belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.9 | 2025-02-05T01:57:08Z | [https://hackage.haskell.org/package/network-transport](https://hackage.haskell.org/package/network-transport) |  |
| candidate | partial | 0.4.0.0 |  | [https://hackage.haskell.org/package/network-transport](https://hackage.haskell.org/package/network-transport) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-transport` at `2026-09-05T00:31:58+00:00`.
...
- `hackage_top_downloads-bc20690cf916ca` from `hackage_top_downloads` as `registry_expansion`
