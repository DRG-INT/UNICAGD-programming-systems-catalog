...
| Source record ids | lua-source-38 |

## System Engineer Summary

Testing is tracked as a testing framework record in the Lua family branch. The source did not
...
For a systems engineer, Testing belongs in the Lua family inventory as part of unit/integration
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 38}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-38` from `master_json` as `source_list_item`
...
| telescope | Testing Framework | [open](lua-family-telescope-ae7297ba.md) |
