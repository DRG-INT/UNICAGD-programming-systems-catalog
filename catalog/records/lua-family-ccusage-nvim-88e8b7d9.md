...
<!-- canonical: https://luarocks.org/modules/s1m0n38/ccusage.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/s1m0n38/ccusage.nvim](https://luarocks.org/modules/s1m0n38/ccusage.nvim) |
| Source record ids | luarocks_root_manifest-430dad355f1485 |

## System Engineer Summary

⌖ Track Claude Code usage in Neovim

## Operational Role

For a systems engineer, ccusage.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-430dad355f1485` from `luarocks_root_manifest` as `registry_expansion`
