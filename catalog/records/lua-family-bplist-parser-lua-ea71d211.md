...
<!-- canonical: https://luarocks.org/modules/leonsilicon/bplist-parser-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/leonsilicon/bplist-parser-lua](https://luarocks.org/modules/leonsilicon/bplist-parser-lua) |
| Source record ids | luarocks_root_manifest-314158cc93faf5 |

## System Engineer Summary

bplist-parser-lua is tracked as a parser lexer ast record in the Lua family branch. The source did
...
For a systems engineer, bplist-parser-lua belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-314158cc93faf5` from `luarocks_root_manifest` as `registry_expansion`
