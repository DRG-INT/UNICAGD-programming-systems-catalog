...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Siv3D/OpenSiv3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Siv3D/OpenSiv3D](https://github.com/Siv3D/OpenSiv3D) |
| Source record ids | awesome_list-7a37400af8afa3 |

## System Engineer Summary

Siv3D (OpenSiv3D) is a C++20 framework for creative coding (2D/3D games, media art, visualizers, and
simulators). MIT

## Operational Role

For a systems engineer, Siv3D belongs in the C++23 inventory as part of ecosystem capability
...
- `awesome_list-7a37400af8afa3` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| SaneCppLibraries | Undefined Behavior Analyzer | [open](c-23-sanecpplibraries-be64eac7.md) |
| Yomm2 | Undefined Behavior Analyzer | [open](c-23-yomm2-9ef3c64f.md) |
