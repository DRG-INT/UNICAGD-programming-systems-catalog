...
<!-- canonical: https://cran.r-project.org/web/packages/bayesGARCH/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayesGARCH/index.html](https://cran.r-project.org/web/packages/bayesGARCH/index.html) |
| Source record ids | cran_packages_by_date-6905416c217075 |
...
For a systems engineer, bayesGARCH belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-21 15:50:02 UTC | [https://cran.r-project.org/web/packages/bayesGARCH/DESCRIPTION](https://cran.r-project.org/web/packages/bayesGARCH/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayesGARCH/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6905416c217075` from `cran_packages_by_date` as `registry_expansion`
