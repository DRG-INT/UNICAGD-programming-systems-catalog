...
<!-- canonical: https://pub.dev/packages/oauth2_client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/oauth2_client](https://pub.dev/packages/oauth2_client) |
| Source record ids | pub_dev-a7c6c73e7441f7 |

## System Engineer Summary

Flutter library for interacting with OAuth2 servers, with classes for transparent authorized
requests, secure token storage, automatic token refreshing.

## Operational Role

For a systems engineer, oauth2_client belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.3 | 2026-08-07T08:56:24.060383Z | [https://pub.dev/api/packages/oauth2_client](https://pub.dev/api/packages/oauth2_client) |  |
| preview | known | 5.0.0-alpha.2 | 2026-08-12T15:14:37.970157Z | [https://pub.dev/api/packages/oauth2_client](https://pub.dev/api/packages/oauth2_client) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/oauth2_client` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-a7c6c73e7441f7` from `pub_dev` as `registry_expansion`
