...
<!-- canonical: https://github.com/amirdew/CollectionViewPagingLayout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amirdew/CollectionViewPagingLayout](https://github.com/amirdew/CollectionViewPagingLayout) |
| Source record ids | github_search_swift-ed6f7aceaa519a |

## System Engineer Summary

A simple but highly customizable UICollectionViewLayout for UICollectionView -- Simple SwiftUI views
that let you make page-view effects.

## Operational Role

For a systems engineer, amirdew/CollectionViewPagingLayout belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-02T09:42:58Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-ed6f7aceaa519a` from `github_search_swift` as `registry_expansion`
