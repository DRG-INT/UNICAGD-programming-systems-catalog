...
<!-- canonical: https://crates.io/crates/find-msvc-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/find-msvc-tools](https://crates.io/crates/find-msvc-tools) |
| Source record ids | crates_io-970ee910d4741f |
...
For a systems engineer, find-msvc-tools belongs in the Rust inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.12 | 2026-09-04T09:28:52.840002Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-04T10:20:14+00:00`.
...
- `crates_io-970ee910d4741f` from `crates_io` as `registry_expansion`
