...
| Canonical URL | [https://github.com/chanzuckerberg/napari-hub](https://github.com/chanzuckerberg/napari-hub) |
| Source record ids | github_search_microscopy-802102804f2a73 |
...
For a systems engineer, chanzuckerberg/napari-hub belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v25.03.0 | 2025-03-27T01:26:03Z | [https://api.github.com/repos/chanzuckerberg/napari-hub/releases/latest](https://api.github.com/repos/chanzuckerberg/napari-hub/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/chanzuckerberg/napari-hub/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-802102804f2a73` from `github_search_microscopy` as `registry_expansion`
...
| TuragaLab/DECODE | Undefined Behavior Analyzer | [open](microscopy-turagalab-decode-e8860fd3.md) |
