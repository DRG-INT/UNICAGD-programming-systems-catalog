...
<!-- canonical: https://cran.r-project.org/web/packages/simPsyStudy/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/simPsyStudy/index.html](https://cran.r-project.org/web/packages/simPsyStudy/index.html) |
| Source record ids | cran_packages_by_date-d4dff7527c5248 |
...
For a systems engineer, simPsyStudy belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.8 | 2026-09-15 13:00:02 UTC | [https://cran.r-project.org/web/packages/simPsyStudy/DESCRIPTION](https://cran.r-project.org/web/packages/simPsyStudy/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/simPsyStudy/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-d4dff7527c5248` from `cran_packages_by_date` as `registry_expansion`
