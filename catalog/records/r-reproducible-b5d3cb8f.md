...
<!-- canonical: https://cran.r-project.org/web/packages/reproducible/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/reproducible/index.html](https://cran.r-project.org/web/packages/reproducible/index.html) |
| Source record ids | cran_packages_by_date-ce4c5237820661 |
...
For a systems engineer, reproducible belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.1 | 2026-08-25 22:40:02 UTC | [https://cran.r-project.org/web/packages/reproducible/DESCRIPTION](https://cran.r-project.org/web/packages/reproducible/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/reproducible/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ce4c5237820661` from `cran_packages_by_date` as `registry_expansion`
