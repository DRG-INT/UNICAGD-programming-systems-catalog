...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/open-metadata/OpenMetadata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata) |
| Source record ids | github_search_catalogs-253e43b6487343 |

## System Engineer Summary

The Open Context Layer for Data and AI , OpenMetadata is the open platform for building trusted data
context and business semantics for humans, AI assistants, and agents.

## Operational Role

For a systems engineer, open-metadata/OpenMetadata belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:24:01Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:data-catalog stars:>50", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-253e43b6487343` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| antgroup/sofa | Build System | [open](catalogs-antgroup-sofa-dfd41cac.md) |
| apache/gravitino | Build System | [open](catalogs-apache-gravitino-f9021fca.md) |
| ckan/ckan | Build System | [open](catalogs-ckan-ckan-56d2a0d2.md) |
| flowershow/markdowndb | Build System | [open](catalogs-flowershow-markdowndb-c72b0d23.md) |
| geolens-io/geolens | Build System | [open](catalogs-geolens-io-geolens-2be2bb7d.md) |
| henomis/lingoose | Build System | [open](catalogs-henomis-lingoose-b7784a16.md) |
| opendatadiscovery/odd-platform | Build System | [open](catalogs-opendatadiscovery-odd-platform-9b006b6d.md) |
| openfun/richie | Build System | [open](catalogs-openfun-richie-3e0bc01d.md) |
