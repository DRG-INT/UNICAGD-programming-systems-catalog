...
<!-- canonical: https://github.com/elastic/mcp-server-elasticsearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elastic/mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch) |
| Source record ids | github_search_databases-d6aa46a8f772b4 |

## System Engineer Summary

elastic/mcp-server-elasticsearch is tracked as a parser lexer ast record in the Databases branch.
...
For a systems engineer, elastic/mcp-server-elasticsearch belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T03:47:10Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d6aa46a8f772b4` from `github_search_databases` as `registry_expansion`
