...
<!-- canonical: https://github.com/codewithMUHILAN/Lightswind-UI-Library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/codewithMUHILAN/Lightswind-UI-Library](https://github.com/codewithMUHILAN/Lightswind-UI-Library) |
| Source record ids | github_search_icons_and_logos-3dcfda7d3c5dec |

## System Engineer Summary

The AI-native CLI-first React component library. 160+ animated, accessible, production-ready
components with MCP Server support for Cursor, Claude & GitHub Copilot. Copy-paste architecture —
you own the code.

## Operational Role

For a systems engineer, codewithMUHILAN/Lightswind-UI-Library belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T07:25:42Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3dcfda7d3c5dec` from `github_search_icons_and_logos` as `registry_expansion`
