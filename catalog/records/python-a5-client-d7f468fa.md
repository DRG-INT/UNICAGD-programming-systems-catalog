...
<!-- canonical: https://pypi.org/project/a5-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a5-client/](https://pypi.org/project/a5-client/) |
| Source record ids | pypi_simple-5aab96ea384576 |
...
For a systems engineer, a5-client belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.22 | 2026-06-08T19:20:34.930306Z | [https://pypi.org/pypi/a5-client/json](https://pypi.org/pypi/a5-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a5-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-5aab96ea384576` from `pypi_simple` as `registry_expansion`
