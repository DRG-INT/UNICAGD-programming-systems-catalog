...
<!-- canonical: https://packagist.org/packages/softcreatr/jsonpath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/softcreatr/jsonpath](https://packagist.org/packages/softcreatr/jsonpath) |
| Source record ids | packagist_search-83341300cf856f |
...
For a systems engineer, softcreatr/jsonpath belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-83341300cf856f` from `packagist_search` as `registry_expansion`
