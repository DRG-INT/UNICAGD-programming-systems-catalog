...
<!-- canonical: https://github.com/layumi/Image-Text-Embedding -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/layumi/Image-Text-Embedding](https://github.com/layumi/Image-Text-Embedding) |
| Source record ids | github_search_matlab-064c9d17190bbe |

## System Engineer Summary

TOMM2020 Dual-Path Convolutional Image-Text Embedding with Instance Loss :feet:

## Operational Role

For a systems engineer, layumi/Image-Text-Embedding belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-06T00:56:20Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-064c9d17190bbe` from `github_search_matlab` as `registry_expansion`
