...
| Canonical URL | [https://luarocks.org/modules/alexkovalevych/kong-plugin-abac](https://luarocks.org/modules/alexkovalevych/kong-plugin-abac) |
| Source record ids | luarocks_root_manifest-4d5536fa337f2a |
...
For a systems engineer, kong-plugin-abac belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4d5536fa337f2a` from `luarocks_root_manifest` as `registry_expansion`
