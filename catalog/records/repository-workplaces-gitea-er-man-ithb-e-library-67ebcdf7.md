...
<!-- canonical: https://gitea.com/er_man/ithb_e_library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/er_man/ithb_e_library](https://gitea.com/er_man/ithb_e_library) |
| Source record ids | gitea_repositories_api-b61bdc2c3377d6 |
...
For a systems engineer, Gitea: er_man/ithb_e_library belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-12T14:08:33Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-b61bdc2c3377d6` from `gitea_repositories_api` as `registry_expansion`
