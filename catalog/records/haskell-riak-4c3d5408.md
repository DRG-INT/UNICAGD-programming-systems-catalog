...
<!-- canonical: https://hackage.haskell.org/package/riak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/riak](https://hackage.haskell.org/package/riak) |
| Source record ids | hackage_top_downloads-f7825cb3c1ebaa |
...
For a systems engineer, riak belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0.0 | 2021-06-16T07:56:07Z | [https://hackage.haskell.org/package/riak](https://hackage.haskell.org/package/riak) |  |
| candidate | partial | 1.1.2.6 |  | [https://hackage.haskell.org/package/riak](https://hackage.haskell.org/package/riak) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/riak` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-f7825cb3c1ebaa` from `hackage_top_downloads` as `registry_expansion`
