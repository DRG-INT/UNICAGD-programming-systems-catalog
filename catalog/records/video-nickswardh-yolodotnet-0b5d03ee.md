...
<!-- canonical: https://github.com/NickSwardh/YoloDotNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NickSwardh/YoloDotNet](https://github.com/NickSwardh/YoloDotNet) |
| Source record ids | github_search_video-de42bf981178c8 |

## System Engineer Summary

YoloDotNet - A C# .NET 8.0 project for Classification, Object Detection, OBB Detection, Segmentation
and Pose Estimation in both images and live video streams.

## Operational Role

For a systems engineer, NickSwardh/YoloDotNet belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-08T17:25:49Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-de42bf981178c8` from `github_search_video` as `registry_expansion`
