...
<!-- canonical: https://www.nuget.org/packages/JsonPath.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonPath.Net](https://www.nuget.org/packages/JsonPath.Net) |
| Source record ids | nuget_search-2c05ee1a85eb2e |
...
For a systems engineer, JsonPath.Net belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-03-15T02:23:35.93+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonpath.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonpath.net/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; https://www.nuget.org/packages/JsonPath.Net/3.0.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonpath.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-2c05ee1a85eb2e` from `nuget_search` as `registry_expansion`
