...
<!-- canonical: https://github.com/apache/spark-docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/spark-docker](https://github.com/apache/spark-docker) |
| Source record ids | github_search_databases-26b0898a12e07c |
...
For a systems engineer, apache/spark-docker belongs in the Databases inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-23T09:03:18Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-26b0898a12e07c` from `github_search_databases` as `registry_expansion`
