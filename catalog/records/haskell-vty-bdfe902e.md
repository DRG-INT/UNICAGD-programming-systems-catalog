...
<!-- canonical: https://hackage.haskell.org/package/vty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vty](https://hackage.haskell.org/package/vty) |
| Source record ids | hackage_top_downloads-8de61cc02661aa |

## System Engineer Summary

Hackage package with 274 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, vty belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.6 | 2026-06-15T02:29:39Z | [https://hackage.haskell.org/package/vty](https://hackage.haskell.org/package/vty) |  |
| candidate | partial | 5.0.0 |  | [https://hackage.haskell.org/package/vty](https://hackage.haskell.org/package/vty) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vty` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-8de61cc02661aa` from `hackage_top_downloads` as `registry_expansion`
...
| aeson | Library | [open](haskell-aeson-7553a0ad.md) |
| aeson-compat | Library | [open](haskell-aeson-compat-76be1cd9.md) |
