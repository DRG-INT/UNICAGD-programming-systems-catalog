...
| Canonical URL | [https://crates.io/crates/if-addrs](https://crates.io/crates/if-addrs) |
| Source record ids | crates_io-0a37f6484a02f7 |
...
For a systems engineer, if-addrs belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-02-08T05:55:03.911864Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-0a37f6484a02f7` from `crates_io` as `registry_expansion`
