...
<!-- canonical: https://github.com/keijiro/Isaura -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keijiro/Isaura](https://github.com/keijiro/Isaura) |
| Source record ids | github_search_effects-7ec2baedea41f2 |
...
For a systems engineer, keijiro/Isaura belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-25T09:14:10Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-7ec2baedea41f2` from `github_search_effects` as `registry_expansion`
