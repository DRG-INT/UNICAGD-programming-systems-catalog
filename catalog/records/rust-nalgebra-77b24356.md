...
<!-- canonical: https://crates.io/crates/nalgebra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/nalgebra](https://crates.io/crates/nalgebra) |
| Source record ids | crates_io-1976b93ea121fb |

## System Engineer Summary

General-purpose linear algebra library with transformations and statically-sized or dynamically-
sized matrices.

## Operational Role

For a systems engineer, nalgebra belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.35.0 | 2026-05-24T16:12:14.939059Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-16T06:26:05+00:00`.
...
- `crates_io-1976b93ea121fb` from `crates_io` as `registry_expansion`
