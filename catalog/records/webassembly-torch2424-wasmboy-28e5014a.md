...
<!-- canonical: https://github.com/torch2424/wasmboy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/torch2424/wasmboy](https://github.com/torch2424/wasmboy) |
| Source record ids | github_search_webassembly-f0cfc3c3753610 |

## System Engineer Summary

Game Boy / Game Boy Color Emulator Library, 🎮written for WebAssembly using AssemblyScript. 🚀Demos
built with Preact and Svelte. ⚛️

## Operational Role

For a systems engineer, torch2424/wasmboy belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-04T02:32:59Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-f0cfc3c3753610` from `github_search_webassembly` as `registry_expansion`
