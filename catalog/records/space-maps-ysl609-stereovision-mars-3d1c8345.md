...
<!-- canonical: https://github.com/ysl609/stereovision-mars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ysl609/stereovision-mars](https://github.com/ysl609/stereovision-mars) |
| Source record ids | github_search_space_maps-146e998493c283 |

## System Engineer Summary

Code implementation for the paper "Stereovision Image Processing for Planetary Navigation Maps with
Semi-Global Matching and Superpixel Segmentation", in the proceedings of ESA ASTRA 2025.

## Operational Role

For a systems engineer, ysl609/stereovision-mars belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-13T15:32:26Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-146e998493c283` from `github_search_space_maps` as `registry_expansion`
