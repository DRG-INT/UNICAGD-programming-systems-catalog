...
<!-- canonical: https://cran.r-project.org/web/packages/pslr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pslr/index.html](https://cran.r-project.org/web/packages/pslr/index.html) |
| Source record ids | cran_packages_by_date-c2fd5741ce5d41 |
...
For a systems engineer, pslr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-14 07:40:24 UTC | [https://cran.r-project.org/web/packages/pslr/DESCRIPTION](https://cran.r-project.org/web/packages/pslr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pslr/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-c2fd5741ce5d41` from `cran_packages_by_date` as `registry_expansion`
