...
<!-- canonical: https://github.com/golang-migrate/migrate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/golang-migrate/migrate](https://github.com/golang-migrate/migrate) |
| Source record ids | github_search_databases-81dfd67fc592e6 |
...
For a systems engineer, golang-migrate/migrate belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T23:57:55Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-81dfd67fc592e6` from `github_search_databases` as `registry_expansion`
