...
<!-- canonical: https://github.com/fonttools/fonttools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fonttools/fonttools](https://github.com/fonttools/fonttools) |
| Source record ids | github_search_font_briefcase-6e99411e2742cd |
...
For a systems engineer, fonttools/fonttools belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:54:23Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-6e99411e2742cd` from `github_search_font_briefcase` as `registry_expansion`
