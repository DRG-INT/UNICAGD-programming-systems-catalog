...
<!-- canonical: https://github.com/IBM/jupyterlab-s3-browser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IBM/jupyterlab-s3-browser](https://github.com/IBM/jupyterlab-s3-browser) |
| Source record ids | github_search_databases-d2f5a36c03c2d4 |
...
For a systems engineer, IBM/jupyterlab-s3-browser belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-17T20:40:57Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d2f5a36c03c2d4` from `github_search_databases` as `registry_expansion`
