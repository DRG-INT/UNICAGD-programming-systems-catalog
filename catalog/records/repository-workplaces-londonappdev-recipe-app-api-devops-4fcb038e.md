# LondonAppDev/recipe-app-api-devops

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/LondonAppDev/recipe-app-api-devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/LondonAppDev/recipe-app-api-devops](https://gitlab.com/LondonAppDev/recipe-app-api-devops) |
| Source record ids | gitlab_projects_api-961eb8ac896e06 |

## System Engineer Summary

Final source code for the course: DevOps deployment automation with Terraform, AWS and Docker

## Operational Role

For a systems engineer, LondonAppDev/recipe-app-api-devops belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-27T13:37:31.156Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-961eb8ac896e06` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: freezmeinster/apisix-docker | Api Abi Checker | [open](repository-workplaces-gitea-freezmeinster-apisix-docker-88600e8a.md) |
| Gitea: pitchayapink/Signtrust-automate-browser-library | Api Abi Checker | [open](repository-workplaces-gitea-pitchayapink-signtrust-automate-browser-library-16f46cdc.md) |
| LondonAppDev/recipe-app-api-devops-course-material | Api Abi Checker | [open](repository-workplaces-londonappdev-recipe-app-api-devops-course-material-ee134a2d.md) |
| LondonAppDev/recipe-app-api-proxy | Api Abi Checker | [open](repository-workplaces-londonappdev-recipe-app-api-proxy-34f38c15.md) |
