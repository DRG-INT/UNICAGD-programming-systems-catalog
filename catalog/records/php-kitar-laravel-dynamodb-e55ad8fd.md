...
<!-- canonical: https://packagist.org/packages/kitar/laravel-dynamodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kitar/laravel-dynamodb](https://packagist.org/packages/kitar/laravel-dynamodb) |
| Source record ids | packagist_search-4bc63beb1eb305 |
...
For a systems engineer, kitar/laravel-dynamodb belongs in the PHP inventory as part of build graph
...
- `packagist_search-4bc63beb1eb305` from `packagist_search` as `registry_expansion`
