...
<!-- canonical: https://cran.r-project.org/web/packages/ggformula/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggformula/index.html](https://cran.r-project.org/web/packages/ggformula/index.html) |
| Source record ids | cran_packages_by_date-9453da5237ab0f |
...
For a systems engineer, ggformula belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-11 02:20:03 UTC | [https://cran.r-project.org/web/packages/ggformula/DESCRIPTION](https://cran.r-project.org/web/packages/ggformula/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggformula/DESCRIPTION` at `2026-09-11T04:21:25+00:00`.
...
- `cran_packages_by_date-9453da5237ab0f` from `cran_packages_by_date` as `registry_expansion`
