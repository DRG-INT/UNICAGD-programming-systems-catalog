...
<!-- canonical: https://crates.io/crates/untrusted -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/untrusted](https://crates.io/crates/untrusted) |
| Source record ids | crates_io-b9767a2f987272 |
...
For a systems engineer, untrusted belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2021-07-13T22:13:26.650010Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-b9767a2f987272` from `crates_io` as `registry_expansion`
