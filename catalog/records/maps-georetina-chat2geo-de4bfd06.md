...
<!-- canonical: https://github.com/GeoRetina/chat2geo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GeoRetina/chat2geo](https://github.com/GeoRetina/chat2geo) |
| Source record ids | github_search_maps-576a42221ea595 |

## System Engineer Summary

Chat2Geo delivers a ChatGPT-like experience tailored for remote-sensing-based geospatial analysis.
Its mission is to democratize geospatial insights at scale by harnessing cutting-edge AI
technologies, making advanced analysis accessible to everyone.

## Operational Role

For a systems engineer, GeoRetina/chat2geo belongs in the Maps inventory as part of defect
...
- `github_search_maps-576a42221ea595` from `github_search_maps` as `registry_expansion`
