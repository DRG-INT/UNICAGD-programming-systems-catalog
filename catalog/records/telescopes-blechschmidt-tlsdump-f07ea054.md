...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/blechschmidt/tlsdump -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blechschmidt/tlsdump](https://github.com/blechschmidt/tlsdump) |
| Source record ids | github_search_telescopes-33e2b9b530cc11 |

## System Engineer Summary

A ptrace-based TLS secret extractor for reverse engineering (PoC)

## Operational Role

For a systems engineer, blechschmidt/tlsdump belongs in the Telescopes inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T22:00:03Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-33e2b9b530cc11` from `github_search_telescopes` as `registry_expansion`
