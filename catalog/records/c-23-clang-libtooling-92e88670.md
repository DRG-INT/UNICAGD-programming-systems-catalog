...
| Source record ids | corpus-93ae312b94fa70 |

## System Engineer Summary

Clang LibTooling is tracked as a codegen codemod refactoring record in the C++23 branch. The source
...
For a systems engineer, Clang LibTooling belongs in the C++23 inventory as part of ecosystem
...
- `corpus-93ae312b94fa70` from `master_json` as `codegen_codemod_refactoring`
...
| clang-rename | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-clang-rename-82c94f22.md) |
