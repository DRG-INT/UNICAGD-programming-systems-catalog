...
<!-- canonical: https://crates.io/crates/asn1-rs-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/asn1-rs-derive](https://crates.io/crates/asn1-rs-derive) |
| Source record ids | crates_io-98c98a67b646dc |
...
For a systems engineer, asn1-rs-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2025-04-14T12:03:58.682608Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-98c98a67b646dc` from `crates_io` as `registry_expansion`
