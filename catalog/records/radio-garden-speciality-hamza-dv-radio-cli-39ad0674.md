...
[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/hamza-dv/radio-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hamza-dv/radio-cli](https://github.com/hamza-dv/radio-cli) |
| Source record ids | github_search_radio_garden_speciality-34d2ea70a91b37 |

## System Engineer Summary

Terminal Radio Garden in Python — browse countries, cities & live stations; play in mpv. No third-
party dependencies.

## Operational Role

For a systems engineer, hamza-dv/radio-cli belongs in the Radio Garden Speciality inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T21:17:21Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-34d2ea70a91b37` from `github_search_radio_garden_speciality` as `registry_expansion`
