...
| Canonical URL | [https://luarocks.org/modules/freed-wu/jieba](https://luarocks.org/modules/freed-wu/jieba) |
| Source record ids | luarocks_root_manifest-bf6244310040e9 |

## System Engineer Summary

基于 jieba-lua 的 neovim 中文词跳转

## Operational Role

For a systems engineer, jieba belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-bf6244310040e9` from `luarocks_root_manifest` as `registry_expansion`
