...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/csound-expression -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/csound-expression](https://hackage.haskell.org/package/csound-expression) |
| Source record ids | hackage_top_downloads-d4c0294bc8a2f0 |
...
For a systems engineer, csound-expression belongs in the Haskell inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.4.1 | 2024-06-16T17:12:05Z | [https://hackage.haskell.org/package/csound-expression](https://hackage.haskell.org/package/csound-expression) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/csound-expression` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-d4c0294bc8a2f0` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| csound-expression-typed | Web Framework | [open](haskell-csound-expression-typed-b0cbea91.md) |
| futhark-server | Web Framework | [open](haskell-futhark-server-1468e986.md) |
...
| servant-auth-server | Web Framework | [open](haskell-servant-auth-server-c68cfa93.md) |
