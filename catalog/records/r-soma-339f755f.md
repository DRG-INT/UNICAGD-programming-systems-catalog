...
<!-- canonical: https://cran.r-project.org/web/packages/soma/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/soma/index.html](https://cran.r-project.org/web/packages/soma/index.html) |
| Source record ids | cran_packages_by_date-710467c66dd4eb |
...
For a systems engineer, soma belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-21 22:00:16 UTC | [https://cran.r-project.org/web/packages/soma/DESCRIPTION](https://cran.r-project.org/web/packages/soma/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/soma/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-710467c66dd4eb` from `cran_packages_by_date` as `registry_expansion`
