...
<!-- canonical: https://cran.r-project.org/web/packages/osmdata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/osmdata/index.html](https://cran.r-project.org/web/packages/osmdata/index.html) |
| Source record ids | cran_packages_by_date-ab41061e9dc305 |
...
For a systems engineer, osmdata belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-09-01 12:00:02 UTC | [https://cran.r-project.org/web/packages/osmdata/DESCRIPTION](https://cran.r-project.org/web/packages/osmdata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/osmdata/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-ab41061e9dc305` from `cran_packages_by_date` as `registry_expansion`
