...
<!-- canonical: https://github.com/langchain-ai/langchain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/langchain-ai/langchain](https://github.com/langchain-ai/langchain) |
| Source record ids | github_search_aims-07080a510e7783 |
...
For a systems engineer, langchain-ai/langchain belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T08:17:49Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-07080a510e7783` from `github_search_aims` as `registry_expansion`
