...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Image Audio Dsp](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/image-audio-dsp.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/xdever/indexedpng](https://luarocks.org/modules/xdever/indexedpng) |
| Source record ids | luarocks_root_manifest-fb7457adc41323 |

## System Engineer Summary

A library for loading palette indexed PNG images for Torch

## Operational Role

For a systems engineer, indexedpng belongs in the Lua family inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| alien-signals | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-alien-signals-b7cf092e.md) |
| ao | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ao-5c30c7cb.md) |
| audiodataload | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-audiodataload-e57e7a6f.md) |
| auproc | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-auproc-0dda5b9e.md) |
| away | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-away-c3d1059a.md) |
| awesome-audiowheel | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-audiowheel-b32db6a9.md) |
| awesome-pulseaudio-widget | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-pulseaudio-widget-55185af1.md) |
| awesome-slot | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-slot-b1c2e4ed.md) |
