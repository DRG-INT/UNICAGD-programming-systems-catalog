...
<!-- canonical: https://cran.r-project.org/web/packages/ulrb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ulrb/index.html](https://cran.r-project.org/web/packages/ulrb/index.html) |
| Source record ids | cran_packages_by_date-06c3448205871f |
...
For a systems engineer, ulrb belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-08-21 05:40:10 UTC | [https://cran.r-project.org/web/packages/ulrb/DESCRIPTION](https://cran.r-project.org/web/packages/ulrb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ulrb/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-06c3448205871f` from `cran_packages_by_date` as `registry_expansion`
