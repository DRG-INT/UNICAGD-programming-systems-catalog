...
<!-- canonical: https://pypi.org/project/acrv-datasets/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acrv-datasets/](https://pypi.org/project/acrv-datasets/) |
| Source record ids | pypi_simple-5f894bc8ad56e1 |

## System Engineer Summary

Datasets manager for the Best of ACRV

## Operational Role

For a systems engineer, acrv-datasets belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2021-06-02T00:55:55.033919Z | [https://pypi.org/pypi/acrv-datasets/json](https://pypi.org/pypi/acrv-datasets/json) |  |
...
| Evidence | License :: OSI Approved :: BSD License |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acrv-datasets/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-5f894bc8ad56e1` from `pypi_simple` as `registry_expansion`
