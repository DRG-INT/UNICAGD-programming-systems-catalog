...
<!-- canonical: https://github.com/KaixoCode/SoundMixr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KaixoCode/SoundMixr](https://github.com/KaixoCode/SoundMixr) |
| Source record ids | github_search_radars-2432705646ca00 |

## System Engineer Summary

SoundMixr is a simple audio mixer for ASIO devices, but specifically made for SAR , it sees all the
channels in the ASIO device and shows them with the option to route any input to any output. Each
channel also has a mute, mono, stereo pan and volume parameter.

## Operational Role

For a systems engineer, KaixoCode/SoundMixr belongs in the Radars inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-02T08:51:21Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-2432705646ca00` from `github_search_radars` as `registry_expansion`
