...
<!-- canonical: https://hackage.haskell.org/package/keystore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keystore](https://hackage.haskell.org/package/keystore) |
| Source record ids | hackage_top_downloads-390783b2ade7f2 |
...
For a systems engineer, keystore belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.2 | 2023-10-14T04:49:11Z | [https://hackage.haskell.org/package/keystore](https://hackage.haskell.org/package/keystore) |  |
| candidate | partial | 0.4.0.0 |  | [https://hackage.haskell.org/package/keystore](https://hackage.haskell.org/package/keystore) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keystore` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-390783b2ade7f2` from `hackage_top_downloads` as `registry_expansion`
