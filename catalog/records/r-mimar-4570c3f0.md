...
<!-- canonical: https://cran.r-project.org/web/packages/mimar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mimar/index.html](https://cran.r-project.org/web/packages/mimar/index.html) |
| Source record ids | cran_packages_by_date-1d862b5572140a |
...
For a systems engineer, mimar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-22 00:50:10 UTC | [https://cran.r-project.org/web/packages/mimar/DESCRIPTION](https://cran.r-project.org/web/packages/mimar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mimar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1d862b5572140a` from `cran_packages_by_date` as `registry_expansion`
