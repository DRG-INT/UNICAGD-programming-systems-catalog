...
<!-- canonical: https://cran.r-project.org/web/packages/spooky/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spooky/index.html](https://cran.r-project.org/web/packages/spooky/index.html) |
| Source record ids | cran_packages_by_date-9a350c6a55bcc1 |
...
For a systems engineer, spooky belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-07 07:10:02 UTC | [https://cran.r-project.org/web/packages/spooky/DESCRIPTION](https://cran.r-project.org/web/packages/spooky/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spooky/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-9a350c6a55bcc1` from `cran_packages_by_date` as `registry_expansion`
