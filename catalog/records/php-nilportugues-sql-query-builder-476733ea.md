...
<!-- canonical: https://packagist.org/packages/nilportugues/sql-query-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nilportugues/sql-query-builder](https://packagist.org/packages/nilportugues/sql-query-builder) |
| Source record ids | packagist_search-53ed466423a7ca |

## System Engineer Summary

An elegant lightweight and efficient SQL QueryInterface BuilderInterface supporting bindings and
complicated query generation.

## Operational Role

For a systems engineer, nilportugues/sql-query-builder belongs in the PHP inventory as part of build
...
- `packagist_search-53ed466423a7ca` from `packagist_search` as `registry_expansion`
