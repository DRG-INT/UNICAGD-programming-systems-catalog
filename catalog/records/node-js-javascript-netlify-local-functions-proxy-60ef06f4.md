...
<!-- canonical: https://www.npmjs.com/package/@netlify/local-functions-proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@netlify/local-functions-proxy](https://www.npmjs.com/package/@netlify/local-functions-proxy) |
| Source record ids | npm_registry-1adce1bbbcf3fe |
...
For a systems engineer, @netlify/local-functions-proxy belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2025-04-04T16:54:11.784Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-1adce1bbbcf3fe` from `npm_registry` as `registry_expansion`
