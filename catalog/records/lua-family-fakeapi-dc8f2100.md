...
| Canonical URL | [https://luarocks.org/modules/vncsmyrnk/fakeapi](https://luarocks.org/modules/vncsmyrnk/fakeapi) |
| Source record ids | luarocks_root_manifest-93a36190efcee1 |

## System Engineer Summary

fakeapi is tracked as an api abi checker record in the Lua family branch. The source did not provide
...
For a systems engineer, fakeapi belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-93a36190efcee1` from `luarocks_root_manifest` as `registry_expansion`
