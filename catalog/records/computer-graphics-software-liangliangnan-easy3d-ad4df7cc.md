...
<!-- canonical: https://github.com/LiangliangNan/Easy3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LiangliangNan/Easy3D](https://github.com/LiangliangNan/Easy3D) |
| Source record ids | github_search_computer_graphics_software-0ea4ee3eff0547 |

## System Engineer Summary

A lightweight, easy-to-use, and efficient library for processing and rendering 3D data (C++ &
Python)

## Operational Role

For a systems engineer, LiangliangNan/Easy3D belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-0ea4ee3eff0547` from `github_search_computer_graphics_software` as `registry_expansion`
