...
<!-- canonical: https://pub.dev/packages/pigeon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pigeon](https://pub.dev/packages/pigeon) |
| Source record ids | pub_dev-f27384731c9be7 |

## System Engineer Summary

Code generator tool to make communication between Flutter and the host platform type-safe and
easier.

## Operational Role

For a systems engineer, pigeon belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 28.0.0 | 2026-08-21T21:53:11.627403Z | [https://pub.dev/api/packages/pigeon](https://pub.dev/api/packages/pigeon) |  |
| preview | known | 0.1.0-experimental.11 | 2020-05-13T21:00:42.192263Z | [https://pub.dev/api/packages/pigeon](https://pub.dev/api/packages/pigeon) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pigeon` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-f27384731c9be7` from `pub_dev` as `registry_expansion`
