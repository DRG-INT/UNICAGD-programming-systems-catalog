# MercaderLabAnatomy/napari-tmidas
...
<!-- canonical: https://github.com/MercaderLabAnatomy/napari-tmidas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MercaderLabAnatomy/napari-tmidas](https://github.com/MercaderLabAnatomy/napari-tmidas) |
| Source record ids | github_search_microscopy-b3e0bb3a3c3642 |
...
For a systems engineer, MercaderLabAnatomy/napari-tmidas belongs in the Microscopy inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T13:34:21Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-b3e0bb3a3c3642` from `github_search_microscopy` as `registry_expansion`
