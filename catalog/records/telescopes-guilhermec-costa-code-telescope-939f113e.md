# guilhermec-costa/code-telescope
...
<!-- canonical: https://github.com/guilhermec-costa/code-telescope -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/guilhermec-costa/code-telescope](https://github.com/guilhermec-costa/code-telescope) |
| Source record ids | github_search_telescopes-c1fd386bb28d94 |

## System Engineer Summary

Telescope.nvim-inspired fuzzy finder for VS Code, bringing keyboard-first navigation to your entire
workflow.

## Operational Role

For a systems engineer, guilhermec-costa/code-telescope belongs in the Telescopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T17:35:41Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-c1fd386bb28d94` from `github_search_telescopes` as `registry_expansion`
