...
<!-- canonical: https://hackage.haskell.org/package/bearriver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bearriver](https://hackage.haskell.org/package/bearriver) |
| Source record ids | hackage_top_downloads-fc64ef3fa25b7f |
...
For a systems engineer, bearriver belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15 | 2025-02-28T07:07:46Z | [https://hackage.haskell.org/package/bearriver](https://hackage.haskell.org/package/bearriver) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bearriver` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-fc64ef3fa25b7f` from `hackage_top_downloads` as `registry_expansion`
