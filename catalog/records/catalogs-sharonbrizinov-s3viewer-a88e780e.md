...
<!-- canonical: https://github.com/SharonBrizinov/s3viewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SharonBrizinov/s3viewer](https://github.com/SharonBrizinov/s3viewer) |
| Source record ids | github_search_catalogs-9a1ac211a47c6f |

## System Engineer Summary

Storage Explorer - Publicly open storage viewer (Amazon S3 Bucket, Azure Blob, FTP server, HTTP
Index Of/)

## Operational Role

For a systems engineer, SharonBrizinov/s3viewer belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-11T05:38:39Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-9a1ac211a47c6f` from `github_search_catalogs` as `registry_expansion`
