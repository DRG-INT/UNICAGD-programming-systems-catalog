# ousmanabakar/Responsive-Web-Design-freecodecamp
...
<!-- canonical: https://github.com/ousmanabakar/Responsive-Web-Design-freecodecamp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ousmanabakar/Responsive-Web-Design-freecodecamp](https://github.com/ousmanabakar/Responsive-Web-Design-freecodecamp) |
| Source record ids | github_search_magazines-e5448ef7b23282 |
...
First, you'll build a cat photo app to learn the basics of HTML and CSS. Later, you'll learn modern
techniques like CSS variables by building a penguin, and best practices for accessibility by
building a quiz site. Finally, you'll learn how to make webpages that respond to different screen
sizes by building a photo gallery with Flexbox, and a magazine article layout with CSS Grid.

## Operational Role

For a systems engineer, ousmanabakar/Responsive-Web-Design-freecodecamp belongs in the Magazines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-19T14:04:15Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-e5448ef7b23282` from `github_search_magazines` as `registry_expansion`
