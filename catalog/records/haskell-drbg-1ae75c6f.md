...
<!-- canonical: https://hackage.haskell.org/package/DRBG -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/DRBG](https://hackage.haskell.org/package/DRBG) |
| Source record ids | hackage_top_downloads-30a5869a4abbe7 |
...
For a systems engineer, DRBG belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.5 | 2015-11-12T16:35:40Z | [https://hackage.haskell.org/package/DRBG](https://hackage.haskell.org/package/DRBG) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/DRBG` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-30a5869a4abbe7` from `hackage_top_downloads` as `registry_expansion`
