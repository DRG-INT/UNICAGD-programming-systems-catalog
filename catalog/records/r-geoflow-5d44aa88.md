...
<!-- canonical: https://cran.r-project.org/web/packages/geoflow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geoflow/index.html](https://cran.r-project.org/web/packages/geoflow/index.html) |
| Source record ids | cran_packages_by_date-88064d42ea5889 |
...
For a systems engineer, geoflow belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-09-05 16:20:02 UTC | [https://cran.r-project.org/web/packages/geoflow/DESCRIPTION](https://cran.r-project.org/web/packages/geoflow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geoflow/DESCRIPTION` at `2026-09-05T18:20:45+00:00`.
...
- `cran_packages_by_date-88064d42ea5889` from `cran_packages_by_date` as `registry_expansion`
