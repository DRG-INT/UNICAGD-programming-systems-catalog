...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/KupynOrest/DeblurGAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KupynOrest/DeblurGAN](https://github.com/KupynOrest/DeblurGAN) |
| Source record ids | github_search_photography-a8a94186339ef4 |
...
For a systems engineer, KupynOrest/DeblurGAN belongs in the Photography inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-25T18:40:00Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:image-processing stars:>500", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_photography-a8a94186339ef4` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Achno/gowall | Networking Http | [open](photography-achno-gowall-1bcfd66d.md) |
| alexjc/neural-doodle | Networking Http | [open](photography-alexjc-neural-doodle-83dae674.md) |
| argyleink/gradient-style | Networking Http | [open](photography-argyleink-gradient-style-33b809ee.md) |
| begeekmyfriend/yasea | Networking Http | [open](photography-begeekmyfriend-yasea-008894a3.md) |
| clawsoftware/clawPDF | Networking Http | [open](photography-clawsoftware-clawpdf-844ac17e.md) |
| mv-lab/InstructIR | Networking Http | [open](photography-mv-lab-instructir-153061d6.md) |
| superuser404notfound/Sodalite | Networking Http | [open](photography-superuser404notfound-sodalite-16dabe3e.md) |
| zyddnys/manga-image-translator | Networking Http | [open](photography-zyddnys-manga-image-translator-bbc95c1a.md) |
