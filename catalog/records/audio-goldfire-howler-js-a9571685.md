...
| Canonical URL | [https://github.com/goldfire/howler.js](https://github.com/goldfire/howler.js) |
| Source record ids | github_search_audio-a437b59d076765 |
...
For a systems engineer, goldfire/howler.js belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.4 | 2023-09-19T15:00:30Z | [https://api.github.com/repos/goldfire/howler.js/releases/latest](https://api.github.com/repos/goldfire/howler.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/goldfire/howler.js/releases/latest` at `2026-09-01T09:23:16+00:00`.
...
- `github_search_audio-a437b59d076765` from `github_search_audio` as `registry_expansion`
