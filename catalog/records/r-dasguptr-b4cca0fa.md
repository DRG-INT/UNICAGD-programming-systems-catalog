...
<!-- canonical: https://cran.r-project.org/web/packages/DasGuptR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DasGuptR/index.html](https://cran.r-project.org/web/packages/DasGuptR/index.html) |
| Source record ids | cran_packages_by_date-61e32c34ddb443 |

## System Engineer Summary

Das Gupta Standardisation and Decomposition

## Operational Role

For a systems engineer, DasGuptR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-04 17:10:15 UTC | [https://cran.r-project.org/web/packages/DasGuptR/DESCRIPTION](https://cran.r-project.org/web/packages/DasGuptR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DasGuptR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-61e32c34ddb443` from `cran_packages_by_date` as `registry_expansion`
