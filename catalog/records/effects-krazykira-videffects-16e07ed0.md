...
<!-- canonical: https://github.com/krazykira/VidEffects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krazykira/VidEffects](https://github.com/krazykira/VidEffects) |
| Source record ids | github_search_effects-719a791c9f90d5 |
...
For a systems engineer, krazykira/VidEffects belongs in the Effects inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-29T19:24:04Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-719a791c9f90d5` from `github_search_effects` as `registry_expansion`
