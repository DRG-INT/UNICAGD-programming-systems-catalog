...
<!-- canonical: https://github.com/thisrares/astronomy-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thisrares/astronomy-tools](https://github.com/thisrares/astronomy-tools) |
| Source record ids | github_search_space_maps-d4e21c335d4886 |

## System Engineer Summary

Tools created for students that want to understand, visualize and memorize the sky map.

## Operational Role

For a systems engineer, thisrares/astronomy-tools belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T15:13:34Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d4e21c335d4886` from `github_search_space_maps` as `registry_expansion`
