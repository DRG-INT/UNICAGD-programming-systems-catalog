...
<!-- canonical: https://gitea.com/intsigdev/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/intsigdev/devops](https://gitea.com/intsigdev/devops) |
| Source record ids | gitea_repositories_api-036ecd3b142d1d |
...
For a systems engineer, Gitea: intsigdev/devops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-16T06:44:21Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-036ecd3b142d1d` from `gitea_repositories_api` as `registry_expansion`
