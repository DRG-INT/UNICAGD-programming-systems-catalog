...
<!-- canonical: https://luarocks.org/modules/flopes/dms -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/flopes/dms](https://luarocks.org/modules/flopes/dms) |
| Source record ids | luarocks_root_manifest-a614a0dec5afe0 |

## System Engineer Summary

Lua parser for DMS, a data syntax with strong typing, ordered maps, multi-line heredocs, and front-
matter metadata.

## Operational Role

For a systems engineer, dms belongs in the Lua family inventory as part of interface contracts,
...
- `luarocks_root_manifest-a614a0dec5afe0` from `luarocks_root_manifest` as `registry_expansion`
