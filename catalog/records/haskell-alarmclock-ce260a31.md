...
<!-- canonical: https://hackage.haskell.org/package/alarmclock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/alarmclock](https://hackage.haskell.org/package/alarmclock) |
| Source record ids | hackage_top_downloads-e9e775930c9481 |
...
For a systems engineer, alarmclock belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.7 | 2024-10-29T16:59:26Z | [https://hackage.haskell.org/package/alarmclock](https://hackage.haskell.org/package/alarmclock) |  |
| candidate | partial | 0.1.0.2 |  | [https://hackage.haskell.org/package/alarmclock](https://hackage.haskell.org/package/alarmclock) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/alarmclock` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-e9e775930c9481` from `hackage_top_downloads` as `registry_expansion`
