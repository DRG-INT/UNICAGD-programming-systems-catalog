...
<!-- canonical: https://pypi.org/project/address-metadata-lib/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-metadata-lib/](https://pypi.org/project/address-metadata-lib/) |
| Source record ids | pypi_simple-c98cc9474b6a98 |

## System Engineer Summary

Reserved by Blockaid. This package is for internal use only.

## Operational Role

For a systems engineer, address-metadata-lib belongs in the Python inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-03-21T21:12:31.124949Z | [https://pypi.org/pypi/address-metadata-lib/json](https://pypi.org/pypi/address-metadata-lib/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-metadata-lib/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-c98cc9474b6a98` from `pypi_simple` as `registry_expansion`
