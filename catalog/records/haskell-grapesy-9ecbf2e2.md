...
<!-- canonical: https://hackage.haskell.org/package/grapesy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/grapesy](https://hackage.haskell.org/package/grapesy) |
| Source record ids | hackage_recent-0c786b314b6410 |

## System Engineer Summary

Hackage package recently uploaded by EdskoDeVries.

## Operational Role

For a systems engineer, grapesy belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-02T12:23:06Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-02T12:25:43+00:00`.
...
- `hackage_recent-0c786b314b6410` from `hackage_recent` as `registry_expansion`
