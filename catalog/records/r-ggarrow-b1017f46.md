...
<!-- canonical: https://cran.r-project.org/web/packages/ggarrow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggarrow/index.html](https://cran.r-project.org/web/packages/ggarrow/index.html) |
| Source record ids | cran_packages_by_date-19d5b712e63f1f |

## System Engineer Summary

ggarrow is tracked as a visualization gui record in the R branch. The source did not provide a long
...
For a systems engineer, ggarrow belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-03 05:20:41 UTC | [https://cran.r-project.org/web/packages/ggarrow/DESCRIPTION](https://cran.r-project.org/web/packages/ggarrow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggarrow/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-19d5b712e63f1f` from `cran_packages_by_date` as `registry_expansion`
