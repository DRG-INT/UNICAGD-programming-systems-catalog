...
<!-- canonical: https://pub.dev/packages/flutter_hooks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_hooks](https://pub.dev/packages/flutter_hooks) |
| Source record ids | pub_dev-b7f88ff42c0f2c |
...
For a systems engineer, flutter_hooks belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.21.3+1 | 2025-08-19T12:55:32.408022Z | [https://pub.dev/api/packages/flutter_hooks](https://pub.dev/api/packages/flutter_hooks) |  |
| preview | known | 0.21.1-pre.4 | 2024-08-01T14:15:01.344414Z | [https://pub.dev/api/packages/flutter_hooks](https://pub.dev/api/packages/flutter_hooks) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_hooks` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-b7f88ff42c0f2c` from `pub_dev` as `registry_expansion`
