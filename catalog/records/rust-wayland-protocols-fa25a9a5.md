...
<!-- canonical: https://crates.io/crates/wayland-protocols -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wayland-protocols](https://crates.io/crates/wayland-protocols) |
| Source record ids | crates_io-a6d577ef2d3eaa |
...
For a systems engineer, wayland-protocols belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.13 | 2026-06-19T15:32:40.359346Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a6d577ef2d3eaa` from `crates_io` as `registry_expansion`
