# dsekz/twitter-x-xp-forwarded-for-header

## Navigation

[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dsekz/twitter-x-xp-forwarded-for-header -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dsekz/twitter-x-xp-forwarded-for-header](https://github.com/dsekz/twitter-x-xp-forwarded-for-header) |
| Source record ids | github_search_webassembly-650bc330539672 |

## System Engineer Summary

Reverse engineering and generation toolkit for Twitter/X's private x-xp-forwarded-for header (XPFF),
used for fingerprinting.

## Operational Role

For a systems engineer, dsekz/twitter-x-xp-forwarded-for-header belongs in the WebAssembly inventory
...
- `github_search_webassembly-650bc330539672` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AmbientRun/Ambient | Game Engine Game Dev | [open](webassembly-ambientrun-ambient-cf0678b7.md) |
| battlelinegames/ArtOfWasm | Game Engine Game Dev | [open](webassembly-battlelinegames-artofwasm-a7847c62.md) |
| boa-dev/boa | Game Engine Game Dev | [open](webassembly-boa-dev-boa-27f5e4a0.md) |
| ColinEberhardt/wasm-game-of-life | Game Engine Game Dev | [open](webassembly-colineberhardt-wasm-game-of-life-82167b9c.md) |
| MaxBittker/sandspiel | Game Engine Game Dev | [open](webassembly-maxbittker-sandspiel-36849093.md) |
| obeli-sk/obelisk | Game Engine Game Dev | [open](webassembly-obeli-sk-obelisk-c5fc4657.md) |
| Porting Games to the Web with WebAssembly (2019) | Game Engine Game Dev | [open](webassembly-porting-games-to-the-web-with-webassembly-2019-0fa6beb2.md) |
| wasvy-org/wasvy | Game Engine Game Dev | [open](webassembly-wasvy-org-wasvy-fa0894e6.md) |
