...
<!-- canonical: https://cran.r-project.org/web/packages/BayesNSGP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesNSGP/index.html](https://cran.r-project.org/web/packages/BayesNSGP/index.html) |
| Source record ids | cran_packages_by_date-e8e67102ca5f0d |
...
For a systems engineer, BayesNSGP belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-19 17:50:02 UTC | [https://cran.r-project.org/web/packages/BayesNSGP/DESCRIPTION](https://cran.r-project.org/web/packages/BayesNSGP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesNSGP/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e8e67102ca5f0d` from `cran_packages_by_date` as `registry_expansion`
