...
| Source record ids | github_search_maps-24741beae3809d |
...
For a systems engineer, devxoul/URLNavigator belongs in the Maps inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/devxoul/URLNavigator/releases/latest` at `2026-09-01T12:29:59+00:00`.
...
- `github_search_maps-24741beae3809d` from `github_search_maps` as `registry_expansion`
