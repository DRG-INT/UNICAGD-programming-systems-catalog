...
<!-- canonical: https://github.com/danpla/fontlink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danpla/fontlink](https://github.com/danpla/fontlink) |
| Source record ids | github_search_font_briefcase-d703549c3fee43 |

## System Engineer Summary

Program to install fonts temporarily on Unix-like systems

## Operational Role

For a systems engineer, danpla/fontlink belongs in the Font Briefcase inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-21T18:45:07Z | gh search repos topic:font-manager stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-d703549c3fee43` from `github_search_font_briefcase` as `registry_expansion`
