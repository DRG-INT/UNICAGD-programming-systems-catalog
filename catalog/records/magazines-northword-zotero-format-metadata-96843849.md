...
<!-- canonical: https://github.com/northword/zotero-format-metadata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/northword/zotero-format-metadata](https://github.com/northword/zotero-format-metadata) |
| Source record ids | github_search_magazines-b418208cecdcd5 |

## System Engineer Summary

Linter for Zotero. A plugin for Zotero to format item metadata. Shortcut to set title rich text; set
journal abbreviations, university places, and item languages, etc; detect duplicate items.

## Operational Role

For a systems engineer, northword/zotero-format-metadata belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T12:07:46Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-b418208cecdcd5` from `github_search_magazines` as `registry_expansion`
