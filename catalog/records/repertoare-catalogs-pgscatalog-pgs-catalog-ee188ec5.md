...
<!-- canonical: https://github.com/PGScatalog/PGS_Catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PGScatalog/PGS_Catalog](https://github.com/PGScatalog/PGS_Catalog) |
| Source record ids | github_search_repertoare_catalogs-dab0fda711e893 |

## System Engineer Summary

An open database of polygenic scores and relevant metadata needed to apply and evaluate them
correctly.

## Operational Role

For a systems engineer, PGScatalog/PGS_Catalog belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T15:07:53Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-dab0fda711e893` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Federico-Aguirre/Veterinaria_Laravel | Database Datastore | [open](repertoare-catalogs-federico-aguirre-veterinaria-laravel-0ef91b6e.md) |
