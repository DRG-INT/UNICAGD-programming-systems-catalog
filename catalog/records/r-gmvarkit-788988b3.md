...
<!-- canonical: https://cran.r-project.org/web/packages/gmvarkit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gmvarkit/index.html](https://cran.r-project.org/web/packages/gmvarkit/index.html) |
| Source record ids | cran_packages_by_date-efd6a7c3ed93a7 |
...
For a systems engineer, gmvarkit belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.2 | 2026-08-04 22:50:20 UTC | [https://cran.r-project.org/web/packages/gmvarkit/DESCRIPTION](https://cran.r-project.org/web/packages/gmvarkit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gmvarkit/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-efd6a7c3ed93a7` from `cran_packages_by_date` as `registry_expansion`
