...
<!-- canonical: https://github.com/WebAssembly/wasi-libc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-libc](https://github.com/WebAssembly/wasi-libc) |
| Source record ids | github_search_webassembly-2e195a8bbfaaef |
...
For a systems engineer, WebAssembly/wasi-libc belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T15:05:40Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; The Unlicense; https://api.github.com/licenses/unlicense; Other |
...
- `github_search_webassembly-2e195a8bbfaaef` from `github_search_webassembly` as `registry_expansion`
