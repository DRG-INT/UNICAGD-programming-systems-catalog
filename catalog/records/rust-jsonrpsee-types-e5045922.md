...
<!-- canonical: https://crates.io/crates/jsonrpsee-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/jsonrpsee-types](https://crates.io/crates/jsonrpsee-types) |
| Source record ids | crates_io-a5fba710462695 |
...
For a systems engineer, jsonrpsee-types belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.26.0 | 2026-05-27T17:18:52.674277Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
