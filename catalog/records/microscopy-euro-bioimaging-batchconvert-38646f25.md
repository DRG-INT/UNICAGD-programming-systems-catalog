...
<!-- canonical: https://github.com/Euro-BioImaging/BatchConvert -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Euro-BioImaging/BatchConvert](https://github.com/Euro-BioImaging/BatchConvert) |
| Source record ids | github_search_microscopy-a838d877f4ce01 |

## System Engineer Summary

A nextflow based tool that wraps bfconvert and bioformats2raw to convert image data collections to
OME-TIFF and OME-Zarr, respectively, in a parallelised manner.

## Operational Role

For a systems engineer, Euro-BioImaging/BatchConvert belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.0.4 | 2024-02-19T13:13:47Z | [https://api.github.com/repos/Euro-BioImaging/BatchConvert/releases/latest](https://api.github.com/repos/Euro-BioImaging/BatchConvert/releases/latest) |  |
| preview | known | v0.0.2 | 2023-09-06T13:49:15Z | [https://api.github.com/repos/Euro-BioImaging/BatchConvert/releases?per_page=10](https://api.github.com/repos/Euro-BioImaging/BatchConvert/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Euro-BioImaging/BatchConvert/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
- `github_search_microscopy-a838d877f4ce01` from `github_search_microscopy` as `registry_expansion`
