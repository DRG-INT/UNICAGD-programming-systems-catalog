...
<!-- canonical: https://hackage.haskell.org/package/text-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/text-builder](https://hackage.haskell.org/package/text-builder) |
| Source record ids | hackage_top_downloads-ff99defa316b42 |
...
For a systems engineer, text-builder belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.5 | 2026-01-02T12:43:16Z | [https://hackage.haskell.org/package/text-builder](https://hackage.haskell.org/package/text-builder) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/text-builder` at `2026-09-01T14:24:34+00:00`.
...
- `hackage_top_downloads-ff99defa316b42` from `hackage_top_downloads` as `registry_expansion`
