...
<!-- canonical: https://github.com/wradlib/wradlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wradlib/wradlib](https://github.com/wradlib/wradlib) |
| Source record ids | github_search_radars-51c65eacb3b8ef |
...
For a systems engineer, wradlib/wradlib belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.5 | 2026-07-15T07:01:20Z | [https://api.github.com/repos/wradlib/wradlib/releases/latest](https://api.github.com/repos/wradlib/wradlib/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wradlib/wradlib/releases/latest` at `2026-09-01T08:26:33+00:00`.
...
- `github_search_radars-51c65eacb3b8ef` from `github_search_radars` as `registry_expansion`
