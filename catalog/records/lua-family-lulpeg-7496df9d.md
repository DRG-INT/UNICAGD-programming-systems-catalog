...
<!-- canonical: https://github.com/pygy/LuLPeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pygy/LuLPeg](https://github.com/pygy/LuLPeg) |
| Source record ids | lua-source-260 |
...
For a systems engineer, LuLPeg belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 260}}` |
...
- `lua-source-260` from `master_json` as `source_list_item`
