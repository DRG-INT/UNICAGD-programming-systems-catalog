...
<!-- canonical: https://github.com/gigapi/gigapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gigapi/gigapi](https://github.com/gigapi/gigapi) |
| Source record ids | github_search_databases-5bcf3ff96dce00 |

## System Engineer Summary

GigAPI is a Timeseries lakehouse for real-time data and sub-second queries, powered by DuckDB OLAP +
Parquet Query Engine, Compactor w/ Cloud-Native Storage. Drop-in FDAP alternative ⭐

## Operational Role

For a systems engineer, gigapi/gigapi belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-20T12:01:02Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5bcf3ff96dce00` from `github_search_databases` as `registry_expansion`
