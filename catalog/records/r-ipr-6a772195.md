...
<!-- canonical: https://cran.r-project.org/web/packages/ipr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ipr/index.html](https://cran.r-project.org/web/packages/ipr/index.html) |
| Source record ids | cran_packages_by_date-fa9afafa841b75 |
...
For a systems engineer, ipr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-11 10:10:02 UTC | [https://cran.r-project.org/web/packages/ipr/DESCRIPTION](https://cran.r-project.org/web/packages/ipr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ipr/DESCRIPTION` at `2026-09-11T10:20:52+00:00`.
...
- `cran_packages_by_date-fa9afafa841b75` from `cran_packages_by_date` as `registry_expansion`
