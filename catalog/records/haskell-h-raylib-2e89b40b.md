...
<!-- canonical: https://hackage.haskell.org/package/h-raylib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/h-raylib](https://hackage.haskell.org/package/h-raylib) |
| Source record ids | hackage_recent-17f036b9189c3e |

## System Engineer Summary

Hackage package recently uploaded by Anut.

## Operational Role

For a systems engineer, h-raylib belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.0.0 | 2026-09-11T21:18:02Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-11T22:18:51+00:00`.
...
- `hackage_recent-17f036b9189c3e` from `hackage_recent` as `registry_expansion`
