...
<!-- canonical: https://github.com/sandstrom/country-bounding-boxes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sandstrom/country-bounding-boxes](https://github.com/sandstrom/country-bounding-boxes) |
| Source record ids | github_search_maps-45919035640560 |
...
For a systems engineer, sandstrom/country-bounding-boxes belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-06T08:52:09Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-45919035640560` from `github_search_maps` as `registry_expansion`
