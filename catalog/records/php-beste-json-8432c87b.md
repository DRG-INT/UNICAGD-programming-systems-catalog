...
| Canonical URL | [https://packagist.org/packages/beste/json](https://packagist.org/packages/beste/json) |
| Source record ids | packagist_search-a8647f61d7adf4 |
...
For a systems engineer, beste/json belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2025-09-11T23:39:55+00:00 | [https://repo.packagist.org/p2/beste/json.json](https://repo.packagist.org/p2/beste/json.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/beste/json.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-a8647f61d7adf4` from `packagist_search` as `registry_expansion`
