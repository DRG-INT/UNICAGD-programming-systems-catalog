...
<!-- canonical: https://github.com/ravynsoft/ravynos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ravynsoft/ravynos](https://github.com/ravynsoft/ravynos) |
| Source record ids | github_search_cocoa-1505c70ad68d08 |

## System Engineer Summary

An open-source OS project that aims to provide source and binary compatibility with macOS® and a
similar user experience.

## Operational Role

For a systems engineer, ravynsoft/ravynos belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T03:19:16Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-1505c70ad68d08` from `github_search_cocoa` as `registry_expansion`
