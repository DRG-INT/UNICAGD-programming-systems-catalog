# indieshade/Unity_Shader_Library_Zoroiscrying
...
<!-- canonical: https://github.com/indieshade/Unity_Shader_Library_Zoroiscrying -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/indieshade/Unity_Shader_Library_Zoroiscrying](https://github.com/indieshade/Unity_Shader_Library_Zoroiscrying) |
| Source record ids | github_search_effects-0839fd3258117f |

## System Engineer Summary

This is a shader library used for unity shader coding, pointing to different shader effects found
from various sources. Several library topics may become public in the future. This project is mainly
for personal study and lack the knowledge of code management and formal name formatting.

## Operational Role

For a systems engineer, indieshade/Unity_Shader_Library_Zoroiscrying belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-22T13:46:49Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0839fd3258117f` from `github_search_effects` as `registry_expansion`
