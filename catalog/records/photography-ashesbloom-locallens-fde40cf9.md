...
| Canonical URL | [https://github.com/ashesbloom/LocalLens](https://github.com/ashesbloom/LocalLens) |
| Source record ids | github_search_photography-978cdbe782f9df |

## System Engineer Summary

Local Lens is a privacy-first, AI-powered photo organizer for your PC. Sort and group photos by
faces, dates, and locations ...all locally, with no cloud upload and no Internet. ... 🫪 Now on
CLAUDE ☼ check below🔽

## Operational Role

For a systems engineer, ashesbloom/LocalLens belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.2 | 2026-08-22T17:34:15Z | [https://api.github.com/repos/ashesbloom/LocalLens/releases/latest](https://api.github.com/repos/ashesbloom/LocalLens/releases/latest) |  |
| preview | known | v2.4.0 | 2026-05-25T09:10:59Z | [https://api.github.com/repos/ashesbloom/LocalLens/releases?per_page=10](https://api.github.com/repos/ashesbloom/LocalLens/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ashesbloom/LocalLens/releases/latest` at `2026-09-01T09:23:28+00:00`.
...
- `github_search_photography-978cdbe782f9df` from `github_search_photography` as `registry_expansion`
