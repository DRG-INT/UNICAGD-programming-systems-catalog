...
<!-- canonical: https://github.com/Ardour/ardour -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ardour/ardour](https://github.com/Ardour/ardour) |
| Source record ids | github_search_audio-bc25fd0d1acea4 |
...
For a systems engineer, Ardour/ardour belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T17:14:07Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-bc25fd0d1acea4` from `github_search_audio` as `registry_expansion`
