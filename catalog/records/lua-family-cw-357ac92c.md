...
<!-- canonical: https://luarocks.org/modules/rrt/cw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/rrt/cw](https://luarocks.org/modules/rrt/cw) |
| Source record ids | luarocks_root_manifest-cbca08d5d461bf |
...
For a systems engineer, cw belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-cbca08d5d461bf` from `luarocks_root_manifest` as `registry_expansion`
