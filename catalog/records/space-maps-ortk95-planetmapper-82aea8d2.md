...
<!-- canonical: https://github.com/ortk95/planetmapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ortk95/planetmapper](https://github.com/ortk95/planetmapper) |
| Source record ids | github_search_space_maps-f9a420dab4fa9f |

## System Engineer Summary

PlanetMapper: An open source Python package for visualising, navigating and mapping Solar System
observations

## Operational Role

For a systems engineer, ortk95/planetmapper belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T09:00:02Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f9a420dab4fa9f` from `github_search_space_maps` as `registry_expansion`
