...
<!-- canonical: https://hackage.haskell.org/package/insert-ordered-containers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/insert-ordered-containers](https://hackage.haskell.org/package/insert-ordered-containers) |
| Source record ids | hackage_top_downloads-0f990994d50857 |
...
For a systems engineer, insert-ordered-containers belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-03-03T21:54:30Z | [https://hackage.haskell.org/package/insert-ordered-containers](https://hackage.haskell.org/package/insert-ordered-containers) |  |
| candidate | partial | 0.2.2 |  | [https://hackage.haskell.org/package/insert-ordered-containers](https://hackage.haskell.org/package/insert-ordered-containers) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/insert-ordered-containers` at `2026-09-05T00:31:55+00:00`.
...
- `hackage_top_downloads-0f990994d50857` from `hackage_top_downloads` as `registry_expansion`
