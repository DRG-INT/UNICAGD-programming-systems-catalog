...
| Canonical URL | [https://packagist.org/packages/boldtrn/jsonb-bundle](https://packagist.org/packages/boldtrn/jsonb-bundle) |
| Source record ids | packagist_search-bb5162a526889a |
...
For a systems engineer, boldtrn/jsonb-bundle belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2019-10-09T07:08:39+00:00 | [https://repo.packagist.org/p2/boldtrn/jsonb-bundle.json](https://repo.packagist.org/p2/boldtrn/jsonb-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/boldtrn/jsonb-bundle.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-bb5162a526889a` from `packagist_search` as `registry_expansion`
