...
<!-- canonical: https://crates.io/crates/matrixmultiply -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/matrixmultiply](https://crates.io/crates/matrixmultiply) |
| Source record ids | crates_io-4c85170a508920 |

## System Engineer Summary

General matrix multiplication for f32 and f64 matrices. Operates on matrices with general layout
(they can use arbitrary row and column stride). Detects and uses SIMD features on x86/x86-64 and
AArch64 transparently for higher performance. Uses a microkernel strategy, so that the
implementation is easy to parallelize and optimize. Supports multithreading.

## Operational Role

For a systems engineer, matrixmultiply belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.11 | 2026-07-14T18:10:37.161378Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `crates_io-4c85170a508920` from `crates_io` as `registry_expansion`
