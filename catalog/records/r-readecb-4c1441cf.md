...
<!-- canonical: https://cran.r-project.org/web/packages/readecb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/readecb/index.html](https://cran.r-project.org/web/packages/readecb/index.html) |
| Source record ids | cran_packages_by_date-a71483d76a832a |
...
For a systems engineer, readecb belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-09 10:40:07 UTC | [https://cran.r-project.org/web/packages/readecb/DESCRIPTION](https://cran.r-project.org/web/packages/readecb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/readecb/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-a71483d76a832a` from `cran_packages_by_date` as `registry_expansion`
