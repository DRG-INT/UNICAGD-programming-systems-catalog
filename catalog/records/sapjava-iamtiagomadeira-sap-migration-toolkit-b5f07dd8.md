# iamtiagomadeira/sap-migration-toolkit
...
<!-- canonical: https://github.com/iamtiagomadeira/sap-migration-toolkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iamtiagomadeira/sap-migration-toolkit](https://github.com/iamtiagomadeira/sap-migration-toolkit) |
| Source record ids | github_search_sapjava-911cdb43f46cef |

## System Engineer Summary

Stateless executor for SAP migration operations — checks & actions for HANA/ASE backup-restore,
tenant copy, HSR, and Java AS system copy.

## Operational Role

For a systems engineer, iamtiagomadeira/sap-migration-toolkit belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T12:11:44Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-911cdb43f46cef` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| KIBA-LABS/SmartUtilityManagement | Utility Library | [open](sapjava-kiba-labs-smartutilitymanagement-924928e5.md) |
