# dlecorre387/Planetary-Image-Processing

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dlecorre387/Planetary-Image-Processing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dlecorre387/Planetary-Image-Processing](https://github.com/dlecorre387/Planetary-Image-Processing) |
| Source record ids | github_search_space_maps-a84fa446778d2e |

## System Engineer Summary

A series of Bash scripts for processing raw planetary image products into calibrated and map-
projected GeoTiff files.

## Operational Role

For a systems engineer, dlecorre387/Planetary-Image-Processing belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-27T19:33:26Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; Other; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_space_maps-a84fa446778d2e` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| WernerDinges/VCIDSpice | Image Audio Dsp | [open](space-maps-wernerdinges-vcidspice-badf152c.md) |
