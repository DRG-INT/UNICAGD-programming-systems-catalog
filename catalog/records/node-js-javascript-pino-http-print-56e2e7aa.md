...
| Canonical URL | [https://www.npmjs.com/package/pino-http-print](https://www.npmjs.com/package/pino-http-print) |
| Source record ids | npm_registry-17ee86be833884 |
...
For a systems engineer, pino-http-print belongs in the Node.js/JavaScript inventory as part of fault
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2025-11-05T11:11:49.050Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @flatfile/utils-debugger | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-flatfile-utils-debugger-b3ec9c7c.md) |
| @graffy/testing | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-graffy-testing-b68ad75f.md) |
| @phenomnomnominal/debug | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-phenomnomnominal-debug-fee07b5f.md) |
| @probe.gl/log | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-probe-gl-log-6d2d59ee.md) |
| @stacksjs/clarity | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-stacksjs-clarity-ea825823.md) |
| axios-debug-log | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-axios-debug-log-07a28227.md) |
| google-logging-utils | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-google-logging-utils-77de47f7.md) |
| pino-debug | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-pino-debug-ced9ed59.md) |
