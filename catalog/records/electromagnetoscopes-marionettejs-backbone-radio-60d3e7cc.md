...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/marionettejs/backbone.radio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marionettejs/backbone.radio](https://github.com/marionettejs/backbone.radio) |
| Source record ids | github_search_electromagnetoscopes-8bca1d9ab32c30 |
...
For a systems engineer, marionettejs/backbone.radio belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-12T17:50:18Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-09 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:radio stars:>100", "retrieved": "2026-09-09", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-8bca1d9ab32c30` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acyucel/VoxHenry | Library | [open](electromagnetoscopes-acyucel-voxhenry-e098e124.md) |
| AlbrechtL/welle.io | Library | [open](electromagnetoscopes-albrechtl-welle-io-1ed8e849.md) |
| alex-faustino/Mag-Cal | Library | [open](electromagnetoscopes-alex-faustino-mag-cal-0249f0e5.md) |
| alicjamusial/turnstile-antenna-3D | Library | [open](electromagnetoscopes-alicjamusial-turnstile-antenna-3d-be8408ee.md) |
| alimoncul/piController | Library | [open](electromagnetoscopes-alimoncul-picontroller-9510e5c5.md) |
| andre-batista/eispy2d | Library | [open](electromagnetoscopes-andre-batista-eispy2d-8658f386.md) |
| andre-batista/Microwave-Imaging | Library | [open](electromagnetoscopes-andre-batista-microwave-imaging-337d4415.md) |
| beamzorg/beamz | Library | [open](electromagnetoscopes-beamzorg-beamz-a88f7bef.md) |
