...
<!-- canonical: https://github.com/chiaweihsu/RGF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chiaweihsu/RGF](https://github.com/chiaweihsu/RGF) |
| Source record ids | github_search_electromagnetoscopes-4b03d78db9a29e |

## System Engineer Summary

2D and 3D scalar finite-difference frequency-domain solver of the scattering matrix with the
recursive Green's function method.

## Operational Role

For a systems engineer, chiaweihsu/RGF belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-22T20:28:02Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-4b03d78db9a29e` from `github_search_electromagnetoscopes` as `registry_expansion`
