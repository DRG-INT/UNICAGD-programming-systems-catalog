...
<!-- canonical: https://gitlab.com/vijai/SqliteDBViewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/vijai/SqliteDBViewer](https://gitlab.com/vijai/SqliteDBViewer) |
| Source record ids | gitlab_projects_api-b9d7cbf5fcff37 |

## System Engineer Summary

An opensource SQLite database viewer for android

## Operational Role

For a systems engineer, vijai/SqliteDBViewer belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-b9d7cbf5fcff37` from `gitlab_projects_api` as `registry_expansion`
