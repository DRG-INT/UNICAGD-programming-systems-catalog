# rbessinger/cleancheck

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rbessinger/cleancheck -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rbessinger/cleancheck](https://github.com/rbessinger/cleancheck) |
| Source record ids | github_search_repertoare_catalogs-4c72e0d9cf6ec1 |

## System Engineer Summary

Instant explicit-content screening for DJs. Check songs, Serato crates, and rekordbox playlists
against official catalog ratings.

## Operational Role

For a systems engineer, rbessinger/cleancheck belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-11T23:13:53Z | gh search repos setlist catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-4c72e0d9cf6ec1` from `github_search_repertoare_catalogs` as `registry_expansion`
