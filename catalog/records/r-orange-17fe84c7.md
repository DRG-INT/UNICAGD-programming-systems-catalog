...
<!-- canonical: https://cran.r-project.org/web/packages/orange/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/orange/index.html](https://cran.r-project.org/web/packages/orange/index.html) |
| Source record ids | cran_packages_by_date-dd800d690dcf09 |
...
For a systems engineer, orange belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 10:50:14 UTC | [https://cran.r-project.org/web/packages/orange/DESCRIPTION](https://cran.r-project.org/web/packages/orange/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/orange/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-dd800d690dcf09` from `cran_packages_by_date` as `registry_expansion`
