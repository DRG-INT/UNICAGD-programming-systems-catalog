...
<!-- canonical: https://pub.dev/packages/curved_navigation_bar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/curved_navigation_bar](https://pub.dev/packages/curved_navigation_bar) |
| Source record ids | pub_dev-62cd9a3a8e0b89 |

## System Engineer Summary

Stunning Animating Curved Shape Navigation Bar. Adjustable color, background color, animation curve,
animation duration.

## Operational Role

For a systems engineer, curved_navigation_bar belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2024-06-13T08:52:48.416005Z | [https://pub.dev/api/packages/curved_navigation_bar](https://pub.dev/api/packages/curved_navigation_bar) |  |
| preview | known | 0.4.0-nullsafety.0 | 2020-11-19T19:52:43.513244Z | [https://pub.dev/api/packages/curved_navigation_bar](https://pub.dev/api/packages/curved_navigation_bar) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/curved_navigation_bar` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-62cd9a3a8e0b89` from `pub_dev` as `registry_expansion`
