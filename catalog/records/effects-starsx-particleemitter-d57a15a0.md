...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/StarsX/ParticleEmitter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/StarsX/ParticleEmitter](https://github.com/StarsX/ParticleEmitter) |
| Source record ids | github_search_effects-87dfe400a1135e |

## System Engineer Summary

An improved implementation of my CASA 2013 paper "Real‐time generation of smoothed‐particle
hydrodynamics‐based special effects in character animation" . Particle emissions from the surface of
mesh. The emitters are approximatively uniformly distributed by taking the advantage of quad
tessellations. The fluid is simulated by SPH using my prefix-sum bin sorting.

## Operational Role

For a systems engineer, StarsX/ParticleEmitter belongs in the Effects inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-10T02:37:03Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-02 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:particle-system stars:>20", "retrieved": "2026-09-02", "status": "forge-cli-derived"}` |
...
- `github_search_effects-87dfe400a1135e` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acorderob/sd-webui-prompt-postprocessor | Networking Http | [open](effects-acorderob-sd-webui-prompt-postprocessor-2b3288cd.md) |
| adobe-research/MetaAF | Networking Http | [open](effects-adobe-research-metaaf-d8172358.md) |
| apohl79/audiogridder | Networking Http | [open](effects-apohl79-audiogridder-8e0db5f2.md) |
| danlivings/oil-painting-effect-shader-unity | Networking Http | [open](effects-danlivings-oil-painting-effect-shader-unity-4c047066.md) |
| iver56/cross-adaptive-audio | Networking Http | [open](effects-iver56-cross-adaptive-audio-881c9d13.md) |
| jankohlbach/real-world-shader | Networking Http | [open](effects-jankohlbach-real-world-shader-081dc1c5.md) |
| maajor/NeuralNetworkPostProcessing | Networking Http | [open](effects-maajor-neuralnetworkpostprocessing-04e8e17b.md) |
| Prateek61/WayShade | Networking Http | [open](effects-prateek61-wayshade-46d90663.md) |
