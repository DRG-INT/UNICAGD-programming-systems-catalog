...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/2013fangwentao/Multi_Sensor_Fusion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2013fangwentao/Multi_Sensor_Fusion](https://github.com/2013fangwentao/Multi_Sensor_Fusion) |
| Source record ids | github_search_radars-27b538637487b5 |
...
For a systems engineer, 2013fangwentao/Multi_Sensor_Fusion belongs in the Radars inventory as part
of device constraints, cross-compilation, driver behavior, and field upgrades.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-07T03:23:44Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:gnss stars:>20", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_radars-27b538637487b5` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Aceinna/gnss-ins-sim | Embedded Hardware | [open](radars-aceinna-gnss-ins-sim-f63e4c46.md) |
| bopen/sarsen | Embedded Hardware | [open](radars-bopen-sarsen-20870959.md) |
| fanweng/Udacity-Sensor-Fusion-Nanodegree | Embedded Hardware | [open](radars-fanweng-udacity-sensor-fusion-nanodegree-475e3016.md) |
| JunshengFu/tracking-with-Extended-Kalman-Filter | Embedded Hardware | [open](radars-junshengfu-tracking-with-extended-kalman-filter-b9a78f6a.md) |
| m6c7l/pymmw | Embedded Hardware | [open](radars-m6c7l-pymmw-dccd876e.md) |
| mithi/fusion-ekf | Embedded Hardware | [open](radars-mithi-fusion-ekf-fce69980.md) |
| mithi/fusion-ukf | Embedded Hardware | [open](radars-mithi-fusion-ukf-78e879a8.md) |
| ser94mor/sensor-fusion | Embedded Hardware | [open](radars-ser94mor-sensor-fusion-a71e7296.md) |
