...
<!-- canonical: https://github.com/wingify/lua-resty-rabbitmqstomp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wingify/lua-resty-rabbitmqstomp](https://github.com/wingify/lua-resty-rabbitmqstomp) |
| Source record ids | lua-source-311 |
...
For a systems engineer, lua-resty-rabbitmqstomp belongs in the Lua family inventory as part of
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 311}}` |
...
- `lua-source-311` from `master_json` as `source_list_item`
