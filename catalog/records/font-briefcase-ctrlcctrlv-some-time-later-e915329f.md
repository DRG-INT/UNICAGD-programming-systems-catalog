# ctrlcctrlv/some-time-later

## Navigation

[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ctrlcctrlv/some-time-later -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ctrlcctrlv/some-time-later](https://github.com/ctrlcctrlv/some-time-later) |
| Source record ids | github_search_font_briefcase-5fcb7463a2d987 |
...
For a systems engineer, ctrlcctrlv/some-time-later belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-14T20:47:28Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | European Union Public License 1.2; https://api.github.com/licenses/eupl-1.2; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `github_search_font_briefcase-5fcb7463a2d987` from `github_search_font_briefcase` as `registry_expansion`
