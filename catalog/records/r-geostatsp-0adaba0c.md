...
<!-- canonical: https://cran.r-project.org/web/packages/geostatsp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geostatsp/index.html](https://cran.r-project.org/web/packages/geostatsp/index.html) |
| Source record ids | cran_packages_by_date-d96502edbb00b3 |
...
For a systems engineer, geostatsp belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-09-10 16:50:06 UTC | [https://cran.r-project.org/web/packages/geostatsp/DESCRIPTION](https://cran.r-project.org/web/packages/geostatsp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geostatsp/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-d96502edbb00b3` from `cran_packages_by_date` as `registry_expansion`
