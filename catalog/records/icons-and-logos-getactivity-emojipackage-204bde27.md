...
<!-- canonical: https://github.com/getActivity/EmojiPackage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/getActivity/EmojiPackage](https://github.com/getActivity/EmojiPackage) |
| Source record ids | github_search_icons_and_logos-a1765b5b56f039 |

## System Engineer Summary

getActivity/EmojiPackage is tracked as a library record in the Icons and Logos branch. The source
...
For a systems engineer, getActivity/EmojiPackage belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-02T06:32:36Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-a1765b5b56f039` from `github_search_icons_and_logos` as `registry_expansion`
