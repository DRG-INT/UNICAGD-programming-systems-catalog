...
<!-- canonical: https://github.com/georust/geo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/georust/geo](https://github.com/georust/geo) |
| Source record ids | github_search_maps-c47d3023eb3613 |
...
For a systems engineer, georust/geo belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T23:05:27Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-c47d3023eb3613` from `github_search_maps` as `registry_expansion`
