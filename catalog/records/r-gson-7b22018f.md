...
<!-- canonical: https://cran.r-project.org/web/packages/gson/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gson/index.html](https://cran.r-project.org/web/packages/gson/index.html) |
| Source record ids | cran_packages_by_date-7cbf92220f36f7 |
...
For a systems engineer, gson belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-04 20:00:16 UTC | [https://cran.r-project.org/web/packages/gson/DESCRIPTION](https://cran.r-project.org/web/packages/gson/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gson/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7cbf92220f36f7` from `cran_packages_by_date` as `registry_expansion`
