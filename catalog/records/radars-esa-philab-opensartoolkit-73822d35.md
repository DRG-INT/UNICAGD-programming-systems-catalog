...
<!-- canonical: https://github.com/ESA-PhiLab/OpenSarToolkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ESA-PhiLab/OpenSarToolkit](https://github.com/ESA-PhiLab/OpenSarToolkit) |
| Source record ids | github_search_radars-c5c05fa4d0aa56 |

## System Engineer Summary

High-level functionality for the inventory, download and pre-processing of Sentinel-1 data in the
python language.

## Operational Role

For a systems engineer, ESA-PhiLab/OpenSarToolkit belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-04T11:00:59Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c5c05fa4d0aa56` from `github_search_radars` as `registry_expansion`
