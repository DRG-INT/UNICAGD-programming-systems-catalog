...
<!-- canonical: https://luarocks.org/modules/neorocks/copilot-cmp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/copilot-cmp](https://luarocks.org/modules/neorocks/copilot-cmp) |
| Source record ids | luarocks_root_manifest-4d25cb32659ae5 |
...
For a systems engineer, copilot-cmp belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4d25cb32659ae5` from `luarocks_root_manifest` as `registry_expansion`
