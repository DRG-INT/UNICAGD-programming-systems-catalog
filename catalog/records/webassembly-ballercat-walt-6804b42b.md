...
<!-- canonical: https://github.com/ballercat/walt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ballercat/walt](https://github.com/ballercat/walt) |
| Source record ids | github_search_webassembly-369a2758f272c2 |
...
For a systems engineer, ballercat/walt belongs in the WebAssembly inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-02T16:57:45Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-369a2758f272c2` from `github_search_webassembly` as `registry_expansion`
