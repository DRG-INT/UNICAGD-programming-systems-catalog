...
| Canonical URL | [https://catalog.loc.gov/](https://catalog.loc.gov/) |
| Source record ids | curated_language_routes-e790d6b42ae357 |

## System Engineer Summary

Library catalog route for works, editions, subjects, names, authority data, and archival references.

## Operational Role

For a systems engineer, Library of Congress Catalog belongs in the Repertoare Catalogs inventory as
...
- `curated_language_routes-e790d6b42ae357` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| IMSLP | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-imslp-5a052cec.md) |
| MusicBrainz | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-musicbrainz-d1f52271.md) |
| Open Library | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-open-library-8d085682.md) |
| OpenAlex | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-openalex-4d2b080b.md) |
| Project Gutenberg | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-project-gutenberg-9c8c6f9d.md) |
| Wikidata | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-wikidata-8e541c2c.md) |
| WorldCat | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repertoare-catalogs-worldcat-4a39de5b.md) |
