...
<!-- canonical: https://cran.r-project.org/web/packages/DPQ/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DPQ/index.html](https://cran.r-project.org/web/packages/DPQ/index.html) |
| Source record ids | cran_packages_by_date-45ed5426ce6c87 |
...
For a systems engineer, DPQ belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6-2 | 2026-09-06 11:00:10 UTC | [https://cran.r-project.org/web/packages/DPQ/DESCRIPTION](https://cran.r-project.org/web/packages/DPQ/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DPQ/DESCRIPTION` at `2026-09-06T12:23:08+00:00`.
...
- `cran_packages_by_date-45ed5426ce6c87` from `cran_packages_by_date` as `registry_expansion`
