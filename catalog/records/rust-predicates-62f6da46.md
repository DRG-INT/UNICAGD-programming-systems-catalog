...
<!-- canonical: https://crates.io/crates/predicates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/predicates](https://crates.io/crates/predicates) |
| Source record ids | crates_io-9f9f12d7a2f9be |
...
For a systems engineer, predicates belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.4 | 2026-02-11T14:41:47.203240Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-9f9f12d7a2f9be` from `crates_io` as `registry_expansion`
