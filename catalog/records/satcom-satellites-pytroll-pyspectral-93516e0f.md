...
<!-- canonical: https://github.com/pytroll/pyspectral -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pytroll/pyspectral](https://github.com/pytroll/pyspectral) |
| Source record ids | github_search_satcom_satellites-d08187398aae62 |

## System Engineer Summary

Pyspectral is a package to read and manipulate satellite sensor spectral responses and solar
irradiance spectra

## Operational Role

For a systems engineer, pytroll/pyspectral belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T17:23:40Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-d08187398aae62` from `github_search_satcom_satellites` as `registry_expansion`
