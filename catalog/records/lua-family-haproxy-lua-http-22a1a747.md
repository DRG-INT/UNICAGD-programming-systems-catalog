...
| Canonical URL | [https://luarocks.org/modules/elfranne/haproxy-lua-http](https://luarocks.org/modules/elfranne/haproxy-lua-http) |
| Source record ids | luarocks_root_manifest-10d9014ce6b049 |
...
For a systems engineer, haproxy-lua-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-10d9014ce6b049` from `luarocks_root_manifest` as `registry_expansion`
