...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-http](https://luarocks.org/modules/moyu/dromozoa-http) |
| Source record ids | luarocks_root_manifest-545201039e7f24 |

## System Engineer Summary

dromozoa-http is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, dromozoa-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-545201039e7f24` from `luarocks_root_manifest` as `registry_expansion`
