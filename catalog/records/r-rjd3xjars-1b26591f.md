...
<!-- canonical: https://cran.r-project.org/web/packages/rjd3xjars/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rjd3xjars/index.html](https://cran.r-project.org/web/packages/rjd3xjars/index.html) |
| Source record ids | cran_packages_by_date-5310543074b96e |
...
For a systems engineer, rjd3xjars belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-20 22:50:02 UTC | [https://cran.r-project.org/web/packages/rjd3xjars/DESCRIPTION](https://cran.r-project.org/web/packages/rjd3xjars/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rjd3xjars/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5310543074b96e` from `cran_packages_by_date` as `registry_expansion`
