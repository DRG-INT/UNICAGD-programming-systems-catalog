...
<!-- canonical: https://github.com/streetcomplete/StreetComplete -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/streetcomplete/StreetComplete](https://github.com/streetcomplete/StreetComplete) |
| Source record ids | github_search_maps-67e62aa76fb435 |
...
For a systems engineer, streetcomplete/StreetComplete belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:06:44Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-67e62aa76fb435` from `github_search_maps` as `registry_expansion`
