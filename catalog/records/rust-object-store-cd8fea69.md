...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Machine Learning](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/machine-learning.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/object_store](https://crates.io/crates/object_store) |
| Source record ids | crates_io-0450ce2f78006b |

## System Engineer Summary

A generic object store interface for uniformly interacting with AWS S3, Google Cloud Storage, Azure
Blob Storage and local files.

## Operational Role

For a systems engineer, object_store belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.1 | 2026-07-15T12:19:06.555622Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| addr | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-addr-ef20923e.md) |
| aligned-vec | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aligned-vec-6c5bb0c5.md) |
| arbitrary | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-arbitrary-70eab534.md) |
| ark-bls12-381 | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-bls12-381-822d8f1d.md) |
| ark-bn254 | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-bn254-ae21784a.md) |
| ark-ec | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-ec-fc62447d.md) |
| as-raw-xcb-connection | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-as-raw-xcb-connection-2a7bc247.md) |
| askama_escape | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-askama-escape-a45b4c20.md) |
