...
| Canonical URL | [https://packagist.org/packages/doctrine/doctrine-bundle](https://packagist.org/packages/doctrine/doctrine-bundle) |
| Source record ids | packagist_search-c078cde0392080 |

## System Engineer Summary

doctrine/doctrine-bundle is tracked as a database datastore record in the PHP branch. The source did
...
For a systems engineer, doctrine/doctrine-bundle belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.19.0 | 2026-07-23T15:15:39+00:00 | [https://repo.packagist.org/p2/doctrine/doctrine-bundle.json](https://repo.packagist.org/p2/doctrine/doctrine-bundle.json) |  |
| preview | known | 1.12.0-Beta1 | 2019-11-12T18:26:15+00:00 | [https://repo.packagist.org/p2/doctrine/doctrine-bundle.json](https://repo.packagist.org/p2/doctrine/doctrine-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/doctrine/doctrine-bundle.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-c078cde0392080` from `packagist_search` as `registry_expansion`
