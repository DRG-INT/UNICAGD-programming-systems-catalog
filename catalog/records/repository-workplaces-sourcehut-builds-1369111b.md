...
| Canonical URL | [https://builds.sr.ht/](https://builds.sr.ht/) |
| Source record ids | curated_repository_workplace_routes-634fe4c4dc3bac |

## System Engineer Summary

sourcehut continuous integration and build automation service.

## Operational Role

For a systems engineer, sourcehut builds belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-634fe4c4dc3bac` from `curated_repository_workplace_routes` as `registry_expansion`
