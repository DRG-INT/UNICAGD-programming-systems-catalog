...
<!-- canonical: https://cran.r-project.org/web/packages/projectLSA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/projectLSA/index.html](https://cran.r-project.org/web/packages/projectLSA/index.html) |
| Source record ids | cran_packages_by_date-a9215020004b99 |
...
For a systems engineer, projectLSA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-22 09:20:08 UTC | [https://cran.r-project.org/web/packages/projectLSA/DESCRIPTION](https://cran.r-project.org/web/packages/projectLSA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/projectLSA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a9215020004b99` from `cran_packages_by_date` as `registry_expansion`
