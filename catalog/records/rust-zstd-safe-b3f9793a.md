...
<!-- canonical: https://crates.io/crates/zstd-safe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zstd-safe](https://crates.io/crates/zstd-safe) |
| Source record ids | crates_io-e1b1f873a2d114 |
...
For a systems engineer, zstd-safe belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.0 | 2026-09-04T14:31:21.134134Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-04T15:20:09+00:00`.
...
- `crates_io-e1b1f873a2d114` from `crates_io` as `registry_expansion`
