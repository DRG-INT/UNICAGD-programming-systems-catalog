...
<!-- canonical: https://github.com/ProjectKumo/KumoApp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ProjectKumo/KumoApp](https://github.com/ProjectKumo/KumoApp) |
| Source record ids | github_search_swift-38e423706d577b |

## System Engineer Summary

A calm, native macOS client for the Mihomo proxy core, built with SwiftUI and a shared agent-
friendly CLI.

## Operational Role

For a systems engineer, ProjectKumo/KumoApp belongs in the Swift inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-05T17:08:02Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-38e423706d577b` from `github_search_swift` as `registry_expansion`
