...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://search.nixos.org/packages -->
<!-- crawl-delay: 10 -->
...
| Evidence | MIT; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
| Name | Category | Page |
| --- | --- | --- |
| Nix Source Route | Registry Repository | [open](nix-nix-source-route-42c0577b.md) |
| NixOS Options Search | Registry Repository | [open](nix-nixos-options-search-c44129a3.md) |
| Nixpkgs | Registry Repository | [open](nix-nixpkgs-35786f68.md) |
