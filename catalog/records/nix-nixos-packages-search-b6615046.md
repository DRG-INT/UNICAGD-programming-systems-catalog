...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: nix](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/nix.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://search.nixos.org/packages](https://search.nixos.org/packages) |
| Source record ids | curated_language_routes-62ad950f1aa10e |

## System Engineer Summary

Official NixOS package search interface for package names, versions, attributes, platforms, and
maintainers.

## Operational Role

For a systems engineer, NixOS Packages Search belongs in the nix inventory as part of ecosystem
...
- `curated_language_routes-62ad950f1aa10e` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Nix Source Route | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/nix-nix-source-route-42c0577b.md) |
| NixOS Options Search | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/nix-nixos-options-search-c44129a3.md) |
| Nixpkgs | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/nix-nixpkgs-35786f68.md) |
