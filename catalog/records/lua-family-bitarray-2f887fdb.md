...
<!-- canonical: https://luarocks.org/modules/cleoold/bitarray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cleoold/bitarray](https://luarocks.org/modules/cleoold/bitarray) |
| Source record ids | luarocks_root_manifest-15099b96a1a7e8 |
...
For a systems engineer, bitarray belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-15099b96a1a7e8` from `luarocks_root_manifest` as `registry_expansion`
