...
<!-- canonical: https://github.com/moby/moby -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/moby/moby](https://github.com/moby/moby) |
| Source record ids | github_search_assembly-d0c534c2fab738 |

## System Engineer Summary

The Moby Project - a collaborative project for the container ecosystem to assemble container-based
systems

## Operational Role

For a systems engineer, moby/moby belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T17:30:56Z | gh search repos assembler stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-d0c534c2fab738` from `github_search_assembly` as `registry_expansion`
