...
<!-- canonical: https://cran.r-project.org/web/packages/rix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rix/index.html](https://cran.r-project.org/web/packages/rix/index.html) |
| Source record ids | cran_packages_by_date-287882bea78496 |
...
For a systems engineer, rix belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.5 | 2026-08-26 09:00:02 UTC | [https://cran.r-project.org/web/packages/rix/DESCRIPTION](https://cran.r-project.org/web/packages/rix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rix/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-287882bea78496` from `cran_packages_by_date` as `registry_expansion`
