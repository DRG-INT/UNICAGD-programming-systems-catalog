...
<!-- canonical: https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html) |
| Source record ids | curated_language_routes-f86bc57ec38c71 |

## System Engineer Summary

Cloud architecture doctrine for operational excellence, security, reliability, performance
efficiency, cost, and sustainability.

## Operational Role

For a systems engineer, AWS Well-Architected Framework belongs in the Doctrines inventory as part of
...
- `curated_language_routes-f86bc57ec38c71` from `curated_language_routes` as `registry_expansion`
