...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CompetingClocks](https://github.com/JuliaRegistries/General/tree/master/C/CompetingClocks) |
| Source record ids | julia_general-b9486feb573f25 |

## System Engineer Summary

Julia package registered in General at C/CompetingClocks.

## Operational Role

For a systems engineer, CompetingClocks belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CompetingClocks", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b9486feb573f25` from `julia_general` as `registry_expansion`
