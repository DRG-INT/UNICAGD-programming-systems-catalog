...
<!-- canonical: https://github.com/ProfessionalWiki/Maps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ProfessionalWiki/Maps](https://github.com/ProfessionalWiki/Maps) |
| Source record ids | github_search_maps-4f03d30e8ec225 |

## System Engineer Summary

🗺 Maps is the MediaWiki extension that enables visualization of geographic data via dynamic embedded
maps.

## Operational Role

For a systems engineer, ProfessionalWiki/Maps belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 14.1.1 | 2026-07-30T22:49:45Z | [https://api.github.com/repos/ProfessionalWiki/Maps/releases/latest](https://api.github.com/repos/ProfessionalWiki/Maps/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ProfessionalWiki/Maps/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-4f03d30e8ec225` from `github_search_maps` as `registry_expansion`
...
| opnsense/core | Visualization Gui | [open](maps-opnsense-core-374c7983.md) |
| QGIS | Visualization Gui | [open](maps-qgis-23704893.md) |
