...
<!-- canonical: https://luarocks.org/modules/iassael/decomposition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/iassael/decomposition](https://luarocks.org/modules/iassael/decomposition) |
| Source record ids | luarocks_root_manifest-1a69ba73113a1d |
...
For a systems engineer, decomposition belongs in the Lua family inventory as part of ecosystem
...
| Evidence | Apache; License :: OSI Approved :: Apache Software License |
...
- `luarocks_root_manifest-1a69ba73113a1d` from `luarocks_root_manifest` as `registry_expansion`
