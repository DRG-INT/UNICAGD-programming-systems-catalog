...
<!-- canonical: https://github.com/Snikimonkd/telescope-git-conflicts.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Snikimonkd/telescope-git-conflicts.nvim](https://github.com/Snikimonkd/telescope-git-conflicts.nvim) |
| Source record ids | github_search_telescopes-0f552d48f38af7 |
...
For a systems engineer, Snikimonkd/telescope-git-conflicts.nvim belongs in the Telescopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-14T11:59:28Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-0f552d48f38af7` from `github_search_telescopes` as `registry_expansion`
