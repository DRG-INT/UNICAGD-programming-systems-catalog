...
<!-- canonical: https://github.com/gnachman/iTerm2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gnachman/iTerm2](https://github.com/gnachman/iTerm2) |
| Source record ids | github_search_cocoa-e1f8563cbb8f4d |
...
For a systems engineer, gnachman/iTerm2 belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T07:08:35Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Objective-C stars:>1000", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_cocoa-e1f8563cbb8f4d` from `github_search_cocoa` as `registry_expansion`
...
| Esqarrouth/EZSwiftExtensions | Language Specification | [open](cocoa-esqarrouth-ezswiftextensions-cfddd979.md) |
| Hammerspoon/hammerspoon | Language Specification | [open](cocoa-hammerspoon-hammerspoon-1d35b69a.md) |
| jdg/MBProgressHUD | Language Specification | [open](cocoa-jdg-mbprogresshud-e13b5233.md) |
| keycastr/keycastr | Language Specification | [open](cocoa-keycastr-keycastr-f4c776a3.md) |
| MustangYM/WeChatExtension-ForMac | Language Specification | [open](cocoa-mustangym-wechatextension-formac-fcd2c960.md) |
| opa334/TrollStore | Language Specification | [open](cocoa-opa334-trollstore-db62b321.md) |
