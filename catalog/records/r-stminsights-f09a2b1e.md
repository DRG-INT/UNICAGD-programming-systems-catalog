...
<!-- canonical: https://cran.r-project.org/web/packages/stminsights/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stminsights/index.html](https://cran.r-project.org/web/packages/stminsights/index.html) |
| Source record ids | cran_packages_by_date-f31bd9917b5dc2 |
...
For a systems engineer, stminsights belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.4 | 2026-09-02 17:10:02 UTC | [https://cran.r-project.org/web/packages/stminsights/DESCRIPTION](https://cran.r-project.org/web/packages/stminsights/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stminsights/DESCRIPTION` at `2026-09-02T17:18:40+00:00`.
...
- `cran_packages_by_date-f31bd9917b5dc2` from `cran_packages_by_date` as `registry_expansion`
