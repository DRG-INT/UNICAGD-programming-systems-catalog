...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/crandep/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crandep/index.html](https://cran.r-project.org/web/packages/crandep/index.html) |
| Source record ids | cran_packages_by_date-4e5bd7bffe7b95 |
...
For a systems engineer, crandep belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.14 | 2026-09-03 16:00:02 UTC | [https://cran.r-project.org/web/packages/crandep/DESCRIPTION](https://cran.r-project.org/web/packages/crandep/DESCRIPTION) |  |
...
| Evidence | MIT; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crandep/DESCRIPTION` at `2026-09-03T17:18:57+00:00`.
...
- `cran_packages_by_date-4e5bd7bffe7b95` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| attachment | Dependency Manager | [open](r-attachment-4b2b8e69.md) |
| getaca | Dependency Manager | [open](r-getaca-f9f6085c.md) |
| MultiSEp | Dependency Manager | [open](r-multisep-81b015ca.md) |
