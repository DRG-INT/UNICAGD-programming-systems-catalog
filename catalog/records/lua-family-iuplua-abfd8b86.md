...
| Canonical URL | [https://luarocks.org/modules/fsantanna/iuplua](https://luarocks.org/modules/fsantanna/iuplua) |
| Source record ids | luarocks_root_manifest-7e734c849ab839 |

## System Engineer Summary

IUP Lua binding - portable GUI toolkit (Tecgraf/PUC-Rio)

## Operational Role

For a systems engineer, iuplua belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-7e734c849ab839` from `luarocks_root_manifest` as `registry_expansion`
