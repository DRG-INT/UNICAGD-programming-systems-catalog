...
<!-- canonical: https://cran.r-project.org/web/packages/bayess/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayess/index.html](https://cran.r-project.org/web/packages/bayess/index.html) |
| Source record ids | cran_packages_by_date-ca903b51a2832f |
...
For a systems engineer, bayess belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7 | 2026-08-28 09:50:37 UTC | [https://cran.r-project.org/web/packages/bayess/DESCRIPTION](https://cran.r-project.org/web/packages/bayess/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayess/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ca903b51a2832f` from `cran_packages_by_date` as `registry_expansion`
