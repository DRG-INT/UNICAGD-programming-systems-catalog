...
<!-- canonical: https://github.com/Radio-Source/RadioSkyMap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Radio-Source/RadioSkyMap](https://github.com/Radio-Source/RadioSkyMap) |
| Source record ids | github_search_space_maps-585ad457f8faa1 |

## System Engineer Summary

RadioSkyMap is an desktop application designed for radio astronomy enthusiasts and amateur
astronomers. It provides a real-time sky map with (azimuth/elevation) overlaid with Neutral Hydrogen
(HI) emission data, 408 MHz synchrotron continuum maps, and major celestial radio source catalogs
(such as 3CR, Parkes, and G4Jy).

## Operational Role

For a systems engineer, Radio-Source/RadioSkyMap belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T15:27:13Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-585ad457f8faa1` from `github_search_space_maps` as `registry_expansion`
