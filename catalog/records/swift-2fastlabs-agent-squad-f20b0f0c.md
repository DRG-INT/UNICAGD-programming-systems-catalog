...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/2FastLabs/agent-squad -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2FastLabs/agent-squad](https://github.com/2FastLabs/agent-squad) |
| Source record ids | github_search_swift-abc08372d72b4d |
...
For a systems engineer, 2FastLabs/agent-squad belongs in the Swift inventory as part of interface
...
- `github_search_swift-abc08372d72b4d` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| NativeScript/NativeScript | Type Checker | [open](swift-nativescript-nativescript-2f4e3a6a.md) |
