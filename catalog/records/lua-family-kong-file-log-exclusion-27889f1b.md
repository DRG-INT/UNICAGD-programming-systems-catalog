...
| Canonical URL | [https://luarocks.org/modules/paymaya/kong-file-log-exclusion](https://luarocks.org/modules/paymaya/kong-file-log-exclusion) |
| Source record ids | luarocks_root_manifest-ead13a125eab00 |

## System Engineer Summary

Kong file logging plugin with options to exclude logged attributes.

## Operational Role

For a systems engineer, kong-file-log-exclusion belongs in the Lua family inventory as part of
...
| Name | Category | Page |
| --- | --- | --- |
| 30log | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-30log-8b4792fd.md) |
| alogger | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-alogger-0e7144fd.md) |
| BioLua | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-biolua-ee5da90c.md) |
| cipher-log | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cipher-log-11cba85e.md) |
| codedash | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-codedash-64de2629.md) |
| CognitioLogger | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cognitiologger-a17a644e.md) |
| coronalog | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-coronalog-800dca38.md) |
| gt-mp-prometheus-plugin | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gt-mp-prometheus-plugin-0b8bbf65.md) |
