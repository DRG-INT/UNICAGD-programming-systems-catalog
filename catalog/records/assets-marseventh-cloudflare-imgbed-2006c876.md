...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/MarSeventh/CloudFlare-ImgBed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MarSeventh/CloudFlare-ImgBed](https://github.com/MarSeventh/CloudFlare-ImgBed) |
| Source record ids | github_search_assets-59e4cb7365adda |

## System Engineer Summary

🏖️ A serverless, open-source file hosting solution built on Cloudflare. Supports image hosting,
secure file storage, and personal cloud drive capabilities.

## Operational Role

For a systems engineer, MarSeventh/CloudFlare-ImgBed belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T02:41:32Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_assets-59e4cb7365adda` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| django-webpack/django-webpack-loader | Web Framework | [open](assets-django-webpack-django-webpack-loader-61d7c881.md) |
| internet-development/www-server-mono | Web Framework | [open](assets-internet-development-www-server-mono-b5773f46.md) |
| jansol/texpresso | Web Framework | [open](assets-jansol-texpresso-c8f9d0fc.md) |
| OCSInventory-NG/OCSInventory-Server | Web Framework | [open](assets-ocsinventory-ng-ocsinventory-server-75ffaffe.md) |
| rykener/django-manifest-loader | Web Framework | [open](assets-rykener-django-manifest-loader-feff5b7a.md) |
