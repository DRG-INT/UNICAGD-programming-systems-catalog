...
<!-- canonical: https://github.com/Yalantis/Pull-to-Refresh.Rentals-iOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Yalantis/Pull-to-Refresh.Rentals-iOS](https://github.com/Yalantis/Pull-to-Refresh.Rentals-iOS) |
| Source record ids | github_search_cocoa-3c538909fade56 |

## System Engineer Summary

This project aims to provide a simple and customizable pull to refresh implementation. Made in
Yalantis

## Operational Role

For a systems engineer, Yalantis/Pull-to-Refresh.Rentals-iOS belongs in the Cocoa inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-16T09:20:03Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-3c538909fade56` from `github_search_cocoa` as `registry_expansion`
