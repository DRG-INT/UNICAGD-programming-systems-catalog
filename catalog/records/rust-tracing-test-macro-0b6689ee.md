...
| Canonical URL | [https://crates.io/crates/tracing-test-macro](https://crates.io/crates/tracing-test-macro) |
| Source record ids | crates_io-87cc016fbf761c |

## System Engineer Summary

A procedural macro that allow for easier testing of crates that use `tracing`. Internal crate,
should only be used through the `tracing-test` crate.

## Operational Role

For a systems engineer, tracing-test-macro belongs in the Rust inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-02-07T23:44:49.605932Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-87cc016fbf761c` from `crates_io` as `registry_expansion`
