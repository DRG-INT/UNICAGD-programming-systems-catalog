...
<!-- canonical: https://github.com/LITUATUI/M3UPT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LITUATUI/M3UPT](https://github.com/LITUATUI/M3UPT) |
| Source record ids | github_search_electromagnetoscopes-44984f0a1d5c96 |

## System Engineer Summary

IPTV playlist in M3U format with TV and radio stations in Portuguese. Public and official streams
only. Made in 🇵🇹 Portugal.

## Operational Role

For a systems engineer, LITUATUI/M3UPT belongs in the Electromagnetoscopes inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T12:15:17Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-44984f0a1d5c96` from `github_search_electromagnetoscopes` as `registry_expansion`
