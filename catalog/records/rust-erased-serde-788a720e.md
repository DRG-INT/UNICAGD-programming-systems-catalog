...
<!-- canonical: https://crates.io/crates/erased-serde -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/erased-serde](https://crates.io/crates/erased-serde) |
| Source record ids | crates_io-b7ec691b21a4a0 |
...
For a systems engineer, erased-serde belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.10 | 2026-03-02T19:44:28.184534Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-b7ec691b21a4a0` from `crates_io` as `registry_expansion`
