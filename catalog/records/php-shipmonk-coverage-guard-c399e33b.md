...
<!-- canonical: https://packagist.org/packages/shipmonk/coverage-guard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/shipmonk/coverage-guard](https://packagist.org/packages/shipmonk/coverage-guard) |
| Source record ids | packagist_search-a47cea4bb2ae18 |

## System Engineer Summary

Enforce code coverage in your CI. Not by percentage, but target core methods. No more untested
Facades, Controllers, or Repositories. Allows you to start enforcing coverage for new code only!

## Operational Role

For a systems engineer, shipmonk/coverage-guard belongs in the PHP inventory as part of
...
- `packagist_search-a47cea4bb2ae18` from `packagist_search` as `registry_expansion`
