# Gitea: Cloud_GitDevSecOps/Database

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/Cloud_GitDevSecOps/Database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Cloud_GitDevSecOps/Database](https://gitea.com/Cloud_GitDevSecOps/Database) |
| Source record ids | gitea_repositories_api-5f21c5b024fef1 |

## System Engineer Summary

Gitea: Cloud_GitDevSecOps/Database is tracked as a database datastore record in the Repository
...
For a systems engineer, Gitea: Cloud_GitDevSecOps/Database belongs in the Repository Workplaces
inventory as part of state persistence, migrations, performance, and operational recovery.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-27T11:48:32Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-02 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "database", "retrieved": "2026-09-02", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-5f21c5b024fef1` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| banana-hackers/store-db | Database Datastore | [open](repository-workplaces-banana-hackers-store-db-85eabcc9.md) |
| barrel-db/barrel-platform | Database Datastore | [open](repository-workplaces-barrel-db-barrel-platform-c0ea9b49.md) |
| bullbytes/scala-js-example | Database Datastore | [open](repository-workplaces-bullbytes-scala-js-example-f737433c.md) |
| cznic/ql | Database Datastore | [open](repository-workplaces-cznic-ql-298bf64a.md) |
| depesz/Versioning | Database Datastore | [open](repository-workplaces-depesz-versioning-c737c869.md) |
| dmfay/pdot | Database Datastore | [open](repository-workplaces-dmfay-pdot-56b85913.md) |
| exploit-database/exploitdb-bin-sploits | Database Datastore | [open](repository-workplaces-exploit-database-exploitdb-bin-sploits-c736210d.md) |
| exploit-database/exploitdb-papers | Database Datastore | [open](repository-workplaces-exploit-database-exploitdb-papers-7796424e.md) |
