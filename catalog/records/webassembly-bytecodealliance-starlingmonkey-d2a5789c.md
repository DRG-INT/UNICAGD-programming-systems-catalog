...
<!-- canonical: https://github.com/bytecodealliance/StarlingMonkey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/StarlingMonkey](https://github.com/bytecodealliance/StarlingMonkey) |
| Source record ids | github_search_webassembly-9037ff522304c2 |
...
For a systems engineer, bytecodealliance/StarlingMonkey belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T14:59:48Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-9037ff522304c2` from `github_search_webassembly` as `registry_expansion`
