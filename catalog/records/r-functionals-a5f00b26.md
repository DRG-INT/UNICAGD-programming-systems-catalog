...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/functionals/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/functionals/index.html](https://cran.r-project.org/web/packages/functionals/index.html) |
| Source record ids | cran_packages_by_date-694fbe1ca614fb |
...
For a systems engineer, functionals belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-08-22 02:10:02 UTC | [https://cran.r-project.org/web/packages/functionals/DESCRIPTION](https://cran.r-project.org/web/packages/functionals/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/functionals/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-694fbe1ca614fb` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mRMRe | Concurrency Parallelism | [open](r-mrmre-354377c9.md) |
| nanonext | Concurrency Parallelism | [open](r-nanonext-239f70fd.md) |
| PosteriorBootstrap | Concurrency Parallelism | [open](r-posteriorbootstrap-9cd1794e.md) |
| prrd | Concurrency Parallelism | [open](r-prrd-b53ae408.md) |
| Rborist | Concurrency Parallelism | [open](r-rborist-a14f867b.md) |
| RcppParallel | Concurrency Parallelism | [open](r-rcppparallel-09afef8f.md) |
| RcppPlanc | Concurrency Parallelism | [open](r-rcppplanc-0cc4953d.md) |
| RcppTrust | Concurrency Parallelism | [open](r-rcpptrust-1cd73d11.md) |
