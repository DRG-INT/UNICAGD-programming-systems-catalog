...
<!-- canonical: https://github.com/fermoya/SwiftUIPager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fermoya/SwiftUIPager](https://github.com/fermoya/SwiftUIPager) |
| Source record ids | github_search_cocoa-0b5e1320f77ac1 |

## System Engineer Summary

fermoya/SwiftUIPager is tracked as a visualization gui record in the Cocoa branch. The source did
...
For a systems engineer, fermoya/SwiftUIPager belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-16T07:20:16Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0b5e1320f77ac1` from `github_search_cocoa` as `registry_expansion`
