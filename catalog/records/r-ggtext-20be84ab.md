...
<!-- canonical: https://cran.r-project.org/web/packages/ggtext/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggtext/index.html](https://cran.r-project.org/web/packages/ggtext/index.html) |
| Source record ids | cran_packages_by_date-eec85624481c8d |
...
For a systems engineer, ggtext belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-28 10:30:07 UTC | [https://cran.r-project.org/web/packages/ggtext/DESCRIPTION](https://cran.r-project.org/web/packages/ggtext/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggtext/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eec85624481c8d` from `cran_packages_by_date` as `registry_expansion`
