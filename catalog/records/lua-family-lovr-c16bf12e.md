...
| Canonical URL | [https://lovr.org](https://lovr.org) |
| Source record ids | lua-source-119 |
...
For a systems engineer, LÖVR belongs in the Lua family inventory as part of service communication,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 119}}` |
...
- `lua-source-119` from `master_json` as `source_list_item`
