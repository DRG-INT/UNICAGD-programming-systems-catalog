...
<!-- canonical: https://github.com/AssemblyScript/examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AssemblyScript/examples](https://github.com/AssemblyScript/examples) |
| Source record ids | github_search_webassembly-3edc6cdd3fddf1 |
...
For a systems engineer, AssemblyScript/examples belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-3edc6cdd3fddf1` from `github_search_webassembly` as `registry_expansion`
