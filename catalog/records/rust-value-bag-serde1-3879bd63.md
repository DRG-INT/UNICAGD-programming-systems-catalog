...
| Canonical URL | [https://crates.io/crates/value-bag-serde1](https://crates.io/crates/value-bag-serde1) |
| Source record ids | crates_io-c6d0742052d1f5 |
...
For a systems engineer, value-bag-serde1 belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.14.0 | 2026-08-31T03:47:15.482389Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-c6d0742052d1f5` from `crates_io` as `registry_expansion`
