...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://opentelemetry.io/docs/specs/semconv/gen-ai/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://opentelemetry.io/docs/specs/semconv/gen-ai/](https://opentelemetry.io/docs/specs/semconv/gen-ai/) |
| Source record ids | curated_language_routes-8e6aef6fd54512 |

## System Engineer Summary

Telemetry conventions for generative AI operations, spans, attributes, models, prompts, and
responses.

## Operational Role

For a systems engineer, OpenTelemetry Semantic Conventions For GenAI belongs in the "aim's"
...
- `curated_language_routes-8e6aef6fd54512` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 2noise/ChatTTS | Logging Observability | [open](aim-s-2noise-chattts-5e993170.md) |
| langfuse/langfuse | Logging Observability | [open](aim-s-langfuse-langfuse-83471c55.md) |
| microsoft/semantic-kernel | Logging Observability | [open](aim-s-microsoft-semantic-kernel-ef95bef0.md) |
| MLflow | Logging Observability | [open](aim-s-mlflow-1732aa2b.md) |
