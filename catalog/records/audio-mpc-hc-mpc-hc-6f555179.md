...
| Source record ids | github_search_audio-2cfd71af08e2c5 |
...
For a systems engineer, mpc-hc/mpc-hc belongs in the Audio inventory as part of service
...
- Latest stable metadata was observed from `https://api.github.com/repos/mpc-hc/mpc-hc/releases/latest` at `2026-09-01T09:23:18+00:00`.
...
- `github_search_audio-2cfd71af08e2c5` from `github_search_audio` as `registry_expansion`
