...
<!-- canonical: https://github.com/HeroTransitions/Hero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HeroTransitions/Hero](https://github.com/HeroTransitions/Hero) |
| Source record ids | github_search_swift-351596a7f1d1e6 |
...
For a systems engineer, HeroTransitions/Hero belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.4 | 2025-01-23T20:29:21Z | [https://api.github.com/repos/HeroTransitions/Hero/releases/latest](https://api.github.com/repos/HeroTransitions/Hero/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/HeroTransitions/Hero/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-351596a7f1d1e6` from `github_search_swift` as `registry_expansion`
