# akka/akka-persistence-dynamodb-1.x
...
<!-- canonical: https://github.com/akka/akka-persistence-dynamodb-1.x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/akka/akka-persistence-dynamodb-1.x](https://github.com/akka/akka-persistence-dynamodb-1.x) |
| Source record ids | github_search_magazines-3f5dd8f79bfef3 |
...
For a systems engineer, akka/akka-persistence-dynamodb-1.x belongs in the Magazines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-18T14:07:10Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-3f5dd8f79bfef3` from `github_search_magazines` as `registry_expansion`
