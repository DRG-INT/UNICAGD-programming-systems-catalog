...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Breinify/brein-time-utilities -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Breinify/brein-time-utilities](https://github.com/Breinify/brein-time-utilities) |
| Source record ids | github_search_catalogs-6d032546331c59 |

## System Engineer Summary

Library which contains several time-dependent data and index structures (e.g., IntervalTree,
BucketTimeSeries), as well as algorithms.

## Operational Role

For a systems engineer, Breinify/brein-time-utilities belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-05T22:09:57Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-6d032546331c59` from `github_search_catalogs` as `registry_expansion`
