...
<!-- canonical: https://cran.r-project.org/web/packages/ruv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ruv/index.html](https://cran.r-project.org/web/packages/ruv/index.html) |
| Source record ids | cran_packages_by_date-3b798adeeb89d1 |
...
For a systems engineer, ruv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.7.2 | 2026-08-31 22:00:08 UTC | [https://cran.r-project.org/web/packages/ruv/DESCRIPTION](https://cran.r-project.org/web/packages/ruv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ruv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3b798adeeb89d1` from `cran_packages_by_date` as `registry_expansion`
