...
<!-- canonical: https://github.com/CodeAbra/iai-personal-memory-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodeAbra/iai-personal-memory-engine](https://github.com/CodeAbra/iai-personal-memory-engine) |
| Source record ids | github_search_databases-1c5add106f4653 |

## System Engineer Summary

A cyber brain for your AI. It never forgets a detail, remembers exactly what you said, and learns
how you work over time. Free, local, works with Cursor, Claude Code, Codex, OpenClaw, Hermes and
more. MIT.

## Operational Role

For a systems engineer, CodeAbra/iai-personal-memory-engine belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T10:42:26Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; zlib License; https://api.github.com/licenses/zlib; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_databases-1c5add106f4653` from `github_search_databases` as `registry_expansion`
...
| Ontos-AI/knowhere | Memory Analyzer | [open](databases-ontos-ai-knowhere-6bb8c219.md) |
