...
<!-- canonical: https://github.com/Dolibarr/dolibarr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Dolibarr/dolibarr](https://github.com/Dolibarr/dolibarr) |
| Source record ids | github_search_databases-3d603e21da013b |

## System Engineer Summary

Dolibarr ERP CRM is a modern software package to manage your company or foundation's activity
(contacts, suppliers, invoices, orders, stocks, agenda, accounting, ...). it's an open source Web
application (written in PHP) designed for businesses of any sizes, foundations and freelancers.

## Operational Role

For a systems engineer, Dolibarr/dolibarr belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T01:38:34Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3d603e21da013b` from `github_search_databases` as `registry_expansion`
