...
<!-- canonical: https://cran.r-project.org/web/packages/sanitizers/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sanitizers/index.html](https://cran.r-project.org/web/packages/sanitizers/index.html) |
| Source record ids | cran_packages_by_date-20231b01aa74b1 |
...
For a systems engineer, sanitizers belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-12 19:00:02 UTC | [https://cran.r-project.org/web/packages/sanitizers/DESCRIPTION](https://cran.r-project.org/web/packages/sanitizers/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sanitizers/DESCRIPTION` at `2026-09-12T20:18:42+00:00`.
...
- `cran_packages_by_date-20231b01aa74b1` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BerkeleyForestsAnalytics | Sanitizer | [open](r-berkeleyforestsanalytics-3515dead.md) |
