...
| Source record ids | curated_language_routes-f02aa653322ced |

## System Engineer Summary

Font rendering library used to load, rasterize, hint, and operate font assets.

## Operational Role

For a systems engineer, FreeType belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-f02aa653322ced` from `curated_language_routes` as `registry_expansion`
