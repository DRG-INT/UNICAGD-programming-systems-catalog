...
<!-- canonical: https://packagist.org/packages/sad_spirit/pg_wrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sad_spirit/pg_wrapper](https://packagist.org/packages/sad_spirit/pg_wrapper) |
| Source record ids | packagist_search-00f67aa6e46b04 |
...
For a systems engineer, sad_spirit/pg_wrapper belongs in the PHP inventory as part of state
...
- `packagist_search-00f67aa6e46b04` from `packagist_search` as `registry_expansion`
