...
| Source record ids | github_search_webassembly-4b1835bb9fc517 |
...
For a systems engineer, CharlieTap/chasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-08-21T18:31:35Z | [https://api.github.com/repos/CharlieTap/chasm/releases/latest](https://api.github.com/repos/CharlieTap/chasm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CharlieTap/chasm/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-4b1835bb9fc517` from `github_search_webassembly` as `registry_expansion`
