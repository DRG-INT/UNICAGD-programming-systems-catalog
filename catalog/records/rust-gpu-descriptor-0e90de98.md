...
| Canonical URL | [https://crates.io/crates/gpu-descriptor](https://crates.io/crates/gpu-descriptor) |
| Source record ids | crates_io-492da81f4ca343 |
...
For a systems engineer, gpu-descriptor belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-05-23T17:04:11.339119Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-492da81f4ca343` from `crates_io` as `registry_expansion`
