...
<!-- canonical: https://pub.dev/packages/postgrest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/postgrest](https://pub.dev/packages/postgrest) |
| Source record ids | pub_dev-500e3e088e5cbf |
...
For a systems engineer, postgrest belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.1 | 2026-08-05T08:47:45.204815Z | [https://pub.dev/api/packages/postgrest](https://pub.dev/api/packages/postgrest) |  |
| preview | known | 3.0.0-dev.2 | 2026-09-01T13:45:33.744514Z | [https://pub.dev/api/packages/postgrest](https://pub.dev/api/packages/postgrest) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/postgrest` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-500e3e088e5cbf` from `pub_dev` as `registry_expansion`
