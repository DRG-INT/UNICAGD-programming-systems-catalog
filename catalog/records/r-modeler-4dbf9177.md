...
<!-- canonical: https://cran.r-project.org/web/packages/Modeler/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Modeler/index.html](https://cran.r-project.org/web/packages/Modeler/index.html) |
| Source record ids | cran_packages_by_date-c8326707eda161 |
...
For a systems engineer, Modeler belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.10 | 2026-08-21 11:20:07 UTC | [https://cran.r-project.org/web/packages/Modeler/DESCRIPTION](https://cran.r-project.org/web/packages/Modeler/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Modeler/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c8326707eda161` from `cran_packages_by_date` as `registry_expansion`
