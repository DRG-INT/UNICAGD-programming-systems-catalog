...
<!-- canonical: https://cran.r-project.org/web/packages/tidySEM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidySEM/index.html](https://cran.r-project.org/web/packages/tidySEM/index.html) |
| Source record ids | cran_packages_by_date-a3c3f73c3118f4 |
...
For a systems engineer, tidySEM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2026-08-20 13:50:02 UTC | [https://cran.r-project.org/web/packages/tidySEM/DESCRIPTION](https://cran.r-project.org/web/packages/tidySEM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidySEM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a3c3f73c3118f4` from `cran_packages_by_date` as `registry_expansion`
