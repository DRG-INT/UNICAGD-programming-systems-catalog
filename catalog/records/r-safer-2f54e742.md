...
<!-- canonical: https://cran.r-project.org/web/packages/safer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/safer/index.html](https://cran.r-project.org/web/packages/safer/index.html) |
| Source record ids | cran_packages_by_date-52b5859213ef74 |
...
For a systems engineer, safer belongs in the R inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-08-29 15:20:02 UTC | [https://cran.r-project.org/web/packages/safer/DESCRIPTION](https://cran.r-project.org/web/packages/safer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/safer/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-52b5859213ef74` from `cran_packages_by_date` as `registry_expansion`
