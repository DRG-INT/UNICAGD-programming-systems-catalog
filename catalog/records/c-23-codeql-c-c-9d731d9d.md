...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Static Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/static-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-51be867e776d02 |

## System Engineer Summary

CodeQL C/C++ is tracked as a static analyzer record in the C++23 branch. The source did not provide
...
For a systems engineer, CodeQL C/C++ belongs in the C++23 inventory as part of defect discovery,
...
- `corpus-51be867e776d02` from `master_json` as `static_analyzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Coverity | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-coverity-ed10c96f.md) |
| cppcheck | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-cppcheck-36a322db.md) |
| PVS-Studio | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-pvs-studio-0ed7cf10.md) |
| SonarQube CFamily | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-sonarqube-cfamily-224ca2e2.md) |
