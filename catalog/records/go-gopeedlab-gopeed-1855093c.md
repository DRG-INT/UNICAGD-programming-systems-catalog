...
<!-- canonical: https://github.com/GopeedLab/gopeed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) |
| Source record ids | github_search_go-613e4a5b00bc83 |

## System Engineer Summary

A fast, modern download manager for HTTP, BitTorrent, Magnet, and ed2k. Cross-platform, built with
Golang and Flutter.

## Operational Role

For a systems engineer, GopeedLab/gopeed belongs in the Go inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T10:08:04Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-613e4a5b00bc83` from `github_search_go` as `registry_expansion`
