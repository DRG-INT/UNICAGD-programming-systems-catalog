...
<!-- canonical: https://cran.r-project.org/web/packages/eigencore/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/eigencore/index.html](https://cran.r-project.org/web/packages/eigencore/index.html) |
| Source record ids | cran_packages_by_date-3616c0fb1129d6 |
...
For a systems engineer, eigencore belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-26 21:10:18 UTC | [https://cran.r-project.org/web/packages/eigencore/DESCRIPTION](https://cran.r-project.org/web/packages/eigencore/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/eigencore/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3616c0fb1129d6` from `cran_packages_by_date` as `registry_expansion`
