...
| Source record ids | lua-source-165 |

## System Engineer Summary

lua-source-165 is tracked as an other record in the Lua family branch. The source did not provide a
...
For a systems engineer, lua-source-165 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 165}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-165` from `master_json` as `source_list_item`
...
| Miscellaneous | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-miscellaneous-735f53b7.md) |
