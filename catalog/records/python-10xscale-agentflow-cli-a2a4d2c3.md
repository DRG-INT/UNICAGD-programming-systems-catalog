...
<!-- canonical: https://pypi.org/project/10xscale-agentflow-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/10xscale-agentflow-cli/](https://pypi.org/project/10xscale-agentflow-cli/) |
| Source record ids | pypi_simple-37d09c10e3cccf |
...
For a systems engineer, 10xscale-agentflow-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-07-21T11:47:35.871399Z | [https://pypi.org/pypi/10xscale-agentflow-cli/json](https://pypi.org/pypi/10xscale-agentflow-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/10xscale-agentflow-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-37d09c10e3cccf` from `pypi_simple` as `registry_expansion`
