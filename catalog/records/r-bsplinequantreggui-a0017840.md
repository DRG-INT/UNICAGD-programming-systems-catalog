...
<!-- canonical: https://cran.r-project.org/web/packages/BsplineQuantRegGui/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BsplineQuantRegGui/index.html](https://cran.r-project.org/web/packages/BsplineQuantRegGui/index.html) |
| Source record ids | cran_packages_by_date-07a30626f97a52 |
...
For a systems engineer, BsplineQuantRegGui belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-01 08:50:15 UTC | [https://cran.r-project.org/web/packages/BsplineQuantRegGui/DESCRIPTION](https://cran.r-project.org/web/packages/BsplineQuantRegGui/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BsplineQuantRegGui/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-07a30626f97a52` from `cran_packages_by_date` as `registry_expansion`
