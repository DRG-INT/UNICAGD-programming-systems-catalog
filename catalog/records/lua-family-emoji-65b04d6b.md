...
| Canonical URL | [https://luarocks.org/modules/kitsunies/emoji](https://luarocks.org/modules/kitsunies/emoji) |
| Source record ids | luarocks_root_manifest-8b44bf7391b327 |

## System Engineer Summary

emoji is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, emoji belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-8b44bf7391b327` from `luarocks_root_manifest` as `registry_expansion`
