...
<!-- canonical: https://cran.r-project.org/web/packages/outliertree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/outliertree/index.html](https://cran.r-project.org/web/packages/outliertree/index.html) |
| Source record ids | cran_packages_by_date-14537db5b6bd57 |
...
For a systems engineer, outliertree belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0-2 | 2026-08-20 09:10:02 UTC | [https://cran.r-project.org/web/packages/outliertree/DESCRIPTION](https://cran.r-project.org/web/packages/outliertree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/outliertree/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-14537db5b6bd57` from `cran_packages_by_date` as `registry_expansion`
