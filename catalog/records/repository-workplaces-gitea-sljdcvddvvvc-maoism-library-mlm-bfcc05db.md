# Gitea: sljdcvddvvvc/maoism-library-mlm

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/sljdcvddvvvc/maoism-library-mlm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/sljdcvddvvvc/maoism-library-mlm](https://gitea.com/sljdcvddvvvc/maoism-library-mlm) |
| Source record ids | gitea_repositories_api-0d26a180a99d87 |

## System Engineer Summary

"马列毛主义"的图书资料汇编,互联网收集毛泽东/列宁/恩格斯/马克思/文化大革命/理论/历史资料,国际共产主义运动,互联网网络安全,自由及开源软件/系统安装使用...

## Operational Role

For a systems engineer, Gitea: sljdcvddvvvc/maoism-library-mlm belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-17T23:37:16Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-0d26a180a99d87` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| baixingwang/devops-user-service | Machine Learning | [open](repository-workplaces-baixingwang-devops-user-service-33f0ca48.md) |
| Gitea: DsyO/ai-wechat-article-library | Machine Learning | [open](repository-workplaces-gitea-dsyo-ai-wechat-article-library-9e311b4c.md) |
| Gitea: pmr-inanepain/auth | Machine Learning | [open](repository-workplaces-gitea-pmr-inanepain-auth-fb7f966f.md) |
| Gitea: pmr-inanepain/cache | Machine Learning | [open](repository-workplaces-gitea-pmr-inanepain-cache-148f78a6.md) |
