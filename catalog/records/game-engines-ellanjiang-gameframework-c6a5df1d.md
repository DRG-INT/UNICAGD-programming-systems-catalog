...
<!-- canonical: https://github.com/EllanJiang/GameFramework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EllanJiang/GameFramework](https://github.com/EllanJiang/GameFramework) |
| Source record ids | github_search_game_engines-e68abeb37b38bc |

## System Engineer Summary

This is literally a game framework, based on Unity game engine. It encapsulates commonly used game
modules during development, and, to a large degree, standardises the process, enhances the
development speed and ensures the product quality.

## Operational Role

For a systems engineer, EllanJiang/GameFramework belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-05T13:24:31Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e68abeb37b38bc` from `github_search_game_engines` as `registry_expansion`
