...
<!-- canonical: https://cran.r-project.org/web/packages/imuGAP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/imuGAP/index.html](https://cran.r-project.org/web/packages/imuGAP/index.html) |
| Source record ids | cran_packages_by_date-7edf11736ddc43 |

## System Engineer Summary

Immunity: Geographic and Age-Based Projection

## Operational Role

For a systems engineer, imuGAP belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-02 15:30:14 UTC | [https://cran.r-project.org/web/packages/imuGAP/DESCRIPTION](https://cran.r-project.org/web/packages/imuGAP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/imuGAP/DESCRIPTION` at `2026-09-02T17:18:40+00:00`.
...
- `cran_packages_by_date-7edf11736ddc43` from `cran_packages_by_date` as `registry_expansion`
