...
| Source record ids | corpus-6cf0f3c4601b45 |

## System Engineer Summary

protobuf-c is tracked as a serialization record in the C99 branch. The source did not provide a long
...
For a systems engineer, protobuf-c belongs in the C99 inventory as part of wire formats,
...
- `corpus-6cf0f3c4601b45` from `master_json` as `serialization`
