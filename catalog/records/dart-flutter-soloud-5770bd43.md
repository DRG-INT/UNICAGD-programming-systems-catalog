...
<!-- canonical: https://pub.dev/packages/flutter_soloud -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_soloud](https://pub.dev/packages/flutter_soloud) |
| Source record ids | pub_dev-f2b47f45d2e56c |

## System Engineer Summary

A low-level audio plugin for Flutter, mainly meant for games and immersive apps. Based on the SoLoud
(C++) audio engine.

## Operational Role

For a systems engineer, flutter_soloud belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.2 | 2026-09-04T11:45:40.646519Z | [https://pub.dev/api/packages/flutter_soloud](https://pub.dev/api/packages/flutter_soloud) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_soloud` at `2026-09-04T12:25:10+00:00`.
...
- `pub_dev-f2b47f45d2e56c` from `pub_dev` as `registry_expansion`
