...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rustfs/rustfs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rustfs/rustfs](https://github.com/rustfs/rustfs) |
| Source record ids | github_search_databases-cf3da536b37814 |

## System Engineer Summary

🚀2.3x faster than MinIO for 4KB object payloads. RustFS is an open-source, S3-compatible high-
performance object storage system supporting migration and coexistence with other S3-compatible
platforms such as MinIO and Ceph.

## Operational Role

For a systems engineer, rustfs/rustfs belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:32:26Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:object-storage stars:>100", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_databases-cf3da536b37814` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| achtungsoftware/alarik | Benchmarking | [open](databases-achtungsoftware-alarik-1fd71dd7.md) |
| akopytov/sysbench | Benchmarking | [open](databases-akopytov-sysbench-030eed13.md) |
| AnghelLeonard/Hibernate-SpringBoot | Benchmarking | [open](databases-anghelleonard-hibernate-springboot-ad555e27.md) |
| brettwooldridge/HikariCP | Benchmarking | [open](databases-brettwooldridge-hikaricp-4189650c.md) |
| ClickHouse/ClickBench | Benchmarking | [open](databases-clickhouse-clickbench-3cbfaabf.md) |
| cnosdb/cnosdb | Benchmarking | [open](databases-cnosdb-cnosdb-5480514a.md) |
| dgraph-io/dgraph | Benchmarking | [open](databases-dgraph-io-dgraph-d8a0cd12.md) |
| dromara/easy-query | Benchmarking | [open](databases-dromara-easy-query-b3c029c2.md) |
