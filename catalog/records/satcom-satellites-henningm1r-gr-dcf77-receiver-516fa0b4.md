# henningM1r/gr_DCF77_Receiver

## Navigation

[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/henningM1r/gr_DCF77_Receiver -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | SatCom Satellites |
| Category | Datetime |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/henningM1r/gr_DCF77_Receiver](https://github.com/henningM1r/gr_DCF77_Receiver) |
| Source record ids | github_search_satcom_satellites-400a15373d855d |

## System Engineer Summary

DCF77 time signal GNURadio receiver for SDRs incl. live decoder and transmitter simulation. It
covers both OOK and phase modulation.

## Operational Role

For a systems engineer, henningM1r/gr_DCF77_Receiver belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-13T19:49:41Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD_3_clause + file LICENSE; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_satcom_satellites-400a15373d855d` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 30hours/blah2 | Datetime | [open](satcom-satellites-30hours-blah2-5333f179.md) |
| filipsPL/autowx2 | Datetime | [open](satcom-satellites-filipspl-autowx2-f68452a6.md) |
| jakiestfu/himawari.js | Datetime | [open](satcom-satellites-jakiestfu-himawari-js-87bf981c.md) |
| JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-with-Adaptive-Coding-and-Modulation | Datetime | [open](satcom-satellites-johnziangas-link-budget-modeling-for-q-band-leo-satellite-communications-with-adaptive-coding-and-modulation-72b8f9a2.md) |
| nitram2342/gr-dcf77-transmitter | Datetime | [open](satcom-satellites-nitram2342-gr-dcf77-transmitter-6f232492.md) |
| sammmlow/ORBITM | Datetime | [open](satcom-satellites-sammmlow-orbitm-b6893fc7.md) |
| VSainteuf/lightweight-temporal-attention-pytorch | Datetime | [open](satcom-satellites-vsainteuf-lightweight-temporal-attention-pytorch-11bc2e8f.md) |
| watson/airplanejs | Datetime | [open](satcom-satellites-watson-airplanejs-6d130187.md) |
