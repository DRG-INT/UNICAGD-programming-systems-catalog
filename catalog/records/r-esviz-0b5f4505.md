...
<!-- canonical: https://cran.r-project.org/web/packages/esviz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/esviz/index.html](https://cran.r-project.org/web/packages/esviz/index.html) |
| Source record ids | cran_packages_by_date-99d6e97290fc8e |
...
For a systems engineer, esviz belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-09-04 13:20:02 UTC | [https://cran.r-project.org/web/packages/esviz/DESCRIPTION](https://cran.r-project.org/web/packages/esviz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/esviz/DESCRIPTION` at `2026-09-04T14:19:07+00:00`.
...
- `cran_packages_by_date-99d6e97290fc8e` from `cran_packages_by_date` as `registry_expansion`
