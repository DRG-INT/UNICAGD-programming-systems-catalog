...
<!-- canonical: https://pub.dev/packages/flutter_scene -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_scene](https://pub.dev/packages/flutter_scene) |
| Source record ids | pub_dev-e7fbdae833131f |

## System Engineer Summary

A flexible realtime 3D engine for Flutter games and apps, with glTF models, physics, skeletal
animation, and PBR lighting.

## Operational Role

For a systems engineer, flutter_scene belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.0 | 2026-08-25T08:36:20.011449Z | [https://pub.dev/api/packages/flutter_scene](https://pub.dev/api/packages/flutter_scene) |  |
| preview | known | 0.9.2-0 | 2025-04-13T07:19:24.360299Z | [https://pub.dev/api/packages/flutter_scene](https://pub.dev/api/packages/flutter_scene) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_scene` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-e7fbdae833131f` from `pub_dev` as `registry_expansion`
