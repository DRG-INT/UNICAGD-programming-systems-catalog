...
<!-- canonical: https://github.com/centrifugal/centrifugo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) |
| Source record ids | github_search_video-77e47f4e66f286 |

## System Engineer Summary

Scalable real-time messaging server in a language-agnostic way. Self-hosted alternative to Pubnub,
Pusher, Ably, socket.io, Phoenix.PubSub, SignalR. Set up once and forever.

## Operational Role

For a systems engineer, centrifugal/centrifugo belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T05:38:48Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-77e47f4e66f286` from `github_search_video` as `registry_expansion`
