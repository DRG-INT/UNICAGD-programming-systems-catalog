...
<!-- canonical: https://pub.dev/packages/firebase_ui_firestore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/firebase_ui_firestore](https://pub.dev/packages/firebase_ui_firestore) |
| Source record ids | pub_dev-ed4cb9c9b4fdb8 |

## System Engineer Summary

Pre-built widgets and utilites that make it easy to integrate Firebase Firestore into your Flutter
app.

## Operational Role

For a systems engineer, firebase_ui_firestore belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-07-15T14:38:59.689425Z | [https://pub.dev/api/packages/firebase_ui_firestore](https://pub.dev/api/packages/firebase_ui_firestore) |  |
| preview | known | 1.0.0-dev.2 | 2022-10-18T16:54:11.963441Z | [https://pub.dev/api/packages/firebase_ui_firestore](https://pub.dev/api/packages/firebase_ui_firestore) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/firebase_ui_firestore` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-ed4cb9c9b4fdb8` from `pub_dev` as `registry_expansion`
