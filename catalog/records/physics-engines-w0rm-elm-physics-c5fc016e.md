...
<!-- canonical: https://github.com/w0rm/elm-physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/w0rm/elm-physics](https://github.com/w0rm/elm-physics) |
| Source record ids | github_search_physics_engines-07413674a31f11 |
...
For a systems engineer, w0rm/elm-physics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T19:09:37Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-07413674a31f11` from `github_search_physics_engines` as `registry_expansion`
