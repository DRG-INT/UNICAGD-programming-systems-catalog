...
| Source record ids | corpus-b863c8fdd8c205 |

## System Engineer Summary

OpenMP is tracked as a concurrency parallelism record in the C++23 branch. The source did not
...
For a systems engineer, OpenMP belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-b863c8fdd8c205` from `master_json` as `concurrency_parallelism`
