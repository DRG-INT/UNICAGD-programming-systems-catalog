...
<!-- canonical: https://cran.r-project.org/web/packages/productivity/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/productivity/index.html](https://cran.r-project.org/web/packages/productivity/index.html) |
| Source record ids | cran_packages_by_date-b6d6b1d2868008 |
...
For a systems engineer, productivity belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-09-08 12:30:18 UTC | [https://cran.r-project.org/web/packages/productivity/DESCRIPTION](https://cran.r-project.org/web/packages/productivity/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/productivity/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-b6d6b1d2868008` from `cran_packages_by_date` as `registry_expansion`
