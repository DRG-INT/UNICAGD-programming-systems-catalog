...
<!-- canonical: https://crates.io/crates/logos-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/logos-derive](https://crates.io/crates/logos-derive) |
| Source record ids | crates_io-d92011c9413768 |
...
For a systems engineer, logos-derive belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.1 | 2026-01-30T13:54:49.372011Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-d92011c9413768` from `crates_io` as `registry_expansion`
