...
<!-- canonical: https://github.com/yahoo/AppDevKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yahoo/AppDevKit](https://github.com/yahoo/AppDevKit) |
| Source record ids | github_search_cocoa-26004bb4741a7b |

## System Engineer Summary

AppDevKit is an iOS development library that provides developers with useful features to fulfill
their everyday iOS app development needs.

## Operational Role

For a systems engineer, yahoo/AppDevKit belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-13T10:04:16Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0; Other |
...
- `github_search_cocoa-26004bb4741a7b` from `github_search_cocoa` as `registry_expansion`
