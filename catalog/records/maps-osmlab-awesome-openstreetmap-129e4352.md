...
<!-- canonical: https://github.com/osmlab/awesome-openstreetmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osmlab/awesome-openstreetmap](https://github.com/osmlab/awesome-openstreetmap) |
| Source record ids | github_search_maps-d38971a2b60728 |
...
For a systems engineer, osmlab/awesome-openstreetmap belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-23T22:06:05Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d38971a2b60728` from `github_search_maps` as `registry_expansion`
