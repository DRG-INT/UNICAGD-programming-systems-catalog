...
<!-- canonical: https://github.com/gbionics/adam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gbionics/adam](https://github.com/gbionics/adam) |
| Source record ids | github_search_physics_engines-0cc1ca06698808 |

## System Engineer Summary

adam implements a collection of algorithms for calculating rigid-body dynamics in Jax, CasADi,
PyTorch, and Numpy.

## Operational Role

For a systems engineer, gbionics/adam belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:55:56Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-0cc1ca06698808` from `github_search_physics_engines` as `registry_expansion`
