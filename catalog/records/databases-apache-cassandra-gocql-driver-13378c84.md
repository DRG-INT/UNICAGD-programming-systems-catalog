...
<!-- canonical: https://github.com/apache/cassandra-gocql-driver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/cassandra-gocql-driver](https://github.com/apache/cassandra-gocql-driver) |
| Source record ids | github_search_databases-fb012a21b996d3 |
...
For a systems engineer, apache/cassandra-gocql-driver belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-28T10:40:38Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fb012a21b996d3` from `github_search_databases` as `registry_expansion`
