...
<!-- canonical: https://cran.r-project.org/web/packages/trade/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/trade/index.html](https://cran.r-project.org/web/packages/trade/index.html) |
| Source record ids | cran_packages_by_date-e8e8305aea6ab2 |
...
For a systems engineer, trade belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.6 | 2026-08-26 12:20:02 UTC | [https://cran.r-project.org/web/packages/trade/DESCRIPTION](https://cran.r-project.org/web/packages/trade/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/trade/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e8e8305aea6ab2` from `cran_packages_by_date` as `registry_expansion`
