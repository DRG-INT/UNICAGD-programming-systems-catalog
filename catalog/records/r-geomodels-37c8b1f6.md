...
<!-- canonical: https://cran.r-project.org/web/packages/GeoModels/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GeoModels/index.html](https://cran.r-project.org/web/packages/GeoModels/index.html) |
| Source record ids | cran_packages_by_date-24f8a159a3cc15 |
...
For a systems engineer, GeoModels belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.8 | 2026-08-21 05:46:27 UTC | [https://cran.r-project.org/web/packages/GeoModels/DESCRIPTION](https://cran.r-project.org/web/packages/GeoModels/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GeoModels/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-24f8a159a3cc15` from `cran_packages_by_date` as `registry_expansion`
