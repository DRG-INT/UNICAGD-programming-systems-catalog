...
<!-- canonical: https://crates.io/crates/wasm-encoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasm-encoder](https://crates.io/crates/wasm-encoder) |
| Source record ids | crates_io-374d729c086e2e |
...
For a systems engineer, wasm-encoder belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.259.0 | 2026-09-10T17:56:39.484498Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-10T18:21:44+00:00`.
...
- `crates_io-374d729c086e2e` from `crates_io` as `registry_expansion`
