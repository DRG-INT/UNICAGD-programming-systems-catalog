...
<!-- canonical: https://www.npmjs.com/package/pushstate-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/pushstate-server](https://www.npmjs.com/package/pushstate-server) |
| Source record ids | npm_registry-6a39187af8dc09 |
...
For a systems engineer, pushstate-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2019-02-12T15:15:42.853Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-6a39187af8dc09` from `npm_registry` as `registry_expansion`
