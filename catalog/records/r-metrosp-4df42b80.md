...
<!-- canonical: https://cran.r-project.org/web/packages/metrosp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metrosp/index.html](https://cran.r-project.org/web/packages/metrosp/index.html) |
| Source record ids | cran_packages_by_date-8bfab4ae851377 |
...
For a systems engineer, metrosp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-03 08:00:02 UTC | [https://cran.r-project.org/web/packages/metrosp/DESCRIPTION](https://cran.r-project.org/web/packages/metrosp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metrosp/DESCRIPTION` at `2026-09-03T08:21:53+00:00`.
...
- `cran_packages_by_date-8bfab4ae851377` from `cran_packages_by_date` as `registry_expansion`
