...
<!-- canonical: https://github.com/hustvl/4DGaussians -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hustvl/4DGaussians](https://github.com/hustvl/4DGaussians) |
| Source record ids | github_search_computer_graphics_software-05b64c3482e972 |
...
For a systems engineer, hustvl/4DGaussians belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-05b64c3482e972` from `github_search_computer_graphics_software` as `registry_expansion`
