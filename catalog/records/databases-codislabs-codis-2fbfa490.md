...
<!-- canonical: https://github.com/CodisLabs/codis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodisLabs/codis](https://github.com/CodisLabs/codis) |
| Source record ids | github_search_databases-173f2525a41a05 |
...
For a systems engineer, CodisLabs/codis belongs in the Databases inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-15T03:46:45Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-173f2525a41a05` from `github_search_databases` as `registry_expansion`
