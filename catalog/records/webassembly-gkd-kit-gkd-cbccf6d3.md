...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/gkd-kit/gkd](https://github.com/gkd-kit/gkd) |
| Source record ids | github_search_webassembly-409b2a8d1e634e |

## System Engineer Summary

基于无障碍，高级选择器，订阅规则的自定义屏幕点击安卓应用 | An Android APP with custom screen tapping based on Accessibility,
Advanced Selectors, and Subscription Rules

## Operational Role

For a systems engineer, gkd-kit/gkd belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.12.1 | 2026-05-20T09:43:34Z | [https://api.github.com/repos/gkd-kit/gkd/releases/latest](https://api.github.com/repos/gkd-kit/gkd/releases/latest) |  |
| preview | known | v1.12.0-beta.9 | 2026-05-09T03:24:13Z | [https://api.github.com/repos/gkd-kit/gkd/releases?per_page=10](https://api.github.com/repos/gkd-kit/gkd/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gkd-kit/gkd/releases/latest` at `2026-09-01T10:25:59+00:00`.
...
- `github_search_webassembly-409b2a8d1e634e` from `github_search_webassembly` as `registry_expansion`
