...
<!-- canonical: https://gitlab.com/libosinfo/osinfo-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/libosinfo/osinfo-db](https://gitlab.com/libosinfo/osinfo-db) |
| Source record ids | gitlab_projects_api-e6fcc36ce1d746 |
...
For a systems engineer, libosinfo/osinfo-db belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-e6fcc36ce1d746` from `gitlab_projects_api` as `registry_expansion`
