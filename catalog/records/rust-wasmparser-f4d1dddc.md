...
<!-- canonical: https://crates.io/crates/wasmparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasmparser](https://crates.io/crates/wasmparser) |
| Source record ids | crates_io-775c71c4d1882a |
...
For a systems engineer, wasmparser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.259.0 | 2026-09-10T17:56:34.205530Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-10T18:21:44+00:00`.
...
- `crates_io-775c71c4d1882a` from `crates_io` as `registry_expansion`
