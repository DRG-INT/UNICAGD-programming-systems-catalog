...
<!-- canonical: https://github.com/gre/jardin-sensors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gre/jardin-sensors](https://github.com/gre/jardin-sensors) |
| Source record ids | github_search_radio_garden_speciality-e21b52f98cd40e |

## System Engineer Summary

LoRa-linked garden sensors with HMAC-authenticated radio and native Home Assistant integration: dumb
emitters in the field, smart gateway at home.

## Operational Role

For a systems engineer, gre/jardin-sensors belongs in the Radio Garden Speciality inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T10:06:56Z | gh search repos "radio.garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-e21b52f98cd40e` from `github_search_radio_garden_speciality` as `registry_expansion`
