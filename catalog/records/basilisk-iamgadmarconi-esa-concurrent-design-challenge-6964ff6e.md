# iamgadmarconi/ESA-Concurrent-Design-Challenge
...
<!-- canonical: https://github.com/iamgadmarconi/ESA-Concurrent-Design-Challenge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iamgadmarconi/ESA-Concurrent-Design-Challenge](https://github.com/iamgadmarconi/ESA-Concurrent-Design-Challenge) |
| Source record ids | github_search_basilisk-a50bf0d1f0626f |

## System Engineer Summary

Code for the ESA Concurrent Design Challenge

## Operational Role

For a systems engineer, iamgadmarconi/ESA-Concurrent-Design-Challenge belongs in the Basilisk
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-17T16:45:54Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-a50bf0d1f0626f` from `github_search_basilisk` as `registry_expansion`
...
| parthib007/Basilisk_Works | Library | [open](basilisk-parthib007-basilisk-works-f8a7fc3f.md) |
