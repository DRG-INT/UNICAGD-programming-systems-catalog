...
<!-- canonical: https://packagist.org/packages/stefangabos/zebra_session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/stefangabos/zebra_session](https://packagist.org/packages/stefangabos/zebra_session) |
| Source record ids | packagist_search-84ac5a545f6cb8 |

## System Engineer Summary

A drop-in replacement for PHP's default session handler which stores session data in a MySQL
database, providing better performance, better security and protection against session fixation and
session hijacking

## Operational Role

For a systems engineer, stefangabos/zebra_session belongs in the PHP inventory as part of supply-
...
- `packagist_search-84ac5a545f6cb8` from `packagist_search` as `registry_expansion`
