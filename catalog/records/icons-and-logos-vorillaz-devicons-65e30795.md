...
| Source record ids | github_search_icons_and_logos-e3a7039d10ce18 |
...
For a systems engineer, vorillaz/devicons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T21:43:36Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-e3a7039d10ce18` from `github_search_icons_and_logos` as `registry_expansion`
