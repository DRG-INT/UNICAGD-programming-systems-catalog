...
<!-- canonical: https://pub.dev/packages/file_selector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/file_selector](https://pub.dev/packages/file_selector) |
| Source record ids | pub_dev-84a54723111a6a |

## System Engineer Summary

Flutter plugin for opening and saving files, or selecting directories, using native file selection
UI.

## Operational Role

For a systems engineer, file_selector belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2025-11-21T18:58:18.508014Z | [https://pub.dev/api/packages/file_selector](https://pub.dev/api/packages/file_selector) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/file_selector` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-84a54723111a6a` from `pub_dev` as `registry_expansion`
