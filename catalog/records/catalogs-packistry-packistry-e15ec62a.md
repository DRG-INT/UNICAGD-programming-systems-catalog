...
<!-- canonical: https://github.com/packistry/packistry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/packistry/packistry](https://github.com/packistry/packistry) |
| Source record ids | github_search_catalogs-cd7c1ecc039bad |
...
For a systems engineer, packistry/packistry belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T19:19:09Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-cd7c1ecc039bad` from `github_search_catalogs` as `registry_expansion`
