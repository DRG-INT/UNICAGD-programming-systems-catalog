...
<!-- canonical: https://github.com/maplant/mgf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplant/mgf](https://github.com/maplant/mgf) |
| Source record ids | github_search_physics_engines-7a5e72825c1d69 |

## System Engineer Summary

maplant/mgf is tracked as a game engine game dev record in the Physics Engines branch. The source
...
For a systems engineer, maplant/mgf belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-27T18:57:23Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7a5e72825c1d69` from `github_search_physics_engines` as `registry_expansion`
