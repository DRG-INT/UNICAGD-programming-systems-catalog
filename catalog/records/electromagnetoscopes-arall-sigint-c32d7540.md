...
<!-- canonical: https://github.com/arall/sigint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arall/sigint](https://github.com/arall/sigint) |
| Source record ids | github_search_electromagnetoscopes-764a1ca1483bb2 |

## System Engineer Summary

Multi-protocol SDR signal detection and triangulation system for ATAK. Detects radio emissions from
distributed receivers using RTL-SDR and HackRF.

## Operational Role

For a systems engineer, arall/sigint belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T09:28:31Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-764a1ca1483bb2` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| eltjonqef/OceanSARImagingSimulator | Image Audio Dsp | [open](electromagnetoscopes-eltjonqef-oceansarimagingsimulator-227c6636.md) |
