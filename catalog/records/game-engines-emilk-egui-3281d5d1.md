...
| Source record ids | github_search_game_engines-a7b2d867faec2e |
...
For a systems engineer, emilk/egui belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:37:51Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-a7b2d867faec2e` from `github_search_game_engines` as `registry_expansion`
