...
<!-- canonical: https://github.com/aerospike/aerospike-client-nodejs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aerospike/aerospike-client-nodejs](https://github.com/aerospike/aerospike-client-nodejs) |
| Source record ids | github_search_databases-263462cf39e9ac |
...
For a systems engineer, aerospike/aerospike-client-nodejs belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:18:30Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-263462cf39e9ac` from `github_search_databases` as `registry_expansion`
