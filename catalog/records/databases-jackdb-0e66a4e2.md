...
<!-- canonical: https://www.jackdb.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.jackdb.com/](https://www.jackdb.com/) |
| Source record ids | awesome_list-7492dfb6bda95e |

## System Engineer Summary

Web-based SQL query interface (Commercial Software).

## Operational Role

For a systems engineer, JackDB belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-7492dfb6bda95e` from `awesome_list` as `registry_expansion`
