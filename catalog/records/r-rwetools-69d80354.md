...
<!-- canonical: https://cran.r-project.org/web/packages/rwetools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rwetools/index.html](https://cran.r-project.org/web/packages/rwetools/index.html) |
| Source record ids | cran_packages_by_date-de2d70a11b8ce2 |

## System Engineer Summary

Estimating Propensity Scores (PS), PS-Based Weights, and Effects

## Operational Role

For a systems engineer, rwetools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-09 16:00:02 UTC | [https://cran.r-project.org/web/packages/rwetools/DESCRIPTION](https://cran.r-project.org/web/packages/rwetools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rwetools/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-de2d70a11b8ce2` from `cran_packages_by_date` as `registry_expansion`
