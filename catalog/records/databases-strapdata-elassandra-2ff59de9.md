...
<!-- canonical: https://github.com/strapdata/elassandra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/strapdata/elassandra](https://github.com/strapdata/elassandra) |
| Source record ids | github_search_databases-cac62aa130f08e |
...
For a systems engineer, strapdata/elassandra belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-17T15:18:41Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cac62aa130f08e` from `github_search_databases` as `registry_expansion`
