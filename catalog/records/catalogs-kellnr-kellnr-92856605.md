...
<!-- canonical: https://github.com/kellnr/kellnr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kellnr/kellnr](https://github.com/kellnr/kellnr) |
| Source record ids | github_search_catalogs-7761f704616b5a |
...
For a systems engineer, kellnr/kellnr belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:42:28Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-7761f704616b5a` from `github_search_catalogs` as `registry_expansion`
