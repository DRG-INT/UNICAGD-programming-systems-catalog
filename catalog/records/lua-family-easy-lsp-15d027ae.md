...
<!-- canonical: https://luarocks.org/modules/benjamin-voisin/easy-lsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/benjamin-voisin/easy-lsp](https://luarocks.org/modules/benjamin-voisin/easy-lsp) |
| Source record ids | luarocks_root_manifest-9d7ea0dc0068c3 |

## System Engineer Summary

Get a working LSP within minutes!

## Operational Role

For a systems engineer, easy-lsp belongs in the Lua family inventory as part of editor intelligence,
...
- `luarocks_root_manifest-9d7ea0dc0068c3` from `luarocks_root_manifest` as `registry_expansion`
