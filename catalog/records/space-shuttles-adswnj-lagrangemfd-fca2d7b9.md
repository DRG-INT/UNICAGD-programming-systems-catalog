...
<!-- canonical: https://github.com/ADSWNJ/LagrangeMFD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ADSWNJ/LagrangeMFD](https://github.com/ADSWNJ/LagrangeMFD) |
| Source record ids | github_search_space_shuttles-121ffbdde32046 |

## System Engineer Summary

LagrangeMFD is an MFD for use with the Orbiter Space Flight Simulator 2016 version.

## Operational Role

For a systems engineer, ADSWNJ/LagrangeMFD belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-11-19T22:29:57Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-121ffbdde32046` from `github_search_space_shuttles` as `registry_expansion`
