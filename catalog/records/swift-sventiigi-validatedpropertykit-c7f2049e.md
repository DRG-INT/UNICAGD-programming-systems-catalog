...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SvenTiigi/ValidatedPropertyKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SvenTiigi/ValidatedPropertyKit](https://github.com/SvenTiigi/ValidatedPropertyKit) |
| Source record ids | github_search_swift-36c08be311774d |
...
For a systems engineer, SvenTiigi/ValidatedPropertyKit belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-08T06:59:50Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-36c08be311774d` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Mijick/Camera | Datetime | [open](swift-mijick-camera-ba7e7b8b.md) |
| Mijick/Timer | Datetime | [open](swift-mijick-timer-321f7ea0.md) |
