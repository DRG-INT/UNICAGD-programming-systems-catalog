...
| Canonical URL | [https://crates.io/crates/sval_nested](https://crates.io/crates/sval_nested) |
| Source record ids | crates_io-06b0693c7dfc75 |
...
For a systems engineer, sval_nested belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.22.0 | 2026-08-31T03:46:18.522277Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-06b0693c7dfc75` from `crates_io` as `registry_expansion`
