...
<!-- canonical: https://github.com/athityakumar/colorls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/athityakumar/colorls](https://github.com/athityakumar/colorls) |
| Source record ids | github_search_icons_and_logos-e1c91e18abc3cb |
...
For a systems engineer, athityakumar/colorls belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T11:41:05Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-e1c91e18abc3cb` from `github_search_icons_and_logos` as `registry_expansion`
