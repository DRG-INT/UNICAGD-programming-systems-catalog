...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChainForth](https://github.com/JuliaRegistries/General/tree/master/C/ChainForth) |
| Source record ids | julia_general-c30f77399a5a07 |

## System Engineer Summary

Julia package registered in General at C/ChainForth.

## Operational Role

For a systems engineer, ChainForth belongs in the Julia inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChainForth", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c30f77399a5a07` from `julia_general` as `registry_expansion`
