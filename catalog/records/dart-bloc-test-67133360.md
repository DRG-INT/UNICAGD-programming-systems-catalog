...
<!-- canonical: https://pub.dev/packages/bloc_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/bloc_test](https://pub.dev/packages/bloc_test) |
| Source record ids | pub_dev-019602d62e2f58 |

## System Engineer Summary

A testing library which makes it easy to test blocs. Built to be used with the bloc state management
package.

## Operational Role

For a systems engineer, bloc_test belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.0 | 2025-01-12T21:09:50.622153Z | [https://pub.dev/api/packages/bloc_test](https://pub.dev/api/packages/bloc_test) |  |
| preview | known | 9.0.0-dev.5 | 2021-11-14T22:56:58.241125Z | [https://pub.dev/api/packages/bloc_test](https://pub.dev/api/packages/bloc_test) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/bloc_test` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-019602d62e2f58` from `pub_dev` as `registry_expansion`
