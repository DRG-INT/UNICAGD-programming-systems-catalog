...
| Canonical URL | [https://github.com/CarVac/filmulator-gui](https://github.com/CarVac/filmulator-gui) |
| Source record ids | github_search_photography-7bf828ed90baaa |
...
For a systems engineer, CarVac/filmulator-gui belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.12.0 | 2026-04-04T15:01:23Z | [https://api.github.com/repos/CarVac/filmulator-gui/releases/latest](https://api.github.com/repos/CarVac/filmulator-gui/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CarVac/filmulator-gui/releases/latest` at `2026-09-01T09:23:29+00:00`.
...
- `github_search_photography-7bf828ed90baaa` from `github_search_photography` as `registry_expansion`
