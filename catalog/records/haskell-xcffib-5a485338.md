...
<!-- canonical: https://hackage.haskell.org/package/xcffib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/xcffib](https://hackage.haskell.org/package/xcffib) |
| Source record ids | hackage_top_downloads-842b4d19bd81df |
...
For a systems engineer, xcffib belongs in the Haskell inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12.0 | 2025-12-14T17:38:07Z | [https://hackage.haskell.org/package/xcffib](https://hackage.haskell.org/package/xcffib) |  |
| candidate | partial | 0.6.0 |  | [https://hackage.haskell.org/package/xcffib](https://hackage.haskell.org/package/xcffib) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/xcffib` at `2026-09-01T14:24:43+00:00`.
...
- `hackage_top_downloads-842b4d19bd81df` from `hackage_top_downloads` as `registry_expansion`
