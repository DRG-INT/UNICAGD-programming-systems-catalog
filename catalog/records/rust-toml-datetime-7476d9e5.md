...
<!-- canonical: https://crates.io/crates/toml_datetime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/toml_datetime](https://crates.io/crates/toml_datetime) |
| Source record ids | crates_io-f3a9d4f4225429 |
...
For a systems engineer, toml_datetime belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1+spec-1.1.0 | 2026-03-31T19:06:07.594537Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-f3a9d4f4225429` from `crates_io` as `registry_expansion`
