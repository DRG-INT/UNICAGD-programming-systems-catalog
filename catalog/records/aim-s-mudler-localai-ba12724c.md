...
<!-- canonical: https://github.com/mudler/LocalAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mudler/LocalAI](https://github.com/mudler/LocalAI) |
| Source record ids | github_search_aims-c0608a5e501f96 |

## System Engineer Summary

LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any
hardware. No GPU required.

## Operational Role

For a systems engineer, mudler/LocalAI belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T10:45:56Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | BSD Zero Clause License; https://api.github.com/licenses/0bsd; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_aims-c0608a5e501f96` from `github_search_aims` as `registry_expansion`
