...
<!-- canonical: https://pub.dev/packages/built_collection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/built_collection](https://pub.dev/packages/built_collection) |
| Source record ids | pub_dev-958963c8cb0358 |

## System Engineer Summary

Immutable collections based on the SDK collections. Each SDK collection class is split into a new
immutable collection class and a corresponding mutable builder class.

## Operational Role

For a systems engineer, built_collection belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.1 | 2021-09-03T07:47:53.359281Z | [https://pub.dev/api/packages/built_collection](https://pub.dev/api/packages/built_collection) |  |
| preview | known | 5.0.0-nullsafety.0 | 2020-11-17T10:35:34.510180Z | [https://pub.dev/api/packages/built_collection](https://pub.dev/api/packages/built_collection) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/built_collection` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-958963c8cb0358` from `pub_dev` as `registry_expansion`
