...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/AssemblyScript/assemblyscript](https://github.com/AssemblyScript/assemblyscript) |
| Source record ids | awesome_list-02f7f36f4f2156 |

## System Engineer Summary

AssemblyScript - Definitely not a TypeScript to WebAssembly compiler is tracked as a compiler record
in the WebAssembly branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, AssemblyScript - Definitely not a TypeScript to WebAssembly compiler belongs
in the WebAssembly inventory as part of compiler selection, diagnostics behavior, target support,
ABI expectations, and build reproducibility.
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Compilers", "source_url": "https://raw.githubusercontent.com/mbasso/awesome-wasm/master/README.md", "status": "curated-list-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `awesome_list-02f7f36f4f2156` from `awesome_list` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Asterius - A Haskell to WebAssembly compiler | Compiler | [open](webassembly-asterius-a-haskell-to-webassembly-compiler-4b7ccecb.md) |
| Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++ | Compiler | [open](webassembly-binaryen-binaryen-is-a-compiler-and-toolchain-infrastructure-library-for-webassembly-written-in-c-b9de4902.md) |
| Emscripten - LLVM-based project that compiles C and C++ | Compiler | [open](webassembly-emscripten-llvm-based-project-that-compiles-c-and-c-c903d9d1.md) |
| emscripten-core/emscripten | Compiler | [open](webassembly-emscripten-core-emscripten-919748ea.md) |
| ilwasm - CIL to WebAssembly compiler | Compiler | [open](webassembly-ilwasm-cil-to-webassembly-compiler-59942fe8.md) |
| PPCI.wasm - PPCI Can compile wasm to machine code and run it in the Python process | Compiler | [open](webassembly-ppci-wasm-ppci-can-compile-wasm-to-machine-code-and-run-it-in-the-python-process-fd90aa07.md) |
| TinyGo - Go for embedded devices and WebAssembly. Creates very small .wasm files. | Compiler | [open](webassembly-tinygo-go-for-embedded-devices-and-webassembly-creates-very-small-wasm-files-2517e753.md) |
| tinygo-org/tinygo | Compiler | [open](webassembly-tinygo-org-tinygo-509450fb.md) |
