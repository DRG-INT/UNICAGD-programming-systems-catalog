...
<!-- canonical: https://cran.r-project.org/web/packages/TFisher/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TFisher/index.html](https://cran.r-project.org/web/packages/TFisher/index.html) |
| Source record ids | cran_packages_by_date-980e47601cdd55 |
...
For a systems engineer, TFisher belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-25 05:20:54 UTC | [https://cran.r-project.org/web/packages/TFisher/DESCRIPTION](https://cran.r-project.org/web/packages/TFisher/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TFisher/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-980e47601cdd55` from `cran_packages_by_date` as `registry_expansion`
