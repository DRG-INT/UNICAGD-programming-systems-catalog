...
<!-- canonical: https://cran.r-project.org/web/packages/RANN/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RANN/index.html](https://cran.r-project.org/web/packages/RANN/index.html) |
| Source record ids | cran_packages_by_date-fa8264ddaedbd6 |
...
For a systems engineer, RANN belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.3 | 2026-08-24 05:20:48 UTC | [https://cran.r-project.org/web/packages/RANN/DESCRIPTION](https://cran.r-project.org/web/packages/RANN/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RANN/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fa8264ddaedbd6` from `cran_packages_by_date` as `registry_expansion`
