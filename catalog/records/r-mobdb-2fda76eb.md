...
<!-- canonical: https://cran.r-project.org/web/packages/mobdb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mobdb/index.html](https://cran.r-project.org/web/packages/mobdb/index.html) |
| Source record ids | cran_packages_by_date-4b423869b64cab |

## System Engineer Summary

Access the 'Mobility Database' API to Discover Transit Feeds

## Operational Role

For a systems engineer, mobdb belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-28 21:40:02 UTC | [https://cran.r-project.org/web/packages/mobdb/DESCRIPTION](https://cran.r-project.org/web/packages/mobdb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mobdb/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4b423869b64cab` from `cran_packages_by_date` as `registry_expansion`
