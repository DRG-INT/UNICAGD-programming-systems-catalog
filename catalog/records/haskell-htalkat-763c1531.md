...
<!-- canonical: https://hackage.haskell.org/package/htalkat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/htalkat](https://hackage.haskell.org/package/htalkat) |
| Source record ids | hackage_recent-3b809eae641976 |

## System Engineer Summary

Hackage package recently uploaded by mbays.

## Operational Role

For a systems engineer, htalkat belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2.7 | 2026-09-06T10:41:24Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-3b809eae641976` from `hackage_recent` as `registry_expansion`
