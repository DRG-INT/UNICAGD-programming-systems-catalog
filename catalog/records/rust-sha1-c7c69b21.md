...
<!-- canonical: https://crates.io/crates/sha1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sha1](https://crates.io/crates/sha1) |
| Source record ids | crates_io-cdbd80621ec9cc, crates_io-a307b0b3295530 |

## System Engineer Summary

sha1 is tracked as a cryptography record in the Rust branch. The source did not provide a long
...
For a systems engineer, sha1 belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2026-07-10T14:30:11.575923Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-cdbd80621ec9cc` from `crates_io` as `registry_expansion`
- `crates_io-a307b0b3295530` from `crates_io` as `registry_expansion`
