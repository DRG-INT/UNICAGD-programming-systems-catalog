...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/imagingbook/imagingbook-calibrate](https://github.com/imagingbook/imagingbook-calibrate) |
| Source record ids | github_search_microscopy-a6632fd6b4cf9f |
...
For a systems engineer, imagingbook/imagingbook-calibrate belongs in the Microscopy inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0b | 2025-10-25T07:48:18Z | [https://api.github.com/repos/imagingbook/imagingbook-calibrate/releases/latest](https://api.github.com/repos/imagingbook/imagingbook-calibrate/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/imagingbook/imagingbook-calibrate/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:imagej stars:>20", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_microscopy-a6632fd6b4cf9f` from `github_search_microscopy` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bioimage-io/core-bioimage-io-python | Image Audio Dsp | [open](microscopy-bioimage-io-core-bioimage-io-python-adb47750.md) |
| bockp/Edge-Detection-project | Image Audio Dsp | [open](microscopy-bockp-edge-detection-project-162e0a24.md) |
| bruvellu/color-blind-luts | Image Audio Dsp | [open](microscopy-bruvellu-color-blind-luts-f9d56aab.md) |
| CellProfiler | Image Audio Dsp | [open](microscopy-cellprofiler-47c245ad.md) |
| emx77/ASI_MTF | Image Audio Dsp | [open](microscopy-emx77-asi-mtf-b19ffd0e.md) |
| Fiji | Image Audio Dsp | [open](microscopy-fiji-ce6f3ab9.md) |
| ij-plugins/ijp-color | Image Audio Dsp | [open](microscopy-ij-plugins-ijp-color-94c66ebb.md) |
| Image-Py/imagepy | Image Audio Dsp | [open](microscopy-image-py-imagepy-e0c3a790.md) |
