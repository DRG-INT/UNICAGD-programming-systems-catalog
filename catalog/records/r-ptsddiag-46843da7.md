...
<!-- canonical: https://cran.r-project.org/web/packages/PTSDdiag/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PTSDdiag/index.html](https://cran.r-project.org/web/packages/PTSDdiag/index.html) |
| Source record ids | cran_packages_by_date-ce3b7142b3bf9e |
...
For a systems engineer, PTSDdiag belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-04 16:30:28 UTC | [https://cran.r-project.org/web/packages/PTSDdiag/DESCRIPTION](https://cran.r-project.org/web/packages/PTSDdiag/DESCRIPTION) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PTSDdiag/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ce3b7142b3bf9e` from `cran_packages_by_date` as `registry_expansion`
...
| ForceChoice | Compiler Diagnostics | [open](r-forcechoice-c43bb33a.md) |
