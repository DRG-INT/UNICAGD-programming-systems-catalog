...
<!-- canonical: http://vrld.github.io/hump/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://vrld.github.io/hump/](http://vrld.github.io/hump/) |
| Source record ids | lua-source-128 |
...
For a systems engineer, HUMP belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 128}}` |
...
- `lua-source-128` from `master_json` as `source_list_item`
