...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Precommit Ci Quality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/precommit-ci-quality.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-afa74eb9ce3bb7 |

## System Engineer Summary

pre-commit is tracked as a precommit ci quality record in the Python branch. The source did not
...
For a systems engineer, pre-commit belongs in the Python inventory as part of ecosystem capability
...
- `corpus-afa74eb9ce3bb7` from `master_json` as `precommit_ci_quality`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Prospector | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-prospector-89c5cbfc.md) |
| SonarQube Python analyzer | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-sonarqube-python-analyzer-8edc33ee.md) |
