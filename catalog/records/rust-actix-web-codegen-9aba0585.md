...
<!-- canonical: https://crates.io/crates/actix-web-codegen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-web-codegen](https://crates.io/crates/actix-web-codegen) |
| Source record ids | crates_io-6af9d559cef61a |
...
For a systems engineer, actix-web-codegen belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2024-06-08T23:24:23.437523Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-6af9d559cef61a` from `crates_io` as `registry_expansion`
...
| backtrace | Interpreter Runtime | [open](rust-backtrace-5a2e8e86.md) |
