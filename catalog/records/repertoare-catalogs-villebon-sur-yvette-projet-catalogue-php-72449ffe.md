# Villebon-Sur-Yvette/Projet-catalogue-PHP
...
<!-- canonical: https://github.com/Villebon-Sur-Yvette/Projet-catalogue-PHP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Villebon-Sur-Yvette/Projet-catalogue-PHP](https://github.com/Villebon-Sur-Yvette/Projet-catalogue-PHP) |
| Source record ids | github_search_repertoare_catalogs-45c495096a735a |

## System Engineer Summary

Ce répertoire recense l'ensemble des fichiers nécessaires pour faire tourner le site du projet PHP
"Catalogue de bibliothèque".

## Operational Role

For a systems engineer, Villebon-Sur-Yvette/Projet-catalogue-PHP belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-03-31T22:03:33Z | gh search repos repertoire catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-45c495096a735a` from `github_search_repertoare_catalogs` as `registry_expansion`
