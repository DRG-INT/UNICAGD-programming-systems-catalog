...
<!-- canonical: https://hackage.haskell.org/package/semirings -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/semirings](https://hackage.haskell.org/package/semirings) |
| Source record ids | hackage_top_downloads-2840fa106ba12e |
...
For a systems engineer, semirings belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7 | 2024-05-21T19:43:36Z | [https://hackage.haskell.org/package/semirings](https://hackage.haskell.org/package/semirings) |  |
| candidate | partial | 0.2.0.0 |  | [https://hackage.haskell.org/package/semirings](https://hackage.haskell.org/package/semirings) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/semirings` at `2026-09-09T00:35:13+00:00`.
...
- `hackage_top_downloads-2840fa106ba12e` from `hackage_top_downloads` as `registry_expansion`
