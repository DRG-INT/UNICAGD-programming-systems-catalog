...
<!-- canonical: https://pgbackrest.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pgbackrest.org/](https://pgbackrest.org/) |
| Source record ids | awesome_list-0b11420d44e390 |
...
For a systems engineer, pgBackRest belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-0b11420d44e390` from `awesome_list` as `registry_expansion`
