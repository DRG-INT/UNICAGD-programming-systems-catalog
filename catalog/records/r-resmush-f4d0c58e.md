...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/resmush/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/resmush/index.html](https://cran.r-project.org/web/packages/resmush/index.html) |
| Source record ids | cran_packages_by_date-94b2ad65e4e7eb |
...
For a systems engineer, resmush belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-25 11:20:02 UTC | [https://cran.r-project.org/web/packages/resmush/DESCRIPTION](https://cran.r-project.org/web/packages/resmush/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/resmush/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-94b2ad65e4e7eb` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| zipcodeR | Compression | [open](r-zipcoder-ccf52b98.md) |
