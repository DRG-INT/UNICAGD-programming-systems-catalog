# youinuk/control-space_scaling

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/youinuk/control-space_scaling](https://github.com/youinuk/control-space_scaling) |
| Source record ids | github_search_space_shuttles-4f518e1045f025 |

## System Engineer Summary

This repository contains the manuscript source, simulation scripts, generated figures, and source-
data CSV files for the manuscript: Control-Space Scaling of Correlated Phase Networks in Parallel
Spin Shuttling Architectures

## Operational Role

For a systems engineer, youinuk/control-space_scaling belongs in the Space Shuttles inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.3-arxiv | 2026-07-16T03:38:37Z | [https://api.github.com/repos/youinuk/control-space_scaling/releases/latest](https://api.github.com/repos/youinuk/control-space_scaling/releases/latest) |  |
| preview | known | v1.0.0-predoi | 2026-06-09T03:15:35Z | [https://api.github.com/repos/youinuk/control-space_scaling/releases?per_page=10](https://api.github.com/repos/youinuk/control-space_scaling/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/youinuk/control-space_scaling/releases/latest` at `2026-09-01T07:24:24+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "space shuttle simulation", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_space_shuttles-4f518e1045f025` from `github_search_space_shuttles` as `registry_expansion`
