...
<!-- canonical: https://github.com/satellite-image-deep-learning/datasets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/satellite-image-deep-learning/datasets](https://github.com/satellite-image-deep-learning/datasets) |
| Source record ids | github_search_radars-3cdd582d2d12bd |
...
For a systems engineer, satellite-image-deep-learning/datasets belongs in the Radars inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:51:43Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3cdd582d2d12bd` from `github_search_radars` as `registry_expansion`
