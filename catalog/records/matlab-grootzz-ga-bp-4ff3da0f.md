...
<!-- canonical: https://github.com/Grootzz/GA-BP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Grootzz/GA-BP](https://github.com/Grootzz/GA-BP) |
| Source record ids | github_search_matlab-4538d6e6ce9ea3 |
...
For a systems engineer, Grootzz/GA-BP belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-09T12:19:52Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-4538d6e6ce9ea3` from `github_search_matlab` as `registry_expansion`
