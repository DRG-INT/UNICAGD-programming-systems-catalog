...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/zlib-rs -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.8 | 2026-09-15T13:10:00.283903Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-15T14:21:13+00:00`.
...
- `crates_io-b47b6b52d911ab` from `crates_io` as `registry_expansion`
