...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Memory Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/memory-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/zlib-rs](https://crates.io/crates/zlib-rs) |
| Source record ids | crates_io-b47b6b52d911ab |
...
For a systems engineer, zlib-rs belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.7 | 2026-08-03T13:07:20.445034Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| astral-tokio-tar | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-astral-tokio-tar-cc055656.md) |
| bitvec | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bitvec-c2457646.md) |
| bytecheck | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bytecheck-fe3284f0.md) |
| compact_str | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-compact-str-7f4b0cf3.md) |
| dary_heap | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dary-heap-2e7eb5bf.md) |
| datafusion | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-datafusion-9ece1411.md) |
| fontdb | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-fontdb-db3bfb04.md) |
| git2 | Memory Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-git2-edeb3289.md) |
