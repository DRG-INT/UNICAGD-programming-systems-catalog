...
<!-- canonical: https://github.com/alecjacobson/gptoolbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alecjacobson/gptoolbox](https://github.com/alecjacobson/gptoolbox) |
| Source record ids | github_search_matlab-86999ec68ed324 |
...
For a systems engineer, alecjacobson/gptoolbox belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T20:42:17Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-86999ec68ed324` from `github_search_matlab` as `registry_expansion`
