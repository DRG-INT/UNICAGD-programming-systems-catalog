...
[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Container Deployment](../by-category/container-deployment.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/waydroid/waydroid](https://github.com/waydroid/waydroid) |
| Source record ids | curated_language_routes-3c4985cab31b21 |

## System Engineer Summary

Container-based Android runtime route for Linux hosts; useful as a comparison point, but not a macOS
or FreeBSD runtime by itself.

## Operational Role

For a systems engineer, Waydroid belongs in the Radio Garden Speciality inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.3 | 2026-05-28T20:12:19Z | [https://api.github.com/repos/waydroid/waydroid/releases/latest](https://api.github.com/repos/waydroid/waydroid/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/waydroid/waydroid/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-3c4985cab31b21` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| BlueStacks Radio Garden Route | Container Deployment | [open](radio-garden-speciality-bluestacks-radio-garden-route-1c58e6f4.md) |
