...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BEASTDataPrep -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BEASTDataPrep](https://github.com/JuliaRegistries/General/tree/master/B/BEASTDataPrep) |
| Source record ids | julia_general-9865a70251595c |

## System Engineer Summary

Julia package registered in General at B/BEASTDataPrep.

## Operational Role

For a systems engineer, BEASTDataPrep belongs in the Julia inventory as part of language tooling,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BEASTDataPrep", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-9865a70251595c` from `julia_general` as `registry_expansion`
