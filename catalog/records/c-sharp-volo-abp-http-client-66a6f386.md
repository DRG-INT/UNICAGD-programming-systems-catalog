...
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Http.Client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Http.Client](https://www.nuget.org/packages/Volo.Abp.Http.Client) |
| Source record ids | nuget_search-121ce085b82bf7 |

## System Engineer Summary

Volo.Abp.Http.Client is tracked as a project scaffolding record in the C-Sharp branch. The source
...
For a systems engineer, Volo.Abp.Http.Client belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:02.16+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.client/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.client/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:21.907+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.client/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.client/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Http.Client/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.client/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-121ce085b82bf7` from `nuget_search` as `registry_expansion`
