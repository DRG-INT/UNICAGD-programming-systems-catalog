...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tuliofalmeida/jama -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tuliofalmeida/jama](https://github.com/tuliofalmeida/jama) |
| Source record ids | github_search_electromagnetoscopes-9928d2bfef7b46 |

## System Engineer Summary

JAMA is a device to measure joint angles wirelessly with 9 DOF, using a microcontroller (ESP32)
together with an inertial measure unit (GY-80).

## Operational Role

For a systems engineer, tuliofalmeida/jama belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-28T13:26:34Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-9928d2bfef7b46` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rtl-airband/RTLSDR-Airband | Cryptography | [open](electromagnetoscopes-rtl-airband-rtlsdr-airband-0011999f.md) |
