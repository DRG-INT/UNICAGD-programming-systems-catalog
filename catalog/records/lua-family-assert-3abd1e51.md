...
<!-- canonical: https://luarocks.org/modules/mah0x211/assert -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/assert](https://luarocks.org/modules/mah0x211/assert) |
| Source record ids | luarocks_root_manifest-f71a5d0e0a3ab6 |
...
For a systems engineer, assert belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-f71a5d0e0a3ab6` from `luarocks_root_manifest` as `registry_expansion`
