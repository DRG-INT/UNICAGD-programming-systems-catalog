...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/ionicons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ionicons](https://pub.dev/packages/ionicons) |
| Source record ids | pub_dev-7849909c014e61 |

## System Engineer Summary

Ionicons is a completely open-source icon set with 1k3+ icons crafted for web, iOS, Android, and
desktop apps. They have both Material Design and iOS versions.

## Operational Role

For a systems engineer, ionicons belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-08-14T11:56:18.816042Z | [https://pub.dev/api/packages/ionicons](https://pub.dev/api/packages/ionicons) |  |
...
| Evidence | MIT; MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ionicons` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-7849909c014e61` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adaptive_action_sheet | Filesystem Os | [open](dart-adaptive-action-sheet-a034d505.md) |
| adaptive_platform_ui | Filesystem Os | [open](dart-adaptive-platform-ui-199cff50.md) |
| alarm | Filesystem Os | [open](dart-alarm-390891d2.md) |
| android_intent_plus | Filesystem Os | [open](dart-android-intent-plus-0c9e162b.md) |
| app_badge_plus | Filesystem Os | [open](dart-app-badge-plus-a51749d2.md) |
| app_links | Filesystem Os | [open](dart-app-links-97fd4e93.md) |
| appsflyer_sdk | Filesystem Os | [open](dart-appsflyer-sdk-6ae65c04.md) |
| arkit_plugin | Filesystem Os | [open](dart-arkit-plugin-b18fbe65.md) |
