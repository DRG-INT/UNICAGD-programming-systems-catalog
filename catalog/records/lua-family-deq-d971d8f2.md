...
<!-- canonical: https://luarocks.org/modules/mah0x211/deq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/deq](https://luarocks.org/modules/mah0x211/deq) |
| Source record ids | luarocks_root_manifest-e10772a8289f06 |

## System Engineer Summary

deq is tracked as an undefined behavior analyzer record in the Lua family branch. The source did not
...
For a systems engineer, deq belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e10772a8289f06` from `luarocks_root_manifest` as `registry_expansion`
