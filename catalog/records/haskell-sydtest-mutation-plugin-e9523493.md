...
<!-- canonical: https://hackage.haskell.org/package/sydtest-mutation-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/sydtest-mutation-plugin](https://hackage.haskell.org/package/sydtest-mutation-plugin) |
| Source record ids | hackage_recent-3be7b5b82f8183 |
...
For a systems engineer, sydtest-mutation-plugin belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.0 | 2026-09-11T13:23:55Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-3be7b5b82f8183` from `hackage_recent` as `registry_expansion`
