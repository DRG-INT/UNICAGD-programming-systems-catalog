...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/spatie/laravel-database-mail-templates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spatie/laravel-database-mail-templates](https://packagist.org/packages/spatie/laravel-database-mail-templates) |
| Source record ids | packagist_search-0605061147c506 |
...
For a systems engineer, spatie/laravel-database-mail-templates belongs in the PHP inventory as part
...
- `packagist_search-0605061147c506` from `packagist_search` as `registry_expansion`
