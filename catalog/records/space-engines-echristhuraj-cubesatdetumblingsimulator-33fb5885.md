# echristhuraj/CubeSatDetumblingSimulator

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/echristhuraj/CubeSatDetumblingSimulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/echristhuraj/CubeSatDetumblingSimulator](https://github.com/echristhuraj/CubeSatDetumblingSimulator) |
| Source record ids | github_search_space_engines-7b078d311d458d |

## System Engineer Summary

6DOF simulation of a CubeSat detumbling in LEO under 3-axis magnetic control using a B-dot
controller and LPFs in closed-loop feedback.

## Operational Role

For a systems engineer, echristhuraj/CubeSatDetumblingSimulator belongs in the Space Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-18T10:41:00Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-7b078d311d458d` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| daftcube/orbitlib | Undefined Behavior Analyzer | [open](space-engines-daftcube-orbitlib-c832782c.md) |
| Hunter-Github/GitScience | Undefined Behavior Analyzer | [open](space-engines-hunter-github-gitscience-4db7d0dd.md) |
| jorgepiloto/lamberthub | Undefined Behavior Analyzer | [open](space-engines-jorgepiloto-lamberthub-2cdb9df3.md) |
