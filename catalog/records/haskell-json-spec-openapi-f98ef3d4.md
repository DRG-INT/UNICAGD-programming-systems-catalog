...
| Source record ids | hackage_top_downloads-9b3ac8d8fb94f1 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/json-spec-openapi` at `2026-09-11T00:31:27+00:00`.
...
- `hackage_top_downloads-9b3ac8d8fb94f1` from `hackage_top_downloads` as `registry_expansion`
