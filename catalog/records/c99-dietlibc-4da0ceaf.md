...
| Source record ids | corpus-fdfef77227b579 |

## System Engineer Summary

dietlibc is tracked as a library record in the C99 branch. The source did not provide a long
...
For a systems engineer, dietlibc belongs in the C99 inventory as part of ecosystem capability
...
- `corpus-fdfef77227b579` from `master_json` as `library`
