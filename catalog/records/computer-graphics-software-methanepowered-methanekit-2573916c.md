...
<!-- canonical: https://github.com/MethanePowered/MethaneKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MethanePowered/MethaneKit](https://github.com/MethanePowered/MethaneKit) |
| Source record ids | github_search_computer_graphics_software-d2e2cc03b27a04 |

## System Engineer Summary

🎲 Modern 3D graphics made simple with C++20 cross-platform framework and rendering abstraction API
on top of DirectX 12, Vulkan & Metal

## Operational Role

For a systems engineer, MethanePowered/MethaneKit belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-d2e2cc03b27a04` from `github_search_computer_graphics_software` as `registry_expansion`
