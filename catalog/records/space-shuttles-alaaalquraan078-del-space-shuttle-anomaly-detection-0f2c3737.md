# alaaalquraan078-del/space-shuttle-anomaly-detection

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/alaaalquraan078-del/space-shuttle-anomaly-detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alaaalquraan078-del/space-shuttle-anomaly-detection](https://github.com/alaaalquraan078-del/space-shuttle-anomaly-detection) |
| Source record ids | github_search_space_shuttles-e8d1e4c72050b4 |

## System Engineer Summary

An end-to-end unsupervised ML & Deep Learning pipeline (PCA, t-SNE, DBSCAN, OC-SVM, and Keras
Autoencoders) engineered for high-dimensional anomaly detection on Space Shuttle telemetry logs,
achieving 93% accuracy.

## Operational Role

For a systems engineer, alaaalquraan078-del/space-shuttle-anomaly-detection belongs in the Space
Shuttles inventory as part of runtime behavior, deployment packaging, embedding, upgrade cadence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-24T19:46:05Z | gh search repos space shuttle telemetry | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-e8d1e4c72050b4` from `github_search_space_shuttles` as `registry_expansion`
