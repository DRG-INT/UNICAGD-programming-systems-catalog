...
| Canonical URL | [https://github.com/iver56/torch-audiomentations](https://github.com/iver56/torch-audiomentations) |
| Source record ids | github_search_audio-5bae0c0983fc94 |
...
For a systems engineer, iver56/torch-audiomentations belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.12.0 | 2025-01-15T09:05:36Z | [https://api.github.com/repos/iver56/torch-audiomentations/releases/latest](https://api.github.com/repos/iver56/torch-audiomentations/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/iver56/torch-audiomentations/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-5bae0c0983fc94` from `github_search_audio` as `registry_expansion`
...
| sergree/matchering | Parser Lexer Ast | [open](audio-sergree-matchering-c548e8ba.md) |
| SFML/SFML | Parser Lexer Ast | [open](audio-sfml-sfml-5e33b791.md) |
| snapcast/snapcast | Parser Lexer Ast | [open](audio-snapcast-snapcast-fc2313eb.md) |
