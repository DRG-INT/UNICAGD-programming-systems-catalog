...
<!-- canonical: https://luarocks.org/modules/freed-wu/currfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/currfile](https://luarocks.org/modules/freed-wu/currfile) |
| Source record ids | luarocks_root_manifest-99272bf6f5ca68 |
...
For a systems engineer, currfile belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-99272bf6f5ca68` from `luarocks_root_manifest` as `registry_expansion`
