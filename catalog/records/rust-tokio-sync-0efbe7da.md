...
| Canonical URL | [https://crates.io/crates/tokio-sync](https://crates.io/crates/tokio-sync) |
| Source record ids | crates_io-1e3bafed81c57c |
...
For a systems engineer, tokio-sync belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2020-02-05T00:23:14.285472Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-1e3bafed81c57c` from `crates_io` as `registry_expansion`
