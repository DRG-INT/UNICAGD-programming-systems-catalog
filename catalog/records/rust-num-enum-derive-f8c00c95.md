...
<!-- canonical: https://crates.io/crates/num_enum_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num_enum_derive](https://crates.io/crates/num_enum_derive) |
| Source record ids | crates_io-74da9fa8843691 |
...
For a systems engineer, num_enum_derive belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.6 | 2026-03-15T21:29:38.220565Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-74da9fa8843691` from `crates_io` as `registry_expansion`
