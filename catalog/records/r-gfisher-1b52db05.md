...
<!-- canonical: https://cran.r-project.org/web/packages/GFisher/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GFisher/index.html](https://cran.r-project.org/web/packages/GFisher/index.html) |
| Source record ids | cran_packages_by_date-bd93ca416b09a5 |
...
For a systems engineer, GFisher belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-24 18:30:20 UTC | [https://cran.r-project.org/web/packages/GFisher/DESCRIPTION](https://cran.r-project.org/web/packages/GFisher/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GFisher/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bd93ca416b09a5` from `cran_packages_by_date` as `registry_expansion`
