...
<!-- canonical: https://pypi.org/project/A-Api-Server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/A-Api-Server/](https://pypi.org/project/A-Api-Server/) |
| Source record ids | pypi_simple-9aee83855b7786 |
...
For a systems engineer, A-Api-Server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2025-10-29T03:24:14.059253Z | [https://pypi.org/pypi/A-Api-Server/json](https://pypi.org/pypi/A-Api-Server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/A-Api-Server/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-9aee83855b7786` from `pypi_simple` as `registry_expansion`
