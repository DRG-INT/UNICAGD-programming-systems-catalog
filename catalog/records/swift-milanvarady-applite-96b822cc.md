...
<!-- canonical: https://github.com/milanvarady/Applite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/milanvarady/Applite](https://github.com/milanvarady/Applite) |
| Source record ids | github_search_swift-69c1754e3b69d8 |
...
For a systems engineer, milanvarady/Applite belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T21:26:35Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-69c1754e3b69d8` from `github_search_swift` as `registry_expansion`
