...
| Source record ids | corpus-fb5c8249aa4a51 |
...
For a systems engineer, proc-macro2 belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.107 | 2026-07-19T00:18:25.189787Z | [https://crates.io/api/v1/crates/proc-macro2](https://crates.io/api/v1/crates/proc-macro2) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/proc-macro2` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-fb5c8249aa4a51` from `master_json` as `parser_lexer_ast`
