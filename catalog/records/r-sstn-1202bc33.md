...
<!-- canonical: https://cran.r-project.org/web/packages/sstn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sstn/index.html](https://cran.r-project.org/web/packages/sstn/index.html) |
| Source record ids | cran_packages_by_date-3b293bad124e4c |

## System Engineer Summary

Self-Similarity Test for Normality

## Operational Role

For a systems engineer, sstn belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-29 17:10:03 UTC | [https://cran.r-project.org/web/packages/sstn/DESCRIPTION](https://cran.r-project.org/web/packages/sstn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sstn/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3b293bad124e4c` from `cran_packages_by_date` as `registry_expansion`
