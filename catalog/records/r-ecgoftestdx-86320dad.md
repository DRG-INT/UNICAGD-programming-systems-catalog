...
<!-- canonical: https://cran.r-project.org/web/packages/ECGofTestDx/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ECGofTestDx/index.html](https://cran.r-project.org/web/packages/ECGofTestDx/index.html) |
| Source record ids | cran_packages_by_date-1ef23e1d52ecc5 |
...
For a systems engineer, ECGofTestDx belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6 | 2026-09-08 05:30:02 UTC | [https://cran.r-project.org/web/packages/ECGofTestDx/DESCRIPTION](https://cran.r-project.org/web/packages/ECGofTestDx/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ECGofTestDx/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-1ef23e1d52ecc5` from `cran_packages_by_date` as `registry_expansion`
