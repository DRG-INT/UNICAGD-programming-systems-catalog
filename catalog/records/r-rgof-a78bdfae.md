...
<!-- canonical: https://cran.r-project.org/web/packages/Rgof/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rgof/index.html](https://cran.r-project.org/web/packages/Rgof/index.html) |
| Source record ids | cran_packages_by_date-70321aa3a8441c |
...
For a systems engineer, Rgof belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-09-13 11:10:02 UTC | [https://cran.r-project.org/web/packages/Rgof/DESCRIPTION](https://cran.r-project.org/web/packages/Rgof/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rgof/DESCRIPTION` at `2026-09-13T11:18:06+00:00`.
...
- `cran_packages_by_date-70321aa3a8441c` from `cran_packages_by_date` as `registry_expansion`
