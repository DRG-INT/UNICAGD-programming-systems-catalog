...
<!-- canonical: https://cran.r-project.org/web/packages/bgms/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bgms/index.html](https://cran.r-project.org/web/packages/bgms/index.html) |
| Source record ids | cran_packages_by_date-f6a28356b6aff8 |
...
For a systems engineer, bgms belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-08-04 03:00:02 UTC | [https://cran.r-project.org/web/packages/bgms/DESCRIPTION](https://cran.r-project.org/web/packages/bgms/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bgms/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f6a28356b6aff8` from `cran_packages_by_date` as `registry_expansion`
