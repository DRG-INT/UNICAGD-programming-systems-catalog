# balessio/diffusiophoresis_turingPatterns

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/balessio/diffusiophoresis_turingPatterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/balessio/diffusiophoresis_turingPatterns](https://github.com/balessio/diffusiophoresis_turingPatterns) |
| Source record ids | github_search_basilisk-08c584c50a6083 |

## System Engineer Summary

A collection of programs written with Basilisk C for the simulation of reaction-diffusion-advection
problems involving instabilities and diffusiophoresis.

## Operational Role

For a systems engineer, balessio/diffusiophoresis_turingPatterns belongs in the Basilisk inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-19T16:58:59Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-08c584c50a6083` from `github_search_basilisk` as `registry_expansion`
