...
| Source record ids | hackage_recent-40ccfa0687bf2b |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/sbv` at `2026-09-01T07:24:08+00:00`.
...
- `hackage_recent-40ccfa0687bf2b` from `hackage_recent` as `registry_expansion`
