...
<!-- canonical: https://crates.io/crates/spm_precompiled -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/spm_precompiled](https://crates.io/crates/spm_precompiled) |
| Source record ids | crates_io-c44c85e526bed6 |

## System Engineer Summary

This crate aims to emulate Dart::DoubleArray struct and it's Normalizer. This crate is highly
specialized and not intended for general use.

## Operational Role

For a systems engineer, spm_precompiled belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2022-05-30T12:08:06.151975Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
