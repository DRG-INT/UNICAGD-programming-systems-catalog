...
[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sriramyy/KarmanCore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sriramyy/KarmanCore](https://github.com/sriramyy/KarmanCore) |
| Source record ids | github_search_space_shuttles-bd4b2f8aa50a9a |

## System Engineer Summary

An intelligent, high-performance aerospace telemetry engine and embedded dashboard system. It
bridges real-time simulation data from atmospheric flight simulators (MSFS/FSX) to orbital
spaceflights (Kerbal Space Program) using a multi-node ESP32 architecture.

## Operational Role

For a systems engineer, sriramyy/KarmanCore belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-23T16:34:20Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-bd4b2f8aa50a9a` from `github_search_space_shuttles` as `registry_expansion`
