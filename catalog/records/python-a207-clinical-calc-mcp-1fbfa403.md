...
<!-- canonical: https://pypi.org/project/a207-clinical-calc-mcp/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a207-clinical-calc-mcp/](https://pypi.org/project/a207-clinical-calc-mcp/) |
| Source record ids | pypi_simple-1ca01a434a53cb |

## System Engineer Summary

儿童 CKD 临床计算 MCP（M6）：eGFR-Schwartz 估算肾小球滤过率、KDIGO 儿童 CKD 分期（G/A 与合并分期）。医生独占（MX-1），只读计算，无跨包依赖。

## Operational Role

For a systems engineer, a207-clinical-calc-mcp belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-10T06:48:47.537114Z | [https://pypi.org/pypi/a207-clinical-calc-mcp/json](https://pypi.org/pypi/a207-clinical-calc-mcp/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a207-clinical-calc-mcp/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-1ca01a434a53cb` from `pypi_simple` as `registry_expansion`
