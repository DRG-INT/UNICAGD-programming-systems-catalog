...
<!-- canonical: https://pub.dev/packages/restart_app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/restart_app](https://pub.dev/packages/restart_app) |
| Source record ids | pub_dev-261728b77ef1f4 |
...
For a systems engineer, restart_app belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.1 | 2026-08-15T18:50:36.368226Z | [https://pub.dev/api/packages/restart_app](https://pub.dev/api/packages/restart_app) |  |
| preview | known | 1.4.0-beta | 2024-09-16T11:44:36.837596Z | [https://pub.dev/api/packages/restart_app](https://pub.dev/api/packages/restart_app) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/restart_app` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-261728b77ef1f4` from `pub_dev` as `registry_expansion`
