...
<!-- canonical: https://packagist.org/packages/longitude-one/doctrine-spatial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/longitude-one/doctrine-spatial](https://packagist.org/packages/longitude-one/doctrine-spatial) |
| Source record ids | packagist_search-e5631e293d5981 |

## System Engineer Summary

Doctrine multi-platform support for spatial types and functions, compliant with Doctrine 2.19, 3.1,
and dev ones (3.2 and 4.0).

## Operational Role

For a systems engineer, longitude-one/doctrine-spatial belongs in the PHP inventory as part of state
...
- `packagist_search-e5631e293d5981` from `packagist_search` as `registry_expansion`
