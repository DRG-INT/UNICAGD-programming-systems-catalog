...
<!-- canonical: https://github.com/bufferedName/ZSpice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bufferedName/ZSpice](https://github.com/bufferedName/ZSpice) |
| Source record ids | github_search_space_maps-c9ce700e543a1e |

## System Engineer Summary

A RTL Synthesizer that can convert Verilog HDL into transistor-level netlist which can be simulated
by Spice

## Operational Role

For a systems engineer, bufferedName/ZSpice belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-04T05:47:00Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-c9ce700e543a1e` from `github_search_space_maps` as `registry_expansion`
...
| EnvironmentOntology/envo | Logging Observability | [open](space-maps-environmentontology-envo-d2072044.md) |
| europlanet-gmap/awesome-planetary-geology | Logging Observability | [open](space-maps-europlanet-gmap-awesome-planetary-geology-77531f19.md) |
| Eyantra698Sumanto/Spice-to-Verilog-Converter | Logging Observability | [open](space-maps-eyantra698sumanto-spice-to-verilog-converter-85f072c2.md) |
| google/skywater-pdk-sky130-raw-data | Logging Observability | [open](space-maps-google-skywater-pdk-sky130-raw-data-3d29ba51.md) |
| ncas-tum/heracles | Logging Observability | [open](space-maps-ncas-tum-heracles-e2511d32.md) |
| rhovector/Cadence_Virtuoso_180nm_Projects | Logging Observability | [open](space-maps-rhovector-cadence-virtuoso-180nm-projects-042f0fa7.md) |
