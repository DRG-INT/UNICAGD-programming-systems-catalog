...
<!-- canonical: https://pypi.org/project/add-testing/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/add-testing/](https://pypi.org/project/add-testing/) |
| Source record ids | pypi_simple-b2da09c4d1612d |

## System Engineer Summary

add-testing is tracked as a testing framework record in the Python branch. The source did not
...
For a systems engineer, add-testing belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2023-04-11T14:07:09.469911Z | [https://pypi.org/pypi/add-testing/json](https://pypi.org/pypi/add-testing/json) |  |
| preview | known | 1.0.dev3 | 2022-11-17T04:32:19.590635Z | [https://pypi.org/pypi/add-testing/json](https://pypi.org/pypi/add-testing/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/add-testing/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-b2da09c4d1612d` from `pypi_simple` as `registry_expansion`
