...
<!-- canonical: https://cran.r-project.org/web/packages/EFA.dimensions/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EFA.dimensions/index.html](https://cran.r-project.org/web/packages/EFA.dimensions/index.html) |
| Source record ids | cran_packages_by_date-c88154db07e22d |
...
For a systems engineer, EFA.dimensions belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9.1 | 2026-09-14 07:10:42 UTC | [https://cran.r-project.org/web/packages/EFA.dimensions/DESCRIPTION](https://cran.r-project.org/web/packages/EFA.dimensions/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EFA.dimensions/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-c88154db07e22d` from `cran_packages_by_date` as `registry_expansion`
