...
<!-- canonical: https://github.com/apache/ofbiz-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/ofbiz-framework](https://github.com/apache/ofbiz-framework) |
| Source record ids | github_search_maps-14a9339f7fe3d4 |

## System Engineer Summary

Apache OFBiz is an open source product for the automation of enterprise processes. It includes
framework components and business applications for ERP, CRM, E-Business/E-Commerce, Supply Chain
Management and Manufacturing Resource Planning. OFBiz provides a foundation and starting point for
reliable, secure and scalable enterprise solutions.

## Operational Role

For a systems engineer, apache/ofbiz-framework belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:55:16Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-14a9339f7fe3d4` from `github_search_maps` as `registry_expansion`
