...
| Canonical URL | [https://crates.io/crates/unicode-id](https://crates.io/crates/unicode-id) |
| Source record ids | crates_io-38e3158c9593c6 |
...
For a systems engineer, unicode-id belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2026-06-30T11:06:07.043740Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-38e3158c9593c6` from `crates_io` as `registry_expansion`
