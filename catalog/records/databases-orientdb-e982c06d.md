...
| Source record ids | curated_database_systems-22229141f8d72a |

## System Engineer Summary

Multi-model database with graph and document capabilities.

## Operational Role

For a systems engineer, OrientDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-22229141f8d72a` from `curated_database_systems` as `registry_expansion`
