...
<!-- canonical: https://github.com/mtickle/space-game -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mtickle/space-game](https://github.com/mtickle/space-game) |
| Source record ids | github_search_space_maps-d93d00a4dcd6c6 |

## System Engineer Summary

An interactive, procedurally generated galaxy map and planetary system explorer built with React and
HTML5 Canvas. Discover unique stars, alliances, and atmospheric data in an infinite universe.

## Operational Role

For a systems engineer, mtickle/space-game belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T10:36:59Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d93d00a4dcd6c6` from `github_search_space_maps` as `registry_expansion`
