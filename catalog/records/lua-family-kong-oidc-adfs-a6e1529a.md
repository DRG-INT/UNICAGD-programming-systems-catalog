...
| Canonical URL | [https://luarocks.org/modules/philbarr/kong-oidc-adfs](https://luarocks.org/modules/philbarr/kong-oidc-adfs) |
| Source record ids | luarocks_root_manifest-0ebe8474caa649 |

## System Engineer Summary

A Kong plugin for implementing the OpenID Connect Relying Party (RP) functionality, with additional
functionality for ADFS

## Operational Role

For a systems engineer, kong-oidc-adfs belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0ebe8474caa649` from `luarocks_root_manifest` as `registry_expansion`
