...
<!-- canonical: https://hackage.haskell.org/package/hw-prim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hw-prim](https://hackage.haskell.org/package/hw-prim) |
| Source record ids | hackage_top_downloads-08c7458040fc29 |
...
For a systems engineer, hw-prim belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3.2 | 2022-10-30T02:42:20Z | [https://hackage.haskell.org/package/hw-prim](https://hackage.haskell.org/package/hw-prim) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hw-prim` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-08c7458040fc29` from `hackage_top_downloads` as `registry_expansion`
