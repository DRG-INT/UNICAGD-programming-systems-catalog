...
| Canonical URL | [https://github.com/sylvainjule/kirby-locator](https://github.com/sylvainjule/kirby-locator) |
| Source record ids | github_search_maps-d85be107c1ac53 |

## System Engineer Summary

A simple map & geolocation field, built on top of open-source services and Mapbox. Compatible with
Kirby 3, 4, 5.

## Operational Role

For a systems engineer, sylvainjule/kirby-locator belongs in the Maps inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2025-08-04T17:19:04Z | [https://api.github.com/repos/sylvainjule/kirby-locator/releases/latest](https://api.github.com/repos/sylvainjule/kirby-locator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/sylvainjule/kirby-locator/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-d85be107c1ac53` from `github_search_maps` as `registry_expansion`
...
| maptiler/maptiler-sdk-js | Machine Learning | [open](maps-maptiler-maptiler-sdk-js-2a5f0115.md) |
| merlinnot/nominatim-docker | Machine Learning | [open](maps-merlinnot-nominatim-docker-1b141d7d.md) |
| mountain-pass/addressr | Machine Learning | [open](maps-mountain-pass-addressr-dd4eff8b.md) |
| openeventdata/mordecai | Machine Learning | [open](maps-openeventdata-mordecai-3aa9fc97.md) |
