...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Build System](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/build-system.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-b54beeef332639 |

## System Engineer Summary

setuptools is tracked as a build system record in the Python branch. The source did not provide a
...
For a systems engineer, setuptools belongs in the Python inventory as part of build graph control,
...
- `corpus-b54beeef332639` from `master_json` as `build_system`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| build | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-build-a87757ae.md) |
| meson-python | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-meson-python-18d89356.md) |
| PDM | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pdm-076dbfc7.md) |
| scikit-build-core | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-scikit-build-core-b4e5a263.md) |
| wheel | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-wheel-dbbc59d1.md) |
