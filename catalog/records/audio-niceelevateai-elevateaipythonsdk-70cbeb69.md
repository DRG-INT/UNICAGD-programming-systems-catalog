...
<!-- canonical: https://github.com/NICEElevateAI/ElevateAIPythonSDK -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NICEElevateAI/ElevateAIPythonSDK](https://github.com/NICEElevateAI/ElevateAIPythonSDK) |
| Source record ids | github_search_audio-7c91cc83be40a9 |
...
For a systems engineer, NICEElevateAI/ElevateAIPythonSDK belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-17T14:08:56Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-7c91cc83be40a9` from `github_search_audio` as `registry_expansion`
