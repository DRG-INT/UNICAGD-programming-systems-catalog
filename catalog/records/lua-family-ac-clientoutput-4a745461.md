...
<!-- canonical: https://luarocks.org/modules/wesen1/ac-clientoutput -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wesen1/ac-clientoutput](https://luarocks.org/modules/wesen1/ac-clientoutput) |
| Source record ids | luarocks_root_manifest-186090be9dace6 |
...
For a systems engineer, AC-ClientOutput belongs in the Lua family inventory as part of low-noise
...
- `luarocks_root_manifest-186090be9dace6` from `luarocks_root_manifest` as `registry_expansion`
