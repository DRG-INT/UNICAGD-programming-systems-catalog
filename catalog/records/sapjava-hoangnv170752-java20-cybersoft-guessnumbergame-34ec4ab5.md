# hoangnv170752/Java20_Cybersoft_GuessNumberGame
...
<!-- canonical: https://github.com/hoangnv170752/Java20_Cybersoft_GuessNumberGame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hoangnv170752/Java20_Cybersoft_GuessNumberGame](https://github.com/hoangnv170752/Java20_Cybersoft_GuessNumberGame) |
| Source record ids | github_search_sapjava-b0a906d409ac30 |

## System Engineer Summary

TODO: Game đoán số - truy cập vào game sinh ra một số 1-1000 sẽ được sinh ra. Nếu đoán sai thì người
dùng sẽ được gợi ý về số đoán nhỏ hơn hay lớn hơn. Thành tích người dùng sắp xếp dựa trên số lần
đoán.

## Operational Role

For a systems engineer, hoangnv170752/Java20_Cybersoft_GuessNumberGame belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T14:35:50Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; {"key": "", "name": "", "url": ""} |
...
- `github_search_sapjava-b0a906d409ac30` from `github_search_sapjava` as `registry_expansion`
