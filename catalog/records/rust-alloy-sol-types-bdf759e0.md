...
| Canonical URL | [https://crates.io/crates/alloy-sol-types](https://crates.io/crates/alloy-sol-types) |
| Source record ids | crates_io-b3f895c9caabaf |
...
For a systems engineer, alloy-sol-types belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-25T20:59:40.769187Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-b3f895c9caabaf` from `crates_io` as `registry_expansion`
