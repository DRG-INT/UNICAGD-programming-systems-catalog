...
<!-- canonical: https://github.com/tom-mohr/particle-life -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tom-mohr/particle-life](https://github.com/tom-mohr/particle-life) |
| Source record ids | github_search_effects-97d5448a3cab0a |

## System Engineer Summary

🦠 A Java framework that can simulate a variety of particle systems, for example Particle Life, a
particle system showing life-like behaviour

## Operational Role

For a systems engineer, tom-mohr/particle-life belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-13T20:28:52Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-97d5448a3cab0a` from `github_search_effects` as `registry_expansion`
