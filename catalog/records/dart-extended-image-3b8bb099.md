...
<!-- canonical: https://pub.dev/packages/extended_image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/extended_image](https://pub.dev/packages/extended_image) |
| Source record ids | pub_dev-d35a23d61c2467 |

## System Engineer Summary

Official extension image, support placeholder for loading/failed state, cache network, zoom/pan,
photo view, slide out page, editor (crop, rotate, flip), painting etc.

## Operational Role

For a systems engineer, extended_image belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.1.0 | 2026-07-12T09:58:08.844204Z | [https://pub.dev/api/packages/extended_image](https://pub.dev/api/packages/extended_image) |  |
| preview | known | 7.0.0-dev.1 | 2022-05-07T11:47:03.053182Z | [https://pub.dev/api/packages/extended_image](https://pub.dev/api/packages/extended_image) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/extended_image` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-d35a23d61c2467` from `pub_dev` as `registry_expansion`
