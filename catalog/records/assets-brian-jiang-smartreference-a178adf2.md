...
<!-- canonical: https://github.com/Brian-Jiang/SmartReference -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Brian-Jiang/SmartReference](https://github.com/Brian-Jiang/SmartReference) |
| Source record ids | github_search_assets-09920836921f6a |

## System Engineer Summary

Smart Reference is a Unity plugin that enables lazy loading asset references in ScriptableObject and
MonoBehaviour.

## Operational Role

For a systems engineer, Brian-Jiang/SmartReference belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-24T08:51:26Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-09920836921f6a` from `github_search_assets` as `registry_expansion`
