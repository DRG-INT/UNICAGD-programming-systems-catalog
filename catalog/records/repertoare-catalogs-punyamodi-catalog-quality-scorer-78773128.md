# punyamodi/catalog-quality-scorer
...
<!-- canonical: https://github.com/punyamodi/catalog-quality-scorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/punyamodi/catalog-quality-scorer](https://github.com/punyamodi/catalog-quality-scorer) |
| Source record ids | github_search_repertoare_catalogs-9931c6e0796444 |

## System Engineer Summary

AI-powered PDF catalog quality scorer. Get dimension-level scores, ranked issues, export reports,
and compare catalogs side by side.

## Operational Role

For a systems engineer, punyamodi/catalog-quality-scorer belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-01T21:50:40Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-9931c6e0796444` from `github_search_repertoare_catalogs` as `registry_expansion`
