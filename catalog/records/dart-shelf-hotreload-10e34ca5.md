...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/shelf_hotreload -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_hotreload](https://pub.dev/packages/shelf_hotreload) |
| Source record ids | pub_dev-65f0105aa4c7ea |
...
For a systems engineer, shelf_hotreload belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2025-10-17T05:25:32.660119Z | [https://pub.dev/api/packages/shelf_hotreload](https://pub.dev/api/packages/shelf_hotreload) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_hotreload` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-65f0105aa4c7ea` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| swipe_to | Interop Bindings | [open](dart-swipe-to-a0725013.md) |
