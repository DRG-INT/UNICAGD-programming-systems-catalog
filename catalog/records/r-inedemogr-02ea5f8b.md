...
<!-- canonical: https://cran.r-project.org/web/packages/inedemogR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inedemogR/index.html](https://cran.r-project.org/web/packages/inedemogR/index.html) |
| Source record ids | cran_packages_by_date-185580b308a773 |

## System Engineer Summary

Tidy Access to Spanish INE Demographic Data

## Operational Role

For a systems engineer, inedemogR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-23 10:30:08 UTC | [https://cran.r-project.org/web/packages/inedemogR/DESCRIPTION](https://cran.r-project.org/web/packages/inedemogR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inedemogR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-185580b308a773` from `cran_packages_by_date` as `registry_expansion`
