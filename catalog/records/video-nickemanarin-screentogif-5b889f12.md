...
| Canonical URL | [https://github.com/NickeManarin/ScreenToGif](https://github.com/NickeManarin/ScreenToGif) |
| Source record ids | github_search_video-86c1b233b3d43e |

## System Engineer Summary

🎬 ScreenToGif allows you to record a selected area of your screen, edit and save it as a gif or
video.

## Operational Role

For a systems engineer, NickeManarin/ScreenToGif belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.43.2 | 2026-07-28T17:52:48Z | [https://api.github.com/repos/NickeManarin/ScreenToGif/releases/latest](https://api.github.com/repos/NickeManarin/ScreenToGif/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/NickeManarin/ScreenToGif/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-86c1b233b3d43e` from `github_search_video` as `registry_expansion`
