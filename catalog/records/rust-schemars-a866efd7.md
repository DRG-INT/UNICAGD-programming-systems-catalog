...
<!-- canonical: https://crates.io/crates/schemars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/schemars](https://crates.io/crates/schemars) |
| Source record ids | crates_io-fdf5e18f12b7ae |
...
For a systems engineer, schemars belongs in the Rust inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-07-27T14:35:28.246709Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-fdf5e18f12b7ae` from `crates_io` as `registry_expansion`
