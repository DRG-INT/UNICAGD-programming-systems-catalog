...
<!-- canonical: https://cran.r-project.org/web/packages/censosbo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/censosbo/index.html](https://cran.r-project.org/web/packages/censosbo/index.html) |
| Source record ids | cran_packages_by_date-e98560fad3f490 |

## System Engineer Summary

Access and Analysis of Bolivian Census Microdata

## Operational Role

For a systems engineer, censosbo belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-07 16:30:12 UTC | [https://cran.r-project.org/web/packages/censosbo/DESCRIPTION](https://cran.r-project.org/web/packages/censosbo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/censosbo/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e98560fad3f490` from `cran_packages_by_date` as `registry_expansion`
