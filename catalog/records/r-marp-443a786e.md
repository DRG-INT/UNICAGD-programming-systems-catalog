...
<!-- canonical: https://cran.r-project.org/web/packages/marp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/marp/index.html](https://cran.r-project.org/web/packages/marp/index.html) |
| Source record ids | cran_packages_by_date-d2aae173f40e90 |
...
For a systems engineer, marp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-21 08:10:08 UTC | [https://cran.r-project.org/web/packages/marp/DESCRIPTION](https://cran.r-project.org/web/packages/marp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/marp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d2aae173f40e90` from `cran_packages_by_date` as `registry_expansion`
