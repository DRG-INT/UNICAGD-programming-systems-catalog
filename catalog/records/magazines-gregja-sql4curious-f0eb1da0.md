...
<!-- canonical: https://github.com/gregja/sql4curious -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gregja/sql4curious](https://github.com/gregja/sql4curious) |
| Source record ids | github_search_magazines-a085ef814e723b |

## System Engineer Summary

SQL queries for curious developers - techniques for marsterclasses and for articles of GNU/Linux
Magazine

## Operational Role

For a systems engineer, gregja/sql4curious belongs in the Magazines inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-06T18:22:23Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-a085ef814e723b` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gillkyle/sol-journal | Database Datastore | [open](magazines-gillkyle-sol-journal-5e3d3b58.md) |
