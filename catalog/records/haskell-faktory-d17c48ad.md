...
<!-- canonical: https://hackage.haskell.org/package/faktory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/faktory](https://hackage.haskell.org/package/faktory) |
| Source record ids | hackage_top_downloads-e2e87557b51889 |
...
For a systems engineer, faktory belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0.0 | 2026-07-23T18:54:18Z | [https://hackage.haskell.org/package/faktory](https://hackage.haskell.org/package/faktory) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/faktory` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-e2e87557b51889` from `hackage_top_downloads` as `registry_expansion`
