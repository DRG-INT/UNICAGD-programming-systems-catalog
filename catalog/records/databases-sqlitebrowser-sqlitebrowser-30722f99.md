...
<!-- canonical: https://github.com/sqlitebrowser/sqlitebrowser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sqlitebrowser/sqlitebrowser](https://github.com/sqlitebrowser/sqlitebrowser) |
| Source record ids | github_search_databases-c5351f69459145 |

## System Engineer Summary

Official home of the DB Browser for SQLite (DB4S) project. Previously known as "SQLite Database
Browser" and "Database Browser for SQLite". Website at:

## Operational Role

For a systems engineer, sqlitebrowser/sqlitebrowser belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:04:31Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c5351f69459145` from `github_search_databases` as `registry_expansion`
