...
<!-- canonical: https://github.com/Unity-Technologies/Robotics-Object-Pose-Estimation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Unity-Technologies/Robotics-Object-Pose-Estimation](https://github.com/Unity-Technologies/Robotics-Object-Pose-Estimation) |
| Source record ids | github_search_physics_engines-9986de9618deae |

## System Engineer Summary

A complete end-to-end demonstration in which we collect training data in Unity and use that data to
train a deep neural network to predict the pose of a cube. This model is then deployed in a
simulated robotic pick-and-place task.

## Operational Role

For a systems engineer, Unity-Technologies/Robotics-Object-Pose-Estimation belongs in the Physics
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-13T17:50:31Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-9986de9618deae` from `github_search_physics_engines` as `registry_expansion`
