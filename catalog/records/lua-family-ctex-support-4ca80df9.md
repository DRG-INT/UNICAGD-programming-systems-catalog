...
<!-- canonical: https://luarocks.org/modules/freed-wu/ctex-support -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/ctex-support](https://luarocks.org/modules/freed-wu/ctex-support) |
| Source record ids | luarocks_root_manifest-4305fd6728b799 |

## System Engineer Summary

Tools to build ctex packages

## Operational Role

For a systems engineer, ctex-support belongs in the Lua family inventory as part of build graph
...
- `luarocks_root_manifest-4305fd6728b799` from `luarocks_root_manifest` as `registry_expansion`
