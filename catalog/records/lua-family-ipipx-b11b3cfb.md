...
| Canonical URL | [https://luarocks.org/modules/aveline/ipipx](https://luarocks.org/modules/aveline/ipipx) |
| Source record ids | luarocks_root_manifest-edeeebfaaf91c1 |

## System Engineer Summary

ipipx is tracked as a package manager record in the Lua family branch. The source did not provide a
...
For a systems engineer, ipipx belongs in the Lua family inventory as part of dependency acquisition,
...
- `luarocks_root_manifest-edeeebfaaf91c1` from `luarocks_root_manifest` as `registry_expansion`
