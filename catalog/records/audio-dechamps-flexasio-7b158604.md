...
<!-- canonical: https://github.com/dechamps/FlexASIO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dechamps/FlexASIO](https://github.com/dechamps/FlexASIO) |
| Source record ids | github_search_audio-6c17955df0089f |

## System Engineer Summary

A flexible universal ASIO driver that uses the PortAudio sound I/O library. Supports WASAPI (shared
and exclusive), KS, DirectSound and MME.

## Operational Role

For a systems engineer, dechamps/FlexASIO belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-27T18:48:58Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-6c17955df0089f` from `github_search_audio` as `registry_expansion`
