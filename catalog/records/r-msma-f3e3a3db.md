...
<!-- canonical: https://cran.r-project.org/web/packages/msma/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/msma/index.html](https://cran.r-project.org/web/packages/msma/index.html) |
| Source record ids | cran_packages_by_date-5d41663c768534 |
...
For a systems engineer, msma belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2 | 2026-08-26 08:40:02 UTC | [https://cran.r-project.org/web/packages/msma/DESCRIPTION](https://cran.r-project.org/web/packages/msma/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/msma/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5d41663c768534` from `cran_packages_by_date` as `registry_expansion`
