...
<!-- canonical: https://cran.r-project.org/web/packages/actibase/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/actibase/index.html](https://cran.r-project.org/web/packages/actibase/index.html) |
| Source record ids | cran_packages_by_date-3290819c29d0e9 |
...
For a systems engineer, actibase belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-21 12:41:00 UTC | [https://cran.r-project.org/web/packages/actibase/DESCRIPTION](https://cran.r-project.org/web/packages/actibase/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/actibase/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3290819c29d0e9` from `cran_packages_by_date` as `registry_expansion`
