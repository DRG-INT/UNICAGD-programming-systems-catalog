...
<!-- canonical: https://cran.r-project.org/web/packages/mikropml/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mikropml/index.html](https://cran.r-project.org/web/packages/mikropml/index.html) |
| Source record ids | cran_packages_by_date-a30f59eb670bca |
...
For a systems engineer, mikropml belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-28 17:10:09 UTC | [https://cran.r-project.org/web/packages/mikropml/DESCRIPTION](https://cran.r-project.org/web/packages/mikropml/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mikropml/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a30f59eb670bca` from `cran_packages_by_date` as `registry_expansion`
