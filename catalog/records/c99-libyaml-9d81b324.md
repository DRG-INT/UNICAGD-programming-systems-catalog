...
| Source record ids | corpus-a6cc05e44db55d |

## System Engineer Summary

libyaml is tracked as a serialization record in the C99 branch. The source did not provide a long
...
For a systems engineer, libyaml belongs in the C99 inventory as part of wire formats, persistence,
...
- `corpus-a6cc05e44db55d` from `master_json` as `serialization`
...
| mpack | Serialization | [open](c99-mpack-9bc50dca.md) |
