...
<!-- canonical: https://cran.r-project.org/web/packages/bunsen/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bunsen/index.html](https://cran.r-project.org/web/packages/bunsen/index.html) |
| Source record ids | cran_packages_by_date-14c182e786a8aa |
...
For a systems engineer, bunsen belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-03 14:30:16 UTC | [https://cran.r-project.org/web/packages/bunsen/DESCRIPTION](https://cran.r-project.org/web/packages/bunsen/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bunsen/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-14c182e786a8aa` from `cran_packages_by_date` as `registry_expansion`
