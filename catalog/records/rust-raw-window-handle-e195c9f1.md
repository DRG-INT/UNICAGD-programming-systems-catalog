...
<!-- canonical: https://crates.io/crates/raw-window-handle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/raw-window-handle](https://crates.io/crates/raw-window-handle) |
| Source record ids | crates_io-afd043e9e630a1 |
...
For a systems engineer, raw-window-handle belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2024-05-17T19:41:38.796080Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-afd043e9e630a1` from `crates_io` as `registry_expansion`
