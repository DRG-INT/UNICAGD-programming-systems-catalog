...
<!-- canonical: https://pypi.org/project/ab-testing-analysis/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-testing-analysis/](https://pypi.org/project/ab-testing-analysis/) |
| Source record ids | pypi_simple-b85551e6c201ae |

## System Engineer Summary

AB test analysis toolbox for analyzing and reporting the results of an ab test experiment. It
provides the functions to analyze the ab test result of an experiment.

## Operational Role

For a systems engineer, ab-testing-analysis belongs in the Python inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.8 | 2023-02-25T00:10:59.904107Z | [https://pypi.org/pypi/ab-testing-analysis/json](https://pypi.org/pypi/ab-testing-analysis/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-testing-analysis/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-b85551e6c201ae` from `pypi_simple` as `registry_expansion`
