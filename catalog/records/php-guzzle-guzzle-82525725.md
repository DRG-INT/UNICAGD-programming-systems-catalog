...
| Canonical URL | [https://packagist.org/packages/guzzle/guzzle](https://packagist.org/packages/guzzle/guzzle) |
| Source record ids | packagist_search-26c1074bd9962f |

## System Engineer Summary

PHP HTTP client. This library is deprecated in favor of

## Operational Role

For a systems engineer, guzzle/guzzle belongs in the PHP inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.9.3 | 2015-03-18T18:23:50+00:00 | [https://repo.packagist.org/p2/guzzle/guzzle.json](https://repo.packagist.org/p2/guzzle/guzzle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/guzzle/guzzle.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-26c1074bd9962f` from `packagist_search` as `registry_expansion`
