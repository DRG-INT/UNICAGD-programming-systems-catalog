...
<!-- canonical: https://github.com/obi1kenobi/trustfall -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/obi1kenobi/trustfall](https://github.com/obi1kenobi/trustfall) |
| Source record ids | github_search_webassembly-330e1afc6ffac6 |

## System Engineer Summary

A query engine for any combination of data sources. Query your files and APIs as if they were
databases!

## Operational Role

For a systems engineer, obi1kenobi/trustfall belongs in the WebAssembly inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T04:42:47Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-330e1afc6ffac6` from `github_search_webassembly` as `registry_expansion`
