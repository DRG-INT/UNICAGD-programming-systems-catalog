...
| Canonical URL | [https://luarocks.org/modules/alehandrosv/jade](https://luarocks.org/modules/alehandrosv/jade) |
| Source record ids | luarocks_root_manifest-be978730bf22d0 |

## System Engineer Summary

Jade is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Jade belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-be978730bf22d0` from `luarocks_root_manifest` as `registry_expansion`
