...
<!-- canonical: https://cran.r-project.org/web/packages/SensoryDataSets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SensoryDataSets/index.html](https://cran.r-project.org/web/packages/SensoryDataSets/index.html) |
| Source record ids | cran_packages_by_date-04693ef49cfe38 |

## System Engineer Summary

A Collection of Sensory Evaluation and Consumer Science Datasets

## Operational Role

For a systems engineer, SensoryDataSets belongs in the R inventory as part of device constraints,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-14 15:40:17 UTC | [https://cran.r-project.org/web/packages/SensoryDataSets/DESCRIPTION](https://cran.r-project.org/web/packages/SensoryDataSets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SensoryDataSets/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-04693ef49cfe38` from `cran_packages_by_date` as `registry_expansion`
