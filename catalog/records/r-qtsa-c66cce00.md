...
<!-- canonical: https://cran.r-project.org/web/packages/qtsa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qtsa/index.html](https://cran.r-project.org/web/packages/qtsa/index.html) |
| Source record ids | cran_packages_by_date-98ea7711876105 |
...
For a systems engineer, qtsa belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-06 13:10:09 UTC | [https://cran.r-project.org/web/packages/qtsa/DESCRIPTION](https://cran.r-project.org/web/packages/qtsa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qtsa/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-98ea7711876105` from `cran_packages_by_date` as `registry_expansion`
