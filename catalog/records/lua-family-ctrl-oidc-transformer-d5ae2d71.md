...
<!-- canonical: https://luarocks.org/modules/bakparthasarathy/ctrl-oidc-transformer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bakparthasarathy/ctrl-oidc-transformer](https://luarocks.org/modules/bakparthasarathy/ctrl-oidc-transformer) |
| Source record ids | luarocks_root_manifest-73fd5e875b735c |

## System Engineer Summary

Custom plugin to transform headers sent by oidc plugin

## Operational Role

For a systems engineer, ctrl-oidc-transformer belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-73fd5e875b735c` from `luarocks_root_manifest` as `registry_expansion`
