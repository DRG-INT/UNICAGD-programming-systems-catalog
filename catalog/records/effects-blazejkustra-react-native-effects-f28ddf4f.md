# blazejkustra/react-native-effects
...
<!-- canonical: https://github.com/blazejkustra/react-native-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blazejkustra/react-native-effects](https://github.com/blazejkustra/react-native-effects) |
| Source record ids | github_search_effects-8a2058997f90c3 |

## System Engineer Summary

WebGPU-powered shader effects for React Native. Drop-in components running on a separate thread

## Operational Role

For a systems engineer, blazejkustra/react-native-effects belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:34:12Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8a2058997f90c3` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| junidy/parallel-dsp | Concurrency Parallelism | [open](effects-junidy-parallel-dsp-31b8efad.md) |
