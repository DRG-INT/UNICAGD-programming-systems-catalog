...
<!-- canonical: https://cran.r-project.org/web/packages/gleifr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gleifr/index.html](https://cran.r-project.org/web/packages/gleifr/index.html) |
| Source record ids | cran_packages_by_date-a77c845e9a1445 |

## System Engineer Summary

Client for the 'GLEIF' API

## Operational Role

For a systems engineer, gleifr belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-16 02:20:02 UTC | [https://cran.r-project.org/web/packages/gleifr/DESCRIPTION](https://cran.r-project.org/web/packages/gleifr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gleifr/DESCRIPTION` at `2026-09-16T03:20:38+00:00`.
...
- `cran_packages_by_date-a77c845e9a1445` from `cran_packages_by_date` as `registry_expansion`
