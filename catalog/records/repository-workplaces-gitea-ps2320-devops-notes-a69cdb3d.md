...
<!-- canonical: https://gitea.com/PS2320/Devops_Notes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/PS2320/Devops_Notes](https://gitea.com/PS2320/Devops_Notes) |
| Source record ids | gitea_repositories_api-4e4f56a55e38e0 |
...
For a systems engineer, Gitea: PS2320/Devops_Notes belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T05:17:58Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-4e4f56a55e38e0` from `gitea_repositories_api` as `registry_expansion`
