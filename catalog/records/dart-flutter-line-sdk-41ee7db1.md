...
<!-- canonical: https://pub.dev/packages/flutter_line_sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_line_sdk](https://pub.dev/packages/flutter_line_sdk) |
| Source record ids | pub_dev-ed952d2d6e3f90 |
...
For a systems engineer, flutter_line_sdk belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.2 | 2026-04-07T04:57:12.328651Z | [https://pub.dev/api/packages/flutter_line_sdk](https://pub.dev/api/packages/flutter_line_sdk) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_line_sdk` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-ed952d2d6e3f90` from `pub_dev` as `registry_expansion`
