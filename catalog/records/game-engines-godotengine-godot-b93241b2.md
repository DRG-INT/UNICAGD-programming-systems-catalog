...
<!-- canonical: https://github.com/godotengine/godot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/godotengine/godot](https://github.com/godotengine/godot) |
| Source record ids | github_search_game_engines-7bc283b6ef4cd3 |
...
For a systems engineer, godotengine/godot belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:14:56Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-7bc283b6ef4cd3` from `github_search_game_engines` as `registry_expansion`
