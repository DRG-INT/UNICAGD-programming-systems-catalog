# Gitea: THE-RZ1/Ultimate-RAT-Collection
...
<!-- canonical: https://gitea.com/THE-RZ1/Ultimate-RAT-Collection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/THE-RZ1/Ultimate-RAT-Collection](https://gitea.com/THE-RZ1/Ultimate-RAT-Collection) |
| Source record ids | gitea_repositories_api-ed4e8f14899a84 |

## System Engineer Summary

For educational purposes only, exhaustive samples of 500+ classic/modern trojan builders including
screenshots.

## Operational Role

For a systems engineer, Gitea: THE-RZ1/Ultimate-RAT-Collection belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-12T02:46:52Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ed4e8f14899a84` from `gitea_repositories_api` as `registry_expansion`
