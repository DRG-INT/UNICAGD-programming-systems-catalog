...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SciCatProject/frontend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SciCatProject/frontend](https://github.com/SciCatProject/frontend) |
| Source record ids | github_search_catalogs-ecae6147c0a1cf |
...
For a systems engineer, SciCatProject/frontend belongs in the Catalogs inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T08:03:32Z | gh search repos topic:metadata-catalog stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:metadata-catalog stars:>10", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-ecae6147c0a1cf` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| COMBINE-lab/pufferfish | Ffi Bindings | [open](catalogs-combine-lab-pufferfish-42ddb5f0.md) |
