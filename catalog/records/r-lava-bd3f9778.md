...
<!-- canonical: https://cran.r-project.org/web/packages/lava/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lava/index.html](https://cran.r-project.org/web/packages/lava/index.html) |
| Source record ids | cran_packages_by_date-7c7c03002e3caa |

## System Engineer Summary

lava is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, lava belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.3 | 2026-08-20 09:20:18 UTC | [https://cran.r-project.org/web/packages/lava/DESCRIPTION](https://cran.r-project.org/web/packages/lava/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lava/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7c7c03002e3caa` from `cran_packages_by_date` as `registry_expansion`
