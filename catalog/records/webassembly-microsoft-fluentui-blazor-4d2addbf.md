...
| Source record ids | github_search_webassembly-ce625273aaf7cd |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.14.4 | 2026-07-29T12:10:35Z | [https://api.github.com/repos/microsoft/fluentui-blazor/releases/latest](https://api.github.com/repos/microsoft/fluentui-blazor/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/microsoft/fluentui-blazor/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-ce625273aaf7cd` from `github_search_webassembly` as `registry_expansion`
