...
<!-- canonical: https://www.postgresql.org/docs/current/libpq.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.postgresql.org/docs/current/libpq.html](https://www.postgresql.org/docs/current/libpq.html) |
| Source record ids | curated_database_systems-7aa609c0985934 |
...
For a systems engineer, libpq belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-7aa609c0985934` from `curated_database_systems` as `registry_expansion`
