...
<!-- canonical: https://github.com/golang-standards/project-layout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/golang-standards/project-layout](https://github.com/golang-standards/project-layout) |
| Source record ids | github_search_go-3ed62a0a21cd38 |
...
For a systems engineer, golang-standards/project-layout belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T17:18:05Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-3ed62a0a21cd38` from `github_search_go` as `registry_expansion`
