...
<!-- canonical: https://github.com/verilog-to-routing/vtr-verilog-to-routing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/verilog-to-routing/vtr-verilog-to-routing](https://github.com/verilog-to-routing/vtr-verilog-to-routing) |
| Source record ids | github_search_maps-0c4fb89fd35966 |
...
For a systems engineer, verilog-to-routing/vtr-verilog-to-routing belongs in the Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T17:49:25Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0c4fb89fd35966` from `github_search_maps` as `registry_expansion`
