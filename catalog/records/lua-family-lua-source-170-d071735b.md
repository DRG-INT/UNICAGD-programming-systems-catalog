...
| Source record ids | lua-source-170 |

## System Engineer Summary

lua-source-170 is tracked as an undefined behavior analyzer record in the Lua family branch. The
...
For a systems engineer, lua-source-170 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 170}}` |
...
- `lua-source-170` from `master_json` as `source_list_item`
