...
<!-- canonical: https://github.com/supervc-stack/VectorChord -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/supervc-stack/VectorChord](https://github.com/supervc-stack/VectorChord) |
| Source record ids | github_search_databases-6ce5b0f899c43c |
...
For a systems engineer, supervc-stack/VectorChord belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T06:34:15Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6ce5b0f899c43c` from `github_search_databases` as `registry_expansion`
