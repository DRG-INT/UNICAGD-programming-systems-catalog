# SAP/cloud-metricswatcher

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SAP/cloud-metricswatcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP/cloud-metricswatcher](https://github.com/SAP/cloud-metricswatcher) |
| Source record ids | github_search_sapjava-8890f855b60aed |

## System Engineer Summary

Simple console Java notification application that will watch each metric for a critical state (of an
app running on HCP), will notify you via email or SMS when such metrics are received, and will take
actions to fix the issues caused by such metrics

## Operational Role

For a systems engineer, SAP/cloud-metricswatcher belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T14:12:12Z | gh search repos org:SAP Java | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "org:SAP Java", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_sapjava-8890f855b60aed` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cloud.yaas.service-sdk:service-sdk-logging | Logging Observability | [open](sapjava-com-sap-cloud-yaas-service-sdk-service-sdk-logging-26d96d5e.md) |
| com.sap.cloud.yaas.service-sdk:service-sdk-logging-filters | Logging Observability | [open](sapjava-com-sap-cloud-yaas-service-sdk-service-sdk-logging-filters-cf3a376b.md) |
| logalitech/cap-skills | Logging Observability | [open](sapjava-logalitech-cap-skills-4147e508.md) |
| SAP/cf-java-logging-support | Logging Observability | [open](sapjava-sap-cf-java-logging-support-6f89dbd9.md) |
| sapanablog/Medical-ERP-CAP | Logging Observability | [open](sapjava-sapanablog-medical-erp-cap-2360a888.md) |
| soyuztechnologies/EY_SAP_BTP_NODEJAVA_Nov2022 | Logging Observability | [open](sapjava-soyuztechnologies-ey-sap-btp-nodejava-nov2022-6f1e6957.md) |
