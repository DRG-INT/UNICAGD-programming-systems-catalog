...
<!-- canonical: https://github.com/seaweedfs/seaweedfs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) |
| Source record ids | github_search_databases-9388a2fa43192b |

## System Engineer Summary

SeaweedFS is a distributed storage system for object storage (S3), file systems, and Iceberg tables,
designed to handle billions of files with O(1) disk access and effortless horizontal scaling.

## Operational Role

For a systems engineer, seaweedfs/seaweedfs belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:32:12Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9388a2fa43192b` from `github_search_databases` as `registry_expansion`
