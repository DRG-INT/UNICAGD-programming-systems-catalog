...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vinta/awesome-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vinta/awesome-python](https://github.com/vinta/awesome-python) |
| Source record ids | web-aa6f49e850695f |

## System Engineer Summary

Opinionated guide covering frameworks, libraries, tools, resources, including Code Analysis,
Testing, Debugging, Build Tools and Python Toolchain.

## Operational Role

For a systems engineer, Awesome Python belongs in the Python inventory as part of ecosystem
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other |
...
- `web-aa6f49e850695f` from `master_json` as `community_reference`
