...
<!-- canonical: https://pub.dev/packages/emoji_picker_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/emoji_picker_flutter](https://pub.dev/packages/emoji_picker_flutter) |
| Source record ids | pub_dev-1d206976d0d2e7 |
...
For a systems engineer, emoji_picker_flutter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.4 | 2026-09-01T16:59:48.535803Z | [https://pub.dev/api/packages/emoji_picker_flutter](https://pub.dev/api/packages/emoji_picker_flutter) |  |
| preview | known | 4.0.0-dev.2 | 2024-11-14T20:50:30.119970Z | [https://pub.dev/api/packages/emoji_picker_flutter](https://pub.dev/api/packages/emoji_picker_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/emoji_picker_flutter` at `2026-09-01T18:22:25+00:00`.
...
- `pub_dev-1d206976d0d2e7` from `pub_dev` as `registry_expansion`
