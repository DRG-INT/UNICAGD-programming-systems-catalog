...
<!-- canonical: https://cran.r-project.org/web/packages/swelex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/swelex/index.html](https://cran.r-project.org/web/packages/swelex/index.html) |
| Source record ids | cran_packages_by_date-475db6ce8bce0e |

## System Engineer Summary

Access the Swedish Code of Statutes via Riksdagen's Open Data

## Operational Role

For a systems engineer, swelex belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 17:10:02 UTC | [https://cran.r-project.org/web/packages/swelex/DESCRIPTION](https://cran.r-project.org/web/packages/swelex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/swelex/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-475db6ce8bce0e` from `cran_packages_by_date` as `registry_expansion`
