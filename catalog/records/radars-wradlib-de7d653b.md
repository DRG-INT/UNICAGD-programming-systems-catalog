...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-9de556c7c1a853 |

## System Engineer Summary

Weather radar data processing library for georeferencing, attenuation correction, compositing, and
hydrology.

## Operational Role

For a systems engineer, wradlib belongs in the Radars inventory as part of ecosystem capability
...
- `curated_language_routes-9de556c7c1a853` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ISCE2 | Math Numeric Scientific | [open](radars-isce2-8d35c44e.md) |
| Py-ART | Math Numeric Scientific | [open](radars-py-art-13759bce.md) |
| sarpy | Math Numeric Scientific | [open](radars-sarpy-801d29c0.md) |
