...
<!-- canonical: https://crates.io/crates/phf_generator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/phf_generator](https://crates.io/crates/phf_generator) |
| Source record ids | crates_io-723c5551bd6eee |

## System Engineer Summary

phf_generator is tracked as a logging observability record in the Rust branch. The source did not
...
For a systems engineer, phf_generator belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-06-21T00:37:27.827587Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-723c5551bd6eee` from `crates_io` as `registry_expansion`
