...
<!-- canonical: https://pub.dev/packages/pro_video_editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pro_video_editor](https://pub.dev/packages/pro_video_editor) |
| Source record ids | pub_dev-9be56af1ed2ef3 |
...
For a systems engineer, pro_video_editor belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.3 | 2026-08-15T14:07:31.352906Z | [https://pub.dev/api/packages/pro_video_editor](https://pub.dev/api/packages/pro_video_editor) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pro_video_editor` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-9be56af1ed2ef3` from `pub_dev` as `registry_expansion`
