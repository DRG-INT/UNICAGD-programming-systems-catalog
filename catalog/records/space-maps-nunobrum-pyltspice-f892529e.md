...
<!-- canonical: https://github.com/nunobrum/PyLTSpice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nunobrum/PyLTSpice](https://github.com/nunobrum/PyLTSpice) |
| Source record ids | github_search_space_maps-a5da363b1e88fb |
...
For a systems engineer, nunobrum/PyLTSpice belongs in the Space Maps inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-20T15:13:48Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a5da363b1e88fb` from `github_search_space_maps` as `registry_expansion`
