...
<!-- canonical: https://cran.r-project.org/web/packages/ipeaplot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ipeaplot/index.html](https://cran.r-project.org/web/packages/ipeaplot/index.html) |
| Source record ids | cran_packages_by_date-2e1fd862b43ff9 |
...
For a systems engineer, ipeaplot belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-31 17:00:22 UTC | [https://cran.r-project.org/web/packages/ipeaplot/DESCRIPTION](https://cran.r-project.org/web/packages/ipeaplot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ipeaplot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2e1fd862b43ff9` from `cran_packages_by_date` as `registry_expansion`
