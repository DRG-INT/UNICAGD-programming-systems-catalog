...
<!-- canonical: https://cran.r-project.org/web/packages/fcl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fcl/index.html](https://cran.r-project.org/web/packages/fcl/index.html) |
| Source record ids | cran_packages_by_date-2e88e66edcf888 |

## System Engineer Summary

fcl is tracked as a precommit ci quality record in the R branch. The source did not provide a long
...
For a systems engineer, fcl belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-22 19:30:02 UTC | [https://cran.r-project.org/web/packages/fcl/DESCRIPTION](https://cran.r-project.org/web/packages/fcl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fcl/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2e88e66edcf888` from `cran_packages_by_date` as `registry_expansion`
