...
<!-- canonical: https://github.com/Viglino/ol-ext -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Viglino/ol-ext](https://github.com/Viglino/ol-ext) |
| Source record ids | github_search_maps-10aff03976fd80 |

## System Engineer Summary

Cool extensions for Openlayers (ol) - animated clusters, CSS popup, Font Awesome symbol renderer,
charts for statistical map (pie/bar), layer switcher, wikipedia layer, animations, canvas filters.

## Operational Role

For a systems engineer, Viglino/ol-ext belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-08T01:30:43Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-10aff03976fd80` from `github_search_maps` as `registry_expansion`
