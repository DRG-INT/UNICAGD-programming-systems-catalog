...
<!-- canonical: https://cran.r-project.org/web/packages/readNSx/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/readNSx/index.html](https://cran.r-project.org/web/packages/readNSx/index.html) |
| Source record ids | cran_packages_by_date-8fa9f996a36cd2 |
...
For a systems engineer, readNSx belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-02 05:20:19 UTC | [https://cran.r-project.org/web/packages/readNSx/DESCRIPTION](https://cran.r-project.org/web/packages/readNSx/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/readNSx/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-8fa9f996a36cd2` from `cran_packages_by_date` as `registry_expansion`
