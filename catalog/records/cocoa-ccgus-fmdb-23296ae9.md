...
<!-- canonical: https://github.com/ccgus/fmdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ccgus/fmdb](https://github.com/ccgus/fmdb) |
| Source record ids | github_search_cocoa-9345359624f402 |
...
For a systems engineer, ccgus/fmdb belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-15T21:06:50Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-9345359624f402` from `github_search_cocoa` as `registry_expansion`
