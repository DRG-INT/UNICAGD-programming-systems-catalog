...
<!-- canonical: https://github.com/NullTale/VhsFx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NullTale/VhsFx](https://github.com/NullTale/VhsFx) |
| Source record ids | github_search_effects-2687985d0d3db0 |

## System Engineer Summary

⬜ Vhs post effect for Unity Urp

## Operational Role

For a systems engineer, NullTale/VhsFx belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-20T19:19:55Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2687985d0d3db0` from `github_search_effects` as `registry_expansion`
