...
<!-- canonical: https://pypi.org/project/adalab-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adalab-cli/](https://pypi.org/project/adalab-cli/) |
| Source record ids | pypi_simple-b8fcfca1f20ea6 |

## System Engineer Summary

The CLI app to interact with the Adamatics Platform.

## Operational Role

For a systems engineer, adalab-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.1 | 2026-08-24T07:52:03.017606Z | [https://pypi.org/pypi/adalab-cli/json](https://pypi.org/pypi/adalab-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adalab-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-b8fcfca1f20ea6` from `pypi_simple` as `registry_expansion`
