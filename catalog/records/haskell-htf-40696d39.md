...
<!-- canonical: https://hackage.haskell.org/package/HTF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HTF](https://hackage.haskell.org/package/HTF) |
| Source record ids | hackage_top_downloads-be56937e5ef921 |
...
For a systems engineer, HTF belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0.2 | 2024-05-03T04:09:35Z | [https://hackage.haskell.org/package/HTF](https://hackage.haskell.org/package/HTF) |  |
| candidate | partial | 0.15.0.1 |  | [https://hackage.haskell.org/package/HTF](https://hackage.haskell.org/package/HTF) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HTF` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-be56937e5ef921` from `hackage_top_downloads` as `registry_expansion`
