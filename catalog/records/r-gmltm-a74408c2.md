...
<!-- canonical: https://cran.r-project.org/web/packages/GMLTM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GMLTM/index.html](https://cran.r-project.org/web/packages/GMLTM/index.html) |
| Source record ids | cran_packages_by_date-973c171ded95b8 |
...
For a systems engineer, GMLTM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-27 12:10:08 UTC | [https://cran.r-project.org/web/packages/GMLTM/DESCRIPTION](https://cran.r-project.org/web/packages/GMLTM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GMLTM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-973c171ded95b8` from `cran_packages_by_date` as `registry_expansion`
