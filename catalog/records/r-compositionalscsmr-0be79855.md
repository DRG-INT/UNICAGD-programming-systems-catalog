...
<!-- canonical: https://cran.r-project.org/web/packages/Compositionalscsmr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Compositionalscsmr/index.html](https://cran.r-project.org/web/packages/Compositionalscsmr/index.html) |
| Source record ids | cran_packages_by_date-3329644027b927 |
...
For a systems engineer, Compositionalscsmr belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-09-12 12:50:07 UTC | [https://cran.r-project.org/web/packages/Compositionalscsmr/DESCRIPTION](https://cran.r-project.org/web/packages/Compositionalscsmr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Compositionalscsmr/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-3329644027b927` from `cran_packages_by_date` as `registry_expansion`
