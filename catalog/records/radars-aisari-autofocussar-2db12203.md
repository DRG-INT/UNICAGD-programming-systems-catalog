...
<!-- canonical: https://github.com/aisari/AutofocusSAR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aisari/AutofocusSAR](https://github.com/aisari/AutofocusSAR) |
| Source record ids | github_search_radars-7418cc40a32823 |
...
For a systems engineer, aisari/AutofocusSAR belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-22T14:49:09Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-7418cc40a32823` from `github_search_radars` as `registry_expansion`
