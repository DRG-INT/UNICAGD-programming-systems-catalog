...
<!-- canonical: https://github.com/jefmenegazzo/mpu-i2c-drivers-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jefmenegazzo/mpu-i2c-drivers-python](https://github.com/jefmenegazzo/mpu-i2c-drivers-python) |
| Source record ids | github_search_electromagnetoscopes-b294940a1a91f7 |
...
For a systems engineer, jefmenegazzo/mpu-i2c-drivers-python belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-27T14:09:38Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b294940a1a91f7` from `github_search_electromagnetoscopes` as `registry_expansion`
