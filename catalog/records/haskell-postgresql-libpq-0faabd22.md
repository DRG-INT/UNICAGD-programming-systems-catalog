...
<!-- canonical: https://hackage.haskell.org/package/postgresql-libpq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/postgresql-libpq](https://hackage.haskell.org/package/postgresql-libpq) |
| Source record ids | hackage_top_downloads-eb506d5a98b8a1 |
...
For a systems engineer, postgresql-libpq belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0.0 | 2024-08-24T16:19:23Z | [https://hackage.haskell.org/package/postgresql-libpq](https://hackage.haskell.org/package/postgresql-libpq) |  |
| candidate | partial | 0.9.4.1 |  | [https://hackage.haskell.org/package/postgresql-libpq](https://hackage.haskell.org/package/postgresql-libpq) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/postgresql-libpq` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-eb506d5a98b8a1` from `hackage_top_downloads` as `registry_expansion`
