...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/peer-calls/peer-calls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peer-calls/peer-calls](https://github.com/peer-calls/peer-calls) |
| Source record ids | github_search_video-ac845471e8d1f7 |
...
For a systems engineer, peer-calls/peer-calls belongs in the Video inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-28T22:46:52Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ac845471e8d1f7` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| etro-js/etro | Type Checker | [open](video-etro-js-etro-fc650c8f.md) |
| Vanilagy/mediabunny | Type Checker | [open](video-vanilagy-mediabunny-f2242c0c.md) |
