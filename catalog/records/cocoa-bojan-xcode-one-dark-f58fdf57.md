...
<!-- canonical: https://github.com/bojan/xcode-one-dark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bojan/xcode-one-dark](https://github.com/bojan/xcode-one-dark) |
| Source record ids | github_search_cocoa-76e25cbe56c0ac |
...
For a systems engineer, bojan/xcode-one-dark belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-04-02T13:49:11Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-76e25cbe56c0ac` from `github_search_cocoa` as `registry_expansion`
