...
<!-- canonical: https://github.com/NirDiamant/RAG_Techniques -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NirDiamant/RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques) |
| Source record ids | github_search_aims-a8f7171f340ae1 |

## System Engineer Summary

This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG)
systems. Each technique has a detailed notebook tutorial.

## Operational Role

For a systems engineer, NirDiamant/RAG_Techniques belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T08:59:28Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-a8f7171f340ae1` from `github_search_aims` as `registry_expansion`
...
| ollama/ollama | Filesystem Os | [open](aim-s-ollama-ollama-8b858f45.md) |
