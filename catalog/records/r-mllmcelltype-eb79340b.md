...
<!-- canonical: https://cran.r-project.org/web/packages/mLLMCelltype/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mLLMCelltype/index.html](https://cran.r-project.org/web/packages/mLLMCelltype/index.html) |
| Source record ids | cran_packages_by_date-8e8631e0350790 |
...
For a systems engineer, mLLMCelltype belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.8 | 2026-09-01 11:40:02 UTC | [https://cran.r-project.org/web/packages/mLLMCelltype/DESCRIPTION](https://cran.r-project.org/web/packages/mLLMCelltype/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mLLMCelltype/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-8e8631e0350790` from `cran_packages_by_date` as `registry_expansion`
