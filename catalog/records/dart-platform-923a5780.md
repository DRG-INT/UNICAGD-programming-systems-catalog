...
<!-- canonical: https://pub.dev/packages/platform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/platform](https://pub.dev/packages/platform) |
| Source record ids | pub_dev-c32540a38b625c |
...
For a systems engineer, platform belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.6 | 2024-10-17T11:43:56.147795Z | [https://pub.dev/api/packages/platform](https://pub.dev/api/packages/platform) |  |
| preview | known | 3.0.0-nullsafety.4 | 2020-11-04T18:29:51.816242Z | [https://pub.dev/api/packages/platform](https://pub.dev/api/packages/platform) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/platform` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-c32540a38b625c` from `pub_dev` as `registry_expansion`
