...
<!-- canonical: https://azure.microsoft.com/products/cosmos-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://azure.microsoft.com/products/cosmos-db](https://azure.microsoft.com/products/cosmos-db) |
| Source record ids | curated_database_systems-ad99fb92cf6522 |

## System Engineer Summary

Globally distributed multi-model managed database service.

## Operational Role

For a systems engineer, Cosmos DB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-ad99fb92cf6522` from `curated_database_systems` as `registry_expansion`
