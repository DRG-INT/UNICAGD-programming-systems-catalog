...
<!-- canonical: https://crates.io/crates/windows-implement -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-implement](https://crates.io/crates/windows-implement) |
| Source record ids | crates_io-e541066d742c6c |
...
For a systems engineer, windows-implement belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:38:25.707732Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-03T17:18:46+00:00`.
...
- `crates_io-e541066d742c6c` from `crates_io` as `registry_expansion`
