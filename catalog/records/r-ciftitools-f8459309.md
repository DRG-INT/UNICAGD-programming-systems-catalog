...
<!-- canonical: https://cran.r-project.org/web/packages/ciftiTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ciftiTools/index.html](https://cran.r-project.org/web/packages/ciftiTools/index.html) |
| Source record ids | cran_packages_by_date-b3da89332617e6 |
...
For a systems engineer, ciftiTools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.21.1 | 2026-09-09 13:30:02 UTC | [https://cran.r-project.org/web/packages/ciftiTools/DESCRIPTION](https://cran.r-project.org/web/packages/ciftiTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ciftiTools/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-b3da89332617e6` from `cran_packages_by_date` as `registry_expansion`
