...
<!-- canonical: https://github.com/chathumal93/Pytorch-UNet-Flood-Segmentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chathumal93/Pytorch-UNet-Flood-Segmentation](https://github.com/chathumal93/Pytorch-UNet-Flood-Segmentation) |
| Source record ids | github_search_radars-e1c20cd151c150 |

## System Engineer Summary

This repository contains a PyTorch implementation of a U-Net model for segmenting water areas (flood
and permananet water) in Sentinel-1 satellite images.

## Operational Role

For a systems engineer, chathumal93/Pytorch-UNet-Flood-Segmentation belongs in the Radars inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-21T08:59:12Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e1c20cd151c150` from `github_search_radars` as `registry_expansion`
