...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/devtools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/devtools](https://gnu-octave.github.io/packages/devtools) |
| Source record ids | octave_packages_index-f04a06e6982440 |

## System Engineer Summary

Developer Tooling and Model Context Protocol Servers for GNU Octave.

## Operational Role

For a systems engineer, devtools belongs in the Octave inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-29 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-f04a06e6982440` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jupyter-notebook | Web Framework | [open](octave-jupyter-notebook-702c1516.md) |
