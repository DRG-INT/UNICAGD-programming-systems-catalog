...
| Source record ids | corpus-f21817d8abfd2c |

## System Engineer Summary

lwIP is tracked as an embedded hardware record in the C99 branch. The source did not provide a long
...
For a systems engineer, lwIP belongs in the C99 inventory as part of device constraints, cross-
...
- `corpus-f21817d8abfd2c` from `master_json` as `embedded_hardware`
