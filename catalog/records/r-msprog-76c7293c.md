...
<!-- canonical: https://cran.r-project.org/web/packages/msprog/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/msprog/index.html](https://cran.r-project.org/web/packages/msprog/index.html) |
| Source record ids | cran_packages_by_date-28bf322d5aa426 |
...
For a systems engineer, msprog belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-04 15:40:02 UTC | [https://cran.r-project.org/web/packages/msprog/DESCRIPTION](https://cran.r-project.org/web/packages/msprog/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/msprog/DESCRIPTION` at `2026-09-04T16:20:41+00:00`.
...
- `cran_packages_by_date-28bf322d5aa426` from `cran_packages_by_date` as `registry_expansion`
