...
| Canonical URL | [https://crates.io/crates/gix-attributes](https://crates.io/crates/gix-attributes) |
| Source record ids | crates_io-94b812456582b6 |
...
For a systems engineer, gix-attributes belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.35.0 | 2026-08-22T19:01:42.866803Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-94b812456582b6` from `crates_io` as `registry_expansion`
