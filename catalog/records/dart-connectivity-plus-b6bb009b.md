...
<!-- canonical: https://pub.dev/packages/connectivity_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/connectivity_plus](https://pub.dev/packages/connectivity_plus) |
| Source record ids | pub_dev-0ab66e78244cc4 |

## System Engineer Summary

Flutter plugin for discovering the state of the network (WiFi & mobile/cellular) connectivity on
Android and iOS.

## Operational Role

For a systems engineer, connectivity_plus belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.1 | 2026-07-23T21:33:03.771147Z | [https://pub.dev/api/packages/connectivity_plus](https://pub.dev/api/packages/connectivity_plus) |  |
| preview | known | 0.9.0-nullsafety.0 | 2021-02-22T20:39:27.027574Z | [https://pub.dev/api/packages/connectivity_plus](https://pub.dev/api/packages/connectivity_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/connectivity_plus` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-0ab66e78244cc4` from `pub_dev` as `registry_expansion`
