...
<!-- canonical: https://cran.r-project.org/web/packages/resevol/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/resevol/index.html](https://cran.r-project.org/web/packages/resevol/index.html) |
| Source record ids | cran_packages_by_date-fdf6fcbbe7242e |
...
For a systems engineer, resevol belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.1 | 2026-08-25 21:40:02 UTC | [https://cran.r-project.org/web/packages/resevol/DESCRIPTION](https://cran.r-project.org/web/packages/resevol/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/resevol/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fdf6fcbbe7242e` from `cran_packages_by_date` as `registry_expansion`
