...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/needle-tools/compilation-visualizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/needle-tools/compilation-visualizer](https://github.com/needle-tools/compilation-visualizer) |
| Source record ids | github_search_assembly-1082f7a815891c |

## System Engineer Summary

Unity Tool showing a timeline of assembly compilation. This is especially helpful when trying to
optimize compile times and dependencies between assemblies. Besides showing a graphical view of
compilation, selecting an assembly shows both dependencies and dependents of that assembly.

## Operational Role

For a systems engineer, needle-tools/compilation-visualizer belongs in the Assembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-17T16:51:27Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-1082f7a815891c` from `github_search_assembly` as `registry_expansion`
