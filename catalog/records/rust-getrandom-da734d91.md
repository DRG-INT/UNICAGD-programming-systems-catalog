...
<!-- canonical: https://crates.io/crates/getrandom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/getrandom](https://crates.io/crates/getrandom) |
| Source record ids | crates_io-1dba9010d9ac35 |
...
For a systems engineer, getrandom belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2026-06-17T18:01:59.979552Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-1dba9010d9ac35` from `crates_io` as `registry_expansion`
