...
<!-- canonical: https://github.com/pedrodiamel/colorchecker-detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pedrodiamel/colorchecker-detection](https://github.com/pedrodiamel/colorchecker-detection) |
| Source record ids | github_search_photography-29f979ab07b60f |

## System Engineer Summary

Multiple ColorChecker Detection. This code implements a multiple colorChecker detection method, as
described in the paper Fast and Robust Multiple ColorChecker Detection.

## Operational Role

For a systems engineer, pedrodiamel/colorchecker-detection belongs in the Photography inventory as
...
- `github_search_photography-29f979ab07b60f` from `github_search_photography` as `registry_expansion`
