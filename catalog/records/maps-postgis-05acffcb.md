...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/maps.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/postgis/postgis](https://github.com/postgis/postgis) |
| Source record ids | curated_language_routes-b8c0c7f715b534 |

## System Engineer Summary

Spatial database extension for PostgreSQL with geometry, geography, indexes, and geospatial SQL
operations.

## Operational Role

For a systems engineer, PostGIS belongs in the Maps inventory as part of state persistence,
...
- `curated_language_routes-b8c0c7f715b534` from `curated_language_routes` as `registry_expansion`
