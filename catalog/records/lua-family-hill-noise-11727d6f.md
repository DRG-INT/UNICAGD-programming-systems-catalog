...
| Canonical URL | [https://luarocks.org/modules/spill/hill_noise](https://luarocks.org/modules/spill/hill_noise) |
| Source record ids | luarocks_root_manifest-d502ee882bc04b |

## System Engineer Summary

hill_noise is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, hill_noise belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d502ee882bc04b` from `luarocks_root_manifest` as `registry_expansion`
