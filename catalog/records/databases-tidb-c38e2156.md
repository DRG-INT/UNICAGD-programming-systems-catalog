...
<!-- canonical: https://github.com/pingcap/tidb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pingcap/tidb](https://github.com/pingcap/tidb) |
| Source record ids | curated_database_systems-1eda16acfa57e1 |

## System Engineer Summary

Distributed SQL database with MySQL compatibility and HTAP design.

## Operational Role

For a systems engineer, TiDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-1eda16acfa57e1` from `curated_database_systems` as `registry_expansion`
