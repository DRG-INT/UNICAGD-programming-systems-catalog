...
<!-- canonical: https://github.com/ClaudeMarais/FindEachOtherCompass_ESP32-C3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ClaudeMarais/FindEachOtherCompass_ESP32-C3](https://github.com/ClaudeMarais/FindEachOtherCompass_ESP32-C3) |
| Source record ids | github_search_electromagnetoscopes-1e337094e3ca94 |

## System Engineer Summary

An Arduino project to create a compass that not only points North, but also points to another
person. This is very useful for outdoor teams sports like Airsoft.

## Operational Role

For a systems engineer, ClaudeMarais/FindEachOtherCompass_ESP32-C3 belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-12T05:56:29Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-1e337094e3ca94` from `github_search_electromagnetoscopes` as `registry_expansion`
