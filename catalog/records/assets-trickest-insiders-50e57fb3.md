...
<!-- canonical: https://github.com/trickest/insiders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/trickest/insiders](https://github.com/trickest/insiders) |
| Source record ids | github_search_assets-5649621b0c5261 |
...
For a systems engineer, trickest/insiders belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-25T15:20:03Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-5649621b0c5261` from `github_search_assets` as `registry_expansion`
