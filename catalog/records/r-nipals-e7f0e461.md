...
<!-- canonical: https://cran.r-project.org/web/packages/nipals/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nipals/index.html](https://cran.r-project.org/web/packages/nipals/index.html) |
| Source record ids | cran_packages_by_date-9947c023701609 |
...
For a systems engineer, nipals belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-09-09 05:20:18 UTC | [https://cran.r-project.org/web/packages/nipals/DESCRIPTION](https://cran.r-project.org/web/packages/nipals/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nipals/DESCRIPTION` at `2026-09-09T06:26:10+00:00`.
...
- `cran_packages_by_date-9947c023701609` from `cran_packages_by_date` as `registry_expansion`
