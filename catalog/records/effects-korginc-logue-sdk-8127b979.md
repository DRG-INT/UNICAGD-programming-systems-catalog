...
| Source record ids | github_search_effects-0bbccb7fb2c352 |
...
For a systems engineer, korginc/logue-sdk belongs in the Effects inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:59:28Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0bbccb7fb2c352` from `github_search_effects` as `registry_expansion`
