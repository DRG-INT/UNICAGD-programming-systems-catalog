...
| Canonical URL | [https://luarocks.org/modules/neorocks/iswap.nvim](https://luarocks.org/modules/neorocks/iswap.nvim) |
| Source record ids | luarocks_root_manifest-b33a012eddf0e4 |

## System Engineer Summary

Interactively select and swap function arguments, list elements, and much more. Powered by tree-
sitter.

## Operational Role

For a systems engineer, iswap.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b33a012eddf0e4` from `luarocks_root_manifest` as `registry_expansion`
