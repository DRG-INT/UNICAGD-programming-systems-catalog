...
| Source type | ffi_bindings |
| Verification | unverified_seed |
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/P/PythonCall](https://github.com/JuliaRegistries/General/tree/master/P/PythonCall) |
| Source record ids | corpus-9f92391e06d894 |

## System Engineer Summary

PythonCall.jl is tracked as a ffi bindings record in the Julia branch. The source did not provide a
...
For a systems engineer, PythonCall.jl belongs in the Julia inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.9.35 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/P/PythonCall/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/P/PythonCall/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-9f92391e06d894` from `master_json` as `ffi_bindings`
...
| AffineScaler | Ffi Bindings | [open](julia-affinescaler-f582a668.md) |
