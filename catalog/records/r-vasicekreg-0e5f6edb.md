...
<!-- canonical: https://cran.r-project.org/web/packages/vasicekreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vasicekreg/index.html](https://cran.r-project.org/web/packages/vasicekreg/index.html) |
| Source record ids | cran_packages_by_date-a5bd64376b43ac |
...
For a systems engineer, vasicekreg belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-20 06:50:02 UTC | [https://cran.r-project.org/web/packages/vasicekreg/DESCRIPTION](https://cran.r-project.org/web/packages/vasicekreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vasicekreg/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a5bd64376b43ac` from `cran_packages_by_date` as `registry_expansion`
