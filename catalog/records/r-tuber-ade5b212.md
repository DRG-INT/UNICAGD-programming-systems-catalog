...
<!-- canonical: https://cran.r-project.org/web/packages/tuber/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tuber/index.html](https://cran.r-project.org/web/packages/tuber/index.html) |
| Source record ids | cran_packages_by_date-e77fc7da05d2aa |
...
For a systems engineer, tuber belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-20 11:20:02 UTC | [https://cran.r-project.org/web/packages/tuber/DESCRIPTION](https://cran.r-project.org/web/packages/tuber/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tuber/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e77fc7da05d2aa` from `cran_packages_by_date` as `registry_expansion`
