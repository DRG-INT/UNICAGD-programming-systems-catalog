...
<!-- canonical: https://packagist.org/packages/pushery/webhooks-for-laravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pushery/webhooks-for-laravel](https://packagist.org/packages/pushery/webhooks-for-laravel) |
| Source record ids | packagist_search-b73d1af49cf5ed |

## System Engineer Summary

An all-in-one, config-gated webhooks toolkit for Laravel: send signed outbound webhooks (Standard
Webhooks signatures by default, Ed25519 optional), receive and verify inbound ones, let customers
self-serve their endpoints, and observe every delivery on a dashboard — switch on only the layers
you need.

## Operational Role

For a systems engineer, pushery/webhooks-for-laravel belongs in the PHP inventory as part of
...
- `packagist_search-b73d1af49cf5ed` from `packagist_search` as `registry_expansion`
