# bexter989/nerdfont-patcher

## Navigation

[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bexter989/nerdfont-patcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bexter989/nerdfont-patcher](https://github.com/bexter989/nerdfont-patcher) |
| Source record ids | github_search_font_briefcase-360484742402c9 |

## System Engineer Summary

A python script that patches fonts with glyphs from the guys at www.nerdfonts.com. It also has
multiprocessing support to speed up patching.

## Operational Role

For a systems engineer, bexter989/nerdfont-patcher belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-09T17:19:58Z | gh search repos topic:fontforge stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-360484742402c9` from `github_search_font_briefcase` as `registry_expansion`
