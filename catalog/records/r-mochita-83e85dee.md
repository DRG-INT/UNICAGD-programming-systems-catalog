...
<!-- canonical: https://cran.r-project.org/web/packages/mochita/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mochita/index.html](https://cran.r-project.org/web/packages/mochita/index.html) |
| Source record ids | cran_packages_by_date-a25feb70c67f58 |

## System Engineer Summary

mochita is tracked as a testing framework record in the R branch. The source did not provide a long
...
For a systems engineer, mochita belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-06 13:40:02 UTC | [https://cran.r-project.org/web/packages/mochita/DESCRIPTION](https://cran.r-project.org/web/packages/mochita/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mochita/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a25feb70c67f58` from `cran_packages_by_date` as `registry_expansion`
