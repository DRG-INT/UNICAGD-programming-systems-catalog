# NythicalNorm/VoxelSpaceProgram

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NythicalNorm/VoxelSpaceProgram -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NythicalNorm/VoxelSpaceProgram](https://github.com/NythicalNorm/VoxelSpaceProgram) |
| Source record ids | github_search_space_engines-0e1f3d507de192 |

## System Engineer Summary

A Minecraft space mod with realistic orbital mechanics in a truly big solar system.

## Operational Role

For a systems engineer, NythicalNorm/VoxelSpaceProgram belongs in the Space Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-04T15:41:41Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-0e1f3d507de192` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| qsantos/spyce | Language Server | [open](space-engines-qsantos-spyce-36ab5cb0.md) |
