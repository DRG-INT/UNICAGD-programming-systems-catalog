...
<!-- canonical: https://github.com/gudbrandtandberg/CPSC540Project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gudbrandtandberg/CPSC540Project](https://github.com/gudbrandtandberg/CPSC540Project) |
| Source record ids | github_search_matlab-56bd0bec242a42 |
...
For a systems engineer, gudbrandtandberg/CPSC540Project belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-04-22T04:57:10Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-56bd0bec242a42` from `github_search_matlab` as `registry_expansion`
