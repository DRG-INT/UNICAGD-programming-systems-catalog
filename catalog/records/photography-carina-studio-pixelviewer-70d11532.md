...
| Canonical URL | [https://github.com/carina-studio/PixelViewer](https://github.com/carina-studio/PixelViewer) |
| Source record ids | github_search_photography-b0c8beb1f827fe |

## System Engineer Summary

A cross-platform image viewer which supports reading raw Luminance/YUV/RGB/ARGB/Bayer pixels data
from file and rendering it.

## Operational Role

For a systems engineer, carina-studio/PixelViewer belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.0.1 | 2026-05-30T02:38:05Z | [https://api.github.com/repos/carina-studio/PixelViewer/releases/latest](https://api.github.com/repos/carina-studio/PixelViewer/releases/latest) |  |
| preview | known | 2026.1.0 | 2026-08-29T02:10:47Z | [https://api.github.com/repos/carina-studio/PixelViewer/releases?per_page=10](https://api.github.com/repos/carina-studio/PixelViewer/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/carina-studio/PixelViewer/releases/latest` at `2026-09-01T09:23:29+00:00`.
...
- `github_search_photography-b0c8beb1f827fe` from `github_search_photography` as `registry_expansion`
...
| Bitpainter75/FerrumPix | Filesystem Os | [open](photography-bitpainter75-ferrumpix-cd4d3242.md) |
| carlospuenteg/File-Injector | Filesystem Os | [open](photography-carlospuenteg-file-injector-2533177f.md) |
| carlospuenteg/Photomosaic-Creator | Filesystem Os | [open](photography-carlospuenteg-photomosaic-creator-b57e7ad4.md) |
