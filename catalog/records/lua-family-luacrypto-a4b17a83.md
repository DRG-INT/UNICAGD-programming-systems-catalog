...
<!-- canonical: https://github.com/mkottman/luacrypto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mkottman/luacrypto](https://github.com/mkottman/luacrypto) |
| Source record ids | lua-source-283 |
...
For a systems engineer, LuaCrypto belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 283}}` |
...
- `lua-source-283` from `master_json` as `source_list_item`
