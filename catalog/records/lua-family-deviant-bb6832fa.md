...
<!-- canonical: https://luarocks.org/modules/epicfile/deviant -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/epicfile/deviant](https://luarocks.org/modules/epicfile/deviant) |
| Source record ids | luarocks_root_manifest-b8b14ac8af12ee |

## System Engineer Summary

A set of small useful functions extending lua's standard library

## Operational Role

For a systems engineer, deviant belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b8b14ac8af12ee` from `luarocks_root_manifest` as `registry_expansion`
