...
| Canonical URL | [https://luarocks.org/modules/rtsisyk/fun](https://luarocks.org/modules/rtsisyk/fun) |
| Source record ids | luarocks_root_manifest-8829997c77d7f3 |
...
For a systems engineer, fun belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-8829997c77d7f3` from `luarocks_root_manifest` as `registry_expansion`
