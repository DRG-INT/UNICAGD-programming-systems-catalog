...
<!-- canonical: https://github.com/Pagghiu/SaneCppLibraries -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Pagghiu/SaneCppLibraries](https://github.com/Pagghiu/SaneCppLibraries) |
| Source record ids | awesome_list-b797f96be48b1a |

## System Engineer Summary

a set of C++ platform abstraction libraries for macOS, Windows and Linux. MIT

## Operational Role

For a systems engineer, SaneCppLibraries belongs in the C++23 inventory as part of ecosystem
...
- `awesome_list-b797f96be48b1a` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Siv3D | Undefined Behavior Analyzer | [open](c-23-siv3d-e1193351.md) |
