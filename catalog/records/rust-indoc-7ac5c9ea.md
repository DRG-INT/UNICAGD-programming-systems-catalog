...
<!-- canonical: https://crates.io/crates/indoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/indoc](https://crates.io/crates/indoc) |
| Source record ids | crates_io-164ddfa892878e |
...
For a systems engineer, indoc belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.7 | 2025-10-21T18:19:56.335839Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-164ddfa892878e` from `crates_io` as `registry_expansion`
