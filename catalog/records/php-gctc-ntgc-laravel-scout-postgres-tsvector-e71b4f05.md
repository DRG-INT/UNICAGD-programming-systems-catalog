...
| Canonical URL | [https://packagist.org/packages/gctc-ntgc/laravel-scout-postgres-tsvector](https://packagist.org/packages/gctc-ntgc/laravel-scout-postgres-tsvector) |
| Source record ids | packagist_search-47868dc6b2e304 |
...
For a systems engineer, gctc-ntgc/laravel-scout-postgres-tsvector belongs in the PHP inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.1 | 2026-05-13T18:04:18+00:00 | [https://repo.packagist.org/p2/gctc-ntgc/laravel-scout-postgres-tsvector.json](https://repo.packagist.org/p2/gctc-ntgc/laravel-scout-postgres-tsvector.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/gctc-ntgc/laravel-scout-postgres-tsvector.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-47868dc6b2e304` from `packagist_search` as `registry_expansion`
