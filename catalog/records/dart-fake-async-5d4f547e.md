...
<!-- canonical: https://pub.dev/packages/fake_async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fake_async](https://pub.dev/packages/fake_async) |
| Source record ids | pub_dev-a0cecf76f930fc |
...
For a systems engineer, fake_async belongs in the Dart inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3 | 2025-01-28T15:18:30.551930Z | [https://pub.dev/api/packages/fake_async](https://pub.dev/api/packages/fake_async) |  |
| preview | known | 1.2.0-nullsafety.3 | 2020-11-03T22:41:44.349884Z | [https://pub.dev/api/packages/fake_async](https://pub.dev/api/packages/fake_async) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fake_async` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-a0cecf76f930fc` from `pub_dev` as `registry_expansion`
