...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Coverage](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/coverage.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-bb64b5930917af |

## System Engineer Summary

tarpaulin is tracked as a coverage record in the Rust branch. The source did not provide a long
...
For a systems engineer, tarpaulin belongs in the Rust inventory as part of ecosystem capability
...
- `corpus-bb64b5930917af` from `master_json` as `coverage`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| cargo-llvm-cov | Coverage | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-llvm-cov-0b81fb2e.md) |
