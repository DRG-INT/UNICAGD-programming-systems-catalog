...
<!-- canonical: https://github.com/mem0ai/mem0 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mem0ai/mem0](https://github.com/mem0ai/mem0) |
| Source record ids | github_search_aims-5334143451ecb8 |

## System Engineer Summary

The Memory Layer for AI Agents - Drop-in memory infrastructure for AI agents and apps. Context that
persists. Built for production.

## Operational Role

For a systems engineer, mem0ai/mem0 belongs in the "aim's" inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T17:30:53Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-5334143451ecb8` from `github_search_aims` as `registry_expansion`
