...
<!-- canonical: https://github.com/hexops/mach -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hexops/mach](https://github.com/hexops/mach) |
| Source record ids | github_search_game_engines-d658657dd4c179 |

## System Engineer Summary

zig game engine & graphics toolkit - mirror of

## Operational Role

For a systems engineer, hexops/mach belongs in the Game Engines inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-23T01:41:18Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-d658657dd4c179` from `github_search_game_engines` as `registry_expansion`
