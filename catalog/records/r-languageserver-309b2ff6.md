...
<!-- canonical: https://cran.r-project.org/web/packages/languageserver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/languageserver/index.html](https://cran.r-project.org/web/packages/languageserver/index.html) |
| Source record ids | cran_packages_by_date-fe5302ac2d8c7f |
...
For a systems engineer, languageserver belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.19 | 2026-09-13 04:10:02 UTC | [https://cran.r-project.org/web/packages/languageserver/DESCRIPTION](https://cran.r-project.org/web/packages/languageserver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/languageserver/DESCRIPTION` at `2026-09-13T04:19:54+00:00`.
...
- `cran_packages_by_date-fe5302ac2d8c7f` from `cran_packages_by_date` as `registry_expansion`
