...
<!-- canonical: https://www.libreoffice.org/discover/base/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.libreoffice.org/discover/base/](https://www.libreoffice.org/discover/base/) |
| Source record ids | curated_database_systems-3051a6c93b1d2a |

## System Engineer Summary

Desktop database front end and table/form/report manager.

## Operational Role

For a systems engineer, LibreOffice Base belongs in the Databases inventory as part of state
...
- `curated_database_systems-3051a6c93b1d2a` from `curated_database_systems` as `registry_expansion`
