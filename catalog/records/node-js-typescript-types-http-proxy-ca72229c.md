...
<!-- canonical: https://www.npmjs.com/package/@types/http-proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@types/http-proxy](https://www.npmjs.com/package/@types/http-proxy) |
| Source record ids | npm_registry-381fdfbd55facc |
...
For a systems engineer, @types/http-proxy belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.17.17 | 2025-10-24T04:14:49.643Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-381fdfbd55facc` from `npm_registry` as `registry_expansion`
