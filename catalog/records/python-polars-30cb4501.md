...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Data Science](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/data-science.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | data_science |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-281489f2fdcd |

## System Engineer Summary

Polars is tracked as a data science record in the Python branch. The source did not provide a long
...
For a systems engineer, Polars belongs in the Python inventory as part of ecosystem capability
...
- Treat category as `data_science` unless a later verified source gives a better classification.
...
- `master-281489f2fdcd` from `master_json` as `data_science`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Dask | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-dask-ba82071e.md) |
| Ibis | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-ibis-2e1b840f.md) |
| Modin | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-modin-114100c6.md) |
| pandas | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pandas-9831121d.md) |
| PyArrow | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pyarrow-3e27e907.md) |
