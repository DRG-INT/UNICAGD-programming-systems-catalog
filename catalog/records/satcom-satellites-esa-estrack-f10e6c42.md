...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: SatCom Satellites](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/satcom-satellites.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.esa.int/Enabling_Support/Operations/ESA_Ground_Stations](https://www.esa.int/Enabling_Support/Operations/ESA_Ground_Stations) |
| Source record ids | curated_language_routes-642c5a617ea8fe |

## System Engineer Summary

ESA ground-station network route for mission communications and tracking support.

## Operational Role

For a systems engineer, ESA Estrack belongs in the SatCom Satellites inventory as part of operator
...
- `curated_language_routes-642c5a617ea8fe` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| NASA TDRS | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/satcom-satellites-nasa-tdrs-e2a57392.md) |
