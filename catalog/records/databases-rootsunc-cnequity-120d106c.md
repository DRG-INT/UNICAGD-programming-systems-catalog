...
<!-- canonical: https://github.com/rootSunc/CNEquity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rootSunc/CNEquity](https://github.com/rootSunc/CNEquity) |
| Source record ids | github_search_databases-08bf603bdf2fc2 |
...
For a systems engineer, rootSunc/CNEquity belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T21:32:54Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-08bf603bdf2fc2` from `github_search_databases` as `registry_expansion`
