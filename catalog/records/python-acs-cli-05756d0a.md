...
<!-- canonical: https://pypi.org/project/acs-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acs-cli/](https://pypi.org/project/acs-cli/) |
| Source record ids | pypi_simple-dc1eb7b7462a1c |
...
For a systems engineer, acs-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.9 | 2017-04-27T12:48:01.608782Z | [https://pypi.org/pypi/acs-cli/json](https://pypi.org/pypi/acs-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acs-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-dc1eb7b7462a1c` from `pypi_simple` as `registry_expansion`
