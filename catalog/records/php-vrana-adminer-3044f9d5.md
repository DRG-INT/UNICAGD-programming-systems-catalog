...
<!-- canonical: https://packagist.org/packages/vrana/adminer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/vrana/adminer](https://packagist.org/packages/vrana/adminer) |
| Source record ids | packagist_search-02eb0264945334 |
...
For a systems engineer, vrana/adminer belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-02eb0264945334` from `packagist_search` as `registry_expansion`
