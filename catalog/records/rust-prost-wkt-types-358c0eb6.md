...
| Canonical URL | [https://crates.io/crates/prost-wkt-types](https://crates.io/crates/prost-wkt-types) |
| Source record ids | crates_io-6cf7178574caff |
...
For a systems engineer, prost-wkt-types belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2026-08-23T16:35:47.009991Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-6cf7178574caff` from `crates_io` as `registry_expansion`
