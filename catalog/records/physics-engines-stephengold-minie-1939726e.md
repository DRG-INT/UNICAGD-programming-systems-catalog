...
<!-- canonical: https://github.com/stephengold/Minie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stephengold/Minie](https://github.com/stephengold/Minie) |
| Source record ids | github_search_physics_engines-e0c517adca5cf4 |
...
For a systems engineer, stephengold/Minie belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T16:04:34Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e0c517adca5cf4` from `github_search_physics_engines` as `registry_expansion`
