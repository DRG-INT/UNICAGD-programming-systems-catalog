...
<!-- canonical: https://cran.r-project.org/web/packages/ibdsim2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ibdsim2/index.html](https://cran.r-project.org/web/packages/ibdsim2/index.html) |
| Source record ids | cran_packages_by_date-8e32724166a775 |
...
For a systems engineer, ibdsim2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.3 | 2026-08-04 20:00:10 UTC | [https://cran.r-project.org/web/packages/ibdsim2/DESCRIPTION](https://cran.r-project.org/web/packages/ibdsim2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ibdsim2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8e32724166a775` from `cran_packages_by_date` as `registry_expansion`
