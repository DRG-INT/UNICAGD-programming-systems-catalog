...
<!-- canonical: https://cran.r-project.org/web/packages/biomes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/biomes/index.html](https://cran.r-project.org/web/packages/biomes/index.html) |
| Source record ids | cran_packages_by_date-178119bcfd2d08 |
...
For a systems engineer, biomes belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.4 | 2026-08-31 13:40:02 UTC | [https://cran.r-project.org/web/packages/biomes/DESCRIPTION](https://cran.r-project.org/web/packages/biomes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/biomes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-178119bcfd2d08` from `cran_packages_by_date` as `registry_expansion`
