...
<!-- canonical: https://crates.io/crates/sqlx-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlx-macros](https://crates.io/crates/sqlx-macros) |
| Source record ids | crates_io-678e59d776982a |
...
For a systems engineer, sqlx-macros belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-05-21T17:35:10.879458Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-678e59d776982a` from `crates_io` as `registry_expansion`
