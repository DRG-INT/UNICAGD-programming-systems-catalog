...
<!-- canonical: https://cran.r-project.org/web/packages/kDGLM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kDGLM/index.html](https://cran.r-project.org/web/packages/kDGLM/index.html) |
| Source record ids | cran_packages_by_date-f8e8d22c1008b4 |
...
For a systems engineer, kDGLM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.15 | 2026-08-29 12:10:29 UTC | [https://cran.r-project.org/web/packages/kDGLM/DESCRIPTION](https://cran.r-project.org/web/packages/kDGLM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kDGLM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f8e8d22c1008b4` from `cran_packages_by_date` as `registry_expansion`
