...
<!-- canonical: https://cran.r-project.org/web/packages/RSP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RSP/index.html](https://cran.r-project.org/web/packages/RSP/index.html) |
| Source record ids | cran_packages_by_date-ceeaeffeab6515 |
...
For a systems engineer, RSP belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-07 21:20:02 UTC | [https://cran.r-project.org/web/packages/RSP/DESCRIPTION](https://cran.r-project.org/web/packages/RSP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RSP/DESCRIPTION` at `2026-09-07T22:19:06+00:00`.
...
- `cran_packages_by_date-ceeaeffeab6515` from `cran_packages_by_date` as `registry_expansion`
