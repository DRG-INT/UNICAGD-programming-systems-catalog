...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Shuttles](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-shuttles.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.nasa.gov/space-shuttle/](https://www.nasa.gov/space-shuttle/) |
| Source record ids | curated_language_routes-89067f0a958ff0 |

## System Engineer Summary

NASA Space Shuttle route for program history, orbiters, missions, systems, and operational
references.

## Operational Role

For a systems engineer, NASA Space Shuttle Overview belongs in the Space Shuttles inventory as part
...
- `curated_language_routes-89067f0a958ff0` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Shuttle Mission Simulator Records | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-shuttles-shuttle-mission-simulator-records-442c81ad.md) |
| Space Shuttle Technical Conference | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-shuttles-space-shuttle-technical-conference-c6fb700e.md) |
