...
| Canonical URL | [https://luarocks.org/modules/olivine-labs/jwt](https://luarocks.org/modules/olivine-labs/jwt) |
| Source record ids | luarocks_root_manifest-609aece2dbc4e2 |
...
For a systems engineer, jwt belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-609aece2dbc4e2` from `luarocks_root_manifest` as `registry_expansion`
