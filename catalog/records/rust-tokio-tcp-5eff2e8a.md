...
<!-- canonical: https://crates.io/crates/tokio-tcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-tcp](https://crates.io/crates/tokio-tcp) |
| Source record ids | crates_io-5ffd3a84ccb1ff |

## System Engineer Summary

tokio-tcp is tracked as a ffi bindings record in the Rust branch. The source did not provide a long
...
For a systems engineer, tokio-tcp belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2020-02-05T00:22:14.110010Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
