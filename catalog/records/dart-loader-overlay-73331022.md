...
<!-- canonical: https://pub.dev/packages/loader_overlay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/loader_overlay](https://pub.dev/packages/loader_overlay) |
| Source record ids | pub_dev-48b6e88474184b |

## System Engineer Summary

A simple package to simplify screen management. When loading any async task, this package prevent
the user from interacting with the screen until the async task finishes.

## Operational Role

For a systems engineer, loader_overlay belongs in the Dart inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2024-12-23T14:25:10.865260Z | [https://pub.dev/api/packages/loader_overlay](https://pub.dev/api/packages/loader_overlay) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-03-02T11:18:18.899719Z | [https://pub.dev/api/packages/loader_overlay](https://pub.dev/api/packages/loader_overlay) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/loader_overlay` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-48b6e88474184b` from `pub_dev` as `registry_expansion`
