...
<!-- canonical: https://cran.r-project.org/web/packages/rbm25/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rbm25/index.html](https://cran.r-project.org/web/packages/rbm25/index.html) |
| Source record ids | cran_packages_by_date-045a6a56c2b67a |
...
For a systems engineer, rbm25 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-08-21 17:30:10 UTC | [https://cran.r-project.org/web/packages/rbm25/DESCRIPTION](https://cran.r-project.org/web/packages/rbm25/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rbm25/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-045a6a56c2b67a` from `cran_packages_by_date` as `registry_expansion`
