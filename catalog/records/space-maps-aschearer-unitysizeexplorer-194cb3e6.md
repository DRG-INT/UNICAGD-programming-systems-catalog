...
<!-- canonical: https://github.com/aschearer/unitysizeexplorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aschearer/unitysizeexplorer](https://github.com/aschearer/unitysizeexplorer) |
| Source record ids | github_search_space_maps-5c32be19f270cc |

## System Engineer Summary

Visualize how much space each asset in your Unity game takes and quickly optimize your game's file
size

## Operational Role

For a systems engineer, aschearer/unitysizeexplorer belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-06-18T06:08:43Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5c32be19f270cc` from `github_search_space_maps` as `registry_expansion`
