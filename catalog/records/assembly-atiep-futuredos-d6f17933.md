...
<!-- canonical: https://github.com/AtieP/FutureDOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AtieP/FutureDOS](https://github.com/AtieP/FutureDOS) |
| Source record ids | github_search_assembly-12dc626a46a80a |

## System Engineer Summary

AtieP/FutureDOS is tracked as a filesystem os record in the Assembly branch. The source did not
...
For a systems engineer, AtieP/FutureDOS belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-09T16:07:35Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-12dc626a46a80a` from `github_search_assembly` as `registry_expansion`
