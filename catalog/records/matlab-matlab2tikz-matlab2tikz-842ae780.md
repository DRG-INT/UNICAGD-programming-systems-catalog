...
| Canonical URL | [https://github.com/matlab2tikz/matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) |
| Source record ids | github_search_matlab-e4181486417669 |

## System Engineer Summary

This program converts MATLAB®/Octave figures to TikZ/pgfplots figures for smooth integration into
LaTeX.

## Operational Role

For a systems engineer, matlab2tikz/matlab2tikz belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.0 | 2016-10-20T20:30:54Z | [https://api.github.com/repos/matlab2tikz/matlab2tikz/releases/latest](https://api.github.com/repos/matlab2tikz/matlab2tikz/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/matlab2tikz/matlab2tikz/releases/latest` at `2026-09-01T07:24:11+00:00`.
...
- `github_search_matlab-e4181486417669` from `github_search_matlab` as `registry_expansion`
