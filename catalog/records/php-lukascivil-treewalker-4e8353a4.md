...
<!-- canonical: https://packagist.org/packages/lukascivil/treewalker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/lukascivil/treewalker](https://packagist.org/packages/lukascivil/treewalker) |
| Source record ids | packagist_search-100dc51ba72593 |

## System Engineer Summary

TreeWalker is a simple and small Library that will help you to work faster with manipulation of
structures in PHP

## Operational Role

For a systems engineer, lukascivil/treewalker belongs in the PHP inventory as part of language
...
- `packagist_search-100dc51ba72593` from `packagist_search` as `registry_expansion`
