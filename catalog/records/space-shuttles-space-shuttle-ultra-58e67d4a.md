...
[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/GLS-SSV/SSV](https://github.com/GLS-SSV/SSV) |
| Source record ids | curated_language_routes-bb8a6243201add |

## System Engineer Summary

Open-source Space Shuttle Vessel addon project for Orbiter-style simulation workflows.

## Operational Role

For a systems engineer, Space Shuttle Ultra belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.16 | 2026-05-05T12:00:01Z | [https://api.github.com/repos/GLS-SSV/SSV/releases/latest](https://api.github.com/repos/GLS-SSV/SSV/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GLS-SSV/SSV/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `curated_language_routes-bb8a6243201add` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| flyingkaktus/go-to-orbit-android-simulator | Game Engine Game Dev | [open](space-shuttles-flyingkaktus-go-to-orbit-android-simulator-c28864e3.md) |
| Orbiter Space Flight Simulator | Game Engine Game Dev | [open](space-shuttles-orbiter-space-flight-simulator-b884bd36.md) |
