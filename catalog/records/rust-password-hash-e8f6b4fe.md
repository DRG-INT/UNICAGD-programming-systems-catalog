...
<!-- canonical: https://crates.io/crates/password-hash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/password-hash](https://crates.io/crates/password-hash) |
| Source record ids | crates_io-92cd7df880c9d9 |

## System Engineer Summary

Traits which describe the functionality of password hashing algorithms, with optional support for a
`no_std`/`no_alloc`-friendly implementation of the PHC string format, as well as generic support for
other formats (e.g. Modular Crypt Format)

## Operational Role

For a systems engineer, password-hash belongs in the Rust inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-04-08T01:00:26.839021Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-92cd7df880c9d9` from `crates_io` as `registry_expansion`
