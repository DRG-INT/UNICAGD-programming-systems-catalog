...
<!-- canonical: https://hackage.haskell.org/package/ats-pkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ats-pkg](https://hackage.haskell.org/package/ats-pkg) |
| Source record ids | hackage_top_downloads-39d00a8c43e202 |

## System Engineer Summary

Hackage package with 313 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, ats-pkg belongs in the Haskell inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.0.3 | 2022-10-03T19:54:59Z | [https://hackage.haskell.org/package/ats-pkg](https://hackage.haskell.org/package/ats-pkg) |  |
| candidate | partial | 0.3.0.0 |  | [https://hackage.haskell.org/package/ats-pkg](https://hackage.haskell.org/package/ats-pkg) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ats-pkg` at `2026-09-01T07:23:59+00:00`.
...
- `hackage_top_downloads-39d00a8c43e202` from `hackage_top_downloads` as `registry_expansion`
