...
<!-- canonical: https://github.com/OpenGeoscience/geojs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenGeoscience/geojs](https://github.com/OpenGeoscience/geojs) |
| Source record ids | github_search_maps-8376cba12ee410 |

## System Engineer Summary

High-performance visualization and interactive data exploration of scientific and geospatial
location aware datasets

## Operational Role

For a systems engineer, OpenGeoscience/geojs belongs in the Maps inventory as part of ecosystem
...
- `github_search_maps-8376cba12ee410` from `github_search_maps` as `registry_expansion`
