...
<!-- canonical: https://pub.dev/packages/material_ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/material_ui](https://pub.dev/packages/material_ui) |
| Source record ids | pub_dev-1fd270508cfc78 |
...
For a systems engineer, material_ui belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-24T16:11:46.867041Z | [https://pub.dev/api/packages/material_ui](https://pub.dev/api/packages/material_ui) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/material_ui` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-1fd270508cfc78` from `pub_dev` as `registry_expansion`
