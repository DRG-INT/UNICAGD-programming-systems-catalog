...
<!-- canonical: https://github.com/pathintegral-institute/mcpm.sh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pathintegral-institute/mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh) |
| Source record ids | github_search_maps-fb5fc199dffecf |

## System Engineer Summary

CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP
servers. Advanced Router & Profile features.

## Operational Role

For a systems engineer, pathintegral-institute/mcpm.sh belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T16:02:39Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-fb5fc199dffecf` from `github_search_maps` as `registry_expansion`
