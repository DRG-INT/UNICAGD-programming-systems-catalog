...
<!-- canonical: https://crates.io/crates/protobuf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/protobuf](https://crates.io/crates/protobuf) |
| Source record ids | crates_io-dd1a82151b6744 |
...
For a systems engineer, protobuf belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.2 | 2026-08-31T23:11:11.188263Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-dd1a82151b6744` from `crates_io` as `registry_expansion`
