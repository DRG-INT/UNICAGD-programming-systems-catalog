...
<!-- canonical: https://github.com/spacetelescope/poppy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spacetelescope/poppy](https://github.com/spacetelescope/poppy) |
| Source record ids | github_search_space_maps-71e1385dbd7127 |
...
For a systems engineer, spacetelescope/poppy belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T14:23:04Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-71e1385dbd7127` from `github_search_space_maps` as `registry_expansion`
