...
<!-- canonical: https://github.com/HamzaGhazouani/HGRippleRadarView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HamzaGhazouani/HGRippleRadarView](https://github.com/HamzaGhazouani/HGRippleRadarView) |
| Source record ids | github_search_radars-9ea5bf628afd26 |

## System Engineer Summary

A beautiful radar view to show nearby items (users, restaurants, ...) with ripple animation, fully
customizable

## Operational Role

For a systems engineer, HamzaGhazouani/HGRippleRadarView belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-13T20:27:29Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9ea5bf628afd26` from `github_search_radars` as `registry_expansion`
