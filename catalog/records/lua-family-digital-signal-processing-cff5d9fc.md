...
| Source record ids | lua-source-28 |

## System Engineer Summary

Digital Signal Processing is tracked as an image audio dsp record in the Lua family branch. The
...
For a systems engineer, Digital Signal Processing belongs in the Lua family inventory as part of
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 28}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-28` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Image Manipulation | Image Audio Dsp | [open](lua-family-image-manipulation-ed1c6dcf.md) |
