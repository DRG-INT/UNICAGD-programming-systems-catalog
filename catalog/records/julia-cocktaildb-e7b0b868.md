...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CocktailDB](https://github.com/JuliaRegistries/General/tree/master/C/CocktailDB) |
| Source record ids | julia_general-4027f5ce9e367f |

## System Engineer Summary

Julia package registered in General at C/CocktailDB.

## Operational Role

For a systems engineer, CocktailDB belongs in the Julia inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CocktailDB", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-4027f5ce9e367f` from `julia_general` as `registry_expansion`
