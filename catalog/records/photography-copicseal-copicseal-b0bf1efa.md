...
| Canonical URL | [https://github.com/copicseal/copicseal](https://github.com/copicseal/copicseal) |
| Source record ids | github_search_photography-47fb3f2e19e465 |

## System Engineer Summary

Copicseal is an EXIF-based photo watermarking tool for adding camera settings like shutter speed and
ISO. Copicseal（可图匠）是一款基于 EXIF 的图片边框水印工具。

## Operational Role

For a systems engineer, copicseal/copicseal belongs in the Photography inventory as part of
...
- `github_search_photography-47fb3f2e19e465` from `github_search_photography` as `registry_expansion`
