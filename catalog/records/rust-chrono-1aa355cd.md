...
| Canonical URL | [https://crates.io/crates/chrono](https://crates.io/crates/chrono) |
| Source record ids | corpus-d759249dbf09e4 |
...
For a systems engineer, chrono belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.45 | 2026-06-04T12:16:42.063037Z | [https://crates.io/api/v1/crates/chrono](https://crates.io/api/v1/crates/chrono) |  |
| preview | known | 0.4.20-rc.1 | 2022-07-26T12:51:12.347496Z | [https://crates.io/api/v1/crates/chrono](https://crates.io/api/v1/crates/chrono) |  |

## Engineering Notes

- Treat category as `utility_library` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/chrono` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-d759249dbf09e4` from `master_json` as `utility_library`
