...
| Canonical URL | [https://spdx.org/licenses/](https://spdx.org/licenses/) |
| Source record ids | curated_language_routes-8222adf5864bc2 |

## System Engineer Summary

Machine-readable license catalog used for package metadata, SBOMs, compliance automation, and
dependency review.

## Operational Role

For a systems engineer, SPDX License List belongs in the Catalogs inventory as part of ecosystem
...
- `curated_language_routes-8222adf5864bc2` from `curated_language_routes` as `registry_expansion`
...
| Libraries.io | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-libraries-io-57dc438b.md) |
