...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/oist/Usiigaci -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oist/Usiigaci](https://github.com/oist/Usiigaci) |
| Source record ids | github_search_microscopy-429309bd197651 |

## System Engineer Summary

Usiigaci: stain-free cell tracking in phase contrast microscopy enabled by supervised machine
learning

## Operational Role

For a systems engineer, oist/Usiigaci belongs in the Microscopy inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-15T17:30:34Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-429309bd197651` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CSET-Toolbox/CSET | Parser Lexer Ast | [open](microscopy-cset-toolbox-cset-197b64ee.md) |
| jr0th/segmentation | Parser Lexer Ast | [open](microscopy-jr0th-segmentation-867d4596.md) |
| lens-biophotonics/ZetaStitcher | Parser Lexer Ast | [open](microscopy-lens-biophotonics-zetastitcher-daabfc39.md) |
| MicroscPSF/MicroscPSF-Matlab | Parser Lexer Ast | [open](microscopy-microscpsf-microscpsf-matlab-1b6bef75.md) |
| MicroscPSF/MicroscPSF-Py | Parser Lexer Ast | [open](microscopy-microscpsf-microscpsf-py-b4f704fa.md) |
