...
<!-- canonical: https://crates.io/crates/zerovec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zerovec](https://crates.io/crates/zerovec) |
| Source record ids | crates_io-839441beb8d524 |
...
For a systems engineer, zerovec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.8 | 2026-08-19T22:32:16.933982Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-839441beb8d524` from `crates_io` as `registry_expansion`
