...
<!-- canonical: https://github.com/hmans/composer-suite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hmans/composer-suite](https://github.com/hmans/composer-suite) |
| Source record ids | github_search_effects-8d4e5a77e04fc2 |

## System Engineer Summary

A suite of libraries for making game development with Three.js and React not only awesome, but so
good, it would feel wrong to use anything else.

## Operational Role

For a systems engineer, hmans/composer-suite belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-27T15:45:58Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8d4e5a77e04fc2` from `github_search_effects` as `registry_expansion`
