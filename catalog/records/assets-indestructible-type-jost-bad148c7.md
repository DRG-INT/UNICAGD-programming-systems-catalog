...
<!-- canonical: https://github.com/indestructible-type/Jost -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/indestructible-type/Jost](https://github.com/indestructible-type/Jost) |
| Source record ids | github_search_assets-41fb331a60de0f |
...
For a systems engineer, indestructible-type/Jost belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-12T13:50:38Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-41fb331a60de0f` from `github_search_assets` as `registry_expansion`
