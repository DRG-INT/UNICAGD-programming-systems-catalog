...
<!-- canonical: https://luarocks.org/modules/cultab/command.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cultab/command.nvim](https://luarocks.org/modules/cultab/command.nvim) |
| Source record ids | luarocks_root_manifest-816e5958dd2e39 |
...
For a systems engineer, command.nvim belongs in the Lua family inventory as part of dependency
...
- `luarocks_root_manifest-816e5958dd2e39` from `luarocks_root_manifest` as `registry_expansion`
