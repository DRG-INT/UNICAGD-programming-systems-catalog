...
<!-- canonical: https://cran.r-project.org/web/packages/smqf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smqf/index.html](https://cran.r-project.org/web/packages/smqf/index.html) |
| Source record ids | cran_packages_by_date-2ad3022f831017 |
...
For a systems engineer, smqf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-8 | 2026-08-30 14:10:02 UTC | [https://cran.r-project.org/web/packages/smqf/DESCRIPTION](https://cran.r-project.org/web/packages/smqf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smqf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2ad3022f831017` from `cran_packages_by_date` as `registry_expansion`
