...
<!-- canonical: https://cran.r-project.org/web/packages/SporeLag/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SporeLag/index.html](https://cran.r-project.org/web/packages/SporeLag/index.html) |
| Source record ids | cran_packages_by_date-b4d521975460ce |
...
For a systems engineer, SporeLag belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-04 09:30:02 UTC | [https://cran.r-project.org/web/packages/SporeLag/DESCRIPTION](https://cran.r-project.org/web/packages/SporeLag/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SporeLag/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b4d521975460ce` from `cran_packages_by_date` as `registry_expansion`
