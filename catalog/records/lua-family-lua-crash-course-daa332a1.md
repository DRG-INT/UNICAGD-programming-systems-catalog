...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [http://www.coppeliarobotics.com/helpFiles/en/luaCrashCourse.htm](http://www.coppeliarobotics.com/helpFiles/en/luaCrashCourse.htm) |
| Source record ids | lua-source-388 |
...
For a systems engineer, Lua Crash Course belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 388}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-388` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| airtable-lua | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-airtable-lua-98c0d840.md) |
| allonet | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-allonet-8d52568c.md) |
| amqp | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amqp-ff04986d.md) |
| amqp-client | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amqp-client-aabf77f4.md) |
| amqp-client-rpc | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amqp-client-rpc-17c56254.md) |
| Amulet | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amulet-939f295b.md) |
| anim8 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-anim8-41df89bb.md) |
| api7-lua-resty-dns-client | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-dns-client-f9e4221d.md) |
