# sree26365-dev/sap-abap-hana-learning
...
<!-- canonical: https://github.com/sree26365-dev/sap-abap-hana-learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sree26365-dev/sap-abap-hana-learning](https://github.com/sree26365-dev/sap-abap-hana-learning) |
| Source record ids | github_search_sapjava-82f6eb44d36536 |

## System Engineer Summary

SAP ABAP Development for HANA — self-study project covering CDS Views, AMDP, OData, BAdI, RAP/EML,
Native vs Non-Native architecture. Built by a Java + REST API developer transitioning to SAP.

## Operational Role

For a systems engineer, sree26365-dev/sap-abap-hana-learning belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-20T08:10:18Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-82f6eb44d36536` from `github_search_sapjava` as `registry_expansion`
