...
<!-- canonical: https://github.com/CharlieTap/chasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CharlieTap/chasm](https://github.com/CharlieTap/chasm) |
| Source record ids | github_search_webassembly-4155f1530e5842 |
...
For a systems engineer, CharlieTap/chasm belongs in the WebAssembly inventory as part of runtime
...
- `github_search_webassembly-4155f1530e5842` from `github_search_webassembly` as `registry_expansion`
...
| faasm/faasm | Interpreter Runtime | [open](webassembly-faasm-faasm-25e74d15.md) |
