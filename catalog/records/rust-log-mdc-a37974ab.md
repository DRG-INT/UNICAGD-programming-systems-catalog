...
| Canonical URL | [https://crates.io/crates/log-mdc](https://crates.io/crates/log-mdc) |
| Source record ids | crates_io-6b12848953d4bd |
...
For a systems engineer, log-mdc belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2016-10-04T03:41:00.944965Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| proc-macro2-diagnostics | Compiler Diagnostics | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-proc-macro2-diagnostics-5295e6a0.md) |
