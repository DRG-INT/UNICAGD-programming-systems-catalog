...
| Canonical URL | [https://packagist.org/packages/adhocore/jwt](https://packagist.org/packages/adhocore/jwt) |
| Source record ids | packagist_search-054f71d4eb2eec |
...
For a systems engineer, adhocore/jwt belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.4 | 2026-05-30T08:00:33+00:00 | [https://repo.packagist.org/p2/adhocore/jwt.json](https://repo.packagist.org/p2/adhocore/jwt.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/adhocore/jwt.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-054f71d4eb2eec` from `packagist_search` as `registry_expansion`
