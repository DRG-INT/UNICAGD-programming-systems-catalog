...
<!-- canonical: https://github.com/redpanda-data/redpanda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/redpanda-data/redpanda](https://github.com/redpanda-data/redpanda) |
| Source record ids | github_search_video-ed42510b6afd06 |

## System Engineer Summary

Redpanda is a streaming data platform for developers. Kafka API compatible. 10x faster. No
ZooKeeper. No JVM!

## Operational Role

For a systems engineer, redpanda-data/redpanda belongs in the Video inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T00:45:06Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ed42510b6afd06` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| v-modal/vmodal_sdk_android | Interpreter Runtime | [open](video-v-modal-vmodal-sdk-android-a967102c.md) |
