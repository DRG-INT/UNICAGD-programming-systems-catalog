...
<!-- canonical: https://cran.r-project.org/web/packages/SLGP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SLGP/index.html](https://cran.r-project.org/web/packages/SLGP/index.html) |
| Source record ids | cran_packages_by_date-dce945157d33c8 |
...
For a systems engineer, SLGP belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 23:40:02 UTC | [https://cran.r-project.org/web/packages/SLGP/DESCRIPTION](https://cran.r-project.org/web/packages/SLGP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SLGP/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dce945157d33c8` from `cran_packages_by_date` as `registry_expansion`
