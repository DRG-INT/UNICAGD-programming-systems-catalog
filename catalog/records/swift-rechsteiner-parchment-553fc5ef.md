...
<!-- canonical: https://github.com/rechsteiner/Parchment -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rechsteiner/Parchment](https://github.com/rechsteiner/Parchment) |
| Source record ids | github_search_swift-583a9ac30465bf |
...
For a systems engineer, rechsteiner/Parchment belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-29T15:40:59Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-583a9ac30465bf` from `github_search_swift` as `registry_expansion`
