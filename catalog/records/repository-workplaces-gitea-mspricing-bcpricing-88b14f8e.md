...
<!-- canonical: https://gitea.com/mspricing/bcpricing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/mspricing/bcpricing](https://gitea.com/mspricing/bcpricing) |
| Source record ids | gitea_repositories_api-ca1825eda2102f |
...
For a systems engineer, Gitea: mspricing/bcpricing belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-04T07:23:18Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ca1825eda2102f` from `gitea_repositories_api` as `registry_expansion`
