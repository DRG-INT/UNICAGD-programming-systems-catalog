...
| Canonical URL | [https://github.com/PESchoenberg/DGIIIAI](https://github.com/PESchoenberg/DGIIIAI) |
| Source record ids | github_search_space_shuttles-300fdf5d9d603f |

## System Engineer Summary

Semi-autonomous variant of the stock Orbiter Space Flight Simulator Delta Glider III equipped with
its own SQL expert-system-based AI.

## Operational Role

For a systems engineer, PESchoenberg/DGIIIAI belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2020-07-31T16:31:50Z | [https://api.github.com/repos/PESchoenberg/DGIIIAI/releases/latest](https://api.github.com/repos/PESchoenberg/DGIIIAI/releases/latest) |  |
| preview | known | v0.0.3 | 2020-04-11T15:59:05Z | [https://api.github.com/repos/PESchoenberg/DGIIIAI/releases?per_page=10](https://api.github.com/repos/PESchoenberg/DGIIIAI/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PESchoenberg/DGIIIAI/releases/latest` at `2026-09-01T07:24:23+00:00`.
...
- `github_search_space_shuttles-300fdf5d9d603f` from `github_search_space_shuttles` as `registry_expansion`
...
| Eleman07/Astra-Space-Simulator | Ide Editor Integration | [open](space-shuttles-eleman07-astra-space-simulator-8c5f9d1c.md) |
