...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/CodelyTV/typescript-ddd-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodelyTV/typescript-ddd-example](https://github.com/CodelyTV/typescript-ddd-example) |
| Source record ids | github_search_pattern_language-2bfc4728333d31 |

## System Engineer Summary

🔷🎯 TypeScript DDD Example: Complete project applying Hexagonal Architecture and Domain-Driven Design
patterns

## Operational Role

For a systems engineer, CodelyTV/typescript-ddd-example belongs in the Pattern language inventory as
part of interface contracts, migration safety, editor feedback, and large-codebase maintainability.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-20T07:07:47Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-2bfc4728333d31` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| node-ts/bus | Type Checker | [open](pattern-language-node-ts-bus-3c9ddce5.md) |
| RefactoringGuru/design-patterns-typescript | Type Checker | [open](pattern-language-refactoringguru-design-patterns-typescript-c92d9ee2.md) |
| rmanguinho/clean-react | Type Checker | [open](pattern-language-rmanguinho-clean-react-f46a6fea.md) |
| rmanguinho/clean-ts-api | Type Checker | [open](pattern-language-rmanguinho-clean-ts-api-fc4f6eb3.md) |
| torokmark/design_patterns_in_typescript | Type Checker | [open](pattern-language-torokmark-design-patterns-in-typescript-2b171588.md) |
