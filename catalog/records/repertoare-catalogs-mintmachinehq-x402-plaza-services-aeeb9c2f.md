# MintMachineHQ/x402-plaza-services
...
<!-- canonical: https://github.com/MintMachineHQ/x402-plaza-services -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MintMachineHQ/x402-plaza-services](https://github.com/MintMachineHQ/x402-plaza-services) |
| Source record ids | github_search_repertoare_catalogs-2286616e1e2459 |

## System Engineer Summary

Paid MCP services for AI agents — 9 tools on 6 chains via x402 micropayments. 100/100 Smithery
quality score. Free plaza.catalog menu tool.

## Operational Role

For a systems engineer, MintMachineHQ/x402-plaza-services belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-16T01:36:15Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-2286616e1e2459` from `github_search_repertoare_catalogs` as `registry_expansion`
