...
<!-- canonical: https://github.com/flowershow/markdowndb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flowershow/markdowndb](https://github.com/flowershow/markdowndb) |
| Source record ids | github_search_catalogs-cd92712b3dd59a |

## System Engineer Summary

Turn markdown files into structured, queryable data with JS. Build markdown-powered docs, blogs, and
sites quickly and reliably.

## Operational Role

For a systems engineer, flowershow/markdowndb belongs in the Catalogs inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-21T02:18:02Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-cd92712b3dd59a` from `github_search_catalogs` as `registry_expansion`
