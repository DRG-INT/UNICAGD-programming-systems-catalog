...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/fast-sql/FastSQL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fast-sql/FastSQL](https://github.com/fast-sql/FastSQL) |
| Source record ids | github_search_databases-d04b109c02f21e |
...
For a systems engineer, fast-sql/FastSQL belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-04T06:07:20Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d04b109c02f21e` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alibaba/zvec | Parser Lexer Ast | [open](databases-alibaba-zvec-99659847.md) |
| appbaseio/dejavu | Parser Lexer Ast | [open](databases-appbaseio-dejavu-cac2e2c6.md) |
| arnaudroger/SimpleFlatMapper | Parser Lexer Ast | [open](databases-arnaudroger-simpleflatmapper-bed9a08c.md) |
| BDR | Parser Lexer Ast | [open](databases-bdr-d3b5137a.md) |
| calcom/cal.diy | Parser Lexer Ast | [open](databases-calcom-cal-diy-2a9d1d15.md) |
| chroma-core/chroma | Parser Lexer Ast | [open](databases-chroma-core-chroma-4683632f.md) |
| danny-avila/rag_api | Parser Lexer Ast | [open](databases-danny-avila-rag-api-13cf38f8.md) |
| datalevin/datalevin | Parser Lexer Ast | [open](databases-datalevin-datalevin-fd00132f.md) |
