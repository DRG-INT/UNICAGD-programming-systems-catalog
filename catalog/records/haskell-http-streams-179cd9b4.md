...
<!-- canonical: https://hackage.haskell.org/package/http-streams -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http-streams](https://hackage.haskell.org/package/http-streams) |
| Source record ids | hackage_top_downloads-fafea7d9366926 |
...
For a systems engineer, http-streams belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.9.9 | 2023-10-20T05:39:49Z | [https://hackage.haskell.org/package/http-streams](https://hackage.haskell.org/package/http-streams) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http-streams` at `2026-09-15T00:30:30+00:00`.
...
- `hackage_top_downloads-fafea7d9366926` from `hackage_top_downloads` as `registry_expansion`
