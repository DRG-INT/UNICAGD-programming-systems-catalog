...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ryanoasis/nerd-fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ryanoasis/nerd-fonts](https://github.com/ryanoasis/nerd-fonts) |
| Source record ids | github_search_assets-d0b177c76f149a |

## System Engineer Summary

Iconic font aggregator, collection, & patcher. 3,600+ icons, 50+ patched fonts: Hack, Source Code
Pro, more. Glyph collections: Font Awesome, Material Design Icons, Octicons, & more

## Operational Role

For a systems engineer, ryanoasis/nerd-fonts belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T10:22:17Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d0b177c76f149a` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| brabadu/awesome-fonts | Community Reference | [open](assets-brabadu-awesome-fonts-b7ce3727.md) |
| Brian-Jiang/SmartReference | Community Reference | [open](assets-brian-jiang-smartreference-a178adf2.md) |
| edcasillas/unity-missing-references-finder | Community Reference | [open](assets-edcasillas-unity-missing-references-finder-df72b315.md) |
| itgalaxy/webfont | Community Reference | [open](assets-itgalaxy-webfont-497adeb1.md) |
| Jolg42/awesome-typography | Community Reference | [open](assets-jolg42-awesome-typography-4ebaa57a.md) |
