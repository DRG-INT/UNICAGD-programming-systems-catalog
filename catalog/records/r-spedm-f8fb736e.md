...
<!-- canonical: https://cran.r-project.org/web/packages/spEDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spEDM/index.html](https://cran.r-project.org/web/packages/spEDM/index.html) |
| Source record ids | cran_packages_by_date-c5199b1da14636 |
...
For a systems engineer, spEDM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13 | 2026-09-09 16:20:02 UTC | [https://cran.r-project.org/web/packages/spEDM/DESCRIPTION](https://cran.r-project.org/web/packages/spEDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spEDM/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-c5199b1da14636` from `cran_packages_by_date` as `registry_expansion`
