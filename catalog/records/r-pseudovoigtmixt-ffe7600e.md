...
<!-- canonical: https://cran.r-project.org/web/packages/PseudoVoigtMixt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PseudoVoigtMixt/index.html](https://cran.r-project.org/web/packages/PseudoVoigtMixt/index.html) |
| Source record ids | cran_packages_by_date-abc4508b48bb0a |

## System Engineer Summary

Multivariate Pseudo-Voigt Mixture Models

## Operational Role

For a systems engineer, PseudoVoigtMixt belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:20:15 UTC | [https://cran.r-project.org/web/packages/PseudoVoigtMixt/DESCRIPTION](https://cran.r-project.org/web/packages/PseudoVoigtMixt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PseudoVoigtMixt/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-abc4508b48bb0a` from `cran_packages_by_date` as `registry_expansion`
