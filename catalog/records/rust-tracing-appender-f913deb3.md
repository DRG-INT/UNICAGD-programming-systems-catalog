...
<!-- canonical: https://crates.io/crates/tracing-appender -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tracing-appender](https://crates.io/crates/tracing-appender) |
| Source record ids | crates_io-e8a660fbaff0d8 |
...
For a systems engineer, tracing-appender belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-04-17T13:23:16.002139Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-e8a660fbaff0d8` from `crates_io` as `registry_expansion`
