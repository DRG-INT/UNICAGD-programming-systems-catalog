...
<!-- canonical: https://hackage.haskell.org/package/configurator-pg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/configurator-pg](https://hackage.haskell.org/package/configurator-pg) |
| Source record ids | hackage_top_downloads-f14866c76a95f8 |
...
For a systems engineer, configurator-pg belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2025-10-10T17:34:55Z | [https://hackage.haskell.org/package/configurator-pg](https://hackage.haskell.org/package/configurator-pg) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/configurator-pg](https://hackage.haskell.org/package/configurator-pg) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/configurator-pg` at `2026-09-03T00:34:26+00:00`.
...
- `hackage_top_downloads-f14866c76a95f8` from `hackage_top_downloads` as `registry_expansion`
