...
<!-- canonical: https://crates.io/crates/axum-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/axum-macros](https://crates.io/crates/axum-macros) |
| Source record ids | crates_io-a924b674935dd6 |

## System Engineer Summary

axum-macros is tracked as a filesystem os record in the Rust branch. The source did not provide a
...
For a systems engineer, axum-macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-04-14T07:55:01.145948Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-a924b674935dd6` from `crates_io` as `registry_expansion`
