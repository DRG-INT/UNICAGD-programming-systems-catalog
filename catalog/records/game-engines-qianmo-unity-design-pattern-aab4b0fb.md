...
<!-- canonical: https://github.com/QianMo/Unity-Design-Pattern -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/QianMo/Unity-Design-Pattern](https://github.com/QianMo/Unity-Design-Pattern) |
| Source record ids | github_search_game_engines-464639426f5bf5 |

## System Engineer Summary

:tea: All Gang of Four Design Patterns written in Unity C# with many examples. And some Game
Programming Patterns written in Unity C#. | 各种设计模式的Unity3D C#版本实现

## Operational Role

For a systems engineer, QianMo/Unity-Design-Pattern belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-06T05:00:57Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-464639426f5bf5` from `github_search_game_engines` as `registry_expansion`
