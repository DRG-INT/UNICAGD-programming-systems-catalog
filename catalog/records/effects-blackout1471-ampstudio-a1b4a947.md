...
<!-- canonical: https://github.com/blackout1471/AmpStudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blackout1471/AmpStudio](https://github.com/blackout1471/AmpStudio) |
| Source record ids | github_search_effects-074a671f9bb942 |

## System Engineer Summary

AmpStudio is an amplifier modeling software where effects can be modelled and shared in lua.

## Operational Role

For a systems engineer, blackout1471/AmpStudio belongs in the Effects inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-22T18:49:11Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-074a671f9bb942` from `github_search_effects` as `registry_expansion`
