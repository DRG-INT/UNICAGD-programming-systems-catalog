...
<!-- canonical: https://crates.io/crates/wide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wide](https://crates.io/crates/wide) |
| Source record ids | crates_io-d75585ad733f52 |
...
For a systems engineer, wide belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-09-14T17:06:02.853323Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-14T18:22:58+00:00`.
...
- `crates_io-d75585ad733f52` from `crates_io` as `registry_expansion`
