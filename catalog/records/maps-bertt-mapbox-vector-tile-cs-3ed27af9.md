...
<!-- canonical: https://github.com/bertt/mapbox-vector-tile-cs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bertt/mapbox-vector-tile-cs](https://github.com/bertt/mapbox-vector-tile-cs) |
| Source record ids | github_search_maps-bc388c2faead9d |

## System Engineer Summary

A .NET Standard 2.0 library for encoding/decoding a Mapbox vector tile

## Operational Role

For a systems engineer, bertt/mapbox-vector-tile-cs belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T08:27:54Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-bc388c2faead9d` from `github_search_maps` as `registry_expansion`
