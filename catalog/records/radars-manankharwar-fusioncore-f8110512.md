...
<!-- canonical: https://github.com/manankharwar/fusioncore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/manankharwar/fusioncore](https://github.com/manankharwar/fusioncore) |
| Source record ids | github_search_radars-3c8a50d026bd0f |

## System Engineer Summary

ROS 2 localization for outdoor robots: IMU, wheel encoders and GPS fused in a 23-state UKF at 100
Hz. When the estimate goes wrong it reports which sensor and why, instead of drifting silently.
Apache 2.0.

## Operational Role

For a systems engineer, manankharwar/fusioncore belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T05:56:36Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:gnss stars:>20", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_radars-3c8a50d026bd0f` from `github_search_radars` as `registry_expansion`
