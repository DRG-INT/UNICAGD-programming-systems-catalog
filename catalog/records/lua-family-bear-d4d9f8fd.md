...
<!-- canonical: https://luarocks.org/modules/dijeferson/bear -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dijeferson/bear](https://luarocks.org/modules/dijeferson/bear) |
| Source record ids | luarocks_root_manifest-ce72fc2769a8d3 |

## System Engineer Summary

A Lua library to interact with Bear the note taking app for macOS, iOS, and iPadOS.

## Operational Role

For a systems engineer, bear belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ce72fc2769a8d3` from `luarocks_root_manifest` as `registry_expansion`
