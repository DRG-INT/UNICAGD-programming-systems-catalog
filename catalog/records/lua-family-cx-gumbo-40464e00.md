...
<!-- canonical: https://luarocks.org/modules/danieldop/cx-gumbo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/danieldop/cx-gumbo](https://luarocks.org/modules/danieldop/cx-gumbo) |
| Source record ids | luarocks_root_manifest-0eb040ce5331d3 |
...
For a systems engineer, cx-gumbo belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-0eb040ce5331d3` from `luarocks_root_manifest` as `registry_expansion`
