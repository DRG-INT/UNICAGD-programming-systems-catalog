...
<!-- canonical: https://pypi.org/project/address-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-parser/](https://pypi.org/project/address-parser/) |
| Source record ids | pypi_simple-89f46fb2502321, pypi_simple-faa49f50ae23cd |

## System Engineer Summary

address-parser is tracked as a parser lexer ast record in the Python branch. The source did not
...
For a systems engineer, address-parser belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2019-06-18T16:42:29.894509Z | [https://pypi.org/pypi/address-parser/json](https://pypi.org/pypi/address-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-parser/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-89f46fb2502321` from `pypi_simple` as `registry_expansion`
- `pypi_simple-faa49f50ae23cd` from `pypi_simple` as `registry_expansion`
