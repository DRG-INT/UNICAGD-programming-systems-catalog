...
<!-- canonical: https://github.com/stargatedaw/stargate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stargatedaw/stargate](https://github.com/stargatedaw/stargate) |
| Source record ids | github_search_audio-ea8142cbf7b7a7 |
...
For a systems engineer, stargatedaw/stargate belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-21T17:51:22Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-ea8142cbf7b7a7` from `github_search_audio` as `registry_expansion`
