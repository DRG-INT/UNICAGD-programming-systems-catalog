...
<!-- canonical: https://pub.dev/packages/numberpicker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/numberpicker](https://pub.dev/packages/numberpicker) |
| Source record ids | pub_dev-9bdf14b4aa10ac |
...
For a systems engineer, numberpicker belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2023-04-11T18:55:50.147641Z | [https://pub.dev/api/packages/numberpicker](https://pub.dev/api/packages/numberpicker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/numberpicker` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-9bdf14b4aa10ac` from `pub_dev` as `registry_expansion`
