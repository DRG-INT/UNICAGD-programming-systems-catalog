...
<!-- canonical: https://cran.r-project.org/web/packages/TrackTrap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TrackTrap/index.html](https://cran.r-project.org/web/packages/TrackTrap/index.html) |
| Source record ids | cran_packages_by_date-c3be20735db9d1 |
...
For a systems engineer, TrackTrap belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-20 06:42:04 UTC | [https://cran.r-project.org/web/packages/TrackTrap/DESCRIPTION](https://cran.r-project.org/web/packages/TrackTrap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TrackTrap/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c3be20735db9d1` from `cran_packages_by_date` as `registry_expansion`
