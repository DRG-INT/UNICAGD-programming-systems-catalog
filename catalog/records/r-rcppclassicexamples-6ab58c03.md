...
<!-- canonical: https://cran.r-project.org/web/packages/RcppClassicExamples/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppClassicExamples/index.html](https://cran.r-project.org/web/packages/RcppClassicExamples/index.html) |
| Source record ids | cran_packages_by_date-4455e17a50a06f |
...
For a systems engineer, RcppClassicExamples belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-02 17:20:07 UTC | [https://cran.r-project.org/web/packages/RcppClassicExamples/DESCRIPTION](https://cran.r-project.org/web/packages/RcppClassicExamples/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppClassicExamples/DESCRIPTION` at `2026-09-02T18:23:31+00:00`.
...
- `cran_packages_by_date-4455e17a50a06f` from `cran_packages_by_date` as `registry_expansion`
