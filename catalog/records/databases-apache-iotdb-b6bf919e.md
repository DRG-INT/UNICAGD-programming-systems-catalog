...
<!-- canonical: https://github.com/apache/iotdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/iotdb](https://github.com/apache/iotdb) |
| Source record ids | github_search_databases-a5066b82b7ea47 |

## System Engineer Summary

apache/iotdb is tracked as a database datastore record in the Databases branch. The source did not
...
For a systems engineer, apache/iotdb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:20:30Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a5066b82b7ea47` from `github_search_databases` as `registry_expansion`
