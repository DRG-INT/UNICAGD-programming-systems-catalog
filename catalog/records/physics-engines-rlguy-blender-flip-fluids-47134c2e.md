...
<!-- canonical: https://github.com/rlguy/Blender-FLIP-Fluids -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rlguy/Blender-FLIP-Fluids](https://github.com/rlguy/Blender-FLIP-Fluids) |
| Source record ids | github_search_physics_engines-4ddac3be64833c |

## System Engineer Summary

The FLIP Fluids addon is a tool that helps you set up, run, and render high quality liquid fluid
effects all within Blender, the free and open source 3D creation suite.

## Operational Role

For a systems engineer, rlguy/Blender-FLIP-Fluids belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T22:35:14Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-4ddac3be64833c` from `github_search_physics_engines` as `registry_expansion`
