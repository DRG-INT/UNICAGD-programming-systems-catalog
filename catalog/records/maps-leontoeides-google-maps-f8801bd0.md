...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/leontoeides/google_maps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leontoeides/google_maps](https://github.com/leontoeides/google_maps) |
| Source record ids | github_search_maps-21f6b1794fa0d7 |
...
For a systems engineer, leontoeides/google_maps belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-12T17:53:34Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_maps-21f6b1794fa0d7` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bertt/mapbox-vector-tile-cs | Language Specification | [open](maps-bertt-mapbox-vector-tile-cs-3ed27af9.md) |
| CesiumGS/3d-tiles | Language Specification | [open](maps-cesiumgs-3d-tiles-437ee108.md) |
| chicago-justice-project/article-tagging | Language Specification | [open](maps-chicago-justice-project-article-tagging-1148e9b3.md) |
| geopython/pygeoapi | Language Specification | [open](maps-geopython-pygeoapi-d6a22971.md) |
| jczic/MicroWebSrv | Language Specification | [open](maps-jczic-microwebsrv-507914eb.md) |
| maplibre/maputnik | Language Specification | [open](maps-maplibre-maputnik-9ad351fe.md) |
| open-meteo/geocoding-api | Language Specification | [open](maps-open-meteo-geocoding-api-8d972914.md) |
| opengeospatial/geoparquet | Language Specification | [open](maps-opengeospatial-geoparquet-135cad2a.md) |
