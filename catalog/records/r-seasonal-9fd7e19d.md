...
<!-- canonical: https://cran.r-project.org/web/packages/seasonal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/seasonal/index.html](https://cran.r-project.org/web/packages/seasonal/index.html) |
| Source record ids | cran_packages_by_date-c9f7f69201f224 |
...
For a systems engineer, seasonal belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11.0 | 2026-09-14 23:00:16 UTC | [https://cran.r-project.org/web/packages/seasonal/DESCRIPTION](https://cran.r-project.org/web/packages/seasonal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/seasonal/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-c9f7f69201f224` from `cran_packages_by_date` as `registry_expansion`
