...
<!-- canonical: https://crates.io/crates/whoami -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/whoami](https://crates.io/crates/whoami) |
| Source record ids | crates_io-2fce4947d93bd1 |
...
For a systems engineer, whoami belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2026-08-11T23:31:57.132972Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-2fce4947d93bd1` from `crates_io` as `registry_expansion`
