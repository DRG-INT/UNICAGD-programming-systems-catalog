...
<!-- canonical: https://github.com/pinecone-io/canopy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pinecone-io/canopy](https://github.com/pinecone-io/canopy) |
| Source record ids | github_search_databases-0c04b8cfb003fc |
...
For a systems engineer, pinecone-io/canopy belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-13T06:32:28Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0c04b8cfb003fc` from `github_search_databases` as `registry_expansion`
