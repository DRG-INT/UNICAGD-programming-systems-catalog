...
| Canonical URL | [https://github.com/WebAssembly/wabt](https://github.com/WebAssembly/wabt) |
| Source record ids | github_search_webassembly-46ef03674629c1 |
...
For a systems engineer, WebAssembly/wabt belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.41 | 2026-05-07T14:32:21Z | [https://api.github.com/repos/WebAssembly/wabt/releases/latest](https://api.github.com/repos/WebAssembly/wabt/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/WebAssembly/wabt/releases/latest` at `2026-09-01T10:26:02+00:00`.
...
- `github_search_webassembly-46ef03674629c1` from `github_search_webassembly` as `registry_expansion`
