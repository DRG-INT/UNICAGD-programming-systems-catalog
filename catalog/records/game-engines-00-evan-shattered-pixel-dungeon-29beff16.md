...
<!-- canonical: https://github.com/00-Evan/shattered-pixel-dungeon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/00-Evan/shattered-pixel-dungeon](https://github.com/00-Evan/shattered-pixel-dungeon) |
| Source record ids | github_search_game_engines-f59492a6b3901d |

## System Engineer Summary

Shattered Pixel Dungeon is an open-source traditional roguelike dungeon crawler with randomized
levels and enemies, and hundreds of items to collect and use. It's based on the source code of Pixel
Dungeon, by Watabou.

## Operational Role

For a systems engineer, 00-Evan/shattered-pixel-dungeon belongs in the Game Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T14:52:52Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-f59492a6b3901d` from `github_search_game_engines` as `registry_expansion`
