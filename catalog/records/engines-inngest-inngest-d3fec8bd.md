...
<!-- canonical: https://github.com/inngest/inngest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/inngest/inngest](https://github.com/inngest/inngest) |
| Source record ids | github_search_engines-857f486ea449e8 |

## System Engineer Summary

The leading workflow orchestration platform. Run stateful step functions and AI workflows on
serverless, servers, or the edge.

## Operational Role

For a systems engineer, inngest/inngest belongs in the Engines inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:18:03Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-857f486ea449e8` from `github_search_engines` as `registry_expansion`
...
| viewflow/viewflow | Web Framework | [open](engines-viewflow-viewflow-26a58ce9.md) |
