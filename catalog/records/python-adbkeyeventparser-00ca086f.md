...
<!-- canonical: https://pypi.org/project/adbkeyeventparser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adbkeyeventparser/](https://pypi.org/project/adbkeyeventparser/) |
| Source record ids | pypi_simple-b58ed0d3739e1e |

## System Engineer Summary

parses Android keycodes from the official documentation and returns a dictionary containing key
information.

## Operational Role

For a systems engineer, adbkeyeventparser belongs in the Python inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2023-10-10T19:32:28.247649Z | [https://pypi.org/pypi/adbkeyeventparser/json](https://pypi.org/pypi/adbkeyeventparser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adbkeyeventparser/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-b58ed0d3739e1e` from `pypi_simple` as `registry_expansion`
