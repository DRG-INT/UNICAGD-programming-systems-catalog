...
<!-- canonical: https://pub.dev/packages/scroll_pos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/scroll_pos](https://pub.dev/packages/scroll_pos) |
| Source record ids | pub_dev-ec1739471631d7 |

## System Engineer Summary

Provides some additional functions to ScrollController to define item position relative to the
screen.

## Operational Role

For a systems engineer, scroll_pos belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2023-10-19T09:36:37.355391Z | [https://pub.dev/api/packages/scroll_pos](https://pub.dev/api/packages/scroll_pos) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/scroll_pos` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-ec1739471631d7` from `pub_dev` as `registry_expansion`
