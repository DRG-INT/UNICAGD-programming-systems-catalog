...
<!-- canonical: https://github.com/Shilo/pixellab-pip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Shilo/pixellab-pip](https://github.com/Shilo/pixellab-pip) |
| Source record ids | github_search_assets-4f4a2fe413ddc0 |

## System Engineer Summary

Meet PixelLab Pip: a tiny pup who fetches the right PixelLab workflow. He follows human commands to
create, edit, and animate pixel assets, then sniffs out a bigger prompt, scouts for a useful tool,
and carries back what happened.

## Operational Role

For a systems engineer, Shilo/pixellab-pip belongs in the Assets inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T04:50:35Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-4f4a2fe413ddc0` from `github_search_assets` as `registry_expansion`
