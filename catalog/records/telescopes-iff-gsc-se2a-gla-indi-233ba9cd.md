# iff-gsc/SE2A_GLA_INDI

## Navigation

[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/iff-gsc/SE2A_GLA_INDI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iff-gsc/SE2A_GLA_INDI](https://github.com/iff-gsc/SE2A_GLA_INDI) |
| Source record ids | github_search_telescopes-7d20a23a2acb2d |
...
For a systems engineer, iff-gsc/SE2A_GLA_INDI belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-17T11:20:52Z | gh search repos topic:indi stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:indi stars:>10", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-7d20a23a2acb2d` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dEskoG/rDUINOScope | Filesystem Os | [open](telescopes-deskog-rduinoscope-0542432f.md) |
| Julien-R44/adoscope | Filesystem Os | [open](telescopes-julien-r44-adoscope-0cdd9994.md) |
| rcos/Telescope | Filesystem Os | [open](telescopes-rcos-telescope-e587062a.md) |
| vlaate/DobsonianDSC | Filesystem Os | [open](telescopes-vlaate-dobsoniandsc-83afe2a8.md) |
