...
<!-- canonical: https://packagist.org/packages/ircmaxell/password-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ircmaxell/password-compat](https://packagist.org/packages/ircmaxell/password-compat) |
| Source record ids | packagist_search-c34eb468fed947 |
...
For a systems engineer, ircmaxell/password-compat belongs in the PHP inventory as part of service
...
- `packagist_search-c34eb468fed947` from `packagist_search` as `registry_expansion`
