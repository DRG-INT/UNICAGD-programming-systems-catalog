...
<!-- canonical: https://github.com/P1xt/p1xt-guides -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/P1xt/p1xt-guides](https://github.com/P1xt/p1xt-guides) |
| Source record ids | github_search_game_engines-fc1168a9fae689 |

## System Engineer Summary

P1xt/p1xt-guides is tracked as an ide editor integration record in the Game Engines branch. The
...
For a systems engineer, P1xt/p1xt-guides belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-03T19:47:46Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-fc1168a9fae689` from `github_search_game_engines` as `registry_expansion`
