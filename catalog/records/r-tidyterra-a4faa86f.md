...
<!-- canonical: https://cran.r-project.org/web/packages/tidyterra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidyterra/index.html](https://cran.r-project.org/web/packages/tidyterra/index.html) |
| Source record ids | cran_packages_by_date-dbf8a4ee3da5cd |
...
For a systems engineer, tidyterra belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-24 08:30:02 UTC | [https://cran.r-project.org/web/packages/tidyterra/DESCRIPTION](https://cran.r-project.org/web/packages/tidyterra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidyterra/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dbf8a4ee3da5cd` from `cran_packages_by_date` as `registry_expansion`
