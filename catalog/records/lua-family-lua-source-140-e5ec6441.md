...
| Source record ids | lua-source-140 |

## System Engineer Summary

lua-source-140 is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, lua-source-140 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 140}}` |
...
- `lua-source-140` from `master_json` as `source_list_item`
