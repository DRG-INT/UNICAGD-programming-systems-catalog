...
<!-- canonical: https://github.com/JunshengFu/tracking-with-Extended-Kalman-Filter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JunshengFu/tracking-with-Extended-Kalman-Filter](https://github.com/JunshengFu/tracking-with-Extended-Kalman-Filter) |
| Source record ids | github_search_radars-a468f078096a1e |

## System Engineer Summary

Object (e.g Pedestrian, vehicles) tracking by Extended Kalman Filter (EKF), with fused data from
both lidar and radar sensors.

## Operational Role

For a systems engineer, JunshengFu/tracking-with-Extended-Kalman-Filter belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-27T15:45:24Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-a468f078096a1e` from `github_search_radars` as `registry_expansion`
