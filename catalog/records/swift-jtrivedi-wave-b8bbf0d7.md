...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jtrivedi/Wave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jtrivedi/Wave](https://github.com/jtrivedi/Wave) |
| Source record ids | github_search_swift-af5cb3b2b15b04 |

## System Engineer Summary

Wave is a spring-based animation engine for iOS and macOS that makes it easy to create fluid,
interruptible animations that feel great.

## Operational Role

For a systems engineer, jtrivedi/Wave belongs in the Swift inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-25T05:36:37Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-af5cb3b2b15b04` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| algolia/instantsearch-ios | Build System | [open](swift-algolia-instantsearch-ios-6743b8b7.md) |
| altic-dev/FluidVoice | Build System | [open](swift-altic-dev-fluidvoice-6306d9c1.md) |
| amirdew/CollectionViewPagingLayout | Build System | [open](swift-amirdew-collectionviewpaginglayout-a21ca0ec.md) |
| GottaGetSwifty/CodableWrappers | Build System | [open](swift-gottagetswifty-codablewrappers-2321bbf2.md) |
| groue/GRDB.swift | Build System | [open](swift-groue-grdb-swift-b95b3c97.md) |
| IBAnimatable/IBAnimatable | Build System | [open](swift-ibanimatable-ibanimatable-d1d4f6a1.md) |
| ninjaprox/NVActivityIndicatorView | Build System | [open](swift-ninjaprox-nvactivityindicatorview-50c765a4.md) |
| pointfreeco/swift-composable-architecture | Build System | [open](swift-pointfreeco-swift-composable-architecture-06df9a62.md) |
