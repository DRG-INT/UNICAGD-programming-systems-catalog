...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CenteredRBMs](https://github.com/JuliaRegistries/General/tree/master/C/CenteredRBMs) |
| Source record ids | julia_general-149045df72fb0f |

## System Engineer Summary

Julia package registered in General at C/CenteredRBMs.

## Operational Role

For a systems engineer, CenteredRBMs belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CenteredRBMs", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-149045df72fb0f` from `julia_general` as `registry_expansion`
