...
<!-- canonical: https://packagist.org/packages/allure-framework/allure-codeception -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/allure-framework/allure-codeception](https://packagist.org/packages/allure-framework/allure-codeception) |
| Source record ids | packagist_search-557b2b70b2e036 |
...
For a systems engineer, allure-framework/allure-codeception belongs in the PHP inventory as part of
...
- `packagist_search-557b2b70b2e036` from `packagist_search` as `registry_expansion`
