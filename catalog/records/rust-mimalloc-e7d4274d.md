...
<!-- canonical: https://crates.io/crates/mimalloc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/mimalloc](https://crates.io/crates/mimalloc) |
| Source record ids | crates_io-dd248ee99c1058 |
...
For a systems engineer, mimalloc belongs in the Rust inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.52 | 2026-05-22T13:15:21.565252Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-16T06:26:06+00:00`.
...
- `crates_io-dd248ee99c1058` from `crates_io` as `registry_expansion`
