...
<!-- canonical: https://crates.io/crates/half -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/half](https://crates.io/crates/half) |
| Source record ids | crates_io-64203ec0350893 |

## System Engineer Summary

Half-precision floating point f16 and bf16 types for Rust implementing the IEEE 754-2008 standard
binary16 and bfloat16 types.

## Operational Role

For a systems engineer, half belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.1 | 2025-10-14T03:59:26.575229Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-64203ec0350893` from `crates_io` as `registry_expansion`
