...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CommonDataFormat](https://github.com/JuliaRegistries/General/tree/master/C/CommonDataFormat) |
| Source record ids | julia_general-8623e37a0800b1 |

## System Engineer Summary

Julia package registered in General at C/CommonDataFormat.

## Operational Role

For a systems engineer, CommonDataFormat belongs in the Julia inventory as part of low-noise code
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CommonDataFormat", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8623e37a0800b1` from `julia_general` as `registry_expansion`
