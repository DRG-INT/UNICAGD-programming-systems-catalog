...
<!-- canonical: https://cran.r-project.org/web/packages/RLumShiny/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RLumShiny/index.html](https://cran.r-project.org/web/packages/RLumShiny/index.html) |
| Source record ids | cran_packages_by_date-25d0ea726bed2c |
...
For a systems engineer, RLumShiny belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8 | 2026-08-25 05:21:00 UTC | [https://cran.r-project.org/web/packages/RLumShiny/DESCRIPTION](https://cran.r-project.org/web/packages/RLumShiny/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RLumShiny/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-25d0ea726bed2c` from `cran_packages_by_date` as `registry_expansion`
