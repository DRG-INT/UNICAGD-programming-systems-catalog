...
<!-- canonical: https://crates.io/crates/foreign-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/foreign-types](https://crates.io/crates/foreign-types) |
| Source record ids | crates_io-a71549025e34bc |
...
For a systems engineer, foreign-types belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2019-10-13T19:24:15.900127Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-a71549025e34bc` from `crates_io` as `registry_expansion`
