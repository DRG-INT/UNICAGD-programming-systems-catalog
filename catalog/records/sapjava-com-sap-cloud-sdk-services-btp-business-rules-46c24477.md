...
[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/btp-business-rules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/btp-business-rules](https://central.sonatype.com/artifact/com.sap.cloud.sdk.services/btp-business-rules) |
| Source record ids | maven_central_search-a7472234ef5b45 |
...
For a systems engineer, com.sap.cloud.sdk.services:btp-business-rules belongs in the SAPJava
...
- `maven_central_search-a7472234ef5b45` from `maven_central_search` as `registry_expansion`
