...
<!-- canonical: https://github.com/swagger-api/swagger-ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/swagger-api/swagger-ui](https://github.com/swagger-api/swagger-ui) |
| Source record ids | curated_language_routes-7d01e47594997f |

## System Engineer Summary

OpenAPI documentation UI and interactive API browser.

## Operational Role

For a systems engineer, Swagger UI belongs in the APIs inventory as part of ecosystem capability
...
- `curated_language_routes-7d01e47594997f` from `curated_language_routes` as `registry_expansion`
