...
| Canonical URL | [https://crates.io/crates/fax](https://crates.io/crates/fax) |
| Source record ids | crates_io-aae424e99dc241 |

## System Engineer Summary

Decoder and Encoder for CCITT Group 3 and 4 bi-level image encodings used by fax machines TIFF and
PDF.

## Operational Role

For a systems engineer, fax belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-07-13T16:45:06.159105Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| ico | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ico-4cdb132a.md) |
| image-webp | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-image-webp-e60625b1.md) |
| loop9 | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-loop9-b2408fc4.md) |
| signal-hook | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-signal-hook-5c152b8c.md) |
| signal-hook-mio | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-signal-hook-mio-17a72fca.md) |
| zune-core | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-zune-core-1162df7a.md) |
