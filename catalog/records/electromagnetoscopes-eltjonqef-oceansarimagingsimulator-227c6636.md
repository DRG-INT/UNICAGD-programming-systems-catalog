...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/eltjonqef/OceanSARImagingSimulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eltjonqef/OceanSARImagingSimulator](https://github.com/eltjonqef/OceanSARImagingSimulator) |
| Source record ids | github_search_electromagnetoscopes-8f1fa1be845762 |
...
For a systems engineer, eltjonqef/OceanSARImagingSimulator belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-02T00:39:44Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-8f1fa1be845762` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dernasherbrezon/r2cloud | Image Audio Dsp | [open](electromagnetoscopes-dernasherbrezon-r2cloud-ccffcbcb.md) |
| emidan19/deep-tempest | Image Audio Dsp | [open](electromagnetoscopes-emidan19-deep-tempest-2244295b.md) |
| GNU Radio | Image Audio Dsp | [open](electromagnetoscopes-gnu-radio-984c5d95.md) |
| jeancsanchez/JcPlayer | Image Audio Dsp | [open](electromagnetoscopes-jeancsanchez-jcplayer-bcd3fe33.md) |
| kbasaran/Speaker-Calculator | Image Audio Dsp | [open](electromagnetoscopes-kbasaran-speaker-calculator-d60ee43a.md) |
| MeowLucian/SDR_Matlab_OFDM_802.11a | Image Audio Dsp | [open](electromagnetoscopes-meowlucian-sdr-matlab-ofdm-802-11a-2c32289f.md) |
| Mictronics/multi-sdr-gps-sim | Image Audio Dsp | [open](electromagnetoscopes-mictronics-multi-sdr-gps-sim-a3c72c37.md) |
| miek/inspectrum | Image Audio Dsp | [open](electromagnetoscopes-miek-inspectrum-db6d4384.md) |
