...
<!-- canonical: https://github.com/nalgeon/sqlean -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nalgeon/sqlean](https://github.com/nalgeon/sqlean) |
| Source record ids | github_search_databases-78519a930c9c20 |
...
For a systems engineer, nalgeon/sqlean belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T11:09:47Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-78519a930c9c20` from `github_search_databases` as `registry_expansion`
