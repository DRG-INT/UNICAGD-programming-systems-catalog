...
<!-- canonical: https://github.com/libsndfile/libsndfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libsndfile/libsndfile](https://github.com/libsndfile/libsndfile) |
| Source record ids | curated_language_routes-9c22d0d1dec448 |

## System Engineer Summary

Audio file I/O library for reading, writing, and converting PCM and compressed sound formats.

## Operational Role

For a systems engineer, libsndfile belongs in the Audio inventory as part of ecosystem capability
...
- `curated_language_routes-9c22d0d1dec448` from `curated_language_routes` as `registry_expansion`
