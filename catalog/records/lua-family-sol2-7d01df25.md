...
| Source record ids | corpus-e9f5d21ce37cea |

## System Engineer Summary

sol2 is tracked as a ffi bindings record in the Lua family branch. The source did not provide a long
...
For a systems engineer, sol2 belongs in the Lua family inventory as part of cross-language
...
- `corpus-e9f5d21ce37cea` from `master_json` as `ffi_bindings`
