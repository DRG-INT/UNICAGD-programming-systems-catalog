...
<!-- canonical: https://packagist.org/packages/cache/predis-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/cache/predis-adapter](https://packagist.org/packages/cache/predis-adapter) |
| Source record ids | packagist_search-50eeb19ec54e16 |
...
For a systems engineer, cache/predis-adapter belongs in the PHP inventory as part of state
...
- `packagist_search-50eeb19ec54e16` from `packagist_search` as `registry_expansion`
