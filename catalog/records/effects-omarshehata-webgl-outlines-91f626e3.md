...
<!-- canonical: https://github.com/OmarShehata/webgl-outlines -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OmarShehata/webgl-outlines](https://github.com/OmarShehata/webgl-outlines) |
| Source record ids | github_search_effects-31d8d04df9efc4 |
...
For a systems engineer, OmarShehata/webgl-outlines belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-09T15:57:56Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-31d8d04df9efc4` from `github_search_effects` as `registry_expansion`
