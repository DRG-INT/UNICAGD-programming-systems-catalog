...
<!-- canonical: https://github.com/va1da5/docker-gnuradio-pluto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/va1da5/docker-gnuradio-pluto](https://github.com/va1da5/docker-gnuradio-pluto) |
| Source record ids | github_search_satcom_satellites-0536ca6903cd23 |

## System Engineer Summary

Docker image for GNU Radio with ADALM-PLUTO SDR

## Operational Role

For a systems engineer, va1da5/docker-gnuradio-pluto belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-10T11:10:56Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-0536ca6903cd23` from `github_search_satcom_satellites` as `registry_expansion`
