...
<!-- canonical: https://github.com/paperless-ngx/paperless-ngx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paperless-ngx/paperless-ngx](https://github.com/paperless-ngx/paperless-ngx) |
| Source record ids | github_search_aims-e1e8d6e6326944 |

## System Engineer Summary

A community-supported supercharged document management system: scan, index and archive all your
documents

## Operational Role

For a systems engineer, paperless-ngx/paperless-ngx belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T09:11:46Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-e1e8d6e6326944` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ZhuLinsen/daily_stock_analysis | Static Analyzer | [open](aim-s-zhulinsen-daily-stock-analysis-509bb8f4.md) |
