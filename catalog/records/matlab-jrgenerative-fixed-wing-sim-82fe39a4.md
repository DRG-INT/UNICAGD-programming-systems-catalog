...
<!-- canonical: https://github.com/jrgenerative/fixed-wing-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jrgenerative/fixed-wing-sim](https://github.com/jrgenerative/fixed-wing-sim) |
| Source record ids | github_search_matlab-56a5649b1f7bed |

## System Engineer Summary

Matlab implementation to simulate the non-linear dynamics of a fixed-wing unmanned areal glider.
Includes tools to calculate aerodynamic coefficients using a vortex lattice method implementation,
and to extract longitudinal and lateral linear systems around the trimmed gliding state.

## Operational Role

For a systems engineer, jrgenerative/fixed-wing-sim belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-02-28T09:10:06Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_matlab-56a5649b1f7bed` from `github_search_matlab` as `registry_expansion`
