...
| Source record ids | corpus-7b957ba54e2436 |

## System Engineer Summary

Metalua is tracked as a parser lexer ast record in the Lua family branch. The source did not provide
...
For a systems engineer, Metalua belongs in the Lua family inventory as part of language tooling,
...
- `corpus-7b957ba54e2436` from `master_json` as `parser_lexer_ast`
