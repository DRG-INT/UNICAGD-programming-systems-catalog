...
<!-- canonical: https://packagist.org/packages/kriswallsmith/buzz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kriswallsmith/buzz](https://packagist.org/packages/kriswallsmith/buzz) |
| Source record ids | packagist_search-2bab841320cc92 |

## System Engineer Summary

kriswallsmith/buzz is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, kriswallsmith/buzz belongs in the PHP inventory as part of service
...
- `packagist_search-2bab841320cc92` from `packagist_search` as `registry_expansion`
