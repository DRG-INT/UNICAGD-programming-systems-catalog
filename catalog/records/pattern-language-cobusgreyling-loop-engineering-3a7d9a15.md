...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) |
| Source record ids | github_search_pattern_language-682ad99888b3e5 |

## System Engineer Summary

Practical patterns, starters & CLI tools for loop engineering with AI coding agents. Design systems
that prompt and orchestrate agents (inspired by Addy Osmani and Boris Cherny). Includes loop-audit,
loop-init, loop-cost.

## Operational Role

For a systems engineer, cobusgreyling/loop-engineering belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.0 | 2026-07-20T18:42:38Z | [https://api.github.com/repos/cobusgreyling/loop-engineering/releases/latest](https://api.github.com/repos/cobusgreyling/loop-engineering/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cobusgreyling/loop-engineering/releases/latest` at `2026-09-01T10:25:53+00:00`.
...
- `github_search_pattern_language-682ad99888b3e5` from `github_search_pattern_language` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| andrechristikan/ack-nestjs-boilerplate-kafka | Project Scaffolding | [open](pattern-language-andrechristikan-ack-nestjs-boilerplate-kafka-29c3d599.md) |
