...
<!-- canonical: https://cran.r-project.org/web/packages/ks/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ks/index.html](https://cran.r-project.org/web/packages/ks/index.html) |
| Source record ids | cran_packages_by_date-e024fc54acf6d5 |

## System Engineer Summary

ks is tracked as a library record in the R branch. The source did not provide a long description, so
this page keeps the identity, release state, provenance, and operational classification explicit for
later enrichment.

## Operational Role

For a systems engineer, ks belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.15.3 | 2026-08-04 13:30:02 UTC | [https://cran.r-project.org/web/packages/ks/DESCRIPTION](https://cran.r-project.org/web/packages/ks/DESCRIPTION) |  |
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; ISC License; https://api.github.com/licenses/isc |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ks/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e024fc54acf6d5` from `cran_packages_by_date` as `registry_expansion`
