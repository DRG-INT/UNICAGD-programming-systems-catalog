...
<!-- canonical: https://crates.io/crates/ouroboros_macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ouroboros_macro](https://crates.io/crates/ouroboros_macro) |
| Source record ids | crates_io-5c591e0a572db7 |
...
For a systems engineer, ouroboros_macro belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.5 | 2025-01-11T04:16:12.258915Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-5c591e0a572db7` from `crates_io` as `registry_expansion`
