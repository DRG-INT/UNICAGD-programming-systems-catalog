...
<!-- canonical: https://crates.io/crates/serde_cbor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_cbor](https://crates.io/crates/serde_cbor) |
| Source record ids | crates_io-4660b218c8cf5e |

## System Engineer Summary

serde_cbor is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, serde_cbor belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.2 | 2021-08-15T14:08:47.328110Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-4660b218c8cf5e` from `crates_io` as `registry_expansion`
