...
<!-- canonical: https://github.com/uwdata/graphscape -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uwdata/graphscape](https://github.com/uwdata/graphscape) |
| Source record ids | github_search_space_maps-49ae198b36658a |
...
For a systems engineer, uwdata/graphscape belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-07T07:41:19Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-49ae198b36658a` from `github_search_space_maps` as `registry_expansion`
