...
<!-- canonical: https://github.com/shinshin86/oh-my-logo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shinshin86/oh-my-logo](https://github.com/shinshin86/oh-my-logo) |
| Source record ids | github_search_icons_and_logos-2e35cd1ab3c2ba |

## System Engineer Summary

Display giant ASCII-art logos with colorful gradients in your terminal — like Claude Code or Gemini
CLI.

## Operational Role

For a systems engineer, shinshin86/oh-my-logo belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-19T07:50:38Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-2e35cd1ab3c2ba` from `github_search_icons_and_logos` as `registry_expansion`
