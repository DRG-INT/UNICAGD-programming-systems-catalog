...
<!-- canonical: https://cran.r-project.org/web/packages/india/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/india/index.html](https://cran.r-project.org/web/packages/india/index.html) |
| Source record ids | cran_packages_by_date-d5c148e1bd5bc2 |
...
For a systems engineer, india belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-5 | 2026-09-14 02:50:17 UTC | [https://cran.r-project.org/web/packages/india/DESCRIPTION](https://cran.r-project.org/web/packages/india/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/india/DESCRIPTION` at `2026-09-14T03:21:16+00:00`.
...
- `cran_packages_by_date-d5c148e1bd5bc2` from `cran_packages_by_date` as `registry_expansion`
