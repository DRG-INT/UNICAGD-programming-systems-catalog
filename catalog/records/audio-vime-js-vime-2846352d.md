...
<!-- canonical: https://github.com/vime-js/vime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vime-js/vime](https://github.com/vime-js/vime) |
| Source record ids | github_search_audio-2d507a609bd1eb |

## System Engineer Summary

Customizable, extensible, accessible and framework agnostic media player. Modern alternative to
Video.js and Plyr. Supports HTML5, HLS, Dash, YouTube, Vimeo, Dailymotion...

## Operational Role

For a systems engineer, vime-js/vime belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-17T10:34:11Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-2d507a609bd1eb` from `github_search_audio` as `registry_expansion`
