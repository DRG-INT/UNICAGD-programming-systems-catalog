...
<!-- canonical: https://github.com/EliaTarasov/ESKF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EliaTarasov/ESKF](https://github.com/EliaTarasov/ESKF) |
| Source record ids | github_search_electromagnetoscopes-7637eaa176436d |

## System Engineer Summary

ROS Error-State Kalman Filter based on PX4/ecl. Performs GPS/Magnetometer/Vision Pose/Optical
Flow/RangeFinder fusion with IMU

## Operational Role

For a systems engineer, EliaTarasov/ESKF belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-03-01T16:27:57Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-7637eaa176436d` from `github_search_electromagnetoscopes` as `registry_expansion`
