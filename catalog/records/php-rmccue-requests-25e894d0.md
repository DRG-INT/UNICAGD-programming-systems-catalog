...
<!-- canonical: https://packagist.org/packages/rmccue/requests -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/rmccue/requests](https://packagist.org/packages/rmccue/requests) |
| Source record ids | packagist_search-8c6b0479d07f71 |
...
For a systems engineer, rmccue/requests belongs in the PHP inventory as part of service
...
- `packagist_search-8c6b0479d07f71` from `packagist_search` as `registry_expansion`
