...
<!-- canonical: https://github.com/jessesquires/JSQMessagesViewController -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jessesquires/JSQMessagesViewController](https://github.com/jessesquires/JSQMessagesViewController) |
| Source record ids | github_search_cocoa-27d7ccc3988eaf |
...
For a systems engineer, jessesquires/JSQMessagesViewController belongs in the Cocoa inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-12T10:45:39Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-27d7ccc3988eaf` from `github_search_cocoa` as `registry_expansion`
