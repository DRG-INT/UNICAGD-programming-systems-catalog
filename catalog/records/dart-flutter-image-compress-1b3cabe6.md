...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/flutter_image_compress -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_image_compress](https://pub.dev/packages/flutter_image_compress) |
| Source record ids | pub_dev-4a30ea7409600e |
...
For a systems engineer, flutter_image_compress belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.1 | 2026-07-25T13:02:06.533259Z | [https://pub.dev/api/packages/flutter_image_compress](https://pub.dev/api/packages/flutter_image_compress) |  |
| preview | known | 1.0.0-nullsafety | 2021-02-26T00:34:44.369188Z | [https://pub.dev/api/packages/flutter_image_compress](https://pub.dev/api/packages/flutter_image_compress) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_image_compress` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-4a30ea7409600e` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| flutter_archive | Compression | [open](dart-flutter-archive-76cccd83.md) |
