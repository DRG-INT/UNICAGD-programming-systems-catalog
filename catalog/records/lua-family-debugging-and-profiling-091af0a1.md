...
| Source record ids | lua-source-12 |

## System Engineer Summary

Debugging and Profiling is tracked as a debugger record in the Lua family branch. The source did not
...
For a systems engineer, Debugging and Profiling belongs in the Lua family inventory as part of fault
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 12}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-12` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| BetterPrint | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-betterprint-3eee7be1.md) |
| cartesix | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cartesix-d3a28b06.md) |
| debug.lua | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-debug-lua-ee19d77c.md) |
| debugger.lua | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-debugger-lua-35c1fc29.md) |
| dprint | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dprint-e88fde94.md) |
| dumper | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dumper-6db95530.md) |
| feather | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-feather-ca265c71.md) |
| icecream | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-icecream-3fa53c2a.md) |
