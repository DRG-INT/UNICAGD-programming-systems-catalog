...
<!-- canonical: https://github.com/bestxtools/weekly-cn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bestxtools/weekly-cn](https://github.com/bestxtools/weekly-cn) |
| Source record ids | github_search_magazines-3be61401681a2b |
...
For a systems engineer, bestxtools/weekly-cn belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-21T00:39:48Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-3be61401681a2b` from `github_search_magazines` as `registry_expansion`
