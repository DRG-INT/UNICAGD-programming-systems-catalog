...
<!-- canonical: https://crates.io/crates/matches -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/matches](https://crates.io/crates/matches) |
| Source record ids | crates_io-ecad4a97cfad44 |
...
For a systems engineer, matches belongs in the Rust inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.10 | 2023-01-21T21:21:50.529117Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-ecad4a97cfad44` from `crates_io` as `registry_expansion`
