...
<!-- canonical: https://gnu-octave.github.io/packages/octave_ffmpeg_free -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/octave_ffmpeg_free](https://gnu-octave.github.io/packages/octave_ffmpeg_free) |
| Source record ids | octave_packages_index-e6b80c0e69c5aa |

## System Engineer Summary

The octave_ffmpeg_free package provides a comprehensive multimedia processing toolkit for GNU
Octave, based on FFmpeg-free libraries.

## Operational Role

For a systems engineer, octave_ffmpeg_free belongs in the Octave inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-18 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-e6b80c0e69c5aa` from `octave_packages_index` as `registry_expansion`
