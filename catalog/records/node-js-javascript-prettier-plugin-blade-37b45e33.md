...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Project Scaffolding](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/project-scaffolding.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/prettier-plugin-blade](https://www.npmjs.com/package/prettier-plugin-blade) |
| Source record ids | npm_registry-aed1bcb57d3105 |
...
For a systems engineer, prettier-plugin-blade belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2026-08-22T22:32:07.779Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Treat category as `project_scaffolding` unless a later verified source gives a better classification.
...
| Name | Category | Page |
| --- | --- | --- |
| @angular-eslint/eslint-plugin-template | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-eslint-plugin-template-d5aff193.md) |
| @angular-eslint/template-parser | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-template-parser-216f6614.md) |
| @e2b/cli | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-e2b-cli-0629f4ac.md) |
| @iarna/cli | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-iarna-cli-842a2184.md) |
| ember-template-lint-plugin-prettier | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-ember-template-lint-plugin-prettier-5949dca3.md) |
| prettier-edge | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-prettier-edge-9655acd4.md) |
| prettier-html-templates | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-prettier-html-templates-5c8f2937.md) |
| prettier-plugin-ember-template-tag | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-prettier-plugin-ember-template-tag-78f38bc8.md) |
