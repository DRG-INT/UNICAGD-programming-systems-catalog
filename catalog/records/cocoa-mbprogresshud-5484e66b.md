...
<!-- canonical: https://cocoapods.org/pods/MBProgressHUD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/MBProgressHUD](https://cocoapods.org/pods/MBProgressHUD) |
| Source record ids | cocoapods_cdn-96340248eee637 |
...
For a systems engineer, MBProgressHUD belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2020-01-13 21:47:56 UTC | [https://trunk.cocoapods.org/api/v1/pods/MBProgressHUD](https://trunk.cocoapods.org/api/v1/pods/MBProgressHUD) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/MBProgressHUD` at `2026-09-01T07:21:27+00:00`.
...
- `cocoapods_cdn-96340248eee637` from `cocoapods_cdn` as `registry_expansion`
