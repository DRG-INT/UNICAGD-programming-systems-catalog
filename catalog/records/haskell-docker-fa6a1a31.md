...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Container Deployment](../by-category/container-deployment.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/docker](https://hackage.haskell.org/package/docker) |
| Source record ids | hackage_top_downloads-497f041509e7f7 |
...
For a systems engineer, docker belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.1 | 2022-06-17T18:48:58Z | [https://hackage.haskell.org/package/docker](https://hackage.haskell.org/package/docker) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/docker` at `2026-09-02T00:32:33+00:00`.
...
- `hackage_top_downloads-497f041509e7f7` from `hackage_top_downloads` as `registry_expansion`
