...
<!-- canonical: https://cran.r-project.org/web/packages/safetensors/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/safetensors/index.html](https://cran.r-project.org/web/packages/safetensors/index.html) |
| Source record ids | cran_packages_by_date-ed6533cd681fd8 |

## System Engineer Summary

safetensors is tracked as a formatter record in the R branch. The source did not provide a long
...
For a systems engineer, safetensors belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21 22:10:02 UTC | [https://cran.r-project.org/web/packages/safetensors/DESCRIPTION](https://cran.r-project.org/web/packages/safetensors/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/safetensors/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ed6533cd681fd8` from `cran_packages_by_date` as `registry_expansion`
