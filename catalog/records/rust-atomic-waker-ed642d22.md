...
<!-- canonical: https://crates.io/crates/atomic-waker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/atomic-waker](https://crates.io/crates/atomic-waker) |
| Source record ids | crates_io-cc11a7a87d4642 |
...
For a systems engineer, atomic-waker belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2023-09-25T17:45:09.388277Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-cc11a7a87d4642` from `crates_io` as `registry_expansion`
