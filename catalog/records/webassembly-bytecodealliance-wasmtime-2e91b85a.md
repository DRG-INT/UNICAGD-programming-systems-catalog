...
| Source record ids | github_search_webassembly-5cdcaac31a0d78 |
...
For a systems engineer, bytecodealliance/wasmtime belongs in the WebAssembly inventory as part of
...
- Latest stable metadata was observed from `https://api.github.com/repos/bytecodealliance/wasmtime/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-5cdcaac31a0d78` from `github_search_webassembly` as `registry_expansion`
