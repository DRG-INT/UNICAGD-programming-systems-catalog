...
| Canonical URL | [https://tortoisesvn.net/](https://tortoisesvn.net/) |
| Source record ids | curated_repository_workplace_routes-0e381a60a32271 |

## System Engineer Summary

Windows shell integration client for Apache Subversion repositories and working copies.

## Operational Role

For a systems engineer, TortoiseSVN belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-0e381a60a32271` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| GitHub Codespaces | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-github-codespaces-f941dff2.md) |
