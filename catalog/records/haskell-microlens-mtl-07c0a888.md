...
<!-- canonical: https://hackage.haskell.org/package/microlens-mtl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/microlens-mtl](https://hackage.haskell.org/package/microlens-mtl) |
| Source record ids | hackage_top_downloads-c086307f65c909 |
...
For a systems engineer, microlens-mtl belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.1 | 2025-09-22T02:11:06Z | [https://hackage.haskell.org/package/microlens-mtl](https://hackage.haskell.org/package/microlens-mtl) |  |
| candidate | partial | 0.2.0.2 |  | [https://hackage.haskell.org/package/microlens-mtl](https://hackage.haskell.org/package/microlens-mtl) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/microlens-mtl` at `2026-09-02T00:32:45+00:00`.
...
- `hackage_top_downloads-c086307f65c909` from `hackage_top_downloads` as `registry_expansion`
