...
<!-- canonical: https://crates.io/crates/futures-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-macro](https://crates.io/crates/futures-macro) |
| Source record ids | crates_io-e48ed112a621f8 |
...
For a systems engineer, futures-macro belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:14.842510Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-e48ed112a621f8` from `crates_io` as `registry_expansion`
