...
<!-- canonical: https://cran.r-project.org/web/packages/gsaot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gsaot/index.html](https://cran.r-project.org/web/packages/gsaot/index.html) |
| Source record ids | cran_packages_by_date-4f77c6166ebffe |
...
For a systems engineer, gsaot belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-09 11:00:02 UTC | [https://cran.r-project.org/web/packages/gsaot/DESCRIPTION](https://cran.r-project.org/web/packages/gsaot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gsaot/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-4f77c6166ebffe` from `cran_packages_by_date` as `registry_expansion`
