...
<!-- canonical: https://github.com/neon-age/AmplifyOcclusion-URP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neon-age/AmplifyOcclusion-URP](https://github.com/neon-age/AmplifyOcclusion-URP) |
| Source record ids | github_search_effects-cbd93a2368ec0b |
...
For a systems engineer, neon-age/AmplifyOcclusion-URP belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-28T22:46:21Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-cbd93a2368ec0b` from `github_search_effects` as `registry_expansion`
