...
<!-- canonical: https://cran.r-project.org/web/packages/cdcanthro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cdcanthro/index.html](https://cran.r-project.org/web/packages/cdcanthro/index.html) |
| Source record ids | cran_packages_by_date-776122c72b6841 |

## System Engineer Summary

Standardized Metrics Based on the CDC and WHO Growth Charts

## Operational Role

For a systems engineer, cdcanthro belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-31 15:20:03 UTC | [https://cran.r-project.org/web/packages/cdcanthro/DESCRIPTION](https://cran.r-project.org/web/packages/cdcanthro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cdcanthro/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-776122c72b6841` from `cran_packages_by_date` as `registry_expansion`
