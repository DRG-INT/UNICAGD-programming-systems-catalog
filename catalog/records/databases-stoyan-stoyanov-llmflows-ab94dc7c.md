...
<!-- canonical: https://github.com/stoyan-stoyanov/llmflows -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stoyan-stoyanov/llmflows](https://github.com/stoyan-stoyanov/llmflows) |
| Source record ids | github_search_databases-b904b9fea37659 |
...
For a systems engineer, stoyan-stoyanov/llmflows belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-20T16:53:45Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b904b9fea37659` from `github_search_databases` as `registry_expansion`
