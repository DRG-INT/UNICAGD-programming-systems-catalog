# ADSWNJ/RV_Orientation

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ADSWNJ/RV_Orientation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ADSWNJ/RV_Orientation](https://github.com/ADSWNJ/RV_Orientation) |
| Source record ids | github_search_space_shuttles-50a04c72e3137c |

## System Engineer Summary

RV Orientation: Orbiter Space Flight Simulator Open Source MFD add on for doing precision rendezvous
operations

## Operational Role

For a systems engineer, ADSWNJ/RV_Orientation belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-11T14:41:49Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_shuttles-50a04c72e3137c` from `github_search_space_shuttles` as `registry_expansion`
