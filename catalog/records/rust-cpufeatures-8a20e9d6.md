...
<!-- canonical: https://crates.io/crates/cpufeatures -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cpufeatures](https://crates.io/crates/cpufeatures) |
| Source record ids | crates_io-c48bab49dba8b4 |

## System Engineer Summary

Lightweight runtime CPU feature detection for aarch64, loongarch64, and x86/x86_64 targets, with
no_std support and support for mobile targets including Android and iOS

## Operational Role

For a systems engineer, cpufeatures belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-26T18:40:04.110390Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-c48bab49dba8b4` from `crates_io` as `registry_expansion`
