...
<!-- canonical: https://cran.r-project.org/web/packages/mpshock/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mpshock/index.html](https://cran.r-project.org/web/packages/mpshock/index.html) |
| Source record ids | cran_packages_by_date-b327c2de452e50 |
...
For a systems engineer, mpshock belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-08 09:30:02 UTC | [https://cran.r-project.org/web/packages/mpshock/DESCRIPTION](https://cran.r-project.org/web/packages/mpshock/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mpshock/DESCRIPTION` at `2026-09-08T10:21:44+00:00`.
...
- `cran_packages_by_date-b327c2de452e50` from `cran_packages_by_date` as `registry_expansion`
