...
<!-- canonical: https://packagist.org/packages/paragonie/ciphersweet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/paragonie/ciphersweet](https://packagist.org/packages/paragonie/ciphersweet) |
| Source record ids | packagist_search-6a7353e35f0949 |
...
For a systems engineer, paragonie/ciphersweet belongs in the PHP inventory as part of state
...
- `packagist_search-6a7353e35f0949` from `packagist_search` as `registry_expansion`
