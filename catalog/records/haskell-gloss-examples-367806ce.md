...
<!-- canonical: https://hackage.haskell.org/package/gloss-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gloss-examples](https://hackage.haskell.org/package/gloss-examples) |
| Source record ids | hackage_top_downloads-cf60cbd415c03f |
...
For a systems engineer, gloss-examples belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.0.4 | 2022-03-20T08:45:24Z | [https://hackage.haskell.org/package/gloss-examples](https://hackage.haskell.org/package/gloss-examples) |  |
| candidate | partial | 1.13.0.3 |  | [https://hackage.haskell.org/package/gloss-examples](https://hackage.haskell.org/package/gloss-examples) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gloss-examples` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-cf60cbd415c03f` from `hackage_top_downloads` as `registry_expansion`
