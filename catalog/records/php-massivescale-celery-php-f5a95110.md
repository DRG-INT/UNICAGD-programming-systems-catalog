...
<!-- canonical: https://packagist.org/packages/massivescale/celery-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/massivescale/celery-php](https://packagist.org/packages/massivescale/celery-php) |
| Source record ids | packagist_search-83d5cc2caf7e20 |
...
For a systems engineer, massivescale/celery-php belongs in the PHP inventory as part of service
...
- `packagist_search-83d5cc2caf7e20` from `packagist_search` as `registry_expansion`
