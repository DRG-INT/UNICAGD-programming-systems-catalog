...
<!-- canonical: https://github.com/jnicol/particleground -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jnicol/particleground](https://github.com/jnicol/particleground) |
| Source record ids | github_search_effects-f826e89b079d2d |
...
For a systems engineer, jnicol/particleground belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-01-29T04:33:31Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f826e89b079d2d` from `github_search_effects` as `registry_expansion`
