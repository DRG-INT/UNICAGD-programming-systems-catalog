...
<!-- canonical: https://github.com/apache/rocketmq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/rocketmq](https://github.com/apache/rocketmq) |
| Source record ids | github_search_video-fbfe87d997b376 |

## System Engineer Summary

Apache RocketMQ is a cloud native messaging and streaming platform, making it simple to build event-
driven applications.

## Operational Role

For a systems engineer, apache/rocketmq belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T07:17:02Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-fbfe87d997b376` from `github_search_video` as `registry_expansion`
