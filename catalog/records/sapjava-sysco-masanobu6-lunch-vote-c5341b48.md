# sysco-masanobu6/lunch-vote

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sysco-masanobu6/lunch-vote -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sysco-masanobu6/lunch-vote](https://github.com/sysco-masanobu6/lunch-vote) |
| Source record ids | github_search_sapjava-43f9ca9a88460a |

## System Engineer Summary

SAP BTP CAP Java lunch voting app - dev to CI/CD deploy practice

## Operational Role

For a systems engineer, sysco-masanobu6/lunch-vote belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T14:07:38Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
| Alert | Backup plan required before embedding, redistributing, or modifying architecture around this dependency. |

## Engineering Notes

- Treat category as `sanitizer` unless a later verified source gives a better classification.
...
- `github_search_sapjava-43f9ca9a88460a` from `github_search_sapjava` as `registry_expansion`
