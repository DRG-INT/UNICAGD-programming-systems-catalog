...
<!-- canonical: https://cran.r-project.org/web/packages/finlex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/finlex/index.html](https://cran.r-project.org/web/packages/finlex/index.html) |
| Source record ids | cran_packages_by_date-a8b2b8f1eff08d |

## System Engineer Summary

Access Open Data from the Finnish 'Finlex' Legislative Database

## Operational Role

For a systems engineer, finlex belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-25 22:10:07 UTC | [https://cran.r-project.org/web/packages/finlex/DESCRIPTION](https://cran.r-project.org/web/packages/finlex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/finlex/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a8b2b8f1eff08d` from `cran_packages_by_date` as `registry_expansion`
