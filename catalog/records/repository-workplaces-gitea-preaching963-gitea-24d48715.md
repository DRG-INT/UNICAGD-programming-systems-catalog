...
<!-- canonical: https://gitea.com/preaching963/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/preaching963/gitea](https://gitea.com/preaching963/gitea) |
| Source record ids | gitea_repositories_api-b14ab440c895d1 |

## System Engineer Summary

Git with a cup of tea! Painless self-hosted all-in-one software development service, including Git
hosting, code review, team collaboration, package registry and CI/CD

## Operational Role

For a systems engineer, Gitea: preaching963/gitea belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-17T15:09:33Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-b14ab440c895d1` from `gitea_repositories_api` as `registry_expansion`
