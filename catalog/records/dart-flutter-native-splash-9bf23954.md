...
<!-- canonical: https://pub.dev/packages/flutter_native_splash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_native_splash](https://pub.dev/packages/flutter_native_splash) |
| Source record ids | pub_dev-24300b37924b5e |
...
For a systems engineer, flutter_native_splash belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.8 | 2026-05-29T20:03:33.749162Z | [https://pub.dev/api/packages/flutter_native_splash](https://pub.dev/api/packages/flutter_native_splash) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_native_splash` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-24300b37924b5e` from `pub_dev` as `registry_expansion`
