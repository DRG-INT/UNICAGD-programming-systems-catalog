...
<!-- canonical: https://github.com/skipperbent/simple-php-router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skipperbent/simple-php-router](https://github.com/skipperbent/simple-php-router) |
| Source record ids | github_search_maps-32799cbb719c66 |

## System Engineer Summary

Simple, fast and yet powerful PHP router that is easy to get integrated and in any project. Heavily
inspired by the way Laravel handles routing, with both simplicity and expand-ability in mind.

## Operational Role

For a systems engineer, skipperbent/simple-php-router belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-10T22:20:16Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-32799cbb719c66` from `github_search_maps` as `registry_expansion`
