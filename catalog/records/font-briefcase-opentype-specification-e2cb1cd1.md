...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Font Briefcase](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/font-briefcase.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://learn.microsoft.com/typography/opentype/spec/](https://learn.microsoft.com/typography/opentype/spec/) |
| Source record ids | curated_language_routes-c758f230438c1b |

## System Engineer Summary

OpenType font format specification route for glyphs, tables, layout, variable fonts, metadata, and
renderer compatibility.

## Operational Role

For a systems engineer, OpenType Specification belongs in the Font Briefcase inventory as part of
...
- `curated_language_routes-c758f230438c1b` from `curated_language_routes` as `registry_expansion`
