...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stackql/stackql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stackql/stackql](https://github.com/stackql/stackql) |
| Source record ids | github_search_assets-4797ca2fa7901f |

## System Engineer Summary

Query, provision and operate Cloud, SaaS, API and Model Context Protocol (MCP) resources through a
unified SQL-based framework for humans and AI agents.

## Operational Role

For a systems engineer, stackql/stackql belongs in the Assets inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:28:01Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-4797ca2fa7901f` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AWS S3 | Database Datastore | [open](assets-aws-s3-71b62ee1.md) |
| Cloudflare R2 | Database Datastore | [open](assets-cloudflare-r2-5b3731f1.md) |
