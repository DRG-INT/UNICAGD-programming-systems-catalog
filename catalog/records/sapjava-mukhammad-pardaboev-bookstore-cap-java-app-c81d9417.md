# mukhammad-pardaboev/bookstore-cap-java-app

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mukhammad-pardaboev/bookstore-cap-java-app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mukhammad-pardaboev/bookstore-cap-java-app](https://github.com/mukhammad-pardaboev/bookstore-cap-java-app) |
| Source record ids | github_search_sapjava-35a6dfec32f3f9 |

## System Engineer Summary

SAP Cap Java Application

## Operational Role

For a systems engineer, mukhammad-pardaboev/bookstore-cap-java-app belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-02T02:22:30Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-35a6dfec32f3f9` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bemariantony/bm-cap-workout | Tutorial Book Styleguide | [open](sapjava-bemariantony-bm-cap-workout-b007c998.md) |
| Linda-DE/sap-cap-bookshop-java | Tutorial Book Styleguide | [open](sapjava-linda-de-sap-cap-bookshop-java-5217673c.md) |
