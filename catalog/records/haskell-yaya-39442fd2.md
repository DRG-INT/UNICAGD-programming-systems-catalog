...
<!-- canonical: https://hackage.haskell.org/package/yaya -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yaya](https://hackage.haskell.org/package/yaya) |
| Source record ids | hackage_top_downloads-ad54f2b4ceda3e |
...
For a systems engineer, yaya belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.0 | 2026-04-30T12:47:27Z | [https://hackage.haskell.org/package/yaya](https://hackage.haskell.org/package/yaya) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yaya` at `2026-09-12T00:29:36+00:00`.
...
- `hackage_top_downloads-ad54f2b4ceda3e` from `hackage_top_downloads` as `registry_expansion`
