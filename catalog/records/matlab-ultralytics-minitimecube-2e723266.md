...
<!-- canonical: https://github.com/ultralytics/miniTimeCube -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ultralytics/miniTimeCube](https://github.com/ultralytics/miniTimeCube) |
| Source record ids | github_search_matlab-89be44cfb0883b |

## System Engineer Summary

MATLAB simulation, signal-processing, visualization, and analysis tools for the miniTimeCube compact
neutrino and particle detector.

## Operational Role

For a systems engineer, ultralytics/miniTimeCube belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T10:39:24Z | gh search repos language:MATLAB topic:signal-processing | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_matlab-89be44cfb0883b` from `github_search_matlab` as `registry_expansion`
