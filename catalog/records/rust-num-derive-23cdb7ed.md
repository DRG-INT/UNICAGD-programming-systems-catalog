...
<!-- canonical: https://crates.io/crates/num-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-derive](https://crates.io/crates/num-derive) |
| Source record ids | crates_io-3efb0666d9af2a |
...
For a systems engineer, num-derive belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-07-21T00:49:03.392741Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-3efb0666d9af2a` from `crates_io` as `registry_expansion`
