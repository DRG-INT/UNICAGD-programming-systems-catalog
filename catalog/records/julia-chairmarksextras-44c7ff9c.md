...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChairmarksExtras](https://github.com/JuliaRegistries/General/tree/master/C/ChairmarksExtras) |
| Source record ids | julia_general-d393e575136f84 |

## System Engineer Summary

Julia package registered in General at C/ChairmarksExtras.

## Operational Role

For a systems engineer, ChairmarksExtras belongs in the Julia inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChairmarksExtras", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d393e575136f84` from `julia_general` as `registry_expansion`
