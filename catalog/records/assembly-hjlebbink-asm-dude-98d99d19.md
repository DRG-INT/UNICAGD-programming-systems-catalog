...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/HJLebbink/asm-dude](https://github.com/HJLebbink/asm-dude) |
| Source record ids | github_search_assembly-3e7848e8f58375 |

## System Engineer Summary

Visual Studio extension for assembly syntax highlighting and code completion in assembly files and
the disassembly window

## Operational Role

For a systems engineer, HJLebbink/asm-dude belongs in the Assembly inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.1.0 | 2024-02-11T22:30:25Z | [https://api.github.com/repos/HJLebbink/asm-dude/releases/latest](https://api.github.com/repos/HJLebbink/asm-dude/releases/latest) |  |
| preview | known | 1.9.6.1 | 2019-01-08T14:46:14Z | [https://api.github.com/repos/HJLebbink/asm-dude/releases?per_page=10](https://api.github.com/repos/HJLebbink/asm-dude/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/HJLebbink/asm-dude/releases/latest` at `2026-09-01T07:24:26+00:00`.
...
- `github_search_assembly-3e7848e8f58375` from `github_search_assembly` as `registry_expansion`
