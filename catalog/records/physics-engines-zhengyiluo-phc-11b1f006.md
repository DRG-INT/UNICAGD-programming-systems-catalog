...
<!-- canonical: https://github.com/ZhengyiLuo/PHC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZhengyiLuo/PHC](https://github.com/ZhengyiLuo/PHC) |
| Source record ids | github_search_physics_engines-25898c9f703acf |

## System Engineer Summary

Official Implementation of the ICCV 2023 paper: Perpetual Humanoid Control for Real-time Simulated
Avatars

## Operational Role

For a systems engineer, ZhengyiLuo/PHC belongs in the Physics Engines inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-21T18:34:47Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-25898c9f703acf` from `github_search_physics_engines` as `registry_expansion`
