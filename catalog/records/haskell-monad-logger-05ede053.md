...
<!-- canonical: https://hackage.haskell.org/package/monad-logger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/monad-logger](https://hackage.haskell.org/package/monad-logger) |
| Source record ids | hackage_top_downloads-1ebe34887af132 |
...
For a systems engineer, monad-logger belongs in the Haskell inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.42 | 2025-03-10T08:59:44Z | [https://hackage.haskell.org/package/monad-logger](https://hackage.haskell.org/package/monad-logger) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/monad-logger` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-1ebe34887af132` from `hackage_top_downloads` as `registry_expansion`
