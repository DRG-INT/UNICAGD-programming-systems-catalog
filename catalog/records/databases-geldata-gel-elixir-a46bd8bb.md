...
<!-- canonical: https://github.com/geldata/gel-elixir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geldata/gel-elixir](https://github.com/geldata/gel-elixir) |
| Source record ids | github_search_databases-9995646ea52a9e |

## System Engineer Summary

geldata/gel-elixir is tracked as a networking http record in the Databases branch. The source did
...
For a systems engineer, geldata/gel-elixir belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-20T22:42:45Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9995646ea52a9e` from `github_search_databases` as `registry_expansion`
