...
<!-- canonical: https://crates.io/crates/version_check -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/version_check](https://crates.io/crates/version_check) |
| Source record ids | crates_io-12a02a507285cd |
...
For a systems engineer, version_check belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.5 | 2024-07-25T23:38:14.142737Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-12a02a507285cd` from `crates_io` as `registry_expansion`
