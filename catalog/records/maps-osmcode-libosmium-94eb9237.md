...
<!-- canonical: https://github.com/osmcode/libosmium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osmcode/libosmium](https://github.com/osmcode/libosmium) |
| Source record ids | github_search_maps-9eccb6a0634f0c |
...
For a systems engineer, osmcode/libosmium belongs in the Maps inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:38:44Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9eccb6a0634f0c` from `github_search_maps` as `registry_expansion`
