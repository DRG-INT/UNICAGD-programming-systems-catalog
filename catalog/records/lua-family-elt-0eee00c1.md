...
| Canonical URL | [https://luarocks.org/modules/suy/elt](https://luarocks.org/modules/suy/elt) |
| Source record ids | luarocks_root_manifest-35b02c2f246884 |

## System Engineer Summary

Embedded Lua Templates. A template engine for writing templates in Lua

## Operational Role

For a systems engineer, elt belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| ahoicpp.nvim | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ahoicpp-nvim-79d7628d.md) |
| awesome-battery_widget | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-battery-widget-312b0944.md) |
| base.nvim | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-base-nvim-dacffc71.md) |
| ci-template.nvim | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ci-template-nvim-6912313f.md) |
| Cosmo | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cosmo-81a1e0fd.md) |
| daemonparts | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-daemonparts-efd4b03f.md) |
| etlua | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-etlua-c0c05473.md) |
| gimlet-render | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gimlet-render-a5d799e1.md) |
