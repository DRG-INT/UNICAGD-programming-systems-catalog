...
| Canonical URL | [https://crates.io/crates/xmlwriter](https://crates.io/crates/xmlwriter) |
| Source record ids | crates_io-65e4186cd1b2fd |
...
For a systems engineer, xmlwriter belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2019-08-12T05:28:56.283266Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-65e4186cd1b2fd` from `crates_io` as `registry_expansion`
