# jonasrmichel/radio-garden-go

## Navigation

[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/jonasrmichel/radio-garden-go](https://github.com/jonasrmichel/radio-garden-go) |
| Source record ids | curated_language_routes-ed751dc183ed7e |

## System Engineer Summary

Apache-2.0 Go client and command-line application for the Radio Garden API; installable with Go
tooling.

## Operational Role

For a systems engineer, jonasrmichel/radio-garden-go belongs in the Radio Garden Speciality
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.0 | 2021-12-30T20:52:49Z | [https://api.github.com/repos/jonasrmichel/radio-garden-go/releases/latest](https://api.github.com/repos/jonasrmichel/radio-garden-go/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jonasrmichel/radio-garden-go/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-ed751dc183ed7e` from `curated_language_routes` as `registry_expansion`
