...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/mindsphere/devops-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/mindsphere/devops-demo](https://gitlab.com/mindsphere/devops-demo) |
| Source record ids | gitlab_projects_api-a196fc2b733551 |

## System Engineer Summary

DevOps demo code demonstrated during MindSphere Developer Days in Berlin.

## Operational Role

For a systems engineer, mindsphere/devops-demo belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-21T18:21:05.175Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-a196fc2b733551` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: noWie2k/basicImageDeepfakeDetector | Image Audio Dsp | [open](repository-workplaces-gitea-nowie2k-basicimagedeepfakedetector-b8c1af97.md) |
