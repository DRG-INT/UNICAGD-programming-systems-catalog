...
| Canonical URL | [https://luarocks.org/modules/ryanford/jsmin](https://luarocks.org/modules/ryanford/jsmin) |
| Source record ids | luarocks_root_manifest-6af0f16fb20b1f |

## System Engineer Summary

jsmin is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, jsmin belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6af0f16fb20b1f` from `luarocks_root_manifest` as `registry_expansion`
