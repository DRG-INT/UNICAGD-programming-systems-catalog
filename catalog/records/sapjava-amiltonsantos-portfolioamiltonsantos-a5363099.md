# AmiltonSantos/portfolioAmiltonSantos

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AmiltonSantos/portfolioAmiltonSantos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AmiltonSantos/portfolioAmiltonSantos](https://github.com/AmiltonSantos/portfolioAmiltonSantos) |
| Source record ids | github_search_sapjava-f4efdee97fbd03 |

## System Engineer Summary

Oi meu nome é Amilton Santos, trabalho como Desenvolvedor Mobile | Ionic | Angular | Java - Spring
Boot | Typescript | JavaScript | ETL Talend | SQLite | PostgreSQL | SQL Server | Oracle 12c R2 | SAP
HANA

## Operational Role

For a systems engineer, AmiltonSantos/portfolioAmiltonSantos belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-26T11:49:43Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_sapjava-f4efdee97fbd03` from `github_search_sapjava` as `registry_expansion`
