...
<!-- canonical: https://github.com/Loyalsoldier/surge-rules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Loyalsoldier/surge-rules](https://github.com/Loyalsoldier/surge-rules) |
| Source record ids | github_search_maps-19462d065d44ba |
...
For a systems engineer, Loyalsoldier/surge-rules belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 202609010120 | 2026-09-01T01:20:32Z | [https://api.github.com/repos/Loyalsoldier/surge-rules/releases/latest](https://api.github.com/repos/Loyalsoldier/surge-rules/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Loyalsoldier/surge-rules/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-19462d065d44ba` from `github_search_maps` as `registry_expansion`
