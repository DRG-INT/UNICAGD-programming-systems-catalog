...
<!-- canonical: https://github.com/strongbox-password-safe/Strongbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/strongbox-password-safe/Strongbox](https://github.com/strongbox-password-safe/Strongbox) |
| Source record ids | github_search_cocoa-0dbf97529d8dc9 |
...
For a systems engineer, strongbox-password-safe/Strongbox belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-17T14:03:41Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0dbf97529d8dc9` from `github_search_cocoa` as `registry_expansion`
