...
<!-- canonical: https://crates.io/crates/aws-lc-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-lc-rs](https://crates.io/crates/aws-lc-rs) |
| Source record ids | crates_io-89a95a5d844e28 |

## System Engineer Summary

aws-lc-rs is a cryptographic library using AWS-LC for its cryptographic operations. This library
strives to be API-compatible with the popular Rust library named ring.

## Operational Role

For a systems engineer, aws-lc-rs belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.18.1 | 2026-09-01T20:08:57.927841Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-07T00:31:28+00:00`.
...
- `crates_io-89a95a5d844e28` from `crates_io` as `registry_expansion`
