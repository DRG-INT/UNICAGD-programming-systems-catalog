...
<!-- canonical: https://github.com/Netflix/maestro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Netflix/maestro](https://github.com/Netflix/maestro) |
| Source record ids | github_search_engines-3643c016cae998 |
...
For a systems engineer, Netflix/maestro belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:20:59Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-3643c016cae998` from `github_search_engines` as `registry_expansion`
