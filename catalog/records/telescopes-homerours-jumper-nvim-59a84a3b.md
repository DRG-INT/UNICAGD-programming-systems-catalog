...
<!-- canonical: https://github.com/homerours/jumper.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/homerours/jumper.nvim](https://github.com/homerours/jumper.nvim) |
| Source record ids | github_search_telescopes-44abfd770ebaad |

## System Engineer Summary

A Neovim plugin for jumper, to jump efficiently to files and folders.

## Operational Role

For a systems engineer, homerours/jumper.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-10T23:59:20Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-44abfd770ebaad` from `github_search_telescopes` as `registry_expansion`
