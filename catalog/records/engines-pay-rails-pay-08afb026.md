...
<!-- canonical: https://github.com/pay-rails/pay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pay-rails/pay](https://github.com/pay-rails/pay) |
| Source record ids | github_search_engines-3c266d48a11425 |
...
For a systems engineer, pay-rails/pay belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T13:26:36Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-3c266d48a11425` from `github_search_engines` as `registry_expansion`
