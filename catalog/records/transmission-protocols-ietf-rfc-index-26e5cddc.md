...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Transmission Protocols](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/transmission-protocols.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.rfc-editor.org/rfc-index.html](https://www.rfc-editor.org/rfc-index.html) |
| Source record ids | curated_language_routes-e2d489b95a5420 |

## System Engineer Summary

Authoritative route to Internet protocol standards, best current practices, and operational
specifications.

## Operational Role

For a systems engineer, IETF RFC Index belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-e2d489b95a5420` from `curated_language_routes` as `registry_expansion`
