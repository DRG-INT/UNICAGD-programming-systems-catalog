...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaAtmos](https://github.com/JuliaRegistries/General/tree/master/C/ClimaAtmos) |
| Source record ids | julia_general-63a703645bd6c5 |

## System Engineer Summary

Julia package registered in General at C/ClimaAtmos.

## Operational Role

For a systems engineer, ClimaAtmos belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaAtmos", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-63a703645bd6c5` from `julia_general` as `registry_expansion`
