...
<!-- canonical: https://luarocks.org/modules/geoffleyland/dbf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/geoffleyland/dbf](https://luarocks.org/modules/geoffleyland/dbf) |
| Source record ids | luarocks_root_manifest-7e0c1e7057669f |

## System Engineer Summary

dbf is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, dbf belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7e0c1e7057669f` from `luarocks_root_manifest` as `registry_expansion`
