...
<!-- canonical: https://cran.r-project.org/web/packages/phontrast/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/phontrast/index.html](https://cran.r-project.org/web/packages/phontrast/index.html) |
| Source record ids | cran_packages_by_date-061fd65a4c7e27 |

## System Engineer Summary

Contrast and Separation Metrics for Phonological Categories

## Operational Role

For a systems engineer, phontrast belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.1 | 2026-09-01 07:50:02 UTC | [https://cran.r-project.org/web/packages/phontrast/DESCRIPTION](https://cran.r-project.org/web/packages/phontrast/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/phontrast/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-061fd65a4c7e27` from `cran_packages_by_date` as `registry_expansion`
