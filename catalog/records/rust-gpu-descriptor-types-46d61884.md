...
| Canonical URL | [https://crates.io/crates/gpu-descriptor-types](https://crates.io/crates/gpu-descriptor-types) |
| Source record ids | crates_io-eef4995bdee7e6 |
...
For a systems engineer, gpu-descriptor-types belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2024-04-09T19:58:06.565965Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-eef4995bdee7e6` from `crates_io` as `registry_expansion`
