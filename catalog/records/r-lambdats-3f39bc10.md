...
<!-- canonical: https://cran.r-project.org/web/packages/lambdaTS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lambdaTS/index.html](https://cran.r-project.org/web/packages/lambdaTS/index.html) |
| Source record ids | cran_packages_by_date-e773651d59dea9 |
...
For a systems engineer, lambdaTS belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-07 09:00:02 UTC | [https://cran.r-project.org/web/packages/lambdaTS/DESCRIPTION](https://cran.r-project.org/web/packages/lambdaTS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lambdaTS/DESCRIPTION` at `2026-09-07T10:20:49+00:00`.
...
- `cran_packages_by_date-e773651d59dea9` from `cran_packages_by_date` as `registry_expansion`
