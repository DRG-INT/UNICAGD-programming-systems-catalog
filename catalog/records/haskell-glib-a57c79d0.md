...
<!-- canonical: https://hackage.haskell.org/package/glib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/glib](https://hackage.haskell.org/package/glib) |
| Source record ids | hackage_top_downloads-fe016bd30d7e50 |
...
For a systems engineer, glib belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.12.0 | 2025-03-20T08:44:19Z | [https://hackage.haskell.org/package/glib](https://hackage.haskell.org/package/glib) |  |
| candidate | partial | 0.12.5.0 |  | [https://hackage.haskell.org/package/glib](https://hackage.haskell.org/package/glib) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/glib` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-fe016bd30d7e50` from `hackage_top_downloads` as `registry_expansion`
