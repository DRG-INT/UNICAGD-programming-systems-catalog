...
<!-- canonical: https://crates.io/crates/aws-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-config](https://crates.io/crates/aws-config) |
| Source record ids | crates_io-14a5f92a34d77e |
...
For a systems engineer, aws-config belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11.0 | 2026-08-20T19:11:28.242208Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-14a5f92a34d77e` from `crates_io` as `registry_expansion`
