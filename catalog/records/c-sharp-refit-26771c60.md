...
<!-- canonical: https://www.nuget.org/packages/Refit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Refit](https://www.nuget.org/packages/Refit) |
| Source record ids | nuget_search-cf91d8c89778ae |

## System Engineer Summary

Type-safe REST API clients for .NET, generated from annotated interfaces with build-time source
generation, direct request construction, System.Text.Json defaults, and support for trimming and
AOT.

## Operational Role

For a systems engineer, Refit belongs in the C-Sharp inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 15.2.0 | 2026-08-18T14:52:52.423+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit/index.json) |  |
| preview | known | 15.0.0-beta.1 | 2026-08-03T08:34:47.76+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit/index.json) |  |
...
| Evidence | Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; MIT; https://www.nuget.org/packages/Refit/15.2.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/refit/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-cf91d8c89778ae` from `nuget_search` as `registry_expansion`
...
| Nuke.Utilities.Text.Json | Build System | [open](c-sharp-nuke-utilities-text-json-fe3c821d.md) |
