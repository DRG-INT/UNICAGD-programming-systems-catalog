...
<!-- canonical: https://cran.r-project.org/web/packages/emulator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/emulator/index.html](https://cran.r-project.org/web/packages/emulator/index.html) |
| Source record ids | cran_packages_by_date-f14f6b60a7ba9e |
...
For a systems engineer, emulator belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3-0 | 2026-09-07 05:20:15 UTC | [https://cran.r-project.org/web/packages/emulator/DESCRIPTION](https://cran.r-project.org/web/packages/emulator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/emulator/DESCRIPTION` at `2026-09-07T06:28:13+00:00`.
...
- `cran_packages_by_date-f14f6b60a7ba9e` from `cran_packages_by_date` as `registry_expansion`
