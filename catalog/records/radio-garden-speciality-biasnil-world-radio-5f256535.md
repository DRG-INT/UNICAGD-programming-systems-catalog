...
<!-- canonical: https://github.com/biasnil/World_Radio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/biasnil/World_Radio](https://github.com/biasnil/World_Radio) |
| Source record ids | github_search_radio_garden_speciality-706b99e08b36de |

## System Engineer Summary

A local, radio.garden-style desktop app for browsing and playing thousands of internet radio
stations on a pannable world map, built with Python, Tkinter, and VLC.

## Operational Role

For a systems engineer, biasnil/World_Radio belongs in the Radio Garden Speciality inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T11:08:07Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-706b99e08b36de` from `github_search_radio_garden_speciality` as `registry_expansion`
