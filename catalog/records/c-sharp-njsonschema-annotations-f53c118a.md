...
<!-- canonical: https://www.nuget.org/packages/NJsonSchema.Annotations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/NJsonSchema.Annotations](https://www.nuget.org/packages/NJsonSchema.Annotations) |
| Source record ids | nuget_search-0a9d19f57be022 |
...
For a systems engineer, NJsonSchema.Annotations belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.6.1 | 2026-04-20T17:47:43.893+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/njsonschema.annotations/index.json](https://api.nuget.org/v3/registration5-gz-semver2/njsonschema.annotations/index.json) |  |
| preview | known | 11.0.0-preview008 | 2023-12-08T15:19:26.45+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/njsonschema.annotations/index.json](https://api.nuget.org/v3/registration5-gz-semver2/njsonschema.annotations/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/NJsonSchema.Annotations/11.6.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/njsonschema.annotations/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-0a9d19f57be022` from `nuget_search` as `registry_expansion`
