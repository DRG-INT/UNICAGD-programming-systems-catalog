...
| Source record ids | github_search_telescopes-f92cf253705487 |
...
For a systems engineer, dilshan/star-pointer belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2022-06-18T16:31:36Z | [https://api.github.com/repos/dilshan/star-pointer/releases/latest](https://api.github.com/repos/dilshan/star-pointer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dilshan/star-pointer/releases/latest` at `2026-09-01T11:22:14+00:00`.
...
- `github_search_telescopes-f92cf253705487` from `github_search_telescopes` as `registry_expansion`
