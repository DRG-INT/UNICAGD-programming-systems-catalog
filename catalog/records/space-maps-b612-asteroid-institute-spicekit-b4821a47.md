# B612-Asteroid-Institute/spicekit
...
<!-- canonical: https://github.com/B612-Asteroid-Institute/spicekit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/B612-Asteroid-Institute/spicekit](https://github.com/B612-Asteroid-Institute/spicekit) |
| Source record ids | github_search_space_maps-86fc53a089f4f4 |

## System Engineer Summary

Pure-Rust reader for SPICE kernel formats (DAF/SPK/PCK/text kernels) — no CSpice linkage

## Operational Role

For a systems engineer, B612-Asteroid-Institute/spicekit belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T14:26:07Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-86fc53a089f4f4` from `github_search_space_maps` as `registry_expansion`
