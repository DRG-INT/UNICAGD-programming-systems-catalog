...
<!-- canonical: https://github.com/gaolongsen/multi-panel_mujoco-pyviewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gaolongsen/multi-panel_mujoco-pyviewer](https://github.com/gaolongsen/multi-panel_mujoco-pyviewer) |
| Source record ids | github_search_physics_engines-534aecc52dcae2 |
...
For a systems engineer, gaolongsen/multi-panel_mujoco-pyviewer belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-14T05:10:30Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-534aecc52dcae2` from `github_search_physics_engines` as `registry_expansion`
