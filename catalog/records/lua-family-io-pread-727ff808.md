...
| Canonical URL | [https://luarocks.org/modules/mah0x211/io-pread](https://luarocks.org/modules/mah0x211/io-pread) |
| Source record ids | luarocks_root_manifest-6e4d3c072bbd88 |
...
For a systems engineer, io-pread belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6e4d3c072bbd88` from `luarocks_root_manifest` as `registry_expansion`
