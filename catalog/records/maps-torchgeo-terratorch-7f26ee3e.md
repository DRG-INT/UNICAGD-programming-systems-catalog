...
<!-- canonical: https://github.com/torchgeo/terratorch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/torchgeo/terratorch](https://github.com/torchgeo/terratorch) |
| Source record ids | github_search_maps-c7163654ea86d0 |
...
For a systems engineer, torchgeo/terratorch belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T13:02:45Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-c7163654ea86d0` from `github_search_maps` as `registry_expansion`
