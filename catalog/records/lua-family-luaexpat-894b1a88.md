...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://matthewwild.co.uk/projects/luaexpat/](https://matthewwild.co.uk/projects/luaexpat/) |
| Source record ids | lua-source-252 |
...
For a systems engineer, LuaExpat belongs in the Lua family inventory as part of language tooling,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 252}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-252` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| api7-lua-rapidjson | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-rapidjson-258b9fe3.md) |
| api7-lua-resty-simdjson | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-simdjson-b3d2eb2c.md) |
| APIcast | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-apicast-a4185e29.md) |
| argon | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argon-39fb2ad5.md) |
| argp | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argp-f6ff92c8.md) |
| argparse | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argparse-52341100.md) |
| argy | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argy-e8e917ea.md) |
| arrr | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-arrr-797726ad.md) |
