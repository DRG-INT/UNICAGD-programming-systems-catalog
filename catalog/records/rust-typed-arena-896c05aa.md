...
<!-- canonical: https://crates.io/crates/typed-arena -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/typed-arena](https://crates.io/crates/typed-arena) |
| Source record ids | crates_io-f19a47ff6a254b |
...
For a systems engineer, typed-arena belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2023-01-09T06:53:08.531421Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-f19a47ff6a254b` from `crates_io` as `registry_expansion`
