...
<!-- canonical: https://github.com/fernandoviton/hohmann-atlas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fernandoviton/hohmann-atlas](https://github.com/fernandoviton/hohmann-atlas) |
| Source record ids | github_search_space_maps-4e691d52dc2146 |

## System Engineer Summary

A planetary-tour mission planner that maps reachable worlds and optimal transfer routes across the
solar system

## Operational Role

For a systems engineer, fernandoviton/hohmann-atlas belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-11T18:44:33Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4e691d52dc2146` from `github_search_space_maps` as `registry_expansion`
