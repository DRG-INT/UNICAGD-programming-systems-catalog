...
<!-- canonical: https://github.com/nicklockwood/iCarousel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nicklockwood/iCarousel](https://github.com/nicklockwood/iCarousel) |
| Source record ids | github_search_cocoa-8398b48c494de4 |
...
For a systems engineer, nicklockwood/iCarousel belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-27T05:43:24Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-8398b48c494de4` from `github_search_cocoa` as `registry_expansion`
