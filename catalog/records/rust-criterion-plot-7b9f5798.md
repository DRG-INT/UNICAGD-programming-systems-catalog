...
<!-- canonical: https://crates.io/crates/criterion-plot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/criterion-plot](https://crates.io/crates/criterion-plot) |
| Source record ids | crates_io-6c5a76a6f010a5 |
...
For a systems engineer, criterion-plot belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-02-04T10:41:23.096352Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-6c5a76a6f010a5` from `crates_io` as `registry_expansion`
