...
<!-- canonical: https://crates.io/crates/typenum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/typenum](https://crates.io/crates/typenum) |
| Source record ids | crates_io-b6653bd28969a3 |

## System Engineer Summary

Typenum is a Rust library for type-level numbers evaluated at compile time. It currently supports
bits, unsigned integers, and signed integers. It also provides a type-level array of type-level
numbers, but its implementation is incomplete.

## Operational Role

For a systems engineer, typenum belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.20.1 | 2026-05-29T16:00:41.793255Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-b6653bd28969a3` from `crates_io` as `registry_expansion`
