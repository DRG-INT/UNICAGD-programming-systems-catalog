...
<!-- canonical: https://pypi.org/project/accmt-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accmt-cli/](https://pypi.org/project/accmt-cli/) |
| Source record ids | pypi_simple-a03d435ac352e0 |
...
For a systems engineer, accmt-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.7.1 | 2025-05-13T21:55:57.632018Z | [https://pypi.org/pypi/accmt-cli/json](https://pypi.org/pypi/accmt-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accmt-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-a03d435ac352e0` from `pypi_simple` as `registry_expansion`
