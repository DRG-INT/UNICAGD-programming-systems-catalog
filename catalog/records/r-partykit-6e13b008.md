...
<!-- canonical: https://cran.r-project.org/web/packages/partykit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/partykit/index.html](https://cran.r-project.org/web/packages/partykit/index.html) |
| Source record ids | cran_packages_by_date-fa0ba656a905d2 |
...
For a systems engineer, partykit belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3-0 | 2026-08-22 16:50:02 UTC | [https://cran.r-project.org/web/packages/partykit/DESCRIPTION](https://cran.r-project.org/web/packages/partykit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/partykit/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fa0ba656a905d2` from `cran_packages_by_date` as `registry_expansion`
