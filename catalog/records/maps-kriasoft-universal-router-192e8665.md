...
<!-- canonical: https://github.com/kriasoft/universal-router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kriasoft/universal-router](https://github.com/kriasoft/universal-router) |
| Source record ids | github_search_maps-b20109c80b9bba |
...
For a systems engineer, kriasoft/universal-router belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-20T02:40:42Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b20109c80b9bba` from `github_search_maps` as `registry_expansion`
