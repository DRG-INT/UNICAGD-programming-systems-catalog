...
| Source record ids | corpus-0e7574cb11d6f6 |

## System Engineer Summary

msgpackr is tracked as a serialization record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, msgpackr belongs in the Node.js/JavaScript inventory as part of wire
...
- `corpus-0e7574cb11d6f6` from `master_json` as `serialization`
