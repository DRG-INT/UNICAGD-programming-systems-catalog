...
<!-- canonical: https://www.npmjs.com/package/decap-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/decap-server](https://www.npmjs.com/package/decap-server) |
| Source record ids | npm_registry-fe759491f2ca0f |
...
For a systems engineer, decap-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.11.0 | 2026-08-31T13:05:34.120Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-fe759491f2ca0f` from `npm_registry` as `registry_expansion`
