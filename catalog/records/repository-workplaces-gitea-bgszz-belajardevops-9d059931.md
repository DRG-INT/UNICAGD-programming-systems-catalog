...
<!-- canonical: https://gitea.com/bgszz/BelajarDevops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/bgszz/BelajarDevops](https://gitea.com/bgszz/BelajarDevops) |
| Source record ids | gitea_repositories_api-4b80b3f7279505 |
...
For a systems engineer, Gitea: bgszz/BelajarDevops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T04:28:25Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-4b80b3f7279505` from `gitea_repositories_api` as `registry_expansion`
