...
<!-- canonical: https://packagist.org/packages/marcelgwerder/laravel-api-handler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/marcelgwerder/laravel-api-handler](https://packagist.org/packages/marcelgwerder/laravel-api-handler) |
| Source record ids | packagist_search-bdc005f60ea0cf |
...
For a systems engineer, marcelgwerder/laravel-api-handler belongs in the PHP inventory as part of
...
- `packagist_search-bdc005f60ea0cf` from `packagist_search` as `registry_expansion`
