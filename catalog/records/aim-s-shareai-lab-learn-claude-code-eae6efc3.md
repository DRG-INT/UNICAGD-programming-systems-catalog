...
<!-- canonical: https://github.com/shareAI-lab/learn-claude-code -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) |
| Source record ids | github_search_aims-68b7fee35a6950 |
...
For a systems engineer, shareAI-lab/learn-claude-code belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T16:38:22Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-68b7fee35a6950` from `github_search_aims` as `registry_expansion`
