...
<!-- canonical: https://cran.r-project.org/web/packages/RobustLPA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RobustLPA/index.html](https://cran.r-project.org/web/packages/RobustLPA/index.html) |
| Source record ids | cran_packages_by_date-873b8700909eb3 |
...
For a systems engineer, RobustLPA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-20 23:02:26 UTC | [https://cran.r-project.org/web/packages/RobustLPA/DESCRIPTION](https://cran.r-project.org/web/packages/RobustLPA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RobustLPA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-873b8700909eb3` from `cran_packages_by_date` as `registry_expansion`
