...
<!-- canonical: https://crates.io/crates/pyo3-build-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pyo3-build-config](https://crates.io/crates/pyo3-build-config) |
| Source record ids | crates_io-c93499605d97b8 |
...
For a systems engineer, pyo3-build-config belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.2 | 2026-08-28T18:29:25.325681Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c93499605d97b8` from `crates_io` as `registry_expansion`
