...
<!-- canonical: https://hackage.haskell.org/package/baikai-effectful -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai-effectful](https://hackage.haskell.org/package/baikai-effectful) |
| Source record ids | hackage_recent-9152dbc958565f |
...
For a systems engineer, baikai-effectful belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0.2 | 2026-09-15T22:39:32Z | [https://hackage.haskell.org/package/baikai-effectful](https://hackage.haskell.org/package/baikai-effectful) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/baikai-effectful` at `2026-09-16T06:31:30+00:00`.
...
- `hackage_recent-9152dbc958565f` from `hackage_recent` as `registry_expansion`
