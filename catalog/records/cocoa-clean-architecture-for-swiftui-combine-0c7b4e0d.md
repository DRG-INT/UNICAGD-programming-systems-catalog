...
<!-- canonical: https://github.com/nalexn/clean-architecture-swiftui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nalexn/clean-architecture-swiftui](https://github.com/nalexn/clean-architecture-swiftui) |
| Source record ids | awesome_list-f9794f2804880b |
...
For a systems engineer, Clean Architecture for SwiftUI + Combine belongs in the Cocoa inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0 | 2024-12-08T18:25:58Z | [https://api.github.com/repos/nalexn/clean-architecture-swiftui/releases/latest](https://api.github.com/repos/nalexn/clean-architecture-swiftui/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nalexn/clean-architecture-swiftui/releases/latest` at `2026-09-01T07:24:04+00:00`.
...
- `awesome_list-f9794f2804880b` from `awesome_list` as `registry_expansion`
