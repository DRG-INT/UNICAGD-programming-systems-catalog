# pythymcpyface/lichess-analyser
...
<!-- canonical: https://github.com/pythymcpyface/lichess-analyser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pythymcpyface/lichess-analyser](https://github.com/pythymcpyface/lichess-analyser) |
| Source record ids | github_search_repertoare_catalogs-2106c47deb51f9 |

## System Engineer Summary

A modern web application built with Nuxt 3 that analyzes your Lichess games to provide deep insights
into your opening repertoire and performance.

## Operational Role

For a systems engineer, pythymcpyface/lichess-analyser belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-03T15:58:08Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-2106c47deb51f9` from `github_search_repertoare_catalogs` as `registry_expansion`
