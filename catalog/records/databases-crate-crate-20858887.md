...
<!-- canonical: https://github.com/crate/crate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/crate/crate](https://github.com/crate/crate) |
| Source record ids | github_search_databases-1f8cb84bf0f9a3 |

## System Engineer Summary

CrateDB is a distributed and scalable SQL database for storing and analyzing massive amounts of data
in near real-time, even with complex queries. It is PostgreSQL-compatible, and based on Lucene.

## Operational Role

For a systems engineer, crate/crate belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:08:09Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1f8cb84bf0f9a3` from `github_search_databases` as `registry_expansion`
