...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CITIfile](https://github.com/JuliaRegistries/General/tree/master/C/CITIfile) |
| Source record ids | julia_general-01f87fd35507d1 |

## System Engineer Summary

Julia package registered in General at C/CITIfile.

## Operational Role

For a systems engineer, CITIfile belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CITIfile", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-01f87fd35507d1` from `julia_general` as `registry_expansion`
