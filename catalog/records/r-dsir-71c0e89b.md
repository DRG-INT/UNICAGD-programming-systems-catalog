...
<!-- canonical: https://cran.r-project.org/web/packages/DSIR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DSIR/index.html](https://cran.r-project.org/web/packages/DSIR/index.html) |
| Source record ids | cran_packages_by_date-ff5763f6094eeb |
...
For a systems engineer, DSIR belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-28 15:00:02 UTC | [https://cran.r-project.org/web/packages/DSIR/DESCRIPTION](https://cran.r-project.org/web/packages/DSIR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DSIR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ff5763f6094eeb` from `cran_packages_by_date` as `registry_expansion`
