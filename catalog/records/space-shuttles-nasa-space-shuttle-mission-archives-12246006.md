# NASA Space Shuttle Mission Archives

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Shuttles](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-shuttles.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.nasa.gov/mission/space-shuttle/](https://www.nasa.gov/mission/space-shuttle/) |
| Source record ids | curated_language_routes-282b03da929e44 |

## System Engineer Summary

NASA mission archive route for shuttle mission records and program data.

## Operational Role

For a systems engineer, NASA Space Shuttle Mission Archives belongs in the Space Shuttles inventory
...
- `curated_language_routes-282b03da929e44` from `curated_language_routes` as `registry_expansion`
