...
<!-- canonical: https://github.com/inoook/EffectShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/inoook/EffectShader](https://github.com/inoook/EffectShader) |
| Source record ids | github_search_effects-57a3773be55695 |
...
For a systems engineer, inoook/EffectShader belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-08-16T15:28:33Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-57a3773be55695` from `github_search_effects` as `registry_expansion`
