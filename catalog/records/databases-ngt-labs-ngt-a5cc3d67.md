...
<!-- canonical: https://github.com/NGT-labs/NGT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NGT-labs/NGT](https://github.com/NGT-labs/NGT) |
| Source record ids | github_search_databases-92f52aaa15b2d6 |
...
For a systems engineer, NGT-labs/NGT belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T02:04:32Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-92f52aaa15b2d6` from `github_search_databases` as `registry_expansion`
