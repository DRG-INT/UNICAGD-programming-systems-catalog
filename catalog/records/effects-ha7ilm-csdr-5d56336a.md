...
| Source record ids | github_search_effects-5dfd728ca9f925 |
...
For a systems engineer, ha7ilm/csdr belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-06T12:13:28Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5dfd728ca9f925` from `github_search_effects` as `registry_expansion`
...
| EemilAhonen/leikkaus | Cli | [open](effects-eemilahonen-leikkaus-f2b2b34e.md) |
