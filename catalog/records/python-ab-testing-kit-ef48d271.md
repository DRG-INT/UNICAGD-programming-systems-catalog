...
<!-- canonical: https://pypi.org/project/ab-testing-kit/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-testing-kit/](https://pypi.org/project/ab-testing-kit/) |
| Source record ids | pypi_simple-53ea28c76f8bd5 |
...
For a systems engineer, ab-testing-kit belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2024-08-01T10:53:21.623640Z | [https://pypi.org/pypi/ab-testing-kit/json](https://pypi.org/pypi/ab-testing-kit/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-testing-kit/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-53ea28c76f8bd5` from `pypi_simple` as `registry_expansion`
