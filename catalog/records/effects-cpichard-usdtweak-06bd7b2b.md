...
<!-- canonical: https://github.com/cpichard/usdtweak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cpichard/usdtweak](https://github.com/cpichard/usdtweak) |
| Source record ids | github_search_effects-3b71a0a96c9e0f |
...
For a systems engineer, cpichard/usdtweak belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T08:57:01Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3b71a0a96c9e0f` from `github_search_effects` as `registry_expansion`
