...
<!-- canonical: https://cran.r-project.org/web/packages/mdendro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mdendro/index.html](https://cran.r-project.org/web/packages/mdendro/index.html) |
| Source record ids | cran_packages_by_date-9e75391c001dab |
...
For a systems engineer, mdendro belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-21 09:50:11 UTC | [https://cran.r-project.org/web/packages/mdendro/DESCRIPTION](https://cran.r-project.org/web/packages/mdendro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mdendro/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9e75391c001dab` from `cran_packages_by_date` as `registry_expansion`
