...
<!-- canonical: https://github.com/DiffAPF/torchcomp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DiffAPF/torchcomp](https://github.com/DiffAPF/torchcomp) |
| Source record ids | github_search_effects-bc58f6ec97a92b |
...
For a systems engineer, DiffAPF/torchcomp belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-10T13:08:21Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-bc58f6ec97a92b` from `github_search_effects` as `registry_expansion`
