...
<!-- canonical: https://crates.io/crates/pest_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pest_derive](https://crates.io/crates/pest_derive) |
| Source record ids | crates_io-e3827b6b3f5848 |

## System Engineer Summary

pest_derive is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, pest_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.1 | 2026-09-05T12:15:00.810433Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-05T12:22:38+00:00`.
...
- `crates_io-e3827b6b3f5848` from `crates_io` as `registry_expansion`
