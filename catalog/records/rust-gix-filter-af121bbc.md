...
| Canonical URL | [https://crates.io/crates/gix-filter](https://crates.io/crates/gix-filter) |
| Source record ids | crates_io-6d15e6dfd68605 |
...
For a systems engineer, gix-filter belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.34.0 | 2026-08-22T19:01:50.405165Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-6d15e6dfd68605` from `crates_io` as `registry_expansion`
