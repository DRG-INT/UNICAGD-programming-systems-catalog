...
<!-- canonical: https://github.com/wasp-lang/open-saas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasp-lang/open-saas](https://github.com/wasp-lang/open-saas) |
| Source record ids | github_search_databases-1e2aca30ec8043 |

## System Engineer Summary

A 100% free modern JS SaaS boilerplate (React, NodeJS, Prisma). Full-featured: Auth (email, google,
github, slack, MS), Email sending, Background jobs, Landing page, Payments (Stripe, Polar.sh),
Shadcn UI, S3 file upload. AI-ready with tailored AGENTS.md, skills, and Claude Code plugin. One cmd
deploy. Powered by Wasp full-stack framework.

## Operational Role

For a systems engineer, wasp-lang/open-saas belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T11:28:44Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1e2aca30ec8043` from `github_search_databases` as `registry_expansion`
