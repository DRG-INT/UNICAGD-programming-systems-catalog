...
| Source record ids | curated_database_systems-a0e9f0899c803d |

## System Engineer Summary

Vector database with hybrid search and schema-aware object storage.

## Operational Role

For a systems engineer, Weaviate belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-a0e9f0899c803d` from `curated_database_systems` as `registry_expansion`
