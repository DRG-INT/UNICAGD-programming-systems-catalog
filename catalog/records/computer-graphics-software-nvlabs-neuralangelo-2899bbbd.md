...
<!-- canonical: https://github.com/NVlabs/neuralangelo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NVlabs/neuralangelo](https://github.com/NVlabs/neuralangelo) |
| Source record ids | github_search_computer_graphics_software-411ad9bf3131da |
...
For a systems engineer, NVlabs/neuralangelo belongs in the Computer Graphics Software inventory as
...
| Evidence | MIT; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Other |
...
- `github_search_computer_graphics_software-411ad9bf3131da` from `github_search_computer_graphics_software` as `registry_expansion`
...
| lettier/3d-game-shaders-for-beginners | Ide Editor Integration | [open](computer-graphics-software-lettier-3d-game-shaders-for-beginners-10162125.md) |
| LibreSprite/LibreSprite | Ide Editor Integration | [open](computer-graphics-software-libresprite-libresprite-f7b0e2a3.md) |
| mono/SkiaSharp | Ide Editor Integration | [open](computer-graphics-software-mono-skiasharp-4faa0454.md) |
| NVlabs/LongSplat | Ide Editor Integration | [open](computer-graphics-software-nvlabs-longsplat-7f4f9cb5.md) |
| PixiEditor/PixiEditor | Ide Editor Integration | [open](computer-graphics-software-pixieditor-pixieditor-966a42ca.md) |
