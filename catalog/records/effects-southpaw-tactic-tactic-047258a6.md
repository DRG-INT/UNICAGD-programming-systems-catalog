...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Southpaw-TACTIC/TACTIC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Southpaw-TACTIC/TACTIC](https://github.com/Southpaw-TACTIC/TACTIC) |
| Source record ids | github_search_effects-b73babb84f7d89 |

## System Engineer Summary

Open source remote collaboration platform used for configuring and deploying enterprise Workflow
solutions.

## Operational Role

For a systems engineer, Southpaw-TACTIC/TACTIC belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-24T01:24:56Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; https://www.nuget.org/packages/HotChocolate.Transport.Http/16.6.2/license; https://www.nuget.org/packages/HotChocolate.Transport.Http/16.1.4/license; Other |
...
- `github_search_effects-b73babb84f7d89` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AcademySoftwareFoundation/openvdb | Configuration | [open](effects-academysoftwarefoundation-openvdb-fbe81c11.md) |
| avivace/dotfiles | Configuration | [open](effects-avivace-dotfiles-d1092acc.md) |
| pinnacle-comp/pinnacle | Configuration | [open](effects-pinnacle-comp-pinnacle-12aa6aeb.md) |
| Sid-WC121/Audio-Echo-Modelling | Configuration | [open](effects-sid-wc121-audio-echo-modelling-b6a9cb65.md) |
| TobiasVanDyk/Audio-Effects-Preamp-VS1053b | Configuration | [open](effects-tobiasvandyk-audio-effects-preamp-vs1053b-7e7ce423.md) |
