...
<!-- canonical: https://cran.r-project.org/web/packages/AnnotationBustR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AnnotationBustR/index.html](https://cran.r-project.org/web/packages/AnnotationBustR/index.html) |
| Source record ids | cran_packages_by_date-edd4f317183afe |
...
For a systems engineer, AnnotationBustR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-08-31 19:00:19 UTC | [https://cran.r-project.org/web/packages/AnnotationBustR/DESCRIPTION](https://cran.r-project.org/web/packages/AnnotationBustR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AnnotationBustR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-edd4f317183afe` from `cran_packages_by_date` as `registry_expansion`
