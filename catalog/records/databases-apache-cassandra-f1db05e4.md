...
| Canonical URL | [https://github.com/apache/cassandra](https://github.com/apache/cassandra) |
| Source record ids | curated_database_systems-0add4a3a5d7662 |

## System Engineer Summary

Distributed wide-column database for high-scale availability and partition-tolerant storage.

## Operational Role

For a systems engineer, Apache Cassandra belongs in the Databases inventory as part of state
...
- `curated_database_systems-0add4a3a5d7662` from `curated_database_systems` as `registry_expansion`
...
| Apache Hudi | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-hudi-6db4b0c4.md) |
