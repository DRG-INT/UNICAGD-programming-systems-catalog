...
<!-- canonical: https://github.com/tier4/nebula -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tier4/nebula](https://github.com/tier4/nebula) |
| Source record ids | github_search_radars-99f6dc1328c528 |

## System Engineer Summary

A universal LiDAR and radar driver for ROS 2, supporting Hesai, Velodyne, Robosense and Continental
sensors.

## Operational Role

For a systems engineer, tier4/nebula belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2026-07-30T06:12:33Z | [https://api.github.com/repos/tier4/nebula/releases/latest](https://api.github.com/repos/tier4/nebula/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tier4/nebula/releases/latest` at `2026-09-01T08:26:32+00:00`.
...
- `github_search_radars-99f6dc1328c528` from `github_search_radars` as `registry_expansion`
...
| Orion-AI-Lab/KuroSiwo | Filesystem Os | [open](radars-orion-ai-lab-kurosiwo-16670f6a.md) |
