...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/davisking/dlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/davisking/dlib](https://github.com/davisking/dlib) |
| Source record ids | awesome_list-edef3e15a647fe |

## System Engineer Summary

:zap: - A toolkit for making real world machine learning and data analysis applications in C++.
Boost

## Operational Role

For a systems engineer, Dlib belongs in the C++23 inventory as part of defect discovery, security
...
- `awesome_list-edef3e15a647fe` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CodeQL C/C++ | Static Analyzer | [open](c-23-codeql-c-c-9d731d9d.md) |
| Coverity | Static Analyzer | [open](c-23-coverity-ed10c96f.md) |
| cppcheck | Static Analyzer | [open](c-23-cppcheck-36a322db.md) |
| PVS-Studio | Static Analyzer | [open](c-23-pvs-studio-0ed7cf10.md) |
| SonarQube CFamily | Static Analyzer | [open](c-23-sonarqube-cfamily-224ca2e2.md) |
