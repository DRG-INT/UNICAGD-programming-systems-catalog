...
<!-- canonical: https://pypi.org/project/a2a-client-172ai/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2a-client-172ai/](https://pypi.org/project/a2a-client-172ai/) |
| Source record ids | pypi_simple-ba330f663fb5d1 |
...
For a systems engineer, a2a-client-172ai belongs in the Python inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2025-11-16T03:14:04.380264Z | [https://pypi.org/pypi/a2a-client-172ai/json](https://pypi.org/pypi/a2a-client-172ai/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2a-client-172ai/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-ba330f663fb5d1` from `pypi_simple` as `registry_expansion`
