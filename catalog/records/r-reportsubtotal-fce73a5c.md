...
<!-- canonical: https://cran.r-project.org/web/packages/ReportSubtotal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ReportSubtotal/index.html](https://cran.r-project.org/web/packages/ReportSubtotal/index.html) |
| Source record ids | cran_packages_by_date-e0458218312e14 |
...
For a systems engineer, ReportSubtotal belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-21 05:45:43 UTC | [https://cran.r-project.org/web/packages/ReportSubtotal/DESCRIPTION](https://cran.r-project.org/web/packages/ReportSubtotal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ReportSubtotal/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e0458218312e14` from `cran_packages_by_date` as `registry_expansion`
