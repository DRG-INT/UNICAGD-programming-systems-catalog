...
| Canonical URL | [https://packagist.org/packages/felixfbecker/advanced-json-rpc](https://packagist.org/packages/felixfbecker/advanced-json-rpc) |
| Source record ids | packagist_search-56207564360e9e |
...
For a systems engineer, felixfbecker/advanced-json-rpc belongs in the PHP inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.2.1 | 2021-06-11T22:35:38+00:00 | [https://repo.packagist.org/p2/felixfbecker/advanced-json-rpc.json](https://repo.packagist.org/p2/felixfbecker/advanced-json-rpc.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/felixfbecker/advanced-json-rpc.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-56207564360e9e` from `packagist_search` as `registry_expansion`
