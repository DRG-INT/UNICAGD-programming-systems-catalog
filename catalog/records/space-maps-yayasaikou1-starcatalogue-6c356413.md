...
<!-- canonical: https://github.com/yayasaikou1/StarCatalogue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yayasaikou1/StarCatalogue](https://github.com/yayasaikou1/StarCatalogue) |
| Source record ids | github_search_space_maps-ede8ad4c559dae |

## System Engineer Summary

A LAMOST stellar spectral star catalog by CNN 一个基于卷积神经网络模型输出的LAMOST观测数据的恒星光谱型星表

## Operational Role

For a systems engineer, yayasaikou1/StarCatalogue belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-26T08:05:15Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ede8ad4c559dae` from `github_search_space_maps` as `registry_expansion`
