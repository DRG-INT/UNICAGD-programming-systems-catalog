...
<!-- canonical: https://gitlab.freedesktop.org/mesa/mesa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.freedesktop.org/mesa/mesa](https://gitlab.freedesktop.org/mesa/mesa) |
| Source record ids | curated_language_routes-b4a2eda5aef0a6 |

## System Engineer Summary

Open-source OpenGL, Vulkan, and GPU driver stack used by Linux desktops, browsers, games, and
compute workloads.

## Operational Role

For a systems engineer, Mesa belongs in the Renderers inventory as part of ecosystem capability
...
- `curated_language_routes-b4a2eda5aef0a6` from `curated_language_routes` as `registry_expansion`
