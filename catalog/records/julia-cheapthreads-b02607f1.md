...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/C/CheapThreads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CheapThreads](https://github.com/JuliaRegistries/General/tree/master/C/CheapThreads) |
| Source record ids | julia_general-c4e6b402db6846 |

## System Engineer Summary

Julia package registered in General at C/CheapThreads.

## Operational Role

For a systems engineer, CheapThreads belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- |
| Detected family | MIT |
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT; https://www.nuget.org/packages/GraphQL.Client.Serializer.SystemTextJson/6.1.0/license |
...
| Name | Category | Page |
| --- | --- | --- |
| BinaryHeaps | Memory Analyzer | [open](julia-binaryheaps-e75c5c34.md) |
