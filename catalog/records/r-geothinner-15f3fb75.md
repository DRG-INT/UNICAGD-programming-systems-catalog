...
<!-- canonical: https://cran.r-project.org/web/packages/GeoThinneR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GeoThinneR/index.html](https://cran.r-project.org/web/packages/GeoThinneR/index.html) |
| Source record ids | cran_packages_by_date-75f4532603a830 |
...
For a systems engineer, GeoThinneR belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2026-08-25 22:00:14 UTC | [https://cran.r-project.org/web/packages/GeoThinneR/DESCRIPTION](https://cran.r-project.org/web/packages/GeoThinneR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GeoThinneR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-75f4532603a830` from `cran_packages_by_date` as `registry_expansion`
