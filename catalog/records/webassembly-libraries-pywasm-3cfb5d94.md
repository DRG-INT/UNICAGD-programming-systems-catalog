...
<!-- canonical: https://github.com/libraries/pywasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libraries/pywasm](https://github.com/libraries/pywasm) |
| Source record ids | github_search_webassembly-381afd04a76009 |
...
For a systems engineer, libraries/pywasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.3 | 2026-05-13T01:44:11Z | [https://api.github.com/repos/libraries/pywasm/releases/latest](https://api.github.com/repos/libraries/pywasm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/libraries/pywasm/releases/latest` at `2026-09-01T10:25:59+00:00`.
...
- `github_search_webassembly-381afd04a76009` from `github_search_webassembly` as `registry_expansion`
