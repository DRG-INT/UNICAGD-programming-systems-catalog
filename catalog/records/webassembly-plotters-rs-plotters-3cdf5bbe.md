...
<!-- canonical: https://github.com/plotters-rs/plotters -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/plotters-rs/plotters](https://github.com/plotters-rs/plotters) |
| Source record ids | github_search_webassembly-a418f57ae6e36e |

## System Engineer Summary

A rust drawing library for high quality data plotting for both WASM and native, statically and
realtimely 🦀 📈🚀

## Operational Role

For a systems engineer, plotters-rs/plotters belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-13T12:44:14Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a418f57ae6e36e` from `github_search_webassembly` as `registry_expansion`
