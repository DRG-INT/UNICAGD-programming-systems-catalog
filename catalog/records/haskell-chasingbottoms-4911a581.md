...
<!-- canonical: https://hackage.haskell.org/package/ChasingBottoms -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ChasingBottoms](https://hackage.haskell.org/package/ChasingBottoms) |
| Source record ids | hackage_top_downloads-58475aa506674f |
...
For a systems engineer, ChasingBottoms belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1.17 | 2025-10-15T10:31:07Z | [https://hackage.haskell.org/package/ChasingBottoms](https://hackage.haskell.org/package/ChasingBottoms) |  |
| candidate | partial | 1.3.1.11 |  | [https://hackage.haskell.org/package/ChasingBottoms](https://hackage.haskell.org/package/ChasingBottoms) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ChasingBottoms` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-58475aa506674f` from `hackage_top_downloads` as `registry_expansion`
