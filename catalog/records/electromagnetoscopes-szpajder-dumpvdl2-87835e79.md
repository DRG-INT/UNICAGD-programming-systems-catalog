...
| Source record ids | github_search_electromagnetoscopes-29a599b1f508b4 |
...
For a systems engineer, szpajder/dumpvdl2 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.7.0 | 2026-08-01T19:58:34Z | [https://api.github.com/repos/szpajder/dumpvdl2/releases/latest](https://api.github.com/repos/szpajder/dumpvdl2/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/szpajder/dumpvdl2/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-29a599b1f508b4` from `github_search_electromagnetoscopes` as `registry_expansion`
