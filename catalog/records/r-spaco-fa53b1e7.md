...
<!-- canonical: https://cran.r-project.org/web/packages/SPACO/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SPACO/index.html](https://cran.r-project.org/web/packages/SPACO/index.html) |
| Source record ids | cran_packages_by_date-79b967eab481fa |

## System Engineer Summary

Spatial Component Analysis for Spatial Sequencing Data

## Operational Role

For a systems engineer, SPACO belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-24 11:00:03 UTC | [https://cran.r-project.org/web/packages/SPACO/DESCRIPTION](https://cran.r-project.org/web/packages/SPACO/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SPACO/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-79b967eab481fa` from `cran_packages_by_date` as `registry_expansion`
