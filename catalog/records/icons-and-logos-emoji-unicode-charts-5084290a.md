# Emoji Unicode Charts

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Icons and Logos](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/icons-and-logos.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://unicode.org/emoji/charts/](https://unicode.org/emoji/charts/) |
| Source record ids | curated_language_routes-cd776e6804e665 |

## System Engineer Summary

Unicode emoji charts and data route for standardized symbols, names, sequences, and rendering
behavior.

## Operational Role

For a systems engineer, Emoji Unicode Charts belongs in the Icons and Logos inventory as part of
...
- `curated_language_routes-cd776e6804e665` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| SVG Specification | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-svg-specification-3ad3bc7c.md) |
| W3C Web App Manifest Icons | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/icons-and-logos-w3c-web-app-manifest-icons-84500c67.md) |
