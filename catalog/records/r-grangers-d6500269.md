...
<!-- canonical: https://cran.r-project.org/web/packages/grangers/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/grangers/index.html](https://cran.r-project.org/web/packages/grangers/index.html) |
| Source record ids | cran_packages_by_date-e4ca652e503a5e |
...
For a systems engineer, grangers belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-04 14:20:09 UTC | [https://cran.r-project.org/web/packages/grangers/DESCRIPTION](https://cran.r-project.org/web/packages/grangers/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/grangers/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e4ca652e503a5e` from `cran_packages_by_date` as `registry_expansion`
