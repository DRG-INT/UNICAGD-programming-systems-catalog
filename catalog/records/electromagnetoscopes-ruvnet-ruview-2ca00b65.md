...
<!-- canonical: https://github.com/ruvnet/RuView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ruvnet/RuView](https://github.com/ruvnet/RuView) |
| Source record ids | github_search_electromagnetoscopes-2d2fea5b890dc3 |

## System Engineer Summary

π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring,
and presence detection — all without a single pixel of video.

## Operational Role

For a systems engineer, ruvnet/RuView belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T18:19:07Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-2d2fea5b890dc3` from `github_search_electromagnetoscopes` as `registry_expansion`
