...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CheckMate](https://github.com/JuliaRegistries/General/tree/master/C/CheckMate) |
| Source record ids | julia_general-6c5784a0f7ed1a |

## System Engineer Summary

Julia package registered in General at C/CheckMate.

## Operational Role

For a systems engineer, CheckMate belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CheckMate", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-6c5784a0f7ed1a` from `julia_general` as `registry_expansion`
