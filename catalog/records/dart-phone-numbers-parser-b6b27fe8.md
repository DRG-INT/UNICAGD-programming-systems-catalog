...
<!-- canonical: https://pub.dev/packages/phone_numbers_parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/phone_numbers_parser](https://pub.dev/packages/phone_numbers_parser) |
| Source record ids | pub_dev-366619f0d616b1 |

## System Engineer Summary

Dart library for parsing phone numbers. Inspired by Google's libphonenumber and PhoneNumberKit for
ios.

## Operational Role

For a systems engineer, phone_numbers_parser belongs in the Dart inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.0.26 | 2026-09-01T00:34:26.060864Z | [https://pub.dev/api/packages/phone_numbers_parser](https://pub.dev/api/packages/phone_numbers_parser) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/phone_numbers_parser` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-366619f0d616b1` from `pub_dev` as `registry_expansion`
