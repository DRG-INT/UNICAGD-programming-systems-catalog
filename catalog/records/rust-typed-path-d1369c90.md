...
| Canonical URL | [https://crates.io/crates/typed-path](https://crates.io/crates/typed-path) |
| Source record ids | crates_io-1b612cab015cfa |
...
For a systems engineer, typed-path belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.3 | 2026-02-11T02:30:37.067886Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-1b612cab015cfa` from `crates_io` as `registry_expansion`
