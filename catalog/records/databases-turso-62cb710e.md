...
| Canonical URL | [https://turso.tech/](https://turso.tech/) |
| Source record ids | curated_database_systems-7d755347977b0f |

## System Engineer Summary

SQLite-compatible database platform based on libSQL.

## Operational Role

For a systems engineer, Turso belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-7d755347977b0f` from `curated_database_systems` as `registry_expansion`
