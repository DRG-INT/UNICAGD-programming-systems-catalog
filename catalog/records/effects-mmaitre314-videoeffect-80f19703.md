...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mmaitre314/VideoEffect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mmaitre314/VideoEffect](https://github.com/mmaitre314/VideoEffect) |
| Source record ids | github_search_effects-8bbd2926077b53 |

## System Engineer Summary

Apply image effects (Lumia Imaging SDK, Win2D, DirectX HLSL pixel shaders) and detectors (ZXing.Net,
etc.) to videos in Universal Store Apps for Windows Phone 8.1 and Windows 8.1.

## Operational Role

For a systems engineer, mmaitre314/VideoEffect belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-09-27T05:31:00Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "shader effects", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_effects-8bbd2926077b53` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 777arc/PySDR | Ide Editor Integration | [open](effects-777arc-pysdr-8eef8c53.md) |
| Akascape/ShaderToyVid | Ide Editor Integration | [open](effects-akascape-shadertoyvid-707b6609.md) |
| alaingalvan/image-editor-effects | Ide Editor Integration | [open](effects-alaingalvan-image-editor-effects-3f083847.md) |
| AlbertoSabater/Robust-and-efficient-post-processing-for-video-object-detection | Ide Editor Integration | [open](effects-albertosabater-robust-and-efficient-post-processing-for-video-object-detection-344c2f6e.md) |
| ArseniyMirniy/Godot-4-Color-Correction-and-Screen-Effects | Ide Editor Integration | [open](effects-arseniymirniy-godot-4-color-correction-and-screen-effects-6a7812f0.md) |
| Arystos/Advanced-Outline-Shader-UE5 | Ide Editor Integration | [open](effects-arystos-advanced-outline-shader-ue5-5e6152c6.md) |
| butterw/bShaders | Ide Editor Integration | [open](effects-butterw-bshaders-5be42b88.md) |
| cpichard/usdtweak | Ide Editor Integration | [open](effects-cpichard-usdtweak-06bd7b2b.md) |
