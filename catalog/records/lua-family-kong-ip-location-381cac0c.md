...
| Canonical URL | [https://luarocks.org/modules/ismailbaskin/kong-ip-location](https://luarocks.org/modules/ismailbaskin/kong-ip-location) |
| Source record ids | luarocks_root_manifest-de30f21f291301 |

## System Engineer Summary

Detect location depends on Maxmind geolite database

## Operational Role

For a systems engineer, kong-ip-location belongs in the Lua family inventory as part of state
...
- `luarocks_root_manifest-de30f21f291301` from `luarocks_root_manifest` as `registry_expansion`
