...
<!-- canonical: https://github.com/rohanhake98/catalogiq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rohanhake98/catalogiq](https://github.com/rohanhake98/catalogiq) |
| Source record ids | github_search_repertoare_catalogs-8e4ff9de574444 |

## System Engineer Summary

AI-powered, evidence-constrained product enrichment engine that transforms sparse industrial product
data into commerce-ready records with controlled attributes, validation, provenance, confidence
scoring, and explicit UNKNOWN/NEEDS_REVIEW states.

## Operational Role

For a systems engineer, rohanhake98/catalogiq belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T14:01:33Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-8e4ff9de574444` from `github_search_repertoare_catalogs` as `registry_expansion`
