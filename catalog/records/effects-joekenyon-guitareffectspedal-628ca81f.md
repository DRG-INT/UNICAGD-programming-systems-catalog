...
<!-- canonical: https://github.com/JoeKenyon/GuitarEffectsPedal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JoeKenyon/GuitarEffectsPedal](https://github.com/JoeKenyon/GuitarEffectsPedal) |
| Source record ids | github_search_effects-34abe4c7eecc62 |

## System Engineer Summary

Guitar effects pedal written for the STM32F746G-DISCO, includes WahWah, Tremolo, Flanger,
Distortion, Vibrato and Echo/Delay. Effect parameters editable in real time.

## Operational Role

For a systems engineer, JoeKenyon/GuitarEffectsPedal belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-16T22:49:20Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-34abe4c7eecc62` from `github_search_effects` as `registry_expansion`
