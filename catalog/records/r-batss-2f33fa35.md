...
<!-- canonical: https://cran.r-project.org/web/packages/BATSS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BATSS/index.html](https://cran.r-project.org/web/packages/BATSS/index.html) |
| Source record ids | cran_packages_by_date-80fc7d87c148f8 |
...
For a systems engineer, BATSS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-01 12:30:27 UTC | [https://cran.r-project.org/web/packages/BATSS/DESCRIPTION](https://cran.r-project.org/web/packages/BATSS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BATSS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-80fc7d87c148f8` from `cran_packages_by_date` as `registry_expansion`
