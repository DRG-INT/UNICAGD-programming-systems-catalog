...
| Source record ids | curated_language_routes-caeba074e03742 |

## System Engineer Summary

JavaScript map library for interactive web maps, tile layers, markers, controls, and plugins.

## Operational Role

For a systems engineer, Leaflet belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.9.4 | 2023-05-18T11:12:03Z | [https://api.github.com/repos/Leaflet/Leaflet/releases/latest](https://api.github.com/repos/Leaflet/Leaflet/releases/latest) |  |
| preview | known | dev | 2025-09-17T11:16:38Z | [https://api.github.com/repos/Leaflet/Leaflet/releases?per_page=10](https://api.github.com/repos/Leaflet/Leaflet/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Leaflet/Leaflet/releases/latest` at `2026-09-01T07:24:43+00:00`.
...
- `curated_language_routes-caeba074e03742` from `curated_language_routes` as `registry_expansion`
