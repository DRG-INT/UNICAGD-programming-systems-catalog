...
<!-- canonical: https://luarocks.org/modules/alexeldeib/adal-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alexeldeib/adal-lua](https://luarocks.org/modules/alexeldeib/adal-lua) |
| Source record ids | luarocks_root_manifest-60bde0c47f7327 |

## System Engineer Summary

adal-lua is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, adal-lua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-60bde0c47f7327` from `luarocks_root_manifest` as `registry_expansion`
