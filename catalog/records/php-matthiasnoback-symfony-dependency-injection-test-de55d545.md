...
<!-- canonical: https://packagist.org/packages/matthiasnoback/symfony-dependency-injection-test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/matthiasnoback/symfony-dependency-injection-test](https://packagist.org/packages/matthiasnoback/symfony-dependency-injection-test) |
| Source record ids | packagist_search-7dae858239a99d |
...
For a systems engineer, matthiasnoback/symfony-dependency-injection-test belongs in the PHP
...
- `packagist_search-7dae858239a99d` from `packagist_search` as `registry_expansion`
