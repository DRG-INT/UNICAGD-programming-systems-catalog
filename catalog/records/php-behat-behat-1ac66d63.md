...
<!-- canonical: https://packagist.org/packages/behat/behat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/behat/behat](https://packagist.org/packages/behat/behat) |
| Source record ids | packagist_search-7edc77bbd65cbb |
...
For a systems engineer, behat/behat belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-7edc77bbd65cbb` from `packagist_search` as `registry_expansion`
