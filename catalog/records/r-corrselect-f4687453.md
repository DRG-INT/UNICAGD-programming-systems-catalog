...
<!-- canonical: https://cran.r-project.org/web/packages/corrselect/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/corrselect/index.html](https://cran.r-project.org/web/packages/corrselect/index.html) |
| Source record ids | cran_packages_by_date-1de177378a0578 |
...
For a systems engineer, corrselect belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2026-08-22 18:10:02 UTC | [https://cran.r-project.org/web/packages/corrselect/DESCRIPTION](https://cran.r-project.org/web/packages/corrselect/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/corrselect/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1de177378a0578` from `cran_packages_by_date` as `registry_expansion`
