...
<!-- canonical: https://cran.r-project.org/web/packages/formatters/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/formatters/index.html](https://cran.r-project.org/web/packages/formatters/index.html) |
| Source record ids | cran_packages_by_date-24cb8bb5719052 |
...
For a systems engineer, formatters belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.13 | 2026-09-15 03:20:02 UTC | [https://cran.r-project.org/web/packages/formatters/DESCRIPTION](https://cran.r-project.org/web/packages/formatters/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/formatters/DESCRIPTION` at `2026-09-15T03:22:13+00:00`.
...
- `cran_packages_by_date-24cb8bb5719052` from `cran_packages_by_date` as `registry_expansion`
