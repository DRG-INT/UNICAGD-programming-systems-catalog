...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GeoNode/geonode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GeoNode/geonode](https://github.com/GeoNode/geonode) |
| Source record ids | github_search_maps-ace4db7d1b9f66 |

## System Engineer Summary

GeoNode is an open source platform that facilitates the creation, sharing, and collaborative use of
geospatial data.

## Operational Role

For a systems engineer, GeoNode/geonode belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T09:45:37Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:gis stars:>100", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_maps-ace4db7d1b9f66` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 52inc/Pulley | Filesystem Os | [open](maps-52inc-pulley-a5b376ec.md) |
| ajnisbet/opentopodata | Filesystem Os | [open](maps-ajnisbet-opentopodata-c059790e.md) |
| alexbosworth/balanceofsatoshis | Filesystem Os | [open](maps-alexbosworth-balanceofsatoshis-9b5e0bba.md) |
| anonymousRAID/OSINT-Mapping-Tool | Filesystem Os | [open](maps-anonymousraid-osint-mapping-tool-8ed049b5.md) |
| apache/calcite | Filesystem Os | [open](maps-apache-calcite-64e8faa1.md) |
| apache/ofbiz | Filesystem Os | [open](maps-apache-ofbiz-0fe319f9.md) |
| apache/sedona | Filesystem Os | [open](maps-apache-sedona-820c9e53.md) |
| artembobkin/ImmersiveMap | Filesystem Os | [open](maps-artembobkin-immersivemap-7806dbe3.md) |
