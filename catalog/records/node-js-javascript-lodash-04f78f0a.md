...
| Source record ids | corpus-4820968b46c005 |

## System Engineer Summary

Lodash is tracked as an utility library record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Lodash belongs in the Node.js/JavaScript inventory as part of ecosystem
...
- `corpus-4820968b46c005` from `master_json` as `utility_library`
...
| uuid | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-uuid-cb668b5f.md) |
