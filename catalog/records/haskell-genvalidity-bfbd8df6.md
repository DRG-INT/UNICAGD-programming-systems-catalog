...
<!-- canonical: https://hackage.haskell.org/package/genvalidity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/genvalidity](https://hackage.haskell.org/package/genvalidity) |
| Source record ids | hackage_top_downloads-e8ebcda22455f4 |
...
For a systems engineer, genvalidity belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1.0 | 2024-07-18T15:40:04Z | [https://hackage.haskell.org/package/genvalidity](https://hackage.haskell.org/package/genvalidity) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/genvalidity` at `2026-09-11T00:31:21+00:00`.
...
- `hackage_top_downloads-e8ebcda22455f4` from `hackage_top_downloads` as `registry_expansion`
