...
| Source record ids | corpus-e74190667f6e3c |

## System Engineer Summary

Sailor is tracked as a web framework record in the Lua family branch. The source did not provide a
...
For a systems engineer, Sailor belongs in the Lua family inventory as part of request routing,
...
- `corpus-e74190667f6e3c` from `master_json` as `web_framework`
...
| OpenResty | Web Framework | [open](lua-family-openresty-0b4d680f.md) |
