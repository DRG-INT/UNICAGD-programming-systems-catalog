...
| Canonical URL | [https://github.com/u-root/gobusybox](https://github.com/u-root/gobusybox) |
| Source record ids | github_search_starlark-f09184062c5d4e |

## System Engineer Summary

Tools for compiling many Go commands into one binary to save space. Builds are supported for vendor-
based Go and module-based Go

## Operational Role

For a systems engineer, u-root/gobusybox belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | src/v0.3.0 | 2026-06-22T14:56:58Z | [https://api.github.com/repos/u-root/gobusybox/releases/latest](https://api.github.com/repos/u-root/gobusybox/releases/latest) |  |
| preview | known | v0.1.0 | 2020-09-18T03:25:07Z | [https://api.github.com/repos/u-root/gobusybox/releases?per_page=10](https://api.github.com/repos/u-root/gobusybox/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/u-root/gobusybox/releases/latest` at `2026-09-01T09:23:07+00:00`.
...
- `github_search_starlark-f09184062c5d4e` from `github_search_starlark` as `registry_expansion`
