...
<!-- canonical: https://hackage.haskell.org/package/atrophy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/atrophy](https://hackage.haskell.org/package/atrophy) |
| Source record ids | hackage_recent-55a85b13b150b3 |
...
For a systems engineer, atrophy belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-09-15T21:25:27Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-15T22:19:02+00:00`.
...
- `hackage_recent-55a85b13b150b3` from `hackage_recent` as `registry_expansion`
