...
| Source record ids | curated_database_systems-571c791bd07af4 |

## System Engineer Summary

GORM is tracked as a database datastore record in the Databases branch. The source did not provide a
...
For a systems engineer, GORM belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.31.2 | 2026-06-25T07:21:23Z | [https://api.github.com/repos/go-gorm/gorm/releases/latest](https://api.github.com/repos/go-gorm/gorm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/go-gorm/gorm/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-571c791bd07af4` from `curated_database_systems` as `registry_expansion`
