...
| Source record ids | github_search_audio-c5dcde527d9923 |
...
For a systems engineer, JiaoXianjun/BTLE belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2 | 2015-11-11T18:05:34Z | [https://api.github.com/repos/JiaoXianjun/BTLE/releases/latest](https://api.github.com/repos/JiaoXianjun/BTLE/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/JiaoXianjun/BTLE/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-c5dcde527d9923` from `github_search_audio` as `registry_expansion`
