...
<!-- canonical: https://pub.dev/packages/flutter_lorem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_lorem](https://pub.dev/packages/flutter_lorem) |
| Source record ids | pub_dev-04744093c6ea30 |
...
For a systems engineer, flutter_lorem belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2021-02-21T12:00:22.297478Z | [https://pub.dev/api/packages/flutter_lorem](https://pub.dev/api/packages/flutter_lorem) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_lorem` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-04744093c6ea30` from `pub_dev` as `registry_expansion`
