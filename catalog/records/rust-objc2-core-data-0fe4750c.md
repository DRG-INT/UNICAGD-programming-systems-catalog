...
| Canonical URL | [https://crates.io/crates/objc2-core-data](https://crates.io/crates/objc2-core-data) |
| Source record ids | crates_io-4d3e8307e2f323 |
...
For a systems engineer, objc2-core-data belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T16:14:39.575218Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-4d3e8307e2f323` from `crates_io` as `registry_expansion`
