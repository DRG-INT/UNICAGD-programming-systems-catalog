...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/3dcitydb-mcp-server/](https://pypi.org/project/3dcitydb-mcp-server/) |
| Source record ids | pypi_simple-a8814c6500a17b |
...
For a systems engineer, 3dcitydb-mcp-server belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-06-01T21:35:02.552948Z | [https://pypi.org/pypi/3dcitydb-mcp-server/json](https://pypi.org/pypi/3dcitydb-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/3dcitydb-mcp-server/json` at `2026-09-01T03:20:33+00:00`.
...
- `pypi_simple-a8814c6500a17b` from `pypi_simple` as `registry_expansion`
