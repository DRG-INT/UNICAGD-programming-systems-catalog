...
<!-- canonical: https://packagist.org/packages/nahid/jsonq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nahid/jsonq](https://packagist.org/packages/nahid/jsonq) |
| Source record ids | packagist_search-9c24697b849769 |
...
For a systems engineer, nahid/jsonq belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-9c24697b849769` from `packagist_search` as `registry_expansion`
