...
<!-- canonical: https://cran.r-project.org/web/packages/AddiVortes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AddiVortes/index.html](https://cran.r-project.org/web/packages/AddiVortes/index.html) |
| Source record ids | cran_packages_by_date-d7e7ca0f28332a |
...
For a systems engineer, AddiVortes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.9 | 2026-08-04 00:20:02 UTC | [https://cran.r-project.org/web/packages/AddiVortes/DESCRIPTION](https://cran.r-project.org/web/packages/AddiVortes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AddiVortes/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d7e7ca0f28332a` from `cran_packages_by_date` as `registry_expansion`
