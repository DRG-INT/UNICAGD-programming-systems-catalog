...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Zeloksa/Cardputer-ADV-CSI-Radar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zeloksa/Cardputer-ADV-CSI-Radar](https://github.com/Zeloksa/Cardputer-ADV-CSI-Radar) |
| Source record ids | github_search_radars-33cd45a7310ee4 |

## System Engineer Summary

Radar V1.5 ADV: High-performance Wi-Fi CSI sensing for M5Stack Cardputer ADV. Features Dual-Core
FreeRTOS architecture, 200+ PPS capture, 2D spatial profiles, and Smart Power Management.

## Operational Role

For a systems engineer, Zeloksa/Cardputer-ADV-CSI-Radar belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T17:12:50Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-33cd45a7310ee4` from `github_search_radars` as `registry_expansion`
