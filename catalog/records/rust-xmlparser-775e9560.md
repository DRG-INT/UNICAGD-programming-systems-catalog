...
<!-- canonical: https://crates.io/crates/xmlparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/xmlparser](https://crates.io/crates/xmlparser) |
| Source record ids | crates_io-e56950eb60d6f5 |
...
For a systems engineer, xmlparser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.6 | 2023-09-30T15:21:25.478529Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-e56950eb60d6f5` from `crates_io` as `registry_expansion`
