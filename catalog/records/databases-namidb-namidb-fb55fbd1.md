...
<!-- canonical: https://github.com/namidb/namidb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/namidb/namidb](https://github.com/namidb/namidb) |
| Source record ids | github_search_databases-77a0daa650fba8 |
...
For a systems engineer, namidb/namidb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T10:09:45Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-77a0daa650fba8` from `github_search_databases` as `registry_expansion`
