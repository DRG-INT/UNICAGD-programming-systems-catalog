...
<!-- canonical: https://github.com/863683348/dsh-plugin-audit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/863683348/dsh-plugin-audit](https://github.com/863683348/dsh-plugin-audit) |
| Source record ids | github_search_repertoare_catalogs-15da1fe24c7bbe |

## System Engineer Summary

Plugin health audit for DeepSeek Harness: sync the GitHub dsh-plugin topic into a local catalog,
probe npm, static-scan for security, score every plugin, and rank them in a web leaderboard.

## Operational Role

For a systems engineer, 863683348/dsh-plugin-audit belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T05:33:57Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-15da1fe24c7bbe` from `github_search_repertoare_catalogs` as `registry_expansion`
