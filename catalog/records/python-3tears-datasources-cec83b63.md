...
<!-- canonical: https://pypi.org/project/3tears-datasources/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/3tears-datasources/](https://pypi.org/project/3tears-datasources/) |
| Source record ids | pypi_simple-0f315039c2e4b6 |

## System Engineer Summary

datasource entities, collections, namespace helpers, agent-yaml config model + driver abstraction
for postgres/redshift/snowflake/bigquery backends

## Operational Role

For a systems engineer, 3tears-datasources belongs in the Python inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.1 | 2026-09-01T01:25:04.918187Z | [https://pypi.org/pypi/3tears-datasources/json](https://pypi.org/pypi/3tears-datasources/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/3tears-datasources/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-0f315039c2e4b6` from `pypi_simple` as `registry_expansion`
