...
<!-- canonical: https://github.com/runtimeverification/wasm-semantics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/runtimeverification/wasm-semantics](https://github.com/runtimeverification/wasm-semantics) |
| Source record ids | github_search_webassembly-5159595027f5f6 |
...
For a systems engineer, runtimeverification/wasm-semantics belongs in the WebAssembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.157 | 2026-07-30T07:52:55Z | [https://api.github.com/repos/runtimeverification/wasm-semantics/releases/latest](https://api.github.com/repos/runtimeverification/wasm-semantics/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/runtimeverification/wasm-semantics/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-5159595027f5f6` from `github_search_webassembly` as `registry_expansion`
