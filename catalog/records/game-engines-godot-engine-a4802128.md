...
| Source record ids | curated_language_routes-24dcd037b12ccd |

## System Engineer Summary

Open-source game engine for 2D/3D games, editor tooling, scripting, rendering, physics, and exports.

## Operational Role

For a systems engineer, Godot Engine belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.7.2-stable | 2026-08-18T16:12:28Z | [https://api.github.com/repos/godotengine/godot/releases/latest](https://api.github.com/repos/godotengine/godot/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/godotengine/godot/releases/latest` at `2026-09-01T12:30:34+00:00`.
...
- `curated_language_routes-24dcd037b12ccd` from `curated_language_routes` as `registry_expansion`
