...
| Canonical URL | [https://crates.io/crates/ar_archive_writer](https://crates.io/crates/ar_archive_writer) |
| Source record ids | crates_io-6537e4585ad31b |
...
For a systems engineer, ar_archive_writer belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-07-31T15:00:01.806640Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-6537e4585ad31b` from `crates_io` as `registry_expansion`
