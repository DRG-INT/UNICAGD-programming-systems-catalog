...
<!-- canonical: https://luarocks.org/modules/shakesoda/cpml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/shakesoda/cpml](https://luarocks.org/modules/shakesoda/cpml) |
| Source record ids | luarocks_root_manifest-904817d7f131e1 |
...
For a systems engineer, cpml belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-904817d7f131e1` from `luarocks_root_manifest` as `registry_expansion`
