...
<!-- canonical: https://hackage.haskell.org/package/HaTeX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HaTeX](https://hackage.haskell.org/package/HaTeX) |
| Source record ids | hackage_top_downloads-ead580d3956e8e |
...
For a systems engineer, HaTeX belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.23.0.2 | 2026-06-11T15:49:40Z | [https://hackage.haskell.org/package/HaTeX](https://hackage.haskell.org/package/HaTeX) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HaTeX` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-ead580d3956e8e` from `hackage_top_downloads` as `registry_expansion`
