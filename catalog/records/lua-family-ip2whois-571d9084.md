...
| Canonical URL | [https://luarocks.org/modules/ip2whois/ip2whois](https://luarocks.org/modules/ip2whois/ip2whois) |
| Source record ids | luarocks_root_manifest-14db67f1714666 |

## System Engineer Summary

ip2whois is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, ip2whois belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-14db67f1714666` from `luarocks_root_manifest` as `registry_expansion`
