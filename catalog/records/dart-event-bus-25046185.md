...
<!-- canonical: https://pub.dev/packages/event_bus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/event_bus](https://pub.dev/packages/event_bus) |
| Source record ids | pub_dev-6bf9dc010efedd |
...
For a systems engineer, event_bus belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2024-09-23T10:58:22.135203Z | [https://pub.dev/api/packages/event_bus](https://pub.dev/api/packages/event_bus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/event_bus` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-6bf9dc010efedd` from `pub_dev` as `registry_expansion`
