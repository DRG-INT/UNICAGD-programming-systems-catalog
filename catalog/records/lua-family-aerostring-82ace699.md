...
<!-- canonical: https://luarocks.org/modules/aeroforger/aerostring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aeroforger/aerostring](https://luarocks.org/modules/aeroforger/aerostring) |
| Source record ids | luarocks_root_manifest-e40ddab4b1431d |
...
For a systems engineer, AeroString belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e40ddab4b1431d` from `luarocks_root_manifest` as `registry_expansion`
...
| awesomewm-autostart | Filesystem Os | [open](lua-family-awesomewm-autostart-4c2012b1.md) |
