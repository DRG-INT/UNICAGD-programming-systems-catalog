...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/symfony/serializer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/serializer](https://packagist.org/packages/symfony/serializer) |
| Source record ids | packagist_search-e82a0d9396d587 |

## System Engineer Summary

Handles serializing and deserializing data structures, including object graphs, into array
structures or other formats like XML and JSON.

## Operational Role

For a systems engineer, symfony/serializer belongs in the PHP inventory as part of low-noise code
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-07 | `{"kind": "packagist_search_and_p2_api", "query": "json", "retrieved": "2026-09-07", "status": "registry-derived"}` |
...
- `packagist_search-e82a0d9396d587` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| iconify/json | Formatter | [open](php-iconify-json-90cf51ea.md) |
| kartik-v/yii2-export | Formatter | [open](php-kartik-v-yii2-export-d0718c10.md) |
| kigkonsult/icalcreator | Formatter | [open](php-kigkonsult-icalcreator-4d88cb23.md) |
| nilportugues/sql-query-formatter | Formatter | [open](php-nilportugues-sql-query-formatter-cbf8ab7c.md) |
| phpunit/php-code-coverage | Formatter | [open](php-phpunit-php-code-coverage-8e22e1f3.md) |
