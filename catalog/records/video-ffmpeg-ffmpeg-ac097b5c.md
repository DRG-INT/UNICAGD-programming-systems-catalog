...
| Source record ids | github_search_video-ecb3a5005b079b |

## System Engineer Summary

FFmpeg/FFmpeg is tracked as a networking http record in the Video branch. The source did not provide
...
For a systems engineer, FFmpeg/FFmpeg belongs in the Video inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:21:50Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ecb3a5005b079b` from `github_search_video` as `registry_expansion`
