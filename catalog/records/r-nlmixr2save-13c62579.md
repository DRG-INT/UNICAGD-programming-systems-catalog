...
<!-- canonical: https://cran.r-project.org/web/packages/nlmixr2save/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nlmixr2save/index.html](https://cran.r-project.org/web/packages/nlmixr2save/index.html) |
| Source record ids | cran_packages_by_date-cf2e07118b81fe |

## System Engineer Summary

Save 'nlmixr2' Fits in a Format Readable Outside 'nlmixr2'

## Operational Role

For a systems engineer, nlmixr2save belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-05 00:20:02 UTC | [https://cran.r-project.org/web/packages/nlmixr2save/DESCRIPTION](https://cran.r-project.org/web/packages/nlmixr2save/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nlmixr2save/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cf2e07118b81fe` from `cran_packages_by_date` as `registry_expansion`
