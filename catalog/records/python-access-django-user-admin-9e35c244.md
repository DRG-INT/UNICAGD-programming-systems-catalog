...
<!-- canonical: https://pypi.org/project/access-django-user-admin/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/access-django-user-admin/](https://pypi.org/project/access-django-user-admin/) |
| Source record ids | pypi_simple-bd45a4d247630f |

## System Engineer Summary

Django User Admin for ACCESS Django Apps

## Operational Role

For a systems engineer, access-django-user-admin belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-06T11:34:08.271822Z | [https://pypi.org/pypi/access-django-user-admin/json](https://pypi.org/pypi/access-django-user-admin/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/access-django-user-admin/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-bd45a4d247630f` from `pypi_simple` as `registry_expansion`
