...
| Source record ids | github_search_game_engines-5366cf445b2e01 |
...
For a systems engineer, bevyengine/bevy belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:50:39Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-5366cf445b2e01` from `github_search_game_engines` as `registry_expansion`
