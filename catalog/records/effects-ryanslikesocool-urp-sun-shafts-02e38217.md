...
<!-- canonical: https://github.com/ryanslikesocool/URP-Sun-Shafts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ryanslikesocool/URP-Sun-Shafts](https://github.com/ryanslikesocool/URP-Sun-Shafts) |
| Source record ids | github_search_effects-51a01780a41bc7 |
...
For a systems engineer, ryanslikesocool/URP-Sun-Shafts belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-15T01:43:59Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-51a01780a41bc7` from `github_search_effects` as `registry_expansion`
