...
<!-- canonical: https://github.com/sicmutils/sicmutils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sicmutils/sicmutils](https://github.com/sicmutils/sicmutils) |
| Source record ids | github_search_physics_engines-bc75f4a794c594 |
...
For a systems engineer, sicmutils/sicmutils belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-18T13:30:25Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-bc75f4a794c594` from `github_search_physics_engines` as `registry_expansion`
