...
<!-- canonical: https://cran.r-project.org/web/packages/evola/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/evola/index.html](https://cran.r-project.org/web/packages/evola/index.html) |
| Source record ids | cran_packages_by_date-63cbe0fc364c3d |

## System Engineer Summary

evola is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, evola belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9 | 2026-09-11 06:30:12 UTC | [https://cran.r-project.org/web/packages/evola/DESCRIPTION](https://cran.r-project.org/web/packages/evola/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/evola/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-63cbe0fc364c3d` from `cran_packages_by_date` as `registry_expansion`
