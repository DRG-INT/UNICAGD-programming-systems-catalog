...
<!-- canonical: https://cran.r-project.org/web/packages/riskutility/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/riskutility/index.html](https://cran.r-project.org/web/packages/riskutility/index.html) |
| Source record ids | cran_packages_by_date-be69919584bf1c |
...
For a systems engineer, riskutility belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-02 09:50:02 UTC | [https://cran.r-project.org/web/packages/riskutility/DESCRIPTION](https://cran.r-project.org/web/packages/riskutility/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/riskutility/DESCRIPTION` at `2026-09-02T10:21:04+00:00`.
...
- `cran_packages_by_date-be69919584bf1c` from `cran_packages_by_date` as `registry_expansion`
