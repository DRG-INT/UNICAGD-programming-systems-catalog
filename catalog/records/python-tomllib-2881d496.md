...
| Source record ids | corpus-ee85826ade703e |

## System Engineer Summary

tomllib is tracked as a serialization record in the Python branch. The source did not provide a long
...
For a systems engineer, tomllib belongs in the Python inventory as part of wire formats,
...
- `corpus-ee85826ade703e` from `master_json` as `serialization`
