...
<!-- canonical: https://github.com/hannesbraun/airwindows-lv2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hannesbraun/airwindows-lv2](https://github.com/hannesbraun/airwindows-lv2) |
| Source record ids | github_search_audio-f7a51ba21c2d55 |
...
For a systems engineer, hannesbraun/airwindows-lv2 belongs in the Audio inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-27T12:32:25Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-f7a51ba21c2d55` from `github_search_audio` as `registry_expansion`
