...
<!-- canonical: https://pypi.org/project/address-finder-data-p01/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-finder-data-p01/](https://pypi.org/project/address-finder-data-p01/) |
| Source record ids | pypi_simple-95ad771c0df7b9 |

## System Engineer Summary

address-finder data chunk p01 - contains address_parser_crf.dat part 2/5

## Operational Role

For a systems engineer, address-finder-data-p01 belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-03-20T17:34:51.616950Z | [https://pypi.org/pypi/address-finder-data-p01/json](https://pypi.org/pypi/address-finder-data-p01/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-finder-data-p01/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-95ad771c0df7b9` from `pypi_simple` as `registry_expansion`
