...
<!-- canonical: https://github.com/gornskew/chartroom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gornskew/chartroom](https://github.com/gornskew/chartroom) |
| Source record ids | github_search_basilisk-275cc532ededcb |

## System Engineer Summary

Astrodynamic Navigation Chart Room for the Basilisk bio-hull space ship &+ astrodyn solver code.

## Operational Role

For a systems engineer, gornskew/chartroom belongs in the Basilisk inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T11:12:04Z | gh search repos basilisk astrodynamics | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-275cc532ededcb` from `github_search_basilisk` as `registry_expansion`
