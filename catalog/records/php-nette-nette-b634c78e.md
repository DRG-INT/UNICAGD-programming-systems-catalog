...
<!-- canonical: https://packagist.org/packages/nette/nette -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nette/nette](https://packagist.org/packages/nette/nette) |
| Source record ids | packagist_search-aa39da481972df |

## System Engineer Summary

👪 Nette Framework - innovative framework for fast and easy development of secured web applications
in PHP (metapackage)

## Operational Role

For a systems engineer, nette/nette belongs in the PHP inventory as part of language tooling, code
...
- `packagist_search-aa39da481972df` from `packagist_search` as `registry_expansion`
