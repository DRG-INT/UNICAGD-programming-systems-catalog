...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CMDimData](https://github.com/JuliaRegistries/General/tree/master/C/CMDimData) |
| Source record ids | julia_general-e581efb2c0dd8a |

## System Engineer Summary

Julia package registered in General at C/CMDimData.

## Operational Role

For a systems engineer, CMDimData belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CMDimData", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e581efb2c0dd8a` from `julia_general` as `registry_expansion`
