...
<!-- canonical: https://crates.io/crates/lexical-write-integer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lexical-write-integer](https://crates.io/crates/lexical-write-integer) |
| Source record ids | crates_io-04878b466848ac |
...
For a systems engineer, lexical-write-integer belongs in the Rust inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2025-09-21T03:34:35.057671Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-04878b466848ac` from `crates_io` as `registry_expansion`
