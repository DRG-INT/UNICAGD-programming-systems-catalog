...
<!-- canonical: https://github.com/Shealynntate/Pixel-Burn-Effect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Shealynntate/Pixel-Burn-Effect](https://github.com/Shealynntate/Pixel-Burn-Effect) |
| Source record ids | github_search_effects-f7bd12250be34a |
...
For a systems engineer, Shealynntate/Pixel-Burn-Effect belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-17T19:07:14Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f7bd12250be34a` from `github_search_effects` as `registry_expansion`
