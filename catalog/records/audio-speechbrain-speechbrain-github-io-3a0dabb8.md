...
<!-- canonical: https://github.com/speechbrain/speechbrain.github.io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/speechbrain/speechbrain.github.io](https://github.com/speechbrain/speechbrain.github.io) |
| Source record ids | github_search_audio-1e45603da0fd66 |

## System Engineer Summary

The SpeechBrain project aims to build a novel speech toolkit fully based on PyTorch. With
SpeechBrain users can easily create speech processing systems, ranging from speech recognition (both
HMM/DNN and end-to-end), speaker recognition, speech enhancement, speech separation, multi-
microphone speech processing, and many others.

## Operational Role

For a systems engineer, speechbrain/speechbrain.github.io belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-18T15:10:38Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-1e45603da0fd66` from `github_search_audio` as `registry_expansion`
