...
<!-- canonical: https://github.com/rjsmethurst/ebvpy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rjsmethurst/ebvpy](https://github.com/rjsmethurst/ebvpy) |
| Source record ids | github_search_space_maps-3e8f874ebcc3cc |

## System Engineer Summary

A python astronomy function to calculate the E(B-V) reddening value for a source at a specific
location on the sky using the Schlegel et al. (1998) dust maps

## Operational Role

For a systems engineer, rjsmethurst/ebvpy belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-05-19T14:02:54Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-3e8f874ebcc3cc` from `github_search_space_maps` as `registry_expansion`
