...
| Canonical URL | [https://crates.io/crates/tabled_derive](https://crates.io/crates/tabled_derive) |
| Source record ids | crates_io-e16e7059f05ead |
...
For a systems engineer, tabled_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2025-04-24T20:51:13.478319Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-e16e7059f05ead` from `crates_io` as `registry_expansion`
