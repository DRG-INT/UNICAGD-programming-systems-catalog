...
| Canonical URL | [https://luarocks.org/modules/kelvinwierks/keycloak-rbac](https://luarocks.org/modules/kelvinwierks/keycloak-rbac) |
| Source record ids | luarocks_root_manifest-104c2fc991a0f4 |

## System Engineer Summary

A Kong plugin for implementing RBAC functionality within the keycloak JWT

## Operational Role

For a systems engineer, keycloak-rbac belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-104c2fc991a0f4` from `luarocks_root_manifest` as `registry_expansion`
