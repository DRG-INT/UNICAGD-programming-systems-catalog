...
<!-- canonical: https://cran.r-project.org/web/packages/weird/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/weird/index.html](https://cran.r-project.org/web/packages/weird/index.html) |
| Source record ids | cran_packages_by_date-34bf640760a8a1 |
...
For a systems engineer, weird belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-09-07 06:40:02 UTC | [https://cran.r-project.org/web/packages/weird/DESCRIPTION](https://cran.r-project.org/web/packages/weird/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/weird/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-34bf640760a8a1` from `cran_packages_by_date` as `registry_expansion`
