...
<!-- canonical: https://crates.io/crates/plain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/plain](https://crates.io/crates/plain) |
| Source record ids | crates_io-d56ccf08ceeace |
...
For a systems engineer, plain belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2017-11-24T15:28:33.966750Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-d56ccf08ceeace` from `crates_io` as `registry_expansion`
