...
<!-- canonical: https://www.npmjs.com/package/vike-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/vike-server](https://www.npmjs.com/package/vike-server) |
| Source record ids | npm_registry-397e3efd1993ae |

## System Engineer Summary

vike-server is tracked as a documentation record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, vike-server belongs in the Node.js/JavaScript inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.25 | 2025-10-20T19:27:02.608Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-397e3efd1993ae` from `npm_registry` as `registry_expansion`
