...
<!-- canonical: https://pypi.org/project/admin-chart-django/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/admin-chart-django/](https://pypi.org/project/admin-chart-django/) |
| Source record ids | pypi_simple-9f96b1d15b283f |
...
For a systems engineer, admin-chart-django belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2024-10-26T06:00:25.430333Z | [https://pypi.org/pypi/admin-chart-django/json](https://pypi.org/pypi/admin-chart-django/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/admin-chart-django/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-9f96b1d15b283f` from `pypi_simple` as `registry_expansion`
