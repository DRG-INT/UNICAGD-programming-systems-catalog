...
<!-- canonical: https://cran.r-project.org/web/packages/multiSA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multiSA/index.html](https://cran.r-project.org/web/packages/multiSA/index.html) |
| Source record ids | cran_packages_by_date-1f87b83d2feb1b |

## System Engineer Summary

multiSA is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, multiSA belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-04 07:20:02 UTC | [https://cran.r-project.org/web/packages/multiSA/DESCRIPTION](https://cran.r-project.org/web/packages/multiSA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multiSA/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-1f87b83d2feb1b` from `cran_packages_by_date` as `registry_expansion`
