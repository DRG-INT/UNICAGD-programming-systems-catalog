...
| Canonical URL | [https://packagist.org/packages/chrisboulton/php-resque](https://packagist.org/packages/chrisboulton/php-resque) |
| Source record ids | packagist_search-92ef85dbd58fdc |

## System Engineer Summary

Redis backed library for creating background jobs and processing them later. Based on resque for
Ruby.

## Operational Role

For a systems engineer, chrisboulton/php-resque belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2012-10-13T07:28:16+00:00 | [https://repo.packagist.org/p2/chrisboulton/php-resque.json](https://repo.packagist.org/p2/chrisboulton/php-resque.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/chrisboulton/php-resque.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-92ef85dbd58fdc` from `packagist_search` as `registry_expansion`
