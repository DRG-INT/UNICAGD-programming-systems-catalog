...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/royerlab/napari-mcp](https://github.com/royerlab/napari-mcp) |
| Source record ids | github_search_microscopy-65d3843edd094c |

## System Engineer Summary

🔬 MCP server for AI-powered napari control. Connect Claude, ChatGPT, Cursor, and other LLMs to
napari for interactive image analysis. Perfect for automating microscopy workflows and building
intelligent image analysis tools.

## Operational Role

For a systems engineer, royerlab/napari-mcp belongs in the Microscopy inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.0 | 2026-03-25T18:17:58Z | [https://api.github.com/repos/royerlab/napari-mcp/releases/latest](https://api.github.com/repos/royerlab/napari-mcp/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/royerlab/napari-mcp/releases/latest` at `2026-09-01T11:22:10+00:00`.
...
- `github_search_microscopy-65d3843edd094c` from `github_search_microscopy` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| labsyspharm/minerva-story | Build System | [open](microscopy-labsyspharm-minerva-story-6e0a209a.md) |
| lemonspurple/DIY-Scanning-Tunneling-Microscope | Build System | [open](microscopy-lemonspurple-diy-scanning-tunneling-microscope-5995151b.md) |
| saeyslab/harpy | Build System | [open](microscopy-saeyslab-harpy-13fb4e50.md) |
