...
<!-- canonical: https://github.com/xmikos/soapy_power -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xmikos/soapy_power](https://github.com/xmikos/soapy_power) |
| Source record ids | github_search_electromagnetoscopes-dd997b82ef9fad |

## System Engineer Summary

Obtain power spectrum from SoapySDR devices (RTL-SDR, Airspy, SDRplay, HackRF, bladeRF, USRP,
LimeSDR, etc.)

## Operational Role

For a systems engineer, xmikos/soapy_power belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-22T16:31:16Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-dd997b82ef9fad` from `github_search_electromagnetoscopes` as `registry_expansion`
