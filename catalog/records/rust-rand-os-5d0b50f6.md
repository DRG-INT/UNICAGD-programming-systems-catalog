...
<!-- canonical: https://crates.io/crates/rand_os -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_os](https://crates.io/crates/rand_os) |
| Source record ids | crates_io-768f51db9a3126 |
...
For a systems engineer, rand_os belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2019-08-28T14:24:22.432373Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-05T12:22:41+00:00`.
...
- `crates_io-768f51db9a3126` from `crates_io` as `registry_expansion`
