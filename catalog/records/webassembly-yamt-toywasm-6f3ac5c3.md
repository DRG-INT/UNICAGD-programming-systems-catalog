...
<!-- canonical: https://github.com/yamt/toywasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yamt/toywasm](https://github.com/yamt/toywasm) |
| Source record ids | github_search_webassembly-fe6296dd4a7aa2 |
...
For a systems engineer, yamt/toywasm belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T12:01:04Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-fe6296dd4a7aa2` from `github_search_webassembly` as `registry_expansion`
