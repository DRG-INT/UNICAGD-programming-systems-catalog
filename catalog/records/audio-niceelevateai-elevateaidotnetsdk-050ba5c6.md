...
<!-- canonical: https://github.com/NICEElevateAI/ElevateAIDotNetSDK -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NICEElevateAI/ElevateAIDotNetSDK](https://github.com/NICEElevateAI/ElevateAIDotNetSDK) |
| Source record ids | github_search_audio-8807daae563ca4 |
...
For a systems engineer, NICEElevateAI/ElevateAIDotNetSDK belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-04T17:13:00Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-8807daae563ca4` from `github_search_audio` as `registry_expansion`
