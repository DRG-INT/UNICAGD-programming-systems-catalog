...
<!-- canonical: https://github.com/Noofbiz/engoBox2dSystem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Noofbiz/engoBox2dSystem](https://github.com/Noofbiz/engoBox2dSystem) |
| Source record ids | github_search_physics_engines-3273f3ff411773 |

## System Engineer Summary

Physics, Collision, and Mouse systems for the Engo game engine that utilizes ByteArena's box2d Go
port

## Operational Role

For a systems engineer, Noofbiz/engoBox2dSystem belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-29T06:05:59Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-3273f3ff411773` from `github_search_physics_engines` as `registry_expansion`
