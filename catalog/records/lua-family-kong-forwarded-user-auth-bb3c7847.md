...
| Canonical URL | [https://luarocks.org/modules/upyun/kong-forwarded-user-auth](https://luarocks.org/modules/upyun/kong-forwarded-user-auth) |
| Source record ids | luarocks_root_manifest-ce02fa9a443cf3 |
...
For a systems engineer, kong-forwarded-user-auth belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-ce02fa9a443cf3` from `luarocks_root_manifest` as `registry_expansion`
