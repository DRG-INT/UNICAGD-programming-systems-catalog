...
<!-- canonical: https://cran.r-project.org/web/packages/wintime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wintime/index.html](https://cran.r-project.org/web/packages/wintime/index.html) |
| Source record ids | cran_packages_by_date-0e2b8a4ea77d28 |
...
For a systems engineer, wintime belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-11 15:50:02 UTC | [https://cran.r-project.org/web/packages/wintime/DESCRIPTION](https://cran.r-project.org/web/packages/wintime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wintime/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-0e2b8a4ea77d28` from `cran_packages_by_date` as `registry_expansion`
