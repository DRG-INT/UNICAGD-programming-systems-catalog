...
<!-- canonical: https://cran.r-project.org/web/packages/fdic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fdic/index.html](https://cran.r-project.org/web/packages/fdic/index.html) |
| Source record ids | cran_packages_by_date-b8e685ed53740b |

## System Engineer Summary

Interface to 'BankFind Suite API'

## Operational Role

For a systems engineer, fdic belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-12 14:50:02 UTC | [https://cran.r-project.org/web/packages/fdic/DESCRIPTION](https://cran.r-project.org/web/packages/fdic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fdic/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-b8e685ed53740b` from `cran_packages_by_date` as `registry_expansion`
