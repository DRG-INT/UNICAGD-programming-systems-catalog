...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ronitsingh10/FineTune -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Swift |
| Category | Language Specification |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/ronitsingh10/FineTune](https://github.com/ronitsingh10/FineTune) |
| Source record ids | github_search_swift-6fe22a3c3d849d |

## System Engineer Summary

FineTune, a macOS menu bar app for per-app volume control, multi-device output, audio routing, and
10-band EQ. Free and open-source alternative to SoundSource.

## Operational Role

For a systems engineer, ronitsingh10/FineTune belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-09T07:54:56Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Swift stars:>1000", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_swift-6fe22a3c3d849d` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| About Swift | Language Specification | [open](swift-about-swift-8bde498c.md) |
| airbnb/lottie-ios | Language Specification | [open](swift-airbnb-lottie-ios-63aa9a28.md) |
| Alamofire/Alamofire | Language Specification | [open](swift-alamofire-alamofire-33377646.md) |
| alienator88/Pearcleaner | Language Specification | [open](swift-alienator88-pearcleaner-bea02e76.md) |
| allenwong/30DaysofSwift | Language Specification | [open](swift-allenwong-30daysofswift-c4ccdfef.md) |
| altic-dev/FluidVoice | Language Specification | [open](swift-altic-dev-fluidvoice-f4158d5b.md) |
| altstoreio/AltStore | Language Specification | [open](swift-altstoreio-altstore-27603fa2.md) |
| AppHouseKitchen/AlDente-Battery_Care_and_Monitoring | Language Specification | [open](swift-apphousekitchen-aldente-battery-care-and-monitoring-af6d47ab.md) |
