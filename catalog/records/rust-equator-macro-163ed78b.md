...
<!-- canonical: https://crates.io/crates/equator-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/equator-macro](https://crates.io/crates/equator-macro) |
| Source record ids | crates_io-737565bc08468e |
...
For a systems engineer, equator-macro belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2025-10-20T07:59:38.359870Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Microsoft.IdentityModel.JsonWebTokens/8.22.0/license |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-07T06:28:02+00:00`.
...
- `crates_io-737565bc08468e` from `crates_io` as `registry_expansion`
