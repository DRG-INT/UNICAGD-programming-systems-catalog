...
<!-- canonical: https://github.com/uiucsn/ztf-dr-vars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uiucsn/ztf-dr-vars](https://github.com/uiucsn/ztf-dr-vars) |
| Source record ids | github_search_space_maps-b1275e70b20aa9 |

## System Engineer Summary

Variable star catalogs cross-matching with ZTF DR

## Operational Role

For a systems engineer, uiucsn/ztf-dr-vars belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-27T13:23:45Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b1275e70b20aa9` from `github_search_space_maps` as `registry_expansion`
