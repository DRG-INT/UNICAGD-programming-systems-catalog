...
<!-- canonical: https://gitlab.com/components/sast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/components/sast](https://gitlab.com/components/sast) |
| Source record ids | gitlab_projects_api-f4603881b8b4fa |
...
For a systems engineer, components/sast belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-f4603881b8b4fa` from `gitlab_projects_api` as `registry_expansion`
