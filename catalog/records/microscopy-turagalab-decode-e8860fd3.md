...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TuragaLab/DECODE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TuragaLab/DECODE](https://github.com/TuragaLab/DECODE) |
| Source record ids | github_search_microscopy-e530a2cb1e4919 |

## System Engineer Summary

This is the official implementation of our publication "Deep learning enables fast and dense single-
molecule localization with high accuracy" (Nature Methods)

## Operational Role

For a systems engineer, TuragaLab/DECODE belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-22T11:37:19Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-e530a2cb1e4919` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| chanzuckerberg/napari-hub | Undefined Behavior Analyzer | [open](microscopy-chanzuckerberg-napari-hub-082ae11f.md) |
| czbiohub-sf/iohub | Undefined Behavior Analyzer | [open](microscopy-czbiohub-sf-iohub-5a760ae0.md) |
| imagingbook/imagingbook-public | Undefined Behavior Analyzer | [open](microscopy-imagingbook-imagingbook-public-35b63f87.md) |
| JaneliaSciComp/fileglancer | Undefined Behavior Analyzer | [open](microscopy-janeliascicomp-fileglancer-a4aeb3db.md) |
| mbalatsko/opencv-rolling-ball | Undefined Behavior Analyzer | [open](microscopy-mbalatsko-opencv-rolling-ball-64eeb75a.md) |
| Mmasoud1/HistoJS | Undefined Behavior Analyzer | [open](microscopy-mmasoud1-histojs-cfc6aaff.md) |
| MWod/DeepHistReg | Undefined Behavior Analyzer | [open](microscopy-mwod-deephistreg-fe9489ee.md) |
| pavikonda/RaspberryPi_FPScope | Undefined Behavior Analyzer | [open](microscopy-pavikonda-raspberrypi-fpscope-b49fb783.md) |
