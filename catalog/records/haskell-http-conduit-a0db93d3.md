...
<!-- canonical: https://hackage.haskell.org/package/http-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http-conduit](https://hackage.haskell.org/package/http-conduit) |
| Source record ids | hackage_top_downloads-0386f9f56a4177 |

## System Engineer Summary

Hackage package with 327 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, http-conduit belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.9.1 | 2024-10-27T07:49:09Z | [https://hackage.haskell.org/package/http-conduit](https://hackage.haskell.org/package/http-conduit) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http-conduit` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-0386f9f56a4177` from `hackage_top_downloads` as `registry_expansion`
