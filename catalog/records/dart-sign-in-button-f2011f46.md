...
<!-- canonical: https://pub.dev/packages/sign_in_button -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sign_in_button](https://pub.dev/packages/sign_in_button) |
| Source record ids | pub_dev-dee6f054839b52 |
...
For a systems engineer, sign_in_button belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-05-18T15:35:22.222767Z | [https://pub.dev/api/packages/sign_in_button](https://pub.dev/api/packages/sign_in_button) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sign_in_button` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-dee6f054839b52` from `pub_dev` as `registry_expansion`
