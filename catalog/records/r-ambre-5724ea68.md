...
<!-- canonical: https://cran.r-project.org/web/packages/ambre/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ambre/index.html](https://cran.r-project.org/web/packages/ambre/index.html) |
| Source record ids | cran_packages_by_date-572f08c5e1d3e8 |
...
For a systems engineer, ambre belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2026-09-04 19:50:02 UTC | [https://cran.r-project.org/web/packages/ambre/DESCRIPTION](https://cran.r-project.org/web/packages/ambre/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ambre/DESCRIPTION` at `2026-09-04T20:19:05+00:00`.
...
- `cran_packages_by_date-572f08c5e1d3e8` from `cran_packages_by_date` as `registry_expansion`
