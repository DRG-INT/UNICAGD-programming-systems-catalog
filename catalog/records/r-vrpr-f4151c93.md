...
<!-- canonical: https://cran.r-project.org/web/packages/vrpr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vrpr/index.html](https://cran.r-project.org/web/packages/vrpr/index.html) |
| Source record ids | cran_packages_by_date-09acddf9f258b8 |
...
For a systems engineer, vrpr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-27 12:00:02 UTC | [https://cran.r-project.org/web/packages/vrpr/DESCRIPTION](https://cran.r-project.org/web/packages/vrpr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vrpr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-09acddf9f258b8` from `cran_packages_by_date` as `registry_expansion`
