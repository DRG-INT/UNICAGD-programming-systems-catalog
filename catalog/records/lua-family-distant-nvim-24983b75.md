...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Language Server](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-server.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/neorocks/distant.nvim](https://luarocks.org/modules/neorocks/distant.nvim) |
| Source record ids | luarocks_root_manifest-d6b2d6b00cd7e0 |

## System Engineer Summary

Edit files, run programs, and work with LSP on a remote machine from the comfort of your local
environment

## Operational Role

For a systems engineer, distant.nvim belongs in the Lua family inventory as part of editor
...
| Name | Category | Page |
| --- | --- | --- |
| actions-preview.nvim | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-actions-preview-nvim-cbd68bc2.md) |
| cmp-nvim-lsp | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cmp-nvim-lsp-0635b295.md) |
| easy-lsp | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-easy-lsp-15d027ae.md) |
| EmmyLua language server | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-emmylua-language-server-01d43d78.md) |
| fidget.nvim | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-fidget-nvim-f92a8be4.md) |
| flutter-tools.nvim | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-flutter-tools-nvim-0fd185d8.md) |
| glance.nvim | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-glance-nvim-b28bc5b6.md) |
| haskell-snippets.nvim | Language Server | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-haskell-snippets-nvim-bbc03765.md) |
