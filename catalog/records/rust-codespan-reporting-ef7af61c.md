...
<!-- canonical: https://crates.io/crates/codespan-reporting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/codespan-reporting](https://crates.io/crates/codespan-reporting) |
| Source record ids | crates_io-a52995fab1b355 |
...
For a systems engineer, codespan-reporting belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.1 | 2025-10-22T11:47:14.098594Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-a52995fab1b355` from `crates_io` as `registry_expansion`
