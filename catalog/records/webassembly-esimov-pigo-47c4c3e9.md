...
<!-- canonical: https://github.com/esimov/pigo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/esimov/pigo](https://github.com/esimov/pigo) |
| Source record ids | github_search_webassembly-6a12b051a902a1 |

## System Engineer Summary

Fast face detection, pupil/eyes localization and facial landmark points detection library in pure
Go.

## Operational Role

For a systems engineer, esimov/pigo belongs in the WebAssembly inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-03T15:07:42Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6a12b051a902a1` from `github_search_webassembly` as `registry_expansion`
