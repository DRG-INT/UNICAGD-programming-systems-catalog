...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/egemenimre/satkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/egemenimre/satkit](https://github.com/egemenimre/satkit) |
| Source record ids | github_search_space_engines-205161874143be |
...
For a systems engineer, egemenimre/satkit belongs in the Space Engines inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-11T21:57:30Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-205161874143be` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alfonsogonzalez/AWP | Static Analyzer | [open](space-engines-alfonsogonzalez-awp-f84d3aa5.md) |
| alopezrivera/huracan | Static Analyzer | [open](space-engines-alopezrivera-huracan-6e1c9cbf.md) |
| ansys/pystk | Static Analyzer | [open](space-engines-ansys-pystk-9e9adf00.md) |
| arda-guler/LETALIS | Static Analyzer | [open](space-engines-arda-guler-letalis-bdbe2639.md) |
| Arrowstar/ksptot | Static Analyzer | [open](space-engines-arrowstar-ksptot-7a1c2c0b.md) |
| deflorio/SpOCK | Static Analyzer | [open](space-engines-deflorio-spock-158b80b1.md) |
| dpad/OrbitalTrajectories.jl | Static Analyzer | [open](space-engines-dpad-orbitaltrajectories-jl-29cbef22.md) |
| egemenimre/satmad | Static Analyzer | [open](space-engines-egemenimre-satmad-1c22bd56.md) |
