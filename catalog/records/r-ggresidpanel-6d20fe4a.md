...
<!-- canonical: https://cran.r-project.org/web/packages/ggResidpanel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggResidpanel/index.html](https://cran.r-project.org/web/packages/ggResidpanel/index.html) |
| Source record ids | cran_packages_by_date-ecb055bdf91187 |
...
For a systems engineer, ggResidpanel belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-05 15:40:20 UTC | [https://cran.r-project.org/web/packages/ggResidpanel/DESCRIPTION](https://cran.r-project.org/web/packages/ggResidpanel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggResidpanel/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-ecb055bdf91187` from `cran_packages_by_date` as `registry_expansion`
