...
<!-- canonical: https://gnu-octave.github.io/packages/statistics-resampling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/statistics-resampling](https://gnu-octave.github.io/packages/statistics-resampling) |
| Source record ids | octave_packages_index-6a95f573600842 |

## System Engineer Summary

Estimate bias, uncertainty (standard errors and confidence intervals) and test hypotheses using
resampling methods. (Note that versions of this package <= 5.4.3 are named 'statistics-bootstrap').

## Operational Role

For a systems engineer, statistics-resampling belongs in the Octave inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.7.1 | 2026-07-06 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-6a95f573600842` from `octave_packages_index` as `registry_expansion`
