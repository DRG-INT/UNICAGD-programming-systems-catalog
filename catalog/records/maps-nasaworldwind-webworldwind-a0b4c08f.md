...
| Source record ids | github_search_maps-bf4a0a5bee0424 |

## System Engineer Summary

The NASA WorldWind Javascript SDK (WebWW) includes the library and examples for creating geo-browser
web applications and for embedding a 3D globe in HTML5 web pages.

## Operational Role

For a systems engineer, NASAWorldWind/WebWorldWind belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-20T07:17:46Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-bf4a0a5bee0424` from `github_search_maps` as `registry_expansion`
