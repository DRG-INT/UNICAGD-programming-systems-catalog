# LoicViennois/KSP-DeltaV-Planner
...
| Canonical URL | [https://github.com/LoicViennois/KSP-DeltaV-Planner](https://github.com/LoicViennois/KSP-DeltaV-Planner) |
| Source record ids | github_search_space_engines-e6c89bafbe1b51 |

## System Engineer Summary

KSP Delta-V Planner is a tool to calculate your rocket Delta-V for interplanetary travels in Kerbal
Space Program. Also known as KSP Delta-V Calculator.

## Operational Role

For a systems engineer, LoicViennois/KSP-DeltaV-Planner belongs in the Space Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.0 | 2026-08-24T13:45:27Z | [https://api.github.com/repos/LoicViennois/KSP-DeltaV-Planner/releases/latest](https://api.github.com/repos/LoicViennois/KSP-DeltaV-Planner/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/LoicViennois/KSP-DeltaV-Planner/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-e6c89bafbe1b51` from `github_search_space_engines` as `registry_expansion`
