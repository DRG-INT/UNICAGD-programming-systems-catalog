...
<!-- canonical: https://github.com/soxofaan/duviz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/soxofaan/duviz](https://github.com/soxofaan/duviz) |
| Source record ids | github_search_space_maps-24f3556405063b |
...
For a systems engineer, soxofaan/duviz belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-05T13:52:37Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-24f3556405063b` from `github_search_space_maps` as `registry_expansion`
