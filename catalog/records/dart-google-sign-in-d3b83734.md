...
<!-- canonical: https://pub.dev/packages/google_sign_in -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_sign_in](https://pub.dev/packages/google_sign_in) |
| Source record ids | pub_dev-d4f02369e32d7f |

## System Engineer Summary

Flutter plugin for Google Sign-In, a secure authentication system for signing in with a Google
account.

## Operational Role

For a systems engineer, google_sign_in belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0 | 2025-09-17T18:37:54.811927Z | [https://pub.dev/api/packages/google_sign_in](https://pub.dev/api/packages/google_sign_in) |  |
| preview | known | 5.0.0-nullsafety | 2021-01-09T17:51:41.863168Z | [https://pub.dev/api/packages/google_sign_in](https://pub.dev/api/packages/google_sign_in) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_sign_in` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-d4f02369e32d7f` from `pub_dev` as `registry_expansion`
