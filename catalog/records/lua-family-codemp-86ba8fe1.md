...
<!-- canonical: https://luarocks.org/modules/alemi/codemp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alemi/codemp](https://luarocks.org/modules/alemi/codemp) |
| Source record ids | luarocks_root_manifest-1ed687ead753c7 |
...
For a systems engineer, codemp belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1ed687ead753c7` from `luarocks_root_manifest` as `registry_expansion`
