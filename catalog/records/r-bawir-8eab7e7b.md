...
<!-- canonical: https://cran.r-project.org/web/packages/BAwiR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BAwiR/index.html](https://cran.r-project.org/web/packages/BAwiR/index.html) |
| Source record ids | cran_packages_by_date-7ecf2502a344fe |
...
For a systems engineer, BAwiR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.4 | 2026-09-07 18:50:02 UTC | [https://cran.r-project.org/web/packages/BAwiR/DESCRIPTION](https://cran.r-project.org/web/packages/BAwiR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BAwiR/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-7ecf2502a344fe` from `cran_packages_by_date` as `registry_expansion`
