...
<!-- canonical: https://github.com/JuliaDSP/DSP.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaDSP/DSP.jl](https://github.com/JuliaDSP/DSP.jl) |
| Source record ids | github_search_audio-3262c781f1a00f |
...
For a systems engineer, JuliaDSP/DSP.jl belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T10:58:30Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-3262c781f1a00f` from `github_search_audio` as `registry_expansion`
