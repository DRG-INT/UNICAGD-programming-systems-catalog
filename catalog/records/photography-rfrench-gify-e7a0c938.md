...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rfrench/gify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rfrench/gify](https://github.com/rfrench/gify) |
| Source record ids | github_search_photography-a9a2fa6b70bdea |
...
For a systems engineer, rfrench/gify belongs in the Photography inventory as part of low-noise code
review, style consistency, and automation-friendly editing.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-08T22:03:16Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:exif stars:>50", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_photography-a9a2fa6b70bdea` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AcademySoftwareFoundation/OpenImageIO | Formatter | [open](photography-academysoftwarefoundation-openimageio-a97ad013.md) |
| AlenVelocity/wa-sticker-formatter | Formatter | [open](photography-alenvelocity-wa-sticker-formatter-09b95bf0.md) |
| ankitdhall/lidar_camera_calibration | Formatter | [open](photography-ankitdhall-lidar-camera-calibration-71522045.md) |
| blakeblackshear/frigate | Formatter | [open](photography-blakeblackshear-frigate-ea8ac18c.md) |
| blakeblackshear/frigate-hass-integration | Formatter | [open](photography-blakeblackshear-frigate-hass-integration-49b84b9e.md) |
| d2phap/ImageGlass | Formatter | [open](photography-d2phap-imageglass-ec40014f.md) |
| dnglab/dnglab | Formatter | [open](photography-dnglab-dnglab-05d113bb.md) |
| exiftool/exiftool | Formatter | [open](photography-exiftool-exiftool-c6310d37.md) |
