...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AladinWay/TransitionButton -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AladinWay/TransitionButton](https://github.com/AladinWay/TransitionButton) |
| Source record ids | github_search_cocoa-d747adc2a9e1b9 |
...
For a systems engineer, AladinWay/TransitionButton belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-05T11:51:13Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-d747adc2a9e1b9` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| devxoul/CocoaSeeds | Undefined Behavior Analyzer | [open](cocoa-devxoul-cocoaseeds-cdcf30f0.md) |
| efremidze/Magnetic | Undefined Behavior Analyzer | [open](cocoa-efremidze-magnetic-ac9421b5.md) |
| KelvinJin/AnimatedCollectionViewLayout | Undefined Behavior Analyzer | [open](cocoa-kelvinjin-animatedcollectionviewlayout-427b1c8f.md) |
| macmade/GitHubUpdates | Undefined Behavior Analyzer | [open](cocoa-macmade-githubupdates-e05a7458.md) |
| subethaedit/SubEthaEdit | Undefined Behavior Analyzer | [open](cocoa-subethaedit-subethaedit-a17dc346.md) |
| tbxark/TKRubberIndicator | Undefined Behavior Analyzer | [open](cocoa-tbxark-tkrubberindicator-51feff82.md) |
| XCDYouTubeKit | Undefined Behavior Analyzer | [open](cocoa-xcdyoutubekit-06b9c2a1.md) |
