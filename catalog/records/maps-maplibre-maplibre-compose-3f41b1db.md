...
<!-- canonical: https://github.com/maplibre/maplibre-compose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/maplibre-compose](https://github.com/maplibre/maplibre-compose) |
| Source record ids | github_search_maps-08106024f8c893 |
...
For a systems engineer, maplibre/maplibre-compose belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T07:40:09Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-08106024f8c893` from `github_search_maps` as `registry_expansion`
