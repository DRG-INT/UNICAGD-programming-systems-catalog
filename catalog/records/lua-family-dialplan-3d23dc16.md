...
<!-- canonical: https://luarocks.org/modules/antirek/dialplan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/antirek/dialplan](https://luarocks.org/modules/antirek/dialplan) |
| Source record ids | luarocks_root_manifest-c00e30cafc8bc0 |

## System Engineer Summary

dialplan is tracked as a parser lexer ast record in the Lua family branch. The source did not
...
For a systems engineer, dialplan belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-c00e30cafc8bc0` from `luarocks_root_manifest` as `registry_expansion`
