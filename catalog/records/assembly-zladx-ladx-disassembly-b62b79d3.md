...
<!-- canonical: https://github.com/zladx/LADX-Disassembly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zladx/LADX-Disassembly](https://github.com/zladx/LADX-Disassembly) |
| Source record ids | github_search_assembly-8e4cbbf9e53bef |

## System Engineer Summary

Disassembly of Legend of Zelda: Link's Awakening DX

## Operational Role

For a systems engineer, zladx/LADX-Disassembly belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T18:45:27Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-8e4cbbf9e53bef` from `github_search_assembly` as `registry_expansion`
