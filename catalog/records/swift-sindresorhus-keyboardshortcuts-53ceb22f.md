...
| Source record ids | github_search_swift-27d5df3c1b180a |
...
For a systems engineer, sindresorhus/KeyboardShortcuts belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T10:24:25Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-27d5df3c1b180a` from `github_search_swift` as `registry_expansion`
