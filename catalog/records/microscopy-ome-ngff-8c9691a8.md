...
| Canonical URL | [https://ngff.openmicroscopy.org/](https://ngff.openmicroscopy.org/) |
| Source record ids | curated_language_routes-c83d567fc9503e |

## System Engineer Summary

Next-generation file format specification for scalable bioimaging data in Zarr-backed layouts.

## Operational Role

For a systems engineer, OME-NGFF belongs in the Microscopy inventory as part of wire formats,
...
- `curated_language_routes-c83d567fc9503e` from `curated_language_routes` as `registry_expansion`
