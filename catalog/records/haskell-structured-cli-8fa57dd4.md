...
<!-- canonical: https://hackage.haskell.org/package/structured-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/structured-cli](https://hackage.haskell.org/package/structured-cli) |
| Source record ids | hackage_top_downloads-191d3a095829f0 |
...
For a systems engineer, structured-cli belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0.1 | 2020-12-17T13:00:08Z | [https://hackage.haskell.org/package/structured-cli](https://hackage.haskell.org/package/structured-cli) |  |
| candidate | partial | 0.9.0.2 |  | [https://hackage.haskell.org/package/structured-cli](https://hackage.haskell.org/package/structured-cli) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/structured-cli` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-191d3a095829f0` from `hackage_top_downloads` as `registry_expansion`
