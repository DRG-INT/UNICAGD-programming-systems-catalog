...
<!-- canonical: https://github.com/nanahou/Awesome-Speech-Enhancement -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nanahou/Awesome-Speech-Enhancement](https://github.com/nanahou/Awesome-Speech-Enhancement) |
| Source record ids | github_search_audio-bceb09f60fd52f |

## System Engineer Summary

A tutorial for Speech Enhancement researchers and practitioners. The purpose of this repo is to
organize the world’s resources for speech enhancement and make them universally accessible and
useful.

## Operational Role

For a systems engineer, nanahou/Awesome-Speech-Enhancement belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-01T10:20:50Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-bceb09f60fd52f` from `github_search_audio` as `registry_expansion`
