...
<!-- canonical: https://github.com/git-pkgs/proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/git-pkgs/proxy](https://github.com/git-pkgs/proxy) |
| Source record ids | github_search_catalogs-95bb7f7ab774bb |
...
For a systems engineer, git-pkgs/proxy belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:24:38Z | gh search repos topic:package-registry stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-95bb7f7ab774bb` from `github_search_catalogs` as `registry_expansion`
