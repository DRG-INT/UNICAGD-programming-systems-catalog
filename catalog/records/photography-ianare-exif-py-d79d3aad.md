...
<!-- canonical: https://github.com/ianare/exif-py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ianare/exif-py](https://github.com/ianare/exif-py) |
| Source record ids | github_search_photography-5624264b49efc0 |
...
For a systems engineer, ianare/exif-py belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T14:55:25Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-5624264b49efc0` from `github_search_photography` as `registry_expansion`
