...
<!-- canonical: https://cran.r-project.org/web/packages/astgrepr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/astgrepr/index.html](https://cran.r-project.org/web/packages/astgrepr/index.html) |
| Source record ids | cran_packages_by_date-c5751660f07490 |
...
For a systems engineer, astgrepr belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-04 14:40:02 UTC | [https://cran.r-project.org/web/packages/astgrepr/DESCRIPTION](https://cran.r-project.org/web/packages/astgrepr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/astgrepr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c5751660f07490` from `cran_packages_by_date` as `registry_expansion`
