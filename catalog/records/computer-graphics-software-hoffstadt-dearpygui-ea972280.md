...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/hoffstadt/DearPyGui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hoffstadt/DearPyGui](https://github.com/hoffstadt/DearPyGui) |
| Source record ids | github_search_computer_graphics_software-621495f35bb748 |

## System Engineer Summary

Dear PyGui: A fast and powerful Graphical User Interface Toolkit for Python with minimal
dependencies

## Operational Role

For a systems engineer, hoffstadt/DearPyGui belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-621495f35bb748` from `github_search_computer_graphics_software` as `registry_expansion`
