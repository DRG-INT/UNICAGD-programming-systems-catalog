...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_gauges -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_gauges](https://pub.dev/packages/syncfusion_flutter_gauges) |
| Source record ids | pub_dev-4ac1b08d48b5d0 |

## System Engineer Summary

The Flutter gauges library includes a linear gauge and radial gauge (a.k.a. circular gauge) to
create modern, interactive, animated gauges and radial sliders.

## Operational Role

For a systems engineer, syncfusion_flutter_gauges belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:27:41.738096Z | [https://pub.dev/api/packages/syncfusion_flutter_gauges](https://pub.dev/api/packages/syncfusion_flutter_gauges) |  |
| preview | known | 17.4.51-beta | 2020-02-25T09:41:38.876007Z | [https://pub.dev/api/packages/syncfusion_flutter_gauges](https://pub.dev/api/packages/syncfusion_flutter_gauges) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_gauges` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-4ac1b08d48b5d0` from `pub_dev` as `registry_expansion`
