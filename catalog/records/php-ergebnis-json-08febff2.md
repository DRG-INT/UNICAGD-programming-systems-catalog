...
<!-- canonical: https://packagist.org/packages/ergebnis/json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ergebnis/json](https://packagist.org/packages/ergebnis/json) |
| Source record ids | packagist_search-354ffeef64054c |
...
For a systems engineer, ergebnis/json belongs in the PHP inventory as part of ecosystem capability
...
- `packagist_search-354ffeef64054c` from `packagist_search` as `registry_expansion`
