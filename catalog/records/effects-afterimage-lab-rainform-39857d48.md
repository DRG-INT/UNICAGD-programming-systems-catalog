...
<!-- canonical: https://github.com/afterimage-lab/Rainform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/afterimage-lab/Rainform](https://github.com/afterimage-lab/Rainform) |
| Source record ids | github_search_effects-af6066bbf16b02 |

## System Engineer Summary

Rainform / 数据成雨 — an interactive WebGL rainfall data visualization built with Three.js.

## Operational Role

For a systems engineer, afterimage-lab/Rainform belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T01:09:34Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-af6066bbf16b02` from `github_search_effects` as `registry_expansion`
...
| GetStream/effects-library | Machine Learning | [open](effects-getstream-effects-library-9b952929.md) |
| GuitarML/FunBox | Machine Learning | [open](effects-guitarml-funbox-b6d4ee50.md) |
| IvanMurzak/Unity-AI-ParticleSystem | Machine Learning | [open](effects-ivanmurzak-unity-ai-particlesystem-ea5e947e.md) |
| iver56/audiomentations | Machine Learning | [open](effects-iver56-audiomentations-635d4f31.md) |
| maia-sdr/maia-sdr | Machine Learning | [open](effects-maia-sdr-maia-sdr-88e8ecf8.md) |
