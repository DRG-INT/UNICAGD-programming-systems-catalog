...
<!-- canonical: https://github.com/WebAssembly/esm-integration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/esm-integration](https://github.com/WebAssembly/esm-integration) |
| Source record ids | github_search_webassembly-00553f247d30be |
...
For a systems engineer, WebAssembly/esm-integration belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-12T22:53:06Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-00553f247d30be` from `github_search_webassembly` as `registry_expansion`
