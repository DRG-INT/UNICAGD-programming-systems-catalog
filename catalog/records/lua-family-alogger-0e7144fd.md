...
<!-- canonical: https://luarocks.org/modules/swarg/alogger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/swarg/alogger](https://luarocks.org/modules/swarg/alogger) |
| Source record ids | luarocks_root_manifest-9d5d7228a42568 |

## System Engineer Summary

alogger is tracked as a logging observability record in the Lua family branch. The source did not
...
For a systems engineer, alogger belongs in the Lua family inventory as part of diagnostics, metrics,
...
- `luarocks_root_manifest-9d5d7228a42568` from `luarocks_root_manifest` as `registry_expansion`
...
| hologo | Logging Observability | [open](lua-family-hologo-9ac1f5e1.md) |
