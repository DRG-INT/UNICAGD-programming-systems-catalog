...
<!-- canonical: https://cran.r-project.org/web/packages/weightedGCM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/weightedGCM/index.html](https://cran.r-project.org/web/packages/weightedGCM/index.html) |
| Source record ids | cran_packages_by_date-76c0735930d613 |
...
For a systems engineer, weightedGCM belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-04 08:00:02 UTC | [https://cran.r-project.org/web/packages/weightedGCM/DESCRIPTION](https://cran.r-project.org/web/packages/weightedGCM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/weightedGCM/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-76c0735930d613` from `cran_packages_by_date` as `registry_expansion`
