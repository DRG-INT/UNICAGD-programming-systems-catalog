...
| Canonical URL | [https://github.com/ExistentialAudio/BlackHole](https://github.com/ExistentialAudio/BlackHole) |
| Source record ids | github_search_audio-a89071b04a96ae |

## System Engineer Summary

BlackHole is a modern macOS audio loopback driver that allows applications to pass audio to other
applications with zero additional latency.

## Operational Role

For a systems engineer, ExistentialAudio/BlackHole belongs in the Audio inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.7.1 | 2026-07-03T17:58:06Z | [https://api.github.com/repos/ExistentialAudio/BlackHole/releases/latest](https://api.github.com/repos/ExistentialAudio/BlackHole/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ExistentialAudio/BlackHole/releases/latest` at `2026-09-01T09:23:16+00:00`.
...
- `github_search_audio-a89071b04a96ae` from `github_search_audio` as `registry_expansion`
