...
| Canonical URL | [https://crates.io/crates/io-extras](https://crates.io/crates/io-extras) |
| Source record ids | crates_io-e6d62db4e474e9 |
...
For a systems engineer, io-extras belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19.0 | 2025-08-06T19:24:42.520777Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-e6d62db4e474e9` from `crates_io` as `registry_expansion`
