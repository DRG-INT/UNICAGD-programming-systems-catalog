...
| Source record ids | github_search_maps-71c578a1d25d8f |
...
For a systems engineer, OSGeo/grass belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T02:10:26Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-71c578a1d25d8f` from `github_search_maps` as `registry_expansion`
