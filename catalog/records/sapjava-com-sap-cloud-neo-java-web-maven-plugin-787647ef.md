# com.sap.cloud:neo-java-web-maven-plugin
...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-maven-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-maven-plugin](https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-maven-plugin) |
| Source record ids | maven_central_search-4f25f5e399265c |
...
For a systems engineer, com.sap.cloud:neo-java-web-maven-plugin belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.24.2 | 2025-06-11T13:48:39+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json) |  |
...
- `maven_central_search-4f25f5e399265c` from `maven_central_search` as `registry_expansion`
