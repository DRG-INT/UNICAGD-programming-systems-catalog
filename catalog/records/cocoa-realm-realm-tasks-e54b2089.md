...
<!-- canonical: https://github.com/realm/realm-tasks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realm/realm-tasks](https://github.com/realm/realm-tasks) |
| Source record ids | github_search_cocoa-a857bf14514765 |
...
For a systems engineer, realm/realm-tasks belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-23T11:14:25Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0; MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_cocoa-a857bf14514765` from `github_search_cocoa` as `registry_expansion`
