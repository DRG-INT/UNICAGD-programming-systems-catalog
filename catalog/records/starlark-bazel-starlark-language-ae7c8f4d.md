...
| Canonical URL | [https://bazel.build/rules/language](https://bazel.build/rules/language) |
| Source record ids | curated_language_routes-e6e3f07e8cdde1 |

## System Engineer Summary

Official Bazel documentation for using Starlark to write BUILD files, macros, and build rules.

## Operational Role

For a systems engineer, Bazel Starlark Language belongs in the Starlark inventory as part of
...
- `curated_language_routes-e6e3f07e8cdde1` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Starlark Language Site | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/starlark-starlark-language-site-2916c153.md) |
