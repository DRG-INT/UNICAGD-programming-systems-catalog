...
<!-- canonical: https://hackage.haskell.org/package/tagsoup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tagsoup](https://hackage.haskell.org/package/tagsoup) |
| Source record ids | hackage_top_downloads-ed6346b4601ffd |
...
For a systems engineer, tagsoup belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.8 | 2019-05-01T19:45:41Z | [https://hackage.haskell.org/package/tagsoup](https://hackage.haskell.org/package/tagsoup) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tagsoup` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-ed6346b4601ffd` from `hackage_top_downloads` as `registry_expansion`
