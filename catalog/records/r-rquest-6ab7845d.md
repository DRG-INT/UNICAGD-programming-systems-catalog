...
<!-- canonical: https://cran.r-project.org/web/packages/rquest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rquest/index.html](https://cran.r-project.org/web/packages/rquest/index.html) |
| Source record ids | cran_packages_by_date-2de1d02356fe05 |

## System Engineer Summary

Hypothesis Tests for Quantiles and Quantile-Based Measures

## Operational Role

For a systems engineer, rquest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-28 07:00:32 UTC | [https://cran.r-project.org/web/packages/rquest/DESCRIPTION](https://cran.r-project.org/web/packages/rquest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rquest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2de1d02356fe05` from `cran_packages_by_date` as `registry_expansion`
