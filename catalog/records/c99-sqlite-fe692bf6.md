...
| Source record ids | master-7849dc52f974 |

## System Engineer Summary

SQLite is tracked as a database datastore record in the C99 branch. The source did not provide a
...
For a systems engineer, SQLite belongs in the C99 inventory as part of state persistence,
...
- `master-7849dc52f974` from `master_json` as `database_datastore`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| libpq | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libpq-51c9f6dc.md) |
