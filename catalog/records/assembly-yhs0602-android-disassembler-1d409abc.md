...
<!-- canonical: https://github.com/yhs0602/Android-Disassembler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yhs0602/Android-Disassembler](https://github.com/yhs0602/Android-Disassembler) |
| Source record ids | github_search_assembly-9deaf1db0cb86c |

## System Engineer Summary

Disassemble ANY files including .so (NDK, JNI), Windows PE(EXE, DLL, SYS, etc), linux binaries,
libraries, and any other files such as pictures, audios, etc(for fun)files on Android. Capstone-
based disassembler application on android. 안드로이드 NDK 공유 라이브러리, Windows 바이너리, etc,... 리버싱 앱

## Operational Role

For a systems engineer, yhs0602/Android-Disassembler belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-22T07:00:35Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-9deaf1db0cb86c` from `github_search_assembly` as `registry_expansion`
