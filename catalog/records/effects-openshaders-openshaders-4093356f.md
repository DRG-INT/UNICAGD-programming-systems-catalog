...
<!-- canonical: https://github.com/openshaders/openshaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openshaders/openshaders](https://github.com/openshaders/openshaders) |
| Source record ids | github_search_effects-d0021741587dd6 |

## System Engineer Summary

The biggest open-source home for shaders on the web.

## Operational Role

For a systems engineer, openshaders/openshaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T17:06:05Z | gh search repos topic:shader-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d0021741587dd6` from `github_search_effects` as `registry_expansion`
