...
<!-- canonical: https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/index.html](https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/index.html) |
| Source record ids | cran_packages_by_date-da2fef5d2b5bfd |

## System Engineer Summary

Small Area Estimation Hierarchical Bayes for Spatial Beta Model

## Operational Role

For a systems engineer, saeHB.Spatial.Beta belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-24 16:00:02 UTC | [https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/DESCRIPTION](https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/saeHB.Spatial.Beta/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-da2fef5d2b5bfd` from `cran_packages_by_date` as `registry_expansion`
