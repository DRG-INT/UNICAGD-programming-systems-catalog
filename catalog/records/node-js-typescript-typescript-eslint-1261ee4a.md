...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/TypeScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-typescript.md) · [Category: Lint Plugin](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/lint-plugin.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Lint Plugin |
| Source type | lint_plugin |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-f47e1bb8f353 |

## System Engineer Summary

ESLint tooling for TypeScript
...
- Treat category as `lint_plugin` unless a later verified source gives a better classification.
...
- `master-f47e1bb8f353` from `master_json` as `lint_plugin`
