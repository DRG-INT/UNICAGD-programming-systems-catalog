...
| Canonical URL | [https://github.com/omaralalwi/laravel-trash-cleaner](https://github.com/omaralalwi/laravel-trash-cleaner) |
| Source record ids | github_search_telescopes-403684d2e53074 |

## System Engineer Summary

clean logs and debug files for debugging packages (clockwork, laravel telescope and more), and free
up space .

## Operational Role

For a systems engineer, omaralalwi/laravel-trash-cleaner belongs in the Telescopes inventory as part
of fault isolation, live inspection, breakpoints, and production-adjacent diagnosis.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.4 | 2025-06-29T22:10:14Z | [https://api.github.com/repos/omaralalwi/laravel-trash-cleaner/releases/latest](https://api.github.com/repos/omaralalwi/laravel-trash-cleaner/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/omaralalwi/laravel-trash-cleaner/releases/latest` at `2026-09-01T08:26:26+00:00`.
...
- `github_search_telescopes-403684d2e53074` from `github_search_telescopes` as `registry_expansion`
