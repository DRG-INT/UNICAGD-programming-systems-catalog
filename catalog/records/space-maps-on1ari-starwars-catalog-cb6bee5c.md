...
<!-- canonical: https://github.com/On1ari/starwars-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/On1ari/starwars-catalog](https://github.com/On1ari/starwars-catalog) |
| Source record ids | github_search_space_maps-897b51f37798a3 |

## System Engineer Summary

On1ari/starwars-catalog is tracked as a logging observability record in the Space Maps branch. The
...
For a systems engineer, On1ari/starwars-catalog belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-16T21:09:11Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-897b51f37798a3` from `github_search_space_maps` as `registry_expansion`
