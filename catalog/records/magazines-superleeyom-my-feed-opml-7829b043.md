...
<!-- canonical: https://github.com/superleeyom/my-feed-OPML -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/superleeyom/my-feed-OPML](https://github.com/superleeyom/my-feed-OPML) |
| Source record ids | github_search_magazines-307f76a40dcbfc |

## System Engineer Summary

📋分享我订阅的一些 Blog 和 Newsletter，通过 Github Actions，每天自动同步我 Feedly 上的订阅源，✅ 代表能正常订阅，❌ 代表暂无法订阅（对于无法订阅的
feed，支持 Telegram Bot、Email、Server酱等推送工具提醒更新）

## Operational Role

For a systems engineer, superleeyom/my-feed-OPML belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-24T01:44:56Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-307f76a40dcbfc` from `github_search_magazines` as `registry_expansion`
