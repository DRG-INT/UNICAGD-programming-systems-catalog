...
<!-- canonical: https://cran.r-project.org/web/packages/textrar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/textrar/index.html](https://cran.r-project.org/web/packages/textrar/index.html) |
| Source record ids | cran_packages_by_date-1e6516b2aa9ccc |
...
For a systems engineer, textrar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-28 20:20:02 UTC | [https://cran.r-project.org/web/packages/textrar/DESCRIPTION](https://cran.r-project.org/web/packages/textrar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/textrar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1e6516b2aa9ccc` from `cran_packages_by_date` as `registry_expansion`
