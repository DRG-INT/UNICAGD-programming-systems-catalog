...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Azure/AzureDataLake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Azure/AzureDataLake](https://github.com/Azure/AzureDataLake) |
| Source record ids | github_search_databases-1d289291cbf294 |
...
For a systems engineer, Azure/AzureDataLake belongs in the Databases inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-16T22:17:51Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1d289291cbf294` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| LibreOffice Writer tables | Documentation | [open](databases-libreoffice-writer-tables-99c2c13d.md) |
| papermark/papermark | Documentation | [open](databases-papermark-papermark-47af8f05.md) |
| Tencent/APIJSON | Documentation | [open](databases-tencent-apijson-2d845d8e.md) |
