...
<!-- canonical: https://hackage.haskell.org/package/DSH -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/DSH](https://hackage.haskell.org/package/DSH) |
| Source record ids | hackage_top_downloads-cb055713ceafa5 |
...
For a systems engineer, DSH belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0.1 | 2015-06-03T19:29:20Z | [https://hackage.haskell.org/package/DSH](https://hackage.haskell.org/package/DSH) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/DSH` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-cb055713ceafa5` from `hackage_top_downloads` as `registry_expansion`
