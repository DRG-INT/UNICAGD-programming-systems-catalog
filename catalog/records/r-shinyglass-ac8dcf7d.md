...
<!-- canonical: https://cran.r-project.org/web/packages/shinyglass/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinyglass/index.html](https://cran.r-project.org/web/packages/shinyglass/index.html) |
| Source record ids | cran_packages_by_date-dcf678dbf5adce |
...
For a systems engineer, shinyglass belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 05:40:42 UTC | [https://cran.r-project.org/web/packages/shinyglass/DESCRIPTION](https://cran.r-project.org/web/packages/shinyglass/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinyglass/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dcf678dbf5adce` from `cran_packages_by_date` as `registry_expansion`
