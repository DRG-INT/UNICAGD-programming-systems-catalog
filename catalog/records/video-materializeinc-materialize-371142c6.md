...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_video-40cbe538fad5cd |
...
For a systems engineer, MaterializeInc/materialize belongs in the Video inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:04:36Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-40cbe538fad5cd` from `github_search_video` as `registry_expansion`
