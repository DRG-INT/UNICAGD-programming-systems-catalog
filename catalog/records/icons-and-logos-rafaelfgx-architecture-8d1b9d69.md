...
| Source record ids | github_search_icons_and_logos-3717d000128705 |
...
For a systems engineer, rafaelfgx/Architecture belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T11:57:31Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3717d000128705` from `github_search_icons_and_logos` as `registry_expansion`
