...
<!-- canonical: https://github.com/mocnik-science/osm-python-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mocnik-science/osm-python-tools](https://github.com/mocnik-science/osm-python-tools) |
| Source record ids | github_search_maps-259e52552d1fe8 |
...
For a systems engineer, mocnik-science/osm-python-tools belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-05T00:40:13Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-259e52552d1fe8` from `github_search_maps` as `registry_expansion`
