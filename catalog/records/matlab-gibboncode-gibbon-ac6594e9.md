...
| Canonical URL | [https://github.com/gibbonCode/GIBBON](https://github.com/gibbonCode/GIBBON) |
| Source record ids | github_search_matlab-7dd61c9f04ae9f |
...
For a systems engineer, gibbonCode/GIBBON belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.5.0 | 2019-05-30T10:08:13Z | [https://api.github.com/repos/gibbonCode/GIBBON/releases/latest](https://api.github.com/repos/gibbonCode/GIBBON/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gibbonCode/GIBBON/releases/latest` at `2026-09-01T07:24:10+00:00`.
...
- `github_search_matlab-7dd61c9f04ae9f` from `github_search_matlab` as `registry_expansion`
