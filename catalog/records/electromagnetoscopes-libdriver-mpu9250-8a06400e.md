...
<!-- canonical: https://github.com/libdriver/mpu9250 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libdriver/mpu9250](https://github.com/libdriver/mpu9250) |
| Source record ids | github_search_electromagnetoscopes-84927eefabd181 |
...
For a systems engineer, libdriver/mpu9250 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T08:55:44Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-84927eefabd181` from `github_search_electromagnetoscopes` as `registry_expansion`
