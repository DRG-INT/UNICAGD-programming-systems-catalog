...
<!-- canonical: https://pub.dev/packages/melos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/melos](https://pub.dev/packages/melos) |
| Source record ids | pub_dev-5fc3820ac7ad51 |

## System Engineer Summary

A tool for managing Dart & Flutter repositories with multiple packages (monorepo). Supports
automated versioning via Conventional Commits. Inspired by JavaScripts Lerna package.

## Operational Role

For a systems engineer, melos belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.6.0 | 2026-08-29T17:19:18.038299Z | [https://pub.dev/api/packages/melos](https://pub.dev/api/packages/melos) |  |
| preview | known | 7.4.0-dev.0 | 2025-12-12T17:03:00.299517Z | [https://pub.dev/api/packages/melos](https://pub.dev/api/packages/melos) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/melos` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-5fc3820ac7ad51` from `pub_dev` as `registry_expansion`
