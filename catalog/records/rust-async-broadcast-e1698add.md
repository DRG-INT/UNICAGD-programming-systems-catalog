...
<!-- canonical: https://crates.io/crates/async-broadcast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-broadcast](https://crates.io/crates/async-broadcast) |
| Source record ids | crates_io-5a9660591770c1 |
...
For a systems engineer, async-broadcast belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2024-12-23T21:10:23.927278Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-5a9660591770c1` from `crates_io` as `registry_expansion`
