...
<!-- canonical: https://github.com/evanw/esbuild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/evanw/esbuild](https://github.com/evanw/esbuild) |
| Source record ids | github_search_go-bf017594b0ddec |
...
For a systems engineer, evanw/esbuild belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T17:20:12Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-bf017594b0ddec` from `github_search_go` as `registry_expansion`
