...
<!-- canonical: https://github.com/optimajet/WorkflowEngine.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/optimajet/WorkflowEngine.NET](https://github.com/optimajet/WorkflowEngine.NET) |
| Source record ids | github_search_engines-73964a1ed51949 |
...
For a systems engineer, optimajet/WorkflowEngine.NET belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T15:16:18Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-73964a1ed51949` from `github_search_engines` as `registry_expansion`
