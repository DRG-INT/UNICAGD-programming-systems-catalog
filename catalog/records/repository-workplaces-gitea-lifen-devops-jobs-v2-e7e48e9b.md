...
<!-- canonical: https://gitea.com/lifen/devops-jobs-v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/lifen/devops-jobs-v2](https://gitea.com/lifen/devops-jobs-v2) |
| Source record ids | gitea_repositories_api-bda80710b8d2c6 |
...
For a systems engineer, Gitea: lifen/devops-jobs-v2 belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-19T15:48:20Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-bda80710b8d2c6` from `gitea_repositories_api` as `registry_expansion`
