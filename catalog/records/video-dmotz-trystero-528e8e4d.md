...
<!-- canonical: https://github.com/dmotz/trystero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dmotz/trystero](https://github.com/dmotz/trystero) |
| Source record ids | github_search_video-deb78701a31e65 |

## System Engineer Summary

✨🤝✨ Build instant multiplayer webapps, no server required — Magic WebRTC matchmaking over
BitTorrent, Nostr, MQTT, IPFS, Supabase, and Firebase

## Operational Role

For a systems engineer, dmotz/trystero belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T17:12:12Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-deb78701a31e65` from `github_search_video` as `registry_expansion`
