...
<!-- canonical: https://cran.r-project.org/web/packages/bacenR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bacenR/index.html](https://cran.r-project.org/web/packages/bacenR/index.html) |
| Source record ids | cran_packages_by_date-6c7895cbfaa513 |

## System Engineer Summary

Access Data from Brazilian Central Bank: IFdata, Active Institutions, Balance Sheets and Normative
Acts

## Operational Role

For a systems engineer, bacenR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-11 19:10:02 UTC | [https://cran.r-project.org/web/packages/bacenR/DESCRIPTION](https://cran.r-project.org/web/packages/bacenR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bacenR/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-6c7895cbfaa513` from `cran_packages_by_date` as `registry_expansion`
