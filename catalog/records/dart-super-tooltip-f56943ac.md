...
<!-- canonical: https://pub.dev/packages/super_tooltip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/super_tooltip](https://pub.dev/packages/super_tooltip) |
| Source record ids | pub_dev-c7ed08afc71c0f |
...
For a systems engineer, super_tooltip belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2026-02-12T23:13:44.498768Z | [https://pub.dev/api/packages/super_tooltip](https://pub.dev/api/packages/super_tooltip) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/super_tooltip` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-c7ed08afc71c0f` from `pub_dev` as `registry_expansion`
