...
<!-- canonical: https://github.com/repnz/snax86 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/repnz/snax86](https://github.com/repnz/snax86) |
| Source record ids | github_search_assembly-6261b564c53fc7 |
...
For a systems engineer, repnz/snax86 belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-10-18T01:53:44Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6261b564c53fc7` from `github_search_assembly` as `registry_expansion`
