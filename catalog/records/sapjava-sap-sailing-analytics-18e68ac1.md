...
[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/SAP/sailing-analytics](https://github.com/SAP/sailing-analytics) |
| Source record ids | github_search_sapjava-f9bd1a92a316ea |

## System Engineer Summary

The Sailing Analytics, formerly known as the "SAP Sailing Analytics," are a solution for portraying
and analyzing sailing regattas, support training scenarios, and power the vast archive at

## Operational Role

For a systems engineer, SAP/sailing-analytics belongs in the SAPJava inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | main-202608312014 | 2026-08-31T20:15:13Z | [https://api.github.com/repos/SAP/sailing-analytics/releases/latest](https://api.github.com/repos/SAP/sailing-analytics/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SAP/sailing-analytics/releases/latest` at `2026-09-01T10:25:36+00:00`.
...
- `github_search_sapjava-f9bd1a92a316ea` from `github_search_sapjava` as `registry_expansion`
