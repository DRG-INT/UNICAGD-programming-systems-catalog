...
<!-- canonical: https://cran.r-project.org/web/packages/lazybar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lazybar/index.html](https://cran.r-project.org/web/packages/lazybar/index.html) |
| Source record ids | cran_packages_by_date-51f4d0cf53ddcb |
...
For a systems engineer, lazybar belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-31 14:30:02 UTC | [https://cran.r-project.org/web/packages/lazybar/DESCRIPTION](https://cran.r-project.org/web/packages/lazybar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lazybar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-51f4d0cf53ddcb` from `cran_packages_by_date` as `registry_expansion`
