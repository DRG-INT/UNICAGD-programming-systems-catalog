...
<!-- canonical: https://packagist.org/packages/syslogic/doctrine-json-functions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/syslogic/doctrine-json-functions](https://packagist.org/packages/syslogic/doctrine-json-functions) |
| Source record ids | packagist_search-b8be7f0e4ec33d |
...
For a systems engineer, syslogic/doctrine-json-functions belongs in the PHP inventory as part of
...
- `packagist_search-b8be7f0e4ec33d` from `packagist_search` as `registry_expansion`
