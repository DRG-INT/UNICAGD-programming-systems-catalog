...
<!-- canonical: https://github.com/smmariquit/atlas-of-my-skies -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/smmariquit/atlas-of-my-skies](https://github.com/smmariquit/atlas-of-my-skies) |
| Source record ids | github_search_space_maps-b51740116e1585 |

## System Engineer Summary

Atlas of My Skies: a Next.js astronomy diary that maps the sky above me each day

## Operational Role

For a systems engineer, smmariquit/atlas-of-my-skies belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T02:46:26Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b51740116e1585` from `github_search_space_maps` as `registry_expansion`
