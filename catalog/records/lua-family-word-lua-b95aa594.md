...
<!-- canonical: https://luarocks.org/modules/clpi/dorm.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/clpi/dorm.lua](https://luarocks.org/modules/clpi/dorm.lua) |
| Source record ids | luarocks_root_manifest-8d7c95ae1c00b8 |
...
For a systems engineer, word.lua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-8d7c95ae1c00b8` from `luarocks_root_manifest` as `registry_expansion`
