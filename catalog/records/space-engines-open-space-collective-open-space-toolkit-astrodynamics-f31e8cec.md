...
| Canonical URL | [https://github.com/open-space-collective/open-space-toolkit-astrodynamics](https://github.com/open-space-collective/open-space-toolkit-astrodynamics) |
| Source record ids | github_search_space_engines-63f6de1a2d3107 |
...
For a systems engineer, open-space-collective/open-space-toolkit-astrodynamics belongs in the Space
Engines inventory as part of hot-path discovery, allocation analysis, latency control, and capacity
planning.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 17.14.0 | 2026-08-19T18:44:37Z | [https://api.github.com/repos/open-space-collective/open-space-toolkit-astrodynamics/releases/latest](https://api.github.com/repos/open-space-collective/open-space-toolkit-astrodynamics/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/open-space-collective/open-space-toolkit-astrodynamics/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-63f6de1a2d3107` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| nasa/vira | Profiler | [open](space-engines-nasa-vira-698e2673.md) |
