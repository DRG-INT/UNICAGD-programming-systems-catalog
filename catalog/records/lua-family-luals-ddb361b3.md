...
| Source record ids | corpus-362fd940709fda |

## System Engineer Summary

LuaLS is tracked as a language server record in the Lua family branch. The source did not provide a
...
For a systems engineer, LuaLS belongs in the Lua family inventory as part of editor intelligence,
...
- `corpus-362fd940709fda` from `master_json` as `language_server`
...
| Lua Language Server | Language Server | [open](lua-family-lua-language-server-1c8121a1.md) |
