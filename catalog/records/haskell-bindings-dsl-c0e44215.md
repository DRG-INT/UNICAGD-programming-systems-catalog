...
<!-- canonical: https://hackage.haskell.org/package/bindings-DSL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bindings-DSL](https://hackage.haskell.org/package/bindings-DSL) |
| Source record ids | hackage_top_downloads-181f51007d7258 |
...
For a systems engineer, bindings-DSL belongs in the Haskell inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-07-11T14:13:24Z | [https://hackage.haskell.org/package/bindings-DSL](https://hackage.haskell.org/package/bindings-DSL) |  |
| candidate | partial | 1.0.24 |  | [https://hackage.haskell.org/package/bindings-DSL](https://hackage.haskell.org/package/bindings-DSL) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bindings-DSL` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-181f51007d7258` from `hackage_top_downloads` as `registry_expansion`
