...
<!-- canonical: https://www.npmjs.com/package/@modelcontextprotocol/server-sequential-thinking -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@modelcontextprotocol/server-sequential-thinking](https://www.npmjs.com/package/@modelcontextprotocol/server-sequential-thinking) |
| Source record ids | npm_registry-416da8a296586b |
...
For a systems engineer, @modelcontextprotocol/server-sequential-thinking belongs in the
Node.js/JavaScript inventory as part of request routing, middleware policy, service structure, and
deployment surface.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.8.31 | 2026-08-31T20:23:44.857Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-416da8a296586b` from `npm_registry` as `registry_expansion`
