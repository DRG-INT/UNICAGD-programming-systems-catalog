...
<!-- canonical: https://cran.r-project.org/web/packages/cmahalanobis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cmahalanobis/index.html](https://cran.r-project.org/web/packages/cmahalanobis/index.html) |
| Source record ids | cran_packages_by_date-a7475ce904c701 |
...
For a systems engineer, cmahalanobis belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-31 15:00:09 UTC | [https://cran.r-project.org/web/packages/cmahalanobis/DESCRIPTION](https://cran.r-project.org/web/packages/cmahalanobis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cmahalanobis/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a7475ce904c701` from `cran_packages_by_date` as `registry_expansion`
