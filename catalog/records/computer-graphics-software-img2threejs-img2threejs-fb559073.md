...
<!-- canonical: https://github.com/img2threejs/img2threejs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/img2threejs/img2threejs](https://github.com/img2threejs/img2threejs) |
| Source record ids | github_search_computer_graphics_software-49af0d406a3a22 |

## System Engineer Summary

Rebuild the object in a reference image as a code-only, procedural, quality-gated, animation-ready
Three.js model. Token-efficient image-to-3D.

## Operational Role

For a systems engineer, img2threejs/img2threejs belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-49af0d406a3a22` from `github_search_computer_graphics_software` as `registry_expansion`
