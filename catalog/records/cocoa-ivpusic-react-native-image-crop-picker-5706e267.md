...
<!-- canonical: https://github.com/ivpusic/react-native-image-crop-picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ivpusic/react-native-image-crop-picker](https://github.com/ivpusic/react-native-image-crop-picker) |
| Source record ids | github_search_cocoa-2542c06845226e |

## System Engineer Summary

iOS/Android image picker with support for camera, video, configurable compression, multiple images
and cropping

## Operational Role

For a systems engineer, ivpusic/react-native-image-crop-picker belongs in the Cocoa inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T23:31:48Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-2542c06845226e` from `github_search_cocoa` as `registry_expansion`
