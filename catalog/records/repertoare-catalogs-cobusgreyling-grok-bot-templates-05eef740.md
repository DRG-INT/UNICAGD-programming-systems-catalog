# cobusgreyling/grok-bot-templates

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cobusgreyling/grok-bot-templates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cobusgreyling/grok-bot-templates](https://github.com/cobusgreyling/grok-bot-templates) |
| Source record ids | github_search_repertoare_catalogs-a4cbbdfc1ad153 |

## System Engineer Summary

The engineering kit for Grok Bot templates. Spec, Bot Ready score, teams, skills, routines, and a
catalog you can paste into Grok Bot today.

## Operational Role

For a systems engineer, cobusgreyling/grok-bot-templates belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T17:25:35Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-a4cbbdfc1ad153` from `github_search_repertoare_catalogs` as `registry_expansion`
