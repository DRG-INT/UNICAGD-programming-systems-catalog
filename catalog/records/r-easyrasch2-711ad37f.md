...
<!-- canonical: https://cran.r-project.org/web/packages/easyRasch2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/easyRasch2/index.html](https://cran.r-project.org/web/packages/easyRasch2/index.html) |
| Source record ids | cran_packages_by_date-3e7b78d79f772c |
...
For a systems engineer, easyRasch2 belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-23 08:30:02 UTC | [https://cran.r-project.org/web/packages/easyRasch2/DESCRIPTION](https://cran.r-project.org/web/packages/easyRasch2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/easyRasch2/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3e7b78d79f772c` from `cran_packages_by_date` as `registry_expansion`
