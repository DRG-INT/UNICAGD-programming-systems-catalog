...
<!-- canonical: https://github.com/ClickHouse/clickhouse-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ClickHouse/clickhouse-java](https://github.com/ClickHouse/clickhouse-java) |
| Source record ids | github_search_databases-ba43fd69bc6fdb |
...
For a systems engineer, ClickHouse/clickhouse-java belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:45:33Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ba43fd69bc6fdb` from `github_search_databases` as `registry_expansion`
