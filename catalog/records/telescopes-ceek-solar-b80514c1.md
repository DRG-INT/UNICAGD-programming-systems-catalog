...
<!-- canonical: https://github.com/ceeK/Solar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ceeK/Solar](https://github.com/ceeK/Solar) |
| Source record ids | github_search_telescopes-45c720a444bca4 |

## System Engineer Summary

A Swift micro library for generating Sunrise and Sunset times on device, requiring no network
access.

## Operational Role

For a systems engineer, ceeK/Solar belongs in the Telescopes inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T23:46:36Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-45c720a444bca4` from `github_search_telescopes` as `registry_expansion`
