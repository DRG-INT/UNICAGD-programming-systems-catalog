...
<!-- canonical: https://pub.dev/packages/fading_edge_scrollview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fading_edge_scrollview](https://pub.dev/packages/fading_edge_scrollview) |
| Source record ids | pub_dev-114fd9d2a05ce3 |
...
For a systems engineer, fading_edge_scrollview belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.1 | 2024-02-25T12:16:19.501201Z | [https://pub.dev/api/packages/fading_edge_scrollview](https://pub.dev/api/packages/fading_edge_scrollview) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fading_edge_scrollview` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-114fd9d2a05ce3` from `pub_dev` as `registry_expansion`
