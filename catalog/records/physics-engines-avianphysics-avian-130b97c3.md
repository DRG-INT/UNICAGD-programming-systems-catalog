...
<!-- canonical: https://github.com/avianphysics/avian -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avianphysics/avian](https://github.com/avianphysics/avian) |
| Source record ids | github_search_physics_engines-90c817fd519b67 |
...
For a systems engineer, avianphysics/avian belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T11:32:10Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-90c817fd519b67` from `github_search_physics_engines` as `registry_expansion`
