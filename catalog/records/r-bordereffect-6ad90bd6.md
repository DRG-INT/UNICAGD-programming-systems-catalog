...
<!-- canonical: https://cran.r-project.org/web/packages/BorderEffect/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BorderEffect/index.html](https://cran.r-project.org/web/packages/BorderEffect/index.html) |
| Source record ids | cran_packages_by_date-2470147a68bf20 |

## System Engineer Summary

Detection of Edge Effects in Field Trials via Besag-Kempton Competition

## Operational Role

For a systems engineer, BorderEffect belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:30:16 UTC | [https://cran.r-project.org/web/packages/BorderEffect/DESCRIPTION](https://cran.r-project.org/web/packages/BorderEffect/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BorderEffect/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2470147a68bf20` from `cran_packages_by_date` as `registry_expansion`
