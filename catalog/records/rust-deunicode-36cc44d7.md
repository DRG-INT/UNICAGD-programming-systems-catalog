...
<!-- canonical: https://crates.io/crates/deunicode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/deunicode](https://crates.io/crates/deunicode) |
| Source record ids | crates_io-78cf4fa12af1da |

## System Engineer Summary

Convert Unicode strings to pure ASCII by intelligently transliterating them. Suppors Emoji and
Chinese.

## Operational Role

For a systems engineer, deunicode belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.2 | 2025-04-27T01:56:01.024761Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-78cf4fa12af1da` from `crates_io` as `registry_expansion`
