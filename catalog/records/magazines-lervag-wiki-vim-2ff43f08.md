...
<!-- canonical: https://github.com/lervag/wiki.vim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lervag/wiki.vim](https://github.com/lervag/wiki.vim) |
| Source record ids | github_search_magazines-67917ba92de142 |

## System Engineer Summary

lervag/wiki.vim is tracked as an ide editor integration record in the Magazines branch. The source
...
For a systems engineer, lervag/wiki.vim belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T08:43:02Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-67917ba92de142` from `github_search_magazines` as `registry_expansion`
