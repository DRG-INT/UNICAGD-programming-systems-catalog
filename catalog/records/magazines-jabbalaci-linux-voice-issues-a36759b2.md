...
<!-- canonical: https://github.com/jabbalaci/Linux-Voice-issues -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jabbalaci/Linux-Voice-issues](https://github.com/jabbalaci/Linux-Voice-issues) |
| Source record ids | github_search_magazines-8aa3e73ad88a07 |

## System Engineer Summary

collection of freely available issues of Linux Voice and MagPi

## Operational Role

For a systems engineer, jabbalaci/Linux-Voice-issues belongs in the Magazines inventory as part of
...
- `github_search_magazines-8aa3e73ad88a07` from `github_search_magazines` as `registry_expansion`
