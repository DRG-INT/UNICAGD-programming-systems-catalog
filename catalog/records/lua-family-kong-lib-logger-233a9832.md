...
| Canonical URL | [https://luarocks.org/modules/emartech/kong-lib-logger](https://luarocks.org/modules/emartech/kong-lib-logger) |
| Source record ids | luarocks_root_manifest-272ac25113c904 |

## System Engineer Summary

A simple logger library for kong - DEPRECATED - TO BE REMOVED

## Operational Role

For a systems engineer, kong-lib-logger belongs in the Lua family inventory as part of diagnostics,
...
- `luarocks_root_manifest-272ac25113c904` from `luarocks_root_manifest` as `registry_expansion`
