# mohammadrezwankhan/matlab-simulink-energy-lab
...
<!-- canonical: https://github.com/mohammadrezwankhan/matlab-simulink-energy-lab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mohammadrezwankhan/matlab-simulink-energy-lab](https://github.com/mohammadrezwankhan/matlab-simulink-energy-lab) |
| Source record ids | github_search_matlab-c1edca2edec156 |

## System Engineer Summary

Open, runnable MATLAB & Simulink reference models for lithium-ion batteries, SOC EKF, thermal
management, power converters, and grid-forming/grid-following BESS control—with reproducible checks.

## Operational Role

For a systems engineer, mohammadrezwankhan/matlab-simulink-energy-lab belongs in the Matlab
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T06:42:08Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-c1edca2edec156` from `github_search_matlab` as `registry_expansion`
