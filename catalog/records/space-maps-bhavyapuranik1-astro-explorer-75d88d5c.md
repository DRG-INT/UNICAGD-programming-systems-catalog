...
<!-- canonical: https://github.com/bhavyapuranik1/Astro-Explorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bhavyapuranik1/Astro-Explorer](https://github.com/bhavyapuranik1/Astro-Explorer) |
| Source record ids | github_search_space_maps-dc168ffe3d1f60 |

## System Engineer Summary

It is a modern astronomy platform featuring an interactive sky map, planet and deep-sky object
exploration, NASA APOD, asteroid tracking, telescope tools, Google Authentication, cloud sync, and
Astro AI—an integrated assistant for learning astronomy through intelligent conversations and real-
time space data.

## Operational Role

For a systems engineer, bhavyapuranik1/Astro-Explorer belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T15:53:39Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-dc168ffe3d1f60` from `github_search_space_maps` as `registry_expansion`
