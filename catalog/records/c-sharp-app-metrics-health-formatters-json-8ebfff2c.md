...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/App.Metrics.Health.Formatters.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/App.Metrics.Health.Formatters.Json](https://www.nuget.org/packages/App.Metrics.Health.Formatters.Json) |
| Source record ids | nuget_search-1d2c75ffd9f78b |
...
For a systems engineer, App.Metrics.Health.Formatters.Json belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2019-10-25T13:23:50.167+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.health.formatters.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.health.formatters.json/index.json) |  |
| preview | known | 3.2.0-dev0002 | 2019-04-26T02:01:12.437+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.health.formatters.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.health.formatters.json/index.json) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""}; Apache-2.0; https://www.nuget.org/packages/App.Metrics.Health.Formatters.Json/3.2.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/app.metrics.health.formatters.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-1d2c75ffd9f78b` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| App.Metrics.Formatters.Json | Formatter | [open](c-sharp-app-metrics-formatters-json-07866095.md) |
| Microsoft.AspNet.WebApi.Client | Formatter | [open](c-sharp-microsoft-aspnet-webapi-client-3e91e976.md) |
| Microsoft.AspNetCore.Mvc.Formatters.Json | Formatter | [open](c-sharp-microsoft-aspnetcore-mvc-formatters-json-baa1ce1b.md) |
| Microsoft.AspNetCore.Mvc.NewtonsoftJson | Formatter | [open](c-sharp-microsoft-aspnetcore-mvc-newtonsoftjson-6acc9f7e.md) |
| Serilog.Formatting.Compact | Formatter | [open](c-sharp-serilog-formatting-compact-303a3085.md) |
| Serilog.Formatting.Compact.Reader | Formatter | [open](c-sharp-serilog-formatting-compact-reader-e6a31e9c.md) |
| System.Net.Http.Formatting.Extension | Formatter | [open](c-sharp-system-net-http-formatting-extension-6007c287.md) |
| Utf8Json | Formatter | [open](c-sharp-utf8json-21e6fad4.md) |
