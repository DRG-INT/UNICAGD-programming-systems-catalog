...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JerryZLiu/Dayflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JerryZLiu/Dayflow](https://github.com/JerryZLiu/Dayflow) |
| Source record ids | github_search_swift-517c4c32c487a7 |

## System Engineer Summary

The automatic work journal/time tracker. Privately turns your screen into a timeline of what you
actually accomplished. Open-source and local-first.

## Operational Role

For a systems engineer, JerryZLiu/Dayflow belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-517c4c32c487a7` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| airbnb/lottie-ios | Filesystem Os | [open](swift-airbnb-lottie-ios-ea069736.md) |
| altstoreio/AltStore | Filesystem Os | [open](swift-altstoreio-altstore-169e84d3.md) |
| apple/containerization | Filesystem Os | [open](swift-apple-containerization-f439a10d.md) |
| ashleymills/Reachability.swift | Filesystem Os | [open](swift-ashleymills-reachability-swift-2be6635a.md) |
| Awesome iOS Interview | Filesystem Os | [open](swift-awesome-ios-interview-37d2afac.md) |
| awesome-macOS | Filesystem Os | [open](swift-awesome-macos-31e862a8.md) |
| Caldis/Mos | Filesystem Os | [open](swift-caldis-mos-9c22eedd.md) |
| ChenYilong/iOSInterviewQuestions | Filesystem Os | [open](swift-chenyilong-iosinterviewquestions-8331dfd3.md) |
