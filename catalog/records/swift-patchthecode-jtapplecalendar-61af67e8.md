...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/patchthecode/JTAppleCalendar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/patchthecode/JTAppleCalendar](https://github.com/patchthecode/JTAppleCalendar) |
| Source record ids | github_search_swift-1dcf07b33b973a |
...
For a systems engineer, patchthecode/JTAppleCalendar belongs in the Swift inventory as part of
...
- `github_search_swift-1dcf07b33b973a` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| EhPanda-Team/EhPanda | Ffi Bindings | [open](swift-ehpanda-team-ehpanda-f35a0864.md) |
| ReactiveCocoa/ReactiveCocoa | Ffi Bindings | [open](swift-reactivecocoa-reactivecocoa-7e0cb5dc.md) |
