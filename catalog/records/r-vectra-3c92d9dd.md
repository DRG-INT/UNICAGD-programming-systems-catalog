...
<!-- canonical: https://cran.r-project.org/web/packages/vectra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vectra/index.html](https://cran.r-project.org/web/packages/vectra/index.html) |
| Source record ids | cran_packages_by_date-74eab44e7c532b |
...
For a systems engineer, vectra belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-09-09 12:40:02 UTC | [https://cran.r-project.org/web/packages/vectra/DESCRIPTION](https://cran.r-project.org/web/packages/vectra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vectra/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-74eab44e7c532b` from `cran_packages_by_date` as `registry_expansion`
