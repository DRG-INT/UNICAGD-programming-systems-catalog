...
<!-- canonical: https://github.com/MortimerGoro/MGSwipeTableCell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MortimerGoro/MGSwipeTableCell](https://github.com/MortimerGoro/MGSwipeTableCell) |
| Source record ids | github_search_cocoa-94afe8eb94a2f0 |

## System Engineer Summary

An easy to use UITableViewCell subclass that allows to display swippable buttons with a variety of
transitions.

## Operational Role

For a systems engineer, MortimerGoro/MGSwipeTableCell belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-22T00:38:19Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-94afe8eb94a2f0` from `github_search_cocoa` as `registry_expansion`
