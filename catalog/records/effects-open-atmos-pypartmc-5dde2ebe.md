...
<!-- canonical: https://github.com/open-atmos/PyPartMC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-atmos/PyPartMC](https://github.com/open-atmos/PyPartMC) |
| Source record ids | github_search_effects-385251bd7e970b |
...
For a systems engineer, open-atmos/PyPartMC belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:08:39Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-385251bd7e970b` from `github_search_effects` as `registry_expansion`
