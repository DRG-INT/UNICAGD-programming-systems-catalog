...
<!-- canonical: https://cran.r-project.org/web/packages/strucchange/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/strucchange/index.html](https://cran.r-project.org/web/packages/strucchange/index.html) |
| Source record ids | cran_packages_by_date-a66a3699e6c97a |
...
For a systems engineer, strucchange belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6-0 | 2026-08-04 10:30:02 UTC | [https://cran.r-project.org/web/packages/strucchange/DESCRIPTION](https://cran.r-project.org/web/packages/strucchange/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/strucchange/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a66a3699e6c97a` from `cran_packages_by_date` as `registry_expansion`
