...
<!-- canonical: https://pypi.org/project/address-parser-js/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-parser-js/](https://pypi.org/project/address-parser-js/) |
| Source record ids | pypi_simple-69cd2106a1a1f6 |

## System Engineer Summary

address-parser-js is tracked as a parser lexer ast record in the Python branch. The source did not
...
For a systems engineer, address-parser-js belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2025-04-07T14:27:45.458244Z | [https://pypi.org/pypi/address-parser-js/json](https://pypi.org/pypi/address-parser-js/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-parser-js/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-69cd2106a1a1f6` from `pypi_simple` as `registry_expansion`
