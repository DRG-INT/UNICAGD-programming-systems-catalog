...
<!-- canonical: https://hackage.haskell.org/package/cabal-add -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-add](https://hackage.haskell.org/package/cabal-add) |
| Source record ids | hackage_recent-70822653d85203 |

## System Engineer Summary

Hackage package recently uploaded by Bodigrim.

## Operational Role

For a systems engineer, cabal-add belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-07-01T19:47:03Z | [https://hackage.haskell.org/package/cabal-add](https://hackage.haskell.org/package/cabal-add) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-add` at `2026-09-04T17:20:30+00:00`.
...
- `hackage_recent-70822653d85203` from `hackage_recent` as `registry_expansion`
