...
<!-- canonical: https://cran.r-project.org/web/packages/ErrorTracer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ErrorTracer/index.html](https://cran.r-project.org/web/packages/ErrorTracer/index.html) |
| Source record ids | cran_packages_by_date-71e88e139157da |
...
For a systems engineer, ErrorTracer belongs in the R inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-19 20:50:02 UTC | [https://cran.r-project.org/web/packages/ErrorTracer/DESCRIPTION](https://cran.r-project.org/web/packages/ErrorTracer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ErrorTracer/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-71e88e139157da` from `cran_packages_by_date` as `registry_expansion`
