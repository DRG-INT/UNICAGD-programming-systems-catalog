...
<!-- canonical: https://cran.r-project.org/web/packages/mvinfluence/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mvinfluence/index.html](https://cran.r-project.org/web/packages/mvinfluence/index.html) |
| Source record ids | cran_packages_by_date-547b6b802a7285 |
...
For a systems engineer, mvinfluence belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.4 | 2026-09-11 18:30:02 UTC | [https://cran.r-project.org/web/packages/mvinfluence/DESCRIPTION](https://cran.r-project.org/web/packages/mvinfluence/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mvinfluence/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-547b6b802a7285` from `cran_packages_by_date` as `registry_expansion`
