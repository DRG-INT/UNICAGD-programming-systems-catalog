...
| Canonical URL | [https://github.com/PicPeak/picpeak](https://github.com/PicPeak/picpeak) |
| Source record ids | github_search_photography-3bd336ee650f1d |

## System Engineer Summary

🚀 Self-hosted photo sharing platform for photographers & events. Open-source alternative to
PicDrop/Scrapbook with time-limited galleries, password protection, custom branding & no monthly
fees. Built with React + Node.js 📸

## Operational Role

For a systems engineer, PicPeak/picpeak belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.46.7 | 2026-08-29T01:25:49Z | [https://api.github.com/repos/PicPeak/picpeak/releases/latest](https://api.github.com/repos/PicPeak/picpeak/releases/latest) |  |
| preview | known | v3.122.2-beta.0 | 2026-09-01T07:31:21Z | [https://api.github.com/repos/PicPeak/picpeak/releases?per_page=10](https://api.github.com/repos/PicPeak/picpeak/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PicPeak/picpeak/releases/latest` at `2026-09-01T09:23:33+00:00`.
...
- `github_search_photography-3bd336ee650f1d` from `github_search_photography` as `registry_expansion`
