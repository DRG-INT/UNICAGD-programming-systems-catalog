...
<!-- canonical: https://github.com/alecazam/kram -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alecazam/kram](https://github.com/alecazam/kram) |
| Source record ids | github_search_assets-bace23b881acb2 |

## System Engineer Summary

Encode/decode/info to KTX/KTX2/DDS files with LDR/HDR and BC/ASTC/ETC2. Mac/Win C++11 too, Mac
viewer, and scripts for batch processing textures.

## Operational Role

For a systems engineer, alecazam/kram belongs in the Assets inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-15T06:45:20Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-bace23b881acb2` from `github_search_assets` as `registry_expansion`
