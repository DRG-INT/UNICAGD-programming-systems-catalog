...
<!-- canonical: https://github.com/facebook/rocksdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/facebook/rocksdb](https://github.com/facebook/rocksdb) |
| Source record ids | github_search_databases-82ae3207e33e0d |
...
For a systems engineer, facebook/rocksdb belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:53:29Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-82ae3207e33e0d` from `github_search_databases` as `registry_expansion`
