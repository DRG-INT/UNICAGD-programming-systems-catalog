...
<!-- canonical: https://cran.r-project.org/web/packages/elixir/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/elixir/index.html](https://cran.r-project.org/web/packages/elixir/index.html) |
| Source record ids | cran_packages_by_date-050f776682fa98 |
...
For a systems engineer, elixir belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-02 23:30:07 UTC | [https://cran.r-project.org/web/packages/elixir/DESCRIPTION](https://cran.r-project.org/web/packages/elixir/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/elixir/DESCRIPTION` at `2026-09-03T00:30:53+00:00`.
...
- `cran_packages_by_date-050f776682fa98` from `cran_packages_by_date` as `registry_expansion`
