...
<!-- canonical: https://cran.r-project.org/web/packages/xiacf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xiacf/index.html](https://cran.r-project.org/web/packages/xiacf/index.html) |
| Source record ids | cran_packages_by_date-623f4558ce86b6 |
...
For a systems engineer, xiacf belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-08-24 17:10:02 UTC | [https://cran.r-project.org/web/packages/xiacf/DESCRIPTION](https://cran.r-project.org/web/packages/xiacf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xiacf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-623f4558ce86b6` from `cran_packages_by_date` as `registry_expansion`
