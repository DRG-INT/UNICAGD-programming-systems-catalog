...
<!-- canonical: https://github.com/quick-perf/quickperf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/quick-perf/quickperf](https://github.com/quick-perf/quickperf) |
| Source record ids | github_search_databases-f9bc7e87164fd0 |

## System Engineer Summary

QuickPerf is a testing library for Java to quickly evaluate and improve some performance-related
properties

## Operational Role

For a systems engineer, quick-perf/quickperf belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-06T14:46:13Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f9bc7e87164fd0` from `github_search_databases` as `registry_expansion`
