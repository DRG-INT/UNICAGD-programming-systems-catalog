...
<!-- canonical: https://crates.io/crates/tokio-reactor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-reactor](https://crates.io/crates/tokio-reactor) |
| Source record ids | crates_io-d36b0c394d792c |
...
For a systems engineer, tokio-reactor belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.12 | 2020-02-05T00:24:22.888936Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Apache-2.0; https://www.nuget.org/packages/Destructurama.JsonNet/4.0.2/license |
