...
<!-- canonical: https://crates.io/crates/predicates-tree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/predicates-tree](https://crates.io/crates/predicates-tree) |
| Source record ids | crates_io-815bccf0ed30b0 |
...
For a systems engineer, predicates-tree belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.13 | 2026-02-11T14:41:54.899104Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-815bccf0ed30b0` from `crates_io` as `registry_expansion`
