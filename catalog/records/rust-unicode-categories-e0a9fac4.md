...
<!-- canonical: https://crates.io/crates/unicode_categories -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode_categories](https://crates.io/crates/unicode_categories) |
| Source record ids | crates_io-86f692a01affc0 |
...
For a systems engineer, unicode_categories belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2016-10-22T17:57:09.493733Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-86f692a01affc0` from `crates_io` as `registry_expansion`
