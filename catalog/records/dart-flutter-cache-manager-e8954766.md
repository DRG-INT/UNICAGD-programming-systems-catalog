...
<!-- canonical: https://pub.dev/packages/flutter_cache_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_cache_manager](https://pub.dev/packages/flutter_cache_manager) |
| Source record ids | pub_dev-6e0bdaaf316d1c |

## System Engineer Summary

Generic cache manager for flutter. Saves web files on the storages of the device and saves the cache
info using sqflite.

## Operational Role

For a systems engineer, flutter_cache_manager belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.2 | 2026-07-21T21:17:03.253518Z | [https://pub.dev/api/packages/flutter_cache_manager](https://pub.dev/api/packages/flutter_cache_manager) |  |
| preview | known | 3.0.0-nullsafety.3 | 2021-03-26T15:22:09.658610Z | [https://pub.dev/api/packages/flutter_cache_manager](https://pub.dev/api/packages/flutter_cache_manager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_cache_manager` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-6e0bdaaf316d1c` from `pub_dev` as `registry_expansion`
