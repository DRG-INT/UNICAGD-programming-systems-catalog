...
<!-- canonical: https://crates.io/crates/rmp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rmp](https://crates.io/crates/rmp) |
| Source record ids | crates_io-93439b14add3bc |
...
For a systems engineer, rmp belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.15 | 2025-12-23T23:54:26.994567Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-93439b14add3bc` from `crates_io` as `registry_expansion`
