# engineersonal/SAP-CAP-Products-Service
...
<!-- canonical: https://github.com/engineersonal/SAP-CAP-Products-Service -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/engineersonal/SAP-CAP-Products-Service](https://github.com/engineersonal/SAP-CAP-Products-Service) |
| Source record ids | github_search_sapjava-06f39afea2d3fb |

## System Engineer Summary

Develop SAP CAP Products Service application using SpringBoot Java

## Operational Role

For a systems engineer, engineersonal/SAP-CAP-Products-Service belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-21T18:09:41Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-06f39afea2d3fb` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| engineersonal/SAP-CAP-Bookstore | Game Engine Game Dev | [open](sapjava-engineersonal-sap-cap-bookstore-e106c68f.md) |
