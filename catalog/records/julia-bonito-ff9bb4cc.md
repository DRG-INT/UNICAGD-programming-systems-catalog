...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/Bonito](https://github.com/JuliaRegistries/General/tree/master/B/Bonito) |
| Source record ids | julia_general-36638412d4b28c |

## System Engineer Summary

Julia package registered in General at B/Bonito.

## Operational Role

For a systems engineer, Bonito belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/Bonito", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-36638412d4b28c` from `julia_general` as `registry_expansion`
