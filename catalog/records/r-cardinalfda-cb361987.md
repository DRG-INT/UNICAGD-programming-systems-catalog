...
<!-- canonical: https://cran.r-project.org/web/packages/cardinalfda/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cardinalfda/index.html](https://cran.r-project.org/web/packages/cardinalfda/index.html) |
| Source record ids | cran_packages_by_date-84f3b02f1a8605 |
...
For a systems engineer, cardinalfda belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-04 09:50:02 UTC | [https://cran.r-project.org/web/packages/cardinalfda/DESCRIPTION](https://cran.r-project.org/web/packages/cardinalfda/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cardinalfda/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-84f3b02f1a8605` from `cran_packages_by_date` as `registry_expansion`
