...
<!-- canonical: https://gitea.com/DUR/bmx-ng-bin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/DUR/bmx-ng-bin](https://gitea.com/DUR/bmx-ng-bin) |
| Source record ids | gitea_repositories_api-fb34d3140ffa88 |
...
For a systems engineer, Gitea: DUR/bmx-ng-bin belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-11T00:10:54Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-fb34d3140ffa88` from `gitea_repositories_api` as `registry_expansion`
