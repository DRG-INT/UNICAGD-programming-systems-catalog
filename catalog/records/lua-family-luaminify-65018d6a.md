...
<!-- canonical: https://github.com/stravant/LuaMinify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stravant/LuaMinify](https://github.com/stravant/LuaMinify) |
| Source record ids | lua-source-333 |
...
For a systems engineer, LuaMinify belongs in the Lua family inventory as part of defect discovery,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 333}}` |
...
- `lua-source-333` from `master_json` as `source_list_item`
