...
| Canonical URL | [https://github.com/juce-framework/JUCE](https://github.com/juce-framework/JUCE) |
| Source record ids | curated_language_routes-77ecf3a0961685 |

## System Engineer Summary

C++ framework for audio plug-ins, DSP effects, instruments, and cross-platform media applications.

## Operational Role

For a systems engineer, JUCE belongs in the Effects inventory as part of ecosystem capability
...
- `curated_language_routes-77ecf3a0961685` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Faust | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-faust-91b0c044.md) |
| G'MIC | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-g-mic-31f4235b.md) |
| GStreamer Editing Services | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-gstreamer-editing-services-207f3c32.md) |
| SoX | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-sox-75b0f915.md) |
