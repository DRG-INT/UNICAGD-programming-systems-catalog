...
<!-- canonical: https://github.com/alaingalvan/image-editor-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alaingalvan/image-editor-effects](https://github.com/alaingalvan/image-editor-effects) |
| Source record ids | github_search_effects-f08251ef80b1ff |

## System Engineer Summary

💎 A WebGL example of image adjustment / effects shaders found in Photoshop, other image editors and
game engines.

## Operational Role

For a systems engineer, alaingalvan/image-editor-effects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-11T09:23:19Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f08251ef80b1ff` from `github_search_effects` as `registry_expansion`
