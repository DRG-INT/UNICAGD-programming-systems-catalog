...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitrusBuilder](https://github.com/JuliaRegistries/General/tree/master/C/CitrusBuilder) |
| Source record ids | julia_general-eb4d2c12326668 |

## System Engineer Summary

Julia package registered in General at C/CitrusBuilder.

## Operational Role

For a systems engineer, CitrusBuilder belongs in the Julia inventory as part of build graph control,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CitrusBuilder", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-eb4d2c12326668` from `julia_general` as `registry_expansion`
