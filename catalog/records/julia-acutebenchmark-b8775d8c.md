...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Benchmarking](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/benchmarking.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type |  |
| Verification | julia_general |
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AcuteBenchmark](https://github.com/JuliaRegistries/General/tree/master/A/AcuteBenchmark) |
| Source record ids | julia_general-800f4a11e508a1 |

## System Engineer Summary

Julia package registered in General at A/AcuteBenchmark.

## Operational Role

For a systems engineer, AcuteBenchmark belongs in the Julia inventory as part of ecosystem
...
- Treat category as `benchmarking` unless a later verified source gives a better classification.
...
| Name | Category | Page |
| --- | --- | --- |
| AnomalyBenchmark | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-anomalybenchmark-ff300368.md) |
| BandwidthBenchmark | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bandwidthbenchmark-3b0836ab.md) |
| BenchmarkCI | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkci-412a85a3.md) |
| BenchmarkConfigSweeps | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkconfigsweeps-3589525f.md) |
| BenchmarkEnvironments | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkenvironments-63e4166e.md) |
| BenchmarkFreeFermions | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkfreefermions-f2cecb6f.md) |
| BenchmarkFunctions | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkfunctions-1e390112.md) |
| BenchmarkHistograms | Benchmarking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchmarkhistograms-7347bd5c.md) |
