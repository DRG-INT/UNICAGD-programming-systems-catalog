...
<!-- canonical: https://github.com/ppgia-unifor/Broadmark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ppgia-unifor/Broadmark](https://github.com/ppgia-unifor/Broadmark) |
| Source record ids | github_search_physics_engines-56b01a17629547 |

## System Engineer Summary

A framework for the development, testing and evaluation of broad phase collision detection
algorithms

## Operational Role

For a systems engineer, ppgia-unifor/Broadmark belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-03-12T15:21:33Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-56b01a17629547` from `github_search_physics_engines` as `registry_expansion`
