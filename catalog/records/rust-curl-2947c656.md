...
| Canonical URL | [https://crates.io/crates/curl](https://crates.io/crates/curl) |
| Source record ids | crates_io-6751eb25099d9e |
...
For a systems engineer, curl belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.50 | 2026-06-11T03:17:48.678138Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-6751eb25099d9e` from `crates_io` as `registry_expansion`
