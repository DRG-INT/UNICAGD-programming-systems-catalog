...
<!-- canonical: https://cran.r-project.org/web/packages/FCPS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FCPS/index.html](https://cran.r-project.org/web/packages/FCPS/index.html) |
| Source record ids | cran_packages_by_date-a230ad86d39885 |
...
For a systems engineer, FCPS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2026-08-20 08:12:18 UTC | [https://cran.r-project.org/web/packages/FCPS/DESCRIPTION](https://cran.r-project.org/web/packages/FCPS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FCPS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a230ad86d39885` from `cran_packages_by_date` as `registry_expansion`
