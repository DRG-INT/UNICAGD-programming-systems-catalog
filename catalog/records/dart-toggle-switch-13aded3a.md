...
<!-- canonical: https://pub.dev/packages/toggle_switch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/toggle_switch](https://pub.dev/packages/toggle_switch) |
| Source record ids | pub_dev-4d9d412655f8e6 |

## System Engineer Summary

Toggle Switch - A simple toggle switch widget. It can be fully customized with desired icons, width,
colors, text, corner radius etc. It also maintains selection state.

## Operational Role

For a systems engineer, toggle_switch belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2024-03-25T19:02:12.355706Z | [https://pub.dev/api/packages/toggle_switch](https://pub.dev/api/packages/toggle_switch) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/toggle_switch` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-4d9d412655f8e6` from `pub_dev` as `registry_expansion`
