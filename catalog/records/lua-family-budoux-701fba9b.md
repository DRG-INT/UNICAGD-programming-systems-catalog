...
<!-- canonical: https://luarocks.org/modules/delphinus/budoux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/delphinus/budoux](https://luarocks.org/modules/delphinus/budoux) |
| Source record ids | luarocks_root_manifest-83c775f8214c19 |

## System Engineer Summary

A Lua port of BudouX — ML-powered line break organizer for CJK text

## Operational Role

For a systems engineer, budoux belongs in the Lua family inventory as part of model pipelines,
...
- `luarocks_root_manifest-83c775f8214c19` from `luarocks_root_manifest` as `registry_expansion`
