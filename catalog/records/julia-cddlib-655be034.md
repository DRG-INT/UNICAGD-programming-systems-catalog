...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CDDLib](https://github.com/JuliaRegistries/General/tree/master/C/CDDLib) |
| Source record ids | julia_general-1819ade0f8ac96 |

## System Engineer Summary

Julia package registered in General at C/CDDLib.

## Operational Role

For a systems engineer, CDDLib belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CDDLib", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-1819ade0f8ac96` from `julia_general` as `registry_expansion`
