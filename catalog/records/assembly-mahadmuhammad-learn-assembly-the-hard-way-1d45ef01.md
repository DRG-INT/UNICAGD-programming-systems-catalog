...
<!-- canonical: https://github.com/MahadMuhammad/Learn-Assembly-The-Hard-Way -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MahadMuhammad/Learn-Assembly-The-Hard-Way](https://github.com/MahadMuhammad/Learn-Assembly-The-Hard-Way) |
| Source record ids | github_search_assembly-15bf47da98df6f |

## System Engineer Summary

A single & unified source of all source codes & helping material in learning the Intel 8088 assembly
language using DOSBOX as an emulator

## Operational Role

For a systems engineer, MahadMuhammad/Learn-Assembly-The-Hard-Way belongs in the Assembly inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-01T14:40:02Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-15bf47da98df6f` from `github_search_assembly` as `registry_expansion`
