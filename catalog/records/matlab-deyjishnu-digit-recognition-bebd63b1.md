...
<!-- canonical: https://github.com/deyjishnu/digit-recognition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deyjishnu/digit-recognition](https://github.com/deyjishnu/digit-recognition) |
| Source record ids | github_search_matlab-852c9342f5fd2c |

## System Engineer Summary

The purpose of this project is to take handwritten digits as input, process the digits, train the
neural network algorithm with the processed data, to recognize the pattern and successfully identify
the test digits. The popular MNIST dataset is used for the training and testing purposes. The IDE
used is MATLAB

## Operational Role

For a systems engineer, deyjishnu/digit-recognition belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-04-02T19:01:47Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-852c9342f5fd2c` from `github_search_matlab` as `registry_expansion`
