...
| Canonical URL | [https://crates.io/crates/async-object-pool](https://crates.io/crates/async-object-pool) |
| Source record ids | crates_io-48005f079e71f2 |
...
For a systems engineer, async-object-pool belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2025-08-27T21:25:55.142159Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-48005f079e71f2` from `crates_io` as `registry_expansion`
