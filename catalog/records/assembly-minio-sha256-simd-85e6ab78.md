...
<!-- canonical: https://github.com/minio/sha256-simd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/minio/sha256-simd](https://github.com/minio/sha256-simd) |
| Source record ids | github_search_assembly-d7b4a16f12ea6c |

## System Engineer Summary

Accelerate SHA256 computations in pure Go using AVX512, SHA Extensions for x86 and ARM64 for ARM. On
AVX512 it provides an up to 8x improvement (over 3 GB/s per core). SHA Extensions give a performance
boost of close to 4x over native.

## Operational Role

For a systems engineer, minio/sha256-simd belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-24T07:54:41Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-d7b4a16f12ea6c` from `github_search_assembly` as `registry_expansion`
