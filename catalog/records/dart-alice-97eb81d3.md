...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/alice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/alice](https://pub.dev/packages/alice) |
| Source record ids | pub_dev-8b2dd4b3d3464c |

## System Engineer Summary

Alice is an HTTP Inspector tool which helps debugging http requests. It catches and stores http
requests and responses, which can be viewed via simple UI.

## Operational Role

For a systems engineer, alice belongs in the Dart inventory as part of fault isolation, live
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-09-15T10:21:19.665413Z | [https://pub.dev/api/packages/alice](https://pub.dev/api/packages/alice) |  |
| preview | known | 1.0.0-dev.12 | 2024-09-29T14:15:39.989936Z | [https://pub.dev/api/packages/alice](https://pub.dev/api/packages/alice) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/alice` at `2026-09-15T12:24:56+00:00`.
...
- `pub_dev-8b2dd4b3d3464c` from `pub_dev` as `registry_expansion`
