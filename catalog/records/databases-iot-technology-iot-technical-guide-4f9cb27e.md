...
<!-- canonical: https://github.com/IoT-Technology/IoT-Technical-Guide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IoT-Technology/IoT-Technical-Guide](https://github.com/IoT-Technology/IoT-Technical-Guide) |
| Source record ids | github_search_databases-12d665809d3261 |

## System Engineer Summary

:honeybee: IoT Technical Guide --- 从零搭建高性能物联网平台及物联网解决方案和Thingsboard源码分析 :sparkles: :sparkles:
:sparkles: (IoT Platform, SaaS, MQTT, CoAP, HTTP, Modbus, OPC, WebSocket, 物模型，Protobuf, PostgreSQL,
MongoDB, Spring Security, OAuth2, RuleEngine, Kafka, Docker)

## Operational Role

For a systems engineer, IoT-Technology/IoT-Technical-Guide belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-05T12:28:00Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-12d665809d3261` from `github_search_databases` as `registry_expansion`
