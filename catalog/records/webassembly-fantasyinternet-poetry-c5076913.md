...
<!-- canonical: https://github.com/FantasyInternet/poetry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FantasyInternet/poetry](https://github.com/FantasyInternet/poetry) |
| Source record ids | github_search_webassembly-06a2de85f0a609 |
...
For a systems engineer, FantasyInternet/poetry belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-13T14:46:50Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-06a2de85f0a609` from `github_search_webassembly` as `registry_expansion`
