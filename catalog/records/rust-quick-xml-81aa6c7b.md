...
<!-- canonical: https://crates.io/crates/quick-xml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quick-xml](https://crates.io/crates/quick-xml) |
| Source record ids | crates_io-977292e997973a |
...
For a systems engineer, quick-xml belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.42.0 | 2026-08-22T19:22:01.795943Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-977292e997973a` from `crates_io` as `registry_expansion`
