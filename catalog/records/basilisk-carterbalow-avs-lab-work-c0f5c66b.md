...
<!-- canonical: https://github.com/CarterBalow/avs-lab-work -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CarterBalow/avs-lab-work](https://github.com/CarterBalow/avs-lab-work) |
| Source record ids | github_search_basilisk-f917a8bd6135ba |

## System Engineer Summary

All of my code pertaining to the Astrodynamics Vehicle Systems Lab, including Basilisk simulations
and experimental code

## Operational Role

For a systems engineer, CarterBalow/avs-lab-work belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:52:11Z | gh search repos basilisk astrodynamics | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-f917a8bd6135ba` from `github_search_basilisk` as `registry_expansion`
