...
| Canonical URL | [https://luarocks.org/modules/erran/kong-datadog-k8s](https://luarocks.org/modules/erran/kong-datadog-k8s) |
| Source record ids | luarocks_root_manifest-763c6a3c5b10aa |

## System Engineer Summary

kong-datadog-k8s is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, kong-datadog-k8s belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-763c6a3c5b10aa` from `luarocks_root_manifest` as `registry_expansion`
