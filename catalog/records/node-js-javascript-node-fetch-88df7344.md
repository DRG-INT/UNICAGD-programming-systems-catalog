...
| Source record ids | corpus-94d64b89c0c5b8 |

## System Engineer Summary

node-fetch is tracked as a networking http record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, node-fetch belongs in the Node.js/JavaScript inventory as part of service
...
- `corpus-94d64b89c0c5b8` from `master_json` as `networking_http`
