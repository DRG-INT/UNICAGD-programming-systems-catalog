...
<!-- canonical: https://github.com/messeb/ios-project-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/messeb/ios-project-template](https://github.com/messeb/ios-project-template) |
| Source record ids | awesome_list-851b8a3c32a378 |

## System Engineer Summary

iOS project template with fastlane lanes, Travis CI jobs and GitHub integrations of Codecov, HoundCI
for SwiftLint and Danger.

## Operational Role

For a systems engineer, iOS project template belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Boilerplates", "source_url": "https://raw.githubusercontent.com/matteocrippa/awesome-swift/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-851b8a3c32a378` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| krzysztofzablocki/Sourcery | Project Scaffolding | [open](swift-krzysztofzablocki-sourcery-82c012e3.md) |
