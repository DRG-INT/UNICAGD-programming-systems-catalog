...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Standard Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/standard-library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/is_terminal_polyfill](https://crates.io/crates/is_terminal_polyfill) |
| Source record ids | crates_io-4b82055ee86318 |
...
For a systems engineer, is_terminal_polyfill belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.70.2 | 2025-10-21T17:10:33.347971Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| alloc-no-stdlib | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alloc-no-stdlib-4bb5e3d7.md) |
| alloc-stdlib | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alloc-stdlib-374940d8.md) |
| javascriptcore-rs | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-javascriptcore-rs-1b6020f2.md) |
| javascriptcore-rs-sys | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-javascriptcore-rs-sys-64aa7b2d.md) |
| once_cell_polyfill | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-once-cell-polyfill-bac8545c.md) |
| papergrid | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-papergrid-fccdef9a.md) |
