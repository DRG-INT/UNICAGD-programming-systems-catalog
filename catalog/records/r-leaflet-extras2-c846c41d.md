...
<!-- canonical: https://cran.r-project.org/web/packages/leaflet.extras2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/leaflet.extras2/index.html](https://cran.r-project.org/web/packages/leaflet.extras2/index.html) |
| Source record ids | cran_packages_by_date-413f8c567a840a |
...
For a systems engineer, leaflet.extras2 belongs in the R inventory as part of input-space
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3 | 2026-09-09 23:50:02 UTC | [https://cran.r-project.org/web/packages/leaflet.extras2/DESCRIPTION](https://cran.r-project.org/web/packages/leaflet.extras2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/leaflet.extras2/DESCRIPTION` at `2026-09-10T00:26:07+00:00`.
...
- `cran_packages_by_date-413f8c567a840a` from `cran_packages_by_date` as `registry_expansion`
