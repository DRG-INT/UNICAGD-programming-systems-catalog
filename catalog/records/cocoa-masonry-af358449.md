...
<!-- canonical: https://cocoapods.org/pods/Masonry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Masonry](https://cocoapods.org/pods/Masonry) |
| Source record ids | cocoapods_cdn-183fae0fcc5f28 |
...
For a systems engineer, Masonry belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2017-09-20 06:43:57 UTC | [https://trunk.cocoapods.org/api/v1/pods/Masonry](https://trunk.cocoapods.org/api/v1/pods/Masonry) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Masonry` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-183fae0fcc5f28` from `cocoapods_cdn` as `registry_expansion`
