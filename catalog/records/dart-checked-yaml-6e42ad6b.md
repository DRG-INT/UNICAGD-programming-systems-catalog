...
<!-- canonical: https://pub.dev/packages/checked_yaml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/checked_yaml](https://pub.dev/packages/checked_yaml) |
| Source record ids | pub_dev-8cc629c3823e28 |

## System Engineer Summary

Generate more helpful exceptions when decoding YAML documents using package:json_serializable and
package:yaml.

## Operational Role

For a systems engineer, checked_yaml belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.4 | 2025-06-05T00:41:05.969146Z | [https://pub.dev/api/packages/checked_yaml](https://pub.dev/api/packages/checked_yaml) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/checked_yaml` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-8cc629c3823e28` from `pub_dev` as `registry_expansion`
