...
<!-- canonical: https://cran.r-project.org/web/packages/isoexplorer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/isoexplorer/index.html](https://cran.r-project.org/web/packages/isoexplorer/index.html) |
| Source record ids | cran_packages_by_date-62079a0a69586b |

## System Engineer Summary

GUI Components to Explore Stable Isotope Data Files

## Operational Role

For a systems engineer, isoexplorer belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-07 20:30:02 UTC | [https://cran.r-project.org/web/packages/isoexplorer/DESCRIPTION](https://cran.r-project.org/web/packages/isoexplorer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/isoexplorer/DESCRIPTION` at `2026-09-07T22:19:06+00:00`.
...
- `cran_packages_by_date-62079a0a69586b` from `cran_packages_by_date` as `registry_expansion`
