...
<!-- canonical: https://cran.r-project.org/web/packages/K4Guru/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/K4Guru/index.html](https://cran.r-project.org/web/packages/K4Guru/index.html) |
| Source record ids | cran_packages_by_date-48cd864f4a9f43 |

## System Engineer Summary

Teacher Context Data Files for TIMSS 2023 Grade 4

## Operational Role

For a systems engineer, K4Guru belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 13:10:03 UTC | [https://cran.r-project.org/web/packages/K4Guru/DESCRIPTION](https://cran.r-project.org/web/packages/K4Guru/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/K4Guru/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-48cd864f4a9f43` from `cran_packages_by_date` as `registry_expansion`
