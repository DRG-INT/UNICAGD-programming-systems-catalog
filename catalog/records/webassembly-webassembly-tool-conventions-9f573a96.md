...
<!-- canonical: https://github.com/WebAssembly/tool-conventions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/tool-conventions](https://github.com/WebAssembly/tool-conventions) |
| Source record ids | github_search_webassembly-fad9af3076fb4c |
...
For a systems engineer, WebAssembly/tool-conventions belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T21:35:48Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Artistic License 2.0; https://api.github.com/licenses/artistic-2.0 |
...
- `github_search_webassembly-fad9af3076fb4c` from `github_search_webassembly` as `registry_expansion`
