...
<!-- canonical: https://pub.dev/packages/flutter_advanced_switch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_advanced_switch](https://pub.dev/packages/flutter_advanced_switch) |
| Source record ids | pub_dev-76659931a3b444 |

## System Engineer Summary

An advanced switch control provides a rich API for widget customization that opens a new look and
feel in your app.

## Operational Role

For a systems engineer, flutter_advanced_switch belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.1 | 2026-07-01T05:50:40.304568Z | [https://pub.dev/api/packages/flutter_advanced_switch](https://pub.dev/api/packages/flutter_advanced_switch) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_advanced_switch` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-76659931a3b444` from `pub_dev` as `registry_expansion`
