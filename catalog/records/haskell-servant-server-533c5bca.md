...
<!-- canonical: https://hackage.haskell.org/package/servant-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/servant-server](https://hackage.haskell.org/package/servant-server) |
| Source record ids | hackage_top_downloads-09f9f359f020e8 |
...
For a systems engineer, servant-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.3.0 | 2025-06-04T10:14:31Z | [https://hackage.haskell.org/package/servant-server](https://hackage.haskell.org/package/servant-server) |  |
| candidate | partial | 0.14.1 |  | [https://hackage.haskell.org/package/servant-server](https://hackage.haskell.org/package/servant-server) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/servant-server` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-09f9f359f020e8` from `hackage_top_downloads` as `registry_expansion`
