...
<!-- canonical: https://cran.r-project.org/web/packages/p2oncology/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/p2oncology/index.html](https://cran.r-project.org/web/packages/p2oncology/index.html) |
| Source record ids | cran_packages_by_date-5171b27c9a5cee |

## System Engineer Summary

Single Arm Phase 2 Oncology Trial

## Operational Role

For a systems engineer, p2oncology belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-14 19:50:02 UTC | [https://cran.r-project.org/web/packages/p2oncology/DESCRIPTION](https://cran.r-project.org/web/packages/p2oncology/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/p2oncology/DESCRIPTION` at `2026-09-14T20:20:20+00:00`.
...
- `cran_packages_by_date-5171b27c9a5cee` from `cran_packages_by_date` as `registry_expansion`
