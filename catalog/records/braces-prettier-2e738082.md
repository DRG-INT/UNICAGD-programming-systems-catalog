...
| Canonical URL | [https://prettier.io/](https://prettier.io/) |
| Source record ids | curated_language_routes-0783f059a7dde8 |

## System Engineer Summary

Opinionated formatter that rewrites brace-delimited JavaScript, TypeScript, JSON, CSS, GraphQL,
Markdown, and many plugin languages.

## Operational Role

For a systems engineer, Prettier belongs in the Braces inventory as part of low-noise code review,
...
- `curated_language_routes-0783f059a7dde8` from `curated_language_routes` as `registry_expansion`
