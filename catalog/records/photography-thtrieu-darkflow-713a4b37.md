...
<!-- canonical: https://github.com/thtrieu/darkflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thtrieu/darkflow](https://github.com/thtrieu/darkflow) |
| Source record ids | github_search_photography-054c7136634ba9 |

## System Engineer Summary

Translate darknet to tensorflow. Load trained weights, retrain/fine-tune using tensorflow, export
constant graph def to mobile devices

## Operational Role

For a systems engineer, thtrieu/darkflow belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-23T23:26:26Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_photography-054c7136634ba9` from `github_search_photography` as `registry_expansion`
