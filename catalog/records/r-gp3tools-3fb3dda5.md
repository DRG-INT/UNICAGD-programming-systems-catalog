...
<!-- canonical: https://cran.r-project.org/web/packages/gp3tools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gp3tools/index.html](https://cran.r-project.org/web/packages/gp3tools/index.html) |
| Source record ids | cran_packages_by_date-f091fc48b4a71d |

## System Engineer Summary

Import, Inspect, Analyse, and Report Gazepoint GP3 Exports

## Operational Role

For a systems engineer, gp3tools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-21 05:43:15 UTC | [https://cran.r-project.org/web/packages/gp3tools/DESCRIPTION](https://cran.r-project.org/web/packages/gp3tools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gp3tools/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f091fc48b4a71d` from `cran_packages_by_date` as `registry_expansion`
...
| AdaptHyCensor | Library | [open](r-adapthycensor-60455d52.md) |
| AddiVortes | Library | [open](r-addivortes-3d7d418d.md) |
