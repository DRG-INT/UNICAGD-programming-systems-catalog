...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | corpus-d99b69dbc53473 |

## System Engineer Summary

spdlog is tracked as a logging observability record in the C++23 branch. The source did not provide
...
For a systems engineer, spdlog belongs in the C++23 inventory as part of diagnostics, metrics,
...
- `corpus-d99b69dbc53473` from `master_json` as `logging_observability`
...
| Name | Category | Page |
| --- | --- | --- |
| Boost.Log | Logging Observability | [open](c-23-boost-log-e3926c67.md) |
| glog | Logging Observability | [open](c-23-glog-70bb7af5.md) |
| OpenTelemetry C++ | Logging Observability | [open](c-23-opentelemetry-c-bd30be82.md) |
