...
<!-- canonical: https://github.com/ahujasid/mcp-for-blender -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ahujasid/mcp-for-blender](https://github.com/ahujasid/mcp-for-blender) |
| Source record ids | github_search_aims-d506ac41f6d98a |
...
For a systems engineer, ahujasid/mcp-for-blender belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-16T05:45:01Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-d506ac41f6d98a` from `github_search_aims` as `registry_expansion`
