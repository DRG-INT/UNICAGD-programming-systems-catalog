...
| Canonical URL | [https://luarocks.org/modules/monzita/encrypto](https://luarocks.org/modules/monzita/encrypto) |
| Source record ids | luarocks_root_manifest-a9d0ea4ec444f7 |

## System Engineer Summary

encrypto is tracked as a cryptography record in the Lua family branch. The source did not provide a
...
For a systems engineer, encrypto belongs in the Lua family inventory as part of confidentiality,
...
- `luarocks_root_manifest-a9d0ea4ec444f7` from `luarocks_root_manifest` as `registry_expansion`
