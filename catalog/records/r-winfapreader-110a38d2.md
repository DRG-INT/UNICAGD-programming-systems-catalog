...
<!-- canonical: https://cran.r-project.org/web/packages/winfapReader/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/winfapReader/index.html](https://cran.r-project.org/web/packages/winfapReader/index.html) |
| Source record ids | cran_packages_by_date-f2fa19a2e40649 |
...
For a systems engineer, winfapReader belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-7.1 | 2026-08-31 19:30:02 UTC | [https://cran.r-project.org/web/packages/winfapReader/DESCRIPTION](https://cran.r-project.org/web/packages/winfapReader/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/winfapReader/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f2fa19a2e40649` from `cran_packages_by_date` as `registry_expansion`
