...
<!-- canonical: https://cran.r-project.org/web/packages/greenbook/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/greenbook/index.html](https://cran.r-project.org/web/packages/greenbook/index.html) |
| Source record ids | cran_packages_by_date-2a2bd48341c7c4 |
...
For a systems engineer, greenbook belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-24 07:30:28 UTC | [https://cran.r-project.org/web/packages/greenbook/DESCRIPTION](https://cran.r-project.org/web/packages/greenbook/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/greenbook/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2a2bd48341c7c4` from `cran_packages_by_date` as `registry_expansion`
