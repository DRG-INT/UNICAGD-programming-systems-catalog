...
<!-- canonical: https://github.com/mountain-pass/addressr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mountain-pass/addressr](https://github.com/mountain-pass/addressr) |
| Source record ids | github_search_maps-ba94ef78ceeb57 |
...
For a systems engineer, mountain-pass/addressr belongs in the Maps inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | @mountainpass/addressr-react@0.7.5 | 2026-08-28T22:32:14Z | [https://api.github.com/repos/mountain-pass/addressr/releases/latest](https://api.github.com/repos/mountain-pass/addressr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mountain-pass/addressr/releases/latest` at `2026-09-01T12:30:03+00:00`.
...
- `github_search_maps-ba94ef78ceeb57` from `github_search_maps` as `registry_expansion`
