...
<!-- canonical: https://crates.io/crates/socket2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/socket2](https://crates.io/crates/socket2) |
| Source record ids | crates_io-aeb6ef12f486ff |
...
For a systems engineer, socket2 belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-07-13T19:45:58.436336Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-aeb6ef12f486ff` from `crates_io` as `registry_expansion`
