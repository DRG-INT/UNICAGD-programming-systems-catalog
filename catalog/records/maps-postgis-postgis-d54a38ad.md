...
| Source record ids | github_search_maps-3ca33e7bfe47b8 |
...
For a systems engineer, postgis/postgis belongs in the Maps inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T09:40:25Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_maps-3ca33e7bfe47b8` from `github_search_maps` as `registry_expansion`
