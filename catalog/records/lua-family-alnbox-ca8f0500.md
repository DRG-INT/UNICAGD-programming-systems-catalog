...
<!-- canonical: https://luarocks.org/modules/starius/alnbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/starius/alnbox](https://luarocks.org/modules/starius/alnbox) |
| Source record ids | luarocks_root_manifest-50eeeecbdf1723 |
...
For a systems engineer, alnbox belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-50eeeecbdf1723` from `luarocks_root_manifest` as `registry_expansion`
