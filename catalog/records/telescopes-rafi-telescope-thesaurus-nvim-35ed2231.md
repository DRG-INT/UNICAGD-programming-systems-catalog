...
<!-- canonical: https://github.com/rafi/telescope-thesaurus.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rafi/telescope-thesaurus.nvim](https://github.com/rafi/telescope-thesaurus.nvim) |
| Source record ids | github_search_telescopes-6790bd8ed6996a |
...
For a systems engineer, rafi/telescope-thesaurus.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-25T04:11:07Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-6790bd8ed6996a` from `github_search_telescopes` as `registry_expansion`
