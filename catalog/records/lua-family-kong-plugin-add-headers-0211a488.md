...
| Canonical URL | [https://luarocks.org/modules/kikito/kong-plugin-add-headers](https://luarocks.org/modules/kikito/kong-plugin-add-headers) |
| Source record ids | luarocks_root_manifest-f0f34617857a2f |
...
For a systems engineer, kong-plugin-add-headers belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-f0f34617857a2f` from `luarocks_root_manifest` as `registry_expansion`
