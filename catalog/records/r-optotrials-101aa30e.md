...
<!-- canonical: https://cran.r-project.org/web/packages/OptOTrials/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OptOTrials/index.html](https://cran.r-project.org/web/packages/OptOTrials/index.html) |
| Source record ids | cran_packages_by_date-0fb3b91600c824 |
...
For a systems engineer, OptOTrials belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-31 18:20:02 UTC | [https://cran.r-project.org/web/packages/OptOTrials/DESCRIPTION](https://cran.r-project.org/web/packages/OptOTrials/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OptOTrials/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0fb3b91600c824` from `cran_packages_by_date` as `registry_expansion`
