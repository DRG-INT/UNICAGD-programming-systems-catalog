...
<!-- canonical: https://hackage.haskell.org/package/comonads-fd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/comonads-fd](https://hackage.haskell.org/package/comonads-fd) |
| Source record ids | hackage_top_downloads-8e377661e91f2f |
...
For a systems engineer, comonads-fd belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0 | 2013-10-13T22:06:51Z | [https://hackage.haskell.org/package/comonads-fd](https://hackage.haskell.org/package/comonads-fd) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/comonads-fd` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-8e377661e91f2f` from `hackage_top_downloads` as `registry_expansion`
