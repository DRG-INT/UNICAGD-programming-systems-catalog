...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/HandsOnLLM/Hands-On-Large-Language-Models](https://github.com/HandsOnLLM/Hands-On-Large-Language-Models) |
| Source record ids | github_search_aims-420c6127cd8276 |
...
For a systems engineer, HandsOnLLM/Hands-On-Large-Language-Models belongs in the "aim's" inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T10:20:08Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-420c6127cd8276` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| feder-cr/AIHawk | Language Specification | [open](aim-s-feder-cr-aihawk-d2319d23.md) |
| FoundationAgents/MetaGPT | Language Specification | [open](aim-s-foundationagents-metagpt-606ff019.md) |
| mlabonne/llm-course | Language Specification | [open](aim-s-mlabonne-llm-course-686674f6.md) |
| mukul975/Anthropic-Cybersecurity-Skills | Language Specification | [open](aim-s-mukul975-anthropic-cybersecurity-skills-9e0cc92c.md) |
| p-e-w/heretic | Language Specification | [open](aim-s-p-e-w-heretic-a6b88cd3.md) |
| sgl-project/sglang | Language Specification | [open](aim-s-sgl-project-sglang-4b12b8a7.md) |
| yamadashy/repomix | Language Specification | [open](aim-s-yamadashy-repomix-25d6e394.md) |
