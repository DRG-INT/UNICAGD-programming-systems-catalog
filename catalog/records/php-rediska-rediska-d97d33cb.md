...
<!-- canonical: https://packagist.org/packages/rediska/rediska -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/rediska/rediska](https://packagist.org/packages/rediska/rediska) |
| Source record ids | packagist_search-eabd29dc60ae5e |
...
For a systems engineer, rediska/rediska belongs in the PHP inventory as part of service
...
- `packagist_search-eabd29dc60ae5e` from `packagist_search` as `registry_expansion`
