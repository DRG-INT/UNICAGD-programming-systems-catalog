...
<!-- canonical: https://cran.r-project.org/web/packages/redlist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/redlist/index.html](https://cran.r-project.org/web/packages/redlist/index.html) |
| Source record ids | cran_packages_by_date-298ca810a93ffb |

## System Engineer Summary

Interface to the IUCN Red List Data with Risk Metrics

## Operational Role

For a systems engineer, redlist belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-04 06:40:02 UTC | [https://cran.r-project.org/web/packages/redlist/DESCRIPTION](https://cran.r-project.org/web/packages/redlist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/redlist/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-298ca810a93ffb` from `cran_packages_by_date` as `registry_expansion`
