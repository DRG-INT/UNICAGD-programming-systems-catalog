...
<!-- canonical: https://packagist.org/packages/php-http/discovery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/discovery](https://packagist.org/packages/php-http/discovery) |
| Source record ids | packagist_search-ce865d46466e64 |
...
For a systems engineer, php-http/discovery belongs in the PHP inventory as part of service
...
- `packagist_search-ce865d46466e64` from `packagist_search` as `registry_expansion`
