...
<!-- canonical: https://github.com/celestiamobile/AndroidCelestia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/celestiamobile/AndroidCelestia](https://github.com/celestiamobile/AndroidCelestia) |
| Source record ids | github_search_telescopes-b4eb3a2dedd9bd |
...
For a systems engineer, celestiamobile/AndroidCelestia belongs in the Telescopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:25:56Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-b4eb3a2dedd9bd` from `github_search_telescopes` as `registry_expansion`
