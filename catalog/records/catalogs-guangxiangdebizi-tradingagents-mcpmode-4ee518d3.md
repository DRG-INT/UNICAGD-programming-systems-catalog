...
<!-- canonical: https://github.com/guangxiangdebizi/TradingAgents-MCPmode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/guangxiangdebizi/TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode) |
| Source record ids | github_search_catalogs-fb0c361a0df77f |

## System Engineer Summary

TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP)
工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

## Operational Role

For a systems engineer, guangxiangdebizi/TradingAgents-MCPmode belongs in the Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-22T07:04:36Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-fb0c361a0df77f` from `github_search_catalogs` as `registry_expansion`
