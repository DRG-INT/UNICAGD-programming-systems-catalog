...
<!-- canonical: https://github.com/jasonjmcghee/rem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jasonjmcghee/rem](https://github.com/jasonjmcghee/rem) |
| Source record ids | github_search_swift-6d33115977419c |
...
For a systems engineer, jasonjmcghee/rem belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-30T04:28:09Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-6d33115977419c` from `github_search_swift` as `registry_expansion`
