...
<!-- canonical: https://github.com/bennylope/pygeocodio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bennylope/pygeocodio](https://github.com/bennylope/pygeocodio) |
| Source record ids | github_search_maps-bd147a7fc3ebc1 |
...
For a systems engineer, bennylope/pygeocodio belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.1 | 2025-06-18T14:43:52Z | [https://api.github.com/repos/bennylope/pygeocodio/releases/latest](https://api.github.com/repos/bennylope/pygeocodio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bennylope/pygeocodio/releases/latest` at `2026-09-01T12:29:58+00:00`.
...
- `github_search_maps-bd147a7fc3ebc1` from `github_search_maps` as `registry_expansion`
