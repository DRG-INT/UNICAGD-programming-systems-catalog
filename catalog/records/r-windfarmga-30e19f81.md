...
<!-- canonical: https://cran.r-project.org/web/packages/windfarmGA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/windfarmGA/index.html](https://cran.r-project.org/web/packages/windfarmGA/index.html) |
| Source record ids | cran_packages_by_date-b5ad4b2aa793a6 |
...
For a systems engineer, windfarmGA belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-09-14 06:40:02 UTC | [https://cran.r-project.org/web/packages/windfarmGA/DESCRIPTION](https://cran.r-project.org/web/packages/windfarmGA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/windfarmGA/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-b5ad4b2aa793a6` from `cran_packages_by_date` as `registry_expansion`
