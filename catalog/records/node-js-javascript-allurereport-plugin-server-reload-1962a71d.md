...
<!-- canonical: https://www.npmjs.com/package/@allurereport/plugin-server-reload -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@allurereport/plugin-server-reload](https://www.npmjs.com/package/@allurereport/plugin-server-reload) |
| Source record ids | npm_registry-82dc973e1c6826 |

## System Engineer Summary

Allure Plugin to reload Allure Static Server on state change

## Operational Role

For a systems engineer, @allurereport/plugin-server-reload belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.16.1 | 2026-09-07T08:15:41.226Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-82dc973e1c6826` from `npm_registry` as `registry_expansion`
