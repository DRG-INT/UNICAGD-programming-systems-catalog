...
<!-- canonical: https://github.com/unicodeveloper/awesome-nextjs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unicodeveloper/awesome-nextjs](https://github.com/unicodeveloper/awesome-nextjs) |
| Source record ids | github_search_maps-2abc6d4d68e161 |

## System Engineer Summary

:notebook_with_decorative_cover: :books: A curated list of awesome resources : books, videos,
articles about using Next.js (A minimalistic framework for universal server-rendered React
applications)

## Operational Role

For a systems engineer, unicodeveloper/awesome-nextjs belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T09:11:21Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2abc6d4d68e161` from `github_search_maps` as `registry_expansion`
