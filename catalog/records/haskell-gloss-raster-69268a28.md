...
<!-- canonical: https://hackage.haskell.org/package/gloss-raster -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gloss-raster](https://hackage.haskell.org/package/gloss-raster) |
| Source record ids | hackage_top_downloads-51ac5759459d53 |
...
For a systems engineer, gloss-raster belongs in the Haskell inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.1.2 | 2020-07-18T08:49:44Z | [https://hackage.haskell.org/package/gloss-raster](https://hackage.haskell.org/package/gloss-raster) |  |
| candidate | partial | 1.13.0.1 |  | [https://hackage.haskell.org/package/gloss-raster](https://hackage.haskell.org/package/gloss-raster) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gloss-raster` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-51ac5759459d53` from `hackage_top_downloads` as `registry_expansion`
