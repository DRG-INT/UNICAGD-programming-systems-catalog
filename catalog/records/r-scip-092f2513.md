...
<!-- canonical: https://cran.r-project.org/web/packages/scip/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scip/index.html](https://cran.r-project.org/web/packages/scip/index.html) |
| Source record ids | cran_packages_by_date-e3dfe8f2430b0c |
...
For a systems engineer, scip belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0-4 | 2026-08-30 14:10:10 UTC | [https://cran.r-project.org/web/packages/scip/DESCRIPTION](https://cran.r-project.org/web/packages/scip/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scip/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e3dfe8f2430b0c` from `cran_packages_by_date` as `registry_expansion`
