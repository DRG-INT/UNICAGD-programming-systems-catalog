...
<!-- canonical: https://pub.dev/packages/sidebarx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sidebarx](https://pub.dev/packages/sidebarx) |
| Source record ids | pub_dev-dd418094780821 |
...
For a systems engineer, sidebarx belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.2 | 2025-07-30T00:04:18.117688Z | [https://pub.dev/api/packages/sidebarx](https://pub.dev/api/packages/sidebarx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sidebarx` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-dd418094780821` from `pub_dev` as `registry_expansion`
