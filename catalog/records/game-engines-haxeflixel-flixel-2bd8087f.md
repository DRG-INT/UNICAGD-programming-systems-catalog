...
<!-- canonical: https://github.com/HaxeFlixel/flixel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HaxeFlixel/flixel](https://github.com/HaxeFlixel/flixel) |
| Source record ids | github_search_game_engines-047e3cdacc3731 |
...
For a systems engineer, HaxeFlixel/flixel belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T21:22:28Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-047e3cdacc3731` from `github_search_game_engines` as `registry_expansion`
