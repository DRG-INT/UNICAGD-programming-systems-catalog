...
<!-- canonical: https://github.com/infiniflow/ragflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/infiniflow/ragflow](https://github.com/infiniflow/ragflow) |
| Source record ids | github_search_go-db23473fd79f29 |

## System Engineer Summary

RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge
RAG with Agent capabilities to create a superior context layer for LLMs

## Operational Role

For a systems engineer, infiniflow/ragflow belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:15:30Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-db23473fd79f29` from `github_search_go` as `registry_expansion`
