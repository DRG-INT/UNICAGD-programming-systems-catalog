...
<!-- canonical: https://pub.dev/packages/patterns_canvas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/patterns_canvas](https://pub.dev/packages/patterns_canvas) |
| Source record ids | pub_dev-d33b7b74e7e459 |
...
For a systems engineer, patterns_canvas belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-03-26T09:19:35.583321Z | [https://pub.dev/api/packages/patterns_canvas](https://pub.dev/api/packages/patterns_canvas) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/patterns_canvas` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-d33b7b74e7e459` from `pub_dev` as `registry_expansion`
