...
<!-- canonical: https://cran.r-project.org/web/packages/RDesk/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RDesk/index.html](https://cran.r-project.org/web/packages/RDesk/index.html) |
| Source record ids | cran_packages_by_date-cb6724700f4584 |
...
For a systems engineer, RDesk belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2026-09-03 14:00:02 UTC | [https://cran.r-project.org/web/packages/RDesk/DESCRIPTION](https://cran.r-project.org/web/packages/RDesk/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RDesk/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-cb6724700f4584` from `cran_packages_by_date` as `registry_expansion`
