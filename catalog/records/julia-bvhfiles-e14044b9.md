...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BVHFiles](https://github.com/JuliaRegistries/General/tree/master/B/BVHFiles) |
| Source record ids | julia_general-8407f78fd43129 |

## System Engineer Summary

Julia package registered in General at B/BVHFiles.

## Operational Role

For a systems engineer, BVHFiles belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BVHFiles", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8407f78fd43129` from `julia_general` as `registry_expansion`
