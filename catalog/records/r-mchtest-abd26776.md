...
<!-- canonical: https://cran.r-project.org/web/packages/MChtest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MChtest/index.html](https://cran.r-project.org/web/packages/MChtest/index.html) |
| Source record ids | cran_packages_by_date-323dce6387a077 |
...
For a systems engineer, MChtest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-4 | 2026-08-31 22:10:14 UTC | [https://cran.r-project.org/web/packages/MChtest/DESCRIPTION](https://cran.r-project.org/web/packages/MChtest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MChtest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-323dce6387a077` from `cran_packages_by_date` as `registry_expansion`
