...
<!-- canonical: https://crates.io/crates/keccak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/keccak](https://crates.io/crates/keccak) |
| Source record ids | crates_io-5d491f744ee4a7 |
...
For a systems engineer, keccak belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-21T12:55:13.628790Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-5d491f744ee4a7` from `crates_io` as `registry_expansion`
