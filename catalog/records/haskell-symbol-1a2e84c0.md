...
<!-- canonical: https://hackage.haskell.org/package/symbol -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/symbol](https://hackage.haskell.org/package/symbol) |
| Source record ids | hackage_recent-2d000a4679dc4d |

## System Engineer Summary

Hackage package recently uploaded by GeoffreyMainland.

## Operational Role

For a systems engineer, symbol belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-11T18:37:27Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-11T20:20:33+00:00`.
...
- `hackage_recent-2d000a4679dc4d` from `hackage_recent` as `registry_expansion`
