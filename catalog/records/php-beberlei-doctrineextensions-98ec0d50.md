...
| Canonical URL | [https://packagist.org/packages/beberlei/doctrineextensions](https://packagist.org/packages/beberlei/doctrineextensions) |
| Source record ids | packagist_search-9ba7d1556e32aa |

## System Engineer Summary

A set of extensions to Doctrine 2 that add support for additional query functions available in
MySQL, Oracle, PostgreSQL and SQLite.

## Operational Role

For a systems engineer, beberlei/doctrineextensions belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.5.0 | 2024-03-03T17:56:18+00:00 | [https://repo.packagist.org/p2/beberlei/doctrineextensions.json](https://repo.packagist.org/p2/beberlei/doctrineextensions.json) |  |
| preview | known | v0.2-alpha | 2015-01-05T13:08:38+00:00 | [https://repo.packagist.org/p2/beberlei/doctrineextensions.json](https://repo.packagist.org/p2/beberlei/doctrineextensions.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/beberlei/doctrineextensions.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-9ba7d1556e32aa` from `packagist_search` as `registry_expansion`
