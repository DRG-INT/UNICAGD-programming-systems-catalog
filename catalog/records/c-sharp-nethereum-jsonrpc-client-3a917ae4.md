...
<!-- canonical: https://www.nuget.org/packages/Nethereum.JsonRpc.Client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Nethereum.JsonRpc.Client](https://www.nuget.org/packages/Nethereum.JsonRpc.Client) |
| Source record ids | nuget_search-0363ca1e2d6142 |

## System Engineer Summary

Nethereum JsonRpc.Client core library to use in conjunction with either the JsonRpc.RpcClient, the
JsonRpc.IpcClient or other custom Rpc provider

## Operational Role

For a systems engineer, Nethereum.JsonRpc.Client belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.0 | 2026-03-25T17:33:31.417+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nethereum.jsonrpc.client/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nethereum.jsonrpc.client/index.json) |  |
| preview | known | 3.0.0-rc3 | 2018-10-25T06:09:24.383+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nethereum.jsonrpc.client/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nethereum.jsonrpc.client/index.json) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit; https://www.nuget.org/packages/Nethereum.JsonRpc.Client/6.1.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/nethereum.jsonrpc.client/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-0363ca1e2d6142` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CacheManager.Serialization.Json | Standard Library | [open](c-sharp-cachemanager-serialization-json-78951178.md) |
