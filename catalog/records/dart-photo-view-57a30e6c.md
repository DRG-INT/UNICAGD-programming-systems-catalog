...
<!-- canonical: https://pub.dev/packages/photo_view -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/photo_view](https://pub.dev/packages/photo_view) |
| Source record ids | pub_dev-633754968aca5e |
...
For a systems engineer, photo_view belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2024-04-17T21:10:06.324115Z | [https://pub.dev/api/packages/photo_view](https://pub.dev/api/packages/photo_view) |  |
| preview | known | 0.7.0-next | 2019-10-23T14:18:36.684923Z | [https://pub.dev/api/packages/photo_view](https://pub.dev/api/packages/photo_view) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/photo_view` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-633754968aca5e` from `pub_dev` as `registry_expansion`
