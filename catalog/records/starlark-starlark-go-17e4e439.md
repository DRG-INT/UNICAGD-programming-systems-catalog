...
<!-- canonical: https://github.com/google/starlark-go -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/google/starlark-go](https://github.com/google/starlark-go) |
| Source record ids | curated_language_routes-558714ecc3f106 |

## System Engineer Summary

Go implementation of the Starlark language for embedding deterministic configuration and scripting.

## Operational Role

For a systems engineer, starlark-go belongs in the Starlark inventory as part of runtime behavior,
...
- `curated_language_routes-558714ecc3f106` from `curated_language_routes` as `registry_expansion`
