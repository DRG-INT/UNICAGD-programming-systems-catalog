...
<!-- canonical: https://github.com/eskopp/d3star -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eskopp/d3star](https://github.com/eskopp/d3star) |
| Source record ids | github_search_space_maps-8a35870658f0a9 |

## System Engineer Summary

Star map — enter a place and a date, view the night sky, pan and zoom

## Operational Role

For a systems engineer, eskopp/d3star belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T21:41:17Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8a35870658f0a9` from `github_search_space_maps` as `registry_expansion`
