...
<!-- canonical: https://crates.io/crates/futures-util -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-util](https://crates.io/crates/futures-util) |
| Source record ids | crates_io-51af13bd20d6af |
...
For a systems engineer, futures-util belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:19.272525Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-51af13bd20d6af` from `crates_io` as `registry_expansion`
