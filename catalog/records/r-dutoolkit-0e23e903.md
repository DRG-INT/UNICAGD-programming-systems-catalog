...
<!-- canonical: https://cran.r-project.org/web/packages/DUToolkit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DUToolkit/index.html](https://cran.r-project.org/web/packages/DUToolkit/index.html) |
| Source record ids | cran_packages_by_date-9848c59767a2df |
...
For a systems engineer, DUToolkit belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-11 17:00:07 UTC | [https://cran.r-project.org/web/packages/DUToolkit/DESCRIPTION](https://cran.r-project.org/web/packages/DUToolkit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DUToolkit/DESCRIPTION` at `2026-09-11T18:22:54+00:00`.
...
- `cran_packages_by_date-9848c59767a2df` from `cran_packages_by_date` as `registry_expansion`
