...
<!-- canonical: https://cran.r-project.org/web/packages/eidosapi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/eidosapi/index.html](https://cran.r-project.org/web/packages/eidosapi/index.html) |
| Source record ids | cran_packages_by_date-eb9e23428b8d86 |
...
For a systems engineer, eidosapi belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-11 12:00:09 UTC | [https://cran.r-project.org/web/packages/eidosapi/DESCRIPTION](https://cran.r-project.org/web/packages/eidosapi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/eidosapi/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-eb9e23428b8d86` from `cran_packages_by_date` as `registry_expansion`
