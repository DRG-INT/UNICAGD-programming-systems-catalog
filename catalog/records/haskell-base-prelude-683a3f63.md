...
<!-- canonical: https://hackage.haskell.org/package/base-prelude -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/base-prelude](https://hackage.haskell.org/package/base-prelude) |
| Source record ids | hackage_top_downloads-08e8b635c4a6fa |
...
For a systems engineer, base-prelude belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.1.1 | 2023-10-11T15:59:16Z | [https://hackage.haskell.org/package/base-prelude](https://hackage.haskell.org/package/base-prelude) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/base-prelude` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-08e8b635c4a6fa` from `hackage_top_downloads` as `registry_expansion`
