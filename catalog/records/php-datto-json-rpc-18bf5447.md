...
<!-- canonical: https://packagist.org/packages/datto/json-rpc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/datto/json-rpc](https://packagist.org/packages/datto/json-rpc) |
| Source record ids | packagist_search-a18936e712d151 |
...
For a systems engineer, datto/json-rpc belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-a18936e712d151` from `packagist_search` as `registry_expansion`
...
| cachewerk/relay | Testing Framework | [open](php-cachewerk-relay-fd3b6a06.md) |
| codeception/module-phpbrowser | Testing Framework | [open](php-codeception-module-phpbrowser-4f1fc3bc.md) |
| laravel/pao | Testing Framework | [open](php-laravel-pao-b15b4327.md) |
| lchrusciel/api-test-case | Testing Framework | [open](php-lchrusciel-api-test-case-b764f954.md) |
| nunomaduro/pao | Testing Framework | [open](php-nunomaduro-pao-58ddb2fb.md) |
| php-vcr/php-vcr | Testing Framework | [open](php-php-vcr-php-vcr-c1e12283.md) |
| phpunit/dbunit | Testing Framework | [open](php-phpunit-dbunit-7e156610.md) |
