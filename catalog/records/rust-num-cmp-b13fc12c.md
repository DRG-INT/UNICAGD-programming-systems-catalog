...
<!-- canonical: https://crates.io/crates/num-cmp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-cmp](https://crates.io/crates/num-cmp) |
| Source record ids | crates_io-05671c6905fe93 |
...
For a systems engineer, num-cmp belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2017-03-02T12:27:31.839910Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-05671c6905fe93` from `crates_io` as `registry_expansion`
