...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lmammino/oidc-authorizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lmammino/oidc-authorizer](https://github.com/lmammino/oidc-authorizer) |
| Source record ids | github_search_radars-25418aab5f1ab1 |
...
For a systems engineer, lmammino/oidc-authorizer belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T15:08:22Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-25418aab5f1ab1` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jie666-6/UrbanSARFloods | Benchmarking | [open](radars-jie666-6-urbansarfloods-71eae460.md) |
| remotebiosensing/rppg | Benchmarking | [open](radars-remotebiosensing-rppg-f297db7f.md) |
| robert80203/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-Wave-Radar | Benchmarking | [open](radars-robert80203-hupr-a-benchmark-for-human-pose-estimation-using-millimeter-wave-radar-f82a6c81.md) |
| rsasaki0109/lidar_slam_ros2 | Benchmarking | [open](radars-rsasaki0109-lidar-slam-ros2-d0c04735.md) |
| songyz2019/rs-fusion-datasets | Benchmarking | [open](radars-songyz2019-rs-fusion-datasets-b8aaf1d6.md) |
| sysstat/sysstat | Benchmarking | [open](radars-sysstat-sysstat-e3b4db1b.md) |
| waterdisappear/ATRNet-STAR | Benchmarking | [open](radars-waterdisappear-atrnet-star-4710a166.md) |
