...
<!-- canonical: https://github.com/jin/awesome-bazel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jin/awesome-bazel](https://github.com/jin/awesome-bazel) |
| Source record ids | github_search_starlark-c673245bd055ff |
...
For a systems engineer, jin/awesome-bazel belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-13T07:46:30Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-c673245bd055ff` from `github_search_starlark` as `registry_expansion`
