...
<!-- canonical: https://pub.dev/packages/tostore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/tostore](https://pub.dev/packages/tostore) |
| Source record ids | pub_dev-a8737eafe22cce |

## System Engineer Summary

Fast distributed AI vector database and persistent local storage engine. High-performance key-value
store supporting SQL, NoSQL, offline cache and encrypted data.

## Operational Role

For a systems engineer, tostore belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.1 | 2026-09-01T18:56:55.052904Z | [https://pub.dev/api/packages/tostore](https://pub.dev/api/packages/tostore) |  |
| preview | known | 3.5.0-test | 2026-09-01T14:43:28.859741Z | [https://pub.dev/api/packages/tostore](https://pub.dev/api/packages/tostore) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/tostore` at `2026-09-02T01:17:15+00:00`.
...
- `pub_dev-a8737eafe22cce` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| grpc | Benchmarking | [open](dart-grpc-b233bbd9.md) |
