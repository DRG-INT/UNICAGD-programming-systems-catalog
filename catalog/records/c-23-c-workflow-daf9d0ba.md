...
| Source record ids | awesome_list-60f68db706ced0 |
...
For a systems engineer, C++ Workflow belongs in the C++23 inventory as part of ecosystem capability
...
- `awesome_list-60f68db706ced0` from `awesome_list` as `registry_expansion`
