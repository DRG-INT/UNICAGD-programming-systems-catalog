...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/tulpa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tulpa/index.html](https://cran.r-project.org/web/packages/tulpa/index.html) |
| Source record ids | cran_packages_by_date-4a9675347e537b |
...
For a systems engineer, tulpa belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-09 15:30:02 UTC | [https://cran.r-project.org/web/packages/tulpa/DESCRIPTION](https://cran.r-project.org/web/packages/tulpa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tulpa/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-4a9675347e537b` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| RcppArmadillo | Project Scaffolding | [open](r-rcpparmadillo-abb60edc.md) |
| templr | Project Scaffolding | [open](r-templr-de1cca22.md) |
