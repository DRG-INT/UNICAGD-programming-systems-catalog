...
<!-- canonical: https://github.com/takenobu-hs/cpu-assembly-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/takenobu-hs/cpu-assembly-examples](https://github.com/takenobu-hs/cpu-assembly-examples) |
| Source record ids | github_search_assembly-caaa2f3f46faae |

## System Engineer Summary

takenobu-hs/cpu-assembly-examples is tracked as a library record in the Assembly branch. The source
...
For a systems engineer, takenobu-hs/cpu-assembly-examples belongs in the Assembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-19T06:55:01Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_assembly-caaa2f3f46faae` from `github_search_assembly` as `registry_expansion`
