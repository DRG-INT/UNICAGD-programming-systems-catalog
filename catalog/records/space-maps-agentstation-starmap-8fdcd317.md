...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/agentstation/starmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/agentstation/starmap](https://github.com/agentstation/starmap) |
| Source record ids | github_search_space_maps-54788bf8e4f4c7 |

## System Engineer Summary

An auto-updating AI Model Catalog - Single binary CLI, REST/SSE Server - SDKs - Golang Package.

## Operational Role

For a systems engineer, agentstation/starmap belongs in the Space Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:39:39Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-54788bf8e4f4c7` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Cognitohazard/ltspice-mcp | Web Framework | [open](space-maps-cognitohazard-ltspice-mcp-ccd6f8ba.md) |
| peteanderson80/coco-caption | Web Framework | [open](space-maps-peteanderson80-coco-caption-9e729876.md) |
