...
| Canonical URL | [https://github.com/gristlabs/grist-core](https://github.com/gristlabs/grist-core) |
| Source record ids | github_search_databases-dad1ac7dc6ac38 |
...
For a systems engineer, gristlabs/grist-core belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:12:55Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-dad1ac7dc6ac38` from `github_search_databases` as `registry_expansion`
