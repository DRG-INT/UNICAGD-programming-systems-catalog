...
<!-- canonical: https://cran.r-project.org/web/packages/unmarked/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/unmarked/index.html](https://cran.r-project.org/web/packages/unmarked/index.html) |
| Source record ids | cran_packages_by_date-ee6d9ba3e3228d |
...
For a systems engineer, unmarked belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.2 | 2026-08-20 05:20:02 UTC | [https://cran.r-project.org/web/packages/unmarked/DESCRIPTION](https://cran.r-project.org/web/packages/unmarked/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/unmarked/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ee6d9ba3e3228d` from `cran_packages_by_date` as `registry_expansion`
