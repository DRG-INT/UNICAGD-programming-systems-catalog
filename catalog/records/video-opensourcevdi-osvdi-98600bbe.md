...
<!-- canonical: https://github.com/opensourcevdi/osvdi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opensourcevdi/osvdi](https://github.com/opensourcevdi/osvdi) |
| Source record ids | github_search_video-87673630580bdb |
...
For a systems engineer, opensourcevdi/osvdi belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-25T20:02:06Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-87673630580bdb` from `github_search_video` as `registry_expansion`
