...
<!-- canonical: https://crates.io/crates/slog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/slog](https://crates.io/crates/slog) |
| Source record ids | crates_io-f13d4c97f1733e |
...
For a systems engineer, slog belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.2 | 2025-10-11T09:43:20.730561Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-f13d4c97f1733e` from `crates_io` as `registry_expansion`
