...
| Source record ids | github_search_assets-a9e537c9550c76 |

## System Engineer Summary

TakWolf/ark-pixel-font is tracked as a library record in the Assets branch. The source did not
...
For a systems engineer, TakWolf/ark-pixel-font belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T11:21:53Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-a9e537c9550c76` from `github_search_assets` as `registry_expansion`
