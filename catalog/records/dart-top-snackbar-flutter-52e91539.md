...
<!-- canonical: https://pub.dev/packages/top_snackbar_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/top_snackbar_flutter](https://pub.dev/packages/top_snackbar_flutter) |
| Source record ids | pub_dev-466ca09bbd1bf6 |
...
For a systems engineer, top_snackbar_flutter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.0 | 2026-08-03T07:46:04.853851Z | [https://pub.dev/api/packages/top_snackbar_flutter](https://pub.dev/api/packages/top_snackbar_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/top_snackbar_flutter` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-466ca09bbd1bf6` from `pub_dev` as `registry_expansion`
