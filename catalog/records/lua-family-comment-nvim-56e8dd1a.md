...
<!-- canonical: https://luarocks.org/modules/neorocks/comment.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/comment.nvim](https://luarocks.org/modules/neorocks/comment.nvim) |
| Source record ids | luarocks_root_manifest-77ac996adc2c96 |

## System Engineer Summary

Smart and powerful comment plugin for neovim. Supports treesitter, dot repeat, left-right/up-down
motions, hooks, and more

## Operational Role

For a systems engineer, comment.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-77ac996adc2c96` from `luarocks_root_manifest` as `registry_expansion`
