# shahraizniazi/-A-Graphics-Satellite-Rescue-Simulation

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/shahraizniazi/-A-Graphics-Satellite-Rescue-Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shahraizniazi/-A-Graphics-Satellite-Rescue-Simulation](https://github.com/shahraizniazi/-A-Graphics-Satellite-Rescue-Simulation) |
| Source record ids | github_search_space_shuttles-8c1c1dfb8617c0 |

## System Engineer Summary

Simulation game- (using graphics) that requires a space shuttle to launch a fuel cell, which will
dock with an orbiting space station. Due to a low fuel supply, the space station has entered a state
of unplanned orbital descent and will eventually crash to the earth, if it does not receive a new
supply of fuel soon.

## Operational Role

For a systems engineer, shahraizniazi/-A-Graphics-Satellite-Rescue-Simulation belongs in the Space
Shuttles inventory as part of model pipelines, numerical runtime constraints, and data/deployment
interfaces.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-09-15T17:13:52Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-8c1c1dfb8617c0` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Adi-Kudus/AI-Space-Combat-Flight-Simulator | Machine Learning | [open](space-shuttles-adi-kudus-ai-space-combat-flight-simulator-c05cc9d7.md) |
| bunga-teratai/Sanagi-Yuzu-XR5-Vanguard | Machine Learning | [open](space-shuttles-bunga-teratai-sanagi-yuzu-xr5-vanguard-6d7b9d62.md) |
| MatiasSaibene/Antonov_An225_for_Orbiter | Machine Learning | [open](space-shuttles-matiassaibene-antonov-an225-for-orbiter-30f8b7da.md) |
| MatiasSaibene/FlightDataRecMFD_for_OpenOrbiter | Machine Learning | [open](space-shuttles-matiassaibene-flightdatarecmfd-for-openorbiter-58027b6e.md) |
| MatiasSaibene/Luna3_orbiter_addon | Machine Learning | [open](space-shuttles-matiassaibene-luna3-orbiter-addon-e221ed3d.md) |
| pml76/orbsim | Machine Learning | [open](space-shuttles-pml76-orbsim-66c95332.md) |
