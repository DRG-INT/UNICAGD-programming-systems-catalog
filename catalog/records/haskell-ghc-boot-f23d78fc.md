...
<!-- canonical: https://hackage.haskell.org/package/ghc-boot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-boot](https://hackage.haskell.org/package/ghc-boot) |
| Source record ids | hackage_top_downloads-cc5905febc94ff |
...
For a systems engineer, ghc-boot belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.14.1 | 2025-12-19T11:52:54Z | [https://hackage.haskell.org/package/ghc-boot](https://hackage.haskell.org/package/ghc-boot) |  |
| candidate | partial | 8.0.2 |  | [https://hackage.haskell.org/package/ghc-boot](https://hackage.haskell.org/package/ghc-boot) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-boot` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-cc5905febc94ff` from `hackage_top_downloads` as `registry_expansion`
