...
<!-- canonical: https://crates.io/crates/dirs-sys-next -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dirs-sys-next](https://crates.io/crates/dirs-sys-next) |
| Source record ids | crates_io-237fc6d48411f4 |
...
For a systems engineer, dirs-sys-next belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2021-01-09T05:59:36.540586Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-237fc6d48411f4` from `crates_io` as `registry_expansion`
