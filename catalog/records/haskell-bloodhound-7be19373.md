...
<!-- canonical: https://hackage.haskell.org/package/bloodhound -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bloodhound](https://hackage.haskell.org/package/bloodhound) |
| Source record ids | hackage_top_downloads-a1ba7bfeb2eeaf |
...
For a systems engineer, bloodhound belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.0 | 2026-06-30T19:19:52Z | [https://hackage.haskell.org/package/bloodhound](https://hackage.haskell.org/package/bloodhound) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/bloodhound](https://hackage.haskell.org/package/bloodhound) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bloodhound` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-a1ba7bfeb2eeaf` from `hackage_top_downloads` as `registry_expansion`
