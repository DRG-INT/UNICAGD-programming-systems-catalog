...
| Canonical URL | [https://crates.io/crates/priority-queue](https://crates.io/crates/priority-queue) |
| Source record ids | crates_io-461a1ca3822790 |

## System Engineer Summary

A Priority Queue implemented as a heap with a function to efficiently change the priority of an
item.

## Operational Role

For a systems engineer, priority-queue belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2025-09-27T17:19:40.866604Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-461a1ca3822790` from `crates_io` as `registry_expansion`
