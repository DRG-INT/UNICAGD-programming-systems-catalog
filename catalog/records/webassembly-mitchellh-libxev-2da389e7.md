...
<!-- canonical: https://github.com/mitchellh/libxev -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mitchellh/libxev](https://github.com/mitchellh/libxev) |
| Source record ids | github_search_webassembly-35965b22f6a1c3 |

## System Engineer Summary

libxev is a cross-platform, high-performance event loop that provides abstractions for non-blocking
IO, timers, events, and more and works on Linux (io_uring or epoll), macOS (kqueue), and Wasm +
WASI. Available as both a Zig and C API.

## Operational Role

For a systems engineer, mitchellh/libxev belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-17T05:22:40Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-35965b22f6a1c3` from `github_search_webassembly` as `registry_expansion`
