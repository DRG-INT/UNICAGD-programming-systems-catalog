...
<!-- canonical: https://cran.r-project.org/web/packages/tm.plugin.mail/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tm.plugin.mail/index.html](https://cran.r-project.org/web/packages/tm.plugin.mail/index.html) |
| Source record ids | cran_packages_by_date-5dcc5a10275e49 |
...
For a systems engineer, tm.plugin.mail belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3-2 | 2026-08-13 07:22:13 UTC | [https://cran.r-project.org/web/packages/tm.plugin.mail/DESCRIPTION](https://cran.r-project.org/web/packages/tm.plugin.mail/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tm.plugin.mail/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5dcc5a10275e49` from `cran_packages_by_date` as `registry_expansion`
