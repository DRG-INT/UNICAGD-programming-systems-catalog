...
| Source record ids | corpus-d993a4cc29ecb9 |

## System Engineer Summary

npm audit is tracked as a security sast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, npm audit belongs in the Node.js/JavaScript inventory as part of supply-
...
- `corpus-d993a4cc29ecb9` from `master_json` as `security_sast`
...
| Socket | Security Sast | [open](node-js-javascript-socket-40f84fa9.md) |
