...
<!-- canonical: https://cran.r-project.org/web/packages/naivereg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/naivereg/index.html](https://cran.r-project.org/web/packages/naivereg/index.html) |
| Source record ids | cran_packages_by_date-39d542cdb9d79f |
...
For a systems engineer, naivereg belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2026-08-22 10:30:07 UTC | [https://cran.r-project.org/web/packages/naivereg/DESCRIPTION](https://cran.r-project.org/web/packages/naivereg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/naivereg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-39d542cdb9d79f` from `cran_packages_by_date` as `registry_expansion`
