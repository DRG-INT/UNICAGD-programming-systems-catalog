...
<!-- canonical: https://luarocks.org/modules/webd97/bustest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/webd97/bustest](https://luarocks.org/modules/webd97/bustest) |
| Source record ids | luarocks_root_manifest-51de0ff0d8b258 |

## System Engineer Summary

bustest is tracked as a testing framework record in the Lua family branch. The source did not
...
For a systems engineer, bustest belongs in the Lua family inventory as part of unit/integration
...
| --- | --- | --- | --- |
| luarocks_root_manifest | registry-derived | 2026-09-01 | `{"kind": "luarocks_root_manifest", "page": 8, "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `luarocks_root_manifest-51de0ff0d8b258` from `luarocks_root_manifest` as `registry_expansion`
