...
<!-- canonical: https://pub.dev/packages/window_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/window_manager](https://pub.dev/packages/window_manager) |
| Source record ids | pub_dev-ba8449c00aa588 |
...
For a systems engineer, window_manager belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-07-04T15:26:18.818367Z | [https://pub.dev/api/packages/window_manager](https://pub.dev/api/packages/window_manager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/window_manager` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-ba8449c00aa588` from `pub_dev` as `registry_expansion`
