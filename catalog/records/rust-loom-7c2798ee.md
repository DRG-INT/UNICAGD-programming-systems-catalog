...
<!-- canonical: https://crates.io/crates/loom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/loom](https://crates.io/crates/loom) |
| Source record ids | crates_io-6c179e1f1ed84b |
...
For a systems engineer, loom belongs in the Rust inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2024-04-23T09:24:01.042539Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-6c179e1f1ed84b` from `crates_io` as `registry_expansion`
