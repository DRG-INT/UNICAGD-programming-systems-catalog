...
<!-- canonical: https://cran.r-project.org/web/packages/hexDensity/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hexDensity/index.html](https://cran.r-project.org/web/packages/hexDensity/index.html) |
| Source record ids | cran_packages_by_date-a914e09745bfc1 |
...
For a systems engineer, hexDensity belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.11 | 2026-08-28 21:30:14 UTC | [https://cran.r-project.org/web/packages/hexDensity/DESCRIPTION](https://cran.r-project.org/web/packages/hexDensity/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hexDensity/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a914e09745bfc1` from `cran_packages_by_date` as `registry_expansion`
