...
<!-- canonical: https://github.com/mv-lab/InstructIR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mv-lab/InstructIR](https://github.com/mv-lab/InstructIR) |
| Source record ids | github_search_photography-8d5fd4dd19cee6 |

## System Engineer Summary

ECCV 2024 InstructIR: High-Quality Image Restoration Following Human Instructions

## Operational Role

For a systems engineer, mv-lab/InstructIR belongs in the Photography inventory as part of ecosystem
...
- `github_search_photography-8d5fd4dd19cee6` from `github_search_photography` as `registry_expansion`
