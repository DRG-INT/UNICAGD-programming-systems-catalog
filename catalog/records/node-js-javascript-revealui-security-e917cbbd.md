...
| Canonical URL | [https://www.npmjs.com/package/@revealui/security](https://www.npmjs.com/package/@revealui/security) |
| Source record ids | npm_registry-a0dba8ed7675a4 |

## System Engineer Summary

Security primitives — CSP/CORS/HSTS headers, RBAC + ABAC policy engine, encryption helpers, audit
logging, GDPR compliance. Ships with RevealUI.

## Operational Role

For a systems engineer, @revealui/security belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-26T16:38:17.367Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a0dba8ed7675a4` from `npm_registry` as `registry_expansion`
