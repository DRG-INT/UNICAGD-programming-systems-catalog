...
<!-- canonical: https://pypi.org/project/3s-cnes-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/3s-cnes-client/](https://pypi.org/project/3s-cnes-client/) |
| Source record ids | pypi_simple-19ce19ff4ea5e0 |
...
For a systems engineer, 3s-cnes-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-07-06T18:32:55.172334Z | [https://pypi.org/pypi/3s-cnes-client/json](https://pypi.org/pypi/3s-cnes-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/3s-cnes-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-19ce19ff4ea5e0` from `pypi_simple` as `registry_expansion`
