...
| Canonical URL | [https://crates.io/crates/jiter](https://crates.io/crates/jiter) |
| Source record ids | crates_io-add277001385a5 |
...
For a systems engineer, jiter belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-06-29T13:00:36.309208Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| rand_jitter | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-rand-jitter-7c3cff93.md) |
