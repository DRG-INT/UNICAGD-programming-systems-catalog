...
<!-- canonical: https://github.com/lightcopy/parquet-index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lightcopy/parquet-index](https://github.com/lightcopy/parquet-index) |
| Source record ids | github_search_catalogs-7d7e4cd22d1897 |
...
For a systems engineer, lightcopy/parquet-index belongs in the Catalogs inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-06T06:21:57Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-7d7e4cd22d1897` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| HypoPG/hypopg | Database Datastore | [open](catalogs-hypopg-hypopg-7940cfbb.md) |
