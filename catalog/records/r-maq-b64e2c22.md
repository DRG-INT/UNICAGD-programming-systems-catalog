...
<!-- canonical: https://cran.r-project.org/web/packages/maq/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/maq/index.html](https://cran.r-project.org/web/packages/maq/index.html) |
| Source record ids | cran_packages_by_date-62169dd178e2e3 |

## System Engineer Summary

maq is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, maq belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-04 13:10:17 UTC | [https://cran.r-project.org/web/packages/maq/DESCRIPTION](https://cran.r-project.org/web/packages/maq/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/maq/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-62169dd178e2e3` from `cran_packages_by_date` as `registry_expansion`
