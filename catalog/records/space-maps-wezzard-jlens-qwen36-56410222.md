...
<!-- canonical: https://github.com/WeZZard/jlens-qwen36 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WeZZard/jlens-qwen36](https://github.com/WeZZard/jlens-qwen36) |
| Source record ids | github_search_space_maps-2beb28fcaa586a |
...
For a systems engineer, WeZZard/jlens-qwen36 belongs in the Space Maps inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T02:04:36Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2beb28fcaa586a` from `github_search_space_maps` as `registry_expansion`
