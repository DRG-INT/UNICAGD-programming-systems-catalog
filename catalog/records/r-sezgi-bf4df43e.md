...
<!-- canonical: https://cran.r-project.org/web/packages/sezgi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sezgi/index.html](https://cran.r-project.org/web/packages/sezgi/index.html) |
| Source record ids | cran_packages_by_date-69d7725063a1e5 |
...
For a systems engineer, sezgi belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-15 10:40:02 UTC | [https://cran.r-project.org/web/packages/sezgi/DESCRIPTION](https://cran.r-project.org/web/packages/sezgi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sezgi/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-69d7725063a1e5` from `cran_packages_by_date` as `registry_expansion`
