...
<!-- canonical: https://pub.dev/packages/back_button_interceptor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/back_button_interceptor](https://pub.dev/packages/back_button_interceptor) |
| Source record ids | pub_dev-345708a69d1f56 |

## System Engineer Summary

Back Button Interceptor. May be used to do stuff when the Android back-button is tapped, as an
alternative to `WillPopScope`.

## Operational Role

For a systems engineer, back_button_interceptor belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.4 | 2025-02-10T15:26:08.678264Z | [https://pub.dev/api/packages/back_button_interceptor](https://pub.dev/api/packages/back_button_interceptor) |  |
| preview | known | 5.0.0-nullsafety.1 | 2021-02-15T21:59:19.038233Z | [https://pub.dev/api/packages/back_button_interceptor](https://pub.dev/api/packages/back_button_interceptor) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/back_button_interceptor` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-345708a69d1f56` from `pub_dev` as `registry_expansion`
