...
<!-- canonical: https://cran.r-project.org/web/packages/gganime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gganime/index.html](https://cran.r-project.org/web/packages/gganime/index.html) |
| Source record ids | cran_packages_by_date-69fd882ff5b4ca |

## System Engineer Summary

Animate 'ggplot2' Plots with 'Anime.js'

## Operational Role

For a systems engineer, gganime belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-30 09:20:02 UTC | [https://cran.r-project.org/web/packages/gganime/DESCRIPTION](https://cran.r-project.org/web/packages/gganime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gganime/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-69fd882ff5b4ca` from `cran_packages_by_date` as `registry_expansion`
