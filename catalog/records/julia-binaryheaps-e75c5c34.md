...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BinaryHeaps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BinaryHeaps](https://github.com/JuliaRegistries/General/tree/master/B/BinaryHeaps) |
| Source record ids | julia_general-5406632292b444 |

## System Engineer Summary

Julia package registered in General at B/BinaryHeaps.

## Operational Role

For a systems engineer, BinaryHeaps belongs in the Julia inventory as part of ecosystem capability
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""}; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BinaryHeaps", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-5406632292b444` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CheapThreads | Memory Analyzer | [open](julia-cheapthreads-b02607f1.md) |
