...
<!-- canonical: https://crates.io/crates/itertools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/itertools](https://crates.io/crates/itertools) |
| Source record ids | crates_io-917ef4d0428024 |
...
For a systems engineer, itertools belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-06-16T15:09:28.880416Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-917ef4d0428024` from `crates_io` as `registry_expansion`
