...
<!-- canonical: https://github.com/devMEremenko/XcodeBenchmark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/devMEremenko/XcodeBenchmark](https://github.com/devMEremenko/XcodeBenchmark) |
| Source record ids | github_search_cocoa-4257c73f23f9d0 |
...
For a systems engineer, devMEremenko/XcodeBenchmark belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-28T21:57:19Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-4257c73f23f9d0` from `github_search_cocoa` as `registry_expansion`
