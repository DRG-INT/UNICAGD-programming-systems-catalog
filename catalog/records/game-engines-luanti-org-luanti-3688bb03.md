...
<!-- canonical: https://github.com/luanti-org/luanti -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luanti-org/luanti](https://github.com/luanti-org/luanti) |
| Source record ids | github_search_game_engines-f66266b252a979 |
...
For a systems engineer, luanti-org/luanti belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:15:10Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-f66266b252a979` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| IvanMurzak/Unity-MCP | Testing Framework | [open](game-engines-ivanmurzak-unity-mcp-d62d2f35.md) |
