...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/Argentum/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Argentum/index.html](https://cran.r-project.org/web/packages/Argentum/index.html) |
| Source record ids | cran_packages_by_date-17989aa4f5a4bf |

## System Engineer Summary

Access Argentine WFS and WMS Geospatial Web Services

## Operational Role

For a systems engineer, Argentum belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-20 23:12:20 UTC | [https://cran.r-project.org/web/packages/Argentum/DESCRIPTION](https://cran.r-project.org/web/packages/Argentum/DESCRIPTION) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Argentum/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-17989aa4f5a4bf` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acro | Filesystem Os | [open](r-acro-20137739.md) |
| admiralneuro | Filesystem Os | [open](r-admiralneuro-64d97e33.md) |
| AlleloBin | Filesystem Os | [open](r-allelobin-7b385a27.md) |
| aplotExtra | Filesystem Os | [open](r-aplotextra-1c110a3f.md) |
| AzureAuth | Filesystem Os | [open](r-azureauth-1e1a78fc.md) |
| balnet | Filesystem Os | [open](r-balnet-d97ebf17.md) |
| BIGpopA | Filesystem Os | [open](r-bigpopa-a13b955e.md) |
| BiostatsUHNplus | Filesystem Os | [open](r-biostatsuhnplus-1879ff59.md) |
