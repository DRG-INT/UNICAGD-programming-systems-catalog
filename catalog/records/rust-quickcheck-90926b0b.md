...
<!-- canonical: https://crates.io/crates/quickcheck -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quickcheck](https://crates.io/crates/quickcheck) |
| Source record ids | master-9607e7e3e814, crates_io-6b97ec6582f148 |
...
For a systems engineer, quickcheck belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-02-10T18:57:19.150934Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-01T07:19:30+00:00`.
...
- `master-9607e7e3e814` from `master_json` as `testing_framework`
- `crates_io-6b97ec6582f148` from `crates_io` as `registry_expansion`
