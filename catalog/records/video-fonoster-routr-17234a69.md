...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/fonoster/routr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fonoster/routr](https://github.com/fonoster/routr) |
| Source record ids | github_search_video-19b8b5fe057a58 |
...
For a systems engineer, fonoster/routr belongs in the Video inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T13:18:28Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-19b8b5fe057a58` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ant-media/Ant-Media-Server | Web Framework | [open](video-ant-media-ant-media-server-fcfbaa1e.md) |
| ggerganov/wave-share | Web Framework | [open](video-ggerganov-wave-share-52a552c1.md) |
| jeremyckahn/chitchatter | Web Framework | [open](video-jeremyckahn-chitchatter-a8b0963a.md) |
| peers/peerjs-server | Web Framework | [open](video-peers-peerjs-server-1430a997.md) |
| rabbitmq/rabbitmq-server | Web Framework | [open](video-rabbitmq-rabbitmq-server-8ca6cfe2.md) |
| Red5/red5-server | Web Framework | [open](video-red5-red5-server-ae8c8a08.md) |
| SPlayer-Dev/SPlayer | Web Framework | [open](video-splayer-dev-splayer-58499ce0.md) |
