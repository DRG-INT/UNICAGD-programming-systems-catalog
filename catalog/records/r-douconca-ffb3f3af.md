...
<!-- canonical: https://cran.r-project.org/web/packages/douconca/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/douconca/index.html](https://cran.r-project.org/web/packages/douconca/index.html) |
| Source record ids | cran_packages_by_date-3241615f608fcd |
...
For a systems engineer, douconca belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.5.1 | 2026-08-24 10:50:09 UTC | [https://cran.r-project.org/web/packages/douconca/DESCRIPTION](https://cran.r-project.org/web/packages/douconca/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/douconca/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3241615f608fcd` from `cran_packages_by_date` as `registry_expansion`
