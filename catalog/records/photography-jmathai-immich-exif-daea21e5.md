...
<!-- canonical: https://github.com/jmathai/immich-exif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jmathai/immich-exif](https://github.com/jmathai/immich-exif) |
| Source record ids | github_search_photography-ea9b6181ec40de |
...
For a systems engineer, jmathai/immich-exif belongs in the Photography inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-26T23:12:52Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-ea9b6181ec40de` from `github_search_photography` as `registry_expansion`
