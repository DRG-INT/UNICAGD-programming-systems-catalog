...
<!-- canonical: https://github.com/jankae/LibreCAL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jankae/LibreCAL](https://github.com/jankae/LibreCAL) |
| Source record ids | github_search_electromagnetoscopes-fa01a097f4e260 |

## System Engineer Summary

jankae/LibreCAL is tracked as a library record in the Electromagnetoscopes branch. The source did
...
For a systems engineer, jankae/LibreCAL belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-03T14:21:22Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-fa01a097f4e260` from `github_search_electromagnetoscopes` as `registry_expansion`
