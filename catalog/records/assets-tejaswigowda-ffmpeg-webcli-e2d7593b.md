...
<!-- canonical: https://github.com/tejaswigowda/ffmpeg-webCLI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tejaswigowda/ffmpeg-webCLI](https://github.com/tejaswigowda/ffmpeg-webCLI) |
| Source record ids | github_search_assets-bfc5704fbcc538 |

## System Engineer Summary

A browser-based video editor powered by ffmpeg.wasm. No uploads, no servers -- all processing
happens locally in your browser using WebAssembly.

## Operational Role

For a systems engineer, tejaswigowda/ffmpeg-webCLI belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T01:41:12Z | gh search repos topic:media-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-bfc5704fbcc538` from `github_search_assets` as `registry_expansion`
