...
<!-- canonical: https://cran.r-project.org/web/packages/frailtypack/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/frailtypack/index.html](https://cran.r-project.org/web/packages/frailtypack/index.html) |
| Source record ids | cran_packages_by_date-51424cc4ef789f |
...
For a systems engineer, frailtypack belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.8.1 | 2026-08-25 11:10:10 UTC | [https://cran.r-project.org/web/packages/frailtypack/DESCRIPTION](https://cran.r-project.org/web/packages/frailtypack/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/frailtypack/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-51424cc4ef789f` from `cran_packages_by_date` as `registry_expansion`
