...
| Source record ids | corpus-4edc04142d8c2d |

## System Engineer Summary

simdjson is tracked as a serialization record in the C++23 branch. The source did not provide a long
...
For a systems engineer, simdjson belongs in the C++23 inventory as part of wire formats,
...
- `corpus-4edc04142d8c2d` from `master_json` as `serialization`
...
| nlohmann/json | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-nlohmann-json-26433fbe.md) |
