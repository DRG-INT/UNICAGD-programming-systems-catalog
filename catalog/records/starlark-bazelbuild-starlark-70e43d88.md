...
| Canonical URL | [https://github.com/bazelbuild/starlark](https://github.com/bazelbuild/starlark) |
| Source record ids | curated_language_routes-b908bf7261524d |

## System Engineer Summary

Official Starlark source/spec repository and language coordination route.

## Operational Role

For a systems engineer, bazelbuild/starlark belongs in the Starlark inventory as part of ecosystem
...
- `curated_language_routes-b908bf7261524d` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bazel Central Registry | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/starlark-bazel-central-registry-4194525a.md) |
