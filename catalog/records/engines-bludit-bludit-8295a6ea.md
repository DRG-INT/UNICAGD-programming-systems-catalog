...
<!-- canonical: https://github.com/bludit/bludit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bludit/bludit](https://github.com/bludit/bludit) |
| Source record ids | github_search_engines-ae9e52601f1b65 |
...
For a systems engineer, bludit/bludit belongs in the Engines inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T16:34:00Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-ae9e52601f1b65` from `github_search_engines` as `registry_expansion`
