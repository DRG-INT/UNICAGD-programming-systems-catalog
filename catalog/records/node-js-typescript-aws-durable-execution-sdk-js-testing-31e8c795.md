...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/TypeScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-typescript.md) · [Category: Type Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/type-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@aws/durable-execution-sdk-js-testing](https://www.npmjs.com/package/@aws/durable-execution-sdk-js-testing) |
| Source record ids | npm_registry-1bc9c9d5096f14 |
...
For a systems engineer, @aws/durable-execution-sdk-js-testing belongs in the Node.js/TypeScript
inventory as part of interface contracts, migration safety, editor feedback, and large-codebase
maintainability.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3 | 2026-07-06T21:09:01.508Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @adobe/css-tools | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-adobe-css-tools-f7566708.md) |
| @anthropic-ai/sdk | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-anthropic-ai-sdk-505c8b05.md) |
| @apollo/cache-control-types | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-apollo-cache-control-types-cf45fb41.md) |
| @apollo/protobufjs | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-apollo-protobufjs-c29bf38c.md) |
| @apollo/utils.withrequired | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-apollo-utils-withrequired-3d97187a.md) |
| @ava/typescript | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-ava-typescript-10335da0.md) |
| @aws-lambda-powertools/logger | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-aws-lambda-powertools-logger-8438a23a.md) |
| @babel/plugin-syntax-typescript | Type Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-babel-plugin-syntax-typescript-f6dbb30b.md) |
