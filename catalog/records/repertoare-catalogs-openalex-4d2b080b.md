...
| Canonical URL | [https://openalex.org/](https://openalex.org/) |
| Source record ids | curated_language_routes-6c03a4fa2f96c3 |

## System Engineer Summary

Open scholarly catalog for works, authors, institutions, concepts, funders, venues, and citation
graph metadata.

## Operational Role

For a systems engineer, OpenAlex belongs in the Repertoare Catalogs inventory as part of ecosystem
...
- `curated_language_routes-6c03a4fa2f96c3` from `curated_language_routes` as `registry_expansion`
