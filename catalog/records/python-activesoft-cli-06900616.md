...
<!-- canonical: https://pypi.org/project/activesoft-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/activesoft-cli/](https://pypi.org/project/activesoft-cli/) |
| Source record ids | pypi_simple-df1fb5043e28bf |
...
For a systems engineer, activesoft-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-06-12T23:26:03.041144Z | [https://pypi.org/pypi/activesoft-cli/json](https://pypi.org/pypi/activesoft-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/activesoft-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-df1fb5043e28bf` from `pypi_simple` as `registry_expansion`
