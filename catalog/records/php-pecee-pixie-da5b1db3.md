...
<!-- canonical: https://packagist.org/packages/pecee/pixie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pecee/pixie](https://packagist.org/packages/pecee/pixie) |
| Source record ids | packagist_search-8edf854ee08faa |
...
For a systems engineer, pecee/pixie belongs in the PHP inventory as part of build graph control,
...
- `packagist_search-8edf854ee08faa` from `packagist_search` as `registry_expansion`
