# nmisyats/KSP-MGA-Planner

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nmisyats/KSP-MGA-Planner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nmisyats/KSP-MGA-Planner](https://github.com/nmisyats/KSP-MGA-Planner) |
| Source record ids | github_search_space_engines-c25e56e4402509 |

## System Engineer Summary

An online tool providing automatic design of trajectories with multiple gravity assists for Kerbal
Space Program.

## Operational Role

For a systems engineer, nmisyats/KSP-MGA-Planner belongs in the Space Engines inventory as part of
...
- `github_search_space_engines-c25e56e4402509` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| juliensimon/starlink-viz | Type Checker | [open](space-engines-juliensimon-starlink-viz-6bd4b750.md) |
