...
<!-- canonical: https://packagist.org/packages/mongodb/laravel-mongodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mongodb/laravel-mongodb](https://packagist.org/packages/mongodb/laravel-mongodb) |
| Source record ids | packagist_search-23a5a055e1d26c |
...
For a systems engineer, mongodb/laravel-mongodb belongs in the PHP inventory as part of build graph
...
- `packagist_search-23a5a055e1d26c` from `packagist_search` as `registry_expansion`
