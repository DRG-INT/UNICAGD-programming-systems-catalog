...
<!-- canonical: https://github.com/ngwnos/gaia-dr3-chunked -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ngwnos/gaia-dr3-chunked](https://github.com/ngwnos/gaia-dr3-chunked) |
| Source record ids | github_search_space_maps-10781e1800d2c5 |

## System Engineer Summary

Gaia DR3 star catalog - chunked by brightness (100k stars/chunk, sorted by magnitude)

## Operational Role

For a systems engineer, ngwnos/gaia-dr3-chunked belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-28T01:46:12Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-10781e1800d2c5` from `github_search_space_maps` as `registry_expansion`
