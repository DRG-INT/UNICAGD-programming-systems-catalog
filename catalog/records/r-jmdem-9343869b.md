...
<!-- canonical: https://cran.r-project.org/web/packages/jmdem/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jmdem/index.html](https://cran.r-project.org/web/packages/jmdem/index.html) |
| Source record ids | cran_packages_by_date-efeff6d7f06cb2 |
...
For a systems engineer, jmdem belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-06 14:40:02 UTC | [https://cran.r-project.org/web/packages/jmdem/DESCRIPTION](https://cran.r-project.org/web/packages/jmdem/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jmdem/DESCRIPTION` at `2026-09-06T16:19:42+00:00`.
...
- `cran_packages_by_date-efeff6d7f06cb2` from `cran_packages_by_date` as `registry_expansion`
