...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Web Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/web-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-ebd761aca406 |

## System Engineer Summary

Rocket is tracked as a web framework record in the Rust branch. The source did not provide a long
...
For a systems engineer, Rocket belongs in the Rust inventory as part of request routing, middleware
...
- `master-ebd761aca406` from `master_json` as `web_framework`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Actix Web | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-actix-web-ea1af490.md) |
| actix-router | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-actix-router-ae0f0295.md) |
| Axum | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-axum-b096d858.md) |
| axum-server | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-axum-server-8765c1b7.md) |
| datafusion-expr | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-datafusion-expr-26a642a3.md) |
| datafusion-functions-aggregate | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-datafusion-functions-aggregate-c103b410.md) |
| datafusion-physical-expr | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-datafusion-physical-expr-84eb0ba8.md) |
| datafusion-physical-expr-common | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-datafusion-physical-expr-common-fb5c136e.md) |
