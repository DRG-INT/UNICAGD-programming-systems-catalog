...
<!-- canonical: https://cran.r-project.org/web/packages/persistence/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/persistence/index.html](https://cran.r-project.org/web/packages/persistence/index.html) |
| Source record ids | cran_packages_by_date-007e61cf8d808e |
...
For a systems engineer, persistence belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-07 16:30:02 UTC | [https://cran.r-project.org/web/packages/persistence/DESCRIPTION](https://cran.r-project.org/web/packages/persistence/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/persistence/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-007e61cf8d808e` from `cran_packages_by_date` as `registry_expansion`
