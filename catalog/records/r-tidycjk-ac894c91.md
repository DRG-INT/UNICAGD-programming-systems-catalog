...
<!-- canonical: https://cran.r-project.org/web/packages/tidycjk/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidycjk/index.html](https://cran.r-project.org/web/packages/tidycjk/index.html) |
| Source record ids | cran_packages_by_date-98f34c7a312653 |

## System Engineer Summary

Tidy Tools for Chinese, Japanese and Korean Text

## Operational Role

For a systems engineer, tidycjk belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 10:20:02 UTC | [https://cran.r-project.org/web/packages/tidycjk/DESCRIPTION](https://cran.r-project.org/web/packages/tidycjk/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidycjk/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-98f34c7a312653` from `cran_packages_by_date` as `registry_expansion`
