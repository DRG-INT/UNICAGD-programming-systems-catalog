...
<!-- canonical: https://crates.io/crates/wit-bindgen-rust-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-bindgen-rust-macro](https://crates.io/crates/wit-bindgen-rust-macro) |
| Source record ids | crates_io-f1ef6db85a96bf |
...
For a systems engineer, wit-bindgen-rust-macro belongs in the Rust inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.61.1 | 2026-08-25T15:28:18.101083Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-f1ef6db85a96bf` from `crates_io` as `registry_expansion`
