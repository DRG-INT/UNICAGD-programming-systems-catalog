# yagiz-aydin/nx-galaxy

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/yagiz-aydin/nx-galaxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yagiz-aydin/nx-galaxy](https://github.com/yagiz-aydin/nx-galaxy) |
| Source record ids | github_search_space_maps-3c08f9b2e02fc2 |

## System Engineer Summary

A Native Federation Microfrontend ecosystem built with Angular 21 and Nx. This project implements a
Decoupled Architecture using ESM (ES Modules) and browser-native Import Maps to orchestrate
independent planetary MFEs (Shell, Terra, Mars) without the overhead of Webpack.

## Operational Role

For a systems engineer, yagiz-aydin/nx-galaxy belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-05T22:00:20Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-3c08f9b2e02fc2` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bexxmodd/vizex | Cli | [open](space-maps-bexxmodd-vizex-73551837.md) |
| GaneshEiGo/ei-climate-anime-atmospheric-time-shift | Cli | [open](space-maps-ganesheigo-ei-climate-anime-atmospheric-time-shift-05598ee3.md) |
| imsnif/diskonaut | Cli | [open](space-maps-imsnif-diskonaut-d353ac29.md) |
| maclifevn/MClean | Cli | [open](space-maps-maclifevn-mclean-ccbb23d0.md) |
| nashondas-oss/terra-gaia-core | Cli | [open](space-maps-nashondas-oss-terra-gaia-core-935373db.md) |
| sjarmak/EuropaClipper_JUICE_UVS | Cli | [open](space-maps-sjarmak-europaclipper-juice-uvs-e6d1b575.md) |
| soxofaan/duviz | Cli | [open](space-maps-soxofaan-duviz-eb5b443f.md) |
