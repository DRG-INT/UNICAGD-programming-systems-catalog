...
<!-- canonical: https://cran.r-project.org/web/packages/gpcihybridII/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpcihybridII/index.html](https://cran.r-project.org/web/packages/gpcihybridII/index.html) |
| Source record ids | cran_packages_by_date-c30ccd5ed40f9b |
...
For a systems engineer, gpcihybridII belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 13:00:36 UTC | [https://cran.r-project.org/web/packages/gpcihybridII/DESCRIPTION](https://cran.r-project.org/web/packages/gpcihybridII/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpcihybridII/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c30ccd5ed40f9b` from `cran_packages_by_date` as `registry_expansion`
