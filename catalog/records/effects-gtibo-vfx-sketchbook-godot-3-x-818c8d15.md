# gtibo/VFX-sketchbook-Godot-3.x
...
<!-- canonical: https://github.com/gtibo/VFX-sketchbook-Godot-3.x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gtibo/VFX-sketchbook-Godot-3.x](https://github.com/gtibo/VFX-sketchbook-Godot-3.x) |
| Source record ids | github_search_effects-7fce01c9d1d46a |

## System Engineer Summary

gtibo/VFX-sketchbook-Godot-3.x is tracked as a tutorial book styleguide record in the Effects
...
For a systems engineer, gtibo/VFX-sketchbook-Godot-3.x belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-04T12:46:16Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-7fce01c9d1d46a` from `github_search_effects` as `registry_expansion`
