...
<!-- canonical: https://cran.r-project.org/web/packages/CLDedgelister/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CLDedgelister/index.html](https://cran.r-project.org/web/packages/CLDedgelister/index.html) |
| Source record ids | cran_packages_by_date-d8949f2e5d92a8 |

## System Engineer Summary

Import System-Dynamics Models and Convert Them to Edge Lists

## Operational Role

For a systems engineer, CLDedgelister belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-20 02:10:02 UTC | [https://cran.r-project.org/web/packages/CLDedgelister/DESCRIPTION](https://cran.r-project.org/web/packages/CLDedgelister/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CLDedgelister/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d8949f2e5d92a8` from `cran_packages_by_date` as `registry_expansion`
