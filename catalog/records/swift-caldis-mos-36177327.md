...
<!-- canonical: https://github.com/Caldis/Mos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Caldis/Mos](https://github.com/Caldis/Mos) |
| Source record ids | github_search_swift-4218b6a4ec8dbf |

## System Engineer Summary

一个用于在 macOS 上平滑你的鼠标滚动效果或单独设置滚动方向的小工具, 让你的滚轮爽如触控板 | A lightweight tool used to smooth scrolling and
set scroll direction independently for your mouse on macOS

## Operational Role

For a systems engineer, Caldis/Mos belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.1 | 2026-05-31T14:49:55Z | [https://api.github.com/repos/Caldis/Mos/releases/latest](https://api.github.com/repos/Caldis/Mos/releases/latest) |  |
| preview | known | 4.3.0-beta-20260820.1 | 2026-08-20T16:22:22Z | [https://api.github.com/repos/Caldis/Mos/releases?per_page=10](https://api.github.com/repos/Caldis/Mos/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Caldis/Mos/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-4218b6a4ec8dbf` from `github_search_swift` as `registry_expansion`
