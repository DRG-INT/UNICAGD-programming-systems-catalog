...
<!-- canonical: https://www.npmjs.com/package/vite-plugin-vue-server-ref -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/vite-plugin-vue-server-ref](https://www.npmjs.com/package/vite-plugin-vue-server-ref) |
| Source record ids | npm_registry-32f835403bd5e9 |
...
For a systems engineer, vite-plugin-vue-server-ref belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-02-18T10:46:00.430Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-32f835403bd5e9` from `npm_registry` as `registry_expansion`
