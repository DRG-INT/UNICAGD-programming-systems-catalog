...
<!-- canonical: https://cran.r-project.org/web/packages/psychnets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/psychnets/index.html](https://cran.r-project.org/web/packages/psychnets/index.html) |
| Source record ids | cran_packages_by_date-31d6869ce7c441 |
...
For a systems engineer, psychnets belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-08-23 20:10:02 UTC | [https://cran.r-project.org/web/packages/psychnets/DESCRIPTION](https://cran.r-project.org/web/packages/psychnets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/psychnets/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-31d6869ce7c441` from `cran_packages_by_date` as `registry_expansion`
