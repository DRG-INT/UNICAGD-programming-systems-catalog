...
<!-- canonical: https://github.com/ashuttl/linecast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ashuttl/linecast](https://github.com/ashuttl/linecast) |
| Source record ids | github_search_radars-78784810e404da |

## System Engineer Summary

Weather, tides, the sun, the moon, and maps, in your terminal. The Old Farmer's Almanac meets
Minitel.

## Operational Role

For a systems engineer, ashuttl/linecast belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.0 | 2026-08-31T15:35:03Z | [https://api.github.com/repos/ashuttl/linecast/releases/latest](https://api.github.com/repos/ashuttl/linecast/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ashuttl/linecast/releases/latest` at `2026-09-01T08:26:28+00:00`.
...
- `github_search_radars-78784810e404da` from `github_search_radars` as `registry_expansion`
