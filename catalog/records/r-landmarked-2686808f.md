...
<!-- canonical: https://cran.r-project.org/web/packages/landmarked/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/landmarked/index.html](https://cran.r-project.org/web/packages/landmarked/index.html) |
| Source record ids | cran_packages_by_date-8b36359b5bebce |

## System Engineer Summary

Plot Adjusted Kaplan-Meier Estimates from a Landmark Time

## Operational Role

For a systems engineer, landmarked belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 14:30:02 UTC | [https://cran.r-project.org/web/packages/landmarked/DESCRIPTION](https://cran.r-project.org/web/packages/landmarked/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/landmarked/DESCRIPTION` at `2026-09-15T16:20:33+00:00`.
...
- `cran_packages_by_date-8b36359b5bebce` from `cran_packages_by_date` as `registry_expansion`
