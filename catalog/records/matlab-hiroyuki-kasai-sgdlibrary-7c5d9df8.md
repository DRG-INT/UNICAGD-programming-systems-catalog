...
<!-- canonical: https://github.com/hiroyuki-kasai/SGDLibrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hiroyuki-kasai/SGDLibrary](https://github.com/hiroyuki-kasai/SGDLibrary) |
| Source record ids | github_search_matlab-d8ab9571e2e3b2 |
...
For a systems engineer, hiroyuki-kasai/SGDLibrary belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-11T06:13:46Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-d8ab9571e2e3b2` from `github_search_matlab` as `registry_expansion`
