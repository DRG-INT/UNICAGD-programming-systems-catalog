...
<!-- canonical: https://crates.io/crates/ark-ff-asm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ark-ff-asm](https://crates.io/crates/ark-ff-asm) |
| Source record ids | crates_io-5c14ec7414a27f |
...
For a systems engineer, ark-ff-asm belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-04-26T19:27:41.787310Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-5c14ec7414a27f` from `crates_io` as `registry_expansion`
