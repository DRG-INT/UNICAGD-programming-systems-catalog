...
<!-- canonical: https://github.com/ekazaev/route-composer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ekazaev/route-composer](https://github.com/ekazaev/route-composer) |
| Source record ids | awesome_list-5381d15891f208 |
...
For a systems engineer, RouteComposer belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.22.2 | 2026-08-18T19:21:54Z | [https://api.github.com/repos/ekazaev/route-composer/releases/latest](https://api.github.com/repos/ekazaev/route-composer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ekazaev/route-composer/releases/latest` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-5381d15891f208` from `awesome_list` as `registry_expansion`
