...
| Canonical URL | [https://crates.io/crates/pretty](https://crates.io/crates/pretty) |
| Source record ids | crates_io-0dca8b2d477e23 |
...
For a systems engineer, pretty belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.5 | 2025-09-26T10:17:47.723455Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-0dca8b2d477e23` from `crates_io` as `registry_expansion`
