...
<!-- canonical: https://github.com/mschwartz/assembly-tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mschwartz/assembly-tutorial](https://github.com/mschwartz/assembly-tutorial) |
| Source record ids | github_search_assembly-07353009973ef4 |
...
For a systems engineer, mschwartz/assembly-tutorial belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-03T23:34:30Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-07353009973ef4` from `github_search_assembly` as `registry_expansion`
