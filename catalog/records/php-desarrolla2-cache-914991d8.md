...
| Canonical URL | [https://packagist.org/packages/desarrolla2/cache](https://packagist.org/packages/desarrolla2/cache) |
| Source record ids | packagist_search-7534e6e47fbb96 |

## System Engineer Summary

Provides an cache interface for several adapters Apc, Apcu, File, Mongo, Memcache, Memcached, Mysql,
Mongo, Redis is supported. New adapters is comming!

## Operational Role

For a systems engineer, desarrolla2/cache belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.3 | 2023-05-04T15:02:07+00:00 | [https://repo.packagist.org/p2/desarrolla2/cache.json](https://repo.packagist.org/p2/desarrolla2/cache.json) |  |
| preview | known | v3.0.0-beta1 | 2018-06-23T03:45:31+00:00 | [https://repo.packagist.org/p2/desarrolla2/cache.json](https://repo.packagist.org/p2/desarrolla2/cache.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/desarrolla2/cache.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-7534e6e47fbb96` from `packagist_search` as `registry_expansion`
