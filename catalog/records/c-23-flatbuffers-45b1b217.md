...
| Source record ids | corpus-08ef002e96916d |

## System Engineer Summary

FlatBuffers is tracked as a serialization record in the C++23 branch. The source did not provide a
...
For a systems engineer, FlatBuffers belongs in the C++23 inventory as part of wire formats,
...
- `corpus-08ef002e96916d` from `master_json` as `serialization`
