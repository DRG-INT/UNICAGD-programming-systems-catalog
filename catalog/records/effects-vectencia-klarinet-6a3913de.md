...
<!-- canonical: https://github.com/vectencia/Klarinet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vectencia/Klarinet](https://github.com/vectencia/Klarinet) |
| Source record ids | github_search_effects-6680ec2fdb6e82 |

## System Engineer Summary

Open-source Kotlin Multiplatform audio SDK with low-latency playback, recording, 16 real-time
effects, and file I/O across Android and Apple platforms.

## Operational Role

For a systems engineer, vectencia/Klarinet belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:24:00Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6680ec2fdb6e82` from `github_search_effects` as `registry_expansion`
