...
<!-- canonical: https://github.com/wasmerio/wasmer-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmerio/wasmer-js](https://github.com/wasmerio/wasmer-js) |
| Source record ids | github_search_webassembly-ff43482badc701 |
...
For a systems engineer, wasmerio/wasmer-js belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T10:59:08Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ff43482badc701` from `github_search_webassembly` as `registry_expansion`
