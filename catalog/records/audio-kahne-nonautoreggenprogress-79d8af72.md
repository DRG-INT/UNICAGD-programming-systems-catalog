...
<!-- canonical: https://github.com/kahne/NonAutoregGenProgress -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kahne/NonAutoregGenProgress](https://github.com/kahne/NonAutoregGenProgress) |
| Source record ids | github_search_audio-84b071885ae65f |
...
For a systems engineer, kahne/NonAutoregGenProgress belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-15T19:33:27Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-84b071885ae65f` from `github_search_audio` as `registry_expansion`
