...
| Canonical URL | [https://crates.io/crates/linked_hash_set](https://crates.io/crates/linked_hash_set) |
| Source record ids | crates_io-b3567e0c80ac84 |
...
For a systems engineer, linked_hash_set belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2025-11-09T01:15:49.411061Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-b3567e0c80ac84` from `crates_io` as `registry_expansion`
