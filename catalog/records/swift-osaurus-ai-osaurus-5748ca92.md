...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/osaurus-ai/osaurus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osaurus-ai/osaurus](https://github.com/osaurus-ai/osaurus) |
| Source record ids | github_search_swift-416c0e33fda472 |

## System Engineer Summary

Own your AI. The native macOS harness for AI agents -- any model, persistent memory, autonomous
execution, cryptographic identity. Built in Swift. Fully offline. Open source.

## Operational Role

For a systems engineer, osaurus-ai/osaurus belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-416c0e33fda472` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apple/swift-system-metrics | Memory Analyzer | [open](swift-apple-swift-system-metrics-823d84b7.md) |
