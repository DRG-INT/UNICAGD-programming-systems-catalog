...
<!-- canonical: https://en.wikibooks.org/wiki/Lua_Programming -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://en.wikibooks.org/wiki/Lua_Programming](https://en.wikibooks.org/wiki/Lua_Programming) |
| Source record ids | lua-source-411 |
...
For a systems engineer, Lua Programming belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 411}}` |
...
- `lua-source-411` from `master_json` as `source_list_item`
