...
<!-- canonical: https://cran.r-project.org/web/packages/thisutils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/thisutils/index.html](https://cran.r-project.org/web/packages/thisutils/index.html) |
| Source record ids | cran_packages_by_date-bce21018eee6e4 |
...
For a systems engineer, thisutils belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-21 10:40:02 UTC | [https://cran.r-project.org/web/packages/thisutils/DESCRIPTION](https://cran.r-project.org/web/packages/thisutils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/thisutils/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-bce21018eee6e4` from `cran_packages_by_date` as `registry_expansion`
