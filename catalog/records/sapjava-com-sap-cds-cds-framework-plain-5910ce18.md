# com.sap.cds:cds-framework-plain
...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cds/cds-framework-plain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cds/cds-framework-plain](https://central.sonatype.com/artifact/com.sap.cds/cds-framework-plain) |
| Source record ids | maven_central_search-0289a1b55a42d5 |
...
For a systems engineer, com.sap.cds:cds-framework-plain belongs in the SAPJava inventory as part of
...
- `maven_central_search-0289a1b55a42d5` from `maven_central_search` as `registry_expansion`
