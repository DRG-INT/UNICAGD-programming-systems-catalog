...
<!-- canonical: https://cran.r-project.org/web/packages/summarySCI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/summarySCI/index.html](https://cran.r-project.org/web/packages/summarySCI/index.html) |
| Source record ids | cran_packages_by_date-f5bbc99a3b3dde |
...
For a systems engineer, summarySCI belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-14 20:30:02 UTC | [https://cran.r-project.org/web/packages/summarySCI/DESCRIPTION](https://cran.r-project.org/web/packages/summarySCI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/summarySCI/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-f5bbc99a3b3dde` from `cran_packages_by_date` as `registry_expansion`
