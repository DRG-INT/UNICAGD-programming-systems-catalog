# gitlab-org/security-products/dast
...
<!-- canonical: https://gitlab.com/gitlab-org/security-products/dast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/security-products/dast](https://gitlab.com/gitlab-org/security-products/dast) |
| Source record ids | gitlab_projects_api-6ee8408a71b33e |
...
For a systems engineer, gitlab-org/security-products/dast belongs in the Repository Workplaces
...
- `gitlab_projects_api-6ee8408a71b33e` from `gitlab_projects_api` as `registry_expansion`
