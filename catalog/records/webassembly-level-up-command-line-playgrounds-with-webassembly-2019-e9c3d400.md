...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://opensource.com/article/19/4/command-line-playgrounds-webassembly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://opensource.com/article/19/4/command-line-playgrounds-webassembly](https://opensource.com/article/19/4/command-line-playgrounds-webassembly) |
| Source record ids | awesome_list-e40a6fb1f03a0e |

## System Engineer Summary

Level up Command-line Playgrounds with WebAssembly (2019) is tracked as a cli record in the
...
For a systems engineer, Level up Command-line Playgrounds with WebAssembly (2019) belongs in the
WebAssembly inventory as part of ecosystem capability mapping, dependency review, release awareness,
...
- `awesome_list-e40a6fb1f03a0e` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| svenstaro/genact | Cli | [open](webassembly-svenstaro-genact-d28ebcc6.md) |
| SwiftTUI/swift-tui | Cli | [open](webassembly-swifttui-swift-tui-ed1cb3aa.md) |
| WebAssembly/wasi-cli | Cli | [open](webassembly-webassembly-wasi-cli-fb8bc0ae.md) |
