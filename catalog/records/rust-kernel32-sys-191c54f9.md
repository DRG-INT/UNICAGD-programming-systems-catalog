...
| Canonical URL | [https://crates.io/crates/kernel32-sys](https://crates.io/crates/kernel32-sys) |
| Source record ids | crates_io-f15de58dd54629 |

## System Engineer Summary

Contains function definitions for the Windows API library kernel32. See winapi for types and
constants.

## Operational Role

For a systems engineer, kernel32-sys belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2016-04-16T05:05:30.825379Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-f15de58dd54629` from `crates_io` as `registry_expansion`
