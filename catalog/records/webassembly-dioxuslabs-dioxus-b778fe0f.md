...
<!-- canonical: https://github.com/DioxusLabs/dioxus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DioxusLabs/dioxus](https://github.com/DioxusLabs/dioxus) |
| Source record ids | github_search_webassembly-edba0197b83181 |
...
For a systems engineer, DioxusLabs/dioxus belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T17:35:05Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-edba0197b83181` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| seed-rs/seed | Framework | [open](webassembly-seed-rs-seed-42f38c62.md) |
