...
<!-- canonical: https://hackage.haskell.org/package/aeson-pretty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/aeson-pretty](https://hackage.haskell.org/package/aeson-pretty) |
| Source record ids | hackage_top_downloads-7a435469863221 |
...
For a systems engineer, aeson-pretty belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.11 | 2026-06-21T19:18:17Z | [https://hackage.haskell.org/package/aeson-pretty](https://hackage.haskell.org/package/aeson-pretty) |  |
| candidate | partial | 0.8.10 |  | [https://hackage.haskell.org/package/aeson-pretty](https://hackage.haskell.org/package/aeson-pretty) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/aeson-pretty` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-7a435469863221` from `hackage_top_downloads` as `registry_expansion`
