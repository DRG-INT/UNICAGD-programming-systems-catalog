...
<!-- canonical: https://hackage.haskell.org/package/wavefront -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wavefront](https://hackage.haskell.org/package/wavefront) |
| Source record ids | hackage_top_downloads-70ea88b626a100 |
...
For a systems engineer, wavefront belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2.0 | 2026-06-14T13:44:03Z | [https://hackage.haskell.org/package/wavefront](https://hackage.haskell.org/package/wavefront) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wavefront` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-70ea88b626a100` from `hackage_top_downloads` as `registry_expansion`
