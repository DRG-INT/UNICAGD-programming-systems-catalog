...
<!-- canonical: https://hackage.haskell.org/package/hsimport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hsimport](https://hackage.haskell.org/package/hsimport) |
| Source record ids | hackage_top_downloads-d396784807d6c6 |
...
For a systems engineer, hsimport belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2019-09-15T08:44:09Z | [https://hackage.haskell.org/package/hsimport](https://hackage.haskell.org/package/hsimport) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hsimport` at `2026-09-05T00:31:54+00:00`.
...
- `hackage_top_downloads-d396784807d6c6` from `hackage_top_downloads` as `registry_expansion`
