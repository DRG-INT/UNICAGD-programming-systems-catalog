...
<!-- canonical: https://github.com/bmwcarit/barefoot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bmwcarit/barefoot](https://github.com/bmwcarit/barefoot) |
| Source record ids | github_search_maps-48efc5af3557b6 |

## System Engineer Summary

Java map matching library for integrating the map into software and services with state-of-the-art
online and offline map matching that can be used stand-alone and in the cloud.

## Operational Role

For a systems engineer, bmwcarit/barefoot belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-14T17:11:38Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-48efc5af3557b6` from `github_search_maps` as `registry_expansion`
