...
<!-- canonical: https://cran.r-project.org/web/packages/ieegio/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ieegio/index.html](https://cran.r-project.org/web/packages/ieegio/index.html) |
| Source record ids | cran_packages_by_date-5b607f98dea398 |
...
For a systems engineer, ieegio belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-03 08:10:11 UTC | [https://cran.r-project.org/web/packages/ieegio/DESCRIPTION](https://cran.r-project.org/web/packages/ieegio/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ieegio/DESCRIPTION` at `2026-09-03T08:21:53+00:00`.
...
- `cran_packages_by_date-5b607f98dea398` from `cran_packages_by_date` as `registry_expansion`
