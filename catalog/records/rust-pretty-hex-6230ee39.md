...
| Canonical URL | [https://crates.io/crates/pretty-hex](https://crates.io/crates/pretty-hex) |
| Source record ids | crates_io-4787fd78913af8 |
...
For a systems engineer, pretty-hex belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-03-15T08:32:02.225497Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-4787fd78913af8` from `crates_io` as `registry_expansion`
