...
<!-- canonical: https://github.com/GimelStudio/Gimel-Studio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GimelStudio/Gimel-Studio](https://github.com/GimelStudio/Gimel-Studio) |
| Source record ids | github_search_photography-34c3274e2e7eda |

## System Engineer Summary

Old repo of the node-based image editor. See for the next generation of Gimel Studio :rocket:

## Operational Role

For a systems engineer, GimelStudio/Gimel-Studio belongs in the Photography inventory as part of
...
- `github_search_photography-34c3274e2e7eda` from `github_search_photography` as `registry_expansion`
