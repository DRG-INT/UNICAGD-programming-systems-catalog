...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CImGui](https://github.com/JuliaRegistries/General/tree/master/C/CImGui) |
| Source record ids | julia_general-c5a729cceb0ee3 |

## System Engineer Summary

Julia package registered in General at C/CImGui.

## Operational Role

For a systems engineer, CImGui belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CImGui", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c5a729cceb0ee3` from `julia_general` as `registry_expansion`
