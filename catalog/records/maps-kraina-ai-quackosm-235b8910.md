...
<!-- canonical: https://github.com/kraina-ai/quackosm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kraina-ai/quackosm](https://github.com/kraina-ai/quackosm) |
| Source record ids | github_search_maps-1a73ea6eabdbdf |
...
For a systems engineer, kraina-ai/quackosm belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T12:02:42Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1a73ea6eabdbdf` from `github_search_maps` as `registry_expansion`
