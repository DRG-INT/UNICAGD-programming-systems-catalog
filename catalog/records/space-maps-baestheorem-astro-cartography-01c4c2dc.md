...
<!-- canonical: https://github.com/BaesTheorem/astro-cartography -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BaesTheorem/astro-cartography](https://github.com/BaesTheorem/astro-cartography) |
| Source record ids | github_search_space_maps-39720ce9c229a8 |

## System Engineer Summary

Printable astrocartography PDF packets: in-mundo planetary lines on the Swiss Ephemeris, themed
world maps, hand-written readings

## Operational Role

For a systems engineer, BaesTheorem/astro-cartography belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T05:18:32Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-39720ce9c229a8` from `github_search_space_maps` as `registry_expansion`
