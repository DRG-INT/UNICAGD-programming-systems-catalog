...
<!-- canonical: https://packagist.org/packages/phootwork/collection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phootwork/collection](https://packagist.org/packages/phootwork/collection) |
| Source record ids | packagist_search-540d109b9734db |

## System Engineer Summary

The phootwork library fills gaps in the php language and provides better solutions than the existing
ones php offers.

## Operational Role

For a systems engineer, phootwork/collection belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-540d109b9734db` from `packagist_search` as `registry_expansion`
