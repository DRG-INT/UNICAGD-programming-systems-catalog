# ageneau/piano-repertoire-index

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ageneau/piano-repertoire-index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ageneau/piano-repertoire-index](https://github.com/ageneau/piano-repertoire-index) |
| Source record ids | github_search_repertoare_catalogs-4ce3f565923576 |

## System Engineer Summary

Index piano YouTube videos and sheet music scores, extract catalog metadata (BWV, Opus), cross-modal
search via ChromaDB

## Operational Role

For a systems engineer, ageneau/piano-repertoire-index belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T15:47:03Z | gh search repos repertoire catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-4ce3f565923576` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BarneyBarnum/belt-it | Undefined Behavior Analyzer | [open](repertoare-catalogs-barneybarnum-belt-it-32074410.md) |
| benlmaoujoud/HighAvailability_Automation_Scripts | Undefined Behavior Analyzer | [open](repertoare-catalogs-benlmaoujoud-highavailability-automation-scripts-6f87c002.md) |
| caereforge/tempo-scores | Undefined Behavior Analyzer | [open](repertoare-catalogs-caereforge-tempo-scores-41391912.md) |
| elandau91/gd-backend | Undefined Behavior Analyzer | [open](repertoare-catalogs-elandau91-gd-backend-8d93b920.md) |
| farhaouiayoub/Flask-Mini-Projects-Collection | Undefined Behavior Analyzer | [open](repertoare-catalogs-farhaouiayoub-flask-mini-projects-collection-ea725ae4.md) |
| ibtissamelhani/Maska_Hunter_League | Undefined Behavior Analyzer | [open](repertoare-catalogs-ibtissamelhani-maska-hunter-league-b5889dc3.md) |
| kathrynmueller/conductor-rep | Undefined Behavior Analyzer | [open](repertoare-catalogs-kathrynmueller-conductor-rep-712ea183.md) |
| Kingdompe/ai-catalog-score-docs | Undefined Behavior Analyzer | [open](repertoare-catalogs-kingdompe-ai-catalog-score-docs-52a2d6b4.md) |
