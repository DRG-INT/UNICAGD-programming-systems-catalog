...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Doctrines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/doctrines.md) · [Category: Tutorial Book Styleguide](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/tutorial-book-styleguide.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://12factor.net/](https://12factor.net/) |
| Source record ids | curated_language_routes-b3c0a63bbcc1e8 |

## System Engineer Summary

Application architecture doctrine for cloud-native configuration, dependencies, backing services,
logs, processes, and disposability.

## Operational Role

For a systems engineer, The Twelve-Factor App belongs in the Doctrines inventory as part of
...
- `curated_language_routes-b3c0a63bbcc1e8` from `curated_language_routes` as `registry_expansion`
