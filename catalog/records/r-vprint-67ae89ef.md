...
<!-- canonical: https://cran.r-project.org/web/packages/vprint/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vprint/index.html](https://cran.r-project.org/web/packages/vprint/index.html) |
| Source record ids | cran_packages_by_date-3387332a678cd8 |
...
For a systems engineer, vprint belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4 | 2026-09-08 17:00:02 UTC | [https://cran.r-project.org/web/packages/vprint/DESCRIPTION](https://cran.r-project.org/web/packages/vprint/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vprint/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-3387332a678cd8` from `cran_packages_by_date` as `registry_expansion`
