...
<!-- canonical: https://github.com/SJTU-Thinklab-Det/DOTA-DOAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SJTU-Thinklab-Det/DOTA-DOAI](https://github.com/SJTU-Thinklab-Det/DOTA-DOAI) |
| Source record ids | github_search_radars-637d63937aa31a |

## System Engineer Summary

This repo is the codebase for our team to participate in DOTA related competitions, including
rotation and horizontal detection.

## Operational Role

For a systems engineer, SJTU-Thinklab-Det/DOTA-DOAI belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-08T11:47:55Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-637d63937aa31a` from `github_search_radars` as `registry_expansion`
