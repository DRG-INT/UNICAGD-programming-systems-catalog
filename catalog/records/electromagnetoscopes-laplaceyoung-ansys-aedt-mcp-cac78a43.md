# LaplaceYoung/ansys-aedt-mcp

## Navigation

[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/LaplaceYoung/ansys-aedt-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LaplaceYoung/ansys-aedt-mcp](https://github.com/LaplaceYoung/ansys-aedt-mcp) |
| Source record ids | github_search_electromagnetoscopes-1a9b5e17caebb7 |

## System Engineer Summary

MCP server for Ansys Electronics Desktop automation with PyAEDT, HFSS, Maxwell, Q3D, Icepak, native
AEDT APIs, reports, sweeps, and simulation workflows.

## Operational Role

For a systems engineer, LaplaceYoung/ansys-aedt-mcp belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-21T22:28:18Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other |
...
- `github_search_electromagnetoscopes-1a9b5e17caebb7` from `github_search_electromagnetoscopes` as `registry_expansion`
