...
<!-- canonical: https://github.com/Physics-Scaling/GeoPT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Physics-Scaling/GeoPT](https://github.com/Physics-Scaling/GeoPT) |
| Source record ids | github_search_physics_engines-5304918ea053b1 |

## System Engineer Summary

Official Code for "GeoPT: Scaling Physics Simulation via Lifted Geometric Pre-Training" (ICML 2026)

## Operational Role

For a systems engineer, Physics-Scaling/GeoPT belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-20T00:38:15Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-5304918ea053b1` from `github_search_physics_engines` as `registry_expansion`
