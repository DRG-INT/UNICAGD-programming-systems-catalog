...
<!-- canonical: https://github.com/risinglightdb/risinglight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/risinglightdb/risinglight](https://github.com/risinglightdb/risinglight) |
| Source record ids | github_search_databases-ec831f9be83067 |
...
For a systems engineer, risinglightdb/risinglight belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-10T04:37:32Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ec831f9be83067` from `github_search_databases` as `registry_expansion`
