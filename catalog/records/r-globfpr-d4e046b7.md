...
<!-- canonical: https://cran.r-project.org/web/packages/gloBFPr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gloBFPr/index.html](https://cran.r-project.org/web/packages/gloBFPr/index.html) |
| Source record ids | cran_packages_by_date-85edb0f98d42db |

## System Engineer Summary

Urban Environment Analysis Using Global Building Height Datasets

## Operational Role

For a systems engineer, gloBFPr belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-04 06:20:02 UTC | [https://cran.r-project.org/web/packages/gloBFPr/DESCRIPTION](https://cran.r-project.org/web/packages/gloBFPr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gloBFPr/DESCRIPTION` at `2026-09-04T06:24:31+00:00`.
...
- `cran_packages_by_date-85edb0f98d42db` from `cran_packages_by_date` as `registry_expansion`
