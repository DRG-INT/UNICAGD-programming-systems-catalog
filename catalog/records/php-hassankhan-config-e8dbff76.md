...
<!-- canonical: https://packagist.org/packages/hassankhan/config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/hassankhan/config](https://packagist.org/packages/hassankhan/config) |
| Source record ids | packagist_search-602fa68b97871c |
...
For a systems engineer, hassankhan/config belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-602fa68b97871c` from `packagist_search` as `registry_expansion`
