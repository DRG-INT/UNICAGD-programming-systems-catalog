...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Jit Vm](../by-category/jit-vm.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/jll/A/AsmJit_jll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/A/AsmJit_jll](https://github.com/JuliaRegistries/General/tree/master/jll/A/AsmJit_jll) |
| Source record ids | julia_general-937ac10de6a9d4 |

## System Engineer Summary

Julia package registered in General at jll/A/AsmJit_jll.

## Operational Role

For a systems engineer, AsmJit_jll belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/A/AsmJit_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-937ac10de6a9d4` from `julia_general` as `registry_expansion`
