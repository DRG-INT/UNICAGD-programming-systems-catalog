...
<!-- canonical: https://cran.r-project.org/web/packages/predHCS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/predHCS/index.html](https://cran.r-project.org/web/packages/predHCS/index.html) |
| Source record ids | cran_packages_by_date-19494b2d8afc20 |
...
For a systems engineer, predHCS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 09:20:09 UTC | [https://cran.r-project.org/web/packages/predHCS/DESCRIPTION](https://cran.r-project.org/web/packages/predHCS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/predHCS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-19494b2d8afc20` from `cran_packages_by_date` as `registry_expansion`
