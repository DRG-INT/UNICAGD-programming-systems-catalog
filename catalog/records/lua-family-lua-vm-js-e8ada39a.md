...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Compiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/daurnimator/lua.vm.js](https://github.com/daurnimator/lua.vm.js) |
| Source record ids | lua-source-62 |
...
For a systems engineer, lua.vm.js belongs in the Lua family inventory as part of compiler selection,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 62}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-62` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bpf | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bpf-81be5656.md) |
| clangd_extensions.nvim | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-clangd-extensions-nvim-36a24d4d.md) |
| cpp-compiler-pretty-output | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cpp-compiler-pretty-output-d5aab195.md) |
| dromozoa-compiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-compiler-363c8d74.md) |
| GopherLua | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gopherlua-c755efc5.md) |
| LLVM-Lua | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-llvm-lua-9ef4a12f.md) |
| luadec51 | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luadec51-e7e06ca1.md) |
| LuaJIT | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luajit-06502a23.md) |
