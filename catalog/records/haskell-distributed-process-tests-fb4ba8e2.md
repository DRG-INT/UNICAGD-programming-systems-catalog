...
<!-- canonical: https://hackage.haskell.org/package/distributed-process-tests -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/distributed-process-tests](https://hackage.haskell.org/package/distributed-process-tests) |
| Source record ids | hackage_top_downloads-0a0f894bba81bf |
...
For a systems engineer, distributed-process-tests belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2025-02-05T01:57:07Z | [https://hackage.haskell.org/package/distributed-process-tests](https://hackage.haskell.org/package/distributed-process-tests) |  |
| candidate | partial | 0.4.3.1 |  | [https://hackage.haskell.org/package/distributed-process-tests](https://hackage.haskell.org/package/distributed-process-tests) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/distributed-process-tests` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-0a0f894bba81bf` from `hackage_top_downloads` as `registry_expansion`
