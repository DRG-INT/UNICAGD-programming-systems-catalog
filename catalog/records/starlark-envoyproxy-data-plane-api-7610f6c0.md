...
<!-- canonical: https://github.com/envoyproxy/data-plane-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/envoyproxy/data-plane-api](https://github.com/envoyproxy/data-plane-api) |
| Source record ids | github_search_starlark-bf5da163b00e9d |
...
For a systems engineer, envoyproxy/data-plane-api belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:38:47Z | gh search repos language:Starlark stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-bf5da163b00e9d` from `github_search_starlark` as `registry_expansion`
