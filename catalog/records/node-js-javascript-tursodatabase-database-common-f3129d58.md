...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Build System](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/build-system.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@tursodatabase/database-common](https://www.npmjs.com/package/@tursodatabase/database-common) |
| Source record ids | npm_registry-4e74659c8f3f6b |

## System Engineer Summary

This package is the Turso embedded database common JS library which is shared between final builds
for Node and Browser.

## Operational Role

For a systems engineer, @tursodatabase/database-common belongs in the Node.js/JavaScript inventory
as part of build graph control, artifact reproducibility, cross-platform build policy, and CI
integration.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2026-07-30T13:59:29.864Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T02:12:58+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| @alis-build/build | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-alis-build-build-9cfc4f9e.md) |
| @alleyinteractive/build-tool | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-alleyinteractive-build-tool-332d8e95.md) |
| @aminya/node-gyp-build | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aminya-node-gyp-build-eecb368f.md) |
| @angular-builders/custom-esbuild | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-builders-custom-esbuild-a3f7e789.md) |
| @angular-builders/custom-webpack | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-builders-custom-webpack-69d8fc3f.md) |
| @angular-devkit/architect | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-devkit-architect-d0ac1a3f.md) |
| @angular-devkit/build-ng-packagr | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-devkit-build-ng-packagr-e9f6c4bb.md) |
| @angular-eslint/builder | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-angular-eslint-builder-871e2113.md) |
