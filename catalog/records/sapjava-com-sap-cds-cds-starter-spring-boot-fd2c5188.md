...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cds/cds-starter-spring-boot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cds/cds-starter-spring-boot](https://central.sonatype.com/artifact/com.sap.cds/cds-starter-spring-boot) |
| Source record ids | maven_central_search-ddce856bf0727b |
...
For a systems engineer, com.sap.cds:cds-starter-spring-boot belongs in the SAPJava inventory as part
...
- `maven_central_search-ddce856bf0727b` from `maven_central_search` as `registry_expansion`
