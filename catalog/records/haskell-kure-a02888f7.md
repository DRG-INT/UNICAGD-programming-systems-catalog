...
<!-- canonical: https://hackage.haskell.org/package/kure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/kure](https://hackage.haskell.org/package/kure) |
| Source record ids | hackage_top_downloads-d85d2a3b252304 |
...
For a systems engineer, kure belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.18.6 | 2021-04-04T16:22:24Z | [https://hackage.haskell.org/package/kure](https://hackage.haskell.org/package/kure) |  |
| candidate | partial | 2.18.6 |  | [https://hackage.haskell.org/package/kure](https://hackage.haskell.org/package/kure) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kure` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-d85d2a3b252304` from `hackage_top_downloads` as `registry_expansion`
