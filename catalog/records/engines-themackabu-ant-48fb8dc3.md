...
<!-- canonical: https://github.com/theMackabu/ant -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/theMackabu/ant](https://github.com/theMackabu/ant) |
| Source record ids | github_search_engines-81dbc2bfceedeb |
...
For a systems engineer, theMackabu/ant belongs in the Engines inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T03:24:45Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-81dbc2bfceedeb` from `github_search_engines` as `registry_expansion`
