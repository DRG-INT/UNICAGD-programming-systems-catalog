...
<!-- canonical: https://hackage.haskell.org/package/cassava -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cassava](https://hackage.haskell.org/package/cassava) |
| Source record ids | hackage_top_downloads-9589571ab22cab |
...
For a systems engineer, cassava belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4.1 | 2025-09-02T12:50:09Z | [https://hackage.haskell.org/package/cassava](https://hackage.haskell.org/package/cassava) |  |
| candidate | partial | 0.5.0.0 |  | [https://hackage.haskell.org/package/cassava](https://hackage.haskell.org/package/cassava) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cassava` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-9589571ab22cab` from `hackage_top_downloads` as `registry_expansion`
