...
<!-- canonical: https://pypi.org/project/acore-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acore-server/](https://pypi.org/project/acore-server/) |
| Source record ids | pypi_simple-aba059d9f12219 |
...
For a systems engineer, acore-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2024-07-26T21:00:27.088014Z | [https://pypi.org/pypi/acore-server/json](https://pypi.org/pypi/acore-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acore-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-aba059d9f12219` from `pypi_simple` as `registry_expansion`
