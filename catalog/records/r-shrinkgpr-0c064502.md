...
<!-- canonical: https://cran.r-project.org/web/packages/shrinkGPR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shrinkGPR/index.html](https://cran.r-project.org/web/packages/shrinkGPR/index.html) |
| Source record ids | cran_packages_by_date-4849379404d994 |
...
For a systems engineer, shrinkGPR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-09-09 14:10:07 UTC | [https://cran.r-project.org/web/packages/shrinkGPR/DESCRIPTION](https://cran.r-project.org/web/packages/shrinkGPR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shrinkGPR/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-4849379404d994` from `cran_packages_by_date` as `registry_expansion`
