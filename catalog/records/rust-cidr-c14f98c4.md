...
| Canonical URL | [https://crates.io/crates/cidr](https://crates.io/crates/cidr) |
| Source record ids | crates_io-63df89c269fde6 |
...
For a systems engineer, cidr belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-12-18T12:37:05.459248Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-63df89c269fde6` from `crates_io` as `registry_expansion`
