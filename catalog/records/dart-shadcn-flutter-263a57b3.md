...
<!-- canonical: https://pub.dev/packages/shadcn_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shadcn_flutter](https://pub.dev/packages/shadcn_flutter) |
| Source record ids | pub_dev-6c2fd18f701063 |
...
For a systems engineer, shadcn_flutter belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.54 | 2026-08-27T18:12:22.644515Z | [https://pub.dev/api/packages/shadcn_flutter](https://pub.dev/api/packages/shadcn_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shadcn_flutter` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-6c2fd18f701063` from `pub_dev` as `registry_expansion`
