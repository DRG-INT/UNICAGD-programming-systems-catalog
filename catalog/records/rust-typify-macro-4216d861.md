...
| Canonical URL | [https://crates.io/crates/typify-macro](https://crates.io/crates/typify-macro) |
| Source record ids | crates_io-2f308fd5ae140d |
...
For a systems engineer, typify-macro belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-06-05T17:56:19.061898Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-2f308fd5ae140d` from `crates_io` as `registry_expansion`
