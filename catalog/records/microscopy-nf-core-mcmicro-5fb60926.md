...
| Canonical URL | [https://github.com/nf-core/mcmicro](https://github.com/nf-core/mcmicro) |
| Source record ids | github_search_microscopy-89a4f23aa996ef |

## System Engineer Summary

An end-to-end processing pipeline that transforms multi-channel whole-slide images into single-cell
data.

## Operational Role

For a systems engineer, nf-core/mcmicro belongs in the Microscopy inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-07-02T14:42:09Z | [https://api.github.com/repos/nf-core/mcmicro/releases/latest](https://api.github.com/repos/nf-core/mcmicro/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nf-core/mcmicro/releases/latest` at `2026-09-01T08:26:20+00:00`.
...
- `github_search_microscopy-89a4f23aa996ef` from `github_search_microscopy` as `registry_expansion`
