...
<!-- canonical: https://github.com/GuLinux/AstroPhoto-Plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GuLinux/AstroPhoto-Plus](https://github.com/GuLinux/AstroPhoto-Plus) |
| Source record ids | github_search_telescopes-d17ed84dc808fc |

## System Engineer Summary

A lightweight, web based astrophotography sequence generator and INDI client written in Python and
React.

## Operational Role

For a systems engineer, GuLinux/AstroPhoto-Plus belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.1 | 2019-03-18T22:02:17Z | [https://api.github.com/repos/GuLinux/AstroPhoto-Plus/releases/latest](https://api.github.com/repos/GuLinux/AstroPhoto-Plus/releases/latest) |  |
| preview | known | v1.0.1-b933 | 2020-11-04T05:44:28Z | [https://api.github.com/repos/GuLinux/AstroPhoto-Plus/releases?per_page=10](https://api.github.com/repos/GuLinux/AstroPhoto-Plus/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GuLinux/AstroPhoto-Plus/releases/latest` at `2026-09-01T11:22:15+00:00`.
...
- `github_search_telescopes-d17ed84dc808fc` from `github_search_telescopes` as `registry_expansion`
