...
<!-- canonical: https://packagist.org/packages/redisent/redisent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/redisent/redisent](https://packagist.org/packages/redisent/redisent) |
| Source record ids | packagist_search-dc29910a7d86b4 |

## System Engineer Summary

redisent/redisent is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, redisent/redisent belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-dc29910a7d86b4` from `packagist_search` as `registry_expansion`
