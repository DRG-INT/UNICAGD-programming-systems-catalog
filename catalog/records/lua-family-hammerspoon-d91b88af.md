...
| Canonical URL | [http://www.hammerspoon.org](http://www.hammerspoon.org) |
| Source record ids | lua-source-346 |
...
For a systems engineer, Hammerspoon belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 346}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-346` from `master_json` as `source_list_item`
