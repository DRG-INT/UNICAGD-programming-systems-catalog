...
<!-- canonical: https://github.com/mnayef95/Android-Weekly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mnayef95/Android-Weekly](https://github.com/mnayef95/Android-Weekly) |
| Source record ids | github_search_magazines-9782d4f8a3fced |

## System Engineer Summary

Android Weekly is a free newsletter that helps you to stay cutting-edge with your Android
Development. The newsletter comes once a week and covers a broad range of topics like tutorials,
screencasts, news... just everything that's awesome in the Android Development world!

## Operational Role

For a systems engineer, mnayef95/Android-Weekly belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-14T19:55:51Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-9782d4f8a3fced` from `github_search_magazines` as `registry_expansion`
