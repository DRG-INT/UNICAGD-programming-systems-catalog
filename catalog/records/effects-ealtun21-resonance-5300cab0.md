...
<!-- canonical: https://github.com/ealtun21/resonance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ealtun21/resonance](https://github.com/ealtun21/resonance) |
| Source record ids | github_search_effects-f3ab55b118834a |

## System Engineer Summary

System-wide parametric EQ + audio-effects engine for Linux, macOS & Windows — GUI, TUI & CLI, with
FxSound & EqualizerAPO preset support

## Operational Role

For a systems engineer, ealtun21/resonance belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T18:16:21Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f3ab55b118834a` from `github_search_effects` as `registry_expansion`
