...
<!-- canonical: https://packagist.org/packages/paragonie/csp-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/paragonie/csp-builder](https://packagist.org/packages/paragonie/csp-builder) |
| Source record ids | packagist_search-738fa77ca2a7f3 |
...
For a systems engineer, paragonie/csp-builder belongs in the PHP inventory as part of build graph
...
- `packagist_search-738fa77ca2a7f3` from `packagist_search` as `registry_expansion`
