...
<!-- canonical: https://github.com/aangelopoulos/im2im-uq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aangelopoulos/im2im-uq](https://github.com/aangelopoulos/im2im-uq) |
| Source record ids | github_search_microscopy-39102de400ba78 |

## System Engineer Summary

Image-to-image regression with uncertainty quantification in PyTorch. Take any dataset and train a
model to regress images to images with rigorous, distribution-free uncertainty quantification.

## Operational Role

For a systems engineer, aangelopoulos/im2im-uq belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-23T19:09:44Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-39102de400ba78` from `github_search_microscopy` as `registry_expansion`
