...
<!-- canonical: https://crates.io/crates/take_mut -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/take_mut](https://crates.io/crates/take_mut) |
| Source record ids | crates_io-b7b8b83f83f59b |
...
For a systems engineer, take_mut belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2018-03-20T05:12:48.872959Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-b7b8b83f83f59b` from `crates_io` as `registry_expansion`
