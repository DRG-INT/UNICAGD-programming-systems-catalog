...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Compiler Diagnostics](../by-category/compiler-diagnostics.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/ForceChoice/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ForceChoice/index.html](https://cran.r-project.org/web/packages/ForceChoice/index.html) |
| Source record ids | cran_packages_by_date-f2bdfcdefbd288 |

## System Engineer Summary

Forced-Choice Modeling Based on Item Response Theory and Cognitive Diagnostic Models

## Operational Role

For a systems engineer, ForceChoice belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-12 17:10:02 UTC | [https://cran.r-project.org/web/packages/ForceChoice/DESCRIPTION](https://cran.r-project.org/web/packages/ForceChoice/DESCRIPTION) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ForceChoice/DESCRIPTION` at `2026-09-12T18:20:25+00:00`.
...
| --- | --- | --- | --- |
| cran_available_packages_by_date | registry-derived | 2026-09-15 | `{"kind": "cran_available_packages_by_date", "retrieved": "2026-09-15", "status": "registry-derived"}` |
...
- `cran_packages_by_date-f2bdfcdefbd288` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| afttest | Compiler Diagnostics | [open](r-afttest-4c2faa0d.md) |
| bayprior | Compiler Diagnostics | [open](r-bayprior-f64cf1ee.md) |
| causaldef | Compiler Diagnostics | [open](r-causaldef-ef86e494.md) |
| CLRtools | Compiler Diagnostics | [open](r-clrtools-e3048f4b.md) |
| ebdt | Compiler Diagnostics | [open](r-ebdt-1cc5e80a.md) |
| ECGofTestDx | Compiler Diagnostics | [open](r-ecgoftestdx-86320dad.md) |
| ggResidpanel | Compiler Diagnostics | [open](r-ggresidpanel-6d20fe4a.md) |
| india | Compiler Diagnostics | [open](r-india-df700ec1.md) |
