...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/segmentio/analytics-ios -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/segmentio/analytics-ios](https://github.com/segmentio/analytics-ios) |
| Source record ids | awesome_list-59ab99f29f4c62 |
...
For a systems engineer, Segment belongs in the Cocoa inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.8 | 2023-02-01T22:35:55Z | [https://api.github.com/repos/segmentio/analytics-ios/releases/latest](https://api.github.com/repos/segmentio/analytics-ios/releases/latest) |  |
| preview | known | 4.0.5 | 2020-08-28T18:52:32Z | [https://api.github.com/repos/segmentio/analytics-ios/releases?per_page=10](https://api.github.com/repos/segmentio/analytics-ios/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/segmentio/analytics-ios/releases/latest` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-59ab99f29f4c62` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| sunjw/fhash | Cryptography | [open](cocoa-sunjw-fhash-8a4442ac.md) |
