...
<!-- canonical: https://crates.io/crates/euclid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/euclid](https://crates.io/crates/euclid) |
| Source record ids | crates_io-9559de11ca4d98 |

## System Engineer Summary

euclid is tracked as a cli record in the Rust branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, euclid belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.14 | 2026-03-18T20:00:26.960761Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-9559de11ca4d98` from `crates_io` as `registry_expansion`
