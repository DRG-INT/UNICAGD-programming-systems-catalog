...
<!-- canonical: https://www.nuget.org/packages/ProtoBufJsonConverter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/ProtoBufJsonConverter](https://www.nuget.org/packages/ProtoBufJsonConverter) |
| Source record ids | nuget_search-8c41c1a81bf742 |
...
For a systems engineer, ProtoBufJsonConverter belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2025-12-24T07:52:40.36+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/protobufjsonconverter/index.json](https://api.nuget.org/v3/registration5-gz-semver2/protobufjsonconverter/index.json) |  |
| preview | known | 0.8.0-preview-01 | 2025-05-04T17:24:10.223+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/protobufjsonconverter/index.json](https://api.nuget.org/v3/registration5-gz-semver2/protobufjsonconverter/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; MIT; https://www.nuget.org/packages/ProtoBufJsonConverter/0.11.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/protobufjsonconverter/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-8c41c1a81bf742` from `nuget_search` as `registry_expansion`
