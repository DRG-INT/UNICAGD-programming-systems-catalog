...
<!-- canonical: https://github.com/phosphor-icons/web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/phosphor-icons/web](https://github.com/phosphor-icons/web) |
| Source record ids | github_search_icons_and_logos-829d8e26288a6e |
...
For a systems engineer, phosphor-icons/web belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-06T21:37:15Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-829d8e26288a6e` from `github_search_icons_and_logos` as `registry_expansion`
