...
<!-- canonical: https://github.com/jakiestfu/himawari.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jakiestfu/himawari.js](https://github.com/jakiestfu/himawari.js) |
| Source record ids | github_search_satcom_satellites-767fef6dd830fb |
...
For a systems engineer, jakiestfu/himawari.js belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-06T19:36:12Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-767fef6dd830fb` from `github_search_satcom_satellites` as `registry_expansion`
