...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/jll/B/blockSQP_jll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/B/blockSQP_jll](https://github.com/JuliaRegistries/General/tree/master/jll/B/blockSQP_jll) |
| Source record ids | julia_general-f60f617b4bbaba |

## System Engineer Summary

Julia package registered in General at jll/B/blockSQP_jll.

## Operational Role

For a systems engineer, blockSQP_jll belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/B/blockSQP_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-f60f617b4bbaba` from `julia_general` as `registry_expansion`
