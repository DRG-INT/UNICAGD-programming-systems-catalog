...
<!-- canonical: https://packagist.org/packages/nilportugues/sql-query-formatter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nilportugues/sql-query-formatter](https://packagist.org/packages/nilportugues/sql-query-formatter) |
| Source record ids | packagist_search-d403ebad7d2988 |

## System Engineer Summary

A very lightweight PHP class that reformats unreadable and computer-generated SQL query statements
to human-friendly, readable text.

## Operational Role

For a systems engineer, nilportugues/sql-query-formatter belongs in the PHP inventory as part of
...
- `packagist_search-d403ebad7d2988` from `packagist_search` as `registry_expansion`
