...
<!-- canonical: https://github.com/dearDreamWeb/camera-watermark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dearDreamWeb/camera-watermark](https://github.com/dearDreamWeb/camera-watermark) |
| Source record ids | github_search_photography-f1084dff257297 |

## System Engineer Summary

dearDreamWeb/camera-watermark is tracked as a library record in the Photography branch. The source
...
For a systems engineer, dearDreamWeb/camera-watermark belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-20T14:12:10Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f1084dff257297` from `github_search_photography` as `registry_expansion`
