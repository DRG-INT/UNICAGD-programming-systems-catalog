...
<!-- canonical: https://crates.io/crates/jsonpath-rust -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/jsonpath-rust](https://crates.io/crates/jsonpath-rust) |
| Source record ids | crates_io-1895df017b5118 |

## System Engineer Summary

The library provides the basic functionality to find the set of the data according to the filtering
query.

## Operational Role

For a systems engineer, jsonpath-rust belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.11 | 2026-09-09T20:05:15.379170Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-09T20:20:23+00:00`.
...
- `crates_io-1895df017b5118` from `crates_io` as `registry_expansion`
