...
<!-- canonical: https://cran.r-project.org/web/packages/MultiStepSSAD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MultiStepSSAD/index.html](https://cran.r-project.org/web/packages/MultiStepSSAD/index.html) |
| Source record ids | cran_packages_by_date-3a2d21e4c0de50 |
...
For a systems engineer, MultiStepSSAD belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 21:00:07 UTC | [https://cran.r-project.org/web/packages/MultiStepSSAD/DESCRIPTION](https://cran.r-project.org/web/packages/MultiStepSSAD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MultiStepSSAD/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3a2d21e4c0de50` from `cran_packages_by_date` as `registry_expansion`
