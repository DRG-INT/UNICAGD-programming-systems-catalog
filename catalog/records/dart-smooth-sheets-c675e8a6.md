...
<!-- canonical: https://pub.dev/packages/smooth_sheets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/smooth_sheets](https://pub.dev/packages/smooth_sheets) |
| Source record ids | pub_dev-76c2a266d644da |

## System Engineer Summary

Sheet widgets with smooth motion and great flexibility. Also supports nested navigation in both
imperative and declarative ways.

## Operational Role

For a systems engineer, smooth_sheets belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-25T00:30:55.340463Z | [https://pub.dev/api/packages/smooth_sheets](https://pub.dev/api/packages/smooth_sheets) |  |
| preview | known | 1.0.0-f324.0.10.2 | 2024-10-19T08:34:56.054876Z | [https://pub.dev/api/packages/smooth_sheets](https://pub.dev/api/packages/smooth_sheets) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/smooth_sheets` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-76c2a266d644da` from `pub_dev` as `registry_expansion`
