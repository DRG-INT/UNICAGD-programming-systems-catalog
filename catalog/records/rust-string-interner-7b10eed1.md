...
| Canonical URL | [https://crates.io/crates/string-interner](https://crates.io/crates/string-interner) |
| Source record ids | crates_io-e761a2bf2297db |
...
For a systems engineer, string-interner belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.0 | 2026-04-30T17:46:44.620449Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-e761a2bf2297db` from `crates_io` as `registry_expansion`
