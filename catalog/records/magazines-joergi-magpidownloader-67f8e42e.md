...
| Source record ids | github_search_magazines-f426f2c8aa868c |
...
For a systems engineer, joergi/MagPiDownloader belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T14:10:04Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 3); MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_magazines-f426f2c8aa868c` from `github_search_magazines` as `registry_expansion`
