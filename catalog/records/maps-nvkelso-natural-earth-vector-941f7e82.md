...
<!-- canonical: https://github.com/nvkelso/natural-earth-vector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nvkelso/natural-earth-vector](https://github.com/nvkelso/natural-earth-vector) |
| Source record ids | github_search_maps-182478c5efaaab |

## System Engineer Summary

A global, public domain map dataset available at three scales and featuring tightly integrated
vector and raster data.

## Operational Role

For a systems engineer, nvkelso/natural-earth-vector belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-22T12:24:13Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-182478c5efaaab` from `github_search_maps` as `registry_expansion`
...
| geomoose/gm3 | Undefined Behavior Analyzer | [open](maps-geomoose-gm3-f1e69386.md) |
