...
<!-- canonical: https://github.com/domlysz/BlenderGIS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/domlysz/BlenderGIS](https://github.com/domlysz/BlenderGIS) |
| Source record ids | github_search_maps-fb6be1ecb8d4c6 |
...
For a systems engineer, domlysz/BlenderGIS belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-20T18:19:10Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-fb6be1ecb8d4c6` from `github_search_maps` as `registry_expansion`
