...
<!-- canonical: https://packagist.org/packages/seinopsys/postgresql-database-class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/seinopsys/postgresql-database-class](https://packagist.org/packages/seinopsys/postgresql-database-class) |
| Source record ids | packagist_search-62f20804692300 |

## System Engineer Summary

PHP wrapper class for PDO-based interaction with PostgreSQL databases, heavily based on
ThingEngineer's MysqliDb class

## Operational Role

For a systems engineer, seinopsys/postgresql-database-class belongs in the PHP inventory as part of
...
- `packagist_search-62f20804692300` from `packagist_search` as `registry_expansion`
