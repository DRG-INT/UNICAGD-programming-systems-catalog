...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/gitlink.nvim](https://luarocks.org/modules/wsdjeg/gitlink.nvim) |
| Source record ids | luarocks_root_manifest-cacaf5a42c0252 |
...
For a systems engineer, gitlink.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-cacaf5a42c0252` from `luarocks_root_manifest` as `registry_expansion`
