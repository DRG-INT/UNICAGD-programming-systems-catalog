...
<!-- canonical: https://cran.r-project.org/web/packages/semFromKeys/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/semFromKeys/index.html](https://cran.r-project.org/web/packages/semFromKeys/index.html) |
| Source record ids | cran_packages_by_date-807e0427188c10 |

## System Engineer Summary

Run 'lavaan' Models from Keys Lists

## Operational Role

For a systems engineer, semFromKeys belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-09-02 02:30:02 UTC | [https://cran.r-project.org/web/packages/semFromKeys/DESCRIPTION](https://cran.r-project.org/web/packages/semFromKeys/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/semFromKeys/DESCRIPTION` at `2026-09-02T02:33:05+00:00`.
...
- `cran_packages_by_date-807e0427188c10` from `cran_packages_by_date` as `registry_expansion`
