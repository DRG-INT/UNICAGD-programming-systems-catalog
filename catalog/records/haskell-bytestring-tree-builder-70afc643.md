...
<!-- canonical: https://hackage.haskell.org/package/bytestring-tree-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bytestring-tree-builder](https://hackage.haskell.org/package/bytestring-tree-builder) |
| Source record ids | hackage_top_downloads-8dd3aeadb7381e |
...
For a systems engineer, bytestring-tree-builder belongs in the Haskell inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7.13 | 2025-02-03T05:43:55Z | [https://hackage.haskell.org/package/bytestring-tree-builder](https://hackage.haskell.org/package/bytestring-tree-builder) |  |
| candidate | partial | 0.2.7.2 |  | [https://hackage.haskell.org/package/bytestring-tree-builder](https://hackage.haskell.org/package/bytestring-tree-builder) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bytestring-tree-builder` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-8dd3aeadb7381e` from `hackage_top_downloads` as `registry_expansion`
