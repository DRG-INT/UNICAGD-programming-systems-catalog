...
<!-- canonical: https://luarocks.org/modules/fsantanna/atmos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fsantanna/atmos](https://luarocks.org/modules/fsantanna/atmos) |
| Source record ids | luarocks_root_manifest-ce25de864087b8 |

## System Engineer Summary

Atmos is a programming library for Lua that reconciles Structured Concurrency with Event-Driven
Programming

## Operational Role

For a systems engineer, atmos belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ce25de864087b8` from `luarocks_root_manifest` as `registry_expansion`
