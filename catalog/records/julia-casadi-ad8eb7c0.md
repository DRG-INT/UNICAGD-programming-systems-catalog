...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CasADi](https://github.com/JuliaRegistries/General/tree/master/C/CasADi) |
| Source record ids | julia_general-291a99140678ed |

## System Engineer Summary

Julia package registered in General at C/CasADi.

## Operational Role

For a systems engineer, CasADi belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CasADi", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-291a99140678ed` from `julia_general` as `registry_expansion`
