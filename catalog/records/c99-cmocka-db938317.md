...
| Source record ids | master-7733adc73021 |
...
For a systems engineer, CMocka belongs in the C99 inventory as part of unit/integration validation,
...
- `master-7733adc73021` from `master_json` as `testing_framework`
