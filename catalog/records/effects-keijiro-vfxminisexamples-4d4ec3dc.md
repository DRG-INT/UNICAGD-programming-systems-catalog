...
<!-- canonical: https://github.com/keijiro/VfxMinisExamples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keijiro/VfxMinisExamples](https://github.com/keijiro/VfxMinisExamples) |
| Source record ids | github_search_effects-e8591a8c279bcd |

## System Engineer Summary

Minis (MIDI extension for Unity Input System) samples with VFX Graph

## Operational Role

For a systems engineer, keijiro/VfxMinisExamples belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-19T08:12:33Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e8591a8c279bcd` from `github_search_effects` as `registry_expansion`
