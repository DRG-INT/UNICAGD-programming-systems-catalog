...
<!-- canonical: https://github.com/martibosch/detectree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/martibosch/detectree](https://github.com/martibosch/detectree) |
| Source record ids | github_search_radars-2befb0382a79ac |
...
For a systems engineer, martibosch/detectree belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T22:32:24Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-2befb0382a79ac` from `github_search_radars` as `registry_expansion`
