...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CircuitModelZoo](https://github.com/JuliaRegistries/General/tree/master/C/CircuitModelZoo) |
| Source record ids | julia_general-d09f971dfd3057 |

## System Engineer Summary

Julia package registered in General at C/CircuitModelZoo.

## Operational Role

For a systems engineer, CircuitModelZoo belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractCircuitComponentRounding | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractcircuitcomponentrounding-8fa9cf47.md) |
| AbstractPlotting | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractplotting-c75fff4b.md) |
| Acquisition | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-acquisition-f18326a2.md) |
| ActiveSetPursuit | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-activesetpursuit-42013bdd.md) |
| AgentsPlots | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-agentsplots-e6df6b08.md) |
| ArviZPythonPlots | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arvizpythonplots-1f03a4f9.md) |
| AsyPlots | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-asyplots-7796108e.md) |
| AutomotiveVisualization | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-automotivevisualization-c33c0e78.md) |
