...
<!-- canonical: https://pypi.org/project/acedatacloud-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acedatacloud-cli/](https://pypi.org/project/acedatacloud-cli/) |
| Source record ids | pypi_simple-52c2984b33709c |
...
For a systems engineer, acedatacloud-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.6.29.0 | 2026-06-29T10:34:57.164995Z | [https://pypi.org/pypi/acedatacloud-cli/json](https://pypi.org/pypi/acedatacloud-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acedatacloud-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-52c2984b33709c` from `pypi_simple` as `registry_expansion`
