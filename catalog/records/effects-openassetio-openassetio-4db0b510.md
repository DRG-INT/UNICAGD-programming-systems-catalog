...
<!-- canonical: https://github.com/OpenAssetIO/OpenAssetIO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenAssetIO/OpenAssetIO](https://github.com/OpenAssetIO/OpenAssetIO) |
| Source record ids | github_search_effects-8fb70285fa87ca |

## System Engineer Summary

An open-source interoperability standard for tools and content management systems used in media
production.

## Operational Role

For a systems engineer, OpenAssetIO/OpenAssetIO belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T13:15:42Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8fb70285fa87ca` from `github_search_effects` as `registry_expansion`
