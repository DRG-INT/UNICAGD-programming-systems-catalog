...
<!-- canonical: https://github.com/lexogrine/hud-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lexogrine/hud-manager](https://github.com/lexogrine/hud-manager) |
| Source record ids | github_search_radars-5978f6f144b328 |
...
For a systems engineer, lexogrine/hud-manager belongs in the Radars inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.3.1 | 2026-06-23T12:13:45Z | [https://api.github.com/repos/lexogrine/hud-manager/releases/latest](https://api.github.com/repos/lexogrine/hud-manager/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lexogrine/hud-manager/releases/latest` at `2026-09-01T08:26:30+00:00`.
...
- `github_search_radars-5978f6f144b328` from `github_search_radars` as `registry_expansion`
