...
<!-- canonical: https://github.com/langhuihui/monibuca -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/langhuihui/monibuca](https://github.com/langhuihui/monibuca) |
| Source record ids | github_search_video-974277a72b54bd |
...
For a systems engineer, langhuihui/monibuca belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:20:13Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-974277a72b54bd` from `github_search_video` as `registry_expansion`
