...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-api](https://central.sonatype.com/artifact/com.sap.cloud/neo-java-web-api) |
| Source record ids | maven_central_search-4defa453d4fcde |
...
For a systems engineer, com.sap.cloud:neo-java-web-api belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.24.2 | 2025-06-11T13:48:38+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cloud%22&rows=100&wt=json) |  |
...
- `maven_central_search-4defa453d4fcde` from `maven_central_search` as `registry_expansion`
