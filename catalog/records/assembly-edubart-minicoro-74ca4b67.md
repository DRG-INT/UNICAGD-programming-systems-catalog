...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/edubart/minicoro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/edubart/minicoro](https://github.com/edubart/minicoro) |
| Source record ids | github_search_assembly-5ebfcde146d5ae |
...
For a systems engineer, edubart/minicoro belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-07T10:36:21Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:assembly stars:>300", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-5ebfcde146d5ae` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| calculuswhiz/Assembly-Syntax-Definition | Undefined Behavior Analyzer | [open](assembly-calculuswhiz-assembly-syntax-definition-034acff7.md) |
| cirosantilli/arm-assembly-cheat | Undefined Behavior Analyzer | [open](assembly-cirosantilli-arm-assembly-cheat-ccbbcbdf.md) |
| franeklubi/dino | Undefined Behavior Analyzer | [open](assembly-franeklubi-dino-8d3e9c1a.md) |
| hlorenzi/customasm | Undefined Behavior Analyzer | [open](assembly-hlorenzi-customasm-85734886.md) |
| IDouble/x86-Assembly-Reverse-Engineering | Undefined Behavior Analyzer | [open](assembly-idouble-x86-assembly-reverse-engineering-fc5247ea.md) |
| tenderlove/fisk | Undefined Behavior Analyzer | [open](assembly-tenderlove-fisk-358e54fe.md) |
| vector4wang/spring-boot-quick | Undefined Behavior Analyzer | [open](assembly-vector4wang-spring-boot-quick-58ca29aa.md) |
| vercas/Beelzebub | Undefined Behavior Analyzer | [open](assembly-vercas-beelzebub-59d56548.md) |
