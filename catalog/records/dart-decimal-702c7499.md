...
<!-- canonical: https://pub.dev/packages/decimal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/decimal](https://pub.dev/packages/decimal) |
| Source record ids | pub_dev-2680dc41e0549a |
...
For a systems engineer, decimal belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.6 | 2026-07-28T20:45:05.599035Z | [https://pub.dev/api/packages/decimal](https://pub.dev/api/packages/decimal) |  |
| preview | known | 1.0.0-nullsafety | 2020-11-27T14:17:05.667375Z | [https://pub.dev/api/packages/decimal](https://pub.dev/api/packages/decimal) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/decimal` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-2680dc41e0549a` from `pub_dev` as `registry_expansion`
