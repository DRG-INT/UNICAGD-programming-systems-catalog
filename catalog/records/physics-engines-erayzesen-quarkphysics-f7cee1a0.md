...
<!-- canonical: https://github.com/erayzesen/QuarkPhysics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/erayzesen/QuarkPhysics](https://github.com/erayzesen/QuarkPhysics) |
| Source record ids | github_search_physics_engines-22070f62ea15cd |
...
For a systems engineer, erayzesen/QuarkPhysics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-17T06:34:37Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-22070f62ea15cd` from `github_search_physics_engines` as `registry_expansion`
