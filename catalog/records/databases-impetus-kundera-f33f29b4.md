...
<!-- canonical: https://github.com/Impetus/kundera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Impetus/kundera](https://github.com/Impetus/kundera) |
| Source record ids | github_search_databases-d4cfc3d0510b26 |

## System Engineer Summary

A JPA 2.1 compliant Polyglot Object-Datastore Mapping Library for NoSQL Datastores.Please subscribe
to:

## Operational Role

For a systems engineer, Impetus/kundera belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-11T05:50:27Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d4cfc3d0510b26` from `github_search_databases` as `registry_expansion`
