...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lgarron/folderify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lgarron/folderify](https://github.com/lgarron/folderify) |
| Source record ids | github_search_icons_and_logos-932714306f7f46 |

## System Engineer Summary

:file_folder: Generate pixel-perfect macOS folder icons in the native style. (Now with support for
macOS 26 Tahoe!)

## Operational Role

For a systems engineer, lgarron/folderify belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T13:20:07Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:icons stars:>500", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_icons_and_logos-932714306f7f46` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 13rac1/twemoji-color-font | Filesystem Os | [open](icons-and-logos-13rac1-twemoji-color-font-75b420c3.md) |
| ayushgoel/AGEmojiKeyboard | Filesystem Os | [open](icons-and-logos-ayushgoel-agemojikeyboard-f0eec669.md) |
| coding/Coding-iOS | Filesystem Os | [open](icons-and-logos-coding-coding-ios-59e494c9.md) |
| composablehorizons/compose-unstyled | Filesystem Os | [open](icons-and-logos-composablehorizons-compose-unstyled-15a39307.md) |
| ealush/emoji-picker-react | Filesystem Os | [open](icons-and-logos-ealush-emoji-picker-react-c9427290.md) |
| elrumo/macOS_Big_Sur_icons_replacements | Filesystem Os | [open](icons-and-logos-elrumo-macos-big-sur-icons-replacements-2eb50ab4.md) |
| enzet/map-machine | Filesystem Os | [open](icons-and-logos-enzet-map-machine-3dab16d2.md) |
| fabriziosalmi/brandkit | Filesystem Os | [open](icons-and-logos-fabriziosalmi-brandkit-e4ea2ac1.md) |
