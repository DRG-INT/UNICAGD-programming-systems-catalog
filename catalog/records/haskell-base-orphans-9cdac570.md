...
<!-- canonical: https://hackage.haskell.org/package/base-orphans -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/base-orphans](https://hackage.haskell.org/package/base-orphans) |
| Source record ids | hackage_top_downloads-e3641891c17293 |
...
For a systems engineer, base-orphans belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.4 | 2026-01-10T15:53:26Z | [https://hackage.haskell.org/package/base-orphans](https://hackage.haskell.org/package/base-orphans) |  |
| candidate | partial | 0 |  | [https://hackage.haskell.org/package/base-orphans](https://hackage.haskell.org/package/base-orphans) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/base-orphans` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-e3641891c17293` from `hackage_top_downloads` as `registry_expansion`
