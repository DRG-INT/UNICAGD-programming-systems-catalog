...
<!-- canonical: https://gitlab.kitware.com/paraview/paraview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.kitware.com/paraview/paraview](https://gitlab.kitware.com/paraview/paraview) |
| Source record ids | curated_language_routes-539b00a35e63db |

## System Engineer Summary

Scientific visualization application for large data analysis, rendering, distributed processing, and
dashboards.

## Operational Role

For a systems engineer, ParaView belongs in the Computer Graphics Software inventory as part of
...
- `curated_language_routes-539b00a35e63db` from `curated_language_routes` as `registry_expansion`
