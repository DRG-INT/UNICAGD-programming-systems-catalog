...
| Canonical URL | [https://github.com/JSsixtyfour/smashremix](https://github.com/JSsixtyfour/smashremix) |
| Source record ids | github_search_assembly-1451e7b9fa6c7c |

## System Engineer Summary

JSsixtyfour/smashremix is tracked as a language specification record in the Assembly branch. The
...
For a systems engineer, JSsixtyfour/smashremix belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-03-08T22:01:34Z | [https://api.github.com/repos/JSsixtyfour/smashremix/releases/latest](https://api.github.com/repos/JSsixtyfour/smashremix/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/JSsixtyfour/smashremix/releases/latest` at `2026-09-01T10:25:49+00:00`.
...
- `github_search_assembly-1451e7b9fa6c7c` from `github_search_assembly` as `registry_expansion`
