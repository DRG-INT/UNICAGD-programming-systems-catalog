...
| Canonical URL | [https://crates.io/crates/axum-extra](https://crates.io/crates/axum-extra) |
| Source record ids | crates_io-60d221b318bcec |
...
For a systems engineer, axum-extra belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.6 | 2026-04-14T07:55:40.731964Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-60d221b318bcec` from `crates_io` as `registry_expansion`
