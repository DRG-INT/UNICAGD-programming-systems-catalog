...
<!-- canonical: https://cran.r-project.org/web/packages/tm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tm/index.html](https://cran.r-project.org/web/packages/tm/index.html) |
| Source record ids | cran_packages_by_date-9e0c17adca99ee |

## System Engineer Summary

tm is tracked as a library record in the R branch. The source did not provide a long description, so
this page keeps the identity, release state, provenance, and operational classification explicit for
later enrichment.

## Operational Role

For a systems engineer, tm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7-19 | 2026-08-13 08:42:02 UTC | [https://cran.r-project.org/web/packages/tm/DESCRIPTION](https://cran.r-project.org/web/packages/tm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9e0c17adca99ee` from `cran_packages_by_date` as `registry_expansion`
