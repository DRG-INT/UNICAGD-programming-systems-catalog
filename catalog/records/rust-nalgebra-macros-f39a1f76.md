...
| Canonical URL | [https://crates.io/crates/nalgebra-macros](https://crates.io/crates/nalgebra-macros) |
| Source record ids | crates_io-b0b634cb03f50b |
...
For a systems engineer, nalgebra-macros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2025-07-31T12:27:33.842666Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-b0b634cb03f50b` from `crates_io` as `registry_expansion`
