...
<!-- canonical: https://www.npmjs.com/package/@strapi/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@strapi/database](https://www.npmjs.com/package/@strapi/database) |
| Source record ids | npm_registry-240fa8ca2d23c0 |

## System Engineer Summary

@strapi/database is tracked as a database datastore record in the Node.js/JavaScript branch. The
...
For a systems engineer, @strapi/database belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.52.3 | 2026-09-02T14:35:58.213Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-02T15:24:04+00:00`.
...
- `npm_registry-240fa8ca2d23c0` from `npm_registry` as `registry_expansion`
