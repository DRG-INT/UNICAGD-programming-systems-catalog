...
<!-- canonical: https://github.com/isadorasophia/murder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/isadorasophia/murder](https://github.com/isadorasophia/murder) |
| Source record ids | github_search_game_engines-e4bbfd7a54a740 |
...
For a systems engineer, isadorasophia/murder belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T07:09:45Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e4bbfd7a54a740` from `github_search_game_engines` as `registry_expansion`
