...
| Canonical URL | [https://github.com/apache/pinot](https://github.com/apache/pinot) |
| Source record ids | curated_database_systems-01ee0899a78f7f |

## System Engineer Summary

Realtime distributed OLAP datastore for user-facing analytics.

## Operational Role

For a systems engineer, Apache Pinot belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | release-1.5.1 | 2026-06-05T01:05:26Z | [https://api.github.com/repos/apache/pinot/releases/latest](https://api.github.com/repos/apache/pinot/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apache/pinot/releases/latest` at `2026-09-01T07:24:48+00:00`.
...
- `curated_database_systems-01ee0899a78f7f` from `curated_database_systems` as `registry_expansion`
