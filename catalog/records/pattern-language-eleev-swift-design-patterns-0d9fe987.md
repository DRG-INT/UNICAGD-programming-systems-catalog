...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/eleev/swift-design-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eleev/swift-design-patterns](https://github.com/eleev/swift-design-patterns) |
| Source record ids | github_search_pattern_language-c6117ee20bc385 |
...
For a systems engineer, eleev/swift-design-patterns belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-04T20:30:48Z | gh search repos software architecture patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-c6117ee20bc385` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| chanakaudaya/solution-architecture-patterns | Precommit Ci Quality | [open](pattern-language-chanakaudaya-solution-architecture-patterns-f91d8174.md) |
| dbacinski/Design-Patterns-In-Kotlin | Precommit Ci Quality | [open](pattern-language-dbacinski-design-patterns-in-kotlin-3eecbd7b.md) |
| tmrts/go-patterns | Precommit Ci Quality | [open](pattern-language-tmrts-go-patterns-9d2a8283.md) |
| webpro/programming-principles | Precommit Ci Quality | [open](pattern-language-webpro-programming-principles-ce6ba8e1.md) |
