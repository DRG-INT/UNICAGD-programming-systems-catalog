...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-2e227f0853a1de |

## System Engineer Summary

Open-source interoperability standard and library for asset management systems and content creation
tools.

## Operational Role

For a systems engineer, OpenAssetIO belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-2e227f0853a1de` from `curated_language_routes` as `registry_expansion`
