...
<!-- canonical: https://cran.r-project.org/web/packages/laGP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/laGP/index.html](https://cran.r-project.org/web/packages/laGP/index.html) |
| Source record ids | cran_packages_by_date-252f71053ff471 |
...
For a systems engineer, laGP belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5-10 | 2026-08-25 21:40:08 UTC | [https://cran.r-project.org/web/packages/laGP/DESCRIPTION](https://cran.r-project.org/web/packages/laGP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/laGP/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-252f71053ff471` from `cran_packages_by_date` as `registry_expansion`
