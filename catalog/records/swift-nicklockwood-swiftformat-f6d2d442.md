...
<!-- canonical: https://github.com/nicklockwood/SwiftFormat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nicklockwood/SwiftFormat](https://github.com/nicklockwood/SwiftFormat) |
| Source record ids | github_search_swift-fdc82b0bc2589f |
...
For a systems engineer, nicklockwood/SwiftFormat belongs in the Swift inventory as part of low-noise
...
- `github_search_swift-fdc82b0bc2589f` from `github_search_swift` as `registry_expansion`
...
| johnbean393/Sidekick | Formatter | [open](swift-johnbean393-sidekick-0969b325.md) |
