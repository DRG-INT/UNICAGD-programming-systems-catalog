...
<!-- canonical: https://github.com/traefik/traefik -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/traefik/traefik](https://github.com/traefik/traefik) |
| Source record ids | github_search_go-24cde77bd40b45 |
...
For a systems engineer, traefik/traefik belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:20:07Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-24cde77bd40b45` from `github_search_go` as `registry_expansion`
