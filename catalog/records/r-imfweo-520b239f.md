...
<!-- canonical: https://cran.r-project.org/web/packages/imfweo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/imfweo/index.html](https://cran.r-project.org/web/packages/imfweo/index.html) |
| Source record ids | cran_packages_by_date-ac1c335222f906 |
...
For a systems engineer, imfweo belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-24 16:20:27 UTC | [https://cran.r-project.org/web/packages/imfweo/DESCRIPTION](https://cran.r-project.org/web/packages/imfweo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/imfweo/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ac1c335222f906` from `cran_packages_by_date` as `registry_expansion`
