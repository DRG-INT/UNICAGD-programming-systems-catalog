...
<!-- canonical: https://github.com/aradfarahani/awesome-geophysics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aradfarahani/awesome-geophysics](https://github.com/aradfarahani/awesome-geophysics) |
| Source record ids | github_search_electromagnetoscopes-51d07bfa7a6740 |

## System Engineer Summary

Awesome Geophysics is a community-curated resource offering essential tools, datasets, and
educational materials for geophysical exploration. It’s designed to empower students, researchers,
and professionals to analyze data, model Earth processes, and stay connected with the latest
industry trends.

## Operational Role

For a systems engineer, aradfarahani/awesome-geophysics belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-02T03:32:39Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-51d07bfa7a6740` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ErniW/Arduino-IMU-and-AHRS-tests | Testing Framework | [open](electromagnetoscopes-erniw-arduino-imu-and-ahrs-tests-6026cf9d.md) |
