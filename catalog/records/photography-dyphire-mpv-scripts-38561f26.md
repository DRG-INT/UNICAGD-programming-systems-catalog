...
<!-- canonical: https://github.com/dyphire/mpv-scripts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dyphire/mpv-scripts](https://github.com/dyphire/mpv-scripts) |
| Source record ids | github_search_photography-29ef5e2259ee8b |

## System Engineer Summary

dyphire/mpv-scripts is tracked as a library record in the Photography branch. The source did not
...
For a systems engineer, dyphire/mpv-scripts belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T07:06:53Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-29ef5e2259ee8b` from `github_search_photography` as `registry_expansion`
