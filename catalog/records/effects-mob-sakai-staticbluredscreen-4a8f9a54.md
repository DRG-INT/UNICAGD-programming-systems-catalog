...
<!-- canonical: https://github.com/mob-sakai/StaticBluredScreen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mob-sakai/StaticBluredScreen](https://github.com/mob-sakai/StaticBluredScreen) |
| Source record ids | github_search_effects-5faee2bd8eaadc |
...
For a systems engineer, mob-sakai/StaticBluredScreen belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-03T11:17:11Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5faee2bd8eaadc` from `github_search_effects` as `registry_expansion`
