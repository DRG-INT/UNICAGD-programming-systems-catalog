...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3benchmark/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3benchmark/index.html](https://cran.r-project.org/web/packages/mlr3benchmark/index.html) |
| Source record ids | cran_packages_by_date-05ab132a56bc78 |
...
For a systems engineer, mlr3benchmark belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-08-21 09:40:02 UTC | [https://cran.r-project.org/web/packages/mlr3benchmark/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3benchmark/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3benchmark/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-05ab132a56bc78` from `cran_packages_by_date` as `registry_expansion`
