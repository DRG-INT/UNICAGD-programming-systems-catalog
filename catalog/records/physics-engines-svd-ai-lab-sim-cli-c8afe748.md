...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/svd-ai-lab/sim-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/svd-ai-lab/sim-cli](https://github.com/svd-ai-lab/sim-cli) |
| Source record ids | github_search_physics_engines-21f54099d06efb |

## System Engineer Summary

Turn existing CAE files into structured text an agent can use — COMSOL, Abaqus, Fluent, HFSS,
Icepak, FloTHERM — plus solver detection, script linting, and live solver sessions. Strong coverage
for electronics thermal and advanced packaging.

## Operational Role

For a systems engineer, svd-ai-lab/sim-cli belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T02:13:39Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-21f54099d06efb` from `github_search_physics_engines` as `registry_expansion`
