...
<!-- canonical: https://github.com/charlessolar/eShopOnContainersDDD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/charlessolar/eShopOnContainersDDD](https://github.com/charlessolar/eShopOnContainersDDD) |
| Source record ids | github_search_pattern_language-73e138e78c0051 |
...
For a systems engineer, charlessolar/eShopOnContainersDDD belongs in the Pattern language inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-04T00:19:52Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-73e138e78c0051` from `github_search_pattern_language` as `registry_expansion`
