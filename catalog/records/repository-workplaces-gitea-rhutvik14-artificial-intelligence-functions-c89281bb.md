# Gitea: rhutvik14/Artificial-intelligence-Functions
...
<!-- canonical: https://gitea.com/rhutvik14/Artificial-intelligence-Functions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/rhutvik14/Artificial-intelligence-Functions](https://gitea.com/rhutvik14/Artificial-intelligence-Functions) |
| Source record ids | gitea_repositories_api-6de045c964171a |
...
For a systems engineer, Gitea: rhutvik14/Artificial-intelligence-Functions belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-29T07:01:21Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6de045c964171a` from `gitea_repositories_api` as `registry_expansion`
