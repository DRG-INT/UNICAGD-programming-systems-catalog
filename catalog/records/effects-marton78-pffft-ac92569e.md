...
| Source record ids | github_search_effects-dfa7f078ff3f0e |
...
For a systems engineer, marton78/pffft belongs in the Effects inventory as part of language tooling,
...
- `github_search_effects-dfa7f078ff3f0e` from `github_search_effects` as `registry_expansion`
