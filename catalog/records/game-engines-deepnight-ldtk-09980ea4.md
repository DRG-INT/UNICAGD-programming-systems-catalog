...
<!-- canonical: https://github.com/deepnight/ldtk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deepnight/ldtk](https://github.com/deepnight/ldtk) |
| Source record ids | github_search_game_engines-2c0eb4196a8d1c |
...
For a systems engineer, deepnight/ldtk belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-12T13:55:51Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-2c0eb4196a8d1c` from `github_search_game_engines` as `registry_expansion`
