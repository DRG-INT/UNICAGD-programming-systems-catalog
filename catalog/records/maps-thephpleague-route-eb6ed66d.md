...
<!-- canonical: https://github.com/thephpleague/route -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thephpleague/route](https://github.com/thephpleague/route) |
| Source record ids | github_search_maps-bb9e446abcc439 |

## System Engineer Summary

Fast PSR-7 based routing and dispatch component including PSR-15 middleware, built on top of
FastRoute.

## Operational Role

For a systems engineer, thephpleague/route belongs in the Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T08:52:02Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-bb9e446abcc439` from `github_search_maps` as `registry_expansion`
