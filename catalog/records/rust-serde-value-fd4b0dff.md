...
<!-- canonical: https://crates.io/crates/serde-value -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde-value](https://crates.io/crates/serde-value) |
| Source record ids | crates_io-0533561225c9fb |
...
For a systems engineer, serde-value belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2020-07-17T18:20:27.889805Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-0533561225c9fb` from `crates_io` as `registry_expansion`
