...
<!-- canonical: https://luarocks.org/modules/frityet/easy-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/frityet/easy-http](https://luarocks.org/modules/frityet/easy-http) |
| Source record ids | luarocks_root_manifest-190294987a743d |
...
For a systems engineer, easy-http belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-190294987a743d` from `luarocks_root_manifest` as `registry_expansion`
