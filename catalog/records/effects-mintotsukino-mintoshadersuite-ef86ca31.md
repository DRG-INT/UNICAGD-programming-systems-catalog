...
<!-- canonical: https://github.com/MintoTsukino/MintoShaderSuite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MintoTsukino/MintoShaderSuite](https://github.com/MintoTsukino/MintoShaderSuite) |
| Source record ids | github_search_effects-fd03e02dd4ee9d |

## System Engineer Summary

Lightweight post-processing shader suite for RPG Maker MZ (Bloom / Vignette / Fog)

## Operational Role

For a systems engineer, MintoTsukino/MintoShaderSuite belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2025-10-23T21:18:21Z | [https://api.github.com/repos/MintoTsukino/MintoShaderSuite/releases/latest](https://api.github.com/repos/MintoTsukino/MintoShaderSuite/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/MintoTsukino/MintoShaderSuite/releases/latest` at `2026-09-01T09:23:12+00:00`.
...
- `github_search_effects-fd03e02dd4ee9d` from `github_search_effects` as `registry_expansion`
