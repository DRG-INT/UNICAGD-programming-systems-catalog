...
<!-- canonical: https://github.com/hitchao/Jvedio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hitchao/Jvedio](https://github.com/hitchao/Jvedio) |
| Source record ids | github_search_video-9fadc32aee3e67 |

## System Engineer Summary

Jvedio 是本地视频管理软件，支持扫描本地视频并导入软件，建立视频库， 提取出视频的 唯一识别码，自动分类视频， 添加标签管理视频，使用人工智能识别演员，支持翻译信息， 基于 FFmpeg
截取视频图片，Window 桌面端流畅美观的应用软件

## Operational Role

For a systems engineer, hitchao/Jvedio belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-18T14:43:43Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-9fadc32aee3e67` from `github_search_video` as `registry_expansion`
