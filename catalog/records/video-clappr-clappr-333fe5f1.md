...
| Canonical URL | [https://github.com/clappr/clappr](https://github.com/clappr/clappr) |
| Source record ids | github_search_video-3ffb9fa65146a7 |
...
For a systems engineer, clappr/clappr belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | @clappr/player@0.14.5 | 2026-08-30T21:13:26Z | [https://api.github.com/repos/clappr/clappr/releases/latest](https://api.github.com/repos/clappr/clappr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/clappr/clappr/releases/latest` at `2026-09-01T09:23:22+00:00`.
...
- `github_search_video-3ffb9fa65146a7` from `github_search_video` as `registry_expansion`
