...
<!-- canonical: https://github.com/Yalantis/DisplaySwitcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Yalantis/DisplaySwitcher](https://github.com/Yalantis/DisplaySwitcher) |
| Source record ids | github_search_cocoa-e5f994f4575dac |
...
For a systems engineer, Yalantis/DisplaySwitcher belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-15T14:13:46Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-e5f994f4575dac` from `github_search_cocoa` as `registry_expansion`
