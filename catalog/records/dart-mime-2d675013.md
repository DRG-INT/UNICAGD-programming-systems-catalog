...
<!-- canonical: https://pub.dev/packages/mime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mime](https://pub.dev/packages/mime) |
| Source record ids | pub_dev-45fd69037837c5 |

## System Engineer Summary

Utilities for handling media (MIME) types, including determining a type from a file extension and
file contents.

## Operational Role

For a systems engineer, mime belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-28T20:42:27.296992Z | [https://pub.dev/api/packages/mime](https://pub.dev/api/packages/mime) |  |
| preview | known | 1.0.0-nullsafety.0 | 2020-12-08T21:24:14.773412Z | [https://pub.dev/api/packages/mime](https://pub.dev/api/packages/mime) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mime` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-45fd69037837c5` from `pub_dev` as `registry_expansion`
