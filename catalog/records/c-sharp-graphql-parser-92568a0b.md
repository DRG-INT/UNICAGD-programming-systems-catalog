...
<!-- canonical: https://www.nuget.org/packages/GraphQL-Parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/GraphQL-Parser](https://www.nuget.org/packages/GraphQL-Parser) |
| Source record ids | nuget_search-c43888c74bf1bf |
...
For a systems engineer, GraphQL-Parser belongs in the C-Sharp inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.5.1 | 2026-02-02T08:19:55.693+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql-parser/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql-parser/index.json) |  |
| preview | known | 3.1.0-preview-39 | 2019-03-21T03:16:30.91+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql-parser/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql-parser/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; https://www.nuget.org/packages/GraphQL-Parser/9.5.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/graphql-parser/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-c43888c74bf1bf` from `nuget_search` as `registry_expansion`
