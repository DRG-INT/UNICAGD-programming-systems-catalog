...
<!-- canonical: https://cran.r-project.org/web/packages/rgoogleads/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rgoogleads/index.html](https://cran.r-project.org/web/packages/rgoogleads/index.html) |
| Source record ids | cran_packages_by_date-f329b683f8e260 |
...
For a systems engineer, rgoogleads belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-08-25 10:40:02 UTC | [https://cran.r-project.org/web/packages/rgoogleads/DESCRIPTION](https://cran.r-project.org/web/packages/rgoogleads/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rgoogleads/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f329b683f8e260` from `cran_packages_by_date` as `registry_expansion`
