...
<!-- canonical: https://cran.r-project.org/web/packages/BayesURTrend/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesURTrend/index.html](https://cran.r-project.org/web/packages/BayesURTrend/index.html) |
| Source record ids | cran_packages_by_date-5b710638602972 |
...
For a systems engineer, BayesURTrend belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 07:00:02 UTC | [https://cran.r-project.org/web/packages/BayesURTrend/DESCRIPTION](https://cran.r-project.org/web/packages/BayesURTrend/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesURTrend/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5b710638602972` from `cran_packages_by_date` as `registry_expansion`
