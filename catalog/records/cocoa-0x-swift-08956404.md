...
<!-- canonical: https://cocoapods.org/pods/0x.swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/0x.swift](https://cocoapods.org/pods/0x.swift) |
| Source record ids | cocoapods_cdn-5c0eb8c03187e0 |
...
For a systems engineer, 0x.swift belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2023-04-08 14:13:20 UTC | [https://trunk.cocoapods.org/api/v1/pods/0x.swift](https://trunk.cocoapods.org/api/v1/pods/0x.swift) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/0x.swift` at `2026-09-01T07:21:28+00:00`.
...
- `cocoapods_cdn-5c0eb8c03187e0` from `cocoapods_cdn` as `registry_expansion`
