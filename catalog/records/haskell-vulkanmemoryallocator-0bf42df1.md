...
<!-- canonical: https://hackage.haskell.org/package/VulkanMemoryAllocator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/VulkanMemoryAllocator](https://hackage.haskell.org/package/VulkanMemoryAllocator) |
| Source record ids | hackage_top_downloads-0e01ae6edcf0ba |
...
For a systems engineer, VulkanMemoryAllocator belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1.0 | 2026-06-21T20:32:26Z | [https://hackage.haskell.org/package/VulkanMemoryAllocator](https://hackage.haskell.org/package/VulkanMemoryAllocator) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/VulkanMemoryAllocator](https://hackage.haskell.org/package/VulkanMemoryAllocator) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/VulkanMemoryAllocator` at `2026-09-01T14:24:37+00:00`.
...
- `hackage_top_downloads-0e01ae6edcf0ba` from `hackage_top_downloads` as `registry_expansion`
