...
<!-- canonical: https://hackage.haskell.org/package/elynx-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/elynx-tools](https://hackage.haskell.org/package/elynx-tools) |
| Source record ids | hackage_top_downloads-3a797a74094046 |
...
For a systems engineer, elynx-tools belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.0 | 2025-08-11T07:21:51Z | [https://hackage.haskell.org/package/elynx-tools](https://hackage.haskell.org/package/elynx-tools) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/elynx-tools` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-3a797a74094046` from `hackage_top_downloads` as `registry_expansion`
