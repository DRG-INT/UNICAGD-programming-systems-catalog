...
<!-- canonical: https://hackage.haskell.org/package/git-repair -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/git-repair](https://hackage.haskell.org/package/git-repair) |
| Source record ids | hackage_top_downloads-c95e810f39078e |
...
For a systems engineer, git-repair belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.20230814 | 2023-08-14T16:32:10Z | [https://hackage.haskell.org/package/git-repair](https://hackage.haskell.org/package/git-repair) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/git-repair` at `2026-09-11T00:31:22+00:00`.
...
- `hackage_top_downloads-c95e810f39078e` from `hackage_top_downloads` as `registry_expansion`
