...
<!-- canonical: https://hackage.haskell.org/package/mwc-random -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mwc-random](https://hackage.haskell.org/package/mwc-random) |
| Source record ids | hackage_top_downloads-c19eb65d355386 |
...
For a systems engineer, mwc-random belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.3.0 | 2025-12-30T11:17:36Z | [https://hackage.haskell.org/package/mwc-random](https://hackage.haskell.org/package/mwc-random) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mwc-random` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-c19eb65d355386` from `hackage_top_downloads` as `registry_expansion`
