...
<!-- canonical: https://github.com/wargio/r2dec-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wargio/r2dec-js](https://github.com/wargio/r2dec-js) |
| Source record ids | github_search_assembly-f3715dbeb300ae |

## System Engineer Summary

r2dec-js is a JavaScript-based decompiler that converts assembly code into pseudo-C. It aids users
in understanding assembly by providing readable high-level explanations, making low-level
programming more accessible and facilitating debugging across diverse hardware platforms.

## Operational Role

For a systems engineer, wargio/r2dec-js belongs in the Assembly inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T18:36:14Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_assembly-f3715dbeb300ae` from `github_search_assembly` as `registry_expansion`
