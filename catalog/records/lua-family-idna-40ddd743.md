...
| Canonical URL | [https://luarocks.org/modules/mah0x211/idna](https://luarocks.org/modules/mah0x211/idna) |
| Source record ids | luarocks_root_manifest-0d2af4979be926 |

## System Engineer Summary

idna is tracked as a ffi bindings record in the Lua family branch. The source did not provide a long
...
For a systems engineer, idna belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-0d2af4979be926` from `luarocks_root_manifest` as `registry_expansion`
