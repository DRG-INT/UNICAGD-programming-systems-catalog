...
<!-- canonical: https://github.com/JuliaRegistries/General -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General](https://github.com/JuliaRegistries/General) |
| Source record ids | curated_repository_workplace_routes-5fd96fedce9a3f |

## System Engineer Summary

Official Julia General package registry source route.

## Operational Role

For a systems engineer, Julia General Registry Route belongs in the Repository Workplaces inventory
...
- `curated_repository_workplace_routes-5fd96fedce9a3f` from `curated_repository_workplace_routes` as `registry_expansion`
