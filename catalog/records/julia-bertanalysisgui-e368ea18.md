...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Static Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/static-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BERTAnalysisGUI](https://github.com/JuliaRegistries/General/tree/master/B/BERTAnalysisGUI) |
| Source record ids | julia_general-29d981f0e5b089 |

## System Engineer Summary

Julia package registered in General at B/BERTAnalysisGUI.

## Operational Role

For a systems engineer, BERTAnalysisGUI belongs in the Julia inventory as part of defect discovery,
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractanalysis-4b7af24c.md) |
| ADRIAanalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-adriaanalysis-4c6519a3.md) |
| AlgorithmAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-algorithmanalysis-817eac37.md) |
| AnalysisOfVariance | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-analysisofvariance-fbd4c33c.md) |
| ApproximationAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-approximationanalysis-27d10d98.md) |
| BinningAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-binninganalysis-3ca2a97d.md) |
| CalibrationAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-calibrationanalysis-77e9646a.md) |
| ChemistryQuantitativeAnalysis | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chemistryquantitativeanalysis-81b528a6.md) |
