...
<!-- canonical: https://hackage.haskell.org/package/tzdata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tzdata](https://hackage.haskell.org/package/tzdata) |
| Source record ids | hackage_top_downloads-4ddbe4c546a591 |
...
For a systems engineer, tzdata belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.20260708.0 | 2026-07-10T02:09:17Z | [https://hackage.haskell.org/package/tzdata](https://hackage.haskell.org/package/tzdata) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tzdata` at `2026-09-01T14:24:35+00:00`.
...
- `hackage_top_downloads-4ddbe4c546a591` from `hackage_top_downloads` as `registry_expansion`
