...
<!-- canonical: https://cran.r-project.org/web/packages/primarycensored/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/primarycensored/index.html](https://cran.r-project.org/web/packages/primarycensored/index.html) |
| Source record ids | cran_packages_by_date-af50d52cb687d7 |
...
For a systems engineer, primarycensored belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.2 | 2026-09-11 03:00:02 UTC | [https://cran.r-project.org/web/packages/primarycensored/DESCRIPTION](https://cran.r-project.org/web/packages/primarycensored/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/primarycensored/DESCRIPTION` at `2026-09-11T04:21:25+00:00`.
...
- `cran_packages_by_date-af50d52cb687d7` from `cran_packages_by_date` as `registry_expansion`
