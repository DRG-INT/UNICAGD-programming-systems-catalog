...
<!-- canonical: https://github.com/scipipe/scipipe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scipipe/scipipe](https://github.com/scipipe/scipipe) |
| Source record ids | github_search_engines-d133e8ee922b3e |
...
For a systems engineer, scipipe/scipipe belongs in the Engines inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-14T01:44:15Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d133e8ee922b3e` from `github_search_engines` as `registry_expansion`
...
| nextflow-io/nextflow | Package Manager | [open](engines-nextflow-io-nextflow-341c952c.md) |
