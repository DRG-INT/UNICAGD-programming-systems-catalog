...
<!-- canonical: https://github.com/apache/linkis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/linkis](https://github.com/apache/linkis) |
| Source record ids | github_search_engines-f8213a28c872a7 |

## System Engineer Summary

Apache Linkis builds a computation middleware layer to facilitate connection, governance and
orchestration between the upper applications and the underlying data engines.

## Operational Role

For a systems engineer, apache/linkis belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T06:25:04Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-f8213a28c872a7` from `github_search_engines` as `registry_expansion`
