...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/astropy/astropy](https://github.com/astropy/astropy) |
| Source record ids | curated_language_routes-4b6961826d98c1 |

## System Engineer Summary

Astronomy Python library for coordinates, time, units, FITS, WCS, tables, cosmology, and observatory
data.

## Operational Role

For a systems engineer, Astropy belongs in the Space Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v8.0.1 | 2026-07-08T13:01:37Z | [https://api.github.com/repos/astropy/astropy/releases/latest](https://api.github.com/repos/astropy/astropy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/astropy/astropy/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `curated_language_routes-4b6961826d98c1` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Skyfield | Math Numeric Scientific | [open](space-maps-skyfield-ea8ff95c.md) |
