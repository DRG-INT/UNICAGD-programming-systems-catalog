...
<!-- canonical: https://github.com/WHU-Sigma/HyperSIGMA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WHU-Sigma/HyperSIGMA](https://github.com/WHU-Sigma/HyperSIGMA) |
| Source record ids | github_search_radars-8170e8c56dc0ed |

## System Engineer Summary

The official repo for TPAMI'25 "HyperSIGMA: Hyperspectral Intelligence Comprehension Foundation
Model"

## Operational Role

For a systems engineer, WHU-Sigma/HyperSIGMA belongs in the Radars inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-20T03:24:09Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-8170e8c56dc0ed` from `github_search_radars` as `registry_expansion`
