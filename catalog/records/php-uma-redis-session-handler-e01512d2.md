...
<!-- canonical: https://packagist.org/packages/uma/redis-session-handler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/uma/redis-session-handler](https://packagist.org/packages/uma/redis-session-handler) |
| Source record ids | packagist_search-73bc1342e2bb35 |
...
For a systems engineer, uma/redis-session-handler belongs in the PHP inventory as part of state
...
- `packagist_search-73bc1342e2bb35` from `packagist_search` as `registry_expansion`
