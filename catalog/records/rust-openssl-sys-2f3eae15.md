...
<!-- canonical: https://crates.io/crates/openssl-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/openssl-sys](https://crates.io/crates/openssl-sys) |
| Source record ids | crates_io-20ac051e3079ba |

## System Engineer Summary

openssl-sys is tracked as a ffi bindings record in the Rust branch. The source did not provide a
...
For a systems engineer, openssl-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.117 | 2026-06-12T18:11:16.432719Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-20ac051e3079ba` from `crates_io` as `registry_expansion`
