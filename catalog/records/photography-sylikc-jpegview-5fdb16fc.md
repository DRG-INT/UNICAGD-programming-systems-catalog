...
<!-- canonical: https://github.com/sylikc/jpegview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sylikc/jpegview](https://github.com/sylikc/jpegview) |
| Source record ids | github_search_photography-44ca75db3e6bb5 |

## System Engineer Summary

Fork of JPEGView by David Kleiner - fast and highly configurable viewer/editor for JPEG, BMP, PNG,
WEBP, TGA, GIF and TIFF images with a minimal GUI. Basic on-the-fly image processing is provided -
allowing adjusting typical parameters as sharpness, color balance, rotation, perspective, contrast
and local under-/overexposure.

## Operational Role

For a systems engineer, sylikc/jpegview belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-09T03:36:52Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-44ca75db3e6bb5` from `github_search_photography` as `registry_expansion`
