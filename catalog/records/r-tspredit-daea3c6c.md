...
<!-- canonical: https://cran.r-project.org/web/packages/tspredit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tspredit/index.html](https://cran.r-project.org/web/packages/tspredit/index.html) |
| Source record ids | cran_packages_by_date-3d6d2dd835232b |
...
For a systems engineer, tspredit belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.717 | 2026-09-09 05:20:02 UTC | [https://cran.r-project.org/web/packages/tspredit/DESCRIPTION](https://cran.r-project.org/web/packages/tspredit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tspredit/DESCRIPTION` at `2026-09-09T06:26:10+00:00`.
...
- `cran_packages_by_date-3d6d2dd835232b` from `cran_packages_by_date` as `registry_expansion`
