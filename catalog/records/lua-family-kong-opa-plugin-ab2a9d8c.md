...
| Canonical URL | [https://luarocks.org/modules/jtbonhomme/kong-opa-plugin](https://luarocks.org/modules/jtbonhomme/kong-opa-plugin) |
| Source record ids | luarocks_root_manifest-bc0ab0626bf66a |

## System Engineer Summary

Integrate the Open Policy Agent (OPA) with Kong API Gateway for API access management, fork of opa
contrib plugin

## Operational Role

For a systems engineer, kong-opa-plugin belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bc0ab0626bf66a` from `luarocks_root_manifest` as `registry_expansion`
