...
<!-- canonical: https://crates.io/crates/crossbeam -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.5 | 2026-09-05T17:47:37.499898Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-05T18:20:34+00:00`.
...
- `crates_io-932e6ecefd2f46` from `crates_io` as `registry_expansion`
