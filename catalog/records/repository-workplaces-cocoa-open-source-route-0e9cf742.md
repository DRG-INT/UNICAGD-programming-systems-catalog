...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://opensource.apple.com/ -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| official_repository_workplace_route | curated-extension-derived | 2026-09-05 | `{"kind": "official_repository_workplace_route", "retrieved": "2026-09-05", "status": "curated-extension-derived"}` |
...
| Name | Category | Page |
| --- | --- | --- |
| Alpine aports | Registry Repository | [open](repository-workplaces-alpine-aports-b9c405de.md) |
| Alpine Linux Packages | Registry Repository | [open](repository-workplaces-alpine-linux-packages-8e21f82a.md) |
| Apache Source Repositories | Registry Repository | [open](repository-workplaces-apache-source-repositories-bf81c8cb.md) |
| Apache Subversion Repository | Registry Repository | [open](repository-workplaces-apache-subversion-repository-2d6c9af4.md) |
| Codeberg | Registry Repository | [open](repository-workplaces-codeberg-5d24942a.md) |
| Dart SDK Source Route | Registry Repository | [open](repository-workplaces-dart-sdk-source-route-368ce761.md) |
| Forgejo | Registry Repository | [open](repository-workplaces-forgejo-bd307bad.md) |
| GHC GitLab Route | Registry Repository | [open](repository-workplaces-ghc-gitlab-route-778f3f6c.md) |
