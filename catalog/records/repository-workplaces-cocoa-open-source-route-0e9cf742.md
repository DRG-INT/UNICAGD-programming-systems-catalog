# Cocoa Open Source Route

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Repository Workplaces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/repository-workplaces.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://opensource.apple.com/](https://opensource.apple.com/) |
| Source record ids | curated_repository_workplace_routes-2eefb0aa8dc6c2 |

## System Engineer Summary

Apple open source release route for Darwin and Apple-distributed open source components.

## Operational Role

For a systems engineer, Cocoa Open Source Route belongs in the Repository Workplaces inventory as
part of ecosystem capability mapping, dependency review, release awareness, and operational fit
assessment.
...
| --- | --- | --- | --- | --- | --- |
| stable | unknown |  |  | unknown | official_workplace_route_requires_source_specific_release_lookup |
| preview/nightly | unknown |  |  | unknown | official_workplace_route_requires_source_specific_preview_lookup |
...
- Stable release is unknown because `official_workplace_route_requires_source_specific_release_lookup`.
- Preview/nightly metadata is unknown because `official_workplace_route_requires_source_specific_preview_lookup`.

## Provenance

| Kind | Status | Date | Detail |
| --- | --- | --- | --- |
| official_repository_workplace_route | curated-extension-derived | 2026-09-01 | `{"kind": "official_repository_workplace_route", "retrieved": "2026-09-01", "status": "curated-extension-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `curated_repository_workplace_routes-2eefb0aa8dc6c2` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Alpine aports | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-alpine-aports-b9c405de.md) |
| Alpine Linux Packages | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-alpine-linux-packages-8e21f82a.md) |
| Apache Source Repositories | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-apache-source-repositories-bf81c8cb.md) |
| Apache Subversion Repository | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-apache-subversion-repository-2d6c9af4.md) |
| Codeberg | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-codeberg-5d24942a.md) |
| Dart SDK Source Route | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-dart-sdk-source-route-368ce761.md) |
| Forgejo | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-forgejo-bd307bad.md) |
| GHC GitLab Route | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-ghc-gitlab-route-778f3f6c.md) |
