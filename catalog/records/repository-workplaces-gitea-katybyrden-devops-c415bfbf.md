...
<!-- canonical: https://gitea.com/katyByrden/Devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/katyByrden/Devops](https://gitea.com/katyByrden/Devops) |
| Source record ids | gitea_repositories_api-0861871ec70a0e |
...
For a systems engineer, Gitea: katyByrden/Devops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-10T06:49:15Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-0861871ec70a0e` from `gitea_repositories_api` as `registry_expansion`
