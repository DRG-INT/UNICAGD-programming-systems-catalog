...
| Canonical URL | [https://wasi.dev/](https://wasi.dev/) |
| Source record ids | awesome_list-79c2fbb437be10 |

## System Engineer Summary

WASI - The WebAssembly System Interface is tracked as a library record in the WebAssembly branch.
...
For a systems engineer, WASI - The WebAssembly System Interface belongs in the WebAssembly inventory
...
- `awesome_list-79c2fbb437be10` from `awesome_list` as `registry_expansion`
