...
<!-- canonical: https://cran.r-project.org/web/packages/treestats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/treestats/index.html](https://cran.r-project.org/web/packages/treestats/index.html) |
| Source record ids | cran_packages_by_date-942fbdf5258020 |
...
For a systems engineer, treestats belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.71.13 | 2026-08-24 12:00:02 UTC | [https://cran.r-project.org/web/packages/treestats/DESCRIPTION](https://cran.r-project.org/web/packages/treestats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/treestats/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-942fbdf5258020` from `cran_packages_by_date` as `registry_expansion`
