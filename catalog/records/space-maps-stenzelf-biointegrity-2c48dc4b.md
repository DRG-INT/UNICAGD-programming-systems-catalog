...
<!-- canonical: https://github.com/stenzelf/biointegrity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stenzelf/biointegrity](https://github.com/stenzelf/biointegrity) |
| Source record ids | github_search_space_maps-657b2a87c1db0d |

## System Engineer Summary

View and download maps and timelines of HANPP and EcoRisk as planetary boundary control variables

## Operational Role

For a systems engineer, stenzelf/biointegrity belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T07:53:19Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-657b2a87c1db0d` from `github_search_space_maps` as `registry_expansion`
