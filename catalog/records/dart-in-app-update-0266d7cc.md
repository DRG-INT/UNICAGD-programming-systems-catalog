...
<!-- canonical: https://pub.dev/packages/in_app_update -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/in_app_update](https://pub.dev/packages/in_app_update) |
| Source record ids | pub_dev-17128459a3758f |
...
For a systems engineer, in_app_update belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-07-04T05:14:11.242560Z | [https://pub.dev/api/packages/in_app_update](https://pub.dev/api/packages/in_app_update) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/in_app_update` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-17128459a3758f` from `pub_dev` as `registry_expansion`
...
| ffi | Ffi Bindings | [open](dart-ffi-db803997.md) |
