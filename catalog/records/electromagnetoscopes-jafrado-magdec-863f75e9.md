...
<!-- canonical: https://github.com/jafrado/magdec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jafrado/magdec](https://github.com/jafrado/magdec) |
| Source record ids | github_search_electromagnetoscopes-6305ae12c84e13 |
...
For a systems engineer, jafrado/magdec belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-15T00:39:45Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6305ae12c84e13` from `github_search_electromagnetoscopes` as `registry_expansion`
