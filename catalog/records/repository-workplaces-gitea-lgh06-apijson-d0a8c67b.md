...
<!-- canonical: https://gitea.com/lgh06/APIJSON -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/lgh06/APIJSON](https://gitea.com/lgh06/APIJSON) |
| Source record ids | gitea_repositories_api-6d725a656d9125 |

## System Engineer Summary

🏆 零代码、全功能、强安全 ORM 库 🚀 后端接口和文档零代码，前端(客户端) 定制返回 JSON 的数据和结构。 🏆 A JSON Transmission Protocol and an ORM
Library 🚀 provides APIs and Docs without writing any code.

## Operational Role

For a systems engineer, Gitea: lgh06/APIJSON belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-29T05:53:26Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6d725a656d9125` from `gitea_repositories_api` as `registry_expansion`
