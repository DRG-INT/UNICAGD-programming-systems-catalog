...
| Canonical URL | [https://crates.io/crates/structmeta-derive](https://crates.io/crates/structmeta-derive) |
| Source record ids | crates_io-3ec8ff83c7c099 |
...
For a systems engineer, structmeta-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-07-22T15:10:17.132025Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-3ec8ff83c7c099` from `crates_io` as `registry_expansion`
