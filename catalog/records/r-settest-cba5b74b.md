...
<!-- canonical: https://cran.r-project.org/web/packages/SetTest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SetTest/index.html](https://cran.r-project.org/web/packages/SetTest/index.html) |
| Source record ids | cran_packages_by_date-1fc6faf109e81d |
...
For a systems engineer, SetTest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-24 18:30:09 UTC | [https://cran.r-project.org/web/packages/SetTest/DESCRIPTION](https://cran.r-project.org/web/packages/SetTest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SetTest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1fc6faf109e81d` from `cran_packages_by_date` as `registry_expansion`
