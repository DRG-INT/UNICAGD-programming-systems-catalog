...
<!-- canonical: https://github.com/langgenius/dify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/langgenius/dify](https://github.com/langgenius/dify) |
| Source record ids | github_search_aims-203f5bd6aa1e2c |

## System Engineer Summary

Build Agentic workflows, RAG pipelines, with rich AI model and tool support on one collaborative
workspace. Deploy on cloud, VPC, or self-hosted, so teams move from prototype to production without
rebuilding the stack.

## Operational Role

For a systems engineer, langgenius/dify belongs in the "aim's" inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:13:12Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-203f5bd6aa1e2c` from `github_search_aims` as `registry_expansion`
