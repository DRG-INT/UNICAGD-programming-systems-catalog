...
<!-- canonical: https://cran.r-project.org/web/packages/bayesplot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayesplot/index.html](https://cran.r-project.org/web/packages/bayesplot/index.html) |
| Source record ids | cran_packages_by_date-b27715bde7f791 |
...
For a systems engineer, bayesplot belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.16.0 | 2026-08-25 07:00:09 UTC | [https://cran.r-project.org/web/packages/bayesplot/DESCRIPTION](https://cran.r-project.org/web/packages/bayesplot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayesplot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b27715bde7f791` from `cran_packages_by_date` as `registry_expansion`
