...
| Canonical URL | [https://www.openssh.com/specs.html](https://www.openssh.com/specs.html) |
| Source record ids | curated_language_routes-2faa88b8fdea36 |

## System Engineer Summary

OpenSSH protocol specification route for SSH transport, authentication, connection, and extensions.

## Operational Role

For a systems engineer, OpenSSH Protocol belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-2faa88b8fdea36` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| OpenSSL | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-openssl-58b5ebe4.md) |
