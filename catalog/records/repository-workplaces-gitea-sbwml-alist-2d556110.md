...
<!-- canonical: https://gitea.com/sbwml/alist -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/sbwml/alist](https://gitea.com/sbwml/alist) |
| Source record ids | gitea_repositories_api-1771632b41cafa |
...
For a systems engineer, Gitea: sbwml/alist belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-08T12:23:19Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-10 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "server", "retrieved": "2026-09-10", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-1771632b41cafa` from `gitea_repositories_api` as `registry_expansion`
