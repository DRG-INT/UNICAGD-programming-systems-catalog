...
| Canonical URL | [https://crates.io/crates/tauri-build](https://crates.io/crates/tauri-build) |
| Source record ids | crates_io-1854d296ffea18 |

## System Engineer Summary

build time code to pair with

## Operational Role

For a systems engineer, tauri-build belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.3 | 2026-06-30T21:04:55.953965Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-1854d296ffea18` from `crates_io` as `registry_expansion`
