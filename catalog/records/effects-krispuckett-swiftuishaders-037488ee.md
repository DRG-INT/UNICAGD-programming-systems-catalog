...
| Source record ids | github_search_effects-96cf05c99cbbf0 |
...
For a systems engineer, krispuckett/SwiftUIShaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-01T22:53:44Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-96cf05c99cbbf0` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Crowdrocker/WehttamSnaps-Niri | Documentation | [open](effects-crowdrocker-wehttamsnaps-niri-e0201a1d.md) |
