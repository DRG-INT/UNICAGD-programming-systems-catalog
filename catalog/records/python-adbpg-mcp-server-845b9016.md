...
<!-- canonical: https://pypi.org/project/adbpg-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adbpg-mcp-server/](https://pypi.org/project/adbpg-mcp-server/) |
| Source record ids | pypi_simple-7d3eeed9ceeca8 |

## System Engineer Summary

AnalyticDB PostgreSQL MCP Server serves as a universal interface between AI Agents and AnalyticDB
PostgreSQL databases. It enables seamless communication between AI Agents and AnalyticDB PostgreSQL,
helping AI Agents retrieve database metadata and execute SQL operations.

## Operational Role

For a systems engineer, adbpg-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-03-05T08:11:30.623067Z | [https://pypi.org/pypi/adbpg-mcp-server/json](https://pypi.org/pypi/adbpg-mcp-server/json) |  |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adbpg-mcp-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-7d3eeed9ceeca8` from `pypi_simple` as `registry_expansion`
