...
<!-- canonical: https://cran.r-project.org/web/packages/myTAI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/myTAI/index.html](https://cran.r-project.org/web/packages/myTAI/index.html) |
| Source record ids | cran_packages_by_date-14a57c068653e5 |
...
For a systems engineer, myTAI belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.7 | 2026-08-24 16:50:02 UTC | [https://cran.r-project.org/web/packages/myTAI/DESCRIPTION](https://cran.r-project.org/web/packages/myTAI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/myTAI/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-14a57c068653e5` from `cran_packages_by_date` as `registry_expansion`
