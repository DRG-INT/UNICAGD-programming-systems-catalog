...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/screenshot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/screenshot](https://pub.dev/packages/screenshot) |
| Source record ids | pub_dev-f99a1d7d5aa9cf |
...
For a systems engineer, screenshot belongs in the Dart inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-05-14T11:36:00.674625Z | [https://pub.dev/api/packages/screenshot](https://pub.dev/api/packages/screenshot) |  |
| preview | known | 1.0.0-nullsafety.1 | 2021-02-10T10:39:00.730104Z | [https://pub.dev/api/packages/screenshot](https://pub.dev/api/packages/screenshot) |  |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/screenshot` at `2026-09-02T00:28:56+00:00`.
...
- `pub_dev-f99a1d7d5aa9cf` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| built_value | Interpreter Runtime | [open](dart-built-value-97fbb3d3.md) |
| dart_frog | Interpreter Runtime | [open](dart-dart-frog-5b77c559.md) |
| jnigen | Interpreter Runtime | [open](dart-jnigen-8e59680d.md) |
| protobuf | Interpreter Runtime | [open](dart-protobuf-7bdc6c86.md) |
| sembast | Interpreter Runtime | [open](dart-sembast-fa8ed2b5.md) |
| sentry | Interpreter Runtime | [open](dart-sentry-27c4653e.md) |
| signals | Interpreter Runtime | [open](dart-signals-615e82a1.md) |
| socket_io_client | Interpreter Runtime | [open](dart-socket-io-client-86cc0b29.md) |
