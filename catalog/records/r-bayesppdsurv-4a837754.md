...
<!-- canonical: https://cran.r-project.org/web/packages/BayesPPDSurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesPPDSurv/index.html](https://cran.r-project.org/web/packages/BayesPPDSurv/index.html) |
| Source record ids | cran_packages_by_date-1f77e2d06f2b26 |
...
For a systems engineer, BayesPPDSurv belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-24 08:10:14 UTC | [https://cran.r-project.org/web/packages/BayesPPDSurv/DESCRIPTION](https://cran.r-project.org/web/packages/BayesPPDSurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesPPDSurv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1f77e2d06f2b26` from `cran_packages_by_date` as `registry_expansion`
