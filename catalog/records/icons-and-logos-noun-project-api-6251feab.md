...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Icons and Logos](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/icons-and-logos.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://api.thenounproject.com/](https://api.thenounproject.com/) |
| Source record ids | curated_language_routes-3ba5654fd8ad9a |

## System Engineer Summary

Icon search and asset API route for symbol discovery and product integrations.

## Operational Role

For a systems engineer, Noun Project API belongs in the Icons and Logos inventory as part of service
...
- `curated_language_routes-3ba5654fd8ad9a` from `curated_language_routes` as `registry_expansion`
