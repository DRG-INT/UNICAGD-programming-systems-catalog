...
<!-- canonical: https://github.com/ferranabello/Viperit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ferranabello/Viperit](https://github.com/ferranabello/Viperit) |
| Source record ids | awesome_list-f14c1919335354 |

## System Engineer Summary

Viper Framework for iOS. Develop an app following VIPER architecture in an easy way. Written and
tested in Swift.

## Operational Role

For a systems engineer, Viperit belongs in the Cocoa inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2021-09-15T10:33:08Z | [https://api.github.com/repos/ferranabello/Viperit/releases/latest](https://api.github.com/repos/ferranabello/Viperit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ferranabello/Viperit/releases/latest` at `2026-09-01T07:24:07+00:00`.
...
- `awesome_list-f14c1919335354` from `awesome_list` as `registry_expansion`
