...
<!-- canonical: https://github.com/serhii-londar/open-source-mac-os-apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/serhii-londar/open-source-mac-os-apps](https://github.com/serhii-londar/open-source-mac-os-apps) |
| Source record ids | awesome_list-a283afa7dd72f0 |
...
For a systems engineer, open-source-mac-os-apps belongs in the Swift inventory as part of ecosystem
...
- `awesome_list-a283afa7dd72f0` from `awesome_list` as `registry_expansion`
