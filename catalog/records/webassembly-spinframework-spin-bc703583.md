...
| Canonical URL | [https://github.com/spinframework/spin](https://github.com/spinframework/spin) |
| Source record ids | github_search_webassembly-0945da43a9e0f8 |

## System Engineer Summary

Spin is the open source developer tool for building and running serverless applications powered by
WebAssembly.

## Operational Role

For a systems engineer, spinframework/spin belongs in the WebAssembly inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.1.0 | 2026-08-26T17:03:14Z | [https://api.github.com/repos/spinframework/spin/releases/latest](https://api.github.com/repos/spinframework/spin/releases/latest) |  |
| preview | known | canary | 2026-08-31T19:48:50Z | [https://api.github.com/repos/spinframework/spin/releases?per_page=10](https://api.github.com/repos/spinframework/spin/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/spinframework/spin/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-0945da43a9e0f8` from `github_search_webassembly` as `registry_expansion`
