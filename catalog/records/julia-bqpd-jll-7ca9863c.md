...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/B/BQPD_jll](https://github.com/JuliaRegistries/General/tree/master/jll/B/BQPD_jll) |
| Source record ids | julia_general-fecc60c2077571 |

## System Engineer Summary

Julia package registered in General at jll/B/BQPD_jll.

## Operational Role

For a systems engineer, BQPD_jll belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/B/BQPD_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-fecc60c2077571` from `julia_general` as `registry_expansion`
