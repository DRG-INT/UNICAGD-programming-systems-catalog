...
<!-- canonical: https://github.com/openai/openai-agents-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openai/openai-agents-python](https://github.com/openai/openai-agents-python) |
| Source record ids | github_search_aims-22d3eab3a255b8 |
...
For a systems engineer, openai/openai-agents-python belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T00:50:20Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-22d3eab3a255b8` from `github_search_aims` as `registry_expansion`
