...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-resty-session](https://luarocks.org/modules/membphis/api7-lua-resty-session) |
| Source record ids | luarocks_root_manifest-bd70c4a85dd8ce |
...
For a systems engineer, api7-lua-resty-session belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-bd70c4a85dd8ce` from `luarocks_root_manifest` as `registry_expansion`
