...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BitcoinRPC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BitcoinRPC](https://github.com/JuliaRegistries/General/tree/master/B/BitcoinRPC) |
| Source record ids | julia_general-39effbf8ddeb47 |

## System Engineer Summary

Julia package registered in General at B/BitcoinRPC.

## Operational Role

For a systems engineer, BitcoinRPC belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BitcoinRPC", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-39effbf8ddeb47` from `julia_general` as `registry_expansion`
