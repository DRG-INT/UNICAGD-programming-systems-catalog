...
<!-- canonical: https://pub.dev/packages/google_maps_flutter_web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_maps_flutter_web](https://pub.dev/packages/google_maps_flutter_web) |
| Source record ids | pub_dev-d474a4c09b238f |
...
For a systems engineer, google_maps_flutter_web belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3+1 | 2026-09-08T23:17:49.579362Z | [https://pub.dev/api/packages/google_maps_flutter_web](https://pub.dev/api/packages/google_maps_flutter_web) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_maps_flutter_web` at `2026-09-09T00:31:18+00:00`.
...
- `pub_dev-d474a4c09b238f` from `pub_dev` as `registry_expansion`
