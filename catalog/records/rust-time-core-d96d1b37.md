...
<!-- canonical: https://crates.io/crates/time-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/time-core](https://crates.io/crates/time-core) |
| Source record ids | crates_io-cfe8a6a6e229f6 |
...
For a systems engineer, time-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-06-30T08:52:47.846641Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-cfe8a6a6e229f6` from `crates_io` as `registry_expansion`
