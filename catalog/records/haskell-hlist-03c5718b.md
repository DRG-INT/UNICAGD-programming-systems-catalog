...
<!-- canonical: https://hackage.haskell.org/package/HList -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HList](https://hackage.haskell.org/package/HList) |
| Source record ids | hackage_top_downloads-4720290a2d53d4 |
...
For a systems engineer, HList belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4.0 | 2025-02-20T22:47:59Z | [https://hackage.haskell.org/package/HList](https://hackage.haskell.org/package/HList) |  |
| candidate | partial | 0.5.0.0 |  | [https://hackage.haskell.org/package/HList](https://hackage.haskell.org/package/HList) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HList` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-4720290a2d53d4` from `hackage_top_downloads` as `registry_expansion`
