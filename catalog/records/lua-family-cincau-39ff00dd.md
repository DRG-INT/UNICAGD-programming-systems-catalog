...
<!-- canonical: https://luarocks.org/modules/lalawue/cincau -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lalawue/cincau](https://luarocks.org/modules/lalawue/cincau) |
| Source record ids | luarocks_root_manifest-4ca8a87a1be357 |
...
For a systems engineer, cincau belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-4ca8a87a1be357` from `luarocks_root_manifest` as `registry_expansion`
