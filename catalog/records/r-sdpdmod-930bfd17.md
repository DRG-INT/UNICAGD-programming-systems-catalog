...
<!-- canonical: https://cran.r-project.org/web/packages/SDPDmod/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SDPDmod/index.html](https://cran.r-project.org/web/packages/SDPDmod/index.html) |
| Source record ids | cran_packages_by_date-ba61b37625116e |
...
For a systems engineer, SDPDmod belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.8 | 2026-09-06 17:20:02 UTC | [https://cran.r-project.org/web/packages/SDPDmod/DESCRIPTION](https://cran.r-project.org/web/packages/SDPDmod/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SDPDmod/DESCRIPTION` at `2026-09-06T18:20:54+00:00`.
...
- `cran_packages_by_date-ba61b37625116e` from `cran_packages_by_date` as `registry_expansion`
