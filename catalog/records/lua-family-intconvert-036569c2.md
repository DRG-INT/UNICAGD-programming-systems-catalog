...
| Canonical URL | [https://luarocks.org/modules/iskolbin/intconvert](https://luarocks.org/modules/iskolbin/intconvert) |
| Source record ids | luarocks_root_manifest-079529eb2e8fe0 |

## System Engineer Summary

Pure Lua integer encoder/decoder

## Operational Role

For a systems engineer, intconvert belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-079529eb2e8fe0` from `luarocks_root_manifest` as `registry_expansion`
