...
<!-- canonical: https://cran.r-project.org/web/packages/IntegMultiReg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IntegMultiReg/index.html](https://cran.r-project.org/web/packages/IntegMultiReg/index.html) |
| Source record ids | cran_packages_by_date-7ac600cd79b08e |
...
For a systems engineer, IntegMultiReg belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-22 15:20:14 UTC | [https://cran.r-project.org/web/packages/IntegMultiReg/DESCRIPTION](https://cran.r-project.org/web/packages/IntegMultiReg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IntegMultiReg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7ac600cd79b08e` from `cran_packages_by_date` as `registry_expansion`
