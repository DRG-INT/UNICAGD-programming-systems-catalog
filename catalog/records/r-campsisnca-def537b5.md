...
<!-- canonical: https://cran.r-project.org/web/packages/campsisnca/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/campsisnca/index.html](https://cran.r-project.org/web/packages/campsisnca/index.html) |
| Source record ids | cran_packages_by_date-2449520a6795c3 |
...
For a systems engineer, campsisnca belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-09-15 12:00:10 UTC | [https://cran.r-project.org/web/packages/campsisnca/DESCRIPTION](https://cran.r-project.org/web/packages/campsisnca/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/campsisnca/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-2449520a6795c3` from `cran_packages_by_date` as `registry_expansion`
