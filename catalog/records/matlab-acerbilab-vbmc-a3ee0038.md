...
<!-- canonical: https://github.com/acerbilab/vbmc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acerbilab/vbmc](https://github.com/acerbilab/vbmc) |
| Source record ids | github_search_matlab-28c0497bfd1039 |
...
For a systems engineer, acerbilab/vbmc belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-03T11:17:08Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_matlab-28c0497bfd1039` from `github_search_matlab` as `registry_expansion`
