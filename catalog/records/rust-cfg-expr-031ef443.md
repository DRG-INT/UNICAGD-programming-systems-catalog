...
<!-- canonical: https://crates.io/crates/cfg-expr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cfg-expr](https://crates.io/crates/cfg-expr) |
| Source record ids | crates_io-09a6c4e6ae5868 |
...
For a systems engineer, cfg-expr belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.9 | 2026-08-22T08:55:06.181998Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-09a6c4e6ae5868` from `crates_io` as `registry_expansion`
