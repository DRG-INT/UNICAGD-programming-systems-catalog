...
<!-- canonical: https://pub.dev/packages/fleather -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fleather](https://pub.dev/packages/fleather) |
| Source record ids | pub_dev-998603d6e84013 |
...
For a systems engineer, fleather belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.28.0 | 2026-08-24T06:11:05.628229Z | [https://pub.dev/api/packages/fleather](https://pub.dev/api/packages/fleather) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fleather` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-998603d6e84013` from `pub_dev` as `registry_expansion`
