...
<!-- canonical: https://cran.r-project.org/web/packages/readnoaa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/readnoaa/index.html](https://cran.r-project.org/web/packages/readnoaa/index.html) |
| Source record ids | cran_packages_by_date-961384c87c164b |
...
For a systems engineer, readnoaa belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-09 09:40:02 UTC | [https://cran.r-project.org/web/packages/readnoaa/DESCRIPTION](https://cran.r-project.org/web/packages/readnoaa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/readnoaa/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-961384c87c164b` from `cran_packages_by_date` as `registry_expansion`
