...
<!-- canonical: https://github.com/Ghoulpachannel/Autodesk-CFD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ghoulpachannel/Autodesk-CFD](https://github.com/Ghoulpachannel/Autodesk-CFD) |
| Source record ids | github_search_physics_engines-99601a0deadfde |

## System Engineer Summary

Ghoulpachannel/Autodesk-CFD is tracked as a visualization gui record in the Physics Engines branch.
...
For a systems engineer, Ghoulpachannel/Autodesk-CFD belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T15:05:40Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-99601a0deadfde` from `github_search_physics_engines` as `registry_expansion`
