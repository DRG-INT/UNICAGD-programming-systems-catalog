...
<!-- canonical: https://cran.r-project.org/web/packages/agriPAM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/agriPAM/index.html](https://cran.r-project.org/web/packages/agriPAM/index.html) |
| Source record ids | cran_packages_by_date-8dfb73a8f3fd0a |
...
For a systems engineer, agriPAM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 09:30:09 UTC | [https://cran.r-project.org/web/packages/agriPAM/DESCRIPTION](https://cran.r-project.org/web/packages/agriPAM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/agriPAM/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-8dfb73a8f3fd0a` from `cran_packages_by_date` as `registry_expansion`
