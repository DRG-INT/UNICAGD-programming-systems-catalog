...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/test-framework-quickcheck2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/test-framework-quickcheck2](https://hackage.haskell.org/package/test-framework-quickcheck2) |
| Source record ids | hackage_top_downloads-beac8aa853d39c |

## System Engineer Summary

Hackage package with 63 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, test-framework-quickcheck2 belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.7 | 2026-01-05T13:43:55Z | [https://hackage.haskell.org/package/test-framework-quickcheck2](https://hackage.haskell.org/package/test-framework-quickcheck2) |  |
| candidate | partial | 0.3.0.4 |  | [https://hackage.haskell.org/package/test-framework-quickcheck2](https://hackage.haskell.org/package/test-framework-quickcheck2) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/test-framework-quickcheck2` at `2026-09-01T14:24:34+00:00`.
...
| --- | --- | --- | --- |
| hackage_top_downloads | registry-derived | 2026-09-02 | `{"kind": "hackage_top_downloads", "retrieved": "2026-09-02", "status": "registry-derived"}` |
...
- `hackage_top_downloads-beac8aa853d39c` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bytestring | Testing Framework | [open](haskell-bytestring-38df8b50.md) |
| bytestring-trie | Testing Framework | [open](haskell-bytestring-trie-fc4506c9.md) |
| distributed-process-tests | Testing Framework | [open](haskell-distributed-process-tests-fb4ba8e2.md) |
| doctest | Testing Framework | [open](haskell-doctest-30d37480.md) |
| hls-test-utils | Testing Framework | [open](haskell-hls-test-utils-92298e45.md) |
| polysemy-test | Testing Framework | [open](haskell-polysemy-test-c2be84ef.md) |
| shelltestrunner | Testing Framework | [open](haskell-shelltestrunner-fa7b5020.md) |
| streaming-bytestring | Testing Framework | [open](haskell-streaming-bytestring-78cfcae5.md) |
