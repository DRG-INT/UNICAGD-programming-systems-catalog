...
| Canonical URL | [https://crates.io/crates/alloy-sol-macro-input](https://crates.io/crates/alloy-sol-macro-input) |
| Source record ids | crates_io-4d8e5c409d9d14 |
...
For a systems engineer, alloy-sol-macro-input belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-25T20:59:32.203280Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-4d8e5c409d9d14` from `crates_io` as `registry_expansion`
