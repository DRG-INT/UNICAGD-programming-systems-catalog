...
<!-- canonical: https://github.com/openscad/openscad -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openscad/openscad](https://github.com/openscad/openscad) |
| Source record ids | github_search_computer_graphics_software-d0daa7db516a1e |
...
For a systems engineer, openscad/openscad belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-d0daa7db516a1e` from `github_search_computer_graphics_software` as `registry_expansion`
