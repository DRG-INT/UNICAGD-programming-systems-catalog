...
<!-- canonical: https://github.com/renanmav/pycst -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/renanmav/pycst](https://github.com/renanmav/pycst) |
| Source record ids | github_search_electromagnetoscopes-90ddf4b98332d1 |
...
For a systems engineer, renanmav/pycst belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-09T20:39:37Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-90ddf4b98332d1` from `github_search_electromagnetoscopes` as `registry_expansion`
