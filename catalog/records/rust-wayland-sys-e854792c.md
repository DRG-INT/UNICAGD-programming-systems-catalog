...
<!-- canonical: https://crates.io/crates/wayland-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wayland-sys](https://crates.io/crates/wayland-sys) |
| Source record ids | crates_io-ca7065430d8a41 |

## System Engineer Summary

FFI bindings to the various libwayland-*.so libraries. You should only need this crate if you are
working on custom wayland protocol extensions. Look at the crate wayland-client for usable bindings.

## Operational Role

For a systems engineer, wayland-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.31.11 | 2026-03-31T02:20:48.724050Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-ca7065430d8a41` from `crates_io` as `registry_expansion`
