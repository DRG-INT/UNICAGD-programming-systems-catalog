...
<!-- canonical: https://github.com/jks-prv/Beagle_SDR_GPS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jks-prv/Beagle_SDR_GPS](https://github.com/jks-prv/Beagle_SDR_GPS) |
| Source record ids | github_search_satcom_satellites-fd3600addabc1c |
...
For a systems engineer, jks-prv/Beagle_SDR_GPS belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-03T02:40:57Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-fd3600addabc1c` from `github_search_satcom_satellites` as `registry_expansion`
