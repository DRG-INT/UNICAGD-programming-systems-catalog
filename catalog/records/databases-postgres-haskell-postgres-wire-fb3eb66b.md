...
<!-- canonical: https://github.com/postgres-haskell/postgres-wire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/postgres-haskell/postgres-wire](https://github.com/postgres-haskell/postgres-wire) |
| Source record ids | github_search_databases-965203639f4fb9 |
...
For a systems engineer, postgres-haskell/postgres-wire belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-04T17:57:49Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-965203639f4fb9` from `github_search_databases` as `registry_expansion`
