...
<!-- canonical: https://hackage.haskell.org/package/distributed-process-p2p -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/distributed-process-p2p](https://hackage.haskell.org/package/distributed-process-p2p) |
| Source record ids | hackage_top_downloads-056bc14a3ca471 |
...
For a systems engineer, distributed-process-p2p belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6.0 | 2026-07-02T15:52:23Z | [https://hackage.haskell.org/package/distributed-process-p2p](https://hackage.haskell.org/package/distributed-process-p2p) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/distributed-process-p2p` at `2026-09-04T00:30:47+00:00`.
...
- `hackage_top_downloads-056bc14a3ca471` from `hackage_top_downloads` as `registry_expansion`
