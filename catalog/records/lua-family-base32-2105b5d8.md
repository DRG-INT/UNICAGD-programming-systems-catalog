...
<!-- canonical: https://luarocks.org/modules/mah0x211/base32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/base32](https://luarocks.org/modules/mah0x211/base32) |
| Source record ids | luarocks_root_manifest-9f2b6cc9bbfcc6 |

## System Engineer Summary

base32 encode/decode module

## Operational Role

For a systems engineer, base32 belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9f2b6cc9bbfcc6` from `luarocks_root_manifest` as `registry_expansion`
