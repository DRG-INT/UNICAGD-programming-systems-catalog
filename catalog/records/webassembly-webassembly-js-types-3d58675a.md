...
<!-- canonical: https://github.com/WebAssembly/js-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/js-types](https://github.com/WebAssembly/js-types) |
| Source record ids | github_search_webassembly-2a00ba22f517c4 |
...
For a systems engineer, WebAssembly/js-types belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-04T06:30:45Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-2a00ba22f517c4` from `github_search_webassembly` as `registry_expansion`
