...
[Catalog index](../index.md) · [Language: C23](../by-language/c23.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | master-739d74b3b34d |

## System Engineer Summary

C23 language/library and compiler-support reference

## Operational Role

For a systems engineer, cppreference C23 belongs in the C23 inventory as part of ecosystem
...
- `master-739d74b3b34d` from `master_json` as `community_reference`
