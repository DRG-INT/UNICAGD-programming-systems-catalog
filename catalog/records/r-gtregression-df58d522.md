...
<!-- canonical: https://cran.r-project.org/web/packages/gtregression/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gtregression/index.html](https://cran.r-project.org/web/packages/gtregression/index.html) |
| Source record ids | cran_packages_by_date-15cbb446cda9e3 |
...
For a systems engineer, gtregression belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 07:30:02 UTC | [https://cran.r-project.org/web/packages/gtregression/DESCRIPTION](https://cran.r-project.org/web/packages/gtregression/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gtregression/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-15cbb446cda9e3` from `cran_packages_by_date` as `registry_expansion`
