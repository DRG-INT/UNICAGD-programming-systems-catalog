...
<!-- canonical: https://github.com/galacean/engine-toolkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/galacean/engine-toolkit](https://github.com/galacean/engine-toolkit) |
| Source record ids | github_search_effects-f5bccbf99db9be |
...
For a systems engineer, galacean/engine-toolkit belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T09:03:34Z | gh search repos topic:visual-effects stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f5bccbf99db9be` from `github_search_effects` as `registry_expansion`
