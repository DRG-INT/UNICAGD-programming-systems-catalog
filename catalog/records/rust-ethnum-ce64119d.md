...
| Canonical URL | [https://crates.io/crates/ethnum](https://crates.io/crates/ethnum) |
| Source record ids | crates_io-5ec4b2ce7d584c |
...
For a systems engineer, ethnum belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.3 | 2026-04-20T15:42:43.724270Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-5ec4b2ce7d584c` from `crates_io` as `registry_expansion`
