...
<!-- canonical: https://hackage.haskell.org/package/toysolver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/toysolver](https://hackage.haskell.org/package/toysolver) |
| Source record ids | hackage_top_downloads-0e378d2c1d8aa8 |
...
For a systems engineer, toysolver belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-07-20T23:56:56Z | [https://hackage.haskell.org/package/toysolver](https://hackage.haskell.org/package/toysolver) |  |
| candidate | partial | 0.1.0 |  | [https://hackage.haskell.org/package/toysolver](https://hackage.haskell.org/package/toysolver) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/toysolver` at `2026-09-01T14:24:35+00:00`.
...
- `hackage_top_downloads-0e378d2c1d8aa8` from `hackage_top_downloads` as `registry_expansion`
