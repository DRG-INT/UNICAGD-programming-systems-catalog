...
<!-- canonical: https://github.com/SwifterSwift/SwifterSwift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SwifterSwift/SwifterSwift](https://github.com/SwifterSwift/SwifterSwift) |
| Source record ids | github_search_swift-def2fc506d2476 |
...
For a systems engineer, SwifterSwift/SwifterSwift belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T05:41:29Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-def2fc506d2476` from `github_search_swift` as `registry_expansion`
