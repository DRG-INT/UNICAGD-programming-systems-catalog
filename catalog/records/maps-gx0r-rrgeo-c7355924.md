...
<!-- canonical: https://github.com/gx0r/rrgeo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gx0r/rrgeo](https://github.com/gx0r/rrgeo) |
| Source record ids | github_search_maps-156ccb94ab77bb |
...
For a systems engineer, gx0r/rrgeo belongs in the Maps inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-22T14:42:50Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-156ccb94ab77bb` from `github_search_maps` as `registry_expansion`
