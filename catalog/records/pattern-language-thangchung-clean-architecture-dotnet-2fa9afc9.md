...
| Canonical URL | [https://github.com/thangchung/clean-architecture-dotnet](https://github.com/thangchung/clean-architecture-dotnet) |
| Source record ids | github_search_pattern_language-5aceaa7465c083 |

## System Engineer Summary

🕸 Yet Another .NET Clean Architecture, but for Microservices project. It uses Minimal Clean
Architecture with DDD-lite, CQRS-lite, and just enough Cloud-native patterns apply on the simple
eCommerce sample and run on Tye with Dapr extension 🍻

## Operational Role

For a systems engineer, thangchung/clean-architecture-dotnet belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | SNAPSHOT-v0.0.3 | 2021-08-01T08:53:43Z | [https://api.github.com/repos/thangchung/clean-architecture-dotnet/releases/latest](https://api.github.com/repos/thangchung/clean-architecture-dotnet/releases/latest) |  |
| preview | known | SNAPSHOT-v0.0.1 | 2021-02-10T12:16:23Z | [https://api.github.com/repos/thangchung/clean-architecture-dotnet/releases?per_page=10](https://api.github.com/repos/thangchung/clean-architecture-dotnet/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/thangchung/clean-architecture-dotnet/releases/latest` at `2026-09-01T12:30:30+00:00`.
...
- `github_search_pattern_language-5aceaa7465c083` from `github_search_pattern_language` as `registry_expansion`
