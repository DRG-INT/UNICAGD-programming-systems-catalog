...
<!-- canonical: https://github.com/jerry060599/YarnBall -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jerry060599/YarnBall](https://github.com/jerry060599/YarnBall) |
| Source record ids | github_search_physics_engines-dd77a16de90553 |

## System Engineer Summary

A massively parallel high performance GPU Cosserat Rods Simulator

## Operational Role

For a systems engineer, jerry060599/YarnBall belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-01T22:29:36Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-dd77a16de90553` from `github_search_physics_engines` as `registry_expansion`
