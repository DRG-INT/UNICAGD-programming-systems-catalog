...
<!-- canonical: https://github.com/DL3DV-10K/Dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DL3DV-10K/Dataset](https://github.com/DL3DV-10K/Dataset) |
| Source record ids | github_search_computer_graphics_software-7820a42b3e28aa |
...
For a systems engineer, DL3DV-10K/Dataset belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-7820a42b3e28aa` from `github_search_computer_graphics_software` as `registry_expansion`
