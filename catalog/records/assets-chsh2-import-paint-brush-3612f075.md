...
<!-- canonical: https://github.com/chsh2/import_paint_brush -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chsh2/import_paint_brush](https://github.com/chsh2/import_paint_brush) |
| Source record ids | github_search_assets-cf7e1ee747c366 |

## System Engineer Summary

An add-on converting brush assets from popular painting software to Blender brushes

## Operational Role

For a systems engineer, chsh2/import_paint_brush belongs in the Assets inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T07:30:37Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-cf7e1ee747c366` from `github_search_assets` as `registry_expansion`
