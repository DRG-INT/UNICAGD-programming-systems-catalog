...
| Canonical URL | [https://crates.io/crates/crypto_secretbox](https://crates.io/crates/crypto_secretbox) |
| Source record ids | crates_io-77f6c46a451760 |

## System Engineer Summary

Pure Rust implementation of the XSalsa20Poly1305 (a.k.a. NaCl crypto_secretbox) authenticated
encryption cipher as well as the libsodium variant of XChaCha20Poly1305

## Operational Role

For a systems engineer, crypto_secretbox belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2025-10-05T12:03:48.011224Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-77f6c46a451760` from `crates_io` as `registry_expansion`
