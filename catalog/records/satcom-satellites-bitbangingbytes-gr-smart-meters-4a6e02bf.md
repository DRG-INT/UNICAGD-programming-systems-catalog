...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/BitBangingBytes/gr-smart_meters -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BitBangingBytes/gr-smart_meters](https://github.com/BitBangingBytes/gr-smart_meters) |
| Source record ids | github_search_satcom_satellites-b4411816ed4076 |

## System Engineer Summary

BitBangingBytes/gr-smart_meters is tracked as a library record in the SatCom Satellites branch. The
...
For a systems engineer, BitBangingBytes/gr-smart_meters belongs in the SatCom Satellites inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-25T14:44:10Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Artistic-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:gnuradio stars:>20", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_satcom_satellites-b4411816ed4076` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AlbrechtL/welle.io | Library | [open](satcom-satellites-albrechtl-welle-io-a00798d6.md) |
| Alexgichamba/sat-rf-sim | Library | [open](satcom-satellites-alexgichamba-sat-rf-sim-aa36e263.md) |
| architek/ccsds-standalone | Library | [open](satcom-satellites-architek-ccsds-standalone-ec3b3382.md) |
| blaylockbk/goes2go | Library | [open](satcom-satellites-blaylockbk-goes2go-6d604dc4.md) |
| brian-armstrong/fec | Library | [open](satcom-satellites-brian-armstrong-fec-b785fbe7.md) |
| btfz-sdr/gnuradio_demo | Library | [open](satcom-satellites-btfz-sdr-gnuradio-demo-1b296ec6.md) |
| cariboulabs/cariboulite | Library | [open](satcom-satellites-cariboulabs-cariboulite-4bcd3490.md) |
| codyd51/gypsum | Library | [open](satcom-satellites-codyd51-gypsum-367a7afa.md) |
