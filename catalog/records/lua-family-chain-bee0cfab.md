...
<!-- canonical: https://luarocks.org/modules/ryanplusplus/chain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ryanplusplus/chain](https://luarocks.org/modules/ryanplusplus/chain) |
| Source record ids | luarocks_root_manifest-092817da5a9b60 |
...
For a systems engineer, chain belongs in the Lua family inventory as part of build graph control,
...
- `luarocks_root_manifest-092817da5a9b60` from `luarocks_root_manifest` as `registry_expansion`
