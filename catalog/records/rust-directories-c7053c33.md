...
<!-- canonical: https://crates.io/crates/directories -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/directories](https://crates.io/crates/directories) |
| Source record ids | crates_io-cf7ec855a8bd7d |
...
For a systems engineer, directories belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2025-01-12T17:19:05.177535Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-cf7ec855a8bd7d` from `crates_io` as `registry_expansion`
