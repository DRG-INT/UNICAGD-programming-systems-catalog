...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/flowable/flowable-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flowable/flowable-engine](https://github.com/flowable/flowable-engine) |
| Source record ids | github_search_engines-b10eb17b089d4e |

## System Engineer Summary

A compact and highly efficient workflow and Business Process Management (BPM) platform for
developers, system admins and business users.

## Operational Role

For a systems engineer, flowable/flowable-engine belongs in the Engines inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:24:14Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-b10eb17b089d4e` from `github_search_engines` as `registry_expansion`
