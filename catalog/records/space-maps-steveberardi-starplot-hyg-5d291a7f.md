...
<!-- canonical: https://github.com/steveberardi/starplot-hyg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/steveberardi/starplot-hyg](https://github.com/steveberardi/starplot-hyg) |
| Source record ids | github_search_space_maps-023d0a7bc989fc |

## System Engineer Summary

Starplot catalog builder for HYG

## Operational Role

For a systems engineer, steveberardi/starplot-hyg belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-10T16:57:32Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-023d0a7bc989fc` from `github_search_space_maps` as `registry_expansion`
