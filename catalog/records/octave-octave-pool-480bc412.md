...
<!-- canonical: https://gnu-octave.github.io/packages/octave-pool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/octave-pool](https://gnu-octave.github.io/packages/octave-pool) |
| Source record ids | octave_packages_index-2f54a04c1a1337 |
...
For a systems engineer, octave-pool belongs in the Octave inventory as part of ecosystem capability
...
- `octave_packages_index-2f54a04c1a1337` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| outliers | Undefined Behavior Analyzer | [open](octave-outliers-7443d59a.md) |
