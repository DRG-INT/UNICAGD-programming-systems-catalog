...
<!-- canonical: https://github.com/openkraken/kraken -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openkraken/kraken](https://github.com/openkraken/kraken) |
| Source record ids | github_search_engines-9ea57b46b89913 |
...
For a systems engineer, openkraken/kraken belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-30T15:02:55Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-9ea57b46b89913` from `github_search_engines` as `registry_expansion`
