...
<!-- canonical: http://webserver2.tecgraf.puc-rio.br/~lhf/ftp/lua/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://webserver2.tecgraf.puc-rio.br/~lhf/ftp/lua/](http://webserver2.tecgraf.puc-rio.br/~lhf/ftp/lua/) |
| Source record ids | lua-source-242 |
...
For a systems engineer, lhf's Lua Tools belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 242}}` |
...
- `lua-source-242` from `master_json` as `source_list_item`
