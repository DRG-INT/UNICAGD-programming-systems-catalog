...
<!-- canonical: https://cran.r-project.org/web/packages/ggthemes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggthemes/index.html](https://cran.r-project.org/web/packages/ggthemes/index.html) |
| Source record ids | cran_packages_by_date-7fef30be0aefc8 |
...
For a systems engineer, ggthemes belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2026-08-30 05:10:30 UTC | [https://cran.r-project.org/web/packages/ggthemes/DESCRIPTION](https://cran.r-project.org/web/packages/ggthemes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggthemes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7fef30be0aefc8` from `cran_packages_by_date` as `registry_expansion`
