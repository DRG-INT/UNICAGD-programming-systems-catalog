...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tomekw/hikari-cp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tomekw/hikari-cp](https://github.com/tomekw/hikari-cp) |
| Source record ids | github_search_databases-c3b43a208649e7 |
...
For a systems engineer, tomekw/hikari-cp belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-16T15:20:38Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c3b43a208649e7` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mkleehammer/pyodbc | Interop Bindings | [open](databases-mkleehammer-pyodbc-1babb273.md) |
| nanodbc/nanodbc | Interop Bindings | [open](databases-nanodbc-nanodbc-97a75e2a.md) |
