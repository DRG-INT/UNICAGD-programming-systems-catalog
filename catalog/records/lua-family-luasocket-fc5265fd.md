...
| Canonical URL | [https://github.com/diegonehab/luasocket](https://github.com/diegonehab/luasocket) |
| Source record ids | lua-source-290 |

## System Engineer Summary

Networking extension which provides a socket API for TCP and UDP, and implements HTTP, FTP, and
SMTP.

## Operational Role

For a systems engineer, LuaSocket belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.1.0 | 2022-07-27T07:11:39Z | [https://api.github.com/repos/diegonehab/luasocket/releases/latest](https://api.github.com/repos/diegonehab/luasocket/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/diegonehab/luasocket/releases/latest` at `2026-09-01T03:21:53+00:00`.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 290}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-290` from `master_json` as `source_list_item`
