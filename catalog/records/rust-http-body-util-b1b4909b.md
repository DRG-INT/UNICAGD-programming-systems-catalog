...
<!-- canonical: https://crates.io/crates/http-body-util -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/http-body-util](https://crates.io/crates/http-body-util) |
| Source record ids | crates_io-f85e8c21c7cbd9 |
...
For a systems engineer, http-body-util belongs in the Rust inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-12T15:22:21.622138Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-f85e8c21c7cbd9` from `crates_io` as `registry_expansion`
