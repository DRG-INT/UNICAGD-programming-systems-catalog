...
<!-- canonical: https://hackage.haskell.org/package/hasql-th -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hasql-th](https://hackage.haskell.org/package/hasql-th) |
| Source record ids | hackage_top_downloads-15e7c6887c9681 |
...
For a systems engineer, hasql-th belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1.1 | 2026-08-06T10:04:02Z | [https://hackage.haskell.org/package/hasql-th](https://hackage.haskell.org/package/hasql-th) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hasql-th` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-15e7c6887c9681` from `hackage_top_downloads` as `registry_expansion`
