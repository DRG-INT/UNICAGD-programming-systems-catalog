...
<!-- canonical: https://pub.dev/packages/mask_text_input_formatter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mask_text_input_formatter](https://pub.dev/packages/mask_text_input_formatter) |
| Source record ids | pub_dev-ba0e12cd957846 |

## System Engineer Summary

The package provides TextInputFormatter for TextField and TextFormField which format the input by a
given mask.

## Operational Role

For a systems engineer, mask_text_input_formatter belongs in the Dart inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.0 | 2024-02-15T09:15:51.194434Z | [https://pub.dev/api/packages/mask_text_input_formatter](https://pub.dev/api/packages/mask_text_input_formatter) |  |
| preview | known | 2.0.0-nullsafety.2 | 2020-12-22T10:53:19.624803Z | [https://pub.dev/api/packages/mask_text_input_formatter](https://pub.dev/api/packages/mask_text_input_formatter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mask_text_input_formatter` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-ba0e12cd957846` from `pub_dev` as `registry_expansion`
