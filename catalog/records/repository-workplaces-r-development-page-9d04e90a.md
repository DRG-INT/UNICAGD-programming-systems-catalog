...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Repository Workplaces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/repository-workplaces.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://developer.r-project.org/](https://developer.r-project.org/) |
| Source record ids | curated_repository_workplace_routes-947a37295eccf4 |

## System Engineer Summary

Official R development route for source, build, patch, bug, and release workflow references.

## Operational Role

For a systems engineer, R Development Page belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-947a37295eccf4` from `curated_repository_workplace_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Gerrit API | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-gerrit-api-eab54e1c.md) |
| Gitea API | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-gitea-api-21f55527.md) |
| GitHub Repository Search API | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-github-repository-search-api-a6eddd2a.md) |
| GitLab Projects API | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-gitlab-projects-api-d576550a.md) |
| Go Dev Source Guide | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-go-dev-source-guide-91115b4b.md) |
| PHP Git Access | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-php-git-access-a76d1614.md) |
| Python Developer Guide | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-python-developer-guide-eb490df4.md) |
| Rust Forge | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-rust-forge-8a4e8ba8.md) |
