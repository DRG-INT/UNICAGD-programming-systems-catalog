# InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets

## Navigation

[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets](https://github.com/InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets) |
| Source record ids | github_search_microscopy-f173a9375e5c3a |

## System Engineer Summary

A web-based resource for the scientific visualization community to enhance reproducibility and
facilitate testing and development of OME-Zarr tools.

## Operational Role

For a systems engineer, InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets belongs in the
Microscopy inventory as part of unit/integration validation, regression protection, and release
confidence.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2026.02.14 | 2026-02-14T17:27:02Z | [https://api.github.com/repos/InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets/releases/latest](https://api.github.com/repos/InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/InsightSoftwareConsortium/OMEZarrOpenSciVisDatasets/releases/latest` at `2026-09-01T08:26:19+00:00`.
...
- `github_search_microscopy-f173a9375e5c3a` from `github_search_microscopy` as `registry_expansion`
