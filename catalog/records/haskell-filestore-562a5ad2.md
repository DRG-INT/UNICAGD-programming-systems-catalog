...
<!-- canonical: https://hackage.haskell.org/package/filestore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/filestore](https://hackage.haskell.org/package/filestore) |
| Source record ids | hackage_top_downloads-66ed83388b898d |
...
For a systems engineer, filestore belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5.1 | 2025-08-26T09:36:15Z | [https://hackage.haskell.org/package/filestore](https://hackage.haskell.org/package/filestore) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/filestore` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-66ed83388b898d` from `hackage_top_downloads` as `registry_expansion`
