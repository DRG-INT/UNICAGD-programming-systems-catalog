...
<!-- canonical: https://github.com/noirblancrouge/YoungSerif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/noirblancrouge/YoungSerif](https://github.com/noirblancrouge/YoungSerif) |
| Source record ids | github_search_font_briefcase-06451643304388 |

## System Engineer Summary

Young Serif is a variable old style serif typeface

## Operational Role

For a systems engineer, noirblancrouge/YoungSerif belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-19T12:03:20Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-06451643304388` from `github_search_font_briefcase` as `registry_expansion`
