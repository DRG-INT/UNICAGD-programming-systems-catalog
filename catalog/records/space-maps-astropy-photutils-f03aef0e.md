...
<!-- canonical: https://github.com/astropy/photutils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/astropy/photutils](https://github.com/astropy/photutils) |
| Source record ids | github_search_space_maps-f69bece3bf26e5 |
...
For a systems engineer, astropy/photutils belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:29:04Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f69bece3bf26e5` from `github_search_space_maps` as `registry_expansion`
