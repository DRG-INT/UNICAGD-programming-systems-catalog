...
<!-- canonical: https://crates.io/crates/time -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-59f1e5139f0271 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.55 | 2026-08-01T08:08:34.139758Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `crates_io-59f1e5139f0271` from `crates_io` as `registry_expansion`
