...
<!-- canonical: https://github.com/wang-boyu/coursera-machine-learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wang-boyu/coursera-machine-learning](https://github.com/wang-boyu/coursera-machine-learning) |
| Source record ids | github_search_matlab-ee1e7fec93a4ef |
...
For a systems engineer, wang-boyu/coursera-machine-learning belongs in the Matlab inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-28T01:09:47Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ee1e7fec93a4ef` from `github_search_matlab` as `registry_expansion`
