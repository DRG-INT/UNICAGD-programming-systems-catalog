...
<!-- canonical: https://github.com/art-den/astra_lite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/art-den/astra_lite](https://github.com/art-den/astra_lite) |
| Source record ids | github_search_telescopes-d5883d5fbc0c53 |

## System Engineer Summary

AstraLite is software for deepsky astrophotography and live stacking on low power PCs (like
rapsberry Pi or Orange Pi)

## Operational Role

For a systems engineer, art-den/astra_lite belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T11:36:25Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-d5883d5fbc0c53` from `github_search_telescopes` as `registry_expansion`
