...
<!-- canonical: https://pypi.org/project/ablate-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ablate-cli/](https://pypi.org/project/ablate-cli/) |
| Source record ids | pypi_simple-2af4f81fdebd76 |
...
For a systems engineer, ablate-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-07-28T13:58:40.360014Z | [https://pypi.org/pypi/ablate-cli/json](https://pypi.org/pypi/ablate-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ablate-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-2af4f81fdebd76` from `pypi_simple` as `registry_expansion`
