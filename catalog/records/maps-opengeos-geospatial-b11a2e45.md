...
<!-- canonical: https://github.com/opengeos/geospatial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opengeos/geospatial](https://github.com/opengeos/geospatial) |
| Source record ids | github_search_maps-bdeacedbf2397e |

## System Engineer Summary

A Python package for installing commonly used packages for geospatial analysis and data
visualization with only one command.

## Operational Role

For a systems engineer, opengeos/geospatial belongs in the Maps inventory as part of defect
...
- `github_search_maps-bdeacedbf2397e` from `github_search_maps` as `registry_expansion`
