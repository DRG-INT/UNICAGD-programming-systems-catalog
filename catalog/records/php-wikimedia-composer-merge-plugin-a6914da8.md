...
<!-- canonical: https://packagist.org/packages/wikimedia/composer-merge-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/wikimedia/composer-merge-plugin](https://packagist.org/packages/wikimedia/composer-merge-plugin) |
| Source record ids | packagist_search-4dab37a17f643e |
...
For a systems engineer, wikimedia/composer-merge-plugin belongs in the PHP inventory as part of wire
...
- `packagist_search-4dab37a17f643e` from `packagist_search` as `registry_expansion`
