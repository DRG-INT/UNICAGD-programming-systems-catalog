...
<!-- canonical: https://crates.io/crates/image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/image](https://crates.io/crates/image) |
| Source record ids | crates_io-9bbbf2febcd3fd |
...
For a systems engineer, image belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.10 | 2026-03-10T16:29:18.250581Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-9bbbf2febcd3fd` from `crates_io` as `registry_expansion`
