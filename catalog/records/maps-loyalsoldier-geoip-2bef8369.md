...
<!-- canonical: https://github.com/Loyalsoldier/geoip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Loyalsoldier/geoip](https://github.com/Loyalsoldier/geoip) |
| Source record ids | github_search_maps-0ee4cdfb66c98f |

## System Engineer Summary

🌚 🌍 🌝 GeoIP 增强版，自由定制多种格式 GeoIP 文件，包括但不限于 V2Ray dat 格式文件 geoip.dat、MaxMind mmdb 格式文件、sing-box SRS
格式文件、mihomo MRS 格式文件、Clash ruleset、Surge ruleset、Nginx allow & deny 规则文件等。Enhanced edition of GeoIP
for Nginx, V2Ray, Xray-core, Clash, mihomo, sing-box, Shadowrocket, Quantumult X, Surge, hysteria,
Trojan-Go, dae, etc.

## Operational Role

For a systems engineer, Loyalsoldier/geoip belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T10:39:23Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0 |
...
- `github_search_maps-0ee4cdfb66c98f` from `github_search_maps` as `registry_expansion`
...
| Loyalsoldier/v2ray-rules-dat | Lint Rule Pack | [open](maps-loyalsoldier-v2ray-rules-dat-36af9fdf.md) |
