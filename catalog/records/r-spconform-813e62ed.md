...
<!-- canonical: https://cran.r-project.org/web/packages/spconform/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spconform/index.html](https://cran.r-project.org/web/packages/spconform/index.html) |
| Source record ids | cran_packages_by_date-680df45f714b7e |
...
For a systems engineer, spconform belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:40:02 UTC | [https://cran.r-project.org/web/packages/spconform/DESCRIPTION](https://cran.r-project.org/web/packages/spconform/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spconform/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-680df45f714b7e` from `cran_packages_by_date` as `registry_expansion`
