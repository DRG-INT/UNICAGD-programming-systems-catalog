...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mob-sakai/CompositeCanvasRenderer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mob-sakai/CompositeCanvasRenderer](https://github.com/mob-sakai/CompositeCanvasRenderer) |
| Source record ids | github_search_effects-c996db5941d179 |

## System Engineer Summary

CompositeCanvasRenderer bakes multiple source graphics into a bake-buffer (RenderTexture) and
renders it. Additional material modification, mesh modification, and baking effects are supported!
Let's enjoy the effects that were difficult to implement with UI shaders, such as blur, soft
outline, and soft shadow!

## Operational Role

For a systems engineer, mob-sakai/CompositeCanvasRenderer belongs in the Effects inventory as part
of cross-language integration, ABI ownership, memory safety, and runtime embedding.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T05:58:19Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-c996db5941d179` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bmcfee/resampy | Ffi Bindings | [open](effects-bmcfee-resampy-e099a0c0.md) |
| bogerchan/Nier-Visualizer | Ffi Bindings | [open](effects-bogerchan-nier-visualizer-09de96bb.md) |
| decisionforce/CoPO | Ffi Bindings | [open](effects-decisionforce-copo-f33691a8.md) |
| Drakulix/wlc.rs | Ffi Bindings | [open](effects-drakulix-wlc-rs-b2cf3c94.md) |
