...
| Canonical URL | [https://crates.io/crates/glib-sys](https://crates.io/crates/glib-sys) |
| Source record ids | crates_io-525dc0dc464860 |
...
For a systems engineer, glib-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.9 | 2026-08-30T17:39:22.182013Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-525dc0dc464860` from `crates_io` as `registry_expansion`
