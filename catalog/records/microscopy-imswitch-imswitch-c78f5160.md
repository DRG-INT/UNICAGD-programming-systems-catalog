...
<!-- canonical: https://github.com/ImSwitch/ImSwitch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ImSwitch/ImSwitch](https://github.com/ImSwitch/ImSwitch) |
| Source record ids | github_search_microscopy-cd020a6d6703be |

## System Engineer Summary

ImSwitch is a software solution in Python that aims at generalizing microscope control by providing
a solution for flexible control of multiple microscope modalities.

## Operational Role

For a systems engineer, ImSwitch/ImSwitch belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T15:00:31Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; ISC License; https://api.github.com/licenses/isc; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_microscopy-cd020a6d6703be` from `github_search_microscopy` as `registry_expansion`
