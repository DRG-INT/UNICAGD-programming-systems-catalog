...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ITS-NIGHTOWL/CSSource-Texture-Installer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ITS-NIGHTOWL/CSSource-Texture-Installer](https://github.com/ITS-NIGHTOWL/CSSource-Texture-Installer) |
| Source record ids | github_search_assets-e1e139aeadad07 |

## System Engineer Summary

A utility designed to help make installing CSSource textures into Garrys Mod safe while also doing
it the legal method by utilizing steamcmd.

## Operational Role

For a systems engineer, ITS-NIGHTOWL/CSSource-Texture-Installer belongs in the Assets inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-19T06:31:13Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-e1e139aeadad07` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| all-iver/shapes2d | Build System | [open](assets-all-iver-shapes2d-173160ec.md) |
| BlueG/DebugTextures | Build System | [open](assets-blueg-debugtextures-063e87e1.md) |
| BuildingVolumes/Unity_Geometry_Sequence_Player | Build System | [open](assets-buildingvolumes-unity-geometry-sequence-player-ed419a9b.md) |
| dbohdan/unflattener | Build System | [open](assets-dbohdan-unflattener-4903eefc.md) |
| dip000/godot-landscaper | Build System | [open](assets-dip000-godot-landscaper-2ec738a9.md) |
| fscorrupt/posterizarr | Build System | [open](assets-fscorrupt-posterizarr-76ea15df.md) |
| KayKit-Game-Assets/KayKit-City-Builder-Bits-1.0 | Build System | [open](assets-kaykit-game-assets-kaykit-city-builder-bits-1-0-6c52227b.md) |
| KayKit-Game-Assets/KayKit-Medieval-Hexagon-Pack-1.0 | Build System | [open](assets-kaykit-game-assets-kaykit-medieval-hexagon-pack-1-0-f6d4ab30.md) |
