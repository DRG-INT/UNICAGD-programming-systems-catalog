...
<!-- canonical: https://github.com/F1ATB/Remote-SDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/F1ATB/Remote-SDR](https://github.com/F1ATB/Remote-SDR) |
| Source record ids | github_search_satcom_satellites-41f4a71369b464 |

## System Engineer Summary

Remote control of 2 Software Design Radio. Receiver and transmitter. Based on Adalm-Pluto SDR or
RTL-SDR or Hack RF SDR or SDRplay and signal processing using GNU Radio on Raspberry PI. GUI on a
web browser.

## Operational Role

For a systems engineer, F1ATB/Remote-SDR belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-18T17:55:41Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-41f4a71369b464` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gnuradio/gr-bokehgui | Visualization Gui | [open](satcom-satellites-gnuradio-gr-bokehgui-61062031.md) |
