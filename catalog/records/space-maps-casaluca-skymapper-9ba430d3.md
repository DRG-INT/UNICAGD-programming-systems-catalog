...
<!-- canonical: https://github.com/casaluca/SkyMapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/casaluca/SkyMapper](https://github.com/casaluca/SkyMapper) |
| Source record ids | github_search_space_maps-a5567659272542 |

## System Engineer Summary

Photometric effective temperatures and metallicities for 9 million stars in SkyMapper and Gaia

## Operational Role

For a systems engineer, casaluca/SkyMapper belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-18T06:57:27Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a5567659272542` from `github_search_space_maps` as `registry_expansion`
