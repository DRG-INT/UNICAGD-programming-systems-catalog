...
| Source record ids | github_search_webassembly-b82dab59d15572 |

## System Engineer Summary

kanaka/mal is tracked as an interpreter runtime record in the WebAssembly branch. The source did not
...
For a systems engineer, kanaka/mal belongs in the WebAssembly inventory as part of runtime behavior,
...
- `github_search_webassembly-b82dab59d15572` from `github_search_webassembly` as `registry_expansion`
