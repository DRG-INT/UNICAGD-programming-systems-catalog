# OpenMaker2/RadioGarden

## Navigation

[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/OpenMaker2/RadioGarden -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenMaker2/RadioGarden](https://github.com/OpenMaker2/RadioGarden) |
| Source record ids | github_search_radio_garden_speciality-20f11ca5882d98, github_search_radio_garden_speciality-b860028bdad58f |

## System Engineer Summary

OpenMaker2/RadioGarden is tracked as a build system record in the Radio Garden Speciality branch.
...
For a systems engineer, OpenMaker2/RadioGarden belongs in the Radio Garden Speciality inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-26T20:04:50Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-20f11ca5882d98` from `github_search_radio_garden_speciality` as `registry_expansion`
- `github_search_radio_garden_speciality-b860028bdad58f` from `github_search_radio_garden_speciality` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| danderfer/Comp_Sci_Sem_2 | Build System | [open](radio-garden-speciality-danderfer-comp-sci-sem-2-960c7dd5.md) |
| LakshmiEvani/RadioAtlas | Build System | [open](radio-garden-speciality-lakshmievani-radioatlas-00c0a225.md) |
| PeterboroughDoors/Creating-a-Comfortable-Working-Environment-with-Replacement-Double-Glazing | Build System | [open](radio-garden-speciality-peterboroughdoors-creating-a-comfortable-working-environment-with-replacement-double-glazing-0e8393ac.md) |
