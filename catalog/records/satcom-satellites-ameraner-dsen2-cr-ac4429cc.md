...
<!-- canonical: https://github.com/ameraner/dsen2-cr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ameraner/dsen2-cr](https://github.com/ameraner/dsen2-cr) |
| Source record ids | github_search_satcom_satellites-bb22e6f6fc51ae |

## System Engineer Summary

DSen2-CR: A network for removing clouds from Sentinel-2 images. This repo contains the model code,
written in Python/Keras, as well as links to pre-trained checkpoints and the SEN12MS-CR dataset.

## Operational Role

For a systems engineer, ameraner/dsen2-cr belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-26T16:29:38Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-bb22e6f6fc51ae` from `github_search_satcom_satellites` as `registry_expansion`
