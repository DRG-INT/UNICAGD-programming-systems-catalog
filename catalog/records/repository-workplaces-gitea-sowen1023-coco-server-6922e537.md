...
<!-- canonical: https://gitea.com/sowen1023/coco-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/sowen1023/coco-server](https://gitea.com/sowen1023/coco-server) |
| Source record ids | gitea_repositories_api-c8a640e6419763 |
...
For a systems engineer, Gitea: sowen1023/coco-server belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-04T05:03:35Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-c8a640e6419763` from `gitea_repositories_api` as `registry_expansion`
