...
<!-- canonical: https://luarocks.org/modules/uriid1/cairo-luajit-ffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/uriid1/cairo-luajit-ffi](https://luarocks.org/modules/uriid1/cairo-luajit-ffi) |
| Source record ids | luarocks_root_manifest-8d6c01ebb3b1bb |
...
For a systems engineer, cairo-luajit-ffi belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-8d6c01ebb3b1bb` from `luarocks_root_manifest` as `registry_expansion`
