# Gitea: VitorDiv/devops-pipeline
...
<!-- canonical: https://gitea.com/VitorDiv/devops-pipeline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/VitorDiv/devops-pipeline](https://gitea.com/VitorDiv/devops-pipeline) |
| Source record ids | gitea_repositories_api-0682940a9e6154 |
...
For a systems engineer, Gitea: VitorDiv/devops-pipeline belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-21T17:29:25Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-0682940a9e6154` from `gitea_repositories_api` as `registry_expansion`
