...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/json](https://gnu-octave.github.io/packages/json) |
| Source record ids | octave_packages_index-008d1bf5b23ab0 |

## System Engineer Summary

JSON support by Matlab compatible (jsondecode / jsonencode) functions. Included in Octave core since
version 7.1.0. No need to install this package in recent Octave versions.

## Operational Role

For a systems engineer, json belongs in the Octave inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2025-03-23 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-008d1bf5b23ab0` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fileio | Serialization | [open](octave-fileio-a3655e15.md) |
