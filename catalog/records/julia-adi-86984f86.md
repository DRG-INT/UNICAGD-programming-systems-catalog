...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/ADI -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/ADI", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-f5d8859d9db01a` from `julia_general` as `registry_expansion`
