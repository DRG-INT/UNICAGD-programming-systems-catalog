...
| Canonical URL | [https://crates.io/crates/askama](https://crates.io/crates/askama) |
| Source record ids | crates_io-68731e86338480 |
...
For a systems engineer, askama belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-04-29T22:48:06.718523Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-68731e86338480` from `crates_io` as `registry_expansion`
