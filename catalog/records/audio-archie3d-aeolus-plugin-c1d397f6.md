...
<!-- canonical: https://github.com/Archie3d/aeolus_plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Archie3d/aeolus_plugin](https://github.com/Archie3d/aeolus_plugin) |
| Source record ids | github_search_audio-aab20ba0a3e55c |
...
For a systems engineer, Archie3d/aeolus_plugin belongs in the Audio inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.3.0 | 2025-05-31T13:17:36Z | [https://api.github.com/repos/Archie3d/aeolus_plugin/releases/latest](https://api.github.com/repos/Archie3d/aeolus_plugin/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Archie3d/aeolus_plugin/releases/latest` at `2026-09-01T11:21:37+00:00`.
...
- `github_search_audio-aab20ba0a3e55c` from `github_search_audio` as `registry_expansion`
