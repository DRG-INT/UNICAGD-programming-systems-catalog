...
<!-- canonical: https://packagist.org/packages/symfony/redis-messenger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/redis-messenger](https://packagist.org/packages/symfony/redis-messenger) |
| Source record ids | packagist_search-617b84038aa127 |
...
For a systems engineer, symfony/redis-messenger belongs in the PHP inventory as part of state
...
- `packagist_search-617b84038aa127` from `packagist_search` as `registry_expansion`
