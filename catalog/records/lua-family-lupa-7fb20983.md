...
| Canonical URL | [https://github.com/scoder/lupa](https://github.com/scoder/lupa) |
| Source record ids | lua-source-67 |
...
For a systems engineer, lupa belongs in the Lua family inventory as part of runtime behavior,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 67}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-67` from `master_json` as `source_list_item`
