...
<!-- canonical: https://pub.dev/packages/responsive_framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/responsive_framework](https://pub.dev/packages/responsive_framework) |
| Source record ids | pub_dev-115a6950b1c8d7 |
...
For a systems engineer, responsive_framework belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2024-08-26T16:35:44.517480Z | [https://pub.dev/api/packages/responsive_framework](https://pub.dev/api/packages/responsive_framework) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/responsive_framework` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-115a6950b1c8d7` from `pub_dev` as `registry_expansion`
