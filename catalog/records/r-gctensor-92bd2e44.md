...
<!-- canonical: https://cran.r-project.org/web/packages/gcTensor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gcTensor/index.html](https://cran.r-project.org/web/packages/gcTensor/index.html) |
| Source record ids | cran_packages_by_date-e1664823482007 |
...
For a systems engineer, gcTensor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-11 06:20:08 UTC | [https://cran.r-project.org/web/packages/gcTensor/DESCRIPTION](https://cran.r-project.org/web/packages/gcTensor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gcTensor/DESCRIPTION` at `2026-09-11T06:25:06+00:00`.
...
- `cran_packages_by_date-e1664823482007` from `cran_packages_by_date` as `registry_expansion`
