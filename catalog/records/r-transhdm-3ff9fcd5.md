...
<!-- canonical: https://cran.r-project.org/web/packages/TransHDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TransHDM/index.html](https://cran.r-project.org/web/packages/TransHDM/index.html) |
| Source record ids | cran_packages_by_date-c87108bc90aedc |
...
For a systems engineer, TransHDM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3 | 2026-08-20 22:52:14 UTC | [https://cran.r-project.org/web/packages/TransHDM/DESCRIPTION](https://cran.r-project.org/web/packages/TransHDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TransHDM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c87108bc90aedc` from `cran_packages_by_date` as `registry_expansion`
