...
<!-- canonical: https://github.com/aviaryan/SublimeNotebook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aviaryan/SublimeNotebook](https://github.com/aviaryan/SublimeNotebook) |
| Source record ids | github_search_magazines-155c3c886c3a7c |
...
For a systems engineer, aviaryan/SublimeNotebook belongs in the Magazines inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-04-30T09:28:17Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-155c3c886c3a7c` from `github_search_magazines` as `registry_expansion`
