...
<!-- canonical: https://github.com/WebAssembly/wasi-threads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-threads](https://github.com/WebAssembly/wasi-threads) |
| Source record ids | github_search_webassembly-ee802f76f333a2 |

## System Engineer Summary

WebAssembly/wasi-threads is tracked as a language specification record in the WebAssembly branch.
...
For a systems engineer, WebAssembly/wasi-threads belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-17T14:07:57Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ee802f76f333a2` from `github_search_webassembly` as `registry_expansion`
