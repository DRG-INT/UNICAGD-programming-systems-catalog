...
<!-- canonical: https://github.com/JuliaGeo/GDAL.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaGeo/GDAL.jl](https://github.com/JuliaGeo/GDAL.jl) |
| Source record ids | github_search_satcom_satellites-99a987dacd836a |
...
For a systems engineer, JuliaGeo/GDAL.jl belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.12.0 | 2025-12-23T20:23:10Z | [https://api.github.com/repos/JuliaGeo/GDAL.jl/releases/latest](https://api.github.com/repos/JuliaGeo/GDAL.jl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/JuliaGeo/GDAL.jl/releases/latest` at `2026-09-01T08:26:35+00:00`.
...
- `github_search_satcom_satellites-99a987dacd836a` from `github_search_satcom_satellites` as `registry_expansion`
...
| martinber/noaa-apt | Filesystem Os | [open](satcom-satellites-martinber-noaa-apt-d4c032f7.md) |
