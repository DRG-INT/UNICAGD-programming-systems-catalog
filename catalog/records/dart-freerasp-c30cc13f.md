...
<!-- canonical: https://pub.dev/packages/freerasp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/freerasp](https://pub.dev/packages/freerasp) |
| Source record ids | pub_dev-a1a3132c576648 |

## System Engineer Summary

Flutter library for improving app security and threat monitoring on Android and iOS mobile devices.
Learn more about provided features on the freeRASP's homepage first.

## Operational Role

For a systems engineer, freerasp belongs in the Dart inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.2.2 | 2026-08-26T10:35:58.238609Z | [https://pub.dev/api/packages/freerasp](https://pub.dev/api/packages/freerasp) |  |
| preview | known | 5.0.0-dev.1 | 2023-04-28T07:25:20.690404Z | [https://pub.dev/api/packages/freerasp](https://pub.dev/api/packages/freerasp) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/freerasp` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-a1a3132c576648` from `pub_dev` as `registry_expansion`
