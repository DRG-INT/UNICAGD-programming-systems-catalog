...
<!-- canonical: https://github.com/m-r-s/hearingaid-prototype -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/m-r-s/hearingaid-prototype](https://github.com/m-r-s/hearingaid-prototype) |
| Source record ids | github_search_matlab-5a5501481f31ef |
...
For a systems engineer, m-r-s/hearingaid-prototype belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-10-20T09:29:04Z | gh search repos language:MATLAB topic:signal-processing | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-5a5501481f31ef` from `github_search_matlab` as `registry_expansion`
