...
<!-- canonical: https://cran.r-project.org/web/packages/flexmix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flexmix/index.html](https://cran.r-project.org/web/packages/flexmix/index.html) |
| Source record ids | cran_packages_by_date-4455b860449ba5 |
...
For a systems engineer, flexmix belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3-21 | 2026-08-25 21:00:10 UTC | [https://cran.r-project.org/web/packages/flexmix/DESCRIPTION](https://cran.r-project.org/web/packages/flexmix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flexmix/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4455b860449ba5` from `cran_packages_by_date` as `registry_expansion`
