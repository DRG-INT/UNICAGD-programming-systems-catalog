...
<!-- canonical: https://github.com/taberhuang/AudioEffectTools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/taberhuang/AudioEffectTools](https://github.com/taberhuang/AudioEffectTools) |
| Source record ids | github_search_effects-a3ffefbe4b2567 |

## System Engineer Summary

AudioEffectTools is a comprehensive real-time audio effects processing and analysis application
built with the JUCE framework. It provides professional-grade audio effects, real-time
visualization, signal generation, and advanced analysis tools for audio engineers, musicians, and
researchers.

## Operational Role

For a systems engineer, taberhuang/AudioEffectTools belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-27T09:47:52Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a3ffefbe4b2567` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alecdotdev/SpectrumTool | Static Analyzer | [open](effects-alecdotdev-spectrumtool-9a0668a1.md) |
