...
<!-- canonical: https://www.npmjs.com/package/browser-level -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/browser-level](https://www.npmjs.com/package/browser-level) |
| Source record ids | npm_registry-d8a4b90d694595 |
...
For a systems engineer, browser-level belongs in the Node.js/JavaScript inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-04-20T15:50:43.709Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-d8a4b90d694595` from `npm_registry` as `registry_expansion`
