...
<!-- canonical: https://github.com/mpv-player/mpv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mpv-player/mpv](https://github.com/mpv-player/mpv) |
| Source record ids | github_search_video-d36e5ef2b225cc |
...
For a systems engineer, mpv-player/mpv belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:05:08Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d36e5ef2b225cc` from `github_search_video` as `registry_expansion`
