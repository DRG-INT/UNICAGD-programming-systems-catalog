...
<!-- canonical: https://invent.kde.org/education/kstars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://invent.kde.org/education/kstars](https://invent.kde.org/education/kstars) |
| Source record ids | curated_language_routes-0b7d077b90ffd8 |

## System Engineer Summary

Desktop planetarium and observatory-control application with Ekos astrophotography and telescope
automation workflows.

## Operational Role

For a systems engineer, KStars belongs in the Telescopes inventory as part of ecosystem capability
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; {"key": "", "name": "", "url": ""} |
...
- `curated_language_routes-0b7d077b90ffd8` from `curated_language_routes` as `registry_expansion`
