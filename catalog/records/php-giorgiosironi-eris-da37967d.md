...
<!-- canonical: https://packagist.org/packages/giorgiosironi/eris -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/giorgiosironi/eris](https://packagist.org/packages/giorgiosironi/eris) |
| Source record ids | packagist_search-0eff7dcc276b0d |
...
For a systems engineer, giorgiosironi/eris belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-0eff7dcc276b0d` from `packagist_search` as `registry_expansion`
