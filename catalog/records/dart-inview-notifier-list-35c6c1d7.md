...
<!-- canonical: https://pub.dev/packages/inview_notifier_list -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/inview_notifier_list](https://pub.dev/packages/inview_notifier_list) |
| Source record ids | pub_dev-d18689044b4246 |
...
For a systems engineer, inview_notifier_list belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-07-04T09:06:43.514495Z | [https://pub.dev/api/packages/inview_notifier_list](https://pub.dev/api/packages/inview_notifier_list) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/inview_notifier_list` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-d18689044b4246` from `pub_dev` as `registry_expansion`
