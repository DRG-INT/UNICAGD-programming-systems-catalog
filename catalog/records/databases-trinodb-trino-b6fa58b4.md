...
<!-- canonical: https://github.com/trinodb/trino -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/trinodb/trino](https://github.com/trinodb/trino) |
| Source record ids | github_search_databases-925042344b3da6 |

## System Engineer Summary

Official repository of Trino, the distributed SQL query engine for big data, formerly known as
PrestoSQL

## Operational Role

For a systems engineer, trinodb/trino belongs in the Databases inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:55:01Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-925042344b3da6` from `github_search_databases` as `registry_expansion`
