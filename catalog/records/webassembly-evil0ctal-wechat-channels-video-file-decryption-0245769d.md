...
<!-- canonical: https://github.com/Evil0ctal/WeChat-Channels-Video-File-Decryption -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Evil0ctal/WeChat-Channels-Video-File-Decryption](https://github.com/Evil0ctal/WeChat-Channels-Video-File-Decryption) |
| Source record ids | github_search_webassembly-50cf81a9486d7c |

## System Engineer Summary

一个可在线运行的微信视频号加密视频解密工具和 API 服务，基于逆向工程分析实现。本项目使用微信官方的 WebAssembly (WASM) 模块来生成 Isaac64 PRNG 密钥流，并通过
XOR 运算完成视频解密。

## Operational Role

For a systems engineer, Evil0ctal/WeChat-Channels-Video-File-Decryption belongs in the WebAssembly
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T05:34:45Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_webassembly-50cf81a9486d7c` from `github_search_webassembly` as `registry_expansion`
