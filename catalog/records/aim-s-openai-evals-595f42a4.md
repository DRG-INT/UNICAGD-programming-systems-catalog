...
| Canonical URL | [https://github.com/openai/evals](https://github.com/openai/evals) |
| Source record ids | curated_language_routes-0ada8814f88ae5 |

## System Engineer Summary

Evaluation framework and registry route for model and application behavior tests.

## Operational Role

For a systems engineer, OpenAI Evals belongs in the "aim's" inventory as part of unit/integration
...
- `curated_language_routes-0ada8814f88ae5` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Ragas | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-ragas-2b8dde5b.md) |
