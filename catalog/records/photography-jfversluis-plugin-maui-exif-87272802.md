...
<!-- canonical: https://github.com/jfversluis/Plugin.Maui.Exif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jfversluis/Plugin.Maui.Exif](https://github.com/jfversluis/Plugin.Maui.Exif) |
| Source record ids | github_search_photography-c5e19031ed3be6 |

## System Engineer Summary

Plugin.Maui.Exif provides the ability to read EXIF metadata from image files in your .NET MAUI
application.

## Operational Role

For a systems engineer, jfversluis/Plugin.Maui.Exif belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-08T17:32:01Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c5e19031ed3be6` from `github_search_photography` as `registry_expansion`
