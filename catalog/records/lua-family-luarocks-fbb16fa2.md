...
| Canonical URL | [https://luarocks.org/](https://luarocks.org/) |
| Source record ids | lua-source-76, master-bcec4e1d9899 |

## System Engineer Summary

De-facto tool for installing Lua modules as packages called "rocks", plus public rock repository and
website. Much like npm or pip.

## Operational Role

For a systems engineer, LuaRocks belongs in the Lua family inventory as part of dependency
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 76}}` |
...
- `lua-source-76` from `master_json` as `source_list_item`
- `master-bcec4e1d9899` from `master_json` as `package_manager`
...
| lredis | Package Manager | [open](lua-family-lredis-74cb4c6d.md) |
