...
<!-- canonical: https://github.com/Chowdhury-DSP/ChowMatrix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Chowdhury-DSP/ChowMatrix](https://github.com/Chowdhury-DSP/ChowMatrix) |
| Source record ids | github_search_audio-38c06839d4d3d6 |

## System Engineer Summary

Chowdhury-DSP/ChowMatrix is tracked as an image audio dsp record in the Audio branch. The source did
...
For a systems engineer, Chowdhury-DSP/ChowMatrix belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-16T14:37:08Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-38c06839d4d3d6` from `github_search_audio` as `registry_expansion`
