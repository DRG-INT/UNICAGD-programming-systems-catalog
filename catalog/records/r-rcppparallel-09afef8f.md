...
<!-- canonical: https://cran.r-project.org/web/packages/RcppParallel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppParallel/index.html](https://cran.r-project.org/web/packages/RcppParallel/index.html) |
| Source record ids | cran_packages_by_date-a4ea103beea6eb |
...
For a systems engineer, RcppParallel belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.2.1 | 2026-08-27 05:10:40 UTC | [https://cran.r-project.org/web/packages/RcppParallel/DESCRIPTION](https://cran.r-project.org/web/packages/RcppParallel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppParallel/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a4ea103beea6eb` from `cran_packages_by_date` as `registry_expansion`
