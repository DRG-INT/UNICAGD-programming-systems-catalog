...
<!-- canonical: https://cran.r-project.org/web/packages/plssem/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/plssem/index.html](https://cran.r-project.org/web/packages/plssem/index.html) |
| Source record ids | cran_packages_by_date-6814a0b0669b90 |
...
For a systems engineer, plssem belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-24 12:50:02 UTC | [https://cran.r-project.org/web/packages/plssem/DESCRIPTION](https://cran.r-project.org/web/packages/plssem/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/plssem/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6814a0b0669b90` from `cran_packages_by_date` as `registry_expansion`
