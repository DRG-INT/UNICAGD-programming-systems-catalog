...
<!-- canonical: https://cran.r-project.org/web/packages/chestR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chestR/index.html](https://cran.r-project.org/web/packages/chestR/index.html) |
| Source record ids | cran_packages_by_date-617680066e5f5c |
...
For a systems engineer, chestR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 15:10:02 UTC | [https://cran.r-project.org/web/packages/chestR/DESCRIPTION](https://cran.r-project.org/web/packages/chestR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chestR/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-617680066e5f5c` from `cran_packages_by_date` as `registry_expansion`
