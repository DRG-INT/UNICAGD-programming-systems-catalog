...
| Canonical URL | [http://dkolf.de/src/dkjson-lua.fsl/home](http://dkolf.de/src/dkjson-lua.fsl/home) |
| Source record ids | lua-source-249, corpus-e8b7d732baab55 |
...
For a systems engineer, dkjson belongs in the Lua family inventory as part of wire formats,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 249}}` |
...
- `lua-source-249` from `master_json` as `source_list_item`
- `corpus-e8b7d732baab55` from `master_json` as `serialization`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| api7-dkjson | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-dkjson-571ee8d1.md) |
| api7-lua-protobuf | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-protobuf-ef96404b.md) |
| binser | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-binser-e5d044a1.md) |
| busted-jsonl | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-busted-jsonl-0c5a0cb4.md) |
| chandra-toml | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-chandra-toml-81123d9d.md) |
| curriculum_vitae | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-curriculum-vitae-c7ee7b24.md) |
| dev-roshangeorge-ljsonschema | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dev-roshangeorge-ljsonschema-5330b465.md) |
| df-serialize | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-df-serialize-a518c9e6.md) |
