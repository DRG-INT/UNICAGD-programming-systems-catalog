...
<!-- canonical: https://hackage.haskell.org/package/cabal-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-cache](https://hackage.haskell.org/package/cabal-cache) |
| Source record ids | hackage_top_downloads-39721adfac8a06 |
...
For a systems engineer, cabal-cache belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0.0 | 2025-01-22T11:55:11Z | [https://hackage.haskell.org/package/cabal-cache](https://hackage.haskell.org/package/cabal-cache) |  |
| candidate | partial | 1.1.0.0 |  | [https://hackage.haskell.org/package/cabal-cache](https://hackage.haskell.org/package/cabal-cache) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-cache` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-39721adfac8a06` from `hackage_top_downloads` as `registry_expansion`
