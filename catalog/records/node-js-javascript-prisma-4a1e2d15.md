...
| Source record ids | corpus-7577fb3d1787c5 |

## System Engineer Summary

Prisma is tracked as a database datastore record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, Prisma belongs in the Node.js/JavaScript inventory as part of state
...
- `corpus-7577fb3d1787c5` from `master_json` as `database_datastore`
