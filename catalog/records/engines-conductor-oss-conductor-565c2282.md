...
<!-- canonical: https://github.com/conductor-oss/conductor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/conductor-oss/conductor](https://github.com/conductor-oss/conductor) |
| Source record ids | github_search_engines-8dba1336242ce7 |

## System Engineer Summary

Conductor is an event driven agentic workflow engine providing durable and highly resilient
execution engine for applications and AI Agents

## Operational Role

For a systems engineer, conductor-oss/conductor belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:07:52Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-8dba1336242ce7` from `github_search_engines` as `registry_expansion`
