...
<!-- canonical: https://cran.r-project.org/web/packages/logger/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/logger/index.html](https://cran.r-project.org/web/packages/logger/index.html) |
| Source record ids | cran_packages_by_date-ba526b492801ea |
...
For a systems engineer, logger belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2026-08-24 16:20:18 UTC | [https://cran.r-project.org/web/packages/logger/DESCRIPTION](https://cran.r-project.org/web/packages/logger/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/logger/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ba526b492801ea` from `cran_packages_by_date` as `registry_expansion`
