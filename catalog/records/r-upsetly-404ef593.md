...
<!-- canonical: https://cran.r-project.org/web/packages/upsetly/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/upsetly/index.html](https://cran.r-project.org/web/packages/upsetly/index.html) |
| Source record ids | cran_packages_by_date-69c3d8391a949f |

## System Engineer Summary

Interactive UpSet Plots Using 'plotly'

## Operational Role

For a systems engineer, upsetly belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-07 10:40:02 UTC | [https://cran.r-project.org/web/packages/upsetly/DESCRIPTION](https://cran.r-project.org/web/packages/upsetly/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/upsetly/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-69c3d8391a949f` from `cran_packages_by_date` as `registry_expansion`
