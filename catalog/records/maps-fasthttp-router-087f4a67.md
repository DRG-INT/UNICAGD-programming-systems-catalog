...
<!-- canonical: https://github.com/fasthttp/router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fasthttp/router](https://github.com/fasthttp/router) |
| Source record ids | github_search_maps-81d0391b7d053a |
...
For a systems engineer, fasthttp/router belongs in the Maps inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-01T23:00:11Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT No Attribution; https://api.github.com/licenses/mit-0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_maps-81d0391b7d053a` from `github_search_maps` as `registry_expansion`
