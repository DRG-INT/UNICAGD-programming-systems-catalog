...
<!-- canonical: https://luarocks.org/modules/djmax/bcrypt-ffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/djmax/bcrypt-ffi](https://luarocks.org/modules/djmax/bcrypt-ffi) |
| Source record ids | luarocks_root_manifest-6d0c7f7727aff0 |
...
For a systems engineer, bcrypt-ffi belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6d0c7f7727aff0` from `luarocks_root_manifest` as `registry_expansion`
