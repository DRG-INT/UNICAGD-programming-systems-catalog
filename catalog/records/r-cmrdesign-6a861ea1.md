...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/cmrdesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cmrdesign/index.html](https://cran.r-project.org/web/packages/cmrdesign/index.html) |
| Source record ids | cran_packages_by_date-6e5040837cb56e |
...
For a systems engineer, cmrdesign belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:30:02 UTC | [https://cran.r-project.org/web/packages/cmrdesign/DESCRIPTION](https://cran.r-project.org/web/packages/cmrdesign/DESCRIPTION) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cmrdesign/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6e5040837cb56e` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| evalITR | Lint Rule Pack | [open](r-evalitr-3f630caf.md) |
| fluffy | Lint Rule Pack | [open](r-fluffy-84571a64.md) |
