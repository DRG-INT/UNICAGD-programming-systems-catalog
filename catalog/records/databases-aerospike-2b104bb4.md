...
<!-- canonical: https://github.com/aerospike/aerospike-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aerospike/aerospike-server](https://github.com/aerospike/aerospike-server) |
| Source record ids | awesome_list-b6d689dd103030 |
...
For a systems engineer, Aerospike belongs in the Databases inventory as part of ecosystem capability
...
- `awesome_list-b6d689dd103030` from `awesome_list` as `registry_expansion`
