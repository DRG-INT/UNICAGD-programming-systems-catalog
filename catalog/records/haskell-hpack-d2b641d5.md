...
<!-- canonical: https://hackage.haskell.org/package/hpack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hpack](https://hackage.haskell.org/package/hpack) |
| Source record ids | hackage_top_downloads-070d32e5d69bd6 |
...
For a systems engineer, hpack belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.39.6 | 2026-06-06T21:52:03Z | [https://hackage.haskell.org/package/hpack](https://hackage.haskell.org/package/hpack) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hpack` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-070d32e5d69bd6` from `hackage_top_downloads` as `registry_expansion`
