...
<!-- canonical: https://cran.r-project.org/web/packages/wikiprofiler/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wikiprofiler/index.html](https://cran.r-project.org/web/packages/wikiprofiler/index.html) |
| Source record ids | cran_packages_by_date-27089f9602ee2b |

## System Engineer Summary

Data Integration and Visualization on 'WikiPathways' Graphics

## Operational Role

For a systems engineer, wikiprofiler belongs in the R inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-08-25 12:20:02 UTC | [https://cran.r-project.org/web/packages/wikiprofiler/DESCRIPTION](https://cran.r-project.org/web/packages/wikiprofiler/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wikiprofiler/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-27089f9602ee2b` from `cran_packages_by_date` as `registry_expansion`
