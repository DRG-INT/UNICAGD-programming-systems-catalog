...
<!-- canonical: https://github.com/bpisano/Sticker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bpisano/Sticker](https://github.com/bpisano/Sticker) |
| Source record ids | github_search_effects-803c066021477d |

## System Engineer Summary

Holographic sticker effects for SwiftUI views.

## Operational Role

For a systems engineer, bpisano/Sticker belongs in the Effects inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-23T08:02:09Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-803c066021477d` from `github_search_effects` as `registry_expansion`
