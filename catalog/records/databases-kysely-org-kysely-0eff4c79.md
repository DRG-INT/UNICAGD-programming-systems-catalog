...
<!-- canonical: https://github.com/kysely-org/kysely -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kysely-org/kysely](https://github.com/kysely-org/kysely) |
| Source record ids | github_search_databases-cbe824602224cb |
...
For a systems engineer, kysely-org/kysely belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T07:47:05Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Microsoft Public License; https://api.github.com/licenses/ms-pl; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_databases-cbe824602224cb` from `github_search_databases` as `registry_expansion`
