...
<!-- canonical: https://hackage.haskell.org/package/ihaskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ihaskell](https://hackage.haskell.org/package/ihaskell) |
| Source record ids | hackage_top_downloads-a97651e675a20f |
...
For a systems engineer, ihaskell belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0.0 | 2025-11-15T12:58:18Z | [https://hackage.haskell.org/package/ihaskell](https://hackage.haskell.org/package/ihaskell) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ihaskell` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-a97651e675a20f` from `hackage_top_downloads` as `registry_expansion`
