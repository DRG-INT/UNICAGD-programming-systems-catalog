...
| Source record ids | github_search_swift-c7fe6f4d7f9f56 |
...
For a systems engineer, realm/SwiftLint belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T08:54:17Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-c7fe6f4d7f9f56` from `github_search_swift` as `registry_expansion`
