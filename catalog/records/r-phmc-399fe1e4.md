...
<!-- canonical: https://cran.r-project.org/web/packages/pHMC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pHMC/index.html](https://cran.r-project.org/web/packages/pHMC/index.html) |
| Source record ids | cran_packages_by_date-998aec66b9692b |
...
For a systems engineer, pHMC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 12:40:09 UTC | [https://cran.r-project.org/web/packages/pHMC/DESCRIPTION](https://cran.r-project.org/web/packages/pHMC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pHMC/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-998aec66b9692b` from `cran_packages_by_date` as `registry_expansion`
