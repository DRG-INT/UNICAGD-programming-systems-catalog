...
<!-- canonical: https://github.com/enix/kube-image-keeper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/enix/kube-image-keeper](https://github.com/enix/kube-image-keeper) |
| Source record ids | github_search_maps-1613518ee4698f |
...
For a systems engineer, enix/kube-image-keeper belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:37:32Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1613518ee4698f` from `github_search_maps` as `registry_expansion`
