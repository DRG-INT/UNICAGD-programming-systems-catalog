...
<!-- canonical: https://crates.io/crates/slog-async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/slog-async](https://crates.io/crates/slog-async) |
| Source record ids | crates_io-e16318f5220640 |
...
For a systems engineer, slog-async belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0 | 2023-08-26T22:31:33.401865Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-e16318f5220640` from `crates_io` as `registry_expansion`
