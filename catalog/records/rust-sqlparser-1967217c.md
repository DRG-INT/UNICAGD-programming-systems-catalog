...
<!-- canonical: https://crates.io/crates/sqlparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlparser](https://crates.io/crates/sqlparser) |
| Source record ids | crates_io-570cfe7bbfbd2e |
...
For a systems engineer, sqlparser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.63.0 | 2026-09-13T20:07:26.055155Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-13T20:19:20+00:00`.
...
- `crates_io-570cfe7bbfbd2e` from `crates_io` as `registry_expansion`
