...
<!-- canonical: https://github.com/WillyBilly06/BDK-AUDIO-APP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WillyBilly06/BDK-AUDIO-APP](https://github.com/WillyBilly06/BDK-AUDIO-APP) |
| Source record ids | github_search_effects-8cc5a41afe75a5 |

## System Engineer Summary

Android app for ESP32 Bluetooth speaker control. Features DSP/EQ controls, LDAC/aptX/AAC codec
selection, LED matrix effects, real-time audio visualization, OTA firmware updates over BLE. Control
bass boost, channel flip, 3-band equalizer for your DIY Bluetooth speaker project.

## Operational Role

For a systems engineer, WillyBilly06/BDK-AUDIO-APP belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-08T09:56:37Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8cc5a41afe75a5` from `github_search_effects` as `registry_expansion`
