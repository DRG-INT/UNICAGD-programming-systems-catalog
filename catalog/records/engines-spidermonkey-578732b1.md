...
| Canonical URL | [https://spidermonkey.dev/](https://spidermonkey.dev/) |
| Source record ids | curated_language_routes-185b7ac204908e |

## System Engineer Summary

Mozilla JavaScript and WebAssembly engine used for language runtime, embedding, JIT, garbage
collection, and shell tooling.

## Operational Role

For a systems engineer, SpiderMonkey belongs in the Engines inventory as part of ecosystem
...
- `curated_language_routes-185b7ac204908e` from `curated_language_routes` as `registry_expansion`
...
| V8 | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/engines-v8-5c32f69e.md) |
