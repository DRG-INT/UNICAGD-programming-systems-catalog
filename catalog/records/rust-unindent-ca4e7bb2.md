...
<!-- canonical: https://crates.io/crates/unindent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unindent](https://crates.io/crates/unindent) |
| Source record ids | crates_io-f92de1e92c1a05 |
...
For a systems engineer, unindent belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2025-03-03T23:32:26.449483Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-f92de1e92c1a05` from `crates_io` as `registry_expansion`
