...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AuditorySignalUtils](https://github.com/JuliaRegistries/General/tree/master/A/AuditorySignalUtils) |
| Source record ids | julia_general-cd8514981186b4 |

## System Engineer Summary

Julia package registered in General at A/AuditorySignalUtils.

## Operational Role

For a systems engineer, AuditorySignalUtils belongs in the Julia inventory as part of supply-chain
...
| Name | Category | Page |
| --- | --- | --- |
| AuditoryFilters | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-auditoryfilters-f901f6bd.md) |
| AuditoryStimuli | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-auditorystimuli-b3292292.md) |
