...
| Canonical URL | [https://www.npmjs.com/package/prettier](https://www.npmjs.com/package/prettier) |
| Source record ids | master-cba34c677d33, npm_registry-2304b603f66bea |

## System Engineer Summary

Prettier is tracked as a formatter record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Prettier belongs in the Node.js/JavaScript inventory as part of low-noise
...
- `master-cba34c677d33` from `master_json` as `formatter`
- `npm_registry-2304b603f66bea` from `npm_registry` as `registry_expansion`
