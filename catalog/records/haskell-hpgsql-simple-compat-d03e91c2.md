...
<!-- canonical: https://hackage.haskell.org/package/hpgsql-simple-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hpgsql-simple-compat](https://hackage.haskell.org/package/hpgsql-simple-compat) |
| Source record ids | hackage_recent-9259bbdab92e2c |
...
For a systems engineer, hpgsql-simple-compat belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-03T18:54:16Z | [https://hackage.haskell.org/package/hpgsql-simple-compat](https://hackage.haskell.org/package/hpgsql-simple-compat) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hpgsql-simple-compat` at `2026-09-04T13:25:57+00:00`.
...
- `hackage_recent-9259bbdab92e2c` from `hackage_recent` as `registry_expansion`
