...
<!-- canonical: https://hackage.haskell.org/package/ppad-aead -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ppad-aead](https://hackage.haskell.org/package/ppad-aead) |
| Source record ids | hackage_recent-1f5b1e2f93bac6 |

## System Engineer Summary

Hackage package recently uploaded by JaredTobin.

## Operational Role

For a systems engineer, ppad-aead belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2026-09-06T14:47:43Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-1f5b1e2f93bac6` from `hackage_recent` as `registry_expansion`
