...
| Source record ids | corpus-b4afcf5bfd64fd |

## System Engineer Summary

ast is tracked as a parser lexer ast record in the Python branch. The source did not provide a long
...
For a systems engineer, ast belongs in the Python inventory as part of language tooling, code
...
- `corpus-b4afcf5bfd64fd` from `master_json` as `parser_lexer_ast`
