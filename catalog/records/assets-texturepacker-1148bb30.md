...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.codeandweb.com/texturepacker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.codeandweb.com/texturepacker](https://www.codeandweb.com/texturepacker) |
| Source record ids | curated_language_routes-4b02a019079d64 |

## System Engineer Summary

Atlas packing tool for sprite sheets, textures, game assets, and runtime loaders.

## Operational Role

For a systems engineer, TexturePacker belongs in the Assets inventory as part of ecosystem
...
- `curated_language_routes-4b02a019079d64` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adobe/asset-share-commons | Visualization Gui | [open](assets-adobe-asset-share-commons-3e73fd7b.md) |
| boytchev/texture-generator | Visualization Gui | [open](assets-boytchev-texture-generator-6e229ec9.md) |
| czyzby/gdx-skins | Visualization Gui | [open](assets-czyzby-gdx-skins-ff760b10.md) |
| FreeType | Visualization Gui | [open](assets-freetype-5b5024ee.md) |
| HarfBuzz | Visualization Gui | [open](assets-harfbuzz-3fcb7bfa.md) |
| martinhodler/unity-aseprite-importer | Visualization Gui | [open](assets-martinhodler-unity-aseprite-importer-30b49df4.md) |
| mopsicus/uis | Visualization Gui | [open](assets-mopsicus-uis-65c71459.md) |
| quiple/galmuri | Visualization Gui | [open](assets-quiple-galmuri-cb71a160.md) |
