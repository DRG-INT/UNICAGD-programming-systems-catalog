# ibtissamelhani/Maska_Hunter_League
...
<!-- canonical: https://github.com/ibtissamelhani/Maska_Hunter_League -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ibtissamelhani/Maska_Hunter_League](https://github.com/ibtissamelhani/Maska_Hunter_League) |
| Source record ids | github_search_repertoare_catalogs-e5d26881d1a343 |

## System Engineer Summary

Hunter's League is a web app for the Maska Hunting Club to manage competitions, member
registrations, scores, and species cataloging. It streamlines processes for administrators, jury,
and participants while enhancing the competition experience.

## Operational Role

For a systems engineer, ibtissamelhani/Maska_Hunter_League belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-20T10:14:01Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-e5d26881d1a343` from `github_search_repertoare_catalogs` as `registry_expansion`
