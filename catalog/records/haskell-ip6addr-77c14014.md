...
<!-- canonical: https://hackage.haskell.org/package/ip6addr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ip6addr](https://hackage.haskell.org/package/ip6addr) |
| Source record ids | hackage_top_downloads-5d9e3df982f7cc |
...
For a systems engineer, ip6addr belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1.0 | 2026-06-11T09:56:55Z | [https://hackage.haskell.org/package/ip6addr](https://hackage.haskell.org/package/ip6addr) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ip6addr` at `2026-09-09T00:35:04+00:00`.
...
- `hackage_top_downloads-5d9e3df982f7cc` from `hackage_top_downloads` as `registry_expansion`
