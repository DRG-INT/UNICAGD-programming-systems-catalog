...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/google_maps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_maps](https://pub.dev/packages/google_maps) |
| Source record ids | pub_dev-8a718903ef636b |
...
For a systems engineer, google_maps belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.3.0 | 2026-07-28T20:22:21.160518Z | [https://pub.dev/api/packages/google_maps](https://pub.dev/api/packages/google_maps) |  |
| preview | known | 8.0.0-dev.4 | 2024-07-24T20:27:56.322621Z | [https://pub.dev/api/packages/google_maps](https://pub.dev/api/packages/google_maps) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_maps` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-8a718903ef636b` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| change_case | Api Abi Checker | [open](dart-change-case-c7b30550.md) |
| flutter_gen | Api Abi Checker | [open](dart-flutter-gen-7700f9d0.md) |
| flutter_gen_runner | Api Abi Checker | [open](dart-flutter-gen-runner-361e1f84.md) |
| puppeteer | Api Abi Checker | [open](dart-puppeteer-51dd17f5.md) |
| search_cep | Api Abi Checker | [open](dart-search-cep-81ce75c2.md) |
