...
<!-- canonical: https://packagist.org/packages/willdurand/jsonp-callback-validator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/willdurand/jsonp-callback-validator](https://packagist.org/packages/willdurand/jsonp-callback-validator) |
| Source record ids | packagist_search-7d75b81571d1c7 |
...
For a systems engineer, willdurand/jsonp-callback-validator belongs in the PHP inventory as part of
...
- `packagist_search-7d75b81571d1c7` from `packagist_search` as `registry_expansion`
