...
<!-- canonical: https://www.nuget.org/packages/Json.More.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Json.More.Net](https://www.nuget.org/packages/Json.More.Net) |
| Source record ids | nuget_search-5f6dfa25673982 |
...
For a systems engineer, Json.More.Net belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-03-15T02:23:28.907+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/json.more.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/json.more.net/index.json) |  |
| preview | known | 1.0.0-rc2 | 2020-08-29T11:32:47.037+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/json.more.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/json.more.net/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; https://www.nuget.org/packages/Json.More.Net/3.0.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/json.more.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-5f6dfa25673982` from `nuget_search` as `registry_expansion`
