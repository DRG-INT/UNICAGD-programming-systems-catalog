...
| Canonical URL | [https://luarocks.org/modules/catwell/fakeredis](https://luarocks.org/modules/catwell/fakeredis) |
| Source record ids | luarocks_root_manifest-067773157b0ace |

## System Engineer Summary

fakeredis is tracked as an assertion mocking record in the Lua family branch. The source did not
...
For a systems engineer, fakeredis belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-067773157b0ace` from `luarocks_root_manifest` as `registry_expansion`
