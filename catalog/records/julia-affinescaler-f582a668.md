...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Ffi Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ffi-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AffineScaler](https://github.com/JuliaRegistries/General/tree/master/A/AffineScaler) |
| Source record ids | julia_general-1332f67a13d4a6 |

## System Engineer Summary

Julia package registered in General at A/AffineScaler.

## Operational Role

For a systems engineer, AffineScaler belongs in the Julia inventory as part of cross-language
...
| Name | Category | Page |
| --- | --- | --- |
| AffineArithmetic | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-affinearithmetic-ad8a577c.md) |
| AffineInvariantMCMC | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-affineinvariantmcmc-7da861f2.md) |
| AffineMaps | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-affinemaps-dfd98495.md) |
| AffineMotions | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-affinemotions-475592a7.md) |
| AGFFileReader | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-agffilereader-d1339cfa.md) |
| ARFFFiles | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arfffiles-e84f6f50.md) |
| CBinding | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cbinding-3560cfb0.md) |
| CBindingGen | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cbindinggen-28425910.md) |
