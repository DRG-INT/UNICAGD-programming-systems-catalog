...
| Canonical URL | [https://gitlab.freedesktop.org/gstreamer/gst-editing-services](https://gitlab.freedesktop.org/gstreamer/gst-editing-services) |
| Source record ids | curated_language_routes-082f115ef44cb7 |

## System Engineer Summary

Timeline and editing framework for media effects, transitions, clips, and rendering pipelines.

## Operational Role

For a systems engineer, GStreamer Editing Services belongs in the Effects inventory as part of
...
- `curated_language_routes-082f115ef44cb7` from `curated_language_routes` as `registry_expansion`
...
| JUCE | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-juce-9b93c4b7.md) |
