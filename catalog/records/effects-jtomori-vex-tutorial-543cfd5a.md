...
<!-- canonical: https://github.com/jtomori/vex_tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jtomori/vex_tutorial](https://github.com/jtomori/vex_tutorial) |
| Source record ids | github_search_effects-e286ce5ab48f16 |

## System Engineer Summary

:bookmark_tabs: A collection of code snippets and examples showing syntax and capabilities of VEX
language inside SideFX Houdini

## Operational Role

For a systems engineer, jtomori/vex_tutorial belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-27T23:21:48Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e286ce5ab48f16` from `github_search_effects` as `registry_expansion`
