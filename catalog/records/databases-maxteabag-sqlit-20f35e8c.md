...
<!-- canonical: https://github.com/Maxteabag/sqlit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Maxteabag/sqlit](https://github.com/Maxteabag/sqlit) |
| Source record ids | github_search_databases-f39bb7f9d3d30b |

## System Engineer Summary

A user friendly TUI for SQL databases. Written in python. Supports SQL server, Mysql, PostreSQL,
SQLite, Turso and more.

## Operational Role

For a systems engineer, Maxteabag/sqlit belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T01:09:18Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f39bb7f9d3d30b` from `github_search_databases` as `registry_expansion`
