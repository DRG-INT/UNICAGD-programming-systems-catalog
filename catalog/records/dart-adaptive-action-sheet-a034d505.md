...
<!-- canonical: https://pub.dev/packages/adaptive_action_sheet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/adaptive_action_sheet](https://pub.dev/packages/adaptive_action_sheet) |
| Source record ids | pub_dev-f8ce62b9da1d8d |
...
For a systems engineer, adaptive_action_sheet belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.4 | 2025-02-21T08:28:44.502535Z | [https://pub.dev/api/packages/adaptive_action_sheet](https://pub.dev/api/packages/adaptive_action_sheet) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/adaptive_action_sheet` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-f8ce62b9da1d8d` from `pub_dev` as `registry_expansion`
