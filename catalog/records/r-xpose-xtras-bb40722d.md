...
<!-- canonical: https://cran.r-project.org/web/packages/xpose.xtras/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xpose.xtras/index.html](https://cran.r-project.org/web/packages/xpose.xtras/index.html) |
| Source record ids | cran_packages_by_date-a45956b178bd2a |
...
For a systems engineer, xpose.xtras belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-01 10:10:03 UTC | [https://cran.r-project.org/web/packages/xpose.xtras/DESCRIPTION](https://cran.r-project.org/web/packages/xpose.xtras/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xpose.xtras/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-a45956b178bd2a` from `cran_packages_by_date` as `registry_expansion`
