...
<!-- canonical: https://cran.r-project.org/web/packages/studyStrap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/studyStrap/index.html](https://cran.r-project.org/web/packages/studyStrap/index.html) |
| Source record ids | cran_packages_by_date-96565a30b2360e |
...
For a systems engineer, studyStrap belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-14 23:40:02 UTC | [https://cran.r-project.org/web/packages/studyStrap/DESCRIPTION](https://cran.r-project.org/web/packages/studyStrap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/studyStrap/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-96565a30b2360e` from `cran_packages_by_date` as `registry_expansion`
