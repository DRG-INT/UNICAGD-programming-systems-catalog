...
<!-- canonical: https://github.com/python-pillow/Pillow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/python-pillow/Pillow](https://github.com/python-pillow/Pillow) |
| Source record ids | github_search_photography-c23844b2d79b0b |
...
For a systems engineer, python-pillow/Pillow belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:42:35Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c23844b2d79b0b` from `github_search_photography` as `registry_expansion`
