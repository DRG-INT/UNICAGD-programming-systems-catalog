...
<!-- canonical: https://hackage.haskell.org/package/fix-imports -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fix-imports](https://hackage.haskell.org/package/fix-imports) |
| Source record ids | hackage_top_downloads-19b0d89e8b8566 |
...
For a systems engineer, fix-imports belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2025-02-16T12:53:28Z | [https://hackage.haskell.org/package/fix-imports](https://hackage.haskell.org/package/fix-imports) |  |
| candidate | partial | 2.3.0 |  | [https://hackage.haskell.org/package/fix-imports](https://hackage.haskell.org/package/fix-imports) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fix-imports` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-19b0d89e8b8566` from `hackage_top_downloads` as `registry_expansion`
