...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ikpil/Box2D.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ikpil/Box2D.NET](https://github.com/ikpil/Box2D.NET) |
| Source record ids | github_search_physics_engines-e06c5b2d8088ed |
...
For a systems engineer, ikpil/Box2D.NET belongs in the Physics Engines inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T15:36:19Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e06c5b2d8088ed` from `github_search_physics_engines` as `registry_expansion`
