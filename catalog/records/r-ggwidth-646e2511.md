...
<!-- canonical: https://cran.r-project.org/web/packages/ggwidth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggwidth/index.html](https://cran.r-project.org/web/packages/ggwidth/index.html) |
| Source record ids | cran_packages_by_date-8a6fb62c74917c |

## System Engineer Summary

Publication-Quality 'ggplot2' Geom Width

## Operational Role

For a systems engineer, ggwidth belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-10 23:40:02 UTC | [https://cran.r-project.org/web/packages/ggwidth/DESCRIPTION](https://cran.r-project.org/web/packages/ggwidth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggwidth/DESCRIPTION` at `2026-09-11T00:27:28+00:00`.
...
- `cran_packages_by_date-8a6fb62c74917c` from `cran_packages_by_date` as `registry_expansion`
