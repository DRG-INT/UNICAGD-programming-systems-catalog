...
<!-- canonical: https://cran.r-project.org/web/packages/qrfactor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qrfactor/index.html](https://cran.r-project.org/web/packages/qrfactor/index.html) |
| Source record ids | cran_packages_by_date-4f7bd5dc12a158 |
...
For a systems engineer, qrfactor belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6 | 2026-09-15 11:00:17 UTC | [https://cran.r-project.org/web/packages/qrfactor/DESCRIPTION](https://cran.r-project.org/web/packages/qrfactor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qrfactor/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-4f7bd5dc12a158` from `cran_packages_by_date` as `registry_expansion`
