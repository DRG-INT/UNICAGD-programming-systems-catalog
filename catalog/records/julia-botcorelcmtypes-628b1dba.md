...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BotCoreLCMTypes](https://github.com/JuliaRegistries/General/tree/master/B/BotCoreLCMTypes) |
| Source record ids | julia_general-189b44c25c087c |

## System Engineer Summary

Julia package registered in General at B/BotCoreLCMTypes.

## Operational Role

For a systems engineer, BotCoreLCMTypes belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BotCoreLCMTypes", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-189b44c25c087c` from `julia_general` as `registry_expansion`
