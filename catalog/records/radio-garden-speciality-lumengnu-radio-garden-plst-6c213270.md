...
<!-- canonical: https://github.com/LumenGNU/radio_garden_plst -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LumenGNU/radio_garden_plst](https://github.com/LumenGNU/radio_garden_plst) |
| Source record ids | github_search_radio_garden_speciality-b4f16db416099d |

## System Engineer Summary

RadioGarden — это веб-сервис, который позволяет пользователям слушать радиостанции со всего мира.
Основной элемент интерфейса — виртуальный глобус, на котором можно выбирать страны и города для
прослушивания локальных радиостанций. Это интерактивный и уникальный способ исследовать
радиокультуру разных стран.

## Operational Role

For a systems engineer, LumenGNU/radio_garden_plst belongs in the Radio Garden Speciality inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-18T18:36:12Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-b4f16db416099d` from `github_search_radio_garden_speciality` as `registry_expansion`
