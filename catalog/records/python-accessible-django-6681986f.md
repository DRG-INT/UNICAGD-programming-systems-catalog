...
<!-- canonical: https://pypi.org/project/accessible-django/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accessible-django/](https://pypi.org/project/accessible-django/) |
| Source record ids | pypi_simple-cd6d35a34b2f89 |
...
For a systems engineer, accessible-django belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2024-12-03T01:06:20.475886Z | [https://pypi.org/pypi/accessible-django/json](https://pypi.org/pypi/accessible-django/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accessible-django/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-cd6d35a34b2f89` from `pypi_simple` as `registry_expansion`
