...
<!-- canonical: https://github.com/TrunkRecorder/trunk-recorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TrunkRecorder/trunk-recorder](https://github.com/TrunkRecorder/trunk-recorder) |
| Source record ids | github_search_electromagnetoscopes-13b7836da4404d |
...
For a systems engineer, TrunkRecorder/trunk-recorder belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.2.1 | 2026-04-08T02:03:57Z | [https://api.github.com/repos/TrunkRecorder/trunk-recorder/releases/latest](https://api.github.com/repos/TrunkRecorder/trunk-recorder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/TrunkRecorder/trunk-recorder/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-13b7836da4404d` from `github_search_electromagnetoscopes` as `registry_expansion`
