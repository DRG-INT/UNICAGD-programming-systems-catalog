...
<!-- canonical: https://luarocks.org/modules/glenn/ai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/glenn/ai](https://luarocks.org/modules/glenn/ai) |
| Source record ids | luarocks_root_manifest-78b30c5ddd1f43 |

## System Engineer Summary

ai is tracked as a machine learning record in the Lua family branch. The source did not provide a
...
For a systems engineer, ai belongs in the Lua family inventory as part of model pipelines, numerical
...
- `luarocks_root_manifest-78b30c5ddd1f43` from `luarocks_root_manifest` as `registry_expansion`
