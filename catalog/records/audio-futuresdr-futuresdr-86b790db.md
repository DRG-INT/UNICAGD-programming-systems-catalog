...
| Source record ids | github_search_audio-1eb3ff7ab574d4 |
...
For a systems engineer, FutureSDR/FutureSDR belongs in the Audio inventory as part of runtime
...
- `github_search_audio-1eb3ff7ab574d4` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gtreshchev/RuntimeSpeechRecognizer | Interpreter Runtime | [open](audio-gtreshchev-runtimespeechrecognizer-efab0aa5.md) |
