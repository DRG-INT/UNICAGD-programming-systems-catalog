...
| Canonical URL | [https://crates.io/crates/tauri-runtime](https://crates.io/crates/tauri-runtime) |
| Source record ids | crates_io-5a7feee4dd0867 |
...
For a systems engineer, tauri-runtime belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.3 | 2026-06-17T13:43:45.580791Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-5a7feee4dd0867` from `crates_io` as `registry_expansion`
