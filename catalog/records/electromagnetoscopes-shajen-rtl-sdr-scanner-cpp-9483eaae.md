...
| Source record ids | github_search_electromagnetoscopes-5f9e22140885df |

## System Engineer Summary

shajen/rtl-sdr-scanner-cpp is tracked as a static analyzer record in the Electromagnetoscopes
...
For a systems engineer, shajen/rtl-sdr-scanner-cpp belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.5 | 2023-02-15T16:22:43Z | [https://api.github.com/repos/shajen/rtl-sdr-scanner-cpp/releases/latest](https://api.github.com/repos/shajen/rtl-sdr-scanner-cpp/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/shajen/rtl-sdr-scanner-cpp/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-5f9e22140885df` from `github_search_electromagnetoscopes` as `registry_expansion`
