...
<!-- canonical: https://github.com/mlflow/mlflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mlflow/mlflow](https://github.com/mlflow/mlflow) |
| Source record ids | curated_language_routes-63d18c5cc1cb52 |

## System Engineer Summary

Machine-learning lifecycle platform for experiments, model registry, packaging, deployment, and
tracking.

## Operational Role

For a systems engineer, MLflow belongs in the "aim's" inventory as part of diagnostics, metrics,
...
- `curated_language_routes-63d18c5cc1cb52` from `curated_language_routes` as `registry_expansion`
...
| OpenTelemetry Semantic Conventions For GenAI | Logging Observability | [open](aim-s-opentelemetry-semantic-conventions-for-genai-e834f611.md) |
