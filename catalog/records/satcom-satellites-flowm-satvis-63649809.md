...
<!-- canonical: https://github.com/Flowm/satvis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Flowm/satvis](https://github.com/Flowm/satvis) |
| Source record ids | github_search_satcom_satellites-1dda2237f812fa |

## System Engineer Summary

3D satellite tracker and pass predictor. 12,000+ satellites live on a globe or in a compass-aimed
sky view, from CelesTrak element sets. Built with CesiumJS and Vue.

## Operational Role

For a systems engineer, Flowm/satvis belongs in the SatCom Satellites inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T03:46:41Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-1dda2237f812fa` from `github_search_satcom_satellites` as `registry_expansion`
