...
<!-- canonical: https://github.com/afollestad/aesthetic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/afollestad/aesthetic](https://github.com/afollestad/aesthetic) |
| Source record ids | github_search_engines-ddd2e5ba214a21 |

## System Engineer Summary

afollestad/aesthetic is tracked as a game engine game dev record in the Engines branch. The source
...
For a systems engineer, afollestad/aesthetic belongs in the Engines inventory as part of ecosystem
...
- `github_search_engines-ddd2e5ba214a21` from `github_search_engines` as `registry_expansion`
