...
<!-- canonical: https://crates.io/crates/icu_locid_transform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_locid_transform](https://crates.io/crates/icu_locid_transform) |
| Source record ids | crates_io-33f3af57ec9a73 |

## System Engineer Summary

icu_locid_transform is tracked as a precommit ci quality record in the Rust branch. The source did
...
For a systems engineer, icu_locid_transform belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-10-14T23:48:39.140863Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-33f3af57ec9a73` from `crates_io` as `registry_expansion`
