...
<!-- canonical: https://cran.r-project.org/web/packages/LABTNSCPSS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LABTNSCPSS/index.html](https://cran.r-project.org/web/packages/LABTNSCPSS/index.html) |
| Source record ids | cran_packages_by_date-99863bd7be0717 |
...
For a systems engineer, LABTNSCPSS belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-05 15:50:14 UTC | [https://cran.r-project.org/web/packages/LABTNSCPSS/DESCRIPTION](https://cran.r-project.org/web/packages/LABTNSCPSS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LABTNSCPSS/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-99863bd7be0717` from `cran_packages_by_date` as `registry_expansion`
