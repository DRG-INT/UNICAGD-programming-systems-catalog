...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/agregR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/agregR/index.html](https://cran.r-project.org/web/packages/agregR/index.html) |
| Source record ids | cran_packages_by_date-d70b106dabce75 |
...
For a systems engineer, agregR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-21 20:50:02 UTC | [https://cran.r-project.org/web/packages/agregR/DESCRIPTION](https://cran.r-project.org/web/packages/agregR/DESCRIPTION) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/agregR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
| --- | --- | --- | --- |
| cran_available_packages_by_date | registry-derived | 2026-09-12 | `{"kind": "cran_available_packages_by_date", "retrieved": "2026-09-12", "status": "registry-derived"}` |
...
- `cran_packages_by_date-d70b106dabce75` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| autoslider.core | Ide Editor Integration | [open](r-autoslider-core-50e0c8df.md) |
| BayesianFitForecast | Ide Editor Integration | [open](r-bayesianfitforecast-7c579244.md) |
| BayesPIM | Ide Editor Integration | [open](r-bayespim-f7ef824c.md) |
| biobouncer | Ide Editor Integration | [open](r-biobouncer-85fc7216.md) |
| bpAcc | Ide Editor Integration | [open](r-bpacc-8fc81132.md) |
| compost | Ide Editor Integration | [open](r-compost-db3bd52a.md) |
| confidenceSim | Ide Editor Integration | [open](r-confidencesim-2c03aed8.md) |
| dsdp | Ide Editor Integration | [open](r-dsdp-3362b407.md) |
