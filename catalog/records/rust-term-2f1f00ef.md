...
<!-- canonical: https://crates.io/crates/term -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/term](https://crates.io/crates/term) |
| Source record ids | crates_io-9a59faeffce6fe |
...
For a systems engineer, term belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2025-12-06T16:40:14.525516Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-9a59faeffce6fe` from `crates_io` as `registry_expansion`
