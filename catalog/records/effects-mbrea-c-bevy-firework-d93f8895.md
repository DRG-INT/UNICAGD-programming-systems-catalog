...
<!-- canonical: https://github.com/mbrea-c/bevy_firework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbrea-c/bevy_firework](https://github.com/mbrea-c/bevy_firework) |
| Source record ids | github_search_effects-90e8b05a31d362 |
...
For a systems engineer, mbrea-c/bevy_firework belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-25T13:49:33Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-90e8b05a31d362` from `github_search_effects` as `registry_expansion`
