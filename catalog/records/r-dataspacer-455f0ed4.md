...
<!-- canonical: https://cran.r-project.org/web/packages/DataSpaceR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DataSpaceR/index.html](https://cran.r-project.org/web/packages/DataSpaceR/index.html) |
| Source record ids | cran_packages_by_date-69c83b49bd7d3d |
...
For a systems engineer, DataSpaceR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-26 23:50:02 UTC | [https://cran.r-project.org/web/packages/DataSpaceR/DESCRIPTION](https://cran.r-project.org/web/packages/DataSpaceR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DataSpaceR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-69c83b49bd7d3d` from `cran_packages_by_date` as `registry_expansion`
