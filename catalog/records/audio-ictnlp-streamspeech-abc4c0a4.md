...
<!-- canonical: https://github.com/ictnlp/StreamSpeech -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ictnlp/StreamSpeech](https://github.com/ictnlp/StreamSpeech) |
| Source record ids | github_search_audio-381db579c2c39d |

## System Engineer Summary

StreamSpeech is an “All in One” seamless model for offline and simultaneous speech recognition,
speech translation and speech synthesis.

## Operational Role

For a systems engineer, ictnlp/StreamSpeech belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-29T02:06:27Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-381db579c2c39d` from `github_search_audio` as `registry_expansion`
