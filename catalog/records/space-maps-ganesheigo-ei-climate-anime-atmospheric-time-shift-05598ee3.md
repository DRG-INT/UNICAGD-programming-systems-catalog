# GaneshEiGo/ei-climate-anime-atmospheric-time-shift
...
<!-- canonical: https://github.com/GaneshEiGo/ei-climate-anime-atmospheric-time-shift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GaneshEiGo/ei-climate-anime-atmospheric-time-shift](https://github.com/GaneshEiGo/ei-climate-anime-atmospheric-time-shift) |
| Source record ids | github_search_space_maps-3fdab16b65cc8b |

## System Engineer Summary

Ei Climate — A 2D anime-style planetary weather explorer where the entire Earth map dynamically
shifts to represent atmospheric conditions for any selected time, from minutes ahead to specific
future dates, allowing users to visually explore how weather systems evolve across the planet.

## Operational Role

For a systems engineer, GaneshEiGo/ei-climate-anime-atmospheric-time-shift belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-09T18:49:33Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-3fdab16b65cc8b` from `github_search_space_maps` as `registry_expansion`
...
| yagiz-aydin/nx-galaxy | Cli | [open](space-maps-yagiz-aydin-nx-galaxy-a8e7323b.md) |
