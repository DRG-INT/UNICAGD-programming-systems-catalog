...
<!-- canonical: https://github.com/ViTAE-Transformer/SAMRS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ViTAE-Transformer/SAMRS](https://github.com/ViTAE-Transformer/SAMRS) |
| Source record ids | github_search_radars-e9bd9cbd468373 |

## System Engineer Summary

The official repo for NeurIPS'23 "SAMRS: Scaling-up Remote Sensing Segmentation Dataset with Segment
Anything Model"

## Operational Role

For a systems engineer, ViTAE-Transformer/SAMRS belongs in the Radars inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-05T12:00:03Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e9bd9cbd468373` from `github_search_radars` as `registry_expansion`
...
| justchenhao/STANet | Ffi Bindings | [open](radars-justchenhao-stanet-97884be0.md) |
