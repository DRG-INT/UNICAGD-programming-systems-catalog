...
<!-- canonical: https://hackage.haskell.org/package/git-monitor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/git-monitor](https://hackage.haskell.org/package/git-monitor) |
| Source record ids | hackage_top_downloads-a211b7cec39265 |
...
For a systems engineer, git-monitor belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2025-12-12T23:32:43Z | [https://hackage.haskell.org/package/git-monitor](https://hackage.haskell.org/package/git-monitor) |  |
| candidate | partial | 3.2.1 |  | [https://hackage.haskell.org/package/git-monitor](https://hackage.haskell.org/package/git-monitor) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/git-monitor` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-a211b7cec39265` from `hackage_top_downloads` as `registry_expansion`
