...
<!-- canonical: https://cran.r-project.org/web/packages/numops/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/numops/index.html](https://cran.r-project.org/web/packages/numops/index.html) |
| Source record ids | cran_packages_by_date-2102603ba5dfd2 |
...
For a systems engineer, numops belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-08 13:40:18 UTC | [https://cran.r-project.org/web/packages/numops/DESCRIPTION](https://cran.r-project.org/web/packages/numops/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/numops/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-2102603ba5dfd2` from `cran_packages_by_date` as `registry_expansion`
