...
<!-- canonical: https://github.com/takushun-wu/WenJinMincho -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/takushun-wu/WenJinMincho](https://github.com/takushun-wu/WenJinMincho) |
| Source record ids | github_search_font_briefcase-3d4d34549c4aa1 |

## System Engineer Summary

可免费商用的大字符集宋体字库，以OFL协议发布。/A large character set fonts in Songti(Mincho) style. Licensed under the SIL
OFL 1.1.

## Operational Role

For a systems engineer, takushun-wu/WenJinMincho belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T05:37:59Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-3d4d34549c4aa1` from `github_search_font_briefcase` as `registry_expansion`
