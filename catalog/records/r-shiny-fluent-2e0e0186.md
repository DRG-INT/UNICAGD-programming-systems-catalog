...
<!-- canonical: https://cran.r-project.org/web/packages/shiny.fluent/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shiny.fluent/index.html](https://cran.r-project.org/web/packages/shiny.fluent/index.html) |
| Source record ids | cran_packages_by_date-3cabe96e9a81cb |
...
For a systems engineer, shiny.fluent belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-21 13:00:02 UTC | [https://cran.r-project.org/web/packages/shiny.fluent/DESCRIPTION](https://cran.r-project.org/web/packages/shiny.fluent/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shiny.fluent/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3cabe96e9a81cb` from `cran_packages_by_date` as `registry_expansion`
