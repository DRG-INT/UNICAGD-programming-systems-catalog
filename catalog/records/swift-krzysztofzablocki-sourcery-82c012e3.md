...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/krzysztofzablocki/Sourcery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krzysztofzablocki/Sourcery](https://github.com/krzysztofzablocki/Sourcery) |
| Source record ids | github_search_swift-72290b62db71af |
...
For a systems engineer, krzysztofzablocki/Sourcery belongs in the Swift inventory as part of
...
- `github_search_swift-72290b62db71af` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| iOS project template | Project Scaffolding | [open](swift-ios-project-template-a7229a2a.md) |
| Model-View-Presenter template | Project Scaffolding | [open](swift-model-view-presenter-template-5ef880b0.md) |
| Swift Module Template | Project Scaffolding | [open](swift-swift-module-template-48451d3a.md) |
| SwiftGen/SwiftGen | Project Scaffolding | [open](swift-swiftgen-swiftgen-7cc10ec0.md) |
