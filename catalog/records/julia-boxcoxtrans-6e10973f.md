...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoxCoxTrans](https://github.com/JuliaRegistries/General/tree/master/B/BoxCoxTrans) |
| Source record ids | julia_general-44545df782b553 |

## System Engineer Summary

Julia package registered in General at B/BoxCoxTrans.

## Operational Role

For a systems engineer, BoxCoxTrans belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoxCoxTrans", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-44545df782b553` from `julia_general` as `registry_expansion`
