...
<!-- canonical: https://hackage.haskell.org/package/stringsearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stringsearch](https://hackage.haskell.org/package/stringsearch) |
| Source record ids | hackage_top_downloads-539461d7cd7ff9 |
...
For a systems engineer, stringsearch belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6.6 | 2015-03-28T23:05:19Z | [https://hackage.haskell.org/package/stringsearch](https://hackage.haskell.org/package/stringsearch) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stringsearch` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-539461d7cd7ff9` from `hackage_top_downloads` as `registry_expansion`
