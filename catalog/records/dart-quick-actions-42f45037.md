...
<!-- canonical: https://pub.dev/packages/quick_actions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/quick_actions](https://pub.dev/packages/quick_actions) |
| Source record ids | pub_dev-39423cbb390f00 |

## System Engineer Summary

Flutter plugin for creating shortcuts on home screen, also known as Quick Actions on iOS and App
Shortcuts on Android.

## Operational Role

For a systems engineer, quick_actions belongs in the Dart inventory as part of ecosystem capability
...
- `pub_dev-39423cbb390f00` from `pub_dev` as `registry_expansion`
