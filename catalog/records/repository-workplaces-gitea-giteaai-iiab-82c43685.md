...
<!-- canonical: https://gitea.com/GiteaAi/iiab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/GiteaAi/iiab](https://gitea.com/GiteaAi/iiab) |
| Source record ids | gitea_repositories_api-7e52272a23ccd0 |
...
For a systems engineer, Gitea: GiteaAi/iiab belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-30T09:20:03Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-7e52272a23ccd0` from `gitea_repositories_api` as `registry_expansion`
