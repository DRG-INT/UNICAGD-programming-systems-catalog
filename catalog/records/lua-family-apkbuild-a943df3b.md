...
<!-- canonical: https://luarocks.org/modules/durrendal/apkbuild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/durrendal/apkbuild](https://luarocks.org/modules/durrendal/apkbuild) |
| Source record ids | luarocks_root_manifest-800b2c8eb38503 |

## System Engineer Summary

An LPEG grammar aimed at parsing Alpine Linux APKBUILD files.

## Operational Role

For a systems engineer, apkbuild belongs in the Lua family inventory as part of build graph control,
...
- `luarocks_root_manifest-800b2c8eb38503` from `luarocks_root_manifest` as `registry_expansion`
