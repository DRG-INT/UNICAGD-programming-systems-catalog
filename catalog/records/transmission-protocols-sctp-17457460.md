...
<!-- canonical: https://www.rfc-editor.org/rfc/rfc9260.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc9260.html](https://www.rfc-editor.org/rfc/rfc9260.html) |
| Source record ids | curated_language_routes-5504ef5f16681a |

## System Engineer Summary

Stream Control Transmission Protocol specification for message-oriented multistream transport.

## Operational Role

For a systems engineer, SCTP belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-5504ef5f16681a` from `curated_language_routes` as `registry_expansion`
