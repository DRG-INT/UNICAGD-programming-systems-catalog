# MarieLynneBlock/RealTimeAudioSignalProcessing-Faust
...
<!-- canonical: https://github.com/MarieLynneBlock/RealTimeAudioSignalProcessing-Faust -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MarieLynneBlock/RealTimeAudioSignalProcessing-Faust](https://github.com/MarieLynneBlock/RealTimeAudioSignalProcessing-Faust) |
| Source record ids | github_search_effects-39f6ef004c6bd2 |

## System Engineer Summary

Projects to get familiar with Faust and Functional Programming: create audio effects and
synthesizers from scratch, create DSP engines.

## Operational Role

For a systems engineer, MarieLynneBlock/RealTimeAudioSignalProcessing-Faust belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-05T19:15:07Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-39f6ef004c6bd2` from `github_search_effects` as `registry_expansion`
