...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vlingo/xoom-symbio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vlingo/xoom-symbio](https://github.com/vlingo/xoom-symbio) |
| Source record ids | github_search_magazines-720b13b5c5a412 |

## System Engineer Summary

The VLINGO XOOM platform SDK delivering Reactive storage that is scalable, high-throughput, and
resilient for CQRS, Event Sourcing, Key-Value, and Objects used by services and applications.

## Operational Role

For a systems engineer, vlingo/xoom-symbio belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-29T22:25:22Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-720b13b5c5a412` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ReScience/ReScience | Precommit Ci Quality | [open](magazines-rescience-rescience-6e84e985.md) |
