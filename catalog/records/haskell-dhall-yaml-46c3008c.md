...
<!-- canonical: https://hackage.haskell.org/package/dhall-yaml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dhall-yaml](https://hackage.haskell.org/package/dhall-yaml) |
| Source record ids | hackage_top_downloads-380015d0b25558 |
...
For a systems engineer, dhall-yaml belongs in the Haskell inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.12 | 2023-04-19T03:11:15Z | [https://hackage.haskell.org/package/dhall-yaml](https://hackage.haskell.org/package/dhall-yaml) |  |
| candidate | partial | 0 |  | [https://hackage.haskell.org/package/dhall-yaml](https://hackage.haskell.org/package/dhall-yaml) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dhall-yaml` at `2026-09-15T00:30:16+00:00`.
...
- `hackage_top_downloads-380015d0b25558` from `hackage_top_downloads` as `registry_expansion`
