# Gitea: corricca/elibrary-publication-analyzer
...
<!-- canonical: https://gitea.com/corricca/elibrary-publication-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/corricca/elibrary-publication-analyzer](https://gitea.com/corricca/elibrary-publication-analyzer) |
| Source record ids | gitea_repositories_api-3122372f95234b, gitea_repositories_api-e6baf0d7f44772 |

## System Engineer Summary

Gitea: corricca/elibrary-publication-analyzer is tracked as a static analyzer record in the
Repository Workplaces branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, Gitea: corricca/elibrary-publication-analyzer belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-29T19:57:29Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-3122372f95234b` from `gitea_repositories_api` as `registry_expansion`
- `gitea_repositories_api-e6baf0d7f44772` from `gitea_repositories_api` as `registry_expansion`
