...
<!-- canonical: https://github.com/oblivioncth/Stexatlaser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oblivioncth/Stexatlaser](https://github.com/oblivioncth/Stexatlaser) |
| Source record ids | github_search_assets-d54edca19961ee |

## System Engineer Summary

A simple tool to automate creating an atlas and its key in the Klei TEX format from many images

## Operational Role

For a systems engineer, oblivioncth/Stexatlaser belongs in the Assets inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T18:53:52Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d54edca19961ee` from `github_search_assets` as `registry_expansion`
