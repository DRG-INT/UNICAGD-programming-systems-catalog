...
| Canonical URL | [https://packagist.org/packages/fig/http-message-util](https://packagist.org/packages/fig/http-message-util) |
| Source record ids | packagist_search-d76f8d6cc958cd |
...
For a systems engineer, fig/http-message-util belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2020-11-24T22:02:59+00:00 | [https://repo.packagist.org/p2/fig/http-message-util.json](https://repo.packagist.org/p2/fig/http-message-util.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/fig/http-message-util.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-d76f8d6cc958cd` from `packagist_search` as `registry_expansion`
...
| fig/link-util | Networking Http | [open](php-fig-link-util-247088e8.md) |
