...
| Source record ids | corpus-e04fb5e86192a9 |

## System Engineer Summary

expected-lite is tracked as a library record in the C++23 branch. The source did not provide a long
...
For a systems engineer, expected-lite belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-e04fb5e86192a9` from `master_json` as `library`
