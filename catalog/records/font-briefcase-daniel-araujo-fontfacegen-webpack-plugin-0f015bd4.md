...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/daniel-araujo/fontfacegen-webpack-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daniel-araujo/fontfacegen-webpack-plugin](https://github.com/daniel-araujo/fontfacegen-webpack-plugin) |
| Source record ids | github_search_font_briefcase-0d8c38bd099381 |

## System Engineer Summary

A plugin for webpack that allows you to convert .ttf and .otf files into various other font formats
such as .eot, .ttf, .svg, .woff and .woff2 using the existing NPM package fontfacegen.

## Operational Role

For a systems engineer, daniel-araujo/fontfacegen-webpack-plugin belongs in the Font Briefcase
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T15:36:34Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-0d8c38bd099381` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fontsource/fontsource | Package Manager | [open](font-briefcase-fontsource-fontsource-b8fc6b63.md) |
| KyleAMathews/typefaces | Package Manager | [open](font-briefcase-kyleamathews-typefaces-e4736f4b.md) |
| typehaus/metropolis | Package Manager | [open](font-briefcase-typehaus-metropolis-b71cc210.md) |
