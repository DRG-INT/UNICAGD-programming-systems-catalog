...
<!-- canonical: https://github.com/teableio/teable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/teableio/teable](https://github.com/teableio/teable) |
| Source record ids | github_search_databases-42529ba999cb99 |
...
For a systems engineer, teableio/teable belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T08:55:43Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-42529ba999cb99` from `github_search_databases` as `registry_expansion`
