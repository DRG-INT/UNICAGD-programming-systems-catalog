...
<!-- canonical: https://crates.io/crates/zerovec-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zerovec-derive](https://crates.io/crates/zerovec-derive) |
| Source record ids | crates_io-5372953a72f334 |
...
For a systems engineer, zerovec-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.6 | 2026-08-20T23:25:28.777419Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-5372953a72f334` from `crates_io` as `registry_expansion`
