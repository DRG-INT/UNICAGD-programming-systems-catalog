...
<!-- canonical: https://github.com/AuroraEditor/AuroraEditor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AuroraEditor/AuroraEditor](https://github.com/AuroraEditor/AuroraEditor) |
| Source record ids | github_search_cocoa-28e420dcb9a7da |

## System Engineer Summary

Aurora Editor is a IDE built by the community, for the community, and written in Swift for the best
native performance and feel for macOS.

## Operational Role

For a systems engineer, AuroraEditor/AuroraEditor belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-26T18:58:06Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-28e420dcb9a7da` from `github_search_cocoa` as `registry_expansion`
