...
| Canonical URL | [https://basilisk.fr/src/examples/README](https://basilisk.fr/src/examples/README) |
| Source record ids | curated_language_routes-7e4adba346a04d |

## System Engineer Summary

Official Basilisk example programs for numerical simulation, solvers, grids, and output workflows.

## Operational Role

For a systems engineer, Basilisk Examples belongs in the Basilisk inventory as part of operator
...
- `curated_language_routes-7e4adba346a04d` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AVSLab Basilisk Documentation | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/basilisk-avslab-basilisk-documentation-31f9f65c.md) |
