...
<!-- canonical: https://github.com/source-foundry/Hack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/source-foundry/Hack](https://github.com/source-foundry/Hack) |
| Source record ids | github_search_font_briefcase-098221068628cf |
...
For a systems engineer, source-foundry/Hack belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-21T18:05:33Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-098221068628cf` from `github_search_font_briefcase` as `registry_expansion`
