...
| Canonical URL | [https://luarocks.org/modules/lblasc/exc](https://luarocks.org/modules/lblasc/exc) |
| Source record ids | luarocks_root_manifest-ffd7b32364d0b5 |

## System Engineer Summary

exc is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, exc belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ffd7b32364d0b5` from `luarocks_root_manifest` as `registry_expansion`
