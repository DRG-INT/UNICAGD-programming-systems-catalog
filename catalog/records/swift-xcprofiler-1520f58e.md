...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/giginet/xcprofiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giginet/xcprofiler](https://github.com/giginet/xcprofiler) |
| Source record ids | awesome_list-c5c856946a3ca0 |

## System Engineer Summary

Command line utility to profile compilation time.

## Operational Role

For a systems engineer, xcprofiler belongs in the Swift inventory as part of hot-path discovery,
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Benchmark", "source_url": "https://raw.githubusercontent.com/matteocrippa/awesome-swift/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-c5c856946a3ca0` from `awesome_list` as `registry_expansion`
