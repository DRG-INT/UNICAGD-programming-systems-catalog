...
<!-- canonical: https://cran.r-project.org/web/packages/log4r/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/log4r/index.html](https://cran.r-project.org/web/packages/log4r/index.html) |
| Source record ids | cran_packages_by_date-dcff3ccc8d7cf2 |
...
For a systems engineer, log4r belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-04 22:50:15 UTC | [https://cran.r-project.org/web/packages/log4r/DESCRIPTION](https://cran.r-project.org/web/packages/log4r/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/log4r/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dcff3ccc8d7cf2` from `cran_packages_by_date` as `registry_expansion`
