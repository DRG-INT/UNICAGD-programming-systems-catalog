...
<!-- canonical: https://github.com/f/textream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/f/textream](https://github.com/f/textream) |
| Source record ids | github_search_video-36f5bfb8931812 |

## System Engineer Summary

Textream is a free macOS teleprompter app for streamers, interviewers, and presenters. It highlights
your script in real-time as you speak, displayed in a beautiful Dynamic Island overlay. With
extensible features.

## Operational Role

For a systems engineer, f/textream belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T00:22:14Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-36f5bfb8931812` from `github_search_video` as `registry_expansion`
