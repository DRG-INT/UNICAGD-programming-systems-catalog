...
<!-- canonical: https://crates.io/crates/futures-lite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-lite](https://crates.io/crates/futures-lite) |
| Source record ids | crates_io-db247a23993267 |
...
For a systems engineer, futures-lite belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.1 | 2025-08-04T00:29:25.672150Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Evidence | CC0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `crates_io-db247a23993267` from `crates_io` as `registry_expansion`
