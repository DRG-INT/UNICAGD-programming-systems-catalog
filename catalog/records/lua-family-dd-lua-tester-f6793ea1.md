...
<!-- canonical: https://luarocks.org/modules/codeofnode/dd-lua-tester -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/codeofnode/dd-lua-tester](https://luarocks.org/modules/codeofnode/dd-lua-tester) |
| Source record ids | luarocks_root_manifest-e008c388a762db |

## System Engineer Summary

dd-lua-tester is tracked as a testing framework record in the Lua family branch. The source did not
...
For a systems engineer, dd-lua-tester belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-e008c388a762db` from `luarocks_root_manifest` as `registry_expansion`
