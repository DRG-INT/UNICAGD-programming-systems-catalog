...
| Source record ids | github_search_webassembly-a732df55aeca57 |
...
For a systems engineer, remko/uxn.wasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.9.0 | 2024-03-19T18:59:36Z | [https://api.github.com/repos/remko/uxn.wasm/releases/latest](https://api.github.com/repos/remko/uxn.wasm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/remko/uxn.wasm/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-a732df55aeca57` from `github_search_webassembly` as `registry_expansion`
