...
<!-- canonical: https://pypi.org/project/aad-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aad-client/](https://pypi.org/project/aad-client/) |
| Source record ids | pypi_simple-cb28676b7e3a64 |
...
For a systems engineer, aad-client belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2020-12-22T23:32:19.312869Z | [https://pypi.org/pypi/aad-client/json](https://pypi.org/pypi/aad-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aad-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-cb28676b7e3a64` from `pypi_simple` as `registry_expansion`
