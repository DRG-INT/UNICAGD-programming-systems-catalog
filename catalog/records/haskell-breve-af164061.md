...
<!-- canonical: https://hackage.haskell.org/package/breve -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/breve](https://hackage.haskell.org/package/breve) |
| Source record ids | hackage_top_downloads-15b338760ea621 |
...
For a systems engineer, breve belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1.0 | 2024-06-30T20:23:17Z | [https://hackage.haskell.org/package/breve](https://hackage.haskell.org/package/breve) |  |
| candidate | partial | 0.4.5.0 |  | [https://hackage.haskell.org/package/breve](https://hackage.haskell.org/package/breve) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/breve` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-15b338760ea621` from `hackage_top_downloads` as `registry_expansion`
