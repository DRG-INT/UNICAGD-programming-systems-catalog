...
<!-- canonical: https://github.com/pnorman/tilekiln -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pnorman/tilekiln](https://github.com/pnorman/tilekiln) |
| Source record ids | github_search_maps-8e3c78fee286d2 |

## System Engineer Summary

pnorman/tilekiln is tracked as a library record in the Maps branch. The source did not provide a
...
For a systems engineer, pnorman/tilekiln belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T22:21:17Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-8e3c78fee286d2` from `github_search_maps` as `registry_expansion`
