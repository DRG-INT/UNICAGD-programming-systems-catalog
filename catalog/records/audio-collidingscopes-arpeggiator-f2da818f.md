...
<!-- canonical: https://github.com/collidingScopes/arpeggiator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/collidingScopes/arpeggiator](https://github.com/collidingScopes/arpeggiator) |
| Source record ids | github_search_audio-0c054cf33c8823 |

## System Engineer Summary

Hand-controlled arpeggiator, drum machine, and audio reactive visualizer. Built with mediapipe
computer vision, threejs, tonejs

## Operational Role

For a systems engineer, collidingScopes/arpeggiator belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-22T20:06:32Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-0c054cf33c8823` from `github_search_audio` as `registry_expansion`
...
| modelscope/FunASR | Package Manager | [open](audio-modelscope-funasr-8e089427.md) |
