...
<!-- canonical: https://github.com/utiasASRL/hero_radar_odometry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/utiasASRL/hero_radar_odometry](https://github.com/utiasASRL/hero_radar_odometry) |
| Source record ids | github_search_radars-cf01f84ae4be29 |
...
For a systems engineer, utiasASRL/hero_radar_odometry belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-15T01:14:30Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-cf01f84ae4be29` from `github_search_radars` as `registry_expansion`
