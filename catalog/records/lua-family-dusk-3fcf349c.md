...
<!-- canonical: https://luarocks.org/modules/felix-kyun/dusk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/felix-kyun/dusk](https://luarocks.org/modules/felix-kyun/dusk) |
| Source record ids | luarocks_root_manifest-94f56b97e46f96 |

## System Engineer Summary

dusk is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, dusk belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-94f56b97e46f96` from `luarocks_root_manifest` as `registry_expansion`
