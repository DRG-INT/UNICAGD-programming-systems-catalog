...
| Canonical URL | [https://github.com/aubio/aubio](https://github.com/aubio/aubio) |
| Source record ids | github_search_audio-9e38240e99e3e7 |
...
For a systems engineer, aubio/aubio belongs in the Audio inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.9 | 2019-02-27T09:00:43Z | [https://api.github.com/repos/aubio/aubio/releases/latest](https://api.github.com/repos/aubio/aubio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/aubio/aubio/releases/latest` at `2026-09-01T09:23:15+00:00`.
...
- `github_search_audio-9e38240e99e3e7` from `github_search_audio` as `registry_expansion`
