...
<!-- canonical: https://github.com/davvid/telescope-git-grep.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/davvid/telescope-git-grep.nvim](https://github.com/davvid/telescope-git-grep.nvim) |
| Source record ids | github_search_telescopes-bccb34614cbf87 |
...
For a systems engineer, davvid/telescope-git-grep.nvim belongs in the Telescopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-09T06:32:22Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-bccb34614cbf87` from `github_search_telescopes` as `registry_expansion`
