...
<!-- canonical: https://hackage.haskell.org/package/samtools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/samtools](https://hackage.haskell.org/package/samtools) |
| Source record ids | hackage_top_downloads-8767e1ad7f336d |
...
For a systems engineer, samtools belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4.3 | 2016-05-30T03:22:14Z | [https://hackage.haskell.org/package/samtools](https://hackage.haskell.org/package/samtools) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/samtools` at `2026-09-06T00:34:56+00:00`.
...
- `hackage_top_downloads-8767e1ad7f336d` from `hackage_top_downloads` as `registry_expansion`
