...
| Canonical URL | [https://packagist.org/packages/fresh/doctrine-enum-bundle](https://packagist.org/packages/fresh/doctrine-enum-bundle) |
| Source record ids | packagist_search-699a141182d43a |
...
For a systems engineer, fresh/doctrine-enum-bundle belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v12.0.1 | 2026-01-07T08:48:30+00:00 | [https://repo.packagist.org/p2/fresh/doctrine-enum-bundle.json](https://repo.packagist.org/p2/fresh/doctrine-enum-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/fresh/doctrine-enum-bundle.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-699a141182d43a` from `packagist_search` as `registry_expansion`
