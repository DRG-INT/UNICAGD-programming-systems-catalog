...
<!-- canonical: https://cran.r-project.org/web/packages/imply/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/imply/index.html](https://cran.r-project.org/web/packages/imply/index.html) |
| Source record ids | cran_packages_by_date-6bfffd06f12b67 |

## System Engineer Summary

Efficiently Apply Functions to Images

## Operational Role

For a systems engineer, imply belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 10:40:16 UTC | [https://cran.r-project.org/web/packages/imply/DESCRIPTION](https://cran.r-project.org/web/packages/imply/DESCRIPTION) |  |
...
| Evidence | BSD_3_clause + file LICENCE |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/imply/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-6bfffd06f12b67` from `cran_packages_by_date` as `registry_expansion`
