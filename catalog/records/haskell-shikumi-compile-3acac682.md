...
<!-- canonical: https://hackage.haskell.org/package/shikumi-compile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-compile](https://hackage.haskell.org/package/shikumi-compile) |
| Source record ids | hackage_recent-f796cad6d7eed3 |
...
For a systems engineer, shikumi-compile belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.0 | 2026-09-08T19:34:21Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-f796cad6d7eed3` from `hackage_recent` as `registry_expansion`
