...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/dhscanner-kbapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dhscanner-kbapi](https://hackage.haskell.org/package/dhscanner-kbapi) |
| Source record ids | hackage_recent-4ae75b98574674 |

## System Engineer Summary

Hackage package recently uploaded by OrenHackage.

## Operational Role

For a systems engineer, dhscanner-kbapi belongs in the Haskell inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2026-09-13T16:58:38Z | [https://hackage.haskell.org/package/dhscanner-kbapi](https://hackage.haskell.org/package/dhscanner-kbapi) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dhscanner-kbapi` at `2026-09-14T07:24:35+00:00`.
...
- `hackage_recent-4ae75b98574674` from `hackage_recent` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dhscanner-kbgen | Static Analyzer | [open](haskell-dhscanner-kbgen-81d7d915.md) |
| ethereum-analyzer | Static Analyzer | [open](haskell-ethereum-analyzer-919d0df7.md) |
| ethereum-analyzer-deps | Static Analyzer | [open](haskell-ethereum-analyzer-deps-0fa0e117.md) |
| ethereum-analyzer-webui | Static Analyzer | [open](haskell-ethereum-analyzer-webui-c1cec8c1.md) |
