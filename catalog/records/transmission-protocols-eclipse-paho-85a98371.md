...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Transmission Protocols](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/transmission-protocols.md) · [Category: Message Broker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/message-broker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/eclipse-paho](https://github.com/eclipse-paho) |
| Source record ids | curated_language_routes-ae31c79ca13f6b |

## System Engineer Summary

MQTT client library family and protocol tooling across languages.

## Operational Role

For a systems engineer, Eclipse Paho belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-ae31c79ca13f6b` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AMQP 1.0 | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-amqp-1-0-b9567fba.md) |
| Kafka Protocol | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-kafka-protocol-2508efba.md) |
| MQTT | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-mqtt-6c1bc678.md) |
| NATS Protocol | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-nats-protocol-a253d579.md) |
| STOMP | Message Broker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-stomp-e2200807.md) |
