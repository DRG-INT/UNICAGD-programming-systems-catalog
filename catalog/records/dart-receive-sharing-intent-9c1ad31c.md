...
<!-- canonical: https://pub.dev/packages/receive_sharing_intent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/receive_sharing_intent](https://pub.dev/packages/receive_sharing_intent) |
| Source record ids | pub_dev-5c3620e518ab1e |
...
For a systems engineer, receive_sharing_intent belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-06-24T22:10:16.281163Z | [https://pub.dev/api/packages/receive_sharing_intent](https://pub.dev/api/packages/receive_sharing_intent) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/receive_sharing_intent` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-5c3620e518ab1e` from `pub_dev` as `registry_expansion`
