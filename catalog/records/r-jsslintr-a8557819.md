...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/jsslintr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jsslintr/index.html](https://cran.r-project.org/web/packages/jsslintr/index.html) |
| Source record ids | cran_packages_by_date-bed510e3ec0dbc |

## System Engineer Summary

JSS 'LaTeX'/'BibTeX' Style Checker

## Operational Role

For a systems engineer, jsslintr belongs in the R inventory as part of static feedback, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-10 20:20:02 UTC | [https://cran.r-project.org/web/packages/jsslintr/DESCRIPTION](https://cran.r-project.org/web/packages/jsslintr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jsslintr/DESCRIPTION` at `2026-09-10T22:18:27+00:00`.
...
- `cran_packages_by_date-bed510e3ec0dbc` from `cran_packages_by_date` as `registry_expansion`
