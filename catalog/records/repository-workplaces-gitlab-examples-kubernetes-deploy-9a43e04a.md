# gitlab-examples/kubernetes-deploy

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://gitlab.com/gitlab-examples/kubernetes-deploy](https://gitlab.com/gitlab-examples/kubernetes-deploy) |
| Source record ids | gitlab_projects_api-e13b2cc47ea6ad |

## System Engineer Summary

Experimental docker-based application to deploy simple applications to Kubernetes

## Operational Role

For a systems engineer, gitlab-examples/kubernetes-deploy belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-07T14:56:28.754Z | [https://gitlab.com/api/v4/projects?search=kubernetes&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=kubernetes&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-01 | `{"kind": "gitlab_projects_api", "query": "kubernetes", "retrieved": "2026-09-01", "status": "forge-api-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `gitlab_projects_api-e13b2cc47ea6ad` from `gitlab_projects_api` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ananace/charts | Undefined Behavior Analyzer | [open](repository-workplaces-ananace-charts-e6b30b05.md) |
| bdowney/ansible-demo | Undefined Behavior Analyzer | [open](repository-workplaces-bdowney-ansible-demo-8ddaacae.md) |
| gitlab-com/gl-infra/k8s-workloads/gitlab-com | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-com-gl-infra-k8s-workloads-gitlab-com-13cc554b.md) |
| gitlab-data/data-image | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-data-data-image-0af0c35c.md) |
| gitlab-examples/ruby-autodeploy | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-examples-ruby-autodeploy-0ea70988.md) |
| gitlab-org/charts/gitlab-agent | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-org-charts-gitlab-agent-4a47eab2.md) |
| gitlab-org/ci-cd/gitlab-runner-pod-cleanup | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-org-ci-cd-gitlab-runner-pod-cleanup-489737ef.md) |
| gitlab-org/cloud-native/gitlab-operator | Undefined Behavior Analyzer | [open](repository-workplaces-gitlab-org-cloud-native-gitlab-operator-a34c605c.md) |
