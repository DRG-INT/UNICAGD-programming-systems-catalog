...
<!-- canonical: https://gitlab.com/gitlab-examples/kubernetes-deploy -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-05 | `{"kind": "gitlab_projects_api", "query": "kubernetes", "retrieved": "2026-09-05", "status": "forge-api-derived"}` |
...
| castlecraft/erpnext_kubernetes | Undefined Behavior Analyzer | [open](repository-workplaces-castlecraft-erpnext-kubernetes-f8edadde.md) |
| cloud-versity/rancher-k3s-first-steps | Undefined Behavior Analyzer | [open](repository-workplaces-cloud-versity-rancher-k3s-first-steps-c86f160c.md) |
| Gitea: admpub/ftpserver | Undefined Behavior Analyzer | [open](repository-workplaces-gitea-admpub-ftpserver-f1e4497d.md) |
| Gitea: avevlad/act | Undefined Behavior Analyzer | [open](repository-workplaces-gitea-avevlad-act-716d3cec.md) |
| Gitea: corricca/elibrary-publication-analyze | Undefined Behavior Analyzer | [open](repository-workplaces-gitea-corricca-elibrary-publication-analyze-a3fc096b.md) |
| Gitea: IDuckOdd/DevOps | Undefined Behavior Analyzer | [open](repository-workplaces-gitea-iduckodd-devops-024d36e6.md) |
