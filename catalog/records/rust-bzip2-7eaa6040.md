...
<!-- canonical: https://crates.io/crates/bzip2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bzip2](https://crates.io/crates/bzip2) |
| Source record ids | crates_io-39ca2719c174df |
...
For a systems engineer, bzip2 belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2025-10-16T14:18:19.210799Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-39ca2719c174df` from `crates_io` as `registry_expansion`
