...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/arda-guler/orbitSim3D](https://github.com/arda-guler/orbitSim3D) |
| Source record ids | github_search_space_engines-14e4425b9fdf45 |

## System Engineer Summary

Sophisticated astrodynamics and space mission simulator. Calculate n-body trajectories, perform
orbital maneuvers, apply various perturbations, generate plots, and more! Minimal dependencies.

## Operational Role

For a systems engineer, arda-guler/orbitSim3D belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.12 | 2024-10-27T11:22:33Z | [https://api.github.com/repos/arda-guler/orbitSim3D/releases/latest](https://api.github.com/repos/arda-guler/orbitSim3D/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/arda-guler/orbitSim3D/releases/latest` at `2026-09-01T07:24:15+00:00`.
...
- `github_search_space_engines-14e4425b9fdf45` from `github_search_space_engines` as `registry_expansion`
