...
| Source record ids | hackage_recent-3621f5b4d5beb4 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:19:46Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-3621f5b4d5beb4` from `hackage_recent` as `registry_expansion`
