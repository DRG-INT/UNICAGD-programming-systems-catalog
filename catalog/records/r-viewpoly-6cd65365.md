...
<!-- canonical: https://cran.r-project.org/web/packages/viewpoly/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/viewpoly/index.html](https://cran.r-project.org/web/packages/viewpoly/index.html) |
| Source record ids | cran_packages_by_date-c7556408e4dec1 |
...
For a systems engineer, viewpoly belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-02 15:20:02 UTC | [https://cran.r-project.org/web/packages/viewpoly/DESCRIPTION](https://cran.r-project.org/web/packages/viewpoly/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/viewpoly/DESCRIPTION` at `2026-09-02T15:24:11+00:00`.
...
- `cran_packages_by_date-c7556408e4dec1` from `cran_packages_by_date` as `registry_expansion`
