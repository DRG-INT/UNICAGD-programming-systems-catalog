# Kraken-Space-Program/Kraken-Space-Program

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Kraken-Space-Program/Kraken-Space-Program -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kraken-Space-Program/Kraken-Space-Program](https://github.com/Kraken-Space-Program/Kraken-Space-Program) |
| Source record ids | github_search_space_engines-8dcb080a87b467 |

## System Engineer Summary

Kraken Space Program is an open-source, community-built aerospace sandbox — a spiritual successor to
the game we all loved, rebuilt from scratch the right way. Fast. Moddable. Cross-platform. With
multiplayer baked in from day one.

## Operational Role

For a systems engineer, Kraken-Space-Program/Kraken-Space-Program belongs in the Space Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-16T22:11:08Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-8dcb080a87b467` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jasonfyw/orbital-sim | Build System | [open](space-engines-jasonfyw-orbital-sim-5f33353e.md) |
