...
<!-- canonical: https://www.nuget.org/packages/Serilog.Formatting.Compact.Reader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Serilog.Formatting.Compact.Reader](https://www.nuget.org/packages/Serilog.Formatting.Compact.Reader) |
| Source record ids | nuget_search-9249b89e22796c |

## System Engineer Summary

Serilog.Formatting.Compact.Reader is tracked as a formatter record in the C-Sharp branch. The source
...
For a systems engineer, Serilog.Formatting.Compact.Reader belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2024-07-02T21:11:38.16+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.formatting.compact.reader/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.formatting.compact.reader/index.json) |  |
| preview | known | 4.1.0-dev-00085 | 2024-08-05T07:01:05.413+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.formatting.compact.reader/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.formatting.compact.reader/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/Serilog.Formatting.Compact.Reader/4.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/serilog.formatting.compact.reader/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-9249b89e22796c` from `nuget_search` as `registry_expansion`
