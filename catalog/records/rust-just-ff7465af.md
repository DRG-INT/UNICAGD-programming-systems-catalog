...
| Canonical URL | [https://crates.io/crates/just](https://crates.io/crates/just) |
| Source record ids | corpus-b1e01276c7485b |

## System Engineer Summary

just is tracked as a build system record in the Rust branch. The source did not provide a long
...
For a systems engineer, just belongs in the Rust inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.58.0 | 2026-08-03T20:29:15.411846Z | [https://crates.io/api/v1/crates/just](https://crates.io/api/v1/crates/just) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/just` at `2026-09-01T02:12:58+00:00`.
...
- `corpus-b1e01276c7485b` from `master_json` as `build_system`
