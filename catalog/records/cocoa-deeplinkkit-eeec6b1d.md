...
<!-- canonical: https://github.com/button/DeepLinkKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/button/DeepLinkKit](https://github.com/button/DeepLinkKit) |
| Source record ids | awesome_list-dc16ae342fdc57 |
...
For a systems engineer, DeepLinkKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2019-09-09T15:35:06Z | [https://api.github.com/repos/button/DeepLinkKit/releases/latest](https://api.github.com/repos/button/DeepLinkKit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/button/DeepLinkKit/releases/latest` at `2026-09-01T07:24:05+00:00`.
...
- `awesome_list-dc16ae342fdc57` from `awesome_list` as `registry_expansion`
