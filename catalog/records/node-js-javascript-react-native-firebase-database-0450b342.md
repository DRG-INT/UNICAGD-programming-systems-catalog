...
<!-- canonical: https://www.npmjs.com/package/@react-native-firebase/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@react-native-firebase/database](https://www.npmjs.com/package/@react-native-firebase/database) |
| Source record ids | npm_registry-f76bd4071c8dcb |

## System Engineer Summary

React Native Firebase - The Firebase Realtime Database is a cloud-hosted database. Data is stored as
JSON and synchronized in realtime to every connected client. React Native Firebase provides native
integration with the Android & iOS Firebase SDKs, suppo

## Operational Role

For a systems engineer, @react-native-firebase/database belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.4.0 | 2026-09-05T01:49:21.021Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-05T02:18:20+00:00`.
...
- `npm_registry-f76bd4071c8dcb` from `npm_registry` as `registry_expansion`
