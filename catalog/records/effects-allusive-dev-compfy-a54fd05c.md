...
<!-- canonical: https://github.com/allusive-dev/compfy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/allusive-dev/compfy](https://github.com/allusive-dev/compfy) |
| Source record ids | github_search_effects-66c836faddb9bd |
...
For a systems engineer, allusive-dev/compfy belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-22T02:54:38Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-66c836faddb9bd` from `github_search_effects` as `registry_expansion`
