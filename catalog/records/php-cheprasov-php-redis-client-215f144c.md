...
| Canonical URL | [https://packagist.org/packages/cheprasov/php-redis-client](https://packagist.org/packages/cheprasov/php-redis-client) |
| Source record ids | packagist_search-6b048428dff585 |

## System Engineer Summary

Php client for Redis. It is a fast, fully-functional and user-friendly client for Redis, optimized
for performance. RedisClient supports the latest versions of Redis starting from 2.6 to 6.0

## Operational Role

For a systems engineer, cheprasov/php-redis-client belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2020-06-20T13:22:40+00:00 | [https://repo.packagist.org/p2/cheprasov/php-redis-client.json](https://repo.packagist.org/p2/cheprasov/php-redis-client.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cheprasov/php-redis-client.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-6b048428dff585` from `packagist_search` as `registry_expansion`
