...
<!-- canonical: https://cran.r-project.org/web/packages/ctrdata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ctrdata/index.html](https://cran.r-project.org/web/packages/ctrdata/index.html) |
| Source record ids | cran_packages_by_date-c3f574d67665db |
...
For a systems engineer, ctrdata belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.3 | 2026-08-28 17:00:02 UTC | [https://cran.r-project.org/web/packages/ctrdata/DESCRIPTION](https://cran.r-project.org/web/packages/ctrdata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ctrdata/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c3f574d67665db` from `cran_packages_by_date` as `registry_expansion`
