...
<!-- canonical: https://github.com/opa334/TrollStore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opa334/TrollStore](https://github.com/opa334/TrollStore) |
| Source record ids | github_search_cocoa-a8044494cdb3ce |
...
For a systems engineer, opa334/TrollStore belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-01T09:43:17Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-a8044494cdb3ce` from `github_search_cocoa` as `registry_expansion`
