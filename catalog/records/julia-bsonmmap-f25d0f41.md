...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BSONMmap](https://github.com/JuliaRegistries/General/tree/master/B/BSONMmap) |
| Source record ids | julia_general-c16c9d7492c821 |

## System Engineer Summary

Julia package registered in General at B/BSONMmap.

## Operational Role

For a systems engineer, BSONMmap belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BSONMmap", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c16c9d7492c821` from `julia_general` as `registry_expansion`
