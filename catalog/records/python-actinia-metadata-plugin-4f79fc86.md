...
<!-- canonical: https://pypi.org/project/actinia-metadata-plugin/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actinia-metadata-plugin/](https://pypi.org/project/actinia-metadata-plugin/) |
| Source record ids | pypi_simple-41b7d7a4fe9961 |

## System Engineer Summary

A (RESTFUL) Flask application which to communicate with a metadata catalog via OGC-CSW, in usage
with GeoNetwork opensource.

## Operational Role

For a systems engineer, actinia-metadata-plugin belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2025-04-17T08:29:24.689663Z | [https://pypi.org/pypi/actinia-metadata-plugin/json](https://pypi.org/pypi/actinia-metadata-plugin/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actinia-metadata-plugin/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-41b7d7a4fe9961` from `pypi_simple` as `registry_expansion`
