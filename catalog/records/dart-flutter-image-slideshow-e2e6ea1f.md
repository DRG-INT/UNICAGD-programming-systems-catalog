...
<!-- canonical: https://pub.dev/packages/flutter_image_slideshow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_image_slideshow](https://pub.dev/packages/flutter_image_slideshow) |
| Source record ids | pub_dev-bd7e32bc2ef740 |

## System Engineer Summary

A simple image slideshow widget. Mainly intended for image widget, but other widgets can also be
used.

## Operational Role

For a systems engineer, flutter_image_slideshow belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2023-07-02T05:42:10.674055Z | [https://pub.dev/api/packages/flutter_image_slideshow](https://pub.dev/api/packages/flutter_image_slideshow) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_image_slideshow` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-bd7e32bc2ef740` from `pub_dev` as `registry_expansion`
