...
<!-- canonical: https://crates.io/crates/test-log-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/test-log-macros](https://crates.io/crates/test-log-macros) |
| Source record ids | crates_io-1e092402806e3a |
...
For a systems engineer, test-log-macros belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.21 | 2026-05-30T22:41:05.102954Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
