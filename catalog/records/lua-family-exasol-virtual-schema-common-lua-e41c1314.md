...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/exasol/exasol-virtual-schema-common-lua](https://luarocks.org/modules/exasol/exasol-virtual-schema-common-lua) |
| Source record ids | luarocks_root_manifest-705b4a8cd5746d |

## System Engineer Summary

Common base library for the Exasol Virtual Schema (Lua) and Row-level Security (Lua)

## Operational Role

For a systems engineer, exasol-virtual-schema-common-lua belongs in the Lua family inventory as part
...
| Name | Category | Page |
| --- | --- | --- |
| ai-lasso-guardrail | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ai-lasso-guardrail-25c625a0.md) |
| Apache APISIX | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-apache-apisix-7afbb669.md) |
| audit-log | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-audit-log-8b3ec16e.md) |
| haproxy-impart | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-haproxy-impart-5084d2c5.md) |
| luatweetnacl | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luatweetnacl-9fe17abd.md) |
