...
<!-- canonical: https://github.com/lamfur07/Flight-Dynamics-and-Control-UAVs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lamfur07/Flight-Dynamics-and-Control-UAVs](https://github.com/lamfur07/Flight-Dynamics-and-Control-UAVs) |
| Source record ids | github_search_matlab-6b8f1a23577346 |

## System Engineer Summary

Understanding of flight control systems, including dynamic models for UAVs, low level autopilot
design, trajectory following, and path planning. The essential physics and sensors of UAV problems,
including low-level autopilot for stability and higher-level autopilot functions of path planning
will be explored. Rigid-body dynamics through aerodynamics, stability augmentation, and state
estimation using onboard sensors, to maneuvering through obstacles. Files include simulation
projects using the MATLAB/Simulink environment. Projects start from modeling rigid-body dynamics,
then add aerodynamics and sensor models. Furthermore, low-level autopilot code, extended Kalman
filters for state estimation, path-following routines, and high-level path-planning algorithms.

## Operational Role

For a systems engineer, lamfur07/Flight-Dynamics-and-Control-UAVs belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-12T18:39:18Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-6b8f1a23577346` from `github_search_matlab` as `registry_expansion`
