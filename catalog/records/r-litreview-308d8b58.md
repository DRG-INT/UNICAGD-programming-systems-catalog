...
<!-- canonical: https://cran.r-project.org/web/packages/litReview/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/litReview/index.html](https://cran.r-project.org/web/packages/litReview/index.html) |
| Source record ids | cran_packages_by_date-e926770730f3a7 |
...
For a systems engineer, litReview belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-26 11:50:02 UTC | [https://cran.r-project.org/web/packages/litReview/DESCRIPTION](https://cran.r-project.org/web/packages/litReview/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/litReview/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e926770730f3a7` from `cran_packages_by_date` as `registry_expansion`
