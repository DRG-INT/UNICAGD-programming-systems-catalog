...
<!-- canonical: https://pub.dev/packages/intl_phone_field -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/intl_phone_field](https://pub.dev/packages/intl_phone_field) |
| Source record ids | pub_dev-01979650a64afa |
...
For a systems engineer, intl_phone_field belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2023-06-24T13:23:03.533691Z | [https://pub.dev/api/packages/intl_phone_field](https://pub.dev/api/packages/intl_phone_field) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/intl_phone_field` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-01979650a64afa` from `pub_dev` as `registry_expansion`
