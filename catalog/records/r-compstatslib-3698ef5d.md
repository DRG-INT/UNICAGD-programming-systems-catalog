...
<!-- canonical: https://cran.r-project.org/web/packages/compstatslib/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/compstatslib/index.html](https://cran.r-project.org/web/packages/compstatslib/index.html) |
| Source record ids | cran_packages_by_date-0e46fc17b4f1c2 |

## System Engineer Summary

Interactive 2D and 3D Visualization of Data and Statistical Concepts

## Operational Role

For a systems engineer, compstatslib belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-08 11:50:13 UTC | [https://cran.r-project.org/web/packages/compstatslib/DESCRIPTION](https://cran.r-project.org/web/packages/compstatslib/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/compstatslib/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0e46fc17b4f1c2` from `cran_packages_by_date` as `registry_expansion`
