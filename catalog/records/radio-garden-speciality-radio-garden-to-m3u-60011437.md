...
| Canonical URL | [https://github.com/ovosimpatico/radio.garden-to-m3u](https://github.com/ovosimpatico/radio.garden-to-m3u) |
| Source record ids | curated_language_routes-1214cbff7c864c |

## System Engineer Summary

AGPL-3.0 Python route for generating M3U playlists from Radio Garden API data; strong copyleft
requires a backup plan for redistribution.

## Operational Role

For a systems engineer, radio.garden-to-m3u belongs in the Radio Garden Speciality inventory as part
...
- `curated_language_routes-1214cbff7c864c` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| radio-garden-m3u | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-radio-garden-m3u-b31cc68d.md) |
