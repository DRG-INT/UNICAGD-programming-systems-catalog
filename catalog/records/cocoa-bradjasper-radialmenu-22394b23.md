...
<!-- canonical: https://github.com/bradjasper/RadialMenu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bradjasper/RadialMenu](https://github.com/bradjasper/RadialMenu) |
| Source record ids | github_search_cocoa-49ad8f8436e349 |

## System Engineer Summary

RadialMenu is a custom control for providing a touch context menu (like iMessage recording in iOS 8)
built with Swift & POP

## Operational Role

For a systems engineer, bradjasper/RadialMenu belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-15T19:50:21Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-49ad8f8436e349` from `github_search_cocoa` as `registry_expansion`
