...
<!-- canonical: https://github.com/ExoSpaceLabs/CCSDSPack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ExoSpaceLabs/CCSDSPack](https://github.com/ExoSpaceLabs/CCSDSPack) |
| Source record ids | github_search_satcom_satellites-d3f23476f2bd0a |

## System Engineer Summary

C++17 library for constructing, parsing, validating, and managing CCSDS Space Packets, with
PUS-A/PUS-C, CUC time, hosted tools, and bare-metal integration.

## Operational Role

For a systems engineer, ExoSpaceLabs/CCSDSPack belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T11:30:37Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-d3f23476f2bd0a` from `github_search_satcom_satellites` as `registry_expansion`
