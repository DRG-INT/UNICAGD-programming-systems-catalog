...
<!-- canonical: https://pub.dev/packages/web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/web](https://pub.dev/packages/web) |
| Source record ids | pub_dev-57d289faf2085f |
...
For a systems engineer, web belongs in the Dart inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-02-26T21:23:27.138850Z | [https://pub.dev/api/packages/web](https://pub.dev/api/packages/web) |  |
| preview | known | 0.3.1-dev | 2023-11-10T23:33:09.415823Z | [https://pub.dev/api/packages/web](https://pub.dev/api/packages/web) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/web` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-57d289faf2085f` from `pub_dev` as `registry_expansion`
