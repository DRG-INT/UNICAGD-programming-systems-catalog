...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gocolly/colly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gocolly/colly](https://github.com/gocolly/colly) |
| Source record ids | github_search_go-bb7966208622ea |
...
For a systems engineer, gocolly/colly belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:21:46Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-bb7966208622ea` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dobyte/due | Framework | [open](go-dobyte-due-642c6a6f.md) |
| micro/go-micro | Framework | [open](go-micro-go-micro-af542d9e.md) |
| Mindinventory/Golang-Project-Structure | Framework | [open](go-mindinventory-golang-project-structure-c6e24a0b.md) |
