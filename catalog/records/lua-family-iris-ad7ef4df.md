...
| Canonical URL | [https://luarocks.org/modules/catwell/iris](https://luarocks.org/modules/catwell/iris) |
| Source record ids | luarocks_root_manifest-26077e4f26314d |

## System Engineer Summary

iris is tracked as a networking http record in the Lua family branch. The source did not provide a
...
For a systems engineer, iris belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-26077e4f26314d` from `luarocks_root_manifest` as `registry_expansion`
