...
<!-- canonical: https://github.com/jpcima/spectacle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jpcima/spectacle](https://github.com/jpcima/spectacle) |
| Source record ids | github_search_audio-537b7794e7a542 |
...
For a systems engineer, jpcima/spectacle belongs in the Audio inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-15T19:24:25Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-537b7794e7a542` from `github_search_audio` as `registry_expansion`
