...
<!-- canonical: https://github.com/TokamakUI/Tokamak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TokamakUI/Tokamak](https://github.com/TokamakUI/Tokamak) |
| Source record ids | github_search_swift-87c83994d3cc01 |

## System Engineer Summary

Looking for active maintainers SwiftUI-compatible framework for building browser apps with
WebAssembly and native apps for other platforms

## Operational Role

For a systems engineer, TokamakUI/Tokamak belongs in the Swift inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-23T16:00:17Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-87c83994d3cc01` from `github_search_swift` as `registry_expansion`
...
| jtrivedi/Wave | Build System | [open](swift-jtrivedi-wave-b8bbf0d7.md) |
