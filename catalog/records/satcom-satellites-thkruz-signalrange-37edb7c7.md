...
<!-- canonical: https://github.com/thkruz/SignalRange -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thkruz/SignalRange](https://github.com/thkruz/SignalRange) |
| Source record ids | github_search_satcom_satellites-0aadfb07a8e2d7 |

## System Engineer Summary

💻📶A stand-alone training platform for Space Electronic Warfare. Learn about ground station
operations.

## Operational Role

For a systems engineer, thkruz/SignalRange belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-04T11:20:09Z | gh search repos topic:satcom stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-0aadfb07a8e2d7` from `github_search_satcom_satellites` as `registry_expansion`
