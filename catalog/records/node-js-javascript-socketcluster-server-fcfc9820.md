...
<!-- canonical: https://www.npmjs.com/package/socketcluster-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/socketcluster-server](https://www.npmjs.com/package/socketcluster-server) |
| Source record ids | npm_registry-bfe067e8849d9d |
...
For a systems engineer, socketcluster-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 20.0.1 | 2026-08-21T09:56:54.529Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-bfe067e8849d9d` from `npm_registry` as `registry_expansion`
