...
<!-- canonical: https://github.com/flashhawk/spp.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flashhawk/spp.js](https://github.com/flashhawk/spp.js) |
| Source record ids | github_search_effects-4a7ccd69177448 |
...
For a systems engineer, flashhawk/spp.js belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.0 | 2013-11-25T15:36:47Z | [https://api.github.com/repos/flashhawk/spp.js/releases/latest](https://api.github.com/repos/flashhawk/spp.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/flashhawk/spp.js/releases/latest` at `2026-09-01T13:22:53+00:00`.
...
- `github_search_effects-4a7ccd69177448` from `github_search_effects` as `registry_expansion`
