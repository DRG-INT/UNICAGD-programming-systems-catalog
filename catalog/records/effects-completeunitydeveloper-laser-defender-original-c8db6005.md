# CompleteUnityDeveloper/Laser-Defender-Original
...
<!-- canonical: https://github.com/CompleteUnityDeveloper/Laser-Defender-Original -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CompleteUnityDeveloper/Laser-Defender-Original](https://github.com/CompleteUnityDeveloper/Laser-Defender-Original) |
| Source record ids | github_search_effects-1241a5496b6552 |

## System Engineer Summary

2D space invaders clone built as part of Complete Unity C# Developer 2D course

## Operational Role

For a systems engineer, CompleteUnityDeveloper/Laser-Defender-Original belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-14T11:29:55Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1241a5496b6552` from `github_search_effects` as `registry_expansion`
