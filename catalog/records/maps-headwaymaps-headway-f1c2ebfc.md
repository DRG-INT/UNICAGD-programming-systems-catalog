...
<!-- canonical: https://github.com/headwaymaps/headway -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/headwaymaps/headway](https://github.com/headwaymaps/headway) |
| Source record ids | github_search_maps-f077ba2bd1a6b6 |
...
For a systems engineer, headwaymaps/headway belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T23:46:18Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f077ba2bd1a6b6` from `github_search_maps` as `registry_expansion`
