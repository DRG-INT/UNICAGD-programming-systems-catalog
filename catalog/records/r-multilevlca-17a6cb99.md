...
<!-- canonical: https://cran.r-project.org/web/packages/multilevLCA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multilevLCA/index.html](https://cran.r-project.org/web/packages/multilevLCA/index.html) |
| Source record ids | cran_packages_by_date-9668ca1b55ccb4 |
...
For a systems engineer, multilevLCA belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.5 | 2026-08-26 16:50:02 UTC | [https://cran.r-project.org/web/packages/multilevLCA/DESCRIPTION](https://cran.r-project.org/web/packages/multilevLCA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multilevLCA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9668ca1b55ccb4` from `cran_packages_by_date` as `registry_expansion`
