...
<!-- canonical: https://crates.io/crates/bytestring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bytestring](https://crates.io/crates/bytestring) |
| Source record ids | crates_io-82c4688a2262e9 |
...
For a systems engineer, bytestring belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2026-04-30T11:55:09.598690Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-82c4688a2262e9` from `crates_io` as `registry_expansion`
