...
<!-- canonical: https://github.com/open-webui/open-webui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-webui/open-webui](https://github.com/open-webui/open-webui) |
| Source record ids | github_search_aims-72d784aabc7068 |
...
For a systems engineer, open-webui/open-webui belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:06:38Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-72d784aabc7068` from `github_search_aims` as `registry_expansion`
