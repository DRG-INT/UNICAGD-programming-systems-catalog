...
<!-- canonical: https://github.com/hclivess/videer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hclivess/videer](https://github.com/hclivess/videer) |
| Source record ids | github_search_video-d2593589b33475 |

## System Engineer Summary

FFmpeg GUI with AviSynth support for deinterlacing and profile configuration that can be used in
frameserving. Created as a replacement for inflexible batch files that do not allow multiple
encodings at the same time easily and make configuration complicated.

## Operational Role

For a systems engineer, hclivess/videer belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T09:04:10Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d2593589b33475` from `github_search_video` as `registry_expansion`
