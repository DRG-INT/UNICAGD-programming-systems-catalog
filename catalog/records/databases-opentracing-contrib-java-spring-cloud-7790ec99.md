...
<!-- canonical: https://github.com/opentracing-contrib/java-spring-cloud -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opentracing-contrib/java-spring-cloud](https://github.com/opentracing-contrib/java-spring-cloud) |
| Source record ids | github_search_databases-177934703e8cfa |
...
For a systems engineer, opentracing-contrib/java-spring-cloud belongs in the Databases inventory as
part of hot-path discovery, allocation analysis, latency control, and capacity planning.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:07:53Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-177934703e8cfa` from `github_search_databases` as `registry_expansion`
