...
<!-- canonical: https://github.com/webtorrent/webtorrent-desktop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/webtorrent/webtorrent-desktop](https://github.com/webtorrent/webtorrent-desktop) |
| Source record ids | github_search_video-b1577bd1c88cf3 |
...
For a systems engineer, webtorrent/webtorrent-desktop belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:51:48Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-b1577bd1c88cf3` from `github_search_video` as `registry_expansion`
