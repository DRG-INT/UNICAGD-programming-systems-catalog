...
<!-- canonical: https://github.com/1ove9/antenna-forge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/1ove9/antenna-forge](https://github.com/1ove9/antenna-forge) |
| Source record ids | github_search_electromagnetoscopes-8a63add2ad94f5 |

## System Engineer Summary

AI-driven inverse antenna design with real NEC2 + openEMS in the loop. Try the live in-browser
playground.

## Operational Role

For a systems engineer, 1ove9/antenna-forge belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-01T09:11:25Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:electromagnetics stars:>5", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-8a63add2ad94f5` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| lyusupov/SoftRF | Machine Learning | [open](electromagnetoscopes-lyusupov-softrf-3a8c8d89.md) |
| maia-sdr/maia-sdr | Machine Learning | [open](electromagnetoscopes-maia-sdr-maia-sdr-d9f4b0b6.md) |
| Soul-AILab/SoulX-Transcriber | Machine Learning | [open](electromagnetoscopes-soul-ailab-soulx-transcriber-f9a0431b.md) |
| SysSec-KAIST/LTESniffer | Machine Learning | [open](electromagnetoscopes-syssec-kaist-ltesniffer-4bb1c9e6.md) |
