...
<!-- canonical: https://cran.r-project.org/web/packages/gkwreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gkwreg/index.html](https://cran.r-project.org/web/packages/gkwreg/index.html) |
| Source record ids | cran_packages_by_date-2ca6808ef970e7 |
...
For a systems engineer, gkwreg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.18 | 2026-08-24 07:40:10 UTC | [https://cran.r-project.org/web/packages/gkwreg/DESCRIPTION](https://cran.r-project.org/web/packages/gkwreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gkwreg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2ca6808ef970e7` from `cran_packages_by_date` as `registry_expansion`
