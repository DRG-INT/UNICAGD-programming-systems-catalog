...
| Canonical URL | [https://github.com/pooler/cpuminer](https://github.com/pooler/cpuminer) |
| Source record ids | github_search_assembly-0a93f58d73b93c |
...
For a systems engineer, pooler/cpuminer belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.5.1 | 2020-06-25T15:50:23Z | [https://api.github.com/repos/pooler/cpuminer/releases/latest](https://api.github.com/repos/pooler/cpuminer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/pooler/cpuminer/releases/latest` at `2026-09-01T10:25:51+00:00`.
...
- `github_search_assembly-0a93f58d73b93c` from `github_search_assembly` as `registry_expansion`
