...
<!-- canonical: https://hackage.haskell.org/package/http-media -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http-media](https://hackage.haskell.org/package/http-media) |
| Source record ids | hackage_top_downloads-91b9abad24383e |
...
For a systems engineer, http-media belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1.1 | 2023-09-10T07:00:50Z | [https://hackage.haskell.org/package/http-media](https://hackage.haskell.org/package/http-media) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http-media` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-91b9abad24383e` from `hackage_top_downloads` as `registry_expansion`
