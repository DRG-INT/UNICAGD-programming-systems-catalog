...
<!-- canonical: https://cran.r-project.org/web/packages/ForeCA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ForeCA/index.html](https://cran.r-project.org/web/packages/ForeCA/index.html) |
| Source record ids | cran_packages_by_date-d83af8c208ec32 |
...
For a systems engineer, ForeCA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8-1 | 2026-08-23 05:00:02 UTC | [https://cran.r-project.org/web/packages/ForeCA/DESCRIPTION](https://cran.r-project.org/web/packages/ForeCA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ForeCA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d83af8c208ec32` from `cran_packages_by_date` as `registry_expansion`
