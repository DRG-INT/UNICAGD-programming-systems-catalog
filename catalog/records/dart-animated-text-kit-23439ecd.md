...
<!-- canonical: https://pub.dev/packages/animated_text_kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/animated_text_kit](https://pub.dev/packages/animated_text_kit) |
| Source record ids | pub_dev-42f45c2fd04e84 |
...
For a systems engineer, animated_text_kit belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2025-10-04T13:50:52.907320Z | [https://pub.dev/api/packages/animated_text_kit](https://pub.dev/api/packages/animated_text_kit) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/animated_text_kit` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-42f45c2fd04e84` from `pub_dev` as `registry_expansion`
...
| flutter_svg | Machine Learning | [open](dart-flutter-svg-da91afe8.md) |
