...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tmrts/go-patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tmrts/go-patterns](https://github.com/tmrts/go-patterns) |
| Source record ids | github_search_go-b35e2af2c7ded0 |
...
For a systems engineer, tmrts/go-patterns belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-14T01:07:28Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-b35e2af2c7ded0` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| codeberg.org/socialhome/socialhome | Precommit Ci Quality | [open](go-codeberg-org-socialhome-socialhome-ce21e69a.md) |
