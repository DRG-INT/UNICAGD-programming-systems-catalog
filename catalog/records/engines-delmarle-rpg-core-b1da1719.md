...
<!-- canonical: https://github.com/delmarle/RPG-Core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/delmarle/RPG-Core](https://github.com/delmarle/RPG-Core) |
| Source record ids | github_search_engines-95e3a4f092b72d |
...
For a systems engineer, delmarle/RPG-Core belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-14T10:39:31Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-95e3a4f092b72d` from `github_search_engines` as `registry_expansion`
