...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Assertion Mocking](../by-category/assertion-mocking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/chillerdragon/dummyddnetpp -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-2e42b828894182` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| assert | Assertion Mocking | [open](lua-family-assert-3abd1e51.md) |
| assertex | Assertion Mocking | [open](lua-family-assertex-a33b1a07.md) |
| du-mocks | Assertion Mocking | [open](lua-family-du-mocks-01ae8c46.md) |
| fakeredis | Assertion Mocking | [open](lua-family-fakeredis-10bc18e2.md) |
