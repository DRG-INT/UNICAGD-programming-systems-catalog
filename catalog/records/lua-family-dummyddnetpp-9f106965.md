...
| Canonical URL | [https://luarocks.org/modules/chillerdragon/dummyddnetpp](https://luarocks.org/modules/chillerdragon/dummyddnetpp) |
| Source record ids | luarocks_root_manifest-2e42b828894182 |

## System Engineer Summary

dummyddnetpp is tracked as an assertion mocking record in the Lua family branch. The source did not
...
For a systems engineer, dummyddnetpp belongs in the Lua family inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| assert | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-assert-3abd1e51.md) |
| assertex | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-assertex-a33b1a07.md) |
| du-mocks | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-du-mocks-01ae8c46.md) |
| fakeredis | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-fakeredis-10bc18e2.md) |
