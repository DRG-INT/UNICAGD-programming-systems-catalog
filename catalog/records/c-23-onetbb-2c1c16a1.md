...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Concurrency Parallelism](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/concurrency-parallelism.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-55689a58aa489d |

## System Engineer Summary

oneTBB is tracked as a concurrency parallelism record in the C++23 branch. The source did not
...
For a systems engineer, oneTBB belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-55689a58aa489d` from `master_json` as `concurrency_parallelism`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| HPX | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-hpx-369f41bd.md) |
| libdispatch | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-libdispatch-2690f167.md) |
| OpenMP | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-openmp-1db95ddc.md) |
