...
<!-- canonical: https://crates.io/crates/android_system_properties -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/android_system_properties](https://crates.io/crates/android_system_properties) |
| Source record ids | crates_io-fea2b9e7876760 |
...
For a systems engineer, android_system_properties belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-05T13:44:27.717073Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-fea2b9e7876760` from `crates_io` as `registry_expansion`
