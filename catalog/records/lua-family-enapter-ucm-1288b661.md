...
| Canonical URL | [https://luarocks.org/modules/enapter/enapter-ucm](https://luarocks.org/modules/enapter/enapter-ucm) |
| Source record ids | luarocks_root_manifest-e9a76ad91fc91c |

## System Engineer Summary

enapter-ucm is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, enapter-ucm belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e9a76ad91fc91c` from `luarocks_root_manifest` as `registry_expansion`
