...
<!-- canonical: https://github.com/joergi/MagPiDownloader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joergi/MagPiDownloader](https://github.com/joergi/MagPiDownloader) |
| Source record ids | github_search_magazines-a2c2ed862296b3 |

## System Engineer Summary

Open Source downloader for all the Mag Pi (Raspberry Pi) magazins on your Windows, Mac OS or Linux
or with Docker

## Operational Role

For a systems engineer, joergi/MagPiDownloader belongs in the Magazines inventory as part of build
...
- `github_search_magazines-a2c2ed862296b3` from `github_search_magazines` as `registry_expansion`
