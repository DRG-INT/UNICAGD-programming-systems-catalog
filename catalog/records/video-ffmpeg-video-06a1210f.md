...
| Canonical URL | [https://github.com/FFmpeg/FFmpeg](https://github.com/FFmpeg/FFmpeg) |
| Source record ids | curated_language_routes-914844d8c4f79e |

## System Engineer Summary

Video decoding, encoding, filtering, transcoding, streaming, container, subtitle, and media pipeline
toolkit.

## Operational Role

For a systems engineer, FFmpeg Video belongs in the Video inventory as part of ecosystem capability
...
- `curated_language_routes-914844d8c4f79e` from `curated_language_routes` as `registry_expansion`
...
| GStreamer Video | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/video-gstreamer-video-aea0fb5a.md) |
