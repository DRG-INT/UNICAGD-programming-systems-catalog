...
<!-- canonical: https://github.com/slobodaapl/vkShade -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/slobodaapl/vkShade](https://github.com/slobodaapl/vkShade) |
| Source record ids | github_search_effects-ef24164ac79d8c |
...
For a systems engineer, slobodaapl/vkShade belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T08:22:19Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ef24164ac79d8c` from `github_search_effects` as `registry_expansion`
