...
<!-- canonical: https://gitlab.com/explore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/explore](https://gitlab.com/explore) |
| Source record ids | curated_language_routes-12350020bda80d |

## System Engineer Summary

Project hub for Git repositories, CI/CD, packages, issues, merge requests, groups, and public
software discovery.

## Operational Role

For a systems engineer, GitLab Explore belongs in the Hubs inventory as part of ecosystem capability
...
- `curated_language_routes-12350020bda80d` from `curated_language_routes` as `registry_expansion`
