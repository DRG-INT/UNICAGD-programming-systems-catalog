...
| Canonical URL | [https://packagist.org/packages/dimsav/laravel-translatable](https://packagist.org/packages/dimsav/laravel-translatable) |
| Source record ids | packagist_search-6445347810c529 |
...
For a systems engineer, dimsav/laravel-translatable belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v10.0.0 | 2019-06-03T06:56:57+00:00 | [https://repo.packagist.org/p2/dimsav/laravel-translatable.json](https://repo.packagist.org/p2/dimsav/laravel-translatable.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dimsav/laravel-translatable.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-6445347810c529` from `packagist_search` as `registry_expansion`
