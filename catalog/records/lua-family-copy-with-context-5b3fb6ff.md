...
<!-- canonical: https://luarocks.org/modules/zhisme/copy_with_context -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/zhisme/copy_with_context](https://luarocks.org/modules/zhisme/copy_with_context) |
| Source record ids | luarocks_root_manifest-3e15158cd6d369 |
...
For a systems engineer, copy_with_context belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3e15158cd6d369` from `luarocks_root_manifest` as `registry_expansion`
