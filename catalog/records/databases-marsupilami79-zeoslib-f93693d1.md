# marsupilami79/zeoslib

## Navigation

[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/marsupilami79/zeoslib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marsupilami79/zeoslib](https://github.com/marsupilami79/zeoslib) |
| Source record ids | github_search_databases-e0da42cd687235 |

## System Engineer Summary

This is a copy of the official zeoslib repository at Tags were migrated as branches. This repository
is for testing purposes and might be deleted in the future. If you find any issues please use the
bug tracker on Sourceforge .

## Operational Role

For a systems engineer, marsupilami79/zeoslib belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T05:51:54Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `github_search_databases-e0da42cd687235` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| benbjohnson/litestream | Testing Framework | [open](databases-benbjohnson-litestream-d7da8b84.md) |
| datopian/r2-bucket-uploader | Testing Framework | [open](databases-datopian-r2-bucket-uploader-a0c1456a.md) |
| dominikhei/Local-Data-LakeHouse | Testing Framework | [open](databases-dominikhei-local-data-lakehouse-4f8f71d9.md) |
| invertase/react-native-firebase | Testing Framework | [open](databases-invertase-react-native-firebase-bdf40bbb.md) |
| long2ice/asyncmy | Testing Framework | [open](databases-long2ice-asyncmy-537bc784.md) |
| netdata/netdata | Testing Framework | [open](databases-netdata-netdata-c3fa5bcb.md) |
| porsager/postgres | Testing Framework | [open](databases-porsager-postgres-fbaff732.md) |
| vladmihalcea/db-util | Testing Framework | [open](databases-vladmihalcea-db-util-1a17f88b.md) |
