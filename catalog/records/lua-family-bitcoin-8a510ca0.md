...
<!-- canonical: https://luarocks.org/modules/glenn/bitcoin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/glenn/bitcoin](https://luarocks.org/modules/glenn/bitcoin) |
| Source record ids | luarocks_root_manifest-951be7bc65c740 |

## System Engineer Summary

bitcoin is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, bitcoin belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-951be7bc65c740` from `luarocks_root_manifest` as `registry_expansion`
