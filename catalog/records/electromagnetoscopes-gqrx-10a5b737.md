...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Electromagnetoscopes](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/electromagnetoscopes.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/gqrx-sdr/gqrx](https://github.com/gqrx-sdr/gqrx) |
| Source record ids | curated_language_routes-b8fbc77776639b |

## System Engineer Summary

Software-defined radio receiver application for spectrum visualization, demodulation, recording, and
hardware control.

## Operational Role

For a systems engineer, Gqrx belongs in the Electromagnetoscopes inventory as part of ecosystem
...
- `curated_language_routes-b8fbc77776639b` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| SigDigger | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/electromagnetoscopes-sigdigger-9dac6595.md) |
