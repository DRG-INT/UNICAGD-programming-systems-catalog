...
<!-- canonical: https://hackage.haskell.org/package/lsp-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/lsp-types](https://hackage.haskell.org/package/lsp-types) |
| Source record ids | hackage_top_downloads-6cc22b06e262f8 |
...
For a systems engineer, lsp-types belongs in the Haskell inventory as part of editor intelligence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.0.0 | 2026-02-17T10:12:29Z | [https://hackage.haskell.org/package/lsp-types](https://hackage.haskell.org/package/lsp-types) |  |
| candidate | partial | 1.0.0.0 |  | [https://hackage.haskell.org/package/lsp-types](https://hackage.haskell.org/package/lsp-types) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/lsp-types` at `2026-09-02T00:32:45+00:00`.
...
- `hackage_top_downloads-6cc22b06e262f8` from `hackage_top_downloads` as `registry_expansion`
...
| lsp | Language Server | [open](haskell-lsp-c5783ad2.md) |
