...
<!-- canonical: https://pub.dev/packages/html_unescape -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/html_unescape](https://pub.dev/packages/html_unescape) |
| Source record ids | pub_dev-e18156cac413a7 |

## System Engineer Summary

A small library for un-escaping HTML. Supports all Named Character References, Decimal Character
References and Hexadecimal Character References.

## Operational Role

For a systems engineer, html_unescape belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2021-03-22T16:08:52.466016Z | [https://pub.dev/api/packages/html_unescape](https://pub.dev/api/packages/html_unescape) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-01-21T20:26:37.480246Z | [https://pub.dev/api/packages/html_unescape](https://pub.dev/api/packages/html_unescape) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/html_unescape` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-e18156cac413a7` from `pub_dev` as `registry_expansion`
