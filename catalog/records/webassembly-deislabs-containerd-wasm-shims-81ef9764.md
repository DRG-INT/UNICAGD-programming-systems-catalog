...
<!-- canonical: https://github.com/deislabs/containerd-wasm-shims -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deislabs/containerd-wasm-shims](https://github.com/deislabs/containerd-wasm-shims) |
| Source record ids | github_search_webassembly-d8e632c7275428 |
...
For a systems engineer, deislabs/containerd-wasm-shims belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-21T22:44:04Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-d8e632c7275428` from `github_search_webassembly` as `registry_expansion`
