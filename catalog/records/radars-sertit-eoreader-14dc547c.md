...
<!-- canonical: https://github.com/sertit/eoreader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sertit/eoreader](https://github.com/sertit/eoreader) |
| Source record ids | github_search_radars-148e45ee5757c3 |

## System Engineer Summary

Remote-sensing opensource python library reading optical and SAR sensors, loading and stacking
bands, clouds, DEM and spectral indices in a sensor-agnostic way.

## Operational Role

For a systems engineer, sertit/eoreader belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T19:02:39Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-148e45ee5757c3` from `github_search_radars` as `registry_expansion`
