# JulioG516/RadioGarden.NET

## Navigation

[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JulioG516/RadioGarden.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JulioG516/RadioGarden.NET](https://github.com/JulioG516/RadioGarden.NET) |
| Source record ids | github_search_radio_garden_speciality-3d59b793a6ce07 |

## System Engineer Summary

🌐 Radio Garden API .NET Library 🎧 A .NET library for interacting with the Radio Garden API, enabling
retrieval of radio channel details, place-specific stations, stream URLs, and client geolocation.

## Operational Role

For a systems engineer, JulioG516/RadioGarden.NET belongs in the Radio Garden Speciality inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-29T19:59:17Z | gh search repos "Radio Garden" API | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "\"Radio Garden\" API", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_radio_garden_speciality-3d59b793a6ce07` from `github_search_radio_garden_speciality` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| antoninadert/Radio-Garden-Client | Networking Http | [open](radio-garden-speciality-antoninadert-radio-garden-client-0f10e734.md) |
| chermenin/radio.G | Networking Http | [open](radio-garden-speciality-chermenin-radio-g-9c2b13d4.md) |
| jonasrmichel/radio-garden-go | Networking Http | [open](radio-garden-speciality-jonasrmichel-radio-garden-go-67385626.md) |
| khaleeljageer/radio_garden | Networking Http | [open](radio-garden-speciality-khaleeljageer-radio-garden-42d10827.md) |
| prafulbusa/Radio-Garden-Client | Networking Http | [open](radio-garden-speciality-prafulbusa-radio-garden-client-287c720b.md) |
| valarpirai/Online-Radio | Networking Http | [open](radio-garden-speciality-valarpirai-online-radio-df01c2e6.md) |
