...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/0xType/0xProto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/0xType/0xProto](https://github.com/0xType/0xProto) |
| Source record ids | github_search_font_briefcase-1f599250ce2c03 |
...
For a systems engineer, 0xType/0xProto belongs in the Font Briefcase inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-21T10:01:37Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-1f599250ce2c03` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| darkroomengineering/forma | Game Engine Game Dev | [open](font-briefcase-darkroomengineering-forma-acf37ac1.md) |
| harfbuzz/harfbuzz | Game Engine Game Dev | [open](font-briefcase-harfbuzz-harfbuzz-a3b0c0bf.md) |
