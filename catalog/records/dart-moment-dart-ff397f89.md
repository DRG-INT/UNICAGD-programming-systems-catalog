...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/moment_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/moment_dart](https://pub.dev/packages/moment_dart) |
| Source record ids | pub_dev-390b6653cfc2e9 |

## System Engineer Summary

Multi-purpose immutable DateTime subclass. Supports multiple localizations to easily convert
DateTime and Duration into human-readable format

## Operational Role

For a systems engineer, moment_dart belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.4 | 2026-05-03T00:31:07.926599Z | [https://pub.dev/api/packages/moment_dart](https://pub.dev/api/packages/moment_dart) |  |
| preview | known | 2.2.1+beta.0 | 2024-07-21T08:45:24.278950Z | [https://pub.dev/api/packages/moment_dart](https://pub.dev/api/packages/moment_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/moment_dart` at `2026-09-06T05:17:58+00:00`.
...
- `pub_dev-390b6653cfc2e9` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| archive | Formatter | [open](dart-archive-707387f9.md) |
| battery_plus | Formatter | [open](dart-battery-plus-d0854517.md) |
| brasil_fields | Formatter | [open](dart-brasil-fields-a5208df0.md) |
| camera_web | Formatter | [open](dart-camera-web-88f0b605.md) |
| currency_text_input_formatter | Formatter | [open](dart-currency-text-input-formatter-9b2cc3c7.md) |
| dart_style | Formatter | [open](dart-dart-style-096ccda0.md) |
| easy_stepper | Formatter | [open](dart-easy-stepper-59c82811.md) |
| flutter_markdown_plus | Formatter | [open](dart-flutter-markdown-plus-b685f3ff.md) |
