...
| Canonical URL | [https://pypi.org/](https://pypi.org/) |
| Source record ids | curated_language_routes-f565c7d3b581e9 |

## System Engineer Summary

Python package hub for distributions, releases, project metadata, maintainers, and install
artifacts.

## Operational Role

For a systems engineer, PyPI belongs in the Hubs inventory as part of ecosystem capability mapping,
...
- `curated_language_routes-f565c7d3b581e9` from `curated_language_routes` as `registry_expansion`
