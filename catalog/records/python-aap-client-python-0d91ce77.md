...
<!-- canonical: https://pypi.org/project/aap-client-python/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aap-client-python/](https://pypi.org/project/aap-client-python/) |
| Source record ids | pypi_simple-6d2f0c8bdb4193 |

## System Engineer Summary

aap-client-python is tracked as a networking http record in the Python branch. The source did not
...
For a systems engineer, aap-client-python belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2018-04-24T15:20:26.347570Z | [https://pypi.org/pypi/aap-client-python/json](https://pypi.org/pypi/aap-client-python/json) |  |
| preview | known | 1.0.0b1 | 2018-08-02T07:56:45.061544Z | [https://pypi.org/pypi/aap-client-python/json](https://pypi.org/pypi/aap-client-python/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aap-client-python/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-6d2f0c8bdb4193` from `pypi_simple` as `registry_expansion`
