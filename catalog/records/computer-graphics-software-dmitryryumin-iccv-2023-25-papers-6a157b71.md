...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DmitryRyumin/ICCV-2023-25-Papers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DmitryRyumin/ICCV-2023-25-Papers](https://github.com/DmitryRyumin/ICCV-2023-25-Papers) |
| Source record ids | github_search_computer_graphics_software-6f1fb71cb1c2ca |

## System Engineer Summary

ICCV 2023-2025 Papers: Discover cutting-edge research from ICCV 2023-25, the leading computer vision
conference. Stay updated on the latest in computer vision and deep learning, with code included. ⭐
support visual intelligence development!

## Operational Role

For a systems engineer, DmitryRyumin/ICCV-2023-25-Papers belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-6f1fb71cb1c2ca` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| google/shaderc | Testing Framework | [open](computer-graphics-software-google-shaderc-cc3fd0a6.md) |
