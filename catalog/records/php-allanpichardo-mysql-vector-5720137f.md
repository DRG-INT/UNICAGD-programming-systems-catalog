...
| Canonical URL | [https://packagist.org/packages/allanpichardo/mysql-vector](https://packagist.org/packages/allanpichardo/mysql-vector) |
| Source record ids | packagist_search-e72e46180acd20 |
...
For a systems engineer, allanpichardo/mysql-vector belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.4 | 2025-01-20T22:18:05+00:00 | [https://repo.packagist.org/p2/allanpichardo/mysql-vector.json](https://repo.packagist.org/p2/allanpichardo/mysql-vector.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/allanpichardo/mysql-vector.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-e72e46180acd20` from `packagist_search` as `registry_expansion`
