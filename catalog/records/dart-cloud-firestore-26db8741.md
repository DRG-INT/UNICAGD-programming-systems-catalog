...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/cloud_firestore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/cloud_firestore](https://pub.dev/packages/cloud_firestore) |
| Source record ids | pub_dev-c0c2eb3d65bc80 |

## System Engineer Summary

Flutter plugin for Cloud Firestore, a cloud-hosted, noSQL database with live synchronization and
offline support on Android and iOS.

## Operational Role

For a systems engineer, cloud_firestore belongs in the Dart inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.10.0 | 2026-09-14T13:33:54.843470Z | [https://pub.dev/api/packages/cloud_firestore](https://pub.dev/api/packages/cloud_firestore) |  |
| preview | known | 1.0.0-1.0.nullsafety.0 | 2021-02-22T12:40:59.565433Z | [https://pub.dev/api/packages/cloud_firestore](https://pub.dev/api/packages/cloud_firestore) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/cloud_firestore` at `2026-09-14T14:23:05+00:00`.
...
- `pub_dev-c0c2eb3d65bc80` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| drift_flutter | Database Datastore | [open](dart-drift-flutter-475023b9.md) |
| postgres | Database Datastore | [open](dart-postgres-36d0d96d.md) |
| sqflite | Database Datastore | [open](dart-sqflite-095e3684.md) |
| sqflite_common | Database Datastore | [open](dart-sqflite-common-296faecb.md) |
| sqlite3_flutter_libs | Database Datastore | [open](dart-sqlite3-flutter-libs-9b6fee4a.md) |
| timezone | Database Datastore | [open](dart-timezone-b9205c53.md) |
