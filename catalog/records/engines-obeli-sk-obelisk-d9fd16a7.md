...
| Source record ids | github_search_engines-0e552a6a26dfd1 |
...
For a systems engineer, obeli-sk/obelisk belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:53:20Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-0e552a6a26dfd1` from `github_search_engines` as `registry_expansion`
