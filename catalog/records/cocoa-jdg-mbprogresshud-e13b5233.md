...
<!-- canonical: https://github.com/jdg/MBProgressHUD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jdg/MBProgressHUD](https://github.com/jdg/MBProgressHUD) |
| Source record ids | github_search_cocoa-6c32c5211ae73a |
...
For a systems engineer, jdg/MBProgressHUD belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-14T01:48:59Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-6c32c5211ae73a` from `github_search_cocoa` as `registry_expansion`
