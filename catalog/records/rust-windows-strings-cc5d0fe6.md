...
<!-- canonical: https://crates.io/crates/windows-strings -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-strings](https://crates.io/crates/windows-strings) |
| Source record ids | crates_io-e7de40ec9da606 |

## System Engineer Summary

windows-strings is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, windows-strings belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:41:44.762627Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-e7de40ec9da606` from `crates_io` as `registry_expansion`
