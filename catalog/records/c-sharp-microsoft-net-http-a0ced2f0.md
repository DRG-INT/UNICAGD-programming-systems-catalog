...
<!-- canonical: https://www.nuget.org/packages/Microsoft.Net.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Net.Http](https://www.nuget.org/packages/Microsoft.Net.Http) |
| Source record ids | nuget_search-11f4a3a6c27e15 |

## System Engineer Summary

This package includes HttpClient for sending requests over HTTP, as well as HttpRequestMessage and
HttpResponseMessage for processing HTTP messages. This package is not supported in Visual Studio
2010, and is only required for projects targeting .NET Framework 4.5, Windows 8, or Windows Phone
8.1 when consuming a library that uses this package. Supported Platforms: - .NET Framework 4 -
Windows 8 - Windows Phone 8.1 - Windows Phone Silverlight 7.5 - Silverlight 4 - Portable Class
Libraries

## Operational Role

For a systems engineer, Microsoft.Net.Http belongs in the C-Sharp inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.29 | 2015-02-25T01:22:58.64+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.net.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.net.http/index.json) |  |
| preview | known | 2.2.27-beta | 2014-06-18T21:55:15.06+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.net.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.net.http/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; http://go.microsoft.com/fwlink/?LinkId=329770 |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.net.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-11f4a3a6c27e15` from `nuget_search` as `registry_expansion`
