...
| Canonical URL | [https://crates.io/crates/slice-group-by](https://crates.io/crates/slice-group-by) |
| Source record ids | crates_io-8f253436b2f3ca |
...
For a systems engineer, slice-group-by belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2023-05-03T13:14:15.474244Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-8f253436b2f3ca` from `crates_io` as `registry_expansion`
