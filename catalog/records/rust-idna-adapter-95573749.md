...
<!-- canonical: https://crates.io/crates/idna_adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/idna_adapter](https://crates.io/crates/idna_adapter) |
| Source record ids | crates_io-846cc33a39da48 |
...
For a systems engineer, idna_adapter belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-04-27T17:45:54.838641Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-846cc33a39da48` from `crates_io` as `registry_expansion`
