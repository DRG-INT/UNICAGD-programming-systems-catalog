...
<!-- canonical: https://luarocks.org/modules/doronbehar/awesomewm-autostart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/doronbehar/awesomewm-autostart](https://luarocks.org/modules/doronbehar/awesomewm-autostart) |
| Source record ids | luarocks_root_manifest-d37ef859acc59d |

## System Engineer Summary

Enhanced autostart for AwesomeWM

## Operational Role

For a systems engineer, awesomewm-autostart belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d37ef859acc59d` from `luarocks_root_manifest` as `registry_expansion`
