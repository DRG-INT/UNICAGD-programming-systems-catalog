...
<!-- canonical: https://cran.r-project.org/web/packages/moderndive/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/moderndive/index.html](https://cran.r-project.org/web/packages/moderndive/index.html) |
| Source record ids | cran_packages_by_date-e0d3125d472629 |
...
For a systems engineer, moderndive belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-04 22:50:08 UTC | [https://cran.r-project.org/web/packages/moderndive/DESCRIPTION](https://cran.r-project.org/web/packages/moderndive/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/moderndive/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e0d3125d472629` from `cran_packages_by_date` as `registry_expansion`
