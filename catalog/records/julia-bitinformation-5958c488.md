...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Formatter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/formatter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BitInformation](https://github.com/JuliaRegistries/General/tree/master/B/BitInformation) |
| Source record ids | julia_general-987f30add03e32 |

## System Engineer Summary

Julia package registered in General at B/BitInformation.

## Operational Role

For a systems engineer, BitInformation belongs in the Julia inventory as part of low-noise code
...
| Name | Category | Page |
| --- | --- | --- |
| AlignedBinaryFormat | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-alignedbinaryformat-6012125b.md) |
| ArnoldiMethodTransformations | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arnoldimethodtransformations-fa5c117f.md) |
| BatchedTransformations | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-batchedtransformations-8efda24f.md) |
| BioformatsLoader | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bioformatsloader-fb763c90.md) |
| Bioinformatics | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bioinformatics-63465a31.md) |
| BiosemiDataFormat | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-biosemidataformat-1e4cc900.md) |
| BlackBoxOptim | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-blackboxoptim-b5024037.md) |
| BlackBoxOptimizationBenchmarking | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-blackboxoptimizationbenchmarking-cd7f357d.md) |
