...
<!-- canonical: https://github.com/rickytan/RTImageAssets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rickytan/RTImageAssets](https://github.com/rickytan/RTImageAssets) |
| Source record ids | github_search_icons_and_logos-a9e14c784c6c74 |

## System Engineer Summary

A Xcode plugin to automatically generate 2x, 1x image from 3x image for you, or upscale to 3x from
2x

## Operational Role

For a systems engineer, rickytan/RTImageAssets belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-22T10:09:01Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-a9e14c784c6c74` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Pythonity/icon-font-to-png | Image Audio Dsp | [open](icons-and-logos-pythonity-icon-font-to-png-c778bc26.md) |
