...
<!-- canonical: https://cran.r-project.org/web/packages/awdb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/awdb/index.html](https://cran.r-project.org/web/packages/awdb/index.html) |
| Source record ids | cran_packages_by_date-1381a30b11f7a4 |
...
For a systems engineer, awdb belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-21 18:00:02 UTC | [https://cran.r-project.org/web/packages/awdb/DESCRIPTION](https://cran.r-project.org/web/packages/awdb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/awdb/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1381a30b11f7a4` from `cran_packages_by_date` as `registry_expansion`
