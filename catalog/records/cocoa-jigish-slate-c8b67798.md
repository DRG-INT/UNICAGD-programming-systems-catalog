...
<!-- canonical: https://github.com/jigish/slate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jigish/slate](https://github.com/jigish/slate) |
| Source record ids | github_search_cocoa-9b12d0916ee8bd |
...
For a systems engineer, jigish/slate belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-23T09:17:42Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-9b12d0916ee8bd` from `github_search_cocoa` as `registry_expansion`
