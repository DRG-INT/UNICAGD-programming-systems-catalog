...
| Source record ids | hackage_top_downloads-6d9e1206b95312 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/effectful-core` at `2026-09-14T00:30:46+00:00`.
...
- `hackage_top_downloads-6d9e1206b95312` from `hackage_top_downloads` as `registry_expansion`
