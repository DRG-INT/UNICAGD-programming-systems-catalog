# hatfullr/UnityURP-AnimeStyleCelShader
...
| Canonical URL | [https://github.com/hatfullr/UnityURP-AnimeStyleCelShader](https://github.com/hatfullr/UnityURP-AnimeStyleCelShader) |
| Source record ids | github_search_effects-c24a49bf61ff71 |

## System Engineer Summary

A custom shader and post-processing effect for achieving anime-style characters or levels in Unity
using the Universal Render Pipeline.

## Operational Role

For a systems engineer, hatfullr/UnityURP-AnimeStyleCelShader belongs in the Effects inventory as
...
- `github_search_effects-c24a49bf61ff71` from `github_search_effects` as `registry_expansion`
...
| JosephOIbrahim/Houdini_Camera_Rig_System | Package Manager | [open](effects-josephoibrahim-houdini-camera-rig-system-2f878675.md) |
| mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect | Package Manager | [open](effects-mbelyavsky-unity-hdrp-jpeg-mp4-compression-postprocessing-effect-b83437c1.md) |
| nvjob/ppsc | Package Manager | [open](effects-nvjob-ppsc-40ef5bfb.md) |
| thevoidky/custom-post-process-on-urp | Package Manager | [open](effects-thevoidky-custom-post-process-on-urp-f0e94f32.md) |
