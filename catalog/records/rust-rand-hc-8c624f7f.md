...
<!-- canonical: https://crates.io/crates/rand_hc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_hc](https://crates.io/crates/rand_hc) |
| Source record ids | crates_io-87fe2a450bbd72 |
...
For a systems engineer, rand_hc belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-06-15T15:41:57.994703Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-87fe2a450bbd72` from `crates_io` as `registry_expansion`
