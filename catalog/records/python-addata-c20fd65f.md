...
<!-- canonical: https://pypi.org/project/addata/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/addata/](https://pypi.org/project/addata/) |
| Source record ids | pypi_simple-acd5e483ba5a3d |

## System Engineer Summary

addata is tracked as a library record in the Python branch. The source did not provide a long
...
For a systems engineer, addata belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2022-07-05T20:29:46.535835Z | [https://pypi.org/pypi/addata/json](https://pypi.org/pypi/addata/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/addata/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-acd5e483ba5a3d` from `pypi_simple` as `registry_expansion`
