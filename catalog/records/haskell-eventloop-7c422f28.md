...
<!-- canonical: https://hackage.haskell.org/package/eventloop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/eventloop](https://hackage.haskell.org/package/eventloop) |
| Source record ids | hackage_top_downloads-5f628dfdd1b05c |
...
For a systems engineer, eventloop belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2.8 | 2019-05-01T08:59:35Z | [https://hackage.haskell.org/package/eventloop](https://hackage.haskell.org/package/eventloop) |  |
| candidate | partial | 0.8.2.8 |  | [https://hackage.haskell.org/package/eventloop](https://hackage.haskell.org/package/eventloop) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/eventloop` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-5f628dfdd1b05c` from `hackage_top_downloads` as `registry_expansion`
