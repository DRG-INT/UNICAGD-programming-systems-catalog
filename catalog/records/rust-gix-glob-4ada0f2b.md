...
<!-- canonical: https://crates.io/crates/gix-glob -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gix-glob](https://crates.io/crates/gix-glob) |
| Source record ids | crates_io-a801598eead299 |
...
For a systems engineer, gix-glob belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.1 | 2026-08-22T19:01:36.390103Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-a801598eead299` from `crates_io` as `registry_expansion`
