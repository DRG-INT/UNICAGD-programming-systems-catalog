...
<!-- canonical: https://github.com/databasus/databasus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/databasus/databasus](https://github.com/databasus/databasus) |
| Source record ids | github_search_databases-374d7cc7aec129 |
...
For a systems engineer, databasus/databasus belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T19:16:37Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-374d7cc7aec129` from `github_search_databases` as `registry_expansion`
