...
<!-- canonical: https://github.com/flame-engine/flame -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flame-engine/flame](https://github.com/flame-engine/flame) |
| Source record ids | github_search_game_engines-ba81c20059694d |
...
For a systems engineer, flame-engine/flame belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:57:31Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-ba81c20059694d` from `github_search_game_engines` as `registry_expansion`
