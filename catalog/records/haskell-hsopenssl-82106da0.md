...
<!-- canonical: https://hackage.haskell.org/package/HsOpenSSL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HsOpenSSL](https://hackage.haskell.org/package/HsOpenSSL) |
| Source record ids | hackage_top_downloads-8afc37b92715aa |
...
For a systems engineer, HsOpenSSL belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.7.11 | 2026-06-29T21:10:25Z | [https://hackage.haskell.org/package/HsOpenSSL](https://hackage.haskell.org/package/HsOpenSSL) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HsOpenSSL` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-8afc37b92715aa` from `hackage_top_downloads` as `registry_expansion`
