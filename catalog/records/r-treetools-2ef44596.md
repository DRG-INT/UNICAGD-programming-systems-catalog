...
<!-- canonical: https://cran.r-project.org/web/packages/TreeTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TreeTools/index.html](https://cran.r-project.org/web/packages/TreeTools/index.html) |
| Source record ids | cran_packages_by_date-39376b9a7ce299 |
...
For a systems engineer, TreeTools belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.1 | 2026-09-10 11:10:07 UTC | [https://cran.r-project.org/web/packages/TreeTools/DESCRIPTION](https://cran.r-project.org/web/packages/TreeTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TreeTools/DESCRIPTION` at `2026-09-10T12:26:17+00:00`.
...
- `cran_packages_by_date-39376b9a7ce299` from `cran_packages_by_date` as `registry_expansion`
