...
<!-- canonical: https://www.npmjs.com/package/mime-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mime-db](https://www.npmjs.com/package/mime-db) |
| Source record ids | npm_registry-fc223187fe9e16 |

## System Engineer Summary

mime-db is tracked as a database datastore record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, mime-db belongs in the Node.js/JavaScript inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.54.0 | 2025-03-18T15:06:44.354Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-fc223187fe9e16` from `npm_registry` as `registry_expansion`
