...
<!-- canonical: https://cran.r-project.org/web/packages/weightflow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/weightflow/index.html](https://cran.r-project.org/web/packages/weightflow/index.html) |
| Source record ids | cran_packages_by_date-3611e433da2f3a |
...
For a systems engineer, weightflow belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-30 03:30:02 UTC | [https://cran.r-project.org/web/packages/weightflow/DESCRIPTION](https://cran.r-project.org/web/packages/weightflow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/weightflow/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3611e433da2f3a` from `cran_packages_by_date` as `registry_expansion`
