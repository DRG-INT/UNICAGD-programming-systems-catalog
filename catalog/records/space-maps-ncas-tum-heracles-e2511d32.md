...
<!-- canonical: https://github.com/ncas-tum/heracles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ncas-tum/heracles](https://github.com/ncas-tum/heracles) |
| Source record ids | github_search_space_maps-e6e26c8990ce6e |

## System Engineer Summary

HfO2 Ferroelectric Capacitor VerilogA Compact Model for Circuit Simulation

## Operational Role

For a systems engineer, ncas-tum/heracles belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-07T16:47:06Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e6e26c8990ce6e` from `github_search_space_maps` as `registry_expansion`
...
| bufferedName/ZSpice | Logging Observability | [open](space-maps-bufferedname-zspice-ef3fa10d.md) |
