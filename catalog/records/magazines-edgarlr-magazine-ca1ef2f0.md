...
<!-- canonical: https://github.com/edgarlr/magazine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/edgarlr/magazine](https://github.com/edgarlr/magazine) |
| Source record ids | github_search_magazines-4933d0b7bef569 |

## System Engineer Summary

Next.js Digital Magazine Starter Kit

## Operational Role

For a systems engineer, edgarlr/magazine belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-10T01:24:38Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-4933d0b7bef569` from `github_search_magazines` as `registry_expansion`
