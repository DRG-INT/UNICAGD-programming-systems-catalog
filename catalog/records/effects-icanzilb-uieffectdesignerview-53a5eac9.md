...
<!-- canonical: https://github.com/icanzilb/UIEffectDesignerView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/icanzilb/UIEffectDesignerView](https://github.com/icanzilb/UIEffectDesignerView) |
| Source record ids | github_search_effects-1b00281983cce9 |
...
For a systems engineer, icanzilb/UIEffectDesignerView belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-03-31T13:13:33Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1b00281983cce9` from `github_search_effects` as `registry_expansion`
