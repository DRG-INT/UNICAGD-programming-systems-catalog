...
<!-- canonical: https://github.com/elastic/eui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elastic/eui](https://github.com/elastic/eui) |
| Source record ids | github_search_icons_and_logos-042a9c1a48e6e7 |

## System Engineer Summary

elastic/eui is tracked as a parser lexer ast record in the Icons and Logos branch. The source did
...
For a systems engineer, elastic/eui belongs in the Icons and Logos inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T15:52:44Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-042a9c1a48e6e7` from `github_search_icons_and_logos` as `registry_expansion`
