...
<!-- canonical: https://github.com/kpobrien/JosephsonCircuits.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kpobrien/JosephsonCircuits.jl](https://github.com/kpobrien/JosephsonCircuits.jl) |
| Source record ids | github_search_space_maps-3d080e3c6ed5ed |

## System Engineer Summary

Frequency domain, multi-tone harmonic balance, simulation of scattering parameters and noise in
nonlinear circuits containing Josephson junctions. Scattering parameter conversion and
interconnection.

## Operational Role

For a systems engineer, kpobrien/JosephsonCircuits.jl belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T21:18:56Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-3d080e3c6ed5ed` from `github_search_space_maps` as `registry_expansion`
