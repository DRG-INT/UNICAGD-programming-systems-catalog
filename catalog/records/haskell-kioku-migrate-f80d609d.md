...
| Canonical URL | [https://hackage.haskell.org/package/kioku-migrate](https://hackage.haskell.org/package/kioku-migrate) |
| Source record ids | hackage_recent-1ea8333adc6eff |
...
For a systems engineer, kioku-migrate belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2.0 | 2026-09-01T04:10:55Z | [https://hackage.haskell.org/package/kioku-migrate](https://hackage.haskell.org/package/kioku-migrate) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kioku-migrate` at `2026-09-01T07:24:08+00:00`.
...
- `hackage_recent-1ea8333adc6eff` from `hackage_recent` as `registry_expansion`
