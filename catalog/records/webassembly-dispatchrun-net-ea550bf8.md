...
<!-- canonical: https://github.com/dispatchrun/net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dispatchrun/net](https://github.com/dispatchrun/net) |
| Source record ids | github_search_webassembly-1579008a554519 |
...
For a systems engineer, dispatchrun/net belongs in the WebAssembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-11T23:36:01Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-1579008a554519` from `github_search_webassembly` as `registry_expansion`
...
| joreilly/PeopleInSpace | Networking Http | [open](webassembly-joreilly-peopleinspace-b99b8c35.md) |
