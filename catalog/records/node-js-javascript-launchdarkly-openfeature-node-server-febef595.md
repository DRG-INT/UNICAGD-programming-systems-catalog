...
<!-- canonical: https://www.npmjs.com/package/@launchdarkly/openfeature-node-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@launchdarkly/openfeature-node-server](https://www.npmjs.com/package/@launchdarkly/openfeature-node-server) |
| Source record ids | npm_registry-24ce9b64a61583 |

## System Engineer Summary

LaunchDarkly OpenFeature provider for the Node.js server SDK

## Operational Role

For a systems engineer, @launchdarkly/openfeature-node-server belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-25T17:04:27.758Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-24ce9b64a61583` from `npm_registry` as `registry_expansion`
