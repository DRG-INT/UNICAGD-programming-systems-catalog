# blackspiritualangel-pixel/astro-map
...
<!-- canonical: https://github.com/blackspiritualangel-pixel/astro-map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blackspiritualangel-pixel/astro-map](https://github.com/blackspiritualangel-pixel/astro-map) |
| Source record ids | github_search_space_maps-0ef1cd5f3ceb53 |

## System Engineer Summary

Dynamic astrocartography world map with personalized planetary lines, designed as a web embed for
Glide.

## Operational Role

For a systems engineer, blackspiritualangel-pixel/astro-map belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-30T14:54:43Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0ef1cd5f3ceb53` from `github_search_space_maps` as `registry_expansion`
