...
<!-- canonical: https://pub.dev/packages/liquid_glass_easy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/liquid_glass_easy](https://pub.dev/packages/liquid_glass_easy) |
| Source record ids | pub_dev-d11697ab8d55df |

## System Engineer Summary

Apple iOS Liquid Glass for Flutter: a shader lens that refracts what is behind it, with blending,
morph, adaptive chrome, controls, batching and lite glass.

## Operational Role

For a systems engineer, liquid_glass_easy belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2026-09-12T00:44:35.272698Z | [https://pub.dev/api/packages/liquid_glass_easy](https://pub.dev/api/packages/liquid_glass_easy) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/liquid_glass_easy` at `2026-09-12T03:19:40+00:00`.
...
- `pub_dev-d11697ab8d55df` from `pub_dev` as `registry_expansion`
