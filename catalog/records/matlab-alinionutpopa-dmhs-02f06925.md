...
<!-- canonical: https://github.com/alinionutpopa/dmhs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alinionutpopa/dmhs](https://github.com/alinionutpopa/dmhs) |
| Source record ids | github_search_matlab-7bf082660da6af |
...
For a systems engineer, alinionutpopa/dmhs belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-12T14:46:54Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-7bf082660da6af` from `github_search_matlab` as `registry_expansion`
