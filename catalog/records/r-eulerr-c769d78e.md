...
<!-- canonical: https://cran.r-project.org/web/packages/eulerr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/eulerr/index.html](https://cran.r-project.org/web/packages/eulerr/index.html) |
| Source record ids | cran_packages_by_date-2ec4d51120e3da |
...
For a systems engineer, eulerr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.3.0 | 2026-08-21 21:50:10 UTC | [https://cran.r-project.org/web/packages/eulerr/DESCRIPTION](https://cran.r-project.org/web/packages/eulerr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/eulerr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2ec4d51120e3da` from `cran_packages_by_date` as `registry_expansion`
