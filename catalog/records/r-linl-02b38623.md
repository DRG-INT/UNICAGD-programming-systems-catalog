...
<!-- canonical: https://cran.r-project.org/web/packages/linl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/linl/index.html](https://cran.r-project.org/web/packages/linl/index.html) |
| Source record ids | cran_packages_by_date-552f9a2ea386ca |

## System Engineer Summary

linl is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, linl belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-08-26 12:20:08 UTC | [https://cran.r-project.org/web/packages/linl/DESCRIPTION](https://cran.r-project.org/web/packages/linl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/linl/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-552f9a2ea386ca` from `cran_packages_by_date` as `registry_expansion`
