...
<!-- canonical: https://github.com/eurostat/eurostat-map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eurostat/eurostat-map](https://github.com/eurostat/eurostat-map) |
| Source record ids | github_search_maps-ef7954dde7b931 |
...
For a systems engineer, eurostat/eurostat-map belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T14:15:04Z | gh search repos topic:web-mapping stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-ef7954dde7b931` from `github_search_maps` as `registry_expansion`
