...
<!-- canonical: https://github.com/rkaczorek/astroberry-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rkaczorek/astroberry-server](https://github.com/rkaczorek/astroberry-server) |
| Source record ids | github_search_space_maps-5e90b816192196 |

## System Engineer Summary

Astroberry Server is a ready to use system for Raspberry Pi for controlling all your astronomy
equipment

## Operational Role

For a systems engineer, rkaczorek/astroberry-server belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-11T12:01:25Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5e90b816192196` from `github_search_space_maps` as `registry_expansion`
