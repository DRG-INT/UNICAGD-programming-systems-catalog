...
| Canonical URL | [https://crates.io/crates/static_assertions_next](https://crates.io/crates/static_assertions_next) |
| Source record ids | crates_io-15baff5064592c |
...
For a systems engineer, static_assertions_next belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2024-01-16T18:28:43.207284Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-15baff5064592c` from `crates_io` as `registry_expansion`
