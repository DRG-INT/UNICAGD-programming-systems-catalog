...
<!-- canonical: https://github.com/tatethurston/nextjs-routes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tatethurston/nextjs-routes](https://github.com/tatethurston/nextjs-routes) |
| Source record ids | github_search_maps-f884495321d234 |
...
For a systems engineer, tatethurston/nextjs-routes belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-17T01:11:20Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f884495321d234` from `github_search_maps` as `registry_expansion`
