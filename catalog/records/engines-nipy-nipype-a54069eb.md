...
<!-- canonical: https://github.com/nipy/nipype -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nipy/nipype](https://github.com/nipy/nipype) |
| Source record ids | github_search_engines-b438700f851e07 |
...
For a systems engineer, nipy/nipype belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:50:20Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-b438700f851e07` from `github_search_engines` as `registry_expansion`
