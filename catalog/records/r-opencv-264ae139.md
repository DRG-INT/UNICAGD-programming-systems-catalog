...
<!-- canonical: https://cran.r-project.org/web/packages/opencv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/opencv/index.html](https://cran.r-project.org/web/packages/opencv/index.html) |
| Source record ids | cran_packages_by_date-5231af3d694947 |
...
For a systems engineer, opencv belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-14 21:30:02 UTC | [https://cran.r-project.org/web/packages/opencv/DESCRIPTION](https://cran.r-project.org/web/packages/opencv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/opencv/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-5231af3d694947` from `cran_packages_by_date` as `registry_expansion`
