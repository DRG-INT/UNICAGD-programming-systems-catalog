...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_space_engines-8df4a3f6deff90 |
...
For a systems engineer, thkruz/ootk belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T14:12:36Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-8df4a3f6deff90` from `github_search_space_engines` as `registry_expansion`
