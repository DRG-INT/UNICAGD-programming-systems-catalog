...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/ACSWR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ACSWR/index.html](https://cran.r-project.org/web/packages/ACSWR/index.html) |
| Source record ids | cran_packages_by_date-10436b583b5bf6 |
...
For a systems engineer, ACSWR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-13 03:50:09 UTC | [https://cran.r-project.org/web/packages/ACSWR/DESCRIPTION](https://cran.r-project.org/web/packages/ACSWR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ACSWR/DESCRIPTION` at `2026-09-13T04:19:54+00:00`.
...
- `cran_packages_by_date-10436b583b5bf6` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bookdown | Tutorial Book Styleguide | [open](r-bookdown-d3626540.md) |
| dobson | Tutorial Book Styleguide | [open](r-dobson-853a14d4.md) |
| magentabook | Tutorial Book Styleguide | [open](r-magentabook-1e1cf25d.md) |
| TRSbook | Tutorial Book Styleguide | [open](r-trsbook-a6bb2d75.md) |
