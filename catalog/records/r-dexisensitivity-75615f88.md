...
<!-- canonical: https://cran.r-project.org/web/packages/dexisensitivity/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dexisensitivity/index.html](https://cran.r-project.org/web/packages/dexisensitivity/index.html) |
| Source record ids | cran_packages_by_date-59074bcf1405b1 |
...
For a systems engineer, dexisensitivity belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-30 10:50:02 UTC | [https://cran.r-project.org/web/packages/dexisensitivity/DESCRIPTION](https://cran.r-project.org/web/packages/dexisensitivity/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dexisensitivity/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-59074bcf1405b1` from `cran_packages_by_date` as `registry_expansion`
