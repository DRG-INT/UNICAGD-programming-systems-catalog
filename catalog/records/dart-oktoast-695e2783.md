...
<!-- canonical: https://pub.dev/packages/oktoast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/oktoast](https://pub.dev/packages/oktoast) |
| Source record ids | pub_dev-fcb79330946e3b |

## System Engineer Summary

A pure flutter toast library, support custom style/widget, easy achieve the same effect with native
toasts.

## Operational Role

For a systems engineer, oktoast belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.0 | 2023-11-17T07:37:04.781812Z | [https://pub.dev/api/packages/oktoast](https://pub.dev/api/packages/oktoast) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/oktoast` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-fcb79330946e3b` from `pub_dev` as `registry_expansion`
