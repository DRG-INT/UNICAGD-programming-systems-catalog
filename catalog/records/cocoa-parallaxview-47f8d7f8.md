...
<!-- canonical: https://github.com/PGSSoft/ParallaxView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PGSSoft/ParallaxView](https://github.com/PGSSoft/ParallaxView) |
| Source record ids | awesome_list-877962fa92266d |
...
For a systems engineer, ParallaxView belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.2 | 2020-08-04T06:46:47Z | [https://api.github.com/repos/PGSSoft/ParallaxView/releases/latest](https://api.github.com/repos/PGSSoft/ParallaxView/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PGSSoft/ParallaxView/releases/latest` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-877962fa92266d` from `awesome_list` as `registry_expansion`
