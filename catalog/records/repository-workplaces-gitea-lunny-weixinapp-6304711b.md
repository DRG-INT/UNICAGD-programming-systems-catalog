...
<!-- canonical: https://gitea.com/lunny/weixinapp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/lunny/weixinapp](https://gitea.com/lunny/weixinapp) |
| Source record ids | gitea_repositories_api-2ef2fc0cca80f5 |
...
For a systems engineer, Gitea: lunny/weixinapp belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-12T13:13:22Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-16 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "library", "retrieved": "2026-09-16", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-2ef2fc0cca80f5` from `gitea_repositories_api` as `registry_expansion`
