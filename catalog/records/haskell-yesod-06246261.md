...
<!-- canonical: https://hackage.haskell.org/package/yesod -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yesod](https://hackage.haskell.org/package/yesod) |
| Source record ids | hackage_top_downloads-0bb75dadab12f4 |

## System Engineer Summary

Hackage package with 506 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, yesod belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.2.3 | 2026-06-16T20:34:36Z | [https://hackage.haskell.org/package/yesod](https://hackage.haskell.org/package/yesod) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yesod` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-0bb75dadab12f4` from `hackage_top_downloads` as `registry_expansion`
