...
<!-- canonical: https://github.com/newlinedotco/FlappySwift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/newlinedotco/FlappySwift](https://github.com/newlinedotco/FlappySwift) |
| Source record ids | github_search_swift-4324210b7d4e46 |
...
For a systems engineer, newlinedotco/FlappySwift belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-29T03:44:50Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-4324210b7d4e46` from `github_search_swift` as `registry_expansion`
