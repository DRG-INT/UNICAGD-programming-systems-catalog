...
<!-- canonical: https://pub.dev/packages/marionette_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/marionette_flutter](https://pub.dev/packages/marionette_flutter) |
| Source record ids | pub_dev-6529ae7216afb7 |

## System Engineer Summary

Flutter extensions for AI agent interaction via MCP — lets Claude, Copilot, and Cursor tap, scroll,
type, and screenshot your app.

## Operational Role

For a systems engineer, marionette_flutter belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-06-23T10:49:07.776397Z | [https://pub.dev/api/packages/marionette_flutter](https://pub.dev/api/packages/marionette_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/marionette_flutter` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-6529ae7216afb7` from `pub_dev` as `registry_expansion`
