...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/skyline75489/SwiftRouter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skyline75489/SwiftRouter](https://github.com/skyline75489/SwiftRouter) |
| Source record ids | awesome_list-a06754e7e33c38 |

## System Engineer Summary

SwiftRouter is tracked as a web framework record in the Cocoa branch. The source did not provide a
...
For a systems engineer, SwiftRouter belongs in the Cocoa inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2015-06-17 08:01:33 UTC | [https://trunk.cocoapods.org/api/v1/pods/SwiftRouter](https://trunk.cocoapods.org/api/v1/pods/SwiftRouter) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/SwiftRouter` at `2026-09-01T07:24:07+00:00`.
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "App Routing", "source_url": "https://raw.githubusercontent.com/vsouza/awesome-ios/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-a06754e7e33c38` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Crossroad | Web Framework | [open](cocoa-crossroad-0dd4a64a.md) |
| Marshroute | Web Framework | [open](cocoa-marshroute-c9068019.md) |
| Matomo | Web Framework | [open](cocoa-matomo-ef799ff1.md) |
