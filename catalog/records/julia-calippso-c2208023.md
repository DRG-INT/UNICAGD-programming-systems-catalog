...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CALiPPSO](https://github.com/JuliaRegistries/General/tree/master/C/CALiPPSO) |
| Source record ids | julia_general-5f3735c057685a |

## System Engineer Summary

Julia package registered in General at C/CALiPPSO.

## Operational Role

For a systems engineer, CALiPPSO belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CALiPPSO", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-5f3735c057685a` from `julia_general` as `registry_expansion`
