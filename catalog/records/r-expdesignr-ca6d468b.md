...
<!-- canonical: https://cran.r-project.org/web/packages/ExpDesignR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ExpDesignR/index.html](https://cran.r-project.org/web/packages/ExpDesignR/index.html) |
| Source record ids | cran_packages_by_date-286759c2e5a8ee |
...
For a systems engineer, ExpDesignR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-01 12:40:08 UTC | [https://cran.r-project.org/web/packages/ExpDesignR/DESCRIPTION](https://cran.r-project.org/web/packages/ExpDesignR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ExpDesignR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-286759c2e5a8ee` from `cran_packages_by_date` as `registry_expansion`
