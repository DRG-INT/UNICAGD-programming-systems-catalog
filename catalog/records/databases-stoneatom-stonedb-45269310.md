...
<!-- canonical: https://github.com/stoneatom/stonedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stoneatom/stonedb](https://github.com/stoneatom/stonedb) |
| Source record ids | github_search_databases-bf0bc09fc4692e |

## System Engineer Summary

StoneDB is an Open-Source MySQL HTAP and MySQL-Native DataBase for OLTP, Real-Time Analytics, a
counterpart of MySQLHeatWave.

## Operational Role

For a systems engineer, stoneatom/stonedb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-23T09:11:04Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-bf0bc09fc4692e` from `github_search_databases` as `registry_expansion`
