...
<!-- canonical: https://crates.io/crates/asynchronous-codec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/asynchronous-codec](https://crates.io/crates/asynchronous-codec) |
| Source record ids | crates_io-90658e6df96281 |
...
For a systems engineer, asynchronous-codec belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2023-10-11T16:03:12.245241Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
