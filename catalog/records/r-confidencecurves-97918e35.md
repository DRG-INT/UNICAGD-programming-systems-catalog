...
<!-- canonical: https://cran.r-project.org/web/packages/confidenceCurves/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/confidenceCurves/index.html](https://cran.r-project.org/web/packages/confidenceCurves/index.html) |
| Source record ids | cran_packages_by_date-63a1bdd65fab31 |

## System Engineer Summary

Frequentist Confidence Analysis for Clinical Trials

## Operational Role

For a systems engineer, confidenceCurves belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-27 04:20:02 UTC | [https://cran.r-project.org/web/packages/confidenceCurves/DESCRIPTION](https://cran.r-project.org/web/packages/confidenceCurves/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/confidenceCurves/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-63a1bdd65fab31` from `cran_packages_by_date` as `registry_expansion`
