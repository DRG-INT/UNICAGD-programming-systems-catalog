...
<!-- canonical: https://pypi.org/project/actvalue.mongo-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actvalue.mongo-client/](https://pypi.org/project/actvalue.mongo-client/) |
| Source record ids | pypi_simple-b78014f9440fb5 |
...
For a systems engineer, actvalue.mongo-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-30T14:42:38.867020Z | [https://pypi.org/pypi/actvalue.mongo-client/json](https://pypi.org/pypi/actvalue.mongo-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actvalue.mongo-client/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-b78014f9440fb5` from `pypi_simple` as `registry_expansion`
