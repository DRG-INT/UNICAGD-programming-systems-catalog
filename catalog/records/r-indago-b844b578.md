...
<!-- canonical: https://cran.r-project.org/web/packages/inDAGO/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inDAGO/index.html](https://cran.r-project.org/web/packages/inDAGO/index.html) |
| Source record ids | cran_packages_by_date-80ce6a87d52ffa |
...
For a systems engineer, inDAGO belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-21 08:50:08 UTC | [https://cran.r-project.org/web/packages/inDAGO/DESCRIPTION](https://cran.r-project.org/web/packages/inDAGO/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inDAGO/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-80ce6a87d52ffa` from `cran_packages_by_date` as `registry_expansion`
