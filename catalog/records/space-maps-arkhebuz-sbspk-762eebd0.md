...
<!-- canonical: https://github.com/arkhebuz/sbspk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arkhebuz/sbspk](https://github.com/arkhebuz/sbspk) |
| Source record ids | github_search_space_maps-a2440904fe0f4e |

## System Engineer Summary

Generate a small-body SPICE kernel using JPL Horizons system

## Operational Role

For a systems engineer, arkhebuz/sbspk belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-03-27T15:20:20Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a2440904fe0f4e` from `github_search_space_maps` as `registry_expansion`
