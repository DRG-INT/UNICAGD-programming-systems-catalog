...
<!-- canonical: https://github.com/directus/directus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/directus/directus](https://github.com/directus/directus) |
| Source record ids | github_search_databases-7d7cfe48608619 |

## System Engineer Summary

The flexible backend for all your projects 🐰 Turn your DB into a headless CMS, admin panels, or apps
with a custom UI, instant APIs, auth & more.

## Operational Role

For a systems engineer, directus/directus belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:59:46Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7d7cfe48608619` from `github_search_databases` as `registry_expansion`
