...
<!-- canonical: https://pub.dev/packages/flutter_reorderable_grid_view -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_reorderable_grid_view](https://pub.dev/packages/flutter_reorderable_grid_view) |
| Source record ids | pub_dev-3517b8a8dcfd50 |

## System Engineer Summary

Enables animated GridViews when updating children or when trying to reorder them by using drag and
drop.

## Operational Role

For a systems engineer, flutter_reorderable_grid_view belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.7.0 | 2026-05-31T13:54:39.165541Z | [https://pub.dev/api/packages/flutter_reorderable_grid_view](https://pub.dev/api/packages/flutter_reorderable_grid_view) |  |
| preview | known | 5.5.0-dev.1 | 2025-02-14T14:04:29.766972Z | [https://pub.dev/api/packages/flutter_reorderable_grid_view](https://pub.dev/api/packages/flutter_reorderable_grid_view) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_reorderable_grid_view` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-3517b8a8dcfd50` from `pub_dev` as `registry_expansion`
