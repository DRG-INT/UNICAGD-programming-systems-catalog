...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Arti3DPlayer/USBDeviceSwift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Arti3DPlayer/USBDeviceSwift](https://github.com/Arti3DPlayer/USBDeviceSwift) |
| Source record ids | github_search_cocoa-f30323dc3e5841 |

## System Engineer Summary

wrapper for IOKit.usb and IOKit.hid written on pure Swift that allows you convenient work with USB
devices

## Operational Role

For a systems engineer, Arti3DPlayer/USBDeviceSwift belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-19T14:09:42Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-f30323dc3e5841` from `github_search_cocoa` as `registry_expansion`
