...
<!-- canonical: https://cran.r-project.org/web/packages/GGIRread/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GGIRread/index.html](https://cran.r-project.org/web/packages/GGIRread/index.html) |
| Source record ids | cran_packages_by_date-a4e385a4906679 |
...
For a systems engineer, GGIRread belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.10 | 2026-08-26 08:50:11 UTC | [https://cran.r-project.org/web/packages/GGIRread/DESCRIPTION](https://cran.r-project.org/web/packages/GGIRread/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GGIRread/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a4e385a4906679` from `cran_packages_by_date` as `registry_expansion`
