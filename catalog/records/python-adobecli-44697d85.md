...
<!-- canonical: https://pypi.org/project/adobecli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adobecli/](https://pypi.org/project/adobecli/) |
| Source record ids | pypi_simple-6cef86893c8be2 |

## System Engineer Summary

adobecli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, adobecli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2019-08-05T16:15:32.027540Z | [https://pypi.org/pypi/adobecli/json](https://pypi.org/pypi/adobecli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adobecli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-6cef86893c8be2` from `pypi_simple` as `registry_expansion`
