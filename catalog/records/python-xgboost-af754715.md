...
| Canonical URL | [https://pypi.org/project/xgboost/](https://pypi.org/project/xgboost/) |
| Source record ids | corpus-86f59a1d5a9eae |

## System Engineer Summary

XGBoost is tracked as a machine learning record in the Python branch. The source did not provide a
...
For a systems engineer, XGBoost belongs in the Python inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.1 | 2026-08-15T08:39:21.197337Z | [https://pypi.org/pypi/XGBoost/json](https://pypi.org/pypi/XGBoost/json) |  |
| preview | known | 3.1.0rc1 | 2025-09-26T06:07:28.499398Z | [https://pypi.org/pypi/XGBoost/json](https://pypi.org/pypi/XGBoost/json) |  |

## Engineering Notes

- Treat category as `machine_learning` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://pypi.org/pypi/XGBoost/json` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-86f59a1d5a9eae` from `master_json` as `machine_learning`
