...
<!-- canonical: https://hackage.haskell.org/package/biohazard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/biohazard](https://hackage.haskell.org/package/biohazard) |
| Source record ids | hackage_top_downloads-df80938c8cc470 |
...
For a systems engineer, biohazard belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1 | 2020-01-06T17:02:26Z | [https://hackage.haskell.org/package/biohazard](https://hackage.haskell.org/package/biohazard) |  |
| candidate | partial | 0.6.2 |  | [https://hackage.haskell.org/package/biohazard](https://hackage.haskell.org/package/biohazard) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/biohazard` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-df80938c8cc470` from `hackage_top_downloads` as `registry_expansion`
