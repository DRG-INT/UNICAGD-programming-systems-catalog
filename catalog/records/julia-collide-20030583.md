...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Collide](https://github.com/JuliaRegistries/General/tree/master/C/Collide) |
| Source record ids | julia_general-8dd3684fe682d3 |

## System Engineer Summary

Julia package registered in General at C/Collide.

## Operational Role

For a systems engineer, Collide belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Collide", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8dd3684fe682d3` from `julia_general` as `registry_expansion`
