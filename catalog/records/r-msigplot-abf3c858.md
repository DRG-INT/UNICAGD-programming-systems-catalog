...
<!-- canonical: https://cran.r-project.org/web/packages/mSigPlot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mSigPlot/index.html](https://cran.r-project.org/web/packages/mSigPlot/index.html) |
| Source record ids | cran_packages_by_date-f9eb79b428a68d |
...
For a systems engineer, mSigPlot belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.42 | 2026-09-03 02:40:02 UTC | [https://cran.r-project.org/web/packages/mSigPlot/DESCRIPTION](https://cran.r-project.org/web/packages/mSigPlot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mSigPlot/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-f9eb79b428a68d` from `cran_packages_by_date` as `registry_expansion`
