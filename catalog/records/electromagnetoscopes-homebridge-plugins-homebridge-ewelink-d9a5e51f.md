...
<!-- canonical: https://github.com/homebridge-plugins/homebridge-ewelink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/homebridge-plugins/homebridge-ewelink](https://github.com/homebridge-plugins/homebridge-ewelink) |
| Source record ids | github_search_electromagnetoscopes-59894b7a411b81 |
...
For a systems engineer, homebridge-plugins/homebridge-ewelink belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T01:03:18Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-59894b7a411b81` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| SoapySDR | Interop Bindings | [open](electromagnetoscopes-soapysdr-38522b6f.md) |
