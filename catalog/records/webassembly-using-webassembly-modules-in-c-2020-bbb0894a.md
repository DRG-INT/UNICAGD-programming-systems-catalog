...
<!-- canonical: https://platform.uno/blog/using-webassembly-modules-in-c/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://platform.uno/blog/using-webassembly-modules-in-c/](https://platform.uno/blog/using-webassembly-modules-in-c/) |
| Source record ids | awesome_list-7c840e8a2536cc |

## System Engineer Summary

Using WebAssembly modules in C# (2020) is tracked as a tutorial book styleguide record in the
...
For a systems engineer, Using WebAssembly modules in C# (2020) belongs in the WebAssembly inventory
...
- `awesome_list-7c840e8a2536cc` from `awesome_list` as `registry_expansion`
