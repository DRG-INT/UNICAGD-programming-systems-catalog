...
<!-- canonical: https://cran.r-project.org/web/packages/Bayenet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Bayenet/index.html](https://cran.r-project.org/web/packages/Bayenet/index.html) |
| Source record ids | cran_packages_by_date-8130f60632f2c5 |
...
For a systems engineer, Bayenet belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4 | 2026-09-10 16:50:17 UTC | [https://cran.r-project.org/web/packages/Bayenet/DESCRIPTION](https://cran.r-project.org/web/packages/Bayenet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Bayenet/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-8130f60632f2c5` from `cran_packages_by_date` as `registry_expansion`
