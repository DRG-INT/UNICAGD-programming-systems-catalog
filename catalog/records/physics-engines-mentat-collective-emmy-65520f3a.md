...
<!-- canonical: https://github.com/mentat-collective/emmy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mentat-collective/emmy](https://github.com/mentat-collective/emmy) |
| Source record ids | github_search_physics_engines-0073cb2dec4a2c |
...
For a systems engineer, mentat-collective/emmy belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-10T13:58:39Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-0073cb2dec4a2c` from `github_search_physics_engines` as `registry_expansion`
