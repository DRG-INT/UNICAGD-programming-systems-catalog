...
<!-- canonical: https://cran.r-project.org/web/packages/HistData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HistData/index.html](https://cran.r-project.org/web/packages/HistData/index.html) |
| Source record ids | cran_packages_by_date-7a598058fa7a93 |
...
For a systems engineer, HistData belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-30 05:10:56 UTC | [https://cran.r-project.org/web/packages/HistData/DESCRIPTION](https://cran.r-project.org/web/packages/HistData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HistData/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7a598058fa7a93` from `cran_packages_by_date` as `registry_expansion`
