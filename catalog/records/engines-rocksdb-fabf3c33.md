...
| Source record ids | curated_language_routes-783c88a27dd546 |

## System Engineer Summary

Embeddable LSM storage engine for persistent key-value workloads, databases, caches, and stream
processors.

## Operational Role

For a systems engineer, RocksDB belongs in the Engines inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v11.8.1 | 2026-08-07T17:30:50Z | [https://api.github.com/repos/facebook/rocksdb/releases/latest](https://api.github.com/repos/facebook/rocksdb/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/facebook/rocksdb/releases/latest` at `2026-09-01T12:30:33+00:00`.
...
- `curated_language_routes-783c88a27dd546` from `curated_language_routes` as `registry_expansion`
