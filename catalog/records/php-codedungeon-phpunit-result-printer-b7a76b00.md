...
<!-- canonical: https://packagist.org/packages/codedungeon/phpunit-result-printer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/codedungeon/phpunit-result-printer](https://packagist.org/packages/codedungeon/phpunit-result-printer) |
| Source record ids | packagist_search-a1928d8c9322df |
...
For a systems engineer, codedungeon/phpunit-result-printer belongs in the PHP inventory as part of
...
- `packagist_search-a1928d8c9322df` from `packagist_search` as `registry_expansion`
