...
<!-- canonical: https://packagist.org/packages/symfony/psr-http-message-bridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/psr-http-message-bridge](https://packagist.org/packages/symfony/psr-http-message-bridge) |
| Source record ids | packagist_search-6f696003d3c1d1 |

## System Engineer Summary

symfony/psr-http-message-bridge is tracked as a networking http record in the PHP branch. The source
...
For a systems engineer, symfony/psr-http-message-bridge belongs in the PHP inventory as part of
...
- `packagist_search-6f696003d3c1d1` from `packagist_search` as `registry_expansion`
