...
<!-- canonical: https://pub.dev/packages/fade_shimmer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fade_shimmer](https://pub.dev/packages/fade_shimmer) |
| Source record ids | pub_dev-0b602b10a9012d |

## System Engineer Summary

A fade shimmer library to implement loading effects like the latest Facebook loading skeleton UI
with smooth fade transitions.

## Operational Role

For a systems engineer, fade_shimmer belongs in the Dart inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.0 | 2025-05-18T16:47:01.352849Z | [https://pub.dev/api/packages/fade_shimmer](https://pub.dev/api/packages/fade_shimmer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fade_shimmer` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-0b602b10a9012d` from `pub_dev` as `registry_expansion`
