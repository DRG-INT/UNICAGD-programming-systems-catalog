...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/shajen/rtl-sdr-scanner-cpp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shajen/rtl-sdr-scanner-cpp](https://github.com/shajen/rtl-sdr-scanner-cpp) |
| Source record ids | github_search_satcom_satellites-efac40d8ed18f1 |

## System Engineer Summary

shajen/rtl-sdr-scanner-cpp is tracked as a static analyzer record in the SatCom Satellites branch.
...
For a systems engineer, shajen/rtl-sdr-scanner-cpp belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-19T05:53:15Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_satcom_satellites-efac40d8ed18f1` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| chuot/rdio-scanner | Static Analyzer | [open](satcom-satellites-chuot-rdio-scanner-731610af.md) |
| ComThings/PandwaRF | Static Analyzer | [open](satcom-satellites-comthings-pandwarf-87a203ee.md) |
| demantz/RFAnalyzer | Static Analyzer | [open](satcom-satellites-demantz-rfanalyzer-8b6a9e20.md) |
| dsward2/LocalRadio | Static Analyzer | [open](satcom-satellites-dsward2-localradio-46a1503f.md) |
| EarToEarOak/RTLSDR-Scanner | Static Analyzer | [open](satcom-satellites-eartoearoak-rtlsdr-scanner-d41948a6.md) |
| falkenber9/falcon | Static Analyzer | [open](satcom-satellites-falkenber9-falcon-9ec4722d.md) |
| ghostop14/sparrow-wifi | Static Analyzer | [open](satcom-satellites-ghostop14-sparrow-wifi-03743768.md) |
| IronGiu/MeshStation | Static Analyzer | [open](satcom-satellites-irongiu-meshstation-c1b5d80e.md) |
