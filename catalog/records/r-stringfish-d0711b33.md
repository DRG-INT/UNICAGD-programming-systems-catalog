...
<!-- canonical: https://cran.r-project.org/web/packages/stringfish/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stringfish/index.html](https://cran.r-project.org/web/packages/stringfish/index.html) |
| Source record ids | cran_packages_by_date-2f3a87a2ace6eb |
...
For a systems engineer, stringfish belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19.2 | 2026-08-04 10:30:17 UTC | [https://cran.r-project.org/web/packages/stringfish/DESCRIPTION](https://cran.r-project.org/web/packages/stringfish/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stringfish/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2f3a87a2ace6eb` from `cran_packages_by_date` as `registry_expansion`
