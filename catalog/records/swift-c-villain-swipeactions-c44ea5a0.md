...
<!-- canonical: https://github.com/c-villain/SwipeActions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/c-villain/SwipeActions](https://github.com/c-villain/SwipeActions) |
| Source record ids | github_search_swift-10cc5b01bccbdd |

## System Engineer Summary

Swipe actions for any view, swipe menu based on SwiftUI, full swiping and RTL languages supporting,
iOS 13+, add your own views to swipes

## Operational Role

For a systems engineer, c-villain/SwipeActions belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-28T09:49:54Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-10cc5b01bccbdd` from `github_search_swift` as `registry_expansion`
