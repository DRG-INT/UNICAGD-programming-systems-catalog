...
<!-- canonical: https://github.com/oracle/opengrok -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oracle/opengrok](https://github.com/oracle/opengrok) |
| Source record ids | github_search_engines-4ade9a5f06ddf2 |
...
For a systems engineer, oracle/opengrok belongs in the Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:03:47Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-4ade9a5f06ddf2` from `github_search_engines` as `registry_expansion`
...
| glumpy/glumpy | Parser Lexer Ast | [open](engines-glumpy-glumpy-18fc21f2.md) |
