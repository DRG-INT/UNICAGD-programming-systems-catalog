...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mojs/mojs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mojs/mojs](https://github.com/mojs/mojs) |
| Source record ids | github_search_computer_graphics_software-af80747cf7b9f4 |
...
For a systems engineer, mojs/mojs belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-af80747cf7b9f4` from `github_search_computer_graphics_software` as `registry_expansion`
