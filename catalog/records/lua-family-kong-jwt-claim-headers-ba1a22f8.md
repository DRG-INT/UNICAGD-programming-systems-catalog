...
| Canonical URL | [https://luarocks.org/modules/uohzxela/kong-jwt-claim-headers](https://luarocks.org/modules/uohzxela/kong-jwt-claim-headers) |
| Source record ids | luarocks_root_manifest-e9afb0566130a4 |

## System Engineer Summary

A Kong plugin to map JWT claims to request headers

## Operational Role

For a systems engineer, kong-jwt-claim-headers belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-e9afb0566130a4` from `luarocks_root_manifest` as `registry_expansion`
