...
<!-- canonical: https://cran.r-project.org/web/packages/survalis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/survalis/index.html](https://cran.r-project.org/web/packages/survalis/index.html) |
| Source record ids | cran_packages_by_date-41523592deba46 |
...
For a systems engineer, survalis belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-22 15:10:08 UTC | [https://cran.r-project.org/web/packages/survalis/DESCRIPTION](https://cran.r-project.org/web/packages/survalis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/survalis/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-41523592deba46` from `cran_packages_by_date` as `registry_expansion`
