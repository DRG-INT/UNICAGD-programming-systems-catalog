...
<!-- canonical: https://crates.io/crates/crc32fast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crc32fast](https://crates.io/crates/crc32fast) |
| Source record ids | crates_io-c34692f7bc6c50 |
...
For a systems engineer, crc32fast belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.2 | 2026-09-12T18:41:46.923561Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-12T20:18:28+00:00`.
...
- `crates_io-c34692f7bc6c50` from `crates_io` as `registry_expansion`
