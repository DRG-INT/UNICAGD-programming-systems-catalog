...
<!-- canonical: https://crates.io/crates/either -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/either](https://crates.io/crates/either) |
| Source record ids | crates_io-f88877a4351607 |
...
For a systems engineer, either belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.18.0 | 2026-08-20T19:36:48.266137Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-f88877a4351607` from `crates_io` as `registry_expansion`
