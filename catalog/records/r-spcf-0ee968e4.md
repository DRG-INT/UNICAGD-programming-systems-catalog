...
<!-- canonical: https://cran.r-project.org/web/packages/spCF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spCF/index.html](https://cran.r-project.org/web/packages/spCF/index.html) |
| Source record ids | cran_packages_by_date-4044ee82cf4974 |

## System Engineer Summary

Coarse-to-Fine Spatial and Spatio-Temporal Modeling

## Operational Role

For a systems engineer, spCF belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-28 17:40:02 UTC | [https://cran.r-project.org/web/packages/spCF/DESCRIPTION](https://cran.r-project.org/web/packages/spCF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spCF/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4044ee82cf4974` from `cran_packages_by_date` as `registry_expansion`
