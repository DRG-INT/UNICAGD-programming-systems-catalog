...
<!-- canonical: https://pub.dev/packages/image_size_getter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/image_size_getter](https://pub.dev/packages/image_size_getter) |
| Source record ids | pub_dev-1fe039251c1520 |

## System Engineer Summary

Get image width and height, the library does not completely decode the image file, just read the
metadata to get the image width and height.

## Operational Role

For a systems engineer, image_size_getter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.1 | 2025-08-06T06:23:07.530585Z | [https://pub.dev/api/packages/image_size_getter](https://pub.dev/api/packages/image_size_getter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/image_size_getter` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-1fe039251c1520` from `pub_dev` as `registry_expansion`
