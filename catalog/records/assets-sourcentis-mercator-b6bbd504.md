...
<!-- canonical: https://github.com/sourcentis/mercator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sourcentis/mercator](https://github.com/sourcentis/mercator) |
| Source record ids | github_search_assets-b730051d10ee66 |
...
For a systems engineer, sourcentis/mercator belongs in the Assets inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:55:55Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-b730051d10ee66` from `github_search_assets` as `registry_expansion`
