...
<!-- canonical: https://crates.io/crates/aws-smithy-query -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-smithy-query](https://crates.io/crates/aws-smithy-query) |
| Source record ids | crates_io-e39501265011b1 |
...
For a systems engineer, aws-smithy-query belongs in the Rust inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.62.1 | 2026-09-15T23:04:27.709163Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-16T00:25:46+00:00`.
...
- `crates_io-e39501265011b1` from `crates_io` as `registry_expansion`
