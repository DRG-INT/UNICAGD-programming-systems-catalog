...
<!-- canonical: https://crates.io/crates/hmac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hmac](https://crates.io/crates/hmac) |
| Source record ids | crates_io-cee783a7a78663 |
...
For a systems engineer, hmac belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-03-29T23:19:21.430299Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-cee783a7a78663` from `crates_io` as `registry_expansion`
