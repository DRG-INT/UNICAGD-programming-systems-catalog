...
<!-- canonical: https://github.com/vanna-ai/vanna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vanna-ai/vanna](https://github.com/vanna-ai/vanna) |
| Source record ids | github_search_databases-4c6480addfbdbe |
...
For a systems engineer, vanna-ai/vanna belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-02T14:14:20Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4c6480addfbdbe` from `github_search_databases` as `registry_expansion`
