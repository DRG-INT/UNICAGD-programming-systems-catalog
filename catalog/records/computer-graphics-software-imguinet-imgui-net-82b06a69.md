...
<!-- canonical: https://github.com/ImGuiNET/ImGui.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ImGuiNET/ImGui.NET](https://github.com/ImGuiNET/ImGui.NET) |
| Source record ids | github_search_computer_graphics_software-45109b1a84bd3d |
...
For a systems engineer, ImGuiNET/ImGui.NET belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-45109b1a84bd3d` from `github_search_computer_graphics_software` as `registry_expansion`
