...
<!-- canonical: https://luarocks.org/modules/gx/claims-handler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gx/claims-handler](https://luarocks.org/modules/gx/claims-handler) |
| Source record ids | luarocks_root_manifest-a586e8bc4852c9 |

## System Engineer Summary

claims-handler is tracked as a machine learning record in the Lua family branch. The source did not
...
For a systems engineer, claims-handler belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-a586e8bc4852c9` from `luarocks_root_manifest` as `registry_expansion`
