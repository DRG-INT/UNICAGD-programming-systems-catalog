...
<!-- canonical: https://hackage.haskell.org/package/logic-classes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/logic-classes](https://hackage.haskell.org/package/logic-classes) |
| Source record ids | hackage_top_downloads-35dba84f499123 |
...
For a systems engineer, logic-classes belongs in the Haskell inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2016-09-18T15:08:04Z | [https://hackage.haskell.org/package/logic-classes](https://hackage.haskell.org/package/logic-classes) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/logic-classes` at `2026-09-10T01:21:06+00:00`.
...
- `hackage_top_downloads-35dba84f499123` from `hackage_top_downloads` as `registry_expansion`
