...
<!-- canonical: https://pub.dev/packages/flutter_secure_storage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_secure_storage](https://pub.dev/packages/flutter_secure_storage) |
| Source record ids | pub_dev-76d60d83200d8c |
...
For a systems engineer, flutter_secure_storage belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.1.1 | 2026-09-11T20:08:14.955343Z | [https://pub.dev/api/packages/flutter_secure_storage](https://pub.dev/api/packages/flutter_secure_storage) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_secure_storage` at `2026-09-11T20:20:34+00:00`.
...
- `pub_dev-76d60d83200d8c` from `pub_dev` as `registry_expansion`
