...
<!-- canonical: https://github.com/FRNT-dev/FRNT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FRNT-dev/FRNT](https://github.com/FRNT-dev/FRNT) |
| Source record ids | github_search_magazines-598035ac408678 |

## System Engineer Summary

FRNT is a new, magazine-style, online publication for front-end developers

## Operational Role

For a systems engineer, FRNT-dev/FRNT belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-21T15:15:58Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-598035ac408678` from `github_search_magazines` as `registry_expansion`
