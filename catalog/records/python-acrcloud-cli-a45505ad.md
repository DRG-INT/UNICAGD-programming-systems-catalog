...
<!-- canonical: https://pypi.org/project/acrcloud-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acrcloud-cli/](https://pypi.org/project/acrcloud-cli/) |
| Source record ids | pypi_simple-2ed045bc93eaf0 |

## System Engineer Summary

A command-line interface for ACRCloud Console API

## Operational Role

For a systems engineer, acrcloud-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-06-01T04:25:03.876217Z | [https://pypi.org/pypi/acrcloud-cli/json](https://pypi.org/pypi/acrcloud-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acrcloud-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-2ed045bc93eaf0` from `pypi_simple` as `registry_expansion`
