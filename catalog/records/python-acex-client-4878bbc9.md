...
<!-- canonical: https://pypi.org/project/acex-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acex-client/](https://pypi.org/project/acex-client/) |
| Source record ids | pypi_simple-11259048190cbb |
...
For a systems engineer, acex-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.0 | 2026-08-27T06:44:54.054428Z | [https://pypi.org/pypi/acex-client/json](https://pypi.org/pypi/acex-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acex-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-11259048190cbb` from `pypi_simple` as `registry_expansion`
