...
<!-- canonical: https://cran.r-project.org/web/packages/dsdp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dsdp/index.html](https://cran.r-project.org/web/packages/dsdp/index.html) |
| Source record ids | cran_packages_by_date-2f52f0d260e25b |
...
For a systems engineer, dsdp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-21 13:00:41 UTC | [https://cran.r-project.org/web/packages/dsdp/DESCRIPTION](https://cran.r-project.org/web/packages/dsdp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dsdp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2f52f0d260e25b` from `cran_packages_by_date` as `registry_expansion`
