...
<!-- canonical: https://github.com/excaliburjs/Excalibur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/excaliburjs/Excalibur](https://github.com/excaliburjs/Excalibur) |
| Source record ids | github_search_game_engines-28551d2f946666 |
...
For a systems engineer, excaliburjs/Excalibur belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:59:28Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-28551d2f946666` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AtomicGameEngine/AtomicGameEngine | Type Checker | [open](game-engines-atomicgameengine-atomicgameengine-2472cde5.md) |
