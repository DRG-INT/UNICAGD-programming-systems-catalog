...
<!-- canonical: https://hackage.haskell.org/package/quickcheck-instances -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/quickcheck-instances](https://hackage.haskell.org/package/quickcheck-instances) |
| Source record ids | hackage_top_downloads-301937d4b61c3f |
...
For a systems engineer, quickcheck-instances belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4 | 2026-01-08T11:48:26Z | [https://hackage.haskell.org/package/quickcheck-instances](https://hackage.haskell.org/package/quickcheck-instances) |  |
| candidate | partial | 0.3.19 |  | [https://hackage.haskell.org/package/quickcheck-instances](https://hackage.haskell.org/package/quickcheck-instances) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/quickcheck-instances` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-301937d4b61c3f` from `hackage_top_downloads` as `registry_expansion`
