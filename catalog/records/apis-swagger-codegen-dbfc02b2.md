...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: APIs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/apis.md) · [Category: Codegen Codemod Refactoring](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/codegen-codemod-refactoring.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | APIs |
| Category | Codegen Codemod Refactoring |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/swagger-api/swagger-codegen](https://github.com/swagger-api/swagger-codegen) |
| Source record ids | curated_language_routes-0eb8fb84951573 |

## System Engineer Summary

OpenAPI-driven client/server code generation tooling.

## Operational Role

For a systems engineer, Swagger Codegen belongs in the APIs inventory as part of ecosystem
...
- Treat category as `codegen_codemod_refactoring` unless a later verified source gives a better classification.
...
- `curated_language_routes-0eb8fb84951573` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AsyncAPI Generator | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-asyncapi-generator-2f56331c.md) |
| OpenAPI Generator | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-openapi-generator-ee0a851a.md) |
