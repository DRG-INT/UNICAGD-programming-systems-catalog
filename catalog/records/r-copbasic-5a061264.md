...
<!-- canonical: https://cran.r-project.org/web/packages/copBasic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/copBasic/index.html](https://cran.r-project.org/web/packages/copBasic/index.html) |
| Source record ids | cran_packages_by_date-685b375d426949 |
...
For a systems engineer, copBasic belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.16 | 2026-08-31 15:40:10 UTC | [https://cran.r-project.org/web/packages/copBasic/DESCRIPTION](https://cran.r-project.org/web/packages/copBasic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/copBasic/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-685b375d426949` from `cran_packages_by_date` as `registry_expansion`
