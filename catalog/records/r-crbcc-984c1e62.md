...
<!-- canonical: https://cran.r-project.org/web/packages/crbcc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crbcc/index.html](https://cran.r-project.org/web/packages/crbcc/index.html) |
| Source record ids | cran_packages_by_date-68087a728d297c |

## System Engineer Summary

crbcc is tracked as a compiler record in the R branch. The source did not provide a long
...
For a systems engineer, crbcc belongs in the R inventory as part of compiler selection, diagnostics
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 09:40:20 UTC | [https://cran.r-project.org/web/packages/crbcc/DESCRIPTION](https://cran.r-project.org/web/packages/crbcc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crbcc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-68087a728d297c` from `cran_packages_by_date` as `registry_expansion`
