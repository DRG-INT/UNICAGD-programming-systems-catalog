...
<!-- canonical: https://luarocks.org/modules/tylerneylon/apidemo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tylerneylon/apidemo](https://luarocks.org/modules/tylerneylon/apidemo) |
| Source record ids | luarocks_root_manifest-d2ce32406b30a6 |
...
For a systems engineer, apidemo belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d2ce32406b30a6` from `luarocks_root_manifest` as `registry_expansion`
