...
<!-- canonical: https://crates.io/crates/async-process -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-process](https://crates.io/crates/async-process) |
| Source record ids | crates_io-44796cd4514fa7 |
...
For a systems engineer, async-process belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2025-09-14T14:11:17.759362Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
| Evidence | ISC; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `crates_io-44796cd4514fa7` from `crates_io` as `registry_expansion`
