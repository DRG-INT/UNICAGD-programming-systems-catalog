...
<!-- canonical: https://crates.io/crates/io-uring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/io-uring](https://crates.io/crates/io-uring) |
| Source record ids | crates_io-47beb24d6b50b0 |
...
For a systems engineer, io-uring belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.15 | 2026-09-07T15:48:45.032143Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-07T16:20:09+00:00`.
...
- `crates_io-47beb24d6b50b0` from `crates_io` as `registry_expansion`
