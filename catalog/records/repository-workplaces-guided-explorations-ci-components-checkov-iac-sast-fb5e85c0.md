...
<!-- canonical: https://gitlab.com/guided-explorations/ci-components/checkov-iac-sast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/guided-explorations/ci-components/checkov-iac-sast](https://gitlab.com/guided-explorations/ci-components/checkov-iac-sast) |
| Source record ids | gitlab_projects_api-9e55dc9459fcc3 |

## System Engineer Summary

Checkov IaC SAST Scanner. Integrates with Security Dashboards, MR Findings and Security Policy Merge
Approvals. Community component - not provided by the Checkov project. Part of the DarwinJS Component
Builder Library.

## Operational Role

For a systems engineer, guided-explorations/ci-components/checkov-iac-sast belongs in the Repository
Workplaces inventory as part of build graph control, artifact reproducibility, cross-platform build
...
- `gitlab_projects_api-9e55dc9459fcc3` from `gitlab_projects_api` as `registry_expansion`
