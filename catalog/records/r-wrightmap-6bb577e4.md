...
<!-- canonical: https://cran.r-project.org/web/packages/WrightMap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/WrightMap/index.html](https://cran.r-project.org/web/packages/WrightMap/index.html) |
| Source record ids | cran_packages_by_date-d335236aa4667d |
...
For a systems engineer, WrightMap belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5 | 2026-08-23 15:10:12 UTC | [https://cran.r-project.org/web/packages/WrightMap/DESCRIPTION](https://cran.r-project.org/web/packages/WrightMap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/WrightMap/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d335236aa4667d` from `cran_packages_by_date` as `registry_expansion`
