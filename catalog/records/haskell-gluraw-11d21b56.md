...
<!-- canonical: https://hackage.haskell.org/package/GLURaw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/GLURaw](https://hackage.haskell.org/package/GLURaw) |
| Source record ids | hackage_top_downloads-99a863afcefad7 |
...
For a systems engineer, GLURaw belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0.5 | 2021-11-14T16:09:11Z | [https://hackage.haskell.org/package/GLURaw](https://hackage.haskell.org/package/GLURaw) |  |
| candidate | partial | 1.4.0.1 |  | [https://hackage.haskell.org/package/GLURaw](https://hackage.haskell.org/package/GLURaw) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/GLURaw` at `2026-09-03T00:34:31+00:00`.
...
- `hackage_top_downloads-99a863afcefad7` from `hackage_top_downloads` as `registry_expansion`
