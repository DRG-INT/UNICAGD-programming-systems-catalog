...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stereolabs/zed-open-capture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stereolabs/zed-open-capture](https://github.com/stereolabs/zed-open-capture) |
| Source record ids | github_search_electromagnetoscopes-ab3b6583ba4fd0 |
...
For a systems engineer, stereolabs/zed-open-capture belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-14T08:50:58Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-ab3b6583ba4fd0` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| srsran/srsRAN_4G | Documentation | [open](electromagnetoscopes-srsran-srsran-4g-2949fc58.md) |
| srsran/srsRAN_Project | Documentation | [open](electromagnetoscopes-srsran-srsran-project-88eaac4d.md) |
