...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp-git -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp-git](https://luarocks.org/modules/neorocks/cmp-git) |
| Source record ids | luarocks_root_manifest-e42be445cde4be |

## System Engineer Summary

cmp-git is tracked as an ide editor integration record in the Lua family branch. The source did not
...
For a systems engineer, cmp-git belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e42be445cde4be` from `luarocks_root_manifest` as `registry_expansion`
