...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_aims-5442c54ea372d7 |

## System Engineer Summary

Get up and running with Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other
models.

## Operational Role

For a systems engineer, ollama/ollama belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T00:52:34Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-5442c54ea372d7` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| f/prompts.chat | Filesystem Os | [open](aim-s-f-prompts-chat-0bb76e45.md) |
| Fosowl/agenticSeek | Filesystem Os | [open](aim-s-fosowl-agenticseek-3f73fd5c.md) |
| microsoft/graphrag | Filesystem Os | [open](aim-s-microsoft-graphrag-16e521eb.md) |
| NirDiamant/RAG_Techniques | Filesystem Os | [open](aim-s-nirdiamant-rag-techniques-681ed394.md) |
