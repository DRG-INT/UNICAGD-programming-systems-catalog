...
| Source record ids | github_search_webassembly-23339a497683cd |
...
For a systems engineer, trunk-rs/trunk belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T16:04:37Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-23339a497683cd` from `github_search_webassembly` as `registry_expansion`
