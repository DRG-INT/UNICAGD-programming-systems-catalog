...
<!-- canonical: https://cran.r-project.org/web/packages/epibyhand/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epibyhand/index.html](https://cran.r-project.org/web/packages/epibyhand/index.html) |
| Source record ids | cran_packages_by_date-fecf11bc74ed87 |

## System Engineer Summary

Worked Derivations for Classical Epidemiological Measures

## Operational Role

For a systems engineer, epibyhand belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 10:10:02 UTC | [https://cran.r-project.org/web/packages/epibyhand/DESCRIPTION](https://cran.r-project.org/web/packages/epibyhand/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epibyhand/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fecf11bc74ed87` from `cran_packages_by_date` as `registry_expansion`
