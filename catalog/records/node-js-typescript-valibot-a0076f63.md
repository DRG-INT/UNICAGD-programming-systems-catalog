...
| Source record ids | corpus-54a4c10be6018a |

## System Engineer Summary

Valibot is tracked as a serialization record in the Node.js/TypeScript branch. The source did not
...
For a systems engineer, Valibot belongs in the Node.js/TypeScript inventory as part of wire formats,
...
- `corpus-54a4c10be6018a` from `master_json` as `serialization`
