...
[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://basilisk.fr/Tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://basilisk.fr/Tutorial](https://basilisk.fr/Tutorial) |
| Source record ids | curated_language_routes-f363fb471cb698 |

## System Engineer Summary

Official Basilisk tutorial for setup, compilation, and first simulation programs.

## Operational Role

For a systems engineer, Basilisk Tutorial belongs in the Basilisk inventory as part of ecosystem
...
- `curated_language_routes-f363fb471cb698` from `curated_language_routes` as `registry_expansion`
