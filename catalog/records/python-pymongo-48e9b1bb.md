...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-798c4f8c8263b3 |

## System Engineer Summary

pymongo is tracked as a database datastore record in the Python branch. The source did not provide a
...
For a systems engineer, pymongo belongs in the Python inventory as part of state persistence,
...
- `corpus-798c4f8c8263b3` from `master_json` as `database_datastore`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Alembic | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-alembic-c6832741.md) |
| asyncpg | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-asyncpg-4ce19d20.md) |
| Django ORM | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-django-orm-f3e75c6f.md) |
| DuckDB Python | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-duckdb-python-19d305ac.md) |
| Peewee | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-peewee-240a9c13.md) |
| psycopg | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-psycopg-be795b0b.md) |
| redis-py | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-redis-py-9fe3236f.md) |
| SQLAlchemy | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-sqlalchemy-57f0cf55.md) |
