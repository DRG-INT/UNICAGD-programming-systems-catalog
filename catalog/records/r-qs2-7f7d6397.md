...
<!-- canonical: https://cran.r-project.org/web/packages/qs2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qs2/index.html](https://cran.r-project.org/web/packages/qs2/index.html) |
| Source record ids | cran_packages_by_date-cb12beb9f8fc4f |
...
For a systems engineer, qs2 belongs in the R inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-21 14:00:07 UTC | [https://cran.r-project.org/web/packages/qs2/DESCRIPTION](https://cran.r-project.org/web/packages/qs2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qs2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cb12beb9f8fc4f` from `cran_packages_by_date` as `registry_expansion`
