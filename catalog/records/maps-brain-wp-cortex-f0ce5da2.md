...
<!-- canonical: https://github.com/Brain-WP/Cortex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Brain-WP/Cortex](https://github.com/Brain-WP/Cortex) |
| Source record ids | github_search_maps-0db7f3d3de595a |
...
For a systems engineer, Brain-WP/Cortex belongs in the Maps inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-18T08:39:48Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0db7f3d3de595a` from `github_search_maps` as `registry_expansion`
