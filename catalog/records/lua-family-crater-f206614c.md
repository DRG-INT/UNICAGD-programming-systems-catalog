...
<!-- canonical: https://luarocks.org/modules/girvel/crater -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/girvel/crater](https://luarocks.org/modules/girvel/crater) |
| Source record ids | luarocks_root_manifest-a4011c44b51828 |

## System Engineer Summary

crater is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, crater belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a4011c44b51828` from `luarocks_root_manifest` as `registry_expansion`
