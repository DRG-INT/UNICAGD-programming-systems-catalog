...
<!-- canonical: https://pub.dev/packages/app_settings -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/app_settings](https://pub.dev/packages/app_settings) |
| Source record ids | pub_dev-6b19f2286f184c |
...
For a systems engineer, app_settings belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.0.0 | 2026-08-16T23:32:09.389664Z | [https://pub.dev/api/packages/app_settings](https://pub.dev/api/packages/app_settings) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/app_settings` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-6b19f2286f184c` from `pub_dev` as `registry_expansion`
