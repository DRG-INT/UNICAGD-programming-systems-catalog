...
<!-- canonical: https://github.com/Zhengqbbb/cz-git -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zhengqbbb/cz-git](https://github.com/Zhengqbbb/cz-git) |
| Source record ids | github_search_icons_and_logos-b336b54432a871 |

## System Engineer Summary

cz-git | czg 🛠️ DX first and more engineered, lightweight, customizable, standard output format
Commitizen adapter and CLI

## Operational Role

For a systems engineer, Zhengqbbb/cz-git belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T02:43:43Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-b336b54432a871` from `github_search_icons_and_logos` as `registry_expansion`
