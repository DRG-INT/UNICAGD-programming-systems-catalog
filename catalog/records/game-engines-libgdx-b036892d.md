...
| Source record ids | curated_language_routes-6dd1fc40f00b8c |

## System Engineer Summary

Java game development framework for desktop, Android, iOS, and web targets.

## Operational Role

For a systems engineer, libGDX belongs in the Game Engines inventory as part of ecosystem capability
...
- `curated_language_routes-6dd1fc40f00b8c` from `curated_language_routes` as `registry_expansion`
