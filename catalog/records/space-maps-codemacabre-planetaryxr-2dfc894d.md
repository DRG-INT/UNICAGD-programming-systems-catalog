...
<!-- canonical: https://github.com/codemacabre/planetaryxr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/codemacabre/planetaryxr](https://github.com/codemacabre/planetaryxr) |
| Source record ids | github_search_space_maps-a571fa138e64f5 |

## System Engineer Summary

A mixed-reality solar system, featuring 3D maps and models of planetary bodies

## Operational Role

For a systems engineer, codemacabre/planetaryxr belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-16T09:49:18Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a571fa138e64f5` from `github_search_space_maps` as `registry_expansion`
