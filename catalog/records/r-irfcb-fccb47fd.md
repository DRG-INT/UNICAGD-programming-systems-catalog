...
<!-- canonical: https://cran.r-project.org/web/packages/iRfcb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/iRfcb/index.html](https://cran.r-project.org/web/packages/iRfcb/index.html) |
| Source record ids | cran_packages_by_date-d7394249d988f6 |
...
For a systems engineer, iRfcb belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-08-19 19:20:02 UTC | [https://cran.r-project.org/web/packages/iRfcb/DESCRIPTION](https://cran.r-project.org/web/packages/iRfcb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/iRfcb/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d7394249d988f6` from `cran_packages_by_date` as `registry_expansion`
