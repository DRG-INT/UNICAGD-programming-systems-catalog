# arockiaraj-kaavian/sap_hana_java_spring
...
<!-- canonical: https://github.com/arockiaraj-kaavian/sap_hana_java_spring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arockiaraj-kaavian/sap_hana_java_spring](https://github.com/arockiaraj-kaavian/sap_hana_java_spring) |
| Source record ids | github_search_sapjava-bb0d0f76b8feca |

## System Engineer Summary

arockiaraj-kaavian/sap_hana_java_spring is tracked as a library record in the SAPJava branch. The
...
For a systems engineer, arockiaraj-kaavian/sap_hana_java_spring belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-17T11:54:13Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_sapjava-bb0d0f76b8feca` from `github_search_sapjava` as `registry_expansion`
