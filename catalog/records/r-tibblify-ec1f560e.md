...
<!-- canonical: https://cran.r-project.org/web/packages/tibblify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tibblify/index.html](https://cran.r-project.org/web/packages/tibblify/index.html) |
| Source record ids | cran_packages_by_date-966173dda4cbb8 |

## System Engineer Summary

tibblify is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, tibblify belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-09-11 14:50:02 UTC | [https://cran.r-project.org/web/packages/tibblify/DESCRIPTION](https://cran.r-project.org/web/packages/tibblify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tibblify/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-966173dda4cbb8` from `cran_packages_by_date` as `registry_expansion`
