...
<!-- canonical: https://pub.dev/packages/phone_state -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/phone_state](https://pub.dev/packages/phone_state) |
| Source record ids | pub_dev-aed87c64ba9e2f |

## System Engineer Summary

This plugin allows you to know quickly and easily if your Android or iOS device is receiving a call
and to know the status of the call.

## Operational Role

For a systems engineer, phone_state belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-07-15T10:12:30.945046Z | [https://pub.dev/api/packages/phone_state](https://pub.dev/api/packages/phone_state) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/phone_state` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-aed87c64ba9e2f` from `pub_dev` as `registry_expansion`
