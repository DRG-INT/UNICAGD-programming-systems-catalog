...
<!-- canonical: https://cran.r-project.org/web/packages/tidypredict/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidypredict/index.html](https://cran.r-project.org/web/packages/tidypredict/index.html) |
| Source record ids | cran_packages_by_date-705db7a54eb888 |
...
For a systems engineer, tidypredict belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-04 05:10:02 UTC | [https://cran.r-project.org/web/packages/tidypredict/DESCRIPTION](https://cran.r-project.org/web/packages/tidypredict/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidypredict/DESCRIPTION` at `2026-09-04T06:24:31+00:00`.
...
- `cran_packages_by_date-705db7a54eb888` from `cran_packages_by_date` as `registry_expansion`
