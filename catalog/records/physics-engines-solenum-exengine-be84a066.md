...
<!-- canonical: https://github.com/solenum/exengine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/solenum/exengine](https://github.com/solenum/exengine) |
| Source record ids | github_search_physics_engines-365de098a1e731 |

## System Engineer Summary

solenum/exengine is tracked as a game engine game dev record in the Physics Engines branch. The
...
For a systems engineer, solenum/exengine belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-21T16:51:48Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-365de098a1e731` from `github_search_physics_engines` as `registry_expansion`
