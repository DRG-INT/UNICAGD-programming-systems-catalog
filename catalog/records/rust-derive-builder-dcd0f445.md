...
<!-- canonical: https://crates.io/crates/derive_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/derive_builder](https://crates.io/crates/derive_builder) |
| Source record ids | crates_io-efa27eac377fd5 |
...
For a systems engineer, derive_builder belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.2 | 2024-10-08T16:55:17.031148Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-efa27eac377fd5` from `crates_io` as `registry_expansion`
