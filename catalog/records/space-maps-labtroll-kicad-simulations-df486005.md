...
<!-- canonical: https://github.com/labtroll/KiCad-Simulations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/labtroll/KiCad-Simulations](https://github.com/labtroll/KiCad-Simulations) |
| Source record ids | github_search_space_maps-4a4e1b66b4caf7 |
...
For a systems engineer, labtroll/KiCad-Simulations belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-12T16:05:29Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4a4e1b66b4caf7` from `github_search_space_maps` as `registry_expansion`
