# daniel-ilett/shaders-gaussian-blur
...
<!-- canonical: https://github.com/daniel-ilett/shaders-gaussian-blur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daniel-ilett/shaders-gaussian-blur](https://github.com/daniel-ilett/shaders-gaussian-blur) |
| Source record ids | github_search_effects-79983e2b6d4936 |
...
For a systems engineer, daniel-ilett/shaders-gaussian-blur belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-05T07:19:11Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-79983e2b6d4936` from `github_search_effects` as `registry_expansion`
