...
<!-- canonical: https://www.nuget.org/packages/Npgsql.Json.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Npgsql.Json.NET](https://www.nuget.org/packages/Npgsql.Json.NET) |
| Source record ids | nuget_search-01b40ace3bf469 |

## System Engineer Summary

Json.NET plugin for Npgsql, allowing transparent serialization/deserialization of JSON objects
directly to and from the database.

## Operational Role

For a systems engineer, Npgsql.Json.NET belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.3 | 2026-05-27T11:33:07.727+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/npgsql.json.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/npgsql.json.net/index.json) |  |
| preview | known | 10.0.0-rc.1 | 2025-10-05T20:17:28.817+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/npgsql.json.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/npgsql.json.net/index.json) |  |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; PostgreSQL; https://www.nuget.org/packages/Npgsql.Json.NET/10.0.3/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/npgsql.json.net/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-01b40ace3bf469` from `nuget_search` as `registry_expansion`
