...
<!-- canonical: https://cran.r-project.org/web/packages/RPesto/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RPesto/index.html](https://cran.r-project.org/web/packages/RPesto/index.html) |
| Source record ids | cran_packages_by_date-1e43c90ab0535b |
...
For a systems engineer, RPesto belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-04 00:10:02 UTC | [https://cran.r-project.org/web/packages/RPesto/DESCRIPTION](https://cran.r-project.org/web/packages/RPesto/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RPesto/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-1e43c90ab0535b` from `cran_packages_by_date` as `registry_expansion`
