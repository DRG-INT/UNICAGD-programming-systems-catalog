...
<!-- canonical: https://cran.r-project.org/web/packages/inshiny/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inshiny/index.html](https://cran.r-project.org/web/packages/inshiny/index.html) |
| Source record ids | cran_packages_by_date-5e5f7ad8803f25 |
...
For a systems engineer, inshiny belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-01 19:20:08 UTC | [https://cran.r-project.org/web/packages/inshiny/DESCRIPTION](https://cran.r-project.org/web/packages/inshiny/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inshiny/DESCRIPTION` at `2026-09-01T20:19:19+00:00`.
...
- `cran_packages_by_date-5e5f7ad8803f25` from `cran_packages_by_date` as `registry_expansion`
