# computerex/orbiter-mods.com

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/computerex/orbiter-mods.com -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/computerex/orbiter-mods.com](https://github.com/computerex/orbiter-mods.com) |
| Source record ids | github_search_space_shuttles-657e05fe3ba8c0 |

## System Engineer Summary

An open source mods repository and mods bundle installer for Orbiter Space Flight Simulator.

## Operational Role

For a systems engineer, computerex/orbiter-mods.com belongs in the Space Shuttles inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-18T06:53:11Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-657e05fe3ba8c0` from `github_search_space_shuttles` as `registry_expansion`
