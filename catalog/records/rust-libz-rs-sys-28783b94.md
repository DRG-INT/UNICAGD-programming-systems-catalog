...
<!-- canonical: https://crates.io/crates/libz-rs-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libz-rs-sys](https://crates.io/crates/libz-rs-sys) |
| Source record ids | crates_io-e2fc156f1c392b |
...
For a systems engineer, libz-rs-sys belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.8 | 2026-09-15T13:10:03.060802Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-15T14:21:15+00:00`.
...
- `crates_io-e2fc156f1c392b` from `crates_io` as `registry_expansion`
