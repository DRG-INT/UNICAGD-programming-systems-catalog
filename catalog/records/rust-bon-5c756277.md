...
<!-- canonical: https://crates.io/crates/bon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bon](https://crates.io/crates/bon) |
| Source record ids | crates_io-727761bd5d6b2e |
...
For a systems engineer, bon belongs in the Rust inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.10.0 | 2026-08-25T01:53:17.161142Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-727761bd5d6b2e` from `crates_io` as `registry_expansion`
