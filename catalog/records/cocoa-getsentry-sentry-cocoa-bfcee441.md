...
<!-- canonical: https://github.com/getsentry/sentry-cocoa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/getsentry/sentry-cocoa](https://github.com/getsentry/sentry-cocoa) |
| Source record ids | github_search_cocoa-27f4deb3419dc9 |
...
For a systems engineer, getsentry/sentry-cocoa belongs in the Cocoa inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:38:53Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-27f4deb3419dc9` from `github_search_cocoa` as `registry_expansion`
