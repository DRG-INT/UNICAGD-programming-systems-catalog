...
<!-- canonical: https://cran.r-project.org/web/packages/isodistrreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/isodistrreg/index.html](https://cran.r-project.org/web/packages/isodistrreg/index.html) |
| Source record ids | cran_packages_by_date-20a07b112bcc86 |
...
For a systems engineer, isodistrreg belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-21 14:40:26 UTC | [https://cran.r-project.org/web/packages/isodistrreg/DESCRIPTION](https://cran.r-project.org/web/packages/isodistrreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/isodistrreg/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-20a07b112bcc86` from `cran_packages_by_date` as `registry_expansion`
