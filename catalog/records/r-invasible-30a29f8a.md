...
<!-- canonical: https://cran.r-project.org/web/packages/invasible/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/invasible/index.html](https://cran.r-project.org/web/packages/invasible/index.html) |
| Source record ids | cran_packages_by_date-99a63dd7cb3c2d |

## System Engineer Summary

Predicting Invasion Probabilities from Phylogenetic Data and Species Traits

## Operational Role

For a systems engineer, invasible belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-05 08:20:12 UTC | [https://cran.r-project.org/web/packages/invasible/DESCRIPTION](https://cran.r-project.org/web/packages/invasible/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/invasible/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-99a63dd7cb3c2d` from `cran_packages_by_date` as `registry_expansion`
