...
| Canonical URL | [https://crates.io/crates/libbz2-rs-sys](https://crates.io/crates/libbz2-rs-sys) |
| Source record ids | crates_io-5f28372daef8da |
...
For a systems engineer, libbz2-rs-sys belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-05-16T13:12:49.413943Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-5f28372daef8da` from `crates_io` as `registry_expansion`
