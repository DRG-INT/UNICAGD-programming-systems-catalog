...
<!-- canonical: https://cran.r-project.org/web/packages/Epi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Epi/index.html](https://cran.r-project.org/web/packages/Epi/index.html) |
| Source record ids | cran_packages_by_date-ee70cfce57992b |
...
For a systems engineer, Epi belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.66 | 2026-08-04 03:10:02 UTC | [https://cran.r-project.org/web/packages/Epi/DESCRIPTION](https://cran.r-project.org/web/packages/Epi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Epi/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ee70cfce57992b` from `cran_packages_by_date` as `registry_expansion`
