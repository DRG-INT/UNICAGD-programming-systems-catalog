...
<!-- canonical: https://github.com/WebAssembly/tail-call -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/tail-call](https://github.com/WebAssembly/tail-call) |
| Source record ids | github_search_webassembly-89a54a3e202eff |
...
For a systems engineer, WebAssembly/tail-call belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-03T10:37:11Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-89a54a3e202eff` from `github_search_webassembly` as `registry_expansion`
