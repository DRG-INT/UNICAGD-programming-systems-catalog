...
<!-- canonical: https://packagist.org/packages/setbased/php-audit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/setbased/php-audit](https://packagist.org/packages/setbased/php-audit) |
| Source record ids | packagist_search-74596ec2caabc4 |
...
For a systems engineer, setbased/php-audit belongs in the PHP inventory as part of supply-chain
...
- `packagist_search-74596ec2caabc4` from `packagist_search` as `registry_expansion`
