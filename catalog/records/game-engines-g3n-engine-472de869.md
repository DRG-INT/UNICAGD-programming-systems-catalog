...
| Source record ids | github_search_game_engines-331369880a4c51 |

## System Engineer Summary

g3n/engine is tracked as a networking http record in the Game Engines branch. The source did not
...
For a systems engineer, g3n/engine belongs in the Game Engines inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T16:23:05Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-331369880a4c51` from `github_search_game_engines` as `registry_expansion`
