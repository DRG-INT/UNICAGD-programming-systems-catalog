...
<!-- canonical: https://developers.cloudflare.com/r2/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://developers.cloudflare.com/r2/](https://developers.cloudflare.com/r2/) |
| Source record ids | curated_database_systems-c1311eee1a38c5 |

## System Engineer Summary

Object storage platform with S3-compatible operations.

## Operational Role

For a systems engineer, Cloudflare R2 belongs in the Databases inventory as part of state
...
- `curated_database_systems-c1311eee1a38c5` from `curated_database_systems` as `registry_expansion`
