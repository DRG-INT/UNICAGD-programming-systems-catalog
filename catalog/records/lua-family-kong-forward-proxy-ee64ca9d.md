...
| Canonical URL | [https://luarocks.org/modules/selvamp/kong-forward-proxy](https://luarocks.org/modules/selvamp/kong-forward-proxy) |
| Source record ids | luarocks_root_manifest-55ffbc84eb9fd2 |

## System Engineer Summary

A Kong plugin that allows access to an upstream url through a proxy

## Operational Role

For a systems engineer, kong-forward-proxy belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-55ffbc84eb9fd2` from `luarocks_root_manifest` as `registry_expansion`
