...
| Canonical URL | [https://github.com/yrlu/quadrotor](https://github.com/yrlu/quadrotor) |
| Source record ids | github_search_matlab-dc5eba98db8143 |
...
For a systems engineer, yrlu/quadrotor belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | quadrotor | 2022-07-05T03:57:51Z | [https://api.github.com/repos/yrlu/quadrotor/releases/latest](https://api.github.com/repos/yrlu/quadrotor/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/yrlu/quadrotor/releases/latest` at `2026-09-01T07:24:15+00:00`.
...
- `github_search_matlab-dc5eba98db8143` from `github_search_matlab` as `registry_expansion`
