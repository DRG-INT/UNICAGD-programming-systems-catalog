...
<!-- canonical: https://packagist.org/packages/geometria-lab/rediska -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/geometria-lab/rediska](https://packagist.org/packages/geometria-lab/rediska) |
| Source record ids | packagist_search-03cd0beef1268b |
...
For a systems engineer, geometria-lab/rediska belongs in the PHP inventory as part of service
...
- `packagist_search-03cd0beef1268b` from `packagist_search` as `registry_expansion`
