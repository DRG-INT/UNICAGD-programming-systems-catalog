...
<!-- canonical: https://github.com/TUC-ProAut/libRSF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TUC-ProAut/libRSF](https://github.com/TUC-ProAut/libRSF) |
| Source record ids | github_search_radars-57c9333d7a3aec |
...
For a systems engineer, TUC-ProAut/libRSF belongs in the Radars inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-06T21:06:26Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-57c9333d7a3aec` from `github_search_radars` as `registry_expansion`
