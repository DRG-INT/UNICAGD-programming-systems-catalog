...
<!-- canonical: https://cran.r-project.org/web/packages/palm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/palm/index.html](https://cran.r-project.org/web/packages/palm/index.html) |
| Source record ids | cran_packages_by_date-e035f203b5431a |
...
For a systems engineer, palm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.7 | 2026-08-20 05:20:59 UTC | [https://cran.r-project.org/web/packages/palm/DESCRIPTION](https://cran.r-project.org/web/packages/palm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/palm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e035f203b5431a` from `cran_packages_by_date` as `registry_expansion`
