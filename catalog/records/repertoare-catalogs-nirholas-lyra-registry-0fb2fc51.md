...
<!-- canonical: https://github.com/nirholas/lyra-registry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nirholas/lyra-registry](https://github.com/nirholas/lyra-registry) |
| Source record ids | github_search_repertoare_catalogs-4e92e174a50c8f |

## System Engineer Summary

Lyra Registry is a standalone API + MCP service that catalogs, scores, and serves metadata for all
tools in the Lyra ecosystem. It enables discovery, evaluation, and integration of 800+ crypto,
blockchain, DeFi, memecoin, NFT, metaverse, trading tools, MCP tools. The list will continue to
grow.

## Operational Role

For a systems engineer, nirholas/lyra-registry belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T22:14:10Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-4e92e174a50c8f` from `github_search_repertoare_catalogs` as `registry_expansion`
