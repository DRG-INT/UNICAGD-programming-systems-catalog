# Gitea: nesin/audacity

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/nesin/audacity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/nesin/audacity](https://gitea.com/nesin/audacity) |
| Source record ids | gitea_repositories_api-091cfe94cb6d70 |

## System Engineer Summary

Gitea: nesin/audacity is tracked as an ide editor integration record in the Repository Workplaces
...
For a systems engineer, Gitea: nesin/audacity belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-08T03:00:49Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-091cfe94cb6d70` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: best-iptv-guide/Best-IPTV-2026--Trusted-Services-Features-Pricing | Ide Editor Integration | [open](repository-workplaces-gitea-best-iptv-guide-best-iptv-2026-trusted-services-features-pricing-8139c338.md) |
| Gitea: best-iptv-service-provider-2026/Best-IPTV-USA-2026-Providers-Pricing-Devices-Guide | Ide Editor Integration | [open](repository-workplaces-gitea-best-iptv-service-provider-2026-best-iptv-usa-2026-providers-pricing-devices-guide-06499f89.md) |
| Gitea: best_iptv_2026/Best-IPTV-Service-Features-Pricing-and-Provider-Guide | Ide Editor Integration | [open](repository-workplaces-gitea-best-iptv-2026-best-iptv-service-features-pricing-and-provider-guide-b9885a99.md) |
| Gitea: IdeaCentral/AI-Observer-experiment | Ide Editor Integration | [open](repository-workplaces-gitea-ideacentral-ai-observer-experiment-6c2dbdf4.md) |
| Gitea: lgh06/APIJSON | Ide Editor Integration | [open](repository-workplaces-gitea-lgh06-apijson-d0a8c67b.md) |
| Gitea: portellam1/auto-xorg | Ide Editor Integration | [open](repository-workplaces-gitea-portellam1-auto-xorg-fa98ab13.md) |
| GitHub Codespaces | Ide Editor Integration | [open](repository-workplaces-github-codespaces-f941dff2.md) |
| guided-explorations/devops-patterns/multi-container-monorepo | Ide Editor Integration | [open](repository-workplaces-guided-explorations-devops-patterns-multi-container-monorepo-7d67a4be.md) |
