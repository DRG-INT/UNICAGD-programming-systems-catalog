...
<!-- canonical: https://pub.dev/packages/flutter_card_swiper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_card_swiper](https://pub.dev/packages/flutter_card_swiper) |
| Source record ids | pub_dev-efbdf819af415e |

## System Engineer Summary

This is a Tinder-like card swiper package. It allows you to swipe left, right, up, and down and
define your own business logic for each direction.

## Operational Role

For a systems engineer, flutter_card_swiper belongs in the Dart inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0 | 2025-11-02T22:09:50.439540Z | [https://pub.dev/api/packages/flutter_card_swiper](https://pub.dev/api/packages/flutter_card_swiper) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_card_swiper` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-efbdf819af415e` from `pub_dev` as `registry_expansion`
