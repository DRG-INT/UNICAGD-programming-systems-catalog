...
<!-- canonical: https://github.com/halilkaandogan/kaaninhos-mp3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/halilkaandogan/kaaninhos-mp3](https://github.com/halilkaandogan/kaaninhos-mp3) |
| Source record ids | github_search_effects-bd89e28e4c30ed |

## System Engineer Summary

A lightweight, retro-styled desktop music player inspired by Winamp. Stream music directly from
YouTube, apply real-time audio effects and play a mini-game while listening!

## Operational Role

For a systems engineer, halilkaandogan/kaaninhos-mp3 belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T19:09:07Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-bd89e28e4c30ed` from `github_search_effects` as `registry_expansion`
