...
| Source record ids | github_search_pattern_language-ebe805f3a34280 |
...
For a systems engineer, ochococo/Design-Patterns-In-Swift belongs in the Pattern language inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-03T07:30:28Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-ebe805f3a34280` from `github_search_pattern_language` as `registry_expansion`
