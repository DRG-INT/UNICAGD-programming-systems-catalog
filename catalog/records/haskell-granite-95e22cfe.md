...
<!-- canonical: https://hackage.haskell.org/package/granite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/granite](https://hackage.haskell.org/package/granite) |
| Source record ids | hackage_top_downloads-0c02cbf412fc5f |
...
For a systems engineer, granite belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.4.0 | 2026-07-01T23:51:27Z | [https://hackage.haskell.org/package/granite](https://hackage.haskell.org/package/granite) |  |
| candidate | partial | 0.1.0.1 |  | [https://hackage.haskell.org/package/granite](https://hackage.haskell.org/package/granite) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/granite` at `2026-09-03T00:34:31+00:00`.
...
- `hackage_top_downloads-0c02cbf412fc5f` from `hackage_top_downloads` as `registry_expansion`
