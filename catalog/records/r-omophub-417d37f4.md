...
<!-- canonical: https://cran.r-project.org/web/packages/omophub/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/omophub/index.html](https://cran.r-project.org/web/packages/omophub/index.html) |
| Source record ids | cran_packages_by_date-a1f8b6996bf6cb |

## System Engineer Summary

R Client for the 'OMOPHub' Medical Vocabulary API

## Operational Role

For a systems engineer, omophub belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-08-19 18:20:02 UTC | [https://cran.r-project.org/web/packages/omophub/DESCRIPTION](https://cran.r-project.org/web/packages/omophub/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/omophub/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a1f8b6996bf6cb` from `cran_packages_by_date` as `registry_expansion`
