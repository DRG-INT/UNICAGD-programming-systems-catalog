...
<!-- canonical: https://cran.r-project.org/web/packages/nanoparquet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nanoparquet/index.html](https://cran.r-project.org/web/packages/nanoparquet/index.html) |
| Source record ids | cran_packages_by_date-081b5b05219d82 |
...
For a systems engineer, nanoparquet belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-09-16 03:30:02 UTC | [https://cran.r-project.org/web/packages/nanoparquet/DESCRIPTION](https://cran.r-project.org/web/packages/nanoparquet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nanoparquet/DESCRIPTION` at `2026-09-16T04:20:47+00:00`.
...
- `cran_packages_by_date-081b5b05219d82` from `cran_packages_by_date` as `registry_expansion`
