...
| Canonical URL | [https://crates.io/crates/wayland-csd-frame](https://crates.io/crates/wayland-csd-frame) |
| Source record ids | crates_io-10ee86a77b0416 |
...
For a systems engineer, wayland-csd-frame belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2023-09-16T13:27:30.087305Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-10ee86a77b0416` from `crates_io` as `registry_expansion`
