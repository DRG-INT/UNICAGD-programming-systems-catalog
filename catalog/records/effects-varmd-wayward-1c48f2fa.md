...
<!-- canonical: https://github.com/varmd/wayward -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/varmd/wayward](https://github.com/varmd/wayward) |
| Source record ids | github_search_effects-f87a06b8ed7caa |
...
For a systems engineer, varmd/wayward belongs in the Effects inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T16:18:28Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f87a06b8ed7caa` from `github_search_effects` as `registry_expansion`
