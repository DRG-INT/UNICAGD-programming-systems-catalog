# JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-with-Adaptive-Coding-and-Modulation
...
<!-- canonical: https://github.com/JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-with-Adaptive-Coding-and-Modulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-with-Adaptive-Coding-and-Modulation](https://github.com/JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-with-Adaptive-Coding-and-Modulation) |
| Source record ids | github_search_satcom_satellites-710f16c9bf4845 |

## System Engineer Summary

MATLAB framework for Q-band LEO satellite link budget modeling with adaptive coding and modulation
(ACM). Includes time-varying propagation and realistic noise modeling.

## Operational Role

For a systems engineer, JohnZiangas/Link-Budget-Modeling-for-Q-Band-LEO-Satellite-Communications-
with-Adaptive-Coding-and-Modulation belongs in the SatCom Satellites inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-16T14:04:30Z | gh search repos topic:satellite-communications stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-710f16c9bf4845` from `github_search_satcom_satellites` as `registry_expansion`
