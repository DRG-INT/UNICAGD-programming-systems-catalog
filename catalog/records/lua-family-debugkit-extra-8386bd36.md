...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Dependency Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/dependency-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/daelvn/debugkit-extra](https://luarocks.org/modules/daelvn/debugkit-extra) |
| Source record ids | luarocks_root_manifest-3699ff1e9b8fbb |
...
For a systems engineer, debugkit-extra belongs in the Lua family inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| amqp-client-52plus | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amqp-client-52plus-0e5e6017.md) |
| bench | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bench-6b5d4620.md) |
| combustion | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-combustion-41520043.md) |
| depgraph | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-depgraph-06273e16.md) |
| jsonwebtoken | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-jsonwebtoken-669a975a.md) |
