...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/daelvn/debugkit-extra -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-3699ff1e9b8fbb` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amqp-client-52plus | Dependency Manager | [open](lua-family-amqp-client-52plus-0e5e6017.md) |
| bench | Dependency Manager | [open](lua-family-bench-6b5d4620.md) |
| combustion | Dependency Manager | [open](lua-family-combustion-41520043.md) |
| depgraph | Dependency Manager | [open](lua-family-depgraph-06273e16.md) |
| jsonwebtoken | Dependency Manager | [open](lua-family-jsonwebtoken-669a975a.md) |
