...
<!-- canonical: https://github.com/kiyoon/telescope-insert-path.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kiyoon/telescope-insert-path.nvim](https://github.com/kiyoon/telescope-insert-path.nvim) |
| Source record ids | github_search_telescopes-b6f2a01619b01b |
...
For a systems engineer, kiyoon/telescope-insert-path.nvim belongs in the Telescopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-20T07:34:31Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-b6f2a01619b01b` from `github_search_telescopes` as `registry_expansion`
