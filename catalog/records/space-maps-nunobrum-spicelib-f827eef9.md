...
<!-- canonical: https://github.com/nunobrum/spicelib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nunobrum/spicelib](https://github.com/nunobrum/spicelib) |
| Source record ids | github_search_space_maps-0afb08c919f129 |
...
For a systems engineer, nunobrum/spicelib belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T19:21:27Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0afb08c919f129` from `github_search_space_maps` as `registry_expansion`
