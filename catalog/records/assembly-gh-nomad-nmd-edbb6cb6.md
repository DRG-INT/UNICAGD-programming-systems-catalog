...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gh-nomad/nmd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gh-nomad/nmd](https://github.com/gh-nomad/nmd) |
| Source record ids | github_search_assembly-8287faeb020a78 |

## System Engineer Summary

set of single-header libraries for C/C++. The code is far from finished but some parts are quite
usable.

## Operational Role

For a systems engineer, gh-nomad/nmd belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-26T00:44:17Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-8287faeb020a78` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| guitmz/virii | Visualization Gui | [open](assembly-guitmz-virii-ed6ff028.md) |
| simon987/Much-Assembly-Required | Visualization Gui | [open](assembly-simon987-much-assembly-required-c15801d9.md) |
