...
<!-- canonical: https://pub.dev/packages/flutter_nfc_kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_nfc_kit](https://pub.dev/packages/flutter_nfc_kit) |
| Source record ids | pub_dev-6db815ba07519f |

## System Engineer Summary

Provide NFC functionality on Android, iOS & Web, including reading metadata, read & write NDEF
records, and transceive layer 3 & 4 data with NFC tags / cards

## Operational Role

For a systems engineer, flutter_nfc_kit belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.2 | 2026-01-20T15:23:42.703588Z | [https://pub.dev/api/packages/flutter_nfc_kit](https://pub.dev/api/packages/flutter_nfc_kit) |  |
| preview | known | 3.6.0-rc.6 | 2024-12-29T02:56:19.631109Z | [https://pub.dev/api/packages/flutter_nfc_kit](https://pub.dev/api/packages/flutter_nfc_kit) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_nfc_kit` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-6db815ba07519f` from `pub_dev` as `registry_expansion`
