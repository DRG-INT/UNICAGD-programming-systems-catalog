...
<!-- canonical: https://cran.r-project.org/web/packages/shinyelectron/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinyelectron/index.html](https://cran.r-project.org/web/packages/shinyelectron/index.html) |
| Source record ids | cran_packages_by_date-dd9582b6e2af50 |

## System Engineer Summary

Export 'Shiny' Applications as Desktop Apps using 'Electron'

## Operational Role

For a systems engineer, shinyelectron belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-07 16:10:02 UTC | [https://cran.r-project.org/web/packages/shinyelectron/DESCRIPTION](https://cran.r-project.org/web/packages/shinyelectron/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinyelectron/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dd9582b6e2af50` from `cran_packages_by_date` as `registry_expansion`
