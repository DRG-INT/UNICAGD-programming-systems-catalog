...
<!-- canonical: https://github.com/makomori/Sharaku -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makomori/Sharaku](https://github.com/makomori/Sharaku) |
| Source record ids | github_search_cocoa-685b17f20e6261 |
...
For a systems engineer, makomori/Sharaku belongs in the Cocoa inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-18T18:53:28Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-685b17f20e6261` from `github_search_cocoa` as `registry_expansion`
