...
<!-- canonical: https://hackage.haskell.org/package/web-routes-th -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/web-routes-th](https://hackage.haskell.org/package/web-routes-th) |
| Source record ids | hackage_top_downloads-6b01c9d9c4a731 |
...
For a systems engineer, web-routes-th belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.8.3 | 2025-09-05T15:48:18Z | [https://hackage.haskell.org/package/web-routes-th](https://hackage.haskell.org/package/web-routes-th) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/web-routes-th` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-6b01c9d9c4a731` from `hackage_top_downloads` as `registry_expansion`
