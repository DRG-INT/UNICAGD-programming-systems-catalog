...
| Source record ids | corpus-ad093c1c2301ec |

## System Engineer Summary

C23 constexpr is tracked as a language specification record in the C23 branch. The source did not
...
For a systems engineer, C23 constexpr belongs in the C23 inventory as part of ecosystem capability
...
- `corpus-ad093c1c2301ec` from `master_json` as `language_specification`
