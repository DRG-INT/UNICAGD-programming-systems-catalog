...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundTypes](https://github.com/JuliaRegistries/General/tree/master/B/BoundTypes) |
| Source record ids | julia_general-9a05ac19897785 |

## System Engineer Summary

Julia package registered in General at B/BoundTypes.

## Operational Role

For a systems engineer, BoundTypes belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundTypes", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-9a05ac19897785` from `julia_general` as `registry_expansion`
