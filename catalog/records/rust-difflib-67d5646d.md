...
<!-- canonical: https://crates.io/crates/difflib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/difflib](https://crates.io/crates/difflib) |
| Source record ids | crates_io-0b691bd053bce5 |
...
For a systems engineer, difflib belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2018-07-22T12:47:54.378558Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-0b691bd053bce5` from `crates_io` as `registry_expansion`
