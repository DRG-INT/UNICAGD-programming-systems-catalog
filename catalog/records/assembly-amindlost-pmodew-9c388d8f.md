...
<!-- canonical: https://github.com/amindlost/pmodew -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amindlost/pmodew](https://github.com/amindlost/pmodew) |
| Source record ids | github_search_assembly-eb8d4a73060a89 |
...
For a systems engineer, amindlost/pmodew belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-21T04:15:58Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-eb8d4a73060a89` from `github_search_assembly` as `registry_expansion`
