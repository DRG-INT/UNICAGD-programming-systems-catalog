...
<!-- canonical: https://github.com/OpenEmu/OpenEmu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenEmu/OpenEmu](https://github.com/OpenEmu/OpenEmu) |
| Source record ids | github_search_swift-0f958af5bee658 |
...
For a systems engineer, OpenEmu/OpenEmu belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-22T21:39:10Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-0f958af5bee658` from `github_search_swift` as `registry_expansion`
