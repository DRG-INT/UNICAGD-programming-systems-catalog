...
<!-- canonical: https://pub.dev/packages/flutter_lucide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_lucide](https://pub.dev/packages/flutter_lucide) |
| Source record ids | pub_dev-9fc7e35cba833d |

## System Engineer Summary

Flutter package for Lucide Icons. Lucide is a free, open-source icon set with 1793+ icons. It's a
fork of the popular Feather icon set.

## Operational Role

For a systems engineer, flutter_lucide belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.39.0 | 2026-09-01T16:54:28.996480Z | [https://pub.dev/api/packages/flutter_lucide](https://pub.dev/api/packages/flutter_lucide) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_lucide` at `2026-09-01T18:22:32+00:00`.
...
- `pub_dev-9fc7e35cba833d` from `pub_dev` as `registry_expansion`
