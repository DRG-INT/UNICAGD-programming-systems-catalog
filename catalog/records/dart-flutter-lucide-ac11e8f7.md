...
Flutter package for Lucide Icons. Lucide is a free, open-source icon set with 1818+ icons. It's a
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.43.0 | 2026-09-08T16:54:14.859572Z | [https://pub.dev/api/packages/flutter_lucide](https://pub.dev/api/packages/flutter_lucide) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_lucide` at `2026-09-08T18:23:56+00:00`.
