# danielraffel/pulp-classic-effects
...
<!-- canonical: https://github.com/danielraffel/pulp-classic-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danielraffel/pulp-classic-effects](https://github.com/danielraffel/pulp-classic-effects) |
| Source record ids | github_search_effects-a20e304124fb80 |

## System Engineer Summary

Classic audio effects as clean-room Pulp SDK example plugins (MIT). Independent implementations from
textbook DSP — see README.

## Operational Role

For a systems engineer, danielraffel/pulp-classic-effects belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T01:54:17Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a20e304124fb80` from `github_search_effects` as `registry_expansion`
