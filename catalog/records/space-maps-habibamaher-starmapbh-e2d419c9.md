...
<!-- canonical: https://github.com/habibamaher/StarMapBH -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/habibamaher/StarMapBH](https://github.com/habibamaher/StarMapBH) |
| Source record ids | github_search_space_maps-5eea3459f04363 |

## System Engineer Summary

An interactive map created for the astronomy community in Bahrain showing night sky visibility in
Bahrain, updated with satellite data and interesting facts

## Operational Role

For a systems engineer, habibamaher/StarMapBH belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-14T11:09:35Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5eea3459f04363` from `github_search_space_maps` as `registry_expansion`
