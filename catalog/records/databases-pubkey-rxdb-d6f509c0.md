...
<!-- canonical: https://github.com/pubkey/rxdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pubkey/rxdb](https://github.com/pubkey/rxdb) |
| Source record ids | github_search_databases-4647c5fe588bb8 |

## System Engineer Summary

The local-first database that runs on every JS runtime and replicates with your existing backend -
no vendor, no lock-in -

## Operational Role

For a systems engineer, pubkey/rxdb belongs in the Databases inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T09:16:33Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4647c5fe588bb8` from `github_search_databases` as `registry_expansion`
...
| jdbi/jdbi | Interpreter Runtime | [open](databases-jdbi-jdbi-3cc6bc95.md) |
