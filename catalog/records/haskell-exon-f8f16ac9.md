...
<!-- canonical: https://hackage.haskell.org/package/exon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/exon](https://hackage.haskell.org/package/exon) |
| Source record ids | hackage_top_downloads-d00b4adcd894b4 |
...
For a systems engineer, exon belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.3.0 | 2026-05-03T22:13:28Z | [https://hackage.haskell.org/package/exon](https://hackage.haskell.org/package/exon) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/exon` at `2026-09-03T00:34:29+00:00`.
...
- `hackage_top_downloads-d00b4adcd894b4` from `hackage_top_downloads` as `registry_expansion`
