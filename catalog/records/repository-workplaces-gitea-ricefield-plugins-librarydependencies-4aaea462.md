# Gitea: RiceField-Plugins/LibraryDependencies
...
<!-- canonical: https://gitea.com/RiceField-Plugins/LibraryDependencies -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/RiceField-Plugins/LibraryDependencies](https://gitea.com/RiceField-Plugins/LibraryDependencies) |
| Source record ids | gitea_repositories_api-6ccc27a5540ccb |
...
For a systems engineer, Gitea: RiceField-Plugins/LibraryDependencies belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-09T18:49:38Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6ccc27a5540ccb` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gitlab-org/security-products/dependency-scanning | Dependency Manager | [open](repository-workplaces-gitlab-org-security-products-dependency-scanning-3f274c86.md) |
...
| gitlab-org/security-products/security-report-schemas | Dependency Manager | [open](repository-workplaces-gitlab-org-security-products-security-report-schemas-1a7d4b38.md) |
