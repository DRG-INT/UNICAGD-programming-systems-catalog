...
<!-- canonical: https://github.com/datalevin/datalevin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/datalevin/datalevin](https://github.com/datalevin/datalevin) |
| Source record ids | github_search_databases-a57e9bd38bd905 |
...
For a systems engineer, datalevin/datalevin belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T23:23:21Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0 |
...
- `github_search_databases-a57e9bd38bd905` from `github_search_databases` as `registry_expansion`
