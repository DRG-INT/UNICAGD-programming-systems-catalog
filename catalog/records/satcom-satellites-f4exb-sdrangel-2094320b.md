...
<!-- canonical: https://github.com/f4exb/sdrangel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/f4exb/sdrangel](https://github.com/f4exb/sdrangel) |
| Source record ids | github_search_satcom_satellites-dcf33e1c265ef2 |

## System Engineer Summary

SDR Rx/Tx software for Airspy, Airspy HF+, BladeRF, HackRF, LimeSDR, PlutoSDR, RTL-SDR, SDRplay and
FunCube

## Operational Role

For a systems engineer, f4exb/sdrangel belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T10:08:39Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-dcf33e1c265ef2` from `github_search_satcom_satellites` as `registry_expansion`
