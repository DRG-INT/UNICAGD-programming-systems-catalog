...
<!-- canonical: https://github.com/simmsb/dsp-stuff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/simmsb/dsp-stuff](https://github.com/simmsb/dsp-stuff) |
| Source record ids | github_search_effects-493d730b1eb55c |

## System Engineer Summary

Some gui audio effects thing

## Operational Role

For a systems engineer, simmsb/dsp-stuff belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-21T12:39:57Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-493d730b1eb55c` from `github_search_effects` as `registry_expansion`
