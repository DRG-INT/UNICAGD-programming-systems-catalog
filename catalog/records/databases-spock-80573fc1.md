...
<!-- canonical: https://github.com/pgEdge/spock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pgEdge/spock](https://github.com/pgEdge/spock) |
| Source record ids | awesome_list-7a153f63ccc10a |
...
For a systems engineer, Spock belongs in the Databases inventory as part of language tooling, code
...
- `awesome_list-7a153f63ccc10a` from `awesome_list` as `registry_expansion`
