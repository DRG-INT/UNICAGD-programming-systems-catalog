...
<!-- canonical: https://crates.io/crates/unsafe-libyaml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unsafe-libyaml](https://crates.io/crates/unsafe-libyaml) |
| Source record ids | crates_io-d0810fa1dd1c87 |
...
For a systems engineer, unsafe-libyaml belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2024-03-17T05:44:18.590756Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-d0810fa1dd1c87` from `crates_io` as `registry_expansion`
