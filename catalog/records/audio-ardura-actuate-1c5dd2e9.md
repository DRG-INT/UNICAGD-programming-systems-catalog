...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ardura/Actuate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ardura/Actuate](https://github.com/ardura/Actuate) |
| Source record ids | github_search_audio-247d1ef9710f63 |
...
For a systems engineer, ardura/Actuate belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-04T16:05:07Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-247d1ef9710f63` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| arjo129/uSpeech | Visualization Gui | [open](audio-arjo129-uspeech-5eba5bde.md) |
| bbc/peaks.js | Visualization Gui | [open](audio-bbc-peaks-js-ecba90fa.md) |
| DhrBaksteen/ArduinoOPL2 | Visualization Gui | [open](audio-dhrbaksteen-arduinoopl2-f259ef2c.md) |
| dwhinham/mt32-pi | Visualization Gui | [open](audio-dwhinham-mt32-pi-7a87163b.md) |
| jatinchowdhury18/Bad-Circuit-Modelling | Visualization Gui | [open](audio-jatinchowdhury18-bad-circuit-modelling-c65762b2.md) |
| jatinchowdhury18/KlonCentaur | Visualization Gui | [open](audio-jatinchowdhury18-kloncentaur-2ceba457.md) |
| Lake1059/FFmpegFreeUI | Visualization Gui | [open](audio-lake1059-ffmpegfreeui-be2fb128.md) |
| monomadic/dd-core | Visualization Gui | [open](audio-monomadic-dd-core-a1124514.md) |
