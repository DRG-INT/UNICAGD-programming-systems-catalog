...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Formatter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/formatter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/jgm/lunamark](https://github.com/jgm/lunamark) |
| Source record ids | lua-source-264 |
...
For a systems engineer, lunamark belongs in the Lua family inventory as part of low-noise code
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 264}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-264` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AC-ClientOutput | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ac-clientoutput-4a745461.md) |
| adf2md | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-adf2md-d4583830.md) |
| aitextcleaner-formatting-residue | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aitextcleaner-formatting-residue-93b6373f.md) |
| au | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-au-30eba858.md) |
| ballerina.nvim | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ballerina-nvim-c9654d98.md) |
| bintrees | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bintrees-ce14d178.md) |
| blackjack | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-blackjack-a256ffb1.md) |
| blacklist3 | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-blacklist3-e85dddea.md) |
