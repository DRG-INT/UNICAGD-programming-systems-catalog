...
<!-- canonical: https://github.com/iCHAIT/awesome-macOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iCHAIT/awesome-macOS](https://github.com/iCHAIT/awesome-macOS) |
| Source record ids | awesome_list-af44c1d474bd1b |
...
For a systems engineer, awesome-macOS belongs in the Swift inventory as part of ecosystem capability
...
- `awesome_list-af44c1d474bd1b` from `awesome_list` as `registry_expansion`
