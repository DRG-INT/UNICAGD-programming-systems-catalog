...
| Canonical URL | [https://fengari.io/](https://fengari.io/) |
| Source record ids | lua-source-64 |
...
For a systems engineer, Fengari belongs in the Lua family inventory as part of runtime behavior,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 64}}` |
...
- `lua-source-64` from `master_json` as `source_list_item`
