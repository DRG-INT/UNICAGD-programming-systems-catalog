...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaViz](https://github.com/JuliaRegistries/General/tree/master/C/ClimaViz) |
| Source record ids | julia_general-b1c0061290941b |

## System Engineer Summary

Julia package registered in General at C/ClimaViz.

## Operational Role

For a systems engineer, ClimaViz belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaViz", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b1c0061290941b` from `julia_general` as `registry_expansion`
