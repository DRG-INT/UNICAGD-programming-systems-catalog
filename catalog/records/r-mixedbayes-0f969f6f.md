...
<!-- canonical: https://cran.r-project.org/web/packages/mixedBayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mixedBayes/index.html](https://cran.r-project.org/web/packages/mixedBayes/index.html) |
| Source record ids | cran_packages_by_date-670d5d0ae9839c |
...
For a systems engineer, mixedBayes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-08-04 16:00:08 UTC | [https://cran.r-project.org/web/packages/mixedBayes/DESCRIPTION](https://cran.r-project.org/web/packages/mixedBayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mixedBayes/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-670d5d0ae9839c` from `cran_packages_by_date` as `registry_expansion`
