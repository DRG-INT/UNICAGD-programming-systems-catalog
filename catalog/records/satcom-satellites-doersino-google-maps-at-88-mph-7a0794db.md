...
<!-- canonical: https://github.com/doersino/google-maps-at-88-mph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doersino/google-maps-at-88-mph](https://github.com/doersino/google-maps-at-88-mph) |
| Source record ids | github_search_satcom_satellites-96ba35cbdaacdb |

## System Engineer Summary

Google Maps keeps old satellite imagery around for a while – this tool collects what's available for
a user-specified region in the form of a GIF.

## Operational Role

For a systems engineer, doersino/google-maps-at-88-mph belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-02T07:22:11Z | gh search repos topic:satellite stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-96ba35cbdaacdb` from `github_search_satcom_satellites` as `registry_expansion`
