...
| Canonical URL | [https://webassembly.github.io/spec/](https://webassembly.github.io/spec/) |
| Source record ids | awesome_list-ea6ef7741874c1 |

## System Engineer Summary

WebAssembly Specification is tracked as a language specification record in the WebAssembly branch.
...
For a systems engineer, WebAssembly Specification belongs in the WebAssembly inventory as part of
...
- `awesome_list-ea6ef7741874c1` from `awesome_list` as `registry_expansion`
...
| Bytecoder - A Rich Domain Model for Java Bytecode and Framework to interpret and transpile it to other languages such as JavaScript, OpenCL or WebAssembly | Language Specification | [open](webassembly-bytecoder-a-rich-domain-model-for-java-bytecode-and-framework-to-interpret-and-transpile-it-to-other-languages-such-as-javascript-opencl-or-webassembly-ec8bb13b.md) |
| faust2 - Functional programming language for signal processing and sound synthesis | Language Specification | [open](webassembly-faust2-functional-programming-language-for-signal-processing-and-sound-synthesis-ffc17d99.md) |
| Rust - A safe, concurrent, practical language | Language Specification | [open](webassembly-rust-a-safe-concurrent-practical-language-889cd244.md) |
