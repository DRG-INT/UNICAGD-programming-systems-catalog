...
| Canonical URL | [https://github.com/xindoo/agentic-design-patterns](https://github.com/xindoo/agentic-design-patterns) |
| Source record ids | github_search_pattern_language-27a32db5ebe0c4 |
...
For a systems engineer, xindoo/agentic-design-patterns belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v76 | 2026-08-30T15:44:32Z | [https://api.github.com/repos/xindoo/agentic-design-patterns/releases/latest](https://api.github.com/repos/xindoo/agentic-design-patterns/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/xindoo/agentic-design-patterns/releases/latest` at `2026-09-01T10:25:57+00:00`.
...
- `github_search_pattern_language-27a32db5ebe0c4` from `github_search_pattern_language` as `registry_expansion`
