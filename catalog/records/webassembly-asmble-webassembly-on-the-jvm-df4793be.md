...
<!-- canonical: https://github.com/cretz/asmble -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cretz/asmble](https://github.com/cretz/asmble) |
| Source record ids | awesome_list-f3fab86e12b754 |

## System Engineer Summary

Asmble - WebAssembly on the JVM is tracked as an interpreter runtime record in the WebAssembly
...
For a systems engineer, Asmble - WebAssembly on the JVM belongs in the WebAssembly inventory as part
...
- `awesome_list-f3fab86e12b754` from `awesome_list` as `registry_expansion`
