...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BSON](https://github.com/JuliaRegistries/General/tree/master/B/BSON) |
| Source record ids | corpus-df4fbeb704ac5d |

## System Engineer Summary

BSON.jl is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, BSON.jl belongs in the Julia inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.3.9 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/B/BSON/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/B/BSON/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-df4fbeb704ac5d` from `master_json` as `serialization`
