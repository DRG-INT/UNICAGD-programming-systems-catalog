...
<!-- canonical: https://cran.r-project.org/web/packages/meteoland/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/meteoland/index.html](https://cran.r-project.org/web/packages/meteoland/index.html) |
| Source record ids | cran_packages_by_date-7a33eb277c4eb8 |
...
For a systems engineer, meteoland belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.8 | 2026-09-02 14:30:02 UTC | [https://cran.r-project.org/web/packages/meteoland/DESCRIPTION](https://cran.r-project.org/web/packages/meteoland/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/meteoland/DESCRIPTION` at `2026-09-02T15:24:11+00:00`.
...
- `cran_packages_by_date-7a33eb277c4eb8` from `cran_packages_by_date` as `registry_expansion`
