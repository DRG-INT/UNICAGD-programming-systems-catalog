...
| Source record ids | master-6c9fdaf59c71 |

## System Engineer Summary

lcov is tracked as a coverage record in the C99 branch. The source did not provide a long
...
For a systems engineer, lcov belongs in the C99 inventory as part of ecosystem capability mapping,
...
- `master-6c9fdaf59c71` from `master_json` as `coverage`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| gcov | Coverage | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-gcov-6d72c31f.md) |
