...
<!-- canonical: https://cran.r-project.org/web/packages/hassediagrams/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hassediagrams/index.html](https://cran.r-project.org/web/packages/hassediagrams/index.html) |
| Source record ids | cran_packages_by_date-3e1921f90db7d3 |
...
For a systems engineer, hassediagrams belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0 | 2026-09-15 09:20:09 UTC | [https://cran.r-project.org/web/packages/hassediagrams/DESCRIPTION](https://cran.r-project.org/web/packages/hassediagrams/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hassediagrams/DESCRIPTION` at `2026-09-15T10:20:58+00:00`.
...
- `cran_packages_by_date-3e1921f90db7d3` from `cran_packages_by_date` as `registry_expansion`
