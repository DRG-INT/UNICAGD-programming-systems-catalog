...
<!-- canonical: https://hackage.haskell.org/package/keid-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keid-core](https://hackage.haskell.org/package/keid-core) |
| Source record ids | hackage_recent-93416aea04be39 |
...
For a systems engineer, keid-core belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.11.1 | 2026-09-06T20:28:06Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-93416aea04be39` from `hackage_recent` as `registry_expansion`
