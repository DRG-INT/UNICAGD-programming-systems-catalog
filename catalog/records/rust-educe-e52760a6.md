...
<!-- canonical: https://crates.io/crates/educe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/educe](https://crates.io/crates/educe) |
| Source record ids | crates_io-a71aabef5ff0ba |

## System Engineer Summary

This crate offers procedural macros designed to facilitate the swift implementation of Rust's built-
in traits.

## Operational Role

For a systems engineer, educe belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-09-12T07:23:23.135839Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-12T08:19:37+00:00`.
...
- `crates_io-a71aabef5ff0ba` from `crates_io` as `registry_expansion`
