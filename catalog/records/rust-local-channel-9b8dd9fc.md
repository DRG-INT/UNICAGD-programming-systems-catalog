...
<!-- canonical: https://crates.io/crates/local-channel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/local-channel](https://crates.io/crates/local-channel) |
| Source record ids | crates_io-1c6e900f038936 |
...
For a systems engineer, local-channel belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2023-10-29T23:18:52.409270Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-1c6e900f038936` from `crates_io` as `registry_expansion`
