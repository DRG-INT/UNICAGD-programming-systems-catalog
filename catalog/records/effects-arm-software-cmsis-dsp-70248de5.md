...
| Source record ids | github_search_effects-4ec593ff660a7a |
...
For a systems engineer, ARM-software/CMSIS-DSP belongs in the Effects inventory as part of device
...
- `github_search_effects-4ec593ff660a7a` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| tony-hw/DSP-Audio-Effects-TMS320C5515 | Embedded Hardware | [open](effects-tony-hw-dsp-audio-effects-tms320c5515-fd5ce0de.md) |
