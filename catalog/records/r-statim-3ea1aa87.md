...
<!-- canonical: https://cran.r-project.org/web/packages/statim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/statim/index.html](https://cran.r-project.org/web/packages/statim/index.html) |
| Source record ids | cran_packages_by_date-fa047bd42e53d3 |
...
For a systems engineer, statim belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 19:50:02 UTC | [https://cran.r-project.org/web/packages/statim/DESCRIPTION](https://cran.r-project.org/web/packages/statim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/statim/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fa047bd42e53d3` from `cran_packages_by_date` as `registry_expansion`
