...
<!-- canonical: https://cran.r-project.org/web/packages/ebrahim.gof/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ebrahim.gof/index.html](https://cran.r-project.org/web/packages/ebrahim.gof/index.html) |
| Source record ids | cran_packages_by_date-c3e446040c2a90 |
...
For a systems engineer, ebrahim.gof belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.0 | 2026-08-28 09:50:24 UTC | [https://cran.r-project.org/web/packages/ebrahim.gof/DESCRIPTION](https://cran.r-project.org/web/packages/ebrahim.gof/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ebrahim.gof/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c3e446040c2a90` from `cran_packages_by_date` as `registry_expansion`
