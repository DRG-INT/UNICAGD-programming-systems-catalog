# henkrijneveld/Microscope-PiCam
...
<!-- canonical: https://github.com/henkrijneveld/Microscope-PiCam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/henkrijneveld/Microscope-PiCam](https://github.com/henkrijneveld/Microscope-PiCam) |
| Source record ids | github_search_microscopy-6f6314628f156c |

## System Engineer Summary

Use the Raspberry PI HQ Camera with a (gemmological) microscope. Fully interactive vue based.
Designed by a Gemmologist :)

## Operational Role

For a systems engineer, henkrijneveld/Microscope-PiCam belongs in the Microscopy inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-13T20:52:44Z | gh search repos topic:microscope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-6f6314628f156c` from `github_search_microscopy` as `registry_expansion`
...
| UU-cellbiology/ZstackDepthColorCode | Logging Observability | [open](microscopy-uu-cellbiology-zstackdepthcolorcode-2dae5fc0.md) |
