...
<!-- canonical: https://luarocks.org/modules/edubart/cartesix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/edubart/cartesix](https://luarocks.org/modules/edubart/cartesix) |
| Source record ids | luarocks_root_manifest-b3559d2dd0b403 |
...
For a systems engineer, cartesix belongs in the Lua family inventory as part of fault isolation,
...
- `luarocks_root_manifest-b3559d2dd0b403` from `luarocks_root_manifest` as `registry_expansion`
