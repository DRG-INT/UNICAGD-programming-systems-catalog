...
<!-- canonical: https://github.com/datenoio/dataportals-registry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/datenoio/dataportals-registry](https://github.com/datenoio/dataportals-registry) |
| Source record ids | github_search_catalogs-c904720051b37b |

## System Engineer Summary

Registry of data portals, catalogs, data repositories including data catalogs dataset and catalog
description standard

## Operational Role

For a systems engineer, datenoio/dataportals-registry belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:13:36Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c904720051b37b` from `github_search_catalogs` as `registry_expansion`
...
| vercel/components.build | Language Specification | [open](catalogs-vercel-components-build-c3f9ff05.md) |
