...
<!-- canonical: https://gitlab.com/nucleoid/nucleoid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/nucleoid/nucleoid](https://gitlab.com/nucleoid/nucleoid) |
| Source record ids | gitlab_projects_api-33ec9c4e458244 |

## System Engineer Summary

Nucleoid is an open source (Apache 2.0), a runtime environment for declarative programming in
ES6/JavaScript syntax and runs as a programming runtime and datastore.

## Operational Role

For a systems engineer, nucleoid/nucleoid belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-05 | `{"kind": "gitlab_projects_api", "query": "runtime", "retrieved": "2026-09-05", "status": "forge-api-derived"}` |
...
- `gitlab_projects_api-33ec9c4e458244` from `gitlab_projects_api` as `registry_expansion`
