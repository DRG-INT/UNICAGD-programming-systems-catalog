...
<!-- canonical: https://github.com/meel-hd/lofi-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/meel-hd/lofi-engine](https://github.com/meel-hd/lofi-engine) |
| Source record ids | github_search_engines-d87e3bbdcda1c1 |
...
For a systems engineer, meel-hd/lofi-engine belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-04T12:50:30Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d87e3bbdcda1c1` from `github_search_engines` as `registry_expansion`
