...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Compiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/C/CompilerSupportLibraries_jll](https://github.com/JuliaRegistries/General/tree/master/jll/C/CompilerSupportLibraries_jll) |
| Source record ids | julia_general-1e29b1698cb40d |

## System Engineer Summary

Julia package registered in General at jll/C/CompilerSupportLibraries_jll.

## Operational Role

For a systems engineer, CompilerSupportLibraries_jll belongs in the Julia inventory as part of
compiler selection, diagnostics behavior, target support, ABI expectations, and build
reproducibility.
...
| Name | Category | Page |
| --- | --- | --- |
| AIE_LLVM_Toolchain_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-aie-llvm-toolchain-jll-0bdebfa5.md) |
| AMDGPU_LLVM_Backend_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-amdgpu-llvm-backend-jll-d62cb603.md) |
| Clang | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clang-565150c9.md) |
| Clang_assert_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clang-assert-jll-d6cc2f46.md) |
| Clang_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clang-jll-6476fe57.md) |
| Clang_unified_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clang-unified-jll-a90c0bb5.md) |
| ClangCompiler | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clangcompiler-0dbea90c.md) |
| ClangExtract_jll | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-clangextract-jll-5c41a437.md) |
