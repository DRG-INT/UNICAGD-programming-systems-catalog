...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md)
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/C/CompilerSupportLibraries_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-1e29b1698cb40d` from `julia_general` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AIE_LLVM_Toolchain_jll | Compiler | [open](julia-aie-llvm-toolchain-jll-0bdebfa5.md) |
| AMDGPU_LLVM_Backend_jll | Compiler | [open](julia-amdgpu-llvm-backend-jll-d62cb603.md) |
| Clang | Compiler | [open](julia-clang-565150c9.md) |
| Clang_assert_jll | Compiler | [open](julia-clang-assert-jll-d6cc2f46.md) |
| Clang_jll | Compiler | [open](julia-clang-jll-6476fe57.md) |
| Clang_unified_jll | Compiler | [open](julia-clang-unified-jll-a90c0bb5.md) |
| ClangCompiler | Compiler | [open](julia-clangcompiler-0dbea90c.md) |
| ClangExtract_jll | Compiler | [open](julia-clangextract-jll-5c41a437.md) |
