...
<!-- canonical: https://github.com/BrowserBox/BrowserBox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BrowserBox/BrowserBox](https://github.com/BrowserBox/BrowserBox) |
| Source record ids | github_search_video-77ee5ba810b2ca |
...
For a systems engineer, BrowserBox/BrowserBox belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T10:06:46Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-77ee5ba810b2ca` from `github_search_video` as `registry_expansion`
