...
<!-- canonical: https://github.com/godot-rust/gdext -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/godot-rust/gdext](https://github.com/godot-rust/gdext) |
| Source record ids | github_search_game_engines-4591bd607c8f25 |
...
For a systems engineer, godot-rust/gdext belongs in the Game Engines inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:10:21Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-4591bd607c8f25` from `github_search_game_engines` as `registry_expansion`
