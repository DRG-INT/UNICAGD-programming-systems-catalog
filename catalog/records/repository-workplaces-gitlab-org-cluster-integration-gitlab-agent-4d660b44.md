...
<!-- canonical: https://gitlab.com/gitlab-org/cluster-integration/gitlab-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/cluster-integration/gitlab-agent](https://gitlab.com/gitlab-org/cluster-integration/gitlab-agent) |
| Source record ids | gitlab_projects_api-fecbd8d2cf023e |

## System Engineer Summary

GitLab Relay - host for various GitLab Features such as: - Workflow Engine (AutoFlow / autocore) -
GitLab CD - Job Router and Runner Controllers - GitLab Agent for Kubernetes (agentk) - Operational
Container Scanning - Remote Development (Workspaces)

## Operational Role

For a systems engineer, gitlab-org/cluster-integration/gitlab-agent belongs in the Repository
...
- `gitlab_projects_api-fecbd8d2cf023e` from `gitlab_projects_api` as `registry_expansion`
...
| mopsa/mopsa-analyzer | Static Analyzer | [open](repository-workplaces-mopsa-mopsa-analyzer-9740e96e.md) |
