...
<!-- canonical: https://hackage.haskell.org/package/Unixutils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Unixutils](https://hackage.haskell.org/package/Unixutils) |
| Source record ids | hackage_top_downloads-4d62af55065aec |
...
For a systems engineer, Unixutils belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.54.3 | 2023-12-18T17:29:15Z | [https://hackage.haskell.org/package/Unixutils](https://hackage.haskell.org/package/Unixutils) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Unixutils` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-4d62af55065aec` from `hackage_top_downloads` as `registry_expansion`
