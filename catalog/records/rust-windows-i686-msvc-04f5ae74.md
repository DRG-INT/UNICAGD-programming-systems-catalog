...
<!-- canonical: https://crates.io/crates/windows_i686_msvc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows_i686_msvc](https://crates.io/crates/windows_i686_msvc) |
| Source record ids | crates_io-9c51ab80714470 |

## System Engineer Summary

windows_i686_msvc is tracked as a library record in the Rust branch. The source did not provide a
...
For a systems engineer, windows_i686_msvc belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.53.1 | 2025-10-06T17:33:49.033999Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-9c51ab80714470` from `crates_io` as `registry_expansion`
