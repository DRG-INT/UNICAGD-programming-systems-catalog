...
| Canonical URL | [https://crates.io/crates/macro_rules_attribute](https://crates.io/crates/macro_rules_attribute) |
| Source record ids | crates_io-963d3fc0041938 |
...
For a systems engineer, macro_rules_attribute belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-07-29T15:38:21.457562Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-963d3fc0041938` from `crates_io` as `registry_expansion`
