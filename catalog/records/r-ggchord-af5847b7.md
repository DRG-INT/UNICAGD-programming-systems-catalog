...
<!-- canonical: https://cran.r-project.org/web/packages/ggchord/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggchord/index.html](https://cran.r-project.org/web/packages/ggchord/index.html) |
| Source record ids | cran_packages_by_date-8c9dec223cf9b0 |
...
For a systems engineer, ggchord belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-24 08:20:19 UTC | [https://cran.r-project.org/web/packages/ggchord/DESCRIPTION](https://cran.r-project.org/web/packages/ggchord/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggchord/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8c9dec223cf9b0` from `cran_packages_by_date` as `registry_expansion`
