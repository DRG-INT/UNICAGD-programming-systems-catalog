...
<!-- canonical: https://github.com/AstrBotDevs/AstrBot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) |
| Source record ids | github_search_aims-16ff5e8b0985cf |

## System Engineer Summary

AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and
AI feature, and can be your openclaw alternative. ✨

## Operational Role

For a systems engineer, AstrBotDevs/AstrBot belongs in the "aim's" inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T17:08:58Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_aims-16ff5e8b0985cf` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| HKUDS/LightRAG | Parser Lexer Ast | [open](aim-s-hkuds-lightrag-8991527b.md) |
