...
<!-- canonical: https://packagist.org/packages/zordius/lightncandy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zordius/lightncandy](https://packagist.org/packages/zordius/lightncandy) |
| Source record ids | packagist_search-b5d553d8b409a7 |
...
For a systems engineer, zordius/lightncandy belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-b5d553d8b409a7` from `packagist_search` as `registry_expansion`
