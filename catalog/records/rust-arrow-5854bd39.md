...
<!-- canonical: https://crates.io/crates/arrow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arrow](https://crates.io/crates/arrow) |
| Source record ids | crates_io-4e94beb9f5ca3d |
...
For a systems engineer, arrow belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 59.3.0 | 2026-09-01T10:38:57.692364Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-01T12:25:16+00:00`.
...
- `crates_io-4e94beb9f5ca3d` from `crates_io` as `registry_expansion`
