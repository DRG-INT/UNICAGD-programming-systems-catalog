...
| Canonical URL | [https://luarocks.org/modules/fsantanna/iuplua-cd](https://luarocks.org/modules/fsantanna/iuplua-cd) |
| Source record ids | luarocks_root_manifest-a9d7217793393e |

## System Engineer Summary

CD (Canvas Draw) binding for Lua (Tecgraf/PUC-Rio)

## Operational Role

For a systems engineer, iuplua-cd belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-a9d7217793393e` from `luarocks_root_manifest` as `registry_expansion`
