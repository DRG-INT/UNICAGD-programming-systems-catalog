...
<!-- canonical: https://crates.io/crates/filetime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/filetime](https://crates.io/crates/filetime) |
| Source record ids | crates_io-32db3a35aad7c7 |
...
For a systems engineer, filetime belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.29 | 2026-05-12T22:38:22.994500Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-32db3a35aad7c7` from `crates_io` as `registry_expansion`
