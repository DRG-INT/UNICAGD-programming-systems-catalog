...
<!-- canonical: https://packagist.org/packages/php-http/message -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/message](https://packagist.org/packages/php-http/message) |
| Source record ids | packagist_search-db09c3414bb00a |
...
For a systems engineer, php-http/message belongs in the PHP inventory as part of service
...
- `packagist_search-db09c3414bb00a` from `packagist_search` as `registry_expansion`
