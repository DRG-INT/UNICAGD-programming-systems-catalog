...
<!-- canonical: https://pub.dev/packages/skeletonizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/skeletonizer](https://pub.dev/packages/skeletonizer) |
| Source record ids | pub_dev-6aeaae3dbf185a |
...
For a systems engineer, skeletonizer belongs in the Dart inventory as part of ecosystem capability
...
- `pub_dev-6aeaae3dbf185a` from `pub_dev` as `registry_expansion`
