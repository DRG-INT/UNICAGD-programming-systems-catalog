...
| Canonical URL | [https://github.com/codeforreal1/compressO](https://github.com/codeforreal1/compressO) |
| Source record ids | github_search_video-5a47d7eab4216c |

## System Engineer Summary

Convert any video/image into a tiny size. 100% free & open-source. Available for Mac, Windows &
Linux.

## Operational Role

For a systems engineer, codeforreal1/compressO belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-04-06T14:25:32Z | [https://api.github.com/repos/codeforreal1/compressO/releases/latest](https://api.github.com/repos/codeforreal1/compressO/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/codeforreal1/compressO/releases/latest` at `2026-09-01T09:23:22+00:00`.
...
- `github_search_video-5a47d7eab4216c` from `github_search_video` as `registry_expansion`
