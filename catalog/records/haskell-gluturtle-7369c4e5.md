...
<!-- canonical: https://hackage.haskell.org/package/gluturtle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gluturtle](https://hackage.haskell.org/package/gluturtle) |
| Source record ids | hackage_top_downloads-79f414baaafad9 |
...
For a systems engineer, gluturtle belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.58.1 | 2014-10-24T15:01:44Z | [https://hackage.haskell.org/package/gluturtle](https://hackage.haskell.org/package/gluturtle) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gluturtle` at `2026-09-10T00:30:52+00:00`.
...
- `hackage_top_downloads-79f414baaafad9` from `hackage_top_downloads` as `registry_expansion`
