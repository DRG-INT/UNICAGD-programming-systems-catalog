...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cookieY/Yearning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cookieY/Yearning](https://github.com/cookieY/Yearning) |
| Source record ids | github_search_databases-52023836e0711c |
...
For a systems engineer, cookieY/Yearning belongs in the Databases inventory as part of supply-chain
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T11:46:31Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-08 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:mysql stars:>500", "retrieved": "2026-09-08", "status": "forge-cli-derived"}` |
...
- `github_search_databases-52023836e0711c` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amark/gun | Security Sast | [open](databases-amark-gun-b5e89507.md) |
| apache/shardingsphere | Security Sast | [open](databases-apache-shardingsphere-d9ea2f58.md) |
| Bytebase | Security Sast | [open](databases-bytebase-3fdd8393.md) |
| IoT-Technology/IoT-Technical-Guide | Security Sast | [open](databases-iot-technology-iot-technical-guide-4f9cb27e.md) |
| lakekeeper/lakekeeper | Security Sast | [open](databases-lakekeeper-lakekeeper-0020b553.md) |
| shashirajraja/onlinebookstore | Security Sast | [open](databases-shashirajraja-onlinebookstore-f5ef7b71.md) |
| soumyadip007/E-Medical-System-Web-Project-Using-Spring-Boot-Security-JPA-Rest-Thymeleaf-HQL | Security Sast | [open](databases-soumyadip007-e-medical-system-web-project-using-spring-boot-security-jpa-rest-thymeleaf-hql-d7409ecf.md) |
| xerj-org/xerj | Security Sast | [open](databases-xerj-org-xerj-9c547839.md) |
