...
<!-- canonical: https://github.com/SFTtech/openage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SFTtech/openage](https://github.com/SFTtech/openage) |
| Source record ids | github_search_engines-95a7e68a4f2fec |
...
For a systems engineer, SFTtech/openage belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T10:38:52Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-95a7e68a4f2fec` from `github_search_engines` as `registry_expansion`
