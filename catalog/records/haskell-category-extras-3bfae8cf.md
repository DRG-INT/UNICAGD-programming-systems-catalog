...
<!-- canonical: https://hackage.haskell.org/package/category-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/category-extras](https://hackage.haskell.org/package/category-extras) |
| Source record ids | hackage_top_downloads-153b2e5ff46157 |
...
For a systems engineer, category-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2012-04-06T20:59:00Z | [https://hackage.haskell.org/package/category-extras](https://hackage.haskell.org/package/category-extras) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/category-extras` at `2026-09-12T00:29:11+00:00`.
...
- `hackage_top_downloads-153b2e5ff46157` from `hackage_top_downloads` as `registry_expansion`
