...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/X-LANCE/SLAM-LLM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/X-LANCE/SLAM-LLM](https://github.com/X-LANCE/SLAM-LLM) |
| Source record ids | github_search_audio-76476ffd530c41 |
...
For a systems engineer, X-LANCE/SLAM-LLM belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-15T12:37:22Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-76476ffd530c41` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ASR-project/Multilingual-PR | Language Specification | [open](audio-asr-project-multilingual-pr-bd7ef9c6.md) |
| atosystem/SpeechCLIP | Language Specification | [open](audio-atosystem-speechclip-84c2e9eb.md) |
| chaosprint/glicol | Language Specification | [open](audio-chaosprint-glicol-c74a5bb7.md) |
| DigitalPhonetics/IMS-Toucan | Language Specification | [open](audio-digitalphonetics-ims-toucan-96508b32.md) |
| FluidSynth/fluidsynth | Language Specification | [open](audio-fluidsynth-fluidsynth-59e20ded.md) |
| ga642381/SpeechPrompt | Language Specification | [open](audio-ga642381-speechprompt-37e497e1.md) |
| grame-cncm/faust | Language Specification | [open](audio-grame-cncm-faust-d30f3de0.md) |
| JiaoXianjun/BTLE | Language Specification | [open](audio-jiaoxianjun-btle-5c3bac18.md) |
