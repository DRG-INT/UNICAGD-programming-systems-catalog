...
<!-- canonical: https://github.com/jazzband/django-newsletter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jazzband/django-newsletter](https://github.com/jazzband/django-newsletter) |
| Source record ids | github_search_magazines-ecfdb7c1749ce6 |

## System Engineer Summary

An email newsletter application for the Django web application framework, including an extended
admin interface, web (un)subscription, dynamic e-mail templates, an archive and HTML email support.

## Operational Role

For a systems engineer, jazzband/django-newsletter belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T05:34:17Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-ecfdb7c1749ce6` from `github_search_magazines` as `registry_expansion`
