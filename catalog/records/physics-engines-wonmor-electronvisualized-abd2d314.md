...
<!-- canonical: https://github.com/wonmor/ElectronVisualized -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wonmor/ElectronVisualized](https://github.com/wonmor/ElectronVisualized) |
| Source record ids | github_search_physics_engines-94ab9819804a89 |
...
For a systems engineer, wonmor/ElectronVisualized belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-17T21:08:02Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-94ab9819804a89` from `github_search_physics_engines` as `registry_expansion`
