...
<!-- canonical: https://github.com/skypjack/entt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skypjack/entt](https://github.com/skypjack/entt) |
| Source record ids | github_search_game_engines-16ec1f25ed2650 |
...
For a systems engineer, skypjack/entt belongs in the Game Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:17:46Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-16ec1f25ed2650` from `github_search_game_engines` as `registry_expansion`
