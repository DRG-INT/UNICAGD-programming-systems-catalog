...
<!-- canonical: https://github.com/noirblancrouge/Formera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/noirblancrouge/Formera](https://github.com/noirblancrouge/Formera) |
| Source record ids | github_search_font_briefcase-9e40a08e5269df |

## System Engineer Summary

Formera (aka FuturaRenner) family is a digital version of Futura lead character belonging to the
typography department of Ecole Nationale Supérieure des Arts de la Cambre, and probably the first
draft of Futura as we know it.

## Operational Role

For a systems engineer, noirblancrouge/Formera belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-14T21:13:42Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `github_search_font_briefcase-9e40a08e5269df` from `github_search_font_briefcase` as `registry_expansion`
