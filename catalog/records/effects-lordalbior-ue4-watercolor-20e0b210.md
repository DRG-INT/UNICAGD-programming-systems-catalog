...
<!-- canonical: https://github.com/LordAlbior/UE4-Watercolor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LordAlbior/UE4-Watercolor](https://github.com/LordAlbior/UE4-Watercolor) |
| Source record ids | github_search_effects-0df8b785400918 |
...
For a systems engineer, LordAlbior/UE4-Watercolor belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-04T14:50:29Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0df8b785400918` from `github_search_effects` as `registry_expansion`
