...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Codegen Codemod Refactoring](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/codegen-codemod-refactoring.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-de104069187e4a |

## System Engineer Summary

Babel codemods is tracked as a codegen codemod refactoring record in the Node.js/JavaScript branch.
...
For a systems engineer, Babel codemods belongs in the Node.js/JavaScript inventory as part of
...
- `corpus-de104069187e4a` from `master_json` as `codegen_codemod_refactoring`
