...
<!-- canonical: https://crates.io/crates/normpath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/normpath](https://crates.io/crates/normpath) |
| Source record ids | crates_io-ba90ecd7120a7d |
...
For a systems engineer, normpath belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2026-05-05T01:39:19.177044Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
| Evidence | GPL-3; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
