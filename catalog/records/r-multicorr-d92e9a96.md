...
<!-- canonical: https://cran.r-project.org/web/packages/multiCorr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multiCorr/index.html](https://cran.r-project.org/web/packages/multiCorr/index.html) |
| Source record ids | cran_packages_by_date-dd134ea84072ca |
...
For a systems engineer, multiCorr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 11:50:08 UTC | [https://cran.r-project.org/web/packages/multiCorr/DESCRIPTION](https://cran.r-project.org/web/packages/multiCorr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multiCorr/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-dd134ea84072ca` from `cran_packages_by_date` as `registry_expansion`
