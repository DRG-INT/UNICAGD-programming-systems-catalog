...
<!-- canonical: https://hackage.haskell.org/package/amazonka-elasticbeanstalk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-elasticbeanstalk](https://hackage.haskell.org/package/amazonka-elasticbeanstalk) |
| Source record ids | hackage_top_downloads-9da5e8f926cc39 |
...
For a systems engineer, amazonka-elasticbeanstalk belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:11:35Z | [https://hackage.haskell.org/package/amazonka-elasticbeanstalk](https://hackage.haskell.org/package/amazonka-elasticbeanstalk) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-elasticbeanstalk` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-9da5e8f926cc39` from `hackage_top_downloads` as `registry_expansion`
