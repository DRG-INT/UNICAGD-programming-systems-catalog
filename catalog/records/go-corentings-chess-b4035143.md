...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/CorentinGS/chess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CorentinGS/chess](https://github.com/CorentinGS/chess) |
| Source record ids | github_search_go-1c414ce94cf86c |

## System Engineer Summary

Go (Golang) chess library: move generation with bitboards, PGN/FEN, UCI/Stockfish, opening books,
image generation. Well-tested & fast.

## Operational Role

For a systems engineer, CorentinGS/chess belongs in the Go inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T09:40:38Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-1c414ce94cf86c` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Ebazhanov/linkedin-skill-assessments-quizzes | Testing Framework | [open](go-ebazhanov-linkedin-skill-assessments-quizzes-05557abd.md) |
| gitee.com/mirrors_testem/testem | Testing Framework | [open](go-gitee-com-mirrors-testem-testem-1b4facf3.md) |
| quii/learn-go-with-tests | Testing Framework | [open](go-quii-learn-go-with-tests-f9d484c4.md) |
| vxcontrol/pentagi | Testing Framework | [open](go-vxcontrol-pentagi-a8d06839.md) |
