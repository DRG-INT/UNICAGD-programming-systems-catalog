...
<!-- canonical: https://crates.io/crates/jsonschema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/jsonschema](https://crates.io/crates/jsonschema) |
| Source record ids | crates_io-1f78f9d91020aa |
...
For a systems engineer, jsonschema belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.56.0 | 2026-09-10T08:19:25.646308Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-11T06:24:57+00:00`.
...
- `crates_io-1f78f9d91020aa` from `crates_io` as `registry_expansion`
