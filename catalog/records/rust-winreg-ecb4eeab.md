...
<!-- canonical: https://crates.io/crates/winreg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/winreg](https://crates.io/crates/winreg) |
| Source record ids | crates_io-f29f1c737deb87 |
...
For a systems engineer, winreg belongs in the Rust inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.56.0 | 2026-03-14T22:02:40.054127Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-02T20:20:00+00:00`.
...
- `crates_io-f29f1c737deb87` from `crates_io` as `registry_expansion`
