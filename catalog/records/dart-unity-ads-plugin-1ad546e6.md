...
<!-- canonical: https://pub.dev/packages/unity_ads_plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/unity_ads_plugin](https://pub.dev/packages/unity_ads_plugin) |
| Source record ids | pub_dev-e9401039c58609 |

## System Engineer Summary

Unity Ads plugin for Flutter Applications. This plugin is able to display Unity Banner Ads and Unity
Video Ads.

## Operational Role

For a systems engineer, unity_ads_plugin belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-29T11:17:45.974053Z | [https://pub.dev/api/packages/unity_ads_plugin](https://pub.dev/api/packages/unity_ads_plugin) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/unity_ads_plugin` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-e9401039c58609` from `pub_dev` as `registry_expansion`
