...
<!-- canonical: https://github.com/johnvteixido/etherlens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/johnvteixido/etherlens](https://github.com/johnvteixido/etherlens) |
| Source record ids | github_search_repertoare_catalogs-a5109fa4b0ec97 |

## System Engineer Summary

An open-source, MIT-licensed alternative to Shodan.io. Autonomously scans and catalogs internet-
connected devices with AI-powered banner classification, risk scoring, and a stunning React 3D globe
dashboard.

## Operational Role

For a systems engineer, johnvteixido/etherlens belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-12T21:21:22Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-a5109fa4b0ec97` from `github_search_repertoare_catalogs` as `registry_expansion`
