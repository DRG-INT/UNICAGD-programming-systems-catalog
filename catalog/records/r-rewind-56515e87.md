...
<!-- canonical: https://cran.r-project.org/web/packages/rewind/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rewind/index.html](https://cran.r-project.org/web/packages/rewind/index.html) |
| Source record ids | cran_packages_by_date-bf79ad66c19026 |
...
For a systems engineer, rewind belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 13:50:08 UTC | [https://cran.r-project.org/web/packages/rewind/DESCRIPTION](https://cran.r-project.org/web/packages/rewind/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rewind/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-bf79ad66c19026` from `cran_packages_by_date` as `registry_expansion`
