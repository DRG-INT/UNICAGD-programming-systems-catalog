...
<!-- canonical: https://crates.io/crates/expect-test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/expect-test](https://crates.io/crates/expect-test) |
| Source record ids | crates_io-c02558cd830fed |
...
For a systems engineer, expect-test belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2024-12-21T13:05:32.571711Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
