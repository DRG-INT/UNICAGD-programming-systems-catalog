...
<!-- canonical: https://gitea.com/0b1tadmin/1-12-2_server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/0b1tadmin/1-12-2_server](https://gitea.com/0b1tadmin/1-12-2_server) |
| Source record ids | gitea_repositories_api-30ea926c5a6d7e |
...
For a systems engineer, Gitea: 0b1tadmin/1-12-2_server belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-14T00:38:06Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-30ea926c5a6d7e` from `gitea_repositories_api` as `registry_expansion`
