...
<!-- canonical: https://github.com/tensorflow/tfjs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tensorflow/tfjs](https://github.com/tensorflow/tfjs) |
| Source record ids | github_search_webassembly-b02983966f6528 |
...
For a systems engineer, tensorflow/tfjs belongs in the WebAssembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-23T00:04:38Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b02983966f6528` from `github_search_webassembly` as `registry_expansion`
