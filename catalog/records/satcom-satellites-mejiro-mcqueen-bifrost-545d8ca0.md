...
<!-- canonical: https://github.com/Mejiro-McQueen/Bifrost -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mejiro-McQueen/Bifrost](https://github.com/Mejiro-McQueen/Bifrost) |
| Source record ids | github_search_satcom_satellites-a19e7c5275227f |
...
For a systems engineer, Mejiro-McQueen/Bifrost belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-18T00:26:27Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-a19e7c5275227f` from `github_search_satcom_satellites` as `registry_expansion`
