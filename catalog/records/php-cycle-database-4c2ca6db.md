...
| Canonical URL | [https://packagist.org/packages/cycle/database](https://packagist.org/packages/cycle/database) |
| Source record ids | packagist_search-9ad106c44a14a2 |
...
For a systems engineer, cycle/database belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.23.1 | 2026-08-19T10:25:15+00:00 | [https://repo.packagist.org/p2/cycle/database.json](https://repo.packagist.org/p2/cycle/database.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cycle/database.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-9ad106c44a14a2` from `packagist_search` as `registry_expansion`
