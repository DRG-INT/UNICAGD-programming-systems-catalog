...
<!-- canonical: https://cran.r-project.org/web/packages/scmix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scmix/index.html](https://cran.r-project.org/web/packages/scmix/index.html) |
| Source record ids | cran_packages_by_date-2e9014cedb10e4 |
...
For a systems engineer, scmix belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-20 14:30:02 UTC | [https://cran.r-project.org/web/packages/scmix/DESCRIPTION](https://cran.r-project.org/web/packages/scmix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scmix/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2e9014cedb10e4` from `cran_packages_by_date` as `registry_expansion`
