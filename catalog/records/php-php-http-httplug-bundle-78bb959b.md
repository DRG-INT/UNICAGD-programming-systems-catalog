...
<!-- canonical: https://packagist.org/packages/php-http/httplug-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/httplug-bundle](https://packagist.org/packages/php-http/httplug-bundle) |
| Source record ids | packagist_search-c44bd1522d8526 |
...
For a systems engineer, php-http/httplug-bundle belongs in the PHP inventory as part of service
...
- `packagist_search-c44bd1522d8526` from `packagist_search` as `registry_expansion`
