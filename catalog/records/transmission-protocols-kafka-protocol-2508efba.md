...
<!-- canonical: https://kafka.apache.org/protocol -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://kafka.apache.org/protocol](https://kafka.apache.org/protocol) |
| Source record ids | curated_language_routes-0687992c656b5e |

## System Engineer Summary

Apache Kafka protocol guide for clients, brokers, requests, responses, versions, and wire
compatibility.

## Operational Role

For a systems engineer, Kafka Protocol belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-0687992c656b5e` from `curated_language_routes` as `registry_expansion`
