...
<!-- canonical: https://www.npmjs.com/package/@hono/vite-dev-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@hono/vite-dev-server](https://www.npmjs.com/package/@hono/vite-dev-server) |
| Source record ids | npm_registry-0925fef945f4cd |
...
For a systems engineer, @hono/vite-dev-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.26.1 | 2026-07-11T04:05:00.157Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-0925fef945f4cd` from `npm_registry` as `registry_expansion`
