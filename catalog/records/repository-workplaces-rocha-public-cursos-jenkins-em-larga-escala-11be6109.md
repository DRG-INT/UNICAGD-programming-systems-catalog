# rocha.public/cursos/jenkins-em-larga-escala
...
<!-- canonical: https://gitlab.com/rocha.public/cursos/jenkins-em-larga-escala -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/rocha.public/cursos/jenkins-em-larga-escala](https://gitlab.com/rocha.public/cursos/jenkins-em-larga-escala) |
| Source record ids | gitlab_projects_api-63dbf4f59b0ef9 |

## System Engineer Summary

Curso disponível em: :rocket:

## Operational Role

For a systems engineer, rocha.public/cursos/jenkins-em-larga-escala belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-04-27T17:12:30.554Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-63dbf4f59b0ef9` from `gitlab_projects_api` as `registry_expansion`
