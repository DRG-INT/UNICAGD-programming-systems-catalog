...
| Source record ids | lua-source-129 |

## System Engineer Summary

lua-source-129 is tracked as a machine learning record in the Lua family branch. The source did not
...
For a systems engineer, lua-source-129 belongs in the Lua family inventory as part of model
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 129}}` |
...
- `lua-source-129` from `master_json` as `source_list_item`
