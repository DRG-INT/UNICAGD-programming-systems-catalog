...
| Canonical URL | [https://www.mercurial-scm.org/](https://www.mercurial-scm.org/) |
| Source record ids | curated_repository_workplace_routes-e7dca5461cb46a |

## System Engineer Summary

Distributed version control system using the hg command, with changesets, branches, bookmarks,
phases, and extension workflows.

## Operational Role

For a systems engineer, Mercurial SCM belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-e7dca5461cb46a` from `curated_repository_workplace_routes` as `registry_expansion`
...
| Fossil SCM | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-fossil-scm-7b38eea0.md) |
