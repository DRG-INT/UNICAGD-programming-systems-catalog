...
<!-- canonical: https://cran.r-project.org/web/packages/rt.test/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rt.test/index.html](https://cran.r-project.org/web/packages/rt.test/index.html) |
| Source record ids | cran_packages_by_date-45944abe1003ca |

## System Engineer Summary

rt.test is tracked as a testing framework record in the R branch. The source did not provide a long
...
For a systems engineer, rt.test belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.9 | 2026-09-14 06:50:02 UTC | [https://cran.r-project.org/web/packages/rt.test/DESCRIPTION](https://cran.r-project.org/web/packages/rt.test/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rt.test/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-45944abe1003ca` from `cran_packages_by_date` as `registry_expansion`
