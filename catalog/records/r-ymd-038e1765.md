...
<!-- canonical: https://cran.r-project.org/web/packages/ymd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ymd/index.html](https://cran.r-project.org/web/packages/ymd/index.html) |
| Source record ids | cran_packages_by_date-89dc0bd3644c6d |
...
For a systems engineer, ymd belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-08-22 23:20:02 UTC | [https://cran.r-project.org/web/packages/ymd/DESCRIPTION](https://cran.r-project.org/web/packages/ymd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ymd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-89dc0bd3644c6d` from `cran_packages_by_date` as `registry_expansion`
