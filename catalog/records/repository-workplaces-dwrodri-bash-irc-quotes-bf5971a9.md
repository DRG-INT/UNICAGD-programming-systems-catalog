# dwrodri/bash_irc_quotes

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/dwrodri/bash_irc_quotes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/dwrodri/bash_irc_quotes](https://gitlab.com/dwrodri/bash_irc_quotes) |
| Source record ids | gitlab_projects_api-e6e9c60febb765 |
...
For a systems engineer, dwrodri/bash_irc_quotes belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-e6e9c60febb765` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| exploit-database/exploitdb | Ffi Bindings | [open](repository-workplaces-exploit-database-exploitdb-f78a49a7.md) |
