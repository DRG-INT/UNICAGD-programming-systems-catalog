...
<!-- canonical: https://pub.dev/packages/ota_update -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ota_update](https://pub.dev/packages/ota_update) |
| Source record ids | pub_dev-f77c2dd0170e72 |
...
For a systems engineer, ota_update belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2025-12-03T09:07:57.549434Z | [https://pub.dev/api/packages/ota_update](https://pub.dev/api/packages/ota_update) |  |
| preview | known | 3.0.0-nullsafety | 2021-03-25T12:35:29.019272Z | [https://pub.dev/api/packages/ota_update](https://pub.dev/api/packages/ota_update) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ota_update` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-f77c2dd0170e72` from `pub_dev` as `registry_expansion`
