...
<!-- canonical: https://gitea.com/3rd/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/3rd/gitea](https://gitea.com/3rd/gitea) |
| Source record ids | gitea_repositories_api-fd05230da7b4c3 |

## System Engineer Summary

Git with a cup of tea! Painless self-hosted all-in-one software development service, includes Git
hosting, code review, team collaboration, package registry and CI/CD

## Operational Role

For a systems engineer, Gitea: 3rd/gitea belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-05T05:10:36Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-fd05230da7b4c3` from `gitea_repositories_api` as `registry_expansion`
