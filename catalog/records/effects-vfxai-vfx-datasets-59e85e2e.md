...
<!-- canonical: https://github.com/vfxai/vfx-datasets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vfxai/vfx-datasets](https://github.com/vfxai/vfx-datasets) |
| Source record ids | github_search_effects-b1804e0fd319f4 |

## System Engineer Summary

vfxai/vfx-datasets is tracked as a machine learning record in the Effects branch. The source did not
...
For a systems engineer, vfxai/vfx-datasets belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-20T03:59:12Z | gh search repos topic:visual-effects stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b1804e0fd319f4` from `github_search_effects` as `registry_expansion`
