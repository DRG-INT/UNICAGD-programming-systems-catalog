...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/evanoberholster/imagemeta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/evanoberholster/imagemeta](https://github.com/evanoberholster/imagemeta) |
| Source record ids | github_search_photography-f75a5023144ecc |

## System Engineer Summary

Image Metadata (Exif and XMP) extraction for JPEG, HEIC, AVIF, TIFF and Camera Raw in golang. Focus
is on providing features and improved performance.

## Operational Role

For a systems engineer, evanoberholster/imagemeta belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T02:39:00Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f75a5023144ecc` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| lovell/sharp | Benchmarking | [open](photography-lovell-sharp-2ca40e3a.md) |
| margelo/react-native-fast-tflite | Benchmarking | [open](photography-margelo-react-native-fast-tflite-26269249.md) |
| margelo/react-native-vision-camera | Benchmarking | [open](photography-margelo-react-native-vision-camera-77b61cb8.md) |
| teslamotors/react-native-camera-kit | Benchmarking | [open](photography-teslamotors-react-native-camera-kit-22df3292.md) |
