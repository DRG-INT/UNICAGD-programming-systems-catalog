...
<!-- canonical: https://hackage.haskell.org/package/web-routes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/web-routes](https://hackage.haskell.org/package/web-routes) |
| Source record ids | hackage_top_downloads-2edeac92cf61b8 |
...
For a systems engineer, web-routes belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.16 | 2024-06-05T17:13:01Z | [https://hackage.haskell.org/package/web-routes](https://hackage.haskell.org/package/web-routes) |  |
| candidate | partial | 0.27.14 |  | [https://hackage.haskell.org/package/web-routes](https://hackage.haskell.org/package/web-routes) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/web-routes` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-2edeac92cf61b8` from `hackage_top_downloads` as `registry_expansion`
