...
<!-- canonical: https://github.com/chinedufn/percy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chinedufn/percy](https://github.com/chinedufn/percy) |
| Source record ids | github_search_webassembly-7d2b8c884b3819 |
...
For a systems engineer, chinedufn/percy belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T00:27:33Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD_3_clause + file LICENSE; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_webassembly-7d2b8c884b3819` from `github_search_webassembly` as `registry_expansion`
