...
<!-- canonical: https://crates.io/crates/serde_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_derive](https://crates.io/crates/serde_derive) |
| Source record ids | crates_io-40822f159ac472 |
...
For a systems engineer, serde_derive belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.229 | 2026-07-18T23:05:07.504375Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-40822f159ac472` from `crates_io` as `registry_expansion`
