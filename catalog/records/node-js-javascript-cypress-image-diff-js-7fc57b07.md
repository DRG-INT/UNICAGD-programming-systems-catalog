...
<!-- canonical: https://www.npmjs.com/package/cypress-image-diff-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/cypress-image-diff-js](https://www.npmjs.com/package/cypress-image-diff-js) |
| Source record ids | npm_registry-aeb3f19a699006 |
...
For a systems engineer, cypress-image-diff-js belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0 | 2026-03-23T16:26:48.775Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-aeb3f19a699006` from `npm_registry` as `registry_expansion`
