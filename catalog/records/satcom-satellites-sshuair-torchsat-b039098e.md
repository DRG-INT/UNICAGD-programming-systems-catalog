...
| Source record ids | github_search_satcom_satellites-7697e2e05f7092 |
...
For a systems engineer, sshuair/torchsat belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.0.1 | 2019-09-24T15:05:01Z | [https://api.github.com/repos/sshuair/torchsat/releases/latest](https://api.github.com/repos/sshuair/torchsat/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/sshuair/torchsat/releases/latest` at `2026-09-01T08:26:38+00:00`.
...
- `github_search_satcom_satellites-7697e2e05f7092` from `github_search_satcom_satellites` as `registry_expansion`
