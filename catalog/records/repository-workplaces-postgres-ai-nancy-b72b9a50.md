...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/postgres-ai/nancy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/postgres-ai/nancy](https://gitlab.com/postgres-ai/nancy) |
| Source record ids | gitlab_projects_api-354495f03c8735 |

## System Engineer Summary

beta Nancy CLI. Automated database experiments

## Operational Role

For a systems engineer, postgres-ai/nancy belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-354495f03c8735` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: 0x61nas/aarty | Cli | [open](repository-workplaces-gitea-0x61nas-aarty-6aeebbea.md) |
| Gitea: Azuma/ASCII-To-Hexadecimal | Cli | [open](repository-workplaces-gitea-azuma-ascii-to-hexadecimal-a6c9bbae.md) |
| GitHub CLI | Cli | [open](repository-workplaces-github-cli-3d665d5e.md) |
| GitLab CLI | Cli | [open](repository-workplaces-gitlab-cli-56a6b9f6.md) |
