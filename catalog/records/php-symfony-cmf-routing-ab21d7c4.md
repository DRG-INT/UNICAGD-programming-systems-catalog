...
<!-- canonical: https://packagist.org/packages/symfony-cmf/routing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony-cmf/routing](https://packagist.org/packages/symfony-cmf/routing) |
| Source record ids | packagist_search-e3a01bd05e05fb |
...
For a systems engineer, symfony-cmf/routing belongs in the PHP inventory as part of request routing,
...
- `packagist_search-e3a01bd05e05fb` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| intaro/pinba-bundle | Web Framework | [open](php-intaro-pinba-bundle-cca9b5a1.md) |
