...
<!-- canonical: https://cran.r-project.org/web/packages/wishartinference/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wishartinference/index.html](https://cran.r-project.org/web/packages/wishartinference/index.html) |
| Source record ids | cran_packages_by_date-a291446f3101c4 |

## System Engineer Summary

Bayesian Inference for the Wishart Distribution Parameters

## Operational Role

For a systems engineer, wishartinference belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 12:10:02 UTC | [https://cran.r-project.org/web/packages/wishartinference/DESCRIPTION](https://cran.r-project.org/web/packages/wishartinference/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wishartinference/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-a291446f3101c4` from `cran_packages_by_date` as `registry_expansion`
