...
<!-- canonical: https://github.com/xhuangcv/neucam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xhuangcv/neucam](https://github.com/xhuangcv/neucam) |
| Source record ids | github_search_photography-32427fcdff161b |

## System Engineer Summary

The official implementation of CVPR 2023 paper: Inverting the Imaging Process by Learning an
Implicit Camera Model

## Operational Role

For a systems engineer, xhuangcv/neucam belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-19T08:15:10Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-32427fcdff161b` from `github_search_photography` as `registry_expansion`
