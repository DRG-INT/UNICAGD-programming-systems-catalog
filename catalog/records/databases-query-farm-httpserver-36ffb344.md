...
<!-- canonical: https://github.com/Query-farm/httpserver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Query-farm/httpserver](https://github.com/Query-farm/httpserver) |
| Source record ids | github_search_databases-1ef5a25b95c8fe |
...
For a systems engineer, Query-farm/httpserver belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T16:13:16Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1ef5a25b95c8fe` from `github_search_databases` as `registry_expansion`
