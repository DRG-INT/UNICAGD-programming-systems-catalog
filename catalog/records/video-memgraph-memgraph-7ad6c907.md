...
<!-- canonical: https://github.com/memgraph/memgraph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/memgraph/memgraph](https://github.com/memgraph/memgraph) |
| Source record ids | github_search_video-dd38029565a1d0 |

## System Engineer Summary

High-performance open-source in-memory graph database for GraphRAG, AI memory, agentic AI, and real-
time graph analytics. Cypher-compatible, built in C++.

## Operational Role

For a systems engineer, memgraph/memgraph belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:18:17Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-dd38029565a1d0` from `github_search_video` as `registry_expansion`
