...
<!-- canonical: https://crates.io/crates/tempfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tempfile](https://crates.io/crates/tempfile) |
| Source record ids | crates_io-115686c7e4e9a2 |
...
For a systems engineer, tempfile belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.27.0 | 2026-03-11T00:20:04.812840Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-115686c7e4e9a2` from `crates_io` as `registry_expansion`
