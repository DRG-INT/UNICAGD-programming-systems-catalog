...
<!-- canonical: https://hackage.haskell.org/package/path -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/path](https://hackage.haskell.org/package/path) |
| Source record ids | hackage_top_downloads-d46b5b09b03b05 |
...
For a systems engineer, path belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.6 | 2024-08-11T12:45:58Z | [https://hackage.haskell.org/package/path](https://hackage.haskell.org/package/path) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/path` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-d46b5b09b03b05` from `hackage_top_downloads` as `registry_expansion`
