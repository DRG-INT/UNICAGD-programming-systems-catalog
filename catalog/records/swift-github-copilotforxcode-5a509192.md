...
<!-- canonical: https://github.com/github/CopilotForXcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/github/CopilotForXcode](https://github.com/github/CopilotForXcode) |
| Source record ids | github_search_swift-4925eb910122b7 |
...
For a systems engineer, github/CopilotForXcode belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T21:24:57Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-4925eb910122b7` from `github_search_swift` as `registry_expansion`
