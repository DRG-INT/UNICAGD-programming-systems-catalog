...
<!-- canonical: https://luarocks.org/modules/glenn/cloud -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/glenn/cloud](https://luarocks.org/modules/glenn/cloud) |
| Source record ids | luarocks_root_manifest-07f290b8767bf8 |

## System Engineer Summary

cloud is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cloud belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-07f290b8767bf8` from `luarocks_root_manifest` as `registry_expansion`
