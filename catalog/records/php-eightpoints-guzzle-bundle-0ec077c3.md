...
| Canonical URL | [https://packagist.org/packages/eightpoints/guzzle-bundle](https://packagist.org/packages/eightpoints/guzzle-bundle) |
| Source record ids | packagist_search-edebfe30687477 |

## System Engineer Summary

Integrates Guzzle 6.x/7.x/8.x, a PHP HTTP Client, into Symfony. Comes with easy and powerful
configuration options and optional plugins.

## Operational Role

For a systems engineer, eightpoints/guzzle-bundle belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v8.9.0 | 2026-08-11T19:16:57+00:00 | [https://repo.packagist.org/p2/eightpoints/guzzle-bundle.json](https://repo.packagist.org/p2/eightpoints/guzzle-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/eightpoints/guzzle-bundle.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-edebfe30687477` from `packagist_search` as `registry_expansion`
