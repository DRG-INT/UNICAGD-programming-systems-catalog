...
<!-- canonical: https://github.com/dimartarmizi/map-to-poster -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dimartarmizi/map-to-poster](https://github.com/dimartarmizi/map-to-poster) |
| Source record ids | github_search_maps-2eac605ba16a96 |

## System Engineer Summary

MapToPoster JS is a client-side web app that turns any location into a high-resolution, customizable
map poster with various themes, layouts, and export options.

## Operational Role

For a systems engineer, dimartarmizi/map-to-poster belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-06T16:19:07Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2eac605ba16a96` from `github_search_maps` as `registry_expansion`
