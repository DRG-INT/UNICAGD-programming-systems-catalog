...
<!-- canonical: https://hackage.haskell.org/package/ethereum-analyzer-webui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ethereum-analyzer-webui](https://hackage.haskell.org/package/ethereum-analyzer-webui) |
| Source record ids | hackage_top_downloads-b96d6cd72df279 |
...
For a systems engineer, ethereum-analyzer-webui belongs in the Haskell inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.4 | 2017-12-25T23:32:57Z | [https://hackage.haskell.org/package/ethereum-analyzer-webui](https://hackage.haskell.org/package/ethereum-analyzer-webui) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ethereum-analyzer-webui` at `2026-09-09T00:34:58+00:00`.
...
- `hackage_top_downloads-b96d6cd72df279` from `hackage_top_downloads` as `registry_expansion`
