...
<!-- canonical: https://github.com/Vincentqyw/Recent-Stars-2025 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Vincentqyw/Recent-Stars-2025](https://github.com/Vincentqyw/Recent-Stars-2025) |
| Source record ids | github_search_computer_graphics_software-a8543f28448abc |

## System Engineer Summary

🔥SLAM, VIsual localization, keypoint detection, Image matching, Pose/Object tracking,
Depth/Disparity/Flow Estimation, 3D-graphic, etc. related papers and code

## Operational Role

For a systems engineer, Vincentqyw/Recent-Stars-2025 belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-a8543f28448abc` from `github_search_computer_graphics_software` as `registry_expansion`
