...
<!-- canonical: https://cran.r-project.org/web/packages/qvivid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qvivid/index.html](https://cran.r-project.org/web/packages/qvivid/index.html) |
| Source record ids | cran_packages_by_date-70dbdce68c7f42 |

## System Engineer Summary

Fast Quantum Simulation and Vivid Visualizations

## Operational Role

For a systems engineer, qvivid belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-23 16:40:02 UTC | [https://cran.r-project.org/web/packages/qvivid/DESCRIPTION](https://cran.r-project.org/web/packages/qvivid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qvivid/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-70dbdce68c7f42` from `cran_packages_by_date` as `registry_expansion`
