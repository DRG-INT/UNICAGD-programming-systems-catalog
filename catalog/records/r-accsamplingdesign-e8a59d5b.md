...
<!-- canonical: https://cran.r-project.org/web/packages/AccSamplingDesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AccSamplingDesign/index.html](https://cran.r-project.org/web/packages/AccSamplingDesign/index.html) |
| Source record ids | cran_packages_by_date-fd36173609b343 |
...
For a systems engineer, AccSamplingDesign belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.9 | 2026-08-25 07:00:18 UTC | [https://cran.r-project.org/web/packages/AccSamplingDesign/DESCRIPTION](https://cran.r-project.org/web/packages/AccSamplingDesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AccSamplingDesign/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fd36173609b343` from `cran_packages_by_date` as `registry_expansion`
