...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/persistent-postgresql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/persistent-postgresql](https://hackage.haskell.org/package/persistent-postgresql) |
| Source record ids | hackage_top_downloads-69efb661fd9acc |

## System Engineer Summary

Hackage package with 283 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, persistent-postgresql belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.14.3.0 | 2026-01-14T23:05:52Z | [https://hackage.haskell.org/package/persistent-postgresql](https://hackage.haskell.org/package/persistent-postgresql) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/persistent-postgresql` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-69efb661fd9acc` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| beam-postgres | Database Datastore | [open](haskell-beam-postgres-10770bea.md) |
| beam-sqlite | Database Datastore | [open](haskell-beam-sqlite-31ef3c68.md) |
| direct-sqlite | Database Datastore | [open](haskell-direct-sqlite-8454c4ec.md) |
| eventium-sqlite | Database Datastore | [open](haskell-eventium-sqlite-16ed666d.md) |
| hasql | Database Datastore | [open](haskell-hasql-3e165709.md) |
| hasql-dynamic-statements | Database Datastore | [open](haskell-hasql-dynamic-statements-256d244c.md) |
| hasql-notifications | Database Datastore | [open](haskell-hasql-notifications-b385cc8e.md) |
| hasql-optparse-applicative | Database Datastore | [open](haskell-hasql-optparse-applicative-66e350d8.md) |
