...
<!-- canonical: https://github.com/JustinLove/gw_shared_systems -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JustinLove/gw_shared_systems](https://github.com/JustinLove/gw_shared_systems) |
| Source record ids | github_search_space_maps-053ad18d35cf5c |

## System Engineer Summary

Mod for Planetary Annihilation to use shared systems and map packs for new Galactic Wars

## Operational Role

For a systems engineer, JustinLove/gw_shared_systems belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-08T23:09:03Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-053ad18d35cf5c` from `github_search_space_maps` as `registry_expansion`
