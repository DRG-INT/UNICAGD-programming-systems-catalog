...
<!-- canonical: https://github.com/ilialek/Pixel-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ilialek/Pixel-Shader](https://github.com/ilialek/Pixel-Shader) |
| Source record ids | github_search_effects-d05f3adc2364fe |

## System Engineer Summary

Post-processing pixel effect shader in Unity

## Operational Role

For a systems engineer, ilialek/Pixel-Shader belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-29T14:43:35Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d05f3adc2364fe` from `github_search_effects` as `registry_expansion`
