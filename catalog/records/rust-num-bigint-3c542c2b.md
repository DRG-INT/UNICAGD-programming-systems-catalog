...
| Canonical URL | [https://crates.io/crates/num-bigint](https://crates.io/crates/num-bigint) |
| Source record ids | crates_io-e6a64fda4c1880 |
...
For a systems engineer, num-bigint belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-07-05T01:20:47.603095Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-e6a64fda4c1880` from `crates_io` as `registry_expansion`
