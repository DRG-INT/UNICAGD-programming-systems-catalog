...
<!-- canonical: https://cran.r-project.org/web/packages/rayrender/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rayrender/index.html](https://cran.r-project.org/web/packages/rayrender/index.html) |
| Source record ids | cran_packages_by_date-cbabc93f6653ff |
...
For a systems engineer, rayrender belongs in the R inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.42.0 | 2026-09-16 02:30:02 UTC | [https://cran.r-project.org/web/packages/rayrender/DESCRIPTION](https://cran.r-project.org/web/packages/rayrender/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rayrender/DESCRIPTION` at `2026-09-16T03:20:38+00:00`.
...
- `cran_packages_by_date-cbabc93f6653ff` from `cran_packages_by_date` as `registry_expansion`
