...
<!-- canonical: https://github.com/antirez/lua-cmsgpack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/antirez/lua-cmsgpack](https://github.com/antirez/lua-cmsgpack) |
| Source record ids | lua-source-256 |
...
For a systems engineer, lua-cmsgpack belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 256}}` |
...
- `lua-source-256` from `master_json` as `source_list_item`
