...
<!-- canonical: https://github.com/HazyResearch/hyena-dna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HazyResearch/hyena-dna](https://github.com/HazyResearch/hyena-dna) |
| Source record ids | github_search_assembly-4d8d8b6dab1ba4 |
...
For a systems engineer, HazyResearch/hyena-dna belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-22T19:15:50Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-4d8d8b6dab1ba4` from `github_search_assembly` as `registry_expansion`
