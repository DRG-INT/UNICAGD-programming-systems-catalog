...
<!-- canonical: https://github.com/parcel-bundler/parcel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) |
| Source record ids | github_search_assets-c2a9780c59a679 |
...
For a systems engineer, parcel-bundler/parcel belongs in the Assets inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T15:46:00Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-c2a9780c59a679` from `github_search_assets` as `registry_expansion`
