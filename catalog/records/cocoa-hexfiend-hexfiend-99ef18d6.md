...
<!-- canonical: https://github.com/HexFiend/HexFiend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HexFiend/HexFiend](https://github.com/HexFiend/HexFiend) |
| Source record ids | github_search_cocoa-51603eb2b2736a |
...
For a systems engineer, HexFiend/HexFiend belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-29T18:26:33Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; The Unlicense; https://api.github.com/licenses/unlicense; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_cocoa-51603eb2b2736a` from `github_search_cocoa` as `registry_expansion`
