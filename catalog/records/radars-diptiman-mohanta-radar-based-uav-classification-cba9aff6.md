...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/diptiman-mohanta/Radar-Based-UAV-Classification -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diptiman-mohanta/Radar-Based-UAV-Classification](https://github.com/diptiman-mohanta/Radar-Based-UAV-Classification) |
| Source record ids | github_search_radars-9e5520c48761a2 |

## System Engineer Summary

Advanced radar-based classification system for detecting and distinguishing UAVs, birds, and RC
aircraft using SVMD signal decomposition and deep learning feature extraction.

## Operational Role

For a systems engineer, diptiman-mohanta/Radar-Based-UAV-Classification belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-02T09:35:51Z | gh search repos topic:radar-signal-processing stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9e5520c48761a2` from `github_search_radars` as `registry_expansion`
