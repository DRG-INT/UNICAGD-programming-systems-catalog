...
<!-- canonical: https://hackage.haskell.org/package/leksah -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/leksah](https://hackage.haskell.org/package/leksah) |
| Source record ids | hackage_top_downloads-c12fa5bd34af81 |
...
For a systems engineer, leksah belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.2.2 | 2017-08-14T23:22:06Z | [https://hackage.haskell.org/package/leksah](https://hackage.haskell.org/package/leksah) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/leksah` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-c12fa5bd34af81` from `hackage_top_downloads` as `registry_expansion`
