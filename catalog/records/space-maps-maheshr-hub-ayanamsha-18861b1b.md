...
<!-- canonical: https://github.com/maheshr-hub/ayanamsha -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maheshr-hub/ayanamsha](https://github.com/maheshr-hub/ayanamsha) |
| Source record ids | github_search_space_maps-ea7cb851d18d3f |

## System Engineer Summary

Ayanamsha is a sky map based on Vedic astronomy. Explore the astronomical basis of Rashi, Nakshatra,
Yoga, Karana and Lagna on this app.

## Operational Role

For a systems engineer, maheshr-hub/ayanamsha belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-26T05:10:14Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ea7cb851d18d3f` from `github_search_space_maps` as `registry_expansion`
