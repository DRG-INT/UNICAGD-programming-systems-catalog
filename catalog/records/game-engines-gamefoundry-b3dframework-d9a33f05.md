...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GameFoundry/B3DFramework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GameFoundry/B3DFramework](https://github.com/GameFoundry/B3DFramework) |
| Source record ids | github_search_game_engines-048c04de1bb641 |
...
For a systems engineer, GameFoundry/B3DFramework belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T18:49:17Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-048c04de1bb641` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bulletphysics/bullet3 | Datetime | [open](game-engines-bulletphysics-bullet3-234c095c.md) |
| carp-lang/Carp | Datetime | [open](game-engines-carp-lang-carp-cfe9a462.md) |
| clockworklabs/SpacetimeDB | Datetime | [open](game-engines-clockworklabs-spacetimedb-48953859.md) |
