...
<!-- canonical: https://crates.io/crates/nix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/nix](https://crates.io/crates/nix) |
| Source record ids | crates_io-373b7364af75c3 |
...
For a systems engineer, nix belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.31.3 | 2026-05-11T07:01:18.650221Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-373b7364af75c3` from `crates_io` as `registry_expansion`
