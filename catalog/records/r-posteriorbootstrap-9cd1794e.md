...
<!-- canonical: https://cran.r-project.org/web/packages/PosteriorBootstrap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PosteriorBootstrap/index.html](https://cran.r-project.org/web/packages/PosteriorBootstrap/index.html) |
| Source record ids | cran_packages_by_date-d74f99577812fc |
...
For a systems engineer, PosteriorBootstrap belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-07 17:00:07 UTC | [https://cran.r-project.org/web/packages/PosteriorBootstrap/DESCRIPTION](https://cran.r-project.org/web/packages/PosteriorBootstrap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PosteriorBootstrap/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-d74f99577812fc` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| functionals | Concurrency Parallelism | [open](r-functionals-a5f00b26.md) |
