...
| Canonical URL | [https://crates.io/crates/Poem](https://crates.io/crates/Poem) |
| Source record ids | corpus-e10b6c8aa8eb6d |
...
For a systems engineer, Poem belongs in the Rust inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.12 | 2025-07-28T04:39:14.775671Z | [https://crates.io/api/v1/crates/Poem](https://crates.io/api/v1/crates/Poem) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/Poem` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-e10b6c8aa8eb6d` from `master_json` as `web_framework`
