...
| Canonical URL | [https://github.com/NVIDIA-Omniverse/PhysX](https://github.com/NVIDIA-Omniverse/PhysX) |
| Source record ids | curated_language_routes-b415477b6a41a4 |

## System Engineer Summary

Physics simulation SDK for rigid bodies, collision, vehicles, particles, and real-time simulation
workloads.

## Operational Role

For a systems engineer, NVIDIA PhysX belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | ovphysx-0.5.11 | 2026-08-28T09:06:55Z | [https://api.github.com/repos/NVIDIA-Omniverse/PhysX/releases/latest](https://api.github.com/repos/NVIDIA-Omniverse/PhysX/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/NVIDIA-Omniverse/PhysX/releases/latest` at `2026-09-01T07:24:41+00:00`.
...
- `curated_language_routes-b415477b6a41a4` from `curated_language_routes` as `registry_expansion`
