...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/parthmax2/genai-starter-pack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/parthmax2/genai-starter-pack](https://github.com/parthmax2/genai-starter-pack) |
| Source record ids | github_search_space_maps-fba6748c2496b3 |

## System Engineer Summary

Curated catalog and dataset of 50 cloneable GenAI apps and Hugging Face Spaces across RAG, AI
agents, LangGraph, MCP, and more

## Operational Role

For a systems engineer, parthmax2/genai-starter-pack belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-20T08:56:38Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-fba6748c2496b3` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashwith/pyMOSChar | Project Scaffolding | [open](space-maps-ashwith-pymoschar-60053eb3.md) |
| d-wwei/CC-Codex-Gemini-companion-starter | Project Scaffolding | [open](space-maps-d-wwei-cc-codex-gemini-companion-starter-244fd72c.md) |
| greglobinski/gatsby-starter-mini-catalog | Project Scaffolding | [open](space-maps-greglobinski-gatsby-starter-mini-catalog-6fffbf07.md) |
| IBM-Cloud/watson-starter-apps | Project Scaffolding | [open](space-maps-ibm-cloud-watson-starter-apps-8269d634.md) |
| johnpolacek/styled-starter | Project Scaffolding | [open](space-maps-johnpolacek-styled-starter-213f2daf.md) |
| johnpolacek/styled-starter-basic | Project Scaffolding | [open](space-maps-johnpolacek-styled-starter-basic-483af579.md) |
| maximus0411/BorisChernyClaudeMarkdown | Project Scaffolding | [open](space-maps-maximus0411-borischernyclaudemarkdown-88d34dbb.md) |
| MohirM/game-catalog-starter | Project Scaffolding | [open](space-maps-mohirm-game-catalog-starter-90f2ab48.md) |
