# kong-plugin-api-gateway-jurnal
...
| Canonical URL | [https://luarocks.org/modules/engineering-jurnal/kong-plugin-api-gateway-jurnal](https://luarocks.org/modules/engineering-jurnal/kong-plugin-api-gateway-jurnal) |
| Source record ids | luarocks_root_manifest-469966afa6238f |

## System Engineer Summary

This plugin is used to inject access token to header for each request to the upstream service

## Operational Role

For a systems engineer, kong-plugin-api-gateway-jurnal belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-469966afa6238f` from `luarocks_root_manifest` as `registry_expansion`
