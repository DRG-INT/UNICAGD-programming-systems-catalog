...
| Source record ids | corpus-99212f8b992a5b |

## System Engineer Summary

FreeRTOS is tracked as an embedded hardware record in the C99 branch. The source did not provide a
...
For a systems engineer, FreeRTOS belongs in the C99 inventory as part of device constraints, cross-
...
- `corpus-99212f8b992a5b` from `master_json` as `embedded_hardware`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CMSIS | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-cmsis-780237b3.md) |
| lwIP | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-lwip-230d001c.md) |
| Zephyr C APIs | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-zephyr-c-apis-5e3b9477.md) |
