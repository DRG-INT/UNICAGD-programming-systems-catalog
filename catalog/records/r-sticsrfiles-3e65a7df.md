...
<!-- canonical: https://cran.r-project.org/web/packages/SticsRFiles/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SticsRFiles/index.html](https://cran.r-project.org/web/packages/SticsRFiles/index.html) |
| Source record ids | cran_packages_by_date-5f5245cf4e8177 |
...
For a systems engineer, SticsRFiles belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-09-14 22:40:09 UTC | [https://cran.r-project.org/web/packages/SticsRFiles/DESCRIPTION](https://cran.r-project.org/web/packages/SticsRFiles/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SticsRFiles/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-5f5245cf4e8177` from `cran_packages_by_date` as `registry_expansion`
