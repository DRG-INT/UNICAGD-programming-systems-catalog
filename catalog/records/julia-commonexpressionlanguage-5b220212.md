...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CommonExpressionLanguage](https://github.com/JuliaRegistries/General/tree/master/C/CommonExpressionLanguage) |
| Source record ids | julia_general-2b6bf8ea2e8403 |

## System Engineer Summary

Julia package registered in General at C/CommonExpressionLanguage.

## Operational Role

For a systems engineer, CommonExpressionLanguage belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| AdvancedEncryptionStandard | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-advancedencryptionstandard-e5b00256.md) |
| Birch_Standard_jll | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-birch-standard-jll-3cd4f324.md) |
| Julia | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-julia-dee19b6c.md) |
