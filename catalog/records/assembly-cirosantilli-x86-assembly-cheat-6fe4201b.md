...
<!-- canonical: https://github.com/cirosantilli/x86-assembly-cheat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cirosantilli/x86-assembly-cheat](https://github.com/cirosantilli/x86-assembly-cheat) |
| Source record ids | github_search_assembly-6db95e5743d88f |

## System Engineer Summary

MOVED TO: with code at SEE README. x86 IA-32 and x86-64 userland minimal examples tutorial. Hundreds
of runnable asserts. Nice GDB setup. IO done with libc, so OS portable in theory. NASM and GAS
covered. Tested in Ubuntu 18.04. Containers (ELF), linking, calling conventions. System land cheat
at: ARM cheat at: 移至： x86 IA-32和x86-64 userland最少示例教程。 数百个可运行的断言。 好的GDB设置。
IO是用libc完成的，因此OS在理论上是可移植的。 涵盖了NASM和GAS。 在Ubuntu 18.04中测试。 容器（ELF），链接，调用约定。
系统土地作弊网址：https：//github.com/cirosantilli/x86-bare-metal-
examples，ARM作弊网址：https：//github.com/cirosantilli/arm-assembly-cheat

## Operational Role

For a systems engineer, cirosantilli/x86-assembly-cheat belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-25T18:10:23Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_assembly-6db95e5743d88f` from `github_search_assembly` as `registry_expansion`
