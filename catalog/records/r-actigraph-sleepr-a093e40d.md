...
<!-- canonical: https://cran.r-project.org/web/packages/actigraph.sleepr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/actigraph.sleepr/index.html](https://cran.r-project.org/web/packages/actigraph.sleepr/index.html) |
| Source record ids | cran_packages_by_date-ff32a202410578 |

## System Engineer Summary

Detect Periods of Sleep and Non-Wear in 'ActiGraph' Data

## Operational Role

For a systems engineer, actigraph.sleepr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-12 14:50:08 UTC | [https://cran.r-project.org/web/packages/actigraph.sleepr/DESCRIPTION](https://cran.r-project.org/web/packages/actigraph.sleepr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/actigraph.sleepr/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-ff32a202410578` from `cran_packages_by_date` as `registry_expansion`
