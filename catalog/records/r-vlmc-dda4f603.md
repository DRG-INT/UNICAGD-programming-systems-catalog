...
<!-- canonical: https://cran.r-project.org/web/packages/VLMC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/VLMC/index.html](https://cran.r-project.org/web/packages/VLMC/index.html) |
| Source record ids | cran_packages_by_date-0ad36d1dcc6064 |
...
For a systems engineer, VLMC belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4-6 | 2026-09-05 21:40:02 UTC | [https://cran.r-project.org/web/packages/VLMC/DESCRIPTION](https://cran.r-project.org/web/packages/VLMC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/VLMC/DESCRIPTION` at `2026-09-05T22:17:45+00:00`.
...
- `cran_packages_by_date-0ad36d1dcc6064` from `cran_packages_by_date` as `registry_expansion`
