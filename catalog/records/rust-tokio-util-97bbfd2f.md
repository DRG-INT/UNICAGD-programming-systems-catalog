...
<!-- canonical: https://crates.io/crates/tokio-util -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-util](https://crates.io/crates/tokio-util) |
| Source record ids | crates_io-8481769a137f6d |
...
For a systems engineer, tokio-util belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.19 | 2026-07-21T12:10:46.915710Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-8481769a137f6d` from `crates_io` as `registry_expansion`
