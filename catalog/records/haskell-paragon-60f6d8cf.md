...
<!-- canonical: https://hackage.haskell.org/package/paragon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/paragon](https://hackage.haskell.org/package/paragon) |
| Source record ids | hackage_top_downloads-5e809992875202 |
...
For a systems engineer, paragon belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.28 | 2012-07-11T07:47:29Z | [https://hackage.haskell.org/package/paragon](https://hackage.haskell.org/package/paragon) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/paragon` at `2026-09-09T00:35:08+00:00`.
...
- `hackage_top_downloads-5e809992875202` from `hackage_top_downloads` as `registry_expansion`
