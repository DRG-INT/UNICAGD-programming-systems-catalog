...
| Canonical URL | [https://luarocks.org/modules/mrcjkb/haskell-tools.nvim](https://luarocks.org/modules/mrcjkb/haskell-tools.nvim) |
| Source record ids | luarocks_root_manifest-0952496bdcb611 |
...
For a systems engineer, haskell-tools.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0952496bdcb611` from `luarocks_root_manifest` as `registry_expansion`
