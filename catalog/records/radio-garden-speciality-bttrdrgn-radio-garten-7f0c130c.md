# BttrDrgn/radio.garten

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Radio Garden Speciality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/radio-garden-speciality.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/BttrDrgn/radio.garten](https://github.com/BttrDrgn/radio.garten) |
| Source record ids | curated_language_routes-0c4f6a51341f88 |

## System Engineer Summary

MIT C++ desktop client and overlay route; cataloged as cautionary because its README reports it no
longer works after a Radio Garden API update.

## Operational Role

For a systems engineer, BttrDrgn/radio.garten belongs in the Radio Garden Speciality inventory as
...
- `curated_language_routes-0c4f6a51341f88` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| antoninadert/Radio-Garden-Client | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-antoninadert-radio-garden-client-ca058555.md) |
| chermenin/radio.G | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-chermenin-radio-g-360dc3fc.md) |
| Radio Garden Web App | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-radio-garden-web-app-5918e0b0.md) |
