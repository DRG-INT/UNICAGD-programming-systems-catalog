...
<!-- canonical: https://github.com/enkimute/hdrpng.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/enkimute/hdrpng.js](https://github.com/enkimute/hdrpng.js) |
| Source record ids | github_search_photography-a8ba5778b61f78 |

## System Engineer Summary

:high_brightness: High Dynamic Range image support for the web. (HTML, canvas & webGL) Used for HDR
support in the official Khronos glTF examples.

## Operational Role

For a systems engineer, enkimute/hdrpng.js belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-30T08:14:07Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a8ba5778b61f78` from `github_search_photography` as `registry_expansion`
