...
<!-- canonical: https://github.com/camunda/camunda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/camunda/camunda](https://github.com/camunda/camunda) |
| Source record ids | github_search_engines-5dbbc78889dd3b |
...
For a systems engineer, camunda/camunda belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:21:32Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-5dbbc78889dd3b` from `github_search_engines` as `registry_expansion`
