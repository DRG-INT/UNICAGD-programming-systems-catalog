...
<!-- canonical: https://pub.dev/packages/tray_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/tray_manager](https://pub.dev/packages/tray_manager) |
| Source record ids | pub_dev-40e481fa1d426a |
...
For a systems engineer, tray_manager belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2026-06-09T15:41:51.594509Z | [https://pub.dev/api/packages/tray_manager](https://pub.dev/api/packages/tray_manager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/tray_manager` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-40e481fa1d426a` from `pub_dev` as `registry_expansion`
