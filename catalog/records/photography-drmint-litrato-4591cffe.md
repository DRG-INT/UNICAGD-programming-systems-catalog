...
<!-- canonical: https://github.com/DrMint/Litrato -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DrMint/Litrato](https://github.com/DrMint/Litrato) |
| Source record ids | github_search_photography-158d0bdf337adb |

## System Engineer Summary

Android photo editing app with various filters and tools. Included advanced features like masking,
histogram, color picker, EXIF viewer...

## Operational Role

For a systems engineer, DrMint/Litrato belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-30T12:58:52Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-158d0bdf337adb` from `github_search_photography` as `registry_expansion`
