...
<!-- canonical: https://cran.r-project.org/web/packages/blockCV/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/blockCV/index.html](https://cran.r-project.org/web/packages/blockCV/index.html) |
| Source record ids | cran_packages_by_date-deeb3a44e59265 |
...
For a systems engineer, blockCV belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0-0 | 2026-08-20 11:12:25 UTC | [https://cran.r-project.org/web/packages/blockCV/DESCRIPTION](https://cran.r-project.org/web/packages/blockCV/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/blockCV/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-deeb3a44e59265` from `cran_packages_by_date` as `registry_expansion`
