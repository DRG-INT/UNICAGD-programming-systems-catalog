# Gitea: Gangavarapu/BOA-VISA-ConfigServer
...
<!-- canonical: https://gitea.com/Gangavarapu/BOA-VISA-ConfigServer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Gangavarapu/BOA-VISA-ConfigServer](https://gitea.com/Gangavarapu/BOA-VISA-ConfigServer) |
| Source record ids | gitea_repositories_api-aa8a617d3c23a5 |
...
For a systems engineer, Gitea: Gangavarapu/BOA-VISA-ConfigServer belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-14T06:00:34Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-aa8a617d3c23a5` from `gitea_repositories_api` as `registry_expansion`
