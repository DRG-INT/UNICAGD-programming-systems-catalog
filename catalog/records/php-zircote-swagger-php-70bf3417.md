...
<!-- canonical: https://packagist.org/packages/zircote/swagger-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zircote/swagger-php](https://packagist.org/packages/zircote/swagger-php) |
| Source record ids | packagist_search-ce7ea65dee4315 |

## System Engineer Summary

Generate interactive documentation for your RESTful API using PHP attributes (preferred) or PHPDoc
annotations

## Operational Role

For a systems engineer, zircote/swagger-php belongs in the PHP inventory as part of operator
...
- `packagist_search-ce7ea65dee4315` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| zendesk/zendesk_api_client_php | Documentation | [open](php-zendesk-zendesk-api-client-php-b7dfb3ab.md) |
