...
<!-- canonical: https://www.nuget.org/packages/Serilog.Sinks.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Serilog.Sinks.Http](https://www.nuget.org/packages/Serilog.Sinks.Http) |
| Source record ids | nuget_search-d570fbaaa5412f |
...
For a systems engineer, Serilog.Sinks.Http belongs in the C-Sharp inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.2.1 | 2026-01-03T08:22:48.43+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.sinks.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.sinks.http/index.json) |  |
| preview | known | 9.0.0-beta.2 | 2024-03-27T06:07:00.383+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.sinks.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.sinks.http/index.json) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Apache-2.0; https://www.nuget.org/packages/Serilog.Sinks.Http/9.2.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/serilog.sinks.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-d570fbaaa5412f` from `nuget_search` as `registry_expansion`
