...
| Canonical URL | [https://packagist.org/packages/cachewerk/relay](https://packagist.org/packages/cachewerk/relay) |
| Source record ids | packagist_search-48b881dec7cf19 |

## System Engineer Summary

The fastest Redis client for PHP. 100× faster cache reads, near-zero bandwidth, no code changes
required.

## Operational Role

For a systems engineer, cachewerk/relay belongs in the PHP inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.40.0 | 2026-07-28T17:37:52+00:00 | [https://repo.packagist.org/p2/cachewerk/relay.json](https://repo.packagist.org/p2/cachewerk/relay.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cachewerk/relay.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-48b881dec7cf19` from `packagist_search` as `registry_expansion`
