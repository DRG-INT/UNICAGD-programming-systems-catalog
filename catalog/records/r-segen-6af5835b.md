...
<!-- canonical: https://cran.r-project.org/web/packages/segen/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/segen/index.html](https://cran.r-project.org/web/packages/segen/index.html) |
| Source record ids | cran_packages_by_date-949cd9259906b1 |
...
For a systems engineer, segen belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-09-07 17:40:02 UTC | [https://cran.r-project.org/web/packages/segen/DESCRIPTION](https://cran.r-project.org/web/packages/segen/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/segen/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-949cd9259906b1` from `cran_packages_by_date` as `registry_expansion`
