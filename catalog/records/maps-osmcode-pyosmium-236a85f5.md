...
<!-- canonical: https://github.com/osmcode/pyosmium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osmcode/pyosmium](https://github.com/osmcode/pyosmium) |
| Source record ids | github_search_maps-19c6b604ab5662 |
...
For a systems engineer, osmcode/pyosmium belongs in the Maps inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-02T09:28:31Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-19c6b604ab5662` from `github_search_maps` as `registry_expansion`
