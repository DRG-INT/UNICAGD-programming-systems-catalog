# Gitea: DongHyeokChoi/DATABASE-PROJECT
...
<!-- canonical: https://gitea.com/DongHyeokChoi/DATABASE-PROJECT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/DongHyeokChoi/DATABASE-PROJECT](https://gitea.com/DongHyeokChoi/DATABASE-PROJECT) |
| Source record ids | gitea_repositories_api-6cfa830bf6e4fe |

## System Engineer Summary

flask, mysql 기반에 강의 참여자 정보 시스템 데이터베이스 프로젝트

## Operational Role

For a systems engineer, Gitea: DongHyeokChoi/DATABASE-PROJECT belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-11T16:02:47Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6cfa830bf6e4fe` from `gitea_repositories_api` as `registry_expansion`
