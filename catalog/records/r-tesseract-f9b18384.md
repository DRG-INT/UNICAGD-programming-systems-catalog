...
<!-- canonical: https://cran.r-project.org/web/packages/tesseract/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tesseract/index.html](https://cran.r-project.org/web/packages/tesseract/index.html) |
| Source record ids | cran_packages_by_date-b47cc66fc1c834 |

## System Engineer Summary

tesseract is tracked as a game engine game dev record in the R branch. The source did not provide a
...
For a systems engineer, tesseract belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.0 | 2026-09-04 21:30:02 UTC | [https://cran.r-project.org/web/packages/tesseract/DESCRIPTION](https://cran.r-project.org/web/packages/tesseract/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tesseract/DESCRIPTION` at `2026-09-04T22:18:17+00:00`.
...
- `cran_packages_by_date-b47cc66fc1c834` from `cran_packages_by_date` as `registry_expansion`
