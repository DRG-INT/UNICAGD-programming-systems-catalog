...
<!-- canonical: https://cran.r-project.org/web/packages/ORCI.Welch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ORCI.Welch/index.html](https://cran.r-project.org/web/packages/ORCI.Welch/index.html) |
| Source record ids | cran_packages_by_date-20ff03d6ad4b37 |

## System Engineer Summary

Approximate Odds Ratio Confidence Intervals with Welch's Adjustments

## Operational Role

For a systems engineer, ORCI.Welch belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-27 10:00:12 UTC | [https://cran.r-project.org/web/packages/ORCI.Welch/DESCRIPTION](https://cran.r-project.org/web/packages/ORCI.Welch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ORCI.Welch/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-20ff03d6ad4b37` from `cran_packages_by_date` as `registry_expansion`
