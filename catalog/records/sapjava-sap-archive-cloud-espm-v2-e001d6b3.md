...
<!-- canonical: https://github.com/SAP-archive/cloud-espm-v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-archive/cloud-espm-v2](https://github.com/SAP-archive/cloud-espm-v2) |
| Source record ids | github_search_sapjava-d2fdb3e7a2b475 |

## System Engineer Summary

This sample is a reference application project, showcasing an end-to-end development scenario for a
Java-based app on SAP BTP. The app has a SAPUI5 web frontend, uses OData to connect to a Java-based
cloud backend which in turn connects via JPA to an SAP HANA DB in the cloud.

## Operational Role

For a systems engineer, SAP-archive/cloud-espm-v2 belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1 | 2017-05-08T14:15:12Z | [https://api.github.com/repos/SAP-archive/cloud-espm-v2/releases/latest](https://api.github.com/repos/SAP-archive/cloud-espm-v2/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SAP-archive/cloud-espm-v2/releases/latest` at `2026-09-01T10:25:36+00:00`.
...
- `github_search_sapjava-d2fdb3e7a2b475` from `github_search_sapjava` as `registry_expansion`
