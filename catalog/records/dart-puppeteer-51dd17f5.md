...
<!-- canonical: https://pub.dev/packages/puppeteer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/puppeteer](https://pub.dev/packages/puppeteer) |
| Source record ids | pub_dev-f1a380e85376ac |

## System Engineer Summary

A high-level API to control headless Chrome over the DevTools Protocol. This is a port of Puppeteer
in Dart.

## Operational Role

For a systems engineer, puppeteer belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.26.0 | 2026-08-13T10:31:00.188058Z | [https://pub.dev/api/packages/puppeteer](https://pub.dev/api/packages/puppeteer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/puppeteer` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-f1a380e85376ac` from `pub_dev` as `registry_expansion`
