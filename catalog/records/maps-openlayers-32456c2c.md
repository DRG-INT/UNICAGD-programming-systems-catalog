...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/maps.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/openlayers/openlayers](https://github.com/openlayers/openlayers) |
| Source record ids | curated_language_routes-6a8160df8766b1 |

## System Engineer Summary

Web mapping library for raster/vector layers, projections, controls, formats, and geospatial
interactions.

## Operational Role

For a systems engineer, OpenLayers belongs in the Maps inventory as part of ecosystem capability
...
- `curated_language_routes-6a8160df8766b1` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Leaflet | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/maps-leaflet-f474f068.md) |
| MapLibre GL JS | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/maps-maplibre-gl-js-998d9403.md) |
| QGIS | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/maps-qgis-23704893.md) |
