...
<!-- canonical: https://github.com/tucktuckg00se/INTERSECT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tucktuckg00se/INTERSECT](https://github.com/tucktuckg00se/INTERSECT) |
| Source record ids | github_search_audio-7de9c5ba7d1c52 |

## System Engineer Summary

A nondestructive, time-stretching, and intersecting sample slicer plugin with independent per-slice
parameter control.

## Operational Role

For a systems engineer, tucktuckg00se/INTERSECT belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-25T09:05:24Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-7de9c5ba7d1c52` from `github_search_audio` as `registry_expansion`
