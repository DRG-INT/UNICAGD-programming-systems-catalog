...
| Canonical URL | [https://github.com/TadasBaltrusaitis/OpenFace](https://github.com/TadasBaltrusaitis/OpenFace) |
| Source record ids | github_search_matlab-a39d024ab63fe3 |

## System Engineer Summary

OpenFace – a state-of-the art tool intended for facial landmark detection, head pose estimation,
facial action unit recognition, and eye-gaze estimation.

## Operational Role

For a systems engineer, TadasBaltrusaitis/OpenFace belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | OpenFace_2.2.0 | 2019-07-13T18:23:41Z | [https://api.github.com/repos/TadasBaltrusaitis/OpenFace/releases/latest](https://api.github.com/repos/TadasBaltrusaitis/OpenFace/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/TadasBaltrusaitis/OpenFace/releases/latest` at `2026-09-01T07:24:14+00:00`.
...
- `github_search_matlab-a39d024ab63fe3` from `github_search_matlab` as `registry_expansion`
