...
| Canonical URL | [https://hackage.haskell.org/package/secretspec](https://hackage.haskell.org/package/secretspec) |
| Source record ids | hackage_recent-1f69dbd7dfac1e |
...
For a systems engineer, secretspec belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.0 | 2026-08-31T18:05:39Z | [https://hackage.haskell.org/package/secretspec](https://hackage.haskell.org/package/secretspec) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/secretspec` at `2026-09-01T07:24:08+00:00`.
...
- `hackage_recent-1f69dbd7dfac1e` from `hackage_recent` as `registry_expansion`
