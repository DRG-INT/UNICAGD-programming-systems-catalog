...
<!-- canonical: https://cran.r-project.org/web/packages/galamm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/galamm/index.html](https://cran.r-project.org/web/packages/galamm/index.html) |
| Source record ids | cran_packages_by_date-19dc90e9b0c41a |
...
For a systems engineer, galamm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-31 19:00:11 UTC | [https://cran.r-project.org/web/packages/galamm/DESCRIPTION](https://cran.r-project.org/web/packages/galamm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/galamm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-19dc90e9b0c41a` from `cran_packages_by_date` as `registry_expansion`
