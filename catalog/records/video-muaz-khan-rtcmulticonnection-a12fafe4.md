...
<!-- canonical: https://github.com/muaz-khan/RTCMultiConnection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/muaz-khan/RTCMultiConnection](https://github.com/muaz-khan/RTCMultiConnection) |
| Source record ids | github_search_video-b358824031a108 |

## System Engineer Summary

RTCMultiConnection is a WebRTC JavaScript library for peer-to-peer applications (screen sharing,
audio/video conferencing, file sharing, media streaming etc.)

## Operational Role

For a systems engineer, muaz-khan/RTCMultiConnection belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-06T15:25:02Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-b358824031a108` from `github_search_video` as `registry_expansion`
