...
<!-- canonical: https://github.com/Jacob-creator-2/Solar-system -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jacob-creator-2/Solar-system](https://github.com/Jacob-creator-2/Solar-system) |
| Source record ids | github_search_space_maps-56d0acb0cd90f7 |

## System Engineer Summary

Solar System 3D Simulation: A realistic 3D solar system visualization with accurate planetary
orbits, scaled sizes, and texture-mapped planets. Features include interactive camera controls,
adjustable rotation speeds, visible orbital paths, Earth's orbiting moon, and local texture support
for high-resolution planetary surfaces.

## Operational Role

For a systems engineer, Jacob-creator-2/Solar-system belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T21:31:37Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-56d0acb0cd90f7` from `github_search_space_maps` as `registry_expansion`
