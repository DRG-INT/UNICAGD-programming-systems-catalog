...
<!-- canonical: https://github.com/jsonmodel/jsonmodel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jsonmodel/jsonmodel](https://github.com/jsonmodel/jsonmodel) |
| Source record ids | github_search_cocoa-cdebe05c2344bb |

## System Engineer Summary

Magical Data Modeling Framework for JSON - allows rapid creation of smart data models. You can use
it in your iOS, macOS, watchOS and tvOS apps.

## Operational Role

For a systems engineer, jsonmodel/jsonmodel belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-06T12:23:36Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-cdebe05c2344bb` from `github_search_cocoa` as `registry_expansion`
