...
| Canonical URL | [https://luarocks.org/modules/neorocks/icon-picker.nvim](https://luarocks.org/modules/neorocks/icon-picker.nvim) |
| Source record ids | luarocks_root_manifest-b47adb1e52359d |
...
For a systems engineer, icon-picker.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b47adb1e52359d` from `luarocks_root_manifest` as `registry_expansion`
