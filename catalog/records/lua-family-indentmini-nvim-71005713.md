...
| Canonical URL | [https://luarocks.org/modules/neorocks/indentmini.nvim](https://luarocks.org/modules/neorocks/indentmini.nvim) |
| Source record ids | luarocks_root_manifest-0f35f7e39c1136 |
...
For a systems engineer, indentmini.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0f35f7e39c1136` from `luarocks_root_manifest` as `registry_expansion`
