...
<!-- canonical: https://cran.r-project.org/web/packages/stratigraphr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stratigraphr/index.html](https://cran.r-project.org/web/packages/stratigraphr/index.html) |
| Source record ids | cran_packages_by_date-1a30e43398acea |

## System Engineer Summary

Archaeological Stratigraphy and Chronological Sequences

## Operational Role

For a systems engineer, stratigraphr belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-12 13:50:02 UTC | [https://cran.r-project.org/web/packages/stratigraphr/DESCRIPTION](https://cran.r-project.org/web/packages/stratigraphr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stratigraphr/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-1a30e43398acea` from `cran_packages_by_date` as `registry_expansion`
