...
<!-- canonical: https://hackage.haskell.org/package/OpenGLRaw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/OpenGLRaw](https://hackage.haskell.org/package/OpenGLRaw) |
| Source record ids | hackage_top_downloads-89e93a437776cb |
...
For a systems engineer, OpenGLRaw belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.4.1 | 2021-11-14T15:29:03Z | [https://hackage.haskell.org/package/OpenGLRaw](https://hackage.haskell.org/package/OpenGLRaw) |  |
| candidate | partial | 1.5.0.0 |  | [https://hackage.haskell.org/package/OpenGLRaw](https://hackage.haskell.org/package/OpenGLRaw) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/OpenGLRaw` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-89e93a437776cb` from `hackage_top_downloads` as `registry_expansion`
