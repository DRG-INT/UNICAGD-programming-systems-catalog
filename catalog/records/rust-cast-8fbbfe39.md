...
<!-- canonical: https://crates.io/crates/cast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cast](https://crates.io/crates/cast) |
| Source record ids | crates_io-25d0a6e7a78623 |
...
For a systems engineer, cast belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2021-09-04T11:07:33.449935Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-25d0a6e7a78623` from `crates_io` as `registry_expansion`
