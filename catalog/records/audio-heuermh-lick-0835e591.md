...
<!-- canonical: https://github.com/heuermh/lick -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/heuermh/lick](https://github.com/heuermh/lick) |
| Source record ids | github_search_audio-aa661aa441615a |

## System Engineer Summary

heuermh/lick is tracked as a library record in the Audio branch. The source did not provide a long
...
For a systems engineer, heuermh/lick belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-05T18:33:36Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-aa661aa441615a` from `github_search_audio` as `registry_expansion`
