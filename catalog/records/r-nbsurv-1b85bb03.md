...
<!-- canonical: https://cran.r-project.org/web/packages/nbsurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nbsurv/index.html](https://cran.r-project.org/web/packages/nbsurv/index.html) |
| Source record ids | cran_packages_by_date-4d2998093a059f |
...
For a systems engineer, nbsurv belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-09-11 12:50:02 UTC | [https://cran.r-project.org/web/packages/nbsurv/DESCRIPTION](https://cran.r-project.org/web/packages/nbsurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nbsurv/DESCRIPTION` at `2026-09-11T14:23:14+00:00`.
...
- `cran_packages_by_date-4d2998093a059f` from `cran_packages_by_date` as `registry_expansion`
