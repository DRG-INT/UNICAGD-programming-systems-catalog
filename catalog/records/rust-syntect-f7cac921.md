...
| Canonical URL | [https://crates.io/crates/syntect](https://crates.io/crates/syntect) |
| Source record ids | crates_io-37ec7037e64c13 |
...
For a systems engineer, syntect belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.0 | 2025-09-27T11:22:43.779471Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-37ec7037e64c13` from `crates_io` as `registry_expansion`
