...
<!-- canonical: https://cran.r-project.org/web/packages/PNC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PNC/index.html](https://cran.r-project.org/web/packages/PNC/index.html) |
| Source record ids | cran_packages_by_date-e404f1dd88d971 |

## System Engineer Summary

Evaluating Phylogeny as a Proxy for Ecological Similarity

## Operational Role

For a systems engineer, PNC belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-29 10:40:02 UTC | [https://cran.r-project.org/web/packages/PNC/DESCRIPTION](https://cran.r-project.org/web/packages/PNC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PNC/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e404f1dd88d971` from `cran_packages_by_date` as `registry_expansion`
