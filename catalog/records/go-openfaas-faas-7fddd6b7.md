...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/openfaas/faas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openfaas/faas](https://github.com/openfaas/faas) |
| Source record ids | github_search_go-94ff5eaa902dc1 |
...
For a systems engineer, openfaas/faas belongs in the Go inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T09:09:13Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-94ff5eaa902dc1` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| JGLTechnologies/gin-rate-limit | Web Framework | [open](go-jgltechnologies-gin-rate-limit-c93a4f16.md) |
