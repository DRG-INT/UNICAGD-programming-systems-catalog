...
<!-- canonical: https://github.com/gazebosim/gz-physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gazebosim/gz-physics](https://github.com/gazebosim/gz-physics) |
| Source record ids | github_search_physics_engines-ff07f27bf4eafd |

## System Engineer Summary

Abstract physics interface designed to support simulation and rapid development of robot
applications.

## Operational Role

For a systems engineer, gazebosim/gz-physics belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T19:43:58Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-ff07f27bf4eafd` from `github_search_physics_engines` as `registry_expansion`
...
| LuizZak/JelloSwift | Filesystem Os | [open](physics-engines-luizzak-jelloswift-2f03d173.md) |
