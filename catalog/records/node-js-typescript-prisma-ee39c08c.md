...
| Source record ids | corpus-2bfd41189e78f4 |

## System Engineer Summary

Prisma is tracked as a database datastore record in the Node.js/TypeScript branch. The source did
...
For a systems engineer, Prisma belongs in the Node.js/TypeScript inventory as part of state
...
- `corpus-2bfd41189e78f4` from `master_json` as `database_datastore`
