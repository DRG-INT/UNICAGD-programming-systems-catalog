...
<!-- canonical: https://github.com/thedotmack/claude-mem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) |
| Source record ids | github_search_databases-4964ec531a70e1 |

## System Engineer Summary

Persistent Context Across Sessions for Every Agent – Captures everything your agent does during
sessions, compresses it with AI, and injects relevant context back into future sessions. Works with
Claude Code, OpenClaw, Codex, Gemini, Hermes, Copilot, OpenCode + More

## Operational Role

For a systems engineer, thedotmack/claude-mem belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:13:59Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4964ec531a70e1` from `github_search_databases` as `registry_expansion`
