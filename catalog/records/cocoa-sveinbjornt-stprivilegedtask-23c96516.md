...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sveinbjornt/STPrivilegedTask -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sveinbjornt/STPrivilegedTask](https://github.com/sveinbjornt/STPrivilegedTask) |
| Source record ids | github_search_cocoa-77778ffcfbbf4a |

## System Engineer Summary

An NSTask-like wrapper around the macOS Security Framework's AuthorizationExecuteWithPrivileges
function to run shell commands with root privileges in Objective-C / Cocoa.

## Operational Role

For a systems engineer, sveinbjornt/STPrivilegedTask belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-06T13:18:15Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-77778ffcfbbf4a` from `github_search_cocoa` as `registry_expansion`
