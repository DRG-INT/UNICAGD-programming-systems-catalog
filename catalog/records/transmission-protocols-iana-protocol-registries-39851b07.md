...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Transmission Protocols](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/transmission-protocols.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.iana.org/protocols](https://www.iana.org/protocols) |
| Source record ids | curated_language_routes-27e0d2421c0f5e |

## System Engineer Summary

Official protocol parameter registries for ports, numbers, media types, DNS, routing, and transport
assignments.

## Operational Role

For a systems engineer, IANA Protocol Registries belongs in the Transmission Protocols inventory as
...
- `curated_language_routes-27e0d2421c0f5e` from `curated_language_routes` as `registry_expansion`
