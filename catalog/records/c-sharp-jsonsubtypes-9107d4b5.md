...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/JsonSubTypes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonSubTypes](https://www.nuget.org/packages/JsonSubTypes) |
| Source record ids | nuget_search-ed49ebfde334c1 |
...
For a systems engineer, JsonSubTypes belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-11T19:30:38.86+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonsubtypes/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonsubtypes/index.json) |  |
| preview/nightly | unknown |  |  | unknown | nuget_preview_version_missing |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonsubtypes/index.json` at `2026-09-01T07:23:57+00:00`.
- Preview/nightly metadata is unknown because `nuget_preview_version_missing`.
...
- `nuget_search-ed49ebfde334c1` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Microsoft.AspNetCore.Http.Connections.Client | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-http-connections-client-477eb4d4.md) |
| Microsoft.AspNetCore.Http.Connections.Common | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-http-connections-common-5f4caac9.md) |
| Microsoft.AspNetCore.Http.Features | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-http-features-22a815ff.md) |
| Microsoft.AspNetCore.JsonPatch | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-jsonpatch-7d9fb127.md) |
| Microsoft.AspNetCore.SignalR.Protocols.Json | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-signalr-protocols-json-ea5be4bc.md) |
| Microsoft.AspNetCore.SignalR.Protocols.NewtonsoftJson | Undefined Behavior Analyzer | [open](c-sharp-microsoft-aspnetcore-signalr-protocols-newtonsoftjson-84ffc2c5.md) |
| Microsoft.Extensions.Http.Polly | Undefined Behavior Analyzer | [open](c-sharp-microsoft-extensions-http-polly-3d8d13fd.md) |
| Microsoft.Net.Http.Headers | Undefined Behavior Analyzer | [open](c-sharp-microsoft-net-http-headers-73c61253.md) |
