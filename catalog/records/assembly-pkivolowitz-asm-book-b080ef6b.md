...
<!-- canonical: https://github.com/pkivolowitz/asm_book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pkivolowitz/asm_book](https://github.com/pkivolowitz/asm_book) |
| Source record ids | github_search_assembly-d90ebb73db2af7 |

## System Engineer Summary

A book teaching assembly language programming on the ARM 64 bit ISA. Along the way, good programming
practices and insights into code development are offered which apply directly to higher level
languages.

## Operational Role

For a systems engineer, pkivolowitz/asm_book belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-20T01:09:10Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-d90ebb73db2af7` from `github_search_assembly` as `registry_expansion`
