...
<!-- canonical: https://github.com/geldata/gel-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geldata/gel-js](https://github.com/geldata/gel-js) |
| Source record ids | github_search_databases-42ce05d19bb17a |
...
For a systems engineer, geldata/gel-js belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-14T14:56:34Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-42ce05d19bb17a` from `github_search_databases` as `registry_expansion`
