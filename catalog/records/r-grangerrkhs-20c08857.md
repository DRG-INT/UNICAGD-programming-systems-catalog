...
<!-- canonical: https://cran.r-project.org/web/packages/GrangerRKHS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GrangerRKHS/index.html](https://cran.r-project.org/web/packages/GrangerRKHS/index.html) |
| Source record ids | cran_packages_by_date-04e682c39296e8 |
...
For a systems engineer, GrangerRKHS belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 07:20:02 UTC | [https://cran.r-project.org/web/packages/GrangerRKHS/DESCRIPTION](https://cran.r-project.org/web/packages/GrangerRKHS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GrangerRKHS/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-04e682c39296e8` from `cran_packages_by_date` as `registry_expansion`
