...
<!-- canonical: https://pub.dev/packages/auto_injector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/auto_injector](https://pub.dev/packages/auto_injector) |
| Source record ids | pub_dev-be5c3726b598a4 |
...
For a systems engineer, auto_injector belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-06-24T01:06:01.014247Z | [https://pub.dev/api/packages/auto_injector](https://pub.dev/api/packages/auto_injector) |  |
| preview | known | 0.0.1-alpha.11 | 2023-01-26T18:34:28.207825Z | [https://pub.dev/api/packages/auto_injector](https://pub.dev/api/packages/auto_injector) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/auto_injector` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-be5c3726b598a4` from `pub_dev` as `registry_expansion`
