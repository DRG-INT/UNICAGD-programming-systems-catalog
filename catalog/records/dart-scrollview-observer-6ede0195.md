...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/scrollview_observer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/scrollview_observer](https://pub.dev/packages/scrollview_observer) |
| Source record ids | pub_dev-064b9353ff5d0a |
...
For a systems engineer, scrollview_observer belongs in the Dart inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.27.1 | 2026-08-22T08:47:37.282864Z | [https://pub.dev/api/packages/scrollview_observer](https://pub.dev/api/packages/scrollview_observer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/scrollview_observer` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-064b9353ff5d0a` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| beamer | Web Framework | [open](dart-beamer-0ac37553.md) |
| cached_query | Web Framework | [open](dart-cached-query-5a245dd8.md) |
| go_router | Web Framework | [open](dart-go-router-065a77a1.md) |
| math_expressions | Web Framework | [open](dart-math-expressions-fae133ac.md) |
| meta | Web Framework | [open](dart-meta-acd5de95.md) |
| navigation_history_observer | Web Framework | [open](dart-navigation-history-observer-07230379.md) |
| neat_periodic_task | Web Framework | [open](dart-neat-periodic-task-de71793c.md) |
| powersync | Web Framework | [open](dart-powersync-6dce0081.md) |
