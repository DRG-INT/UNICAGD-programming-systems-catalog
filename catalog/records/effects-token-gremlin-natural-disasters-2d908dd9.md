# Token-Gremlin/natural-disasters

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Token-Gremlin/natural-disasters -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Token-Gremlin/natural-disasters](https://github.com/Token-Gremlin/natural-disasters) |
| Source record ids | github_search_effects-4d958494a8012f |

## System Engineer Summary

Fully procedural cinematic ocean and extreme weather simulation in the browser. Multi-cascade FFT
waves, volumetric clouds, hurricanes and tsunamis - every pixel generated on the GPU at runtime,
zero external assets. Three.js / WebGL2 / GLSL3.

## Operational Role

For a systems engineer, Token-Gremlin/natural-disasters belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T01:05:06Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-4d958494a8012f` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Dujltqzv/Some-Many-Books | Interpreter Runtime | [open](effects-dujltqzv-some-many-books-a48e40be.md) |
| FletchMcKee/liquid | Interpreter Runtime | [open](effects-fletchmckee-liquid-7d69f5f2.md) |
| FutureSDR/FutureSDR | Interpreter Runtime | [open](effects-futuresdr-futuresdr-6047f36b.md) |
| krazykira/VidEffects | Interpreter Runtime | [open](effects-krazykira-videffects-16e07ed0.md) |
| MasayukiSuda/ExoPlayerFilter | Interpreter Runtime | [open](effects-masayukisuda-exoplayerfilter-37832e26.md) |
| microsoft/FX11 | Interpreter Runtime | [open](effects-microsoft-fx11-b8bd6534.md) |
