...
| Canonical URL | [https://crates.io/crates/winsafe](https://crates.io/crates/winsafe) |
| Source record ids | crates_io-f1957527d2bccf |
...
For a systems engineer, winsafe belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.28 | 2026-07-01T15:15:19.234320Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-f1957527d2bccf` from `crates_io` as `registry_expansion`
