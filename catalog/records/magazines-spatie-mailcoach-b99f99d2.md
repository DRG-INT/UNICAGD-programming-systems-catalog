...
<!-- canonical: https://github.com/spatie/Mailcoach -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spatie/Mailcoach](https://github.com/spatie/Mailcoach) |
| Source record ids | github_search_magazines-7a835fc5b59aac |
...
For a systems engineer, spatie/Mailcoach belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-09T09:27:14Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-7a835fc5b59aac` from `github_search_magazines` as `registry_expansion`
