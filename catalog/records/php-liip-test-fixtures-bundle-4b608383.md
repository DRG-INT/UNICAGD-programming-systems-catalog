...
<!-- canonical: https://packagist.org/packages/liip/test-fixtures-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/liip/test-fixtures-bundle](https://packagist.org/packages/liip/test-fixtures-bundle) |
| Source record ids | packagist_search-8970948ea2502f |

## System Engineer Summary

This bundles enables efficient loading of Doctrine fixtures in functional test-cases for Symfony
applications

## Operational Role

For a systems engineer, liip/test-fixtures-bundle belongs in the PHP inventory as part of
...
- `packagist_search-8970948ea2502f` from `packagist_search` as `registry_expansion`
