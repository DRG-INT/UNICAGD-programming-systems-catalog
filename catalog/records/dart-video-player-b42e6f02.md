...
<!-- canonical: https://pub.dev/packages/video_player -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/video_player](https://pub.dev/packages/video_player) |
| Source record ids | pub_dev-59ac5a5684c528 |

## System Engineer Summary

Flutter plugin for displaying inline video with other Flutter widgets on Android, iOS, macOS and
web.

## Operational Role

For a systems engineer, video_player belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.14.0 | 2026-08-11T18:46:12.558899Z | [https://pub.dev/api/packages/video_player](https://pub.dev/api/packages/video_player) |  |
| preview | known | 2.0.0-nullsafety.10 | 2021-02-18T20:35:42.306357Z | [https://pub.dev/api/packages/video_player](https://pub.dev/api/packages/video_player) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/video_player` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-59ac5a5684c528` from `pub_dev` as `registry_expansion`
