...
<!-- canonical: https://cran.r-project.org/web/packages/ggExametrika/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggExametrika/index.html](https://cran.r-project.org/web/packages/ggExametrika/index.html) |
| Source record ids | cran_packages_by_date-51a303cf668f75 |
...
For a systems engineer, ggExametrika belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-21 05:43:38 UTC | [https://cran.r-project.org/web/packages/ggExametrika/DESCRIPTION](https://cran.r-project.org/web/packages/ggExametrika/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggExametrika/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-51a303cf668f75` from `cran_packages_by_date` as `registry_expansion`
