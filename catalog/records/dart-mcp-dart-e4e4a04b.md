...
<!-- canonical: https://pub.dev/packages/mcp_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mcp_dart](https://pub.dev/packages/mcp_dart) |
| Source record ids | pub_dev-716d49a58e0c5c |

## System Engineer Summary

Dart and Flutter SDK for building Model Context Protocol (MCP) servers, clients, hosts, and AI
tools.

## Operational Role

For a systems engineer, mcp_dart belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.2 | 2026-09-03T12:50:58.227944Z | [https://pub.dev/api/packages/mcp_dart](https://pub.dev/api/packages/mcp_dart) |  |
| preview | known | 2.3.0-dev.3 | 2026-07-22T14:58:30.235193Z | [https://pub.dev/api/packages/mcp_dart](https://pub.dev/api/packages/mcp_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mcp_dart` at `2026-09-03T14:21:30+00:00`.
...
- `pub_dev-716d49a58e0c5c` from `pub_dev` as `registry_expansion`
