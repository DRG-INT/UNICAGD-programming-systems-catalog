...
<!-- canonical: https://cran.r-project.org/web/packages/shapr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shapr/index.html](https://cran.r-project.org/web/packages/shapr/index.html) |
| Source record ids | cran_packages_by_date-8e3a9ccb262cf4 |
...
For a systems engineer, shapr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-11 21:00:02 UTC | [https://cran.r-project.org/web/packages/shapr/DESCRIPTION](https://cran.r-project.org/web/packages/shapr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shapr/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-8e3a9ccb262cf4` from `cran_packages_by_date` as `registry_expansion`
