...
<!-- canonical: https://www.nuget.org/packages/OpenIddict.Client.SystemNetHttp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/OpenIddict.Client.SystemNetHttp](https://www.nuget.org/packages/OpenIddict.Client.SystemNetHttp) |
| Source record ids | nuget_search-6ecb4009d2dc43 |
...
For a systems engineer, OpenIddict.Client.SystemNetHttp belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.6.1 | 2026-08-27T07:22:40.57+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/openiddict.client.systemnethttp/index.json](https://api.nuget.org/v3/registration5-gz-semver2/openiddict.client.systemnethttp/index.json) |  |
| preview | known | 8.0.0-preview.3.26427.30 | 2026-08-27T07:38:25.193+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/openiddict.client.systemnethttp/index.json](https://api.nuget.org/v3/registration5-gz-semver2/openiddict.client.systemnethttp/index.json) |  |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Apache-2.0; https://www.nuget.org/packages/OpenIddict.Client.SystemNetHttp/7.6.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/openiddict.client.systemnethttp/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-6ecb4009d2dc43` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| OpenIddict.Validation.SystemNetHttp | Security Sast | [open](c-sharp-openiddict-validation-systemnethttp-454cef37.md) |
