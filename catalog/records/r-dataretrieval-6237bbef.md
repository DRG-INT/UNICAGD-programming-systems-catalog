...
<!-- canonical: https://cran.r-project.org/web/packages/dataRetrieval/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dataRetrieval/index.html](https://cran.r-project.org/web/packages/dataRetrieval/index.html) |
| Source record ids | cran_packages_by_date-86b3e8811683db |
...
For a systems engineer, dataRetrieval belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.26 | 2026-09-11 02:10:02 UTC | [https://cran.r-project.org/web/packages/dataRetrieval/DESCRIPTION](https://cran.r-project.org/web/packages/dataRetrieval/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dataRetrieval/DESCRIPTION` at `2026-09-11T02:20:20+00:00`.
...
- `cran_packages_by_date-86b3e8811683db` from `cran_packages_by_date` as `registry_expansion`
