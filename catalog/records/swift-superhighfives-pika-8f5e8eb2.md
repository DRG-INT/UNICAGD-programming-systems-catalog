...
<!-- canonical: https://github.com/superhighfives/pika -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/superhighfives/pika](https://github.com/superhighfives/pika) |
| Source record ids | github_search_swift-f73782eddaf357 |
...
For a systems engineer, superhighfives/pika belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T02:22:40Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-f73782eddaf357` from `github_search_swift` as `registry_expansion`
