...
<!-- canonical: https://github.com/suislanchez/polygenic-risk-score-calc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/suislanchez/polygenic-risk-score-calc](https://github.com/suislanchez/polygenic-risk-score-calc) |
| Source record ids | github_search_repertoare_catalogs-abca7427c2cada |

## System Engineer Summary

Web-based Polygenic Risk Score calculator for 50+ diseases using PGS Catalog. Supports 23andMe,
AncestryDNA, VCF. Ancestry-aware normalization for EUR/AFR/EAS/SAS/AMR. By Luis Sanchez (UC
Berkeley) & Shubhankar Tripathy (Stanford).

## Operational Role

For a systems engineer, suislanchez/polygenic-risk-score-calc belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-31T14:58:36Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-abca7427c2cada` from `github_search_repertoare_catalogs` as `registry_expansion`
