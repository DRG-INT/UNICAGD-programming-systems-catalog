...
| Canonical URL | [https://crates.io/crates/serde_yml](https://crates.io/crates/serde_yml) |
| Source record ids | crates_io-0fd9872e115dc9 |

## System Engineer Summary

DEPRECATED — `serde_yml` is unmaintained. This release is a thin compatibility shim that forwards
every call to `noyalib` (a pure-Rust, `#!forbid(unsafe_code)` YAML library). Please migrate to
`noyalib`.

## Operational Role

For a systems engineer, serde_yml belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.13 | 2026-05-27T22:51:08.150617Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-0fd9872e115dc9` from `crates_io` as `registry_expansion`
