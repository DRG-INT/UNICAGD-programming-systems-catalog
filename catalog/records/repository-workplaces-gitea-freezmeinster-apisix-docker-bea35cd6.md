# Gitea: freezmeinster/apisix-docker
...
<!-- canonical: https://gitea.com/freezmeinster/apisix-docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/freezmeinster/apisix-docker](https://gitea.com/freezmeinster/apisix-docker) |
| Source record ids | gitea_repositories_api-f168d38e57cf3c |
...
For a systems engineer, Gitea: freezmeinster/apisix-docker belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-16T10:37:44Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f168d38e57cf3c` from `gitea_repositories_api` as `registry_expansion`
