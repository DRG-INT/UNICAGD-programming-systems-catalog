...
<!-- canonical: https://cran.r-project.org/web/packages/bases/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bases/index.html](https://cran.r-project.org/web/packages/bases/index.html) |
| Source record ids | cran_packages_by_date-7b3163c423c779 |
...
For a systems engineer, bases belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-04 23:10:02 UTC | [https://cran.r-project.org/web/packages/bases/DESCRIPTION](https://cran.r-project.org/web/packages/bases/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bases/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7b3163c423c779` from `cran_packages_by_date` as `registry_expansion`
