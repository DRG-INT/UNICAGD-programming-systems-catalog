...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_calendar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_calendar](https://pub.dev/packages/syncfusion_flutter_calendar) |
| Source record ids | pub_dev-203a9a8b705773 |

## System Engineer Summary

The Flutter Calendar widget has nine built-in configurable views that provide basic functionalities
for scheduling and representing appointments/events efficiently.

## Operational Role

For a systems engineer, syncfusion_flutter_calendar belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:34:39.596673Z | [https://pub.dev/api/packages/syncfusion_flutter_calendar](https://pub.dev/api/packages/syncfusion_flutter_calendar) |  |
| preview | known | 18.1.59-beta | 2020-06-23T10:48:09.698747Z | [https://pub.dev/api/packages/syncfusion_flutter_calendar](https://pub.dev/api/packages/syncfusion_flutter_calendar) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_calendar` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-203a9a8b705773` from `pub_dev` as `registry_expansion`
