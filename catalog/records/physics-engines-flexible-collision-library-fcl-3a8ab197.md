...
<!-- canonical: https://github.com/flexible-collision-library/fcl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flexible-collision-library/fcl](https://github.com/flexible-collision-library/fcl) |
| Source record ids | github_search_physics_engines-3133754253e33f |
...
For a systems engineer, flexible-collision-library/fcl belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T17:53:05Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-3133754253e33f` from `github_search_physics_engines` as `registry_expansion`
