...
<!-- canonical: https://cran.r-project.org/web/packages/wcvpmatch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wcvpmatch/index.html](https://cran.r-project.org/web/packages/wcvpmatch/index.html) |
| Source record ids | cran_packages_by_date-f9a2927a95f7d9 |

## System Engineer Summary

Taxonomic Name Reconciliation Against the 'WCVP' Backbone

## Operational Role

For a systems engineer, wcvpmatch belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-09-09 03:10:02 UTC | [https://cran.r-project.org/web/packages/wcvpmatch/DESCRIPTION](https://cran.r-project.org/web/packages/wcvpmatch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wcvpmatch/DESCRIPTION` at `2026-09-09T03:20:36+00:00`.
...
- `cran_packages_by_date-f9a2927a95f7d9` from `cran_packages_by_date` as `registry_expansion`
