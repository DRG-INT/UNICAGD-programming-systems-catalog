...
<!-- canonical: https://github.com/GuitarML/FunBox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GuitarML/FunBox](https://github.com/GuitarML/FunBox) |
| Source record ids | github_search_effects-eba25202076b2b |

## System Engineer Summary

Stereo guitar pedal platform using Daisy Seed.

## Operational Role

For a systems engineer, GuitarML/FunBox belongs in the Effects inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T15:59:36Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-eba25202076b2b` from `github_search_effects` as `registry_expansion`
