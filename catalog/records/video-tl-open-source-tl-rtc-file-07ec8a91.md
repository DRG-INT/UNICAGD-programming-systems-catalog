...
<!-- canonical: https://github.com/tl-open-source/tl-rtc-file -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tl-open-source/tl-rtc-file](https://github.com/tl-open-source/tl-rtc-file) |
| Source record ids | github_search_video-6be78ef98291f2 |

## System Engineer Summary

WebRTC P2P online web media streaming tool (for files, video, screen, live streaming, text) with
management and statistical monitoring capabilities.

## Operational Role

For a systems engineer, tl-open-source/tl-rtc-file belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-13T01:05:16Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-6be78ef98291f2` from `github_search_video` as `registry_expansion`
