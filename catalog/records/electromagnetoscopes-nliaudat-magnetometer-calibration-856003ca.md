...
<!-- canonical: https://github.com/nliaudat/magnetometer_calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nliaudat/magnetometer_calibration](https://github.com/nliaudat/magnetometer_calibration) |
| Source record ids | github_search_electromagnetoscopes-0b11b7181082c0 |
...
For a systems engineer, nliaudat/magnetometer_calibration belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-21T17:01:14Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-0b11b7181082c0` from `github_search_electromagnetoscopes` as `registry_expansion`
