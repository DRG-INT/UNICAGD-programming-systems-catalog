...
<!-- canonical: https://cran.r-project.org/web/packages/multilevelmediation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multilevelmediation/index.html](https://cran.r-project.org/web/packages/multilevelmediation/index.html) |
| Source record ids | cran_packages_by_date-e314f2bf0394e3 |
...
For a systems engineer, multilevelmediation belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-07 18:00:02 UTC | [https://cran.r-project.org/web/packages/multilevelmediation/DESCRIPTION](https://cran.r-project.org/web/packages/multilevelmediation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multilevelmediation/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-e314f2bf0394e3` from `cran_packages_by_date` as `registry_expansion`
