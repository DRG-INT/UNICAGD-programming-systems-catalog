...
<!-- canonical: https://github.com/tyfkda/xcc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tyfkda/xcc](https://github.com/tyfkda/xcc) |
| Source record ids | github_search_webassembly-42e5f822ad15d7 |
...
For a systems engineer, tyfkda/xcc belongs in the WebAssembly inventory as part of compiler
selection, diagnostics behavior, target support, ABI expectations, and build reproducibility.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T01:00:50Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | {"key": "", "name": "", "url": ""}; The Unlicense; https://api.github.com/licenses/unlicense; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:wasi stars:>100", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_webassembly-42e5f822ad15d7` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AssemblyScript - Definitely not a TypeScript to WebAssembly compiler | Compiler | [open](webassembly-assemblyscript-definitely-not-a-typescript-to-webassembly-compiler-ea8a75e1.md) |
