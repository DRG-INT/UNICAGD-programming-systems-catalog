...
<!-- canonical: https://github.com/meilisearch/meilisearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/meilisearch/meilisearch](https://github.com/meilisearch/meilisearch) |
| Source record ids | github_search_databases-7ba79c2d9cf1ed |
...
For a systems engineer, meilisearch/meilisearch belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T16:43:01Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7ba79c2d9cf1ed` from `github_search_databases` as `registry_expansion`
...
| dbcli/mycli | Parser Lexer Ast | [open](databases-dbcli-mycli-1357562c.md) |
| dbcli/pgcli | Parser Lexer Ast | [open](databases-dbcli-pgcli-df04d56c.md) |
| dgraph-io/badger | Parser Lexer Ast | [open](databases-dgraph-io-badger-fed32884.md) |
| encoredev/encore | Parser Lexer Ast | [open](databases-encoredev-encore-b1a45646.md) |
| influxdata/influxdb | Parser Lexer Ast | [open](databases-influxdata-influxdb-1fb47735.md) |
| LMDB | Parser Lexer Ast | [open](databases-lmdb-475d4578.md) |
