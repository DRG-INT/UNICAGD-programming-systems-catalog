# whothefluff/sap-cap-unsupported-db-read

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/whothefluff/sap-cap-unsupported-db-read -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/whothefluff/sap-cap-unsupported-db-read](https://github.com/whothefluff/sap-cap-unsupported-db-read) |
| Source record ids | github_search_sapjava-509641fb9753b4 |

## System Engineer Summary

whothefluff/sap-cap-unsupported-db-read is tracked as a database datastore record in the SAPJava
...
For a systems engineer, whothefluff/sap-cap-unsupported-db-read belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-09T20:25:05Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-509641fb9753b4` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cds:cds-feature-postgresql | Database Datastore | [open](sapjava-com-sap-cds-cds-feature-postgresql-6b0afe0c.md) |
| com.sap.cds:cds-feature-redis | Database Datastore | [open](sapjava-com-sap-cds-cds-feature-redis-94961708.md) |
| omar-software/mini-sap-ui5-hana-material-app | Database Datastore | [open](sapjava-omar-software-mini-sap-ui5-hana-material-app-5c18274a.md) |
| santhosh0000000/JDBC_SAP | Database Datastore | [open](sapjava-santhosh0000000-jdbc-sap-5723fb2c.md) |
| stainboy/springboot-jpa-hana | Database Datastore | [open](sapjava-stainboy-springboot-jpa-hana-e9e14156.md) |
