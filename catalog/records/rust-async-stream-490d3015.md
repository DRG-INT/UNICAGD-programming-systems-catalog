...
<!-- canonical: https://crates.io/crates/async-stream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-stream](https://crates.io/crates/async-stream) |
| Source record ids | crates_io-11c6af3f194aac |
...
For a systems engineer, async-stream belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2024-10-01T19:36:32.827442Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-11c6af3f194aac` from `crates_io` as `registry_expansion`
