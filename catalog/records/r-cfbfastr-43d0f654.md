...
<!-- canonical: https://cran.r-project.org/web/packages/cfbfastR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cfbfastR/index.html](https://cran.r-project.org/web/packages/cfbfastR/index.html) |
| Source record ids | cran_packages_by_date-877091ccce7ed6 |
...
For a systems engineer, cfbfastR belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-24 16:40:02 UTC | [https://cran.r-project.org/web/packages/cfbfastR/DESCRIPTION](https://cran.r-project.org/web/packages/cfbfastR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cfbfastR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-877091ccce7ed6` from `cran_packages_by_date` as `registry_expansion`
