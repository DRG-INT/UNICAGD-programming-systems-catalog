...
<!-- canonical: https://cran.r-project.org/web/packages/csranks/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/csranks/index.html](https://cran.r-project.org/web/packages/csranks/index.html) |
| Source record ids | cran_packages_by_date-bf81f1b9dbee57 |
...
For a systems engineer, csranks belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-21 05:44:19 UTC | [https://cran.r-project.org/web/packages/csranks/DESCRIPTION](https://cran.r-project.org/web/packages/csranks/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/csranks/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bf81f1b9dbee57` from `cran_packages_by_date` as `registry_expansion`
