...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: "aim's"](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/aim-s.md) · [Category: Container Deployment](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/container-deployment.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://docs.ray.io/en/latest/serve/](https://docs.ray.io/en/latest/serve/) |
| Source record ids | curated_language_routes-0ae28363ca47bd |

## System Engineer Summary

Scalable model serving and Python application serving layer for distributed AI workloads.

## Operational Role

For a systems engineer, Ray Serve belongs in the "aim's" inventory as part of ecosystem capability
...
- `curated_language_routes-0ae28363ca47bd` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| KServe | Container Deployment | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-kserve-2678b3d2.md) |
