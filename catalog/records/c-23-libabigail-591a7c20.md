...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Api Abi Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/api-abi-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | api_abi_checker |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-da2969fbf3d9ad |

## System Engineer Summary

libabigail is tracked as an api abi checker record in the C++23 branch. The source did not provide a
...
For a systems engineer, libabigail belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-da2969fbf3d9ad` from `master_json` as `api_abi_checker`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| abi-compliance-checker | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-abi-compliance-checker-56afc11b.md) |
