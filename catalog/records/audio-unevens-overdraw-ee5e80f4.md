...
<!-- canonical: https://github.com/unevens/Overdraw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unevens/Overdraw](https://github.com/unevens/Overdraw) |
| Source record ids | github_search_audio-c4d0eb563e235f |

## System Engineer Summary

An audio plug-in that implements a waveshaper in which the transfer function of each channel is an
automatable spline.

## Operational Role

For a systems engineer, unevens/Overdraw belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T04:30:14Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-c4d0eb563e235f` from `github_search_audio` as `registry_expansion`
