...
<!-- canonical: https://packagist.org/packages/nikolaposa/rate-limit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nikolaposa/rate-limit](https://packagist.org/packages/nikolaposa/rate-limit) |
| Source record ids | packagist_search-506f7bdbe05993 |
...
For a systems engineer, nikolaposa/rate-limit belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-05 | `{"kind": "packagist_search_and_p2_api", "query": "redis", "retrieved": "2026-09-05", "status": "registry-derived"}` |
...
- `packagist_search-506f7bdbe05993` from `packagist_search` as `registry_expansion`
