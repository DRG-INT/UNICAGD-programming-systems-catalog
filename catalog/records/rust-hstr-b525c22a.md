...
| Canonical URL | [https://crates.io/crates/hstr](https://crates.io/crates/hstr) |
| Source record ids | crates_io-91bf67e92343d3 |
...
For a systems engineer, hstr belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-08-08T01:17:15.123092Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-91bf67e92343d3` from `crates_io` as `registry_expansion`
