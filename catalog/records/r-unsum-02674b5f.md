...
<!-- canonical: https://cran.r-project.org/web/packages/unsum/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/unsum/index.html](https://cran.r-project.org/web/packages/unsum/index.html) |
| Source record ids | cran_packages_by_date-340e9f09faa629 |
...
For a systems engineer, unsum belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-04 18:30:02 UTC | [https://cran.r-project.org/web/packages/unsum/DESCRIPTION](https://cran.r-project.org/web/packages/unsum/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/unsum/DESCRIPTION` at `2026-09-04T20:19:05+00:00`.
...
- `cran_packages_by_date-340e9f09faa629` from `cran_packages_by_date` as `registry_expansion`
