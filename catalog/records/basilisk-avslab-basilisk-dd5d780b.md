...
[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-f6ebb07585f4d1 |

## System Engineer Summary

Astrodynamics simulation framework with Python, C/C++, messaging, visualization, and GN&C workflows.

## Operational Role

For a systems engineer, AVSLab Basilisk belongs in the Basilisk inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/AVSLab/basilisk/releases/latest` at `2026-09-01T12:30:31+00:00`.
...
- `curated_language_routes-f6ebb07585f4d1` from `curated_language_routes` as `registry_expansion`
