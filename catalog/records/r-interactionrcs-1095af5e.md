...
<!-- canonical: https://cran.r-project.org/web/packages/interactionRCS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/interactionRCS/index.html](https://cran.r-project.org/web/packages/interactionRCS/index.html) |
| Source record ids | cran_packages_by_date-9b0ae50b0ca67b |
...
For a systems engineer, interactionRCS belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-10 22:20:02 UTC | [https://cran.r-project.org/web/packages/interactionRCS/DESCRIPTION](https://cran.r-project.org/web/packages/interactionRCS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/interactionRCS/DESCRIPTION` at `2026-09-11T00:27:28+00:00`.
...
- `cran_packages_by_date-9b0ae50b0ca67b` from `cran_packages_by_date` as `registry_expansion`
