...
<!-- canonical: https://hackage.haskell.org/package/bio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bio](https://hackage.haskell.org/package/bio) |
| Source record ids | hackage_top_downloads-b2f7e04666fe2d |
...
For a systems engineer, bio belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.3 | 2013-07-20T07:33:11Z | [https://hackage.haskell.org/package/bio](https://hackage.haskell.org/package/bio) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bio` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-b2f7e04666fe2d` from `hackage_top_downloads` as `registry_expansion`
