...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/corquaid/international-space-station-APIs](https://github.com/corquaid/international-space-station-APIs) |
| Source record ids | github_search_space_engines-a4a1306683b1bb |

## System Engineer Summary

JSON files containing lots of interesting information on the people currently living in space for
use in your project.

## Operational Role

For a systems engineer, corquaid/international-space-station-APIs belongs in the Space Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.120.0 | 2026-07-26T09:49:46Z | [https://api.github.com/repos/corquaid/international-space-station-APIs/releases/latest](https://api.github.com/repos/corquaid/international-space-station-APIs/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/corquaid/international-space-station-APIs/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `github_search_space_engines-a4a1306683b1bb` from `github_search_space_engines` as `registry_expansion`
