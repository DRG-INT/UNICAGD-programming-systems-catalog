# Gitea: dh.azdevops.othau/dh.azdevops.othau
...
<!-- canonical: https://gitea.com/dh.azdevops.othau/dh.azdevops.othau -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dh.azdevops.othau/dh.azdevops.othau](https://gitea.com/dh.azdevops.othau/dh.azdevops.othau) |
| Source record ids | gitea_repositories_api-1b3f7086162dd5 |
...
For a systems engineer, Gitea: dh.azdevops.othau/dh.azdevops.othau belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-24T14:38:02Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-1b3f7086162dd5` from `gitea_repositories_api` as `registry_expansion`
