...
<!-- canonical: https://github.com/marceloprates/prettymaps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marceloprates/prettymaps](https://github.com/marceloprates/prettymaps) |
| Source record ids | github_search_maps-2aed98ecef71e5 |
...
For a systems engineer, marceloprates/prettymaps belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T16:29:42Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2aed98ecef71e5` from `github_search_maps` as `registry_expansion`
