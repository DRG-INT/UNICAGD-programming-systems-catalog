...
<!-- canonical: https://github.com/pixeltable/pixeltable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pixeltable/pixeltable](https://github.com/pixeltable/pixeltable) |
| Source record ids | github_search_databases-a8d5e4effca771 |

## System Engineer Summary

The unified multimodal backend for AI data apps. Database, orchestration, and serving in one Python
file.

## Operational Role

For a systems engineer, pixeltable/pixeltable belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T06:09:12Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a8d5e4effca771` from `github_search_databases` as `registry_expansion`
