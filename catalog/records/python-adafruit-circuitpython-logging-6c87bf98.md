...
<!-- canonical: https://pypi.org/project/adafruit-circuitpython-logging/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adafruit-circuitpython-logging/](https://pypi.org/project/adafruit-circuitpython-logging/) |
| Source record ids | pypi_simple-b0076322acecf8 |
...
For a systems engineer, adafruit-circuitpython-logging belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.6.4 | 2026-04-23T21:21:56.811154Z | [https://pypi.org/pypi/adafruit-circuitpython-logging/json](https://pypi.org/pypi/adafruit-circuitpython-logging/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adafruit-circuitpython-logging/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-b0076322acecf8` from `pypi_simple` as `registry_expansion`
