...
| Source record ids | github_search_radars-61a5ef730c2824 |
...
For a systems engineer, denkywu/SAR-Synthetic-Aperture-Radar belongs in the Radars inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-19T03:15:56Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT OR Apache-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_radars-61a5ef730c2824` from `github_search_radars` as `registry_expansion`
