...
<!-- canonical: https://github.com/bots-garden/capsule -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bots-garden/capsule](https://github.com/bots-garden/capsule) |
| Source record ids | github_search_webassembly-5edc7f66214338 |

## System Engineer Summary

A Capsule application is a runner (or launcher) of wasm functions. Capsule HTTP can serve the
functions through HTTP (it’s possible to use Capsule as a simple CLI with Capsule CLI). And soon:
NATS and MQTT

## Operational Role

For a systems engineer, bots-garden/capsule belongs in the WebAssembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-11T07:06:30Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-5edc7f66214338` from `github_search_webassembly` as `registry_expansion`
