...
<!-- canonical: https://crates.io/crates/is_ci -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/is_ci](https://crates.io/crates/is_ci) |
| Source record ids | crates_io-349d7297934296 |
...
For a systems engineer, is_ci belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2024-02-04T02:57:53.234697Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-349d7297934296` from `crates_io` as `registry_expansion`
