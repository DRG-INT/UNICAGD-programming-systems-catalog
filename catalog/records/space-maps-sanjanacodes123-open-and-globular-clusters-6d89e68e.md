# Sanjanacodes123/Open-and-Globular-Clusters
...
<!-- canonical: https://github.com/Sanjanacodes123/Open-and-Globular-Clusters -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Sanjanacodes123/Open-and-Globular-Clusters](https://github.com/Sanjanacodes123/Open-and-Globular-Clusters) |
| Source record ids | github_search_space_maps-0fcf8b77eb18b1 |

## System Engineer Summary

Exploration of open and globular star clusters using Gaia catalog data with Python. The project
involves querying astronomical databases, processing stellar coordinates, and visualizing cluster
distributions on sky maps as part of guided beginner-level learning in computational astronomy.

## Operational Role

For a systems engineer, Sanjanacodes123/Open-and-Globular-Clusters belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-20T08:09:38Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0fcf8b77eb18b1` from `github_search_space_maps` as `registry_expansion`
