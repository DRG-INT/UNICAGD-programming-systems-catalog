...
<!-- canonical: https://cran.r-project.org/web/packages/GRIN2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GRIN2/index.html](https://cran.r-project.org/web/packages/GRIN2/index.html) |
| Source record ids | cran_packages_by_date-6b648edcb74e12 |
...
For a systems engineer, GRIN2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-22 15:20:20 UTC | [https://cran.r-project.org/web/packages/GRIN2/DESCRIPTION](https://cran.r-project.org/web/packages/GRIN2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GRIN2/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6b648edcb74e12` from `cran_packages_by_date` as `registry_expansion`
