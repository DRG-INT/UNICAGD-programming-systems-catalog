...
<!-- canonical: https://packagist.org/packages/prwnr/laravel-streamer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/prwnr/laravel-streamer](https://packagist.org/packages/prwnr/laravel-streamer) |
| Source record ids | packagist_search-f7e922416058af |
...
For a systems engineer, prwnr/laravel-streamer belongs in the PHP inventory as part of state
...
- `packagist_search-f7e922416058af` from `packagist_search` as `registry_expansion`
