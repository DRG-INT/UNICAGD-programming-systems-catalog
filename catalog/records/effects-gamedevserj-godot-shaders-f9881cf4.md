...
<!-- canonical: https://github.com/gamedevserj/Godot-Shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gamedevserj/Godot-Shaders](https://github.com/gamedevserj/Godot-Shaders) |
| Source record ids | github_search_effects-9071a60a86b8b2 |
...
For a systems engineer, gamedevserj/Godot-Shaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-04T15:16:01Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9071a60a86b8b2` from `github_search_effects` as `registry_expansion`
