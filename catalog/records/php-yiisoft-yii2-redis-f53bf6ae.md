...
<!-- canonical: https://packagist.org/packages/yiisoft/yii2-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yiisoft/yii2-redis](https://packagist.org/packages/yiisoft/yii2-redis) |
| Source record ids | packagist_search-ad7eac0b2db2ee |
...
For a systems engineer, yiisoft/yii2-redis belongs in the PHP inventory as part of state
...
- `packagist_search-ad7eac0b2db2ee` from `packagist_search` as `registry_expansion`
