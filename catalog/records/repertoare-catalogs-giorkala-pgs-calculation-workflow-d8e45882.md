# giorkala/pgs_calculation_workflow
...
<!-- canonical: https://github.com/giorkala/pgs_calculation_workflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giorkala/pgs_calculation_workflow](https://github.com/giorkala/pgs_calculation_workflow) |
| Source record ids | github_search_repertoare_catalogs-e37bc99e880d3d |

## System Engineer Summary

Simple pipeline for calculating polygenic risk scores (PGS; aka PRS) for an individual's genotypes,
using variant weights from the PGS Catalog.

## Operational Role

For a systems engineer, giorkala/pgs_calculation_workflow belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-19T19:37:13Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-e37bc99e880d3d` from `github_search_repertoare_catalogs` as `registry_expansion`
