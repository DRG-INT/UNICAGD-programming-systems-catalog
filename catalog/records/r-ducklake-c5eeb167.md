...
<!-- canonical: https://cran.r-project.org/web/packages/ducklake/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ducklake/index.html](https://cran.r-project.org/web/packages/ducklake/index.html) |
| Source record ids | cran_packages_by_date-bb72fc8925ef45 |
...
For a systems engineer, ducklake belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-09 14:50:02 UTC | [https://cran.r-project.org/web/packages/ducklake/DESCRIPTION](https://cran.r-project.org/web/packages/ducklake/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ducklake/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-bb72fc8925ef45` from `cran_packages_by_date` as `registry_expansion`
