...
<!-- canonical: https://github.com/JohnEstropia/CoreStore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JohnEstropia/CoreStore](https://github.com/JohnEstropia/CoreStore) |
| Source record ids | github_search_cocoa-a34310a5381db8 |
...
For a systems engineer, JohnEstropia/CoreStore belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T04:56:44Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-a34310a5381db8` from `github_search_cocoa` as `registry_expansion`
