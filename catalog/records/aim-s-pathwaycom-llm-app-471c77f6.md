...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pathwaycom/llm-app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pathwaycom/llm-app](https://github.com/pathwaycom/llm-app) |
| Source record ids | github_search_aims-02d30e8095136b |

## System Engineer Summary

Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-
friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs,
and more.

## Operational Role

For a systems engineer, pathwaycom/llm-app belongs in the "aim's" inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T17:59:07Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-02d30e8095136b` from `github_search_aims` as `registry_expansion`
