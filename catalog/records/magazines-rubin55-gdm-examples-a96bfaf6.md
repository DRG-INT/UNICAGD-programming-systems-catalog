...
<!-- canonical: https://github.com/rubin55/gdm-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rubin55/gdm-examples](https://github.com/rubin55/gdm-examples) |
| Source record ids | github_search_magazines-64d3a892ccea29 |

## System Engineer Summary

A collection of examples from Game Developer Magazine

## Operational Role

For a systems engineer, rubin55/gdm-examples belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-10T20:28:04Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-64d3a892ccea29` from `github_search_magazines` as `registry_expansion`
