...
<!-- canonical: https://gitea.com/shastriii/compiler-lab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/shastriii/compiler-lab](https://gitea.com/shastriii/compiler-lab) |
| Source record ids | gitea_repositories_api-beef3e15a2475d |
...
For a systems engineer, Gitea: shastriii/compiler-lab belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T04:44:02Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-beef3e15a2475d` from `gitea_repositories_api` as `registry_expansion`
