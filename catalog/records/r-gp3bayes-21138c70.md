...
<!-- canonical: https://cran.r-project.org/web/packages/gp3bayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gp3bayes/index.html](https://cran.r-project.org/web/packages/gp3bayes/index.html) |
| Source record ids | cran_packages_by_date-35b0c60e3dafd9 |

## System Engineer Summary

Contract-First Bayesian Workflows for Hierarchical Behavioural Data

## Operational Role

For a systems engineer, gp3bayes belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-23 10:40:44 UTC | [https://cran.r-project.org/web/packages/gp3bayes/DESCRIPTION](https://cran.r-project.org/web/packages/gp3bayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gp3bayes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-35b0c60e3dafd9` from `cran_packages_by_date` as `registry_expansion`
