...
<!-- canonical: https://crates.io/crates/urlencoding -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/urlencoding](https://crates.io/crates/urlencoding) |
| Source record ids | crates_io-caad8d7901e76f |
...
For a systems engineer, urlencoding belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2023-07-21T15:12:17.534094Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-caad8d7901e76f` from `crates_io` as `registry_expansion`
