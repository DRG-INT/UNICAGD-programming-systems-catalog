...
<!-- canonical: https://github.com/sh123/antenna_analyzer_vna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sh123/antenna_analyzer_vna](https://github.com/sh123/antenna_analyzer_vna) |
| Source record ids | github_search_electromagnetoscopes-63933e19eb56b8 |

## System Engineer Summary

Pocket Arduino Nano based graphical SWR 160-6m bands panoramic VNA antenna analyzer based on AD9850,
AD8302 and SGA3386

## Operational Role

For a systems engineer, sh123/antenna_analyzer_vna belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-20T14:52:01Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-63933e19eb56b8` from `github_search_electromagnetoscopes` as `registry_expansion`
