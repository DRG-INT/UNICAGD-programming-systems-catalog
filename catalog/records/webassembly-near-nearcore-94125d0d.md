...
<!-- canonical: https://github.com/near/nearcore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/near/nearcore](https://github.com/near/nearcore) |
| Source record ids | github_search_webassembly-aced46ccc6529f |
...
For a systems engineer, near/nearcore belongs in the WebAssembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T09:34:33Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-aced46ccc6529f` from `github_search_webassembly` as `registry_expansion`
