...
<!-- canonical: https://cran.r-project.org/web/packages/wordvector/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wordvector/index.html](https://cran.r-project.org/web/packages/wordvector/index.html) |
| Source record ids | cran_packages_by_date-d64753ad7b4bad |
...
For a systems engineer, wordvector belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-09-10 14:40:02 UTC | [https://cran.r-project.org/web/packages/wordvector/DESCRIPTION](https://cran.r-project.org/web/packages/wordvector/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wordvector/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-d64753ad7b4bad` from `cran_packages_by_date` as `registry_expansion`
