...
| Canonical URL | [https://crates.io/crates/vergen](https://crates.io/crates/vergen) |
| Source record ids | crates_io-16ded45ce3c681 |
...
For a systems engineer, vergen belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.3 | 2026-08-24T16:17:36.406962Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-16ded45ce3c681` from `crates_io` as `registry_expansion`
