...
<!-- canonical: https://luarocks.org/modules/oxy2dev/bars-n-lines.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/oxy2dev/bars-n-lines.nvim](https://luarocks.org/modules/oxy2dev/bars-n-lines.nvim) |
| Source record ids | luarocks_root_manifest-565cf7edd18c9a |

## System Engineer Summary

Deprecated example bars & lines plugin for Neovim. Use `bars.nvim` instead

## Operational Role

For a systems engineer, bars-n-lines.nvim belongs in the Lua family inventory as part of ecosystem
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `luarocks_root_manifest-565cf7edd18c9a` from `luarocks_root_manifest` as `registry_expansion`
