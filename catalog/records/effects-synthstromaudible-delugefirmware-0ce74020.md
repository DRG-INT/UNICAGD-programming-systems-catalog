...
<!-- canonical: https://github.com/SynthstromAudible/DelugeFirmware -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SynthstromAudible/DelugeFirmware](https://github.com/SynthstromAudible/DelugeFirmware) |
| Source record ids | github_search_effects-422df4f81aefa5 |
...
For a systems engineer, SynthstromAudible/DelugeFirmware belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T10:08:20Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-422df4f81aefa5` from `github_search_effects` as `registry_expansion`
