...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/acceldata-openlineage/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acceldata-openlineage/](https://pypi.org/project/acceldata-openlineage/) |
| Source record ids | pypi_simple-ce8bae925f9c7a |

## System Engineer Summary

Custom OpenLineage extractors for Acceldata integrations

## Operational Role

For a systems engineer, acceldata-openlineage belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-17T07:53:54.028618Z | [https://pypi.org/pypi/acceldata-openlineage/json](https://pypi.org/pypi/acceldata-openlineage/json) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acceldata-openlineage/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-ce8bae925f9c7a` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 101703311-Missing-Data | Library | [open](python-101703311-missing-data-f6320cdf.md) |
| 2u-enterprise-data | Library | [open](python-2u-enterprise-data-a63cd741.md) |
| a-data-source | Library | [open](python-a-data-source-531249a0.md) |
| a-datas-stock | Library | [open](python-a-datas-stock-5d340587.md) |
| AbdoDataPrepKit | Library | [open](python-abdodataprepkit-fa1f4ac2.md) |
| absdataset | Library | [open](python-absdataset-92e845a6.md) |
| abstract-data-types | Library | [open](python-abstract-data-types-4d6cc531.md) |
| abstract_dataloader | Library | [open](python-abstract-dataloader-4cdc50de.md) |
