...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/firebase_performance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/firebase_performance](https://pub.dev/packages/firebase_performance) |
| Source record ids | pub_dev-e9256d7559a8f8 |

## System Engineer Summary

Flutter plugin for Google Performance Monitoring for Firebase, an app measurement solution that
monitors traces and HTTP/S network requests on Android and iOS.

## Operational Role

For a systems engineer, firebase_performance belongs in the Dart inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.5 | 2026-08-24T13:41:38.990765Z | [https://pub.dev/api/packages/firebase_performance](https://pub.dev/api/packages/firebase_performance) |  |
| preview | known | 0.8.0-dev.1 | 2021-12-07T23:15:38.752212Z | [https://pub.dev/api/packages/firebase_performance](https://pub.dev/api/packages/firebase_performance) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/firebase_performance` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-e9256d7559a8f8` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| sentry_dio | Profiler | [open](dart-sentry-dio-7067a5da.md) |
| stack_trace | Profiler | [open](dart-stack-trace-b647609e.md) |
