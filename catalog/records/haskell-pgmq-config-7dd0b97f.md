...
<!-- canonical: https://hackage.haskell.org/package/pgmq-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pgmq-config](https://hackage.haskell.org/package/pgmq-config) |
| Source record ids | hackage_recent-a848917cef6406 |
...
For a systems engineer, pgmq-config belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2026-09-10T19:39:36Z | [https://hackage.haskell.org/package/pgmq-config](https://hackage.haskell.org/package/pgmq-config) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pgmq-config` at `2026-09-11T01:22:35+00:00`.
...
- `hackage_recent-a848917cef6406` from `hackage_recent` as `registry_expansion`
