...
<!-- canonical: https://github.com/scarf-sh/gateway -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scarf-sh/gateway](https://github.com/scarf-sh/gateway) |
| Source record ids | github_search_catalogs-94510c9886eb46 |

## System Engineer Summary

Scarf Gateway is a universal redirect layer for any digital artifact or URL, anywhere online. Scarf
Gateway acts much like a customizable link shortener that also lets you serve software like Docker
containers, Python packages, or anything other kind of software you distribute.

## Operational Role

For a systems engineer, scarf-sh/gateway belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-13T16:09:48Z | gh search repos topic:package-registry stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:package-registry stars:>50", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_catalogs-94510c9886eb46` from `github_search_catalogs` as `registry_expansion`
