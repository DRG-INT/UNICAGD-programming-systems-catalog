...
<!-- canonical: https://cran.r-project.org/web/packages/PatientGenerator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PatientGenerator/index.html](https://cran.r-project.org/web/packages/PatientGenerator/index.html) |
| Source record ids | cran_packages_by_date-c5668757b7d3c5 |
...
For a systems engineer, PatientGenerator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-09-16 00:10:10 UTC | [https://cran.r-project.org/web/packages/PatientGenerator/DESCRIPTION](https://cran.r-project.org/web/packages/PatientGenerator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PatientGenerator/DESCRIPTION` at `2026-09-16T00:25:59+00:00`.
...
- `cran_packages_by_date-c5668757b7d3c5` from `cran_packages_by_date` as `registry_expansion`
