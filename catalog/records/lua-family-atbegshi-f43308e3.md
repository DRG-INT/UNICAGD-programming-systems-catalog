...
| Canonical URL | [https://luarocks.org/modules/freed-wu/atbegshi](https://luarocks.org/modules/freed-wu/atbegshi) |
| Source record ids | luarocks_root_manifest-5614536f00aac5 |
...
For a systems engineer, atbegshi belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| clock | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-clock-86e354c0.md) |
| cputime | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cputime-26607d81.md) |
| ctc | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ctc-b878c81a.md) |
| custom-access-time | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-custom-access-time-4f482e5c.md) |
| date | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-date-6c1341e8.md) |
| dromozoa-calendar | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-calendar-9962678c.md) |
| elscheduler | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-elscheduler-3a59f84a.md) |
| emoji-clock | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-emoji-clock-a927397a.md) |
