...
<!-- canonical: https://pub.dev/packages/google_fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_fonts](https://pub.dev/packages/google_fonts) |
| Source record ids | pub_dev-d6ff3fd4cc5f33 |

## System Engineer Summary

A Flutter package to use fonts from fonts.google.com. Supports HTTP fetching, caching, and asset
bundling.

## Operational Role

For a systems engineer, google_fonts belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.2.1 | 2026-07-31T23:41:06.826038Z | [https://pub.dev/api/packages/google_fonts](https://pub.dev/api/packages/google_fonts) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-02-12T00:57:24.764445Z | [https://pub.dev/api/packages/google_fonts](https://pub.dev/api/packages/google_fonts) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_fonts` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-d6ff3fd4cc5f33` from `pub_dev` as `registry_expansion`
