...
<!-- canonical: https://github.com/davemollen/dm-TimeWarp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/davemollen/dm-TimeWarp](https://github.com/davemollen/dm-TimeWarp) |
| Source record ids | github_search_audio-d58f1c4fa2218f |

## System Engineer Summary

Granular delay, looper & sampler plugin with time stretch capabilities

## Operational Role

For a systems engineer, davemollen/dm-TimeWarp belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T11:49:08Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-d58f1c4fa2218f` from `github_search_audio` as `registry_expansion`
