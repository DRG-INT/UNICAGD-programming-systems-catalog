...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tidwall/buntdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tidwall/buntdb](https://github.com/tidwall/buntdb) |
| Source record ids | github_search_maps-9bf56e70998de5 |

## System Engineer Summary

BuntDB is an embeddable, in-memory key/value database for Go with custom indexing and geospatial
support

## Operational Role

For a systems engineer, tidwall/buntdb belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-19T13:29:56Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9bf56e70998de5` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| tidwall/summitdb | Memory Analyzer | [open](maps-tidwall-summitdb-dbfadca9.md) |
