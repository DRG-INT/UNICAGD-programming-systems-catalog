...
<!-- canonical: https://luarocks.org/modules/helmutb/amqp-client-rpc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/helmutb/amqp-client-rpc](https://luarocks.org/modules/helmutb/amqp-client-rpc) |
| Source record ids | luarocks_root_manifest-67a9df39154a4c |

## System Engineer Summary

amqp-client-rpc is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, amqp-client-rpc belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-67a9df39154a4c` from `luarocks_root_manifest` as `registry_expansion`
