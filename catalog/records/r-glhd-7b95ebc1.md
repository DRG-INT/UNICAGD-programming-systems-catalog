...
<!-- canonical: https://cran.r-project.org/web/packages/GLHD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GLHD/index.html](https://cran.r-project.org/web/packages/GLHD/index.html) |
| Source record ids | cran_packages_by_date-64343a5727e743 |
...
For a systems engineer, GLHD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-1 | 2026-08-09 08:10:19 UTC | [https://cran.r-project.org/web/packages/GLHD/DESCRIPTION](https://cran.r-project.org/web/packages/GLHD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GLHD/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-64343a5727e743` from `cran_packages_by_date` as `registry_expansion`
