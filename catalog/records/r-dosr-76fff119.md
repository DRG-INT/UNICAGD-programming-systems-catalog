...
<!-- canonical: https://cran.r-project.org/web/packages/dosr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dosr/index.html](https://cran.r-project.org/web/packages/dosr/index.html) |
| Source record ids | cran_packages_by_date-3c8ac396b1fd64 |

## System Engineer Summary

Survey Analysis Tools for the Chilean Social Observatory

## Operational Role

For a systems engineer, dosr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2026-08-28 07:01:14 UTC | [https://cran.r-project.org/web/packages/dosr/DESCRIPTION](https://cran.r-project.org/web/packages/dosr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dosr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3c8ac396b1fd64` from `cran_packages_by_date` as `registry_expansion`
