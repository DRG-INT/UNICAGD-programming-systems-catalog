# gitlab-examples/kubernetes-example
...
<!-- canonical: https://gitlab.com/gitlab-examples/kubernetes-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-examples/kubernetes-example](https://gitlab.com/gitlab-examples/kubernetes-example) |
| Source record ids | gitlab_projects_api-7e421cd184f044 |

## System Engineer Summary

Template app including deploy using Kubernetes

## Operational Role

For a systems engineer, gitlab-examples/kubernetes-example belongs in the Repository Workplaces
...
- `gitlab_projects_api-7e421cd184f044` from `gitlab_projects_api` as `registry_expansion`
