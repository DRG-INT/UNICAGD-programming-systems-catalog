...
<!-- canonical: https://cran.r-project.org/web/packages/SeqExpMatch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SeqExpMatch/index.html](https://cran.r-project.org/web/packages/SeqExpMatch/index.html) |
| Source record ids | cran_packages_by_date-88477e451e45a5 |
...
For a systems engineer, SeqExpMatch belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-19 11:20:11 UTC | [https://cran.r-project.org/web/packages/SeqExpMatch/DESCRIPTION](https://cran.r-project.org/web/packages/SeqExpMatch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SeqExpMatch/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-88477e451e45a5` from `cran_packages_by_date` as `registry_expansion`
