...
<!-- canonical: https://crates.io/crates/plotters -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/plotters](https://crates.io/crates/plotters) |
| Source record ids | crates_io-c1f534ceb0ce9d |
...
For a systems engineer, plotters belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7 | 2024-09-08T14:48:03.071447Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c1f534ceb0ce9d` from `crates_io` as `registry_expansion`
