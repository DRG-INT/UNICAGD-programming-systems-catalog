...
<!-- canonical: https://crates.io/crates/itoa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/itoa](https://crates.io/crates/itoa) |
| Source record ids | crates_io-a19d60b8404c92 |
...
For a systems engineer, itoa belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.18 | 2026-03-20T00:12:37.043881Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-a19d60b8404c92` from `crates_io` as `registry_expansion`
