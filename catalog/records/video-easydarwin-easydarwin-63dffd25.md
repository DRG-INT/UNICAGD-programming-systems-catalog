...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/EasyDarwin/EasyDarwin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EasyDarwin/EasyDarwin](https://github.com/EasyDarwin/EasyDarwin) |
| Source record ids | github_search_video-d5cde86bccd36d |

## System Engineer Summary

open source、high performance、industrial rtsp streaming server,a lot of optimization on streaming
relay,KeyFrame cache,RESTful,and web management,also EasyDarwin support distributed load balancing,a
simple streaming media cloud platform architecture.

## Operational Role

For a systems engineer, EasyDarwin/EasyDarwin belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-07T06:59:14Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d5cde86bccd36d` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/seatunnel | Benchmarking | [open](video-apache-seatunnel-7a3188b7.md) |
| ossrs/srs | Benchmarking | [open](video-ossrs-srs-d03d5a5e.md) |
