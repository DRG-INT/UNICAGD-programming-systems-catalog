...
<!-- canonical: https://pypi.org/project/address-finder-data-p05/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-finder-data-p05/](https://pypi.org/project/address-finder-data-p05/) |
| Source record ids | pypi_simple-50a1aee55891a0 |

## System Engineer Summary

address-finder data chunk p05 - contains address_parser_postal_codes.dat part 1/1

## Operational Role

For a systems engineer, address-finder-data-p05 belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-03-20T17:38:47.296207Z | [https://pypi.org/pypi/address-finder-data-p05/json](https://pypi.org/pypi/address-finder-data-p05/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-finder-data-p05/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-50a1aee55891a0` from `pypi_simple` as `registry_expansion`
