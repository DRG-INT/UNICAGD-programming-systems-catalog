...
<!-- canonical: https://cran.r-project.org/web/packages/grt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/grt/index.html](https://cran.r-project.org/web/packages/grt/index.html) |
| Source record ids | cran_packages_by_date-8fc99a1aeacbc5 |
...
For a systems engineer, grt belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-24 09:20:02 UTC | [https://cran.r-project.org/web/packages/grt/DESCRIPTION](https://cran.r-project.org/web/packages/grt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/grt/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8fc99a1aeacbc5` from `cran_packages_by_date` as `registry_expansion`
