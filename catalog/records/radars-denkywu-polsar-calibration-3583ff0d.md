...
<!-- canonical: https://github.com/denkywu/PolSAR-Calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/denkywu/PolSAR-Calibration](https://github.com/denkywu/PolSAR-Calibration) |
| Source record ids | github_search_radars-2807864160506e |

## System Engineer Summary

极化合成孔径雷达，极化定标和校准 相关。Some work I did during my graduate studies (Matlab Code) : (3) Polarimetric SAR
(PolSAR) Calibration, including (a) the Whitt algorithm, (b) the Quegan algorithm, (c) the Ainsworth
algorithm, (d) the PARC algorithm.

## Operational Role

For a systems engineer, denkywu/PolSAR-Calibration belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-03T03:54:06Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-2807864160506e` from `github_search_radars` as `registry_expansion`
