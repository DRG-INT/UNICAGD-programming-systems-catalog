...
| Canonical URL | [https://github.com/fieldtrip/fieldtrip](https://github.com/fieldtrip/fieldtrip) |
| Source record ids | github_search_matlab-a5b1e37e103f85 |
...
For a systems engineer, fieldtrip/fieldtrip belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 20251218 | 2026-01-08T13:00:55Z | [https://api.github.com/repos/fieldtrip/fieldtrip/releases/latest](https://api.github.com/repos/fieldtrip/fieldtrip/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fieldtrip/fieldtrip/releases/latest` at `2026-09-01T07:24:10+00:00`.
...
- `github_search_matlab-a5b1e37e103f85` from `github_search_matlab` as `registry_expansion`
