...
<!-- canonical: https://cran.r-project.org/web/packages/selecta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/selecta/index.html](https://cran.r-project.org/web/packages/selecta/index.html) |
| Source record ids | cran_packages_by_date-79c42bb9b14d90 |

## System Engineer Summary

Declarative EQUATOR-Style Flow Diagrams for Clinical Studies

## Operational Role

For a systems engineer, selecta belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-22 18:40:02 UTC | [https://cran.r-project.org/web/packages/selecta/DESCRIPTION](https://cran.r-project.org/web/packages/selecta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/selecta/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-79c42bb9b14d90` from `cran_packages_by_date` as `registry_expansion`
