...
<!-- canonical: https://packagist.org/packages/kkomelin/laravel-translatable-string-exporter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kkomelin/laravel-translatable-string-exporter](https://packagist.org/packages/kkomelin/laravel-translatable-string-exporter) |
| Source record ids | packagist_search-548f63b2203d15 |
...
For a systems engineer, kkomelin/laravel-translatable-string-exporter belongs in the PHP inventory
...
- `packagist_search-548f63b2203d15` from `packagist_search` as `registry_expansion`
