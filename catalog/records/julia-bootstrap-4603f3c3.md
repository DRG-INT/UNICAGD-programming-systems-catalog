...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/Bootstrap](https://github.com/JuliaRegistries/General/tree/master/B/Bootstrap) |
| Source record ids | julia_general-ab3a26be3db581 |

## System Engineer Summary

Julia package registered in General at B/Bootstrap.

## Operational Role

For a systems engineer, Bootstrap belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/Bootstrap", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ab3a26be3db581` from `julia_general` as `registry_expansion`
