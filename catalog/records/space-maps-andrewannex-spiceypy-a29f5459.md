...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AndrewAnnex/SpiceyPy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AndrewAnnex/SpiceyPy](https://github.com/AndrewAnnex/SpiceyPy) |
| Source record ids | github_search_space_maps-8e6b067d263e14 |
...
For a systems engineer, AndrewAnnex/SpiceyPy belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T01:43:50Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8e6b067d263e14` from `github_search_space_maps` as `registry_expansion`
