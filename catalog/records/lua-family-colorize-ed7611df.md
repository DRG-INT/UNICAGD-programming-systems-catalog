...
<!-- canonical: https://luarocks.org/modules/code-nuage/colorize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/code-nuage/colorize](https://luarocks.org/modules/code-nuage/colorize) |
| Source record ids | luarocks_root_manifest-a400e09b0846a0 |

## System Engineer Summary

colorize is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, colorize belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a400e09b0846a0` from `luarocks_root_manifest` as `registry_expansion`
