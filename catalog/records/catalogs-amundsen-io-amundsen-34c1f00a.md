...
<!-- canonical: https://github.com/amundsen-io/amundsen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amundsen-io/amundsen](https://github.com/amundsen-io/amundsen) |
| Source record ids | github_search_catalogs-ae001b3122ae1b |

## System Engineer Summary

Amundsen is a metadata driven application for improving the productivity of data analysts, data
scientists and engineers when interacting with data.

## Operational Role

For a systems engineer, amundsen-io/amundsen belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T21:15:53Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ae001b3122ae1b` from `github_search_catalogs` as `registry_expansion`
