...
<!-- canonical: https://github.com/Remix-Design/RemixIcon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Remix-Design/RemixIcon](https://github.com/Remix-Design/RemixIcon) |
| Source record ids | github_search_icons_and_logos-785ac204264673 |
...
For a systems engineer, Remix-Design/RemixIcon belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T09:25:21Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-785ac204264673` from `github_search_icons_and_logos` as `registry_expansion`
