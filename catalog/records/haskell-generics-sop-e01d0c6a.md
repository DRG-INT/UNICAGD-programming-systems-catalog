...
<!-- canonical: https://hackage.haskell.org/package/generics-sop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/generics-sop](https://hackage.haskell.org/package/generics-sop) |
| Source record ids | hackage_top_downloads-c8a1382226044b |
...
For a systems engineer, generics-sop belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1.4 | 2023-10-18T09:48:58Z | [https://hackage.haskell.org/package/generics-sop](https://hackage.haskell.org/package/generics-sop) |  |
| candidate | partial | 0.2.5.0 |  | [https://hackage.haskell.org/package/generics-sop](https://hackage.haskell.org/package/generics-sop) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/generics-sop` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-c8a1382226044b` from `hackage_top_downloads` as `registry_expansion`
