...
<!-- canonical: https://github.com/zhayujie/CowAgent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) |
| Source record ids | github_search_aims-dc9c4f2e6bd843 |
...
For a systems engineer, zhayujie/CowAgent belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:17:33Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-dc9c4f2e6bd843` from `github_search_aims` as `registry_expansion`
