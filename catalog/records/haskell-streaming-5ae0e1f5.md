...
<!-- canonical: https://hackage.haskell.org/package/streaming -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/streaming](https://hackage.haskell.org/package/streaming) |
| Source record ids | hackage_top_downloads-01855e9a9817ab |
...
For a systems engineer, streaming belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4.0 | 2023-07-06T15:25:05Z | [https://hackage.haskell.org/package/streaming](https://hackage.haskell.org/package/streaming) |  |
| candidate | partial | 0.2.3.0 |  | [https://hackage.haskell.org/package/streaming](https://hackage.haskell.org/package/streaming) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/streaming` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-01855e9a9817ab` from `hackage_top_downloads` as `registry_expansion`
