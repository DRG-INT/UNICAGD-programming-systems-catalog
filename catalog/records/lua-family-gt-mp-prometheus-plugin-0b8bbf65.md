...
| Canonical URL | [https://luarocks.org/modules/faqiharifian/gt-mp-prometheus-plugin](https://luarocks.org/modules/faqiharifian/gt-mp-prometheus-plugin) |
| Source record ids | luarocks_root_manifest-558ea1a49cff1e |
...
For a systems engineer, gt-mp-prometheus-plugin belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-558ea1a49cff1e` from `luarocks_root_manifest` as `registry_expansion`
