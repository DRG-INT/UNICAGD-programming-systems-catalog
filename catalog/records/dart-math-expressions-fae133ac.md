...
<!-- canonical: https://pub.dev/packages/math_expressions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/math_expressions](https://pub.dev/packages/math_expressions) |
| Source record ids | pub_dev-f8f6d02859ae45 |

## System Engineer Summary

A library for parsing and evaluating mathematical expressions, supporting real numbers, vectors, and
basic interval arithmetic.

## Operational Role

For a systems engineer, math_expressions belongs in the Dart inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-07-29T09:28:21.143785Z | [https://pub.dev/api/packages/math_expressions](https://pub.dev/api/packages/math_expressions) |  |
| preview | known | 2.7.0-rc.3 | 2025-02-03T10:15:29.571372Z | [https://pub.dev/api/packages/math_expressions](https://pub.dev/api/packages/math_expressions) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/math_expressions` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-f8f6d02859ae45` from `pub_dev` as `registry_expansion`
