...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/background_downloader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/background_downloader](https://pub.dev/packages/background_downloader) |
| Source record ids | pub_dev-a1d97a81329bf9 |

## System Engineer Summary

A multi-platform background file downloader and uploader. Define the task, enqueue and monitor
progress

## Operational Role

For a systems engineer, background_downloader belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.5.9 | 2026-08-29T15:37:19.988407Z | [https://pub.dev/api/packages/background_downloader](https://pub.dev/api/packages/background_downloader) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/background_downloader` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-a1d97a81329bf9` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| queue | Message Broker | [open](dart-queue-31aae422.md) |
