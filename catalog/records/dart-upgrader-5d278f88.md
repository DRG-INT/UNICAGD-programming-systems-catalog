...
<!-- canonical: https://pub.dev/packages/upgrader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/upgrader](https://pub.dev/packages/upgrader) |
| Source record ids | pub_dev-3c8b62a59663cf |

## System Engineer Summary

Flutter package for prompting users to upgrade when there is a newer version of the app in the
store.

## Operational Role

For a systems engineer, upgrader belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.7.0 | 2026-08-18T13:21:08.386055Z | [https://pub.dev/api/packages/upgrader](https://pub.dev/api/packages/upgrader) |  |
| preview | known | 11.5.0-alpha.1 | 2025-06-01T01:48:07.338355Z | [https://pub.dev/api/packages/upgrader](https://pub.dev/api/packages/upgrader) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/upgrader` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-3c8b62a59663cf` from `pub_dev` as `registry_expansion`
