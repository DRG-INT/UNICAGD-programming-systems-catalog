...
| Source record ids | github_search_webassembly-e0906279928ed1 |
...
For a systems engineer, remko/waforth belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.20.1 | 2024-02-24T08:11:58Z | [https://api.github.com/repos/remko/waforth/releases/latest](https://api.github.com/repos/remko/waforth/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/remko/waforth/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-e0906279928ed1` from `github_search_webassembly` as `registry_expansion`
