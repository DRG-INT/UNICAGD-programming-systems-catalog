...
<!-- canonical: https://github.com/open-services/open-registry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-services/open-registry](https://github.com/open-services/open-registry) |
| Source record ids | github_search_catalogs-c001e1fab471f5 |
...
For a systems engineer, open-services/open-registry belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-26T22:36:15Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c001e1fab471f5` from `github_search_catalogs` as `registry_expansion`
