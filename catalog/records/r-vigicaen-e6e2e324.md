...
<!-- canonical: https://cran.r-project.org/web/packages/vigicaen/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vigicaen/index.html](https://cran.r-project.org/web/packages/vigicaen/index.html) |
| Source record ids | cran_packages_by_date-69c08d7b2851f5 |
...
For a systems engineer, vigicaen belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-09-14 21:20:02 UTC | [https://cran.r-project.org/web/packages/vigicaen/DESCRIPTION](https://cran.r-project.org/web/packages/vigicaen/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vigicaen/DESCRIPTION` at `2026-09-14T22:20:19+00:00`.
...
- `cran_packages_by_date-69c08d7b2851f5` from `cran_packages_by_date` as `registry_expansion`
