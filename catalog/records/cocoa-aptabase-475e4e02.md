...
<!-- canonical: https://aptabase.com/for-swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://aptabase.com/for-swift](https://aptabase.com/for-swift) |
| Source record ids | awesome_list-3a94ab002552dc |
...
For a systems engineer, Aptabase belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2023-05-22 13:00:56 UTC | [https://trunk.cocoapods.org/api/v1/pods/Aptabase](https://trunk.cocoapods.org/api/v1/pods/Aptabase) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Aptabase` at `2026-09-01T07:24:04+00:00`.
...
- `awesome_list-3a94ab002552dc` from `awesome_list` as `registry_expansion`
