...
<!-- canonical: https://crates.io/crates/auto_impl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/auto_impl](https://crates.io/crates/auto_impl) |
| Source record ids | crates_io-a431c6dbe9cd1d |
...
For a systems engineer, auto_impl belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2025-04-09T22:07:12.632059Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a431c6dbe9cd1d` from `crates_io` as `registry_expansion`
