...
| Canonical URL | [https://github.com/stongey/PhotoRestore](https://github.com/stongey/PhotoRestore) |
| Source record ids | github_search_photography-d6fb2e2c1e2306 |

## System Engineer Summary

Python scripts and GIMP plugins for restoring the color of scans of old faded photographs.

## Operational Role

For a systems engineer, stongey/PhotoRestore belongs in the Photography inventory as part of defect
...
- `github_search_photography-d6fb2e2c1e2306` from `github_search_photography` as `registry_expansion`
...
| react-native-camera/react-native-camera | Static Analyzer | [open](photography-react-native-camera-react-native-camera-beed788e.md) |
