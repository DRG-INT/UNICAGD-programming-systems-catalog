...
| Canonical URL | [https://crates.io/crates/actix-tls](https://crates.io/crates/actix-tls) |
| Source record ids | crates_io-22ce00424eb501 |
...
For a systems engineer, actix-tls belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.0 | 2025-11-10T06:50:39.269267Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-22ce00424eb501` from `crates_io` as `registry_expansion`
