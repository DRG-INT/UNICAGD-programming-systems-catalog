...
<!-- canonical: https://github.com/dbcli/mycli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbcli/mycli](https://github.com/dbcli/mycli) |
| Source record ids | github_search_databases-680f7747e5a09a |
...
For a systems engineer, dbcli/mycli belongs in the Databases inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:43:35Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-680f7747e5a09a` from `github_search_databases` as `registry_expansion`
