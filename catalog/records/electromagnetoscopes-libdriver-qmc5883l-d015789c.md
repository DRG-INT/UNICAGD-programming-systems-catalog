...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/libdriver/qmc5883l -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libdriver/qmc5883l](https://github.com/libdriver/qmc5883l) |
| Source record ids | github_search_electromagnetoscopes-ff51ab01f0dbf8 |
...
For a systems engineer, libdriver/qmc5883l belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-30T12:49:07Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-ff51ab01f0dbf8` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ainfosec/FISSURE | Filesystem Os | [open](electromagnetoscopes-ainfosec-fissure-685993bb.md) |
| AlexandreRouma/SDRPlusPlus | Filesystem Os | [open](electromagnetoscopes-alexandrerouma-sdrplusplus-df221116.md) |
| AlexGustafsson/fuse-motion | Filesystem Os | [open](electromagnetoscopes-alexgustafsson-fuse-motion-4e390d02.md) |
| alexysong/tdyno | Filesystem Os | [open](electromagnetoscopes-alexysong-tdyno-3d0cc073.md) |
| alphansahin/mmWaveSDR | Filesystem Os | [open](electromagnetoscopes-alphansahin-mmwavesdr-d631631e.md) |
| ApplikeySolutions/PandoraPlayer | Filesystem Os | [open](electromagnetoscopes-applikeysolutions-pandoraplayer-2a041af3.md) |
| aritchie/sensors | Filesystem Os | [open](electromagnetoscopes-aritchie-sensors-58a78d27.md) |
| balamuruganky/ros_gps_imu_vel_filter | Filesystem Os | [open](electromagnetoscopes-balamuruganky-ros-gps-imu-vel-filter-2ae4ace2.md) |
