...
<!-- canonical: https://github.com/pkulchenko/serpent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pkulchenko/serpent](https://github.com/pkulchenko/serpent) |
| Source record ids | lua-source-272 |
...
For a systems engineer, serpent belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 272}}` |
...
- `lua-source-272` from `master_json` as `source_list_item`
