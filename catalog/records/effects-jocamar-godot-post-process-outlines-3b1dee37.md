...
<!-- canonical: https://github.com/jocamar/Godot-Post-Process-Outlines -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jocamar/Godot-Post-Process-Outlines](https://github.com/jocamar/Godot-Post-Process-Outlines) |
| Source record ids | github_search_effects-325b660cf7d3fe |

## System Engineer Summary

A set of shaders and a custom camera node to easily integrate post process outlines into your game.
Works with both 2D and 3D games.

## Operational Role

For a systems engineer, jocamar/Godot-Post-Process-Outlines belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-02-22T06:19:22Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-325b660cf7d3fe` from `github_search_effects` as `registry_expansion`
