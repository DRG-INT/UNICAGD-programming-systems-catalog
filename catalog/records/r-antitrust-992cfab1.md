...
<!-- canonical: https://cran.r-project.org/web/packages/antitrust/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/antitrust/index.html](https://cran.r-project.org/web/packages/antitrust/index.html) |
| Source record ids | cran_packages_by_date-907c1857d39439 |
...
For a systems engineer, antitrust belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.99.33 | 2026-08-26 03:50:02 UTC | [https://cran.r-project.org/web/packages/antitrust/DESCRIPTION](https://cran.r-project.org/web/packages/antitrust/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/antitrust/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-907c1857d39439` from `cran_packages_by_date` as `registry_expansion`
