...
| Source record ids | corpus-6c8f78b5777e0f |

## System Engineer Summary

Snyk is tracked as a security sast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Snyk belongs in the Node.js/JavaScript inventory as part of supply-chain
...
- `corpus-6c8f78b5777e0f` from `master_json` as `security_sast`
