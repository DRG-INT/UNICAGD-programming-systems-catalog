...
<!-- canonical: https://github.com/jie666-6/UrbanSARFloods -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jie666-6/UrbanSARFloods](https://github.com/jie666-6/UrbanSARFloods) |
| Source record ids | github_search_radars-3a8bef2858fc1f |

## System Engineer Summary

The 1st Sentinel-1 SLC benchmark dataset for large scale flood mapping (open floods and urban
floods), including intensity and coherence.

## Operational Role

For a systems engineer, jie666-6/UrbanSARFloods belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-06T16:14:02Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3a8bef2858fc1f` from `github_search_radars` as `registry_expansion`
