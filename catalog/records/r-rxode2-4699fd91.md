...
<!-- canonical: https://cran.r-project.org/web/packages/rxode2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rxode2/index.html](https://cran.r-project.org/web/packages/rxode2/index.html) |
| Source record ids | cran_packages_by_date-fbb32ced536df9 |
...
For a systems engineer, rxode2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.6 | 2026-08-04 23:00:02 UTC | [https://cran.r-project.org/web/packages/rxode2/DESCRIPTION](https://cran.r-project.org/web/packages/rxode2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rxode2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fbb32ced536df9` from `cran_packages_by_date` as `registry_expansion`
