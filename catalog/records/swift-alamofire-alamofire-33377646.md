...
| Source record ids | github_search_swift-974235b82e633b |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.12.0 | 2026-05-05T01:44:54Z | [https://api.github.com/repos/Alamofire/Alamofire/releases/latest](https://api.github.com/repos/Alamofire/Alamofire/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Alamofire/Alamofire/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-974235b82e633b` from `github_search_swift` as `registry_expansion`
