...
<!-- canonical: https://github.com/michelegz/astro-web-indexer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/michelegz/astro-web-indexer](https://github.com/michelegz/astro-web-indexer) |
| Source record ids | github_search_telescopes-0dabe0fcf4ead5 |

## System Engineer Summary

Web tool to explore and search astronomical data, designed for observatories and astrophotographers

## Operational Role

For a systems engineer, michelegz/astro-web-indexer belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-23T15:27:12Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-0dabe0fcf4ead5` from `github_search_telescopes` as `registry_expansion`
