...
<!-- canonical: https://github.com/SAP/cloud-sdk-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP/cloud-sdk-java](https://github.com/SAP/cloud-sdk-java) |
| Source record ids | github_search_sapjava-68ceedc56e97b4 |

## System Engineer Summary

Use the SAP Cloud SDK for Java to reduce development effort when building applications on SAP
Business Technology Platform that communicate with SAP solutions and services such as SAP S/4HANA
Cloud, SAP SuccessFactors, and many others.

## Operational Role

For a systems engineer, SAP/cloud-sdk-java belongs in the SAPJava inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:52:11Z | gh search repos org:SAP Java | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "org:SAP Java", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_sapjava-68ceedc56e97b4` from `github_search_sapjava` as `registry_expansion`
