...
<!-- canonical: https://github.com/spacetelescope/jwst -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spacetelescope/jwst](https://github.com/spacetelescope/jwst) |
| Source record ids | github_search_space_maps-2638a901136645 |
...
For a systems engineer, spacetelescope/jwst belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:52:41Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2638a901136645` from `github_search_space_maps` as `registry_expansion`
...
| NeelPatra/Micro-Cap-12-Archive | Package Manager | [open](space-maps-neelpatra-micro-cap-12-archive-cb3664f9.md) |
