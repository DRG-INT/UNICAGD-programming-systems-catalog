...
<!-- canonical: https://crates.io/crates/multimap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/multimap](https://crates.io/crates/multimap) |
| Source record ids | crates_io-733baf85b5ba40 |
...
For a systems engineer, multimap belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1 | 2025-05-11T19:27:20.627530Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-733baf85b5ba40` from `crates_io` as `registry_expansion`
