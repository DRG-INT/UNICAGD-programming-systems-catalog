...
<!-- canonical: https://cran.r-project.org/web/packages/MN/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MN/index.html](https://cran.r-project.org/web/packages/MN/index.html) |
| Source record ids | cran_packages_by_date-1a9f858ba187e1 |
...
For a systems engineer, MN belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-09-03 07:20:02 UTC | [https://cran.r-project.org/web/packages/MN/DESCRIPTION](https://cran.r-project.org/web/packages/MN/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MN/DESCRIPTION` at `2026-09-03T08:21:53+00:00`.
...
- `cran_packages_by_date-1a9f858ba187e1` from `cran_packages_by_date` as `registry_expansion`
