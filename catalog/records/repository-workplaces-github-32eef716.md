...
| Source record ids | curated_repository_workplace_routes-f4483bd13cb1ad |

## System Engineer Summary

GitHub public source-code workplace and repository discovery surface for repositories, issues, pull
requests, releases, packages, actions, organizations, and automation APIs.

## Operational Role

For a systems engineer, GitHub belongs in the Repository Workplaces inventory as part of ecosystem
...
- `curated_repository_workplace_routes-f4483bd13cb1ad` from `curated_repository_workplace_routes` as `registry_expansion`
