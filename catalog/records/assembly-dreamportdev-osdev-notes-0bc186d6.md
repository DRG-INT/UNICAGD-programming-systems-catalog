...
| Canonical URL | [https://github.com/dreamportdev/Osdev-Notes](https://github.com/dreamportdev/Osdev-Notes) |
| Source record ids | github_search_assembly-38499739fe5ef5 |
...
For a systems engineer, dreamportdev/Osdev-Notes belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6 | 2026-02-21T15:32:17Z | [https://api.github.com/repos/dreamportdev/Osdev-Notes/releases/latest](https://api.github.com/repos/dreamportdev/Osdev-Notes/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dreamportdev/Osdev-Notes/releases/latest` at `2026-09-01T07:24:25+00:00`.
...
- `github_search_assembly-38499739fe5ef5` from `github_search_assembly` as `registry_expansion`
