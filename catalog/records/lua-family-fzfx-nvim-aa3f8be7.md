...
| Canonical URL | [https://luarocks.org/modules/linrongbin16/fzfx.nvim](https://luarocks.org/modules/linrongbin16/fzfx.nvim) |
| Source record ids | luarocks_root_manifest-f5e4a364bb9a7a |

## System Engineer Summary

FZF-based fuzzy finder running on a dynamic engine that parsing user query and selection on every
keystroke.

## Operational Role

For a systems engineer, fzfx.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f5e4a364bb9a7a` from `luarocks_root_manifest` as `registry_expansion`
