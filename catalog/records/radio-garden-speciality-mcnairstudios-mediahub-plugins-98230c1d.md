# mcnairstudios/mediahub-plugins
...
<!-- canonical: https://github.com/mcnairstudios/mediahub-plugins -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mcnairstudios/mediahub-plugins](https://github.com/mcnairstudios/mediahub-plugins) |
| Source record ids | github_search_radio_garden_speciality-1d18690d6d9b51 |

## System Engineer Summary

WASM source plugins for MediaHub — demo, space launches, radio garden, movie trailers

## Operational Role

For a systems engineer, mcnairstudios/mediahub-plugins belongs in the Radio Garden Speciality
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-07T18:52:30Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-1d18690d6d9b51` from `github_search_radio_garden_speciality` as `registry_expansion`
