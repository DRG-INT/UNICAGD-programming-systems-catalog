...
<!-- canonical: https://hackage.haskell.org/package/interval-algebra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/interval-algebra](https://hackage.haskell.org/package/interval-algebra) |
| Source record ids | hackage_top_downloads-645992250743a6 |
...
For a systems engineer, interval-algebra belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2023-05-26T12:21:22Z | [https://hackage.haskell.org/package/interval-algebra](https://hackage.haskell.org/package/interval-algebra) |  |
| candidate | partial | 0.2.0 |  | [https://hackage.haskell.org/package/interval-algebra](https://hackage.haskell.org/package/interval-algebra) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/interval-algebra` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-645992250743a6` from `hackage_top_downloads` as `registry_expansion`
