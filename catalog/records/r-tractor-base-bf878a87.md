...
<!-- canonical: https://cran.r-project.org/web/packages/tractor.base/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tractor.base/index.html](https://cran.r-project.org/web/packages/tractor.base/index.html) |
| Source record ids | cran_packages_by_date-5ec1adaf4b4982 |
...
For a systems engineer, tractor.base belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.2.1 | 2026-08-21 10:10:02 UTC | [https://cran.r-project.org/web/packages/tractor.base/DESCRIPTION](https://cran.r-project.org/web/packages/tractor.base/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tractor.base/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5ec1adaf4b4982` from `cran_packages_by_date` as `registry_expansion`
