...
<!-- canonical: https://crates.io/crates/rustc-demangle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustc-demangle](https://crates.io/crates/rustc-demangle) |
| Source record ids | crates_io-88e3fb69c72fcc |
...
For a systems engineer, rustc-demangle belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.28 | 2026-07-08T16:08:22.858292Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-10T06:26:04+00:00`.
...
- `crates_io-88e3fb69c72fcc` from `crates_io` as `registry_expansion`
