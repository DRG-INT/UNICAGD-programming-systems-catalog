...
<!-- canonical: https://github.com/burhanrashid52/PhotoEditor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/burhanrashid52/PhotoEditor](https://github.com/burhanrashid52/PhotoEditor) |
| Source record ids | github_search_icons_and_logos-f70abe3b48035f |

## System Engineer Summary

A Photo Editor library with simple, easy support for image editing using paints,text,filters,emoji
and Sticker like stories.

## Operational Role

For a systems engineer, burhanrashid52/PhotoEditor belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T06:24:16Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-f70abe3b48035f` from `github_search_icons_and_logos` as `registry_expansion`
