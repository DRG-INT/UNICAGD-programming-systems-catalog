...
<!-- canonical: https://cran.r-project.org/web/packages/agridatasets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/agridatasets/index.html](https://cran.r-project.org/web/packages/agridatasets/index.html) |
| Source record ids | cran_packages_by_date-f224f1343c29af |
...
For a systems engineer, agridatasets belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-20 23:02:10 UTC | [https://cran.r-project.org/web/packages/agridatasets/DESCRIPTION](https://cran.r-project.org/web/packages/agridatasets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/agridatasets/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f224f1343c29af` from `cran_packages_by_date` as `registry_expansion`
