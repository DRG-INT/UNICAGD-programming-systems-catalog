...
<!-- canonical: https://packagist.org/packages/lichtner/fluentpdo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/lichtner/fluentpdo](https://packagist.org/packages/lichtner/fluentpdo) |
| Source record ids | packagist_search-3624f51ca7833f |

## System Engineer Summary

FluentPDO is a quick and light PHP library for rapid query building. It features a smart join
builder, which automatically creates table joins.

## Operational Role

For a systems engineer, lichtner/fluentpdo belongs in the PHP inventory as part of build graph
...
- `packagist_search-3624f51ca7833f` from `packagist_search` as `registry_expansion`
