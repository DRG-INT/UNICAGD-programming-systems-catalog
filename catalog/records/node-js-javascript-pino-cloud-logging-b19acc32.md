...
| Canonical URL | [https://www.npmjs.com/package/pino-cloud-logging](https://www.npmjs.com/package/pino-cloud-logging) |
| Source record ids | npm_registry-d3e3845ef65627 |

## System Engineer Summary

This package provides a simple configuration to use with Pino to make it adhere to Google Cloud
Logging structured logging.

## Operational Role

For a systems engineer, pino-cloud-logging belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2022-09-03T18:17:05.430Z | [https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-d3e3845ef65627` from `npm_registry` as `registry_expansion`
