...
<!-- canonical: https://crates.io/crates/crossterm_winapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crossterm_winapi](https://crates.io/crates/crossterm_winapi) |
| Source record ids | crates_io-c8d4566c54fbf9 |
...
For a systems engineer, crossterm_winapi belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2023-06-12T18:05:33.496457Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-c8d4566c54fbf9` from `crates_io` as `registry_expansion`
