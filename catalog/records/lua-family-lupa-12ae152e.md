...
| Source record ids | corpus-7512b819a138c1 |

## System Engineer Summary

Lupa is tracked as a ffi bindings record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Lupa belongs in the Lua family inventory as part of cross-language
...
- `corpus-7512b819a138c1` from `master_json` as `ffi_bindings`
