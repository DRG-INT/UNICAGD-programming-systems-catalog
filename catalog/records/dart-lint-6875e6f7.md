...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.10.0 | 2026-09-04T17:20:20.852571Z | [https://pub.dev/api/packages/lint](https://pub.dev/api/packages/lint) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/lint` at `2026-09-04T18:21:07+00:00`.
