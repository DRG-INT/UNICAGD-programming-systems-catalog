...
<!-- canonical: https://cran.r-project.org/web/packages/KernSmooth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/KernSmooth/index.html](https://cran.r-project.org/web/packages/KernSmooth/index.html) |
| Source record ids | cran_packages_by_date-f0acd2e552765f |
...
For a systems engineer, KernSmooth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.23-27 | 2026-08-12 06:40:09 UTC | [https://cran.r-project.org/web/packages/KernSmooth/DESCRIPTION](https://cran.r-project.org/web/packages/KernSmooth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/KernSmooth/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f0acd2e552765f` from `cran_packages_by_date` as `registry_expansion`
