...
<!-- canonical: https://github.com/JiepengTan/LockstepEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JiepengTan/LockstepEngine](https://github.com/JiepengTan/LockstepEngine) |
| Source record ids | github_search_engines-21c2c77e1c2ae8 |

## System Engineer Summary

A lockstep solution include lots of deterministic library
(Math,Collision,Navmesh,BehaviorTree,Serialization ...)

## Operational Role

For a systems engineer, JiepengTan/LockstepEngine belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-03-23T05:36:17Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-21c2c77e1c2ae8` from `github_search_engines` as `registry_expansion`
