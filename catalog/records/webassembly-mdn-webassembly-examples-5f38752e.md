...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mdn/webassembly-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mdn/webassembly-examples](https://github.com/mdn/webassembly-examples) |
| Source record ids | github_search_webassembly-493225722e1353 |

## System Engineer Summary

Code examples that accompany the MDN WebAssembly documentation — see

## Operational Role

For a systems engineer, mdn/webassembly-examples belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-493225722e1353` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| nalgeon/codapi-js | Documentation | [open](webassembly-nalgeon-codapi-js-17b81d12.md) |
| pyscript/pyscript | Documentation | [open](webassembly-pyscript-pyscript-6d2e79e8.md) |
