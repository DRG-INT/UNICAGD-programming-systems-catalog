...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/akka/akka-persistence-jdbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/akka/akka-persistence-jdbc](https://github.com/akka/akka-persistence-jdbc) |
| Source record ids | github_search_magazines-6855975874f1af |

## System Engineer Summary

Asynchronously writes journal and snapshot entries to configured JDBC databases so that Akka Actors
can recover state

## Operational Role

For a systems engineer, akka/akka-persistence-jdbc belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T08:15:49Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-6855975874f1af` from `github_search_magazines` as `registry_expansion`
