...
<!-- canonical: https://github.com/PimpinPumpkin/Vela -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PimpinPumpkin/Vela](https://github.com/PimpinPumpkin/Vela) |
| Source record ids | github_search_maps-023938fd01f086 |

## System Engineer Summary

Degoogled maps & turn-by-turn navigation for Android - MapLibre + Jetpack Compose, no Google Play
Services

## Operational Role

For a systems engineer, PimpinPumpkin/Vela belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T07:02:37Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-023938fd01f086` from `github_search_maps` as `registry_expansion`
