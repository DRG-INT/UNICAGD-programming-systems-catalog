...
<!-- canonical: https://hackage.haskell.org/package/grpc-spec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/grpc-spec](https://hackage.haskell.org/package/grpc-spec) |
| Source record ids | hackage_recent-9d97fd66e22732 |
...
For a systems engineer, grpc-spec belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-02T12:21:56Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-9d97fd66e22732` from `hackage_recent` as `registry_expansion`
