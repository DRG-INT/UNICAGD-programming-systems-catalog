...
<!-- canonical: https://github.com/joergmlpts/usb-camera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joergmlpts/usb-camera](https://github.com/joergmlpts/usb-camera) |
| Source record ids | github_search_microscopy-084a7debe65297 |

## System Engineer Summary

Python code to connect a microscope, or another USB camera, to Linux and show its video stream.

## Operational Role

For a systems engineer, joergmlpts/usb-camera belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-09T02:02:54Z | gh search repos topic:microscope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-084a7debe65297` from `github_search_microscopy` as `registry_expansion`
