...
<!-- canonical: https://hackage.haskell.org/package/hedgehog-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hedgehog-extras](https://hackage.haskell.org/package/hedgehog-extras) |
| Source record ids | hackage_top_downloads-ed232396faf336 |
...
For a systems engineer, hedgehog-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.1.0 | 2025-11-03T22:08:12Z | [https://hackage.haskell.org/package/hedgehog-extras](https://hackage.haskell.org/package/hedgehog-extras) |  |
| candidate | partial | 0.0.0.1 |  | [https://hackage.haskell.org/package/hedgehog-extras](https://hackage.haskell.org/package/hedgehog-extras) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hedgehog-extras` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-ed232396faf336` from `hackage_top_downloads` as `registry_expansion`
