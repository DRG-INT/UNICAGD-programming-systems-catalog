...
<!-- canonical: https://cran.r-project.org/web/packages/brazilmaps/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/brazilmaps/index.html](https://cran.r-project.org/web/packages/brazilmaps/index.html) |
| Source record ids | cran_packages_by_date-7325ad4599eb5e |
...
For a systems engineer, brazilmaps belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-04 10:20:03 UTC | [https://cran.r-project.org/web/packages/brazilmaps/DESCRIPTION](https://cran.r-project.org/web/packages/brazilmaps/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/brazilmaps/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7325ad4599eb5e` from `cran_packages_by_date` as `registry_expansion`
