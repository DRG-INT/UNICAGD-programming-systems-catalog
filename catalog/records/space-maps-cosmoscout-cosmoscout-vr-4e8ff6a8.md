...
<!-- canonical: https://github.com/cosmoscout/cosmoscout-vr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cosmoscout/cosmoscout-vr](https://github.com/cosmoscout/cosmoscout-vr) |
| Source record ids | github_search_space_maps-520978afd356da |

## System Engineer Summary

:milky_way: A virtual universe which lets you explore, analyze and present huge planetary datasets
and large simulation data in real-time.

## Operational Role

For a systems engineer, cosmoscout/cosmoscout-vr belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T14:41:16Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-520978afd356da` from `github_search_space_maps` as `registry_expansion`
