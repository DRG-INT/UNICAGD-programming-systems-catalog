...
<!-- canonical: https://cran.r-project.org/web/packages/gss/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gss/index.html](https://cran.r-project.org/web/packages/gss/index.html) |
| Source record ids | cran_packages_by_date-47ad04abe71f6d |
...
For a systems engineer, gss belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0-0 | 2026-08-19 12:00:02 UTC | [https://cran.r-project.org/web/packages/gss/DESCRIPTION](https://cran.r-project.org/web/packages/gss/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gss/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-47ad04abe71f6d` from `cran_packages_by_date` as `registry_expansion`
