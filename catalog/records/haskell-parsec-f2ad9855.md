...
<!-- canonical: https://hackage.haskell.org/package/parsec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/parsec](https://hackage.haskell.org/package/parsec) |
| Source record ids | hackage_top_downloads-9a0b63586c1a81 |
...
For a systems engineer, parsec belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.18.0 | 2025-01-05T00:08:05Z | [https://hackage.haskell.org/package/parsec](https://hackage.haskell.org/package/parsec) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/parsec` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-9a0b63586c1a81` from `hackage_top_downloads` as `registry_expansion`
