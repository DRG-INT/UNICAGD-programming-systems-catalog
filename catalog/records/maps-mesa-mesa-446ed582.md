...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mesa/mesa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mesa/mesa](https://github.com/mesa/mesa) |
| Source record ids | github_search_maps-3f9276b16ba84e |

## System Engineer Summary

Mesa is an open-source Python library for agent-based modeling, ideal for simulating complex systems
and exploring emergent behaviors.

## Operational Role

For a systems engineer, mesa/mesa belongs in the Maps inventory as part of defect discovery,
...
- `github_search_maps-3f9276b16ba84e` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| antvis/L7 | Static Analyzer | [open](maps-antvis-l7-6780853b.md) |
| c2g-dev/city2graph | Static Analyzer | [open](maps-c2g-dev-city2graph-75122023.md) |
| CosmiQ/solaris | Static Analyzer | [open](maps-cosmiq-solaris-c6ba877b.md) |
| Esri/arcgis-python-api | Static Analyzer | [open](maps-esri-arcgis-python-api-1e7e8d6c.md) |
| gboeing/osmnx | Static Analyzer | [open](maps-gboeing-osmnx-e39532fb.md) |
| gee-community/geemap | Static Analyzer | [open](maps-gee-community-geemap-3a2ab7d7.md) |
| GeoRetina/chat2geo | Static Analyzer | [open](maps-georetina-chat2geo-de4bfd06.md) |
| iamtekson/Leaflet-from-basic-to-advance | Static Analyzer | [open](maps-iamtekson-leaflet-from-basic-to-advance-889350fe.md) |
