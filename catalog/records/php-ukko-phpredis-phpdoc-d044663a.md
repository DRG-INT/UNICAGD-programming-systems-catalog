...
<!-- canonical: https://packagist.org/packages/ukko/phpredis-phpdoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ukko/phpredis-phpdoc](https://packagist.org/packages/ukko/phpredis-phpdoc) |
| Source record ids | packagist_search-d17d7d8d7bb867 |
...
For a systems engineer, ukko/phpredis-phpdoc belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-d17d7d8d7bb867` from `packagist_search` as `registry_expansion`
