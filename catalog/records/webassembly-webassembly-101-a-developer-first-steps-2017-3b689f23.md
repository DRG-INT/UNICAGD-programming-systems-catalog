...
<!-- canonical: http://blog.openbloc.fr/webassembly-first-steps/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://blog.openbloc.fr/webassembly-first-steps/](http://blog.openbloc.fr/webassembly-first-steps/) |
| Source record ids | awesome_list-6c5ad8ec158b39 |

## System Engineer Summary

WebAssembly 101: a developer first steps (2017) is tracked as a tutorial book styleguide record in
the WebAssembly branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, WebAssembly 101: a developer first steps (2017) belongs in the WebAssembly
...
- `awesome_list-6c5ad8ec158b39` from `awesome_list` as `registry_expansion`
