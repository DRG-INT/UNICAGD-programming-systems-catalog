...
<!-- canonical: https://packagist.org/packages/jean85/pretty-package-versions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jean85/pretty-package-versions](https://packagist.org/packages/jean85/pretty-package-versions) |
| Source record ids | packagist_search-01f59dd8614024 |
...
For a systems engineer, jean85/pretty-package-versions belongs in the PHP inventory as part of
...
- `packagist_search-01f59dd8614024` from `packagist_search` as `registry_expansion`
