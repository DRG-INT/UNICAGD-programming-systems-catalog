...
<!-- canonical: https://crates.io/crates/bytesize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bytesize](https://crates.io/crates/bytesize) |
| Source record ids | crates_io-b3979e0d86998e |
...
For a systems engineer, bytesize belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2026-08-02T03:27:39.038202Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-b3979e0d86998e` from `crates_io` as `registry_expansion`
