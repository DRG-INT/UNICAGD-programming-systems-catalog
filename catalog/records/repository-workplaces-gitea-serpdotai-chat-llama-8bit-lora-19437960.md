# Gitea: serpdotai/Chat-LLaMA-8bit-LoRA
...
<!-- canonical: https://gitea.com/serpdotai/Chat-LLaMA-8bit-LoRA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/serpdotai/Chat-LLaMA-8bit-LoRA](https://gitea.com/serpdotai/Chat-LLaMA-8bit-LoRA) |
| Source record ids | gitea_repositories_api-ccd79d0467b38d |

## System Engineer Summary

Repository for training a LoRA for the LLaMA model on HuggingFace with 8-bit quantization. Research
only. 👉 Join our Discord Server for updates, support & collaboration Dataset creation, training,
weight merging, and quantization instructions are in the docs.

## Operational Role

For a systems engineer, Gitea: serpdotai/Chat-LLaMA-8bit-LoRA belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-04T12:21:52Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ccd79d0467b38d` from `gitea_repositories_api` as `registry_expansion`
