...
<!-- canonical: https://cran.r-project.org/web/packages/rasch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rasch/index.html](https://cran.r-project.org/web/packages/rasch/index.html) |
| Source record ids | cran_packages_by_date-54e7c5f7c138c3 |

## System Engineer Summary

Models and Diagnostics for Rasch Measurement Theory

## Operational Role

For a systems engineer, rasch belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12.0 | 2026-08-24 08:40:02 UTC | [https://cran.r-project.org/web/packages/rasch/DESCRIPTION](https://cran.r-project.org/web/packages/rasch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rasch/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-54e7c5f7c138c3` from `cran_packages_by_date` as `registry_expansion`
