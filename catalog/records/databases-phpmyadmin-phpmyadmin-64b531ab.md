...
<!-- canonical: https://github.com/phpmyadmin/phpmyadmin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/phpmyadmin/phpmyadmin](https://github.com/phpmyadmin/phpmyadmin) |
| Source record ids | github_search_databases-fe4892587dc9cb |
...
For a systems engineer, phpmyadmin/phpmyadmin belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:51:37Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fe4892587dc9cb` from `github_search_databases` as `registry_expansion`
