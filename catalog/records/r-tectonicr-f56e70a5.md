...
<!-- canonical: https://cran.r-project.org/web/packages/tectonicr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tectonicr/index.html](https://cran.r-project.org/web/packages/tectonicr/index.html) |
| Source record ids | cran_packages_by_date-4b25495cb58c03 |
...
For a systems engineer, tectonicr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.9 | 2026-08-29 12:50:02 UTC | [https://cran.r-project.org/web/packages/tectonicr/DESCRIPTION](https://cran.r-project.org/web/packages/tectonicr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tectonicr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4b25495cb58c03` from `cran_packages_by_date` as `registry_expansion`
