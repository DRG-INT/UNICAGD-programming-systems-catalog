...
<!-- canonical: https://cran.r-project.org/web/packages/rtiktoken/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rtiktoken/index.html](https://cran.r-project.org/web/packages/rtiktoken/index.html) |
| Source record ids | cran_packages_by_date-e39548241d7e19 |
...
For a systems engineer, rtiktoken belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0.3 | 2026-08-31 18:40:02 UTC | [https://cran.r-project.org/web/packages/rtiktoken/DESCRIPTION](https://cran.r-project.org/web/packages/rtiktoken/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rtiktoken/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e39548241d7e19` from `cran_packages_by_date` as `registry_expansion`
