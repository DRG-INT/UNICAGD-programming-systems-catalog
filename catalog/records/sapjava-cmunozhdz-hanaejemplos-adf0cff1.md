...
<!-- canonical: https://github.com/cmunozhdz/HanaEjemplos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cmunozhdz/HanaEjemplos](https://github.com/cmunozhdz/HanaEjemplos) |
| Source record ids | github_search_sapjava-04598dc99f9a08 |

## System Engineer Summary

Proyectos de java usando la base de datos SAP-Hana

## Operational Role

For a systems engineer, cmunozhdz/HanaEjemplos belongs in the SAPJava inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-19T04:13:34Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-04598dc99f9a08` from `github_search_sapjava` as `registry_expansion`
