...
| Source record ids | github_search_swift-5e1be88ea17bb8 |
...
For a systems engineer, stephencelis/SQLite.swift belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T10:03:46Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-5e1be88ea17bb8` from `github_search_swift` as `registry_expansion`
