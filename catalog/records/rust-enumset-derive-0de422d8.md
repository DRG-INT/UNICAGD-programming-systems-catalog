...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Undefined Behavior Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/undefined-behavior-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/enumset_derive](https://crates.io/crates/enumset_derive) |
| Source record ids | crates_io-47668431916fb8 |
...
For a systems engineer, enumset_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.0 | 2026-05-07T02:09:58.762591Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| ab_glyph_rasterizer | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ab-glyph-rasterizer-464e9603.md) |
| aho-corasick | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aho-corasick-a8e674f0.md) |
| arcstr | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-arcstr-eaa86f7e.md) |
| block-modes | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-block-modes-f7a78757.md) |
| bollard-stubs | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bollard-stubs-cb7e5514.md) |
| console-subscriber | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-console-subscriber-4a7b7eb4.md) |
| ctutils | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ctutils-aacf297f.md) |
| dbl | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dbl-08691b55.md) |
