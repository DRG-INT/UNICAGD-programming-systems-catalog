...
<!-- canonical: https://github.com/gosu/gosu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gosu/gosu](https://github.com/gosu/gosu) |
| Source record ids | github_search_game_engines-fac71715e954bd |
...
For a systems engineer, gosu/gosu belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T16:38:43Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-fac71715e954bd` from `github_search_game_engines` as `registry_expansion`
...
| leereilly/games | Undefined Behavior Analyzer | [open](game-engines-leereilly-games-e26381aa.md) |
