...
| Canonical URL | [https://luarocks.org/modules/fajarhide/hmac-auth-okadoc](https://luarocks.org/modules/fajarhide/hmac-auth-okadoc) |
| Source record ids | luarocks_root_manifest-2601d8b411c06b |

## System Engineer Summary

hmac-auth-okadoc is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, hmac-auth-okadoc belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-2601d8b411c06b` from `luarocks_root_manifest` as `registry_expansion`
