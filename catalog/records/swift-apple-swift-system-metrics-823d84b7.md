...
<!-- canonical: https://github.com/apple/swift-system-metrics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apple/swift-system-metrics](https://github.com/apple/swift-system-metrics) |
| Source record ids | github_search_swift-f11272b093a562 |
...
For a systems engineer, apple/swift-system-metrics belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T15:01:26Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_swift-f11272b093a562` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| osaurus-ai/osaurus | Memory Analyzer | [open](swift-osaurus-ai-osaurus-5748ca92.md) |
