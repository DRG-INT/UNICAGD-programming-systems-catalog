...
<!-- canonical: https://github.com/pgalko/BambooAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pgalko/BambooAI](https://github.com/pgalko/BambooAI) |
| Source record ids | github_search_databases-55244457090055 |
...
For a systems engineer, pgalko/BambooAI belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T04:53:42Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-55244457090055` from `github_search_databases` as `registry_expansion`
