...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Web Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/web-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/dream11/kong-advanced-router](https://luarocks.org/modules/dream11/kong-advanced-router) |
| Source record ids | luarocks_root_manifest-37d2b3e80da8f9 |
...
For a systems engineer, kong-advanced-router belongs in the Lua family inventory as part of request
...
| Name | Category | Page |
| --- | --- | --- |
| alive | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-alive-28e46cce.md) |
| atlas | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-atlas-e05de62f.md) |
| cl | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cl-d27ccc1c.md) |
| DataDumper | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-datadumper-e7ab91a4.md) |
| dromozoa-regexp | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-regexp-5f6583f7.md) |
| fsrouter | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-fsrouter-996a0bba.md) |
| gimlet-cocktail | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gimlet-cocktail-42553e2c.md) |
| gonapps-url-router | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gonapps-url-router-ed6cc04b.md) |
