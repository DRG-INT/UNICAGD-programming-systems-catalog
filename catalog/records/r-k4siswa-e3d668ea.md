...
<!-- canonical: https://cran.r-project.org/web/packages/K4Siswa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/K4Siswa/index.html](https://cran.r-project.org/web/packages/K4Siswa/index.html) |
| Source record ids | cran_packages_by_date-7eca25f0755fb6 |

## System Engineer Summary

Student Context Data Files for TIMSS 2023 Grade 4

## Operational Role

For a systems engineer, K4Siswa belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:50:16 UTC | [https://cran.r-project.org/web/packages/K4Siswa/DESCRIPTION](https://cran.r-project.org/web/packages/K4Siswa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/K4Siswa/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7eca25f0755fb6` from `cran_packages_by_date` as `registry_expansion`
