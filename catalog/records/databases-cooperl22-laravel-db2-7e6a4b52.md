...
<!-- canonical: https://github.com/cooperl22/laravel-db2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cooperl22/laravel-db2](https://github.com/cooperl22/laravel-db2) |
| Source record ids | github_search_databases-e6f1c9118ae022 |

## System Engineer Summary

laravel-db2 is a simple DB2 service provider for Laravel. It provides DB2 Connection by extending
the Illuminate Database component of the laravel framework.

## Operational Role

For a systems engineer, cooperl22/laravel-db2 belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-13T12:41:31Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e6f1c9118ae022` from `github_search_databases` as `registry_expansion`
