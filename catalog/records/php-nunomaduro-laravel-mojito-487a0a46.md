...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Jit Vm](../by-category/jit-vm.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/nunomaduro/laravel-mojito -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nunomaduro/laravel-mojito](https://packagist.org/packages/nunomaduro/laravel-mojito) |
| Source record ids | packagist_search-fa4eda14032658 |
...
For a systems engineer, nunomaduro/laravel-mojito belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-fa4eda14032658` from `packagist_search` as `registry_expansion`
