...
<!-- canonical: https://cran.r-project.org/web/packages/S7schema/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/S7schema/index.html](https://cran.r-project.org/web/packages/S7schema/index.html) |
| Source record ids | cran_packages_by_date-df47af2d83c9c3 |
...
For a systems engineer, S7schema belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-21 22:01:19 UTC | [https://cran.r-project.org/web/packages/S7schema/DESCRIPTION](https://cran.r-project.org/web/packages/S7schema/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/S7schema/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-df47af2d83c9c3` from `cran_packages_by_date` as `registry_expansion`
