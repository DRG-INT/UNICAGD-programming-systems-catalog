...
<!-- canonical: https://luarocks.org/modules/datenlabor/discount3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/datenlabor/discount3](https://luarocks.org/modules/datenlabor/discount3) |
| Source record ids | luarocks_root_manifest-a1898358e6082d |

## System Engineer Summary

Lua bindings for the Discount Markdown library V3

## Operational Role

For a systems engineer, discount3 belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-a1898358e6082d` from `luarocks_root_manifest` as `registry_expansion`
