...
<!-- canonical: https://cran.r-project.org/web/packages/cincinnatiOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cincinnatiOpenData/index.html](https://cran.r-project.org/web/packages/cincinnatiOpenData/index.html) |
| Source record ids | cran_packages_by_date-b2e466747d7e86 |

## System Engineer Summary

A Lightweight Interface to Cincinnati Open Data APIs

## Operational Role

For a systems engineer, cincinnatiOpenData belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:50:06 UTC | [https://cran.r-project.org/web/packages/cincinnatiOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/cincinnatiOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cincinnatiOpenData/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b2e466747d7e86` from `cran_packages_by_date` as `registry_expansion`
