...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/swaggyliu/FlatWorld -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/swaggyliu/FlatWorld](https://github.com/swaggyliu/FlatWorld) |
| Source record ids | github_search_physics_engines-a48d008657e893 |

## System Engineer Summary

2D rigid/soft-body physics engine with simulation data pipeline. Train lightweight world model
StateLeWM to power the interactive game Spirit Push.

## Operational Role

For a systems engineer, swaggyliu/FlatWorld belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:05:57Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a48d008657e893` from `github_search_physics_engines` as `registry_expansion`
