...
<!-- canonical: https://crates.io/crates/asn1-rs-impl -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2025-04-14T12:04:48.354846Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-02T00:28:36+00:00`.
...
- `crates_io-2264021f0e9e2a` from `crates_io` as `registry_expansion`
