...
| Canonical URL | [https://crates.io/crates/sentry](https://crates.io/crates/sentry) |
| Source record ids | crates_io-90a676060f7ac8 |
...
For a systems engineer, sentry belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.49.2 | 2026-08-26T14:42:50.483766Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-90a676060f7ac8` from `crates_io` as `registry_expansion`
