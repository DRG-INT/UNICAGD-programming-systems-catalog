...
<!-- canonical: https://pub.dev/packages/audioplayers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/audioplayers](https://pub.dev/packages/audioplayers) |
| Source record ids | pub_dev-7f57650ec78403 |
...
For a systems engineer, audioplayers belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.8.1 | 2026-06-27T13:47:09.650930Z | [https://pub.dev/api/packages/audioplayers](https://pub.dev/api/packages/audioplayers) |  |
| preview | known | 1.0.0-rc.4 | 2022-05-08T16:54:12.036201Z | [https://pub.dev/api/packages/audioplayers](https://pub.dev/api/packages/audioplayers) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/audioplayers` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-7f57650ec78403` from `pub_dev` as `registry_expansion`
