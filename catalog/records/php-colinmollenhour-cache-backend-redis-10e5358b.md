...
| Canonical URL | [https://packagist.org/packages/colinmollenhour/cache-backend-redis](https://packagist.org/packages/colinmollenhour/cache-backend-redis) |
| Source record ids | packagist_search-b5f7f4491391cd |
...
For a systems engineer, colinmollenhour/cache-backend-redis belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.18.0 | 2026-02-02T07:42:05+00:00 | [https://repo.packagist.org/p2/colinmollenhour/cache-backend-redis.json](https://repo.packagist.org/p2/colinmollenhour/cache-backend-redis.json) |  |
...
| Evidence | BSD-3-Clause-Modification |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/colinmollenhour/cache-backend-redis.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-b5f7f4491391cd` from `packagist_search` as `registry_expansion`
