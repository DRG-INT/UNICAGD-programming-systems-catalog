...
<!-- canonical: https://github.com/caryll/otfcc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/caryll/otfcc](https://github.com/caryll/otfcc) |
| Source record ids | github_search_font_briefcase-86cccea0b5a4bb |
...
For a systems engineer, caryll/otfcc belongs in the Font Briefcase inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-03T19:18:27Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-86cccea0b5a4bb` from `github_search_font_briefcase` as `registry_expansion`
