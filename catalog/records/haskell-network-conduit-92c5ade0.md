...
<!-- canonical: https://hackage.haskell.org/package/network-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-conduit](https://hackage.haskell.org/package/network-conduit) |
| Source record ids | hackage_top_downloads-d2bf3a5f95260e |
...
For a systems engineer, network-conduit belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2014-04-02T08:03:05Z | [https://hackage.haskell.org/package/network-conduit](https://hackage.haskell.org/package/network-conduit) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-conduit` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-d2bf3a5f95260e` from `hackage_top_downloads` as `registry_expansion`
