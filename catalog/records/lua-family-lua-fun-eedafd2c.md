...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Utility Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/utility-library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-ef5f716143ccb5 |

## System Engineer Summary

Lua Fun is tracked as an utility library record in the Lua family branch. The source did not provide
...
For a systems engineer, Lua Fun belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-ef5f716143ccb5` from `master_json` as `utility_library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ansify | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ansify-afcc5bd4.md) |
| arnaudleroy | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-arnaudleroy-ee7c472b.md) |
| dromozoa-dyld | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-dyld-9341feff.md) |
| dromozoa-socks | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-socks-b9c7870e.md) |
| eth-secp256k1 | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-eth-secp256k1-f2c2a233.md) |
| graph-toolkit | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-graph-toolkit-8c33df5e.md) |
| handler-helpers | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-handler-helpers-7f14ff27.md) |
| iptv-org-pro-url-tools | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-iptv-org-pro-url-tools-5590eee5.md) |
