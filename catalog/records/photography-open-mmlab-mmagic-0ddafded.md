...
<!-- canonical: https://github.com/open-mmlab/mmagic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-mmlab/mmagic](https://github.com/open-mmlab/mmagic) |
| Source record ids | github_search_photography-5eb1b12ecb987a |

## System Engineer Summary

OpenMMLab Multimodal Advanced, Generative, and Intelligent Creation Toolbox. Unlock the magic 🪄:
Generative-AI (AIGC), easy-to-use APIs, awsome model zoo, diffusion models, for text-to-image
generation, image/video restoration/enhancement, etc.

## Operational Role

For a systems engineer, open-mmlab/mmagic belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-06T07:19:40Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-5eb1b12ecb987a` from `github_search_photography` as `registry_expansion`
