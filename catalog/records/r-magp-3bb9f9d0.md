...
<!-- canonical: https://cran.r-project.org/web/packages/magp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/magp/index.html](https://cran.r-project.org/web/packages/magp/index.html) |
| Source record ids | cran_packages_by_date-9a450d044c9310 |
...
For a systems engineer, magp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-09-03 11:40:09 UTC | [https://cran.r-project.org/web/packages/magp/DESCRIPTION](https://cran.r-project.org/web/packages/magp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/magp/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-9a450d044c9310` from `cran_packages_by_date` as `registry_expansion`
