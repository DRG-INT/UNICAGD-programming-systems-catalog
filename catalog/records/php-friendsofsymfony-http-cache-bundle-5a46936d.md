...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/friendsofsymfony/http-cache-bundle](https://packagist.org/packages/friendsofsymfony/http-cache-bundle) |
| Source record ids | packagist_search-572abdad743e4c |
...
For a systems engineer, friendsofsymfony/http-cache-bundle belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.1 | 2026-06-08T14:40:25+00:00 | [https://repo.packagist.org/p2/friendsofsymfony/http-cache-bundle.json](https://repo.packagist.org/p2/friendsofsymfony/http-cache-bundle.json) |  |
| preview | known | 2.2.0-alpha1 | 2017-11-09T20:07:24+00:00 | [https://repo.packagist.org/p2/friendsofsymfony/http-cache-bundle.json](https://repo.packagist.org/p2/friendsofsymfony/http-cache-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/friendsofsymfony/http-cache-bundle.json` at `2026-09-01T07:20:23+00:00`.
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-01 | `{"kind": "packagist_search_and_p2_api", "query": "http", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `packagist_search-572abdad743e4c` from `packagist_search` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| amphp/hpack | Networking Http | [open](php-amphp-hpack-880a63cd.md) |
| amphp/http | Networking Http | [open](php-amphp-http-d35d6e59.md) |
| amphp/websocket | Networking Http | [open](php-amphp-websocket-1122914c.md) |
| contributte/redis | Networking Http | [open](php-contributte-redis-588fae9b.md) |
| dflydev/fig-cookies | Networking Http | [open](php-dflydev-fig-cookies-8c9de25d.md) |
| edamov/pushok | Networking Http | [open](php-edamov-pushok-7ffe198c.md) |
| eightpoints/guzzle-bundle | Networking Http | [open](php-eightpoints-guzzle-bundle-0ec077c3.md) |
| fig/http-message-util | Networking Http | [open](php-fig-http-message-util-23ee2d56.md) |
