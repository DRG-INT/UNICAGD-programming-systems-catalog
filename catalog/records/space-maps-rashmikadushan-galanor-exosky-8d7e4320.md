...
<!-- canonical: https://github.com/RashmikaDushan/GalaNor-ExoSky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RashmikaDushan/GalaNor-ExoSky](https://github.com/RashmikaDushan/GalaNor-ExoSky) |
| Source record ids | github_search_space_maps-11c056582c9eed |

## System Engineer Summary

This web app visualizes the night sky from exoplanets using NASA's Exoplanet Archive and star
catalogs, enabling users to create interactive, customizable star charts.

## Operational Role

For a systems engineer, RashmikaDushan/GalaNor-ExoSky belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-10T20:20:19Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-11c056582c9eed` from `github_search_space_maps` as `registry_expansion`
