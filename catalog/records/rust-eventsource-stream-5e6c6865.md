...
| Canonical URL | [https://crates.io/crates/eventsource-stream](https://crates.io/crates/eventsource-stream) |
| Source record ids | crates_io-a4c25b19c2a2d0 |
...
For a systems engineer, eventsource-stream belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2022-02-17T19:33:45.863426Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-a4c25b19c2a2d0` from `crates_io` as `registry_expansion`
