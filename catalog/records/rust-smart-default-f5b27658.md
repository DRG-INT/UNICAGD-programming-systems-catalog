...
| Canonical URL | [https://crates.io/crates/smart-default](https://crates.io/crates/smart-default) |
| Source record ids | crates_io-9ba1c59475a8c8 |
...
For a systems engineer, smart-default belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2023-04-24T15:51:20.102795Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-9ba1c59475a8c8` from `crates_io` as `registry_expansion`
