...
<!-- canonical: https://cocoapods.org/pods/AACustomCollectionViewLayouts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/AACustomCollectionViewLayouts](https://cocoapods.org/pods/AACustomCollectionViewLayouts) |
| Source record ids | cocoapods_cdn-8a820686affea1 |
...
For a systems engineer, AACustomCollectionViewLayouts belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2017-07-03 18:13:20 UTC | [https://trunk.cocoapods.org/api/v1/pods/AACustomCollectionViewLayouts](https://trunk.cocoapods.org/api/v1/pods/AACustomCollectionViewLayouts) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/AACustomCollectionViewLayouts` at `2026-09-01T07:21:27+00:00`.
...
- `cocoapods_cdn-8a820686affea1` from `cocoapods_cdn` as `registry_expansion`
