...
| Canonical URL | [https://github.com/pycroscopy/atomai](https://github.com/pycroscopy/atomai) |
| Source record ids | github_search_microscopy-2d673d692d676d |
...
For a systems engineer, pycroscopy/atomai belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.8.1 | 2025-06-24T07:57:00Z | [https://api.github.com/repos/pycroscopy/atomai/releases/latest](https://api.github.com/repos/pycroscopy/atomai/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/pycroscopy/atomai/releases/latest` at `2026-09-01T08:26:20+00:00`.
...
- `github_search_microscopy-2d673d692d676d` from `github_search_microscopy` as `registry_expansion`
