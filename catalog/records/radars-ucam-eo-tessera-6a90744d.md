...
<!-- canonical: https://github.com/ucam-eo/tessera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ucam-eo/tessera](https://github.com/ucam-eo/tessera) |
| Source record ids | github_search_radars-c4c7dd95999c08 |

## System Engineer Summary

CVPR26 TESSERA is a foundation model that can process time-series satellite imagery for applications
such as land classification and canopy height prediction. Developed at the University of Cambridge,
it enables efficient extraction of temporal patterns from Earth observation

## Operational Role

For a systems engineer, ucam-eo/tessera belongs in the Radars inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T01:32:22Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c4c7dd95999c08` from `github_search_radars` as `registry_expansion`
