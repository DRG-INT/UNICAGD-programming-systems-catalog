...
| Canonical URL | [https://luarocks.org/modules/xriss/gamecake](https://luarocks.org/modules/xriss/gamecake) |
| Source record ids | luarocks_root_manifest-0313e1a68cd6bc |

## System Engineer Summary

gamecake is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, gamecake belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0313e1a68cd6bc` from `luarocks_root_manifest` as `registry_expansion`
