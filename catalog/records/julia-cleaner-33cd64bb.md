...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Cleaner](https://github.com/JuliaRegistries/General/tree/master/C/Cleaner) |
| Source record ids | julia_general-75f2210cc4761c |

## System Engineer Summary

Julia package registered in General at C/Cleaner.

## Operational Role

For a systems engineer, Cleaner belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Cleaner", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-75f2210cc4761c` from `julia_general` as `registry_expansion`
