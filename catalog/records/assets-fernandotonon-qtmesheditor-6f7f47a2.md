...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/fernandotonon/QtMeshEditor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fernandotonon/QtMeshEditor](https://github.com/fernandotonon/QtMeshEditor) |
| Source record ids | github_search_assets-5e82f5f8559761 |

## System Engineer Summary

Free 3D asset tool for indie game developers — merge animations, convert between 40+ 3D formats,
edit materials with AI

## Operational Role

For a systems engineer, fernandotonon/QtMeshEditor belongs in the Assets inventory as part of low-
noise code review, style consistency, and automation-friendly editing.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:51:18Z | gh search repos topic:3d-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:3d-assets stars:>20", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_assets-5e82f5f8559761` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xC0000054/pdn-ddsfiletype-plus | Formatter | [open](assets-0xc0000054-pdn-ddsfiletype-plus-8da0f368.md) |
| aMarCruz/react-native-text-size | Formatter | [open](assets-amarcruz-react-native-text-size-989d2e6b.md) |
| assimp/assimp | Formatter | [open](assets-assimp-assimp-e26f9fa8.md) |
| BlackFoundryCom/InriaFonts | Formatter | [open](assets-blackfoundrycom-inriafonts-1005f303.md) |
| dogoncouch/LogESP | Formatter | [open](assets-dogoncouch-logesp-487d8edc.md) |
| elasota/ConvectionKernels | Formatter | [open](assets-elasota-convectionkernels-1bd72eb9.md) |
| fcamarlinghi/expresso | Formatter | [open](assets-fcamarlinghi-expresso-80b908f5.md) |
| iZePlayzYT/SuperMarioEclipse-TexturePacks | Formatter | [open](assets-izeplayzyt-supermarioeclipse-texturepacks-f6aeecb0.md) |
