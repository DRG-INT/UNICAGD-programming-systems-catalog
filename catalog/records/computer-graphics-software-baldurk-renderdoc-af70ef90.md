...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/baldurk/renderdoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/baldurk/renderdoc](https://github.com/baldurk/renderdoc) |
| Source record ids | github_search_computer_graphics_software-dd21adee7c8393 |
...
For a systems engineer, baldurk/renderdoc belongs in the Computer Graphics Software inventory as
part of fault isolation, live inspection, breakpoints, and production-adjacent diagnosis.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:graphics stars:>1000", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_computer_graphics_software-dd21adee7c8393` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| eug/awesome-opengl | Debugger | [open](computer-graphics-software-eug-awesome-opengl-af405246.md) |
