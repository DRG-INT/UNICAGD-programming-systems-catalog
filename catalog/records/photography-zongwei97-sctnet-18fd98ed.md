...
<!-- canonical: https://github.com/Zongwei97/SCTNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zongwei97/SCTNet](https://github.com/Zongwei97/SCTNet) |
| Source record ids | github_search_photography-f84dbd1e5f346d |

## System Engineer Summary

ICCV 23 Official implementation of Alignment-free HDR Deghosting with Sematnics Consistent
Transformer (Code & Dataset)

## Operational Role

For a systems engineer, Zongwei97/SCTNet belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-01T17:11:52Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f84dbd1e5f346d` from `github_search_photography` as `registry_expansion`
