...
<!-- canonical: https://cran.r-project.org/web/packages/SuperLearner/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SuperLearner/index.html](https://cran.r-project.org/web/packages/SuperLearner/index.html) |
| Source record ids | cran_packages_by_date-a0a0f7ca81e20d |
...
For a systems engineer, SuperLearner belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0-41 | 2026-08-21 22:40:02 UTC | [https://cran.r-project.org/web/packages/SuperLearner/DESCRIPTION](https://cran.r-project.org/web/packages/SuperLearner/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SuperLearner/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a0a0f7ca81e20d` from `cran_packages_by_date` as `registry_expansion`
