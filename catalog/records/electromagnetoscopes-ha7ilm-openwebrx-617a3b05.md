...
| Source record ids | github_search_electromagnetoscopes-d416022cd844f1 |
...
For a systems engineer, ha7ilm/openwebrx belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15 | 2017-05-11T09:01:50Z | [https://api.github.com/repos/ha7ilm/openwebrx/releases/latest](https://api.github.com/repos/ha7ilm/openwebrx/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ha7ilm/openwebrx/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-d416022cd844f1` from `github_search_electromagnetoscopes` as `registry_expansion`
