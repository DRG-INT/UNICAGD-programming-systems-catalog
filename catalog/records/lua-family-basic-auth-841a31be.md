...
<!-- canonical: https://luarocks.org/modules/jairojair/basic-auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jairojair/basic-auth](https://luarocks.org/modules/jairojair/basic-auth) |
| Source record ids | luarocks_root_manifest-ca6eda194a919a |
...
For a systems engineer, basic-auth belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ca6eda194a919a` from `luarocks_root_manifest` as `registry_expansion`
