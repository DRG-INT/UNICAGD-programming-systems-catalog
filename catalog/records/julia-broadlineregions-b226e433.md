...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BroadLineRegions](https://github.com/JuliaRegistries/General/tree/master/B/BroadLineRegions) |
| Source record ids | julia_general-ec0d54ade3862a |

## System Engineer Summary

Julia package registered in General at B/BroadLineRegions.

## Operational Role

For a systems engineer, BroadLineRegions belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BroadLineRegions", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ec0d54ade3862a` from `julia_general` as `registry_expansion`
