...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/rayimage/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rayimage/index.html](https://cran.r-project.org/web/packages/rayimage/index.html) |
| Source record ids | cran_packages_by_date-bcae50920106c9 |
...
For a systems engineer, rayimage belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.1 | 2026-09-13 14:20:02 UTC | [https://cran.r-project.org/web/packages/rayimage/DESCRIPTION](https://cran.r-project.org/web/packages/rayimage/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rayimage/DESCRIPTION` at `2026-09-13T16:19:40+00:00`.
...
- `cran_packages_by_date-bcae50920106c9` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DeCAFS | Image Audio Dsp | [open](r-decafs-0a0e43b1.md) |
| DRIP | Image Audio Dsp | [open](r-drip-69d87f82.md) |
| gasper | Image Audio Dsp | [open](r-gasper-765e7234.md) |
| grayleafspotdata | Image Audio Dsp | [open](r-grayleafspotdata-587a47f0.md) |
| libopenexr | Image Audio Dsp | [open](r-libopenexr-415f6d9f.md) |
| rcicr | Image Audio Dsp | [open](r-rcicr-8cd8aead.md) |
| RNiftyReg | Image Audio Dsp | [open](r-rniftyreg-251ec455.md) |
| tractor.base | Image Audio Dsp | [open](r-tractor-base-bf878a87.md) |
