...
<!-- canonical: https://hackage.haskell.org/package/bugsnag -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bugsnag](https://hackage.haskell.org/package/bugsnag) |
| Source record ids | hackage_recent-15fcfdbd7752f4 |
...
For a systems engineer, bugsnag belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0.4 | 2026-09-04T16:16:13Z | [https://hackage.haskell.org/package/bugsnag](https://hackage.haskell.org/package/bugsnag) |  |
| candidate | partial | 1.1.0.2 |  | [https://hackage.haskell.org/package/bugsnag](https://hackage.haskell.org/package/bugsnag) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bugsnag` at `2026-09-04T17:20:30+00:00`.
...
- `hackage_recent-15fcfdbd7752f4` from `hackage_recent` as `registry_expansion`
