...
<!-- canonical: https://crates.io/crates/unsigned-varint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unsigned-varint](https://crates.io/crates/unsigned-varint) |
| Source record ids | crates_io-993f7ca205cd44 |
...
For a systems engineer, unsigned-varint belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2023-11-01T17:52:24.337696Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-04T00:27:33+00:00`.
...
- `crates_io-993f7ca205cd44` from `crates_io` as `registry_expansion`
