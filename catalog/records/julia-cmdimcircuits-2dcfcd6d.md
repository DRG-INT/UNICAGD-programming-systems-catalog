...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CMDimCircuits](https://github.com/JuliaRegistries/General/tree/master/C/CMDimCircuits) |
| Source record ids | julia_general-97604d29483427 |

## System Engineer Summary

Julia package registered in General at C/CMDimCircuits.

## Operational Role

For a systems engineer, CMDimCircuits belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CMDimCircuits", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-97604d29483427` from `julia_general` as `registry_expansion`
