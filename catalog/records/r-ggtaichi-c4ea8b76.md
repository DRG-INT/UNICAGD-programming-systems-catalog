...
<!-- canonical: https://cran.r-project.org/web/packages/ggtaichi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggtaichi/index.html](https://cran.r-project.org/web/packages/ggtaichi/index.html) |
| Source record ids | cran_packages_by_date-4da473dbae1401 |

## System Engineer Summary

Taichi-Diagram Visualization for Two Data Sources

## Operational Role

For a systems engineer, ggtaichi belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-24 17:40:02 UTC | [https://cran.r-project.org/web/packages/ggtaichi/DESCRIPTION](https://cran.r-project.org/web/packages/ggtaichi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggtaichi/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4da473dbae1401` from `cran_packages_by_date` as `registry_expansion`
