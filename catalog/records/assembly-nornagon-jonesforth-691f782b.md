...
<!-- canonical: https://github.com/nornagon/jonesforth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nornagon/jonesforth](https://github.com/nornagon/jonesforth) |
| Source record ids | github_search_assembly-a412e3a340fb42 |

## System Engineer Summary

nornagon/jonesforth is tracked as a language specification record in the Assembly branch. The source
...
For a systems engineer, nornagon/jonesforth belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-04T16:56:38Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-a412e3a340fb42` from `github_search_assembly` as `registry_expansion`
