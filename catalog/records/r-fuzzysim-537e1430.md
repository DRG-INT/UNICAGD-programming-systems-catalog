...
<!-- canonical: https://cran.r-project.org/web/packages/fuzzySim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fuzzySim/index.html](https://cran.r-project.org/web/packages/fuzzySim/index.html) |
| Source record ids | cran_packages_by_date-87538ebc49a5e2 |
...
For a systems engineer, fuzzySim belongs in the R inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.59 | 2026-08-28 12:10:02 UTC | [https://cran.r-project.org/web/packages/fuzzySim/DESCRIPTION](https://cran.r-project.org/web/packages/fuzzySim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fuzzySim/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-87538ebc49a5e2` from `cran_packages_by_date` as `registry_expansion`
