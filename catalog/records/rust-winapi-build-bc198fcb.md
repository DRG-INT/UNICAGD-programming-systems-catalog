...
| Canonical URL | [https://crates.io/crates/winapi-build](https://crates.io/crates/winapi-build) |
| Source record ids | crates_io-c1547a60ba8dc2 |
...
For a systems engineer, winapi-build belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2015-12-16T00:01:49.263868Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-c1547a60ba8dc2` from `crates_io` as `registry_expansion`
