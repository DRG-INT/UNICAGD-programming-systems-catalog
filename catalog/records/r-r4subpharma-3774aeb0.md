...
<!-- canonical: https://cran.r-project.org/web/packages/r4subpharma/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/r4subpharma/index.html](https://cran.r-project.org/web/packages/r4subpharma/index.html) |
| Source record ids | cran_packages_by_date-812ef7b293c40c |

## System Engineer Summary

'pharmaverse' Adapters for R4SUB Submission Readiness Evidence

## Operational Role

For a systems engineer, r4subpharma belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-11 13:00:02 UTC | [https://cran.r-project.org/web/packages/r4subpharma/DESCRIPTION](https://cran.r-project.org/web/packages/r4subpharma/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/r4subpharma/DESCRIPTION` at `2026-09-11T14:23:14+00:00`.
...
- `cran_packages_by_date-812ef7b293c40c` from `cran_packages_by_date` as `registry_expansion`
