...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChordalGraph](https://github.com/JuliaRegistries/General/tree/master/C/ChordalGraph) |
| Source record ids | julia_general-c383c5088ddf8d |

## System Engineer Summary

Julia package registered in General at C/ChordalGraph.

## Operational Role

For a systems engineer, ChordalGraph belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChordalGraph", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c383c5088ddf8d` from `julia_general` as `registry_expansion`
