...
<!-- canonical: https://github.com/CesiumGS/3d-tiles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CesiumGS/3d-tiles](https://github.com/CesiumGS/3d-tiles) |
| Source record ids | github_search_maps-a89d42477dc158 |
...
For a systems engineer, CesiumGS/3d-tiles belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T19:18:09Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-a89d42477dc158` from `github_search_maps` as `registry_expansion`
