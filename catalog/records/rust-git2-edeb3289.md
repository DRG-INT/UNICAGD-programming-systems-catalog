...
<!-- canonical: https://crates.io/crates/git2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/git2](https://crates.io/crates/git2) |
| Source record ids | crates_io-1060a436aebf7e |

## System Engineer Summary

Bindings to libgit2 for interoperating with git repositories. This library is both threadsafe and
memory safe and allows both reading and writing git repositories.

## Operational Role

For a systems engineer, git2 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.21.0 | 2026-05-18T16:06:09.315886Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-1060a436aebf7e` from `crates_io` as `registry_expansion`
