...
<!-- canonical: https://github.com/RelevanceAI/vectorhub -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RelevanceAI/vectorhub](https://github.com/RelevanceAI/vectorhub) |
| Source record ids | github_search_video-7fd1b997c3f0fe |

## System Engineer Summary

Vector Hub - Library for easy discovery, and consumption of State-of-the-art models to turn data
into vectors. (text2vec, image2vec, video2vec, graph2vec, bert, inception, etc)

## Operational Role

For a systems engineer, RelevanceAI/vectorhub belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-20T01:25:01Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-7fd1b997c3f0fe` from `github_search_video` as `registry_expansion`
