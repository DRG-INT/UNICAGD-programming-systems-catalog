...
<!-- canonical: https://luarocks.org/modules/thegoldenpro/aghpb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thegoldenpro/aghpb](https://luarocks.org/modules/thegoldenpro/aghpb) |
| Source record ids | luarocks_root_manifest-d209baa330757c |
...
For a systems engineer, aghpb belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d209baa330757c` from `luarocks_root_manifest` as `registry_expansion`
