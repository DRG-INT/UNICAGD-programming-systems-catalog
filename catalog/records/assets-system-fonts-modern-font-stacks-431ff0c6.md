...
<!-- canonical: https://github.com/system-fonts/modern-font-stacks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/system-fonts/modern-font-stacks](https://github.com/system-fonts/modern-font-stacks) |
| Source record ids | github_search_assets-d662623dfbfc45 |
...
For a systems engineer, system-fonts/modern-font-stacks belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-10T21:21:49Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d662623dfbfc45` from `github_search_assets` as `registry_expansion`
