...
<!-- canonical: https://cran.r-project.org/web/packages/gghotelling/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gghotelling/index.html](https://cran.r-project.org/web/packages/gghotelling/index.html) |
| Source record ids | cran_packages_by_date-c1dba902e23e2c |
...
For a systems engineer, gghotelling belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-09 06:50:13 UTC | [https://cran.r-project.org/web/packages/gghotelling/DESCRIPTION](https://cran.r-project.org/web/packages/gghotelling/DESCRIPTION) |  |
...
| Evidence | LGPL-3; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gghotelling/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c1dba902e23e2c` from `cran_packages_by_date` as `registry_expansion`
