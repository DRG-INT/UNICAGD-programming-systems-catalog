...
<!-- canonical: https://github.com/systemed/tilemaker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/systemed/tilemaker](https://github.com/systemed/tilemaker) |
| Source record ids | github_search_maps-45c4ed9b7bac8f |
...
For a systems engineer, systemed/tilemaker belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T21:00:10Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-45c4ed9b7bac8f` from `github_search_maps` as `registry_expansion`
