...
| Source record ids | corpus-bf9fcf49270bdb |

## System Engineer Summary

lua-parser is tracked as a parser lexer ast record in the Lua family branch. The source did not
...
For a systems engineer, lua-parser belongs in the Lua family inventory as part of language tooling,
...
- `corpus-bf9fcf49270bdb` from `master_json` as `parser_lexer_ast`
