...
<!-- canonical: https://packagist.org/packages/kreait/firebase-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kreait/firebase-php](https://packagist.org/packages/kreait/firebase-php) |
| Source record ids | packagist_search-1ff5d67440e986 |

## System Engineer Summary

kreait/firebase-php is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, kreait/firebase-php belongs in the PHP inventory as part of service
...
- `packagist_search-1ff5d67440e986` from `packagist_search` as `registry_expansion`
