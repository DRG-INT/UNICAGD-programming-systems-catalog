...
<!-- canonical: https://cran.r-project.org/web/packages/extrafrail/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/extrafrail/index.html](https://cran.r-project.org/web/packages/extrafrail/index.html) |
| Source record ids | cran_packages_by_date-04128ff06d4d2f |
...
For a systems engineer, extrafrail belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.15 | 2026-08-28 21:20:07 UTC | [https://cran.r-project.org/web/packages/extrafrail/DESCRIPTION](https://cran.r-project.org/web/packages/extrafrail/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/extrafrail/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-04128ff06d4d2f` from `cran_packages_by_date` as `registry_expansion`
