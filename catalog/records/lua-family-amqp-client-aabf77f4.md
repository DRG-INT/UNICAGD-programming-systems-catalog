...
<!-- canonical: https://luarocks.org/modules/gsdenys/amqp-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gsdenys/amqp-client](https://luarocks.org/modules/gsdenys/amqp-client) |
| Source record ids | luarocks_root_manifest-8f3f273ab93647 |

## System Engineer Summary

amqp-client is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, amqp-client belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-8f3f273ab93647` from `luarocks_root_manifest` as `registry_expansion`
