...
<!-- canonical: https://luarocks.org/modules/neorocks/cybu.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cybu.nvim](https://luarocks.org/modules/neorocks/cybu.nvim) |
| Source record ids | luarocks_root_manifest-e041e99b76e70a |

## System Engineer Summary

Neovim plugin that offers context when cycling buffers in the form of a customizable notification
window.

## Operational Role

For a systems engineer, cybu.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e041e99b76e70a` from `luarocks_root_manifest` as `registry_expansion`
