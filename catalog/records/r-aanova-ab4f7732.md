...
<!-- canonical: https://cran.r-project.org/web/packages/aanova/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aanova/index.html](https://cran.r-project.org/web/packages/aanova/index.html) |
| Source record ids | cran_packages_by_date-42c51241cfea1f |

## System Engineer Summary

Robust Ecological and Fisheries Data Analysis and Visualization

## Operational Role

For a systems engineer, aanova belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-10 09:30:15 UTC | [https://cran.r-project.org/web/packages/aanova/DESCRIPTION](https://cran.r-project.org/web/packages/aanova/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aanova/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-42c51241cfea1f` from `cran_packages_by_date` as `registry_expansion`
