...
<!-- canonical: https://cran.r-project.org/web/packages/phylopath/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/phylopath/index.html](https://cran.r-project.org/web/packages/phylopath/index.html) |
| Source record ids | cran_packages_by_date-d13e28588a0add |
...
For a systems engineer, phylopath belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-20 09:20:02 UTC | [https://cran.r-project.org/web/packages/phylopath/DESCRIPTION](https://cran.r-project.org/web/packages/phylopath/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/phylopath/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d13e28588a0add` from `cran_packages_by_date` as `registry_expansion`
