...
<!-- canonical: https://pub.dev/packages/in_app_review -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/in_app_review](https://pub.dev/packages/in_app_review) |
| Source record ids | pub_dev-7639f98c5803f2 |

## System Engineer Summary

Flutter plugin for showing the In-App Review/System Rating pop up on Android, iOS and MacOS. It
makes it easy for users to rate your app.

## Operational Role

For a systems engineer, in_app_review belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.12 | 2026-05-15T13:02:25.768745Z | [https://pub.dev/api/packages/in_app_review](https://pub.dev/api/packages/in_app_review) |  |
| preview | known | 2.0.1-dev | 2021-03-03T14:35:12.131403Z | [https://pub.dev/api/packages/in_app_review](https://pub.dev/api/packages/in_app_review) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/in_app_review` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-7639f98c5803f2` from `pub_dev` as `registry_expansion`
