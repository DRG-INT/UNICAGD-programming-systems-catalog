...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/teckel12/LuaTelemetry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/teckel12/LuaTelemetry](https://github.com/teckel12/LuaTelemetry) |
| Source record ids | github_search_radars-f86012ef7ba2ff |

## System Engineer Summary

FrSky SmartPort(S.Port), D-series, F.Port and TBS Crossfire telemetry on all Taranis and Horus
transmitters

## Operational Role

For a systems engineer, teckel12/LuaTelemetry belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.7.5 | 2021-02-28T20:45:40Z | [https://api.github.com/repos/teckel12/LuaTelemetry/releases/latest](https://api.github.com/repos/teckel12/LuaTelemetry/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/teckel12/LuaTelemetry/releases/latest` at `2026-09-01T08:26:32+00:00`.
...
- `github_search_radars-f86012ef7ba2ff` from `github_search_radars` as `registry_expansion`
