...
<!-- canonical: https://pub.dev/packages/shamsi_date -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shamsi_date](https://pub.dev/packages/shamsi_date) |
| Source record ids | pub_dev-2a2147f1201aba |

## System Engineer Summary

A Flutter and Dart package for using Jalali (Shamsi, Solar, Persian, Jalaali or شمسی) calendar. You
can convert, format and manipulate Jalali and Gregorian (Miladi) date and times.

## Operational Role

For a systems engineer, shamsi_date belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-07-15T03:41:45.197329Z | [https://pub.dev/api/packages/shamsi_date](https://pub.dev/api/packages/shamsi_date) |  |
| preview | known | 0.11.0-nullsafety.0 | 2021-02-06T16:26:00.395407Z | [https://pub.dev/api/packages/shamsi_date](https://pub.dev/api/packages/shamsi_date) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shamsi_date` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-2a2147f1201aba` from `pub_dev` as `registry_expansion`
