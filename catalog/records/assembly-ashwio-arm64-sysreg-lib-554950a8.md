...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ashwio/arm64-sysreg-lib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ashwio/arm64-sysreg-lib](https://github.com/ashwio/arm64-sysreg-lib) |
| Source record ids | github_search_assembly-9de58a5786efbb |

## System Engineer Summary

Header-only C library for reading/writing 64-bit Arm registers, automatically generated by parsing
the AArch64 System Register XML.

## Operational Role

For a systems engineer, ashwio/arm64-sysreg-lib belongs in the Assembly inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-26T21:10:50Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-9de58a5786efbb` from `github_search_assembly` as `registry_expansion`
