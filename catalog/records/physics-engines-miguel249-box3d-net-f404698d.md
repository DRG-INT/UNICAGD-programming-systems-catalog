...
<!-- canonical: https://github.com/Miguel249/Box3D.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Miguel249/Box3D.NET](https://github.com/Miguel249/Box3D.NET) |
| Source record ids | github_search_physics_engines-a9771a782145b3 |

## System Engineer Summary

An idiomatic C# binding for Box3D, Erin Catto's 3D physics engine. No managed allocations on the
simulation hot path, NativeAOT- and trimming-ready, with native binaries for Windows, Linux and
macOS on x64 and arm64.

## Operational Role

For a systems engineer, Miguel249/Box3D.NET belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T12:20:56Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a9771a782145b3` from `github_search_physics_engines` as `registry_expansion`
