...
<!-- canonical: https://pub.dev/packages/pdfx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pdfx](https://pub.dev/packages/pdfx) |
| Source record ids | pub_dev-7c0a4e2b097aae |
...
For a systems engineer, pdfx belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.0 | 2026-08-20T13:18:46.850883Z | [https://pub.dev/api/packages/pdfx](https://pub.dev/api/packages/pdfx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pdfx` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-7c0a4e2b097aae` from `pub_dev` as `registry_expansion`
