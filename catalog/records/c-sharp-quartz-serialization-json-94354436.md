...
<!-- canonical: https://www.nuget.org/packages/Quartz.Serialization.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Quartz.Serialization.Json](https://www.nuget.org/packages/Quartz.Serialization.Json) |
| Source record ids | nuget_search-d678f952e565e8 |
...
For a systems engineer, Quartz.Serialization.Json belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.20.0 | 2026-08-27T19:37:24.58+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/quartz.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/quartz.serialization.json/index.json) |  |
| preview | known | 3.0.0-beta1 | 2017-10-08T10:53:29.083+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/quartz.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/quartz.serialization.json/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; Apache-2.0; https://www.nuget.org/packages/Quartz.Serialization.Json/3.20.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/quartz.serialization.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-d678f952e565e8` from `nuget_search` as `registry_expansion`
