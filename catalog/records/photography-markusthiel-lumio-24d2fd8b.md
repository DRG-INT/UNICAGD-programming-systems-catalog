...
<!-- canonical: https://github.com/markusthiel/lumio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/markusthiel/lumio](https://github.com/markusthiel/lumio) |
| Source record ids | github_search_photography-15ed3a06d245fb |

## System Engineer Summary

Self-hosted client galleries for photographers — proofing, image selection, print shop, AI tagging.
GDPR-native, your data stays with you. A source-available alternative to Pixieset & Picdrop.

## Operational Role

For a systems engineer, markusthiel/lumio belongs in the Photography inventory as part of interface
...
- `github_search_photography-15ed3a06d245fb` from `github_search_photography` as `registry_expansion`
