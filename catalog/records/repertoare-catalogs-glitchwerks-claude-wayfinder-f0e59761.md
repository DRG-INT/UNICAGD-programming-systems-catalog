...
<!-- canonical: https://github.com/glitchwerks/claude-wayfinder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/glitchwerks/claude-wayfinder](https://github.com/glitchwerks/claude-wayfinder) |
| Source record ids | github_search_repertoare_catalogs-5221b8375e5c43 |

## System Engineer Summary

Deterministic, auditable agent/skill dispatch for Claude Code. A typed seven-decision scoring kernel
runs after the router has read the conversation — post-cognitive routing instead of prose-scanning.
Auto-generates its catalog from skill sidecars and agent frontmatter.

## Operational Role

For a systems engineer, glitchwerks/claude-wayfinder belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:26:04Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-5221b8375e5c43` from `github_search_repertoare_catalogs` as `registry_expansion`
