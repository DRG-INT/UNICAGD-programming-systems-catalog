...
| Source record ids | hackage_recent-c9f3000d2a5b8e |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hls-test-utils` at `2026-09-04T13:25:56+00:00`.
...
- `hackage_recent-c9f3000d2a5b8e` from `hackage_recent` as `registry_expansion`
