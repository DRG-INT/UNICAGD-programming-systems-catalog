...
<!-- canonical: https://github.com/fortiql/data-forge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fortiql/data-forge](https://github.com/fortiql/data-forge) |
| Source record ids | github_search_databases-f188640db1ff38 |

## System Engineer Summary

Data Forge — a modern data stack playground to practice flows and best practices, not just tools.
Spark, Trino, Kafka, Iceberg, ClickHouse, Airflow, MinIO, Superset — all wired together locally with
Docker Compose.

## Operational Role

For a systems engineer, fortiql/data-forge belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-11T09:01:25Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f188640db1ff38` from `github_search_databases` as `registry_expansion`
