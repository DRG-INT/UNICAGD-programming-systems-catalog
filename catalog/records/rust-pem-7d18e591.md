...
<!-- canonical: https://crates.io/crates/pem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pem](https://crates.io/crates/pem) |
| Source record ids | crates_io-c4558e3de7dee0 |
...
For a systems engineer, pem belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-07-28T13:38:46.529827Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-c4558e3de7dee0` from `crates_io` as `registry_expansion`
