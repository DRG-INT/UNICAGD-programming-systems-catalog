...
<!-- canonical: https://pub.dev/packages/audio_waveforms -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/audio_waveforms](https://pub.dev/packages/audio_waveforms) |
| Source record ids | pub_dev-42dea4251bd068 |
...
For a systems engineer, audio_waveforms belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-01-09T11:59:16.583870Z | [https://pub.dev/api/packages/audio_waveforms](https://pub.dev/api/packages/audio_waveforms) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/audio_waveforms` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-42dea4251bd068` from `pub_dev` as `registry_expansion`
