...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/twpayne/go-geom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/twpayne/go-geom](https://github.com/twpayne/go-geom) |
| Source record ids | github_search_maps-57d3496dae7d5a |
...
For a systems engineer, twpayne/go-geom belongs in the Maps inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T19:57:18Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_maps-57d3496dae7d5a` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crazycapivara/h3-r | Ffi Bindings | [open](maps-crazycapivara-h3-r-7a69cf02.md) |
| Gaia3D/mago-3d-tiler | Ffi Bindings | [open](maps-gaia3d-mago-3d-tiler-ef3c4fa4.md) |
| geoserver/geoserver | Ffi Bindings | [open](maps-geoserver-geoserver-be5dd005.md) |
| geotools/geotools | Ffi Bindings | [open](maps-geotools-geotools-a7928212.md) |
| mvexel/overpass-api-python-wrapper | Ffi Bindings | [open](maps-mvexel-overpass-api-python-wrapper-3ec1fd9d.md) |
| naturalatlas/node-gdal | Ffi Bindings | [open](maps-naturalatlas-node-gdal-bc3c7bb2.md) |
| osmcode/pyosmium | Ffi Bindings | [open](maps-osmcode-pyosmium-236a85f5.md) |
| rtuszik/photon-docker | Ffi Bindings | [open](maps-rtuszik-photon-docker-df6fa4fc.md) |
