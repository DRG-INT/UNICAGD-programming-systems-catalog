...
<!-- canonical: https://github.com/s60sc/ESP32-CAM_MJPEG2SD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/s60sc/ESP32-CAM_MJPEG2SD](https://github.com/s60sc/ESP32-CAM_MJPEG2SD) |
| Source record ids | github_search_video-a4e93c6aef0c15 |

## System Engineer Summary

ESP32 Camera motion capture application to record JPEGs to SD card as AVI files and stream to
browser as MJPEG. If a microphone is installed then a WAV file is also created. Files can be
uploaded via FTP or downloaded to browser.

## Operational Role

For a systems engineer, s60sc/ESP32-CAM_MJPEG2SD belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T01:04:03Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_video-a4e93c6aef0c15` from `github_search_video` as `registry_expansion`
