...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitableCorpus](https://github.com/JuliaRegistries/General/tree/master/C/CitableCorpus) |
| Source record ids | julia_general-e0e0b61bd7f108 |

## System Engineer Summary

Julia package registered in General at C/CitableCorpus.

## Operational Role

For a systems engineer, CitableCorpus belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CitableCorpus", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e0e0b61bd7f108` from `julia_general` as `registry_expansion`
