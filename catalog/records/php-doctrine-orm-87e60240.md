...
| Canonical URL | [https://packagist.org/packages/doctrine/orm](https://packagist.org/packages/doctrine/orm) |
| Source record ids | packagist_search-ba052c001d5b7f |
...
For a systems engineer, doctrine/orm belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.8 | 2026-08-05T19:06:34+00:00 | [https://repo.packagist.org/p2/doctrine/orm.json](https://repo.packagist.org/p2/doctrine/orm.json) |  |
| preview | known | 3.0.0-RC1 | 2024-01-28T16:39:58+00:00 | [https://repo.packagist.org/p2/doctrine/orm.json](https://repo.packagist.org/p2/doctrine/orm.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/doctrine/orm.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-ba052c001d5b7f` from `packagist_search` as `registry_expansion`
