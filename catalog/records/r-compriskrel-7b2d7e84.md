...
<!-- canonical: https://cran.r-project.org/web/packages/CompRiskRel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CompRiskRel/index.html](https://cran.r-project.org/web/packages/CompRiskRel/index.html) |
| Source record ids | cran_packages_by_date-8dc42d424dcc7d |

## System Engineer Summary

Reliability and Competing Risks Analysis under Hybrid Censoring

## Operational Role

For a systems engineer, CompRiskRel belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:30:11 UTC | [https://cran.r-project.org/web/packages/CompRiskRel/DESCRIPTION](https://cran.r-project.org/web/packages/CompRiskRel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CompRiskRel/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8dc42d424dcc7d` from `cran_packages_by_date` as `registry_expansion`
