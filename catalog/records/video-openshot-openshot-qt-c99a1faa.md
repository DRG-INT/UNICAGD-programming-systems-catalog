...
| Canonical URL | [https://github.com/OpenShot/openshot-qt](https://github.com/OpenShot/openshot-qt) |
| Source record ids | github_search_video-1a6cd11907bac5 |

## System Engineer Summary

OpenShot Video Editor is an award-winning free and open-source video editor for Linux, Mac, and
Windows, and is dedicated to delivering high quality video editing and animation solutions to the
world.

## Operational Role

For a systems engineer, OpenShot/openshot-qt belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.0.0 | 2026-08-30T18:03:38Z | [https://api.github.com/repos/OpenShot/openshot-qt/releases/latest](https://api.github.com/repos/OpenShot/openshot-qt/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OpenShot/openshot-qt/releases/latest` at `2026-09-01T09:23:26+00:00`.
...
- `github_search_video-1a6cd11907bac5` from `github_search_video` as `registry_expansion`
