...
| Source record ids | corpus-506dcfc10fbb4e |

## System Engineer Summary

Esprima is tracked as a parser lexer ast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Esprima belongs in the Node.js/JavaScript inventory as part of language
...
- `corpus-506dcfc10fbb4e` from `master_json` as `parser_lexer_ast`
