...
[Catalog index](../index.md) · [Language: Braces](../by-language/braces.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://editorconfig.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://editorconfig.org/](https://editorconfig.org/) |
| Source record ids | curated_language_routes-76c93ec1411e9e |

## System Engineer Summary

Cross-editor configuration format used with formatters and editors to keep indentation and brace-
adjacent layout consistent.

## Operational Role

For a systems engineer, EditorConfig belongs in the Braces inventory as part of ecosystem capability
...
- `curated_language_routes-76c93ec1411e9e` from `curated_language_routes` as `registry_expansion`
