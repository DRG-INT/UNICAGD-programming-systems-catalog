...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Name | Category | Page |
| --- | --- | --- |
| aws-sdk-sts | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-sdk-sts-4cfb0f29.md) |
| cargo-audit | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-audit-c60e4666.md) |
| cargo-geiger | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-geiger-32a45576.md) |
| cargo-semver-checks | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-semver-checks-8d894f1c.md) |
| cargo-vet | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-vet-8488044c.md) |
| mimalloc | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-mimalloc-e7d4274d.md) |
| security-framework-sys | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-security-framework-sys-04a0e5a5.md) |
