...
<!-- canonical: https://github.com/git-up/GitUp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/git-up/GitUp](https://github.com/git-up/GitUp) |
| Source record ids | github_search_cocoa-56ae0d745f058f |
...
For a systems engineer, git-up/GitUp belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T00:05:17Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-56ae0d745f058f` from `github_search_cocoa` as `registry_expansion`
