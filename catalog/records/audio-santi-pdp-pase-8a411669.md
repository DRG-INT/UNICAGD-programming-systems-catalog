...
<!-- canonical: https://github.com/santi-pdp/pase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/santi-pdp/pase](https://github.com/santi-pdp/pase) |
| Source record ids | github_search_audio-89cf47f6860175 |
...
For a systems engineer, santi-pdp/pase belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-06T21:26:17Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-89cf47f6860175` from `github_search_audio` as `registry_expansion`
