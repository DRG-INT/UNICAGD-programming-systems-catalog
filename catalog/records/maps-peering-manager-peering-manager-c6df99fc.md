...
<!-- canonical: https://github.com/peering-manager/peering-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peering-manager/peering-manager](https://github.com/peering-manager/peering-manager) |
| Source record ids | github_search_maps-d51a479e7c92ab |
...
For a systems engineer, peering-manager/peering-manager belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T06:59:36Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d51a479e7c92ab` from `github_search_maps` as `registry_expansion`
