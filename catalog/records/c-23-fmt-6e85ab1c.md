...
| Source record ids | master-932e39bb93b5 |

## System Engineer Summary

fmt is tracked as a library record in the C++23 branch. The source did not provide a long
...
For a systems engineer, fmt belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `master-932e39bb93b5` from `master_json` as `library`
