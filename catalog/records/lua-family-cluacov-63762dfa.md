...
<!-- canonical: https://luarocks.org/modules/lunarmodules/cluacov -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lunarmodules/cluacov](https://luarocks.org/modules/lunarmodules/cluacov) |
| Source record ids | luarocks_root_manifest-a7eed92f7e5e96 |

## System Engineer Summary

cluacov is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cluacov belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a7eed92f7e5e96` from `luarocks_root_manifest` as `registry_expansion`
