# cabralbrcwb/incident-management
...
<!-- canonical: https://github.com/cabralbrcwb/incident-management -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cabralbrcwb/incident-management](https://github.com/cabralbrcwb/incident-management) |
| Source record ids | github_search_sapjava-e690084b01d0ee |

## System Engineer Summary

Uma aplicação full-stack para gerenciamento de incidentes, desenvolvida com o SAP Cloud Application
Programming Model (CAP) usando Java e implantada na SAP Business Technology Platform (BTP).

## Operational Role

For a systems engineer, cabralbrcwb/incident-management belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-10T09:46:47Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_sapjava-e690084b01d0ee` from `github_search_sapjava` as `registry_expansion`
