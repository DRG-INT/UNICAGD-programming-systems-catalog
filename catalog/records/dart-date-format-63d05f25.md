...
<!-- canonical: https://pub.dev/packages/date_format -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/date_format](https://pub.dev/packages/date_format) |
| Source record ids | pub_dev-373c16c465e6b7 |

## System Engineer Summary

A simple API to format dates. Provides various constants to build Date format string. Use
`formatDate` method to format date according to format string.

## Operational Role

For a systems engineer, date_format belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.9 | 2024-08-21T12:07:39.330098Z | [https://pub.dev/api/packages/date_format](https://pub.dev/api/packages/date_format) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/date_format` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-373c16c465e6b7` from `pub_dev` as `registry_expansion`
