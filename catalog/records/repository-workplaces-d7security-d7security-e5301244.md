...
<!-- canonical: https://gitlab.com/d7security/d7security -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/d7security/d7security](https://gitlab.com/d7security/d7security) |
| Source record ids | gitlab_projects_api-d2cf29da9d9558 |

## System Engineer Summary

Main D7Security project for discussions and support. Also holds the list of supported Drupal 7
projects and their Update XML.

## Operational Role

For a systems engineer, d7security/d7security belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-d2cf29da9d9558` from `gitlab_projects_api` as `registry_expansion`
