...
<!-- canonical: https://github.com/3lvis/SwiftSync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/3lvis/SwiftSync](https://github.com/3lvis/SwiftSync) |
| Source record ids | github_search_cocoa-38c63af20aa508 |
...
For a systems engineer, 3lvis/SwiftSync belongs in the Cocoa inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-27T09:58:57Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-38c63af20aa508` from `github_search_cocoa` as `registry_expansion`
