...
<!-- canonical: https://github.com/izayoijiichan/VGO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/izayoijiichan/VGO](https://github.com/izayoijiichan/VGO) |
| Source record ids | github_search_effects-ec2d24f5fc88b7 |

## System Engineer Summary

VGO is a 3D data format for Unity that can store Mesh, Texture, Material, Collider, Rigidbody, Cloth
and Particle information.

## Operational Role

For a systems engineer, izayoijiichan/VGO belongs in the Effects inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-18T12:50:36Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ec2d24f5fc88b7` from `github_search_effects` as `registry_expansion`
