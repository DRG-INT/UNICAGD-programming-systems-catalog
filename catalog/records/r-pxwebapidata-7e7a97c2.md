...
<!-- canonical: https://cran.r-project.org/web/packages/PxWebApiData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PxWebApiData/index.html](https://cran.r-project.org/web/packages/PxWebApiData/index.html) |
| Source record ids | cran_packages_by_date-10982cffe06c8e |

## System Engineer Summary

PxWebApiData is tracked as an api abi checker record in the R branch. The source did not provide a
...
For a systems engineer, PxWebApiData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-09 09:40:08 UTC | [https://cran.r-project.org/web/packages/PxWebApiData/DESCRIPTION](https://cran.r-project.org/web/packages/PxWebApiData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PxWebApiData/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-10982cffe06c8e` from `cran_packages_by_date` as `registry_expansion`
