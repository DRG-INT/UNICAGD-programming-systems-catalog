...
<!-- canonical: https://packagist.org/packages/nette/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nette/database](https://packagist.org/packages/nette/database) |
| Source record ids | packagist_search-347e6360e0bb51 |

## System Engineer Summary

💾 Nette Database: layer with a familiar PDO-like API but much more powerful. Building queries,
advanced joins, drivers for MySQL, PostgreSQL, SQLite, MS SQL Server and Oracle.

## Operational Role

For a systems engineer, nette/database belongs in the PHP inventory as part of build graph control,
...
- `packagist_search-347e6360e0bb51` from `packagist_search` as `registry_expansion`
