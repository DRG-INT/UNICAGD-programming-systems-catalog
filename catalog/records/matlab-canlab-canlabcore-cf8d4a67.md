...
<!-- canonical: https://github.com/canlab/CanlabCore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/canlab/CanlabCore](https://github.com/canlab/CanlabCore) |
| Source record ids | github_search_matlab-30b256b8746f68 |

## System Engineer Summary

Core tools required for running Canlab Matlab toolboxes. The heart of this toolbox is object-
oriented tools that enable interactive analysis of neuroimaging data and simple scripts using high-
level commands tailored to neuroimaging analysis.

## Operational Role

For a systems engineer, canlab/CanlabCore belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T18:18:26Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
| Evidence | SEE LICENSE IN LICENSE; Other |
...
- `github_search_matlab-30b256b8746f68` from `github_search_matlab` as `registry_expansion`
