...
<!-- canonical: https://packagist.org/packages/ml/json-ld -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ml/json-ld](https://packagist.org/packages/ml/json-ld) |
| Source record ids | packagist_search-121f8443ac1e0d |
...
For a systems engineer, ml/json-ld belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-121f8443ac1e0d` from `packagist_search` as `registry_expansion`
