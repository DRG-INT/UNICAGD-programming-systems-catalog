...
<!-- canonical: https://packagist.org/packages/codeception/codeception -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/codeception/codeception](https://packagist.org/packages/codeception/codeception) |
| Source record ids | packagist_search-0c7a64c15c7409 |
...
For a systems engineer, codeception/codeception belongs in the PHP inventory as part of
...
- `packagist_search-0c7a64c15c7409` from `packagist_search` as `registry_expansion`
