...
<!-- canonical: https://docs.gitlab.com/ci/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.gitlab.com/ci/](https://docs.gitlab.com/ci/) |
| Source record ids | curated_repository_workplace_routes-bec92d89564ee1 |

## System Engineer Summary

GitLab pipeline system for build, test, release, deployment, package, security, and environment
automation.

## Operational Role

For a systems engineer, GitLab CI/CD belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-bec92d89564ee1` from `curated_repository_workplace_routes` as `registry_expansion`
