...
| Canonical URL | [https://github.com/morkt/GARbro](https://github.com/morkt/GARbro) |
| Source record ids | github_search_audio-cd2d938c6546d6 |
...
For a systems engineer, morkt/GARbro belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.5.44 | 2019-03-31T17:45:13Z | [https://api.github.com/repos/morkt/GARbro/releases/latest](https://api.github.com/repos/morkt/GARbro/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/morkt/GARbro/releases/latest` at `2026-09-01T09:23:18+00:00`.
...
- `github_search_audio-cd2d938c6546d6` from `github_search_audio` as `registry_expansion`
