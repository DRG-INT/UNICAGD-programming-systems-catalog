...
<!-- canonical: https://github.com/facebookresearch/MultiModalExplorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/facebookresearch/MultiModalExplorer](https://github.com/facebookresearch/MultiModalExplorer) |
| Source record ids | github_search_space_maps-8b1cba473e700d |

## System Engineer Summary

Visualize multi-model embedding spaces. The first goal is to quickly get a lay of the land of any
embedding space. Then be able to scroll, zoom, search (via any modality text, image, audio etc) .

## Operational Role

For a systems engineer, facebookresearch/MultiModalExplorer belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-16T10:32:56Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8b1cba473e700d` from `github_search_space_maps` as `registry_expansion`
