...
<!-- canonical: https://cran.r-project.org/web/packages/naive/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/naive/index.html](https://cran.r-project.org/web/packages/naive/index.html) |
| Source record ids | cran_packages_by_date-803a5c529f325e |
...
For a systems engineer, naive belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-07 20:50:02 UTC | [https://cran.r-project.org/web/packages/naive/DESCRIPTION](https://cran.r-project.org/web/packages/naive/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/naive/DESCRIPTION` at `2026-09-07T22:19:06+00:00`.
...
- `cran_packages_by_date-803a5c529f325e` from `cran_packages_by_date` as `registry_expansion`
...
| gseries | Datetime | [open](r-gseries-a7e7405a.md) |
| heims | Datetime | [open](r-heims-9499322e.md) |
| markovchain | Datetime | [open](r-markovchain-c93d8c55.md) |
