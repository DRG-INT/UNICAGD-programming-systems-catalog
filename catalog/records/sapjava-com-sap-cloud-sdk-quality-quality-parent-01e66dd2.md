# com.sap.cloud.sdk.quality:quality-parent

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.sdk.quality/quality-parent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.sdk.quality/quality-parent](https://central.sonatype.com/artifact/com.sap.cloud.sdk.quality/quality-parent) |
| Source record ids | maven_central_search-4f3e1423d7a4ed |
...
For a systems engineer, com.sap.cloud.sdk.quality:quality-parent belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.78.0 | 2022-12-19T12:43:37+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json) |  |
...
- `maven_central_search-4f3e1423d7a4ed` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| xurxovega/poc-sap-integration-java | Precommit Ci Quality | [open](sapjava-xurxovega-poc-sap-integration-java-5825ab03.md) |
