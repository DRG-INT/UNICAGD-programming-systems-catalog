...
<!-- canonical: https://cran.r-project.org/web/packages/CGNM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CGNM/index.html](https://cran.r-project.org/web/packages/CGNM/index.html) |
| Source record ids | cran_packages_by_date-6440f5db08b8f8 |
...
For a systems engineer, CGNM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-09-13 08:00:02 UTC | [https://cran.r-project.org/web/packages/CGNM/DESCRIPTION](https://cran.r-project.org/web/packages/CGNM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CGNM/DESCRIPTION` at `2026-09-13T08:20:51+00:00`.
...
- `cran_packages_by_date-6440f5db08b8f8` from `cran_packages_by_date` as `registry_expansion`
