...
<!-- canonical: https://cran.r-project.org/web/packages/prinsurf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prinsurf/index.html](https://cran.r-project.org/web/packages/prinsurf/index.html) |
| Source record ids | cran_packages_by_date-8397f9bbbe504b |
...
For a systems engineer, prinsurf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-09-09 12:20:02 UTC | [https://cran.r-project.org/web/packages/prinsurf/DESCRIPTION](https://cran.r-project.org/web/packages/prinsurf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prinsurf/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-8397f9bbbe504b` from `cran_packages_by_date` as `registry_expansion`
