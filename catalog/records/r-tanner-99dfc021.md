...
<!-- canonical: https://cran.r-project.org/web/packages/tanner/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tanner/index.html](https://cran.r-project.org/web/packages/tanner/index.html) |
| Source record ids | cran_packages_by_date-7fecefa9ba0849 |
...
For a systems engineer, tanner belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-08-06 13:10:02 UTC | [https://cran.r-project.org/web/packages/tanner/DESCRIPTION](https://cran.r-project.org/web/packages/tanner/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tanner/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7fecefa9ba0849` from `cran_packages_by_date` as `registry_expansion`
