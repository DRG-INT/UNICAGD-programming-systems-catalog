...
<!-- canonical: https://github.com/jeecgboot/MiniDao -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeecgboot/MiniDao](https://github.com/jeecgboot/MiniDao) |
| Source record ids | github_search_databases-6ce1d397033a6c |

## System Engineer Summary

一个比 MyBatis 更轻量的 Java 持久化框架，无缝集成springboot项目

## Operational Role

For a systems engineer, jeecgboot/MiniDao belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T01:46:01Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6ce1d397033a6c` from `github_search_databases` as `registry_expansion`
