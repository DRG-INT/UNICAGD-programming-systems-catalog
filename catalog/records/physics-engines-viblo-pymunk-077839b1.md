...
<!-- canonical: https://github.com/viblo/pymunk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/viblo/pymunk](https://github.com/viblo/pymunk) |
| Source record ids | github_search_physics_engines-c07b34b7d1bacd |

## System Engineer Summary

Pymunk is a easy-to-use pythonic 2d physics library that can be used whenever you need 2d rigid body
physics from Python

## Operational Role

For a systems engineer, viblo/pymunk belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-06T06:53:29Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-c07b34b7d1bacd` from `github_search_physics_engines` as `registry_expansion`
