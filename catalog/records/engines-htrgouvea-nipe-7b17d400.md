...
<!-- canonical: https://github.com/htrgouvea/nipe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/htrgouvea/nipe](https://github.com/htrgouvea/nipe) |
| Source record ids | github_search_engines-31068b177514f1 |
...
For a systems engineer, htrgouvea/nipe belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-27T10:01:13Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-31068b177514f1` from `github_search_engines` as `registry_expansion`
