...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/junidy/parallel-dsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/junidy/parallel-dsp](https://github.com/junidy/parallel-dsp) |
| Source record ids | github_search_effects-1f0d7f535ff8ab |

## System Engineer Summary

Multithreading DSP for real-time audio effects

## Operational Role

For a systems engineer, junidy/parallel-dsp belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-16T14:54:35Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1f0d7f535ff8ab` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| blazejkustra/react-native-effects | Concurrency Parallelism | [open](effects-blazejkustra-react-native-effects-f28ddf4f.md) |
