...
<!-- canonical: https://pypi.org/project/ab-auth-client-service/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-auth-client-service/](https://pypi.org/project/ab-auth-client-service/) |
| Source record ids | pypi_simple-eb22a388e1ac4a |

## System Engineer Summary

ab-auth-client-service is tracked as a networking http record in the Python branch. The source did
...
For a systems engineer, ab-auth-client-service belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.5 | 2026-03-01T07:14:17.732610Z | [https://pypi.org/pypi/ab-auth-client-service/json](https://pypi.org/pypi/ab-auth-client-service/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-auth-client-service/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-eb22a388e1ac4a` from `pypi_simple` as `registry_expansion`
