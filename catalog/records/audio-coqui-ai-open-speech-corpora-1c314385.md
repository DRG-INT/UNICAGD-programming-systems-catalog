...
<!-- canonical: https://github.com/coqui-ai/open-speech-corpora -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coqui-ai/open-speech-corpora](https://github.com/coqui-ai/open-speech-corpora) |
| Source record ids | github_search_audio-0e1e98f7518338 |
...
For a systems engineer, coqui-ai/open-speech-corpora belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-06T11:33:44Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-0e1e98f7518338` from `github_search_audio` as `registry_expansion`
