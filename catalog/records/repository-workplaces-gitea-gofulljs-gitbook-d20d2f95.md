...
<!-- canonical: https://gitea.com/gofulljs/gitbook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/gofulljs/gitbook](https://gitea.com/gofulljs/gitbook) |
| Source record ids | gitea_repositories_api-2716987559a012 |
...
For a systems engineer, Gitea: gofulljs/gitbook belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-13T10:05:55Z | [https://gitea.com/api/v1/repos/search?q=documentation&limit=50](https://gitea.com/api/v1/repos/search?q=documentation&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-2716987559a012` from `gitea_repositories_api` as `registry_expansion`
