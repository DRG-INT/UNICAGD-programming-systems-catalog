...
<!-- canonical: https://cran.r-project.org/web/packages/GMTM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GMTM/index.html](https://cran.r-project.org/web/packages/GMTM/index.html) |
| Source record ids | cran_packages_by_date-be6aa7a33faf90 |

## System Engineer Summary

Gaussian Mixture Text Models for Topic Analysis

## Operational Role

For a systems engineer, GMTM belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 11:20:09 UTC | [https://cran.r-project.org/web/packages/GMTM/DESCRIPTION](https://cran.r-project.org/web/packages/GMTM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GMTM/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-be6aa7a33faf90` from `cran_packages_by_date` as `registry_expansion`
