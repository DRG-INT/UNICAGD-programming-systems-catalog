...
| Canonical URL | [https://github.com/SciML/SciMLBenchmarks.jl](https://github.com/SciML/SciMLBenchmarks.jl) |
| Source record ids | github_search_matlab-79b3baba9afaab |

## System Engineer Summary

Scientific machine learning (SciML) benchmarks, AI for science, and (differential) equation solvers.
Covers Julia, Python (PyTorch, Jax), MATLAB, R

## Operational Role

For a systems engineer, SciML/SciMLBenchmarks.jl belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.0 | 2026-08-27T21:43:14Z | [https://api.github.com/repos/SciML/SciMLBenchmarks.jl/releases/latest](https://api.github.com/repos/SciML/SciMLBenchmarks.jl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SciML/SciMLBenchmarks.jl/releases/latest` at `2026-09-01T07:24:13+00:00`.
...
- `github_search_matlab-79b3baba9afaab` from `github_search_matlab` as `registry_expansion`
