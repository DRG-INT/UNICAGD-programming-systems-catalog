...
<!-- canonical: https://github.com/stlin256/OpenHomepage-V2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stlin256/OpenHomepage-V2](https://github.com/stlin256/OpenHomepage-V2) |
| Source record ids | github_search_magazines-d301f77e875ea0 |

## System Engineer Summary

🎓 Modern magazine-style academic & developer homepage generator built with Astro 5. Features BibTeX
publications, local WYSIWYG editor, i18n, KaTeX, and privacy-first CI/CD.

## Operational Role

For a systems engineer, stlin256/OpenHomepage-V2 belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:17:45Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-d301f77e875ea0` from `github_search_magazines` as `registry_expansion`
