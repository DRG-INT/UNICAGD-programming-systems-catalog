...
<!-- canonical: https://packagist.org/packages/phpmyadmin/sql-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpmyadmin/sql-parser](https://packagist.org/packages/phpmyadmin/sql-parser) |
| Source record ids | packagist_search-cf15b1dd6632e4 |
...
For a systems engineer, phpmyadmin/sql-parser belongs in the PHP inventory as part of language
...
- `packagist_search-cf15b1dd6632e4` from `packagist_search` as `registry_expansion`
