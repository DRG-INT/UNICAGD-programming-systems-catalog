...
<!-- canonical: https://github.com/mauriciojost/olympus-photosync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mauriciojost/olympus-photosync](https://github.com/mauriciojost/olympus-photosync) |
| Source record ids | github_search_photography-d26baeec188340 |

## System Engineer Summary

This simple multi-platform application allows to download media through WIFI from digital Olympus
cameras.

## Operational Role

For a systems engineer, mauriciojost/olympus-photosync belongs in the Photography inventory as part
...
- `github_search_photography-d26baeec188340` from `github_search_photography` as `registry_expansion`
