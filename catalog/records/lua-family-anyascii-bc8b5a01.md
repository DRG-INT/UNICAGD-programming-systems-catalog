...
<!-- canonical: https://luarocks.org/modules/fita-slovo/anyascii -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fita-slovo/anyascii](https://luarocks.org/modules/fita-slovo/anyascii) |
| Source record ids | luarocks_root_manifest-edf62750a4af77 |
...
For a systems engineer, AnyAscii belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-edf62750a4af77` from `luarocks_root_manifest` as `registry_expansion`
