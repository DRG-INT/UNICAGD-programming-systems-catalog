...
| Source record ids | corpus-e4d81fc827de30 |

## System Engineer Summary

LuaSQL is tracked as a database datastore record in the Lua family branch. The source did not
...
For a systems engineer, LuaSQL belongs in the Lua family inventory as part of state persistence,
...
- `corpus-e4d81fc827de30` from `master_json` as `database_datastore`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| lua-resty-redis | Database Datastore | [open](lua-family-lua-resty-redis-c3192ca1.md) |
| lua-source-301 | Database Datastore | [open](lua-family-lua-source-301-2bf30dc0.md) |
| pgmoon | Database Datastore | [open](lua-family-pgmoon-2c31413e.md) |
| redis-lua | Database Datastore | [open](lua-family-redis-lua-4027de8b.md) |
