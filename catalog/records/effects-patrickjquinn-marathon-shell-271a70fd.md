...
<!-- canonical: https://github.com/patrickjquinn/Marathon-Shell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/patrickjquinn/Marathon-Shell](https://github.com/patrickjquinn/Marathon-Shell) |
| Source record ids | github_search_effects-e36dff345d3270 |

## System Engineer Summary

Marathon OS: a Qt6/QML mobile shell and Wayland compositor, its first-party apps, and the packaging
that builds a bootable image for Librem 5, Raspberry Pi, OnePlus 6 and QEMU.

## Operational Role

For a systems engineer, patrickjquinn/Marathon-Shell belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:33:23Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e36dff345d3270` from `github_search_effects` as `registry_expansion`
