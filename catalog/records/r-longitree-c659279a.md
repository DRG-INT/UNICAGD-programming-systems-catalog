...
<!-- canonical: https://cran.r-project.org/web/packages/longitree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/longitree/index.html](https://cran.r-project.org/web/packages/longitree/index.html) |
| Source record ids | cran_packages_by_date-fd20bec3a43c3a |
...
For a systems engineer, longitree belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-26 14:40:03 UTC | [https://cran.r-project.org/web/packages/longitree/DESCRIPTION](https://cran.r-project.org/web/packages/longitree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/longitree/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fd20bec3a43c3a` from `cran_packages_by_date` as `registry_expansion`
