...
| Source type | benchmarking |
| Verification | unverified_seed |
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Chairmarks](https://github.com/JuliaRegistries/General/tree/master/C/Chairmarks) |
| Source record ids | corpus-2eda59ae7b56d5 |

## System Engineer Summary

Chairmarks.jl is tracked as a benchmarking record in the Julia branch. The source did not provide a
...
For a systems engineer, Chairmarks.jl belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.3.1 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/C/Chairmarks/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/C/Chairmarks/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-2eda59ae7b56d5` from `master_json` as `benchmarking`
