...
| Canonical URL | [https://luarocks.org/modules/oka/env](https://luarocks.org/modules/oka/env) |
| Source record ids | luarocks_root_manifest-cc3ab9d652c372 |

## System Engineer Summary

Environment & sandbox import utility

## Operational Role

For a systems engineer, env belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-cc3ab9d652c372` from `luarocks_root_manifest` as `registry_expansion`
