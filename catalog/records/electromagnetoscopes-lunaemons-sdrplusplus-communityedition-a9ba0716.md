# LunaeMons/SDRPlusPlus_CommunityEdition
...
<!-- canonical: https://github.com/LunaeMons/SDRPlusPlus_CommunityEdition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LunaeMons/SDRPlusPlus_CommunityEdition](https://github.com/LunaeMons/SDRPlusPlus_CommunityEdition) |
| Source record ids | github_search_electromagnetoscopes-2104d852b19309 |

## System Engineer Summary

🎵 SDR++CE Community Edition - Advanced SDR software with MPX analysis, cross-platform support for
RTL-SDR, HackRF, LimeSDR, AirSpy, PlutoSDR and more. Features real-time FM broadcasting analysis,
frequency scanning, and spectrum visualization.

## Operational Role

For a systems engineer, LunaeMons/SDRPlusPlus_CommunityEdition belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-08T18:44:29Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-2104d852b19309` from `github_search_electromagnetoscopes` as `registry_expansion`
