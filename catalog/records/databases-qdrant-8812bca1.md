...
<!-- canonical: https://github.com/qdrant/qdrant -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qdrant/qdrant](https://github.com/qdrant/qdrant) |
| Source record ids | curated_database_systems-1db0eebef6c200 |

## System Engineer Summary

Vector database and similarity search engine.

## Operational Role

For a systems engineer, Qdrant belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-1db0eebef6c200` from `curated_database_systems` as `registry_expansion`
