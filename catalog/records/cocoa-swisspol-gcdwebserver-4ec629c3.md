...
<!-- canonical: https://github.com/swisspol/GCDWebServer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/swisspol/GCDWebServer](https://github.com/swisspol/GCDWebServer) |
| Source record ids | github_search_cocoa-89f435251f288e |
...
For a systems engineer, swisspol/GCDWebServer belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-05T03:56:25Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-89f435251f288e` from `github_search_cocoa` as `registry_expansion`
