...
<!-- canonical: https://luarocks.org/modules/kingmichaelpark/age.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kingmichaelpark/age.nvim](https://luarocks.org/modules/kingmichaelpark/age.nvim) |
| Source record ids | luarocks_root_manifest-e7d3610340312d |

## System Engineer Summary

load secrets from age encrypted text files

## Operational Role

For a systems engineer, age.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e7d3610340312d` from `luarocks_root_manifest` as `registry_expansion`
