...
<!-- canonical: https://github.com/caddyserver/caddy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/caddyserver/caddy](https://github.com/caddyserver/caddy) |
| Source record ids | github_search_go-8bb5e6c86a7181 |
...
For a systems engineer, caddyserver/caddy belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T14:48:08Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_go-8bb5e6c86a7181` from `github_search_go` as `registry_expansion`
