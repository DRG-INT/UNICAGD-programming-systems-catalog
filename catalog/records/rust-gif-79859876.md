...
<!-- canonical: https://crates.io/crates/gif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gif](https://crates.io/crates/gif) |
| Source record ids | crates_io-11e7b6a426893b |

## System Engineer Summary

gif is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, gif belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.2 | 2026-04-09T19:00:07.494155Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-11e7b6a426893b` from `crates_io` as `registry_expansion`
