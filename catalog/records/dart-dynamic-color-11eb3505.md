...
<!-- canonical: https://pub.dev/packages/dynamic_color -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dynamic_color](https://pub.dev/packages/dynamic_color) |
| Source record ids | pub_dev-e756c5a303d00b |

## System Engineer Summary

A Flutter package to create Material color schemes based on a platform's implementation of dynamic
color.

## Operational Role

For a systems engineer, dynamic_color belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-20T16:48:11.504485Z | [https://pub.dev/api/packages/dynamic_color](https://pub.dev/api/packages/dynamic_color) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dynamic_color` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-e756c5a303d00b` from `pub_dev` as `registry_expansion`
