...
<!-- canonical: https://cran.r-project.org/web/packages/WebGestaltR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/WebGestaltR/index.html](https://cran.r-project.org/web/packages/WebGestaltR/index.html) |
| Source record ids | cran_packages_by_date-78c83eda6cabac |
...
For a systems engineer, WebGestaltR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-05 12:30:02 UTC | [https://cran.r-project.org/web/packages/WebGestaltR/DESCRIPTION](https://cran.r-project.org/web/packages/WebGestaltR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/WebGestaltR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-78c83eda6cabac` from `cran_packages_by_date` as `registry_expansion`
