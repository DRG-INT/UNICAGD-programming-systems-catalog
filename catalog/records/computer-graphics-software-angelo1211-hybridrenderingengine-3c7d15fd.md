...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Angelo1211/HybridRenderingEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Angelo1211/HybridRenderingEngine](https://github.com/Angelo1211/HybridRenderingEngine) |
| Source record ids | github_search_computer_graphics_software-1f48c1d9de7853 |

## System Engineer Summary

Clustered Forward/Deferred renderer with Physically Based Shading, Image Based Lighting and a whole
lot of OpenGL.

## Operational Role

For a systems engineer, Angelo1211/HybridRenderingEngine belongs in the Computer Graphics Software
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-16 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:3d-graphics stars:>100", "retrieved": "2026-09-16", "status": "forge-cli-derived"}` |
...
- `github_search_computer_graphics_software-1f48c1d9de7853` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AmbientRun/Ambient | Game Engine Game Dev | [open](computer-graphics-software-ambientrun-ambient-e668ce18.md) |
| asc-community/MxEngine | Game Engine Game Dev | [open](computer-graphics-software-asc-community-mxengine-fd5ec386.md) |
| ezEngine/ezEngine | Game Engine Game Dev | [open](computer-graphics-software-ezengine-ezengine-78ec6246.md) |
| fegennari/3DWorld | Game Engine Game Dev | [open](computer-graphics-software-fegennari-3dworld-233d051a.md) |
| Gforcex/OpenGraphic | Game Engine Game Dev | [open](computer-graphics-software-gforcex-opengraphic-5ec0d484.md) |
| kitao/pyxel | Game Engine Game Dev | [open](computer-graphics-software-kitao-pyxel-a00a4293.md) |
| PardCode/CPP-3D-Game-Tutorial-Series | Game Engine Game Dev | [open](computer-graphics-software-pardcode-cpp-3d-game-tutorial-series-c37a9001.md) |
| stevinz/awesome-game-engine-dev | Game Engine Game Dev | [open](computer-graphics-software-stevinz-awesome-game-engine-dev-b7327e6c.md) |
