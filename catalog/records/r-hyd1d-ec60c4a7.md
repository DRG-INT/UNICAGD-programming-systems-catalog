...
<!-- canonical: https://cran.r-project.org/web/packages/hyd1d/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hyd1d/index.html](https://cran.r-project.org/web/packages/hyd1d/index.html) |
| Source record ids | cran_packages_by_date-f71328fce760ea |
...
For a systems engineer, hyd1d belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.5 | 2026-08-19 17:00:02 UTC | [https://cran.r-project.org/web/packages/hyd1d/DESCRIPTION](https://cran.r-project.org/web/packages/hyd1d/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hyd1d/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f71328fce760ea` from `cran_packages_by_date` as `registry_expansion`
