...
| Canonical URL | [https://github.com/skymanbp/autoshade](https://github.com/skymanbp/autoshade) |
| Source record ids | github_search_photography-988509dfc781e1 |

## System Engineer Summary

AI-assisted RAW photo developer: GPT vision advisor proposes an EditRecipe, a deterministic Rust
engine renders it — Lightroom-compatible XMP sidecars, 24 RAW formats + baked images, measured (not
guessed) Lightroom mask geometry, local GUI/web UI, AI denoise & segmentation sidecars

## Operational Role

For a systems engineer, skymanbp/autoshade belongs in the Photography inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2026-09-01T05:18:17Z | [https://api.github.com/repos/skymanbp/autoshade/releases/latest](https://api.github.com/repos/skymanbp/autoshade/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/skymanbp/autoshade/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-988509dfc781e1` from `github_search_photography` as `registry_expansion`
