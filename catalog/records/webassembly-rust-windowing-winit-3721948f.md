...
<!-- canonical: https://github.com/rust-windowing/winit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rust-windowing/winit](https://github.com/rust-windowing/winit) |
| Source record ids | github_search_webassembly-8efc608ffbe7f1 |
...
For a systems engineer, rust-windowing/winit belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T10:12:40Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-8efc608ffbe7f1` from `github_search_webassembly` as `registry_expansion`
