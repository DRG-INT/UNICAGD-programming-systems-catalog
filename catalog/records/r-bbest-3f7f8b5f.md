...
<!-- canonical: https://cran.r-project.org/web/packages/BBEST/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BBEST/index.html](https://cran.r-project.org/web/packages/BBEST/index.html) |
| Source record ids | cran_packages_by_date-c9e509bfffe353 |
...
For a systems engineer, BBEST belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-9 | 2026-09-04 11:10:02 UTC | [https://cran.r-project.org/web/packages/BBEST/DESCRIPTION](https://cran.r-project.org/web/packages/BBEST/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BBEST/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-c9e509bfffe353` from `cran_packages_by_date` as `registry_expansion`
