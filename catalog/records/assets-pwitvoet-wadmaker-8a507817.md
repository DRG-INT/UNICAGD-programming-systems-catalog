...
<!-- canonical: https://github.com/pwitvoet/wadmaker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pwitvoet/wadmaker](https://github.com/pwitvoet/wadmaker) |
| Source record ids | github_search_assets-d9a97f23174f96 |
...
For a systems engineer, pwitvoet/wadmaker belongs in the Assets inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-12T09:52:36Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-d9a97f23174f96` from `github_search_assets` as `registry_expansion`
