...
<!-- canonical: https://cran.r-project.org/web/packages/BMisc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BMisc/index.html](https://cran.r-project.org/web/packages/BMisc/index.html) |
| Source record ids | cran_packages_by_date-d163660ae3ebe1 |
...
For a systems engineer, BMisc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.10 | 2026-08-22 16:10:03 UTC | [https://cran.r-project.org/web/packages/BMisc/DESCRIPTION](https://cran.r-project.org/web/packages/BMisc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BMisc/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d163660ae3ebe1` from `cran_packages_by_date` as `registry_expansion`
