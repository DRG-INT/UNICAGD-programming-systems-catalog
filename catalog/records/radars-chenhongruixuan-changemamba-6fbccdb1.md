...
<!-- canonical: https://github.com/ChenHongruixuan/ChangeMamba -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChenHongruixuan/ChangeMamba](https://github.com/ChenHongruixuan/ChangeMamba) |
| Source record ids | github_search_radars-e7980b4b4b0456 |

## System Engineer Summary

IEEE TGRS 2024 ChangeMamba: Remote Sensing Change Detection Based on Spatio-Temporal State Space
Model

## Operational Role

For a systems engineer, ChenHongruixuan/ChangeMamba belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T03:46:33Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e7980b4b4b0456` from `github_search_radars` as `registry_expansion`
