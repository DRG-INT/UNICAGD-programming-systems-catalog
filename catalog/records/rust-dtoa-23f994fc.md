...
<!-- canonical: https://crates.io/crates/dtoa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dtoa](https://crates.io/crates/dtoa) |
| Source record ids | crates_io-32176263d652c9 |
...
For a systems engineer, dtoa belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.11 | 2025-12-27T06:45:26.518961Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-32176263d652c9` from `crates_io` as `registry_expansion`
