...
| Canonical URL | [https://github.com/CarGuo/GSYVideoPlayer](https://github.com/CarGuo/GSYVideoPlayer) |
| Source record ids | github_search_video-a50163f13d30ea |

## System Engineer Summary

Video players (IJKplayer, ExoPlayer, MediaPlayer), HTTPS, 16k page size, danmaku (bullet chat)
support, external subtitles, support for filters, watermarks, and GIF screenshots, pre-roll and mid-
roll ads, multiple simultaneous playback, basic seeking/dragging, volume and brightness adjustment,
play-while-cache support

## Operational Role

For a systems engineer, CarGuo/GSYVideoPlayer belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v13.2.1 | 2026-08-19T12:46:18Z | [https://api.github.com/repos/CarGuo/GSYVideoPlayer/releases/latest](https://api.github.com/repos/CarGuo/GSYVideoPlayer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CarGuo/GSYVideoPlayer/releases/latest` at `2026-09-01T09:23:22+00:00`.
...
- `github_search_video-a50163f13d30ea` from `github_search_video` as `registry_expansion`
