...
<!-- canonical: https://crates.io/crates/rustix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustix](https://crates.io/crates/rustix) |
| Source record ids | crates_io-46c9b8ba05b320 |
...
For a systems engineer, rustix belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-02-22T16:22:51.655697Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-46c9b8ba05b320` from `crates_io` as `registry_expansion`
