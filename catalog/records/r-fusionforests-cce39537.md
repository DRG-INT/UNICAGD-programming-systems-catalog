...
<!-- canonical: https://cran.r-project.org/web/packages/FusionForests/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FusionForests/index.html](https://cran.r-project.org/web/packages/FusionForests/index.html) |
| Source record ids | cran_packages_by_date-b3177e66013685 |

## System Engineer Summary

Bayesian Tree Ensembles for Data Fusion and Causal Inference

## Operational Role

For a systems engineer, FusionForests belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-09 06:40:10 UTC | [https://cran.r-project.org/web/packages/FusionForests/DESCRIPTION](https://cran.r-project.org/web/packages/FusionForests/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FusionForests/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b3177e66013685` from `cran_packages_by_date` as `registry_expansion`
