...
<!-- canonical: https://luarocks.org/modules/membphis/api7-dkjson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-dkjson](https://luarocks.org/modules/membphis/api7-dkjson) |
| Source record ids | luarocks_root_manifest-29412c08400712 |

## System Engineer Summary

api7-dkjson is tracked as a serialization record in the Lua family branch. The source did not
...
For a systems engineer, api7-dkjson belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-29412c08400712` from `luarocks_root_manifest` as `registry_expansion`
