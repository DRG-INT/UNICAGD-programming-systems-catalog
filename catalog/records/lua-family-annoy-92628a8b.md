...
<!-- canonical: https://luarocks.org/modules/starius/annoy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/starius/annoy](https://luarocks.org/modules/starius/annoy) |
| Source record ids | luarocks_root_manifest-01cf89f57d6a59 |
...
For a systems engineer, annoy belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-01cf89f57d6a59` from `luarocks_root_manifest` as `registry_expansion`
