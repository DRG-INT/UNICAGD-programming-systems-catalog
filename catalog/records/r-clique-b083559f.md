...
<!-- canonical: https://cran.r-project.org/web/packages/CLIQUE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CLIQUE/index.html](https://cran.r-project.org/web/packages/CLIQUE/index.html) |
| Source record ids | cran_packages_by_date-b6adb6444db92e |
...
For a systems engineer, CLIQUE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-09 12:40:23 UTC | [https://cran.r-project.org/web/packages/CLIQUE/DESCRIPTION](https://cran.r-project.org/web/packages/CLIQUE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CLIQUE/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-b6adb6444db92e` from `cran_packages_by_date` as `registry_expansion`
