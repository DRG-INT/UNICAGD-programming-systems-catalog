...
<!-- canonical: https://github.com/piellardj/post-treatment-gpu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/piellardj/post-treatment-gpu](https://github.com/piellardj/post-treatment-gpu) |
| Source record ids | github_search_effects-e869b5235ce9de |
...
For a systems engineer, piellardj/post-treatment-gpu belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-11-28T19:07:26Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e869b5235ce9de` from `github_search_effects` as `registry_expansion`
