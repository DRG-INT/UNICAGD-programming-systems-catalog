...
<!-- canonical: https://cran.r-project.org/web/packages/NetSimR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NetSimR/index.html](https://cran.r-project.org/web/packages/NetSimR/index.html) |
| Source record ids | cran_packages_by_date-4554324da29833 |
...
For a systems engineer, NetSimR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-15 11:30:13 UTC | [https://cran.r-project.org/web/packages/NetSimR/DESCRIPTION](https://cran.r-project.org/web/packages/NetSimR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NetSimR/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-4554324da29833` from `cran_packages_by_date` as `registry_expansion`
