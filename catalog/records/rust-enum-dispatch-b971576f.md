...
<!-- canonical: https://crates.io/crates/enum_dispatch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enum_dispatch](https://crates.io/crates/enum_dispatch) |
| Source record ids | crates_io-509f8a1e54f983 |
...
For a systems engineer, enum_dispatch belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.13 | 2024-03-28T16:25:44.789544Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- `crates_io-509f8a1e54f983` from `crates_io` as `registry_expansion`
