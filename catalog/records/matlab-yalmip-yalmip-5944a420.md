...
| Canonical URL | [https://github.com/yalmip/YALMIP](https://github.com/yalmip/YALMIP) |
| Source record ids | github_search_matlab-5490a0f49bd359 |
...
For a systems engineer, yalmip/YALMIP belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | R20250626_fix2 | 2025-06-26T12:32:51Z | [https://api.github.com/repos/yalmip/YALMIP/releases/latest](https://api.github.com/repos/yalmip/YALMIP/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/yalmip/YALMIP/releases/latest` at `2026-09-01T07:24:14+00:00`.
...
- `github_search_matlab-5490a0f49bd359` from `github_search_matlab` as `registry_expansion`
