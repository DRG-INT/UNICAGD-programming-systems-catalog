...
| Canonical URL | [https://crates.io/crates/jsonway](https://crates.io/crates/jsonway) |
| Source record ids | crates_io-530c2d004b06fd |
...
For a systems engineer, jsonway belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2018-03-07T02:54:13.611589Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-530c2d004b06fd` from `crates_io` as `registry_expansion`
