...
<!-- canonical: https://crates.io/crates/quote -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quote](https://crates.io/crates/quote) |
| Source record ids | crates_io-ef3378aaa3f438 |
...
For a systems engineer, quote belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.47 | 2026-07-19T00:16:57.083778Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-ef3378aaa3f438` from `crates_io` as `registry_expansion`
