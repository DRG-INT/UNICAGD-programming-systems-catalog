...
<!-- canonical: https://cran.r-project.org/web/packages/ggchangepoint/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggchangepoint/index.html](https://cran.r-project.org/web/packages/ggchangepoint/index.html) |
| Source record ids | cran_packages_by_date-44c594892758aa |
...
For a systems engineer, ggchangepoint belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-24 18:50:16 UTC | [https://cran.r-project.org/web/packages/ggchangepoint/DESCRIPTION](https://cran.r-project.org/web/packages/ggchangepoint/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggchangepoint/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-44c594892758aa` from `cran_packages_by_date` as `registry_expansion`
