...
<!-- canonical: https://github.com/bytedance/deer-flow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytedance/deer-flow](https://github.com/bytedance/deer-flow) |
| Source record ids | github_search_aims-06b2729acad869 |

## System Engineer Summary

An open-source long-horizon SuperAgent harness that researches, codes, and creates. With the help of
sandboxes, memories, tools, skill, subagents and message gateway, it handles different levels of
tasks that could take minutes to hours.

## Operational Role

For a systems engineer, bytedance/deer-flow belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T03:30:36Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-06b2729acad869` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| sansan0/TrendRadar | Undefined Behavior Analyzer | [open](aim-s-sansan0-trendradar-72e65ee1.md) |
