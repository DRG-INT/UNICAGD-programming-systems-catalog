...
<!-- canonical: http://tylerneylon.com/a/learn-lua/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://tylerneylon.com/a/learn-lua/](http://tylerneylon.com/a/learn-lua/) |
| Source record ids | lua-source-389 |
...
For a systems engineer, Learn Lua in 15 Minutes belongs in the Lua family inventory as part of
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 389}}` |
...
- `lua-source-389` from `master_json` as `source_list_item`
