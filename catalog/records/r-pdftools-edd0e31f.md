...
<!-- canonical: https://cran.r-project.org/web/packages/pdftools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pdftools/index.html](https://cran.r-project.org/web/packages/pdftools/index.html) |
| Source record ids | cran_packages_by_date-6e5ce41c86f818 |
...
For a systems engineer, pdftools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.9.1 | 2026-09-01 10:20:02 UTC | [https://cran.r-project.org/web/packages/pdftools/DESCRIPTION](https://cran.r-project.org/web/packages/pdftools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pdftools/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-6e5ce41c86f818` from `cran_packages_by_date` as `registry_expansion`
