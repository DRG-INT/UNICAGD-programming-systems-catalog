...
<!-- canonical: https://github.com/KonghaYao/cn-font-split -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KonghaYao/cn-font-split](https://github.com/KonghaYao/cn-font-split) |
| Source record ids | github_search_font_briefcase-3dc419705d70e0 |

## System Engineer Summary

划时代的字体切割工具，CJK与任何字符！支持 otf、ttf、woff2 字体多线程切割，完美地细颗粒度地进行包大小控制。A revolutionary font subetter that
supports CJK and any characters! It enables multi-threaded subset of otf, ttf, and woff2 fonts,
allowing for precise control over package size.

## Operational Role

For a systems engineer, KonghaYao/cn-font-split belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-12T13:45:21Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-3dc419705d70e0` from `github_search_font_briefcase` as `registry_expansion`
