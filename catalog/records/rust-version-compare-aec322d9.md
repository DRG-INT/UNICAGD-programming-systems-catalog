...
<!-- canonical: https://crates.io/crates/version-compare -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/version-compare](https://crates.io/crates/version-compare) |
| Source record ids | crates_io-cf9ae3674ab89a |

## System Engineer Summary

Rust library to easily compare version numbers with no specific format, and test against various
comparison operators.

## Operational Role

For a systems engineer, version-compare belongs in the Rust inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2025-10-31T15:57:40.502887Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-cf9ae3674ab89a` from `crates_io` as `registry_expansion`
