...
<!-- canonical: https://github.com/wkjarosz/hdrview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wkjarosz/hdrview](https://github.com/wkjarosz/hdrview) |
| Source record ids | github_search_photography-51c9ef8eae3150 |

## System Engineer Summary

A simple research-oriented image viewer with an emphasis on examining and comparing high-dynamic
range (HDR) images.

## Operational Role

For a systems engineer, wkjarosz/hdrview belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T06:30:10Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-51c9ef8eae3150` from `github_search_photography` as `registry_expansion`
