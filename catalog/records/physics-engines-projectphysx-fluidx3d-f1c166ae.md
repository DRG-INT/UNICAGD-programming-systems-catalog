...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ProjectPhysX/FluidX3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ProjectPhysX/FluidX3D](https://github.com/ProjectPhysX/FluidX3D) |
| Source record ids | github_search_physics_engines-0a61b52841e8d9 |

## System Engineer Summary

The fastest and most memory efficient lattice Boltzmann CFD software, running on all GPUs and CPUs
via OpenCL. Free for non-commercial use.

## Operational Role

For a systems engineer, ProjectPhysX/FluidX3D belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T19:23:12Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-0a61b52841e8d9` from `github_search_physics_engines` as `registry_expansion`
