...
| Canonical URL | [https://github.com/harfbuzz/harfbuzz](https://github.com/harfbuzz/harfbuzz) |
| Source record ids | curated_language_routes-947fa0feb66bba |

## System Engineer Summary

Text shaping engine for font assets, scripts, glyph layout, and rendering pipelines.

## Operational Role

For a systems engineer, HarfBuzz belongs in the Assets inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 14.4.0 | 2026-08-26T19:30:27Z | [https://api.github.com/repos/harfbuzz/harfbuzz/releases/latest](https://api.github.com/repos/harfbuzz/harfbuzz/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/harfbuzz/harfbuzz/releases/latest` at `2026-09-01T07:24:42+00:00`.
...
- `curated_language_routes-947fa0feb66bba` from `curated_language_routes` as `registry_expansion`
...
| TexturePacker | Visualization Gui | [open](assets-texturepacker-1148bb30.md) |
