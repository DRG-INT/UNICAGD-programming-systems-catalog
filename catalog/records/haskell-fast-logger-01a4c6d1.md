...
<!-- canonical: https://hackage.haskell.org/package/fast-logger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fast-logger](https://hackage.haskell.org/package/fast-logger) |
| Source record ids | hackage_top_downloads-834d0ef6fee56a |
...
For a systems engineer, fast-logger belongs in the Haskell inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.7 | 2026-08-06T00:55:13Z | [https://hackage.haskell.org/package/fast-logger](https://hackage.haskell.org/package/fast-logger) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fast-logger` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-834d0ef6fee56a` from `hackage_top_downloads` as `registry_expansion`
