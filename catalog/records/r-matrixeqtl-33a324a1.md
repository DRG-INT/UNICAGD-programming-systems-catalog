...
<!-- canonical: https://cran.r-project.org/web/packages/MatrixEQTL/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MatrixEQTL/index.html](https://cran.r-project.org/web/packages/MatrixEQTL/index.html) |
| Source record ids | cran_packages_by_date-0836421d62a0a0 |
...
For a systems engineer, MatrixEQTL belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4 | 2026-09-02 05:20:47 UTC | [https://cran.r-project.org/web/packages/MatrixEQTL/DESCRIPTION](https://cran.r-project.org/web/packages/MatrixEQTL/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MatrixEQTL/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-0836421d62a0a0` from `cran_packages_by_date` as `registry_expansion`
