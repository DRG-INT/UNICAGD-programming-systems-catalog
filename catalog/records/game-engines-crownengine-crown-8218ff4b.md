...
<!-- canonical: https://github.com/crownengine/crown -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/crownengine/crown](https://github.com/crownengine/crown) |
| Source record ids | github_search_game_engines-9737d81047bb52 |
...
For a systems engineer, crownengine/crown belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:31:36Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-9737d81047bb52` from `github_search_game_engines` as `registry_expansion`
