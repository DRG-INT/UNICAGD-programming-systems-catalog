...
<!-- canonical: https://github.com/AlisamTechnology/ATSCAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlisamTechnology/ATSCAN](https://github.com/AlisamTechnology/ATSCAN) |
| Source record ids | github_search_engines-fed2ec948394ef |
...
For a systems engineer, AlisamTechnology/ATSCAN belongs in the Engines inventory as part of defect
...
- `github_search_engines-fed2ec948394ef` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| TheHive-Project/Cortex | Static Analyzer | [open](engines-thehive-project-cortex-04a9572a.md) |
