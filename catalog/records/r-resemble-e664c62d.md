...
<!-- canonical: https://cran.r-project.org/web/packages/resemble/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/resemble/index.html](https://cran.r-project.org/web/packages/resemble/index.html) |
| Source record ids | cran_packages_by_date-901acf4287a040 |
...
For a systems engineer, resemble belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-08-31 16:30:02 UTC | [https://cran.r-project.org/web/packages/resemble/DESCRIPTION](https://cran.r-project.org/web/packages/resemble/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/resemble/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-901acf4287a040` from `cran_packages_by_date` as `registry_expansion`
