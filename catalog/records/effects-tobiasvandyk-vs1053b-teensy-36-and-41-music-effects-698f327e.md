...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TobiasVanDyk/VS1053B-Teensy-36-and-41-Music-Effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TobiasVanDyk/VS1053B-Teensy-36-and-41-Music-Effects](https://github.com/TobiasVanDyk/VS1053B-Teensy-36-and-41-Music-Effects) |
| Source record ids | github_search_effects-6a970a14b47cf8 |

## System Engineer Summary

2020: VS1053 Teensy36 Teensy41 Music Effects Player. Adjust volume and 5 effect parameters: delay,
decay-repeat, modulation speed and depth, and wet-dry mix-ratio. Also bass and treble boost, bass
and treble centre frequency, and a selection of six gain values.

## Operational Role

For a systems engineer, TobiasVanDyk/VS1053B-Teensy-36-and-41-Music-Effects belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-24T15:59:34Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License (>= 2); Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-6a970a14b47cf8` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 1ay1/neowall | Filesystem Os | [open](effects-1ay1-neowall-29ce32e8.md) |
| AdultLink/HoloShield | Filesystem Os | [open](effects-adultlink-holoshield-acc1efda.md) |
| AhmedAmrNabil/arena-rush | Filesystem Os | [open](effects-ahmedamrnabil-arena-rush-d1327c86.md) |
| ahopness/GodotRetro | Filesystem Os | [open](effects-ahopness-godotretro-b094835b.md) |
| aiyaapp/AiyaEffectsIOS | Filesystem Os | [open](effects-aiyaapp-aiyaeffectsios-74a3ed57.md) |
| Alchemist0823/three.quarks | Filesystem Os | [open](effects-alchemist0823-three-quarks-ef545dfc.md) |
| allusive-dev/compfy | Filesystem Os | [open](effects-allusive-dev-compfy-a54fd05c.md) |
| AmplitudeAudio/sdk | Filesystem Os | [open](effects-amplitudeaudio-sdk-34ae5fe0.md) |
