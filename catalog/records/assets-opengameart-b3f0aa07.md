...
| Canonical URL | [https://opengameart.org/](https://opengameart.org/) |
| Source record ids | curated_language_routes-4bc970b06b5a85 |

## System Engineer Summary

Game asset repository for textures, sprites, audio, models, tilesets, and license-aware reuse.

## Operational Role

For a systems engineer, OpenGameArt belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-4bc970b06b5a85` from `curated_language_routes` as `registry_expansion`
...
| Google Fonts | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-google-fonts-d302d4f6.md) |
