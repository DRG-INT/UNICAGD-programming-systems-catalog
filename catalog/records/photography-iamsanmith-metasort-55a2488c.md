...
<!-- canonical: https://github.com/iamsanmith/MetaSort -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iamsanmith/MetaSort](https://github.com/iamsanmith/MetaSort) |
| Source record ids | github_search_photography-f92d1d0e3db300 |

## System Engineer Summary

📸 Smart Google Photos organizer! Clean files, extract dates, embed metadata, sort by date, generate
reports. Supports 50+ formats including RAW.

## Operational Role

For a systems engineer, iamsanmith/MetaSort belongs in the Photography inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-17T12:19:55Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f92d1d0e3db300` from `github_search_photography` as `registry_expansion`
