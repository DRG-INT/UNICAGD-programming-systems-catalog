...
<!-- canonical: https://crates.io/crates/backoff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/backoff](https://crates.io/crates/backoff) |
| Source record ids | crates_io-be2ec5f6ca4348 |
...
For a systems engineer, backoff belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2021-12-14T21:16:45.606935Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-be2ec5f6ca4348` from `crates_io` as `registry_expansion`
