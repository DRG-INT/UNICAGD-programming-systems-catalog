...
<!-- canonical: https://crates.io/crates/rand_chacha -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_chacha](https://crates.io/crates/rand_chacha) |
| Source record ids | crates_io-24eed5130d2be7 |
...
For a systems engineer, rand_chacha belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-02-02T08:15:02.537641Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-24eed5130d2be7` from `crates_io` as `registry_expansion`
