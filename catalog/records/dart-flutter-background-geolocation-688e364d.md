...
<!-- canonical: https://pub.dev/packages/flutter_background_geolocation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_background_geolocation](https://pub.dev/packages/flutter_background_geolocation) |
| Source record ids | pub_dev-d659223ad8cd01 |

## System Engineer Summary

The most sophisticated background location tracking & geofencing module with battery-conscious
motion-detection intelligence for iOS and Android.

## Operational Role

For a systems engineer, flutter_background_geolocation belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.6.0 | 2026-08-30T18:45:52.009934Z | [https://pub.dev/api/packages/flutter_background_geolocation](https://pub.dev/api/packages/flutter_background_geolocation) |  |
| preview | known | 5.0.0-beta.4 | 2025-12-03T15:24:08.172459Z | [https://pub.dev/api/packages/flutter_background_geolocation](https://pub.dev/api/packages/flutter_background_geolocation) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_background_geolocation` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-d659223ad8cd01` from `pub_dev` as `registry_expansion`
