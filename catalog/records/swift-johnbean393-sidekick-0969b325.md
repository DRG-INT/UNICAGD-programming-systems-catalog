...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/johnbean393/Sidekick -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/johnbean393/Sidekick](https://github.com/johnbean393/Sidekick) |
| Source record ids | github_search_swift-b358415af4bb16 |

## System Engineer Summary

A native macOS app that allows users to chat with a local LLM that can respond with information from
files, folders and websites on your Mac without installing any other software. Powered by llama.cpp.

## Operational Role

For a systems engineer, johnbean393/Sidekick belongs in the Swift inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-24T05:34:09Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-b358415af4bb16` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Blackjacx/WWDC | Formatter | [open](swift-blackjacx-wwdc-b115e9db.md) |
| malcommac/SwiftDate | Formatter | [open](swift-malcommac-swiftdate-adcb1ba9.md) |
| nicklockwood/SwiftFormat | Formatter | [open](swift-nicklockwood-swiftformat-f6d2d442.md) |
