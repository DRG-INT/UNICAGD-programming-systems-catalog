...
<!-- canonical: https://cran.r-project.org/web/packages/AutoGenAI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AutoGenAI/index.html](https://cran.r-project.org/web/packages/AutoGenAI/index.html) |
| Source record ids | cran_packages_by_date-21e2eb01444f69 |
...
For a systems engineer, AutoGenAI belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 07:40:02 UTC | [https://cran.r-project.org/web/packages/AutoGenAI/DESCRIPTION](https://cran.r-project.org/web/packages/AutoGenAI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AutoGenAI/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-21e2eb01444f69` from `cran_packages_by_date` as `registry_expansion`
