...
<!-- canonical: https://pypi.org/project/abc-sphinx-extensions/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abc-sphinx-extensions/](https://pypi.org/project/abc-sphinx-extensions/) |
| Source record ids | pypi_simple-0bd1ebbbb0dbb2 |

## System Engineer Summary

Sphinx extensions for creating tunebooks with abcfiles

## Operational Role

For a systems engineer, abc-sphinx-extensions belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2021-05-16T15:23:04.939087Z | [https://pypi.org/pypi/abc-sphinx-extensions/json](https://pypi.org/pypi/abc-sphinx-extensions/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abc-sphinx-extensions/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-0bd1ebbbb0dbb2` from `pypi_simple` as `registry_expansion`
...
| Sphinx | Api Doc Generator | [open](python-sphinx-0137ce76.md) |
