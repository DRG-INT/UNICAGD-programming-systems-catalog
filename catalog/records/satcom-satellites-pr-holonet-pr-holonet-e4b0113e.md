...
<!-- canonical: https://github.com/pr-holonet/pr-holonet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pr-holonet/pr-holonet](https://github.com/pr-holonet/pr-holonet) |
| Source record ids | github_search_satcom_satellites-996ef940d8ab48 |

## System Engineer Summary

PR-Holonet is a low-cost, open-source emergency communications gateway that is easy to build,
configure and use. It is built for operation in disaster-struck zones or hard-to-reach areas with
little or no existing power or communication infrastructure.

## Operational Role

For a systems engineer, pr-holonet/pr-holonet belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-10-20T19:37:39Z | gh search repos topic:satcom stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense; Other |
...
- `github_search_satcom_satellites-996ef940d8ab48` from `github_search_satcom_satellites` as `registry_expansion`
