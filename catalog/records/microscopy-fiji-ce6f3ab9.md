...
| Canonical URL | [https://imagej.net/software/fiji/](https://imagej.net/software/fiji/) |
| Source record ids | curated_language_routes-252b6f3172b837 |

## System Engineer Summary

ImageJ distribution with bundled plugins for biological-image analysis and microscopy workflows.

## Operational Role

For a systems engineer, Fiji belongs in the Microscopy inventory as part of ecosystem capability
...
- `curated_language_routes-252b6f3172b837` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CellProfiler | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/microscopy-cellprofiler-47c245ad.md) |
| ImageJ | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/microscopy-imagej-433ddc8a.md) |
| QuPath | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/microscopy-qupath-721d0946.md) |
