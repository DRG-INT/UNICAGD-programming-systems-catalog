...
<!-- canonical: https://luarocks.org/modules/digifi/digifi-lua-resty-session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/digifi/digifi-lua-resty-session](https://luarocks.org/modules/digifi/digifi-lua-resty-session) |
| Source record ids | luarocks_root_manifest-dab98722cc2b37 |
...
For a systems engineer, digifi-lua-resty-session belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-dab98722cc2b37` from `luarocks_root_manifest` as `registry_expansion`
