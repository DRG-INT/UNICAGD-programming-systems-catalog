...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/apache/kyuubi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/kyuubi](https://github.com/apache/kyuubi) |
| Source record ids | github_search_databases-c6bd587ca32422 |

## System Engineer Summary

Apache Kyuubi is a distributed and multi-tenant gateway to provide serverless SQL on data warehouses
and lakehouses.

## Operational Role

For a systems engineer, apache/kyuubi belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T12:53:38Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; ISC License; https://api.github.com/licenses/isc; Other |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-15 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:jdbc stars:>50", "retrieved": "2026-09-15", "status": "forge-cli-derived"}` |
...
- `github_search_databases-c6bd587ca32422` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aerospike-community/aerospike-client-ruby | Undefined Behavior Analyzer | [open](databases-aerospike-community-aerospike-client-ruby-04491640.md) |
| apache/incubator-pegasus | Undefined Behavior Analyzer | [open](databases-apache-incubator-pegasus-7ce631b5.md) |
| bytebase/dbhub | Undefined Behavior Analyzer | [open](databases-bytebase-dbhub-ead21c0d.md) |
| CaviraOSS/LongMemory | Undefined Behavior Analyzer | [open](databases-caviraoss-longmemory-7c32bdd6.md) |
| christopherkarani/Wax | Undefined Behavior Analyzer | [open](databases-christopherkarani-wax-06442a2f.md) |
| cloudnative-pg/cloudnative-pg | Undefined Behavior Analyzer | [open](databases-cloudnative-pg-cloudnative-pg-5b60613f.md) |
| CodingDocs/awesome-java | Undefined Behavior Analyzer | [open](databases-codingdocs-awesome-java-f7da703d.md) |
| cstore_fdw | Undefined Behavior Analyzer | [open](databases-cstore-fdw-4259f19e.md) |
