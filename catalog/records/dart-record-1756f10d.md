...
<!-- canonical: https://pub.dev/packages/record -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/record](https://pub.dev/packages/record) |
| Source record ids | pub_dev-da56aef6fd7a52 |

## System Engineer Summary

Audio recorder from microphone to file or stream with multiple codecs, bit rate and sampling rate
options.

## Operational Role

For a systems engineer, record belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.1 | 2026-06-29T09:23:33.796873Z | [https://pub.dev/api/packages/record](https://pub.dev/api/packages/record) |  |
| preview | known | 5.0.0-beta.3+1 | 2023-10-02T10:55:24.356676Z | [https://pub.dev/api/packages/record](https://pub.dev/api/packages/record) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/record` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-da56aef6fd7a52` from `pub_dev` as `registry_expansion`
