...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/J/JSON](https://github.com/JuliaRegistries/General/tree/master/J/JSON) |
| Source record ids | corpus-9d51c9572e2fc5 |

## System Engineer Summary

JSON.jl is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, JSON.jl belongs in the Julia inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.7.1 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/J/JSON/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/J/JSON/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-9d51c9572e2fc5` from `master_json` as `serialization`
