...
<!-- canonical: https://www.rfc-editor.org/rfc/rfc768.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc768.html](https://www.rfc-editor.org/rfc/rfc768.html) |
| Source record ids | curated_language_routes-579baf30dcdc86 |

## System Engineer Summary

User Datagram Protocol specification for datagram transport and protocol layering.

## Operational Role

For a systems engineer, UDP belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-579baf30dcdc86` from `curated_language_routes` as `registry_expansion`
