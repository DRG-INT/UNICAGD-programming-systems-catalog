...
<!-- canonical: https://github.com/acieroid/wassail -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acieroid/wassail](https://github.com/acieroid/wassail) |
| Source record ids | github_search_webassembly-47453aea6a2694 |

## System Engineer Summary

wassail (WebAssembly static analyzer and inspection library) is a toolkit to perform both
lightweight and heavyweight static analysis of WebAssembly modules.

## Operational Role

For a systems engineer, acieroid/wassail belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T20:17:02Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 3); BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Other |
...
- `github_search_webassembly-47453aea6a2694` from `github_search_webassembly` as `registry_expansion`
