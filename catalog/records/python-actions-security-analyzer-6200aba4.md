...
<!-- canonical: https://pypi.org/project/actions-security-analyzer/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actions-security-analyzer/](https://pypi.org/project/actions-security-analyzer/) |
| Source record ids | pypi_simple-a4b5085742f3ba |
...
For a systems engineer, actions-security-analyzer belongs in the Python inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.5 | 2023-08-03T20:40:21.768903Z | [https://pypi.org/pypi/actions-security-analyzer/json](https://pypi.org/pypi/actions-security-analyzer/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actions-security-analyzer/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-a4b5085742f3ba` from `pypi_simple` as `registry_expansion`
