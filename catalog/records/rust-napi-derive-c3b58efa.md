...
| Canonical URL | [https://crates.io/crates/napi-derive](https://crates.io/crates/napi-derive) |
| Source record ids | crates_io-fa3d516e715ca2 |

## System Engineer Summary

napi-derive is tracked as a filesystem os record in the Rust branch. The source did not provide a
...
For a systems engineer, napi-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.3 | 2026-08-10T01:26:00.816014Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-fa3d516e715ca2` from `crates_io` as `registry_expansion`
