...
<!-- canonical: https://github.com/donnemartin/system-design-primer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) |
| Source record ids | github_search_icons_and_logos-e1651fe81dcc6e |

## System Engineer Summary

Learn how to design large-scale systems. Prep for the system design interview. Includes Anki
flashcards.

## Operational Role

For a systems engineer, donnemartin/system-design-primer belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-20T01:52:19Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-e1651fe81dcc6e` from `github_search_icons_and_logos` as `registry_expansion`
