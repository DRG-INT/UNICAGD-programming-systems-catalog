...
<!-- canonical: https://pub.dev/packages/modal_progress_hud_nsn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/modal_progress_hud_nsn](https://pub.dev/packages/modal_progress_hud_nsn) |
| Source record ids | pub_dev-bd0e42d50f9f1e |

## System Engineer Summary

A modal progress indicator widget with Sound Null Safety. A fork of

## Operational Role

For a systems engineer, modal_progress_hud_nsn belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2024-01-21T07:54:41.686829Z | [https://pub.dev/api/packages/modal_progress_hud_nsn](https://pub.dev/api/packages/modal_progress_hud_nsn) |  |
| preview | known | 0.1.0-nullsafety-1 | 2021-02-18T11:09:24.207887Z | [https://pub.dev/api/packages/modal_progress_hud_nsn](https://pub.dev/api/packages/modal_progress_hud_nsn) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/modal_progress_hud_nsn` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-bd0e42d50f9f1e` from `pub_dev` as `registry_expansion`
