...
<!-- canonical: https://packagist.org/packages/swaggest/json-diff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/swaggest/json-diff](https://packagist.org/packages/swaggest/json-diff) |
| Source record ids | packagist_search-652a56de6096cd |
...
For a systems engineer, swaggest/json-diff belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-652a56de6096cd` from `packagist_search` as `registry_expansion`
