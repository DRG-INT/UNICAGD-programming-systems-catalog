...
| Canonical URL | [https://cran.r-project.org/web/packages/coresynth/index.html](https://cran.r-project.org/web/packages/coresynth/index.html) |
| Source record ids | cran_packages_by_date-e24ba8aec8cf9f |
...
For a systems engineer, coresynth belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-25 11:40:02 UTC | [https://cran.r-project.org/web/packages/coresynth/DESCRIPTION](https://cran.r-project.org/web/packages/coresynth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/coresynth/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e24ba8aec8cf9f` from `cran_packages_by_date` as `registry_expansion`
...
| cfbfastR | Parser Lexer Ast | [open](r-cfbfastr-43d0f654.md) |
| cofad | Parser Lexer Ast | [open](r-cofad-1e4308ad.md) |
| crch | Parser Lexer Ast | [open](r-crch-1dd1c9b5.md) |
