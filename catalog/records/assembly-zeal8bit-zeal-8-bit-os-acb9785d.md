...
| Canonical URL | [https://github.com/Zeal8bit/Zeal-8-bit-OS](https://github.com/Zeal8bit/Zeal-8-bit-OS) |
| Source record ids | github_search_assembly-28704ab2f2c683 |
...
For a systems engineer, Zeal8bit/Zeal-8-bit-OS belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.7.0 | 2026-03-24T15:36:27Z | [https://api.github.com/repos/Zeal8bit/Zeal-8-bit-OS/releases/latest](https://api.github.com/repos/Zeal8bit/Zeal-8-bit-OS/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Zeal8bit/Zeal-8-bit-OS/releases/latest` at `2026-09-01T10:25:53+00:00`.
...
- `github_search_assembly-28704ab2f2c683` from `github_search_assembly` as `registry_expansion`
