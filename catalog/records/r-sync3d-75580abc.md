...
<!-- canonical: https://cran.r-project.org/web/packages/sync3d/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sync3d/index.html](https://cran.r-project.org/web/packages/sync3d/index.html) |
| Source record ids | cran_packages_by_date-2fc9d8e30b0397 |

## System Engineer Summary

Synchronized 3D Vector and Marker Animations in 'Plotly'

## Operational Role

For a systems engineer, sync3d belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-12 07:30:02 UTC | [https://cran.r-project.org/web/packages/sync3d/DESCRIPTION](https://cran.r-project.org/web/packages/sync3d/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sync3d/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-2fc9d8e30b0397` from `cran_packages_by_date` as `registry_expansion`
