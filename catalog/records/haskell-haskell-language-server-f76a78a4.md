...
| Source record ids | hackage_recent-84dc0b41ed9f0f |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haskell-language-server` at `2026-09-04T17:20:31+00:00`.
...
- `hackage_recent-84dc0b41ed9f0f` from `hackage_recent` as `registry_expansion`
