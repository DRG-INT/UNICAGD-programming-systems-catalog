...
<!-- canonical: https://hackage.haskell.org/package/haskell-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/haskell-language-server](https://hackage.haskell.org/package/haskell-language-server) |
| Source record ids | hackage_top_downloads-84dc0b41ed9f0f |
...
For a systems engineer, haskell-language-server belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0.0 | 2026-09-04T10:38:07Z | [https://hackage.haskell.org/package/haskell-language-server](https://hackage.haskell.org/package/haskell-language-server) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/haskell-language-server](https://hackage.haskell.org/package/haskell-language-server) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haskell-language-server` at `2026-09-05T00:31:52+00:00`.
...
- `hackage_top_downloads-84dc0b41ed9f0f` from `hackage_top_downloads` as `registry_expansion`
