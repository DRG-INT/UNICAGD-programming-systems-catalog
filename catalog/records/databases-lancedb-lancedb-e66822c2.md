...
<!-- canonical: https://github.com/lancedb/lancedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lancedb/lancedb](https://github.com/lancedb/lancedb) |
| Source record ids | github_search_databases-3123e99571b6da |
...
For a systems engineer, lancedb/lancedb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T07:33:05Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3123e99571b6da` from `github_search_databases` as `registry_expansion`
