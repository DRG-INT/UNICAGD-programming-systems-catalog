...
<!-- canonical: https://cran.r-project.org/web/packages/wishmom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wishmom/index.html](https://cran.r-project.org/web/packages/wishmom/index.html) |
| Source record ids | cran_packages_by_date-24ae830c395e3a |
...
For a systems engineer, wishmom belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-09 14:10:01 UTC | [https://cran.r-project.org/web/packages/wishmom/DESCRIPTION](https://cran.r-project.org/web/packages/wishmom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wishmom/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-24ae830c395e3a` from `cran_packages_by_date` as `registry_expansion`
