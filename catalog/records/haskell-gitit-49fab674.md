...
<!-- canonical: https://hackage.haskell.org/package/gitit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gitit](https://hackage.haskell.org/package/gitit) |
| Source record ids | hackage_top_downloads-30819d7fe5898d |
...
For a systems engineer, gitit belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0.1 | 2026-08-31T18:07:48Z | [https://hackage.haskell.org/package/gitit](https://hackage.haskell.org/package/gitit) |  |
| candidate | partial | 0.12.3 |  | [https://hackage.haskell.org/package/gitit](https://hackage.haskell.org/package/gitit) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gitit` at `2026-09-01T15:38:46+00:00`.
...
- `hackage_top_downloads-30819d7fe5898d` from `hackage_top_downloads` as `registry_expansion`
