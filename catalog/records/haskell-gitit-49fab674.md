...
| Source record ids | hackage_recent-30819d7fe5898d |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gitit` at `2026-09-01T07:24:08+00:00`.
...
- `hackage_recent-30819d7fe5898d` from `hackage_recent` as `registry_expansion`
