...
<!-- canonical: https://cran.r-project.org/web/packages/fntl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fntl/index.html](https://cran.r-project.org/web/packages/fntl/index.html) |
| Source record ids | cran_packages_by_date-2300b774e9d4ac |
...
For a systems engineer, fntl belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3.2 | 2026-08-28 10:00:08 UTC | [https://cran.r-project.org/web/packages/fntl/DESCRIPTION](https://cran.r-project.org/web/packages/fntl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fntl/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2300b774e9d4ac` from `cran_packages_by_date` as `registry_expansion`
