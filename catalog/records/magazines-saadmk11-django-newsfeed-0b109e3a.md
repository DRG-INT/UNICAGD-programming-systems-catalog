...
<!-- canonical: https://github.com/saadmk11/django-newsfeed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/saadmk11/django-newsfeed](https://github.com/saadmk11/django-newsfeed) |
| Source record ids | github_search_magazines-b8753516b9bbcc |
...
For a systems engineer, saadmk11/django-newsfeed belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-18T08:09:01Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-b8753516b9bbcc` from `github_search_magazines` as `registry_expansion`
