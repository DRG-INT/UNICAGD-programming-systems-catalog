...
<!-- canonical: https://pub.dev/packages/audio_session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/audio_session](https://pub.dev/packages/audio_session) |
| Source record ids | pub_dev-188bc52c5be262 |

## System Engineer Summary

Sets the iOS audio session category and Android audio attributes for your app, and manages your
app's audio focus, mixing and ducking behaviour.

## Operational Role

For a systems engineer, audio_session belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-06-29T13:10:31.881382Z | [https://pub.dev/api/packages/audio_session](https://pub.dev/api/packages/audio_session) |  |
| preview | known | 0.1.0-nullsafety.3 | 2021-02-01T06:06:47.006662Z | [https://pub.dev/api/packages/audio_session](https://pub.dev/api/packages/audio_session) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/audio_session` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-188bc52c5be262` from `pub_dev` as `registry_expansion`
