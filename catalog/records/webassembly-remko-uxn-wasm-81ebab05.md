...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/remko/uxn.wasm](https://github.com/remko/uxn.wasm) |
| Source record ids | github_search_webassembly-e7a34c98ec152f |
...
For a systems engineer, remko/uxn.wasm belongs in the WebAssembly inventory as part of runtime
behavior, deployment packaging, embedding, upgrade cadence, and compatibility validation.
...
- `github_search_webassembly-e7a34c98ec152f` from `github_search_webassembly` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Asmble - WebAssembly on the JVM | Interpreter Runtime | [open](webassembly-asmble-webassembly-on-the-jvm-df4793be.md) |
| astrid-runtime/astrid | Interpreter Runtime | [open](webassembly-astrid-runtime-astrid-00366bc4.md) |
| boa-dev/boa | Interpreter Runtime | [open](webassembly-boa-dev-boa-f27788a8.md) |
| capstone-engine/capstone | Interpreter Runtime | [open](webassembly-capstone-engine-capstone-6ab35549.md) |
| CharlieTap/chasm | Interpreter Runtime | [open](webassembly-charlietap-chasm-199c3c2f.md) |
| chevdor/subwasm | Interpreter Runtime | [open](webassembly-chevdor-subwasm-777bc49e.md) |
| FastVM/Web49 | Interpreter Runtime | [open](webassembly-fastvm-web49-1f2e17c8.md) |
| fizzy - Fast, deterministic, and pedantic WebAssembly interpreter written in clean C++17 | Interpreter Runtime | [open](webassembly-fizzy-fast-deterministic-and-pedantic-webassembly-interpreter-written-in-clean-c-17-a2857ea8.md) |
