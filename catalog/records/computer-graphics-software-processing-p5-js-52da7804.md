...
<!-- canonical: https://github.com/processing/p5.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/processing/p5.js](https://github.com/processing/p5.js) |
| Source record ids | github_search_computer_graphics_software-af6450be3e2bfc |

## System Engineer Summary

p5.js is a client-side JS platform that empowers artists, designers, students, and anyone to learn
to code and express themselves creatively on the web. It is based on the core principles of
Processing. Looking for p5.js 2.0?

## Operational Role

For a systems engineer, processing/p5.js belongs in the Computer Graphics Software inventory as part
...
| Evidence | {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `github_search_computer_graphics_software-af6450be3e2bfc` from `github_search_computer_graphics_software` as `registry_expansion`
