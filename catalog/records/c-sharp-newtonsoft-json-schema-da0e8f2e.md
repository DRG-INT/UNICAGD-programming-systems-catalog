...
<!-- canonical: https://www.nuget.org/packages/Newtonsoft.Json.Schema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Newtonsoft.Json.Schema](https://www.nuget.org/packages/Newtonsoft.Json.Schema) |
| Source record ids | nuget_search-ec952ade93d4ee |
...
For a systems engineer, Newtonsoft.Json.Schema belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2024-06-08T13:10:37.15+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json.schema/index.json](https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json.schema/index.json) |  |
| preview | known | 4.0.2-beta2 | 2025-02-16T13:32:30.583+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json.schema/index.json](https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json.schema/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json.schema/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-ec952ade93d4ee` from `nuget_search` as `registry_expansion`
