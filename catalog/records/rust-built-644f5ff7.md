...
<!-- canonical: https://crates.io/crates/built -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/built](https://crates.io/crates/built) |
| Source record ids | crates_io-14cf27fb78700d |
...
For a systems engineer, built belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-05-21T20:10:07.082823Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-14cf27fb78700d` from `crates_io` as `registry_expansion`
