...
| Canonical URL | [https://packagist.org/packages/gesdinet/jwt-refresh-token-bundle](https://packagist.org/packages/gesdinet/jwt-refresh-token-bundle) |
| Source record ids | packagist_search-bdb3a0bc352bf9 |
...
For a systems engineer, gesdinet/jwt-refresh-token-bundle belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.0 | 2026-08-05T15:17:49+00:00 | [https://repo.packagist.org/p2/gesdinet/jwt-refresh-token-bundle.json](https://repo.packagist.org/p2/gesdinet/jwt-refresh-token-bundle.json) |  |
| preview | known | 2.0.0-beta | 2025-12-29T22:56:24+00:00 | [https://repo.packagist.org/p2/gesdinet/jwt-refresh-token-bundle.json](https://repo.packagist.org/p2/gesdinet/jwt-refresh-token-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/gesdinet/jwt-refresh-token-bundle.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-bdb3a0bc352bf9` from `packagist_search` as `registry_expansion`
