...
<!-- canonical: https://luarocks.org/modules/devikamehra/cipher-log -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/devikamehra/cipher-log](https://luarocks.org/modules/devikamehra/cipher-log) |
| Source record ids | luarocks_root_manifest-76b3486c13deb8 |
...
For a systems engineer, cipher-log belongs in the Lua family inventory as part of diagnostics,
...
- `luarocks_root_manifest-76b3486c13deb8` from `luarocks_root_manifest` as `registry_expansion`
