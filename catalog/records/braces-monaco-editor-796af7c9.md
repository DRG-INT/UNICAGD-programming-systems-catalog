...
[Catalog index](../index.md) · [Language: Braces](../by-language/braces.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://microsoft.github.io/monaco-editor/ -->
<!-- crawl-delay: 10 -->
...
| Name | Category | Page |
| --- | --- | --- |
| CodeMirror Bracket Matching | Ide Editor Integration | [open](braces-codemirror-bracket-matching-6cba71e1.md) |
| VS Code Bracket Pair Colorization | Ide Editor Integration | [open](braces-vs-code-bracket-pair-colorization-396c5b7e.md) |
