...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Braces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/braces.md) · [Category: Ide Editor Integration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ide-editor-integration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://microsoft.github.io/monaco-editor/](https://microsoft.github.io/monaco-editor/) |
| Source record ids | curated_language_routes-5b79c8b704e4c8 |

## System Engineer Summary

Browser editor engine used by VS Code-derived tools with bracket matching, syntax services, and
formatter integration.

## Operational Role

For a systems engineer, Monaco Editor belongs in the Braces inventory as part of ecosystem
...
- `curated_language_routes-5b79c8b704e4c8` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CodeMirror Bracket Matching | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/braces-codemirror-bracket-matching-6cba71e1.md) |
| VS Code Bracket Pair Colorization | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/braces-vs-code-bracket-pair-colorization-396c5b7e.md) |
