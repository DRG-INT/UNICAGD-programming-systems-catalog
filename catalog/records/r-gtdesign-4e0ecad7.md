...
<!-- canonical: https://cran.r-project.org/web/packages/gtDesign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gtDesign/index.html](https://cran.r-project.org/web/packages/gtDesign/index.html) |
| Source record ids | cran_packages_by_date-3b21d930e53f7a |

## System Engineer Summary

Convex Optimal Designs for Group Testing Experiments

## Operational Role

For a systems engineer, gtDesign belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-02 07:10:16 UTC | [https://cran.r-project.org/web/packages/gtDesign/DESCRIPTION](https://cran.r-project.org/web/packages/gtDesign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gtDesign/DESCRIPTION` at `2026-09-02T08:21:51+00:00`.
...
- `cran_packages_by_date-3b21d930e53f7a` from `cran_packages_by_date` as `registry_expansion`
