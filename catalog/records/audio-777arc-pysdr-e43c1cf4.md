...
| Source record ids | github_search_audio-0bc41f8a628379 |
...
For a systems engineer, 777arc/PySDR belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T19:31:51Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-0bc41f8a628379` from `github_search_audio` as `registry_expansion`
