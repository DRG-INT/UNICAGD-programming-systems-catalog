...
| Canonical URL | [https://github.com/carlospuenteg/File-Injector](https://github.com/carlospuenteg/File-Injector) |
| Source record ids | github_search_photography-389fab11a06e80 |
...
For a systems engineer, carlospuenteg/File-Injector belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.2 | 2022-11-18T00:20:21Z | [https://api.github.com/repos/carlospuenteg/File-Injector/releases/latest](https://api.github.com/repos/carlospuenteg/File-Injector/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/carlospuenteg/File-Injector/releases/latest` at `2026-09-01T09:23:29+00:00`.
...
- `github_search_photography-389fab11a06e80` from `github_search_photography` as `registry_expansion`
