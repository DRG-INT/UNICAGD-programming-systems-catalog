...
<!-- canonical: https://pypi.org/project/adaptivetesting/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adaptivetesting/](https://pypi.org/project/adaptivetesting/) |
| Source record ids | pypi_simple-2fabd3e263ec1e |

## System Engineer Summary

adaptivetesting is a Python package that can be used to simulate and evaluate custom CAT scenarios
as well as implement them in real-world testing scenarios from a single codebase

## Operational Role

For a systems engineer, adaptivetesting belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-06-29T08:36:15.304953Z | [https://pypi.org/pypi/adaptivetesting/json](https://pypi.org/pypi/adaptivetesting/json) |  |
| preview | known | 1.2b1 | 2026-03-19T11:00:39.600938Z | [https://pypi.org/pypi/adaptivetesting/json](https://pypi.org/pypi/adaptivetesting/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adaptivetesting/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-2fabd3e263ec1e` from `pypi_simple` as `registry_expansion`
