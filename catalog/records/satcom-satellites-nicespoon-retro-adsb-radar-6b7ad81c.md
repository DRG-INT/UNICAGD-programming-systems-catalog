# nicespoon/retro-adsb-radar

## Navigation

[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nicespoon/retro-adsb-radar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nicespoon/retro-adsb-radar](https://github.com/nicespoon/retro-adsb-radar) |
| Source record ids | github_search_satcom_satellites-fc3f29b64b8571 |

## System Engineer Summary

Aircraft radar display with retro styling. Visualises real-time aircraft positions and information
from an ADS-B feed.

## Operational Role

For a systems engineer, nicespoon/retro-adsb-radar belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T10:18:06Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-fc3f29b64b8571` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| joshuaferrara/go-satellite | Formatter | [open](satcom-satellites-joshuaferrara-go-satellite-adf32609.md) |
| opensatelliteproject/OpenSatelliteProject | Formatter | [open](satcom-satellites-opensatelliteproject-opensatelliteproject-a627e533.md) |
| sigmf/sigmf-python | Formatter | [open](satcom-satellites-sigmf-sigmf-python-329846a5.md) |
