...
<!-- canonical: https://github.com/chitalu/oibvh-tree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chitalu/oibvh-tree](https://github.com/chitalu/oibvh-tree) |
| Source record ids | github_search_physics_engines-f6efc6f229d70a |

## System Engineer Summary

Reference implementation of Oi-BVH tree from the paper "Binary Ostensibly‐Implicit Trees for Fast
Collision Detection"

## Operational Role

For a systems engineer, chitalu/oibvh-tree belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-27T17:44:26Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f6efc6f229d70a` from `github_search_physics_engines` as `registry_expansion`
...
| nlbucki/RAPPIDS | Parser Lexer Ast | [open](physics-engines-nlbucki-rappids-072ab53a.md) |
