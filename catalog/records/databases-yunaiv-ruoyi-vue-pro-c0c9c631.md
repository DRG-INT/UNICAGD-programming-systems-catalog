...
<!-- canonical: https://github.com/YunaiV/ruoyi-vue-pro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/YunaiV/ruoyi-vue-pro](https://github.com/YunaiV/ruoyi-vue-pro) |
| Source record ids | github_search_databases-a13164d6b53587 |

## System Engineer Summary

🔥 官方推荐 🔥 RuoYi-Vue 全新 Pro 版本，优化重构所有功能。基于 Spring Boot + MyBatis Plus + Vue & Element 实现的后台管理系统 +
微信小程序，支持 RBAC 动态权限、数据权限、SaaS 多租户、Flowable 工作流、三方登录、支付、短信、商城、CRM、ERP、MES、IM、AI 大模型、IoT 物联网等功能。你的 ⭐️
Star ⭐️，是作者生发的动力！

## Operational Role

For a systems engineer, YunaiV/ruoyi-vue-pro belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T14:37:38Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a13164d6b53587` from `github_search_databases` as `registry_expansion`
