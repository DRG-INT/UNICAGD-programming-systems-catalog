...
| Canonical URL | [https://crates.io/crates/bitstream-io](https://crates.io/crates/bitstream-io) |
| Source record ids | crates_io-ca4256fef34ec1 |

## System Engineer Summary

Library for reading/writing un-aligned values from/to streams in big-endian and little-endian
formats.

## Operational Role

For a systems engineer, bitstream-io belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.10.0 | 2026-04-14T19:30:17.129106Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-ca4256fef34ec1` from `crates_io` as `registry_expansion`
