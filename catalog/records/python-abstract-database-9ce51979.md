...
<!-- canonical: https://pypi.org/project/abstract-database/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abstract-database/](https://pypi.org/project/abstract-database/) |
| Source record ids | pypi_simple-9b0eebe783b545 |

## System Engineer Summary

Lazy, environment-driven PostgreSQL connection management with multi-database support and
table/query helpers.

## Operational Role

For a systems engineer, abstract-database belongs in the Python inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2.190 | 2026-08-23T07:46:17.897685Z | [https://pypi.org/pypi/abstract-database/json](https://pypi.org/pypi/abstract-database/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abstract-database/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-9b0eebe783b545` from `pypi_simple` as `registry_expansion`
