...
<!-- canonical: https://crates.io/crates/proc-macro2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/proc-macro2](https://crates.io/crates/proc-macro2) |
| Source record ids | crates_io-87819272026ca6 |

## System Engineer Summary

A substitute implementation of the compiler's `proc_macro` API to decouple token-based libraries
from the procedural macro use case.

## Operational Role

For a systems engineer, proc-macro2 belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.107 | 2026-07-19T00:18:25.189787Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-87819272026ca6` from `crates_io` as `registry_expansion`
