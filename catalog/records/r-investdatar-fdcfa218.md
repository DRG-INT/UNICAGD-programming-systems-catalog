...
<!-- canonical: https://cran.r-project.org/web/packages/investdatar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/investdatar/index.html](https://cran.r-project.org/web/packages/investdatar/index.html) |
| Source record ids | cran_packages_by_date-9b4c73e6dcb924 |
...
For a systems engineer, investdatar belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-21 13:40:07 UTC | [https://cran.r-project.org/web/packages/investdatar/DESCRIPTION](https://cran.r-project.org/web/packages/investdatar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/investdatar/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9b4c73e6dcb924` from `cran_packages_by_date` as `registry_expansion`
