...
<!-- canonical: https://cran.r-project.org/web/packages/twoCoprimary/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/twoCoprimary/index.html](https://cran.r-project.org/web/packages/twoCoprimary/index.html) |
| Source record ids | cran_packages_by_date-425b24196ba6b9 |
...
For a systems engineer, twoCoprimary belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-29 04:40:03 UTC | [https://cran.r-project.org/web/packages/twoCoprimary/DESCRIPTION](https://cran.r-project.org/web/packages/twoCoprimary/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/twoCoprimary/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-425b24196ba6b9` from `cran_packages_by_date` as `registry_expansion`
