...
<!-- canonical: https://github.com/DrA1ex/JS_ParticleSystem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DrA1ex/JS_ParticleSystem](https://github.com/DrA1ex/JS_ParticleSystem) |
| Source record ids | github_search_effects-c5beab9c2efb0d |
...
For a systems engineer, DrA1ex/JS_ParticleSystem belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-12T19:03:30Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-c5beab9c2efb0d` from `github_search_effects` as `registry_expansion`
