...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kevmo314/magic-copy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kevmo314/magic-copy](https://github.com/kevmo314/magic-copy) |
| Source record ids | github_search_photography-82dc5fceb8f616 |

## System Engineer Summary

Magic Copy is a Chrome extension that uses Meta's Segment Anything Model to extract a foreground
object from an image and copy it to the clipboard.

## Operational Role

For a systems engineer, kevmo314/magic-copy belongs in the Photography inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-06T20:41:13Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-82dc5fceb8f616` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jdisho/Papr | Interpreter Runtime | [open](photography-jdisho-papr-a1ad362c.md) |
| Neko3000/Monotone | Interpreter Runtime | [open](photography-neko3000-monotone-3360e26b.md) |
