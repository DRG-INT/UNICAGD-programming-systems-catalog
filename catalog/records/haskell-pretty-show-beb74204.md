...
<!-- canonical: https://hackage.haskell.org/package/pretty-show -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pretty-show](https://hackage.haskell.org/package/pretty-show) |
| Source record ids | hackage_top_downloads-0653753877863a |
...
For a systems engineer, pretty-show belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10 | 2020-01-30T19:08:20Z | [https://hackage.haskell.org/package/pretty-show](https://hackage.haskell.org/package/pretty-show) |  |
| candidate | partial | 1.6.4 |  | [https://hackage.haskell.org/package/pretty-show](https://hackage.haskell.org/package/pretty-show) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pretty-show` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-0653753877863a` from `hackage_top_downloads` as `registry_expansion`
