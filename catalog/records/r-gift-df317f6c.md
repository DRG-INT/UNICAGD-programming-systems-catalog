...
<!-- canonical: https://cran.r-project.org/web/packages/GIFT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GIFT/index.html](https://cran.r-project.org/web/packages/GIFT/index.html) |
| Source record ids | cran_packages_by_date-0277fda8653b74 |
...
For a systems engineer, GIFT belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2026-08-24 11:20:15 UTC | [https://cran.r-project.org/web/packages/GIFT/DESCRIPTION](https://cran.r-project.org/web/packages/GIFT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GIFT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0277fda8653b74` from `cran_packages_by_date` as `registry_expansion`
