...
<!-- canonical: https://packagist.org/packages/ramsey/uuid-doctrine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ramsey/uuid-doctrine](https://packagist.org/packages/ramsey/uuid-doctrine) |
| Source record ids | packagist_search-c99fbca0ef7cf8 |
...
For a systems engineer, ramsey/uuid-doctrine belongs in the PHP inventory as part of state
...
- `packagist_search-c99fbca0ef7cf8` from `packagist_search` as `registry_expansion`
