...
<!-- canonical: https://crates.io/crates/leb128fmt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/leb128fmt](https://crates.io/crates/leb128fmt) |
| Source record ids | crates_io-253e9eb311ae4e |
...
For a systems engineer, leb128fmt belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2023-10-02T21:31:24.075885Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-10T06:26:05+00:00`.
...
- `crates_io-253e9eb311ae4e` from `crates_io` as `registry_expansion`
