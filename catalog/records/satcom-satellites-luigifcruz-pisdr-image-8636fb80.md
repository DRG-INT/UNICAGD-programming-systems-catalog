...
<!-- canonical: https://github.com/luigifcruz/pisdr-image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luigifcruz/pisdr-image](https://github.com/luigifcruz/pisdr-image) |
| Source record ids | github_search_satcom_satellites-9479b7b492cd74 |

## System Engineer Summary

🥧 A SDR Linux Distro for the Raspberry Pi and other SBC. Compatible out of the box with multiple
SDR.

## Operational Role

For a systems engineer, luigifcruz/pisdr-image belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.0.0-alpha2 | 2023-12-19T17:45:06Z | [https://api.github.com/repos/luigifcruz/pisdr-image/releases/latest](https://api.github.com/repos/luigifcruz/pisdr-image/releases/latest) |  |
| preview | known | v7.0.0-alpha | 2023-08-28T19:57:26Z | [https://api.github.com/repos/luigifcruz/pisdr-image/releases?per_page=10](https://api.github.com/repos/luigifcruz/pisdr-image/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/luigifcruz/pisdr-image/releases/latest` at `2026-09-01T08:26:36+00:00`.
...
- `github_search_satcom_satellites-9479b7b492cd74` from `github_search_satcom_satellites` as `registry_expansion`
