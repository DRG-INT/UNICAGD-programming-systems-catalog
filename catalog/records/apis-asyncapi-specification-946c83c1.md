...
| Canonical URL | [https://www.asyncapi.com/docs/reference/specification/latest](https://www.asyncapi.com/docs/reference/specification/latest) |
| Source record ids | curated_language_routes-1e8c1a2b6d1f6a |

## System Engineer Summary

Official AsyncAPI specification for event-driven APIs, channels, messages, bindings, and schemas.

## Operational Role

For a systems engineer, AsyncAPI Specification belongs in the APIs inventory as part of ecosystem
...
- `curated_language_routes-1e8c1a2b6d1f6a` from `curated_language_routes` as `registry_expansion`
...
| OpenAPI Specification | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-openapi-specification-00766c13.md) |
