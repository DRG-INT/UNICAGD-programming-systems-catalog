...
<!-- canonical: https://pub.dev/packages/flutter_slider_drawer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_slider_drawer](https://pub.dev/packages/flutter_slider_drawer) |
| Source record ids | pub_dev-c14af21466ebce |
...
For a systems engineer, flutter_slider_drawer belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2025-01-16T17:00:14.933906Z | [https://pub.dev/api/packages/flutter_slider_drawer](https://pub.dev/api/packages/flutter_slider_drawer) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_slider_drawer` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-c14af21466ebce` from `pub_dev` as `registry_expansion`
