...
<!-- canonical: https://luarocks.org/modules/f4z3r/beancount -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/f4z3r/beancount](https://luarocks.org/modules/f4z3r/beancount) |
| Source record ids | luarocks_root_manifest-c144ba73b1618a |
...
For a systems engineer, beancount belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c144ba73b1618a` from `luarocks_root_manifest` as `registry_expansion`
