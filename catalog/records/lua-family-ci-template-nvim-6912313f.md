...
<!-- canonical: https://luarocks.org/modules/linrongbin16/ci-template.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/linrongbin16/ci-template.nvim](https://luarocks.org/modules/linrongbin16/ci-template.nvim) |
| Source record ids | luarocks_root_manifest-7b0fbb05fd135b |
...
For a systems engineer, ci-template.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7b0fbb05fd135b` from `luarocks_root_manifest` as `registry_expansion`
