...
<!-- canonical: https://cran.r-project.org/web/packages/causalsim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/causalsim/index.html](https://cran.r-project.org/web/packages/causalsim/index.html) |
| Source record ids | cran_packages_by_date-2f62355c000303 |

## System Engineer Summary

Simulation-Ready Causal Data Generating Processes

## Operational Role

For a systems engineer, causalsim belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-30 10:00:15 UTC | [https://cran.r-project.org/web/packages/causalsim/DESCRIPTION](https://cran.r-project.org/web/packages/causalsim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/causalsim/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2f62355c000303` from `cran_packages_by_date` as `registry_expansion`
