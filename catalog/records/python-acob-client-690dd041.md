...
<!-- canonical: https://pypi.org/project/acob-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acob-client/](https://pypi.org/project/acob-client/) |
| Source record ids | pypi_simple-b4feb5c898cf3b |

## System Engineer Summary

Asynchronous Python client for Agent Controlled Browser

## Operational Role

For a systems engineer, acob-client belongs in the Python inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-08-29T04:45:41.972298Z | [https://pypi.org/pypi/acob-client/json](https://pypi.org/pypi/acob-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acob-client/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-b4feb5c898cf3b` from `pypi_simple` as `registry_expansion`
