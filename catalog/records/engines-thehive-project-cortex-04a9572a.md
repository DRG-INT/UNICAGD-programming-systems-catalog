...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TheHive-Project/Cortex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheHive-Project/Cortex](https://github.com/TheHive-Project/Cortex) |
| Source record ids | github_search_engines-0db55f2779de8d |
...
For a systems engineer, TheHive-Project/Cortex belongs in the Engines inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-30T09:01:11Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-0db55f2779de8d` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AlisamTechnology/ATSCAN | Static Analyzer | [open](engines-alisamtechnology-atscan-3c4805cf.md) |
