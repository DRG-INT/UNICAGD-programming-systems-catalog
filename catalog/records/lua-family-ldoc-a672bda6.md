...
<!-- canonical: http://stevedonovan.github.io/ldoc/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://stevedonovan.github.io/ldoc/](http://stevedonovan.github.io/ldoc/) |
| Source record ids | lua-source-203 |
...
For a systems engineer, LDoc belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 203}}` |
...
- `lua-source-203` from `master_json` as `source_list_item`
