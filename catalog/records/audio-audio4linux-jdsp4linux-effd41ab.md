...
| Source record ids | github_search_audio-cfd523ba332cc1 |
...
For a systems engineer, Audio4Linux/JDSP4Linux belongs in the Audio inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2023-12-09T23:28:06Z | [https://api.github.com/repos/Audio4Linux/JDSP4Linux/releases/latest](https://api.github.com/repos/Audio4Linux/JDSP4Linux/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Audio4Linux/JDSP4Linux/releases/latest` at `2026-09-01T09:23:15+00:00`.
...
- `github_search_audio-cfd523ba332cc1` from `github_search_audio` as `registry_expansion`
