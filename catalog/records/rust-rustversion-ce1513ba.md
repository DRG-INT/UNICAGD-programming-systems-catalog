...
<!-- canonical: https://crates.io/crates/rustversion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustversion](https://crates.io/crates/rustversion) |
| Source record ids | crates_io-031dc1a89de913 |
...
For a systems engineer, rustversion belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.23 | 2026-07-07T02:10:26.015429Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-031dc1a89de913` from `crates_io` as `registry_expansion`
