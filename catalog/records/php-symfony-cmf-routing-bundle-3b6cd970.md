...
<!-- canonical: https://packagist.org/packages/symfony-cmf/routing-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony-cmf/routing-bundle](https://packagist.org/packages/symfony-cmf/routing-bundle) |
| Source record ids | packagist_search-e658d525932149 |

## System Engineer Summary

symfony-cmf/routing-bundle is tracked as a database datastore record in the PHP branch. The source
...
For a systems engineer, symfony-cmf/routing-bundle belongs in the PHP inventory as part of state
...
- `packagist_search-e658d525932149` from `packagist_search` as `registry_expansion`
