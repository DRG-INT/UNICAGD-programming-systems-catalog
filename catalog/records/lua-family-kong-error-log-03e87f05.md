...
| Canonical URL | [https://luarocks.org/modules/optum-ross/kong-error-log](https://luarocks.org/modules/optum-ross/kong-error-log) |
| Source record ids | luarocks_root_manifest-b7f51794ade87d |
...
For a systems engineer, kong-error-log belongs in the Lua family inventory as part of diagnostics,
...
- `luarocks_root_manifest-b7f51794ade87d` from `luarocks_root_manifest` as `registry_expansion`
