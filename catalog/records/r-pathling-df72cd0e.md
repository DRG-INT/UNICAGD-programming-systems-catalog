...
<!-- canonical: https://cran.r-project.org/web/packages/pathling/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pathling/index.html](https://cran.r-project.org/web/packages/pathling/index.html) |
| Source record ids | cran_packages_by_date-897c23ba478b13 |
...
For a systems engineer, pathling belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.9.0 | 2026-09-03 04:00:02 UTC | [https://cran.r-project.org/web/packages/pathling/DESCRIPTION](https://cran.r-project.org/web/packages/pathling/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pathling/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-897c23ba478b13` from `cran_packages_by_date` as `registry_expansion`
