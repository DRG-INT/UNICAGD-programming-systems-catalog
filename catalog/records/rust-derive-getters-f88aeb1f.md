...
| Canonical URL | [https://crates.io/crates/derive-getters](https://crates.io/crates/derive-getters) |
| Source record ids | crates_io-d5ead213cd5732 |
...
For a systems engineer, derive-getters belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2024-08-07T15:13:22.140823Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| askama | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-askama-650709f8.md) |
| askama_parser | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-askama-parser-194b08cd.md) |
| delegate | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-delegate-13063a41.md) |
| error-chain | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-error-chain-75f2b5f9.md) |
| serialize-to-javascript | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-serialize-to-javascript-92771f0b.md) |
| tera | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-tera-f327f6af.md) |
| tinytemplate | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-tinytemplate-d98f6f3a.md) |
| uritemplate-next | Project Scaffolding | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-uritemplate-next-b1c377c4.md) |
