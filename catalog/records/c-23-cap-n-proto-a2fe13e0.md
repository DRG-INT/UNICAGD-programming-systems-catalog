...
| Source record ids | corpus-0f63bc010639c4 |

## System Engineer Summary

Cap'n Proto is tracked as a serialization record in the C++23 branch. The source did not provide a
...
For a systems engineer, Cap'n Proto belongs in the C++23 inventory as part of wire formats,
...
- `corpus-0f63bc010639c4` from `master_json` as `serialization`
