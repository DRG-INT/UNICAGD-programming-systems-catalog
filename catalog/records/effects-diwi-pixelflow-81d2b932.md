...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/diwi/PixelFlow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diwi/PixelFlow](https://github.com/diwi/PixelFlow) |
| Source record ids | github_search_effects-279501c5d10e8f |

## System Engineer Summary

A Processing/Java library for high performance GPU-Computing (GLSL). Fluid Simulation + SoftBody
Dynamics + Optical Flow + Rendering + Image Processing + Particle Systems + Physics +...

## Operational Role

For a systems engineer, diwi/PixelFlow belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 62 | 2018-01-10T18:05:55Z | [https://api.github.com/repos/diwi/PixelFlow/releases/latest](https://api.github.com/repos/diwi/PixelFlow/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/diwi/PixelFlow/releases/latest` at `2026-09-01T09:23:09+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "particle system", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_effects-279501c5d10e8f` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AI-SLOP-BOX/kagarivfx | Benchmarking | [open](effects-ai-slop-box-kagarivfx-a2ec54c0.md) |
| DanielZanad/distributed-audio-dsp | Benchmarking | [open](effects-danielzanad-distributed-audio-dsp-84936212.md) |
| mustache-dev/Three-VFX | Benchmarking | [open](effects-mustache-dev-three-vfx-7b5a4bb9.md) |
| nayeem-rafi/Audio-Effect-Processor | Benchmarking | [open](effects-nayeem-rafi-audio-effect-processor-2d2ce38d.md) |
| smu160/PhastFT | Benchmarking | [open](effects-smu160-phastft-968bf587.md) |
