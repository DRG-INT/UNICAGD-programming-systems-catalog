# sasgis/sas.planet.src

## Navigation

[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sasgis/sas.planet.src -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sasgis/sas.planet.src](https://github.com/sasgis/sas.planet.src) |
| Source record ids | github_search_maps-49056a31328bc6 |

## System Engineer Summary

SAS.Planet is a free, open-source Geographic Information System (GIS) software designed for viewing,
downloading, and managing high-resolution satellite imagery and conventional maps from various
online sources.

## Operational Role

For a systems engineer, sasgis/sas.planet.src belongs in the Maps inventory as part of low-noise
...
- `github_search_maps-49056a31328bc6` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apdevelop/tile-map-service | Formatter | [open](maps-apdevelop-tile-map-service-5e26afce.md) |
| awesome-spectral-indices/awesome-spectral-indices | Formatter | [open](maps-awesome-spectral-indices-awesome-spectral-indices-cbfc90d0.md) |
| bugra9/gdal3.js | Formatter | [open](maps-bugra9-gdal3-js-e7b39271.md) |
| davemlz/eemont | Formatter | [open](maps-davemlz-eemont-fb067ac2.md) |
| MIERUNE/plateau-gis-converter | Formatter | [open](maps-mierune-plateau-gis-converter-33d0b196.md) |
| plant99/felicette | Formatter | [open](maps-plant99-felicette-60be9d6d.md) |
| proj4js/proj4js | Formatter | [open](maps-proj4js-proj4js-79ed1335.md) |
| pyproj4/pyproj | Formatter | [open](maps-pyproj4-pyproj-66a83255.md) |
