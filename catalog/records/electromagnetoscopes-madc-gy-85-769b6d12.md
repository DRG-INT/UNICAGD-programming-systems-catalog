...
<!-- canonical: https://github.com/madc/GY-85 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/madc/GY-85](https://github.com/madc/GY-85) |
| Source record ids | github_search_electromagnetoscopes-b3a4caabfad993 |

## System Engineer Summary

Arduino implementation for GY-85 (ADXL345 accelerometer, ITG3200 gyroscope and HMC5883L
magnetometer)

## Operational Role

For a systems engineer, madc/GY-85 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-06-10T15:23:04Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b3a4caabfad993` from `github_search_electromagnetoscopes` as `registry_expansion`
