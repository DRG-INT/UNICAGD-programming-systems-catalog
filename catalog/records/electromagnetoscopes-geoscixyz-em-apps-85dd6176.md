...
<!-- canonical: https://github.com/geoscixyz/em-apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geoscixyz/em-apps](https://github.com/geoscixyz/em-apps) |
| Source record ids | github_search_electromagnetoscopes-b3db494928fa2a |
...
For a systems engineer, geoscixyz/em-apps belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-09T16:18:53Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b3db494928fa2a` from `github_search_electromagnetoscopes` as `registry_expansion`
