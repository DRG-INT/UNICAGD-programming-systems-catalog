...
<!-- canonical: https://luarocks.org/modules/mascarenhas/alien -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mascarenhas/alien](https://luarocks.org/modules/mascarenhas/alien) |
| Source record ids | luarocks_root_manifest-554df0f9e627f0 |

## System Engineer Summary

Alien is tracked as a ffi bindings record in the Lua family branch. The source did not provide a
...
For a systems engineer, Alien belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-554df0f9e627f0` from `luarocks_root_manifest` as `registry_expansion`
