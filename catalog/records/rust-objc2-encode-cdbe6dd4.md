...
<!-- canonical: https://crates.io/crates/objc2-encode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2-encode](https://crates.io/crates/objc2-encode) |
| Source record ids | crates_io-ce1a3c44c85281 |
...
For a systems engineer, objc2-encode belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2025-01-22T23:40:12.051433Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-ce1a3c44c85281` from `crates_io` as `registry_expansion`
