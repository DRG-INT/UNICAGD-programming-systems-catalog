...
<!-- canonical: https://github.com/pimalaya/calendula -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pimalaya/calendula](https://github.com/pimalaya/calendula) |
| Source record ids | github_search_magazines-23f57cb6be4e8a |

## System Engineer Summary

pimalaya/calendula is tracked as a cli record in the Magazines branch. The source did not provide a
...
For a systems engineer, pimalaya/calendula belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T00:36:17Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-23f57cb6be4e8a` from `github_search_magazines` as `registry_expansion`
