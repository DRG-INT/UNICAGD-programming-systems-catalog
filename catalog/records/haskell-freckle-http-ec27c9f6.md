...
| Canonical URL | [https://hackage.haskell.org/package/freckle-http](https://hackage.haskell.org/package/freckle-http) |
| Source record ids | hackage_recent-30bbdc91959c46 |
...
For a systems engineer, freckle-http belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.0 | 2026-08-31T18:42:24Z | [https://hackage.haskell.org/package/freckle-http](https://hackage.haskell.org/package/freckle-http) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/freckle-http` at `2026-09-01T07:24:07+00:00`.
...
- `hackage_recent-30bbdc91959c46` from `hackage_recent` as `registry_expansion`
