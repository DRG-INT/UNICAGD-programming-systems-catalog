...
<!-- canonical: https://github.com/alexjc/neural-doodle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexjc/neural-doodle](https://github.com/alexjc/neural-doodle) |
| Source record ids | github_search_photography-a529d5468cb7d3 |

## System Engineer Summary

Turn your two-bit doodles into fine artworks with deep neural networks, generate seamless textures
from photos, transfer style from one image to another, perform example-based upscaling, but wait...
there's more! (An implementation of Semantic Style Transfer.)

## Operational Role

For a systems engineer, alexjc/neural-doodle belongs in the Photography inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-01T16:54:52Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a529d5468cb7d3` from `github_search_photography` as `registry_expansion`
