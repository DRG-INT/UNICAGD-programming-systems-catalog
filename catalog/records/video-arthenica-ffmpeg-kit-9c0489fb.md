...
<!-- canonical: https://github.com/arthenica/ffmpeg-kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arthenica/ffmpeg-kit](https://github.com/arthenica/ffmpeg-kit) |
| Source record ids | github_search_video-92c77e4dad3302 |

## System Engineer Summary

FFmpeg Kit for applications. Supports Android, Flutter, iOS, Linux, macOS, React Native and tvOS.
Supersedes MobileFFmpeg, flutter_ffmpeg and react-native-ffmpeg.

## Operational Role

For a systems engineer, arthenica/ffmpeg-kit belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T19:58:31Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-92c77e4dad3302` from `github_search_video` as `registry_expansion`
