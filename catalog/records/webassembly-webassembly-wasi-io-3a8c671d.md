...
<!-- canonical: https://github.com/WebAssembly/wasi-io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-io](https://github.com/WebAssembly/wasi-io) |
| Source record ids | github_search_webassembly-b24d2aa1a5e15a |
...
For a systems engineer, WebAssembly/wasi-io belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T20:40:43Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b24d2aa1a5e15a` from `github_search_webassembly` as `registry_expansion`
