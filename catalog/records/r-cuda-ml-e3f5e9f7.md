...
<!-- canonical: https://cran.r-project.org/web/packages/cuda.ml/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cuda.ml/index.html](https://cran.r-project.org/web/packages/cuda.ml/index.html) |
| Source record ids | cran_packages_by_date-2dddeb17c43d5a |
...
For a systems engineer, cuda.ml belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-21 05:44:12 UTC | [https://cran.r-project.org/web/packages/cuda.ml/DESCRIPTION](https://cran.r-project.org/web/packages/cuda.ml/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cuda.ml/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2dddeb17c43d5a` from `cran_packages_by_date` as `registry_expansion`
