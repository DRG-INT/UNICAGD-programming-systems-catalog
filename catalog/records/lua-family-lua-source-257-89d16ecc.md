...
| Source record ids | lua-source-257 |

## System Engineer Summary

lua-source-257 is tracked as an other record in the Lua family branch. The source did not provide a
...
For a systems engineer, lua-source-257 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 257}}` |
...
- `lua-source-257` from `master_json` as `source_list_item`
