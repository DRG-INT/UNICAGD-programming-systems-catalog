...
<!-- canonical: https://crates.io/crates/iovec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/iovec](https://crates.io/crates/iovec) |
| Source record ids | crates_io-4d628858d406d3 |
...
For a systems engineer, iovec belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2019-10-09T18:09:56.560010Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-4d628858d406d3` from `crates_io` as `registry_expansion`
