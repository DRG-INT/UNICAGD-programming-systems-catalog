...
<!-- canonical: https://cran.r-project.org/web/packages/ggalttext/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggalttext/index.html](https://cran.r-project.org/web/packages/ggalttext/index.html) |
| Source record ids | cran_packages_by_date-24c24ca0f66b77 |

## System Engineer Summary

Make 'ggplot2' Fully Accessible by Generating Alternative Text

## Operational Role

For a systems engineer, ggalttext belongs in the R inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-31 20:00:02 UTC | [https://cran.r-project.org/web/packages/ggalttext/DESCRIPTION](https://cran.r-project.org/web/packages/ggalttext/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggalttext/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-24c24ca0f66b77` from `cran_packages_by_date` as `registry_expansion`
