...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/simpeg-research/casingSimulations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/simpeg-research/casingSimulations](https://github.com/simpeg-research/casingSimulations) |
| Source record ids | github_search_electromagnetoscopes-f13dc4bff62855 |
...
For a systems engineer, simpeg-research/casingSimulations belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-14T18:13:08Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-f13dc4bff62855` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| IDI-Systems/acre2 | Configuration | [open](electromagnetoscopes-idi-systems-acre2-9d999e66.md) |
| Koenvh1/ets2-local-radio | Configuration | [open](electromagnetoscopes-koenvh1-ets2-local-radio-8d5f9c1b.md) |
