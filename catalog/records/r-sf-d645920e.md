...
<!-- canonical: https://cran.r-project.org/web/packages/sf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sf/index.html](https://cran.r-project.org/web/packages/sf/index.html) |
| Source record ids | cran_packages_by_date-ad1ae079328d3a |

## System Engineer Summary

sf is tracked as a library record in the R branch. The source did not provide a long description, so
this page keeps the identity, release state, provenance, and operational classification explicit for
later enrichment.

## Operational Role

For a systems engineer, sf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-3 | 2026-09-11 06:40:02 UTC | [https://cran.r-project.org/web/packages/sf/DESCRIPTION](https://cran.r-project.org/web/packages/sf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sf/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-ad1ae079328d3a` from `cran_packages_by_date` as `registry_expansion`
