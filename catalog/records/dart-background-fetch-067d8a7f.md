...
<!-- canonical: https://pub.dev/packages/background_fetch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/background_fetch](https://pub.dev/packages/background_fetch) |
| Source record ids | pub_dev-32bcef2b43fcda |

## System Engineer Summary

Periodic callbacks in the background for both iOS and Android. Includes Android Headless
implementation.

## Operational Role

For a systems engineer, background_fetch belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2026-05-25T14:46:29.301892Z | [https://pub.dev/api/packages/background_fetch](https://pub.dev/api/packages/background_fetch) |  |
| preview | known | 1.0.0-nullsafety.3 | 2021-06-09T15:58:22.652748Z | [https://pub.dev/api/packages/background_fetch](https://pub.dev/api/packages/background_fetch) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/background_fetch` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-32bcef2b43fcda` from `pub_dev` as `registry_expansion`
