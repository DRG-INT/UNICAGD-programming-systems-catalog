...
<!-- canonical: https://cran.r-project.org/web/packages/fracreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fracreg/index.html](https://cran.r-project.org/web/packages/fracreg/index.html) |
| Source record ids | cran_packages_by_date-85a855bb0e29e1 |
...
For a systems engineer, fracreg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-20 13:00:02 UTC | [https://cran.r-project.org/web/packages/fracreg/DESCRIPTION](https://cran.r-project.org/web/packages/fracreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fracreg/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-85a855bb0e29e1` from `cran_packages_by_date` as `registry_expansion`
