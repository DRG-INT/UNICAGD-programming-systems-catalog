...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/needenv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/needenv/index.html](https://cran.r-project.org/web/packages/needenv/index.html) |
| Source record ids | cran_packages_by_date-ededdc81838f30 |
...
For a systems engineer, needenv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 09:20:18 UTC | [https://cran.r-project.org/web/packages/needenv/DESCRIPTION](https://cran.r-project.org/web/packages/needenv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/needenv/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ededdc81838f30` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| blockCV | Configuration | [open](r-blockcv-d3605783.md) |
| CausalState | Configuration | [open](r-causalstate-3d54ad2d.md) |
| checker | Configuration | [open](r-checker-4a867235.md) |
| eigencore | Configuration | [open](r-eigencore-f3582b39.md) |
| envar | Configuration | [open](r-envar-b96db934.md) |
| envnames | Configuration | [open](r-envnames-bb1ac672.md) |
| oystermapR | Configuration | [open](r-oystermapr-0d46e238.md) |
| rix | Configuration | [open](r-rix-fccc1330.md) |
