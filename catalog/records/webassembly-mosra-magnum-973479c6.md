...
| Source record ids | github_search_webassembly-1de6acbba84e5a |
...
For a systems engineer, mosra/magnum belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2020.06 | 2020-07-02T13:05:09Z | [https://api.github.com/repos/mosra/magnum/releases/latest](https://api.github.com/repos/mosra/magnum/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mosra/magnum/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-1de6acbba84e5a` from `github_search_webassembly` as `registry_expansion`
