...
| Source record ids | github_search_physics_engines-f87d9612ec9bc4 |
...
For a systems engineer, petercorke/robotics-toolbox-matlab belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-01T21:23:11Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `github_search_physics_engines-f87d9612ec9bc4` from `github_search_physics_engines` as `registry_expansion`
