...
<!-- canonical: https://github.com/sadhvikoli/space-rover-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sadhvikoli/space-rover-agent](https://github.com/sadhvikoli/space-rover-agent) |
| Source record ids | github_search_space_maps-2d3927a18be5e1 |

## System Engineer Summary

Autonomous Map-Based Space Rover Agent for simulated planetary exploration

## Operational Role

For a systems engineer, sadhvikoli/space-rover-agent belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-14T14:20:02Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2d3927a18be5e1` from `github_search_space_maps` as `registry_expansion`
