...
<!-- canonical: https://pypi.org/project/acs_cli_mi/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acs_cli_mi/](https://pypi.org/project/acs_cli_mi/) |
| Source record ids | pypi_simple-6e045f8adcb25c |
...
For a systems engineer, acs_cli_mi belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-02-26T18:34:03.315850Z | [https://pypi.org/pypi/acs_cli_mi/json](https://pypi.org/pypi/acs_cli_mi/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acs_cli_mi/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-6e045f8adcb25c` from `pypi_simple` as `registry_expansion`
