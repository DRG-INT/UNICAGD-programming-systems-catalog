...
<!-- canonical: https://github.com/dorukkumkumoglu/optocamzero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dorukkumkumoglu/optocamzero](https://github.com/dorukkumkumoglu/optocamzero) |
| Source record ids | github_search_photography-319cc9757b2e6c |

## System Engineer Summary

Optocam Zero is a Raspberry Pi Zero based compact digital camera made using off the shelf
components.

## Operational Role

For a systems engineer, dorukkumkumoglu/optocamzero belongs in the Photography inventory as part of
...
- `github_search_photography-319cc9757b2e6c` from `github_search_photography` as `registry_expansion`
