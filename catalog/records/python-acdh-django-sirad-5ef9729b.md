...
<!-- canonical: https://pypi.org/project/acdh-django-sirad/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-sirad/](https://pypi.org/project/acdh-django-sirad/) |
| Source record ids | pypi_simple-ec2e2eb40ac442 |
...
For a systems engineer, acdh-django-sirad belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2018-09-07T12:08:58.686406Z | [https://pypi.org/pypi/acdh-django-sirad/json](https://pypi.org/pypi/acdh-django-sirad/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-sirad/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-ec2e2eb40ac442` from `pypi_simple` as `registry_expansion`
