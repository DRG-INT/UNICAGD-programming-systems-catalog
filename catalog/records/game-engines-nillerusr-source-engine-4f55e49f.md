...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nillerusr/source-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nillerusr/source-engine](https://github.com/nillerusr/source-engine) |
| Source record ids | github_search_game_engines-4fc9736dcd0778 |
...
For a systems engineer, nillerusr/source-engine belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T03:33:03Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-4fc9736dcd0778` from `github_search_game_engines` as `registry_expansion`
