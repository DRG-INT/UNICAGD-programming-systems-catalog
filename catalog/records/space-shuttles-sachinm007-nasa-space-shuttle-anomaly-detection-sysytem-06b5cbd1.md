# SachinM007/NASA-Space-Shuttle-Anomaly-Detection-Sysytem

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SachinM007/NASA-Space-Shuttle-Anomaly-Detection-Sysytem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SachinM007/NASA-Space-Shuttle-Anomaly-Detection-Sysytem](https://github.com/SachinM007/NASA-Space-Shuttle-Anomaly-Detection-Sysytem) |
| Source record ids | github_search_space_shuttles-52e0c5a024d312 |

## System Engineer Summary

A machine learning system that automatically detects anomalies in multivariate time series data from
the NASA Space Shuttle. These anomalies can correspond to system malfunctions, sensor drifts, or
operational faults

## Operational Role

For a systems engineer, SachinM007/NASA-Space-Shuttle-Anomaly-Detection-Sysytem belongs in the Space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-09T05:55:33Z | gh search repos NASA space shuttle data | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-52e0c5a024d312` from `github_search_space_shuttles` as `registry_expansion`
