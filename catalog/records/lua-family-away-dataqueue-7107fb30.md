...
<!-- canonical: https://luarocks.org/modules/thislight/away-dataqueue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thislight/away-dataqueue](https://luarocks.org/modules/thislight/away-dataqueue) |
| Source record ids | luarocks_root_manifest-f1cf0723aba794 |
...
For a systems engineer, away-dataqueue belongs in the Lua family inventory as part of concurrency
...
- `luarocks_root_manifest-f1cf0723aba794` from `luarocks_root_manifest` as `registry_expansion`
