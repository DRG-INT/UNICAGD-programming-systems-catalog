...
<!-- canonical: https://pub.dev/packages/timezone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/timezone](https://pub.dev/packages/timezone) |
| Source record ids | pub_dev-d844b6beb79e43 |
...
For a systems engineer, timezone belongs in the Dart inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1 | 2026-06-29T07:44:30.784613Z | [https://pub.dev/api/packages/timezone](https://pub.dev/api/packages/timezone) |  |
| preview | known | 0.7.0-nullsafety.0 | 2021-01-12T16:21:20.697480Z | [https://pub.dev/api/packages/timezone](https://pub.dev/api/packages/timezone) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/timezone` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-d844b6beb79e43` from `pub_dev` as `registry_expansion`
