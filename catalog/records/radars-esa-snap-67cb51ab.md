...
<!-- canonical: https://step.esa.int/main/toolboxes/snap/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://step.esa.int/main/toolboxes/snap/](https://step.esa.int/main/toolboxes/snap/) |
| Source record ids | curated_language_routes-58eb1e4f8356dd |

## System Engineer Summary

Sentinel Application Platform for SAR, optical remote sensing, radar processing, and geospatial
analysis.

## Operational Role

For a systems engineer, ESA SNAP belongs in the Radars inventory as part of ecosystem capability
...
- `curated_language_routes-58eb1e4f8356dd` from `curated_language_routes` as `registry_expansion`
