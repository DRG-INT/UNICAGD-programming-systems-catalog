...
<!-- canonical: https://crates.io/crates/md5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/md5](https://crates.io/crates/md5) |
| Source record ids | crates_io-b483d994a0c350 |
...
For a systems engineer, md5 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-07-09T09:41:18.896790Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-b483d994a0c350` from `crates_io` as `registry_expansion`
