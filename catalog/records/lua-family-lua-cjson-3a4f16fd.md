...
<!-- canonical: https://github.com/mpx/lua-cjson/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mpx/lua-cjson/](https://github.com/mpx/lua-cjson/) |
| Source record ids | lua-source-247 |
...
For a systems engineer, lua-cjson belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 247}}` |
...
- `lua-source-247` from `master_json` as `source_list_item`
