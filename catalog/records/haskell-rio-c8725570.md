...
<!-- canonical: https://hackage.haskell.org/package/rio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/rio](https://hackage.haskell.org/package/rio) |
| Source record ids | hackage_top_downloads-0c490cecb83d1d |
...
For a systems engineer, rio belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.25.0 | 2026-07-03T22:14:25Z | [https://hackage.haskell.org/package/rio](https://hackage.haskell.org/package/rio) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/rio` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-0c490cecb83d1d` from `hackage_top_downloads` as `registry_expansion`
