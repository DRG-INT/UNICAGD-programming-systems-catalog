...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/playcanvas/engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/playcanvas/engine](https://github.com/playcanvas/engine) |
| Source record ids | github_search_game_engines-e956be22b65a02 |
...
For a systems engineer, playcanvas/engine belongs in the Game Engines inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:35:47Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e956be22b65a02` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gonglei007/GameDevMind | Interpreter Runtime | [open](game-engines-gonglei007-gamedevmind-f08a85ea.md) |
| korlibs/korge | Interpreter Runtime | [open](game-engines-korlibs-korge-93eb84fb.md) |
