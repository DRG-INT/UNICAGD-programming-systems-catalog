...
<!-- canonical: https://github.com/opensource-socialnetwork/opensource-socialnetwork -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opensource-socialnetwork/opensource-socialnetwork](https://github.com/opensource-socialnetwork/opensource-socialnetwork) |
| Source record ids | github_search_icons_and_logos-ea5258a32c1a9b |

## System Engineer Summary

Open Source Social Network (OSSN) is a powerful open-source social networking software developed in
PHP. It enables you to create a fully functional social networking website that fosters community
engagement and helps your members form meaningful social relationships.

## Operational Role

For a systems engineer, opensource-socialnetwork/opensource-socialnetwork belongs in the Icons and
Logos inventory as part of service communication, clients/servers, protocol handling, and edge
integration.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T19:23:34Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-ea5258a32c1a9b` from `github_search_icons_and_logos` as `registry_expansion`
