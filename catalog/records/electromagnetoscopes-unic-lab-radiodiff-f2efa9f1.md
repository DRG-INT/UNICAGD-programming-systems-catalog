...
<!-- canonical: https://github.com/UNIC-Lab/RadioDiff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UNIC-Lab/RadioDiff](https://github.com/UNIC-Lab/RadioDiff) |
| Source record ids | github_search_electromagnetoscopes-4d8201a3b6affc |

## System Engineer Summary

This is the code for the paper "RadioDiff: An Effective Generative Diffusion Model for Sampling-Free
Dynamic Radio Map Construction", IEEE TCCN.

## Operational Role

For a systems engineer, UNIC-Lab/RadioDiff belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-04T04:35:53Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-4d8201a3b6affc` from `github_search_electromagnetoscopes` as `registry_expansion`
