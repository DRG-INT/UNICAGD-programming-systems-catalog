...
| Canonical URL | [https://crates.io/crates/fast_chemail](https://crates.io/crates/fast_chemail) |
| Source record ids | crates_io-2003ce2d2874f9 |

## System Engineer Summary

fast_chemail is tracked as a parser lexer ast record in the Rust branch. The source did not provide
...
For a systems engineer, fast_chemail belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.6 | 2019-02-15T12:02:40.474144Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-2003ce2d2874f9` from `crates_io` as `registry_expansion`
