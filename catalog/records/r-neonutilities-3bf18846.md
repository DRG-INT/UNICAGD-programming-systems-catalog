...
<!-- canonical: https://cran.r-project.org/web/packages/neonUtilities/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/neonUtilities/index.html](https://cran.r-project.org/web/packages/neonUtilities/index.html) |
| Source record ids | cran_packages_by_date-296cf8ee45d869 |
...
For a systems engineer, neonUtilities belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2026-09-09 20:50:02 UTC | [https://cran.r-project.org/web/packages/neonUtilities/DESCRIPTION](https://cran.r-project.org/web/packages/neonUtilities/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/neonUtilities/DESCRIPTION` at `2026-09-09T22:18:43+00:00`.
...
- `cran_packages_by_date-296cf8ee45d869` from `cran_packages_by_date` as `registry_expansion`
