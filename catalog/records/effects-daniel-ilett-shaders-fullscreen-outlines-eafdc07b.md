...
<!-- canonical: https://github.com/daniel-ilett/shaders-fullscreen-outlines -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daniel-ilett/shaders-fullscreen-outlines](https://github.com/daniel-ilett/shaders-fullscreen-outlines) |
| Source record ids | github_search_effects-d342a9c819e161 |
...
For a systems engineer, daniel-ilett/shaders-fullscreen-outlines belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-21T11:09:20Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d342a9c819e161` from `github_search_effects` as `registry_expansion`
