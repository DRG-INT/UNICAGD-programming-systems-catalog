...
<!-- canonical: https://cran.r-project.org/web/packages/term/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/term/index.html](https://cran.r-project.org/web/packages/term/index.html) |
| Source record ids | cran_packages_by_date-25e4768c50e6cd |
...
For a systems engineer, term belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-30 12:50:02 UTC | [https://cran.r-project.org/web/packages/term/DESCRIPTION](https://cran.r-project.org/web/packages/term/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/term/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-25e4768c50e6cd` from `cran_packages_by_date` as `registry_expansion`
