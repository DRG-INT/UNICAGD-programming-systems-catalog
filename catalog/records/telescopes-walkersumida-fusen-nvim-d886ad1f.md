...
| Canonical URL | [https://github.com/walkersumida/fusen.nvim](https://github.com/walkersumida/fusen.nvim) |
| Source record ids | github_search_telescopes-56cb4f9fe410e7 |

## System Engineer Summary

Sticky note bookmarks for Neovim — per Git branch, with hover annotations, Telescope integration,
and one-keystroke handoff to AI assistants

## Operational Role

For a systems engineer, walkersumida/fusen.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.10.1 | 2026-07-22T13:23:58Z | [https://api.github.com/repos/walkersumida/fusen.nvim/releases/latest](https://api.github.com/repos/walkersumida/fusen.nvim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/walkersumida/fusen.nvim/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_telescopes-56cb4f9fe410e7` from `github_search_telescopes` as `registry_expansion`
