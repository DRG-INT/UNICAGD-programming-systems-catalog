# luoxue03/mpv-lazy-2026-custom

## Navigation

[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/luoxue03/mpv-lazy-2026-custom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luoxue03/mpv-lazy-2026-custom](https://github.com/luoxue03/mpv-lazy-2026-custom) |
| Source record ids | github_search_photography-87918992ef96a1 |

## System Engineer Summary

MPV Lazy 2026 custom Windows build with RIFE/TensorRT, VapourSynth, Anime4K, external-player,
Telegram Web MPV bridge, and Chinese docs.

## Operational Role

For a systems engineer, luoxue03/mpv-lazy-2026-custom belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T14:18:51Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-87918992ef96a1` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Chinna95P/mpv-anime-build | Build System | [open](photography-chinna95p-mpv-anime-build-c3f4be6f.md) |
| natario1/CameraView | Build System | [open](photography-natario1-cameraview-d63ed58c.md) |
| nuno-faria/tiler | Build System | [open](photography-nuno-faria-tiler-7b94422f.md) |
| NVIDIA/DALI | Build System | [open](photography-nvidia-dali-a173c9e6.md) |
| Srameo/LED | Build System | [open](photography-srameo-led-221cbacc.md) |
