...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Transmission Protocols](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/transmission-protocols.md) · [Category: Cryptography](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cryptography.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Transmission Protocols |
| Category | Cryptography |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/openssl/openssl](https://github.com/openssl/openssl) |
| Source record ids | curated_language_routes-1b04526728eb33 |

## System Engineer Summary

TLS/cryptography library and protocol implementation used in many transport stacks.

## Operational Role

For a systems engineer, OpenSSL belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-1b04526728eb33` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| OpenSSH Protocol | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-openssh-protocol-852d3503.md) |
| TLS 1.3 | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-tls-1-3-53d058ea.md) |
