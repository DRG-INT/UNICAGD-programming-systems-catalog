...
<!-- canonical: https://crates.io/crates/fiat-crypto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fiat-crypto](https://crates.io/crates/fiat-crypto) |
| Source record ids | crates_io-3c68cd0ecc8c93 |
...
For a systems engineer, fiat-crypto belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2025-06-04T02:42:06.808859Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-04T18:20:51+00:00`.
...
- `crates_io-3c68cd0ecc8c93` from `crates_io` as `registry_expansion`
