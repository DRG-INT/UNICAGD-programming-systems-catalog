...
<!-- canonical: https://cran.r-project.org/web/packages/later2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/later2/index.html](https://cran.r-project.org/web/packages/later2/index.html) |
| Source record ids | cran_packages_by_date-7aad5b56ab3435 |
...
For a systems engineer, later2 belongs in the R inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2026-09-03 12:50:02 UTC | [https://cran.r-project.org/web/packages/later2/DESCRIPTION](https://cran.r-project.org/web/packages/later2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/later2/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-7aad5b56ab3435` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rush | Async Runtime | [open](r-rush-d3668ebf.md) |
