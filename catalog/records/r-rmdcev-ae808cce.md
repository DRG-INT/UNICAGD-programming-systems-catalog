...
<!-- canonical: https://cran.r-project.org/web/packages/rmdcev/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rmdcev/index.html](https://cran.r-project.org/web/packages/rmdcev/index.html) |
| Source record ids | cran_packages_by_date-43914d4e5730f0 |
...
For a systems engineer, rmdcev belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2026-09-14 23:40:07 UTC | [https://cran.r-project.org/web/packages/rmdcev/DESCRIPTION](https://cran.r-project.org/web/packages/rmdcev/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rmdcev/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-43914d4e5730f0` from `cran_packages_by_date` as `registry_expansion`
