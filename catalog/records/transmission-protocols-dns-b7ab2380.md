...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Transmission Protocols](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/transmission-protocols.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc1035.html](https://www.rfc-editor.org/rfc/rfc1035.html) |
| Source record ids | curated_language_routes-b51d080462ad7b |

## System Engineer Summary

Domain Name System protocol specification for names, resource records, messages, and resolvers.

## Operational Role

For a systems engineer, DNS belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-b51d080462ad7b` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| gRPC over HTTP/2 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-grpc-over-http-2-9d4c8167.md) |
| HTTP Semantics | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-http-semantics-ef878c32.md) |
| HTTP/1.1 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-http-1-1-fed37ebc.md) |
| HTTP/2 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-http-2-598c88cd.md) |
| HTTP/3 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-http-3-12c535ac.md) |
| lsquic | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-lsquic-fd5dba46.md) |
| ngtcp2 | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-ngtcp2-180e4dcd.md) |
| QUIC | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/transmission-protocols-quic-3814ec39.md) |
