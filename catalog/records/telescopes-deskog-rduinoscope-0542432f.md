...
| Source record ids | github_search_telescopes-61bfdef3cbc8cc |
...
For a systems engineer, dEskoG/rDUINOScope belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.3.1 | 2017-09-09T08:25:13Z | [https://api.github.com/repos/dEskoG/rDUINOScope/releases/latest](https://api.github.com/repos/dEskoG/rDUINOScope/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dEskoG/rDUINOScope/releases/latest` at `2026-09-01T11:22:13+00:00`.
...
- `github_search_telescopes-61bfdef3cbc8cc` from `github_search_telescopes` as `registry_expansion`
