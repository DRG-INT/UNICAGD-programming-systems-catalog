...
<!-- canonical: https://github.com/austinmhorn/basilisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/austinmhorn/basilisk](https://github.com/austinmhorn/basilisk) |
| Source record ids | github_search_basilisk-dd77fca740b02c |

## System Engineer Summary

Deterministic C++20 cave-hunting game engine with shared core logic, SDL3 clients, simulation
tooling, and WebAssembly support.

## Operational Role

For a systems engineer, austinmhorn/basilisk belongs in the Basilisk inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:51:11Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-dd77fca740b02c` from `github_search_basilisk` as `registry_expansion`
