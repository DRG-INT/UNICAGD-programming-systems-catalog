...
<!-- canonical: https://crates.io/crates/ron -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-1bd9226f998ea5 |

## System Engineer Summary

ron is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, ron belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.2 | 2026-06-22T19:06:10.059085Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-1bd9226f998ea5` from `crates_io` as `registry_expansion`
