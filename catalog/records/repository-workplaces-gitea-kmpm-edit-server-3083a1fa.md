...
<!-- canonical: https://gitea.com/kmpm/edit-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/kmpm/edit-server](https://gitea.com/kmpm/edit-server) |
| Source record ids | gitea_repositories_api-35b1b1e54583c7 |
...
For a systems engineer, Gitea: kmpm/edit-server belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-22T14:40:03Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-35b1b1e54583c7` from `gitea_repositories_api` as `registry_expansion`
