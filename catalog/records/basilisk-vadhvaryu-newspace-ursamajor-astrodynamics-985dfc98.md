# vadhvaryu/newspace-ursamajor-astrodynamics
...
<!-- canonical: https://github.com/vadhvaryu/newspace-ursamajor-astrodynamics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vadhvaryu/newspace-ursamajor-astrodynamics](https://github.com/vadhvaryu/newspace-ursamajor-astrodynamics) |
| Source record ids | github_search_basilisk-4fd8070f99a234 |

## System Engineer Summary

Relevant Basilisk files for NewSpcae @ Berkeley's Astrodynamics project for Ursa Major

## Operational Role

For a systems engineer, vadhvaryu/newspace-ursamajor-astrodynamics belongs in the Basilisk inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T10:01:54Z | gh search repos basilisk astrodynamics | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-4fd8070f99a234` from `github_search_basilisk` as `registry_expansion`
