...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/VoltAgent/awesome-claude-design -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VoltAgent/awesome-claude-design](https://github.com/VoltAgent/awesome-claude-design) |
| Source record ids | github_search_icons_and_logos-cd081ff9a2a38e |

## System Engineer Summary

Awesome Claude Design: 68 ready-to-use design system inspirations in DESIGN.md format. Drop one in,
scaffold a full UI in one shot.

## Operational Role

For a systems engineer, VoltAgent/awesome-claude-design belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-20T17:54:18Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-cd081ff9a2a38e` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DesignRevision/shards-dashboard-react | Project Scaffolding | [open](icons-and-logos-designrevision-shards-dashboard-react-e799d912.md) |
| MohamedYoussouf/Design-Resources | Project Scaffolding | [open](icons-and-logos-mohamedyoussouf-design-resources-ca4805fc.md) |
| rladies/starter-kit | Project Scaffolding | [open](icons-and-logos-rladies-starter-kit-96e24921.md) |
| studio1902/statamic-peak | Project Scaffolding | [open](icons-and-logos-studio1902-statamic-peak-9976aca5.md) |
| Zer0CoolX/guacamole-customize-loginscreen-extension | Project Scaffolding | [open](icons-and-logos-zer0coolx-guacamole-customize-loginscreen-extension-bc0baf89.md) |
