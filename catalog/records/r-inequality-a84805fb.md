...
<!-- canonical: https://cran.r-project.org/web/packages/inequality/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inequality/index.html](https://cran.r-project.org/web/packages/inequality/index.html) |
| Source record ids | cran_packages_by_date-275ffb103453d9 |
...
For a systems engineer, inequality belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-08 07:20:10 UTC | [https://cran.r-project.org/web/packages/inequality/DESCRIPTION](https://cran.r-project.org/web/packages/inequality/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inequality/DESCRIPTION` at `2026-09-08T08:22:37+00:00`.
...
- `cran_packages_by_date-275ffb103453d9` from `cran_packages_by_date` as `registry_expansion`
