...
<!-- canonical: https://cran.r-project.org/web/packages/metalite.ae/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metalite.ae/index.html](https://cran.r-project.org/web/packages/metalite.ae/index.html) |
| Source record ids | cran_packages_by_date-eb34bc3c7495a1 |
...
For a systems engineer, metalite.ae belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-29 12:10:22 UTC | [https://cran.r-project.org/web/packages/metalite.ae/DESCRIPTION](https://cran.r-project.org/web/packages/metalite.ae/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metalite.ae/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eb34bc3c7495a1` from `cran_packages_by_date` as `registry_expansion`
