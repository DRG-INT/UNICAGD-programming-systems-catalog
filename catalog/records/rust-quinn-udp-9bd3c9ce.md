...
<!-- canonical: https://crates.io/crates/quinn-udp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quinn-udp](https://crates.io/crates/quinn-udp) |
| Source record ids | crates_io-7f19d9f348c7d3 |
...
For a systems engineer, quinn-udp belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2026-09-06T07:39:02.338192Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-06T08:20:16+00:00`.
...
- `crates_io-7f19d9f348c7d3` from `crates_io` as `registry_expansion`
