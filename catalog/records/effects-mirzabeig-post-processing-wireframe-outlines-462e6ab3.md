...
<!-- canonical: https://github.com/MirzaBeig/Post-Processing-Wireframe-Outlines -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MirzaBeig/Post-Processing-Wireframe-Outlines](https://github.com/MirzaBeig/Post-Processing-Wireframe-Outlines) |
| Source record ids | github_search_effects-8494931e675c38 |
...
For a systems engineer, MirzaBeig/Post-Processing-Wireframe-Outlines belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-06T00:14:55Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8494931e675c38` from `github_search_effects` as `registry_expansion`
