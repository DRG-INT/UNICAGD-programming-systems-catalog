...
<!-- canonical: https://github.com/RononDex/Astrobot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RononDex/Astrobot](https://github.com/RononDex/Astrobot) |
| Source record ids | github_search_telescopes-9612e6e7541027 |

## System Engineer Summary

An advanced discord bot running on .net core, that can help with anything that is astronomy related
(platesolving, image analysis, astronomical weather forecast, get information on DSO's, ...)

## Operational Role

For a systems engineer, RononDex/Astrobot belongs in the Telescopes inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:57:34Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-9612e6e7541027` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gwastro/pycbc | Static Analyzer | [open](telescopes-gwastro-pycbc-b93b6565.md) |
