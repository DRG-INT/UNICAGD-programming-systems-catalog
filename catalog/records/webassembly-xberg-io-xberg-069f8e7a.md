...
<!-- canonical: https://github.com/xberg-io/xberg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xberg-io/xberg](https://github.com/xberg-io/xberg) |
| Source record ids | github_search_webassembly-b27a486799e93b |

## System Engineer Summary

Polyglot document intelligence with a Rust core: extract text, metadata, images, tables, and
structured data from 106 formats across 140 file extensions, plus code intelligence for 371
languages. Fifteen bindings, with CLI, REST API, and MCP server.

## Operational Role

For a systems engineer, xberg-io/xberg belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T12:00:03Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b27a486799e93b` from `github_search_webassembly` as `registry_expansion`
