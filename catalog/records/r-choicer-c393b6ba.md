...
<!-- canonical: https://cran.r-project.org/web/packages/choicer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/choicer/index.html](https://cran.r-project.org/web/packages/choicer/index.html) |
| Source record ids | cran_packages_by_date-a26480dc241962 |
...
For a systems engineer, choicer belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-04 21:20:02 UTC | [https://cran.r-project.org/web/packages/choicer/DESCRIPTION](https://cran.r-project.org/web/packages/choicer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/choicer/DESCRIPTION` at `2026-09-04T22:18:17+00:00`.
...
- `cran_packages_by_date-a26480dc241962` from `cran_packages_by_date` as `registry_expansion`
