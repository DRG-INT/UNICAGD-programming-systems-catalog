...
<!-- canonical: https://github.com/appsinacup/godot-rapier-physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/appsinacup/godot-rapier-physics](https://github.com/appsinacup/godot-rapier-physics) |
| Source record ids | github_search_physics_engines-212a87926bf476 |

## System Engineer Summary

Godot Rapier Physics – 2D and 3D physics engine for the Godot game engine. with better stability,
performance, liquids, determinism, state serialization and no ghost collisions.

## Operational Role

For a systems engineer, appsinacup/godot-rapier-physics belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:30:25Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-212a87926bf476` from `github_search_physics_engines` as `registry_expansion`
