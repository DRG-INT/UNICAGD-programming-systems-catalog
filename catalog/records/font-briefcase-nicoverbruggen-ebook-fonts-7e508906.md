...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nicoverbruggen/ebook-fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nicoverbruggen/ebook-fonts](https://github.com/nicoverbruggen/ebook-fonts) |
| Source record ids | github_search_font_briefcase-54b0f996bc33ad |

## System Engineer Summary

Selection of fonts with modified line height and family names, optimized for e-reading, particularly
for Kobo, Kindle and Boox devices.

## Operational Role

For a systems engineer, nicoverbruggen/ebook-fonts belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T10:20:17Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-54b0f996bc33ad` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fontforge/designwithfontforge.com | Tutorial Book Styleguide | [open](font-briefcase-fontforge-designwithfontforge-com-a783fc58.md) |
