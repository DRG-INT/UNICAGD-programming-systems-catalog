...
<!-- canonical: https://github.com/zhuohan123/macaron-net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhuohan123/macaron-net](https://github.com/zhuohan123/macaron-net) |
| Source record ids | github_search_effects-013ee965961a92 |

## System Engineer Summary

Codes for "Understanding and Improving Transformer From a Multi-Particle Dynamic System Point of
View"

## Operational Role

For a systems engineer, zhuohan123/macaron-net belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-10T09:05:34Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-013ee965961a92` from `github_search_effects` as `registry_expansion`
