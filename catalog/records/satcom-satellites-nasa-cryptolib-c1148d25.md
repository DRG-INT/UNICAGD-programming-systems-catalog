...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nasa/CryptoLib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nasa/CryptoLib](https://github.com/nasa/CryptoLib) |
| Source record ids | github_search_satcom_satellites-645a6bfb25bfaf |

## System Engineer Summary

Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended
Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System
(cFS) and a ground station.

## Operational Role

For a systems engineer, nasa/CryptoLib belongs in the SatCom Satellites inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T19:23:01Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-645a6bfb25bfaf` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| githubsatelliteworkshops/codeql | Security Sast | [open](satcom-satellites-githubsatelliteworkshops-codeql-9d99324c.md) |
| ine-labs/ORBITAL-EXPLOIT | Security Sast | [open](satcom-satellites-ine-labs-orbital-exploit-553262d7.md) |
| Peco602/awesome-space-security | Security Sast | [open](satcom-satellites-peco602-awesome-space-security-600d05c6.md) |
| PentHertz/RF-Swift | Security Sast | [open](satcom-satellites-penthertz-rf-swift-0cf96f11.md) |
