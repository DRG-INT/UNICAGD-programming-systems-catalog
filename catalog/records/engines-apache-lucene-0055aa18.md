...
| Canonical URL | [https://github.com/apache/lucene](https://github.com/apache/lucene) |
| Source record ids | curated_language_routes-856f0ffd70cc95 |

## System Engineer Summary

Search engine library for indexing, query execution, analyzers, scoring, and full-text retrieval
systems.

## Operational Role

For a systems engineer, Apache Lucene belongs in the Engines inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | releases/lucene/10.5.1 | 2026-08-12T14:59:46Z | [https://api.github.com/repos/apache/lucene/releases/latest](https://api.github.com/repos/apache/lucene/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apache/lucene/releases/latest` at `2026-09-01T12:30:33+00:00`.
...
- `curated_language_routes-856f0ffd70cc95` from `curated_language_routes` as `registry_expansion`
