...
<!-- canonical: https://luarocks.org/modules/cwood-sdf/banana.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cwood-sdf/banana.nvim](https://luarocks.org/modules/cwood-sdf/banana.nvim) |
| Source record ids | luarocks_root_manifest-d4741da4f9e70a |
...
For a systems engineer, banana.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d4741da4f9e70a` from `luarocks_root_manifest` as `registry_expansion`
