...
| Canonical URL | [https://crates.io/crates/unicode-id-start](https://crates.io/crates/unicode-id-start) |
| Source record ids | crates_io-31e43944c01731 |

## System Engineer Summary

Determine whether characters have the ID_Start or ID_Continue properties according to Unicode
Standard Annex #31

## Operational Role

For a systems engineer, unicode-id-start belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-06-30T11:06:32.099974Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-31e43944c01731` from `crates_io` as `registry_expansion`
