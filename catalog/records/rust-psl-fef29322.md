...
| Canonical URL | [https://crates.io/crates/psl](https://crates.io/crates/psl) |
| Source record ids | crates_io-4962aa4abcff5c |
...
For a systems engineer, psl belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.226 | 2026-08-21T01:45:42.252358Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-4962aa4abcff5c` from `crates_io` as `registry_expansion`
