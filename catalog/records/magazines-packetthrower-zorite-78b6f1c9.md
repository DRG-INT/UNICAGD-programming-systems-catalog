...
<!-- canonical: https://github.com/packetThrower/zorite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/packetThrower/zorite](https://github.com/packetThrower/zorite) |
| Source record ids | github_search_magazines-5e01d8d88f50a5 |

## System Engineer Summary

Local-first, Logseq-style daily journal. Rust + GPUI + SQLite, with a custom gpui-markdown renderer
and PDF viewer, custom gpui-whiteboard, (clickable wiki-links, tags, slash menu).

## Operational Role

For a systems engineer, packetThrower/zorite belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T17:30:49Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-5e01d8d88f50a5` from `github_search_magazines` as `registry_expansion`
