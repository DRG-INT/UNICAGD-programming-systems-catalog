...
<!-- canonical: https://crates.io/crates/toml -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-fe9b6dd8fc389e |
...
For a systems engineer, toml belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5+spec-1.1.0 | 2026-09-02T13:52:08.284086Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-fe9b6dd8fc389e` from `crates_io` as `registry_expansion`
