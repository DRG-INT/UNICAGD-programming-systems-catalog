...
<!-- canonical: https://cran.r-project.org/web/packages/gkwdist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gkwdist/index.html](https://cran.r-project.org/web/packages/gkwdist/index.html) |
| Source record ids | cran_packages_by_date-153bab54b0680c |
...
For a systems engineer, gkwdist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2026-08-23 06:50:02 UTC | [https://cran.r-project.org/web/packages/gkwdist/DESCRIPTION](https://cran.r-project.org/web/packages/gkwdist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gkwdist/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-153bab54b0680c` from `cran_packages_by_date` as `registry_expansion`
