...
<!-- canonical: https://cran.r-project.org/web/packages/gatoRs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gatoRs/index.html](https://cran.r-project.org/web/packages/gatoRs/index.html) |
| Source record ids | cran_packages_by_date-70404d5d08da04 |
...
For a systems engineer, gatoRs belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-25 11:00:58 UTC | [https://cran.r-project.org/web/packages/gatoRs/DESCRIPTION](https://cran.r-project.org/web/packages/gatoRs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gatoRs/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-70404d5d08da04` from `cran_packages_by_date` as `registry_expansion`
