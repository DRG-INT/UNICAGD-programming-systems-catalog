...
<!-- canonical: https://github.com/delirvfx/Delir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/delirvfx/Delir](https://github.com/delirvfx/Delir) |
| Source record ids | github_search_effects-ccbbdf2d273c6d |
...
For a systems engineer, delirvfx/Delir belongs in the Effects inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-24T09:00:58Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ccbbdf2d273c6d` from `github_search_effects` as `registry_expansion`
