...
<!-- canonical: https://hackage.haskell.org/package/HStringTemplate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HStringTemplate](https://hackage.haskell.org/package/HStringTemplate) |
| Source record ids | hackage_top_downloads-cd820ba0fd074e |
...
For a systems engineer, HStringTemplate belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.8 | 2021-08-12T20:28:23Z | [https://hackage.haskell.org/package/HStringTemplate](https://hackage.haskell.org/package/HStringTemplate) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HStringTemplate` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-cd820ba0fd074e` from `hackage_top_downloads` as `registry_expansion`
