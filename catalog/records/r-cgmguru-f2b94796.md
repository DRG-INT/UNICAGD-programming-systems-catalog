...
<!-- canonical: https://cran.r-project.org/web/packages/cgmguru/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cgmguru/index.html](https://cran.r-project.org/web/packages/cgmguru/index.html) |
| Source record ids | cran_packages_by_date-4e33aaadc5f469 |
...
For a systems engineer, cgmguru belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-21 05:44:51 UTC | [https://cran.r-project.org/web/packages/cgmguru/DESCRIPTION](https://cran.r-project.org/web/packages/cgmguru/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cgmguru/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4e33aaadc5f469` from `cran_packages_by_date` as `registry_expansion`
