...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/electric-sql/pglite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/electric-sql/pglite](https://github.com/electric-sql/pglite) |
| Source record ids | github_search_webassembly-2342645b263d49 |
...
For a systems engineer, electric-sql/pglite belongs in the WebAssembly inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T18:35:11Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-2342645b263d49` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| brson/wasm-opt-rs | Ffi Bindings | [open](webassembly-brson-wasm-opt-rs-c5dac925.md) |
| bytecodealliance/wasi-rs | Ffi Bindings | [open](webassembly-bytecodealliance-wasi-rs-ab5ac60a.md) |
| Official Site | Ffi Bindings | [open](webassembly-official-site-dc08a7a4.md) |
| vitoplantamura/OnnxStream | Ffi Bindings | [open](webassembly-vitoplantamura-onnxstream-8e84d814.md) |
| yewstack/yew | Ffi Bindings | [open](webassembly-yewstack-yew-caa03f24.md) |
