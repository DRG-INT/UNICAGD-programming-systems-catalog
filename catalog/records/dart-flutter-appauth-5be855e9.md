...
<!-- canonical: https://pub.dev/packages/flutter_appauth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_appauth](https://pub.dev/packages/flutter_appauth) |
| Source record ids | pub_dev-109b0cbbb80884 |

## System Engineer Summary

This plugin provides an abstraction around the Android and iOS AppAuth SDKs so it can be used to
communicate with OAuth 2.0 and OpenID Connect providers

## Operational Role

For a systems engineer, flutter_appauth belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 12.1.0 | 2026-08-29T13:02:03.169238Z | [https://pub.dev/api/packages/flutter_appauth](https://pub.dev/api/packages/flutter_appauth) |  |
| preview | known | 12.0.0-dev.1 | 2026-02-19T11:58:46.066327Z | [https://pub.dev/api/packages/flutter_appauth](https://pub.dev/api/packages/flutter_appauth) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_appauth` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-109b0cbbb80884` from `pub_dev` as `registry_expansion`
