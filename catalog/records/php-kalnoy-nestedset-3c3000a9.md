...
<!-- canonical: https://packagist.org/packages/kalnoy/nestedset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kalnoy/nestedset](https://packagist.org/packages/kalnoy/nestedset) |
| Source record ids | packagist_search-2a797fc741135e |
...
For a systems engineer, kalnoy/nestedset belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-2a797fc741135e` from `packagist_search` as `registry_expansion`
