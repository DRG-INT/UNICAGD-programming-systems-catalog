...
<!-- canonical: https://luarocks.org/modules/brigid-jp/brigid-mbedtls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/brigid-jp/brigid-mbedtls](https://luarocks.org/modules/brigid-jp/brigid-mbedtls) |
| Source record ids | luarocks_root_manifest-81ab887742814f |
...
For a systems engineer, brigid-mbedtls belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-81ab887742814f` from `luarocks_root_manifest` as `registry_expansion`
