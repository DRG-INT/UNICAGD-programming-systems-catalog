...
<!-- canonical: https://cran.r-project.org/web/packages/rcompanion/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rcompanion/index.html](https://cran.r-project.org/web/packages/rcompanion/index.html) |
| Source record ids | cran_packages_by_date-44edc4cc0e549c |
...
For a systems engineer, rcompanion belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.4 | 2026-08-20 05:20:43 UTC | [https://cran.r-project.org/web/packages/rcompanion/DESCRIPTION](https://cran.r-project.org/web/packages/rcompanion/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rcompanion/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-44edc4cc0e549c` from `cran_packages_by_date` as `registry_expansion`
