...
<!-- canonical: https://github.com/chalcrow/Atlantis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chalcrow/Atlantis](https://github.com/chalcrow/Atlantis) |
| Source record ids | github_search_space_shuttles-bfbc045dfe0796 |

## System Engineer Summary

Atlantis space shuttle simulator for the Orbiter 2016 flight simulator

## Operational Role

For a systems engineer, chalcrow/Atlantis belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-27T21:15:44Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-bfbc045dfe0796` from `github_search_space_shuttles` as `registry_expansion`
