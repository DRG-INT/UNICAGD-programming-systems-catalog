...
<!-- canonical: https://cran.r-project.org/web/packages/RelDists/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RelDists/index.html](https://cran.r-project.org/web/packages/RelDists/index.html) |
| Source record ids | cran_packages_by_date-481b9e8ee043ae |
...
For a systems engineer, RelDists belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-07 02:20:02 UTC | [https://cran.r-project.org/web/packages/RelDists/DESCRIPTION](https://cran.r-project.org/web/packages/RelDists/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RelDists/DESCRIPTION` at `2026-09-07T03:21:14+00:00`.
...
- `cran_packages_by_date-481b9e8ee043ae` from `cran_packages_by_date` as `registry_expansion`
