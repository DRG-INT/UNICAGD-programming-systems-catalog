...
| Canonical URL | [https://crates.io/crates/serde_fmt](https://crates.io/crates/serde_fmt) |
| Source record ids | crates_io-59a0dbdfeb1c73 |
...
For a systems engineer, serde_fmt belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2025-11-22T23:06:28.844316Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-59a0dbdfeb1c73` from `crates_io` as `registry_expansion`
