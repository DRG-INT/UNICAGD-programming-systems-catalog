...
<!-- canonical: https://github.com/popcorntime/popcorntime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/popcorntime/popcorntime](https://github.com/popcorntime/popcorntime) |
| Source record ids | github_search_video-c07c19d9ac0615 |

## System Engineer Summary

Popcorn Time™ puts everything in one place. Your favorite platforms, your shows, your movies-ready
when you are.

## Operational Role

For a systems engineer, popcorntime/popcorntime belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T03:18:38Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-c07c19d9ac0615` from `github_search_video` as `registry_expansion`
