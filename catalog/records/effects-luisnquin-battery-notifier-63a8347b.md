...
<!-- canonical: https://github.com/luisnquin/battery-notifier -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luisnquin/battery-notifier](https://github.com/luisnquin/battery-notifier) |
| Source record ids | github_search_effects-b30081b3b96b8f |

## System Engineer Summary

The missing part of your WM, a customizable battery notifier for Linux

## Operational Role

For a systems engineer, luisnquin/battery-notifier belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-13T04:07:29Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b30081b3b96b8f` from `github_search_effects` as `registry_expansion`
