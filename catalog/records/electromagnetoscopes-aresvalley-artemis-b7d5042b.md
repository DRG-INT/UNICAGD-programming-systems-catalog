...
<!-- canonical: https://github.com/AresValley/Artemis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AresValley/Artemis](https://github.com/AresValley/Artemis) |
| Source record ids | github_search_electromagnetoscopes-d3a1270cfd5c64 |

## System Engineer Summary

The reference for radio signal identification

## Operational Role

For a systems engineer, AresValley/Artemis belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.2.0 | 2026-07-18T16:03:00Z | [https://api.github.com/repos/AresValley/Artemis/releases/latest](https://api.github.com/repos/AresValley/Artemis/releases/latest) |  |
| preview | known | v4.0.0-RC3 | 2024-06-05T20:37:48Z | [https://api.github.com/repos/AresValley/Artemis/releases?per_page=10](https://api.github.com/repos/AresValley/Artemis/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/AresValley/Artemis/releases/latest` at `2026-09-01T08:26:39+00:00`.
...
- `github_search_electromagnetoscopes-d3a1270cfd5c64` from `github_search_electromagnetoscopes` as `registry_expansion`
