...
| Canonical URL | [https://crates.io/crates/async-net](https://crates.io/crates/async-net) |
| Source record ids | crates_io-3a01e0939819e4 |
...
For a systems engineer, async-net belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2023-10-29T01:50:56.095276Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-3a01e0939819e4` from `crates_io` as `registry_expansion`
