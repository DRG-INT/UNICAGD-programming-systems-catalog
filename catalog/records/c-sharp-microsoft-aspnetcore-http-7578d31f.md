...
<!-- canonical: https://www.nuget.org/packages/Microsoft.AspNetCore.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.AspNetCore.Http](https://www.nuget.org/packages/Microsoft.AspNetCore.Http) |
| Source record ids | nuget_search-73cfecba903e08 |
...
For a systems engineer, Microsoft.AspNetCore.Http belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.12 | 2026-08-11T17:17:03.197+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http/index.json) |  |
| preview | known | 2.2.0-preview3-35497 | 2018-10-17T15:16:46.73+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; https://raw.githubusercontent.com/aspnet/AspNetCore/2.0.0/LICENSE.txt |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-73cfecba903e08` from `nuget_search` as `registry_expansion`
