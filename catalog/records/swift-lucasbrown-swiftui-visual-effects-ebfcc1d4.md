...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lucasbrown/swiftui-visual-effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lucasbrown/swiftui-visual-effects](https://github.com/lucasbrown/swiftui-visual-effects) |
| Source record ids | github_search_swift-c05920c6b70a3f |
...
For a systems engineer, lucasbrown/swiftui-visual-effects belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-09T16:25:34Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-c05920c6b70a3f` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jaywcjlove/PermissionFlow | Configuration | [open](swift-jaywcjlove-permissionflow-44ca9e55.md) |
| simibac/ConfettiSwiftUI | Configuration | [open](swift-simibac-confettiswiftui-c16e3fe7.md) |
| sindresorhus/Settings | Configuration | [open](swift-sindresorhus-settings-0df3359d.md) |
