...
<!-- canonical: https://pub.dev/packages/recase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/recase](https://pub.dev/packages/recase) |
| Source record ids | pub_dev-7816e5b88c4106 |
...
For a systems engineer, recase belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2022-09-26T18:51:03.275187Z | [https://pub.dev/api/packages/recase](https://pub.dev/api/packages/recase) |  |
| preview | known | 4.0.0-nullsafety.0 | 2020-12-05T03:36:40.280192Z | [https://pub.dev/api/packages/recase](https://pub.dev/api/packages/recase) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/recase` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-7816e5b88c4106` from `pub_dev` as `registry_expansion`
