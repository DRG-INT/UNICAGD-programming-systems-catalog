...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Michael-A-Kuykendall/crabcamera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Michael-A-Kuykendall/crabcamera](https://github.com/Michael-A-Kuykendall/crabcamera) |
| Source record ids | github_search_photography-6d43e59b6ccf6e |

## System Engineer Summary

Professional desktop camera plugin for Tauri with automated quality validation and advanced hardware
controls. Zero-config cross-platform solution for photography apps, surveillance systems, and
automated capture workflows.

## Operational Role

For a systems engineer, Michael-A-Kuykendall/crabcamera belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T20:25:22Z | gh search repos topic:photography stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-6d43e59b6ccf6e` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Codectory/AutoActions | Configuration | [open](photography-codectory-autoactions-e74cd863.md) |
| copicseal/copicseal | Configuration | [open](photography-copicseal-copicseal-d2019de1.md) |
| geerlingguy/pi-webcam | Configuration | [open](photography-geerlingguy-pi-webcam-1d30657f.md) |
| hybridgroup/gocv | Configuration | [open](photography-hybridgroup-gocv-a4916bb3.md) |
