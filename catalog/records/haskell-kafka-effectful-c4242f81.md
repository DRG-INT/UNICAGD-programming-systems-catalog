...
<!-- canonical: https://hackage.haskell.org/package/kafka-effectful -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/kafka-effectful](https://hackage.haskell.org/package/kafka-effectful) |
| Source record ids | hackage_recent-3c6eed9272d436 |
...
For a systems engineer, kafka-effectful belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1.0 | 2026-09-16T02:33:40Z | [https://hackage.haskell.org/package/kafka-effectful](https://hackage.haskell.org/package/kafka-effectful) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kafka-effectful` at `2026-09-16T06:31:30+00:00`.
...
- `hackage_recent-3c6eed9272d436` from `hackage_recent` as `registry_expansion`
