...
<!-- canonical: https://luarocks.org/modules/robertlzj/data2string -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/robertlzj/data2string](https://luarocks.org/modules/robertlzj/data2string) |
| Source record ids | luarocks_root_manifest-db2efc754de00f |
...
For a systems engineer, Data2String belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-db2efc754de00f` from `luarocks_root_manifest` as `registry_expansion`
