...
<!-- canonical: https://luarocks.org/modules/bakpakin/binser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bakpakin/binser](https://luarocks.org/modules/bakpakin/binser) |
| Source record ids | luarocks_root_manifest-5932a260db3e67 |
...
For a systems engineer, binser belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-5932a260db3e67` from `luarocks_root_manifest` as `registry_expansion`
