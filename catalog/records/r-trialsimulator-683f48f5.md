...
<!-- canonical: https://cran.r-project.org/web/packages/TrialSimulator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TrialSimulator/index.html](https://cran.r-project.org/web/packages/TrialSimulator/index.html) |
| Source record ids | cran_packages_by_date-d2459d82b1b473 |
...
For a systems engineer, TrialSimulator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.35.8 | 2026-09-04 17:00:02 UTC | [https://cran.r-project.org/web/packages/TrialSimulator/DESCRIPTION](https://cran.r-project.org/web/packages/TrialSimulator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TrialSimulator/DESCRIPTION` at `2026-09-04T18:21:01+00:00`.
...
- `cran_packages_by_date-d2459d82b1b473` from `cran_packages_by_date` as `registry_expansion`
