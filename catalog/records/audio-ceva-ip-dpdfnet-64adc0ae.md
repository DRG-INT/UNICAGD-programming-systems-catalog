...
<!-- canonical: https://github.com/ceva-ip/DPDFNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ceva-ip/DPDFNet](https://github.com/ceva-ip/DPDFNet) |
| Source record ids | github_search_audio-af62b158a7e951 |

## System Engineer Summary

Clean up noisy speech in real time with DPDFNet - open-source streaming speech enhancement for
research, audio apps, and edge devices. Includes pretrained models, PyTorch code, ONNX/TFLite
inference, 8/16/48 kHz support, and live demos.

## Operational Role

For a systems engineer, ceva-ip/DPDFNet belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T11:34:38Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_audio-af62b158a7e951` from `github_search_audio` as `registry_expansion`
