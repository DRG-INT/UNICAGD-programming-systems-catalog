...
<!-- canonical: https://github.com/GIScience/openrouteservice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GIScience/openrouteservice](https://github.com/GIScience/openrouteservice) |
| Source record ids | github_search_maps-a8ebffc3032277 |
...
For a systems engineer, GIScience/openrouteservice belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:25:58Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-a8ebffc3032277` from `github_search_maps` as `registry_expansion`
