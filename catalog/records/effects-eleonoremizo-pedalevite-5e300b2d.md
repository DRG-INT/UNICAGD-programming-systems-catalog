...
<!-- canonical: https://github.com/EleonoreMizo/pedalevite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EleonoreMizo/pedalevite](https://github.com/EleonoreMizo/pedalevite) |
| Source record ids | github_search_effects-6aefba9f7082ec |
...
For a systems engineer, EleonoreMizo/pedalevite belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-01T21:13:56Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl |
...
- `github_search_effects-6aefba9f7082ec` from `github_search_effects` as `registry_expansion`
