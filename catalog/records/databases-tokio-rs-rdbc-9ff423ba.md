...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tokio-rs/rdbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tokio-rs/rdbc](https://github.com/tokio-rs/rdbc) |
| Source record ids | github_search_databases-a92497e421150b |
...
For a systems engineer, tokio-rs/rdbc belongs in the Databases inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-23T02:42:42Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:odbc stars:>50", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_databases-a92497e421150b` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aio-libs/aioodbc | Async Runtime | [open](databases-aio-libs-aioodbc-8b3e0b93.md) |
| art049/odmantic | Async Runtime | [open](databases-art049-odmantic-81efbc63.md) |
| davidmoten/rxjava2-jdbc | Async Runtime | [open](databases-davidmoten-rxjava2-jdbc-7f82410a.md) |
| jasync-sql/jasync-sql | Async Runtime | [open](databases-jasync-sql-jasync-sql-155dc14a.md) |
| Nozbe/WatermelonDB | Async Runtime | [open](databases-nozbe-watermelondb-40dcc1ed.md) |
| psqlpy-python/psqlpy | Async Runtime | [open](databases-psqlpy-python-psqlpy-1df2d26b.md) |
| transact-rs/sqlx | Async Runtime | [open](databases-transact-rs-sqlx-1d6f9b53.md) |
