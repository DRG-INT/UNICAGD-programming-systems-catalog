...
| Source record ids | packagist_search-e4d6aceec2dcae |
...
For a systems engineer, doctrine/mongodb belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.4 | 2019-07-11T05:36:15+00:00 | [https://repo.packagist.org/p2/doctrine/mongodb.json](https://repo.packagist.org/p2/doctrine/mongodb.json) |  |
| preview | known | 1.0.0-BETA3 | 2012-12-05T16:15:17+00:00 | [https://repo.packagist.org/p2/doctrine/mongodb.json](https://repo.packagist.org/p2/doctrine/mongodb.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/doctrine/mongodb.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-e4d6aceec2dcae` from `packagist_search` as `registry_expansion`
