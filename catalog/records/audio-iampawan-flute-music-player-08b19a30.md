...
<!-- canonical: https://github.com/iampawan/Flute-Music-Player -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iampawan/Flute-Music-Player](https://github.com/iampawan/Flute-Music-Player) |
| Source record ids | github_search_audio-8933c7a7b57433 |

## System Engineer Summary

Flute Music Player - First Open Source Flutter based material design music player with audio plugin
to play local music files.

## Operational Role

For a systems engineer, iampawan/Flute-Music-Player belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-30T15:43:12Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-8933c7a7b57433` from `github_search_audio` as `registry_expansion`
