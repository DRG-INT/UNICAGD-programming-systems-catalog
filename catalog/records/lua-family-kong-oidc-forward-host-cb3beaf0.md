...
| Canonical URL | [https://luarocks.org/modules/jasine/kong-oidc-forward-host](https://luarocks.org/modules/jasine/kong-oidc-forward-host) |
| Source record ids | luarocks_root_manifest-317fc88f14010f |
...
For a systems engineer, kong-oidc-forward-host belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-317fc88f14010f` from `luarocks_root_manifest` as `registry_expansion`
