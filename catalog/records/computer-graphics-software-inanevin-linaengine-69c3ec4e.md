...
<!-- canonical: https://github.com/inanevin/LinaEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/inanevin/LinaEngine](https://github.com/inanevin/LinaEngine) |
| Source record ids | github_search_computer_graphics_software-71bce5d23fac5b |

## System Engineer Summary

Lina Engine is an open-source , modular, tiny and fast C++ game engine, aimed to develop 3D desktop
games.

## Operational Role

For a systems engineer, inanevin/LinaEngine belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-71bce5d23fac5b` from `github_search_computer_graphics_software` as `registry_expansion`
