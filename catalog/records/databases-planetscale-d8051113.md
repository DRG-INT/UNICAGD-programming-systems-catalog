...
<!-- canonical: https://planetscale.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://planetscale.com/](https://planetscale.com/) |
| Source record ids | curated_database_systems-329e8b41b8c899 |

## System Engineer Summary

Managed Vitess/MySQL-compatible database platform.

## Operational Role

For a systems engineer, PlanetScale belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-329e8b41b8c899` from `curated_database_systems` as `registry_expansion`
