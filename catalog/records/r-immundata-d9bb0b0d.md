...
<!-- canonical: https://cran.r-project.org/web/packages/immundata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/immundata/index.html](https://cran.r-project.org/web/packages/immundata/index.html) |
| Source record ids | cran_packages_by_date-7e75b949c0b5c6 |
...
For a systems engineer, immundata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-26 10:00:02 UTC | [https://cran.r-project.org/web/packages/immundata/DESCRIPTION](https://cran.r-project.org/web/packages/immundata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/immundata/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7e75b949c0b5c6` from `cran_packages_by_date` as `registry_expansion`
