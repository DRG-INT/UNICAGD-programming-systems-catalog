...
<!-- canonical: https://pub.dev/packages/flutter_keychain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_keychain](https://pub.dev/packages/flutter_keychain) |
| Source record ids | pub_dev-2a48b6f56e25ac |

## System Engineer Summary

Flutter secure storage via Keychain (iOS) and Keystore (Android). Supports optional iOS access
groups and item labels.

## Operational Role

For a systems engineer, flutter_keychain belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-03-30T12:03:12.684383Z | [https://pub.dev/api/packages/flutter_keychain](https://pub.dev/api/packages/flutter_keychain) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_keychain` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-2a48b6f56e25ac` from `pub_dev` as `registry_expansion`
