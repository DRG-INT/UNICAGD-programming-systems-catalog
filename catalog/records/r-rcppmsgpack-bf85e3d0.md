...
<!-- canonical: https://cran.r-project.org/web/packages/RcppMsgPack/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppMsgPack/index.html](https://cran.r-project.org/web/packages/RcppMsgPack/index.html) |
| Source record ids | cran_packages_by_date-78946cb4346a9b |
...
For a systems engineer, RcppMsgPack belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-19 16:10:09 UTC | [https://cran.r-project.org/web/packages/RcppMsgPack/DESCRIPTION](https://cran.r-project.org/web/packages/RcppMsgPack/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppMsgPack/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-78946cb4346a9b` from `cran_packages_by_date` as `registry_expansion`
