...
<!-- canonical: https://github.com/nlbucki/RapidQuadcopterCollisionDetection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nlbucki/RapidQuadcopterCollisionDetection](https://github.com/nlbucki/RapidQuadcopterCollisionDetection) |
| Source record ids | github_search_physics_engines-a24989c646debc |

## System Engineer Summary

nlbucki/RapidQuadcopterCollisionDetection is tracked as an api abi checker record in the Physics
Engines branch. The source did not provide a long description, so this page keeps the identity,
release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, nlbucki/RapidQuadcopterCollisionDetection belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-21T00:21:57Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a24989c646debc` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AlexanderFabisch/distance3d | Api Abi Checker | [open](physics-engines-alexanderfabisch-distance3d-7af4cbf7.md) |
