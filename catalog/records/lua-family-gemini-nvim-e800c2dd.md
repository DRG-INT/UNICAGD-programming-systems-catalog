...
| Canonical URL | [https://luarocks.org/modules/prime-run/gemini.nvim](https://luarocks.org/modules/prime-run/gemini.nvim) |
| Source record ids | luarocks_root_manifest-191512513ef296 |

## System Engineer Summary

gemini.nvim is tracked as an ide editor integration record in the Lua family branch. The source did
...
For a systems engineer, gemini.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-191512513ef296` from `luarocks_root_manifest` as `registry_expansion`
