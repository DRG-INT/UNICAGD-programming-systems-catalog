...
<!-- canonical: https://cran.r-project.org/web/packages/apsimeval/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/apsimeval/index.html](https://cran.r-project.org/web/packages/apsimeval/index.html) |
| Source record ids | cran_packages_by_date-8e8c4def033d6b |

## System Engineer Summary

Evaluation, Visualisation and Sensitivity Analysis of 'APSIM' Classic Output

## Operational Role

For a systems engineer, apsimeval belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 14:10:24 UTC | [https://cran.r-project.org/web/packages/apsimeval/DESCRIPTION](https://cran.r-project.org/web/packages/apsimeval/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/apsimeval/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-8e8c4def033d6b` from `cran_packages_by_date` as `registry_expansion`
