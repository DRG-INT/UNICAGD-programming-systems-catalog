...
<!-- canonical: https://luarocks.org/modules/geoffleyland/csv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/geoffleyland/csv](https://luarocks.org/modules/geoffleyland/csv) |
| Source record ids | luarocks_root_manifest-428cd575b91b49 |
...
For a systems engineer, csv belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-428cd575b91b49` from `luarocks_root_manifest` as `registry_expansion`
