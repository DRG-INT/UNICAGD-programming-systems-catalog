...
<!-- canonical: https://hackage.haskell.org/package/keiro-pgmq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keiro-pgmq](https://hackage.haskell.org/package/keiro-pgmq) |
| Source record ids | hackage_recent-31ecc5494c6ada |
...
For a systems engineer, keiro-pgmq belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0.0 | 2026-09-08T05:17:14Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-31ecc5494c6ada` from `hackage_recent` as `registry_expansion`
