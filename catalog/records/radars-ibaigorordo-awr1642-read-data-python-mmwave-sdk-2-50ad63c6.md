...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ibaiGorordo/AWR1642-Read-Data-Python-MMWAVE-SDK-2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ibaiGorordo/AWR1642-Read-Data-Python-MMWAVE-SDK-2](https://github.com/ibaiGorordo/AWR1642-Read-Data-Python-MMWAVE-SDK-2) |
| Source record ids | github_search_radars-15e52105d61f69 |

## System Engineer Summary

Python program to read and plot the data in real time from the AWR1642 and IWR1642 mmWave radar
boards (Texas Instruments).

## Operational Role

For a systems engineer, ibaiGorordo/AWR1642-Read-Data-Python-MMWAVE-SDK-2 belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-18T13:36:40Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:radar stars:>20", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_radars-15e52105d61f69` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 30hours/blah2 | Datetime | [open](radars-30hours-blah2-4acda32e.md) |
| ibaiGorordo/AWR1843-Read-Data-Python-MMWAVE-SDK-3- | Datetime | [open](radars-ibaigorordo-awr1843-read-data-python-mmwave-sdk-3-62fb498c.md) |
| insarlab/MintPy | Datetime | [open](radars-insarlab-mintpy-762351b7.md) |
| isce-framework/sweets | Datetime | [open](radars-isce-framework-sweets-db6cf485.md) |
| Unsigned-Long/iKalibr | Datetime | [open](radars-unsigned-long-ikalibr-cc58fd6a.md) |
| Unsigned-Long/River | Datetime | [open](radars-unsigned-long-river-2a595389.md) |
| wangxiao5791509/MultiModal_BigModels_Survey | Datetime | [open](radars-wangxiao5791509-multimodal-bigmodels-survey-409b52f5.md) |
