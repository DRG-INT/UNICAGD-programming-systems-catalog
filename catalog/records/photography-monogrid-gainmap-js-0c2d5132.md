...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/MONOGRID/gainmap-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MONOGRID/gainmap-js](https://github.com/MONOGRID/gainmap-js) |
| Source record ids | github_search_photography-485e9449ee3561 |

## System Engineer Summary

A Javascript (TypeScript) Port of Adobe Gainmap Technology for storing HDR Images using an SDR Image
+ a gainmap

## Operational Role

For a systems engineer, MONOGRID/gainmap-js belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-06T18:23:45Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-485e9449ee3561` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Afilmory/afilmory | Type Checker | [open](photography-afilmory-afilmory-565a9d79.md) |
| iammatthias/com | Type Checker | [open](photography-iammatthias-com-ce0fc9aa.md) |
| markusthiel/lumio | Type Checker | [open](photography-markusthiel-lumio-24d2fd8b.md) |
| meetqy/rao-pics | Type Checker | [open](photography-meetqy-rao-pics-009a75b3.md) |
| PicPeak/picpeak | Type Checker | [open](photography-picpeak-picpeak-189749c9.md) |
| SuboptimalEng/orbital | Type Checker | [open](photography-suboptimaleng-orbital-a7a00a6b.md) |
