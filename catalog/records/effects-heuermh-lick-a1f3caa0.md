...
| Source record ids | github_search_effects-1c86812211c347 |

## System Engineer Summary

heuermh/lick is tracked as an image audio dsp record in the Effects branch. The source did not
...
For a systems engineer, heuermh/lick belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-05T18:33:36Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-1c86812211c347` from `github_search_effects` as `registry_expansion`
