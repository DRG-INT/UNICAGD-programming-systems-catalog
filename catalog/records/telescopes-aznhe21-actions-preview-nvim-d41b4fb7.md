...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aznhe21/actions-preview.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aznhe21/actions-preview.nvim](https://github.com/aznhe21/actions-preview.nvim) |
| Source record ids | github_search_telescopes-208449bbb01f6c |
...
For a systems engineer, aznhe21/actions-preview.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-22T17:18:08Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-208449bbb01f6c` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adoyle-h/lsp-toggle.nvim | Language Server | [open](telescopes-adoyle-h-lsp-toggle-nvim-8d7889c6.md) |
