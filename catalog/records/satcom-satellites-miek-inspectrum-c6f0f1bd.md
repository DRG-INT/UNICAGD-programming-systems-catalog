...
<!-- canonical: https://github.com/miek/inspectrum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/miek/inspectrum](https://github.com/miek/inspectrum) |
| Source record ids | github_search_satcom_satellites-324ab64b7b2625 |

## System Engineer Summary

miek/inspectrum is tracked as an image audio dsp record in the SatCom Satellites branch. The source
...
For a systems engineer, miek/inspectrum belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-06T15:44:29Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_satcom_satellites-324ab64b7b2625` from `github_search_satcom_satellites` as `registry_expansion`
