...
<!-- canonical: https://pypi.org/project/acquisition-statute-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acquisition-statute-parser/](https://pypi.org/project/acquisition-statute-parser/) |
| Source record ids | pypi_simple-6979cb3cad059e |
...
For a systems engineer, acquisition-statute-parser belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2022-05-14T17:08:39.804033Z | [https://pypi.org/pypi/acquisition-statute-parser/json](https://pypi.org/pypi/acquisition-statute-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acquisition-statute-parser/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-6979cb3cad059e` from `pypi_simple` as `registry_expansion`
