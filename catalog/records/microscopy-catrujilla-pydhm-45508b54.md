...
<!-- canonical: https://github.com/catrujilla/pyDHM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/catrujilla/pyDHM](https://github.com/catrujilla/pyDHM) |
| Source record ids | github_search_microscopy-c27f5585645cd2 |

## System Engineer Summary

A Python library to numerically recover the complex wavefield information of samples from Digital
Holographic Microscopy (DHM) recordings. Phase compensation, phase-shifting methods, and numerical
propagators for different configurations and types of recordings in DHM are provided.

## Operational Role

For a systems engineer, catrujilla/pyDHM belongs in the Microscopy inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-16T21:49:38Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-c27f5585645cd2` from `github_search_microscopy` as `registry_expansion`
