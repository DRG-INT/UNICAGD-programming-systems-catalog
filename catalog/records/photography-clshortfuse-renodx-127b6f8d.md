...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/clshortfuse/renodx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/clshortfuse/renodx](https://github.com/clshortfuse/renodx) |
| Source record ids | github_search_photography-0d685c6b1bd426 |
...
For a systems engineer, clshortfuse/renodx belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T01:42:15Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:hdr stars:>20", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_photography-0d685c6b1bd426` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CleasbyCode/jdvrif | Game Engine Game Dev | [open](photography-cleasbycode-jdvrif-e7dd7897.md) |
| Ershany/Arcane-Engine | Game Engine Game Dev | [open](photography-ershany-arcane-engine-77807fd7.md) |
| HerrZatacke/2bit-pxlr-studio | Game Engine Game Dev | [open](photography-herrzatacke-2bit-pxlr-studio-c3ca0627.md) |
| xavier150/Blender-For-UnrealEngine-Addons | Game Engine Game Dev | [open](photography-xavier150-blender-for-unrealengine-addons-cb8cc817.md) |
