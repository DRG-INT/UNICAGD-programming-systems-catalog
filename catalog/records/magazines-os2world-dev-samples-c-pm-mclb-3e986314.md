# OS2World/DEV-SAMPLES-C-PM-mclb
...
<!-- canonical: https://github.com/OS2World/DEV-SAMPLES-C-PM-mclb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OS2World/DEV-SAMPLES-C-PM-mclb](https://github.com/OS2World/DEV-SAMPLES-C-PM-mclb) |
| Source record ids | github_search_magazines-0b5735dff97671 |

## System Engineer Summary

MultiColumn ListBox custom PM control as described in OS/2 Developer magazine (Nov/Dec 1995). This
toolkit includes complete source code, online programming reference, and working sample programs.

## Operational Role

For a systems engineer, OS2World/DEV-SAMPLES-C-PM-mclb belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-12T19:19:58Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-0b5735dff97671` from `github_search_magazines` as `registry_expansion`
