...
<!-- canonical: https://hackage.haskell.org/package/lens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/lens](https://hackage.haskell.org/package/lens) |
| Source record ids | hackage_top_downloads-f0c9b3a4a8f882 |

## System Engineer Summary

Hackage package with 533 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, lens belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.6 | 2026-01-10T22:05:13Z | [https://hackage.haskell.org/package/lens](https://hackage.haskell.org/package/lens) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/lens` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-f0c9b3a4a8f882` from `hackage_top_downloads` as `registry_expansion`
