...
<!-- canonical: https://cran.r-project.org/web/packages/pbapply/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pbapply/index.html](https://cran.r-project.org/web/packages/pbapply/index.html) |
| Source record ids | cran_packages_by_date-51e32bd744a471 |
...
For a systems engineer, pbapply belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7-5 | 2026-09-01 08:20:12 UTC | [https://cran.r-project.org/web/packages/pbapply/DESCRIPTION](https://cran.r-project.org/web/packages/pbapply/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pbapply/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-51e32bd744a471` from `cran_packages_by_date` as `registry_expansion`
