...
<!-- canonical: https://pub.dev/packages/blurrycontainer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/blurrycontainer](https://pub.dev/packages/blurrycontainer) |
| Source record ids | pub_dev-f7a0d1f88cb3bb |
...
For a systems engineer, blurrycontainer belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2024-05-04T08:54:00.377771Z | [https://pub.dev/api/packages/blurrycontainer](https://pub.dev/api/packages/blurrycontainer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/blurrycontainer` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-f7a0d1f88cb3bb` from `pub_dev` as `registry_expansion`
