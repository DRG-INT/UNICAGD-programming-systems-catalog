...
| Canonical URL | [https://crates.io/crates/sha3-asm](https://crates.io/crates/sha3-asm) |
| Source record ids | crates_io-723bb116611242 |
...
For a systems engineer, sha3-asm belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-06-10T12:27:17.250355Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-723bb116611242` from `crates_io` as `registry_expansion`
