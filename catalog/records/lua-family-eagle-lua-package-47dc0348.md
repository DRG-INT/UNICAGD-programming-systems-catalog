...
<!-- canonical: https://luarocks.org/modules/eagleyinfz/eagle-lua-package -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/eagleyinfz/eagle-lua-package](https://luarocks.org/modules/eagleyinfz/eagle-lua-package) |
| Source record ids | luarocks_root_manifest-2f0c3ef1947ff8 |

## System Engineer Summary

A test lua package with luarocks

## Operational Role

For a systems engineer, eagle-lua-package belongs in the Lua family inventory as part of dependency
...
- `luarocks_root_manifest-2f0c3ef1947ff8` from `luarocks_root_manifest` as `registry_expansion`
