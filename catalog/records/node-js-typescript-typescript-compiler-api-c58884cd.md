...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/TypeScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-typescript.md) · [Category: Codegen Codemod Refactoring](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/codegen-codemod-refactoring.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-7859a419cf7060 |

## System Engineer Summary

TypeScript Compiler API is tracked as a codegen codemod refactoring record in the Node.js/TypeScript
...
For a systems engineer, TypeScript Compiler API belongs in the Node.js/TypeScript inventory as part
...
- `corpus-7859a419cf7060` from `master_json` as `codegen_codemod_refactoring`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| tsquery | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-tsquery-ca33bcc1.md) |
