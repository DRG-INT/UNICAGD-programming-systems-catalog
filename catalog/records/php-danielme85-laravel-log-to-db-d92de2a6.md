...
| Canonical URL | [https://packagist.org/packages/danielme85/laravel-log-to-db](https://packagist.org/packages/danielme85/laravel-log-to-db) |
| Source record ids | packagist_search-5be79e68b0545f |

## System Engineer Summary

Custom Laravel Log channel handler that can store log events to SQL or MongoDB databases. Uses
Laravel native logging functionality.

## Operational Role

For a systems engineer, danielme85/laravel-log-to-db belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.0.0 | 2026-07-28T00:28:08+00:00 | [https://repo.packagist.org/p2/danielme85/laravel-log-to-db.json](https://repo.packagist.org/p2/danielme85/laravel-log-to-db.json) |  |
| preview | known | v5.0.0-alpha | 2026-07-02T17:07:19+00:00 | [https://repo.packagist.org/p2/danielme85/laravel-log-to-db.json](https://repo.packagist.org/p2/danielme85/laravel-log-to-db.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/danielme85/laravel-log-to-db.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-5be79e68b0545f` from `packagist_search` as `registry_expansion`
