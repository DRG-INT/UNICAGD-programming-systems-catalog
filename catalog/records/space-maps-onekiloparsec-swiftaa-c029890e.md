...
<!-- canonical: https://github.com/onekiloparsec/SwiftAA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/onekiloparsec/SwiftAA](https://github.com/onekiloparsec/SwiftAA) |
| Source record ids | github_search_space_maps-8e7a03630fd553 |
...
For a systems engineer, onekiloparsec/SwiftAA belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-31T09:03:53Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8e7a03630fd553` from `github_search_space_maps` as `registry_expansion`
