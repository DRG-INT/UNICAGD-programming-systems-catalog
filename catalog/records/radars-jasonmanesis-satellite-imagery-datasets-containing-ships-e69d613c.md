...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jasonmanesis/Satellite-Imagery-Datasets-Containing-Ships -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jasonmanesis/Satellite-Imagery-Datasets-Containing-Ships](https://github.com/jasonmanesis/Satellite-Imagery-Datasets-Containing-Ships) |
| Source record ids | github_search_radars-d94b462683f0ed |

## System Engineer Summary

This repository provides a comprehensive list of radar and optical satellite datasets curated for
ship detection, classification, semantic segmentation, and instance segmentation tasks. These
datasets are ideal for applications in computer vision, machine learning, remote sensing, and
maritime analysis.

## Operational Role

For a systems engineer, jasonmanesis/Satellite-Imagery-Datasets-Containing-Ships belongs in the
Radars inventory as part of defect discovery, security review, undefined-state detection, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-18T15:15:58Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_radars-d94b462683f0ed` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ANDRVV/gapcast | Static Analyzer | [open](radars-andrvv-gapcast-2f99ac58.md) |
| bleutner/RStoolbox | Static Analyzer | [open](radars-bleutner-rstoolbox-b0dc8bbf.md) |
| chadi0x/TheBigBrother | Static Analyzer | [open](radars-chadi0x-thebigbrother-17499a23.md) |
| cryotools/osaris | Static Analyzer | [open](radars-cryotools-osaris-52c31f3c.md) |
| egagli/sar_snowmelt_timing | Static Analyzer | [open](radars-egagli-sar-snowmelt-timing-61862ecf.md) |
| gee-community/geemap | Static Analyzer | [open](radars-gee-community-geemap-83890093.md) |
| GeoRetina/chat2geo | Static Analyzer | [open](radars-georetina-chat2geo-606c922b.md) |
| GeoscienceAustralia/dea-notebooks | Static Analyzer | [open](radars-geoscienceaustralia-dea-notebooks-86a9662a.md) |
