...
| Canonical URL | [https://crates.io/crates/scale-info](https://crates.io/crates/scale-info) |
| Source record ids | crates_io-63ca9cf99831f4 |
...
For a systems engineer, scale-info belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.6 | 2024-11-20T14:49:29.345447Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-63ca9cf99831f4` from `crates_io` as `registry_expansion`
