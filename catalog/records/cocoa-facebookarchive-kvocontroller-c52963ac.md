...
<!-- canonical: https://github.com/facebookarchive/KVOController -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/facebookarchive/KVOController](https://github.com/facebookarchive/KVOController) |
| Source record ids | github_search_cocoa-dfc783fe6dfe22 |
...
For a systems engineer, facebookarchive/KVOController belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-01-25T04:18:28Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-dfc783fe6dfe22` from `github_search_cocoa` as `registry_expansion`
