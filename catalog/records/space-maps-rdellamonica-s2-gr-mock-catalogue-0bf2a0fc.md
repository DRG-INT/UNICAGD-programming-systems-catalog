# rdellamonica/S2-gr-mock-catalogue
...
<!-- canonical: https://github.com/rdellamonica/S2-gr-mock-catalogue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rdellamonica/S2-gr-mock-catalogue](https://github.com/rdellamonica/S2-gr-mock-catalogue) |
| Source record ids | github_search_space_maps-bd9f3f314ff5f1 |

## System Engineer Summary

A mock catalogue for the S2 star in the Galactic Centre, considering a relativistic orbital model in
a Schwarzschild spacetime, of simulated astrometric positions and radial velocity measurements as
could be potentially measured by the GRAVITY instrument at VLT in the following years.

## Operational Role

For a systems engineer, rdellamonica/S2-gr-mock-catalogue belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-30T08:27:15Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bd9f3f314ff5f1` from `github_search_space_maps` as `registry_expansion`
