...
<!-- canonical: https://pub.dev/packages/flutter_flavorizr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_flavorizr](https://pub.dev/packages/flutter_flavorizr) |
| Source record ids | pub_dev-e0feeea07825bf |
...
For a systems engineer, flutter_flavorizr belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.0 | 2026-07-15T17:54:58.886322Z | [https://pub.dev/api/packages/flutter_flavorizr](https://pub.dev/api/packages/flutter_flavorizr) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_flavorizr` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-e0feeea07825bf` from `pub_dev` as `registry_expansion`
