...
<!-- canonical: https://github.com/geocoder-php/GeocoderLaravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geocoder-php/GeocoderLaravel](https://github.com/geocoder-php/GeocoderLaravel) |
| Source record ids | github_search_maps-70194cc55a1b06 |
...
For a systems engineer, geocoder-php/GeocoderLaravel belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.2.2 | 2026-06-23T19:37:03Z | [https://api.github.com/repos/geocoder-php/GeocoderLaravel/releases/latest](https://api.github.com/repos/geocoder-php/GeocoderLaravel/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/geocoder-php/GeocoderLaravel/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-70194cc55a1b06` from `github_search_maps` as `registry_expansion`
