...
<!-- canonical: https://pub.dev/packages/jwt_decoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/jwt_decoder](https://pub.dev/packages/jwt_decoder) |
| Source record ids | pub_dev-58cb9834626cad |
...
For a systems engineer, jwt_decoder belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2021-03-26T20:34:30.505536Z | [https://pub.dev/api/packages/jwt_decoder](https://pub.dev/api/packages/jwt_decoder) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/jwt_decoder` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-58cb9834626cad` from `pub_dev` as `registry_expansion`
