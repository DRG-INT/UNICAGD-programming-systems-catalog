...
| Canonical URL | [https://crates.io/crates/objc2-core-location](https://crates.io/crates/objc2-core-location) |
| Source record ids | crates_io-89c7871e3d22d0 |
...
For a systems engineer, objc2-core-location belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T15:48:12.323758Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-89c7871e3d22d0` from `crates_io` as `registry_expansion`
