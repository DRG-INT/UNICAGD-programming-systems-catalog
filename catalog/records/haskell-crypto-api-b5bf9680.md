...
<!-- canonical: https://hackage.haskell.org/package/crypto-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/crypto-api](https://hackage.haskell.org/package/crypto-api) |
| Source record ids | hackage_top_downloads-24bccfd9d0bb16 |
...
For a systems engineer, crypto-api belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.3 | 2018-01-05T00:16:18Z | [https://hackage.haskell.org/package/crypto-api](https://hackage.haskell.org/package/crypto-api) |  |
| candidate | partial | 0.13.3 |  | [https://hackage.haskell.org/package/crypto-api](https://hackage.haskell.org/package/crypto-api) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/crypto-api` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-24bccfd9d0bb16` from `hackage_top_downloads` as `registry_expansion`
