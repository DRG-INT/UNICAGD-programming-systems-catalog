...
<!-- canonical: https://crates.io/crates/slab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/slab](https://crates.io/crates/slab) |
| Source record ids | crates_io-86a706e2c29a4e |
...
For a systems engineer, slab belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.12 | 2026-01-31T12:59:22.609198Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-86a706e2c29a4e` from `crates_io` as `registry_expansion`
