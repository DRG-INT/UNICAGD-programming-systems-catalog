...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-64470de69cac81 |

## System Engineer Summary

ETL is tracked as a library record in the C++23 branch. The source did not provide a long
...
For a systems engineer, ETL belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-64470de69cac81` from `master_json` as `library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Abseil | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-abseil-f685c4df.md) |
| Boost | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-boost-f7e23625.md) |
| expected-lite | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-expected-lite-97a4343e.md) |
| fmt | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-fmt-6e85ab1c.md) |
| Folly | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-folly-1d787d1f.md) |
| Outcome | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-outcome-55e93257.md) |
| range-v3 | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-range-v3-1f7734dd.md) |
| span-lite | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-span-lite-aaa43173.md) |
