# Gitea: yueyue5201314/jadx

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/yueyue5201314/jadx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/yueyue5201314/jadx](https://gitea.com/yueyue5201314/jadx) |
| Source record ids | gitea_repositories_api-0f3b27c03ab491 |

## System Engineer Summary

Gitea: yueyue5201314/jadx is tracked as a compiler record in the Repository Workplaces branch. The
...
For a systems engineer, Gitea: yueyue5201314/jadx belongs in the Repository Workplaces inventory as
part of compiler selection, diagnostics behavior, target support, ABI expectations, and build
reproducibility.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-29T18:14:09Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-02 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "compiler", "retrieved": "2026-09-02", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-0f3b27c03ab491` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| arm-hpc/training/arm-sve-tools | Compiler | [open](repository-workplaces-arm-hpc-training-arm-sve-tools-21f1b9fd.md) |
| BonsaiDen/gbc-rs | Compiler | [open](repository-workplaces-bonsaiden-gbc-rs-0bcbf02a.md) |
| BuildGrid/recc | Compiler | [open](repository-workplaces-buildgrid-recc-21c7a89e.md) |
| cznic/cc | Compiler | [open](repository-workplaces-cznic-cc-89e992e6.md) |
| dfffffff/gcc6809 | Compiler | [open](repository-workplaces-dfffffff-gcc6809-15bef404.md) |
| freepascal.org/fpc/source | Compiler | [open](repository-workplaces-freepascal-org-fpc-source-0fc2714e.md) |
| Gitea: 6lin/sbcl | Compiler | [open](repository-workplaces-gitea-6lin-sbcl-f57192a2.md) |
| Gitea: catdog100/zlcompiler | Compiler | [open](repository-workplaces-gitea-catdog100-zlcompiler-cde7bc6e.md) |
