...
| Canonical URL | [https://crates.io/crates/gix-credentials](https://crates.io/crates/gix-credentials) |
| Source record ids | crates_io-bd16831fbc0b14 |
...
For a systems engineer, gix-credentials belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.40.0 | 2026-08-22T19:04:06.565643Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-bd16831fbc0b14` from `crates_io` as `registry_expansion`
