...
| Canonical URL | [https://crates.io/crates/mach](https://crates.io/crates/mach) |
| Source record ids | crates_io-660cee82ccae07 |
...
For a systems engineer, mach belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2019-06-01T11:04:57.829203Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-660cee82ccae07` from `crates_io` as `registry_expansion`
