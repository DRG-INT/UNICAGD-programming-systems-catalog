...
| Canonical URL | [https://crates.io/crates/serde_yaml](https://crates.io/crates/serde_yaml) |
| Source record ids | corpus-1cf6040bddeef6 |
...
For a systems engineer, serde_yaml belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.34+deprecated | 2024-03-25T00:50:19.759577Z | [https://crates.io/api/v1/crates/serde_yaml](https://crates.io/api/v1/crates/serde_yaml) |  |
| preview | known | 0.6.0-rc1 | 2017-01-28T23:43:57.544424Z | [https://crates.io/api/v1/crates/serde_yaml](https://crates.io/api/v1/crates/serde_yaml) |  |

## Engineering Notes

- Treat category as `serialization` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/serde_yaml` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-1cf6040bddeef6` from `master_json` as `serialization`
