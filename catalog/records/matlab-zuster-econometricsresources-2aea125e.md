...
<!-- canonical: https://github.com/zuster/EconometricsResources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zuster/EconometricsResources](https://github.com/zuster/EconometricsResources) |
| Source record ids | github_search_matlab-36c5b4da62a2e5 |

## System Engineer Summary

zuster/EconometricsResources is tracked as a language specification record in the Matlab branch. The
...
For a systems engineer, zuster/EconometricsResources belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-19T07:29:19Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-36c5b4da62a2e5` from `github_search_matlab` as `registry_expansion`
