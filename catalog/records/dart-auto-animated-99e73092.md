...
<!-- canonical: https://pub.dev/packages/auto_animated -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/auto_animated](https://pub.dev/packages/auto_animated) |
| Source record ids | pub_dev-061d290b477322 |

## System Engineer Summary

Widgets starting auto play animation when mounted. It is already possible to animate the list and
icons.

## Operational Role

For a systems engineer, auto_animated belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2023-06-30T15:10:33.138687Z | [https://pub.dev/api/packages/auto_animated](https://pub.dev/api/packages/auto_animated) |  |
| preview | known | 2.0.0-dev.4 | 2019-12-30T04:23:58.987245Z | [https://pub.dev/api/packages/auto_animated](https://pub.dev/api/packages/auto_animated) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/auto_animated` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-061d290b477322` from `pub_dev` as `registry_expansion`
