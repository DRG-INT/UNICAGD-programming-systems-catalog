...
<!-- canonical: https://pub.dev/packages/country_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/country_picker](https://pub.dev/packages/country_picker) |
| Source record ids | pub_dev-9d0d1dd6cedf19 |
...
For a systems engineer, country_picker belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.28 | 2026-06-10T21:15:07.876411Z | [https://pub.dev/api/packages/country_picker](https://pub.dev/api/packages/country_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/country_picker` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-9d0d1dd6cedf19` from `pub_dev` as `registry_expansion`
