...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Static Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/static-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/andremm/typedlua](https://github.com/andremm/typedlua) |
| Source record ids | lua-source-334, corpus-e71af3fddf3dc4 |
...
For a systems engineer, Typed Lua belongs in the Lua family inventory as part of defect discovery,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 334}}` |
...
- `lua-source-334` from `master_json` as `source_list_item`
- `corpus-e71af3fddf3dc4` from `master_json` as `static_analyzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| aitextwatermarkremover-tools | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aitextwatermarkremover-tools-cedeabf4.md) |
| Analysis Tools and ASTs | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-analysis-tools-and-asts-7d84a8fc.md) |
| digestif | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-digestif-514882f8.md) |
| dromozoa-shlex | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dromozoa-shlex-fd3eca87.md) |
| globals-lua | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-globals-lua-77b9e911.md) |
| lua-parser | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-parser-aaefaf05.md) |
| luacheck | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luacheck-55c5c338.md) |
| luacov | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luacov-2744a6ec.md) |
