...
<!-- canonical: https://hackage.haskell.org/package/hashed-storage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hashed-storage](https://hackage.haskell.org/package/hashed-storage) |
| Source record ids | hackage_top_downloads-3ea509026a71ca |
...
For a systems engineer, hashed-storage belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.11 | 2014-04-07T13:37:01Z | [https://hackage.haskell.org/package/hashed-storage](https://hackage.haskell.org/package/hashed-storage) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hashed-storage` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-3ea509026a71ca` from `hackage_top_downloads` as `registry_expansion`
...
| hashable | Cryptography | [open](haskell-hashable-034408b0.md) |
