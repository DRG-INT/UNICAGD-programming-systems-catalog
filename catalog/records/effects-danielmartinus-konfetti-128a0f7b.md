...
<!-- canonical: https://github.com/DanielMartinus/Konfetti -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DanielMartinus/Konfetti](https://github.com/DanielMartinus/Konfetti) |
| Source record ids | github_search_effects-50082a16bcabfa |
...
For a systems engineer, DanielMartinus/Konfetti belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.5 | 2024-11-28T08:39:33Z | [https://api.github.com/repos/DanielMartinus/Konfetti/releases/latest](https://api.github.com/repos/DanielMartinus/Konfetti/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/DanielMartinus/Konfetti/releases/latest` at `2026-09-01T09:23:09+00:00`.
...
- `github_search_effects-50082a16bcabfa` from `github_search_effects` as `registry_expansion`
