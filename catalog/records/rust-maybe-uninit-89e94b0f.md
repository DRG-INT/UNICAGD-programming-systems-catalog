...
| Canonical URL | [https://crates.io/crates/maybe-uninit](https://crates.io/crates/maybe-uninit) |
| Source record ids | crates_io-8094e7bf7e64b9 |
...
For a systems engineer, maybe-uninit belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2019-07-10T13:41:31.043470Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-8094e7bf7e64b9` from `crates_io` as `registry_expansion`
