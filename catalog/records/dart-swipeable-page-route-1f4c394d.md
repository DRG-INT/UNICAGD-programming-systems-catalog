...
<!-- canonical: https://pub.dev/packages/swipeable_page_route -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/swipeable_page_route](https://pub.dev/packages/swipeable_page_route) |
| Source record ids | pub_dev-a6c1b02538d41c |
...
For a systems engineer, swipeable_page_route belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.8 | 2026-01-02T14:31:23.336312Z | [https://pub.dev/api/packages/swipeable_page_route](https://pub.dev/api/packages/swipeable_page_route) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/swipeable_page_route` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-a6c1b02538d41c` from `pub_dev` as `registry_expansion`
