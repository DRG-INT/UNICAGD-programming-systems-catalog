...
<!-- canonical: https://luarocks.org/modules/taylor/cycle-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/taylor/cycle-cache](https://luarocks.org/modules/taylor/cycle-cache) |
| Source record ids | luarocks_root_manifest-b2a20013074448 |

## System Engineer Summary

cycle-cache is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, cycle-cache belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b2a20013074448` from `luarocks_root_manifest` as `registry_expansion`
