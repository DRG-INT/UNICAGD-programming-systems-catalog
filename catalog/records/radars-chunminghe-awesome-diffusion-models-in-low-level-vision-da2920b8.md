...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ChunmingHe/awesome-diffusion-models-in-low-level-vision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChunmingHe/awesome-diffusion-models-in-low-level-vision](https://github.com/ChunmingHe/awesome-diffusion-models-in-low-level-vision) |
| Source record ids | github_search_radars-839c9f276937ed |
...
For a systems engineer, ChunmingHe/awesome-diffusion-models-in-low-level-vision belongs in the
Radars inventory as part of ecosystem capability mapping, dependency review, release awareness, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-23T18:03:03Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:remote-sensing stars:>50", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_radars-839c9f276937ed` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acgeospatial/awesome-earthobservation-code | Filesystem Os | [open](radars-acgeospatial-awesome-earthobservation-code-72dc0793.md) |
| ailab-hanyang/Radar4Motion | Filesystem Os | [open](radars-ailab-hanyang-radar4motion-9053c2a1.md) |
| birgander2/PyRAT | Filesystem Os | [open](radars-birgander2-pyrat-f127a5d8.md) |
| cggos/imu_x_fusion | Filesystem Os | [open](radars-cggos-imu-x-fusion-d563c757.md) |
| chathumal93/Pytorch-UNet-Flood-Segmentation | Filesystem Os | [open](radars-chathumal93-pytorch-unet-flood-segmentation-cfa3dbdf.md) |
| chrieke/awesome-geospatial-companies | Filesystem Os | [open](radars-chrieke-awesome-geospatial-companies-9663190b.md) |
| commaai/comma2k19 | Filesystem Os | [open](radars-commaai-comma2k19-b38ccfe9.md) |
| deepVector/geospatial-machine-learning | Filesystem Os | [open](radars-deepvector-geospatial-machine-learning-313d6171.md) |
