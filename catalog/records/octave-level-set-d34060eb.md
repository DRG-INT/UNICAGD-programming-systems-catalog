...
<!-- canonical: https://gnu-octave.github.io/packages/level-set -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/level-set](https://gnu-octave.github.io/packages/level-set) |
| Source record ids | octave_packages_index-e44cd6b825f139 |

## System Engineer Summary

Routines for calculating the time-evolution of the level-set equation and extracting geometric
information from the level-set function.

## Operational Role

For a systems engineer, level-set belongs in the Octave inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2015-12-17 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-e44cd6b825f139` from `octave_packages_index` as `registry_expansion`
