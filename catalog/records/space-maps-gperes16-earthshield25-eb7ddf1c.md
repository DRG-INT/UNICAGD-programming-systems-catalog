# gperes16/earthshield25

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gperes16/earthshield25 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gperes16/earthshield25](https://github.com/gperes16/earthshield25) |
| Source record ids | github_search_space_maps-231c0609fd7759 |

## System Engineer Summary

EarthShield25 — An interactive web app that lists NASA’s Near-Earth Objects (NEOs) and simulates
asteroid impacts on Earth. Built with NASA NeoWs API, Leaflet maps, and educational impact models,
it raises awareness of planetary defense and mitigation strategies.

## Operational Role

For a systems engineer, gperes16/earthshield25 belongs in the Space Maps inventory as part of input-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T21:34:38Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-231c0609fd7759` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ajmas/OpenPlanetMaps | Fuzzer | [open](space-maps-ajmas-openplanetmaps-067b3278.md) |
| Rishit-katiyar/LavaFlowSimulation | Fuzzer | [open](space-maps-rishit-katiyar-lavaflowsimulation-e57be53c.md) |
