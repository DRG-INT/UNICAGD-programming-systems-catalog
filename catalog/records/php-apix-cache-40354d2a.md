...
| Canonical URL | [https://packagist.org/packages/apix/cache](https://packagist.org/packages/apix/cache) |
| Source record ids | packagist_search-b2b205fb7ab5b3 |

## System Engineer Summary

A thin PSR-6 cache wrapper with a generic interface to various caching backends emphasising cache
taggging and indexing to Redis, Memcached, PDO/SQL, APC and other adapters.

## Operational Role

For a systems engineer, apix/cache belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.5 | 2020-06-11T09:11:06+00:00 | [https://repo.packagist.org/p2/apix/cache.json](https://repo.packagist.org/p2/apix/cache.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/apix/cache.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-b2b205fb7ab5b3` from `packagist_search` as `registry_expansion`
