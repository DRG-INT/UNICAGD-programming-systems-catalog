...
<!-- canonical: https://pypi.org/project/adn-gocd-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adn-gocd-cli/](https://pypi.org/project/adn-gocd-cli/) |
| Source record ids | pypi_simple-a5df71601c7a2e |

## System Engineer Summary

adn-gocd-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, adn-gocd-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 99.9.9 | 2022-10-21T07:17:07.139004Z | [https://pypi.org/pypi/adn-gocd-cli/json](https://pypi.org/pypi/adn-gocd-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adn-gocd-cli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-a5df71601c7a2e` from `pypi_simple` as `registry_expansion`
