...
<!-- canonical: https://cran.r-project.org/web/packages/taxify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/taxify/index.html](https://cran.r-project.org/web/packages/taxify/index.html) |
| Source record ids | cran_packages_by_date-c158fa552a1ad8 |

## System Engineer Summary

Offline Taxonomic Name Matching Against Darwin Core Backbones

## Operational Role

For a systems engineer, taxify belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-02 07:10:02 UTC | [https://cran.r-project.org/web/packages/taxify/DESCRIPTION](https://cran.r-project.org/web/packages/taxify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/taxify/DESCRIPTION` at `2026-09-02T08:21:51+00:00`.
...
- `cran_packages_by_date-c158fa552a1ad8` from `cran_packages_by_date` as `registry_expansion`
