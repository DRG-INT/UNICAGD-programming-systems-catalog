...
<!-- canonical: https://crates.io/crates/spki -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/spki](https://crates.io/crates/spki) |
| Source record ids | crates_io-779cea6f381dd7 |

## System Engineer Summary

X.509 Subject Public Key Info (RFC5280) describing public keys as well as their associated
AlgorithmIdentifiers (i.e. OIDs)

## Operational Role

For a systems engineer, spki belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-04-04T14:18:52.799846Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-779cea6f381dd7` from `crates_io` as `registry_expansion`
