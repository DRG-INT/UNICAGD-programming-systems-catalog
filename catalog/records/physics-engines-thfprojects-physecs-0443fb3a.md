...
<!-- canonical: https://github.com/thfProjects/Physecs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thfProjects/Physecs](https://github.com/thfProjects/Physecs) |
| Source record ids | github_search_physics_engines-86a18046242bf4 |
...
For a systems engineer, thfProjects/Physecs belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T23:10:46Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-86a18046242bf4` from `github_search_physics_engines` as `registry_expansion`
