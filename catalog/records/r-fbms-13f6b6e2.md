...
<!-- canonical: https://cran.r-project.org/web/packages/FBMS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FBMS/index.html](https://cran.r-project.org/web/packages/FBMS/index.html) |
| Source record ids | cran_packages_by_date-e3fde6260e2b4d |
...
For a systems engineer, FBMS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4 | 2026-08-25 21:50:09 UTC | [https://cran.r-project.org/web/packages/FBMS/DESCRIPTION](https://cran.r-project.org/web/packages/FBMS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FBMS/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e3fde6260e2b4d` from `cran_packages_by_date` as `registry_expansion`
