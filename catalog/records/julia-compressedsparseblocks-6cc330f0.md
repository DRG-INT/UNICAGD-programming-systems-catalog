...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Compression](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compression.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CompressedSparseBlocks](https://github.com/JuliaRegistries/General/tree/master/C/CompressedSparseBlocks) |
| Source record ids | julia_general-4345550115ccba |

## System Engineer Summary

Julia package registered in General at C/CompressedSparseBlocks.

## Operational Role

For a systems engineer, CompressedSparseBlocks belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| aws_c_compression_jll | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-aws-c-compression-jll-1cf62d21.md) |
| brotli_jll | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-brotli-jll-34da05cb.md) |
| Bzip2_jll | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bzip2-jll-90d294ed.md) |
| CodecBzip2 | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-codecbzip2-555294d8.md) |
| CodecZstd | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-codeczstd-9c2e7664.md) |
| CompressedBeliefMDPs | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-compressedbeliefmdps-e03eb13f.md) |
| CompressedSensing | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-compressedsensing-4b1d44cd.md) |
| CompressiveLearning | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-compressivelearning-5cbe31d0.md) |
