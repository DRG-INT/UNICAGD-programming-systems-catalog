...
<!-- canonical: https://cran.r-project.org/web/packages/postvocs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/postvocs/index.html](https://cran.r-project.org/web/packages/postvocs/index.html) |
| Source record ids | cran_packages_by_date-3c8f0b746c69bb |

## System Engineer Summary

Post-Processing Tools for GC-MS Volatile Organic Compound Data

## Operational Role

For a systems engineer, postvocs belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-09-12 07:10:08 UTC | [https://cran.r-project.org/web/packages/postvocs/DESCRIPTION](https://cran.r-project.org/web/packages/postvocs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/postvocs/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-3c8f0b746c69bb` from `cran_packages_by_date` as `registry_expansion`
