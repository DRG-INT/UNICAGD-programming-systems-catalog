...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bitglue/gr-radioteletype -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bitglue/gr-radioteletype](https://github.com/bitglue/gr-radioteletype) |
| Source record ids | github_search_satcom_satellites-0bea788158578f |
...
For a systems engineer, bitglue/gr-radioteletype belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-23T13:48:33Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-0bea788158578f` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| open-sdr/openwifi-hw | Embedded Hardware | [open](satcom-satellites-open-sdr-openwifi-hw-b39d70cb.md) |
| pytroll/pyspectral | Embedded Hardware | [open](satcom-satellites-pytroll-pyspectral-93516e0f.md) |
