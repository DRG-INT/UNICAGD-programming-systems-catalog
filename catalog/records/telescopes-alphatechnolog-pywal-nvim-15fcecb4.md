...
<!-- canonical: https://github.com/AlphaTechnolog/pywal.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlphaTechnolog/pywal.nvim](https://github.com/AlphaTechnolog/pywal.nvim) |
| Source record ids | github_search_telescopes-09cb2dac645b7f |

## System Engineer Summary

pywal.nvim is a reimplementation of pywal.vim to support a few lua plugins like nvim-tree,
telescope, bufferline, etc

## Operational Role

For a systems engineer, AlphaTechnolog/pywal.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-03T20:32:20Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-09cb2dac645b7f` from `github_search_telescopes` as `registry_expansion`
