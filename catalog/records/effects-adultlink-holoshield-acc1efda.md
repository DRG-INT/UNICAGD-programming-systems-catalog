...
<!-- canonical: https://github.com/AdultLink/HoloShield -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AdultLink/HoloShield](https://github.com/AdultLink/HoloShield) |
| Source record ids | github_search_effects-571da79ef44aa1 |

## System Engineer Summary

Highly customizable sci-fi shield / force field shader for Unity3D. Allows you to set edge power &
color, inner texture scrolling, waviness, scale pulsation and procedural intensity noise. Implements
tessellation for low-poly base meshes.

## Operational Role

For a systems engineer, AdultLink/HoloShield belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-07T12:27:11Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-571da79ef44aa1` from `github_search_effects` as `registry_expansion`
