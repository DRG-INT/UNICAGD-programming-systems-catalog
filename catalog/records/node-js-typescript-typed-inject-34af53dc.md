...
[Catalog index](../index.md) · [Language: Node.js/TypeScript](../by-language/node-js-typescript.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/typed-inject -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/typed-inject](https://www.npmjs.com/package/typed-inject) |
| Source record ids | npm_registry-1191d63e29182f |
...
For a systems engineer, typed-inject belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2024-12-13T22:05:01.260Z | [https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-1191d63e29182f` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| detective-typescript | Dependency Manager | [open](node-js-typescript-detective-typescript-96cecc20.md) |
| typescript-retry-decorator | Dependency Manager | [open](node-js-typescript-typescript-retry-decorator-fa1e36aa.md) |
