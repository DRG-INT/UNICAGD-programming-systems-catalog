...
<!-- canonical: https://cran.r-project.org/web/packages/mitools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mitools/index.html](https://cran.r-project.org/web/packages/mitools/index.html) |
| Source record ids | cran_packages_by_date-130bcd609eaa5c |
...
For a systems engineer, mitools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7 | 2026-08-31 19:30:54 UTC | [https://cran.r-project.org/web/packages/mitools/DESCRIPTION](https://cran.r-project.org/web/packages/mitools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mitools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-130bcd609eaa5c` from `cran_packages_by_date` as `registry_expansion`
