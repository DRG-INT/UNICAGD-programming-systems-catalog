...
<!-- canonical: https://pub.dev/packages/time -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/time](https://pub.dev/packages/time) |
| Source record ids | pub_dev-e0f97b8f3e8808 |
...
For a systems engineer, time belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.6 | 2025-12-07T08:02:47.174095Z | [https://pub.dev/api/packages/time](https://pub.dev/api/packages/time) |  |
| preview | known | 1.5.0-nullsafety.1 | 2021-03-05T06:38:59.888203Z | [https://pub.dev/api/packages/time](https://pub.dev/api/packages/time) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/time` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-e0f97b8f3e8808` from `pub_dev` as `registry_expansion`
