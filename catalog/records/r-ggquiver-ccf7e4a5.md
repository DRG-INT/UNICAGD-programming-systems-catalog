...
<!-- canonical: https://cran.r-project.org/web/packages/ggquiver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggquiver/index.html](https://cran.r-project.org/web/packages/ggquiver/index.html) |
| Source record ids | cran_packages_by_date-a7b5cf5d7a4b73 |
...
For a systems engineer, ggquiver belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-20 14:10:22 UTC | [https://cran.r-project.org/web/packages/ggquiver/DESCRIPTION](https://cran.r-project.org/web/packages/ggquiver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggquiver/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a7b5cf5d7a4b73` from `cran_packages_by_date` as `registry_expansion`
