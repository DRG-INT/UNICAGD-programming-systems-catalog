...
<!-- canonical: https://cran.r-project.org/web/packages/usethis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/usethis/index.html](https://cran.r-project.org/web/packages/usethis/index.html) |
| Source record ids | cran_packages_by_date-d81b6ac2bec6f9 |
...
For a systems engineer, usethis belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2026-09-10 22:30:02 UTC | [https://cran.r-project.org/web/packages/usethis/DESCRIPTION](https://cran.r-project.org/web/packages/usethis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/usethis/DESCRIPTION` at `2026-09-11T00:27:28+00:00`.
...
- `cran_packages_by_date-d81b6ac2bec6f9` from `cran_packages_by_date` as `registry_expansion`
