...
<!-- canonical: https://github.com/ayalgenzer/Security-Camera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ayalgenzer/Security-Camera](https://github.com/ayalgenzer/Security-Camera) |
| Source record ids | github_search_electromagnetoscopes-6debd119b4816c |

## System Engineer Summary

Streaming live video from rasbperry pi camera to an Android app and controlling movement with servo
engines.

## Operational Role

For a systems engineer, ayalgenzer/Security-Camera belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-18T12:20:23Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6debd119b4816c` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| PentHertz/RF-Swift | Security Sast | [open](electromagnetoscopes-penthertz-rf-swift-91a223bf.md) |
