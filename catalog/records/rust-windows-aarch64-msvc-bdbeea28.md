...
<!-- canonical: https://crates.io/crates/windows_aarch64_msvc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows_aarch64_msvc](https://crates.io/crates/windows_aarch64_msvc) |
| Source record ids | crates_io-ca63d3e1a1ba2b |

## System Engineer Summary

windows_aarch64_msvc is tracked as a library record in the Rust branch. The source did not provide a
...
For a systems engineer, windows_aarch64_msvc belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.53.1 | 2025-10-06T17:33:33.380608Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-ca63d3e1a1ba2b` from `crates_io` as `registry_expansion`
