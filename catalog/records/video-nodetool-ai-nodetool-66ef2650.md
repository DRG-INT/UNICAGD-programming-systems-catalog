...
<!-- canonical: https://github.com/nodetool-ai/nodetool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nodetool-ai/nodetool](https://github.com/nodetool-ai/nodetool) |
| Source record ids | github_search_video-7adec4c82871d3 |

## System Engineer Summary

nodetool-ai/nodetool is tracked as an ide editor integration record in the Video branch. The source
...
For a systems engineer, nodetool-ai/nodetool belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:48:18Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-7adec4c82871d3` from `github_search_video` as `registry_expansion`
