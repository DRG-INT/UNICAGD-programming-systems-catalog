...
<!-- canonical: https://about.gitea.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://about.gitea.com/](https://about.gitea.com/) |
| Source record ids | curated_repository_workplace_routes-e98da0a6b64f16 |

## System Engineer Summary

Self-hostable Git forge with repositories, issues, pull requests, packages, actions, and federation-
oriented workflows.

## Operational Role

For a systems engineer, Gitea belongs in the Repository Workplaces inventory as part of ecosystem
...
- `curated_repository_workplace_routes-e98da0a6b64f16` from `curated_repository_workplace_routes` as `registry_expansion`
