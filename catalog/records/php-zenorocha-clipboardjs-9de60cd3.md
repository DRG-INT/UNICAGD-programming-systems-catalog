...
<!-- canonical: https://packagist.org/packages/zenorocha/clipboardjs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zenorocha/clipboardjs](https://packagist.org/packages/zenorocha/clipboardjs) |
| Source record ids | packagist_search-939d0e420aec22 |
...
For a systems engineer, zenorocha/clipboardjs belongs in the PHP inventory as part of service
...
- `packagist_search-939d0e420aec22` from `packagist_search` as `registry_expansion`
