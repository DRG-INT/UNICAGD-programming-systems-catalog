...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: APIs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/apis.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://aws.amazon.com/api-gateway/](https://aws.amazon.com/api-gateway/) |
| Source record ids | curated_language_routes-7ff42aa67a4023 |

## System Engineer Summary

Managed API gateway for REST, HTTP, WebSocket APIs, authorization, throttling, stages, and
serverless integrations.

## Operational Role

For a systems engineer, AWS API Gateway belongs in the APIs inventory as part of service
...
- `curated_language_routes-7ff42aa67a4023` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Apigee | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-apigee-bbdf4f09.md) |
| gRPC | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-grpc-e4f753fc.md) |
| Kong Gateway | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-kong-gateway-402bfd95.md) |
| Tyk Gateway | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-tyk-gateway-1f77c3a9.md) |
