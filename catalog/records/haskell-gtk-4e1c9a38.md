...
<!-- canonical: https://hackage.haskell.org/package/gtk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gtk](https://hackage.haskell.org/package/gtk) |
| Source record ids | hackage_top_downloads-7d517415040948 |
...
For a systems engineer, gtk belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.10 | 2025-03-20T08:47:33Z | [https://hackage.haskell.org/package/gtk](https://hackage.haskell.org/package/gtk) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gtk` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-7d517415040948` from `hackage_top_downloads` as `registry_expansion`
