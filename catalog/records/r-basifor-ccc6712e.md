...
<!-- canonical: https://cran.r-project.org/web/packages/basifoR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/basifoR/index.html](https://cran.r-project.org/web/packages/basifoR/index.html) |
| Source record ids | cran_packages_by_date-c41c78c84df9b1 |
...
For a systems engineer, basifoR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.9 | 2026-08-26 08:50:02 UTC | [https://cran.r-project.org/web/packages/basifoR/DESCRIPTION](https://cran.r-project.org/web/packages/basifoR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/basifoR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c41c78c84df9b1` from `cran_packages_by_date` as `registry_expansion`
