...
<!-- canonical: https://cran.r-project.org/web/packages/ggnext/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggnext/index.html](https://cran.r-project.org/web/packages/ggnext/index.html) |
| Source record ids | cran_packages_by_date-1fe9d3be14388a |
...
For a systems engineer, ggnext belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-26 18:40:02 UTC | [https://cran.r-project.org/web/packages/ggnext/DESCRIPTION](https://cran.r-project.org/web/packages/ggnext/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggnext/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1fe9d3be14388a` from `cran_packages_by_date` as `registry_expansion`
