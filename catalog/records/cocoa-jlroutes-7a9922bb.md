...
| Source record ids | awesome_list-e9fb164ab9c01f |
...
For a systems engineer, JLRoutes belongs in the Cocoa inventory as part of ecosystem capability
...
- Latest stable metadata was observed from `https://api.github.com/repos/joeldev/JLRoutes/releases/latest` at `2026-09-01T07:24:05+00:00`.
...
- `awesome_list-e9fb164ab9c01f` from `awesome_list` as `registry_expansion`
