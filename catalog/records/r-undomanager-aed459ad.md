...
<!-- canonical: https://cran.r-project.org/web/packages/undomanager/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/undomanager/index.html](https://cran.r-project.org/web/packages/undomanager/index.html) |
| Source record ids | cran_packages_by_date-4a2cd9fa186100 |

## System Engineer Summary

Manage the History of Any Object with Undo/Redo Operations

## Operational Role

For a systems engineer, undomanager belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 08:50:02 UTC | [https://cran.r-project.org/web/packages/undomanager/DESCRIPTION](https://cran.r-project.org/web/packages/undomanager/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/undomanager/DESCRIPTION` at `2026-09-12T10:18:41+00:00`.
...
- `cran_packages_by_date-4a2cd9fa186100` from `cran_packages_by_date` as `registry_expansion`
