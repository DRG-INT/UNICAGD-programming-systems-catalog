...
<!-- canonical: https://github.com/InteractiveComputerGraphics/TriangleMeshDistance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/InteractiveComputerGraphics/TriangleMeshDistance](https://github.com/InteractiveComputerGraphics/TriangleMeshDistance) |
| Source record ids | github_search_physics_engines-a881356edb479a |

## System Engineer Summary

Header only, single file, simple and efficient C++11 library to compute the signed distance function
(SDF) to a triangle mesh

## Operational Role

For a systems engineer, InteractiveComputerGraphics/TriangleMeshDistance belongs in the Physics
Engines inventory as part of cross-language integration, ABI ownership, memory safety, and runtime
embedding.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-14T17:36:17Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a881356edb479a` from `github_search_physics_engines` as `registry_expansion`
...
| elbywan/quadtree-lib | Ffi Bindings | [open](physics-engines-elbywan-quadtree-lib-23bee7fb.md) |
