...
<!-- canonical: https://cran.r-project.org/web/packages/colorrepel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/colorrepel/index.html](https://cran.r-project.org/web/packages/colorrepel/index.html) |
| Source record ids | cran_packages_by_date-b0088551ad228d |
...
For a systems engineer, colorrepel belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-08-22 05:30:02 UTC | [https://cran.r-project.org/web/packages/colorrepel/DESCRIPTION](https://cran.r-project.org/web/packages/colorrepel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/colorrepel/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b0088551ad228d` from `cran_packages_by_date` as `registry_expansion`
