...
<!-- canonical: https://github.com/facebookarchive/Shimmer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/facebookarchive/Shimmer](https://github.com/facebookarchive/Shimmer) |
| Source record ids | github_search_cocoa-5c7b6649951a1e |
...
For a systems engineer, facebookarchive/Shimmer belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-02-06T00:01:46Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-5c7b6649951a1e` from `github_search_cocoa` as `registry_expansion`
