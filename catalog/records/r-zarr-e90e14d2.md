...
<!-- canonical: https://cran.r-project.org/web/packages/zarr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/zarr/index.html](https://cran.r-project.org/web/packages/zarr/index.html) |
| Source record ids | cran_packages_by_date-5668c5e0922551 |
...
For a systems engineer, zarr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-30 05:10:02 UTC | [https://cran.r-project.org/web/packages/zarr/DESCRIPTION](https://cran.r-project.org/web/packages/zarr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/zarr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5668c5e0922551` from `cran_packages_by_date` as `registry_expansion`
