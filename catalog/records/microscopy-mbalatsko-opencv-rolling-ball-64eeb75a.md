...
<!-- canonical: https://github.com/mbalatsko/opencv-rolling-ball -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbalatsko/opencv-rolling-ball](https://github.com/mbalatsko/opencv-rolling-ball) |
| Source record ids | github_search_microscopy-9dfa5411f41088 |

## System Engineer Summary

Fully Ported to Python from ImageJ's Background Subtractor. Rolling ball and sliding paraboloid
background subtraction algorithms.

## Operational Role

For a systems engineer, mbalatsko/opencv-rolling-ball belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-21T21:15:02Z | gh search repos topic:imagej stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | SEE LICENSE IN LICENSE.md; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_microscopy-9dfa5411f41088` from `github_search_microscopy` as `registry_expansion`
