...
<!-- canonical: https://cran.r-project.org/web/packages/gpciIntCensor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpciIntCensor/index.html](https://cran.r-project.org/web/packages/gpciIntCensor/index.html) |
| Source record ids | cran_packages_by_date-7b3e382cc0eead |
...
For a systems engineer, gpciIntCensor belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 13:00:02 UTC | [https://cran.r-project.org/web/packages/gpciIntCensor/DESCRIPTION](https://cran.r-project.org/web/packages/gpciIntCensor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpciIntCensor/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7b3e382cc0eead` from `cran_packages_by_date` as `registry_expansion`
