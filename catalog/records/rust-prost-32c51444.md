...
<!-- canonical: https://crates.io/crates/prost -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/prost](https://crates.io/crates/prost) |
| Source record ids | crates_io-ddae15f7b0ca27 |
...
For a systems engineer, prost belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.4 | 2026-06-07T10:13:40.918481Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-ddae15f7b0ca27` from `crates_io` as `registry_expansion`
