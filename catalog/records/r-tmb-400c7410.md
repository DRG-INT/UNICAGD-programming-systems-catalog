...
<!-- canonical: https://cran.r-project.org/web/packages/TMB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TMB/index.html](https://cran.r-project.org/web/packages/TMB/index.html) |
| Source record ids | cran_packages_by_date-c05a775205c8e9 |
...
For a systems engineer, TMB belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.25 | 2026-08-22 09:50:02 UTC | [https://cran.r-project.org/web/packages/TMB/DESCRIPTION](https://cran.r-project.org/web/packages/TMB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TMB/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c05a775205c8e9` from `cran_packages_by_date` as `registry_expansion`
