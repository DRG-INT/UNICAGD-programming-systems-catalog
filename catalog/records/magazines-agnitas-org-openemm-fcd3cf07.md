...
<!-- canonical: https://github.com/agnitas-org/openemm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/agnitas-org/openemm](https://github.com/agnitas-org/openemm) |
| Source record ids | github_search_magazines-cac23be4f2a507 |

## System Engineer Summary

Web-based software for email automation and marketing (newsletters, multi-stage mail campaigns,
transaction mails, autoresponder, etc.)

## Operational Role

For a systems engineer, agnitas-org/openemm belongs in the Magazines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:48:04Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-cac23be4f2a507` from `github_search_magazines` as `registry_expansion`
