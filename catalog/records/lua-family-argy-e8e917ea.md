...
<!-- canonical: https://luarocks.org/modules/pogwat/argy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/pogwat/argy](https://luarocks.org/modules/pogwat/argy) |
| Source record ids | luarocks_root_manifest-7b273d28693aa2 |

## System Engineer Summary

argy is tracked as a parser lexer ast record in the Lua family branch. The source did not provide a
...
For a systems engineer, argy belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-7b273d28693aa2` from `luarocks_root_manifest` as `registry_expansion`
