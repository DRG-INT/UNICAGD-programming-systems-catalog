...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: "aim's"](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/aim-s.md) · [Category: Machine Learning](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/machine-learning.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) |
| Source record ids | curated_language_routes-e5ec4e2050e443 |

## System Engineer Summary

Machine-learning framework for training, serving, mobile, graph execution, and production model
pipelines.

## Operational Role

For a systems engineer, TensorFlow belongs in the "aim's" inventory as part of model pipelines,
...
- `curated_language_routes-e5ec4e2050e443` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Hugging Face Transformers | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-hugging-face-transformers-9b7d820e.md) |
| JAX | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-jax-160b4e37.md) |
| PyTorch | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-pytorch-ce083d68.md) |
