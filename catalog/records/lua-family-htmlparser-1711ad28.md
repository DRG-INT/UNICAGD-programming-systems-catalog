...
| Canonical URL | [https://luarocks.org/modules/mva/htmlparser](https://luarocks.org/modules/mva/htmlparser) |
| Source record ids | luarocks_root_manifest-f103217f5ae87c |
...
For a systems engineer, htmlparser belongs in the Lua family inventory as part of language tooling,
...
- `luarocks_root_manifest-f103217f5ae87c` from `luarocks_root_manifest` as `registry_expansion`
