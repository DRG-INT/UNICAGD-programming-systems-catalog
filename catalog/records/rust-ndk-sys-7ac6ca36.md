...
<!-- canonical: https://crates.io/crates/ndk-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ndk-sys](https://crates.io/crates/ndk-sys) |
| Source record ids | crates_io-cb7fbcdf2fd7c2 |
...
For a systems engineer, ndk-sys belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0+11769913 | 2024-04-26T15:14:59.325509Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-cb7fbcdf2fd7c2` from `crates_io` as `registry_expansion`
