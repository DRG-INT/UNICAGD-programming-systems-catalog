...
<!-- canonical: https://pub.dev/packages/path_provider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/path_provider](https://pub.dev/packages/path_provider) |
| Source record ids | pub_dev-92ef967ccebf13 |

## System Engineer Summary

Flutter plugin for getting commonly used locations on host platform file systems, such as the temp
and app data directories.

## Operational Role

For a systems engineer, path_provider belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.6 | 2026-06-15T13:51:07.158561Z | [https://pub.dev/api/packages/path_provider](https://pub.dev/api/packages/path_provider) |  |
| preview | known | 2.0.0-nullsafety.1 | 2021-02-16T17:17:35.922701Z | [https://pub.dev/api/packages/path_provider](https://pub.dev/api/packages/path_provider) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/path_provider` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-92ef967ccebf13` from `pub_dev` as `registry_expansion`
