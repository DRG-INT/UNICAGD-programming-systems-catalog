...
<!-- canonical: https://crates.io/crates/rawpointer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rawpointer](https://crates.io/crates/rawpointer) |
| Source record ids | crates_io-64ee59766d27fb |

## System Engineer Summary

Extra methods for raw pointers and `NonNull<T>`. For example `.post_inc()` and `.pre_dec()` (c.f.
`ptr++` and `--ptr`), `offset` and `add` for `NonNull<T>`, and the function `ptrdistance`.

## Operational Role

For a systems engineer, rawpointer belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2019-09-12T07:51:36.405018Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `crates_io-64ee59766d27fb` from `crates_io` as `registry_expansion`
