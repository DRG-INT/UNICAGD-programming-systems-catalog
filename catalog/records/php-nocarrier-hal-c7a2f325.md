...
<!-- canonical: https://packagist.org/packages/nocarrier/hal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/nocarrier/hal](https://packagist.org/packages/nocarrier/hal) |
| Source record ids | packagist_search-93b6e3db242e3d |
...
For a systems engineer, nocarrier/hal belongs in the PHP inventory as part of build graph control,
...
- `packagist_search-93b6e3db242e3d` from `packagist_search` as `registry_expansion`
