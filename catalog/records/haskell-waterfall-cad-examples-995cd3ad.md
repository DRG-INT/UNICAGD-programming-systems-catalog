...
<!-- canonical: https://hackage.haskell.org/package/waterfall-cad-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/waterfall-cad-examples](https://hackage.haskell.org/package/waterfall-cad-examples) |
| Source record ids | hackage_top_downloads-1d9ec9e5c2e107 |
...
For a systems engineer, waterfall-cad-examples belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3.2 | 2026-08-21T20:50:47Z | [https://hackage.haskell.org/package/waterfall-cad-examples](https://hackage.haskell.org/package/waterfall-cad-examples) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/waterfall-cad-examples` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-1d9ec9e5c2e107` from `hackage_top_downloads` as `registry_expansion`
