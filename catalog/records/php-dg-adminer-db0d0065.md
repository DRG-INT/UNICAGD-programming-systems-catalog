...
<!-- canonical: https://packagist.org/packages/dg/adminer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/dg/adminer](https://packagist.org/packages/dg/adminer) |
| Source record ids | packagist_search-9d79a7d85e2740 |
...
For a systems engineer, dg/adminer belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-9d79a7d85e2740` from `packagist_search` as `registry_expansion`
