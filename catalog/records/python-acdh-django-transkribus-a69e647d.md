...
<!-- canonical: https://pypi.org/project/acdh-django-transkribus/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-transkribus/](https://pypi.org/project/acdh-django-transkribus/) |
| Source record ids | pypi_simple-d287ba16978771 |
...
For a systems engineer, acdh-django-transkribus belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2020-03-20T08:58:46.006785Z | [https://pypi.org/pypi/acdh-django-transkribus/json](https://pypi.org/pypi/acdh-django-transkribus/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-transkribus/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-d287ba16978771` from `pypi_simple` as `registry_expansion`
