...
<!-- canonical: https://hackage.haskell.org/package/cipher-aes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cipher-aes](https://hackage.haskell.org/package/cipher-aes) |
| Source record ids | hackage_top_downloads-7657c96a4cd608 |
...
For a systems engineer, cipher-aes belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2015-06-21T12:13:54Z | [https://hackage.haskell.org/package/cipher-aes](https://hackage.haskell.org/package/cipher-aes) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cipher-aes` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-7657c96a4cd608` from `hackage_top_downloads` as `registry_expansion`
