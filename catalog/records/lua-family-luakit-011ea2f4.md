...
<!-- canonical: https://luakit.github.io/luakit/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luakit.github.io/luakit/](https://luakit.github.io/luakit/) |
| Source record ids | lua-source-345 |
...
For a systems engineer, luakit belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 345}}` |
...
- `lua-source-345` from `master_json` as `source_list_item`
