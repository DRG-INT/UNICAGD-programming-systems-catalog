...
<!-- canonical: https://cran.r-project.org/web/packages/LLMing/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LLMing/index.html](https://cran.r-project.org/web/packages/LLMing/index.html) |
| Source record ids | cran_packages_by_date-891a2ef4ed7f02 |
...
For a systems engineer, LLMing belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-27 02:30:02 UTC | [https://cran.r-project.org/web/packages/LLMing/DESCRIPTION](https://cran.r-project.org/web/packages/LLMing/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LLMing/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-891a2ef4ed7f02` from `cran_packages_by_date` as `registry_expansion`
