...
<!-- canonical: https://pub.dev/packages/slang -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/slang](https://pub.dev/packages/slang) |
| Source record ids | pub_dev-29dd7cadb3675a |

## System Engineer Summary

Localization / Internationalization (i18n) solution. Use JSON, YAML, CSV, or ARB files to create
typesafe translations via source generation.

## Operational Role

For a systems engineer, slang belongs in the Dart inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.19.0 | 2026-08-06T13:01:17.257108Z | [https://pub.dev/api/packages/slang](https://pub.dev/api/packages/slang) |  |
| preview | known | 4.0.0-dev.1 | 2024-10-21T01:19:26.399707Z | [https://pub.dev/api/packages/slang](https://pub.dev/api/packages/slang) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/slang` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-29dd7cadb3675a` from `pub_dev` as `registry_expansion`
