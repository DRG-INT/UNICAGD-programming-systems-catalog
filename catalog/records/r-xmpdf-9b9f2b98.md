...
<!-- canonical: https://cran.r-project.org/web/packages/xmpdf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xmpdf/index.html](https://cran.r-project.org/web/packages/xmpdf/index.html) |
| Source record ids | cran_packages_by_date-1924137cf8c2c3 |
...
For a systems engineer, xmpdf belongs in the R inventory as part of operator onboarding, API
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-25 23:20:02 UTC | [https://cran.r-project.org/web/packages/xmpdf/DESCRIPTION](https://cran.r-project.org/web/packages/xmpdf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xmpdf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1924137cf8c2c3` from `cran_packages_by_date` as `registry_expansion`
