...
<!-- canonical: https://cran.r-project.org/web/packages/sidrar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sidrar/index.html](https://cran.r-project.org/web/packages/sidrar/index.html) |
| Source record ids | cran_packages_by_date-a77e206513b45f |
...
For a systems engineer, sidrar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-26 02:20:03 UTC | [https://cran.r-project.org/web/packages/sidrar/DESCRIPTION](https://cran.r-project.org/web/packages/sidrar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sidrar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a77e206513b45f` from `cran_packages_by_date` as `registry_expansion`
