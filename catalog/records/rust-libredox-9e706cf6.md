...
<!-- canonical: https://crates.io/crates/libredox -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.23 | 2026-09-01T16:28:56.798096Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-01T16:40:55+00:00`.
...
- `crates_io-c10c2af3e67308` from `crates_io` as `registry_expansion`
