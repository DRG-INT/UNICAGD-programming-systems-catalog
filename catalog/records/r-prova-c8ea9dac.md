...
<!-- canonical: https://cran.r-project.org/web/packages/prova/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prova/index.html](https://cran.r-project.org/web/packages/prova/index.html) |
| Source record ids | cran_packages_by_date-294ce5cadff203 |
...
For a systems engineer, prova belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-20 23:10:02 UTC | [https://cran.r-project.org/web/packages/prova/DESCRIPTION](https://cran.r-project.org/web/packages/prova/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prova/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-294ce5cadff203` from `cran_packages_by_date` as `registry_expansion`
