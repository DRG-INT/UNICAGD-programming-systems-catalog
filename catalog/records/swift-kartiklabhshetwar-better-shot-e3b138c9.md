...
| Source record ids | github_search_swift-a5e178e70dd0b7 |

## System Engineer Summary

One app for the whole screen. Screenshots, screen recording, and a video editor, native on macOS.
Open-source CleanShot X + Loom alternative. No subscription, no account, no telemetry.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T20:57:24Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-a5e178e70dd0b7` from `github_search_swift` as `registry_expansion`
