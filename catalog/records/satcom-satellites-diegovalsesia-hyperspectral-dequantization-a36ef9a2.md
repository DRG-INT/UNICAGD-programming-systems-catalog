...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/diegovalsesia/hyperspectral-dequantization -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diegovalsesia/hyperspectral-dequantization](https://github.com/diegovalsesia/hyperspectral-dequantization) |
| Source record ids | github_search_satcom_satellites-c2143bc9b70316 |

## System Engineer Summary

Code from paper High-throughput Onboard Hyperspectral Image Compression with Ground-based CNN
Reconstruction

## Operational Role

For a systems engineer, diegovalsesia/hyperspectral-dequantization belongs in the SatCom Satellites
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-06T21:26:46Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:ccsds stars:>5", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_satcom_satellites-c2143bc9b70316` from `github_search_satcom_satellites` as `registry_expansion`
