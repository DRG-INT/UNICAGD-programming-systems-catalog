...
<!-- canonical: https://packagist.org/packages/udan11/sql-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/udan11/sql-parser](https://packagist.org/packages/udan11/sql-parser) |
| Source record ids | packagist_search-0dae441d06be83 |
...
For a systems engineer, udan11/sql-parser belongs in the PHP inventory as part of language tooling,
...
- `packagist_search-0dae441d06be83` from `packagist_search` as `registry_expansion`
