...
| Canonical URL | [https://crates.io/crates/quote-use-macros](https://crates.io/crates/quote-use-macros) |
| Source record ids | crates_io-81211a65377b5a |
...
For a systems engineer, quote-use-macros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2024-08-25T12:48:06.030177Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-81211a65377b5a` from `crates_io` as `registry_expansion`
