...
<!-- canonical: https://github.com/PrestaShop/prestashop-icon-font -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PrestaShop/prestashop-icon-font](https://github.com/PrestaShop/prestashop-icon-font) |
| Source record ids | github_search_icons_and_logos-35debc1c671a08 |

## System Engineer Summary

An open source icon pack made with love by the PrestaShop design team. You can use it everywhere to
make your designs and websites look awesome.

## Operational Role

For a systems engineer, PrestaShop/prestashop-icon-font belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-10-12T18:21:36Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-35debc1c671a08` from `github_search_icons_and_logos` as `registry_expansion`
