# Gitea: vallu/ascii_eng

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/vallu/ascii_eng -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/vallu/ascii_eng](https://gitea.com/vallu/ascii_eng) |
| Source record ids | gitea_repositories_api-43a36b4f5602bd |

## System Engineer Summary

ASCII game engine written in Python.

## Operational Role

For a systems engineer, Gitea: vallu/ascii_eng belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-30T19:15:48Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-02 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "ci", "retrieved": "2026-09-02", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-43a36b4f5602bd` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: kalkabena/ASCIIlery-game | Game Engine Game Dev | [open](repository-workplaces-gitea-kalkabena-asciilery-game-26745840.md) |
