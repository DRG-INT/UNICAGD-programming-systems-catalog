...
<!-- canonical: https://pub.dev/packages/pinput -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pinput](https://pub.dev/packages/pinput) |
| Source record ids | pub_dev-c98f47f47c13b5 |

## System Engineer Summary

Pin code input (OTP) text field, iOS SMS autofill, Android SMS autofill One Time Code, Password,
Passcode, Captcha, Security, Coupon, Wowcher, 2FA, Two step verification

## Operational Role

For a systems engineer, pinput belongs in the Dart inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.2 | 2026-02-04T17:39:50.329332Z | [https://pub.dev/api/packages/pinput](https://pub.dev/api/packages/pinput) |  |
| preview | known | 0.2.0-dev.1 | 2020-04-07T11:03:34.271394Z | [https://pub.dev/api/packages/pinput](https://pub.dev/api/packages/pinput) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pinput` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-c98f47f47c13b5` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| envied | Security Sast | [open](dart-envied-a8a210f2.md) |
