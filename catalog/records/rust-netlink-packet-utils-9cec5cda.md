...
| Canonical URL | [https://crates.io/crates/netlink-packet-utils](https://crates.io/crates/netlink-packet-utils) |
| Source record ids | crates_io-01b8e4920ca35c |
...
For a systems engineer, netlink-packet-utils belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2025-08-27T13:11:33.690883Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-01b8e4920ca35c` from `crates_io` as `registry_expansion`
