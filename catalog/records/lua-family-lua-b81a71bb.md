...
<!-- canonical: http://www.lua.org/download.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://www.lua.org/download.html](http://www.lua.org/download.html) |
| Source record ids | lua-source-58 |
...
For a systems engineer, Lua belongs in the Lua family inventory as part of runtime behavior,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 58}}` |
...
- `lua-source-58` from `master_json` as `source_list_item`
