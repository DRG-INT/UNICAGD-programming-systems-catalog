...
<!-- canonical: https://pub.dev/packages/dropdown_search -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dropdown_search](https://pub.dev/packages/dropdown_search) |
| Source record ids | pub_dev-4b4e76a718d261 |

## System Engineer Summary

Simple, reactive and highly customizable Flutter Dropdown with a lot of features (search, popups
platform, async/sync,...) with multi mode like menu, dialog, bottomSheet and etc.

## Operational Role

For a systems engineer, dropdown_search belongs in the Dart inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.0 | 2026-04-03T19:53:34.566417Z | [https://pub.dev/api/packages/dropdown_search](https://pub.dev/api/packages/dropdown_search) |  |
| preview | known | 7.0.0-pre7 | 2026-04-03T19:42:28.160915Z | [https://pub.dev/api/packages/dropdown_search](https://pub.dev/api/packages/dropdown_search) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dropdown_search` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-4b4e76a718d261` from `pub_dev` as `registry_expansion`
