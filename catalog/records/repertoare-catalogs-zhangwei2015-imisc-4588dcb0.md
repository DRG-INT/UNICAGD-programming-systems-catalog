...
<!-- canonical: https://github.com/zhangwei2015/IMisc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhangwei2015/IMisc](https://github.com/zhangwei2015/IMisc) |
| Source record ids | github_search_repertoare_catalogs-bc42cd372db8bb |

## System Engineer Summary

Identifing the disease associated clones, classifing two groups using these clones, and evaluating
it performance by cross-validation from two group's (control && case) immune repertoire data.

## Operational Role

For a systems engineer, zhangwei2015/IMisc belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-23T08:51:32Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-bc42cd372db8bb` from `github_search_repertoare_catalogs` as `registry_expansion`
