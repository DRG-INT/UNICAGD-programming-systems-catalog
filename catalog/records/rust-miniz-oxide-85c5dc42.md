...
<!-- canonical: https://crates.io/crates/miniz_oxide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/miniz_oxide](https://crates.io/crates/miniz_oxide) |
| Source record ids | crates_io-0bc7e697657a17 |
...
For a systems engineer, miniz_oxide belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2026-03-13T00:19:26.378812Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-0bc7e697657a17` from `crates_io` as `registry_expansion`
