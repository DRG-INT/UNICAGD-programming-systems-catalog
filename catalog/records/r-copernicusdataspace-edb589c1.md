...
<!-- canonical: https://cran.r-project.org/web/packages/CopernicusDataspace/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CopernicusDataspace/index.html](https://cran.r-project.org/web/packages/CopernicusDataspace/index.html) |
| Source record ids | cran_packages_by_date-338b018129700d |
...
For a systems engineer, CopernicusDataspace belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5 | 2026-08-28 10:20:02 UTC | [https://cran.r-project.org/web/packages/CopernicusDataspace/DESCRIPTION](https://cran.r-project.org/web/packages/CopernicusDataspace/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CopernicusDataspace/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-338b018129700d` from `cran_packages_by_date` as `registry_expansion`
