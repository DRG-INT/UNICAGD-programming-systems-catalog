...
<!-- canonical: https://cran.r-project.org/web/packages/lexicon/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lexicon/index.html](https://cran.r-project.org/web/packages/lexicon/index.html) |
| Source record ids | cran_packages_by_date-25abc42afe1da7 |
...
For a systems engineer, lexicon belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2026-08-31 19:50:12 UTC | [https://cran.r-project.org/web/packages/lexicon/DESCRIPTION](https://cran.r-project.org/web/packages/lexicon/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lexicon/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-25abc42afe1da7` from `cran_packages_by_date` as `registry_expansion`
