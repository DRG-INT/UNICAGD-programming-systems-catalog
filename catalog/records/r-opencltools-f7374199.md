...
<!-- canonical: https://cran.r-project.org/web/packages/opencltools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/opencltools/index.html](https://cran.r-project.org/web/packages/opencltools/index.html) |
| Source record ids | cran_packages_by_date-bcf439247d880f |
...
For a systems engineer, opencltools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2026-08-04 18:00:07 UTC | [https://cran.r-project.org/web/packages/opencltools/DESCRIPTION](https://cran.r-project.org/web/packages/opencltools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/opencltools/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-bcf439247d880f` from `cran_packages_by_date` as `registry_expansion`
