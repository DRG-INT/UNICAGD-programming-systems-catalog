...
<!-- canonical: https://gitlab.kitware.com/vtk/vtk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.kitware.com/vtk/vtk](https://gitlab.kitware.com/vtk/vtk) |
| Source record ids | curated_language_routes-0dd6f3c10eb5ee |

## System Engineer Summary

Visualization Toolkit for scientific graphics, imaging, geometry processing, rendering, and data
pipelines.

## Operational Role

For a systems engineer, VTK belongs in the Computer Graphics Software inventory as part of ecosystem
...
- `curated_language_routes-0dd6f3c10eb5ee` from `curated_language_routes` as `registry_expansion`
