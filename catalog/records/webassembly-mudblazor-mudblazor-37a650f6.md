...
<!-- canonical: https://github.com/MudBlazor/MudBlazor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MudBlazor/MudBlazor](https://github.com/MudBlazor/MudBlazor) |
| Source record ids | github_search_webassembly-95685ab075966f |

## System Engineer Summary

Blazor Component Library based on Material Design principles. Do more with Blazor, utilizing CSS and
keeping JavaScript to a bare minimum.

## Operational Role

For a systems engineer, MudBlazor/MudBlazor belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T18:06:53Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-95685ab075966f` from `github_search_webassembly` as `registry_expansion`
