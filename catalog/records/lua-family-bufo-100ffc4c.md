...
<!-- canonical: https://luarocks.org/modules/y-akulau/bufo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/y-akulau/bufo](https://luarocks.org/modules/y-akulau/bufo) |
| Source record ids | luarocks_root_manifest-37626138a8f4dd |

## System Engineer Summary

A encantador Lua testing library with a focus on simplicity.

## Operational Role

For a systems engineer, bufo belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-37626138a8f4dd` from `luarocks_root_manifest` as `registry_expansion`
