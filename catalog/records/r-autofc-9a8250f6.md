...
<!-- canonical: https://cran.r-project.org/web/packages/autoFC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autoFC/index.html](https://cran.r-project.org/web/packages/autoFC/index.html) |
| Source record ids | cran_packages_by_date-77fc7e68827d30 |
...
For a systems engineer, autoFC belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.1100 | 2026-08-23 05:10:10 UTC | [https://cran.r-project.org/web/packages/autoFC/DESCRIPTION](https://cran.r-project.org/web/packages/autoFC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autoFC/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-77fc7e68827d30` from `cran_packages_by_date` as `registry_expansion`
