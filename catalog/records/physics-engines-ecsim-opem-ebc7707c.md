...
<!-- canonical: https://github.com/ECSIM/opem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ECSIM/opem](https://github.com/ECSIM/opem) |
| Source record ids | github_search_physics_engines-33ce2fbfd48f0c |
...
For a systems engineer, ECSIM/opem belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T01:32:50Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-33ce2fbfd48f0c` from `github_search_physics_engines` as `registry_expansion`
