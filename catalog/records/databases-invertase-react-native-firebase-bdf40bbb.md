...
<!-- canonical: https://github.com/invertase/react-native-firebase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/invertase/react-native-firebase](https://github.com/invertase/react-native-firebase) |
| Source record ids | github_search_databases-0daf6f8af1ca17 |

## System Engineer Summary

🔥 A well-tested feature-rich modular Firebase implementation for React Native. Supports both iOS &
Android platforms for all Firebase services.

## Operational Role

For a systems engineer, invertase/react-native-firebase belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T03:45:35Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; Other |
...
- `github_search_databases-0daf6f8af1ca17` from `github_search_databases` as `registry_expansion`
