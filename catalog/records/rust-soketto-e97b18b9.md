...
| Canonical URL | [https://crates.io/crates/soketto](https://crates.io/crates/soketto) |
| Source record ids | crates_io-f9cd79394ce66c |
...
For a systems engineer, soketto belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2024-12-02T11:17:40.439226Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-f9cd79394ce66c` from `crates_io` as `registry_expansion`
