...
<!-- canonical: https://github.com/manimino/ducks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/manimino/ducks](https://github.com/manimino/ducks) |
| Source record ids | github_search_catalogs-a9db50e3d6a6cd |
...
For a systems engineer, manimino/ducks belongs in the Catalogs inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-29T13:06:13Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-a9db50e3d6a6cd` from `github_search_catalogs` as `registry_expansion`
