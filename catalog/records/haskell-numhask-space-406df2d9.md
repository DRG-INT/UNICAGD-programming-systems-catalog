...
<!-- canonical: https://hackage.haskell.org/package/numhask-space -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/numhask-space](https://hackage.haskell.org/package/numhask-space) |
| Source record ids | hackage_top_downloads-35d4d87aef79bb |
...
For a systems engineer, numhask-space belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.3.0 | 2026-07-10T22:50:59Z | [https://hackage.haskell.org/package/numhask-space](https://hackage.haskell.org/package/numhask-space) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/numhask-space` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-35d4d87aef79bb` from `hackage_top_downloads` as `registry_expansion`
