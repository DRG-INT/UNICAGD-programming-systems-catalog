...
<!-- canonical: https://github.com/shibco/txt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shibco/txt](https://github.com/shibco/txt) |
| Source record ids | github_search_magazines-e9aafe9675c5ab |
...
For a systems engineer, shibco/txt belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-03T15:14:16Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-e9aafe9675c5ab` from `github_search_magazines` as `registry_expansion`
