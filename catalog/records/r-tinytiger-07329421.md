...
<!-- canonical: https://cran.r-project.org/web/packages/tinytiger/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinytiger/index.html](https://cran.r-project.org/web/packages/tinytiger/index.html) |
| Source record ids | cran_packages_by_date-bba6a2cd673499 |
...
For a systems engineer, tinytiger belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.12 | 2026-08-22 17:00:02 UTC | [https://cran.r-project.org/web/packages/tinytiger/DESCRIPTION](https://cran.r-project.org/web/packages/tinytiger/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinytiger/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bba6a2cd673499` from `cran_packages_by_date` as `registry_expansion`
