...
| Canonical URL | [https://crates.io/crates/topological-sort](https://crates.io/crates/topological-sort) |
| Source record ids | crates_io-e9e674fd3d44e8 |
...
For a systems engineer, topological-sort belongs in the Rust inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-07T08:39:06.915078Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-e9e674fd3d44e8` from `crates_io` as `registry_expansion`
