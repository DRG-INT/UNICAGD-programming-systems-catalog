...
<!-- canonical: https://www.nuget.org/packages/StreamJsonRpc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/StreamJsonRpc](https://www.nuget.org/packages/StreamJsonRpc) |
| Source record ids | nuget_search-5d5a3b744b0184 |

## System Engineer Summary

A cross-platform .NETStandard library that implements the JSON-RPC wire protocol and can use
System.IO.Stream, System.IO.Pipelines or WebSocket so you can use it with any transport.

## Operational Role

For a systems engineer, StreamJsonRpc belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.25.29+RR | 2026-06-15T18:13:05.593+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/streamjsonrpc/index.json](https://api.nuget.org/v3/registration5-gz-semver2/streamjsonrpc/index.json) |  |
| preview | known | 2.23.32-alpha | 2025-06-20T16:05:33.073+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/streamjsonrpc/index.json](https://api.nuget.org/v3/registration5-gz-semver2/streamjsonrpc/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; MIT; https://www.nuget.org/packages/StreamJsonRpc/2.25.29/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/streamjsonrpc/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-5d5a3b744b0184` from `nuget_search` as `registry_expansion`
