...
| Source record ids | github_search_satcom_satellites-93c4fe47b6792f |
...
For a systems engineer, gnuradio/volk belongs in the SatCom Satellites inventory as part of
...
- `github_search_satcom_satellites-93c4fe47b6792f` from `github_search_satcom_satellites` as `registry_expansion`
