...
<!-- canonical: https://pypi.org/project/acdh-django-handle/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-handle/](https://pypi.org/project/acdh-django-handle/) |
| Source record ids | pypi_simple-71dae25b5935c3 |
...
For a systems engineer, acdh-django-handle belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2018-06-28T10:00:39.830433Z | [https://pypi.org/pypi/acdh-django-handle/json](https://pypi.org/pypi/acdh-django-handle/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-handle/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-71dae25b5935c3` from `pypi_simple` as `registry_expansion`
