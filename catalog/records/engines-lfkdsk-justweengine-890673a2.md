...
<!-- canonical: https://github.com/lfkdsk/JustWeEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lfkdsk/JustWeEngine](https://github.com/lfkdsk/JustWeEngine) |
| Source record ids | github_search_engines-d0fe1eae377f91 |
...
For a systems engineer, lfkdsk/JustWeEngine belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T09:07:23Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d0fe1eae377f91` from `github_search_engines` as `registry_expansion`
