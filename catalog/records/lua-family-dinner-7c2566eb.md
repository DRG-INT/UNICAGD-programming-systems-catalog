...
<!-- canonical: https://luarocks.org/modules/xiaq/dinner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/xiaq/dinner](https://luarocks.org/modules/xiaq/dinner) |
| Source record ids | luarocks_root_manifest-9dbb473051d8e3 |

## System Engineer Summary

A rock showcasing the new addon functionality.

## Operational Role

For a systems engineer, dinner belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9dbb473051d8e3` from `luarocks_root_manifest` as `registry_expansion`
