...
<!-- canonical: https://cran.r-project.org/web/packages/PowerXgammaRF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PowerXgammaRF/index.html](https://cran.r-project.org/web/packages/PowerXgammaRF/index.html) |
| Source record ids | cran_packages_by_date-461e60751bcac2 |
...
For a systems engineer, PowerXgammaRF belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-21 13:20:24 UTC | [https://cran.r-project.org/web/packages/PowerXgammaRF/DESCRIPTION](https://cran.r-project.org/web/packages/PowerXgammaRF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PowerXgammaRF/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-461e60751bcac2` from `cran_packages_by_date` as `registry_expansion`
