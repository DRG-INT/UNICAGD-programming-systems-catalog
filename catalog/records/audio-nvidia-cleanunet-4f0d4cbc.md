...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NVIDIA/CleanUNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NVIDIA/CleanUNet](https://github.com/NVIDIA/CleanUNet) |
| Source record ids | github_search_audio-c77b436b737ad0 |
...
For a systems engineer, NVIDIA/CleanUNet belongs in the Audio inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-11T12:13:16Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-c77b436b737ad0` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dotnet/Silk.NET | Ffi Bindings | [open](audio-dotnet-silk-net-d83f3a2e.md) |
| gopher-atz/4klang | Ffi Bindings | [open](audio-gopher-atz-4klang-e6dac937.md) |
| gopher-atz/64klang | Ffi Bindings | [open](audio-gopher-atz-64klang-9d53cc3c.md) |
| haoxiangsnr/A-Convolutional-Recurrent-Neural-Network-for-Real-Time-Speech-Enhancement | Ffi Bindings | [open](audio-haoxiangsnr-a-convolutional-recurrent-neural-network-for-real-time-speech-enhancement-0b300d82.md) |
| juce-framework/tremolo-juce-course | Ffi Bindings | [open](audio-juce-framework-tremolo-juce-course-8967b4d6.md) |
| mravanelli/SincNet | Ffi Bindings | [open](audio-mravanelli-sincnet-8b7e8ce3.md) |
| rishikksh20/SoundStorm-pytorch | Ffi Bindings | [open](audio-rishikksh20-soundstorm-pytorch-1c8a7ca2.md) |
| ShawnPi233/HQ-SVC | Ffi Bindings | [open](audio-shawnpi233-hq-svc-5552f326.md) |
