...
<!-- canonical: https://github.com/tongson/omnia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tongson/omnia](https://github.com/tongson/omnia) |
| Source record ids | lua-source-83 |
...
For a systems engineer, omnia belongs in the Lua family inventory as part of build graph control,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 83}}` |
...
- `lua-source-83` from `master_json` as `source_list_item`
