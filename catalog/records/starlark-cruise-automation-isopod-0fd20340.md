...
| Canonical URL | [https://github.com/cruise-automation/isopod](https://github.com/cruise-automation/isopod) |
| Source record ids | github_search_starlark-edf343799ba2f7 |
...
For a systems engineer, cruise-automation/isopod belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.8.7 | 2022-10-20T20:43:38Z | [https://api.github.com/repos/cruise-automation/isopod/releases/latest](https://api.github.com/repos/cruise-automation/isopod/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cruise-automation/isopod/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-edf343799ba2f7` from `github_search_starlark` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| openrundev/openrun | Undefined Behavior Analyzer | [open](starlark-openrundev-openrun-0f48908b.md) |
