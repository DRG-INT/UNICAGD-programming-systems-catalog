...
<!-- canonical: https://github.com/crsh/papaja -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/crsh/papaja](https://github.com/crsh/papaja) |
| Source record ids | github_search_magazines-0a8bf3192ae09a |

## System Engineer Summary

papaja (Preparing APA Journal Articles) is an R package that provides document formats to produce
complete APA manuscripts from RMarkdown-files (PDF and Word documents) and helper functions that
facilitate reporting statistics, tables, and plots.

## Operational Role

For a systems engineer, crsh/papaja belongs in the Magazines inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:19:32Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-0a8bf3192ae09a` from `github_search_magazines` as `registry_expansion`
