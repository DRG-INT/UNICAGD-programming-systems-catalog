...
| Canonical URL | [https://luarocks.org/modules/xriss/gamecake-pack](https://luarocks.org/modules/xriss/gamecake-pack) |
| Source record ids | luarocks_root_manifest-fe78614a40da4b |
...
For a systems engineer, gamecake-pack belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-fe78614a40da4b` from `luarocks_root_manifest` as `registry_expansion`
