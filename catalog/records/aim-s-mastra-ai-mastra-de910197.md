...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mastra-ai/mastra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mastra-ai/mastra](https://github.com/mastra-ai/mastra) |
| Source record ids | github_search_aims-6096957b2ca974 |
...
For a systems engineer, mastra-ai/mastra belongs in the "aim's" inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:22:08Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-6096957b2ca974` from `github_search_aims` as `registry_expansion`
