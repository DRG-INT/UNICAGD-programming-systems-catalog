...
<!-- canonical: https://crates.io/crates/mio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/mio](https://crates.io/crates/mio) |
| Source record ids | corpus-35e37223f18632, crates_io-16b531b12f122f |
...
For a systems engineer, mio belongs in the Rust inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-09-02T13:22:12.206563Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Other; MIT; https://www.nuget.org/packages/Refit.HttpClientFactory/15.2.0/license |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-02T14:19:54+00:00`.
...
- `corpus-35e37223f18632` from `master_json` as `async_runtime`
- `crates_io-16b531b12f122f` from `crates_io` as `registry_expansion`
