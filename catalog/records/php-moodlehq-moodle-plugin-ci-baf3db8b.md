...
<!-- canonical: https://packagist.org/packages/moodlehq/moodle-plugin-ci -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/moodlehq/moodle-plugin-ci](https://packagist.org/packages/moodlehq/moodle-plugin-ci) |
| Source record ids | packagist_search-6805bf0e6d2d41 |
...
For a systems engineer, moodlehq/moodle-plugin-ci belongs in the PHP inventory as part of defect
...
- `packagist_search-6805bf0e6d2d41` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| phpmetrics/phpmetrics | Static Analyzer | [open](php-phpmetrics-phpmetrics-6539e460.md) |
