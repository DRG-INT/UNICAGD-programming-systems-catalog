...
<!-- canonical: https://github.com/tomayac/local-reverse-geocoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tomayac/local-reverse-geocoder](https://github.com/tomayac/local-reverse-geocoder) |
| Source record ids | github_search_maps-c26a1a0d52ac52 |
...
For a systems engineer, tomayac/local-reverse-geocoder belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.16.8 | 2026-06-14T16:06:15Z | [https://api.github.com/repos/tomayac/local-reverse-geocoder/releases/latest](https://api.github.com/repos/tomayac/local-reverse-geocoder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tomayac/local-reverse-geocoder/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-c26a1a0d52ac52` from `github_search_maps` as `registry_expansion`
