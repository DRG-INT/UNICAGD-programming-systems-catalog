...
<!-- canonical: https://cran.r-project.org/web/packages/idiographic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/idiographic/index.html](https://cran.r-project.org/web/packages/idiographic/index.html) |
| Source record ids | cran_packages_by_date-ab07e3a38010f1 |
...
For a systems engineer, idiographic belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4 | 2026-08-24 07:30:10 UTC | [https://cran.r-project.org/web/packages/idiographic/DESCRIPTION](https://cran.r-project.org/web/packages/idiographic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/idiographic/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ab07e3a38010f1` from `cran_packages_by_date` as `registry_expansion`
