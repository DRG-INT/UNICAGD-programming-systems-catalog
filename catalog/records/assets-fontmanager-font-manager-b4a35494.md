...
| Source record ids | github_search_assets-9897190068a896 |

## System Engineer Summary

FontManager/font-manager is tracked as a library record in the Assets branch. The source did not
...
For a systems engineer, FontManager/font-manager belongs in the Assets inventory as part of
...
- `github_search_assets-9897190068a896` from `github_search_assets` as `registry_expansion`
