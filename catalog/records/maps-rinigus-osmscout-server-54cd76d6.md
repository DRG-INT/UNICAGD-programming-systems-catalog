...
<!-- canonical: https://github.com/rinigus/osmscout-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rinigus/osmscout-server](https://github.com/rinigus/osmscout-server) |
| Source record ids | github_search_maps-e065edebd498cd |
...
For a systems engineer, rinigus/osmscout-server belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T19:22:25Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-e065edebd498cd` from `github_search_maps` as `registry_expansion`
