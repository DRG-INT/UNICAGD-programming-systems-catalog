...
<!-- canonical: https://github.com/Vhonowslend/StreamFX-Public -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Vhonowslend/StreamFX-Public](https://github.com/Vhonowslend/StreamFX-Public) |
| Source record ids | github_search_video-79792f119d07b2 |

## System Engineer Summary

StreamFX is a plugin for OBS® Studio which adds many new effects, filters, sources, transitions and
encoders! Be it 3D Transform, Blur, complex Masking, or even custom shaders, you'll find it all
here.

## Operational Role

For a systems engineer, Vhonowslend/StreamFX-Public belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-13T06:41:33Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-79792f119d07b2` from `github_search_video` as `registry_expansion`
