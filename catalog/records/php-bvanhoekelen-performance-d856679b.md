...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/bvanhoekelen/performance](https://packagist.org/packages/bvanhoekelen/performance) |
| Source record ids | packagist_search-31e80a962e3081 |

## System Engineer Summary

PHP performance tool analyser your script on time, memory usage and db query. Support Laravel and
Composer for web, web console and command line interfaces.

## Operational Role

For a systems engineer, bvanhoekelen/performance belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.6.0 | 2026-02-21T09:24:10+00:00 | [https://repo.packagist.org/p2/bvanhoekelen/performance.json](https://repo.packagist.org/p2/bvanhoekelen/performance.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/bvanhoekelen/performance.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-31e80a962e3081` from `packagist_search` as `registry_expansion`
