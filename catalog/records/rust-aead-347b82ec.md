...
<!-- canonical: https://crates.io/crates/aead -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aead](https://crates.io/crates/aead) |
| Source record ids | crates_io-37d4b464561c68 |

## System Engineer Summary

Traits for Authenticated Encryption with Associated Data (AEAD) algorithms, such as AES-GCM as
ChaCha20Poly1305, which provide a high-level API

## Operational Role

For a systems engineer, aead belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-06-17T15:11:01.381082Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-37d4b464561c68` from `crates_io` as `registry_expansion`
