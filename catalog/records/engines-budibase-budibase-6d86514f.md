...
<!-- canonical: https://github.com/Budibase/budibase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Budibase/budibase](https://github.com/Budibase/budibase) |
| Source record ids | github_search_engines-e28fc35eb35adf |
...
For a systems engineer, Budibase/budibase belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:59:39Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-e28fc35eb35adf` from `github_search_engines` as `registry_expansion`
