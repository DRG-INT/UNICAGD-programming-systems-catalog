...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-dfc2a7c81e5073 |

## System Engineer Summary

Compiler infrastructure engine for frontends, optimizers, code generation, linkers, runtimes, and
tooling.

## Operational Role

For a systems engineer, LLVM belongs in the Engines inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | llvmorg-23.1.0 | 2026-08-25T19:21:39Z | [https://api.github.com/repos/llvm/llvm-project/releases/latest](https://api.github.com/repos/llvm/llvm-project/releases/latest) |  |
| preview | known | llvmorg-23.1.0-rc3 | 2026-08-12T05:01:22Z | [https://api.github.com/repos/llvm/llvm-project/releases?per_page=10](https://api.github.com/repos/llvm/llvm-project/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/llvm/llvm-project/releases/latest` at `2026-09-01T12:30:33+00:00`.
...
- `curated_language_routes-dfc2a7c81e5073` from `curated_language_routes` as `registry_expansion`
