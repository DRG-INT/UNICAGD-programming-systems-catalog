...
<!-- canonical: https://cran.r-project.org/web/packages/heims/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/heims/index.html](https://cran.r-project.org/web/packages/heims/index.html) |
| Source record ids | cran_packages_by_date-80518942fd13ed |
...
For a systems engineer, heims belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2026-08-22 15:10:19 UTC | [https://cran.r-project.org/web/packages/heims/DESCRIPTION](https://cran.r-project.org/web/packages/heims/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/heims/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-80518942fd13ed` from `cran_packages_by_date` as `registry_expansion`
