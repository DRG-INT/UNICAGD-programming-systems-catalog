...
<!-- canonical: https://cran.r-project.org/web/packages/redeem/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/redeem/index.html](https://cran.r-project.org/web/packages/redeem/index.html) |
| Source record ids | cran_packages_by_date-5d5449f7a9bb70 |
...
For a systems engineer, redeem belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 10:30:02 UTC | [https://cran.r-project.org/web/packages/redeem/DESCRIPTION](https://cran.r-project.org/web/packages/redeem/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/redeem/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5d5449f7a9bb70` from `cran_packages_by_date` as `registry_expansion`
