...
<!-- canonical: https://cran.r-project.org/web/packages/SynergyLMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SynergyLMM/index.html](https://cran.r-project.org/web/packages/SynergyLMM/index.html) |
| Source record ids | cran_packages_by_date-8d748e93523316 |
...
For a systems engineer, SynergyLMM belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-08-20 23:02:18 UTC | [https://cran.r-project.org/web/packages/SynergyLMM/DESCRIPTION](https://cran.r-project.org/web/packages/SynergyLMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SynergyLMM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8d748e93523316` from `cran_packages_by_date` as `registry_expansion`
...
| crew | Framework | [open](r-crew-aa2b57a5.md) |
