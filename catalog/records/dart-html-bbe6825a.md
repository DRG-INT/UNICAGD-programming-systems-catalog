...
<!-- canonical: https://pub.dev/packages/html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/html](https://pub.dev/packages/html) |
| Source record ids | pub_dev-5fbffebabd5b78 |
...
For a systems engineer, html belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.15.7 | 2026-08-28T20:42:28.160706Z | [https://pub.dev/api/packages/html](https://pub.dev/api/packages/html) |  |
| preview | known | 0.15.0-nullsafety.0 | 2021-02-01T18:12:07.903788Z | [https://pub.dev/api/packages/html](https://pub.dev/api/packages/html) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/html` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-5fbffebabd5b78` from `pub_dev` as `registry_expansion`
