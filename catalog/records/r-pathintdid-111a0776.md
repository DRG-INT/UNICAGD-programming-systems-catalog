...
<!-- canonical: https://cran.r-project.org/web/packages/pathintdid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pathintdid/index.html](https://cran.r-project.org/web/packages/pathintdid/index.html) |
| Source record ids | cran_packages_by_date-203154f3b59bf2 |

## System Engineer Summary

Path-Integrated Difference-in-Differences

## Operational Role

For a systems engineer, pathintdid belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 11:50:02 UTC | [https://cran.r-project.org/web/packages/pathintdid/DESCRIPTION](https://cran.r-project.org/web/packages/pathintdid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pathintdid/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-203154f3b59bf2` from `cran_packages_by_date` as `registry_expansion`
