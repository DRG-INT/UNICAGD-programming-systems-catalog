...
| Source record ids | curated_database_systems-4027f6eb49e9ea, awesome_list-4027f6eb49e9ea |

## System Engineer Summary

Universal database client and SQL IDE.

## Operational Role

For a systems engineer, DBeaver belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.2.0 | 2026-08-30T18:07:06Z | [https://api.github.com/repos/dbeaver/dbeaver/releases/latest](https://api.github.com/repos/dbeaver/dbeaver/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dbeaver/dbeaver/releases/latest` at `2026-09-01T07:24:48+00:00`.
...
- `curated_database_systems-4027f6eb49e9ea` from `curated_database_systems` as `registry_expansion`
- `awesome_list-4027f6eb49e9ea` from `awesome_list` as `registry_expansion`
