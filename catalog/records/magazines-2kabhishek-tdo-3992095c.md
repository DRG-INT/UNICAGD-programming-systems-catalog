...
<!-- canonical: https://github.com/2KAbhishek/tdo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2KAbhishek/tdo](https://github.com/2KAbhishek/tdo) |
| Source record ids | github_search_magazines-ff21fd21a314ab |
...
For a systems engineer, 2KAbhishek/tdo belongs in the Magazines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:12:57Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-ff21fd21a314ab` from `github_search_magazines` as `registry_expansion`
