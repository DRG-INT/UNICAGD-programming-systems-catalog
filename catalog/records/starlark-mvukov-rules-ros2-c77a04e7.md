...
<!-- canonical: https://github.com/mvukov/rules_ros2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mvukov/rules_ros2](https://github.com/mvukov/rules_ros2) |
| Source record ids | github_search_starlark-4f306993d5ba91 |

## System Engineer Summary

mvukov/rules_ros2 is tracked as a build system record in the Starlark branch. The source did not
...
For a systems engineer, mvukov/rules_ros2 belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:28:37Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-4f306993d5ba91` from `github_search_starlark` as `registry_expansion`
