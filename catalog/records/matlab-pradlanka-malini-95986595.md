...
<!-- canonical: https://github.com/pradlanka/malini -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pradlanka/malini](https://github.com/pradlanka/malini) |
| Source record ids | github_search_matlab-b7dbabf7bba323 |

## System Engineer Summary

Machine Learning in NeuroImaging (MALINI) is a MATLAB-based toolbox used for feature extraction and
disease classification using resting state functional magnetic resonance imaging (rs-fMRI) data. 18
different popular classifiers are presented. With slight modifications, it can also be used for any
classification problem using any set of features.

## Operational Role

For a systems engineer, pradlanka/malini belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-27T23:37:40Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-b7dbabf7bba323` from `github_search_matlab` as `registry_expansion`
