...
<!-- canonical: https://packagist.org/packages/psr/http-server-middleware -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/psr/http-server-middleware](https://packagist.org/packages/psr/http-server-middleware) |
| Source record ids | packagist_search-6309f8a4cbfb9e |
...
For a systems engineer, psr/http-server-middleware belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-6309f8a4cbfb9e` from `packagist_search` as `registry_expansion`
