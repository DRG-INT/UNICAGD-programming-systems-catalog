...
<!-- canonical: https://cran.r-project.org/web/packages/lstar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lstar/index.html](https://cran.r-project.org/web/packages/lstar/index.html) |
| Source record ids | cran_packages_by_date-d5ae1602bc3493 |
...
For a systems engineer, lstar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-04 17:10:09 UTC | [https://cran.r-project.org/web/packages/lstar/DESCRIPTION](https://cran.r-project.org/web/packages/lstar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lstar/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d5ae1602bc3493` from `cran_packages_by_date` as `registry_expansion`
