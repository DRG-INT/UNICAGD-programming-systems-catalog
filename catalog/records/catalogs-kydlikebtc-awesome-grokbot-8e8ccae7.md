...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kydlikebtc/awesome-grokbot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kydlikebtc/awesome-grokbot](https://github.com/kydlikebtc/awesome-grokbot) |
| Source record ids | github_search_catalogs-7dc6394dac8473 |

## System Engineer Summary

440 live x.ai/bot shares for Grok Bot — every link status-checked, every row attributed. Bilingual
EN/中文 catalog with a JSON schema, CI, and a searchable site.

## Operational Role

For a systems engineer, kydlikebtc/awesome-grokbot belongs in the Catalogs inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:16:54Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-7dc6394dac8473` from `github_search_catalogs` as `registry_expansion`
