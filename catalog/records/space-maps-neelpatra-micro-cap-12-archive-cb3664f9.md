# NeelPatra/Micro-Cap-12-Archive

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NeelPatra/Micro-Cap-12-Archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NeelPatra/Micro-Cap-12-Archive](https://github.com/NeelPatra/Micro-Cap-12-Archive) |
| Source record ids | github_search_space_maps-a2aa4c9d659fb9 |

## System Engineer Summary

Free download of Micro-Cap 12 (Spectrum Software). Complete archive of the final SPICE circuit
simulator, including the Windows installer, libraries, and components.

## Operational Role

For a systems engineer, NeelPatra/Micro-Cap-12-Archive belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-11T06:50:17Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a2aa4c9d659fb9` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AndrewAnnex/asap_stereo | Package Manager | [open](space-maps-andrewannex-asap-stereo-37cce249.md) |
| athob/py-ananke | Package Manager | [open](space-maps-athob-py-ananke-ac3b22bc.md) |
| bysiber/cleardisk | Package Manager | [open](space-maps-bysiber-cleardisk-83f43fa2.md) |
| cybatron0/the-kardashev | Package Manager | [open](space-maps-cybatron0-the-kardashev-90ca95ea.md) |
| daddykev/stardust-distro | Package Manager | [open](space-maps-daddykev-stardust-distro-1e09e701.md) |
| daddykev/stardust-dsp | Package Manager | [open](space-maps-daddykev-stardust-dsp-ad11bf31.md) |
| Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog | Package Manager | [open](space-maps-snowflake-labs-sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog-300e96a6.md) |
| spacetelescope/jwst | Package Manager | [open](space-maps-spacetelescope-jwst-eb2c4c25.md) |
