...
<!-- canonical: https://github.com/TencentBlueKing/bk-sops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TencentBlueKing/bk-sops](https://github.com/TencentBlueKing/bk-sops) |
| Source record ids | github_search_engines-5df8e682fae19e |

## System Engineer Summary

TencentBlueKing/bk-sops is tracked as a game engine game dev record in the Engines branch. The
...
For a systems engineer, TencentBlueKing/bk-sops belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T08:37:52Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-5df8e682fae19e` from `github_search_engines` as `registry_expansion`
