...
<!-- canonical: https://github.com/ethanhuang13/ladybug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ethanhuang13/ladybug](https://github.com/ethanhuang13/ladybug) |
| Source record ids | github_search_radars-b1f1e39fa75291 |
...
For a systems engineer, ethanhuang13/ladybug belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.2 | 2018-09-21T09:40:03Z | [https://api.github.com/repos/ethanhuang13/ladybug/releases/latest](https://api.github.com/repos/ethanhuang13/ladybug/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ethanhuang13/ladybug/releases/latest` at `2026-09-01T08:26:29+00:00`.
...
- `github_search_radars-b1f1e39fa75291` from `github_search_radars` as `registry_expansion`
