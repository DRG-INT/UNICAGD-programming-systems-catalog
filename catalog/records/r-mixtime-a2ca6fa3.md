...
<!-- canonical: https://cran.r-project.org/web/packages/mixtime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mixtime/index.html](https://cran.r-project.org/web/packages/mixtime/index.html) |
| Source record ids | cran_packages_by_date-fc8fa50c518751 |

## System Engineer Summary

Mixed Temporal Vectors and Operations

## Operational Role

For a systems engineer, mixtime belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-24 05:30:02 UTC | [https://cran.r-project.org/web/packages/mixtime/DESCRIPTION](https://cran.r-project.org/web/packages/mixtime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mixtime/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fc8fa50c518751` from `cran_packages_by_date` as `registry_expansion`
