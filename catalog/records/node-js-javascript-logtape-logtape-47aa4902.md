...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Dependency Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/dependency-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@logtape/logtape](https://www.npmjs.com/package/@logtape/logtape) |
| Source record ids | npm_registry-23c4dcae3a137a |

## System Engineer Summary

Unobtrusive logging library with zero dependencies—library-first design for
Deno/Node.js/Bun/browsers/edge

## Operational Role

For a systems engineer, @logtape/logtape belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-08-21T06:49:49.240Z | [https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=logging&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T04:19:08+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| @mondaydotcomorg/browserslist-config | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-mondaydotcomorg-browserslist-config-02bd07d7.md) |
| @sandworm/audit | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-sandworm-audit-a6bfa2b2.md) |
| @socketsecurity/socket-patch | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-socketsecurity-socket-patch-992a1d25.md) |
| @yottameta/yotta-security-audit | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-yottameta-yotta-security-audit-d6d852a7.md) |
| eslint-import-resolver-webpack | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-eslint-import-resolver-webpack-fcc4cdd9.md) |
| graphql-http | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-graphql-http-03ee5905.md) |
| graphql-sse | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-graphql-sse-4e53170e.md) |
| graphql-ws | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-graphql-ws-c620328a.md) |
