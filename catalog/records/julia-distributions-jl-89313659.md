...
| Source record ids | corpus-202f741c354441 |

## System Engineer Summary

Distributions.jl is tracked as a data science record in the Julia branch. The source did not provide
...
For a systems engineer, Distributions.jl belongs in the Julia inventory as part of ecosystem
...
- `corpus-202f741c354441` from `master_json` as `data_science`
