...
<!-- canonical: https://hackage.haskell.org/package/keel-linalg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keel-linalg](https://hackage.haskell.org/package/keel-linalg) |
| Source record ids | hackage_recent-94a17d896d7b10 |
...
For a systems engineer, keel-linalg belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-03T12:55:26Z | [https://hackage.haskell.org/package/keel-linalg](https://hackage.haskell.org/package/keel-linalg) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keel-linalg` at `2026-09-03T16:25:12+00:00`.
...
- `hackage_recent-94a17d896d7b10` from `hackage_recent` as `registry_expansion`
