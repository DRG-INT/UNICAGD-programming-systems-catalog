...
<!-- canonical: https://github.com/AcademySoftwareFoundation/openvdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AcademySoftwareFoundation/openvdb](https://github.com/AcademySoftwareFoundation/openvdb) |
| Source record ids | github_search_effects-73f6296d78bcbf |
...
For a systems engineer, AcademySoftwareFoundation/openvdb belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:08:06Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-73f6296d78bcbf` from `github_search_effects` as `registry_expansion`
