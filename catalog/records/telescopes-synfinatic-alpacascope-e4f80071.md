...
| Canonical URL | [https://github.com/synfinatic/alpacascope](https://github.com/synfinatic/alpacascope) |
| Source record ids | github_search_telescopes-c18d2dcf3e8191 |
...
For a systems engineer, synfinatic/alpacascope belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.4.1 | 2024-07-09T19:42:07Z | [https://api.github.com/repos/synfinatic/alpacascope/releases/latest](https://api.github.com/repos/synfinatic/alpacascope/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/synfinatic/alpacascope/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_telescopes-c18d2dcf3e8191` from `github_search_telescopes` as `registry_expansion`
