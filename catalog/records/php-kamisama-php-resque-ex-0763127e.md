...
<!-- canonical: https://packagist.org/packages/kamisama/php-resque-ex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kamisama/php-resque-ex](https://packagist.org/packages/kamisama/php-resque-ex) |
| Source record ids | packagist_search-a4a9022e1d134d |

## System Engineer Summary

Redis backed library for creating background jobs and processing them later. PHP port based on
resque for Ruby.

## Operational Role

For a systems engineer, kamisama/php-resque-ex belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-a4a9022e1d134d` from `packagist_search` as `registry_expansion`
