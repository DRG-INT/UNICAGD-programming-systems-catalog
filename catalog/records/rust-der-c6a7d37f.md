...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Lint Rule Pack](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/lint-rule-pack.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/der](https://crates.io/crates/der) |
| Source record ids | crates_io-7b170a37a0102f |

## System Engineer Summary

Pure Rust embedded-friendly implementation of the Distinguished Encoding Rules (DER) for Abstract
Syntax Notation One (ASN.1) as described in ITU X.690 with full support for heapless
`no_std`/`no_alloc` targets

## Operational Role

For a systems engineer, der belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-07-09T05:02:38.440237Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| ident_case | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ident-case-d5365a2e.md) |
| konst_macro_rules | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-konst-macro-rules-17afdf44.md) |
| macro_rules_attribute | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-macro-rules-attribute-ce9bc3b9.md) |
| macro_rules_attribute-proc_macro | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-macro-rules-attribute-proc-macro-4a294dd1.md) |
| proc-macro-crate | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-proc-macro-crate-2a8a4c1d.md) |
| shell-words | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-shell-words-973376cd.md) |
