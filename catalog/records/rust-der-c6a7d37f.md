...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/der -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-09-05T14:12:57.504716Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""} |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-05T14:17:28+00:00`.
...
- `crates_io-7b170a37a0102f` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ident_case | Lint Rule Pack | [open](rust-ident-case-d5365a2e.md) |
| konst_macro_rules | Lint Rule Pack | [open](rust-konst-macro-rules-17afdf44.md) |
| macro_rules_attribute | Lint Rule Pack | [open](rust-macro-rules-attribute-ce9bc3b9.md) |
| macro_rules_attribute-proc_macro | Lint Rule Pack | [open](rust-macro-rules-attribute-proc-macro-4a294dd1.md) |
| proc-macro-crate | Lint Rule Pack | [open](rust-proc-macro-crate-2a8a4c1d.md) |
| shell-words | Lint Rule Pack | [open](rust-shell-words-973376cd.md) |
