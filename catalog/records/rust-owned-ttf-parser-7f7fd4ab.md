...
| Canonical URL | [https://crates.io/crates/owned_ttf_parser](https://crates.io/crates/owned_ttf_parser) |
| Source record ids | crates_io-6ceb22c6fa43be |
...
For a systems engineer, owned_ttf_parser belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.1 | 2025-07-24T08:13:23.649753Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-6ceb22c6fa43be` from `crates_io` as `registry_expansion`
