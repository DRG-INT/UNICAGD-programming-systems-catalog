...
<!-- canonical: https://cran.r-project.org/web/packages/ifo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ifo/index.html](https://cran.r-project.org/web/packages/ifo/index.html) |
| Source record ids | cran_packages_by_date-25233b591fb901 |
...
For a systems engineer, ifo belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-21 14:20:02 UTC | [https://cran.r-project.org/web/packages/ifo/DESCRIPTION](https://cran.r-project.org/web/packages/ifo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ifo/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-25233b591fb901` from `cran_packages_by_date` as `registry_expansion`
