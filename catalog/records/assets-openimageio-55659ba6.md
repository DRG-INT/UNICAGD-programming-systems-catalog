...
| Source record ids | curated_language_routes-cdc75948413964 |

## System Engineer Summary

Image I/O library and tools for reading, writing, converting, and inspecting texture/image asset
formats.

## Operational Role

For a systems engineer, OpenImageIO belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-cdc75948413964` from `curated_language_routes` as `registry_expansion`
