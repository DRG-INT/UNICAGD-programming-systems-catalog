...
<!-- canonical: https://crates.io/crates/miow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/miow](https://crates.io/crates/miow) |
| Source record ids | crates_io-299929bf18a86f |
...
For a systems engineer, miow belongs in the Rust inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2025-09-10T22:01:05.981172Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-299929bf18a86f` from `crates_io` as `registry_expansion`
