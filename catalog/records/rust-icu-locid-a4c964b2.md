...
<!-- canonical: https://crates.io/crates/icu_locid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_locid](https://crates.io/crates/icu_locid) |
| Source record ids | crates_io-c2a38a378c7aa1 |

## System Engineer Summary

icu_locid is tracked as a precommit ci quality record in the Rust branch. The source did not provide
...
For a systems engineer, icu_locid belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-10-14T23:48:14.069275Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-c2a38a378c7aa1` from `crates_io` as `registry_expansion`
