...
<!-- canonical: https://github.com/ehang-io/nps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ehang-io/nps](https://github.com/ehang-io/nps) |
| Source record ids | github_search_go-218a6750eb8373 |

## System Engineer Summary

一款轻量级、高性能、功能强大的内网穿透代理服务器。支持tcp、udp、socks5、http等几乎所有流量转发，可用来访问内网网站、本地支付接口调试、ssh访问、远程桌面，内网dns解析、内网sock
s5代理等等……，并带有功能强大的web管理端。a lightweight, high-performance, powerful intranet penetration proxy server,
with a powerful web management terminal.

## Operational Role

For a systems engineer, ehang-io/nps belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-30T03:51:08Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
| Evidence | (UPL-1.0 OR Apache-2.0); GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_go-218a6750eb8373` from `github_search_go` as `registry_expansion`
