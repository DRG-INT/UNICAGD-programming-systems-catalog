...
<!-- canonical: https://crates.io/crates/opentelemetry-semantic-conventions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/opentelemetry-semantic-conventions](https://crates.io/crates/opentelemetry-semantic-conventions) |
| Source record ids | crates_io-e5cad8cde33376 |
...
For a systems engineer, opentelemetry-semantic-conventions belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.1 | 2026-06-26T01:34:28.188841Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-e5cad8cde33376` from `crates_io` as `registry_expansion`
