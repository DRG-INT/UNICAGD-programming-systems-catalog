...
<!-- canonical: https://google.github.io/swift/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://google.github.io/swift/](https://google.github.io/swift/) |
| Source record ids | awesome_list-3251d5cfbbdb11 |

## System Engineer Summary

This style guide is based on Apple’s excellent Swift standard library style and also incorporates
feedback from usage across multiple Swift projects within Google.

## Operational Role

For a systems engineer, Google belongs in the Swift inventory as part of ecosystem capability
...
- `awesome_list-3251d5cfbbdb11` from `awesome_list` as `registry_expansion`
