...
<!-- canonical: https://github.com/eryajf/learning-weekly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eryajf/learning-weekly](https://github.com/eryajf/learning-weekly) |
| Source record ids | github_search_go-4a1378698d0cbc |
...
For a systems engineer, eryajf/learning-weekly belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T15:27:30Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-4a1378698d0cbc` from `github_search_go` as `registry_expansion`
