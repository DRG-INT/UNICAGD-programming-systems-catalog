...
| Source record ids | github_search_video-efa9b85a71f4ce |
...
For a systems engineer, taco-group/SparkVSR belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T04:15:33Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-efa9b85a71f4ce` from `github_search_video` as `registry_expansion`
