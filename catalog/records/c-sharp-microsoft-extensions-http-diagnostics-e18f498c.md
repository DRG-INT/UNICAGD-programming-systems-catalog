...
<!-- canonical: https://www.nuget.org/packages/Microsoft.Extensions.Http.Diagnostics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Extensions.Http.Diagnostics](https://www.nuget.org/packages/Microsoft.Extensions.Http.Diagnostics) |
| Source record ids | nuget_search-a0f98e1a438256 |
...
For a systems engineer, Microsoft.Extensions.Http.Diagnostics belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.9.0 | 2026-08-11T23:33:42.553+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.diagnostics/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.diagnostics/index.json) |  |
| preview | known | 9.0.0-preview.9.24507.7 | 2024-10-08T15:05:57.78+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.diagnostics/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.diagnostics/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; https://www.nuget.org/packages/Microsoft.Extensions.Http.Diagnostics/10.9.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.diagnostics/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-a0f98e1a438256` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Microsoft.Extensions.Http | Compiler Diagnostics | [open](c-sharp-microsoft-extensions-http-428ced21.md) |
