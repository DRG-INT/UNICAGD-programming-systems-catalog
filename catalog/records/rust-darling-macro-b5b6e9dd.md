...
<!-- canonical: https://crates.io/crates/darling_macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/darling_macro](https://crates.io/crates/darling_macro) |
| Source record ids | crates_io-c34974b0c62398 |

## System Engineer Summary

Internal support for a proc-macro library for reading attributes into structs when implementing
custom derives. Use in your code.

## Operational Role

For a systems engineer, darling_macro belongs in the Rust inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.1 | 2026-08-20T15:11:50.704280Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-c34974b0c62398` from `crates_io` as `registry_expansion`
