...
| Canonical URL | [https://packagist.org/packages/greenlion/php-sql-parser](https://packagist.org/packages/greenlion/php-sql-parser) |
| Source record ids | packagist_search-0c1fdb365ef40f |
...
For a systems engineer, greenlion/php-sql-parser belongs in the PHP inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.7.0 | 2024-12-02T21:26:25+00:00 | [https://repo.packagist.org/p2/greenlion/php-sql-parser.json](https://repo.packagist.org/p2/greenlion/php-sql-parser.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/greenlion/php-sql-parser.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-0c1fdb365ef40f` from `packagist_search` as `registry_expansion`
