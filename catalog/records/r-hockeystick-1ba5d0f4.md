...
<!-- canonical: https://cran.r-project.org/web/packages/hockeystick/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hockeystick/index.html](https://cran.r-project.org/web/packages/hockeystick/index.html) |
| Source record ids | cran_packages_by_date-8fdf738229eb6b |

## System Engineer Summary

Download and Visualize Essential Global Heating Data

## Operational Role

For a systems engineer, hockeystick belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-28 09:50:16 UTC | [https://cran.r-project.org/web/packages/hockeystick/DESCRIPTION](https://cran.r-project.org/web/packages/hockeystick/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hockeystick/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8fdf738229eb6b` from `cran_packages_by_date` as `registry_expansion`
