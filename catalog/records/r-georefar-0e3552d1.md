...
<!-- canonical: https://cran.r-project.org/web/packages/georefar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/georefar/index.html](https://cran.r-project.org/web/packages/georefar/index.html) |
| Source record ids | cran_packages_by_date-c3a67e4cae2d7f |

## System Engineer Summary

Wrapper for the Argentine 'Georef' Geocoding API

## Operational Role

For a systems engineer, georefar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 09:20:02 UTC | [https://cran.r-project.org/web/packages/georefar/DESCRIPTION](https://cran.r-project.org/web/packages/georefar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/georefar/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-c3a67e4cae2d7f` from `cran_packages_by_date` as `registry_expansion`
