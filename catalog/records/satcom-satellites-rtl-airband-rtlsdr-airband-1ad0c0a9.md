...
| Source record ids | github_search_satcom_satellites-1e18b46895110c |
...
For a systems engineer, rtl-airband/RTLSDR-Airband belongs in the SatCom Satellites inventory as
...
- `github_search_satcom_satellites-1e18b46895110c` from `github_search_satcom_satellites` as `registry_expansion`
