...
| Source record ids | github_search_photography-0e467ec8f4bfc6 |

## System Engineer Summary

Open-source, self-hosted photo and video galleries for photographers and events, with client
proofing, password protection, guest uploads, custom branding and Docker deployment.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T13:44:08Z | gh search repos topic:photography stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-0e467ec8f4bfc6` from `github_search_photography` as `registry_expansion`
