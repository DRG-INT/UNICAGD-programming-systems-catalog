...
<!-- canonical: https://pypi.org/project/actx-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actx-cli/](https://pypi.org/project/actx-cli/) |
| Source record ids | pypi_simple-90736f7e35268b |

## System Engineer Summary

An open-source standard for AI project context.

## Operational Role

For a systems engineer, actx-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-03-26T03:53:42.475772Z | [https://pypi.org/pypi/actx-cli/json](https://pypi.org/pypi/actx-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actx-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-90736f7e35268b` from `pypi_simple` as `registry_expansion`
