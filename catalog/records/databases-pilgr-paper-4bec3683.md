...
<!-- canonical: https://github.com/pilgr/Paper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pilgr/Paper](https://github.com/pilgr/Paper) |
| Source record ids | github_search_databases-4a0bc9e5ebc65f |

## System Engineer Summary

Paper is a fast NoSQL-like storage for Java/Kotlin objects on Android with automatic schema
migration support.

## Operational Role

For a systems engineer, pilgr/Paper belongs in the Databases inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-06T22:00:05Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4a0bc9e5ebc65f` from `github_search_databases` as `registry_expansion`
