...
<!-- canonical: https://cocoapods.org/pods/Alamofire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/Alamofire](https://cocoapods.org/pods/Alamofire) |
| Source record ids | cocoapods_cdn-d2ca2f34cae153 |
...
For a systems engineer, Alamofire belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.12.0 | 2026-07-27 19:22:32 UTC | [https://trunk.cocoapods.org/api/v1/pods/Alamofire](https://trunk.cocoapods.org/api/v1/pods/Alamofire) |  |
| preview | known | 5.0.0-rc.3 | 2019-10-27 01:01:03 UTC | [https://trunk.cocoapods.org/api/v1/pods/Alamofire](https://trunk.cocoapods.org/api/v1/pods/Alamofire) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Alamofire` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-d2ca2f34cae153` from `cocoapods_cdn` as `registry_expansion`
