...
<!-- canonical: https://crates.io/crates/aws-lc-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-lc-sys](https://crates.io/crates/aws-lc-sys) |
| Source record ids | crates_io-ff78f7f308b1c1 |

## System Engineer Summary

AWS-LC is a general-purpose cryptographic library maintained by the AWS Cryptography team for AWS
and their customers. It іs based on code from the Google BoringSSL project and the OpenSSL project.

## Operational Role

For a systems engineer, aws-lc-sys belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.45.0 | 2026-09-01T13:00:11.051728Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-01T14:20:12+00:00`.
...
- `crates_io-ff78f7f308b1c1` from `crates_io` as `registry_expansion`
...
| better_scoped_tls | Cryptography | [open](rust-better-scoped-tls-8d69717a.md) |
