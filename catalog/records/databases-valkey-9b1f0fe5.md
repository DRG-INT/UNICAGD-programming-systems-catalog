...
| Source record ids | curated_database_systems-328aa8ab1a02c8 |

## System Engineer Summary

Open-source in-memory key/value datastore derived from Redis.

## Operational Role

For a systems engineer, Valkey belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-328aa8ab1a02c8` from `curated_database_systems` as `registry_expansion`
