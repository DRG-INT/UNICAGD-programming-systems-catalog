...
| Canonical URL | [https://crates.io/crates/nom_locate](https://crates.io/crates/nom_locate) |
| Source record ids | crates_io-31322c8de2395b |
...
For a systems engineer, nom_locate belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2025-02-03T18:29:55.942967Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-31322c8de2395b` from `crates_io` as `registry_expansion`
