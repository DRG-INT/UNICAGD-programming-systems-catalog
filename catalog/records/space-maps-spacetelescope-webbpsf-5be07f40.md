...
<!-- canonical: https://github.com/spacetelescope/webbpsf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spacetelescope/webbpsf](https://github.com/spacetelescope/webbpsf) |
| Source record ids | github_search_space_maps-4b48ce856d3cdc |
...
For a systems engineer, spacetelescope/webbpsf belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-02T16:51:26Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4b48ce856d3cdc` from `github_search_space_maps` as `registry_expansion`
