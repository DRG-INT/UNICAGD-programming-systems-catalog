...
<!-- canonical: https://github.com/fercasloz/sap_cap_java_btp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fercasloz/sap_cap_java_btp](https://github.com/fercasloz/sap_cap_java_btp) |
| Source record ids | github_search_sapjava-a04e735c088ec3 |

## System Engineer Summary

fercasloz/sap_cap_java_btp is tracked as a library record in the SAPJava branch. The source did not
...
For a systems engineer, fercasloz/sap_cap_java_btp belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-08T15:09:52Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-a04e735c088ec3` from `github_search_sapjava` as `registry_expansion`
