...
<!-- canonical: https://github.com/korlibs/korge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/korlibs/korge](https://github.com/korlibs/korge) |
| Source record ids | github_search_game_engines-0654477ff56003 |
...
For a systems engineer, korlibs/korge belongs in the Game Engines inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T08:14:44Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-0654477ff56003` from `github_search_game_engines` as `registry_expansion`
...
| playcanvas/engine | Interpreter Runtime | [open](game-engines-playcanvas-engine-124896fd.md) |
