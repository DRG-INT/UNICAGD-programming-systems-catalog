...
| Source record ids | github_search_radars-c25e8bd6ea4d09 |
...
For a systems engineer, kvos/CoastSat belongs in the Radars inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-05T13:54:15Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c25e8bd6ea4d09` from `github_search_radars` as `registry_expansion`
