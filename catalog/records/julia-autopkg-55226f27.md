...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Package Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/package-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AutoPkg](https://github.com/JuliaRegistries/General/tree/master/A/AutoPkg) |
| Source record ids | julia_general-f9c45589601acd |

## System Engineer Summary

Julia package registered in General at A/AutoPkg.

## Operational Role

For a systems engineer, AutoPkg belongs in the Julia inventory as part of dependency acquisition,
...
| Name | Category | Page |
| --- | --- | --- |
| AMLPipelineBase | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-amlpipelinebase-0d521acf.md) |
| AssetRegistry | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-assetregistry-bef07843.md) |
| AutoMLPipeline | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-automlpipeline-450f8c8b.md) |
| BrkgaMpIpr | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-brkgampipr-d28e5cc1.md) |
| BumplessPipeDreams | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bumplesspipedreams-70b9f0a5.md) |
| cargo_license_jll | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cargo-license-jll-1b5aaed9.md) |
| Pkg | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-pkg-2e2b5eea.md) |
