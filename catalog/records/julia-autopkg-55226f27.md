...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AutoPkg -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AutoPkg", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-f9c45589601acd` from `julia_general` as `registry_expansion`
...
| Pkg | Package Manager | [open](julia-pkg-2e2b5eea.md) |
