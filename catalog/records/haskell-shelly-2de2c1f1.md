...
<!-- canonical: https://hackage.haskell.org/package/shelly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shelly](https://hackage.haskell.org/package/shelly) |
| Source record ids | hackage_top_downloads-0106255ff9e533 |

## System Engineer Summary

Hackage package with 404 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, shelly belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12.1.1 | 2025-08-25T12:40:36Z | [https://hackage.haskell.org/package/shelly](https://hackage.haskell.org/package/shelly) |  |
| candidate | partial | 1.8.2 |  | [https://hackage.haskell.org/package/shelly](https://hackage.haskell.org/package/shelly) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/shelly` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-0106255ff9e533` from `hackage_top_downloads` as `registry_expansion`
