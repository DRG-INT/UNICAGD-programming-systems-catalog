...
<!-- canonical: https://www.npmjs.com/package/@earendil-works/pi-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@earendil-works/pi-server](https://www.npmjs.com/package/@earendil-works/pi-server) |
| Source record ids | npm_registry-88acf9b96fbf1c |
...
For a systems engineer, @earendil-works/pi-server belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.85.1 | 2026-09-05T12:04:16.414Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-88acf9b96fbf1c` from `npm_registry` as `registry_expansion`
