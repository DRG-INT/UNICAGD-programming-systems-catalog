...
<!-- canonical: https://github.com/AlexGladkov/Spacie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AlexGladkov/Spacie](https://github.com/AlexGladkov/Spacie) |
| Source record ids | github_search_space_maps-d062aad513c361 |

## System Engineer Summary

Native macOS disk space analyzer for Apple Silicon. Sunburst/treemap visualization, duplicate
finder, smart cleanup. Swift 6 + SwiftUI.

## Operational Role

For a systems engineer, AlexGladkov/Spacie belongs in the Space Maps inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-15T16:21:37Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d062aad513c361` from `github_search_space_maps` as `registry_expansion`
