...
<!-- canonical: https://github.com/questrail/keysight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/questrail/keysight](https://github.com/questrail/keysight) |
| Source record ids | github_search_electromagnetoscopes-ade7adff898684 |

## System Engineer Summary

Python package for working with Keysight/Agilent/HP test equipment.

## Operational Role

For a systems engineer, questrail/keysight belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T15:43:15Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-ade7adff898684` from `github_search_electromagnetoscopes` as `registry_expansion`
