...
<!-- canonical: https://cran.r-project.org/web/packages/text2map/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/text2map/index.html](https://cran.r-project.org/web/packages/text2map/index.html) |
| Source record ids | cran_packages_by_date-a86baf557e0821 |
...
For a systems engineer, text2map belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-15 11:00:02 UTC | [https://cran.r-project.org/web/packages/text2map/DESCRIPTION](https://cran.r-project.org/web/packages/text2map/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/text2map/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-a86baf557e0821` from `cran_packages_by_date` as `registry_expansion`
