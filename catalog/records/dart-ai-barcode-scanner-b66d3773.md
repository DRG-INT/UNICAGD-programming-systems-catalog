...
<!-- canonical: https://pub.dev/packages/ai_barcode_scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ai_barcode_scanner](https://pub.dev/packages/ai_barcode_scanner) |
| Source record ids | pub_dev-7d691416f91cb6 |
...
For a systems engineer, ai_barcode_scanner belongs in the Dart inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.0 | 2025-09-27T09:26:27.134359Z | [https://pub.dev/api/packages/ai_barcode_scanner](https://pub.dev/api/packages/ai_barcode_scanner) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ai_barcode_scanner` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-7d691416f91cb6` from `pub_dev` as `registry_expansion`
