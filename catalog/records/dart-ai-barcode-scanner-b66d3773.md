...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.1 | 2026-09-12T09:04:26.763388Z | [https://pub.dev/api/packages/ai_barcode_scanner](https://pub.dev/api/packages/ai_barcode_scanner) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ai_barcode_scanner` at `2026-09-12T10:18:48+00:00`.
