...
| Source record ids | github_search_webassembly-3fd4fc3220725d |
...
For a systems engineer, makepad/stitch belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-24T19:11:38Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-3fd4fc3220725d` from `github_search_webassembly` as `registry_expansion`
