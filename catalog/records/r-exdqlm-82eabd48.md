...
<!-- canonical: https://cran.r-project.org/web/packages/exdqlm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/exdqlm/index.html](https://cran.r-project.org/web/packages/exdqlm/index.html) |
| Source record ids | cran_packages_by_date-e3f78046ece89f |
...
For a systems engineer, exdqlm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-28 19:00:02 UTC | [https://cran.r-project.org/web/packages/exdqlm/DESCRIPTION](https://cran.r-project.org/web/packages/exdqlm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/exdqlm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e3f78046ece89f` from `cran_packages_by_date` as `registry_expansion`
