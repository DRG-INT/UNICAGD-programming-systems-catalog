...
| Source record ids | corpus-37a8aa0b16f90a |

## System Engineer Summary

FLTK is tracked as a visualization gui record in the C++23 branch. The source did not provide a long
...
For a systems engineer, FLTK belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-37a8aa0b16f90a` from `master_json` as `visualization_gui`
