...
| Canonical URL | [https://github.com/superstreamerapp/superstreamer](https://github.com/superstreamerapp/superstreamer) |
| Source record ids | github_search_video-1f9d5c816367bd |

## System Engineer Summary

An open, scalable, online streaming setup. All-in-one toolkit from ingest to adaptive video
playback. Built for developers in need of video tooling.

## Operational Role

For a systems engineer, superstreamerapp/superstreamer belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2025-02-22T10:03:08Z | [https://api.github.com/repos/superstreamerapp/superstreamer/releases/latest](https://api.github.com/repos/superstreamerapp/superstreamer/releases/latest) |  |
| preview | known | v0.0.1 | 2024-09-05T20:19:28Z | [https://api.github.com/repos/superstreamerapp/superstreamer/releases?per_page=10](https://api.github.com/repos/superstreamerapp/superstreamer/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/superstreamerapp/superstreamer/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-1f9d5c816367bd` from `github_search_video` as `registry_expansion`
