...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/language-dickinson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/language-dickinson](https://hackage.haskell.org/package/language-dickinson) |
| Source record ids | hackage_top_downloads-8372fca5bd7d07 |

## System Engineer Summary

Hackage package with 57 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, language-dickinson belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.3.1 | 2024-05-29T03:39:07Z | [https://hackage.haskell.org/package/language-dickinson](https://hackage.haskell.org/package/language-dickinson) |  |
| candidate | partial | 1.4.3.0 |  | [https://hackage.haskell.org/package/language-dickinson](https://hackage.haskell.org/package/language-dickinson) | hackage_candidate_date_missing |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/language-dickinson` at `2026-09-01T14:24:23+00:00`.
...
| --- | --- | --- | --- |
| hackage_top_downloads | registry-derived | 2026-09-07 | `{"kind": "hackage_top_downloads", "retrieved": "2026-09-07", "status": "registry-derived"}` |
...
- `hackage_top_downloads-8372fca5bd7d07` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| copilot-language | Language Specification | [open](haskell-copilot-language-8b8dd8fc.md) |
| haskell-language-server | Language Specification | [open](haskell-haskell-language-server-f76a78a4.md) |
| language-ats | Language Specification | [open](haskell-language-ats-602673bb.md) |
| language-c | Language Specification | [open](haskell-language-c-a79e97b2.md) |
| language-c-quote | Language Specification | [open](haskell-language-c-quote-f44b2168.md) |
| language-docker | Language Specification | [open](haskell-language-docker-44c5293b.md) |
| language-ecmascript | Language Specification | [open](haskell-language-ecmascript-952591f7.md) |
| language-javascript | Language Specification | [open](haskell-language-javascript-4e899615.md) |
