...
<!-- canonical: https://gitea.com/huangxinyu/devops-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/huangxinyu/devops-demo](https://gitea.com/huangxinyu/devops-demo) |
| Source record ids | gitea_repositories_api-757450376a9b00 |
...
For a systems engineer, Gitea: huangxinyu/devops-demo belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-24T01:49:28Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-757450376a9b00` from `gitea_repositories_api` as `registry_expansion`
