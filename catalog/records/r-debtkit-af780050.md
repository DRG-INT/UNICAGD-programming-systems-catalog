...
<!-- canonical: https://cran.r-project.org/web/packages/debtkit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/debtkit/index.html](https://cran.r-project.org/web/packages/debtkit/index.html) |
| Source record ids | cran_packages_by_date-1227bb7f163501 |
...
For a systems engineer, debtkit belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-08 07:20:16 UTC | [https://cran.r-project.org/web/packages/debtkit/DESCRIPTION](https://cran.r-project.org/web/packages/debtkit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/debtkit/DESCRIPTION` at `2026-09-08T08:22:37+00:00`.
...
- `cran_packages_by_date-1227bb7f163501` from `cran_packages_by_date` as `registry_expansion`
