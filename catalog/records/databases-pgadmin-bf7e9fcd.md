...
| Canonical URL | [https://www.pgadmin.org/](https://www.pgadmin.org/) |
| Source record ids | curated_database_systems-1d64f543061219, awesome_list-1d64f543061219 |

## System Engineer Summary

PostgreSQL administration and dashboard tool.

## Operational Role

For a systems engineer, pgAdmin belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-1d64f543061219` from `curated_database_systems` as `registry_expansion`
- `awesome_list-1d64f543061219` from `awesome_list` as `registry_expansion`
