...
<!-- canonical: https://github.com/2ndQuadrant/bdr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2ndQuadrant/bdr](https://github.com/2ndQuadrant/bdr) |
| Source record ids | awesome_list-eeb720cd65fa48 |

## System Engineer Summary

BiDirectional Replication - a multimaster replication system for PostgreSQL

## Operational Role

For a systems engineer, BDR belongs in the Databases inventory as part of language tooling, code
...
- `awesome_list-eeb720cd65fa48` from `awesome_list` as `registry_expansion`
