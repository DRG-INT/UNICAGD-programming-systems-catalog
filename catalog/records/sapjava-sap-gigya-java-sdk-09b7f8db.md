...
[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/SAP/gigya-java-sdk](https://github.com/SAP/gigya-java-sdk) |
| Source record ids | github_search_sapjava-2f0157e9ba6d7a |

## System Engineer Summary

SAP CDC (Gigya) java sdk for server

## Operational Role

For a systems engineer, SAP/gigya-java-sdk belongs in the SAPJava inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.1 | 2024-12-31T09:14:58Z | [https://api.github.com/repos/SAP/gigya-java-sdk/releases/latest](https://api.github.com/repos/SAP/gigya-java-sdk/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SAP/gigya-java-sdk/releases/latest` at `2026-09-01T10:25:36+00:00`.
...
- `github_search_sapjava-2f0157e9ba6d7a` from `github_search_sapjava` as `registry_expansion`
