...
<!-- canonical: https://crates.io/crates/anes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/anes](https://crates.io/crates/anes) |
| Source record ids | crates_io-49455398b7173e |
...
For a systems engineer, anes belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2025-07-01T14:49:33.393964Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-49455398b7173e` from `crates_io` as `registry_expansion`
