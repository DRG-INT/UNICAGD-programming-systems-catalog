...
<!-- canonical: https://github.com/D-plus/Star-Wars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/D-plus/Star-Wars](https://github.com/D-plus/Star-Wars) |
| Source record ids | github_search_space_maps-b4b34bf7cf0aef |

## System Engineer Summary

Catalog of all the people in Star Wars history, where you can search, filter and look at their
profile information

## Operational Role

For a systems engineer, D-plus/Star-Wars belongs in the Space Maps inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-07T12:47:11Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b4b34bf7cf0aef` from `github_search_space_maps` as `registry_expansion`
