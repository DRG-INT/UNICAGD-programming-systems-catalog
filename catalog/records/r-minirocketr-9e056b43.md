...
<!-- canonical: https://cran.r-project.org/web/packages/minirocketR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/minirocketR/index.html](https://cran.r-project.org/web/packages/minirocketR/index.html) |
| Source record ids | cran_packages_by_date-f5146120d874f9 |
...
For a systems engineer, minirocketR belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 12:30:25 UTC | [https://cran.r-project.org/web/packages/minirocketR/DESCRIPTION](https://cran.r-project.org/web/packages/minirocketR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/minirocketR/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-f5146120d874f9` from `cran_packages_by_date` as `registry_expansion`
