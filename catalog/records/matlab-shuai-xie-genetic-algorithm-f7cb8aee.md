...
<!-- canonical: https://github.com/Shuai-Xie/genetic-algorithm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Shuai-Xie/genetic-algorithm](https://github.com/Shuai-Xie/genetic-algorithm) |
| Source record ids | github_search_matlab-15a79d943e4207 |

## System Engineer Summary

Shuai-Xie/genetic-algorithm is tracked as a language specification record in the Matlab branch. The
...
For a systems engineer, Shuai-Xie/genetic-algorithm belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-08-05T18:20:10Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-15a79d943e4207` from `github_search_matlab` as `registry_expansion`
