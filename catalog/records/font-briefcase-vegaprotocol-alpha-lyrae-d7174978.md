...
<!-- canonical: https://github.com/vegaprotocol/alpha-lyrae -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vegaprotocol/alpha-lyrae](https://github.com/vegaprotocol/alpha-lyrae) |
| Source record ids | github_search_font_briefcase-1721deb60c66fd |

## System Engineer Summary

The Vega font - uses Ligatures & Contextual Alternates to add a little glitch to your world

## Operational Role

For a systems engineer, vegaprotocol/alpha-lyrae belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-23T09:37:01Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-1721deb60c66fd` from `github_search_font_briefcase` as `registry_expansion`
