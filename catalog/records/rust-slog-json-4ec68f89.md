...
| Canonical URL | [https://crates.io/crates/slog-json](https://crates.io/crates/slog-json) |
| Source record ids | crates_io-7c82f27d1d95c4 |

## System Engineer Summary

slog-json is tracked as a serialization record in the Rust branch. The source did not provide a long
...
For a systems engineer, slog-json belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.1 | 2022-03-21T18:11:23.119992Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-7c82f27d1d95c4` from `crates_io` as `registry_expansion`
