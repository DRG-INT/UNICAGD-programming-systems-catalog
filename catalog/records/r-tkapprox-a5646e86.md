...
<!-- canonical: https://cran.r-project.org/web/packages/TKApprox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TKApprox/index.html](https://cran.r-project.org/web/packages/TKApprox/index.html) |
| Source record ids | cran_packages_by_date-07cc04b7791881 |
...
For a systems engineer, TKApprox belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 20:00:02 UTC | [https://cran.r-project.org/web/packages/TKApprox/DESCRIPTION](https://cran.r-project.org/web/packages/TKApprox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TKApprox/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-07cc04b7791881` from `cran_packages_by_date` as `registry_expansion`
