...
<!-- canonical: https://pypi.org/project/adnotatio-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adnotatio-server/](https://pypi.org/project/adnotatio-server/) |
| Source record ids | pypi_simple-a3f2895a65517b |
...
For a systems engineer, adnotatio-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2021-01-06T20:14:33.094335Z | [https://pypi.org/pypi/adnotatio-server/json](https://pypi.org/pypi/adnotatio-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adnotatio-server/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-a3f2895a65517b` from `pypi_simple` as `registry_expansion`
