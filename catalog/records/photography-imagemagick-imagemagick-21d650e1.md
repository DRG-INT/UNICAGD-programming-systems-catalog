...
<!-- canonical: https://github.com/ImageMagick/ImageMagick -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick) |
| Source record ids | github_search_photography-3cebcae5adb260 |

## System Engineer Summary

ImageMagick is a free, open-source software suite for creating, editing, converting, and displaying
images. It supports 200+ formats and offers powerful command-line tools and APIs for automation,
scripting, and integration across platforms.

## Operational Role

For a systems engineer, ImageMagick/ImageMagick belongs in the Photography inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:08:44Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-3cebcae5adb260` from `github_search_photography` as `registry_expansion`
