...
<!-- canonical: https://github.com/valence-rs/valence -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/valence-rs/valence](https://github.com/valence-rs/valence) |
| Source record ids | github_search_game_engines-5e4d64c19b13c2 |
...
For a systems engineer, valence-rs/valence belongs in the Game Engines inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-15T05:25:50Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-5e4d64c19b13c2` from `github_search_game_engines` as `registry_expansion`
