...
<!-- canonical: https://search.nixos.org/options -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://search.nixos.org/options](https://search.nixos.org/options) |
| Source record ids | curated_language_routes-ef22f3c569abc7 |

## System Engineer Summary

Official NixOS option search interface for declarative system configuration.

## Operational Role

For a systems engineer, NixOS Options Search belongs in the nix inventory as part of ecosystem
...
- `curated_language_routes-ef22f3c569abc7` from `curated_language_routes` as `registry_expansion`
