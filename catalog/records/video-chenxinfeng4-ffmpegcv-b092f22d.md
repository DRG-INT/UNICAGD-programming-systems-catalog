...
<!-- canonical: https://github.com/chenxinfeng4/ffmpegcv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chenxinfeng4/ffmpegcv](https://github.com/chenxinfeng4/ffmpegcv) |
| Source record ids | github_search_video-bbe87225ead5db |
...
For a systems engineer, chenxinfeng4/ffmpegcv belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-26T08:35:12Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-bbe87225ead5db` from `github_search_video` as `registry_expansion`
