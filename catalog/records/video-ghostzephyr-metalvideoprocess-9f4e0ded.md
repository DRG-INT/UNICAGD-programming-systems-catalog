...
<!-- canonical: https://github.com/GhostZephyr/MetalVideoProcess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GhostZephyr/MetalVideoProcess](https://github.com/GhostZephyr/MetalVideoProcess) |
| Source record ids | github_search_video-8be51cafa55b9d |

## System Engineer Summary

MetalVideoProcess is a High-Performance video effects processing framework. It's base on GPUImage3
Metal, support asynchronous and multithread processing.

## Operational Role

For a systems engineer, GhostZephyr/MetalVideoProcess belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-16T06:36:56Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-8be51cafa55b9d` from `github_search_video` as `registry_expansion`
