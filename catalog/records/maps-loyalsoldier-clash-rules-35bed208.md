...
<!-- canonical: https://github.com/Loyalsoldier/clash-rules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Loyalsoldier/clash-rules](https://github.com/Loyalsoldier/clash-rules) |
| Source record ids | github_search_maps-654694dac79d92 |
...
For a systems engineer, Loyalsoldier/clash-rules belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 202609010121 | 2026-09-01T01:21:45Z | [https://api.github.com/repos/Loyalsoldier/clash-rules/releases/latest](https://api.github.com/repos/Loyalsoldier/clash-rules/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Loyalsoldier/clash-rules/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-654694dac79d92` from `github_search_maps` as `registry_expansion`
