...
| Canonical URL | [https://github.com/WasmEdge/WasmEdge](https://github.com/WasmEdge/WasmEdge) |
| Source record ids | github_search_webassembly-4f447affd9278c |

## System Engineer Summary

WasmEdge is a lightweight, high-performance, and extensible WebAssembly runtime for cloud native,
edge, and decentralized applications. It powers serverless apps, embedded functions, microservices,
smart contracts, and IoT devices.

## Operational Role

For a systems engineer, WasmEdge/WasmEdge belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.1 | 2026-07-06T12:43:02Z | [https://api.github.com/repos/WasmEdge/WasmEdge/releases/latest](https://api.github.com/repos/WasmEdge/WasmEdge/releases/latest) |  |
| preview | known | 0.18.0-alpha.1 | 2026-08-28T13:37:34Z | [https://api.github.com/repos/WasmEdge/WasmEdge/releases?per_page=10](https://api.github.com/repos/WasmEdge/WasmEdge/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/WasmEdge/WasmEdge/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-4f447affd9278c` from `github_search_webassembly` as `registry_expansion`
