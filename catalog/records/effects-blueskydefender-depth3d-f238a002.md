...
<!-- canonical: https://github.com/BlueSkyDefender/Depth3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BlueSkyDefender/Depth3D](https://github.com/BlueSkyDefender/Depth3D) |
| Source record ids | github_search_effects-d18e2dbaf82602 |
...
For a systems engineer, BlueSkyDefender/Depth3D belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-28T10:07:10Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-d18e2dbaf82602` from `github_search_effects` as `registry_expansion`
