...
<!-- canonical: https://cran.r-project.org/web/packages/dtlog/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dtlog/index.html](https://cran.r-project.org/web/packages/dtlog/index.html) |
| Source record ids | cran_packages_by_date-9309d1d05ceded |
...
For a systems engineer, dtlog belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 10:50:27 UTC | [https://cran.r-project.org/web/packages/dtlog/DESCRIPTION](https://cran.r-project.org/web/packages/dtlog/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dtlog/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-9309d1d05ceded` from `cran_packages_by_date` as `registry_expansion`
