...
<!-- canonical: https://github.com/JaysonBucket/NewsCommander -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JaysonBucket/NewsCommander](https://github.com/JaysonBucket/NewsCommander) |
| Source record ids | github_search_repertoare_catalogs-7694c6ecb570e5 |

## System Engineer Summary

A personal news-triage Cowork Custom Skill for the Microsoft ecosystem. One curated catalog, topic-
scored, deduplicated, one digest per day.

## Operational Role

For a systems engineer, JaysonBucket/NewsCommander belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-28T23:50:57Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-7694c6ecb570e5` from `github_search_repertoare_catalogs` as `registry_expansion`
