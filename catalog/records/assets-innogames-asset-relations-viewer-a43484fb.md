...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/innogames/asset-relations-viewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/innogames/asset-relations-viewer](https://github.com/innogames/asset-relations-viewer) |
| Source record ids | github_search_assets-7897d7ab357e74 |

## System Engineer Summary

Plugin to display dependencies between assets, files, assetgroups, etc. in a tree based view within
the Unity editor.

## Operational Role

For a systems engineer, innogames/asset-relations-viewer belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-15T09:46:13Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-7897d7ab357e74` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Unity Addressables | Dependency Manager | [open](assets-unity-addressables-03211f2d.md) |
