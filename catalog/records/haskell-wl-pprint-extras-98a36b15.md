...
<!-- canonical: https://hackage.haskell.org/package/wl-pprint-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wl-pprint-extras](https://hackage.haskell.org/package/wl-pprint-extras) |
| Source record ids | hackage_top_downloads-d4f77996c04d7e |
...
For a systems engineer, wl-pprint-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.0.5 | 2015-06-09T23:21:22Z | [https://hackage.haskell.org/package/wl-pprint-extras](https://hackage.haskell.org/package/wl-pprint-extras) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wl-pprint-extras` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-d4f77996c04d7e` from `hackage_top_downloads` as `registry_expansion`
