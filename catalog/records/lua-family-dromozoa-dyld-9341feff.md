...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-dyld -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-dyld](https://luarocks.org/modules/moyu/dromozoa-dyld) |
| Source record ids | luarocks_root_manifest-4ac98241f810ea |

## System Engineer Summary

dromozoa-dyld is tracked as an utility library record in the Lua family branch. The source did not
...
For a systems engineer, dromozoa-dyld belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4ac98241f810ea` from `luarocks_root_manifest` as `registry_expansion`
