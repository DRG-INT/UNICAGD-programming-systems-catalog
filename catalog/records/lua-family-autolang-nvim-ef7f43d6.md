...
<!-- canonical: https://luarocks.org/modules/suderio/autolang.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/suderio/autolang.nvim](https://luarocks.org/modules/suderio/autolang.nvim) |
| Source record ids | luarocks_root_manifest-3214862edc9b97 |

## System Engineer Summary

A very simple language detector neovim plugin

## Operational Role

For a systems engineer, autolang.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3214862edc9b97` from `luarocks_root_manifest` as `registry_expansion`
