...
<!-- canonical: https://pypi.org/project/a2a-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2a-mcp-server/](https://pypi.org/project/a2a-mcp-server/) |
| Source record ids | pypi_simple-7b7f8dc840d18a |
...
For a systems engineer, a2a-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2025-06-18T07:23:41.953142Z | [https://pypi.org/pypi/a2a-mcp-server/json](https://pypi.org/pypi/a2a-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2a-mcp-server/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-7b7f8dc840d18a` from `pypi_simple` as `registry_expansion`
...
| aa-mcp-server | Web Framework | [open](python-aa-mcp-server-96792d67.md) |
