...
<!-- canonical: https://github.com/maclifevn/MClean -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maclifevn/MClean](https://github.com/maclifevn/MClean) |
| Source record ids | github_search_space_maps-acae31ee4eeec8 |

## System Engineer Summary

Free, open-source macOS app manager & system cleaner with Space Lens disk visualizer

## Operational Role

For a systems engineer, maclifevn/MClean belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T04:48:38Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Other; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-acae31ee4eeec8` from `github_search_space_maps` as `registry_expansion`
