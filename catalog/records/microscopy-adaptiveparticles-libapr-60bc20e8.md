...
<!-- canonical: https://github.com/AdaptiveParticles/LibAPR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AdaptiveParticles/LibAPR](https://github.com/AdaptiveParticles/LibAPR) |
| Source record ids | github_search_microscopy-9c47221e277695 |
...
For a systems engineer, AdaptiveParticles/LibAPR belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-20T12:27:29Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-06 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:microscopy stars:>20", "retrieved": "2026-09-06", "status": "forge-cli-derived"}` |
...
- `github_search_microscopy-9c47221e277695` from `github_search_microscopy` as `registry_expansion`
...
| ariel-waisman/LabelsToROIs | Filesystem Os | [open](microscopy-ariel-waisman-labelstorois-70803f22.md) |
