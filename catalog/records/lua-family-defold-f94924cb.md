...
| Source record ids | corpus-7db5732b62c5e9 |

## System Engineer Summary

Defold is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, Defold belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-7db5732b62c5e9` from `master_json` as `game_engine_game_dev`
