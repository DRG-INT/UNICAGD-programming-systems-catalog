...
| Canonical URL | [https://crates.io/crates/libflate](https://crates.io/crates/libflate) |
| Source record ids | crates_io-9d3b21490676b1 |
...
For a systems engineer, libflate belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-07-25T12:43:50.662287Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-9d3b21490676b1` from `crates_io` as `registry_expansion`
