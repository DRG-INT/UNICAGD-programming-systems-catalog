...
<!-- canonical: https://hackage.haskell.org/package/wai-websockets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/wai-websockets](https://hackage.haskell.org/package/wai-websockets) |
| Source record ids | hackage_top_downloads-c1d6ad5db01ca2 |
...
For a systems engineer, wai-websockets belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1.2 | 2018-03-19T12:32:07Z | [https://hackage.haskell.org/package/wai-websockets](https://hackage.haskell.org/package/wai-websockets) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/wai-websockets` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-c1d6ad5db01ca2` from `hackage_top_downloads` as `registry_expansion`
