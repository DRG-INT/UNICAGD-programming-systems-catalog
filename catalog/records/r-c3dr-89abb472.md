...
<!-- canonical: https://cran.r-project.org/web/packages/c3dr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/c3dr/index.html](https://cran.r-project.org/web/packages/c3dr/index.html) |
| Source record ids | cran_packages_by_date-cde439d8b3cc73 |
...
For a systems engineer, c3dr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-11 11:40:11 UTC | [https://cran.r-project.org/web/packages/c3dr/DESCRIPTION](https://cran.r-project.org/web/packages/c3dr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/c3dr/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-cde439d8b3cc73` from `cran_packages_by_date` as `registry_expansion`
