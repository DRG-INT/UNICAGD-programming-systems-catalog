...
<!-- canonical: https://github.com/rafabelokurows/staRmaps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rafabelokurows/staRmaps](https://github.com/rafabelokurows/staRmaps) |
| Source record ids | github_search_space_maps-5089081265cbe7 |

## System Engineer Summary

Plotting map of the skies with R

## Operational Role

For a systems engineer, rafabelokurows/staRmaps belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-03T21:15:02Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5089081265cbe7` from `github_search_space_maps` as `registry_expansion`
