...
<!-- canonical: https://github.com/mafiosnik777/enhancr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mafiosnik777/enhancr](https://github.com/mafiosnik777/enhancr) |
| Source record ids | github_search_video-bb04540dc1e454 |

## System Engineer Summary

Video Frame Interpolation & Super Resolution using NVIDIA's TensorRT & Tencent's NCNN inference,
beautifully crafted and packaged into a single app

## Operational Role

For a systems engineer, mafiosnik777/enhancr belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-15T16:08:08Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-bb04540dc1e454` from `github_search_video` as `registry_expansion`
