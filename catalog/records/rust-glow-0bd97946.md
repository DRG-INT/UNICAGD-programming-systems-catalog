...
<!-- canonical: https://crates.io/crates/glow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/glow](https://crates.io/crates/glow) |
| Source record ids | crates_io-5fc1b4eed7ba75 |

## System Engineer Summary

GL on Whatever: a set of bindings to run GL (Open GL, OpenGL ES, and WebGL) anywhere, and avoid
target-specific code.

## Operational Role

For a systems engineer, glow belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.0 | 2026-07-09T03:15:20.938802Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
