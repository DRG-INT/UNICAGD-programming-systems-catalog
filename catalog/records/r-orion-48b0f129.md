...
<!-- canonical: https://cran.r-project.org/web/packages/ORION/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ORION/index.html](https://cran.r-project.org/web/packages/ORION/index.html) |
| Source record ids | cran_packages_by_date-e7b23a96de908b |

## System Engineer Summary

ORION is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, ORION belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-24 12:30:02 UTC | [https://cran.r-project.org/web/packages/ORION/DESCRIPTION](https://cran.r-project.org/web/packages/ORION/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ORION/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e7b23a96de908b` from `cran_packages_by_date` as `registry_expansion`
