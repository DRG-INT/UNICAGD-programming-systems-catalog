...
<!-- canonical: https://cran.r-project.org/web/packages/autodb/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autodb/index.html](https://cran.r-project.org/web/packages/autodb/index.html) |
| Source record ids | cran_packages_by_date-cccb46e9c668ce |
...
For a systems engineer, autodb belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.1 | 2026-08-21 13:40:33 UTC | [https://cran.r-project.org/web/packages/autodb/DESCRIPTION](https://cran.r-project.org/web/packages/autodb/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autodb/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cccb46e9c668ce` from `cran_packages_by_date` as `registry_expansion`
