...
<!-- canonical: https://github.com/CAIDA/walrus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CAIDA/walrus](https://github.com/CAIDA/walrus) |
| Source record ids | github_search_space_maps-1572a9fadd10d9 |

## System Engineer Summary

tool for interactively visualizing large directed graphs in three-dimensional hyperbolic space

## Operational Role

For a systems engineer, CAIDA/walrus belongs in the Space Maps inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-08-31T17:45:48Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-1572a9fadd10d9` from `github_search_space_maps` as `registry_expansion`
