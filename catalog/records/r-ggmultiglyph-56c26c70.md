...
<!-- canonical: https://cran.r-project.org/web/packages/ggmultiglyph/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggmultiglyph/index.html](https://cran.r-project.org/web/packages/ggmultiglyph/index.html) |
| Source record ids | cran_packages_by_date-eec7ebf1cbd447 |
...
For a systems engineer, ggmultiglyph belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 13:50:03 UTC | [https://cran.r-project.org/web/packages/ggmultiglyph/DESCRIPTION](https://cran.r-project.org/web/packages/ggmultiglyph/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggmultiglyph/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-eec7ebf1cbd447` from `cran_packages_by_date` as `registry_expansion`
