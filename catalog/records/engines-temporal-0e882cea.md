...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-5d8592e16f9d9f |

## System Engineer Summary

Durable workflow engine for long-running services, retries, activities, signals, schedules, and
distributed execution.

## Operational Role

For a systems engineer, Temporal belongs in the Engines inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.31.2 | 2026-07-08T17:10:11Z | [https://api.github.com/repos/temporalio/temporal/releases/latest](https://api.github.com/repos/temporalio/temporal/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/temporalio/temporal/releases/latest` at `2026-09-01T07:24:40+00:00`.
...
- `curated_language_routes-5d8592e16f9d9f` from `curated_language_routes` as `registry_expansion`
