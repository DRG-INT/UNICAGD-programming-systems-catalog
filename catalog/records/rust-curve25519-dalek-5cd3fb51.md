...
<!-- canonical: https://crates.io/crates/curve25519-dalek -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/curve25519-dalek](https://crates.io/crates/curve25519-dalek) |
| Source record ids | crates_io-c1e985883f2d0c |
...
For a systems engineer, curve25519-dalek belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-07-06T16:22:48.020142Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c1e985883f2d0c` from `crates_io` as `registry_expansion`
