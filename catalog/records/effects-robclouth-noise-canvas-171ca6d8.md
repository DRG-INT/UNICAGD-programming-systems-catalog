...
<!-- canonical: https://github.com/robclouth/noise-canvas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/robclouth/noise-canvas](https://github.com/robclouth/noise-canvas) |
| Source record ids | github_search_effects-32dfd768cfbbd4 |

## System Engineer Summary

Noise Canvas is a sound design tool in which you paint sounds or effects directly into a
spectrogram. Kind of like Photoshop but for sound. Free download for Mac, Windows and Linux.

## Operational Role

For a systems engineer, robclouth/noise-canvas belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T09:29:49Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-32dfd768cfbbd4` from `github_search_effects` as `registry_expansion`
