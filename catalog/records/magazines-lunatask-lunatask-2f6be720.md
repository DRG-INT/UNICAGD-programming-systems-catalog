...
<!-- canonical: https://github.com/lunatask/lunatask -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lunatask/lunatask](https://github.com/lunatask/lunatask) |
| Source record ids | github_search_magazines-21af6f6237c1d1 |

## System Engineer Summary

Lunatask is an all-in-one encrypted to-do list, habit tracker, journaling, life-tracking and notes
app. It remembers stuff for you and keeps track of your mental well-being 🌟

## Operational Role

For a systems engineer, lunatask/lunatask belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T21:01:27Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-21af6f6237c1d1` from `github_search_magazines` as `registry_expansion`
