...
<!-- canonical: https://pub.dev/packages/arkit_plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/arkit_plugin](https://pub.dev/packages/arkit_plugin) |
| Source record ids | pub_dev-3cff2a734df76b |

## System Engineer Summary

Flutter Plugin for ARKit - Apple's augmented reality (AR) development platform for iOS mobile
devices.

## Operational Role

For a systems engineer, arkit_plugin belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-08-03T18:29:00.381474Z | [https://pub.dev/api/packages/arkit_plugin](https://pub.dev/api/packages/arkit_plugin) |  |
| preview | known | 1.0.0-nullsafety.0 | 2021-05-22T10:41:21.333513Z | [https://pub.dev/api/packages/arkit_plugin](https://pub.dev/api/packages/arkit_plugin) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/arkit_plugin` at `2026-09-01T07:20:16+00:00`.
...
- `pub_dev-3cff2a734df76b` from `pub_dev` as `registry_expansion`
