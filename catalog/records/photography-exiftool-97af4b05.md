...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://exiftool.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://exiftool.org/](https://exiftool.org/) |
| Source record ids | curated_language_routes-2bce6504700731 |

## System Engineer Summary

Metadata extraction and writing tool for images, camera RAW files, video, geotags, and asset
management.

## Operational Role

For a systems engineer, ExifTool belongs in the Photography inventory as part of ecosystem
...
- `curated_language_routes-2bce6504700731` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cbassa/sattools | Utility Library | [open](photography-cbassa-sattools-c329b908.md) |
| kaeldrin-gh/HDR-Gamma-Fix | Utility Library | [open](photography-kaeldrin-gh-hdr-gamma-fix-403dab7d.md) |
