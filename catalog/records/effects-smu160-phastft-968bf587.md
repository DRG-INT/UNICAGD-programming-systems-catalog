...
<!-- canonical: https://github.com/smu160/PhastFT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/smu160/PhastFT](https://github.com/smu160/PhastFT) |
| Source record ids | github_search_effects-f2a7424c05902b |
...
For a systems engineer, smu160/PhastFT belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T22:26:02Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f2a7424c05902b` from `github_search_effects` as `registry_expansion`
...
| diwi/PixelFlow | Benchmarking | [open](effects-diwi-pixelflow-81d2b932.md) |
