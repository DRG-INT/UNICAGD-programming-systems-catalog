...
<!-- canonical: https://github.com/weisongwen/UrbanNavDataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/weisongwen/UrbanNavDataset](https://github.com/weisongwen/UrbanNavDataset) |
| Source record ids | github_search_radars-ce709c8db5a829 |

## System Engineer Summary

UrbanNav: an Open-Sourcing Localization Data Collected in Asian Urban Canyons, Including Tokyo and
Hong Kong

## Operational Role

For a systems engineer, weisongwen/UrbanNavDataset belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-21T08:28:20Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-ce709c8db5a829` from `github_search_radars` as `registry_expansion`
