...
<!-- canonical: https://www.npmjs.com/package/apollo-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/apollo-language-server](https://www.npmjs.com/package/apollo-language-server) |
| Source record ids | npm_registry-7cca2b46c1c475 |
...
For a systems engineer, apollo-language-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.9 | 2022-05-04T04:42:28.070Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-7cca2b46c1c475` from `npm_registry` as `registry_expansion`
