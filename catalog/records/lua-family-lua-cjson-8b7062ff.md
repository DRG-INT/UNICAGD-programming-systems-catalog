...
| Source record ids | corpus-586b887ca499b8 |

## System Engineer Summary

lua-cjson is tracked as a serialization record in the Lua family branch. The source did not provide
...
For a systems engineer, lua-cjson belongs in the Lua family inventory as part of wire formats,
...
- `corpus-586b887ca499b8` from `master_json` as `serialization`
