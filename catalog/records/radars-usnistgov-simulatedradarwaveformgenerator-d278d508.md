...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/usnistgov/SimulatedRadarWaveformGenerator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/usnistgov/SimulatedRadarWaveformGenerator](https://github.com/usnistgov/SimulatedRadarWaveformGenerator) |
| Source record ids | github_search_radars-25db3f05ce2525 |

## System Engineer Summary

A software tool that generates simulated radar signals and creates RF datasets for developing and
testing machine/deep learning detection algorithms.

## Operational Role

For a systems engineer, usnistgov/SimulatedRadarWaveformGenerator belongs in the Radars inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | V1.1 | 2021-05-10T15:44:50Z | [https://api.github.com/repos/usnistgov/SimulatedRadarWaveformGenerator/releases/latest](https://api.github.com/repos/usnistgov/SimulatedRadarWaveformGenerator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/usnistgov/SimulatedRadarWaveformGenerator/releases/latest` at `2026-09-01T08:26:32+00:00`.
...
- `github_search_radars-25db3f05ce2525` from `github_search_radars` as `registry_expansion`
