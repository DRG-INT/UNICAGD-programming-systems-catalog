...
<!-- canonical: https://github.com/yigithanmehmetkose/ODREC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yigithanmehmetkose/ODREC](https://github.com/yigithanmehmetkose/ODREC) |
| Source record ids | github_search_space_engines-2dba8485985bf1 |

## System Engineer Summary

A tool for preliminary design and regenerative cooling modelling of liquid propellant rocket engines

## Operational Role

For a systems engineer, yigithanmehmetkose/ODREC belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-25T16:14:20Z | gh search repos topic:rocket-engine stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-2dba8485985bf1` from `github_search_space_engines` as `registry_expansion`
