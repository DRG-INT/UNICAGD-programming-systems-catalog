...
<!-- canonical: https://www.nuget.org/packages/Microsoft.Kiota.Http.HttpClientLibrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Kiota.Http.HttpClientLibrary](https://www.nuget.org/packages/Microsoft.Kiota.Http.HttpClientLibrary) |
| Source record ids | nuget_search-8f397333c1ed84 |
...
For a systems engineer, Microsoft.Kiota.Http.HttpClientLibrary belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-05-06T23:50:54.197+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.kiota.http.httpclientlibrary/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.kiota.http.httpclientlibrary/index.json) |  |
| preview | known | 1.9.8-preview | 2024-07-09T06:31:33.51+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.kiota.http.httpclientlibrary/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.kiota.http.httpclientlibrary/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; The Unlicense; https://api.github.com/licenses/unlicense; MIT; https://www.nuget.org/packages/Microsoft.Kiota.Http.HttpClientLibrary/2.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.kiota.http.httpclientlibrary/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-8f397333c1ed84` from `nuget_search` as `registry_expansion`
