...
<!-- canonical: https://cran.r-project.org/web/packages/strategyr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/strategyr/index.html](https://cran.r-project.org/web/packages/strategyr/index.html) |
| Source record ids | cran_packages_by_date-c8a9af31ef1e27 |

## System Engineer Summary

Execution-Oriented Strategy Workflows for Dynamic Trading Decisions

## Operational Role

For a systems engineer, strategyr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7.1 | 2026-09-12 13:30:02 UTC | [https://cran.r-project.org/web/packages/strategyr/DESCRIPTION](https://cran.r-project.org/web/packages/strategyr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/strategyr/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-c8a9af31ef1e27` from `cran_packages_by_date` as `registry_expansion`
