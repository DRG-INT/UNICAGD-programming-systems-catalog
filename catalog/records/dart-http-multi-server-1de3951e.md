...
<!-- canonical: https://pub.dev/packages/http_multi_server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/http_multi_server](https://pub.dev/packages/http_multi_server) |
| Source record ids | pub_dev-846b948df12fcf |
...
For a systems engineer, http_multi_server belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2024-12-17T12:50:20.600442Z | [https://pub.dev/api/packages/http_multi_server](https://pub.dev/api/packages/http_multi_server) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/http_multi_server` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-846b948df12fcf` from `pub_dev` as `registry_expansion`
