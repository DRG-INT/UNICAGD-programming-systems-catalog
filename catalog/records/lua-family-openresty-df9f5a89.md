...
| Source record ids | lua-source-19 |

## System Engineer Summary

OpenResty is tracked as an other record in the Lua family branch. The source did not provide a long
...
For a systems engineer, OpenResty belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 19}}` |
...
- `lua-source-19` from `master_json` as `source_list_item`
