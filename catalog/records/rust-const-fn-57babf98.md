...
<!-- canonical: https://crates.io/crates/const_fn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/const_fn](https://crates.io/crates/const_fn) |
| Source record ids | crates_io-f394c99610e35c |
...
For a systems engineer, const_fn belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.12 | 2026-03-03T15:35:19.938934Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-f394c99610e35c` from `crates_io` as `registry_expansion`
