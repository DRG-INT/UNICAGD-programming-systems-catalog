...
<!-- canonical: https://github.com/apdevelop/tile-map-service -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apdevelop/tile-map-service](https://github.com/apdevelop/tile-map-service) |
| Source record ids | github_search_maps-01b532c4eb0a20 |

## System Engineer Summary

Tile server for .NET8 with MBTiles, Filesystem, GeoTIFF, HTTP sources and XYZ, TMS, WMTS, WMS
endpoints (protocols support) and various output formats

## Operational Role

For a systems engineer, apdevelop/tile-map-service belongs in the Maps inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-05T06:12:32Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-01b532c4eb0a20` from `github_search_maps` as `registry_expansion`
...
| sasgis/sas.planet.src | Formatter | [open](maps-sasgis-sas-planet-src-337db903.md) |
