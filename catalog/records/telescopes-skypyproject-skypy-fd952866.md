...
<!-- canonical: https://github.com/skypyproject/skypy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skypyproject/skypy](https://github.com/skypyproject/skypy) |
| Source record ids | github_search_telescopes-8df99515a948d4 |
...
For a systems engineer, skypyproject/skypy belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T19:20:21Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-8df99515a948d4` from `github_search_telescopes` as `registry_expansion`
