...
| Source record ids | github_search_webassembly-6e1b0febfd62a9 |
...
For a systems engineer, gxchain/gxb-core belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.201217 | 2020-12-17T01:33:13Z | [https://api.github.com/repos/gxchain/gxb-core/releases/latest](https://api.github.com/repos/gxchain/gxb-core/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gxchain/gxb-core/releases/latest` at `2026-09-01T10:25:59+00:00`.
...
- `github_search_webassembly-6e1b0febfd62a9` from `github_search_webassembly` as `registry_expansion`
