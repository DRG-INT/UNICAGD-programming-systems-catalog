...
<!-- canonical: https://pypi.org/project/acryl-datahub-airflow-plugin/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acryl-datahub-airflow-plugin/](https://pypi.org/project/acryl-datahub-airflow-plugin/) |
| Source record ids | pypi_simple-0a73028f3c6682 |

## System Engineer Summary

DataHub Airflow plugin — automatically capture pipeline lineage, run history, and task metadata from
Apache Airflow

## Operational Role

For a systems engineer, acryl-datahub-airflow-plugin belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0.7 | 2026-08-26T13:47:37.877570Z | [https://pypi.org/pypi/acryl-datahub-airflow-plugin/json](https://pypi.org/pypi/acryl-datahub-airflow-plugin/json) |  |
| preview | known | 15.0.5rc2 | 2025-01-23T12:55:32.033982Z | [https://pypi.org/pypi/acryl-datahub-airflow-plugin/json](https://pypi.org/pypi/acryl-datahub-airflow-plugin/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acryl-datahub-airflow-plugin/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-0a73028f3c6682` from `pypi_simple` as `registry_expansion`
