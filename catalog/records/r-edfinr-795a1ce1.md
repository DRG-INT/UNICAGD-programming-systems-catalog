...
<!-- canonical: https://cran.r-project.org/web/packages/edfinr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/edfinr/index.html](https://cran.r-project.org/web/packages/edfinr/index.html) |
| Source record ids | cran_packages_by_date-287c38c0038714 |
...
For a systems engineer, edfinr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 21:01:02 UTC | [https://cran.r-project.org/web/packages/edfinr/DESCRIPTION](https://cran.r-project.org/web/packages/edfinr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/edfinr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-287c38c0038714` from `cran_packages_by_date` as `registry_expansion`
