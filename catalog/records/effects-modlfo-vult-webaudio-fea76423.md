...
<!-- canonical: https://github.com/modlfo/vult-webaudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/modlfo/vult-webaudio](https://github.com/modlfo/vult-webaudio) |
| Source record ids | github_search_effects-828dcc6010831d |
...
For a systems engineer, modlfo/vult-webaudio belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-08-05T08:58:06Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-828dcc6010831d` from `github_search_effects` as `registry_expansion`
