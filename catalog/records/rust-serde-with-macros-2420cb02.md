...
<!-- canonical: https://crates.io/crates/serde_with_macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_with_macros](https://crates.io/crates/serde_with_macros) |
| Source record ids | crates_io-f87c5263f1c415 |
...
For a systems engineer, serde_with_macros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.22.0 | 2026-08-09T12:48:38.884775Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-f87c5263f1c415` from `crates_io` as `registry_expansion`
