...
<!-- canonical: https://cran.r-project.org/web/packages/distplyr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/distplyr/index.html](https://cran.r-project.org/web/packages/distplyr/index.html) |
| Source record ids | cran_packages_by_date-452ea1272974a4 |

## System Engineer Summary

Manipulate and Combine Probability Distributions

## Operational Role

For a systems engineer, distplyr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-15 06:40:02 UTC | [https://cran.r-project.org/web/packages/distplyr/DESCRIPTION](https://cran.r-project.org/web/packages/distplyr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/distplyr/DESCRIPTION` at `2026-09-15T08:23:18+00:00`.
...
- `cran_packages_by_date-452ea1272974a4` from `cran_packages_by_date` as `registry_expansion`
