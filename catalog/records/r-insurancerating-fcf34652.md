...
<!-- canonical: https://cran.r-project.org/web/packages/insurancerating/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/insurancerating/index.html](https://cran.r-project.org/web/packages/insurancerating/index.html) |
| Source record ids | cran_packages_by_date-ea7efb44156535 |
...
For a systems engineer, insurancerating belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-09-01 11:50:02 UTC | [https://cran.r-project.org/web/packages/insurancerating/DESCRIPTION](https://cran.r-project.org/web/packages/insurancerating/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/insurancerating/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-ea7efb44156535` from `cran_packages_by_date` as `registry_expansion`
