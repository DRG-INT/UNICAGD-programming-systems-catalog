...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Testing Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/testing-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-0355a396efb0 |

## System Engineer Summary

Environment orchestration/testing

## Operational Role

For a systems engineer, tox belongs in the Python inventory as part of unit/integration validation,
...
- `master-0355a396efb0` from `master_json` as `testing_framework`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Hypothesis | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-hypothesis-13494c56.md) |
| nox | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-nox-fd3958be.md) |
| pytest | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pytest-b1be0e2c.md) |
