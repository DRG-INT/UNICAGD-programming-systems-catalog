# steeltroops-ai/blackhole-simulation

## Navigation

[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/steeltroops-ai/blackhole-simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/steeltroops-ai/blackhole-simulation](https://github.com/steeltroops-ai/blackhole-simulation) |
| Source record ids | github_search_physics_engines-e1f46995ebc2f1 |

## System Engineer Summary

A scientifically accurate, real-time relativistic ray-marching engine for visualizing Kerr black
holes. Built with Next.js 14, WebGPU / WebGL 2.0, and Rust (WASM).

## Operational Role

For a systems engineer, steeltroops-ai/blackhole-simulation belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-29T22:23:10Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e1f46995ebc2f1` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| anuraghazra/Verly.js | Formatter | [open](physics-engines-anuraghazra-verly-js-0d5dd2a2.md) |
