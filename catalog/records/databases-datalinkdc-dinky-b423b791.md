...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DataLinkDC/dinky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DataLinkDC/dinky](https://github.com/DataLinkDC/dinky) |
| Source record ids | github_search_databases-49474c56509708 |

## System Engineer Summary

Dinky is a real-time data development platform based on Apache Flink, enabling agile data
development, deployment and operation.

## Operational Role

For a systems engineer, DataLinkDC/dinky belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T01:50:27Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-49474c56509708` from `github_search_databases` as `registry_expansion`
