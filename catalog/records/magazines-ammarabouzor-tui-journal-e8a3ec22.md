...
<!-- canonical: https://github.com/AmmarAbouZor/tui-journal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AmmarAbouZor/tui-journal](https://github.com/AmmarAbouZor/tui-journal) |
| Source record ids | github_search_magazines-813ef91cb274de |
...
For a systems engineer, AmmarAbouZor/tui-journal belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T12:19:49Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-813ef91cb274de` from `github_search_magazines` as `registry_expansion`
