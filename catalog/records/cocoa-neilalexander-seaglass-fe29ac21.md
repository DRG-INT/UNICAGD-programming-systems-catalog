...
<!-- canonical: https://github.com/neilalexander/seaglass -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neilalexander/seaglass](https://github.com/neilalexander/seaglass) |
| Source record ids | github_search_cocoa-0e71094aff05d0 |
...
For a systems engineer, neilalexander/seaglass belongs in the Cocoa inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-20T13:46:51Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0e71094aff05d0` from `github_search_cocoa` as `registry_expansion`
