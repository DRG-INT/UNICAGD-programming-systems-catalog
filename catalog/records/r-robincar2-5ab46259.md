...
<!-- canonical: https://cran.r-project.org/web/packages/RobinCar2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RobinCar2/index.html](https://cran.r-project.org/web/packages/RobinCar2/index.html) |
| Source record ids | cran_packages_by_date-486c258c472d75 |
...
For a systems engineer, RobinCar2 belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-08-22 17:30:02 UTC | [https://cran.r-project.org/web/packages/RobinCar2/DESCRIPTION](https://cran.r-project.org/web/packages/RobinCar2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RobinCar2/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-486c258c472d75` from `cran_packages_by_date` as `registry_expansion`
