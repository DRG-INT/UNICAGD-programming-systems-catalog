...
<!-- canonical: https://luarocks.org/modules/joenio/dublang -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/joenio/dublang](https://luarocks.org/modules/joenio/dublang) |
| Source record ids | luarocks_root_manifest-0974e46d424227 |

## System Engineer Summary

dublang universal live coding interface

## Operational Role

For a systems engineer, dublang belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0974e46d424227` from `luarocks_root_manifest` as `registry_expansion`
