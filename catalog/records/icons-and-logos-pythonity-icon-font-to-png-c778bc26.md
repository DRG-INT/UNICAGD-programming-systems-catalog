...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Pythonity/icon-font-to-png -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Pythonity/icon-font-to-png](https://github.com/Pythonity/icon-font-to-png) |
| Source record ids | github_search_icons_and_logos-87a6e79cd4f595 |

## System Engineer Summary

Python script (and library) for exporting icons from icon fonts (e.g. Font Awesome, Octicons) as PNG
images

## Operational Role

For a systems engineer, Pythonity/icon-font-to-png belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-28T14:14:18Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-87a6e79cd4f595` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rickytan/RTImageAssets | Image Audio Dsp | [open](icons-and-logos-rickytan-rtimageassets-aa208fb9.md) |
