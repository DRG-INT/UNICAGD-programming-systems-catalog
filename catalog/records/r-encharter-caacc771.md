...
<!-- canonical: https://cran.r-project.org/web/packages/encharter/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/encharter/index.html](https://cran.r-project.org/web/packages/encharter/index.html) |
| Source record ids | cran_packages_by_date-0099965e918ff1 |

## System Engineer Summary

Enhanced Office Open XML Charting for 'openxlsx2'

## Operational Role

For a systems engineer, encharter belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2026-08-04 16:10:02 UTC | [https://cran.r-project.org/web/packages/encharter/DESCRIPTION](https://cran.r-project.org/web/packages/encharter/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/encharter/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0099965e918ff1` from `cran_packages_by_date` as `registry_expansion`
...
| mlr3automl | Serialization | [open](r-mlr3automl-01287262.md) |
