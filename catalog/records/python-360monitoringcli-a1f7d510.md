...
<!-- canonical: https://pypi.org/project/360monitoringcli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/360monitoringcli/](https://pypi.org/project/360monitoringcli/) |
| Source record ids | pypi_simple-c798b9e5becc08 |

## System Engineer Summary

360monitoringcli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, 360monitoringcli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.19 | 2023-05-02T21:52:51.993580Z | [https://pypi.org/pypi/360monitoringcli/json](https://pypi.org/pypi/360monitoringcli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/360monitoringcli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-c798b9e5becc08` from `pypi_simple` as `registry_expansion`
