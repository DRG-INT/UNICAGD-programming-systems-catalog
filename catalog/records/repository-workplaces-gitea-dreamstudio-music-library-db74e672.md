# Gitea: dreamstudio/music-library
...
<!-- canonical: https://gitea.com/dreamstudio/music-library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dreamstudio/music-library](https://gitea.com/dreamstudio/music-library) |
| Source record ids | gitea_repositories_api-5ab2c9731f4832 |
...
For a systems engineer, Gitea: dreamstudio/music-library belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T11:31:08Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-5ab2c9731f4832` from `gitea_repositories_api` as `registry_expansion`
