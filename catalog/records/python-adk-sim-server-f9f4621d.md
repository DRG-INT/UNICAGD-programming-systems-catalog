...
<!-- canonical: https://pypi.org/project/adk-sim-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adk-sim-server/](https://pypi.org/project/adk-sim-server/) |
| Source record ids | pypi_simple-fe9a2436ec8c2b |

## System Engineer Summary

ADK Agent Simulator - gRPC Server

## Operational Role

For a systems engineer, adk-sim-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.22 | 2026-01-21T12:05:29.051471Z | [https://pypi.org/pypi/adk-sim-server/json](https://pypi.org/pypi/adk-sim-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adk-sim-server/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-fe9a2436ec8c2b` from `pypi_simple` as `registry_expansion`
