...
| Source record ids | github_search_swift-ed898d21dd5172 |
...
- Latest stable metadata was observed from `https://api.github.com/repos/insidegui/WWDC/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-ed898d21dd5172` from `github_search_swift` as `registry_expansion`
