...
<!-- canonical: https://github.com/stupside/castor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stupside/castor](https://github.com/stupside/castor) |
| Source record ids | github_search_video-1f6affb418c08c |

## System Engineer Summary

Point it at any web page and it finds the video, extracts the stream, transcodes it and casts in
real time to your TV. It even burns subtitles….

## Operational Role

For a systems engineer, stupside/castor belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T20:37:48Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-1f6affb418c08c` from `github_search_video` as `registry_expansion`
