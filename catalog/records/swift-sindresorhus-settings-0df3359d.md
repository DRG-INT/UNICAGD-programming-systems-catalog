...
| Source record ids | github_search_swift-71260e7f62f453 |
...
For a systems engineer, sindresorhus/Settings belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-10T17:10:41Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-71260e7f62f453` from `github_search_swift` as `registry_expansion`
...
| lucasbrown/swiftui-visual-effects | Configuration | [open](swift-lucasbrown-swiftui-visual-effects-ebfcc1d4.md) |
