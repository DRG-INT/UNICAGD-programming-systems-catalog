...
| Source record ids | lua-source-15 |

## System Engineer Summary

Game Engines is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, Game Engines belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 15}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-15` from `master_json` as `source_list_item`
...
| game-tools | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-game-tools-027200ee.md) |
