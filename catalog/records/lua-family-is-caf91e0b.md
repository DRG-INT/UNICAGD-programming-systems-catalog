...
<!-- canonical: https://luarocks.org/modules/jackwilsdon/is -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jackwilsdon/is](https://luarocks.org/modules/jackwilsdon/is) |
| Source record ids | luarocks_root_manifest-e69b7bf3cc8de7 |

## System Engineer Summary

is is tracked as a type checker record in the Lua family branch. The source did not provide a long
...
For a systems engineer, is belongs in the Lua family inventory as part of interface contracts,
...
| Name | Category | Page |
| --- | --- | --- |
| annotate | Type Checker | [open](lua-family-annotate-ea33f84e.md) |
