...
<!-- canonical: https://github.com/encoredev/encore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/encoredev/encore](https://github.com/encoredev/encore) |
| Source record ids | github_search_databases-7b3832fd8bf30d |
...
For a systems engineer, encoredev/encore belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:06:16Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7b3832fd8bf30d` from `github_search_databases` as `registry_expansion`
