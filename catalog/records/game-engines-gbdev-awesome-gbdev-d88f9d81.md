...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gbdev/awesome-gbdev -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gbdev/awesome-gbdev](https://github.com/gbdev/awesome-gbdev) |
| Source record ids | github_search_game_engines-48b602306a50df |

## System Engineer Summary

A curated list of Game Boy development resources such as tools, docs, emulators, related projects
and open-source ROMs.

## Operational Role

For a systems engineer, gbdev/awesome-gbdev belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T19:03:27Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-48b602306a50df` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| godotengine/godot-docs | Documentation | [open](game-engines-godotengine-godot-docs-ca7326a9.md) |
