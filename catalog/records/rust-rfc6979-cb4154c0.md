...
<!-- canonical: https://crates.io/crates/rfc6979 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rfc6979](https://crates.io/crates/rfc6979) |
| Source record ids | crates_io-b31b39169a0475 |
...
For a systems engineer, rfc6979 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-06-30T02:21:44.756111Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-b31b39169a0475` from `crates_io` as `registry_expansion`
