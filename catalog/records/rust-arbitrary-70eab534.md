...
<!-- canonical: https://crates.io/crates/arbitrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arbitrary](https://crates.io/crates/arbitrary) |
| Source record ids | crates_io-9998ae8df0c2e8 |
...
For a systems engineer, arbitrary belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2025-08-14T18:20:10.780830Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-9998ae8df0c2e8` from `crates_io` as `registry_expansion`
