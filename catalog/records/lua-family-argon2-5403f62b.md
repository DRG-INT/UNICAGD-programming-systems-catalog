...
<!-- canonical: https://luarocks.org/modules/thibaultcha/argon2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/thibaultcha/argon2](https://luarocks.org/modules/thibaultcha/argon2) |
| Source record ids | luarocks_root_manifest-69b6822b0bdb11 |
...
For a systems engineer, argon2 belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-69b6822b0bdb11` from `luarocks_root_manifest` as `registry_expansion`
