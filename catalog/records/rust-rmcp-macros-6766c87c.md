...
| Canonical URL | [https://crates.io/crates/rmcp-macros](https://crates.io/crates/rmcp-macros) |
| Source record ids | crates_io-ba97bc700f951c |
...
For a systems engineer, rmcp-macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-08-31T23:16:27.383019Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-ba97bc700f951c` from `crates_io` as `registry_expansion`
