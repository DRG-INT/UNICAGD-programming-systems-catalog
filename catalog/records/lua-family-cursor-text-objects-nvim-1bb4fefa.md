...
<!-- canonical: https://luarocks.org/modules/colinkennedy/cursor-text-objects.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/colinkennedy/cursor-text-objects.nvim](https://luarocks.org/modules/colinkennedy/cursor-text-objects.nvim) |
| Source record ids | luarocks_root_manifest-e5d99c1e4f4c89 |
...
For a systems engineer, cursor-text-objects.nvim belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-e5d99c1e4f4c89` from `luarocks_root_manifest` as `registry_expansion`
