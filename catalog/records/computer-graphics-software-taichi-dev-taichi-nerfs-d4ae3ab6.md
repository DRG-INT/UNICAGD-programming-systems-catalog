...
<!-- canonical: https://github.com/taichi-dev/taichi-nerfs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/taichi-dev/taichi-nerfs](https://github.com/taichi-dev/taichi-nerfs) |
| Source record ids | github_search_computer_graphics_software-16eab6e7351e6b |
...
For a systems engineer, taichi-dev/taichi-nerfs belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-16eab6e7351e6b` from `github_search_computer_graphics_software` as `registry_expansion`
