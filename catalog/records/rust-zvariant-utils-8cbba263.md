...
<!-- canonical: https://crates.io/crates/zvariant_utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zvariant_utils](https://crates.io/crates/zvariant_utils) |
| Source record ids | crates_io-0bb3b5746dabbe |
...
For a systems engineer, zvariant_utils belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-08-18T11:45:57.255393Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-0bb3b5746dabbe` from `crates_io` as `registry_expansion`
