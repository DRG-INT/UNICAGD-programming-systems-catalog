...
<!-- canonical: https://cran.r-project.org/web/packages/GLMMcosinor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GLMMcosinor/index.html](https://cran.r-project.org/web/packages/GLMMcosinor/index.html) |
| Source record ids | cran_packages_by_date-d8f93a1f592ca1 |
...
For a systems engineer, GLMMcosinor belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-15 06:30:17 UTC | [https://cran.r-project.org/web/packages/GLMMcosinor/DESCRIPTION](https://cran.r-project.org/web/packages/GLMMcosinor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GLMMcosinor/DESCRIPTION` at `2026-09-15T08:23:18+00:00`.
...
- `cran_packages_by_date-d8f93a1f592ca1` from `cran_packages_by_date` as `registry_expansion`
