...
<!-- canonical: https://cran.r-project.org/web/packages/RcppCWB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppCWB/index.html](https://cran.r-project.org/web/packages/RcppCWB/index.html) |
| Source record ids | cran_packages_by_date-5d406cf340573a |
...
For a systems engineer, RcppCWB belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.11 | 2026-08-20 05:24:03 UTC | [https://cran.r-project.org/web/packages/RcppCWB/DESCRIPTION](https://cran.r-project.org/web/packages/RcppCWB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppCWB/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5d406cf340573a` from `cran_packages_by_date` as `registry_expansion`
