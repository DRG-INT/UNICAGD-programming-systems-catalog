...
<!-- canonical: https://crates.io/crates/cesu8 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cesu8](https://crates.io/crates/cesu8) |
| Source record ids | crates_io-48b513a39b27d7 |
...
For a systems engineer, cesu8 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2016-05-15T12:20:41.086989Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-48b513a39b27d7` from `crates_io` as `registry_expansion`
