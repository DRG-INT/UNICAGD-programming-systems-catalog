...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Api Abi Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/api-abi-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/winapi-i686-pc-windows-gnu](https://crates.io/crates/winapi-i686-pc-windows-gnu) |
| Source record ids | crates_io-f13c06ef7d2012 |

## System Engineer Summary

Import libraries for the i686-pc-windows-gnu target. Please don't use this crate directly, depend on
winapi instead.

## Operational Role

For a systems engineer, winapi-i686-pc-windows-gnu belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2018-01-18T00:55:38.910834Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| allocator-api2 | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-allocator-api2-ef2cc681.md) |
| alsa | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alsa-f6e49951.md) |
| anstyle-query | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-anstyle-query-ef10648f.md) |
| ark-std | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-std-40e4037f.md) |
| cap-primitives | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cap-primitives-ce9524c6.md) |
| caps | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-caps-48d57fef.md) |
| dns-lookup | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dns-lookup-b9ddaa98.md) |
| escape8259 | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-escape8259-d971a789.md) |
