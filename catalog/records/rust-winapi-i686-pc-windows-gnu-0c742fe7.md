...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/winapi-i686-pc-windows-gnu -->
<!-- crawl-delay: 10 -->
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; MIT; https://www.nuget.org/packages/GraphQL.NewtonsoftJson/8.8.5/license |
...
- `crates_io-f13c06ef7d2012` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| allocator-api2 | Api Abi Checker | [open](rust-allocator-api2-ef2cc681.md) |
| alsa | Api Abi Checker | [open](rust-alsa-f6e49951.md) |
| anstyle-query | Api Abi Checker | [open](rust-anstyle-query-ef10648f.md) |
| ark-std | Api Abi Checker | [open](rust-ark-std-40e4037f.md) |
| cap-primitives | Api Abi Checker | [open](rust-cap-primitives-ce9524c6.md) |
| caps | Api Abi Checker | [open](rust-caps-48d57fef.md) |
| dns-lookup | Api Abi Checker | [open](rust-dns-lookup-b9ddaa98.md) |
| escape8259 | Api Abi Checker | [open](rust-escape8259-d971a789.md) |
