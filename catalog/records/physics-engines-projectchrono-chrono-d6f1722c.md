...
| Source record ids | github_search_physics_engines-4ddfa7bcaf568c |
...
For a systems engineer, projectchrono/chrono belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:17:07Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-4ddfa7bcaf568c` from `github_search_physics_engines` as `registry_expansion`
