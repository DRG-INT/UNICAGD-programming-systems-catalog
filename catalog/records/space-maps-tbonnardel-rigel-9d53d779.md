...
<!-- canonical: https://github.com/tbonnardel/rigel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tbonnardel/rigel](https://github.com/tbonnardel/rigel) |
| Source record ids | github_search_space_maps-f39da7823d125f |

## System Engineer Summary

Rigel is a GUI that shows the animated sky map at a specific observation point

## Operational Role

For a systems engineer, tbonnardel/rigel belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-06T17:00:48Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f39da7823d125f` from `github_search_space_maps` as `registry_expansion`
