...
<!-- canonical: https://crates.io/crates/fd-lock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fd-lock](https://crates.io/crates/fd-lock) |
| Source record ids | crates_io-4a07eb7b0a1596 |
...
For a systems engineer, fd-lock belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.4 | 2025-03-10T15:53:43.359688Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-4a07eb7b0a1596` from `crates_io` as `registry_expansion`
