...
<!-- canonical: https://github.com/Rubikplayer/flame-fitting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Rubikplayer/flame-fitting](https://github.com/Rubikplayer/flame-fitting) |
| Source record ids | github_search_computer_graphics_software-cc26e26b14c205 |

## System Engineer Summary

Example code for the FLAME 3D head model. The code demonstrates how to sample 3D heads from the
model, fit the model to 3D keypoints and 3D scans.

## Operational Role

For a systems engineer, Rubikplayer/flame-fitting belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-cc26e26b14c205` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| OTFCG/Awesome-Game-Analysis | Static Analyzer | [open](computer-graphics-software-otfcg-awesome-game-analysis-c8d50206.md) |
