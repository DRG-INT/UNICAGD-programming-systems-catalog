...
<!-- canonical: https://github.com/bitmovin/bitmovin-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bitmovin/bitmovin-python](https://github.com/bitmovin/bitmovin-python) |
| Source record ids | github_search_video-b7e4ea49a7080b |

## System Engineer Summary

DEPRECATED: Python client for the Bitmovin API, see

## Operational Role

For a systems engineer, bitmovin/bitmovin-python belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-01-28T14:50:20Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-b7e4ea49a7080b` from `github_search_video` as `registry_expansion`
