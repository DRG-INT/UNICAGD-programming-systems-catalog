...
<!-- canonical: https://www.nuget.org/packages/Xamarin.Firebase.Encoders.JSON -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Xamarin.Firebase.Encoders.JSON](https://www.nuget.org/packages/Xamarin.Firebase.Encoders.JSON) |
| Source record ids | nuget_search-938dc75136283d |

## System Engineer Summary

.NET for Android and MAUI bindings for the Android Java library 'com.google.firebase:firebase-
encoders-json'.

## Operational Role

For a systems engineer, Xamarin.Firebase.Encoders.JSON belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 118.0.1.18 | 2026-06-27T20:55:08.66+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/xamarin.firebase.encoders.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/xamarin.firebase.encoders.json/index.json) |  |
| preview | known | 116.1.0-preview02 | 2020-07-15T13:03:40.563+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/xamarin.firebase.encoders.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/xamarin.firebase.encoders.json/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT AND Apache-2.0; https://www.nuget.org/packages/Xamarin.Firebase.Encoders.JSON/118.0.1.18/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/xamarin.firebase.encoders.json/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-938dc75136283d` from `nuget_search` as `registry_expansion`
