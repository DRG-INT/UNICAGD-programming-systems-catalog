...
<!-- canonical: https://cran.r-project.org/web/packages/MR.RGM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MR.RGM/index.html](https://cran.r-project.org/web/packages/MR.RGM/index.html) |
| Source record ids | cran_packages_by_date-1593ade9d81bee |

## System Engineer Summary

Fitting Multivariate Bidirectional Mendelian Randomization Networks Using Bayesian Directed Cyclic
Graphical Models

## Operational Role

For a systems engineer, MR.RGM belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-27 12:10:02 UTC | [https://cran.r-project.org/web/packages/MR.RGM/DESCRIPTION](https://cran.r-project.org/web/packages/MR.RGM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MR.RGM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1593ade9d81bee` from `cran_packages_by_date` as `registry_expansion`
