...
<!-- canonical: https://github.com/bolt/bolt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bolt/bolt](https://github.com/bolt/bolt) |
| Source record ids | github_search_databases-412b107428912d |

## System Engineer Summary

Bolt is a simple CMS written in PHP. It is based on Silex and Symfony components, uses Twig and
either SQLite, MySQL or PostgreSQL.

## Operational Role

For a systems engineer, bolt/bolt belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-27T10:22:08Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_databases-412b107428912d` from `github_search_databases` as `registry_expansion`
