...
| Source record ids | corpus-dad3c6c42226ee |

## System Engineer Summary

SFML is tracked as an image audio dsp record in the C++23 branch. The source did not provide a long
...
For a systems engineer, SFML belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-dad3c6c42226ee` from `master_json` as `image_audio_dsp`
...
| SDL | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-sdl-4f8ef49a.md) |
