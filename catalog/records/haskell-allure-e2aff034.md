...
<!-- canonical: https://hackage.haskell.org/package/Allure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Allure](https://hackage.haskell.org/package/Allure) |
| Source record ids | hackage_top_downloads-d5554cd81f70d6 |
...
For a systems engineer, Allure belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0.0 | 2021-12-17T17:46:58Z | [https://hackage.haskell.org/package/Allure](https://hackage.haskell.org/package/Allure) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Allure` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-d5554cd81f70d6` from `hackage_top_downloads` as `registry_expansion`
