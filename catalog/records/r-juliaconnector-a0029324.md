...
<!-- canonical: https://cran.r-project.org/web/packages/JuliaConnectoR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/JuliaConnectoR/index.html](https://cran.r-project.org/web/packages/JuliaConnectoR/index.html) |
| Source record ids | cran_packages_by_date-a0ab84d319f00f |
...
For a systems engineer, JuliaConnectoR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.6 | 2026-08-31 19:31:10 UTC | [https://cran.r-project.org/web/packages/JuliaConnectoR/DESCRIPTION](https://cran.r-project.org/web/packages/JuliaConnectoR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/JuliaConnectoR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a0ab84d319f00f` from `cran_packages_by_date` as `registry_expansion`
