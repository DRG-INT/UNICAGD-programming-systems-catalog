...
<!-- canonical: https://pub.dev/packages/image_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/image_picker](https://pub.dev/packages/image_picker) |
| Source record ids | pub_dev-3651e74c3990d2 |

## System Engineer Summary

Flutter plugin for selecting images from the Android and iOS image library, and taking new pictures
with the camera.

## Operational Role

For a systems engineer, image_picker belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-06-30T19:54:39.256802Z | [https://pub.dev/api/packages/image_picker](https://pub.dev/api/packages/image_picker) |  |
| preview | known | 0.7.0-nullsafety | 2021-02-08T16:25:37.489746Z | [https://pub.dev/api/packages/image_picker](https://pub.dev/api/packages/image_picker) |  |
...
| Evidence | Apache-2.0 OR MIT; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/image_picker` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-3651e74c3990d2` from `pub_dev` as `registry_expansion`
