...
<!-- canonical: https://crates.io/crates/windows-interface -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-interface](https://crates.io/crates/windows-interface) |
| Source record ids | crates_io-2559c860b03e12 |
...
For a systems engineer, windows-interface belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:38:48.257023Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-03T17:18:47+00:00`.
...
- `crates_io-2559c860b03e12` from `crates_io` as `registry_expansion`
