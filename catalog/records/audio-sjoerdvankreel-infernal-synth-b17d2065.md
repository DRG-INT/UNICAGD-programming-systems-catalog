...
<!-- canonical: https://github.com/sjoerdvankreel/infernal-synth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sjoerdvankreel/infernal-synth](https://github.com/sjoerdvankreel/infernal-synth) |
| Source record ids | github_search_audio-cc24e0e6e277f9 |

## System Engineer Summary

An open source VST3 and CLAP synthesizer and effect plugin.

## Operational Role

For a systems engineer, sjoerdvankreel/infernal-synth belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-08T21:25:39Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_audio-cc24e0e6e277f9` from `github_search_audio` as `registry_expansion`
