...
<!-- canonical: https://pub.dev/packages/clarity_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/clarity_flutter](https://pub.dev/packages/clarity_flutter) |
| Source record ids | pub_dev-64b7aefa6c6d70 |

## System Engineer Summary

Official Microsoft Clarity Flutter SDK; add free, privacy-conscious session replay, heatmaps &
interaction analytics to Flutter mobile apps.

## Operational Role

For a systems engineer, clarity_flutter belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2026-09-01T14:23:26.024576Z | [https://pub.dev/api/packages/clarity_flutter](https://pub.dev/api/packages/clarity_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/clarity_flutter` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-64b7aefa6c6d70` from `pub_dev` as `registry_expansion`
