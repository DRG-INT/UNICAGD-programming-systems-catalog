...
<!-- canonical: https://crates.io/crates/fs-err -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fs-err](https://crates.io/crates/fs-err) |
| Source record ids | crates_io-9102c42e80be95 |
...
For a systems engineer, fs-err belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.1 | 2026-07-03T20:15:39.211067Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-9102c42e80be95` from `crates_io` as `registry_expansion`
