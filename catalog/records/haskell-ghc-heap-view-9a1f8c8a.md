...
<!-- canonical: https://hackage.haskell.org/package/ghc-heap-view -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-heap-view](https://hackage.haskell.org/package/ghc-heap-view) |
| Source record ids | hackage_top_downloads-788cfbda05c55f |
...
For a systems engineer, ghc-heap-view belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4.1 | 2024-01-06T14:49:36Z | [https://hackage.haskell.org/package/ghc-heap-view](https://hackage.haskell.org/package/ghc-heap-view) |  |
| candidate | partial | 0.5.10 |  | [https://hackage.haskell.org/package/ghc-heap-view](https://hackage.haskell.org/package/ghc-heap-view) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-heap-view` at `2026-09-09T00:34:59+00:00`.
...
- `hackage_top_downloads-788cfbda05c55f` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ghc-heap | Memory Analyzer | [open](haskell-ghc-heap-47a2e491.md) |
