...
<!-- canonical: https://hackage.haskell.org/package/bluefin-random -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bluefin-random](https://hackage.haskell.org/package/bluefin-random) |
| Source record ids | hackage_recent-27661bfd61e3a2 |
...
For a systems engineer, bluefin-random belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.0 | 2026-09-11T12:12:28Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-27661bfd61e3a2` from `hackage_recent` as `registry_expansion`
