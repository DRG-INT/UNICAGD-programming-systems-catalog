...
<!-- canonical: https://cran.r-project.org/web/packages/vazul/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vazul/index.html](https://cran.r-project.org/web/packages/vazul/index.html) |
| Source record ids | cran_packages_by_date-8eea105af51f08 |

## System Engineer Summary

vazul is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, vazul belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-04 11:00:02 UTC | [https://cran.r-project.org/web/packages/vazul/DESCRIPTION](https://cran.r-project.org/web/packages/vazul/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vazul/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-8eea105af51f08` from `cran_packages_by_date` as `registry_expansion`
