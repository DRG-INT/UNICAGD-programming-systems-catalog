...
<!-- canonical: https://pub.dev/packages/two_dimensional_scrollables -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/two_dimensional_scrollables](https://pub.dev/packages/two_dimensional_scrollables) |
| Source record ids | pub_dev-c50f1c7d87b08b |
...
For a systems engineer, two_dimensional_scrollables belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4 | 2026-08-27T20:33:36.668997Z | [https://pub.dev/api/packages/two_dimensional_scrollables](https://pub.dev/api/packages/two_dimensional_scrollables) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/two_dimensional_scrollables` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-c50f1c7d87b08b` from `pub_dev` as `registry_expansion`
