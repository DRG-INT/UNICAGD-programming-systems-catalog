# com.sap.cloud.yaas.service-sdk:service-sdk-audit

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.yaas.service-sdk/service-sdk-audit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.yaas.service-sdk/service-sdk-audit](https://central.sonatype.com/artifact/com.sap.cloud.yaas.service-sdk/service-sdk-audit) |
| Source record ids | maven_central_search-4e6b024ea3dbba |
...
For a systems engineer, com.sap.cloud.yaas.service-sdk:service-sdk-audit belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.17.1 | 2017-10-26T05:29:46+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json) |  |
...
- `maven_central_search-4e6b024ea3dbba` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cds:cds-feature-auditlog-v2 | Security Sast | [open](sapjava-com-sap-cds-cds-feature-auditlog-v2-5b8d8b51.md) |
| com.sap.cloud.sdk.cloudplatform:auditlog | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-auditlog-fd34c3d3.md) |
| com.sap.cloud.sdk.cloudplatform:auditlog-scp-cf | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-auditlog-scp-cf-782a5f4c.md) |
| com.sap.cloud.sdk.cloudplatform:auditlog-scp-neo | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-auditlog-scp-neo-f48af866.md) |
| com.sap.cloud.sdk.cloudplatform:security-scp-cf | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-security-scp-cf-2ed04b01.md) |
| com.sap.cloud.sdk.cloudplatform:security-scp-neo | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-security-scp-neo-b025ca8d.md) |
| com.sap.cloud.sdk.cloudplatform:security-servlet | Security Sast | [open](sapjava-com-sap-cloud-sdk-cloudplatform-security-servlet-c3aa2206.md) |
| com.sap.cloud.yaas.service-sdk:service-sdk-audit-base | Security Sast | [open](sapjava-com-sap-cloud-yaas-service-sdk-service-sdk-audit-base-b588b7f1.md) |
