...
| Canonical URL | [https://packagist.org/packages/dg/dibi](https://packagist.org/packages/dg/dibi) |
| Source record ids | packagist_search-11a30e0c57fd48 |
...
For a systems engineer, dg/dibi belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.1.1 | 2026-02-22T20:47:54+00:00 | [https://repo.packagist.org/p2/dg/dibi.json](https://repo.packagist.org/p2/dg/dibi.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dg/dibi.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-11a30e0c57fd48` from `packagist_search` as `registry_expansion`
