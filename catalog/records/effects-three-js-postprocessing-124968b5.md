...
| Source record ids | curated_language_routes-07be158068ffe5 |

## System Engineer Summary

Post-processing effect framework for three.js scenes, passes, bloom, anti-aliasing, and screen-space
effects.

## Operational Role

For a systems engineer, three.js postprocessing belongs in the Effects inventory as part of
...
- `curated_language_routes-07be158068ffe5` from `curated_language_routes` as `registry_expansion`
