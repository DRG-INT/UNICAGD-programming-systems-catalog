...
<!-- canonical: https://gnu-octave.github.io/packages/mboct-octave-pkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/mboct-octave-pkg](https://gnu-octave.github.io/packages/mboct-octave-pkg) |
| Source record ids | octave_packages_index-84d7b7649486c3 |

## System Engineer Summary

This package belongs to a suite of packages which can be used for pre- and postprocessing of
flexible bodies in MBDyn (www.mbdyn.org) with GNU-Octave. It contains general purpose utility
functions used in all mboct-* packages.

## Operational Role

For a systems engineer, mboct-octave-pkg belongs in the Octave inventory as part of dependency
...
- `octave_packages_index-84d7b7649486c3` from `octave_packages_index` as `registry_expansion`
