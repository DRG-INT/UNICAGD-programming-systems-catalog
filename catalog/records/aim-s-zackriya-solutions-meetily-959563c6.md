...
<!-- canonical: https://github.com/Zackriya-Solutions/meetily -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily) |
| Source record ids | github_search_aims-aeedc83856fd1e |

## System Engineer Summary

Privacy first, AI meeting assistant with 4x faster Parakeet/Whisper live transcription, speaker
diarization, and Ollama summarization built on Rust. 100% local processing. no cloud required.
Meetily is the #1 Self-hosted, Open-source Ai meeting note taker for macOS & Windows. Understand How
to write meeting minutes

## Operational Role

For a systems engineer, Zackriya-Solutions/meetily belongs in the "aim's" inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:51:34Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-aeedc83856fd1e` from `github_search_aims` as `registry_expansion`
