...
<!-- canonical: https://github.com/tekknolagi/full-beans -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tekknolagi/full-beans](https://github.com/tekknolagi/full-beans) |
| Source record ids | github_search_cocoa-879396738e86d3 |

## System Engineer Summary

tekknolagi/full-beans is tracked as a library record in the Cocoa branch. The source did not provide
...
For a systems engineer, tekknolagi/full-beans belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-28T15:41:38Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-879396738e86d3` from `github_search_cocoa` as `registry_expansion`
