...
<!-- canonical: https://cran.r-project.org/web/packages/reapeR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/reapeR/index.html](https://cran.r-project.org/web/packages/reapeR/index.html) |
| Source record ids | cran_packages_by_date-02177a4ecf4345 |

## System Engineer Summary

Interface to the 'REAPER' Library

## Operational Role

For a systems engineer, reapeR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-24 10:10:02 UTC | [https://cran.r-project.org/web/packages/reapeR/DESCRIPTION](https://cran.r-project.org/web/packages/reapeR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/reapeR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-02177a4ecf4345` from `cran_packages_by_date` as `registry_expansion`
