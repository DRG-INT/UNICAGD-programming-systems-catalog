...
<!-- canonical: https://crates.io/crates/cexpr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cexpr](https://crates.io/crates/cexpr) |
| Source record ids | crates_io-38d244b203b0ab |
...
For a systems engineer, cexpr belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2021-10-11T09:31:52.220209Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-38d244b203b0ab` from `crates_io` as `registry_expansion`
