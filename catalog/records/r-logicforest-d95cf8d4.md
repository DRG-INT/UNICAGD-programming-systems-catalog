...
<!-- canonical: https://cran.r-project.org/web/packages/LogicForest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LogicForest/index.html](https://cran.r-project.org/web/packages/LogicForest/index.html) |
| Source record ids | cran_packages_by_date-93eea37f1bfc30 |

## System Engineer Summary

LogicForest is tracked as a logging observability record in the R branch. The source did not provide
...
For a systems engineer, LogicForest belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.5 | 2026-08-28 20:00:14 UTC | [https://cran.r-project.org/web/packages/LogicForest/DESCRIPTION](https://cran.r-project.org/web/packages/LogicForest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LogicForest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-93eea37f1bfc30` from `cran_packages_by_date` as `registry_expansion`
