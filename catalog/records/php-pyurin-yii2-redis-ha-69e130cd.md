...
<!-- canonical: https://packagist.org/packages/pyurin/yii2-redis-ha -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pyurin/yii2-redis-ha](https://packagist.org/packages/pyurin/yii2-redis-ha) |
| Source record ids | packagist_search-e966d978c1ff33 |

## System Engineer Summary

pyurin/yii2-redis-ha is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, pyurin/yii2-redis-ha belongs in the PHP inventory as part of service
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-04 | `{"kind": "packagist_search_and_p2_api", "query": "redis", "retrieved": "2026-09-04", "status": "registry-derived"}` |
...
- `packagist_search-e966d978c1ff33` from `packagist_search` as `registry_expansion`
