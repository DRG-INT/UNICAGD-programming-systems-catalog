...
<!-- canonical: https://luarocks.org/modules/bonidjukic/aka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bonidjukic/aka](https://luarocks.org/modules/bonidjukic/aka) |
| Source record ids | luarocks_root_manifest-061429ce8ec7d2 |

## System Engineer Summary

Simple command-line tool which lets you define per directory config files as aliases for shell
commands.

## Operational Role

For a systems engineer, aka belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-061429ce8ec7d2` from `luarocks_root_manifest` as `registry_expansion`
