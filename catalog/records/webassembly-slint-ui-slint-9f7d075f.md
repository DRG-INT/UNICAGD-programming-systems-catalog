...
<!-- canonical: https://github.com/slint-ui/slint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/slint-ui/slint](https://github.com/slint-ui/slint) |
| Source record ids | github_search_webassembly-b06d1ee5046cc7 |

## System Engineer Summary

Slint is an open-source declarative GUI toolkit to build native user interfaces for Rust, C++,
JavaScript, or Python apps.

## Operational Role

For a systems engineer, slint-ui/slint belongs in the WebAssembly inventory as part of ecosystem
...
- `github_search_webassembly-b06d1ee5046cc7` from `github_search_webassembly` as `registry_expansion`
