...
<!-- canonical: https://github.com/gethugothemes/hugo-modules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gethugothemes/hugo-modules](https://github.com/gethugothemes/hugo-modules) |
| Source record ids | github_search_go-f7c09184b7566b |
...
For a systems engineer, gethugothemes/hugo-modules belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-01T05:48:56Z | gh search repos topic:go-modules stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-f7c09184b7566b` from `github_search_go` as `registry_expansion`
