...
<!-- canonical: https://github.com/torch2424/as-bind -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/torch2424/as-bind](https://github.com/torch2424/as-bind) |
| Source record ids | github_search_webassembly-b5d4f58b554ac0 |

## System Engineer Summary

Isomorphic library to handle passing high-level data structures between AssemblyScript and
JavaScript 🤝🚀

## Operational Role

For a systems engineer, torch2424/as-bind belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2021-08-17T19:04:23Z | [https://api.github.com/repos/torch2424/as-bind/releases/latest](https://api.github.com/repos/torch2424/as-bind/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/torch2424/as-bind/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-b5d4f58b554ac0` from `github_search_webassembly` as `registry_expansion`
