...
| Canonical URL | [https://github.com/bazel-contrib/rules_nodejs](https://github.com/bazel-contrib/rules_nodejs) |
| Source record ids | github_search_starlark-e06695936adf21 |
...
For a systems engineer, bazel-contrib/rules_nodejs belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.7.5 | 2026-06-24T07:29:48Z | [https://api.github.com/repos/bazel-contrib/rules_nodejs/releases/latest](https://api.github.com/repos/bazel-contrib/rules_nodejs/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazel-contrib/rules_nodejs/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-e06695936adf21` from `github_search_starlark` as `registry_expansion`
