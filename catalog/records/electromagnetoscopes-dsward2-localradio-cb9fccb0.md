...
<!-- canonical: https://github.com/dsward2/LocalRadio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dsward2/LocalRadio](https://github.com/dsward2/LocalRadio) |
| Source record ids | github_search_electromagnetoscopes-a36cee309201f6 |

## System Engineer Summary

📻 LocalRadio is "Radio for Cord-Cutters" – a Software-Defined Radio (SDR) app for your Mac and
mobile devices. With an inexpensive RTL-SDR USB device, LocalRadio provides a casual, home-based
radio listening experience for your favorite local frequencies - FM broadcasts/free
music/news/sports/weather/public safety & aviation scanner/etc.

## Operational Role

For a systems engineer, dsward2/LocalRadio belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T02:36:04Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_electromagnetoscopes-a36cee309201f6` from `github_search_electromagnetoscopes` as `registry_expansion`
