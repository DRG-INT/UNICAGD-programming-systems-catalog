...
<!-- canonical: https://cran.r-project.org/web/packages/danlex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/danlex/index.html](https://cran.r-project.org/web/packages/danlex/index.html) |
| Source record ids | cran_packages_by_date-326aeb4ced0f7a |

## System Engineer Summary

Access Danish Legislation from Retsinformation

## Operational Role

For a systems engineer, danlex belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-11 12:00:15 UTC | [https://cran.r-project.org/web/packages/danlex/DESCRIPTION](https://cran.r-project.org/web/packages/danlex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/danlex/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-326aeb4ced0f7a` from `cran_packages_by_date` as `registry_expansion`
