...
<!-- canonical: https://github.com/DamascenoRafael/reminders-menubar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DamascenoRafael/reminders-menubar](https://github.com/DamascenoRafael/reminders-menubar) |
| Source record ids | github_search_swift-fa1e38e8e72354 |

## System Engineer Summary

Simple macOS menu bar application to view and interact with reminders. Developed with SwiftUI and
using Apple Reminders as a source.

## Operational Role

For a systems engineer, DamascenoRafael/reminders-menubar belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T22:11:19Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-fa1e38e8e72354` from `github_search_swift` as `registry_expansion`
