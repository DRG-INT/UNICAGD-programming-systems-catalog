...
<!-- canonical: https://github.com/4ra1n/mysql-fake-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/4ra1n/mysql-fake-server](https://github.com/4ra1n/mysql-fake-server) |
| Source record ids | github_search_databases-805c511f53ee86 |

## System Engineer Summary

纯 Java 实现的 MySQL Fake Server | 支持 GUI 版和命令行版 | 支持反序列化和文件读取的利用方式 | 支持常见的 GADGET 和自定义 GADGET 数据 |
根据目标环境自动生成匹配的 PAYLOAD | 支持 PGSQL 和 DERBY 的利用

## Operational Role

For a systems engineer, 4ra1n/mysql-fake-server belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-18T15:13:23Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-805c511f53ee86` from `github_search_databases` as `registry_expansion`
