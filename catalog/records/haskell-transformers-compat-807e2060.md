...
<!-- canonical: https://hackage.haskell.org/package/transformers-compat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/transformers-compat](https://hackage.haskell.org/package/transformers-compat) |
| Source record ids | hackage_top_downloads-86c1a6e5f0c910 |
...
For a systems engineer, transformers-compat belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8 | 2026-01-11T02:47:58Z | [https://hackage.haskell.org/package/transformers-compat](https://hackage.haskell.org/package/transformers-compat) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/transformers-compat` at `2026-09-01T14:24:35+00:00`.
...
- `hackage_top_downloads-86c1a6e5f0c910` from `hackage_top_downloads` as `registry_expansion`
