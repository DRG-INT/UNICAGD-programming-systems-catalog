...
<!-- canonical: https://github.com/zeloe/DAFX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zeloe/DAFX](https://github.com/zeloe/DAFX) |
| Source record ids | github_search_effects-92db3a44292e7b |
...
For a systems engineer, zeloe/DAFX belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-06T14:01:38Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-92db3a44292e7b` from `github_search_effects` as `registry_expansion`
