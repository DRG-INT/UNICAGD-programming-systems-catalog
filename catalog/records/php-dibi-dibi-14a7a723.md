...
| Canonical URL | [https://packagist.org/packages/dibi/dibi](https://packagist.org/packages/dibi/dibi) |
| Source record ids | packagist_search-ba3cee9b9b75f2 |
...
For a systems engineer, dibi/dibi belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.1.1 | 2026-02-22T20:47:54+00:00 | [https://repo.packagist.org/p2/dibi/dibi.json](https://repo.packagist.org/p2/dibi/dibi.json) |  |
...
| Evidence | BSD-3-Clause; GPL-2.0-only; GPL-3.0-only |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dibi/dibi.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-ba3cee9b9b75f2` from `packagist_search` as `registry_expansion`
