...
<!-- canonical: https://github.com/bazel-contrib/rules_kotlin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_kotlin](https://github.com/bazel-contrib/rules_kotlin) |
| Source record ids | github_search_starlark-e3ae7a05b8ca21 |

## System Engineer Summary

bazel-contrib/rules_kotlin is tracked as a build system record in the Starlark branch. The source
...
For a systems engineer, bazel-contrib/rules_kotlin belongs in the Starlark inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:32:15Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-e3ae7a05b8ca21` from `github_search_starlark` as `registry_expansion`
