...
<!-- canonical: https://pub.dev/packages/extension_google_sign_in_as_googleapis_auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/extension_google_sign_in_as_googleapis_auth](https://pub.dev/packages/extension_google_sign_in_as_googleapis_auth) |
| Source record ids | pub_dev-ac40d8735a0bc4 |

## System Engineer Summary

A bridge package between google_sign_in and googleapis_auth, to create Authenticated Clients from
google_sign_in user credentials.

## Operational Role

For a systems engineer, extension_google_sign_in_as_googleapis_auth belongs in the Dart inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-06-26T15:40:35.597571Z | [https://pub.dev/api/packages/extension_google_sign_in_as_googleapis_auth](https://pub.dev/api/packages/extension_google_sign_in_as_googleapis_auth) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/extension_google_sign_in_as_googleapis_auth` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-ac40d8735a0bc4` from `pub_dev` as `registry_expansion`
