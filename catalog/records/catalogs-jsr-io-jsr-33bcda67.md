...
<!-- canonical: https://github.com/jsr-io/jsr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jsr-io/jsr](https://github.com/jsr-io/jsr) |
| Source record ids | github_search_catalogs-726b7d0ab15fc4 |
...
For a systems engineer, jsr-io/jsr belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T06:13:17Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-726b7d0ab15fc4` from `github_search_catalogs` as `registry_expansion`
