...
<!-- canonical: https://hackage.haskell.org/package/mini -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mini](https://hackage.haskell.org/package/mini) |
| Source record ids | hackage_recent-8f6b763e7985db |

## System Engineer Summary

Hackage package recently uploaded by vicwall.

## Operational Role

For a systems engineer, mini belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0.0 | 2026-09-07T18:07:57Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-07T18:23:11+00:00`.
...
- `hackage_recent-8f6b763e7985db` from `hackage_recent` as `registry_expansion`
