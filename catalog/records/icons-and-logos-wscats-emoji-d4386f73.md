...
<!-- canonical: https://github.com/Wscats/emoji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Wscats/emoji](https://github.com/Wscats/emoji) |
| Source record ids | github_search_icons_and_logos-988affde1c3eab |

## System Engineer Summary

Wscats/emoji is tracked as a library record in the Icons and Logos branch. The source did not
...
For a systems engineer, Wscats/emoji belongs in the Icons and Logos inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-31T16:00:37Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-988affde1c3eab` from `github_search_icons_and_logos` as `registry_expansion`
