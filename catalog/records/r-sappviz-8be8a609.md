...
<!-- canonical: https://cran.r-project.org/web/packages/sappviz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sappviz/index.html](https://cran.r-project.org/web/packages/sappviz/index.html) |
| Source record ids | cran_packages_by_date-5a974ce6a0fc83 |

## System Engineer Summary

Sector-Adjusted Points Plot for Feature Dominance

## Operational Role

For a systems engineer, sappviz belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.16 | 2026-08-06 12:50:02 UTC | [https://cran.r-project.org/web/packages/sappviz/DESCRIPTION](https://cran.r-project.org/web/packages/sappviz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sappviz/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5a974ce6a0fc83` from `cran_packages_by_date` as `registry_expansion`
