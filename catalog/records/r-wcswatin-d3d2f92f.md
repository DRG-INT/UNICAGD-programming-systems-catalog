...
<!-- canonical: https://cran.r-project.org/web/packages/wcswatin/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wcswatin/index.html](https://cran.r-project.org/web/packages/wcswatin/index.html) |
| Source record ids | cran_packages_by_date-d8beb6de74b806 |
...
For a systems engineer, wcswatin belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-11 07:10:03 UTC | [https://cran.r-project.org/web/packages/wcswatin/DESCRIPTION](https://cran.r-project.org/web/packages/wcswatin/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wcswatin/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-d8beb6de74b806` from `cran_packages_by_date` as `registry_expansion`
