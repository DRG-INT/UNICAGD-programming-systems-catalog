...
| Source record ids | github_search_game_engines-59e5dba62f5eb8 |

## System Engineer Summary

urho3d/urho3d is tracked as a game engine game dev record in the Game Engines branch. The source did
...
For a systems engineer, urho3d/urho3d belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-25T17:29:02Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-59e5dba62f5eb8` from `github_search_game_engines` as `registry_expansion`
