...
| Canonical URL | [https://crates.io/crates/attribute-derive](https://crates.io/crates/attribute-derive) |
| Source record ids | crates_io-afb66f74119d43 |
...
For a systems engineer, attribute-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.5 | 2025-10-02T09:31:44.858004Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-afb66f74119d43` from `crates_io` as `registry_expansion`
