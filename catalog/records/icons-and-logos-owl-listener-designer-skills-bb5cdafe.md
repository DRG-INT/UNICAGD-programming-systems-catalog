...
<!-- canonical: https://github.com/Owl-Listener/designer-skills -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Owl-Listener/designer-skills](https://github.com/Owl-Listener/designer-skills) |
| Source record ids | github_search_icons_and_logos-e516fa186f4d2c |

## System Engineer Summary

Designer Skills Collection: agentic skills, commands, and plugins for design — from research to
systems, UI, interaction, and delivery.

## Operational Role

For a systems engineer, Owl-Listener/designer-skills belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T14:10:53Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-e516fa186f4d2c` from `github_search_icons_and_logos` as `registry_expansion`
