...
<!-- canonical: https://luarocks.org/modules/nymphium/adt.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nymphium/adt.lua](https://luarocks.org/modules/nymphium/adt.lua) |
| Source record ids | luarocks_root_manifest-0d255bf4f4eba8 |
...
For a systems engineer, adt.lua belongs in the Lua family inventory as part of model pipelines,
...
- `luarocks_root_manifest-0d255bf4f4eba8` from `luarocks_root_manifest` as `registry_expansion`
