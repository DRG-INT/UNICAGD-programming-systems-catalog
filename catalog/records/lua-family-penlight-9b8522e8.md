...
| Source record ids | corpus-dcf64c6a0c0318 |

## System Engineer Summary

Penlight is tracked as an utility library record in the Lua family branch. The source did not
...
For a systems engineer, Penlight belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-dcf64c6a0c0318` from `master_json` as `utility_library`
