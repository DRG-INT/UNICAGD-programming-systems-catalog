...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/O/ODBC](https://github.com/JuliaRegistries/General/tree/master/O/ODBC) |
| Source record ids | corpus-ac8757c5599925 |

## System Engineer Summary

ODBC.jl is tracked as a database datastore record in the Julia branch. The source did not provide a
...
For a systems engineer, ODBC.jl belongs in the Julia inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.2.1 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/O/ODBC/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/O/ODBC/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-ac8757c5599925` from `master_json` as `database_datastore`
