...
<!-- canonical: https://github.com/MetaModels/core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MetaModels/core](https://github.com/MetaModels/core) |
| Source record ids | github_search_catalogs-5468ce72f4db2c |

## System Engineer Summary

MetaModels/core is tracked as a logging observability record in the Catalogs branch. The source did
...
For a systems engineer, MetaModels/core belongs in the Catalogs inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T15:28:27Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-5468ce72f4db2c` from `github_search_catalogs` as `registry_expansion`
