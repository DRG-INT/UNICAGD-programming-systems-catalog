...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Profiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/profiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-29d1469f041b |
...
For a systems engineer, cProfile belongs in the Python inventory as part of hot-path discovery,
...
- `master-29d1469f041b` from `master_json` as `profiler`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| py-spy | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-py-spy-403faa7b.md) |
| Scalene | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-scalene-7e606905.md) |
