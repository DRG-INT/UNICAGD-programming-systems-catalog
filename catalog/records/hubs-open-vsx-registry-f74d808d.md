...
| Canonical URL | [https://open-vsx.org/](https://open-vsx.org/) |
| Source record ids | curated_language_routes-d06caae486e9ce |

## System Engineer Summary

Open extension hub for VS Code-compatible editors and development environments.

## Operational Role

For a systems engineer, Open VSX Registry belongs in the Hubs inventory as part of ecosystem
...
- `curated_language_routes-d06caae486e9ce` from `curated_language_routes` as `registry_expansion`
