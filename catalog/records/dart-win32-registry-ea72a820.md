...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/win32_registry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/win32_registry](https://pub.dev/packages/win32_registry) |
| Source record ids | pub_dev-925b66a9805ff5 |
...
For a systems engineer, win32_registry belongs in the Dart inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.3 | 2026-04-11T20:02:05.758851Z | [https://pub.dev/api/packages/win32_registry](https://pub.dev/api/packages/win32_registry) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/win32_registry` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-925b66a9805ff5` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mongo_dart | Package Manager | [open](dart-mongo-dart-2703015a.md) |
