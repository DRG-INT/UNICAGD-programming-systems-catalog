...
<!-- canonical: https://github.com/wiidede/exif-gallery-nuxt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wiidede/exif-gallery-nuxt](https://github.com/wiidede/exif-gallery-nuxt) |
| Source record ids | github_search_photography-f7f91c6e8716e7 |

## System Engineer Summary

A free personal photo gallery (nuxt + nuxthub) deployable on Cloudflare, with AI image analysis and
browser-side image compression 可免费部署在 Cloudflare 的个人相册网站，支持AI图像分析，浏览器压缩图片

## Operational Role

For a systems engineer, wiidede/exif-gallery-nuxt belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-01T17:30:55Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-f7f91c6e8716e7` from `github_search_photography` as `registry_expansion`
