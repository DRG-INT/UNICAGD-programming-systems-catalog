...
| Canonical URL | [https://github.com/Apress/low-level-programming](https://github.com/Apress/low-level-programming) |
| Source record ids | github_search_assembly-7607be9518fcc6 |
...
For a systems engineer, Apress/low-level-programming belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2017-07-14T15:19:19Z | [https://api.github.com/repos/Apress/low-level-programming/releases/latest](https://api.github.com/repos/Apress/low-level-programming/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Apress/low-level-programming/releases/latest` at `2026-09-01T07:24:24+00:00`.
...
- `github_search_assembly-7607be9518fcc6` from `github_search_assembly` as `registry_expansion`
...
| below/HelloSilicon | Language Specification | [open](assembly-below-hellosilicon-8ff6614f.md) |
