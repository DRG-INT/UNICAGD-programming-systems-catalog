...
<!-- canonical: https://luarocks.org/modules/peterbillam/ao -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/peterbillam/ao](https://luarocks.org/modules/peterbillam/ao) |
| Source record ids | luarocks_root_manifest-1e3e24501c247e |
...
For a systems engineer, ao belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1e3e24501c247e` from `luarocks_root_manifest` as `registry_expansion`
