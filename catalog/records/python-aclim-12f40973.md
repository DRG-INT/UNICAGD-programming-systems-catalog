...
<!-- canonical: https://pypi.org/project/aclim/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclim/](https://pypi.org/project/aclim/) |
| Source record ids | pypi_simple-928cfcbd206311 |

## System Engineer Summary

Official reserved package name for the ACLIM formal name.

## Operational Role

For a systems engineer, aclim belongs in the Python inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-04-13T08:14:55.098664Z | [https://pypi.org/pypi/aclim/json](https://pypi.org/pypi/aclim/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclim/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-928cfcbd206311` from `pypi_simple` as `registry_expansion`
...
| acn-client | Ffi Bindings | [open](python-acn-client-1221a4fa.md) |
