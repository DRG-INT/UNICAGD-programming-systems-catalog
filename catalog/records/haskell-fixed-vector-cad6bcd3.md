...
<!-- canonical: https://hackage.haskell.org/package/fixed-vector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fixed-vector](https://hackage.haskell.org/package/fixed-vector) |
| Source record ids | hackage_top_downloads-a6a9c21ade708a |
...
For a systems engineer, fixed-vector belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1.0 | 2026-02-28T11:56:35Z | [https://hackage.haskell.org/package/fixed-vector](https://hackage.haskell.org/package/fixed-vector) |  |
| candidate | partial | 0.5.1.1 |  | [https://hackage.haskell.org/package/fixed-vector](https://hackage.haskell.org/package/fixed-vector) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fixed-vector` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-a6a9c21ade708a` from `hackage_top_downloads` as `registry_expansion`
