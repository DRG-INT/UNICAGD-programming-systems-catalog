...
<!-- canonical: https://crates.io/crates/dunce -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/dunce](https://crates.io/crates/dunce) |
| Source record ids | crates_io-44401b9b062ea6 |
...
For a systems engineer, dunce belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2024-08-04T01:36:46.487482Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-44401b9b062ea6` from `crates_io` as `registry_expansion`
