...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Idov31/Cronos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Idov31/Cronos](https://github.com/Idov31/Cronos) |
| Source record ids | github_search_assembly-c49c1fd87e64b4 |
...
For a systems engineer, Idov31/Cronos belongs in the Assembly inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-26T18:06:10Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_assembly-c49c1fd87e64b4` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| enkomio/thematrix | Static Analyzer | [open](assembly-enkomio-thematrix-8cd2748c.md) |
| mandiant/flare-learning-hub | Static Analyzer | [open](assembly-mandiant-flare-learning-hub-36dc67ad.md) |
| mohitmishra786/reversingBits | Static Analyzer | [open](assembly-mohitmishra786-reversingbits-a3d9abef.md) |
| RRZE-HPC/OSACA | Static Analyzer | [open](assembly-rrze-hpc-osaca-67fcadc4.md) |
| x86byte/RE-MA-Roadmap | Static Analyzer | [open](assembly-x86byte-re-ma-roadmap-041535bd.md) |
