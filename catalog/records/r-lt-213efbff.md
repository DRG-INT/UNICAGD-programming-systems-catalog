...
<!-- canonical: https://cran.r-project.org/web/packages/lt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lt/index.html](https://cran.r-project.org/web/packages/lt/index.html) |
| Source record ids | cran_packages_by_date-3453f09a8ab342 |

## System Engineer Summary

Lightweight Tables via JSON Specs and JavaScript

## Operational Role

For a systems engineer, lt belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4 | 2026-09-01 16:00:08 UTC | [https://cran.r-project.org/web/packages/lt/DESCRIPTION](https://cran.r-project.org/web/packages/lt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lt/DESCRIPTION` at `2026-09-01T16:41:04+00:00`.
...
- `cran_packages_by_date-3453f09a8ab342` from `cran_packages_by_date` as `registry_expansion`
