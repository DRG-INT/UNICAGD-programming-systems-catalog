...
<!-- canonical: https://cran.r-project.org/web/packages/NPCDTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NPCDTools/index.html](https://cran.r-project.org/web/packages/NPCDTools/index.html) |
| Source record ids | cran_packages_by_date-b07fb9c19dd8a2 |
...
For a systems engineer, NPCDTools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-31 22:20:13 UTC | [https://cran.r-project.org/web/packages/NPCDTools/DESCRIPTION](https://cran.r-project.org/web/packages/NPCDTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NPCDTools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b07fb9c19dd8a2` from `cran_packages_by_date` as `registry_expansion`
