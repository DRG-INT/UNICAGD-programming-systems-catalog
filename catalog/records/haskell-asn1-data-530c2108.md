...
<!-- canonical: https://hackage.haskell.org/package/asn1-data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/asn1-data](https://hackage.haskell.org/package/asn1-data) |
| Source record ids | hackage_top_downloads-b41c385ffe2964 |
...
For a systems engineer, asn1-data belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2015-09-07T09:57:38Z | [https://hackage.haskell.org/package/asn1-data](https://hackage.haskell.org/package/asn1-data) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/asn1-data` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-b41c385ffe2964` from `hackage_top_downloads` as `registry_expansion`
