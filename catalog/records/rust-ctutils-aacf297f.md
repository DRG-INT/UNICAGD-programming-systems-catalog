...
<!-- canonical: https://crates.io/crates/ctutils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ctutils](https://crates.io/crates/ctutils) |
| Source record ids | crates_io-0151188ff0dcad |
...
For a systems engineer, ctutils belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-04-02T20:44:34.184153Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-08T12:26:38+00:00`.
...
- `crates_io-0151188ff0dcad` from `crates_io` as `registry_expansion`
