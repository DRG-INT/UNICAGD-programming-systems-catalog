...
<!-- canonical: https://luarocks.org/modules/istr/cdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/istr/cdb](https://luarocks.org/modules/istr/cdb) |
| Source record ids | luarocks_root_manifest-1eaa2253d84d7f |
...
For a systems engineer, cdb belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-1eaa2253d84d7f` from `luarocks_root_manifest` as `registry_expansion`
