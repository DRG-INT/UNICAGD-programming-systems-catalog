# JustinLove/section_of_foreign_intelligence
...
<!-- canonical: https://github.com/JustinLove/section_of_foreign_intelligence -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JustinLove/section_of_foreign_intelligence](https://github.com/JustinLove/section_of_foreign_intelligence) |
| Source record ids | github_search_space_maps-c2080544402e56 |

## System Engineer Summary

Mod for Planetary Annihilation that adds a preview of the number and strength of enemy commanders to
the Galactic War map system detail

## Operational Role

For a systems engineer, JustinLove/section_of_foreign_intelligence belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-10T18:45:49Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-c2080544402e56` from `github_search_space_maps` as `registry_expansion`
...
| ThomasWinn/repo-AiPlanetaryWars | Machine Learning | [open](space-maps-thomaswinn-repo-aiplanetarywars-389320ec.md) |
