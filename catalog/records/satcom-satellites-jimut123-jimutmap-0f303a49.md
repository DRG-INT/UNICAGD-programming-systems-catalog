...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Jimut123/jimutmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jimut123/jimutmap](https://github.com/Jimut123/jimutmap) |
| Source record ids | github_search_satcom_satellites-dd7701c9e56725 |

## System Engineer Summary

API to get enormous amount of high resolution satellite images from satellites.pro quickly through
multi-threading! create map your own map dataset. Bringing data to Humans.

## Operational Role

For a systems engineer, Jimut123/jimutmap belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.4.5 | 2023-06-30T20:37:06Z | [https://api.github.com/repos/Jimut123/jimutmap/releases/latest](https://api.github.com/repos/Jimut123/jimutmap/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Jimut123/jimutmap/releases/latest` at `2026-09-01T08:26:35+00:00`.
...
- `github_search_satcom_satellites-dd7701c9e56725` from `github_search_satcom_satellites` as `registry_expansion`
