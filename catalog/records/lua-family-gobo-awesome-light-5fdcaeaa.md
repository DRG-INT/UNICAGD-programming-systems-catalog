...
| Canonical URL | [https://luarocks.org/modules/hisham/gobo-awesome-light](https://luarocks.org/modules/hisham/gobo-awesome-light) |
| Source record ids | luarocks_root_manifest-43fc370729be8d |

## System Engineer Summary

gobo-awesome-light is tracked as a community reference record in the Lua family branch. The source
...
For a systems engineer, gobo-awesome-light belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-43fc370729be8d` from `luarocks_root_manifest` as `registry_expansion`
