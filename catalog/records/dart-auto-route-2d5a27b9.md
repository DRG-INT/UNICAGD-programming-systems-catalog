...
<!-- canonical: https://pub.dev/packages/auto_route -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/auto_route](https://pub.dev/packages/auto_route) |
| Source record ids | pub_dev-49d537473fe689 |
...
For a systems engineer, auto_route belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.1.0 | 2025-12-16T17:41:04.571709Z | [https://pub.dev/api/packages/auto_route](https://pub.dev/api/packages/auto_route) |  |
| preview | known | 6.0.0-rc-7 | 2023-03-15T16:04:29.182890Z | [https://pub.dev/api/packages/auto_route](https://pub.dev/api/packages/auto_route) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/auto_route` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-49d537473fe689` from `pub_dev` as `registry_expansion`
