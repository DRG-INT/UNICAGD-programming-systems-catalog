...
<!-- canonical: https://crates.io/crates/wasm-streams -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasm-streams](https://crates.io/crates/wasm-streams) |
| Source record ids | crates_io-fe5c5a61c02bee |
...
For a systems engineer, wasm-streams belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-05-24T13:46:25.406359Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-fe5c5a61c02bee` from `crates_io` as `registry_expansion`
