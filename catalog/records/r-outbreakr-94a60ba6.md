...
<!-- canonical: https://cran.r-project.org/web/packages/OutbreakR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OutbreakR/index.html](https://cran.r-project.org/web/packages/OutbreakR/index.html) |
| Source record ids | cran_packages_by_date-c684db63662c22 |

## System Engineer Summary

Epidemiological Tools for Outbreak Investigation and Analysis

## Operational Role

For a systems engineer, OutbreakR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 14:10:31 UTC | [https://cran.r-project.org/web/packages/OutbreakR/DESCRIPTION](https://cran.r-project.org/web/packages/OutbreakR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OutbreakR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c684db63662c22` from `cran_packages_by_date` as `registry_expansion`
