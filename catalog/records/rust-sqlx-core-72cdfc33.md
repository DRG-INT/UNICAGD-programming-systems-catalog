...
<!-- canonical: https://crates.io/crates/sqlx-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlx-core](https://crates.io/crates/sqlx-core) |
| Source record ids | crates_io-c540cd47289a4f |
...
For a systems engineer, sqlx-core belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-05-21T17:33:20.890999Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Evidence | GPL-2 \| GPL-3; {"key": "", "name": "", "url": ""} |
...
- `crates_io-c540cd47289a4f` from `crates_io` as `registry_expansion`
