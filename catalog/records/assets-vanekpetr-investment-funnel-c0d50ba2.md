...
<!-- canonical: https://github.com/VanekPetr/investment-funnel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VanekPetr/investment-funnel](https://github.com/VanekPetr/investment-funnel) |
| Source record ids | github_search_assets-1b37cc4e4c82d8 |

## System Engineer Summary

Investment Funnel 📈 is an open-source python platform designed for an easy development and
backtesting of outperforming investment strategies.

## Operational Role

For a systems engineer, VanekPetr/investment-funnel belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T02:14:40Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-1b37cc4e4c82d8` from `github_search_assets` as `registry_expansion`
