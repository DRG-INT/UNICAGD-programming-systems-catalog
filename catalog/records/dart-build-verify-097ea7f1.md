...
<!-- canonical: https://pub.dev/packages/build_verify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/build_verify](https://pub.dev/packages/build_verify) |
| Source record ids | pub_dev-5d1139d7f03263 |
...
For a systems engineer, build_verify belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2025-06-13T16:57:12.994613Z | [https://pub.dev/api/packages/build_verify](https://pub.dev/api/packages/build_verify) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/build_verify` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-5d1139d7f03263` from `pub_dev` as `registry_expansion`
