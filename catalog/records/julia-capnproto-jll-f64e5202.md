...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/C/capnproto_jll](https://github.com/JuliaRegistries/General/tree/master/jll/C/capnproto_jll) |
| Source record ids | julia_general-f26cd0b687619e |

## System Engineer Summary

Julia package registered in General at jll/C/capnproto_jll.

## Operational Role

For a systems engineer, capnproto_jll belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/C/capnproto_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f26cd0b687619e` from `julia_general` as `registry_expansion`
