...
| Canonical URL | [https://www.npmjs.com/package/@expo/build-tools](https://www.npmjs.com/package/@expo/build-tools) |
| Source record ids | npm_registry-e6f2e7b9637aef |

## System Engineer Summary

`@expo/build-tools` is the core library for the EAS Build service. It implements the build process
for React Native projects and for managed Expo applications.

## Operational Role

For a systems engineer, @expo/build-tools belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 23.2.0 | 2026-08-31T20:27:28.121Z | [https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-e6f2e7b9637aef` from `npm_registry` as `registry_expansion`
