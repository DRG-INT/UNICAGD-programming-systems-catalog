...
<!-- canonical: https://cran.r-project.org/web/packages/armadillo4r/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/armadillo4r/index.html](https://cran.r-project.org/web/packages/armadillo4r/index.html) |
| Source record ids | cran_packages_by_date-04850bd56bace5 |
...
For a systems engineer, armadillo4r belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 15.4.2 | 2026-08-23 15:20:10 UTC | [https://cran.r-project.org/web/packages/armadillo4r/DESCRIPTION](https://cran.r-project.org/web/packages/armadillo4r/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/armadillo4r/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-04850bd56bace5` from `cran_packages_by_date` as `registry_expansion`
