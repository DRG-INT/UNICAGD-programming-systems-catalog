...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/rsmatrix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rsmatrix/index.html](https://cran.r-project.org/web/packages/rsmatrix/index.html) |
| Source record ids | cran_packages_by_date-96f3fd5a584c6f |
...
For a systems engineer, rsmatrix belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-30 04:40:02 UTC | [https://cran.r-project.org/web/packages/rsmatrix/DESCRIPTION](https://cran.r-project.org/web/packages/rsmatrix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rsmatrix/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-96f3fd5a584c6f` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| eq5d | Registry Repository | [open](r-eq5d-6d0b04da.md) |
| pressfreedom.data | Registry Repository | [open](r-pressfreedom-data-a74cd050.md) |
| Qindex | Registry Repository | [open](r-qindex-6006e0ca.md) |
| Qindex.data | Registry Repository | [open](r-qindex-data-9963844a.md) |
| RESI | Registry Repository | [open](r-resi-c14c374d.md) |
| SII | Registry Repository | [open](r-sii-8129f3b9.md) |
