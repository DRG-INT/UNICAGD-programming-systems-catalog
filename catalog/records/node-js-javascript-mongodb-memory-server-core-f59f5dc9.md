...
<!-- canonical: https://www.npmjs.com/package/mongodb-memory-server-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mongodb-memory-server-core](https://www.npmjs.com/package/mongodb-memory-server-core) |
| Source record ids | npm_registry-b982d5529beed4 |

## System Engineer Summary

MongoDB Server for testing (core package, without autodownload). The server will allow you to
connect your favourite ODM or client library to the MongoDB Server and run parallel integration
tests isolated from each other.

## Operational Role

For a systems engineer, mongodb-memory-server-core belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.2.0 | 2026-05-28T10:20:42.726Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-b982d5529beed4` from `npm_registry` as `registry_expansion`
