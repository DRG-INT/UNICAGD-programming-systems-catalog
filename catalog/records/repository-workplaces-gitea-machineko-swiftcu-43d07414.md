...
<!-- canonical: https://gitea.com/machineko/SwiftCU -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/machineko/SwiftCU](https://gitea.com/machineko/SwiftCU) |
| Source record ids | gitea_repositories_api-e8b7b6640edaa3 |

## System Engineer Summary

SwiftCU is a wrapper for CUDA runtime API's (exposed as cxxCU) with extra utilities for device
management, memory ops and kernel execution, along with a robust suite of tests. Repo is tested on
newest (v12.5) CUDA runtime API on both Linux and Windows.

## Operational Role

For a systems engineer, Gitea: machineko/SwiftCU belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-07T20:00:18Z | [https://gitea.com/api/v1/repos/search?q=runtime&limit=50](https://gitea.com/api/v1/repos/search?q=runtime&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-e8b7b6640edaa3` from `gitea_repositories_api` as `registry_expansion`
