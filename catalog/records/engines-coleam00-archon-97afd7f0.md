...
<!-- canonical: https://github.com/coleam00/Archon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coleam00/Archon](https://github.com/coleam00/Archon) |
| Source record ids | github_search_engines-c85fa39b69462a |
...
For a systems engineer, coleam00/Archon belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T21:00:47Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-c85fa39b69462a` from `github_search_engines` as `registry_expansion`
