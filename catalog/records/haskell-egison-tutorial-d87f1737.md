...
<!-- canonical: https://hackage.haskell.org/package/egison-tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/egison-tutorial](https://hackage.haskell.org/package/egison-tutorial) |
| Source record ids | hackage_top_downloads-fec6bbc6cf776e |
...
For a systems engineer, egison-tutorial belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.3 | 2021-12-18T11:33:44Z | [https://hackage.haskell.org/package/egison-tutorial](https://hackage.haskell.org/package/egison-tutorial) |  |
| candidate | partial | 3.7.1 |  | [https://hackage.haskell.org/package/egison-tutorial](https://hackage.haskell.org/package/egison-tutorial) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/egison-tutorial` at `2026-09-09T00:34:57+00:00`.
...
- `hackage_top_downloads-fec6bbc6cf776e` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cookbook | Tutorial Book Styleguide | [open](haskell-cookbook-13d16884.md) |
