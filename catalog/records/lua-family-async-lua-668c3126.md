...
<!-- canonical: https://luarocks.org/modules/sclu1034/async.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/sclu1034/async.lua](https://luarocks.org/modules/sclu1034/async.lua) |
| Source record ids | luarocks_root_manifest-f19d45f9a71e4f |
...
For a systems engineer, async.lua belongs in the Lua family inventory as part of concurrency
...
- `luarocks_root_manifest-f19d45f9a71e4f` from `luarocks_root_manifest` as `registry_expansion`
