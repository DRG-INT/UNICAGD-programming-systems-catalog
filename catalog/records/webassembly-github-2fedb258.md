...
<!-- canonical: https://github.com/webassembly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/webassembly](https://github.com/webassembly) |
| Source record ids | awesome_list-a5ecafb6b7f2b8 |

## System Engineer Summary

GitHub is tracked as an undefined behavior analyzer record in the WebAssembly branch. The source did
...
For a systems engineer, GitHub belongs in the WebAssembly inventory as part of ecosystem capability
...
- `awesome_list-a5ecafb6b7f2b8` from `awesome_list` as `registry_expansion`
