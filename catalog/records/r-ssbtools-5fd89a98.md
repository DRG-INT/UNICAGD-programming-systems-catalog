...
<!-- canonical: https://cran.r-project.org/web/packages/SSBtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SSBtools/index.html](https://cran.r-project.org/web/packages/SSBtools/index.html) |
| Source record ids | cran_packages_by_date-7c8e471fd3e827 |
...
For a systems engineer, SSBtools belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.8 | 2026-08-21 22:01:09 UTC | [https://cran.r-project.org/web/packages/SSBtools/DESCRIPTION](https://cran.r-project.org/web/packages/SSBtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SSBtools/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7c8e471fd3e827` from `cran_packages_by_date` as `registry_expansion`
