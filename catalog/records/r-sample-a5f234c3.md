...
<!-- canonical: https://cran.r-project.org/web/packages/SAMPLE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SAMPLE/index.html](https://cran.r-project.org/web/packages/SAMPLE/index.html) |
| Source record ids | cran_packages_by_date-823557145e8e1b |

## System Engineer Summary

Estimate Sampling Effort for Species Occurrence Rates

## Operational Role

For a systems engineer, SAMPLE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-15 11:30:08 UTC | [https://cran.r-project.org/web/packages/SAMPLE/DESCRIPTION](https://cran.r-project.org/web/packages/SAMPLE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SAMPLE/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-823557145e8e1b` from `cran_packages_by_date` as `registry_expansion`
