...
<!-- canonical: https://github.com/k3s-io/k3s -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/k3s-io/k3s](https://github.com/k3s-io/k3s) |
| Source record ids | github_search_go-bc5e3a7c7bd5cd |

## System Engineer Summary

k3s-io/k3s is tracked as a language specification record in the Go branch. The source did not
...
For a systems engineer, k3s-io/k3s belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T18:24:04Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-bc5e3a7c7bd5cd` from `github_search_go` as `registry_expansion`
