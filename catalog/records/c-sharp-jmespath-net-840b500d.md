...
<!-- canonical: https://www.nuget.org/packages/JmesPath.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JmesPath.Net](https://www.nuget.org/packages/JmesPath.Net) |
| Source record ids | nuget_search-6783b16870f716 |
...
For a systems engineer, JmesPath.Net belongs in the C-Sharp inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-03-05T08:23:12.26+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jmespath.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jmespath.net/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache-2.0; https://www.nuget.org/packages/JmesPath.Net/1.1.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jmespath.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-6783b16870f716` from `nuget_search` as `registry_expansion`
...
| SpecFlow.Internal.Json | Parser Lexer Ast | [open](c-sharp-specflow-internal-json-601af665.md) |
