...
<!-- canonical: https://cran.r-project.org/web/packages/anovapowersim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/anovapowersim/index.html](https://cran.r-project.org/web/packages/anovapowersim/index.html) |
| Source record ids | cran_packages_by_date-d2e770315e6060 |
...
For a systems engineer, anovapowersim belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-09 12:10:02 UTC | [https://cran.r-project.org/web/packages/anovapowersim/DESCRIPTION](https://cran.r-project.org/web/packages/anovapowersim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/anovapowersim/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-d2e770315e6060` from `cran_packages_by_date` as `registry_expansion`
