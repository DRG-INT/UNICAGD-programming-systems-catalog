...
<!-- canonical: https://github.com/CodecWang/opencv-python-tutorial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodecWang/opencv-python-tutorial](https://github.com/CodecWang/opencv-python-tutorial) |
| Source record ids | github_search_photography-6965b2093ae053 |
...
For a systems engineer, CodecWang/opencv-python-tutorial belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-11T11:22:35Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-6965b2093ae053` from `github_search_photography` as `registry_expansion`
