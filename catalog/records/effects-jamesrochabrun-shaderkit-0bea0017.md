...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jamesrochabrun/ShaderKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jamesrochabrun/ShaderKit](https://github.com/jamesrochabrun/ShaderKit) |
| Source record ids | github_search_effects-17c3b7aa275fbf |
...
For a systems engineer, jamesrochabrun/ShaderKit belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T19:41:34Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-17c3b7aa275fbf` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AhmadHassan-BTed/RoseWish | Logging Observability | [open](effects-ahmadhassan-bted-rosewish-dceb8ccb.md) |
| AnalogFeelings/godot-psx | Logging Observability | [open](effects-analogfeelings-godot-psx-57803d35.md) |
| bpisano/Sticker | Logging Observability | [open](effects-bpisano-sticker-3a964c87.md) |
| delirvfx/Delir | Logging Observability | [open](effects-delirvfx-delir-589e1244.md) |
| emilwidlund/alma | Logging Observability | [open](effects-emilwidlund-alma-df8cec5c.md) |
| mkkellogg/Photons2 | Logging Observability | [open](effects-mkkellogg-photons2-c636d17d.md) |
| mob-sakai/StaticBluredScreen | Logging Observability | [open](effects-mob-sakai-staticbluredscreen-4a8f9a54.md) |
| sevagh/pitch-detection | Logging Observability | [open](effects-sevagh-pitch-detection-f6fea54d.md) |
