...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ChrisChen667788/pixcull -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChrisChen667788/pixcull](https://github.com/ChrisChen667788/pixcull) |
| Source record ids | github_search_photography-4350acc4572249 |

## System Engineer Summary

Local-first AI photo culling for professional photographers — 6-axis rubric, XMP/IPTC export,
Lightroom & Capture One ready.

## Operational Role

For a systems engineer, ChrisChen667788/pixcull belongs in the Photography inventory as part of
...
- `github_search_photography-4350acc4572249` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashesbloom/LocalLens | Package Manager | [open](photography-ashesbloom-locallens-2ee3b0cd.md) |
| awawa-dev/HyperHDR | Package Manager | [open](photography-awawa-dev-hyperhdr-e35f8c3a.md) |
| bean-mhm/flim | Package Manager | [open](photography-bean-mhm-flim-3c680854.md) |
| james-see/iptcinfo3 | Package Manager | [open](photography-james-see-iptcinfo3-05875274.md) |
| kepengxu/RealCamNet | Package Manager | [open](photography-kepengxu-realcamnet-aaafb86d.md) |
| loliri/Starshot | Package Manager | [open](photography-loliri-starshot-54549de2.md) |
| SlavaSexton/ComfyUI-OCIO | Package Manager | [open](photography-slavasexton-comfyui-ocio-367e8dd5.md) |
| snapotter-hq/SnapOtter | Package Manager | [open](photography-snapotter-hq-snapotter-d8fb50c1.md) |
