...
| Canonical URL | [https://crates.io/crates/tabled](https://crates.io/crates/tabled) |
| Source record ids | crates_io-3665e1277cb76a |
...
For a systems engineer, tabled belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.21.0 | 2026-05-31T22:30:21.291367Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-3665e1277cb76a` from `crates_io` as `registry_expansion`
