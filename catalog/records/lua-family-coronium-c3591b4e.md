...
<!-- canonical: https://develephant.github.io/coronium-core-docs/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://develephant.github.io/coronium-core-docs/](https://develephant.github.io/coronium-core-docs/) |
| Source record ids | lua-source-124 |
...
For a systems engineer, Coronium belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 124}}` |
...
- `lua-source-124` from `master_json` as `source_list_item`
