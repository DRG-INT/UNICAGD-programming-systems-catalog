...
<!-- canonical: https://cran.r-project.org/web/packages/edf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/edf/index.html](https://cran.r-project.org/web/packages/edf/index.html) |
| Source record ids | cran_packages_by_date-be08c0f7f4262b |
...
For a systems engineer, edf belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-31 14:50:02 UTC | [https://cran.r-project.org/web/packages/edf/DESCRIPTION](https://cran.r-project.org/web/packages/edf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/edf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-be08c0f7f4262b` from `cran_packages_by_date` as `registry_expansion`
