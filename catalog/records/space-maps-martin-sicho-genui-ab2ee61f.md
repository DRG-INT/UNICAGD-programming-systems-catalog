...
<!-- canonical: https://github.com/martin-sicho/genui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/martin-sicho/genui](https://github.com/martin-sicho/genui) |
| Source record ids | github_search_space_maps-4bd2f85e038b13 |

## System Engineer Summary

The backend services of the GenUI framework. The backend provides the REST API used for molecular
generation, QSAR modelling and chemical space visualization.

## Operational Role

For a systems engineer, martin-sicho/genui belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-03T09:59:24Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4bd2f85e038b13` from `github_search_space_maps` as `registry_expansion`
