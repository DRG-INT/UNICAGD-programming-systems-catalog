...
<!-- canonical: https://cran.r-project.org/web/packages/allofus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/allofus/index.html](https://cran.r-project.org/web/packages/allofus/index.html) |
| Source record ids | cran_packages_by_date-f65c161ac1f372 |
...
For a systems engineer, allofus belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-09-03 15:40:08 UTC | [https://cran.r-project.org/web/packages/allofus/DESCRIPTION](https://cran.r-project.org/web/packages/allofus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/allofus/DESCRIPTION` at `2026-09-03T17:18:57+00:00`.
...
- `cran_packages_by_date-f65c161ac1f372` from `cran_packages_by_date` as `registry_expansion`
