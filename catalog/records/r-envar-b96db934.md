...
<!-- canonical: https://cran.r-project.org/web/packages/envar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/envar/index.html](https://cran.r-project.org/web/packages/envar/index.html) |
| Source record ids | cran_packages_by_date-d09da408768837 |
...
For a systems engineer, envar belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-21 05:43:51 UTC | [https://cran.r-project.org/web/packages/envar/DESCRIPTION](https://cran.r-project.org/web/packages/envar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/envar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d09da408768837` from `cran_packages_by_date` as `registry_expansion`
...
| needenv | Configuration | [open](r-needenv-824efe2b.md) |
