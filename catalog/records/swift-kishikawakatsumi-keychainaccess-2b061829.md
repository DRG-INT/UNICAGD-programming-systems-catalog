...
<!-- canonical: https://github.com/kishikawakatsumi/KeychainAccess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kishikawakatsumi/KeychainAccess](https://github.com/kishikawakatsumi/KeychainAccess) |
| Source record ids | github_search_swift-6910d1c38bfb4f |
...
For a systems engineer, kishikawakatsumi/KeychainAccess belongs in the Swift inventory as part of
...
- `github_search_swift-6910d1c38bfb4f` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| maxgoedjen/secretive | Security Sast | [open](swift-maxgoedjen-secretive-1285aac6.md) |
