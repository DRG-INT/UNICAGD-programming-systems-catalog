...
<!-- canonical: https://github.com/cs-chan/Exclusively-Dark-Image-Dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cs-chan/Exclusively-Dark-Image-Dataset](https://github.com/cs-chan/Exclusively-Dark-Image-Dataset) |
| Source record ids | github_search_matlab-aa39db56465ef6 |

## System Engineer Summary

Exclusively Dark (ExDARK) dataset which to the best of our knowledge, is the largest collection of
low-light images taken in very low-light environments to twilight (i.e 10 different conditions) to-
date with image class and object level annotations.

## Operational Role

For a systems engineer, cs-chan/Exclusively-Dark-Image-Dataset belongs in the Matlab inventory as
...
- `github_search_matlab-aa39db56465ef6` from `github_search_matlab` as `registry_expansion`
