...
<!-- canonical: https://github.com/PyLCARS/Python-and-SPICE-Book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PyLCARS/Python-and-SPICE-Book](https://github.com/PyLCARS/Python-and-SPICE-Book) |
| Source record ids | github_search_space_maps-2083fa51d0b607 |

## System Engineer Summary

Unfinished open book on circuit simulation in Python with PySpice and ngspice

## Operational Role

For a systems engineer, PyLCARS/Python-and-SPICE-Book belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-28T07:51:03Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2083fa51d0b607` from `github_search_space_maps` as `registry_expansion`
