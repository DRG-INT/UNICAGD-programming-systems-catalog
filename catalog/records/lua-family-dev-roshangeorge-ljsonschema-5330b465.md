...
<!-- canonical: https://luarocks.org/modules/roshan/dev-roshangeorge-ljsonschema -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/roshan/dev-roshangeorge-ljsonschema](https://luarocks.org/modules/roshan/dev-roshangeorge-ljsonschema) |
| Source record ids | luarocks_root_manifest-95cb2586389205 |
...
For a systems engineer, dev-roshangeorge-ljsonschema belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-95cb2586389205` from `luarocks_root_manifest` as `registry_expansion`
