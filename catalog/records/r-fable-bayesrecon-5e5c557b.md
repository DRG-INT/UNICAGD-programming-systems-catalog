...
<!-- canonical: https://cran.r-project.org/web/packages/fable.bayesRecon/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fable.bayesRecon/index.html](https://cran.r-project.org/web/packages/fable.bayesRecon/index.html) |
| Source record ids | cran_packages_by_date-7d51f831115250 |
...
For a systems engineer, fable.bayesRecon belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 08:20:26 UTC | [https://cran.r-project.org/web/packages/fable.bayesRecon/DESCRIPTION](https://cran.r-project.org/web/packages/fable.bayesRecon/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fable.bayesRecon/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7d51f831115250` from `cran_packages_by_date` as `registry_expansion`
