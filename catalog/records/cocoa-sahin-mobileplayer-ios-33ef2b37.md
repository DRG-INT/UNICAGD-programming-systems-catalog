...
<!-- canonical: https://github.com/sahin/mobileplayer-ios -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sahin/mobileplayer-ios](https://github.com/sahin/mobileplayer-ios) |
| Source record ids | github_search_cocoa-623a7f6d21649a |
...
For a systems engineer, sahin/mobileplayer-ios belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-21T22:10:51Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other |
...
- `github_search_cocoa-623a7f6d21649a` from `github_search_cocoa` as `registry_expansion`
