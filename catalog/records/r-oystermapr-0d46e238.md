...
<!-- canonical: https://cran.r-project.org/web/packages/oystermapR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/oystermapR/index.html](https://cran.r-project.org/web/packages/oystermapR/index.html) |
| Source record ids | cran_packages_by_date-770740e0deee73 |
...
For a systems engineer, oystermapR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-08-31 19:00:02 UTC | [https://cran.r-project.org/web/packages/oystermapR/DESCRIPTION](https://cran.r-project.org/web/packages/oystermapR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/oystermapR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-770740e0deee73` from `cran_packages_by_date` as `registry_expansion`
