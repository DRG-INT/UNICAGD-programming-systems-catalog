...
| Source record ids | github_search_pattern_language-9788ebe76d4597 |
...
For a systems engineer, tmrts/go-patterns belongs in the Pattern language inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-14T01:07:28Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-9788ebe76d4597` from `github_search_pattern_language` as `registry_expansion`
