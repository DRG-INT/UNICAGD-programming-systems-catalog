...
| Canonical URL | [https://crates.io/crates/test-case-core](https://crates.io/crates/test-case-core) |
| Source record ids | crates_io-d3e3df01c635e5 |

## System Engineer Summary

Provides core functionality for parsing #test_case(...) procedural macro attribute for generating
parametrized test cases easily

## Operational Role

For a systems engineer, test-case-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.1 | 2023-11-17T20:16:23.910151Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-d3e3df01c635e5` from `crates_io` as `registry_expansion`
