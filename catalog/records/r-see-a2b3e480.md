...
<!-- canonical: https://cran.r-project.org/web/packages/see/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/see/index.html](https://cran.r-project.org/web/packages/see/index.html) |
| Source record ids | cran_packages_by_date-0de05b43785129 |
...
For a systems engineer, see belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.2 | 2026-09-01 12:30:02 UTC | [https://cran.r-project.org/web/packages/see/DESCRIPTION](https://cran.r-project.org/web/packages/see/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/see/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0de05b43785129` from `cran_packages_by_date` as `registry_expansion`
