...
<!-- canonical: https://cran.r-project.org/web/packages/hcinfer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hcinfer/index.html](https://cran.r-project.org/web/packages/hcinfer/index.html) |
| Source record ids | cran_packages_by_date-6e961da972f71e |
...
For a systems engineer, hcinfer belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-25 21:00:02 UTC | [https://cran.r-project.org/web/packages/hcinfer/DESCRIPTION](https://cran.r-project.org/web/packages/hcinfer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hcinfer/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6e961da972f71e` from `cran_packages_by_date` as `registry_expansion`
