...
<!-- canonical: https://github.com/wasmerio/python-ext-wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmerio/python-ext-wasm](https://github.com/wasmerio/python-ext-wasm) |
| Source record ids | awesome_list-c0d94ae35da899 |

## System Engineer Summary

Wasmer for Python is tracked as a library record in the WebAssembly branch. The source did not
...
For a systems engineer, Wasmer for Python belongs in the WebAssembly inventory as part of ecosystem
...
- `awesome_list-c0d94ae35da899` from `awesome_list` as `registry_expansion`
