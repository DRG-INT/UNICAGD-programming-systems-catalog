...
<!-- canonical: https://cran.r-project.org/web/packages/icons/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/icons/index.html](https://cran.r-project.org/web/packages/icons/index.html) |
| Source record ids | cran_packages_by_date-e49f8ecafd4f81 |

## System Engineer Summary

Easily Insert SVG Icons into R Outputs

## Operational Role

For a systems engineer, icons belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-03 12:10:14 UTC | [https://cran.r-project.org/web/packages/icons/DESCRIPTION](https://cran.r-project.org/web/packages/icons/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/icons/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-e49f8ecafd4f81` from `cran_packages_by_date` as `registry_expansion`
