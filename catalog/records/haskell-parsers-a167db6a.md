...
<!-- canonical: https://hackage.haskell.org/package/parsers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/parsers](https://hackage.haskell.org/package/parsers) |
| Source record ids | hackage_top_downloads-241688a0d2e1a2 |
...
For a systems engineer, parsers belongs in the Haskell inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.12 | 2024-10-26T19:58:41Z | [https://hackage.haskell.org/package/parsers](https://hackage.haskell.org/package/parsers) |  |
| candidate | partial | 0.12.6 |  | [https://hackage.haskell.org/package/parsers](https://hackage.haskell.org/package/parsers) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/parsers` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-241688a0d2e1a2` from `hackage_top_downloads` as `registry_expansion`
