...
<!-- canonical: https://crates.io/crates/cfg_aliases -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cfg_aliases](https://crates.io/crates/cfg_aliases) |
| Source record ids | crates_io-805b2fafdac044 |
...
For a systems engineer, cfg_aliases belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-07-16T14:57:16.699789Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-805b2fafdac044` from `crates_io` as `registry_expansion`
