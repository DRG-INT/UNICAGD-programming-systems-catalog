...
<!-- canonical: https://github.com/psampaz/go-mod-outdated -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psampaz/go-mod-outdated](https://github.com/psampaz/go-mod-outdated) |
| Source record ids | github_search_go-7c15c60be66ddf |

## System Engineer Summary

Find outdated dependencies of your Go projects. go-mod-outdated provides a table view of the go list
-u -m -json all command which lists all dependencies of a Go project and their available minor and
patch updates. It also provides a way to filter indirect dependencies and dependencies without
updates.

## Operational Role

For a systems engineer, psampaz/go-mod-outdated belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-19T20:22:43Z | gh search repos topic:go-modules stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-7c15c60be66ddf` from `github_search_go` as `registry_expansion`
