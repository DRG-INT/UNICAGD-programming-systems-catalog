...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/flutter_localization -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_localization](https://pub.dev/packages/flutter_localization) |
| Source record ids | pub_dev-456c6050f4dee8 |

## System Engineer Summary

Flutter Localization is a package use for in-app localization with map data. More easier and faster
to implement and inspired by the flutter_localizations itself.

## Operational Role

For a systems engineer, flutter_localization belongs in the Dart inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-06-27T11:24:38.070693Z | [https://pub.dev/api/packages/flutter_localization](https://pub.dev/api/packages/flutter_localization) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_localization` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-456c6050f4dee8` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| another_flushbar | Parser Lexer Ast | [open](dart-another-flushbar-37336a0b.md) |
| args | Parser Lexer Ast | [open](dart-args-8edaa41c.md) |
| bonsoir | Parser Lexer Ast | [open](dart-bonsoir-bb5da73a.md) |
| boolean_selector | Parser Lexer Ast | [open](dart-boolean-selector-fec28f23.md) |
| bot_toast | Parser Lexer Ast | [open](dart-bot-toast-b7903dbd.md) |
| confetti | Parser Lexer Ast | [open](dart-confetti-dc49ae1e.md) |
| enum_to_string | Parser Lexer Ast | [open](dart-enum-to-string-d311278a.md) |
| fast_immutable_collections | Parser Lexer Ast | [open](dart-fast-immutable-collections-4cd6a34f.md) |
