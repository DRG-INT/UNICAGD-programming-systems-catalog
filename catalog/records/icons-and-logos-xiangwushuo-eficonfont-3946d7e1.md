...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/XiangWuShuo/EFIconFont -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/XiangWuShuo/EFIconFont](https://github.com/XiangWuShuo/EFIconFont) |
| Source record ids | github_search_icons_and_logos-aa9b97aadbbd22 |
...
For a systems engineer, XiangWuShuo/EFIconFont belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-26T12:03:40Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_icons_and_logos-aa9b97aadbbd22` from `github_search_icons_and_logos` as `registry_expansion`
