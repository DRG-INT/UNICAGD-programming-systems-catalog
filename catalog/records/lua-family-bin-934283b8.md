...
<!-- canonical: https://luarocks.org/modules/rayaman/bin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/rayaman/bin](https://luarocks.org/modules/rayaman/bin) |
| Source record ids | luarocks_root_manifest-095abcf247815c |
...
For a systems engineer, bin belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-095abcf247815c` from `luarocks_root_manifest` as `registry_expansion`
