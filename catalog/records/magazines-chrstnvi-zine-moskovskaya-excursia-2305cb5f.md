# chrstnvi/zine-moskovskaya-excursia
...
<!-- canonical: https://github.com/chrstnvi/zine-moskovskaya-excursia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chrstnvi/zine-moskovskaya-excursia](https://github.com/chrstnvi/zine-moskovskaya-excursia) |
| Source record ids | github_search_magazines-75365fdf47c158 |

## System Engineer Summary

Experimental zine and interactive case based on Pamela Travers’ Moscow Excursion (1934).

## Operational Role

For a systems engineer, chrstnvi/zine-moskovskaya-excursia belongs in the Magazines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T17:11:23Z | gh search repos topic:zine stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-75365fdf47c158` from `github_search_magazines` as `registry_expansion`
