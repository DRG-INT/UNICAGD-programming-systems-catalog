...
<!-- canonical: https://github.com/briskml/brisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/briskml/brisk](https://github.com/briskml/brisk) |
| Source record ids | github_search_cocoa-c5a9c7bc802c3a |
...
For a systems engineer, briskml/brisk belongs in the Cocoa inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-11-03T14:15:35Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-c5a9c7bc802c3a` from `github_search_cocoa` as `registry_expansion`
