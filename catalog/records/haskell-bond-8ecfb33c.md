...
<!-- canonical: https://hackage.haskell.org/package/bond -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bond](https://hackage.haskell.org/package/bond) |
| Source record ids | hackage_top_downloads-f2fe641aab53b8 |
...
For a systems engineer, bond belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0.0 | 2024-07-15T12:14:20Z | [https://hackage.haskell.org/package/bond](https://hackage.haskell.org/package/bond) |  |
| candidate | partial | 0.4.0.1 |  | [https://hackage.haskell.org/package/bond](https://hackage.haskell.org/package/bond) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bond` at `2026-09-05T00:31:42+00:00`.
...
- `hackage_top_downloads-f2fe641aab53b8` from `hackage_top_downloads` as `registry_expansion`
