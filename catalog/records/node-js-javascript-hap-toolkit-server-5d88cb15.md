...
<!-- canonical: https://www.npmjs.com/package/@hap-toolkit/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@hap-toolkit/server](https://www.npmjs.com/package/@hap-toolkit/server) |
| Source record ids | npm_registry-7f73d50b7b0858 |

## System Engineer Summary

@hap-toolkit/server is tracked as a web framework record in the Node.js/JavaScript branch. The
...
For a systems engineer, @hap-toolkit/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2026-08-28T06:59:58.093Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-7f73d50b7b0858` from `npm_registry` as `registry_expansion`
