...
<!-- canonical: https://github.com/cocos2d/cocos2d-x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cocos2d/cocos2d-x](https://github.com/cocos2d/cocos2d-x) |
| Source record ids | github_search_game_engines-18a45ad7b5e583 |

## System Engineer Summary

Cocos2d-x is a suite of open-source, cross-platform, game-development tools utilized by millions of
developers across the globe. Its core has evolved to serve as the foundation for Cocos Creator 1.x &
2.x.

## Operational Role

For a systems engineer, cocos2d/cocos2d-x belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-09T03:36:03Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_game_engines-18a45ad7b5e583` from `github_search_game_engines` as `registry_expansion`
