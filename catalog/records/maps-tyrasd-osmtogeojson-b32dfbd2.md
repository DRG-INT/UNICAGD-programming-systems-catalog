...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tyrasd/osmtogeojson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tyrasd/osmtogeojson](https://github.com/tyrasd/osmtogeojson) |
| Source record ids | github_search_maps-892cbbc4376898 |

## System Engineer Summary

tyrasd/osmtogeojson is tracked as a serialization record in the Maps branch. The source did not
...
For a systems engineer, tyrasd/osmtogeojson belongs in the Maps inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T02:49:39Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-892cbbc4376898` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aourednik/historical-basemaps | Serialization | [open](maps-aourednik-historical-basemaps-3269cb50.md) |
| clickbar/laravel-magellan | Serialization | [open](maps-clickbar-laravel-magellan-eb282357.md) |
| daohoangson/dvhcvn | Serialization | [open](maps-daohoangson-dvhcvn-5a603731.md) |
| GEOSwift/GEOSwift | Serialization | [open](maps-geoswift-geoswift-b0eef061.md) |
| geotools/geotools | Serialization | [open](maps-geotools-geotools-38424177.md) |
| mbloch/mapshaper | Serialization | [open](maps-mbloch-mapshaper-c692c7a0.md) |
| openwisp/django-rest-framework-gis | Serialization | [open](maps-openwisp-django-rest-framework-gis-98d4e656.md) |
| paulmach/orb | Serialization | [open](maps-paulmach-orb-d7fd1fed.md) |
