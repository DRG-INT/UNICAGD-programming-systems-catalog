...
| Source record ids | github_search_electromagnetoscopes-581438e8556bbe |
...
For a systems engineer, RedhawkSDR/redhawk belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2023-03-03T18:07:25Z | [https://api.github.com/repos/RedhawkSDR/redhawk/releases/latest](https://api.github.com/repos/RedhawkSDR/redhawk/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/RedhawkSDR/redhawk/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-581438e8556bbe` from `github_search_electromagnetoscopes` as `registry_expansion`
