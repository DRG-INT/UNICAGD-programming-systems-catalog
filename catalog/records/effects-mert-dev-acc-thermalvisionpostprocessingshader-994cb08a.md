...
<!-- canonical: https://github.com/mert-dev-acc/ThermalVisionPostProcessingShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mert-dev-acc/ThermalVisionPostProcessingShader](https://github.com/mert-dev-acc/ThermalVisionPostProcessingShader) |
| Source record ids | github_search_effects-19da88303f0a5a |

## System Engineer Summary

Thermal Goggles Post Processing StackV2 effect along with custom editorreplacement shaders and
shadergraph on LWRP

## Operational Role

For a systems engineer, mert-dev-acc/ThermalVisionPostProcessingShader belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-31T10:18:03Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-19da88303f0a5a` from `github_search_effects` as `registry_expansion`
