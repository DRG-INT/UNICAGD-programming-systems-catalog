...
<!-- canonical: https://github.com/Specifyapp/parsers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Specifyapp/parsers](https://github.com/Specifyapp/parsers) |
| Source record ids | github_search_assets-111761b6fd1f15 |

## System Engineer Summary

Specify helps you unify your brand identity by collecting, storing and distributing design tokens
and assets — automatically.

## Operational Role

For a systems engineer, Specifyapp/parsers belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-30T13:23:14Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-111761b6fd1f15` from `github_search_assets` as `registry_expansion`
