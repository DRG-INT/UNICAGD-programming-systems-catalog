...
<!-- canonical: https://crates.io/crates/zstd-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zstd-sys](https://crates.io/crates/zstd-sys) |
| Source record ids | crates_io-3ae3dab06f6158 |
...
For a systems engineer, zstd-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0+zstd.1.5.7 | 2026-09-04T19:02:16.559799Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-04T20:18:54+00:00`.
...
- `crates_io-3ae3dab06f6158` from `crates_io` as `registry_expansion`
