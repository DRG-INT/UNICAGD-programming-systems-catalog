...
<!-- canonical: https://luarocks.org/modules/mah0x211/act -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/act](https://luarocks.org/modules/mah0x211/act) |
| Source record ids | luarocks_root_manifest-23a4fddb00470c |
...
For a systems engineer, act belongs in the Lua family inventory as part of concurrency scheduling,
...
- `luarocks_root_manifest-23a4fddb00470c` from `luarocks_root_manifest` as `registry_expansion`
