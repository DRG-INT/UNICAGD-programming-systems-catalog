...
<!-- canonical: https://github.com/SFML/SFML -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SFML/SFML](https://github.com/SFML/SFML) |
| Source record ids | github_search_computer_graphics_software-11fe83e349f815 |
...
For a systems engineer, SFML/SFML belongs in the Computer Graphics Software inventory as part of
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; zlib License; https://api.github.com/licenses/zlib |
...
- `github_search_computer_graphics_software-11fe83e349f815` from `github_search_computer_graphics_software` as `registry_expansion`
...
| ssloy/tinyraycaster | Parser Lexer Ast | [open](computer-graphics-software-ssloy-tinyraycaster-8019adcd.md) |
