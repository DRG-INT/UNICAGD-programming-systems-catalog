...
<!-- canonical: https://crates.io/crates/derive_arbitrary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/derive_arbitrary](https://crates.io/crates/derive_arbitrary) |
| Source record ids | crates_io-5236c386d8d532 |
...
For a systems engineer, derive_arbitrary belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2025-08-14T18:20:00.920961Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-5236c386d8d532` from `crates_io` as `registry_expansion`
