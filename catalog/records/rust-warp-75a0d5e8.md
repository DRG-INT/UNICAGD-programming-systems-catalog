...
| Source record ids | corpus-7be62e07e04dc5 |
...
For a systems engineer, Warp belongs in the Rust inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2026-05-04T19:33:48.290142Z | [https://crates.io/api/v1/crates/Warp](https://crates.io/api/v1/crates/Warp) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/Warp` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-7be62e07e04dc5` from `master_json` as `web_framework`
