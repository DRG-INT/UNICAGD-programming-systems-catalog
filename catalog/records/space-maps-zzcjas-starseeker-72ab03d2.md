...
<!-- canonical: https://github.com/ZZCjas/StarSeeker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZZCjas/StarSeeker](https://github.com/ZZCjas/StarSeeker) |
| Source record ids | github_search_space_maps-797653f9b5c16e |

## System Engineer Summary

Real‑time sky observation tool with stars, planets, deep‑sky objects, and satellite tracking.
Interactive star map with multi‑language support.

## Operational Role

For a systems engineer, ZZCjas/StarSeeker belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T12:36:54Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-797653f9b5c16e` from `github_search_space_maps` as `registry_expansion`
