...
<!-- canonical: https://pypi.org/project/abs-web-testing/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abs-web-testing/](https://pypi.org/project/abs-web-testing/) |
| Source record ids | pypi_simple-ca394eeb5fbd6f |

## System Engineer Summary

Action Based Selenium WebTesting library - selenium in more accessible way :)

## Operational Role

For a systems engineer, abs-web-testing belongs in the Python inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5 | 2020-10-26T10:49:27.181809Z | [https://pypi.org/pypi/abs-web-testing/json](https://pypi.org/pypi/abs-web-testing/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abs-web-testing/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-ca394eeb5fbd6f` from `pypi_simple` as `registry_expansion`
