...
<!-- canonical: https://pub.dev/packages/persistent_bottom_nav_bar_v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/persistent_bottom_nav_bar_v2](https://pub.dev/packages/persistent_bottom_nav_bar_v2) |
| Source record ids | pub_dev-f278e3b3ba41a0 |

## System Engineer Summary

A highly customizable bottom navigation bar for Flutter. Includes 17 prebuilt styles but can also be
used with your custom style.

## Operational Role

For a systems engineer, persistent_bottom_nav_bar_v2 belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.4.0 | 2026-08-10T22:23:40.208953Z | [https://pub.dev/api/packages/persistent_bottom_nav_bar_v2](https://pub.dev/api/packages/persistent_bottom_nav_bar_v2) |  |
| preview | known | 5.0.0-beta.10 | 2024-03-13T15:32:06.939963Z | [https://pub.dev/api/packages/persistent_bottom_nav_bar_v2](https://pub.dev/api/packages/persistent_bottom_nav_bar_v2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/persistent_bottom_nav_bar_v2` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-f278e3b3ba41a0` from `pub_dev` as `registry_expansion`
