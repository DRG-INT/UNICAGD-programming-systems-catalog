...
<!-- canonical: https://luarocks.org/modules/freed-wu/citation-style-language-locales -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/citation-style-language-locales](https://luarocks.org/modules/freed-wu/citation-style-language-locales) |
| Source record ids | luarocks_root_manifest-f015f952f6e13b |

## System Engineer Summary

localize citations and bibliographies generated with CSL styles, and consist of localized terms,
date formats and grammar rules

## Operational Role

For a systems engineer, citation-style-language-locales belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-f015f952f6e13b` from `luarocks_root_manifest` as `registry_expansion`
