...
<!-- canonical: https://hackage.haskell.org/package/gi-soup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gi-soup](https://hackage.haskell.org/package/gi-soup) |
| Source record ids | hackage_top_downloads-b2122bee0a63f0 |
...
For a systems engineer, gi-soup belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.4 | 2025-01-01T13:01:26Z | [https://hackage.haskell.org/package/gi-soup](https://hackage.haskell.org/package/gi-soup) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gi-soup` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-b2122bee0a63f0` from `hackage_top_downloads` as `registry_expansion`
