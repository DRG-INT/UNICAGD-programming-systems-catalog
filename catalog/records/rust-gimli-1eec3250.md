...
<!-- canonical: https://crates.io/crates/gimli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gimli](https://crates.io/crates/gimli) |
| Source record ids | crates_io-ccf55640df88c3 |
...
For a systems engineer, gimli belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.34.0 | 2026-06-25T07:08:40.637831Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-10T20:18:27+00:00`.
...
- `crates_io-ccf55640df88c3` from `crates_io` as `registry_expansion`
