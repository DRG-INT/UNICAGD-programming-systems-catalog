...
<!-- canonical: https://github.com/openmaptiles/openmaptiles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openmaptiles/openmaptiles](https://github.com/openmaptiles/openmaptiles) |
| Source record ids | github_search_maps-b391c7ba5763b5 |
...
For a systems engineer, openmaptiles/openmaptiles belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T12:19:41Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b391c7ba5763b5` from `github_search_maps` as `registry_expansion`
