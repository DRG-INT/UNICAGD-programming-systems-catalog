...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/abyo-software/s4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abyo-software/s4](https://github.com/abyo-software/s4) |
| Source record ids | github_search_databases-5fbe24c81fec41 |

## System Engineer Summary

GPU-accelerated transparent compression S3-compatible storage gateway. Drop-in replacement for AWS
S3 endpoints; cuts your S3 bill 50-80% with no app changes (Rust, nvCOMP, zstd).

## Operational Role

For a systems engineer, abyo-software/s4 belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T01:22:57Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5fbe24c81fec41` from `github_search_databases` as `registry_expansion`
