...
<!-- canonical: https://luarocks.org/modules/emiruz/decide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/emiruz/decide](https://luarocks.org/modules/emiruz/decide) |
| Source record ids | luarocks_root_manifest-e08b0a6742e258 |

## System Engineer Summary

Easily make state machines and decision flows in Lua.

## Operational Role

For a systems engineer, decide belongs in the Lua family inventory as part of build graph control,
...
- `luarocks_root_manifest-e08b0a6742e258` from `luarocks_root_manifest` as `registry_expansion`
