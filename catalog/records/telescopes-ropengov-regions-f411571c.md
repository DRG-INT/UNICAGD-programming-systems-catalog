...
<!-- canonical: https://github.com/rOpenGov/regions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rOpenGov/regions](https://github.com/rOpenGov/regions) |
| Source record ids | github_search_telescopes-08e15fab7eba2c |

## System Engineer Summary

R package for validating sub-national statistical typologies, re-coding across standard typologies
of sub-national statistics. Check out or for use cases.

## Operational Role

For a systems engineer, rOpenGov/regions belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-24T12:53:07Z | gh search repos topic:observatory stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-08e15fab7eba2c` from `github_search_telescopes` as `registry_expansion`
