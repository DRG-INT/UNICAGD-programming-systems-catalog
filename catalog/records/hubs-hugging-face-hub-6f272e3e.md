...
<!-- canonical: https://huggingface.co/docs/hub/index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://huggingface.co/docs/hub/index](https://huggingface.co/docs/hub/index) |
| Source record ids | curated_language_routes-980a01cbe809fc |

## System Engineer Summary

Model, dataset, and application hub for AI artifacts, hosted demos, versioning, inference, and
collaboration.

## Operational Role

For a systems engineer, Hugging Face Hub belongs in the Hubs inventory as part of ecosystem
...
- `curated_language_routes-980a01cbe809fc` from `curated_language_routes` as `registry_expansion`
