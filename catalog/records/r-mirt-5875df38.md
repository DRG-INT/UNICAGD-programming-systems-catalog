...
<!-- canonical: https://cran.r-project.org/web/packages/mirt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mirt/index.html](https://cran.r-project.org/web/packages/mirt/index.html) |
| Source record ids | cran_packages_by_date-70bacab22a653b |
...
For a systems engineer, mirt belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.47 | 2026-08-20 09:10:08 UTC | [https://cran.r-project.org/web/packages/mirt/DESCRIPTION](https://cran.r-project.org/web/packages/mirt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mirt/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-70bacab22a653b` from `cran_packages_by_date` as `registry_expansion`
