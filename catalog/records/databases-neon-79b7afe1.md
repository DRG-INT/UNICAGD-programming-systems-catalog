...
| Canonical URL | [https://neon.tech/](https://neon.tech/) |
| Source record ids | curated_database_systems-98a69f2e42e892 |

## System Engineer Summary

Serverless Postgres platform with branching and scale-to-zero architecture.

## Operational Role

For a systems engineer, Neon belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-98a69f2e42e892` from `curated_database_systems` as `registry_expansion`
