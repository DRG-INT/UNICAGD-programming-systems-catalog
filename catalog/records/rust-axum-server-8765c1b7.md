...
| Canonical URL | [https://crates.io/crates/axum-server](https://crates.io/crates/axum-server) |
| Source record ids | crates_io-5ee0e27e7a1c87 |
...
For a systems engineer, axum-server belongs in the Rust inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2025-12-06T21:14:52.290458Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-5ee0e27e7a1c87` from `crates_io` as `registry_expansion`
