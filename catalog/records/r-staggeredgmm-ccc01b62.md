...
<!-- canonical: https://cran.r-project.org/web/packages/staggeredGMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/staggeredGMM/index.html](https://cran.r-project.org/web/packages/staggeredGMM/index.html) |
| Source record ids | cran_packages_by_date-8429d27b4f1b20 |
...
For a systems engineer, staggeredGMM belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 11:00:10 UTC | [https://cran.r-project.org/web/packages/staggeredGMM/DESCRIPTION](https://cran.r-project.org/web/packages/staggeredGMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/staggeredGMM/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-8429d27b4f1b20` from `cran_packages_by_date` as `registry_expansion`
