...
<!-- canonical: https://crates.io/crates/rcgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rcgen](https://crates.io/crates/rcgen) |
| Source record ids | crates_io-ef50e4bb0077dd |
...
For a systems engineer, rcgen belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.10 | 2026-08-28T21:30:01.600392Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-ef50e4bb0077dd` from `crates_io` as `registry_expansion`
