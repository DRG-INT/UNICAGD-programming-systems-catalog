...
<!-- canonical: https://luarocks.org/modules/saucisson/c3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/saucisson/c3](https://luarocks.org/modules/saucisson/c3) |
| Source record ids | luarocks_root_manifest-318fe321d7e32f |
...
For a systems engineer, c3 belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-318fe321d7e32f` from `luarocks_root_manifest` as `registry_expansion`
