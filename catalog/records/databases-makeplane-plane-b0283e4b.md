...
<!-- canonical: https://github.com/makeplane/plane -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makeplane/plane](https://github.com/makeplane/plane) |
| Source record ids | github_search_databases-1cdc999770e3e3 |

## System Engineer Summary

🔥🔥🔥 Open-source Jira, Linear, Monday, and ClickUp alternative. Plane is a modern project management
platform to manage tasks, sprints, docs, and triage.

## Operational Role

For a systems engineer, makeplane/plane belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T12:13:28Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1cdc999770e3e3` from `github_search_databases` as `registry_expansion`
