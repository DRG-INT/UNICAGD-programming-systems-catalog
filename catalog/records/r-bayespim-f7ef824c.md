...
<!-- canonical: https://cran.r-project.org/web/packages/BayesPIM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesPIM/index.html](https://cran.r-project.org/web/packages/BayesPIM/index.html) |
| Source record ids | cran_packages_by_date-659e084a2c9161 |
...
For a systems engineer, BayesPIM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-08-21 13:50:21 UTC | [https://cran.r-project.org/web/packages/BayesPIM/DESCRIPTION](https://cran.r-project.org/web/packages/BayesPIM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesPIM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-659e084a2c9161` from `cran_packages_by_date` as `registry_expansion`
