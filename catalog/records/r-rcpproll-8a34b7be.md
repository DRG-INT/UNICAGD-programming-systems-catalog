...
<!-- canonical: https://cran.r-project.org/web/packages/RcppRoll/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppRoll/index.html](https://cran.r-project.org/web/packages/RcppRoll/index.html) |
| Source record ids | cran_packages_by_date-100f10d872c36a |
...
For a systems engineer, RcppRoll belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-06 07:50:08 UTC | [https://cran.r-project.org/web/packages/RcppRoll/DESCRIPTION](https://cran.r-project.org/web/packages/RcppRoll/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppRoll/DESCRIPTION` at `2026-09-06T08:20:26+00:00`.
...
- `cran_packages_by_date-100f10d872c36a` from `cran_packages_by_date` as `registry_expansion`
