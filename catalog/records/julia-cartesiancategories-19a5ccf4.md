...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CartesianCategories](https://github.com/JuliaRegistries/General/tree/master/C/CartesianCategories) |
| Source record ids | julia_general-d533524784421a |

## System Engineer Summary

Julia package registered in General at C/CartesianCategories.

## Operational Role

For a systems engineer, CartesianCategories belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CartesianCategories", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-d533524784421a` from `julia_general` as `registry_expansion`
