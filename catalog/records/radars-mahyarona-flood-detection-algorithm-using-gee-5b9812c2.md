...
<!-- canonical: https://github.com/Mahyarona/Flood-Detection-Algorithm-using-GEE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mahyarona/Flood-Detection-Algorithm-using-GEE](https://github.com/Mahyarona/Flood-Detection-Algorithm-using-GEE) |
| Source record ids | github_search_radars-db17a4a244fd68 |

## System Engineer Summary

A JavaScript code developed in Google Earth Engine (GEE) Platform to Detect Flooded Area along with
Affected Population

## Operational Role

For a systems engineer, Mahyarona/Flood-Detection-Algorithm-using-GEE belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-01T05:08:53Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-db17a4a244fd68` from `github_search_radars` as `registry_expansion`
