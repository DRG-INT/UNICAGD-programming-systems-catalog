...
| Canonical URL | [https://github.com/mixxxdj/mixxx](https://github.com/mixxxdj/mixxx) |
| Source record ids | github_search_audio-40fe4c9bbcd146 |
...
For a systems engineer, mixxxdj/mixxx belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.6 | 2026-03-27T17:45:39Z | [https://api.github.com/repos/mixxxdj/mixxx/releases/latest](https://api.github.com/repos/mixxxdj/mixxx/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mixxxdj/mixxx/releases/latest` at `2026-09-01T09:23:18+00:00`.
...
- `github_search_audio-40fe4c9bbcd146` from `github_search_audio` as `registry_expansion`
