...
<!-- canonical: https://github.com/mapsforge/mapsforge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mapsforge/mapsforge](https://github.com/mapsforge/mapsforge) |
| Source record ids | github_search_maps-87ed788956a280 |
...
For a systems engineer, mapsforge/mapsforge belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T07:11:05Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-87ed788956a280` from `github_search_maps` as `registry_expansion`
