...
<!-- canonical: https://crates.io/crates/ureq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ureq](https://crates.io/crates/ureq) |
| Source record ids | crates_io-91f384fd3d6872 |
...
For a systems engineer, ureq belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.1 | 2026-09-06T10:07:56.416828Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-06T10:18:46+00:00`.
...
- `crates_io-91f384fd3d6872` from `crates_io` as `registry_expansion`
