...
<!-- canonical: https://cran.r-project.org/web/packages/neo2R/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/neo2R/index.html](https://cran.r-project.org/web/packages/neo2R/index.html) |
| Source record ids | cran_packages_by_date-42819ae8900a77 |

## System Engineer Summary

neo2R is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, neo2R belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-08-05 08:20:02 UTC | [https://cran.r-project.org/web/packages/neo2R/DESCRIPTION](https://cran.r-project.org/web/packages/neo2R/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/neo2R/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-42819ae8900a77` from `cran_packages_by_date` as `registry_expansion`
