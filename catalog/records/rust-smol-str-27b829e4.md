...
<!-- canonical: https://crates.io/crates/smol_str -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/smol_str](https://crates.io/crates/smol_str) |
| Source record ids | crates_io-aadffc512f581e |
...
For a systems engineer, smol_str belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2026-03-04T06:27:06.114096Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-aadffc512f581e` from `crates_io` as `registry_expansion`
