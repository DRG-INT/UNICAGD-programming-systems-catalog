...
| Source record ids | hackage_recent-d9d7148b21366a |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hledger` at `2026-09-11T01:22:35+00:00`.
...
- `hackage_recent-d9d7148b21366a` from `hackage_recent` as `registry_expansion`
