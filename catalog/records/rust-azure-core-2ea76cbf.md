...
| Canonical URL | [https://crates.io/crates/azure_core](https://crates.io/crates/azure_core) |
| Source record ids | crates_io-20a985dea2ea3c |
...
For a systems engineer, azure_core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-07-10T20:07:47.918809Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-20a985dea2ea3c` from `crates_io` as `registry_expansion`
