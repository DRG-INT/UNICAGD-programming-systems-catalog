...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mikepenz/AboutLibraries -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mikepenz/AboutLibraries](https://github.com/mikepenz/AboutLibraries) |
| Source record ids | github_search_webassembly-a92b98e18db87c |

## System Engineer Summary

AboutLibraries automatically collects all dependencies and licenses of any gradle project (Kotlin
MultiPlatform), and provides easy to integrate UI components for Android and Compose Multiplatform
environments

## Operational Role

For a systems engineer, mikepenz/AboutLibraries belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T15:20:35Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a92b98e18db87c` from `github_search_webassembly` as `registry_expansion`
