...
<!-- canonical: https://github.com/WEC-Sim/WEC-Sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WEC-Sim/WEC-Sim](https://github.com/WEC-Sim/WEC-Sim) |
| Source record ids | github_search_matlab-569e8dd4508306 |

## System Engineer Summary

Wave Energy Converter Simulator (WEC-Sim), an open-source code for simulating wave energy
converters.

## Operational Role

For a systems engineer, WEC-Sim/WEC-Sim belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T15:00:27Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-569e8dd4508306` from `github_search_matlab` as `registry_expansion`
