...
<!-- canonical: https://pub.dev/packages/installed_apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/installed_apps](https://pub.dev/packages/installed_apps) |
| Source record ids | pub_dev-2a14eb1380c52c |
...
For a systems engineer, installed_apps belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2026-02-03T09:30:32.487166Z | [https://pub.dev/api/packages/installed_apps](https://pub.dev/api/packages/installed_apps) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/installed_apps` at `2026-09-02T00:28:56+00:00`.
...
- `pub_dev-2a14eb1380c52c` from `pub_dev` as `registry_expansion`
...
| maps_toolkit | Utility Library | [open](dart-maps-toolkit-8dcbb6c5.md) |
