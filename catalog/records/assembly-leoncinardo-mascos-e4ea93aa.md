...
<!-- canonical: https://github.com/leoncinardo/MascOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leoncinardo/MascOS](https://github.com/leoncinardo/MascOS) |
| Source record ids | github_search_assembly-6892db0793602c |
...
For a systems engineer, leoncinardo/MascOS belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-26T16:15:37Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6892db0793602c` from `github_search_assembly` as `registry_expansion`
