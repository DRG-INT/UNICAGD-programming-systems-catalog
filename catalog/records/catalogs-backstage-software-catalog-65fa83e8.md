...
<!-- canonical: https://backstage.io/docs/features/software-catalog/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://backstage.io/docs/features/software-catalog/](https://backstage.io/docs/features/software-catalog/) |
| Source record ids | curated_language_routes-066103efc06ad4 |

## System Engineer Summary

Service and software catalog system for components, APIs, resources, owners, templates, and platform
engineering metadata.

## Operational Role

For a systems engineer, Backstage Software Catalog belongs in the Catalogs inventory as part of
...
- `curated_language_routes-066103efc06ad4` from `curated_language_routes` as `registry_expansion`
