...
<!-- canonical: https://cran.r-project.org/web/packages/flexstanr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flexstanr/index.html](https://cran.r-project.org/web/packages/flexstanr/index.html) |
| Source record ids | cran_packages_by_date-77bff2cee6cc60 |
...
For a systems engineer, flexstanr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-25 21:30:02 UTC | [https://cran.r-project.org/web/packages/flexstanr/DESCRIPTION](https://cran.r-project.org/web/packages/flexstanr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flexstanr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-77bff2cee6cc60` from `cran_packages_by_date` as `registry_expansion`
