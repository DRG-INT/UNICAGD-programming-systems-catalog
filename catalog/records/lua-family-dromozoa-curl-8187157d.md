...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-curl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-curl](https://luarocks.org/modules/moyu/dromozoa-curl) |
| Source record ids | luarocks_root_manifest-e13303c18f4b7d |
...
For a systems engineer, dromozoa-curl belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-e13303c18f4b7d` from `luarocks_root_manifest` as `registry_expansion`
