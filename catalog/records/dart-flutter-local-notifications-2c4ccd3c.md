...
<!-- canonical: https://pub.dev/packages/flutter_local_notifications -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_local_notifications](https://pub.dev/packages/flutter_local_notifications) |
| Source record ids | pub_dev-6bed881eee8983 |

## System Engineer Summary

A cross platform plugin for displaying and scheduling local notifications for Flutter applications
with the ability to customise for each platform.

## Operational Role

For a systems engineer, flutter_local_notifications belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 22.3.0 | 2026-08-08T08:48:50.612325Z | [https://pub.dev/api/packages/flutter_local_notifications](https://pub.dev/api/packages/flutter_local_notifications) |  |
| preview | known | 22.0.0-dev.3 | 2026-05-13T12:26:27.798753Z | [https://pub.dev/api/packages/flutter_local_notifications](https://pub.dev/api/packages/flutter_local_notifications) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_local_notifications` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-6bed881eee8983` from `pub_dev` as `registry_expansion`
