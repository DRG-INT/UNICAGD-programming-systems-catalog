...
<!-- canonical: https://github.com/denialwm/denial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/denialwm/denial](https://github.com/denialwm/denial) |
| Source record ids | github_search_effects-541aea0e654c3f |

## System Engineer Summary

Denial is a Flutter-native Wayland compositor that puts Flutter at the foundation of the desktop,
unifying the shell, motion, and application composition into one fluid experience.

## Operational Role

For a systems engineer, denialwm/denial belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T21:15:38Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-541aea0e654c3f` from `github_search_effects` as `registry_expansion`
