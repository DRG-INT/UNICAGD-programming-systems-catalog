...
<!-- canonical: https://cran.r-project.org/web/packages/curl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/curl/index.html](https://cran.r-project.org/web/packages/curl/index.html) |
| Source record ids | cran_packages_by_date-e1081000e26252 |
...
For a systems engineer, curl belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-08-25 16:40:02 UTC | [https://cran.r-project.org/web/packages/curl/DESCRIPTION](https://cran.r-project.org/web/packages/curl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/curl/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e1081000e26252` from `cran_packages_by_date` as `registry_expansion`
