...
<!-- canonical: https://pub.dev/packages/app_tracking_transparency -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/app_tracking_transparency](https://pub.dev/packages/app_tracking_transparency) |
| Source record ids | pub_dev-c6ebea822d5799 |

## System Engineer Summary

This Flutter plugin allows you to display ios tracking authorization dialogue and request permission
to collect data.

## Operational Role

For a systems engineer, app_tracking_transparency belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.7 | 2026-05-28T08:12:01.948811Z | [https://pub.dev/api/packages/app_tracking_transparency](https://pub.dev/api/packages/app_tracking_transparency) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/app_tracking_transparency` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-c6ebea822d5799` from `pub_dev` as `registry_expansion`
...
| fimber | Logging Observability | [open](dart-fimber-7a3085d6.md) |
