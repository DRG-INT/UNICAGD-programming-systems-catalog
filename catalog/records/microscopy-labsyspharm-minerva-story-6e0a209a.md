...
<!-- canonical: https://github.com/labsyspharm/minerva-story -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/labsyspharm/minerva-story](https://github.com/labsyspharm/minerva-story) |
| Source record ids | github_search_microscopy-56c6e19929394e |

## System Engineer Summary

Minerva Story is an image viewer that is designed specifically to make it easy for non-expert users
to interact with complex tissue images.

## Operational Role

For a systems engineer, labsyspharm/minerva-story belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-08T18:52:37Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-56c6e19929394e` from `github_search_microscopy` as `registry_expansion`
