...
<!-- canonical: https://github.com/open-sdr/openwifi-hw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-sdr/openwifi-hw](https://github.com/open-sdr/openwifi-hw) |
| Source record ids | github_search_satcom_satellites-02bde6e6a6ca1c |
...
For a systems engineer, open-sdr/openwifi-hw belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-23T06:57:55Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-02bde6e6a6ca1c` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bitglue/gr-radioteletype | Embedded Hardware | [open](satcom-satellites-bitglue-gr-radioteletype-8621d6d5.md) |
