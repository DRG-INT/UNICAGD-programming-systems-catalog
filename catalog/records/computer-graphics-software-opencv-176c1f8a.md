...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/opencv/opencv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opencv/opencv](https://github.com/opencv/opencv) |
| Source record ids | curated_language_routes-9848f674c4ed5e |

## System Engineer Summary

Computer vision and image processing library used in graphics pipelines, camera systems, media
tools, and automation.

## Operational Role

For a systems engineer, OpenCV belongs in the Computer Graphics Software inventory as part of
...
- `curated_language_routes-9848f674c4ed5e` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fogleman/primitive | Image Audio Dsp | [open](computer-graphics-software-fogleman-primitive-65c47d64.md) |
| GaParmar/clean-fid | Image Audio Dsp | [open](computer-graphics-software-gaparmar-clean-fid-c7462dca.md) |
| jayin92/Skyfall-GS | Image Audio Dsp | [open](computer-graphics-software-jayin92-skyfall-gs-8cb93d15.md) |
| junyanz/pytorch-CycleGAN-and-pix2pix | Image Audio Dsp | [open](computer-graphics-software-junyanz-pytorch-cyclegan-and-pix2pix-a9a177e7.md) |
| NVIDIA/pix2pixHD | Image Audio Dsp | [open](computer-graphics-software-nvidia-pix2pixhd-1a28744b.md) |
| phillipi/pix2pix | Image Audio Dsp | [open](computer-graphics-software-phillipi-pix2pix-15a80609.md) |
| pkhungurn/talking-head-anime-3-demo | Image Audio Dsp | [open](computer-graphics-software-pkhungurn-talking-head-anime-3-demo-e8183610.md) |
| pkhungurn/talking-head-anime-demo | Image Audio Dsp | [open](computer-graphics-software-pkhungurn-talking-head-anime-demo-9df39afd.md) |
