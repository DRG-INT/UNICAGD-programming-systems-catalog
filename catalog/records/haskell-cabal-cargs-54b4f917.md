...
<!-- canonical: https://hackage.haskell.org/package/cabal-cargs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-cargs](https://hackage.haskell.org/package/cabal-cargs) |
| Source record ids | hackage_top_downloads-b39814c106dfb3 |
...
For a systems engineer, cabal-cargs belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2025-09-22T16:00:10Z | [https://hackage.haskell.org/package/cabal-cargs](https://hackage.haskell.org/package/cabal-cargs) |  |
| candidate | partial | 1.7.0 |  | [https://hackage.haskell.org/package/cabal-cargs](https://hackage.haskell.org/package/cabal-cargs) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-cargs` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-b39814c106dfb3` from `hackage_top_downloads` as `registry_expansion`
