# zkud/sap-cap-java-advanced-dev-containers-sample
...
<!-- canonical: https://github.com/zkud/sap-cap-java-advanced-dev-containers-sample -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zkud/sap-cap-java-advanced-dev-containers-sample](https://github.com/zkud/sap-cap-java-advanced-dev-containers-sample) |
| Source record ids | github_search_sapjava-f2304c7dacd796 |

## System Engineer Summary

Advanced Sample for SAP CAP Java setup with Dev Containers

## Operational Role

For a systems engineer, zkud/sap-cap-java-advanced-dev-containers-sample belongs in the SAPJava
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-20T18:38:12Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-f2304c7dacd796` from `github_search_sapjava` as `registry_expansion`
