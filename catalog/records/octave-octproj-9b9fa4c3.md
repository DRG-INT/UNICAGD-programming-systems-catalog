...
<!-- canonical: https://gnu-octave.github.io/packages/octproj -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/octproj](https://gnu-octave.github.io/packages/octproj) |
| Source record ids | octave_packages_index-b274abc68c1a7a |

## System Engineer Summary

This package allows to call functions of PROJ library for cartographic projections and CRS
transformations.

## Operational Role

For a systems engineer, octproj belongs in the Octave inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2025-06-30 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-b274abc68c1a7a` from `octave_packages_index` as `registry_expansion`
