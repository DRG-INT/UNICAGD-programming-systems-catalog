...
<!-- canonical: https://github.com/jagrosh/MusicBot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jagrosh/MusicBot](https://github.com/jagrosh/MusicBot) |
| Source record ids | github_search_electromagnetoscopes-48e55e03806dfa |
...
For a systems engineer, jagrosh/MusicBot belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2024-08-05T22:08:33Z | [https://api.github.com/repos/jagrosh/MusicBot/releases/latest](https://api.github.com/repos/jagrosh/MusicBot/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jagrosh/MusicBot/releases/latest` at `2026-09-01T08:26:40+00:00`.
...
- `github_search_electromagnetoscopes-48e55e03806dfa` from `github_search_electromagnetoscopes` as `registry_expansion`
