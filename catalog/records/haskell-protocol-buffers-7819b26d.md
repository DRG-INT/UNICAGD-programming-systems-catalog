...
<!-- canonical: https://hackage.haskell.org/package/protocol-buffers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/protocol-buffers](https://hackage.haskell.org/package/protocol-buffers) |
| Source record ids | hackage_top_downloads-da776cb287fe81 |

## System Engineer Summary

Hackage package with 169 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, protocol-buffers belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.17 | 2020-11-05T20:59:18Z | [https://hackage.haskell.org/package/protocol-buffers](https://hackage.haskell.org/package/protocol-buffers) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/protocol-buffers` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-da776cb287fe81` from `hackage_top_downloads` as `registry_expansion`
