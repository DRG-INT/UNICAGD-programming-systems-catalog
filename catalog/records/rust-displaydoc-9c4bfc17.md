...
<!-- canonical: https://crates.io/crates/displaydoc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/displaydoc](https://crates.io/crates/displaydoc) |
| Source record ids | crates_io-a35e0c4fcab2de |
...
For a systems engineer, displaydoc belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2026-07-28T13:58:21.461609Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-a35e0c4fcab2de` from `crates_io` as `registry_expansion`
