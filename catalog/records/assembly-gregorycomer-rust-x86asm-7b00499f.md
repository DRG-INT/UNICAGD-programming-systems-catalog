...
<!-- canonical: https://github.com/GregoryComer/rust-x86asm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GregoryComer/rust-x86asm](https://github.com/GregoryComer/rust-x86asm) |
| Source record ids | github_search_assembly-a4e3f080ff1ad0 |
...
For a systems engineer, GregoryComer/rust-x86asm belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-21T18:39:44Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-a4e3f080ff1ad0` from `github_search_assembly` as `registry_expansion`
