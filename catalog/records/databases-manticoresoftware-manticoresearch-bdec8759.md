...
<!-- canonical: https://github.com/manticoresoftware/manticoresearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/manticoresoftware/manticoresearch](https://github.com/manticoresoftware/manticoresearch) |
| Source record ids | github_search_databases-f0ef1d3a4de08e |

## System Engineer Summary

Open-source search database for full-text, vector, and hybrid search with real-time indexing and
SQL.

## Operational Role

For a systems engineer, manticoresoftware/manticoresearch belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:28:43Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f0ef1d3a4de08e` from `github_search_databases` as `registry_expansion`
