...
<!-- canonical: https://pub.dev/packages/cron -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/cron](https://pub.dev/packages/cron) |
| Source record ids | pub_dev-49be0da53f1cb7 |
...
For a systems engineer, cron belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2025-04-30T18:42:47.321807Z | [https://pub.dev/api/packages/cron](https://pub.dev/api/packages/cron) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/cron` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-49be0da53f1cb7` from `pub_dev` as `registry_expansion`
