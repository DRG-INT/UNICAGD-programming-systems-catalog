...
<!-- canonical: https://www.w3.org/TR/appmanifest/#icons-member -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.w3.org/TR/appmanifest/#icons-member](https://www.w3.org/TR/appmanifest/#icons-member) |
| Source record ids | curated_language_routes-6b778547b10c14 |

## System Engineer Summary

Web app manifest icon member specification for installable web applications and icon asset
selection.

## Operational Role

For a systems engineer, W3C Web App Manifest Icons belongs in the Icons and Logos inventory as part
...
- `curated_language_routes-6b778547b10c14` from `curated_language_routes` as `registry_expansion`
