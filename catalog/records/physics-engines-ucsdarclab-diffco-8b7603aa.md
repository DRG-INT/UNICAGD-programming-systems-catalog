...
<!-- canonical: https://github.com/ucsdarclab/diffco -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ucsdarclab/diffco](https://github.com/ucsdarclab/diffco) |
| Source record ids | github_search_physics_engines-8660d15f8f9d87 |
...
For a systems engineer, ucsdarclab/diffco belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-18T23:08:05Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8660d15f8f9d87` from `github_search_physics_engines` as `registry_expansion`
