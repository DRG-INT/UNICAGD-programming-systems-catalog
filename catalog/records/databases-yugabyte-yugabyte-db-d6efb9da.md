...
<!-- canonical: https://github.com/yugabyte/yugabyte-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yugabyte/yugabyte-db](https://github.com/yugabyte/yugabyte-db) |
| Source record ids | github_search_databases-a490ef3c3228bf |
...
For a systems engineer, yugabyte/yugabyte-db belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T19:24:16Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:database stars:>1000", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_databases-a490ef3c3228bf` from `github_search_databases` as `registry_expansion`
