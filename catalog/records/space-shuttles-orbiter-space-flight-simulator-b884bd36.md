...
| Canonical URL | [https://www.orbiter-forum.com/](https://www.orbiter-forum.com/) |
| Source record ids | curated_language_routes-0c2c480954fab0 |

## System Engineer Summary

Space flight simulator ecosystem for orbital mechanics, shuttle-style vehicles, addons, and mission
scenarios.

## Operational Role

For a systems engineer, Orbiter Space Flight Simulator belongs in the Space Shuttles inventory as
...
- `curated_language_routes-0c2c480954fab0` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Space Shuttle Ultra | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-shuttles-space-shuttle-ultra-58e67d4a.md) |
