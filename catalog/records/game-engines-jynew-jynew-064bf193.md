...
<!-- canonical: https://github.com/jynew/jynew -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jynew/jynew](https://github.com/jynew/jynew) |
| Source record ids | github_search_game_engines-937d2c741d36d9 |

## System Engineer Summary

JinYongLegend-like RPG Game Framework with full Modding support and 10+ hours playable samples of
game.

## Operational Role

For a systems engineer, jynew/jynew belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-25T01:07:55Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-937d2c741d36d9` from `github_search_game_engines` as `registry_expansion`
