...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AbstractIterativeSolvers](https://github.com/JuliaRegistries/General/tree/master/A/AbstractIterativeSolvers) |
| Source record ids | julia_general-e4443015c0146c |

## System Engineer Summary

Julia package registered in General at A/AbstractIterativeSolvers.

## Operational Role

For a systems engineer, AbstractIterativeSolvers belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| Abaco | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abaco-0e24cdcd.md) |
| AbaqusReader | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abaqusreader-b258534f.md) |
| ABBAj | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abbaj-c5e7bbb2.md) |
| AbbreviatedTypes | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abbreviatedtypes-f4cf081f.md) |
| ABC_jll | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abc-jll-ce944477.md) |
| ABCdeZ | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abcdez-e3699134.md) |
| ABCDMatrixOptics | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abcdmatrixoptics-ef3bf4e1.md) |
| ABCredit | Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abcredit-c3e93b27.md) |
