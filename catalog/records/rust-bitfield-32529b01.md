...
| Canonical URL | [https://crates.io/crates/bitfield](https://crates.io/crates/bitfield) |
| Source record ids | crates_io-484504e6353a69 |
...
For a systems engineer, bitfield belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19.5 | 2026-07-25T15:06:40.869674Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-484504e6353a69` from `crates_io` as `registry_expansion`
