...
| Canonical URL | [https://luarocks.org/modules/arthuradolfo/godo.nvim](https://luarocks.org/modules/arthuradolfo/godo.nvim) |
| Source record ids | luarocks_root_manifest-ee9ee2a8a1387a |

## System Engineer Summary

Neovim plugin to integrate godo tool.

## Operational Role

For a systems engineer, godo.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ee9ee2a8a1387a` from `luarocks_root_manifest` as `registry_expansion`
