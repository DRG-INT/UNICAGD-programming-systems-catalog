...
<!-- canonical: https://luarocks.org/modules/bakpakin/bkopenssl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bakpakin/bkopenssl](https://luarocks.org/modules/bakpakin/bkopenssl) |
| Source record ids | luarocks_root_manifest-ccb5b7bea40099 |

## System Engineer Summary

bkopenssl is tracked as a ffi bindings record in the Lua family branch. The source did not provide a
...
For a systems engineer, bkopenssl belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-ccb5b7bea40099` from `luarocks_root_manifest` as `registry_expansion`
