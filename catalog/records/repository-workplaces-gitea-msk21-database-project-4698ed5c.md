...
<!-- canonical: https://gitea.com/msk21/database_project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/msk21/database_project](https://gitea.com/msk21/database_project) |
| Source record ids | gitea_repositories_api-fac0f9722deab8 |
...
For a systems engineer, Gitea: msk21/database_project belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-17T07:15:16Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-fac0f9722deab8` from `gitea_repositories_api` as `registry_expansion`
