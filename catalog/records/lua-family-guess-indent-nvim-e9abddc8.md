...
| Canonical URL | [https://luarocks.org/modules/neorocks/guess-indent.nvim](https://luarocks.org/modules/neorocks/guess-indent.nvim) |
| Source record ids | luarocks_root_manifest-c4e2ed2ada18ef |
...
For a systems engineer, guess-indent.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c4e2ed2ada18ef` from `luarocks_root_manifest` as `registry_expansion`
