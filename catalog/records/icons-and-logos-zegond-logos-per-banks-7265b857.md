...
<!-- canonical: https://github.com/zegond/logos-per-banks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zegond/logos-per-banks](https://github.com/zegond/logos-per-banks) |
| Source record ids | github_search_icons_and_logos-3b545b9bbb8c7d |

## System Engineer Summary

LogoS is a design project about logos. In clean vector and organized as libraries to use. This one
includes logos of Banks and Payment Gateways of Iran

## Operational Role

For a systems engineer, zegond/logos-per-banks belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-31T23:28:02Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3b545b9bbb8c7d` from `github_search_icons_and_logos` as `registry_expansion`
