...
<!-- canonical: https://github.com/geonetwork/core-geonetwork -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geonetwork/core-geonetwork](https://github.com/geonetwork/core-geonetwork) |
| Source record ids | github_search_catalogs-f83c1dedf080be |

## System Engineer Summary

GeoNetwork is a catalog application to manage spatially referenced resources. It provides powerful
metadata editing and search functions as well as an interactive web map viewer. It is currently used
in numerous Spatial Data Infrastructure initiatives across the world.

## Operational Role

For a systems engineer, geonetwork/core-geonetwork belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T17:59:43Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_catalogs-f83c1dedf080be` from `github_search_catalogs` as `registry_expansion`
