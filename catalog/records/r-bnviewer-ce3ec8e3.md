...
<!-- canonical: https://cran.r-project.org/web/packages/bnviewer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bnviewer/index.html](https://cran.r-project.org/web/packages/bnviewer/index.html) |
| Source record ids | cran_packages_by_date-596d4674d23b96 |
...
For a systems engineer, bnviewer belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-09-14 02:50:23 UTC | [https://cran.r-project.org/web/packages/bnviewer/DESCRIPTION](https://cran.r-project.org/web/packages/bnviewer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bnviewer/DESCRIPTION` at `2026-09-14T03:21:16+00:00`.
...
- `cran_packages_by_date-596d4674d23b96` from `cran_packages_by_date` as `registry_expansion`
