...
<!-- canonical: https://cran.r-project.org/web/packages/bigrquerystorage/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bigrquerystorage/index.html](https://cran.r-project.org/web/packages/bigrquerystorage/index.html) |
| Source record ids | cran_packages_by_date-94e33440b6f5d1 |
...
For a systems engineer, bigrquerystorage belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-09-04 15:30:03 UTC | [https://cran.r-project.org/web/packages/bigrquerystorage/DESCRIPTION](https://cran.r-project.org/web/packages/bigrquerystorage/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bigrquerystorage/DESCRIPTION` at `2026-09-04T16:20:41+00:00`.
...
- `cran_packages_by_date-94e33440b6f5d1` from `cran_packages_by_date` as `registry_expansion`
