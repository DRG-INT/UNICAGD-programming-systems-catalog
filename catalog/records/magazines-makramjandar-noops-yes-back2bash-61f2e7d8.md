# makramjandar/NoOps-Yes-Back2Bash

## Navigation

[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/makramjandar/NoOps-Yes-Back2Bash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makramjandar/NoOps-Yes-Back2Bash](https://github.com/makramjandar/NoOps-Yes-Back2Bash) |
| Source record ids | github_search_magazines-a1f160b256a586 |

## System Engineer Summary

Programmez HS N2 - the only magazine written by and 4 developers: In the next special issue
Programmez out on October 23rd, the Infeeny Xperts have taken to the challenge to their hearts'
content !! 4 columns on techies tricks, bleeding edge use cases and feedbacks. Besides my technical
contribution dedicated to 👉 #NoOps, #Azure Pipelines and to the #IaC, I thoroughly enjoyed the
writing exercise.

## Operational Role

For a systems engineer, makramjandar/NoOps-Yes-Back2Bash belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-03T01:30:33Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-a1f160b256a586` from `github_search_magazines` as `registry_expansion`
