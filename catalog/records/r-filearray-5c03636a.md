...
<!-- canonical: https://cran.r-project.org/web/packages/filearray/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/filearray/index.html](https://cran.r-project.org/web/packages/filearray/index.html) |
| Source record ids | cran_packages_by_date-7fb1771bcc63b3 |
...
For a systems engineer, filearray belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-08-21 11:00:02 UTC | [https://cran.r-project.org/web/packages/filearray/DESCRIPTION](https://cran.r-project.org/web/packages/filearray/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/filearray/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7fb1771bcc63b3` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| basetable | Memory Analyzer | [open](r-basetable-f21002c5.md) |
