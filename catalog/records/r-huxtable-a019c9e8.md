...
<!-- canonical: https://cran.r-project.org/web/packages/huxtable/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/huxtable/index.html](https://cran.r-project.org/web/packages/huxtable/index.html) |
| Source record ids | cran_packages_by_date-79d3576232495d |
...
For a systems engineer, huxtable belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.1 | 2026-09-15 09:30:02 UTC | [https://cran.r-project.org/web/packages/huxtable/DESCRIPTION](https://cran.r-project.org/web/packages/huxtable/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/huxtable/DESCRIPTION` at `2026-09-15T10:20:58+00:00`.
...
- `cran_packages_by_date-79d3576232495d` from `cran_packages_by_date` as `registry_expansion`
