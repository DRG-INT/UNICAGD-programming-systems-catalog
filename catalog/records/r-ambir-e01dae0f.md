...
<!-- canonical: https://cran.r-project.org/web/packages/ambiR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ambiR/index.html](https://cran.r-project.org/web/packages/ambiR/index.html) |
| Source record ids | cran_packages_by_date-043830b76b4b58 |
...
For a systems engineer, ambiR belongs in the R inventory as part of device constraints, cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-20 13:52:14 UTC | [https://cran.r-project.org/web/packages/ambiR/DESCRIPTION](https://cran.r-project.org/web/packages/ambiR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ambiR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-043830b76b4b58` from `cran_packages_by_date` as `registry_expansion`
