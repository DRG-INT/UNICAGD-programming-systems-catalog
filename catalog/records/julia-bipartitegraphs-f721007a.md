...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BipartiteGraphs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BipartiteGraphs](https://github.com/JuliaRegistries/General/tree/master/B/BipartiteGraphs) |
| Source record ids | julia_general-d01818d9afb6db |

## System Engineer Summary

Julia package registered in General at B/BipartiteGraphs.

## Operational Role

For a systems engineer, BipartiteGraphs belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BipartiteGraphs", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-d01818d9afb6db` from `julia_general` as `registry_expansion`
