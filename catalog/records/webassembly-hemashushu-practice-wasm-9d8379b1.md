...
<!-- canonical: https://github.com/hemashushu/practice-wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hemashushu/practice-wasm](https://github.com/hemashushu/practice-wasm) |
| Source record ids | github_search_webassembly-d85f99d51d3dd9 |
...
For a systems engineer, hemashushu/practice-wasm belongs in the WebAssembly inventory as part of
...
| preview | known | v0.1.1-beta | 2022-06-11T07:49:15Z | [https://api.github.com/repos/hemashushu/practice-wasm/releases?per_page=10](https://api.github.com/repos/hemashushu/practice-wasm/releases?per_page=10) |  |
...
- `github_search_webassembly-d85f99d51d3dd9` from `github_search_webassembly` as `registry_expansion`
