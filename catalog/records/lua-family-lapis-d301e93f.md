...
| Source record ids | corpus-245bfa6d057525 |

## System Engineer Summary

Lapis is tracked as a web framework record in the Lua family branch. The source did not provide a
...
For a systems engineer, Lapis belongs in the Lua family inventory as part of request routing,
...
- `corpus-245bfa6d057525` from `master_json` as `web_framework`
