...
<!-- canonical: https://pub.dev/packages/device_info_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/device_info_plus](https://pub.dev/packages/device_info_plus) |
| Source record ids | pub_dev-ea45796491b321 |

## System Engineer Summary

Flutter plugin providing detailed information about the device (make, model, etc.), and Android or
iOS version the app is running on.

## Operational Role

For a systems engineer, device_info_plus belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.2.0 | 2026-06-26T12:36:05.872515Z | [https://pub.dev/api/packages/device_info_plus](https://pub.dev/api/packages/device_info_plus) |  |
| preview | known | 1.0.0-nullsafety.1 | 2021-02-20T09:24:38.335575Z | [https://pub.dev/api/packages/device_info_plus](https://pub.dev/api/packages/device_info_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/device_info_plus` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-ea45796491b321` from `pub_dev` as `registry_expansion`
