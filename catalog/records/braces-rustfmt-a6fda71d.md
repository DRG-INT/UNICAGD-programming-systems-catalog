...
[Catalog index](../index.md) · [Language: Braces](../by-language/braces.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/rust-lang/rustfmt](https://github.com/rust-lang/rustfmt) |
| Source record ids | curated_language_routes-262f789be3330b |

## System Engineer Summary

Rust formatter for brace style, blocks, expressions, item layout, imports, and edition-aware
formatting.

## Operational Role

For a systems engineer, rustfmt belongs in the Braces inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.0 | 2023-07-01T19:03:27Z | [https://api.github.com/repos/rust-lang/rustfmt/releases/latest](https://api.github.com/repos/rust-lang/rustfmt/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rust-lang/rustfmt/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_language_routes-262f789be3330b` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| clang-format | Formatter | [open](braces-clang-format-3926eef1.md) |
| Prettier | Formatter | [open](braces-prettier-2e738082.md) |
