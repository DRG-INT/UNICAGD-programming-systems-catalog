...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Orlandster/geo-on-fire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Orlandster/geo-on-fire](https://github.com/Orlandster/geo-on-fire) |
| Source record ids | github_search_maps-5e25e98df2ed40 |

## System Engineer Summary

A library to create high performance geolocation queries for Firebase. Checkout the demos: and

## Operational Role

For a systems engineer, Orlandster/geo-on-fire belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-28T00:59:32Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5e25e98df2ed40` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| OpenGeoscience/geojs | Benchmarking | [open](maps-opengeoscience-geojs-be7c0940.md) |
| vinayakkulkarni/tileserver-rs | Benchmarking | [open](maps-vinayakkulkarni-tileserver-rs-2d275fb8.md) |
