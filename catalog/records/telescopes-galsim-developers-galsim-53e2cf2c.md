...
| Source record ids | github_search_telescopes-bf28f273633f24 |
...
For a systems engineer, GalSim-developers/GalSim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.8.5 | 2026-08-05T03:03:20Z | [https://api.github.com/repos/GalSim-developers/GalSim/releases/latest](https://api.github.com/repos/GalSim-developers/GalSim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GalSim-developers/GalSim/releases/latest` at `2026-09-01T08:26:23+00:00`.
...
- `github_search_telescopes-bf28f273633f24` from `github_search_telescopes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| meridianfield/pushnav | Documentation | [open](telescopes-meridianfield-pushnav-d0b59adc.md) |
