...
<!-- canonical: https://cran.r-project.org/web/packages/influential/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/influential/index.html](https://cran.r-project.org/web/packages/influential/index.html) |
| Source record ids | cran_packages_by_date-7a2973eed8dfa1 |
...
For a systems engineer, influential belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-08-23 12:30:02 UTC | [https://cran.r-project.org/web/packages/influential/DESCRIPTION](https://cran.r-project.org/web/packages/influential/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/influential/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7a2973eed8dfa1` from `cran_packages_by_date` as `registry_expansion`
