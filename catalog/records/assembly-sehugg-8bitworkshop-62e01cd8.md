...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sehugg/8bitworkshop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sehugg/8bitworkshop](https://github.com/sehugg/8bitworkshop) |
| Source record ids | github_search_assembly-c32234512ff2a0 |
...
For a systems engineer, sehugg/8bitworkshop belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T17:12:50Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-08 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:assembly stars:>300", "retrieved": "2026-09-08", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-c32234512ff2a0` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dan-c-underwood/vscode-arm | Ide Editor Integration | [open](assembly-dan-c-underwood-vscode-arm-40542dc4.md) |
| eatonphil/x86e | Ide Editor Integration | [open](assembly-eatonphil-x86e-a3d2b156.md) |
| kovidomi/game-reversing | Ide Editor Integration | [open](assembly-kovidomi-game-reversing-eb71b6a8.md) |
| mikeroyal/Assembly-Guide | Ide Editor Integration | [open](assembly-mikeroyal-assembly-guide-e4afccda.md) |
| minio/sha256-simd | Ide Editor Integration | [open](assembly-minio-sha256-simd-85e6ab78.md) |
| oded8bit/Assembly-Lib | Ide Editor Integration | [open](assembly-oded8bit-assembly-lib-a552ed5a.md) |
| robalb/x86-64-playground | Ide Editor Integration | [open](assembly-robalb-x86-64-playground-c440c3c0.md) |
| Specy/asm-editor | Ide Editor Integration | [open](assembly-specy-asm-editor-c3b9e30b.md) |
