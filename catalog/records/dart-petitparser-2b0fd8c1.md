...
<!-- canonical: https://pub.dev/packages/petitparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/petitparser](https://pub.dev/packages/petitparser) |
| Source record ids | pub_dev-c22e0de226aeeb |
...
For a systems engineer, petitparser belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.2 | 2026-02-14T10:03:01.017261Z | [https://pub.dev/api/packages/petitparser](https://pub.dev/api/packages/petitparser) |  |
| preview | known | 4.0.0-nullsafety.1 | 2020-11-21T07:57:07.968835Z | [https://pub.dev/api/packages/petitparser](https://pub.dev/api/packages/petitparser) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/petitparser` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-c22e0de226aeeb` from `pub_dev` as `registry_expansion`
