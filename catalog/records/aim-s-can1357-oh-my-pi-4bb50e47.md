...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/can1357/oh-my-pi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) |
| Source record ids | github_search_aims-376ba573324b28 |
...
For a systems engineer, can1357/oh-my-pi belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:12:17Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-376ba573324b28` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AlexsJones/llmfit | Ide Editor Integration | [open](aim-s-alexsjones-llmfit-337bd975.md) |
| decolua/9router | Ide Editor Integration | [open](aim-s-decolua-9router-0eed32d7.md) |
| harry0703/MoneyPrinterTurbo | Ide Editor Integration | [open](aim-s-harry0703-moneyprinterturbo-d466d4ad.md) |
| hesreallyhim/awesome-claude-code | Ide Editor Integration | [open](aim-s-hesreallyhim-awesome-claude-code-cf08e2ba.md) |
| mudler/LocalAI | Ide Editor Integration | [open](aim-s-mudler-localai-ba12724c.md) |
| upstash/context7 | Ide Editor Integration | [open](aim-s-upstash-context7-9349bef0.md) |
| voideditor/void | Ide Editor Integration | [open](aim-s-voideditor-void-f00971ce.md) |
