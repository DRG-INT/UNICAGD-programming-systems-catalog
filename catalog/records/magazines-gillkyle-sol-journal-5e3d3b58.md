...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gillkyle/sol-journal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gillkyle/sol-journal](https://github.com/gillkyle/sol-journal) |
| Source record ids | github_search_magazines-dea12bd63c8576 |
...
For a systems engineer, gillkyle/sol-journal belongs in the Magazines inventory as part of state
...
- `github_search_magazines-dea12bd63c8576` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gregja/sql4curious | Database Datastore | [open](magazines-gregja-sql4curious-f0eb1da0.md) |
