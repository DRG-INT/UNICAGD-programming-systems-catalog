...
<!-- canonical: https://luarocks.org/modules/mna/elan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mna/elan](https://luarocks.org/modules/mna/elan) |
| Source record ids | luarocks_root_manifest-ebbe02df68d84d |

## System Engineer Summary

elan is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, elan belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ebbe02df68d84d` from `luarocks_root_manifest` as `registry_expansion`
