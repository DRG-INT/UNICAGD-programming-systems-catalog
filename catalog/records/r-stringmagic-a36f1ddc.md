...
<!-- canonical: https://cran.r-project.org/web/packages/stringmagic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stringmagic/index.html](https://cran.r-project.org/web/packages/stringmagic/index.html) |
| Source record ids | cran_packages_by_date-370337d083acad |
...
For a systems engineer, stringmagic belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-04 10:30:09 UTC | [https://cran.r-project.org/web/packages/stringmagic/DESCRIPTION](https://cran.r-project.org/web/packages/stringmagic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stringmagic/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-370337d083acad` from `cran_packages_by_date` as `registry_expansion`
