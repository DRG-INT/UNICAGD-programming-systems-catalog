...
<!-- canonical: https://cran.r-project.org/web/packages/fitdistrBayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fitdistrBayes/index.html](https://cran.r-project.org/web/packages/fitdistrBayes/index.html) |
| Source record ids | cran_packages_by_date-5d78fb22ea16c1 |
...
For a systems engineer, fitdistrBayes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-29 17:50:02 UTC | [https://cran.r-project.org/web/packages/fitdistrBayes/DESCRIPTION](https://cran.r-project.org/web/packages/fitdistrBayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fitdistrBayes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5d78fb22ea16c1` from `cran_packages_by_date` as `registry_expansion`
