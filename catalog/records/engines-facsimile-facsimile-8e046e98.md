...
<!-- canonical: https://github.com/Facsimile/facsimile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Facsimile/facsimile](https://github.com/Facsimile/facsimile) |
| Source record ids | github_search_engines-2f309cd840a9df |
...
For a systems engineer, Facsimile/facsimile belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-20T19:06:10Z | gh search repos topic:simulation-engine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-2f309cd840a9df` from `github_search_engines` as `registry_expansion`
