...
<!-- canonical: https://docs.blender.org/manual/en/latest/compositing/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.blender.org/manual/en/latest/compositing/index.html](https://docs.blender.org/manual/en/latest/compositing/index.html) |
| Source record ids | curated_language_routes-9ee4848bc89ce7 |

## System Engineer Summary

Blender compositing system for visual effects, nodes, masks, color operations, and render outputs.

## Operational Role

For a systems engineer, Blender Compositor belongs in the Effects inventory as part of ecosystem
...
- `curated_language_routes-9ee4848bc89ce7` from `curated_language_routes` as `registry_expansion`
