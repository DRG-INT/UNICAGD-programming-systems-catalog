...
<!-- canonical: https://cran.r-project.org/web/packages/OncoBayes2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OncoBayes2/index.html](https://cran.r-project.org/web/packages/OncoBayes2/index.html) |
| Source record ids | cran_packages_by_date-86d9f569abd593 |
...
For a systems engineer, OncoBayes2 belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10-0 | 2026-08-04 21:30:02 UTC | [https://cran.r-project.org/web/packages/OncoBayes2/DESCRIPTION](https://cran.r-project.org/web/packages/OncoBayes2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OncoBayes2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-86d9f569abd593` from `cran_packages_by_date` as `registry_expansion`
