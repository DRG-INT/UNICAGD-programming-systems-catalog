...
<!-- canonical: https://github.com/EliverLara/candy-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EliverLara/candy-icons](https://github.com/EliverLara/candy-icons) |
| Source record ids | github_search_icons_and_logos-20874f573553ad |
...
For a systems engineer, EliverLara/candy-icons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-06T23:36:09Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-20874f573553ad` from `github_search_icons_and_logos` as `registry_expansion`
