# Gitea: sillyguodong/asciicast_test
...
<!-- canonical: https://gitea.com/sillyguodong/asciicast_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/sillyguodong/asciicast_test](https://gitea.com/sillyguodong/asciicast_test) |
| Source record ids | gitea_repositories_api-1a5e07a59e769c |
...
For a systems engineer, Gitea: sillyguodong/asciicast_test belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-21T03:04:25Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-1a5e07a59e769c` from `gitea_repositories_api` as `registry_expansion`
