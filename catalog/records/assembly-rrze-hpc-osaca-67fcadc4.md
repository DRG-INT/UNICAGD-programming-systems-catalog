...
<!-- canonical: https://github.com/RRZE-HPC/OSACA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RRZE-HPC/OSACA](https://github.com/RRZE-HPC/OSACA) |
| Source record ids | github_search_assembly-47049ad5b2212f |
...
For a systems engineer, RRZE-HPC/OSACA belongs in the Assembly inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T15:16:35Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-47049ad5b2212f` from `github_search_assembly` as `registry_expansion`
