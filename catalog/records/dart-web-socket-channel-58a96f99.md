...
<!-- canonical: https://pub.dev/packages/web_socket_channel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/web_socket_channel](https://pub.dev/packages/web_socket_channel) |
| Source record ids | pub_dev-9b9bea96693245 |

## System Engineer Summary

StreamChannel wrappers for WebSockets. Provides a cross-platform WebSocketChannel API, a cross-
platform implementation of that API that communicates over an underlying StreamChannel.

## Operational Role

For a systems engineer, web_socket_channel belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.3 | 2025-04-17T20:42:13.656396Z | [https://pub.dev/api/packages/web_socket_channel](https://pub.dev/api/packages/web_socket_channel) |  |
| preview | known | 1.0.6-dev | 2017-09-22T20:54:29.363492Z | [https://pub.dev/api/packages/web_socket_channel](https://pub.dev/api/packages/web_socket_channel) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/web_socket_channel` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-9b9bea96693245` from `pub_dev` as `registry_expansion`
