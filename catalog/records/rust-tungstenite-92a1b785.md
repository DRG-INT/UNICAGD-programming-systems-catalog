...
<!-- canonical: https://crates.io/crates/tungstenite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tungstenite](https://crates.io/crates/tungstenite) |
| Source record ids | crates_io-8572b496dccdce |
...
For a systems engineer, tungstenite belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.0 | 2026-07-11T12:50:30.264231Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-8572b496dccdce` from `crates_io` as `registry_expansion`
