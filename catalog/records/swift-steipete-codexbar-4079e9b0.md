...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/steipete/CodexBar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/steipete/CodexBar](https://github.com/steipete/CodexBar) |
| Source record ids | github_search_swift-97c07e83f6f59a |
...
For a systems engineer, steipete/CodexBar belongs in the Swift inventory as part of diagnostics,
...
- `github_search_swift-97c07e83f6f59a` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| momenbasel/PureMac | Logging Observability | [open](swift-momenbasel-puremac-3b37aa0d.md) |
| sindresorhus/LaunchAtLogin-Legacy | Logging Observability | [open](swift-sindresorhus-launchatlogin-legacy-90e57007.md) |
| sindresorhus/LaunchAtLogin-Modern | Logging Observability | [open](swift-sindresorhus-launchatlogin-modern-7ab8cabe.md) |
