...
<!-- canonical: https://cran.r-project.org/web/packages/gpcihybridIILinApp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpcihybridIILinApp/index.html](https://cran.r-project.org/web/packages/gpcihybridIILinApp/index.html) |
| Source record ids | cran_packages_by_date-a908af915e0b0b |

## System Engineer Summary

Lindley Approximation for Capability Indices under Hybrid Censoring

## Operational Role

For a systems engineer, gpcihybridIILinApp belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 13:00:20 UTC | [https://cran.r-project.org/web/packages/gpcihybridIILinApp/DESCRIPTION](https://cran.r-project.org/web/packages/gpcihybridIILinApp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpcihybridIILinApp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a908af915e0b0b` from `cran_packages_by_date` as `registry_expansion`
