...
<!-- canonical: https://github.com/RefactoringGuru/design-patterns-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RefactoringGuru/design-patterns-python](https://github.com/RefactoringGuru/design-patterns-python) |
| Source record ids | github_search_pattern_language-20ddf877d87ee4 |
...
For a systems engineer, RefactoringGuru/design-patterns-python belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-24T14:07:23Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; {"key": "", "name": "", "url": ""}; Other |
...
- `github_search_pattern_language-20ddf877d87ee4` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| RefactoringGuru/design-patterns-java | Codegen Codemod Refactoring | [open](pattern-language-refactoringguru-design-patterns-java-1d4f4da3.md) |
