...
<!-- canonical: https://github.com/NASA-IMPACT/hls-foundation-os -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NASA-IMPACT/hls-foundation-os](https://github.com/NASA-IMPACT/hls-foundation-os) |
| Source record ids | github_search_radars-be19a2a6115162 |

## System Engineer Summary

This repository contains examples of fine-tuning Harmonized Landsat and Sentinel-2 (HLS) Prithvi
foundation model.

## Operational Role

For a systems engineer, NASA-IMPACT/hls-foundation-os belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-18T06:38:40Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-be19a2a6115162` from `github_search_radars` as `registry_expansion`
