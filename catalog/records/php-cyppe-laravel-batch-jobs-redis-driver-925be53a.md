...
| Canonical URL | [https://packagist.org/packages/cyppe/laravel-batch-jobs-redis-driver](https://packagist.org/packages/cyppe/laravel-batch-jobs-redis-driver) |
| Source record ids | packagist_search-25533177da3083 |
...
For a systems engineer, cyppe/laravel-batch-jobs-redis-driver belongs in the PHP inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-03-06T06:18:57+00:00 | [https://repo.packagist.org/p2/cyppe/laravel-batch-jobs-redis-driver.json](https://repo.packagist.org/p2/cyppe/laravel-batch-jobs-redis-driver.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cyppe/laravel-batch-jobs-redis-driver.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-25533177da3083` from `packagist_search` as `registry_expansion`
