...
<!-- canonical: https://gitlab.com/barrel-db/barrel-platform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/barrel-db/barrel-platform](https://gitlab.com/barrel-db/barrel-platform) |
| Source record ids | gitlab_projects_api-008fd7eda39e52 |
...
For a systems engineer, barrel-db/barrel-platform belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-008fd7eda39e52` from `gitlab_projects_api` as `registry_expansion`
