...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AbInitioSoftwareBase -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AbInitioSoftwareBase", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-6138c5d03bed6d` from `julia_general` as `registry_expansion`
