...
| Canonical URL | [https://crates.io/crates/cpu-time](https://crates.io/crates/cpu-time) |
| Source record ids | crates_io-de55c68641aa40 |
...
For a systems engineer, cpu-time belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2019-10-27T22:41:49.171117Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-de55c68641aa40` from `crates_io` as `registry_expansion`
