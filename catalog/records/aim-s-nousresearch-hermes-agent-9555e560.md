...
| Canonical URL | [https://github.com/NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) |
| Source record ids | github_search_aims-a57d45653dad25 |
...
For a systems engineer, NousResearch/hermes-agent belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:28:23Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-a57d45653dad25` from `github_search_aims` as `registry_expansion`
