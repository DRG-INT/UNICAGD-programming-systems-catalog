...
| Source record ids | lua-source-54 |

## System Engineer Summary

Other Lists is tracked as an other record in the Lua family branch. The source did not provide a
...
For a systems engineer, Other Lists belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 54}}` |
...
- `lua-source-54` from `master_json` as `source_list_item`
