...
<!-- canonical: https://hackage.haskell.org/package/clash-prelude-hedgehog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/clash-prelude-hedgehog](https://hackage.haskell.org/package/clash-prelude-hedgehog) |
| Source record ids | hackage_recent-d09a93f13857fa |
...
For a systems engineer, clash-prelude-hedgehog belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.2 | 2026-09-07T09:27:15Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-d09a93f13857fa` from `hackage_recent` as `registry_expansion`
