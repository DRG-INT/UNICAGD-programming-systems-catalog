...
<!-- canonical: https://github.com/kamadak/exif-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kamadak/exif-rs](https://github.com/kamadak/exif-rs) |
| Source record ids | github_search_photography-403346293cfa83 |
...
For a systems engineer, kamadak/exif-rs belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-21T14:42:29Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 3); MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_photography-403346293cfa83` from `github_search_photography` as `registry_expansion`
