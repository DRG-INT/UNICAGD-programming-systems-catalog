...
<!-- canonical: https://github.com/ItsTanPI/2DURP-GodRays -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ItsTanPI/2DURP-GodRays](https://github.com/ItsTanPI/2DURP-GodRays) |
| Source record ids | github_search_effects-35f1780c234503 |

## System Engineer Summary

GodRays Post-Processing Shader for Unity URP 2D Scenes

## Operational Role

For a systems engineer, ItsTanPI/2DURP-GodRays belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2024-11-01T13:44:58Z | [https://api.github.com/repos/ItsTanPI/2DURP-GodRays/releases/latest](https://api.github.com/repos/ItsTanPI/2DURP-GodRays/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ItsTanPI/2DURP-GodRays/releases/latest` at `2026-09-01T09:23:10+00:00`.
...
- `github_search_effects-35f1780c234503` from `github_search_effects` as `registry_expansion`
