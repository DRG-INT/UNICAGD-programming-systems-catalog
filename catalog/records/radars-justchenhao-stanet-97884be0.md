...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/justchenhao/STANet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/justchenhao/STANet](https://github.com/justchenhao/STANet) |
| Source record ids | github_search_radars-6e70800cf815b7 |

## System Engineer Summary

official implementation of the spatial-temporal attention neural network (STANet) for remote sensing
image change detection

## Operational Role

For a systems engineer, justchenhao/STANet belongs in the Radars inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-11T13:56:15Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-6e70800cf815b7` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jaychempan/LAE-DINO | Ffi Bindings | [open](radars-jaychempan-lae-dino-7c49fbd2.md) |
| JeanExtreme002/FlightRadarAPI | Ffi Bindings | [open](radars-jeanextreme002-flightradarapi-6af98461.md) |
| PolyX-Research/Awesome-Remote-Sensing-Agents | Ffi Bindings | [open](radars-polyx-research-awesome-remote-sensing-agents-e785f828.md) |
| ucam-eo/tessera | Ffi Bindings | [open](radars-ucam-eo-tessera-6a90744d.md) |
| umr-lops/xsar | Ffi Bindings | [open](radars-umr-lops-xsar-a786e2ff.md) |
| ViTAE-Transformer/Remote-Sensing-RVSA | Ffi Bindings | [open](radars-vitae-transformer-remote-sensing-rvsa-ace3c8d7.md) |
| ViTAE-Transformer/SAMRS | Ffi Bindings | [open](radars-vitae-transformer-samrs-81fed666.md) |
| WHU-Sigma/HyperSIGMA | Ffi Bindings | [open](radars-whu-sigma-hypersigma-4627d6e6.md) |
