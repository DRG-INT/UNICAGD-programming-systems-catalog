...
<!-- canonical: https://github.com/webprofusion/OpenAudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/webprofusion/OpenAudio](https://github.com/webprofusion/OpenAudio) |
| Source record ids | github_search_audio-34fb1f7702de77 |

## System Engineer Summary

A list of open source audio software projects (Apps, Plugins and Libraries). Please contribute more
links or open source your own plugins.

## Operational Role

For a systems engineer, webprofusion/OpenAudio belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T07:08:44Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-34fb1f7702de77` from `github_search_audio` as `registry_expansion`
