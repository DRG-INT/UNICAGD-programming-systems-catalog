...
<!-- canonical: https://moaifiddle.com -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://moaifiddle.com](https://moaifiddle.com) |
| Source record ids | lua-source-130 |
...
For a systems engineer, moaifiddle belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 130}}` |
...
- `lua-source-130` from `master_json` as `source_list_item`
