...
<!-- canonical: https://github.com/dariol83/ccsds -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dariol83/ccsds](https://github.com/dariol83/ccsds) |
| Source record ids | github_search_satcom_satellites-db7c7132d4220b |

## System Engineer Summary

Open source Java implementation of publicly available CCSDS standards: SLE, TM/TC, AOS, Space
Packets, COP-1, time formats, CFDP, Encapsulation Packets.

## Operational Role

For a systems engineer, dariol83/ccsds belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.6 | 2024-03-01T15:39:26Z | [https://api.github.com/repos/dariol83/ccsds/releases/latest](https://api.github.com/repos/dariol83/ccsds/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dariol83/ccsds/releases/latest` at `2026-09-01T08:26:34+00:00`.
...
- `github_search_satcom_satellites-db7c7132d4220b` from `github_search_satcom_satellites` as `registry_expansion`
