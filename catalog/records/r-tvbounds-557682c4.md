...
<!-- canonical: https://cran.r-project.org/web/packages/tvbounds/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tvbounds/index.html](https://cran.r-project.org/web/packages/tvbounds/index.html) |
| Source record ids | cran_packages_by_date-b28cd30c3bc04d |

## System Engineer Summary

Sensitivity Analysis and Bounds under Total Variation Neighborhoods

## Operational Role

For a systems engineer, tvbounds belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-10 14:20:02 UTC | [https://cran.r-project.org/web/packages/tvbounds/DESCRIPTION](https://cran.r-project.org/web/packages/tvbounds/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tvbounds/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-b28cd30c3bc04d` from `cran_packages_by_date` as `registry_expansion`
