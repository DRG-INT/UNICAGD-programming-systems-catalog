...
<!-- canonical: https://cran.r-project.org/web/packages/EDE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EDE/index.html](https://cran.r-project.org/web/packages/EDE/index.html) |
| Source record ids | cran_packages_by_date-ac630e5104902f |
...
For a systems engineer, EDE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 16:00:14 UTC | [https://cran.r-project.org/web/packages/EDE/DESCRIPTION](https://cran.r-project.org/web/packages/EDE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EDE/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ac630e5104902f` from `cran_packages_by_date` as `registry_expansion`
