...
<!-- canonical: https://github.com/maelgangloff/domain-watchdog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maelgangloff/domain-watchdog](https://github.com/maelgangloff/domain-watchdog) |
| Source record ids | github_search_catalogs-837b752c9affd6 |

## System Engineer Summary

🔍 An app that monitors domain names using RDAP, tracks their history, and helps you acquire them
when they expire

## Operational Role

For a systems engineer, maelgangloff/domain-watchdog belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-21T20:57:34Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-837b752c9affd6` from `github_search_catalogs` as `registry_expansion`
