...
<!-- canonical: https://github.com/deislabs/wagi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deislabs/wagi](https://github.com/deislabs/wagi) |
| Source record ids | github_search_webassembly-13cf47d3aef18b |
...
For a systems engineer, deislabs/wagi belongs in the WebAssembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-15T16:22:16Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-13cf47d3aef18b` from `github_search_webassembly` as `registry_expansion`
