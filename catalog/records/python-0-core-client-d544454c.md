...
<!-- canonical: https://pypi.org/project/0-core-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/0-core-client/](https://pypi.org/project/0-core-client/) |
| Source record ids | pypi_simple-f0ec3f08b2cd91 |

## System Engineer Summary

0-core-client is tracked as a networking http record in the Python branch. The source did not
...
For a systems engineer, 0-core-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0a8 | 2017-10-11T13:19:49.816030Z | [https://pypi.org/pypi/0-core-client/json](https://pypi.org/pypi/0-core-client/json) |  |
| preview | known | 1.1.0a7 | 2017-08-08T18:10:31.426796Z | [https://pypi.org/pypi/0-core-client/json](https://pypi.org/pypi/0-core-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/0-core-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-f0ec3f08b2cd91` from `pypi_simple` as `registry_expansion`
