...
<!-- canonical: https://crates.io/crates/alsa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/alsa](https://crates.io/crates/alsa) |
| Source record ids | crates_io-9625e9906eb3ab |
...
For a systems engineer, alsa belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.1 | 2026-07-31T11:41:39.989720Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0 |
...
| foreign-types | Api Abi Checker | [open](rust-foreign-types-cbb5497c.md) |
