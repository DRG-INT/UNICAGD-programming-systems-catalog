...
<!-- canonical: https://github.com/dominikhei/Local-Data-LakeHouse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dominikhei/Local-Data-LakeHouse](https://github.com/dominikhei/Local-Data-LakeHouse) |
| Source record ids | github_search_databases-6f991ca2266980 |

## System Engineer Summary

Sample Data Lakehouse deployed in Docker containers using Apache Iceberg, Minio, Trino and a Hive
Metastore. Can be used for local testing.

## Operational Role

For a systems engineer, dominikhei/Local-Data-LakeHouse belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-02T20:04:35Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6f991ca2266980` from `github_search_databases` as `registry_expansion`
