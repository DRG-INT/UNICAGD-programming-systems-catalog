...
| Canonical URL | [https://packagist.org/packages/atk4/data](https://packagist.org/packages/atk4/data) |
| Source record ids | packagist_search-ef92fa88b35fae |
...
For a systems engineer, atk4/data belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2025-04-22T14:31:17+00:00 | [https://repo.packagist.org/p2/atk4/data.json](https://repo.packagist.org/p2/atk4/data.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/atk4/data.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-ef92fa88b35fae` from `packagist_search` as `registry_expansion`
