...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/jll/A/AFLplusplus_jll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/A/AFLplusplus_jll](https://github.com/JuliaRegistries/General/tree/master/jll/A/AFLplusplus_jll) |
| Source record ids | julia_general-434bb65a95b0ee |

## System Engineer Summary

Julia package registered in General at jll/A/AFLplusplus_jll.

## Operational Role

For a systems engineer, AFLplusplus_jll belongs in the Julia inventory as part of input-space
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "jll/A/AFLplusplus_jll", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-434bb65a95b0ee` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AirSeaFluxes | Fuzzer | [open](julia-airseafluxes-0ebc67f8.md) |
