...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/oscar30gt/pulse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oscar30gt/pulse](https://github.com/oscar30gt/pulse) |
| Source record ids | github_search_engines-a5e034888ebfda |

## System Engineer Summary

Pulse is a multi-platform digital logic simulation engine for VHDL made with C++. It transforms VHDL
source code into logic components so it can be simulated and debugged.

## Operational Role

For a systems engineer, oscar30gt/pulse belongs in the Engines inventory as part of fault isolation,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T12:18:41Z | gh search repos topic:simulation-engine stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_engines-a5e034888ebfda` from `github_search_engines` as `registry_expansion`
