...
<!-- canonical: https://github.com/apache/incubator-heron -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/incubator-heron](https://github.com/apache/incubator-heron) |
| Source record ids | github_search_video-ac1596e9ced443 |

## System Engineer Summary

Apache Heron (Incubating) is a realtime, distributed, fault-tolerant stream processing engine from
Twitter

## Operational Role

For a systems engineer, apache/incubator-heron belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-01T15:11:08Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ac1596e9ced443` from `github_search_video` as `registry_expansion`
