...
<!-- canonical: https://github.com/rezoo/movis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rezoo/movis](https://github.com/rezoo/movis) |
| Source record ids | github_search_video-c35af91b13584e |

## System Engineer Summary

Python library for video editing, presentation video generation, motion graphics, shader art coding,
and other video production tasks

## Operational Role

For a systems engineer, rezoo/movis belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-25T14:57:04Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-c35af91b13584e` from `github_search_video` as `registry_expansion`
