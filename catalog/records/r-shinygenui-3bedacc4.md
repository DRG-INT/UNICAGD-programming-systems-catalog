...
<!-- canonical: https://cran.r-project.org/web/packages/shinygenui/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinygenui/index.html](https://cran.r-project.org/web/packages/shinygenui/index.html) |
| Source record ids | cran_packages_by_date-080c4d1a7870cd |
...
For a systems engineer, shinygenui belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 16:40:02 UTC | [https://cran.r-project.org/web/packages/shinygenui/DESCRIPTION](https://cran.r-project.org/web/packages/shinygenui/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinygenui/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-080c4d1a7870cd` from `cran_packages_by_date` as `registry_expansion`
