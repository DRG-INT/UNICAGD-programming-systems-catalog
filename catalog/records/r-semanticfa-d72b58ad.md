...
<!-- canonical: https://cran.r-project.org/web/packages/semanticfa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/semanticfa/index.html](https://cran.r-project.org/web/packages/semanticfa/index.html) |
| Source record ids | cran_packages_by_date-4091a1c42baa61 |
...
For a systems engineer, semanticfa belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-01 21:00:02 UTC | [https://cran.r-project.org/web/packages/semanticfa/DESCRIPTION](https://cran.r-project.org/web/packages/semanticfa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/semanticfa/DESCRIPTION` at `2026-09-01T22:17:57+00:00`.
...
- `cran_packages_by_date-4091a1c42baa61` from `cran_packages_by_date` as `registry_expansion`
