...
<!-- canonical: https://cran.r-project.org/web/packages/faunabr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/faunabr/index.html](https://cran.r-project.org/web/packages/faunabr/index.html) |
| Source record ids | cran_packages_by_date-ab5cdd94b3c0d4 |

## System Engineer Summary

Explore Catálogo Taxônomico da Fauna do Brasil Database

## Operational Role

For a systems engineer, faunabr belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-21 13:30:25 UTC | [https://cran.r-project.org/web/packages/faunabr/DESCRIPTION](https://cran.r-project.org/web/packages/faunabr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/faunabr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ab5cdd94b3c0d4` from `cran_packages_by_date` as `registry_expansion`
