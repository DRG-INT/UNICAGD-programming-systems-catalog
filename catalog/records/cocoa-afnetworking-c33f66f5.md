...
<!-- canonical: https://cocoapods.org/pods/AFNetworking -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/AFNetworking](https://cocoapods.org/pods/AFNetworking) |
| Source record ids | cocoapods_cdn-c155a31afa7b3a |
...
For a systems engineer, AFNetworking belongs in the Cocoa inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2020-04-20 02:25:51 UTC | [https://trunk.cocoapods.org/api/v1/pods/AFNetworking](https://trunk.cocoapods.org/api/v1/pods/AFNetworking) |  |
| preview | known | 3.0.0-beta.3 | 2015-12-04 21:42:21 UTC | [https://trunk.cocoapods.org/api/v1/pods/AFNetworking](https://trunk.cocoapods.org/api/v1/pods/AFNetworking) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/AFNetworking` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-c155a31afa7b3a` from `cocoapods_cdn` as `registry_expansion`
