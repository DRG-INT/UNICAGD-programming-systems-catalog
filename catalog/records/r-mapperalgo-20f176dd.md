...
<!-- canonical: https://cran.r-project.org/web/packages/MapperAlgo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MapperAlgo/index.html](https://cran.r-project.org/web/packages/MapperAlgo/index.html) |
| Source record ids | cran_packages_by_date-883041448d3269 |
...
For a systems engineer, MapperAlgo belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-31 14:40:02 UTC | [https://cran.r-project.org/web/packages/MapperAlgo/DESCRIPTION](https://cran.r-project.org/web/packages/MapperAlgo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MapperAlgo/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-883041448d3269` from `cran_packages_by_date` as `registry_expansion`
