...
<!-- canonical: https://hackage.haskell.org/package/exchangealgebra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/exchangealgebra](https://hackage.haskell.org/package/exchangealgebra) |
| Source record ids | hackage_recent-792e7e5061c2b3 |

## System Engineer Summary

Hackage package recently uploaded by yakagika.

## Operational Role

For a systems engineer, exchangealgebra belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.0 | 2026-09-04T03:50:08Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-792e7e5061c2b3` from `hackage_recent` as `registry_expansion`
