...
<!-- canonical: https://github.com/ChartsOrg/Charts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChartsOrg/Charts](https://github.com/ChartsOrg/Charts) |
| Source record ids | github_search_swift-0b6eab6770424f |
...
For a systems engineer, ChartsOrg/Charts belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-07T05:36:26Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-0b6eab6770424f` from `github_search_swift` as `registry_expansion`
