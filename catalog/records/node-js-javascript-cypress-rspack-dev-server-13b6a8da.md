...
<!-- canonical: https://www.npmjs.com/package/cypress-rspack-dev-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/cypress-rspack-dev-server](https://www.npmjs.com/package/cypress-rspack-dev-server) |
| Source record ids | npm_registry-555be3cb3db799 |
...
For a systems engineer, cypress-rspack-dev-server belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2026-08-17T13:05:00.220Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-555be3cb3db799` from `npm_registry` as `registry_expansion`
