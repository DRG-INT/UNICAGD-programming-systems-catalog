...
| Canonical URL | [https://github.com/altmany/export_fig](https://github.com/altmany/export_fig) |
| Source record ids | github_search_matlab-fec630b2e7230f |
...
For a systems engineer, altmany/export_fig belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.58 | 2026-08-13T13:43:22Z | [https://api.github.com/repos/altmany/export_fig/releases/latest](https://api.github.com/repos/altmany/export_fig/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/altmany/export_fig/releases/latest` at `2026-09-01T07:24:08+00:00`.
...
- `github_search_matlab-fec630b2e7230f` from `github_search_matlab` as `registry_expansion`
