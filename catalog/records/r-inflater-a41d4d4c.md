...
<!-- canonical: https://cran.r-project.org/web/packages/inflateR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/inflateR/index.html](https://cran.r-project.org/web/packages/inflateR/index.html) |
| Source record ids | cran_packages_by_date-a3c24cac0ba016 |
...
For a systems engineer, inflateR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-09 10:40:20 UTC | [https://cran.r-project.org/web/packages/inflateR/DESCRIPTION](https://cran.r-project.org/web/packages/inflateR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/inflateR/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-a3c24cac0ba016` from `cran_packages_by_date` as `registry_expansion`
