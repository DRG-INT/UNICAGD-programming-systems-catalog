...
<!-- canonical: https://cran.r-project.org/web/packages/GerminaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GerminaR/index.html](https://cran.r-project.org/web/packages/GerminaR/index.html) |
| Source record ids | cran_packages_by_date-15469e80ef5484 |
...
For a systems engineer, GerminaR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.7 | 2026-09-10 05:00:02 UTC | [https://cran.r-project.org/web/packages/GerminaR/DESCRIPTION](https://cran.r-project.org/web/packages/GerminaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GerminaR/DESCRIPTION` at `2026-09-10T05:19:38+00:00`.
...
- `cran_packages_by_date-15469e80ef5484` from `cran_packages_by_date` as `registry_expansion`
