...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ipc-sim/IPC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ipc-sim/IPC](https://github.com/ipc-sim/IPC) |
| Source record ids | github_search_computer_graphics_software-6b5f5af5a5fedd |

## System Engineer Summary

Incremental Potential Contact (IPC) is for robust and accurate time stepping of nonlinear
elastodynamics. IPC guarantees intersection- and inversion-free trajectories regardless of
materials, time-step sizes, velocities, or deformation severity.

## Operational Role

For a systems engineer, ipc-sim/IPC belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-6b5f5af5a5fedd` from `github_search_computer_graphics_software` as `registry_expansion`
