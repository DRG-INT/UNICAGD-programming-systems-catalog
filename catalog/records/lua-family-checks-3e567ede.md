...
<!-- canonical: https://luarocks.org/modules/fab13n/checks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fab13n/checks](https://luarocks.org/modules/fab13n/checks) |
| Source record ids | luarocks_root_manifest-05bb6749cdb5f3 |
...
For a systems engineer, checks belongs in the Lua family inventory as part of interface contracts,
...
- `luarocks_root_manifest-05bb6749cdb5f3` from `luarocks_root_manifest` as `registry_expansion`
