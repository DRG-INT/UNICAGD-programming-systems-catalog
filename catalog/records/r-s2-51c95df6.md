...
<!-- canonical: https://cran.r-project.org/web/packages/s2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/s2/index.html](https://cran.r-project.org/web/packages/s2/index.html) |
| Source record ids | cran_packages_by_date-5276e448b1b953 |
...
For a systems engineer, s2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.12 | 2026-09-03 09:30:02 UTC | [https://cran.r-project.org/web/packages/s2/DESCRIPTION](https://cran.r-project.org/web/packages/s2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/s2/DESCRIPTION` at `2026-09-03T10:21:04+00:00`.
...
- `cran_packages_by_date-5276e448b1b953` from `cran_packages_by_date` as `registry_expansion`
