...
io-ts is tracked as a serialization record in the Node.js/TypeScript branch. The source did not
...
| Name | Category | Page |
| --- | --- | --- |
| ArkType | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-arktype-c9b17f92.md) |
