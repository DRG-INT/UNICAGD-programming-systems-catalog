...
<!-- canonical: https://cran.r-project.org/web/packages/SpaDES.tools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SpaDES.tools/index.html](https://cran.r-project.org/web/packages/SpaDES.tools/index.html) |
| Source record ids | cran_packages_by_date-5e30ce2a5e674c |
...
For a systems engineer, SpaDES.tools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2026-08-28 21:30:33 UTC | [https://cran.r-project.org/web/packages/SpaDES.tools/DESCRIPTION](https://cran.r-project.org/web/packages/SpaDES.tools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SpaDES.tools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5e30ce2a5e674c` from `cran_packages_by_date` as `registry_expansion`
