...
<!-- canonical: https://github.com/cosmonium/cosmonium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cosmonium/cosmonium](https://github.com/cosmonium/cosmonium) |
| Source record ids | github_search_telescopes-363d4dc0450daa |
...
For a systems engineer, cosmonium/cosmonium belongs in the Telescopes inventory as part of language
tooling, code generation, static analysis, and source transformation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.1.1 | 2021-01-03T23:33:38Z | [https://api.github.com/repos/cosmonium/cosmonium/releases/latest](https://api.github.com/repos/cosmonium/cosmonium/releases/latest) |  |
| preview | known | v0.3.0.dev876 | 2024-05-01T08:18:26Z | [https://api.github.com/repos/cosmonium/cosmonium/releases?per_page=10](https://api.github.com/repos/cosmonium/cosmonium/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cosmonium/cosmonium/releases/latest` at `2026-09-01T08:26:23+00:00`.
...
- `github_search_telescopes-363d4dc0450daa` from `github_search_telescopes` as `registry_expansion`
