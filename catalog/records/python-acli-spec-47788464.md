...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/acli-spec/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acli-spec/](https://pypi.org/project/acli-spec/) |
| Source record ids | pypi_simple-1df6b797943cf5 |
...
For a systems engineer, acli-spec belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-04-23T19:38:21.957651Z | [https://pypi.org/pypi/acli-spec/json](https://pypi.org/pypi/acli-spec/json) |  |
...
| Evidence | License :: OSI Approved :: European Union Public Licence 1.2 (EUPL 1.2) |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acli-spec/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-1df6b797943cf5` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0x-sra-client | Language Specification | [open](python-0x-sra-client-9195d9dc.md) |
| 3dcitydb-mcp-server | Language Specification | [open](python-3dcitydb-mcp-server-83ade52b.md) |
| aas-standard-parser | Language Specification | [open](python-aas-standard-parser-556a520f.md) |
| ab-logging | Language Specification | [open](python-ab-logging-e2f153ca.md) |
| abcli | Language Specification | [open](python-abcli-d38c5df3.md) |
| actx-cli | Language Specification | [open](python-actx-cli-65a25b28.md) |
| adamlint | Language Specification | [open](python-adamlint-642ccba3.md) |
| adaptorch-client | Language Specification | [open](python-adaptorch-client-4c684090.md) |
