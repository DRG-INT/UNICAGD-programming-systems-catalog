...
<!-- canonical: https://github.com/gokriznastic/HybridSN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gokriznastic/HybridSN](https://github.com/gokriznastic/HybridSN) |
| Source record ids | github_search_radars-10259995ea48db |

## System Engineer Summary

A keras based implementation of Hybrid-Spectral-Net as in IEEE GRSL paper "HybridSN: Exploring 3D-2D
CNN Feature Hierarchy for Hyperspectral Image Classification".

## Operational Role

For a systems engineer, gokriznastic/HybridSN belongs in the Radars inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-23T07:24:11Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-10259995ea48db` from `github_search_radars` as `registry_expansion`
