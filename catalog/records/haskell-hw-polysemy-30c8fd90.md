...
<!-- canonical: https://hackage.haskell.org/package/hw-polysemy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hw-polysemy](https://hackage.haskell.org/package/hw-polysemy) |
| Source record ids | hackage_top_downloads-7620a4d6cba2d4 |
...
For a systems engineer, hw-polysemy belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1.2 | 2024-12-30T13:36:06Z | [https://hackage.haskell.org/package/hw-polysemy](https://hackage.haskell.org/package/hw-polysemy) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hw-polysemy` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-7620a4d6cba2d4` from `hackage_top_downloads` as `registry_expansion`
