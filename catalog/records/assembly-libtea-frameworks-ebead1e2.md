...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/libtea/frameworks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libtea/frameworks](https://github.com/libtea/frameworks) |
| Source record ids | github_search_assembly-fcfcf3e2eedd0d |

## System Engineer Summary

Microarchitectural attack development frameworks for prototyping attacks in native code (C, C++,
ASM) and in the browser

## Operational Role

For a systems engineer, libtea/frameworks belongs in the Assembly inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-07T14:59:34Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-fcfcf3e2eedd0d` from `github_search_assembly` as `registry_expansion`
