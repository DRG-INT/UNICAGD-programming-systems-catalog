...
| Canonical URL | [https://luarocks.org/modules/neorocks/elixir-tools.nvim](https://luarocks.org/modules/neorocks/elixir-tools.nvim) |
| Source record ids | luarocks_root_manifest-4f2d3447691f7e |
...
For a systems engineer, elixir-tools.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4f2d3447691f7e` from `luarocks_root_manifest` as `registry_expansion`
