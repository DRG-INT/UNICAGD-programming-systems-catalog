...
<!-- canonical: https://github.com/fancompute/fdfdpy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fancompute/fdfdpy](https://github.com/fancompute/fdfdpy) |
| Source record ids | github_search_electromagnetoscopes-b6ac40ee6de4b7 |
...
For a systems engineer, fancompute/fdfdpy belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-05T22:12:15Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b6ac40ee6de4b7` from `github_search_electromagnetoscopes` as `registry_expansion`
