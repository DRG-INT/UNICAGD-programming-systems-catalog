...
<!-- canonical: https://cran.r-project.org/web/packages/lrstat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lrstat/index.html](https://cran.r-project.org/web/packages/lrstat/index.html) |
| Source record ids | cran_packages_by_date-eb9c2eac6a6b83 |
...
For a systems engineer, lrstat belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-25 13:00:02 UTC | [https://cran.r-project.org/web/packages/lrstat/DESCRIPTION](https://cran.r-project.org/web/packages/lrstat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lrstat/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eb9c2eac6a6b83` from `cran_packages_by_date` as `registry_expansion`
