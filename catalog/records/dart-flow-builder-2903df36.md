...
<!-- canonical: https://pub.dev/packages/flow_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flow_builder](https://pub.dev/packages/flow_builder) |
| Source record ids | pub_dev-071110babe4ab3 |
...
For a systems engineer, flow_builder belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2024-04-02T04:42:38.369249Z | [https://pub.dev/api/packages/flow_builder](https://pub.dev/api/packages/flow_builder) |  |
| preview | known | 0.0.1-nullsafety.0 | 2021-01-26T02:02:58.264277Z | [https://pub.dev/api/packages/flow_builder](https://pub.dev/api/packages/flow_builder) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flow_builder` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-071110babe4ab3` from `pub_dev` as `registry_expansion`
