...
<!-- canonical: https://cran.r-project.org/web/packages/EWAScaller/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EWAScaller/index.html](https://cran.r-project.org/web/packages/EWAScaller/index.html) |
| Source record ids | cran_packages_by_date-0499e49637fbd0 |
...
For a systems engineer, EWAScaller belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 08:40:09 UTC | [https://cran.r-project.org/web/packages/EWAScaller/DESCRIPTION](https://cran.r-project.org/web/packages/EWAScaller/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EWAScaller/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0499e49637fbd0` from `cran_packages_by_date` as `registry_expansion`
