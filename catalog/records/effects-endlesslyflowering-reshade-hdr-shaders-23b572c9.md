...
<!-- canonical: https://github.com/EndlesslyFlowering/ReShade_HDR_shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EndlesslyFlowering/ReShade_HDR_shaders](https://github.com/EndlesslyFlowering/ReShade_HDR_shaders) |
| Source record ids | github_search_effects-200ba012700da9 |
...
For a systems engineer, EndlesslyFlowering/ReShade_HDR_shaders belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.02.28 | 2026-02-27T23:16:01Z | [https://api.github.com/repos/EndlesslyFlowering/ReShade_HDR_shaders/releases/latest](https://api.github.com/repos/EndlesslyFlowering/ReShade_HDR_shaders/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/EndlesslyFlowering/ReShade_HDR_shaders/releases/latest` at `2026-09-01T09:23:09+00:00`.
...
- `github_search_effects-200ba012700da9` from `github_search_effects` as `registry_expansion`
...
| yihong1120/Construction-Hazard-Detection | Static Analyzer | [open](effects-yihong1120-construction-hazard-detection-3100e426.md) |
