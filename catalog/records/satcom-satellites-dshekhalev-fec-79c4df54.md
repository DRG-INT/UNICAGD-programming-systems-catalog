...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Standard Library](../by-category/standard-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dshekhalev/FEC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dshekhalev/FEC](https://github.com/dshekhalev/FEC) |
| Source record ids | github_search_satcom_satellites-9e1e81518699ba |
...
For a systems engineer, dshekhalev/FEC belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T18:02:38Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-9e1e81518699ba` from `github_search_satcom_satellites` as `registry_expansion`
