...
<!-- canonical: https://github.com/nyxos-dev/nyx-os -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nyxos-dev/nyx-os](https://github.com/nyxos-dev/nyx-os) |
| Source record ids | github_search_assembly-2aabbd9df21a7c |

## System Engineer Summary

x86_64 higher-half kernel with multitasking, GUI compositor, TCP/IP networking, EXT2 filesystem, ELF
userspace and full app suite

## Operational Role

For a systems engineer, nyxos-dev/nyx-os belongs in the Assembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:16:57Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-2aabbd9df21a7c` from `github_search_assembly` as `registry_expansion`
...
| OWASP/ZSC | Networking Http | [open](assembly-owasp-zsc-566fd5f9.md) |
