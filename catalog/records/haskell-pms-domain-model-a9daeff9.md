...
<!-- canonical: https://hackage.haskell.org/package/pms-domain-model -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pms-domain-model](https://hackage.haskell.org/package/pms-domain-model) |
| Source record ids | hackage_top_downloads-6773ad3fe7be38 |
...
For a systems engineer, pms-domain-model belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9.0 | 2026-06-19T23:35:47Z | [https://hackage.haskell.org/package/pms-domain-model](https://hackage.haskell.org/package/pms-domain-model) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pms-domain-model` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-6773ad3fe7be38` from `hackage_top_downloads` as `registry_expansion`
