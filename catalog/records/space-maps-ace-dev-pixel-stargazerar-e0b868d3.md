...
<!-- canonical: https://github.com/ace-dev-pixel/StargazerAR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ace-dev-pixel/StargazerAR](https://github.com/ace-dev-pixel/StargazerAR) |
| Source record ids | github_search_space_maps-0a18e1fc334640 |

## System Engineer Summary

A personalized astronomy guide with an Augmented Reality sky map. Built with React Native

## Operational Role

For a systems engineer, ace-dev-pixel/StargazerAR belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-14T14:29:14Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0a18e1fc334640` from `github_search_space_maps` as `registry_expansion`
