...
| Canonical URL | [https://luarocks.org/modules/deybismelendez/game-tools](https://luarocks.org/modules/deybismelendez/game-tools) |
| Source record ids | luarocks_root_manifest-6b7d43642bcff5 |

## System Engineer Summary

game-tools is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, game-tools belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-6b7d43642bcff5` from `luarocks_root_manifest` as `registry_expansion`
