...
<!-- canonical: https://github.com/rangasri85/ranga -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rangasri85/ranga](https://github.com/rangasri85/ranga) |
| Source record ids | github_search_sapjava-89ee79403cd54c |

## System Engineer Summary

rangasri85/ranga is tracked as an interpreter runtime record in the SAPJava branch. The source did
...
For a systems engineer, rangasri85/ranga belongs in the SAPJava inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-14T13:14:42Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-89ee79403cd54c` from `github_search_sapjava` as `registry_expansion`
