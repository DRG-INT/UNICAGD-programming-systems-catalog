...
<!-- canonical: https://hackage.haskell.org/package/time-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/time-manager](https://hackage.haskell.org/package/time-manager) |
| Source record ids | hackage_top_downloads-ee3255efab7376 |
...
For a systems engineer, time-manager belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-04-05T15:23:53Z | [https://hackage.haskell.org/package/time-manager](https://hackage.haskell.org/package/time-manager) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/time-manager` at `2026-09-01T14:24:35+00:00`.
...
- `hackage_top_downloads-ee3255efab7376` from `hackage_top_downloads` as `registry_expansion`
