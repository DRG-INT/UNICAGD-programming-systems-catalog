...
| Canonical URL | [https://crates.io/crates/html-escape](https://crates.io/crates/html-escape) |
| Source record ids | crates_io-04f737b4c54b56, crates_io-bdde0bfb100d01 |

## System Engineer Summary

This library is for encoding/escaping special characters in HTML and decoding/unescaping HTML
entities as well.

## Operational Role

For a systems engineer, html-escape belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.15 | 2026-08-01T11:17:38.043268Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-04f737b4c54b56` from `crates_io` as `registry_expansion`
- `crates_io-bdde0bfb100d01` from `crates_io` as `registry_expansion`
