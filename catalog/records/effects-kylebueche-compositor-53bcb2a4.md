...
<!-- canonical: https://github.com/kylebueche/compositor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kylebueche/compositor](https://github.com/kylebueche/compositor) |
| Source record ids | github_search_effects-611dca5e599de4 |

## System Engineer Summary

A VFX Compositor for my class, ICS489: Computer Visual Effects

## Operational Role

For a systems engineer, kylebueche/compositor belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-02T08:34:18Z | gh search repos visual effects compositor | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-611dca5e599de4` from `github_search_effects` as `registry_expansion`
