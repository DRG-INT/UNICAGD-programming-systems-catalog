...
<!-- canonical: https://github.com/tobspr-games/shapez.io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tobspr-games/shapez.io](https://github.com/tobspr-games/shapez.io) |
| Source record ids | github_search_game_engines-2450cd42a625b0 |
...
For a systems engineer, tobspr-games/shapez.io belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-28T06:56:37Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-2450cd42a625b0` from `github_search_game_engines` as `registry_expansion`
