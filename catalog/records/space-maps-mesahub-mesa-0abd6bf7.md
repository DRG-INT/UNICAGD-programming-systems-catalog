...
<!-- canonical: https://github.com/MESAHub/mesa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MESAHub/mesa](https://github.com/MESAHub/mesa) |
| Source record ids | github_search_space_maps-e58d13224fbfb4 |
...
For a systems engineer, MESAHub/mesa belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T05:23:44Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e58d13224fbfb4` from `github_search_space_maps` as `registry_expansion`
