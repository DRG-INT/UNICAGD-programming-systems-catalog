...
| Canonical URL | [https://luarocks.org/modules/optum-ross/kong-cluster-drain](https://luarocks.org/modules/optum-ross/kong-cluster-drain) |
| Source record ids | luarocks_root_manifest-d6e3aa9935dcaf |

## System Engineer Summary

Drain and divert your traffic without briging down the LTM and iterrupting existing traffic by a
switch that allows failing your healthcheck to a datacenter.

## Operational Role

For a systems engineer, kong-cluster-drain belongs in the Lua family inventory as part of cross-
...
- `luarocks_root_manifest-d6e3aa9935dcaf` from `luarocks_root_manifest` as `registry_expansion`
