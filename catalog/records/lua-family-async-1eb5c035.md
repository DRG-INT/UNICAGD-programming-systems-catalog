...
<!-- canonical: https://luarocks.org/modules/bartbes/async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bartbes/async](https://luarocks.org/modules/bartbes/async) |
| Source record ids | luarocks_root_manifest-7481972c08d700 |
...
For a systems engineer, async belongs in the Lua family inventory as part of concurrency scheduling,
...
- `luarocks_root_manifest-7481972c08d700` from `luarocks_root_manifest` as `registry_expansion`
...
| dromozoa-future | Async Runtime | [open](lua-family-dromozoa-future-755e7788.md) |
