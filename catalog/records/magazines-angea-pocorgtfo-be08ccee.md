...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/angea/pocorgtfo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/angea/pocorgtfo](https://github.com/angea/pocorgtfo) |
| Source record ids | github_search_magazines-8e9a24ff131993 |

## System Engineer Summary

a "Proof of Concept or GTFO" mirror with an extensive index with also whole issues or individual
articles as clean PDFs.

## Operational Role

For a systems engineer, angea/pocorgtfo belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-11T19:59:00Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-8e9a24ff131993` from `github_search_magazines` as `registry_expansion`
