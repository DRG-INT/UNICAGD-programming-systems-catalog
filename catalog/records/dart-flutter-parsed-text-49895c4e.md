...
<!-- canonical: https://pub.dev/packages/flutter_parsed_text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_parsed_text](https://pub.dev/packages/flutter_parsed_text) |
| Source record ids | pub_dev-19bdac72e9b64b |
...
For a systems engineer, flutter_parsed_text belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2021-06-01T04:58:40.278380Z | [https://pub.dev/api/packages/flutter_parsed_text](https://pub.dev/api/packages/flutter_parsed_text) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_parsed_text` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-19bdac72e9b64b` from `pub_dev` as `registry_expansion`
