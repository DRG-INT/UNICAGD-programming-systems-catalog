...
<!-- canonical: https://crates.io/crates/httpdate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/httpdate](https://crates.io/crates/httpdate) |
| Source record ids | crates_io-87522023a83f7e |
...
For a systems engineer, httpdate belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2023-08-13T10:55:54.391658Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-87522023a83f7e` from `crates_io` as `registry_expansion`
