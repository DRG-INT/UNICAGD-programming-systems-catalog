...
<!-- canonical: https://github.com/mathworks/Simscape-Battery-Electric-Vehicle-Model -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mathworks/Simscape-Battery-Electric-Vehicle-Model](https://github.com/mathworks/Simscape-Battery-Electric-Vehicle-Model) |
| Source record ids | github_search_matlab-3935fcc648b772 |
...
For a systems engineer, mathworks/Simscape-Battery-Electric-Vehicle-Model belongs in the Matlab
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T14:42:27Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-3935fcc648b772` from `github_search_matlab` as `registry_expansion`
