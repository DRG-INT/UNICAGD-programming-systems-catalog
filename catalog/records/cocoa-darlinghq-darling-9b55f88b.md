...
<!-- canonical: https://github.com/darlinghq/darling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/darlinghq/darling](https://github.com/darlinghq/darling) |
| Source record ids | github_search_cocoa-4bcd553cc79d3a |
...
For a systems engineer, darlinghq/darling belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T23:42:36Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-4bcd553cc79d3a` from `github_search_cocoa` as `registry_expansion`
