# Gitea: marco.fullstack2/devops_test

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/marco.fullstack2/devops_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/marco.fullstack2/devops_test](https://gitea.com/marco.fullstack2/devops_test) |
| Source record ids | gitea_repositories_api-6c89f495447785 |
...
For a systems engineer, Gitea: marco.fullstack2/devops_test belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-27T15:06:12Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6c89f495447785` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: docker_test/db2 | Testing Framework | [open](repository-workplaces-gitea-docker-test-db2-173a455c.md) |
| Gitea: nhanpt/config-server-test | Testing Framework | [open](repository-workplaces-gitea-nhanpt-config-server-test-694815eb.md) |
| Gitea: sillyguodong/asciicast_test | Testing Framework | [open](repository-workplaces-gitea-sillyguodong-asciicast-test-bbac7031.md) |
| postgres-ai/database-lab | Testing Framework | [open](repository-workplaces-postgres-ai-database-lab-87d74ca8.md) |
