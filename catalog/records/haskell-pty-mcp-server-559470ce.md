...
<!-- canonical: https://hackage.haskell.org/package/pty-mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pty-mcp-server](https://hackage.haskell.org/package/pty-mcp-server) |
| Source record ids | hackage_top_downloads-ce19c122986eba |
...
For a systems engineer, pty-mcp-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2.0 | 2026-07-13T09:12:34Z | [https://hackage.haskell.org/package/pty-mcp-server](https://hackage.haskell.org/package/pty-mcp-server) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pty-mcp-server` at `2026-09-05T00:32:01+00:00`.
...
- `hackage_top_downloads-ce19c122986eba` from `hackage_top_downloads` as `registry_expansion`
