...
<!-- canonical: https://cran.r-project.org/web/packages/SynthETIC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SynthETIC/index.html](https://cran.r-project.org/web/packages/SynthETIC/index.html) |
| Source record ids | cran_packages_by_date-7c1cb054cf309c |
...
For a systems engineer, SynthETIC belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-30 05:10:39 UTC | [https://cran.r-project.org/web/packages/SynthETIC/DESCRIPTION](https://cran.r-project.org/web/packages/SynthETIC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SynthETIC/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7c1cb054cf309c` from `cran_packages_by_date` as `registry_expansion`
