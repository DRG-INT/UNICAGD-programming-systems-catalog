...
| Canonical URL | [https://github.com/unoplatform/Uno.Wasm.Bootstrap](https://github.com/unoplatform/Uno.Wasm.Bootstrap) |
| Source record ids | github_search_webassembly-dc5340687fb212 |
...
For a systems engineer, unoplatform/Uno.Wasm.Bootstrap belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.0.3 | 2024-10-31T18:27:58Z | [https://api.github.com/repos/unoplatform/Uno.Wasm.Bootstrap/releases/latest](https://api.github.com/repos/unoplatform/Uno.Wasm.Bootstrap/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/unoplatform/Uno.Wasm.Bootstrap/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-dc5340687fb212` from `github_search_webassembly` as `registry_expansion`
