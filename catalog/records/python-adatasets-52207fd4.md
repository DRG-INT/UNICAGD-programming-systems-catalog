...
<!-- canonical: https://pypi.org/project/adatasets/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adatasets/](https://pypi.org/project/adatasets/) |
| Source record ids | pypi_simple-25a3cacdf30db8 |

## System Engineer Summary

adatasets is tracked as a library record in the Python branch. The source did not provide a long
...
For a systems engineer, adatasets belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.16295265 | 2021-08-21T06:15:03.732785Z | [https://pypi.org/pypi/adatasets/json](https://pypi.org/pypi/adatasets/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adatasets/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-25a3cacdf30db8` from `pypi_simple` as `registry_expansion`
