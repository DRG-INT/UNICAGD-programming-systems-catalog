# fujiaze/Gaia-DR3-DR3SP-Client-C

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/fujiaze/Gaia-DR3-DR3SP-Client-C -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fujiaze/Gaia-DR3-DR3SP-Client-C](https://github.com/fujiaze/Gaia-DR3-DR3SP-Client-C) |
| Source record ids | github_search_space_maps-16a618cb8cdf1b |

## System Engineer Summary

Gaia DR3SP Client（C）— Lightweight C client for PixInsight Gaia DR3 XPSD offline star catalog

## Operational Role

For a systems engineer, fujiaze/Gaia-DR3-DR3SP-Client-C belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T09:41:47Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-16a618cb8cdf1b` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Corsinvest/cv4pve-vdi | Networking Http | [open](space-maps-corsinvest-cv4pve-vdi-bc170682.md) |
| electerm/electerm | Networking Http | [open](space-maps-electerm-electerm-8c5dc479.md) |
| fat/space-tweet | Networking Http | [open](space-maps-fat-space-tweet-f2d19386.md) |
| FreeRDP/Remmina | Networking Http | [open](space-maps-freerdp-remmina-5536d2a1.md) |
| gamergenic/ASATDebrisVisualization | Networking Http | [open](space-maps-gamergenic-asatdebrisvisualization-f225aa3d.md) |
| JamesDavid/Overhead | Networking Http | [open](space-maps-jamesdavid-overhead-e7ed8b99.md) |
| joseljim/Route_Planning | Networking Http | [open](space-maps-joseljim-route-planning-1e5a7375.md) |
| litescript/ls-horizons | Networking Http | [open](space-maps-litescript-ls-horizons-882cd858.md) |
