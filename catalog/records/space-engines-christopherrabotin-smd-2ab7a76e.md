...
<!-- canonical: https://github.com/ChristopherRabotin/smd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChristopherRabotin/smd](https://github.com/ChristopherRabotin/smd) |
| Source record ids | github_search_space_engines-8961c7278afa3c |

## System Engineer Summary

Space Mission Design - A SPICE-enhanced continuous thrust interplanetary mission propagator and
vizualizer

## Operational Role

For a systems engineer, ChristopherRabotin/smd belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-18T01:07:09Z | gh search repos topic:astrodynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-8961c7278afa3c` from `github_search_space_engines` as `registry_expansion`
