...
<!-- canonical: https://github.com/hugsy/bochscpu-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hugsy/bochscpu-python](https://github.com/hugsy/bochscpu-python) |
| Source record ids | github_search_assembly-536ada46cb20da |
...
For a systems engineer, hugsy/bochscpu-python belongs in the Assembly inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-10T17:01:32Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-536ada46cb20da` from `github_search_assembly` as `registry_expansion`
