...
<!-- canonical: https://github.com/isce-framework/sweets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/isce-framework/sweets](https://github.com/isce-framework/sweets) |
| Source record ids | github_search_radars-1d3be02d2225e6 |
...
For a systems engineer, isce-framework/sweets belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.3.1 | 2026-04-15T19:26:15Z | [https://api.github.com/repos/isce-framework/sweets/releases/latest](https://api.github.com/repos/isce-framework/sweets/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/isce-framework/sweets/releases/latest` at `2026-09-01T08:26:29+00:00`.
...
- `github_search_radars-1d3be02d2225e6` from `github_search_radars` as `registry_expansion`
