...
| Source record ids | github_search_radars-2fbb27c300beb0 |
...
For a systems engineer, opengeos/geospatial belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:50:18Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-2fbb27c300beb0` from `github_search_radars` as `registry_expansion`
