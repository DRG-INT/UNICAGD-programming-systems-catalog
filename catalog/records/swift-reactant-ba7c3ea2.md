...
| Source record ids | awesome_list-d109c055b8413c |
...
For a systems engineer, Reactant belongs in the Swift inventory as part of ecosystem capability
...
- `awesome_list-d109c055b8413c` from `awesome_list` as `registry_expansion`
