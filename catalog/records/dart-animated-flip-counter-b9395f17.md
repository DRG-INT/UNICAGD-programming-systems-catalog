...
<!-- canonical: https://pub.dev/packages/animated_flip_counter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/animated_flip_counter](https://pub.dev/packages/animated_flip_counter) |
| Source record ids | pub_dev-1f3a651f718ea9 |

## System Engineer Summary

An implicit animation widget that flips from one number to another, with support for customize
styles, decimals and negative values.

## Operational Role

For a systems engineer, animated_flip_counter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4 | 2024-04-02T00:13:33.110163Z | [https://pub.dev/api/packages/animated_flip_counter](https://pub.dev/api/packages/animated_flip_counter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/animated_flip_counter` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-1f3a651f718ea9` from `pub_dev` as `registry_expansion`
