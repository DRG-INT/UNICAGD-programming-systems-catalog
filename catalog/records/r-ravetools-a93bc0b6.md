...
<!-- canonical: https://cran.r-project.org/web/packages/ravetools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ravetools/index.html](https://cran.r-project.org/web/packages/ravetools/index.html) |
| Source record ids | cran_packages_by_date-194063203966e2 |
...
For a systems engineer, ravetools belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-09-04 07:00:02 UTC | [https://cran.r-project.org/web/packages/ravetools/DESCRIPTION](https://cran.r-project.org/web/packages/ravetools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ravetools/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-194063203966e2` from `cran_packages_by_date` as `registry_expansion`
