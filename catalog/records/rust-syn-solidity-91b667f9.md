...
| Canonical URL | [https://crates.io/crates/syn-solidity](https://crates.io/crates/syn-solidity) |
| Source record ids | crates_io-6aa7a02cef7f60 |
...
For a systems engineer, syn-solidity belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-25T20:59:25.039439Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-6aa7a02cef7f60` from `crates_io` as `registry_expansion`
