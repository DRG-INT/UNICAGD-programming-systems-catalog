# tanagraspace/ccsds124

## Navigation

[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tanagraspace/ccsds124 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tanagraspace/ccsds124](https://github.com/tanagraspace/ccsds124) |
| Source record ids | github_search_satcom_satellites-ff5db3aa37b991 |

## System Engineer Summary

Multi-language implementations of CCSDS 124.0-B-1 in C, C++, Python, Go, Rust, and Java. The
lossless compression standard for fixed-length spacecraft housekeeping telemetry, based on ESA's
patented POCKET+ algorithm and built from low-level OR/XOR/AND operations to run on low-power
spacecraft processors under tight real-time constraints.

## Operational Role

For a systems engineer, tanagraspace/ccsds124 belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T08:34:01Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-ff5db3aa37b991` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AcubeSAT/ccsds-space-data-link-protocols | Language Specification | [open](satcom-satellites-acubesat-ccsds-space-data-link-protocols-3a657041.md) |
| CCSDS | Language Specification | [open](satcom-satellites-ccsds-6269d855.md) |
| dariol83/ccsds | Language Specification | [open](satcom-satellites-dariol83-ccsds-663735fc.md) |
| DVB-S2 | Language Specification | [open](satcom-satellites-dvb-s2-cd7b5095.md) |
| GeoTIFF/georaster | Language Specification | [open](satcom-satellites-geotiff-georaster-f7f81e47.md) |
| JiaoXianjun/BTLE | Language Specification | [open](satcom-satellites-jiaoxianjun-btle-a4649a5e.md) |
| JuliaSpace/SatelliteToolbox.jl | Language Specification | [open](satcom-satellites-juliaspace-satellitetoolbox-jl-2f61cb76.md) |
| lasp/space_packet_parser | Language Specification | [open](satcom-satellites-lasp-space-packet-parser-c1755c7c.md) |
