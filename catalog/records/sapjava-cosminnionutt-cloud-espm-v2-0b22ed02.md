# cosminnionutt/cloud-espm-v2

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cosminnionutt/cloud-espm-v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cosminnionutt/cloud-espm-v2](https://github.com/cosminnionutt/cloud-espm-v2) |
| Source record ids | github_search_sapjava-1282581f42ece1 |

## System Engineer Summary

About This sample is a reference application project, showcasing an end-to-end development scenario
for a Java-based app on SAP BTP. The app has a SAPUI5 web frontend, uses OData to connect to a Java-
based cloud backend which in turn connects via JPA to an SAP HANA DB in the cloud.

## Operational Role

For a systems engineer, cosminnionutt/cloud-espm-v2 belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-04T08:51:15Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
| Evidence | Open Data Commons Open Database License v1.0; https://api.github.com/licenses/odbl-1.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_sapjava-1282581f42ece1` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AdrianoBispo/estude-sap-cap-com-java | Filesystem Os | [open](sapjava-adrianobispo-estude-sap-cap-com-java-cd237f6f.md) |
| cap-js-community/sap-afc-sdk | Filesystem Os | [open](sapjava-cap-js-community-sap-afc-sdk-ceed7a56.md) |
| cmunozhdz/HanaEjemplos | Filesystem Os | [open](sapjava-cmunozhdz-hanaejemplos-adf0cff1.md) |
| Hosseini1373/MultitenantApp_CF_SAP_BTP_JAVA | Filesystem Os | [open](sapjava-hosseini1373-multitenantapp-cf-sap-btp-java-60965f5f.md) |
| Marcosfarhat/centro-medico-cap-java | Filesystem Os | [open](sapjava-marcosfarhat-centro-medico-cap-java-1246b3a5.md) |
| thorstenfreitag/SAP-IoT_Train-HCP_Java_Backend | Filesystem Os | [open](sapjava-thorstenfreitag-sap-iot-train-hcp-java-backend-3ba09925.md) |
