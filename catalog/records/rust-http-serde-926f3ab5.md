...
| Canonical URL | [https://crates.io/crates/http-serde](https://crates.io/crates/http-serde) |
| Source record ids | crates_io-5f11777abcfdb3 |
...
For a systems engineer, http-serde belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2024-05-27T23:29:18.070009Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-5f11777abcfdb3` from `crates_io` as `registry_expansion`
