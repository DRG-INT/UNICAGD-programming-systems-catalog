...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mattwilson1024/google-photos-exif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mattwilson1024/google-photos-exif](https://github.com/mattwilson1024/google-photos-exif) |
| Source record ids | github_search_photography-b82600edbb5492 |

## System Engineer Summary

A tool to populate missing `DateTimeOriginal` EXIF metadata in Google Photos takeout, using Google's
JSON metadata.

## Operational Role

For a systems engineer, mattwilson1024/google-photos-exif belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-06T00:49:51Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-b82600edbb5492` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Jermic/awesome-aiart-pics-prompts | Serialization | [open](photography-jermic-awesome-aiart-pics-prompts-7d7d38d2.md) |
| jmathai/immich-exif | Serialization | [open](photography-jmathai-immich-exif-daea21e5.md) |
| saindriches/dovi_meta | Serialization | [open](photography-saindriches-dovi-meta-ff6ad1f2.md) |
| Visgean/photos2geojson | Serialization | [open](photography-visgean-photos2geojson-fe736256.md) |
