...
<!-- canonical: https://crates.io/crates/num_cpus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num_cpus](https://crates.io/crates/num_cpus) |
| Source record ids | crates_io-ca773b243bfdfe |
...
For a systems engineer, num_cpus belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.17.0 | 2025-05-30T18:59:42.537878Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-ca773b243bfdfe` from `crates_io` as `registry_expansion`
