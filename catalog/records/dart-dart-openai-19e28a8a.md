...
<!-- canonical: https://pub.dev/packages/dart_openai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dart_openai](https://pub.dev/packages/dart_openai) |
| Source record ids | pub_dev-5e9e5587c45d1f |

## System Engineer Summary

Unofficial Dart & Flutter SDK for the OpenAI API. Typed clients for Responses, Chat, Realtime,
Videos, Batch, Fine-tuning, Vector Stores and more.

## Operational Role

For a systems engineer, dart_openai belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-08-25T02:32:06.758945Z | [https://pub.dev/api/packages/dart_openai](https://pub.dev/api/packages/dart_openai) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dart_openai` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-5e9e5587c45d1f` from `pub_dev` as `registry_expansion`
