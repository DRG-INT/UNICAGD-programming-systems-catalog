...
<!-- canonical: https://cran.r-project.org/web/packages/vartest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vartest/index.html](https://cran.r-project.org/web/packages/vartest/index.html) |
| Source record ids | cran_packages_by_date-9d1e6a868eebd1 |
...
For a systems engineer, vartest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7 | 2026-08-25 10:50:02 UTC | [https://cran.r-project.org/web/packages/vartest/DESCRIPTION](https://cran.r-project.org/web/packages/vartest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vartest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9d1e6a868eebd1` from `cran_packages_by_date` as `registry_expansion`
