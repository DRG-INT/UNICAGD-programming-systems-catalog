...
<!-- canonical: https://crates.io/crates/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/http](https://crates.io/crates/http) |
| Source record ids | crates_io-986ff3307f6988 |
...
For a systems engineer, http belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-07-29T14:57:21.755258Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-986ff3307f6988` from `crates_io` as `registry_expansion`
