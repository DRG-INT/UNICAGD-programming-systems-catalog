...
<!-- canonical: https://pub.dev/packages/carousel_slider_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/carousel_slider_plus](https://pub.dev/packages/carousel_slider_plus) |
| Source record ids | pub_dev-c9b882c5c69aeb |
...
For a systems engineer, carousel_slider_plus belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1.2 | 2026-05-02T04:29:12.916266Z | [https://pub.dev/api/packages/carousel_slider_plus](https://pub.dev/api/packages/carousel_slider_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/carousel_slider_plus` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-c9b882c5c69aeb` from `pub_dev` as `registry_expansion`
