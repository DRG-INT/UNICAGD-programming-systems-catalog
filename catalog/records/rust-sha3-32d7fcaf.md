...
<!-- canonical: https://crates.io/crates/sha3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sha3](https://crates.io/crates/sha3) |
| Source record ids | crates_io-286fe2e4180241 |
...
For a systems engineer, sha3 belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-05-15T18:32:15.852781Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Microsoft.Extensions.Http.Polly/10.0.11/license |
...
- `crates_io-286fe2e4180241` from `crates_io` as `registry_expansion`
