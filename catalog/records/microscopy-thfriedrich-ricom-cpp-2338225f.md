...
<!-- canonical: https://github.com/ThFriedrich/riCOM_cpp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ThFriedrich/riCOM_cpp](https://github.com/ThFriedrich/riCOM_cpp) |
| Source record ids | github_search_microscopy-50649abab1afa2 |

## System Engineer Summary

riCOM (real time centre of mass) application for 4D STEM

## Operational Role

For a systems engineer, ThFriedrich/riCOM_cpp belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-19T16:32:03Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-50649abab1afa2` from `github_search_microscopy` as `registry_expansion`
