...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CalculatedABC](https://github.com/JuliaRegistries/General/tree/master/C/CalculatedABC) |
| Source record ids | julia_general-8bffc1d8654902 |

## System Engineer Summary

Julia package registered in General at C/CalculatedABC.

## Operational Role

For a systems engineer, CalculatedABC belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CalculatedABC", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8bffc1d8654902` from `julia_general` as `registry_expansion`
