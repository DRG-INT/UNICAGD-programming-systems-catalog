...
<!-- canonical: https://github.com/spiculedata/saiku -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spiculedata/saiku](https://github.com/spiculedata/saiku) |
| Source record ids | github_search_databases-40294c65502184 |

## System Engineer Summary

Open-source semantic layer: one cube for Excel (MDX/XMLA), dashboards, and AI agents (MCP). Mondrian
+ Apache Calcite.

## Operational Role

For a systems engineer, spiculedata/saiku belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T14:49:59Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-40294c65502184` from `github_search_databases` as `registry_expansion`
