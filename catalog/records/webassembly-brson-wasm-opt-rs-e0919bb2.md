...
<!-- canonical: https://github.com/brson/wasm-opt-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brson/wasm-opt-rs](https://github.com/brson/wasm-opt-rs) |
| Source record ids | github_search_webassembly-8d9ce7cf46a562 |
...
For a systems engineer, brson/wasm-opt-rs belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-31T11:55:41Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-8d9ce7cf46a562` from `github_search_webassembly` as `registry_expansion`
