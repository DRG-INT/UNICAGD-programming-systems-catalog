...
| Source record ids | github_search_assets-c888dc8886f205 |
...
For a systems engineer, IdreesInc/Monocraft belongs in the Assets inventory as part of ecosystem
...
- `github_search_assets-c888dc8886f205` from `github_search_assets` as `registry_expansion`
