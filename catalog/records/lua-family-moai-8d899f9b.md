...
| Source record ids | corpus-59c1b3e544b356 |

## System Engineer Summary

MOAI is tracked as a game engine game dev record in the Lua family branch. The source did not
...
For a systems engineer, MOAI belongs in the Lua family inventory as part of ecosystem capability
...
- `corpus-59c1b3e544b356` from `master_json` as `game_engine_game_dev`
