...
| Canonical URL | [https://github.com/SAP/cf-cli-java-plugin](https://github.com/SAP/cf-cli-java-plugin) |
| Source record ids | github_search_sapjava-48ae053a9fe37e |
...
For a systems engineer, SAP/cf-cli-java-plugin belongs in the SAPJava inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | snapshot | 2026-05-29T08:24:19Z | [https://api.github.com/repos/SAP/cf-cli-java-plugin/releases/latest](https://api.github.com/repos/SAP/cf-cli-java-plugin/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SAP/cf-cli-java-plugin/releases/latest` at `2026-09-01T10:25:36+00:00`.
...
- `github_search_sapjava-48ae053a9fe37e` from `github_search_sapjava` as `registry_expansion`
