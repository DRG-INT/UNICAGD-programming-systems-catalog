...
<!-- canonical: https://luarocks.org/modules/jirutka/brieflz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jirutka/brieflz](https://luarocks.org/modules/jirutka/brieflz) |
| Source record ids | luarocks_root_manifest-bd5399ecf779c9 |
...
For a systems engineer, brieflz belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-bd5399ecf779c9` from `luarocks_root_manifest` as `registry_expansion`
