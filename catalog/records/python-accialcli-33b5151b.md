...
<!-- canonical: https://pypi.org/project/accialcli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accialcli/](https://pypi.org/project/accialcli/) |
| Source record ids | pypi_simple-d0d21b769259e0 |

## System Engineer Summary

CLI that send to our API 1 Borrower, 1 Application, 1 Loan and 1 Payment

## Operational Role

For a systems engineer, accialcli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2021-08-05T05:14:18.625234Z | [https://pypi.org/pypi/accialcli/json](https://pypi.org/pypi/accialcli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accialcli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-d0d21b769259e0` from `pypi_simple` as `registry_expansion`
