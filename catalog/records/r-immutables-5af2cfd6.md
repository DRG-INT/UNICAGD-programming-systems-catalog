...
<!-- canonical: https://cran.r-project.org/web/packages/Immutables/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Immutables/index.html](https://cran.r-project.org/web/packages/Immutables/index.html) |
| Source record ids | cran_packages_by_date-8974058941cd32 |
...
For a systems engineer, Immutables belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 17:50:08 UTC | [https://cran.r-project.org/web/packages/Immutables/DESCRIPTION](https://cran.r-project.org/web/packages/Immutables/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Immutables/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8974058941cd32` from `cran_packages_by_date` as `registry_expansion`
