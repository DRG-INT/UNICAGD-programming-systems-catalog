...
<!-- canonical: https://cran.r-project.org/web/packages/countSTAR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/countSTAR/index.html](https://cran.r-project.org/web/packages/countSTAR/index.html) |
| Source record ids | cran_packages_by_date-24fdc8495ff607 |
...
For a systems engineer, countSTAR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-21 05:50:02 UTC | [https://cran.r-project.org/web/packages/countSTAR/DESCRIPTION](https://cran.r-project.org/web/packages/countSTAR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/countSTAR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-24fdc8495ff607` from `cran_packages_by_date` as `registry_expansion`
