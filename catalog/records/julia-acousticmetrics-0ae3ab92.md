...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AcousticMetrics](https://github.com/JuliaRegistries/General/tree/master/A/AcousticMetrics) |
| Source record ids | julia_general-a1deff1900031c |

## System Engineer Summary

Julia package registered in General at A/AcousticMetrics.

## Operational Role

For a systems engineer, AcousticMetrics belongs in the Julia inventory as part of diagnostics,
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractCosmologicalEmulators | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractcosmologicalemulators-4ec57a2f.md) |
| AbstractLogic | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abstractlogic-032d90e3.md) |
| AcousticAnalogies | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-acousticanalogies-b7c2f3fb.md) |
| ApproxLogFunction | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-approxlogfunction-c39275b9.md) |
| Autologistic | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-autologistic-a0f00887.md) |
| AverageLoglikelihoodRatio | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-averageloglikelihoodratio-9ce00d52.md) |
| BayesianNonparametrics | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bayesiannonparametrics-f3d439d6.md) |
| BayesianNonparametricStatistics | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bayesiannonparametricstatistics-0e973994.md) |
