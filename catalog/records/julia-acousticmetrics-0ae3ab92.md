...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AcousticMetrics -->
<!-- crawl-delay: 10 -->
...
| Evidence | {"key": "", "name": "", "url": ""}; Other; http://choosealicense.com/licenses/bsd-2-clause/ |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AcousticMetrics", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-a1deff1900031c` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AbstractCosmologicalEmulators | Logging Observability | [open](julia-abstractcosmologicalemulators-4ec57a2f.md) |
| AbstractLogic | Logging Observability | [open](julia-abstractlogic-032d90e3.md) |
| AcousticAnalogies | Logging Observability | [open](julia-acousticanalogies-b7c2f3fb.md) |
| ApproxLogFunction | Logging Observability | [open](julia-approxlogfunction-c39275b9.md) |
| Autologistic | Logging Observability | [open](julia-autologistic-a0f00887.md) |
| AverageLoglikelihoodRatio | Logging Observability | [open](julia-averageloglikelihoodratio-9ce00d52.md) |
| BayesianNonparametrics | Logging Observability | [open](julia-bayesiannonparametrics-f3d439d6.md) |
| BayesianNonparametricStatistics | Logging Observability | [open](julia-bayesiannonparametricstatistics-0e973994.md) |
