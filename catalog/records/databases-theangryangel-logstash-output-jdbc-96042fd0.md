...
<!-- canonical: https://github.com/theangryangel/logstash-output-jdbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/theangryangel/logstash-output-jdbc](https://github.com/theangryangel/logstash-output-jdbc) |
| Source record ids | github_search_databases-46b1d0f175a651 |
...
For a systems engineer, theangryangel/logstash-output-jdbc belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-19T08:36:05Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-46b1d0f175a651` from `github_search_databases` as `registry_expansion`
