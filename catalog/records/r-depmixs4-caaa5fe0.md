...
<!-- canonical: https://cran.r-project.org/web/packages/depmixS4/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/depmixS4/index.html](https://cran.r-project.org/web/packages/depmixS4/index.html) |
| Source record ids | cran_packages_by_date-50c55ec95bf27b |
...
For a systems engineer, depmixS4 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5-4 | 2026-08-24 13:40:19 UTC | [https://cran.r-project.org/web/packages/depmixS4/DESCRIPTION](https://cran.r-project.org/web/packages/depmixS4/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/depmixS4/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-50c55ec95bf27b` from `cran_packages_by_date` as `registry_expansion`
