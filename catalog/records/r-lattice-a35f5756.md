...
<!-- canonical: https://cran.r-project.org/web/packages/lattice/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lattice/index.html](https://cran.r-project.org/web/packages/lattice/index.html) |
| Source record ids | cran_packages_by_date-af26a650190350 |

## System Engineer Summary

lattice is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, lattice belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23-1 | 2026-08-12 14:43:29 UTC | [https://cran.r-project.org/web/packages/lattice/DESCRIPTION](https://cran.r-project.org/web/packages/lattice/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lattice/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-af26a650190350` from `cran_packages_by_date` as `registry_expansion`
