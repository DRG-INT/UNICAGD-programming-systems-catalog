...
<!-- canonical: https://cran.r-project.org/web/packages/nlmixr2est/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nlmixr2est/index.html](https://cran.r-project.org/web/packages/nlmixr2est/index.html) |
| Source record ids | cran_packages_by_date-c2a3f4760d2d12 |
...
For a systems engineer, nlmixr2est belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.2 | 2026-08-04 20:50:09 UTC | [https://cran.r-project.org/web/packages/nlmixr2est/DESCRIPTION](https://cran.r-project.org/web/packages/nlmixr2est/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nlmixr2est/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c2a3f4760d2d12` from `cran_packages_by_date` as `registry_expansion`
