...
<!-- canonical: https://github.com/HiroIshida/plainmp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HiroIshida/plainmp](https://github.com/HiroIshida/plainmp) |
| Source record ids | github_search_physics_engines-32a8296a097d64 |

## System Engineer Summary

Very fast motion planning for articulated robot, through a bit of premature-optimization (C++ core
with Python bindings) *less than 1ms for moderate problems

## Operational Role

For a systems engineer, HiroIshida/plainmp belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-07T18:51:43Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-32a8296a097d64` from `github_search_physics_engines` as `registry_expansion`
