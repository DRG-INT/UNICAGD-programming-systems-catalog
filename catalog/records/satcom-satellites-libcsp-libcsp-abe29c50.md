...
<!-- canonical: https://github.com/libcsp/libcsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libcsp/libcsp](https://github.com/libcsp/libcsp) |
| Source record ids | github_search_satcom_satellites-890457c1136566 |
...
For a systems engineer, libcsp/libcsp belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1 | 2025-10-11T09:35:53Z | [https://api.github.com/repos/libcsp/libcsp/releases/latest](https://api.github.com/repos/libcsp/libcsp/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/libcsp/libcsp/releases/latest` at `2026-09-01T08:26:35+00:00`.
...
- `github_search_satcom_satellites-890457c1136566` from `github_search_satcom_satellites` as `registry_expansion`
