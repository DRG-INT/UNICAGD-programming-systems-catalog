...
| Canonical URL | [https://crates.io/crates/napi-sys](https://crates.io/crates/napi-sys) |
| Source record ids | crates_io-170f8cee13aa8d |
...
For a systems engineer, napi-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2026-07-21T05:26:05.314744Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-170f8cee13aa8d` from `crates_io` as `registry_expansion`
