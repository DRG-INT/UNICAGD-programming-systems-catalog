...
<!-- canonical: https://cran.r-project.org/web/packages/ipred/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ipred/index.html](https://cran.r-project.org/web/packages/ipred/index.html) |
| Source record ids | cran_packages_by_date-f67e7c234f4003 |

## System Engineer Summary

ipred is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, ipred belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9-16 | 2026-08-22 15:50:18 UTC | [https://cran.r-project.org/web/packages/ipred/DESCRIPTION](https://cran.r-project.org/web/packages/ipred/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ipred/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f67e7c234f4003` from `cran_packages_by_date` as `registry_expansion`
