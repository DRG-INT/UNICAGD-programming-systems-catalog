...
<!-- canonical: https://pub.dev/packages/maplibre_gl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/maplibre_gl](https://pub.dev/packages/maplibre_gl) |
| Source record ids | pub_dev-26e77f28804cd0 |

## System Engineer Summary

Native MapLibre maps for Flutter: Mapbox Vector Tile (MVT) and PMTiles sources, custom styles,
GeoJSON layers and offline regions on Android, iOS and Web.

## Operational Role

For a systems engineer, maplibre_gl belongs in the Dart inventory as part of wire formats,
...
- `pub_dev-26e77f28804cd0` from `pub_dev` as `registry_expansion`
