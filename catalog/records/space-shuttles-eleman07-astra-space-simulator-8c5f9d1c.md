# Eleman07/Astra-Space-Simulator

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/Eleman07/Astra-Space-Simulator](https://github.com/Eleman07/Astra-Space-Simulator) |
| Source record ids | github_search_space_shuttles-b5b03aa9eb860d |

## System Engineer Summary

**Astra Space Simulator** is a high-fidelity Unity-based space flight simulator featuring realistic
Newtonian physics, orbital mechanics, advanced GNC systems, modular spacecraft, and real-time
telemetry. Execute complete missions from launch to landing in a planetary-scale environment
inspired by real aerospace engineering.

## Operational Role

For a systems engineer, Eleman07/Astra-Space-Simulator belongs in the Space Shuttles inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2026-06-13T12:05:19Z | [https://api.github.com/repos/Eleman07/Astra-Space-Simulator/releases/latest](https://api.github.com/repos/Eleman07/Astra-Space-Simulator/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Eleman07/Astra-Space-Simulator/releases/latest` at `2026-09-01T07:24:21+00:00`.
...
- `github_search_space_shuttles-b5b03aa9eb860d` from `github_search_space_shuttles` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| E-S-Waga15/Spacecraft-Motion-Simulation | Ide Editor Integration | [open](space-shuttles-e-s-waga15-spacecraft-motion-simulation-fadcd10c.md) |
| PESchoenberg/DGIIIAI | Ide Editor Integration | [open](space-shuttles-peschoenberg-dgiiiai-186f5f03.md) |
| PESchoenberg/SQLC | Ide Editor Integration | [open](space-shuttles-peschoenberg-sqlc-5b02e07d.md) |
