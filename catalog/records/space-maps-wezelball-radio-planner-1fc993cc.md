...
<!-- canonical: https://github.com/wezelball/radio_planner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wezelball/radio_planner](https://github.com/wezelball/radio_planner) |
| Source record ids | github_search_space_maps-c074878c691e4a |

## System Engineer Summary

Radio astronomy observation planner with AltAz and RA/Dec sky maps

## Operational Role

For a systems engineer, wezelball/radio_planner belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-26T02:37:22Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-c074878c691e4a` from `github_search_space_maps` as `registry_expansion`
