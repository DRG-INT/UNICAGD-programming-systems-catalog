...
<!-- canonical: https://hackage.haskell.org/package/fsnotify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fsnotify](https://hackage.haskell.org/package/fsnotify) |
| Source record ids | hackage_top_downloads-1b2ee3b7ccfc6b |
...
For a systems engineer, fsnotify belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.4.0 | 2025-08-25T23:37:12Z | [https://hackage.haskell.org/package/fsnotify](https://hackage.haskell.org/package/fsnotify) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fsnotify` at `2026-09-01T14:24:16+00:00`.
...
- `hackage_top_downloads-1b2ee3b7ccfc6b` from `hackage_top_downloads` as `registry_expansion`
