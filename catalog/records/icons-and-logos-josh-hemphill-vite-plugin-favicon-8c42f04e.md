...
<!-- canonical: https://github.com/josh-hemphill/vite-plugin-favicon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/josh-hemphill/vite-plugin-favicon](https://github.com/josh-hemphill/vite-plugin-favicon) |
| Source record ids | github_search_icons_and_logos-d642b07d23de2e |

## System Engineer Summary

Leverages on favicons to automatically generate your favicons for you. And if you want to also
consolidate your PWA manifest, will generate that as well with linked icons.

## Operational Role

For a systems engineer, josh-hemphill/vite-plugin-favicon belongs in the Icons and Logos inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-27T04:25:58Z | gh search repos topic:favicons stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-d642b07d23de2e` from `github_search_icons_and_logos` as `registry_expansion`
