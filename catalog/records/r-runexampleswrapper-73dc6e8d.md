...
<!-- canonical: https://cran.r-project.org/web/packages/runExamplesWrapper/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/runExamplesWrapper/index.html](https://cran.r-project.org/web/packages/runExamplesWrapper/index.html) |
| Source record ids | cran_packages_by_date-77f53fad6fa3b5 |

## System Engineer Summary

Wrapper for 'run_example()'

## Operational Role

For a systems engineer, runExamplesWrapper belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-08-28 07:00:27 UTC | [https://cran.r-project.org/web/packages/runExamplesWrapper/DESCRIPTION](https://cran.r-project.org/web/packages/runExamplesWrapper/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/runExamplesWrapper/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-77f53fad6fa3b5` from `cran_packages_by_date` as `registry_expansion`
