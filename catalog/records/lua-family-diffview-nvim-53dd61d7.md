...
<!-- canonical: https://luarocks.org/modules/neorocks/diffview.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/diffview.nvim](https://luarocks.org/modules/neorocks/diffview.nvim) |
| Source record ids | luarocks_root_manifest-a5a2ffc4a38b19 |
...
For a systems engineer, diffview.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a5a2ffc4a38b19` from `luarocks_root_manifest` as `registry_expansion`
