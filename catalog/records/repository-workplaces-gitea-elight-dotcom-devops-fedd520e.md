...
<!-- canonical: https://gitea.com/Elight-dotcom/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Elight-dotcom/devops](https://gitea.com/Elight-dotcom/devops) |
| Source record ids | gitea_repositories_api-a00dbee876b49a |
...
For a systems engineer, Gitea: Elight-dotcom/devops belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-29T05:46:52Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-a00dbee876b49a` from `gitea_repositories_api` as `registry_expansion`
