...
| Source record ids | github_search_swift-76e800402d1ee5 |
...
For a systems engineer, maxgoedjen/secretive belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T08:42:13Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-76e800402d1ee5` from `github_search_swift` as `registry_expansion`
