...
<!-- canonical: https://gitlab.com/r2devops/hub -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/r2devops/hub](https://gitlab.com/r2devops/hub) |
| Source record ids | gitlab_projects_api-ac1c9a7d38137c |

## System Engineer Summary

🚀 The collaborative collection of open source CI/CD templates to help everyone quickly build
powerful pipelines. 👉

## Operational Role

For a systems engineer, r2devops/hub belongs in the Repository Workplaces inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-10T11:14:45.423Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-ac1c9a7d38137c` from `gitlab_projects_api` as `registry_expansion`
