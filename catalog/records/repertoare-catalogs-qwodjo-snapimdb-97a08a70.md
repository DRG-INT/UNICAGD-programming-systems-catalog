...
<!-- canonical: https://github.com/Qwodjo/SnapIMDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Qwodjo/SnapIMDB](https://github.com/Qwodjo/SnapIMDB) |
| Source record ids | github_search_repertoare_catalogs-bbe9639a61c8b5 |

## System Engineer Summary

SnapIMDB — AI-powered product cataloging for retail teams. Upload or photograph a product → vision
AI extracts all 13 IMDB attributes → confidence-scored preview → inline edit → export
predictions.xlsx. Multi-image fusion, two-pass critic extraction, normalization layer, duplicate
detection, and live eval dashboard.

## Operational Role

For a systems engineer, Qwodjo/SnapIMDB belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T23:12:15Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-bbe9639a61c8b5` from `github_search_repertoare_catalogs` as `registry_expansion`
