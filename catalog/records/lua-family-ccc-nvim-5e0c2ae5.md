...
<!-- canonical: https://luarocks.org/modules/neorocks/ccc.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/ccc.nvim](https://luarocks.org/modules/neorocks/ccc.nvim) |
| Source record ids | luarocks_root_manifest-21826bd27d6e2d |
...
For a systems engineer, ccc.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-21826bd27d6e2d` from `luarocks_root_manifest` as `registry_expansion`
