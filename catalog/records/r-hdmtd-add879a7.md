...
<!-- canonical: https://cran.r-project.org/web/packages/hdMTD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hdMTD/index.html](https://cran.r-project.org/web/packages/hdMTD/index.html) |
| Source record ids | cran_packages_by_date-e2a881593745ea |
...
For a systems engineer, hdMTD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-09-09 15:40:02 UTC | [https://cran.r-project.org/web/packages/hdMTD/DESCRIPTION](https://cran.r-project.org/web/packages/hdMTD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hdMTD/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-e2a881593745ea` from `cran_packages_by_date` as `registry_expansion`
