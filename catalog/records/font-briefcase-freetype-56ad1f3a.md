...
<!-- canonical: https://gitlab.freedesktop.org/freetype/freetype -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.freedesktop.org/freetype/freetype](https://gitlab.freedesktop.org/freetype/freetype) |
| Source record ids | curated_language_routes-e37b00df25232d |

## System Engineer Summary

Font rendering library used to load, rasterize, hint, and operate font assets across platforms.

## Operational Role

For a systems engineer, FreeType belongs in the Font Briefcase inventory as part of ecosystem
...
- `curated_language_routes-e37b00df25232d` from `curated_language_routes` as `registry_expansion`
