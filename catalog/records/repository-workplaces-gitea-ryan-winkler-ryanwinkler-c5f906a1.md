# Gitea: ryan-winkler/ryanwinkler
...
<!-- canonical: https://gitea.com/ryan-winkler/ryanwinkler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/ryan-winkler/ryanwinkler](https://gitea.com/ryan-winkler/ryanwinkler) |
| Source record ids | gitea_repositories_api-33abefde34ff2a |

## System Engineer Summary

Public profile README covering how I approach product, AI systems, and customer signal in
production.

## Operational Role

For a systems engineer, Gitea: ryan-winkler/ryanwinkler belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T10:30:44Z | [https://gitea.com/api/v1/repos/search?q=documentation&limit=50](https://gitea.com/api/v1/repos/search?q=documentation&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-33abefde34ff2a` from `gitea_repositories_api` as `registry_expansion`
