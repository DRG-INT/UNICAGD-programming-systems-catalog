...
| Canonical URL | [https://crates.io/crates/sea-query](https://crates.io/crates/sea-query) |
| Source record ids | crates_io-e5deb28a48b645 |
...
For a systems engineer, sea-query belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-12T22:44:57.689934Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-e5deb28a48b645` from `crates_io` as `registry_expansion`
