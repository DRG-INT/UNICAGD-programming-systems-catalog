...
<!-- canonical: https://cran.r-project.org/web/packages/PTLENKies/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PTLENKies/index.html](https://cran.r-project.org/web/packages/PTLENKies/index.html) |
| Source record ids | cran_packages_by_date-53be029b172ba6 |

## System Engineer Summary

Computation of PTLENKies Distribution Properties

## Operational Role

For a systems engineer, PTLENKies belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 11:50:47 UTC | [https://cran.r-project.org/web/packages/PTLENKies/DESCRIPTION](https://cran.r-project.org/web/packages/PTLENKies/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PTLENKies/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-53be029b172ba6` from `cran_packages_by_date` as `registry_expansion`
