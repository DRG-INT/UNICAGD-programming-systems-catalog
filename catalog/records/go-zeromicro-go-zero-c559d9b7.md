...
<!-- canonical: https://github.com/zeromicro/go-zero -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zeromicro/go-zero](https://github.com/zeromicro/go-zero) |
| Source record ids | github_search_go-81d0b5a621a265 |
...
For a systems engineer, zeromicro/go-zero belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:53:08Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-81d0b5a621a265` from `github_search_go` as `registry_expansion`
