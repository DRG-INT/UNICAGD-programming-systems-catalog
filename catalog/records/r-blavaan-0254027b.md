...
<!-- canonical: https://cran.r-project.org/web/packages/blavaan/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/blavaan/index.html](https://cran.r-project.org/web/packages/blavaan/index.html) |
| Source record ids | cran_packages_by_date-33e75e16a0d072 |
...
For a systems engineer, blavaan belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6-1 | 2026-08-22 23:20:30 UTC | [https://cran.r-project.org/web/packages/blavaan/DESCRIPTION](https://cran.r-project.org/web/packages/blavaan/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/blavaan/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-33e75e16a0d072` from `cran_packages_by_date` as `registry_expansion`
