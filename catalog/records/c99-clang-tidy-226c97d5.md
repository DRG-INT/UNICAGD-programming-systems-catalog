...
| Source record ids | master-80f93640f943 |

## System Engineer Summary

Clang-based linter and static analysis framework

## Operational Role

For a systems engineer, clang-tidy belongs in the C99 inventory as part of defect discovery,
...
- `master-80f93640f943` from `master_json` as `static_analyzer`
