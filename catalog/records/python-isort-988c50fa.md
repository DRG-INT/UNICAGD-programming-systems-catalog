...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Formatter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/formatter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-bd0e2cc70bf5 |

## System Engineer Summary

isort is tracked as a formatter record in the Python branch. The source did not provide a long
...
For a systems engineer, isort belongs in the Python inventory as part of low-noise code review,
...
- `master-bd0e2cc70bf5` from `master_json` as `formatter`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| black | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-black-c618db75.md) |
