...
<!-- canonical: https://hackage.haskell.org/package/shikumi-cache-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-cache-redis](https://hackage.haskell.org/package/shikumi-cache-redis) |
| Source record ids | hackage_recent-a2916f3e2e51af |
...
For a systems engineer, shikumi-cache-redis belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3.0 | 2026-09-08T19:34:44Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-a2916f3e2e51af` from `hackage_recent` as `registry_expansion`
