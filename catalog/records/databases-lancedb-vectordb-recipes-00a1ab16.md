...
<!-- canonical: https://github.com/lancedb/vectordb-recipes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lancedb/vectordb-recipes](https://github.com/lancedb/vectordb-recipes) |
| Source record ids | github_search_databases-cbfe877b195fe6 |
...
For a systems engineer, lancedb/vectordb-recipes belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T11:29:16Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cbfe877b195fe6` from `github_search_databases` as `registry_expansion`
