...
| Canonical URL | [https://github.com/isce-framework/isce2](https://github.com/isce-framework/isce2) |
| Source record ids | curated_language_routes-04f06fd1fd19c8 |

## System Engineer Summary

InSAR Scientific Computing Environment for synthetic-aperture radar processing and geodesy
workflows.

## Operational Role

For a systems engineer, ISCE2 belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.6.5 | 2026-06-30T19:42:59Z | [https://api.github.com/repos/isce-framework/isce2/releases/latest](https://api.github.com/repos/isce-framework/isce2/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/isce-framework/isce2/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-04f06fd1fd19c8` from `curated_language_routes` as `registry_expansion`
...
| wradlib | Math Numeric Scientific | [open](radars-wradlib-de7d653b.md) |
