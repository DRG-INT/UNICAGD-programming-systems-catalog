...
<!-- canonical: https://crates.io/crates/peeking_take_while -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/peeking_take_while](https://crates.io/crates/peeking_take_while) |
| Source record ids | crates_io-99761376e02ea6 |

## System Engineer Summary

Like `Iterator::take_while`, but calls the predicate on a peeked value. This allows you to use
`Iterator::by_ref` and `Iterator::take_while` together, and still get the first value for which the
`take_while` predicate returned false after dropping the `by_ref`.

## Operational Role

For a systems engineer, peeking_take_while belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2021-09-03T17:58:50.443671Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-99761376e02ea6` from `crates_io` as `registry_expansion`
