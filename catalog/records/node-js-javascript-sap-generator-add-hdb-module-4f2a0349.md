...
<!-- canonical: https://www.npmjs.com/package/@sap/generator-add-hdb-module -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@sap/generator-add-hdb-module](https://www.npmjs.com/package/@sap/generator-add-hdb-module) |
| Source record ids | npm_registry-f759a2dcc23500 |

## System Engineer Summary

A database module contains design-time database artifacts. On deployment, a database module is
assigned an HDI container to which the corresponding run-time database objects are deployed.

## Operational Role

For a systems engineer, @sap/generator-add-hdb-module belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.0 | 2025-11-05T20:43:19.110Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-f759a2dcc23500` from `npm_registry` as `registry_expansion`
