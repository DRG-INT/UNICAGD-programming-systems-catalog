...
| Source record ids | github_search_assets-c7893d6c99b6ca |
...
For a systems engineer, rickytan/RTImageAssets belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-22T10:09:01Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-c7893d6c99b6ca` from `github_search_assets` as `registry_expansion`
