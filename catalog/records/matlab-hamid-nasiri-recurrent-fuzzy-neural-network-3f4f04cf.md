...
<!-- canonical: https://github.com/Hamid-Nasiri/Recurrent-Fuzzy-Neural-Network -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Hamid-Nasiri/Recurrent-Fuzzy-Neural-Network](https://github.com/Hamid-Nasiri/Recurrent-Fuzzy-Neural-Network) |
| Source record ids | github_search_matlab-5d3446f8741608 |
...
For a systems engineer, Hamid-Nasiri/Recurrent-Fuzzy-Neural-Network belongs in the Matlab inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-09T15:43:24Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-5d3446f8741608` from `github_search_matlab` as `registry_expansion`
