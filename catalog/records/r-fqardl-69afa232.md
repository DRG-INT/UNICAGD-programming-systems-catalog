...
<!-- canonical: https://cran.r-project.org/web/packages/fqardl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fqardl/index.html](https://cran.r-project.org/web/packages/fqardl/index.html) |
| Source record ids | cran_packages_by_date-8b6ddf1683c679 |
...
For a systems engineer, fqardl belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-23 03:40:02 UTC | [https://cran.r-project.org/web/packages/fqardl/DESCRIPTION](https://cran.r-project.org/web/packages/fqardl/DESCRIPTION) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fqardl/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8b6ddf1683c679` from `cran_packages_by_date` as `registry_expansion`
