...
<!-- canonical: https://packagist.org/packages/php-http/promise -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/promise](https://packagist.org/packages/php-http/promise) |
| Source record ids | packagist_search-ee2a470bf19ba3 |
...
For a systems engineer, php-http/promise belongs in the PHP inventory as part of concurrency
...
- `packagist_search-ee2a470bf19ba3` from `packagist_search` as `registry_expansion`
...
| amphp/postgres | Async Runtime | [open](php-amphp-postgres-91a1ac9b.md) |
