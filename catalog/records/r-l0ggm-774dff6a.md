...
<!-- canonical: https://cran.r-project.org/web/packages/L0ggm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/L0ggm/index.html](https://cran.r-project.org/web/packages/L0ggm/index.html) |
| Source record ids | cran_packages_by_date-97a98086b5f301 |
...
For a systems engineer, L0ggm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-26 18:10:02 UTC | [https://cran.r-project.org/web/packages/L0ggm/DESCRIPTION](https://cran.r-project.org/web/packages/L0ggm/DESCRIPTION) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | SEE LICENSE IN GEOLITE2_LICENSE AND GEOLITE2_EULA; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/L0ggm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-97a98086b5f301` from `cran_packages_by_date` as `registry_expansion`
