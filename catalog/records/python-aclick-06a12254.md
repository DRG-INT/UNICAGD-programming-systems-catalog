...
<!-- canonical: https://pypi.org/project/aclick/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclick/](https://pypi.org/project/aclick/) |
| Source record ids | pypi_simple-a4937080ad01d8 |

## System Engineer Summary

aclick is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, aclick belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2022-06-09T12:48:01.082505Z | [https://pypi.org/pypi/aclick/json](https://pypi.org/pypi/aclick/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclick/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-a4937080ad01d8` from `pypi_simple` as `registry_expansion`
