...
<!-- canonical: https://github.com/ErsaGunTosun/astro-map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ErsaGunTosun/astro-map](https://github.com/ErsaGunTosun/astro-map) |
| Source record ids | github_search_space_maps-40e16b9c198740 |

## System Engineer Summary

Astro Map is an interactive astronomy application that allows you to embark on a journey into the
depths of the sky

## Operational Role

For a systems engineer, ErsaGunTosun/astro-map belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-04T09:06:00Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-40e16b9c198740` from `github_search_space_maps` as `registry_expansion`
