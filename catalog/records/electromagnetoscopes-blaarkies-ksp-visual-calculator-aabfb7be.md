...
<!-- canonical: https://github.com/Blaarkies/ksp-visual-calculator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Blaarkies/ksp-visual-calculator](https://github.com/Blaarkies/ksp-visual-calculator) |
| Source record ids | github_search_electromagnetoscopes-dabffc0d7ee099 |

## System Engineer Summary

Online tool for Kerbal Space Program that helps players determine delta-v requirements for a
mission, and what type of comms dishes a certain satellite requires.

## Operational Role

For a systems engineer, Blaarkies/ksp-visual-calculator belongs in the Electromagnetoscopes
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Other |
...
- `github_search_electromagnetoscopes-dabffc0d7ee099` from `github_search_electromagnetoscopes` as `registry_expansion`
