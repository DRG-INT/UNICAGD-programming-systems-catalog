...
<!-- canonical: https://cran.r-project.org/web/packages/actiwalkability/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/actiwalkability/index.html](https://cran.r-project.org/web/packages/actiwalkability/index.html) |
| Source record ids | cran_packages_by_date-f96a06e620a63a |

## System Engineer Summary

Access the EPA Walkability Index

## Operational Role

For a systems engineer, actiwalkability belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:20:09 UTC | [https://cran.r-project.org/web/packages/actiwalkability/DESCRIPTION](https://cran.r-project.org/web/packages/actiwalkability/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/actiwalkability/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-f96a06e620a63a` from `cran_packages_by_date` as `registry_expansion`
