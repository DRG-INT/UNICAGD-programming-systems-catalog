...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_webassembly-5932fd2baf43cc |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.3.0 | 2026-08-25T18:35:58Z | [https://api.github.com/repos/perspective-dev/perspective/releases/latest](https://api.github.com/repos/perspective-dev/perspective/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/perspective-dev/perspective/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-5932fd2baf43cc` from `github_search_webassembly` as `registry_expansion`
