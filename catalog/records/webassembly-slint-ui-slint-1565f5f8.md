...
| Source record ids | github_search_webassembly-50927433db1bbb |
...
For a systems engineer, slint-ui/slint belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.17.1 | 2026-07-07T07:27:27Z | [https://api.github.com/repos/slint-ui/slint/releases/latest](https://api.github.com/repos/slint-ui/slint/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/slint-ui/slint/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-50927433db1bbb` from `github_search_webassembly` as `registry_expansion`
