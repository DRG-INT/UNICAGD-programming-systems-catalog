...
| Source record ids | github_search_effects-26e8366258d5a3 |
...
For a systems engineer, olilarkin/awesome-musicdsp belongs in the Effects inventory as part of
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT + file LICENSE; Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0 |
...
- `github_search_effects-26e8366258d5a3` from `github_search_effects` as `registry_expansion`
