...
<!-- canonical: https://www.npmjs.com/package/eslint-config-prettier-standard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/eslint-config-prettier-standard](https://www.npmjs.com/package/eslint-config-prettier-standard) |
| Source record ids | npm_registry-8010f4ba9adfc3 |

## System Engineer Summary

An ESLint shareable config for projects using 'Prettier' and 'JavaScript Standard Style' as ESLint
rules.

## Operational Role

For a systems engineer, eslint-config-prettier-standard belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2021-02-22T15:39:42.800Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
