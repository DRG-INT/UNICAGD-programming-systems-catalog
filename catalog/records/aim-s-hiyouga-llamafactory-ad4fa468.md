...
<!-- canonical: https://github.com/hiyouga/LlamaFactory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory) |
| Source record ids | github_search_aims-6fa14d3b47606f |
...
For a systems engineer, hiyouga/LlamaFactory belongs in the "aim's" inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:52:23Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-6fa14d3b47606f` from `github_search_aims` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| iOfficeAI/AionUi | Ffi Bindings | [open](aim-s-iofficeai-aionui-ae4168e1.md) |
