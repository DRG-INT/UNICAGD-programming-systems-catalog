...
<!-- canonical: https://github.com/dariol83/reatmetric -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dariol83/reatmetric](https://github.com/dariol83/reatmetric) |
| Source record ids | github_search_satcom_satellites-137c2ac033c1ca |

## System Engineer Summary

Software infrastructure for monitoring & control of hardware and software elements.

## Operational Role

For a systems engineer, dariol83/reatmetric belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-01T16:38:11Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-137c2ac033c1ca` from `github_search_satcom_satellites` as `registry_expansion`
