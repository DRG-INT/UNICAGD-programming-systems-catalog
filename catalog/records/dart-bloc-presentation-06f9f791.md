...
<!-- canonical: https://pub.dev/packages/bloc_presentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/bloc_presentation](https://pub.dev/packages/bloc_presentation) |
| Source record ids | pub_dev-013af56acc0858 |

## System Engineer Summary

Dispatch single-time side effects (navigation / snackbar / dialog) from Bloc or Cubit without
polluting state.

## Operational Role

For a systems engineer, bloc_presentation belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2+3 | 2026-03-12T11:22:30.130782Z | [https://pub.dev/api/packages/bloc_presentation](https://pub.dev/api/packages/bloc_presentation) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/bloc_presentation` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-013af56acc0858` from `pub_dev` as `registry_expansion`
...
| flutter_flavor | Undefined Behavior Analyzer | [open](dart-flutter-flavor-f7a568dd.md) |
