...
| Source record ids | corpus-73c2cf6d623af1 |

## System Engineer Summary

NodeMCU Lua is tracked as an embedded hardware record in the Lua family branch. The source did not
...
For a systems engineer, NodeMCU Lua belongs in the Lua family inventory as part of device
...
- `corpus-73c2cf6d623af1` from `master_json` as `embedded_hardware`
