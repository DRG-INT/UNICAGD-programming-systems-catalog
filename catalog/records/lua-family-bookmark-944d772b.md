...
<!-- canonical: https://luarocks.org/modules/freed-wu/bookmark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/bookmark](https://luarocks.org/modules/freed-wu/bookmark) |
| Source record ids | luarocks_root_manifest-a57819d0dfbdb7 |
...
For a systems engineer, bookmark belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a57819d0dfbdb7` from `luarocks_root_manifest` as `registry_expansion`
