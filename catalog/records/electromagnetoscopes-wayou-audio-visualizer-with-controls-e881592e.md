# wayou/audio-visualizer-with-controls
...
<!-- canonical: https://github.com/wayou/audio-visualizer-with-controls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wayou/audio-visualizer-with-controls](https://github.com/wayou/audio-visualizer-with-controls) |
| Source record ids | github_search_electromagnetoscopes-c7693f49a014c9 |
...
For a systems engineer, wayou/audio-visualizer-with-controls belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-22T14:16:10Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c7693f49a014c9` from `github_search_electromagnetoscopes` as `registry_expansion`
