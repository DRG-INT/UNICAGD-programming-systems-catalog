...
<!-- canonical: https://crates.io/crates/error-chain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/error-chain](https://crates.io/crates/error-chain) |
| Source record ids | crates_io-c777a1b5603e68 |
...
For a systems engineer, error-chain belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.4 | 2020-08-02T17:50:33.565942Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-c777a1b5603e68` from `crates_io` as `registry_expansion`
