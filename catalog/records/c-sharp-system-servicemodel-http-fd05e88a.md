...
<!-- canonical: https://www.nuget.org/packages/System.ServiceModel.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/System.ServiceModel.Http](https://www.nuget.org/packages/System.ServiceModel.Http) |
| Source record ids | nuget_search-fdb17953198efe |
...
For a systems engineer, System.ServiceModel.Http belongs in the C-Sharp inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.652802 | 2025-11-11T17:20:18.923+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.servicemodel.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.servicemodel.http/index.json) |  |
| preview | known | 6.0.0-rc.23205.4 | 2023-04-07T18:12:25.057+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/system.servicemodel.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/system.servicemodel.http/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT; https://www.nuget.org/packages/System.ServiceModel.Http/10.0.652802/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/system.servicemodel.http/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-fdb17953198efe` from `nuget_search` as `registry_expansion`
