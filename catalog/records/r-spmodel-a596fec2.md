...
<!-- canonical: https://cran.r-project.org/web/packages/spmodel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spmodel/index.html](https://cran.r-project.org/web/packages/spmodel/index.html) |
| Source record ids | cran_packages_by_date-da9688f350c54b |
...
For a systems engineer, spmodel belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-09-10 18:40:02 UTC | [https://cran.r-project.org/web/packages/spmodel/DESCRIPTION](https://cran.r-project.org/web/packages/spmodel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spmodel/DESCRIPTION` at `2026-09-10T20:18:42+00:00`.
...
- `cran_packages_by_date-da9688f350c54b` from `cran_packages_by_date` as `registry_expansion`
