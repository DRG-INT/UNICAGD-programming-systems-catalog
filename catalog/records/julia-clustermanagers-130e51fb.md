...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClusterManagers](https://github.com/JuliaRegistries/General/tree/master/C/ClusterManagers) |
| Source record ids | julia_general-8a474393291197 |

## System Engineer Summary

Julia package registered in General at C/ClusterManagers.

## Operational Role

For a systems engineer, ClusterManagers belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClusterManagers", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8a474393291197` from `julia_general` as `registry_expansion`
