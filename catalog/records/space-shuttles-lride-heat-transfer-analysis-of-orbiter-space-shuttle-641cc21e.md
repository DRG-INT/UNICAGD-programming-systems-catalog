# lride/Heat-transfer-analysis-of-Orbiter-space-shuttle-

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lride/Heat-transfer-analysis-of-Orbiter-space-shuttle- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lride/Heat-transfer-analysis-of-Orbiter-space-shuttle-](https://github.com/lride/Heat-transfer-analysis-of-Orbiter-space-shuttle-) |
| Source record ids | github_search_space_shuttles-c1a23d07954995 |

## System Engineer Summary

Plotting NASA shuttle data corresponding to surface thermals at time of atmospheric reentry. Using
standard specific heat expression to model various liquids being dispersed over the surface as
'sweat' to reduce surface temperatures, then plotting both data sets over each other to illustrate
discrepancies

## Operational Role

For a systems engineer, lride/Heat-transfer-analysis-of-Orbiter-space-shuttle- belongs in the Space
Shuttles inventory as part of ecosystem capability mapping, dependency review, release awareness,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-09T02:22:27Z | gh search repos NASA space shuttle data | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-c1a23d07954995` from `github_search_space_shuttles` as `registry_expansion`
