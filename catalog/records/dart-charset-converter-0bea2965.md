...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/charset_converter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/charset_converter](https://pub.dev/packages/charset_converter) |
| Source record ids | pub_dev-3248f70037b7bc |
...
For a systems engineer, charset_converter belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.1 | 2026-07-18T14:07:38.980406Z | [https://pub.dev/api/packages/charset_converter](https://pub.dev/api/packages/charset_converter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/charset_converter` at `2026-09-01T07:20:16+00:00`.
...
- `pub_dev-3248f70037b7bc` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| animate_do | Dependency Manager | [open](dart-animate-do-4140f3b7.md) |
| flutter_modular | Dependency Manager | [open](dart-flutter-modular-3b75173e.md) |
| get | Dependency Manager | [open](dart-get-e3ee2ea4.md) |
| injector | Dependency Manager | [open](dart-injector-fd195535.md) |
| kiwi | Dependency Manager | [open](dart-kiwi-1b8f8bc5.md) |
| loading_indicator | Dependency Manager | [open](dart-loading-indicator-4dc70ef9.md) |
| pin_input_text_field | Dependency Manager | [open](dart-pin-input-text-field-b2436d80.md) |
