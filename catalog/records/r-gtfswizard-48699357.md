...
<!-- canonical: https://cran.r-project.org/web/packages/GTFSwizard/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GTFSwizard/index.html](https://cran.r-project.org/web/packages/GTFSwizard/index.html) |
| Source record ids | cran_packages_by_date-ca30e2eb72432f |

## System Engineer Summary

Creating, Exploring, and Manipulating GTFS Files

## Operational Role

For a systems engineer, GTFSwizard belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-08-21 13:10:47 UTC | [https://cran.r-project.org/web/packages/GTFSwizard/DESCRIPTION](https://cran.r-project.org/web/packages/GTFSwizard/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GTFSwizard/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ca30e2eb72432f` from `cran_packages_by_date` as `registry_expansion`
