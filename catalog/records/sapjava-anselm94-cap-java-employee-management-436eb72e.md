...
<!-- canonical: https://github.com/anselm94/cap-java-employee-management -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anselm94/cap-java-employee-management](https://github.com/anselm94/cap-java-employee-management) |
| Source record ids | github_search_sapjava-8dafa2e758b3d6 |

## System Engineer Summary

A simple single/multitenant implementation of Employee Portal in SAP CAP for Java

## Operational Role

For a systems engineer, anselm94/cap-java-employee-management belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T15:08:34Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-8dafa2e758b3d6` from `github_search_sapjava` as `registry_expansion`
