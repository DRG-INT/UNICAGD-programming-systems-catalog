...
<!-- canonical: https://github.com/WindowsNT/asm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WindowsNT/asm](https://github.com/WindowsNT/asm) |
| Source record ids | github_search_assembly-c66d89995251f1 |
...
For a systems engineer, WindowsNT/asm belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-10T09:55:30Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-c66d89995251f1` from `github_search_assembly` as `registry_expansion`
