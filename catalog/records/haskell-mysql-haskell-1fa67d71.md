...
<!-- canonical: https://hackage.haskell.org/package/mysql-haskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mysql-haskell](https://hackage.haskell.org/package/mysql-haskell) |
| Source record ids | hackage_top_downloads-a896bfebc93aee |
...
For a systems engineer, mysql-haskell belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-07-22T08:21:11Z | [https://hackage.haskell.org/package/mysql-haskell](https://hackage.haskell.org/package/mysql-haskell) |  |
| candidate | partial | 1.1.0 |  | [https://hackage.haskell.org/package/mysql-haskell](https://hackage.haskell.org/package/mysql-haskell) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mysql-haskell` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-a896bfebc93aee` from `hackage_top_downloads` as `registry_expansion`
