...
<!-- canonical: https://github.com/PhDP/mlbop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PhDP/mlbop](https://github.com/PhDP/mlbop) |
| Source record ids | github_search_matlab-2e9e182e371154 |
...
For a systems engineer, PhDP/mlbop belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-08T15:10:54Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-2e9e182e371154` from `github_search_matlab` as `registry_expansion`
