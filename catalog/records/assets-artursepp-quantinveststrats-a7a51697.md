...
<!-- canonical: https://github.com/ArturSepp/QuantInvestStrats -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ArturSepp/QuantInvestStrats](https://github.com/ArturSepp/QuantInvestStrats) |
| Source record ids | github_search_assets-b0a92a9d18a45f |
...
For a systems engineer, ArturSepp/QuantInvestStrats belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T20:26:12Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-b0a92a9d18a45f` from `github_search_assets` as `registry_expansion`
