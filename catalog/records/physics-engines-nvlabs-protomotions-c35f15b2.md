...
<!-- canonical: https://github.com/NVlabs/ProtoMotions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NVlabs/ProtoMotions](https://github.com/NVlabs/ProtoMotions) |
| Source record ids | github_search_physics_engines-34c1bcab82c941 |

## System Engineer Summary

ProtoMotions is a GPU-accelerated simulation and learning framework for training physically
simulated digital humans and humanoid robots.

## Operational Role

For a systems engineer, NVlabs/ProtoMotions belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T01:12:02Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-34c1bcab82c941` from `github_search_physics_engines` as `registry_expansion`
