...
<!-- canonical: https://github.com/acrlw/Physics2D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acrlw/Physics2D](https://github.com/acrlw/Physics2D) |
| Source record ids | github_search_physics_engines-8461cce04228b4 |
...
For a systems engineer, acrlw/Physics2D belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-04T07:23:54Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8461cce04228b4` from `github_search_physics_engines` as `registry_expansion`
