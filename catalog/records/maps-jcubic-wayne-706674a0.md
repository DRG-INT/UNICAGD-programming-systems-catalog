...
<!-- canonical: https://github.com/jcubic/wayne -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jcubic/wayne](https://github.com/jcubic/wayne) |
| Source record ids | github_search_maps-02296dab4c6fbe |
...
For a systems engineer, jcubic/wayne belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T16:49:44Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-02296dab4c6fbe` from `github_search_maps` as `registry_expansion`
