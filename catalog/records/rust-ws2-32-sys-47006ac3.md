...
<!-- canonical: https://crates.io/crates/ws2_32-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ws2_32-sys](https://crates.io/crates/ws2_32-sys) |
| Source record ids | crates_io-4525963904d215 |

## System Engineer Summary

Contains function definitions for the Windows API library ws2_32. See winapi for types and
constants.

## Operational Role

For a systems engineer, ws2_32-sys belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2015-12-16T00:01:49.263868Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
