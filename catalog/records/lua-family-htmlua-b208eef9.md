...
| Canonical URL | [https://luarocks.org/modules/benglard/htmlua](https://luarocks.org/modules/benglard/htmlua) |
| Source record ids | luarocks_root_manifest-6bd60d8c21bfd2 |

## System Engineer Summary

htmlua is tracked as a project scaffolding record in the Lua family branch. The source did not
...
For a systems engineer, htmlua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6bd60d8c21bfd2` from `luarocks_root_manifest` as `registry_expansion`
