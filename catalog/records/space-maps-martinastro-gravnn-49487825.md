...
<!-- canonical: https://github.com/MartinAstro/GravNN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MartinAstro/GravNN](https://github.com/MartinAstro/GravNN) |
| Source record ids | github_search_space_maps-65b7e3e4832009 |
...
For a systems engineer, MartinAstro/GravNN belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-14T11:33:09Z | gh search repos topic:planetary-science stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-65b7e3e4832009` from `github_search_space_maps` as `registry_expansion`
