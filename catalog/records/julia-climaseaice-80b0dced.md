...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaSeaIce](https://github.com/JuliaRegistries/General/tree/master/C/ClimaSeaIce) |
| Source record ids | julia_general-e73319887f6a5a |

## System Engineer Summary

Julia package registered in General at C/ClimaSeaIce.

## Operational Role

For a systems engineer, ClimaSeaIce belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaSeaIce", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e73319887f6a5a` from `julia_general` as `registry_expansion`
