...
<!-- canonical: https://cran.r-project.org/web/packages/bamp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bamp/index.html](https://cran.r-project.org/web/packages/bamp/index.html) |
| Source record ids | cran_packages_by_date-c61293f7910e84 |
...
For a systems engineer, bamp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-31 17:20:02 UTC | [https://cran.r-project.org/web/packages/bamp/DESCRIPTION](https://cran.r-project.org/web/packages/bamp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bamp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c61293f7910e84` from `cran_packages_by_date` as `registry_expansion`
