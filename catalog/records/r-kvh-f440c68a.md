...
<!-- canonical: https://cran.r-project.org/web/packages/kvh/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kvh/index.html](https://cran.r-project.org/web/packages/kvh/index.html) |
| Source record ids | cran_packages_by_date-7f9447d052d1d5 |
...
For a systems engineer, kvh belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-09-08 16:20:02 UTC | [https://cran.r-project.org/web/packages/kvh/DESCRIPTION](https://cran.r-project.org/web/packages/kvh/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kvh/DESCRIPTION` at `2026-09-08T16:22:20+00:00`.
...
- `cran_packages_by_date-7f9447d052d1d5` from `cran_packages_by_date` as `registry_expansion`
