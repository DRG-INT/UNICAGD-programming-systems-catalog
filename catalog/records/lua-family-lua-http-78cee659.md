...
<!-- canonical: https://github.com/daurnimator/lua-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daurnimator/lua-http](https://github.com/daurnimator/lua-http) |
| Source record ids | lua-source-293 |

## System Engineer Summary

Asynchronous HTTP and WebSocket library with client and server APIs, TLS, and HTTP/2; based on
cqueues.

## Operational Role

For a systems engineer, lua-http belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 293}}` |
...
- `lua-source-293` from `master_json` as `source_list_item`
