...
<!-- canonical: https://cran.r-project.org/web/packages/fsbrain/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fsbrain/index.html](https://cran.r-project.org/web/packages/fsbrain/index.html) |
| Source record ids | cran_packages_by_date-48f692c6b10bf5 |
...
For a systems engineer, fsbrain belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-23 15:30:02 UTC | [https://cran.r-project.org/web/packages/fsbrain/DESCRIPTION](https://cran.r-project.org/web/packages/fsbrain/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fsbrain/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-48f692c6b10bf5` from `cran_packages_by_date` as `registry_expansion`
