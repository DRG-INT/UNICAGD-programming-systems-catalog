...
<!-- canonical: https://luarocks.org/modules/catwell/cwtest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/catwell/cwtest](https://luarocks.org/modules/catwell/cwtest) |
| Source record ids | luarocks_root_manifest-615cddb5d00b69 |

## System Engineer Summary

cwtest is tracked as a testing framework record in the Lua family branch. The source did not provide
...
For a systems engineer, cwtest belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-615cddb5d00b69` from `luarocks_root_manifest` as `registry_expansion`
