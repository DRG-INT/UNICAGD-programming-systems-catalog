...
<!-- canonical: https://cran.r-project.org/web/packages/anticlust/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/anticlust/index.html](https://cran.r-project.org/web/packages/anticlust/index.html) |
| Source record ids | cran_packages_by_date-514c646efd7d44 |
...
For a systems engineer, anticlust belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.16 | 2026-09-09 08:50:02 UTC | [https://cran.r-project.org/web/packages/anticlust/DESCRIPTION](https://cran.r-project.org/web/packages/anticlust/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/anticlust/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-514c646efd7d44` from `cran_packages_by_date` as `registry_expansion`
