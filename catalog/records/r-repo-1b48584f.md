...
<!-- canonical: https://cran.r-project.org/web/packages/repo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/repo/index.html](https://cran.r-project.org/web/packages/repo/index.html) |
| Source record ids | cran_packages_by_date-5406be69e9fc81 |
...
For a systems engineer, repo belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.7 | 2026-08-04 23:00:21 UTC | [https://cran.r-project.org/web/packages/repo/DESCRIPTION](https://cran.r-project.org/web/packages/repo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/repo/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5406be69e9fc81` from `cran_packages_by_date` as `registry_expansion`
