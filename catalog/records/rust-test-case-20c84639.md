...
<!-- canonical: https://crates.io/crates/test-case -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/test-case](https://crates.io/crates/test-case) |
| Source record ids | crates_io-6266f1eb9fe8d8 |
...
For a systems engineer, test-case belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.1 | 2023-11-17T20:16:53.517911Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-6266f1eb9fe8d8` from `crates_io` as `registry_expansion`
