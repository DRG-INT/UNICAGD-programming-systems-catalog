...
| Canonical URL | [https://packagist.org/packages/ergebnis/json-schema-validator](https://packagist.org/packages/ergebnis/json-schema-validator) |
| Source record ids | packagist_search-bdae65bb06dc95 |
...
For a systems engineer, ergebnis/json-schema-validator belongs in the PHP inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.1 | 2025-09-06T11:37:52+00:00 | [https://repo.packagist.org/p2/ergebnis/json-schema-validator.json](https://repo.packagist.org/p2/ergebnis/json-schema-validator.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ergebnis/json-schema-validator.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-bdae65bb06dc95` from `packagist_search` as `registry_expansion`
