...
<!-- canonical: https://github.com/fred9076/OPFA_matlab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fred9076/OPFA_matlab](https://github.com/fred9076/OPFA_matlab) |
| Source record ids | github_search_radars-9c28c67c1b9b6b |

## System Engineer Summary

A demo of Gotcha Large Scene data orthorectified imaging with DEM via Orthorectified Polar Format
Algorithm (OPFA)

## Operational Role

For a systems engineer, fred9076/OPFA_matlab belongs in the Radars inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-26T06:50:48Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9c28c67c1b9b6b` from `github_search_radars` as `registry_expansion`
