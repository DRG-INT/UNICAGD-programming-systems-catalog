...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/format.nvim](https://luarocks.org/modules/wsdjeg/format.nvim) |
| Source record ids | luarocks_root_manifest-6bfb3e9f3d1065 |
...
For a systems engineer, format.nvim belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-6bfb3e9f3d1065` from `luarocks_root_manifest` as `registry_expansion`
