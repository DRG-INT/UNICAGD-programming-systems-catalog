...
<!-- canonical: https://github.com/kbhujbal/Trident-synthetic_aperture_radar_maritime_vessel_detection_yolov8 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kbhujbal/Trident-synthetic_aperture_radar_maritime_vessel_detection_yolov8](https://github.com/kbhujbal/Trident-synthetic_aperture_radar_maritime_vessel_detection_yolov8) |
| Source record ids | github_search_radars-689862c86dcc4f |

## System Engineer Summary

📡 Production-grade maritime surveillance system for detecting ships in Synthetic Aperture Radar
(SAR) imagery using YOLOv8-OBB (Oriented Bounding Boxes) and Lee speckle filtering. Handles the
unique challenges of radar imagery: multiplicative noise and arbitrarily-oriented vessels.

## Operational Role

For a systems engineer, kbhujbal/Trident-synthetic_aperture_radar_maritime_vessel_detection_yolov8
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-04T23:48:35Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-689862c86dcc4f` from `github_search_radars` as `registry_expansion`
