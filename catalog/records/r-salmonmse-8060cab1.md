...
<!-- canonical: https://cran.r-project.org/web/packages/salmonMSE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/salmonMSE/index.html](https://cran.r-project.org/web/packages/salmonMSE/index.html) |
| Source record ids | cran_packages_by_date-b8a088c3a89d58 |
...
For a systems engineer, salmonMSE belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-20 10:00:02 UTC | [https://cran.r-project.org/web/packages/salmonMSE/DESCRIPTION](https://cran.r-project.org/web/packages/salmonMSE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/salmonMSE/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b8a088c3a89d58` from `cran_packages_by_date` as `registry_expansion`
