...
<!-- canonical: https://pub.dev/packages/formz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/formz](https://pub.dev/packages/formz) |
| Source record ids | pub_dev-8280be9987f51e |

## System Engineer Summary

A unified form representation in Dart which aims to simplify form representation and validation in a
generic way.

## Operational Role

For a systems engineer, formz belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-08-10T12:12:09.731229Z | [https://pub.dev/api/packages/formz](https://pub.dev/api/packages/formz) |  |
| preview | known | 0.5.0-dev.1 | 2022-05-03T22:28:10.370736Z | [https://pub.dev/api/packages/formz](https://pub.dev/api/packages/formz) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/formz` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-8280be9987f51e` from `pub_dev` as `registry_expansion`
