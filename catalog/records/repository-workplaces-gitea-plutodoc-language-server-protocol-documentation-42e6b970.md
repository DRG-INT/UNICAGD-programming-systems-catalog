# Gitea: plutodoc/language-server-protocol-documentation
...
<!-- canonical: https://gitea.com/plutodoc/language-server-protocol-documentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/plutodoc/language-server-protocol-documentation](https://gitea.com/plutodoc/language-server-protocol-documentation) |
| Source record ids | gitea_repositories_api-29d3abc447fe72 |
...
For a systems engineer, Gitea: plutodoc/language-server-protocol-documentation belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-20T08:43:19Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-29d3abc447fe72` from `gitea_repositories_api` as `registry_expansion`
