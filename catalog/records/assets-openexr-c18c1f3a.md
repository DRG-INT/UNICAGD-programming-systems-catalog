...
| Source record ids | curated_language_routes-98ad976c3a488e |

## System Engineer Summary

High dynamic-range image file format and library for visual effects, rendering, and archival image
assets.

## Operational Role

For a systems engineer, OpenEXR belongs in the Assets inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.15 | 2026-08-21T22:40:38Z | [https://api.github.com/repos/AcademySoftwareFoundation/openexr/releases/latest](https://api.github.com/repos/AcademySoftwareFoundation/openexr/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/AcademySoftwareFoundation/openexr/releases/latest` at `2026-09-01T07:24:43+00:00`.
...
- `curated_language_routes-98ad976c3a488e` from `curated_language_routes` as `registry_expansion`
