...
<!-- canonical: https://github.com/yihong1120/Construction-Hazard-Detection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yihong1120/Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection) |
| Source record ids | github_search_effects-523e3205b46a8d |

## System Engineer Summary

Enhances construction site safety using YOLO for object detection, identifying hazards like workers
without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety
cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

## Operational Role

For a systems engineer, yihong1120/Construction-Hazard-Detection belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T12:51:43Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-523e3205b46a8d` from `github_search_effects` as `registry_expansion`
...
| Lallapallooza/fast-audiomentations | Static Analyzer | [open](effects-lallapallooza-fast-audiomentations-41239683.md) |
| librosa/librosa | Static Analyzer | [open](effects-librosa-librosa-f589e674.md) |
| MirzaBeig/Post-Processing-Scan | Static Analyzer | [open](effects-mirzabeig-post-processing-scan-81ec406f.md) |
| MTG/essentia | Static Analyzer | [open](effects-mtg-essentia-5260afcf.md) |
