...
<!-- canonical: https://hackage.haskell.org/package/keel-onnx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keel-onnx](https://hackage.haskell.org/package/keel-onnx) |
| Source record ids | hackage_recent-d30f27eef08ee0 |
...
For a systems engineer, keel-onnx belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-03T12:55:27Z | [https://hackage.haskell.org/package/keel-onnx](https://hackage.haskell.org/package/keel-onnx) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keel-onnx` at `2026-09-03T16:25:12+00:00`.
...
- `hackage_recent-d30f27eef08ee0` from `hackage_recent` as `registry_expansion`
