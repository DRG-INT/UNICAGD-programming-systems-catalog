...
<!-- canonical: https://github.com/NygenAnalytics/scarf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NygenAnalytics/scarf](https://github.com/NygenAnalytics/scarf) |
| Source record ids | github_search_databases-4009a98046fbe5 |

## System Engineer Summary

Memory-efficient single-cell analysis in Python. Stream RNA, ATAC, CITE-seq and multi-omics from
local or remote Zarr stores, from laptop to atlas scale, with reusable fingerprinted results.

## Operational Role

For a systems engineer, NygenAnalytics/scarf belongs in the Databases inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:03:53Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4009a98046fbe5` from `github_search_databases` as `registry_expansion`
