...
<!-- canonical: https://github.com/abiosoft/colima -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abiosoft/colima](https://github.com/abiosoft/colima) |
| Source record ids | github_search_go-e3b6fccc45112c |
...
For a systems engineer, abiosoft/colima belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T17:22:35Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-e3b6fccc45112c` from `github_search_go` as `registry_expansion`
