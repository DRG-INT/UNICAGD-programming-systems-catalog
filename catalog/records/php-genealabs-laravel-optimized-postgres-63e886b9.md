...
| Canonical URL | [https://packagist.org/packages/genealabs/laravel-optimized-postgres](https://packagist.org/packages/genealabs/laravel-optimized-postgres) |
| Source record ids | packagist_search-7476ab22187eb4 |
...
For a systems engineer, genealabs/laravel-optimized-postgres belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.0.0 | 2026-08-18T21:37:26+00:00 | [https://repo.packagist.org/p2/genealabs/laravel-optimized-postgres.json](https://repo.packagist.org/p2/genealabs/laravel-optimized-postgres.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/genealabs/laravel-optimized-postgres.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-7476ab22187eb4` from `packagist_search` as `registry_expansion`
