...
<!-- canonical: https://github.com/SICKAG/sick_scan_xd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SICKAG/sick_scan_xd](https://github.com/SICKAG/sick_scan_xd) |
| Source record ids | github_search_radars-ab7b4979224743 |

## System Engineer Summary

A versatile driver for a wide range of SICK LiDAR and RADAR devices, providing support for both
Linux and Windows platforms.

## Operational Role

For a systems engineer, SICKAG/sick_scan_xd belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.9.0 | 2026-03-17T11:39:59Z | [https://api.github.com/repos/SICKAG/sick_scan_xd/releases/latest](https://api.github.com/repos/SICKAG/sick_scan_xd/releases/latest) |  |
| preview | known | 3.3.0 | 2024-04-02T08:07:41Z | [https://api.github.com/repos/SICKAG/sick_scan_xd/releases?per_page=10](https://api.github.com/repos/SICKAG/sick_scan_xd/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SICKAG/sick_scan_xd/releases/latest` at `2026-09-01T08:26:31+00:00`.
...
- `github_search_radars-ab7b4979224743` from `github_search_radars` as `registry_expansion`
