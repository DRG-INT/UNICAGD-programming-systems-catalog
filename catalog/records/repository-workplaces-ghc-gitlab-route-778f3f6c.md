...
<!-- canonical: https://gitlab.haskell.org/ghc/ghc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.haskell.org/ghc/ghc](https://gitlab.haskell.org/ghc/ghc) |
| Source record ids | curated_repository_workplace_routes-1c3779a8803efa |

## System Engineer Summary

Official GHC source route on GitLab for compiler and runtime development.

## Operational Role

For a systems engineer, GHC GitLab Route belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-1c3779a8803efa` from `curated_repository_workplace_routes` as `registry_expansion`
