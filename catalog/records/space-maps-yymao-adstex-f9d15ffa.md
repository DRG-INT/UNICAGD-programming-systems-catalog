...
<!-- canonical: https://github.com/yymao/adstex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yymao/adstex](https://github.com/yymao/adstex) |
| Source record ids | github_search_space_maps-81cf7418ae3bf1 |
...
For a systems engineer, yymao/adstex belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-12T14:36:55Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Attribution 4.0 International; https://api.github.com/licenses/cc-by-4.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-81cf7418ae3bf1` from `github_search_space_maps` as `registry_expansion`
