...
<!-- canonical: https://gitlab.com/mts-teta-public/devops-tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/mts-teta-public/devops-tools](https://gitlab.com/mts-teta-public/devops-tools) |
| Source record ids | gitlab_projects_api-9e78feea58f07f |
...
For a systems engineer, mts-teta-public/devops-tools belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-20T14:05:32.817Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-9e78feea58f07f` from `gitlab_projects_api` as `registry_expansion`
