...
<!-- canonical: https://crates.io/crates/libsqlite3-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libsqlite3-sys](https://crates.io/crates/libsqlite3-sys) |
| Source record ids | crates_io-b225a5a81dc7cd |
...
For a systems engineer, libsqlite3-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.38.2 | 2026-08-08T14:21:30.774453Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-b225a5a81dc7cd` from `crates_io` as `registry_expansion`
