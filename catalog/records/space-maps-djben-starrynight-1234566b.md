...
<!-- canonical: https://github.com/DJBen/StarryNight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DJBen/StarryNight](https://github.com/DJBen/StarryNight) |
| Source record ids | github_search_space_maps-87555dc262d3ca |

## System Engineer Summary

Star and constellation query in Swift 6. Render 120k stars up to mag 21. Star Catalogs including HR,
HD, HIP, Gould and Bayer-Flamsteed designations.

## Operational Role

For a systems engineer, DJBen/StarryNight belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-26T19:14:33Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-87555dc262d3ca` from `github_search_space_maps` as `registry_expansion`
