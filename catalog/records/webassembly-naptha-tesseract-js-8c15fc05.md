...
| Canonical URL | [https://github.com/naptha/tesseract.js](https://github.com/naptha/tesseract.js) |
| Source record ids | github_search_webassembly-ab1fb8bf37b3b8 |
...
For a systems engineer, naptha/tesseract.js belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.0.0 | 2025-12-15T03:45:56Z | [https://api.github.com/repos/naptha/tesseract.js/releases/latest](https://api.github.com/repos/naptha/tesseract.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/naptha/tesseract.js/releases/latest` at `2026-09-01T10:26:00+00:00`.
...
- `github_search_webassembly-ab1fb8bf37b3b8` from `github_search_webassembly` as `registry_expansion`
