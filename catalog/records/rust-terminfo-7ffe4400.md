...
| Canonical URL | [https://crates.io/crates/terminfo](https://crates.io/crates/terminfo) |
| Source record ids | crates_io-319b9b482afecc |

## System Engineer Summary

terminfo is tracked as a formatter record in the Rust branch. The source did not provide a long
...
For a systems engineer, terminfo belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2024-05-08T13:44:46.919814Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-319b9b482afecc` from `crates_io` as `registry_expansion`
