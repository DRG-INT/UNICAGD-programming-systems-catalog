...
<!-- canonical: https://crates.io/crates/metrics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/metrics](https://crates.io/crates/metrics) |
| Source record ids | crates_io-e5e81fd3486067 |
...
For a systems engineer, metrics belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.6 | 2026-05-13T17:50:59.032914Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-e5e81fd3486067` from `crates_io` as `registry_expansion`
