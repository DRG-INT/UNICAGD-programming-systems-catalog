...
<!-- canonical: https://luarocks.org/modules/s1m0n38/dante.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/s1m0n38/dante.nvim](https://luarocks.org/modules/s1m0n38/dante.nvim) |
| Source record ids | luarocks_root_manifest-0d7e784fdace5b |
...
For a systems engineer, dante.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0d7e784fdace5b` from `luarocks_root_manifest` as `registry_expansion`
