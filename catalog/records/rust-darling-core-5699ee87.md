...
<!-- canonical: https://crates.io/crates/darling_core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/darling_core](https://crates.io/crates/darling_core) |
| Source record ids | crates_io-9862d3cdd888f1 |

## System Engineer Summary

Helper crate for proc-macro library for reading attributes into structs when implementing custom
derives. Use in your code.

## Operational Role

For a systems engineer, darling_core belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.1 | 2026-08-20T15:11:43.129462Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-9862d3cdd888f1` from `crates_io` as `registry_expansion`
