...
<!-- canonical: https://github.com/stevedonovan/luabuild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevedonovan/luabuild](https://github.com/stevedonovan/luabuild) |
| Source record ids | lua-source-81 |
...
For a systems engineer, Luabuild belongs in the Lua family inventory as part of build graph control,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 81}}` |
...
- `lua-source-81` from `master_json` as `source_list_item`
