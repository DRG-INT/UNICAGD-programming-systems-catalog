...
| Source record ids | corpus-c765d302a0224b |

## System Engineer Summary

VitePress is tracked as a documentation record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, VitePress belongs in the Node.js/JavaScript inventory as part of operator
...
- `corpus-c765d302a0224b` from `master_json` as `documentation`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| @sentry/cli | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-sentry-cli-0da5e1b2.md) |
