...
<!-- canonical: https://github.com/alikon-art/DeterminFlow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alikon-art/DeterminFlow](https://github.com/alikon-art/DeterminFlow) |
| Source record ids | github_search_engines-0d0cae812b1ba8 |

## System Engineer Summary

A production-oriented AI workflow runtime for building, validating, recovering, and shipping complex
AI workflows as dependable services. 面向生产的 AI 工作流运行时：快速开发、验证和恢复复杂 AI 工作流，并将其稳定交付为服务。

## Operational Role

For a systems engineer, alikon-art/DeterminFlow belongs in the Engines inventory as part of runtime
...
- `github_search_engines-0d0cae812b1ba8` from `github_search_engines` as `registry_expansion`
