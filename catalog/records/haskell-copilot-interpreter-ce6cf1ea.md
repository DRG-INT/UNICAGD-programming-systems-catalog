...
<!-- canonical: https://hackage.haskell.org/package/copilot-interpreter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/copilot-interpreter](https://hackage.haskell.org/package/copilot-interpreter) |
| Source record ids | hackage_recent-06875ef13f88c3 |
...
For a systems engineer, copilot-interpreter belongs in the Haskell inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.8.1 | 2026-09-08T22:19:58Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-06875ef13f88c3` from `hackage_recent` as `registry_expansion`
