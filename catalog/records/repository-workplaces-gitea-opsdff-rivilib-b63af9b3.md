...
<!-- canonical: https://gitea.com/Opsdff/RiviLib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Opsdff/RiviLib](https://gitea.com/Opsdff/RiviLib) |
| Source record ids | gitea_repositories_api-10dbba4c167d0a |
...
For a systems engineer, Gitea: Opsdff/RiviLib belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T13:49:56Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-10dbba4c167d0a` from `gitea_repositories_api` as `registry_expansion`
