...
<!-- canonical: https://cran.r-project.org/web/packages/mRMRe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mRMRe/index.html](https://cran.r-project.org/web/packages/mRMRe/index.html) |
| Source record ids | cran_packages_by_date-79487b8814b757 |
...
For a systems engineer, mRMRe belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3.1 | 2026-09-04 05:10:14 UTC | [https://cran.r-project.org/web/packages/mRMRe/DESCRIPTION](https://cran.r-project.org/web/packages/mRMRe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mRMRe/DESCRIPTION` at `2026-09-04T06:24:31+00:00`.
...
- `cran_packages_by_date-79487b8814b757` from `cran_packages_by_date` as `registry_expansion`
