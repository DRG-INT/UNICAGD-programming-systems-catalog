...
| Canonical URL | [https://packagist.org/packages/amphp/hpack](https://packagist.org/packages/amphp/hpack) |
| Source record ids | packagist_search-777ffda68de745 |
...
For a systems engineer, amphp/hpack belongs in the PHP inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.2.2 | 2026-05-03T19:30:31+00:00 | [https://repo.packagist.org/p2/amphp/hpack.json](https://repo.packagist.org/p2/amphp/hpack.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/amphp/hpack.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-777ffda68de745` from `packagist_search` as `registry_expansion`
