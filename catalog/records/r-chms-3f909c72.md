...
<!-- canonical: https://cran.r-project.org/web/packages/chms/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chms/index.html](https://cran.r-project.org/web/packages/chms/index.html) |
| Source record ids | cran_packages_by_date-c49d0639bbb7b2 |

## System Engineer Summary

Accelerometer Processing Methods for Cycle 7 of the CHMS

## Operational Role

For a systems engineer, chms belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.1 | 2026-09-08 13:30:15 UTC | [https://cran.r-project.org/web/packages/chms/DESCRIPTION](https://cran.r-project.org/web/packages/chms/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chms/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-c49d0639bbb7b2` from `cran_packages_by_date` as `registry_expansion`
