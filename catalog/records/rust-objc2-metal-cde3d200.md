...
| Canonical URL | [https://crates.io/crates/objc2-metal](https://crates.io/crates/objc2-metal) |
| Source record ids | crates_io-6c34a2f79365a2 |
...
For a systems engineer, objc2-metal belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T15:47:38.897269Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-6c34a2f79365a2` from `crates_io` as `registry_expansion`
