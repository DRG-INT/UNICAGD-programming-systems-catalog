...
<!-- canonical: https://luarocks.org/modules/aperezdc/dotty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aperezdc/dotty](https://luarocks.org/modules/aperezdc/dotty) |
| Source record ids | luarocks_root_manifest-5ea8ecb719b0de |
...
For a systems engineer, dotty belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5ea8ecb719b0de` from `luarocks_root_manifest` as `registry_expansion`
...
| CommandLineUI | Cli | [open](lua-family-commandlineui-7a8d2bb7.md) |
