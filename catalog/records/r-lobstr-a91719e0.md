...
<!-- canonical: https://cran.r-project.org/web/packages/lobstr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lobstr/index.html](https://cran.r-project.org/web/packages/lobstr/index.html) |
| Source record ids | cran_packages_by_date-b867948a0aa611 |
...
For a systems engineer, lobstr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-09-01 02:20:10 UTC | [https://cran.r-project.org/web/packages/lobstr/DESCRIPTION](https://cran.r-project.org/web/packages/lobstr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lobstr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b867948a0aa611` from `cran_packages_by_date` as `registry_expansion`
