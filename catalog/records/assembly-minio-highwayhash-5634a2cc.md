...
| Canonical URL | [https://github.com/minio/highwayhash](https://github.com/minio/highwayhash) |
| Source record ids | github_search_assembly-75e8508a36c0d2 |

## System Engineer Summary

Native Go version of HighwayHash with optimized assembly implementations on Intel and ARM. Able to
process over 10 GB/sec on a single core on Intel CPUs -

## Operational Role

For a systems engineer, minio/highwayhash belongs in the Assembly inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.4 | 2026-03-21T05:38:40Z | [https://api.github.com/repos/minio/highwayhash/releases/latest](https://api.github.com/repos/minio/highwayhash/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/minio/highwayhash/releases/latest` at `2026-09-01T10:25:50+00:00`.
...
- `github_search_assembly-75e8508a36c0d2` from `github_search_assembly` as `registry_expansion`
