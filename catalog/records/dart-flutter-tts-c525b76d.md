...
<!-- canonical: https://pub.dev/packages/flutter_tts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_tts](https://pub.dev/packages/flutter_tts) |
| Source record ids | pub_dev-30a686be20a8dc |

## System Engineer Summary

A flutter plugin for Text to Speech. This plugin is supported on iOS, macOS, Android, Web, &
Windows.

## Operational Role

For a systems engineer, flutter_tts belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.5 | 2026-01-05T17:54:55.367504Z | [https://pub.dev/api/packages/flutter_tts](https://pub.dev/api/packages/flutter_tts) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_tts` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-30a686be20a8dc` from `pub_dev` as `registry_expansion`
