...
<!-- canonical: https://github.com/unoplatform/uno -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unoplatform/uno](https://github.com/unoplatform/uno) |
| Source record ids | github_search_webassembly-a1ed1f0e837d8a |

## System Engineer Summary

Open-source platform for building cross-platform native Mobile, Web, Desktop, and Embedded apps from
a single C#/XAML codebase. Work from any IDE/CLI with Hot Reload, Visual Designer, MCPs, and Skills
built for modern .NET workflows. 200M+ NuGet downloads.

## Operational Role

For a systems engineer, unoplatform/uno belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.6.166 | 2026-07-30T01:32:22Z | [https://api.github.com/repos/unoplatform/uno/releases/latest](https://api.github.com/repos/unoplatform/uno/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/unoplatform/uno/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-a1ed1f0e837d8a` from `github_search_webassembly` as `registry_expansion`
