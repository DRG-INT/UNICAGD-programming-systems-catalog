...
<!-- canonical: https://github.com/UnityTechnologies/ATerribleKingdom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UnityTechnologies/ATerribleKingdom](https://github.com/UnityTechnologies/ATerribleKingdom) |
| Source record ids | github_search_effects-71cfb996e63cd1 |

## System Engineer Summary

Scripting the Timeline for games in creative ways. Includes a small RTS game build on the 'A Mighty
Kingdom' assets

## Operational Role

For a systems engineer, UnityTechnologies/ATerribleKingdom belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-04T07:30:56Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-71cfb996e63cd1` from `github_search_effects` as `registry_expansion`
...
| noisefactorllc/noisemaker | Build System | [open](effects-noisefactorllc-noisemaker-3b4d1858.md) |
