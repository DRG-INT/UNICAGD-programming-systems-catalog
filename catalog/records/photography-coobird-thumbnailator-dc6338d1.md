...
<!-- canonical: https://github.com/coobird/thumbnailator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coobird/thumbnailator](https://github.com/coobird/thumbnailator) |
| Source record ids | github_search_photography-048db20687dbfb |
...
For a systems engineer, coobird/thumbnailator belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-17T17:48:42Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-048db20687dbfb` from `github_search_photography` as `registry_expansion`
