...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Mictronics/multi-sdr-gps-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mictronics/multi-sdr-gps-sim](https://github.com/Mictronics/multi-sdr-gps-sim) |
| Source record ids | github_search_satcom_satellites-76bb9fb7ca8fb1 |

## System Engineer Summary

multi-sdr-gps-sim generates a IQ data stream on-the-fly to simulate a GPS L1 baseband signal using a
SDR platform like HackRF or ADLAM-Pluto.

## Operational Role

For a systems engineer, Mictronics/multi-sdr-gps-sim belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-17T08:08:19Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_satcom_satellites-76bb9fb7ca8fb1` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CCSDSPy/ccsdspy | Image Audio Dsp | [open](satcom-satellites-ccsdspy-ccsdspy-6643ef17.md) |
| cn0xroot/gr-replay | Image Audio Dsp | [open](satcom-satellites-cn0xroot-gr-replay-ac89c8ee.md) |
| dernasherbrezon/r2cloud | Image Audio Dsp | [open](satcom-satellites-dernasherbrezon-r2cloud-d7412eaf.md) |
| emidan19/deep-tempest | Image Audio Dsp | [open](satcom-satellites-emidan19-deep-tempest-249c2c36.md) |
| GNU Radio Satellite Workflows | Image Audio Dsp | [open](satcom-satellites-gnu-radio-satellite-workflows-de665cfb.md) |
| gr-satellites | Image Audio Dsp | [open](satcom-satellites-gr-satellites-b6e76f51.md) |
| jayin92/Skyfall-GS | Image Audio Dsp | [open](satcom-satellites-jayin92-skyfall-gs-e8526276.md) |
| lennart-rth/Live-Earth-Wallpapers | Image Audio Dsp | [open](satcom-satellites-lennart-rth-live-earth-wallpapers-8a410278.md) |
