...
<!-- canonical: https://packagist.org/packages/doctrine/dbal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/doctrine/dbal](https://packagist.org/packages/doctrine/dbal) |
| Source record ids | packagist_search-eabaaa1494bebf |
...
For a systems engineer, doctrine/dbal belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-eabaaa1494bebf` from `packagist_search` as `registry_expansion`
