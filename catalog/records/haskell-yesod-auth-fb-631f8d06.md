...
<!-- canonical: https://hackage.haskell.org/package/yesod-auth-fb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yesod-auth-fb](https://hackage.haskell.org/package/yesod-auth-fb) |
| Source record ids | hackage_top_downloads-4681929c3e3061 |
...
For a systems engineer, yesod-auth-fb belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.1 | 2020-03-14T17:21:15Z | [https://hackage.haskell.org/package/yesod-auth-fb](https://hackage.haskell.org/package/yesod-auth-fb) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yesod-auth-fb` at `2026-09-01T14:24:43+00:00`.
...
- `hackage_top_downloads-4681929c3e3061` from `hackage_top_downloads` as `registry_expansion`
