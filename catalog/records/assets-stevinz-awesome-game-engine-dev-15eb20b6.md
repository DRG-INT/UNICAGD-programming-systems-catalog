...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stevinz/awesome-game-engine-dev -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevinz/awesome-game-engine-dev](https://github.com/stevinz/awesome-game-engine-dev) |
| Source record ids | github_search_assets-46bab13114dbf1 |
...
For a systems engineer, stevinz/awesome-game-engine-dev belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T18:26:37Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- `github_search_assets-46bab13114dbf1` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashe23/ProjectCleaner | Game Engine Game Dev | [open](assets-ashe23-projectcleaner-d29fe2cd.md) |
| Escartem/GenshinTextures | Game Engine Game Dev | [open](assets-escartem-genshintextures-e0aff47b.md) |
| felladrin/game-development-resources-list | Game Engine Game Dev | [open](assets-felladrin-game-development-resources-list-6087f418.md) |
| fourgames/resources | Game Engine Game Dev | [open](assets-fourgames-resources-96067fd2.md) |
| harfbuzz/harfbuzz | Game Engine Game Dev | [open](assets-harfbuzz-harfbuzz-d76a4fa5.md) |
| hec-ovi/text-to-3D-skill | Game Engine Game Dev | [open](assets-hec-ovi-text-to-3d-skill-3ef6fa92.md) |
| kristiker/source1import | Game Engine Game Dev | [open](assets-kristiker-source1import-382cf47f.md) |
| memo-db/pixel-heroes-spine | Game Engine Game Dev | [open](assets-memo-db-pixel-heroes-spine-1bf85b13.md) |
