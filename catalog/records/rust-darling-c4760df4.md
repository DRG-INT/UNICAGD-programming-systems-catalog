...
<!-- canonical: https://crates.io/crates/darling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/darling](https://crates.io/crates/darling) |
| Source record ids | crates_io-ca9eca4fe9618a |
...
For a systems engineer, darling belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.1 | 2026-08-20T15:12:01.702411Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-ca9eca4fe9618a` from `crates_io` as `registry_expansion`
