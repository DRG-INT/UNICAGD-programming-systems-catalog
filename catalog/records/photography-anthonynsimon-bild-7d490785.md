...
<!-- canonical: https://github.com/anthonynsimon/bild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anthonynsimon/bild](https://github.com/anthonynsimon/bild) |
| Source record ids | github_search_photography-a70a044b5a3b1d |
...
For a systems engineer, anthonynsimon/bild belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T09:45:40Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a70a044b5a3b1d` from `github_search_photography` as `registry_expansion`
