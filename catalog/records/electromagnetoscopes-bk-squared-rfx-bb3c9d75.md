...
<!-- canonical: https://github.com/bk-squared/rfx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bk-squared/rfx](https://github.com/bk-squared/rfx) |
| Source record ids | github_search_electromagnetoscopes-6403594cc91b5f |

## System Engineer Summary

JAX-based 3D FDTD electromagnetic simulator

## Operational Role

For a systems engineer, bk-squared/rfx belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:41:35Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6403594cc91b5f` from `github_search_electromagnetoscopes` as `registry_expansion`
