...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CircuitComponentRounding](https://github.com/JuliaRegistries/General/tree/master/C/CircuitComponentRounding) |
| Source record ids | julia_general-cbee708c009f40 |

## System Engineer Summary

Julia package registered in General at C/CircuitComponentRounding.

## Operational Role

For a systems engineer, CircuitComponentRounding belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CircuitComponentRounding", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-cbee708c009f40` from `julia_general` as `registry_expansion`
