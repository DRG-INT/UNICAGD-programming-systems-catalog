...
<!-- canonical: https://cran.r-project.org/web/packages/mstudentd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mstudentd/index.html](https://cran.r-project.org/web/packages/mstudentd/index.html) |
| Source record ids | cran_packages_by_date-e0b966b345fda2 |
...
For a systems engineer, mstudentd belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2026-08-25 15:00:02 UTC | [https://cran.r-project.org/web/packages/mstudentd/DESCRIPTION](https://cran.r-project.org/web/packages/mstudentd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mstudentd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e0b966b345fda2` from `cran_packages_by_date` as `registry_expansion`
