...
<!-- canonical: https://pub.dev/packages/graphs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/graphs](https://pub.dev/packages/graphs) |
| Source record ids | pub_dev-b4e403ee3f7c94 |
...
For a systems engineer, graphs belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2024-07-18T17:05:54.823274Z | [https://pub.dev/api/packages/graphs](https://pub.dev/api/packages/graphs) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/graphs` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-b4e403ee3f7c94` from `pub_dev` as `registry_expansion`
