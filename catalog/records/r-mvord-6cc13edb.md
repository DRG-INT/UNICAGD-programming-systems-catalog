...
<!-- canonical: https://cran.r-project.org/web/packages/mvord/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mvord/index.html](https://cran.r-project.org/web/packages/mvord/index.html) |
| Source record ids | cran_packages_by_date-877dbd4c98aaa0 |
...
For a systems engineer, mvord belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.7 | 2026-08-21 12:50:02 UTC | [https://cran.r-project.org/web/packages/mvord/DESCRIPTION](https://cran.r-project.org/web/packages/mvord/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mvord/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-877dbd4c98aaa0` from `cran_packages_by_date` as `registry_expansion`
