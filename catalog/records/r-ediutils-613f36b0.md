...
<!-- canonical: https://cran.r-project.org/web/packages/EDIutils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EDIutils/index.html](https://cran.r-project.org/web/packages/EDIutils/index.html) |
| Source record ids | cran_packages_by_date-847de6759703d3 |
...
For a systems engineer, EDIutils belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-08-19 23:10:07 UTC | [https://cran.r-project.org/web/packages/EDIutils/DESCRIPTION](https://cran.r-project.org/web/packages/EDIutils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EDIutils/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-847de6759703d3` from `cran_packages_by_date` as `registry_expansion`
