...
<!-- canonical: https://github.com/EllangoK/ComfyUI-post-processing-nodes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EllangoK/ComfyUI-post-processing-nodes](https://github.com/EllangoK/ComfyUI-post-processing-nodes) |
| Source record ids | github_search_effects-8d645f6abf4456 |
...
For a systems engineer, EllangoK/ComfyUI-post-processing-nodes belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-20T07:16:46Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8d645f6abf4456` from `github_search_effects` as `registry_expansion`
