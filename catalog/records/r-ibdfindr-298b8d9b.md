...
<!-- canonical: https://cran.r-project.org/web/packages/ibdfindr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ibdfindr/index.html](https://cran.r-project.org/web/packages/ibdfindr/index.html) |
| Source record ids | cran_packages_by_date-ca14cbb024a7d1 |

## System Engineer Summary

HMM Toolkit for Inferring IBD Segments from SNP Genotypes

## Operational Role

For a systems engineer, ibdfindr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-31 22:50:02 UTC | [https://cran.r-project.org/web/packages/ibdfindr/DESCRIPTION](https://cran.r-project.org/web/packages/ibdfindr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ibdfindr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ca14cbb024a7d1` from `cran_packages_by_date` as `registry_expansion`
