...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BokehServer](https://github.com/JuliaRegistries/General/tree/master/B/BokehServer) |
| Source record ids | julia_general-b8988f73a533ec |

## System Engineer Summary

Julia package registered in General at B/BokehServer.

## Operational Role

For a systems engineer, BokehServer belongs in the Julia inventory as part of request routing,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BokehServer", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b8988f73a533ec` from `julia_general` as `registry_expansion`
