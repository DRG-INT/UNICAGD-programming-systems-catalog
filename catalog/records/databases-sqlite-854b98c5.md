...
<!-- canonical: https://www.sqlite.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.sqlite.org/](https://www.sqlite.org/) |
| Source record ids | curated_database_systems-0155304bd1183a |

## System Engineer Summary

Embedded SQL database engine used in applications, devices, browsers, and local-first storage.

## Operational Role

For a systems engineer, SQLite belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-0155304bd1183a` from `curated_database_systems` as `registry_expansion`
