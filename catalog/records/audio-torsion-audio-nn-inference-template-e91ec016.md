...
<!-- canonical: https://github.com/Torsion-Audio/nn-inference-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Torsion-Audio/nn-inference-template](https://github.com/Torsion-Audio/nn-inference-template) |
| Source record ids | github_search_audio-556ae5d4fb3d31 |
...
For a systems engineer, Torsion-Audio/nn-inference-template belongs in the Audio inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-28T14:14:50Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-556ae5d4fb3d31` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mhamilt/Audio-Unit-V3-Templates | Project Scaffolding | [open](audio-mhamilt-audio-unit-v3-templates-d443e50a.md) |
