...
| Canonical URL | [https://packagist.org/packages/cuyz/valinor](https://packagist.org/packages/cuyz/valinor) |
| Source record ids | packagist_search-f744a997d48b7d |
...
For a systems engineer, cuyz/valinor belongs in the PHP inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.0 | 2026-08-11T07:31:36+00:00 | [https://repo.packagist.org/p2/cuyz/valinor.json](https://repo.packagist.org/p2/cuyz/valinor.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cuyz/valinor.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-f744a997d48b7d` from `packagist_search` as `registry_expansion`
