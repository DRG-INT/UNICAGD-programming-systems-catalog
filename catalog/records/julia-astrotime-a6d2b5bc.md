...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AstroTime -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AstroTime", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-3ae7a1751350ee` from `julia_general` as `registry_expansion`
