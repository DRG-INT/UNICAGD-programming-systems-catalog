...
| Source record ids | awesome_list-d7e5bd0343a73c |

## System Engineer Summary

Wasmer - Standalone JIT WebAssembly Runtime is tracked as an interpreter runtime record in the
...
For a systems engineer, Wasmer - Standalone JIT WebAssembly Runtime belongs in the WebAssembly
...
- `awesome_list-d7e5bd0343a73c` from `awesome_list` as `registry_expansion`
