...
| Source record ids | corpus-dd95ece03894e6 |

## System Engineer Summary

cqueues is tracked as a networking http record in the Lua family branch. The source did not provide
...
For a systems engineer, cqueues belongs in the Lua family inventory as part of service
...
- `corpus-dd95ece03894e6` from `master_json` as `networking_http`
