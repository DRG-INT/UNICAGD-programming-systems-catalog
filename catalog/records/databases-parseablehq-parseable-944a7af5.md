...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/parseablehq/parseable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/parseablehq/parseable](https://github.com/parseablehq/parseable) |
| Source record ids | github_search_databases-26ba53f889f151 |

## System Engineer Summary

Parseable is an open source, unified infrastructure observability platform built in Rust on a data
lake architecture. It tracks logs, metrics, traces, and events across apps, agents, and systems,
reducing storage costs by up to 90% through columnar telemetry compression.

## Operational Role

For a systems engineer, parseablehq/parseable belongs in the Databases inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T09:02:26Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-26ba53f889f151` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| grafana/grafana | Profiler | [open](databases-grafana-grafana-e48fd20c.md) |
| GreptimeTeam/greptimedb | Profiler | [open](databases-greptimeteam-greptimedb-0f875ab8.md) |
| opentracing-contrib/java-specialagent | Profiler | [open](databases-opentracing-contrib-java-specialagent-3908d3dc.md) |
| opentracing-contrib/java-spring-cloud | Profiler | [open](databases-opentracing-contrib-java-spring-cloud-7790ec99.md) |
| uptrace/bun | Profiler | [open](databases-uptrace-bun-d7ce71ee.md) |
