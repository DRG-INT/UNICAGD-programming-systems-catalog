...
<!-- canonical: https://cran.r-project.org/web/packages/sgee/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sgee/index.html](https://cran.r-project.org/web/packages/sgee/index.html) |
| Source record ids | cran_packages_by_date-ccd6b353b21ca5 |
...
For a systems engineer, sgee belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6-2 | 2026-08-31 19:50:02 UTC | [https://cran.r-project.org/web/packages/sgee/DESCRIPTION](https://cran.r-project.org/web/packages/sgee/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sgee/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ccd6b353b21ca5` from `cran_packages_by_date` as `registry_expansion`
