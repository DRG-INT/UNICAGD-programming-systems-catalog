# Gitea: shivishbrahma/library-books

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/shivishbrahma/library-books -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/shivishbrahma/library-books](https://gitea.com/shivishbrahma/library-books) |
| Source record ids | gitea_repositories_api-47cb65982c6096 |
...
For a systems engineer, Gitea: shivishbrahma/library-books belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T10:14:49Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-47cb65982c6096` from `gitea_repositories_api` as `registry_expansion`
