...
<!-- canonical: https://cran.r-project.org/web/packages/writexl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/writexl/index.html](https://cran.r-project.org/web/packages/writexl/index.html) |
| Source record ids | cran_packages_by_date-96f31fdc24d281 |
...
For a systems engineer, writexl belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-21 13:10:02 UTC | [https://cran.r-project.org/web/packages/writexl/DESCRIPTION](https://cran.r-project.org/web/packages/writexl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/writexl/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-96f31fdc24d281` from `cran_packages_by_date` as `registry_expansion`
