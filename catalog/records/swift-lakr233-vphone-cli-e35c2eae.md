...
| Source record ids | github_search_swift-05a0fc871935f8 |

## System Engineer Summary

Lakr233/vphone-cli is tracked as a cli record in the Swift branch. The source did not provide a long
...
- `github_search_swift-05a0fc871935f8` from `github_search_swift` as `registry_expansion`
