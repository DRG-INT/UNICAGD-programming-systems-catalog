...
<!-- canonical: https://cran.r-project.org/web/packages/survival/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/survival/index.html](https://cran.r-project.org/web/packages/survival/index.html) |
| Source record ids | cran_packages_by_date-ce40fa702571cd |

## System Engineer Summary

survival is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, survival belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.8-11 | 2026-08-21 13:10:11 UTC | [https://cran.r-project.org/web/packages/survival/DESCRIPTION](https://cran.r-project.org/web/packages/survival/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/survival/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ce40fa702571cd` from `cran_packages_by_date` as `registry_expansion`
