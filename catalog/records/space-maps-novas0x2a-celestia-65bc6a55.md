...
<!-- canonical: https://github.com/novas0x2a/celestia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/novas0x2a/celestia](https://github.com/novas0x2a/celestia) |
| Source record ids | github_search_space_maps-a3f95b48fc875c |

## System Engineer Summary

UNOFFICIAL MIRROR: Celestia is an application for real-time 3D visualization of space, with a
detailed model of the solar system, over 100,000 stars, more than 10,000 galaxies, and an extension
mechanism for adding more objects.

## Operational Role

For a systems engineer, novas0x2a/celestia belongs in the Space Maps inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-10-13T03:31:16Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-a3f95b48fc875c` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mars-sim/mars-sim | Ffi Bindings | [open](space-maps-mars-sim-mars-sim-54bf76f4.md) |
