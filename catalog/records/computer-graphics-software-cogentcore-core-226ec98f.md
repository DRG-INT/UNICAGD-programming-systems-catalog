...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cogentcore/core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cogentcore/core](https://github.com/cogentcore/core) |
| Source record ids | github_search_computer_graphics_software-3b9bd285682663 |

## System Engineer Summary

A free and open source framework for building powerful, fast, elegant 2D and 3D apps that run on
macOS, Windows, Linux, iOS, Android, and web with a single Go codebase, allowing you to Code Once,
Run Everywhere.

## Operational Role

For a systems engineer, cogentcore/core belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-3b9bd285682663` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| img2threejs/img2threejs | Build System | [open](computer-graphics-software-img2threejs-img2threejs-fb559073.md) |
| jgraph/drawio-desktop | Build System | [open](computer-graphics-software-jgraph-drawio-desktop-5e241017.md) |
| o3de/o3de | Build System | [open](computer-graphics-software-o3de-o3de-e457c3e7.md) |
| storytold/artcraft | Build System | [open](computer-graphics-software-storytold-artcraft-5baeb4dc.md) |
