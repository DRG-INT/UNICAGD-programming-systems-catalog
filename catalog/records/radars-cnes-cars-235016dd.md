...
<!-- canonical: https://github.com/CNES/cars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CNES/cars](https://github.com/CNES/cars) |
| Source record ids | github_search_radars-bb2e5add9ce54f |

## System Engineer Summary

CARS is a dedicated and open source 3D tool to produce Digital Surface Models from satellite imaging
by photogrammetry.

## Operational Role

For a systems engineer, CNES/cars belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:57:30Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-bb2e5add9ce54f` from `github_search_radars` as `registry_expansion`
