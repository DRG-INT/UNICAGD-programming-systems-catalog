...
<!-- canonical: https://crates.io/crates/const-oid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/const-oid](https://crates.io/crates/const-oid) |
| Source record ids | crates_io-1241f19d8da0a3 |

## System Engineer Summary

Const-friendly implementation of the ISO/IEC Object Identifier (OID) standard as defined in ITU
X.660, with support for BER/DER encoding/decoding as well as heapless no_std (i.e. embedded) support

## Operational Role

For a systems engineer, const-oid belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2 | 2026-01-07T23:11:57.242553Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-1241f19d8da0a3` from `crates_io` as `registry_expansion`
