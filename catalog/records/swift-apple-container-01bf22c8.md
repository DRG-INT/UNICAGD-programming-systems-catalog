...
| Source record ids | github_search_swift-4cd9d6317f9843 |
...
For a systems engineer, apple/container belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-29T00:24:57Z | [https://api.github.com/repos/apple/container/releases/latest](https://api.github.com/repos/apple/container/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apple/container/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-4cd9d6317f9843` from `github_search_swift` as `registry_expansion`
