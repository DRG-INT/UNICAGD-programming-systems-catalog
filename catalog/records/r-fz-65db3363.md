...
<!-- canonical: https://cran.r-project.org/web/packages/fz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fz/index.html](https://cran.r-project.org/web/packages/fz/index.html) |
| Source record ids | cran_packages_by_date-a620b6d9870346 |
...
For a systems engineer, fz belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-04 16:30:02 UTC | [https://cran.r-project.org/web/packages/fz/DESCRIPTION](https://cran.r-project.org/web/packages/fz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fz/DESCRIPTION` at `2026-09-04T18:21:01+00:00`.
...
- `cran_packages_by_date-a620b6d9870346` from `cran_packages_by_date` as `registry_expansion`
