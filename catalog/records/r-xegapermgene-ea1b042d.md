...
<!-- canonical: https://cran.r-project.org/web/packages/xegaPermGene/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xegaPermGene/index.html](https://cran.r-project.org/web/packages/xegaPermGene/index.html) |
| Source record ids | cran_packages_by_date-7b4cefafb0cdf8 |
...
For a systems engineer, xegaPermGene belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.2 | 2026-08-20 13:20:02 UTC | [https://cran.r-project.org/web/packages/xegaPermGene/DESCRIPTION](https://cran.r-project.org/web/packages/xegaPermGene/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xegaPermGene/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7b4cefafb0cdf8` from `cran_packages_by_date` as `registry_expansion`
