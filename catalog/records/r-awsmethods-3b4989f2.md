...
<!-- canonical: https://cran.r-project.org/web/packages/awsMethods/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/awsMethods/index.html](https://cran.r-project.org/web/packages/awsMethods/index.html) |
| Source record ids | cran_packages_by_date-722cb1f66a1444 |
...
For a systems engineer, awsMethods belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-2 | 2026-08-28 07:10:03 UTC | [https://cran.r-project.org/web/packages/awsMethods/DESCRIPTION](https://cran.r-project.org/web/packages/awsMethods/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/awsMethods/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-722cb1f66a1444` from `cran_packages_by_date` as `registry_expansion`
