...
<!-- canonical: https://hackage.haskell.org/package/HsHTSLib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HsHTSLib](https://hackage.haskell.org/package/HsHTSLib) |
| Source record ids | hackage_top_downloads-ae453a41c97f58 |
...
For a systems engineer, HsHTSLib belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.2.2 | 2021-09-30T05:30:01Z | [https://hackage.haskell.org/package/HsHTSLib](https://hackage.haskell.org/package/HsHTSLib) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HsHTSLib` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-ae453a41c97f58` from `hackage_top_downloads` as `registry_expansion`
