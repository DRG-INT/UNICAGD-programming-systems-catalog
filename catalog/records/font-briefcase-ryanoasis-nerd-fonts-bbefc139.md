...
| Source record ids | github_search_font_briefcase-a33aadb1e44012 |
...
For a systems engineer, ryanoasis/nerd-fonts belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:42:55Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-a33aadb1e44012` from `github_search_font_briefcase` as `registry_expansion`
