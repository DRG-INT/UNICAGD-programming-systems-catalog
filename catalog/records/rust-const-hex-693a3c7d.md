...
<!-- canonical: https://crates.io/crates/const-hex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/const-hex](https://crates.io/crates/const-hex) |
| Source record ids | crates_io-093d49403c7656 |
...
For a systems engineer, const-hex belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.2 | 2026-09-15T14:20:40.304599Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-15T14:21:14+00:00`.
...
- `crates_io-093d49403c7656` from `crates_io` as `registry_expansion`
