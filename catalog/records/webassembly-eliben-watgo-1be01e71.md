...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/eliben/watgo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eliben/watgo](https://github.com/eliben/watgo) |
| Source record ids | github_search_webassembly-b931b6bf6141a6 |
...
For a systems engineer, eliben/watgo belongs in the WebAssembly inventory as part of ecosystem
...
- `github_search_webassembly-b931b6bf6141a6` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| WebAssembly/wabt | Utility Library | [open](webassembly-webassembly-wabt-4c17737d.md) |
