...
<!-- canonical: https://crates.io/crates/crossbeam-deque -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crossbeam-deque](https://crates.io/crates/crossbeam-deque) |
| Source record ids | crates_io-dd69c142d902b9 |
...
For a systems engineer, crossbeam-deque belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.8 | 2026-09-05T17:47:08.254122Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-05T18:20:32+00:00`.
...
- `crates_io-dd69c142d902b9` from `crates_io` as `registry_expansion`
