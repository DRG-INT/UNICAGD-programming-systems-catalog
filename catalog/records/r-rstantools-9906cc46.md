...
<!-- canonical: https://cran.r-project.org/web/packages/rstantools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rstantools/index.html](https://cran.r-project.org/web/packages/rstantools/index.html) |
| Source record ids | cran_packages_by_date-363d9188edf0f4 |
...
For a systems engineer, rstantools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.1 | 2026-08-29 15:20:07 UTC | [https://cran.r-project.org/web/packages/rstantools/DESCRIPTION](https://cran.r-project.org/web/packages/rstantools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rstantools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-363d9188edf0f4` from `cran_packages_by_date` as `registry_expansion`
