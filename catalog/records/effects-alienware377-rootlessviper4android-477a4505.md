# alienware377/RootlessViPER4Android
...
<!-- canonical: https://github.com/alienware377/RootlessViPER4Android -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alienware377/RootlessViPER4Android](https://github.com/alienware377/RootlessViPER4Android) |
| Source record ids | github_search_effects-4381d2b8b74f34 |

## System Engineer Summary

RootlessViPER4Android (RV4A) — ViPER4Android effects natively ported into a RootlessJamesDSP fork.
Rootless or rooted, no Magisk module required. Formerly RootlessJamesDSP — ViPER4Android Edition.

## Operational Role

For a systems engineer, alienware377/RootlessViPER4Android belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T21:39:11Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-4381d2b8b74f34` from `github_search_effects` as `registry_expansion`
