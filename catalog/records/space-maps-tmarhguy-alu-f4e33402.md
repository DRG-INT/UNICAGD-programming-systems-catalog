...
<!-- canonical: https://github.com/tmarhguy/alu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tmarhguy/alu](https://github.com/tmarhguy/alu) |
| Source record ids | github_search_space_maps-8ef5441f0bfcd6 |

## System Engineer Summary

8-bit combinational ALU built from scratch with 3,488 CMOS transistors (KiCad + SPICE + Logisim +
1.24M tests

## Operational Role

For a systems engineer, tmarhguy/alu belongs in the Space Maps inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-05T05:40:28Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8ef5441f0bfcd6` from `github_search_space_maps` as `registry_expansion`
