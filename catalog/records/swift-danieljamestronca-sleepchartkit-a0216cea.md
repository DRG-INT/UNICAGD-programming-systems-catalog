# DanielJamesTronca/SleepChartKit

## Navigation

[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DanielJamesTronca/SleepChartKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DanielJamesTronca/SleepChartKit](https://github.com/DanielJamesTronca/SleepChartKit) |
| Source record ids | github_search_swift-8fde44cc4a647b |

## System Engineer Summary

A production-ready, high-fidelity reproduction of Apple's detailed sleep analysis chart, built with
pure SwiftUI.

## Operational Role

For a systems engineer, DanielJamesTronca/SleepChartKit belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.0 | 2025-10-21T20:25:27Z | [https://api.github.com/repos/DanielJamesTronca/SleepChartKit/releases/latest](https://api.github.com/repos/DanielJamesTronca/SleepChartKit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/DanielJamesTronca/SleepChartKit/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-8fde44cc4a647b` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AudioKit/AudioKit | Static Analyzer | [open](swift-audiokit-audiokit-0a7c5399.md) |
