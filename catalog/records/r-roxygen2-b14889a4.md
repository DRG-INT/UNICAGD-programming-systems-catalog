...
<!-- canonical: https://cran.r-project.org/web/packages/roxygen2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/roxygen2/index.html](https://cran.r-project.org/web/packages/roxygen2/index.html) |
| Source record ids | cran_packages_by_date-4f83af3a80002f |
...
For a systems engineer, roxygen2 belongs in the R inventory as part of operator onboarding, API
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.1.0 | 2026-08-04 20:00:02 UTC | [https://cran.r-project.org/web/packages/roxygen2/DESCRIPTION](https://cran.r-project.org/web/packages/roxygen2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/roxygen2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4f83af3a80002f` from `cran_packages_by_date` as `registry_expansion`
