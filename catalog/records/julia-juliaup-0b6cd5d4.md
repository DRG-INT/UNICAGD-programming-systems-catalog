...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | master-4da0d7606909 |

## System Engineer Summary

Julia version installer and version manager

## Operational Role

For a systems engineer, Juliaup belongs in the Julia inventory as part of ecosystem capability
...
- `master-4da0d7606909` from `master_json` as `dependency_manager`
