...
<!-- canonical: https://cran.r-project.org/web/packages/SCORPION/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SCORPION/index.html](https://cran.r-project.org/web/packages/SCORPION/index.html) |
| Source record ids | cran_packages_by_date-8a843ff941f614 |
...
For a systems engineer, SCORPION belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3 | 2026-09-02 14:50:02 UTC | [https://cran.r-project.org/web/packages/SCORPION/DESCRIPTION](https://cran.r-project.org/web/packages/SCORPION/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SCORPION/DESCRIPTION` at `2026-09-02T15:24:11+00:00`.
...
- `cran_packages_by_date-8a843ff941f614` from `cran_packages_by_date` as `registry_expansion`
