...
<!-- canonical: https://hackage.haskell.org/package/validation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/validation](https://hackage.haskell.org/package/validation) |
| Source record ids | hackage_top_downloads-c0dbbc45b52a37 |
...
For a systems engineer, validation belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-04-22T12:11:49Z | [https://hackage.haskell.org/package/validation](https://hackage.haskell.org/package/validation) |  |
| candidate | partial | 0.5.0 |  | [https://hackage.haskell.org/package/validation](https://hackage.haskell.org/package/validation) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/validation` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-c0dbbc45b52a37` from `hackage_top_downloads` as `registry_expansion`
