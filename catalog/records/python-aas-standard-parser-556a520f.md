...
<!-- canonical: https://pypi.org/project/aas-standard-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aas-standard-parser/](https://pypi.org/project/aas-standard-parser/) |
| Source record ids | pypi_simple-34244323aa0adc |
...
For a systems engineer, aas-standard-parser belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.7 | 2026-09-01T09:06:21.923425Z | [https://pypi.org/pypi/aas-standard-parser/json](https://pypi.org/pypi/aas-standard-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aas-standard-parser/json` at `2026-09-01T10:21:38+00:00`.
...
- `pypi_simple-34244323aa0adc` from `pypi_simple` as `registry_expansion`
