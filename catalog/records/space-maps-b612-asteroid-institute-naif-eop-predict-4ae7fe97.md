...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/B612-Asteroid-Institute/naif_eop_predict -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/B612-Asteroid-Institute/naif_eop_predict](https://github.com/B612-Asteroid-Institute/naif_eop_predict) |
| Source record ids | github_search_space_maps-99b085d76ac413 |
...
For a systems engineer, B612-Asteroid-Institute/naif_eop_predict belongs in the Space Maps inventory
as part of language tooling, code generation, static analysis, and source transformation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T02:34:47Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
| Evidence | zlib License; https://api.github.com/licenses/zlib; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_space_maps-99b085d76ac413` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xCoto/Virgo | Parser Lexer Ast | [open](space-maps-0xcoto-virgo-032ae2e8.md) |
| aaronwmorris/indi-allsky | Parser Lexer Ast | [open](space-maps-aaronwmorris-indi-allsky-b7f86b59.md) |
| abbyazari/data_vis_statistics_geosciences | Parser Lexer Ast | [open](space-maps-abbyazari-data-vis-statistics-geosciences-7687caa4.md) |
| adarshiniraju/Interactive-Stargazer-Sky-Map | Parser Lexer Ast | [open](space-maps-adarshiniraju-interactive-stargazer-sky-map-afb025f4.md) |
| adrn/gala | Parser Lexer Ast | [open](space-maps-adrn-gala-39adb199.md) |
| Alex-Broughton/sky-mapper | Parser Lexer Ast | [open](space-maps-alex-broughton-sky-mapper-55636494.md) |
| AllskyTeam/allsky | Parser Lexer Ast | [open](space-maps-allskyteam-allsky-81002f5d.md) |
| ameya-tries-coding/Night-Sky-Visibility-AI | Parser Lexer Ast | [open](space-maps-ameya-tries-coding-night-sky-visibility-ai-35b0be4d.md) |
