...
<!-- canonical: https://github.com/BigShoots/PGenerator-Plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BigShoots/PGenerator-Plus](https://github.com/BigShoots/PGenerator-Plus) |
| Source record ids | github_search_photography-038105723b23af |

## System Engineer Summary

PGenerator+ is a free, open-source Raspberry Pi–based display calibration suite built around a
precision HDMI test pattern generator.

## Operational Role

For a systems engineer, BigShoots/PGenerator-Plus belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T23:24:52Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-038105723b23af` from `github_search_photography` as `registry_expansion`
