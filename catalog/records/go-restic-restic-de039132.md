...
<!-- canonical: https://github.com/restic/restic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/restic/restic](https://github.com/restic/restic) |
| Source record ids | github_search_go-43f723036fc488 |
...
For a systems engineer, restic/restic belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T01:43:58Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-43f723036fc488` from `github_search_go` as `registry_expansion`
