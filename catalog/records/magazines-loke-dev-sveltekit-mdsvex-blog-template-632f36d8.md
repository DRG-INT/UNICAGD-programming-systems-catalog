# loke-dev/sveltekit-mdsvex-blog-template
...
<!-- canonical: https://github.com/loke-dev/sveltekit-mdsvex-blog-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/loke-dev/sveltekit-mdsvex-blog-template](https://github.com/loke-dev/sveltekit-mdsvex-blog-template) |
| Source record ids | github_search_magazines-aeab2e9ee9c129 |
...
For a systems engineer, loke-dev/sveltekit-mdsvex-blog-template belongs in the Magazines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T10:13:42Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-aeab2e9ee9c129` from `github_search_magazines` as `registry_expansion`
