...
<!-- canonical: https://gitlab.com/dmfay/pdot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/dmfay/pdot](https://gitlab.com/dmfay/pdot) |
| Source record ids | gitlab_projects_api-40e98ec6f0f9e9 |

## System Engineer Summary

Explore your Postgres databases by generating dot or mermaid graphs of high-context foreign key
relationships, trigger cascades, role inheritance and permissions, and more!

## Operational Role

For a systems engineer, dmfay/pdot belongs in the Repository Workplaces inventory as part of state
...
- `gitlab_projects_api-40e98ec6f0f9e9` from `gitlab_projects_api` as `registry_expansion`
