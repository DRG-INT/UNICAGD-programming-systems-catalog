...
<!-- canonical: https://crates.io/crates/libloading -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/libloading](https://crates.io/crates/libloading) |
| Source record ids | crates_io-8464372de19b34 |
...
For a systems engineer, libloading belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2025-11-05T23:15:12.937093Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-8464372de19b34` from `crates_io` as `registry_expansion`
