...
<!-- canonical: https://crates.io/crates/async-signal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-signal](https://crates.io/crates/async-signal) |
| Source record ids | crates_io-bd9e71487ac7c3 |

## System Engineer Summary

async-signal is tracked as an async runtime record in the Rust branch. The source did not provide a
...
For a systems engineer, async-signal belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.14 | 2026-04-07T11:50:26.817406Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-bd9e71487ac7c3` from `crates_io` as `registry_expansion`
