...
<!-- canonical: https://cran.r-project.org/web/packages/ibist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ibist/index.html](https://cran.r-project.org/web/packages/ibist/index.html) |
| Source record ids | cran_packages_by_date-77d4063c39579b |

## System Engineer Summary

Data and Functions for Introduction to Biostatistics with R

## Operational Role

For a systems engineer, ibist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-0 | 2026-09-12 13:10:02 UTC | [https://cran.r-project.org/web/packages/ibist/DESCRIPTION](https://cran.r-project.org/web/packages/ibist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ibist/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-77d4063c39579b` from `cran_packages_by_date` as `registry_expansion`
