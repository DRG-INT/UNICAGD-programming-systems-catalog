...
<!-- canonical: https://github.com/reales/retromulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/reales/retromulator](https://github.com/reales/retromulator) |
| Source record ids | github_search_audio-d021896f5fb66f |

## System Engineer Summary

A standalone app and DAW plugin (AAX / VST3 / AU) that emulates classic hardware synthesizers,
samplers, and keyboards by running their original firmware on cycle-accurate CPU and DSP emulators.

## Operational Role

For a systems engineer, reales/retromulator belongs in the Audio inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T07:24:46Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-d021896f5fb66f` from `github_search_audio` as `registry_expansion`
