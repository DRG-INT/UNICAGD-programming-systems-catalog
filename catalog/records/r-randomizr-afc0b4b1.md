...
<!-- canonical: https://cran.r-project.org/web/packages/randomizr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/randomizr/index.html](https://cran.r-project.org/web/packages/randomizr/index.html) |
| Source record ids | cran_packages_by_date-9122186c811769 |
...
For a systems engineer, randomizr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-27 05:10:15 UTC | [https://cran.r-project.org/web/packages/randomizr/DESCRIPTION](https://cran.r-project.org/web/packages/randomizr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/randomizr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9122186c811769` from `cran_packages_by_date` as `registry_expansion`
