...
<!-- canonical: https://pub.dev/packages/args -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/args](https://pub.dev/packages/args) |
| Source record ids | pub_dev-2cb40832010a09 |

## System Engineer Summary

Library for defining parsers for parsing raw command-line arguments into a set of options and values
using GNU and POSIX style options.

## Operational Role

For a systems engineer, args belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2025-03-12T17:56:09.371210Z | [https://pub.dev/api/packages/args](https://pub.dev/api/packages/args) |  |
| preview | known | 2.0.0-nullsafety.0 | 2020-12-30T19:35:27.256058Z | [https://pub.dev/api/packages/args](https://pub.dev/api/packages/args) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/args` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-2cb40832010a09` from `pub_dev` as `registry_expansion`
...
| flutter_contacts | Parser Lexer Ast | [open](dart-flutter-contacts-06b4e09a.md) |
