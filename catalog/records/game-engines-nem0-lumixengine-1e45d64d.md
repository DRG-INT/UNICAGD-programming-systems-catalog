...
<!-- canonical: https://github.com/nem0/LumixEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nem0/LumixEngine](https://github.com/nem0/LumixEngine) |
| Source record ids | github_search_game_engines-40317de60be0b7 |
...
For a systems engineer, nem0/LumixEngine belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:22:32Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-40317de60be0b7` from `github_search_game_engines` as `registry_expansion`
