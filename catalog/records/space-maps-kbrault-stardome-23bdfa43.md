...
<!-- canonical: https://github.com/kbrault/stardome -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kbrault/stardome](https://github.com/kbrault/stardome) |
| Source record ids | github_search_space_maps-5af6ac2b087bba |

## System Engineer Summary

An interactive browser-based 3D star map that projects real Hipparcos catalog data onto a canvas,
letting users explore the night sky from any location and time.

## Operational Role

For a systems engineer, kbrault/stardome belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T09:36:28Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5af6ac2b087bba` from `github_search_space_maps` as `registry_expansion`
