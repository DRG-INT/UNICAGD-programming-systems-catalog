...
<!-- canonical: https://github.com/taybenlor/runno -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/taybenlor/runno](https://github.com/taybenlor/runno) |
| Source record ids | github_search_webassembly-c5e3a3dd347902 |

## System Engineer Summary

Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server,
or via MCP.

## Operational Role

For a systems engineer, taybenlor/runno belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T02:02:29Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-c5e3a3dd347902` from `github_search_webassembly` as `registry_expansion`
