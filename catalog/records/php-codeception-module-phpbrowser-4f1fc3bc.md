...
| Canonical URL | [https://packagist.org/packages/codeception/module-phpbrowser](https://packagist.org/packages/codeception/module-phpbrowser) |
| Source record ids | packagist_search-d33fdc1040dc49 |
...
For a systems engineer, codeception/module-phpbrowser belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.1.0 | 2026-07-27T06:12:30+00:00 | [https://repo.packagist.org/p2/codeception/module-phpbrowser.json](https://repo.packagist.org/p2/codeception/module-phpbrowser.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/codeception/module-phpbrowser.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-d33fdc1040dc49` from `packagist_search` as `registry_expansion`
