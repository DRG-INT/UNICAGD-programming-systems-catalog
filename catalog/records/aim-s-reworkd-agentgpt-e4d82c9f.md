...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/reworkd/AgentGPT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/reworkd/AgentGPT](https://github.com/reworkd/AgentGPT) |
| Source record ids | github_search_aims-a362fecf3941ef |
...
For a systems engineer, reworkd/AgentGPT belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-29T01:19:32Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_aims-a362fecf3941ef` from `github_search_aims` as `registry_expansion`
