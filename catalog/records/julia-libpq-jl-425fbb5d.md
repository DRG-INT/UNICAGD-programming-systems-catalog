...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-567efcd9c2a111 |

## System Engineer Summary

LibPQ.jl is tracked as a database datastore record in the Julia branch. The source did not provide a
...
For a systems engineer, LibPQ.jl belongs in the Julia inventory as part of state persistence,
...
- `corpus-567efcd9c2a111` from `master_json` as `database_datastore`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AirfoilDatabase | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-airfoildatabase-ff2201d5.md) |
| BitemporalPostgres | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bitemporalpostgres-2c522397.md) |
| BitemporalPostgresDDL | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bitemporalpostgresddl-d1e65ed7.md) |
| ODBC.jl | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-odbc-jl-6db59fc8.md) |
| SQLite.jl | Database Datastore | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-sqlite-jl-555b1802.md) |
