...
<!-- canonical: https://cran.r-project.org/web/packages/hcruR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hcruR/index.html](https://cran.r-project.org/web/packages/hcruR/index.html) |
| Source record ids | cran_packages_by_date-cfa76a77d2a6f6 |
...
For a systems engineer, hcruR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-30 05:10:24 UTC | [https://cran.r-project.org/web/packages/hcruR/DESCRIPTION](https://cran.r-project.org/web/packages/hcruR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hcruR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-cfa76a77d2a6f6` from `cran_packages_by_date` as `registry_expansion`
