...
<!-- canonical: https://cran.r-project.org/web/packages/enrichit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/enrichit/index.html](https://cran.r-project.org/web/packages/enrichit/index.html) |
| Source record ids | cran_packages_by_date-2e0653a6670286 |
...
For a systems engineer, enrichit belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-04 18:40:02 UTC | [https://cran.r-project.org/web/packages/enrichit/DESCRIPTION](https://cran.r-project.org/web/packages/enrichit/DESCRIPTION) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; The Unlicense; https://api.github.com/licenses/unlicense |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/enrichit/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2e0653a6670286` from `cran_packages_by_date` as `registry_expansion`
