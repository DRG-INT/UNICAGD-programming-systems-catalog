...
| Canonical URL | [https://github.com/Supporterino/photo-organizer](https://github.com/Supporterino/photo-organizer) |
| Source record ids | github_search_photography-865124a35e55da |

## System Engineer Summary

A simple python script to sort or reorganise your collection of images or RAWs. Or just any files
you want to sort by creation date.

## Operational Role

For a systems engineer, Supporterino/photo-organizer belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-12-27T19:35:22Z | [https://api.github.com/repos/Supporterino/photo-organizer/releases/latest](https://api.github.com/repos/Supporterino/photo-organizer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Supporterino/photo-organizer/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-865124a35e55da` from `github_search_photography` as `registry_expansion`
