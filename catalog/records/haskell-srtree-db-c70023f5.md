...
<!-- canonical: https://hackage.haskell.org/package/srtree-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/srtree-db](https://hackage.haskell.org/package/srtree-db) |
| Source record ids | hackage_recent-6179081120d6b4 |
...
For a systems engineer, srtree-db belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2.0 | 2026-09-02T22:43:38Z | [https://hackage.haskell.org/package/srtree-db](https://hackage.haskell.org/package/srtree-db) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/srtree-db` at `2026-09-03T16:25:12+00:00`.
...
- `hackage_recent-6179081120d6b4` from `hackage_recent` as `registry_expansion`
