...
<!-- canonical: https://software.nasa.gov/software/LEW-17687-1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://software.nasa.gov/software/LEW-17687-1](https://software.nasa.gov/software/LEW-17687-1) |
| Source record ids | curated_language_routes-8ac18f1e378c5a |

## System Engineer Summary

NASA Chemical Equilibrium with Applications software route for rocket performance and combustion
calculations.

## Operational Role

For a systems engineer, NASA CEA belongs in the Space Engines inventory as part of ecosystem
...
- `curated_language_routes-8ac18f1e378c5a` from `curated_language_routes` as `registry_expansion`
