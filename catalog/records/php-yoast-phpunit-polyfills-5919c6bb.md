...
<!-- canonical: https://packagist.org/packages/yoast/phpunit-polyfills -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yoast/phpunit-polyfills](https://packagist.org/packages/yoast/phpunit-polyfills) |
| Source record ids | packagist_search-e48e9fa367205a |

## System Engineer Summary

Set of polyfills for changed PHPUnit functionality to allow for creating PHPUnit cross-version
compatible tests

## Operational Role

For a systems engineer, yoast/phpunit-polyfills belongs in the PHP inventory as part of
...
- `packagist_search-e48e9fa367205a` from `packagist_search` as `registry_expansion`
