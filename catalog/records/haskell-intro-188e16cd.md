...
<!-- canonical: https://hackage.haskell.org/package/intro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/intro](https://hackage.haskell.org/package/intro) |
| Source record ids | hackage_top_downloads-535f3753874e0f |
...
For a systems engineer, intro belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.0 | 2020-08-28T12:01:20Z | [https://hackage.haskell.org/package/intro](https://hackage.haskell.org/package/intro) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/intro` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-535f3753874e0f` from `hackage_top_downloads` as `registry_expansion`
