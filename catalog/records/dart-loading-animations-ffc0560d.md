...
<!-- canonical: https://pub.dev/packages/loading_animations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/loading_animations](https://pub.dev/packages/loading_animations) |
| Source record ids | pub_dev-11561ada2b42ee |
...
For a systems engineer, loading_animations belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2021-03-09T18:16:45.595868Z | [https://pub.dev/api/packages/loading_animations](https://pub.dev/api/packages/loading_animations) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/loading_animations` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-11561ada2b42ee` from `pub_dev` as `registry_expansion`
