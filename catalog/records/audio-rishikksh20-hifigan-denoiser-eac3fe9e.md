...
<!-- canonical: https://github.com/rishikksh20/hifigan-denoiser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rishikksh20/hifigan-denoiser](https://github.com/rishikksh20/hifigan-denoiser) |
| Source record ids | github_search_audio-9673d499eea210 |

## System Engineer Summary

HiFi-GAN: High Fidelity Denoising and Dereverberation Based on Speech Deep Features in Adversarial
Networks

## Operational Role

For a systems engineer, rishikksh20/hifigan-denoiser belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-08T12:09:35Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-9673d499eea210` from `github_search_audio` as `registry_expansion`
