...
<!-- canonical: https://cran.r-project.org/web/packages/urbstatdata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/urbstatdata/index.html](https://cran.r-project.org/web/packages/urbstatdata/index.html) |
| Source record ids | cran_packages_by_date-d068fc18fa416e |

## System Engineer Summary

Seven Data Sets for Urban and Built-Environment Statistics

## Operational Role

For a systems engineer, urbstatdata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-01 08:50:02 UTC | [https://cran.r-project.org/web/packages/urbstatdata/DESCRIPTION](https://cran.r-project.org/web/packages/urbstatdata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/urbstatdata/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-d068fc18fa416e` from `cran_packages_by_date` as `registry_expansion`
