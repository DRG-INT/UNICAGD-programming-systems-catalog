# pomirleanu/PHP-5-Zend-study-guide-2ndEd
...
<!-- canonical: https://github.com/pomirleanu/PHP-5-Zend-study-guide-2ndEd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pomirleanu/PHP-5-Zend-study-guide-2ndEd](https://github.com/pomirleanu/PHP-5-Zend-study-guide-2ndEd) |
| Source record ids | github_search_magazines-a9ef86112493f3 |

## System Engineer Summary

Zend's new PHP 5 Certification Exam represent an excellent tool for professional PHP developers who
want to distinguish themselves in their field. php|architect's Zend PHP 5 Certification Study Guide,
edited and produced by the publishers of php|architect magazine, provides the most comprehensive and
thorough preparation tool for developers who wish to take the exam. This book provides complete
coverage of every topic that is part of the exam, including: ? PHP Basics ? Functions ? Arrays ?
Strings and Patterns ? Web Programming ? Object Oriented Programming ? Database Programming ?
Object-oriented Design ? XML and Web Services ? Security ? Streams and Network Programming ?
Differences Between PHP 4 and 5 Written by PHP professionals and Zend Certified PHP 5 Engineers
Davey Shafik and Ben Ramsey, and reviewed by core PHP developer Derick Rethans, this is the perfect
book for every prospective Zend Certified PHP Engineer candidate!

## Operational Role

For a systems engineer, pomirleanu/PHP-5-Zend-study-guide-2ndEd belongs in the Magazines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-07-10T06:07:41Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-a9ef86112493f3` from `github_search_magazines` as `registry_expansion`
