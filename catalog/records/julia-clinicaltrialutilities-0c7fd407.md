...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClinicalTrialUtilities](https://github.com/JuliaRegistries/General/tree/master/C/ClinicalTrialUtilities) |
| Source record ids | julia_general-bf615d094953b9 |

## System Engineer Summary

Julia package registered in General at C/ClinicalTrialUtilities.

## Operational Role

For a systems engineer, ClinicalTrialUtilities belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClinicalTrialUtilities", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-bf615d094953b9` from `julia_general` as `registry_expansion`
