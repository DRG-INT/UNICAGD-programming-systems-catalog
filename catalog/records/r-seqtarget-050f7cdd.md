...
<!-- canonical: https://cran.r-project.org/web/packages/SEQTaRget/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SEQTaRget/index.html](https://cran.r-project.org/web/packages/SEQTaRget/index.html) |
| Source record ids | cran_packages_by_date-15a62159903cbf |
...
For a systems engineer, SEQTaRget belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.4 | 2026-08-28 07:50:02 UTC | [https://cran.r-project.org/web/packages/SEQTaRget/DESCRIPTION](https://cran.r-project.org/web/packages/SEQTaRget/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SEQTaRget/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-15a62159903cbf` from `cran_packages_by_date` as `registry_expansion`
