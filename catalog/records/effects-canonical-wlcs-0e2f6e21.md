...
<!-- canonical: https://github.com/canonical/wlcs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/canonical/wlcs](https://github.com/canonical/wlcs) |
| Source record ids | github_search_effects-1698fc3aec061d |
...
For a systems engineer, canonical/wlcs belongs in the Effects inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T23:52:14Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1698fc3aec061d` from `github_search_effects` as `registry_expansion`
