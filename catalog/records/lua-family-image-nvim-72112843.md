...
| Canonical URL | [https://luarocks.org/modules/3rd/image.nvim](https://luarocks.org/modules/3rd/image.nvim) |
| Source record ids | luarocks_root_manifest-1b425ca256d5ce |
...
For a systems engineer, image.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1b425ca256d5ce` from `luarocks_root_manifest` as `registry_expansion`
