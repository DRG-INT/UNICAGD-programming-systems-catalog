...
<!-- canonical: https://packagist.org/packages/pear/console_getopt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pear/console_getopt](https://packagist.org/packages/pear/console_getopt) |
| Source record ids | packagist_search-babc748deb6fbc |

## System Engineer Summary

pear/console_getopt is tracked as a networking http record in the PHP branch. The source did not
...
For a systems engineer, pear/console_getopt belongs in the PHP inventory as part of service
...
- `packagist_search-babc748deb6fbc` from `packagist_search` as `registry_expansion`
