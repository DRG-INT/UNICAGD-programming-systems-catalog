...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/marshuang80/cell-segmentation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marshuang80/cell-segmentation](https://github.com/marshuang80/cell-segmentation) |
| Source record ids | github_search_microscopy-4d01fde52dafbf |
...
For a systems engineer, marshuang80/cell-segmentation belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-27T22:00:21Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_microscopy-4d01fde52dafbf` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| EliHei2/segger_dev | Networking Http | [open](microscopy-elihei2-segger-dev-5e470160.md) |
| kdha0727/cancer-instance-segmentation-from-tissue | Networking Http | [open](microscopy-kdha0727-cancer-instance-segmentation-from-tissue-932ff299.md) |
| nadeemlab/DeepLIIF | Networking Http | [open](microscopy-nadeemlab-deepliif-f336f8fd.md) |
| peterhpark/neuroclear | Networking Http | [open](microscopy-peterhpark-neuroclear-7179bfb8.md) |
