...
<!-- canonical: https://hackage.haskell.org/package/hasql-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hasql-postgres](https://hackage.haskell.org/package/hasql-postgres) |
| Source record ids | hackage_top_downloads-34a3d8b9785d7b |
...
For a systems engineer, hasql-postgres belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.6 | 2015-09-21T03:28:44Z | [https://hackage.haskell.org/package/hasql-postgres](https://hackage.haskell.org/package/hasql-postgres) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hasql-postgres` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-34a3d8b9785d7b` from `hackage_top_downloads` as `registry_expansion`
