...
<!-- canonical: https://cran.r-project.org/web/packages/freegroup/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/freegroup/index.html](https://cran.r-project.org/web/packages/freegroup/index.html) |
| Source record ids | cran_packages_by_date-0875c9abccc071 |

## System Engineer Summary

freegroup is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, freegroup belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2-1-1 | 2026-08-21 21:50:02 UTC | [https://cran.r-project.org/web/packages/freegroup/DESCRIPTION](https://cran.r-project.org/web/packages/freegroup/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/freegroup/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0875c9abccc071` from `cran_packages_by_date` as `registry_expansion`
