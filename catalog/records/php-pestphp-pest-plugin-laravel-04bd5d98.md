...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-laravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-laravel](https://packagist.org/packages/pestphp/pest-plugin-laravel) |
| Source record ids | packagist_search-fd5be182b15ed5 |

## System Engineer Summary

pestphp/pest-plugin-laravel is tracked as a testing framework record in the PHP branch. The source
...
For a systems engineer, pestphp/pest-plugin-laravel belongs in the PHP inventory as part of
...
- `packagist_search-fd5be182b15ed5` from `packagist_search` as `registry_expansion`
