...
<!-- canonical: https://github.com/joelpurra/xmouse-controls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joelpurra/xmouse-controls](https://github.com/joelpurra/xmouse-controls) |
| Source record ids | github_search_catalogs-c6da8f1dc99394 |

## System Engineer Summary

Microsoft Windows utility to manage the active window tracking/raising settings. This is known as
x-mouse behavior or focus follows mouse on Unix and Linux systems.

## Operational Role

For a systems engineer, joelpurra/xmouse-controls belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-25T11:46:20Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c6da8f1dc99394` from `github_search_catalogs` as `registry_expansion`
