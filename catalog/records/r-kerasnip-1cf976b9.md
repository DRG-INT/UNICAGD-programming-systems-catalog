...
<!-- canonical: https://cran.r-project.org/web/packages/kerasnip/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kerasnip/index.html](https://cran.r-project.org/web/packages/kerasnip/index.html) |
| Source record ids | cran_packages_by_date-cd2440af98fea1 |
...
For a systems engineer, kerasnip belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-03 17:20:02 UTC | [https://cran.r-project.org/web/packages/kerasnip/DESCRIPTION](https://cran.r-project.org/web/packages/kerasnip/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kerasnip/DESCRIPTION` at `2026-09-03T18:23:06+00:00`.
...
- `cran_packages_by_date-cd2440af98fea1` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| arcgisutils | Interop Bindings | [open](r-arcgisutils-9c834bfb.md) |
