...
<!-- canonical: https://pub.dev/packages/local_auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/local_auth](https://pub.dev/packages/local_auth) |
| Source record ids | pub_dev-0022a83b7692b1 |
...
For a systems engineer, local_auth belongs in the Dart inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.2 | 2026-07-09T14:20:36.444883Z | [https://pub.dev/api/packages/local_auth](https://pub.dev/api/packages/local_auth) |  |
| preview | known | 1.1.0-nullsafety | 2021-01-15T05:31:31.828668Z | [https://pub.dev/api/packages/local_auth](https://pub.dev/api/packages/local_auth) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/local_auth` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-0022a83b7692b1` from `pub_dev` as `registry_expansion`
