...
| Source record ids | curated_language_routes-bf03d5ea7be480 |

## System Engineer Summary

Image I/O library and command-line tools for photo/image formats, metadata, conversion, and
inspection.

## Operational Role

For a systems engineer, OpenImageIO belongs in the Photography inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/AcademySoftwareFoundation/OpenImageIO/releases/latest` at `2026-09-01T07:24:45+00:00`.
...
- `curated_language_routes-bf03d5ea7be480` from `curated_language_routes` as `registry_expansion`
