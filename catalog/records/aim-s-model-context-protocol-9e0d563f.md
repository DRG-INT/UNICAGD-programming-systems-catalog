...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: "aim's"](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/aim-s.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://modelcontextprotocol.io/](https://modelcontextprotocol.io/) |
| Source record ids | curated_language_routes-80220b86b56bd7 |

## System Engineer Summary

Protocol route for connecting AI applications to tools, resources, prompts, and external systems.

## Operational Role

For a systems engineer, Model Context Protocol belongs in the "aim's" inventory as part of service
...
- `curated_language_routes-80220b86b56bd7` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| OpenAI API | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-openai-api-2f1d86e4.md) |
