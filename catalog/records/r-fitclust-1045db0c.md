...
<!-- canonical: https://cran.r-project.org/web/packages/FITclust/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FITclust/index.html](https://cran.r-project.org/web/packages/FITclust/index.html) |
| Source record ids | cran_packages_by_date-6588062f69ef54 |
...
For a systems engineer, FITclust belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-21 13:40:48 UTC | [https://cran.r-project.org/web/packages/FITclust/DESCRIPTION](https://cran.r-project.org/web/packages/FITclust/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FITclust/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6588062f69ef54` from `cran_packages_by_date` as `registry_expansion`
