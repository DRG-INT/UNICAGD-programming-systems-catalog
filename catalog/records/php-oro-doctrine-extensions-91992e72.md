...
<!-- canonical: https://packagist.org/packages/oro/doctrine-extensions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/oro/doctrine-extensions](https://packagist.org/packages/oro/doctrine-extensions) |
| Source record ids | packagist_search-6349f3aa284bfa |
...
For a systems engineer, oro/doctrine-extensions belongs in the PHP inventory as part of state
...
- `packagist_search-6349f3aa284bfa` from `packagist_search` as `registry_expansion`
