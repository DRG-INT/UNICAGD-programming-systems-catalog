...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/import_process.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/import_process.html](https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/import_process.html) |
| Source record ids | curated_language_routes-131de8267c74c8 |

## System Engineer Summary

Godot asset import pipeline for source assets, imported resources, metadata, and runtime-ready
files.

## Operational Role

For a systems engineer, Godot Import Process belongs in the Assets inventory as part of operator
...
- `curated_language_routes-131de8267c74c8` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| agit8or1/clientst0r | Documentation | [open](assets-agit8or1-clientst0r-68b602b6.md) |
| varchashva/LetsMapYourNetwork | Documentation | [open](assets-varchashva-letsmapyournetwork-17553d39.md) |
