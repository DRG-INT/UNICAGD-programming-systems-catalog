...
<!-- canonical: https://github.com/slashsbin/styleguide-git-commit-message -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/slashsbin/styleguide-git-commit-message](https://github.com/slashsbin/styleguide-git-commit-message) |
| Source record ids | github_search_icons_and_logos-4e484b9005cf48 |
...
For a systems engineer, slashsbin/styleguide-git-commit-message belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-29T07:10:31Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-4e484b9005cf48` from `github_search_icons_and_logos` as `registry_expansion`
