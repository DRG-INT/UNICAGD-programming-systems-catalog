...
<!-- canonical: https://github.com/ms-studio/karmilla -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ms-studio/karmilla](https://github.com/ms-studio/karmilla) |
| Source record ids | github_search_font_briefcase-712497eb3f92d1 |

## System Engineer Summary

An expanded version of the amazing Karla webfont, adding support for various languages (French,
German, Norse, Hungarian, Latvian, Icelandic...)

## Operational Role

For a systems engineer, ms-studio/karmilla belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:25:53Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-712497eb3f92d1` from `github_search_font_briefcase` as `registry_expansion`
