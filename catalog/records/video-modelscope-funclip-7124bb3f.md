...
<!-- canonical: https://github.com/modelscope/FunClip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/modelscope/FunClip](https://github.com/modelscope/FunClip) |
| Source record ids | github_search_video-f99762d494e65e |

## System Engineer Summary

FunASR-powered video transcription, subtitle generation, and LLM-assisted clipping tool with a local
Gradio UI.

## Operational Role

For a systems engineer, modelscope/FunClip belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T12:36:13Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_video-f99762d494e65e` from `github_search_video` as `registry_expansion`
