# xianglinyang/DeepVisualInsight
...
<!-- canonical: https://github.com/xianglinyang/DeepVisualInsight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xianglinyang/DeepVisualInsight](https://github.com/xianglinyang/DeepVisualInsight) |
| Source record ids | github_search_space_maps-94a1798e78015f |

## System Engineer Summary

DeepVisualInsight (DVI) is a time-travelling visualization solution for how the classification
boundaries of a learned model is trained in two-dimensional space.

## Operational Role

For a systems engineer, xianglinyang/DeepVisualInsight belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-06T07:01:46Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-94a1798e78015f` from `github_search_space_maps` as `registry_expansion`
