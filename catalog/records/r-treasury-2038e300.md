...
<!-- canonical: https://cran.r-project.org/web/packages/treasury/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/treasury/index.html](https://cran.r-project.org/web/packages/treasury/index.html) |
| Source record ids | cran_packages_by_date-238ffacaa61a1d |
...
For a systems engineer, treasury belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-22 15:10:02 UTC | [https://cran.r-project.org/web/packages/treasury/DESCRIPTION](https://cran.r-project.org/web/packages/treasury/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/treasury/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-238ffacaa61a1d` from `cran_packages_by_date` as `registry_expansion`
