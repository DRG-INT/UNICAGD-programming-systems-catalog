...
<!-- canonical: https://cran.r-project.org/web/packages/lvmPlot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lvmPlot/index.html](https://cran.r-project.org/web/packages/lvmPlot/index.html) |
| Source record ids | cran_packages_by_date-ab701eb8f09409 |

## System Engineer Summary

Publication-Quality Diagrams for Latent Variable Models

## Operational Role

For a systems engineer, lvmPlot belongs in the R inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-08 13:50:02 UTC | [https://cran.r-project.org/web/packages/lvmPlot/DESCRIPTION](https://cran.r-project.org/web/packages/lvmPlot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lvmPlot/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-ab701eb8f09409` from `cran_packages_by_date` as `registry_expansion`
...
| twinsvm | Interpreter Runtime | [open](r-twinsvm-06192759.md) |
