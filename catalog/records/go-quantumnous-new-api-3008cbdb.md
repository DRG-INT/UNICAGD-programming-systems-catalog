...
<!-- canonical: https://github.com/QuantumNous/new-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/QuantumNous/new-api](https://github.com/QuantumNous/new-api) |
| Source record ids | github_search_go-75e8508e0fcfe4 |

## System Engineer Summary

A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs
into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats. A centralized gateway for
personal and enterprise model management.

## Operational Role

For a systems engineer, QuantumNous/new-api belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T06:37:57Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-75e8508e0fcfe4` from `github_search_go` as `registry_expansion`
