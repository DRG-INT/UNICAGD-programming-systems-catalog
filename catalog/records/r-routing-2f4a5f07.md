...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/routing/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/routing/index.html](https://cran.r-project.org/web/packages/routing/index.html) |
| Source record ids | cran_packages_by_date-d088094849788c |

## System Engineer Summary

'Express.js' Like Routing for R Web Frameworks

## Operational Role

For a systems engineer, routing belongs in the R inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-04 10:00:02 UTC | [https://cran.r-project.org/web/packages/routing/DESCRIPTION](https://cran.r-project.org/web/packages/routing/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/routing/DESCRIPTION` at `2026-09-04T10:20:25+00:00`.
...
- `cran_packages_by_date-d088094849788c` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| dtangle | Web Framework | [open](r-dtangle-d15feee6.md) |
| reactRouter | Web Framework | [open](r-reactrouter-331dc40d.md) |
| Rserve | Web Framework | [open](r-rserve-caa5a1fc.md) |
| statsExpressions | Web Framework | [open](r-statsexpressions-77ded36b.md) |
