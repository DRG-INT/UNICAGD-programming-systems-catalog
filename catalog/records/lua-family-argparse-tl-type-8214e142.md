...
<!-- canonical: https://luarocks.org/modules/types/argparse-tl-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/types/argparse-tl-type](https://luarocks.org/modules/types/argparse-tl-type) |
| Source record ids | luarocks_root_manifest-35743f1a35df1c |

## System Engineer Summary

Teal type definition files for argparse

## Operational Role

For a systems engineer, argparse-tl-type belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-35743f1a35df1c` from `luarocks_root_manifest` as `registry_expansion`
