...
| Canonical URL | [https://packagist.org/packages/fpdo/fluentpdo](https://packagist.org/packages/fpdo/fluentpdo) |
| Source record ids | packagist_search-21ac9aea8a39ed |
...
For a systems engineer, fpdo/fluentpdo belongs in the PHP inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.4 | 2022-02-05T05:00:28+00:00 | [https://repo.packagist.org/p2/fpdo/fluentpdo.json](https://repo.packagist.org/p2/fpdo/fluentpdo.json) |  |
| preview | known | v2.0.0-beta2 | 2018-10-29T20:27:20+00:00 | [https://repo.packagist.org/p2/fpdo/fluentpdo.json](https://repo.packagist.org/p2/fpdo/fluentpdo.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/fpdo/fluentpdo.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-21ac9aea8a39ed` from `packagist_search` as `registry_expansion`
