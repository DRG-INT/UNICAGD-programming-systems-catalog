...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Api Abi Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/api-abi-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Api Abi Checker |
| Source type |  |
| Verification | julia_general |
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChatAPICall](https://github.com/JuliaRegistries/General/tree/master/C/ChatAPICall) |
| Source record ids | julia_general-ea9937096543d2 |

## System Engineer Summary

Julia package registered in General at C/ChatAPICall.

## Operational Role

For a systems engineer, ChatAPICall belongs in the Julia inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| ActiveMeshStabilization | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-activemeshstabilization-09d524c7.md) |
| AnnealingAPI | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-annealingapi-357d0583.md) |
| Awabi | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-awabi-68375c6e.md) |
| CatColabInterop | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-catcolabinterop-f8aadbb0.md) |
| CDSAPI | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cdsapi-f5defc73.md) |
| cif_api_jll | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cif-api-jll-28d9488f.md) |
| CitrusAPI | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-citrusapi-dac358fe.md) |
| ComputabilityTheory | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-computabilitytheory-cb147bd7.md) |
