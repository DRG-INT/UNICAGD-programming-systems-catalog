...
<!-- canonical: https://github.com/AIRCentre/SARProcessing.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AIRCentre/SARProcessing.jl](https://github.com/AIRCentre/SARProcessing.jl) |
| Source record ids | github_search_radars-2279a9c615ce45 |

## System Engineer Summary

AIRCentre/SARProcessing.jl is tracked as a machine learning record in the Radars branch. The source
...
For a systems engineer, AIRCentre/SARProcessing.jl belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-03T17:45:16Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-2279a9c615ce45` from `github_search_radars` as `registry_expansion`
