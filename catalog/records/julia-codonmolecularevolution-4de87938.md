...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CodonMolecularEvolution](https://github.com/JuliaRegistries/General/tree/master/C/CodonMolecularEvolution) |
| Source record ids | julia_general-97c0686b288de2 |

## System Engineer Summary

Julia package registered in General at C/CodonMolecularEvolution.

## Operational Role

For a systems engineer, CodonMolecularEvolution belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CodonMolecularEvolution", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-97c0686b288de2` from `julia_general` as `registry_expansion`
