...
<!-- canonical: https://github.com/Kigs-framework/kigs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kigs-framework/kigs](https://github.com/Kigs-framework/kigs) |
| Source record ids | awesome_list-75b2353871b0a7 |

## System Engineer Summary

A free and open source C++ modular multi-purpose cross platform RAD framework. MIT

## Operational Role

For a systems engineer, Kigs framework belongs in the C++23 inventory as part of service
...
- `awesome_list-75b2353871b0a7` from `awesome_list` as `registry_expansion`
