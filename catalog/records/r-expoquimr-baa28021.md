...
<!-- canonical: https://cran.r-project.org/web/packages/expoquimR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/expoquimR/index.html](https://cran.r-project.org/web/packages/expoquimR/index.html) |
| Source record ids | cran_packages_by_date-86215c26039e97 |
...
For a systems engineer, expoquimR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 07:10:07 UTC | [https://cran.r-project.org/web/packages/expoquimR/DESCRIPTION](https://cran.r-project.org/web/packages/expoquimR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/expoquimR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-86215c26039e97` from `cran_packages_by_date` as `registry_expansion`
