...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Testing Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/testing-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/cranelift-control](https://crates.io/crates/cranelift-control) |
| Source record ids | crates_io-c8170a4c697d9d |
...
For a systems engineer, cranelift-control belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.135.1 | 2026-08-24T19:58:00.061915Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| assert_cmd | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-assert-cmd-f76e4491.md) |
| bytestring | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bytestring-f2468504.md) |
| cargo-nextest | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-nextest-05dbb2fa.md) |
| expect-test | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-expect-test-95c38b84.md) |
| insta | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-insta-643e7f55.md) |
| interpolate_name | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-interpolate-name-66f63399.md) |
| is-terminal | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-is-terminal-8fe73d90.md) |
| libtest-mimic | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-libtest-mimic-6f6700d8.md) |
