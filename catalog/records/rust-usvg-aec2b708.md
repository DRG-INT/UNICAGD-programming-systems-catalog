...
| Canonical URL | [https://crates.io/crates/usvg](https://crates.io/crates/usvg) |
| Source record ids | crates_io-d57ca6801607f3 |
...
For a systems engineer, usvg belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.48.1 | 2026-08-02T14:13:55.187963Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-d57ca6801607f3` from `crates_io` as `registry_expansion`
