...
<!-- canonical: https://cran.r-project.org/web/packages/earth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/earth/index.html](https://cran.r-project.org/web/packages/earth/index.html) |
| Source record ids | cran_packages_by_date-09d25c8dd723d9 |
...
For a systems engineer, earth belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.6 | 2026-08-21 11:40:02 UTC | [https://cran.r-project.org/web/packages/earth/DESCRIPTION](https://cran.r-project.org/web/packages/earth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/earth/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-09d25c8dd723d9` from `cran_packages_by_date` as `registry_expansion`
