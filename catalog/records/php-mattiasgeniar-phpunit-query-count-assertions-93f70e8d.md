...
<!-- canonical: https://packagist.org/packages/mattiasgeniar/phpunit-query-count-assertions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mattiasgeniar/phpunit-query-count-assertions](https://packagist.org/packages/mattiasgeniar/phpunit-query-count-assertions) |
| Source record ids | packagist_search-1d06794d77e7d9 |

## System Engineer Summary

A custom assertion for phpunit that allows you to count the amount of SQL queries used in a test.
Can be used to enforce certain performance characteristics (ie: limit queries to X for a certain
action).

## Operational Role

For a systems engineer, mattiasgeniar/phpunit-query-count-assertions belongs in the PHP inventory as
...
- `packagist_search-1d06794d77e7d9` from `packagist_search` as `registry_expansion`
...
| dama/doctrine-test-bundle | Benchmarking | [open](php-dama-doctrine-test-bundle-4431d726.md) |
