...
<!-- canonical: https://cran.r-project.org/web/packages/CoxAalenCR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CoxAalenCR/index.html](https://cran.r-project.org/web/packages/CoxAalenCR/index.html) |
| Source record ids | cran_packages_by_date-4f431d1ef9f050 |

## System Engineer Summary

Additive-Multiplicative Cox-Aalen Subdistribution Hazard Model for Competing Risks

## Operational Role

For a systems engineer, CoxAalenCR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 15:20:02 UTC | [https://cran.r-project.org/web/packages/CoxAalenCR/DESCRIPTION](https://cran.r-project.org/web/packages/CoxAalenCR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CoxAalenCR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4f431d1ef9f050` from `cran_packages_by_date` as `registry_expansion`
...
| gatoRs | Undefined Behavior Analyzer | [open](r-gators-ed81d295.md) |
