...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp-buffer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp-buffer](https://luarocks.org/modules/neorocks/cmp-buffer) |
| Source record ids | luarocks_root_manifest-86ceb7ec9ebcc0 |
...
For a systems engineer, cmp-buffer belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-86ceb7ec9ebcc0` from `luarocks_root_manifest` as `registry_expansion`
