...
<!-- canonical: https://cran.r-project.org/web/packages/NSTempRFA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NSTempRFA/index.html](https://cran.r-project.org/web/packages/NSTempRFA/index.html) |
| Source record ids | cran_packages_by_date-3d0b51fe52234f |

## System Engineer Summary

Adapts the Regional Frequency Analysis to Air Temperature

## Operational Role

For a systems engineer, NSTempRFA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-06 12:50:06 UTC | [https://cran.r-project.org/web/packages/NSTempRFA/DESCRIPTION](https://cran.r-project.org/web/packages/NSTempRFA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NSTempRFA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3d0b51fe52234f` from `cran_packages_by_date` as `registry_expansion`
