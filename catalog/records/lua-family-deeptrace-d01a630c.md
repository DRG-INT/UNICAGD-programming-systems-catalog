...
<!-- canonical: https://luarocks.org/modules/raingloom/deeptrace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/raingloom/deeptrace](https://luarocks.org/modules/raingloom/deeptrace) |
| Source record ids | luarocks_root_manifest-8db75d617f2cde |
...
For a systems engineer, deeptrace belongs in the Lua family inventory as part of hot-path discovery,
...
- `luarocks_root_manifest-8db75d617f2cde` from `luarocks_root_manifest` as `registry_expansion`
