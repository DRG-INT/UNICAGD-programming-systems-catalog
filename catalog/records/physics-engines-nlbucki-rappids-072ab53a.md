...
<!-- canonical: https://github.com/nlbucki/RAPPIDS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nlbucki/RAPPIDS](https://github.com/nlbucki/RAPPIDS) |
| Source record ids | github_search_physics_engines-6d312604fff771 |

## System Engineer Summary

Rectangular Pyramid Partitioning using Integrated Depth Sensors (RAPPIDS): A Fast Planner for
Multicopter Navigation

## Operational Role

For a systems engineer, nlbucki/RAPPIDS belongs in the Physics Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-23T22:51:09Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-6d312604fff771` from `github_search_physics_engines` as `registry_expansion`
