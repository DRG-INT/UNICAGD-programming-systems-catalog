...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/astrocatalogs/supernovae -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/astrocatalogs/supernovae](https://github.com/astrocatalogs/supernovae) |
| Source record ids | github_search_catalogs-972a214cce5204 |

## System Engineer Summary

Astrocats module for the Open Supernova Catalog (OSC). Please use the issue tracker on this repo for
all OSC issues.

## Operational Role

For a systems engineer, astrocatalogs/supernovae belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-10T16:45:53Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-972a214cce5204` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| astrocatalogs/OACAPI | Parser Lexer Ast | [open](catalogs-astrocatalogs-oacapi-6f7169ea.md) |
| ekzhang/classes.wtf | Parser Lexer Ast | [open](catalogs-ekzhang-classes-wtf-8cb77037.md) |
| manimino/ducks | Parser Lexer Ast | [open](catalogs-manimino-ducks-7b913fc2.md) |
| mosuka/blast | Parser Lexer Ast | [open](catalogs-mosuka-blast-14893b6b.md) |
| mrhooray/kdtree-rs | Parser Lexer Ast | [open](catalogs-mrhooray-kdtree-rs-b09de0d4.md) |
| streamnative/pulsar-flink | Parser Lexer Ast | [open](catalogs-streamnative-pulsar-flink-cd3e9bb2.md) |
| valeriansaliou/node-sonic-channel | Parser Lexer Ast | [open](catalogs-valeriansaliou-node-sonic-channel-feef3388.md) |
| valeriansaliou/sonic | Parser Lexer Ast | [open](catalogs-valeriansaliou-sonic-140efc5d.md) |
