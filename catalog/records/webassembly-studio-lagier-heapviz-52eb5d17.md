...
<!-- canonical: https://github.com/studio-lagier/heapviz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/studio-lagier/heapviz](https://github.com/studio-lagier/heapviz) |
| Source record ids | github_search_webassembly-ea0d3fc28c7214 |
...
For a systems engineer, studio-lagier/heapviz belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-ea0d3fc28c7214` from `github_search_webassembly` as `registry_expansion`
...
| ruvnet/RuVector | Memory Analyzer | [open](webassembly-ruvnet-ruvector-92764a9f.md) |
