...
<!-- canonical: https://pub.dev/packages/flutter_linkify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_linkify](https://pub.dev/packages/flutter_linkify) |
| Source record ids | pub_dev-6bd3f618df91ed |
...
For a systems engineer, flutter_linkify belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2023-05-15T23:26:20.808993Z | [https://pub.dev/api/packages/flutter_linkify](https://pub.dev/api/packages/flutter_linkify) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_linkify` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-6bd3f618df91ed` from `pub_dev` as `registry_expansion`
