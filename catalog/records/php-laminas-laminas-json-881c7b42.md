...
<!-- canonical: https://packagist.org/packages/laminas/laminas-json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laminas/laminas-json](https://packagist.org/packages/laminas/laminas-json) |
| Source record ids | packagist_search-ad67df00438e4e |
...
For a systems engineer, laminas/laminas-json belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-ad67df00438e4e` from `packagist_search` as `registry_expansion`
