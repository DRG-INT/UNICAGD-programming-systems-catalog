...
<!-- canonical: https://crates.io/crates/icu_properties -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_properties](https://crates.io/crates/icu_properties) |
| Source record ids | crates_io-b79a6fad843a57 |
...
For a systems engineer, icu_properties belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-13T23:28:46.255153Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-b79a6fad843a57` from `crates_io` as `registry_expansion`
