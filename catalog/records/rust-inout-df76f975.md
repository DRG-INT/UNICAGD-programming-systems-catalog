...
<!-- canonical: https://crates.io/crates/inout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/inout](https://crates.io/crates/inout) |
| Source record ids | crates_io-1aabd27abae9d8 |
...
For a systems engineer, inout belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-02-06T17:21:49.007391Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-1aabd27abae9d8` from `crates_io` as `registry_expansion`
