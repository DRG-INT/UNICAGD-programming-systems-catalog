...
<!-- canonical: https://github.com/simon3dv/SLR-SFS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/simon3dv/SLR-SFS](https://github.com/simon3dv/SLR-SFS) |
| Source record ids | github_search_physics_engines-2913fc8edcbcd9 |
...
For a systems engineer, simon3dv/SLR-SFS belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-04T03:35:23Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-2913fc8edcbcd9` from `github_search_physics_engines` as `registry_expansion`
