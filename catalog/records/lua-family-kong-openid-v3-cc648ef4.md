...
| Canonical URL | [https://luarocks.org/modules/ricristan/kong-openid-v3](https://luarocks.org/modules/ricristan/kong-openid-v3) |
| Source record ids | luarocks_root_manifest-b8d2e214ce89eb |
...
For a systems engineer, kong-openid-v3 belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b8d2e214ce89eb` from `luarocks_root_manifest` as `registry_expansion`
