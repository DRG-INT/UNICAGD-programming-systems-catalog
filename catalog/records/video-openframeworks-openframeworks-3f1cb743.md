...
| Source record ids | github_search_video-62cd947e7667cc |
...
For a systems engineer, openframeworks/openFrameworks belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T15:16:59Z | gh search repos topic:video stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3 \| file LICENSE; Other |
...
- `github_search_video-62cd947e7667cc` from `github_search_video` as `registry_expansion`
