...
<!-- canonical: https://cran.r-project.org/web/packages/couplr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/couplr/index.html](https://cran.r-project.org/web/packages/couplr/index.html) |
| Source record ids | cran_packages_by_date-8e1411dce13312 |
...
For a systems engineer, couplr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.1 | 2026-08-23 00:20:02 UTC | [https://cran.r-project.org/web/packages/couplr/DESCRIPTION](https://cran.r-project.org/web/packages/couplr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/couplr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8e1411dce13312` from `cran_packages_by_date` as `registry_expansion`
