...
<!-- canonical: https://crates.io/crates/bs58 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bs58](https://crates.io/crates/bs58) |
| Source record ids | crates_io-82c1d530b931c5 |
...
For a systems engineer, bs58 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2024-03-19T12:50:23.529199Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-82c1d530b931c5` from `crates_io` as `registry_expansion`
