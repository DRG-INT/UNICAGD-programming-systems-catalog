# techcareer/techcareer_middle_devops
...
<!-- canonical: https://gitlab.com/techcareer/techcareer_middle_devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/techcareer/techcareer_middle_devops](https://gitlab.com/techcareer/techcareer_middle_devops) |
| Source record ids | gitlab_projects_api-f7950f57f4f6cc |
...
For a systems engineer, techcareer/techcareer_middle_devops belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-07T10:07:00.551Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-f7950f57f4f6cc` from `gitlab_projects_api` as `registry_expansion`
