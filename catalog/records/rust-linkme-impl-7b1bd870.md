...
| Canonical URL | [https://crates.io/crates/linkme-impl](https://crates.io/crates/linkme-impl) |
| Source record ids | crates_io-cf175f1888f886 |
...
For a systems engineer, linkme-impl belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.37 | 2026-07-18T21:38:30.325120Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-cf175f1888f886` from `crates_io` as `registry_expansion`
