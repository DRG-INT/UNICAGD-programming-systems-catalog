...
<!-- canonical: https://github.com/microservices-patterns/ftgo-application -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microservices-patterns/ftgo-application](https://github.com/microservices-patterns/ftgo-application) |
| Source record ids | github_search_pattern_language-fb02c17cd54f8f |
...
For a systems engineer, microservices-patterns/ftgo-application belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-13T01:11:04Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-fb02c17cd54f8f` from `github_search_pattern_language` as `registry_expansion`
