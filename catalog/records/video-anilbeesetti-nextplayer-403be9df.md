...
<!-- canonical: https://github.com/anilbeesetti/nextplayer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anilbeesetti/nextplayer](https://github.com/anilbeesetti/nextplayer) |
| Source record ids | github_search_video-957fca1a2e66d0 |
...
For a systems engineer, anilbeesetti/nextplayer belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T08:04:05Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-957fca1a2e66d0` from `github_search_video` as `registry_expansion`
