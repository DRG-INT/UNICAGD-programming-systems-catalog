...
<!-- canonical: https://github.com/VectorLogoZone/logosearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VectorLogoZone/logosearch](https://github.com/VectorLogoZone/logosearch) |
| Source record ids | github_search_icons_and_logos-8f82f5f8e8a5cc |

## System Engineer Summary

LogoSear.ch and IconSear.ch: search through zillions of SVG logos/icons directly linked to their
source repos.

## Operational Role

For a systems engineer, VectorLogoZone/logosearch belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-27T03:19:04Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-8f82f5f8e8a5cc` from `github_search_icons_and_logos` as `registry_expansion`
