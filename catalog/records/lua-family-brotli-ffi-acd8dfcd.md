...
<!-- canonical: https://luarocks.org/modules/genessyx/brotli-ffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/genessyx/brotli-ffi](https://luarocks.org/modules/genessyx/brotli-ffi) |
| Source record ids | luarocks_root_manifest-d8f71fa784ce21 |
...
For a systems engineer, brotli-ffi belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d8f71fa784ce21` from `luarocks_root_manifest` as `registry_expansion`
