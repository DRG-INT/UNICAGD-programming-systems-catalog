...
<!-- canonical: https://github.com/kaxap/arl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kaxap/arl](https://github.com/kaxap/arl) |
| Source record ids | github_search_assembly-66780b5adbf20c |

## System Engineer Summary

lists of most popular repositories for most favoured programming languages (according to
StackOverflow)

## Operational Role

For a systems engineer, kaxap/arl belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-27T21:22:15Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-66780b5adbf20c` from `github_search_assembly` as `registry_expansion`
