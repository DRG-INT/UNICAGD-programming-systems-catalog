...
<!-- canonical: https://crates.io/crates/objc2-core-text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2-core-text](https://crates.io/crates/objc2-core-text) |
| Source record ids | crates_io-a519fc0a0e065f |
...
For a systems engineer, objc2-core-text belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T16:15:20.614374Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
