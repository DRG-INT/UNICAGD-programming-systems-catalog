...
<!-- canonical: https://cran.r-project.org/web/packages/OpenRange/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OpenRange/index.html](https://cran.r-project.org/web/packages/OpenRange/index.html) |
| Source record ids | cran_packages_by_date-901e9b10723daf |

## System Engineer Summary

Code to Access Open Access Species Range Maps

## Operational Role

For a systems engineer, OpenRange belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-08-25 07:10:02 UTC | [https://cran.r-project.org/web/packages/OpenRange/DESCRIPTION](https://cran.r-project.org/web/packages/OpenRange/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OpenRange/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-901e9b10723daf` from `cran_packages_by_date` as `registry_expansion`
