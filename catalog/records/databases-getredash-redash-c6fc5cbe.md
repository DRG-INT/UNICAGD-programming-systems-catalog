...
<!-- canonical: https://github.com/getredash/redash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/getredash/redash](https://github.com/getredash/redash) |
| Source record ids | github_search_databases-13db1a5418177f |
...
For a systems engineer, getredash/redash belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:43:52Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-13db1a5418177f` from `github_search_databases` as `registry_expansion`
