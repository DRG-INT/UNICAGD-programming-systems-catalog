...
<!-- canonical: https://hackage.haskell.org/package/antiope-contract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/antiope-contract](https://hackage.haskell.org/package/antiope-contract) |
| Source record ids | hackage_top_downloads-d5955df00a93f6 |

## System Engineer Summary

Hackage package with 130 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, antiope-contract belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.5.3 | 2020-10-22T11:56:16Z | [https://hackage.haskell.org/package/antiope-contract](https://hackage.haskell.org/package/antiope-contract) |  |
| candidate | partial | 7.0.1 |  | [https://hackage.haskell.org/package/antiope-contract](https://hackage.haskell.org/package/antiope-contract) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/antiope-contract` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-d5955df00a93f6` from `hackage_top_downloads` as `registry_expansion`
