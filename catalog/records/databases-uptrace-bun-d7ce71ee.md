...
<!-- canonical: https://github.com/uptrace/bun -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uptrace/bun](https://github.com/uptrace/bun) |
| Source record ids | github_search_databases-fb3d932907624d |

## System Engineer Summary

uptrace/bun is tracked as a profiler record in the Databases branch. The source did not provide a
...
For a systems engineer, uptrace/bun belongs in the Databases inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T14:17:15Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fb3d932907624d` from `github_search_databases` as `registry_expansion`
...
| parseablehq/parseable | Profiler | [open](databases-parseablehq-parseable-944a7af5.md) |
