...
| Canonical URL | [https://docs.gitea.com/api/](https://docs.gitea.com/api/) |
| Source record ids | curated_repository_workplace_routes-4df8cc764803e4 |

## System Engineer Summary

Official Gitea API reference for repository, organization, issue, pull request, package, and
automation operations.

## Operational Role

For a systems engineer, Gitea API belongs in the Repository Workplaces inventory as part of operator
...
- `curated_repository_workplace_routes-4df8cc764803e4` from `curated_repository_workplace_routes` as `registry_expansion`
...
| R Development Page | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/repository-workplaces-r-development-page-9d04e90a.md) |
