...
<!-- canonical: https://pub.dev/packages/flutter_sticky_header -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_sticky_header](https://pub.dev/packages/flutter_sticky_header) |
| Source record ids | pub_dev-92b51d78a4648a |
...
For a systems engineer, flutter_sticky_header belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2025-05-21T09:50:44.123858Z | [https://pub.dev/api/packages/flutter_sticky_header](https://pub.dev/api/packages/flutter_sticky_header) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_sticky_header` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-92b51d78a4648a` from `pub_dev` as `registry_expansion`
