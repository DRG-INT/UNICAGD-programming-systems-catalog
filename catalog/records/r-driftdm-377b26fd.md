...
<!-- canonical: https://cran.r-project.org/web/packages/dRiftDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dRiftDM/index.html](https://cran.r-project.org/web/packages/dRiftDM/index.html) |
| Source record ids | cran_packages_by_date-5c64cd8e5fa53b |
...
For a systems engineer, dRiftDM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-23 11:00:02 UTC | [https://cran.r-project.org/web/packages/dRiftDM/DESCRIPTION](https://cran.r-project.org/web/packages/dRiftDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dRiftDM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5c64cd8e5fa53b` from `cran_packages_by_date` as `registry_expansion`
