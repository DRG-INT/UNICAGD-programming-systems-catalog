...
<!-- canonical: https://github.com/eoswindev/contract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eoswindev/contract](https://github.com/eoswindev/contract) |
| Source record ids | github_search_webassembly-23c0f0d4c19fab |

## System Engineer Summary

eoswindev/contract is tracked as a language specification record in the WebAssembly branch. The
...
For a systems engineer, eoswindev/contract belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-14T10:10:47Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-23c0f0d4c19fab` from `github_search_webassembly` as `registry_expansion`
