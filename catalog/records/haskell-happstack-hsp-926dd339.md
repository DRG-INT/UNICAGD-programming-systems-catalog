...
<!-- canonical: https://hackage.haskell.org/package/happstack-hsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/happstack-hsp](https://hackage.haskell.org/package/happstack-hsp) |
| Source record ids | hackage_top_downloads-a59efefd5b0a92 |
...
For a systems engineer, happstack-hsp belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.7.8 | 2025-09-09T02:43:53Z | [https://hackage.haskell.org/package/happstack-hsp](https://hackage.haskell.org/package/happstack-hsp) |  |
| candidate | partial | 7.3.7.4 |  | [https://hackage.haskell.org/package/happstack-hsp](https://hackage.haskell.org/package/happstack-hsp) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/happstack-hsp` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-a59efefd5b0a92` from `hackage_top_downloads` as `registry_expansion`
