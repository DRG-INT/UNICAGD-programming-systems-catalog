...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Coverage](../by-category/coverage.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/adguard-home-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adguard-home-cli/](https://pypi.org/project/adguard-home-cli/) |
| Source record ids | pypi_simple-a94d8b307ed975 |

## System Engineer Summary

Full-coverage CLI for AdGuard Home

## Operational Role

For a systems engineer, adguard-home-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-05-24T16:10:17.103119Z | [https://pypi.org/pypi/adguard-home-cli/json](https://pypi.org/pypi/adguard-home-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adguard-home-cli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-a94d8b307ed975` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| coverage.py | Coverage | [open](python-coverage-py-6650c91c.md) |
