...
<!-- canonical: https://crates.io/crates/rocksdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rocksdb](https://crates.io/crates/rocksdb) |
| Source record ids | crates_io-b2fdf72565bd5b |
...
For a systems engineer, rocksdb belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.0 | 2026-08-16T12:04:05.567337Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-12T06:23:30+00:00`.
...
- `crates_io-b2fdf72565bd5b` from `crates_io` as `registry_expansion`
