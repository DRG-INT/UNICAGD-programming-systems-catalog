...
| Source record ids | lua-source-137 |

## System Engineer Summary

lua-source-137 is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, lua-source-137 belongs in the Lua family inventory as part of ecosystem
...
| Evidence | GPL-3 \| file LICENSE; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 137}}` |
...
- `lua-source-137` from `master_json` as `source_list_item`
