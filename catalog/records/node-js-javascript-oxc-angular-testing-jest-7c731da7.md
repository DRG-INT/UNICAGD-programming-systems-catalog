...
<!-- canonical: https://www.npmjs.com/package/@oxc-angular-testing/jest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@oxc-angular-testing/jest](https://www.npmjs.com/package/@oxc-angular-testing/jest) |
| Source record ids | npm_registry-eb0365f1990dcb |

## System Engineer Summary

Jest transformer wiring up @oxc-angular-testing/transform for Angular unit tests.

## Operational Role

For a systems engineer, @oxc-angular-testing/jest belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.16-beta.1 | 2026-08-22T00:34:00.676Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-eb0365f1990dcb` from `npm_registry` as `registry_expansion`
