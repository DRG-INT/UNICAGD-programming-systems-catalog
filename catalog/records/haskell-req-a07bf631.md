...
<!-- canonical: https://hackage.haskell.org/package/req -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/req](https://hackage.haskell.org/package/req) |
| Source record ids | hackage_top_downloads-2840579aeb06a0 |
...
For a systems engineer, req belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.13.4 | 2024-09-29T19:50:09Z | [https://hackage.haskell.org/package/req](https://hackage.haskell.org/package/req) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/req` at `2026-09-01T21:21:05+00:00`.
...
- `hackage_top_downloads-2840579aeb06a0` from `hackage_top_downloads` as `registry_expansion`
