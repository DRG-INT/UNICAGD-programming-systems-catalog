...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/SerhiiStets/skylab](https://github.com/SerhiiStets/skylab) |
| Source record ids | github_search_space_engines-f575ab4fd17731 |
...
For a systems engineer, SerhiiStets/skylab belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.1 | 2023-05-10T21:52:15Z | [https://api.github.com/repos/SerhiiStets/skylab/releases/latest](https://api.github.com/repos/SerhiiStets/skylab/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SerhiiStets/skylab/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `github_search_space_engines-f575ab4fd17731` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| TheSpaceDevs/spaceflightnewsapi | Testing Framework | [open](space-engines-thespacedevs-spaceflightnewsapi-044e3573.md) |
