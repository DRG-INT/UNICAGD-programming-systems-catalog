...
<!-- canonical: https://hackage.haskell.org/package/netwire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/netwire](https://hackage.haskell.org/package/netwire) |
| Source record ids | hackage_top_downloads-c563ed42f2b306 |
...
For a systems engineer, netwire belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.3 | 2018-03-25T02:36:57Z | [https://hackage.haskell.org/package/netwire](https://hackage.haskell.org/package/netwire) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/netwire` at `2026-09-04T00:31:00+00:00`.
...
- `hackage_top_downloads-c563ed42f2b306` from `hackage_top_downloads` as `registry_expansion`
