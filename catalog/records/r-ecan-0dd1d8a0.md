...
<!-- canonical: https://cran.r-project.org/web/packages/ecan/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ecan/index.html](https://cran.r-project.org/web/packages/ecan/index.html) |
| Source record ids | cran_packages_by_date-308e34f166d0a3 |
...
For a systems engineer, ecan belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-22 09:20:14 UTC | [https://cran.r-project.org/web/packages/ecan/DESCRIPTION](https://cran.r-project.org/web/packages/ecan/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ecan/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-308e34f166d0a3` from `cran_packages_by_date` as `registry_expansion`
