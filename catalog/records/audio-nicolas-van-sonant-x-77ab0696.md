...
<!-- canonical: https://github.com/nicolas-van/sonant-x -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nicolas-van/sonant-x](https://github.com/nicolas-van/sonant-x) |
| Source record ids | github_search_audio-fe31094a87eaab |
...
For a systems engineer, nicolas-van/sonant-x belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2024-10-08T14:01:15Z | [https://api.github.com/repos/nicolas-van/sonant-x/releases/latest](https://api.github.com/repos/nicolas-van/sonant-x/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nicolas-van/sonant-x/releases/latest` at `2026-09-01T11:21:41+00:00`.
...
- `github_search_audio-fe31094a87eaab` from `github_search_audio` as `registry_expansion`
