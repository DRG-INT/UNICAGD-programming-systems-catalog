...
| Canonical URL | [https://packagist.org/packages/firebase/php-jwt](https://packagist.org/packages/firebase/php-jwt) |
| Source record ids | packagist_search-2f840bb5e3fade |

## System Engineer Summary

A simple library to encode and decode JSON Web Tokens (JWT) in PHP. Should conform to the current
spec.

## Operational Role

For a systems engineer, firebase/php-jwt belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.1.0 | 2026-06-11T17:54:29+00:00 | [https://repo.packagist.org/p2/firebase/php-jwt.json](https://repo.packagist.org/p2/firebase/php-jwt.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/firebase/php-jwt.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-2f840bb5e3fade` from `packagist_search` as `registry_expansion`
