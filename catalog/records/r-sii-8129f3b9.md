...
<!-- canonical: https://cran.r-project.org/web/packages/SII/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SII/index.html](https://cran.r-project.org/web/packages/SII/index.html) |
| Source record ids | cran_packages_by_date-bda0840f4fc841 |
...
For a systems engineer, SII belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.4 | 2026-09-12 14:30:07 UTC | [https://cran.r-project.org/web/packages/SII/DESCRIPTION](https://cran.r-project.org/web/packages/SII/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SII/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-bda0840f4fc841` from `cran_packages_by_date` as `registry_expansion`
