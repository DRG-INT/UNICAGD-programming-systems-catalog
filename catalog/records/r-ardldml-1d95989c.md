...
<!-- canonical: https://cran.r-project.org/web/packages/ardldml/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ardldml/index.html](https://cran.r-project.org/web/packages/ardldml/index.html) |
| Source record ids | cran_packages_by_date-64beffc3167882 |
...
For a systems engineer, ardldml belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 12:20:09 UTC | [https://cran.r-project.org/web/packages/ardldml/DESCRIPTION](https://cran.r-project.org/web/packages/ardldml/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ardldml/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-64beffc3167882` from `cran_packages_by_date` as `registry_expansion`
