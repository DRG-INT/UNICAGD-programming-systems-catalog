...
<!-- canonical: https://github.com/philburk/jsyn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/philburk/jsyn](https://github.com/philburk/jsyn) |
| Source record ids | github_search_audio-cb91d788be28cd |
...
For a systems engineer, philburk/jsyn belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v17.2.0 | 2025-06-29T21:59:54Z | [https://api.github.com/repos/philburk/jsyn/releases/latest](https://api.github.com/repos/philburk/jsyn/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/philburk/jsyn/releases/latest` at `2026-09-01T11:21:41+00:00`.
...
- `github_search_audio-cb91d788be28cd` from `github_search_audio` as `registry_expansion`
