...
<!-- canonical: https://cran.r-project.org/web/packages/Usmile/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Usmile/index.html](https://cran.r-project.org/web/packages/Usmile/index.html) |
| Source record ids | cran_packages_by_date-a4399d4056d81e |

## System Engineer Summary

Threshold-Free Class-Specific Comparison of Binary Classifiers

## Operational Role

For a systems engineer, Usmile belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-08 12:00:11 UTC | [https://cran.r-project.org/web/packages/Usmile/DESCRIPTION](https://cran.r-project.org/web/packages/Usmile/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Usmile/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a4399d4056d81e` from `cran_packages_by_date` as `registry_expansion`
