...
<!-- canonical: https://github.com/alexmyczko/fnt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexmyczko/fnt](https://github.com/alexmyczko/fnt) |
| Source record ids | github_search_font_briefcase-68de9f3b0d6a4c |
...
For a systems engineer, alexmyczko/fnt belongs in the Font Briefcase inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T01:12:00Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-68de9f3b0d6a4c` from `github_search_font_briefcase` as `registry_expansion`
