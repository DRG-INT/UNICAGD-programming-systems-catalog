...
<!-- canonical: https://github.com/SamsonRuan/Photo-Insight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SamsonRuan/Photo-Insight](https://github.com/SamsonRuan/Photo-Insight) |
| Source record ids | github_search_photography-436378a634cb33 |

## System Engineer Summary

A privacy-first native macOS app for locally scanning, organizing, and analyzing photo EXIF, GPS,
equipment, and shooting patterns—with customizable scan profiles.

## Operational Role

For a systems engineer, SamsonRuan/Photo-Insight belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T11:41:32Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-436378a634cb33` from `github_search_photography` as `registry_expansion`
