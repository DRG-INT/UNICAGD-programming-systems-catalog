...
| Canonical URL | [https://crates.io/crates/replace_with](https://crates.io/crates/replace_with) |
| Source record ids | crates_io-7fe847e3f9df04 |

## System Engineer Summary

Temporarily take ownership of a value at a mutable location, and replace it with a new value based
on the old one.

## Operational Role

For a systems engineer, replace_with belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2025-05-20T16:43:43.608397Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-7fe847e3f9df04` from `crates_io` as `registry_expansion`
