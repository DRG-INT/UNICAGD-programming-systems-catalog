...
| Canonical URL | [https://github.com/skyfielders/python-skyfield](https://github.com/skyfielders/python-skyfield) |
| Source record ids | curated_language_routes-31e7eebe0c81c7 |

## System Engineer Summary

Python astronomy library for positions of stars, planets, satellites, and Earth observers.

## Operational Role

For a systems engineer, Skyfield belongs in the Space Maps inventory as part of ecosystem capability
...
- `curated_language_routes-31e7eebe0c81c7` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Astropy | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-maps-astropy-004ca499.md) |
