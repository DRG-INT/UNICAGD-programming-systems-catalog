...
<!-- canonical: https://cran.r-project.org/web/packages/gpcihybridIIImpSam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpcihybridIIImpSam/index.html](https://cran.r-project.org/web/packages/gpcihybridIIImpSam/index.html) |
| Source record ids | cran_packages_by_date-a4b359527f5f2d |

## System Engineer Summary

Process Capability Indices for Hybrid Type-II Data via Importance Sampling

## Operational Role

For a systems engineer, gpcihybridIIImpSam belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 13:00:26 UTC | [https://cran.r-project.org/web/packages/gpcihybridIIImpSam/DESCRIPTION](https://cran.r-project.org/web/packages/gpcihybridIIImpSam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpcihybridIIImpSam/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a4b359527f5f2d` from `cran_packages_by_date` as `registry_expansion`
