...
| Canonical URL | [https://crates.io/crates/askama_escape](https://crates.io/crates/askama_escape) |
| Source record ids | crates_io-5be0abb80fe869 |
...
For a systems engineer, askama_escape belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-04-29T22:47:58.509990Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-5be0abb80fe869` from `crates_io` as `registry_expansion`
