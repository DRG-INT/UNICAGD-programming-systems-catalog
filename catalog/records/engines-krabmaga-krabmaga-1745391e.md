...
<!-- canonical: https://github.com/krABMaga/krABMaga -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krABMaga/krABMaga](https://github.com/krABMaga/krABMaga) |
| Source record ids | github_search_engines-d6a492b320ee1c |

## System Engineer Summary

krABMaga: A modern developing art for reliable and efficient Agent-based Model (ABM) simulation with
the Rust language

## Operational Role

For a systems engineer, krABMaga/krABMaga belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:00:02Z | gh search repos topic:simulation-engine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d6a492b320ee1c` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AmrDeveloper/GQL | Language Specification | [open](engines-amrdeveloper-gql-59536c22.md) |
