...
<!-- canonical: https://hackage.haskell.org/package/hgeometry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hgeometry](https://hackage.haskell.org/package/hgeometry) |
| Source record ids | hackage_top_downloads-e70ff03ed8f7de |
...
For a systems engineer, hgeometry belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14 | 2022-03-08T18:20:54Z | [https://hackage.haskell.org/package/hgeometry](https://hackage.haskell.org/package/hgeometry) |  |
| candidate | partial | 0.5.0.0 |  | [https://hackage.haskell.org/package/hgeometry](https://hackage.haskell.org/package/hgeometry) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hgeometry` at `2026-09-02T00:32:40+00:00`.
...
- `hackage_top_downloads-e70ff03ed8f7de` from `hackage_top_downloads` as `registry_expansion`
