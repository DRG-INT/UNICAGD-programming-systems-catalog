...
| Canonical URL | [https://crates.io/crates/cached](https://crates.io/crates/cached) |
| Source record ids | crates_io-117c991385c4e1 |
...
For a systems engineer, cached belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-08-27T00:48:26.013506Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-117c991385c4e1` from `crates_io` as `registry_expansion`
