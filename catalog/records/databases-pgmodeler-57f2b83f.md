...
| Canonical URL | [https://pgmodeler.io/](https://pgmodeler.io/) |
| Source record ids | awesome_list-d4a1eb62552f5a |
...
For a systems engineer, pgModeler belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-d4a1eb62552f5a` from `awesome_list` as `registry_expansion`
