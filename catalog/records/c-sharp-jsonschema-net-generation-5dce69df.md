...
<!-- canonical: https://www.nuget.org/packages/JsonSchema.Net.Generation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonSchema.Net.Generation](https://www.nuget.org/packages/JsonSchema.Net.Generation) |
| Source record ids | nuget_search-11a34df7adbbce |
...
For a systems engineer, JsonSchema.Net.Generation belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.11 | 2026-08-08T02:45:45.313+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net.generation/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net.generation/index.json) |  |
| preview | known | 7.1.0-beta2 | 2026-02-12T08:35:20.183+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net.generation/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net.generation/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; https://www.nuget.org/packages/JsonSchema.Net.Generation/7.3.11/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net.generation/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-11a34df7adbbce` from `nuget_search` as `registry_expansion`
