...
| Canonical URL | [https://www.npmjs.com/package/@toruslabs/openlogin-jrpc](https://www.npmjs.com/package/@toruslabs/openlogin-jrpc) |
| Source record ids | npm_registry-981bb4856fbe21 |

## System Engineer Summary

OpenLogin is a plug & play authentication suite that combines the simplicity of passwordless
authentication with the security of non-custodial public key infrastructure (PKI).

## Operational Role

For a systems engineer, @toruslabs/openlogin-jrpc belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.3.0 | 2024-08-10T03:47:01.308Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-981bb4856fbe21` from `npm_registry` as `registry_expansion`
