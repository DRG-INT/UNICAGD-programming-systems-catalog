...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/tlambert03/LLSpy](https://github.com/tlambert03/LLSpy) |
| Source record ids | github_search_microscopy-8e2baa12b85855 |
...
For a systems engineer, tlambert03/LLSpy belongs in the Microscopy inventory as part of editor
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.5.0 | 2023-12-09T14:50:27Z | [https://api.github.com/repos/tlambert03/LLSpy/releases/latest](https://api.github.com/repos/tlambert03/LLSpy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tlambert03/LLSpy/releases/latest` at `2026-09-01T11:22:11+00:00`.
...
- `github_search_microscopy-8e2baa12b85855` from `github_search_microscopy` as `registry_expansion`
