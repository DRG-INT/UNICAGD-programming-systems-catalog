...
<!-- canonical: https://cran.r-project.org/web/packages/hydrogeofetch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hydrogeofetch/index.html](https://cran.r-project.org/web/packages/hydrogeofetch/index.html) |
| Source record ids | cran_packages_by_date-a063a6acccfd3b |

## System Engineer Summary

Hydrologic Geospatial Fabric Extraction Tool Chain

## Operational Role

For a systems engineer, hydrogeofetch belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-08-28 21:50:02 UTC | [https://cran.r-project.org/web/packages/hydrogeofetch/DESCRIPTION](https://cran.r-project.org/web/packages/hydrogeofetch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hydrogeofetch/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a063a6acccfd3b` from `cran_packages_by_date` as `registry_expansion`
