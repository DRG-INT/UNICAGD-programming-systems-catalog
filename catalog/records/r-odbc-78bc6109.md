...
<!-- canonical: https://cran.r-project.org/web/packages/odbc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/odbc/index.html](https://cran.r-project.org/web/packages/odbc/index.html) |
| Source record ids | cran_packages_by_date-b61eb00eef7699 |
...
For a systems engineer, odbc belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-09-16 04:50:02 UTC | [https://cran.r-project.org/web/packages/odbc/DESCRIPTION](https://cran.r-project.org/web/packages/odbc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/odbc/DESCRIPTION` at `2026-09-16T06:26:24+00:00`.
...
- `cran_packages_by_date-b61eb00eef7699` from `cran_packages_by_date` as `registry_expansion`
