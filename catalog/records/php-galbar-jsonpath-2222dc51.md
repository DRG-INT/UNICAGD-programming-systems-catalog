...
| Canonical URL | [https://packagist.org/packages/galbar/jsonpath](https://packagist.org/packages/galbar/jsonpath) |
| Source record ids | packagist_search-aafd7639eb8410 |
...
For a systems engineer, galbar/jsonpath belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0 | 2023-03-05T19:46:27+00:00 | [https://repo.packagist.org/p2/galbar/jsonpath.json](https://repo.packagist.org/p2/galbar/jsonpath.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/galbar/jsonpath.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-aafd7639eb8410` from `packagist_search` as `registry_expansion`
