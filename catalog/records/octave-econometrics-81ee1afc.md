...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/econometrics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/econometrics](https://gnu-octave.github.io/packages/econometrics) |
| Source record ids | octave_packages_index-c3a9a5c2258bc9 |

## System Engineer Summary

econometrics is tracked as a logging observability record in the Octave branch. The source did not
...
For a systems engineer, econometrics belongs in the Octave inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2019-10-15 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-c3a9a5c2258bc9` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| psychrometrics | Logging Observability | [open](octave-psychrometrics-6ceac8f8.md) |
