...
<!-- canonical: https://github.com/GeorgePyralis/dsp-audio-fx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GeorgePyralis/dsp-audio-fx](https://github.com/GeorgePyralis/dsp-audio-fx) |
| Source record ids | github_search_effects-9c62814c837f11 |

## System Engineer Summary

Python project implementing classic DSP audio effects (Tube Distortion, WahWah, Reverb) on guitar
recordings. Includes a scalable pipeline architecture.

## Operational Role

For a systems engineer, GeorgePyralis/dsp-audio-fx belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-13T11:59:59Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9c62814c837f11` from `github_search_effects` as `registry_expansion`
