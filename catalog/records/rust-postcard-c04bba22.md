...
<!-- canonical: https://crates.io/crates/postcard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/postcard](https://crates.io/crates/postcard) |
| Source record ids | crates_io-50138271dcb8ff |
...
For a systems engineer, postcard belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3 | 2025-07-24T15:55:57.238442Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-50138271dcb8ff` from `crates_io` as `registry_expansion`
