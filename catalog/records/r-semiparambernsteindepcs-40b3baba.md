...
<!-- canonical: https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/index.html](https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/index.html) |
| Source record ids | cran_packages_by_date-56c25f20f8fa62 |
...
For a systems engineer, SemiParamBernsteinDepCS belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 10:40:07 UTC | [https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/DESCRIPTION](https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SemiParamBernsteinDepCS/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-56c25f20f8fa62` from `cran_packages_by_date` as `registry_expansion`
