...
<!-- canonical: https://cran.r-project.org/web/packages/APRScenario/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/APRScenario/index.html](https://cran.r-project.org/web/packages/APRScenario/index.html) |
| Source record ids | cran_packages_by_date-ffadadd03e82a8 |
...
For a systems engineer, APRScenario belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4.2 | 2026-08-26 08:50:17 UTC | [https://cran.r-project.org/web/packages/APRScenario/DESCRIPTION](https://cran.r-project.org/web/packages/APRScenario/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/APRScenario/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ffadadd03e82a8` from `cran_packages_by_date` as `registry_expansion`
...
| AugmentedPooledRCBD | Static Analyzer | [open](r-augmentedpooledrcbd-6f44ef88.md) |
