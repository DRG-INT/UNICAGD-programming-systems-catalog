...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Vanilagy/mediabunny -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Vanilagy/mediabunny](https://github.com/Vanilagy/mediabunny) |
| Source record ids | github_search_audio-f1068b356da6e9 |

## System Engineer Summary

Pure TypeScript media toolkit for reading, writing, and converting video and audio files, directly
in the browser.

## Operational Role

For a systems engineer, Vanilagy/mediabunny belongs in the Audio inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T10:04:05Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0 |
...
- `github_search_audio-f1068b356da6e9` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| seehiong/noteflow | Type Checker | [open](audio-seehiong-noteflow-25a87e06.md) |
