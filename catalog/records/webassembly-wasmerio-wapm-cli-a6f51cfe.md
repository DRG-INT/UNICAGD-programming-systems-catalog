...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wasmerio/wapm-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmerio/wapm-cli](https://github.com/wasmerio/wapm-cli) |
| Source record ids | github_search_webassembly-ba3e01dcbcd835 |
...
For a systems engineer, wasmerio/wapm-cli belongs in the WebAssembly inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-07T11:04:22Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ba3e01dcbcd835` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fluvio-community/fluvio | Package Manager | [open](webassembly-fluvio-community-fluvio-ea45e18f.md) |
