# 3equalspi/Basilisk-flu-dyn-sim

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/3equalspi/Basilisk-flu-dyn-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/3equalspi/Basilisk-flu-dyn-sim](https://github.com/3equalspi/Basilisk-flu-dyn-sim) |
| Source record ids | github_search_basilisk-2d7928b27a886d |

## System Engineer Summary

A C-simulation using basilisk of a dense ring falling through air, hitting water, and sinking. As it
plunges downward, it pushes water inward beneath it, launching a vertical jet upward from the center
of the surface. The ring eventually settles on the tank floor while the jet rises, breaks up, and
the water gradually returns to rest.

## Operational Role

For a systems engineer, 3equalspi/Basilisk-flu-dyn-sim belongs in the Basilisk inventory as part of
editor intelligence, refactoring assistance, diagnostics, and navigation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T16:53:21Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-2d7928b27a886d` from `github_search_basilisk` as `registry_expansion`
