...
<!-- canonical: https://github.com/cloudscape-design/components -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cloudscape-design/components](https://github.com/cloudscape-design/components) |
| Source record ids | github_search_icons_and_logos-2b2e9d1bb44325 |
...
For a systems engineer, cloudscape-design/components belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:18:38Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-2b2e9d1bb44325` from `github_search_icons_and_logos` as `registry_expansion`
