...
| Canonical URL | [https://crates.io/crates/rstar](https://crates.io/crates/rstar) |
| Source record ids | crates_io-2823bcc719a988 |
...
For a systems engineer, rstar belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-05-24T13:51:26.336790Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-2823bcc719a988` from `crates_io` as `registry_expansion`
