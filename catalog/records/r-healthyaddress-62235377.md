...
<!-- canonical: https://cran.r-project.org/web/packages/healthyAddress/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/healthyAddress/index.html](https://cran.r-project.org/web/packages/healthyAddress/index.html) |
| Source record ids | cran_packages_by_date-08b4f69b02ccc1 |
...
For a systems engineer, healthyAddress belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-08-21 06:00:18 UTC | [https://cran.r-project.org/web/packages/healthyAddress/DESCRIPTION](https://cran.r-project.org/web/packages/healthyAddress/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/healthyAddress/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-08b4f69b02ccc1` from `cran_packages_by_date` as `registry_expansion`
