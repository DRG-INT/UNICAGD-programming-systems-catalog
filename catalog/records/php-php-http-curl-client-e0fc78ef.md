...
<!-- canonical: https://packagist.org/packages/php-http/curl-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/curl-client](https://packagist.org/packages/php-http/curl-client) |
| Source record ids | packagist_search-6ad9ced1645959 |
...
For a systems engineer, php-http/curl-client belongs in the PHP inventory as part of concurrency
...
- `packagist_search-6ad9ced1645959` from `packagist_search` as `registry_expansion`
