...
<!-- canonical: https://github.com/bitmovin/bitmovin-javascript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bitmovin/bitmovin-javascript](https://github.com/bitmovin/bitmovin-javascript) |
| Source record ids | github_search_video-2852d47104b900 |

## System Engineer Summary

DEPRECATED: JavaScript client for the Bitmovin API, see

## Operational Role

For a systems engineer, bitmovin/bitmovin-javascript belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-19T10:26:41Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-2852d47104b900` from `github_search_video` as `registry_expansion`
