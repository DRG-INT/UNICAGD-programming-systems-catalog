...
| Source record ids | hackage_recent-78b98a2a69768f |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghcide` at `2026-09-04T17:20:31+00:00`.
...
- `hackage_recent-78b98a2a69768f` from `hackage_recent` as `registry_expansion`
