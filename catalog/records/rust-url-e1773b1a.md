...
<!-- canonical: https://crates.io/crates/url -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/url](https://crates.io/crates/url) |
| Source record ids | crates_io-577d3772090d21 |
...
For a systems engineer, url belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.8 | 2026-01-05T22:14:31.414927Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-577d3772090d21` from `crates_io` as `registry_expansion`
