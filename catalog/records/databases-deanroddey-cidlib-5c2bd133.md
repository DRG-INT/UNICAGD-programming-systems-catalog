...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/DeanRoddey/CIDLib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DeanRoddey/CIDLib](https://github.com/DeanRoddey/CIDLib) |
| Source record ids | github_search_databases-9bc2282240d386 |
...
For a systems engineer, DeanRoddey/CIDLib belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-06T16:40:55Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9bc2282240d386` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| noobaa/noobaa-operator | Configuration | [open](databases-noobaa-noobaa-operator-45b0f920.md) |
