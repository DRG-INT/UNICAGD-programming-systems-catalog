...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/2nd-opinion-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/2nd-opinion-cli/](https://pypi.org/project/2nd-opinion-cli/) |
| Source record ids | pypi_simple-b8e061791ca685 |

## System Engineer Summary

Second Opinion: a cross-referencing debate CLI where two frontier models debate, a cheaper judge
rules, orchestrates, and synthesizes.

## Operational Role

For a systems engineer, 2nd-opinion-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-06-17T09:53:46.210942Z | [https://pypi.org/pypi/2nd-opinion-cli/json](https://pypi.org/pypi/2nd-opinion-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/2nd-opinion-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-b8e061791ca685` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adblockparser | Lint Rule Pack | [open](python-adblockparser-27af7456.md) |
