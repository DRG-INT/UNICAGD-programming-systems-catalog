...
<!-- canonical: https://cran.r-project.org/web/packages/modsem/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modsem/index.html](https://cran.r-project.org/web/packages/modsem/index.html) |
| Source record ids | cran_packages_by_date-e2aad6b208789d |
...
For a systems engineer, modsem belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.22 | 2026-08-21 07:00:09 UTC | [https://cran.r-project.org/web/packages/modsem/DESCRIPTION](https://cran.r-project.org/web/packages/modsem/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modsem/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e2aad6b208789d` from `cran_packages_by_date` as `registry_expansion`
