...
| Canonical URL | [https://github.com/shenmintao/Raw-Alchemy](https://github.com/shenmintao/Raw-Alchemy) |
| Source record ids | github_search_photography-0f2ee7ece3b209 |

## System Engineer Summary

Bridge the gap between photo and video color grading. Accurately apply any creative LUT to your RAW
files with this tool.

## Operational Role

For a systems engineer, shenmintao/Raw-Alchemy belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | studio-v0.5.0 | 2026-02-10T04:17:49Z | [https://api.github.com/repos/shenmintao/Raw-Alchemy/releases/latest](https://api.github.com/repos/shenmintao/Raw-Alchemy/releases/latest) |  |
| preview | known | studio-v0.6.0-pre7 | 2026-07-13T08:15:42Z | [https://api.github.com/repos/shenmintao/Raw-Alchemy/releases?per_page=10](https://api.github.com/repos/shenmintao/Raw-Alchemy/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/shenmintao/Raw-Alchemy/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-0f2ee7ece3b209` from `github_search_photography` as `registry_expansion`
