...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/yapstudios/YapAnimator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yapstudios/YapAnimator](https://github.com/yapstudios/YapAnimator) |
| Source record ids | github_search_physics_engines-13fc048fccbcf2 |
...
For a systems engineer, yapstudios/YapAnimator belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-07T18:40:35Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-13fc048fccbcf2` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alexkid77/3dEngineOpenGL | Parser Lexer Ast | [open](physics-engines-alexkid77-3dengineopengl-f03c9545.md) |
| CaNS-World/CaNS | Parser Lexer Ast | [open](physics-engines-cans-world-cans-0bc74ac2.md) |
| chitalu/oibvh-tree | Parser Lexer Ast | [open](physics-engines-chitalu-oibvh-tree-a8c52ed1.md) |
| HiroIshida/plainmp | Parser Lexer Ast | [open](physics-engines-hiroishida-plainmp-d627112f.md) |
| JeroenGar/jagua-rs | Parser Lexer Ast | [open](physics-engines-jeroengar-jagua-rs-b1e56e5f.md) |
| kotsoft/particle_based_viscoelastic_fluid | Parser Lexer Ast | [open](physics-engines-kotsoft-particle-based-viscoelastic-fluid-6966115d.md) |
| markeasting/THREE-XPBD | Parser Lexer Ast | [open](physics-engines-markeasting-three-xpbd-a82fdf12.md) |
| mtsamis/box2d-optimized | Parser Lexer Ast | [open](physics-engines-mtsamis-box2d-optimized-fedfd3fe.md) |
