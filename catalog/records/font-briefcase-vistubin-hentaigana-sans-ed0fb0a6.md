...
<!-- canonical: https://github.com/VistuBin/hentaigana-sans -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VistuBin/hentaigana-sans](https://github.com/VistuBin/hentaigana-sans) |
| Source record ids | github_search_font_briefcase-20f665d3cd55dd |

## System Engineer Summary

A Gothic Hentaigana font

## Operational Role

For a systems engineer, VistuBin/hentaigana-sans belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-18T16:08:52Z | gh search repos topic:fontforge stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-20f665d3cd55dd` from `github_search_font_briefcase` as `registry_expansion`
