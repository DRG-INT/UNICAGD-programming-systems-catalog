...
<!-- canonical: https://crates.io/crates/hostname -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hostname](https://crates.io/crates/hostname) |
| Source record ids | crates_io-bf087d2adf17a4 |
...
For a systems engineer, hostname belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2025-11-28T19:32:27.326347Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-bf087d2adf17a4` from `crates_io` as `registry_expansion`
