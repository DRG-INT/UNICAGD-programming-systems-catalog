...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AmrDeveloper/GQL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AmrDeveloper/GQL](https://github.com/AmrDeveloper/GQL) |
| Source record ids | github_search_engines-69b97bae1a47c2 |

## System Engineer Summary

GitQL is a extensible SQL-like query language and SDK to perform queries on various data sources
such .git files with supports of most of SQL features such as grouping, ordering and aggregation and
window functions and allow customization like user-defined types and functions

## Operational Role

For a systems engineer, AmrDeveloper/GQL belongs in the Engines inventory as part of ecosystem
...
- `github_search_engines-69b97bae1a47c2` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| danielgerlag/workflow-core | Language Specification | [open](engines-danielgerlag-workflow-core-58906f6f.md) |
| dtm-labs/dtm | Language Specification | [open](engines-dtm-labs-dtm-91896a18.md) |
| expr-lang/expr | Language Specification | [open](engines-expr-lang-expr-9f2f81f6.md) |
| krABMaga/krABMaga | Language Specification | [open](engines-krabmaga-krabmaga-1745391e.md) |
| master-co/css | Language Specification | [open](engines-master-co-css-daa9361b.md) |
| openkraken/kraken | Language Specification | [open](engines-openkraken-kraken-3bf4b456.md) |
