...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Engines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-engines.md) · [Category: Math Numeric Scientific](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/math-numeric-scientific.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://gitlab.orekit.org/orekit/orekit](https://gitlab.orekit.org/orekit/orekit) |
| Source record ids | curated_language_routes-44f2a7d719a042 |

## System Engineer Summary

Astrodynamics library for orbit propagation, estimation, frames, time scales, maneuvers, and mission
analysis.

## Operational Role

For a systems engineer, Orekit belongs in the Space Engines inventory as part of ecosystem
...
- `curated_language_routes-44f2a7d719a042` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Cantera | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-cantera-2ade34ed.md) |
| NASA CEA | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-nasa-cea-f1c0cc44.md) |
| NASA General Mission Analysis Tool | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-nasa-general-mission-analysis-tool-d7cd2ddf.md) |
| OpenRocket | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-openrocket-13460a76.md) |
| poliastro | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-poliastro-c31fd472.md) |
| RocketCEA | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-rocketcea-3fdfcc70.md) |
| SPICE Toolkit | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-spice-toolkit-0305bdf8.md) |
| Tudat | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-engines-tudat-4d50fb8b.md) |
