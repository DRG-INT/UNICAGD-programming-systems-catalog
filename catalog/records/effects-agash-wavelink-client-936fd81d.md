# Agash/WaveLink.Client

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Agash/WaveLink.Client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Agash/WaveLink.Client](https://github.com/Agash/WaveLink.Client) |
| Source record ids | github_search_effects-8c366207381b9e |

## System Engineer Summary

modern, AOT ready net10 client for the Elgato Wave Link 3 local WebSocket JSON-RPC. Control audio
inputs, outputs, hardware DSP effects, and consume real-time audio meters via IAsyncEnumerable and
Events

## Operational Role

For a systems engineer, Agash/WaveLink.Client belongs in the Effects inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T09:53:57Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8c366207381b9e` from `github_search_effects` as `registry_expansion`
