...
<!-- canonical: https://pub.dev/packages/loading_indicator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/loading_indicator](https://pub.dev/packages/loading_indicator) |
| Source record ids | pub_dev-9d5a43ec69906b |
...
For a systems engineer, loading_indicator belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2026-08-30T13:26:57.334044Z | [https://pub.dev/api/packages/loading_indicator](https://pub.dev/api/packages/loading_indicator) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/loading_indicator` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-9d5a43ec69906b` from `pub_dev` as `registry_expansion`
