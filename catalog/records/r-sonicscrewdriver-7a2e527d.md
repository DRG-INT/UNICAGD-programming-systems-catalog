...
<!-- canonical: https://cran.r-project.org/web/packages/sonicscrewdriver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sonicscrewdriver/index.html](https://cran.r-project.org/web/packages/sonicscrewdriver/index.html) |
| Source record ids | cran_packages_by_date-42f00e1e3bf1a2 |
...
For a systems engineer, sonicscrewdriver belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7.1 | 2026-08-21 09:20:08 UTC | [https://cran.r-project.org/web/packages/sonicscrewdriver/DESCRIPTION](https://cran.r-project.org/web/packages/sonicscrewdriver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sonicscrewdriver/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-42f00e1e3bf1a2` from `cran_packages_by_date` as `registry_expansion`
