...
<!-- canonical: https://crates.io/crates/rust_decimal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rust_decimal](https://crates.io/crates/rust_decimal) |
| Source record ids | crates_io-d16ae55a88c4e0 |

## System Engineer Summary

Decimal number implementation written in pure Rust suitable for financial and fixed-precision
calculations.

## Operational Role

For a systems engineer, rust_decimal belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.43.0 | 2026-09-02T00:43:11.457502Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-02T02:32:53+00:00`.
...
- `crates_io-d16ae55a88c4e0` from `crates_io` as `registry_expansion`
