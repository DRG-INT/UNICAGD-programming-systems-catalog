...
<!-- canonical: https://github.com/NixOS/nix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NixOS/nix](https://github.com/NixOS/nix) |
| Source record ids | curated_language_routes-58e0b5843f39b5 |

## System Engineer Summary

Official Nix package manager and language implementation source repository.

## Operational Role

For a systems engineer, Nix Source Route belongs in the nix inventory as part of ecosystem
...
- `curated_language_routes-58e0b5843f39b5` from `curated_language_routes` as `registry_expansion`
