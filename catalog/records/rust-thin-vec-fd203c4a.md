...
| Canonical URL | [https://crates.io/crates/thin-vec](https://crates.io/crates/thin-vec) |
| Source record ids | crates_io-794ea6c2307acc |
...
For a systems engineer, thin-vec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.19 | 2026-07-26T12:35:38.368918Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-794ea6c2307acc` from `crates_io` as `registry_expansion`
