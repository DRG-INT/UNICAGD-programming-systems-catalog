# ngalog-gitlab/openapi_security_scanner
...
<!-- canonical: https://gitlab.com/ngalog-gitlab/openapi_security_scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/ngalog-gitlab/openapi_security_scanner](https://gitlab.com/ngalog-gitlab/openapi_security_scanner) |
| Source record ids | gitlab_projects_api-46324f0700e138 |
...
For a systems engineer, ngalog-gitlab/openapi_security_scanner belongs in the Repository Workplaces
...
- `gitlab_projects_api-46324f0700e138` from `gitlab_projects_api` as `registry_expansion`
