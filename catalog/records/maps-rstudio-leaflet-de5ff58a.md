...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Fuzzer](../by-category/fuzzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rstudio/leaflet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rstudio/leaflet](https://github.com/rstudio/leaflet) |
| Source record ids | github_search_maps-daa7eae937ca15 |
...
For a systems engineer, rstudio/leaflet belongs in the Maps inventory as part of input-space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-08T20:50:29Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-daa7eae937ca15` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| banesullivan/localtileserver | Fuzzer | [open](maps-banesullivan-localtileserver-66c265a9.md) |
| emikhalev/leaflet-2gis | Fuzzer | [open](maps-emikhalev-leaflet-2gis-256a4bf3.md) |
| Esri/esri-leaflet-geocoder | Fuzzer | [open](maps-esri-esri-leaflet-geocoder-90d234ea.md) |
| fleaflet/flutter_map | Fuzzer | [open](maps-fleaflet-flutter-map-860f9704.md) |
| geoman-io/leaflet-geoman | Fuzzer | [open](maps-geoman-io-leaflet-geoman-fd699ba4.md) |
| geosolutions-it/MapStore2 | Fuzzer | [open](maps-geosolutions-it-mapstore2-b03f8e67.md) |
| GeoTIFF/georaster-layer-for-leaflet | Fuzzer | [open](maps-geotiff-georaster-layer-for-leaflet-de078a6e.md) |
| humangeo/leaflet-dvf | Fuzzer | [open](maps-humangeo-leaflet-dvf-f9b85b0b.md) |
