...
<!-- canonical: https://github.com/johnpolacek/styled-starter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/johnpolacek/styled-starter](https://github.com/johnpolacek/styled-starter) |
| Source record ids | github_search_space_maps-d7e86236ffb32a |

## System Engineer Summary

Starter Kit with React, Next.js, Styled System and Catalog to get projects going with a design
theme, built-in styleguide and browser testing

## Operational Role

For a systems engineer, johnpolacek/styled-starter belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-09-02T13:46:29Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d7e86236ffb32a` from `github_search_space_maps` as `registry_expansion`
