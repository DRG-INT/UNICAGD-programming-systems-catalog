...
<!-- canonical: https://hackage.haskell.org/package/baikai-claude -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai-claude](https://hackage.haskell.org/package/baikai-claude) |
| Source record ids | hackage_recent-fcb8a1c8163b1b |
...
For a systems engineer, baikai-claude belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.0 | 2026-09-08T14:48:35Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-fcb8a1c8163b1b` from `hackage_recent` as `registry_expansion`
