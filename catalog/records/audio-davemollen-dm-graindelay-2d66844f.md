...
<!-- canonical: https://github.com/davemollen/dm-GrainDelay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/davemollen/dm-GrainDelay](https://github.com/davemollen/dm-GrainDelay) |
| Source record ids | github_search_audio-bc1ce0eae99965 |

## System Engineer Summary

davemollen/dm-GrainDelay is tracked as a machine learning record in the Audio branch. The source did
...
For a systems engineer, davemollen/dm-GrainDelay belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-27T13:22:09Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_audio-bc1ce0eae99965` from `github_search_audio` as `registry_expansion`
