...
<!-- canonical: https://crates.io/crates/bytemuck_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bytemuck_derive](https://crates.io/crates/bytemuck_derive) |
| Source record ids | crates_io-bec154c0914365 |
...
For a systems engineer, bytemuck_derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.12.1 | 2026-09-11T20:47:15.014342Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-11T22:18:37+00:00`.
...
- `crates_io-bec154c0914365` from `crates_io` as `registry_expansion`
