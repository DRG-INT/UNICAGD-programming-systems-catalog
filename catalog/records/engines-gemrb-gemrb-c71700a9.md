...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gemrb/gemrb -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Engines |
| Category | Game Engine Game Dev |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/gemrb/gemrb](https://github.com/gemrb/gemrb) |
| Source record ids | github_search_engines-12c0b0d169faa1 |
...
For a systems engineer, gemrb/gemrb belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:40:55Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:engine stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_engines-12c0b0d169faa1` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aelassas/wexflow | Game Engine Game Dev | [open](engines-aelassas-wexflow-2844d6ae.md) |
| afollestad/aesthetic | Game Engine Game Dev | [open](engines-afollestad-aesthetic-476cc6a0.md) |
| amethyst/amethyst | Game Engine Game Dev | [open](engines-amethyst-amethyst-3c5e2553.md) |
| ange-yaghi/engine-sim | Game Engine Game Dev | [open](engines-ange-yaghi-engine-sim-7e49c066.md) |
| autokitteh/autokitteh | Game Engine Game Dev | [open](engines-autokitteh-autokitteh-b5d221ba.md) |
| AVISEngine/AVIS-Engine-Python-API | Game Engine Game Dev | [open](engines-avisengine-avis-engine-python-api-6690d3f0.md) |
| azkaban/azkaban | Game Engine Game Dev | [open](engines-azkaban-azkaban-70e229b3.md) |
| Azure/device-simulation-dotnet | Game Engine Game Dev | [open](engines-azure-device-simulation-dotnet-e81163c4.md) |
