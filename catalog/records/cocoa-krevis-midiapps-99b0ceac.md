...
<!-- canonical: https://github.com/krevis/MIDIApps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krevis/MIDIApps](https://github.com/krevis/MIDIApps) |
| Source record ids | github_search_cocoa-50e65a700279f8 |
...
For a systems engineer, krevis/MIDIApps belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-13T06:02:06Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-50e65a700279f8` from `github_search_cocoa` as `registry_expansion`
