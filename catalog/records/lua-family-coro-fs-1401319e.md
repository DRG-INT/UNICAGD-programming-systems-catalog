...
<!-- canonical: https://luarocks.org/modules/code-nuage/coro-fs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/code-nuage/coro-fs](https://luarocks.org/modules/code-nuage/coro-fs) |
| Source record ids | luarocks_root_manifest-3aac7c7864a631 |

## System Engineer Summary

coro-fs is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, coro-fs belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-3aac7c7864a631` from `luarocks_root_manifest` as `registry_expansion`
