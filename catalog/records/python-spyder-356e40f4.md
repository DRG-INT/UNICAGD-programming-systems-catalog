...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Ide Editor Integration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ide-editor-integration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-304c8d1983da3c |

## System Engineer Summary

Spyder is tracked as an ide editor integration record in the Python branch. The source did not
...
For a systems engineer, Spyder belongs in the Python inventory as part of ecosystem capability
...
- `corpus-304c8d1983da3c` from `master_json` as `ide_editor_integration`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| IPython | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-ipython-6ab63bc1.md) |
| JupyterLab | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-jupyterlab-439e86e5.md) |
