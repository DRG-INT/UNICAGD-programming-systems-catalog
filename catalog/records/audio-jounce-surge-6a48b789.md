...
| Source record ids | github_search_audio-97685f81603b02 |
...
For a systems engineer, Jounce/Surge belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2019-11-02T17:22:51Z | [https://api.github.com/repos/Jounce/Surge/releases/latest](https://api.github.com/repos/Jounce/Surge/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Jounce/Surge/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-97685f81603b02` from `github_search_audio` as `registry_expansion`
