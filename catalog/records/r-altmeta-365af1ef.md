...
<!-- canonical: https://cran.r-project.org/web/packages/altmeta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/altmeta/index.html](https://cran.r-project.org/web/packages/altmeta/index.html) |
| Source record ids | cran_packages_by_date-95d7accd6aff8a |
...
For a systems engineer, altmeta belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4 | 2026-08-21 07:20:02 UTC | [https://cran.r-project.org/web/packages/altmeta/DESCRIPTION](https://cran.r-project.org/web/packages/altmeta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/altmeta/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-95d7accd6aff8a` from `cran_packages_by_date` as `registry_expansion`
