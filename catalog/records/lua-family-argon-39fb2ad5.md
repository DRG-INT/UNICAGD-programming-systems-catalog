...
<!-- canonical: https://luarocks.org/modules/wfrsk/argon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wfrsk/argon](https://luarocks.org/modules/wfrsk/argon) |
| Source record ids | luarocks_root_manifest-9218197dbafd0b |
...
For a systems engineer, argon belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-9218197dbafd0b` from `luarocks_root_manifest` as `registry_expansion`
