# projectofst/el-sw/opensource/software10e
...
<!-- canonical: https://gitlab.com/projectofst/el-sw/opensource/software10e -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/projectofst/el-sw/opensource/software10e](https://gitlab.com/projectofst/el-sw/opensource/software10e) |
| Source record ids | gitlab_projects_api-4852e8a325e3e2 |

## System Engineer Summary

This repo holds the code for all electronic modules deployed in the formula student prototypes
developed by FST Lisboa, as well as other software tools, such as an interface for CAN bus data
analysis and a database for storage of on track data.

## Operational Role

For a systems engineer, projectofst/el-sw/opensource/software10e belongs in the Repository
Workplaces inventory as part of defect discovery, security review, undefined-state detection, and
...
- `gitlab_projects_api-4852e8a325e3e2` from `gitlab_projects_api` as `registry_expansion`
...
| gitlab-org/gitlab | Static Analyzer | [open](repository-workplaces-gitlab-org-gitlab-e1cb5b67.md) |
...
| internet-cleanup-foundation/web-security-map | Static Analyzer | [open](repository-workplaces-internet-cleanup-foundation-web-security-map-8627947d.md) |
