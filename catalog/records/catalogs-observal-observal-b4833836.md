...
<!-- canonical: https://github.com/Observal/Observal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Observal/Observal](https://github.com/Observal/Observal) |
| Source record ids | github_search_catalogs-6973ed09757b3b |

## System Engineer Summary

Observal is self-hosted registry for your coding agent extensions with a built in insight engine.
Setup Observal, define the scope and share your Skills, MCPs and Agents with your peers.

## Operational Role

For a systems engineer, Observal/Observal belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T10:12:28Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-6973ed09757b3b` from `github_search_catalogs` as `registry_expansion`
