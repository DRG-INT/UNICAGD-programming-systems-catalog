...
<!-- canonical: https://cran.r-project.org/web/packages/arakno/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/arakno/index.html](https://cran.r-project.org/web/packages/arakno/index.html) |
| Source record ids | cran_packages_by_date-de120fe74dbdc9 |
...
For a systems engineer, arakno belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3 | 2026-08-28 10:30:14 UTC | [https://cran.r-project.org/web/packages/arakno/DESCRIPTION](https://cran.r-project.org/web/packages/arakno/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/arakno/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-de120fe74dbdc9` from `cran_packages_by_date` as `registry_expansion`
