...
<!-- canonical: https://cran.r-project.org/web/packages/asremlPlus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/asremlPlus/index.html](https://cran.r-project.org/web/packages/asremlPlus/index.html) |
| Source record ids | cran_packages_by_date-6c53fab3a6d43d |

## System Engineer Summary

Augments 'ASReml-R' in Fitting Mixed Models and Packages Generally in Exploring Prediction
Differences

## Operational Role

For a systems engineer, asremlPlus belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.65 | 2026-09-15 12:10:02 UTC | [https://cran.r-project.org/web/packages/asremlPlus/DESCRIPTION](https://cran.r-project.org/web/packages/asremlPlus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/asremlPlus/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-6c53fab3a6d43d` from `cran_packages_by_date` as `registry_expansion`
