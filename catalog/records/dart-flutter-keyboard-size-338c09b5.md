...
<!-- canonical: https://pub.dev/packages/flutter_keyboard_size -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_keyboard_size](https://pub.dev/packages/flutter_keyboard_size) |
| Source record ids | pub_dev-ba5643e165e846 |

## System Engineer Summary

A straightforward and convenient provider that helps get info about - keyboard height, is it open or
not, set bool value is screen small or not.

## Operational Role

For a systems engineer, flutter_keyboard_size belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2022-10-18T10:49:32.759359Z | [https://pub.dev/api/packages/flutter_keyboard_size](https://pub.dev/api/packages/flutter_keyboard_size) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_keyboard_size` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-ba5643e165e846` from `pub_dev` as `registry_expansion`
