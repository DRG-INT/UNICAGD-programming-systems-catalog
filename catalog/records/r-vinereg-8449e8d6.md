...
<!-- canonical: https://cran.r-project.org/web/packages/vinereg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vinereg/index.html](https://cran.r-project.org/web/packages/vinereg/index.html) |
| Source record ids | cran_packages_by_date-9754fd7ae4425f |
...
For a systems engineer, vinereg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-08-31 21:50:02 UTC | [https://cran.r-project.org/web/packages/vinereg/DESCRIPTION](https://cran.r-project.org/web/packages/vinereg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vinereg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9754fd7ae4425f` from `cran_packages_by_date` as `registry_expansion`
