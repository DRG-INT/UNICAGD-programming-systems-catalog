...
<!-- canonical: https://cran.r-project.org/web/packages/messydates/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/messydates/index.html](https://cran.r-project.org/web/packages/messydates/index.html) |
| Source record ids | cran_packages_by_date-0f700a25998f2e |
...
For a systems engineer, messydates belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-01 10:30:03 UTC | [https://cran.r-project.org/web/packages/messydates/DESCRIPTION](https://cran.r-project.org/web/packages/messydates/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/messydates/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-0f700a25998f2e` from `cran_packages_by_date` as `registry_expansion`
