...
<!-- canonical: https://crates.io/crates/unarray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unarray](https://crates.io/crates/unarray) |
| Source record ids | crates_io-738104e49162e1 |
...
For a systems engineer, unarray belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2022-11-30T17:09:42.916530Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-738104e49162e1` from `crates_io` as `registry_expansion`
