...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Profiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/profiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/luauser42/dt-anchor-tools](https://luarocks.org/modules/luauser42/dt-anchor-tools) |
| Source record ids | luarocks_root_manifest-abdd46b2447e3e |

## System Engineer Summary

Resolve Dragon Traveler profile links by keyword

## Operational Role

For a systems engineer, dt-anchor-tools belongs in the Lua family inventory as part of hot-path
...
| Name | Category | Page |
| --- | --- | --- |
| deeptrace | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-deeptrace-d01a630c.md) |
| dtracing | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dtracing-8d61bd65.md) |
| ELProfiler | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-elprofiler-5281476f.md) |
| luatrace | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luatrace-30f7fe16.md) |
| ProFi | Profiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-profi-5f67f00e.md) |
