...
<!-- canonical: https://learn.microsoft.com/dotnet/framework/data/adonet/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://learn.microsoft.com/dotnet/framework/data/adonet/](https://learn.microsoft.com/dotnet/framework/data/adonet/) |
| Source record ids | curated_database_systems-575e89bab083c2 |

## System Engineer Summary

.NET data access provider model and database connectivity API.

## Operational Role

For a systems engineer, ADO.NET belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-575e89bab083c2` from `curated_database_systems` as `registry_expansion`
