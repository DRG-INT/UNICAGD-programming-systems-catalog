...
<!-- canonical: https://packagist.org/packages/seld/jsonlint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/seld/jsonlint](https://packagist.org/packages/seld/jsonlint) |
| Source record ids | packagist_search-87f80d9815c908 |

## System Engineer Summary

seld/jsonlint is tracked as a linter record in the PHP branch. The source did not provide a long
...
For a systems engineer, seld/jsonlint belongs in the PHP inventory as part of static feedback, style
...
- `packagist_search-87f80d9815c908` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| pushery/sqlens-for-laravel | Linter | [open](php-pushery-sqlens-for-laravel-1a18e4e8.md) |
