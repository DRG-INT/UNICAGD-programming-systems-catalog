...
| Canonical URL | [https://crates.io/crates/wasmprinter](https://crates.io/crates/wasmprinter) |
| Source record ids | crates_io-1597e63bd45d1c |
...
For a systems engineer, wasmprinter belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.258.0 | 2026-08-24T17:11:56.612073Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-1597e63bd45d1c` from `crates_io` as `registry_expansion`
