...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-maps.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.ivoa.net/](https://www.ivoa.net/) |
| Source record ids | curated_language_routes-fa11e7582040f0 |

## System Engineer Summary

Astronomical data interoperability standards and registry ecosystem for sky catalogs, archives, and
tools.

## Operational Role

For a systems engineer, International Virtual Observatory Alliance belongs in the Space Maps
...
- `curated_language_routes-fa11e7582040f0` from `curated_language_routes` as `registry_expansion`
