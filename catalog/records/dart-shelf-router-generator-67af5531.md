...
<!-- canonical: https://pub.dev/packages/shelf_router_generator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_router_generator](https://pub.dev/packages/shelf_router_generator) |
| Source record ids | pub_dev-ba8608418b1e07 |

## System Engineer Summary

A package:build-compatible builder for generating request routers for the shelf web-framework based
on source annotations.

## Operational Role

For a systems engineer, shelf_router_generator belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2026-06-25T12:49:35.319962Z | [https://pub.dev/api/packages/shelf_router_generator](https://pub.dev/api/packages/shelf_router_generator) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_router_generator` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-ba8608418b1e07` from `pub_dev` as `registry_expansion`
