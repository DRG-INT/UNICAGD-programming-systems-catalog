...
<!-- canonical: https://packagist.org/packages/stfalcon-studio/doctrine-redis-cache-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/stfalcon-studio/doctrine-redis-cache-bundle](https://packagist.org/packages/stfalcon-studio/doctrine-redis-cache-bundle) |
| Source record ids | packagist_search-5f7b71f20b006e |
...
For a systems engineer, stfalcon-studio/doctrine-redis-cache-bundle belongs in the PHP inventory as
...
- `packagist_search-5f7b71f20b006e` from `packagist_search` as `registry_expansion`
