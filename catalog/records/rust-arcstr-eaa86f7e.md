...
| Canonical URL | [https://crates.io/crates/arcstr](https://crates.io/crates/arcstr) |
| Source record ids | crates_io-75e364926c3499 |

## System Engineer Summary

A better reference-counted string type, with zero-cost (allocation-free) support for string
literals, and reference counted substrings.

## Operational Role

For a systems engineer, arcstr belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2024-05-07T02:37:10.279194Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-75e364926c3499` from `crates_io` as `registry_expansion`
