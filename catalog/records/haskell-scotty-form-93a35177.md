...
<!-- canonical: https://hackage.haskell.org/package/scotty-form -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/scotty-form](https://hackage.haskell.org/package/scotty-form) |
| Source record ids | hackage_recent-a36649bd60ab3b |

## System Engineer Summary

Hackage package recently uploaded by goolord.

## Operational Role

For a systems engineer, scotty-form belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.0 | 2026-09-05T00:18:16Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-a36649bd60ab3b` from `hackage_recent` as `registry_expansion`
