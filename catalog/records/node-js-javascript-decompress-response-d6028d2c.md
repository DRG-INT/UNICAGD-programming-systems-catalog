...
<!-- canonical: https://www.npmjs.com/package/decompress-response -->
<!-- crawl-delay: 10 -->
...
| Evidence | Microsoft Public License; https://api.github.com/licenses/ms-pl; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `npm_registry-92cd80b945ed50` from `npm_registry` as `registry_expansion`
