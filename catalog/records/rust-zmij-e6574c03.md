...
<!-- canonical: https://crates.io/crates/zmij -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zmij](https://crates.io/crates/zmij) |
| Source record ids | crates_io-ff66d4b015c4ae |
...
For a systems engineer, zmij belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.23 | 2026-07-13T12:58:53.705886Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-05T18:20:33+00:00`.
...
- `crates_io-ff66d4b015c4ae` from `crates_io` as `registry_expansion`
