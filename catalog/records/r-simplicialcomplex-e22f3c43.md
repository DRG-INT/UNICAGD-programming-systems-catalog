...
<!-- canonical: https://cran.r-project.org/web/packages/SimplicialComplex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SimplicialComplex/index.html](https://cran.r-project.org/web/packages/SimplicialComplex/index.html) |
| Source record ids | cran_packages_by_date-c9d50a35dfb01c |
...
For a systems engineer, SimplicialComplex belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-24 18:40:50 UTC | [https://cran.r-project.org/web/packages/SimplicialComplex/DESCRIPTION](https://cran.r-project.org/web/packages/SimplicialComplex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SimplicialComplex/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c9d50a35dfb01c` from `cran_packages_by_date` as `registry_expansion`
