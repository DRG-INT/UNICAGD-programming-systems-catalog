...
<!-- canonical: https://packagist.org/packages/jakeasmith/http_build_url -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jakeasmith/http_build_url](https://packagist.org/packages/jakeasmith/http_build_url) |
| Source record ids | packagist_search-e0567d961a37bc |

## System Engineer Summary

Deprecated: use PHP 8.5's built-in Uri\Rfc3986\Uri instead. Provides http_build_url() for
environments without pecl_http.

## Operational Role

For a systems engineer, jakeasmith/http_build_url belongs in the PHP inventory as part of build
...
- `packagist_search-e0567d961a37bc` from `packagist_search` as `registry_expansion`
