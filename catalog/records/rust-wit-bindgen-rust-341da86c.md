...
<!-- canonical: https://crates.io/crates/wit-bindgen-rust -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-bindgen-rust](https://crates.io/crates/wit-bindgen-rust) |
| Source record ids | crates_io-f7207d9dd11138 |

## System Engineer Summary

Rust bindings generator for WIT and the component model, typically used through the `wit-bindgen`
crate's `generate!` macro.

## Operational Role

For a systems engineer, wit-bindgen-rust belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.61.1 | 2026-08-25T15:28:02.658100Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-f7207d9dd11138` from `crates_io` as `registry_expansion`
