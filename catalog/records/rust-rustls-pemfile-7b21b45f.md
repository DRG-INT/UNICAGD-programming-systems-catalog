...
<!-- canonical: https://crates.io/crates/rustls-pemfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rustls-pemfile](https://crates.io/crates/rustls-pemfile) |
| Source record ids | crates_io-21003a6ec44f73 |
...
For a systems engineer, rustls-pemfile belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2024-09-30T16:29:22.598843Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-21003a6ec44f73` from `crates_io` as `registry_expansion`
