...
<!-- canonical: https://hackage.haskell.org/package/mainland-pretty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mainland-pretty](https://hackage.haskell.org/package/mainland-pretty) |
| Source record ids | hackage_top_downloads-fc02cedaca1f72 |
...
For a systems engineer, mainland-pretty belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1.1 | 2024-07-02T14:23:43Z | [https://hackage.haskell.org/package/mainland-pretty](https://hackage.haskell.org/package/mainland-pretty) |  |
| candidate | partial | 0.7.0.1 |  | [https://hackage.haskell.org/package/mainland-pretty](https://hackage.haskell.org/package/mainland-pretty) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mainland-pretty` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-fc02cedaca1f72` from `hackage_top_downloads` as `registry_expansion`
