...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/radar-lab/ti_mmwave_rospkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/radar-lab/ti_mmwave_rospkg](https://github.com/radar-lab/ti_mmwave_rospkg) |
| Source record ids | github_search_radars-7ba685dd1e8675 |
...
For a systems engineer, radar-lab/ti_mmwave_rospkg belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-01T08:14:27Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-7ba685dd1e8675` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| eupassarinho/sentinel-1-SAR-vegetation-indices | Package Manager | [open](radars-eupassarinho-sentinel-1-sar-vegetation-indices-fd72636b.md) |
