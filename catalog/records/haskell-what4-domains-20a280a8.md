...
<!-- canonical: https://hackage.haskell.org/package/what4-domains -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/what4-domains](https://hackage.haskell.org/package/what4-domains) |
| Source record ids | hackage_recent-35beadab7001d5 |
...
For a systems engineer, what4-domains belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2026-09-01T17:34:44Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-35beadab7001d5` from `hackage_recent` as `registry_expansion`
