...
<!-- canonical: https://github.com/cszn/FFDNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cszn/FFDNet](https://github.com/cszn/FFDNet) |
| Source record ids | github_search_matlab-ab37f4ed766403 |
...
For a systems engineer, cszn/FFDNet belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-10-09T22:05:04Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ab37f4ed766403` from `github_search_matlab` as `registry_expansion`
