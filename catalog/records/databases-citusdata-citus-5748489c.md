...
<!-- canonical: https://github.com/citusdata/citus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/citusdata/citus](https://github.com/citusdata/citus) |
| Source record ids | github_search_databases-abc378e45720f1 |
...
For a systems engineer, citusdata/citus belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T22:58:48Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Other; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_databases-abc378e45720f1` from `github_search_databases` as `registry_expansion`
