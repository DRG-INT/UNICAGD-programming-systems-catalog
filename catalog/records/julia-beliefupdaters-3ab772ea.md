...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BeliefUpdaters -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BeliefUpdaters", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-99bf7022271411` from `julia_general` as `registry_expansion`
