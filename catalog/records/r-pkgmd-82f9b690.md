...
<!-- canonical: https://cran.r-project.org/web/packages/pkgmd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pkgmd/index.html](https://cran.r-project.org/web/packages/pkgmd/index.html) |
| Source record ids | cran_packages_by_date-72c6c6c7c78d1a |

## System Engineer Summary

Generate Markdown Reference Documentation for R Packages

## Operational Role

For a systems engineer, pkgmd belongs in the R inventory as part of dependency acquisition, lockfile
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1 | 2026-08-07 16:10:10 UTC | [https://cran.r-project.org/web/packages/pkgmd/DESCRIPTION](https://cran.r-project.org/web/packages/pkgmd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pkgmd/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-72c6c6c7c78d1a` from `cran_packages_by_date` as `registry_expansion`
