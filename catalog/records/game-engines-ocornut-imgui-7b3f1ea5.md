...
<!-- canonical: https://github.com/ocornut/imgui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ocornut/imgui](https://github.com/ocornut/imgui) |
| Source record ids | github_search_game_engines-904d541eff854a |
...
For a systems engineer, ocornut/imgui belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:39:22Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-904d541eff854a` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| KilledByAPixel/LittleJS | Dependency Manager | [open](game-engines-killedbyapixel-littlejs-1373ebf3.md) |
