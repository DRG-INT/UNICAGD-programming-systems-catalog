...
<!-- canonical: https://hackage.haskell.org/package/http-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http-types](https://hackage.haskell.org/package/http-types) |
| Source record ids | hackage_top_downloads-2be8db937d4cd4 |
...
For a systems engineer, http-types belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.6 | 2026-08-13T12:48:46Z | [https://hackage.haskell.org/package/http-types](https://hackage.haskell.org/package/http-types) |  |
| candidate | partial | 0.10 |  | [https://hackage.haskell.org/package/http-types](https://hackage.haskell.org/package/http-types) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http-types` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-2be8db937d4cd4` from `hackage_top_downloads` as `registry_expansion`
