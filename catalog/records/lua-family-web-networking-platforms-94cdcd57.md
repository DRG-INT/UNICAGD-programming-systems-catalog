...
| Source record ids | lua-source-18 |

## System Engineer Summary

Web/Networking Platforms is tracked as a networking http record in the Lua family branch. The source
...
For a systems engineer, Web/Networking Platforms belongs in the Lua family inventory as part of
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 18}}` |
...
- `lua-source-18` from `master_json` as `source_list_item`
