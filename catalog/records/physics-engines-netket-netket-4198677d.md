...
<!-- canonical: https://github.com/netket/netket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/netket/netket](https://github.com/netket/netket) |
| Source record ids | github_search_physics_engines-f5cb0ee1febd05 |
...
For a systems engineer, netket/netket belongs in the Physics Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T04:32:51Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f5cb0ee1febd05` from `github_search_physics_engines` as `registry_expansion`
...
| phenomLi/Torque | Machine Learning | [open](physics-engines-phenomli-torque-d1ae5f59.md) |
