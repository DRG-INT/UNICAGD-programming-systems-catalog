...
<!-- canonical: https://pub.dev/packages/country_code_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/country_code_picker](https://pub.dev/packages/country_code_picker) |
| Source record ids | pub_dev-66c7cdebf69d55 |

## System Engineer Summary

A flutter package for showing a country code selector. In addition it gives the possibility to
select a list of favorites countries, as well as to search using a simple searchbox

## Operational Role

For a systems engineer, country_code_picker belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.1 | 2025-10-08T13:39:50.323677Z | [https://pub.dev/api/packages/country_code_picker](https://pub.dev/api/packages/country_code_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/country_code_picker` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-66c7cdebf69d55` from `pub_dev` as `registry_expansion`
