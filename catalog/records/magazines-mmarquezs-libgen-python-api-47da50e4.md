...
<!-- canonical: https://github.com/mmarquezs/libgen-python-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mmarquezs/libgen-python-api](https://github.com/mmarquezs/libgen-python-api) |
| Source record ids | github_search_magazines-e5afabe8da1a6f |

## System Engineer Summary

A Python library that provides an api to search and get links from Books,Magazines,Comics,... from
Library Genesis.

## Operational Role

For a systems engineer, mmarquezs/libgen-python-api belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-18T15:15:49Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-e5afabe8da1a6f` from `github_search_magazines` as `registry_expansion`
