...
<!-- canonical: https://github.com/spaceymonk/morse-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spaceymonk/morse-analyzer](https://github.com/spaceymonk/morse-analyzer) |
| Source record ids | github_search_electromagnetoscopes-8da9d3f2849d3e |
...
For a systems engineer, spaceymonk/morse-analyzer belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-25T11:57:38Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-8da9d3f2849d3e` from `github_search_electromagnetoscopes` as `registry_expansion`
