...
<!-- canonical: https://github.com/jplim/sap-cloud-cap-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jplim/sap-cloud-cap-java](https://github.com/jplim/sap-cloud-cap-java) |
| Source record ids | github_search_sapjava-b005fc5566b728 |
...
For a systems engineer, jplim/sap-cloud-cap-java belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-19T02:47:55Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-b005fc5566b728` from `github_search_sapjava` as `registry_expansion`
