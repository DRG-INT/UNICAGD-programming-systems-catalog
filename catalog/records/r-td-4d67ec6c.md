...
<!-- canonical: https://cran.r-project.org/web/packages/td/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/td/index.html](https://cran.r-project.org/web/packages/td/index.html) |
| Source record ids | cran_packages_by_date-7327eba5d4a112 |
...
For a systems engineer, td belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7 | 2026-09-13 13:30:02 UTC | [https://cran.r-project.org/web/packages/td/DESCRIPTION](https://cran.r-project.org/web/packages/td/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/td/DESCRIPTION` at `2026-09-13T14:18:34+00:00`.
...
- `cran_packages_by_date-7327eba5d4a112` from `cran_packages_by_date` as `registry_expansion`
