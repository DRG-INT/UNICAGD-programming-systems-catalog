...
<!-- canonical: https://luarocks.org/modules/glenn/bitproxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/glenn/bitproxy](https://luarocks.org/modules/glenn/bitproxy) |
| Source record ids | luarocks_root_manifest-aa089be29092a1 |

## System Engineer Summary

bitproxy is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, bitproxy belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-aa089be29092a1` from `luarocks_root_manifest` as `registry_expansion`
