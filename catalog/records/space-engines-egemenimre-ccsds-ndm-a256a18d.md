...
<!-- canonical: https://github.com/egemenimre/ccsds-ndm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/egemenimre/ccsds-ndm](https://github.com/egemenimre/ccsds-ndm) |
| Source record ids | github_search_space_engines-92c8a0db5d5a24 |
...
For a systems engineer, egemenimre/ccsds-ndm belongs in the Space Engines inventory as part of
...
- `github_search_space_engines-92c8a0db5d5a24` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Astroshaper/AsteroidThermoPhysicalModels.jl | Language Specification | [open](space-engines-astroshaper-asteroidthermophysicalmodels-jl-27e16628.md) |
