...
| Source record ids | github_search_space_maps-0dbb90602f0de7 |
...
For a systems engineer, bluescarni/heyoka.py belongs in the Space Maps inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T10:54:03Z | gh search repos topic:celestial-mechanics stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0dbb90602f0de7` from `github_search_space_maps` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bluescarni/heyoka | Compiler | [open](space-maps-bluescarni-heyoka-bf9e17ae.md) |
