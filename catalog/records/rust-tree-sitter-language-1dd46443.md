...
| Canonical URL | [https://crates.io/crates/tree-sitter-language](https://crates.io/crates/tree-sitter-language) |
| Source record ids | crates_io-e2ae6a13af7993 |
...
For a systems engineer, tree-sitter-language belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-08-30T17:22:42.325300Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-e2ae6a13af7993` from `crates_io` as `registry_expansion`
