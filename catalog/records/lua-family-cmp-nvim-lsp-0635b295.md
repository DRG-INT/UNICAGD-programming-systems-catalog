...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp-nvim-lsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp-nvim-lsp](https://luarocks.org/modules/neorocks/cmp-nvim-lsp) |
| Source record ids | luarocks_root_manifest-45a44488341de1 |
...
For a systems engineer, cmp-nvim-lsp belongs in the Lua family inventory as part of editor
...
- `luarocks_root_manifest-45a44488341de1` from `luarocks_root_manifest` as `registry_expansion`
