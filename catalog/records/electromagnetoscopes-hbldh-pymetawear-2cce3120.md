...
<!-- canonical: https://github.com/hbldh/pymetawear -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hbldh/pymetawear](https://github.com/hbldh/pymetawear) |
| Source record ids | github_search_electromagnetoscopes-6e223ce74f716d |
...
For a systems engineer, hbldh/pymetawear belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-30T14:04:42Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-6e223ce74f716d` from `github_search_electromagnetoscopes` as `registry_expansion`
