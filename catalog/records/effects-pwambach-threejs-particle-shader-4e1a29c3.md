...
<!-- canonical: https://github.com/pwambach/threejs-particle-shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pwambach/threejs-particle-shader](https://github.com/pwambach/threejs-particle-shader) |
| Source record ids | github_search_effects-870df338edd12e |
...
For a systems engineer, pwambach/threejs-particle-shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-02-25T22:06:32Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-870df338edd12e` from `github_search_effects` as `registry_expansion`
