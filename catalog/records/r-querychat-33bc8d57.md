...
<!-- canonical: https://cran.r-project.org/web/packages/querychat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/querychat/index.html](https://cran.r-project.org/web/packages/querychat/index.html) |
| Source record ids | cran_packages_by_date-a4117867c1cc50 |
...
For a systems engineer, querychat belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-13 22:40:02 UTC | [https://cran.r-project.org/web/packages/querychat/DESCRIPTION](https://cran.r-project.org/web/packages/querychat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/querychat/DESCRIPTION` at `2026-09-14T00:28:12+00:00`.
...
- `cran_packages_by_date-a4117867c1cc50` from `cran_packages_by_date` as `registry_expansion`
