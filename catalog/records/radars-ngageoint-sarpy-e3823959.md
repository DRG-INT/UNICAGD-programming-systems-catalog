...
| Source record ids | github_search_radars-d2f152dd5b5708 |

## System Engineer Summary

A basic Python library to demonstrate reading, writing, display, and simple processing of complex
SAR data using the NGA SICD standard.

## Operational Role

For a systems engineer, ngageoint/sarpy belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T17:31:26Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-d2f152dd5b5708` from `github_search_radars` as `registry_expansion`
