...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Effects](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/effects.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/NatronGitHub/Natron](https://github.com/NatronGitHub/Natron) |
| Source record ids | curated_language_routes-78749e0d08dffc |

## System Engineer Summary

Node-based compositor for visual effects, rotoscoping, keying, color, and OpenFX plug-ins.

## Operational Role

For a systems engineer, Natron belongs in the Effects inventory as part of ecosystem capability
...
- `curated_language_routes-78749e0d08dffc` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Blender Compositor | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-blender-compositor-20ae76f1.md) |
| Cinder | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-cinder-520874a6.md) |
| PixiJS Filters | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-pixijs-filters-2c7b5506.md) |
| Shadertoy | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-shadertoy-7ba0fe72.md) |
| three.js postprocessing | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/effects-three-js-postprocessing-124968b5.md) |
