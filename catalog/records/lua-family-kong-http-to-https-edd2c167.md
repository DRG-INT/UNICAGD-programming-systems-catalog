...
| Canonical URL | [https://luarocks.org/modules/ingresse/kong-http-to-https](https://luarocks.org/modules/ingresse/kong-http-to-https) |
| Source record ids | luarocks_root_manifest-eb264512694bfe |

## System Engineer Summary

Kong plugin to redirect HTTP requests to HTTPS

## Operational Role

For a systems engineer, kong-http-to-https belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-eb264512694bfe` from `luarocks_root_manifest` as `registry_expansion`
