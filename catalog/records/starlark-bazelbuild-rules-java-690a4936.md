...
<!-- canonical: https://github.com/bazelbuild/rules_java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazelbuild/rules_java](https://github.com/bazelbuild/rules_java) |
| Source record ids | github_search_starlark-2afde78158e3ff |

## System Engineer Summary

bazelbuild/rules_java is tracked as a build system record in the Starlark branch. The source did not
...
For a systems engineer, bazelbuild/rules_java belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T16:38:19Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; {"key": "", "name": "", "url": ""}; Boost Software License 1.0; https://api.github.com/licenses/bsl-1.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_starlark-2afde78158e3ff` from `github_search_starlark` as `registry_expansion`
