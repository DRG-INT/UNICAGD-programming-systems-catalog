...
<!-- canonical: https://github.com/xioTechnologies/Gait-Tracking-With-x-IMU -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xioTechnologies/Gait-Tracking-With-x-IMU](https://github.com/xioTechnologies/Gait-Tracking-With-x-IMU) |
| Source record ids | github_search_matlab-871b469840ca94 |

## System Engineer Summary

xioTechnologies/Gait-Tracking-With-x-IMU is tracked as a language specification record in the Matlab
...
For a systems engineer, xioTechnologies/Gait-Tracking-With-x-IMU belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-14T12:00:26Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-871b469840ca94` from `github_search_matlab` as `registry_expansion`
