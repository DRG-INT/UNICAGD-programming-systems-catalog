...
<!-- canonical: https://hackage.haskell.org/package/hjsmin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hjsmin](https://hackage.haskell.org/package/hjsmin) |
| Source record ids | hackage_top_downloads-a9ef44e6064f10 |
...
For a systems engineer, hjsmin belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2023-01-11T02:35:34Z | [https://hackage.haskell.org/package/hjsmin](https://hackage.haskell.org/package/hjsmin) |  |
| candidate | partial | 0.1.4.2 |  | [https://hackage.haskell.org/package/hjsmin](https://hackage.haskell.org/package/hjsmin) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hjsmin` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-a9ef44e6064f10` from `hackage_top_downloads` as `registry_expansion`
