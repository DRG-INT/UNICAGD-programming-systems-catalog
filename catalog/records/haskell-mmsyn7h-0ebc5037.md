...
<!-- canonical: https://hackage.haskell.org/package/mmsyn7h -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mmsyn7h](https://hackage.haskell.org/package/mmsyn7h) |
| Source record ids | hackage_top_downloads-979d51680ae12c |
...
For a systems engineer, mmsyn7h belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1.0 | 2020-12-03T18:49:56Z | [https://hackage.haskell.org/package/mmsyn7h](https://hackage.haskell.org/package/mmsyn7h) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mmsyn7h` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-979d51680ae12c` from `hackage_top_downloads` as `registry_expansion`
