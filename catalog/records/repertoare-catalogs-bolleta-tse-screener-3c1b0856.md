# bolleta/tse-screener

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bolleta/tse-screener -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bolleta/tse-screener](https://github.com/bolleta/tse-screener) |
| Source record ids | github_search_repertoare_catalogs-60c48a546ea30e |

## System Engineer Summary

Rule-driven Tokyo Stock Exchange equity screener on the J-Quants V2 API — strength-based scoring
(82-strategy YAML catalog), an N-bagger screener, and a dependency-free web UI.

## Operational Role

For a systems engineer, bolleta/tse-screener belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T15:20:33Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-60c48a546ea30e` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| KyonTanaka/yagni-auditor | Dependency Manager | [open](repertoare-catalogs-kyontanaka-yagni-auditor-da95753d.md) |
