...
<!-- canonical: https://github.com/panpf/sketch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/panpf/sketch](https://github.com/panpf/sketch) |
| Source record ids | github_search_photography-860243b839cb07 |

## System Engineer Summary

Image loading library designed for Compose Multiplatform and Android View. Supports loading Image,
GIF, SVG, Video thumbnails from the network, local, resources, and photo albums.

## Operational Role

For a systems engineer, panpf/sketch belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-08T08:33:06Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_photography-860243b839cb07` from `github_search_photography` as `registry_expansion`
