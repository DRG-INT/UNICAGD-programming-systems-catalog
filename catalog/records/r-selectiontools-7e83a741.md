...
<!-- canonical: https://cran.r-project.org/web/packages/SelectionTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SelectionTools/index.html](https://cran.r-project.org/web/packages/SelectionTools/index.html) |
| Source record ids | cran_packages_by_date-2c0e2ad38fe1a5 |
...
For a systems engineer, SelectionTools belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.3 | 2026-09-15 10:40:21 UTC | [https://cran.r-project.org/web/packages/SelectionTools/DESCRIPTION](https://cran.r-project.org/web/packages/SelectionTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SelectionTools/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-2c0e2ad38fe1a5` from `cran_packages_by_date` as `registry_expansion`
