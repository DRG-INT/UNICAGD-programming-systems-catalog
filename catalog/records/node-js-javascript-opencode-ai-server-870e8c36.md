...
<!-- canonical: https://www.npmjs.com/package/@opencode-ai/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@opencode-ai/server](https://www.npmjs.com/package/@opencode-ai/server) |
| Source record ids | npm_registry-7f9eae044c744f |

## System Engineer Summary

Reserved package name for opencode server.

## Operational Role

For a systems engineer, @opencode-ai/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0-reserved.0 | 2026-07-01T22:05:01.103Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-7f9eae044c744f` from `npm_registry` as `registry_expansion`
