...
<!-- canonical: https://crates.io/crates/safemem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/safemem](https://crates.io/crates/safemem) |
| Source record ids | crates_io-b8a3d658f61427 |
...
For a systems engineer, safemem belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2019-10-22T03:54:11.474305Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-b8a3d658f61427` from `crates_io` as `registry_expansion`
