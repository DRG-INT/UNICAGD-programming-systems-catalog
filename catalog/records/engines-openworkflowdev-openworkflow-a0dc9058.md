...
<!-- canonical: https://github.com/openworkflowdev/openworkflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openworkflowdev/openworkflow](https://github.com/openworkflowdev/openworkflow) |
| Source record ids | github_search_engines-1e6b58c093ae7b |

## System Engineer Summary

Open-source TypeScript framework for building durable, resumable workflows. Supports Node.js and
Bun.

## Operational Role

For a systems engineer, openworkflowdev/openworkflow belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:45:25Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-1e6b58c093ae7b` from `github_search_engines` as `registry_expansion`
