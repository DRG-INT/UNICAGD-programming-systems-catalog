...
<!-- canonical: https://github.com/RCmags/basicMPU6050 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RCmags/basicMPU6050](https://github.com/RCmags/basicMPU6050) |
| Source record ids | github_search_electromagnetoscopes-f7fc51b4c4a759 |
...
For a systems engineer, RCmags/basicMPU6050 belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-19T01:01:43Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-f7fc51b4c4a759` from `github_search_electromagnetoscopes` as `registry_expansion`
