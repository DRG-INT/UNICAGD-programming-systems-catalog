...
| Canonical URL | [https://pypi.org/project/Django/](https://pypi.org/project/Django/) |
| Source record ids | master-ebf46998622b |

## System Engineer Summary

Django is tracked as a web framework record in the Python branch. The source did not provide a long
...
For a systems engineer, Django belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1 | 2026-08-05T19:21:53.789229Z | [https://pypi.org/pypi/Django/json](https://pypi.org/pypi/Django/json) |  |
| preview | known | 6.1rc1 | 2026-07-22T20:07:51.603498Z | [https://pypi.org/pypi/Django/json](https://pypi.org/pypi/Django/json) |  |

## Engineering Notes

- Treat category as `web_framework` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://pypi.org/pypi/Django/json` at `2026-09-01T02:13:00+00:00`.
...
- `master-ebf46998622b` from `master_json` as `web_framework`
