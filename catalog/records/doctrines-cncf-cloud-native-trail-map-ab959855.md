...
[Catalog index](../index.md) · [Language: Doctrines](../by-language/doctrines.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cncf/trailmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cncf/trailmap](https://github.com/cncf/trailmap) |
| Source record ids | curated_language_routes-292bdc59ae364f |

## System Engineer Summary

Cloud-native adoption map for container, orchestration, observability, service, and platform
engineering decisions.

## Operational Role

For a systems engineer, CNCF Cloud Native Trail Map belongs in the Doctrines inventory as part of
...
- `curated_language_routes-292bdc59ae364f` from `curated_language_routes` as `registry_expansion`
