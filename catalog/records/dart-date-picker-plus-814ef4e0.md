...
<!-- canonical: https://pub.dev/packages/date_picker_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/date_picker_plus](https://pub.dev/packages/date_picker_plus) |
| Source record ids | pub_dev-b4d8b2c8b03521 |
...
For a systems engineer, date_picker_plus belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2026-09-01T06:46:18.740759Z | [https://pub.dev/api/packages/date_picker_plus](https://pub.dev/api/packages/date_picker_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/date_picker_plus` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-b4d8b2c8b03521` from `pub_dev` as `registry_expansion`
