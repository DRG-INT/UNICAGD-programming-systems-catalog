...
| Source record ids | github_search_maps-ada897701f85fa |
...
For a systems engineer, microsoft/farmvibes-ai belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T00:14:55Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-ada897701f85fa` from `github_search_maps` as `registry_expansion`
