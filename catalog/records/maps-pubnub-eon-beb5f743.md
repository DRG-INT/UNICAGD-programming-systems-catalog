...
<!-- canonical: https://github.com/pubnub/eon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pubnub/eon](https://github.com/pubnub/eon) |
| Source record ids | github_search_maps-0bb66663987216 |
...
For a systems engineer, pubnub/eon belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-06T09:15:05Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0bb66663987216` from `github_search_maps` as `registry_expansion`
