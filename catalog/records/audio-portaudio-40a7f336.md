...
| Canonical URL | [https://github.com/PortAudio/portaudio](https://github.com/PortAudio/portaudio) |
| Source record ids | curated_language_routes-362a1a63d600ac |

## System Engineer Summary

Cross-platform audio I/O library for recording, playback, low-latency streams, and device
integration.

## Operational Role

For a systems engineer, PortAudio belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v19.7.0 | 2021-04-06T16:47:05Z | [https://api.github.com/repos/PortAudio/portaudio/releases/latest](https://api.github.com/repos/PortAudio/portaudio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PortAudio/portaudio/releases/latest` at `2026-09-01T07:24:45+00:00`.
...
- `curated_language_routes-362a1a63d600ac` from `curated_language_routes` as `registry_expansion`
