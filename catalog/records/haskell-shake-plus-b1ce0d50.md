...
<!-- canonical: https://hackage.haskell.org/package/shake-plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shake-plus](https://hackage.haskell.org/package/shake-plus) |
| Source record ids | hackage_top_downloads-578dead1f5ad89 |
...
For a systems engineer, shake-plus belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4.0 | 2021-07-10T07:13:23Z | [https://hackage.haskell.org/package/shake-plus](https://hackage.haskell.org/package/shake-plus) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/shake-plus` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-578dead1f5ad89` from `hackage_top_downloads` as `registry_expansion`
