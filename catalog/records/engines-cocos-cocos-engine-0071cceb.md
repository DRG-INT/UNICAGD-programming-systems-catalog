...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cocos/cocos-engine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cocos/cocos-engine](https://github.com/cocos/cocos-engine) |
| Source record ids | github_search_engines-3583fe11401c11 |

## System Engineer Summary

Cocos simplifies game creation and distribution with Cocos Creator, a free, open-source, cross-
platform game engine. Empowering millions of developers to create high-performance, engaging 2D/3D
games and instant web entertainment.

## Operational Role

For a systems engineer, cocos/cocos-engine belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:50:59Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-3583fe11401c11` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rulego/rulego | Benchmarking | [open](engines-rulego-rulego-24f33e58.md) |
| s8sg/goflow | Benchmarking | [open](engines-s8sg-goflow-42947b0d.md) |
