...
<!-- canonical: https://cran.r-project.org/web/packages/swash/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/swash/index.html](https://cran.r-project.org/web/packages/swash/index.html) |
| Source record ids | cran_packages_by_date-6adfca51d7df91 |
...
For a systems engineer, swash belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-30 09:40:02 UTC | [https://cran.r-project.org/web/packages/swash/DESCRIPTION](https://cran.r-project.org/web/packages/swash/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/swash/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6adfca51d7df91` from `cran_packages_by_date` as `registry_expansion`
