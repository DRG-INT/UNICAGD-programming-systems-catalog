...
| Canonical URL | [https://github.com/PytorchConnectomics/pytorch_connectomics](https://github.com/PytorchConnectomics/pytorch_connectomics) |
| Source record ids | github_search_microscopy-b27e6713823966 |
...
For a systems engineer, PytorchConnectomics/pytorch_connectomics belongs in the Microscopy inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2025-09-28T03:27:53Z | [https://api.github.com/repos/PytorchConnectomics/pytorch_connectomics/releases/latest](https://api.github.com/repos/PytorchConnectomics/pytorch_connectomics/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PytorchConnectomics/pytorch_connectomics/releases/latest` at `2026-09-01T11:22:09+00:00`.
...
- `github_search_microscopy-b27e6713823966` from `github_search_microscopy` as `registry_expansion`
