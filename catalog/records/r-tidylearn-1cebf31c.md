...
<!-- canonical: https://cran.r-project.org/web/packages/tidylearn/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidylearn/index.html](https://cran.r-project.org/web/packages/tidylearn/index.html) |
| Source record ids | cran_packages_by_date-710a0457369e25 |
...
For a systems engineer, tidylearn belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-02 06:20:02 UTC | [https://cran.r-project.org/web/packages/tidylearn/DESCRIPTION](https://cran.r-project.org/web/packages/tidylearn/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidylearn/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-710a0457369e25` from `cran_packages_by_date` as `registry_expansion`
