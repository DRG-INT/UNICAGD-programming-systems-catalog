...
<!-- canonical: https://crates.io/crates/datafusion-functions-aggregate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/datafusion-functions-aggregate](https://crates.io/crates/datafusion-functions-aggregate) |
| Source record ids | crates_io-17e779134459a3 |
...
For a systems engineer, datafusion-functions-aggregate belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 55.0.0 | 2026-08-18T21:09:25.584197Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
