...
| Canonical URL | [https://crates.io/crates/async-graphql](https://crates.io/crates/async-graphql) |
| Source record ids | crates_io-76fd31b5ae6efe |
...
For a systems engineer, async-graphql belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.1 | 2026-04-21T22:46:09.588412Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-76fd31b5ae6efe` from `crates_io` as `registry_expansion`
