...
<!-- canonical: https://github.com/restatedev/restate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/restatedev/restate](https://github.com/restatedev/restate) |
| Source record ids | github_search_engines-30f3e6083c9a5f |

## System Engineer Summary

Restate is the platform for building resilient applications that tolerate all infrastructure faults
w/o the need for a PhD.

## Operational Role

For a systems engineer, restatedev/restate belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:08:32Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-30f3e6083c9a5f` from `github_search_engines` as `registry_expansion`
