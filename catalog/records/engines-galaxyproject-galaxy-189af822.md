...
<!-- canonical: https://github.com/galaxyproject/galaxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/galaxyproject/galaxy](https://github.com/galaxyproject/galaxy) |
| Source record ids | github_search_engines-c4d1ea9ad735b5 |
...
For a systems engineer, galaxyproject/galaxy belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:39:58Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-c4d1ea9ad735b5` from `github_search_engines` as `registry_expansion`
