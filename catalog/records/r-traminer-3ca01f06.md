...
<!-- canonical: https://cran.r-project.org/web/packages/TraMineR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TraMineR/index.html](https://cran.r-project.org/web/packages/TraMineR/index.html) |
| Source record ids | cran_packages_by_date-73ac8eaa47beca |
...
For a systems engineer, TraMineR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2-14 | 2026-09-15 23:50:02 UTC | [https://cran.r-project.org/web/packages/TraMineR/DESCRIPTION](https://cran.r-project.org/web/packages/TraMineR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TraMineR/DESCRIPTION` at `2026-09-16T00:25:59+00:00`.
...
- `cran_packages_by_date-73ac8eaa47beca` from `cran_packages_by_date` as `registry_expansion`
