...
| Source record ids | github_search_cocoa-00160d7261ae2d |
...
For a systems engineer, Quick/Quick belongs in the Cocoa inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-18T15:19:28Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit; Other; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_cocoa-00160d7261ae2d` from `github_search_cocoa` as `registry_expansion`
