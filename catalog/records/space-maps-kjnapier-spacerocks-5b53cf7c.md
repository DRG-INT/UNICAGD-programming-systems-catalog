...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kjnapier/spacerocks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kjnapier/spacerocks](https://github.com/kjnapier/spacerocks) |
| Source record ids | github_search_space_maps-1799413e0553a4 |

## System Engineer Summary

Tools for solar system dynamics and observations.

## Operational Role

For a systems engineer, kjnapier/spacerocks belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-07T22:57:12Z | gh search repos topic:planetary-science stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-1799413e0553a4` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| peter-santana/Interactive-Sky-Map | Api Abi Checker | [open](space-maps-peter-santana-interactive-sky-map-9814667a.md) |
| shrey-sudo/Exoplanet-Habitable-Zone-Mapping | Api Abi Checker | [open](space-maps-shrey-sudo-exoplanet-habitable-zone-mapping-cdcf21b5.md) |
