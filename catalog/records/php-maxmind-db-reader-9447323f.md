...
<!-- canonical: https://packagist.org/packages/maxmind-db/reader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/maxmind-db/reader](https://packagist.org/packages/maxmind-db/reader) |
| Source record ids | packagist_search-e4f57913d1e3a9 |

## System Engineer Summary

maxmind-db/reader is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, maxmind-db/reader belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-e4f57913d1e3a9` from `packagist_search` as `registry_expansion`
