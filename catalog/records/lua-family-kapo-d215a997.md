...
| Canonical URL | [https://luarocks.org/modules/kaeza/kapo](https://luarocks.org/modules/kaeza/kapo) |
| Source record ids | luarocks_root_manifest-ae1e4f7677323d |
...
For a systems engineer, Kapo belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-ae1e4f7677323d` from `luarocks_root_manifest` as `registry_expansion`
