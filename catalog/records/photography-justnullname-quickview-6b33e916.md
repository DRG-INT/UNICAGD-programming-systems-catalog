...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/justnullname/QuickView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/justnullname/QuickView](https://github.com/justnullname/QuickView) |
| Source record ids | github_search_photography-79774de7ad338b |

## System Engineer Summary

The fastest Direct2D-powered image viewer for Windows. Features multi-threaded JXL/AVIF decoding,
GPU acceleration, and a borderless geek UI. Supports WebP, RAW, & QOI with visual settings and auto-
updates. Portable & SIMD-optimized.

## Operational Role

For a systems engineer, justnullname/QuickView belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T13:55:11Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-79774de7ad338b` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BigShoots/PGenerator-Plus | Testing Framework | [open](photography-bigshoots-pgenerator-plus-9c91b47a.md) |
| cnr-isti-vclab/piccante | Testing Framework | [open](photography-cnr-isti-vclab-piccante-e2c40130.md) |
| MikeKovarik/exifr | Testing Framework | [open](photography-mikekovarik-exifr-eeeac6dc.md) |
