...
<!-- canonical: https://crates.io/crates/futf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futf](https://crates.io/crates/futf) |
| Source record ids | crates_io-9134a0c8b59be8 |
...
For a systems engineer, futf belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2022-02-04T12:41:11.281402Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-9134a0c8b59be8` from `crates_io` as `registry_expansion`
