...
<!-- canonical: https://github.com/IFTTT/JazzHands -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IFTTT/JazzHands](https://github.com/IFTTT/JazzHands) |
| Source record ids | github_search_cocoa-1b01488250724e |
...
For a systems engineer, IFTTT/JazzHands belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-30T13:01:27Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-1b01488250724e` from `github_search_cocoa` as `registry_expansion`
