...
<!-- canonical: https://crates.io/crates/phf_shared -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/phf_shared](https://crates.io/crates/phf_shared) |
| Source record ids | crates_io-017173ce9fb5b6 |
...
For a systems engineer, phf_shared belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-06-21T00:37:12.234879Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-017173ce9fb5b6` from `crates_io` as `registry_expansion`
