...
<!-- canonical: https://github.com/QianMo/X-PostProcessing-Library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/QianMo/X-PostProcessing-Library](https://github.com/QianMo/X-PostProcessing-Library) |
| Source record ids | github_search_effects-0a3564f471e90e |
...
For a systems engineer, QianMo/X-PostProcessing-Library belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-14T17:42:11Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:post-processing stars:>50", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_effects-0a3564f471e90e` from `github_search_effects` as `registry_expansion`
...
| bandaloo/merge-pass | Filesystem Os | [open](effects-bandaloo-merge-pass-ebe955b1.md) |
