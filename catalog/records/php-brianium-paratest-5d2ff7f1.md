...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/brianium/paratest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/brianium/paratest](https://packagist.org/packages/brianium/paratest) |
| Source record ids | packagist_search-5b5da8ae0c4d88 |
...
For a systems engineer, brianium/paratest belongs in the PHP inventory as part of unit/integration
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-04 | `{"kind": "packagist_search_and_p2_api", "query": "testing", "retrieved": "2026-09-04", "status": "registry-derived"}` |
...
- `packagist_search-5b5da8ae0c4d88` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 10up/wp_mock | Testing Framework | [open](php-10up-wp-mock-b1eabddf.md) |
| allure-framework/allure-codeception | Testing Framework | [open](php-allure-framework-allure-codeception-d31ef854.md) |
| allure-framework/allure-phpunit | Testing Framework | [open](php-allure-framework-allure-phpunit-8d5922dc.md) |
| antecedent/patchwork | Testing Framework | [open](php-antecedent-patchwork-6b16f6b8.md) |
| auth0/login | Testing Framework | [open](php-auth0-login-2836946f.md) |
| behat/behat | Testing Framework | [open](php-behat-behat-1ac66d63.md) |
| behat/mink | Testing Framework | [open](php-behat-mink-39e58b31.md) |
| behat/mink-browserkit-driver | Testing Framework | [open](php-behat-mink-browserkit-driver-98d8bf49.md) |
