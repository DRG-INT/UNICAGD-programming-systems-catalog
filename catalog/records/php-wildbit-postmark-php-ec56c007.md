...
<!-- canonical: https://packagist.org/packages/wildbit/postmark-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/wildbit/postmark-php](https://packagist.org/packages/wildbit/postmark-php) |
| Source record ids | packagist_search-8bc45a33340166 |

## System Engineer Summary

The officially supported client for Postmark

## Operational Role

For a systems engineer, wildbit/postmark-php belongs in the PHP inventory as part of cross-language
...
- `packagist_search-8bc45a33340166` from `packagist_search` as `registry_expansion`
