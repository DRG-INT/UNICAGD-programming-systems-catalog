...
<!-- canonical: https://cran.r-project.org/web/packages/xegaGaGene/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xegaGaGene/index.html](https://cran.r-project.org/web/packages/xegaGaGene/index.html) |
| Source record ids | cran_packages_by_date-1ff5652915a7a0 |
...
For a systems engineer, xegaGaGene belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.7 | 2026-08-20 13:20:08 UTC | [https://cran.r-project.org/web/packages/xegaGaGene/DESCRIPTION](https://cran.r-project.org/web/packages/xegaGaGene/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xegaGaGene/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-1ff5652915a7a0` from `cran_packages_by_date` as `registry_expansion`
