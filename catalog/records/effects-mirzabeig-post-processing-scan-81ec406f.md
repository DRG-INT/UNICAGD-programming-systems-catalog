...
<!-- canonical: https://github.com/MirzaBeig/Post-Processing-Scan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MirzaBeig/Post-Processing-Scan](https://github.com/MirzaBeig/Post-Processing-Scan) |
| Source record ids | github_search_effects-ec1fe977fcfde1 |

## System Engineer Summary

A 3D scan/sonar-like post-processing effect for Unity. Essentially a visualization of a spherical
signed distance field (SDF).

## Operational Role

For a systems engineer, MirzaBeig/Post-Processing-Scan belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-05T10:53:19Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ec1fe977fcfde1` from `github_search_effects` as `registry_expansion`
