...
| Canonical URL | [https://github.com/Djdefrag/QualityScaler](https://github.com/Djdefrag/QualityScaler) |
| Source record ids | github_search_video-eaf0335acfc2d5 |
...
For a systems engineer, Djdefrag/QualityScaler belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.4 | 2026-08-26T16:14:26Z | [https://api.github.com/repos/Djdefrag/QualityScaler/releases/latest](https://api.github.com/repos/Djdefrag/QualityScaler/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Djdefrag/QualityScaler/releases/latest` at `2026-09-01T09:23:23+00:00`.
...
- `github_search_video-eaf0335acfc2d5` from `github_search_video` as `registry_expansion`
