...
<!-- canonical: https://github.com/grommet/grommet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grommet/grommet](https://github.com/grommet/grommet) |
| Source record ids | github_search_icons_and_logos-79dc829c077de2 |

## System Engineer Summary

a react-based framework that provides accessibility, modularity, responsiveness, and theming in a
tidy package

## Operational Role

For a systems engineer, grommet/grommet belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:22:33Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-79dc829c077de2` from `github_search_icons_and_logos` as `registry_expansion`
