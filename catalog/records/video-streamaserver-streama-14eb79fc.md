...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/streamaserver/streama -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/streamaserver/streama](https://github.com/streamaserver/streama) |
| Source record ids | github_search_video-cdfde010af3b3e |
...
For a systems engineer, streamaserver/streama belongs in the Video inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T20:24:33Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-cdfde010af3b3e` from `github_search_video` as `registry_expansion`
