...
<!-- canonical: https://github.com/lealone-plugins/QinSQL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lealone-plugins/QinSQL](https://github.com/lealone-plugins/QinSQL) |
| Source record ids | github_search_databases-c8648ad5048739 |

## System Engineer Summary

lealone-plugins/QinSQL is tracked as a database datastore record in the Databases branch. The source
...
For a systems engineer, lealone-plugins/QinSQL belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-09T16:32:14Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c8648ad5048739` from `github_search_databases` as `registry_expansion`
