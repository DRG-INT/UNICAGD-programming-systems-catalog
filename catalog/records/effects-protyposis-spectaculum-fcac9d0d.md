...
<!-- canonical: https://github.com/protyposis/Spectaculum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/protyposis/Spectaculum](https://github.com/protyposis/Spectaculum) |
| Source record ids | github_search_effects-b76e1a419e2a7e |
...
For a systems engineer, protyposis/Spectaculum belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-21T09:28:30Z | gh search repos topic:shader-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b76e1a419e2a7e` from `github_search_effects` as `registry_expansion`
