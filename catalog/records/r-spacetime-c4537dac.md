...
<!-- canonical: https://cran.r-project.org/web/packages/spacetime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spacetime/index.html](https://cran.r-project.org/web/packages/spacetime/index.html) |
| Source record ids | cran_packages_by_date-98acfa347fb1b8 |
...
For a systems engineer, spacetime belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3-4 | 2026-08-24 17:00:02 UTC | [https://cran.r-project.org/web/packages/spacetime/DESCRIPTION](https://cran.r-project.org/web/packages/spacetime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spacetime/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-98acfa347fb1b8` from `cran_packages_by_date` as `registry_expansion`
