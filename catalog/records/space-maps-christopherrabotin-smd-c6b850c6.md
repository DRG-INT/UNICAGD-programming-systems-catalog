...
| Source record ids | github_search_space_maps-cdb117c6cfd300 |
...
For a systems engineer, ChristopherRabotin/smd belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-18T01:07:09Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_space_maps-cdb117c6cfd300` from `github_search_space_maps` as `registry_expansion`
