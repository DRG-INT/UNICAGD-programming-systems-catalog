...
<!-- canonical: https://pub.dev/packages/ollama_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ollama_dart](https://pub.dev/packages/ollama_dart) |
| Source record ids | pub_dev-7c12cc66b7020d |

## System Engineer Summary

Dart client for the Ollama API to run LLMs locally (OpenAI gpt-oss, DeepSeek-R1, Gemma 3, Llama 4,
and more).

## Operational Role

For a systems engineer, ollama_dart belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.1 | 2026-09-02T12:16:56.989003Z | [https://pub.dev/api/packages/ollama_dart](https://pub.dev/api/packages/ollama_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ollama_dart` at `2026-09-12T21:19:19+00:00`.
...
- `pub_dev-7c12cc66b7020d` from `pub_dev` as `registry_expansion`
