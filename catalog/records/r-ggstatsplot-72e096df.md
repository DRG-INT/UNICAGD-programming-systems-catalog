...
<!-- canonical: https://cran.r-project.org/web/packages/ggstatsplot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggstatsplot/index.html](https://cran.r-project.org/web/packages/ggstatsplot/index.html) |
| Source record ids | cran_packages_by_date-7c034054f00c57 |
...
For a systems engineer, ggstatsplot belongs in the R inventory as part of model pipelines, numerical
runtime constraints, and data/deployment interfaces.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-25 05:20:37 UTC | [https://cran.r-project.org/web/packages/ggstatsplot/DESCRIPTION](https://cran.r-project.org/web/packages/ggstatsplot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggstatsplot/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7c034054f00c57` from `cran_packages_by_date` as `registry_expansion`
...
| AQIR | Machine Learning | [open](r-aqir-ac8c783f.md) |
| AutoGenAI | Machine Learning | [open](r-autogenai-3635fb7a.md) |
