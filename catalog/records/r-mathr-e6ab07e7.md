...
<!-- canonical: https://cran.r-project.org/web/packages/mathr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mathr/index.html](https://cran.r-project.org/web/packages/mathr/index.html) |
| Source record ids | cran_packages_by_date-206b96b3909dcc |
...
For a systems engineer, mathr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-10 15:10:02 UTC | [https://cran.r-project.org/web/packages/mathr/DESCRIPTION](https://cran.r-project.org/web/packages/mathr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mathr/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-206b96b3909dcc` from `cran_packages_by_date` as `registry_expansion`
