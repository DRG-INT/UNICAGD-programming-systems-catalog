...
<!-- canonical: https://cran.r-project.org/web/packages/OptOR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OptOR/index.html](https://cran.r-project.org/web/packages/OptOR/index.html) |
| Source record ids | cran_packages_by_date-6f173e71a664c0 |

## System Engineer Summary

Optimal Hyperrectangular Operating Regions

## Operational Role

For a systems engineer, OptOR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:10:39 UTC | [https://cran.r-project.org/web/packages/OptOR/DESCRIPTION](https://cran.r-project.org/web/packages/OptOR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OptOR/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-6f173e71a664c0` from `cran_packages_by_date` as `registry_expansion`
