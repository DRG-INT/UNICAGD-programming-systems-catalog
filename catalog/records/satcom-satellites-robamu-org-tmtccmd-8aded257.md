...
<!-- canonical: https://github.com/robamu-org/tmtccmd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/robamu-org/tmtccmd](https://github.com/robamu-org/tmtccmd) |
| Source record ids | github_search_satcom_satellites-73227815fb1edc |

## System Engineer Summary

robamu-org/tmtccmd is tracked as a library record in the SatCom Satellites branch. The source did
...
For a systems engineer, robamu-org/tmtccmd belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-14T11:22:06Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-73227815fb1edc` from `github_search_satcom_satellites` as `registry_expansion`
