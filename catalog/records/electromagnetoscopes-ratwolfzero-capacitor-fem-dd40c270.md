...
<!-- canonical: https://github.com/ratwolfzero/Capacitor_FEM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ratwolfzero/Capacitor_FEM](https://github.com/ratwolfzero/Capacitor_FEM) |
| Source record ids | github_search_electromagnetoscopes-63fd127e252fa7 |

## System Engineer Summary

A self-contained 2D finite-element electrostatics solver for simulating real capacitor geometries —
parallel plates, coaxial cables, and arbitrary shapes built from simple primitives — rather than
relying on closed-form formulas that only exist for a handful of idealized geometries. Pure NumPy /
SciPy / Matplotlib.

## Operational Role

For a systems engineer, ratwolfzero/Capacitor_FEM belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T19:55:58Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-63fd127e252fa7` from `github_search_electromagnetoscopes` as `registry_expansion`
