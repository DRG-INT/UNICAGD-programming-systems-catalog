...
<!-- canonical: https://github.com/kane50613/takumi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kane50613/takumi](https://github.com/kane50613/takumi) |
| Source record ids | github_search_webassembly-b19cf274b80bcf |

## System Engineer Summary

Render OG images and paged PDFs from JSX, HTML, and CSS. No headless browser. Runs on Node.js,
Cloudflare Workers, browsers, and Rust.

## Operational Role

For a systems engineer, kane50613/takumi belongs in the WebAssembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:51:31Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b19cf274b80bcf` from `github_search_webassembly` as `registry_expansion`
