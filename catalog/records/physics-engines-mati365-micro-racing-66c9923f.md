...
<!-- canonical: https://github.com/Mati365/micro-racing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mati365/micro-racing](https://github.com/Mati365/micro-racing) |
| Source record ids | github_search_physics_engines-d26b8d19b3d0e3 |

## System Engineer Summary

🚗 🏎️ 🎮 A browser-based isometric racing game built with a custom WebGL 1.x engine. Features real-
time multiplayer with client-side prediction, spatial optimizations via quad trees, and AI opponents
powered by neural networks trained through genetic algorithms.

## Operational Role

For a systems engineer, Mati365/micro-racing belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-05T05:13:10Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-d26b8d19b3d0e3` from `github_search_physics_engines` as `registry_expansion`
