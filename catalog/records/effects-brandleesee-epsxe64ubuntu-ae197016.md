...
<!-- canonical: https://github.com/brandleesee/ePSXe64Ubuntu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brandleesee/ePSXe64Ubuntu](https://github.com/brandleesee/ePSXe64Ubuntu) |
| Source record ids | github_search_effects-78ace98b595e53 |

## System Engineer Summary

OBSOLETE - ePSXe64Ubuntu is an interactive script that installs ePSXe Linux (x64) & shaders using
BIOS HLE and Core Plugins on x86-64 Debian, Ubuntu, Linux Mint, and their derivatives.

## Operational Role

For a systems engineer, brandleesee/ePSXe64Ubuntu belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-20T07:52:14Z | gh search repos topic:shader-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-78ace98b595e53` from `github_search_effects` as `registry_expansion`
