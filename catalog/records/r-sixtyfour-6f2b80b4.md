...
<!-- canonical: https://cran.r-project.org/web/packages/sixtyfour/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sixtyfour/index.html](https://cran.r-project.org/web/packages/sixtyfour/index.html) |
| Source record ids | cran_packages_by_date-599ba0ee152687 |
...
For a systems engineer, sixtyfour belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-08-28 07:00:17 UTC | [https://cran.r-project.org/web/packages/sixtyfour/DESCRIPTION](https://cran.r-project.org/web/packages/sixtyfour/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sixtyfour/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-599ba0ee152687` from `cran_packages_by_date` as `registry_expansion`
