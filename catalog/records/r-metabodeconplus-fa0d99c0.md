...
<!-- canonical: https://cran.r-project.org/web/packages/metabodeconplus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metabodeconplus/index.html](https://cran.r-project.org/web/packages/metabodeconplus/index.html) |
| Source record ids | cran_packages_by_date-3a17d4f491d980 |

## System Engineer Summary

Deconvolution, Alignment and Model Fitting of 1d NMR Spectra

## Operational Role

For a systems engineer, metabodeconplus belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.0 | 2026-08-09 07:30:08 UTC | [https://cran.r-project.org/web/packages/metabodeconplus/DESCRIPTION](https://cran.r-project.org/web/packages/metabodeconplus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metabodeconplus/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3a17d4f491d980` from `cran_packages_by_date` as `registry_expansion`
