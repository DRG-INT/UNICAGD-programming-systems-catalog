...
<!-- canonical: https://cran.r-project.org/web/packages/tidydann/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidydann/index.html](https://cran.r-project.org/web/packages/tidydann/index.html) |
| Source record ids | cran_packages_by_date-22c029fcffb5a1 |
...
For a systems engineer, tidydann belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-29 18:00:02 UTC | [https://cran.r-project.org/web/packages/tidydann/DESCRIPTION](https://cran.r-project.org/web/packages/tidydann/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidydann/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-22c029fcffb5a1` from `cran_packages_by_date` as `registry_expansion`
