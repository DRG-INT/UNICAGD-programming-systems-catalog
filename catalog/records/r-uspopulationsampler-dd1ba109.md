...
<!-- canonical: https://cran.r-project.org/web/packages/USPopulationSampler/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/USPopulationSampler/index.html](https://cran.r-project.org/web/packages/USPopulationSampler/index.html) |
| Source record ids | cran_packages_by_date-fabfcc63ada5fa |
...
For a systems engineer, USPopulationSampler belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-12 14:20:16 UTC | [https://cran.r-project.org/web/packages/USPopulationSampler/DESCRIPTION](https://cran.r-project.org/web/packages/USPopulationSampler/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/USPopulationSampler/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-fabfcc63ada5fa` from `cran_packages_by_date` as `registry_expansion`
