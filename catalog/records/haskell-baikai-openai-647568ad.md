...
<!-- canonical: https://hackage.haskell.org/package/baikai-openai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/baikai-openai](https://hackage.haskell.org/package/baikai-openai) |
| Source record ids | hackage_recent-d7868fd72b635a |
...
For a systems engineer, baikai-openai belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.0 | 2026-09-08T14:51:07Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-d7868fd72b635a` from `hackage_recent` as `registry_expansion`
