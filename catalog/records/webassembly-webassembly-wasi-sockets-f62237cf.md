...
<!-- canonical: https://github.com/WebAssembly/wasi-sockets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/wasi-sockets](https://github.com/WebAssembly/wasi-sockets) |
| Source record ids | github_search_webassembly-b426a3f408c904 |
...
For a systems engineer, WebAssembly/wasi-sockets belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T22:55:39Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b426a3f408c904` from `github_search_webassembly` as `registry_expansion`
