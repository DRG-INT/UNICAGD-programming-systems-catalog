...
<!-- canonical: https://cran.r-project.org/web/packages/UBStats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/UBStats/index.html](https://cran.r-project.org/web/packages/UBStats/index.html) |
| Source record ids | cran_packages_by_date-5e73943f52da7e |

## System Engineer Summary

UBStats is tracked as an undefined behavior analyzer record in the R branch. The source did not
...
For a systems engineer, UBStats belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.3 | 2026-08-29 10:20:02 UTC | [https://cran.r-project.org/web/packages/UBStats/DESCRIPTION](https://cran.r-project.org/web/packages/UBStats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/UBStats/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5e73943f52da7e` from `cran_packages_by_date` as `registry_expansion`
