...
<!-- canonical: https://github.com/maptiler/maptiler-geocoding-control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maptiler/maptiler-geocoding-control](https://github.com/maptiler/maptiler-geocoding-control) |
| Source record ids | github_search_maps-bc7b7aecc4f3c3 |

## System Engineer Summary

The Javascript & TypeScript Map Control component for MapTiler Geocoding service! Easy to be
integrated into any JavaScript mapping application.

## Operational Role

For a systems engineer, maptiler/maptiler-geocoding-control belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.0 | 2026-04-08T02:40:31Z | [https://api.github.com/repos/maptiler/maptiler-geocoding-control/releases/latest](https://api.github.com/repos/maptiler/maptiler-geocoding-control/releases/latest) |  |
| preview | known | v3.1.0-rc.3 | 2026-07-29T11:57:08Z | [https://api.github.com/repos/maptiler/maptiler-geocoding-control/releases?per_page=10](https://api.github.com/repos/maptiler/maptiler-geocoding-control/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/maptiler/maptiler-geocoding-control/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-bc7b7aecc4f3c3` from `github_search_maps` as `registry_expansion`
