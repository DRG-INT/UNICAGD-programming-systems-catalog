...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/milvus-io/bootcamp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/milvus-io/bootcamp](https://github.com/milvus-io/bootcamp) |
| Source record ids | github_search_databases-4268edf8211e60 |

## System Engineer Summary

Dealing with all unstructured data, such as reverse image search, audio search, molecular search,
video analysis, question and answer systems, NLP, etc.

## Operational Role

For a systems engineer, milvus-io/bootcamp belongs in the Databases inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T09:14:04Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4268edf8211e60` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DataBrewery/cubes | Static Analyzer | [open](databases-databrewery-cubes-5a028f66.md) |
| donnemartin/dev-setup | Static Analyzer | [open](databases-donnemartin-dev-setup-b0548ea3.md) |
| NygenAnalytics/scarf | Static Analyzer | [open](databases-nygenanalytics-scarf-8496d3f8.md) |
| rupurt/odbc-scanner-duckdb-extension | Static Analyzer | [open](databases-rupurt-odbc-scanner-duckdb-extension-71eefae9.md) |
| shzlw/poli | Static Analyzer | [open](databases-shzlw-poli-beee279d.md) |
