...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClaudeCodeSDK](https://github.com/JuliaRegistries/General/tree/master/C/ClaudeCodeSDK) |
| Source record ids | julia_general-e8ba727fdb3015 |

## System Engineer Summary

Julia package registered in General at C/ClaudeCodeSDK.

## Operational Role

For a systems engineer, ClaudeCodeSDK belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClaudeCodeSDK", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-e8ba727fdb3015` from `julia_general` as `registry_expansion`
