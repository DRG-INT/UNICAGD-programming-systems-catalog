...
<!-- canonical: https://cran.r-project.org/web/packages/refugees/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/refugees/index.html](https://cran.r-project.org/web/packages/refugees/index.html) |
| Source record ids | cran_packages_by_date-b0d4107b75f598 |
...
For a systems engineer, refugees belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2025.12.2 | 2026-08-19 22:20:02 UTC | [https://cran.r-project.org/web/packages/refugees/DESCRIPTION](https://cran.r-project.org/web/packages/refugees/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/refugees/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b0d4107b75f598` from `cran_packages_by_date` as `registry_expansion`
