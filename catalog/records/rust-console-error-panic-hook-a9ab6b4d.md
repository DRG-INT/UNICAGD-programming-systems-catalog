...
<!-- canonical: https://crates.io/crates/console_error_panic_hook -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/console_error_panic_hook](https://crates.io/crates/console_error_panic_hook) |
| Source record ids | crates_io-a124123d84a6fa |
...
For a systems engineer, console_error_panic_hook belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2021-10-11T17:01:02.936833Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-a124123d84a6fa` from `crates_io` as `registry_expansion`
...
| env_filter | Logging Observability | [open](rust-env-filter-ad832d12.md) |
