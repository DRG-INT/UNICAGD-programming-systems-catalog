...
<!-- canonical: https://github.com/baztian/jaydebeapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/baztian/jaydebeapi](https://github.com/baztian/jaydebeapi) |
| Source record ids | github_search_databases-0a9cf8e4bc1f66 |

## System Engineer Summary

JayDeBeApi module allows you to connect from Python code to databases using Java JDBC. It provides a
Python DB-API v2.0 to that database.

## Operational Role

For a systems engineer, baztian/jaydebeapi belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-03T11:26:59Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- `github_search_databases-0a9cf8e4bc1f66` from `github_search_databases` as `registry_expansion`
