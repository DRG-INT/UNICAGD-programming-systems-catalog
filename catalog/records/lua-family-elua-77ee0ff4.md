...
<!-- canonical: http://www.eluaproject.net/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://www.eluaproject.net/](http://www.eluaproject.net/) |
| Source record ids | lua-source-236 |

## System Engineer Summary

Lua, extended with optimizations and specific features for efficient and portable embedded software
development.

## Operational Role

For a systems engineer, eLua belongs in the Lua family inventory as part of cross-language
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 236}}` |
...
- `lua-source-236` from `master_json` as `source_list_item`
