...
<!-- canonical: https://github.com/Malidos/Stylized-Water-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Malidos/Stylized-Water-Shader](https://github.com/Malidos/Stylized-Water-Shader) |
| Source record ids | github_search_effects-9dcc79b19e64e4 |

## System Engineer Summary

An advanced water shader that samples the screen texture and absorbs defined color values depending
on depth. Comes with simple player interactions and refraction. Reflections are possible through
Godot's own post-processing methods.

## Operational Role

For a systems engineer, Malidos/Stylized-Water-Shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-11T15:47:23Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT + file LICENSE; {"key": "", "name": "", "url": ""}; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- `github_search_effects-9dcc79b19e64e4` from `github_search_effects` as `registry_expansion`
