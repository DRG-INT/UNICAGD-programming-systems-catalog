...
<!-- canonical: https://cran.r-project.org/web/packages/gamstransfer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gamstransfer/index.html](https://cran.r-project.org/web/packages/gamstransfer/index.html) |
| Source record ids | cran_packages_by_date-859ca29b71d718 |
...
For a systems engineer, gamstransfer belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.9 | 2026-09-09 12:00:07 UTC | [https://cran.r-project.org/web/packages/gamstransfer/DESCRIPTION](https://cran.r-project.org/web/packages/gamstransfer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gamstransfer/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-859ca29b71d718` from `cran_packages_by_date` as `registry_expansion`
