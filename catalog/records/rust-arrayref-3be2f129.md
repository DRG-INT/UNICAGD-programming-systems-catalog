...
<!-- canonical: https://crates.io/crates/arrayref -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/arrayref](https://crates.io/crates/arrayref) |
| Source record ids | crates_io-493dcedbdd6b74 |
...
For a systems engineer, arrayref belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.9 | 2026-08-20T07:15:00.821563Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-493dcedbdd6b74` from `crates_io` as `registry_expansion`
