# Gitea: catnipteaparty/empirical-reasoning-language-model
...
<!-- canonical: https://gitea.com/catnipteaparty/empirical-reasoning-language-model -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/catnipteaparty/empirical-reasoning-language-model](https://gitea.com/catnipteaparty/empirical-reasoning-language-model) |
| Source record ids | gitea_repositories_api-c9d98a65538594 |
...
For a systems engineer, Gitea: catnipteaparty/empirical-reasoning-language-model belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T07:52:18Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-01 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "language", "retrieved": "2026-09-01", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-c9d98a65538594` from `gitea_repositories_api` as `registry_expansion`
...
| Gitea: eq/CursorLanguageIndicator | Language Specification | [open](repository-workplaces-gitea-eq-cursorlanguageindicator-3fe5fdec.md) |
