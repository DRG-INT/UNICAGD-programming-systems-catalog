...
<!-- canonical: https://cran.r-project.org/web/packages/Directional/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Directional/index.html](https://cran.r-project.org/web/packages/Directional/index.html) |
| Source record ids | cran_packages_by_date-b4ca765cd984fe |
...
For a systems engineer, Directional belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.8 | 2026-09-02 12:20:22 UTC | [https://cran.r-project.org/web/packages/Directional/DESCRIPTION](https://cran.r-project.org/web/packages/Directional/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Directional/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-b4ca765cd984fe` from `cran_packages_by_date` as `registry_expansion`
