...
<!-- canonical: https://github.com/adrische/quant-jobs-zurich -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adrische/quant-jobs-zurich](https://github.com/adrische/quant-jobs-zurich) |
| Source record ids | github_search_assets-a17228fed01cf7 |

## System Engineer Summary

A list of companies of possible interest for mathematicians (or related) that are looking for a job
in quantitative finance in Zurich.

## Operational Role

For a systems engineer, adrische/quant-jobs-zurich belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-06T09:08:53Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_assets-a17228fed01cf7` from `github_search_assets` as `registry_expansion`
