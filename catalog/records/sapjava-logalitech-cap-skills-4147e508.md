...
<!-- canonical: https://github.com/logalitech/cap-skills -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/logalitech/cap-skills](https://github.com/logalitech/cap-skills) |
| Source record ids | github_search_sapjava-2eeefe2c0a1955 |

## System Engineer Summary

Agent Skills de Logali Tech para SAP CAP: modelado CDS, service handlers (Node.js/Java),
autorización XSUAA, servicios remotos y despliegue en BTP.

## Operational Role

For a systems engineer, logalitech/cap-skills belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T09:07:37Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-2eeefe2c0a1955` from `github_search_sapjava` as `registry_expansion`
...
| SAP/cloud-metricswatcher | Logging Observability | [open](sapjava-sap-cloud-metricswatcher-128bcc69.md) |
