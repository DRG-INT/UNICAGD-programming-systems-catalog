...
<!-- canonical: https://hackage.haskell.org/package/scip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/scip](https://hackage.haskell.org/package/scip) |
| Source record ids | hackage_recent-cafe48bb462f82 |

## System Engineer Summary

Hackage package recently uploaded by jupblb.

## Operational Role

For a systems engineer, scip belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-09-03T18:39:59Z | [https://hackage.haskell.org/package/scip](https://hackage.haskell.org/package/scip) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/scip` at `2026-09-04T13:25:57+00:00`.
...
- `hackage_recent-cafe48bb462f82` from `hackage_recent` as `registry_expansion`
