...
<!-- canonical: https://luarocks.org/modules/siffiejoe/bit32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/siffiejoe/bit32](https://luarocks.org/modules/siffiejoe/bit32) |
| Source record ids | luarocks_root_manifest-baa14f1afd2dff |
...
For a systems engineer, bit32 belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-baa14f1afd2dff` from `luarocks_root_manifest` as `registry_expansion`
