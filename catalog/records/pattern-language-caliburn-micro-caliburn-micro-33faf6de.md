...
| Canonical URL | [https://github.com/Caliburn-Micro/Caliburn.Micro](https://github.com/Caliburn-Micro/Caliburn.Micro) |
| Source record ids | github_search_pattern_language-10bb85898406ba |

## System Engineer Summary

A small, yet powerful framework, designed for building applications across all XAML platforms. Its
strong support for MV* patterns will enable you to build your solution quickly, without the need to
sacrifice code quality or testability.

## Operational Role

For a systems engineer, Caliburn-Micro/Caliburn.Micro belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.258 | 2025-10-14T00:34:56Z | [https://api.github.com/repos/Caliburn-Micro/Caliburn.Micro/releases/latest](https://api.github.com/repos/Caliburn-Micro/Caliburn.Micro/releases/latest) |  |
| preview | known | 4.0.136-rc | 2020-06-21T11:07:56Z | [https://api.github.com/repos/Caliburn-Micro/Caliburn.Micro/releases?per_page=10](https://api.github.com/repos/Caliburn-Micro/Caliburn.Micro/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Caliburn-Micro/Caliburn.Micro/releases/latest` at `2026-09-01T10:25:53+00:00`.
...
- `github_search_pattern_language-10bb85898406ba` from `github_search_pattern_language` as `registry_expansion`
