...
<!-- canonical: https://github.com/kanaka/wac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kanaka/wac](https://github.com/kanaka/wac) |
| Source record ids | awesome_list-f3d1ce8fac29ae |

## System Engineer Summary

wac - WebAssembly in C (x86) is tracked as a library record in the WebAssembly branch. The source
...
For a systems engineer, wac - WebAssembly in C (x86) belongs in the WebAssembly inventory as part of
...
- `awesome_list-f3d1ce8fac29ae` from `awesome_list` as `registry_expansion`
