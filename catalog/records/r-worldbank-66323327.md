...
<!-- canonical: https://cran.r-project.org/web/packages/worldbank/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/worldbank/index.html](https://cran.r-project.org/web/packages/worldbank/index.html) |
| Source record ids | cran_packages_by_date-54b857836ee804 |
...
For a systems engineer, worldbank belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-08-21 05:40:02 UTC | [https://cran.r-project.org/web/packages/worldbank/DESCRIPTION](https://cran.r-project.org/web/packages/worldbank/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/worldbank/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-54b857836ee804` from `cran_packages_by_date` as `registry_expansion`
