...
| Canonical URL | [https://crates.io/crates/inflections](https://crates.io/crates/inflections) |
| Source record ids | crates_io-9d1a642da77d32 |
...
For a systems engineer, inflections belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2017-09-14T17:51:25.170557Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-9d1a642da77d32` from `crates_io` as `registry_expansion`
