...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bethrobson/Head-First-Design-Patterns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bethrobson/Head-First-Design-Patterns](https://github.com/bethrobson/Head-First-Design-Patterns) |
| Source record ids | github_search_pattern_language-1ed7ea882bb199 |
...
For a systems engineer, bethrobson/Head-First-Design-Patterns belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-05T09:09:01Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-1ed7ea882bb199` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| krasimir/react-in-patterns | Tutorial Book Styleguide | [open](pattern-language-krasimir-react-in-patterns-a1f72d2b.md) |
