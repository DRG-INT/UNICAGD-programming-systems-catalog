...
<!-- canonical: https://luarocks.org/modules/s1m0n38/ctx.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/s1m0n38/ctx.nvim](https://luarocks.org/modules/s1m0n38/ctx.nvim) |
| Source record ids | luarocks_root_manifest-df98b4eda98c4c |

## System Engineer Summary

⧉ Quickfix / Location List Items → Markdown

## Operational Role

For a systems engineer, ctx.nvim belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-df98b4eda98c4c` from `luarocks_root_manifest` as `registry_expansion`
