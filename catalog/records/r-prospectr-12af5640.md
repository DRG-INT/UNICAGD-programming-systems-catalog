...
<!-- canonical: https://cran.r-project.org/web/packages/prospectr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prospectr/index.html](https://cran.r-project.org/web/packages/prospectr/index.html) |
| Source record ids | cran_packages_by_date-e4f8999643bac8 |
...
For a systems engineer, prospectr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2026-08-25 05:20:14 UTC | [https://cran.r-project.org/web/packages/prospectr/DESCRIPTION](https://cran.r-project.org/web/packages/prospectr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prospectr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e4f8999643bac8` from `cran_packages_by_date` as `registry_expansion`
