...
| Canonical URL | [https://github.com/acerbilab/bads](https://github.com/acerbilab/bads) |
| Source record ids | github_search_matlab-d997c9c63ce522 |
...
For a systems engineer, acerbilab/bads belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.3 | 2025-12-05T17:27:27Z | [https://api.github.com/repos/acerbilab/bads/releases/latest](https://api.github.com/repos/acerbilab/bads/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/acerbilab/bads/releases/latest` at `2026-09-01T07:24:08+00:00`.
...
- `github_search_matlab-d997c9c63ce522` from `github_search_matlab` as `registry_expansion`
