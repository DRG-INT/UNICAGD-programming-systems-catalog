...
<!-- canonical: https://github.com/Kavex/GameDev-Resources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kavex/GameDev-Resources](https://github.com/Kavex/GameDev-Resources) |
| Source record ids | github_search_game_engines-7a48125ea45042 |
...
For a systems engineer, Kavex/GameDev-Resources belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T19:20:30Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-7a48125ea45042` from `github_search_game_engines` as `registry_expansion`
...
| opentk/opentk | Ide Editor Integration | [open](game-engines-opentk-opentk-5bd354d6.md) |
