...
| Canonical URL | [https://github.com/0xAX/asm](https://github.com/0xAX/asm) |
| Source record ids | github_search_assembly-06de38807fce74 |
...
For a systems engineer, 0xAX/asm belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.1 | 2026-08-25T10:09:33Z | [https://api.github.com/repos/0xAX/asm/releases/latest](https://api.github.com/repos/0xAX/asm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/0xAX/asm/releases/latest` at `2026-09-01T07:24:24+00:00`.
...
- `github_search_assembly-06de38807fce74` from `github_search_assembly` as `registry_expansion`
