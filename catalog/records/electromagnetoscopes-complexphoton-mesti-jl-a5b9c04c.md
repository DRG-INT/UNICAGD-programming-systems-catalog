...
<!-- canonical: https://github.com/complexphoton/MESTI.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/complexphoton/MESTI.jl](https://github.com/complexphoton/MESTI.jl) |
| Source record ids | github_search_electromagnetoscopes-4ae6c70579429c |

## System Engineer Summary

3D multi-source electromagnetic simulations in frequency domain, implementing the augmented partial
factorization (APF) and other methods.

## Operational Role

For a systems engineer, complexphoton/MESTI.jl belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-11T04:59:52Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-4ae6c70579429c` from `github_search_electromagnetoscopes` as `registry_expansion`
