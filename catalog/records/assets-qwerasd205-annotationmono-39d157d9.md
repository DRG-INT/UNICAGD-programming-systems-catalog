...
<!-- canonical: https://github.com/qwerasd205/AnnotationMono -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qwerasd205/AnnotationMono](https://github.com/qwerasd205/AnnotationMono) |
| Source record ids | github_search_assets-1470cb27d7871a |
...
For a systems engineer, qwerasd205/AnnotationMono belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-28T05:24:50Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-1470cb27d7871a` from `github_search_assets` as `registry_expansion`
