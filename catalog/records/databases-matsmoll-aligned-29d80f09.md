...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/MatsMoll/aligned -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MatsMoll/aligned](https://github.com/MatsMoll/aligned) |
| Source record ids | github_search_databases-56da1528231755 |
...
For a systems engineer, MatsMoll/aligned belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-16T10:40:42Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-56da1528231755` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| giancarloerra/SocratiCode | Dependency Manager | [open](databases-giancarloerra-socraticode-bcc8ee56.md) |
| Lulzx/zs3 | Dependency Manager | [open](databases-lulzx-zs3-f630b3a4.md) |
| philippgille/chromem-go | Dependency Manager | [open](databases-philippgille-chromem-go-fd3fa6e9.md) |
| SleekDB/SleekDB | Dependency Manager | [open](databases-sleekdb-sleekdb-44bd7f0e.md) |
