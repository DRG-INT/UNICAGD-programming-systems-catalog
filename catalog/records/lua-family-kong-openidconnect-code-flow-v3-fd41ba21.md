# kong-openidconnect-code-flow-v3
...
| Canonical URL | [https://luarocks.org/modules/elisiumm/kong-openidconnect-code-flow-v3](https://luarocks.org/modules/elisiumm/kong-openidconnect-code-flow-v3) |
| Source record ids | luarocks_root_manifest-0200f9a695df9e |
...
For a systems engineer, kong-openidconnect-code-flow-v3 belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-0200f9a695df9e` from `luarocks_root_manifest` as `registry_expansion`
