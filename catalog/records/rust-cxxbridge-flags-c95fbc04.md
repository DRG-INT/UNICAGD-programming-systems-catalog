...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Compiler](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compiler.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/cxxbridge-flags](https://crates.io/crates/cxxbridge-flags) |
| Source record ids | crates_io-347d46d911a378 |
...
For a systems engineer, cxxbridge-flags belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.199 | 2026-08-08T06:52:59.395792Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| autocfg | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-autocfg-ca0f8a64.md) |
| cc | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cc-40676e0b.md) |
| clang-sys | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-clang-sys-f1961db1.md) |
| cmov | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cmov-061e5bcb.md) |
| compiler_builtins | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-compiler-builtins-aa173dbd.md) |
| gcc | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-gcc-09b58dce.md) |
| libfuzzer-sys | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-libfuzzer-sys-61022c5c.md) |
| miette | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-miette-197355ef.md) |
