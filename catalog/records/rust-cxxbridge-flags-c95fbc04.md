...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/cxxbridge-flags -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.200 | 2026-09-04T20:29:52.414572Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | Artistic-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-04T22:18:06+00:00`.
...
- `crates_io-347d46d911a378` from `crates_io` as `registry_expansion`
