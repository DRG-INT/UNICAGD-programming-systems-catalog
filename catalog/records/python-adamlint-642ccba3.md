...
<!-- canonical: https://pypi.org/project/adamlint/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adamlint/](https://pypi.org/project/adamlint/) |
| Source record ids | pypi_simple-0ea05a124afa2a |

## System Engineer Summary

A linter launcher for projects that have multiple source languages.

## Operational Role

For a systems engineer, adamlint belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2025-08-30T18:35:07.398419Z | [https://pypi.org/pypi/adamlint/json](https://pypi.org/pypi/adamlint/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adamlint/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-0ea05a124afa2a` from `pypi_simple` as `registry_expansion`
