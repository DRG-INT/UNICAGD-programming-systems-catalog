...
<!-- canonical: https://cran.r-project.org/web/packages/FuzzyLogit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FuzzyLogit/index.html](https://cran.r-project.org/web/packages/FuzzyLogit/index.html) |
| Source record ids | cran_packages_by_date-58c0935e6263ba |
...
For a systems engineer, FuzzyLogit belongs in the R inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-09 09:40:14 UTC | [https://cran.r-project.org/web/packages/FuzzyLogit/DESCRIPTION](https://cran.r-project.org/web/packages/FuzzyLogit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FuzzyLogit/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-58c0935e6263ba` from `cran_packages_by_date` as `registry_expansion`
