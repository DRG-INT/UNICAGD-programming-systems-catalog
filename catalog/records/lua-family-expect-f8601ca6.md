...
| Canonical URL | [https://luarocks.org/modules/sveyret/expect](https://luarocks.org/modules/sveyret/expect) |
| Source record ids | luarocks_root_manifest-ff40df22948561 |
...
For a systems engineer, expect belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-ff40df22948561` from `luarocks_root_manifest` as `registry_expansion`
