...
| Canonical URL | [https://crates.io/crates/encoding_rs_io](https://crates.io/crates/encoding_rs_io) |
| Source record ids | crates_io-5eddccb6a847bc |
...
For a systems engineer, encoding_rs_io belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2026-08-04T12:47:28.970320Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-5eddccb6a847bc` from `crates_io` as `registry_expansion`
