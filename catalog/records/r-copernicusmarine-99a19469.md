...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/CopernicusMarine/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CopernicusMarine/index.html](https://cran.r-project.org/web/packages/CopernicusMarine/index.html) |
| Source record ids | cran_packages_by_date-e34097ced141c1 |
...
For a systems engineer, CopernicusMarine belongs in the R inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.9 | 2026-08-28 10:10:02 UTC | [https://cran.r-project.org/web/packages/CopernicusMarine/DESCRIPTION](https://cran.r-project.org/web/packages/CopernicusMarine/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CopernicusMarine/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e34097ced141c1` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| agecrypt | Formatter | [open](r-agecrypt-ecdcf1cd.md) |
| bain | Formatter | [open](r-bain-318aac57.md) |
| bbotk | Formatter | [open](r-bbotk-73f02c1f.md) |
| BIDistances | Formatter | [open](r-bidistances-4d1001bb.md) |
| cffr | Formatter | [open](r-cffr-761a4643.md) |
| collapse | Formatter | [open](r-collapse-8082d6f3.md) |
| danlex | Formatter | [open](r-danlex-f8075393.md) |
| datawizard | Formatter | [open](r-datawizard-62fb7afc.md) |
