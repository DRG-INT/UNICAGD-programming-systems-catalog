...
[Catalog index](../index.md) · [Language: Starlark](../by-language/starlark.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/KCarretto/paragon](https://github.com/KCarretto/paragon) |
| Source record ids | github_search_starlark-9cf980e98ceb40 |
...
For a systems engineer, KCarretto/paragon belongs in the Starlark inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.4 | 2022-02-05T05:53:22Z | [https://api.github.com/repos/KCarretto/paragon/releases/latest](https://api.github.com/repos/KCarretto/paragon/releases/latest) |  |
| preview | known | v0.4.0 | 2020-04-24T01:33:28Z | [https://api.github.com/repos/KCarretto/paragon/releases?per_page=10](https://api.github.com/repos/KCarretto/paragon/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/KCarretto/paragon/releases/latest` at `2026-09-01T09:23:07+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:starlark stars:>100", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_starlark-9cf980e98ceb40` from `github_search_starlark` as `registry_expansion`
