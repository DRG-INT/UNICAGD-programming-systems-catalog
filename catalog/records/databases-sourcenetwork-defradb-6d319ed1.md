...
<!-- canonical: https://github.com/sourcenetwork/defradb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sourcenetwork/defradb](https://github.com/sourcenetwork/defradb) |
| Source record ids | github_search_databases-28d36a15a7b6ec |

## System Engineer Summary

DefraDB is a Peer-to-Peer Edge-First Database. It's the core data storage system for the Source
Ecosystem.

## Operational Role

For a systems engineer, sourcenetwork/defradb belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:16:05Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-28d36a15a7b6ec` from `github_search_databases` as `registry_expansion`
