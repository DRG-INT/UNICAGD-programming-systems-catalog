...
<!-- canonical: https://github.com/dabana/TEM_dash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dabana/TEM_dash](https://github.com/dabana/TEM_dash) |
| Source record ids | github_search_electromagnetoscopes-ff4a0f990d4ce3 |

## System Engineer Summary

A Dash application to visualize time-domain electromagnectic soundings (TEM) modeled with UBC-GIF
em1dtmfwd

## Operational Role

For a systems engineer, dabana/TEM_dash belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-09-25T11:40:19Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-ff4a0f990d4ce3` from `github_search_electromagnetoscopes` as `registry_expansion`
