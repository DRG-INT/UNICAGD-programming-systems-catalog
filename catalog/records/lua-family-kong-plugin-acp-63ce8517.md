...
| Canonical URL | [https://luarocks.org/modules/cloudentity/kong-plugin-acp](https://luarocks.org/modules/cloudentity/kong-plugin-acp) |
| Source record ids | luarocks_root_manifest-4890381d611b38 |

## System Engineer Summary

Integrate the Authorization Control Plan (ACP) with the Kong API Gateway.

## Operational Role

For a systems engineer, kong-plugin-acp belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4890381d611b38` from `luarocks_root_manifest` as `registry_expansion`
