...
| Source record ids | github_search_pattern_language-c65634aa5ffcd1 |
...
For a systems engineer, QianMo/Unity-Design-Pattern belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-06T05:00:57Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-c65634aa5ffcd1` from `github_search_pattern_language` as `registry_expansion`
