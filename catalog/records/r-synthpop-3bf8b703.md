...
<!-- canonical: https://cran.r-project.org/web/packages/synthpop/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/synthpop/index.html](https://cran.r-project.org/web/packages/synthpop/index.html) |
| Source record ids | cran_packages_by_date-d151ade9895f92 |
...
For a systems engineer, synthpop belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9-3 | 2026-09-10 11:50:02 UTC | [https://cran.r-project.org/web/packages/synthpop/DESCRIPTION](https://cran.r-project.org/web/packages/synthpop/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/synthpop/DESCRIPTION` at `2026-09-10T12:26:17+00:00`.
...
- `cran_packages_by_date-d151ade9895f92` from `cran_packages_by_date` as `registry_expansion`
