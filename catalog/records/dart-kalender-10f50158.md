...
<!-- canonical: https://pub.dev/packages/kalender -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/kalender](https://pub.dev/packages/kalender) |
| Source record ids | pub_dev-e54c78ed0356a1 |

## System Engineer Summary

A highly customizable calendar widget with day, multi-day, month and schedule views, drag-and-drop
rescheduling, event resizing, and timezone support.

## Operational Role

For a systems engineer, kalender belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.1 | 2026-09-02T11:13:55.062128Z | [https://pub.dev/api/packages/kalender](https://pub.dev/api/packages/kalender) |  |
| preview | known | 0.29.0-dev.1 | 2026-08-31T09:58:01.412806Z | [https://pub.dev/api/packages/kalender](https://pub.dev/api/packages/kalender) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/kalender` at `2026-09-02T12:25:45+00:00`.
...
- `pub_dev-e54c78ed0356a1` from `pub_dev` as `registry_expansion`
