...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://pypi.org/project/keras/](https://pypi.org/project/keras/) |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.15.1 | 2026-07-29T18:20:13.909888Z | [https://pypi.org/pypi/Keras/json](https://pypi.org/pypi/Keras/json) |  |
| preview | known | 2.9.0rc2 | 2022-04-22T17:58:51.846789Z | [https://pypi.org/pypi/Keras/json](https://pypi.org/pypi/Keras/json) |  |

## Engineering Notes

- Treat category as `machine_learning` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://pypi.org/pypi/Keras/json` at `2026-09-01T02:12:59+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| CatBoost | Machine Learning | [open](python-catboost-1f3d24f0.md) |
| LightGBM | Machine Learning | [open](python-lightgbm-f2c0a0dc.md) |
| PyTorch | Machine Learning | [open](python-pytorch-e89b4194.md) |
| scikit-learn | Machine Learning | [open](python-scikit-learn-bee9600b.md) |
| spaCy | Machine Learning | [open](python-spacy-1bab951d.md) |
| TensorFlow | Machine Learning | [open](python-tensorflow-f73b5f36.md) |
| Transformers | Machine Learning | [open](python-transformers-ba8e634a.md) |
| XGBoost | Machine Learning | [open](python-xgboost-af754715.md) |
