...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Machine Learning](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/machine-learning.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | machine_learning |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-21ae7d397256af |

## System Engineer Summary

Keras is tracked as a machine learning record in the Python branch. The source did not provide a
...
For a systems engineer, Keras belongs in the Python inventory as part of model pipelines, numerical
...
- `corpus-21ae7d397256af` from `master_json` as `machine_learning`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CatBoost | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-catboost-1f3d24f0.md) |
| LightGBM | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-lightgbm-f2c0a0dc.md) |
| PyTorch | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pytorch-e89b4194.md) |
| scikit-learn | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-scikit-learn-bee9600b.md) |
| spaCy | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-spacy-1bab951d.md) |
| TensorFlow | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-tensorflow-f73b5f36.md) |
| Transformers | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-transformers-ba8e634a.md) |
| XGBoost | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-xgboost-af754715.md) |
