...
| Canonical URL | [https://luarocks.org/modules/kyonru/feather](https://luarocks.org/modules/kyonru/feather) |
| Source record ids | luarocks_root_manifest-a5a4c4826a9299 |

## System Engineer Summary

Debug & Inspect Tool for LÖVE (love2d)

## Operational Role

For a systems engineer, feather belongs in the Lua family inventory as part of fault isolation, live
...
- `luarocks_root_manifest-a5a4c4826a9299` from `luarocks_root_manifest` as `registry_expansion`
