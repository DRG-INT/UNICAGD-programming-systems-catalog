...
<!-- canonical: https://cran.r-project.org/web/packages/DTRlearn2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DTRlearn2/index.html](https://cran.r-project.org/web/packages/DTRlearn2/index.html) |
| Source record ids | cran_packages_by_date-d828c86d236783 |
...
For a systems engineer, DTRlearn2 belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1 | 2026-09-10 20:50:02 UTC | [https://cran.r-project.org/web/packages/DTRlearn2/DESCRIPTION](https://cran.r-project.org/web/packages/DTRlearn2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DTRlearn2/DESCRIPTION` at `2026-09-10T22:18:27+00:00`.
...
- `cran_packages_by_date-d828c86d236783` from `cran_packages_by_date` as `registry_expansion`
