...
<!-- canonical: https://cran.r-project.org/web/packages/HausdorffGoF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HausdorffGoF/index.html](https://cran.r-project.org/web/packages/HausdorffGoF/index.html) |
| Source record ids | cran_packages_by_date-4764886dcf924b |
...
For a systems engineer, HausdorffGoF belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-24 09:20:20 UTC | [https://cran.r-project.org/web/packages/HausdorffGoF/DESCRIPTION](https://cran.r-project.org/web/packages/HausdorffGoF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HausdorffGoF/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4764886dcf924b` from `cran_packages_by_date` as `registry_expansion`
