...
<!-- canonical: https://github.com/Mintplex-Labs/vector-admin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mintplex-Labs/vector-admin](https://github.com/Mintplex-Labs/vector-admin) |
| Source record ids | github_search_databases-276f28ede4653c |

## System Engineer Summary

The universal tool suite for vector database management. Manage Pinecone, Chroma, Qdrant, Weaviate
and more vector databases with ease.

## Operational Role

For a systems engineer, Mintplex-Labs/vector-admin belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-15T20:40:32Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-276f28ede4653c` from `github_search_databases` as `registry_expansion`
