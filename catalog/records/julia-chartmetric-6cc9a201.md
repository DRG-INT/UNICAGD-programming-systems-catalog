...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Chartmetric](https://github.com/JuliaRegistries/General/tree/master/C/Chartmetric) |
| Source record ids | julia_general-988021aa21213a |

## System Engineer Summary

Julia package registered in General at C/Chartmetric.

## Operational Role

For a systems engineer, Chartmetric belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Chartmetric", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-988021aa21213a` from `julia_general` as `registry_expansion`
