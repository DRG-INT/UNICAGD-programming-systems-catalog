...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/danielhenrymantilla/shellcode-factory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danielhenrymantilla/shellcode-factory](https://github.com/danielhenrymantilla/shellcode-factory) |
| Source record ids | github_search_assembly-97bceb7e78f37f |
...
For a systems engineer, danielhenrymantilla/shellcode-factory belongs in the Assembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-22T14:46:30Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-97bceb7e78f37f` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| barotto/test386.asm | Testing Framework | [open](assembly-barotto-test386-asm-fa35ae55.md) |
