# adamgell/TenantPulse

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/adamgell/TenantPulse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adamgell/TenantPulse](https://github.com/adamgell/TenantPulse) |
| Source record ids | github_search_repertoare_catalogs-7e7033a1be4f5b |

## System Engineer Summary

Read-only PowerShell module that assesses Microsoft Intune/Entra tenant health against a versioned
check catalog and produces a deterministic, pseudonymized, scored findings report. Built on GraphKit
— never writes to a tenant.

## Operational Role

For a systems engineer, adamgell/TenantPulse belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T18:08:04Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-7e7033a1be4f5b` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aberson/x-marks-the-spot | Cli | [open](repertoare-catalogs-aberson-x-marks-the-spot-b4e276e0.md) |
| ethanolivertroy/kevs-tui | Cli | [open](repertoare-catalogs-ethanolivertroy-kevs-tui-1382f3ab.md) |
| kauwelab/PolyRiskScore | Cli | [open](repertoare-catalogs-kauwelab-polyriskscore-3e2ae85d.md) |
