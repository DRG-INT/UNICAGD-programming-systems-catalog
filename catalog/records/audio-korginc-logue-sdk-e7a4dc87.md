...
<!-- canonical: https://github.com/korginc/logue-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/korginc/logue-sdk](https://github.com/korginc/logue-sdk) |
| Source record ids | github_search_audio-86f2bcd4b7f56a |

## System Engineer Summary

This repository contains all the files and tools needed to build custom oscillators and effects for
the prologue synthesizer.

## Operational Role

For a systems engineer, korginc/logue-sdk belongs in the Audio inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:59:28Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-86f2bcd4b7f56a` from `github_search_audio` as `registry_expansion`
