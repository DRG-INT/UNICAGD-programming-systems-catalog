...
<!-- canonical: https://github.com/harry0703/MoneyPrinterTurbo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) |
| Source record ids | github_search_aims-08055bb405028d |

## System Engineer Summary

利用 AI 大模型和自动化工作流，根据主题或关键词一键生成高清短视频。Generate HD short videos from a topic or keyword with an
automated AI workflow.

## Operational Role

For a systems engineer, harry0703/MoneyPrinterTurbo belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T03:31:11Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-08055bb405028d` from `github_search_aims` as `registry_expansion`
...
| can1357/oh-my-pi | Ide Editor Integration | [open](aim-s-can1357-oh-my-pi-4bb50e47.md) |
