...
<!-- canonical: https://github.com/wilder-minds/CodeRazorPages -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wilder-minds/CodeRazorPages](https://github.com/wilder-minds/CodeRazorPages) |
| Source record ids | github_search_magazines-62f5d6a18ffc14 |

## System Engineer Summary

Example from my Code Magazine Article on Razor Pages for WebForms developers.

## Operational Role

For a systems engineer, wilder-minds/CodeRazorPages belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-29T06:26:08Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-62f5d6a18ffc14` from `github_search_magazines` as `registry_expansion`
