...
<!-- canonical: https://github.com/kratofl/kratomix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kratofl/kratomix](https://github.com/kratofl/kratomix) |
| Source record ids | github_search_effects-9e4af267fd936b |

## System Engineer Summary

JUCE-based plugin monorepo for Logic Pro-first macOS audio effects, with shared build tooling,
templates, and reusable plugin infrastructure.

## Operational Role

For a systems engineer, kratofl/kratomix belongs in the Effects inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T21:09:01Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9e4af267fd936b` from `github_search_effects` as `registry_expansion`
