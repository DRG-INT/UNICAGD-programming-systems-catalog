...
<!-- canonical: https://luarocks.org/modules/cosyverif/cosy-instance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cosyverif/cosy-instance](https://luarocks.org/modules/cosyverif/cosy-instance) |
| Source record ids | luarocks_root_manifest-9f1bed603828c0 |

## System Engineer Summary

cosy-instance is tracked as a filesystem os record in the Lua family branch. The source did not
...
For a systems engineer, cosy-instance belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-9f1bed603828c0` from `luarocks_root_manifest` as `registry_expansion`
