...
<!-- canonical: https://github.com/Scrawk/GPU-GEMS-3D-Fluid-Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Scrawk/GPU-GEMS-3D-Fluid-Simulation](https://github.com/Scrawk/GPU-GEMS-3D-Fluid-Simulation) |
| Source record ids | github_search_physics_engines-d3e4d1b6917aa7 |
...
For a systems engineer, Scrawk/GPU-GEMS-3D-Fluid-Simulation belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-30T13:49:02Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-d3e4d1b6917aa7` from `github_search_physics_engines` as `registry_expansion`
