...
<!-- canonical: https://cran.r-project.org/web/packages/ctOpenData/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ctOpenData/index.html](https://cran.r-project.org/web/packages/ctOpenData/index.html) |
| Source record ids | cran_packages_by_date-d2896c98385315 |

## System Engineer Summary

A Lightweight Interface to Connecticut Open Data APIs

## Operational Role

For a systems engineer, ctOpenData belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-05 13:50:14 UTC | [https://cran.r-project.org/web/packages/ctOpenData/DESCRIPTION](https://cran.r-project.org/web/packages/ctOpenData/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ctOpenData/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-d2896c98385315` from `cran_packages_by_date` as `registry_expansion`
