...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/super_sliver_list -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/super_sliver_list](https://pub.dev/packages/super_sliver_list) |
| Source record ids | pub_dev-d06a6f87e1586e |

## System Engineer Summary

Drop-in replacement for SliverList and ListView that can handle large lists with variable extents
and jump/animate to specific items.

## Operational Role

For a systems engineer, super_sliver_list belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2024-03-26T12:29:13.005500Z | [https://pub.dev/api/packages/super_sliver_list](https://pub.dev/api/packages/super_sliver_list) |  |
| preview | known | 0.2.0-dev.2 | 2024-02-19T17:09:24.573319Z | [https://pub.dev/api/packages/super_sliver_list](https://pub.dev/api/packages/super_sliver_list) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/super_sliver_list` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-d06a6f87e1586e` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| animated_flip_counter | Precommit Ci Quality | [open](dart-animated-flip-counter-b9395f17.md) |
| infinite_carousel | Precommit Ci Quality | [open](dart-infinite-carousel-fae7c921.md) |
| restart_app | Precommit Ci Quality | [open](dart-restart-app-3ced8d2c.md) |
| sign_in_button | Precommit Ci Quality | [open](dart-sign-in-button-f2011f46.md) |
| simple_circular_progress_bar | Precommit Ci Quality | [open](dart-simple-circular-progress-bar-f4842aa8.md) |
