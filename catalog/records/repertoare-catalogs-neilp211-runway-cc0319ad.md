...
<!-- canonical: https://github.com/NeilP211/runway -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NeilP211/runway](https://github.com/NeilP211/runway) |
| Source record ids | github_search_repertoare_catalogs-834fbd32e5fbfa |

## System Engineer Summary

An AI stylist that learns what actually goes together. A graph neural network trained on 35k real
Polyvore outfits scores garment compatibility (0.848 AUC), powering full-stack catalog search,
image-extracted color/brand filters, and an interactive "Catwalk" outfit builder.

## Operational Role

For a systems engineer, NeilP211/runway belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T16:13:46Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-834fbd32e5fbfa` from `github_search_repertoare_catalogs` as `registry_expansion`
