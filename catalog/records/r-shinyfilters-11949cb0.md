...
<!-- canonical: https://cran.r-project.org/web/packages/shinyfilters/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinyfilters/index.html](https://cran.r-project.org/web/packages/shinyfilters/index.html) |
| Source record ids | cran_packages_by_date-e3e65a3630ce3f |
...
For a systems engineer, shinyfilters belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-09-15 04:40:02 UTC | [https://cran.r-project.org/web/packages/shinyfilters/DESCRIPTION](https://cran.r-project.org/web/packages/shinyfilters/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinyfilters/DESCRIPTION` at `2026-09-15T05:20:43+00:00`.
...
- `cran_packages_by_date-e3e65a3630ce3f` from `cran_packages_by_date` as `registry_expansion`
