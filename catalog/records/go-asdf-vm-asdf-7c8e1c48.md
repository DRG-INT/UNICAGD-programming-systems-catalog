...
<!-- canonical: https://github.com/asdf-vm/asdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asdf-vm/asdf](https://github.com/asdf-vm/asdf) |
| Source record ids | github_search_go-c1d5526f32141a |
...
For a systems engineer, asdf-vm/asdf belongs in the Go inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:58:03Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-c1d5526f32141a` from `github_search_go` as `registry_expansion`
