...
<!-- canonical: https://pub.dev/packages/camera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/camera](https://pub.dev/packages/camera) |
| Source record ids | pub_dev-1f9c75a7268c56 |

## System Engineer Summary

A Flutter plugin for controlling the camera. Supports previewing the camera feed, capturing images
and video, and streaming image buffers to Dart.

## Operational Role

For a systems engineer, camera belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0+2 | 2026-07-13T17:48:30.017835Z | [https://pub.dev/api/packages/camera](https://pub.dev/api/packages/camera) |  |
| preview | known | 0.8.0-nullsafety.2 | 2021-02-22T17:16:06.084680Z | [https://pub.dev/api/packages/camera](https://pub.dev/api/packages/camera) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/camera` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-1f9c75a7268c56` from `pub_dev` as `registry_expansion`
