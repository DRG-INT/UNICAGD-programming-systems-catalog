...
<!-- canonical: https://cran.r-project.org/web/packages/ellmer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ellmer/index.html](https://cran.r-project.org/web/packages/ellmer/index.html) |
| Source record ids | cran_packages_by_date-e67479edd393cc |
...
For a systems engineer, ellmer belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-04 06:30:02 UTC | [https://cran.r-project.org/web/packages/ellmer/DESCRIPTION](https://cran.r-project.org/web/packages/ellmer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ellmer/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-e67479edd393cc` from `cran_packages_by_date` as `registry_expansion`
