...
<!-- canonical: https://cran.r-project.org/web/packages/kza/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kza/index.html](https://cran.r-project.org/web/packages/kza/index.html) |
| Source record ids | cran_packages_by_date-70969327e54a48 |
...
For a systems engineer, kza belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-09-15 02:10:14 UTC | [https://cran.r-project.org/web/packages/kza/DESCRIPTION](https://cran.r-project.org/web/packages/kza/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kza/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-70969327e54a48` from `cran_packages_by_date` as `registry_expansion`
