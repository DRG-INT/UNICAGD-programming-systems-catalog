...
<!-- canonical: https://cran.r-project.org/web/packages/wbstats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wbstats/index.html](https://cran.r-project.org/web/packages/wbstats/index.html) |
| Source record ids | cran_packages_by_date-5e8b8e00b4030b |
...
For a systems engineer, wbstats belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-08-28 09:50:02 UTC | [https://cran.r-project.org/web/packages/wbstats/DESCRIPTION](https://cran.r-project.org/web/packages/wbstats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wbstats/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5e8b8e00b4030b` from `cran_packages_by_date` as `registry_expansion`
