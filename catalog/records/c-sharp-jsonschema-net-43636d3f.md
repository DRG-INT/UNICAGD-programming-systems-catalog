...
<!-- canonical: https://www.nuget.org/packages/JsonSchema.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonSchema.Net](https://www.nuget.org/packages/JsonSchema.Net) |
| Source record ids | nuget_search-0f3b2a90af742e |
...
For a systems engineer, JsonSchema.Net belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.4.0 | 2026-07-26T11:35:10.96+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net/index.json) |  |
| preview | known | 9.1.0-beta | 2026-02-12T07:31:16.747+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net/index.json) |  |
...
| Evidence | SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; https://www.nuget.org/packages/JsonSchema.Net/9.4.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonschema.net/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-0f3b2a90af742e` from `nuget_search` as `registry_expansion`
