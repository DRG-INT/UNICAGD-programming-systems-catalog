...
<!-- canonical: https://github.com/forthespada/CS-Books -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/forthespada/CS-Books](https://github.com/forthespada/CS-Books) |
| Source record ids | github_search_databases-b41d89b5af0786 |

## System Engineer Summary

🔥🔥超过1000本的计算机经典书籍、个人笔记资料以及本人在各平台发表文章中所涉及的资源等。书籍资源包括C/C++、Java、Python、Go语言、数据结构与算法、操作系统、后端架构、计算机系统知识、
数据库、计算机网络、设计模式、前端、汇编以及校招社招各种面经~

## Operational Role

For a systems engineer, forthespada/CS-Books belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-06T12:55:46Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b41d89b5af0786` from `github_search_databases` as `registry_expansion`
