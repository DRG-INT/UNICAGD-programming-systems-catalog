...
<!-- canonical: https://github.com/DavidPeicho/3ffects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DavidPeicho/3ffects](https://github.com/DavidPeicho/3ffects) |
| Source record ids | github_search_effects-e7bb73edc20b4e |
...
For a systems engineer, DavidPeicho/3ffects belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-23T15:59:19Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e7bb73edc20b4e` from `github_search_effects` as `registry_expansion`
