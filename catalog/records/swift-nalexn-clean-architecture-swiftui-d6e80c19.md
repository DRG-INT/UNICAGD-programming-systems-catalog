...
| Source record ids | github_search_swift-faee0b6f2c2b5b |

## System Engineer Summary

SwiftUI sample app using Clean Architecture. Examples of working with SwiftData persistence,
networking, dependency injection, unit testing, and more.

## Operational Role

For a systems engineer, nalexn/clean-architecture-swiftui belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-14T17:10:30Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-faee0b6f2c2b5b` from `github_search_swift` as `registry_expansion`
