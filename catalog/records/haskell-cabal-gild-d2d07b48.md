...
<!-- canonical: https://hackage.haskell.org/package/cabal-gild -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-gild](https://hackage.haskell.org/package/cabal-gild) |
| Source record ids | hackage_top_downloads-966b52837d813e |
...
For a systems engineer, cabal-gild belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.4.2 | 2026-08-17T19:30:18Z | [https://hackage.haskell.org/package/cabal-gild](https://hackage.haskell.org/package/cabal-gild) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-gild` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-966b52837d813e` from `hackage_top_downloads` as `registry_expansion`
