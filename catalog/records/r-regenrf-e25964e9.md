...
<!-- canonical: https://cran.r-project.org/web/packages/RegEnRF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RegEnRF/index.html](https://cran.r-project.org/web/packages/RegEnRF/index.html) |
| Source record ids | cran_packages_by_date-ac77ecfa7ecf17 |
...
For a systems engineer, RegEnRF belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-24 09:20:09 UTC | [https://cran.r-project.org/web/packages/RegEnRF/DESCRIPTION](https://cran.r-project.org/web/packages/RegEnRF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RegEnRF/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ac77ecfa7ecf17` from `cran_packages_by_date` as `registry_expansion`
