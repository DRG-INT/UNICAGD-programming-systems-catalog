...
<!-- canonical: https://github.com/makerportal/mpu92-calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makerportal/mpu92-calibration](https://github.com/makerportal/mpu92-calibration) |
| Source record ids | github_search_electromagnetoscopes-fa7993b340ad20 |

## System Engineer Summary

Calibration procedure for the MPU9250's accelerometer, gyroscope, and magnetometer using Python and
a Raspberry Pi Computer

## Operational Role

For a systems engineer, makerportal/mpu92-calibration belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:30:03Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-fa7993b340ad20` from `github_search_electromagnetoscopes` as `registry_expansion`
