...
<!-- canonical: https://github.com/lldap/lldap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lldap/lldap](https://github.com/lldap/lldap) |
| Source record ids | github_search_webassembly-303251824b9ca5 |
...
For a systems engineer, lldap/lldap belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T21:38:48Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-303251824b9ca5` from `github_search_webassembly` as `registry_expansion`
