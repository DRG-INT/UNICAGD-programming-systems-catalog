...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Jit Vm](../by-category/jit-vm.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/jitsi/jitsi-meet](https://github.com/jitsi/jitsi-meet) |
| Source record ids | github_search_video-42d2f95f4b48eb |

## System Engineer Summary

Jitsi Meet - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed
in your web application.

## Operational Role

For a systems engineer, jitsi/jitsi-meet belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | stable/jitsi-meet_11146 | 2026-08-03T07:34:35Z | [https://api.github.com/repos/jitsi/jitsi-meet/releases/latest](https://api.github.com/repos/jitsi/jitsi-meet/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jitsi/jitsi-meet/releases/latest` at `2026-09-01T09:23:24+00:00`.
...
- `github_search_video-42d2f95f4b48eb` from `github_search_video` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| jitsi/jitsi | Jit Vm | [open](video-jitsi-jitsi-d268b078.md) |
