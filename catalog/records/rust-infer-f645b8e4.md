...
<!-- canonical: https://crates.io/crates/infer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/infer](https://crates.io/crates/infer) |
| Source record ids | crates_io-403759141071df |
...
For a systems engineer, infer belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.0 | 2026-07-15T15:05:03.081761Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-403759141071df` from `crates_io` as `registry_expansion`
