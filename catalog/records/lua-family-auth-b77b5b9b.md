...
<!-- canonical: https://luarocks.org/modules/freed-wu/auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/auth](https://luarocks.org/modules/freed-wu/auth) |
| Source record ids | luarocks_root_manifest-3085f89027933d |
...
For a systems engineer, auth belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-3085f89027933d` from `luarocks_root_manifest` as `registry_expansion`
