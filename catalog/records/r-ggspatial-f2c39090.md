...
<!-- canonical: https://cran.r-project.org/web/packages/ggspatial/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggspatial/index.html](https://cran.r-project.org/web/packages/ggspatial/index.html) |
| Source record ids | cran_packages_by_date-cdee681489cac9 |
...
For a systems engineer, ggspatial belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.11 | 2026-09-14 22:10:02 UTC | [https://cran.r-project.org/web/packages/ggspatial/DESCRIPTION](https://cran.r-project.org/web/packages/ggspatial/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggspatial/DESCRIPTION` at `2026-09-14T22:20:18+00:00`.
...
- `cran_packages_by_date-cdee681489cac9` from `cran_packages_by_date` as `registry_expansion`
