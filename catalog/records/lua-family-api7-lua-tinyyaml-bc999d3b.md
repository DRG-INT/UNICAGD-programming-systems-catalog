...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-tinyyaml -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-98ab7710a0c117` from `luarocks_root_manifest` as `registry_expansion`
