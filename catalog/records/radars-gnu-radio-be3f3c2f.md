...
| Source record ids | curated_language_routes-fb520a44f0f10f |

## System Engineer Summary

Signal-processing toolkit for software-defined radio, radar experiments, communications, and RF
prototyping.

## Operational Role

For a systems engineer, GNU Radio belongs in the Radars inventory as part of ecosystem capability
...
- Latest stable metadata was observed from `https://api.github.com/repos/gnuradio/gnuradio/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-fb520a44f0f10f` from `curated_language_routes` as `registry_expansion`
