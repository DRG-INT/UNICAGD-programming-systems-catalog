...
<!-- canonical: https://github.com/ComposioHQ/composio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ComposioHQ/composio](https://github.com/ComposioHQ/composio) |
| Source record ids | github_search_aims-ed5e6420dbfcac |

## System Engineer Summary

Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed
workbench to help you build AI agents that turn intent into action.

## Operational Role

For a systems engineer, ComposioHQ/composio belongs in the "aim's" inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:08:37Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-ed5e6420dbfcac` from `github_search_aims` as `registry_expansion`
