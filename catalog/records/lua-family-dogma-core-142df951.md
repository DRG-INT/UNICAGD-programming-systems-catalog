...
<!-- canonical: https://luarocks.org/modules/dogma/dogma-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dogma/dogma-core](https://luarocks.org/modules/dogma/dogma-core) |
| Source record ids | luarocks_root_manifest-598df39c1a1db4 |

## System Engineer Summary

dogma-core is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, dogma-core belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-598df39c1a1db4` from `luarocks_root_manifest` as `registry_expansion`
