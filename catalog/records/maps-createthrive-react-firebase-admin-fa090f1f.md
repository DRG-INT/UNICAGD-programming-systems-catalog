...
<!-- canonical: https://github.com/CreateThrive/react-firebase-admin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CreateThrive/react-firebase-admin](https://github.com/CreateThrive/react-firebase-admin) |
| Source record ids | github_search_maps-5de6055c1843b8 |

## System Engineer Summary

React ⚛️ starter kit with Firebase 🔥 and Bulma for setting up an admin dashboard - Highly scalable,
PWA, Serverless

## Operational Role

For a systems engineer, CreateThrive/react-firebase-admin belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-06T17:28:28Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5de6055c1843b8` from `github_search_maps` as `registry_expansion`
