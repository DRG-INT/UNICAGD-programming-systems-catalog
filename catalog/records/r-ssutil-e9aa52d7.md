...
<!-- canonical: https://cran.r-project.org/web/packages/ssutil/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ssutil/index.html](https://cran.r-project.org/web/packages/ssutil/index.html) |
| Source record ids | cran_packages_by_date-01d160990cf0da |
...
For a systems engineer, ssutil belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-06 17:40:02 UTC | [https://cran.r-project.org/web/packages/ssutil/DESCRIPTION](https://cran.r-project.org/web/packages/ssutil/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ssutil/DESCRIPTION` at `2026-09-06T18:20:54+00:00`.
...
- `cran_packages_by_date-01d160990cf0da` from `cran_packages_by_date` as `registry_expansion`
