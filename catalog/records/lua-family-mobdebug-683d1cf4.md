...
<!-- canonical: https://github.com/pkulchenko/MobDebug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pkulchenko/MobDebug](https://github.com/pkulchenko/MobDebug) |
| Source record ids | lua-source-90 |
...
For a systems engineer, MobDebug belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 90}}` |
...
- `lua-source-90` from `master_json` as `source_list_item`
