...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BrowseTables](https://github.com/JuliaRegistries/General/tree/master/B/BrowseTables) |
| Source record ids | julia_general-f8048bddd0b081 |

## System Engineer Summary

Julia package registered in General at B/BrowseTables.

## Operational Role

For a systems engineer, BrowseTables belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BrowseTables", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f8048bddd0b081` from `julia_general` as `registry_expansion`
