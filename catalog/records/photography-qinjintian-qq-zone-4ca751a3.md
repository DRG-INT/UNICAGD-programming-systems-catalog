...
<!-- canonical: https://github.com/qinjintian/qq-zone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qinjintian/qq-zone](https://github.com/qinjintian/qq-zone) |
| Source record ids | github_search_photography-0fe8075725ee0e |

## System Engineer Summary

QQ空间相册备份：扫码登录，一键下载原图、原视频和实况图，保留 EXIF。支持好友相册、增量续传与失败重试。QZone original photo/video backup.

## Operational Role

For a systems engineer, qinjintian/qq-zone belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:35:31Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-0fe8075725ee0e` from `github_search_photography` as `registry_expansion`
