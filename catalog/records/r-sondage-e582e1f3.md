...
<!-- canonical: https://cran.r-project.org/web/packages/sondage/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sondage/index.html](https://cran.r-project.org/web/packages/sondage/index.html) |
| Source record ids | cran_packages_by_date-69f57059292e16 |

## System Engineer Summary

Survey Sampling Algorithms

## Operational Role

For a systems engineer, sondage belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2026-08-04 23:20:02 UTC | [https://cran.r-project.org/web/packages/sondage/DESCRIPTION](https://cran.r-project.org/web/packages/sondage/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sondage/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-69f57059292e16` from `cran_packages_by_date` as `registry_expansion`
