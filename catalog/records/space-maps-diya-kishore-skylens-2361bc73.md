...
<!-- canonical: https://github.com/diya-kishore/SkyLens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diya-kishore/SkyLens](https://github.com/diya-kishore/SkyLens) |
| Source record ids | github_search_space_maps-d1b04c6103a4f6 |

## System Engineer Summary

SkyLens is a modern, web-based astronomy toolset that brings the night sky closer to users. With an
interactive star map powered by Aladin Lite and a comprehensive Star Wiki, users can explore stars
and constellations easily. Designed with a retro aesthetic and smooth UI, SkyLens aims to make
stargazing and astronomical learning fun and accessible

## Operational Role

For a systems engineer, diya-kishore/SkyLens belongs in the Space Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-31T10:03:01Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d1b04c6103a4f6` from `github_search_space_maps` as `registry_expansion`
