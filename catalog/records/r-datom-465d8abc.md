...
<!-- canonical: https://cran.r-project.org/web/packages/datom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datom/index.html](https://cran.r-project.org/web/packages/datom/index.html) |
| Source record ids | cran_packages_by_date-73325f32c61222 |
...
For a systems engineer, datom belongs in the R inventory as part of hot-path discovery, allocation
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-01 11:40:15 UTC | [https://cran.r-project.org/web/packages/datom/DESCRIPTION](https://cran.r-project.org/web/packages/datom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datom/DESCRIPTION` at `2026-09-01T12:25:39+00:00`.
...
- `cran_packages_by_date-73325f32c61222` from `cran_packages_by_date` as `registry_expansion`
