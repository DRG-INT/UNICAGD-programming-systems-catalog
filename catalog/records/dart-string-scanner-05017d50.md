...
<!-- canonical: https://pub.dev/packages/string_scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/string_scanner](https://pub.dev/packages/string_scanner) |
| Source record ids | pub_dev-aacf357c91d70a |
...
For a systems engineer, string_scanner belongs in the Dart inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2024-12-17T10:00:43.322120Z | [https://pub.dev/api/packages/string_scanner](https://pub.dev/api/packages/string_scanner) |  |
| preview | known | 1.1.0-nullsafety.3 | 2020-11-03T22:35:52.697298Z | [https://pub.dev/api/packages/string_scanner](https://pub.dev/api/packages/string_scanner) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/string_scanner` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-aacf357c91d70a` from `pub_dev` as `registry_expansion`
