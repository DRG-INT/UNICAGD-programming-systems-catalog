...
<!-- canonical: https://cran.r-project.org/web/packages/AnomalyScore/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AnomalyScore/index.html](https://cran.r-project.org/web/packages/AnomalyScore/index.html) |
| Source record ids | cran_packages_by_date-bbe39468f24929 |
...
For a systems engineer, AnomalyScore belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-13 21:30:13 UTC | [https://cran.r-project.org/web/packages/AnomalyScore/DESCRIPTION](https://cran.r-project.org/web/packages/AnomalyScore/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AnomalyScore/DESCRIPTION` at `2026-09-13T22:19:02+00:00`.
...
- `cran_packages_by_date-bbe39468f24929` from `cran_packages_by_date` as `registry_expansion`
