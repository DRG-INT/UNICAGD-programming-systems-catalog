...
| Source record ids | hackage_recent-e96fef15488e1e |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1.0 | 2026-09-11T12:12:03Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-e96fef15488e1e` from `hackage_recent` as `registry_expansion`
