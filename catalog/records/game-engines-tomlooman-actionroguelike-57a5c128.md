...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tomlooman/ActionRoguelike -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tomlooman/ActionRoguelike](https://github.com/tomlooman/ActionRoguelike) |
| Source record ids | github_search_game_engines-648f8acf4d8e3c |
...
For a systems engineer, tomlooman/ActionRoguelike belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T15:45:23Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-648f8acf4d8e3c` from `github_search_game_engines` as `registry_expansion`
