...
| Canonical URL | [https://luarocks.org/modules/mah0x211/exec](https://luarocks.org/modules/mah0x211/exec) |
| Source record ids | luarocks_root_manifest-403dca1f9a8a26 |

## System Engineer Summary

exec is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, exec belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-403dca1f9a8a26` from `luarocks_root_manifest` as `registry_expansion`
