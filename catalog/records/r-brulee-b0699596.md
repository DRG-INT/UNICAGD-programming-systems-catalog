...
<!-- canonical: https://cran.r-project.org/web/packages/brulee/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/brulee/index.html](https://cran.r-project.org/web/packages/brulee/index.html) |
| Source record ids | cran_packages_by_date-efd05ff32bc747 |
...
For a systems engineer, brulee belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-02 20:20:09 UTC | [https://cran.r-project.org/web/packages/brulee/DESCRIPTION](https://cran.r-project.org/web/packages/brulee/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/brulee/DESCRIPTION` at `2026-09-02T22:19:13+00:00`.
...
- `cran_packages_by_date-efd05ff32bc747` from `cran_packages_by_date` as `registry_expansion`
