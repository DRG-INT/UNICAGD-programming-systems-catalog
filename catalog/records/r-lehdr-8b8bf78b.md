...
<!-- canonical: https://cran.r-project.org/web/packages/lehdr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lehdr/index.html](https://cran.r-project.org/web/packages/lehdr/index.html) |
| Source record ids | cran_packages_by_date-a1b3b462134365 |
...
For a systems engineer, lehdr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-22 18:30:12 UTC | [https://cran.r-project.org/web/packages/lehdr/DESCRIPTION](https://cran.r-project.org/web/packages/lehdr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lehdr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a1b3b462134365` from `cran_packages_by_date` as `registry_expansion`
