...
<!-- canonical: https://github.com/Leaflet/Leaflet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Leaflet/Leaflet](https://github.com/Leaflet/Leaflet) |
| Source record ids | github_search_maps-b1f18b25c2d581 |
...
For a systems engineer, Leaflet/Leaflet belongs in the Maps inventory as part of input-space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T21:11:20Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b1f18b25c2d581` from `github_search_maps` as `registry_expansion`
