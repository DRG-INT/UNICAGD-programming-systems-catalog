...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Data Science](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/data-science.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BanyanDataFrames](https://github.com/JuliaRegistries/General/tree/master/B/BanyanDataFrames) |
| Source record ids | julia_general-511db72d8969ff |

## System Engineer Summary

Julia package registered in General at B/BanyanDataFrames.

## Operational Role

For a systems engineer, BanyanDataFrames belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| CategoricalArrays.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-categoricalarrays-jl-cd20869a.md) |
| DataFrames.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-dataframes-jl-c257457c.md) |
| Distributions.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-distributions-jl-89313659.md) |
| StatsBase.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-statsbase-jl-9492ab3b.md) |
| StructArrays.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-structarrays-jl-bbc2652e.md) |
| Tables.jl | Data Science | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-tables-jl-bf52e39c.md) |
