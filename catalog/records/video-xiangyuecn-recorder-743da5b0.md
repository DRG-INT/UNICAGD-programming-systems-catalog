...
<!-- canonical: https://github.com/xiangyuecn/Recorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xiangyuecn/Recorder](https://github.com/xiangyuecn/Recorder) |
| Source record ids | github_search_video-51ed19535e4c77 |

## System Engineer Summary

html5 js 录音 mp3 wav ogg webm amr g711a g711u 格式，支持pc和Android、iOS部分Web浏览器、Hybrid App（提供Android iOS
App源码）、微信，提供ASR语音识别转文字 H5版语音通话聊天示例 DTMF编码解码

## Operational Role

For a systems engineer, xiangyuecn/Recorder belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T11:12:03Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-51ed19535e4c77` from `github_search_video` as `registry_expansion`
