...
<!-- canonical: https://github.com/mlt131220/Astral3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mlt131220/Astral3D](https://github.com/mlt131220/Astral3D) |
| Source record ids | github_search_effects-ffb0cd8d2fbe00 |

## System Engineer Summary

基于Vue3 + THREE.JS 免费开源的三维引擎及配套编辑器，包含BIM轻量化、CAD解析预览、粒子系统、插件系统等功能。 A free and open-source 3D engine
based on Vue3 + THREE.JS and its accompanying editor, featuring functions such as BIM
lightweighting, CAD parsing preview, particle system, and plugin system.

## Operational Role

For a systems engineer, mlt131220/Astral3D belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T05:27:59Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_effects-ffb0cd8d2fbe00` from `github_search_effects` as `registry_expansion`
