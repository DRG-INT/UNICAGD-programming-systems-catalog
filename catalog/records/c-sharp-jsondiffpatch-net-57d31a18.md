...
<!-- canonical: https://www.nuget.org/packages/JsonDiffPatch.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonDiffPatch.Net](https://www.nuget.org/packages/JsonDiffPatch.Net) |
| Source record ids | nuget_search-d61f09518c2889 |
...
For a systems engineer, JsonDiffPatch.Net belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2025-07-23T01:05:40.993+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsondiffpatch.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsondiffpatch.net/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other; MIT; https://www.nuget.org/packages/JsonDiffPatch.Net/2.5.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsondiffpatch.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-d61f09518c2889` from `nuget_search` as `registry_expansion`
