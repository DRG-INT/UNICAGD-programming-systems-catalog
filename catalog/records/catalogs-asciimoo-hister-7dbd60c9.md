...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/asciimoo/hister -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asciimoo/hister](https://github.com/asciimoo/hister) |
| Source record ids | github_search_catalogs-97df7b1e4b526b |

## System Engineer Summary

asciimoo/hister is tracked as a game engine game dev record in the Catalogs branch. The source did
...
For a systems engineer, asciimoo/hister belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T19:35:17Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_catalogs-97df7b1e4b526b` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| gamedilong/awesome-cn | Game Engine Game Dev | [open](catalogs-gamedilong-awesome-cn-95ab928b.md) |
