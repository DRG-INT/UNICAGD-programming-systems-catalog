...
<!-- canonical: https://github.com/drandyhaas/KiCadRoutingTools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drandyhaas/KiCadRoutingTools](https://github.com/drandyhaas/KiCadRoutingTools) |
| Source record ids | github_search_maps-f2eac00b8cebfb |
...
For a systems engineer, drandyhaas/KiCadRoutingTools belongs in the Maps inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T21:30:11Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f2eac00b8cebfb` from `github_search_maps` as `registry_expansion`
