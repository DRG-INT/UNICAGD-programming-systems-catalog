...
<!-- canonical: https://github.com/tropicalstream/TapGarden -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tropicalstream/TapGarden](https://github.com/tropicalstream/TapGarden) |
| Source record ids | github_search_radio_garden_speciality-78602fdb9953d9 |

## System Engineer Summary

Tap Garden is a web app that comfortably displays Radio Garden for the RayNeo X3 Pro Glasses

## Operational Role

For a systems engineer, tropicalstream/TapGarden belongs in the Radio Garden Speciality inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-28T23:16:42Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-78602fdb9953d9` from `github_search_radio_garden_speciality` as `registry_expansion`
