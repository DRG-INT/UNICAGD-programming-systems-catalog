...
<!-- canonical: https://github.com/dominikmartn/ProgressiveBlurHeader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dominikmartn/ProgressiveBlurHeader](https://github.com/dominikmartn/ProgressiveBlurHeader) |
| Source record ids | github_search_swift-222d7c987d3379 |

## System Engineer Summary

Drop-in SwiftUI component for sticky headers with progressive blur — like Apple Music, Photos, and
App Store. Content scrolls underneath with increasing blur, never clipped.

## Operational Role

For a systems engineer, dominikmartn/ProgressiveBlurHeader belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-09T05:08:23Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-222d7c987d3379` from `github_search_swift` as `registry_expansion`
