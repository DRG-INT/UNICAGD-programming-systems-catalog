...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/mah454/finch](https://luarocks.org/modules/mah454/finch) |
| Source record ids | luarocks_root_manifest-890ab9d152edcd |

## System Engineer Summary

A minimal and lightweight micro framework for Lua

## Operational Role

For a systems engineer, finch belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| dawn | Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-dawn-1a512844.md) |
| emma | Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-emma-b7f11429.md) |
| exile | Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-exile-01d5c94e.md) |
| ggram | Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ggram-5d78e3cb.md) |
| lua-source-167 | Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-source-167-c457b73b.md) |
