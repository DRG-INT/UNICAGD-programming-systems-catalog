...
<!-- canonical: https://cran.r-project.org/web/packages/ssel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ssel/index.html](https://cran.r-project.org/web/packages/ssel/index.html) |
| Source record ids | cran_packages_by_date-344e5a3c9921ed |
...
For a systems engineer, ssel belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-24 18:50:02 UTC | [https://cran.r-project.org/web/packages/ssel/DESCRIPTION](https://cran.r-project.org/web/packages/ssel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ssel/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-344e5a3c9921ed` from `cran_packages_by_date` as `registry_expansion`
