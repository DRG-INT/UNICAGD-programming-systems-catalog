...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/dekor/php-array-table](https://packagist.org/packages/dekor/php-array-table) |
| Source record ids | packagist_search-a9b35df6fa6a7b |
...
For a systems engineer, dekor/php-array-table belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-02-08T23:44:22+00:00 | [https://repo.packagist.org/p2/dekor/php-array-table.json](https://repo.packagist.org/p2/dekor/php-array-table.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dekor/php-array-table.json` at `2026-09-01T07:20:24+00:00`.
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-01 | `{"kind": "packagist_search_and_p2_api", "query": "mysql", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `packagist_search-a9b35df6fa6a7b` from `packagist_search` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| clouddueling/mysqldump-php | Cli | [open](php-clouddueling-mysqldump-php-6f8042b5.md) |
| cybercog/laravel-clickhouse | Cli | [open](php-cybercog-laravel-clickhouse-03bf04d3.md) |
| druidfi/mysqldump-php | Cli | [open](php-druidfi-mysqldump-php-f81fc9a9.md) |
