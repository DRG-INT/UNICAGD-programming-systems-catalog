...
<!-- canonical: https://gitea.com/kklives2/librarys-repo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/kklives2/librarys-repo](https://gitea.com/kklives2/librarys-repo) |
| Source record ids | gitea_repositories_api-c9a66904ecded2 |
...
For a systems engineer, Gitea: kklives2/librarys-repo belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-31T05:36:31Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-c9a66904ecded2` from `gitea_repositories_api` as `registry_expansion`
