...
<!-- canonical: https://github.com/ytakzk/Fusuma -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ytakzk/Fusuma](https://github.com/ytakzk/Fusuma) |
| Source record ids | github_search_cocoa-0f30bdb4db07b0 |
...
For a systems engineer, ytakzk/Fusuma belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-14T22:46:06Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0f30bdb4db07b0` from `github_search_cocoa` as `registry_expansion`
