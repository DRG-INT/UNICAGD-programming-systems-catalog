...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Space Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/space-maps.md) · [Category: Database Datastore](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/database-datastore.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://naif.jpl.nasa.gov/naif/data.html](https://naif.jpl.nasa.gov/naif/data.html) |
| Source record ids | curated_language_routes-ba3fdc9ae03a1a |

## System Engineer Summary

NASA NAIF SPICE kernel data route for ephemerides, spacecraft, instruments, frames, and mission
geometry.

## Operational Role

For a systems engineer, SPICE Kernels belongs in the Space Maps inventory as part of state
...
- `curated_language_routes-ba3fdc9ae03a1a` from `curated_language_routes` as `registry_expansion`
