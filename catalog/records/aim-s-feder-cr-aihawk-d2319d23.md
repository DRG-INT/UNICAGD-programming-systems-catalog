...
Open-source AI browser agent: an autonomous web agent for web automation in plain language. It
browses, clicks, types and reads real websites to do the tasks you describe. Standalone UI, or MCP
