...
| Source record ids | github_search_aims-b1192f01091c5e |

## System Engineer Summary

Open-source AI browser agent: describe any task in plain language and it autonomously browses,
clicks, types and reads the web for you. Standalone UI, or MCP for Claude Code, Codex and Gemini
CLI.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T18:20:47Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-b1192f01091c5e` from `github_search_aims` as `registry_expansion`
