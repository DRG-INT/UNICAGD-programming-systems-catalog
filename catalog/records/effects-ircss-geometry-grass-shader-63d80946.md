# IRCSS/Geometry-Grass-Shader

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/IRCSS/Geometry-Grass-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IRCSS/Geometry-Grass-Shader](https://github.com/IRCSS/Geometry-Grass-Shader) |
| Source record ids | github_search_effects-42b119afbf0bc5 |
...
For a systems engineer, IRCSS/Geometry-Grass-Shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-29T08:18:36Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-42b119afbf0bc5` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| appleseedhq/appleseed | Game Engine Game Dev | [open](effects-appleseedhq-appleseed-7150506a.md) |
| creativelifeform/three-nebula | Game Engine Game Dev | [open](effects-creativelifeform-three-nebula-c054525f.md) |
| daniel-ilett/shaders-portal | Game Engine Game Dev | [open](effects-daniel-ilett-shaders-portal-f6698878.md) |
| flashhawk/spp.js | Game Engine Game Dev | [open](effects-flashhawk-spp-js-ce4e0a32.md) |
| furkansarihan/enigine | Game Engine Game Dev | [open](effects-furkansarihan-enigine-7fe9aa3f.md) |
| galacean/engine-toolkit | Game Engine Game Dev | [open](effects-galacean-engine-toolkit-b50ec288.md) |
| gamedevserj/Godot-Shaders | Game Engine Game Dev | [open](effects-gamedevserj-godot-shaders-f9881cf4.md) |
| gamedevserj/Shader-Graph-Experiments | Game Engine Game Dev | [open](effects-gamedevserj-shader-graph-experiments-a4d1d520.md) |
