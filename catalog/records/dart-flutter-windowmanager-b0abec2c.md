...
<!-- canonical: https://pub.dev/packages/flutter_windowmanager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_windowmanager](https://pub.dev/packages/flutter_windowmanager) |
| Source record ids | pub_dev-ee1683a39d1658 |
...
For a systems engineer, flutter_windowmanager belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2021-08-26T10:40:37.269839Z | [https://pub.dev/api/packages/flutter_windowmanager](https://pub.dev/api/packages/flutter_windowmanager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_windowmanager` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-ee1683a39d1658` from `pub_dev` as `registry_expansion`
