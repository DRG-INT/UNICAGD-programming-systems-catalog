...
<!-- canonical: https://gitea.com/TanThibault/DevOps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/TanThibault/DevOps](https://gitea.com/TanThibault/DevOps) |
| Source record ids | gitea_repositories_api-f91b34695076cf |
...
For a systems engineer, Gitea: TanThibault/DevOps belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-25T18:49:33Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f91b34695076cf` from `gitea_repositories_api` as `registry_expansion`
