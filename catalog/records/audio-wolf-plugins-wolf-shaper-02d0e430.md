...
<!-- canonical: https://github.com/wolf-plugins/wolf-shaper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wolf-plugins/wolf-shaper](https://github.com/wolf-plugins/wolf-shaper) |
| Source record ids | github_search_audio-3e71666fad1e9a |
...
For a systems engineer, wolf-plugins/wolf-shaper belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-11T14:54:32Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-3e71666fad1e9a` from `github_search_audio` as `registry_expansion`
