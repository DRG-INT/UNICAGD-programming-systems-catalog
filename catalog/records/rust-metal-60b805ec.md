...
| Canonical URL | [https://crates.io/crates/metal](https://crates.io/crates/metal) |
| Source record ids | crates_io-c6296cfaf8dc35 |

## System Engineer Summary

metal is tracked as a ffi bindings record in the Rust branch. The source did not provide a long
...
For a systems engineer, metal belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.33.0 | 2025-12-17T20:06:22.008564Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-c6296cfaf8dc35` from `crates_io` as `registry_expansion`
