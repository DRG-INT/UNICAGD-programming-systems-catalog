...
<!-- canonical: https://cran.r-project.org/web/packages/VIM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/VIM/index.html](https://cran.r-project.org/web/packages/VIM/index.html) |
| Source record ids | cran_packages_by_date-774aed780e033e |
...
For a systems engineer, VIM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.0 | 2026-09-02 10:20:02 UTC | [https://cran.r-project.org/web/packages/VIM/DESCRIPTION](https://cran.r-project.org/web/packages/VIM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/VIM/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-774aed780e033e` from `cran_packages_by_date` as `registry_expansion`
