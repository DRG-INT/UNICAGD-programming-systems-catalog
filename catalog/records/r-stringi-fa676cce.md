...
<!-- canonical: https://cran.r-project.org/web/packages/stringi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stringi/index.html](https://cran.r-project.org/web/packages/stringi/index.html) |
| Source record ids | cran_packages_by_date-7ca719a9c390d5 |
...
For a systems engineer, stringi belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.9 | 2026-08-04 16:30:03 UTC | [https://cran.r-project.org/web/packages/stringi/DESCRIPTION](https://cran.r-project.org/web/packages/stringi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stringi/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7ca719a9c390d5` from `cran_packages_by_date` as `registry_expansion`
