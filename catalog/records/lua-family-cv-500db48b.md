...
<!-- canonical: https://luarocks.org/modules/shrubb/cv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/shrubb/cv](https://luarocks.org/modules/shrubb/cv) |
| Source record ids | luarocks_root_manifest-69863f2fbcb532 |
...
For a systems engineer, cv belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-69863f2fbcb532` from `luarocks_root_manifest` as `registry_expansion`
