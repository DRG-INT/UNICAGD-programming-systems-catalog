...
<!-- canonical: https://github.com/coollabsio/fonts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coollabsio/fonts](https://github.com/coollabsio/fonts) |
| Source record ids | github_search_assets-8c9cd9fd64e71d |
...
For a systems engineer, coollabsio/fonts belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-16T18:37:01Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-8c9cd9fd64e71d` from `github_search_assets` as `registry_expansion`
