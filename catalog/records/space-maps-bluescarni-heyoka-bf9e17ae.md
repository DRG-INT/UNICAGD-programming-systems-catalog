...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_space_maps-2947698f362c80 |
...
For a systems engineer, bluescarni/heyoka belongs in the Space Maps inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T15:10:58Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0 |
...
- `github_search_space_maps-2947698f362c80` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bluescarni/heyoka.py | Compiler | [open](space-maps-bluescarni-heyoka-py-7446afa8.md) |
