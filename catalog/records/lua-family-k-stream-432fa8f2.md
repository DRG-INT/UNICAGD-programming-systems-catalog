...
| Canonical URL | [https://luarocks.org/modules/ashkankiani/k-stream](https://luarocks.org/modules/ashkankiani/k-stream) |
| Source record ids | luarocks_root_manifest-0ab981da919508 |

## System Engineer Summary

k-stream is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, k-stream belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0ab981da919508` from `luarocks_root_manifest` as `registry_expansion`
