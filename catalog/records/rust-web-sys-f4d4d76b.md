...
<!-- canonical: https://crates.io/crates/web-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/web-sys](https://crates.io/crates/web-sys) |
| Source record ids | crates_io-97e11b31a41458 |
...
For a systems engineer, web-sys belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.105 | 2026-09-04T23:58:14.724782Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Other; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-05T00:29:03+00:00`.
...
- `crates_io-97e11b31a41458` from `crates_io` as `registry_expansion`
