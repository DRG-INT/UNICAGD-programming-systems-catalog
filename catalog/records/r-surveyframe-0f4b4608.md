...
<!-- canonical: https://cran.r-project.org/web/packages/surveyframe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/surveyframe/index.html](https://cran.r-project.org/web/packages/surveyframe/index.html) |
| Source record ids | cran_packages_by_date-e07f0dcb0c0f37 |
...
For a systems engineer, surveyframe belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-20 23:20:02 UTC | [https://cran.r-project.org/web/packages/surveyframe/DESCRIPTION](https://cran.r-project.org/web/packages/surveyframe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/surveyframe/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e07f0dcb0c0f37` from `cran_packages_by_date` as `registry_expansion`
