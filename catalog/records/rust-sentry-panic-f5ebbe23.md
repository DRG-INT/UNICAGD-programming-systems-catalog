...
| Canonical URL | [https://crates.io/crates/sentry-panic](https://crates.io/crates/sentry-panic) |
| Source record ids | crates_io-f03baaddd28902 |
...
For a systems engineer, sentry-panic belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.49.2 | 2026-08-26T14:42:45.810909Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-f03baaddd28902` from `crates_io` as `registry_expansion`
