...
<!-- canonical: https://cran.r-project.org/web/packages/mapsf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mapsf/index.html](https://cran.r-project.org/web/packages/mapsf/index.html) |
| Source record ids | cran_packages_by_date-00fd024f765a54 |

## System Engineer Summary

mapsf is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, mapsf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-09-02 12:40:02 UTC | [https://cran.r-project.org/web/packages/mapsf/DESCRIPTION](https://cran.r-project.org/web/packages/mapsf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mapsf/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-00fd024f765a54` from `cran_packages_by_date` as `registry_expansion`
