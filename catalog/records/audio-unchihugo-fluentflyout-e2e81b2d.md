...
| Canonical URL | [https://github.com/unchihugo/FluentFlyout](https://github.com/unchihugo/FluentFlyout) |
| Source record ids | github_search_audio-273d7c8a8d9e1a |

## System Engineer Summary

The modern Flyout app for Windows 11, built with Fluent 2 Design principles. Media Flyouts, Taskbar
Widgets and more.

## Operational Role

For a systems engineer, unchihugo/FluentFlyout belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.14.0 | 2026-08-12T18:07:50Z | [https://api.github.com/repos/unchihugo/FluentFlyout/releases/latest](https://api.github.com/repos/unchihugo/FluentFlyout/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/unchihugo/FluentFlyout/releases/latest` at `2026-09-01T09:23:21+00:00`.
...
- `github_search_audio-273d7c8a8d9e1a` from `github_search_audio` as `registry_expansion`
