...
[Catalog index](../index.md) · [Language: Octave](../by-language/octave.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gnu-octave.github.io/packages/doctest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/doctest](https://gnu-octave.github.io/packages/doctest) |
| Source record ids | octave_packages_index-e555f5a549b080 |

## System Engineer Summary

doctest is tracked as a testing framework record in the Octave branch. The source did not provide a
...
For a systems engineer, doctest belongs in the Octave inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-06-02 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-e555f5a549b080` from `octave_packages_index` as `registry_expansion`
