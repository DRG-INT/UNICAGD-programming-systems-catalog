...
<!-- canonical: https://typescript-eslint.io/ -->
<!-- crawl-delay: 10 -->
...
| Category | Linter |
| Source type | typed_linting_framework |
| Verification | web_verified_this_pass |
| Canonical URL | [https://typescript-eslint.io/](https://typescript-eslint.io/) |
| Source record ids | web-verified-0013, npm_registry-9695412e78bb68 |

## System Engineer Summary

Static-analysis tooling enabling ESLint and related tooling for TypeScript.

## Operational Role

For a systems engineer, typescript-eslint belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.69.0 | 2026-08-31T17:08:46.355Z | [https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T07:19:33+00:00`.
...
- `web-verified-0013` from `master_json` as `typed_linting_framework`
- `npm_registry-9695412e78bb68` from `npm_registry` as `registry_expansion`
