...
<!-- canonical: https://packagist.org/packages/jquery-form/form -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jquery-form/form](https://packagist.org/packages/jquery-form/form) |
| Source record ids | packagist_search-06903f48272d9b |
...
For a systems engineer, jquery-form/form belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-06903f48272d9b` from `packagist_search` as `registry_expansion`
