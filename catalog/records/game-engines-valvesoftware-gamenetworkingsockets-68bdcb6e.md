...
<!-- canonical: https://github.com/ValveSoftware/GameNetworkingSockets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ValveSoftware/GameNetworkingSockets](https://github.com/ValveSoftware/GameNetworkingSockets) |
| Source record ids | github_search_game_engines-31265d8bc11c0d |

## System Engineer Summary

Reliable & unreliable messages over UDP. Robust message fragmentation & reassembly. P2P networking /
NAT traversal. Encryption.

## Operational Role

For a systems engineer, ValveSoftware/GameNetworkingSockets belongs in the Game Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T01:04:25Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_game_engines-31265d8bc11c0d` from `github_search_game_engines` as `registry_expansion`
