...
<!-- canonical: https://www.npmjs.com/package/graphql-language-service-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/graphql-language-service-server](https://www.npmjs.com/package/graphql-language-service-server) |
| Source record ids | npm_registry-3234e0775f9340 |
...
For a systems engineer, graphql-language-service-server belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0 | 2026-08-30T19:49:57.015Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-3234e0775f9340` from `npm_registry` as `registry_expansion`
