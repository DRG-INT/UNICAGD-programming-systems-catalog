...
<!-- canonical: https://cran.r-project.org/web/packages/rregm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rregm/index.html](https://cran.r-project.org/web/packages/rregm/index.html) |
| Source record ids | cran_packages_by_date-3b353bc973175a |
...
For a systems engineer, rregm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4 | 2026-09-05 02:10:02 UTC | [https://cran.r-project.org/web/packages/rregm/DESCRIPTION](https://cran.r-project.org/web/packages/rregm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rregm/DESCRIPTION` at `2026-09-05T02:18:28+00:00`.
...
- `cran_packages_by_date-3b353bc973175a` from `cran_packages_by_date` as `registry_expansion`
