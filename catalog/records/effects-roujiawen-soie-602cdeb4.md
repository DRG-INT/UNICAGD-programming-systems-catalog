...
<!-- canonical: https://github.com/roujiawen/soie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/roujiawen/soie](https://github.com/roujiawen/soie) |
| Source record ids | github_search_effects-2689c7e68eae7a |

## System Engineer Summary

Self-organization Interactive Evolution (SOIE) is a simulation interface, allowing the interactive
exploration of self-organizing particle systems.

## Operational Role

For a systems engineer, roujiawen/soie belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-12T12:14:22Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2689c7e68eae7a` from `github_search_effects` as `registry_expansion`
