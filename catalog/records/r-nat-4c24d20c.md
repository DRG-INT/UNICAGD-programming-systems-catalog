...
<!-- canonical: https://cran.r-project.org/web/packages/nat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nat/index.html](https://cran.r-project.org/web/packages/nat/index.html) |
| Source record ids | cran_packages_by_date-8381c13493d285 |
...
For a systems engineer, nat belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.26 | 2026-08-04 12:00:02 UTC | [https://cran.r-project.org/web/packages/nat/DESCRIPTION](https://cran.r-project.org/web/packages/nat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nat/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8381c13493d285` from `cran_packages_by_date` as `registry_expansion`
