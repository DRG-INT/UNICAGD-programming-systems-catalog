...
<!-- canonical: https://luarocks.org/modules/swarg/cli-app-base -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/swarg/cli-app-base](https://luarocks.org/modules/swarg/cli-app-base) |
| Source record ids | luarocks_root_manifest-c9607faea6a1b3 |
...
For a systems engineer, cli-app-base belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c9607faea6a1b3` from `luarocks_root_manifest` as `registry_expansion`
