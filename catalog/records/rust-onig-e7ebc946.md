...
<!-- canonical: https://crates.io/crates/onig -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/onig](https://crates.io/crates/onig) |
| Source record ids | crates_io-6e3a6aea91e429 |

## System Engineer Summary

Rust-Onig is a set of Rust bindings for the Oniguruma regular expression library. Oniguruma is a
modern regex library with support for multiple character encodings and regex syntaxes.

## Operational Role

For a systems engineer, onig belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.5.3 | 2026-04-27T06:46:41.335899Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-6e3a6aea91e429` from `crates_io` as `registry_expansion`
