...
<!-- canonical: https://github.com/gitleaks/gitleaks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gitleaks/gitleaks](https://github.com/gitleaks/gitleaks) |
| Source record ids | github_search_go-0265033584ae09 |
...
For a systems engineer, gitleaks/gitleaks belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T04:17:05Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-0265033584ae09` from `github_search_go` as `registry_expansion`
