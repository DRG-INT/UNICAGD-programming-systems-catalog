...
<!-- canonical: https://pub.dev/packages/barcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/barcode](https://pub.dev/packages/barcode) |
| Source record ids | pub_dev-8aaab812fdcb29 |
...
For a systems engineer, barcode belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.9 | 2025-01-25T21:17:30.962523Z | [https://pub.dev/api/packages/barcode](https://pub.dev/api/packages/barcode) |  |
| preview | known | 2.0.0-nullsafety | 2020-11-28T00:29:59.717641Z | [https://pub.dev/api/packages/barcode](https://pub.dev/api/packages/barcode) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/barcode` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-8aaab812fdcb29` from `pub_dev` as `registry_expansion`
