...
<!-- canonical: https://cran.r-project.org/web/packages/arcpbf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/arcpbf/index.html](https://cran.r-project.org/web/packages/arcpbf/index.html) |
| Source record ids | cran_packages_by_date-9ff53cf1562fd8 |
...
For a systems engineer, arcpbf belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-21 10:50:02 UTC | [https://cran.r-project.org/web/packages/arcpbf/DESCRIPTION](https://cran.r-project.org/web/packages/arcpbf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/arcpbf/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9ff53cf1562fd8` from `cran_packages_by_date` as `registry_expansion`
