...
| Canonical URL | [https://github.com/danilogcrf2-oss/ESP32Synth](https://github.com/danilogcrf2-oss/ESP32Synth) |
| Source record ids | github_search_audio-1f1e510bb14b85 |

## System Engineer Summary

Polyphonic synthesizer with up to 350 voices/channels for the ESP32 dual core family, offering high-
fidelity audio (48kHz @ 32bit).

## Operational Role

For a systems engineer, danilogcrf2-oss/ESP32Synth belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.6 | 2026-08-30T15:16:20Z | [https://api.github.com/repos/danilogcrf2-oss/ESP32Synth/releases/latest](https://api.github.com/repos/danilogcrf2-oss/ESP32Synth/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/danilogcrf2-oss/ESP32Synth/releases/latest` at `2026-09-01T11:21:38+00:00`.
...
- `github_search_audio-1f1e510bb14b85` from `github_search_audio` as `registry_expansion`
