...
| Canonical URL | [https://crates.io/crates/alloy-sol-macro-expander](https://crates.io/crates/alloy-sol-macro-expander) |
| Source record ids | crates_io-b85e81dac686c6 |
...
For a systems engineer, alloy-sol-macro-expander belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.1 | 2026-08-25T20:59:35.257659Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads` at `2026-09-01T02:12:58+00:00`.
...
- `crates_io-b85e81dac686c6` from `crates_io` as `registry_expansion`
