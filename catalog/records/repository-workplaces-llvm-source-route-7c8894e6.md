...
<!-- canonical: https://github.com/llvm/llvm-project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/llvm/llvm-project](https://github.com/llvm/llvm-project) |
| Source record ids | curated_repository_workplace_routes-1bf1538a95a2b7 |

## System Engineer Summary

Official LLVM monorepo route used by Clang, lld, libc++, compiler-rt, MLIR, and related tooling.

## Operational Role

For a systems engineer, LLVM Source Route belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-1bf1538a95a2b7` from `curated_repository_workplace_routes` as `registry_expansion`
