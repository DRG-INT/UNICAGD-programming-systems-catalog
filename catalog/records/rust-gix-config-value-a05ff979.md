...
| Canonical URL | [https://crates.io/crates/gix-config-value](https://crates.io/crates/gix-config-value) |
| Source record ids | crates_io-6f2d9a5abda5f4 |
...
For a systems engineer, gix-config-value belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19.1 | 2026-08-03T18:23:30.345278Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-6f2d9a5abda5f4` from `crates_io` as `registry_expansion`
