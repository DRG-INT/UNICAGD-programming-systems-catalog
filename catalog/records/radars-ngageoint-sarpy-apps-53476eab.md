...
<!-- canonical: https://github.com/ngageoint/sarpy_apps -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ngageoint/sarpy_apps](https://github.com/ngageoint/sarpy_apps) |
| Source record ids | github_search_radars-c5f20a546ea3df |

## System Engineer Summary

ngageoint/sarpy_apps is tracked as a library record in the Radars branch. The source did not provide
...
For a systems engineer, ngageoint/sarpy_apps belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-19T15:16:27Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c5f20a546ea3df` from `github_search_radars` as `registry_expansion`
