...
<!-- canonical: https://cran.r-project.org/web/packages/qbr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qbr/index.html](https://cran.r-project.org/web/packages/qbr/index.html) |
| Source record ids | cran_packages_by_date-5a005c62c1d143 |
...
For a systems engineer, qbr belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-19 22:20:07 UTC | [https://cran.r-project.org/web/packages/qbr/DESCRIPTION](https://cran.r-project.org/web/packages/qbr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qbr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5a005c62c1d143` from `cran_packages_by_date` as `registry_expansion`
