...
<!-- canonical: https://docs.gitea.com/usage/packages/overview -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.gitea.com/usage/packages/overview](https://docs.gitea.com/usage/packages/overview) |
| Source record ids | curated_repository_workplace_routes-2e75bbfdf6f234 |

## System Engineer Summary

Gitea package registry surface for language package ecosystems and container artifacts.

## Operational Role

For a systems engineer, Gitea Packages belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-2e75bbfdf6f234` from `curated_repository_workplace_routes` as `registry_expansion`
