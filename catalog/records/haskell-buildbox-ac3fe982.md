...
<!-- canonical: https://hackage.haskell.org/package/buildbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/buildbox](https://hackage.haskell.org/package/buildbox) |
| Source record ids | hackage_top_downloads-ac37f30f4b02fc |
...
For a systems engineer, buildbox belongs in the Haskell inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1.2 | 2018-10-12T10:02:44Z | [https://hackage.haskell.org/package/buildbox](https://hackage.haskell.org/package/buildbox) |  |
| candidate | partial | 2.2.1.1 |  | [https://hackage.haskell.org/package/buildbox](https://hackage.haskell.org/package/buildbox) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/buildbox` at `2026-09-01T14:24:08+00:00`.
...
- `hackage_top_downloads-ac37f30f4b02fc` from `hackage_top_downloads` as `registry_expansion`
