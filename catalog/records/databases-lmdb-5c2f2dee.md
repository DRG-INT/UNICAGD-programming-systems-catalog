...
<!-- canonical: https://git.openldap.org/openldap/openldap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://git.openldap.org/openldap/openldap](https://git.openldap.org/openldap/openldap) |
| Source record ids | curated_database_systems-97282686dc4476 |

## System Engineer Summary

Memory-mapped embedded key-value database engine.

## Operational Role

For a systems engineer, LMDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-97282686dc4476` from `curated_database_systems` as `registry_expansion`
