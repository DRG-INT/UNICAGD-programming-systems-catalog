...
| Canonical URL | [https://packagist.org/packages/devtheorem/peachy-sql](https://packagist.org/packages/devtheorem/peachy-sql) |
| Source record ids | packagist_search-ff8716aa590017 |
...
For a systems engineer, devtheorem/peachy-sql belongs in the PHP inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.0.2 | 2026-08-07T02:47:03+00:00 | [https://repo.packagist.org/p2/devtheorem/peachy-sql.json](https://repo.packagist.org/p2/devtheorem/peachy-sql.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/devtheorem/peachy-sql.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-ff8716aa590017` from `packagist_search` as `registry_expansion`
...
| ezsql/ezsql | Build System | [open](php-ezsql-ezsql-96ed119a.md) |
