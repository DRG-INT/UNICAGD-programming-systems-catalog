...
<!-- canonical: https://crates.io/crates/remove_dir_all -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/remove_dir_all](https://crates.io/crates/remove_dir_all) |
| Source record ids | crates_io-811a78ab24be16 |
...
For a systems engineer, remove_dir_all belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2024-11-22T13:28:04.656448Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-811a78ab24be16` from `crates_io` as `registry_expansion`
