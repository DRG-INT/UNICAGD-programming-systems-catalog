...
<!-- canonical: https://github.com/superuser404notfound/Sodalite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/superuser404notfound/Sodalite](https://github.com/superuser404notfound/Sodalite) |
| Source record ids | github_search_photography-7748f5691b985e |

## System Engineer Summary

Native Jellyfin client for Apple TV, iPhone and iPad with built-in Seerr requests. Direct Play for
movies, shows, music and live TV with DVR, real HDR10 / HDR10+ / Dolby Vision and Dolby Atmos.
AirPlay and Picture in Picture on iOS. Powered by AetherEngine.

## Operational Role

For a systems engineer, superuser404notfound/Sodalite belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T06:20:17Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_photography-7748f5691b985e` from `github_search_photography` as `registry_expansion`
