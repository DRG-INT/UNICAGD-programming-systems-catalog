...
<!-- canonical: https://www.nuget.org/packages/Ecng.Collections -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Ecng.Collections](https://www.nuget.org/packages/Ecng.Collections) |
| Source record ids | nuget_search-b350279a38ca39 |

## System Engineer Summary

Ecng.Collections is tracked as a serialization record in the C-Sharp branch. The source did not
...
For a systems engineer, Ecng.Collections belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.308 | 2026-08-30T21:14:16.35+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/ecng.collections/index.json](https://api.nuget.org/v3/registration5-gz-semver2/ecng.collections/index.json) |  |
| preview | known | 1.0.29-atestpub | 2020-11-11T22:59:12.163+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/ecng.collections/index.json](https://api.nuget.org/v3/registration5-gz-semver2/ecng.collections/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; https://stocksharp.com/en/en/products/eula/ |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/ecng.collections/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-b350279a38ca39` from `nuget_search` as `registry_expansion`
