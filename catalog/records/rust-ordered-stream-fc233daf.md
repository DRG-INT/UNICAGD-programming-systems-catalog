...
<!-- canonical: https://crates.io/crates/ordered-stream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ordered-stream](https://crates.io/crates/ordered-stream) |
| Source record ids | crates_io-b6958ca35f16d5 |
...
For a systems engineer, ordered-stream belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-02-11T15:42:09.415977Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-b6958ca35f16d5` from `crates_io` as `registry_expansion`
