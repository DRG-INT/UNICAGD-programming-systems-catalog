...
<!-- canonical: https://pub.dev/packages/shelf_static -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_static](https://pub.dev/packages/shelf_static) |
| Source record ids | pub_dev-921ea7d69f2db7 |
...
For a systems engineer, shelf_static belongs in the Dart inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3 | 2024-09-06T16:01:03.025091Z | [https://pub.dev/api/packages/shelf_static](https://pub.dev/api/packages/shelf_static) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_static` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-921ea7d69f2db7` from `pub_dev` as `registry_expansion`
