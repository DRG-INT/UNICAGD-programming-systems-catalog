...
| Canonical URL | [https://crates.io/crates/cursor-icon](https://crates.io/crates/cursor-icon) |
| Source record ids | crates_io-e7f6ad16b10f27 |
...
For a systems engineer, cursor-icon belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2025-05-25T14:10:49.317221Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-e7f6ad16b10f27` from `crates_io` as `registry_expansion`
