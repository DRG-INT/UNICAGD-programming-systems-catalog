...
<!-- canonical: https://luarocks.org/modules/freed-wu/dottify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/dottify](https://luarocks.org/modules/freed-wu/dottify) |
| Source record ids | luarocks_root_manifest-90c108b6b66d3e |
...
For a systems engineer, dottify belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-90c108b6b66d3e` from `luarocks_root_manifest` as `registry_expansion`
