...
<!-- canonical: https://github.com/danielgerlag/workflow-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danielgerlag/workflow-core](https://github.com/danielgerlag/workflow-core) |
| Source record ids | github_search_engines-d7490d6892e2e8 |
...
For a systems engineer, danielgerlag/workflow-core belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T18:10:17Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d7490d6892e2e8` from `github_search_engines` as `registry_expansion`
