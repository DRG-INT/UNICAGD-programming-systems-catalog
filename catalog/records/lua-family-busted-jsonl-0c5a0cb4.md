...
<!-- canonical: https://luarocks.org/modules/eskerda/busted-jsonl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/eskerda/busted-jsonl](https://luarocks.org/modules/eskerda/busted-jsonl) |
| Source record ids | luarocks_root_manifest-e98adb763ff286 |
...
For a systems engineer, busted-jsonl belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-e98adb763ff286` from `luarocks_root_manifest` as `registry_expansion`
