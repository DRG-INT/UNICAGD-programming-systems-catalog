...
<!-- canonical: https://crates.io/crates/convert_case -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/convert_case](https://crates.io/crates/convert_case) |
| Source record ids | crates_io-487b287e296ed6 |
...
For a systems engineer, convert_case belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-08-27T10:11:15.495987Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-487b287e296ed6` from `crates_io` as `registry_expansion`
