...
| Canonical URL | [https://crates.io/crates/softbuffer](https://crates.io/crates/softbuffer) |
| Source record ids | crates_io-d9cea0640110fb |
...
For a systems engineer, softbuffer belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.8 | 2025-12-13T22:00:22.125107Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-d9cea0640110fb` from `crates_io` as `registry_expansion`
