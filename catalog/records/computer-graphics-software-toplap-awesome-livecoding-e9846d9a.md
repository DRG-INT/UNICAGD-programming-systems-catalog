...
<!-- canonical: https://github.com/toplap/awesome-livecoding -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/toplap/awesome-livecoding](https://github.com/toplap/awesome-livecoding) |
| Source record ids | github_search_computer_graphics_software-02654d551f410f |

## System Engineer Summary

toplap/awesome-livecoding is tracked as a community reference record in the Computer Graphics
Software branch. The source did not provide a long description, so this page keeps the identity,
release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, toplap/awesome-livecoding belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-02654d551f410f` from `github_search_computer_graphics_software` as `registry_expansion`
