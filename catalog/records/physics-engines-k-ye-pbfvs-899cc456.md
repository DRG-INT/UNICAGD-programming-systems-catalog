...
<!-- canonical: https://github.com/k-ye/PbfVs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/k-ye/PbfVs](https://github.com/k-ye/PbfVs) |
| Source record ids | github_search_physics_engines-10488b54105df9 |

## System Engineer Summary

Implementation of Macklin, Miles, and Matthias Müller. "Position based fluids.". Visual Studio 2015
+ CUDA 8.0

## Operational Role

For a systems engineer, k-ye/PbfVs belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-08-05T17:41:45Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-10488b54105df9` from `github_search_physics_engines` as `registry_expansion`
