# com.sap.cds:cds4j-dependencies-bom

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cds/cds4j-dependencies-bom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cds/cds4j-dependencies-bom](https://central.sonatype.com/artifact/com.sap.cds/cds4j-dependencies-bom) |
| Source record ids | maven_central_search-205ed0b32724c8 |
...
For a systems engineer, com.sap.cds:cds4j-dependencies-bom belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.10.1 | 2025-05-16T09:42:50+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json) |  |
...
- `maven_central_search-205ed0b32724c8` from `maven_central_search` as `registry_expansion`
