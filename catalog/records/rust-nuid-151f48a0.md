...
| Canonical URL | [https://crates.io/crates/nuid](https://crates.io/crates/nuid) |
| Source record ids | crates_io-ff9441cc1799f1 |
...
For a systems engineer, nuid belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2025-07-21T19:04:02.145210Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-ff9441cc1799f1` from `crates_io` as `registry_expansion`
