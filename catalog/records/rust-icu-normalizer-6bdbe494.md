...
<!-- canonical: https://crates.io/crates/icu_normalizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_normalizer](https://crates.io/crates/icu_normalizer) |
| Source record ids | crates_io-0bf4433775fe55 |
...
For a systems engineer, icu_normalizer belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-13T23:28:56.931089Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-0bf4433775fe55` from `crates_io` as `registry_expansion`
