...
<!-- canonical: https://github.com/PerfectlySoft/Perfect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PerfectlySoft/Perfect](https://github.com/PerfectlySoft/Perfect) |
| Source record ids | github_search_swift-8f4ee8fd8508af |

## System Engineer Summary

Legacy Perfect - Server-side Swift. The Perfect core toolset and framework for Swift Developers.
(For mobile back-end development, website and API development, and more…)

## Operational Role

For a systems engineer, PerfectlySoft/Perfect belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-03T15:38:39Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_swift-8f4ee8fd8508af` from `github_search_swift` as `registry_expansion`
