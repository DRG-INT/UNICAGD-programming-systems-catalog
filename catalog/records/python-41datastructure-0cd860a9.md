...
<!-- canonical: https://pypi.org/project/41datastructure/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/41datastructure/](https://pypi.org/project/41datastructure/) |
| Source record ids | pypi_simple-c338515ab06f1e |
...
For a systems engineer, 41datastructure belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5 | 2023-04-17T14:54:38.401223Z | [https://pypi.org/pypi/41datastructure/json](https://pypi.org/pypi/41datastructure/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/41datastructure/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-c338515ab06f1e` from `pypi_simple` as `registry_expansion`
