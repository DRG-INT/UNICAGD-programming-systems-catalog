...
<!-- canonical: https://github.com/ij-plugins/ijp-color -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ij-plugins/ijp-color](https://github.com/ij-plugins/ijp-color) |
| Source record ids | github_search_microscopy-2223aa7363880a |
...
For a systems engineer, ij-plugins/ijp-color belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-23T03:47:09Z | gh search repos topic:imagej stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `github_search_microscopy-2223aa7363880a` from `github_search_microscopy` as `registry_expansion`
...
| ImageJ | Image Audio Dsp | [open](microscopy-imagej-433ddc8a.md) |
