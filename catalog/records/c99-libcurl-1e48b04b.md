...
| Source record ids | master-65e7fb04bc2c |

## System Engineer Summary

libcurl is tracked as a networking http record in the C99 branch. The source did not provide a long
...
For a systems engineer, libcurl belongs in the C99 inventory as part of service communication,
...
- `master-65e7fb04bc2c` from `master_json` as `networking_http`
