...
<!-- canonical: https://github.com/tboox/tbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tboox/tbox](https://github.com/tboox/tbox) |
| Source record ids | awesome_list-85bde9f596cdfb |

## System Engineer Summary

A glib-like multi-platform c library. Apache2

## Operational Role

For a systems engineer, tbox belongs in the C++23 inventory as part of service communication,
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache-2.0; https://www.nuget.org/packages/NodaTime.Serialization.JsonNet/3.3.0/license |
...
- `awesome_list-85bde9f596cdfb` from `awesome_list` as `registry_expansion`
