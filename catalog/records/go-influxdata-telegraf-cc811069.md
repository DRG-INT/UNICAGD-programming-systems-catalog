...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/influxdata/telegraf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/influxdata/telegraf](https://github.com/influxdata/telegraf) |
| Source record ids | github_search_go-9a4b3439c17d6b |
...
For a systems engineer, influxdata/telegraf belongs in the Go inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:12:32Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-9a4b3439c17d6b` from `github_search_go` as `registry_expansion`
