# matiahasmasan/nightSky

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/matiahasmasan/nightSky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matiahasmasan/nightSky](https://github.com/matiahasmasan/nightSky) |
| Source record ids | github_search_space_maps-607e1d4212bf39 |

## System Engineer Summary

NightSky is a web app that generated dynamically sky maps using AstromonyAPI and nominatimAPI. This
system include just the client interfaces, built with html, css, Tailwind CSS and javaScript for the
front-end, Node.js for the back-end

## Operational Role

For a systems engineer, matiahasmasan/nightSky belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T17:06:21Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-607e1d4212bf39` from `github_search_space_maps` as `registry_expansion`
