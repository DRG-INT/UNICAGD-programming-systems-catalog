...
<!-- canonical: https://pub.dev/packages/serverpod -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/serverpod](https://pub.dev/packages/serverpod) |
| Source record ids | pub_dev-e11342a8df7a00 |
...
For a systems engineer, serverpod belongs in the Dart inventory as part of request routing,
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; {"key": "", "name": "", "url": ""} |
...
- `pub_dev-e11342a8df7a00` from `pub_dev` as `registry_expansion`
