...
<!-- canonical: https://cran.r-project.org/web/packages/PBD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PBD/index.html](https://cran.r-project.org/web/packages/PBD/index.html) |
| Source record ids | cran_packages_by_date-ff2cc1c72e968a |
...
For a systems engineer, PBD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6 | 2026-09-04 16:40:02 UTC | [https://cran.r-project.org/web/packages/PBD/DESCRIPTION](https://cran.r-project.org/web/packages/PBD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PBD/DESCRIPTION` at `2026-09-04T18:21:01+00:00`.
...
- `cran_packages_by_date-ff2cc1c72e968a` from `cran_packages_by_date` as `registry_expansion`
