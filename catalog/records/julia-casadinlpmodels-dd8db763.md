...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CasADiNLPModels](https://github.com/JuliaRegistries/General/tree/master/C/CasADiNLPModels) |
| Source record ids | julia_general-4a595b9fbeaf7c |

## System Engineer Summary

Julia package registered in General at C/CasADiNLPModels.

## Operational Role

For a systems engineer, CasADiNLPModels belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CasADiNLPModels", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-4a595b9fbeaf7c` from `julia_general` as `registry_expansion`
