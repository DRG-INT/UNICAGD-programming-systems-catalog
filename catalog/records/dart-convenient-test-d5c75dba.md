...
<!-- canonical: https://pub.dev/packages/convenient_test -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/convenient_test](https://pub.dev/packages/convenient_test) |
| Source record ids | pub_dev-75f9ec645ae018 |

## System Engineer Summary

Write and debug tests easily, with full action history, time travel, screenshots, rapid re-
execution, video records, interactivity, isolation and more

## Operational Role

For a systems engineer, convenient_test belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.2 | 2026-03-28T00:59:52.527631Z | [https://pub.dev/api/packages/convenient_test](https://pub.dev/api/packages/convenient_test) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/convenient_test` at `2026-09-01T07:20:16+00:00`.
...
- `pub_dev-75f9ec645ae018` from `pub_dev` as `registry_expansion`
