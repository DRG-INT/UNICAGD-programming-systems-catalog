...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Linter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/linter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-d5b84735c85c |

## System Engineer Summary

Selene is tracked as a linter record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Selene belongs in the Lua family inventory as part of static feedback, style
...
- `master-d5b84735c85c` from `master_json` as `linter`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| BabeLua | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-babelua-7861cdcc.md) |
| chineselinter.nvim | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-chineselinter-nvim-47d52761.md) |
| efmls-configs-nvim | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-efmls-configs-nvim-7178f999.md) |
| guard.nvim | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-guard-nvim-1067da84.md) |
| luacheck | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luacheck-f60b1257.md) |
| LuaInspect | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-luainspect-4f34f4fc.md) |
| vscode-lua | Linter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-vscode-lua-96a38461.md) |
