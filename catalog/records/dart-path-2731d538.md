...
<!-- canonical: https://pub.dev/packages/path -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/path](https://pub.dev/packages/path) |
| Source record ids | pub_dev-a8e72ad6044d2b |

## System Engineer Summary

A string-based path manipulation library. All of the path operations you know and love, with solid
support for Windows, POSIX (Linux and Mac OS X), and the web.

## Operational Role

For a systems engineer, path belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.1 | 2024-10-17T08:37:58.135322Z | [https://pub.dev/api/packages/path](https://pub.dev/api/packages/path) |  |
| preview | known | 1.8.0-nullsafety.3 | 2020-11-03T22:15:31.815817Z | [https://pub.dev/api/packages/path](https://pub.dev/api/packages/path) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/path` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-a8e72ad6044d2b` from `pub_dev` as `registry_expansion`
