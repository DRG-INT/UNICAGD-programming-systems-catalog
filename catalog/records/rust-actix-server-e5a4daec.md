...
<!-- canonical: https://crates.io/crates/actix-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-server](https://crates.io/crates/actix-server) |
| Source record ids | crates_io-214f8e2f9961cb |
...
For a systems engineer, actix-server belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.1 | 2026-08-27T18:31:01.057307Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-214f8e2f9961cb` from `crates_io` as `registry_expansion`
