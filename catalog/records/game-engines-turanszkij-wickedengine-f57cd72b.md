...
<!-- canonical: https://github.com/turanszkij/WickedEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/turanszkij/WickedEngine](https://github.com/turanszkij/WickedEngine) |
| Source record ids | github_search_game_engines-bfc53198adcbcc |
...
For a systems engineer, turanszkij/WickedEngine belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T15:27:47Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-bfc53198adcbcc` from `github_search_game_engines` as `registry_expansion`
