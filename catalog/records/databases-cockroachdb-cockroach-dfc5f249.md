...
| Source record ids | github_search_databases-bf819248551b50 |
...
For a systems engineer, cockroachdb/cockroach belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T17:32:56Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-bf819248551b50` from `github_search_databases` as `registry_expansion`
