...
| Canonical URL | [https://crates.io/crates/uuid](https://crates.io/crates/uuid) |
| Source record ids | corpus-433cef6ab1f20a |
...
For a systems engineer, uuid belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.26.0 | 2026-08-26T22:08:30.860532Z | [https://crates.io/api/v1/crates/uuid](https://crates.io/api/v1/crates/uuid) |  |
| preview | known | 1.0.0-alpha.1 | 2021-11-18T02:15:16.111070Z | [https://crates.io/api/v1/crates/uuid](https://crates.io/api/v1/crates/uuid) |  |

## Engineering Notes

- Treat category as `utility_library` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/uuid` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-433cef6ab1f20a` from `master_json` as `utility_library`
