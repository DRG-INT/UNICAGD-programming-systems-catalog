# sergiodm92/spring-telemetry

## Navigation

[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sergiodm92/spring-telemetry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sergiodm92/spring-telemetry](https://github.com/sergiodm92/spring-telemetry) |
| Source record ids | github_search_telescopes-37da3fc78a28d7 |

## System Engineer Summary

A zero-configuration, real-time debugging and observability dashboard for Spring Boot 3. Captures
HTTP requests, SQL queries, exceptions, logs, cache, scheduled tasks, events, mail, and Hibernate
model changes — all in-memory. Add one dependency, open /telescope.

## Operational Role

For a systems engineer, sergiodm92/spring-telemetry belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-31T11:09:02Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-37da3fc78a28d7` from `github_search_telescopes` as `registry_expansion`
