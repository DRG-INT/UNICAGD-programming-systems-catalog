...
| Source record ids | github_search_matlab-51639bff9dd2b1 |
...
For a systems engineer, nanahou/Awesome-Speech-Enhancement belongs in the Matlab inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-01T10:20:50Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_matlab-51639bff9dd2b1` from `github_search_matlab` as `registry_expansion`
