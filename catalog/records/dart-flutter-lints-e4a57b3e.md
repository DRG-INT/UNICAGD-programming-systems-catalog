...
<!-- canonical: https://pub.dev/packages/flutter_lints -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_lints](https://pub.dev/packages/flutter_lints) |
| Source record ids | pub_dev-da19118eebe01a |
...
For a systems engineer, flutter_lints belongs in the Dart inventory as part of static feedback,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2025-05-27T13:59:16.618213Z | [https://pub.dev/api/packages/flutter_lints](https://pub.dev/api/packages/flutter_lints) |  |
| preview | known | 1.0.0-dev.0 | 2021-05-05T23:57:43.122279Z | [https://pub.dev/api/packages/flutter_lints](https://pub.dev/api/packages/flutter_lints) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_lints` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-da19118eebe01a` from `pub_dev` as `registry_expansion`
