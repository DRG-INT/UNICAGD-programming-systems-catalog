...
<!-- canonical: https://github.com/subsoap/deffx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/subsoap/deffx](https://github.com/subsoap/deffx) |
| Source record ids | github_search_effects-ed63ecd8e6a276 |
...
For a systems engineer, subsoap/deffx belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-26T18:55:18Z | gh search repos topic:shader-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ed63ecd8e6a276` from `github_search_effects` as `registry_expansion`
