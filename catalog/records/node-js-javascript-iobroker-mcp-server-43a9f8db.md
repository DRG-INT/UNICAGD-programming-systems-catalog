...
<!-- canonical: https://www.npmjs.com/package/@iobroker/mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@iobroker/mcp-server](https://www.npmjs.com/package/@iobroker/mcp-server) |
| Source record ids | npm_registry-4bc2fedca41567 |

## System Engineer Summary

@iobroker/mcp-server is tracked as a web framework record in the Node.js/JavaScript branch. The
...
For a systems engineer, @iobroker/mcp-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-03T16:58:14.574Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4bc2fedca41567` from `npm_registry` as `registry_expansion`
