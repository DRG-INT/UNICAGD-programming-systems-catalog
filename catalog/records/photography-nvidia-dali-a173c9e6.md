...
<!-- canonical: https://github.com/NVIDIA/DALI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NVIDIA/DALI](https://github.com/NVIDIA/DALI) |
| Source record ids | github_search_photography-66ba1049b682a8 |

## System Engineer Summary

A GPU-accelerated library containing highly optimized building blocks and an execution engine for
data processing to accelerate deep learning training and inference applications.

## Operational Role

For a systems engineer, NVIDIA/DALI belongs in the Photography inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:25:51Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-66ba1049b682a8` from `github_search_photography` as `registry_expansion`
