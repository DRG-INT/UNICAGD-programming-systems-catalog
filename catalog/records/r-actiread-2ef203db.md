...
<!-- canonical: https://cran.r-project.org/web/packages/actiread/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/actiread/index.html](https://cran.r-project.org/web/packages/actiread/index.html) |
| Source record ids | cran_packages_by_date-92c491933531d5 |

## System Engineer Summary

Baseline Package for Reading Actigraphy and Activity Data

## Operational Role

For a systems engineer, actiread belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-21 20:40:02 UTC | [https://cran.r-project.org/web/packages/actiread/DESCRIPTION](https://cran.r-project.org/web/packages/actiread/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/actiread/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-92c491933531d5` from `cran_packages_by_date` as `registry_expansion`
