...
<!-- canonical: https://pypi.org/project/acore-server-metadata/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acore-server-metadata/](https://pypi.org/project/acore-server-metadata/) |
| Source record ids | pypi_simple-65cd2ea5f8b9a0 |
...
For a systems engineer, acore-server-metadata belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2024-06-22T14:46:14.792548Z | [https://pypi.org/pypi/acore-server-metadata/json](https://pypi.org/pypi/acore-server-metadata/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acore-server-metadata/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-65cd2ea5f8b9a0` from `pypi_simple` as `registry_expansion`
