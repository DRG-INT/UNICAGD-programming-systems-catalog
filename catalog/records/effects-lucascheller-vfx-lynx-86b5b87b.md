...
<!-- canonical: https://github.com/LucaScheller/VFX-LYNX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LucaScheller/VFX-LYNX](https://github.com/LucaScheller/VFX-LYNX) |
| Source record ids | github_search_effects-a2e6abcacdad93 |
...
For a systems engineer, LucaScheller/VFX-LYNX belongs in the Effects inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-08-19T17:49:26Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a2e6abcacdad93` from `github_search_effects` as `registry_expansion`
