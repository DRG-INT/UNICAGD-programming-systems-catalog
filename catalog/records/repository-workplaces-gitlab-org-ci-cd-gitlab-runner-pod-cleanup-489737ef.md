...
<!-- canonical: https://gitlab.com/gitlab-org/ci-cd/gitlab-runner-pod-cleanup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/ci-cd/gitlab-runner-pod-cleanup](https://gitlab.com/gitlab-org/ci-cd/gitlab-runner-pod-cleanup) |
| Source record ids | gitlab_projects_api-141957e93f7c4f |
...
For a systems engineer, gitlab-org/ci-cd/gitlab-runner-pod-cleanup belongs in the Repository
...
- `gitlab_projects_api-141957e93f7c4f` from `gitlab_projects_api` as `registry_expansion`
