...
<!-- canonical: https://cran.r-project.org/web/packages/cellGeometry/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cellGeometry/index.html](https://cran.r-project.org/web/packages/cellGeometry/index.html) |
| Source record ids | cran_packages_by_date-c4afdae953acfd |
...
For a systems engineer, cellGeometry belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-09-07 17:10:02 UTC | [https://cran.r-project.org/web/packages/cellGeometry/DESCRIPTION](https://cran.r-project.org/web/packages/cellGeometry/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cellGeometry/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-c4afdae953acfd` from `cran_packages_by_date` as `registry_expansion`
