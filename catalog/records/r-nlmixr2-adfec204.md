...
<!-- canonical: https://cran.r-project.org/web/packages/nlmixr2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nlmixr2/index.html](https://cran.r-project.org/web/packages/nlmixr2/index.html) |
| Source record ids | cran_packages_by_date-f52d50f8a86d0b |
...
For a systems engineer, nlmixr2 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.1 | 2026-08-05 00:20:08 UTC | [https://cran.r-project.org/web/packages/nlmixr2/DESCRIPTION](https://cran.r-project.org/web/packages/nlmixr2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nlmixr2/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f52d50f8a86d0b` from `cran_packages_by_date` as `registry_expansion`
