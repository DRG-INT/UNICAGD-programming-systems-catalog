...
<!-- canonical: https://github.com/sztupy/luadec51 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sztupy/luadec51](https://github.com/sztupy/luadec51) |
| Source record ids | lua-source-327 |
...
For a systems engineer, luadec51 belongs in the Lua family inventory as part of compiler selection,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 327}}` |
...
- `lua-source-327` from `master_json` as `source_list_item`
