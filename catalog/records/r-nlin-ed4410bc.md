...
<!-- canonical: https://cran.r-project.org/web/packages/NLIN/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NLIN/index.html](https://cran.r-project.org/web/packages/NLIN/index.html) |
| Source record ids | cran_packages_by_date-1bfe17fcec9ddf |

## System Engineer Summary

Critical Points for Nonlinear Growth Models

## Operational Role

For a systems engineer, NLIN belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 16:30:07 UTC | [https://cran.r-project.org/web/packages/NLIN/DESCRIPTION](https://cran.r-project.org/web/packages/NLIN/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NLIN/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-1bfe17fcec9ddf` from `cran_packages_by_date` as `registry_expansion`
