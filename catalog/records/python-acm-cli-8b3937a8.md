...
<!-- canonical: https://pypi.org/project/acm-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acm-cli/](https://pypi.org/project/acm-cli/) |
| Source record ids | pypi_simple-6f011c79d80ca7 |
...
For a systems engineer, acm-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-04-14T02:19:38.515192Z | [https://pypi.org/pypi/acm-cli/json](https://pypi.org/pypi/acm-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acm-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-6f011c79d80ca7` from `pypi_simple` as `registry_expansion`
