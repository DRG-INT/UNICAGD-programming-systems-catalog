...
<!-- canonical: https://github.com/gvx/Ser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gvx/Ser](https://github.com/gvx/Ser) |
| Source record ids | lua-source-273 |
...
For a systems engineer, Ser belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 273}}` |
...
- `lua-source-273` from `master_json` as `source_list_item`
