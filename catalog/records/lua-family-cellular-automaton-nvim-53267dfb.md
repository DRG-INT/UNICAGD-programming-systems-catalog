...
<!-- canonical: https://luarocks.org/modules/neorocks/cellular-automaton.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cellular-automaton.nvim](https://luarocks.org/modules/neorocks/cellular-automaton.nvim) |
| Source record ids | luarocks_root_manifest-1bc37ef6d1e801 |

## System Engineer Summary

Lets you execute aesthetically pleasing, cellular automaton animations based on the content of
neovim buffer.

## Operational Role

For a systems engineer, cellular-automaton.nvim belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-1bc37ef6d1e801` from `luarocks_root_manifest` as `registry_expansion`
