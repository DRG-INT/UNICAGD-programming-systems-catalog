...
<!-- canonical: https://crates.io/crates/enumflags2_derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enumflags2_derive](https://crates.io/crates/enumflags2_derive) |
| Source record ids | crates_io-34663bd1614042 |

## System Engineer Summary

Do not use directly, use the reexport in the `enumflags2` crate. This allows for better
compatibility across versions.

## Operational Role

For a systems engineer, enumflags2_derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.12 | 2025-06-09T22:15:13.358677Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-34663bd1614042` from `crates_io` as `registry_expansion`
