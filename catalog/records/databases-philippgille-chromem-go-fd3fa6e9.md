...
<!-- canonical: https://github.com/philippgille/chromem-go -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/philippgille/chromem-go](https://github.com/philippgille/chromem-go) |
| Source record ids | github_search_databases-94f90015f8f249 |

## System Engineer Summary

Embeddable vector database for Go with Chroma-like interface and zero third-party dependencies. In-
memory with optional persistence.

## Operational Role

For a systems engineer, philippgille/chromem-go belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-17T18:00:12Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-94f90015f8f249` from `github_search_databases` as `registry_expansion`
