...
| Canonical URL | [https://crates.io/crates/gix-chunk](https://crates.io/crates/gix-chunk) |
| Source record ids | crates_io-2ccb1f9b4fbae6 |
...
For a systems engineer, gix-chunk belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-08-22T19:01:57.501738Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-2ccb1f9b4fbae6` from `crates_io` as `registry_expansion`
