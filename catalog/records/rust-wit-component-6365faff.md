...
<!-- canonical: https://crates.io/crates/wit-component -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-component](https://crates.io/crates/wit-component) |
| Source record ids | crates_io-219e0faa9a89ec |
...
For a systems engineer, wit-component belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.259.0 | 2026-09-10T17:57:00.077281Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-10T18:21:44+00:00`.
...
- `crates_io-219e0faa9a89ec` from `crates_io` as `registry_expansion`
