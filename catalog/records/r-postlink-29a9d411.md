...
<!-- canonical: https://cran.r-project.org/web/packages/postlink/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/postlink/index.html](https://cran.r-project.org/web/packages/postlink/index.html) |
| Source record ids | cran_packages_by_date-48976a5bbbd568 |
...
For a systems engineer, postlink belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-04 07:00:14 UTC | [https://cran.r-project.org/web/packages/postlink/DESCRIPTION](https://cran.r-project.org/web/packages/postlink/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/postlink/DESCRIPTION` at `2026-09-04T08:21:46+00:00`.
...
- `cran_packages_by_date-48976a5bbbd568` from `cran_packages_by_date` as `registry_expansion`
