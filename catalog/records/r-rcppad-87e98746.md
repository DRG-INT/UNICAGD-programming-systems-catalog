...
<!-- canonical: https://cran.r-project.org/web/packages/RCppAD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RCppAD/index.html](https://cran.r-project.org/web/packages/RCppAD/index.html) |
| Source record ids | cran_packages_by_date-5d754bbefdb442 |
...
For a systems engineer, RCppAD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.20260000.0-1 | 2026-09-11 07:00:22 UTC | [https://cran.r-project.org/web/packages/RCppAD/DESCRIPTION](https://cran.r-project.org/web/packages/RCppAD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RCppAD/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-5d754bbefdb442` from `cran_packages_by_date` as `registry_expansion`
