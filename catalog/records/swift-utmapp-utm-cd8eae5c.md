...
<!-- canonical: https://github.com/utmapp/UTM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/utmapp/UTM](https://github.com/utmapp/UTM) |
| Source record ids | github_search_swift-b16acb8bfe0fc0 |
...
For a systems engineer, utmapp/UTM belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T05:28:36Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-b16acb8bfe0fc0` from `github_search_swift` as `registry_expansion`
