...
<!-- canonical: https://github.com/LinArcX/telescope-command-palette.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LinArcX/telescope-command-palette.nvim](https://github.com/LinArcX/telescope-command-palette.nvim) |
| Source record ids | github_search_telescopes-1427c000f214d2 |
...
For a systems engineer, LinArcX/telescope-command-palette.nvim belongs in the Telescopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-24T06:16:23Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-1427c000f214d2` from `github_search_telescopes` as `registry_expansion`
