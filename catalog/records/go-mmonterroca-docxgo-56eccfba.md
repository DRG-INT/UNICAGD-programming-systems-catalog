...
<!-- canonical: https://github.com/mmonterroca/docxgo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mmonterroca/docxgo](https://github.com/mmonterroca/docxgo) |
| Source record ids | github_search_go-82b6d2d395b772 |

## System Engineer Summary

Create and edit Microsoft Word (.docx) documents in pure Go — fluent builder, templates & mail
merge, themes, tables, and images.

## Operational Role

For a systems engineer, mmonterroca/docxgo belongs in the Go inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T23:05:23Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-82b6d2d395b772` from `github_search_go` as `registry_expansion`
