...
<!-- canonical: https://github.com/konvajs/konva -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/konvajs/konva](https://github.com/konvajs/konva) |
| Source record ids | github_search_computer_graphics_software-9e53b684af1eac |

## System Engineer Summary

Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas
interactivity for desktop and mobile applications.

## Operational Role

For a systems engineer, konvajs/konva belongs in the Computer Graphics Software inventory as part of
...
- `github_search_computer_graphics_software-9e53b684af1eac` from `github_search_computer_graphics_software` as `registry_expansion`
