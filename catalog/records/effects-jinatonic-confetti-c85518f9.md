...
| Canonical URL | [https://github.com/jinatonic/confetti](https://github.com/jinatonic/confetti) |
| Source record ids | github_search_effects-0d54d034f18f0f |
...
For a systems engineer, jinatonic/confetti belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2017-12-11T21:30:00Z | [https://api.github.com/repos/jinatonic/confetti/releases/latest](https://api.github.com/repos/jinatonic/confetti/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jinatonic/confetti/releases/latest` at `2026-09-01T09:23:11+00:00`.
...
- `github_search_effects-0d54d034f18f0f` from `github_search_effects` as `registry_expansion`
...
| pixijs-userland/particle-emitter | Library | [open](effects-pixijs-userland-particle-emitter-b76be455.md) |
