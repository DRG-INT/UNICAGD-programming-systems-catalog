...
<!-- canonical: https://github.com/Michaelredaa/Djed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Michaelredaa/Djed](https://github.com/Michaelredaa/Djed) |
| Source record ids | github_search_assets-8b0b7857e06e0b |

## System Engineer Summary

Djed is an assets tools for manage and facilitate the workflow by connect all dcc together and save
the published asset into database

## Operational Role

For a systems engineer, Michaelredaa/Djed belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-24T21:26:55Z | gh search repos topic:3d-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-8b0b7857e06e0b` from `github_search_assets` as `registry_expansion`
