...
| Source record ids | lua-source-48 |

## System Engineer Summary

References is tracked as a community reference record in the Lua family branch. The source did not
...
For a systems engineer, References belongs in the Lua family inventory as part of ecosystem
...
| Evidence | MIT + file LICENSE; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 48}}` |
...
- `lua-source-48` from `master_json` as `source_list_item`
