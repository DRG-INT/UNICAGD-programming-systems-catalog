...
<!-- canonical: https://cran.r-project.org/web/packages/gert/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gert/index.html](https://cran.r-project.org/web/packages/gert/index.html) |
| Source record ids | cran_packages_by_date-c6e7fac19230d8 |

## System Engineer Summary

gert is tracked as a networking http record in the R branch. The source did not provide a long
...
For a systems engineer, gert belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.1 | 2026-08-19 14:20:02 UTC | [https://cran.r-project.org/web/packages/gert/DESCRIPTION](https://cran.r-project.org/web/packages/gert/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gert/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c6e7fac19230d8` from `cran_packages_by_date` as `registry_expansion`
