...
<!-- canonical: https://github.com/TableProApp/TablePro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TableProApp/TablePro](https://github.com/TableProApp/TablePro) |
| Source record ids | github_search_swift-d7775de3d033b2 |
...
For a systems engineer, TableProApp/TablePro belongs in the Swift inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:37:39Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-d7775de3d033b2` from `github_search_swift` as `registry_expansion`
...
| Moya/Moya | Networking Http | [open](swift-moya-moya-feb40e46.md) |
