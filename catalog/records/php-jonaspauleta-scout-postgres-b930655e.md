...
<!-- canonical: https://packagist.org/packages/jonaspauleta/scout-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jonaspauleta/scout-postgres](https://packagist.org/packages/jonaspauleta/scout-postgres) |
| Source record ids | packagist_search-94158b05db6df4 |
...
For a systems engineer, jonaspauleta/scout-postgres belongs in the PHP inventory as part of state
...
- `packagist_search-94158b05db6df4` from `packagist_search` as `registry_expansion`
