...
<!-- canonical: https://github.com/feder-cr/AIHawk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/feder-cr/AIHawk](https://github.com/feder-cr/AIHawk) |
| Source record ids | github_search_aims-9baa9cb657686f |
...
For a systems engineer, feder-cr/AIHawk belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T21:57:35Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-9baa9cb657686f` from `github_search_aims` as `registry_expansion`
