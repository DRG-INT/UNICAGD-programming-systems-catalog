...
<!-- canonical: https://github.com/dtm-labs/dtm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dtm-labs/dtm](https://github.com/dtm-labs/dtm) |
| Source record ids | github_search_databases-e12c6960023aca |

## System Engineer Summary

A distributed transaction framework, supports workflow, saga, tcc, xa, 2-phase message, outbox
patterns, supports many languages.

## Operational Role

For a systems engineer, dtm-labs/dtm belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-03T13:47:46Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e12c6960023aca` from `github_search_databases` as `registry_expansion`
