...
<!-- canonical: https://cran.r-project.org/web/packages/htmlreportR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/htmlreportR/index.html](https://cran.r-project.org/web/packages/htmlreportR/index.html) |
| Source record ids | cran_packages_by_date-212c9801b77d57 |
...
For a systems engineer, htmlreportR belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-09-11 10:20:02 UTC | [https://cran.r-project.org/web/packages/htmlreportR/DESCRIPTION](https://cran.r-project.org/web/packages/htmlreportR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/htmlreportR/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-212c9801b77d57` from `cran_packages_by_date` as `registry_expansion`
