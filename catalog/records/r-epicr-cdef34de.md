...
<!-- canonical: https://cran.r-project.org/web/packages/epicR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/epicR/index.html](https://cran.r-project.org/web/packages/epicR/index.html) |
| Source record ids | cran_packages_by_date-0e84bcdde5148b |

## System Engineer Summary

Evaluation Platform in Chronic Obstructive Pulmonary Disease

## Operational Role

For a systems engineer, epicR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-09 07:40:20 UTC | [https://cran.r-project.org/web/packages/epicR/DESCRIPTION](https://cran.r-project.org/web/packages/epicR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/epicR/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-0e84bcdde5148b` from `cran_packages_by_date` as `registry_expansion`
