...
<!-- canonical: https://github.com/Continuous-Collision-Detection/Tight-Inclusion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Continuous-Collision-Detection/Tight-Inclusion](https://github.com/Continuous-Collision-Detection/Tight-Inclusion) |
| Source record ids | github_search_physics_engines-80cf018355f068 |

## System Engineer Summary

A conservative continuous collision detection (CCD) method with support for minimum separation. Wang
et al. 2021

## Operational Role

For a systems engineer, Continuous-Collision-Detection/Tight-Inclusion belongs in the Physics
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T15:36:01Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-80cf018355f068` from `github_search_physics_engines` as `registry_expansion`
