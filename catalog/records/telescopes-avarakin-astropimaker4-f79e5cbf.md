...
<!-- canonical: https://github.com/avarakin/AstroPiMaker4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avarakin/AstroPiMaker4](https://github.com/avarakin/AstroPiMaker4) |
| Source record ids | github_search_telescopes-a5b6b8a07978a0 |

## System Engineer Summary

This repository provides instructions and script for building a computer for Astrophotography

## Operational Role

For a systems engineer, avarakin/AstroPiMaker4 belongs in the Telescopes inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-07T02:00:10Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-a5b6b8a07978a0` from `github_search_telescopes` as `registry_expansion`
