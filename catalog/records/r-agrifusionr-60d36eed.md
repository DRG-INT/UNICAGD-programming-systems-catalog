...
<!-- canonical: https://cran.r-project.org/web/packages/AgriFusionR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AgriFusionR/index.html](https://cran.r-project.org/web/packages/AgriFusionR/index.html) |
| Source record ids | cran_packages_by_date-ba1d06acaea1df |
...
For a systems engineer, AgriFusionR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-26 20:20:08 UTC | [https://cran.r-project.org/web/packages/AgriFusionR/DESCRIPTION](https://cran.r-project.org/web/packages/AgriFusionR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AgriFusionR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ba1d06acaea1df` from `cran_packages_by_date` as `registry_expansion`
