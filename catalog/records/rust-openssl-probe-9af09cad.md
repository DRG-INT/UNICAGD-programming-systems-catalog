...
<!-- canonical: https://crates.io/crates/openssl-probe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/openssl-probe](https://crates.io/crates/openssl-probe) |
| Source record ids | crates_io-7f08006d849de1 |

## System Engineer Summary

A library for helping to find system-wide trust anchor ("root") certificate locations based on paths
typically used by `openssl`.

## Operational Role

For a systems engineer, openssl-probe belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-01-20T19:53:29.225766Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-7f08006d849de1` from `crates_io` as `registry_expansion`
