...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Stratio/cassandra-lucene-index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Stratio/cassandra-lucene-index](https://github.com/Stratio/cassandra-lucene-index) |
| Source record ids | github_search_catalogs-5f068b42e49dd1 |
...
For a systems engineer, Stratio/cassandra-lucene-index belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-05-27T11:21:14Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-5f068b42e49dd1` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| algolia/scout-extended | Registry Repository | [open](catalogs-algolia-scout-extended-cc62ced2.md) |
| apache/lucenenet | Registry Repository | [open](catalogs-apache-lucenenet-be7a96a2.md) |
| Backstage Software Catalog | Registry Repository | [open](catalogs-backstage-software-catalog-65fa83e8.md) |
| CKAN | Registry Repository | [open](catalogs-ckan-265fba92.md) |
| DataHub | Registry Repository | [open](catalogs-datahub-fc4a0261.md) |
| Ecosyste.ms | Registry Repository | [open](catalogs-ecosyste-ms-b04b4db1.md) |
| EpicWink/proxpi | Registry Repository | [open](catalogs-epicwink-proxpi-19684f44.md) |
| FreeCAD/FreeCAD-addons | Registry Repository | [open](catalogs-freecad-freecad-addons-a615b5b9.md) |
