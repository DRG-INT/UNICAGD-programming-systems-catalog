# imamankhatri/SpaceShuttle-Simulation
...
<!-- canonical: https://github.com/imamankhatri/SpaceShuttle-Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/imamankhatri/SpaceShuttle-Simulation](https://github.com/imamankhatri/SpaceShuttle-Simulation) |
| Source record ids | github_search_space_shuttles-afa2ce86aa5cfa |
...
For a systems engineer, imamankhatri/SpaceShuttle-Simulation belongs in the Space Shuttles inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-08T16:52:14Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-afa2ce86aa5cfa` from `github_search_space_shuttles` as `registry_expansion`
