...
<!-- canonical: https://pub.dev/packages/reflectable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/reflectable](https://pub.dev/packages/reflectable) |
| Source record ids | pub_dev-43da7b37e4e162 |

## System Engineer Summary

Reflection support based on code generation, using 'capabilities' to specify which operations to
support, on which objects. This is the run-time part of reflectable.

## Operational Role

For a systems engineer, reflectable belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.2.3 | 2026-05-26T11:52:15.597918Z | [https://pub.dev/api/packages/reflectable](https://pub.dev/api/packages/reflectable) |  |
| preview | known | 3.0.0-nullsafety.1 | 2021-01-21T15:21:15.042923Z | [https://pub.dev/api/packages/reflectable](https://pub.dev/api/packages/reflectable) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/reflectable` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-43da7b37e4e162` from `pub_dev` as `registry_expansion`
