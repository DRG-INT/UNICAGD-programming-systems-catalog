...
<!-- canonical: https://crates.io/crates/chrono -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-76f273829b6750 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.45 | 2026-06-04T12:16:42.063037Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-07T00:31:27+00:00`.
...
- `crates_io-76f273829b6750` from `crates_io` as `registry_expansion`
