...
| Source record ids | github_search_effects-84bd7f703542c9 |
...
For a systems engineer, white-shiro-bai/ghost_sa belongs in the Effects inventory as part of request
...
- `github_search_effects-84bd7f703542c9` from `github_search_effects` as `registry_expansion`
