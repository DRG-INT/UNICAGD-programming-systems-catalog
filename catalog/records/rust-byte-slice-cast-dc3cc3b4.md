...
<!-- canonical: https://crates.io/crates/byte-slice-cast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/byte-slice-cast](https://crates.io/crates/byte-slice-cast) |
| Source record ids | crates_io-bdedbe0794a4aa |
...
For a systems engineer, byte-slice-cast belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2025-03-03T10:02:39.494851Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-bdedbe0794a4aa` from `crates_io` as `registry_expansion`
