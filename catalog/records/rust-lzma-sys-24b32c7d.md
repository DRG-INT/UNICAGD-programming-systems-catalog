...
<!-- canonical: https://crates.io/crates/lzma-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lzma-sys](https://crates.io/crates/lzma-sys) |
| Source record ids | crates_io-a46fe16ed03980 |
...
For a systems engineer, lzma-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.20 | 2022-10-31T15:18:35.015053Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a46fe16ed03980` from `crates_io` as `registry_expansion`
