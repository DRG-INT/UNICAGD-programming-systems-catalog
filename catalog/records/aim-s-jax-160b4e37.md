...
| Canonical URL | [https://github.com/jax-ml/jax](https://github.com/jax-ml/jax) |
| Source record ids | curated_language_routes-03ded5dcb383fa |

## System Engineer Summary

Composable numerical computing and accelerator framework used for AI research, transformations,
autodiff, and compilation.

## Operational Role

For a systems engineer, JAX belongs in the "aim's" inventory as part of model pipelines, numerical
...
- `curated_language_routes-03ded5dcb383fa` from `curated_language_routes` as `registry_expansion`
...
| TensorFlow | Machine Learning | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/aim-s-tensorflow-128400a0.md) |
