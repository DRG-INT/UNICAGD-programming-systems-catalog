...
<!-- canonical: https://github.com/appml/neutrinote -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/appml/neutrinote](https://github.com/appml/neutrinote) |
| Source record ids | github_search_magazines-c1f9470504dc69 |

## System Engineer Summary

neutriNote - the original Markdown + Math note app. Programmatically extensible. Sync-ready note
storage. Non-commerical. No lock-ins. Only 3 MB footprint & highly optimized. Designed for plaintext
purists.

## Operational Role

For a systems engineer, appml/neutrinote belongs in the Magazines inventory as part of ecosystem
...
- `github_search_magazines-c1f9470504dc69` from `github_search_magazines` as `registry_expansion`
