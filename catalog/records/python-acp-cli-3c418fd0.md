...
<!-- canonical: https://pypi.org/project/acp-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acp-cli/](https://pypi.org/project/acp-cli/) |
| Source record ids | pypi_simple-11ef25df069c95 |

## System Engineer Summary

acp-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, acp-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.804 | 2026-01-16T22:36:43.010581Z | [https://pypi.org/pypi/acp-cli/json](https://pypi.org/pypi/acp-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acp-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-11ef25df069c95` from `pypi_simple` as `registry_expansion`
