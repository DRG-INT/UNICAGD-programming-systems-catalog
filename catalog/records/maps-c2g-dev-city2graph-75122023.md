...
<!-- canonical: https://github.com/c2g-dev/city2graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/c2g-dev/city2graph](https://github.com/c2g-dev/city2graph) |
| Source record ids | github_search_maps-69e5beec20de5e |
...
For a systems engineer, c2g-dev/city2graph belongs in the Maps inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:22:20Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-69e5beec20de5e` from `github_search_maps` as `registry_expansion`
