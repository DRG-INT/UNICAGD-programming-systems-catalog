...
<!-- canonical: https://www.nuget.org/packages/Refit.Newtonsoft.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Refit.Newtonsoft.Json](https://www.nuget.org/packages/Refit.Newtonsoft.Json) |
| Source record ids | nuget_search-04a91270db2d93 |

## System Engineer Summary

Newtonsoft.Json content serializer for Refit clients that need Json.NET converters, settings, or
compatibility behavior instead of the default System.Text.Json serializer.

## Operational Role

For a systems engineer, Refit.Newtonsoft.Json belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 15.2.0 | 2026-08-18T14:52:54.973+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit.newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit.newtonsoft.json/index.json) |  |
| preview | known | 15.0.0-beta.1 | 2026-08-03T08:34:49.76+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/refit.newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/refit.newtonsoft.json/index.json) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT; https://www.nuget.org/packages/Refit.Newtonsoft.Json/15.2.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/refit.newtonsoft.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-04a91270db2d93` from `nuget_search` as `registry_expansion`
