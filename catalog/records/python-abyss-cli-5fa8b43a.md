...
<!-- canonical: https://pypi.org/project/abyss-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abyss-cli/](https://pypi.org/project/abyss-cli/) |
| Source record ids | pypi_simple-ce13ef2722927b |

## System Engineer Summary

abyss-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, abyss-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-08-01T16:40:04.167122Z | [https://pypi.org/pypi/abyss-cli/json](https://pypi.org/pypi/abyss-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abyss-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-ce13ef2722927b` from `pypi_simple` as `registry_expansion`
