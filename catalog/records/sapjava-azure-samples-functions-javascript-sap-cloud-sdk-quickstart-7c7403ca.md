# Azure-Samples/functions-javascript-sap-cloud-sdk-quickstart
...
<!-- canonical: https://github.com/Azure-Samples/functions-javascript-sap-cloud-sdk-quickstart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Azure-Samples/functions-javascript-sap-cloud-sdk-quickstart](https://github.com/Azure-Samples/functions-javascript-sap-cloud-sdk-quickstart) |
| Source record ids | github_search_sapjava-4a3f9cd3f31d6e |
...
For a systems engineer, Azure-Samples/functions-javascript-sap-cloud-sdk-quickstart belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-27T07:46:01Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-4a3f9cd3f31d6e` from `github_search_sapjava` as `registry_expansion`
