...
<!-- canonical: https://github.com/zhoubolei/CAM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zhoubolei/CAM](https://github.com/zhoubolei/CAM) |
| Source record ids | github_search_matlab-557993eb03669d |
...
For a systems engineer, zhoubolei/CAM belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-13T14:02:02Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-557993eb03669d` from `github_search_matlab` as `registry_expansion`
