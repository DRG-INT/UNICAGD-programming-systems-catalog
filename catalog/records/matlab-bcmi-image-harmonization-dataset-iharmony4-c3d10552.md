...
<!-- canonical: https://github.com/bcmi/Image-Harmonization-Dataset-iHarmony4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bcmi/Image-Harmonization-Dataset-iHarmony4](https://github.com/bcmi/Image-Harmonization-Dataset-iHarmony4) |
| Source record ids | github_search_matlab-818c9851907815 |

## System Engineer Summary

CVPR 2020 The first large-scale public benchmark dataset for image harmonization. The code used in
our paper "DoveNet: Deep Image Harmonization via Domain Verification", CVPR2020. Useful for image
harmonization, image composition, etc.

## Operational Role

For a systems engineer, bcmi/Image-Harmonization-Dataset-iHarmony4 belongs in the Matlab inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T08:31:02Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-818c9851907815` from `github_search_matlab` as `registry_expansion`
