...
<!-- canonical: https://github.com/ColsonZhang/CZ_OpenSpice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ColsonZhang/CZ_OpenSpice](https://github.com/ColsonZhang/CZ_OpenSpice) |
| Source record ids | github_search_space_maps-36a3c343c372c9 |

## System Engineer Summary

ColsonZhang/CZ_OpenSpice is tracked as a library record in the Space Maps branch. The source did not
...
For a systems engineer, ColsonZhang/CZ_OpenSpice belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-03T05:27:05Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-36a3c343c372c9` from `github_search_space_maps` as `registry_expansion`
