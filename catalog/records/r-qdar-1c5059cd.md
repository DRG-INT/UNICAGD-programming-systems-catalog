...
<!-- canonical: https://cran.r-project.org/web/packages/qdaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qdaR/index.html](https://cran.r-project.org/web/packages/qdaR/index.html) |
| Source record ids | cran_packages_by_date-3872a55917cca4 |

## System Engineer Summary

Read and Analyse Qualitative Coding Exported from Zotero

## Operational Role

For a systems engineer, qdaR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-05 13:50:08 UTC | [https://cran.r-project.org/web/packages/qdaR/DESCRIPTION](https://cran.r-project.org/web/packages/qdaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qdaR/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-3872a55917cca4` from `cran_packages_by_date` as `registry_expansion`
