...
<!-- canonical: https://pub.dev/packages/android_id -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/android_id](https://pub.dev/packages/android_id) |
| Source record ids | pub_dev-b48888304bb38d |
...
For a systems engineer, android_id belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2+1 | 2026-07-06T20:09:20.962087Z | [https://pub.dev/api/packages/android_id](https://pub.dev/api/packages/android_id) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/android_id` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-b48888304bb38d` from `pub_dev` as `registry_expansion`
...
| back_button_interceptor | Library | [open](dart-back-button-interceptor-a1769376.md) |
