...
| Source record ids | github_search_assets-3361e7e2106afa |
...
For a systems engineer, unjs/fontaine belongs in the Assets inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T03:58:50Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-3361e7e2106afa` from `github_search_assets` as `registry_expansion`
