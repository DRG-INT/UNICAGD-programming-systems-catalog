...
<!-- canonical: https://hackage.haskell.org/package/arch-hs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/arch-hs](https://hackage.haskell.org/package/arch-hs) |
| Source record ids | hackage_top_downloads-ac04315f573ba8 |
...
For a systems engineer, arch-hs belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.1 | 2026-06-25T20:36:05Z | [https://hackage.haskell.org/package/arch-hs](https://hackage.haskell.org/package/arch-hs) |  |
| candidate | partial | 0.0.0.0 |  | [https://hackage.haskell.org/package/arch-hs](https://hackage.haskell.org/package/arch-hs) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/arch-hs` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-ac04315f573ba8` from `hackage_top_downloads` as `registry_expansion`
