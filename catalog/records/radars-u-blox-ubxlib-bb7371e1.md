...
<!-- canonical: https://github.com/u-blox/ubxlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/u-blox/ubxlib](https://github.com/u-blox/ubxlib) |
| Source record ids | github_search_radars-59655c82ee046d |

## System Engineer Summary

Portable C libraries which provide APIs to build applications with u-blox products and services.
Delivered as add-on to existing microcontroller and RTOS SDKs.

## Operational Role

For a systems engineer, u-blox/ubxlib belongs in the Radars inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-11T13:41:33Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-59655c82ee046d` from `github_search_radars` as `registry_expansion`
