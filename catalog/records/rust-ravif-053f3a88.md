...
| Canonical URL | [https://crates.io/crates/ravif](https://crates.io/crates/ravif) |
| Source record ids | crates_io-5ff0ea2a268b17 |
...
For a systems engineer, ravif belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-01-19T02:06:16.292679Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-5ff0ea2a268b17` from `crates_io` as `registry_expansion`
