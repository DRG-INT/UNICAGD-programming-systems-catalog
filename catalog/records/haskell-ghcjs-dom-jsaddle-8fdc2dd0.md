...
<!-- canonical: https://hackage.haskell.org/package/ghcjs-dom-jsaddle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghcjs-dom-jsaddle](https://hackage.haskell.org/package/ghcjs-dom-jsaddle) |
| Source record ids | hackage_top_downloads-a698adaef0d8da |
...
For a systems engineer, ghcjs-dom-jsaddle belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.9.1 | 2026-03-26T04:42:31Z | [https://hackage.haskell.org/package/ghcjs-dom-jsaddle](https://hackage.haskell.org/package/ghcjs-dom-jsaddle) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghcjs-dom-jsaddle` at `2026-09-09T00:35:00+00:00`.
...
- `hackage_top_downloads-a698adaef0d8da` from `hackage_top_downloads` as `registry_expansion`
