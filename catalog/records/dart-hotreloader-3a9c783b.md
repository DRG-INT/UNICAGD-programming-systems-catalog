...
<!-- canonical: https://pub.dev/packages/hotreloader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/hotreloader](https://pub.dev/packages/hotreloader) |
| Source record ids | pub_dev-7b2c55898638b2 |

## System Engineer Summary

Automatic hot code reloader for Dart projects that monitors the source files of a Dart project for
changes and automatically applies them to the running Dart process.

## Operational Role

For a systems engineer, hotreloader belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.0 | 2026-04-04T22:53:18.913943Z | [https://pub.dev/api/packages/hotreloader](https://pub.dev/api/packages/hotreloader) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/hotreloader` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-7b2c55898638b2` from `pub_dev` as `registry_expansion`
