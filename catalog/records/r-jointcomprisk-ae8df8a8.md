...
<!-- canonical: https://cran.r-project.org/web/packages/jointCompRisk/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jointCompRisk/index.html](https://cran.r-project.org/web/packages/jointCompRisk/index.html) |
| Source record ids | cran_packages_by_date-6264286f6e7727 |
...
For a systems engineer, jointCompRisk belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-19 23:10:02 UTC | [https://cran.r-project.org/web/packages/jointCompRisk/DESCRIPTION](https://cran.r-project.org/web/packages/jointCompRisk/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jointCompRisk/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6264286f6e7727` from `cran_packages_by_date` as `registry_expansion`
