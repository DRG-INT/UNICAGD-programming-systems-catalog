...
<!-- canonical: https://github.com/scality/Zenko -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scality/Zenko](https://github.com/scality/Zenko) |
| Source record ids | github_search_databases-33063a1ca5b05e |

## System Engineer Summary

Zenko is the open source multi-cloud data controller: own and keep control of your data on any
cloud.

## Operational Role

For a systems engineer, scality/Zenko belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:50:17Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-33063a1ca5b05e` from `github_search_databases` as `registry_expansion`
