...
<!-- canonical: https://crates.io/crates/enum-iterator-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enum-iterator-derive](https://crates.io/crates/enum-iterator-derive) |
| Source record ids | crates_io-cc93cb0a8f931a |
...
For a systems engineer, enum-iterator-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2025-09-08T15:10:18.561931Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-cc93cb0a8f931a` from `crates_io` as `registry_expansion`
