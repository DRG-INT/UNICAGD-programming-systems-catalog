...
<!-- canonical: https://cran.r-project.org/web/packages/healthyR.ai/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/healthyR.ai/index.html](https://cran.r-project.org/web/packages/healthyR.ai/index.html) |
| Source record ids | cran_packages_by_date-321eff7283db77 |
...
For a systems engineer, healthyR.ai belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-21 14:40:33 UTC | [https://cran.r-project.org/web/packages/healthyR.ai/DESCRIPTION](https://cran.r-project.org/web/packages/healthyR.ai/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/healthyR.ai/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-321eff7283db77` from `cran_packages_by_date` as `registry_expansion`
