# Farhad8797/solar-system-threejs
...
<!-- canonical: https://github.com/Farhad8797/solar-system-threejs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Farhad8797/solar-system-threejs](https://github.com/Farhad8797/solar-system-threejs) |
| Source record ids | github_search_space_maps-e8427932847eae |

## System Engineer Summary

An interactive 3D Solar System simulation built with Three.js, featuring planetary orbits,
procedural lighting, custom texture maps, and smooth OrbitControls.

## Operational Role

For a systems engineer, Farhad8797/solar-system-threejs belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T13:38:07Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e8427932847eae` from `github_search_space_maps` as `registry_expansion`
