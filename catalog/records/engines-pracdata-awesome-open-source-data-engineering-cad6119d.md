...
<!-- canonical: https://github.com/pracdata/awesome-open-source-data-engineering -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pracdata/awesome-open-source-data-engineering](https://github.com/pracdata/awesome-open-source-data-engineering) |
| Source record ids | github_search_engines-d46b9bdc7ef455 |
...
For a systems engineer, pracdata/awesome-open-source-data-engineering belongs in the Engines
...
- `github_search_engines-d46b9bdc7ef455` from `github_search_engines` as `registry_expansion`
