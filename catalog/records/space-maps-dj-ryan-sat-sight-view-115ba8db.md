...
<!-- canonical: https://github.com/dj-ryan/sat-sight-view -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dj-ryan/sat-sight-view](https://github.com/dj-ryan/sat-sight-view) |
| Source record ids | github_search_space_maps-cb2437940da0ea |

## System Engineer Summary

A simulation of the Yale bright star catalog. Stars are position acording to their galactic
longitude and latitude.

## Operational Role

For a systems engineer, dj-ryan/sat-sight-view belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-04T23:00:17Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-cb2437940da0ea` from `github_search_space_maps` as `registry_expansion`
