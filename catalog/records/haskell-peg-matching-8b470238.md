...
<!-- canonical: https://hackage.haskell.org/package/peg-matching -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/peg-matching](https://hackage.haskell.org/package/peg-matching) |
| Source record ids | hackage_recent-2e5eb175e39bb5 |
...
For a systems engineer, peg-matching belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0.0 | 2026-09-01T20:20:18Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-2e5eb175e39bb5` from `hackage_recent` as `registry_expansion`
