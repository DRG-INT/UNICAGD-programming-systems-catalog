...
<!-- canonical: https://pypi.org/project/a13n-logging/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a13n-logging/](https://pypi.org/project/a13n-logging/) |
| Source record ids | pypi_simple-421a3671f48e9d |

## System Engineer Summary

Shared structured and developer-friendly logging for Agent Foundation

## Operational Role

For a systems engineer, a13n-logging belongs in the Python inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.3 | 2026-08-27T04:22:28.400410Z | [https://pypi.org/pypi/a13n-logging/json](https://pypi.org/pypi/a13n-logging/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a13n-logging/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-421a3671f48e9d` from `pypi_simple` as `registry_expansion`
