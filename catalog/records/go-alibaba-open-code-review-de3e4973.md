...
<!-- canonical: https://github.com/alibaba/open-code-review -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alibaba/open-code-review](https://github.com/alibaba/open-code-review) |
| Source record ids | github_search_go-080fff4f04ad6c |
...
For a systems engineer, alibaba/open-code-review belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-16T00:20:22Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-080fff4f04ad6c` from `github_search_go` as `registry_expansion`
