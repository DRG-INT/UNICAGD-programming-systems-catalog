...
<!-- canonical: https://github.com/deroverda/recommended-radio-streams -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deroverda/recommended-radio-streams](https://github.com/deroverda/recommended-radio-streams) |
| Source record ids | github_search_electromagnetoscopes-1d111a586db916 |

## System Engineer Summary

Internet radio stations I actually listen to - underground electronic, freeform, jazz, ambient, and
weird stuff. Direct stream URLs and the apps to play them.

## Operational Role

For a systems engineer, deroverda/recommended-radio-streams belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T05:29:36Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-1d111a586db916` from `github_search_electromagnetoscopes` as `registry_expansion`
