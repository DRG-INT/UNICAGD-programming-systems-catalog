...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Physics Engines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/physics-engines.md) · [Category: Math Numeric Scientific](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/math-numeric-scientific.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/RobotLocomotion/drake](https://github.com/RobotLocomotion/drake) |
| Source record ids | curated_language_routes-9475ede5d459e0 |

## System Engineer Summary

Model-based design and simulation toolbox for robotics dynamics, optimization, control, and
planning.

## Operational Role

For a systems engineer, Drake belongs in the Physics Engines inventory as part of ecosystem
...
- `curated_language_routes-9475ede5d459e0` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| MuJoCo | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-mujoco-46b4295a.md) |
| Project Chrono | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-project-chrono-ac9214b7.md) |
