# atg-testing/demo-webui-auditing
...
<!-- canonical: https://github.com/atg-testing/demo-webui-auditing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atg-testing/demo-webui-auditing](https://github.com/atg-testing/demo-webui-auditing) |
| Source record ids | github_search_repertoare_catalogs-5aa9449fed2877 |

## System Engineer Summary

Security & compliance audit suite auto-generated by ATG for SauceDemo's login form — injects real
payloads (XSS, SQLi, boundary/edge cases) per field and scores the result against ATG's rule
catalog. Clone it and run it yourself.

## Operational Role

For a systems engineer, atg-testing/demo-webui-auditing belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T17:58:33Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-5aa9449fed2877` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| earbona23/entra-privilege-auditor | Security Sast | [open](repertoare-catalogs-earbona23-entra-privilege-auditor-08c52285.md) |
