...
| Canonical URL | [https://github.com/chebfun/chebfun](https://github.com/chebfun/chebfun) |
| Source record ids | github_search_matlab-c1f148e11d3365 |
...
For a systems engineer, chebfun/chebfun belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.7.0 | 2017-06-02T09:35:42Z | [https://api.github.com/repos/chebfun/chebfun/releases/latest](https://api.github.com/repos/chebfun/chebfun/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/chebfun/chebfun/releases/latest` at `2026-09-01T07:24:09+00:00`.
...
- `github_search_matlab-c1f148e11d3365` from `github_search_matlab` as `registry_expansion`
