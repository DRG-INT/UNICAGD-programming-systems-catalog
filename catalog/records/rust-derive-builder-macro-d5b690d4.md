...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Build System](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/build-system.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/derive_builder_macro](https://crates.io/crates/derive_builder_macro) |
| Source record ids | crates_io-01cd04fd7c8410 |
...
For a systems engineer, derive_builder_macro belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.2 | 2024-10-08T16:54:13.062233Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| android-activity | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-android-activity-958c810f.md) |
| async-task | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-async-task-7248a7cd.md) |
| backon | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-backon-59db9d30.md) |
| bon | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bon-5c756277.md) |
| build_const | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-build-const-0aeeb00d.md) |
| cargo-make | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-make-dcab0faa.md) |
| chrono-tz-build | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-chrono-tz-build-0484d9ba.md) |
| clap_builder | Build System | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-clap-builder-81592afe.md) |
