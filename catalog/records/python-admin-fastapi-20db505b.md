...
<!-- canonical: https://pypi.org/project/admin-fastapi/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/admin-fastapi/](https://pypi.org/project/admin-fastapi/) |
| Source record ids | pypi_simple-cf1da47c2a99a8 |

## System Engineer Summary

admin-fastapi is tracked as a parser lexer ast record in the Python branch. The source did not
...
For a systems engineer, admin-fastapi belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2020-08-09T22:19:02.250773Z | [https://pypi.org/pypi/admin-fastapi/json](https://pypi.org/pypi/admin-fastapi/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/admin-fastapi/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-cf1da47c2a99a8` from `pypi_simple` as `registry_expansion`
