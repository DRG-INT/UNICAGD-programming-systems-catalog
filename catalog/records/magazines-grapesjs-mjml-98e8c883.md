...
<!-- canonical: https://github.com/GrapesJS/mjml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GrapesJS/mjml](https://github.com/GrapesJS/mjml) |
| Source record ids | github_search_magazines-da1a685e0ee5f7 |
...
For a systems engineer, GrapesJS/mjml belongs in the Magazines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-15T18:48:10Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-da1a685e0ee5f7` from `github_search_magazines` as `registry_expansion`
