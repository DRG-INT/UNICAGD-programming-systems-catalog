...
<!-- canonical: https://github.com/tailec/ios-architecture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tailec/ios-architecture](https://github.com/tailec/ios-architecture) |
| Source record ids | awesome_list-064c7e77f1c494 |
...
For a systems engineer, ios-architecture belongs in the Cocoa inventory as part of runtime behavior,
...
- `awesome_list-064c7e77f1c494` from `awesome_list` as `registry_expansion`
