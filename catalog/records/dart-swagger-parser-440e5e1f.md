...
<!-- canonical: https://pub.dev/packages/swagger_parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/swagger_parser](https://pub.dev/packages/swagger_parser) |
| Source record ids | pub_dev-12cd6303171ebc |
...
For a systems engineer, swagger_parser belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.44.2 | 2026-09-01T10:16:51.778078Z | [https://pub.dev/api/packages/swagger_parser](https://pub.dev/api/packages/swagger_parser) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/swagger_parser` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-12cd6303171ebc` from `pub_dev` as `registry_expansion`
