...
<!-- canonical: https://cran.r-project.org/web/packages/AstraeaDB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AstraeaDB/index.html](https://cran.r-project.org/web/packages/AstraeaDB/index.html) |
| Source record ids | cran_packages_by_date-be7445bc418c7c |

## System Engineer Summary

Client for the 'AstraeaDB' Graph Database

## Operational Role

For a systems engineer, AstraeaDB belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-21 13:50:28 UTC | [https://cran.r-project.org/web/packages/AstraeaDB/DESCRIPTION](https://cran.r-project.org/web/packages/AstraeaDB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AstraeaDB/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-be7445bc418c7c` from `cran_packages_by_date` as `registry_expansion`
