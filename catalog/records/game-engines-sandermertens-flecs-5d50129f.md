...
<!-- canonical: https://github.com/SanderMertens/flecs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SanderMertens/flecs](https://github.com/SanderMertens/flecs) |
| Source record ids | github_search_game_engines-034a3011e8de3d |
...
For a systems engineer, SanderMertens/flecs belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:16:45Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-034a3011e8de3d` from `github_search_game_engines` as `registry_expansion`
