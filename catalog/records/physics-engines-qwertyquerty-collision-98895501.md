...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/qwertyquerty/collision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qwertyquerty/collision](https://github.com/qwertyquerty/collision) |
| Source record ids | github_search_physics_engines-e54bb49e0c2d84 |

## System Engineer Summary

Collision is a python library meant for collision detection between convex and concave polygons,
circles, and points.

## Operational Role

For a systems engineer, qwertyquerty/collision belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-22T18:02:03Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e54bb49e0c2d84` from `github_search_physics_engines` as `registry_expansion`
