...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Telescopes](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/telescopes.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | curated_language_routes-75209052cc8f76 |

## System Engineer Summary

Planetarium and sky simulation software with telescope control plugins and astronomical catalogs.

## Operational Role

For a systems engineer, Stellarium belongs in the Telescopes inventory as part of ecosystem
...
- `curated_language_routes-75209052cc8f76` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| KStars | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/telescopes-kstars-8ac0884b.md) |
| SAOImage DS9 | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/telescopes-saoimage-ds9-75c04688.md) |
