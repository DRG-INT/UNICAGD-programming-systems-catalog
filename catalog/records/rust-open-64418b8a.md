...
<!-- canonical: https://crates.io/crates/open -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/open](https://crates.io/crates/open) |
| Source record ids | crates_io-543655ef68fdad |
...
For a systems engineer, open belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.4 | 2026-09-10T04:08:21.519593Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-10T05:19:29+00:00`.
...
- `crates_io-543655ef68fdad` from `crates_io` as `registry_expansion`
