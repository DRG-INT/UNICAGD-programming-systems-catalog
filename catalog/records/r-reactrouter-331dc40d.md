...
<!-- canonical: https://cran.r-project.org/web/packages/reactRouter/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/reactRouter/index.html](https://cran.r-project.org/web/packages/reactRouter/index.html) |
| Source record ids | cran_packages_by_date-e5dd365da02e7a |
...
For a systems engineer, reactRouter belongs in the R inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-01 08:20:02 UTC | [https://cran.r-project.org/web/packages/reactRouter/DESCRIPTION](https://cran.r-project.org/web/packages/reactRouter/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/reactRouter/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-e5dd365da02e7a` from `cran_packages_by_date` as `registry_expansion`
