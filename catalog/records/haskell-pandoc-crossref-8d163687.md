...
<!-- canonical: https://hackage.haskell.org/package/pandoc-crossref -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pandoc-crossref](https://hackage.haskell.org/package/pandoc-crossref) |
| Source record ids | hackage_top_downloads-296014c8107cc1 |
...
For a systems engineer, pandoc-crossref belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.25 | 2026-07-28T11:22:37Z | [https://hackage.haskell.org/package/pandoc-crossref](https://hackage.haskell.org/package/pandoc-crossref) |  |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pandoc-crossref` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-296014c8107cc1` from `hackage_top_downloads` as `registry_expansion`
