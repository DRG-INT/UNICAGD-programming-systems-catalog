...
<!-- canonical: https://cran.r-project.org/web/packages/ICESat2VegR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ICESat2VegR/index.html](https://cran.r-project.org/web/packages/ICESat2VegR/index.html) |
| Source record ids | cran_packages_by_date-ea9cad4df0a58b |

## System Engineer Summary

ICESat-2 Data Analysis for Land and Vegetation

## Operational Role

For a systems engineer, ICESat2VegR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-09-11 07:10:09 UTC | [https://cran.r-project.org/web/packages/ICESat2VegR/DESCRIPTION](https://cran.r-project.org/web/packages/ICESat2VegR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ICESat2VegR/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-ea9cad4df0a58b` from `cran_packages_by_date` as `registry_expansion`
