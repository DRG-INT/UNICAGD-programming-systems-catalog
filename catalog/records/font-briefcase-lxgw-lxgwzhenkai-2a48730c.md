...
<!-- canonical: https://github.com/lxgw/LxgwZhenKai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lxgw/LxgwZhenKai](https://github.com/lxgw/LxgwZhenKai) |
| Source record ids | github_search_font_briefcase-eddddae4263dd6 |

## System Engineer Summary

霞鹜臻楷：基于「霞鹜文楷」衍生，前期手动加粗调整字形，后期由 AI 生成字形辅助补字的开源中文字体。A bolder weight, AI-assisted font derived from
LXGW Wenkai.

## Operational Role

For a systems engineer, lxgw/LxgwZhenKai belongs in the Font Briefcase inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T08:57:47Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; MIT License; https://api.github.com/licenses/mit; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `github_search_font_briefcase-eddddae4263dd6` from `github_search_font_briefcase` as `registry_expansion`
