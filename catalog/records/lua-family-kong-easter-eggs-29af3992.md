...
| Canonical URL | [https://luarocks.org/modules/max/kong-easter-eggs](https://luarocks.org/modules/max/kong-easter-eggs) |
| Source record ids | luarocks_root_manifest-deae1f21d18693 |

## System Engineer Summary

A Kong plugin for adding of Easter Eggs to your API

## Operational Role

For a systems engineer, kong-easter-eggs belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-deae1f21d18693` from `luarocks_root_manifest` as `registry_expansion`
