...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/modelscope/FunASR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/modelscope/FunASR](https://github.com/modelscope/FunASR) |
| Source record ids | github_search_audio-4e3275a9144317 |

## System Engineer Summary

Open-source speech recognition toolkit for training, inference, streaming ASR, VAD, punctuation,
speaker diarization pipelines, and OpenAI-compatible/MCP serving.

## Operational Role

For a systems engineer, modelscope/FunASR belongs in the Audio inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:28:00Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-4e3275a9144317` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Archie3d/aeolus_plugin | Package Manager | [open](audio-archie3d-aeolus-plugin-c1d397f6.md) |
| attenlabs/saa-sdk | Package Manager | [open](audio-attenlabs-saa-sdk-feb070cb.md) |
| Audio4Linux/JDSP4Linux | Package Manager | [open](audio-audio4linux-jdsp4linux-effd41ab.md) |
| collidingScopes/arpeggiator | Package Manager | [open](audio-collidingscopes-arpeggiator-f2da818f.md) |
| open-audio-stack/open-audio-stack-registry | Package Manager | [open](audio-open-audio-stack-open-audio-stack-registry-6bcfb8c0.md) |
