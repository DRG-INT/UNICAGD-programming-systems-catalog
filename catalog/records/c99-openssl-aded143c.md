...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Cryptography](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cryptography.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-69ad4e35e9e5 |

## System Engineer Summary

TLS/cryptography library

## Operational Role

For a systems engineer, OpenSSL belongs in the C99 inventory as part of confidentiality, integrity,
...
- `master-69ad4e35e9e5` from `master_json` as `cryptography`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| LibreSSL | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libressl-b80bacb9.md) |
| libsodium | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libsodium-9c07dc84.md) |
| mbed TLS | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-mbed-tls-4e155f6a.md) |
| wolfSSL | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-wolfssl-fbf59074.md) |
