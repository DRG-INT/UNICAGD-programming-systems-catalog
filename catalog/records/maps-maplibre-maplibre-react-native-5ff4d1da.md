...
<!-- canonical: https://github.com/maplibre/maplibre-react-native -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/maplibre-react-native](https://github.com/maplibre/maplibre-react-native) |
| Source record ids | github_search_maps-82092dcf216019 |

## System Engineer Summary

MapLibre React Native – Interactive vector tile maps with MapLibre Native in Expo and React Native
supporting Android & iOS.

## Operational Role

For a systems engineer, maplibre/maplibre-react-native belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T05:04:13Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-82092dcf216019` from `github_search_maps` as `registry_expansion`
