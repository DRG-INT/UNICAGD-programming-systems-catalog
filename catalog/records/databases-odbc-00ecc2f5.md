...
<!-- canonical: https://learn.microsoft.com/sql/odbc/reference/odbc-programmer-s-reference -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://learn.microsoft.com/sql/odbc/reference/odbc-programmer-s-reference](https://learn.microsoft.com/sql/odbc/reference/odbc-programmer-s-reference) |
| Source record ids | curated_database_systems-812f5902e039b0 |

## System Engineer Summary

Open Database Connectivity API for database drivers and clients.

## Operational Role

For a systems engineer, ODBC belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-812f5902e039b0` from `curated_database_systems` as `registry_expansion`
