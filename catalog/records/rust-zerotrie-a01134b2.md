...
<!-- canonical: https://crates.io/crates/zerotrie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zerotrie](https://crates.io/crates/zerotrie) |
| Source record ids | crates_io-8f7d70ec33e3b8 |
...
For a systems engineer, zerotrie belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-13T23:28:19.996564Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-8f7d70ec33e3b8` from `crates_io` as `registry_expansion`
