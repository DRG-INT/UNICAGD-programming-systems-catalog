...
<!-- canonical: https://github.com/pml76/orbsim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pml76/orbsim](https://github.com/pml76/orbsim) |
| Source record ids | github_search_space_shuttles-2d0864874bf7fb |

## System Engineer Summary

A space flight simulator in the spirit of Orbiter: real orbital mechanics, 6-DOF vessels, MFD
instrumentation. C++23 and Vulkan.

## Operational Role

For a systems engineer, pml76/orbsim belongs in the Space Shuttles inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T09:25:07Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-2d0864874bf7fb` from `github_search_space_shuttles` as `registry_expansion`
