...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Thomas-Loudis/georb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Thomas-Loudis/georb](https://github.com/Thomas-Loudis/georb) |
| Source record ids | github_search_space_engines-896eb0d207fb4b |

## System Engineer Summary

Software for precise orbit determination, gravity field recovery and mission design

## Operational Role

For a systems engineer, Thomas-Loudis/georb belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T12:36:11Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_space_engines-896eb0d207fb4b` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Conquer-Space/Conquer-Space | Precommit Ci Quality | [open](space-engines-conquer-space-conquer-space-a0dd07bc.md) |
