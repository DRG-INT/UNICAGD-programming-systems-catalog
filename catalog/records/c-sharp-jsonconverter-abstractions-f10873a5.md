...
<!-- canonical: https://www.nuget.org/packages/JsonConverter.Abstractions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonConverter.Abstractions](https://www.nuget.org/packages/JsonConverter.Abstractions) |
| Source record ids | nuget_search-89072dbf3bd067 |
...
For a systems engineer, JsonConverter.Abstractions belongs in the C-Sharp inventory as part of wire
formats, persistence, interoperability, and compatibility boundaries.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-06-07T19:06:16.21+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.abstractions/index.json) |  |
| preview | known | 0.0.1-preview-01 | 2022-08-13T07:55:05.57+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.abstractions/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/JsonConverter.Abstractions/0.13.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.abstractions/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-89072dbf3bd067` from `nuget_search` as `registry_expansion`
...
| CloudNative.CloudEvents.SystemTextJson | Serialization | [open](c-sharp-cloudnative-cloudevents-systemtextjson-a23a5ae4.md) |
