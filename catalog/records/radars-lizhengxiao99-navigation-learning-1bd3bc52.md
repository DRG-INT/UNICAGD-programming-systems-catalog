...
<!-- canonical: https://github.com/LiZhengXiao99/Navigation-Learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/LiZhengXiao99/Navigation-Learning](https://github.com/LiZhengXiao99/Navigation-Learning) |
| Source record ids | github_search_radars-9459821326b67b |

## System Engineer Summary

我的导航算法学习笔记，内容涵盖导航定位开源程序的源码解读、开源项目梳理、书籍讲义、博客翻译、教程讲座推荐；所有内容都可以随意转载，原始文件都放在这里了，大家可以在我的基础上整理出自己的一些文档。（Ti
ps：①主要是写给初学者，已经有基础的同学应该多看论文和代码，看我的笔记学不到啥；②仓库持续更新中，不建议 fork）

## Operational Role

For a systems engineer, LiZhengXiao99/Navigation-Learning belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-07T06:21:33Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9459821326b67b` from `github_search_radars` as `registry_expansion`
