...
<!-- canonical: https://packagist.org/packages/pomm-project/model-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pomm-project/model-manager](https://packagist.org/packages/pomm-project/model-manager) |
| Source record ids | packagist_search-1f7d6c5642469e |
...
For a systems engineer, pomm-project/model-manager belongs in the PHP inventory as part of state
...
- `packagist_search-1f7d6c5642469e` from `packagist_search` as `registry_expansion`
