...
<!-- canonical: https://www.npmjs.com/package/expo-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/expo-server](https://www.npmjs.com/package/expo-server) |
| Source record ids | npm_registry-9d1858c577a5aa, npm_registry-8eb496027afdd7 |
...
For a systems engineer, expo-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 57.0.3 | 2026-08-14T14:22:51.084Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-9d1858c577a5aa` from `npm_registry` as `registry_expansion`
- `npm_registry-8eb496027afdd7` from `npm_registry` as `registry_expansion`
