...
<!-- canonical: https://gitea.com/RachelGardner/Devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/RachelGardner/Devops](https://gitea.com/RachelGardner/Devops) |
| Source record ids | gitea_repositories_api-e59dab6095273c |
...
For a systems engineer, Gitea: RachelGardner/Devops belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-18T07:41:27Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-e59dab6095273c` from `gitea_repositories_api` as `registry_expansion`
