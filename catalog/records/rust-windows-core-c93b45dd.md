...
<!-- canonical: https://crates.io/crates/windows-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-core](https://crates.io/crates/windows-core) |
| Source record ids | crates_io-183df143352a02 |
...
For a systems engineer, windows-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:42:56.290894Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-03T17:18:46+00:00`.
...
- `crates_io-183df143352a02` from `crates_io` as `registry_expansion`
