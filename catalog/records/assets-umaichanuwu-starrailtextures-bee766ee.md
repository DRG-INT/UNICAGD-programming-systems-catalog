...
<!-- canonical: https://github.com/umaichanuwu/StarRailTextures -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/umaichanuwu/StarRailTextures](https://github.com/umaichanuwu/StarRailTextures) |
| Source record ids | github_search_assets-38ff2ae6d83e3a |

## System Engineer Summary

All textures from honkai star rail at different versions

## Operational Role

For a systems engineer, umaichanuwu/StarRailTextures belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-01T02:19:40Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-38ff2ae6d83e3a` from `github_search_assets` as `registry_expansion`
