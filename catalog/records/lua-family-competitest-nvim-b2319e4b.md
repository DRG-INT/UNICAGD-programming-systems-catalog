...
<!-- canonical: https://luarocks.org/modules/neorocks/competitest.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/competitest.nvim](https://luarocks.org/modules/neorocks/competitest.nvim) |
| Source record ids | luarocks_root_manifest-fcfe47953b6d17 |

## System Engineer Summary

CompetiTest.nvim is a Neovim plugin for Competitive Programming: it can manage and check testcases,
download problems and contests from online judges and much more

## Operational Role

For a systems engineer, competitest.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-fcfe47953b6d17` from `luarocks_root_manifest` as `registry_expansion`
