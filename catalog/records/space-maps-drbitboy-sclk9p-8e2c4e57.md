...
<!-- canonical: https://github.com/drbitboy/Sclk9P -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drbitboy/Sclk9P](https://github.com/drbitboy/Sclk9P) |
| Source record ids | github_search_space_maps-8730353258cceb |

## System Engineer Summary

Characterization and Improvement of the SPICE Kernels from the Deep Impact Encounter with Comet
Tempel 1

## Operational Role

For a systems engineer, drbitboy/Sclk9P belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-09-26T18:59:06Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8730353258cceb` from `github_search_space_maps` as `registry_expansion`
