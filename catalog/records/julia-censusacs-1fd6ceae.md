...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CensusACS](https://github.com/JuliaRegistries/General/tree/master/C/CensusACS) |
| Source record ids | julia_general-fdf013d4e16f84 |

## System Engineer Summary

Julia package registered in General at C/CensusACS.

## Operational Role

For a systems engineer, CensusACS belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CensusACS", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-fdf013d4e16f84` from `julia_general` as `registry_expansion`
