...
<!-- canonical: https://crates.io/crates/ptr_meta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ptr_meta](https://crates.io/crates/ptr_meta) |
| Source record ids | crates_io-5e1cfcfc7fb3e0 |
...
For a systems engineer, ptr_meta belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-05T11:57:40.251295Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-5e1cfcfc7fb3e0` from `crates_io` as `registry_expansion`
