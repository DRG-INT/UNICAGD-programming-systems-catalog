...
<!-- canonical: https://cran.r-project.org/web/packages/afttest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/afttest/index.html](https://cran.r-project.org/web/packages/afttest/index.html) |
| Source record ids | cran_packages_by_date-ac19b8627c1fa1 |
...
For a systems engineer, afttest belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.6.1 | 2026-09-01 00:00:03 UTC | [https://cran.r-project.org/web/packages/afttest/DESCRIPTION](https://cran.r-project.org/web/packages/afttest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/afttest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ac19b8627c1fa1` from `cran_packages_by_date` as `registry_expansion`
