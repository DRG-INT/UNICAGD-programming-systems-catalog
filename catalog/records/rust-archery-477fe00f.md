...
| Canonical URL | [https://crates.io/crates/archery](https://crates.io/crates/archery) |
| Source record ids | crates_io-4af303c708b84c |
...
For a systems engineer, archery belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-08-09T23:14:46.631776Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-4af303c708b84c` from `crates_io` as `registry_expansion`
