...
<!-- canonical: https://gnu-octave.github.io/packages/fxp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/fxp](https://gnu-octave.github.io/packages/fxp) |
| Source record ids | octave_packages_index-61f70ce163f19f |

## System Engineer Summary

Lightweight fixed-point numeric type for GNU Octave. Intended for fixed-point modeling, algorithm
validation, and education. Supports signed and unsigned formats, quantization, overflow handling,
and basic arithmetic operations.

## Operational Role

For a systems engineer, fxp belongs in the Octave inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-04-12 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-61f70ce163f19f` from `octave_packages_index` as `registry_expansion`
