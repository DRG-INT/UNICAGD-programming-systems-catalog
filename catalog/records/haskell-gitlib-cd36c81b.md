...
<!-- canonical: https://hackage.haskell.org/package/gitlib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gitlib](https://hackage.haskell.org/package/gitlib) |
| Source record ids | hackage_top_downloads-67be7aa613ffb4 |
...
For a systems engineer, gitlib belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.3 | 2021-03-21T21:17:39Z | [https://hackage.haskell.org/package/gitlib](https://hackage.haskell.org/package/gitlib) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gitlib` at `2026-09-09T00:35:00+00:00`.
...
- `hackage_top_downloads-67be7aa613ffb4` from `hackage_top_downloads` as `registry_expansion`
