...
<!-- canonical: https://github.com/KonghaYao/chinese-free-web-font-storage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KonghaYao/chinese-free-web-font-storage](https://github.com/KonghaYao/chinese-free-web-font-storage) |
| Source record ids | github_search_font_briefcase-784ccf6ea378da |

## System Engineer Summary

中文网字计划 (Chinese Webfont Project) 是一个免费的中文 web 字体库，支持在线加载及查看字体信息。Explore our free CJK web font
library that enables online loading and font information viewing.

## Operational Role

For a systems engineer, KonghaYao/chinese-free-web-font-storage belongs in the Font Briefcase
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-16T07:38:56Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-784ccf6ea378da` from `github_search_font_briefcase` as `registry_expansion`
...
| aui/font-spider | Formatter | [open](font-briefcase-aui-font-spider-a2f342c9.md) |
