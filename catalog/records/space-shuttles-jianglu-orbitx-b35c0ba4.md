...
<!-- canonical: https://github.com/jianglu/orbitx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jianglu/orbitx](https://github.com/jianglu/orbitx) |
| Source record ids | github_search_space_shuttles-f5a74b815c8e19 |

## System Engineer Summary

Orbiter Space Flight Simulator 的 Rust 移植：刚体物理建模 + 多级火箭发射仿真

## Operational Role

For a systems engineer, jianglu/orbitx belongs in the Space Shuttles inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-18T05:38:45Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-f5a74b815c8e19` from `github_search_space_shuttles` as `registry_expansion`
