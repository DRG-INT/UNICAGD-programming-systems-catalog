...
<!-- canonical: https://hackage.haskell.org/package/stm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stm](https://hackage.haskell.org/package/stm) |
| Source record ids | hackage_top_downloads-63ed4b1bc1382a |
...
For a systems engineer, stm belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.3.1 | 2024-04-12T15:34:42Z | [https://hackage.haskell.org/package/stm](https://hackage.haskell.org/package/stm) |  |
| candidate | partial | 2.4.3 |  | [https://hackage.haskell.org/package/stm](https://hackage.haskell.org/package/stm) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stm` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-63ed4b1bc1382a` from `hackage_top_downloads` as `registry_expansion`
