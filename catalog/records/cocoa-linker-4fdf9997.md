...
<!-- canonical: https://github.com/MaksimKurpa/Linker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MaksimKurpa/Linker](https://github.com/MaksimKurpa/Linker) |
| Source record ids | awesome_list-23c0e932cc9f27 |
...
For a systems engineer, Linker belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2018-02-16 13:10:21 UTC | [https://trunk.cocoapods.org/api/v1/pods/Linker](https://trunk.cocoapods.org/api/v1/pods/Linker) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Linker` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-23c0e932cc9f27` from `awesome_list` as `registry_expansion`
