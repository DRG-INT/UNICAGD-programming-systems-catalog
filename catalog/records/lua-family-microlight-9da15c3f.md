...
<!-- canonical: https://github.com/stevedonovan/Microlight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stevedonovan/Microlight](https://github.com/stevedonovan/Microlight) |
| Source record ids | lua-source-108 |
...
For a systems engineer, Microlight belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 108}}` |
...
- `lua-source-108` from `master_json` as `source_list_item`
