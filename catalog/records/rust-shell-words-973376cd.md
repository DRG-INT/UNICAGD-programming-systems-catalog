...
<!-- canonical: https://crates.io/crates/shell-words -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/shell-words](https://crates.io/crates/shell-words) |
| Source record ids | crates_io-665d2c11c2ac5f |
...
For a systems engineer, shell-words belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-12-10T20:48:28.942402Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-665d2c11c2ac5f` from `crates_io` as `registry_expansion`
