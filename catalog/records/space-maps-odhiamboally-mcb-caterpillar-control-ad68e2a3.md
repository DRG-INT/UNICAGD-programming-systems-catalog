# odhiamboally/mcb_caterpillar_control
...
<!-- canonical: https://github.com/odhiamboally/mcb_caterpillar_control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/odhiamboally/mcb_caterpillar_control](https://github.com/odhiamboally/mcb_caterpillar_control) |
| Source record ids | github_search_space_maps-4e0ec1f1aacb9f |

## System Engineer Summary

Manages giant caterpillars on a unique planetary surface. Features include map design, caterpillar
control, radar display, and user input. Developed in C# with ASP.NET Core Console to simulate the
planet surface.

## Operational Role

For a systems engineer, odhiamboally/mcb_caterpillar_control belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-31T00:57:21Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4e0ec1f1aacb9f` from `github_search_space_maps` as `registry_expansion`
