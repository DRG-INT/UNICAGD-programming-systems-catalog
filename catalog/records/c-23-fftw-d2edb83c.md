...
| Source record ids | corpus-102b4275b964ae |

## System Engineer Summary

FFTW is tracked as an image audio dsp record in the C++23 branch. The source did not provide a long
...
For a systems engineer, FFTW belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-102b4275b964ae` from `master_json` as `image_audio_dsp`
