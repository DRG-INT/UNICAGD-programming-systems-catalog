...
<!-- canonical: https://crates.io/crates/tap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tap](https://crates.io/crates/tap) |
| Source record ids | crates_io-1bcbb768827920 |
...
For a systems engineer, tap belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2021-02-13T02:43:25.525644Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-1bcbb768827920` from `crates_io` as `registry_expansion`
