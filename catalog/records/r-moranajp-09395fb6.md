...
<!-- canonical: https://cran.r-project.org/web/packages/moranajp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/moranajp/index.html](https://cran.r-project.org/web/packages/moranajp/index.html) |
| Source record ids | cran_packages_by_date-e2e89c1ae71d73 |
...
For a systems engineer, moranajp belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.8 | 2026-08-05 08:20:06 UTC | [https://cran.r-project.org/web/packages/moranajp/DESCRIPTION](https://cran.r-project.org/web/packages/moranajp/DESCRIPTION) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/moranajp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e2e89c1ae71d73` from `cran_packages_by_date` as `registry_expansion`
