...
<!-- canonical: https://github.com/vearch/vearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vearch/vearch](https://github.com/vearch/vearch) |
| Source record ids | github_search_databases-380c5f9865913e |
...
For a systems engineer, vearch/vearch belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T05:29:53Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-380c5f9865913e` from `github_search_databases` as `registry_expansion`
