# ivancasas96/SpringBootApp-CloudFoundry
...
<!-- canonical: https://github.com/ivancasas96/SpringBootApp-CloudFoundry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ivancasas96/SpringBootApp-CloudFoundry](https://github.com/ivancasas96/SpringBootApp-CloudFoundry) |
| Source record ids | github_search_sapjava-b1af83e3ac7a33 |

## System Engineer Summary

Application using Java and the Spring-boot framework, deploying the application to Cloud Foundry,
querying an SAP API using the SAP Cloud SDK.

## Operational Role

For a systems engineer, ivancasas96/SpringBootApp-CloudFoundry belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-24T14:06:42Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-b1af83e3ac7a33` from `github_search_sapjava` as `registry_expansion`
