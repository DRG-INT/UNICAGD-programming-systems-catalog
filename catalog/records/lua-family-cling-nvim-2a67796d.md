...
<!-- canonical: https://luarocks.org/modules/juniorsundar/cling.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/juniorsundar/cling.nvim](https://luarocks.org/modules/juniorsundar/cling.nvim) |
| Source record ids | luarocks_root_manifest-5b0b94b7e36306 |
...
For a systems engineer, cling.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5b0b94b7e36306` from `luarocks_root_manifest` as `registry_expansion`
