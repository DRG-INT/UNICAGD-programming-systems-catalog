...
<!-- canonical: https://crates.io/crates/fragile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fragile](https://crates.io/crates/fragile) |
| Source record ids | crates_io-70cb17c52f92f5 |
...
For a systems engineer, fragile belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-09-04T22:54:23.273345Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads` at `2026-09-05T00:29:04+00:00`.
...
- `crates_io-70cb17c52f92f5` from `crates_io` as `registry_expansion`
