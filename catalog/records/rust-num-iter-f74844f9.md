...
<!-- canonical: https://crates.io/crates/num-iter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-iter](https://crates.io/crates/num-iter) |
| Source record ids | crates_io-d6aa6cf03a958e |
...
For a systems engineer, num-iter belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.46 | 2026-07-07T19:51:46.163752Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-d6aa6cf03a958e` from `crates_io` as `registry_expansion`
