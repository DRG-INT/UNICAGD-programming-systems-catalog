...
<!-- canonical: https://github.com/juanfont/headscale -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/juanfont/headscale](https://github.com/juanfont/headscale) |
| Source record ids | github_search_go-0996526e8cdfe9 |
...
For a systems engineer, juanfont/headscale belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:34:04Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-0996526e8cdfe9` from `github_search_go` as `registry_expansion`
