...
<!-- canonical: https://luarocks.org/modules/3scale/benchmark-ips -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/3scale/benchmark-ips](https://luarocks.org/modules/3scale/benchmark-ips) |
| Source record ids | luarocks_root_manifest-b1fd11e3ab612c |

## System Engineer Summary

benchmark-ips - provides iteration per second benchmarking

## Operational Role

For a systems engineer, benchmark-ips belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b1fd11e3ab612c` from `luarocks_root_manifest` as `registry_expansion`
