...
<!-- canonical: https://pub.dev/packages/currency_text_input_formatter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/currency_text_input_formatter](https://pub.dev/packages/currency_text_input_formatter) |
| Source record ids | pub_dev-5171be8395f76f |
...
For a systems engineer, currency_text_input_formatter belongs in the Dart inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-08-21T11:14:05.104335Z | [https://pub.dev/api/packages/currency_text_input_formatter](https://pub.dev/api/packages/currency_text_input_formatter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/currency_text_input_formatter` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-5171be8395f76f` from `pub_dev` as `registry_expansion`
