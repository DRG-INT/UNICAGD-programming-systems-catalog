...
<!-- canonical: https://cran.r-project.org/web/packages/evgam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/evgam/index.html](https://cran.r-project.org/web/packages/evgam/index.html) |
| Source record ids | cran_packages_by_date-772305d35cecaf |
...
For a systems engineer, evgam belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-03 14:30:09 UTC | [https://cran.r-project.org/web/packages/evgam/DESCRIPTION](https://cran.r-project.org/web/packages/evgam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/evgam/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-772305d35cecaf` from `cran_packages_by_date` as `registry_expansion`
