# abbyazari/data_vis_statistics_geosciences
...
<!-- canonical: https://github.com/abbyazari/data_vis_statistics_geosciences -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abbyazari/data_vis_statistics_geosciences](https://github.com/abbyazari/data_vis_statistics_geosciences) |
| Source record ids | github_search_space_maps-547e6d92034397 |

## System Engineer Summary

This repository contains the laboratory portion of an upper level undergraduate class in Python on
data visualization and statistics for geo & space scientists. Labs are updated when the course is in
session through the most recent branch. See master version for current class.

## Operational Role

For a systems engineer, abbyazari/data_vis_statistics_geosciences belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-29T02:59:43Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-547e6d92034397` from `github_search_space_maps` as `registry_expansion`
