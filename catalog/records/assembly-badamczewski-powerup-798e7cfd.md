...
<!-- canonical: https://github.com/badamczewski/PowerUp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/badamczewski/PowerUp](https://github.com/badamczewski/PowerUp) |
| Source record ids | github_search_assembly-b5a548dd5b36af |
...
For a systems engineer, badamczewski/PowerUp belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-25T09:23:08Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-b5a548dd5b36af` from `github_search_assembly` as `registry_expansion`
