...
<!-- canonical: https://github.com/symfony/assetic-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/symfony/assetic-bundle](https://github.com/symfony/assetic-bundle) |
| Source record ids | github_search_assets-98a580770a1d0f |

## System Engineer Summary

DEPRECATED This was the recommended way to manage web assets in Symfony 2 applications. Newer
Symfony applications should use Webpack Encore.

## Operational Role

For a systems engineer, symfony/assetic-bundle belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-07T16:20:58Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-98a580770a1d0f` from `github_search_assets` as `registry_expansion`
