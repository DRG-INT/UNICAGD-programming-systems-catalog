...
<!-- canonical: https://crates.io/crates/dialoguer -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-05bc5749a6bd2d |
...
For a systems engineer, dialoguer belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2025-08-23T15:37:51.581957Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-05bc5749a6bd2d` from `crates_io` as `registry_expansion`
