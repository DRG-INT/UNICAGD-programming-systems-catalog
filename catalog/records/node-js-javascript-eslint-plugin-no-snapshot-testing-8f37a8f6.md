...
<!-- canonical: https://www.npmjs.com/package/eslint-plugin-no-snapshot-testing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/eslint-plugin-no-snapshot-testing](https://www.npmjs.com/package/eslint-plugin-no-snapshot-testing) |
| Source record ids | npm_registry-48f82f4cc48fde |
...
For a systems engineer, eslint-plugin-no-snapshot-testing belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.61 | 2020-08-10T11:27:54.027Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-48f82f4cc48fde` from `npm_registry` as `registry_expansion`
