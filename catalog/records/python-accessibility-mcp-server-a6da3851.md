...
<!-- canonical: https://pypi.org/project/accessibility-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accessibility-mcp-server/](https://pypi.org/project/accessibility-mcp-server/) |
| Source record ids | pypi_simple-f8873e59ee27cd |

## System Engineer Summary

MCP-Server fuer Web-Accessibility-Checks: WCAG 2.1/2.2 Pruefung, Kontrast, ARIA, Formular-
Validierung

## Operational Role

For a systems engineer, accessibility-mcp-server belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-04-09T07:44:52.952206Z | [https://pypi.org/pypi/accessibility-mcp-server/json](https://pypi.org/pypi/accessibility-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accessibility-mcp-server/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-f8873e59ee27cd` from `pypi_simple` as `registry_expansion`
