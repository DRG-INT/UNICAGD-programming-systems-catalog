...
| Source record ids | github_search_assets-e8d6e9b3a5a77c |
...
For a systems engineer, Stolz/Assets belongs in the Assets inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-02-01T12:06:15Z | gh search repos topic:asset-pipeline stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_assets-e8d6e9b3a5a77c` from `github_search_assets` as `registry_expansion`
