...
<!-- canonical: https://github.com/SAP/opensearch-otlp-receiver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP/opensearch-otlp-receiver](https://github.com/SAP/opensearch-otlp-receiver) |
| Source record ids | github_search_sapjava-79ffcf499a6d3d |

## System Engineer Summary

A Plugin that embeds OTLP ingestion directly into OpenSearch, letting OpenTelemetry SDKs and
Collectors send traces, metrics, and logs without an intermediary like Data Prepper.

## Operational Role

For a systems engineer, SAP/opensearch-otlp-receiver belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T12:31:15Z | gh search repos org:SAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-79ffcf499a6d3d` from `github_search_sapjava` as `registry_expansion`
...
| Sunshinedaily2288/flashsale-interop-governance | Profiler | [open](sapjava-sunshinedaily2288-flashsale-interop-governance-bede392c.md) |
