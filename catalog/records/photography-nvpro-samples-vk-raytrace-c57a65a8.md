...
<!-- canonical: https://github.com/nvpro-samples/vk_raytrace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nvpro-samples/vk_raytrace](https://github.com/nvpro-samples/vk_raytrace) |
| Source record ids | github_search_photography-4dc6e89d1e6b48 |
...
For a systems engineer, nvpro-samples/vk_raytrace belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-29T11:20:15Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-4dc6e89d1e6b48` from `github_search_photography` as `registry_expansion`
