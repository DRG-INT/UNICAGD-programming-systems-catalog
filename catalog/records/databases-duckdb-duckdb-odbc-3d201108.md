...
<!-- canonical: https://github.com/duckdb/duckdb-odbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/duckdb/duckdb-odbc](https://github.com/duckdb/duckdb-odbc) |
| Source record ids | github_search_databases-f6b6ac959ddcd2 |

## System Engineer Summary

duckdb/duckdb-odbc is tracked as a library record in the Databases branch. The source did not
...
For a systems engineer, duckdb/duckdb-odbc belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T06:55:46Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f6b6ac959ddcd2` from `github_search_databases` as `registry_expansion`
