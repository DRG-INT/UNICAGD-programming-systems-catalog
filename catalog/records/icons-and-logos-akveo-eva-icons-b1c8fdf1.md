...
<!-- canonical: https://github.com/akveo/eva-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/akveo/eva-icons](https://github.com/akveo/eva-icons) |
| Source record ids | github_search_icons_and_logos-5c5a6d17f0f8cb |
...
For a systems engineer, akveo/eva-icons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-04T01:54:54Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-5c5a6d17f0f8cb` from `github_search_icons_and_logos` as `registry_expansion`
