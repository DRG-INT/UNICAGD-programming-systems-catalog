...
<!-- canonical: https://cran.r-project.org/web/packages/shinyds/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shinyds/index.html](https://cran.r-project.org/web/packages/shinyds/index.html) |
| Source record ids | cran_packages_by_date-34be13ceec059e |
...
For a systems engineer, shinyds belongs in the R inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-22 11:40:02 UTC | [https://cran.r-project.org/web/packages/shinyds/DESCRIPTION](https://cran.r-project.org/web/packages/shinyds/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shinyds/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-34be13ceec059e` from `cran_packages_by_date` as `registry_expansion`
