...
<!-- canonical: https://cran.r-project.org/web/packages/rstudio.prefs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rstudio.prefs/index.html](https://cran.r-project.org/web/packages/rstudio.prefs/index.html) |
| Source record ids | cran_packages_by_date-0fa5862c6ee863 |
...
For a systems engineer, rstudio.prefs belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-20 05:20:37 UTC | [https://cran.r-project.org/web/packages/rstudio.prefs/DESCRIPTION](https://cran.r-project.org/web/packages/rstudio.prefs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rstudio.prefs/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0fa5862c6ee863` from `cran_packages_by_date` as `registry_expansion`
