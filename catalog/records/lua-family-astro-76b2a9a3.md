...
<!-- canonical: https://luarocks.org/modules/engine-machiner/astro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/engine-machiner/astro](https://luarocks.org/modules/engine-machiner/astro) |
| Source record ids | luarocks_root_manifest-712907594d6874 |
...
For a systems engineer, astro belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-712907594d6874` from `luarocks_root_manifest` as `registry_expansion`
