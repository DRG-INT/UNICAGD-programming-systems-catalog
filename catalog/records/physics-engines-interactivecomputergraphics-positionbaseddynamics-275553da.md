...
<!-- canonical: https://github.com/InteractiveComputerGraphics/PositionBasedDynamics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/InteractiveComputerGraphics/PositionBasedDynamics](https://github.com/InteractiveComputerGraphics/PositionBasedDynamics) |
| Source record ids | github_search_physics_engines-7a3ca4b6d4a658 |

## System Engineer Summary

PositionBasedDynamics is a library for the physically-based simulation of rigid bodies, deformable
solids and fluids.

## Operational Role

For a systems engineer, InteractiveComputerGraphics/PositionBasedDynamics belongs in the Physics
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T06:08:48Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7a3ca4b6d4a658` from `github_search_physics_engines` as `registry_expansion`
