...
<!-- canonical: https://gitea.com/linusified/isjsruntime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/linusified/isjsruntime](https://gitea.com/linusified/isjsruntime) |
| Source record ids | gitea_repositories_api-8f1235617751b5 |
...
For a systems engineer, Gitea: linusified/isjsruntime belongs in the Repository Workplaces inventory
as part of runtime behavior, deployment packaging, embedding, upgrade cadence, and compatibility
validation.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-27T10:10:37Z | [https://gitea.com/api/v1/repos/search?q=runtime&limit=50](https://gitea.com/api/v1/repos/search?q=runtime&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8f1235617751b5` from `gitea_repositories_api` as `registry_expansion`
