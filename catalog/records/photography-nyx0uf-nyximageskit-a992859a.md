...
<!-- canonical: https://github.com/Nyx0uf/NYXImagesKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Nyx0uf/NYXImagesKit](https://github.com/Nyx0uf/NYXImagesKit) |
| Source record ids | github_search_photography-17f8ed979ea838 |

## System Engineer Summary

A set of efficient categories for UIImage class. It allows filtering, resizing, masking, rotating,
enhancing... and more.

## Operational Role

For a systems engineer, Nyx0uf/NYXImagesKit belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-06T18:49:55Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-17f8ed979ea838` from `github_search_photography` as `registry_expansion`
