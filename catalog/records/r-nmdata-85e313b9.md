...
<!-- canonical: https://cran.r-project.org/web/packages/NMdata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NMdata/index.html](https://cran.r-project.org/web/packages/NMdata/index.html) |
| Source record ids | cran_packages_by_date-5c5c177b4f4aac |
...
For a systems engineer, NMdata belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-08-23 16:20:14 UTC | [https://cran.r-project.org/web/packages/NMdata/DESCRIPTION](https://cran.r-project.org/web/packages/NMdata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NMdata/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5c5c177b4f4aac` from `cran_packages_by_date` as `registry_expansion`
