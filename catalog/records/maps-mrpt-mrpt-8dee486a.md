...
<!-- canonical: https://github.com/MRPT/mrpt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MRPT/mrpt](https://github.com/MRPT/mrpt) |
| Source record ids | github_search_maps-f462b5df45b4b8 |
...
For a systems engineer, MRPT/mrpt belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T22:42:48Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f462b5df45b4b8` from `github_search_maps` as `registry_expansion`
