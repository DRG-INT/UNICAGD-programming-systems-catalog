...
<!-- canonical: https://cran.r-project.org/web/packages/Boom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Boom/index.html](https://cran.r-project.org/web/packages/Boom/index.html) |
| Source record ids | cran_packages_by_date-24690447d6dbda |
...
For a systems engineer, Boom belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.17 | 2026-09-16 06:20:02 UTC | [https://cran.r-project.org/web/packages/Boom/DESCRIPTION](https://cran.r-project.org/web/packages/Boom/DESCRIPTION) |  |
...
| Evidence | LGPL-2.1 \| file LICENSE |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Boom/DESCRIPTION` at `2026-09-16T06:26:24+00:00`.
...
- `cran_packages_by_date-24690447d6dbda` from `cran_packages_by_date` as `registry_expansion`
