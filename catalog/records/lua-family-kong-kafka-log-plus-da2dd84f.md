...
| Canonical URL | [https://luarocks.org/modules/p6/kong-kafka-log-plus](https://luarocks.org/modules/p6/kong-kafka-log-plus) |
| Source record ids | luarocks_root_manifest-c5265a2d7fe089 |
...
For a systems engineer, kong-kafka-log-plus belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c5265a2d7fe089` from `luarocks_root_manifest` as `registry_expansion`
