...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BOSS](https://github.com/JuliaRegistries/General/tree/master/B/BOSS) |
| Source record ids | julia_general-dbc52cbf4e04fc |

## System Engineer Summary

Julia package registered in General at B/BOSS.

## Operational Role

For a systems engineer, BOSS belongs in the Julia inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BOSS", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-dbc52cbf4e04fc` from `julia_general` as `registry_expansion`
