...
| Canonical URL | [https://crates.io/crates/glutin](https://crates.io/crates/glutin) |
| Source record ids | crates_io-9d09e838243ddd |
...
For a systems engineer, glutin belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.3 | 2025-04-30T11:33:39.726207Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-9d09e838243ddd` from `crates_io` as `registry_expansion`
