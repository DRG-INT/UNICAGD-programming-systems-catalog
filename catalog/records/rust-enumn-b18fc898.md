...
| Canonical URL | [https://crates.io/crates/enumn](https://crates.io/crates/enumn) |
| Source record ids | crates_io-d39a99ba065cb9 |

## System Engineer Summary

enumn is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, enumn belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.14 | 2024-07-30T05:57:57.757718Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-d39a99ba065cb9` from `crates_io` as `registry_expansion`
