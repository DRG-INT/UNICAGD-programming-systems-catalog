...
<!-- canonical: https://luarocks.org/modules/membphis/api7-snowflake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-snowflake](https://luarocks.org/modules/membphis/api7-snowflake) |
| Source record ids | luarocks_root_manifest-1116409a672220 |
...
For a systems engineer, api7-snowflake belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1116409a672220` from `luarocks_root_manifest` as `registry_expansion`
...
| APIOAK | Api Abi Checker | [open](lua-family-apioak-24acbe33.md) |
