...
<!-- canonical: https://luarocks.org/modules/geoffleyland/argcheck -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/geoffleyland/argcheck](https://luarocks.org/modules/geoffleyland/argcheck) |
| Source record ids | luarocks_root_manifest-52b58d84486a4b |
...
For a systems engineer, argcheck belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-52b58d84486a4b` from `luarocks_root_manifest` as `registry_expansion`
