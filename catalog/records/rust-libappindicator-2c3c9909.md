...
| Canonical URL | [https://crates.io/crates/libappindicator](https://crates.io/crates/libappindicator) |
| Source record ids | crates_io-8c1c51d5a78016 |
...
For a systems engineer, libappindicator belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2023-10-01T11:57:03.767908Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-8c1c51d5a78016` from `crates_io` as `registry_expansion`
