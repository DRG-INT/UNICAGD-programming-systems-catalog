...
<!-- canonical: https://cran.r-project.org/web/packages/IndFarmCost/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IndFarmCost/index.html](https://cran.r-project.org/web/packages/IndFarmCost/index.html) |
| Source record ids | cran_packages_by_date-479dcfa443a2e5 |

## System Engineer Summary

Indian Farm Cost Concepts for Agricultural Economic Analysis

## Operational Role

For a systems engineer, IndFarmCost belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-10 08:30:08 UTC | [https://cran.r-project.org/web/packages/IndFarmCost/DESCRIPTION](https://cran.r-project.org/web/packages/IndFarmCost/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IndFarmCost/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-479dcfa443a2e5` from `cran_packages_by_date` as `registry_expansion`
