...
<!-- canonical: https://pub.dev/packages/universal_ble -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/universal_ble](https://pub.dev/packages/universal_ble) |
| Source record ids | pub_dev-6d5dbee202dbc9 |
...
For a systems engineer, universal_ble belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-28T11:14:48.416200Z | [https://pub.dev/api/packages/universal_ble](https://pub.dev/api/packages/universal_ble) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/universal_ble` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-6d5dbee202dbc9` from `pub_dev` as `registry_expansion`
