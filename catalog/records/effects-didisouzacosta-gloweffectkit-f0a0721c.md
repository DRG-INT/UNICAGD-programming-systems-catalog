...
<!-- canonical: https://github.com/didisouzacosta/GlowEffectKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/didisouzacosta/GlowEffectKit](https://github.com/didisouzacosta/GlowEffectKit) |
| Source record ids | github_search_effects-f318cb38f23542 |

## System Engineer Summary

GlowEffectKit is a SwiftUI SDK for adding animated glow effect to iOS and macOS components, powered
by a bundled Metal shader. More compact version: SwiftUI SDK for animated grow and glow effects
powered by bundled Metal shaders.

## Operational Role

For a systems engineer, didisouzacosta/GlowEffectKit belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-07T12:57:01Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f318cb38f23542` from `github_search_effects` as `registry_expansion`
