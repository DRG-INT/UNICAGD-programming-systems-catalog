...
| Source record ids | github_search_effects-26ffacd80eae5a |
...
For a systems engineer, ideoforms/signalflow belongs in the Effects inventory as part of ecosystem
...
- `github_search_effects-26ffacd80eae5a` from `github_search_effects` as `registry_expansion`
