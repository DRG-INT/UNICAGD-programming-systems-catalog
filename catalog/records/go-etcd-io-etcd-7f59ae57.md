...
| Source record ids | github_search_go-c7fc0a0a4fef77 |
...
For a systems engineer, etcd-io/etcd belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:48:29Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-c7fc0a0a4fef77` from `github_search_go` as `registry_expansion`
