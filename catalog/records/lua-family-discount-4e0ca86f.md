...
<!-- canonical: https://luarocks.org/modules/craigb/discount -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/craigb/discount](https://luarocks.org/modules/craigb/discount) |
| Source record ids | luarocks_root_manifest-b7b5df45f88d47 |
...
For a systems engineer, discount belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-b7b5df45f88d47` from `luarocks_root_manifest` as `registry_expansion`
