...
<!-- canonical: https://luarocks.org/modules/lblasc/box -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lblasc/box](https://luarocks.org/modules/lblasc/box) |
| Source record ids | luarocks_root_manifest-d9a938d075813c |

## System Engineer Summary

box is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, box belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d9a938d075813c` from `luarocks_root_manifest` as `registry_expansion`
