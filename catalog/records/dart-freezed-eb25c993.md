...
<!-- canonical: https://pub.dev/packages/freezed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/freezed](https://pub.dev/packages/freezed) |
| Source record ids | pub_dev-a5cb2b42d29790 |

## System Engineer Summary

Code generation for immutable classes that has a simple syntax/API without compromising on the
features.

## Operational Role

For a systems engineer, freezed belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-08-29T17:50:43.317002Z | [https://pub.dev/api/packages/freezed](https://pub.dev/api/packages/freezed) |  |
| preview | known | 4.0.0-dev.3 | 2026-06-13T18:54:30.456593Z | [https://pub.dev/api/packages/freezed](https://pub.dev/api/packages/freezed) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/freezed` at `2026-09-01T14:20:28+00:00`.
...
- `pub_dev-a5cb2b42d29790` from `pub_dev` as `registry_expansion`
