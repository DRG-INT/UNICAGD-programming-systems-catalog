...
<!-- canonical: https://github.com/earthaccess-dev/earthaccess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/earthaccess-dev/earthaccess](https://github.com/earthaccess-dev/earthaccess) |
| Source record ids | github_search_maps-cd58b05897e879 |
...
For a systems engineer, earthaccess-dev/earthaccess belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T04:35:22Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-cd58b05897e879` from `github_search_maps` as `registry_expansion`
