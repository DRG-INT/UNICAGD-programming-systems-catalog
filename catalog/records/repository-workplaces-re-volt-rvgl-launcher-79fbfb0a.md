...
<!-- canonical: https://gitlab.com/re-volt/rvgl-launcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/re-volt/rvgl-launcher](https://gitlab.com/re-volt/rvgl-launcher) |
| Source record ids | gitlab_projects_api-05fcf3182ea199 |

## System Engineer Summary

A cross-platform installer, launcher and package manager for RVGL.

## Operational Role

For a systems engineer, re-volt/rvgl-launcher belongs in the Repository Workplaces inventory as part
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; {"key": "", "name": "", "url": ""}; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit |
...
- `gitlab_projects_api-05fcf3182ea199` from `gitlab_projects_api` as `registry_expansion`
