...
<!-- canonical: https://cran.r-project.org/web/packages/xegaDfGene/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xegaDfGene/index.html](https://cran.r-project.org/web/packages/xegaDfGene/index.html) |
| Source record ids | cran_packages_by_date-9b06433680f478 |
...
For a systems engineer, xegaDfGene belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.10 | 2026-08-20 14:20:02 UTC | [https://cran.r-project.org/web/packages/xegaDfGene/DESCRIPTION](https://cran.r-project.org/web/packages/xegaDfGene/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xegaDfGene/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9b06433680f478` from `cran_packages_by_date` as `registry_expansion`
