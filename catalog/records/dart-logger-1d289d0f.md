...
<!-- canonical: https://pub.dev/packages/logger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/logger](https://pub.dev/packages/logger) |
| Source record ids | pub_dev-0004949f20f2ec |
...
For a systems engineer, logger belongs in the Dart inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2026-03-15T23:38:02.269541Z | [https://pub.dev/api/packages/logger](https://pub.dev/api/packages/logger) |  |
| preview | known | 1.0.0-nullsafety.0 | 2020-12-15T08:30:41.271923Z | [https://pub.dev/api/packages/logger](https://pub.dev/api/packages/logger) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/logger` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-0004949f20f2ec` from `pub_dev` as `registry_expansion`
