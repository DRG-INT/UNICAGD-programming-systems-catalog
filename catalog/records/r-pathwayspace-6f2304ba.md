...
<!-- canonical: https://cran.r-project.org/web/packages/PathwaySpace/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PathwaySpace/index.html](https://cran.r-project.org/web/packages/PathwaySpace/index.html) |
| Source record ids | cran_packages_by_date-ae14082d5ce1ea |
...
For a systems engineer, PathwaySpace belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2026-08-24 13:00:08 UTC | [https://cran.r-project.org/web/packages/PathwaySpace/DESCRIPTION](https://cran.r-project.org/web/packages/PathwaySpace/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PathwaySpace/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ae14082d5ce1ea` from `cran_packages_by_date` as `registry_expansion`
