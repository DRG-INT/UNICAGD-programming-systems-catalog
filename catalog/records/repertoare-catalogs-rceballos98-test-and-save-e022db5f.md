# rceballos98/test_and_save

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rceballos98/test_and_save -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rceballos98/test_and_save](https://github.com/rceballos98/test_and_save) |
| Source record ids | github_search_repertoare_catalogs-407f1ea9c48d7e |

## System Engineer Summary

General framework for machine learning projects in MATLAB that keeps track of past training
parameters, accuracy scores and trained models for arbitrary trainers, automatically cataloging
optimization routines and eliminating redundant training.

## Operational Role

For a systems engineer, rceballos98/test_and_save belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-07-14T18:46:57Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-407f1ea9c48d7e` from `github_search_repertoare_catalogs` as `registry_expansion`
