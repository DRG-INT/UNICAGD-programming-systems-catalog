...
<!-- canonical: https://crates.io/crates/schannel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/schannel](https://crates.io/crates/schannel) |
| Source record ids | crates_io-9e90bc2b6a9fe5 |

## System Engineer Summary

Schannel bindings for rust, allowing SSL/TLS without openssl

## Operational Role

For a systems engineer, schannel belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.29 | 2026-04-04T09:15:10.501727Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-9e90bc2b6a9fe5` from `crates_io` as `registry_expansion`
