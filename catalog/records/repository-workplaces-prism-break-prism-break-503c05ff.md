...
<!-- canonical: https://gitlab.com/prism-break/prism-break -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/prism-break/prism-break](https://gitlab.com/prism-break/prism-break) |
| Source record ids | gitlab_projects_api-10df29863b2598 |

## System Engineer Summary

Privacy/security-oriented software recommendations

## Operational Role

For a systems engineer, prism-break/prism-break belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-10df29863b2598` from `gitlab_projects_api` as `registry_expansion`
