# com.sap.cds:cds-feature-api

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cds/cds-feature-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cds/cds-feature-api](https://central.sonatype.com/artifact/com.sap.cds/cds-feature-api) |
| Source record ids | maven_central_search-5c69c8fcbc2f2b |
...
For a systems engineer, com.sap.cds:cds-feature-api belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.17.0 | 2021-07-14T08:05:44+00:00 | [https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=g%3A%22com.sap.cds%22&rows=100&wt=json) |  |
...
- `maven_central_search-5c69c8fcbc2f2b` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cds:cds-adapter-api | Api Abi Checker | [open](sapjava-com-sap-cds-cds-adapter-api-c251dfad.md) |
| com.sap.cds:cds-services-api | Api Abi Checker | [open](sapjava-com-sap-cds-cds-services-api-e9c5fa60.md) |
| com.sap.cds:cds4j-api | Api Abi Checker | [open](sapjava-com-sap-cds-cds4j-api-125b3d3f.md) |
| com.sap.cloud.mkt:sdk-api | Api Abi Checker | [open](sapjava-com-sap-cloud-mkt-sdk-api-759edf9a.md) |
| com.sap.cloud.sdk.datamodel:openapi-parent | Api Abi Checker | [open](sapjava-com-sap-cloud-sdk-datamodel-openapi-parent-c3aa70ac.md) |
| com.sap.cloud.sdk.s4hana:s4hana-api-messaging | Api Abi Checker | [open](sapjava-com-sap-cloud-sdk-s4hana-s4hana-api-messaging-ae249404.md) |
| com.sap.cloud.sdk.s4hana:s4hana-api-odata | Api Abi Checker | [open](sapjava-com-sap-cloud-sdk-s4hana-s4hana-api-odata-0160b9f0.md) |
| com.sap.cloud.sdk.s4hana:s4hana-api-parent | Api Abi Checker | [open](sapjava-com-sap-cloud-sdk-s4hana-s4hana-api-parent-b7bc6735.md) |
