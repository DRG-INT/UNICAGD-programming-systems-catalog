...
<!-- canonical: https://github.com/Cyanilux/URP_RetroCRTShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cyanilux/URP_RetroCRTShader](https://github.com/Cyanilux/URP_RetroCRTShader) |
| Source record ids | github_search_effects-64a0817a6dcd5b |

## System Engineer Summary

📺📼 A shader graph which replicates some retro tv/monitor/vhs effects. CRT warping, scanlines,
static, distortion, etc.

## Operational Role

For a systems engineer, Cyanilux/URP_RetroCRTShader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-27T18:00:55Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-64a0817a6dcd5b` from `github_search_effects` as `registry_expansion`
