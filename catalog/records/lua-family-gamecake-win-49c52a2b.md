...
| Canonical URL | [https://luarocks.org/modules/xriss/gamecake-win](https://luarocks.org/modules/xriss/gamecake-win) |
| Source record ids | luarocks_root_manifest-aaa194e2fd6515 |

## System Engineer Summary

gamecake-win is tracked as a game engine game dev record in the Lua family branch. The source did
...
For a systems engineer, gamecake-win belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-aaa194e2fd6515` from `luarocks_root_manifest` as `registry_expansion`
