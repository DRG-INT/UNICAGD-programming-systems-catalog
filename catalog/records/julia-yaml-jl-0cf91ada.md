...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/Y/YAML](https://github.com/JuliaRegistries/General/tree/master/Y/YAML) |
| Source record ids | corpus-c416f79bf96a34 |

## System Engineer Summary

YAML.jl is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, YAML.jl belongs in the Julia inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.4.16 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/Y/YAML/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/Y/YAML/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-c416f79bf96a34` from `master_json` as `serialization`
