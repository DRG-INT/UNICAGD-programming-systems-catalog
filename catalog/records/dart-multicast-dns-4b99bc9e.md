...
<!-- canonical: https://pub.dev/packages/multicast_dns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/multicast_dns](https://pub.dev/packages/multicast_dns) |
| Source record ids | pub_dev-2226c1d36d6455 |
...
For a systems engineer, multicast_dns belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3+1 | 2026-06-09T19:08:38.103069Z | [https://pub.dev/api/packages/multicast_dns](https://pub.dev/api/packages/multicast_dns) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/multicast_dns` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-2226c1d36d6455` from `pub_dev` as `registry_expansion`
