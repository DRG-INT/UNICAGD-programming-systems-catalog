...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Interpreter Runtime](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interpreter-runtime.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@objectstack/plugin-security](https://www.npmjs.com/package/@objectstack/plugin-security) |
| Source record ids | npm_registry-0d28293f479fdd |
...
For a systems engineer, @objectstack/plugin-security belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 17.2.0 | 2026-08-23T07:01:00.621Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @anthropic-ai/sandbox-runtime | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-anthropic-ai-sandbox-runtime-33dfae82.md) |
| @arcjet/next | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-arcjet-next-ecb21626.md) |
| @edge-runtime/primitives | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-edge-runtime-primitives-2d3ff9e2.md) |
| @eslint/core | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-eslint-core-7e1d5558.md) |
| @remix-run/server-runtime | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-remix-run-server-runtime-cd606808.md) |
| @sanity/runtime-cli | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-sanity-runtime-cli-727107f0.md) |
| @typespec/ts-http-runtime | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-typespec-ts-http-runtime-4178f4d2.md) |
| @vscode/sandbox-runtime | Interpreter Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-vscode-sandbox-runtime-7698def6.md) |
