...
<!-- canonical: https://github.com/dubinc/dub -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dubinc/dub](https://github.com/dubinc/dub) |
| Source record ids | github_search_databases-6ded3253adf6b7 |

## System Engineer Summary

The modern link attribution platform. Loved by world-class marketing teams like Framer, Perplexity,
Superhuman, Twilio, Buffer and more.

## Operational Role

For a systems engineer, dubinc/dub belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T06:31:13Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6ded3253adf6b7` from `github_search_databases` as `registry_expansion`
