...
<!-- canonical: https://github.com/robert80203/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-Wave-Radar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/robert80203/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-Wave-Radar](https://github.com/robert80203/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-Wave-Radar) |
| Source record ids | github_search_radars-e4a2000d99c18b |

## System Engineer Summary

The official implementation of HuPR: A Benchmark for Human Pose Estimation Using Millimeter Wave
Radar

## Operational Role

For a systems engineer, robert80203/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-
Wave-Radar belongs in the Radars inventory as part of ecosystem capability mapping, dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-11T15:59:17Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e4a2000d99c18b` from `github_search_radars` as `registry_expansion`
