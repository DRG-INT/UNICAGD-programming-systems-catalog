...
<!-- canonical: https://cran.r-project.org/web/packages/dashboardapi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dashboardapi/index.html](https://cran.r-project.org/web/packages/dashboardapi/index.html) |
| Source record ids | cran_packages_by_date-c6afb583e9de28 |

## System Engineer Summary

Access Japan's Statistics Dashboard API

## Operational Role

For a systems engineer, dashboardapi belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 11:10:02 UTC | [https://cran.r-project.org/web/packages/dashboardapi/DESCRIPTION](https://cran.r-project.org/web/packages/dashboardapi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dashboardapi/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c6afb583e9de28` from `cran_packages_by_date` as `registry_expansion`
