...
<!-- canonical: https://packagist.org/packages/netresearch/jsonmapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/netresearch/jsonmapper](https://packagist.org/packages/netresearch/jsonmapper) |
| Source record ids | packagist_search-63d0a950ff21f0 |
...
For a systems engineer, netresearch/jsonmapper belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-63d0a950ff21f0` from `packagist_search` as `registry_expansion`
