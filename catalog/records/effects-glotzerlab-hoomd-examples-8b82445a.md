...
<!-- canonical: https://github.com/glotzerlab/hoomd-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/glotzerlab/hoomd-examples](https://github.com/glotzerlab/hoomd-examples) |
| Source record ids | github_search_effects-d821e99fbf666a |
...
For a systems engineer, glotzerlab/hoomd-examples belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T13:19:32Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Elastic-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_effects-d821e99fbf666a` from `github_search_effects` as `registry_expansion`
