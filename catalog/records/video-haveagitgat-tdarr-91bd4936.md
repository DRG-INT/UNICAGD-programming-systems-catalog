...
<!-- canonical: https://github.com/HaveAGitGat/Tdarr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HaveAGitGat/Tdarr](https://github.com/HaveAGitGat/Tdarr) |
| Source record ids | github_search_video-a4696ffc36b715 |

## System Engineer Summary

Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics +
video health checking (Windows, macOS, Linux & Docker)

## Operational Role

For a systems engineer, HaveAGitGat/Tdarr belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T07:37:45Z | gh search repos topic:video stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | (UPL-1.0 OR Apache-2.0); MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_video-a4696ffc36b715` from `github_search_video` as `registry_expansion`
