...
<!-- canonical: https://github.com/bazel-contrib/rules_cuda -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bazel-contrib/rules_cuda](https://github.com/bazel-contrib/rules_cuda) |
| Source record ids | github_search_starlark-77b11f697f446d |
...
For a systems engineer, bazel-contrib/rules_cuda belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:36:11Z | gh search repos topic:starlark stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-77b11f697f446d` from `github_search_starlark` as `registry_expansion`
