...
<!-- canonical: https://gitlab.com/gitlab-org/security-products/sast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/security-products/sast](https://gitlab.com/gitlab-org/security-products/sast) |
| Source record ids | gitlab_projects_api-e2a0e83665152f |

## System Engineer Summary

Deprecated project for SAST Docker-in-Docker orchestrator. See for full docs

## Operational Role

For a systems engineer, gitlab-org/security-products/sast belongs in the Repository Workplaces
...
- `gitlab_projects_api-e2a0e83665152f` from `gitlab_projects_api` as `registry_expansion`
