...
<!-- canonical: https://cran.r-project.org/web/packages/spatcovar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spatcovar/index.html](https://cran.r-project.org/web/packages/spatcovar/index.html) |
| Source record ids | cran_packages_by_date-1d10902d0b6fe4 |
...
For a systems engineer, spatcovar belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-08 13:30:02 UTC | [https://cran.r-project.org/web/packages/spatcovar/DESCRIPTION](https://cran.r-project.org/web/packages/spatcovar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spatcovar/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-1d10902d0b6fe4` from `cran_packages_by_date` as `registry_expansion`
