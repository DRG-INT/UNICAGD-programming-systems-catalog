...
| Canonical URL | [https://github.com/Srameo/LED](https://github.com/Srameo/LED) |
| Source record ids | github_search_photography-d1dd8a84fe645e |

## System Engineer Summary

ICCV 2023 Lighting Every Darkness in Two Pairs: A Calibration-Free Pipeline for RAW Denoising &&
Arxiv 2023 Make Explicit Calibration Implicit: Calibrate Denoiser Instead of the Noise Model &&
NeurIPS 2025 UltraLED: Learning to See Everything in Ultra-High Dynamic Range Scenes

## Operational Role

For a systems engineer, Srameo/LED belongs in the Photography inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2024-01-13T08:15:21Z | [https://api.github.com/repos/Srameo/LED/releases/latest](https://api.github.com/repos/Srameo/LED/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Srameo/LED/releases/latest` at `2026-09-01T09:23:34+00:00`.
...
- `github_search_photography-d1dd8a84fe645e` from `github_search_photography` as `registry_expansion`
