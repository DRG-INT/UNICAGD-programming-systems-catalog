...
<!-- canonical: https://pub.dev/packages/brasil_fields -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/brasil_fields](https://pub.dev/packages/brasil_fields) |
| Source record ids | pub_dev-bb92cc25b9d94e |
...
For a systems engineer, brasil_fields belongs in the Dart inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.0 | 2026-03-30T13:57:34.775340Z | [https://pub.dev/api/packages/brasil_fields](https://pub.dev/api/packages/brasil_fields) |  |
| preview | known | 1.0.0-nullsafety.1 | 2021-02-18T22:44:19.708038Z | [https://pub.dev/api/packages/brasil_fields](https://pub.dev/api/packages/brasil_fields) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/brasil_fields` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-bb92cc25b9d94e` from `pub_dev` as `registry_expansion`
