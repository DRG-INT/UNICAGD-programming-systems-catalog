...
<!-- canonical: https://github.com/eigilnikolajsen/commit-mono -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eigilnikolajsen/commit-mono](https://github.com/eigilnikolajsen/commit-mono) |
| Source record ids | github_search_font_briefcase-70a4a3a60372ff |
...
For a systems engineer, eigilnikolajsen/commit-mono belongs in the Font Briefcase inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-24T12:10:17Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-70a4a3a60372ff` from `github_search_font_briefcase` as `registry_expansion`
