...
<!-- canonical: https://hackage.haskell.org/package/x509-validation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/x509-validation](https://hackage.haskell.org/package/x509-validation) |
| Source record ids | hackage_top_downloads-5f2665c1e0b3e8 |
...
For a systems engineer, x509-validation belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.12 | 2022-01-17T07:57:12Z | [https://hackage.haskell.org/package/x509-validation](https://hackage.haskell.org/package/x509-validation) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Educational Community License v2.0; https://api.github.com/licenses/ecl-2.0 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/x509-validation` at `2026-09-01T14:24:43+00:00`.
...
- `hackage_top_downloads-5f2665c1e0b3e8` from `hackage_top_downloads` as `registry_expansion`
