...
<!-- canonical: https://github.com/gnuradio/pybombs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gnuradio/pybombs](https://github.com/gnuradio/pybombs) |
| Source record ids | github_search_electromagnetoscopes-8656ffc86e86a9 |

## System Engineer Summary

PyBOMBS (Python Build Overlay Managed Bundle System) is the GNU Radio install management system for
resolving dependencies and pulling in out-of-tree projects.

## Operational Role

For a systems engineer, gnuradio/pybombs belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-25T19:50:21Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-8656ffc86e86a9` from `github_search_electromagnetoscopes` as `registry_expansion`
