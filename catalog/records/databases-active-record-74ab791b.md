...
| Canonical URL | [https://github.com/rails/rails/tree/main/activerecord](https://github.com/rails/rails/tree/main/activerecord) |
| Source record ids | curated_database_systems-ae8dd055324b79 |

## System Engineer Summary

Ruby on Rails ORM and database migration layer.

## Operational Role

For a systems engineer, Active Record belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v8.1.3.1 | 2026-07-29T14:59:54Z | [https://api.github.com/repos/rails/rails/releases/latest](https://api.github.com/repos/rails/rails/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rails/rails/releases/latest` at `2026-09-01T07:24:47+00:00`.
...
- `curated_database_systems-ae8dd055324b79` from `curated_database_systems` as `registry_expansion`
