...
<!-- canonical: https://www.nuget.org/packages/Confluent.SchemaRegistry.Serdes.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Confluent.SchemaRegistry.Serdes.Json](https://www.nuget.org/packages/Confluent.SchemaRegistry.Serdes.Json) |
| Source record ids | nuget_search-5a84940dc7b4e7 |

## System Engineer Summary

Provides a JSON Serializer and Deserializer for use with Confluent.Kafka with Confluent Schema
Registry integration

## Operational Role

For a systems engineer, Confluent.SchemaRegistry.Serdes.Json belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0 | 2026-06-30T18:17:49.517+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/confluent.schemaregistry.serdes.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/confluent.schemaregistry.serdes.json/index.json) |  |
| preview | known | 2.15.0-RC2 | 2026-06-30T12:48:01.567+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/confluent.schemaregistry.serdes.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/confluent.schemaregistry.serdes.json/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/confluent.schemaregistry.serdes.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-5a84940dc7b4e7` from `nuget_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Refit.HttpClientFactory | Package Manager | [open](c-sharp-refit-httpclientfactory-6d864536.md) |
