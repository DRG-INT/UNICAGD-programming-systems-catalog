...
<!-- canonical: https://cran.r-project.org/web/packages/xnicher/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xnicher/index.html](https://cran.r-project.org/web/packages/xnicher/index.html) |
| Source record ids | cran_packages_by_date-a5e26a49daa898 |

## System Engineer Summary

Estimates Ecological Niche Models Using Ellipses

## Operational Role

For a systems engineer, xnicher belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-15 11:20:02 UTC | [https://cran.r-project.org/web/packages/xnicher/DESCRIPTION](https://cran.r-project.org/web/packages/xnicher/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xnicher/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-a5e26a49daa898` from `cran_packages_by_date` as `registry_expansion`
