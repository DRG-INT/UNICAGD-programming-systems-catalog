...
<!-- canonical: https://www.npmjs.com/package/@vercel/cosmosdb-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@vercel/cosmosdb-server](https://www.npmjs.com/package/@vercel/cosmosdb-server) |
| Source record ids | npm_registry-4cbc72c90058f8 |
...
For a systems engineer, @vercel/cosmosdb-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-03-09T18:28:03.744Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4cbc72c90058f8` from `npm_registry` as `registry_expansion`
