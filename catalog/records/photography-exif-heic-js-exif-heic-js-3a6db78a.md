...
<!-- canonical: https://github.com/exif-heic-js/exif-heic-js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/exif-heic-js/exif-heic-js](https://github.com/exif-heic-js/exif-heic-js) |
| Source record ids | github_search_photography-31a8059bada0e2 |
...
For a systems engineer, exif-heic-js/exif-heic-js belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-03T14:31:17Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-31a8059bada0e2` from `github_search_photography` as `registry_expansion`
