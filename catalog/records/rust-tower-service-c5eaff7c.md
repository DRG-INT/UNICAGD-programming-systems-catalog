...
<!-- canonical: https://crates.io/crates/tower-service -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tower-service](https://crates.io/crates/tower-service) |
| Source record ids | crates_io-e19af0c2eea707 |
...
For a systems engineer, tower-service belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2024-08-13T16:23:33.548845Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-e19af0c2eea707` from `crates_io` as `registry_expansion`
