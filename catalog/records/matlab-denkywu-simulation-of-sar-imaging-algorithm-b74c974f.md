# denkywu/Simulation-of-SAR-Imaging-Algorithm
...
<!-- canonical: https://github.com/denkywu/Simulation-of-SAR-Imaging-Algorithm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/denkywu/Simulation-of-SAR-Imaging-Algorithm](https://github.com/denkywu/Simulation-of-SAR-Imaging-Algorithm) |
| Source record ids | github_search_matlab-aabbff9db2fe25 |

## System Engineer Summary

合成孔径雷达成像 相关。Some work I did during my graduate studies (Matlab Code) : (1) Simulation of SAR Imaging
Algorithm, including RD and CS.

## Operational Role

For a systems engineer, denkywu/Simulation-of-SAR-Imaging-Algorithm belongs in the Matlab inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-03T03:54:58Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-aabbff9db2fe25` from `github_search_matlab` as `registry_expansion`
