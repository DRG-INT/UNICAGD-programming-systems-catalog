...
<!-- canonical: https://cran.r-project.org/web/packages/PCMRS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PCMRS/index.html](https://cran.r-project.org/web/packages/PCMRS/index.html) |
| Source record ids | cran_packages_by_date-89d0c510a8c63d |
...
For a systems engineer, PCMRS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-6 | 2026-09-07 15:50:07 UTC | [https://cran.r-project.org/web/packages/PCMRS/DESCRIPTION](https://cran.r-project.org/web/packages/PCMRS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PCMRS/DESCRIPTION` at `2026-09-07T16:20:18+00:00`.
...
- `cran_packages_by_date-89d0c510a8c63d` from `cran_packages_by_date` as `registry_expansion`
