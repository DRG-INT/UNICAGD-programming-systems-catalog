...
<!-- canonical: https://crates.io/crates/serde_yaml -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-5f123bc0941d4c |
...
For a systems engineer, serde_yaml belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.34+deprecated | 2024-03-25T00:50:19.759577Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-5f123bc0941d4c` from `crates_io` as `registry_expansion`
