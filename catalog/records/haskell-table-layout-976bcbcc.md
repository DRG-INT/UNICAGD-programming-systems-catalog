...
<!-- canonical: https://hackage.haskell.org/package/table-layout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/table-layout](https://hackage.haskell.org/package/table-layout) |
| Source record ids | hackage_top_downloads-fcf7e62af72fe9 |
...
For a systems engineer, table-layout belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.2 | 2025-05-18T13:53:50Z | [https://hackage.haskell.org/package/table-layout](https://hackage.haskell.org/package/table-layout) |  |
| candidate | partial | 0.8.0.5 |  | [https://hackage.haskell.org/package/table-layout](https://hackage.haskell.org/package/table-layout) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/table-layout` at `2026-09-02T00:32:53+00:00`.
...
- `hackage_top_downloads-fcf7e62af72fe9` from `hackage_top_downloads` as `registry_expansion`
