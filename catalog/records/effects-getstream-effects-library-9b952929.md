...
<!-- canonical: https://github.com/GetStream/effects-library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GetStream/effects-library](https://github.com/GetStream/effects-library) |
| Source record ids | github_search_effects-085f6560b4d1b6 |

## System Engineer Summary

The Effects Library allows developers to create sophisticated and realistic particle systems such as
snow, fire, rain, confetti, fireworks, and smoke with no or minimal effort.

## Operational Role

For a systems engineer, GetStream/effects-library belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2022-05-31T12:20:21Z | [https://api.github.com/repos/GetStream/effects-library/releases/latest](https://api.github.com/repos/GetStream/effects-library/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GetStream/effects-library/releases/latest` at `2026-09-01T09:23:10+00:00`.
...
- `github_search_effects-085f6560b4d1b6` from `github_search_effects` as `registry_expansion`
...
| naveen-kumawat/Flower | Machine Learning | [open](effects-naveen-kumawat-flower-2bf17aa5.md) |
| vfxai/vfx-datasets | Machine Learning | [open](effects-vfxai-vfx-datasets-59e85e2e.md) |
