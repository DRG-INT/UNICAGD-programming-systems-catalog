...
| Source record ids | corpus-a4fc23ce46f461 |

## System Engineer Summary

tree-sitter is tracked as a parser lexer ast record in the C++23 branch. The source did not provide
...
For a systems engineer, tree-sitter belongs in the C++23 inventory as part of language tooling, code
...
- `corpus-a4fc23ce46f461` from `master_json` as `parser_lexer_ast`
