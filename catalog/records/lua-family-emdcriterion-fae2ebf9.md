...
| Canonical URL | [https://luarocks.org/modules/manuelmartinez/emdcriterion](https://luarocks.org/modules/manuelmartinez/emdcriterion) |
| Source record ids | luarocks_root_manifest-a25096f7e6f6b6 |

## System Engineer Summary

EMDCriterion is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, EMDCriterion belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a25096f7e6f6b6` from `luarocks_root_manifest` as `registry_expansion`
