...
<!-- canonical: https://pub.dev/packages/glass_kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/glass_kit](https://pub.dev/packages/glass_kit) |
| Source record ids | pub_dev-a6c0884b332557 |
...
For a systems engineer, glass_kit belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2025-09-30T14:39:17.400516Z | [https://pub.dev/api/packages/glass_kit](https://pub.dev/api/packages/glass_kit) |  |
| preview | known | 2.0.0-nullsafety.1 | 2021-02-22T10:19:21.003376Z | [https://pub.dev/api/packages/glass_kit](https://pub.dev/api/packages/glass_kit) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/glass_kit` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-a6c0884b332557` from `pub_dev` as `registry_expansion`
