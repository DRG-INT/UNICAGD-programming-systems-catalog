...
<!-- canonical: https://owasp.org/www-project-application-security-verification-standard/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://owasp.org/www-project-application-security-verification-standard/](https://owasp.org/www-project-application-security-verification-standard/) |
| Source record ids | curated_language_routes-3f2dd42f92cd1d |

## System Engineer Summary

Application Security Verification Standard for web application security requirements and
verification levels.

## Operational Role

For a systems engineer, OWASP ASVS belongs in the Doctrines inventory as part of supply-chain
...
- `curated_language_routes-3f2dd42f92cd1d` from `curated_language_routes` as `registry_expansion`
