...
<!-- canonical: https://cran.r-project.org/web/packages/data.table/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/data.table/index.html](https://cran.r-project.org/web/packages/data.table/index.html) |
| Source record ids | cran_packages_by_date-76b1dc5cf304f2 |
...
For a systems engineer, data.table belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.18.6.1 | 2026-08-24 08:40:13 UTC | [https://cran.r-project.org/web/packages/data.table/DESCRIPTION](https://cran.r-project.org/web/packages/data.table/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/data.table/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-76b1dc5cf304f2` from `cran_packages_by_date` as `registry_expansion`
