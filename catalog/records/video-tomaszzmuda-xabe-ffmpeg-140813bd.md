...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tomaszzmuda/Xabe.FFmpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tomaszzmuda/Xabe.FFmpeg](https://github.com/tomaszzmuda/Xabe.FFmpeg) |
| Source record ids | github_search_video-5aaeac8974bada |

## System Engineer Summary

.NET Standard wrapper for FFmpeg. It allows to process media without know how FFmpeg works, and can
be used to pass customized arguments to FFmpeg from dotnet core application.

## Operational Role

For a systems engineer, tomaszzmuda/Xabe.FFmpeg belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T18:35:53Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-5aaeac8974bada` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| centrifugal/centrifugo | Language Specification | [open](video-centrifugal-centrifugo-38edc1e4.md) |
| IliasHad/edit-mind | Language Specification | [open](video-iliashad-edit-mind-9f5bd280.md) |
| ReactiveX/RxGo | Language Specification | [open](video-reactivex-rxgo-2ad7430c.md) |
| sitkevij/awesome-video | Language Specification | [open](video-sitkevij-awesome-video-c96e5be4.md) |
| streamproc/MediaStreamRecorder | Language Specification | [open](video-streamproc-mediastreamrecorder-95e3d418.md) |
| umlx5h/LLPlayer | Language Specification | [open](video-umlx5h-llplayer-e3659d7e.md) |
