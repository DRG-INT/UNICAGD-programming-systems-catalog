...
<!-- canonical: https://github.com/3breadt/dd-plist -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/3breadt/dd-plist](https://github.com/3breadt/dd-plist) |
| Source record ids | github_search_cocoa-0dba41f0c9fabe |
...
For a systems engineer, 3breadt/dd-plist belongs in the Cocoa inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T12:28:17Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0dba41f0c9fabe` from `github_search_cocoa` as `registry_expansion`
