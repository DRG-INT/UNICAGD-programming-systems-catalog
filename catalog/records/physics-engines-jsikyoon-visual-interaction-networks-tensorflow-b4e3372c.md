...
<!-- canonical: https://github.com/jsikyoon/visual-interaction-networks_tensorflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jsikyoon/visual-interaction-networks_tensorflow](https://github.com/jsikyoon/visual-interaction-networks_tensorflow) |
| Source record ids | github_search_physics_engines-d67c37710bb018 |
...
For a systems engineer, jsikyoon/visual-interaction-networks_tensorflow belongs in the Physics
Engines inventory as part of service communication, clients/servers, protocol handling, and edge
integration.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-24T15:51:48Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-d67c37710bb018` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Raocp/PINN-laminar-flow | Networking Http | [open](physics-engines-raocp-pinn-laminar-flow-51e9b57c.md) |
