...
<!-- canonical: https://cran.r-project.org/web/packages/metajam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/metajam/index.html](https://cran.r-project.org/web/packages/metajam/index.html) |
| Source record ids | cran_packages_by_date-e955cf7164005e |
...
For a systems engineer, metajam belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-09-12 13:30:18 UTC | [https://cran.r-project.org/web/packages/metajam/DESCRIPTION](https://cran.r-project.org/web/packages/metajam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/metajam/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-e955cf7164005e` from `cran_packages_by_date` as `registry_expansion`
