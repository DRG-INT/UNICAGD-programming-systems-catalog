...
| Canonical URL | [https://crates.io/crates/uname](https://crates.io/crates/uname) |
| Source record ids | crates_io-4b486b82a92e21 |
...
For a systems engineer, uname belongs in the Rust inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2016-10-11T18:23:38.774567Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-4b486b82a92e21` from `crates_io` as `registry_expansion`
