...
<!-- canonical: https://crates.io/crates/normalize-line-endings -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/normalize-line-endings](https://crates.io/crates/normalize-line-endings) |
| Source record ids | crates_io-add33206f6178e |
...
For a systems engineer, normalize-line-endings belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2018-12-16T15:17:15.641063Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-15T12:24:37+00:00`.
...
- `crates_io-add33206f6178e` from `crates_io` as `registry_expansion`
