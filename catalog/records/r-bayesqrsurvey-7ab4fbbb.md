...
<!-- canonical: https://cran.r-project.org/web/packages/bayesQRsurvey/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayesQRsurvey/index.html](https://cran.r-project.org/web/packages/bayesQRsurvey/index.html) |
| Source record ids | cran_packages_by_date-522a087aa083ba |
...
For a systems engineer, bayesQRsurvey belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-21 05:45:11 UTC | [https://cran.r-project.org/web/packages/bayesQRsurvey/DESCRIPTION](https://cran.r-project.org/web/packages/bayesQRsurvey/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayesQRsurvey/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-522a087aa083ba` from `cran_packages_by_date` as `registry_expansion`
