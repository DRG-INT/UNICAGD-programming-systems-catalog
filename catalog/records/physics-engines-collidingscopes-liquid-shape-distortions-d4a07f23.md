...
<!-- canonical: https://github.com/collidingScopes/liquid-shape-distortions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/collidingScopes/liquid-shape-distortions](https://github.com/collidingScopes/liquid-shape-distortions) |
| Source record ids | github_search_physics_engines-abbc9fe89d2abb |

## System Engineer Summary

Create psychedelic animations in real-time in the browser. Webgl shader using liquid motion,
distortion, shadows, and light.

## Operational Role

For a systems engineer, collidingScopes/liquid-shape-distortions belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-24T12:34:58Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-abbc9fe89d2abb` from `github_search_physics_engines` as `registry_expansion`
