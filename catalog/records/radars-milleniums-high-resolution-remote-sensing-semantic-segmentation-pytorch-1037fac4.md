...
<!-- canonical: https://github.com/milleniums/High-Resolution-Remote-Sensing-Semantic-Segmentation-PyTorch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/milleniums/High-Resolution-Remote-Sensing-Semantic-Segmentation-PyTorch](https://github.com/milleniums/High-Resolution-Remote-Sensing-Semantic-Segmentation-PyTorch) |
| Source record ids | github_search_radars-76368a9aebd77c |

## System Engineer Summary

milleniums/High-Resolution-Remote-Sensing-Semantic-Segmentation-PyTorch is tracked as a library
record in the Radars branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, milleniums/High-Resolution-Remote-Sensing-Semantic-Segmentation-PyTorch
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-11T07:15:43Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-76368a9aebd77c` from `github_search_radars` as `registry_expansion`
