...
<!-- canonical: https://github.com/2KAbhishek/pickme.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2KAbhishek/pickme.nvim](https://github.com/2KAbhishek/pickme.nvim) |
| Source record ids | github_search_telescopes-a1cb9448f33484 |
...
For a systems engineer, 2KAbhishek/pickme.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2025-04-13T21:14:40Z | [https://api.github.com/repos/2KAbhishek/pickme.nvim/releases/latest](https://api.github.com/repos/2KAbhishek/pickme.nvim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/2KAbhishek/pickme.nvim/releases/latest` at `2026-09-01T11:22:11+00:00`.
...
- `github_search_telescopes-a1cb9448f33484` from `github_search_telescopes` as `registry_expansion`
