...
<!-- canonical: https://pypi.org/project/aditya-portfolio-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aditya-portfolio-cli/](https://pypi.org/project/aditya-portfolio-cli/) |
| Source record ids | pypi_simple-3cb06730956f06 |
...
For a systems engineer, aditya-portfolio-cli belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.3 | 2026-01-20T22:44:10.570634Z | [https://pypi.org/pypi/aditya-portfolio-cli/json](https://pypi.org/pypi/aditya-portfolio-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aditya-portfolio-cli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-3cb06730956f06` from `pypi_simple` as `registry_expansion`
