...
<!-- canonical: https://github.com/CapableRobot/notebooks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CapableRobot/notebooks](https://github.com/CapableRobot/notebooks) |
| Source record ids | github_search_space_maps-193988c9e8763e |
...
For a systems engineer, CapableRobot/notebooks belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-17T15:58:03Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-193988c9e8763e` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jkaufy/JupyterModule | Tutorial Book Styleguide | [open](space-maps-jkaufy-jupytermodule-8e1588e2.md) |
