...
| Canonical URL | [https://crates.io/crates/embed-resource](https://crates.io/crates/embed-resource) |
| Source record ids | crates_io-5d3968cffa83b5 |

## System Engineer Summary

A Cargo library to handle compilation and inclusion of Windows resources in the most resilient
fashion imaginable

## Operational Role

For a systems engineer, embed-resource belongs in the Rust inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.11 | 2026-07-02T15:15:09.314952Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-5d3968cffa83b5` from `crates_io` as `registry_expansion`
