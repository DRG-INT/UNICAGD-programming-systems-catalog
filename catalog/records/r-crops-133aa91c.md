...
<!-- canonical: https://cran.r-project.org/web/packages/crops/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/crops/index.html](https://cran.r-project.org/web/packages/crops/index.html) |
| Source record ids | cran_packages_by_date-f09c66522f9045 |
...
For a systems engineer, crops belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-09-04 13:50:01 UTC | [https://cran.r-project.org/web/packages/crops/DESCRIPTION](https://cran.r-project.org/web/packages/crops/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/crops/DESCRIPTION` at `2026-09-04T14:19:07+00:00`.
...
- `cran_packages_by_date-f09c66522f9045` from `cran_packages_by_date` as `registry_expansion`
