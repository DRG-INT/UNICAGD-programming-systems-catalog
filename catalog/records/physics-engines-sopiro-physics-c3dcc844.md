...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Sopiro/Physics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Sopiro/Physics](https://github.com/Sopiro/Physics) |
| Source record ids | github_search_physics_engines-48b2ed6dc0a938 |
...
For a systems engineer, Sopiro/Physics belongs in the Physics Engines inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-09T12:40:01Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-48b2ed6dc0a938` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Altanis/kinetics | Type Checker | [open](physics-engines-altanis-kinetics-83b3a378.md) |
| hood/bump.ts | Type Checker | [open](physics-engines-hood-bump-ts-1b614f18.md) |
| NewKrok/nape-js | Type Checker | [open](physics-engines-newkrok-nape-js-93e66961.md) |
