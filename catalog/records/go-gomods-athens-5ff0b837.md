...
<!-- canonical: https://github.com/gomods/athens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gomods/athens](https://github.com/gomods/athens) |
| Source record ids | github_search_go-877fd96825f9ee |
...
For a systems engineer, gomods/athens belongs in the Go inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:53:04Z | gh search repos topic:go-modules stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-877fd96825f9ee` from `github_search_go` as `registry_expansion`
