...
<!-- canonical: https://github.com/allogic/KDBG -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/allogic/KDBG](https://github.com/allogic/KDBG) |
| Source record ids | github_search_assembly-85e9c04edc8608 |

## System Engineer Summary

The windows kernel debugger consists of two parts, KMOD which is the kernel driver handling ring3
request and KCLI, the command line interface for the driver. It originated due to insufficient
useability with CheatEngine's DBVM driver while debugging games running under certain AntiCheat
software.

## Operational Role

For a systems engineer, allogic/KDBG belongs in the Assembly inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-12T23:01:55Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-85e9c04edc8608` from `github_search_assembly` as `registry_expansion`
