...
<!-- canonical: https://cran.r-project.org/web/packages/prrd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prrd/index.html](https://cran.r-project.org/web/packages/prrd/index.html) |
| Source record ids | cran_packages_by_date-afa990341acef6 |
...
For a systems engineer, prrd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7 | 2026-08-27 11:00:02 UTC | [https://cran.r-project.org/web/packages/prrd/DESCRIPTION](https://cran.r-project.org/web/packages/prrd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prrd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-afa990341acef6` from `cran_packages_by_date` as `registry_expansion`
