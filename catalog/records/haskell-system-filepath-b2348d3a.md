...
<!-- canonical: https://hackage.haskell.org/package/system-filepath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/system-filepath](https://hackage.haskell.org/package/system-filepath) |
| Source record ids | hackage_top_downloads-e0f08b69a660b1 |
...
For a systems engineer, system-filepath belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.14.1 | 2024-11-13T17:36:45Z | [https://hackage.haskell.org/package/system-filepath](https://hackage.haskell.org/package/system-filepath) |  |
| candidate | partial | 0.4.14.1 |  | [https://hackage.haskell.org/package/system-filepath](https://hackage.haskell.org/package/system-filepath) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/system-filepath` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-e0f08b69a660b1` from `hackage_top_downloads` as `registry_expansion`
