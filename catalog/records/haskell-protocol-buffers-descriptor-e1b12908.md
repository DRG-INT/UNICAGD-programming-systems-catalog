...
<!-- canonical: https://hackage.haskell.org/package/protocol-buffers-descriptor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/protocol-buffers-descriptor](https://hackage.haskell.org/package/protocol-buffers-descriptor) |
| Source record ids | hackage_top_downloads-740704d9d3a8f7 |
...
For a systems engineer, protocol-buffers-descriptor belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.17 | 2020-11-05T20:59:50Z | [https://hackage.haskell.org/package/protocol-buffers-descriptor](https://hackage.haskell.org/package/protocol-buffers-descriptor) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/protocol-buffers-descriptor` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-740704d9d3a8f7` from `hackage_top_downloads` as `registry_expansion`
