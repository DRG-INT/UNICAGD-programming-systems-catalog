...
<!-- canonical: https://cran.r-project.org/web/packages/logStirling2/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/logStirling2/index.html](https://cran.r-project.org/web/packages/logStirling2/index.html) |
| Source record ids | cran_packages_by_date-e8d23aef0f059c |

## System Engineer Summary

Fast Stirling Numbers of the Second Kind

## Operational Role

For a systems engineer, logStirling2 belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-07 17:00:02 UTC | [https://cran.r-project.org/web/packages/logStirling2/DESCRIPTION](https://cran.r-project.org/web/packages/logStirling2/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/logStirling2/DESCRIPTION` at `2026-09-07T18:23:10+00:00`.
...
- `cran_packages_by_date-e8d23aef0f059c` from `cran_packages_by_date` as `registry_expansion`
