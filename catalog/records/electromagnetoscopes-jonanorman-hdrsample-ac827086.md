...
| Source record ids | github_search_electromagnetoscopes-ac0b9acec9aea3 |
...
For a systems engineer, JonaNorman/HDRSample belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2023-10-07T06:18:58Z | [https://api.github.com/repos/JonaNorman/HDRSample/releases/latest](https://api.github.com/repos/JonaNorman/HDRSample/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/JonaNorman/HDRSample/releases/latest` at `2026-09-01T08:26:41+00:00`.
...
- `github_search_electromagnetoscopes-ac0b9acec9aea3` from `github_search_electromagnetoscopes` as `registry_expansion`
