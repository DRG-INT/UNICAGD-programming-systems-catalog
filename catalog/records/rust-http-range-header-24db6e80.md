...
<!-- canonical: https://crates.io/crates/http-range-header -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/http-range-header](https://crates.io/crates/http-range-header) |
| Source record ids | crates_io-4dad76f568e9d2 |
...
For a systems engineer, http-range-header belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2024-11-28T12:38:42.267978Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-4dad76f568e9d2` from `crates_io` as `registry_expansion`
