...
<!-- canonical: https://hackage.haskell.org/package/seqloc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/seqloc](https://hackage.haskell.org/package/seqloc) |
| Source record ids | hackage_top_downloads-271f7d541b47a9 |
...
For a systems engineer, seqloc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1.1 | 2015-01-16T16:38:57Z | [https://hackage.haskell.org/package/seqloc](https://hackage.haskell.org/package/seqloc) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/seqloc` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-271f7d541b47a9` from `hackage_top_downloads` as `registry_expansion`
