...
<!-- canonical: https://www.npmjs.com/package/@rspack/dev-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@rspack/dev-server](https://www.npmjs.com/package/@rspack/dev-server) |
| Source record ids | npm_registry-20d28ef2e390e6 |
...
For a systems engineer, @rspack/dev-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2026-08-22T05:54:21.220Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-20d28ef2e390e6` from `npm_registry` as `registry_expansion`
