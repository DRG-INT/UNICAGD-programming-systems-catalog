...
<!-- canonical: https://github.com/sixem/ivfi-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sixem/ivfi-php](https://github.com/sixem/ivfi-php) |
| Source record ids | github_search_catalogs-4a5e0419a6c9b7 |

## System Engineer Summary

IVFi is a directory indexer that aims to make it easy to browse and explore web-accessible
directories.

## Operational Role

For a systems engineer, sixem/ivfi-php belongs in the Catalogs inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:33:05Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-4a5e0419a6c9b7` from `github_search_catalogs` as `registry_expansion`
