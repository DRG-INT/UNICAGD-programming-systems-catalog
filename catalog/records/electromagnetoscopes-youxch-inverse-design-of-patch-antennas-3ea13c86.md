...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/youxch/Inverse-design-of-patch-antennas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/youxch/Inverse-design-of-patch-antennas](https://github.com/youxch/Inverse-design-of-patch-antennas) |
| Source record ids | github_search_electromagnetoscopes-bb121a2da39ace |

## System Engineer Summary

This repository hosts a simple demonstration of a deep learning approach for the inverse design of
patch antennas. The goal is to explore energy-efficient designs and to significantly reduce
simulation cost compared to conventional methods.

## Operational Role

For a systems engineer, youxch/Inverse-design-of-patch-antennas belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-10T07:04:39Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-bb121a2da39ace` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Arkanic/rtljs | Ffi Bindings | [open](electromagnetoscopes-arkanic-rtljs-1bff2dba.md) |
| ElmerCSC/elmerfem | Ffi Bindings | [open](electromagnetoscopes-elmercsc-elmerfem-2ad5920f.md) |
| hbldh/pymetawear | Ffi Bindings | [open](electromagnetoscopes-hbldh-pymetawear-2cce3120.md) |
