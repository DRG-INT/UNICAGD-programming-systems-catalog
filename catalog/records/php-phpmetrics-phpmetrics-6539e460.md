...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/phpmetrics/phpmetrics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpmetrics/phpmetrics](https://packagist.org/packages/phpmetrics/phpmetrics) |
| Source record ids | packagist_search-5d8b2b08ba6b57 |

## System Engineer Summary

Static analyzer tool for PHP : Coupling, Cyclomatic complexity, Maintainability Index, Halstead's
metrics... and more !

## Operational Role

For a systems engineer, phpmetrics/phpmetrics belongs in the PHP inventory as part of defect
...
- `packagist_search-5d8b2b08ba6b57` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| moodlehq/moodle-plugin-ci | Static Analyzer | [open](php-moodlehq-moodle-plugin-ci-baf3db8b.md) |
