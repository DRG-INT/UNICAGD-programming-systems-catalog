...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Cryptography](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cryptography.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/marcosdanielr/bcryptlua](https://luarocks.org/modules/marcosdanielr/bcryptlua) |
| Source record ids | luarocks_root_manifest-a14d6c7c1a6dd1 |
...
For a systems engineer, bcryptlua belongs in the Lua family inventory as part of confidentiality,
...
| Name | Category | Page |
| --- | --- | --- |
| AesFileEncrypt | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aesfileencrypt-206e6762.md) |
| bgcrypto-aes | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bgcrypto-aes-0825098f.md) |
| bgcrypto-hmac | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bgcrypto-hmac-0e041331.md) |
| bgcrypto-lmd5 | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bgcrypto-lmd5-556d411d.md) |
| bgcrypto-pbkdf2 | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bgcrypto-pbkdf2-caee8115.md) |
| bgcrypto-sha | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bgcrypto-sha-f7e84cdd.md) |
| cctea | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cctea-859cb765.md) |
| communiteq-lua-resty-auto-ssl | Cryptography | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-communiteq-lua-resty-auto-ssl-e4217c8a.md) |
