...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/choojs/bankai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/choojs/bankai](https://github.com/choojs/bankai) |
| Source record ids | github_search_assets-3495b5f87bc2a2 |
...
For a systems engineer, choojs/bankai belongs in the Assets inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-19T12:03:36Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-3495b5f87bc2a2` from `github_search_assets` as `registry_expansion`
