...
<!-- canonical: https://pub.dev/packages/queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/queue](https://pub.dev/packages/queue) |
| Source record ids | pub_dev-c92850d13fc697 |
...
For a systems engineer, queue belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.0 | 2025-01-01T12:50:03.380770Z | [https://pub.dev/api/packages/queue](https://pub.dev/api/packages/queue) |  |
| preview | known | 3.0.0-nullsafety.0 | 2021-02-23T02:14:06.895700Z | [https://pub.dev/api/packages/queue](https://pub.dev/api/packages/queue) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/queue` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-c92850d13fc697` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| background_downloader | Message Broker | [open](dart-background-downloader-c2530439.md) |
