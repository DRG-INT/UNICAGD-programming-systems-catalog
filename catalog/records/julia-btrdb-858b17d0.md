...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BTrDB](https://github.com/JuliaRegistries/General/tree/master/B/BTrDB) |
| Source record ids | julia_general-0914d21afed6cd |

## System Engineer Summary

Julia package registered in General at B/BTrDB.

## Operational Role

For a systems engineer, BTrDB belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BTrDB", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-0914d21afed6cd` from `julia_general` as `registry_expansion`
