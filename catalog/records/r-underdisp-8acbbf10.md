...
<!-- canonical: https://cran.r-project.org/web/packages/underdisp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/underdisp/index.html](https://cran.r-project.org/web/packages/underdisp/index.html) |
| Source record ids | cran_packages_by_date-49a8e6b6e5adfb |
...
For a systems engineer, underdisp belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-20 16:40:02 UTC | [https://cran.r-project.org/web/packages/underdisp/DESCRIPTION](https://cran.r-project.org/web/packages/underdisp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/underdisp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-49a8e6b6e5adfb` from `cran_packages_by_date` as `registry_expansion`
...
| PTSDdiag | Compiler Diagnostics | [open](r-ptsddiag-46843da7.md) |
