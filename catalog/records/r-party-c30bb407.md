...
<!-- canonical: https://cran.r-project.org/web/packages/party/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/party/index.html](https://cran.r-project.org/web/packages/party/index.html) |
| Source record ids | cran_packages_by_date-160a7a038f0653 |
...
For a systems engineer, party belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3-23 | 2026-08-31 22:00:26 UTC | [https://cran.r-project.org/web/packages/party/DESCRIPTION](https://cran.r-project.org/web/packages/party/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/party/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-160a7a038f0653` from `cran_packages_by_date` as `registry_expansion`
