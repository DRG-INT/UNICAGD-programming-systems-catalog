...
<!-- canonical: https://github.com/apache/cloudberry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/cloudberry](https://github.com/apache/cloudberry) |
| Source record ids | github_search_databases-fb3b43af69813a |

## System Engineer Summary

One advanced and mature open-source MPP (Massively Parallel Processing) database. Open source
alternative to Greenplum Database.

## Operational Role

For a systems engineer, apache/cloudberry belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:59:03Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fb3b43af69813a` from `github_search_databases` as `registry_expansion`
...
| pg\_probackup | Concurrency Parallelism | [open](databases-pg-probackup-e70f04d4.md) |
