...
<!-- canonical: https://en.wikipedia.org/wiki/WebAssembly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://en.wikipedia.org/wiki/WebAssembly](https://en.wikipedia.org/wiki/WebAssembly) |
| Source record ids | awesome_list-4027f9d2828c7a |

## System Engineer Summary

WebAssembly Wikipedia is tracked as a library record in the WebAssembly branch. The source did not
...
For a systems engineer, WebAssembly Wikipedia belongs in the WebAssembly inventory as part of
...
- `awesome_list-4027f9d2828c7a` from `awesome_list` as `registry_expansion`
