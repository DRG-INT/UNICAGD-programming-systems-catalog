# UrbanVue/linked_camera

## Navigation

[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/UrbanVue/linked_camera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UrbanVue/linked_camera](https://github.com/UrbanVue/linked_camera) |
| Source record ids | github_search_photography-a29abd6eb8ef3d |

## System Engineer Summary

A lightweight, privacy-aware Android camera app for field data collection with automatic Nextcloud
upload and offline queue management.

## Operational Role

For a systems engineer, UrbanVue/linked_camera belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-07T08:56:59Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-a29abd6eb8ef3d` from `github_search_photography` as `registry_expansion`
