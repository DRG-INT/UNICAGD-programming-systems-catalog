...
<!-- canonical: https://github.com/wsl2ls/iOS_Tips -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wsl2ls/iOS_Tips](https://github.com/wsl2ls/iOS_Tips) |
| Source record ids | github_search_photography-76b4f4142a3c8d |

## System Engineer Summary

iOS的一些示例，持续更新中：1、AVFoundation 高仿微信相机拍摄和编辑 2、AVFoundation 人脸检测、实时滤镜、音视频编解码、GPUImage框架的使用等音视频相关内容
3、OpenGLES 4、LeetCode算法练习 5、iOS Crash防护和APM监控 6、WKWebView相关的内容 等........

## Operational Role

For a systems engineer, wsl2ls/iOS_Tips belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-28T19:02:32Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-76b4f4142a3c8d` from `github_search_photography` as `registry_expansion`
