...
<!-- canonical: https://cran.r-project.org/web/packages/MergeKmeans/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MergeKmeans/index.html](https://cran.r-project.org/web/packages/MergeKmeans/index.html) |
| Source record ids | cran_packages_by_date-ed5876c476e537 |
...
For a systems engineer, MergeKmeans belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-04 15:50:13 UTC | [https://cran.r-project.org/web/packages/MergeKmeans/DESCRIPTION](https://cran.r-project.org/web/packages/MergeKmeans/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MergeKmeans/DESCRIPTION` at `2026-09-04T16:20:41+00:00`.
...
- `cran_packages_by_date-ed5876c476e537` from `cran_packages_by_date` as `registry_expansion`
