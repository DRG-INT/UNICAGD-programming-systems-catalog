...
<!-- canonical: https://github.com/infobip/infobip-spring-data-querydsl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/infobip/infobip-spring-data-querydsl](https://github.com/infobip/infobip-spring-data-querydsl) |
| Source record ids | github_search_databases-b1ddcbb2c718fe |

## System Engineer Summary

Infobip Spring Data Querydsl provides new functionality that enables the user to leverage the full
power of Querydsl API on top of Spring Data repository infrastructure.

## Operational Role

For a systems engineer, infobip/infobip-spring-data-querydsl belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T13:41:08Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b1ddcbb2c718fe` from `github_search_databases` as `registry_expansion`
