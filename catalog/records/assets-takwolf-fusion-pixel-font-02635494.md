...
| Source record ids | github_search_assets-a6931a405b25ba |

## System Engineer Summary

TakWolf/fusion-pixel-font is tracked as a library record in the Assets branch. The source did not
...
For a systems engineer, TakWolf/fusion-pixel-font belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T11:40:17Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-a6931a405b25ba` from `github_search_assets` as `registry_expansion`
