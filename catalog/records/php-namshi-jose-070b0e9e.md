...
<!-- canonical: https://packagist.org/packages/namshi/jose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/namshi/jose](https://packagist.org/packages/namshi/jose) |
| Source record ids | packagist_search-bd1053f7e2879e |
...
For a systems engineer, namshi/jose belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-bd1053f7e2879e` from `packagist_search` as `registry_expansion`
