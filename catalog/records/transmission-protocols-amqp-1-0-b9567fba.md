...
<!-- canonical: https://docs.oasis-open.org/amqp/core/v1.0/amqp-core-complete-v1.0.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.oasis-open.org/amqp/core/v1.0/amqp-core-complete-v1.0.html](https://docs.oasis-open.org/amqp/core/v1.0/amqp-core-complete-v1.0.html) |
| Source record ids | curated_language_routes-444453f3770944 |

## System Engineer Summary

OASIS AMQP 1.0 specification for interoperable messaging.

## Operational Role

For a systems engineer, AMQP 1.0 belongs in the Transmission Protocols inventory as part of
...
- `curated_language_routes-444453f3770944` from `curated_language_routes` as `registry_expansion`
