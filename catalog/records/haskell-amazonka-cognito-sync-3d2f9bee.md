...
<!-- canonical: https://hackage.haskell.org/package/amazonka-cognito-sync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-cognito-sync](https://hackage.haskell.org/package/amazonka-cognito-sync) |
| Source record ids | hackage_top_downloads-e88ad41c738f78 |
...
For a systems engineer, amazonka-cognito-sync belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:08:42Z | [https://hackage.haskell.org/package/amazonka-cognito-sync](https://hackage.haskell.org/package/amazonka-cognito-sync) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-cognito-sync` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-e88ad41c738f78` from `hackage_top_downloads` as `registry_expansion`
