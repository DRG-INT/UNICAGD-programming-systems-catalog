...
<!-- canonical: https://packagist.org/packages/phpunit/phpunit-selenium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpunit/phpunit-selenium](https://packagist.org/packages/phpunit/phpunit-selenium) |
| Source record ids | packagist_search-e1011f1ff70d3b |
...
For a systems engineer, phpunit/phpunit-selenium belongs in the PHP inventory as part of
...
- `packagist_search-e1011f1ff70d3b` from `packagist_search` as `registry_expansion`
