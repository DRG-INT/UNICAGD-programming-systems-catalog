...
<!-- canonical: https://pub.dev/packages/shelf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf](https://pub.dev/packages/shelf) |
| Source record ids | pub_dev-17189017be2374 |
...
For a systems engineer, shelf belongs in the Dart inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2024-06-21T17:47:04.083038Z | [https://pub.dev/api/packages/shelf](https://pub.dev/api/packages/shelf) |  |
| preview | known | 1.0.0-nullsafety.0 | 2021-01-29T16:27:07.654638Z | [https://pub.dev/api/packages/shelf](https://pub.dev/api/packages/shelf) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-17189017be2374` from `pub_dev` as `registry_expansion`
