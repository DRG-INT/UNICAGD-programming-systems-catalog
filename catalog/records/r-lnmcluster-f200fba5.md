...
<!-- canonical: https://cran.r-project.org/web/packages/lnmCluster/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lnmCluster/index.html](https://cran.r-project.org/web/packages/lnmCluster/index.html) |
| Source record ids | cran_packages_by_date-7a06f1971a1fee |
...
For a systems engineer, lnmCluster belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-28 13:00:02 UTC | [https://cran.r-project.org/web/packages/lnmCluster/DESCRIPTION](https://cran.r-project.org/web/packages/lnmCluster/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lnmCluster/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7a06f1971a1fee` from `cran_packages_by_date` as `registry_expansion`
