...
<!-- canonical: https://cran.r-project.org/web/packages/ofemeantest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ofemeantest/index.html](https://cran.r-project.org/web/packages/ofemeantest/index.html) |
| Source record ids | cran_packages_by_date-add57519214f99 |

## System Engineer Summary

On Farm Experimentation Mean Test

## Operational Role

For a systems engineer, ofemeantest belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-20 14:20:14 UTC | [https://cran.r-project.org/web/packages/ofemeantest/DESCRIPTION](https://cran.r-project.org/web/packages/ofemeantest/DESCRIPTION) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ofemeantest/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-add57519214f99` from `cran_packages_by_date` as `registry_expansion`
