...
<!-- canonical: https://cran.r-project.org/web/packages/ggm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggm/index.html](https://cran.r-project.org/web/packages/ggm/index.html) |
| Source record ids | cran_packages_by_date-babcfa35a5f581 |
...
For a systems engineer, ggm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.4 | 2026-08-04 11:00:02 UTC | [https://cran.r-project.org/web/packages/ggm/DESCRIPTION](https://cran.r-project.org/web/packages/ggm/DESCRIPTION) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-babcfa35a5f581` from `cran_packages_by_date` as `registry_expansion`
