...
<!-- canonical: https://pub.dev/packages/xml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/xml](https://pub.dev/packages/xml) |
| Source record ids | pub_dev-732c7ce953ccc3 |
...
For a systems engineer, xml belongs in the Dart inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.1 | 2026-04-25T17:34:36.413972Z | [https://pub.dev/api/packages/xml](https://pub.dev/api/packages/xml) |  |
| preview | known | 5.0.0-nullsafety.1 | 2020-11-21T08:05:05.403331Z | [https://pub.dev/api/packages/xml](https://pub.dev/api/packages/xml) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/xml` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-732c7ce953ccc3` from `pub_dev` as `registry_expansion`
