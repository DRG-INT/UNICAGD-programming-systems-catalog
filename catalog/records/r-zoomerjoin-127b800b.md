...
<!-- canonical: https://cran.r-project.org/web/packages/zoomerjoin/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/zoomerjoin/index.html](https://cran.r-project.org/web/packages/zoomerjoin/index.html) |
| Source record ids | cran_packages_by_date-864cef10eb70e1 |
...
For a systems engineer, zoomerjoin belongs in the R inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-08-27 05:10:02 UTC | [https://cran.r-project.org/web/packages/zoomerjoin/DESCRIPTION](https://cran.r-project.org/web/packages/zoomerjoin/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/zoomerjoin/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-864cef10eb70e1` from `cran_packages_by_date` as `registry_expansion`
