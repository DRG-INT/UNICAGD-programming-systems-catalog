...
<!-- canonical: https://cran.r-project.org/web/packages/ggbiplot/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggbiplot/index.html](https://cran.r-project.org/web/packages/ggbiplot/index.html) |
| Source record ids | cran_packages_by_date-5d4e68180b6a9f |
...
For a systems engineer, ggbiplot belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-09-07 05:20:02 UTC | [https://cran.r-project.org/web/packages/ggbiplot/DESCRIPTION](https://cran.r-project.org/web/packages/ggbiplot/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggbiplot/DESCRIPTION` at `2026-09-07T06:28:13+00:00`.
...
- `cran_packages_by_date-5d4e68180b6a9f` from `cran_packages_by_date` as `registry_expansion`
