...
<!-- canonical: https://github.com/renpy/renpy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/renpy/renpy](https://github.com/renpy/renpy) |
| Source record ids | github_search_game_engines-ce0153b6ba15a5 |
...
For a systems engineer, renpy/renpy belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:42:00Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-ce0153b6ba15a5` from `github_search_game_engines` as `registry_expansion`
