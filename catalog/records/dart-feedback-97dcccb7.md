...
<!-- canonical: https://pub.dev/packages/feedback -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/feedback](https://pub.dev/packages/feedback) |
| Source record ids | pub_dev-fe286be0797453 |

## System Engineer Summary

A Flutter package for getting better feedback. It allows the user to give interactive feedback
directly in the app.

## Operational Role

For a systems engineer, feedback belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2025-07-06T14:15:49.058026Z | [https://pub.dev/api/packages/feedback](https://pub.dev/api/packages/feedback) |  |
| preview | known | 2.3.0-beta | 2021-12-31T13:40:18.053035Z | [https://pub.dev/api/packages/feedback](https://pub.dev/api/packages/feedback) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/feedback` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-fe286be0797453` from `pub_dev` as `registry_expansion`
