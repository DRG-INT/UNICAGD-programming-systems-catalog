...
| Source record ids | github_search_satcom_satellites-be45c7133f0d7c |

## System Engineer Summary

hi-paris/deepdespeckling is tracked as a library record in the SatCom Satellites branch. The source
...
For a systems engineer, hi-paris/deepdespeckling belongs in the SatCom Satellites inventory as part
...
- Latest stable metadata was observed from `https://api.github.com/repos/hi-paris/deepdespeckling/releases/latest` at `2026-09-01T08:26:35+00:00`.
...
- `github_search_satcom_satellites-be45c7133f0d7c` from `github_search_satcom_satellites` as `registry_expansion`
