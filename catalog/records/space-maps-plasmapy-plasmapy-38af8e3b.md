...
| Source record ids | github_search_space_maps-4e9cf218bb05be |
...
For a systems engineer, PlasmaPy/PlasmaPy belongs in the Space Maps inventory as part of language
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_space_maps-4e9cf218bb05be` from `github_search_space_maps` as `registry_expansion`
