...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/statfidelity/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/statfidelity/index.html](https://cran.r-project.org/web/packages/statfidelity/index.html) |
| Source record ids | cran_packages_by_date-6ff8c3a57a5602 |
...
For a systems engineer, statfidelity belongs in the R inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 12:10:08 UTC | [https://cran.r-project.org/web/packages/statfidelity/DESCRIPTION](https://cran.r-project.org/web/packages/statfidelity/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/statfidelity/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-6ff8c3a57a5602` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BKVerify | Security Sast | [open](r-bkverify-2e517280.md) |
| DataAudit | Security Sast | [open](r-dataaudit-3683b0f1.md) |
| dwg2geo | Security Sast | [open](r-dwg2geo-7dafc3d4.md) |
| palettecore | Security Sast | [open](r-palettecore-cac75def.md) |
