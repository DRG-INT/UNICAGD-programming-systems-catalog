...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/vllm-project/vllm](https://github.com/vllm-project/vllm) |
| Source record ids | curated_language_routes-0d26617fad7fa3 |

## System Engineer Summary

High-throughput LLM inference and serving engine with batching, GPU execution, and OpenAI-compatible
server surfaces.

## Operational Role

For a systems engineer, vLLM belongs in the "aim's" inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.28.0 | 2026-08-26T09:46:30Z | [https://api.github.com/repos/vllm-project/vllm/releases/latest](https://api.github.com/repos/vllm-project/vllm/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/vllm-project/vllm/releases/latest` at `2026-09-01T12:30:32+00:00`.
...
- `curated_language_routes-0d26617fad7fa3` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| llama.cpp | Interpreter Runtime | [open](aim-s-llama-cpp-9828c514.md) |
| ONNX Runtime | Interpreter Runtime | [open](aim-s-onnx-runtime-98d3a1c6.md) |
