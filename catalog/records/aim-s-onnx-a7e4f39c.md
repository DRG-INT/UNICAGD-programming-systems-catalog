...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://onnx.ai/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://onnx.ai/](https://onnx.ai/) |
| Source record ids | curated_language_routes-09e88237c0b439 |

## System Engineer Summary

Open Neural Network Exchange format for model interchange, graph serialization, runtimes, and
toolchain compatibility.

## Operational Role

For a systems engineer, ONNX belongs in the "aim's" inventory as part of wire formats, persistence,
...
- `curated_language_routes-09e88237c0b439` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| headroomlabs-ai/headroom | Serialization | [open](aim-s-headroomlabs-ai-headroom-d7859a86.md) |
