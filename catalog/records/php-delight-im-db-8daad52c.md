...
| Canonical URL | [https://packagist.org/packages/delight-im/db](https://packagist.org/packages/delight-im/db) |
| Source record ids | packagist_search-3739f330171a0a |
...
For a systems engineer, delight-im/db belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.5.0 | 2025-05-26T19:42:14+00:00 | [https://repo.packagist.org/p2/delight-im/db.json](https://repo.packagist.org/p2/delight-im/db.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/delight-im/db.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-3739f330171a0a` from `packagist_search` as `registry_expansion`
