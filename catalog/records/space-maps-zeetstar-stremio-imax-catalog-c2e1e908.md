...
<!-- canonical: https://github.com/zeetstar/stremio-imax-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zeetstar/stremio-imax-catalog](https://github.com/zeetstar/stremio-imax-catalog) |
| Source record ids | github_search_space_maps-209d297b352cba |

## System Engineer Summary

A Stremio community addon that helps you discover which movies have IMAX releases. Browse by full-
frame 1.43:1 (Nolan, Dune), expanded 1.90:1 (MCU, Star Wars), or the full library. Catalog only —
pairs with your existing streaming addons.

## Operational Role

For a systems engineer, zeetstar/stremio-imax-catalog belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-23T23:32:12Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-209d297b352cba` from `github_search_space_maps` as `registry_expansion`
