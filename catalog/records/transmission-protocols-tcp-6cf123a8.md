...
<!-- canonical: https://www.rfc-editor.org/rfc/rfc9293.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc9293.html](https://www.rfc-editor.org/rfc/rfc9293.html) |
| Source record ids | curated_language_routes-4968f4457d72b7 |

## System Engineer Summary

Current Transmission Control Protocol specification for reliable byte streams, state machines, and
congestion-aware transport behavior.

## Operational Role

For a systems engineer, TCP belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-4968f4457d72b7` from `curated_language_routes` as `registry_expansion`
