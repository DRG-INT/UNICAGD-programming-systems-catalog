...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/Certara.NLME8/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Certara.NLME8/index.html](https://cran.r-project.org/web/packages/Certara.NLME8/index.html) |
| Source record ids | cran_packages_by_date-c074e2e393da55 |
...
For a systems engineer, Certara.NLME8 belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-09-11 20:20:02 UTC | [https://cran.r-project.org/web/packages/Certara.NLME8/DESCRIPTION](https://cran.r-project.org/web/packages/Certara.NLME8/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Certara.NLME8/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-c074e2e393da55` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| censored | Game Engine Game Dev | [open](r-censored-7cd16838.md) |
| evoFE | Game Engine Game Dev | [open](r-evofe-21bb898e.md) |
| favr | Game Engine Game Dev | [open](r-favr-f965b253.md) |
| glmbayesCore | Game Engine Game Dev | [open](r-glmbayescore-4ea591fe.md) |
| MuTATE | Game Engine Game Dev | [open](r-mutate-ab649532.md) |
| recipes | Game Engine Game Dev | [open](r-recipes-3c2cc0ff.md) |
| RivRetrieve | Game Engine Game Dev | [open](r-rivretrieve-8fe2601b.md) |
| simplermarkdown | Game Engine Game Dev | [open](r-simplermarkdown-0754946e.md) |
