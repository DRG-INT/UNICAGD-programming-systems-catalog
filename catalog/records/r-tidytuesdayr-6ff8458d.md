...
<!-- canonical: https://cran.r-project.org/web/packages/tidytuesdayR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidytuesdayR/index.html](https://cran.r-project.org/web/packages/tidytuesdayR/index.html) |
| Source record ids | cran_packages_by_date-be0e1439c956c6 |
...
For a systems engineer, tidytuesdayR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3 | 2026-09-11 15:20:02 UTC | [https://cran.r-project.org/web/packages/tidytuesdayR/DESCRIPTION](https://cran.r-project.org/web/packages/tidytuesdayR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidytuesdayR/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-be0e1439c956c6` from `cran_packages_by_date` as `registry_expansion`
