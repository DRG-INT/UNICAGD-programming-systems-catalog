...
| Source record ids | github_search_telescopes-0f9dad9bae9829 |
...
For a systems engineer, gammapy/gammapy belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1 | 2026-04-02T13:49:09Z | [https://api.github.com/repos/gammapy/gammapy/releases/latest](https://api.github.com/repos/gammapy/gammapy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gammapy/gammapy/releases/latest` at `2026-09-01T08:26:23+00:00`.
...
- `github_search_telescopes-0f9dad9bae9829` from `github_search_telescopes` as `registry_expansion`
