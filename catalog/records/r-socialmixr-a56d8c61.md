...
<!-- canonical: https://cran.r-project.org/web/packages/socialmixr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/socialmixr/index.html](https://cran.r-project.org/web/packages/socialmixr/index.html) |
| Source record ids | cran_packages_by_date-382ce05f3e7e2f |
...
For a systems engineer, socialmixr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-22 23:20:16 UTC | [https://cran.r-project.org/web/packages/socialmixr/DESCRIPTION](https://cran.r-project.org/web/packages/socialmixr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/socialmixr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-382ce05f3e7e2f` from `cran_packages_by_date` as `registry_expansion`
