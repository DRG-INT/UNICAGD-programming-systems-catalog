...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Fuzzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/fuzzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-a2cc393cc042 |

## System Engineer Summary

AFL++ is tracked as a fuzzer record in the C99 branch. The source did not provide a long
...
For a systems engineer, AFL++ belongs in the C99 inventory as part of input-space exploration,
...
- `master-a2cc393cc042` from `master_json` as `fuzzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| libFuzzer | Fuzzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libfuzzer-26a1d4a0.md) |
