...
<!-- canonical: https://crates.io/crates/value-bag -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/value-bag](https://crates.io/crates/value-bag) |
| Source record ids | crates_io-54f5c9aeb2fed7 |
...
For a systems engineer, value-bag belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.14.1 | 2026-09-01T22:08:19.738990Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-01T22:17:45+00:00`.
...
- `crates_io-54f5c9aeb2fed7` from `crates_io` as `registry_expansion`
