# defcon24bit/record-and-replay-RF-remote
...
<!-- canonical: https://github.com/defcon24bit/record-and-replay-RF-remote -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/defcon24bit/record-and-replay-RF-remote](https://github.com/defcon24bit/record-and-replay-RF-remote) |
| Source record ids | github_search_electromagnetoscopes-aefc8b8e6a4d0b |

## System Engineer Summary

record and replay remote control signal with Raspberry Pi & RTL-SDR dongle (optional) integrate with
Home Assistant, Alexa and Google Home ( radio frequency RF )

## Operational Role

For a systems engineer, defcon24bit/record-and-replay-RF-remote belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-08T13:25:04Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-aefc8b8e6a4d0b` from `github_search_electromagnetoscopes` as `registry_expansion`
