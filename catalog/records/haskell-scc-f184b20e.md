...
<!-- canonical: https://hackage.haskell.org/package/scc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/scc](https://hackage.haskell.org/package/scc) |
| Source record ids | hackage_top_downloads-90c132ac05dc45 |
...
For a systems engineer, scc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4.1 | 2026-01-19T00:43:19Z | [https://hackage.haskell.org/package/scc](https://hackage.haskell.org/package/scc) |  |
| candidate | partial | 0.8.2.1 |  | [https://hackage.haskell.org/package/scc](https://hackage.haskell.org/package/scc) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/scc` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-90c132ac05dc45` from `hackage_top_downloads` as `registry_expansion`
