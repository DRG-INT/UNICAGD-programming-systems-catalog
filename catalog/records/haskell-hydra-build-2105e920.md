...
<!-- canonical: https://hackage.haskell.org/package/hydra-build -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hydra-build](https://hackage.haskell.org/package/hydra-build) |
| Source record ids | hackage_recent-d2ae9863c91198 |
...
For a systems engineer, hydra-build belongs in the Haskell inventory as part of build graph control,
...
- `hackage_recent-d2ae9863c91198` from `hackage_recent` as `registry_expansion`
