...
| Source record ids | master-5c9d4875650a |
...
For a systems engineer, UndefinedBehaviorSanitizer belongs in the C99 inventory as part of ecosystem
...
- `master-5c9d4875650a` from `master_json` as `sanitizer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AddressSanitizer | Sanitizer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-addresssanitizer-16e730f4.md) |
