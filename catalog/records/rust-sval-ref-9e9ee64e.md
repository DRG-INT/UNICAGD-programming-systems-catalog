...
| Canonical URL | [https://crates.io/crates/sval_ref](https://crates.io/crates/sval_ref) |
| Source record ids | crates_io-073e628ed8f2e8 |
...
For a systems engineer, sval_ref belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.22.0 | 2026-08-31T03:44:44.017451Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-073e628ed8f2e8` from `crates_io` as `registry_expansion`
