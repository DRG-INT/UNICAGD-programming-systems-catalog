...
<!-- canonical: https://luarocks.org/modules/gunnar-z/debug.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gunnar-z/debug.lua](https://luarocks.org/modules/gunnar-z/debug.lua) |
| Source record ids | luarocks_root_manifest-d487430b3c7352 |
...
For a systems engineer, debug.lua belongs in the Lua family inventory as part of fault isolation,
...
- `luarocks_root_manifest-d487430b3c7352` from `luarocks_root_manifest` as `registry_expansion`
