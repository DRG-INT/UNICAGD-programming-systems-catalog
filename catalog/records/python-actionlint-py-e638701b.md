...
<!-- canonical: https://pypi.org/project/actionlint-py/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/actionlint-py/](https://pypi.org/project/actionlint-py/) |
| Source record ids | pypi_simple-09117f57048020 |

## System Engineer Summary

Python wrapper around invoking actionlint

## Operational Role

For a systems engineer, actionlint-py belongs in the Python inventory as part of static feedback,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.12.24 | 2026-03-31T06:21:35.015041Z | [https://pypi.org/pypi/actionlint-py/json](https://pypi.org/pypi/actionlint-py/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/actionlint-py/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-09117f57048020` from `pypi_simple` as `registry_expansion`
