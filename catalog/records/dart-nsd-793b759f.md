...
<!-- canonical: https://pub.dev/packages/nsd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/nsd](https://pub.dev/packages/nsd) |
| Source record ids | pub_dev-6be531cbcdb25c |
...
For a systems engineer, nsd belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.1 | 2026-04-04T11:24:09.581954Z | [https://pub.dev/api/packages/nsd](https://pub.dev/api/packages/nsd) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/nsd` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-6be531cbcdb25c` from `pub_dev` as `registry_expansion`
