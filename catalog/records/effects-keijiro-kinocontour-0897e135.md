...
<!-- canonical: https://github.com/keijiro/KinoContour -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keijiro/KinoContour](https://github.com/keijiro/KinoContour) |
| Source record ids | github_search_effects-fd99237ac08bc0 |
...
For a systems engineer, keijiro/KinoContour belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-10-30T02:15:15Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-fd99237ac08bc0` from `github_search_effects` as `registry_expansion`
