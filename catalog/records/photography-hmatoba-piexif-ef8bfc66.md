...
<!-- canonical: https://github.com/hMatoba/Piexif -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hMatoba/Piexif](https://github.com/hMatoba/Piexif) |
| Source record ids | github_search_photography-7a3db36224a2a8 |
...
For a systems engineer, hMatoba/Piexif belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-22T15:55:08Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-7a3db36224a2a8` from `github_search_photography` as `registry_expansion`
