...
<!-- canonical: https://hackage.haskell.org/package/path-io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/path-io](https://hackage.haskell.org/package/path-io) |
| Source record ids | hackage_top_downloads-a91c58c6ef512a |
...
For a systems engineer, path-io belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.2 | 2024-05-20T08:12:23Z | [https://hackage.haskell.org/package/path-io](https://hackage.haskell.org/package/path-io) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/path-io` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-a91c58c6ef512a` from `hackage_top_downloads` as `registry_expansion`
