...
| Source record ids | corpus-e0b44846a16140 |

## System Engineer Summary

LuaInspect is tracked as a static analyzer record in the Lua family branch. The source did not
...
For a systems engineer, LuaInspect belongs in the Lua family inventory as part of defect discovery,
...
- `corpus-e0b44846a16140` from `master_json` as `static_analyzer`
