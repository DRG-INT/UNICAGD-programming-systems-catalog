...
| Canonical URL | [https://packagist.org/packages/ergebnis/composer-normalize](https://packagist.org/packages/ergebnis/composer-normalize) |
| Source record ids | packagist_search-519a9c5113f1a2 |
...
For a systems engineer, ergebnis/composer-normalize belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.52.0 | 2026-05-15T15:39:30+00:00 | [https://repo.packagist.org/p2/ergebnis/composer-normalize.json](https://repo.packagist.org/p2/ergebnis/composer-normalize.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ergebnis/composer-normalize.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-519a9c5113f1a2` from `packagist_search` as `registry_expansion`
