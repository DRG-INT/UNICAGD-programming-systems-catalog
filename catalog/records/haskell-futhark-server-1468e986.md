...
<!-- canonical: https://hackage.haskell.org/package/futhark-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/futhark-server](https://hackage.haskell.org/package/futhark-server) |
| Source record ids | hackage_top_downloads-fe4b6ed11a7f1b |
...
For a systems engineer, futhark-server belongs in the Haskell inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0.0 | 2026-09-08T20:04:13Z | [https://hackage.haskell.org/package/futhark-server](https://hackage.haskell.org/package/futhark-server) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/futhark-server` at `2026-09-10T01:21:04+00:00`.
...
- `hackage_top_downloads-fe4b6ed11a7f1b` from `hackage_top_downloads` as `registry_expansion`
