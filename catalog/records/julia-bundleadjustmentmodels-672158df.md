...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BundleAdjustmentModels](https://github.com/JuliaRegistries/General/tree/master/B/BundleAdjustmentModels) |
| Source record ids | julia_general-890f44c4c35076 |

## System Engineer Summary

Julia package registered in General at B/BundleAdjustmentModels.

## Operational Role

For a systems engineer, BundleAdjustmentModels belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BundleAdjustmentModels", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-890f44c4c35076` from `julia_general` as `registry_expansion`
