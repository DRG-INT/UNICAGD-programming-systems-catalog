...
| Source record ids | github_search_telescopes-7b9f758f6a8d9a |
...
For a systems engineer, jasonsturges/lunarphase-js belongs in the Telescopes inventory as part of
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; ISC License; https://api.github.com/licenses/isc |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-09 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:astronomy stars:>100", "retrieved": "2026-09-09", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-7b9f758f6a8d9a` from `github_search_telescopes` as `registry_expansion`
