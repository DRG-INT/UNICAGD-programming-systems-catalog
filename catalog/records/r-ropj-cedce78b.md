...
<!-- canonical: https://cran.r-project.org/web/packages/Ropj/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Ropj/index.html](https://cran.r-project.org/web/packages/Ropj/index.html) |
| Source record ids | cran_packages_by_date-447948f7c4bb36 |
...
For a systems engineer, Ropj belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3-7 | 2026-08-22 07:30:02 UTC | [https://cran.r-project.org/web/packages/Ropj/DESCRIPTION](https://cran.r-project.org/web/packages/Ropj/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Ropj/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-447948f7c4bb36` from `cran_packages_by_date` as `registry_expansion`
