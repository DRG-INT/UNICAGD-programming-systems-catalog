...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/blackholll/loonflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blackholll/loonflow](https://github.com/blackholll/loonflow) |
| Source record ids | github_search_engines-1654fbbc9c9180 |
...
For a systems engineer, blackholll/loonflow belongs in the Engines inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T12:37:25Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_engines-1654fbbc9c9180` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| anuraghazra/Verly.js | Formatter | [open](engines-anuraghazra-verly-js-1a90fd92.md) |
