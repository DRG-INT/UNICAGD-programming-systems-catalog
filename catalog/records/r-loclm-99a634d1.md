...
<!-- canonical: https://cran.r-project.org/web/packages/loclm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/loclm/index.html](https://cran.r-project.org/web/packages/loclm/index.html) |
| Source record ids | cran_packages_by_date-50b6d9085931ec |

## System Engineer Summary

loclm is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, loclm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-07 16:30:02 UTC | [https://cran.r-project.org/web/packages/loclm/DESCRIPTION](https://cran.r-project.org/web/packages/loclm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/loclm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-50b6d9085931ec` from `cran_packages_by_date` as `registry_expansion`
