...
| Source record ids | corpus-9d030e28119b69 |

## System Engineer Summary

glibc is tracked as a library record in the C99 branch. The source did not provide a long
...
For a systems engineer, glibc belongs in the C99 inventory as part of ecosystem capability mapping,
...
- `corpus-9d030e28119b69` from `master_json` as `library`
