...
<!-- canonical: https://github.com/paulmis/dual-systems -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paulmis/dual-systems](https://github.com/paulmis/dual-systems) |
| Source record ids | github_search_space_maps-5208da6bf50d06 |

## System Engineer Summary

Interactive, strategy-oriented, planetary system map for Dual Universe that enables more interesting
p2p interactions.

## Operational Role

For a systems engineer, paulmis/dual-systems belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-17T03:14:04Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5208da6bf50d06` from `github_search_space_maps` as `registry_expansion`
