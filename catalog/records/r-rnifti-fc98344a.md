...
<!-- canonical: https://cran.r-project.org/web/packages/RNifti/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RNifti/index.html](https://cran.r-project.org/web/packages/RNifti/index.html) |
| Source record ids | cran_packages_by_date-2a3152786539f8 |
...
For a systems engineer, RNifti belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2026-08-20 23:12:14 UTC | [https://cran.r-project.org/web/packages/RNifti/DESCRIPTION](https://cran.r-project.org/web/packages/RNifti/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RNifti/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2a3152786539f8` from `cran_packages_by_date` as `registry_expansion`
