...
<!-- canonical: https://www.npmjs.com/package/yaml-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/yaml-language-server](https://www.npmjs.com/package/yaml-language-server) |
| Source record ids | npm_registry-daf1ef9a7f98e3 |

## System Engineer Summary

yaml-language-server is tracked as a language specification record in the Node.js/JavaScript branch.
...
For a systems engineer, yaml-language-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.24.0 | 2026-07-07T20:01:54.754Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-daf1ef9a7f98e3` from `npm_registry` as `registry_expansion`
