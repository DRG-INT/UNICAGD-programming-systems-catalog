...
<!-- canonical: https://www.unrealengine.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.unrealengine.com/](https://www.unrealengine.com/) |
| Source record ids | curated_language_routes-7122d799b7e304 |

## System Engineer Summary

Commercial-scale real-time 3D engine for games, simulation, virtual production, rendering,
networking, and tools.

## Operational Role

For a systems engineer, Unreal Engine belongs in the Game Engines inventory as part of ecosystem
...
- `curated_language_routes-7122d799b7e304` from `curated_language_routes` as `registry_expansion`
