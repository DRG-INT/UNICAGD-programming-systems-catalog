...
| Canonical URL | [https://crates.io/crates/munge](https://crates.io/crates/munge) |
| Source record ids | crates_io-8a77f24a4dffc6 |
...
For a systems engineer, munge belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.7 | 2025-09-29T14:59:31.928345Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-8a77f24a4dffc6` from `crates_io` as `registry_expansion`
