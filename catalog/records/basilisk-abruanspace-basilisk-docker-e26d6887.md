# abruanspace/basilisk-docker

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/abruanspace/basilisk-docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abruanspace/basilisk-docker](https://github.com/abruanspace/basilisk-docker) |
| Source record ids | github_search_basilisk-c5e25883daf2f9 |

## System Engineer Summary

Dockerized build and deployment environment for the Basilisk astrodynamics simulation framework,
enabling reproducible GN&C simulations across heterogeneous systems.

## Operational Role

For a systems engineer, abruanspace/basilisk-docker belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-24T01:09:05Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-c5e25883daf2f9` from `github_search_basilisk` as `registry_expansion`
