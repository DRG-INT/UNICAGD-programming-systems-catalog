...
<!-- canonical: https://github.com/olric-data/olric -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/olric-data/olric](https://github.com/olric-data/olric) |
| Source record ids | github_search_databases-14e6f9894287d1 |

## System Engineer Summary

Distributed, in-memory key/value store and cache. It can be used as an embedded Go library and a
language-independent service.

## Operational Role

For a systems engineer, olric-data/olric belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T18:34:18Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-14e6f9894287d1` from `github_search_databases` as `registry_expansion`
