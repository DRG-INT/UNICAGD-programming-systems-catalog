...
| Source record ids | corpus-e3fca37149c173 |

## System Engineer Summary

ts-pattern is tracked as an utility library record in the Node.js/TypeScript branch. The source did
...
For a systems engineer, ts-pattern belongs in the Node.js/TypeScript inventory as part of ecosystem
...
- `corpus-e3fca37149c173` from `master_json` as `utility_library`
...
| ts-toolbelt | Utility Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-typescript-ts-toolbelt-5aaa404b.md) |
