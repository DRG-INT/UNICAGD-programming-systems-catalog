...
<!-- canonical: https://crates.io/crates/rend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rend](https://crates.io/crates/rend) |
| Source record ids | crates_io-09eb26e49e525c |
...
For a systems engineer, rend belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4 | 2026-07-02T19:29:05.044252Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-09eb26e49e525c` from `crates_io` as `registry_expansion`
