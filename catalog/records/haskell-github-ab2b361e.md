...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/github -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/github](https://hackage.haskell.org/package/github) |
| Source record ids | hackage_top_downloads-261cf241d894fd |

## System Engineer Summary

Hackage package with 119 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, github belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.0.2 | 2026-03-12T18:53:11Z | [https://hackage.haskell.org/package/github](https://hackage.haskell.org/package/github) |  |
| candidate | partial | 0.12 |  | [https://hackage.haskell.org/package/github](https://hackage.haskell.org/package/github) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/github` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-261cf241d894fd` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crypto-pubkey | Undefined Behavior Analyzer | [open](haskell-crypto-pubkey-dd8079af.md) |
| double-conversion | Undefined Behavior Analyzer | [open](haskell-double-conversion-f4c44962.md) |
| github-backup | Undefined Behavior Analyzer | [open](haskell-github-backup-781e11f0.md) |
| github-release | Undefined Behavior Analyzer | [open](haskell-github-release-419d95ec.md) |
| hruby | Undefined Behavior Analyzer | [open](haskell-hruby-359a7de0.md) |
| kubernetes-api | Undefined Behavior Analyzer | [open](haskell-kubernetes-api-326b53e0.md) |
| monoid-subclasses | Undefined Behavior Analyzer | [open](haskell-monoid-subclasses-175270f0.md) |
| publicsuffix | Undefined Behavior Analyzer | [open](haskell-publicsuffix-6ccdbed9.md) |
