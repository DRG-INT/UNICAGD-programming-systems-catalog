...
<!-- canonical: https://github.com/mas-cli/mas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mas-cli/mas](https://github.com/mas-cli/mas) |
| Source record ids | github_search_swift-d02cadc1961759 |
...
For a systems engineer, mas-cli/mas belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T13:20:08Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-d02cadc1961759` from `github_search_swift` as `registry_expansion`
