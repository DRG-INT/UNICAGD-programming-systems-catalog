...
<!-- canonical: https://luarocks.org/modules/s1m0n38/claude.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/s1m0n38/claude.nvim](https://luarocks.org/modules/s1m0n38/claude.nvim) |
| Source record ids | luarocks_root_manifest-d7c7698bd32b07 |

## System Engineer Summary

Simiple claude code integration

## Operational Role

For a systems engineer, claude.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d7c7698bd32b07` from `luarocks_root_manifest` as `registry_expansion`
