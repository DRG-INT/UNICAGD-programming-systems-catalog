...
<!-- canonical: https://github.com/kuzudb/kuzu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kuzudb/kuzu](https://github.com/kuzudb/kuzu) |
| Source record ids | github_search_databases-488d1ab796855d |

## System Engineer Summary

Embedded property graph database built for speed. Vector search and full-text search built in.
Implements Cypher.

## Operational Role

For a systems engineer, kuzudb/kuzu belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-10T15:34:00Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_databases-488d1ab796855d` from `github_search_databases` as `registry_expansion`
