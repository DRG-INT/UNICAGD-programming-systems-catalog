...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Package Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/package-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@vltpkg/security-archive](https://www.npmjs.com/package/@vltpkg/security-archive) |
| Source record ids | npm_registry-3712e74d6d6619 |
...
For a systems engineer, @vltpkg/security-archive belongs in the Node.js/JavaScript inventory as part
of dependency acquisition, lockfile policy, provenance control, and supply-chain monitoring.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.7 | 2026-08-28T20:46:36.667Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @aptos-labs/aptos-cli | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aptos-labs-aptos-cli-8128fa9d.md) |
| @azure/core-rest-pipeline | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-azure-core-rest-pipeline-23affe2b.md) |
| @chanzuckerberg/axe-storybook-testing | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-chanzuckerberg-axe-storybook-testing-e02a0405.md) |
| @dxos/echo-pipeline | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-dxos-echo-pipeline-dabf82d1.md) |
| @jmondi/oauth2-server | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-jmondi-oauth2-server-cbd685de.md) |
| @npm-questionpro/wick-ui-prettier-config | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-npm-questionpro-wick-ui-prettier-config-edd1ae3d.md) |
| @npmcli/agent | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-npmcli-agent-e5009f29.md) |
| @npmcli/config | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-npmcli-config-2b941ed1.md) |
