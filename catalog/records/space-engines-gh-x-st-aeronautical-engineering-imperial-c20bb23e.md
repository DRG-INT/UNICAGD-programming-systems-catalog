# GH-X-ST/Aeronautical-Engineering-Imperial

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GH-X-ST/Aeronautical-Engineering-Imperial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GH-X-ST/Aeronautical-Engineering-Imperial](https://github.com/GH-X-ST/Aeronautical-Engineering-Imperial) |
| Source record ids | github_search_space_engines-103b1a72c550e7 |
...
For a systems engineer, GH-X-ST/Aeronautical-Engineering-Imperial belongs in the Space Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T15:10:12Z | gh search repos topic:propulsion stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-103b1a72c550e7` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Conquer-Space/Conquer-Space | Game Engine Game Dev | [open](space-engines-conquer-space-conquer-space-3ac38eeb.md) |
