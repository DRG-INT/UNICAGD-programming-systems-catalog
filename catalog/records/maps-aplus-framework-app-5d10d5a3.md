...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aplus-framework/app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aplus-framework/app](https://github.com/aplus-framework/app) |
| Source record ids | github_search_maps-b6394e4b9bf98e |
...
For a systems engineer, aplus-framework/app belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T18:58:25Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-b6394e4b9bf98e` from `github_search_maps` as `registry_expansion`
