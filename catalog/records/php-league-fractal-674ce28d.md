...
<!-- canonical: https://packagist.org/packages/league/fractal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/league/fractal](https://packagist.org/packages/league/fractal) |
| Source record ids | packagist_search-ccf32ac1e180bb |
...
For a systems engineer, league/fractal belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-ccf32ac1e180bb` from `packagist_search` as `registry_expansion`
