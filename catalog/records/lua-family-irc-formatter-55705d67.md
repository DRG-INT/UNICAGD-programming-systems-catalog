...
| Canonical URL | [https://luarocks.org/modules/jprjr/irc-formatter](https://luarocks.org/modules/jprjr/irc-formatter) |
| Source record ids | luarocks_root_manifest-fc90d94c0cbbce |
...
For a systems engineer, irc-formatter belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-fc90d94c0cbbce` from `luarocks_root_manifest` as `registry_expansion`
