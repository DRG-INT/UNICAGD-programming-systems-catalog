...
<!-- canonical: https://github.com/airbnb/swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/airbnb/swift](https://github.com/airbnb/swift) |
| Source record ids | awesome_list-d2e5aca74afec2 |
...
For a systems engineer, Airbnb belongs in the Swift inventory as part of ecosystem capability
...
- `awesome_list-d2e5aca74afec2` from `awesome_list` as `registry_expansion`
