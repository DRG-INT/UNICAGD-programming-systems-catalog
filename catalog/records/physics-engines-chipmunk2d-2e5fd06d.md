...
<!-- canonical: https://github.com/slembcke/Chipmunk2D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/slembcke/Chipmunk2D](https://github.com/slembcke/Chipmunk2D) |
| Source record ids | curated_language_routes-77aac5421a8695 |

## System Engineer Summary

Lightweight 2D physics engine for games and interactive simulations.

## Operational Role

For a systems engineer, Chipmunk2D belongs in the Physics Engines inventory as part of ecosystem
...
- `curated_language_routes-77aac5421a8695` from `curated_language_routes` as `registry_expansion`
