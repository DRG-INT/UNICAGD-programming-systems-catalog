...
<!-- canonical: https://github.com/xiaolincoder/CS-Base -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xiaolincoder/CS-Base](https://github.com/xiaolincoder/CS-Base) |
| Source record ids | github_search_go-838a4acd815771 |
...
For a systems engineer, xiaolincoder/CS-Base belongs in the Go inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-27T06:32:13Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-838a4acd815771` from `github_search_go` as `registry_expansion`
