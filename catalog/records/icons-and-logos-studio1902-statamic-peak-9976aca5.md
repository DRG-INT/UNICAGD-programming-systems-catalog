...
<!-- canonical: https://github.com/studio1902/statamic-peak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/studio1902/statamic-peak](https://github.com/studio1902/statamic-peak) |
| Source record ids | github_search_icons_and_logos-f8ba4cd6a4ba3d |
...
For a systems engineer, studio1902/statamic-peak belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T11:45:58Z | gh search repos topic:favicons stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-f8ba4cd6a4ba3d` from `github_search_icons_and_logos` as `registry_expansion`
