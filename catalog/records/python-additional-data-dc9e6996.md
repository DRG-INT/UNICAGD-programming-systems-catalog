...
<!-- canonical: https://pypi.org/project/additional-data/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/additional-data/](https://pypi.org/project/additional-data/) |
| Source record ids | pypi_simple-45a7ffc10545e9 |

## System Engineer Summary

Simple library for reading and writing additional data files

## Operational Role

For a systems engineer, additional-data belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1.1 | 2019-02-21T10:40:08.411526Z | [https://pypi.org/pypi/additional-data/json](https://pypi.org/pypi/additional-data/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/additional-data/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-45a7ffc10545e9` from `pypi_simple` as `registry_expansion`
