...
| Canonical URL | [https://luarocks.org/modules/erento/erento-lua-rfc-4122-uuid-generator](https://luarocks.org/modules/erento/erento-lua-rfc-4122-uuid-generator) |
| Source record ids | luarocks_root_manifest-5cf1e4f4df980b |

## System Engineer Summary

Pure Lua Implementation of RFC 4122-compliant v4 pseudorandom UUID generator.

## Operational Role

For a systems engineer, erento-LUA-RFC-4122-UUID-Generator belongs in the Lua family inventory as
...
- `luarocks_root_manifest-5cf1e4f4df980b` from `luarocks_root_manifest` as `registry_expansion`
