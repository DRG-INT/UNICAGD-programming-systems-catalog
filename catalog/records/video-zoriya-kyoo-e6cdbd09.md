...
<!-- canonical: https://github.com/zoriya/Kyoo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zoriya/Kyoo](https://github.com/zoriya/Kyoo) |
| Source record ids | github_search_video-4ea28184487d85 |
...
For a systems engineer, zoriya/Kyoo belongs in the Video inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T08:53:47Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-4ea28184487d85` from `github_search_video` as `registry_expansion`
