...
<!-- canonical: https://hackage.haskell.org/package/antiope-sqs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/antiope-sqs](https://hackage.haskell.org/package/antiope-sqs) |
| Source record ids | hackage_top_downloads-e9c1d8223cd51d |
...
For a systems engineer, antiope-sqs belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.5.3 | 2020-10-22T11:56:15Z | [https://hackage.haskell.org/package/antiope-sqs](https://hackage.haskell.org/package/antiope-sqs) |  |
| candidate | partial | 7.0.1 |  | [https://hackage.haskell.org/package/antiope-sqs](https://hackage.haskell.org/package/antiope-sqs) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/antiope-sqs` at `2026-09-01T07:23:59+00:00`.
...
- `hackage_top_downloads-e9c1d8223cd51d` from `hackage_top_downloads` as `registry_expansion`
