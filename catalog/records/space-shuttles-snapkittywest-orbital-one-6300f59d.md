# SNAPKITTYWEST/orbital-one

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SNAPKITTYWEST/orbital-one -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SNAPKITTYWEST/orbital-one](https://github.com/SNAPKITTYWEST/orbital-one) |
| Source record ids | github_search_space_shuttles-3ffb15e1977a5d |

## System Engineer Summary

orbital-one — browser spacecraft simulator + headless flight-model SDK. TypeScript, Three.js, zero-
dependency sim engine (state/physics/guidance/navigation/propulsion/mission/telemetry/math).

## Operational Role

For a systems engineer, SNAPKITTYWEST/orbital-one belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T15:47:58Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-3ffb15e1977a5d` from `github_search_space_shuttles` as `registry_expansion`
