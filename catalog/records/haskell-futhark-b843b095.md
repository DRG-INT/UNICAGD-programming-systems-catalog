...
<!-- canonical: https://hackage.haskell.org/package/futhark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/futhark](https://hackage.haskell.org/package/futhark) |
| Source record ids | hackage_top_downloads-5fa605307f4f29 |

## System Engineer Summary

Hackage package with 471 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, futhark belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.27.1 | 2026-08-19T12:15:41Z | [https://hackage.haskell.org/package/futhark](https://hackage.haskell.org/package/futhark) |  |
| candidate | partial | 0.7.3 |  | [https://hackage.haskell.org/package/futhark](https://hackage.haskell.org/package/futhark) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/futhark` at `2026-09-01T07:24:01+00:00`.
...
- `hackage_top_downloads-5fa605307f4f29` from `hackage_top_downloads` as `registry_expansion`
