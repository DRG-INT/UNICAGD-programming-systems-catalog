...
<!-- canonical: https://packagist.org/packages/php-http/logger-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/logger-plugin](https://packagist.org/packages/php-http/logger-plugin) |
| Source record ids | packagist_search-72ce22d0d50655 |
...
For a systems engineer, php-http/logger-plugin belongs in the PHP inventory as part of service
...
- `packagist_search-72ce22d0d50655` from `packagist_search` as `registry_expansion`
