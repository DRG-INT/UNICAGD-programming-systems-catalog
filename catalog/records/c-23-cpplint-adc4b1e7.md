...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Linter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/linter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-8ed6c1d6fae928 |

## System Engineer Summary

cpplint is tracked as a linter record in the C++23 branch. The source did not provide a long
...
For a systems engineer, cpplint belongs in the C++23 inventory as part of static feedback, style
...
- `corpus-8ed6c1d6fae928` from `master_json` as `linter`
