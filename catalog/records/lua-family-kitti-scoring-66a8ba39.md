...
| Canonical URL | [https://luarocks.org/modules/joelschlosser/kitti_scoring](https://luarocks.org/modules/joelschlosser/kitti_scoring) |
| Source record ids | luarocks_root_manifest-75386e33e2450a |

## System Engineer Summary

kitti_scoring is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, kitti_scoring belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-75386e33e2450a` from `luarocks_root_manifest` as `registry_expansion`
