...
<!-- canonical: https://www.nuget.org/packages/JsonConverter.Newtonsoft.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/JsonConverter.Newtonsoft.Json](https://www.nuget.org/packages/JsonConverter.Newtonsoft.Json) |
| Source record ids | nuget_search-5ffce607049e9d |
...
For a systems engineer, JsonConverter.Newtonsoft.Json belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-06-07T19:06:17.04+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.newtonsoft.json/index.json) |  |
| preview | known | 0.0.1-preview-01 | 2022-08-13T07:55:17.19+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.newtonsoft.json/index.json) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT; https://www.nuget.org/packages/JsonConverter.Newtonsoft.Json/0.13.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/jsonconverter.newtonsoft.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-5ffce607049e9d` from `nuget_search` as `registry_expansion`
