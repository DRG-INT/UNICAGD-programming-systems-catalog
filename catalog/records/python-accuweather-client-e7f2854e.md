...
<!-- canonical: https://pypi.org/project/accuweather-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accuweather-client/](https://pypi.org/project/accuweather-client/) |
| Source record ids | pypi_simple-d0c844b191ca17 |

## System Engineer Summary

Human-friendly, typed AccuWeather API client: weather by city name, POI or coordinates, with sync +
async clients and a CLI.

## Operational Role

For a systems engineer, accuweather-client belongs in the Python inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-07-31T20:08:05.463808Z | [https://pypi.org/pypi/accuweather-client/json](https://pypi.org/pypi/accuweather-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accuweather-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-d0c844b191ca17` from `pypi_simple` as `registry_expansion`
