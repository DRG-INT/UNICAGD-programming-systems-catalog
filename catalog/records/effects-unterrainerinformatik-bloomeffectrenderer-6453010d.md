...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/UnterrainerInformatik/BloomEffectRenderer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/UnterrainerInformatik/BloomEffectRenderer](https://github.com/UnterrainerInformatik/BloomEffectRenderer) |
| Source record ids | github_search_effects-8ca18de5383ab4 |

## System Engineer Summary

This is a PCL library for MonoGame. It uses your local MG installation and provides an easy way to
render a bloom-post-process-effect from and to any RenderTarget you like.

## Operational Role

For a systems engineer, UnterrainerInformatik/BloomEffectRenderer belongs in the Effects inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2020-01-18T23:00:33Z | [https://api.github.com/repos/UnterrainerInformatik/BloomEffectRenderer/releases/latest](https://api.github.com/repos/UnterrainerInformatik/BloomEffectRenderer/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/UnterrainerInformatik/BloomEffectRenderer/releases/latest` at `2026-09-01T09:23:14+00:00`.
...
- `github_search_effects-8ca18de5383ab4` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AcademySoftwareFoundation/OpenImageIO | Formatter | [open](effects-academysoftwarefoundation-openimageio-0013edc0.md) |
| AcademySoftwareFoundation/OpenTimelineIO | Formatter | [open](effects-academysoftwarefoundation-opentimelineio-3fcbc8e9.md) |
| AmitDigga/threejs-galaxy-shader | Formatter | [open](effects-amitdigga-threejs-galaxy-shader-29702c73.md) |
| blackout1471/AmpStudio | Formatter | [open](effects-blackout1471-ampstudio-a1b4a947.md) |
| Frikallo/SonicSynth | Formatter | [open](effects-frikallo-sonicsynth-5f25bf87.md) |
| HalbFettKaese/ShaderSelectorV3 | Formatter | [open](effects-halbfettkaese-shaderselectorv3-85677bef.md) |
| hasnain7abbas/gargantua-blackhole | Formatter | [open](effects-hasnain7abbas-gargantua-blackhole-6026f2a1.md) |
| indieshade/Unity_Shader_Library_Zoroiscrying | Formatter | [open](effects-indieshade-unity-shader-library-zoroiscrying-35c86291.md) |
