...
<!-- canonical: https://pub.dev/packages/ansicolor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ansicolor](https://pub.dev/packages/ansicolor) |
| Source record ids | pub_dev-8b5bbad13941df |

## System Engineer Summary

Looking to add some color to your terminal logs? `ansicolor` is an xterm-256 color support library
that lets you change the foreground and background color of your text.

## Operational Role

For a systems engineer, ansicolor belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2024-08-12T15:02:37.568435Z | [https://pub.dev/api/packages/ansicolor](https://pub.dev/api/packages/ansicolor) |  |
| preview | known | 2.0.0-nullsafety.0 | 2020-11-21T19:34:59.797173Z | [https://pub.dev/api/packages/ansicolor](https://pub.dev/api/packages/ansicolor) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ansicolor` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-8b5bbad13941df` from `pub_dev` as `registry_expansion`
...
| very_good_cli | Cli | [open](dart-very-good-cli-30812194.md) |
