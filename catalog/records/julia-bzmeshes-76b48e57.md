...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BZMeshes](https://github.com/JuliaRegistries/General/tree/master/B/BZMeshes) |
| Source record ids | julia_general-11aee494879413 |

## System Engineer Summary

Julia package registered in General at B/BZMeshes.

## Operational Role

For a systems engineer, BZMeshes belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BZMeshes", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-11aee494879413` from `julia_general` as `registry_expansion`
