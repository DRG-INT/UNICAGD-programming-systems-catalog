...
<!-- canonical: https://crates.io/crates/enum-as-inner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enum-as-inner](https://crates.io/crates/enum-as-inner) |
| Source record ids | crates_io-1572417a4a52dc |
...
For a systems engineer, enum-as-inner belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-02-02T05:05:11.471053Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-1572417a4a52dc` from `crates_io` as `registry_expansion`
