...
<!-- canonical: https://github.com/nasa/pyDownlinkParser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nasa/pyDownlinkParser](https://github.com/nasa/pyDownlinkParser) |
| Source record ids | github_search_satcom_satellites-c12f494c5c489d |

## System Engineer Summary

Parse downlinks binary file following CCSDS standard, primarily for Europa-Clipper Science Data
System.

## Operational Role

For a systems engineer, nasa/pyDownlinkParser belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-01T21:37:49Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-c12f494c5c489d` from `github_search_satcom_satellites` as `registry_expansion`
