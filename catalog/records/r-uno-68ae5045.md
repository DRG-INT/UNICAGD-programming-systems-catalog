...
<!-- canonical: https://cran.r-project.org/web/packages/Uno/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Uno/index.html](https://cran.r-project.org/web/packages/Uno/index.html) |
| Source record ids | cran_packages_by_date-e2d6c7a52a73dd |
...
For a systems engineer, Uno belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.4-1 | 2026-08-30 14:10:18 UTC | [https://cran.r-project.org/web/packages/Uno/DESCRIPTION](https://cran.r-project.org/web/packages/Uno/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Uno/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e2d6c7a52a73dd` from `cran_packages_by_date` as `registry_expansion`
