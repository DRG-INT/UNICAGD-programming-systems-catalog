...
<!-- canonical: https://github.com/keplerproject -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keplerproject](https://github.com/keplerproject) |
| Source record ids | lua-source-156 |
...
For a systems engineer, Kepler Project belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 156}}` |
...
- `lua-source-156` from `master_json` as `source_list_item`
