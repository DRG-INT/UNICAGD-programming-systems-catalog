...
<!-- canonical: http://www.lua.org/gems/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://www.lua.org/gems/](http://www.lua.org/gems/) |
| Source record ids | lua-source-410 |

## System Engineer Summary

A collection of articles covering existing wisdom and practices on programming well in Lua, in a
broad variety of use cases.

## Operational Role

For a systems engineer, Programming Gems belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 410}}` |
...
- `lua-source-410` from `master_json` as `source_list_item`
