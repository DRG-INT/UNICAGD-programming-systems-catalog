...
<!-- canonical: https://cran.r-project.org/web/packages/stt.api/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stt.api/index.html](https://cran.r-project.org/web/packages/stt.api/index.html) |
| Source record ids | cran_packages_by_date-d5630745cb51ef |
...
For a systems engineer, stt.api belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-04 22:40:02 UTC | [https://cran.r-project.org/web/packages/stt.api/DESCRIPTION](https://cran.r-project.org/web/packages/stt.api/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stt.api/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d5630745cb51ef` from `cran_packages_by_date` as `registry_expansion`
