...
<!-- canonical: https://www.npmjs.com/package/@cap-js/mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@cap-js/mcp-server](https://www.npmjs.com/package/@cap-js/mcp-server) |
| Source record ids | npm_registry-c02812b51763ce |
...
For a systems engineer, @cap-js/mcp-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5 | 2026-04-27T10:04:39.260Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-c02812b51763ce` from `npm_registry` as `registry_expansion`
