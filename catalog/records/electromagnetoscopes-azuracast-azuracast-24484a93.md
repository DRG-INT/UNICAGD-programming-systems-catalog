...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AzuraCast/AzuraCast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AzuraCast/AzuraCast](https://github.com/AzuraCast/AzuraCast) |
| Source record ids | github_search_electromagnetoscopes-ae0747351a9a51 |

## System Engineer Summary

A self-hosted web radio management suite, including turnkey installer tools for the full radio
software stack and a modern, easy-to-use web app to manage your stations.

## Operational Role

For a systems engineer, AzuraCast/AzuraCast belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T11:44:59Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_electromagnetoscopes-ae0747351a9a51` from `github_search_electromagnetoscopes` as `registry_expansion`
