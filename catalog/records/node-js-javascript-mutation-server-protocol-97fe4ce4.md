...
<!-- canonical: https://www.npmjs.com/package/mutation-server-protocol -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mutation-server-protocol](https://www.npmjs.com/package/mutation-server-protocol) |
| Source record ids | npm_registry-2ddcf2c3902193 |
...
For a systems engineer, mutation-server-protocol belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-01-16T13:56:25.257Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-2ddcf2c3902193` from `npm_registry` as `registry_expansion`
