...
<!-- canonical: https://github.com/sqlmapproject/sqlmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sqlmapproject/sqlmap](https://github.com/sqlmapproject/sqlmap) |
| Source record ids | github_search_databases-2229870d0af028 |
...
For a systems engineer, sqlmapproject/sqlmap belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:51:26Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-2229870d0af028` from `github_search_databases` as `registry_expansion`
