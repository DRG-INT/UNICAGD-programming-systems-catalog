...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Game Engine Game Dev](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/game-engine-game-dev.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AlgamesDriving](https://github.com/JuliaRegistries/General/tree/master/A/AlgamesDriving) |
| Source record ids | julia_general-12a94784334434 |

## System Engineer Summary

Julia package registered in General at A/AlgamesDriving.

## Operational Role

For a systems engineer, AlgamesDriving belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| AdvRBMs | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-advrbms-8875b487.md) |
| Algames | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-algames-756e1995.md) |
| avr_binutils_jll | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-avr-binutils-jll-27c11a9c.md) |
| avrdude_jll | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-avrdude-jll-38e928d4.md) |
| Avro | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-avro-18c94e70.md) |
| Avro_jll | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-avro-jll-784929fb.md) |
| AvrutinSearch | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-avrutinsearch-91dfb19d.md) |
| BoardGameGeek | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-boardgamegeek-79d8bb9a.md) |
