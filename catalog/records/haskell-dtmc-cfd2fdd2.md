...
<!-- canonical: https://hackage.haskell.org/package/dtmc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dtmc](https://hackage.haskell.org/package/dtmc) |
| Source record ids | hackage_recent-3dac3a6b541303 |

## System Engineer Summary

Hackage package recently uploaded by arkadiikholmetskii.

## Operational Role

For a systems engineer, dtmc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-09-07T20:16:38Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-07T20:19:53+00:00`.
...
- `hackage_recent-3dac3a6b541303` from `hackage_recent` as `registry_expansion`
