...
<!-- canonical: https://cran.r-project.org/web/packages/glmbayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmbayes/index.html](https://cran.r-project.org/web/packages/glmbayes/index.html) |
| Source record ids | cran_packages_by_date-44e493bf39e238 |
...
For a systems engineer, glmbayes belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.75 | 2026-08-04 19:20:02 UTC | [https://cran.r-project.org/web/packages/glmbayes/DESCRIPTION](https://cran.r-project.org/web/packages/glmbayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmbayes/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-44e493bf39e238` from `cran_packages_by_date` as `registry_expansion`
