...
<!-- canonical: https://packagist.org/packages/jwadhams/json-logic-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jwadhams/json-logic-php](https://packagist.org/packages/jwadhams/json-logic-php) |
| Source record ids | packagist_search-0d0050b35a857a |

## System Engineer Summary

Build rules with complex comparisons and boolean operators, serialized as JSON, and execute them in
PHP

## Operational Role

For a systems engineer, jwadhams/json-logic-php belongs in the PHP inventory as part of build graph
...
- `packagist_search-0d0050b35a857a` from `packagist_search` as `registry_expansion`
