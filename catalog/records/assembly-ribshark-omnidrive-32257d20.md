...
| Canonical URL | [https://github.com/RibShark/OmniDrive](https://github.com/RibShark/OmniDrive) |
| Source record ids | github_search_assembly-115cb9a0278f31 |

## System Engineer Summary

RibShark/OmniDrive is tracked as a language specification record in the Assembly branch. The source
...
For a systems engineer, RibShark/OmniDrive belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.4 | 2026-07-18T06:48:57Z | [https://api.github.com/repos/RibShark/OmniDrive/releases/latest](https://api.github.com/repos/RibShark/OmniDrive/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/RibShark/OmniDrive/releases/latest` at `2026-09-01T07:24:29+00:00`.
...
- `github_search_assembly-115cb9a0278f31` from `github_search_assembly` as `registry_expansion`
