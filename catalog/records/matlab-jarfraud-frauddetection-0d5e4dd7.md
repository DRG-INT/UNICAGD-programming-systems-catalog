...
<!-- canonical: https://github.com/JarFraud/FraudDetection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JarFraud/FraudDetection](https://github.com/JarFraud/FraudDetection) |
| Source record ids | github_search_matlab-3273428c5d2814 |
...
For a systems engineer, JarFraud/FraudDetection belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-31T02:54:52Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-3273428c5d2814` from `github_search_matlab` as `registry_expansion`
