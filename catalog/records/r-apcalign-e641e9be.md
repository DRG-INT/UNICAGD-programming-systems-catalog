...
<!-- canonical: https://cran.r-project.org/web/packages/APCalign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/APCalign/index.html](https://cran.r-project.org/web/packages/APCalign/index.html) |
| Source record ids | cran_packages_by_date-c73219de45fb58 |
...
For a systems engineer, APCalign belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-09-09 07:40:27 UTC | [https://cran.r-project.org/web/packages/APCalign/DESCRIPTION](https://cran.r-project.org/web/packages/APCalign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/APCalign/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-c73219de45fb58` from `cran_packages_by_date` as `registry_expansion`
