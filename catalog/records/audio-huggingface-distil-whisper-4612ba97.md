...
<!-- canonical: https://github.com/huggingface/distil-whisper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/huggingface/distil-whisper](https://github.com/huggingface/distil-whisper) |
| Source record ids | github_search_audio-6595e17da3724a |
...
For a systems engineer, huggingface/distil-whisper belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-08T10:09:47Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-6595e17da3724a` from `github_search_audio` as `registry_expansion`
