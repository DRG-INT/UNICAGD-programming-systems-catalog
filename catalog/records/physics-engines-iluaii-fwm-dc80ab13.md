...
<!-- canonical: https://github.com/iluaii/fwm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iluaii/fwm](https://github.com/iluaii/fwm) |
| Source record ids | github_search_physics_engines-32e0d4e074c1e9 |

## System Engineer Summary

Wayland compositor in C/wlroots where windows are physical objects (real Box2D rigid bodies) — and a
full desktop besides: ten desktops on one scrolling world, tiling or floating per desktop, launcher,
expo, screenshots, mixer and visualiser built in, live IPC. Legacy X11 version on the x11 branch.

## Operational Role

For a systems engineer, iluaii/fwm belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:45:18Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-32e0d4e074c1e9` from `github_search_physics_engines` as `registry_expansion`
...
| victorfisac/Physac | Ide Editor Integration | [open](physics-engines-victorfisac-physac-872bee73.md) |
