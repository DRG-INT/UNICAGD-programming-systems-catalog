...
<!-- canonical: https://github.com/skx/kpie -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skx/kpie](https://github.com/skx/kpie) |
| Source record ids | lua-source-347 |
...
For a systems engineer, kpie belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 347}}` |
...
- `lua-source-347` from `master_json` as `source_list_item`
