# mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect
...
<!-- canonical: https://github.com/mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect](https://github.com/mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect) |
| Source record ids | github_search_effects-e7ce4fc7e07749 |

## System Engineer Summary

This unity shader effect was ported to work on uniity HDRP Pipeline. It is more like a glitch shader
effect for artistic purposes.

## Operational Role

For a systems engineer, mbelyavsky/Unity-HDRP-JPEG-MP4-Compression-PostProcessing-Effect belongs in
the Effects inventory as part of dependency acquisition, lockfile policy, provenance control, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-06T12:47:27Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e7ce4fc7e07749` from `github_search_effects` as `registry_expansion`
