...
<!-- canonical: https://cran.r-project.org/web/packages/evalHTE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/evalHTE/index.html](https://cran.r-project.org/web/packages/evalHTE/index.html) |
| Source record ids | cran_packages_by_date-feaed15b35ec60 |
...
For a systems engineer, evalHTE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-07 08:30:02 UTC | [https://cran.r-project.org/web/packages/evalHTE/DESCRIPTION](https://cran.r-project.org/web/packages/evalHTE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/evalHTE/DESCRIPTION` at `2026-09-07T10:20:49+00:00`.
...
- `cran_packages_by_date-feaed15b35ec60` from `cran_packages_by_date` as `registry_expansion`
