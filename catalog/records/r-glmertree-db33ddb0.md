...
<!-- canonical: https://cran.r-project.org/web/packages/glmertree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmertree/index.html](https://cran.r-project.org/web/packages/glmertree/index.html) |
| Source record ids | cran_packages_by_date-6125bcda9ab7d7 |
...
For a systems engineer, glmertree belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2-7 | 2026-08-21 11:10:10 UTC | [https://cran.r-project.org/web/packages/glmertree/DESCRIPTION](https://cran.r-project.org/web/packages/glmertree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmertree/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6125bcda9ab7d7` from `cran_packages_by_date` as `registry_expansion`
