...
<!-- canonical: https://pub.dev/packages/beamer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/beamer](https://pub.dev/packages/beamer) |
| Source record ids | pub_dev-0b99ef6e8d059e |

## System Engineer Summary

A routing package built on top of Router and Navigator's pages API, supporting arbitrary nested
navigation, guards and more.

## Operational Role

For a systems engineer, beamer belongs in the Dart inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0 | 2024-10-08T20:45:02.640302Z | [https://pub.dev/api/packages/beamer](https://pub.dev/api/packages/beamer) |  |
| preview | known | 2.0.0-dev.1 | 2024-03-09T22:12:21.460059Z | [https://pub.dev/api/packages/beamer](https://pub.dev/api/packages/beamer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/beamer` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-0b99ef6e8d059e` from `pub_dev` as `registry_expansion`
