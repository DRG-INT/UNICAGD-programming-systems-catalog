...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/fitoprincipe/geetools-code-editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fitoprincipe/geetools-code-editor](https://github.com/fitoprincipe/geetools-code-editor) |
| Source record ids | github_search_radars-bb2f02f10255b9 |
...
For a systems engineer, fitoprincipe/geetools-code-editor belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-02T23:06:19Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-bb2f02f10255b9` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ashuttl/linecast | Ide Editor Integration | [open](radars-ashuttl-linecast-afb4bdb7.md) |
| bellingcat/sar-interference-tracker | Ide Editor Integration | [open](radars-bellingcat-sar-interference-tracker-8efa36c7.md) |
| bellingcat/umbra-open-data-tracker | Ide Editor Integration | [open](radars-bellingcat-umbra-open-data-tracker-b56dce91.md) |
| ChenHongruixuan/ChangeDetectionRepository | Ide Editor Integration | [open](radars-chenhongruixuan-changedetectionrepository-b7588393.md) |
| CyanideCN/PyCINRAD | Ide Editor Integration | [open](radars-cyanidecn-pycinrad-fe2b1f00.md) |
| kbhujbal/Trident-synthetic_aperture_radar_maritime_vessel_detection_yolov8 | Ide Editor Integration | [open](radars-kbhujbal-trident-synthetic-aperture-radar-maritime-vessel-detection-yolov8-84b83c31.md) |
| manideep2510/eye-in-the-sky | Ide Editor Integration | [open](radars-manideep2510-eye-in-the-sky-f8be2776.md) |
| prouast/heartbeat | Ide Editor Integration | [open](radars-prouast-heartbeat-323ff4b9.md) |
