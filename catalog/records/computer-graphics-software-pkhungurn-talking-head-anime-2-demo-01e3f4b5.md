...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pkhungurn/talking-head-anime-2-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pkhungurn/talking-head-anime-2-demo](https://github.com/pkhungurn/talking-head-anime-2-demo) |
| Source record ids | github_search_computer_graphics_software-8ebfee5b1173bd |
...
For a systems engineer, pkhungurn/talking-head-anime-2-demo belongs in the Computer Graphics
Software inventory as part of request routing, middleware policy, service structure, and deployment
surface.
...
- `github_search_computer_graphics_software-8ebfee5b1173bd` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| termux/termux-x11 | Web Framework | [open](computer-graphics-software-termux-termux-x11-a9d6e86c.md) |
