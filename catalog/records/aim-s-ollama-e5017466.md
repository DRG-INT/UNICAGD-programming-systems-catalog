...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ollama/ollama -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ollama/ollama](https://github.com/ollama/ollama) |
| Source record ids | curated_language_routes-15ca7ceef92d32 |

## System Engineer Summary

Local model runner and service for packaging, serving, and operating LLMs on developer and server
machines.

## Operational Role

For a systems engineer, Ollama belongs in the "aim's" inventory as part of ecosystem capability
...
- `curated_language_routes-15ca7ceef92d32` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| esengine/DeepSeek-Reasonix | Cli | [open](aim-s-esengine-deepseek-reasonix-88239b13.md) |
| feder-cr/AIHawk | Cli | [open](aim-s-feder-cr-aihawk-d86efbac.md) |
| QwenLM/qwen-code | Cli | [open](aim-s-qwenlm-qwen-code-59e3d415.md) |
