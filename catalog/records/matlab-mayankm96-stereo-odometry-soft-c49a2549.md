...
<!-- canonical: https://github.com/Mayankm96/Stereo-Odometry-SOFT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mayankm96/Stereo-Odometry-SOFT](https://github.com/Mayankm96/Stereo-Odometry-SOFT) |
| Source record ids | github_search_matlab-457557285b13c5 |
...
For a systems engineer, Mayankm96/Stereo-Odometry-SOFT belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-11-23T17:37:38Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-457557285b13c5` from `github_search_matlab` as `registry_expansion`
