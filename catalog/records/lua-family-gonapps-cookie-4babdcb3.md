...
| Canonical URL | [https://luarocks.org/modules/gonapps/gonapps-cookie](https://luarocks.org/modules/gonapps/gonapps-cookie) |
| Source record ids | luarocks_root_manifest-dcb59971917eb8 |

## System Engineer Summary

gonapps-cookie is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, gonapps-cookie belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-dcb59971917eb8` from `luarocks_root_manifest` as `registry_expansion`
