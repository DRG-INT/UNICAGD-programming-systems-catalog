...
<!-- canonical: https://github.com/krylosov-aa/pg-status -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/krylosov-aa/pg-status](https://github.com/krylosov-aa/pg-status) |
| Source record ids | awesome_list-e8457b6ba77b9a |

## System Engineer Summary

A microservice that provides HTTP endpoints for instantly retrieving the current master host or a
replica that meets various criteria.

## Operational Role

For a systems engineer, pg-status belongs in the Databases inventory as part of ecosystem capability
...
- `awesome_list-e8457b6ba77b9a` from `awesome_list` as `registry_expansion`
