...
<!-- canonical: https://github.com/JustinSDK/dotSCAD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JustinSDK/dotSCAD](https://github.com/JustinSDK/dotSCAD) |
| Source record ids | github_search_computer_graphics_software-53571876973998 |
...
For a systems engineer, JustinSDK/dotSCAD belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-53571876973998` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rustgd/cgmath | Math Numeric Scientific | [open](computer-graphics-software-rustgd-cgmath-53d753df.md) |
