...
<!-- canonical: https://github.com/selkies-project/selkies -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/selkies-project/selkies](https://github.com/selkies-project/selkies) |
| Source record ids | github_search_video-702e14f807e2a3 |

## System Engineer Summary

Low-Latency Accelerated Web Remote Desktop Streaming Platform for Self-Hosting, Containers,
Kubernetes, or Cloud/HPC

## Operational Role

For a systems engineer, selkies-project/selkies belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:56:31Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-702e14f807e2a3` from `github_search_video` as `registry_expansion`
