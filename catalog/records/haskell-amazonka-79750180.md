...
<!-- canonical: https://hackage.haskell.org/package/amazonka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka](https://hackage.haskell.org/package/amazonka) |
| Source record ids | hackage_top_downloads-f94c8bd1939c21 |
...
For a systems engineer, amazonka belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:26:11Z | [https://hackage.haskell.org/package/amazonka](https://hackage.haskell.org/package/amazonka) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-f94c8bd1939c21` from `hackage_top_downloads` as `registry_expansion`
