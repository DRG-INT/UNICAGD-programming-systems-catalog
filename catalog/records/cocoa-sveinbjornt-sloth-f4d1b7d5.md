...
<!-- canonical: https://github.com/sveinbjornt/Sloth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sveinbjornt/Sloth](https://github.com/sveinbjornt/Sloth) |
| Source record ids | github_search_cocoa-323b500597b83d |

## System Engineer Summary

Mac app that shows all open files, directories, sockets, pipes and devices in use by all running
processes. Nice GUI for lsof.

## Operational Role

For a systems engineer, sveinbjornt/Sloth belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T10:31:22Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-323b500597b83d` from `github_search_cocoa` as `registry_expansion`
