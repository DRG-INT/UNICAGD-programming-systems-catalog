...
<!-- canonical: https://github.com/carvel-dev/imgpkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/carvel-dev/imgpkg](https://github.com/carvel-dev/imgpkg) |
| Source record ids | github_search_catalogs-025db511e20dba |
...
For a systems engineer, carvel-dev/imgpkg belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:29:51Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-025db511e20dba` from `github_search_catalogs` as `registry_expansion`
