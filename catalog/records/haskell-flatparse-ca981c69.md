...
<!-- canonical: https://hackage.haskell.org/package/flatparse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/flatparse](https://hackage.haskell.org/package/flatparse) |
| Source record ids | hackage_top_downloads-bd8ed769fb6a3a |
...
For a systems engineer, flatparse belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4.4 | 2026-08-19T22:59:51Z | [https://hackage.haskell.org/package/flatparse](https://hackage.haskell.org/package/flatparse) |  |
| candidate | partial | 0.1.0.1 |  | [https://hackage.haskell.org/package/flatparse](https://hackage.haskell.org/package/flatparse) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/flatparse` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-bd8ed769fb6a3a` from `hackage_top_downloads` as `registry_expansion`
