...
<!-- canonical: https://github.com/SAP-samples/cloud-cap-samples-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-samples/cloud-cap-samples-java](https://github.com/SAP-samples/cloud-cap-samples-java) |
| Source record ids | github_search_sapjava-cbea0972765fa1 |

## System Engineer Summary

A sample application that demonstrates the features of the Java SDK for the SAP Cloud Application
Programming Model.

## Operational Role

For a systems engineer, SAP-samples/cloud-cap-samples-java belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T23:39:50Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-cbea0972765fa1` from `github_search_sapjava` as `registry_expansion`
