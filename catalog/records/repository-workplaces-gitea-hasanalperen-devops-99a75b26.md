# Gitea: hasanalperen/devops

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/hasanalperen/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/hasanalperen/devops](https://gitea.com/hasanalperen/devops) |
| Source record ids | gitea_repositories_api-7fb31d0b751222 |
...
For a systems engineer, Gitea: hasanalperen/devops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-27T17:27:50Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-7fb31d0b751222` from `gitea_repositories_api` as `registry_expansion`
