...
| Canonical URL | [https://crates.io/crates/konst_macro_rules](https://crates.io/crates/konst_macro_rules) |
| Source record ids | crates_io-3fc84d1d0dfd63 |
...
For a systems engineer, konst_macro_rules belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.19 | 2022-10-09T06:33:57.082659Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-3fc84d1d0dfd63` from `crates_io` as `registry_expansion`
