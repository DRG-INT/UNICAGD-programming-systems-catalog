...
<!-- canonical: https://github.com/Infinitegameworks/Paper2DPlus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Infinitegameworks/Paper2DPlus](https://github.com/Infinitegameworks/Paper2DPlus) |
| Source record ids | github_search_repertoare_catalogs-592c46d651df2f |

## System Engineer Summary

Character sprite pipeline for UE 5.0-5.8 Paper2D: visual editors for flipbooks, per-frame hitboxes,
sockets, root motion, and frame timing; behavior-carrying Frame Cues with authorable Cue Types;
layered runtime appearance; Animation Map combo chains; Aseprite import; catalog, effect, and
combat-scoring tools.

## Operational Role

For a systems engineer, Infinitegameworks/Paper2DPlus belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T19:49:41Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-592c46d651df2f` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| thiagocorreanet/mestre-yoda | Interpreter Runtime | [open](repertoare-catalogs-thiagocorreanet-mestre-yoda-6b0b2efd.md) |
