...
<!-- canonical: https://github.com/wwt/SwiftCurrent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wwt/SwiftCurrent](https://github.com/wwt/SwiftCurrent) |
| Source record ids | awesome_list-573d3f8e558627 |
...
For a systems engineer, SwiftCurrent belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.12 | 2022-11-29T03:20:32Z | [https://api.github.com/repos/wwt/SwiftCurrent/releases/latest](https://api.github.com/repos/wwt/SwiftCurrent/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wwt/SwiftCurrent/releases/latest` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-573d3f8e558627` from `awesome_list` as `registry_expansion`
