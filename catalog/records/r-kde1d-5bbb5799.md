...
<!-- canonical: https://cran.r-project.org/web/packages/kde1d/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kde1d/index.html](https://cran.r-project.org/web/packages/kde1d/index.html) |
| Source record ids | cran_packages_by_date-8936af5c475a36 |
...
For a systems engineer, kde1d belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-10 11:40:02 UTC | [https://cran.r-project.org/web/packages/kde1d/DESCRIPTION](https://cran.r-project.org/web/packages/kde1d/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kde1d/DESCRIPTION` at `2026-09-10T12:26:17+00:00`.
...
- `cran_packages_by_date-8936af5c475a36` from `cran_packages_by_date` as `registry_expansion`
