# Gitea: OpenSource-Auth/auth-server-backup
...
<!-- canonical: https://gitea.com/OpenSource-Auth/auth-server-backup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/OpenSource-Auth/auth-server-backup](https://gitea.com/OpenSource-Auth/auth-server-backup) |
| Source record ids | gitea_repositories_api-240dca753330ca |
...
For a systems engineer, Gitea: OpenSource-Auth/auth-server-backup belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-30T04:23:49Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-240dca753330ca` from `gitea_repositories_api` as `registry_expansion`
