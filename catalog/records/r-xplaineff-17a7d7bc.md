...
<!-- canonical: https://cran.r-project.org/web/packages/xplaineff/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xplaineff/index.html](https://cran.r-project.org/web/packages/xplaineff/index.html) |
| Source record ids | cran_packages_by_date-bea9abdb7731c1 |
...
For a systems engineer, xplaineff belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-14 15:00:02 UTC | [https://cran.r-project.org/web/packages/xplaineff/DESCRIPTION](https://cran.r-project.org/web/packages/xplaineff/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xplaineff/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-bea9abdb7731c1` from `cran_packages_by_date` as `registry_expansion`
