...
| Canonical URL | [https://luarocks.org/modules/kikito/kong-plugin-add-header-to-request](https://luarocks.org/modules/kikito/kong-plugin-add-header-to-request) |
| Source record ids | luarocks_root_manifest-b2c06d8240fddc |
...
For a systems engineer, kong-plugin-add-header-to-request belongs in the Lua family inventory as
...
- `luarocks_root_manifest-b2c06d8240fddc` from `luarocks_root_manifest` as `registry_expansion`
