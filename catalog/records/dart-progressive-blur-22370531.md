...
<!-- canonical: https://pub.dev/packages/progressive_blur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/progressive_blur](https://pub.dev/packages/progressive_blur) |
| Source record ids | pub_dev-91335d08b1e4d2 |
...
For a systems engineer, progressive_blur belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2025-06-10T09:10:18.122177Z | [https://pub.dev/api/packages/progressive_blur](https://pub.dev/api/packages/progressive_blur) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/progressive_blur` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-91335d08b1e4d2` from `pub_dev` as `registry_expansion`
