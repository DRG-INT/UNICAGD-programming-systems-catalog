...
<!-- canonical: https://crates.io/crates/metrics-exporter-prometheus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/metrics-exporter-prometheus](https://crates.io/crates/metrics-exporter-prometheus) |
| Source record ids | crates_io-38baf35502f0aa |
...
For a systems engineer, metrics-exporter-prometheus belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.3 | 2026-04-30T13:36:08.766993Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
