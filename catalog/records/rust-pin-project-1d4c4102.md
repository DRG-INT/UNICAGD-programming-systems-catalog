...
<!-- canonical: https://crates.io/crates/pin-project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pin-project](https://crates.io/crates/pin-project) |
| Source record ids | crates_io-efa27add073f4f |
...
For a systems engineer, pin-project belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.13 | 2026-05-13T18:32:09.030433Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-efa27add073f4f` from `crates_io` as `registry_expansion`
