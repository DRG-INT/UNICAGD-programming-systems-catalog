...
<!-- canonical: https://github.com/termux/termux-x11 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/termux/termux-x11](https://github.com/termux/termux-x11) |
| Source record ids | github_search_computer_graphics_software-a4799fb2418345 |

## System Engineer Summary

termux/termux-x11 is tracked as a web framework record in the Computer Graphics Software branch. The
...
For a systems engineer, termux/termux-x11 belongs in the Computer Graphics Software inventory as
...
| Evidence | {"key": "", "name": "", "url": ""}; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_computer_graphics_software-a4799fb2418345` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| pkhungurn/talking-head-anime-2-demo | Web Framework | [open](computer-graphics-software-pkhungurn-talking-head-anime-2-demo-01e3f4b5.md) |
