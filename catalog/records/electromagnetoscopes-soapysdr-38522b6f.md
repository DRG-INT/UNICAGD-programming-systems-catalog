...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pothosware/SoapySDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pothosware/SoapySDR](https://github.com/pothosware/SoapySDR) |
| Source record ids | curated_language_routes-be10819d2bfafc |

## System Engineer Summary

Vendor-neutral SDR support library and module system for radio hardware access.

## Operational Role

For a systems engineer, SoapySDR belongs in the Electromagnetoscopes inventory as part of ecosystem
...
- `curated_language_routes-be10819d2bfafc` from `curated_language_routes` as `registry_expansion`
