...
<!-- canonical: https://hackage.haskell.org/package/diagrams-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/diagrams-builder](https://hackage.haskell.org/package/diagrams-builder) |
| Source record ids | hackage_top_downloads-c8f11f7135ee85 |
...
For a systems engineer, diagrams-builder belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0.6 | 2023-07-10T18:13:04Z | [https://hackage.haskell.org/package/diagrams-builder](https://hackage.haskell.org/package/diagrams-builder) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/diagrams-builder` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-c8f11f7135ee85` from `hackage_top_downloads` as `registry_expansion`
