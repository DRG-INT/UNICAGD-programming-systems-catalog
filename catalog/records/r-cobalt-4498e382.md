...
<!-- canonical: https://cran.r-project.org/web/packages/cobalt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cobalt/index.html](https://cran.r-project.org/web/packages/cobalt/index.html) |
| Source record ids | cran_packages_by_date-85e29f8b6c5687 |
...
For a systems engineer, cobalt belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-08-25 21:10:16 UTC | [https://cran.r-project.org/web/packages/cobalt/DESCRIPTION](https://cran.r-project.org/web/packages/cobalt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cobalt/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-85e29f8b6c5687` from `cran_packages_by_date` as `registry_expansion`
