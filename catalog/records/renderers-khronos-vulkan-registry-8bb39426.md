...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Renderers](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/renderers.md) · [Category: Language Specification](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-specification.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://registry.khronos.org/vulkan/](https://registry.khronos.org/vulkan/) |
| Source record ids | curated_language_routes-b311d3c2470ca0 |

## System Engineer Summary

Official Vulkan specification and registry route for graphics, compute, extensions, SPIR-V
capabilities, and conformance-facing renderer work.

## Operational Role

For a systems engineer, Khronos Vulkan Registry belongs in the Renderers inventory as part of
...
- `curated_language_routes-b311d3c2470ca0` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Khronos OpenGL Registry | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-khronos-opengl-registry-58865751.md) |
| SVG Specification | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-svg-specification-40a25756.md) |
| W3C WebGPU | Language Specification | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-w3c-webgpu-ee925e14.md) |
