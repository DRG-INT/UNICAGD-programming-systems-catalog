...
<!-- canonical: https://gitea.com/APYieldFarmer/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/APYieldFarmer/devops](https://gitea.com/APYieldFarmer/devops) |
| Source record ids | gitea_repositories_api-5955831f042ea6 |
...
For a systems engineer, Gitea: APYieldFarmer/devops belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-13T11:00:07Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-5955831f042ea6` from `gitea_repositories_api` as `registry_expansion`
...
| Gitea: fighting7ta/library_management_system | Library | [open](repository-workplaces-gitea-fighting7ta-library-management-system-6d1ae866.md) |
