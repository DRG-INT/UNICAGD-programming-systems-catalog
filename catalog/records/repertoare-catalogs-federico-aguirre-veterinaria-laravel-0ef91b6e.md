# Federico-Aguirre/Veterinaria_Laravel

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Federico-Aguirre/Veterinaria_Laravel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Federico-Aguirre/Veterinaria_Laravel](https://github.com/Federico-Aguirre/Veterinaria_Laravel) |
| Source record ids | github_search_repertoare_catalogs-fe9728ed9603d3 |

## System Engineer Summary

Veterinary management system built with Laravel, Livewire & Alpine.js. Features pet & appointment
CRUDs, product catalog with shopping cart, social auth, and PostgreSQL (Neon) integration. Optimized
with 100% Google PageSpeed scores.

## Operational Role

For a systems engineer, Federico-Aguirre/Veterinaria_Laravel belongs in the Repertoare Catalogs
...
- `github_search_repertoare_catalogs-fe9728ed9603d3` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ens-lgil/PGS_Catalog_deprecated | Database Datastore | [open](repertoare-catalogs-ens-lgil-pgs-catalog-deprecated-88d51e98.md) |
| hwasun-zip/Catalog-Triage | Database Datastore | [open](repertoare-catalogs-hwasun-zip-catalog-triage-f9629850.md) |
| PGScatalog/PGS_Catalog | Database Datastore | [open](repertoare-catalogs-pgscatalog-pgs-catalog-ee188ec5.md) |
