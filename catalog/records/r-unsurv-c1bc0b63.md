...
<!-- canonical: https://cran.r-project.org/web/packages/unsurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/unsurv/index.html](https://cran.r-project.org/web/packages/unsurv/index.html) |
| Source record ids | cran_packages_by_date-0725c5851337d2 |
...
For a systems engineer, unsurv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-31 22:30:02 UTC | [https://cran.r-project.org/web/packages/unsurv/DESCRIPTION](https://cran.r-project.org/web/packages/unsurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/unsurv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0725c5851337d2` from `cran_packages_by_date` as `registry_expansion`
