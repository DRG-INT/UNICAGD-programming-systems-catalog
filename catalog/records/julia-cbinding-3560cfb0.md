...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CBinding](https://github.com/JuliaRegistries/General/tree/master/C/CBinding) |
| Source record ids | julia_general-b95a6a6426df0e |

## System Engineer Summary

Julia package registered in General at C/CBinding.

## Operational Role

For a systems engineer, CBinding belongs in the Julia inventory as part of cross-language
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CBinding", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b95a6a6426df0e` from `julia_general` as `registry_expansion`
