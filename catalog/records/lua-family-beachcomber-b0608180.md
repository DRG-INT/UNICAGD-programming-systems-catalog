...
<!-- canonical: https://luarocks.org/modules/jhogendorn/beachcomber -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jhogendorn/beachcomber](https://luarocks.org/modules/jhogendorn/beachcomber) |
| Source record ids | luarocks_root_manifest-1220b5c06c2758 |

## System Engineer Summary

Name reservation — install libbeachcomber instead

## Operational Role

For a systems engineer, beachcomber belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1220b5c06c2758` from `luarocks_root_manifest` as `registry_expansion`
