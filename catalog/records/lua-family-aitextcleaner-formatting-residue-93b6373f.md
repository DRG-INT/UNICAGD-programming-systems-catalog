...
<!-- canonical: https://luarocks.org/modules/bbwdadfg/aitextcleaner-formatting-residue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bbwdadfg/aitextcleaner-formatting-residue](https://luarocks.org/modules/bbwdadfg/aitextcleaner-formatting-residue) |
| Source record ids | luarocks_root_manifest-ff38b628be5fd6 |

## System Engineer Summary

Local formatting-residue cleanup helper for copied text.

## Operational Role

For a systems engineer, aitextcleaner-formatting-residue belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-ff38b628be5fd6` from `luarocks_root_manifest` as `registry_expansion`
...
| cardfileformat | Formatter | [open](lua-family-cardfileformat-77ce19a2.md) |
