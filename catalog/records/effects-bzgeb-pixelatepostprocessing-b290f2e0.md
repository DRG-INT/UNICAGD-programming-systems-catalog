...
<!-- canonical: https://github.com/bzgeb/PixelatePostProcessing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bzgeb/PixelatePostProcessing](https://github.com/bzgeb/PixelatePostProcessing) |
| Source record ids | github_search_effects-44a56ca844c4dc |
...
For a systems engineer, bzgeb/PixelatePostProcessing belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-17T17:24:44Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-44a56ca844c4dc` from `github_search_effects` as `registry_expansion`
