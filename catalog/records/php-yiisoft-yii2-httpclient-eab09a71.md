...
<!-- canonical: https://packagist.org/packages/yiisoft/yii2-httpclient -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/yiisoft/yii2-httpclient](https://packagist.org/packages/yiisoft/yii2-httpclient) |
| Source record ids | packagist_search-bb2df4f83cab25 |
...
For a systems engineer, yiisoft/yii2-httpclient belongs in the PHP inventory as part of service
...
- `packagist_search-bb2df4f83cab25` from `packagist_search` as `registry_expansion`
