...
| Source record ids | github_search_pattern_language-17b6ae1c00d44b |
...
For a systems engineer, magicpatterns/catalog belongs in the Pattern language inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-03T20:23:35Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-17b6ae1c00d44b` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Unity-Technologies/game-programming-patterns-demo | Logging Observability | [open](pattern-language-unity-technologies-game-programming-patterns-demo-4d631e53.md) |
