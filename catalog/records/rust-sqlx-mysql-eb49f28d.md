...
<!-- canonical: https://crates.io/crates/sqlx-mysql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlx-mysql](https://crates.io/crates/sqlx-mysql) |
| Source record ids | crates_io-5f541acfdf06ac |
...
For a systems engineer, sqlx-mysql belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-05-21T17:33:45.946246Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-5f541acfdf06ac` from `crates_io` as `registry_expansion`
