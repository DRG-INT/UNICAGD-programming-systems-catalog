...
<!-- canonical: https://github.com/placemark/placemark -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/placemark/placemark](https://github.com/placemark/placemark) |
| Source record ids | github_search_maps-7c2322eadccd88 |
...
For a systems engineer, placemark/placemark belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T23:59:40Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7c2322eadccd88` from `github_search_maps` as `registry_expansion`
