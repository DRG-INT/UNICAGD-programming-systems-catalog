...
<!-- canonical: https://cran.r-project.org/web/packages/MD2sample/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MD2sample/index.html](https://cran.r-project.org/web/packages/MD2sample/index.html) |
| Source record ids | cran_packages_by_date-776780fbe59fe4 |
...
For a systems engineer, MD2sample belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-04 10:30:40 UTC | [https://cran.r-project.org/web/packages/MD2sample/DESCRIPTION](https://cran.r-project.org/web/packages/MD2sample/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MD2sample/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-776780fbe59fe4` from `cran_packages_by_date` as `registry_expansion`
