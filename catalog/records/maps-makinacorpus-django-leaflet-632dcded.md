...
<!-- canonical: https://github.com/makinacorpus/django-leaflet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/makinacorpus/django-leaflet](https://github.com/makinacorpus/django-leaflet) |
| Source record ids | github_search_maps-0db3666b4c6459 |
...
For a systems engineer, makinacorpus/django-leaflet belongs in the Maps inventory as part of input-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T08:41:03Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0db3666b4c6459` from `github_search_maps` as `registry_expansion`
