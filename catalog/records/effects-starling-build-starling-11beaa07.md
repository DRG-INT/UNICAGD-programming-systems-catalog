...
<!-- canonical: https://github.com/starling-build/starling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/starling-build/starling](https://github.com/starling-build/starling) |
| Source record ids | github_search_effects-5ebe4bc537cf67 |

## System Engineer Summary

Starling — a new Linux desktop environment: Swift shell, its own compositor, a Flutter-to-Swift
framework port, and first-party apps

## Operational Role

For a systems engineer, starling-build/starling belongs in the Effects inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:32:26Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5ebe4bc537cf67` from `github_search_effects` as `registry_expansion`
