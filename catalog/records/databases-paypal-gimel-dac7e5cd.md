...
<!-- canonical: https://github.com/paypal/gimel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/paypal/gimel](https://github.com/paypal/gimel) |
| Source record ids | github_search_databases-cf24b203fb313f |
...
For a systems engineer, paypal/gimel belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-10T08:52:55Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cf24b203fb313f` from `github_search_databases` as `registry_expansion`
