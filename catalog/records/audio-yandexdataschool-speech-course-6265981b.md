...
| Source record ids | github_search_audio-928a70a86bd1c0 |
...
For a systems engineer, yandexdataschool/speech_course belongs in the Audio inventory as part of
...
- `github_search_audio-928a70a86bd1c0` from `github_search_audio` as `registry_expansion`
