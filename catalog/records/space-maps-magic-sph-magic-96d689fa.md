...
<!-- canonical: https://github.com/magic-sph/magic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/magic-sph/magic](https://github.com/magic-sph/magic) |
| Source record ids | github_search_space_maps-dc3fbe86241678 |

## System Engineer Summary

MagIC is a high-performance code that solves the magneto-hydrodynamics equations in rotating
spherical shells

## Operational Role

For a systems engineer, magic-sph/magic belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T00:30:00Z | gh search repos topic:planetary-science stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-dc3fbe86241678` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| juliensimon/starlink-viz | Benchmarking | [open](space-maps-juliensimon-starlink-viz-9a56fe81.md) |
