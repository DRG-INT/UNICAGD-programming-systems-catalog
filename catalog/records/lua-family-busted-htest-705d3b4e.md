...
<!-- canonical: https://luarocks.org/modules/hisham/busted-htest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/hisham/busted-htest](https://luarocks.org/modules/hisham/busted-htest) |
| Source record ids | luarocks_root_manifest-6b98a16ec6fb2c |
...
For a systems engineer, busted-htest belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-6b98a16ec6fb2c` from `luarocks_root_manifest` as `registry_expansion`
