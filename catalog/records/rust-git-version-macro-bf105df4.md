...
| Canonical URL | [https://crates.io/crates/git-version-macro](https://crates.io/crates/git-version-macro) |
| Source record ids | crates_io-1d9f57b9d47bdb |
...
For a systems engineer, git-version-macro belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.9 | 2023-12-13T18:22:04.489168Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-1d9f57b9d47bdb` from `crates_io` as `registry_expansion`
