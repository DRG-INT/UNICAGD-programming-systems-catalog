...
<!-- canonical: https://github.com/Adam-CAD/CADAM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Adam-CAD/CADAM](https://github.com/Adam-CAD/CADAM) |
| Source record ids | github_search_webassembly-ddc1142832ec5c |
...
For a systems engineer, Adam-CAD/CADAM belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:58:08Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-ddc1142832ec5c` from `github_search_webassembly` as `registry_expansion`
