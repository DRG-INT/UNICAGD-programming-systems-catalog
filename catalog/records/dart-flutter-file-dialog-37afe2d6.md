...
<!-- canonical: https://pub.dev/packages/flutter_file_dialog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_file_dialog](https://pub.dev/packages/flutter_file_dialog) |
| Source record ids | pub_dev-b7c9f88e5821d0 |
...
For a systems engineer, flutter_file_dialog belongs in the Dart inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.2 | 2026-07-24T16:59:04.690317Z | [https://pub.dev/api/packages/flutter_file_dialog](https://pub.dev/api/packages/flutter_file_dialog) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_file_dialog` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-b7c9f88e5821d0` from `pub_dev` as `registry_expansion`
