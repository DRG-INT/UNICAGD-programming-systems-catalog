...
<!-- canonical: https://github.com/atsushieno/uapmd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atsushieno/uapmd](https://github.com/atsushieno/uapmd) |
| Source record ids | github_search_audio-5b2dabcec201b7 |

## System Engineer Summary

A liberal plugin hosting library (VST3/AU/LV2/CLAP/AAP/WebCLAP) with fully-featured MIDI 2.0 (UMP +
MIDI-CI) frontend where applicable. Create virtual MIDI 2.0 devices using your favorite plugins.

## Operational Role

For a systems engineer, atsushieno/uapmd belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T15:03:13Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-5b2dabcec201b7` from `github_search_audio` as `registry_expansion`
