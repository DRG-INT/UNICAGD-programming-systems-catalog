...
<!-- canonical: https://cran.r-project.org/web/packages/chk/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chk/index.html](https://cran.r-project.org/web/packages/chk/index.html) |
| Source record ids | cran_packages_by_date-dcddede41f7d57 |
...
For a systems engineer, chk belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2026-09-03 05:20:50 UTC | [https://cran.r-project.org/web/packages/chk/DESCRIPTION](https://cran.r-project.org/web/packages/chk/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chk/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-dcddede41f7d57` from `cran_packages_by_date` as `registry_expansion`
