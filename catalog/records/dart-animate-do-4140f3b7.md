...
<!-- canonical: https://pub.dev/packages/animate_do -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/animate_do](https://pub.dev/packages/animate_do) |
| Source record ids | pub_dev-c96ba8d080816c |

## System Engineer Summary

Beautiful animations inspired by Animate.css, providing customizable widget-based animations with no
external dependencies.

## Operational Role

For a systems engineer, animate_do belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.0 | 2026-04-18T23:45:53.214102Z | [https://pub.dev/api/packages/animate_do](https://pub.dev/api/packages/animate_do) |  |
| preview | known | 2.0.0-dev.1 | 2021-03-05T22:56:35.784757Z | [https://pub.dev/api/packages/animate_do](https://pub.dev/api/packages/animate_do) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/animate_do` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-c96ba8d080816c` from `pub_dev` as `registry_expansion`
