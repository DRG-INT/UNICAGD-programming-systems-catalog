# Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog
...
<!-- canonical: https://github.com/Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog](https://github.com/Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog) |
| Source record ids | github_search_space_maps-32f97aba4d3602 |

## System Engineer Summary

Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-iceberg-snowflake-open-catalog
is tracked as a package manager record in the Space Maps branch. The source did not provide a long
...
For a systems engineer, Snowflake-Labs/sfguide-getting-started-with-snowpipe-streaming-apache-
iceberg-snowflake-open-catalog belongs in the Space Maps inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-09T17:11:17Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-32f97aba4d3602` from `github_search_space_maps` as `registry_expansion`
