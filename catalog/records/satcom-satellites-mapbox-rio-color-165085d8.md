...
<!-- canonical: https://github.com/mapbox/rio-color -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mapbox/rio-color](https://github.com/mapbox/rio-color) |
| Source record ids | github_search_satcom_satellites-6fb614faa97cd3 |
...
For a systems engineer, mapbox/rio-color belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2024-12-19T21:09:47Z | [https://api.github.com/repos/mapbox/rio-color/releases/latest](https://api.github.com/repos/mapbox/rio-color/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mapbox/rio-color/releases/latest` at `2026-09-01T08:26:36+00:00`.
...
- `github_search_satcom_satellites-6fb614faa97cd3` from `github_search_satcom_satellites` as `registry_expansion`
