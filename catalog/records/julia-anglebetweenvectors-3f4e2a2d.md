...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AngleBetweenVectors -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AngleBetweenVectors", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-5248602f99c61c` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AppEnv | Configuration | [open](julia-appenv-267cf394.md) |
| ArcadeLearningEnvironment | Configuration | [open](julia-arcadelearningenvironment-ed5f492b.md) |
| ArcadeLearningEnvironment_jll | Configuration | [open](julia-arcadelearningenvironment-jll-44c96093.md) |
| BenchPerfConfigSweeps | Configuration | [open](julia-benchperfconfigsweeps-64f5b865.md) |
| ClassicControlEnvironments | Configuration | [open](julia-classiccontrolenvironments-e0d8de63.md) |
