...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Configuration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/configuration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AngleBetweenVectors](https://github.com/JuliaRegistries/General/tree/master/A/AngleBetweenVectors) |
| Source record ids | julia_general-5248602f99c61c |

## System Engineer Summary

Julia package registered in General at A/AngleBetweenVectors.

## Operational Role

For a systems engineer, AngleBetweenVectors belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| AppEnv | Configuration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-appenv-267cf394.md) |
| ArcadeLearningEnvironment | Configuration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arcadelearningenvironment-ed5f492b.md) |
| ArcadeLearningEnvironment_jll | Configuration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-arcadelearningenvironment-jll-44c96093.md) |
| BenchPerfConfigSweeps | Configuration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-benchperfconfigsweeps-64f5b865.md) |
| ClassicControlEnvironments | Configuration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-classiccontrolenvironments-e0d8de63.md) |
