...
<!-- canonical: https://gitea.com/xiaox/New-Library-Demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/xiaox/New-Library-Demo](https://gitea.com/xiaox/New-Library-Demo) |
| Source record ids | gitea_repositories_api-162711bb66283a |
...
For a systems engineer, Gitea: xiaox/New-Library-Demo belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-24T01:57:35Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-162711bb66283a` from `gitea_repositories_api` as `registry_expansion`
