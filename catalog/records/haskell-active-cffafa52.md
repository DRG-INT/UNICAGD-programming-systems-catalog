...
<!-- canonical: https://hackage.haskell.org/package/active -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/active](https://hackage.haskell.org/package/active) |
| Source record ids | hackage_top_downloads-667e35efac2304 |
...
For a systems engineer, active belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.1 | 2026-04-20T17:27:54Z | [https://hackage.haskell.org/package/active](https://hackage.haskell.org/package/active) |  |
| candidate | partial | 0.1.0.14 |  | [https://hackage.haskell.org/package/active](https://hackage.haskell.org/package/active) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/active` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-667e35efac2304` from `hackage_top_downloads` as `registry_expansion`
