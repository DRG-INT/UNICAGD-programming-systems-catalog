...
<!-- canonical: https://github.com/blue42shade/remap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blue42shade/remap](https://github.com/blue42shade/remap) |
| Source record ids | github_search_space_shuttles-638fed2c4f39a1 |

## System Engineer Summary

Remap additional keys for the Orbiter Space Flight Simulator

## Operational Role

For a systems engineer, blue42shade/remap belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-02-20T04:05:28Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-638fed2c4f39a1` from `github_search_space_shuttles` as `registry_expansion`
