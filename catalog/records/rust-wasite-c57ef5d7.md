...
<!-- canonical: https://crates.io/crates/wasite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasite](https://crates.io/crates/wasite) |
| Source record ids | crates_io-95979937c6de2f |
...
For a systems engineer, wasite belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-01-08T04:37:24.431809Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-95979937c6de2f` from `crates_io` as `registry_expansion`
