...
<!-- canonical: https://github.com/ayushsi42/geo-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ayushsi42/geo-sim](https://github.com/ayushsi42/geo-sim) |
| Source record ids | github_search_space_maps-03961f7a82241a |

## System Engineer Summary

GeoSim is a planetary-scale geopolitical world model and simulation platform designed to map,
analyze, and simulate the dynamics of global politics.

## Operational Role

For a systems engineer, ayushsi42/geo-sim belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-10T18:05:51Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-03961f7a82241a` from `github_search_space_maps` as `registry_expansion`
