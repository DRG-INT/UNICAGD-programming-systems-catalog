...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/zueblin/Polaron -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zueblin/Polaron](https://github.com/zueblin/Polaron) |
| Source record ids | github_search_audio-2d5c6617773add |
...
For a systems engineer, zueblin/Polaron belongs in the Audio inventory as part of device
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-05T12:28:45Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-2d5c6617773add` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adplug/adplug | Embedded Hardware | [open](audio-adplug-adplug-e2680a2a.md) |
| ARM-software/CMSIS-DSP | Embedded Hardware | [open](audio-arm-software-cmsis-dsp-5aab5965.md) |
| reales/retromulator | Embedded Hardware | [open](audio-reales-retromulator-fdf0cc26.md) |
