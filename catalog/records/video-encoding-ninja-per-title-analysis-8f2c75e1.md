# encoding-ninja/per-title-analysis
...
<!-- canonical: https://github.com/encoding-ninja/per-title-analysis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/encoding-ninja/per-title-analysis](https://github.com/encoding-ninja/per-title-analysis) |
| Source record ids | github_search_video-8053d217a97022 |
...
For a systems engineer, encoding-ninja/per-title-analysis belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-14T14:14:08Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-8053d217a97022` from `github_search_video` as `registry_expansion`
