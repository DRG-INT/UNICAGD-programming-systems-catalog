...
| Canonical URL | [https://github.com/mrdoob/three.js](https://github.com/mrdoob/three.js) |
| Source record ids | curated_language_routes-1eecfdb66b97d4 |

## System Engineer Summary

JavaScript 3D graphics library for WebGL/WebGPU scenes, assets, materials, animation, and browser
rendering.

## Operational Role

For a systems engineer, three.js belongs in the Computer Graphics Software inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | r185 | 2026-07-01T23:22:26Z | [https://api.github.com/repos/mrdoob/three.js/releases/latest](https://api.github.com/repos/mrdoob/three.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mrdoob/three.js/releases/latest` at `2026-09-01T07:24:40+00:00`.
...
- `curated_language_routes-1eecfdb66b97d4` from `curated_language_routes` as `registry_expansion`
