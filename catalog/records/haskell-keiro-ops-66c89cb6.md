...
<!-- canonical: https://hackage.haskell.org/package/keiro-ops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keiro-ops](https://hackage.haskell.org/package/keiro-ops) |
| Source record ids | hackage_recent-adb71b5b82b688 |
...
For a systems engineer, keiro-ops belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0.0 | 2026-09-08T05:30:34Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-adb71b5b82b688` from `hackage_recent` as `registry_expansion`
