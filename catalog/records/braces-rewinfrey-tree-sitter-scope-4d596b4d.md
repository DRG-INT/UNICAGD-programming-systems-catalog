...
<!-- canonical: https://github.com/rewinfrey/tree-sitter-scope -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rewinfrey/tree-sitter-scope](https://github.com/rewinfrey/tree-sitter-scope) |
| Source record ids | github_search_braces-d727f135954937 |

## System Engineer Summary

Parser for identifying scope hierarchy for languages using curly braces to denote scopes.

## Operational Role

For a systems engineer, rewinfrey/tree-sitter-scope belongs in the Braces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-03T15:22:12Z | gh search repos tree-sitter braces | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "tree-sitter braces", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_braces-d727f135954937` from `github_search_braces` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ECMAScript Language Specification | Language Specification | [open](braces-ecmascript-language-specification-f5ea1fe4.md) |
