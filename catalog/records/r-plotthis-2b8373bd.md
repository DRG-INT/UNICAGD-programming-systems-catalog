...
<!-- canonical: https://cran.r-project.org/web/packages/plotthis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/plotthis/index.html](https://cran.r-project.org/web/packages/plotthis/index.html) |
| Source record ids | cran_packages_by_date-5ce6724b71c466 |
...
For a systems engineer, plotthis belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-08-29 12:10:02 UTC | [https://cran.r-project.org/web/packages/plotthis/DESCRIPTION](https://cran.r-project.org/web/packages/plotthis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/plotthis/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5ce6724b71c466` from `cran_packages_by_date` as `registry_expansion`
