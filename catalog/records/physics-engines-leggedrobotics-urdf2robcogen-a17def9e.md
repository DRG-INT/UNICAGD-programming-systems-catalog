...
<!-- canonical: https://github.com/leggedrobotics/urdf2robcogen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leggedrobotics/urdf2robcogen](https://github.com/leggedrobotics/urdf2robcogen) |
| Source record ids | github_search_physics_engines-c7193f751bb8b6 |

## System Engineer Summary

A tool that translates a robot URDF description into the kindsl format that can be processed by
RobCoGen.

## Operational Role

For a systems engineer, leggedrobotics/urdf2robcogen belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-01T14:03:35Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-c7193f751bb8b6` from `github_search_physics_engines` as `registry_expansion`
...
| steeltroops-ai/blackhole-simulation | Formatter | [open](physics-engines-steeltroops-ai-blackhole-simulation-dde1cc2a.md) |
