...
| Canonical URL | [https://github.com/olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) |
| Source record ids | github_search_telescopes-a20f65ab51d09c |
...
For a systems engineer, olimorris/persisted.nvim belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.1.0 | 2026-08-25T10:18:46Z | [https://api.github.com/repos/olimorris/persisted.nvim/releases/latest](https://api.github.com/repos/olimorris/persisted.nvim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/olimorris/persisted.nvim/releases/latest` at `2026-09-01T08:26:26+00:00`.
...
- `github_search_telescopes-a20f65ab51d09c` from `github_search_telescopes` as `registry_expansion`
