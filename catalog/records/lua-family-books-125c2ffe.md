...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Tutorial Book Styleguide](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/tutorial-book-styleguide.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | lua-source-53 |

## System Engineer Summary

Books is tracked as a tutorial book styleguide record in the Lua family branch. The source did not
...
For a systems engineer, Books belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 53}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-53` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bookmark | Tutorial Book Styleguide | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bookmark-944d772b.md) |
| fbtorch | Tutorial Book Styleguide | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-fbtorch-0c5b7744.md) |
| hycolor | Tutorial Book Styleguide | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-hycolor-e986e428.md) |
| Tutorials | Tutorial Book Styleguide | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-tutorials-9e4c17d4.md) |
