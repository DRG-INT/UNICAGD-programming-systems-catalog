...
<!-- canonical: https://github.com/avivace/dotfiles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/avivace/dotfiles](https://github.com/avivace/dotfiles) |
| Source record ids | github_search_effects-41b37fc77d4a3f |

## System Engineer Summary

i3 + Plasma: using the i3 window manager on the top of KDE Plasma and other dotfiles,
configurations, scripts, workarounds and practises from my Debian Sid machines.

## Operational Role

For a systems engineer, avivace/dotfiles belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-06T09:29:22Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-41b37fc77d4a3f` from `github_search_effects` as `registry_expansion`
