...
| Canonical URL | [https://packagist.org/packages/clue/redis-react](https://packagist.org/packages/clue/redis-react) |
| Source record ids | packagist_search-ac93b89bee0e2e |
...
For a systems engineer, clue/redis-react belongs in the PHP inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.8.0 | 2025-01-03T16:19:18+00:00 | [https://repo.packagist.org/p2/clue/redis-react.json](https://repo.packagist.org/p2/clue/redis-react.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/clue/redis-react.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-ac93b89bee0e2e` from `packagist_search` as `registry_expansion`
