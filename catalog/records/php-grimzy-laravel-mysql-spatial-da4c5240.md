...
| Canonical URL | [https://packagist.org/packages/grimzy/laravel-mysql-spatial](https://packagist.org/packages/grimzy/laravel-mysql-spatial) |
| Source record ids | packagist_search-9e87330c12cfae |
...
For a systems engineer, grimzy/laravel-mysql-spatial belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2020-10-17T07:35:07+00:00 | [https://repo.packagist.org/p2/grimzy/laravel-mysql-spatial.json](https://repo.packagist.org/p2/grimzy/laravel-mysql-spatial.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/grimzy/laravel-mysql-spatial.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-9e87330c12cfae` from `packagist_search` as `registry_expansion`
