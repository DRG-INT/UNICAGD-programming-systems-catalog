...
<!-- canonical: https://cran.r-project.org/web/packages/clustGLMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/clustGLMM/index.html](https://cran.r-project.org/web/packages/clustGLMM/index.html) |
| Source record ids | cran_packages_by_date-7083af5fbe6325 |
...
For a systems engineer, clustGLMM belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-19 16:00:14 UTC | [https://cran.r-project.org/web/packages/clustGLMM/DESCRIPTION](https://cran.r-project.org/web/packages/clustGLMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/clustGLMM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7083af5fbe6325` from `cran_packages_by_date` as `registry_expansion`
