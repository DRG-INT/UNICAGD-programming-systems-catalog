...
<!-- canonical: https://hackage.haskell.org/package/yaml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/yaml](https://hackage.haskell.org/package/yaml) |
| Source record ids | hackage_top_downloads-50a9dfebb38f68 |

## System Engineer Summary

Hackage package with 356 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, yaml belongs in the Haskell inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.11.2 | 2023-07-01T18:43:54Z | [https://hackage.haskell.org/package/yaml](https://hackage.haskell.org/package/yaml) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/yaml` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-50a9dfebb38f68` from `hackage_top_downloads` as `registry_expansion`
