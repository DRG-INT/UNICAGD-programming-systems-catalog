...
| Source record ids | github_search_magazines-accf1f39544379 |
...
For a systems engineer, pentix/qjournalctl belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-25T21:04:06Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-accf1f39544379` from `github_search_magazines` as `registry_expansion`
