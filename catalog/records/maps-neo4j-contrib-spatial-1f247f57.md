...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/neo4j-contrib/spatial -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neo4j-contrib/spatial](https://github.com/neo4j-contrib/spatial) |
| Source record ids | github_search_maps-a80c71d718689b |

## System Engineer Summary

Neo4j Spatial is a library of utilities for Neo4j that faciliates the enabling of spatial operations
on data. In particular you can add spatial indexes to already located data, and perform spatial
operations on the data like searching for data within specified regions or within a specified
distance of a point of interest.

## Operational Role

For a systems engineer, neo4j-contrib/spatial belongs in the Maps inventory as part of request
routing, middleware policy, service structure, and deployment surface.
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
| --- | --- | --- | --- |
| github_repository_search | registry-derived | 2026-09-01 | `{"kind": "github_repository_search", "query": "topic:gis stars:>100", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `github_search_maps-a80c71d718689b` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| angular-ui/ui-router | Web Framework | [open](maps-angular-ui-ui-router-206fd635.md) |
| bramus/router | Web Framework | [open](maps-bramus-router-6e37f1d6.md) |
| cablate/mcp-google-map | Web Framework | [open](maps-cablate-mcp-google-map-31eb1d92.md) |
| consbio/mbtileserver | Web Framework | [open](maps-consbio-mbtileserver-d40256c2.md) |
| corteva/djangorestframework-mvt | Web Framework | [open](maps-corteva-djangorestframework-mvt-cc913f1c.md) |
| csells/go_router | Web Framework | [open](maps-csells-go-router-71bea4d9.md) |
| dannyvankooten/AltoRouter | Web Framework | [open](maps-dannyvankooten-altorouter-a35314f2.md) |
| developmentseed/timvt | Web Framework | [open](maps-developmentseed-timvt-45af3e5c.md) |
