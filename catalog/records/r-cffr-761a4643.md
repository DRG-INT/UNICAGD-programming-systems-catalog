...
<!-- canonical: https://cran.r-project.org/web/packages/cffr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cffr/index.html](https://cran.r-project.org/web/packages/cffr/index.html) |
| Source record ids | cran_packages_by_date-43eef2aac12def |
...
For a systems engineer, cffr belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2026-08-24 12:10:02 UTC | [https://cran.r-project.org/web/packages/cffr/DESCRIPTION](https://cran.r-project.org/web/packages/cffr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cffr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-43eef2aac12def` from `cran_packages_by_date` as `registry_expansion`
