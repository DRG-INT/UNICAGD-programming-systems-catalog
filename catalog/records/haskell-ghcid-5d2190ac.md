...
<!-- canonical: https://hackage.haskell.org/package/ghcid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghcid](https://hackage.haskell.org/package/ghcid) |
| Source record ids | hackage_top_downloads-ace226d5a4ab8b |
...
For a systems engineer, ghcid belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-19T03:38:40Z | [https://hackage.haskell.org/package/ghcid](https://hackage.haskell.org/package/ghcid) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghcid` at `2026-09-01T14:24:17+00:00`.
...
- `hackage_top_downloads-ace226d5a4ab8b` from `hackage_top_downloads` as `registry_expansion`
