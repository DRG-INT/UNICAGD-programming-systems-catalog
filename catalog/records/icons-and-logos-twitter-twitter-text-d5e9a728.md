...
<!-- canonical: https://github.com/twitter/twitter-text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/twitter/twitter-text](https://github.com/twitter/twitter-text) |
| Source record ids | github_search_icons_and_logos-c5ce9c14de3b6d |

## System Engineer Summary

Twitter Text Libraries. This code is used at Twitter to tokenize and parse text to meet the
expectations for what can be used on the platform.

## Operational Role

For a systems engineer, twitter/twitter-text belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-26T09:15:03Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-c5ce9c14de3b6d` from `github_search_icons_and_logos` as `registry_expansion`
