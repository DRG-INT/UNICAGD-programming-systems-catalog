...
<!-- canonical: https://hackage.haskell.org/package/network-multicast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/network-multicast](https://hackage.haskell.org/package/network-multicast) |
| Source record ids | hackage_top_downloads-cf8e87ceb3fab4 |
...
For a systems engineer, network-multicast belongs in the Haskell inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2019-05-28T16:45:42Z | [https://hackage.haskell.org/package/network-multicast](https://hackage.haskell.org/package/network-multicast) |  |
| candidate | partial | 0.3.0 |  | [https://hackage.haskell.org/package/network-multicast](https://hackage.haskell.org/package/network-multicast) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/network-multicast` at `2026-09-13T00:31:07+00:00`.
...
- `hackage_top_downloads-cf8e87ceb3fab4` from `hackage_top_downloads` as `registry_expansion`
