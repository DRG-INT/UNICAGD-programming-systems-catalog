...
<!-- canonical: https://luarocks.org/modules/neilcook/elasticsearch-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neilcook/elasticsearch-lua](https://luarocks.org/modules/neilcook/elasticsearch-lua) |
| Source record ids | luarocks_root_manifest-3607c897b52292 |
...
For a systems engineer, elasticsearch-lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3607c897b52292` from `luarocks_root_manifest` as `registry_expansion`
