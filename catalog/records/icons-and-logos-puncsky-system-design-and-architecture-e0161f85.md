...
<!-- canonical: https://github.com/puncsky/system-design-and-architecture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/puncsky/system-design-and-architecture](https://github.com/puncsky/system-design-and-architecture) |
| Source record ids | github_search_icons_and_logos-cc1e179d4dd06f |
...
For a systems engineer, puncsky/system-design-and-architecture belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-17T23:10:26Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-cc1e179d4dd06f` from `github_search_icons_and_logos` as `registry_expansion`
