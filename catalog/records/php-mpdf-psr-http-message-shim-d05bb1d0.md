...
<!-- canonical: https://packagist.org/packages/mpdf/psr-http-message-shim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mpdf/psr-http-message-shim](https://packagist.org/packages/mpdf/psr-http-message-shim) |
| Source record ids | packagist_search-6937b19bd9e3a2 |
...
For a systems engineer, mpdf/psr-http-message-shim belongs in the PHP inventory as part of service
...
- `packagist_search-6937b19bd9e3a2` from `packagist_search` as `registry_expansion`
