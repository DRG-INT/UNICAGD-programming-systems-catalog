...
<!-- canonical: https://cran.r-project.org/web/packages/p2distance/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/p2distance/index.html](https://cran.r-project.org/web/packages/p2distance/index.html) |
| Source record ids | cran_packages_by_date-49eb2a637ea673 |

## System Engineer Summary

Welfare's Synthetic Indicator

## Operational Role

For a systems engineer, p2distance belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-15 11:50:02 UTC | [https://cran.r-project.org/web/packages/p2distance/DESCRIPTION](https://cran.r-project.org/web/packages/p2distance/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/p2distance/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-49eb2a637ea673` from `cran_packages_by_date` as `registry_expansion`
