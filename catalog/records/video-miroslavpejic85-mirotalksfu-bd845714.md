...
<!-- canonical: https://github.com/miroslavpejic85/mirotalksfu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/miroslavpejic85/mirotalksfu](https://github.com/miroslavpejic85/mirotalksfu) |
| Source record ids | github_search_video-9091c9bb6a649c |

## System Engineer Summary

🏆 Self-hosted, open-source WebRTC video conferencing platform for real-time communication and
collaboration. A modern alternative to Zoom, Google Meet, Jitsi Meet, and Microsoft Teams, powered
by scalable SFU architecture with Mediasoup.

## Operational Role

For a systems engineer, miroslavpejic85/mirotalksfu belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T08:03:46Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-9091c9bb6a649c` from `github_search_video` as `registry_expansion`
