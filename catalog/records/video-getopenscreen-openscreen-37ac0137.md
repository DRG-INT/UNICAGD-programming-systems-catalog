...
<!-- canonical: https://github.com/getopenscreen/openscreen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/getopenscreen/openscreen](https://github.com/getopenscreen/openscreen) |
| Source record ids | github_search_video-ec7ef56e11b33b |

## System Engineer Summary

Record your screen, ship a demo. Free and open-source, GPU-accelerated, no watermarks, no
subscriptions. Windows, macOS, Linux. Actively maintained.

## Operational Role

For a systems engineer, getopenscreen/openscreen belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T19:07:30Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ec7ef56e11b33b` from `github_search_video` as `registry_expansion`
