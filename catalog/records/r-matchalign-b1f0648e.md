...
<!-- canonical: https://cran.r-project.org/web/packages/MatchAlign/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MatchAlign/index.html](https://cran.r-project.org/web/packages/MatchAlign/index.html) |
| Source record ids | cran_packages_by_date-3596de8e651f4d |

## System Engineer Summary

Parsing GFA and GAF Alignment Files

## Operational Role

For a systems engineer, MatchAlign belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-12 15:00:12 UTC | [https://cran.r-project.org/web/packages/MatchAlign/DESCRIPTION](https://cran.r-project.org/web/packages/MatchAlign/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MatchAlign/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-3596de8e651f4d` from `cran_packages_by_date` as `registry_expansion`
