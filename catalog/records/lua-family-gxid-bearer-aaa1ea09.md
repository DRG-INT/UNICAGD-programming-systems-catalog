...
| Canonical URL | [https://luarocks.org/modules/gx/gxid-bearer](https://luarocks.org/modules/gx/gxid-bearer) |
| Source record ids | luarocks_root_manifest-ade83a681ed570 |

## System Engineer Summary

gxid-bearer is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, gxid-bearer belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ade83a681ed570` from `luarocks_root_manifest` as `registry_expansion`
