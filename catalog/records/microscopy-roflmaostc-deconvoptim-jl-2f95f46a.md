...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/roflmaostc/DeconvOptim.jl](https://github.com/roflmaostc/DeconvOptim.jl) |
| Source record ids | github_search_microscopy-1455ac84a1572a |

## System Engineer Summary

A multi-dimensional, high performance deconvolution framework written in Julia Lang for CPUs and
GPUs.

## Operational Role

For a systems engineer, roflmaostc/DeconvOptim.jl belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.8.0 | 2026-08-24T17:08:35Z | [https://api.github.com/repos/roflmaostc/DeconvOptim.jl/releases/latest](https://api.github.com/repos/roflmaostc/DeconvOptim.jl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/roflmaostc/DeconvOptim.jl/releases/latest` at `2026-09-01T11:22:10+00:00`.
...
- `github_search_microscopy-1455ac84a1572a` from `github_search_microscopy` as `registry_expansion`
