...
| Canonical URL | [https://github.com/bbc/peaks.js](https://github.com/bbc/peaks.js) |
| Source record ids | github_search_audio-7bbee4eeb3e38e |
...
For a systems engineer, bbc/peaks.js belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.2 | 2024-08-15T19:46:53Z | [https://api.github.com/repos/bbc/peaks.js/releases/latest](https://api.github.com/repos/bbc/peaks.js/releases/latest) |  |
| preview | known | v4.0.0-beta.2 | 2025-05-13T08:18:58Z | [https://api.github.com/repos/bbc/peaks.js/releases?per_page=10](https://api.github.com/repos/bbc/peaks.js/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bbc/peaks.js/releases/latest` at `2026-09-01T09:23:15+00:00`.
...
- `github_search_audio-7bbee4eeb3e38e` from `github_search_audio` as `registry_expansion`
