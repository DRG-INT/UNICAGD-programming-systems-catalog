# toskao/descomplicandokubernetes
...
<!-- canonical: https://gitlab.com/toskao/descomplicandokubernetes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/toskao/descomplicandokubernetes](https://gitlab.com/toskao/descomplicandokubernetes) |
| Source record ids | gitlab_projects_api-8647dee94d46f8 |

## System Engineer Summary

Example GitBook site using GitLab Pages:

## Operational Role

For a systems engineer, toskao/descomplicandokubernetes belongs in the Repository Workplaces
...
- `gitlab_projects_api-8647dee94d46f8` from `gitlab_projects_api` as `registry_expansion`
