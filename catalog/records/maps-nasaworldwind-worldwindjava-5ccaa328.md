...
<!-- canonical: https://github.com/NASAWorldWind/WorldWindJava -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NASAWorldWind/WorldWindJava](https://github.com/NASAWorldWind/WorldWindJava) |
| Source record ids | github_search_maps-fcec56248666e6 |

## System Engineer Summary

The NASA WorldWind Java SDK (WWJ) is for building cross-platform 3D geospatial desktop applications
in Java.

## Operational Role

For a systems engineer, NASAWorldWind/WorldWindJava belongs in the Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-24T20:07:25Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-fcec56248666e6` from `github_search_maps` as `registry_expansion`
