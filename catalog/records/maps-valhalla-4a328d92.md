...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/maps.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/valhalla/valhalla](https://github.com/valhalla/valhalla) |
| Source record ids | curated_language_routes-23c46186c0e928 |

## System Engineer Summary

Open-source routing engine for navigation, map matching, multimodal routes, and turn-by-turn data.

## Operational Role

For a systems engineer, Valhalla belongs in the Maps inventory as part of service communication,
...
- `curated_language_routes-23c46186c0e928` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Nominatim | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/maps-nominatim-7f0fa10a.md) |
