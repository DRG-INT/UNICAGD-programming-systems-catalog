...
<!-- canonical: https://cran.r-project.org/web/packages/pdglasso/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pdglasso/index.html](https://cran.r-project.org/web/packages/pdglasso/index.html) |
| Source record ids | cran_packages_by_date-5955cb97e9428d |
...
For a systems engineer, pdglasso belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-09-08 13:30:09 UTC | [https://cran.r-project.org/web/packages/pdglasso/DESCRIPTION](https://cran.r-project.org/web/packages/pdglasso/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pdglasso/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-5955cb97e9428d` from `cran_packages_by_date` as `registry_expansion`
