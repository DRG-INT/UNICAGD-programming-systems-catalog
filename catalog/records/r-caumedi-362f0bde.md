...
<!-- canonical: https://cran.r-project.org/web/packages/CauMedi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CauMedi/index.html](https://cran.r-project.org/web/packages/CauMedi/index.html) |
| Source record ids | cran_packages_by_date-cb54789cb5b700 |

## System Engineer Summary

Cell Type-Specific Causal Mediation Models for Single-Cell Data

## Operational Role

For a systems engineer, CauMedi belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-04 13:50:12 UTC | [https://cran.r-project.org/web/packages/CauMedi/DESCRIPTION](https://cran.r-project.org/web/packages/CauMedi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CauMedi/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cb54789cb5b700` from `cran_packages_by_date` as `registry_expansion`
