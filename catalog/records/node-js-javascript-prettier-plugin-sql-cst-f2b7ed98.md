...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Formatter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/formatter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/prettier-plugin-sql-cst](https://www.npmjs.com/package/prettier-plugin-sql-cst) |
| Source record ids | npm_registry-423c4d246f1687 |

## System Engineer Summary

prettier-plugin-sql-cst is tracked as a formatter record in the Node.js/JavaScript branch. The
source did not provide a long description, so this page keeps the identity, release state,
provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, prettier-plugin-sql-cst belongs in the Node.js/JavaScript inventory as part
of low-noise code review, style consistency, and automation-friendly editing.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.1 | 2026-05-04T06:28:42.379Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-01T02:12:58+00:00`.
...
| Name | Category | Page |
| --- | --- | --- |
| @1password/prettier-config | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-1password-prettier-config-03cebd8d.md) |
| @adonisjs/prettier-config | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-adonisjs-prettier-config-c51ea836.md) |
| @airbnb/config-prettier | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-airbnb-config-prettier-8716aa9c.md) |
| @aleph-alpha/prettier-config-frontend | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aleph-alpha-prettier-config-frontend-e7e612ee.md) |
| @alexlit/config-prettier | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-alexlit-config-prettier-97e5a4ea.md) |
| @amedia/prettier-config | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-amedia-prettier-config-9f668e8e.md) |
| @anolilab/prettier-config | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-anolilab-prettier-config-c48051d5.md) |
| @aws-amplify/deployed-backend-client | Formatter | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-aws-amplify-deployed-backend-client-e7cf3524.md) |
