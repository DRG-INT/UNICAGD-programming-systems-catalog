...
<!-- canonical: https://github.com/Bahn-X/swift-composable-navigator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Bahn-X/swift-composable-navigator](https://github.com/Bahn-X/swift-composable-navigator) |
| Source record ids | awesome_list-5c70fcdcb34a50 |

## System Engineer Summary

An open source library for building deep-linkable SwiftUI applications with composition, testing and
ergonomics in mind

## Operational Role

For a systems engineer, Composable Navigator belongs in the Cocoa inventory as part of build graph
...
- `awesome_list-5c70fcdcb34a50` from `awesome_list` as `registry_expansion`
