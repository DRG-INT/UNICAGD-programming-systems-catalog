...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/stomp-queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stomp-queue](https://hackage.haskell.org/package/stomp-queue) |
| Source record ids | hackage_top_downloads-6e850d75b5a0e5 |
...
For a systems engineer, stomp-queue belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2020-12-27T12:55:57Z | [https://hackage.haskell.org/package/stomp-queue](https://hackage.haskell.org/package/stomp-queue) |  |
| candidate | partial | 0.0.5 |  | [https://hackage.haskell.org/package/stomp-queue](https://hackage.haskell.org/package/stomp-queue) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stomp-queue` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-6e850d75b5a0e5` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kafka-effectful | Message Broker | [open](haskell-kafka-effectful-c4242f81.md) |
| net-mqtt | Message Broker | [open](haskell-net-mqtt-a7b88a5b.md) |
| pqueue | Message Broker | [open](haskell-pqueue-ac6cbc50.md) |
| psqueues | Message Broker | [open](haskell-psqueues-b1fa6808.md) |
| shibuya-kafka-adapter | Message Broker | [open](haskell-shibuya-kafka-adapter-60dcb820.md) |
