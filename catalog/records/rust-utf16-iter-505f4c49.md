...
<!-- canonical: https://crates.io/crates/utf16_iter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/utf16_iter](https://crates.io/crates/utf16_iter) |
| Source record ids | crates_io-c34c6b4c88542c |
...
For a systems engineer, utf16_iter belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2023-12-01T17:42:42.216648Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-c34c6b4c88542c` from `crates_io` as `registry_expansion`
