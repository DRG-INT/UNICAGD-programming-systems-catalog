...
<!-- canonical: https://github.com/finos/TimeBase-CE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/finos/TimeBase-CE](https://github.com/finos/TimeBase-CE) |
| Source record ids | github_search_databases-168fb05a1474ed |
...
For a systems engineer, finos/TimeBase-CE belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T13:00:08Z | gh search repos topic:time-series-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-168fb05a1474ed` from `github_search_databases` as `registry_expansion`
