...
<!-- canonical: https://cran.r-project.org/web/packages/jointNmix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/jointNmix/index.html](https://cran.r-project.org/web/packages/jointNmix/index.html) |
| Source record ids | cran_packages_by_date-b4327fa4010150 |
...
For a systems engineer, jointNmix belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-1 | 2026-08-20 04:20:02 UTC | [https://cran.r-project.org/web/packages/jointNmix/DESCRIPTION](https://cran.r-project.org/web/packages/jointNmix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/jointNmix/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b4327fa4010150` from `cran_packages_by_date` as `registry_expansion`
