...
<!-- canonical: https://crates.io/crates/wit-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-parser](https://crates.io/crates/wit-parser) |
| Source record ids | crates_io-3560ece737cac4 |
...
For a systems engineer, wit-parser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.259.0 | 2026-09-10T17:56:54.988282Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-10T18:21:44+00:00`.
...
- `crates_io-3560ece737cac4` from `crates_io` as `registry_expansion`
