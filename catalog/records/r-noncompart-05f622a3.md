...
<!-- canonical: https://cran.r-project.org/web/packages/NonCompart/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NonCompart/index.html](https://cran.r-project.org/web/packages/NonCompart/index.html) |
| Source record ids | cran_packages_by_date-fedf56264a1cbb |
...
For a systems engineer, NonCompart belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2026-08-21 12:10:02 UTC | [https://cran.r-project.org/web/packages/NonCompart/DESCRIPTION](https://cran.r-project.org/web/packages/NonCompart/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NonCompart/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fedf56264a1cbb` from `cran_packages_by_date` as `registry_expansion`
