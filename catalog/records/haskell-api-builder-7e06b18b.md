...
<!-- canonical: https://hackage.haskell.org/package/api-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/api-builder](https://hackage.haskell.org/package/api-builder) |
| Source record ids | hackage_top_downloads-72bff35ce25164 |
...
For a systems engineer, api-builder belongs in the Haskell inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.0.0 | 2020-01-21T18:54:03Z | [https://hackage.haskell.org/package/api-builder](https://hackage.haskell.org/package/api-builder) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/api-builder` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-72bff35ce25164` from `hackage_top_downloads` as `registry_expansion`
