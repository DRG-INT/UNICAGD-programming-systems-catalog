...
<!-- canonical: https://hackage.haskell.org/package/sectile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/sectile](https://hackage.haskell.org/package/sectile) |
| Source record ids | hackage_recent-1197835ee1801b |

## System Engineer Summary

Hackage package recently uploaded by gdifolco.

## Operational Role

For a systems engineer, sectile belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0.0 | 2026-09-08T17:29:19Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-08T18:23:46+00:00`.
...
- `hackage_recent-1197835ee1801b` from `hackage_recent` as `registry_expansion`
