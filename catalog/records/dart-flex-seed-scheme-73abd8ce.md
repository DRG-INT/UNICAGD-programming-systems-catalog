...
<!-- canonical: https://pub.dev/packages/flex_seed_scheme -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flex_seed_scheme](https://pub.dev/packages/flex_seed_scheme) |
| Source record ids | pub_dev-37fdb7dc79a0da |

## System Engineer Summary

A more flexible and powerful version of Flutter's ColorScheme.fromSeed. Use multiple seed colors,
custom chroma and tone mapping.

## Operational Role

For a systems engineer, flex_seed_scheme belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.1 | 2026-08-30T21:01:25.561877Z | [https://pub.dev/api/packages/flex_seed_scheme](https://pub.dev/api/packages/flex_seed_scheme) |  |
| preview | known | 5.0.0-dev.1 | 2026-08-24T00:26:32.266828Z | [https://pub.dev/api/packages/flex_seed_scheme](https://pub.dev/api/packages/flex_seed_scheme) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flex_seed_scheme` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-37fdb7dc79a0da` from `pub_dev` as `registry_expansion`
