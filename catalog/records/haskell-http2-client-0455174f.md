...
<!-- canonical: https://hackage.haskell.org/package/http2-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http2-client](https://hackage.haskell.org/package/http2-client) |
| Source record ids | hackage_top_downloads-fe9ed49dcc4a04 |
...
For a systems engineer, http2-client belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0.2 | 2024-05-01T18:34:43Z | [https://hackage.haskell.org/package/http2-client](https://hackage.haskell.org/package/http2-client) |  |
| candidate | partial | 0.8.0.1 |  | [https://hackage.haskell.org/package/http2-client](https://hackage.haskell.org/package/http2-client) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http2-client` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-fe9ed49dcc4a04` from `hackage_top_downloads` as `registry_expansion`
