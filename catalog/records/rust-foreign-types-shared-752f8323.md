...
<!-- canonical: https://crates.io/crates/foreign-types-shared -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/foreign-types-shared](https://crates.io/crates/foreign-types-shared) |
| Source record ids | crates_io-b702bbd2a02037 |
...
For a systems engineer, foreign-types-shared belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2022-03-21T22:06:37.413498Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-b702bbd2a02037` from `crates_io` as `registry_expansion`
