...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/oddsapiR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/oddsapiR/index.html](https://cran.r-project.org/web/packages/oddsapiR/index.html) |
| Source record ids | cran_packages_by_date-72cf174200580e |
...
For a systems engineer, oddsapiR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-27 23:20:02 UTC | [https://cran.r-project.org/web/packages/oddsapiR/DESCRIPTION](https://cran.r-project.org/web/packages/oddsapiR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/oddsapiR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-72cf174200580e` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| actiwalkability | Api Abi Checker | [open](r-actiwalkability-88d9dd5c.md) |
| alepe | Api Abi Checker | [open](r-alepe-e7e73747.md) |
| alphavantagepf | Api Abi Checker | [open](r-alphavantagepf-39564484.md) |
| bigrquerystorage | Api Abi Checker | [open](r-bigrquerystorage-55805a4e.md) |
| bruno | Api Abi Checker | [open](r-bruno-1aca8836.md) |
| capn | Api Abi Checker | [open](r-capn-846ef6f0.md) |
| chiOpenData | Api Abi Checker | [open](r-chiopendata-b2c76002.md) |
| cincinnatiOpenData | Api Abi Checker | [open](r-cincinnatiopendata-7d923261.md) |
