...
<!-- canonical: https://crates.io/crates/wasip3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasip3](https://crates.io/crates/wasip3) |
| Source record ids | crates_io-992534c37b783f |
...
For a systems engineer, wasip3 belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0+wasi-0.3.0 | 2026-09-10T21:01:46.174573Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-10T22:18:17+00:00`.
...
- `crates_io-992534c37b783f` from `crates_io` as `registry_expansion`
