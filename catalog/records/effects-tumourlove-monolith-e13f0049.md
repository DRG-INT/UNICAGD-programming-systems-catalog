...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tumourlove/monolith -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tumourlove/monolith](https://github.com/tumourlove/monolith) |
| Source record ids | github_search_effects-c0fc7a61887f48 |

## System Engineer Summary

MCP plugin for Unreal Engine 5.7 & 5.8 — gives AI assistants full read/write access to Blueprints,
Materials, Niagara, Animation, Mesh, AI, GAS, Logic Driver, ComboGraph, UI, Audio, plus Reflection
Intelligence (decision / risk / C++ reflection / replication queries). 1,400+ actions across 25+
namespaces. Native C++, zero Python dependency.

## Operational Role

For a systems engineer, tumourlove/monolith belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T12:26:15Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-c0fc7a61887f48` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| chris-gardner/usd-noodle | Dependency Manager | [open](effects-chris-gardner-usd-noodle-cd2d05e7.md) |
| vbacollective/riff | Dependency Manager | [open](effects-vbacollective-riff-5f93725f.md) |
