...
<!-- canonical: https://cran.r-project.org/web/packages/HeatStressR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HeatStressR/index.html](https://cran.r-project.org/web/packages/HeatStressR/index.html) |
| Source record ids | cran_packages_by_date-2dc23f92c6ae89 |
...
For a systems engineer, HeatStressR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2026-08-07 22:00:15 UTC | [https://cran.r-project.org/web/packages/HeatStressR/DESCRIPTION](https://cran.r-project.org/web/packages/HeatStressR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HeatStressR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2dc23f92c6ae89` from `cran_packages_by_date` as `registry_expansion`
