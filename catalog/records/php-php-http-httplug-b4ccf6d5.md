...
<!-- canonical: https://packagist.org/packages/php-http/httplug -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/httplug](https://packagist.org/packages/php-http/httplug) |
| Source record ids | packagist_search-a340a09068ae00 |
...
For a systems engineer, php-http/httplug belongs in the PHP inventory as part of service
...
- `packagist_search-a340a09068ae00` from `packagist_search` as `registry_expansion`
