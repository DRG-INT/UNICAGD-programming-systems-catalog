...
<!-- canonical: https://cran.r-project.org/web/packages/KSgeneral/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/KSgeneral/index.html](https://cran.r-project.org/web/packages/KSgeneral/index.html) |
| Source record ids | cran_packages_by_date-05dc6cd78fe8b4 |

## System Engineer Summary

Computing P-Values of the One-Sample K-S Test and the Two-Sample K-S and Kuiper Tests for
(Dis)Continuous Null Distribution

## Operational Role

For a systems engineer, KSgeneral belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-23 03:50:08 UTC | [https://cran.r-project.org/web/packages/KSgeneral/DESCRIPTION](https://cran.r-project.org/web/packages/KSgeneral/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/KSgeneral/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-05dc6cd78fe8b4` from `cran_packages_by_date` as `registry_expansion`
