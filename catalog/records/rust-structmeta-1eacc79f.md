...
| Canonical URL | [https://crates.io/crates/structmeta](https://crates.io/crates/structmeta) |
| Source record ids | crates_io-be1238912aca8a |
...
For a systems engineer, structmeta belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-07-22T15:10:19.584002Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-be1238912aca8a` from `crates_io` as `registry_expansion`
