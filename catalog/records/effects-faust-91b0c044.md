...
| Source record ids | curated_language_routes-90e45f541aed36 |

## System Engineer Summary

Functional DSP language and compiler for audio effects, synthesis, plug-ins, and embedded targets.

## Operational Role

For a systems engineer, Faust belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.85.9 | 2026-07-01T05:59:07Z | [https://api.github.com/repos/grame-cncm/faust/releases/latest](https://api.github.com/repos/grame-cncm/faust/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/grame-cncm/faust/releases/latest` at `2026-09-01T07:24:45+00:00`.
...
- `curated_language_routes-90e45f541aed36` from `curated_language_routes` as `registry_expansion`
