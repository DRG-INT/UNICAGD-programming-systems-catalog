...
<!-- canonical: https://crates.io/crates/actix-router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-router](https://crates.io/crates/actix-router) |
| Source record ids | crates_io-2e49fd8ffb0335 |
...
For a systems engineer, actix-router belongs in the Rust inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4 | 2026-02-18T10:04:20.875730Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-2e49fd8ffb0335` from `crates_io` as `registry_expansion`
...
| if_chain | Web Framework | [open](rust-if-chain-94e3791a.md) |
