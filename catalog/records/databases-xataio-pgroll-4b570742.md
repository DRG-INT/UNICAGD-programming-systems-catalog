...
<!-- canonical: https://github.com/xataio/pgroll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xataio/pgroll](https://github.com/xataio/pgroll) |
| Source record ids | github_search_databases-0373ca5b61b6b3 |
...
For a systems engineer, xataio/pgroll belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T08:40:31Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0373ca5b61b6b3` from `github_search_databases` as `registry_expansion`
