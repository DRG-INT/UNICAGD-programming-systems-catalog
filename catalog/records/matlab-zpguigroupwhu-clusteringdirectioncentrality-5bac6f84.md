...
<!-- canonical: https://github.com/ZPGuiGroupWhu/ClusteringDirectionCentrality -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ZPGuiGroupWhu/ClusteringDirectionCentrality](https://github.com/ZPGuiGroupWhu/ClusteringDirectionCentrality) |
| Source record ids | github_search_matlab-ee031824b9f810 |

## System Engineer Summary

A novel Clustering algorithm by measuring Direction Centrality (CDC) locally. It adopts a density-
independent metric based on the distribution of K-nearest neighbors (KNNs) to distinguish between
internal and boundary points. The boundary points generate enclosed cages to bind the connections of
internal points.

## Operational Role

For a systems engineer, ZPGuiGroupWhu/ClusteringDirectionCentrality belongs in the Matlab inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-13T13:29:27Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-ee031824b9f810` from `github_search_matlab` as `registry_expansion`
