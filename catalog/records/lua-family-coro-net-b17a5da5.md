...
<!-- canonical: https://luarocks.org/modules/code-nuage/coro-net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/code-nuage/coro-net](https://luarocks.org/modules/code-nuage/coro-net) |
| Source record ids | luarocks_root_manifest-790eb19b85a58b |

## System Engineer Summary

coro-net is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, coro-net belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-790eb19b85a58b` from `luarocks_root_manifest` as `registry_expansion`
