...
<!-- canonical: https://hackage.haskell.org/package/amazonka-ecs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-ecs](https://hackage.haskell.org/package/amazonka-ecs) |
| Source record ids | hackage_top_downloads-747194a6f207fe |
...
For a systems engineer, amazonka-ecs belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:11:19Z | [https://hackage.haskell.org/package/amazonka-ecs](https://hackage.haskell.org/package/amazonka-ecs) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-ecs` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-747194a6f207fe` from `hackage_top_downloads` as `registry_expansion`
