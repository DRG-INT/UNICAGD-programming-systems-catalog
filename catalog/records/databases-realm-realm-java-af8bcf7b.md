...
<!-- canonical: https://github.com/realm/realm-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realm/realm-java](https://github.com/realm/realm-java) |
| Source record ids | github_search_databases-9067a57703ba14 |
...
For a systems engineer, realm/realm-java belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-15T18:19:00Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9067a57703ba14` from `github_search_databases` as `registry_expansion`
