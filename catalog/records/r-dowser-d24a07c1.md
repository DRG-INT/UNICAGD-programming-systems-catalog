...
<!-- canonical: https://cran.r-project.org/web/packages/dowser/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dowser/index.html](https://cran.r-project.org/web/packages/dowser/index.html) |
| Source record ids | cran_packages_by_date-0f15b6c7d44286 |
...
For a systems engineer, dowser belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.1 | 2026-08-20 11:20:10 UTC | [https://cran.r-project.org/web/packages/dowser/DESCRIPTION](https://cran.r-project.org/web/packages/dowser/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dowser/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0f15b6c7d44286` from `cran_packages_by_date` as `registry_expansion`
