...
<!-- canonical: https://github.com/fooyin/fooyin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fooyin/fooyin](https://github.com/fooyin/fooyin) |
| Source record ids | github_search_video-65de4a8315bb89 |
...
For a systems engineer, fooyin/fooyin belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T07:22:50Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-65de4a8315bb89` from `github_search_video` as `registry_expansion`
