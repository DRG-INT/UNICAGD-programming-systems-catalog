...
<!-- canonical: https://github.com/giladaya/arduino-particle-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/giladaya/arduino-particle-sys](https://github.com/giladaya/arduino-particle-sys) |
| Source record ids | github_search_effects-3f0e3fe8cef7d7 |
...
For a systems engineer, giladaya/arduino-particle-sys belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-05-18T20:05:20Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3f0e3fe8cef7d7` from `github_search_effects` as `registry_expansion`
