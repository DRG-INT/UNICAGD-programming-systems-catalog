...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BrazilCentralBank](https://github.com/JuliaRegistries/General/tree/master/B/BrazilCentralBank) |
| Source record ids | julia_general-de4d1c1fdc6fde |

## System Engineer Summary

Julia package registered in General at B/BrazilCentralBank.

## Operational Role

For a systems engineer, BrazilCentralBank belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BrazilCentralBank", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-de4d1c1fdc6fde` from `julia_general` as `registry_expansion`
