...
<!-- canonical: https://github.com/EmergeTools/Pow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EmergeTools/Pow](https://github.com/EmergeTools/Pow) |
| Source record ids | github_search_swift-6de44a263df11b |
...
For a systems engineer, EmergeTools/Pow belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-13T04:12:15Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-6de44a263df11b` from `github_search_swift` as `registry_expansion`
