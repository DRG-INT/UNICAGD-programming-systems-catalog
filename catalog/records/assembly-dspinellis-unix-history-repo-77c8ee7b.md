...
<!-- canonical: https://github.com/dspinellis/unix-history-repo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dspinellis/unix-history-repo](https://github.com/dspinellis/unix-history-repo) |
| Source record ids | github_search_assembly-28c28b0aaa1ebc |
...
For a systems engineer, dspinellis/unix-history-repo belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-05T16:53:18Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-28c28b0aaa1ebc` from `github_search_assembly` as `registry_expansion`
