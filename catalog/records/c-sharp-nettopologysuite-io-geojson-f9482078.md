...
<!-- canonical: https://www.nuget.org/packages/NetTopologySuite.IO.GeoJSON -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/NetTopologySuite.IO.GeoJSON](https://www.nuget.org/packages/NetTopologySuite.IO.GeoJSON) |
| Source record ids | nuget_search-40560909e9520c |

## System Engineer Summary

This package contains the GeoJSON IO library. Portions of this library were inspired from an early
version of GeoJSON.Net by Jörg Battermann.

## Operational Role

For a systems engineer, NetTopologySuite.IO.GeoJSON belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2023-09-15T11:06:18.78+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nettopologysuite.io.geojson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nettopologysuite.io.geojson/index.json) |  |
| preview | known | 2.0.0-pre001 | 2019-08-25T02:16:01.407+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nettopologysuite.io.geojson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nettopologysuite.io.geojson/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; BSD-3-Clause; https://www.nuget.org/packages/NetTopologySuite.IO.GeoJSON/4.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/nettopologysuite.io.geojson/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-40560909e9520c` from `nuget_search` as `registry_expansion`
