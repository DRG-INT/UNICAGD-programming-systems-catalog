...
<!-- canonical: https://pub.dev/packages/cronet_http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/cronet_http](https://pub.dev/packages/cronet_http) |
| Source record ids | pub_dev-3c3179fcf83bdd |
...
For a systems engineer, cronet_http belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-06-23T17:45:00.287210Z | [https://pub.dev/api/packages/cronet_http](https://pub.dev/api/packages/cronet_http) |  |
| preview | known | 0.4.0-jni | 2023-09-14T18:32:26.515098Z | [https://pub.dev/api/packages/cronet_http](https://pub.dev/api/packages/cronet_http) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/cronet_http` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-3c3179fcf83bdd` from `pub_dev` as `registry_expansion`
