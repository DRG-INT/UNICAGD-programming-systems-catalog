...
<!-- canonical: https://crates.io/crates/hyper-util -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hyper-util](https://crates.io/crates/hyper-util) |
| Source record ids | crates_io-2434fa1da736ad |

## System Engineer Summary

hyper-util is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, hyper-util belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.20 | 2026-02-02T14:17:16.623245Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-2434fa1da736ad` from `crates_io` as `registry_expansion`
