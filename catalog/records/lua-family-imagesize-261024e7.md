...
| Canonical URL | [https://luarocks.org/modules/leafo/imagesize](https://luarocks.org/modules/leafo/imagesize) |
| Source record ids | luarocks_root_manifest-aa80458620dd2e |
...
For a systems engineer, imagesize belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-aa80458620dd2e` from `luarocks_root_manifest` as `registry_expansion`
