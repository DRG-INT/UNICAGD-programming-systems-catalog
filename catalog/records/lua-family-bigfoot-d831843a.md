...
<!-- canonical: https://luarocks.org/modules/freed-wu/bigfoot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/bigfoot](https://luarocks.org/modules/freed-wu/bigfoot) |
| Source record ids | luarocks_root_manifest-638eb7b1620234 |
...
For a systems engineer, bigfoot belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-638eb7b1620234` from `luarocks_root_manifest` as `registry_expansion`
