...
| Canonical URL | [https://crates.io/crates/fontconfig-parser](https://crates.io/crates/fontconfig-parser) |
| Source record ids | crates_io-df9585c7d3c400 |
...
For a systems engineer, fontconfig-parser belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.8 | 2025-05-12T11:37:45.648663Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-df9585c7d3c400` from `crates_io` as `registry_expansion`
