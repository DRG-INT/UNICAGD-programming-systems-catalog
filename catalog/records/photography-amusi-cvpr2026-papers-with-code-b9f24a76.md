...
<!-- canonical: https://github.com/amusi/CVPR2026-Papers-with-Code -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amusi/CVPR2026-Papers-with-Code](https://github.com/amusi/CVPR2026-Papers-with-Code) |
| Source record ids | github_search_photography-c4cc4403fa7a7b |

## System Engineer Summary

amusi/CVPR2026-Papers-with-Code is tracked as an image audio dsp record in the Photography branch.
...
For a systems engineer, amusi/CVPR2026-Papers-with-Code belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-08T07:27:34Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c4cc4403fa7a7b` from `github_search_photography` as `registry_expansion`
