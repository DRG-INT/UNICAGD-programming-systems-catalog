...
<!-- canonical: https://github.com/jthuraisamy/SysWhispers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jthuraisamy/SysWhispers](https://github.com/jthuraisamy/SysWhispers) |
| Source record ids | github_search_assembly-e16ac739c86c8a |
...
For a systems engineer, jthuraisamy/SysWhispers belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-01T03:42:21Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-e16ac739c86c8a` from `github_search_assembly` as `registry_expansion`
