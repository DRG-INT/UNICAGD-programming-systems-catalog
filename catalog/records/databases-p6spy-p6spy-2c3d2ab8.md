...
<!-- canonical: https://github.com/p6spy/p6spy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/p6spy/p6spy](https://github.com/p6spy/p6spy) |
| Source record ids | github_search_databases-b47bf8b0b826ef |

## System Engineer Summary

P6Spy is a framework that enables database data to be seamlessly intercepted and logged with no code
changes to the application.

## Operational Role

For a systems engineer, p6spy/p6spy belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-21T16:46:12Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b47bf8b0b826ef` from `github_search_databases` as `registry_expansion`
