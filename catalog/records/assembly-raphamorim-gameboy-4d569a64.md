...
<!-- canonical: https://github.com/raphamorim/gameboy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/raphamorim/gameboy](https://github.com/raphamorim/gameboy) |
| Source record ids | github_search_assembly-592d2b0fa41d6e |
...
For a systems engineer, raphamorim/gameboy belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-04T18:57:27Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-592d2b0fa41d6e` from `github_search_assembly` as `registry_expansion`
