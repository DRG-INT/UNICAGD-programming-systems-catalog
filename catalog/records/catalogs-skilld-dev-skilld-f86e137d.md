...
<!-- canonical: https://github.com/skilld-dev/skilld -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skilld-dev/skilld](https://github.com/skilld-dev/skilld) |
| Source record ids | github_search_catalogs-033724997c906a |

## System Engineer Summary

Curated Agent Skills with a human author. Search, run, install, and keep them current from one CLI.

## Operational Role

For a systems engineer, skilld-dev/skilld belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:05:44Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-033724997c906a` from `github_search_catalogs` as `registry_expansion`
