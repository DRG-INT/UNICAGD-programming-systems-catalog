...
| Source record ids | lua-source-183 |

## System Engineer Summary

lua-source-183 is tracked as a concurrency parallelism record in the Lua family branch. The source
...
For a systems engineer, lua-source-183 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 183}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-183` from `master_json` as `source_list_item`
...
| lua-source-187 | Concurrency Parallelism | [open](lua-family-lua-source-187-4f7473bd.md) |
