...
| Canonical URL | [https://crates.io/crates/indicatif](https://crates.io/crates/indicatif) |
| Source record ids | corpus-cfca486c3cf9ef, crates_io-81812097f19ed9 |
...
For a systems engineer, indicatif belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.6 | 2026-07-01T13:45:24.733589Z | [https://crates.io/api/v1/crates/indicatif](https://crates.io/api/v1/crates/indicatif) |  |
| preview | known | 0.17.0-rc.11 | 2022-05-24T21:35:26.521203Z | [https://crates.io/api/v1/crates/indicatif](https://crates.io/api/v1/crates/indicatif) |  |

## Engineering Notes

- Treat category as `cli` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/indicatif` at `2026-09-01T02:12:58+00:00`.
...
- `corpus-cfca486c3cf9ef` from `master_json` as `cli`
- `crates_io-81812097f19ed9` from `crates_io` as `registry_expansion`
