...
<!-- canonical: https://cran.r-project.org/web/packages/circumplex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/circumplex/index.html](https://cran.r-project.org/web/packages/circumplex/index.html) |
| Source record ids | cran_packages_by_date-855e18da4007ff |
...
For a systems engineer, circumplex belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-02 21:40:03 UTC | [https://cran.r-project.org/web/packages/circumplex/DESCRIPTION](https://cran.r-project.org/web/packages/circumplex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/circumplex/DESCRIPTION` at `2026-09-02T22:19:13+00:00`.
...
- `cran_packages_by_date-855e18da4007ff` from `cran_packages_by_date` as `registry_expansion`
