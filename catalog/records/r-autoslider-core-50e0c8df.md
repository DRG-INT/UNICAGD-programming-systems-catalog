...
<!-- canonical: https://cran.r-project.org/web/packages/autoslider.core/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autoslider.core/index.html](https://cran.r-project.org/web/packages/autoslider.core/index.html) |
| Source record ids | cran_packages_by_date-aa136c0d3ff101 |
...
For a systems engineer, autoslider.core belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2026-08-29 17:20:02 UTC | [https://cran.r-project.org/web/packages/autoslider.core/DESCRIPTION](https://cran.r-project.org/web/packages/autoslider.core/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autoslider.core/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-aa136c0d3ff101` from `cran_packages_by_date` as `registry_expansion`
