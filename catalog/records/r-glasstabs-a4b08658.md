...
<!-- canonical: https://cran.r-project.org/web/packages/glasstabs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glasstabs/index.html](https://cran.r-project.org/web/packages/glasstabs/index.html) |
| Source record ids | cran_packages_by_date-9e6ec5f81fed1f |

## System Engineer Summary

Animated Glass-Style Tabs and Select Inputs for 'Shiny'

## Operational Role

For a systems engineer, glasstabs belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-11 15:50:13 UTC | [https://cran.r-project.org/web/packages/glasstabs/DESCRIPTION](https://cran.r-project.org/web/packages/glasstabs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glasstabs/DESCRIPTION` at `2026-09-11T16:21:15+00:00`.
...
- `cran_packages_by_date-9e6ec5f81fed1f` from `cran_packages_by_date` as `registry_expansion`
