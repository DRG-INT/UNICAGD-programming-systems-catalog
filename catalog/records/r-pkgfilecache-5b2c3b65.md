...
<!-- canonical: https://cran.r-project.org/web/packages/pkgfilecache/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pkgfilecache/index.html](https://cran.r-project.org/web/packages/pkgfilecache/index.html) |
| Source record ids | cran_packages_by_date-76170f8a73c176 |
...
For a systems engineer, pkgfilecache belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-31 22:20:02 UTC | [https://cran.r-project.org/web/packages/pkgfilecache/DESCRIPTION](https://cran.r-project.org/web/packages/pkgfilecache/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pkgfilecache/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-76170f8a73c176` from `cran_packages_by_date` as `registry_expansion`
