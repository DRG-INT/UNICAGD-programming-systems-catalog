...
<!-- canonical: https://github.com/FRRouting/frr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FRRouting/frr](https://github.com/FRRouting/frr) |
| Source record ids | github_search_maps-e0a1a38ae0a815 |
...
For a systems engineer, FRRouting/frr belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:02:17Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-e0a1a38ae0a815` from `github_search_maps` as `registry_expansion`
