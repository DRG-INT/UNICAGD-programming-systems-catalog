...
<!-- canonical: https://hackage.haskell.org/package/MissingH -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/MissingH](https://hackage.haskell.org/package/MissingH) |
| Source record ids | hackage_top_downloads-e3ecafc5d7bd4f |
...
For a systems engineer, MissingH belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0.3 | 2026-01-07T08:02:37Z | [https://hackage.haskell.org/package/MissingH](https://hackage.haskell.org/package/MissingH) |  |
| candidate | partial | 1.3.0.2 |  | [https://hackage.haskell.org/package/MissingH](https://hackage.haskell.org/package/MissingH) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/MissingH` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-e3ecafc5d7bd4f` from `hackage_top_downloads` as `registry_expansion`
