...
<!-- canonical: https://github.com/cggos/imu_x_fusion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cggos/imu_x_fusion](https://github.com/cggos/imu_x_fusion) |
| Source record ids | github_search_radars-1e197e122c82fb |

## System Engineer Summary

IMU + X(GNSS, 6DoF Odom) Loosely-Coupled Fusion Localization based on ESKF, IEKF, UKF(UKF/SPKF,
JUKF, SVD-UKF) and MAP

## Operational Role

For a systems engineer, cggos/imu_x_fusion belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-28T10:28:25Z | gh search repos topic:gnss stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-1e197e122c82fb` from `github_search_radars` as `registry_expansion`
