...
<!-- canonical: https://cran.r-project.org/web/packages/bruno/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bruno/index.html](https://cran.r-project.org/web/packages/bruno/index.html) |
| Source record ids | cran_packages_by_date-919fdd38dd5e2b |

## System Engineer Summary

Predicting User-Defined Event Recurrence under Exchangeability

## Operational Role

For a systems engineer, bruno belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 13:30:38 UTC | [https://cran.r-project.org/web/packages/bruno/DESCRIPTION](https://cran.r-project.org/web/packages/bruno/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bruno/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-919fdd38dd5e2b` from `cran_packages_by_date` as `registry_expansion`
