...
| Canonical URL | [https://crates.io/crates/nonempty](https://crates.io/crates/nonempty) |
| Source record ids | crates_io-8a87c765e00a0d |
...
For a systems engineer, nonempty belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2025-07-19T14:13:47.493811Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-8a87c765e00a0d` from `crates_io` as `registry_expansion`
