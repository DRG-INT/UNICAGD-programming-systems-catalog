...
<!-- canonical: https://packagist.org/packages/behat/mink-selenium2-driver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/behat/mink-selenium2-driver](https://packagist.org/packages/behat/mink-selenium2-driver) |
| Source record ids | packagist_search-ae7d90b329eb1c |
...
For a systems engineer, behat/mink-selenium2-driver belongs in the PHP inventory as part of
...
- `packagist_search-ae7d90b329eb1c` from `packagist_search` as `registry_expansion`
