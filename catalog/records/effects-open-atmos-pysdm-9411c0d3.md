...
<!-- canonical: https://github.com/open-atmos/PySDM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-atmos/PySDM](https://github.com/open-atmos/PySDM) |
| Source record ids | github_search_effects-777e7a0b63e1de |

## System Engineer Summary

Pythonic particle-based (super-droplet) cloud microphysics (and aqueous-chemistry) package with box,
parcel & 1D/2D prescribed-flow examples in Python, Julia and Matlab

## Operational Role

For a systems engineer, open-atmos/PySDM belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T11:28:40Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-777e7a0b63e1de` from `github_search_effects` as `registry_expansion`
