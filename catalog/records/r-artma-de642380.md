...
<!-- canonical: https://cran.r-project.org/web/packages/artma/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/artma/index.html](https://cran.r-project.org/web/packages/artma/index.html) |
| Source record ids | cran_packages_by_date-78b12c8f6e3fa3 |
...
For a systems engineer, artma belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-20 05:10:02 UTC | [https://cran.r-project.org/web/packages/artma/DESCRIPTION](https://cran.r-project.org/web/packages/artma/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/artma/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-78b12c8f6e3fa3` from `cran_packages_by_date` as `registry_expansion`
