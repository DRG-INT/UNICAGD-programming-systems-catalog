...
<!-- canonical: https://www.nuget.org/packages/LaunchDarkly.JsonStream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/LaunchDarkly.JsonStream](https://www.nuget.org/packages/LaunchDarkly.JsonStream) |
| Source record ids | nuget_search-d5c1b63ffe7f9e |
...
For a systems engineer, LaunchDarkly.JsonStream belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2023-02-27T20:54:06.91+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/launchdarkly.jsonstream/index.json](https://api.nuget.org/v3/registration5-gz-semver2/launchdarkly.jsonstream/index.json) |  |
...
| Evidence | MIT + file LICENSE; {"key": "", "name": "", "url": ""}; Apache-2.0; https://www.nuget.org/packages/LaunchDarkly.JsonStream/1.1.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/launchdarkly.jsonstream/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-d5c1b63ffe7f9e` from `nuget_search` as `registry_expansion`
