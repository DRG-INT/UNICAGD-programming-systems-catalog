...
<!-- canonical: https://pub.dev/packages/sprung -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sprung](https://pub.dev/packages/sprung) |
| Source record ids | pub_dev-1026b74eaeae40 |
...
For a systems engineer, sprung belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2022-07-27T13:31:26.056844Z | [https://pub.dev/api/packages/sprung](https://pub.dev/api/packages/sprung) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sprung` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-1026b74eaeae40` from `pub_dev` as `registry_expansion`
