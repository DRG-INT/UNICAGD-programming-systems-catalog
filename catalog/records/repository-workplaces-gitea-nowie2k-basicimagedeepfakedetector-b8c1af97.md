# Gitea: noWie2k/basicImageDeepfakeDetector
...
<!-- canonical: https://gitea.com/noWie2k/basicImageDeepfakeDetector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/noWie2k/basicImageDeepfakeDetector](https://gitea.com/noWie2k/basicImageDeepfakeDetector) |
| Source record ids | gitea_repositories_api-dfb2cc7d7c46fb |

## System Engineer Summary

basicImageDeepfakeDetector is a very basic deepfake detector that uses metadata to determine weather
an Image is "deepfake" or not.

## Operational Role

For a systems engineer, Gitea: noWie2k/basicImageDeepfakeDetector belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-24T01:15:13Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-dfb2cc7d7c46fb` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| mindsphere/devops-demo | Image Audio Dsp | [open](repository-workplaces-mindsphere-devops-demo-a54808d3.md) |
