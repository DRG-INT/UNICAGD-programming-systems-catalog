...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_game_engines-e0b381dc11b62c |
...
For a systems engineer, iamlukethedev/Claw3D belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T11:07:08Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e0b381dc11b62c` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cocos/cocos-engine | Benchmarking | [open](game-engines-cocos-cocos-engine-8165bebe.md) |
| crownengine/crown | Benchmarking | [open](game-engines-crownengine-crown-8218ff4b.md) |
| TokisanGames/Terrain3D | Benchmarking | [open](game-engines-tokisangames-terrain3d-500e25fb.md) |
| ultralight-ux/Ultralight | Benchmarking | [open](game-engines-ultralight-ux-ultralight-6ca2dde5.md) |
