...
<!-- canonical: https://cran.r-project.org/web/packages/gridmicrotex/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gridmicrotex/index.html](https://cran.r-project.org/web/packages/gridmicrotex/index.html) |
| Source record ids | cran_packages_by_date-6e43ce0f661bc8 |

## System Engineer Summary

Native 'LaTeX' Math Rendering for Grid Graphics

## Operational Role

For a systems engineer, gridmicrotex belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-24 07:30:20 UTC | [https://cran.r-project.org/web/packages/gridmicrotex/DESCRIPTION](https://cran.r-project.org/web/packages/gridmicrotex/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gridmicrotex/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6e43ce0f661bc8` from `cran_packages_by_date` as `registry_expansion`
