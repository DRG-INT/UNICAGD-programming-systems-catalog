...
<!-- canonical: https://hackage.haskell.org/package/shikumi-trace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-trace](https://hackage.haskell.org/package/shikumi-trace) |
| Source record ids | hackage_recent-31305628b3873b |
...
For a systems engineer, shikumi-trace belongs in the Haskell inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.0 | 2026-09-08T19:34:33Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-31305628b3873b` from `hackage_recent` as `registry_expansion`
