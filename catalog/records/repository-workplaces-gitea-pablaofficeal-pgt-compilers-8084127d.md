# Gitea: pablaofficeal/PGT-compilers
...
<!-- canonical: https://gitea.com/pablaofficeal/PGT-compilers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/pablaofficeal/PGT-compilers](https://gitea.com/pablaofficeal/PGT-compilers) |
| Source record ids | gitea_repositories_api-1f108b5496a5bb |
...
For a systems engineer, Gitea: pablaofficeal/PGT-compilers belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T17:54:54Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-1f108b5496a5bb` from `gitea_repositories_api` as `registry_expansion`
