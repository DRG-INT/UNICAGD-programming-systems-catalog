...
<!-- canonical: https://packagist.org/packages/infection/infection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/infection/infection](https://packagist.org/packages/infection/infection) |
| Source record ids | packagist_search-aa0c33bca3b33c |

## System Engineer Summary

Infection is a Mutation Testing framework for PHP. The mutation adequacy score can be used to
measure the effectiveness of a test set in terms of its ability to detect faults.

## Operational Role

For a systems engineer, infection/infection belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-aa0c33bca3b33c` from `packagist_search` as `registry_expansion`
