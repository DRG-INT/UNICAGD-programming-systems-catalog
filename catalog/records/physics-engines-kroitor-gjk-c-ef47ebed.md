...
<!-- canonical: https://github.com/kroitor/gjk.c -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kroitor/gjk.c](https://github.com/kroitor/gjk.c) |
| Source record ids | github_search_physics_engines-4420ce08b2ddff |
...
For a systems engineer, kroitor/gjk.c belongs in the Physics Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-13T02:39:45Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-4420ce08b2ddff` from `github_search_physics_engines` as `registry_expansion`
