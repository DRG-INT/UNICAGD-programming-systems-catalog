...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bwajtr/java-persistence-frameworks-comparison -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bwajtr/java-persistence-frameworks-comparison](https://github.com/bwajtr/java-persistence-frameworks-comparison) |
| Source record ids | github_search_databases-3ee8c0fe2be2e5 |

## System Engineer Summary

Comparison of non-JPA SQL mapping frameworks for Java (Jooq, Spring JDBCTemplate, MyBatis, EBean,
JDBI, Speedment, sql2o)

## Operational Role

For a systems engineer, bwajtr/java-persistence-frameworks-comparison belongs in the Databases
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-30T07:07:44Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3ee8c0fe2be2e5` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fastapi/full-stack-fastapi-template | Project Scaffolding | [open](databases-fastapi-full-stack-fastapi-template-ee26fae0.md) |
| Patroni | Project Scaffolding | [open](databases-patroni-581c2ddc.md) |
| patroni/patroni | Project Scaffolding | [open](databases-patroni-patroni-5638a23a.md) |
| wasp-lang/open-saas | Project Scaffolding | [open](databases-wasp-lang-open-saas-7ae427a8.md) |
