...
<!-- canonical: https://github.com/Mintplex-Labs/anything-llm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) |
| Source record ids | github_search_databases-f756ac95433ee9 |

## System Engineer Summary

Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-
first agent experience

## Operational Role

For a systems engineer, Mintplex-Labs/anything-llm belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T03:33:26Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f756ac95433ee9` from `github_search_databases` as `registry_expansion`
