...
| Canonical URL | [https://crates.io/crates/prost-wkt](https://crates.io/crates/prost-wkt) |
| Source record ids | crates_io-f6a790a7cd04f9 |
...
For a systems engineer, prost-wkt belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2026-08-23T16:35:30.258509Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-f6a790a7cd04f9` from `crates_io` as `registry_expansion`
