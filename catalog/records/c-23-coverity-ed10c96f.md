...
| Source record ids | corpus-a644aa7b47d773 |

## System Engineer Summary

Coverity is tracked as a static analyzer record in the C++23 branch. The source did not provide a
...
For a systems engineer, Coverity belongs in the C++23 inventory as part of defect discovery,
...
- `corpus-a644aa7b47d773` from `master_json` as `static_analyzer`
