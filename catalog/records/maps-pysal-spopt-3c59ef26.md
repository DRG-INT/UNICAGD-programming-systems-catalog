...
<!-- canonical: https://github.com/pysal/spopt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pysal/spopt](https://github.com/pysal/spopt) |
| Source record ids | github_search_maps-29561d7bd71bd0 |

## System Engineer Summary

pysal/spopt is tracked as a library record in the Maps branch. The source did not provide a long
...
For a systems engineer, pysal/spopt belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-07T02:43:16Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-29561d7bd71bd0` from `github_search_maps` as `registry_expansion`
