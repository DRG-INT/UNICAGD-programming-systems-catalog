...
<!-- canonical: https://cran.r-project.org/web/packages/learningtower/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/learningtower/index.html](https://cran.r-project.org/web/packages/learningtower/index.html) |
| Source record ids | cran_packages_by_date-03cc2b3f7251fa |

## System Engineer Summary

OECD PISA Datasets from 2000-2022 in an Easy-to-Use Format

## Operational Role

For a systems engineer, learningtower belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-25 10:50:08 UTC | [https://cran.r-project.org/web/packages/learningtower/DESCRIPTION](https://cran.r-project.org/web/packages/learningtower/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/learningtower/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-03cc2b3f7251fa` from `cran_packages_by_date` as `registry_expansion`
