...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-zmq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-zmq](https://luarocks.org/modules/moyu/dromozoa-zmq) |
| Source record ids | luarocks_root_manifest-8dfa8db5092d77 |

## System Engineer Summary

dromozoa-zmq is tracked as a ffi bindings record in the Lua family branch. The source did not
...
For a systems engineer, dromozoa-zmq belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-8dfa8db5092d77` from `luarocks_root_manifest` as `registry_expansion`
