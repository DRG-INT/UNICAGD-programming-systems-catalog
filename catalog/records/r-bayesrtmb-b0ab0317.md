...
<!-- canonical: https://cran.r-project.org/web/packages/BayesRTMB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesRTMB/index.html](https://cran.r-project.org/web/packages/BayesRTMB/index.html) |
| Source record ids | cran_packages_by_date-8b242d397b7b21 |
...
For a systems engineer, BayesRTMB belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-20 12:12:04 UTC | [https://cran.r-project.org/web/packages/BayesRTMB/DESCRIPTION](https://cran.r-project.org/web/packages/BayesRTMB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesRTMB/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8b242d397b7b21` from `cran_packages_by_date` as `registry_expansion`
