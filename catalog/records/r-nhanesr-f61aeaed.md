...
<!-- canonical: https://cran.r-project.org/web/packages/nhanesR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nhanesR/index.html](https://cran.r-project.org/web/packages/nhanesR/index.html) |
| Source record ids | cran_packages_by_date-983556b1f067d6 |
...
For a systems engineer, nhanesR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-25 11:00:37 UTC | [https://cran.r-project.org/web/packages/nhanesR/DESCRIPTION](https://cran.r-project.org/web/packages/nhanesR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nhanesR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-983556b1f067d6` from `cran_packages_by_date` as `registry_expansion`
