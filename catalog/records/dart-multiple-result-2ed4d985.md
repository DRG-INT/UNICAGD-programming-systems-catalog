...
<!-- canonical: https://pub.dev/packages/multiple_result -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/multiple_result](https://pub.dev/packages/multiple_result) |
| Source record ids | pub_dev-be869ba194065d |
...
For a systems engineer, multiple_result belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.0 | 2026-03-14T19:13:11.233768Z | [https://pub.dev/api/packages/multiple_result](https://pub.dev/api/packages/multiple_result) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/multiple_result` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-be869ba194065d` from `pub_dev` as `registry_expansion`
