...
| Canonical URL | [https://crates.io/crates/flagset](https://crates.io/crates/flagset) |
| Source record ids | crates_io-760e3614fd6d43 |
...
For a systems engineer, flagset belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.7 | 2025-04-04T00:44:54.941020Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-760e3614fd6d43` from `crates_io` as `registry_expansion`
