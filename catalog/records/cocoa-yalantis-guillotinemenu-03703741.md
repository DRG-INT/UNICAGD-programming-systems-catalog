...
<!-- canonical: https://github.com/Yalantis/GuillotineMenu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Yalantis/GuillotineMenu](https://github.com/Yalantis/GuillotineMenu) |
| Source record ids | github_search_cocoa-0295fa021082de |

## System Engineer Summary

Our Guillotine Menu Transitioning Animation implemented in Swift reminds a bit of a notorious
killing machine.

## Operational Role

For a systems engineer, Yalantis/GuillotineMenu belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-13T12:49:18Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-0295fa021082de` from `github_search_cocoa` as `registry_expansion`
