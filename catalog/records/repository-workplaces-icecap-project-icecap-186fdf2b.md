...
<!-- canonical: https://gitlab.com/icecap-project/icecap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/icecap-project/icecap](https://gitlab.com/icecap-project/icecap) |
| Source record ids | gitlab_projects_api-120bdf6b6eab54 |

## System Engineer Summary

Primary IceCap repository.

## Operational Role

For a systems engineer, icecap-project/icecap belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-120bdf6b6eab54` from `gitlab_projects_api` as `registry_expansion`
