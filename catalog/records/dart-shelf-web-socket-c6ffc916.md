...
<!-- canonical: https://pub.dev/packages/shelf_web_socket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_web_socket](https://pub.dev/packages/shelf_web_socket) |
| Source record ids | pub_dev-3c9a8ae14537b6 |
...
For a systems engineer, shelf_web_socket belongs in the Dart inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-01-30T17:50:10.363347Z | [https://pub.dev/api/packages/shelf_web_socket](https://pub.dev/api/packages/shelf_web_socket) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_web_socket` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-3c9a8ae14537b6` from `pub_dev` as `registry_expansion`
...
| cached_network_image | Networking Http | [open](dart-cached-network-image-69772a62.md) |
