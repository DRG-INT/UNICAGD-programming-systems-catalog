...
<!-- canonical: https://pypi.org/project/abxrcli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abxrcli/](https://pypi.org/project/abxrcli/) |
| Source record ids | pypi_simple-abea9442185d03 |

## System Engineer Summary

abxrcli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, abxrcli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-05-21T18:04:00.383049Z | [https://pypi.org/pypi/abxrcli/json](https://pypi.org/pypi/abxrcli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abxrcli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-abea9442185d03` from `pypi_simple` as `registry_expansion`
