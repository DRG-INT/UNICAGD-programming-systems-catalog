...
<!-- canonical: https://cran.r-project.org/web/packages/howManyImputations/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/howManyImputations/index.html](https://cran.r-project.org/web/packages/howManyImputations/index.html) |
| Source record ids | cran_packages_by_date-6a3384168b1144 |
...
For a systems engineer, howManyImputations belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-08-24 18:00:10 UTC | [https://cran.r-project.org/web/packages/howManyImputations/DESCRIPTION](https://cran.r-project.org/web/packages/howManyImputations/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/howManyImputations/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6a3384168b1144` from `cran_packages_by_date` as `registry_expansion`
