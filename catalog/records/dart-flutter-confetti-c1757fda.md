...
<!-- canonical: https://pub.dev/packages/flutter_confetti -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_confetti](https://pub.dev/packages/flutter_confetti) |
| Source record ids | pub_dev-882a930d0f861a |
...
For a systems engineer, flutter_confetti belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.2 | 2026-07-31T14:17:49.739851Z | [https://pub.dev/api/packages/flutter_confetti](https://pub.dev/api/packages/flutter_confetti) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_confetti` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-882a930d0f861a` from `pub_dev` as `registry_expansion`
