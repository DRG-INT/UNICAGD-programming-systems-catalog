...
<!-- canonical: https://github.com/geolonia/normalize-japanese-addresses -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geolonia/normalize-japanese-addresses](https://github.com/geolonia/normalize-japanese-addresses) |
| Source record ids | github_search_maps-0de5189e168bfa |

## System Engineer Summary

geolonia/normalize-japanese-addresses is tracked as a library record in the Maps branch. The source
...
For a systems engineer, geolonia/normalize-japanese-addresses belongs in the Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.1.3 | 2024-12-24T02:42:36Z | [https://api.github.com/repos/geolonia/normalize-japanese-addresses/releases/latest](https://api.github.com/repos/geolonia/normalize-japanese-addresses/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/geolonia/normalize-japanese-addresses/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-0de5189e168bfa` from `github_search_maps` as `registry_expansion`
