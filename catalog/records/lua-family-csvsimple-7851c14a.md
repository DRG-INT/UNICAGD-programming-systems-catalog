...
<!-- canonical: https://luarocks.org/modules/freed-wu/csvsimple -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/csvsimple](https://luarocks.org/modules/freed-wu/csvsimple) |
| Source record ids | luarocks_root_manifest-33be7c9e5bb696 |
...
For a systems engineer, csvsimple belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-33be7c9e5bb696` from `luarocks_root_manifest` as `registry_expansion`
