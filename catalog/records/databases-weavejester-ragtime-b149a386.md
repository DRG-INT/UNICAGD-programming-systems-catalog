...
<!-- canonical: https://github.com/weavejester/ragtime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/weavejester/ragtime](https://github.com/weavejester/ragtime) |
| Source record ids | github_search_databases-76cbe87a02f5f7 |
...
For a systems engineer, weavejester/ragtime belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-23T14:39:42Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0 |
...
- `github_search_databases-76cbe87a02f5f7` from `github_search_databases` as `registry_expansion`
