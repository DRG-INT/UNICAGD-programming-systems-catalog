...
<!-- canonical: https://cran.r-project.org/web/packages/rcatfish/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rcatfish/index.html](https://cran.r-project.org/web/packages/rcatfish/index.html) |
| Source record ids | cran_packages_by_date-9d9f424173d734 |
...
For a systems engineer, rcatfish belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-08-20 10:30:02 UTC | [https://cran.r-project.org/web/packages/rcatfish/DESCRIPTION](https://cran.r-project.org/web/packages/rcatfish/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rcatfish/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9d9f424173d734` from `cran_packages_by_date` as `registry_expansion`
