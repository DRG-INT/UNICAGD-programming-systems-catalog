...
| Canonical URL | [https://github.com/tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) |
| Source record ids | github_search_webassembly-adee2f5e11f0aa |

## System Engineer Summary

Go compiler for small places. Microcontrollers, WebAssembly (WASM/WASI), and command-line tools.
Based on LLVM.

## Operational Role

For a systems engineer, tinygo-org/tinygo belongs in the WebAssembly inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.42.0 | 2026-09-01T08:02:13Z | [https://api.github.com/repos/tinygo-org/tinygo/releases/latest](https://api.github.com/repos/tinygo-org/tinygo/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tinygo-org/tinygo/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-adee2f5e11f0aa` from `github_search_webassembly` as `registry_expansion`
