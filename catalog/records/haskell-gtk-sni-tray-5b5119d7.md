...
<!-- canonical: https://hackage.haskell.org/package/gtk-sni-tray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gtk-sni-tray](https://hackage.haskell.org/package/gtk-sni-tray) |
| Source record ids | hackage_top_downloads-36c752587a9a87 |
...
For a systems engineer, gtk-sni-tray belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.4 | 2026-07-15T20:42:16Z | [https://hackage.haskell.org/package/gtk-sni-tray](https://hackage.haskell.org/package/gtk-sni-tray) |  |
| candidate | partial | 0.1.4.0 |  | [https://hackage.haskell.org/package/gtk-sni-tray](https://hackage.haskell.org/package/gtk-sni-tray) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gtk-sni-tray` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-36c752587a9a87` from `hackage_top_downloads` as `registry_expansion`
