...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/4gray/iptvnator](https://github.com/4gray/iptvnator) |
| Source record ids | github_search_video-c3db280f6818c3 |

## System Engineer Summary

:tv: Cross-platform IPTV player application with multiple features, such as support of m3u and m3u8
playlists, favorites, TV guide, TV archive/catchup and more.

## Operational Role

For a systems engineer, 4gray/iptvnator belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.23.0 | 2026-08-30T08:43:21Z | [https://api.github.com/repos/4gray/iptvnator/releases/latest](https://api.github.com/repos/4gray/iptvnator/releases/latest) |  |
| preview | known | app-v1.0.0-7 | 2025-10-02T12:14:31Z | [https://api.github.com/repos/4gray/iptvnator/releases?per_page=10](https://api.github.com/repos/4gray/iptvnator/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/4gray/iptvnator/releases/latest` at `2026-09-01T09:23:21+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:video stars:>500", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `github_search_video-c3db280f6818c3` from `github_search_video` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| aandrew-me/ytDownloader | Ide Editor Integration | [open](video-aandrew-me-ytdownloader-cd56d660.md) |
| AaronFeng753/Waifu2x-Extension-GUI | Ide Editor Integration | [open](video-aaronfeng753-waifu2x-extension-gui-26771eef.md) |
| abhiTronix/vidgear | Ide Editor Integration | [open](video-abhitronix-vidgear-c204bb6d.md) |
| alyssaxuu/screenity | Ide Editor Integration | [open](video-alyssaxuu-screenity-950c051f.md) |
| Archmage83/tvapk | Ide Editor Integration | [open](video-archmage83-tvapk-f1570f1b.md) |
| bacalhau-project/bacalhau | Ide Editor Integration | [open](video-bacalhau-project-bacalhau-f12bfb54.md) |
| bennyhuo/Kotlin-Tutorials | Ide Editor Integration | [open](video-bennyhuo-kotlin-tutorials-d23521e7.md) |
| bigbluebutton/bigbluebutton | Ide Editor Integration | [open](video-bigbluebutton-bigbluebutton-9d135955.md) |
