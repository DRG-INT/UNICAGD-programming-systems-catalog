...
<!-- canonical: https://cran.r-project.org/web/packages/rice/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rice/index.html](https://cran.r-project.org/web/packages/rice/index.html) |
| Source record ids | cran_packages_by_date-0db9a9d74d5a71 |

## System Engineer Summary

rice is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, rice belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-19 14:30:02 UTC | [https://cran.r-project.org/web/packages/rice/DESCRIPTION](https://cran.r-project.org/web/packages/rice/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rice/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0db9a9d74d5a71` from `cran_packages_by_date` as `registry_expansion`
