...
<!-- canonical: https://github.com/cadenji/foolrenderer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cadenji/foolrenderer](https://github.com/cadenji/foolrenderer) |
| Source record ids | github_search_computer_graphics_software-4d09289dc2dff8 |

## System Engineer Summary

A tiny software renderer implemented from scratch without the use of graphics API, used to
understand how GPUs work.

## Operational Role

For a systems engineer, cadenji/foolrenderer belongs in the Computer Graphics Software inventory as
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_computer_graphics_software-4d09289dc2dff8` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Overv/VulkanTutorial | Api Abi Checker | [open](computer-graphics-software-overv-vulkantutorial-33ce6023.md) |
