...
<!-- canonical: https://github.com/white-shiro-bai/ghost_sa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/white-shiro-bai/ghost_sa](https://github.com/white-shiro-bai/ghost_sa) |
| Source record ids | github_search_audio-d4f0f21669c3d5 |

## System Engineer Summary

open_server for sensorsdata ghost_sa(鬼策)的用途是接收 神策SDK
上报的埋点数据，移动广告监测，站外阅读监测，短链创建与解析，反爬，接入控制与管理，用户分群与召回等功能

## Operational Role

For a systems engineer, white-shiro-bai/ghost_sa belongs in the Audio inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-24T01:58:52Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-d4f0f21669c3d5` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DarkstarProject/darkstar | Web Framework | [open](audio-darkstarproject-darkstar-f806036a.md) |
