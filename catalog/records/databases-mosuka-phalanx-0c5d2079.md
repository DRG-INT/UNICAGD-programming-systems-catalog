...
<!-- canonical: https://github.com/mosuka/phalanx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mosuka/phalanx](https://github.com/mosuka/phalanx) |
| Source record ids | github_search_databases-f43d6e8b9922fc |

## System Engineer Summary

Phalanx is a cloud-native distributed search engine that provides endpoints through gRPC and
traditional RESTful API.

## Operational Role

For a systems engineer, mosuka/phalanx belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-02T06:06:28Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f43d6e8b9922fc` from `github_search_databases` as `registry_expansion`
