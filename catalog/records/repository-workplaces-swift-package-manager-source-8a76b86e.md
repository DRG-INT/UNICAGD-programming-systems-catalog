...
| Source record ids | curated_repository_workplace_routes-b80243912ca4de |

## System Engineer Summary

Official Swift Package Manager source repository route.

## Operational Role

For a systems engineer, Swift Package Manager Source belongs in the Repository Workplaces inventory
...
- `curated_repository_workplace_routes-b80243912ca4de` from `curated_repository_workplace_routes` as `registry_expansion`
