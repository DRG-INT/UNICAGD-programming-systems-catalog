...
<!-- canonical: https://cran.r-project.org/web/packages/cataScience/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cataScience/index.html](https://cran.r-project.org/web/packages/cataScience/index.html) |
| Source record ids | cran_packages_by_date-322d4beacf9c56 |
...
For a systems engineer, cataScience belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.3 | 2026-08-28 07:01:32 UTC | [https://cran.r-project.org/web/packages/cataScience/DESCRIPTION](https://cran.r-project.org/web/packages/cataScience/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cataScience/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-322d4beacf9c56` from `cran_packages_by_date` as `registry_expansion`
