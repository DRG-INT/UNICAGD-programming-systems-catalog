# codeberg.org/momar/simple-scan-server

## Navigation

[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pkg.go.dev/codeberg.org/momar/simple-scan-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pkg.go.dev/codeberg.org/momar/simple-scan-server](https://pkg.go.dev/codeberg.org/momar/simple-scan-server) |
| Source record ids | go_module_index-e06520ddabe5fe |
...
For a systems engineer, codeberg.org/momar/simple-scan-server belongs in the Go inventory as part of
...
| module-preview | known | v0.0.0-20260830125315-0a212e8db2d8 | 2026-08-30T12:54:21.545387Z | [https://index.golang.org/index?since=2026-08-30T12%3A21%3A35.036416Z&limit=2000](https://index.golang.org/index?since=2026-08-30T12%3A21%3A35.036416Z&limit=2000) |  |
...
- `go_module_index-e06520ddabe5fe` from `go_module_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| career-ops-hq/career-ops | Static Analyzer | [open](go-career-ops-hq-career-ops-89690772.md) |
