...
<!-- canonical: https://github.com/JanWilczek/audio-plugin-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JanWilczek/audio-plugin-template](https://github.com/JanWilczek/audio-plugin-template) |
| Source record ids | github_search_audio-0ba4e9a2a6d8ce |

## System Engineer Summary

A template repository that you can use for creating audio plugins with the JUCE C++ framework. It is
based on CMake, uses CPM package manager, the JUCE C++ framework (obviously), and the GoogleTest
framework. All of these are easy to change on demand. You can also base off your new repo off this
template because the setup is very simple.

## Operational Role

For a systems engineer, JanWilczek/audio-plugin-template belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-23T11:41:11Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-0ba4e9a2a6d8ce` from `github_search_audio` as `registry_expansion`
