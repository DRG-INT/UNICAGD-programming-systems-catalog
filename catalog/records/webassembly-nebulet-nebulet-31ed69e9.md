...
<!-- canonical: https://github.com/nebulet/nebulet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nebulet/nebulet](https://github.com/nebulet/nebulet) |
| Source record ids | github_search_webassembly-e59fbd2bdaf689 |
...
For a systems engineer, nebulet/nebulet belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-28T21:27:36Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-e59fbd2bdaf689` from `github_search_webassembly` as `registry_expansion`
