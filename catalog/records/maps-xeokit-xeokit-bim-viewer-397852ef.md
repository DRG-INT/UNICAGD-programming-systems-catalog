...
<!-- canonical: https://github.com/xeokit/xeokit-bim-viewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xeokit/xeokit-bim-viewer](https://github.com/xeokit/xeokit-bim-viewer) |
| Source record ids | github_search_maps-27e8df9d95e0a1 |

## System Engineer Summary

Built with xeokit SDK. IFC, BIM and Point Cloud 3D Viewer as a package. Enables AEC & GIS
applications with double precision global coordinates.

## Operational Role

For a systems engineer, xeokit/xeokit-bim-viewer belongs in the Maps inventory as part of ecosystem
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; The Unlicense; https://api.github.com/licenses/unlicense; Other; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_maps-27e8df9d95e0a1` from `github_search_maps` as `registry_expansion`
