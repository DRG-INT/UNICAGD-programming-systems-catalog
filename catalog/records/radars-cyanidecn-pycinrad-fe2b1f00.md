...
<!-- canonical: https://github.com/CyanideCN/PyCINRAD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CyanideCN/PyCINRAD](https://github.com/CyanideCN/PyCINRAD) |
| Source record ids | github_search_radars-2da75e205380a2 |
...
For a systems engineer, CyanideCN/PyCINRAD belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.9.3 | 2026-01-02T03:34:10Z | [https://api.github.com/repos/CyanideCN/PyCINRAD/releases/latest](https://api.github.com/repos/CyanideCN/PyCINRAD/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CyanideCN/PyCINRAD/releases/latest` at `2026-09-01T08:26:28+00:00`.
...
- `github_search_radars-2da75e205380a2` from `github_search_radars` as `registry_expansion`
