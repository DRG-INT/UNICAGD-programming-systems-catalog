# kshanth/db-routing-cap-samples-java
...
<!-- canonical: https://github.com/kshanth/db-routing-cap-samples-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kshanth/db-routing-cap-samples-java](https://github.com/kshanth/db-routing-cap-samples-java) |
| Source record ids | github_search_sapjava-c3e40449ab4800 |
...
For a systems engineer, kshanth/db-routing-cap-samples-java belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-31T07:02:15Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-c3e40449ab4800` from `github_search_sapjava` as `registry_expansion`
