...
| Canonical URL | [https://packagist.org/packages/auth0/login](https://packagist.org/packages/auth0/login) |
| Source record ids | packagist_search-ddb4d64f97ec11 |

## System Engineer Summary

Auth0 Laravel SDK. Straight-forward and tested methods for implementing authentication, and
accessing Auth0's Management API endpoints.

## Operational Role

For a systems engineer, auth0/login belongs in the PHP inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.22.0 | 2026-04-08T11:22:36+00:00 | [https://repo.packagist.org/p2/auth0/login.json](https://repo.packagist.org/p2/auth0/login.json) |  |
| preview | known | 8.0.0-beta.0 | 2026-08-08T11:56:37+00:00 | [https://repo.packagist.org/p2/auth0/login.json](https://repo.packagist.org/p2/auth0/login.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/auth0/login.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-ddb4d64f97ec11` from `packagist_search` as `registry_expansion`
