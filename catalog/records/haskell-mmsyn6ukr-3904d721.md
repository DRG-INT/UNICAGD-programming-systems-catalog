...
<!-- canonical: https://hackage.haskell.org/package/mmsyn6ukr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mmsyn6ukr](https://hackage.haskell.org/package/mmsyn6ukr) |
| Source record ids | hackage_top_downloads-5a74a7a42a0f52 |
...
For a systems engineer, mmsyn6ukr belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0.0 | 2020-11-07T13:07:48Z | [https://hackage.haskell.org/package/mmsyn6ukr](https://hackage.haskell.org/package/mmsyn6ukr) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mmsyn6ukr` at `2026-09-06T00:34:51+00:00`.
...
- `hackage_top_downloads-5a74a7a42a0f52` from `hackage_top_downloads` as `registry_expansion`
