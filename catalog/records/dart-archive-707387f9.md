...
<!-- canonical: https://pub.dev/packages/archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/archive](https://pub.dev/packages/archive) |
| Source record ids | pub_dev-93ec767decd828 |

## System Engineer Summary

Provides encoders and decoders for various archive and compression formats such as zip, tar, bzip2,
gzip, and zlib.

## Operational Role

For a systems engineer, archive belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-08-22T21:08:11.409906Z | [https://pub.dev/api/packages/archive](https://pub.dev/api/packages/archive) |  |
| preview | known | 3.0.0-nullsafety.0 | 2021-01-20T19:01:05.050676Z | [https://pub.dev/api/packages/archive](https://pub.dev/api/packages/archive) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/archive` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-93ec767decd828` from `pub_dev` as `registry_expansion`
