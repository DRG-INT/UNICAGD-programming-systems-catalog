...
<!-- canonical: https://packagist.org/packages/malkusch/lock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/malkusch/lock](https://packagist.org/packages/malkusch/lock) |
| Source record ids | packagist_search-dec488c47c0a9d |
...
For a systems engineer, malkusch/lock belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-dec488c47c0a9d` from `packagist_search` as `registry_expansion`
