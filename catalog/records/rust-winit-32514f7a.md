...
<!-- canonical: https://crates.io/crates/winit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/winit](https://crates.io/crates/winit) |
| Source record ids | crates_io-c0b6fc39d9e1b0 |
...
For a systems engineer, winit belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.13 | 2026-09-04T18:23:20.252485Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-04T20:18:56+00:00`.
...
- `crates_io-c0b6fc39d9e1b0` from `crates_io` as `registry_expansion`
