...
<!-- canonical: https://crates.io/crates/async-global-executor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-global-executor](https://crates.io/crates/async-global-executor) |
| Source record ids | crates_io-676cb931741f9a |
...
For a systems engineer, async-global-executor belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2025-02-26T14:26:42.950567Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-676cb931741f9a` from `crates_io` as `registry_expansion`
