...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/ffi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ffi](https://pub.dev/packages/ffi) |
| Source record ids | pub_dev-00f5d5ba606549 |
...
For a systems engineer, ffi belongs in the Dart inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-02-11T14:08:51.217392Z | [https://pub.dev/api/packages/ffi](https://pub.dev/api/packages/ffi) |  |
| preview | known | 1.2.0-dev.0 | 2022-01-20T15:11:31.996350Z | [https://pub.dev/api/packages/ffi](https://pub.dev/api/packages/ffi) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ffi` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-00f5d5ba606549` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amplitude_flutter | Ffi Bindings | [open](dart-amplitude-flutter-bf9e79ec.md) |
| clarity_flutter | Ffi Bindings | [open](dart-clarity-flutter-b01cb39f.md) |
| cupertino_ui | Ffi Bindings | [open](dart-cupertino-ui-67a4e2e1.md) |
| device_preview | Ffi Bindings | [open](dart-device-preview-08e5439c.md) |
| ffmpeg_kit_flutter_new | Ffi Bindings | [open](dart-ffmpeg-kit-flutter-new-e600e8b3.md) |
| flutter_rust_bridge | Ffi Bindings | [open](dart-flutter-rust-bridge-2c8c964c.md) |
| fwfh_webview | Ffi Bindings | [open](dart-fwfh-webview-d3af7d13.md) |
| in_app_update | Ffi Bindings | [open](dart-in-app-update-0266d7cc.md) |
