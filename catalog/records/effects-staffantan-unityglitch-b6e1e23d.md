...
<!-- canonical: https://github.com/staffantan/unityglitch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/staffantan/unityglitch](https://github.com/staffantan/unityglitch) |
| Source record ids | github_search_effects-5cf0a5b4901c5a |
...
For a systems engineer, staffantan/unityglitch belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-18T11:59:55Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-5cf0a5b4901c5a` from `github_search_effects` as `registry_expansion`
