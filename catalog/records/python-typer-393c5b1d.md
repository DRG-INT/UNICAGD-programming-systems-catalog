...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Cli](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/cli.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-322bd0f9f313bf |

## System Engineer Summary

Typer is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, Typer belongs in the Python inventory as part of ecosystem capability
...
- `corpus-322bd0f9f313bf` from `master_json` as `cli`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| argparse | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-argparse-3d1e7393.md) |
| Click | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-click-28bc91cf.md) |
| prompt_toolkit | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-prompt-toolkit-c44b6fbb.md) |
| Rich | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-rich-2c232cc6.md) |
| Textual | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-textual-abf67e32.md) |
