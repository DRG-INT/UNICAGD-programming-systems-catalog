...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/T/TOML](https://github.com/JuliaRegistries/General/tree/master/T/TOML) |
| Source record ids | corpus-51e20c15c94164 |

## System Engineer Summary

TOML is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, TOML belongs in the Julia inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.0.3 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/T/TOML/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/T/TOML/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-51e20c15c94164` from `master_json` as `serialization`
...
| cJSON_jll | Serialization | [open](julia-cjson-jll-e2a4aab8.md) |
