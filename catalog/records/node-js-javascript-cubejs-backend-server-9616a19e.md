...
[Catalog index](../index.md) · [Language: Node.js/JavaScript](../by-language/node-js-javascript.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/@cubejs-backend/server -->
<!-- crawl-delay: 10 -->
...
@cubejs-backend/server is tracked as an undefined behavior analyzer record in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.38 | 2026-09-14T17:33:51.676Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-14T18:22:59+00:00`.
...
| --- | --- | --- | --- |
| npm_registry_search | registry-derived | 2026-09-15 | `{"kind": "npm_registry_search", "query": "server", "retrieved": "2026-09-15", "status": "registry-derived"}` |
...
- `npm_registry-3e0a564ca3404d` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| @arethetypeswrong/cli | Undefined Behavior Analyzer | [open](node-js-javascript-arethetypeswrong-cli-ef4de260.md) |
| @backstage/cli-module-github | Undefined Behavior Analyzer | [open](node-js-javascript-backstage-cli-module-github-929a0021.md) |
| @camunda/task-testing | Undefined Behavior Analyzer | [open](node-js-javascript-camunda-task-testing-da18aa2b.md) |
| @cubejs-backend/athena-driver | Undefined Behavior Analyzer | [open](node-js-javascript-cubejs-backend-athena-driver-6bacd80a.md) |
| @cubejs-backend/bigquery-driver | Undefined Behavior Analyzer | [open](node-js-javascript-cubejs-backend-bigquery-driver-5b2b13fc.md) |
| @cubejs-backend/clickhouse-driver | Undefined Behavior Analyzer | [open](node-js-javascript-cubejs-backend-clickhouse-driver-4d0c7732.md) |
| @cubejs-backend/databricks-jdbc-driver | Undefined Behavior Analyzer | [open](node-js-javascript-cubejs-backend-databricks-jdbc-driver-75fcf91d.md) |
| @cubejs-backend/druid-driver | Undefined Behavior Analyzer | [open](node-js-javascript-cubejs-backend-druid-driver-4b43d84c.md) |
