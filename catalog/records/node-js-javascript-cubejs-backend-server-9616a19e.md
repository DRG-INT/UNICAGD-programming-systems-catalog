...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Undefined Behavior Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/undefined-behavior-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@cubejs-backend/server](https://www.npmjs.com/package/@cubejs-backend/server) |
| Source record ids | npm_registry-3e0a564ca3404d |
...
For a systems engineer, @cubejs-backend/server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.31 | 2026-08-31T16:55:07.180Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @arethetypeswrong/cli | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-arethetypeswrong-cli-ef4de260.md) |
| @backstage/cli-module-github | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-backstage-cli-module-github-929a0021.md) |
| @camunda/task-testing | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-camunda-task-testing-da18aa2b.md) |
| @cubejs-backend/athena-driver | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cubejs-backend-athena-driver-6bacd80a.md) |
| @cubejs-backend/bigquery-driver | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cubejs-backend-bigquery-driver-5b2b13fc.md) |
| @cubejs-backend/clickhouse-driver | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cubejs-backend-clickhouse-driver-4d0c7732.md) |
| @cubejs-backend/databricks-jdbc-driver | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cubejs-backend-databricks-jdbc-driver-75fcf91d.md) |
| @cubejs-backend/druid-driver | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-cubejs-backend-druid-driver-4b43d84c.md) |
