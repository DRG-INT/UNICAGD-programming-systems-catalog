...
<!-- canonical: https://crates.io/crates/async-executor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-executor](https://crates.io/crates/async-executor) |
| Source record ids | crates_io-376220a6e033cd |

## System Engineer Summary

async-executor is tracked as an async runtime record in the Rust branch. The source did not provide
...
For a systems engineer, async-executor belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.14.0 | 2026-02-15T16:45:48.706047Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-376220a6e033cd` from `crates_io` as `registry_expansion`
