...
<!-- canonical: https://github.com/sethoscope/heatmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sethoscope/heatmap](https://github.com/sethoscope/heatmap) |
| Source record ids | github_search_maps-874f307db81c60 |

## System Engineer Summary

Python script for generating high quality heatmaps based on any coordinate data (GPS tracks, eye
tracking, etc).

## Operational Role

For a systems engineer, sethoscope/heatmap belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-20T01:58:04Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-874f307db81c60` from `github_search_maps` as `registry_expansion`
