...
<!-- canonical: https://cran.r-project.org/web/packages/mispitools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mispitools/index.html](https://cran.r-project.org/web/packages/mispitools/index.html) |
| Source record ids | cran_packages_by_date-33367bab8e1097 |
...
For a systems engineer, mispitools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-26 21:10:07 UTC | [https://cran.r-project.org/web/packages/mispitools/DESCRIPTION](https://cran.r-project.org/web/packages/mispitools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mispitools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-33367bab8e1097` from `cran_packages_by_date` as `registry_expansion`
