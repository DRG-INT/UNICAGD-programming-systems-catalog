...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/radix-ui/website -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/radix-ui/website](https://github.com/radix-ui/website) |
| Source record ids | github_search_icons_and_logos-cd991aa3a2f3e8 |
...
For a systems engineer, radix-ui/website belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T05:18:16Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-cd991aa3a2f3e8` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Favicon Cheat Sheet | Documentation | [open](icons-and-logos-favicon-cheat-sheet-be3861cf.md) |
