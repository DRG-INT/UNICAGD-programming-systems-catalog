...
<!-- canonical: https://crates.io/crates/faster-hex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/faster-hex](https://crates.io/crates/faster-hex) |
| Source record ids | crates_io-d596d9fc597d88 |

## System Engineer Summary

faster-hex is tracked as a parser lexer ast record in the Rust branch. The source did not provide a
...
For a systems engineer, faster-hex belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2024-09-14T06:29:11.794302Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-d596d9fc597d88` from `crates_io` as `registry_expansion`
