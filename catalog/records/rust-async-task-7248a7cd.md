...
<!-- canonical: https://crates.io/crates/async-task -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-task](https://crates.io/crates/async-task) |
| Source record ids | crates_io-af9499223c310b |
...
For a systems engineer, async-task belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.7.1 | 2024-04-27T23:06:20.560257Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-af9499223c310b` from `crates_io` as `registry_expansion`
