...
<!-- canonical: https://github.com/DGivney/assemblytutorials -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DGivney/assemblytutorials](https://github.com/DGivney/assemblytutorials) |
| Source record ids | github_search_assembly-f50b4347ddb81b |
...
For a systems engineer, DGivney/assemblytutorials belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-08T11:40:58Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-13 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:Assembly stars:>500", "retrieved": "2026-09-13", "status": "forge-cli-derived"}` |
...
- `github_search_assembly-f50b4347ddb81b` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xADE1A1DE/AssemblyLine | Language Specification | [open](assembly-0xade1a1de-assemblyline-114a6144.md) |
...
| avivbrook/Intel-Assembly-Language-Programming-Exercises | Language Specification | [open](assembly-avivbrook-intel-assembly-language-programming-exercises-027e9b7f.md) |
