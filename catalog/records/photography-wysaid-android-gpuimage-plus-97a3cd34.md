...
<!-- canonical: https://github.com/wysaid/android-gpuimage-plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wysaid/android-gpuimage-plus](https://github.com/wysaid/android-gpuimage-plus) |
| Source record ids | github_search_photography-918bac89ec4296 |
...
For a systems engineer, wysaid/android-gpuimage-plus belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-28T15:30:55Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-918bac89ec4296` from `github_search_photography` as `registry_expansion`
