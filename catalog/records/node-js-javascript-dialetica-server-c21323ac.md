...
<!-- canonical: https://www.npmjs.com/package/@dialetica/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@dialetica/server](https://www.npmjs.com/package/@dialetica/server) |
| Source record ids | npm_registry-ace391e8ad8782 |

## System Engineer Summary

Dialetica AI — self-hosted server CLI

## Operational Role

For a systems engineer, @dialetica/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-05-12T02:26:08.818Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-ace391e8ad8782` from `npm_registry` as `registry_expansion`
