...
<!-- canonical: https://cran.r-project.org/web/packages/bodycompref/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bodycompref/index.html](https://cran.r-project.org/web/packages/bodycompref/index.html) |
| Source record ids | cran_packages_by_date-d7ebfc9c5486a6 |

## System Engineer Summary

Reference Values for CT-Assessed Body Composition

## Operational Role

For a systems engineer, bodycompref belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-09-09 17:50:02 UTC | [https://cran.r-project.org/web/packages/bodycompref/DESCRIPTION](https://cran.r-project.org/web/packages/bodycompref/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bodycompref/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-d7ebfc9c5486a6` from `cran_packages_by_date` as `registry_expansion`
