...
<!-- canonical: https://crates.io/crates/enumflags2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enumflags2](https://crates.io/crates/enumflags2) |
| Source record ids | crates_io-7da26b14b86480 |

## System Engineer Summary

enumflags2 is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, enumflags2 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.12 | 2025-06-09T22:16:25.147642Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-7da26b14b86480` from `crates_io` as `registry_expansion`
