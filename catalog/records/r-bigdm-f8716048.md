...
<!-- canonical: https://cran.r-project.org/web/packages/bigDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bigDM/index.html](https://cran.r-project.org/web/packages/bigDM/index.html) |
| Source record ids | cran_packages_by_date-85e7e17b002936 |
...
For a systems engineer, bigDM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.8 | 2026-08-19 16:20:02 UTC | [https://cran.r-project.org/web/packages/bigDM/DESCRIPTION](https://cran.r-project.org/web/packages/bigDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bigDM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-85e7e17b002936` from `cran_packages_by_date` as `registry_expansion`
