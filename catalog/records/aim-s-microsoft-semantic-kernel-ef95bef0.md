...
<!-- canonical: https://github.com/microsoft/semantic-kernel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel) |
| Source record ids | github_search_aims-7f8aa95bf4cdf2 |
...
For a systems engineer, microsoft/semantic-kernel belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T01:07:56Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-7f8aa95bf4cdf2` from `github_search_aims` as `registry_expansion`
