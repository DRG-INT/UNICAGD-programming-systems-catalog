...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CLEARSWI](https://github.com/JuliaRegistries/General/tree/master/C/CLEARSWI) |
| Source record ids | julia_general-639569592c6aad |

## System Engineer Summary

Julia package registered in General at C/CLEARSWI.

## Operational Role

For a systems engineer, CLEARSWI belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CLEARSWI", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-639569592c6aad` from `julia_general` as `registry_expansion`
