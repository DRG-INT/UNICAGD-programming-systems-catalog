...
<!-- canonical: https://github.com/podgorskiy/KeplerOrbits -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/podgorskiy/KeplerOrbits](https://github.com/podgorskiy/KeplerOrbits) |
| Source record ids | github_search_space_engines-51335d10e5059e |

## System Engineer Summary

podgorskiy/KeplerOrbits is tracked as a library record in the Space Engines branch. The source did
...
For a systems engineer, podgorskiy/KeplerOrbits belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-02T23:28:28Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-51335d10e5059e` from `github_search_space_engines` as `registry_expansion`
