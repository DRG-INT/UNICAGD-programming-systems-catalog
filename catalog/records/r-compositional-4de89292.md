...
<!-- canonical: https://cran.r-project.org/web/packages/Compositional/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Compositional/index.html](https://cran.r-project.org/web/packages/Compositional/index.html) |
| Source record ids | cran_packages_by_date-bd980a9d49c538 |
...
For a systems engineer, Compositional belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.3 | 2026-08-21 06:30:16 UTC | [https://cran.r-project.org/web/packages/Compositional/DESCRIPTION](https://cran.r-project.org/web/packages/Compositional/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Compositional/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-bd980a9d49c538` from `cran_packages_by_date` as `registry_expansion`
