...
<!-- canonical: https://github.com/xverse-engine/XScene-UEPlugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xverse-engine/XScene-UEPlugin](https://github.com/xverse-engine/XScene-UEPlugin) |
| Source record ids | github_search_computer_graphics_software-77a81ebfb9c893 |

## System Engineer Summary

A Unreal Engine 5 (UE5) based plugin aiming to provide real-time visulization, management, editing,
and scalable hybrid rendering of Guassian Splatting model.

## Operational Role

For a systems engineer, xverse-engine/XScene-UEPlugin belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-77a81ebfb9c893` from `github_search_computer_graphics_software` as `registry_expansion`
