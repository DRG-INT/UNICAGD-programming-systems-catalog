...
<!-- canonical: https://luarocks.org/modules/luarocks/densearrays -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/densearrays](https://luarocks.org/modules/luarocks/densearrays) |
| Source record ids | luarocks_root_manifest-b547336881324a |

## System Engineer Summary

A library for dense arrays of numbers or booleans

## Operational Role

For a systems engineer, densearrays belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b547336881324a` from `luarocks_root_manifest` as `registry_expansion`
