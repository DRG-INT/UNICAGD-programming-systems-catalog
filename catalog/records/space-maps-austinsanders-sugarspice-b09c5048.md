...
<!-- canonical: https://github.com/AustinSanders/SugarSpice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AustinSanders/SugarSpice](https://github.com/AustinSanders/SugarSpice) |
| Source record ids | github_search_space_maps-265b41c6a5a815 |

## System Engineer Summary

High level tools for interacting with Spice kernels.

## Operational Role

For a systems engineer, AustinSanders/SugarSpice belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-30T01:01:34Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-265b41c6a5a815` from `github_search_space_maps` as `registry_expansion`
