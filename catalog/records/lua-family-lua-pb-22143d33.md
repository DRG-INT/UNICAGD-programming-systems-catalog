...
<!-- canonical: https://github.com/Neopallium/lua-pb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Neopallium/lua-pb](https://github.com/Neopallium/lua-pb) |
| Source record ids | lua-source-266 |
...
For a systems engineer, lua-pb belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 266}}` |
...
- `lua-source-266` from `master_json` as `source_list_item`
