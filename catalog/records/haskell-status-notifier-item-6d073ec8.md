...
<!-- canonical: https://hackage.haskell.org/package/status-notifier-item -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/status-notifier-item](https://hackage.haskell.org/package/status-notifier-item) |
| Source record ids | hackage_top_downloads-283c5eb2681906 |
...
For a systems engineer, status-notifier-item belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2.16 | 2026-07-15T20:27:37Z | [https://hackage.haskell.org/package/status-notifier-item](https://hackage.haskell.org/package/status-notifier-item) |  |
| candidate | partial | 0.2.2.1 |  | [https://hackage.haskell.org/package/status-notifier-item](https://hackage.haskell.org/package/status-notifier-item) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/status-notifier-item` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-283c5eb2681906` from `hackage_top_downloads` as `registry_expansion`
