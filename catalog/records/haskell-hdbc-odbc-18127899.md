...
<!-- canonical: https://hackage.haskell.org/package/HDBC-odbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HDBC-odbc](https://hackage.haskell.org/package/HDBC-odbc) |
| Source record ids | hackage_top_downloads-f116802d9948da |
...
For a systems engineer, HDBC-odbc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.0.0 | 2019-04-08T12:32:11Z | [https://hackage.haskell.org/package/HDBC-odbc](https://hackage.haskell.org/package/HDBC-odbc) |  |
| candidate | partial | 2.4.0.0 |  | [https://hackage.haskell.org/package/HDBC-odbc](https://hackage.haskell.org/package/HDBC-odbc) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/HDBC-odbc` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-f116802d9948da` from `hackage_top_downloads` as `registry_expansion`
