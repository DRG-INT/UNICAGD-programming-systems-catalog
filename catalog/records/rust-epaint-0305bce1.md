...
| Canonical URL | [https://crates.io/crates/epaint](https://crates.io/crates/epaint) |
| Source record ids | crates_io-3e9026a954be2a |
...
For a systems engineer, epaint belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.36.1 | 2026-08-07T13:09:29.796936Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-3e9026a954be2a` from `crates_io` as `registry_expansion`
