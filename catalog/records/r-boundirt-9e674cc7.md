...
<!-- canonical: https://cran.r-project.org/web/packages/BoundIRT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BoundIRT/index.html](https://cran.r-project.org/web/packages/BoundIRT/index.html) |
| Source record ids | cran_packages_by_date-c8ed494878bf85 |
...
For a systems engineer, BoundIRT belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-21 05:47:08 UTC | [https://cran.r-project.org/web/packages/BoundIRT/DESCRIPTION](https://cran.r-project.org/web/packages/BoundIRT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BoundIRT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c8ed494878bf85` from `cran_packages_by_date` as `registry_expansion`
