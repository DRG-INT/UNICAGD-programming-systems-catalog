...
<!-- canonical: https://cran.r-project.org/web/packages/PanelSelect/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PanelSelect/index.html](https://cran.r-project.org/web/packages/PanelSelect/index.html) |
| Source record ids | cran_packages_by_date-859fe936f87af2 |
...
For a systems engineer, PanelSelect belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-27 05:10:46 UTC | [https://cran.r-project.org/web/packages/PanelSelect/DESCRIPTION](https://cran.r-project.org/web/packages/PanelSelect/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PanelSelect/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-859fe936f87af2` from `cran_packages_by_date` as `registry_expansion`
