# CanYuzbey/Cpp-Audio-Bitcrusher
...
<!-- canonical: https://github.com/CanYuzbey/Cpp-Audio-Bitcrusher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CanYuzbey/Cpp-Audio-Bitcrusher](https://github.com/CanYuzbey/Cpp-Audio-Bitcrusher) |
| Source record ids | github_search_effects-6202a350b7d741 |
...
For a systems engineer, CanYuzbey/Cpp-Audio-Bitcrusher belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-25T15:51:00Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6202a350b7d741` from `github_search_effects` as `registry_expansion`
