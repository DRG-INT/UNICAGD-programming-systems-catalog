...
| Canonical URL | [https://packagist.org/packages/astrotomic/laravel-translatable](https://packagist.org/packages/astrotomic/laravel-translatable) |
| Source record ids | packagist_search-b2762fc8b75ecb |
...
For a systems engineer, astrotomic/laravel-translatable belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v11.17.1 | 2026-08-14T20:50:15+00:00 | [https://repo.packagist.org/p2/astrotomic/laravel-translatable.json](https://repo.packagist.org/p2/astrotomic/laravel-translatable.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/astrotomic/laravel-translatable.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-b2762fc8b75ecb` from `packagist_search` as `registry_expansion`
