...
| Source record ids | github_search_pattern_language-848c03a30e5be5 |
...
For a systems engineer, sohamkamani/javascript-design-patterns-for-humans belongs in the Pattern
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-08T05:07:39Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-848c03a30e5be5` from `github_search_pattern_language` as `registry_expansion`
