...
| Canonical URL | [https://crates.io/crates/migrations_macros](https://crates.io/crates/migrations_macros) |
| Source record ids | crates_io-9f2d26d07f1a8a |
...
For a systems engineer, migrations_macros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2025-09-12T12:35:45.303192Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-9f2d26d07f1a8a` from `crates_io` as `registry_expansion`
