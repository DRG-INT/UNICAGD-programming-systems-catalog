...
<!-- canonical: http://vrld.github.io/HardonCollider/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://vrld.github.io/HardonCollider/](http://vrld.github.io/HardonCollider/) |
| Source record ids | lua-source-136 |
...
For a systems engineer, HardonCollider belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 136}}` |
...
- `lua-source-136` from `master_json` as `source_list_item`
