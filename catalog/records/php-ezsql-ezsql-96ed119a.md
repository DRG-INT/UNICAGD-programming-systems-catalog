...
| Canonical URL | [https://packagist.org/packages/ezsql/ezsql](https://packagist.org/packages/ezsql/ezsql) |
| Source record ids | packagist_search-446e389c61c3b8 |

## System Engineer Summary

Advance database access library. Make interacting with a database ridiculously easy. An universal
interchangeable CRUD system.

## Operational Role

For a systems engineer, ezsql/ezsql belongs in the PHP inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.3 | 2026-04-02T10:56:41+00:00 | [https://repo.packagist.org/p2/ezsql/ezsql.json](https://repo.packagist.org/p2/ezsql/ezsql.json) |  |
...
| Evidence | LGPL-3.0-or-later; MIT |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ezsql/ezsql.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-446e389c61c3b8` from `packagist_search` as `registry_expansion`
