...
<!-- canonical: https://github.com/OvenMediaLabs/OvenMediaEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OvenMediaLabs/OvenMediaEngine](https://github.com/OvenMediaLabs/OvenMediaEngine) |
| Source record ids | github_search_video-ef696935909bd9 |

## System Engineer Summary

OvenMediaEngine (OME) is a Sub-Second Latency Live Streaming Server with Large-Scale and High-
Definition. #WebRTC #LLHLS

## Operational Role

For a systems engineer, OvenMediaLabs/OvenMediaEngine belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T15:01:52Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ef696935909bd9` from `github_search_video` as `registry_expansion`
