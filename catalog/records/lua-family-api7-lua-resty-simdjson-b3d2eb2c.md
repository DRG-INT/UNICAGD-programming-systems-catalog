...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-simdjson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-resty-simdjson](https://luarocks.org/modules/membphis/api7-lua-resty-simdjson) |
| Source record ids | luarocks_root_manifest-33f5cb6323ced4 |

## System Engineer Summary

Fast JSON encoder and decoder for OpenResty

## Operational Role

For a systems engineer, api7-lua-resty-simdjson belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-33f5cb6323ced4` from `luarocks_root_manifest` as `registry_expansion`
