...
| Canonical URL | [https://crates.io/crates/aes-gcm-siv](https://crates.io/crates/aes-gcm-siv) |
| Source record ids | crates_io-866327e898289e |

## System Engineer Summary

Pure Rust implementation of the AES-GCM-SIV Misuse-Resistant Authenticated Encryption Cipher (RFC
8452) with optional architecture-specific hardware acceleration

## Operational Role

For a systems engineer, aes-gcm-siv belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.1 | 2026-08-21T20:59:03.046842Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-866327e898289e` from `crates_io` as `registry_expansion`
