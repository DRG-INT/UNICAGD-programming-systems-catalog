...
| Canonical URL | [https://luarocks.org/modules/mah0x211/getopts](https://luarocks.org/modules/mah0x211/getopts) |
| Source record ids | luarocks_root_manifest-6e081b5f05ba22 |

## System Engineer Summary

getopts is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, getopts belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6e081b5f05ba22` from `luarocks_root_manifest` as `registry_expansion`
