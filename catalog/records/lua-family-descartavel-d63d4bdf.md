...
<!-- canonical: https://luarocks.org/modules/y-akulau/descartavel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/y-akulau/descartavel](https://luarocks.org/modules/y-akulau/descartavel) |
| Source record ids | luarocks_root_manifest-ee815964c8c442 |

## System Engineer Summary

descartavel is tracked as a filesystem os record in the Lua family branch. The source did not
...
For a systems engineer, descartavel belongs in the Lua family inventory as part of ecosystem
...
| Evidence | GPL-3; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit |
...
- `luarocks_root_manifest-ee815964c8c442` from `luarocks_root_manifest` as `registry_expansion`
