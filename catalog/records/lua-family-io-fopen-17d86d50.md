...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Filesystem Os](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/filesystem-os.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/io-fopen](https://luarocks.org/modules/mah0x211/io-fopen) |
| Source record ids | luarocks_root_manifest-d4a5089df9ac6c |
...
For a systems engineer, io-fopen belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| ab-microsensor | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ab-microsensor-111dea48.md) |
| access-token-introspection | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-access-token-introspection-6c4174ae.md) |
| adjustbox | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-adjustbox-d42a52c7.md) |
| AeroString | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aerostring-82ace699.md) |
| Anarchy | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-anarchy-c50edec9.md) |
| Anarchy32 | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-anarchy32-01c14b49.md) |
| ao-lua-lib | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-ao-lua-lib-e8815035.md) |
| awesome-autostart | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-autostart-91918fbc.md) |
