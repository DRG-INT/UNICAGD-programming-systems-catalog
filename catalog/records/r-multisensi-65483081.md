...
<!-- canonical: https://cran.r-project.org/web/packages/multisensi/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multisensi/index.html](https://cran.r-project.org/web/packages/multisensi/index.html) |
| Source record ids | cran_packages_by_date-713443f7f54086 |
...
For a systems engineer, multisensi belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2-1 | 2026-08-19 22:00:02 UTC | [https://cran.r-project.org/web/packages/multisensi/DESCRIPTION](https://cran.r-project.org/web/packages/multisensi/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multisensi/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-713443f7f54086` from `cran_packages_by_date` as `registry_expansion`
