...
<!-- canonical: https://cran.r-project.org/web/packages/MSCsimtester/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MSCsimtester/index.html](https://cran.r-project.org/web/packages/MSCsimtester/index.html) |
| Source record ids | cran_packages_by_date-610ae9887c33e9 |
...
For a systems engineer, MSCsimtester belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-08-22 02:50:02 UTC | [https://cran.r-project.org/web/packages/MSCsimtester/DESCRIPTION](https://cran.r-project.org/web/packages/MSCsimtester/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MSCsimtester/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-610ae9887c33e9` from `cran_packages_by_date` as `registry_expansion`
