# JDat/orbiterVncClient

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JDat/orbiterVncClient -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JDat/orbiterVncClient](https://github.com/JDat/orbiterVncClient) |
| Source record ids | github_search_space_shuttles-d208b4314d50fc |

## System Engineer Summary

VNC client for Orbiter space flight simulator.

## Operational Role

For a systems engineer, JDat/orbiterVncClient belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-24T11:01:49Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-d208b4314d50fc` from `github_search_space_shuttles` as `registry_expansion`
