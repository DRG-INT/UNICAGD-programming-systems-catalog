...
<!-- canonical: https://github.com/gnucap/gnucap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gnucap/gnucap](https://github.com/gnucap/gnucap) |
| Source record ids | github_search_space_maps-e50b740cf5017f |
...
For a systems engineer, gnucap/gnucap belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T06:40:32Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e50b740cf5017f` from `github_search_space_maps` as `registry_expansion`
