...
<!-- canonical: https://cran.r-project.org/web/packages/vetiver/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vetiver/index.html](https://cran.r-project.org/web/packages/vetiver/index.html) |
| Source record ids | cran_packages_by_date-5447a5554f170c |
...
For a systems engineer, vetiver belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8 | 2026-08-23 06:40:02 UTC | [https://cran.r-project.org/web/packages/vetiver/DESCRIPTION](https://cran.r-project.org/web/packages/vetiver/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vetiver/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5447a5554f170c` from `cran_packages_by_date` as `registry_expansion`
