...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitrusAPI](https://github.com/JuliaRegistries/General/tree/master/C/CitrusAPI) |
| Source record ids | julia_general-8fa0f6e53213c4 |

## System Engineer Summary

Julia package registered in General at C/CitrusAPI.

## Operational Role

For a systems engineer, CitrusAPI belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CitrusAPI", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-8fa0f6e53213c4` from `julia_general` as `registry_expansion`
