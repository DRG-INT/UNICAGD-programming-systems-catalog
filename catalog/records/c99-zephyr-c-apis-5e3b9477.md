...
| Source record ids | corpus-895c5a144fb71f |

## System Engineer Summary

Zephyr C APIs is tracked as an embedded hardware record in the C99 branch. The source did not
...
For a systems engineer, Zephyr C APIs belongs in the C99 inventory as part of device constraints,
...
- `corpus-895c5a144fb71f` from `master_json` as `embedded_hardware`
...
| FreeRTOS | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-freertos-f4307900.md) |
