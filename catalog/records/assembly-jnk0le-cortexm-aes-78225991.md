...
<!-- canonical: https://github.com/jnk0le/cortexm-AES -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jnk0le/cortexm-AES](https://github.com/jnk0le/cortexm-AES) |
| Source record ids | github_search_assembly-b064794a286d6c |
...
For a systems engineer, jnk0le/cortexm-AES belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T21:28:25Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-b064794a286d6c` from `github_search_assembly` as `registry_expansion`
