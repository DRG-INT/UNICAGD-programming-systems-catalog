...
<!-- canonical: https://cran.r-project.org/web/packages/RColetum/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RColetum/index.html](https://cran.r-project.org/web/packages/RColetum/index.html) |
| Source record ids | cran_packages_by_date-fc6345d4a60a3c |
...
For a systems engineer, RColetum belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 05:46:03 UTC | [https://cran.r-project.org/web/packages/RColetum/DESCRIPTION](https://cran.r-project.org/web/packages/RColetum/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RColetum/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fc6345d4a60a3c` from `cran_packages_by_date` as `registry_expansion`
