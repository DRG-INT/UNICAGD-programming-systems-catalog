...
<!-- canonical: https://hackage.haskell.org/package/servant-auth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/servant-auth](https://hackage.haskell.org/package/servant-auth) |
| Source record ids | hackage_top_downloads-132d5b240d37dd |
...
For a systems engineer, servant-auth belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.10.0 | 2026-06-20T10:37:09Z | [https://hackage.haskell.org/package/servant-auth](https://hackage.haskell.org/package/servant-auth) |  |
| candidate | partial | 0.3.2.0 |  | [https://hackage.haskell.org/package/servant-auth](https://hackage.haskell.org/package/servant-auth) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/servant-auth` at `2026-09-12T00:29:30+00:00`.
...
- `hackage_top_downloads-132d5b240d37dd` from `hackage_top_downloads` as `registry_expansion`
