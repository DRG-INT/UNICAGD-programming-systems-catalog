...
<!-- canonical: https://luarocks.org/modules/linrongbin16/colorbox.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/linrongbin16/colorbox.nvim](https://luarocks.org/modules/linrongbin16/colorbox.nvim) |
| Source record ids | luarocks_root_manifest-f3638ba46ec225 |
...
For a systems engineer, colorbox.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f3638ba46ec225` from `luarocks_root_manifest` as `registry_expansion`
