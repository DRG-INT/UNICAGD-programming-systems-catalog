...
<!-- canonical: https://crates.io/crates/etcetera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/etcetera](https://crates.io/crates/etcetera) |
| Source record ids | crates_io-b3ac7046d33697 |
...
For a systems engineer, etcetera belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2025-10-28T13:28:11.765603Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-b3ac7046d33697` from `crates_io` as `registry_expansion`
