...
<!-- canonical: https://cran.r-project.org/web/packages/grattanInflators/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/grattanInflators/index.html](https://cran.r-project.org/web/packages/grattanInflators/index.html) |
| Source record ids | cran_packages_by_date-b9b5dd22a9f6f8 |
...
For a systems engineer, grattanInflators belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-11 08:00:02 UTC | [https://cran.r-project.org/web/packages/grattanInflators/DESCRIPTION](https://cran.r-project.org/web/packages/grattanInflators/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/grattanInflators/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-b9b5dd22a9f6f8` from `cran_packages_by_date` as `registry_expansion`
