...
<!-- canonical: https://cran.r-project.org/web/packages/specmine/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/specmine/index.html](https://cran.r-project.org/web/packages/specmine/index.html) |
| Source record ids | cran_packages_by_date-42241b7ab326d0 |
...
For a systems engineer, specmine belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.8 | 2026-08-05 09:20:02 UTC | [https://cran.r-project.org/web/packages/specmine/DESCRIPTION](https://cran.r-project.org/web/packages/specmine/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/specmine/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-42241b7ab326d0` from `cran_packages_by_date` as `registry_expansion`
