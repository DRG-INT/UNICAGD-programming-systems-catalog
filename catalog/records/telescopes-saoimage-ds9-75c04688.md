...
| Canonical URL | [https://sites.google.com/cfa.harvard.edu/saoimageds9](https://sites.google.com/cfa.harvard.edu/saoimageds9) |
| Source record ids | curated_language_routes-e21a4881b79b2f |

## System Engineer Summary

Astronomical imaging and data visualization application for FITS inspection, regions, catalogs, and
analysis.

## Operational Role

For a systems engineer, SAOImage DS9 belongs in the Telescopes inventory as part of ecosystem
...
- `curated_language_routes-e21a4881b79b2f` from `curated_language_routes` as `registry_expansion`
...
| Stellarium | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/telescopes-stellarium-4df0b7db.md) |
