...
| Source record ids | github_search_effects-1541ee3ba775fb |
...
For a systems engineer, monadgroup/axiom belongs in the Effects inventory as part of ecosystem
...
- `github_search_effects-1541ee3ba775fb` from `github_search_effects` as `registry_expansion`
