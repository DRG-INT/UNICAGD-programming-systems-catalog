...
<!-- canonical: https://pub.dev/packages/flutter_floating_bottom_bar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_floating_bottom_bar](https://pub.dev/packages/flutter_floating_bottom_bar) |
| Source record ids | pub_dev-848ef667c771c1 |

## System Engineer Summary

An adaptable Flutter floating bottom bar for navigation, search, and custom widgets, with scroll-
aware visibility and accessible interactions.

## Operational Role

For a systems engineer, flutter_floating_bottom_bar belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-10T16:21:15.529163Z | [https://pub.dev/api/packages/flutter_floating_bottom_bar](https://pub.dev/api/packages/flutter_floating_bottom_bar) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_floating_bottom_bar` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-848ef667c771c1` from `pub_dev` as `registry_expansion`
