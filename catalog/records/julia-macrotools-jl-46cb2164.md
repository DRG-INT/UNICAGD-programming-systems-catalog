...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/M/MacroTools](https://github.com/JuliaRegistries/General/tree/master/M/MacroTools) |
| Source record ids | corpus-e556abea9e930b |

## System Engineer Summary

MacroTools.jl is tracked as a parser lexer ast record in the Julia branch. The source did not
...
For a systems engineer, MacroTools.jl belongs in the Julia inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0.5.16 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/M/MacroTools/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/M/MacroTools/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-e556abea9e930b` from `master_json` as `parser_lexer_ast`
