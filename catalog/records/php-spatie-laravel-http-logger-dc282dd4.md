...
<!-- canonical: https://packagist.org/packages/spatie/laravel-http-logger -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spatie/laravel-http-logger](https://packagist.org/packages/spatie/laravel-http-logger) |
| Source record ids | packagist_search-8dafb42288cd98 |
...
For a systems engineer, spatie/laravel-http-logger belongs in the PHP inventory as part of service
...
- `packagist_search-8dafb42288cd98` from `packagist_search` as `registry_expansion`
