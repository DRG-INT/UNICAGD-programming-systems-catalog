...
| Canonical URL | [https://github.com/maplibre/maplibre-gl-js](https://github.com/maplibre/maplibre-gl-js) |
| Source record ids | curated_language_routes-620d53392f5f1d |

## System Engineer Summary

Open-source web map renderer for vector tiles, styles, interactions, and browser map applications.

## Operational Role

For a systems engineer, MapLibre GL JS belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.6.0 | 2026-08-24T15:15:59Z | [https://api.github.com/repos/maplibre/maplibre-gl-js/releases/latest](https://api.github.com/repos/maplibre/maplibre-gl-js/releases/latest) |  |
| preview | known | v6.0.0-22 | 2026-07-15T12:34:12Z | [https://api.github.com/repos/maplibre/maplibre-gl-js/releases?per_page=10](https://api.github.com/repos/maplibre/maplibre-gl-js/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/maplibre/maplibre-gl-js/releases/latest` at `2026-09-01T07:24:43+00:00`.
...
- `curated_language_routes-620d53392f5f1d` from `curated_language_routes` as `registry_expansion`
