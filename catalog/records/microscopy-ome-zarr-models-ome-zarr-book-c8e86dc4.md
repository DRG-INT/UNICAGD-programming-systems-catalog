# ome-zarr-models/ome-zarr-book

## Navigation

[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ome-zarr-models/ome-zarr-book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ome-zarr-models/ome-zarr-book](https://github.com/ome-zarr-models/ome-zarr-book) |
| Source record ids | github_search_microscopy-141ccb7ba688a3 |
...
For a systems engineer, ome-zarr-models/ome-zarr-book belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T10:28:50Z | gh search repos topic:bioimaging stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-141ccb7ba688a3` from `github_search_microscopy` as `registry_expansion`
