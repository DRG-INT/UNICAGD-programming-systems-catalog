...
<!-- canonical: https://pypi.org/project/acme-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acme-client/](https://pypi.org/project/acme-client/) |
| Source record ids | pypi_simple-d7208839f0e384 |

## System Engineer Summary

acme-client is tracked as a networking http record in the Python branch. The source did not provide
...
For a systems engineer, acme-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 0 |  | [https://pypi.org/pypi/acme-client/json](https://pypi.org/pypi/acme-client/json) | release_date_missing |
...
- `pypi_simple-d7208839f0e384` from `pypi_simple` as `registry_expansion`
