...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/tomland -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tomland](https://hackage.haskell.org/package/tomland) |
| Source record ids | hackage_top_downloads-af6e590fb5bc25 |
...
For a systems engineer, tomland belongs in the Haskell inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.3.3 | 2024-06-07T13:15:00Z | [https://hackage.haskell.org/package/tomland](https://hackage.haskell.org/package/tomland) |  |
| candidate | partial | 0.0.0 |  | [https://hackage.haskell.org/package/tomland](https://hackage.haskell.org/package/tomland) | hackage_candidate_date_missing |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; The Unlicense; https://api.github.com/licenses/unlicense; {"key": "", "name": "", "url": ""} |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tomland` at `2026-09-08T00:34:55+00:00`.
...
| --- | --- | --- | --- |
| hackage_top_downloads | registry-derived | 2026-09-13 | `{"kind": "hackage_top_downloads", "retrieved": "2026-09-13", "status": "registry-derived"}` |
...
- `hackage_top_downloads-af6e590fb5bc25` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| data-object-yaml | Serialization | [open](haskell-data-object-yaml-cba0e157.md) |
| dhall-json | Serialization | [open](haskell-dhall-json-d0352d72.md) |
| geojson | Serialization | [open](haskell-geojson-5c5d094c.md) |
| HaXml | Serialization | [open](haskell-haxml-8e99a984.md) |
| hjsonpointer | Serialization | [open](haskell-hjsonpointer-e806cabf.md) |
| hjsonschema | Serialization | [open](haskell-hjsonschema-585b7220.md) |
| htoml-megaparsec | Serialization | [open](haskell-htoml-megaparsec-9c00d85a.md) |
| hw-json | Serialization | [open](haskell-hw-json-d9e81d55.md) |
