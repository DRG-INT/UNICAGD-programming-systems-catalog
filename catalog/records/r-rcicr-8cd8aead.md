...
<!-- canonical: https://cran.r-project.org/web/packages/rcicr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rcicr/index.html](https://cran.r-project.org/web/packages/rcicr/index.html) |
| Source record ids | cran_packages_by_date-ccd2755cc0fc68 |
...
For a systems engineer, rcicr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-09-02 21:10:03 UTC | [https://cran.r-project.org/web/packages/rcicr/DESCRIPTION](https://cran.r-project.org/web/packages/rcicr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rcicr/DESCRIPTION` at `2026-09-02T22:19:13+00:00`.
...
- `cran_packages_by_date-ccd2755cc0fc68` from `cran_packages_by_date` as `registry_expansion`
