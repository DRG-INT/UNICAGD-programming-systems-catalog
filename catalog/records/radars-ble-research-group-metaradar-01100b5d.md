...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/BLE-Research-Group/MetaRadar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BLE-Research-Group/MetaRadar](https://github.com/BLE-Research-Group/MetaRadar) |
| Source record ids | github_search_radars-835eb399d23018 |

## System Engineer Summary

A tool for BLE environment monitoring. Find and track Bluetooth devices around, create custom
filters, get notified when the BLE fingerprint you are looking for is around.

## Operational Role

For a systems engineer, BLE-Research-Group/MetaRadar belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-22T20:42:21Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-835eb399d23018` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| davidscmx/radar-target-generation-and-detection | Configuration | [open](radars-davidscmx-radar-target-generation-and-detection-582f6c31.md) |
| HKUST-Aerial-Robotics/GVINS | Configuration | [open](radars-hkust-aerial-robotics-gvins-ce8f2cf2.md) |
