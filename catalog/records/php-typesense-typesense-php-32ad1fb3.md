...
<!-- canonical: https://packagist.org/packages/typesense/typesense-php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/typesense/typesense-php](https://packagist.org/packages/typesense/typesense-php) |
| Source record ids | packagist_search-6870d2ac6736af |

## System Engineer Summary

PHP client for Typesense Search Server:

## Operational Role

For a systems engineer, typesense/typesense-php belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-6870d2ac6736af` from `packagist_search` as `registry_expansion`
...
| mix/redis-subscriber | Undefined Behavior Analyzer | [open](php-mix-redis-subscriber-5bb558f8.md) |
