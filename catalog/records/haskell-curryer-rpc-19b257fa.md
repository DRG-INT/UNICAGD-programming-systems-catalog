...
<!-- canonical: https://hackage.haskell.org/package/curryer-rpc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/curryer-rpc](https://hackage.haskell.org/package/curryer-rpc) |
| Source record ids | hackage_top_downloads-f8ce7aec6a1fc1 |
...
For a systems engineer, curryer-rpc belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-07-25T04:48:06Z | [https://hackage.haskell.org/package/curryer-rpc](https://hackage.haskell.org/package/curryer-rpc) |  |
| candidate | partial | 0.1 |  | [https://hackage.haskell.org/package/curryer-rpc](https://hackage.haskell.org/package/curryer-rpc) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/curryer-rpc` at `2026-09-11T00:31:18+00:00`.
...
- `hackage_top_downloads-f8ce7aec6a1fc1` from `hackage_top_downloads` as `registry_expansion`
