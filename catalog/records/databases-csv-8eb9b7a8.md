...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc4180](https://www.rfc-editor.org/rfc/rfc4180) |
| Source record ids | curated_database_systems-d1e3a284e5fd3e |

## System Engineer Summary

Comma-separated values tabular interchange format.

## Operational Role

For a systems engineer, CSV belongs in the Databases inventory as part of wire formats, persistence,
...
- `curated_database_systems-d1e3a284e5fd3e` from `curated_database_systems` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Apache Arrow | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-arrow-de15310e.md) |
| Apache Avro | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-avro-547a0b9e.md) |
| Apache ORC | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-orc-a9582620.md) |
| Apache Parquet | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-apache-parquet-4e0e3d4f.md) |
| JSON Lines | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/databases-json-lines-b2bf7401.md) |
