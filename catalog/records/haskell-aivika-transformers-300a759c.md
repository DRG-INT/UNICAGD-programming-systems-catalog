...
<!-- canonical: https://hackage.haskell.org/package/aivika-transformers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/aivika-transformers](https://hackage.haskell.org/package/aivika-transformers) |
| Source record ids | hackage_top_downloads-2ae11da3b9345d |
...
For a systems engineer, aivika-transformers belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.1 | 2024-06-29T13:24:12Z | [https://hackage.haskell.org/package/aivika-transformers](https://hackage.haskell.org/package/aivika-transformers) |  |
| candidate | partial | 2.0 |  | [https://hackage.haskell.org/package/aivika-transformers](https://hackage.haskell.org/package/aivika-transformers) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/aivika-transformers` at `2026-09-14T00:30:39+00:00`.
...
- `hackage_top_downloads-2ae11da3b9345d` from `hackage_top_downloads` as `registry_expansion`
