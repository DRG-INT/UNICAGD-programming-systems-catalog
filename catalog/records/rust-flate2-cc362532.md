...
<!-- canonical: https://crates.io/crates/flate2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/flate2](https://crates.io/crates/flate2) |
| Source record ids | crates_io-7fcb5815231744 |

## System Engineer Summary

DEFLATE compression and decompression exposed as Read/BufRead/Write streams. Supports miniz_oxide
and multiple zlib implementations. Supports zlib, gzip, and raw deflate streams.

## Operational Role

For a systems engineer, flate2 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.10 | 2026-08-28T04:35:22.192325Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-7fcb5815231744` from `crates_io` as `registry_expansion`
