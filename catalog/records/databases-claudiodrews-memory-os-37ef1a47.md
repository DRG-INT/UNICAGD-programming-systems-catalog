...
<!-- canonical: https://github.com/ClaudioDrews/memory-os -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ClaudioDrews/memory-os](https://github.com/ClaudioDrews/memory-os) |
| Source record ids | github_search_databases-827af065e495a8 |

## System Engineer Summary

A 7-layer memory operating system for Hermes Agent — persistent memory with Qdrant, structured
facts, fabric recall, auto-curated wiki, and surgical context injection. Runs locally, any LLM
provider.

## Operational Role

For a systems engineer, ClaudioDrews/memory-os belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-10T10:40:43Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-827af065e495a8` from `github_search_databases` as `registry_expansion`
