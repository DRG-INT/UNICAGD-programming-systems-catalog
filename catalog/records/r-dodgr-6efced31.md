...
<!-- canonical: https://cran.r-project.org/web/packages/dodgr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dodgr/index.html](https://cran.r-project.org/web/packages/dodgr/index.html) |
| Source record ids | cran_packages_by_date-a28d6ace0f9eb1 |
...
For a systems engineer, dodgr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-03 13:50:09 UTC | [https://cran.r-project.org/web/packages/dodgr/DESCRIPTION](https://cran.r-project.org/web/packages/dodgr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dodgr/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-a28d6ace0f9eb1` from `cran_packages_by_date` as `registry_expansion`
