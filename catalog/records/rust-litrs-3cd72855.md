...
<!-- canonical: https://crates.io/crates/litrs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/litrs](https://crates.io/crates/litrs) |
| Source record ids | crates_io-a2b5d9a0342bf6 |

## System Engineer Summary

Parse and inspect Rust literals (i.e. tokens in the Rust programming language representing fixed
values). Particularly useful for proc macros, but can also be used outside of a proc-macro context.

## Operational Role

For a systems engineer, litrs belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2025-10-20T10:00:07.760737Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-a2b5d9a0342bf6` from `crates_io` as `registry_expansion`
