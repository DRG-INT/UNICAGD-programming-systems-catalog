...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lettucecfd/lettuce -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lettucecfd/lettuce](https://github.com/lettucecfd/lettuce) |
| Source record ids | github_search_physics_engines-1ceb115fd2363d |
...
For a systems engineer, lettucecfd/lettuce belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-13T23:21:59Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:physics-simulation stars:>50", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_physics_engines-1ceb115fd2363d` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ACskyline/Wave-Particles-with-Interactive-Vortices | Visualization Gui | [open](physics-engines-acskyline-wave-particles-with-interactive-vortices-744568eb.md) |
| Bithack/principia | Visualization Gui | [open](physics-engines-bithack-principia-a871fdbd.md) |
| DanielChappuis/reactphysics3d | Visualization Gui | [open](physics-engines-danielchappuis-reactphysics3d-121a1574.md) |
| Erkaman/gl-water2d | Visualization Gui | [open](physics-engines-erkaman-gl-water2d-264bb64b.md) |
| Ghoulpachannel/Autodesk-CFD | Visualization Gui | [open](physics-engines-ghoulpachannel-autodesk-cfd-b48294a5.md) |
| GregTJ/stable-fluids | Visualization Gui | [open](physics-engines-gregtj-stable-fluids-7e205e9c.md) |
| guitarfreak/DirectX-11-Demo | Visualization Gui | [open](physics-engines-guitarfreak-directx-11-demo-ca294a5d.md) |
| hagmas/MobileFluidSimulation | Visualization Gui | [open](physics-engines-hagmas-mobilefluidsimulation-06082174.md) |
