...
<!-- canonical: https://github.com/analogdevicesinc/plutosdr-fw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/analogdevicesinc/plutosdr-fw](https://github.com/analogdevicesinc/plutosdr-fw) |
| Source record ids | github_search_satcom_satellites-f0dcc6c783a735 |

## System Engineer Summary

analogdevicesinc/plutosdr-fw is tracked as a logging observability record in the SatCom Satellites
...
For a systems engineer, analogdevicesinc/plutosdr-fw belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T21:21:29Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-f0dcc6c783a735` from `github_search_satcom_satellites` as `registry_expansion`
