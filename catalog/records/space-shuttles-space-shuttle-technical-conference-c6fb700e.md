...
| Canonical URL | [https://ntrs.nasa.gov/](https://ntrs.nasa.gov/) |
| Source record ids | curated_language_routes-4d0cdec7824822 |

## System Engineer Summary

NASA Technical Reports Server route for shuttle engineering papers, mission documents, and systems
references.

## Operational Role

For a systems engineer, Space Shuttle Technical Conference belongs in the Space Shuttles inventory
...
- `curated_language_routes-4d0cdec7824822` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| NASA Space Shuttle Overview | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/space-shuttles-nasa-space-shuttle-overview-8fb6d0f3.md) |
