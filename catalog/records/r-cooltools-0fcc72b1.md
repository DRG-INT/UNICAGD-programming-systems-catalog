...
<!-- canonical: https://cran.r-project.org/web/packages/cooltools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cooltools/index.html](https://cran.r-project.org/web/packages/cooltools/index.html) |
| Source record ids | cran_packages_by_date-3c6774e48579e0 |
...
For a systems engineer, cooltools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.33 | 2026-09-11 10:20:08 UTC | [https://cran.r-project.org/web/packages/cooltools/DESCRIPTION](https://cran.r-project.org/web/packages/cooltools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cooltools/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-3c6774e48579e0` from `cran_packages_by_date` as `registry_expansion`
