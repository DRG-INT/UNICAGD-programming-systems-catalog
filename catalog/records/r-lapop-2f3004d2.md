...
<!-- canonical: https://cran.r-project.org/web/packages/lapop/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lapop/index.html](https://cran.r-project.org/web/packages/lapop/index.html) |
| Source record ids | cran_packages_by_date-eecbd19b07c81e |
...
For a systems engineer, lapop belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2 | 2026-09-05 16:00:03 UTC | [https://cran.r-project.org/web/packages/lapop/DESCRIPTION](https://cran.r-project.org/web/packages/lapop/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lapop/DESCRIPTION` at `2026-09-05T16:19:03+00:00`.
...
- `cran_packages_by_date-eecbd19b07c81e` from `cran_packages_by_date` as `registry_expansion`
