...
<!-- canonical: https://hackage.haskell.org/package/vector-instances -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vector-instances](https://hackage.haskell.org/package/vector-instances) |
| Source record ids | hackage_top_downloads-6344c54d82ec88 |
...
For a systems engineer, vector-instances belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.3 | 2025-06-01T22:17:56Z | [https://hackage.haskell.org/package/vector-instances](https://hackage.haskell.org/package/vector-instances) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vector-instances` at `2026-09-10T01:21:10+00:00`.
...
- `hackage_top_downloads-6344c54d82ec88` from `hackage_top_downloads` as `registry_expansion`
