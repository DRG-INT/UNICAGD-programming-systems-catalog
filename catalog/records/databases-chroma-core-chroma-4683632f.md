...
| Source record ids | github_search_databases-d8a3c4786456b1 |
...
For a systems engineer, chroma-core/chroma belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T00:43:16Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d8a3c4786456b1` from `github_search_databases` as `registry_expansion`
