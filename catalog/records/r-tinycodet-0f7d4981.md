...
<!-- canonical: https://cran.r-project.org/web/packages/tinycodet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinycodet/index.html](https://cran.r-project.org/web/packages/tinycodet/index.html) |
| Source record ids | cran_packages_by_date-159c0a14fa193c |
...
For a systems engineer, tinycodet belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-08-21 06:20:02 UTC | [https://cran.r-project.org/web/packages/tinycodet/DESCRIPTION](https://cran.r-project.org/web/packages/tinycodet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinycodet/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-159c0a14fa193c` from `cran_packages_by_date` as `registry_expansion`
