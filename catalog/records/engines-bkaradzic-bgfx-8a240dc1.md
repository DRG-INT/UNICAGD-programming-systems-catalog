...
<!-- canonical: https://github.com/bkaradzic/bgfx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bkaradzic/bgfx](https://github.com/bkaradzic/bgfx) |
| Source record ids | github_search_engines-2ff18daadcc1f5 |
...
For a systems engineer, bkaradzic/bgfx belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:07:58Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_engines-2ff18daadcc1f5` from `github_search_engines` as `registry_expansion`
...
| coronalabs/corona | Filesystem Os | [open](engines-coronalabs-corona-521f8f94.md) |
