...
<!-- canonical: https://cran.r-project.org/web/packages/RCtest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RCtest/index.html](https://cran.r-project.org/web/packages/RCtest/index.html) |
| Source record ids | cran_packages_by_date-eb29e544fbd46d |
...
For a systems engineer, RCtest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-08-28 14:40:10 UTC | [https://cran.r-project.org/web/packages/RCtest/DESCRIPTION](https://cran.r-project.org/web/packages/RCtest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RCtest/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eb29e544fbd46d` from `cran_packages_by_date` as `registry_expansion`
