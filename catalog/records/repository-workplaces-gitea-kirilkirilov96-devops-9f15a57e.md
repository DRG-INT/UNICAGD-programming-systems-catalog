...
<!-- canonical: https://gitea.com/KirilKirilov96/devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/KirilKirilov96/devops](https://gitea.com/KirilKirilov96/devops) |
| Source record ids | gitea_repositories_api-6ce58a05f5e528 |
...
For a systems engineer, Gitea: KirilKirilov96/devops belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-04T19:17:05Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-6ce58a05f5e528` from `gitea_repositories_api` as `registry_expansion`
