...
<!-- canonical: https://cran.r-project.org/web/packages/tidygedcom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tidygedcom/index.html](https://cran.r-project.org/web/packages/tidygedcom/index.html) |
| Source record ids | cran_packages_by_date-d881e3e63e05b7 |

## System Engineer Summary

Read and Tidy 'GEDCOM' Genealogy Files

## Operational Role

For a systems engineer, tidygedcom belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-01 08:50:08 UTC | [https://cran.r-project.org/web/packages/tidygedcom/DESCRIPTION](https://cran.r-project.org/web/packages/tidygedcom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tidygedcom/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-d881e3e63e05b7` from `cran_packages_by_date` as `registry_expansion`
