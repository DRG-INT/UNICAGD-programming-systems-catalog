...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/imsai-sh/awesome-deepseek-harness-plugins -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/imsai-sh/awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) |
| Source record ids | github_search_catalogs-50d3a92e001c70 |

## System Engineer Summary

DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings,
install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与格式校验，免费搜索
API。deepseek1024.com

## Operational Role

For a systems engineer, imsai-sh/awesome-deepseek-harness-plugins belongs in the Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T16:43:47Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-50d3a92e001c70` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AppImage/appimage.github.io | Undefined Behavior Analyzer | [open](catalogs-appimage-appimage-github-io-f260d9b1.md) |
| awclub/catalog | Undefined Behavior Analyzer | [open](catalogs-awclub-catalog-58839c97.md) |
| datahub-project/datahub | Undefined Behavior Analyzer | [open](catalogs-datahub-project-datahub-245b610a.md) |
| erikdarlingdata/DarlingData | Undefined Behavior Analyzer | [open](catalogs-erikdarlingdata-darlingdata-be996c85.md) |
| FeatureBaseDB/featurebase | Undefined Behavior Analyzer | [open](catalogs-featurebasedb-featurebase-1eac6a36.md) |
| italia/.github | Undefined Behavior Analyzer | [open](catalogs-italia-github-0b346e57.md) |
| leenkcool/Blue-Whale-Harness | Undefined Behavior Analyzer | [open](catalogs-leenkcool-blue-whale-harness-b2691c97.md) |
| llnl/llnl.github.io | Undefined Behavior Analyzer | [open](catalogs-llnl-llnl-github-io-afb77a91.md) |
