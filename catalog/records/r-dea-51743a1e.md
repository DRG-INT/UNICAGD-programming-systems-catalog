...
<!-- canonical: https://cran.r-project.org/web/packages/DEA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DEA/index.html](https://cran.r-project.org/web/packages/DEA/index.html) |
| Source record ids | cran_packages_by_date-f96c5ab8d5a56c |
...
For a systems engineer, DEA belongs in the R inventory as part of defect discovery, security review,
undefined-state detection, and regression prevention.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-10 08:40:02 UTC | [https://cran.r-project.org/web/packages/DEA/DESCRIPTION](https://cran.r-project.org/web/packages/DEA/DESCRIPTION) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DEA/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-f96c5ab8d5a56c` from `cran_packages_by_date` as `registry_expansion`
