...
<!-- canonical: https://cran.r-project.org/web/packages/cloudosR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cloudosR/index.html](https://cran.r-project.org/web/packages/cloudosR/index.html) |
| Source record ids | cran_packages_by_date-b32e84f061b3f8 |

## System Engineer Summary

'Lifebit' Platform 'API' Client

## Operational Role

For a systems engineer, cloudosR belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-08-28 09:00:02 UTC | [https://cran.r-project.org/web/packages/cloudosR/DESCRIPTION](https://cran.r-project.org/web/packages/cloudosR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cloudosR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b32e84f061b3f8` from `cran_packages_by_date` as `registry_expansion`
