...
| Canonical URL | [https://www.rfc-editor.org/rfc/rfc9000.html](https://www.rfc-editor.org/rfc/rfc9000.html) |
| Source record ids | curated_language_routes-356dabe093e18c |

## System Engineer Summary

QUIC transport protocol specification for encrypted multiplexed streams over UDP.

## Operational Role

For a systems engineer, QUIC belongs in the Transmission Protocols inventory as part of service
...
- `curated_language_routes-356dabe093e18c` from `curated_language_routes` as `registry_expansion`
