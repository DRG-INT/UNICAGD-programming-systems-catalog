...
<!-- canonical: https://pub.dev/packages/sentry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/sentry](https://pub.dev/packages/sentry) |
| Source record ids | pub_dev-fd04484eba95d2 |

## System Engineer Summary

A crash reporting library for Dart that sends crash reports to Sentry.io. This library supports Dart
VM and Web. For Flutter consider sentry_flutter instead.

## Operational Role

For a systems engineer, sentry belongs in the Dart inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.30.0 | 2026-09-10T16:04:39.565069Z | [https://pub.dev/api/packages/sentry](https://pub.dev/api/packages/sentry) |  |
| preview | known | 10.0.0-alpha.5 | 2026-09-08T11:27:24.015188Z | [https://pub.dev/api/packages/sentry](https://pub.dev/api/packages/sentry) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/sentry` at `2026-09-10T19:16:48+00:00`.
...
- `pub_dev-fd04484eba95d2` from `pub_dev` as `registry_expansion`
...
| screenshot | Interpreter Runtime | [open](dart-screenshot-1783622b.md) |
