...
<!-- canonical: https://hackage.haskell.org/package/store -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/store](https://hackage.haskell.org/package/store) |
| Source record ids | hackage_top_downloads-d1f56ea5d902bf |
...
For a systems engineer, store belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.22 | 2026-06-10T22:36:29Z | [https://hackage.haskell.org/package/store](https://hackage.haskell.org/package/store) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/store` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-d1f56ea5d902bf` from `hackage_top_downloads` as `registry_expansion`
