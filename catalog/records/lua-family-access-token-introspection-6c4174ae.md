...
<!-- canonical: https://luarocks.org/modules/vitorduarte/access-token-introspection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vitorduarte/access-token-introspection](https://luarocks.org/modules/vitorduarte/access-token-introspection) |
| Source record ids | luarocks_root_manifest-019ea6ff85e773 |

## System Engineer Summary

0 JWT access-token, added to request header.

## Operational Role

For a systems engineer, access-token-introspection belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-019ea6ff85e773` from `luarocks_root_manifest` as `registry_expansion`
