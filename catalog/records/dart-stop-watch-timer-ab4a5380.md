...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/stop_watch_timer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/stop_watch_timer](https://pub.dev/packages/stop_watch_timer) |
| Source record ids | pub_dev-1b3356098886ba |
...
For a systems engineer, stop_watch_timer belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2025-04-16T00:53:33.047504Z | [https://pub.dev/api/packages/stop_watch_timer](https://pub.dev/api/packages/stop_watch_timer) |  |
| preview | known | 0.8.0-nullsafety.0 | 2020-12-18T00:47:16.878324Z | [https://pub.dev/api/packages/stop_watch_timer](https://pub.dev/api/packages/stop_watch_timer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/stop_watch_timer` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-1b3356098886ba` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| add_2_calendar | Datetime | [open](dart-add-2-calendar-3ac9ecfa.md) |
| board_datetime_picker | Datetime | [open](dart-board-datetime-picker-13c3ffb4.md) |
| bottom_picker | Datetime | [open](dart-bottom-picker-4467bf7b.md) |
| calendar_date_picker2 | Datetime | [open](dart-calendar-date-picker2-ddfedab4.md) |
| calendar_view | Datetime | [open](dart-calendar-view-9c4f778e.md) |
| cron | Datetime | [open](dart-cron-b2accb33.md) |
| flutter_scene | Datetime | [open](dart-flutter-scene-87bec71b.md) |
| flutter_timezone | Datetime | [open](dart-flutter-timezone-80d10085.md) |
