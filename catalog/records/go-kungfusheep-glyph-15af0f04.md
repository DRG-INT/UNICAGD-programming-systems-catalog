...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kungfusheep/glyph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kungfusheep/glyph](https://github.com/kungfusheep/glyph) |
| Source record ids | github_search_go-7a194ed55e7075 |
...
For a systems engineer, kungfusheep/glyph belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T16:49:36Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-7a194ed55e7075` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| inancgumus/learngo | Visualization Gui | [open](go-inancgumus-learngo-aa01cb96.md) |
| modernc.org/quickjs | Visualization Gui | [open](go-modernc-org-quickjs-953c15ce.md) |
| piquette/finance-go | Visualization Gui | [open](go-piquette-finance-go-e7f50ebc.md) |
