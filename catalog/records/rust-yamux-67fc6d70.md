...
| Canonical URL | [https://crates.io/crates/yamux](https://crates.io/crates/yamux) |
| Source record ids | crates_io-3a746c049760a3 |
...
For a systems engineer, yamux belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-06-20T14:16:47.283089Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-3a746c049760a3` from `crates_io` as `registry_expansion`
