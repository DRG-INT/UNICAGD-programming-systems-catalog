...
<!-- canonical: https://hackage.haskell.org/package/postgresql-query -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/postgresql-query](https://hackage.haskell.org/package/postgresql-query) |
| Source record ids | hackage_top_downloads-29d4320d96cbf2 |
...
For a systems engineer, postgresql-query belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.10.0 | 2022-08-22T18:13:16Z | [https://hackage.haskell.org/package/postgresql-query](https://hackage.haskell.org/package/postgresql-query) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/postgresql-query` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-29d4320d96cbf2` from `hackage_top_downloads` as `registry_expansion`
