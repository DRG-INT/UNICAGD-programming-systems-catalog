...
<!-- canonical: https://cran.r-project.org/web/packages/fdm2id/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fdm2id/index.html](https://cran.r-project.org/web/packages/fdm2id/index.html) |
| Source record ids | cran_packages_by_date-20656094af97de |
...
For a systems engineer, fdm2id belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-28 07:01:00 UTC | [https://cran.r-project.org/web/packages/fdm2id/DESCRIPTION](https://cran.r-project.org/web/packages/fdm2id/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fdm2id/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-20656094af97de` from `cran_packages_by_date` as `registry_expansion`
