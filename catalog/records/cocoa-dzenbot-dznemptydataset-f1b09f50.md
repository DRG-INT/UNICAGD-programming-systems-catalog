...
<!-- canonical: https://github.com/dzenbot/DZNEmptyDataSet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dzenbot/DZNEmptyDataSet](https://github.com/dzenbot/DZNEmptyDataSet) |
| Source record ids | github_search_cocoa-02262eb5e77cac |

## System Engineer Summary

A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the
view has no content to display

## Operational Role

For a systems engineer, dzenbot/DZNEmptyDataSet belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-06T08:08:53Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-02262eb5e77cac` from `github_search_cocoa` as `registry_expansion`
