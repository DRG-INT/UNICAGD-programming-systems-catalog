...
<!-- canonical: https://pub.dev/packages/keyboard_actions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/keyboard_actions](https://pub.dev/packages/keyboard_actions) |
| Source record ids | pub_dev-d7b701e018734c |

## System Engineer Summary

Add a keyboard toolbar in Flutter with Done, Prev/Next, custom bars, and custom keyboards. Works in
forms, lists, dialogs, and sheets.

## Operational Role

For a systems engineer, keyboard_actions belongs in the Dart inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.2 | 2026-08-10T15:13:41.903477Z | [https://pub.dev/api/packages/keyboard_actions](https://pub.dev/api/packages/keyboard_actions) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/keyboard_actions` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-d7b701e018734c` from `pub_dev` as `registry_expansion`
