...
<!-- canonical: https://crates.io/crates/serde_derive_internals -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_derive_internals](https://crates.io/crates/serde_derive_internals) |
| Source record ids | crates_io-bfa95f41d123da |
...
For a systems engineer, serde_derive_internals belongs in the Rust inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.0 | 2026-07-25T14:58:00.367023Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-bfa95f41d123da` from `crates_io` as `registry_expansion`
