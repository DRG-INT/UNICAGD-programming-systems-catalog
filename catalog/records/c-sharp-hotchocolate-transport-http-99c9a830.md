...
<!-- canonical: https://www.nuget.org/packages/HotChocolate.Transport.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/HotChocolate.Transport.Http](https://www.nuget.org/packages/HotChocolate.Transport.Http) |
| Source record ids | nuget_search-152a602464fb98 |
...
For a systems engineer, HotChocolate.Transport.Http belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 16.6.2 | 2026-08-28T14:46:29.82+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/hotchocolate.transport.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/hotchocolate.transport.http/index.json) |  |
| preview | known | 16.7.0-p.2 | 2026-09-01T08:19:12.06+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/hotchocolate.transport.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/hotchocolate.transport.http/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/HotChocolate.Transport.Http/16.6.2/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/hotchocolate.transport.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-152a602464fb98` from `nuget_search` as `registry_expansion`
