# Gitea: ndroid/admin_panel-server-alpacino
...
<!-- canonical: https://gitea.com/ndroid/admin_panel-server-alpacino -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/ndroid/admin_panel-server-alpacino](https://gitea.com/ndroid/admin_panel-server-alpacino) |
| Source record ids | gitea_repositories_api-815bff51f30977 |

## System Engineer Summary

Admin panel integrated with Rest api and Android App

## Operational Role

For a systems engineer, Gitea: ndroid/admin_panel-server-alpacino belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-27T11:32:16Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-815bff51f30977` from `gitea_repositories_api` as `registry_expansion`
