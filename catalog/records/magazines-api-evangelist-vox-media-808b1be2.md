...
<!-- canonical: https://github.com/api-evangelist/vox-media -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/api-evangelist/vox-media](https://github.com/api-evangelist/vox-media) |
| Source record ids | github_search_magazines-5dbc1b6fc1cad5 |

## System Engineer Summary

Vox Media — independent third-party profile of a public API surface, by API Evangelist. Vox Media is
a modern media company whose networks include The Verge, Vox, New York Magazine, SB Nation, Eater,
Polygon, The Cut, and Vulture. Its developer-facing surface centers on Coral (Coral by Vox Media),
the open-source commenting and community-moderation

## Operational Role

For a systems engineer, api-evangelist/vox-media belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T20:24:39Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-5dbc1b6fc1cad5` from `github_search_magazines` as `registry_expansion`
