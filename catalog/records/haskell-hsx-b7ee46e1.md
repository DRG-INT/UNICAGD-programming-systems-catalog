...
<!-- canonical: https://hackage.haskell.org/package/hsx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hsx](https://hackage.haskell.org/package/hsx) |
| Source record ids | hackage_top_downloads-4bedbe400388c9 |
...
For a systems engineer, hsx belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.5 | 2013-09-05T19:59:03Z | [https://hackage.haskell.org/package/hsx](https://hackage.haskell.org/package/hsx) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hsx` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-4bedbe400388c9` from `hackage_top_downloads` as `registry_expansion`
