...
<!-- canonical: https://www.npmjs.com/package/es-dev-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/es-dev-server](https://www.npmjs.com/package/es-dev-server) |
| Source record ids | npm_registry-80d0604edaf515 |
...
For a systems engineer, es-dev-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2021-01-18T21:36:54.178Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-80d0604edaf515` from `npm_registry` as `registry_expansion`
