...
| Source record ids | github_search_databases-6d3adad19d6996 |

## System Engineer Summary

Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next
generation of AI. Also available in the cloud

## Operational Role

For a systems engineer, qdrant/qdrant belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:23:50Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6d3adad19d6996` from `github_search_databases` as `registry_expansion`
