...
<!-- canonical: https://luarocks.org/modules/leonsilicon/balanced-match-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/leonsilicon/balanced-match-lua](https://luarocks.org/modules/leonsilicon/balanced-match-lua) |
| Source record ids | luarocks_root_manifest-2cdbe4d82fff26 |

## System Engineer Summary

balanced-match-lua is tracked as a library record in the Lua family branch. The source did not
...
For a systems engineer, balanced-match-lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-2cdbe4d82fff26` from `luarocks_root_manifest` as `registry_expansion`
