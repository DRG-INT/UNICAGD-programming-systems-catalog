...
<!-- canonical: https://crates.io/crates/float-ord -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/float-ord](https://crates.io/crates/float-ord) |
| Source record ids | crates_io-cc4b32ff358954 |
...
For a systems engineer, float-ord belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2021-07-27T15:40:28.462791Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
