...
<!-- canonical: https://luarocks.org/modules/oka/base -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/oka/base](https://luarocks.org/modules/oka/base) |
| Source record ids | luarocks_root_manifest-aea74ff976f0d0 |
...
For a systems engineer, base belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-aea74ff976f0d0` from `luarocks_root_manifest` as `registry_expansion`
