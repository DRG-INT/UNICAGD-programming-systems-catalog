...
<!-- canonical: https://github.com/andre-batista/eispy2d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/andre-batista/eispy2d](https://github.com/andre-batista/eispy2d) |
| Source record ids | github_search_electromagnetoscopes-b75b25f527152c |

## System Engineer Summary

An Open-Source Python Library for the development of algorithms for 2D Electromagnetic Inverse
Scattering Problems.

## Operational Role

For a systems engineer, andre-batista/eispy2d belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T13:27:37Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b75b25f527152c` from `github_search_electromagnetoscopes` as `registry_expansion`
