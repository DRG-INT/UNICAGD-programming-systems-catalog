...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bmadone/senior-software-engineer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bmadone/senior-software-engineer](https://github.com/bmadone/senior-software-engineer) |
| Source record ids | github_search_pattern_language-3367dc170c0fac |
...
For a systems engineer, bmadone/senior-software-engineer belongs in the Pattern language inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-09T17:38:39Z | gh search repos software architecture patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-3367dc170c0fac` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| LilMGenius/paperthin | Game Engine Game Dev | [open](pattern-language-lilmgenius-paperthin-6c1ddacf.md) |
| QianMo/Unity-Design-Pattern | Game Engine Game Dev | [open](pattern-language-qianmo-unity-design-pattern-dd640cdc.md) |
