...
| Canonical URL | [https://crates.io/crates/histogram](https://crates.io/crates/histogram) |
| Source record ids | crates_io-38b12ea113a021 |
...
For a systems engineer, histogram belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-07-02T19:38:16.200316Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-38b12ea113a021` from `crates_io` as `registry_expansion`
