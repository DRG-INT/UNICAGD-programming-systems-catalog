...
| Canonical URL | [https://packagist.org/packages/belamov/postgres-range](https://packagist.org/packages/belamov/postgres-range) |
| Source record ids | packagist_search-b48fbda348607b |
...
For a systems engineer, belamov/postgres-range belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-04-17T20:33:12+00:00 | [https://repo.packagist.org/p2/belamov/postgres-range.json](https://repo.packagist.org/p2/belamov/postgres-range.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/belamov/postgres-range.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-b48fbda348607b` from `packagist_search` as `registry_expansion`
