...
<!-- canonical: https://github.com/mrhooray/kdtree-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mrhooray/kdtree-rs](https://github.com/mrhooray/kdtree-rs) |
| Source record ids | github_search_catalogs-ec6c782ead7e65 |
...
For a systems engineer, mrhooray/kdtree-rs belongs in the Catalogs inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-23T21:09:47Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ec6c782ead7e65` from `github_search_catalogs` as `registry_expansion`
