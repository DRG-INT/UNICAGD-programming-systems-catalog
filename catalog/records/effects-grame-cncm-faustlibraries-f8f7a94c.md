...
<!-- canonical: https://github.com/grame-cncm/faustlibraries -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grame-cncm/faustlibraries](https://github.com/grame-cncm/faustlibraries) |
| Source record ids | github_search_effects-919ed32bb695ae |

## System Engineer Summary

grame-cncm/faustlibraries is tracked as an image audio dsp record in the Effects branch. The source
...
For a systems engineer, grame-cncm/faustlibraries belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T16:46:10Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-919ed32bb695ae` from `github_search_effects` as `registry_expansion`
