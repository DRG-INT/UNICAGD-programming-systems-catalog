...
<!-- canonical: https://cran.r-project.org/web/packages/xaci/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xaci/index.html](https://cran.r-project.org/web/packages/xaci/index.html) |
| Source record ids | cran_packages_by_date-ae2c747d2c79df |

## System Engineer Summary

xaci is tracked as a cli record in the R branch. The source did not provide a long description, so
this page keeps the identity, release state, provenance, and operational classification explicit for
later enrichment.

## Operational Role

For a systems engineer, xaci belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 15:20:02 UTC | [https://cran.r-project.org/web/packages/xaci/DESCRIPTION](https://cran.r-project.org/web/packages/xaci/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xaci/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-ae2c747d2c79df` from `cran_packages_by_date` as `registry_expansion`
