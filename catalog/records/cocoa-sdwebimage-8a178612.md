...
<!-- canonical: https://cocoapods.org/pods/SDWebImage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/SDWebImage](https://cocoapods.org/pods/SDWebImage) |
| Source record ids | cocoapods_cdn-70198346ef8da8 |
...
For a systems engineer, SDWebImage belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.21.7 | 2026-02-26 07:41:49 UTC | [https://trunk.cocoapods.org/api/v1/pods/SDWebImage](https://trunk.cocoapods.org/api/v1/pods/SDWebImage) |  |
| preview | known | 5.0.0-beta6 | 2019-03-15 07:52:07 UTC | [https://trunk.cocoapods.org/api/v1/pods/SDWebImage](https://trunk.cocoapods.org/api/v1/pods/SDWebImage) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/SDWebImage` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-70198346ef8da8` from `cocoapods_cdn` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| michaelhenry/ImageViewer.swift | Image Audio Dsp | [open](cocoa-michaelhenry-imageviewer-swift-87f7ff2e.md) |
