...
<!-- canonical: https://github.com/daxnet/we-text -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daxnet/we-text](https://github.com/daxnet/we-text) |
| Source record ids | github_search_pattern_language-bdb68544d73219 |

## System Engineer Summary

WeText is a sample application that demonstrates the implementation of DDD/CQRS and microservice
architectural patterns in C#.

## Operational Role

For a systems engineer, daxnet/we-text belongs in the Pattern language inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-11-15T07:06:13Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-bdb68544d73219` from `github_search_pattern_language` as `registry_expansion`
