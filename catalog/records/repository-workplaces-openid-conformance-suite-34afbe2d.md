...
<!-- canonical: https://gitlab.com/openid/conformance-suite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/openid/conformance-suite](https://gitlab.com/openid/conformance-suite) |
| Source record ids | gitlab_projects_api-35dbc4514e291a |

## System Engineer Summary

Conformance/certification suite for OIDF's OpenID Connect, FAPI & FAPI-CIBA Profiles, including
OpenBanking UK & Australia CDR security conformance certification Production deployment:

## Operational Role

For a systems engineer, openid/conformance-suite belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-35dbc4514e291a` from `gitlab_projects_api` as `registry_expansion`
