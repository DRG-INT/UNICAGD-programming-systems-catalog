...
<!-- canonical: https://github.com/gaarason/database-all -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gaarason/database-all](https://github.com/gaarason/database-all) |
| Source record ids | github_search_databases-ba3ca55315c609 |
...
For a systems engineer, gaarason/database-all belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-09T17:30:02Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ba3ca55315c609` from `github_search_databases` as `registry_expansion`
