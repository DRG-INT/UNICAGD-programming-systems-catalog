...
<!-- canonical: https://github.com/apache/calcite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/calcite](https://github.com/apache/calcite) |
| Source record ids | github_search_maps-5878afeb113048 |

## System Engineer Summary

apache/calcite is tracked as a filesystem os record in the Maps branch. The source did not provide a
...
For a systems engineer, apache/calcite belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T07:31:30Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5878afeb113048` from `github_search_maps` as `registry_expansion`
...
| CesiumGS/cesium-unreal | Filesystem Os | [open](maps-cesiumgs-cesium-unreal-403e1d28.md) |
