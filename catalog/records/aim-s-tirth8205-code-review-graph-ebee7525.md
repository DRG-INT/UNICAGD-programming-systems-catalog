...
<!-- canonical: https://github.com/tirth8205/code-review-graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) |
| Source record ids | github_search_aims-d503e8e9c21769 |

## System Engineer Summary

Local-first code intelligence graph for MCP and CLI. Builds a persistent map of your codebase so AI
coding tools read only what matters, with benchmarked context reductions on reviews and large-repo
workflows.

## Operational Role

For a systems engineer, tirth8205/code-review-graph belongs in the "aim's" inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T09:46:23Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-d503e8e9c21769` from `github_search_aims` as `registry_expansion`
