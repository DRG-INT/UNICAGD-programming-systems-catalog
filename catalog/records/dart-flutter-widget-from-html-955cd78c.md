...
<!-- canonical: https://pub.dev/packages/flutter_widget_from_html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_widget_from_html](https://pub.dev/packages/flutter_widget_from_html) |
| Source record ids | pub_dev-9672b32ccb83de |

## System Engineer Summary

Flutter package to render html as widgets that supports hyperlink, image, audio, video, iframe and
many other tags.

## Operational Role

For a systems engineer, flutter_widget_from_html belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.3 | 2026-08-30T03:35:30.146869Z | [https://pub.dev/api/packages/flutter_widget_from_html](https://pub.dev/api/packages/flutter_widget_from_html) |  |
| preview | known | 0.14.1-alpha.1 | 2023-10-15T18:27:48.170988Z | [https://pub.dev/api/packages/flutter_widget_from_html](https://pub.dev/api/packages/flutter_widget_from_html) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_widget_from_html` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-9672b32ccb83de` from `pub_dev` as `registry_expansion`
