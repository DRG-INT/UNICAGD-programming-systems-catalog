...
| Canonical URL | [https://github.com/kickstarter/ios-oss](https://github.com/kickstarter/ios-oss) |
| Source record ids | github_search_swift-263af9e06e05f3 |
...
For a systems engineer, kickstarter/ios-oss belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.37.0 | 2026-08-26T14:52:47Z | [https://api.github.com/repos/kickstarter/ios-oss/releases/latest](https://api.github.com/repos/kickstarter/ios-oss/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/kickstarter/ios-oss/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-263af9e06e05f3` from `github_search_swift` as `registry_expansion`
