...
<!-- canonical: https://hackage.haskell.org/package/plot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/plot](https://hackage.haskell.org/package/plot) |
| Source record ids | hackage_top_downloads-a0256dd697e710 |

## System Engineer Summary

Hackage package with 64 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, plot belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3.12 | 2024-03-18T22:27:54Z | [https://hackage.haskell.org/package/plot](https://hackage.haskell.org/package/plot) |  |
| candidate | partial | 0.2.3.9 |  | [https://hackage.haskell.org/package/plot](https://hackage.haskell.org/package/plot) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/plot` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-a0256dd697e710` from `hackage_top_downloads` as `registry_expansion`
