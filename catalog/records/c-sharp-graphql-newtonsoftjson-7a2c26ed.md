...
<!-- canonical: https://www.nuget.org/packages/GraphQL.NewtonsoftJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/GraphQL.NewtonsoftJson](https://www.nuget.org/packages/GraphQL.NewtonsoftJson) |
| Source record ids | nuget_search-d2a46b62ca8c82 |
...
For a systems engineer, GraphQL.NewtonsoftJson belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.8.5 | 2026-08-18T13:56:16.563+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql.newtonsoftjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql.newtonsoftjson/index.json) |  |
| preview | known | 3.0.0-preview-1719 | 2020-08-17T22:25:37.94+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql.newtonsoftjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql.newtonsoftjson/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT; https://www.nuget.org/packages/GraphQL.NewtonsoftJson/8.8.5/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/graphql.newtonsoftjson/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-d2a46b62ca8c82` from `nuget_search` as `registry_expansion`
