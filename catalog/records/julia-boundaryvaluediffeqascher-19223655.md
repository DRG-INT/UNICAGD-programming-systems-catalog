...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoundaryValueDiffEqAscher](https://github.com/JuliaRegistries/General/tree/master/B/BoundaryValueDiffEqAscher) |
| Source record ids | julia_general-19118c181260ba |

## System Engineer Summary

Julia package registered in General at B/BoundaryValueDiffEqAscher.

## Operational Role

For a systems engineer, BoundaryValueDiffEqAscher belongs in the Julia inventory as part of
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoundaryValueDiffEqAscher", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-19118c181260ba` from `julia_general` as `registry_expansion`
