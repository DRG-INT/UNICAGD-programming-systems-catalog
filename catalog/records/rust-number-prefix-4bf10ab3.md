...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Math Numeric Scientific](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/math-numeric-scientific.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/number_prefix](https://crates.io/crates/number_prefix) |
| Source record ids | crates_io-c2dec3f01438d6 |
...
For a systems engineer, number_prefix belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2020-04-07T01:48:04.585296Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| core_maths | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-core-maths-d5834902.md) |
| emath | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-emath-88d3f20f.md) |
| ndarray | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ndarray-3e26555d.md) |
| num | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-num-f21ace27.md) |
| num-iter | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-num-iter-f74844f9.md) |
| num-traits | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-num-traits-26d9c7d0.md) |
| strict-num | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-strict-num-6614f5f5.md) |
| windows-numerics | Math Numeric Scientific | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-windows-numerics-980e10e5.md) |
