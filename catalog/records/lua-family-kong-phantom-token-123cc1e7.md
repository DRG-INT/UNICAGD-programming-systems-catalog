...
| Canonical URL | [https://luarocks.org/modules/curityio/kong-phantom-token](https://luarocks.org/modules/curityio/kong-phantom-token) |
| Source record ids | luarocks_root_manifest-3ada2f4945b63e |
...
For a systems engineer, kong-phantom-token belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3ada2f4945b63e` from `luarocks_root_manifest` as `registry_expansion`
