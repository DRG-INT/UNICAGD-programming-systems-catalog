...
<!-- canonical: https://pub.dev/packages/geocoding -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/geocoding](https://pub.dev/packages/geocoding) |
| Source record ids | pub_dev-fea1a7f954b5ef |
...
For a systems engineer, geocoding belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-07-03T15:25:51.732762Z | [https://pub.dev/api/packages/geocoding](https://pub.dev/api/packages/geocoding) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/geocoding` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-fea1a7f954b5ef` from `pub_dev` as `registry_expansion`
