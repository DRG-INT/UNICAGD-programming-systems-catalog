...
<!-- canonical: https://cran.r-project.org/web/packages/LCPA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LCPA/index.html](https://cran.r-project.org/web/packages/LCPA/index.html) |
| Source record ids | cran_packages_by_date-73afb2336e9393 |
...
For a systems engineer, LCPA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-09-06 22:50:10 UTC | [https://cran.r-project.org/web/packages/LCPA/DESCRIPTION](https://cran.r-project.org/web/packages/LCPA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LCPA/DESCRIPTION` at `2026-09-07T00:31:41+00:00`.
...
- `cran_packages_by_date-73afb2336e9393` from `cran_packages_by_date` as `registry_expansion`
