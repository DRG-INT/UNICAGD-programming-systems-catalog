...
<!-- canonical: https://gitea.com/Betsy/Aplicacion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Betsy/Aplicacion](https://gitea.com/Betsy/Aplicacion) |
| Source record ids | gitea_repositories_api-b13058b51dc0d6 |
...
For a systems engineer, Gitea: Betsy/Aplicacion belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-22T00:00:25Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-b13058b51dc0d6` from `gitea_repositories_api` as `registry_expansion`
