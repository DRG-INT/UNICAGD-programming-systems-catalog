...
<!-- canonical: https://pub.dev/packages/badges -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/badges](https://pub.dev/packages/badges) |
| Source record ids | pub_dev-45ccab5abd6d3c |

## System Engineer Summary

A package for creating badges. Badges can be used for an additional marker for any widget, e.g. show
a number of items in a shopping cart.

## Operational Role

For a systems engineer, badges belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-04-10T00:28:09.349737Z | [https://pub.dev/api/packages/badges](https://pub.dev/api/packages/badges) |  |
| preview | known | 3.0.0-beta.1 | 2022-12-25T17:35:36.932195Z | [https://pub.dev/api/packages/badges](https://pub.dev/api/packages/badges) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/badges` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-45ccab5abd6d3c` from `pub_dev` as `registry_expansion`
