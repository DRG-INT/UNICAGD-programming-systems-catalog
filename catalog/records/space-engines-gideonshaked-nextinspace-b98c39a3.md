...
| Canonical URL | [https://github.com/gideonshaked/nextinspace](https://github.com/gideonshaked/nextinspace) |
| Source record ids | github_search_space_engines-bba4aa42d91c4b |

## System Engineer Summary

gideonshaked/nextinspace is tracked as an ide editor integration record in the Space Engines branch.
...
For a systems engineer, gideonshaked/nextinspace belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.1 | 2024-12-21T06:08:48Z | [https://api.github.com/repos/gideonshaked/nextinspace/releases/latest](https://api.github.com/repos/gideonshaked/nextinspace/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/gideonshaked/nextinspace/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `github_search_space_engines-bba4aa42d91c4b` from `github_search_space_engines` as `registry_expansion`
