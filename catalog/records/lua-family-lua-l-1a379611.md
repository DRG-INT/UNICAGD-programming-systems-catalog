...
| Canonical URL | [http://www.lua.org/lua-l.html](http://www.lua.org/lua-l.html) |
| Source record ids | lua-source-362 |
...
For a systems engineer, lua-l belongs in the Lua family inventory as part of cross-language
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 362}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-362` from `master_json` as `source_list_item`
...
| Lua Unofficial FAQ | Ffi Bindings | [open](lua-family-lua-unofficial-faq-1f4e9326.md) |
