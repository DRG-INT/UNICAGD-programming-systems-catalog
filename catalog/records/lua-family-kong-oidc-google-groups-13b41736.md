...
| Canonical URL | [https://luarocks.org/modules/newtonx/kong-oidc-google-groups](https://luarocks.org/modules/newtonx/kong-oidc-google-groups) |
| Source record ids | luarocks_root_manifest-0aa11db8e07e4d |

## System Engineer Summary

A Kong plugin for implementing Google OIDC, with additional Google Groups-based authorization

## Operational Role

For a systems engineer, kong-oidc-google-groups belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-0aa11db8e07e4d` from `luarocks_root_manifest` as `registry_expansion`
