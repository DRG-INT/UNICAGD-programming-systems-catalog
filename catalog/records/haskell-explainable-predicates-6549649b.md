...
<!-- canonical: https://hackage.haskell.org/package/explainable-predicates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/explainable-predicates](https://hackage.haskell.org/package/explainable-predicates) |
| Source record ids | hackage_recent-7743035e5050d7 |
...
For a systems engineer, explainable-predicates belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3.0 | 2026-09-01T16:00:49Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-01T16:41:05+00:00`.
...
- `hackage_recent-7743035e5050d7` from `hackage_recent` as `registry_expansion`
