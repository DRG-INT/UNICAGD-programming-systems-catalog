...
<!-- canonical: https://github.com/ToxSam/open-source-3D-assets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ToxSam/open-source-3D-assets](https://github.com/ToxSam/open-source-3D-assets) |
| Source record ids | github_search_assets-7851776c29fd2e |

## System Engineer Summary

CC0 3D asset registry: 991+ GLB models from metaverse projects. JSON-based database linking to
permanent storage. Medieval props, vaporwave rooms, Egyptian temples, neon streets, and more. API-
friendly structure for developers building asset browsers and creative tools.

## Operational Role

For a systems engineer, ToxSam/open-source-3D-assets belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-23T10:59:14Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-7851776c29fd2e` from `github_search_assets` as `registry_expansion`
