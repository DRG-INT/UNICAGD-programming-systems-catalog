...
<!-- canonical: https://cran.r-project.org/web/packages/RapidFuzz/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RapidFuzz/index.html](https://cran.r-project.org/web/packages/RapidFuzz/index.html) |
| Source record ids | cran_packages_by_date-fc6b01171f62d8 |
...
For a systems engineer, RapidFuzz belongs in the R inventory as part of input-space exploration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-31 22:40:02 UTC | [https://cran.r-project.org/web/packages/RapidFuzz/DESCRIPTION](https://cran.r-project.org/web/packages/RapidFuzz/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RapidFuzz/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fc6b01171f62d8` from `cran_packages_by_date` as `registry_expansion`
