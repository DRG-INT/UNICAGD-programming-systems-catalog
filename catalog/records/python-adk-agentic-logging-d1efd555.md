...
<!-- canonical: https://pypi.org/project/adk-agentic-logging/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adk-agentic-logging/](https://pypi.org/project/adk-agentic-logging/) |
| Source record ids | pypi_simple-bc8c790cdc0ad2 |
...
For a systems engineer, adk-agentic-logging belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-01-22T16:33:56.165141Z | [https://pypi.org/pypi/adk-agentic-logging/json](https://pypi.org/pypi/adk-agentic-logging/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adk-agentic-logging/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-bc8c790cdc0ad2` from `pypi_simple` as `registry_expansion`
