...
<!-- canonical: https://cran.r-project.org/web/packages/rKraken/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rKraken/index.html](https://cran.r-project.org/web/packages/rKraken/index.html) |
| Source record ids | cran_packages_by_date-f4569e8456e053 |

## System Engineer Summary

rKraken is tracked as a build system record in the R branch. The source did not provide a long
...
For a systems engineer, rKraken belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-04 09:40:08 UTC | [https://cran.r-project.org/web/packages/rKraken/DESCRIPTION](https://cran.r-project.org/web/packages/rKraken/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rKraken/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f4569e8456e053` from `cran_packages_by_date` as `registry_expansion`
