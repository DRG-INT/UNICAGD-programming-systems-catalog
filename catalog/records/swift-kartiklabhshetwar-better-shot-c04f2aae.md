...
<!-- canonical: https://github.com/KartikLabhshetwar/better-shot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KartikLabhshetwar/better-shot](https://github.com/KartikLabhshetwar/better-shot) |
| Source record ids | github_search_swift-879dc6a49212fe |

## System Engineer Summary

Screenshot, screen recording, and video editor for macOS. Native SwiftUI app with capture deck, 75+
customizable shortcuts, URL scheme automation, and self-hosted cloud sharing. Open-source
alternative to CleanShot X and Loom.

## Operational Role

For a systems engineer, KartikLabhshetwar/better-shot belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T19:46:54Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-879dc6a49212fe` from `github_search_swift` as `registry_expansion`
