...
<!-- canonical: https://github.com/kitspace/kitspace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kitspace/kitspace](https://github.com/kitspace/kitspace) |
| Source record ids | github_search_catalogs-f10e2d1c652423 |
...
For a systems engineer, kitspace/kitspace belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-18T15:33:33Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-f10e2d1c652423` from `github_search_catalogs` as `registry_expansion`
