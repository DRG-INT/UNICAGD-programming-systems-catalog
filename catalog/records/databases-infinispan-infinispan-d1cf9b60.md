...
<!-- canonical: https://github.com/infinispan/infinispan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/infinispan/infinispan](https://github.com/infinispan/infinispan) |
| Source record ids | github_search_databases-4b663399f2edec |
...
For a systems engineer, infinispan/infinispan belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T10:03:19Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4b663399f2edec` from `github_search_databases` as `registry_expansion`
