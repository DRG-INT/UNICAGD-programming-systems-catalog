...
<!-- canonical: https://github.com/rmnkhr/shaderbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rmnkhr/shaderbox](https://github.com/rmnkhr/shaderbox) |
| Source record ids | github_search_effects-a7986ef0027888 |

## System Engineer Summary

Welcome to ShaderBox — a growing collection of beautiful and dynamic shader effects for Android

## Operational Role

For a systems engineer, rmnkhr/shaderbox belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-20T17:56:27Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a7986ef0027888` from `github_search_effects` as `registry_expansion`
