...
| Source record ids | curated_language_routes-2f4e441a3bc504 |

## System Engineer Summary

Text shaping engine for scripts, glyph layout, font features, and renderer integration.

## Operational Role

For a systems engineer, HarfBuzz belongs in the Font Briefcase inventory as part of ecosystem
...
- Latest stable metadata was observed from `https://api.github.com/repos/harfbuzz/harfbuzz/releases/latest` at `2026-09-01T12:30:35+00:00`.
...
- `curated_language_routes-2f4e441a3bc504` from `curated_language_routes` as `registry_expansion`
