...
<!-- canonical: https://github.com/crosire/reshade-shaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/crosire/reshade-shaders](https://github.com/crosire/reshade-shaders) |
| Source record ids | github_search_effects-188510db486f9f |
...
For a systems engineer, crosire/reshade-shaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T19:54:22Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "post processing shader", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_effects-188510db486f9f` from `github_search_effects` as `registry_expansion`
