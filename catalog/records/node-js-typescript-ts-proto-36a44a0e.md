...
| Canonical URL | [https://www.npmjs.com/package/ts-proto](https://www.npmjs.com/package/ts-proto) |
| Source record ids | npm_registry-381dbb4dd8fe45 |

## System Engineer Summary

ts-proto is tracked as a build system record in the Node.js/TypeScript branch. The source did not
...
For a systems engineer, ts-proto belongs in the Node.js/TypeScript inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.12.1 | 2026-08-20T20:00:45.683Z | [https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-381dbb4dd8fe45` from `npm_registry` as `registry_expansion`
