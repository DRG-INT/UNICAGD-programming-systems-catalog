...
<!-- canonical: https://luarocks.org/modules/ignacio/bitness -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ignacio/bitness](https://luarocks.org/modules/ignacio/bitness) |
| Source record ids | luarocks_root_manifest-46fd8527c47de8 |
...
For a systems engineer, bitness belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-46fd8527c47de8` from `luarocks_root_manifest` as `registry_expansion`
