...
<!-- canonical: https://hackage.haskell.org/package/universum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/universum](https://hackage.haskell.org/package/universum) |
| Source record ids | hackage_top_downloads-a20811a291b163 |
...
For a systems engineer, universum belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.3.1 | 2026-06-13T17:57:22Z | [https://hackage.haskell.org/package/universum](https://hackage.haskell.org/package/universum) |  |
| candidate | partial | 1.2.0 |  | [https://hackage.haskell.org/package/universum](https://hackage.haskell.org/package/universum) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/universum` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-a20811a291b163` from `hackage_top_downloads` as `registry_expansion`
