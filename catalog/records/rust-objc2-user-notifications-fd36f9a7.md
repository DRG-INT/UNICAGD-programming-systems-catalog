...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Ffi Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ffi-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/objc2-user-notifications](https://crates.io/crates/objc2-user-notifications) |
| Source record ids | crates_io-95484e269ef03b |
...
For a systems engineer, objc2-user-notifications belongs in the Rust inventory as part of cross-
language integration, ABI ownership, memory safety, and runtime embedding.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T16:15:39.439199Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| android_log-sys | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-android-log-sys-81ebab28.md) |
| ark-poly | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-poly-a44b76b4.md) |
| ash | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ash-027ec31e.md) |
| async-tungstenite | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-async-tungstenite-5edcf7da.md) |
| atk | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-atk-d196f43c.md) |
| atk-sys | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-atk-sys-cb5c942b.md) |
| bindgen | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bindgen-355a5568.md) |
| blst | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-blst-563b5ba6.md) |
