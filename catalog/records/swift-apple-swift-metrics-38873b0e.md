...
<!-- canonical: https://github.com/apple/swift-metrics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apple/swift-metrics](https://github.com/apple/swift-metrics) |
| Source record ids | github_search_swift-23afd48832f9a1 |

## System Engineer Summary

apple/swift-metrics is tracked as a web framework record in the Swift branch. The source did not
...
For a systems engineer, apple/swift-metrics belongs in the Swift inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T09:36:38Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-23afd48832f9a1` from `github_search_swift` as `registry_expansion`
