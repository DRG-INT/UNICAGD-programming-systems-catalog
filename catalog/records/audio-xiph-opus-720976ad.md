...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/xiph/opus](https://github.com/xiph/opus) |
| Source record ids | github_search_audio-42fecce0b2b0e8 |
...
For a systems engineer, xiph/opus belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.5.2 | 2024-09-11T15:10:07Z | [https://api.github.com/repos/xiph/opus/releases/latest](https://api.github.com/repos/xiph/opus/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/xiph/opus/releases/latest` at `2026-09-01T09:23:21+00:00`.
...
- `github_search_audio-42fecce0b2b0e8` from `github_search_audio` as `registry_expansion`
