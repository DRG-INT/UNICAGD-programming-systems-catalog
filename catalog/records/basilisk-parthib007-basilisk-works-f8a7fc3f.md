# parthib007/Basilisk_Works

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/parthib007/Basilisk_Works -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/parthib007/Basilisk_Works](https://github.com/parthib007/Basilisk_Works) |
| Source record ids | github_search_basilisk-764d204ea030a4 |

## System Engineer Summary

Simulations/Projects that I have done using Basilisk C

## Operational Role

For a systems engineer, parthib007/Basilisk_Works belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-17T18:58:18Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-764d204ea030a4` from `github_search_basilisk` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| iamgadmarconi/ESA-Concurrent-Design-Challenge | Library | [open](basilisk-iamgadmarconi-esa-concurrent-design-challenge-6964ff6e.md) |
| mujavidb/basiliskRobotsChallenge | Library | [open](basilisk-mujavidb-basiliskrobotschallenge-3fb7aaec.md) |
| yliu-fort/ChannelFlowLES | Library | [open](basilisk-yliu-fort-channelflowles-b3e98e9f.md) |
