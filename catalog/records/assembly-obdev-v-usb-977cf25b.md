...
<!-- canonical: https://github.com/obdev/v-usb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/obdev/v-usb](https://github.com/obdev/v-usb) |
| Source record ids | github_search_assembly-85dd0b3a89e969 |
...
For a systems engineer, obdev/v-usb belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T14:47:54Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-85dd0b3a89e969` from `github_search_assembly` as `registry_expansion`
