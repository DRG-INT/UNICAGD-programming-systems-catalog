# anvayeem-spec/personal_portfolio
...
<!-- canonical: https://github.com/anvayeem-spec/personal_portfolio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anvayeem-spec/personal_portfolio](https://github.com/anvayeem-spec/personal_portfolio) |
| Source record ids | github_search_magazines-4afd1e33266c6e |

## System Engineer Summary

Frontend developer portfolio showcasing projects in HTML, CSS, and JavaScript — built with an
editorial, magazine-cover inspired design."

## Operational Role

For a systems engineer, anvayeem-spec/personal_portfolio belongs in the Magazines inventory as part
...
- `github_search_magazines-4afd1e33266c6e` from `github_search_magazines` as `registry_expansion`
...
| jessa-clark/dignified-winers | Ide Editor Integration | [open](magazines-jessa-clark-dignified-winers-10548068.md) |
| lervag/wiki.vim | Ide Editor Integration | [open](magazines-lervag-wiki-vim-2ff43f08.md) |
| Manna-Network/bitcoin_ad_agency | Ide Editor Integration | [open](magazines-manna-network-bitcoin-ad-agency-f8bbb11d.md) |
| mmarquezs/libgen-python-api | Ide Editor Integration | [open](magazines-mmarquezs-libgen-python-api-47da50e4.md) |
| pajoma/vscode-journal | Ide Editor Integration | [open](magazines-pajoma-vscode-journal-fd5206d8.md) |
