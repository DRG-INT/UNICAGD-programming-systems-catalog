# SAP/smart-test-picker

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SAP/smart-test-picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP/smart-test-picker](https://github.com/SAP/smart-test-picker) |
| Source record ids | github_search_sapjava-1e603cfa0498f6 |

## System Engineer Summary

Selects only the tests affected by your code changes by mapping per-test runtime coverage against
Git diffs, cutting regression suite execution time.

## Operational Role

For a systems engineer, SAP/smart-test-picker belongs in the SAPJava inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T08:49:00Z | gh search repos org:SAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-1e603cfa0498f6` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cds:cds4j-runtime | Interpreter Runtime | [open](sapjava-com-sap-cds-cds4j-runtime-78d29f7f.md) |
| ivannov/addon-saphcp | Interpreter Runtime | [open](sapjava-ivannov-addon-saphcp-6b72ce4b.md) |
| rangasri85/ranga | Interpreter Runtime | [open](sapjava-rangasri85-ranga-3185d6ee.md) |
| SAP-archive/cloud-sample-library | Interpreter Runtime | [open](sapjava-sap-archive-cloud-sample-library-47935dc9.md) |
| SAP-samples/hana-apl-apis-runtimes | Interpreter Runtime | [open](sapjava-sap-samples-hana-apl-apis-runtimes-e35cdaa8.md) |
