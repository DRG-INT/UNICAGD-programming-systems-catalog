...
<!-- canonical: https://www.npmjs.com/package/@dxos/echo-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@dxos/echo-db](https://www.npmjs.com/package/@dxos/echo-db) |
| Source record ids | npm_registry-a5251a95db711e |

## System Engineer Summary

@dxos/echo-db is tracked as a database datastore record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @dxos/echo-db belongs in the Node.js/JavaScript inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2025-07-03T16:32:13.957Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a5251a95db711e` from `npm_registry` as `registry_expansion`
