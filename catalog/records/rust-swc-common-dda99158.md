...
| Canonical URL | [https://crates.io/crates/swc_common](https://crates.io/crates/swc_common) |
| Source record ids | crates_io-870024289aa59b |
...
For a systems engineer, swc_common belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.0.0 | 2026-08-14T13:08:25.581590Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-870024289aa59b` from `crates_io` as `registry_expansion`
