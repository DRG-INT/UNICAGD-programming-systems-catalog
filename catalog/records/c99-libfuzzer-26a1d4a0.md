...
| Source record ids | master-feed42009810 |

## System Engineer Summary

LLVM in-process coverage-guided fuzzer

## Operational Role

For a systems engineer, libFuzzer belongs in the C99 inventory as part of input-space exploration,
...
- `master-feed42009810` from `master_json` as `fuzzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AFL++ | Fuzzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-afl-ed41eef1.md) |
