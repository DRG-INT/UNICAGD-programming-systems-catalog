...
<!-- canonical: https://crates.io/crates/wasm-bindgen-shared -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.128 | 2026-09-04T23:58:03.129200Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads` at `2026-09-05T00:29:03+00:00`.
...
- `crates_io-6ebadd547b7403` from `crates_io` as `registry_expansion`
