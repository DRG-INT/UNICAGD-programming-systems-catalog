...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Dependency Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/dependency-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/wasm-bindgen-shared](https://crates.io/crates/wasm-bindgen-shared) |
| Source record ids | crates_io-6ebadd547b7403 |
...
For a systems engineer, wasm-bindgen-shared belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.127 | 2026-08-08T00:56:52.445936Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| basic-toml | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-basic-toml-5cd7ab13.md) |
| configparser | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-configparser-ce31efc8.md) |
| hex-conservative | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-hex-conservative-879cabf9.md) |
| minijinja | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-minijinja-a500af64.md) |
| precomputed-hash | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-precomputed-hash-2150f344.md) |
| protobuf-parse | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-protobuf-parse-5321e0ad.md) |
| raw-cpuid | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-raw-cpuid-e0c8cffb.md) |
| rustup | Dependency Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-rustup-eaa7a72b.md) |
