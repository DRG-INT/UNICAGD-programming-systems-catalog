...
<!-- canonical: https://github.com/dieselpoint/norm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dieselpoint/norm](https://github.com/dieselpoint/norm) |
| Source record ids | github_search_databases-532183a7b10462 |
...
For a systems engineer, dieselpoint/norm belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-27T18:08:09Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | University of Illinois/NCSA Open Source License; https://api.github.com/licenses/ncsa; Other |
...
- `github_search_databases-532183a7b10462` from `github_search_databases` as `registry_expansion`
