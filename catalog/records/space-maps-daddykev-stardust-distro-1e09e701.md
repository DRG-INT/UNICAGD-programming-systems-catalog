...
<!-- canonical: https://github.com/daddykev/stardust-distro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daddykev/stardust-distro](https://github.com/daddykev/stardust-distro) |
| Source record ids | github_search_space_maps-319f6f1dca4b71 |

## System Engineer Summary

Open-source, npm-installable music distribution platform that enables labels and artists to manage
their catalog, generate DDEX-compliant ERN messages, and deliver releases to DSPs.

## Operational Role

For a systems engineer, daddykev/stardust-distro belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-03T23:13:59Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-319f6f1dca4b71` from `github_search_space_maps` as `registry_expansion`
