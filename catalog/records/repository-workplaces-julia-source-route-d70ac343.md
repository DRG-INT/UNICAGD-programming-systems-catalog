...
<!-- canonical: https://github.com/JuliaLang/julia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaLang/julia](https://github.com/JuliaLang/julia) |
| Source record ids | curated_repository_workplace_routes-5beaeeeb6456eb |

## System Engineer Summary

Official Julia language source repository route.

## Operational Role

For a systems engineer, Julia Source Route belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-5beaeeeb6456eb` from `curated_repository_workplace_routes` as `registry_expansion`
