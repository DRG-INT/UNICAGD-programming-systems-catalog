...
<!-- canonical: https://github.com/Abdul-Wasay-008/Atlas26 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Abdul-Wasay-008/Atlas26](https://github.com/Abdul-Wasay-008/Atlas26) |
| Source record ids | github_search_space_maps-3b4108a0809c00 |

## System Engineer Summary

Atlas26 is a real-time 3D space visualization web app built with Next.js and Three.js. It renders
planets, satellites, and cosmic elements using live NASA & Celestrak data, bringing the living
cosmos to your screen.

## Operational Role

For a systems engineer, Abdul-Wasay-008/Atlas26 belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-28T21:57:36Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-3b4108a0809c00` from `github_search_space_maps` as `registry_expansion`
