...
<!-- canonical: https://pypi.org/project/acdh-django-sparql/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-django-sparql/](https://pypi.org/project/acdh-django-sparql/) |
| Source record ids | pypi_simple-df51cf5dd1f93c |
...
For a systems engineer, acdh-django-sparql belongs in the Python inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2018-12-14T13:41:46.047664Z | [https://pypi.org/pypi/acdh-django-sparql/json](https://pypi.org/pypi/acdh-django-sparql/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-django-sparql/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-df51cf5dd1f93c` from `pypi_simple` as `registry_expansion`
