...
<!-- canonical: https://github.com/EdgeLake/EdgeLake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EdgeLake/EdgeLake](https://github.com/EdgeLake/EdgeLake) |
| Source record ids | github_search_databases-14c61dcc7a88ec |

## System Engineer Summary

EdgeLake/EdgeLake is tracked as a library record in the Databases branch. The source did not provide
...
For a systems engineer, EdgeLake/EdgeLake belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-29T18:26:25Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-14c61dcc7a88ec` from `github_search_databases` as `registry_expansion`
