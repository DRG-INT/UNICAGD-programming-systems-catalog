...
<!-- canonical: https://luarocks.org/modules/rodamaral/dummy_lux_lib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/rodamaral/dummy_lux_lib](https://luarocks.org/modules/rodamaral/dummy_lux_lib) |
| Source record ids | luarocks_root_manifest-a18c8190336548 |

## System Engineer Summary

dummy_lux_lib is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, dummy_lux_lib belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a18c8190336548` from `luarocks_root_manifest` as `registry_expansion`
