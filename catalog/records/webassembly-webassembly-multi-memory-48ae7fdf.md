...
<!-- canonical: https://github.com/WebAssembly/multi-memory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/multi-memory](https://github.com/WebAssembly/multi-memory) |
| Source record ids | github_search_webassembly-0f3bc0accea948 |
...
For a systems engineer, WebAssembly/multi-memory belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-06T21:16:56Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-0f3bc0accea948` from `github_search_webassembly` as `registry_expansion`
