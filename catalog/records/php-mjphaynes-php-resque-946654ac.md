...
<!-- canonical: https://packagist.org/packages/mjphaynes/php-resque -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mjphaynes/php-resque](https://packagist.org/packages/mjphaynes/php-resque) |
| Source record ids | packagist_search-d13c57bed15e32 |
...
For a systems engineer, mjphaynes/php-resque belongs in the PHP inventory as part of state
...
- `packagist_search-d13c57bed15e32` from `packagist_search` as `registry_expansion`
