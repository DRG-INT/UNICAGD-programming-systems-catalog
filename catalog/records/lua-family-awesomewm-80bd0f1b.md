...
| Canonical URL | [https://awesomewm.org/](https://awesomewm.org/) |
| Source record ids | lua-source-349 |
...
For a systems engineer, AwesomeWM belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 349}}` |
...
- `lua-source-349` from `master_json` as `source_list_item`
