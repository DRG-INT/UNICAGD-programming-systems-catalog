...
<!-- canonical: https://github.com/estuariolabs/tolhuin-chord -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/estuariolabs/tolhuin-chord](https://github.com/estuariolabs/tolhuin-chord) |
| Source record ids | github_search_effects-76413fb123ff66 |

## System Engineer Summary

Diatonic chord synthesizer on ESP32-S3 — from-scratch audio engine (band-limited synthesis, diatonic
harmony, step sequencer, effects, USB/BLE MIDI). Firmware + hardware + tools.

## Operational Role

For a systems engineer, estuariolabs/tolhuin-chord belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T04:13:46Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-76413fb123ff66` from `github_search_effects` as `registry_expansion`
