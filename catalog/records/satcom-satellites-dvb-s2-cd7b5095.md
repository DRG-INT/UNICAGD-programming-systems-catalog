...
<!-- canonical: https://www.etsi.org/technologies/satellite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.etsi.org/technologies/satellite](https://www.etsi.org/technologies/satellite) |
| Source record ids | curated_language_routes-d39e153a1315ea |

## System Engineer Summary

ETSI satellite communication standards route including DVB-S/S2/S2X and related broadcast/data
links.

## Operational Role

For a systems engineer, DVB-S2 belongs in the SatCom Satellites inventory as part of ecosystem
...
- `curated_language_routes-d39e153a1315ea` from `curated_language_routes` as `registry_expansion`
...
| ManishSahu53/Vector-Map-Generation-from-Aerial-Imagery-using-Deep-Learning-GeoSpatial-UNET | Language Specification | [open](satcom-satellites-manishsahu53-vector-map-generation-from-aerial-imagery-using-deep-learning-geospatial-unet-9fa0bbd0.md) |
| psi-consortium/psi | Language Specification | [open](satcom-satellites-psi-consortium-psi-ddc5eac0.md) |
