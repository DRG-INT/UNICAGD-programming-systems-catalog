...
<!-- canonical: https://crates.io/crates/cpp_demangle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cpp_demangle](https://crates.io/crates/cpp_demangle) |
| Source record ids | crates_io-c60b2d086c0e16 |
...
For a systems engineer, cpp_demangle belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2025-11-05T16:23:13.729125Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-c60b2d086c0e16` from `crates_io` as `registry_expansion`
