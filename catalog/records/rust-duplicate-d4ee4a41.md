...
| Canonical URL | [https://crates.io/crates/duplicate](https://crates.io/crates/duplicate) |
| Source record ids | crates_io-c2328e1a1a86d5 |
...
For a systems engineer, duplicate belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2025-11-03T14:27:42.504558Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-c2328e1a1a86d5` from `crates_io` as `registry_expansion`
