...
<!-- canonical: https://crates.io/crates/tagptr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tagptr](https://crates.io/crates/tagptr) |
| Source record ids | crates_io-71ef50a7c52460 |
...
For a systems engineer, tagptr belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2021-08-13T09:10:42.049617Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-71ef50a7c52460` from `crates_io` as `registry_expansion`
