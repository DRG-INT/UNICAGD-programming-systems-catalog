...
| Canonical URL | [https://luarocks.org/modules/husl-colors/husl](https://luarocks.org/modules/husl-colors/husl) |
| Source record ids | luarocks_root_manifest-b5fb9c1ce9ca5c |

## System Engineer Summary

husl is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, husl belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b5fb9c1ce9ca5c` from `luarocks_root_manifest` as `registry_expansion`
