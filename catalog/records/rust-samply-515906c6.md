...
| Canonical URL | [https://crates.io/crates/samply](https://crates.io/crates/samply) |
| Source record ids | corpus-29f147f0f12f26 |
...
For a systems engineer, samply belongs in the Rust inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.1 | 2025-02-01T06:57:38.581398Z | [https://crates.io/api/v1/crates/samply](https://crates.io/api/v1/crates/samply) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/samply` at `2026-09-01T01:59:22+00:00`.
...
- `corpus-29f147f0f12f26` from `master_json` as `profiler`
