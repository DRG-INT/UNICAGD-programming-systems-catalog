...
<!-- canonical: https://github.com/Pometry/Raphtory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Pometry/Raphtory](https://github.com/Pometry/Raphtory) |
| Source record ids | github_search_databases-d4d20c47578ba8 |

## System Engineer Summary

Scalable graph analytics database powered by a multithreaded, vectorized temporal engine, written in
Rust

## Operational Role

For a systems engineer, Pometry/Raphtory belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T05:47:20Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d4d20c47578ba8` from `github_search_databases` as `registry_expansion`
