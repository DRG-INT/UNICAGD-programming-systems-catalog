...
<!-- canonical: https://github.com/norman/telescope -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/norman/telescope](https://github.com/norman/telescope) |
| Source record ids | lua-source-316 |
...
For a systems engineer, telescope belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 316}}` |
...
- `lua-source-316` from `master_json` as `source_list_item`
