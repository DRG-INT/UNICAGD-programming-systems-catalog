...
<!-- canonical: https://github.com/apache/pouchdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/pouchdb](https://github.com/apache/pouchdb) |
| Source record ids | github_search_databases-82f6029217c3e4 |
...
For a systems engineer, apache/pouchdb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:16:08Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-82f6029217c3e4` from `github_search_databases` as `registry_expansion`
