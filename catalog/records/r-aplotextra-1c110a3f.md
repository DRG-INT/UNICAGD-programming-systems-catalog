...
<!-- canonical: https://cran.r-project.org/web/packages/aplotExtra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aplotExtra/index.html](https://cran.r-project.org/web/packages/aplotExtra/index.html) |
| Source record ids | cran_packages_by_date-cac171da93b829 |
...
For a systems engineer, aplotExtra belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-08-04 15:00:02 UTC | [https://cran.r-project.org/web/packages/aplotExtra/DESCRIPTION](https://cran.r-project.org/web/packages/aplotExtra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aplotExtra/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cac171da93b829` from `cran_packages_by_date` as `registry_expansion`
