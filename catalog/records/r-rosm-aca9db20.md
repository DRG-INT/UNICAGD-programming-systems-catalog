...
<!-- canonical: https://cran.r-project.org/web/packages/rosm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rosm/index.html](https://cran.r-project.org/web/packages/rosm/index.html) |
| Source record ids | cran_packages_by_date-68b619ffa763fd |
...
For a systems engineer, rosm belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-09-02 05:20:08 UTC | [https://cran.r-project.org/web/packages/rosm/DESCRIPTION](https://cran.r-project.org/web/packages/rosm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rosm/DESCRIPTION` at `2026-09-02T06:29:49+00:00`.
...
- `cran_packages_by_date-68b619ffa763fd` from `cran_packages_by_date` as `registry_expansion`
