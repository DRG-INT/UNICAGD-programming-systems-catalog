...
<!-- canonical: https://cran.r-project.org/web/packages/pgt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pgt/index.html](https://cran.r-project.org/web/packages/pgt/index.html) |
| Source record ids | cran_packages_by_date-79a8d0aa36b0b2 |
...
For a systems engineer, pgt belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-19 11:30:02 UTC | [https://cran.r-project.org/web/packages/pgt/DESCRIPTION](https://cran.r-project.org/web/packages/pgt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pgt/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-79a8d0aa36b0b2` from `cran_packages_by_date` as `registry_expansion`
