...
<!-- canonical: https://github.com/cjee21/Check-UEFISecureBootVariables -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cjee21/Check-UEFISecureBootVariables](https://github.com/cjee21/Check-UEFISecureBootVariables) |
| Source record ids | github_search_catalogs-734a95f25460d5 |

## System Engineer Summary

PowerShell scripts to check the UEFI KEK, DB and DBX Secure Boot variables as well as scripts for
other Secure Boot related items.

## Operational Role

For a systems engineer, cjee21/Check-UEFISecureBootVariables belongs in the Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:04:25Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-734a95f25460d5` from `github_search_catalogs` as `registry_expansion`
