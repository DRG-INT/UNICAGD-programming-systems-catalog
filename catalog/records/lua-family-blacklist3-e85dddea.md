...
<!-- canonical: https://luarocks.org/modules/henriquechehad/blacklist3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/henriquechehad/blacklist3](https://luarocks.org/modules/henriquechehad/blacklist3) |
| Source record ids | luarocks_root_manifest-8f69258001a8a0 |

## System Engineer Summary

blacklist3 is tracked as a formatter record in the Lua family branch. The source did not provide a
...
For a systems engineer, blacklist3 belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-8f69258001a8a0` from `luarocks_root_manifest` as `registry_expansion`
