...
<!-- canonical: https://github.com/Fabric-Project/Fabric -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Fabric-Project/Fabric](https://github.com/Fabric-Project/Fabric) |
| Source record ids | github_search_effects-0af39afb592258 |
...
For a systems engineer, Fabric-Project/Fabric belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T23:45:07Z | gh search repos topic:post-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0af39afb592258` from `github_search_effects` as `registry_expansion`
