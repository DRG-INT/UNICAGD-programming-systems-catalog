...
<!-- canonical: https://cran.r-project.org/web/packages/hexify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hexify/index.html](https://cran.r-project.org/web/packages/hexify/index.html) |
| Source record ids | cran_packages_by_date-18f444d856c111 |
...
For a systems engineer, hexify belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-08-22 16:00:03 UTC | [https://cran.r-project.org/web/packages/hexify/DESCRIPTION](https://cran.r-project.org/web/packages/hexify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hexify/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-18f444d856c111` from `cran_packages_by_date` as `registry_expansion`
