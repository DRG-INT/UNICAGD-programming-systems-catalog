...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/recursionpharma/maes_microscopy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/recursionpharma/maes_microscopy](https://github.com/recursionpharma/maes_microscopy) |
| Source record ids | github_search_microscopy-6984b7a86d681d |

## System Engineer Summary

Official repo for Recursion's accepted spotlight paper at NeurIPS 2023 Generative AI & Biology
workshop.

## Operational Role

For a systems engineer, recursionpharma/maes_microscopy belongs in the Microscopy inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-06T04:13:04Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-6984b7a86d681d` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cgohlke/tifffile | Ffi Bindings | [open](microscopy-cgohlke-tifffile-e4f65d37.md) |
| ChristophReich1996/Cell-DETR | Ffi Bindings | [open](microscopy-christophreich1996-cell-detr-9a4cd5c8.md) |
| computational-cell-analytics/peft-sam | Ffi Bindings | [open](microscopy-computational-cell-analytics-peft-sam-19563e2e.md) |
| katrinleinweber/PhD-thesis | Ffi Bindings | [open](microscopy-katrinleinweber-phd-thesis-59a4075b.md) |
| mkang315/ASF-YOLO | Ffi Bindings | [open](microscopy-mkang315-asf-yolo-86c1c52d.md) |
| SlavkoPrytula/IAUNet | Ffi Bindings | [open](microscopy-slavkoprytula-iaunet-f79bfe2c.md) |
| tlambert03/PSFmodels | Ffi Bindings | [open](microscopy-tlambert03-psfmodels-2fadd375.md) |
| WeisongZhao/sparse-deconv-py | Ffi Bindings | [open](microscopy-weisongzhao-sparse-deconv-py-42be63da.md) |
