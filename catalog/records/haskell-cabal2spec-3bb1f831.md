...
<!-- canonical: https://hackage.haskell.org/package/cabal2spec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal2spec](https://hackage.haskell.org/package/cabal2spec) |
| Source record ids | hackage_top_downloads-9721c64ec53640 |
...
For a systems engineer, cabal2spec belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0 | 2025-07-23T13:04:07Z | [https://hackage.haskell.org/package/cabal2spec](https://hackage.haskell.org/package/cabal2spec) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal2spec` at `2026-09-02T00:32:25+00:00`.
...
- `hackage_top_downloads-9721c64ec53640` from `hackage_top_downloads` as `registry_expansion`
