...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/porpass/web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/porpass/web](https://github.com/porpass/web) |
| Source record ids | github_search_space_maps-87a88f054a9853 |

## System Engineer Summary

Web frontend of PORPASS, the Planetary Orbital Radar Processing and Simulation System. Browse and
search SHARAD, MARSIS, and LRS observations, view them on an interactive map, and queue processing
jobs for the porpass/daemon. Built in PHP + MariaDB + OpenLayers at the Planetary Science Institute.

## Operational Role

For a systems engineer, porpass/web belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T20:11:01Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-87a88f054a9853` from `github_search_space_maps` as `registry_expansion`
