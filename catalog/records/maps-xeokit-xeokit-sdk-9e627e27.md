...
<!-- canonical: https://github.com/xeokit/xeokit-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xeokit/xeokit-sdk](https://github.com/xeokit/xeokit-sdk) |
| Source record ids | github_search_maps-7058f1468d1a34 |

## System Engineer Summary

3D BIM IFC Viewer SDK for AEC engineering applications. Open Source JavaScript Toolkit based on pure
WebGL for top performance, real-world coordinates and full double precision

## Operational Role

For a systems engineer, xeokit/xeokit-sdk belongs in the Maps inventory as part of build graph
...
- `github_search_maps-7058f1468d1a34` from `github_search_maps` as `registry_expansion`
...
| falcoframework/Falco | Build System | [open](maps-falcoframework-falco-2b86ca7d.md) |
