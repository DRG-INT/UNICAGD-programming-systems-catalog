...
<!-- canonical: https://luarocks.org/modules/gregorias/coop.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/gregorias/coop.nvim](https://luarocks.org/modules/gregorias/coop.nvim) |
| Source record ids | luarocks_root_manifest-b481259fa021b0 |

## System Engineer Summary

A Neovim plugin for structured concurrency with coroutines.

## Operational Role

For a systems engineer, coop.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-b481259fa021b0` from `luarocks_root_manifest` as `registry_expansion`
