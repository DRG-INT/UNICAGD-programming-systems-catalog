...
<!-- canonical: https://github.com/exiftool-rb/exiftool.rb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/exiftool-rb/exiftool.rb](https://github.com/exiftool-rb/exiftool.rb) |
| Source record ids | github_search_photography-31348b63126013 |
...
For a systems engineer, exiftool-rb/exiftool.rb belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-22T16:52:35Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-31348b63126013` from `github_search_photography` as `registry_expansion`
