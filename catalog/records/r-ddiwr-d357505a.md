...
<!-- canonical: https://cran.r-project.org/web/packages/DDIwR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DDIwR/index.html](https://cran.r-project.org/web/packages/DDIwR/index.html) |
| Source record ids | cran_packages_by_date-d1f969d443841c |

## System Engineer Summary

DDIwR is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, DDIwR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20 | 2026-08-22 03:20:02 UTC | [https://cran.r-project.org/web/packages/DDIwR/DESCRIPTION](https://cran.r-project.org/web/packages/DDIwR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DDIwR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d1f969d443841c` from `cran_packages_by_date` as `registry_expansion`
