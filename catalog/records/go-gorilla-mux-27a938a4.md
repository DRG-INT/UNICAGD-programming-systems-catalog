...
<!-- canonical: https://github.com/gorilla/mux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gorilla/mux](https://github.com/gorilla/mux) |
| Source record ids | github_search_go-47cc147ec666e3 |
...
For a systems engineer, gorilla/mux belongs in the Go inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-15T03:10:55Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-47cc147ec666e3` from `github_search_go` as `registry_expansion`
