...
<!-- canonical: https://github.com/geosolutions-it/MapStore2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geosolutions-it/MapStore2](https://github.com/geosolutions-it/MapStore2) |
| Source record ids | github_search_maps-70d68893cfa3bc |

## System Engineer Summary

The solution to create and share maps, dashboards, geostories with 3D support on the web. And it is
open-source too!

## Operational Role

For a systems engineer, geosolutions-it/MapStore2 belongs in the Maps inventory as part of input-
space exploration, parser hardening, and unsafe edge-case discovery.
...
- `github_search_maps-70d68893cfa3bc` from `github_search_maps` as `registry_expansion`
