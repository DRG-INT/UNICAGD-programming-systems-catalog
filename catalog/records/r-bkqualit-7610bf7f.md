...
<!-- canonical: https://cran.r-project.org/web/packages/BKQualit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BKQualit/index.html](https://cran.r-project.org/web/packages/BKQualit/index.html) |
| Source record ids | cran_packages_by_date-7961e8fb969b78 |
...
For a systems engineer, BKQualit belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-08 13:20:02 UTC | [https://cran.r-project.org/web/packages/BKQualit/DESCRIPTION](https://cran.r-project.org/web/packages/BKQualit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BKQualit/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7961e8fb969b78` from `cran_packages_by_date` as `registry_expansion`
