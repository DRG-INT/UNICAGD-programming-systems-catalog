...
<!-- canonical: https://luarocks.org/modules/aire-one/awesome-battery_widget -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aire-one/awesome-battery_widget](https://luarocks.org/modules/aire-one/awesome-battery_widget) |
| Source record ids | luarocks_root_manifest-2e7b84328543c3 |
...
For a systems engineer, awesome-battery_widget belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-2e7b84328543c3` from `luarocks_root_manifest` as `registry_expansion`
