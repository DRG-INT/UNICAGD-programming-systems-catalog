...
<!-- canonical: https://crates.io/crates/endian-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/endian-type](https://crates.io/crates/endian-type) |
| Source record ids | crates_io-0e9af0625ef9ae |
...
For a systems engineer, endian-type belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-03-06T12:19:53.764548Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-0e9af0625ef9ae` from `crates_io` as `registry_expansion`
...
| inotify | Interop Bindings | [open](rust-inotify-d166077b.md) |
