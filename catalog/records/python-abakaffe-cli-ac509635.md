...
<!-- canonical: https://pypi.org/project/abakaffe-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abakaffe-cli/](https://pypi.org/project/abakaffe-cli/) |
| Source record ids | pypi_simple-901df505d6cedb |

## System Engineer Summary

A CLI for the Abakus Coffee API

## Operational Role

For a systems engineer, abakaffe-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8 | 2016-10-24T10:15:30.393077Z | [https://pypi.org/pypi/abakaffe-cli/json](https://pypi.org/pypi/abakaffe-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abakaffe-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-901df505d6cedb` from `pypi_simple` as `registry_expansion`
