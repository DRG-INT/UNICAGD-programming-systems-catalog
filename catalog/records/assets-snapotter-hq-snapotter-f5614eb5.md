...
<!-- canonical: https://github.com/snapotter-hq/SnapOtter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/snapotter-hq/SnapOtter](https://github.com/snapotter-hq/SnapOtter) |
| Source record ids | github_search_assets-8921fd560ca7f3 |

## System Engineer Summary

Open-source, self-hosted file-processing tool. Convert, compress, OCR, transcribe & run local AI
across image, video, audio, PDF & documents, via UI, REST API & pipelines. Your files never leave
your network.

## Operational Role

For a systems engineer, snapotter-hq/SnapOtter belongs in the Assets inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T16:44:04Z | gh search repos topic:media-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-8921fd560ca7f3` from `github_search_assets` as `registry_expansion`
