# theoknock/JABPlanetaryHourClockKitComplication
...
<!-- canonical: https://github.com/theoknock/JABPlanetaryHourClockKitComplication -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/theoknock/JABPlanetaryHourClockKitComplication](https://github.com/theoknock/JABPlanetaryHourClockKitComplication) |
| Source record ids | github_search_space_maps-66f69376c0261f |

## System Engineer Summary

An WatchKit app for Apple Watch Series 4 (or higher) that calculates and displays the planetary
hour(s) for the current date and time in a ClockKit Complication. There is at least one complication
for every watch face. The app itself displays a table of the planetary hours for the current solar
day; tapping a planetary hour displays a map showing the coordinate of the previous, current and
future planetary hour relative to the the GPS location.

## Operational Role

For a systems engineer, theoknock/JABPlanetaryHourClockKitComplication belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-14T15:52:06Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-66f69376c0261f` from `github_search_space_maps` as `registry_expansion`
