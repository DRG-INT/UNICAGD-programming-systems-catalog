...
<!-- canonical: https://luarocks.org/modules/reasonmix/astar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/reasonmix/astar](https://luarocks.org/modules/reasonmix/astar) |
| Source record ids | luarocks_root_manifest-f38729b91e7008 |

## System Engineer Summary

astar is tracked as a parser lexer ast record in the Lua family branch. The source did not provide a
...
For a systems engineer, astar belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-f38729b91e7008` from `luarocks_root_manifest` as `registry_expansion`
