...
<!-- canonical: https://github.com/jagumiel/Guitar-Pedal-Effects-on-FPGA -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jagumiel/Guitar-Pedal-Effects-on-FPGA](https://github.com/jagumiel/Guitar-Pedal-Effects-on-FPGA) |
| Source record ids | github_search_effects-73dafbd4758221 |

## System Engineer Summary

FPGA-based real-time guitar effects processor for the Terasic DE1-SoC, implementing distortion,
overdrive, tremolo, echo and reverb in VHDL and Nios II/C.

## Operational Role

For a systems engineer, jagumiel/Guitar-Pedal-Effects-on-FPGA belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T19:55:10Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-73dafbd4758221` from `github_search_effects` as `registry_expansion`
