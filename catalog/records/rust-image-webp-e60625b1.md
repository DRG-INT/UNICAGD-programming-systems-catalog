...
<!-- canonical: https://crates.io/crates/image-webp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/image-webp](https://crates.io/crates/image-webp) |
| Source record ids | crates_io-faf3b5afcf6637 |
...
For a systems engineer, image-webp belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2025-08-27T01:41:15.168634Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-faf3b5afcf6637` from `crates_io` as `registry_expansion`
