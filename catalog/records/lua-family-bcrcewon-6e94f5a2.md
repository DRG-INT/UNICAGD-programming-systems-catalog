...
<!-- canonical: https://luarocks.org/modules/maxrio87/bcrcewon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/maxrio87/bcrcewon](https://luarocks.org/modules/maxrio87/bcrcewon) |
| Source record ids | luarocks_root_manifest-9a42f4f3bc35ab |

## System Engineer Summary

bcrcewon is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, bcrcewon belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9a42f4f3bc35ab` from `luarocks_root_manifest` as `registry_expansion`
