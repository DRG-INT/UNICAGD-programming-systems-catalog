...
<!-- canonical: https://github.com/geldata/gel-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geldata/gel-python](https://github.com/geldata/gel-python) |
| Source record ids | github_search_databases-e7ffdfe4734b38 |
...
For a systems engineer, geldata/gel-python belongs in the Databases inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-06T02:05:16Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-e7ffdfe4734b38` from `github_search_databases` as `registry_expansion`
...
| maxi-k/btrblocks | Ffi Bindings | [open](databases-maxi-k-btrblocks-dc270804.md) |
