...
<!-- canonical: https://packagist.org/packages/php-http/message-factory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/message-factory](https://packagist.org/packages/php-http/message-factory) |
| Source record ids | packagist_search-1b0610407f7dc1 |
...
For a systems engineer, php-http/message-factory belongs in the PHP inventory as part of service
...
- `packagist_search-1b0610407f7dc1` from `packagist_search` as `registry_expansion`
