...
<!-- canonical: https://github.com/stablekernel/aqueduct -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stablekernel/aqueduct](https://github.com/stablekernel/aqueduct) |
| Source record ids | github_search_maps-9310dd0b11d19a |
...
For a systems engineer, stablekernel/aqueduct belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2019-03-07T14:52:06Z | [https://api.github.com/repos/stablekernel/aqueduct/releases/latest](https://api.github.com/repos/stablekernel/aqueduct/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/stablekernel/aqueduct/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-9310dd0b11d19a` from `github_search_maps` as `registry_expansion`
