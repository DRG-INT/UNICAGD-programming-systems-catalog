...
<!-- canonical: https://hackage.haskell.org/package/stm-containers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/stm-containers](https://hackage.haskell.org/package/stm-containers) |
| Source record ids | hackage_top_downloads-3f54ee1a0e8f6e |
...
For a systems engineer, stm-containers belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-01-04T13:15:58Z | [https://hackage.haskell.org/package/stm-containers](https://hackage.haskell.org/package/stm-containers) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/stm-containers` at `2026-09-02T00:32:52+00:00`.
...
- `hackage_top_downloads-3f54ee1a0e8f6e` from `hackage_top_downloads` as `registry_expansion`
