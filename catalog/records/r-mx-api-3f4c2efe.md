...
<!-- canonical: https://cran.r-project.org/web/packages/mx.api/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mx.api/index.html](https://cran.r-project.org/web/packages/mx.api/index.html) |
| Source record ids | cran_packages_by_date-933d5cc27a8330 |

## System Engineer Summary

Minimal Matrix Client-Server API

## Operational Role

For a systems engineer, mx.api belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-09-11 02:50:02 UTC | [https://cran.r-project.org/web/packages/mx.api/DESCRIPTION](https://cran.r-project.org/web/packages/mx.api/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mx.api/DESCRIPTION` at `2026-09-11T04:21:25+00:00`.
...
- `cran_packages_by_date-933d5cc27a8330` from `cran_packages_by_date` as `registry_expansion`
