...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/huihut/Facemoji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/huihut/Facemoji](https://github.com/huihut/Facemoji) |
| Source record ids | github_search_icons_and_logos-88af0424e546ec |

## System Engineer Summary

😆 A voice chatbot that can imitate your expression. OpenCV+Dlib+Live2D+Moments Recorder+Turing
Robot+Iflytek IAT+Iflytek TTS

## Operational Role

For a systems engineer, huihut/Facemoji belongs in the Icons and Logos inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-02-24T07:49:45Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-88af0424e546ec` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fabiocaccamo/django-admin-interface | Web Framework | [open](icons-and-logos-fabiocaccamo-django-admin-interface-930ddd64.md) |
