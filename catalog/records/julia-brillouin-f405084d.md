...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/Brillouin](https://github.com/JuliaRegistries/General/tree/master/B/Brillouin) |
| Source record ids | julia_general-eb975f419f75d5 |

## System Engineer Summary

Julia package registered in General at B/Brillouin.

## Operational Role

For a systems engineer, Brillouin belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/Brillouin", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-eb975f419f75d5` from `julia_general` as `registry_expansion`
