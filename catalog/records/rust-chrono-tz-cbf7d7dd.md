...
<!-- canonical: https://crates.io/crates/chrono-tz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/chrono-tz](https://crates.io/crates/chrono-tz) |
| Source record ids | crates_io-c9c8fbf041b8f4 |
...
For a systems engineer, chrono-tz belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.4 | 2025-07-11T19:08:33.700056Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-c9c8fbf041b8f4` from `crates_io` as `registry_expansion`
