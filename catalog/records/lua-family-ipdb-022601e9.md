...
| Canonical URL | [https://luarocks.org/modules/aveline/ipdb](https://luarocks.org/modules/aveline/ipdb) |
| Source record ids | luarocks_root_manifest-0f862ee528cecc |

## System Engineer Summary

ipdb is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, ipdb belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0f862ee528cecc` from `luarocks_root_manifest` as `registry_expansion`
