...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/seq-macro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/seq-macro](https://crates.io/crates/seq-macro) |
| Source record ids | crates_io-c701a32bcf3f37 |
...
For a systems engineer, seq-macro belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2025-03-04T00:15:39.018851Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-c701a32bcf3f37` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| crates.io | Registry Repository | [open](rust-crates-io-9814f943.md) |
