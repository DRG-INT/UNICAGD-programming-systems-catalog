...
<!-- canonical: https://luarocks.org/modules/xnaltasee/brightness -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/xnaltasee/brightness](https://luarocks.org/modules/xnaltasee/brightness) |
| Source record ids | luarocks_root_manifest-c7c9063110a4cd |
...
For a systems engineer, brightness belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c7c9063110a4cd` from `luarocks_root_manifest` as `registry_expansion`
