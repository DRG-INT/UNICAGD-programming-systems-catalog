...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BigRiverEssence -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BigRiverEssence", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-c515c394aa500a` from `julia_general` as `registry_expansion`
