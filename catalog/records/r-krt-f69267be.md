...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/krt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/krt/index.html](https://cran.r-project.org/web/packages/krt/index.html) |
| Source record ids | cran_packages_by_date-7dc1fc17829f21 |

## System Engineer Summary

Author, Validate, and Export Key Resources Tables

## Operational Role

For a systems engineer, krt belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:20:08 UTC | [https://cran.r-project.org/web/packages/krt/DESCRIPTION](https://cran.r-project.org/web/packages/krt/DESCRIPTION) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/krt/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-7dc1fc17829f21` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AHTauDesign | Datetime | [open](r-ahtaudesign-eac37f16.md) |
| brfinance | Datetime | [open](r-brfinance-6a384a4d.md) |
| dRiftDM | Datetime | [open](r-driftdm-377b26fd.md) |
| DTWBI | Datetime | [open](r-dtwbi-b6bdf44f.md) |
| DTWUMI | Datetime | [open](r-dtwumi-a8dc05b6.md) |
| EDE | Datetime | [open](r-ede-c12ce47c.md) |
| EmpiricalDynamics | Datetime | [open](r-empiricaldynamics-7b4496a1.md) |
| ftsspec | Datetime | [open](r-ftsspec-22de4146.md) |
