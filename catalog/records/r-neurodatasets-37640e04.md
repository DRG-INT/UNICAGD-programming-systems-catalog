...
<!-- canonical: https://cran.r-project.org/web/packages/NeuroDataSets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NeuroDataSets/index.html](https://cran.r-project.org/web/packages/NeuroDataSets/index.html) |
| Source record ids | cran_packages_by_date-433aa4d40d0c81 |
...
For a systems engineer, NeuroDataSets belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-22 23:40:02 UTC | [https://cran.r-project.org/web/packages/NeuroDataSets/DESCRIPTION](https://cran.r-project.org/web/packages/NeuroDataSets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NeuroDataSets/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-433aa4d40d0c81` from `cran_packages_by_date` as `registry_expansion`
