...
<!-- canonical: https://github.com/kowasm/kowasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kowasm/kowasm](https://github.com/kowasm/kowasm) |
| Source record ids | github_search_webassembly-a796e3bec70944 |

## System Engineer Summary

Server-side and full stack development with Kotlin and WebAssembly leveraging WASI and Component
Model

## Operational Role

For a systems engineer, kowasm/kowasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-23T21:38:11Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a796e3bec70944` from `github_search_webassembly` as `registry_expansion`
