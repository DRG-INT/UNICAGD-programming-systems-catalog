...
<!-- canonical: https://github.com/unum-cloud/USearch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unum-cloud/USearch](https://github.com/unum-cloud/USearch) |
| Source record ids | github_search_webassembly-7f3edb24c55f98 |

## System Engineer Summary

Fast Open-Source Search & Clustering engine × for Vectors & Arbitrary Objects × in C++, C, Python,
JavaScript, Rust, Java, Objective-C, Swift, C#, GoLang, and Wolfram 🔍

## Operational Role

For a systems engineer, unum-cloud/USearch belongs in the WebAssembly inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T22:47:21Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-7f3edb24c55f98` from `github_search_webassembly` as `registry_expansion`
