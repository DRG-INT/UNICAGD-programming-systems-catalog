...
<!-- canonical: https://github.com/Abhinandan-Kushwaha/react-native-gifted-charts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Abhinandan-Kushwaha/react-native-gifted-charts](https://github.com/Abhinandan-Kushwaha/react-native-gifted-charts) |
| Source record ids | github_search_radars-bfb91459920c1d |

## System Engineer Summary

The most loved library for Bar, Line, Area, Pie, Donut, Stacked Bar, Population Pyramid, Radar,
Bubble, Scatter and Candle Stick charts in React Native. Allows 2D, 3D, gradient, animations and
live data updates.

## Operational Role

For a systems engineer, Abhinandan-Kushwaha/react-native-gifted-charts belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.4.78 | 2026-08-10T13:08:25Z | [https://api.github.com/repos/Abhinandan-Kushwaha/react-native-gifted-charts/releases/latest](https://api.github.com/repos/Abhinandan-Kushwaha/react-native-gifted-charts/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Abhinandan-Kushwaha/react-native-gifted-charts/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_radars-bfb91459920c1d` from `github_search_radars` as `registry_expansion`
...
| jldz9/InSARHub | Undefined Behavior Analyzer | [open](radars-jldz9-insarhub-fdef62b9.md) |
