...
<!-- canonical: https://hackage.haskell.org/package/flow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/flow](https://hackage.haskell.org/package/flow) |
| Source record ids | hackage_top_downloads-8dfefb1e32de83 |
...
For a systems engineer, flow belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0.11 | 2026-01-14T15:20:55Z | [https://hackage.haskell.org/package/flow](https://hackage.haskell.org/package/flow) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/flow` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-8dfefb1e32de83` from `hackage_top_downloads` as `registry_expansion`
