...
<!-- canonical: https://github.com/gcunhase/Emotional-Video-to-Audio-with-ANFIS-DeepRNN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gcunhase/Emotional-Video-to-Audio-with-ANFIS-DeepRNN](https://github.com/gcunhase/Emotional-Video-to-Audio-with-ANFIS-DeepRNN) |
| Source record ids | github_search_matlab-0db1898781cf22 |
...
For a systems engineer, gcunhase/Emotional-Video-to-Audio-with-ANFIS-DeepRNN belongs in the Matlab
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-16T17:37:35Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-0db1898781cf22` from `github_search_matlab` as `registry_expansion`
