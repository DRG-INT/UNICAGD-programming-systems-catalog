...
<!-- canonical: https://cran.r-project.org/web/packages/hierNet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hierNet/index.html](https://cran.r-project.org/web/packages/hierNet/index.html) |
| Source record ids | cran_packages_by_date-fca0e5872e214d |
...
For a systems engineer, hierNet belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.1 | 2026-09-09 19:30:02 UTC | [https://cran.r-project.org/web/packages/hierNet/DESCRIPTION](https://cran.r-project.org/web/packages/hierNet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hierNet/DESCRIPTION` at `2026-09-09T20:20:33+00:00`.
...
- `cran_packages_by_date-fca0e5872e214d` from `cran_packages_by_date` as `registry_expansion`
