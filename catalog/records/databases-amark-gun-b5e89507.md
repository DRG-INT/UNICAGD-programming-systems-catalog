...
<!-- canonical: https://github.com/amark/gun -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amark/gun](https://github.com/amark/gun) |
| Source record ids | github_search_databases-12ea802296021f |
...
For a systems engineer, amark/gun belongs in the Databases inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T11:38:47Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-12ea802296021f` from `github_search_databases` as `registry_expansion`
