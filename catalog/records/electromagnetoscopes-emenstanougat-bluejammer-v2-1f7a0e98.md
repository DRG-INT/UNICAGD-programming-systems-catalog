...
<!-- canonical: https://github.com/EmenstaNougat/BlueJammer-V2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EmenstaNougat/BlueJammer-V2](https://github.com/EmenstaNougat/BlueJammer-V2) |
| Source record ids | github_search_electromagnetoscopes-5f4d8170b9085f |

## System Engineer Summary

BlueJammer-V2 is a two-board RF research platform combining an ESP32 jamming engine with a BW16 5GHz
web controller. Features up to 4x NRF24L01 modules, live OLED display, real-time web interface and
full UART communication between both boards. Educational purposes only!

## Operational Role

For a systems engineer, EmenstaNougat/BlueJammer-V2 belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T17:46:26Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-5f4d8170b9085f` from `github_search_electromagnetoscopes` as `registry_expansion`
