...
<!-- canonical: https://cran.r-project.org/web/packages/codecountR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/codecountR/index.html](https://cran.r-project.org/web/packages/codecountR/index.html) |
| Source record ids | cran_packages_by_date-f024c611a1c568 |
...
For a systems engineer, codecountR belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4.9 | 2026-09-07 14:50:02 UTC | [https://cran.r-project.org/web/packages/codecountR/DESCRIPTION](https://cran.r-project.org/web/packages/codecountR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/codecountR/DESCRIPTION` at `2026-09-07T16:20:18+00:00`.
...
- `cran_packages_by_date-f024c611a1c568` from `cran_packages_by_date` as `registry_expansion`
