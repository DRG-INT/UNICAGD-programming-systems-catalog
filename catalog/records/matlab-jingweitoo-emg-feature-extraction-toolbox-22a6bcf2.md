...
<!-- canonical: https://github.com/JingweiToo/EMG-Feature-Extraction-Toolbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JingweiToo/EMG-Feature-Extraction-Toolbox](https://github.com/JingweiToo/EMG-Feature-Extraction-Toolbox) |
| Source record ids | github_search_matlab-bc8b5c5c03f377 |

## System Engineer Summary

This toolbox offers 40 feature extraction methods (EMAV, EWL, MAV, WL, SSC, ZC, and etc.) for
Electromyography (EMG) signals applications.

## Operational Role

For a systems engineer, JingweiToo/EMG-Feature-Extraction-Toolbox belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-11T03:30:03Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-bc8b5c5c03f377` from `github_search_matlab` as `registry_expansion`
