...
<!-- canonical: https://github.com/phkaeser/wlmaker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/phkaeser/wlmaker](https://github.com/phkaeser/wlmaker) |
| Source record ids | github_search_effects-0e9bc85ac26ba3 |
...
For a systems engineer, phkaeser/wlmaker belongs in the Effects inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T17:50:14Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0e9bc85ac26ba3` from `github_search_effects` as `registry_expansion`
