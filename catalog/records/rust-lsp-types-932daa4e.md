...
<!-- canonical: https://crates.io/crates/lsp-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lsp-types](https://crates.io/crates/lsp-types) |
| Source record ids | crates_io-f55a93f78d71ed |
...
For a systems engineer, lsp-types belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.97.0 | 2024-06-04T12:38:56.735619Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
