...
| Canonical URL | [https://luarocks.org/modules/xavier-wang/gbk](https://luarocks.org/modules/xavier-wang/gbk) |
| Source record ids | luarocks_root_manifest-ea9821684e459d |

## System Engineer Summary

gbk is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, gbk belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ea9821684e459d` from `luarocks_root_manifest` as `registry_expansion`
