...
| Source record ids | curated_language_routes-8849eca8b047bc |

## System Engineer Summary

Software-defined radio toolkit used for satellite signal processing, demodulation, telemetry, and
communication experiments.

## Operational Role

For a systems engineer, GNU Radio Satellite Workflows belongs in the SatCom Satellites inventory as
...
- `curated_language_routes-8849eca8b047bc` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| gr-satellites | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/satcom-satellites-gr-satellites-b6e76f51.md) |
