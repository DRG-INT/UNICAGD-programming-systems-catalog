...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/datamindedbe/lighthouse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/datamindedbe/lighthouse](https://github.com/datamindedbe/lighthouse) |
| Source record ids | github_search_databases-8be6305e99a328 |

## System Engineer Summary

Lighthouse is a library for data lakes built on top of Apache Spark. It provides high-level APIs in
Scala to streamline data pipelines and apply best practices.

## Operational Role

For a systems engineer, datamindedbe/lighthouse belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-06T14:49:32Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-8be6305e99a328` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| airbytehq/airbyte | Package Manager | [open](databases-airbytehq-airbyte-c3bd56b6.md) |
| CodisLabs/codis | Package Manager | [open](databases-codislabs-codis-2fbfa490.md) |
| datajoint/datajoint-python | Package Manager | [open](databases-datajoint-datajoint-python-fe901d32.md) |
| doobidoo/mcp-memory-service | Package Manager | [open](databases-doobidoo-mcp-memory-service-1f3af65d.md) |
| memvid/memvid | Package Manager | [open](databases-memvid-memvid-85e03b2f.md) |
| oramasearch/orama | Package Manager | [open](databases-oramasearch-orama-c7b7d315.md) |
| pathwaycom/llm-app | Package Manager | [open](databases-pathwaycom-llm-app-200fc9af.md) |
| pchunduri6/rag-demystified | Package Manager | [open](databases-pchunduri6-rag-demystified-4f769fe6.md) |
