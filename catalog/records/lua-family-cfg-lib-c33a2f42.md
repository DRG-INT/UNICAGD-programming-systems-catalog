...
<!-- canonical: https://luarocks.org/modules/vsajip/cfg-lib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vsajip/cfg-lib](https://luarocks.org/modules/vsajip/cfg-lib) |
| Source record ids | luarocks_root_manifest-b38e3218b332db |
...
For a systems engineer, cfg-lib belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-b38e3218b332db` from `luarocks_root_manifest` as `registry_expansion`
