...
<!-- canonical: https://www.lua.org/community.html#workshop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.lua.org/community.html#workshop](https://www.lua.org/community.html#workshop) |
| Source record ids | lua-source-367 |
...
For a systems engineer, Lua Workshop belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 367}}` |
...
- `lua-source-367` from `master_json` as `source_list_item`
