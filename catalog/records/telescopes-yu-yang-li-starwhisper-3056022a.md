...
| Canonical URL | [https://github.com/Yu-Yang-Li/StarWhisper](https://github.com/Yu-Yang-Li/StarWhisper) |
| Source record ids | github_search_telescopes-682c64364177e7 |
...
For a systems engineer, Yu-Yang-Li/StarWhisper belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.0 | 2023-10-12T08:36:35Z | [https://api.github.com/repos/Yu-Yang-Li/StarWhisper/releases/latest](https://api.github.com/repos/Yu-Yang-Li/StarWhisper/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Yu-Yang-Li/StarWhisper/releases/latest` at `2026-09-01T08:26:27+00:00`.
...
- `github_search_telescopes-682c64364177e7` from `github_search_telescopes` as `registry_expansion`
