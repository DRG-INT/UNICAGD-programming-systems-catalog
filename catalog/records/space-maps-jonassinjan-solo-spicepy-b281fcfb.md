# JonasSinjan/solo_spicepy

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JonasSinjan/solo_spicepy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JonasSinjan/solo_spicepy](https://github.com/JonasSinjan/solo_spicepy) |
| Source record ids | github_search_space_maps-96daebba430c9c |

## System Engineer Summary

Python code to extract orbit information from the ESA Solar Orbiter Spice Kernels

## Operational Role

For a systems engineer, JonasSinjan/solo_spicepy belongs in the Space Maps inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-15T19:21:57Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-96daebba430c9c` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ACADLab/SPICEPilot | Formatter | [open](space-maps-acadlab-spicepilot-26ac7adc.md) |
| aduboisforge/Bright-Star-Catalog-JSON | Formatter | [open](space-maps-aduboisforge-bright-star-catalog-json-56a2faf5.md) |
| asdf-format/asdf | Formatter | [open](space-maps-asdf-format-asdf-f4898a65.md) |
| B612-Asteroid-Institute/spicekit | Formatter | [open](space-maps-b612-asteroid-institute-spicekit-b4821a47.md) |
| bgmeulem/luminet | Formatter | [open](space-maps-bgmeulem-luminet-66cad96d.md) |
| blackspiritualangel-pixel/astro-map | Formatter | [open](space-maps-blackspiritualangel-pixel-astro-map-9af237a4.md) |
| cyberkolbasa/JNSQ_info | Formatter | [open](space-maps-cyberkolbasa-jnsq-info-591b1abf.md) |
| cyberkolbasa/JNSQ_Info_extended | Formatter | [open](space-maps-cyberkolbasa-jnsq-info-extended-0c48fb94.md) |
