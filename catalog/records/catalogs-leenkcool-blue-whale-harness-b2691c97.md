...
<!-- canonical: https://github.com/leenkcool/Blue-Whale-Harness -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leenkcool/Blue-Whale-Harness](https://github.com/leenkcool/Blue-Whale-Harness) |
| Source record ids | github_search_catalogs-47989254199338 |

## System Engineer Summary

🐋 DeepSeek Harness 插件总目录 · The catalog of DSH plugins：1958 个仓库 / 1819 个真插件（Skills · MCP · Tools · UI
· Orchestration），中英文搜索、分类筛选、STAR 排序 → leenkcool.github.io

## Operational Role

For a systems engineer, leenkcool/Blue-Whale-Harness belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T03:49:36Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-47989254199338` from `github_search_catalogs` as `registry_expansion`
