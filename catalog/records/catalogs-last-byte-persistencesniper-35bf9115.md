...
<!-- canonical: https://github.com/last-byte/PersistenceSniper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/last-byte/PersistenceSniper](https://github.com/last-byte/PersistenceSniper) |
| Source record ids | github_search_catalogs-444cd5e70a51d6 |

## System Engineer Summary

Powershell module that can be used by Blue Teams, Incident Responders and System Administrators to
hunt persistences implanted in Windows machines. Official Twitter/X account @PersistSniper. Made
with ❤️ by @last0x00 and @dottor_morte

## Operational Role

For a systems engineer, last-byte/PersistenceSniper belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-11T16:45:04Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2 \| file LICENSE; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Other |
...
- `github_search_catalogs-444cd5e70a51d6` from `github_search_catalogs` as `registry_expansion`
