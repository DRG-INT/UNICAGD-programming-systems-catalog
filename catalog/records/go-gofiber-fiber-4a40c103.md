...
<!-- canonical: https://github.com/gofiber/fiber -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gofiber/fiber](https://github.com/gofiber/fiber) |
| Source record ids | github_search_go-d3071ad545cff7 |
...
For a systems engineer, gofiber/fiber belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T01:15:13Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-d3071ad545cff7` from `github_search_go` as `registry_expansion`
