...
<!-- canonical: https://crates.io/crates/serde_urlencoded -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_urlencoded](https://crates.io/crates/serde_urlencoded) |
| Source record ids | crates_io-8df5a3fdb74132 |
...
For a systems engineer, serde_urlencoded belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2022-01-17T11:26:21.628923Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-8df5a3fdb74132` from `crates_io` as `registry_expansion`
