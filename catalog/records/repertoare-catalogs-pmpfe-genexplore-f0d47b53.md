...
<!-- canonical: https://github.com/pmpfe/genexplore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pmpfe/genexplore](https://github.com/pmpfe/genexplore) |
| Source record ids | github_search_repertoare_catalogs-80f89b420f793d |

## System Engineer Summary

A simple desktop application for analyzing human genome sequence data against the GWAS Catalog, now
featuring polygenic risk score analysis. This is an exploration tool, not a medical instrument.

## Operational Role

For a systems engineer, pmpfe/genexplore belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-20T23:47:31Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-80f89b420f793d` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Agam3108/Catalogue-Scanning-App | Static Analyzer | [open](repertoare-catalogs-agam3108-catalogue-scanning-app-ae967b87.md) |
