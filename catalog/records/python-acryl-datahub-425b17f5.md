...
<!-- canonical: https://pypi.org/project/acryl-datahub/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acryl-datahub/](https://pypi.org/project/acryl-datahub/) |
| Source record ids | pypi_simple-645236d6e1714d |

## System Engineer Summary

DataHub ingestion framework and CLI — connect, extract, and push metadata from 50+ data sources into
your DataHub catalog

## Operational Role

For a systems engineer, acryl-datahub belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0.7 | 2026-08-26T13:47:55.490323Z | [https://pypi.org/pypi/acryl-datahub/json](https://pypi.org/pypi/acryl-datahub/json) |  |
| preview | known | 1.7.0rc2 | 2026-08-04T17:02:08.290175Z | [https://pypi.org/pypi/acryl-datahub/json](https://pypi.org/pypi/acryl-datahub/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acryl-datahub/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-645236d6e1714d` from `pypi_simple` as `registry_expansion`
