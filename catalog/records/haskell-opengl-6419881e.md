...
<!-- canonical: https://hackage.haskell.org/package/OpenGL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/OpenGL](https://hackage.haskell.org/package/OpenGL) |
| Source record ids | hackage_top_downloads-cd3c6450933235 |
...
For a systems engineer, OpenGL belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.3.0 | 2019-05-06T12:03:03Z | [https://hackage.haskell.org/package/OpenGL](https://hackage.haskell.org/package/OpenGL) |  |
| candidate | partial | 2.9.2.0 |  | [https://hackage.haskell.org/package/OpenGL](https://hackage.haskell.org/package/OpenGL) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/OpenGL` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-cd3c6450933235` from `hackage_top_downloads` as `registry_expansion`
