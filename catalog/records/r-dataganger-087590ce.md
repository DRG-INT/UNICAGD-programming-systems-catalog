...
<!-- canonical: https://cran.r-project.org/web/packages/dataganger/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dataganger/index.html](https://cran.r-project.org/web/packages/dataganger/index.html) |
| Source record ids | cran_packages_by_date-f79c45ef7dd505 |
...
For a systems engineer, dataganger belongs in the R inventory as part of interface contracts,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-08-24 18:30:02 UTC | [https://cran.r-project.org/web/packages/dataganger/DESCRIPTION](https://cran.r-project.org/web/packages/dataganger/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dataganger/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f79c45ef7dd505` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| PINSPlus | Type Checker | [open](r-pinsplus-38f98d56.md) |
