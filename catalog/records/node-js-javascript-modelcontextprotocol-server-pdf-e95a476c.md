...
<!-- canonical: https://www.npmjs.com/package/@modelcontextprotocol/server-pdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@modelcontextprotocol/server-pdf](https://www.npmjs.com/package/@modelcontextprotocol/server-pdf) |
| Source record ids | npm_registry-9de9b2f232452f |

## System Engineer Summary

MCP server for loading and extracting text from PDF files with chunked pagination and interactive
viewer

## Operational Role

For a systems engineer, @modelcontextprotocol/server-pdf belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.5 | 2026-07-23T11:30:02.373Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-9de9b2f232452f` from `npm_registry` as `registry_expansion`
