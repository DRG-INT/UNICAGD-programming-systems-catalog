...
<!-- canonical: https://crates.io/crates/num-rational -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-rational](https://crates.io/crates/num-rational) |
| Source record ids | crates_io-f096b546a0963c |
...
For a systems engineer, num-rational belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2025-01-25T00:45:16.565243Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-f096b546a0963c` from `crates_io` as `registry_expansion`
