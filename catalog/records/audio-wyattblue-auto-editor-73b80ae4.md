...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/WyattBlue/auto-editor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WyattBlue/auto-editor](https://github.com/WyattBlue/auto-editor) |
| Source record ids | github_search_audio-1dfabf90dd73a2 |
...
For a systems engineer, WyattBlue/auto-editor belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T02:25:02Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:audio stars:>500", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_audio-1dfabf90dd73a2` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 777arc/PySDR | Ide Editor Integration | [open](audio-777arc-pysdr-e43c1cf4.md) |
| alyssaxuu/motionity | Ide Editor Integration | [open](audio-alyssaxuu-motionity-3c2fb703.md) |
| audacity/audacity | Ide Editor Integration | [open](audio-audacity-audacity-76dd21d8.md) |
| bitgapp/eqMac | Ide Editor Integration | [open](audio-bitgapp-eqmac-bb6a049e.md) |
| dan-k-k/vocal-gate | Ide Editor Integration | [open](audio-dan-k-k-vocal-gate-8c08df3b.md) |
| danilogcrf2-oss/ESP32Synth | Ide Editor Integration | [open](audio-danilogcrf2-oss-esp32synth-7a58d4c6.md) |
| deniscerri/ytdlnis | Ide Editor Integration | [open](audio-deniscerri-ytdlnis-096edb21.md) |
| everythingwillbetakenaway/DX7-Supercollider | Ide Editor Integration | [open](audio-everythingwillbetakenaway-dx7-supercollider-316ba0b4.md) |
