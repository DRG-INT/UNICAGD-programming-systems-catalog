...
<!-- canonical: https://github.com/0xADE1A1DE/AssemblyLine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/0xADE1A1DE/AssemblyLine](https://github.com/0xADE1A1DE/AssemblyLine) |
| Source record ids | github_search_assembly-0eee93dabcfe73 |

## System Engineer Summary

A C library and binary for generating machine code of x86_64 assembly language and executing on the
fly without invoking another compiler, assembler or linker.

## Operational Role

For a systems engineer, 0xADE1A1DE/AssemblyLine belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-10T03:28:23Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-0eee93dabcfe73` from `github_search_assembly` as `registry_expansion`
