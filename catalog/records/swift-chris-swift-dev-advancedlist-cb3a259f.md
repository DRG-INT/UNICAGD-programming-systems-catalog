...
| Canonical URL | [https://github.com/chris-swift-dev/AdvancedList](https://github.com/chris-swift-dev/AdvancedList) |
| Source record ids | github_search_swift-1fe310d0736849 |
...
For a systems engineer, chris-swift-dev/AdvancedList belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2022-04-10T22:06:33Z | [https://api.github.com/repos/chris-swift-dev/AdvancedList/releases/latest](https://api.github.com/repos/chris-swift-dev/AdvancedList/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/chris-swift-dev/AdvancedList/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-1fe310d0736849` from `github_search_swift` as `registry_expansion`
...
| spacenation/swiftui-charts | Visualization Gui | [open](swift-spacenation-swiftui-charts-664f689a.md) |
