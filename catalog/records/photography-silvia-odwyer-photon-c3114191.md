...
<!-- canonical: https://github.com/silvia-odwyer/photon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/silvia-odwyer/photon](https://github.com/silvia-odwyer/photon) |
| Source record ids | github_search_photography-7e3ebcb7d2ce28 |
...
For a systems engineer, silvia-odwyer/photon belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T12:02:31Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-7e3ebcb7d2ce28` from `github_search_photography` as `registry_expansion`
