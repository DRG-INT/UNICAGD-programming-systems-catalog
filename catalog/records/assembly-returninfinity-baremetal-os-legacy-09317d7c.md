...
| Canonical URL | [https://github.com/ReturnInfinity/BareMetal-OS-legacy](https://github.com/ReturnInfinity/BareMetal-OS-legacy) |
| Source record ids | github_search_assembly-867b81693068f9 |

## System Engineer Summary

BareMetal is a 64-bit OS for x86-64 based computers. The OS is written entirely in Assembly while
applications can be written in Assembly, C/C++, and Rust.

## Operational Role

For a systems engineer, ReturnInfinity/BareMetal-OS-legacy belongs in the Assembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.1 | 2013-08-20T01:11:10Z | [https://api.github.com/repos/ReturnInfinity/BareMetal-OS-legacy/releases/latest](https://api.github.com/repos/ReturnInfinity/BareMetal-OS-legacy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ReturnInfinity/BareMetal-OS-legacy/releases/latest` at `2026-09-01T12:30:22+00:00`.
...
- `github_search_assembly-867b81693068f9` from `github_search_assembly` as `registry_expansion`
