...
<!-- canonical: https://luarocks.org/modules/mah0x211/bitvec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/bitvec](https://luarocks.org/modules/mah0x211/bitvec) |
| Source record ids | luarocks_root_manifest-2daa2fe2aabafe |

## System Engineer Summary

bitvec is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, bitvec belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2daa2fe2aabafe` from `luarocks_root_manifest` as `registry_expansion`
