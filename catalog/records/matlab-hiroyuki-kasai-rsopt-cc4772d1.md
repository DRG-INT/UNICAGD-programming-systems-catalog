...
<!-- canonical: https://github.com/hiroyuki-kasai/RSOpt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hiroyuki-kasai/RSOpt](https://github.com/hiroyuki-kasai/RSOpt) |
| Source record ids | github_search_matlab-b45a5d87f046b9 |
...
For a systems engineer, hiroyuki-kasai/RSOpt belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-05T03:31:45Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-b45a5d87f046b9` from `github_search_matlab` as `registry_expansion`
