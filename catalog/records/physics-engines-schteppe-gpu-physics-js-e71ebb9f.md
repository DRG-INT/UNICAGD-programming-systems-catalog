...
<!-- canonical: https://github.com/schteppe/gpu-physics.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/schteppe/gpu-physics.js](https://github.com/schteppe/gpu-physics.js) |
| Source record ids | github_search_physics_engines-23b50e553a4bea |
...
For a systems engineer, schteppe/gpu-physics.js belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-31T11:51:43Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-23b50e553a4bea` from `github_search_physics_engines` as `registry_expansion`
