...
| Canonical URL | [https://packagist.org/packages/guzzlehttp/psr7](https://packagist.org/packages/guzzlehttp/psr7) |
| Source record ids | packagist_search-8315533952b4da |
...
For a systems engineer, guzzlehttp/psr7 belongs in the PHP inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-08-24T11:03:23+00:00 | [https://repo.packagist.org/p2/guzzlehttp/psr7.json](https://repo.packagist.org/p2/guzzlehttp/psr7.json) |  |
| preview | known | 2.0.0-rc1 | 2021-04-29T07:36:18+00:00 | [https://repo.packagist.org/p2/guzzlehttp/psr7.json](https://repo.packagist.org/p2/guzzlehttp/psr7.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/guzzlehttp/psr7.json` at `2026-09-01T07:20:23+00:00`.
...
- `packagist_search-8315533952b4da` from `packagist_search` as `registry_expansion`
