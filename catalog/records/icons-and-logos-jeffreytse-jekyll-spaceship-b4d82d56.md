...
<!-- canonical: https://github.com/jeffreytse/jekyll-spaceship -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeffreytse/jekyll-spaceship](https://github.com/jeffreytse/jekyll-spaceship) |
| Source record ids | github_search_icons_and_logos-ad32fda1a4459f |

## System Engineer Summary

🚀 A Jekyll plugin to provide powerful supports for table, mathjax, plantuml, mermaid, emoji, video,
audio, youtube, vimeo, dailymotion, soundcloud, spotify, etc.

## Operational Role

For a systems engineer, jeffreytse/jekyll-spaceship belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-03T19:54:34Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-ad32fda1a4459f` from `github_search_icons_and_logos` as `registry_expansion`
