...
<!-- canonical: https://github.com/NirDiamant/Agent_Memory_Techniques -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NirDiamant/Agent_Memory_Techniques](https://github.com/NirDiamant/Agent_Memory_Techniques) |
| Source record ids | github_search_databases-fa8d2555a21739 |

## System Engineer Summary

Agent memory for LLMs: 30 runnable Jupyter notebooks covering conversation buffers, vector stores,
knowledge graphs, episodic and semantic memory, MemGPT, Mem0, Letta, Zep, Graphiti, LoCoMo
benchmarks, and production patterns.

## Operational Role

For a systems engineer, NirDiamant/Agent_Memory_Techniques belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T12:01:14Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-fa8d2555a21739` from `github_search_databases` as `registry_expansion`
