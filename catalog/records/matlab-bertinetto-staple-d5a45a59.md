...
<!-- canonical: https://github.com/bertinetto/staple -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bertinetto/staple](https://github.com/bertinetto/staple) |
| Source record ids | github_search_matlab-beadbfa65bbdbf |
...
For a systems engineer, bertinetto/staple belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-04-25T16:36:08Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-beadbfa65bbdbf` from `github_search_matlab` as `registry_expansion`
