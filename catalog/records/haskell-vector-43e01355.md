...
<!-- canonical: https://hackage.haskell.org/package/vector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vector](https://hackage.haskell.org/package/vector) |
| Source record ids | hackage_top_downloads-1c071be36ea1a4 |
...
For a systems engineer, vector belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.2.0 | 2024-10-31T18:01:59Z | [https://hackage.haskell.org/package/vector](https://hackage.haskell.org/package/vector) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vector` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-1c071be36ea1a4` from `hackage_top_downloads` as `registry_expansion`
