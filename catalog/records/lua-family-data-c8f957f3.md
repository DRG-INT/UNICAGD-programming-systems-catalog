...
<!-- canonical: https://luarocks.org/modules/glenn/data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/glenn/data](https://luarocks.org/modules/glenn/data) |
| Source record ids | luarocks_root_manifest-9ad5cae3eff3eb |

## System Engineer Summary

data is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, data belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9ad5cae3eff3eb` from `luarocks_root_manifest` as `registry_expansion`
