...
| Source record ids | github_search_swift-e8da061b5d6f81 |
...
For a systems engineer, steipete/CodexBar belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T04:24:44Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-e8da061b5d6f81` from `github_search_swift` as `registry_expansion`
