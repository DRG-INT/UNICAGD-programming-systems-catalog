...
<!-- canonical: https://hackage.haskell.org/package/HMock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/HMock](https://hackage.haskell.org/package/HMock) |
| Source record ids | hackage_recent-62497183bd454a |

## System Engineer Summary

Hackage package recently uploaded by ChrisSmith.

## Operational Role

For a systems engineer, HMock belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2.0 | 2026-09-01T17:21:39Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-01T18:22:21+00:00`.
...
- `hackage_recent-62497183bd454a` from `hackage_recent` as `registry_expansion`
...
| servant-mock | Assertion Mocking | [open](haskell-servant-mock-4cfe14bb.md) |
