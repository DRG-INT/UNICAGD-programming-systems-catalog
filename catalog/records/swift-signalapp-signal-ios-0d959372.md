...
<!-- canonical: https://github.com/signalapp/Signal-iOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/signalapp/Signal-iOS](https://github.com/signalapp/Signal-iOS) |
| Source record ids | github_search_swift-d10646b01dc8eb |
...
For a systems engineer, signalapp/Signal-iOS belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:53:41Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-d10646b01dc8eb` from `github_search_swift` as `registry_expansion`
