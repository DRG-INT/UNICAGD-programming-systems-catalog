...
<!-- canonical: https://github.com/medusalix/MiniVST -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/medusalix/MiniVST](https://github.com/medusalix/MiniVST) |
| Source record ids | github_search_effects-70b82e963f0f29 |

## System Engineer Summary

Minimalistic Windows-only VST2 Host

## Operational Role

For a systems engineer, medusalix/MiniVST belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-03-06T17:18:51Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-70b82e963f0f29` from `github_search_effects` as `registry_expansion`
