...
<!-- canonical: https://cran.r-project.org/web/packages/badcontrols/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/badcontrols/index.html](https://cran.r-project.org/web/packages/badcontrols/index.html) |
| Source record ids | cran_packages_by_date-77ade3f9d88140 |
...
For a systems engineer, badcontrols belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-12 14:40:30 UTC | [https://cran.r-project.org/web/packages/badcontrols/DESCRIPTION](https://cran.r-project.org/web/packages/badcontrols/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/badcontrols/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-77ade3f9d88140` from `cran_packages_by_date` as `registry_expansion`
