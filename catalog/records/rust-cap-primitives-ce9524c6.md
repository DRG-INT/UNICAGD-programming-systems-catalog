...
| Canonical URL | [https://crates.io/crates/cap-primitives](https://crates.io/crates/cap-primitives) |
| Source record ids | crates_io-fd49de32a7ffc6 |
...
For a systems engineer, cap-primitives belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.3 | 2026-08-20T15:13:07.622171Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-fd49de32a7ffc6` from `crates_io` as `registry_expansion`
