...
<!-- canonical: https://pypi.org/project/5mghost-shared-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/5mghost-shared-client/](https://pypi.org/project/5mghost-shared-client/) |
| Source record ids | pypi_simple-63c4db087ff457 |
...
For a systems engineer, 5mghost-shared-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5 | 2026-04-14T17:59:30.619590Z | [https://pypi.org/pypi/5mghost-shared-client/json](https://pypi.org/pypi/5mghost-shared-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/5mghost-shared-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-63c4db087ff457` from `pypi_simple` as `registry_expansion`
