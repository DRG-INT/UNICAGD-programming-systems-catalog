...
<!-- canonical: https://pub.dev/packages/english_words -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/english_words](https://pub.dev/packages/english_words) |
| Source record ids | pub_dev-fe29b6babd0a85 |

## System Engineer Summary

Utilities for working with English words. Counts syllables, generates well-sounding word
combinations, and provides access to the top 5000 English words by usage.

## Operational Role

For a systems engineer, english_words belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2021-03-24T21:07:45.496950Z | [https://pub.dev/api/packages/english_words](https://pub.dev/api/packages/english_words) |  |
| preview | known | 4.0.0-nullsafety.0 | 2020-11-10T19:44:38.125616Z | [https://pub.dev/api/packages/english_words](https://pub.dev/api/packages/english_words) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/english_words` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-fe29b6babd0a85` from `pub_dev` as `registry_expansion`
