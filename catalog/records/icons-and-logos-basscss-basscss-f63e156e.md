...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/basscss/basscss -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/basscss/basscss](https://github.com/basscss/basscss) |
| Source record ids | github_search_icons_and_logos-ecede62d767cdc |
...
For a systems engineer, basscss/basscss belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-30T17:37:47Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-ecede62d767cdc` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ForkAwesome/Fork-Awesome | Utility Library | [open](icons-and-logos-forkawesome-fork-awesome-a32defe0.md) |
| FortAwesome/Font-Awesome | Utility Library | [open](icons-and-logos-fortawesome-font-awesome-eb4f1426.md) |
| kenangundogan/fontisto | Utility Library | [open](icons-and-logos-kenangundogan-fontisto-765bfc36.md) |
