...
<!-- canonical: https://pub.dev/packages/remixicon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/remixicon](https://pub.dev/packages/remixicon) |
| Source record ids | pub_dev-df650eb6f86da4 |
...
For a systems engineer, remixicon belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.9.3 | 2026-04-04T09:52:42.682479Z | [https://pub.dev/api/packages/remixicon](https://pub.dev/api/packages/remixicon) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/remixicon` at `2026-09-12T21:19:19+00:00`.
...
- `pub_dev-df650eb6f86da4` from `pub_dev` as `registry_expansion`
