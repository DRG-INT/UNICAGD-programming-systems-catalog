...
<!-- canonical: https://cran.r-project.org/web/packages/opencis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/opencis/index.html](https://cran.r-project.org/web/packages/opencis/index.html) |
| Source record ids | cran_packages_by_date-2f317e27575306 |

## System Engineer Summary

Import Data from Spanish Sociological Research Center (CIS)

## Operational Role

For a systems engineer, opencis belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-09-07 18:30:14 UTC | [https://cran.r-project.org/web/packages/opencis/DESCRIPTION](https://cran.r-project.org/web/packages/opencis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/opencis/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-2f317e27575306` from `cran_packages_by_date` as `registry_expansion`
