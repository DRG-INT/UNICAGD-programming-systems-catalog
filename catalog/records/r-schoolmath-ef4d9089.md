...
<!-- canonical: https://cran.r-project.org/web/packages/schoolmath/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/schoolmath/index.html](https://cran.r-project.org/web/packages/schoolmath/index.html) |
| Source record ids | cran_packages_by_date-9dd6513928511e |
...
For a systems engineer, schoolmath belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-08-27 05:10:09 UTC | [https://cran.r-project.org/web/packages/schoolmath/DESCRIPTION](https://cran.r-project.org/web/packages/schoolmath/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/schoolmath/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9dd6513928511e` from `cran_packages_by_date` as `registry_expansion`
