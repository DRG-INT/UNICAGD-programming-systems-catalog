# Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator](https://github.com/Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator) |
| Source record ids | github_search_space_maps-3669659962801e |

## System Engineer Summary

A deep learning N-body orbital simulator utilizing NASA SPICE kernels and RK4 integration to predict
chaotic gravitational perturbations in real-time.

## Operational Role

For a systems engineer, Soldeusss/Simulacrum-A-Deep-Learning-N-Body-Simulator belongs in the Space
Maps inventory as part of ecosystem capability mapping, dependency review, release awareness, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-17T14:37:01Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "SPICE kernels", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_space_maps-3669659962801e` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Arxhsz/Project-Orion | Datetime | [open](space-maps-arxhsz-project-orion-6090cda4.md) |
| CelestiaProject/Celestia | Datetime | [open](space-maps-celestiaproject-celestia-c6ce4bc8.md) |
| Gabriel-Hatcher/Planetry_Oribital_Graphics | Datetime | [open](space-maps-gabriel-hatcher-planetry-oribital-graphics-b8d855fb.md) |
| hollisliu/Spacetime-Rhapsody | Datetime | [open](space-maps-hollisliu-spacetime-rhapsody-fd23d073.md) |
| Jthora/TimeMaps | Datetime | [open](space-maps-jthora-timemaps-5e27a537.md) |
| mraad/space-time-ripple | Datetime | [open](space-maps-mraad-space-time-ripple-4b5f58f2.md) |
| stenzelf/biointegrity | Datetime | [open](space-maps-stenzelf-biointegrity-2c48dc4b.md) |
| xianglinyang/DeepVisualInsight | Datetime | [open](space-maps-xianglinyang-deepvisualinsight-c6301fd9.md) |
