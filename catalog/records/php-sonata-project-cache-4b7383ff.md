...
<!-- canonical: https://packagist.org/packages/sonata-project/cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sonata-project/cache](https://packagist.org/packages/sonata-project/cache) |
| Source record ids | packagist_search-9cda0a077ae6ea |

## System Engineer Summary

sonata-project/cache is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, sonata-project/cache belongs in the PHP inventory as part of state
...
- `packagist_search-9cda0a077ae6ea` from `packagist_search` as `registry_expansion`
