...
<!-- canonical: https://pub.dev/packages/pin_code_fields -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pin_code_fields](https://pub.dev/packages/pin_code_fields) |
| Source record ids | pub_dev-0ef5cff9579b46 |

## System Engineer Summary

A highly customizable PIN/OTP input field for Flutter with Material Design support and headless core
for custom UIs.

## Operational Role

For a systems engineer, pin_code_fields belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.0 | 2026-09-11T07:55:50.991810Z | [https://pub.dev/api/packages/pin_code_fields](https://pub.dev/api/packages/pin_code_fields) |  |
| preview | known | 9.0.0-dev.3 | 2026-02-02T19:33:14.857407Z | [https://pub.dev/api/packages/pin_code_fields](https://pub.dev/api/packages/pin_code_fields) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pin_code_fields` at `2026-09-11T08:21:53+00:00`.
...
- `pub_dev-0ef5cff9579b46` from `pub_dev` as `registry_expansion`
