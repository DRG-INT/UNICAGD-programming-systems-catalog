...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClimaCalibrate](https://github.com/JuliaRegistries/General/tree/master/C/ClimaCalibrate) |
| Source record ids | julia_general-cfe8a7ccc081d9 |

## System Engineer Summary

Julia package registered in General at C/ClimaCalibrate.

## Operational Role

For a systems engineer, ClimaCalibrate belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClimaCalibrate", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-cfe8a7ccc081d9` from `julia_general` as `registry_expansion`
