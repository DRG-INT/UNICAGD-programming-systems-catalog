...
| Canonical URL | [https://crates.io/crates/sea-orm](https://crates.io/crates/sea-orm) |
| Source record ids | crates_io-7ad48e1ccba215 |
...
For a systems engineer, sea-orm belongs in the Rust inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-12T21:06:12.423143Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-7ad48e1ccba215` from `crates_io` as `registry_expansion`
