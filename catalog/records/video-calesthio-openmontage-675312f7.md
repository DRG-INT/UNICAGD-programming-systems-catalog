...
<!-- canonical: https://github.com/calesthio/OpenMontage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) |
| Source record ids | github_search_video-a837e4fb8802b0 |

## System Engineer Summary

World's first open-source, agentic video production system. 12 production pipelines, 100+ tools,
700+ agent skill and production-knowledge files. Turn your AI coding assistant into a full video
production studio.

## Operational Role

For a systems engineer, calesthio/OpenMontage belongs in the Video inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T18:22:24Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-a837e4fb8802b0` from `github_search_video` as `registry_expansion`
