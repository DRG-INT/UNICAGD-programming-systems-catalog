...
<!-- canonical: https://hackage.haskell.org/package/serialport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/serialport](https://hackage.haskell.org/package/serialport) |
| Source record ids | hackage_top_downloads-e99035925dadc3 |
...
For a systems engineer, serialport belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2025-09-21T21:31:06Z | [https://hackage.haskell.org/package/serialport](https://hackage.haskell.org/package/serialport) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/serialport` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-e99035925dadc3` from `hackage_top_downloads` as `registry_expansion`
