...
<!-- canonical: https://github.com/agamrossen/VolAnti -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/agamrossen/VolAnti](https://github.com/agamrossen/VolAnti) |
| Source record ids | github_search_audio-41ca549ab44134 |

## System Engineer Summary

Open-source acoustic drone detection. It hears the propellers, not the radio, so it works against
fibre-optic FPV aircraft that emit no signal at all.

## Operational Role

For a systems engineer, agamrossen/VolAnti belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T13:03:58Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-41ca549ab44134` from `github_search_audio` as `registry_expansion`
