...
<!-- canonical: https://github.com/newmarcel/KeepingYouAwake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/newmarcel/KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) |
| Source record ids | github_search_cocoa-3dcfa2bd783f47 |
...
For a systems engineer, newmarcel/KeepingYouAwake belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T11:38:08Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-3dcfa2bd783f47` from `github_search_cocoa` as `registry_expansion`
