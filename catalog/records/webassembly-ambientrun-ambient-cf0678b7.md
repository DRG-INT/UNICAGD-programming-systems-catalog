...
| Source record ids | github_search_webassembly-b6efca85325b3b |
...
For a systems engineer, AmbientRun/Ambient belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-07T09:48:53Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-b6efca85325b3b` from `github_search_webassembly` as `registry_expansion`
