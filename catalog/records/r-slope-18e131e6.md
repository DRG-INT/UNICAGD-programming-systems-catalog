...
<!-- canonical: https://cran.r-project.org/web/packages/SLOPE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SLOPE/index.html](https://cran.r-project.org/web/packages/SLOPE/index.html) |
| Source record ids | cran_packages_by_date-de082f870a54c7 |
...
For a systems engineer, SLOPE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2026-08-29 12:00:09 UTC | [https://cran.r-project.org/web/packages/SLOPE/DESCRIPTION](https://cran.r-project.org/web/packages/SLOPE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SLOPE/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-de082f870a54c7` from `cran_packages_by_date` as `registry_expansion`
