...
<!-- canonical: https://gitea.com/zishuo/mpp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/zishuo/mpp](https://gitea.com/zishuo/mpp) |
| Source record ids | gitea_repositories_api-8383d1e63d392c |
...
For a systems engineer, Gitea: zishuo/mpp belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-19T11:10:11Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8383d1e63d392c` from `gitea_repositories_api` as `registry_expansion`
