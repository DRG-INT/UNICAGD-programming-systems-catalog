...
<!-- canonical: https://github.com/nforrester/NexPlane -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nforrester/NexPlane](https://github.com/nforrester/NexPlane) |
| Source record ids | github_search_telescopes-06e55c2fef7535 |

## System Engineer Summary

Track airplanes and satellites using a Celestron or Sky-Watcher telescope mount

## Operational Role

For a systems engineer, nforrester/NexPlane belongs in the Telescopes inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-04T00:21:23Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-06e55c2fef7535` from `github_search_telescopes` as `registry_expansion`
