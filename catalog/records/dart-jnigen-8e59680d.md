...
<!-- canonical: https://pub.dev/packages/jnigen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/jnigen](https://pub.dev/packages/jnigen) |
| Source record ids | pub_dev-4bc72c847b451a |

## System Engineer Summary

A Dart bindings generator for Java and Kotlin that uses JNI under the hood to interop with Java
virtual machine.

## Operational Role

For a systems engineer, jnigen belongs in the Dart inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.0 | 2026-07-27T01:10:49.441977Z | [https://pub.dev/api/packages/jnigen](https://pub.dev/api/packages/jnigen) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/jnigen` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-4bc72c847b451a` from `pub_dev` as `registry_expansion`
