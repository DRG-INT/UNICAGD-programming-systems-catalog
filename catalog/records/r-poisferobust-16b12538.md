...
<!-- canonical: https://cran.r-project.org/web/packages/poisFErobust/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/poisFErobust/index.html](https://cran.r-project.org/web/packages/poisFErobust/index.html) |
| Source record ids | cran_packages_by_date-80af2604ba3102 |
...
For a systems engineer, poisFErobust belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-09-01 07:20:02 UTC | [https://cran.r-project.org/web/packages/poisFErobust/DESCRIPTION](https://cran.r-project.org/web/packages/poisFErobust/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/poisFErobust/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-80af2604ba3102` from `cran_packages_by_date` as `registry_expansion`
