...
<!-- canonical: https://luarocks.org/modules/tieske/darksidesync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tieske/darksidesync](https://luarocks.org/modules/tieske/darksidesync) |
| Source record ids | luarocks_root_manifest-3681daf9ff4868 |
...
For a systems engineer, darksidesync belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3681daf9ff4868` from `luarocks_root_manifest` as `registry_expansion`
