...
<!-- canonical: https://pub.dev/packages/tap_debouncer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/tap_debouncer](https://pub.dev/packages/tap_debouncer) |
| Source record ids | pub_dev-a7f83989899710 |
...
For a systems engineer, tap_debouncer belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2023-05-21T17:07:06.791272Z | [https://pub.dev/api/packages/tap_debouncer](https://pub.dev/api/packages/tap_debouncer) |  |
| preview | known | 2.0.0-nullsafety.1 | 2020-11-20T08:49:00.132439Z | [https://pub.dev/api/packages/tap_debouncer](https://pub.dev/api/packages/tap_debouncer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/tap_debouncer` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-a7f83989899710` from `pub_dev` as `registry_expansion`
