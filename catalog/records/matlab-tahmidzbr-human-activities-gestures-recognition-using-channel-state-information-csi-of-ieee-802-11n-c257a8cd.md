...
<!-- canonical: https://github.com/tahmidzbr/Human-Activities-Gestures-Recognition-using-Channel-State-Information-CSI-of-IEEE-802.11n -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tahmidzbr/Human-Activities-Gestures-Recognition-using-Channel-State-Information-CSI-of-IEEE-802.11n](https://github.com/tahmidzbr/Human-Activities-Gestures-Recognition-using-Channel-State-Information-CSI-of-IEEE-802.11n) |
| Source record ids | github_search_matlab-db3369919f05b2 |

## System Engineer Summary

This is a data-set for Human Activities & Gestures Recognition (HAGR) using the Channel State
information (CSI) of IEEE 802.11n devices

## Operational Role

For a systems engineer, tahmidzbr/Human-Activities-Gestures-Recognition-using-Channel-State-
Information-CSI-of-IEEE-802.11n belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-09-19T20:03:06Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-db3369919f05b2` from `github_search_matlab` as `registry_expansion`
