# sjarmak/EuropaClipper_JUICE_UVS
...
<!-- canonical: https://github.com/sjarmak/EuropaClipper_JUICE_UVS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sjarmak/EuropaClipper_JUICE_UVS](https://github.com/sjarmak/EuropaClipper_JUICE_UVS) |
| Source record ids | github_search_space_maps-1eb6a94474d027 |

## System Engineer Summary

IDL observation-planning tool for the Europa Clipper UVS and JUICE UVS ultraviolet spectrograph
instruments, including SPICE kernels, mission trajectories, map images, and plotting routines.

## Operational Role

For a systems engineer, sjarmak/EuropaClipper_JUICE_UVS belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T13:50:34Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-1eb6a94474d027` from `github_search_space_maps` as `registry_expansion`
