...
<!-- canonical: https://cran.r-project.org/web/packages/RCurl/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RCurl/index.html](https://cran.r-project.org/web/packages/RCurl/index.html) |
| Source record ids | cran_packages_by_date-63dcc383ab34c1 |
...
For a systems engineer, RCurl belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.98-1.20 | 2026-08-21 23:40:08 UTC | [https://cran.r-project.org/web/packages/RCurl/DESCRIPTION](https://cran.r-project.org/web/packages/RCurl/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RCurl/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-63dcc383ab34c1` from `cran_packages_by_date` as `registry_expansion`
