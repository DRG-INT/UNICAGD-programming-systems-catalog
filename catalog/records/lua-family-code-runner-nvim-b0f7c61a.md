...
<!-- canonical: https://luarocks.org/modules/wsdjeg/code-runner.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/wsdjeg/code-runner.nvim](https://luarocks.org/modules/wsdjeg/code-runner.nvim) |
| Source record ids | luarocks_root_manifest-fcfbdfd00c21ae, luarocks_root_manifest-e7748b07ef07f4 |
...
For a systems engineer, code-runner.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-fcfbdfd00c21ae` from `luarocks_root_manifest` as `registry_expansion`
- `luarocks_root_manifest-e7748b07ef07f4` from `luarocks_root_manifest` as `registry_expansion`
