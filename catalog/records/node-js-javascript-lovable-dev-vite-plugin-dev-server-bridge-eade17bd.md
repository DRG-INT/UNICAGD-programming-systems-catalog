...
[Catalog index](../index.md) · [Language: Node.js/JavaScript](../by-language/node-js-javascript.md) · [Category: Compiler Diagnostics](../by-category/compiler-diagnostics.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/@lovable.dev/vite-plugin-dev-server-bridge -->
<!-- crawl-delay: 10 -->
...
- `npm_registry-8467422c223220` from `npm_registry` as `registry_expansion`
