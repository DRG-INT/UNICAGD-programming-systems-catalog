...
<!-- canonical: https://crates.io/crates/crossbeam-epoch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crossbeam-epoch](https://crates.io/crates/crossbeam-epoch) |
| Source record ids | crates_io-2220ad9f8faa0e |
...
For a systems engineer, crossbeam-epoch belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.20 | 2026-07-06T18:09:38.968039Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-2220ad9f8faa0e` from `crates_io` as `registry_expansion`
