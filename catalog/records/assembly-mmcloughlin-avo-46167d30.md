...
| Canonical URL | [https://github.com/mmcloughlin/avo](https://github.com/mmcloughlin/avo) |
| Source record ids | github_search_assembly-06519c9406c04c |
...
For a systems engineer, mmcloughlin/avo belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.0 | 2024-01-07T21:34:13Z | [https://api.github.com/repos/mmcloughlin/avo/releases/latest](https://api.github.com/repos/mmcloughlin/avo/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mmcloughlin/avo/releases/latest` at `2026-09-01T10:25:50+00:00`.
...
- `github_search_assembly-06519c9406c04c` from `github_search_assembly` as `registry_expansion`
