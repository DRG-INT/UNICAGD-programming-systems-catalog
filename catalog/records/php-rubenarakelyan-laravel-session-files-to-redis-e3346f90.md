...
<!-- canonical: https://packagist.org/packages/rubenarakelyan/laravel-session-files-to-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/rubenarakelyan/laravel-session-files-to-redis](https://packagist.org/packages/rubenarakelyan/laravel-session-files-to-redis) |
| Source record ids | packagist_search-afafb9e0ab03b2 |
...
For a systems engineer, rubenarakelyan/laravel-session-files-to-redis belongs in the PHP inventory
...
- `packagist_search-afafb9e0ab03b2` from `packagist_search` as `registry_expansion`
