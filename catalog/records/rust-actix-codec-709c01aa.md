...
<!-- canonical: https://crates.io/crates/actix-codec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-codec](https://crates.io/crates/actix-codec) |
| Source record ids | crates_io-707a11450aee6f |
...
For a systems engineer, actix-codec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.4 | 2026-09-12T17:27:06.516100Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-12T18:20:16+00:00`.
...
- `crates_io-707a11450aee6f` from `crates_io` as `registry_expansion`
