...
| Source type | image_audio_dsp |
| Verification | unverified_seed |
| Canonical URL | unknown |
| Source record ids | corpus-45d26f5acd06e7 |

## System Engineer Summary

pydub is tracked as an image audio dsp record in the Python branch. The source did not provide a
...
For a systems engineer, pydub belongs in the Python inventory as part of ecosystem capability
...
- `corpus-45d26f5acd06e7` from `master_json` as `image_audio_dsp`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| librosa | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-librosa-17912c2c.md) |
| OpenCV-Python | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-opencv-python-3327f46c.md) |
| Pillow | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-pillow-db62c338.md) |
| scikit-image | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-scikit-image-4ed3cf49.md) |
