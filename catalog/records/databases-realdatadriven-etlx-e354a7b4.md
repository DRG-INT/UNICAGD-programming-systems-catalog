...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/realdatadriven/etlx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/realdatadriven/etlx](https://github.com/realdatadriven/etlx) |
| Source record ids | github_search_databases-9e5651187c10db |

## System Engineer Summary

ETL / ELT / Reverse ETL Framework powered by DuckDB, designed to seamlessly integrate and process
data from diverse sources. It leverages Markdown as a configuration medium, where YAML blocks define
metadata for each data source, and embedded SQL blocks specify the extraction, transformation, and
loading logic.

## Operational Role

For a systems engineer, realdatadriven/etlx belongs in the Databases inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T19:50:04Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9e5651187c10db` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/amoro | Formatter | [open](databases-apache-amoro-d2a3a509.md) |
| cube2222/octosql | Formatter | [open](databases-cube2222-octosql-cab58556.md) |
| mabel-dev/opteryx | Formatter | [open](databases-mabel-dev-opteryx-2e638eaa.md) |
| shunfei/indexr | Formatter | [open](databases-shunfei-indexr-0f058165.md) |
| suninformation/ymate-platform-v2 | Formatter | [open](databases-suninformation-ymate-platform-v2-2a0f15f5.md) |
| thulab/tsfile | Formatter | [open](databases-thulab-tsfile-977bb312.md) |
