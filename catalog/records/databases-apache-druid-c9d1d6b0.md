...
| Canonical URL | [https://github.com/apache/druid](https://github.com/apache/druid) |
| Source record ids | curated_database_systems-4b358aa60d6cd5 |

## System Engineer Summary

Real-time analytics database for event streams and OLAP workloads.

## Operational Role

For a systems engineer, Apache Druid belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | druid-37.0.0 | 2026-05-08T22:00:21Z | [https://api.github.com/repos/apache/druid/releases/latest](https://api.github.com/repos/apache/druid/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apache/druid/releases/latest` at `2026-09-01T07:24:48+00:00`.
...
- `curated_database_systems-4b358aa60d6cd5` from `curated_database_systems` as `registry_expansion`
