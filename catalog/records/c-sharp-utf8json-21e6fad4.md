...
<!-- canonical: https://www.nuget.org/packages/Utf8Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Utf8Json](https://www.nuget.org/packages/Utf8Json) |
| Source record ids | nuget_search-34119143b80e75 |
...
For a systems engineer, Utf8Json belongs in the C-Sharp inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.7 | 2018-01-30T02:52:04.57+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/utf8json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/utf8json/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/utf8json/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-34119143b80e75` from `nuget_search` as `registry_expansion`
