...
<!-- canonical: https://hackage.haskell.org/package/memory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/memory](https://hackage.haskell.org/package/memory) |
| Source record ids | hackage_top_downloads-f13dfcfd243d63 |
...
For a systems engineer, memory belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.0 | 2022-09-05T01:54:53Z | [https://hackage.haskell.org/package/memory](https://hackage.haskell.org/package/memory) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/memory` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-f13dfcfd243d63` from `hackage_top_downloads` as `registry_expansion`
