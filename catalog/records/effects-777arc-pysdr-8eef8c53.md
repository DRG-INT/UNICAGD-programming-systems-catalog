...
| Source record ids | github_search_effects-350640830d45f4 |
...
For a systems engineer, 777arc/PySDR belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:56:23Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-350640830d45f4` from `github_search_effects` as `registry_expansion`
