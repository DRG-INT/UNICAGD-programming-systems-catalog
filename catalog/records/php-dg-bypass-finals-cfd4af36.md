...
<!-- canonical: https://packagist.org/packages/dg/bypass-finals -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/dg/bypass-finals](https://packagist.org/packages/dg/bypass-finals) |
| Source record ids | packagist_search-8b6d4fb6cd9002 |
...
For a systems engineer, dg/bypass-finals belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-8b6d4fb6cd9002` from `packagist_search` as `registry_expansion`
