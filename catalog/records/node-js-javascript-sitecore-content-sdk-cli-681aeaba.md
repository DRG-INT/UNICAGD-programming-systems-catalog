...
[Catalog index](../index.md) · [Language: Node.js/JavaScript](../by-language/node-js-javascript.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/@sitecore-content-sdk/cli -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-09-10T08:30:32.781Z | [https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-10T10:20:48+00:00`.
...
- `npm_registry-8178cf4bb1adbd` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| @accio-ai/cli | Cli | [open](node-js-javascript-accio-ai-cli-98437ac9.md) |
| @alwaysmeticulous/cli | Cli | [open](node-js-javascript-alwaysmeticulous-cli-4c42a276.md) |
| @amplitude/ampli | Cli | [open](node-js-javascript-amplitude-ampli-69d1d68a.md) |
| @angular-devkit/schematics-cli | Cli | [open](node-js-javascript-angular-devkit-schematics-cli-932336ca.md) |
| @angular/cli | Cli | [open](node-js-javascript-angular-cli-8e368136.md) |
| @apla/clickhouse | Cli | [open](node-js-javascript-apla-clickhouse-1f13f09f.md) |
| @asciidoctor/cli | Cli | [open](node-js-javascript-asciidoctor-cli-118e50d8.md) |
| @aws-amplify/cli | Cli | [open](node-js-javascript-aws-amplify-cli-3d73264c.md) |
