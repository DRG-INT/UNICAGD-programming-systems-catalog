...
<!-- canonical: https://github.com/asrikanth777/columbiaSpaceShuttle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asrikanth777/columbiaSpaceShuttle](https://github.com/asrikanth777/columbiaSpaceShuttle) |
| Source record ids | github_search_space_shuttles-72385f52c0b192 |

## System Engineer Summary

Inspired by astronaut Rick Husband, this project is a Python-based simulation of the Columbia Space
Shuttle's journey to orbit.

## Operational Role

For a systems engineer, asrikanth777/columbiaSpaceShuttle belongs in the Space Shuttles inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-30T02:42:11Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-72385f52c0b192` from `github_search_space_shuttles` as `registry_expansion`
