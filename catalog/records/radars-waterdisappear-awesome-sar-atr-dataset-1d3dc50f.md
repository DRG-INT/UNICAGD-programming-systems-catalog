# waterdisappear/Awesome-SAR-ATR-Dataset
...
<!-- canonical: https://github.com/waterdisappear/Awesome-SAR-ATR-Dataset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/waterdisappear/Awesome-SAR-ATR-Dataset](https://github.com/waterdisappear/Awesome-SAR-ATR-Dataset) |
| Source record ids | github_search_radars-ae66795cd8d6b8 |

## System Engineer Summary

A brief introduction to the SAR ATR dataset from the 1990s to the 2020s

## Operational Role

For a systems engineer, waterdisappear/Awesome-SAR-ATR-Dataset belongs in the Radars inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-05T03:31:36Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-ae66795cd8d6b8` from `github_search_radars` as `registry_expansion`
