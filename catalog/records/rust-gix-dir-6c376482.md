...
| Canonical URL | [https://crates.io/crates/gix-dir](https://crates.io/crates/gix-dir) |
| Source record ids | crates_io-dc5153cd1bb4b4 |
...
For a systems engineer, gix-dir belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.1 | 2026-08-24T13:56:48.210718Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-dc5153cd1bb4b4` from `crates_io` as `registry_expansion`
