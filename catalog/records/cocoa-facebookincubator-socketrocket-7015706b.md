...
<!-- canonical: https://github.com/facebookincubator/SocketRocket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/facebookincubator/SocketRocket](https://github.com/facebookincubator/SocketRocket) |
| Source record ids | github_search_cocoa-4a5887c792bc44 |
...
For a systems engineer, facebookincubator/SocketRocket belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-04T01:29:19Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-4a5887c792bc44` from `github_search_cocoa` as `registry_expansion`
