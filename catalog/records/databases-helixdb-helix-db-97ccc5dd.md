...
<!-- canonical: https://github.com/HelixDB/helix-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HelixDB/helix-db](https://github.com/HelixDB/helix-db) |
| Source record ids | github_search_databases-33a85e15e137c3 |

## System Engineer Summary

HelixDB is an OLTP graph database with native vector and full-text search built in Rust on Object
Storage.

## Operational Role

For a systems engineer, HelixDB/helix-db belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T10:48:31Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-33a85e15e137c3` from `github_search_databases` as `registry_expansion`
