...
<!-- canonical: https://github.com/lapfelix/BluetoothConnector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lapfelix/BluetoothConnector](https://github.com/lapfelix/BluetoothConnector) |
| Source record ids | github_search_swift-253d6e8aadd843 |

## System Engineer Summary

Simple macOS CLI to connect/disconnect a Bluetooth device. Useful for AirPods or other Bluetooth
headphones.

## Operational Role

For a systems engineer, lapfelix/BluetoothConnector belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-19T00:02:39Z | gh search repos topic:swift-package stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-253d6e8aadd843` from `github_search_swift` as `registry_expansion`
