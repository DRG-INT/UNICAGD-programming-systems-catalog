...
<!-- canonical: https://www.nuget.org/packages/Microsoft.Extensions.Http.Polly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Extensions.Http.Polly](https://www.nuget.org/packages/Microsoft.Extensions.Http.Polly) |
| Source record ids | nuget_search-98f15feeaa4b86 |

## System Engineer Summary

The HttpClient factory is a pattern for configuring and retrieving named HttpClients in a composable
way. This package integrates IHttpClientFactory with the Polly library, to add transient-fault-
handling and resiliency through fluent policies such as Retry, Circuit Breaker, Timeout, Bulkhead
Isolation, and Fallback. This package was built from the source code at

## Operational Role

For a systems engineer, Microsoft.Extensions.Http.Polly belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.11 | 2026-08-11T16:54:33.6+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.polly/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.polly/index.json) |  |
| preview | known | 11.0.0-preview.7.26381.103 | 2026-08-11T16:20:09.63+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.polly/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.polly/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT; https://www.nuget.org/packages/Microsoft.Extensions.Http.Polly/10.0.11/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.http.polly/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-98f15feeaa4b86` from `nuget_search` as `registry_expansion`
