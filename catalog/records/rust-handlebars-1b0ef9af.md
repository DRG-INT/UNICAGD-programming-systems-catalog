...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Templating](../by-category/templating.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/handlebars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/handlebars](https://crates.io/crates/handlebars) |
| Source record ids | crates_io-7ae9ed66dc745c |
...
For a systems engineer, handlebars belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.4.4 | 2026-08-12T04:01:58.673164Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-7ae9ed66dc745c` from `crates_io` as `registry_expansion`
