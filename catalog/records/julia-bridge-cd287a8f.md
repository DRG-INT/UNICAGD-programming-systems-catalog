...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/Bridge](https://github.com/JuliaRegistries/General/tree/master/B/Bridge) |
| Source record ids | julia_general-ac24e50e253142 |

## System Engineer Summary

Julia package registered in General at B/Bridge.

## Operational Role

For a systems engineer, Bridge belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/Bridge", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-ac24e50e253142` from `julia_general` as `registry_expansion`
...
| BridgeSDEInference | Interop Bindings | [open](julia-bridgesdeinference-373877c3.md) |
