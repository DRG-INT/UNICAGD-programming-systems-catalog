...
<!-- canonical: https://github.com/tcgoetz/GarminDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tcgoetz/GarminDB](https://github.com/tcgoetz/GarminDB) |
| Source record ids | github_search_databases-0f321f2032a62d |

## System Engineer Summary

Download and parse data from Garmin Connect or a Garmin watch, FitBit CSV, and MS Health CSV files
into and analyze data in Sqlite serverless databases with Jupyter notebooks.

## Operational Role

For a systems engineer, tcgoetz/GarminDB belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:27:25Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0f321f2032a62d` from `github_search_databases` as `registry_expansion`
