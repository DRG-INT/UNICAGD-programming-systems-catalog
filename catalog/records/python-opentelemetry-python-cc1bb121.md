...
[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | corpus-ccec75653a1011 |

## System Engineer Summary

OpenTelemetry Python is tracked as a logging observability record in the Python branch. The source
...
For a systems engineer, OpenTelemetry Python belongs in the Python inventory as part of diagnostics,
...
- `corpus-ccec75653a1011` from `master_json` as `logging_observability`
...
| Name | Category | Page |
| --- | --- | --- |
| a13n-logging | Logging Observability | [open](python-a13n-logging-04c73f7f.md) |
| a8logging | Logging Observability | [open](python-a8logging-075ce2a6.md) |
| adafruit-circuitpython-logging | Logging Observability | [open](python-adafruit-circuitpython-logging-6c87bf98.md) |
| adb-logging | Logging Observability | [open](python-adb-logging-72cb37b0.md) |
| logging | Logging Observability | [open](python-logging-ff9ef028.md) |
| loguru | Logging Observability | [open](python-loguru-dd1fa5ad.md) |
| Sentry SDK | Logging Observability | [open](python-sentry-sdk-f80cee5b.md) |
| structlog | Logging Observability | [open](python-structlog-1b77b86e.md) |
