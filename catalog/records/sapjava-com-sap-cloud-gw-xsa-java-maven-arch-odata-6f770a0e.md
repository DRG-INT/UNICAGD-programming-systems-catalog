# com.sap.cloud.gw.xsa:java-maven-arch-odata
...
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.gw.xsa/java-maven-arch-odata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.gw.xsa/java-maven-arch-odata](https://central.sonatype.com/artifact/com.sap.cloud.gw.xsa/java-maven-arch-odata) |
| Source record ids | maven_central_search-6a396560b5df48 |
...
For a systems engineer, com.sap.cloud.gw.xsa:java-maven-arch-odata belongs in the SAPJava inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.8 | 2019-09-20T13:32:17+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20odata%20java&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20odata%20java&rows=100&wt=json) |  |
...
- Latest stable metadata was observed from `https://search.maven.org/solrsearch/select?q=sap%20odata%20java&rows=100&wt=json` at `2026-09-01T07:21:13+00:00`.
...
| --- | --- | --- | --- |
| maven_central_search | registry-derived | 2026-09-05 | `{"kind": "maven_central_search", "query": "sap odata java", "retrieved": "2026-09-05", "status": "registry-derived"}` |
...
- `maven_central_search-6a396560b5df48` from `maven_central_search` as `registry_expansion`
