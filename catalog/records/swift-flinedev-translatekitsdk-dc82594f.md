...
<!-- canonical: https://github.com/FlineDev/TranslateKitSDK -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FlineDev/TranslateKitSDK](https://github.com/FlineDev/TranslateKitSDK) |
| Source record ids | github_search_swift-35633a5c0c807b |

## System Engineer Summary

SF Symbols for Texts: 2000+ built-in translations in 40 languages + semantic localization key macro
for Swift devs

## Operational Role

For a systems engineer, FlineDev/TranslateKitSDK belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2025-09-01T13:11:49Z | [https://api.github.com/repos/FlineDev/TranslateKitSDK/releases/latest](https://api.github.com/repos/FlineDev/TranslateKitSDK/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/FlineDev/TranslateKitSDK/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-35633a5c0c807b` from `github_search_swift` as `registry_expansion`
