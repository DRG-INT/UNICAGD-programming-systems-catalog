...
<!-- canonical: https://cran.r-project.org/web/packages/AISanalyze/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AISanalyze/index.html](https://cran.r-project.org/web/packages/AISanalyze/index.html) |
| Source record ids | cran_packages_by_date-0c2f1566403e02 |

## System Engineer Summary

Processing and Analyzing AIS Vessel Tracking Data

## Operational Role

For a systems engineer, AISanalyze belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.2 | 2026-08-26 19:40:01 UTC | [https://cran.r-project.org/web/packages/AISanalyze/DESCRIPTION](https://cran.r-project.org/web/packages/AISanalyze/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AISanalyze/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0c2f1566403e02` from `cran_packages_by_date` as `registry_expansion`
