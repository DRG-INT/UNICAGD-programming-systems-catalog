...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mikro-orm/mikro-orm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mikro-orm/mikro-orm](https://github.com/mikro-orm/mikro-orm) |
| Source record ids | github_search_databases-9ab9a6817d29ec |

## System Engineer Summary

TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns. Supports
MongoDB, MySQL, MariaDB, MS SQL Server, PostgreSQL and SQLite/libSQL databases.

## Operational Role

For a systems engineer, mikro-orm/mikro-orm belongs in the Databases inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T11:30:19Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9ab9a6817d29ec` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| prisma/orm | Type Checker | [open](databases-prisma-orm-d7875b44.md) |
| rehacktive/caffeine | Type Checker | [open](databases-rehacktive-caffeine-7ba154b8.md) |
| sequelize/sequelize | Type Checker | [open](databases-sequelize-sequelize-980d8352.md) |
| strapi/strapi | Type Checker | [open](databases-strapi-strapi-16f55c01.md) |
| typeorm/typeorm | Type Checker | [open](databases-typeorm-typeorm-5d6b5459.md) |
