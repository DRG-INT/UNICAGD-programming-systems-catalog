...
<!-- canonical: https://cran.r-project.org/web/packages/genpca/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/genpca/index.html](https://cran.r-project.org/web/packages/genpca/index.html) |
| Source record ids | cran_packages_by_date-28a81b6947e29b |
...
For a systems engineer, genpca belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 10:50:19 UTC | [https://cran.r-project.org/web/packages/genpca/DESCRIPTION](https://cran.r-project.org/web/packages/genpca/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/genpca/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-28a81b6947e29b` from `cran_packages_by_date` as `registry_expansion`
