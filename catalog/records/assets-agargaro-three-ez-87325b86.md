...
[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/agargaro/three.ez -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/agargaro/three.ez](https://github.com/agargaro/three.ez) |
| Source record ids | github_search_assets-2e0bc1afa465bd |

## System Engineer Summary

Simplify three.js development, including events, drag & drop, binding, focus management, smart
rendering, tweening and more.

## Operational Role

For a systems engineer, agargaro/three.ez belongs in the Assets inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-02T09:30:59Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-2e0bc1afa465bd` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Faithful-Resource-Pack/Faithful-Dungeons-32x | Ffi Bindings | [open](assets-faithful-resource-pack-faithful-dungeons-32x-ea17a09a.md) |
| perceivelab/surfacenet | Ffi Bindings | [open](assets-perceivelab-surfacenet-f1457206.md) |
