...
<!-- canonical: https://luarocks.org/modules/djfdyuruiry/cnc-nco -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/djfdyuruiry/cnc-nco](https://luarocks.org/modules/djfdyuruiry/cnc-nco) |
| Source record ids | luarocks_root_manifest-a1b8f1d4e7cf98 |
...
For a systems engineer, cnc-nco belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a1b8f1d4e7cf98` from `luarocks_root_manifest` as `registry_expansion`
