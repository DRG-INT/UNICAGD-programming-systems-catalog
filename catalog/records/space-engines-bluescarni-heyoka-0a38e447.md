...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bluescarni/heyoka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bluescarni/heyoka](https://github.com/bluescarni/heyoka) |
| Source record ids | github_search_space_engines-40af3a1e85985f |
...
For a systems engineer, bluescarni/heyoka belongs in the Space Engines inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T11:50:57Z | gh search repos topic:astrodynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:astrodynamics stars:>20", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_space_engines-40af3a1e85985f` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bluescarni/heyoka.py | Compiler | [open](space-engines-bluescarni-heyoka-py-a173cf06.md) |
