...
<!-- canonical: https://github.com/ungoldman/himawari-bg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ungoldman/himawari-bg](https://github.com/ungoldman/himawari-bg) |
| Source record ids | github_search_satcom_satellites-8719c685406797 |
...
For a systems engineer, ungoldman/himawari-bg belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.2 | 2023-01-20T23:31:35Z | [https://api.github.com/repos/ungoldman/himawari-bg/releases/latest](https://api.github.com/repos/ungoldman/himawari-bg/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ungoldman/himawari-bg/releases/latest` at `2026-09-01T08:26:38+00:00`.
...
- `github_search_satcom_satellites-8719c685406797` from `github_search_satcom_satellites` as `registry_expansion`
