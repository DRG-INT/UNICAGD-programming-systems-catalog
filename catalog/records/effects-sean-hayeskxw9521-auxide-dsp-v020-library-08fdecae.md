# sean-hayeskxw9521/auxide-dsp-v020-library
...
<!-- canonical: https://github.com/sean-hayeskxw9521/auxide-dsp-v020-library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sean-hayeskxw9521/auxide-dsp-v020-library](https://github.com/sean-hayeskxw9521/auxide-dsp-v020-library) |
| Source record ids | github_search_effects-7199b5d14d2311 |

## System Engineer Summary

Auxide DSP v0.2.0 is a Rust library for building real-time audio synthesis and processing graphs
with reusable oscillators, filters, effects, envelopes, modulators, and utility nodes.

## Operational Role

For a systems engineer, sean-hayeskxw9521/auxide-dsp-v020-library belongs in the Effects inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:26:03Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-7199b5d14d2311` from `github_search_effects` as `registry_expansion`
