...
| Canonical URL | [https://github.com/ARM-DOE/pyart](https://github.com/ARM-DOE/pyart) |
| Source record ids | curated_language_routes-451d3b062ede77 |

## System Engineer Summary

Python ARM Radar Toolkit for weather radar data, gridding, correction, visualization, and analysis.

## Operational Role

For a systems engineer, Py-ART belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.2.5 | 2026-07-07T01:42:06Z | [https://api.github.com/repos/ARM-DOE/pyart/releases/latest](https://api.github.com/repos/ARM-DOE/pyart/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ARM-DOE/pyart/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-451d3b062ede77` from `curated_language_routes` as `registry_expansion`
