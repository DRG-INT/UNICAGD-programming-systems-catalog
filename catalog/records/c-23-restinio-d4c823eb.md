...
| Source record ids | corpus-9b4fccf77dc4d5 |

## System Engineer Summary

Restinio is tracked as a networking http record in the C++23 branch. The source did not provide a
...
For a systems engineer, Restinio belongs in the C++23 inventory as part of service communication,
...
- `corpus-9b4fccf77dc4d5` from `master_json` as `networking_http`
