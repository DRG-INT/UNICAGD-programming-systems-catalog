...
<!-- canonical: https://crates.io/crates/maybe-async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/maybe-async](https://crates.io/crates/maybe-async) |
| Source record ids | crates_io-807da6d5e6637d |
...
For a systems engineer, maybe-async belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2026-05-15T06:13:41.215606Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; https://www.nuget.org/packages/JsonConverter.Newtonsoft.Json/0.13.0/license |
...
- `crates_io-807da6d5e6637d` from `crates_io` as `registry_expansion`
