...
<!-- canonical: https://pypi.org/project/abstract-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abstract-server/](https://pypi.org/project/abstract-server/) |
| Source record ids | pypi_simple-b989b5f1768fe5 |

## System Engineer Summary

abstract-server is tracked as a web framework record in the Python branch. The source did not
...
For a systems engineer, abstract-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0.5 | 2023-12-01T07:10:36.630886Z | [https://pypi.org/pypi/abstract-server/json](https://pypi.org/pypi/abstract-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abstract-server/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-b989b5f1768fe5` from `pypi_simple` as `registry_expansion`
