...
<!-- canonical: https://cran.r-project.org/web/packages/traj/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/traj/index.html](https://cran.r-project.org/web/packages/traj/index.html) |
| Source record ids | cran_packages_by_date-035f8b8bf2c7cc |
...
For a systems engineer, traj belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-09-08 18:40:03 UTC | [https://cran.r-project.org/web/packages/traj/DESCRIPTION](https://cran.r-project.org/web/packages/traj/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/traj/DESCRIPTION` at `2026-09-08T20:19:48+00:00`.
...
- `cran_packages_by_date-035f8b8bf2c7cc` from `cran_packages_by_date` as `registry_expansion`
