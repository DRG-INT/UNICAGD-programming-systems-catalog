# ericfish/EOS-Dev-Book

## Navigation

[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ericfish/EOS-Dev-Book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ericfish/EOS-Dev-Book](https://github.com/ericfish/EOS-Dev-Book) |
| Source record ids | github_search_webassembly-728048828849d5 |

## System Engineer Summary

ericfish/EOS-Dev-Book is tracked as a language specification record in the WebAssembly branch. The
...
For a systems engineer, ericfish/EOS-Dev-Book belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-29T07:11:05Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:WebAssembly stars:>50", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_webassembly-728048828849d5` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acieroid/wassail | Language Specification | [open](webassembly-acieroid-wassail-530baf4d.md) |
| appcypher/awesome-wasm-langs | Language Specification | [open](webassembly-appcypher-awesome-wasm-langs-71e918d7.md) |
| as2d/as2d | Language Specification | [open](webassembly-as2d-as2d-2db5a0c4.md) |
| Assembleash - WebAssembly and Typescript-like languages playground | Language Specification | [open](webassembly-assembleash-webassembly-and-typescript-like-languages-playground-980d8d0a.md) |
| AssemblyScript/assemblyscript | Language Specification | [open](webassembly-assemblyscript-assemblyscript-378a4954.md) |
| AssemblyScript/examples | Language Specification | [open](webassembly-assemblyscript-examples-43e3dc9c.md) |
| ASSERT-KTH/slumps | Language Specification | [open](webassembly-assert-kth-slumps-03fa2e3c.md) |
| athre0z/wasm | Language Specification | [open](webassembly-athre0z-wasm-51efa5d4.md) |
