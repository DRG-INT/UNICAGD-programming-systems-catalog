...
| Canonical URL | [https://luarocks.org/modules/fsantanna/iuplua-examples](https://luarocks.org/modules/fsantanna/iuplua-examples) |
| Source record ids | luarocks_root_manifest-a2038337f442e0 |

## System Engineer Summary

IupLua examples from the official IUP documentation

## Operational Role

For a systems engineer, iuplua-examples belongs in the Lua family inventory as part of operator
...
- `luarocks_root_manifest-a2038337f442e0` from `luarocks_root_manifest` as `registry_expansion`
