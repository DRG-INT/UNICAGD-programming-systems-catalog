...
<!-- canonical: https://github.com/nektos/act -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nektos/act](https://github.com/nektos/act) |
| Source record ids | github_search_go-765820d78997ea |
...
For a systems engineer, nektos/act belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T22:50:11Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-765820d78997ea` from `github_search_go` as `registry_expansion`
