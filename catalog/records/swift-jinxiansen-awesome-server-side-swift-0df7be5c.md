...
<!-- canonical: https://github.com/Jinxiansen/Awesome-Server-Side-Swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jinxiansen/Awesome-Server-Side-Swift](https://github.com/Jinxiansen/Awesome-Server-Side-Swift) |
| Source record ids | github_search_swift-3d27ed84907802 |
...
For a systems engineer, Jinxiansen/Awesome-Server-Side-Swift belongs in the Swift inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-24T12:35:03Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-3d27ed84907802` from `github_search_swift` as `registry_expansion`
