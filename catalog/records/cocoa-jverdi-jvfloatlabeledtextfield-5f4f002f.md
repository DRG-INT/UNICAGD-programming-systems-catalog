...
<!-- canonical: https://github.com/jverdi/JVFloatLabeledTextField -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jverdi/JVFloatLabeledTextField](https://github.com/jverdi/JVFloatLabeledTextField) |
| Source record ids | github_search_cocoa-f2226796e6f074 |
...
For a systems engineer, jverdi/JVFloatLabeledTextField belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-17T14:38:05Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-f2226796e6f074` from `github_search_cocoa` as `registry_expansion`
