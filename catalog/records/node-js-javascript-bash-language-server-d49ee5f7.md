...
<!-- canonical: https://www.npmjs.com/package/bash-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/bash-language-server](https://www.npmjs.com/package/bash-language-server) |
| Source record ids | npm_registry-1671360903782f |
...
For a systems engineer, bash-language-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.6.0 | 2025-04-13T21:25:27.098Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-1671360903782f` from `npm_registry` as `registry_expansion`
