...
<!-- canonical: https://github.com/docker/login-action -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/docker/login-action](https://github.com/docker/login-action) |
| Source record ids | github_search_catalogs-a5aaaafce5f0f3 |
...
For a systems engineer, docker/login-action belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:23:52Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-a5aaaafce5f0f3` from `github_search_catalogs` as `registry_expansion`
