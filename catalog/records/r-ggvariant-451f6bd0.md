...
<!-- canonical: https://cran.r-project.org/web/packages/ggvariant/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggvariant/index.html](https://cran.r-project.org/web/packages/ggvariant/index.html) |
| Source record ids | cran_packages_by_date-767dc4c79a6c28 |
...
For a systems engineer, ggvariant belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 05:43:32 UTC | [https://cran.r-project.org/web/packages/ggvariant/DESCRIPTION](https://cran.r-project.org/web/packages/ggvariant/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggvariant/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-767dc4c79a6c28` from `cran_packages_by_date` as `registry_expansion`
