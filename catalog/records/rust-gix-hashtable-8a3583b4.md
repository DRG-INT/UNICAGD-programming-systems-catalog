...
| Canonical URL | [https://crates.io/crates/gix-hashtable](https://crates.io/crates/gix-hashtable) |
| Source record ids | crates_io-ea716dcf08e080 |
...
For a systems engineer, gix-hashtable belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2026-07-23T13:14:52.044966Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-ea716dcf08e080` from `crates_io` as `registry_expansion`
