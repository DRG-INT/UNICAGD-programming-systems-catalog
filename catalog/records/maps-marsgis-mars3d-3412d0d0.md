...
<!-- canonical: https://github.com/marsgis/mars3d -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marsgis/mars3d](https://github.com/marsgis/mars3d) |
| Source record ids | github_search_maps-5a0e5c5ec7f76f |
...
For a systems engineer, marsgis/mars3d belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T12:02:08Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5a0e5c5ec7f76f` from `github_search_maps` as `registry_expansion`
