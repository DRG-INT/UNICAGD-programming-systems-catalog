...
<!-- canonical: https://github.com/Fadi002/de4py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Fadi002/de4py](https://github.com/Fadi002/de4py) |
| Source record ids | github_search_engines-1998b5e7207f07 |
...
For a systems engineer, Fadi002/de4py belongs in the Engines inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T12:28:28Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-1998b5e7207f07` from `github_search_engines` as `registry_expansion`
