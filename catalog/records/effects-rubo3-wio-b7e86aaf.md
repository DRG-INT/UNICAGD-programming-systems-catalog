...
<!-- canonical: https://github.com/Rubo3/wio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Rubo3/wio](https://github.com/Rubo3/wio) |
| Source record ids | github_search_effects-fc220606758743 |
...
For a systems engineer, Rubo3/wio belongs in the Effects inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-30T21:34:24Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-fc220606758743` from `github_search_effects` as `registry_expansion`
