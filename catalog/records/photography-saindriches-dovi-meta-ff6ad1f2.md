...
<!-- canonical: https://github.com/saindriches/dovi_meta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/saindriches/dovi_meta](https://github.com/saindriches/dovi_meta) |
| Source record ids | github_search_photography-829eca145d2304 |

## System Engineer Summary

dovi_meta is a CLI tool for creating Dolby Vision XML metadata from an encoded deliverable with
binary metadata.

## Operational Role

For a systems engineer, saindriches/dovi_meta belongs in the Photography inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-23T02:07:50Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-829eca145d2304` from `github_search_photography` as `registry_expansion`
