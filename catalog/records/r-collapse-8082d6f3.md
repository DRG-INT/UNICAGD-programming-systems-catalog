...
<!-- canonical: https://cran.r-project.org/web/packages/collapse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/collapse/index.html](https://cran.r-project.org/web/packages/collapse/index.html) |
| Source record ids | cran_packages_by_date-72418785d1dac5 |
...
For a systems engineer, collapse belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.8 | 2026-08-30 16:00:02 UTC | [https://cran.r-project.org/web/packages/collapse/DESCRIPTION](https://cran.r-project.org/web/packages/collapse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/collapse/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-72418785d1dac5` from `cran_packages_by_date` as `registry_expansion`
