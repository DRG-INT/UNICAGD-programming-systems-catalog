...
| Canonical URL | [https://luarocks.org/modules/shakna-israel/f.lua](https://luarocks.org/modules/shakna-israel/f.lua) |
| Source record ids | luarocks_root_manifest-692ed2f701a60b |
...
For a systems engineer, f.lua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-692ed2f701a60b` from `luarocks_root_manifest` as `registry_expansion`
