...
<!-- canonical: https://hackage.haskell.org/package/trifecta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/trifecta](https://hackage.haskell.org/package/trifecta) |
| Source record ids | hackage_top_downloads-4b3f2fcebb16d9 |

## System Engineer Summary

Hackage package with 195 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, trifecta belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.4 | 2024-02-07T15:52:11Z | [https://hackage.haskell.org/package/trifecta](https://hackage.haskell.org/package/trifecta) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/trifecta` at `2026-09-01T07:24:04+00:00`.
...
- `hackage_top_downloads-4b3f2fcebb16d9` from `hackage_top_downloads` as `registry_expansion`
