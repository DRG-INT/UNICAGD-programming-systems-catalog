...
| Source record ids | github_search_video-d2f172509ea944 |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2020-10-08T11:54:23Z | [https://api.github.com/repos/leandromoreira/ffmpeg-libav-tutorial/releases/latest](https://api.github.com/repos/leandromoreira/ffmpeg-libav-tutorial/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/leandromoreira/ffmpeg-libav-tutorial/releases/latest` at `2026-09-01T09:23:24+00:00`.
...
- `github_search_video-d2f172509ea944` from `github_search_video` as `registry_expansion`
