...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bogwi/sarpro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bogwi/sarpro](https://github.com/bogwi/sarpro) |
| Source record ids | github_search_radars-997fa4c4749f10 |

## System Engineer Summary

Blazing-fast Sentinel‑1 Synthetic Aperture Radar (SAR) GRD to GeoTIFF/JPEG processor with CLI, GUI,
and Rust API — autoscaling, synthetic RGB, and batch workflows.

## Operational Role

For a systems engineer, bogwi/sarpro belongs in the Radars inventory as part of language tooling,
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:synthetic-aperture-radar stars:>10", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_radars-997fa4c4749f10` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0xastro/fmcw-RADAR | Parser Lexer Ast | [open](radars-0xastro-fmcw-radar-5329543c.md) |
| azavea/raster-vision | Parser Lexer Ast | [open](radars-azavea-raster-vision-6beec97c.md) |
| chrieke/InstanceSegmentation_Sentinel2 | Parser Lexer Ast | [open](radars-chrieke-instancesegmentation-sentinel2-c236a634.md) |
| DetectionTeamUCAS/R2CNN_Faster-RCNN_Tensorflow | Parser Lexer Ast | [open](radars-detectionteamucas-r2cnn-faster-rcnn-tensorflow-c3697349.md) |
| gokriznastic/HybridSN | Parser Lexer Ast | [open](radars-gokriznastic-hybridsn-cb76b62d.md) |
| jasonmanesis/Ship-Detection-on-Remote-Sensing-Synthetic-Aperture-Radar-Data | Parser Lexer Ast | [open](radars-jasonmanesis-ship-detection-on-remote-sensing-synthetic-aperture-radar-data-46a09a32.md) |
| kvos/CoastSat | Parser Lexer Ast | [open](radars-kvos-coastsat-0bb6749e.md) |
| lexogrine/hud-manager | Parser Lexer Ast | [open](radars-lexogrine-hud-manager-66c5b100.md) |
