...
<!-- canonical: https://gitlab.com/kargo-ci/kubernetes-sigs-kubespray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/kargo-ci/kubernetes-sigs-kubespray](https://gitlab.com/kargo-ci/kubernetes-sigs-kubespray) |
| Source record ids | gitlab_projects_api-62aacdc440ffdd |
...
For a systems engineer, kargo-ci/kubernetes-sigs-kubespray belongs in the Repository Workplaces
...
- `gitlab_projects_api-62aacdc440ffdd` from `gitlab_projects_api` as `registry_expansion`
