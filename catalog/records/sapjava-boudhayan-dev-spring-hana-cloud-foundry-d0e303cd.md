# boudhayan-dev/spring-hana-cloud-foundry
...
<!-- canonical: https://github.com/boudhayan-dev/spring-hana-cloud-foundry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/boudhayan-dev/spring-hana-cloud-foundry](https://github.com/boudhayan-dev/spring-hana-cloud-foundry) |
| Source record ids | github_search_sapjava-60091a36eda45c |
...
For a systems engineer, boudhayan-dev/spring-hana-cloud-foundry belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-07-22T13:58:28Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-60091a36eda45c` from `github_search_sapjava` as `registry_expansion`
