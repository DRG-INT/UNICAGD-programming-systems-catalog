...
<!-- canonical: https://github.com/maplibre/maplibre-gl-geocoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/maplibre-gl-geocoder](https://github.com/maplibre/maplibre-gl-geocoder) |
| Source record ids | github_search_maps-256280e4dd89a6 |

## System Engineer Summary

Geocoding component for MapLibre

## Operational Role

For a systems engineer, maplibre/maplibre-gl-geocoder belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.9.4 | 2025-12-27T11:56:31Z | [https://api.github.com/repos/maplibre/maplibre-gl-geocoder/releases/latest](https://api.github.com/repos/maplibre/maplibre-gl-geocoder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/maplibre/maplibre-gl-geocoder/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-256280e4dd89a6` from `github_search_maps` as `registry_expansion`
