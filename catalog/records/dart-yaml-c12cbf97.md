...
<!-- canonical: https://pub.dev/packages/yaml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/yaml](https://pub.dev/packages/yaml) |
| Source record ids | pub_dev-382d0743acab30 |
...
For a systems engineer, yaml belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.4 | 2026-08-28T20:42:59.265928Z | [https://pub.dev/api/packages/yaml](https://pub.dev/api/packages/yaml) |  |
| preview | known | 3.0.0-nullsafety.0 | 2020-11-17T20:52:10.940468Z | [https://pub.dev/api/packages/yaml](https://pub.dev/api/packages/yaml) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/yaml` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-382d0743acab30` from `pub_dev` as `registry_expansion`
