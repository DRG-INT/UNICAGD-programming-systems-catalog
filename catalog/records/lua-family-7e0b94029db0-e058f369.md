...
<!-- canonical: https://luarocks.org/modules/maxrio87/7e0b94029db0 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/maxrio87/7e0b94029db0](https://luarocks.org/modules/maxrio87/7e0b94029db0) |
| Source record ids | luarocks_root_manifest-f02aaf945d81e8 |

## System Engineer Summary

7e0b94029db0 is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, 7e0b94029db0 belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f02aaf945d81e8` from `luarocks_root_manifest` as `registry_expansion`
