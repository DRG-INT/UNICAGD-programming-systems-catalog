...
<!-- canonical: https://crates.io/crates/indenter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/indenter](https://crates.io/crates/indenter) |
| Source record ids | crates_io-3c4b361050be91 |
...
For a systems engineer, indenter belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.4 | 2025-08-06T20:29:35.416164Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-3c4b361050be91` from `crates_io` as `registry_expansion`
