...
<!-- canonical: https://hackage.haskell.org/package/aura -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/aura](https://hackage.haskell.org/package/aura) |
| Source record ids | hackage_top_downloads-ced5a6260ac19e |
...
For a systems engineer, aura belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.10 | 2024-07-16T21:43:42Z | [https://hackage.haskell.org/package/aura](https://hackage.haskell.org/package/aura) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/aura` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-ced5a6260ac19e` from `hackage_top_downloads` as `registry_expansion`
