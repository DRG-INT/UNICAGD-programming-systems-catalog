...
<!-- canonical: https://pub.dev/packages/flutter_carousel_widget -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_carousel_widget](https://pub.dev/packages/flutter_carousel_widget) |
| Source record ids | pub_dev-c5e4c310535964 |

## System Engineer Summary

A customizable Flutter carousel widget with infinite scrolling, auto-scrolling, pre-built
indicators, expandable widgets, auto-sized child support, and enlarged center page.

## Operational Role

For a systems engineer, flutter_carousel_widget belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-07-02T22:06:56.199316Z | [https://pub.dev/api/packages/flutter_carousel_widget](https://pub.dev/api/packages/flutter_carousel_widget) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_carousel_widget` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-c5e4c310535964` from `pub_dev` as `registry_expansion`
