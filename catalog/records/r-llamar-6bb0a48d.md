...
<!-- canonical: https://cran.r-project.org/web/packages/llamaR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/llamaR/index.html](https://cran.r-project.org/web/packages/llamaR/index.html) |
| Source record ids | cran_packages_by_date-10107c8fdc5d26 |
...
For a systems engineer, llamaR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-08-27 12:00:09 UTC | [https://cran.r-project.org/web/packages/llamaR/DESCRIPTION](https://cran.r-project.org/web/packages/llamaR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/llamaR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-10107c8fdc5d26` from `cran_packages_by_date` as `registry_expansion`
