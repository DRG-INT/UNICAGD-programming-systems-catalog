...
| Canonical URL | [https://github.com/czbiohub-sf/iohub](https://github.com/czbiohub-sf/iohub) |
| Source record ids | github_search_microscopy-06af8df71b09cb |
...
For a systems engineer, czbiohub-sf/iohub belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.3.11 | 2026-08-17T21:32:13Z | [https://api.github.com/repos/czbiohub-sf/iohub/releases/latest](https://api.github.com/repos/czbiohub-sf/iohub/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/czbiohub-sf/iohub/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-06af8df71b09cb` from `github_search_microscopy` as `registry_expansion`
