...
<!-- canonical: https://github.com/sdfeer-collab/Ember -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sdfeer-collab/Ember](https://github.com/sdfeer-collab/Ember) |
| Source record ids | github_search_basilisk-168c143115e44c |

## System Engineer Summary

Project Basilisk is a compiler toolchain that builds itself from absolute zero. It starts with a
pure ARM64 assembly seed compiler (seed.s), written from scratch, that compiles the Ember language
compiler (emberc.em), which in turn can compile itself.

## Operational Role

For a systems engineer, sdfeer-collab/Ember belongs in the Basilisk inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T06:43:04Z | gh search repos Basilisk language compiler | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-02 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "Basilisk language compiler", "retrieved": "2026-09-02", "status": "forge-cli-derived"}` |
...
- `github_search_basilisk-168c143115e44c` from `github_search_basilisk` as `registry_expansion`
...
| ZeeSpaceMechaGNC/Open-Source-General-Basilisk-Tool-for-Coronagraphic-Pointing-Stability-Proposal-Workshop | Language Specification | [open](basilisk-zeespacemechagnc-open-source-general-basilisk-tool-for-coronagraphic-pointing-stability-proposal-workshop-1019c263.md) |
