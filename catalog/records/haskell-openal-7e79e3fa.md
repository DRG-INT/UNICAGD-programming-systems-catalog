...
<!-- canonical: https://hackage.haskell.org/package/OpenAL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/OpenAL](https://hackage.haskell.org/package/OpenAL) |
| Source record ids | hackage_top_downloads-0de3adabbe1a56 |
...
For a systems engineer, OpenAL belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0.5 | 2019-06-10T16:04:48Z | [https://hackage.haskell.org/package/OpenAL](https://hackage.haskell.org/package/OpenAL) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/OpenAL` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-0de3adabbe1a56` from `hackage_top_downloads` as `registry_expansion`
