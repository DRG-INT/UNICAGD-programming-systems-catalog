...
<!-- canonical: https://github.com/rlguy/GridFluidSim3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rlguy/GridFluidSim3D](https://github.com/rlguy/GridFluidSim3D) |
| Source record ids | github_search_physics_engines-6765ea06d27417 |

## System Engineer Summary

A PIC/FLIP fluid simulation based on the methods found in Robert Bridson's "Fluid Simulation for
Computer Graphics"

## Operational Role

For a systems engineer, rlguy/GridFluidSim3D belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-24T18:32:35Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; Other; zlib License; https://api.github.com/licenses/zlib |
...
- `github_search_physics_engines-6765ea06d27417` from `github_search_physics_engines` as `registry_expansion`
