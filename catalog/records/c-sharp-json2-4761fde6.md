...
<!-- canonical: https://www.nuget.org/packages/json2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/json2](https://www.nuget.org/packages/json2) |
| Source record ids | nuget_search-5ca4a913c7b324 |

## System Engineer Summary

JSON is a light-weight, language independent, data interchange format. See This package implements
JSON encoders/decoders in JavaScript.

## Operational Role

For a systems engineer, json2 belongs in the C-Sharp inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2011-12-28T01:25:21.503+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/json2/index.json](https://api.nuget.org/v3/registration5-gz-semver2/json2/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/json2/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-5ca4a913c7b324` from `nuget_search` as `registry_expansion`
