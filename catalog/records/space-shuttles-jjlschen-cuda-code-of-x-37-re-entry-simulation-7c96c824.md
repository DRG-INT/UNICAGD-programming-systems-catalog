# jjlschen/cuda-code-of-X-37-re-entry-simulation
...
<!-- canonical: https://github.com/jjlschen/cuda-code-of-X-37-re-entry-simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jjlschen/cuda-code-of-X-37-re-entry-simulation](https://github.com/jjlschen/cuda-code-of-X-37-re-entry-simulation) |
| Source record ids | github_search_space_shuttles-3fd89ead7ca3b8 |

## System Engineer Summary

# cuda-code-of-X-37-re-entry-simulation-0 Use Lax-Friedrichs scheme to solve the Euler equation for
the flow field around space shuttle X-37.

## Operational Role

For a systems engineer, jjlschen/cuda-code-of-X-37-re-entry-simulation belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-01-12T17:28:04Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-3fd89ead7ca3b8` from `github_search_space_shuttles` as `registry_expansion`
