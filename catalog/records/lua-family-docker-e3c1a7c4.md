...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Api Abi Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/api-abi-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/epicfile/docker](https://luarocks.org/modules/epicfile/docker) |
| Source record ids | luarocks_root_manifest-640f81fde72499 |

## System Engineer Summary

Module for working with docker API

## Operational Role

For a systems engineer, docker belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| aghpb | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aghpb-93f1e423.md) |
| amber-apigw | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-amber-apigw-ae6efaf4.md) |
| api-gateway-request-validation | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api-gateway-request-validation-a7503939.md) |
| api7-lua-resty-aws | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-aws-8ea19429.md) |
| api7-lua-resty-session | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-session-3a10068e.md) |
| api7-skywalking-nginx-lua | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-skywalking-nginx-lua-74628846.md) |
| api7-snowflake | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-snowflake-a28aea64.md) |
| apibrasil | Api Abi Checker | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-apibrasil-5b62103f.md) |
