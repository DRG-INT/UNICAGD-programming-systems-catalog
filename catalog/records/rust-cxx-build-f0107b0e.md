...
<!-- canonical: https://crates.io/crates/cxx-build -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cxx-build](https://crates.io/crates/cxx-build) |
| Source record ids | crates_io-67fc0ac58a5291 |
...
For a systems engineer, cxx-build belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.200 | 2026-09-04T20:29:51.371448Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-04T22:18:06+00:00`.
...
- `crates_io-67fc0ac58a5291` from `crates_io` as `registry_expansion`
