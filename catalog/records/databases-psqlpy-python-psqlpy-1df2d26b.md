...
<!-- canonical: https://github.com/psqlpy-python/psqlpy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psqlpy-python/psqlpy](https://github.com/psqlpy-python/psqlpy) |
| Source record ids | github_search_databases-09f28ed8cb38e0 |
...
For a systems engineer, psqlpy-python/psqlpy belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T17:32:09Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-09f28ed8cb38e0` from `github_search_databases` as `registry_expansion`
