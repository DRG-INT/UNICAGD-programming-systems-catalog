...
<!-- canonical: https://cran.r-project.org/web/packages/OmopSketch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/OmopSketch/index.html](https://cran.r-project.org/web/packages/OmopSketch/index.html) |
| Source record ids | cran_packages_by_date-0901ea49baffe8 |
...
For a systems engineer, OmopSketch belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-08-27 11:10:02 UTC | [https://cran.r-project.org/web/packages/OmopSketch/DESCRIPTION](https://cran.r-project.org/web/packages/OmopSketch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/OmopSketch/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0901ea49baffe8` from `cran_packages_by_date` as `registry_expansion`
