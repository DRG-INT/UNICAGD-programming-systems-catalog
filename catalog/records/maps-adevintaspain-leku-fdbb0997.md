...
<!-- canonical: https://github.com/AdevintaSpain/Leku -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AdevintaSpain/Leku](https://github.com/AdevintaSpain/Leku) |
| Source record ids | github_search_maps-0d1166ec115c9a |

## System Engineer Summary

:earth_africa: Map location picker component for Android. Based on Google Maps. An alternative to
Google Place Picker.

## Operational Role

For a systems engineer, AdevintaSpain/Leku belongs in the Maps inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-13T11:03:38Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-0d1166ec115c9a` from `github_search_maps` as `registry_expansion`
