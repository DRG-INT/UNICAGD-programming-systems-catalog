...
<!-- canonical: https://github.com/libdriver/hmc5883l -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libdriver/hmc5883l](https://github.com/libdriver/hmc5883l) |
| Source record ids | github_search_electromagnetoscopes-b8e43a72ba4435 |

## System Engineer Summary

HMC5883L full-featured driver library for general-purpose MCU and Linux.

## Operational Role

For a systems engineer, libdriver/hmc5883l belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-28T06:29:30Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-b8e43a72ba4435` from `github_search_electromagnetoscopes` as `registry_expansion`
