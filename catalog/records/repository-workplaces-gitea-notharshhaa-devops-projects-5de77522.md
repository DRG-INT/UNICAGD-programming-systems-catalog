# Gitea: NotHarshhaa/DevOps-Projects
...
<!-- canonical: https://gitea.com/NotHarshhaa/DevOps-Projects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/NotHarshhaa/DevOps-Projects](https://gitea.com/NotHarshhaa/DevOps-Projects) |
| Source record ids | gitea_repositories_api-ec4edd9f934476 |

## System Engineer Summary

🚀 Real-world DevOps projects for aspiring engineers — Beginner to Advanced. Covers AWS, Kubernetes,
Docker, CI/CD, Terraform, Jenkins, and more. Hands-on learning with step-by-step guides.

## Operational Role

For a systems engineer, Gitea: NotHarshhaa/DevOps-Projects belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T18:39:38Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ec4edd9f934476` from `gitea_repositories_api` as `registry_expansion`
