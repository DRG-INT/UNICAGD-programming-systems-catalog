...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Formatter](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/formatter.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-abe5ca06961c |

## System Engineer Summary

clang-format is tracked as a formatter record in the C99 branch. The source did not provide a long
...
For a systems engineer, clang-format belongs in the C99 inventory as part of low-noise code review,
...
- `master-abe5ca06961c` from `master_json` as `formatter`
