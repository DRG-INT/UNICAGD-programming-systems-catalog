...
<!-- canonical: https://www.npmjs.com/package/server-cli-only -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/server-cli-only](https://www.npmjs.com/package/server-cli-only) |
| Source record ids | npm_registry-616f2a89b9da37 |

## System Engineer Summary

The server-cli-only package is designed to restrict the import of modules exclusively to React
Server Components or scripts running on the CLI.

## Operational Role

For a systems engineer, server-cli-only belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2024-04-30T11:09:03.373Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-616f2a89b9da37` from `npm_registry` as `registry_expansion`
