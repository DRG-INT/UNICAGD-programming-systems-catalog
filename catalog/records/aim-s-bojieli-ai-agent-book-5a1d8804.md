...
<!-- canonical: https://github.com/bojieli/ai-agent-book -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) |
| Source record ids | github_search_aims-33608ba834299b |
...
For a systems engineer, bojieli/ai-agent-book belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T06:35:56Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-33608ba834299b` from `github_search_aims` as `registry_expansion`
