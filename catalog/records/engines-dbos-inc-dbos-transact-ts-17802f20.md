...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dbos-inc/dbos-transact-ts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dbos-inc/dbos-transact-ts](https://github.com/dbos-inc/dbos-transact-ts) |
| Source record ids | github_search_engines-6599417bc6c20a |
...
For a systems engineer, dbos-inc/dbos-transact-ts belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:44:07Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-6599417bc6c20a` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ill-inc/biomes-game | Type Checker | [open](engines-ill-inc-biomes-game-56bb9ed2.md) |
