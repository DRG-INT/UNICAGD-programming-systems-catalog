...
<!-- canonical: https://www.npmjs.com/package/mongodb-memory-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mongodb-memory-server](https://www.npmjs.com/package/mongodb-memory-server) |
| Source record ids | npm_registry-a3597d4a65f071 |

## System Engineer Summary

MongoDB Server for testing (auto-download latest version). The server will allow you to connect your
favourite ODM or client library to the MongoDB Server and run parallel integration tests isolated
from each other.

## Operational Role

For a systems engineer, mongodb-memory-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.2.0 | 2026-05-28T10:20:50.030Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a3597d4a65f071` from `npm_registry` as `registry_expansion`
