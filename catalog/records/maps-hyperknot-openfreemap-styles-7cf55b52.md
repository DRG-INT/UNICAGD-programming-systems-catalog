...
<!-- canonical: https://github.com/hyperknot/openfreemap-styles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hyperknot/openfreemap-styles](https://github.com/hyperknot/openfreemap-styles) |
| Source record ids | github_search_maps-6a930ad4acc78a |

## System Engineer Summary

hyperknot/openfreemap-styles is tracked as a library record in the Maps branch. The source did not
...
For a systems engineer, hyperknot/openfreemap-styles belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-15T01:04:11Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-6a930ad4acc78a` from `github_search_maps` as `registry_expansion`
