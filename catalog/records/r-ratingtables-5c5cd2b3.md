...
<!-- canonical: https://cran.r-project.org/web/packages/ratingtables/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ratingtables/index.html](https://cran.r-project.org/web/packages/ratingtables/index.html) |
| Source record ids | cran_packages_by_date-42132afe1a203b |
...
For a systems engineer, ratingtables belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-09 08:40:02 UTC | [https://cran.r-project.org/web/packages/ratingtables/DESCRIPTION](https://cran.r-project.org/web/packages/ratingtables/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ratingtables/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-42132afe1a203b` from `cran_packages_by_date` as `registry_expansion`
