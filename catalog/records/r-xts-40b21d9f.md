...
<!-- canonical: https://cran.r-project.org/web/packages/xts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xts/index.html](https://cran.r-project.org/web/packages/xts/index.html) |
| Source record ids | cran_packages_by_date-5c54d4aa437c3e |

## System Engineer Summary

xts is tracked as a datetime record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, xts belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.3 | 2026-09-08 16:50:02 UTC | [https://cran.r-project.org/web/packages/xts/DESCRIPTION](https://cran.r-project.org/web/packages/xts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xts/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-5c54d4aa437c3e` from `cran_packages_by_date` as `registry_expansion`
