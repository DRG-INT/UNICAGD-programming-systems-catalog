...
<!-- canonical: https://github.com/prisma/prisma1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/prisma/prisma1](https://github.com/prisma/prisma1) |
| Source record ids | github_search_databases-6990c83e63759c |
...
For a systems engineer, prisma/prisma1 belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-01T18:57:41Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6990c83e63759c` from `github_search_databases` as `registry_expansion`
