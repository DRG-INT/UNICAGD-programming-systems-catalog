...
| Canonical URL | [https://luarocks.org/modules/gate11/kong-oidc-v3](https://luarocks.org/modules/gate11/kong-oidc-v3) |
| Source record ids | luarocks_root_manifest-5089d0a5aa3771 |
...
For a systems engineer, kong-oidc-v3 belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5089d0a5aa3771` from `luarocks_root_manifest` as `registry_expansion`
