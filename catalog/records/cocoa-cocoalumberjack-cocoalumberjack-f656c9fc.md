...
<!-- canonical: https://github.com/CocoaLumberjack/CocoaLumberjack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CocoaLumberjack/CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) |
| Source record ids | github_search_cocoa-f24483efaa5525 |

## System Engineer Summary

A fast & simple, yet powerful & flexible logging framework for macOS, iOS, tvOS, watchOS and
visionOS

## Operational Role

For a systems engineer, CocoaLumberjack/CocoaLumberjack belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T06:31:06Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-f24483efaa5525` from `github_search_cocoa` as `registry_expansion`
