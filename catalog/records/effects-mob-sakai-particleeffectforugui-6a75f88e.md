...
<!-- canonical: https://github.com/mob-sakai/ParticleEffectForUGUI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mob-sakai/ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) |
| Source record ids | github_search_effects-17fc3721580102 |

## System Engineer Summary

Render particle effect in UnityUI(uGUI). Maskable, sortable, and no extra
Camera/RenderTexture/Canvas.

## Operational Role

For a systems engineer, mob-sakai/ParticleEffectForUGUI belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T11:28:20Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-17fc3721580102` from `github_search_effects` as `registry_expansion`
