...
<!-- canonical: https://cran.r-project.org/web/packages/saeproj.multilevel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/saeproj.multilevel/index.html](https://cran.r-project.org/web/packages/saeproj.multilevel/index.html) |
| Source record ids | cran_packages_by_date-26ed7750298766 |
...
For a systems engineer, saeproj.multilevel belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-07 18:30:02 UTC | [https://cran.r-project.org/web/packages/saeproj.multilevel/DESCRIPTION](https://cran.r-project.org/web/packages/saeproj.multilevel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/saeproj.multilevel/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-26ed7750298766` from `cran_packages_by_date` as `registry_expansion`
