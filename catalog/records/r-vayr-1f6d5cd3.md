...
<!-- canonical: https://cran.r-project.org/web/packages/vayr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vayr/index.html](https://cran.r-project.org/web/packages/vayr/index.html) |
| Source record ids | cran_packages_by_date-991fb789d44860 |
...
For a systems engineer, vayr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-21 17:30:02 UTC | [https://cran.r-project.org/web/packages/vayr/DESCRIPTION](https://cran.r-project.org/web/packages/vayr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vayr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-991fb789d44860` from `cran_packages_by_date` as `registry_expansion`
