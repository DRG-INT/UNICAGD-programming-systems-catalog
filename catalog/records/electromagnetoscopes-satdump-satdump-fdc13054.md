...
| Source record ids | github_search_electromagnetoscopes-f1438d4eaaedc6 |
...
For a systems engineer, SatDump/SatDump belongs in the Electromagnetoscopes inventory as part of
...
- Latest stable metadata was observed from `https://api.github.com/repos/SatDump/SatDump/releases/latest` at `2026-09-01T08:26:42+00:00`.
...
- `github_search_electromagnetoscopes-f1438d4eaaedc6` from `github_search_electromagnetoscopes` as `registry_expansion`
