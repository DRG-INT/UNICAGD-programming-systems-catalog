...
<!-- canonical: https://crates.io/crates/anstream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/anstream](https://crates.io/crates/anstream) |
| Source record ids | crates_io-f59ea3fe9e61f8 |

## System Engineer Summary

IO stream adapters for writing colored text that will gracefully degrade according to your
terminal's capabilities.

## Operational Role

For a systems engineer, anstream belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-02-11T13:23:11.167553Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-f59ea3fe9e61f8` from `crates_io` as `registry_expansion`
