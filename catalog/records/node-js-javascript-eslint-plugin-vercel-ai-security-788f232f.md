...
<!-- canonical: https://www.npmjs.com/package/eslint-plugin-vercel-ai-security -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/eslint-plugin-vercel-ai-security](https://www.npmjs.com/package/eslint-plugin-vercel-ai-security) |
| Source record ids | npm_registry-422133eac15501 |

## System Engineer Summary

ESLint plugin for Vercel AI SDK security — detects prompt injection, system-prompt leaks, hardcoded
API keys, and unvalidated model output in generateText and streamText.

## Operational Role

For a systems engineer, eslint-plugin-vercel-ai-security belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-25T03:15:06.314Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
