...
<!-- canonical: https://hackage.haskell.org/package/compdata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/compdata](https://hackage.haskell.org/package/compdata) |
| Source record ids | hackage_top_downloads-a5c66f0ff34ce0 |
...
For a systems engineer, compdata belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.1 | 2023-10-16T18:01:03Z | [https://hackage.haskell.org/package/compdata](https://hackage.haskell.org/package/compdata) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/compdata` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-a5c66f0ff34ce0` from `hackage_top_downloads` as `registry_expansion`
