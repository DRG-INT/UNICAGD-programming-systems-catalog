...
<!-- canonical: https://aws.amazon.com/dynamodb/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://aws.amazon.com/dynamodb/](https://aws.amazon.com/dynamodb/) |
| Source record ids | curated_database_systems-e4fa1dcf9e5cde |

## System Engineer Summary

Managed key-value and document database service.

## Operational Role

For a systems engineer, DynamoDB belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-e4fa1dcf9e5cde` from `curated_database_systems` as `registry_expansion`
