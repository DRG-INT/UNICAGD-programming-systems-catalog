...
| Source record ids | github_search_databases-8fdedf98dac203 |
...
For a systems engineer, debezium/debezium belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:50:50Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-8fdedf98dac203` from `github_search_databases` as `registry_expansion`
