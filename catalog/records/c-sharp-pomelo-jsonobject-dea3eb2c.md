...
<!-- canonical: https://www.nuget.org/packages/Pomelo.JsonObject -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Pomelo.JsonObject](https://www.nuget.org/packages/Pomelo.JsonObject) |
| Source record ids | nuget_search-eabb625ee2b147 |
...
For a systems engineer, Pomelo.JsonObject belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2019-11-22T11:55:08.727+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/pomelo.jsonobject/index.json](https://api.nuget.org/v3/registration5-gz-semver2/pomelo.jsonobject/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/pomelo.jsonobject/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-eabb625ee2b147` from `nuget_search` as `registry_expansion`
