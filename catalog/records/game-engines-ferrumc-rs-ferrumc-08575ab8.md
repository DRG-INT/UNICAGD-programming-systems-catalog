...
<!-- canonical: https://github.com/ferrumc-rs/ferrumc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ferrumc-rs/ferrumc](https://github.com/ferrumc-rs/ferrumc) |
| Source record ids | github_search_game_engines-10dc6a8b5eec63 |
...
For a systems engineer, ferrumc-rs/ferrumc belongs in the Game Engines inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T15:03:31Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-10dc6a8b5eec63` from `github_search_game_engines` as `registry_expansion`
...
| rathena/rathena | Web Framework | [open](game-engines-rathena-rathena-206ad221.md) |
