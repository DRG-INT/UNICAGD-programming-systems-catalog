...
<!-- canonical: https://crates.io/crates/fastrand -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fastrand](https://crates.io/crates/fastrand) |
| Source record ids | crates_io-c4b2f0c1c36df4 |
...
For a systems engineer, fastrand belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2026-07-19T12:40:53.683020Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-c4b2f0c1c36df4` from `crates_io` as `registry_expansion`
