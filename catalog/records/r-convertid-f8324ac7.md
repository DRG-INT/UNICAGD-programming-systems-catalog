...
<!-- canonical: https://cran.r-project.org/web/packages/convertid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/convertid/index.html](https://cran.r-project.org/web/packages/convertid/index.html) |
| Source record ids | cran_packages_by_date-608ca89d6d324a |
...
For a systems engineer, convertid belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-24 16:20:33 UTC | [https://cran.r-project.org/web/packages/convertid/DESCRIPTION](https://cran.r-project.org/web/packages/convertid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/convertid/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-608ca89d6d324a` from `cran_packages_by_date` as `registry_expansion`
