...
| Canonical URL | [https://packagist.org/packages/colinmollenhour/magento-redis-session](https://packagist.org/packages/colinmollenhour/magento-redis-session) |
| Source record ids | packagist_search-8bd66db1c41355 |
...
For a systems engineer, colinmollenhour/magento-redis-session belongs in the PHP inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2025-05-29T19:32:55+00:00 | [https://repo.packagist.org/p2/colinmollenhour/magento-redis-session.json](https://repo.packagist.org/p2/colinmollenhour/magento-redis-session.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/colinmollenhour/magento-redis-session.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-8bd66db1c41355` from `packagist_search` as `registry_expansion`
