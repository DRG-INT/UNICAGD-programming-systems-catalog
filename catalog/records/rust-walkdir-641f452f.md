...
<!-- canonical: https://crates.io/crates/walkdir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/walkdir](https://crates.io/crates/walkdir) |
| Source record ids | crates_io-44ae6311d0616e |
...
For a systems engineer, walkdir belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2024-03-01T17:55:09.221032Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-44ae6311d0616e` from `crates_io` as `registry_expansion`
