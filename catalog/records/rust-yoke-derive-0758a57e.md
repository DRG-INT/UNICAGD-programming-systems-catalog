...
<!-- canonical: https://crates.io/crates/yoke-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/yoke-derive](https://crates.io/crates/yoke-derive) |
| Source record ids | crates_io-234f26e00f9fb3 |
...
For a systems engineer, yoke-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-04-01T16:46:42.411874Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-05T12:22:38+00:00`.
...
- `crates_io-234f26e00f9fb3` from `crates_io` as `registry_expansion`
