...
<!-- canonical: https://packagist.org/packages/tommyknocker/pdo-database-class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/tommyknocker/pdo-database-class](https://packagist.org/packages/tommyknocker/pdo-database-class) |
| Source record ids | packagist_search-7381675238aca9 |

## System Engineer Summary

Framework-agnostic PHP database library with unified API for MySQL, MariaDB, PostgreSQL, SQLite,
MSSQL, and Oracle. Query Builder, caching, sharding, window functions, CTEs, JSON, migrations,
ActiveRecord, CLI tools, AI-powered analysis. Zero external dependencies.

## Operational Role

For a systems engineer, tommyknocker/pdo-database-class belongs in the PHP inventory as part of
...
- `packagist_search-7381675238aca9` from `packagist_search` as `registry_expansion`
