...
<!-- canonical: https://github.com/bytedance/bitsail -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytedance/bitsail](https://github.com/bytedance/bitsail) |
| Source record ids | github_search_databases-0432405fdc48e7 |

## System Engineer Summary

BitSail is a distributed high-performance data integration engine which supports batch, streaming
and incremental scenarios. BitSail is widely used to synchronize hundreds of trillions of data every
day.

## Operational Role

For a systems engineer, bytedance/bitsail belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-01T15:59:00Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Eclipse Public License 2.0; https://api.github.com/licenses/epl-2.0; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-0432405fdc48e7` from `github_search_databases` as `registry_expansion`
