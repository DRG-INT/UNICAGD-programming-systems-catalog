...
| Canonical URL | [https://crates.io/crates/tauri-codegen](https://crates.io/crates/tauri-codegen) |
| Source record ids | crates_io-f770b6ce2e97f4 |
...
For a systems engineer, tauri-codegen belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.3 | 2026-06-17T13:44:30.045424Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-f770b6ce2e97f4` from `crates_io` as `registry_expansion`
