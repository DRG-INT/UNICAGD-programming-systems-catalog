...
| Canonical URL | [https://luarocks.org/modules/develcuy/eth-keccak](https://luarocks.org/modules/develcuy/eth-keccak) |
| Source record ids | luarocks_root_manifest-be4219418cdb2b |

## System Engineer Summary

Ethereum-compatible Keccak-256 for Lua 5.1

## Operational Role

For a systems engineer, eth-keccak belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-be4219418cdb2b` from `luarocks_root_manifest` as `registry_expansion`
