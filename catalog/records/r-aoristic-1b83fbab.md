...
<!-- canonical: https://cran.r-project.org/web/packages/aoristic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aoristic/index.html](https://cran.r-project.org/web/packages/aoristic/index.html) |
| Source record ids | cran_packages_by_date-9e6cc26ecb5b9e |
...
For a systems engineer, aoristic belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-09 07:30:09 UTC | [https://cran.r-project.org/web/packages/aoristic/DESCRIPTION](https://cran.r-project.org/web/packages/aoristic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aoristic/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-9e6cc26ecb5b9e` from `cran_packages_by_date` as `registry_expansion`
