...
<!-- canonical: https://github.com/griddb/griddb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/griddb/griddb](https://github.com/griddb/griddb) |
| Source record ids | github_search_databases-dd7491905f6520 |

## System Engineer Summary

GridDB is a next-generation open source database that makes time series IoT and big data fast,and
easy.

## Operational Role

For a systems engineer, griddb/griddb belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-19T08:57:07Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-dd7491905f6520` from `github_search_databases` as `registry_expansion`
