...
<!-- canonical: https://luarocks.org/modules/mascarenhas/cosmo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mascarenhas/cosmo](https://luarocks.org/modules/mascarenhas/cosmo) |
| Source record ids | luarocks_root_manifest-ef0236d80c57e5 |

## System Engineer Summary

Cosmo is tracked as a project scaffolding record in the Lua family branch. The source did not
...
For a systems engineer, Cosmo belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-ef0236d80c57e5` from `luarocks_root_manifest` as `registry_expansion`
