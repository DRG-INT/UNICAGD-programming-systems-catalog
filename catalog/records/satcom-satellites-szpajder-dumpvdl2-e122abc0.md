...
<!-- canonical: https://github.com/szpajder/dumpvdl2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/szpajder/dumpvdl2](https://github.com/szpajder/dumpvdl2) |
| Source record ids | github_search_satcom_satellites-56763d5df70527 |
...
For a systems engineer, szpajder/dumpvdl2 belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T19:58:06Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-56763d5df70527` from `github_search_satcom_satellites` as `registry_expansion`
