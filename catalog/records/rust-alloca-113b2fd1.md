...
| Canonical URL | [https://crates.io/crates/alloca](https://crates.io/crates/alloca) |
| Source record ids | crates_io-a60ed2ac855572 |
...
For a systems engineer, alloca belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2023-08-03T12:08:27.714601Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-a60ed2ac855572` from `crates_io` as `registry_expansion`
