...
<!-- canonical: https://github.com/unionlabs/union -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unionlabs/union](https://github.com/unionlabs/union) |
| Source record ids | github_search_go-3eb2e52539793d |

## System Engineer Summary

The trust-minimized, zero-knowledge bridging protocol, designed for censorship resistance, extremely
high security, and usage in decentralized finance.

## Operational Role

For a systems engineer, unionlabs/union belongs in the Go inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-25T18:20:02Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-3eb2e52539793d` from `github_search_go` as `registry_expansion`
