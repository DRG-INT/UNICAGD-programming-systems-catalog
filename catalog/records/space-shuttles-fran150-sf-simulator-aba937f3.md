...
<!-- canonical: https://github.com/fran150/sf-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fran150/sf-simulator](https://github.com/fran150/sf-simulator) |
| Source record ids | github_search_space_shuttles-f0e1d760fdc7ae |

## System Engineer Summary

A space flight simulator inspired by Orbiter

## Operational Role

For a systems engineer, fran150/sf-simulator belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-02T05:14:33Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-f0e1d760fdc7ae` from `github_search_space_shuttles` as `registry_expansion`
