...
<!-- canonical: https://cran.r-project.org/web/packages/ggtime/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggtime/index.html](https://cran.r-project.org/web/packages/ggtime/index.html) |
| Source record ids | cran_packages_by_date-5278bbf999c28e |
...
For a systems engineer, ggtime belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-01 13:10:19 UTC | [https://cran.r-project.org/web/packages/ggtime/DESCRIPTION](https://cran.r-project.org/web/packages/ggtime/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggtime/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5278bbf999c28e` from `cran_packages_by_date` as `registry_expansion`
