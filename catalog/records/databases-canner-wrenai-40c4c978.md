...
<!-- canonical: https://github.com/Canner/WrenAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Canner/WrenAI](https://github.com/Canner/WrenAI) |
| Source record ids | github_search_databases-afba2f6157c659 |

## System Engineer Summary

GenBI (Generative BI) for AI agents, an open-source, governed text-to-SQL through an open context
layer that turns natural-language questions into trusted dashboards, charts, and SQL across 20+ data
sources, such as BigQuery, Snowflake, PostgreSQL, ClickHouse, Amazon Redshift, Databricks and more.

## Operational Role

For a systems engineer, Canner/WrenAI belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T08:16:36Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-afba2f6157c659` from `github_search_databases` as `registry_expansion`
