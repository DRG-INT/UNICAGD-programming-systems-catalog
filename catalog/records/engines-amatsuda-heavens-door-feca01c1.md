...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/amatsuda/heavens_door -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amatsuda/heavens_door](https://github.com/amatsuda/heavens_door) |
| Source record ids | github_search_engines-d5a84a0699a335 |
...
For a systems engineer, amatsuda/heavens_door belongs in the Engines inventory as part of
...
- `github_search_engines-d5a84a0699a335` from `github_search_engines` as `registry_expansion`
