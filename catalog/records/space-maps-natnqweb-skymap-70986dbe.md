...
<!-- canonical: https://github.com/natnqweb/SkyMap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/natnqweb/SkyMap](https://github.com/natnqweb/SkyMap) |
| Source record ids | github_search_space_maps-36859a1373dd71 |
...
For a systems engineer, natnqweb/SkyMap belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-14T21:25:22Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_space_maps-36859a1373dd71` from `github_search_space_maps` as `registry_expansion`
