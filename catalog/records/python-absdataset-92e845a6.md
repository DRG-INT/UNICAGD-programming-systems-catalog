...
<!-- canonical: https://pypi.org/project/absdataset/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/absdataset/](https://pypi.org/project/absdataset/) |
| Source record ids | pypi_simple-8358bdffafed49 |

## System Engineer Summary

absdataset is tracked as a library record in the Python branch. The source did not provide a long
...
For a systems engineer, absdataset belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2022-04-10T11:03:19.932125Z | [https://pypi.org/pypi/absdataset/json](https://pypi.org/pypi/absdataset/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/absdataset/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-8358bdffafed49` from `pypi_simple` as `registry_expansion`
