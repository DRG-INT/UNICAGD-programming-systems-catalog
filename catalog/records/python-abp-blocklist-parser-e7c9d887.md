...
<!-- canonical: https://pypi.org/project/abp-blocklist-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abp-blocklist-parser/](https://pypi.org/project/abp-blocklist-parser/) |
| Source record ids | pypi_simple-99b7c07caf3cd3 |
...
For a systems engineer, abp-blocklist-parser belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3 | 2020-01-23T22:08:07.256572Z | [https://pypi.org/pypi/abp-blocklist-parser/json](https://pypi.org/pypi/abp-blocklist-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abp-blocklist-parser/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-99b7c07caf3cd3` from `pypi_simple` as `registry_expansion`
