...
<!-- canonical: https://cran.r-project.org/web/packages/fpod/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fpod/index.html](https://cran.r-project.org/web/packages/fpod/index.html) |
| Source record ids | cran_packages_by_date-b941b60adcb410 |
...
For a systems engineer, fpod belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-14 09:10:02 UTC | [https://cran.r-project.org/web/packages/fpod/DESCRIPTION](https://cran.r-project.org/web/packages/fpod/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fpod/DESCRIPTION` at `2026-09-14T10:20:50+00:00`.
...
- `cran_packages_by_date-b941b60adcb410` from `cran_packages_by_date` as `registry_expansion`
