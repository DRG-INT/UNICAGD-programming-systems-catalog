...
| Source record ids | curated_language_routes-a85d44c686a6aa |

## System Engineer Summary

Functional DSP language and compiler for audio effects, synthesis, plug-ins, and embedded audio
targets.

## Operational Role

For a systems engineer, Faust belongs in the Audio inventory as part of ecosystem capability
...
- `curated_language_routes-a85d44c686a6aa` from `curated_language_routes` as `registry_expansion`
