...
<!-- canonical: https://crates.io/crates/block-padding -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/block-padding](https://crates.io/crates/block-padding) |
| Source record ids | crates_io-6f2ca67cd62497 |
...
For a systems engineer, block-padding belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-02-06T17:19:08.045856Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-6f2ca67cd62497` from `crates_io` as `registry_expansion`
