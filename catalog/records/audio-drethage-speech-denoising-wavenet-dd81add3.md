...
<!-- canonical: https://github.com/drethage/speech-denoising-wavenet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drethage/speech-denoising-wavenet](https://github.com/drethage/speech-denoising-wavenet) |
| Source record ids | github_search_audio-69f4e9dcfb435d |
...
For a systems engineer, drethage/speech-denoising-wavenet belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-06T21:12:03Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-69f4e9dcfb435d` from `github_search_audio` as `registry_expansion`
