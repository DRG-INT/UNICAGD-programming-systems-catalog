...
<!-- canonical: https://github.com/bsumlin/PyMieScatt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bsumlin/PyMieScatt](https://github.com/bsumlin/PyMieScatt) |
| Source record ids | github_search_electromagnetoscopes-51fb6ebada18b6 |

## System Engineer Summary

A collection of forward and inverse Mie solving routines for Python 3, based on Bohren and Huffman's
Mie Theory derivations

## Operational Role

For a systems engineer, bsumlin/PyMieScatt belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-19T16:27:47Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-51fb6ebada18b6` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| kc-ml2/meent | Machine Learning | [open](electromagnetoscopes-kc-ml2-meent-d3573ea3.md) |
