...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Renderers](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/renderers.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Renderers |
| Category | Visualization Gui |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://www.cairographics.org/](https://www.cairographics.org/) |
| Source record ids | curated_language_routes-2affdc8c4017ef |

## System Engineer Summary

2D graphics library for vector drawing, raster output, PDF/SVG surfaces, and UI rendering pipelines.

## Operational Role

For a systems engineer, Cairo Graphics belongs in the Renderers inventory as part of ecosystem
...
- `curated_language_routes-2affdc8c4017ef` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ANGLE | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-angle-943037ea.md) |
| Blender Cycles | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-blender-cycles-c91554d8.md) |
| Dawn | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-dawn-e113c4c1.md) |
| Filament | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-filament-e2ef2a1b.md) |
| Mesa | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-mesa-79fde81e.md) |
| Pixman | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-pixman-bae7808a.md) |
| Skia | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-skia-947236ea.md) |
| WebGPU Native | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/renderers-webgpu-native-f04d6b9a.md) |
