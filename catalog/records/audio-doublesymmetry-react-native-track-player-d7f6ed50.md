...
| Canonical URL | [https://github.com/doublesymmetry/react-native-track-player](https://github.com/doublesymmetry/react-native-track-player) |
| Source record ids | github_search_audio-dfb0267390a9b8 |

## System Engineer Summary

The best audio player for React Native. Built on the New Architecture — Android Auto, caching,
preloading, background playback, and more.

## Operational Role

For a systems engineer, doublesymmetry/react-native-track-player belongs in the Audio inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.7.0 | 2026-07-16T10:24:21Z | [https://api.github.com/repos/doublesymmetry/react-native-track-player/releases/latest](https://api.github.com/repos/doublesymmetry/react-native-track-player/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/doublesymmetry/react-native-track-player/releases/latest` at `2026-09-01T09:23:16+00:00`.
...
- `github_search_audio-dfb0267390a9b8` from `github_search_audio` as `registry_expansion`
