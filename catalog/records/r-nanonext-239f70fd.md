...
<!-- canonical: https://cran.r-project.org/web/packages/nanonext/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nanonext/index.html](https://cran.r-project.org/web/packages/nanonext/index.html) |
| Source record ids | cran_packages_by_date-74318d78fe462a |
...
For a systems engineer, nanonext belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.2 | 2026-08-04 14:30:02 UTC | [https://cran.r-project.org/web/packages/nanonext/DESCRIPTION](https://cran.r-project.org/web/packages/nanonext/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nanonext/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-74318d78fe462a` from `cran_packages_by_date` as `registry_expansion`
