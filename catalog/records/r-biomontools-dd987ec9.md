...
<!-- canonical: https://cran.r-project.org/web/packages/BioMonTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BioMonTools/index.html](https://cran.r-project.org/web/packages/BioMonTools/index.html) |
| Source record ids | cran_packages_by_date-88c3fdd43f6cdb |
...
For a systems engineer, BioMonTools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2026-08-04 22:30:02 UTC | [https://cran.r-project.org/web/packages/BioMonTools/DESCRIPTION](https://cran.r-project.org/web/packages/BioMonTools/DESCRIPTION) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; The Unlicense; https://api.github.com/licenses/unlicense |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BioMonTools/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-88c3fdd43f6cdb` from `cran_packages_by_date` as `registry_expansion`
