...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoreholeResistance](https://github.com/JuliaRegistries/General/tree/master/B/BoreholeResistance) |
| Source record ids | julia_general-b6743d28fcbdda |

## System Engineer Summary

Julia package registered in General at B/BoreholeResistance.

## Operational Role

For a systems engineer, BoreholeResistance belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoreholeResistance", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-b6743d28fcbdda` from `julia_general` as `registry_expansion`
