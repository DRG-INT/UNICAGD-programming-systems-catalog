# abdolrezat/TURBN-Turbine-Design

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/abdolrezat/TURBN-Turbine-Design -->
<!-- crawl-delay: 10 -->
...
| Field | Value |
| --- | --- |
| Language branch | Space Engines |
| Category | Filesystem Os |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://github.com/abdolrezat/TURBN-Turbine-Design](https://github.com/abdolrezat/TURBN-Turbine-Design) |
| Source record ids | github_search_space_engines-40e4ed81e3d6e4 |

## System Engineer Summary

A MATLAB GUI for estimating some properties of turbines, the code is mainly based on Mattingly's
"Elements of Propulsion". This repository is made for educational purposes, it does solve the
problems in the book so it would be a useful resource for students. See the interface screenshots or
just run the code, it's pre-loaded with examples!

## Operational Role

For a systems engineer, abdolrezat/TURBN-Turbine-Design belongs in the Space Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-11-23T08:45:24Z | gh search repos topic:propulsion stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:propulsion stars:>10", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_space_engines-40e4ed81e3d6e4` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aerospaceresearch/orbitdeterminator | Filesystem Os | [open](space-engines-aerospaceresearch-orbitdeterminator-0d7657db.md) |
| aweeri/TLEscope | Filesystem Os | [open](space-engines-aweeri-tlescope-54c55a54.md) |
| donutTheJedi/Rocket-Launch-Simulation | Filesystem Os | [open](space-engines-donutthejedi-rocket-launch-simulation-e1707ede.md) |
| GH-X-ST/Aeronautical-Engineering-Imperial | Filesystem Os | [open](space-engines-gh-x-st-aeronautical-engineering-imperial-83f4e349.md) |
| haynieresearch/pep-for-zos | Filesystem Os | [open](space-engines-haynieresearch-pep-for-zos-46e1a9b2.md) |
| KOSASIH/thermal-protection-system | Filesystem Os | [open](space-engines-kosasih-thermal-protection-system-88c292b3.md) |
| maneatingape/rsvp | Filesystem Os | [open](space-engines-maneatingape-rsvp-5568bef4.md) |
| monomere/pshine | Filesystem Os | [open](space-engines-monomere-pshine-086e583b.md) |
