...
<!-- canonical: https://cran.r-project.org/web/packages/secrfunc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/secrfunc/index.html](https://cran.r-project.org/web/packages/secrfunc/index.html) |
| Source record ids | cran_packages_by_date-e4ebd815c289df |
...
For a systems engineer, secrfunc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-08-04 07:30:02 UTC | [https://cran.r-project.org/web/packages/secrfunc/DESCRIPTION](https://cran.r-project.org/web/packages/secrfunc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/secrfunc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e4ebd815c289df` from `cran_packages_by_date` as `registry_expansion`
