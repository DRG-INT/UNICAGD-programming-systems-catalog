...
| Canonical URL | [https://packagist.org/packages/easyswoole/mysqli](https://packagist.org/packages/easyswoole/mysqli) |
| Source record ids | packagist_search-622fe354ada881 |
...
For a systems engineer, easyswoole/mysqli belongs in the PHP inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.2 | 2026-08-26T12:33:34+00:00 | [https://repo.packagist.org/p2/easyswoole/mysqli.json](https://repo.packagist.org/p2/easyswoole/mysqli.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/easyswoole/mysqli.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-622fe354ada881` from `packagist_search` as `registry_expansion`
