...
<!-- canonical: https://cran.r-project.org/web/packages/nimble/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nimble/index.html](https://cran.r-project.org/web/packages/nimble/index.html) |
| Source record ids | cran_packages_by_date-57ca38519a474e |
...
For a systems engineer, nimble belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.3 | 2026-08-22 04:30:10 UTC | [https://cran.r-project.org/web/packages/nimble/DESCRIPTION](https://cran.r-project.org/web/packages/nimble/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nimble/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57ca38519a474e` from `cran_packages_by_date` as `registry_expansion`
