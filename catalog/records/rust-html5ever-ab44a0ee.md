...
<!-- canonical: https://crates.io/crates/html5ever -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/html5ever](https://crates.io/crates/html5ever) |
| Source record ids | crates_io-2599aaebb9ebb7 |
...
For a systems engineer, html5ever belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.40.0 | 2026-09-11T14:33:09.269951Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-11T16:21:04+00:00`.
...
- `crates_io-2599aaebb9ebb7` from `crates_io` as `registry_expansion`
