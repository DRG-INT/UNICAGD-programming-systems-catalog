# AndrewPlayer3/sentinel1_decode

## Navigation

[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AndrewPlayer3/sentinel1_decode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AndrewPlayer3/sentinel1_decode](https://github.com/AndrewPlayer3/sentinel1_decode) |
| Source record ids | github_search_radars-c2942c4ed9101e |

## System Engineer Summary

Decoding and Range Doppler Algorithm Based Image Formation for Level-0 RAW Sentinel-1 Data

## Operational Role

For a systems engineer, AndrewPlayer3/sentinel1_decode belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T20:13:20Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-c2942c4ed9101e` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fred9076/OPFA_matlab | Formatter | [open](radars-fred9076-opfa-matlab-f0318603.md) |
| nicespoon/retro-adsb-radar | Formatter | [open](radars-nicespoon-retro-adsb-radar-fe5109d7.md) |
| OSGeo/gdal | Formatter | [open](radars-osgeo-gdal-f77226f8.md) |
| Ttl/torchbp | Formatter | [open](radars-ttl-torchbp-2fa85796.md) |
