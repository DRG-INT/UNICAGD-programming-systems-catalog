...
<!-- canonical: https://luarocks.org/modules/3scale/apicast-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/3scale/apicast-cli](https://luarocks.org/modules/3scale/apicast-cli) |
| Source record ids | luarocks_root_manifest-4dd5f9ca0af794 |

## System Engineer Summary

A Lua tool to bootstrap project.

## Operational Role

For a systems engineer, apicast-cli belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-4dd5f9ca0af794` from `luarocks_root_manifest` as `registry_expansion`
