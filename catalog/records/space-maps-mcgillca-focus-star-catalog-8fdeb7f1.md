...
<!-- canonical: https://github.com/mcgillca/focus-star-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mcgillca/focus-star-catalog](https://github.com/mcgillca/focus-star-catalog) |
| Source record ids | github_search_space_maps-5dc2aac44a260d |

## System Engineer Summary

mcgillca/focus-star-catalog is tracked as a logging observability record in the Space Maps branch.
...
For a systems engineer, mcgillca/focus-star-catalog belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T15:55:01Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5dc2aac44a260d` from `github_search_space_maps` as `registry_expansion`
