...
<!-- canonical: https://pub.dev/packages/flutter_mobx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_mobx](https://pub.dev/packages/flutter_mobx) |
| Source record ids | pub_dev-81c4b4c944fd81 |

## System Engineer Summary

Flutter integration for MobX. It provides a set of Observer widgets that automatically rebuild when
the tracked observables change.

## Operational Role

For a systems engineer, flutter_mobx belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2024-12-16T13:02:23.833877Z | [https://pub.dev/api/packages/flutter_mobx](https://pub.dev/api/packages/flutter_mobx) |  |
| preview | known | 2.0.0-nullsafety.3 | 2021-03-21T10:56:49.759185Z | [https://pub.dev/api/packages/flutter_mobx](https://pub.dev/api/packages/flutter_mobx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_mobx` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-81c4b4c944fd81` from `pub_dev` as `registry_expansion`
