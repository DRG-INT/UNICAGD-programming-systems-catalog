...
<!-- canonical: https://cran.r-project.org/web/packages/refuginator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/refuginator/index.html](https://cran.r-project.org/web/packages/refuginator/index.html) |
| Source record ids | cran_packages_by_date-787b483646b3f7 |

## System Engineer Summary

An Interactive Tool for Identifying Refugia

## Operational Role

For a systems engineer, refuginator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-09-15 10:30:02 UTC | [https://cran.r-project.org/web/packages/refuginator/DESCRIPTION](https://cran.r-project.org/web/packages/refuginator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/refuginator/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-787b483646b3f7` from `cran_packages_by_date` as `registry_expansion`
