...
<!-- canonical: https://github.com/nuxt-modules/i18n -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nuxt-modules/i18n](https://github.com/nuxt-modules/i18n) |
| Source record ids | github_search_maps-d459fec7a03b1c |

## System Engineer Summary

nuxt-modules/i18n is tracked as a library record in the Maps branch. The source did not provide a
...
For a systems engineer, nuxt-modules/i18n belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v10.6.0 | 2026-07-30T10:49:10Z | [https://api.github.com/repos/nuxt-modules/i18n/releases/latest](https://api.github.com/repos/nuxt-modules/i18n/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nuxt-modules/i18n/releases/latest` at `2026-09-01T12:30:03+00:00`.
...
- `github_search_maps-d459fec7a03b1c` from `github_search_maps` as `registry_expansion`
