...
<!-- canonical: https://hackage.haskell.org/package/dhall-bash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dhall-bash](https://hackage.haskell.org/package/dhall-bash) |
| Source record ids | hackage_top_downloads-efd1762c1263b1 |
...
For a systems engineer, dhall-bash belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.41 | 2023-04-19T03:11:39Z | [https://hackage.haskell.org/package/dhall-bash](https://hackage.haskell.org/package/dhall-bash) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dhall-bash` at `2026-09-02T00:32:33+00:00`.
...
- `hackage_top_downloads-efd1762c1263b1` from `hackage_top_downloads` as `registry_expansion`
