...
| Canonical URL | [https://crates.io/crates/reqwest-retry](https://crates.io/crates/reqwest-retry) |
| Source record ids | crates_io-6c4931b3052d1e |
...
For a systems engineer, reqwest-retry belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2026-02-05T17:32:20.115195Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-6c4931b3052d1e` from `crates_io` as `registry_expansion`
