...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wasm-bindgen/wasm-bindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasm-bindgen/wasm-bindgen](https://github.com/wasm-bindgen/wasm-bindgen) |
| Source record ids | github_search_webassembly-6dcc4432701390 |
...
For a systems engineer, wasm-bindgen/wasm-bindgen belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T05:54:27Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6dcc4432701390` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ArthurSonzogni/Diagon | Precommit Ci Quality | [open](webassembly-arthursonzogni-diagon-5fb2401c.md) |
| MudBlazor/MudBlazor | Precommit Ci Quality | [open](webassembly-mudblazor-mudblazor-37a650f6.md) |
