...
<!-- canonical: https://crates.io/crates/hyper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hyper](https://crates.io/crates/hyper) |
| Source record ids | crates_io-b40ea0b93d75db |
...
For a systems engineer, hyper belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11.1 | 2026-08-28T12:22:30.892284Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-b40ea0b93d75db` from `crates_io` as `registry_expansion`
