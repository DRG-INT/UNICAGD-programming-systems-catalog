...
<!-- canonical: https://cran.r-project.org/web/packages/kpp2019/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kpp2019/index.html](https://cran.r-project.org/web/packages/kpp2019/index.html) |
| Source record ids | cran_packages_by_date-a88b68bccca801 |

## System Engineer Summary

Kenya Population Projections 2019

## Operational Role

For a systems engineer, kpp2019 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-08-20 14:10:09 UTC | [https://cran.r-project.org/web/packages/kpp2019/DESCRIPTION](https://cran.r-project.org/web/packages/kpp2019/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kpp2019/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a88b68bccca801` from `cran_packages_by_date` as `registry_expansion`
