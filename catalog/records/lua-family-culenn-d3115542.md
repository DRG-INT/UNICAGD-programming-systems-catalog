...
<!-- canonical: https://luarocks.org/modules/ano/culenn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ano/culenn](https://luarocks.org/modules/ano/culenn) |
| Source record ids | luarocks_root_manifest-9d9186be228bf9 |

## System Engineer Summary

CUDA Version Variable Length Extension of Neural Network package for Torch

## Operational Role

For a systems engineer, culenn belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-9d9186be228bf9` from `luarocks_root_manifest` as `registry_expansion`
