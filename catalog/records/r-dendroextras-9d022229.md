...
<!-- canonical: https://cran.r-project.org/web/packages/dendroextras/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dendroextras/index.html](https://cran.r-project.org/web/packages/dendroextras/index.html) |
| Source record ids | cran_packages_by_date-dad8b1833269a1 |
...
For a systems engineer, dendroextras belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2026-08-24 05:20:24 UTC | [https://cran.r-project.org/web/packages/dendroextras/DESCRIPTION](https://cran.r-project.org/web/packages/dendroextras/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dendroextras/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dad8b1833269a1` from `cran_packages_by_date` as `registry_expansion`
