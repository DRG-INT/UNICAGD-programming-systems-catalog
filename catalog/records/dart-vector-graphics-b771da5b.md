...
<!-- canonical: https://pub.dev/packages/vector_graphics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/vector_graphics](https://pub.dev/packages/vector_graphics) |
| Source record ids | pub_dev-f3f07b50ce2f0d |
...
For a systems engineer, vector_graphics belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.3 | 2026-07-31T20:16:18.697900Z | [https://pub.dev/api/packages/vector_graphics](https://pub.dev/api/packages/vector_graphics) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/vector_graphics` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-f3f07b50ce2f0d` from `pub_dev` as `registry_expansion`
