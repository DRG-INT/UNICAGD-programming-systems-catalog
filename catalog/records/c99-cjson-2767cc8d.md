...
| Source record ids | master-347098d388f8 |
...
For a systems engineer, cJSON belongs in the C99 inventory as part of wire formats, persistence,
...
- `master-347098d388f8` from `master_json` as `serialization`
