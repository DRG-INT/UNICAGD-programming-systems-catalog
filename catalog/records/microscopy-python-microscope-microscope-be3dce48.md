...
<!-- canonical: https://github.com/python-microscope/microscope -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/python-microscope/microscope](https://github.com/python-microscope/microscope) |
| Source record ids | github_search_microscopy-cc699a286d3479 |

## System Engineer Summary

Python library for control of microscope devices, supporting hardware triggers and distribution of
devices over the network for performance and flexibility.

## Operational Role

For a systems engineer, python-microscope/microscope belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-13T16:54:05Z | gh search repos topic:microscope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-cc699a286d3479` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| roflmaostc/DeconvOptim.jl | Benchmarking | [open](microscopy-roflmaostc-deconvoptim-jl-2f95f46a.md) |
