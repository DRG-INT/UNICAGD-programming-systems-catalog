...
<!-- canonical: https://crates.io/crates/nom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/nom](https://crates.io/crates/nom) |
| Source record ids | corpus-2fa6687051da14, crates_io-26075c2649d106 |
...
For a systems engineer, nom belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.0.0 | 2025-01-26T16:03:28.068915Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `corpus-2fa6687051da14` from `master_json` as `parser_lexer_ast`
- `crates_io-26075c2649d106` from `crates_io` as `registry_expansion`
