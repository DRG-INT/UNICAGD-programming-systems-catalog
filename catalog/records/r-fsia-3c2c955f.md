...
<!-- canonical: https://cran.r-project.org/web/packages/fsia/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fsia/index.html](https://cran.r-project.org/web/packages/fsia/index.html) |
| Source record ids | cran_packages_by_date-606dfc463207d0 |
...
For a systems engineer, fsia belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-09-01 13:30:02 UTC | [https://cran.r-project.org/web/packages/fsia/DESCRIPTION](https://cran.r-project.org/web/packages/fsia/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fsia/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-606dfc463207d0` from `cran_packages_by_date` as `registry_expansion`
