...
<!-- canonical: https://github.com/naver/spring-jdbc-plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/naver/spring-jdbc-plus](https://github.com/naver/spring-jdbc-plus) |
| Source record ids | github_search_databases-47843afb14ae9a |

## System Engineer Summary

naver/spring-jdbc-plus is tracked as a library record in the Databases branch. The source did not
...
For a systems engineer, naver/spring-jdbc-plus belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-22T01:26:45Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-47843afb14ae9a` from `github_search_databases` as `registry_expansion`
