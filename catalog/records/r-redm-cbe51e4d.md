...
<!-- canonical: https://cran.r-project.org/web/packages/rEDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rEDM/index.html](https://cran.r-project.org/web/packages/rEDM/index.html) |
| Source record ids | cran_packages_by_date-be4163f7cc5e23 |
...
For a systems engineer, rEDM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-08-30 05:10:18 UTC | [https://cran.r-project.org/web/packages/rEDM/DESCRIPTION](https://cran.r-project.org/web/packages/rEDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rEDM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-be4163f7cc5e23` from `cran_packages_by_date` as `registry_expansion`
