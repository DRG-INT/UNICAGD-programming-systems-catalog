...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/oqtane/oqtane.framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oqtane/oqtane.framework](https://github.com/oqtane/oqtane.framework) |
| Source record ids | github_search_webassembly-97acd57c366340 |

## System Engineer Summary

Oqtane is an open-source developer productivity platform for building modern .NET applications and
websites that run on Web, Desktop and Mobile.

## Operational Role

For a systems engineer, oqtane/oqtane.framework belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T19:58:40Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-97acd57c366340` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Build Your First Thing With WebAssembly (2016) | Build System | [open](webassembly-build-your-first-thing-with-webassembly-2016-d0e54406.md) |
| chinedufn/percy | Build System | [open](webassembly-chinedufn-percy-ab9a44d2.md) |
| evidence-dev/evidence | Build System | [open](webassembly-evidence-dev-evidence-610aea2a.md) |
| extism/extism | Build System | [open](webassembly-extism-extism-7f80b48c.md) |
| golemcloud/golem | Build System | [open](webassembly-golemcloud-golem-14251c66.md) |
| hexops/vecty | Build System | [open](webassembly-hexops-vecty-883121fc.md) |
| JetBrains/compose-multiplatform | Build System | [open](webassembly-jetbrains-compose-multiplatform-11636c4e.md) |
| kanaka/mal | Build System | [open](webassembly-kanaka-mal-077545d0.md) |
