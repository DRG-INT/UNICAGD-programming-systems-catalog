...
| Canonical URL | [https://crates.io/crates/serde-aux](https://crates.io/crates/serde-aux) |
| Source record ids | crates_io-a45f61cce42bde |
...
For a systems engineer, serde-aux belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.7.0 | 2025-04-23T07:28:48.494219Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-a45f61cce42bde` from `crates_io` as `registry_expansion`
