...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/envied -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/envied](https://pub.dev/packages/envied) |
| Source record ids | pub_dev-1e43c194b94ab2 |
...
For a systems engineer, envied belongs in the Dart inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.8 | 2026-07-03T19:14:32.220764Z | [https://pub.dev/api/packages/envied](https://pub.dev/api/packages/envied) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/envied` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-1e43c194b94ab2` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| freerasp | Security Sast | [open](dart-freerasp-c30cc13f.md) |
| pinput | Security Sast | [open](dart-pinput-7e72c012.md) |
