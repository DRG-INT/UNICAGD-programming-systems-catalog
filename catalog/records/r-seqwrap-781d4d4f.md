...
<!-- canonical: https://cran.r-project.org/web/packages/seqwrap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/seqwrap/index.html](https://cran.r-project.org/web/packages/seqwrap/index.html) |
| Source record ids | cran_packages_by_date-abb4641960135b |
...
For a systems engineer, seqwrap belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-09-03 11:20:02 UTC | [https://cran.r-project.org/web/packages/seqwrap/DESCRIPTION](https://cran.r-project.org/web/packages/seqwrap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/seqwrap/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-abb4641960135b` from `cran_packages_by_date` as `registry_expansion`
