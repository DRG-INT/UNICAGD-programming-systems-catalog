...
<!-- canonical: https://hackage.haskell.org/package/proteome -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/proteome](https://hackage.haskell.org/package/proteome) |
| Source record ids | hackage_top_downloads-ef5865fd93a24e |
...
For a systems engineer, proteome belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.10 | 2022-09-26T13:32:30Z | [https://hackage.haskell.org/package/proteome](https://hackage.haskell.org/package/proteome) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/proteome](https://hackage.haskell.org/package/proteome) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/proteome` at `2026-09-08T00:34:50+00:00`.
...
- `hackage_top_downloads-ef5865fd93a24e` from `hackage_top_downloads` as `registry_expansion`
