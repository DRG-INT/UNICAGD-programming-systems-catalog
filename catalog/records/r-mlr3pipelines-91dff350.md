...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3pipelines/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3pipelines/index.html](https://cran.r-project.org/web/packages/mlr3pipelines/index.html) |
| Source record ids | cran_packages_by_date-4d8fbfa0d2e06c |
...
For a systems engineer, mlr3pipelines belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2026-09-05 10:10:02 UTC | [https://cran.r-project.org/web/packages/mlr3pipelines/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3pipelines/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3pipelines/DESCRIPTION` at `2026-09-05T10:17:48+00:00`.
...
- `cran_packages_by_date-4d8fbfa0d2e06c` from `cran_packages_by_date` as `registry_expansion`
