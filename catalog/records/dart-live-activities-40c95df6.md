...
<!-- canonical: https://pub.dev/packages/live_activities -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/live_activities](https://pub.dev/packages/live_activities) |
| Source record ids | pub_dev-9780fc7306760a |
...
For a systems engineer, live_activities belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.1 | 2026-07-17T15:17:34.645143Z | [https://pub.dev/api/packages/live_activities](https://pub.dev/api/packages/live_activities) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/live_activities` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-9780fc7306760a` from `pub_dev` as `registry_expansion`
