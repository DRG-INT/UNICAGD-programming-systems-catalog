...
<!-- canonical: https://github.com/Gurdon-Super-Res-Lab/Microscope-Control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Gurdon-Super-Res-Lab/Microscope-Control](https://github.com/Gurdon-Super-Res-Lab/Microscope-Control) |
| Source record ids | github_search_microscopy-d630d3c4731aec |

## System Engineer Summary

Modular microscope control in LabView.

## Operational Role

For a systems engineer, Gurdon-Super-Res-Lab/Microscope-Control belongs in the Microscopy inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-20T09:52:18Z | gh search repos topic:microscope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-d630d3c4731aec` from `github_search_microscopy` as `registry_expansion`
