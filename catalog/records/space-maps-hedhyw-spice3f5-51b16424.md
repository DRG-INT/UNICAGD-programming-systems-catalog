...
<!-- canonical: https://github.com/hedhyw/spice3f5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hedhyw/spice3f5](https://github.com/hedhyw/spice3f5) |
| Source record ids | github_search_space_maps-573d6aafbed562 |

## System Engineer Summary

Add cmake to spice3f5 for build in linux or windows. SPICE is a general-purpose circuit simulator
with several built-in semiconductor device models. SPICE was developed at the Electronics Research
Laboratory of the University of California, Berkeley.

## Operational Role

For a systems engineer, hedhyw/spice3f5 belongs in the Space Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-05-01T06:08:00Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-573d6aafbed562` from `github_search_space_maps` as `registry_expansion`
