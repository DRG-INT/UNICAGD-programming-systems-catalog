...
<!-- canonical: https://packagist.org/packages/jms/serializer-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jms/serializer-bundle](https://packagist.org/packages/jms/serializer-bundle) |
| Source record ids | packagist_search-a6ba44cd603dc3 |
...
For a systems engineer, jms/serializer-bundle belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-a6ba44cd603dc3` from `packagist_search` as `registry_expansion`
