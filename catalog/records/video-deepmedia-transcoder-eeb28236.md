...
<!-- canonical: https://github.com/deepmedia/Transcoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deepmedia/Transcoder](https://github.com/deepmedia/Transcoder) |
| Source record ids | github_search_video-46ab89e2f4d390 |

## System Engineer Summary

🎞 Hardware-accelerated video transcoding using Android MediaCodec APIs. Supports cropping,
concatenation, clipping, audio processing, video speed and much more.

## Operational Role

For a systems engineer, deepmedia/Transcoder belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-05T03:24:32Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-46ab89e2f4d390` from `github_search_video` as `registry_expansion`
