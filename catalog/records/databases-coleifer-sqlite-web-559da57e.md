...
<!-- canonical: https://github.com/coleifer/sqlite-web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coleifer/sqlite-web](https://github.com/coleifer/sqlite-web) |
| Source record ids | github_search_databases-9b356ee1b64abc |
...
For a systems engineer, coleifer/sqlite-web belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:40:44Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9b356ee1b64abc` from `github_search_databases` as `registry_expansion`
