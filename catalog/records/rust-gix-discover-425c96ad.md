...
| Canonical URL | [https://crates.io/crates/gix-discover](https://crates.io/crates/gix-discover) |
| Source record ids | crates_io-726269c8ae9bea |
...
For a systems engineer, gix-discover belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.55.0 | 2026-08-22T19:04:13.708653Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-726269c8ae9bea` from `crates_io` as `registry_expansion`
