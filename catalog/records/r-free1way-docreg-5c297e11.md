...
<!-- canonical: https://cran.r-project.org/web/packages/free1way.docreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/free1way.docreg/index.html](https://cran.r-project.org/web/packages/free1way.docreg/index.html) |
| Source record ids | cran_packages_by_date-5b450d8a5adb67 |
...
For a systems engineer, free1way.docreg belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0-3 | 2026-09-08 16:00:02 UTC | [https://cran.r-project.org/web/packages/free1way.docreg/DESCRIPTION](https://cran.r-project.org/web/packages/free1way.docreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/free1way.docreg/DESCRIPTION` at `2026-09-08T16:22:20+00:00`.
...
- `cran_packages_by_date-5b450d8a5adb67` from `cran_packages_by_date` as `registry_expansion`
