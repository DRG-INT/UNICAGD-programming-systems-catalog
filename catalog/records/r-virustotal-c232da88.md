...
<!-- canonical: https://cran.r-project.org/web/packages/virustotal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/virustotal/index.html](https://cran.r-project.org/web/packages/virustotal/index.html) |
| Source record ids | cran_packages_by_date-23b690af2c3d8c |
...
For a systems engineer, virustotal belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-20 11:10:02 UTC | [https://cran.r-project.org/web/packages/virustotal/DESCRIPTION](https://cran.r-project.org/web/packages/virustotal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/virustotal/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-23b690af2c3d8c` from `cran_packages_by_date` as `registry_expansion`
