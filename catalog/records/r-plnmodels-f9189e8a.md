...
<!-- canonical: https://cran.r-project.org/web/packages/PLNmodels/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PLNmodels/index.html](https://cran.r-project.org/web/packages/PLNmodels/index.html) |
| Source record ids | cran_packages_by_date-23a5f40d0ea24e |
...
For a systems engineer, PLNmodels belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-29 10:10:02 UTC | [https://cran.r-project.org/web/packages/PLNmodels/DESCRIPTION](https://cran.r-project.org/web/packages/PLNmodels/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PLNmodels/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-23a5f40d0ea24e` from `cran_packages_by_date` as `registry_expansion`
