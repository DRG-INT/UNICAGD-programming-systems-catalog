...
<!-- canonical: https://crates.io/crates/rand_pcg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_pcg](https://crates.io/crates/rand_pcg) |
| Source record ids | crates_io-9f6a0dd7460a95 |
...
For a systems engineer, rand_pcg belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2 | 2026-04-11T13:36:48.925934Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-9f6a0dd7460a95` from `crates_io` as `registry_expansion`
