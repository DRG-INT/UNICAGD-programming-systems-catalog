...
<!-- canonical: https://github.com/master-co/css -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/master-co/css](https://github.com/master-co/css) |
| Source record ids | github_search_engines-a4800348e14caf |
...
For a systems engineer, master-co/css belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T15:25:01Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-a4800348e14caf` from `github_search_engines` as `registry_expansion`
