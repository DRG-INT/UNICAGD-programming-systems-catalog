# juce-framework/tremolo-juce-course
...
<!-- canonical: https://github.com/juce-framework/tremolo-juce-course -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/juce-framework/tremolo-juce-course](https://github.com/juce-framework/tremolo-juce-course) |
| Source record ids | github_search_audio-f9c1f41a7a74a2 |

## System Engineer Summary

Tremolo audio plugin used in the official JUCE C++ framework course on audio plugin development.

## Operational Role

For a systems engineer, juce-framework/tremolo-juce-course belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-16T16:40:34Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-f9c1f41a7a74a2` from `github_search_audio` as `registry_expansion`
