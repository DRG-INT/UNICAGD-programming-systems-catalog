...
<!-- canonical: https://www.nuget.org/packages/Chr.Avro.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Chr.Avro.Json](https://www.nuget.org/packages/Chr.Avro.Json) |
| Source record ids | nuget_search-2a0f82a3a701fc |
...
For a systems engineer, Chr.Avro.Json belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.13.1 | 2026-04-09T13:15:04.153+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/chr.avro.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/chr.avro.json/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/chr.avro.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-2a0f82a3a701fc` from `nuget_search` as `registry_expansion`
