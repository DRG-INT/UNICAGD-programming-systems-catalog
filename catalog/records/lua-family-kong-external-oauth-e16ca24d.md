...
| Canonical URL | [https://luarocks.org/modules/ehekatl/kong-external-oauth](https://luarocks.org/modules/ehekatl/kong-external-oauth) |
| Source record ids | luarocks_root_manifest-913235119e7fe1 |
...
For a systems engineer, kong-external-oauth belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-913235119e7fe1` from `luarocks_root_manifest` as `registry_expansion`
