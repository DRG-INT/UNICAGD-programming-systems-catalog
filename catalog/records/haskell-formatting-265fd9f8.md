...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/formatting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/formatting](https://hackage.haskell.org/package/formatting) |
| Source record ids | hackage_top_downloads-963e4a862eb0bf |
...
For a systems engineer, formatting belongs in the Haskell inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0 | 2022-11-25T23:41:48Z | [https://hackage.haskell.org/package/formatting](https://hackage.haskell.org/package/formatting) |  |
| candidate | partial | 7.0.0 |  | [https://hackage.haskell.org/package/formatting](https://hackage.haskell.org/package/formatting) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/formatting` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-963e4a862eb0bf` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amazonka-cloudformation | Formatter | [open](haskell-amazonka-cloudformation-db4ba4be.md) |
| ats-format | Formatter | [open](haskell-ats-format-a0591a36.md) |
| bioinformatics-toolkit | Formatter | [open](haskell-bioinformatics-toolkit-24c32fd6.md) |
| sequence-formats | Formatter | [open](haskell-sequence-formats-57dac885.md) |
| text-format | Formatter | [open](haskell-text-format-a2c5e7e6.md) |
