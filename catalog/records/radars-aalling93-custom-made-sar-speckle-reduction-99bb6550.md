# aalling93/Custom-made-SAR-speckle-reduction
...
<!-- canonical: https://github.com/aalling93/Custom-made-SAR-speckle-reduction -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aalling93/Custom-made-SAR-speckle-reduction](https://github.com/aalling93/Custom-made-SAR-speckle-reduction) |
| Source record ids | github_search_radars-8a38eb1a134c28 |

## System Engineer Summary

Spekle reduction of SAR images in matlab using different custom-made filters: -Mean filter. -Frost
filter. -Modified frost filter(added thresholds). -Lee filter(Using Masks, ENL ect). Note these
fitlers are developed without the use of loops to make them faster.

## Operational Role

For a systems engineer, aalling93/Custom-made-SAR-speckle-reduction belongs in the Radars inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-09T11:26:15Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-8a38eb1a134c28` from `github_search_radars` as `registry_expansion`
