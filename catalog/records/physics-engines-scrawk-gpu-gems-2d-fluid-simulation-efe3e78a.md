...
<!-- canonical: https://github.com/Scrawk/GPU-GEMS-2D-Fluid-Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Scrawk/GPU-GEMS-2D-Fluid-Simulation](https://github.com/Scrawk/GPU-GEMS-2D-Fluid-Simulation) |
| Source record ids | github_search_physics_engines-ee9682062e4907 |
...
For a systems engineer, Scrawk/GPU-GEMS-2D-Fluid-Simulation belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-30T13:48:46Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-ee9682062e4907` from `github_search_physics_engines` as `registry_expansion`
