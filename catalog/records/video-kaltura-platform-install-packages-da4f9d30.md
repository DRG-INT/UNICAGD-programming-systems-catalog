...
<!-- canonical: https://github.com/kaltura/platform-install-packages -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kaltura/platform-install-packages](https://github.com/kaltura/platform-install-packages) |
| Source record ids | github_search_video-aba88685cb2ac6 |

## System Engineer Summary

Official deployment packages to install the Kaltura platform on a server or cluster environments
using native OS package managers

## Operational Role

For a systems engineer, kaltura/platform-install-packages belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-31T20:11:47Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-aba88685cb2ac6` from `github_search_video` as `registry_expansion`
