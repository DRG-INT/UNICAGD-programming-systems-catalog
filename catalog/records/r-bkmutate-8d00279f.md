...
<!-- canonical: https://cran.r-project.org/web/packages/BKMutate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BKMutate/index.html](https://cran.r-project.org/web/packages/BKMutate/index.html) |
| Source record ids | cran_packages_by_date-0fa2bccd2db60c |
...
For a systems engineer, BKMutate belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:10:07 UTC | [https://cran.r-project.org/web/packages/BKMutate/DESCRIPTION](https://cran.r-project.org/web/packages/BKMutate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BKMutate/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0fa2bccd2db60c` from `cran_packages_by_date` as `registry_expansion`
