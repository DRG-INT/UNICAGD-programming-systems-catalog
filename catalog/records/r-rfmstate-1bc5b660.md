...
<!-- canonical: https://cran.r-project.org/web/packages/RFmstate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RFmstate/index.html](https://cran.r-project.org/web/packages/RFmstate/index.html) |
| Source record ids | cran_packages_by_date-fcdb8278594858 |
...
For a systems engineer, RFmstate belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-09-09 18:30:02 UTC | [https://cran.r-project.org/web/packages/RFmstate/DESCRIPTION](https://cran.r-project.org/web/packages/RFmstate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RFmstate/DESCRIPTION` at `2026-09-09T20:20:33+00:00`.
...
- `cran_packages_by_date-fcdb8278594858` from `cran_packages_by_date` as `registry_expansion`
