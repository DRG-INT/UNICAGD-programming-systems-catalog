...
<!-- canonical: https://github.com/PowerBroker2/MAMMAL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PowerBroker2/MAMMAL](https://github.com/PowerBroker2/MAMMAL) |
| Source record ids | github_search_electromagnetoscopes-32df410b97cd6c |

## System Engineer Summary

MAMMAL - Magnetic Anomaly Map Matching Airborne and Land: A Python package for simulating and
processing aeromagnetic anomaly survey data. It can be used to create magnetic anomaly maps for
Magnetic Navigation solutions (MagNav).

## Operational Role

For a systems engineer, PowerBroker2/MAMMAL belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-24T05:46:03Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-32df410b97cd6c` from `github_search_electromagnetoscopes` as `registry_expansion`
