...
<!-- canonical: https://luarocks.org/modules/vitiral/civtest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/vitiral/civtest](https://luarocks.org/modules/vitiral/civtest) |
| Source record ids | luarocks_root_manifest-be83308830775d |
...
For a systems engineer, civtest belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-be83308830775d` from `luarocks_root_manifest` as `registry_expansion`
