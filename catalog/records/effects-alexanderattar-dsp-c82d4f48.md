...
<!-- canonical: https://github.com/alexanderattar/dsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexanderattar/dsp](https://github.com/alexanderattar/dsp) |
| Source record ids | github_search_effects-e22803bf457bee |

## System Engineer Summary

Digital Signal Processing - Audio Effects: A collection of Python scripts

## Operational Role

For a systems engineer, alexanderattar/dsp belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-05-20T00:53:54Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e22803bf457bee` from `github_search_effects` as `registry_expansion`
