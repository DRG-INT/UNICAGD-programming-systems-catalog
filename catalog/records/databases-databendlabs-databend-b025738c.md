...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/databendlabs/databend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/databendlabs/databend](https://github.com/databendlabs/databend) |
| Source record ids | github_search_databases-06e44de193b477 |

## System Engineer Summary

Data Agent Ready Warehouse : One for Analytics, Search, AI, Python Sandbox. — rebuilt from scratch.
Unified architecture on your S3.

## Operational Role

For a systems engineer, databendlabs/databend belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:31:11Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:olap stars:>200", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_databases-06e44de193b477` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/spark | Data Science | [open](databases-apache-spark-8676d6b2.md) |
