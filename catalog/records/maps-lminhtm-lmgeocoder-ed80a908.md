...
| Canonical URL | [https://github.com/lminhtm/LMGeocoder](https://github.com/lminhtm/LMGeocoder) |
| Source record ids | github_search_maps-dafe98f73a807c |

## System Engineer Summary

Simple wrapper for geocoding and reverse geocoding, using both Google Geocoding API and Apple iOS
Geocoding Framework.

## Operational Role

For a systems engineer, lminhtm/LMGeocoder belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2019-08-24T11:48:41Z | [https://api.github.com/repos/lminhtm/LMGeocoder/releases/latest](https://api.github.com/repos/lminhtm/LMGeocoder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lminhtm/LMGeocoder/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-dafe98f73a807c` from `github_search_maps` as `registry_expansion`
...
| ipea/geocodebr | Filesystem Os | [open](maps-ipea-geocodebr-97586b43.md) |
