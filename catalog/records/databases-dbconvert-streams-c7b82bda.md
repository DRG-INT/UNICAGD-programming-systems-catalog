...
| Canonical URL | [https://streams.dbconvert.com/](https://streams.dbconvert.com/) |
| Source record ids | awesome_list-512b2626aed08f |

## System Engineer Summary

Database IDE with migration, federated SQL, and CDC replication for PostgreSQL, MySQL, files, and
S3-compatible storage. (Commercial Software).

## Operational Role

For a systems engineer, DBConvert Streams belongs in the Databases inventory as part of ecosystem
...
- `awesome_list-512b2626aed08f` from `awesome_list` as `registry_expansion`
...
| pgbackup-sidecar | Ide Editor Integration | [open](databases-pgbackup-sidecar-e9843914.md) |
