...
<!-- canonical: https://github.com/shzlw/poli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shzlw/poli](https://github.com/shzlw/poli) |
| Source record ids | github_search_databases-5095f25a8d1d57 |

## System Engineer Summary

An easy-to-use BI server built for SQL lovers. Power data analysis in SQL and gain faster business
insights.

## Operational Role

For a systems engineer, shzlw/poli belongs in the Databases inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-06T21:00:47Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5095f25a8d1d57` from `github_search_databases` as `registry_expansion`
...
| milvus-io/bootcamp | Static Analyzer | [open](databases-milvus-io-bootcamp-d2394190.md) |
