...
<!-- canonical: https://hackage.haskell.org/package/cryptonite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cryptonite](https://hackage.haskell.org/package/cryptonite) |
| Source record ids | hackage_top_downloads-f4142ff2e390e3 |
...
For a systems engineer, cryptonite belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30 | 2022-03-13T12:56:59Z | [https://hackage.haskell.org/package/cryptonite](https://hackage.haskell.org/package/cryptonite) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cryptonite` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-f4142ff2e390e3` from `hackage_top_downloads` as `registry_expansion`
