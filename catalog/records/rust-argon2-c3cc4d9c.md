...
<!-- canonical: https://crates.io/crates/argon2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/argon2](https://crates.io/crates/argon2) |
| Source record ids | crates_io-2f7b4ad3d0e8fe |

## System Engineer Summary

Pure Rust implementation of the Argon2 password hashing function with support for the Argon2d,
Argon2i, and Argon2id algorithmic variants

## Operational Role

For a systems engineer, argon2 belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-08-27T16:54:18.571817Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-2f7b4ad3d0e8fe` from `crates_io` as `registry_expansion`
