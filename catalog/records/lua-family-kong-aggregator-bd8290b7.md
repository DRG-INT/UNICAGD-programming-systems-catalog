...
| Canonical URL | [https://luarocks.org/modules/bramiproject/kong-aggregator](https://luarocks.org/modules/bramiproject/kong-aggregator) |
| Source record ids | luarocks_root_manifest-d2b1b2d3b5c13a |

## System Engineer Summary

kong-aggregator is tracked as a library record in the Lua family branch. The source did not provide
...
For a systems engineer, kong-aggregator belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d2b1b2d3b5c13a` from `luarocks_root_manifest` as `registry_expansion`
