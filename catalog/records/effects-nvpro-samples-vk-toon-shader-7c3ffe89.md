...
<!-- canonical: https://github.com/nvpro-samples/vk_toon_shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nvpro-samples/vk_toon_shader](https://github.com/nvpro-samples/vk_toon_shader) |
| Source record ids | github_search_effects-85d9bc95d146f4 |
...
For a systems engineer, nvpro-samples/vk_toon_shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-27T20:08:54Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-85d9bc95d146f4` from `github_search_effects` as `registry_expansion`
