...
| Canonical URL | [https://crates.io/crates/const-str](https://crates.io/crates/const-str) |
| Source record ids | crates_io-6eeac929b2e19a |
...
For a systems engineer, const-str belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-02-01T16:48:06.760309Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-6eeac929b2e19a` from `crates_io` as `registry_expansion`
