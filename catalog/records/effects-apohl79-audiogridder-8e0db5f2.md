...
| Source record ids | github_search_effects-52f41c7e3937e0 |
...
For a systems engineer, apohl79/audiogridder belongs in the Effects inventory as part of service
...
- `github_search_effects-52f41c7e3937e0` from `github_search_effects` as `registry_expansion`
