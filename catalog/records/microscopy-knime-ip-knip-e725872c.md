...
<!-- canonical: https://github.com/knime-ip/knip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/knime-ip/knip](https://github.com/knime-ip/knip) |
| Source record ids | github_search_microscopy-45eea2facdb97f |
...
For a systems engineer, knime-ip/knip belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T13:47:26Z | gh search repos topic:imagej stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-45eea2facdb97f` from `github_search_microscopy` as `registry_expansion`
