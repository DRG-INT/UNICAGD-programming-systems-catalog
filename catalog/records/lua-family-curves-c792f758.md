...
<!-- canonical: https://luarocks.org/modules/stdgregwar/curves -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/stdgregwar/curves](https://luarocks.org/modules/stdgregwar/curves) |
| Source record ids | luarocks_root_manifest-3410d1ed697e97 |

## System Engineer Summary

curves is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, curves belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-3410d1ed697e97` from `luarocks_root_manifest` as `registry_expansion`
