...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Api Abi Checker](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/api-abi-checker.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-9a820be473fce2 |

## System Engineer Summary

libabigail is tracked as an api abi checker record in the C99 branch. The source did not provide a
...
For a systems engineer, libabigail belongs in the C99 inventory as part of ecosystem capability
...
- `corpus-9a820be473fce2` from `master_json` as `api_abi_checker`
