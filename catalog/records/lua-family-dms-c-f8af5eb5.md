...
<!-- canonical: https://luarocks.org/modules/flopes/dms-c -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/flopes/dms-c](https://luarocks.org/modules/flopes/dms-c) |
| Source record ids | luarocks_root_manifest-7f1651221ae99f |

## System Engineer Summary

Native (C) DMS decoder for Lua — wraps the dms-c reference parser via a Lua C module.

## Operational Role

For a systems engineer, dms-c belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-7f1651221ae99f` from `luarocks_root_manifest` as `registry_expansion`
