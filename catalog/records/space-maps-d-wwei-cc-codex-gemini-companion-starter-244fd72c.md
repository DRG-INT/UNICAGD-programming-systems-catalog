# d-wwei/CC-Codex-Gemini-companion-starter
...
<!-- canonical: https://github.com/d-wwei/CC-Codex-Gemini-companion-starter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/d-wwei/CC-Codex-Gemini-companion-starter](https://github.com/d-wwei/CC-Codex-Gemini-companion-starter) |
| Source record ids | github_search_space_maps-67de1d1964c7fe |

## System Engineer Summary

Single-repository bootstrap framework for Claude Code, Codex, and Gemini with memory, IM bridge, and
catalog-guided MCP/skills onboarding.

## Operational Role

For a systems engineer, d-wwei/CC-Codex-Gemini-companion-starter belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-11T15:24:36Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-67de1d1964c7fe` from `github_search_space_maps` as `registry_expansion`
