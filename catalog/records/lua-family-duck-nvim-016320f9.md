...
<!-- canonical: https://luarocks.org/modules/bodby/duck-nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/bodby/duck-nvim](https://luarocks.org/modules/bodby/duck-nvim) |
| Source record ids | luarocks_root_manifest-f0a45b18a8def1, luarocks_root_manifest-6801348058ec68 |
...
For a systems engineer, duck-nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f0a45b18a8def1` from `luarocks_root_manifest` as `registry_expansion`
- `luarocks_root_manifest-6801348058ec68` from `luarocks_root_manifest` as `registry_expansion`
