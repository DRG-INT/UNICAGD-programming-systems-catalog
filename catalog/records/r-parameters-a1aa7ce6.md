...
<!-- canonical: https://cran.r-project.org/web/packages/parameters/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/parameters/index.html](https://cran.r-project.org/web/packages/parameters/index.html) |
| Source record ids | cran_packages_by_date-9f6c7c4e2ddb3e |
...
For a systems engineer, parameters belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.29.3 | 2026-09-02 15:00:02 UTC | [https://cran.r-project.org/web/packages/parameters/DESCRIPTION](https://cran.r-project.org/web/packages/parameters/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/parameters/DESCRIPTION` at `2026-09-02T15:24:11+00:00`.
...
- `cran_packages_by_date-9f6c7c4e2ddb3e` from `cran_packages_by_date` as `registry_expansion`
