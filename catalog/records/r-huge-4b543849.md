...
<!-- canonical: https://cran.r-project.org/web/packages/huge/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/huge/index.html](https://cran.r-project.org/web/packages/huge/index.html) |
| Source record ids | cran_packages_by_date-8acf6ee4c88b07 |
...
For a systems engineer, huge belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-04 10:30:34 UTC | [https://cran.r-project.org/web/packages/huge/DESCRIPTION](https://cran.r-project.org/web/packages/huge/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/huge/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8acf6ee4c88b07` from `cran_packages_by_date` as `registry_expansion`
