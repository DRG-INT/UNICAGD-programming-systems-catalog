...
<!-- canonical: https://github.com/Zesters/Kernel_spicekey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Zesters/Kernel_spicekey](https://github.com/Zesters/Kernel_spicekey) |
| Source record ids | github_search_space_maps-40a4125ed4a2d6 |

## System Engineer Summary

This is a source kernel forked by the projects of motorola

## Operational Role

For a systems engineer, Zesters/Kernel_spicekey belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2012-11-10T02:32:47Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-40a4125ed4a2d6` from `github_search_space_maps` as `registry_expansion`
