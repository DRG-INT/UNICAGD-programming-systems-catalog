...
<!-- canonical: https://www.npmjs.com/package/mcp-database-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mcp-database-server](https://www.npmjs.com/package/mcp-database-server) |
| Source record ids | npm_registry-14a36c003a011a |
...
For a systems engineer, mcp-database-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2025-09-23T08:21:33.501Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-14a36c003a011a` from `npm_registry` as `registry_expansion`
