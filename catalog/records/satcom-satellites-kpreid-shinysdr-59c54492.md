...
| Source record ids | github_search_satcom_satellites-39bab23c2bd493 |
...
For a systems engineer, kpreid/shinysdr belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-17T04:34:50Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-39bab23c2bd493` from `github_search_satcom_satellites` as `registry_expansion`
