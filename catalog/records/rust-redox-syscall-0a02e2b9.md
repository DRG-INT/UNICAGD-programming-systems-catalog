...
<!-- canonical: https://crates.io/crates/redox_syscall -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/redox_syscall](https://crates.io/crates/redox_syscall) |
| Source record ids | crates_io-da25cb3f314cc1 |
...
For a systems engineer, redox_syscall belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.4 | 2026-09-05T08:52:15.805729Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads` at `2026-09-05T10:17:32+00:00`.
...
- `crates_io-da25cb3f314cc1` from `crates_io` as `registry_expansion`
