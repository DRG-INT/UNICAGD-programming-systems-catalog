...
| Canonical URL | [https://crates.io/crates/cargo-nextest](https://crates.io/crates/cargo-nextest) |
| Source record ids | master-32f4ff5548e5 |

## System Engineer Summary

cargo-nextest is tracked as a testing framework record in the Rust branch. The source did not
...
For a systems engineer, cargo-nextest belongs in the Rust inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.143 | 2026-08-04T22:27:47.650426Z | [https://crates.io/api/v1/crates/cargo-nextest](https://crates.io/api/v1/crates/cargo-nextest) |  |
| preview | known | 0.9.132-rc.3 | 2026-03-20T23:38:42.481835Z | [https://crates.io/api/v1/crates/cargo-nextest](https://crates.io/api/v1/crates/cargo-nextest) |  |

## Engineering Notes

- Treat category as `testing_framework` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/cargo-nextest` at `2026-09-01T02:12:59+00:00`.
...
- `master-32f4ff5548e5` from `master_json` as `testing_framework`
