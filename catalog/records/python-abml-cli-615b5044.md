...
<!-- canonical: https://pypi.org/project/abml-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abml-cli/](https://pypi.org/project/abml-cli/) |
| Source record ids | pypi_simple-e17e8bbe9b2a86 |

## System Engineer Summary

abml-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, abml-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.19 | 2023-10-18T18:34:42.939194Z | [https://pypi.org/pypi/abml-cli/json](https://pypi.org/pypi/abml-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abml-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-e17e8bbe9b2a86` from `pypi_simple` as `registry_expansion`
