...
<!-- canonical: https://github.com/apple/swift-nio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apple/swift-nio](https://github.com/apple/swift-nio) |
| Source record ids | github_search_swift-d3f5f79fe863fe |

## System Engineer Summary

Event-driven network application framework for high performance protocol servers & clients, non-
blocking.

## Operational Role

For a systems engineer, apple/swift-nio belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T11:10:23Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-d3f5f79fe863fe` from `github_search_swift` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ordo-one/benchmark | Benchmarking | [open](swift-ordo-one-benchmark-1abb4df6.md) |
