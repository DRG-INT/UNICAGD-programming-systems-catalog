...
| Source record ids | corpus-c1d7a79b63e0ca |

## System Engineer Summary

Acorn is tracked as a parser lexer ast record in the Node.js/JavaScript branch. The source did not
...
For a systems engineer, Acorn belongs in the Node.js/JavaScript inventory as part of language
...
- `corpus-c1d7a79b63e0ca` from `master_json` as `parser_lexer_ast`
