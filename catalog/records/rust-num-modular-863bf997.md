...
| Canonical URL | [https://crates.io/crates/num-modular](https://crates.io/crates/num-modular) |
| Source record ids | crates_io-6ff620783326d1 |

## System Engineer Summary

Implementation of efficient integer division and modular arithmetic operations with generic number
types. Supports various backends including num-bigint, etc..

## Operational Role

For a systems engineer, num-modular belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2026-08-08T09:15:15.912001Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-6ff620783326d1` from `crates_io` as `registry_expansion`
