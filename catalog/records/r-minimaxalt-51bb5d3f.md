...
<!-- canonical: https://cran.r-project.org/web/packages/minimaxALT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/minimaxALT/index.html](https://cran.r-project.org/web/packages/minimaxALT/index.html) |
| Source record ids | cran_packages_by_date-89cd7bb83b2919 |
...
For a systems engineer, minimaxALT belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-31 19:50:07 UTC | [https://cran.r-project.org/web/packages/minimaxALT/DESCRIPTION](https://cran.r-project.org/web/packages/minimaxALT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/minimaxALT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-89cd7bb83b2919` from `cran_packages_by_date` as `registry_expansion`
