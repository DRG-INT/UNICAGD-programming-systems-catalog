...
| Canonical URL | [https://crates.io/crates/glib](https://crates.io/crates/glib) |
| Source record ids | crates_io-b4f067181db1d6 |
...
For a systems engineer, glib belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.9 | 2026-08-30T17:44:33.970299Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-b4f067181db1d6` from `crates_io` as `registry_expansion`
