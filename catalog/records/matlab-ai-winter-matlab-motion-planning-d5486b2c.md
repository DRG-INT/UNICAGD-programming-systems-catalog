...
<!-- canonical: https://github.com/ai-winter/matlab_motion_planning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ai-winter/matlab_motion_planning](https://github.com/ai-winter/matlab_motion_planning) |
| Source record ids | github_search_matlab-86be34f763fab5 |

## System Engineer Summary

Motion planning and Navigation of AGV/AMR：matlab implementation of Dijkstra, A*, Theta*, JPS, D*,
LPA*, D* Lite, RRT, RRT*, RRT-Connect, Informed RRT*, ACO, Voronoi, PID, LQR, MPC, APF, RPP, DWA,
DDPG, Bezier, B-spline, Dubins, Reeds-Shepp etc.

## Operational Role

For a systems engineer, ai-winter/matlab_motion_planning belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-03T09:05:56Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-86be34f763fab5` from `github_search_matlab` as `registry_expansion`
