...
<!-- canonical: https://github.com/juandagilc/Audio-Effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/juandagilc/Audio-Effects](https://github.com/juandagilc/Audio-Effects) |
| Source record ids | github_search_effects-2c11fa14b65780 |

## System Engineer Summary

Collection of audio effects plugins implemented from the explanations in the book "Audio Effects:
Theory, Implementation and Application" by Joshua D. Reiss and Andrew P. McPherson.

## Operational Role

For a systems engineer, juandagilc/Audio-Effects belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-16T22:00:18Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2c11fa14b65780` from `github_search_effects` as `registry_expansion`
