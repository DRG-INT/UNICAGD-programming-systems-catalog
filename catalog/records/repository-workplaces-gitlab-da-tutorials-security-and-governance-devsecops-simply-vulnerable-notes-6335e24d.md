# gitlab-da/tutorials/security-and-governance/devsecops/simply-vulnerable-notes
...
<!-- canonical: https://gitlab.com/gitlab-da/tutorials/security-and-governance/devsecops/simply-vulnerable-notes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-da/tutorials/security-and-governance/devsecops/simply-vulnerable-notes](https://gitlab.com/gitlab-da/tutorials/security-and-governance/devsecops/simply-vulnerable-notes) |
| Source record ids | gitlab_projects_api-af0a5be5362e8a |

## System Engineer Summary

This basic note-taking application is used to showcase the different GitLab features around security
and governance. To get started checkout the .

## Operational Role

For a systems engineer, gitlab-da/tutorials/security-and-governance/devsecops/simply-vulnerable-
notes belongs in the Repository Workplaces inventory as part of supply-chain review, vulnerability
detection, and release gate enforcement.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-11T13:11:18.025Z | [https://gitlab.com/api/v4/projects?search=security&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=security&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-af0a5be5362e8a` from `gitlab_projects_api` as `registry_expansion`
