...
<!-- canonical: https://github.com/sueda/redmax -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sueda/redmax](https://github.com/sueda/redmax) |
| Source record ids | github_search_physics_engines-a29a3808d0de66 |
...
For a systems engineer, sueda/redmax belongs in the Physics Engines inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-15T15:21:49Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-a29a3808d0de66` from `github_search_physics_engines` as `registry_expansion`
