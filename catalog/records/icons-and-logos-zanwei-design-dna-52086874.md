...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/zanwei/design-dna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zanwei/design-dna](https://github.com/zanwei/design-dna) |
| Source record ids | github_search_icons_and_logos-5fe6245500bd3c |

## System Engineer Summary

Turn reference UIs (images, screenshots, URLs) into quantified Design DNA JSON—tokens, qualitative
style, visual effects—then generate matching UI from your content.

## Operational Role

For a systems engineer, zanwei/design-dna belongs in the Icons and Logos inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T01:58:49Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-5fe6245500bd3c` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| elrumordelaluz/svgson | Serialization | [open](icons-and-logos-elrumordelaluz-svgson-e98eeaa1.md) |
| muan/unicode-emoji-json | Serialization | [open](icons-and-logos-muan-unicode-emoji-json-7291ae74.md) |
| taksssss/iptv-tool | Serialization | [open](icons-and-logos-taksssss-iptv-tool-93823a46.md) |
