...
<!-- canonical: https://hackage.haskell.org/package/either -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/either](https://hackage.haskell.org/package/either) |
| Source record ids | hackage_top_downloads-38282902b0a727 |
...
For a systems engineer, either belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.3 | 2025-06-17T11:53:15Z | [https://hackage.haskell.org/package/either](https://hackage.haskell.org/package/either) |  |
| candidate | partial | 5 |  | [https://hackage.haskell.org/package/either](https://hackage.haskell.org/package/either) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/either` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-38282902b0a727` from `hackage_top_downloads` as `registry_expansion`
