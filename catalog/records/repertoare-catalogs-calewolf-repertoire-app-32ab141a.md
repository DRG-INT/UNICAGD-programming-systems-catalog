# calewolf/Repertoire_App

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/calewolf/Repertoire_App -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/calewolf/Repertoire_App](https://github.com/calewolf/Repertoire_App) |
| Source record ids | github_search_repertoare_catalogs-810a6420b80494 |

## System Engineer Summary

CS125 Final Project. An Android app that enables musicians to keep track of repertoire by logging
practice and performance minutes and song information.

## Operational Role

For a systems engineer, calewolf/Repertoire_App belongs in the Repertoare Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-12-08T04:29:55Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-810a6420b80494` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| benory/Concert-database-website | Formatter | [open](repertoare-catalogs-benory-concert-database-website-07737f0b.md) |
