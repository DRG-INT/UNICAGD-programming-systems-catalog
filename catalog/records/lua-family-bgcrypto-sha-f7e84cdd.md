...
<!-- canonical: https://luarocks.org/modules/moteus/bgcrypto-sha -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moteus/bgcrypto-sha](https://luarocks.org/modules/moteus/bgcrypto-sha) |
| Source record ids | luarocks_root_manifest-ea7db5fdccd07e |
...
For a systems engineer, bgcrypto-sha belongs in the Lua family inventory as part of confidentiality,
...
- `luarocks_root_manifest-ea7db5fdccd07e` from `luarocks_root_manifest` as `registry_expansion`
