...
<!-- canonical: https://crates.io/crates/petgraph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/petgraph](https://crates.io/crates/petgraph) |
| Source record ids | crates_io-61c4b0fd1cfc67 |
...
For a systems engineer, petgraph belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2025-09-30T13:16:04.011947Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-61c4b0fd1cfc67` from `crates_io` as `registry_expansion`
