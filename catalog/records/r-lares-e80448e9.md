...
<!-- canonical: https://cran.r-project.org/web/packages/lares/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lares/index.html](https://cran.r-project.org/web/packages/lares/index.html) |
| Source record ids | cran_packages_by_date-57ef99fc5590ba |
...
For a systems engineer, lares belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.1 | 2026-08-28 08:10:02 UTC | [https://cran.r-project.org/web/packages/lares/DESCRIPTION](https://cran.r-project.org/web/packages/lares/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lares/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57ef99fc5590ba` from `cran_packages_by_date` as `registry_expansion`
