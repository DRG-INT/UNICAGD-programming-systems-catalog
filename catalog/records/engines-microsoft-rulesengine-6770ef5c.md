...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/microsoft/RulesEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/RulesEngine](https://github.com/microsoft/RulesEngine) |
| Source record ids | github_search_engines-24f89bcd67a3b4 |
...
For a systems engineer, microsoft/RulesEngine belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T10:11:09Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-24f89bcd67a3b4` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CacheControl/json-rules-engine | Lint Rule Pack | [open](engines-cachecontrol-json-rules-engine-77e7cfed.md) |
| mithunsatheesh/node-rules | Lint Rule Pack | [open](engines-mithunsatheesh-node-rules-09384125.md) |
