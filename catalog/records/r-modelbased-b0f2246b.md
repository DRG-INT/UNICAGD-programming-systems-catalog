...
<!-- canonical: https://cran.r-project.org/web/packages/modelbased/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modelbased/index.html](https://cran.r-project.org/web/packages/modelbased/index.html) |
| Source record ids | cran_packages_by_date-e385aec66d4b52 |
...
For a systems engineer, modelbased belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.0 | 2026-08-28 11:00:02 UTC | [https://cran.r-project.org/web/packages/modelbased/DESCRIPTION](https://cran.r-project.org/web/packages/modelbased/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modelbased/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e385aec66d4b52` from `cran_packages_by_date` as `registry_expansion`
