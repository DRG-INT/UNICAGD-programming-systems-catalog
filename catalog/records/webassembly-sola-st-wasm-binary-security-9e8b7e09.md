...
| Source record ids | github_search_webassembly-1b5890881d7f4d |

## System Engineer Summary

sola-st/wasm-binary-security is tracked as a security sast record in the WebAssembly branch. The
...
- `github_search_webassembly-1b5890881d7f4d` from `github_search_webassembly` as `registry_expansion`
