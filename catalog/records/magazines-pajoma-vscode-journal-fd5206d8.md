...
<!-- canonical: https://github.com/pajoma/vscode-journal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pajoma/vscode-journal](https://github.com/pajoma/vscode-journal) |
| Source record ids | github_search_magazines-81f672cbf88496 |
...
For a systems engineer, pajoma/vscode-journal belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T20:30:19Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-81f672cbf88496` from `github_search_magazines` as `registry_expansion`
