...
<!-- canonical: https://pub.dev/packages/unicons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/unicons](https://pub.dev/packages/unicons) |
| Source record ids | pub_dev-809fae0a6df2dc |
...
For a systems engineer, unicons belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-08-27T00:11:02.581226Z | [https://pub.dev/api/packages/unicons](https://pub.dev/api/packages/unicons) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/unicons` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-809fae0a6df2dc` from `pub_dev` as `registry_expansion`
