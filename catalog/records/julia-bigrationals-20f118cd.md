...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BigRationals -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BigRationals", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-174634f7d0135f` from `julia_general` as `registry_expansion`
