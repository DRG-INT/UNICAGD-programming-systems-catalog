...
<!-- canonical: https://cran.r-project.org/web/packages/randompack/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/randompack/index.html](https://cran.r-project.org/web/packages/randompack/index.html) |
| Source record ids | cran_packages_by_date-57e72186368ff7 |
...
For a systems engineer, randompack belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.10 | 2026-08-24 08:10:02 UTC | [https://cran.r-project.org/web/packages/randompack/DESCRIPTION](https://cran.r-project.org/web/packages/randompack/DESCRIPTION) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Other; MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/randompack/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57e72186368ff7` from `cran_packages_by_date` as `registry_expansion`
