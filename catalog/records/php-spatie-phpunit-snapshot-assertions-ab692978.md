...
<!-- canonical: https://packagist.org/packages/spatie/phpunit-snapshot-assertions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spatie/phpunit-snapshot-assertions](https://packagist.org/packages/spatie/phpunit-snapshot-assertions) |
| Source record ids | packagist_search-e5f8aa86d76a9b |
...
For a systems engineer, spatie/phpunit-snapshot-assertions belongs in the PHP inventory as part of
...
- `packagist_search-e5f8aa86d76a9b` from `packagist_search` as `registry_expansion`
