...
<!-- canonical: https://github.com/MITHaystack/srt-py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MITHaystack/srt-py](https://github.com/MITHaystack/srt-py) |
| Source record ids | github_search_telescopes-129589fc329797 |

## System Engineer Summary

MITHaystack/srt-py is tracked as a library record in the Telescopes branch. The source did not
...
For a systems engineer, MITHaystack/srt-py belongs in the Telescopes inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-02T19:26:23Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_telescopes-129589fc329797` from `github_search_telescopes` as `registry_expansion`
