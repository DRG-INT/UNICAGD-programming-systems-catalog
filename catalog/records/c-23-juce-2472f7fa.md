...
| Source record ids | corpus-3862499b665b57 |

## System Engineer Summary

JUCE is tracked as an image audio dsp record in the C++23 branch. The source did not provide a long
...
For a systems engineer, JUCE belongs in the C++23 inventory as part of ecosystem capability mapping,
...
- `corpus-3862499b665b57` from `master_json` as `image_audio_dsp`
