...
<!-- canonical: https://crates.io/crates/tokio-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-postgres](https://crates.io/crates/tokio-postgres) |
| Source record ids | crates_io-a72ed7bd04d2f6 |
...
For a systems engineer, tokio-postgres belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.18 | 2026-06-12T15:39:21.848936Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a72ed7bd04d2f6` from `crates_io` as `registry_expansion`
