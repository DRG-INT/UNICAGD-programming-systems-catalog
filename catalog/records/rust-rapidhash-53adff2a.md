...
| Canonical URL | [https://crates.io/crates/rapidhash](https://crates.io/crates/rapidhash) |
| Source record ids | crates_io-4d35e5fafd3705 |
...
For a systems engineer, rapidhash belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.1 | 2026-07-03T23:22:24.832297Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-4d35e5fafd3705` from `crates_io` as `registry_expansion`
