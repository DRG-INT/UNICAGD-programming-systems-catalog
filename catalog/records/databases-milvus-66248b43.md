...
| Source record ids | curated_database_systems-6364de1a562d93 |

## System Engineer Summary

Vector database for similarity search and AI retrieval workloads.

## Operational Role

For a systems engineer, Milvus belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.0 | 2026-07-29T14:27:06Z | [https://api.github.com/repos/milvus-io/milvus/releases/latest](https://api.github.com/repos/milvus-io/milvus/releases/latest) |  |
| preview | known | client/v3.0.0-beta | 2026-07-19T14:35:01Z | [https://api.github.com/repos/milvus-io/milvus/releases?per_page=10](https://api.github.com/repos/milvus-io/milvus/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/milvus-io/milvus/releases/latest` at `2026-09-01T07:24:50+00:00`.
...
- `curated_database_systems-6364de1a562d93` from `curated_database_systems` as `registry_expansion`
