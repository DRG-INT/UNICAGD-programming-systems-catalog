...
<!-- canonical: https://github.com/mawinkler/uptonight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mawinkler/uptonight](https://github.com/mawinkler/uptonight) |
| Source record ids | github_search_telescopes-52198b46f30812 |
...
For a systems engineer, mawinkler/uptonight belongs in the Telescopes inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7 | 2026-04-11T10:00:38Z | [https://api.github.com/repos/mawinkler/uptonight/releases/latest](https://api.github.com/repos/mawinkler/uptonight/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mawinkler/uptonight/releases/latest` at `2026-09-01T11:22:16+00:00`.
...
- `github_search_telescopes-52198b46f30812` from `github_search_telescopes` as `registry_expansion`
