...
<!-- canonical: https://github.com/HazyResearch/safari -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HazyResearch/safari](https://github.com/HazyResearch/safari) |
| Source record ids | github_search_assembly-044258e61718e6 |
...
For a systems engineer, HazyResearch/safari belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-13T21:57:14Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-044258e61718e6` from `github_search_assembly` as `registry_expansion`
