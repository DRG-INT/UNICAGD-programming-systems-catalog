...
<!-- canonical: https://github.com/davidmoten/rxjava2-jdbc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/davidmoten/rxjava2-jdbc](https://github.com/davidmoten/rxjava2-jdbc) |
| Source record ids | github_search_databases-e183b9e9ae6353 |
...
For a systems engineer, davidmoten/rxjava2-jdbc belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T17:04:38Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e183b9e9ae6353` from `github_search_databases` as `registry_expansion`
...
| tokio-rs/rdbc | Async Runtime | [open](databases-tokio-rs-rdbc-9ff423ba.md) |
