...
<!-- canonical: https://cran.r-project.org/web/packages/DTWUMI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DTWUMI/index.html](https://cran.r-project.org/web/packages/DTWUMI/index.html) |
| Source record ids | cran_packages_by_date-6825becea1e054 |
...
For a systems engineer, DTWUMI belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-09-09 08:40:08 UTC | [https://cran.r-project.org/web/packages/DTWUMI/DESCRIPTION](https://cran.r-project.org/web/packages/DTWUMI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DTWUMI/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-6825becea1e054` from `cran_packages_by_date` as `registry_expansion`
