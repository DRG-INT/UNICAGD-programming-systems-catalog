...
| Source record ids | corpus-e8449487875c71 |

## System Engineer Summary

Boost.Spirit is tracked as a parser lexer ast record in the C++23 branch. The source did not provide
...
For a systems engineer, Boost.Spirit belongs in the C++23 inventory as part of language tooling,
...
- `corpus-e8449487875c71` from `master_json` as `parser_lexer_ast`
