...
<!-- canonical: https://github.com/nodejs/node -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nodejs/node](https://github.com/nodejs/node) |
| Source record ids | curated_repository_workplace_routes-426cc8bae6fd66 |

## System Engineer Summary

Official Node.js runtime source repository route.

## Operational Role

For a systems engineer, Node.js Source Route belongs in the Repository Workplaces inventory as part
...
- `curated_repository_workplace_routes-426cc8bae6fd66` from `curated_repository_workplace_routes` as `registry_expansion`
