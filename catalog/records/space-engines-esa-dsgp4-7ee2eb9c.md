...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | github_search_space_engines-debb0c6343bac6 |
...
For a systems engineer, esa/dSGP4 belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.3.0 | 2026-08-07T13:58:05Z | [https://api.github.com/repos/esa/dSGP4/releases/latest](https://api.github.com/repos/esa/dSGP4/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/esa/dSGP4/releases/latest` at `2026-09-01T07:24:17+00:00`.
...
- `github_search_space_engines-debb0c6343bac6` from `github_search_space_engines` as `registry_expansion`
