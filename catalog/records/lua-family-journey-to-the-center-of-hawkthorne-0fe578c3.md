...
<!-- canonical: https://github.com/hawkthorne/hawkthorne-journey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hawkthorne/hawkthorne-journey](https://github.com/hawkthorne/hawkthorne-journey) |
| Source record ids | lua-source-144 |

## System Engineer Summary

2D platformer based on Community's episode, made with LÖVE.

## Operational Role

For a systems engineer, Journey to the Center of Hawkthorne belongs in the Lua family inventory as
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 144}}` |
...
- `lua-source-144` from `master_json` as `source_list_item`
