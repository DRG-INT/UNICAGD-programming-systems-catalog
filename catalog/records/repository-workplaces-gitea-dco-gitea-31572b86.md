...
<!-- canonical: https://gitea.com/dco/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/dco/gitea](https://gitea.com/dco/gitea) |
| Source record ids | gitea_repositories_api-cd77c68f1ad95f |
...
For a systems engineer, Gitea: dco/gitea belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-26T06:22:29Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-cd77c68f1ad95f` from `gitea_repositories_api` as `registry_expansion`
...
| Gitea: kapil786151/gitea | Package Manager | [open](repository-workplaces-gitea-kapil786151-gitea-13e88d87.md) |
