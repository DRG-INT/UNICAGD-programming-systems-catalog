...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aristoteleo/spateo-release -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aristoteleo/spateo-release](https://github.com/aristoteleo/spateo-release) |
| Source record ids | github_search_microscopy-17038fae79dbc7 |
...
For a systems engineer, aristoteleo/spateo-release belongs in the Microscopy inventory as part of
device constraints, cross-compilation, driver behavior, and field upgrades.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-25T23:25:40Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:cell-segmentation stars:>20", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_microscopy-17038fae79dbc7` from `github_search_microscopy` as `registry_expansion`
