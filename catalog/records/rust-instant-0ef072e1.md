...
<!-- canonical: https://crates.io/crates/instant -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/instant](https://crates.io/crates/instant) |
| Source record ids | crates_io-3df99ec751159c |

## System Engineer Summary

Unmaintained, consider using web-time instead - A partial replacement for std::time::Instant that
works on WASM to.

## Operational Role

For a systems engineer, instant belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.13 | 2024-05-17T19:56:13.760985Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-3df99ec751159c` from `crates_io` as `registry_expansion`
