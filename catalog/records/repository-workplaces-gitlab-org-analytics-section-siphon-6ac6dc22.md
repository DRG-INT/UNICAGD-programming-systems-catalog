...
<!-- canonical: https://gitlab.com/gitlab-org/analytics-section/siphon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/analytics-section/siphon](https://gitlab.com/gitlab-org/analytics-section/siphon) |
| Source record ids | gitlab_projects_api-ec6de6b028d172 |

## System Engineer Summary

Siphon is an application written in `golang` which can be used to synchronize data from a PostgreSQL
database to other data stores by reading the PostgreSQL logical replication stream.

## Operational Role

For a systems engineer, gitlab-org/analytics-section/siphon belongs in the Repository Workplaces
...
- `gitlab_projects_api-ec6de6b028d172` from `gitlab_projects_api` as `registry_expansion`
