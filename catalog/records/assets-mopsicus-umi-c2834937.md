...
<!-- canonical: https://github.com/mopsicus/umi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mopsicus/umi](https://github.com/mopsicus/umi) |
| Source record ids | github_search_assets-0c4c00b3e974b0 |

## System Engineer Summary

Unity mobile input (UMI) plugin for Android and iOS, allows to use features of mobile native input
fields

## Operational Role

For a systems engineer, mopsicus/umi belongs in the Assets inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-04T08:07:01Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-0c4c00b3e974b0` from `github_search_assets` as `registry_expansion`
