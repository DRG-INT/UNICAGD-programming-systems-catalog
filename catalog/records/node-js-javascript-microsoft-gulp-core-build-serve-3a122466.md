...
<!-- canonical: https://www.npmjs.com/package/@microsoft/gulp-core-build-serve -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@microsoft/gulp-core-build-serve](https://www.npmjs.com/package/@microsoft/gulp-core-build-serve) |
| Source record ids | npm_registry-80764be179e97e |

## System Engineer Summary

`gulp-core-build-serve` is a `gulp-core-build` subtask for testing/serving web content on the
localhost, and live reloading it when things change.

## Operational Role

For a systems engineer, @microsoft/gulp-core-build-serve belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.13.0 | 2024-09-16T02:01:59.516Z | [https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
