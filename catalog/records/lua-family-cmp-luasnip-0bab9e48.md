...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp_luasnip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp_luasnip](https://luarocks.org/modules/neorocks/cmp_luasnip) |
| Source record ids | luarocks_root_manifest-55c78dba879d7a |
...
For a systems engineer, cmp_luasnip belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-55c78dba879d7a` from `luarocks_root_manifest` as `registry_expansion`
