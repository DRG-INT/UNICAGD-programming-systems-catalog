...
<!-- canonical: https://github.com/elemaudio/elementary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elemaudio/elementary](https://github.com/elemaudio/elementary) |
| Source record ids | github_search_effects-ccabe5020ab4a2 |
...
For a systems engineer, elemaudio/elementary belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-19T19:25:43Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ccabe5020ab4a2` from `github_search_effects` as `registry_expansion`
