...
<!-- canonical: https://cran.r-project.org/web/packages/rtpcr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rtpcr/index.html](https://cran.r-project.org/web/packages/rtpcr/index.html) |
| Source record ids | cran_packages_by_date-873fd27935f3fd |

## System Engineer Summary

rtpcr is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, rtpcr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.9 | 2026-08-21 07:00:02 UTC | [https://cran.r-project.org/web/packages/rtpcr/DESCRIPTION](https://cran.r-project.org/web/packages/rtpcr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rtpcr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-873fd27935f3fd` from `cran_packages_by_date` as `registry_expansion`
