...
<!-- canonical: https://cran.r-project.org/web/packages/RProtoBuf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RProtoBuf/index.html](https://cran.r-project.org/web/packages/RProtoBuf/index.html) |
| Source record ids | cran_packages_by_date-07e14944c131e3 |
...
For a systems engineer, RProtoBuf belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.28 | 2026-08-21 22:01:25 UTC | [https://cran.r-project.org/web/packages/RProtoBuf/DESCRIPTION](https://cran.r-project.org/web/packages/RProtoBuf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RProtoBuf/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-07e14944c131e3` from `cran_packages_by_date` as `registry_expansion`
