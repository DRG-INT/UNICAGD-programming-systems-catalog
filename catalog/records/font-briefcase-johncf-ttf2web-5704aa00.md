...
<!-- canonical: https://github.com/johncf/ttf2web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/johncf/ttf2web](https://github.com/johncf/ttf2web) |
| Source record ids | github_search_font_briefcase-5050999435d49d |
...
For a systems engineer, johncf/ttf2web belongs in the Font Briefcase inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-01-30T09:42:03Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-5050999435d49d` from `github_search_font_briefcase` as `registry_expansion`
