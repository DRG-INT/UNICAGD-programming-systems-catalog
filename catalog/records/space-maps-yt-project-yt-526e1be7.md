...
<!-- canonical: https://github.com/yt-project/yt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yt-project/yt](https://github.com/yt-project/yt) |
| Source record ids | github_search_space_maps-b1462c6527bf8c |

## System Engineer Summary

yt-project/yt is tracked as a parser lexer ast record in the Space Maps branch. The source did not
...
For a systems engineer, yt-project/yt belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T19:02:20Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Eclipse Public License 1.0; https://api.github.com/licenses/epl-1.0; Other |
...
- `github_search_space_maps-b1462c6527bf8c` from `github_search_space_maps` as `registry_expansion`
