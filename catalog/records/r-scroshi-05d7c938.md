...
<!-- canonical: https://cran.r-project.org/web/packages/scROSHI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scROSHI/index.html](https://cran.r-project.org/web/packages/scROSHI/index.html) |
| Source record ids | cran_packages_by_date-9219b9008dc113 |
...
For a systems engineer, scROSHI belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.1 | 2026-09-09 14:00:02 UTC | [https://cran.r-project.org/web/packages/scROSHI/DESCRIPTION](https://cran.r-project.org/web/packages/scROSHI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scROSHI/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-9219b9008dc113` from `cran_packages_by_date` as `registry_expansion`
