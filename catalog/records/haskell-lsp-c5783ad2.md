...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Language Server](../by-category/language-server.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/lsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/lsp](https://hackage.haskell.org/package/lsp) |
| Source record ids | hackage_top_downloads-148fd7e20b41ae |
...
For a systems engineer, lsp belongs in the Haskell inventory as part of editor intelligence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0.0 | 2026-02-17T10:12:25Z | [https://hackage.haskell.org/package/lsp](https://hackage.haskell.org/package/lsp) |  |
| candidate | partial | 1.0.0.0 |  | [https://hackage.haskell.org/package/lsp](https://hackage.haskell.org/package/lsp) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/lsp` at `2026-09-09T00:35:06+00:00`.
...
- `hackage_top_downloads-148fd7e20b41ae` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| haskell-lsp | Language Server | [open](haskell-haskell-lsp-04b985b1.md) |
| haskell-lsp-types | Language Server | [open](haskell-haskell-lsp-types-6668820c.md) |
| lsp-test | Language Server | [open](haskell-lsp-test-d5a7e9ed.md) |
| lsp-types | Language Server | [open](haskell-lsp-types-f97ca895.md) |
