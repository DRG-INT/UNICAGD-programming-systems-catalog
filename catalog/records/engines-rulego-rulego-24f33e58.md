...
<!-- canonical: https://github.com/rulego/rulego -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rulego/rulego](https://github.com/rulego/rulego) |
| Source record ids | github_search_engines-d0ea05959d22a8 |

## System Engineer Summary

⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule
engine framework for Go.

## Operational Role

For a systems engineer, rulego/rulego belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T06:15:36Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-d0ea05959d22a8` from `github_search_engines` as `registry_expansion`
