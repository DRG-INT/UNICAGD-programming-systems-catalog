...
<!-- canonical: https://gitlab.com/sofreeus/introtodevops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/sofreeus/introtodevops](https://gitlab.com/sofreeus/introtodevops) |
| Source record ids | gitlab_projects_api-162ef133387547 |

## System Engineer Summary

Introduction to DevOps: Zero to Hero? Or Dive Bar to Superstar?

## Operational Role

For a systems engineer, sofreeus/introtodevops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-06T17:07:00.042Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-162ef133387547` from `gitlab_projects_api` as `registry_expansion`
