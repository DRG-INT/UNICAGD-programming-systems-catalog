...
<!-- canonical: https://github.com/GrapheneOS/Camera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GrapheneOS/Camera](https://github.com/GrapheneOS/Camera) |
| Source record ids | github_search_photography-36f5de0b1e90b9 |
...
For a systems engineer, GrapheneOS/Camera belongs in the Photography inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T20:43:08Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-36f5de0b1e90b9` from `github_search_photography` as `registry_expansion`
