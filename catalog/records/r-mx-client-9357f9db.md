...
<!-- canonical: https://cran.r-project.org/web/packages/mx.client/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mx.client/index.html](https://cran.r-project.org/web/packages/mx.client/index.html) |
| Source record ids | cran_packages_by_date-9715e6fd1071df |
...
For a systems engineer, mx.client belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-04 22:10:08 UTC | [https://cran.r-project.org/web/packages/mx.client/DESCRIPTION](https://cran.r-project.org/web/packages/mx.client/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mx.client/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9715e6fd1071df` from `cran_packages_by_date` as `registry_expansion`
