...
<!-- canonical: https://crates.io/crates/tikv-jemallocator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tikv-jemallocator](https://crates.io/crates/tikv-jemallocator) |
| Source record ids | crates_io-00127f30c23549 |
...
For a systems engineer, tikv-jemallocator belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-05-25T17:14:14.038227Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-00127f30c23549` from `crates_io` as `registry_expansion`
