...
<!-- canonical: https://crates.io/crates/hkdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hkdf](https://crates.io/crates/hkdf) |
| Source record ids | crates_io-6c65ee0e06551f |
...
For a systems engineer, hkdf belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.0 | 2026-03-30T14:36:50.965552Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-6c65ee0e06551f` from `crates_io` as `registry_expansion`
