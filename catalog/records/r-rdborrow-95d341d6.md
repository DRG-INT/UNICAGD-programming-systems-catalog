...
<!-- canonical: https://cran.r-project.org/web/packages/rdborrow/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rdborrow/index.html](https://cran.r-project.org/web/packages/rdborrow/index.html) |
| Source record ids | cran_packages_by_date-8d19378b2750b5 |
...
For a systems engineer, rdborrow belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4.0 | 2026-08-31 14:00:10 UTC | [https://cran.r-project.org/web/packages/rdborrow/DESCRIPTION](https://cran.r-project.org/web/packages/rdborrow/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rdborrow/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8d19378b2750b5` from `cran_packages_by_date` as `registry_expansion`
