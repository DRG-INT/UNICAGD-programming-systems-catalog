...
<!-- canonical: https://cran.r-project.org/web/packages/occCite/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/occCite/index.html](https://cran.r-project.org/web/packages/occCite/index.html) |
| Source record ids | cran_packages_by_date-e588c5ac249184 |
...
For a systems engineer, occCite belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2026-09-01 16:00:02 UTC | [https://cran.r-project.org/web/packages/occCite/DESCRIPTION](https://cran.r-project.org/web/packages/occCite/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/occCite/DESCRIPTION` at `2026-09-01T16:41:04+00:00`.
...
- `cran_packages_by_date-e588c5ac249184` from `cran_packages_by_date` as `registry_expansion`
