...
<!-- canonical: https://github.com/plattysoft/Leonids -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/plattysoft/Leonids](https://github.com/plattysoft/Leonids) |
| Source record ids | github_search_effects-c57527012f3280 |
...
For a systems engineer, plattysoft/Leonids belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2016-09-19T22:04:39Z | [https://api.github.com/repos/plattysoft/Leonids/releases/latest](https://api.github.com/repos/plattysoft/Leonids/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/plattysoft/Leonids/releases/latest` at `2026-09-01T09:23:13+00:00`.
...
- `github_search_effects-c57527012f3280` from `github_search_effects` as `registry_expansion`
