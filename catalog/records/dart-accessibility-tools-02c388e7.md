...
<!-- canonical: https://pub.dev/packages/accessibility_tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/accessibility_tools](https://pub.dev/packages/accessibility_tools) |
| Source record ids | pub_dev-499eb814d24f93 |

## System Engineer Summary

Checkers and tools to ensure your app is accessible to all. Ensures your app is accessible from day
one, by checking your interface as you build it.

## Operational Role

For a systems engineer, accessibility_tools belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.0 | 2025-11-13T10:37:26.877158Z | [https://pub.dev/api/packages/accessibility_tools](https://pub.dev/api/packages/accessibility_tools) |  |
| preview | known | 0.0.1-dev.0 | 2022-11-28T14:05:25.492210Z | [https://pub.dev/api/packages/accessibility_tools](https://pub.dev/api/packages/accessibility_tools) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/accessibility_tools` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-499eb814d24f93` from `pub_dev` as `registry_expansion`
...
| checks | Build System | [open](dart-checks-a600eaef.md) |
