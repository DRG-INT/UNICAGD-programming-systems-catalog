...
| Canonical URL | [https://github.com/arda-guler/LETALIS](https://github.com/arda-guler/LETALIS) |
| Source record ids | github_search_space_engines-16f71b1042dd3d |
...
For a systems engineer, arda-guler/LETALIS belongs in the Space Engines inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | R4 | 2023-09-16T14:55:06Z | [https://api.github.com/repos/arda-guler/LETALIS/releases/latest](https://api.github.com/repos/arda-guler/LETALIS/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/arda-guler/LETALIS/releases/latest` at `2026-09-01T07:24:15+00:00`.
...
- `github_search_space_engines-16f71b1042dd3d` from `github_search_space_engines` as `registry_expansion`
