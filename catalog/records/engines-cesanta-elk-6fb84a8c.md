...
<!-- canonical: https://github.com/cesanta/elk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cesanta/elk](https://github.com/cesanta/elk) |
| Source record ids | github_search_engines-2f7a25d5471825 |
...
For a systems engineer, cesanta/elk belongs in the Engines inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-18T17:59:48Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-2f7a25d5471825` from `github_search_engines` as `registry_expansion`
