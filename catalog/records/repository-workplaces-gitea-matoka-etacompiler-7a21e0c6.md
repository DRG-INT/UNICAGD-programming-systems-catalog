...
<!-- canonical: https://gitea.com/matoka/etaCompiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/matoka/etaCompiler](https://gitea.com/matoka/etaCompiler) |
| Source record ids | gitea_repositories_api-f88b0a1465d9d3 |

## System Engineer Summary

Eta/Rho compiler designed in course CS4120 of Cornell University. Just for record. No use without
permission allowed.

## Operational Role

For a systems engineer, Gitea: matoka/etaCompiler belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-25T03:01:55Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f88b0a1465d9d3` from `gitea_repositories_api` as `registry_expansion`
