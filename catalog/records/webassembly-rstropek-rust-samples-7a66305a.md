...
| Canonical URL | [https://github.com/rstropek/rust-samples](https://github.com/rstropek/rust-samples) |
| Source record ids | github_search_webassembly-c8b7e50245f537 |

## System Engineer Summary

rstropek/rust-samples is tracked as a library record in the WebAssembly branch. The source did not
...
For a systems engineer, rstropek/rust-samples belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-c8b7e50245f537` from `github_search_webassembly` as `registry_expansion`
