...
<!-- canonical: https://github.com/tzaeschke/tinspin-indexes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tzaeschke/tinspin-indexes](https://github.com/tzaeschke/tinspin-indexes) |
| Source record ids | github_search_catalogs-f2914db8fbcd9d |
...
For a systems engineer, tzaeschke/tinspin-indexes belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T17:22:43Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-f2914db8fbcd9d` from `github_search_catalogs` as `registry_expansion`
