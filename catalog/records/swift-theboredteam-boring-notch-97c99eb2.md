...
<!-- canonical: https://github.com/TheBoredTeam/boring.notch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheBoredTeam/boring.notch](https://github.com/TheBoredTeam/boring.notch) |
| Source record ids | github_search_swift-5b54cfcb0453a2 |
...
For a systems engineer, TheBoredTeam/boring.notch belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T07:24:40Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-5b54cfcb0453a2` from `github_search_swift` as `registry_expansion`
