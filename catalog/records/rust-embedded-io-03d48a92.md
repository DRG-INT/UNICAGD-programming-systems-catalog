...
<!-- canonical: https://crates.io/crates/embedded-io -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/embedded-io](https://crates.io/crates/embedded-io) |
| Source record ids | crates_io-abcdf5041e245e |

## System Engineer Summary

embedded-io is tracked as a machine learning record in the Rust branch. The source did not provide a
...
For a systems engineer, embedded-io belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2025-10-01T10:36:11.222774Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-abcdf5041e245e` from `crates_io` as `registry_expansion`
