...
<!-- canonical: https://cran.r-project.org/web/packages/palettecore/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/palettecore/index.html](https://cran.r-project.org/web/packages/palettecore/index.html) |
| Source record ids | cran_packages_by_date-e2730b0f7326a8 |
...
For a systems engineer, palettecore belongs in the R inventory as part of supply-chain review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-09 08:10:02 UTC | [https://cran.r-project.org/web/packages/palettecore/DESCRIPTION](https://cran.r-project.org/web/packages/palettecore/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/palettecore/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e2730b0f7326a8` from `cran_packages_by_date` as `registry_expansion`
