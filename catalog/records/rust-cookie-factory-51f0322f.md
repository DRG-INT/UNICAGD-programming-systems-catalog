...
| Canonical URL | [https://crates.io/crates/cookie-factory](https://crates.io/crates/cookie-factory) |
| Source record ids | crates_io-0061f9173912f0 |
...
For a systems engineer, cookie-factory belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2024-03-21T20:34:06.291708Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-0061f9173912f0` from `crates_io` as `registry_expansion`
