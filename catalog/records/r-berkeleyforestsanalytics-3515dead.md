...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/index.html](https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/index.html) |
| Source record ids | cran_packages_by_date-5ca76c697be037 |

## System Engineer Summary

Compute and Summarize Core Forest Metrics from Field Data

## Operational Role

For a systems engineer, BerkeleyForestsAnalytics belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-09-05 05:20:02 UTC | [https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/DESCRIPTION](https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BerkeleyForestsAnalytics/DESCRIPTION` at `2026-09-05T06:22:48+00:00`.
...
- `cran_packages_by_date-5ca76c697be037` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| sanitizers | Sanitizer | [open](r-sanitizers-6dfa61d8.md) |
