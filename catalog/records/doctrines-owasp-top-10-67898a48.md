...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Doctrines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/doctrines.md) · [Category: Security Sast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/security-sast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)

## Identity

| Field | Value |
| --- | --- |
| Language branch | Doctrines |
| Category | Security Sast |
| Source type | registry_expansion |
| Verification | registry-derived |
| Canonical URL | [https://owasp.org/www-project-top-ten/](https://owasp.org/www-project-top-ten/) |
| Source record ids | curated_language_routes-02787df61cf8e5 |

## System Engineer Summary

Common web application risk doctrine and education route.

## Operational Role

For a systems engineer, OWASP Top 10 belongs in the Doctrines inventory as part of supply-chain
...
- `curated_language_routes-02787df61cf8e5` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CISA Secure by Design | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-cisa-secure-by-design-0e2f29c4.md) |
| MITRE ATT&CK | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-mitre-att-ck-d776b071.md) |
| NIST Cybersecurity Framework | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-nist-cybersecurity-framework-46fe6bb8.md) |
| NIST Secure Software Development Framework | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-nist-secure-software-development-framework-d3fed9ea.md) |
| NIST SP 800-218 | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-nist-sp-800-218-01a8a158.md) |
| NIST SP 800-53 | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-nist-sp-800-53-de2208e3.md) |
| OpenSSF Best Practices Badge | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-openssf-best-practices-badge-bbb89a65.md) |
| OpenSSF Scorecard | Security Sast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/doctrines-openssf-scorecard-88328b4b.md) |
