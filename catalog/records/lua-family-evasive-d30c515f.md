...
| Canonical URL | [https://luarocks.org/modules/code-nuage/evasive](https://luarocks.org/modules/code-nuage/evasive) |
| Source record ids | luarocks_root_manifest-a92f6d4a5d8db6 |

## System Engineer Summary

evasive is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, evasive belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a92f6d4a5d8db6` from `luarocks_root_manifest` as `registry_expansion`
