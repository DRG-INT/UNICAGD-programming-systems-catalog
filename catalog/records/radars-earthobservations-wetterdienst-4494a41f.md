...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/earthobservations/wetterdienst -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/earthobservations/wetterdienst](https://github.com/earthobservations/wetterdienst) |
| Source record ids | github_search_radars-3053e37e78c698 |
...
For a systems engineer, earthobservations/wetterdienst belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T19:49:15Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3053e37e78c698` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 16EAGLE/getSpatialData | Library | [open](radars-16eagle-getspatialdata-2135beaa.md) |
| acconeer/acconeer-python-exploration | Library | [open](radars-acconeer-acconeer-python-exploration-c570151f.md) |
| AlexeyPechnikov/pygmtsar | Library | [open](radars-alexeypechnikov-pygmtsar-07358760.md) |
| anilca/NetTrader.Indicator | Library | [open](radars-anilca-nettrader-indicator-20301495.md) |
| anxiangsir/urban_seg | Library | [open](radars-anxiangsir-urban-seg-9978d84d.md) |
| aresys-srl/sct | Library | [open](radars-aresys-srl-sct-ec34e249.md) |
| benzenemo/TightlyCoupledINSGNSS | Library | [open](radars-benzenemo-tightlycoupledinsgnss-400a89e0.md) |
| bopen/xarray-sentinel | Library | [open](radars-bopen-xarray-sentinel-d49585c9.md) |
