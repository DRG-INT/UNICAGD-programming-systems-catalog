...
<!-- canonical: https://packagist.org/packages/iamcal/sql-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/iamcal/sql-parser](https://packagist.org/packages/iamcal/sql-parser) |
| Source record ids | packagist_search-2defb951b13069 |

## System Engineer Summary

iamcal/sql-parser is tracked as a parser lexer ast record in the PHP branch. The source did not
...
For a systems engineer, iamcal/sql-parser belongs in the PHP inventory as part of language tooling,
...
- `packagist_search-2defb951b13069` from `packagist_search` as `registry_expansion`
