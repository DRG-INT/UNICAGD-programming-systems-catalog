# SPerrott22/Deepcell-to-QuPath

## Navigation

[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/SPerrott22/Deepcell-to-QuPath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SPerrott22/Deepcell-to-QuPath](https://github.com/SPerrott22/Deepcell-to-QuPath) |
| Source record ids | github_search_microscopy-a1e7ec701175dc |

## System Engineer Summary

pipeline that converts Deepcell generated instance segmentation masks of nuclei from an ome-tiff to
Cell Objects with auto-generated cytoplasms in QuPath

## Operational Role

For a systems engineer, SPerrott22/Deepcell-to-QuPath belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-26T00:18:52Z | gh search repos topic:ome-tiff stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT No Attribution; https://api.github.com/licenses/mit-0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:ome-tiff stars:>5", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_microscopy-a1e7ec701175dc` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AntonotnaWang/3DCellSeg | Package Manager | [open](microscopy-antonotnawang-3dcellseg-f26edf96.md) |
| ciccalab/SIMPLI | Package Manager | [open](microscopy-ciccalab-simpli-f44ea336.md) |
| DeepTrackAI/DeepTrack2 | Package Manager | [open](microscopy-deeptrackai-deeptrack2-c4bed0ae.md) |
| hallvaaw/awesome-biological-image-analysis | Package Manager | [open](microscopy-hallvaaw-awesome-biological-image-analysis-b00b91fa.md) |
| lachlanchen/OpenHI | Package Manager | [open](microscopy-lachlanchen-openhi-6563c12a.md) |
| nf-core/mcmicro | Package Manager | [open](microscopy-nf-core-mcmicro-5fb60926.md) |
| nf-core/spatialvi | Package Manager | [open](microscopy-nf-core-spatialvi-764d8d93.md) |
