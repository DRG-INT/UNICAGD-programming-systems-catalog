...
<!-- canonical: https://cran.r-project.org/web/packages/spatialkit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spatialkit/index.html](https://cran.r-project.org/web/packages/spatialkit/index.html) |
| Source record ids | cran_packages_by_date-5051208dce9a78 |
...
For a systems engineer, spatialkit belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-07 16:40:02 UTC | [https://cran.r-project.org/web/packages/spatialkit/DESCRIPTION](https://cran.r-project.org/web/packages/spatialkit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spatialkit/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5051208dce9a78` from `cran_packages_by_date` as `registry_expansion`
