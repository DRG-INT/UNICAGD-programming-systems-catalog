...
<!-- canonical: https://pub.dev/packages/flutter_rust_bridge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_rust_bridge](https://pub.dev/packages/flutter_rust_bridge) |
| Source record ids | pub_dev-ac565d1abec683 |
...
For a systems engineer, flutter_rust_bridge belongs in the Dart inventory as part of cross-language
...
| preview | known | 2.13.0-beta.6 | 2026-08-08T08:24:48.483276Z | [https://pub.dev/api/packages/flutter_rust_bridge](https://pub.dev/api/packages/flutter_rust_bridge) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_rust_bridge` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-ac565d1abec683` from `pub_dev` as `registry_expansion`
