...
| Canonical URL | [https://crates.io/crates/dispatch](https://crates.io/crates/dispatch) |
| Source record ids | crates_io-c3fddb90c20842 |
...
For a systems engineer, dispatch belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2020-01-19T06:24:11.514318Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-c3fddb90c20842` from `crates_io` as `registry_expansion`
