...
<!-- canonical: https://github.com/commsor/titanoboa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/commsor/titanoboa](https://github.com/commsor/titanoboa) |
| Source record ids | github_search_engines-e037c137cec16e |

## System Engineer Summary

Titanoboa makes complex workflows easy. It is a low-code workflow orchestration platform for JVM -
distributed, highly scalable and fault tolerant.

## Operational Role

For a systems engineer, commsor/titanoboa belongs in the Engines inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-16T12:57:43Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-e037c137cec16e` from `github_search_engines` as `registry_expansion`
