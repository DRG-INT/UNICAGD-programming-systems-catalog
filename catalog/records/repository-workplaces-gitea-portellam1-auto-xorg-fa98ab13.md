...
<!-- canonical: https://gitea.com/portellam1/auto-xorg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/portellam1/auto-xorg](https://gitea.com/portellam1/auto-xorg) |
| Source record ids | gitea_repositories_api-a10171661b24d0 |

## System Engineer Summary

Automatically set the proper video output given a video device (VGA) is unavailable due to hardware-
passthrough (VFIO) or any other reason, in the X.Org display environment for a Linux machine.

## Operational Role

For a systems engineer, Gitea: portellam1/auto-xorg belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-05T02:32:02Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-a10171661b24d0` from `gitea_repositories_api` as `registry_expansion`
