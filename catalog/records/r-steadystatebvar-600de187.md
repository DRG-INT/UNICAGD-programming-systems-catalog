...
<!-- canonical: https://cran.r-project.org/web/packages/SteadyStateBVAR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SteadyStateBVAR/index.html](https://cran.r-project.org/web/packages/SteadyStateBVAR/index.html) |
| Source record ids | cran_packages_by_date-04c17b327ce89d |
...
For a systems engineer, SteadyStateBVAR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 02:40:26 UTC | [https://cran.r-project.org/web/packages/SteadyStateBVAR/DESCRIPTION](https://cran.r-project.org/web/packages/SteadyStateBVAR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SteadyStateBVAR/DESCRIPTION` at `2026-09-15T03:22:13+00:00`.
...
- `cran_packages_by_date-04c17b327ce89d` from `cran_packages_by_date` as `registry_expansion`
