...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://ascom-standards.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://ascom-standards.org/](https://ascom-standards.org/) |
| Source record ids | curated_language_routes-0a8a3d4f59e19b |

## System Engineer Summary

Astronomy device-control standards and driver ecosystem for telescopes, cameras, focusers, domes,
and observatory automation.

## Operational Role

For a systems engineer, ASCOM Initiative belongs in the Telescopes inventory as part of ecosystem
...
- `curated_language_routes-0a8a3d4f59e19b` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| INDI Library | Interop Bindings | [open](telescopes-indi-library-b3b4aa6c.md) |
