...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Effects](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/effects.md) · [Category: Interop Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interop-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://openeffects.org/](https://openeffects.org/) |
| Source record ids | curated_language_routes-82b42d7ec06715 |

## System Engineer Summary

Open plug-in API for visual effects hosts and image-processing effects.

## Operational Role

For a systems engineer, OpenFX belongs in the Effects inventory as part of ecosystem capability
...
- `curated_language_routes-82b42d7ec06715` from `curated_language_routes` as `registry_expansion`
