...
<!-- canonical: https://gitea.com/deathrashed/Icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/deathrashed/Icons](https://gitea.com/deathrashed/Icons) |
| Source record ids | gitea_repositories_api-31d2f1ad7abdce |

## System Engineer Summary

A collection of icons — PNG, SVG, ICNS formats for apps, folders, services, and more. (60,000+)

## Operational Role

For a systems engineer, Gitea: deathrashed/Icons belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-25T12:18:00Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-31d2f1ad7abdce` from `gitea_repositories_api` as `registry_expansion`
