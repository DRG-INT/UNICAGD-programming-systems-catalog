...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/keerah/SendTo_FFmpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keerah/SendTo_FFmpeg](https://github.com/keerah/SendTo_FFmpeg) |
| Source record ids | github_search_video-720b3dc63c0f7b |

## System Engineer Summary

Zero-dependency FFmpeg-based batch framework for repetitive and bulk high-quality transcoding in one
click

## Operational Role

For a systems engineer, keerah/SendTo_FFmpeg belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-23T05:48:03Z | gh search repos topic:video-encoding stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-720b3dc63c0f7b` from `github_search_video` as `registry_expansion`
