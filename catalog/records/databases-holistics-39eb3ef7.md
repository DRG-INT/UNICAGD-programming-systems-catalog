...
<!-- canonical: https://www.holistics.io/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.holistics.io/](https://www.holistics.io/) |
| Source record ids | awesome_list-520206db805584 |

## System Engineer Summary

Online cross platform database management tool and SQL query reporting GUI with strong PostgreSQL
support (Commercial Software).

## Operational Role

For a systems engineer, Holistics belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-520206db805584` from `awesome_list` as `registry_expansion`
