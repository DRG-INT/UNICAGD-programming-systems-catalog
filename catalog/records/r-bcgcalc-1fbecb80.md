...
<!-- canonical: https://cran.r-project.org/web/packages/BCGcalc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BCGcalc/index.html](https://cran.r-project.org/web/packages/BCGcalc/index.html) |
| Source record ids | cran_packages_by_date-8b08f3d729ec5e |
...
For a systems engineer, BCGcalc belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-08-08 10:30:02 UTC | [https://cran.r-project.org/web/packages/BCGcalc/DESCRIPTION](https://cran.r-project.org/web/packages/BCGcalc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BCGcalc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8b08f3d729ec5e` from `cran_packages_by_date` as `registry_expansion`
