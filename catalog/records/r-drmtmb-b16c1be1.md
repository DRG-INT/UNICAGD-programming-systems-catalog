...
<!-- canonical: https://cran.r-project.org/web/packages/drmTMB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/drmTMB/index.html](https://cran.r-project.org/web/packages/drmTMB/index.html) |
| Source record ids | cran_packages_by_date-fc6dcf090eb9ab |

## System Engineer Summary

Distributional Regression Models Using Template Model Builder

## Operational Role

For a systems engineer, drmTMB belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-09-15 11:00:29 UTC | [https://cran.r-project.org/web/packages/drmTMB/DESCRIPTION](https://cran.r-project.org/web/packages/drmTMB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/drmTMB/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-fc6dcf090eb9ab` from `cran_packages_by_date` as `registry_expansion`
