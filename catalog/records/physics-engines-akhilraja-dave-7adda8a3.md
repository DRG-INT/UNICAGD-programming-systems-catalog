...
<!-- canonical: https://github.com/AkhilRaja/Dave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AkhilRaja/Dave](https://github.com/AkhilRaja/Dave) |
| Source record ids | github_search_physics_engines-f237ee9db70d21 |
...
For a systems engineer, AkhilRaja/Dave belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-13T20:50:49Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f237ee9db70d21` from `github_search_physics_engines` as `registry_expansion`
