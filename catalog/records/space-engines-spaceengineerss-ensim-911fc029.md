...
| Canonical URL | [https://github.com/SpaceEngineerSS/EnSim](https://github.com/SpaceEngineerSS/EnSim) |
| Source record ids | github_search_space_engines-f9d5e0b1ff65e3 |

## System Engineer Summary

🚀 Professional rocket engine simulation & 6-DOF flight analysis platform. NASA CEA validated
thermochemistry, real-time performance calculations, Monte Carlo dispersion analysis.

## Operational Role

For a systems engineer, SpaceEngineerSS/EnSim belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.0.1 | 2026-08-20T16:06:16Z | [https://api.github.com/repos/SpaceEngineerSS/EnSim/releases/latest](https://api.github.com/repos/SpaceEngineerSS/EnSim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/SpaceEngineerSS/EnSim/releases/latest` at `2026-09-01T07:24:20+00:00`.
...
- `github_search_space_engines-f9d5e0b1ff65e3` from `github_search_space_engines` as `registry_expansion`
