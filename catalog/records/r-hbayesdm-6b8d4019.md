...
<!-- canonical: https://cran.r-project.org/web/packages/hBayesDM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hBayesDM/index.html](https://cran.r-project.org/web/packages/hBayesDM/index.html) |
| Source record ids | cran_packages_by_date-c5291e7e411de5 |
...
For a systems engineer, hBayesDM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-01 12:30:12 UTC | [https://cran.r-project.org/web/packages/hBayesDM/DESCRIPTION](https://cran.r-project.org/web/packages/hBayesDM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hBayesDM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c5291e7e411de5` from `cran_packages_by_date` as `registry_expansion`
