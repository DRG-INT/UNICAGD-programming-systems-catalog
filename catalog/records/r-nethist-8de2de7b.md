...
<!-- canonical: https://cran.r-project.org/web/packages/nethist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nethist/index.html](https://cran.r-project.org/web/packages/nethist/index.html) |
| Source record ids | cran_packages_by_date-18930658429c55 |

## System Engineer Summary

nethist is tracked as a networking http record in the R branch. The source did not provide a long
...
For a systems engineer, nethist belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-02 11:30:02 UTC | [https://cran.r-project.org/web/packages/nethist/DESCRIPTION](https://cran.r-project.org/web/packages/nethist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nethist/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-18930658429c55` from `cran_packages_by_date` as `registry_expansion`
...
| densemlp | Networking Http | [open](r-densemlp-e5e46ec2.md) |
