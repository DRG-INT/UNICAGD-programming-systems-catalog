...
<!-- canonical: https://crates.io/crates/zerocopy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zerocopy](https://crates.io/crates/zerocopy) |
| Source record ids | crates_io-ae933518a0953c |
...
For a systems engineer, zerocopy belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.57 | 2026-09-08T21:40:04.359293Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads` at `2026-09-08T22:19:09+00:00`.
...
- `crates_io-ae933518a0953c` from `crates_io` as `registry_expansion`
