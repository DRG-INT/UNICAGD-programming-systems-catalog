...
<!-- canonical: https://cran.r-project.org/web/packages/groupedHyperframe/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/groupedHyperframe/index.html](https://cran.r-project.org/web/packages/groupedHyperframe/index.html) |
| Source record ids | cran_packages_by_date-825e7633c28e28 |
...
For a systems engineer, groupedHyperframe belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.5 | 2026-08-25 22:00:02 UTC | [https://cran.r-project.org/web/packages/groupedHyperframe/DESCRIPTION](https://cran.r-project.org/web/packages/groupedHyperframe/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/groupedHyperframe/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-825e7633c28e28` from `cran_packages_by_date` as `registry_expansion`
