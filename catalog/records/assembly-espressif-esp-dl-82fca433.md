...
| Canonical URL | [https://github.com/espressif/esp-dl](https://github.com/espressif/esp-dl) |
| Source record ids | github_search_assembly-5203b5deba4395 |
...
For a systems engineer, espressif/esp-dl belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.2.0 | 2025-10-23T06:23:34Z | [https://api.github.com/repos/espressif/esp-dl/releases/latest](https://api.github.com/repos/espressif/esp-dl/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/espressif/esp-dl/releases/latest` at `2026-09-01T10:25:49+00:00`.
...
- `github_search_assembly-5203b5deba4395` from `github_search_assembly` as `registry_expansion`
