...
<!-- canonical: https://pub.dev/packages/flutter_advanced_drawer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_advanced_drawer](https://pub.dev/packages/flutter_advanced_drawer) |
| Source record ids | pub_dev-821a2b1bdd818f |
...
For a systems engineer, flutter_advanced_drawer belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2025-05-01T07:22:26.137965Z | [https://pub.dev/api/packages/flutter_advanced_drawer](https://pub.dev/api/packages/flutter_advanced_drawer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_advanced_drawer` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-821a2b1bdd818f` from `pub_dev` as `registry_expansion`
