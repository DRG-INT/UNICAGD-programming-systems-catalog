...
| Canonical URL | [https://github.com/osm-search/Nominatim](https://github.com/osm-search/Nominatim) |
| Source record ids | curated_language_routes-4ce428354ad0dc |

## System Engineer Summary

OpenStreetMap geocoder and search engine for address/place lookup and reverse geocoding.

## Operational Role

For a systems engineer, Nominatim belongs in the Maps inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.3.2 | 2026-04-19T09:05:04Z | [https://api.github.com/repos/osm-search/Nominatim/releases/latest](https://api.github.com/repos/osm-search/Nominatim/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/osm-search/Nominatim/releases/latest` at `2026-09-01T07:24:43+00:00`.
...
- `curated_language_routes-4ce428354ad0dc` from `curated_language_routes` as `registry_expansion`
