...
<!-- canonical: https://luarocks.org/modules/nullromo/cash.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nullromo/cash.nvim](https://luarocks.org/modules/nullromo/cash.nvim) |
| Source record ids | luarocks_root_manifest-aec64b1ad650b5 |

## System Engineer Summary

Extra search registers, each with its own highlight color

## Operational Role

For a systems engineer, cash.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-aec64b1ad650b5` from `luarocks_root_manifest` as `registry_expansion`
