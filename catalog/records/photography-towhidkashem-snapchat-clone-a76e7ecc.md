...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TowhidKashem/snapchat-clone -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TowhidKashem/snapchat-clone](https://github.com/TowhidKashem/snapchat-clone) |
| Source record ids | github_search_photography-ced59ce95cd8b0 |

## System Engineer Summary

👻 A Snapchat clone built with React and Redux. Written in Typescript. Styled with SASS. Tested with
Cypress, Jest and Enzyme. Linted with Eslint and formatted with Prettier!

## Operational Role

For a systems engineer, TowhidKashem/snapchat-clone belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-12T00:27:16Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-ced59ce95cd8b0` from `github_search_photography` as `registry_expansion`
