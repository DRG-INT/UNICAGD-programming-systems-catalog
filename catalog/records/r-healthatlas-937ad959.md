...
<!-- canonical: https://cran.r-project.org/web/packages/healthatlas/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/healthatlas/index.html](https://cran.r-project.org/web/packages/healthatlas/index.html) |
| Source record ids | cran_packages_by_date-f2fbf065d22bec |
...
For a systems engineer, healthatlas belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-08-21 05:42:58 UTC | [https://cran.r-project.org/web/packages/healthatlas/DESCRIPTION](https://cran.r-project.org/web/packages/healthatlas/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/healthatlas/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f2fbf065d22bec` from `cran_packages_by_date` as `registry_expansion`
