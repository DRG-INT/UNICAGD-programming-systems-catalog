...
<!-- canonical: https://crates.io/crates/pkcs1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pkcs1](https://crates.io/crates/pkcs1) |
| Source record ids | crates_io-2c6232c65175e1 |

## System Engineer Summary

Pure Rust implementation of Public-Key Cryptography Standards (PKCS) #1: RSA Cryptography
Specifications Version 2.2 (RFC 8017)

## Operational Role

For a systems engineer, pkcs1 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.5 | 2025-09-15T22:56:14.318972Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-2c6232c65175e1` from `crates_io` as `registry_expansion`
