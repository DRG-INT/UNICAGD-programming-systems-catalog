...
<!-- canonical: https://hackage.haskell.org/package/kit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/kit](https://hackage.haskell.org/package/kit) |
| Source record ids | hackage_top_downloads-44088e498ee497 |
...
For a systems engineer, kit belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.12 | 2013-02-06T02:01:45Z | [https://hackage.haskell.org/package/kit](https://hackage.haskell.org/package/kit) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kit` at `2026-09-09T00:35:05+00:00`.
...
- `hackage_top_downloads-44088e498ee497` from `hackage_top_downloads` as `registry_expansion`
