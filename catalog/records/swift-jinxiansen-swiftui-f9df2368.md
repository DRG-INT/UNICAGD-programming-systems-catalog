...
<!-- canonical: https://github.com/Jinxiansen/SwiftUI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jinxiansen/SwiftUI](https://github.com/Jinxiansen/SwiftUI) |
| Source record ids | github_search_swift-afcf8cc7e0e29f |
...
For a systems engineer, Jinxiansen/SwiftUI belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-17T16:47:54Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-afcf8cc7e0e29f` from `github_search_swift` as `registry_expansion`
