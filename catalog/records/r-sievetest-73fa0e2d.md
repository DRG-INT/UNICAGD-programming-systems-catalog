...
<!-- canonical: https://cran.r-project.org/web/packages/sievetest/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sievetest/index.html](https://cran.r-project.org/web/packages/sievetest/index.html) |
| Source record ids | cran_packages_by_date-88fd62ae5345df |
...
For a systems engineer, sievetest belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.4 | 2026-09-03 15:40:02 UTC | [https://cran.r-project.org/web/packages/sievetest/DESCRIPTION](https://cran.r-project.org/web/packages/sievetest/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sievetest/DESCRIPTION` at `2026-09-03T17:18:57+00:00`.
...
- `cran_packages_by_date-88fd62ae5345df` from `cran_packages_by_date` as `registry_expansion`
