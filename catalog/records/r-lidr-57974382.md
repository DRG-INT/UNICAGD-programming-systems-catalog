...
<!-- canonical: https://cran.r-project.org/web/packages/lidR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lidR/index.html](https://cran.r-project.org/web/packages/lidR/index.html) |
| Source record ids | cran_packages_by_date-c38736ca797db2 |
...
For a systems engineer, lidR belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.3 | 2026-09-15 22:10:08 UTC | [https://cran.r-project.org/web/packages/lidR/DESCRIPTION](https://cran.r-project.org/web/packages/lidR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lidR/DESCRIPTION` at `2026-09-15T22:19:01+00:00`.
...
- `cran_packages_by_date-c38736ca797db2` from `cran_packages_by_date` as `registry_expansion`
