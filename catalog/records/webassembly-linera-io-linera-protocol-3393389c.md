...
<!-- canonical: https://github.com/linera-io/linera-protocol -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/linera-io/linera-protocol](https://github.com/linera-io/linera-protocol) |
| Source record ids | github_search_webassembly-dd4056df50f3ef |
...
For a systems engineer, linera-io/linera-protocol belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:58:51Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-dd4056df50f3ef` from `github_search_webassembly` as `registry_expansion`
