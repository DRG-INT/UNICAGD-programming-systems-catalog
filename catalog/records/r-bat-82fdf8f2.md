...
<!-- canonical: https://cran.r-project.org/web/packages/BAT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BAT/index.html](https://cran.r-project.org/web/packages/BAT/index.html) |
| Source record ids | cran_packages_by_date-62c7b208669834 |
...
For a systems engineer, BAT belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.3 | 2026-08-26 13:50:02 UTC | [https://cran.r-project.org/web/packages/BAT/DESCRIPTION](https://cran.r-project.org/web/packages/BAT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BAT/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-62c7b208669834` from `cran_packages_by_date` as `registry_expansion`
