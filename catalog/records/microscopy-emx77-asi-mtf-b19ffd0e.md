...
| Canonical URL | [https://github.com/emx77/ASI_MTF](https://github.com/emx77/ASI_MTF) |
| Source record ids | github_search_microscopy-9e2a74bd5bebce |
...
For a systems engineer, emx77/ASI_MTF belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2020-10-26T09:32:00Z | [https://api.github.com/repos/emx77/ASI_MTF/releases/latest](https://api.github.com/repos/emx77/ASI_MTF/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/emx77/ASI_MTF/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
- `github_search_microscopy-9e2a74bd5bebce` from `github_search_microscopy` as `registry_expansion`
