...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Catalogs](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/catalogs.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://libraries.io/](https://libraries.io/) |
| Source record ids | curated_language_routes-2719a7dcd862f7 |

## System Engineer Summary

Open-source package catalog route for dependency metadata, releases, package managers, repositories,
and ecosystem search.

## Operational Role

For a systems engineer, Libraries.io belongs in the Catalogs inventory as part of ecosystem
...
- `curated_language_routes-2719a7dcd862f7` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Backstage Software Catalog | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-backstage-software-catalog-65fa83e8.md) |
| CKAN | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-ckan-265fba92.md) |
| DataHub | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-datahub-fc4a0261.md) |
| Ecosyste.ms | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-ecosyste-ms-b04b4db1.md) |
| OpenAPI Directory | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-openapi-directory-1693bcf6.md) |
| OpenMetadata | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-openmetadata-f48d69a5.md) |
| SPDX License List | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/catalogs-spdx-license-list-ea4e5cc6.md) |
