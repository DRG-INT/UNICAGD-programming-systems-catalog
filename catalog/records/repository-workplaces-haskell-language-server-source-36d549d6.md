# Haskell Language Server Source
...
<!-- canonical: https://github.com/haskell/haskell-language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/haskell/haskell-language-server](https://github.com/haskell/haskell-language-server) |
| Source record ids | curated_repository_workplace_routes-3f29e920f8bd4a |

## System Engineer Summary

Official Haskell Language Server source route.

## Operational Role

For a systems engineer, Haskell Language Server Source belongs in the Repository Workplaces
...
- `curated_repository_workplace_routes-3f29e920f8bd4a` from `curated_repository_workplace_routes` as `registry_expansion`
