...
<!-- canonical: https://github.com/fluent-plugins-nursery/fluent-plugin-systemd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fluent-plugins-nursery/fluent-plugin-systemd](https://github.com/fluent-plugins-nursery/fluent-plugin-systemd) |
| Source record ids | github_search_magazines-dcafd1be5236af |
...
For a systems engineer, fluent-plugins-nursery/fluent-plugin-systemd belongs in the Magazines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T00:40:53Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-dcafd1be5236af` from `github_search_magazines` as `registry_expansion`
...
| PostOwl/postowl | Logging Observability | [open](magazines-postowl-postowl-41c9b3d1.md) |
