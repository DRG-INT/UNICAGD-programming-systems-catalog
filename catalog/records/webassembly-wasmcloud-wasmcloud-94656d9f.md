...
<!-- canonical: https://github.com/wasmCloud/wasmCloud -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmCloud/wasmCloud](https://github.com/wasmCloud/wasmCloud) |
| Source record ids | github_search_webassembly-6b320e6fd2e63a |

## System Engineer Summary

wasmCloud is an open source Cloud Native Computing Foundation (CNCF) project that enables teams to
build, manage, and scale polyglot apps across any cloud, K8s, or edge.

## Operational Role

For a systems engineer, wasmCloud/wasmCloud belongs in the WebAssembly inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T19:52:05Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6b320e6fd2e63a` from `github_search_webassembly` as `registry_expansion`
