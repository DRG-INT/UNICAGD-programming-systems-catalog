...
<!-- canonical: https://luarocks.org/modules/cosyverif/cosy-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/cosyverif/cosy-client](https://luarocks.org/modules/cosyverif/cosy-client) |
| Source record ids | luarocks_root_manifest-14602626724588 |

## System Engineer Summary

cosy-client is tracked as a networking http record in the Lua family branch. The source did not
...
For a systems engineer, cosy-client belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-14602626724588` from `luarocks_root_manifest` as `registry_expansion`
