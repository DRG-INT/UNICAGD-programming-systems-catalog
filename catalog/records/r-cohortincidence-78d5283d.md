...
<!-- canonical: https://cran.r-project.org/web/packages/CohortIncidence/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CohortIncidence/index.html](https://cran.r-project.org/web/packages/CohortIncidence/index.html) |
| Source record ids | cran_packages_by_date-8b4f2669c76b21 |

## System Engineer Summary

Cohort Incidence Analysis for the OMOP Common Data Model

## Operational Role

For a systems engineer, CohortIncidence belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-08-25 14:10:02 UTC | [https://cran.r-project.org/web/packages/CohortIncidence/DESCRIPTION](https://cran.r-project.org/web/packages/CohortIncidence/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CohortIncidence/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8b4f2669c76b21` from `cran_packages_by_date` as `registry_expansion`
