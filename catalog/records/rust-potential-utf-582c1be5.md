...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Datetime](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/datetime.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/potential_utf](https://crates.io/crates/potential_utf) |
| Source record ids | crates_io-ddc4e542f19792 |
...
For a systems engineer, potential_utf belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-13T23:28:14.578806Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| alloy-sol-types | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alloy-sol-types-bdf759e0.md) |
| chrono | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-chrono-ecf13070.md) |
| clocksource | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-clocksource-19fe3bcf.md) |
| clru | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-clru-5e85cbe2.md) |
| const-str | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-const-str-1d88b550.md) |
| constant_time_eq | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-constant-time-eq-d38d066f.md) |
| futures-timer | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-futures-timer-fb5f7561.md) |
| gix-features | Datetime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-gix-features-6c36356e.md) |
