...
<!-- canonical: https://gitlab.com/yamagoya/jmdictdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/yamagoya/jmdictdb](https://gitlab.com/yamagoya/jmdictdb) |
| Source record ids | gitlab_projects_api-f169857a306281 |

## System Engineer Summary

A Postgresql database, Python API and web WSGI front-end for storing and maintaining Japanese
dictionary data. For more info see

## Operational Role

For a systems engineer, yamagoya/jmdictdb belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-f169857a306281` from `gitlab_projects_api` as `registry_expansion`
...
| jrmiller82/pathfinder-2-sqlite | Networking Http | [open](repository-workplaces-jrmiller82-pathfinder-2-sqlite-806cf747.md) |
