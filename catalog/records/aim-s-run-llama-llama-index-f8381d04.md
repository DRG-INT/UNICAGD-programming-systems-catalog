...
<!-- canonical: https://github.com/run-llama/llama_index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/run-llama/llama_index](https://github.com/run-llama/llama_index) |
| Source record ids | github_search_aims-e911d0b0447a8e |
...
For a systems engineer, run-llama/llama_index belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:09:01Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-e911d0b0447a8e` from `github_search_aims` as `registry_expansion`
...
| datawhalechina/hello-agents | Machine Learning | [open](aim-s-datawhalechina-hello-agents-7c22b3b1.md) |
