...
<!-- canonical: https://github.com/grizzlypeak3d/DJV -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grizzlypeak3d/DJV](https://github.com/grizzlypeak3d/DJV) |
| Source record ids | github_search_effects-0c9e0f72039b1c |

## System Engineer Summary

Free EXR file viewer. DJV is a free, open-source high bit-depth image sequence player built for
professional film, VFX & animation workflows. Use it for frame-accurate dailies, shot review, and
A/B comparisons. Available for Linux, macOS, and Windows.

## Operational Role

For a systems engineer, grizzlypeak3d/DJV belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T23:24:58Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_effects-0c9e0f72039b1c` from `github_search_effects` as `registry_expansion`
