...
<!-- canonical: https://cran.r-project.org/web/packages/MachineShop/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MachineShop/index.html](https://cran.r-project.org/web/packages/MachineShop/index.html) |
| Source record ids | cran_packages_by_date-6523b1cc1d8b2b |
...
For a systems engineer, MachineShop belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.9.4 | 2026-09-04 15:50:19 UTC | [https://cran.r-project.org/web/packages/MachineShop/DESCRIPTION](https://cran.r-project.org/web/packages/MachineShop/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MachineShop/DESCRIPTION` at `2026-09-04T16:20:41+00:00`.
...
- `cran_packages_by_date-6523b1cc1d8b2b` from `cran_packages_by_date` as `registry_expansion`
