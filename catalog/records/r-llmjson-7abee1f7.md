...
<!-- canonical: https://cran.r-project.org/web/packages/llmjson/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/llmjson/index.html](https://cran.r-project.org/web/packages/llmjson/index.html) |
| Source record ids | cran_packages_by_date-6eb34f3f7e3a23 |
...
For a systems engineer, llmjson belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-03 11:50:18 UTC | [https://cran.r-project.org/web/packages/llmjson/DESCRIPTION](https://cran.r-project.org/web/packages/llmjson/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/llmjson/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-6eb34f3f7e3a23` from `cran_packages_by_date` as `registry_expansion`
