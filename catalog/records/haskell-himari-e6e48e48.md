...
<!-- canonical: https://hackage.haskell.org/package/himari -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/himari](https://hackage.haskell.org/package/himari) |
| Source record ids | hackage_top_downloads-a8c88f76d7a656 |
...
For a systems engineer, himari belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.6.1 | 2026-07-27T02:07:43Z | [https://hackage.haskell.org/package/himari](https://hackage.haskell.org/package/himari) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/himari` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-a8c88f76d7a656` from `hackage_top_downloads` as `registry_expansion`
