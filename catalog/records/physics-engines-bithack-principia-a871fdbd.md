...
<!-- canonical: https://github.com/Bithack/principia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Bithack/principia](https://github.com/Bithack/principia) |
| Source record ids | github_search_physics_engines-cb9cea551c3313 |

## System Engineer Summary

Open source physics-based sandbox game with electronic circuitry, mechanics, robots, puzzles, Lua
scripting and more.

## Operational Role

For a systems engineer, Bithack/principia belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T22:18:21Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; zlib License; https://api.github.com/licenses/zlib; {"key": "", "name": "", "url": ""}; Other |
...
- `github_search_physics_engines-cb9cea551c3313` from `github_search_physics_engines` as `registry_expansion`
