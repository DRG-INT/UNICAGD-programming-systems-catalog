...
<!-- canonical: https://packagist.org/packages/heyosseus/vacuum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/heyosseus/vacuum](https://packagist.org/packages/heyosseus/vacuum) |
| Source record ids | packagist_search-9ae29e9f57f5ee |

## System Engineer Summary

PostgreSQL monitoring for Laravel: wraparound, autovacuum, fillfactor-aware bloat, dead tuples,
cache-hit ratio, stale statistics, and wasted indexes — each with the exact SQL to fix it. Shown,
never run. Blade dashboard or Filament panel.

## Operational Role

For a systems engineer, heyosseus/vacuum belongs in the PHP inventory as part of language tooling,
...
- `packagist_search-9ae29e9f57f5ee` from `packagist_search` as `registry_expansion`
