...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BuildConstructors](https://github.com/JuliaRegistries/General/tree/master/B/BuildConstructors) |
| Source record ids | julia_general-2dbed6acfa593c |

## System Engineer Summary

Julia package registered in General at B/BuildConstructors.

## Operational Role

For a systems engineer, BuildConstructors belongs in the Julia inventory as part of build graph
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BuildConstructors", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-2dbed6acfa593c` from `julia_general` as `registry_expansion`
