...
<!-- canonical: https://cran.r-project.org/web/packages/controlcharts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/controlcharts/index.html](https://cran.r-project.org/web/packages/controlcharts/index.html) |
| Source record ids | cran_packages_by_date-a6cca231dd8321 |
...
For a systems engineer, controlcharts belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.19 | 2026-08-04 10:10:07 UTC | [https://cran.r-project.org/web/packages/controlcharts/DESCRIPTION](https://cran.r-project.org/web/packages/controlcharts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/controlcharts/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a6cca231dd8321` from `cran_packages_by_date` as `registry_expansion`
