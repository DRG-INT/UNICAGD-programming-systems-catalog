...
<!-- canonical: https://crates.io/crates/cfg-if -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cfg-if](https://crates.io/crates/cfg-if) |
| Source record ids | crates_io-35e9dd003c0710 |

## System Engineer Summary

A macro to ergonomically define an item depending on a large number of #cfg parameters. Structured
like an if-else chain, the first matching branch is the item that gets emitted.

## Operational Role

For a systems engineer, cfg-if belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2025-10-15T08:12:46.455816Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-35e9dd003c0710` from `crates_io` as `registry_expansion`
