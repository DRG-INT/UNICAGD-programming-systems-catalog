...
<!-- canonical: https://cran.r-project.org/web/packages/spMC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spMC/index.html](https://cran.r-project.org/web/packages/spMC/index.html) |
| Source record ids | cran_packages_by_date-141ba03ea36f6f |
...
For a systems engineer, spMC belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.16 | 2026-09-05 19:40:02 UTC | [https://cran.r-project.org/web/packages/spMC/DESCRIPTION](https://cran.r-project.org/web/packages/spMC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spMC/DESCRIPTION` at `2026-09-05T20:19:01+00:00`.
...
- `cran_packages_by_date-141ba03ea36f6f` from `cran_packages_by_date` as `registry_expansion`
