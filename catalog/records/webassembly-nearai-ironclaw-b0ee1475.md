...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nearai/ironclaw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nearai/ironclaw](https://github.com/nearai/ironclaw) |
| Source record ids | github_search_webassembly-d16d4f0266fd25 |
...
For a systems engineer, nearai/ironclaw belongs in the WebAssembly inventory as part of supply-chain
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T19:18:18Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-d16d4f0266fd25` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| carverauto/serviceradar | Security Sast | [open](webassembly-carverauto-serviceradar-c01081ce.md) |
| sola-st/wasm-binary-security | Security Sast | [open](webassembly-sola-st-wasm-binary-security-9e8b7e09.md) |
