# hh-hang/three-player-controller
...
<!-- canonical: https://github.com/hh-hang/three-player-controller -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hh-hang/three-player-controller](https://github.com/hh-hang/three-player-controller) |
| Source record ids | github_search_physics_engines-c183192736d3aa |

## System Engineer Summary

A first-person & third-person character controller for three.js

## Operational Role

For a systems engineer, hh-hang/three-player-controller belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T13:47:45Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-c183192736d3aa` from `github_search_physics_engines` as `registry_expansion`
