...
<!-- canonical: https://crates.io/crates/opentelemetry-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/opentelemetry-http](https://crates.io/crates/opentelemetry-http) |
| Source record ids | crates_io-8b756ff433d986 |

## System Engineer Summary

Helper implementations for sending HTTP requests. Uses include propagating and extracting context
over http, exporting telemetry, requesting sampling strategies.

## Operational Role

For a systems engineer, opentelemetry-http belongs in the Rust inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.32.0 | 2026-05-08T23:41:20.917466Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-8b756ff433d986` from `crates_io` as `registry_expansion`
