...
<!-- canonical: https://github.com/PatrickTUM/UnCRtainTS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PatrickTUM/UnCRtainTS](https://github.com/PatrickTUM/UnCRtainTS) |
| Source record ids | github_search_radars-63887ade46a872 |

## System Engineer Summary

PatrickTUM/UnCRtainTS is tracked as a machine learning record in the Radars branch. The source did
...
For a systems engineer, PatrickTUM/UnCRtainTS belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-26T20:19:21Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-63887ade46a872` from `github_search_radars` as `registry_expansion`
