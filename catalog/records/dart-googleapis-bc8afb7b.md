...
<!-- canonical: https://pub.dev/packages/googleapis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/googleapis](https://pub.dev/packages/googleapis) |
| Source record ids | pub_dev-682220645987af |

## System Engineer Summary

Auto-generated client libraries for accessing Google APIs described through the API discovery
service.

## Operational Role

For a systems engineer, googleapis belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 17.0.0 | 2026-08-24T23:12:57.747027Z | [https://pub.dev/api/packages/googleapis](https://pub.dev/api/packages/googleapis) |  |
| preview | known | 1.0.0-beta.0 | 2021-02-05T23:03:09.421208Z | [https://pub.dev/api/packages/googleapis](https://pub.dev/api/packages/googleapis) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/googleapis` at `2026-09-03T17:19:01+00:00`.
...
- `pub_dev-682220645987af` from `pub_dev` as `registry_expansion`
