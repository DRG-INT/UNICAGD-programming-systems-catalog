...
<!-- canonical: https://hackage.haskell.org/package/uri-bytestring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/uri-bytestring](https://hackage.haskell.org/package/uri-bytestring) |
| Source record ids | hackage_top_downloads-9f63c1c63922f5 |
...
For a systems engineer, uri-bytestring belongs in the Haskell inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0.1 | 2025-04-10T16:35:16Z | [https://hackage.haskell.org/package/uri-bytestring](https://hackage.haskell.org/package/uri-bytestring) |  |
| candidate | partial | 0.0.1 |  | [https://hackage.haskell.org/package/uri-bytestring](https://hackage.haskell.org/package/uri-bytestring) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/uri-bytestring` at `2026-09-03T00:34:46+00:00`.
...
- `hackage_top_downloads-9f63c1c63922f5` from `hackage_top_downloads` as `registry_expansion`
