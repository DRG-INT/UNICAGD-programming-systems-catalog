...
<!-- canonical: https://github.com/mikelikesdesign/SwiftUI-experiments -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mikelikesdesign/SwiftUI-experiments](https://github.com/mikelikesdesign/SwiftUI-experiments) |
| Source record ids | github_search_swift-5fa53bce265329 |

## System Engineer Summary

Examples with SwiftUI and other Apple frameworks that showcase various interactions, animations and
more

## Operational Role

For a systems engineer, mikelikesdesign/SwiftUI-experiments belongs in the Swift inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T13:58:37Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-5fa53bce265329` from `github_search_swift` as `registry_expansion`
