...
<!-- canonical: https://hackage.haskell.org/package/ncurses -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ncurses](https://hackage.haskell.org/package/ncurses) |
| Source record ids | hackage_top_downloads-b83ce8a2e19934 |
...
For a systems engineer, ncurses belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.16 | 2016-08-29T01:10:53Z | [https://hackage.haskell.org/package/ncurses](https://hackage.haskell.org/package/ncurses) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ncurses` at `2026-09-09T00:35:07+00:00`.
...
- `hackage_top_downloads-b83ce8a2e19934` from `hackage_top_downloads` as `registry_expansion`
