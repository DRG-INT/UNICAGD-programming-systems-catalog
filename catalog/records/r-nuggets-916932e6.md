...
<!-- canonical: https://cran.r-project.org/web/packages/nuggets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nuggets/index.html](https://cran.r-project.org/web/packages/nuggets/index.html) |
| Source record ids | cran_packages_by_date-f34aed2b222323 |
...
For a systems engineer, nuggets belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.3 | 2026-08-20 13:10:03 UTC | [https://cran.r-project.org/web/packages/nuggets/DESCRIPTION](https://cran.r-project.org/web/packages/nuggets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nuggets/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f34aed2b222323` from `cran_packages_by_date` as `registry_expansion`
