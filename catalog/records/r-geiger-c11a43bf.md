...
<!-- canonical: https://cran.r-project.org/web/packages/geiger/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geiger/index.html](https://cran.r-project.org/web/packages/geiger/index.html) |
| Source record ids | cran_packages_by_date-a0ef3ee7e2da17 |
...
For a systems engineer, geiger belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.12 | 2026-08-31 22:30:08 UTC | [https://cran.r-project.org/web/packages/geiger/DESCRIPTION](https://cran.r-project.org/web/packages/geiger/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geiger/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a0ef3ee7e2da17` from `cran_packages_by_date` as `registry_expansion`
