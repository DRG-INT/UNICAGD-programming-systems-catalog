...
<!-- canonical: https://github.com/zohaibbashir/Google-Maps-Scrapper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zohaibbashir/Google-Maps-Scrapper](https://github.com/zohaibbashir/Google-Maps-Scrapper) |
| Source record ids | github_search_maps-7942b77b65c98d |

## System Engineer Summary

This code is used to perform web scraping and data extraction from Google Maps. It is particularly
designed for obtaining information about businesses, including their name, address, website, phone
number, reviews, and more.

## Operational Role

For a systems engineer, zohaibbashir/Google-Maps-Scrapper belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-18T19:25:40Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7942b77b65c98d` from `github_search_maps` as `registry_expansion`
