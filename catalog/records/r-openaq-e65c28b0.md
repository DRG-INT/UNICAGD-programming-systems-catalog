...
<!-- canonical: https://cran.r-project.org/web/packages/openaq/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/openaq/index.html](https://cran.r-project.org/web/packages/openaq/index.html) |
| Source record ids | cran_packages_by_date-81625c000bcbeb |
...
For a systems engineer, openaq belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-19 23:30:02 UTC | [https://cran.r-project.org/web/packages/openaq/DESCRIPTION](https://cran.r-project.org/web/packages/openaq/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/openaq/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-81625c000bcbeb` from `cran_packages_by_date` as `registry_expansion`
