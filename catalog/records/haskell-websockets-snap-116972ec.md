...
<!-- canonical: https://hackage.haskell.org/package/websockets-snap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/websockets-snap](https://hackage.haskell.org/package/websockets-snap) |
| Source record ids | hackage_top_downloads-feadf5f993088e |
...
For a systems engineer, websockets-snap belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.3.1 | 2019-05-06T11:31:08Z | [https://hackage.haskell.org/package/websockets-snap](https://hackage.haskell.org/package/websockets-snap) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/websockets-snap` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-feadf5f993088e` from `hackage_top_downloads` as `registry_expansion`
