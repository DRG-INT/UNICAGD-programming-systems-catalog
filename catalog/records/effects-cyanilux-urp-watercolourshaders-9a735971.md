...
<!-- canonical: https://github.com/Cyanilux/URP_WatercolourShaders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cyanilux/URP_WatercolourShaders](https://github.com/Cyanilux/URP_WatercolourShaders) |
| Source record ids | github_search_effects-8ad48ebce1f38f |

## System Engineer Summary

💧🎨 Experiments with watercolour-like shader effects. Made using Shader Graph. Unity 2020.1.2f1, URP
8.2.0

## Operational Role

For a systems engineer, Cyanilux/URP_WatercolourShaders belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-28T10:41:44Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8ad48ebce1f38f` from `github_search_effects` as `registry_expansion`
