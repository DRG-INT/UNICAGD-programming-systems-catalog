...
<!-- canonical: https://github.com/celerforge/freenote -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/celerforge/freenote](https://github.com/celerforge/freenote) |
| Source record ids | github_search_magazines-ba5b67103076f0 |

## System Engineer Summary

Freenote is an open-source AI journal app with Markdown support. You can freely record your notes,
and with AI assistance, easily search and summarize past entries, enhancing creativity capture and
management. All data is stored locally on your device, ensuring privacy and security.

## Operational Role

For a systems engineer, celerforge/freenote belongs in the Magazines inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-16T04:38:51Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-3; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_magazines-ba5b67103076f0` from `github_search_magazines` as `registry_expansion`
