...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/xmartlabs/XLActionController -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xmartlabs/XLActionController](https://github.com/xmartlabs/XLActionController) |
| Source record ids | github_search_cocoa-b3e20ea6725294 |
...
For a systems engineer, xmartlabs/XLActionController belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:cocoapods stars:>200", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_cocoa-b3e20ea6725294` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0x.swift | Library | [open](cocoa-0x-swift-08956404.md) |
| @react-native-mapbox-gl-mapbox-mobile-events-static | Library | [open](cocoa-react-native-mapbox-gl-mapbox-mobile-events-static-6813244f.md) |
| @react-native-mapbox-gl-mapbox-static | Library | [open](cocoa-react-native-mapbox-gl-mapbox-static-c3ae4366.md) |
| @react-native-mapbox-gl-mapbox-turf-static | Library | [open](cocoa-react-native-mapbox-gl-mapbox-turf-static-54ef8964.md) |
| AACustomCollectionViewLayouts | Library | [open](cocoa-aacustomcollectionviewlayouts-2326be83.md) |
| Alamofire | Library | [open](cocoa-alamofire-71d81a2b.md) |
| Appz | Library | [open](cocoa-appz-7ff129e8.md) |
| ARKit-CoreLocation | Library | [open](cocoa-arkit-corelocation-9ac024d1.md) |
