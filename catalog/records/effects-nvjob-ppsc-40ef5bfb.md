...
<!-- canonical: https://github.com/nvjob/ppsc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nvjob/ppsc](https://github.com/nvjob/ppsc) |
| Source record ids | github_search_effects-40cf7763b20b66 |
...
For a systems engineer, nvjob/ppsc belongs in the Effects inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-10T11:30:49Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-40cf7763b20b66` from `github_search_effects` as `registry_expansion`
