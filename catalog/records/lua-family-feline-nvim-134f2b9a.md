...
| Canonical URL | [https://luarocks.org/modules/freddiehaddad/feline.nvim](https://luarocks.org/modules/freddiehaddad/feline.nvim) |
| Source record ids | luarocks_root_manifest-e33f8bef0b3f3b |
...
For a systems engineer, feline.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e33f8bef0b3f3b` from `luarocks_root_manifest` as `registry_expansion`
