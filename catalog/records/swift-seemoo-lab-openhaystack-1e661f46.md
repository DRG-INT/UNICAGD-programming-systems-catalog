...
<!-- canonical: https://github.com/seemoo-lab/openhaystack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/seemoo-lab/openhaystack](https://github.com/seemoo-lab/openhaystack) |
| Source record ids | github_search_swift-80a203f8e4d67a |

## System Engineer Summary

Build your own 'AirTags' 🏷 today! Framework for tracking personal Bluetooth devices via Apple's
massive Find My network.

## Operational Role

For a systems engineer, seemoo-lab/openhaystack belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T12:23:59Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_swift-80a203f8e4d67a` from `github_search_swift` as `registry_expansion`
