...
<!-- canonical: https://cran.r-project.org/web/packages/chilemapas/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chilemapas/index.html](https://cran.r-project.org/web/packages/chilemapas/index.html) |
| Source record ids | cran_packages_by_date-db8cb564a33679 |

## System Engineer Summary

Mapas De Las Divisiones Politicas y Administrativas De Chile (Maps of the Political and
Administrative Divisions of Chile)

## Operational Role

For a systems engineer, chilemapas belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-09-08 13:30:23 UTC | [https://cran.r-project.org/web/packages/chilemapas/DESCRIPTION](https://cran.r-project.org/web/packages/chilemapas/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chilemapas/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-db8cb564a33679` from `cran_packages_by_date` as `registry_expansion`
