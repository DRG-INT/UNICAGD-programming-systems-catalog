...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/zjoooooo/galaxy-explorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zjoooooo/galaxy-explorer](https://github.com/zjoooooo/galaxy-explorer) |
| Source record ids | github_search_space_maps-d825e3ace79cef |

## System Engineer Summary

🌌 An interactive, procedurally-generated Milky Way galaxy in the browser — WebGL / three.js, no
backend, no build step. MIT licensed.

## Operational Role

For a systems engineer, zjoooooo/galaxy-explorer belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-04T16:32:18Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; {"key": "", "name": "", "url": ""}; Other |
...
- `github_search_space_maps-d825e3ace79cef` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| andrebelem/PlanetaryMaps | Build System | [open](space-maps-andrebelem-planetarymaps-a9e4750c.md) |
| backlundtransform/ExoPlanetService | Build System | [open](space-maps-backlundtransform-exoplanetservice-e567cb26.md) |
| dirien/stop-building-portals-start-building-conversations | Build System | [open](space-maps-dirien-stop-building-portals-start-building-conversations-fe9e289e.md) |
| diya-kishore/SkyLens | Build System | [open](space-maps-diya-kishore-skylens-2361bc73.md) |
| geraked/matlab-mna | Build System | [open](space-maps-geraked-matlab-mna-f71d0322.md) |
| hedhyw/spice3f5 | Build System | [open](space-maps-hedhyw-spice3f5-51b16424.md) |
| jens-maus/thinRoot | Build System | [open](space-maps-jens-maus-thinroot-b9a7b737.md) |
| JohnVV/MyCelestiaBuild | Build System | [open](space-maps-johnvv-mycelestiabuild-0063b9fa.md) |
