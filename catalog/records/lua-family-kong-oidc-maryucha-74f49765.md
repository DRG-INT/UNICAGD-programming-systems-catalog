...
| Canonical URL | [https://luarocks.org/modules/maryucha/kong-oidc-maryucha](https://luarocks.org/modules/maryucha/kong-oidc-maryucha) |
| Source record ids | luarocks_root_manifest-61adebe6a1f7db |

## System Engineer Summary

Plugin Kong para autenticação OpenID Connect como Relying Party (RP)

## Operational Role

For a systems engineer, kong-oidc-maryucha belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-61adebe6a1f7db` from `luarocks_root_manifest` as `registry_expansion`
