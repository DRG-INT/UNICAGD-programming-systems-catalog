...
<!-- canonical: https://cran.r-project.org/web/packages/Hmisc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Hmisc/index.html](https://cran.r-project.org/web/packages/Hmisc/index.html) |
| Source record ids | cran_packages_by_date-4fc79efec0b464 |

## System Engineer Summary

Hmisc is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, Hmisc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3-0 | 2026-09-06 12:40:02 UTC | [https://cran.r-project.org/web/packages/Hmisc/DESCRIPTION](https://cran.r-project.org/web/packages/Hmisc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Hmisc/DESCRIPTION` at `2026-09-06T14:18:36+00:00`.
...
- `cran_packages_by_date-4fc79efec0b464` from `cran_packages_by_date` as `registry_expansion`
