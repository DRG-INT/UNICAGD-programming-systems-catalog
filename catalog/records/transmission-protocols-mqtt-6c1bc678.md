...
<!-- canonical: https://docs.oasis-open.org/mqtt/mqtt/v5.0/mqtt-v5.0.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://docs.oasis-open.org/mqtt/mqtt/v5.0/mqtt-v5.0.html](https://docs.oasis-open.org/mqtt/mqtt/v5.0/mqtt-v5.0.html) |
| Source record ids | curated_language_routes-f91e1e726a946f |

## System Engineer Summary

OASIS MQTT 5.0 protocol specification for lightweight publish/subscribe messaging.

## Operational Role

For a systems engineer, MQTT belongs in the Transmission Protocols inventory as part of ecosystem
...
- `curated_language_routes-f91e1e726a946f` from `curated_language_routes` as `registry_expansion`
