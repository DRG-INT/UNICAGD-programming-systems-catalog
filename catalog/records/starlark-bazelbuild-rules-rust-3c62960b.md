...
| Canonical URL | [https://github.com/bazelbuild/rules_rust](https://github.com/bazelbuild/rules_rust) |
| Source record ids | github_search_starlark-7667499c943887 |

## System Engineer Summary

bazelbuild/rules_rust is tracked as a language specification record in the Starlark branch. The
...
For a systems engineer, bazelbuild/rules_rust belongs in the Starlark inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.74.0 | 2026-08-28T20:08:14Z | [https://api.github.com/repos/bazelbuild/rules_rust/releases/latest](https://api.github.com/repos/bazelbuild/rules_rust/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazelbuild/rules_rust/releases/latest` at `2026-09-01T09:23:06+00:00`.
...
- `github_search_starlark-7667499c943887` from `github_search_starlark` as `registry_expansion`
