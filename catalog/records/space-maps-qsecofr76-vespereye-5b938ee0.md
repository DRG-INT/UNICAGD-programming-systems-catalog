...
<!-- canonical: https://github.com/qsecofr76/VesperEye -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qsecofr76/VesperEye](https://github.com/qsecofr76/VesperEye) |
| Source record ids | github_search_space_maps-328a04d57b8fc1 |

## System Engineer Summary

A modern, real-time stargazing planner for amateur astronomers. Features planet visibility
calculations, planetary moon orbit maps, interactive planisphere, live solar activity, and space
station (ISS & Tiangong) flyby predictions

## Operational Role

For a systems engineer, qsecofr76/VesperEye belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-14T09:11:06Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-328a04d57b8fc1` from `github_search_space_maps` as `registry_expansion`
