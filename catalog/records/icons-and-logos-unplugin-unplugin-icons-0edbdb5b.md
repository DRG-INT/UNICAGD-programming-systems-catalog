...
<!-- canonical: https://github.com/unplugin/unplugin-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unplugin/unplugin-icons](https://github.com/unplugin/unplugin-icons) |
| Source record ids | github_search_icons_and_logos-7b8069eecf2629 |
...
For a systems engineer, unplugin/unplugin-icons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-14T10:52:48Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7b8069eecf2629` from `github_search_icons_and_logos` as `registry_expansion`
