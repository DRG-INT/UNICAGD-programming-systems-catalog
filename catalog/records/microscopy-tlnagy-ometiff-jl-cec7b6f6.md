...
[Catalog index](../index.md) · [Language: Microscopy](../by-language/microscopy.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tlnagy/OMETIFF.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tlnagy/OMETIFF.jl](https://github.com/tlnagy/OMETIFF.jl) |
| Source record ids | github_search_microscopy-e2fd15c61bf0b2 |
...
For a systems engineer, tlnagy/OMETIFF.jl belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-01T18:19:01Z | gh search repos topic:ome-tiff stars:>5 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2; MIT License; https://api.github.com/licenses/mit; Other |
...
- `github_search_microscopy-e2fd15c61bf0b2` from `github_search_microscopy` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BodenmillerGroup/imctools | Library | [open](microscopy-bodenmillergroup-imctools-751b7c0c.md) |
| DanuserLab/u-segment3D | Library | [open](microscopy-danuserlab-u-segment3d-458f504b.md) |
| FZJ-INM1-BDA/celldetection | Library | [open](microscopy-fzj-inm1-bda-celldetection-dff52c0c.md) |
| okunator/cellseg_models.pytorch | Library | [open](microscopy-okunator-cellseg-models-pytorch-11f6ec48.md) |
| royerlab/ultrack | Library | [open](microscopy-royerlab-ultrack-fa4cffd9.md) |
| stardist/stardist | Library | [open](microscopy-stardist-stardist-a1fcea9e.md) |
| stardist/stardist-napari | Library | [open](microscopy-stardist-stardist-napari-cf638dd5.md) |
| yaoguangluo/ETL_Unicorn | Library | [open](microscopy-yaoguangluo-etl-unicorn-e0a016db.md) |
