...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Starainrt/astro -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Starainrt/astro](https://github.com/Starainrt/astro) |
| Source record ids | github_search_space_engines-4d1c6e61a9d003 |

## System Engineer Summary

Astro: Go Astronomy Algorithms Library - Chinese Lunar Calendar, Solar/Lunar Eclipses,
Sun/Moon/Planet Positions, Rise/Set, Planet Events, Stars, Coordinates, Orbits, Sundials and
Lightweight Ephemerides (天文算法 Go 库：农历、日月食、日月行星位置、升落、行星天象、恒星、坐标、轨道、日晷与轻量星历)

## Operational Role

For a systems engineer, Starainrt/astro belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T04:42:42Z | gh search repos topic:orbital-mechanics stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-07 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:orbital-mechanics stars:>20", "retrieved": "2026-09-07", "status": "forge-cli-derived"}` |
...
- `github_search_space_engines-4d1c6e61a9d003` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alfonsogonzalez/AWP | Ide Editor Integration | [open](space-engines-alfonsogonzalez-awp-ad0b811b.md) |
| djangovanderplas/LiquidEngineSizingTool | Ide Editor Integration | [open](space-engines-djangovanderplas-liquidenginesizingtool-a78e7605.md) |
| ermersonmoura/LOGAN-Hypersonic-Vehicle-Model | Ide Editor Integration | [open](space-engines-ermersonmoura-logan-hypersonic-vehicle-model-74cb0c52.md) |
| gideonshaked/nextinspace | Ide Editor Integration | [open](space-engines-gideonshaked-nextinspace-b98c39a3.md) |
| helgee/JPLEphemeris.jl | Ide Editor Integration | [open](space-engines-helgee-jplephemeris-jl-66b47a37.md) |
| jrenaud90/TidalPy | Ide Editor Integration | [open](space-engines-jrenaud90-tidalpy-156822c1.md) |
| JuliaAstro/GeneralAstrodynamics.jl | Ide Editor Integration | [open](space-engines-juliaastro-generalastrodynamics-jl-7232995f.md) |
| JuliaSpaceMissionDesign/Ephemerides.jl | Ide Editor Integration | [open](space-engines-juliaspacemissiondesign-ephemerides-jl-1c705450.md) |
