...
<!-- canonical: https://luarocks.org/modules/mah0x211/dirname -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/dirname](https://luarocks.org/modules/mah0x211/dirname) |
| Source record ids | luarocks_root_manifest-be08ef6e2131b4 |
...
For a systems engineer, dirname belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-be08ef6e2131b4` from `luarocks_root_manifest` as `registry_expansion`
