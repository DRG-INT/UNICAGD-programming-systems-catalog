...
<!-- canonical: https://cran.r-project.org/web/packages/Rfactor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rfactor/index.html](https://cran.r-project.org/web/packages/Rfactor/index.html) |
| Source record ids | cran_packages_by_date-a42f4da75ed074 |

## System Engineer Summary

Rainfall Erosivity Calculations from Precipitation Records

## Operational Role

For a systems engineer, Rfactor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-12 13:50:09 UTC | [https://cran.r-project.org/web/packages/Rfactor/DESCRIPTION](https://cran.r-project.org/web/packages/Rfactor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rfactor/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-a42f4da75ed074` from `cran_packages_by_date` as `registry_expansion`
