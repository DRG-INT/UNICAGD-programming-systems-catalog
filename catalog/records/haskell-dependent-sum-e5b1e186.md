...
<!-- canonical: https://hackage.haskell.org/package/dependent-sum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dependent-sum](https://hackage.haskell.org/package/dependent-sum) |
| Source record ids | hackage_top_downloads-4630382809df59 |
...
For a systems engineer, dependent-sum belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2.0 | 2022-12-22T16:26:37Z | [https://hackage.haskell.org/package/dependent-sum](https://hackage.haskell.org/package/dependent-sum) |  |
| candidate | partial | 0.6 |  | [https://hackage.haskell.org/package/dependent-sum](https://hackage.haskell.org/package/dependent-sum) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dependent-sum` at `2026-09-11T00:31:18+00:00`.
...
- `hackage_top_downloads-4630382809df59` from `hackage_top_downloads` as `registry_expansion`
