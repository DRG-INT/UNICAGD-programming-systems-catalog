...
<!-- canonical: https://www.npmjs.com/package/@cubejs-backend/mysql-driver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@cubejs-backend/mysql-driver](https://www.npmjs.com/package/@cubejs-backend/mysql-driver) |
| Source record ids | npm_registry-9df5c8643a614c |
...
For a systems engineer, @cubejs-backend/mysql-driver belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.33 | 2026-09-03T09:06:13.584Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-9df5c8643a614c` from `npm_registry` as `registry_expansion`
