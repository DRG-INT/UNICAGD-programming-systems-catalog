...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://packagist.org/packages/event-engine/php-postgres-document-store](https://packagist.org/packages/event-engine/php-postgres-document-store) |
| Source record ids | packagist_search-43d30caedebaa8 |
...
For a systems engineer, event-engine/php-postgres-document-store belongs in the PHP inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.14.1 | 2025-01-17T17:52:56+00:00 | [https://repo.packagist.org/p2/event-engine/php-postgres-document-store.json](https://repo.packagist.org/p2/event-engine/php-postgres-document-store.json) |  |
| preview/nightly | unknown |  |  | unknown | packagist_preview_version_missing |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/event-engine/php-postgres-document-store.json` at `2026-09-01T07:20:25+00:00`.
- Preview/nightly metadata is unknown because `packagist_preview_version_missing`.

## Provenance

| Kind | Status | Date | Detail |
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-01 | `{"kind": "packagist_search_and_p2_api", "query": "postgres", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `packagist_search-43d30caedebaa8` from `packagist_search` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| adodb/adodb-php | Database Datastore | [open](php-adodb-adodb-php-7c797a72.md) |
| allanpichardo/mysql-vector | Database Datastore | [open](php-allanpichardo-mysql-vector-5720137f.md) |
| apix/cache | Database Datastore | [open](php-apix-cache-40354d2a.md) |
| atk4/data | Database Datastore | [open](php-atk4-data-610bf0c1.md) |
| awssat/laravel-visits | Database Datastore | [open](php-awssat-laravel-visits-4eed0cc7.md) |
| baum/baum | Database Datastore | [open](php-baum-baum-8c52a975.md) |
| beberlei/doctrineextensions | Database Datastore | [open](php-beberlei-doctrineextensions-98ec0d50.md) |
| belamov/postgres-range | Database Datastore | [open](php-belamov-postgres-range-79a3d88f.md) |
