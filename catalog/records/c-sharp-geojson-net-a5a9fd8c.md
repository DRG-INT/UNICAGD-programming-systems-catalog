...
<!-- canonical: https://www.nuget.org/packages/GeoJSON.Net -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/GeoJSON.Net](https://www.nuget.org/packages/GeoJSON.Net) |
| Source record ids | nuget_search-af1559051befe3 |
...
For a systems engineer, GeoJSON.Net belongs in the C-Sharp inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2024-07-12T07:59:22.28+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/geojson.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/geojson.net/index.json) |  |
| preview | known | 1.3.6-rc | 2022-10-28T15:15:05.213+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/geojson.net/index.json](https://api.nuget.org/v3/registration5-gz-semver2/geojson.net/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; Other; MIT; https://www.nuget.org/packages/GeoJSON.Net/1.4.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/geojson.net/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-af1559051befe3` from `nuget_search` as `registry_expansion`
