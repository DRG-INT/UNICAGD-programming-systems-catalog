...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AtomicGameEngine/AtomicGameEngine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AtomicGameEngine/AtomicGameEngine](https://github.com/AtomicGameEngine/AtomicGameEngine) |
| Source record ids | github_search_game_engines-3c26e3820a123a |

## System Engineer Summary

The Atomic Game Engine is a multi-platform 2D and 3D engine with a consistent API in C++, C#,
JavaScript, and TypeScript

## Operational Role

For a systems engineer, AtomicGameEngine/AtomicGameEngine belongs in the Game Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-17T05:11:58Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-3c26e3820a123a` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| excaliburjs/Excalibur | Type Checker | [open](game-engines-excaliburjs-excalibur-c358b570.md) |
