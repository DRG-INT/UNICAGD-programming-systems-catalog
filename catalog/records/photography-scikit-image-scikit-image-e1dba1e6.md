...
<!-- canonical: https://github.com/scikit-image/scikit-image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scikit-image/scikit-image](https://github.com/scikit-image/scikit-image) |
| Source record ids | github_search_photography-8aac4faf60c69f |
...
For a systems engineer, scikit-image/scikit-image belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T17:29:31Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-8aac4faf60c69f` from `github_search_photography` as `registry_expansion`
