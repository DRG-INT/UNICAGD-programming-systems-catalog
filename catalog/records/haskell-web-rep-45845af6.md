...
<!-- canonical: https://hackage.haskell.org/package/web-rep -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/web-rep](https://hackage.haskell.org/package/web-rep) |
| Source record ids | hackage_top_downloads-8cb27936898e86 |
...
For a systems engineer, web-rep belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.1.0 | 2026-03-30T05:16:33Z | [https://hackage.haskell.org/package/web-rep](https://hackage.haskell.org/package/web-rep) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/web-rep` at `2026-09-01T14:24:42+00:00`.
...
- `hackage_top_downloads-8cb27936898e86` from `hackage_top_downloads` as `registry_expansion`
