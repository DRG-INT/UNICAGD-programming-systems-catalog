...
<!-- canonical: https://crates.io/crates/option-ext -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/option-ext](https://crates.io/crates/option-ext) |
| Source record ids | crates_io-80610d9fa94622 |
...
For a systems engineer, option-ext belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-01-11T19:28:05.598091Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-80610d9fa94622` from `crates_io` as `registry_expansion`
