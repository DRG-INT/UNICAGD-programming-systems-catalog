...
<!-- canonical: https://crates.io/crates/cargo_toml -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cargo_toml](https://crates.io/crates/cargo_toml) |
| Source record ids | crates_io-37258e63e6c9ca |
...
For a systems engineer, cargo_toml belongs in the Rust inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-01T22:01:58.871701Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads` at `2026-09-01T22:17:47+00:00`.
...
- `crates_io-37258e63e6c9ca` from `crates_io` as `registry_expansion`
