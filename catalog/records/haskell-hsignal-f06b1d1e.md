...
<!-- canonical: https://hackage.haskell.org/package/hsignal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hsignal](https://hackage.haskell.org/package/hsignal) |
| Source record ids | hackage_top_downloads-7ecdd4f5c4437e |
...
For a systems engineer, hsignal belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7.5 | 2016-11-14T02:54:26Z | [https://hackage.haskell.org/package/hsignal](https://hackage.haskell.org/package/hsignal) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hsignal` at `2026-09-09T00:35:03+00:00`.
...
- `hackage_top_downloads-7ecdd4f5c4437e` from `hackage_top_downloads` as `registry_expansion`
