...
<!-- canonical: https://github.com/allenai/ai2thor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/allenai/ai2thor](https://github.com/allenai/ai2thor) |
| Source record ids | github_search_physics_engines-66ffbfd7c4b8db |
...
For a systems engineer, allenai/ai2thor belongs in the Physics Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-04T06:09:29Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-66ffbfd7c4b8db` from `github_search_physics_engines` as `registry_expansion`
