...
<!-- canonical: https://www.adminer.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.adminer.org/](https://www.adminer.org/) |
| Source record ids | awesome_list-12f3c1a429dd8e |
...
For a systems engineer, Adminer belongs in the Databases inventory as part of state persistence,
...
- `awesome_list-12f3c1a429dd8e` from `awesome_list` as `registry_expansion`
