...
<!-- canonical: https://hackage.haskell.org/package/hasql-notifications -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hasql-notifications](https://hackage.haskell.org/package/hasql-notifications) |
| Source record ids | hackage_top_downloads-ddcc957264cbd4 |
...
For a systems engineer, hasql-notifications belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6.0 | 2026-08-23T21:33:55Z | [https://hackage.haskell.org/package/hasql-notifications](https://hackage.haskell.org/package/hasql-notifications) |  |
| candidate | partial | 0.2.0.4 |  | [https://hackage.haskell.org/package/hasql-notifications](https://hackage.haskell.org/package/hasql-notifications) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hasql-notifications` at `2026-09-09T00:35:02+00:00`.
...
- `hackage_top_downloads-ddcc957264cbd4` from `hackage_top_downloads` as `registry_expansion`
