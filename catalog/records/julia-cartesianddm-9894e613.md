...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CartesianDDM](https://github.com/JuliaRegistries/General/tree/master/C/CartesianDDM) |
| Source record ids | julia_general-359bb3755652d5 |

## System Engineer Summary

Julia package registered in General at C/CartesianDDM.

## Operational Role

For a systems engineer, CartesianDDM belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CartesianDDM", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-359bb3755652d5` from `julia_general` as `registry_expansion`
