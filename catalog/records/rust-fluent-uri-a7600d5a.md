...
<!-- canonical: https://crates.io/crates/fluent-uri -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/fluent-uri](https://crates.io/crates/fluent-uri) |
| Source record ids | crates_io-8740376e09c4af |
...
For a systems engineer, fluent-uri belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2025-11-04T16:55:20.820735Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-8740376e09c4af` from `crates_io` as `registry_expansion`
