...
<!-- canonical: https://luarocks.org/modules/fsantanna/atmos-env-pico -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fsantanna/atmos-env-pico](https://luarocks.org/modules/fsantanna/atmos-env-pico) |
| Source record ids | luarocks_root_manifest-00e4be39d0a293 |

## System Engineer Summary

Pico environment for Atmos

## Operational Role

For a systems engineer, atmos-env-pico belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-00e4be39d0a293` from `luarocks_root_manifest` as `registry_expansion`
