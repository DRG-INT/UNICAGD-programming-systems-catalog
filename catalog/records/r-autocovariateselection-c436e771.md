...
<!-- canonical: https://cran.r-project.org/web/packages/autoCovariateSelection/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autoCovariateSelection/index.html](https://cran.r-project.org/web/packages/autoCovariateSelection/index.html) |
| Source record ids | cran_packages_by_date-2185035cd5f733 |

## System Engineer Summary

R Package to Implement Automated Covariate Selection for Two Exposure Cohorts Using High-Dimensional
Propensity Score Algorithm

## Operational Role

For a systems engineer, autoCovariateSelection belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-15 00:30:08 UTC | [https://cran.r-project.org/web/packages/autoCovariateSelection/DESCRIPTION](https://cran.r-project.org/web/packages/autoCovariateSelection/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autoCovariateSelection/DESCRIPTION` at `2026-09-15T02:22:05+00:00`.
...
- `cran_packages_by_date-2185035cd5f733` from `cran_packages_by_date` as `registry_expansion`
