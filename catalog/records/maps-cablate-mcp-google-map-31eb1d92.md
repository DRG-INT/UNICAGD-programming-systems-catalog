...
<!-- canonical: https://github.com/cablate/mcp-google-map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cablate/mcp-google-map](https://github.com/cablate/mcp-google-map) |
| Source record ids | github_search_maps-ed2a7defdf9721 |

## System Engineer Summary

A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration
with LLM processing capabilities.

## Operational Role

For a systems engineer, cablate/mcp-google-map belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.0.55 | 2026-08-16T12:55:41Z | [https://api.github.com/repos/cablate/mcp-google-map/releases/latest](https://api.github.com/repos/cablate/mcp-google-map/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cablate/mcp-google-map/releases/latest` at `2026-09-01T12:29:59+00:00`.
...
- `github_search_maps-ed2a7defdf9721` from `github_search_maps` as `registry_expansion`
