...
<!-- canonical: https://cran.r-project.org/web/packages/TBRDist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TBRDist/index.html](https://cran.r-project.org/web/packages/TBRDist/index.html) |
| Source record ids | cran_packages_by_date-f45babf811d554 |

## System Engineer Summary

Rearrangement Distances Between Phylogenetic Trees

## Operational Role

For a systems engineer, TBRDist belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2026-09-02 14:30:08 UTC | [https://cran.r-project.org/web/packages/TBRDist/DESCRIPTION](https://cran.r-project.org/web/packages/TBRDist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TBRDist/DESCRIPTION` at `2026-09-02T15:24:11+00:00`.
...
- `cran_packages_by_date-f45babf811d554` from `cran_packages_by_date` as `registry_expansion`
