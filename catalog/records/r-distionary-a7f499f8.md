...
<!-- canonical: https://cran.r-project.org/web/packages/distionary/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/distionary/index.html](https://cran.r-project.org/web/packages/distionary/index.html) |
| Source record ids | cran_packages_by_date-0d3e7049fad1ee |
...
For a systems engineer, distionary belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-14 07:10:10 UTC | [https://cran.r-project.org/web/packages/distionary/DESCRIPTION](https://cran.r-project.org/web/packages/distionary/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/distionary/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-0d3e7049fad1ee` from `cran_packages_by_date` as `registry_expansion`
