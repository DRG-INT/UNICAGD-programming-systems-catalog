...
| Canonical URL | [https://www.npmjs.com/package/mcp-security-lab](https://www.npmjs.com/package/mcp-security-lab) |
| Source record ids | npm_registry-08a26fe9cb4ff5 |

## System Engineer Summary

MCP Security Lab — MCP Verifier: evidence-first, deterministic security checks for local and remote
Model Context Protocol servers, with optional Claude-powered remediation.

## Operational Role

For a systems engineer, mcp-security-lab belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.5 | 2026-08-02T00:06:00.466Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-08a26fe9cb4ff5` from `npm_registry` as `registry_expansion`
