...
<!-- canonical: https://github.com/rsadsb/adsb_deku -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rsadsb/adsb_deku](https://github.com/rsadsb/adsb_deku) |
| Source record ids | github_search_satcom_satellites-16ead61e364064 |
...
For a systems engineer, rsadsb/adsb_deku belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-04T16:18:33Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-16ead61e364064` from `github_search_satcom_satellites` as `registry_expansion`
