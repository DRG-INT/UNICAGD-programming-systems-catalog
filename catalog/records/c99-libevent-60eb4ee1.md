...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Networking Http](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/networking-http.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-ac52e2a35191f4 |

## System Engineer Summary

libevent is tracked as a networking http record in the C99 branch. The source did not provide a long
...
For a systems engineer, libevent belongs in the C99 inventory as part of service communication,
...
- `corpus-ac52e2a35191f4` from `master_json` as `networking_http`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| CivetWeb | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-civetweb-aa809f1e.md) |
| libcurl | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libcurl-1e48b04b.md) |
| libev | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libev-8f899346.md) |
| libmicrohttpd | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libmicrohttpd-88409473.md) |
| Mongoose | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-mongoose-27c28f22.md) |
