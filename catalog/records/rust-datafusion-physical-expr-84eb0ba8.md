...
| Canonical URL | [https://crates.io/crates/datafusion-physical-expr](https://crates.io/crates/datafusion-physical-expr) |
| Source record ids | crates_io-fa4b8c6d3bb566 |
...
For a systems engineer, datafusion-physical-expr belongs in the Rust inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 55.0.0 | 2026-08-18T21:09:14.528250Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
| if_chain | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-if-chain-94e3791a.md) |
