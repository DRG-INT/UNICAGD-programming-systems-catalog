...
<!-- canonical: https://github.com/tweag/rules_haskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tweag/rules_haskell](https://github.com/tweag/rules_haskell) |
| Source record ids | github_search_starlark-9ef76e43c36cc1 |
...
For a systems engineer, tweag/rules_haskell belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:33:13Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-9ef76e43c36cc1` from `github_search_starlark` as `registry_expansion`
