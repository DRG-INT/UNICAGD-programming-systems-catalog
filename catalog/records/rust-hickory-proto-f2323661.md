...
<!-- canonical: https://crates.io/crates/hickory-proto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/hickory-proto](https://crates.io/crates/hickory-proto) |
| Source record ids | crates_io-881f6369df3bdf |
...
For a systems engineer, hickory-proto belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.26.2 | 2026-09-03T19:35:15.083130Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-03T20:18:34+00:00`.
...
- `crates_io-881f6369df3bdf` from `crates_io` as `registry_expansion`
