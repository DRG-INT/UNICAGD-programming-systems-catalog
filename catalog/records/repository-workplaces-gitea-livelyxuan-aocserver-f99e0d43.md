...
<!-- canonical: https://gitea.com/LivelyXuan/AOCserver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/LivelyXuan/AOCserver](https://gitea.com/LivelyXuan/AOCserver) |
| Source record ids | gitea_repositories_api-d4f10e6e3f8861 |
...
For a systems engineer, Gitea: LivelyXuan/AOCserver belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T08:27:00Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-d4f10e6e3f8861` from `gitea_repositories_api` as `registry_expansion`
