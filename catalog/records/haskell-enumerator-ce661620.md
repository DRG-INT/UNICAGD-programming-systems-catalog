...
<!-- canonical: https://hackage.haskell.org/package/enumerator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/enumerator](https://hackage.haskell.org/package/enumerator) |
| Source record ids | hackage_top_downloads-f48f78f04f6c1a |
...
For a systems engineer, enumerator belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.20 | 2013-10-13T01:39:33Z | [https://hackage.haskell.org/package/enumerator](https://hackage.haskell.org/package/enumerator) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/enumerator` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-f48f78f04f6c1a` from `hackage_top_downloads` as `registry_expansion`
