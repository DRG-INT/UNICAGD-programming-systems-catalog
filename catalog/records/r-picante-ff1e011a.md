...
<!-- canonical: https://cran.r-project.org/web/packages/picante/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/picante/index.html](https://cran.r-project.org/web/packages/picante/index.html) |
| Source record ids | cran_packages_by_date-9ea2480f4e5c93 |
...
For a systems engineer, picante belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.4 | 2026-08-23 15:50:08 UTC | [https://cran.r-project.org/web/packages/picante/DESCRIPTION](https://cran.r-project.org/web/packages/picante/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/picante/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9ea2480f4e5c93` from `cran_packages_by_date` as `registry_expansion`
