...
<!-- canonical: https://luarocks.org/modules/craigb/createtable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/craigb/createtable](https://luarocks.org/modules/craigb/createtable) |
| Source record ids | luarocks_root_manifest-ba187faf74668f |
...
For a systems engineer, createtable belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-ba187faf74668f` from `luarocks_root_manifest` as `registry_expansion`
