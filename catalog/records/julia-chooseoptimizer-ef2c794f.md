...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChooseOptimizer](https://github.com/JuliaRegistries/General/tree/master/C/ChooseOptimizer) |
| Source record ids | julia_general-496b81fb8745db |

## System Engineer Summary

Julia package registered in General at C/ChooseOptimizer.

## Operational Role

For a systems engineer, ChooseOptimizer belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChooseOptimizer", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-496b81fb8745db` from `julia_general` as `registry_expansion`
