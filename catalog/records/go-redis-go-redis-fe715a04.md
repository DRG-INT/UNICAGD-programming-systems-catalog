...
<!-- canonical: https://github.com/redis/go-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/redis/go-redis](https://github.com/redis/go-redis) |
| Source record ids | github_search_go-a8167cfce129ed |

## System Engineer Summary

redis/go-redis is tracked as a networking http record in the Go branch. The source did not provide a
...
For a systems engineer, redis/go-redis belongs in the Go inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T18:19:12Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-a8167cfce129ed` from `github_search_go` as `registry_expansion`
...
| go-resty/resty | Networking Http | [open](go-go-resty-resty-9cfada1b.md) |
