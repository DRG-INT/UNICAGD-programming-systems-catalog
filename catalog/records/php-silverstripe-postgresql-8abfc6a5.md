...
<!-- canonical: https://packagist.org/packages/silverstripe/postgresql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/silverstripe/postgresql](https://packagist.org/packages/silverstripe/postgresql) |
| Source record ids | packagist_search-4cf46cdb9ac208 |
...
For a systems engineer, silverstripe/postgresql belongs in the PHP inventory as part of state
...
- `packagist_search-4cf46cdb9ac208` from `packagist_search` as `registry_expansion`
