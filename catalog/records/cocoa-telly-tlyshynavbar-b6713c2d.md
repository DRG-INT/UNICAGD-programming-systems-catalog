...
<!-- canonical: https://github.com/telly/TLYShyNavBar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/telly/TLYShyNavBar](https://github.com/telly/TLYShyNavBar) |
| Source record ids | github_search_cocoa-484f9b54594ffd |

## System Engineer Summary

Unlike all those arrogant UINavigationBar, this one is shy and humble! Easily create auto-scrolling
navigation bars!

## Operational Role

For a systems engineer, telly/TLYShyNavBar belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-09-20T09:24:13Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-484f9b54594ffd` from `github_search_cocoa` as `registry_expansion`
