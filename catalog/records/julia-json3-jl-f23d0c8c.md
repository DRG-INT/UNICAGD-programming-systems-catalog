...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/J/JSON3](https://github.com/JuliaRegistries/General/tree/master/J/JSON3) |
| Source record ids | master-d71d626730da |

## System Engineer Summary

JSON3.jl is tracked as a serialization record in the Julia branch. The source did not provide a long
...
For a systems engineer, JSON3.jl belongs in the Julia inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.14.3 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/J/JSON3/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/J/JSON3/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `master-d71d626730da` from `master_json` as `serialization`
