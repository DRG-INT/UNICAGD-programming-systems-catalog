...
<!-- canonical: https://github.com/Aufree/trip-to-iOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Aufree/trip-to-iOS](https://github.com/Aufree/trip-to-iOS) |
| Source record ids | github_search_cocoa-9f7167bdd50a30 |
...
For a systems engineer, Aufree/trip-to-iOS belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-17T07:07:01Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-9f7167bdd50a30` from `github_search_cocoa` as `registry_expansion`
