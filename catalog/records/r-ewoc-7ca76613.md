...
<!-- canonical: https://cran.r-project.org/web/packages/ewoc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ewoc/index.html](https://cran.r-project.org/web/packages/ewoc/index.html) |
| Source record ids | cran_packages_by_date-0152d86d1c8b74 |
...
For a systems engineer, ewoc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-31 22:30:22 UTC | [https://cran.r-project.org/web/packages/ewoc/DESCRIPTION](https://cran.r-project.org/web/packages/ewoc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ewoc/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0152d86d1c8b74` from `cran_packages_by_date` as `registry_expansion`
