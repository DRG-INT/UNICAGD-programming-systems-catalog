...
<!-- canonical: https://github.com/pfefferle/openwebicons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pfefferle/openwebicons](https://github.com/pfefferle/openwebicons) |
| Source record ids | github_search_icons_and_logos-06b32adf53f6ac |

## System Engineer Summary

pfefferle/openwebicons is tracked as a library record in the Icons and Logos branch. The source did
...
For a systems engineer, pfefferle/openwebicons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T18:26:57Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-06b32adf53f6ac` from `github_search_icons_and_logos` as `registry_expansion`
