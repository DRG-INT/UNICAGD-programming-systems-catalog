...
<!-- canonical: https://pub.dev/packages/husky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/husky](https://pub.dev/packages/husky) |
| Source record ids | pub_dev-b60517bb17d252 |
...
For a systems engineer, husky belongs in the Dart inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2024-01-29T09:26:35.260296Z | [https://pub.dev/api/packages/husky](https://pub.dev/api/packages/husky) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/husky` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-b60517bb17d252` from `pub_dev` as `registry_expansion`
