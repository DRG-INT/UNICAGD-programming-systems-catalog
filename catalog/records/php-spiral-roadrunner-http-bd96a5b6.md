...
<!-- canonical: https://packagist.org/packages/spiral/roadrunner-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spiral/roadrunner-http](https://packagist.org/packages/spiral/roadrunner-http) |
| Source record ids | packagist_search-479d44c505b952 |
...
For a systems engineer, spiral/roadrunner-http belongs in the PHP inventory as part of service
...
- `packagist_search-479d44c505b952` from `packagist_search` as `registry_expansion`
