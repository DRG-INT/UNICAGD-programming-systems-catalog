...
<!-- canonical: https://cran.r-project.org/web/packages/combinat/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/combinat/index.html](https://cran.r-project.org/web/packages/combinat/index.html) |
| Source record ids | cran_packages_by_date-672c2d01312220 |

## System Engineer Summary

combinat is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, combinat belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0-9 | 2026-09-14 08:00:02 UTC | [https://cran.r-project.org/web/packages/combinat/DESCRIPTION](https://cran.r-project.org/web/packages/combinat/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/combinat/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-672c2d01312220` from `cran_packages_by_date` as `registry_expansion`
