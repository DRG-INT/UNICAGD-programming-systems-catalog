...
<!-- canonical: https://github.com/Omid-H/audio_project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Omid-H/audio_project](https://github.com/Omid-H/audio_project) |
| Source record ids | github_search_effects-a6f1b072aad915 |

## System Engineer Summary

سیستم جامع پردازش صوت و تبدیل صدا | Real-time audio processing system with DSP effects and AI Voice
Conversion (RVC v2) running on CPU.

## Operational Role

For a systems engineer, Omid-H/audio_project belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T16:21:25Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a6f1b072aad915` from `github_search_effects` as `registry_expansion`
