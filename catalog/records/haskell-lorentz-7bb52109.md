...
<!-- canonical: https://hackage.haskell.org/package/lorentz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/lorentz](https://hackage.haskell.org/package/lorentz) |
| Source record ids | hackage_top_downloads-cca2cdfff9fb5c |
...
For a systems engineer, lorentz belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.0 | 2023-07-31T17:42:35Z | [https://hackage.haskell.org/package/lorentz](https://hackage.haskell.org/package/lorentz) |  |
| candidate | partial | 0.7.1 |  | [https://hackage.haskell.org/package/lorentz](https://hackage.haskell.org/package/lorentz) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/lorentz` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-cca2cdfff9fb5c` from `hackage_top_downloads` as `registry_expansion`
