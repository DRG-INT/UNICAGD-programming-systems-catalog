...
<!-- canonical: https://github.com/kubernetes/kubernetes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) |
| Source record ids | github_search_go-9178ba15f4e644 |
...
For a systems engineer, kubernetes/kubernetes belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T18:14:21Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-9178ba15f4e644` from `github_search_go` as `registry_expansion`
