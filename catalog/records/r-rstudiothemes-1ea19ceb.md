...
<!-- canonical: https://cran.r-project.org/web/packages/rstudiothemes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rstudiothemes/index.html](https://cran.r-project.org/web/packages/rstudiothemes/index.html) |
| Source record ids | cran_packages_by_date-115861d9328c19 |
...
For a systems engineer, rstudiothemes belongs in the R inventory as part of device constraints,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-28 15:40:02 UTC | [https://cran.r-project.org/web/packages/rstudiothemes/DESCRIPTION](https://cran.r-project.org/web/packages/rstudiothemes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rstudiothemes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-115861d9328c19` from `cran_packages_by_date` as `registry_expansion`
...
| iotools | Embedded Hardware | [open](r-iotools-9033e8e4.md) |
