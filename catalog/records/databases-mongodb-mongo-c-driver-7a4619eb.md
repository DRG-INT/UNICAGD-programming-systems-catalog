...
<!-- canonical: https://github.com/mongodb/mongo-c-driver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mongodb/mongo-c-driver](https://github.com/mongodb/mongo-c-driver) |
| Source record ids | github_search_databases-076b4083287756 |
...
For a systems engineer, mongodb/mongo-c-driver belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T17:52:15Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-076b4083287756` from `github_search_databases` as `registry_expansion`
