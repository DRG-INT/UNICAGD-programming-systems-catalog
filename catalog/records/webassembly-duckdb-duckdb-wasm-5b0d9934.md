...
<!-- canonical: https://github.com/duckdb/duckdb-wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/duckdb/duckdb-wasm](https://github.com/duckdb/duckdb-wasm) |
| Source record ids | github_search_webassembly-aa803614f53f5d |
...
For a systems engineer, duckdb/duckdb-wasm belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-28T09:43:35Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-aa803614f53f5d` from `github_search_webassembly` as `registry_expansion`
