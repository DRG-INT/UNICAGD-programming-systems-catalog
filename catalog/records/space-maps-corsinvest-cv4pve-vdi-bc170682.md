...
<!-- canonical: https://github.com/Corsinvest/cv4pve-vdi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Corsinvest/cv4pve-vdi](https://github.com/Corsinvest/cv4pve-vdi) |
| Source record ids | github_search_space_maps-d97b0a1d26d1f6 |
...
For a systems engineer, Corsinvest/cv4pve-vdi belongs in the Space Maps inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T17:05:15Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d97b0a1d26d1f6` from `github_search_space_maps` as `registry_expansion`
