...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stephengold/jolt-jni -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stephengold/jolt-jni](https://github.com/stephengold/jolt-jni) |
| Source record ids | github_search_physics_engines-6cab0512061c0a |
...
For a systems engineer, stephengold/jolt-jni belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T03:28:07Z | gh search repos topic:rigid-body-dynamics stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-6cab0512061c0a` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| stephengold/Libbulletjme | Interpreter Runtime | [open](physics-engines-stephengold-libbulletjme-bf0c33a3.md) |
