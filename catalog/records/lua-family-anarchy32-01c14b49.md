...
<!-- canonical: https://luarocks.org/modules/solsword/anarchy32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/solsword/anarchy32](https://luarocks.org/modules/solsword/anarchy32) |
| Source record ids | luarocks_root_manifest-411cc69feba88b |

## System Engineer Summary

A module for incremental & reversible chaos.

## Operational Role

For a systems engineer, Anarchy32 belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-411cc69feba88b` from `luarocks_root_manifest` as `registry_expansion`
