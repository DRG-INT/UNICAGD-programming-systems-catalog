...
<!-- canonical: https://cran.r-project.org/web/packages/pilotr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pilotr/index.html](https://cran.r-project.org/web/packages/pilotr/index.html) |
| Source record ids | cran_packages_by_date-5564080d513e8c |
...
For a systems engineer, pilotr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-12 07:30:08 UTC | [https://cran.r-project.org/web/packages/pilotr/DESCRIPTION](https://cran.r-project.org/web/packages/pilotr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pilotr/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-5564080d513e8c` from `cran_packages_by_date` as `registry_expansion`
