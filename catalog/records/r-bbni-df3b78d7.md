...
<!-- canonical: https://cran.r-project.org/web/packages/BBNI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BBNI/index.html](https://cran.r-project.org/web/packages/BBNI/index.html) |
| Source record ids | cran_packages_by_date-3fa0a5b97b5e90 |
...
For a systems engineer, BBNI belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-19 19:20:12 UTC | [https://cran.r-project.org/web/packages/BBNI/DESCRIPTION](https://cran.r-project.org/web/packages/BBNI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BBNI/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3fa0a5b97b5e90` from `cran_packages_by_date` as `registry_expansion`
