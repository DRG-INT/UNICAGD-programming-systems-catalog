...
<!-- canonical: https://pypi.org/project/accoladecli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/accoladecli/](https://pypi.org/project/accoladecli/) |
| Source record ids | pypi_simple-679274d9f93f32 |

## System Engineer Summary

accoladecli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, accoladecli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.7 | 2018-08-14T22:27:19.817022Z | [https://pypi.org/pypi/accoladecli/json](https://pypi.org/pypi/accoladecli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/accoladecli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-679274d9f93f32` from `pypi_simple` as `registry_expansion`
