...
| Canonical URL | [https://crates.io/crates/strsim](https://crates.io/crates/strsim) |
| Source record ids | crates_io-e24912594427cd |

## System Engineer Summary

Implementations of string similarity metrics. Includes Hamming, Levenshtein, OSA, Damerau-
Levenshtein, Jaro, Jaro-Winkler, and Sørensen-Dice.

## Operational Role

For a systems engineer, strsim belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1 | 2024-04-02T22:18:09.406790Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| android_logger | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-android-logger-4234548c.md) |
| arrow-schema | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-arrow-schema-3690b891.md) |
| aws-smithy-eventstream | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-smithy-eventstream-e8e6d761.md) |
| aws-smithy-observability | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-smithy-observability-7204d6c5.md) |
| aws-smithy-query | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-smithy-query-b6654ee8.md) |
| console_error_panic_hook | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-console-error-panic-hook-a9ab6b4d.md) |
| console_log | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-console-log-715f7bc2.md) |
| dialoguer | Logging Observability | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dialoguer-3213388c.md) |
