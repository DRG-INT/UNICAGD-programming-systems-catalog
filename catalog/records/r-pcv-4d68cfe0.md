...
<!-- canonical: https://cran.r-project.org/web/packages/pcv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pcv/index.html](https://cran.r-project.org/web/packages/pcv/index.html) |
| Source record ids | cran_packages_by_date-ee6ac69f6a2a26 |
...
For a systems engineer, pcv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-22 14:50:02 UTC | [https://cran.r-project.org/web/packages/pcv/DESCRIPTION](https://cran.r-project.org/web/packages/pcv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pcv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ee6ac69f6a2a26` from `cran_packages_by_date` as `registry_expansion`
