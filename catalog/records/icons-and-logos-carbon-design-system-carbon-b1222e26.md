...
<!-- canonical: https://github.com/carbon-design-system/carbon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/carbon-design-system/carbon](https://github.com/carbon-design-system/carbon) |
| Source record ids | github_search_icons_and_logos-8963cddaa7b1af |
...
For a systems engineer, carbon-design-system/carbon belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:22:18Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-8963cddaa7b1af` from `github_search_icons_and_logos` as `registry_expansion`
