...
<!-- canonical: https://github.com/hackclub/some-assembly-required -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hackclub/some-assembly-required](https://github.com/hackclub/some-assembly-required) |
| Source record ids | github_search_assembly-d5620f0ca190f1 |
...
For a systems engineer, hackclub/some-assembly-required belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-02T23:13:25Z | gh search repos language:Assembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-d5620f0ca190f1` from `github_search_assembly` as `registry_expansion`
