...
<!-- canonical: https://github.com/grafana/loki -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grafana/loki](https://github.com/grafana/loki) |
| Source record ids | github_search_go-6d412063fb1fec |
...
For a systems engineer, grafana/loki belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:22:05Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-6d412063fb1fec` from `github_search_go` as `registry_expansion`
