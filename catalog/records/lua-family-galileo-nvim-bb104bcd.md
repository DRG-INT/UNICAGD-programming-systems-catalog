...
| Canonical URL | [https://luarocks.org/modules/s1m0n38/galileo.nvim](https://luarocks.org/modules/s1m0n38/galileo.nvim) |
| Source record ids | luarocks_root_manifest-1bfdc4b043885f |

## System Engineer Summary

galileo.nvim is tracked as an ide editor integration record in the Lua family branch. The source did
...
For a systems engineer, galileo.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1bfdc4b043885f` from `luarocks_root_manifest` as `registry_expansion`
