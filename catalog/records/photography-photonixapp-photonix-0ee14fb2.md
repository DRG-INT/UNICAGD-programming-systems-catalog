...
| Canonical URL | [https://github.com/photonixapp/photonix](https://github.com/photonixapp/photonix) |
| Source record ids | github_search_photography-b07b04774b253b |

## System Engineer Summary

A modern, web-based photo management server. Run it on your home server and it will let you find the
right photo from your collection on any device. Smart filtering is made possible by object
recognition, face recognition, location awareness, color analysis and other ML algorithms.

## Operational Role

For a systems engineer, photonixapp/photonix belongs in the Photography inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.24.0 | 2021-11-18T22:14:31Z | [https://api.github.com/repos/photonixapp/photonix/releases/latest](https://api.github.com/repos/photonixapp/photonix/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/photonixapp/photonix/releases/latest` at `2026-09-01T09:23:33+00:00`.
...
- `github_search_photography-b07b04774b253b` from `github_search_photography` as `registry_expansion`
