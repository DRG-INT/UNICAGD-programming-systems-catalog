...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/victorfisac/Physac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/victorfisac/Physac](https://github.com/victorfisac/Physac) |
| Source record ids | github_search_physics_engines-a8efc0e9cf0389 |
...
For a systems engineer, victorfisac/Physac belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-20T15:16:31Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:physics-engine stars:>50", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_physics_engines-a8efc0e9cf0389` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| freezy/VisualPinball.Engine | Ide Editor Integration | [open](physics-engines-freezy-visualpinball-engine-fc9f3475.md) |
| iluaii/fwm | Ide Editor Integration | [open](physics-engines-iluaii-fwm-dc80ab13.md) |
| johannes-do/multiplayer-babylon-js-game | Ide Editor Integration | [open](physics-engines-johannes-do-multiplayer-babylon-js-game-0189ac60.md) |
| JordiCorbilla/thundax-delphi-physics-engine | Ide Editor Integration | [open](physics-engines-jordicorbilla-thundax-delphi-physics-engine-1f15f884.md) |
| Mati365/micro-racing | Ide Editor Integration | [open](physics-engines-mati365-micro-racing-66c9923f.md) |
| MissingDeadlines/iolite | Ide Editor Integration | [open](physics-engines-missingdeadlines-iolite-59ecdc76.md) |
| stevenlsw/physgen | Ide Editor Integration | [open](physics-engines-stevenlsw-physgen-04c29129.md) |
| THU-SI/Physics3D | Ide Editor Integration | [open](physics-engines-thu-si-physics3d-940fe5e2.md) |
