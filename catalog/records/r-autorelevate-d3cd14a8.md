...
<!-- canonical: https://cran.r-project.org/web/packages/autorelevate/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autorelevate/index.html](https://cran.r-project.org/web/packages/autorelevate/index.html) |
| Source record ids | cran_packages_by_date-3d287b2258e8dd |
...
For a systems engineer, autorelevate belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 14:10:02 UTC | [https://cran.r-project.org/web/packages/autorelevate/DESCRIPTION](https://cran.r-project.org/web/packages/autorelevate/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autorelevate/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-3d287b2258e8dd` from `cran_packages_by_date` as `registry_expansion`
