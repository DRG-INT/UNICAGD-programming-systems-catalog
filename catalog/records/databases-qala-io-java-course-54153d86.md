...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/qala-io/java-course -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qala-io/java-course](https://github.com/qala-io/java-course) |
| Source record ids | github_search_databases-f4f718f3176366 |
...
For a systems engineer, qala-io/java-course belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-20T08:48:10Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f4f718f3176366` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alanchn31/Data-Engineering-Projects | Game Engine Game Dev | [open](databases-alanchn31-data-engineering-projects-ec5e441e.md) |
| apache/datafusion-ballista | Game Engine Game Dev | [open](databases-apache-datafusion-ballista-0541951e.md) |
| Jayvardhan-Reddy/Azure-Certification-DP-200 | Game Engine Game Dev | [open](databases-jayvardhan-reddy-azure-certification-dp-200-bc190a86.md) |
| KentHsu/Udacity-Data-Engineering-Nanodgree | Game Engine Game Dev | [open](databases-kenthsu-udacity-data-engineering-nanodgree-c9151339.md) |
| Wathon/data_engineering_with_python-track-datacamp | Game Engine Game Dev | [open](databases-wathon-data-engineering-with-python-track-datacamp-d9923c83.md) |
