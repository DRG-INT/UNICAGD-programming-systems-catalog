...
<!-- canonical: https://pub.dev/packages/flutter_calendar_carousel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_calendar_carousel](https://pub.dev/packages/flutter_calendar_carousel) |
| Source record ids | pub_dev-e1a7aa73b16dd9 |

## System Engineer Summary

An accessible, theme-aware Flutter calendar with lazy month and week paging, controlled dates, and
typed event builders.

## Operational Role

For a systems engineer, flutter_calendar_carousel belongs in the Dart inventory as part of build
...
- `pub_dev-e1a7aa73b16dd9` from `pub_dev` as `registry_expansion`
