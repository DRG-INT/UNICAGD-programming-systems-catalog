...
<!-- canonical: https://github.com/lightkurve/lightkurve -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lightkurve/lightkurve](https://github.com/lightkurve/lightkurve) |
| Source record ids | github_search_space_maps-804111e92c52ba |
...
For a systems engineer, lightkurve/lightkurve belongs in the Space Maps inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T19:58:28Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-804111e92c52ba` from `github_search_space_maps` as `registry_expansion`
