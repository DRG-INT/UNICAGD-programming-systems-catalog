...
<!-- canonical: https://pub.dev/packages/dbus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dbus](https://pub.dev/packages/dbus) |
| Source record ids | pub_dev-014e418c5cc2a1 |

## System Engineer Summary

A native Dart implementation of the D-Bus message bus client. This package allows Dart applications
to directly access services on the Linux desktop.

## Operational Role

For a systems engineer, dbus belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.15 | 2026-08-20T00:31:10.817441Z | [https://pub.dev/api/packages/dbus](https://pub.dev/api/packages/dbus) |  |
| preview | known | 0.0.0-dev.23 | 2020-10-28T03:53:55.905789Z | [https://pub.dev/api/packages/dbus](https://pub.dev/api/packages/dbus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dbus` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-014e418c5cc2a1` from `pub_dev` as `registry_expansion`
