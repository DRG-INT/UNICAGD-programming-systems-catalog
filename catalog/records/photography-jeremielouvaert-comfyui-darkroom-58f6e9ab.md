...
<!-- canonical: https://github.com/jeremieLouvaert/ComfyUI-Darkroom -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeremieLouvaert/ComfyUI-Darkroom](https://github.com/jeremieLouvaert/ComfyUI-Darkroom) |
| Source record ids | github_search_photography-4814207e6a016c |

## System Engineer Summary

Professional color grading & film emulation suite for ComfyUI. 161 film stocks with real Capture One
curve data. Physics-based H&D curves, grain, halation, print stock chain.

## Operational Role

For a systems engineer, jeremieLouvaert/ComfyUI-Darkroom belongs in the Photography inventory as
...
- `github_search_photography-4814207e6a016c` from `github_search_photography` as `registry_expansion`
