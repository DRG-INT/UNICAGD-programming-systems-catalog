...
<!-- canonical: https://github.com/speechbrain/speechbrain -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/speechbrain/speechbrain](https://github.com/speechbrain/speechbrain) |
| Source record ids | github_search_audio-95a9ef5f51d23b |
...
For a systems engineer, speechbrain/speechbrain belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T13:48:19Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_audio-95a9ef5f51d23b` from `github_search_audio` as `registry_expansion`
