...
<!-- canonical: https://pub.dev/packages/board_datetime_picker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/board_datetime_picker](https://pub.dev/packages/board_datetime_picker) |
| Source record ids | pub_dev-35c66db4fc08be |

## System Engineer Summary

Picker to select date and time for Flutter. It is both a calendar and a picker, offering a variety
of options as a package.

## Operational Role

For a systems engineer, board_datetime_picker belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.8.7 | 2026-07-25T07:15:04.494783Z | [https://pub.dev/api/packages/board_datetime_picker](https://pub.dev/api/packages/board_datetime_picker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/board_datetime_picker` at `2026-09-06T05:17:58+00:00`.
...
- `pub_dev-35c66db4fc08be` from `pub_dev` as `registry_expansion`
