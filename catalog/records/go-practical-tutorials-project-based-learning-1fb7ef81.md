...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/practical-tutorials/project-based-learning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) |
| Source record ids | github_search_go-508ed396ec04a8 |
...
For a systems engineer, practical-tutorials/project-based-learning belongs in the Go inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T07:08:03Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-508ed396ec04a8` from `github_search_go` as `registry_expansion`
