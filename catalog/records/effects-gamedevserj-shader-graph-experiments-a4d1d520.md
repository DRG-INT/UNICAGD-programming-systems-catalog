...
<!-- canonical: https://github.com/gamedevserj/Shader-Graph-Experiments -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gamedevserj/Shader-Graph-Experiments](https://github.com/gamedevserj/Shader-Graph-Experiments) |
| Source record ids | github_search_effects-f2c59ae4d7f700 |

## System Engineer Summary

Various shader graph effects with Unity URP

## Operational Role

For a systems engineer, gamedevserj/Shader-Graph-Experiments belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-05T18:34:23Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f2c59ae4d7f700` from `github_search_effects` as `registry_expansion`
