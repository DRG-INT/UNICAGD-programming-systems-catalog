...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CompAir](https://github.com/JuliaRegistries/General/tree/master/C/CompAir) |
| Source record ids | julia_general-1ed4e31076f5f3 |

## System Engineer Summary

Julia package registered in General at C/CompAir.

## Operational Role

For a systems engineer, CompAir belongs in the Julia inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CompAir", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-1ed4e31076f5f3` from `julia_general` as `registry_expansion`
