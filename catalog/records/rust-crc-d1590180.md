...
<!-- canonical: https://crates.io/crates/crc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crc](https://crates.io/crates/crc) |
| Source record ids | crates_io-e6411f0483d296 |
...
For a systems engineer, crc belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.0 | 2025-11-26T17:46:02.621035Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-e6411f0483d296` from `crates_io` as `registry_expansion`
