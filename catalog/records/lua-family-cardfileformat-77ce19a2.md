...
<!-- canonical: https://luarocks.org/modules/yakupcemilk/cardfileformat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/yakupcemilk/cardfileformat](https://luarocks.org/modules/yakupcemilk/cardfileformat) |
| Source record ids | luarocks_root_manifest-77a2d9e2d0ab22 |
...
For a systems engineer, cardfileformat belongs in the Lua family inventory as part of low-noise code
...
- `luarocks_root_manifest-77a2d9e2d0ab22` from `luarocks_root_manifest` as `registry_expansion`
