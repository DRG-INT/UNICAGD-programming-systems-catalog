...
<!-- canonical: https://github.com/jangsoopark/AConvNet-pytorch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jangsoopark/AConvNet-pytorch](https://github.com/jangsoopark/AConvNet-pytorch) |
| Source record ids | github_search_radars-79875796ae521a |
...
For a systems engineer, jangsoopark/AConvNet-pytorch belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-27T11:36:42Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-79875796ae521a` from `github_search_radars` as `registry_expansion`
