...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/thecatalinstan/Criollo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thecatalinstan/Criollo](https://github.com/thecatalinstan/Criollo) |
| Source record ids | github_search_cocoa-2454eddff34bd4 |
...
For a systems engineer, thecatalinstan/Criollo belongs in the Cocoa inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-09-20T21:52:51Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-2454eddff34bd4` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AFNetworking | Networking Http | [open](cocoa-afnetworking-c33f66f5.md) |
| Alamofire/Alamofire | Networking Http | [open](cocoa-alamofire-alamofire-e2b01e1d.md) |
| ChangbaDevs/KTVHTTPCache | Networking Http | [open](cocoa-changbadevs-ktvhttpcache-542d5edc.md) |
| ChiliLabs/CHIPageControl | Networking Http | [open](cocoa-chililabs-chipagecontrol-cbd520fb.md) |
| dustturtle/RealReachability | Networking Http | [open](cocoa-dustturtle-realreachability-89a5cfc6.md) |
| emqx/CocoaMQTT | Networking Http | [open](cocoa-emqx-cocoamqtt-ef5d936b.md) |
| jkpang/PPNetworkHelper | Networking Http | [open](cocoa-jkpang-ppnetworkhelper-8c57f6f7.md) |
| neilalexander/seaglass | Networking Http | [open](cocoa-neilalexander-seaglass-fe29ac21.md) |
