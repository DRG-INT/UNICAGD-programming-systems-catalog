...
<!-- canonical: https://github.com/maplibre/flutter-maplibre-gl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maplibre/flutter-maplibre-gl](https://github.com/maplibre/flutter-maplibre-gl) |
| Source record ids | github_search_maps-fae0e6227126de |

## System Engineer Summary

Flutter plugin for MapLibre: vendor‑neutral vector & raster maps on Android, iOS and Web, with
custom styles, offline regions, GeoJSON layers and PMTiles (fork of flutter-mapbox-gl)

## Operational Role

For a systems engineer, maplibre/flutter-maplibre-gl belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T07:25:28Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-fae0e6227126de` from `github_search_maps` as `registry_expansion`
