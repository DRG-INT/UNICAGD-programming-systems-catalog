...
<!-- canonical: https://github.com/XDeadHackerX/NetRadar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/XDeadHackerX/NetRadar](https://github.com/XDeadHackerX/NetRadar) |
| Source record ids | github_search_radars-45970baadbc3dd |

## System Engineer Summary

NetRadar is a Networking tool focused on mapping local and WiFi networks. It provides detailed
information about connected devices, open ports, servers and automated scans for WiFi
networks.NetRadar es una herramienta de Networking centrada en el mapeo de redes locales y WiFi.
Proporciona información detallada sobre dispositivos conectados, puert..

## Operational Role

For a systems engineer, XDeadHackerX/NetRadar belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-01T10:54:49Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-45970baadbc3dd` from `github_search_radars` as `registry_expansion`
