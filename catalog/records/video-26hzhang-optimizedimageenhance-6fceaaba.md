...
<!-- canonical: https://github.com/26hzhang/OptimizedImageEnhance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/26hzhang/OptimizedImageEnhance](https://github.com/26hzhang/OptimizedImageEnhance) |
| Source record ids | github_search_video-8fcc2726892821 |

## System Engineer Summary

Several image/video enhancement methods, implemented by Java, to tackle common tasks, like dehazing,
denoising, backscatter removal, low illuminance enhancement, featuring, smoothing and etc.

## Operational Role

For a systems engineer, 26hzhang/OptimizedImageEnhance belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-15T05:53:26Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:video-processing stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_video-8fcc2726892821` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 0voice/audio_video_streaming | Ide Editor Integration | [open](video-0voice-audio-video-streaming-bf7a47cf.md) |
| 4gray/iptvnator | Ide Editor Integration | [open](video-4gray-iptvnator-5303edee.md) |
...
| ahmetgunduz/Real-time-GesRec | Ide Editor Integration | [open](video-ahmetgunduz-real-time-gesrec-04ed05c7.md) |
| alyssaxuu/screenity | Ide Editor Integration | [open](video-alyssaxuu-screenity-950c051f.md) |
| anchen1011/toflow | Ide Editor Integration | [open](video-anchen1011-toflow-e5460699.md) |
