...
<!-- canonical: https://github.com/khanhnamle1994/neural-nets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/khanhnamle1994/neural-nets](https://github.com/khanhnamle1994/neural-nets) |
| Source record ids | github_search_matlab-42ed86ed163cbe |

## System Engineer Summary

Programming Assignments and Lectures for Geoffrey Hinton's "Neural Networks for Machine Learning"
Coursera course

## Operational Role

For a systems engineer, khanhnamle1994/neural-nets belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-08T01:17:54Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-42ed86ed163cbe` from `github_search_matlab` as `registry_expansion`
