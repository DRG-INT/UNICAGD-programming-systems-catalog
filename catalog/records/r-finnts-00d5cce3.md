...
<!-- canonical: https://cran.r-project.org/web/packages/finnts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/finnts/index.html](https://cran.r-project.org/web/packages/finnts/index.html) |
| Source record ids | cran_packages_by_date-80fbe6dd137fe9 |
...
For a systems engineer, finnts belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-27 03:30:02 UTC | [https://cran.r-project.org/web/packages/finnts/DESCRIPTION](https://cran.r-project.org/web/packages/finnts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/finnts/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-80fbe6dd137fe9` from `cran_packages_by_date` as `registry_expansion`
