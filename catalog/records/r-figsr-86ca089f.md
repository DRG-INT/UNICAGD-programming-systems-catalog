...
<!-- canonical: https://cran.r-project.org/web/packages/figsr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/figsr/index.html](https://cran.r-project.org/web/packages/figsr/index.html) |
| Source record ids | cran_packages_by_date-d23908c2be8e50 |
...
For a systems engineer, figsr belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-31 22:30:16 UTC | [https://cran.r-project.org/web/packages/figsr/DESCRIPTION](https://cran.r-project.org/web/packages/figsr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/figsr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d23908c2be8e50` from `cran_packages_by_date` as `registry_expansion`
