...
<!-- canonical: https://github.com/emmanuelepp/sap-btp-edi-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/emmanuelepp/sap-btp-edi-demo](https://github.com/emmanuelepp/sap-btp-edi-demo) |
| Source record ids | github_search_sapjava-0b03f080986a85 |

## System Engineer Summary

Minimal EDI X12 850 ingestion pipeline built with SAP CAP Java: OData V4, Fiori preview and Swagger
UI

## Operational Role

For a systems engineer, emmanuelepp/sap-btp-edi-demo belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T16:48:18Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-0b03f080986a85` from `github_search_sapjava` as `registry_expansion`
