...
<!-- canonical: https://github.com/lyogavin/airllm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lyogavin/airllm](https://github.com/lyogavin/airllm) |
| Source record ids | github_search_aims-b8352ef19baf3c |
...
For a systems engineer, lyogavin/airllm belongs in the "aim's" inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T06:26:04Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-b8352ef19baf3c` from `github_search_aims` as `registry_expansion`
