...
| Source record ids | github_search_audio-822966e0ed2e4d |

## System Engineer Summary

grame-cncm/faustlibraries is tracked as an image audio dsp record in the Audio branch. The source
...
For a systems engineer, grame-cncm/faustlibraries belongs in the Audio inventory as part of
...
- `github_search_audio-822966e0ed2e4d` from `github_search_audio` as `registry_expansion`
