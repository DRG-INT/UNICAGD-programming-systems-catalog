...
<!-- canonical: https://crates.io/crates/rand -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand](https://crates.io/crates/rand) |
| Source record ids | crates_io-64d280bea98971 |
...
For a systems engineer, rand belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2 | 2026-08-25T07:45:50.786344Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-64d280bea98971` from `crates_io` as `registry_expansion`
