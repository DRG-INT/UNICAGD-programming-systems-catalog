...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/serde -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde](https://crates.io/crates/serde) |
| Source record ids | crates_io-37a6c480fb514b |
...
For a systems engineer, serde belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.229 | 2026-07-18T23:05:13.266456Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-37a6c480fb514b` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rkyv | Framework | [open](rust-rkyv-db630c9b.md) |
| snow | Framework | [open](rust-snow-d5167cfc.md) |
