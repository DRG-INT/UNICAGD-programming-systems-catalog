...
<!-- canonical: https://github.com/thesofproject/sof -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thesofproject/sof](https://github.com/thesofproject/sof) |
| Source record ids | github_search_effects-9975e87a30276f |

## System Engineer Summary

thesofproject/sof is tracked as an image audio dsp record in the Effects branch. The source did not
...
For a systems engineer, thesofproject/sof belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T13:16:24Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9975e87a30276f` from `github_search_effects` as `registry_expansion`
