...
| Canonical URL | [https://github.com/apache/parquet-format](https://github.com/apache/parquet-format) |
| Source record ids | curated_database_systems-1dde03ad041490 |

## System Engineer Summary

Columnar storage format for analytics data.

## Operational Role

For a systems engineer, Apache Parquet belongs in the Databases inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | apache-parquet-format-2.13.0 | 2026-06-13T06:49:01Z | [https://api.github.com/repos/apache/parquet-format/releases/latest](https://api.github.com/repos/apache/parquet-format/releases/latest) |  |
| preview | known | apache-parquet-format-2.13.0-rc0 | 2026-06-09T02:14:22Z | [https://api.github.com/repos/apache/parquet-format/releases?per_page=10](https://api.github.com/repos/apache/parquet-format/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apache/parquet-format/releases/latest` at `2026-09-01T07:24:48+00:00`.
...
- `curated_database_systems-1dde03ad041490` from `curated_database_systems` as `registry_expansion`
