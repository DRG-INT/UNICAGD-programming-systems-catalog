...
<!-- canonical: https://github.com/faithcure/NukeChat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/faithcure/NukeChat](https://github.com/faithcure/NukeChat) |
| Source record ids | github_search_effects-6c10a2affe471f |

## System Engineer Summary

It provides a seamless communication platform for visual effects artists, compositors, and technical
directors working within the Nuke ecosystem.

## Operational Role

For a systems engineer, faithcure/NukeChat belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-10T12:16:00Z | gh search repos visual effects compositor | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6c10a2affe471f` from `github_search_effects` as `registry_expansion`
