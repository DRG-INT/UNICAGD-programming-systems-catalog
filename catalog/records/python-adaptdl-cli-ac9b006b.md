...
<!-- canonical: https://pypi.org/project/adaptdl-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adaptdl-cli/](https://pypi.org/project/adaptdl-cli/) |
| Source record ids | pypi_simple-a2b323ce56a057 |
...
For a systems engineer, adaptdl-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.11 | 2022-04-20T05:32:14.312259Z | [https://pypi.org/pypi/adaptdl-cli/json](https://pypi.org/pypi/adaptdl-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adaptdl-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-a2b323ce56a057` from `pypi_simple` as `registry_expansion`
