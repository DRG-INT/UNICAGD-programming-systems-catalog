...
<!-- canonical: https://github.com/CialloKing/ba-click-fx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CialloKing/ba-click-fx](https://github.com/CialloKing/ba-click-fx) |
| Source record ids | github_search_effects-cc38b9391e1900 |

## System Engineer Summary

Blue Archive web click effect, mouse effect & cursor trail｜蔚蓝档案 点击特效、鼠标特效与光标拖尾｜Canvas 2D · npm/CDN

## Operational Role

For a systems engineer, CialloKing/ba-click-fx belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T05:57:36Z | gh search repos topic:visual-effects stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-cc38b9391e1900` from `github_search_effects` as `registry_expansion`
