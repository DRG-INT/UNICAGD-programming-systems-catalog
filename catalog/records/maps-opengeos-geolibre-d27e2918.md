...
<!-- canonical: https://github.com/opengeos/GeoLibre -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opengeos/GeoLibre](https://github.com/opengeos/GeoLibre) |
| Source record ids | github_search_maps-a3cd065b7c412a |

## System Engineer Summary

A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data.
It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.

## Operational Role

For a systems engineer, opengeos/GeoLibre belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:20:49Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-a3cd065b7c412a` from `github_search_maps` as `registry_expansion`
