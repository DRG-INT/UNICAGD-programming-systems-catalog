...
<!-- canonical: https://github.com/mongodb/mongo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mongodb/mongo](https://github.com/mongodb/mongo) |
| Source record ids | github_search_databases-8892553b126594 |

## System Engineer Summary

mongodb/mongo is tracked as a database datastore record in the Databases branch. The source did not
...
For a systems engineer, mongodb/mongo belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T21:06:49Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-8892553b126594` from `github_search_databases` as `registry_expansion`
