...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Starlark](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/starlark.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://registry.bazel.build/](https://registry.bazel.build/) |
| Source record ids | curated_language_routes-07a6e4083feb56 |

## System Engineer Summary

Official Bazel module registry for Bzlmod module discovery and version metadata.

## Operational Role

For a systems engineer, Bazel Central Registry belongs in the Starlark inventory as part of
...
- `curated_language_routes-07a6e4083feb56` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bazelbuild/starlark | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/starlark-bazelbuild-starlark-70e43d88.md) |
