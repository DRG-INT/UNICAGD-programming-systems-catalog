...
<!-- canonical: https://cran.r-project.org/web/packages/smaa/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smaa/index.html](https://cran.r-project.org/web/packages/smaa/index.html) |
| Source record ids | cran_packages_by_date-7cb93aabad81da |
...
For a systems engineer, smaa belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3-4 | 2026-08-21 06:40:02 UTC | [https://cran.r-project.org/web/packages/smaa/DESCRIPTION](https://cran.r-project.org/web/packages/smaa/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smaa/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7cb93aabad81da` from `cran_packages_by_date` as `registry_expansion`
