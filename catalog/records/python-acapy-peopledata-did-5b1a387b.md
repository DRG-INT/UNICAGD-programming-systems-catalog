...
<!-- canonical: https://pypi.org/project/acapy-peopledata-did/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acapy-peopledata-did/](https://pypi.org/project/acapy-peopledata-did/) |
| Source record ids | pypi_simple-94576df0971bd4 |
...
For a systems engineer, acapy-peopledata-did belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2022-09-23T10:07:12.551869Z | [https://pypi.org/pypi/acapy-peopledata-did/json](https://pypi.org/pypi/acapy-peopledata-did/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acapy-peopledata-did/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-94576df0971bd4` from `pypi_simple` as `registry_expansion`
