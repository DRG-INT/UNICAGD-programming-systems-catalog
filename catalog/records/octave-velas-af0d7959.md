...
<!-- canonical: https://gnu-octave.github.io/packages/velas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/velas](https://gnu-octave.github.io/packages/velas) |
| Source record ids | octave_packages_index-dbb890ad02b169 |

## System Engineer Summary

VELAS is a user-friendly open-source toolbox for the visualization and analysis of elastic
anisotropy written in GNU Octave that can be used for any crystal symmetry.

## Operational Role

For a systems engineer, velas belongs in the Octave inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2023-09-05 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-dbb890ad02b169` from `octave_packages_index` as `registry_expansion`
