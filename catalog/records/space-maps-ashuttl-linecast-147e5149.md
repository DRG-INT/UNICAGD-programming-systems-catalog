...
| Source record ids | github_search_space_maps-63bd0980077012 |

## System Engineer Summary

Weather, tides, the sun, the moon, maps, and a planetarium, in your terminal. The Old Farmer's
Almanac meets Minitel.

## Operational Role

For a systems engineer, ashuttl/linecast belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T02:16:44Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-63bd0980077012` from `github_search_space_maps` as `registry_expansion`
