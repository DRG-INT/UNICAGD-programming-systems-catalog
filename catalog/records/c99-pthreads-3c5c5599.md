...
| Source record ids | corpus-cf055748958e8d |

## System Engineer Summary

pthreads is tracked as a concurrency parallelism record in the C99 branch. The source did not
...
For a systems engineer, pthreads belongs in the C99 inventory as part of ecosystem capability
...
- `corpus-cf055748958e8d` from `master_json` as `concurrency_parallelism`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| C11 threads | Concurrency Parallelism | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-c11-threads-2dea4da9.md) |
