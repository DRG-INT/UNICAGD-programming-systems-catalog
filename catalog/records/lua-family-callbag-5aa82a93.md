...
<!-- canonical: https://luarocks.org/modules/prabirshrestha/callbag -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/prabirshrestha/callbag](https://luarocks.org/modules/prabirshrestha/callbag) |
| Source record ids | luarocks_root_manifest-b4111a5d815b37 |

## System Engineer Summary

callbag is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, callbag belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b4111a5d815b37` from `luarocks_root_manifest` as `registry_expansion`
