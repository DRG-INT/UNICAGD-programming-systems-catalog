...
| Canonical URL | [https://github.com/ossrs/srs](https://github.com/ossrs/srs) |
| Source record ids | github_search_audio-23b9c681cb2357 |

## System Engineer Summary

SRS is a simple, high-performance, AI-driven real-time media server supporting RTMP, WebRTC, HLS,
HTTP-FLV, HTTP-TS, SRT, MPEG-DASH, and GB28181, with codec support for H.264, H.265, AV1, VP9, AAC,
Opus, and G.711.

## Operational Role

For a systems engineer, ossrs/srs belongs in the Audio inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.0-r1 | 2026-08-12T18:06:49Z | [https://api.github.com/repos/ossrs/srs/releases/latest](https://api.github.com/repos/ossrs/srs/releases/latest) |  |
| preview | known | v7.0-d0 | 2026-08-12T20:51:49Z | [https://api.github.com/repos/ossrs/srs/releases?per_page=10](https://api.github.com/repos/ossrs/srs/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ossrs/srs/releases/latest` at `2026-09-01T09:23:19+00:00`.
...
- `github_search_audio-23b9c681cb2357` from `github_search_audio` as `registry_expansion`
