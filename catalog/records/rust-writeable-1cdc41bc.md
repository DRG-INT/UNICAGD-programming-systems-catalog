...
<!-- canonical: https://crates.io/crates/writeable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/writeable](https://crates.io/crates/writeable) |
| Source record ids | crates_io-b66b336dea0eba |
...
For a systems engineer, writeable belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-08-13T23:28:09.637125Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-b66b336dea0eba` from `crates_io` as `registry_expansion`
