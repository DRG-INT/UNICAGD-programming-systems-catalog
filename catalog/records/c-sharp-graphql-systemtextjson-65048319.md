...
<!-- canonical: https://www.nuget.org/packages/GraphQL.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/GraphQL.SystemTextJson](https://www.nuget.org/packages/GraphQL.SystemTextJson) |
| Source record ids | nuget_search-aae576097a801e |
...
For a systems engineer, GraphQL.SystemTextJson belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.8.5 | 2026-08-18T13:56:16.2+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql.systemtextjson/index.json) |  |
| preview | known | 3.0.0-preview-1719 | 2020-08-17T22:25:59.14+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/graphql.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/graphql.systemtextjson/index.json) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; MIT; https://www.nuget.org/packages/GraphQL.SystemTextJson/8.8.5/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/graphql.systemtextjson/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-aae576097a801e` from `nuget_search` as `registry_expansion`
