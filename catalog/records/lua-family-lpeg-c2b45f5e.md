...
<!-- canonical: http://www.inf.puc-rio.br/~roberto/lpeg/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://www.inf.puc-rio.br/~roberto/lpeg/](http://www.inf.puc-rio.br/~roberto/lpeg/) |
| Source record ids | lua-source-258, master-c575857bf553 |
...
For a systems engineer, LPeg belongs in the Lua family inventory as part of language tooling, code
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 258}}` |
...
- `lua-source-258` from `master_json` as `source_list_item`
- `master-c575857bf553` from `master_json` as `parser_lexer_ast`
