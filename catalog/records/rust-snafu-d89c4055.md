...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/snafu -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.2 | 2026-07-21T17:52:51.420139Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-10T06:26:05+00:00`.
...
| --- | --- | --- | --- |
| crates_io | registry-derived | 2026-09-14 | `{"kind": "crates_io", "retrieved": "2026-09-14", "status": "registry-derived"}` |
...
- `crates_io-f09340d35f023b` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| actix-codec | Library | [open](rust-actix-codec-709c01aa.md) |
| adler | Library | [open](rust-adler-1931712a.md) |
| adler2 | Library | [open](rust-adler2-e332371d.md) |
| adler32 | Library | [open](rust-adler32-07e2471b.md) |
| aes-soft | Library | [open](rust-aes-soft-4aab2dd6.md) |
| aliasable | Library | [open](rust-aliasable-96aa15f8.md) |
| alloy-primitives | Library | [open](rust-alloy-primitives-60e7d849.md) |
| alloy-rlp | Library | [open](rust-alloy-rlp-dd7a9406.md) |
