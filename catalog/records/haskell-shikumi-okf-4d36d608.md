...
<!-- canonical: https://hackage.haskell.org/package/shikumi-okf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-okf](https://hackage.haskell.org/package/shikumi-okf) |
| Source record ids | hackage_recent-0154ef14481072 |
...
For a systems engineer, shikumi-okf belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1.0 | 2026-09-08T19:35:27Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-0154ef14481072` from `hackage_recent` as `registry_expansion`
