...
<!-- canonical: https://cran.r-project.org/web/packages/polarzonoid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/polarzonoid/index.html](https://cran.r-project.org/web/packages/polarzonoid/index.html) |
| Source record ids | cran_packages_by_date-64e4cac6015ea7 |

## System Engineer Summary

Compute Maps and Properties of Polar Zonoids

## Operational Role

For a systems engineer, polarzonoid belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4-0 | 2026-08-22 04:30:02 UTC | [https://cran.r-project.org/web/packages/polarzonoid/DESCRIPTION](https://cran.r-project.org/web/packages/polarzonoid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/polarzonoid/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-64e4cac6015ea7` from `cran_packages_by_date` as `registry_expansion`
