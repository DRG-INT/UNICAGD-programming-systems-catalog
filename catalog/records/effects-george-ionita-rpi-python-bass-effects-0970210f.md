# george-ionita/rpi_python_bass_effects
...
<!-- canonical: https://github.com/george-ionita/rpi_python_bass_effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/george-ionita/rpi_python_bass_effects](https://github.com/george-ionita/rpi_python_bass_effects) |
| Source record ids | github_search_effects-eeaf8adea3043c |
...
For a systems engineer, george-ionita/rpi_python_bass_effects belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-10-19T20:03:18Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-eeaf8adea3043c` from `github_search_effects` as `registry_expansion`
