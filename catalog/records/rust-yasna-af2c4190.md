...
<!-- canonical: https://crates.io/crates/yasna -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/yasna](https://crates.io/crates/yasna) |
| Source record ids | crates_io-aa0ce5fe9503d1 |

## System Engineer Summary

yasna is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, yasna belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-03-14T04:29:57.441431Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-aa0ce5fe9503d1` from `crates_io` as `registry_expansion`
