...
<!-- canonical: https://cran.r-project.org/web/packages/smoothROC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smoothROC/index.html](https://cran.r-project.org/web/packages/smoothROC/index.html) |
| Source record ids | cran_packages_by_date-a4ef2254563fb4 |

## System Engineer Summary

Kernel-Smoothed ROC and AUC with Bandwidth Selection

## Operational Role

For a systems engineer, smoothROC belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 17:10:07 UTC | [https://cran.r-project.org/web/packages/smoothROC/DESCRIPTION](https://cran.r-project.org/web/packages/smoothROC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smoothROC/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a4ef2254563fb4` from `cran_packages_by_date` as `registry_expansion`
