...
<!-- canonical: https://packagist.org/packages/pcrov/jsonreader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pcrov/jsonreader](https://packagist.org/packages/pcrov/jsonreader) |
| Source record ids | packagist_search-70014e7ecd11a6 |

## System Engineer Summary

pcrov/jsonreader is tracked as a parser lexer ast record in the PHP branch. The source did not
...
For a systems engineer, pcrov/jsonreader belongs in the PHP inventory as part of language tooling,
...
- `packagist_search-70014e7ecd11a6` from `packagist_search` as `registry_expansion`
