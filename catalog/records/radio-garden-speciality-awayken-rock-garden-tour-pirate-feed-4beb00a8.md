# awayken/Rock-Garden-Tour-Pirate-Feed

## Navigation

[Catalog index](../index.md) · [Language: Radio Garden Speciality](../by-language/radio-garden-speciality.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/awayken/Rock-Garden-Tour-Pirate-Feed -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/awayken/Rock-Garden-Tour-Pirate-Feed](https://github.com/awayken/Rock-Garden-Tour-Pirate-Feed) |
| Source record ids | github_search_radio_garden_speciality-729c6eb45a0ba3 |

## System Engineer Summary

This is what happens when a dude majors in computer science in college. (And gets sick of nine-
minute Rock Garden Tour podcast episodes.) Generates a pirate RSS feed for the Rock Garden Tour
radio show, using ColdFusion.

## Operational Role

For a systems engineer, awayken/Rock-Garden-Tour-Pirate-Feed belongs in the Radio Garden Speciality
inventory as part of language tooling, code generation, static analysis, and source transformation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-09-12T15:10:06Z | gh search repos "radio.garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-729c6eb45a0ba3` from `github_search_radio_garden_speciality` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kristofer-astro/kimika-bot | Parser Lexer Ast | [open](radio-garden-speciality-kristofer-astro-kimika-bot-4aaf56d4.md) |
