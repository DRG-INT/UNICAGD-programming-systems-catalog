...
| Source record ids | github_search_swift-e8a71e8147cbde |
...
For a systems engineer, CosmicMind/Material belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.8 | 2019-09-23T14:10:03Z | [https://api.github.com/repos/CosmicMind/Material/releases/latest](https://api.github.com/repos/CosmicMind/Material/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/CosmicMind/Material/releases/latest` at `2026-09-01T10:26:03+00:00`.
...
- `github_search_swift-e8a71e8147cbde` from `github_search_swift` as `registry_expansion`
