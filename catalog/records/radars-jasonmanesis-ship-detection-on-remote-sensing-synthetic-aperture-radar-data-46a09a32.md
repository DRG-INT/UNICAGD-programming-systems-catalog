...
<!-- canonical: https://github.com/jasonmanesis/Ship-Detection-on-Remote-Sensing-Synthetic-Aperture-Radar-Data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jasonmanesis/Ship-Detection-on-Remote-Sensing-Synthetic-Aperture-Radar-Data](https://github.com/jasonmanesis/Ship-Detection-on-Remote-Sensing-Synthetic-Aperture-Radar-Data) |
| Source record ids | github_search_radars-e64aeef059bee1 |

## System Engineer Summary

Maritime vessel detection from remote sensing SAR data, based on the architectures of the Faster-
RCNN and YOLOv5 networks.

## Operational Role

For a systems engineer, jasonmanesis/Ship-Detection-on-Remote-Sensing-Synthetic-Aperture-Radar-Data
belongs in the Radars inventory as part of language tooling, code generation, static analysis, and
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-06T15:07:37Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e64aeef059bee1` from `github_search_radars` as `registry_expansion`
