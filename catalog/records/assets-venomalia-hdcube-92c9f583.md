...
<!-- canonical: https://github.com/Venomalia/HDcube -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Venomalia/HDcube](https://github.com/Venomalia/HDcube) |
| Source record ids | github_search_assets-52bd4786d7e98b |

## System Engineer Summary

This is an ESRGAN model trained specifically for upscaling GameCube and Wii textures, but it can of
course be used for other textures from that period.

## Operational Role

For a systems engineer, Venomalia/HDcube belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-08-05T18:54:36Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-52bd4786d7e98b` from `github_search_assets` as `registry_expansion`
