...
<!-- canonical: https://cran.r-project.org/web/packages/tmdbR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tmdbR/index.html](https://cran.r-project.org/web/packages/tmdbR/index.html) |
| Source record ids | cran_packages_by_date-cdd8470f7d8b60 |

## System Engineer Summary

Modern 'R' Client for 'The Movie Database' API

## Operational Role

For a systems engineer, tmdbR belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-01 09:00:02 UTC | [https://cran.r-project.org/web/packages/tmdbR/DESCRIPTION](https://cran.r-project.org/web/packages/tmdbR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tmdbR/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-cdd8470f7d8b60` from `cran_packages_by_date` as `registry_expansion`
