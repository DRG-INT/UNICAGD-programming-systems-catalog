...
<!-- canonical: https://github.com/SKBv0/ComfyUI_CreativeCode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SKBv0/ComfyUI_CreativeCode](https://github.com/SKBv0/ComfyUI_CreativeCode) |
| Source record ids | github_search_effects-829e8c7ec0ea5d |

## System Engineer Summary

Real-time coding in ComfyUI with GLSL Shaders and p5.js support. Create generative art, animations,
and visual effects directly within your workflow.

## Operational Role

For a systems engineer, SKBv0/ComfyUI_CreativeCode belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T00:51:51Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-829e8c7ec0ea5d` from `github_search_effects` as `registry_expansion`
