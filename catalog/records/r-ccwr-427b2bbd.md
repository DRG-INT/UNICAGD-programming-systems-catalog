...
<!-- canonical: https://cran.r-project.org/web/packages/ccwr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ccwr/index.html](https://cran.r-project.org/web/packages/ccwr/index.html) |
| Source record ids | cran_packages_by_date-a60dd8f65e4424 |

## System Engineer Summary

Clone-Censor-Weight Methods for Target Trial Emulation

## Operational Role

For a systems engineer, ccwr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-09-03 12:00:16 UTC | [https://cran.r-project.org/web/packages/ccwr/DESCRIPTION](https://cran.r-project.org/web/packages/ccwr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ccwr/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-a60dd8f65e4424` from `cran_packages_by_date` as `registry_expansion`
