...
<!-- canonical: https://cran.r-project.org/web/packages/glmMisrep/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/glmMisrep/index.html](https://cran.r-project.org/web/packages/glmMisrep/index.html) |
| Source record ids | cran_packages_by_date-7381418890421d |
...
For a systems engineer, glmMisrep belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-20 23:00:02 UTC | [https://cran.r-project.org/web/packages/glmMisrep/DESCRIPTION](https://cran.r-project.org/web/packages/glmMisrep/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/glmMisrep/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7381418890421d` from `cran_packages_by_date` as `registry_expansion`
