...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/go-ego/riot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/go-ego/riot](https://github.com/go-ego/riot) |
| Source record ids | github_search_catalogs-2594140f286e06 |

## System Engineer Summary

Go Open Source, Distributed, Simple and efficient Search Engine; Warning: This is V1 and beta
version, because of big memory consume, and the V2 will be rewrite all code.

## Operational Role

For a systems engineer, go-ego/riot belongs in the Catalogs inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-13T13:31:05Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-2594140f286e06` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| baotonglu/dash | Memory Analyzer | [open](catalogs-baotonglu-dash-cf3f420e.md) |
| FgForrest/evitaDB | Memory Analyzer | [open](catalogs-fgforrest-evitadb-0b44527c.md) |
| ggrandes/kvstore | Memory Analyzer | [open](catalogs-ggrandes-kvstore-6580d57c.md) |
| thustorage/Sherman | Memory Analyzer | [open](catalogs-thustorage-sherman-1b85d616.md) |
