...
<!-- canonical: https://cran.r-project.org/web/packages/rifexpectile/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rifexpectile/index.html](https://cran.r-project.org/web/packages/rifexpectile/index.html) |
| Source record ids | cran_packages_by_date-608ed56381d998 |
...
For a systems engineer, rifexpectile belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-31 22:00:21 UTC | [https://cran.r-project.org/web/packages/rifexpectile/DESCRIPTION](https://cran.r-project.org/web/packages/rifexpectile/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rifexpectile/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-608ed56381d998` from `cran_packages_by_date` as `registry_expansion`
