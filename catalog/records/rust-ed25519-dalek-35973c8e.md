...
<!-- canonical: https://crates.io/crates/ed25519-dalek -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ed25519-dalek](https://crates.io/crates/ed25519-dalek) |
| Source record ids | crates_io-d0f026a11b42eb |
...
For a systems engineer, ed25519-dalek belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-07-06T16:23:09.992366Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-d0f026a11b42eb` from `crates_io` as `registry_expansion`
