...
<!-- canonical: https://pub.dev/packages/material_color_utilities -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/material_color_utilities](https://pub.dev/packages/material_color_utilities) |
| Source record ids | pub_dev-2af2f78036087d |

## System Engineer Summary

Algorithms and utilities that power the Material Design 3 color system, including choosing theme
colors from images and creating tones of colors; all in a new color space.

## Operational Role

For a systems engineer, material_color_utilities belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.1 | 2026-08-10T14:58:12.420872Z | [https://pub.dev/api/packages/material_color_utilities](https://pub.dev/api/packages/material_color_utilities) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/material_color_utilities` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-2af2f78036087d` from `pub_dev` as `registry_expansion`
