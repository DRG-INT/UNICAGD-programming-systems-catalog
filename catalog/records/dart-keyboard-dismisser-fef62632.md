...
<!-- canonical: https://pub.dev/packages/keyboard_dismisser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/keyboard_dismisser](https://pub.dev/packages/keyboard_dismisser) |
| Source record ids | pub_dev-cff4b061473b46 |
...
For a systems engineer, keyboard_dismisser belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2022-05-20T14:54:12.709877Z | [https://pub.dev/api/packages/keyboard_dismisser](https://pub.dev/api/packages/keyboard_dismisser) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/keyboard_dismisser` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-cff4b061473b46` from `pub_dev` as `registry_expansion`
