...
<!-- canonical: https://github.com/ArcReel/ArcReel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ArcReel/ArcReel](https://github.com/ArcReel/ArcReel) |
| Source record ids | github_search_video-15037b1af7a1cc |

## System Engineer Summary

AI Agent 驱动的开源可自部署视频工作台：将小说与剧本转为角色、场景、道具资产、分镜、视频和剪映草稿，支持跨镜头一致性、多供应商与费用追踪 | Self-hosted AI video
workspace for stories, storyboards and short-form video production

## Operational Role

For a systems engineer, ArcReel/ArcReel belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T09:05:14Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-15037b1af7a1cc` from `github_search_video` as `registry_expansion`
