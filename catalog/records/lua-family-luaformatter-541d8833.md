...
| Source record ids | corpus-eac7c20c0ba7d4 |

## System Engineer Summary

LuaFormatter is tracked as a formatter record in the Lua family branch. The source did not provide a
...
For a systems engineer, LuaFormatter belongs in the Lua family inventory as part of low-noise code
...
- `corpus-eac7c20c0ba7d4` from `master_json` as `formatter`
...
| lunamark | Formatter | [open](lua-family-lunamark-793c19e5.md) |
