...
<!-- canonical: https://crates.io/crates/rmp-serde -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rmp-serde](https://crates.io/crates/rmp-serde) |
| Source record ids | crates_io-339cd6ce3b1fe3 |
...
For a systems engineer, rmp-serde belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2025-12-23T23:54:42.671970Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-339cd6ce3b1fe3` from `crates_io` as `registry_expansion`
