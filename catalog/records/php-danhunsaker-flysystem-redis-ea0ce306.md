...
<!-- canonical: https://packagist.org/packages/danhunsaker/flysystem-redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/danhunsaker/flysystem-redis](https://packagist.org/packages/danhunsaker/flysystem-redis) |
| Source record ids | packagist_search-4dd0929c9e7b7d |
...
For a systems engineer, danhunsaker/flysystem-redis belongs in the PHP inventory as part of state
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `packagist_search-4dd0929c9e7b7d` from `packagist_search` as `registry_expansion`
