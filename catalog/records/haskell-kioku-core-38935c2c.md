...
| Canonical URL | [https://hackage.haskell.org/package/kioku-core](https://hackage.haskell.org/package/kioku-core) |
| Source record ids | hackage_recent-2c80f696145345 |
...
For a systems engineer, kioku-core belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2.0 | 2026-09-01T03:56:37Z | [https://hackage.haskell.org/package/kioku-core](https://hackage.haskell.org/package/kioku-core) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kioku-core` at `2026-09-01T07:24:07+00:00`.
...
- `hackage_recent-2c80f696145345` from `hackage_recent` as `registry_expansion`
