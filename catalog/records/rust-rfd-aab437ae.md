...
| Canonical URL | [https://crates.io/crates/rfd](https://crates.io/crates/rfd) |
| Source record ids | crates_io-d3c90e8c0e3bc8 |

## System Engineer Summary

rfd is tracked as a logging observability record in the Rust branch. The source did not provide a
...
For a systems engineer, rfd belongs in the Rust inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.17.2 | 2026-01-12T20:57:19.255609Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-d3c90e8c0e3bc8` from `crates_io` as `registry_expansion`
