...
<!-- canonical: https://crates.io/crates/insta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/insta](https://crates.io/crates/insta) |
| Source record ids | crates_io-eafc680ec4b7e9 |
...
For a systems engineer, insta belongs in the Rust inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.48.0 | 2026-06-11T14:13:41.200726Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-eafc680ec4b7e9` from `crates_io` as `registry_expansion`
