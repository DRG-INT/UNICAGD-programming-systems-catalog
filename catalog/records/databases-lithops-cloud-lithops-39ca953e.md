...
<!-- canonical: https://github.com/lithops-cloud/lithops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lithops-cloud/lithops](https://github.com/lithops-cloud/lithops) |
| Source record ids | github_search_databases-3269bb84b89691 |

## System Engineer Summary

A multi-cloud framework for big data analytics and embarrassingly parallel jobs, that provides an
universal API for building parallel applications in the cloud ☁️🚀

## Operational Role

For a systems engineer, lithops-cloud/lithops belongs in the Databases inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T13:44:14Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3269bb84b89691` from `github_search_databases` as `registry_expansion`
...
| genkit-ai/genkit | Build System | [open](databases-genkit-ai-genkit-d1a3caa1.md) |
| griddb/griddb | Build System | [open](databases-griddb-griddb-b48b6432.md) |
| kossakovsky/selfhost-ai | Build System | [open](databases-kossakovsky-selfhost-ai-b4f9a555.md) |
| kysely-org/kysely | Build System | [open](databases-kysely-org-kysely-0eff4c79.md) |
