...
<!-- canonical: https://crates.io/crates/lru-slab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/lru-slab](https://crates.io/crates/lru-slab) |
| Source record ids | crates_io-08583eeee63957 |
...
For a systems engineer, lru-slab belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-13T19:19:47.208511Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-13T20:19:17+00:00`.
...
- `crates_io-08583eeee63957` from `crates_io` as `registry_expansion`
