...
<!-- canonical: https://pub.dev/packages/group_button -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/group_button](https://pub.dev/packages/group_button) |
| Source record ids | pub_dev-ef5a948c0de085 |
...
For a systems engineer, group_button belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.4 | 2024-01-09T08:58:31.062648Z | [https://pub.dev/api/packages/group_button](https://pub.dev/api/packages/group_button) |  |
| preview | known | 5.2.1-dev.1 | 2022-09-12T12:41:08.897261Z | [https://pub.dev/api/packages/group_button](https://pub.dev/api/packages/group_button) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/group_button` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-ef5a948c0de085` from `pub_dev` as `registry_expansion`
