...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/debian-build -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/debian-build](https://hackage.haskell.org/package/debian-build) |
| Source record ids | hackage_top_downloads-ae7ba350b02cc3 |
...
For a systems engineer, debian-build belongs in the Haskell inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.2.1 | 2021-09-04T11:39:39Z | [https://hackage.haskell.org/package/debian-build](https://hackage.haskell.org/package/debian-build) |  |
| candidate | partial | 0.10.1.1 |  | [https://hackage.haskell.org/package/debian-build](https://hackage.haskell.org/package/debian-build) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/debian-build` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-ae7ba350b02cc3` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| api-builder | Build System | [open](haskell-api-builder-7e06b18b.md) |
| blaze-builder | Build System | [open](haskell-blaze-builder-b3c25d08.md) |
| buffer-builder | Build System | [open](haskell-buffer-builder-7c396083.md) |
| buildbox | Build System | [open](haskell-buildbox-ac3fe982.md) |
| buildwrapper | Build System | [open](haskell-buildwrapper-f31b8ef2.md) |
| bytestring-tree-builder | Build System | [open](haskell-bytestring-tree-builder-70afc643.md) |
| diagrams-builder | Build System | [open](haskell-diagrams-builder-ffd7884d.md) |
| gtk2hs-buildtools | Build System | [open](haskell-gtk2hs-buildtools-90244e73.md) |
