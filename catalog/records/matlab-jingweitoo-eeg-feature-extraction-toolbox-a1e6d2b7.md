...
<!-- canonical: https://github.com/JingweiToo/EEG-Feature-Extraction-Toolbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JingweiToo/EEG-Feature-Extraction-Toolbox](https://github.com/JingweiToo/EEG-Feature-Extraction-Toolbox) |
| Source record ids | github_search_matlab-f4c9f5d77c4903 |

## System Engineer Summary

This toolbox offers 30 types of EEG feature extraction methods (HA, HM, HC, and etc.) for
Electroencephalogram (EEG) applications.

## Operational Role

For a systems engineer, JingweiToo/EEG-Feature-Extraction-Toolbox belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-10T04:50:52Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-f4c9f5d77c4903` from `github_search_matlab` as `registry_expansion`
