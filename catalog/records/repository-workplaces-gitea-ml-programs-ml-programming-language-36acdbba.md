# Gitea: ML-Programs/ml-programming-language
...
<!-- canonical: https://gitea.com/ML-Programs/ml-programming-language -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/ML-Programs/ml-programming-language](https://gitea.com/ML-Programs/ml-programming-language) |
| Source record ids | gitea_repositories_api-5abad1c4e6779c |

## System Engineer Summary

ML or MiniLang is a simple programming language designed for demonstration purposes. It supports
basic arithmetic operations, variable assignment, and a print statement.

## Operational Role

For a systems engineer, Gitea: ML-Programs/ml-programming-language belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-03T22:38:09Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-5abad1c4e6779c` from `gitea_repositories_api` as `registry_expansion`
