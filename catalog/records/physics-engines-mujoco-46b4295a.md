...
| Canonical URL | [https://github.com/google-deepmind/mujoco](https://github.com/google-deepmind/mujoco) |
| Source record ids | curated_language_routes-a8a09678060a55 |

## System Engineer Summary

Physics engine for robotics, biomechanics, contacts, articulated bodies, simulation, and control
research.

## Operational Role

For a systems engineer, MuJoCo belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.12.0 | 2026-08-20T11:11:59Z | [https://api.github.com/repos/google-deepmind/mujoco/releases/latest](https://api.github.com/repos/google-deepmind/mujoco/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/google-deepmind/mujoco/releases/latest` at `2026-09-01T07:24:41+00:00`.
...
- `curated_language_routes-a8a09678060a55` from `curated_language_routes` as `registry_expansion`
