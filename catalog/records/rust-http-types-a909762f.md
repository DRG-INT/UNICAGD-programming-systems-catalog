...
<!-- canonical: https://crates.io/crates/http-types -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/http-types](https://crates.io/crates/http-types) |
| Source record ids | crates_io-fb5be85ecfe6bb |
...
For a systems engineer, http-types belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.12.0 | 2021-08-10T17:22:45.729254Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-fb5be85ecfe6bb` from `crates_io` as `registry_expansion`
