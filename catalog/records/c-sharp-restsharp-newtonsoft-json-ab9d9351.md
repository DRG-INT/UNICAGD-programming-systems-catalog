...
<!-- canonical: https://www.nuget.org/packages/RestSharp.Newtonsoft.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/RestSharp.Newtonsoft.Json](https://www.nuget.org/packages/RestSharp.Newtonsoft.Json) |
| Source record ids | nuget_search-ca8e8a1513e446 |
...
For a systems engineer, RestSharp.Newtonsoft.Json belongs in the C-Sharp inventory as part of wire
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.1 | 2018-12-25T15:48:08.93+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/restsharp.newtonsoft.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/restsharp.newtonsoft.json/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; https://github.com/adamfisher/RestSharp.Serializers.Newtonsoft.Json/blob/master/LICENSE |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/restsharp.newtonsoft.json/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-ca8e8a1513e446` from `nuget_search` as `registry_expansion`
