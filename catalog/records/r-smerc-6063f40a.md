...
<!-- canonical: https://cran.r-project.org/web/packages/smerc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smerc/index.html](https://cran.r-project.org/web/packages/smerc/index.html) |
| Source record ids | cran_packages_by_date-c5dd5067586db7 |
...
For a systems engineer, smerc belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.6 | 2026-08-20 05:20:27 UTC | [https://cran.r-project.org/web/packages/smerc/DESCRIPTION](https://cran.r-project.org/web/packages/smerc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smerc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c5dd5067586db7` from `cran_packages_by_date` as `registry_expansion`
