...
<!-- canonical: https://packagist.org/packages/laravel/pao -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laravel/pao](https://packagist.org/packages/laravel/pao) |
| Source record ids | packagist_search-b95873d5494a47 |
...
For a systems engineer, laravel/pao belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-b95873d5494a47` from `packagist_search` as `registry_expansion`
