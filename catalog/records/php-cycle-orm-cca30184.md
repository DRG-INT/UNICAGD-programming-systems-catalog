...
| Canonical URL | [https://packagist.org/packages/cycle/orm](https://packagist.org/packages/cycle/orm) |
| Source record ids | packagist_search-6446f48945450c |
...
For a systems engineer, cycle/orm belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.18.0 | 2026-06-15T16:49:22+00:00 | [https://repo.packagist.org/p2/cycle/orm.json](https://repo.packagist.org/p2/cycle/orm.json) |  |
| preview | known | 2.11.0-RC1 | 2025-05-04T14:33:56+00:00 | [https://repo.packagist.org/p2/cycle/orm.json](https://repo.packagist.org/p2/cycle/orm.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/cycle/orm.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-6446f48945450c` from `packagist_search` as `registry_expansion`
