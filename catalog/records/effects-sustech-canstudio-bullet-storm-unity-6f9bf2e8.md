...
<!-- canonical: https://github.com/SUSTech-CANStudio/bullet-storm-unity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SUSTech-CANStudio/bullet-storm-unity](https://github.com/SUSTech-CANStudio/bullet-storm-unity) |
| Source record ids | github_search_effects-bfc732fb5bece5 |
...
For a systems engineer, SUSTech-CANStudio/bullet-storm-unity belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-04-21T18:51:00Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-bfc732fb5bece5` from `github_search_effects` as `registry_expansion`
