# petterh/range-slider

## Navigation

[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/petterh/range-slider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/petterh/range-slider](https://github.com/petterh/range-slider) |
| Source record ids | github_search_magazines-c35b0fc30d4ed6 |

## System Engineer Summary

In a 2001 I devoted one of my "User Interface Programming" columns (Windows Developer's
Journal/Windows Developer Magazine) to a simple range slider. Due to space constraints in the print
mag, it was fairly simple, so I later expanded on it and published the result on my web site. This
project serves as a repository for that old Win32 project (which still works and compiles), plus a
new effort to create modern versions -- starting with WPF.

## Operational Role

For a systems engineer, petterh/range-slider belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "developer magazine", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_magazines-c35b0fc30d4ed6` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Abdo-Hussien/Magazine-System | Undefined Behavior Analyzer | [open](magazines-abdo-hussien-magazine-system-99fd7e1b.md) |
| api-evangelist/vox-media | Undefined Behavior Analyzer | [open](magazines-api-evangelist-vox-media-808b1be2.md) |
| ayushi7rawat/Ultimate-Python-Resource-Hub | Undefined Behavior Analyzer | [open](magazines-ayushi7rawat-ultimate-python-resource-hub-7be0a988.md) |
| bahdotsh/blogr | Undefined Behavior Analyzer | [open](magazines-bahdotsh-blogr-a26c09e7.md) |
| bindthegap/bindthegap.github.io | Undefined Behavior Analyzer | [open](magazines-bindthegap-bindthegap-github-io-fd1d4194.md) |
| brycewang-stanford/Awesome-Journal-Skills | Undefined Behavior Analyzer | [open](magazines-brycewang-stanford-awesome-journal-skills-ea63d997.md) |
| daryllxd/lifelong-learning | Undefined Behavior Analyzer | [open](magazines-daryllxd-lifelong-learning-9f4c2b9f.md) |
| dcodesdev/LetterSpace | Undefined Behavior Analyzer | [open](magazines-dcodesdev-letterspace-64787355.md) |
