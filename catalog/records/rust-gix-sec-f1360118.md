...
| Canonical URL | [https://crates.io/crates/gix-sec](https://crates.io/crates/gix-sec) |
| Source record ids | crates_io-e8e38467c773a7 |
...
For a systems engineer, gix-sec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.2 | 2026-07-23T13:04:27.942846Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-e8e38467c773a7` from `crates_io` as `registry_expansion`
