...
<!-- canonical: https://cran.r-project.org/web/packages/diffuseR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/diffuseR/index.html](https://cran.r-project.org/web/packages/diffuseR/index.html) |
| Source record ids | cran_packages_by_date-3e720fb1fc2cde |

## System Engineer Summary

Functional Interface to Diffusion Models in R

## Operational Role

For a systems engineer, diffuseR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-08 12:40:02 UTC | [https://cran.r-project.org/web/packages/diffuseR/DESCRIPTION](https://cran.r-project.org/web/packages/diffuseR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/diffuseR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3e720fb1fc2cde` from `cran_packages_by_date` as `registry_expansion`
