...
<!-- canonical: https://github.com/xolox/lua-lxsh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xolox/lua-lxsh](https://github.com/xolox/lua-lxsh) |
| Source record ids | lua-source-265 |
...
For a systems engineer, LXSH belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 265}}` |
...
- `lua-source-265` from `master_json` as `source_list_item`
