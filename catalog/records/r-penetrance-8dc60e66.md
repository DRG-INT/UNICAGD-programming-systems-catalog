...
<!-- canonical: https://cran.r-project.org/web/packages/penetrance/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/penetrance/index.html](https://cran.r-project.org/web/packages/penetrance/index.html) |
| Source record ids | cran_packages_by_date-2940534456b8b0 |

## System Engineer Summary

Methods for Penetrance Estimation in Family-Based Studies

## Operational Role

For a systems engineer, penetrance belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-08 19:00:02 UTC | [https://cran.r-project.org/web/packages/penetrance/DESCRIPTION](https://cran.r-project.org/web/packages/penetrance/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/penetrance/DESCRIPTION` at `2026-09-08T20:19:48+00:00`.
...
- `cran_packages_by_date-2940534456b8b0` from `cran_packages_by_date` as `registry_expansion`
