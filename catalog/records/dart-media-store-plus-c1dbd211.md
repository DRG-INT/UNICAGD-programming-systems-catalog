...
<!-- canonical: https://pub.dev/packages/media_store_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/media_store_plus](https://pub.dev/packages/media_store_plus) |
| Source record ids | pub_dev-49e3bffba764cc |

## System Engineer Summary

To use Android MediaStore API in Flutter, It supports both read & write operation in every android
version through flutter.

## Operational Role

For a systems engineer, media_store_plus belongs in the Dart inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2024-09-22T20:01:46.939286Z | [https://pub.dev/api/packages/media_store_plus](https://pub.dev/api/packages/media_store_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/media_store_plus` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-49e3bffba764cc` from `pub_dev` as `registry_expansion`
