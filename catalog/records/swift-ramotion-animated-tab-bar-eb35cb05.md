...
<!-- canonical: https://github.com/Ramotion/animated-tab-bar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Ramotion/animated-tab-bar](https://github.com/Ramotion/animated-tab-bar) |
| Source record ids | github_search_swift-2e6ac8ff604982 |

## System Engineer Summary

:octocat: RAMAnimatedTabBarController is a Swift UI module library for adding animation to iOS
tabbar items and icons. iOS library made by @Ramotion

## Operational Role

For a systems engineer, Ramotion/animated-tab-bar belongs in the Swift inventory as part of
...
- `github_search_swift-2e6ac8ff604982` from `github_search_swift` as `registry_expansion`
