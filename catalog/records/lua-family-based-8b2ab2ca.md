...
<!-- canonical: https://luarocks.org/modules/darkwiiplayer/based -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/darkwiiplayer/based](https://luarocks.org/modules/darkwiiplayer/based) |
| Source record ids | luarocks_root_manifest-7fc4e6317c899c |
...
For a systems engineer, based belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7fc4e6317c899c` from `luarocks_root_manifest` as `registry_expansion`
