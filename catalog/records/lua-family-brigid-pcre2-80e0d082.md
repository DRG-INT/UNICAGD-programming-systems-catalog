...
<!-- canonical: https://luarocks.org/modules/brigid-jp/brigid-pcre2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/brigid-jp/brigid-pcre2](https://luarocks.org/modules/brigid-jp/brigid-pcre2) |
| Source record ids | luarocks_root_manifest-7d8ccc023710ea |

## System Engineer Summary

brigid-pcre2 is tracked as a ffi bindings record in the Lua family branch. The source did not
...
For a systems engineer, brigid-pcre2 belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-7d8ccc023710ea` from `luarocks_root_manifest` as `registry_expansion`
