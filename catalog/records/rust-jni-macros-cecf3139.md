...
| Canonical URL | [https://crates.io/crates/jni-macros](https://crates.io/crates/jni-macros) |
| Source record ids | crates_io-43069f93aa5714 |
...
For a systems engineer, jni-macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.4 | 2026-03-16T13:29:39.385205Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-43069f93aa5714` from `crates_io` as `registry_expansion`
