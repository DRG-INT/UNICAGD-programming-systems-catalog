...
<!-- canonical: https://packagist.org/packages/psr/link -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/psr/link](https://packagist.org/packages/psr/link) |
| Source record ids | packagist_search-336d3a2b395385 |
...
For a systems engineer, psr/link belongs in the PHP inventory as part of service communication,
...
- `packagist_search-336d3a2b395385` from `packagist_search` as `registry_expansion`
