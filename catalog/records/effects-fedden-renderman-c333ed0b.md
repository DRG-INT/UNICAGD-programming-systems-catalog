...
<!-- canonical: https://github.com/fedden/RenderMan -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fedden/RenderMan](https://github.com/fedden/RenderMan) |
| Source record ids | github_search_effects-34a2d631ec0336 |

## System Engineer Summary

Command line C++ and Python VSTi Host library with MFCC, FFT, RMS and audio extraction and .wav
writing.

## Operational Role

For a systems engineer, fedden/RenderMan belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-02T21:11:26Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-34a2d631ec0336` from `github_search_effects` as `registry_expansion`
