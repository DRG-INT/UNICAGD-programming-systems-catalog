...
| Canonical URL | [https://luarocks.org/modules/pa/imgui](https://luarocks.org/modules/pa/imgui) |
| Source record ids | luarocks_root_manifest-9019df8fe88394 |

## System Engineer Summary

imgui is tracked as a visualization gui record in the Lua family branch. The source did not provide
...
For a systems engineer, imgui belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9019df8fe88394` from `luarocks_root_manifest` as `registry_expansion`
