...
<!-- canonical: https://github.com/neodsp/neort -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neodsp/neort](https://github.com/neodsp/neort) |
| Source record ids | github_search_effects-24c8f88242f2d4 |

## System Engineer Summary

neort is a framework for real-time audio applications, including audio IO, effects and visualization

## Operational Role

For a systems engineer, neodsp/neort belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-19T06:42:32Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-24c8f88242f2d4` from `github_search_effects` as `registry_expansion`
