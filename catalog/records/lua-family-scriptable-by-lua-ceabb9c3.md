...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Other](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/other.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | lua-source-42 |

## System Engineer Summary

Scriptable by Lua is tracked as an other record in the Lua family branch. The source did not provide
...
For a systems engineer, Scriptable by Lua belongs in the Lua family inventory as part of ecosystem
...
- Treat category as `other` unless a later verified source gives a better classification.
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 42}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-42` from `master_json` as `source_list_item`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Articles | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-articles-c87b05c6.md) |
| Data Stores | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-data-stores-34c32814.md) |
| Experimental, etc | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-experimental-etc-7c96177c.md) |
| Humanize | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-humanize-8c52cc7b.md) |
| lua-source-162 | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-source-162-fd45a267.md) |
| lua-source-165 | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-source-165-9bd1b6db.md) |
| lua-source-254 | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-source-254-f0ba8f6a.md) |
| lua-source-257 | Other | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-lua-source-257-89d16ecc.md) |
