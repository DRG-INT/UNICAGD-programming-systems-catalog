# beepboopshru/cassini-trajectory-analysis
...
<!-- canonical: https://github.com/beepboopshru/cassini-trajectory-analysis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/beepboopshru/cassini-trajectory-analysis](https://github.com/beepboopshru/cassini-trajectory-analysis) |
| Source record ids | github_search_space_maps-993312a19be778 |

## System Engineer Summary

Reconstructs Cassini's Saturn trajectory from NASA SPICE kernels with spiceypy.

## Operational Role

For a systems engineer, beepboopshru/cassini-trajectory-analysis belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T07:03:35Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-993312a19be778` from `github_search_space_maps` as `registry_expansion`
