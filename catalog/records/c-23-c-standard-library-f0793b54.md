...
<!-- canonical: https://en.wikipedia.org/wiki/C%2B%2B_Standard_Library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://en.wikipedia.org/wiki/C%2B%2B_Standard_Library](https://en.wikipedia.org/wiki/C%2B%2B_Standard_Library) |
| Source record ids | awesome_list-9cc597588b362f |

## System Engineer Summary

A collection of classes and functions, which are written in the core language and part of the C++
ISO Standard itself.

## Operational Role

For a systems engineer, C++ Standard Library belongs in the C++23 inventory as part of ecosystem
...
- `awesome_list-9cc597588b362f` from `awesome_list` as `registry_expansion`
