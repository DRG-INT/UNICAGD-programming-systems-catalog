...
<!-- canonical: https://github.com/cyberbotics/webots -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cyberbotics/webots](https://github.com/cyberbotics/webots) |
| Source record ids | github_search_physics_engines-ec2c2d4fddcfdf |

## System Engineer Summary

cyberbotics/webots is tracked as a game engine game dev record in the Physics Engines branch. The
...
For a systems engineer, cyberbotics/webots belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T23:17:59Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-ec2c2d4fddcfdf` from `github_search_physics_engines` as `registry_expansion`
