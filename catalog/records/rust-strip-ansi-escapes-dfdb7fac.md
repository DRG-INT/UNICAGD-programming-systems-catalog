...
<!-- canonical: https://crates.io/crates/strip-ansi-escapes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/strip-ansi-escapes](https://crates.io/crates/strip-ansi-escapes) |
| Source record ids | crates_io-63585ce81200ff |
...
For a systems engineer, strip-ansi-escapes belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2025-01-14T15:47:27.043349Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-63585ce81200ff` from `crates_io` as `registry_expansion`
