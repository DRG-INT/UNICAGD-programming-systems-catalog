...
<!-- canonical: https://github.com/tapparelj/gr-lora_sdr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tapparelj/gr-lora_sdr](https://github.com/tapparelj/gr-lora_sdr) |
| Source record ids | github_search_satcom_satellites-313d22cae0dc88 |

## System Engineer Summary

This is the fully-functional GNU Radio software-defined radio (SDR) implementation of a LoRa
transceiver with all the necessary receiver components to operate correctly even at very low SNRs.
This work has been conducted at the Telecommunication Circuits Laboratory, EPFL.

## Operational Role

For a systems engineer, tapparelj/gr-lora_sdr belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-05T15:46:12Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-313d22cae0dc88` from `github_search_satcom_satellites` as `registry_expansion`
