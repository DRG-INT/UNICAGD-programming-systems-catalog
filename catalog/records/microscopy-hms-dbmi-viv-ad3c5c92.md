...
<!-- canonical: https://github.com/hms-dbmi/viv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hms-dbmi/viv](https://github.com/hms-dbmi/viv) |
| Source record ids | github_search_microscopy-6cbc1c81e4a73d |

## System Engineer Summary

Library for multiscale visualization of high-resolution multiplexed bioimaging data on the web.
Directly renders Zarr and OME-TIFF.

## Operational Role

For a systems engineer, hms-dbmi/viv belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | @hms-dbmi/viv@0.16.1 | 2024-03-13T03:15:38Z | [https://api.github.com/repos/hms-dbmi/viv/releases/latest](https://api.github.com/repos/hms-dbmi/viv/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/hms-dbmi/viv/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
- `github_search_microscopy-6cbc1c81e4a73d` from `github_search_microscopy` as `registry_expansion`
