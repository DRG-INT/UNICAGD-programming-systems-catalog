...
<!-- canonical: https://github.com/mabel-dev/opteryx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mabel-dev/opteryx](https://github.com/mabel-dev/opteryx) |
| Source record ids | github_search_databases-2eefa5052cad2c |

## System Engineer Summary

🦖 A SQL-on-everything Query Engine you can execute over multiple databases and file formats. Query
your data, where it lives.

## Operational Role

For a systems engineer, mabel-dev/opteryx belongs in the Databases inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T09:29:10Z | gh search repos topic:serverless-database stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-08 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:serverless-database stars:>20", "retrieved": "2026-09-08", "status": "forge-cli-derived"}` |
...
- `github_search_databases-2eefa5052cad2c` from `github_search_databases` as `registry_expansion`
