...
<!-- canonical: https://cran.r-project.org/web/packages/netDFI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/netDFI/index.html](https://cran.r-project.org/web/packages/netDFI/index.html) |
| Source record ids | cran_packages_by_date-3ae39a0f26b84e |
...
For a systems engineer, netDFI belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-15 13:20:08 UTC | [https://cran.r-project.org/web/packages/netDFI/DESCRIPTION](https://cran.r-project.org/web/packages/netDFI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/netDFI/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-3ae39a0f26b84e` from `cran_packages_by_date` as `registry_expansion`
