...
| Canonical URL | [https://luarocks.org/modules/kibadda/kanban.nvim](https://luarocks.org/modules/kibadda/kanban.nvim) |
| Source record ids | luarocks_root_manifest-87ff717ac21ac7 |

## System Engineer Summary

kanban.nvim is tracked as an ide editor integration record in the Lua family branch. The source did
...
For a systems engineer, kanban.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-87ff717ac21ac7` from `luarocks_root_manifest` as `registry_expansion`
