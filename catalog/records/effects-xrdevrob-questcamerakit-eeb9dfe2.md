...
<!-- canonical: https://github.com/xrdevrob/QuestCameraKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xrdevrob/QuestCameraKit](https://github.com/xrdevrob/QuestCameraKit) |
| Source record ids | github_search_effects-0b027c795b6f32 |

## System Engineer Summary

QuestVisionKit is a collection of template and reference projects demonstrating how to use Meta
Quest’s new Passthrough Camera API for advanced AR/VR vision, tracking, and shader effects.

## Operational Role

For a systems engineer, xrdevrob/QuestCameraKit belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-08T10:07:22Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-0b027c795b6f32` from `github_search_effects` as `registry_expansion`
