...
<!-- canonical: https://github.com/hikerpig/note-graph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hikerpig/note-graph](https://github.com/hikerpig/note-graph) |
| Source record ids | github_search_space_maps-93383752c735fd |

## System Engineer Summary

A generic visualization lib designed to show the structure of the document space and the relations
between each doc.

## Operational Role

For a systems engineer, hikerpig/note-graph belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-21T04:37:41Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-93383752c735fd` from `github_search_space_maps` as `registry_expansion`
