...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Python](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/python.md) · [Category: Web Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/web-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-8ddac9504a2cfc |

## System Engineer Summary

Starlette is tracked as a web framework record in the Python branch. The source did not provide a
...
For a systems engineer, Starlette belongs in the Python inventory as part of request routing,
middleware policy, service structure, and deployment surface.
...
- `corpus-8ddac9504a2cfc` from `master_json` as `web_framework`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| aiohttp | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-aiohttp-7ff48487.md) |
| Bottle | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-bottle-57369310.md) |
| CherryPy | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-cherrypy-92c7948b.md) |
| Django | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-django-c22c55f8.md) |
| Falcon | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-falcon-c570a7e5.md) |
| FastAPI | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-fastapi-08264570.md) |
| Flask | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-flask-4622a4a5.md) |
| Litestar | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/python-litestar-c82f6af5.md) |
