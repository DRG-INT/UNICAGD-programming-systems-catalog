...
<!-- canonical: https://pypi.org/project/ab-auth-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-auth-client/](https://pypi.org/project/ab-auth-client/) |
| Source record ids | pypi_simple-352f9dd5a85544 |

## System Engineer Summary

ab-auth-client is tracked as a networking http record in the Python branch. The source did not
...
For a systems engineer, ab-auth-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.16 | 2026-03-01T07:12:41.663013Z | [https://pypi.org/pypi/ab-auth-client/json](https://pypi.org/pypi/ab-auth-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-auth-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-352f9dd5a85544` from `pypi_simple` as `registry_expansion`
