...
<!-- canonical: https://pub.dev/packages/riverpod -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/riverpod](https://pub.dev/packages/riverpod) |
| Source record ids | pub_dev-d311ff3cfad944 |

## System Engineer Summary

A reactive caching and data-binding framework. Riverpod makes working with asynchronous code a
breeze.

## Operational Role

For a systems engineer, riverpod belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.3 | 2026-09-03T22:14:57.641244Z | [https://pub.dev/api/packages/riverpod](https://pub.dev/api/packages/riverpod) |  |
| preview | known | 3.3.2-dev.2 | 2026-05-06T12:34:05.527153Z | [https://pub.dev/api/packages/riverpod](https://pub.dev/api/packages/riverpod) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/riverpod` at `2026-09-04T00:27:45+00:00`.
...
- `pub_dev-d311ff3cfad944` from `pub_dev` as `registry_expansion`
