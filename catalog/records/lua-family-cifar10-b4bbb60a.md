...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Precommit Ci Quality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/precommit-ci-quality.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/pedropgusmao/cifar10](https://luarocks.org/modules/pedropgusmao/cifar10) |
| Source record ids | luarocks_root_manifest-d51b8eca8a855f |

## System Engineer Summary

cifar10 is tracked as a precommit ci quality record in the Lua family branch. The source did not
...
For a systems engineer, cifar10 belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| AnyAscii | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-anyascii-bc8b5a01.md) |
| balance-tree | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-balance-tree-747c149a.md) |
| bint | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bint-17614521.md) |
| chacha | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-chacha-5026769d.md) |
| cifar | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-cifar-ae1e3fad.md) |
| civ | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-civ-a83f4d89.md) |
| civix | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-civix-ad3ac695.md) |
| convert-charsets | Precommit Ci Quality | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-convert-charsets-34db0996.md) |
