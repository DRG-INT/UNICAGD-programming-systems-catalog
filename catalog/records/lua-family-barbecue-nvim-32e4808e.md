...
<!-- canonical: https://luarocks.org/modules/neorocks/barbecue.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/barbecue.nvim](https://luarocks.org/modules/neorocks/barbecue.nvim) |
| Source record ids | luarocks_root_manifest-db937c829c9949 |
...
For a systems engineer, barbecue.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-db937c829c9949` from `luarocks_root_manifest` as `registry_expansion`
