...
<!-- canonical: https://cran.r-project.org/web/packages/graphvec/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/graphvec/index.html](https://cran.r-project.org/web/packages/graphvec/index.html) |
| Source record ids | cran_packages_by_date-d9646790eaadf3 |
...
For a systems engineer, graphvec belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 12:40:02 UTC | [https://cran.r-project.org/web/packages/graphvec/DESCRIPTION](https://cran.r-project.org/web/packages/graphvec/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/graphvec/DESCRIPTION` at `2026-09-03T14:21:26+00:00`.
...
- `cran_packages_by_date-d9646790eaadf3` from `cran_packages_by_date` as `registry_expansion`
