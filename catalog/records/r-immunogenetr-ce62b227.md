...
<!-- canonical: https://cran.r-project.org/web/packages/immunogenetr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/immunogenetr/index.html](https://cran.r-project.org/web/packages/immunogenetr/index.html) |
| Source record ids | cran_packages_by_date-a69fe6a343b45f |
...
For a systems engineer, immunogenetr belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-08-19 22:10:08 UTC | [https://cran.r-project.org/web/packages/immunogenetr/DESCRIPTION](https://cran.r-project.org/web/packages/immunogenetr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/immunogenetr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a69fe6a343b45f` from `cran_packages_by_date` as `registry_expansion`
