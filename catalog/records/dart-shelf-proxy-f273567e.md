...
<!-- canonical: https://pub.dev/packages/shelf_proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shelf_proxy](https://pub.dev/packages/shelf_proxy) |
| Source record ids | pub_dev-1ed1861259c209 |
...
For a systems engineer, shelf_proxy belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5 | 2026-04-23T18:46:50.188508Z | [https://pub.dev/api/packages/shelf_proxy](https://pub.dev/api/packages/shelf_proxy) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shelf_proxy` at `2026-09-01T16:41:07+00:00`.
...
- `pub_dev-1ed1861259c209` from `pub_dev` as `registry_expansion`
