...
<!-- canonical: https://github.com/MindorksOpenSource/iOS-Viper-Architecture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MindorksOpenSource/iOS-Viper-Architecture](https://github.com/MindorksOpenSource/iOS-Viper-Architecture) |
| Source record ids | awesome_list-8a764c4c7a08eb |

## System Engineer Summary

This repository contains a detailed sample app that implements VIPER architecture in iOS using
libraries and frameworks like Alamofire, AlamofireImage, PKHUD, CoreData etc.

## Operational Role

For a systems engineer, iOS-Viper-Architecture belongs in the Cocoa inventory as part of ecosystem
...
- `awesome_list-8a764c4c7a08eb` from `awesome_list` as `registry_expansion`
