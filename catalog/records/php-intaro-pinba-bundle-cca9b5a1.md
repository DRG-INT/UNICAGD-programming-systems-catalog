...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/intaro/pinba-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/intaro/pinba-bundle](https://packagist.org/packages/intaro/pinba-bundle) |
| Source record ids | packagist_search-945f382717a725 |

## System Engineer Summary

Collects and sends execution time of Doctrine queries, Twig renders and Redis requests as pinba
timers to pinba server

## Operational Role

For a systems engineer, intaro/pinba-bundle belongs in the PHP inventory as part of request routing,
...
| Evidence | LGPL-3; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `packagist_search-945f382717a725` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| launchdarkly/server-sdk-redis-predis | Web Framework | [open](php-launchdarkly-server-sdk-redis-predis-de02cbe8.md) |
| symfony-cmf/routing | Web Framework | [open](php-symfony-cmf-routing-ab21d7c4.md) |
| tpetry/laravel-query-expressions | Web Framework | [open](php-tpetry-laravel-query-expressions-63bdd853.md) |
| zaber-dev/laravel-quota | Web Framework | [open](php-zaber-dev-laravel-quota-5a5e9635.md) |
