...
<!-- canonical: https://luarocks.org/modules/refreezed/dumbluaparser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/refreezed/dumbluaparser](https://luarocks.org/modules/refreezed/dumbluaparser) |
| Source record ids | luarocks_root_manifest-8a9848db3c625c |
...
For a systems engineer, DumbLuaParser belongs in the Lua family inventory as part of language
...
- `luarocks_root_manifest-8a9848db3c625c` from `luarocks_root_manifest` as `registry_expansion`
