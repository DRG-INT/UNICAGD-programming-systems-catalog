...
| Canonical URL | [https://luarocks.org/modules/huakim/get_os_name](https://luarocks.org/modules/huakim/get_os_name) |
| Source record ids | luarocks_root_manifest-5cd26814b90afc |
...
For a systems engineer, get_os_name belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5cd26814b90afc` from `luarocks_root_manifest` as `registry_expansion`
