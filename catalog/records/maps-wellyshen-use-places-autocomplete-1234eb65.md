...
<!-- canonical: https://github.com/wellyshen/use-places-autocomplete -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wellyshen/use-places-autocomplete](https://github.com/wellyshen/use-places-autocomplete) |
| Source record ids | github_search_maps-af180a62f5af56 |
...
For a systems engineer, wellyshen/use-places-autocomplete belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.0.1 | 2023-08-12T16:33:30Z | [https://api.github.com/repos/wellyshen/use-places-autocomplete/releases/latest](https://api.github.com/repos/wellyshen/use-places-autocomplete/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wellyshen/use-places-autocomplete/releases/latest` at `2026-09-01T12:30:06+00:00`.
...
- `github_search_maps-af180a62f5af56` from `github_search_maps` as `registry_expansion`
