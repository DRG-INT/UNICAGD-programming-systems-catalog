...
<!-- canonical: https://crates.io/crates/actix-rt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-rt](https://crates.io/crates/actix-rt) |
| Source record ids | crates_io-c9cc67d1e1e8b1 |
...
For a systems engineer, actix-rt belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.15.0 | 2026-09-13T10:24:44.125095Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads` at `2026-09-13T11:17:54+00:00`.
...
- `crates_io-c9cc67d1e1e8b1` from `crates_io` as `registry_expansion`
