...
<!-- canonical: https://crates.io/crates/block-buffer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/block-buffer](https://crates.io/crates/block-buffer) |
| Source record ids | crates_io-f1a6fc91ff5a9c |
...
For a systems engineer, block-buffer belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.1 | 2026-06-11T15:40:05.682576Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-f1a6fc91ff5a9c` from `crates_io` as `registry_expansion`
