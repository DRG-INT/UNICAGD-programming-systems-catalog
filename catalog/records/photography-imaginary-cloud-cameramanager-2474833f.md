...
<!-- canonical: https://github.com/imaginary-cloud/CameraManager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/imaginary-cloud/CameraManager](https://github.com/imaginary-cloud/CameraManager) |
| Source record ids | github_search_photography-c293d4d78ca90c |

## System Engineer Summary

Simple Swift class to provide all the configurations you need to create custom camera view in your
app

## Operational Role

For a systems engineer, imaginary-cloud/CameraManager belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-19T13:58:45Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c293d4d78ca90c` from `github_search_photography` as `registry_expansion`
