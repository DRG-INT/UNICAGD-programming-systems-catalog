...
<!-- canonical: https://cran.r-project.org/web/packages/biofetchR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/biofetchR/index.html](https://cran.r-project.org/web/packages/biofetchR/index.html) |
| Source record ids | cran_packages_by_date-33b8b52e9c4ddf |
...
For a systems engineer, biofetchR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-19 19:50:02 UTC | [https://cran.r-project.org/web/packages/biofetchR/DESCRIPTION](https://cran.r-project.org/web/packages/biofetchR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/biofetchR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-33b8b52e9c4ddf` from `cran_packages_by_date` as `registry_expansion`
