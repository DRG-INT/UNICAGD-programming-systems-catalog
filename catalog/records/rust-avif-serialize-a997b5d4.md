...
| Canonical URL | [https://crates.io/crates/avif-serialize](https://crates.io/crates/avif-serialize) |
| Source record ids | crates_io-6e932fb87d9b6f |
...
For a systems engineer, avif-serialize belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.9 | 2026-05-07T10:14:04.400169Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
| bytes-varint | Serialization | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bytes-varint-b50454e9.md) |
