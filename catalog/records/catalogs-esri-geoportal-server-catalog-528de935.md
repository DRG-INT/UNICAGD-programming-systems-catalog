...
<!-- canonical: https://github.com/Esri/geoportal-server-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Esri/geoportal-server-catalog](https://github.com/Esri/geoportal-server-catalog) |
| Source record ids | github_search_catalogs-c96634cbeaf498 |

## System Engineer Summary

Esri Geoportal Server is an open-source metadata catalog and editor

## Operational Role

For a systems engineer, Esri/geoportal-server-catalog belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:53:13Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c96634cbeaf498` from `github_search_catalogs` as `registry_expansion`
...
| fnplus/community-project-ideas | Ide Editor Integration | [open](catalogs-fnplus-community-project-ideas-1f98ace0.md) |
