...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wesdoyle/design-patterns-explained-with-food -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wesdoyle/design-patterns-explained-with-food](https://github.com/wesdoyle/design-patterns-explained-with-food) |
| Source record ids | github_search_pattern_language-2f3b2cdd506504 |

## System Engineer Summary

GoF Design Patterns with "Real-World" examples involving Food-Related Businesses and mock
dependencies

## Operational Role

For a systems engineer, wesdoyle/design-patterns-explained-with-food belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-21T16:43:48Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-2f3b2cdd506504` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kawser2133/clean-structured-project | Dependency Manager | [open](pattern-language-kawser2133-clean-structured-project-b271a1e4.md) |
