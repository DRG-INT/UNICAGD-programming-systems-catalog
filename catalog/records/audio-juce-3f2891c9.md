...
| Source record ids | curated_language_routes-2c44b1b300e9e3 |

## System Engineer Summary

C++ framework for audio applications, plug-ins, DSP effects, instruments, and cross-platform media
tools.

## Operational Role

For a systems engineer, JUCE belongs in the Audio inventory as part of ecosystem capability mapping,
...
- `curated_language_routes-2c44b1b300e9e3` from `curated_language_routes` as `registry_expansion`
...
| PipeWire | Image Audio Dsp | [open](audio-pipewire-00d8ecfd.md) |
