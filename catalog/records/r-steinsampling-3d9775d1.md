...
| Canonical URL | [https://cran.r-project.org/web/packages/steinsampling/index.html](https://cran.r-project.org/web/packages/steinsampling/index.html) |
| Source record ids | cran_packages_by_date-afe4a3bf52ce38 |
...
For a systems engineer, steinsampling belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-28 11:10:02 UTC | [https://cran.r-project.org/web/packages/steinsampling/DESCRIPTION](https://cran.r-project.org/web/packages/steinsampling/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/steinsampling/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-afe4a3bf52ce38` from `cran_packages_by_date` as `registry_expansion`
...
| DiscreteTests | Testing Framework | [open](r-discretetests-c4aa034b.md) |
| DPComb | Testing Framework | [open](r-dpcomb-ea26f266.md) |
| ebrahim.gof | Testing Framework | [open](r-ebrahim-gof-516fb9cc.md) |
| fqardl | Testing Framework | [open](r-fqardl-69afa232.md) |
