...
<!-- canonical: https://github.com/yattee/yattee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yattee/yattee](https://github.com/yattee/yattee) |
| Source record ids | github_search_swift-b0f373d85e8dae |
...
For a systems engineer, yattee/yattee belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T11:05:24Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-b0f373d85e8dae` from `github_search_swift` as `registry_expansion`
