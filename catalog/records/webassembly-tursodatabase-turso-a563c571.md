...
| Canonical URL | [https://github.com/tursodatabase/turso](https://github.com/tursodatabase/turso) |
| Source record ids | github_search_webassembly-90d3ddd509d9b6 |

## System Engineer Summary

A SQL database in Rust: SQLite-compatible, now also speaking Postgres (experimental). The LLVM of
databases.

## Operational Role

For a systems engineer, tursodatabase/turso belongs in the WebAssembly inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.7.2 | 2026-07-30T13:56:13Z | [https://api.github.com/repos/tursodatabase/turso/releases/latest](https://api.github.com/repos/tursodatabase/turso/releases/latest) |  |
| preview | known | v0.8.0-pre.7 | 2026-08-21T06:09:18Z | [https://api.github.com/repos/tursodatabase/turso/releases?per_page=10](https://api.github.com/repos/tursodatabase/turso/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tursodatabase/turso/releases/latest` at `2026-09-01T10:26:01+00:00`.
...
- `github_search_webassembly-90d3ddd509d9b6` from `github_search_webassembly` as `registry_expansion`
