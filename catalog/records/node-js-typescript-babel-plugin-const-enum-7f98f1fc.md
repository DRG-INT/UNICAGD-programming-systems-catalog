...
<!-- canonical: https://www.npmjs.com/package/babel-plugin-const-enum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/babel-plugin-const-enum](https://www.npmjs.com/package/babel-plugin-const-enum) |
| Source record ids | npm_registry-a73688577bdca3 |
...
For a systems engineer, babel-plugin-const-enum belongs in the Node.js/TypeScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2021-11-06T16:27:57.589Z | [https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a73688577bdca3` from `npm_registry` as `registry_expansion`
