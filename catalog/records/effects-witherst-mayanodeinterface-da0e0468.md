...
<!-- canonical: https://github.com/witherst/MayaNodeInterface -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/witherst/MayaNodeInterface](https://github.com/witherst/MayaNodeInterface) |
| Source record ids | github_search_effects-ac827a221b0bcf |

## System Engineer Summary

I designed this Node-based interface as a way of learning Python and PyQt. It has been developed
with Maya 2011 and only (as of now) works with Maya 2011. It's only meant to work with setting up
particle systems. Some node functions aren't complete, but for the most part all of them are done.

## Operational Role

For a systems engineer, witherst/MayaNodeInterface belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-08-27T16:34:34Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ac827a221b0bcf` from `github_search_effects` as `registry_expansion`
