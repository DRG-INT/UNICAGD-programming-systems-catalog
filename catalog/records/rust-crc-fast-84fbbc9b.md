...
| Canonical URL | [https://crates.io/crates/crc-fast](https://crates.io/crates/crc-fast) |
| Source record ids | crates_io-65784430e7df7c |

## System Engineer Summary

World's fastest generic CRC16, CRC32, and CRC64 calculator using SIMD. Supplies a C-compatible
shared library for use in other languages.

## Operational Role

For a systems engineer, crc-fast belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2025-12-31T19:34:28.092669Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-65784430e7df7c` from `crates_io` as `registry_expansion`
