...
<!-- canonical: https://gitlab.com/xavki/tutorials-postgresql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/xavki/tutorials-postgresql](https://gitlab.com/xavki/tutorials-postgresql) |
| Source record ids | gitlab_projects_api-6b6baba0246bef |

## System Engineer Summary

PostgreSQL deep dive: install, databases, tables, indexes (B-tree, hash), views, roles, permissions,
logs, dumps. Xavki tutorials in French —

## Operational Role

For a systems engineer, xavki/tutorials-postgresql belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-6b6baba0246bef` from `gitlab_projects_api` as `registry_expansion`
