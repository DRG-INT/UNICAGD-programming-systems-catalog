...
<!-- canonical: https://crates.io/crates/x25519-dalek -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/x25519-dalek](https://crates.io/crates/x25519-dalek) |
| Source record ids | crates_io-a999febd23f82e |
...
For a systems engineer, x25519-dalek belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-07-06T16:23:00.505143Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a999febd23f82e` from `crates_io` as `registry_expansion`
