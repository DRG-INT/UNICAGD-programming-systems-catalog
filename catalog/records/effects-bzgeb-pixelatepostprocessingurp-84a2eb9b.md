# bzgeb/PixelatePostProcessingURP
...
<!-- canonical: https://github.com/bzgeb/PixelatePostProcessingURP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bzgeb/PixelatePostProcessingURP](https://github.com/bzgeb/PixelatePostProcessingURP) |
| Source record ids | github_search_effects-6297ec193aa8cb |
...
For a systems engineer, bzgeb/PixelatePostProcessingURP belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-25T00:02:40Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6297ec193aa8cb` from `github_search_effects` as `registry_expansion`
