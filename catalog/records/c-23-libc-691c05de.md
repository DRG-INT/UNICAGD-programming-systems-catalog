...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Standard Library](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/standard-library.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | standard_library |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-02f1da476755 |
...
For a systems engineer, libc++ belongs in the C++23 inventory as part of ecosystem capability
...
- `master-02f1da476755` from `master_json` as `standard_library`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| libstdc++ | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-libstdc-cefb5646.md) |
| MSVC STL | Standard Library | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-msvc-stl-3fbed3b5.md) |
