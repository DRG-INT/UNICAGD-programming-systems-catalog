...
<!-- canonical: https://packagist.org/packages/orchestra/workbench -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/orchestra/workbench](https://packagist.org/packages/orchestra/workbench) |
| Source record ids | packagist_search-7a314f315afa17 |
...
For a systems engineer, orchestra/workbench belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-7a314f315afa17` from `packagist_search` as `registry_expansion`
