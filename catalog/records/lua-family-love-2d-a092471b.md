...
| Canonical URL | [http://love2d.org/](http://love2d.org/) |
| Source record ids | lua-source-114 |
...
For a systems engineer, LÖVE 2D belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 114}}` |
...
- `lua-source-114` from `master_json` as `source_list_item`
