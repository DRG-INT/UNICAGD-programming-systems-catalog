...
<!-- canonical: https://github.com/rasbt/LLMs-from-scratch -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch) |
| Source record ids | github_search_aims-f6873d1e6b6110 |
...
For a systems engineer, rasbt/LLMs-from-scratch belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T20:36:18Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-f6873d1e6b6110` from `github_search_aims` as `registry_expansion`
