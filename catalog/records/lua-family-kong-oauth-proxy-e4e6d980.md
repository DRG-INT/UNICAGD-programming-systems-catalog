...
| Canonical URL | [https://luarocks.org/modules/curityio/kong-oauth-proxy](https://luarocks.org/modules/curityio/kong-oauth-proxy) |
| Source record ids | luarocks_root_manifest-49a9ffcbd1d4d3 |
...
For a systems engineer, kong-oauth-proxy belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-49a9ffcbd1d4d3` from `luarocks_root_manifest` as `registry_expansion`
