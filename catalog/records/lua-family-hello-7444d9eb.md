...
| Canonical URL | [https://luarocks.org/modules/glenn/hello](https://luarocks.org/modules/glenn/hello) |
| Source record ids | luarocks_root_manifest-daff1f1e3060de |

## System Engineer Summary

hello is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, hello belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-daff1f1e3060de` from `luarocks_root_manifest` as `registry_expansion`
