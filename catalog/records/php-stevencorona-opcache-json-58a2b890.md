...
<!-- canonical: https://packagist.org/packages/stevencorona/opcache-json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/stevencorona/opcache-json](https://packagist.org/packages/stevencorona/opcache-json) |
| Source record ids | packagist_search-d03e5079c2704f |

## System Engineer Summary

Library that grabs some critical stats from Zend Opcache and outputs to JSON for monitoring and
alerting. Can also output to statsd sink.

## Operational Role

For a systems engineer, stevencorona/opcache-json belongs in the PHP inventory as part of wire
...
- `packagist_search-d03e5079c2704f` from `packagist_search` as `registry_expansion`
