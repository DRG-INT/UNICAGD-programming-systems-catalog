...
<!-- canonical: https://cran.r-project.org/web/packages/fastFGEE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastFGEE/index.html](https://cran.r-project.org/web/packages/fastFGEE/index.html) |
| Source record ids | cran_packages_by_date-a7b77cd9478f34 |
...
For a systems engineer, fastFGEE belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 11:00:23 UTC | [https://cran.r-project.org/web/packages/fastFGEE/DESCRIPTION](https://cran.r-project.org/web/packages/fastFGEE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastFGEE/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-a7b77cd9478f34` from `cran_packages_by_date` as `registry_expansion`
