...
| Canonical URL | [https://github.com/apple/foundationdb](https://github.com/apple/foundationdb) |
| Source record ids | curated_database_systems-e8c0d00ebe6f3f |

## System Engineer Summary

Distributed transactional key-value store with layered data models.

## Operational Role

For a systems engineer, FoundationDB belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.3.77 | 2026-04-16T19:24:36Z | [https://api.github.com/repos/apple/foundationdb/releases/latest](https://api.github.com/repos/apple/foundationdb/releases/latest) |  |
| preview | known | 7.3.79 | 2026-07-15T20:13:35Z | [https://api.github.com/repos/apple/foundationdb/releases?per_page=10](https://api.github.com/repos/apple/foundationdb/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/apple/foundationdb/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-e8c0d00ebe6f3f` from `curated_database_systems` as `registry_expansion`
