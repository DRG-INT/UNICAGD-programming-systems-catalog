...
<!-- canonical: https://gnu-octave.github.io/packages/pkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/pkg](https://gnu-octave.github.io/packages/pkg) |
| Source record ids | octave_packages_index-36317c9f0df14b |

## System Engineer Summary

The GNU Octave package management tool `pkg` is already installed with GNU Octave itself. This
package is a proof of conecpt and NOT REQUIRED to work with Octave packages.

## Operational Role

For a systems engineer, pkg belongs in the Octave inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | dev |  | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) | release_date_missing |
...
- `octave_packages_index-36317c9f0df14b` from `octave_packages_index` as `registry_expansion`
