...
<!-- canonical: https://luarocks.org/modules/clpi/down.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/clpi/down.nvim](https://luarocks.org/modules/clpi/down.nvim) |
| Source record ids | luarocks_root_manifest-622adfc85aca65 |
...
For a systems engineer, down.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-622adfc85aca65` from `luarocks_root_manifest` as `registry_expansion`
