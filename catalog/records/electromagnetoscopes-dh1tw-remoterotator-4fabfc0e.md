...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dh1tw/remoteRotator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dh1tw/remoteRotator](https://github.com/dh1tw/remoteRotator) |
| Source record ids | github_search_electromagnetoscopes-edf4da670762bf |
...
For a systems engineer, dh1tw/remoteRotator belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:18:03Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-14 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:antenna stars:>10", "retrieved": "2026-09-14", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-edf4da670762bf` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AsmSafone/RadioPlayerV3 | Networking Http | [open](electromagnetoscopes-asmsafone-radioplayerv3-cb668f6d.md) |
| cpainchaud/RFLink32 | Networking Http | [open](electromagnetoscopes-cpainchaud-rflink32-443611fd.md) |
| hudsonvalleydigitalnetwork/hasviolet | Networking Http | [open](electromagnetoscopes-hudsonvalleydigitalnetwork-hasviolet-ce5bb324.md) |
| liamcottle/reticulum-meshchat | Networking Http | [open](electromagnetoscopes-liamcottle-reticulum-meshchat-06a9395e.md) |
| meshcore-dev/meshcore-ha | Networking Http | [open](electromagnetoscopes-meshcore-dev-meshcore-ha-99d8a718.md) |
| niyeradori/QuickSmith-Web | Networking Http | [open](electromagnetoscopes-niyeradori-quicksmith-web-d875bce9.md) |
| osmocom/gr-osmosdr | Networking Http | [open](electromagnetoscopes-osmocom-gr-osmosdr-e519982e.md) |
| osmocom/rtl-sdr | Networking Http | [open](electromagnetoscopes-osmocom-rtl-sdr-3b21ada6.md) |
