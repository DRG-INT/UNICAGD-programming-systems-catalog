...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Sanitizer](../by-category/sanitizer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/asantee/ethanon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/asantee/ethanon](https://github.com/asantee/ethanon) |
| Source record ids | github_search_effects-4e919b8a69f111 |

## System Engineer Summary

Free 2D game development tool focused on the recent video cards for hardware acceleration and shader
effects. It may be used to develop any style of game, such as top-down view RPG's, side scrollers
and shoot'em up games. The main goal of this engine is to provide high-quality lighting, shadow and
particle effects with an easy to use visual interface and a simple and direct scripting system.

## Operational Role

For a systems engineer, asantee/ethanon belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:24:42Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-4e919b8a69f111` from `github_search_effects` as `registry_expansion`
