...
<!-- canonical: https://hackage.haskell.org/package/parconc-examples -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/parconc-examples](https://hackage.haskell.org/package/parconc-examples) |
| Source record ids | hackage_top_downloads-178f93f6f29455 |
...
For a systems engineer, parconc-examples belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.8 | 2021-04-02T11:31:32Z | [https://hackage.haskell.org/package/parconc-examples](https://hackage.haskell.org/package/parconc-examples) |  |
| candidate | partial | 0.4.7 |  | [https://hackage.haskell.org/package/parconc-examples](https://hackage.haskell.org/package/parconc-examples) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/parconc-examples` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-178f93f6f29455` from `hackage_top_downloads` as `registry_expansion`
