...
<!-- canonical: https://github.com/jakubvalenta/geoshare -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jakubvalenta/geoshare](https://github.com/jakubvalenta/geoshare) |
| Source record ids | github_search_maps-009adb2bab55d6 |
...
For a systems engineer, jakubvalenta/geoshare belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T18:25:31Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-009adb2bab55d6` from `github_search_maps` as `registry_expansion`
