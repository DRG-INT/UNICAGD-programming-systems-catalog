...
<!-- canonical: https://cran.r-project.org/web/packages/admiralneuro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/admiralneuro/index.html](https://cran.r-project.org/web/packages/admiralneuro/index.html) |
| Source record ids | cran_packages_by_date-05c3fce3a11311 |
...
For a systems engineer, admiralneuro belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-20 22:52:08 UTC | [https://cran.r-project.org/web/packages/admiralneuro/DESCRIPTION](https://cran.r-project.org/web/packages/admiralneuro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/admiralneuro/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-05c3fce3a11311` from `cran_packages_by_date` as `registry_expansion`
