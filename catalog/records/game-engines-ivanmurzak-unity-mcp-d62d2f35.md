...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/IvanMurzak/Unity-MCP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) |
| Source record ids | github_search_game_engines-e1356155f26424 |

## System Engineer Summary

AI Skills, MCP Tools, and CLI for Unity Engine. Full AI develop and test loop. Use cli for quick
setup. Efficient token usage, advanced tools. Any C# method may be turned into a tool by a single
line. Works with Claude Code, Gemini, Copilot, Cursor and any other absolutely for free.

## Operational Role

For a systems engineer, IvanMurzak/Unity-MCP belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T11:07:32Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-e1356155f26424` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| luanti-org/luanti | Testing Framework | [open](game-engines-luanti-org-luanti-3688bb03.md) |
