...
<!-- canonical: https://luarocks.org/modules/alekm/caas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/alekm/caas](https://luarocks.org/modules/alekm/caas) |
| Source record ids | luarocks_root_manifest-c1d0448a7ed3dc |
...
For a systems engineer, caas belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-c1d0448a7ed3dc` from `luarocks_root_manifest` as `registry_expansion`
