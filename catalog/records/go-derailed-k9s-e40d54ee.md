...
<!-- canonical: https://github.com/derailed/k9s -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/derailed/k9s](https://github.com/derailed/k9s) |
| Source record ids | github_search_go-92f1787c607afb |
...
For a systems engineer, derailed/k9s belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T09:47:02Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-92f1787c607afb` from `github_search_go` as `registry_expansion`
