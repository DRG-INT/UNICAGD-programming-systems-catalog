...
<!-- canonical: https://github.com/jogendra/LoadingShimmer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jogendra/LoadingShimmer](https://github.com/jogendra/LoadingShimmer) |
| Source record ids | github_search_cocoa-bd4e493acd5098 |

## System Engineer Summary

An easy way to add a shimmering effect to any view with just one line of code. It is useful as an
unobtrusive loading indicator.

## Operational Role

For a systems engineer, jogendra/LoadingShimmer belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-22T13:31:11Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-bd4e493acd5098` from `github_search_cocoa` as `registry_expansion`
