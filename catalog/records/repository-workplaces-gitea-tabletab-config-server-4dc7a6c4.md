...
<!-- canonical: https://gitea.com/TableTab/config-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/TableTab/config-server](https://gitea.com/TableTab/config-server) |
| Source record ids | gitea_repositories_api-214672a1e76cf3 |
...
For a systems engineer, Gitea: TableTab/config-server belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-15T03:42:12Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-214672a1e76cf3` from `gitea_repositories_api` as `registry_expansion`
