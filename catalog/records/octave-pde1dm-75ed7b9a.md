...
<!-- canonical: https://gnu-octave.github.io/packages/pde1dm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/pde1dm](https://gnu-octave.github.io/packages/pde1dm) |
| Source record ids | octave_packages_index-a214262fa60256 |

## System Engineer Summary

Solve systems of partial differential equations (PDE) in a single spatial variable and time. The
input is mostly compatible with the MATLAB function pdepe. Many pdepe examples will work with pde1dm
with only small changes.

## Operational Role

For a systems engineer, pde1dm belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2022-05-02 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-a214262fa60256` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| biosig | Filesystem Os | [open](octave-biosig-cd6b4a39.md) |
