...
<!-- canonical: https://hackage.haskell.org/package/monoid-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/monoid-extras](https://hackage.haskell.org/package/monoid-extras) |
| Source record ids | hackage_top_downloads-88024c0cfcdccd |
...
For a systems engineer, monoid-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.2 | 2026-04-17T21:51:44Z | [https://hackage.haskell.org/package/monoid-extras](https://hackage.haskell.org/package/monoid-extras) |  |
| candidate | partial | 0.3.3.3 |  | [https://hackage.haskell.org/package/monoid-extras](https://hackage.haskell.org/package/monoid-extras) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/monoid-extras` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-88024c0cfcdccd` from `hackage_top_downloads` as `registry_expansion`
