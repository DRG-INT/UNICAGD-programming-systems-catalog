...
[Catalog index](../index.md) · [Language: Doctrines](../by-language/doctrines.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://www.iso.org/standard/74393.html](https://www.iso.org/standard/74393.html) |
| Source record ids | curated_language_routes-26a9211916774c |

## System Engineer Summary

Architecture description standard for systems and software engineering views, viewpoints,
stakeholders, and concerns.

## Operational Role

For a systems engineer, ISO/IEC/IEEE 42010 belongs in the Doctrines inventory as part of operator
onboarding, API understanding, and upgrade review.
...
- `curated_language_routes-26a9211916774c` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AWS Well-Architected Framework | Documentation | [open](doctrines-aws-well-architected-framework-35a6c9de.md) |
| Azure Well-Architected Framework | Documentation | [open](doctrines-azure-well-architected-framework-4bd3542f.md) |
| Google Cloud Architecture Framework | Documentation | [open](doctrines-google-cloud-architecture-framework-4d55fb0b.md) |
