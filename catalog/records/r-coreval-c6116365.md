...
<!-- canonical: https://cran.r-project.org/web/packages/coreval/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/coreval/index.html](https://cran.r-project.org/web/packages/coreval/index.html) |
| Source record ids | cran_packages_by_date-01df441a5efbeb |

## System Engineer Summary

Check Clinical Trial Data Against 'CDISC' Open Rules

## Operational Role

For a systems engineer, coreval belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 12:30:08 UTC | [https://cran.r-project.org/web/packages/coreval/DESCRIPTION](https://cran.r-project.org/web/packages/coreval/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/coreval/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-01df441a5efbeb` from `cran_packages_by_date` as `registry_expansion`
