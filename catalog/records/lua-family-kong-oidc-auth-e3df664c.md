...
| Canonical URL | [https://luarocks.org/modules/optum-ross/kong-oidc-auth](https://luarocks.org/modules/optum-ross/kong-oidc-auth) |
| Source record ids | luarocks_root_manifest-542e18228dc540 |
...
For a systems engineer, kong-oidc-auth belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-542e18228dc540` from `luarocks_root_manifest` as `registry_expansion`
