...
<!-- canonical: https://github.com/joryleech/Godot-Ascii-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joryleech/Godot-Ascii-Shader](https://github.com/joryleech/Godot-Ascii-Shader) |
| Source record ids | github_search_effects-6f6d03549218b8 |

## System Engineer Summary

A shader graph based post processing shader for godot 4 that converts the screen space into ascii.

## Operational Role

For a systems engineer, joryleech/Godot-Ascii-Shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-27T00:47:55Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-6f6d03549218b8` from `github_search_effects` as `registry_expansion`
