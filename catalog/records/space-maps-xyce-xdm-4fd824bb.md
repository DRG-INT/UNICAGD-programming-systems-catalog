...
<!-- canonical: https://github.com/Xyce/XDM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Xyce/XDM](https://github.com/Xyce/XDM) |
| Source record ids | github_search_space_maps-ea9ec30848ffc3 |
...
For a systems engineer, Xyce/XDM belongs in the Space Maps inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-15T05:27:51Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ea9ec30848ffc3` from `github_search_space_maps` as `registry_expansion`
...
| D-plus/Star-Wars | Formatter | [open](space-maps-d-plus-star-wars-84016317.md) |
| dcf21/star-charter | Formatter | [open](space-maps-dcf21-star-charter-7d97d4d4.md) |
| MoTahaAboHeiba/E-Commerce-Lakehouse-Using-Databricks | Formatter | [open](space-maps-motahaaboheiba-e-commerce-lakehouse-using-databricks-dd224fa3.md) |
| nunobrum/PyLTSpice | Formatter | [open](space-maps-nunobrum-pyltspice-f892529e.md) |
