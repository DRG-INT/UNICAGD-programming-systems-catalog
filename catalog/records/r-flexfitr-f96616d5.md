...
<!-- canonical: https://cran.r-project.org/web/packages/flexFitR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flexFitR/index.html](https://cran.r-project.org/web/packages/flexFitR/index.html) |
| Source record ids | cran_packages_by_date-f9ca5cb5313d42 |
...
For a systems engineer, flexFitR belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.4 | 2026-08-21 19:20:02 UTC | [https://cran.r-project.org/web/packages/flexFitR/DESCRIPTION](https://cran.r-project.org/web/packages/flexFitR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flexFitR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f9ca5cb5313d42` from `cran_packages_by_date` as `registry_expansion`
