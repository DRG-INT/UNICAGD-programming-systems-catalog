...
<!-- canonical: https://github.com/FLEXTool/FLEX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FLEXTool/FLEX](https://github.com/FLEXTool/FLEX) |
| Source record ids | github_search_cocoa-9e5548f7489507 |
...
For a systems engineer, FLEXTool/FLEX belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-11T20:34:01Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-9e5548f7489507` from `github_search_cocoa` as `registry_expansion`
