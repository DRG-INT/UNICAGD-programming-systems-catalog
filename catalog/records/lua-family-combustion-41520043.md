...
<!-- canonical: https://luarocks.org/modules/frityet/combustion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/frityet/combustion](https://luarocks.org/modules/frityet/combustion) |
| Source record ids | luarocks_root_manifest-16d1b1dc57abea |
...
For a systems engineer, combustion belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-16d1b1dc57abea` from `luarocks_root_manifest` as `registry_expansion`
