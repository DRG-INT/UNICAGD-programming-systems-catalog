...
<!-- canonical: https://crates.io/crates/yoke -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/yoke](https://crates.io/crates/yoke) |
| Source record ids | crates_io-9144cd65556b37 |
...
For a systems engineer, yoke belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2026-06-03T20:59:17.678438Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-9144cd65556b37` from `crates_io` as `registry_expansion`
