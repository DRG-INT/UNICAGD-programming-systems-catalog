...
<!-- canonical: https://hackage.haskell.org/package/socket -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/socket](https://hackage.haskell.org/package/socket) |
| Source record ids | hackage_top_downloads-d9d9f8fbdb8d9e |
...
For a systems engineer, socket belongs in the Haskell inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3.0 | 2020-06-29T07:18:38Z | [https://hackage.haskell.org/package/socket](https://hackage.haskell.org/package/socket) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/socket` at `2026-09-06T00:34:57+00:00`.
...
- `hackage_top_downloads-d9d9f8fbdb8d9e` from `hackage_top_downloads` as `registry_expansion`
