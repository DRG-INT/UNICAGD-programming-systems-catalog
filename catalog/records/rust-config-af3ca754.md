...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/config -->
<!-- crawl-delay: 10 -->
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `crates_io-a5cb3b5fbe9e4e` from `crates_io` as `registry_expansion`
...
| datafusion-execution | Configuration | [open](rust-datafusion-execution-0db0e857.md) |
