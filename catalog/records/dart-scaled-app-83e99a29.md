...
<!-- canonical: https://pub.dev/packages/scaled_app -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/scaled_app](https://pub.dev/packages/scaled_app) |
| Source record ids | pub_dev-29f05dd3503978 |
...
For a systems engineer, scaled_app belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2026-08-18T15:26:31.052429Z | [https://pub.dev/api/packages/scaled_app](https://pub.dev/api/packages/scaled_app) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/scaled_app` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-29f05dd3503978` from `pub_dev` as `registry_expansion`
