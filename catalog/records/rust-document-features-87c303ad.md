...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Package Manager](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/package-manager.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/document-features](https://crates.io/crates/document-features) |
| Source record ids | crates_io-1140f028819130 |
...
For a systems engineer, document-features belongs in the Rust inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.12 | 2025-10-24T09:43:31.356480Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| Cargo | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-3cea6d5b.md) |
| cargo-lock | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-lock-a883070b.md) |
| cargo-platform | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-platform-63e0b745.md) |
| cargo-util-schemas | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-util-schemas-52eca356.md) |
| cargo_metadata | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-metadata-08b46fd4.md) |
| cargo_toml | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cargo-toml-c9d5ba6f.md) |
| embed-resource | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-embed-resource-394d9ab2.md) |
| find-msvc-tools | Package Manager | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-find-msvc-tools-14b1752c.md) |
