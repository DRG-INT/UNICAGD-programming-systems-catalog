...
<!-- canonical: https://cran.r-project.org/web/packages/transferegovr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/transferegovr/index.html](https://cran.r-project.org/web/packages/transferegovr/index.html) |
| Source record ids | cran_packages_by_date-bd326fd3c70a4f |

## System Engineer Summary

Access the 'TransfereGov' Open Data APIs

## Operational Role

For a systems engineer, transferegovr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 11:30:08 UTC | [https://cran.r-project.org/web/packages/transferegovr/DESCRIPTION](https://cran.r-project.org/web/packages/transferegovr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/transferegovr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-bd326fd3c70a4f` from `cran_packages_by_date` as `registry_expansion`
