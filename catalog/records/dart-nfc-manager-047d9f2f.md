...
<!-- canonical: https://pub.dev/packages/nfc_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/nfc_manager](https://pub.dev/packages/nfc_manager) |
| Source record ids | pub_dev-9b85da375f525d |
...
For a systems engineer, nfc_manager belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.1 | 2026-04-03T10:32:12.636338Z | [https://pub.dev/api/packages/nfc_manager](https://pub.dev/api/packages/nfc_manager) |  |
| preview | known | 4.0.0-dev | 2024-02-11T03:55:50.873503Z | [https://pub.dev/api/packages/nfc_manager](https://pub.dev/api/packages/nfc_manager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/nfc_manager` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-9b85da375f525d` from `pub_dev` as `registry_expansion`
