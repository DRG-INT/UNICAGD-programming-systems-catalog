...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/leereilly/games -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leereilly/games](https://github.com/leereilly/games) |
| Source record ids | github_search_game_engines-f171bc55d633ba |

## System Engineer Summary

Archived — A list of games, add-ons, maps, etc. hosted on GitHub. Any genre. Any platform. Any
engine.

## Operational Role

For a systems engineer, leereilly/games belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-13T20:06:46Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-f171bc55d633ba` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| agones-dev/agones | Undefined Behavior Analyzer | [open](game-engines-agones-dev-agones-16e87465.md) |
| aws/containers-roadmap | Undefined Behavior Analyzer | [open](game-engines-aws-containers-roadmap-04682765.md) |
| gosu/gosu | Undefined Behavior Analyzer | [open](game-engines-gosu-gosu-8a3383db.md) |
| ihhub/fheroes2 | Undefined Behavior Analyzer | [open](game-engines-ihhub-fheroes2-2169c061.md) |
| juicycleff/flutter-unity-view-widget | Undefined Behavior Analyzer | [open](game-engines-juicycleff-flutter-unity-view-widget-7a35823f.md) |
| weaveworks/scope | Undefined Behavior Analyzer | [open](game-engines-weaveworks-scope-237fa3ea.md) |
