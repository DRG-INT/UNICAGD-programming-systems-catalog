...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/peterbillam/commandlineui -->
<!-- crawl-delay: 10 -->
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
- `luarocks_root_manifest-120f6b1cd4f69b` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aka | Cli | [open](lua-family-aka-5e87e15b.md) |
| butter | Cli | [open](lua-family-butter-033c1de7.md) |
| caas | Cli | [open](lua-family-caas-6ba5b9ac.md) |
| chalk | Cli | [open](lua-family-chalk-fbf46ebe.md) |
| cli-app-base | Cli | [open](lua-family-cli-app-base-886dd90d.md) |
| Command-line Utilities | Cli | [open](lua-family-command-line-utilities-3a46a26b.md) |
| crescent | Cli | [open](lua-family-crescent-10098f6d.md) |
| cw | Cli | [open](lua-family-cw-357ac92c.md) |
