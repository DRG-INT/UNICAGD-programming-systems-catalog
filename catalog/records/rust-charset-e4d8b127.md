...
| Canonical URL | [https://crates.io/crates/charset](https://crates.io/crates/charset) |
| Source record ids | crates_io-d7b4e668ccd468 |
...
For a systems engineer, charset belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2024-07-21T14:04:50.814592Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-d7b4e668ccd468` from `crates_io` as `registry_expansion`
