...
<!-- canonical: https://github.com/soumyadip007/E-Medical-System-Web-Project-Using-Spring-Boot-Security-JPA-Rest-Thymeleaf-HQL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/soumyadip007/E-Medical-System-Web-Project-Using-Spring-Boot-Security-JPA-Rest-Thymeleaf-HQL](https://github.com/soumyadip007/E-Medical-System-Web-Project-Using-Spring-Boot-Security-JPA-Rest-Thymeleaf-HQL) |
| Source record ids | github_search_databases-c96582868e65dd |

## System Engineer Summary

Project on 👨🏻‍⚕️Bio-Medical & 🏥Hospital sector which is covering various fields🩺 of this 3
sector🚑.This project is using☕ Spring Framework, Hibernate, JPA, Rest, JSP also with 🖥️(Post-Dev
Data-Science, Big-data, ML etc. )🌡️ for Hackathon, CSI & SIH💊

## Operational Role

For a systems engineer, soumyadip007/E-Medical-System-Web-Project-Using-Spring-Boot-Security-JPA-
Rest-Thymeleaf-HQL belongs in the Databases inventory as part of supply-chain review, vulnerability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-08-27T07:27:07Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c96582868e65dd` from `github_search_databases` as `registry_expansion`
