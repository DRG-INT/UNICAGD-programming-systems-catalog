...
<!-- canonical: https://github.com/PGScatalog/pgsc_calc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PGScatalog/pgsc_calc](https://github.com/PGScatalog/pgsc_calc) |
| Source record ids | github_search_repertoare_catalogs-caba466858430d |
...
For a systems engineer, PGScatalog/pgsc_calc belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T11:48:46Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-caba466858430d` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| DanielHaggstrom/Genomics | Package Manager | [open](repertoare-catalogs-danielhaggstrom-genomics-9d0627e3.md) |
