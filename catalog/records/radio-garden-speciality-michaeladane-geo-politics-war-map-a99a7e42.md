# MichaelAdane/geo-politics-war-map-
...
<!-- canonical: https://github.com/MichaelAdane/geo-politics-war-map- -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MichaelAdane/geo-politics-war-map-](https://github.com/MichaelAdane/geo-politics-war-map-) |
| Source record ids | github_search_radio_garden_speciality-d2e4da91a9fb5a |

## System Engineer Summary

a geo map for war and also natural events that happing right like a new but not in a formal way like
a radio garden

## Operational Role

For a systems engineer, MichaelAdane/geo-politics-war-map- belongs in the Radio Garden Speciality
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-04T11:44:03Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-d2e4da91a9fb5a` from `github_search_radio_garden_speciality` as `registry_expansion`
