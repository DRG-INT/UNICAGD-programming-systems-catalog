...
<!-- canonical: https://cran.r-project.org/web/packages/StanHeaders/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/StanHeaders/index.html](https://cran.r-project.org/web/packages/StanHeaders/index.html) |
| Source record ids | cran_packages_by_date-0ce7060e6e2bb3 |
...
For a systems engineer, StanHeaders belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.39.1 | 2026-09-02 12:10:09 UTC | [https://cran.r-project.org/web/packages/StanHeaders/DESCRIPTION](https://cran.r-project.org/web/packages/StanHeaders/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/StanHeaders/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-0ce7060e6e2bb3` from `cran_packages_by_date` as `registry_expansion`
