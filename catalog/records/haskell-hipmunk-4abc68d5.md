...
<!-- canonical: https://hackage.haskell.org/package/Hipmunk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Hipmunk](https://hackage.haskell.org/package/Hipmunk) |
| Source record ids | hackage_top_downloads-9e3561e6809e6b |
...
For a systems engineer, Hipmunk belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.2.0.17 | 2015-07-23T15:01:58Z | [https://hackage.haskell.org/package/Hipmunk](https://hackage.haskell.org/package/Hipmunk) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Hipmunk` at `2026-09-01T14:24:20+00:00`.
...
- `hackage_top_downloads-9e3561e6809e6b` from `hackage_top_downloads` as `registry_expansion`
