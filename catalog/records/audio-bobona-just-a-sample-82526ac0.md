...
<!-- canonical: https://github.com/BOBONA/Just-a-Sample -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BOBONA/Just-a-Sample](https://github.com/BOBONA/Just-a-Sample) |
| Source record ids | github_search_audio-642ec85921a2ec |

## System Engineer Summary

Just a Sample is a modern, open-source audio sampler

## Operational Role

For a systems engineer, BOBONA/Just-a-Sample belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-17T18:41:25Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-642ec85921a2ec` from `github_search_audio` as `registry_expansion`
