...
| Canonical URL | [https://packagist.org/packages/creof/doctrine2-spatial](https://packagist.org/packages/creof/doctrine2-spatial) |
| Source record ids | packagist_search-7b69b994b6ff3c |
...
For a systems engineer, creof/doctrine2-spatial belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2017-10-20T15:57:18+00:00 | [https://repo.packagist.org/p2/creof/doctrine2-spatial.json](https://repo.packagist.org/p2/creof/doctrine2-spatial.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/creof/doctrine2-spatial.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-7b69b994b6ff3c` from `packagist_search` as `registry_expansion`
