...
<!-- canonical: https://cran.r-project.org/web/packages/gaussfacts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gaussfacts/index.html](https://cran.r-project.org/web/packages/gaussfacts/index.html) |
| Source record ids | cran_packages_by_date-9a739bb142fdf6 |
...
For a systems engineer, gaussfacts belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-09-01 14:00:10 UTC | [https://cran.r-project.org/web/packages/gaussfacts/DESCRIPTION](https://cran.r-project.org/web/packages/gaussfacts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gaussfacts/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9a739bb142fdf6` from `cran_packages_by_date` as `registry_expansion`
