...
[Catalog index](../index.md) · [Language: Braces](../by-language/braces.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://tc39.es/ecma262/ -->
<!-- crawl-delay: 10 -->
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| Name | Category | Page |
| --- | --- | --- |
| GNU Bash Brace Expansion | Language Specification | [open](braces-gnu-bash-brace-expansion-5ed23f97.md) |
| POSIX Shell Command Language | Language Specification | [open](braces-posix-shell-command-language-d36c7728.md) |
| rewinfrey/tree-sitter-scope | Language Specification | [open](braces-rewinfrey-tree-sitter-scope-4d596b4d.md) |
