...
<!-- canonical: https://hackage.haskell.org/package/list-t -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/list-t](https://hackage.haskell.org/package/list-t) |
| Source record ids | hackage_top_downloads-99d31cd8e7ef8c |
...
For a systems engineer, list-t belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.5.7 | 2023-10-11T16:26:25Z | [https://hackage.haskell.org/package/list-t](https://hackage.haskell.org/package/list-t) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/list-t` at `2026-09-11T00:31:28+00:00`.
...
- `hackage_top_downloads-99d31cd8e7ef8c` from `hackage_top_downloads` as `registry_expansion`
