...
| Source record ids | github_search_font_briefcase-4242301a1d238e |

## System Engineer Summary

spoqa/spoqa-han-sans is tracked as a library record in the Font Briefcase branch. The source did not
...
For a systems engineer, spoqa/spoqa-han-sans belongs in the Font Briefcase inventory as part of
...
- `github_search_font_briefcase-4242301a1d238e` from `github_search_font_briefcase` as `registry_expansion`
