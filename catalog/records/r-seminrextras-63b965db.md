...
<!-- canonical: https://cran.r-project.org/web/packages/seminrExtras/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/seminrExtras/index.html](https://cran.r-project.org/web/packages/seminrExtras/index.html) |
| Source record ids | cran_packages_by_date-841740e0fd4e3d |
...
For a systems engineer, seminrExtras belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-08-19 22:50:03 UTC | [https://cran.r-project.org/web/packages/seminrExtras/DESCRIPTION](https://cran.r-project.org/web/packages/seminrExtras/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/seminrExtras/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-841740e0fd4e3d` from `cran_packages_by_date` as `registry_expansion`
