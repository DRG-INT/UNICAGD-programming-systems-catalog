...
<!-- canonical: https://luarocks.org/modules/neorocks/cmp-path -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/cmp-path](https://luarocks.org/modules/neorocks/cmp-path) |
| Source record ids | luarocks_root_manifest-203bc987e18fd2 |
...
For a systems engineer, cmp-path belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-203bc987e18fd2` from `luarocks_root_manifest` as `registry_expansion`
