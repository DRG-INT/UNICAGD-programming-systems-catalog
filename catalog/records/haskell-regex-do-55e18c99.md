...
<!-- canonical: https://hackage.haskell.org/package/regex-do -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/regex-do](https://hackage.haskell.org/package/regex-do) |
| Source record ids | hackage_top_downloads-7b04823a7adefe |
...
For a systems engineer, regex-do belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.2 | 2020-02-11T01:04:14Z | [https://hackage.haskell.org/package/regex-do](https://hackage.haskell.org/package/regex-do) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/regex-do` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-7b04823a7adefe` from `hackage_top_downloads` as `registry_expansion`
