...
<!-- canonical: https://pub.dev/packages/result_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/result_dart](https://pub.dev/packages/result_dart) |
| Source record ids | pub_dev-32dfa0cf61431d |
...
For a systems engineer, result_dart belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-03-07T18:50:51.040100Z | [https://pub.dev/api/packages/result_dart](https://pub.dev/api/packages/result_dart) |  |
| preview | known | 2.0.0-alpha.4 | 2024-12-11T14:18:45.422810Z | [https://pub.dev/api/packages/result_dart](https://pub.dev/api/packages/result_dart) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT + file LICENSE; MIT License; https://api.github.com/licenses/mit; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/result_dart` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-32dfa0cf61431d` from `pub_dev` as `registry_expansion`
