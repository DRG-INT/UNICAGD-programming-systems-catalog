...
<!-- canonical: https://hackage.haskell.org/package/langchain-hs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/langchain-hs](https://hackage.haskell.org/package/langchain-hs) |
| Source record ids | hackage_recent-824a427af813c4 |
...
For a systems engineer, langchain-hs belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5.0 | 2026-09-12T13:14:41Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-824a427af813c4` from `hackage_recent` as `registry_expansion`
