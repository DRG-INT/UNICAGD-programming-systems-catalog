...
<!-- canonical: https://github.com/NGSolve/ngsolve -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NGSolve/ngsolve](https://github.com/NGSolve/ngsolve) |
| Source record ids | github_search_electromagnetoscopes-a9c8819858a410 |

## System Engineer Summary

Netgen/NGSolve is a high performance multiphysics finite element software. It is widely used to
analyze models from solid mechanics, fluid dynamics and electromagnetics. Due to its flexible Python
interface new physical equations and solution algorithms can be implemented easily.

## Operational Role

For a systems engineer, NGSolve/ngsolve belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T22:45:51Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-a9c8819858a410` from `github_search_electromagnetoscopes` as `registry_expansion`
