...
<!-- canonical: https://github.com/oracle/docker-images -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oracle/docker-images](https://github.com/oracle/docker-images) |
| Source record ids | github_search_databases-7327e7a4fd5c6f |
...
For a systems engineer, oracle/docker-images belongs in the Databases inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T22:53:10Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; Universal Permissive License v1.0; https://api.github.com/licenses/upl-1.0 |
...
- `github_search_databases-7327e7a4fd5c6f` from `github_search_databases` as `registry_expansion`
