...
<!-- canonical: https://cran.r-project.org/web/packages/seqmagick/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/seqmagick/index.html](https://cran.r-project.org/web/packages/seqmagick/index.html) |
| Source record ids | cran_packages_by_date-ad2adb4086f8f6 |
...
For a systems engineer, seqmagick belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-08-30 06:30:02 UTC | [https://cran.r-project.org/web/packages/seqmagick/DESCRIPTION](https://cran.r-project.org/web/packages/seqmagick/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/seqmagick/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ad2adb4086f8f6` from `cran_packages_by_date` as `registry_expansion`
