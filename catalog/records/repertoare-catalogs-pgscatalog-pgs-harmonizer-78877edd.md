...
<!-- canonical: https://github.com/PGScatalog/pgs-harmonizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PGScatalog/pgs-harmonizer](https://github.com/PGScatalog/pgs-harmonizer) |
| Source record ids | github_search_repertoare_catalogs-6bbb08295357bb |

## System Engineer Summary

A pipeline to format and harmonise Polygenic Score (PGS) Catalog Scoring Files within and between
different genome builds.

## Operational Role

For a systems engineer, PGScatalog/pgs-harmonizer belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-26T10:04:58Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_repertoare_catalogs-6bbb08295357bb` from `github_search_repertoare_catalogs` as `registry_expansion`
