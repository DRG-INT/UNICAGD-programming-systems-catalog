...
<!-- canonical: https://github.com/kannagi0303/yt-dlp-gui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kannagi0303/yt-dlp-gui](https://github.com/kannagi0303/yt-dlp-gui) |
| Source record ids | github_search_video-d75f95b06562a7 |

## System Engineer Summary

kannagi0303/yt-dlp-gui is tracked as a visualization gui record in the Video branch. The source did
...
For a systems engineer, kannagi0303/yt-dlp-gui belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-13T11:02:40Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-d75f95b06562a7` from `github_search_video` as `registry_expansion`
