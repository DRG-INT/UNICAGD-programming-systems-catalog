...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Ffi Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ffi-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/wellyxs/dialog](https://luarocks.org/modules/wellyxs/dialog) |
| Source record ids | luarocks_root_manifest-3eb71dc83963df |

## System Engineer Summary

dialog is tracked as a ffi bindings record in the Lua family branch. The source did not provide a
...
For a systems engineer, dialog belongs in the Lua family inventory as part of cross-language
...
| Name | Category | Page |
| --- | --- | --- |
| abletonlink | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-abletonlink-8bf2632e.md) |
| Alien | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-alien-d4598c7e.md) |
| allegro5_lua | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-allegro5-lua-80568ff1.md) |
| argon2 | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argon2-5403f62b.md) |
| avro | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-avro-e3de1894.md) |
| awesome-ez | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-awesome-ez-3c37dc4e.md) |
| benchgecko | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-benchgecko-e348fcc9.md) |
| bestline | Ffi Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bestline-d3a69439.md) |
