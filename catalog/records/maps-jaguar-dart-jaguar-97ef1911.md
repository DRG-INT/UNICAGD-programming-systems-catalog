...
<!-- canonical: https://github.com/Jaguar-dart/jaguar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jaguar-dart/jaguar](https://github.com/Jaguar-dart/jaguar) |
| Source record ids | github_search_maps-051103bacde214 |

## System Engineer Summary

Jaguar, a server framework built for speed, simplicity and extensible. ORM, Session, Authentication
& Authorization, OAuth

## Operational Role

For a systems engineer, Jaguar-dart/jaguar belongs in the Maps inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-08T23:00:41Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-051103bacde214` from `github_search_maps` as `registry_expansion`
