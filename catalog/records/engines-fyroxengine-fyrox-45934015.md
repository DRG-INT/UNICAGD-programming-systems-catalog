...
<!-- canonical: https://github.com/FyroxEngine/Fyrox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FyroxEngine/Fyrox](https://github.com/FyroxEngine/Fyrox) |
| Source record ids | github_search_engines-ef820e47100f73 |
...
For a systems engineer, FyroxEngine/Fyrox belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:45:41Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-ef820e47100f73` from `github_search_engines` as `registry_expansion`
