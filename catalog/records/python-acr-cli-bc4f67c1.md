...
<!-- canonical: https://pypi.org/project/acr-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acr-cli/](https://pypi.org/project/acr-cli/) |
| Source record ids | pypi_simple-02197b132a837e |
...
For a systems engineer, acr-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2025-11-09T09:08:22.236695Z | [https://pypi.org/pypi/acr-cli/json](https://pypi.org/pypi/acr-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acr-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-02197b132a837e` from `pypi_simple` as `registry_expansion`
