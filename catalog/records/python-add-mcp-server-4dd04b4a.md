...
<!-- canonical: https://pypi.org/project/add-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/add-mcp-server/](https://pypi.org/project/add-mcp-server/) |
| Source record ids | pypi_simple-fdc5066b26220a |

## System Engineer Summary

A custom MCP Server example for PyPI.

## Operational Role

For a systems engineer, add-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2025-05-25T11:01:35.024183Z | [https://pypi.org/pypi/add-mcp-server/json](https://pypi.org/pypi/add-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/add-mcp-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-fdc5066b26220a` from `pypi_simple` as `registry_expansion`
