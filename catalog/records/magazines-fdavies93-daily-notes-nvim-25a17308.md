...
<!-- canonical: https://github.com/fdavies93/daily-notes.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fdavies93/daily-notes.nvim](https://github.com/fdavies93/daily-notes.nvim) |
| Source record ids | github_search_magazines-b565b9891701da |
...
For a systems engineer, fdavies93/daily-notes.nvim belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-22T08:32:10Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-b565b9891701da` from `github_search_magazines` as `registry_expansion`
