...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/S/SQLite](https://github.com/JuliaRegistries/General/tree/master/S/SQLite) |
| Source record ids | corpus-b10a1288b4a073 |

## System Engineer Summary

SQLite.jl is tracked as a database datastore record in the Julia branch. The source did not provide
...
For a systems engineer, SQLite.jl belongs in the Julia inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.8.2 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/S/SQLite/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/S/SQLite/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-b10a1288b4a073` from `master_json` as `database_datastore`
