...
<!-- canonical: https://github.com/djaiss/mapsicon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/djaiss/mapsicon](https://github.com/djaiss/mapsicon) |
| Source record ids | github_search_icons_and_logos-1a677c5d55457b |
...
For a systems engineer, djaiss/mapsicon belongs in the Icons and Logos inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-06-07T13:24:47Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-1a677c5d55457b` from `github_search_icons_and_logos` as `registry_expansion`
