...
<!-- canonical: https://luarocks.org/modules/luatoolz/autossl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luatoolz/autossl](https://luarocks.org/modules/luatoolz/autossl) |
| Source record ids | luarocks_root_manifest-6a431fdb8fd135 |

## System Engineer Summary

autossl: multidomain nginx+lua+resty.asme.autossl env autoconfig

## Operational Role

For a systems engineer, autossl belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6a431fdb8fd135` from `luarocks_root_manifest` as `registry_expansion`
...
| ccrunx-compose | Configuration | [open](lua-family-ccrunx-compose-069edc4d.md) |
