...
<!-- canonical: https://github.com/oras-project/oras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oras-project/oras](https://github.com/oras-project/oras) |
| Source record ids | github_search_catalogs-ea3206cd1704f9 |
...
For a systems engineer, oras-project/oras belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T03:45:52Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ea3206cd1704f9` from `github_search_catalogs` as `registry_expansion`
