...
<!-- canonical: https://cran.r-project.org/web/packages/LMERConvenienceFunctions/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LMERConvenienceFunctions/index.html](https://cran.r-project.org/web/packages/LMERConvenienceFunctions/index.html) |
| Source record ids | cran_packages_by_date-58c1ae05ec0fe2 |
...
For a systems engineer, LMERConvenienceFunctions belongs in the R inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2 | 2026-08-24 20:10:02 UTC | [https://cran.r-project.org/web/packages/LMERConvenienceFunctions/DESCRIPTION](https://cran.r-project.org/web/packages/LMERConvenienceFunctions/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LMERConvenienceFunctions/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-58c1ae05ec0fe2` from `cran_packages_by_date` as `registry_expansion`
