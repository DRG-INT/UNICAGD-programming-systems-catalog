# leonaaraujo/unity-phosphor-monitor-shader
...
<!-- canonical: https://github.com/leonaaraujo/unity-phosphor-monitor-shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leonaaraujo/unity-phosphor-monitor-shader](https://github.com/leonaaraujo/unity-phosphor-monitor-shader) |
| Source record ids | github_search_effects-0e9e20ede22a6a |

## System Engineer Summary

A post-processing shader to simulate a phosphor monitor on unity camera. Just copy the files to
Assets folder and use "Phosphor Monitor" component on Camera.

## Operational Role

For a systems engineer, leonaaraujo/unity-phosphor-monitor-shader belongs in the Effects inventory
...
- `github_search_effects-0e9e20ede22a6a` from `github_search_effects` as `registry_expansion`
