...
| Source record ids | github_search_go-7466e124682415 |
...
For a systems engineer, pingcap/tidb belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T17:16:44Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-7466e124682415` from `github_search_go` as `registry_expansion`
