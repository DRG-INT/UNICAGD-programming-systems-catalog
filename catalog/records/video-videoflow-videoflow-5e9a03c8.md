...
| Canonical URL | [https://github.com/videoflow/videoflow](https://github.com/videoflow/videoflow) |
| Source record ids | github_search_video-639aa6547d3443 |

## System Engineer Summary

Python framework that facilitates the quick development of complex video analysis applications and
other series-processing based applications in a multiprocessing environment.

## Operational Role

For a systems engineer, videoflow/videoflow belongs in the Video inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.10 | 2020-03-19T13:54:45Z | [https://api.github.com/repos/videoflow/videoflow/releases/latest](https://api.github.com/repos/videoflow/videoflow/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/videoflow/videoflow/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-639aa6547d3443` from `github_search_video` as `registry_expansion`
