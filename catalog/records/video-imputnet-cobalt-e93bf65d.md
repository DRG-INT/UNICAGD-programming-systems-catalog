...
<!-- canonical: https://github.com/imputnet/cobalt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/imputnet/cobalt](https://github.com/imputnet/cobalt) |
| Source record ids | github_search_video-873d8a1b1e4d69 |
...
For a systems engineer, imputnet/cobalt belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-06T11:59:56Z | gh search repos topic:video stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-873d8a1b1e4d69` from `github_search_video` as `registry_expansion`
