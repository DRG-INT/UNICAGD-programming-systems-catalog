...
<!-- canonical: https://hackage.haskell.org/package/mysql-simple -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mysql-simple](https://hackage.haskell.org/package/mysql-simple) |
| Source record ids | hackage_top_downloads-306a0350e8abe0 |
...
For a systems engineer, mysql-simple belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.9 | 2022-11-01T11:46:00Z | [https://hackage.haskell.org/package/mysql-simple](https://hackage.haskell.org/package/mysql-simple) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mysql-simple` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-306a0350e8abe0` from `hackage_top_downloads` as `registry_expansion`
