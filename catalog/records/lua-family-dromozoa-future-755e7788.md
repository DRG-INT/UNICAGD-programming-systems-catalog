...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-future](https://luarocks.org/modules/moyu/dromozoa-future) |
| Source record ids | luarocks_root_manifest-d5cef15f064aa0 |
...
For a systems engineer, dromozoa-future belongs in the Lua family inventory as part of concurrency
...
| Name | Category | Page |
| --- | --- | --- |
| act | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-act-4ff0ad7b.md) |
| async | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-async-1eb5c035.md) |
| async-framework | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-async-framework-b849d00e.md) |
| async-utils | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-async-utils-efc85dd0.md) |
| async.lua | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-async-lua-668c3126.md) |
| asyncio | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-asyncio-8daeeae9.md) |
| away-dataqueue | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-away-dataqueue-7107fb30.md) |
| Copas | Async Runtime | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-copas-8a6e8951.md) |
