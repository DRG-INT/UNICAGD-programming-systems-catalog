...
<!-- canonical: https://cran.r-project.org/web/packages/poLCAParallel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/poLCAParallel/index.html](https://cran.r-project.org/web/packages/poLCAParallel/index.html) |
| Source record ids | cran_packages_by_date-3f46fd23e5ad5f |
...
For a systems engineer, poLCAParallel belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.9 | 2026-08-25 14:50:02 UTC | [https://cran.r-project.org/web/packages/poLCAParallel/DESCRIPTION](https://cran.r-project.org/web/packages/poLCAParallel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/poLCAParallel/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3f46fd23e5ad5f` from `cran_packages_by_date` as `registry_expansion`
