...
<!-- canonical: https://crates.io/crates/color-eyre -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/color-eyre](https://crates.io/crates/color-eyre) |
| Source record ids | crates_io-73e00d8b16bcdf |

## System Engineer Summary

An error report handler for panics and eyre::Reports for colorful, consistent, and well formatted
error reports for all kinds of errors.

## Operational Role

For a systems engineer, color-eyre belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.5 | 2025-05-30T16:39:28.879707Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-73e00d8b16bcdf` from `crates_io` as `registry_expansion`
