...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/openstreetmap/openstreetmap-website -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/openstreetmap/openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) |
| Source record ids | github_search_maps-b9dcb97d46e7f2 |
...
For a systems engineer, openstreetmap/openstreetmap-website belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T16:42:49Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-13 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:openstreetmap stars:>100", "retrieved": "2026-09-13", "status": "forge-cli-derived"}` |
...
- `github_search_maps-b9dcb97d46e7f2` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Adamant-im/adamant-explorer | Machine Learning | [open](maps-adamant-im-adamant-explorer-65f99887.md) |
| AdevintaSpain/Leku | Machine Learning | [open](maps-adevintaspain-leku-fdbb0997.md) |
| BigBodyCobain/Shadowbroker | Machine Learning | [open](maps-bigbodycobain-shadowbroker-93ec024b.md) |
| cesiumlab/XbsjEarthUI | Machine Learning | [open](maps-cesiumlab-xbsjearthui-ebc31770.md) |
| darkmoonight/Rain | Machine Learning | [open](maps-darkmoonight-rain-cd8bf6ae.md) |
| Esri/arcgis-maps-sdk-dotnet-samples | Machine Learning | [open](maps-esri-arcgis-maps-sdk-dotnet-samples-0c5516d2.md) |
| flask-extensions/Flask-GoogleMaps | Machine Learning | [open](maps-flask-extensions-flask-googlemaps-43b3b72f.md) |
| heremaps/maps-api-for-javascript-examples | Machine Learning | [open](maps-heremaps-maps-api-for-javascript-examples-735bd309.md) |
