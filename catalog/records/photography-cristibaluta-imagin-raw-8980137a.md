...
| Source record ids | github_search_photography-aa254756f56bfd |
...
- `github_search_photography-aa254756f56bfd` from `github_search_photography` as `registry_expansion`
