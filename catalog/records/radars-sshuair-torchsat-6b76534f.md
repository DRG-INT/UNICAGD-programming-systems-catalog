...
<!-- canonical: https://github.com/sshuair/torchsat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sshuair/torchsat](https://github.com/sshuair/torchsat) |
| Source record ids | github_search_radars-07ccee5c5a1c46 |

## System Engineer Summary

🔥TorchSat 🌏 is an open-source deep learning framework for satellite imagery analysis based on
PyTorch.

## Operational Role

For a systems engineer, sshuair/torchsat belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-08-30T14:03:49Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_radars-07ccee5c5a1c46` from `github_search_radars` as `registry_expansion`
