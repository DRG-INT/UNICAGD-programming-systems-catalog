...
<!-- canonical: https://github.com/zyddnys/manga-image-translator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zyddnys/manga-image-translator](https://github.com/zyddnys/manga-image-translator) |
| Source record ids | github_search_photography-5c3927e7eb1234 |

## System Engineer Summary

Translate manga/image 一键翻译各类图片内文字 (no longer working)

## Operational Role

For a systems engineer, zyddnys/manga-image-translator belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T07:17:48Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-5c3927e7eb1234` from `github_search_photography` as `registry_expansion`
