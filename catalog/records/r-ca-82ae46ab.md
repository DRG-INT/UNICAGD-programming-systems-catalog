...
<!-- canonical: https://cran.r-project.org/web/packages/ca/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ca/index.html](https://cran.r-project.org/web/packages/ca/index.html) |
| Source record ids | cran_packages_by_date-a36f28ad688005 |
...
For a systems engineer, ca belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.72 | 2026-09-13 21:40:02 UTC | [https://cran.r-project.org/web/packages/ca/DESCRIPTION](https://cran.r-project.org/web/packages/ca/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ca/DESCRIPTION` at `2026-09-13T22:19:02+00:00`.
...
- `cran_packages_by_date-a36f28ad688005` from `cran_packages_by_date` as `registry_expansion`
