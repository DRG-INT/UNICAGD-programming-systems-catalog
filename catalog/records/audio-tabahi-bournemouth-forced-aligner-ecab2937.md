...
<!-- canonical: https://github.com/tabahi/bournemouth-forced-aligner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tabahi/bournemouth-forced-aligner](https://github.com/tabahi/bournemouth-forced-aligner) |
| Source record ids | github_search_audio-204d94fd212b6e |
...
For a systems engineer, tabahi/bournemouth-forced-aligner belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-07T00:51:20Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-204d94fd212b6e` from `github_search_audio` as `registry_expansion`
