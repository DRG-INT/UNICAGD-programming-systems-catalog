...
| Canonical URL | [https://crates.io/crates/oneshot](https://crates.io/crates/oneshot) |
| Source record ids | crates_io-32720f640707c2 |

## System Engineer Summary

Oneshot spsc channel with (potentially) lock-free non-blocking send, and a receiver supporting both
thread blocking receive operations as well as Future based async polling.

## Operational Role

For a systems engineer, oneshot belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-02-23T22:51:52.157768Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-32720f640707c2` from `crates_io` as `registry_expansion`
