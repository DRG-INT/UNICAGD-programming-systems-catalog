...
<!-- canonical: https://crates.io/crates/wasm-metadata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasm-metadata](https://crates.io/crates/wasm-metadata) |
| Source record ids | crates_io-ac143c6bdafd32 |
...
For a systems engineer, wasm-metadata belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.258.0 | 2026-08-24T17:12:14.886911Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-ac143c6bdafd32` from `crates_io` as `registry_expansion`
