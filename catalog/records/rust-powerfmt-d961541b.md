...
<!-- canonical: https://crates.io/crates/powerfmt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/powerfmt](https://crates.io/crates/powerfmt) |
| Source record ids | crates_io-92441554186475 |

## System Engineer Summary

`powerfmt` is a library that provides utilities for formatting values. This crate makes it
significantly easier to support filling to a minimum width with alignment, avoid heap allocation,
and avoid repetitive calculations.

## Operational Role

For a systems engineer, powerfmt belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2023-10-13T22:04:23.598335Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-92441554186475` from `crates_io` as `registry_expansion`
