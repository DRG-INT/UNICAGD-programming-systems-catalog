...
<!-- canonical: https://hackage.haskell.org/package/ftp-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ftp-client](https://hackage.haskell.org/package/ftp-client) |
| Source record ids | hackage_recent-d4a2c7400d119e |

## System Engineer Summary

Hackage package recently uploaded by janus.

## Operational Role

For a systems engineer, ftp-client belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2026-09-12T19:31:31Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-12T20:18:44+00:00`.
...
- `hackage_recent-d4a2c7400d119e` from `hackage_recent` as `registry_expansion`
