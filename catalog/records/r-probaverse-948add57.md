...
<!-- canonical: https://cran.r-project.org/web/packages/probaverse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/probaverse/index.html](https://cran.r-project.org/web/packages/probaverse/index.html) |
| Source record ids | cran_packages_by_date-331a8146fd2368 |

## System Engineer Summary

Install and Load the 'probaverse' Packages

## Operational Role

For a systems engineer, probaverse belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-09-15 21:30:02 UTC | [https://cran.r-project.org/web/packages/probaverse/DESCRIPTION](https://cran.r-project.org/web/packages/probaverse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/probaverse/DESCRIPTION` at `2026-09-15T22:19:01+00:00`.
...
- `cran_packages_by_date-331a8146fd2368` from `cran_packages_by_date` as `registry_expansion`
