...
<!-- canonical: https://github.com/koide3/direct_visual_lidar_calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/koide3/direct_visual_lidar_calibration](https://github.com/koide3/direct_visual_lidar_calibration) |
| Source record ids | github_search_photography-0f892823db159c |
...
For a systems engineer, koide3/direct_visual_lidar_calibration belongs in the Photography inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-22T00:13:43Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-0f892823db159c` from `github_search_photography` as `registry_expansion`
