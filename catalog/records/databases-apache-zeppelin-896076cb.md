...
<!-- canonical: https://github.com/apache/zeppelin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/zeppelin](https://github.com/apache/zeppelin) |
| Source record ids | github_search_databases-12a14beaf3e051 |
...
For a systems engineer, apache/zeppelin belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T10:04:13Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-12a14beaf3e051` from `github_search_databases` as `registry_expansion`
