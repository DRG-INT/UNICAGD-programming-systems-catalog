...
<!-- canonical: https://github.com/neoseek/AudioForge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neoseek/AudioForge](https://github.com/neoseek/AudioForge) |
| Source record ids | github_search_effects-2d71f53d6d491e |

## System Engineer Summary

Full audio effects DSP plugin for Steam Deck with integrated JamesDSP. EQ, Reverb and much more.

## Operational Role

For a systems engineer, neoseek/AudioForge belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-09T10:38:16Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-2d71f53d6d491e` from `github_search_effects` as `registry_expansion`
