...
| Canonical URL | [https://github.com/capstone-engine/capstone](https://github.com/capstone-engine/capstone) |
| Source record ids | github_search_webassembly-365904bae0d3b6 |

## System Engineer Summary

Capstone disassembly/disassembler framework for ARM, ARM64 (ARMv8), Alpha, BPF, Ethereum VM, HPPA,
LoongArch, M68K, M680X, Mips, MOS65XX, PPC, RISC-V(rv32G/rv64G), SH, Sparc, SystemZ, TMS320C64X,
TriCore, Webassembly, XCore and X86.

## Operational Role

For a systems engineer, capstone-engine/capstone belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0-Alpha10 | 2026-07-21T17:12:50Z | [https://api.github.com/repos/capstone-engine/capstone/releases/latest](https://api.github.com/repos/capstone-engine/capstone/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/capstone-engine/capstone/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-365904bae0d3b6` from `github_search_webassembly` as `registry_expansion`
...
| leaningtech/webvm | Interpreter Runtime | [open](webassembly-leaningtech-webvm-e3518757.md) |
| lunatic-solutions/lunatic | Interpreter Runtime | [open](webassembly-lunatic-solutions-lunatic-b2983cdd.md) |
| wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint | Interpreter Runtime | [open](webassembly-wamr-webassembly-micro-runtime-wamr-is-an-aot-jit-interpreter-focusing-on-small-footprint-358da7f6.md) |
| wasm-micro-runtime/wasm-micro-runtime | Interpreter Runtime | [open](webassembly-wasm-micro-runtime-wasm-micro-runtime-0baaf623.md) |
| wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa) | Interpreter Runtime | [open](webassembly-wasm3-the-fastest-webassembly-interpreter-x86-x64-arm-mips-xtensa-05225f2f.md) |
