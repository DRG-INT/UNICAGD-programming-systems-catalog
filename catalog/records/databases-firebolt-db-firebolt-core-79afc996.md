...
<!-- canonical: https://github.com/firebolt-db/firebolt-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/firebolt-db/firebolt-core](https://github.com/firebolt-db/firebolt-core) |
| Source record ids | github_search_databases-3dea5f57ef2c29 |

## System Engineer Summary

Firebolt Core is a free, self-hosted edition of Firebolt's distributed query engine ; it provides
high-performance data warehousing capabilities that can be deployed anywhere from a single laptop to
enterprise datacenters.

## Operational Role

For a systems engineer, firebolt-db/firebolt-core belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T06:43:42Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3dea5f57ef2c29` from `github_search_databases` as `registry_expansion`
