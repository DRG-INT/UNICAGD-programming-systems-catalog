...
<!-- canonical: https://hackage.haskell.org/package/simplest-sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/simplest-sqlite](https://hackage.haskell.org/package/simplest-sqlite) |
| Source record ids | hackage_top_downloads-04c2bebbefcde7 |
...
For a systems engineer, simplest-sqlite belongs in the Haskell inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.1 | 2026-03-17T01:14:39Z | [https://hackage.haskell.org/package/simplest-sqlite](https://hackage.haskell.org/package/simplest-sqlite) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/simplest-sqlite` at `2026-09-04T00:31:04+00:00`.
...
- `hackage_top_downloads-04c2bebbefcde7` from `hackage_top_downloads` as `registry_expansion`
