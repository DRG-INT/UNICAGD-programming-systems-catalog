...
<!-- canonical: https://luarocks.org/modules/olical/conjure -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/olical/conjure](https://luarocks.org/modules/olical/conjure) |
| Source record ids | luarocks_root_manifest-18f5da99922d34 |

## System Engineer Summary

Interactive evaluation for Neovim (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile, Python and
more!)

## Operational Role

For a systems engineer, conjure belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-18f5da99922d34` from `luarocks_root_manifest` as `registry_expansion`
