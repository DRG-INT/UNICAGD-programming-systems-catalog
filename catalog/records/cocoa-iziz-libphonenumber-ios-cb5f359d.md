...
<!-- canonical: https://github.com/iziz/libPhoneNumber-iOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iziz/libPhoneNumber-iOS](https://github.com/iziz/libPhoneNumber-iOS) |
| Source record ids | github_search_cocoa-b8f921fd128469 |

## System Engineer Summary

iOS port of Google's libphonenumber with Objective-C core, Swift facade, SwiftUI input, and
CocoaPods/SPM support

## Operational Role

For a systems engineer, iziz/libPhoneNumber-iOS belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T15:30:59Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-b8f921fd128469` from `github_search_cocoa` as `registry_expansion`
