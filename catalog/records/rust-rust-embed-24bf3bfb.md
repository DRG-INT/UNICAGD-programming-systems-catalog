...
| Canonical URL | [https://crates.io/crates/rust-embed](https://crates.io/crates/rust-embed) |
| Source record ids | crates_io-663cb00dc6a70f |

## System Engineer Summary

Rust Custom Derive Macro which loads files into the rust binary at compile time during release and
loads the file from the fs during dev

## Operational Role

For a systems engineer, rust-embed belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.12.0 | 2026-07-08T06:06:06.917158Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-663cb00dc6a70f` from `crates_io` as `registry_expansion`
