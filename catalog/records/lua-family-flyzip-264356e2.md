...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Compression](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compression.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/solra-bizna/flyzip](https://luarocks.org/modules/solra-bizna/flyzip) |
| Source record ids | luarocks_root_manifest-29dd4af6f5c25d |
...
For a systems engineer, flyzip belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| Compression | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-compression-ea2b0c67.md) |
| gamecake-zip | Compression | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gamecake-zip-56dddff9.md) |
