...
<!-- canonical: https://cran.r-project.org/web/packages/autotestR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/autotestR/index.html](https://cran.r-project.org/web/packages/autotestR/index.html) |
| Source record ids | cran_packages_by_date-a0f0d4ad901351 |
...
For a systems engineer, autotestR belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.16 | 2026-08-21 05:45:17 UTC | [https://cran.r-project.org/web/packages/autotestR/DESCRIPTION](https://cran.r-project.org/web/packages/autotestR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/autotestR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a0f0d4ad901351` from `cran_packages_by_date` as `registry_expansion`
