...
| Source record ids | lua-source-162 |

## System Engineer Summary

lua-source-162 is tracked as an other record in the Lua family branch. The source did not provide a
...
For a systems engineer, lua-source-162 belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 162}}` |
...
- `lua-source-162` from `master_json` as `source_list_item`
