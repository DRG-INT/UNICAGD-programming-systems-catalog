...
<!-- canonical: https://crates.io/crates/termcolor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/termcolor](https://crates.io/crates/termcolor) |
| Source record ids | crates_io-99cafa175e7ea7 |
...
For a systems engineer, termcolor belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2024-01-10T12:40:32.427230Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; CC0-1.0; https://www.nuget.org/packages/JWT/11.1.0/license |
...
- `crates_io-99cafa175e7ea7` from `crates_io` as `registry_expansion`
