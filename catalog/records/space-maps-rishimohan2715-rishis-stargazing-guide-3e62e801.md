# rishimohan2715/rishis-stargazing-guide
...
<!-- canonical: https://github.com/rishimohan2715/rishis-stargazing-guide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rishimohan2715/rishis-stargazing-guide](https://github.com/rishimohan2715/rishis-stargazing-guide) |
| Source record ids | github_search_space_maps-438f8356dc57b7 |

## System Engineer Summary

Interactive stargazing dashboard with sky map, ISS tracking, moon phase, satellites, comets, and
star/object lookups (Next.js + TypeScript).

## Operational Role

For a systems engineer, rishimohan2715/rishis-stargazing-guide belongs in the Space Maps inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-01T16:33:21Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-438f8356dc57b7` from `github_search_space_maps` as `registry_expansion`
