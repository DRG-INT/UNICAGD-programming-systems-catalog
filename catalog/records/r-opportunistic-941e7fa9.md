...
<!-- canonical: https://cran.r-project.org/web/packages/Opportunistic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Opportunistic/index.html](https://cran.r-project.org/web/packages/Opportunistic/index.html) |
| Source record ids | cran_packages_by_date-7fbfefa57daa97 |
...
For a systems engineer, Opportunistic belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.1 | 2026-09-07 19:50:02 UTC | [https://cran.r-project.org/web/packages/Opportunistic/DESCRIPTION](https://cran.r-project.org/web/packages/Opportunistic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Opportunistic/DESCRIPTION` at `2026-09-07T20:19:51+00:00`.
...
- `cran_packages_by_date-7fbfefa57daa97` from `cran_packages_by_date` as `registry_expansion`
