...
<!-- canonical: https://github.com/psi-consortium/psi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psi-consortium/psi](https://github.com/psi-consortium/psi) |
| Source record ids | github_search_satcom_satellites-5be54f1a2cda52 |

## System Engineer Summary

A set of common standardized interfaces allowing the interoperability between Pooling and Sharing
systems (PSS) for satellite communication (SatCom) services

## Operational Role

For a systems engineer, psi-consortium/psi belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1-alpha | 2026-07-27T22:30:18Z | [https://api.github.com/repos/psi-consortium/psi/releases/latest](https://api.github.com/repos/psi-consortium/psi/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/psi-consortium/psi/releases/latest` at `2026-09-01T08:26:37+00:00`.
...
- `github_search_satcom_satellites-5be54f1a2cda52` from `github_search_satcom_satellites` as `registry_expansion`
