...
<!-- canonical: https://github.com/pcjbird/AssetsExtractor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pcjbird/AssetsExtractor](https://github.com/pcjbird/AssetsExtractor) |
| Source record ids | github_search_assets-1b1d458cb9a7d1 |

## System Engineer Summary

『Assets提取工具』是一款OSX平台上用于将Assets.car或xxx.app中打包的png图片、pdf等资源重新提取出来的开发者工具。Assets.car常见于iOS/Mac/Unity等开发
中的资源打包。

## Operational Role

For a systems engineer, pcjbird/AssetsExtractor belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-04-28T14:08:03Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-1b1d458cb9a7d1` from `github_search_assets` as `registry_expansion`
