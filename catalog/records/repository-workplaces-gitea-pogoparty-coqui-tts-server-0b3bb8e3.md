# Gitea: pogoParty/coqui-tts-server
...
<!-- canonical: https://gitea.com/pogoParty/coqui-tts-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/pogoParty/coqui-tts-server](https://gitea.com/pogoParty/coqui-tts-server) |
| Source record ids | gitea_repositories_api-51ce29f02f82f9 |
...
For a systems engineer, Gitea: pogoParty/coqui-tts-server belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-14T11:32:04Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-51ce29f02f82f9` from `gitea_repositories_api` as `registry_expansion`
