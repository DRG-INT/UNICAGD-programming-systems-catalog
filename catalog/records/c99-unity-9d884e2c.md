...
| Source record ids | master-7da16a57aa91 |
...
For a systems engineer, Unity belongs in the C99 inventory as part of unit/integration validation,
...
- `master-7da16a57aa91` from `master_json` as `testing_framework`
...
| Criterion | Testing Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-criterion-280e095e.md) |
