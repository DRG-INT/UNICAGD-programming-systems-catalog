...
| Canonical URL | [https://crates.io/crates/profiling-procmacros](https://crates.io/crates/profiling-procmacros) |
| Source record ids | crates_io-397d1e49a2c48f |
...
For a systems engineer, profiling-procmacros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.18 | 2026-05-04T03:33:06.663759Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-397d1e49a2c48f` from `crates_io` as `registry_expansion`
