...
<!-- canonical: https://crates.io/crates/tokio-stream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-stream](https://crates.io/crates/tokio-stream) |
| Source record ids | crates_io-ae21f5132f0c5e |
...
For a systems engineer, tokio-stream belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.19 | 2026-07-22T08:19:01.447272Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-ae21f5132f0c5e` from `crates_io` as `registry_expansion`
