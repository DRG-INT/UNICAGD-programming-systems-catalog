...
<!-- canonical: https://cran.r-project.org/web/packages/shadowVIMP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/shadowVIMP/index.html](https://cran.r-project.org/web/packages/shadowVIMP/index.html) |
| Source record ids | cran_packages_by_date-e9110e5ae303f8 |
...
For a systems engineer, shadowVIMP belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-09-10 14:20:09 UTC | [https://cran.r-project.org/web/packages/shadowVIMP/DESCRIPTION](https://cran.r-project.org/web/packages/shadowVIMP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/shadowVIMP/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-e9110e5ae303f8` from `cran_packages_by_date` as `registry_expansion`
