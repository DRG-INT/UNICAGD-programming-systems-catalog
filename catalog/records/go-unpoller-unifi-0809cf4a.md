...
<!-- canonical: https://github.com/unpoller/unifi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unpoller/unifi](https://github.com/unpoller/unifi) |
| Source record ids | github_search_go-5de8f5918de1dd |
...
For a systems engineer, unpoller/unifi belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T12:00:24Z | gh search repos topic:go-modules stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-5de8f5918de1dd` from `github_search_go` as `registry_expansion`
