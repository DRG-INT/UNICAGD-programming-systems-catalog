...
<!-- canonical: https://github.com/drawcall/Proton -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/drawcall/Proton](https://github.com/drawcall/Proton) |
| Source record ids | github_search_effects-8d448ceb72a54f |
...
For a systems engineer, drawcall/Proton belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-06T08:19:03Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-8d448ceb72a54f` from `github_search_effects` as `registry_expansion`
