...
<!-- canonical: https://github.com/geolens-io/geolens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geolens-io/geolens](https://github.com/geolens-io/geolens) |
| Source record ids | github_search_maps-6ffac8fc59b94a |

## System Engineer Summary

Self-hosted geospatial data catalog with semantic search (pgvector), OGC/STAC APIs, and map builder.
Built on FastAPI, PostGIS, React, and MapLibre.

## Operational Role

For a systems engineer, geolens-io/geolens belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T02:50:33Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-6ffac8fc59b94a` from `github_search_maps` as `registry_expansion`
