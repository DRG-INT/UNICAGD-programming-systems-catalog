# rawsec/rawsec-cybersecurity-list
...
<!-- canonical: https://gitlab.com/rawsec/rawsec-cybersecurity-list -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/rawsec/rawsec-cybersecurity-list](https://gitlab.com/rawsec/rawsec-cybersecurity-list) |
| Source record ids | gitlab_projects_api-f9e0b539f65b53 |
...
For a systems engineer, rawsec/rawsec-cybersecurity-list belongs in the Repository Workplaces
...
- `gitlab_projects_api-f9e0b539f65b53` from `gitlab_projects_api` as `registry_expansion`
