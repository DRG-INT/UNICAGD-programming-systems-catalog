...
<!-- canonical: https://packagist.org/packages/codeception/module-db -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/codeception/module-db](https://packagist.org/packages/codeception/module-db) |
| Source record ids | packagist_search-c1583f0cbc8570 |
...
For a systems engineer, codeception/module-db belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-15 | `{"kind": "packagist_search_and_p2_api", "query": "database", "retrieved": "2026-09-15", "status": "registry-derived"}` |
...
- `packagist_search-c1583f0cbc8570` from `packagist_search` as `registry_expansion`
