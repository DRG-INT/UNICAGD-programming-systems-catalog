...
<!-- canonical: https://cran.r-project.org/web/packages/CVXR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CVXR/index.html](https://cran.r-project.org/web/packages/CVXR/index.html) |
| Source record ids | cran_packages_by_date-3ae4c8987f7bd8 |
...
For a systems engineer, CVXR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.2 | 2026-08-24 05:21:00 UTC | [https://cran.r-project.org/web/packages/CVXR/DESCRIPTION](https://cran.r-project.org/web/packages/CVXR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CVXR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3ae4c8987f7bd8` from `cran_packages_by_date` as `registry_expansion`
