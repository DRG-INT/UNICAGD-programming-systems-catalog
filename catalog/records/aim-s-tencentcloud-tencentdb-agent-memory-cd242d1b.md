...
<!-- canonical: https://github.com/TencentCloud/TencentDB-Agent-Memory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) |
| Source record ids | github_search_aims-df5a37642cbffc |

## System Engineer Summary

TencentDB Agent Memory is a team-level memory hub for AI Agents — turning conversations, docs, and
code into four reusable memory assets (Chat Memory, Skill, LLM-Wiki, Code-Graph) that are governed,
shared, and equipped across agents and frameworks.

## Operational Role

For a systems engineer, TencentCloud/TencentDB-Agent-Memory belongs in the "aim's" inventory as part
...
- `github_search_aims-df5a37642cbffc` from `github_search_aims` as `registry_expansion`
