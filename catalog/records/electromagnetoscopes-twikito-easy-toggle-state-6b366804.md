...
<!-- canonical: https://github.com/Twikito/easy-toggle-state -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Twikito/easy-toggle-state](https://github.com/Twikito/easy-toggle-state) |
| Source record ids | github_search_electromagnetoscopes-7e66ae131eb9f0 |

## System Engineer Summary

A tiny JavaScript library to easily toggle the state of any HTML element in any contexts, and create
UI components in no time.

## Operational Role

For a systems engineer, Twikito/easy-toggle-state belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-26T04:21:29Z | gh search repos topic:radio stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-7e66ae131eb9f0` from `github_search_electromagnetoscopes` as `registry_expansion`
