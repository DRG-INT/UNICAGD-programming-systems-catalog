...
<!-- canonical: https://cran.r-project.org/web/packages/koopman.dmd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/koopman.dmd/index.html](https://cran.r-project.org/web/packages/koopman.dmd/index.html) |
| Source record ids | cran_packages_by_date-c233aa59860482 |
...
For a systems engineer, koopman.dmd belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-14 15:20:02 UTC | [https://cran.r-project.org/web/packages/koopman.dmd/DESCRIPTION](https://cran.r-project.org/web/packages/koopman.dmd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/koopman.dmd/DESCRIPTION` at `2026-09-14T16:20:36+00:00`.
...
- `cran_packages_by_date-c233aa59860482` from `cran_packages_by_date` as `registry_expansion`
