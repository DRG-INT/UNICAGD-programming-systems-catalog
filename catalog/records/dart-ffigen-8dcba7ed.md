...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Compiler](../by-category/compiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/ffigen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/ffigen](https://pub.dev/packages/ffigen) |
| Source record ids | pub_dev-869725fa238db2 |
...
For a systems engineer, ffigen belongs in the Dart inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 21.0.0 | 2026-07-27T01:12:02.861886Z | [https://pub.dev/api/packages/ffigen](https://pub.dev/api/packages/ffigen) |  |
| preview | known | 21.0.0-dev.0 | 2026-04-24T09:20:53.193057Z | [https://pub.dev/api/packages/ffigen](https://pub.dev/api/packages/ffigen) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/ffigen` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-869725fa238db2` from `pub_dev` as `registry_expansion`
