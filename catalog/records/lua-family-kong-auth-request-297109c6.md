...
| Canonical URL | [https://luarocks.org/modules/ascho/kong-auth-request](https://luarocks.org/modules/ascho/kong-auth-request) |
| Source record ids | luarocks_root_manifest-4ed8ae1f935312 |

## System Engineer Summary

A Kong plugin that make GET auth request before proxying the original.

## Operational Role

For a systems engineer, kong-auth-request belongs in the Lua family inventory as part of build graph
...
- `luarocks_root_manifest-4ed8ae1f935312` from `luarocks_root_manifest` as `registry_expansion`
