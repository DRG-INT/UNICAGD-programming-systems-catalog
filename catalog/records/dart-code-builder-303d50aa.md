...
<!-- canonical: https://pub.dev/packages/code_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/code_builder](https://pub.dev/packages/code_builder) |
| Source record ids | pub_dev-df5c81eeb56de2 |
...
For a systems engineer, code_builder belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.12.0 | 2026-08-28T20:42:19.300883Z | [https://pub.dev/api/packages/code_builder](https://pub.dev/api/packages/code_builder) |  |
| preview | known | 3.0.0-alpha | 2017-12-22T20:21:47.613324Z | [https://pub.dev/api/packages/code_builder](https://pub.dev/api/packages/code_builder) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/code_builder` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-df5c81eeb56de2` from `pub_dev` as `registry_expansion`
