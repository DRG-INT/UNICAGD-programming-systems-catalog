...
| Canonical URL | [https://crates.io/crates/skrifa](https://crates.io/crates/skrifa) |
| Source record ids | crates_io-c9241f6f5d4dea |
...
For a systems engineer, skrifa belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.46.2 | 2026-08-21T18:27:48.039640Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-c9241f6f5d4dea` from `crates_io` as `registry_expansion`
