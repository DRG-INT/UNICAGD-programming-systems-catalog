...
| Canonical URL | [https://luarocks.org/modules/mykaarma/kong-kafka-custom-log](https://luarocks.org/modules/mykaarma/kong-kafka-custom-log) |
| Source record ids | luarocks_root_manifest-69d988ab9fb714 |

## System Engineer Summary

kong-kafka-custom-log is a custom plugin made at MyKaarma to publish custom logs to Apache Kafka

## Operational Role

For a systems engineer, kong-kafka-custom-log belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-69d988ab9fb714` from `luarocks_root_manifest` as `registry_expansion`
