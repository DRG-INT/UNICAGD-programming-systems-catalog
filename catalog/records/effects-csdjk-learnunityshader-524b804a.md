...
<!-- canonical: https://github.com/csdjk/LearnUnityShader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/csdjk/LearnUnityShader](https://github.com/csdjk/LearnUnityShader) |
| Source record ids | github_search_effects-4d7a34f5ea398d |
...
For a systems engineer, csdjk/LearnUnityShader belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-10T02:51:21Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-4d7a34f5ea398d` from `github_search_effects` as `registry_expansion`
