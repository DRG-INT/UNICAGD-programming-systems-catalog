...
<!-- canonical: https://packagist.org/packages/laravel-doctrine/orm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laravel-doctrine/orm](https://packagist.org/packages/laravel-doctrine/orm) |
| Source record ids | packagist_search-70722ae6c786fc |
...
For a systems engineer, laravel-doctrine/orm belongs in the PHP inventory as part of state
...
- `packagist_search-70722ae6c786fc` from `packagist_search` as `registry_expansion`
