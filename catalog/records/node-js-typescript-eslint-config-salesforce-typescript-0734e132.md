...
<!-- canonical: https://www.npmjs.com/package/eslint-config-salesforce-typescript -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/eslint-config-salesforce-typescript](https://www.npmjs.com/package/eslint-config-salesforce-typescript) |
| Source record ids | npm_registry-0851a7182b9d64 |

## System Engineer Summary

The eslint flat config for Salesforce typescript projects

## Operational Role

For a systems engineer, eslint-config-salesforce-typescript belongs in the Node.js/TypeScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.0.0 | 2026-08-24T15:18:02.461Z | [https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=typescript&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-0851a7182b9d64` from `npm_registry` as `registry_expansion`
