...
<!-- canonical: https://cran.r-project.org/web/packages/ldsep/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ldsep/index.html](https://cran.r-project.org/web/packages/ldsep/index.html) |
| Source record ids | cran_packages_by_date-e8d56f215df730 |
...
For a systems engineer, ldsep belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.7 | 2026-09-09 20:40:02 UTC | [https://cran.r-project.org/web/packages/ldsep/DESCRIPTION](https://cran.r-project.org/web/packages/ldsep/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ldsep/DESCRIPTION` at `2026-09-09T22:18:43+00:00`.
...
- `cran_packages_by_date-e8d56f215df730` from `cran_packages_by_date` as `registry_expansion`
