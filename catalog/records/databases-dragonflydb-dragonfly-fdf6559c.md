...
<!-- canonical: https://github.com/dragonflydb/dragonfly -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dragonflydb/dragonfly](https://github.com/dragonflydb/dragonfly) |
| Source record ids | github_search_databases-30ca9f991bed8f |
...
For a systems engineer, dragonflydb/dragonfly belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:23:34Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-30ca9f991bed8f` from `github_search_databases` as `registry_expansion`
