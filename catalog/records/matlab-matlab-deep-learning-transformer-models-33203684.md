...
| Canonical URL | [https://github.com/matlab-deep-learning/transformer-models](https://github.com/matlab-deep-learning/transformer-models) |
| Source record ids | github_search_matlab-bbd6882138ddb0 |
...
For a systems engineer, matlab-deep-learning/transformer-models belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | R2023a | 2023-07-25T09:04:48Z | [https://api.github.com/repos/matlab-deep-learning/transformer-models/releases/latest](https://api.github.com/repos/matlab-deep-learning/transformer-models/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/matlab-deep-learning/transformer-models/releases/latest` at `2026-09-01T07:24:11+00:00`.
...
- `github_search_matlab-bbd6882138ddb0` from `github_search_matlab` as `registry_expansion`
