...
<!-- canonical: https://hackage.haskell.org/package/lightstep-haskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/lightstep-haskell](https://hackage.haskell.org/package/lightstep-haskell) |
| Source record ids | hackage_top_downloads-288c2b75785ffd |
...
For a systems engineer, lightstep-haskell belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.4 | 2020-10-09T11:00:49Z | [https://hackage.haskell.org/package/lightstep-haskell](https://hackage.haskell.org/package/lightstep-haskell) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/lightstep-haskell` at `2026-09-12T00:29:24+00:00`.
...
- `hackage_top_downloads-288c2b75785ffd` from `hackage_top_downloads` as `registry_expansion`
