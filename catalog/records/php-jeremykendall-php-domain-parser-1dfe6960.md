...
<!-- canonical: https://packagist.org/packages/jeremykendall/php-domain-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jeremykendall/php-domain-parser](https://packagist.org/packages/jeremykendall/php-domain-parser) |
| Source record ids | packagist_search-239e944814fef9 |
...
For a systems engineer, jeremykendall/php-domain-parser belongs in the PHP inventory as part of
...
- `packagist_search-239e944814fef9` from `packagist_search` as `registry_expansion`
