...
| Canonical URL | [https://luarocks.org/modules/daelvn/grasp](https://luarocks.org/modules/daelvn/grasp) |
| Source record ids | luarocks_root_manifest-f640d7265a341e |

## System Engineer Summary

A wrapper around lsqlite3

## Operational Role

For a systems engineer, grasp belongs in the Lua family inventory as part of state persistence,
...
- `luarocks_root_manifest-f640d7265a341e` from `luarocks_root_manifest` as `registry_expansion`
