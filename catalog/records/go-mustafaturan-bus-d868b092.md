...
<!-- canonical: https://github.com/mustafaturan/bus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mustafaturan/bus](https://github.com/mustafaturan/bus) |
| Source record ids | github_search_go-a8e14e1ff871e9 |
...
For a systems engineer, mustafaturan/bus belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-14T03:59:03Z | gh search repos topic:go-library stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-a8e14e1ff871e9` from `github_search_go` as `registry_expansion`
