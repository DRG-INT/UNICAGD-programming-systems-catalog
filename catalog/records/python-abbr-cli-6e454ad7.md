...
<!-- canonical: https://pypi.org/project/abbr-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abbr-cli/](https://pypi.org/project/abbr-cli/) |
| Source record ids | pypi_simple-27aada3bfb5656 |
...
For a systems engineer, abbr-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2021-07-08T21:05:17.172740Z | [https://pypi.org/pypi/abbr-cli/json](https://pypi.org/pypi/abbr-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abbr-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-27aada3bfb5656` from `pypi_simple` as `registry_expansion`
