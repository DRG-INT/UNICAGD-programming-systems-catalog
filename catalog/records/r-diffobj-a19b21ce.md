...
<!-- canonical: https://cran.r-project.org/web/packages/diffobj/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/diffobj/index.html](https://cran.r-project.org/web/packages/diffobj/index.html) |
| Source record ids | cran_packages_by_date-faa9a08d569279 |

## System Engineer Summary

diffobj is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, diffobj belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.9 | 2026-09-11 21:00:16 UTC | [https://cran.r-project.org/web/packages/diffobj/DESCRIPTION](https://cran.r-project.org/web/packages/diffobj/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/diffobj/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-faa9a08d569279` from `cran_packages_by_date` as `registry_expansion`
