# LaboratoryOpticsBiosciences/FLUTE
...
| Canonical URL | [https://github.com/LaboratoryOpticsBiosciences/FLUTE](https://github.com/LaboratoryOpticsBiosciences/FLUTE) |
| Source record ids | github_search_microscopy-58c20ecf32be4d |

## System Engineer Summary

Fluorescence Lifetime Ultimate Explorer (FLUTE) is a GUI for exploring and analyzing Fluorescence
Lifetime Microscopy (FLIM) data

## Operational Role

For a systems engineer, LaboratoryOpticsBiosciences/FLUTE belongs in the Microscopy inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.0 | 2023-09-26T09:24:08Z | [https://api.github.com/repos/LaboratoryOpticsBiosciences/FLUTE/releases/latest](https://api.github.com/repos/LaboratoryOpticsBiosciences/FLUTE/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/LaboratoryOpticsBiosciences/FLUTE/releases/latest` at `2026-09-01T08:26:19+00:00`.
...
- `github_search_microscopy-58c20ecf32be4d` from `github_search_microscopy` as `registry_expansion`
