...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ClassicalOrthogonalPolynomials](https://github.com/JuliaRegistries/General/tree/master/C/ClassicalOrthogonalPolynomials) |
| Source record ids | julia_general-54c7175cf8734f |

## System Engineer Summary

Julia package registered in General at C/ClassicalOrthogonalPolynomials.

## Operational Role

For a systems engineer, ClassicalOrthogonalPolynomials belongs in the Julia inventory as part of
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ClassicalOrthogonalPolynomials", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-54c7175cf8734f` from `julia_general` as `registry_expansion`
