...
| Source record ids | github_search_swift-312b6a27290921 |
...
For a systems engineer, ReactiveX/RxSwift belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T09:20:08Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-312b6a27290921` from `github_search_swift` as `registry_expansion`
