...
<!-- canonical: https://github.com/rern/rAudio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rern/rAudio](https://github.com/rern/rAudio) |
| Source record ids | github_search_effects-1d9847197155f9 |

## System Engineer Summary

Raspberry Pi audio player: AirPlay, Audio CD, Bluetooth, DAB radio, DSP, Internet radio, Multi-room,
Spotify Connect, UPnP/DLNA

## Operational Role

For a systems engineer, rern/rAudio belongs in the Effects inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T08:45:03Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-1d9847197155f9` from `github_search_effects` as `registry_expansion`
