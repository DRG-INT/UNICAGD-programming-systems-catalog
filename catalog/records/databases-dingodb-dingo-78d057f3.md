...
<!-- canonical: https://github.com/dingodb/dingo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dingodb/dingo](https://github.com/dingodb/dingo) |
| Source record ids | github_search_databases-8b89843f59cda8 |

## System Engineer Summary

A multi-modal vector database that supports upserts and vector queries using unified SQL (MySQL-
Compatible) on structured and unstructured data, while meeting the requirements of high concurrency
and ultra-low latency.

## Operational Role

For a systems engineer, dingodb/dingo belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-10T11:13:29Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | ISC License; https://api.github.com/licenses/isc; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-8b89843f59cda8` from `github_search_databases` as `registry_expansion`
