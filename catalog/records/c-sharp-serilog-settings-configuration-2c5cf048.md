...
<!-- canonical: https://www.nuget.org/packages/Serilog.Settings.Configuration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Serilog.Settings.Configuration](https://www.nuget.org/packages/Serilog.Settings.Configuration) |
| Source record ids | nuget_search-9790b34bcf27cd |
...
For a systems engineer, Serilog.Settings.Configuration belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.0.1 | 2026-06-15T06:44:54.293+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.settings.configuration/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.settings.configuration/index.json) |  |
| preview | known | 10.0.1-dev-02351 | 2026-05-26T22:00:56.18+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/serilog.settings.configuration/index.json](https://api.nuget.org/v3/registration5-gz-semver2/serilog.settings.configuration/index.json) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/Serilog.Settings.Configuration/10.0.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/serilog.settings.configuration/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-9790b34bcf27cd` from `nuget_search` as `registry_expansion`
