...
<!-- canonical: https://github.com/VipaiLab/Signals-and-Systems-course -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VipaiLab/Signals-and-Systems-course](https://github.com/VipaiLab/Signals-and-Systems-course) |
| Source record ids | github_search_matlab-0dd409246064fe |

## System Engineer Summary

VipaiLab/Signals-and-Systems-course is tracked as a language specification record in the Matlab
...
For a systems engineer, VipaiLab/Signals-and-Systems-course belongs in the Matlab inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-16T04:20:49Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-0dd409246064fe` from `github_search_matlab` as `registry_expansion`
