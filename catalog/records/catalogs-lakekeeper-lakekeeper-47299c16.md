...
<!-- canonical: https://github.com/lakekeeper/lakekeeper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lakekeeper/lakekeeper](https://github.com/lakekeeper/lakekeeper) |
| Source record ids | github_search_catalogs-2c1b1fd8540b7c |

## System Engineer Summary

Apache Iceberg REST Catalog in Rust — access control, credential vending and audit for every engine
and AI agent. Apache 2.0.

## Operational Role

For a systems engineer, lakekeeper/lakekeeper belongs in the Catalogs inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T22:52:17Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-2c1b1fd8540b7c` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| GoogleCloudPlatform/bigquery-data-lineage | Security Sast | [open](catalogs-googlecloudplatform-bigquery-data-lineage-32b670fd.md) |
