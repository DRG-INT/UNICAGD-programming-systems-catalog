...
<!-- canonical: https://luarocks.org/modules/imring/dislua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/imring/dislua](https://luarocks.org/modules/imring/dislua) |
| Source record ids | luarocks_root_manifest-5521fc387eb455 |

## System Engineer Summary

LuaJIT 2.1 Bytecode Parser

## Operational Role

For a systems engineer, DisLua belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5521fc387eb455` from `luarocks_root_manifest` as `registry_expansion`
