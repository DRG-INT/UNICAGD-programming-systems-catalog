...
| Canonical URL | [https://github.com/swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) |
| Source record ids | curated_language_routes-d42c2f04e2c972 |

## System Engineer Summary

OpenAPI editing and validation tool for API design workflows.

## Operational Role

For a systems engineer, Swagger Editor belongs in the APIs inventory as part of ecosystem capability
...
- `curated_language_routes-d42c2f04e2c972` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Stoplight | Api Doc Generator | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/apis-stoplight-4b1ad415.md) |
