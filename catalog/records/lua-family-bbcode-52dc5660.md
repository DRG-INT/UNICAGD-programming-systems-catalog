...
<!-- canonical: https://luarocks.org/modules/karai17/bbcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/karai17/bbcode](https://luarocks.org/modules/karai17/bbcode) |
| Source record ids | luarocks_root_manifest-a747a9827accf3 |

## System Engineer Summary

BBCode is tracked as a parser lexer ast record in the Lua family branch. The source did not provide
...
For a systems engineer, BBCode belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-a747a9827accf3` from `luarocks_root_manifest` as `registry_expansion`
