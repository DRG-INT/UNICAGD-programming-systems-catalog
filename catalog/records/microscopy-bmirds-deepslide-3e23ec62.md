...
<!-- canonical: https://github.com/BMIRDS/deepslide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BMIRDS/deepslide](https://github.com/BMIRDS/deepslide) |
| Source record ids | github_search_microscopy-b1a74003284e71 |

## System Engineer Summary

Code for the Nature Scientific Reports paper "Pathologist-level classification of histologic
patterns on resected lung adenocarcinoma slides with deep neural networks." A sliding window
framework for classification of high resolution whole-slide images, often microscopy or
histopathology images.

## Operational Role

For a systems engineer, BMIRDS/deepslide belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-07T15:22:44Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-b1a74003284e71` from `github_search_microscopy` as `registry_expansion`
