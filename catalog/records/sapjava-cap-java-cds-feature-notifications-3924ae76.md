# cap-java/cds-feature-notifications
...
<!-- canonical: https://github.com/cap-java/cds-feature-notifications -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cap-java/cds-feature-notifications](https://github.com/cap-java/cds-feature-notifications) |
| Source record ids | github_search_sapjava-da78efc4d79383 |

## System Engineer Summary

A CAP Java plugin that integrates SAP Alert Notification service (ANS) with the SAP Cloud
Application Programming Model (CAP) for sending business notifications.

## Operational Role

For a systems engineer, cap-java/cds-feature-notifications belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2-alpha | 2026-08-25T16:05:45Z | [https://api.github.com/repos/cap-java/cds-feature-notifications/releases/latest](https://api.github.com/repos/cap-java/cds-feature-notifications/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cap-java/cds-feature-notifications/releases/latest` at `2026-09-01T10:25:33+00:00`.
...
- `github_search_sapjava-da78efc4d79383` from `github_search_sapjava` as `registry_expansion`
