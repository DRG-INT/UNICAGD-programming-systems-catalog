...
<!-- canonical: https://github.com/IBM-Cloud/sap-netweaver-java-hana -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IBM-Cloud/sap-netweaver-java-hana](https://github.com/IBM-Cloud/sap-netweaver-java-hana) |
| Source record ids | github_search_sapjava-6305e975b9e638 |

## System Engineer Summary

Automating SAP NetWeaver 7.x and SAP HANA 3-tier distributed architecture on IBM Cloud® VPC with
Terraform and Ansible

## Operational Role

For a systems engineer, IBM-Cloud/sap-netweaver-java-hana belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-12T09:45:20Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-6305e975b9e638` from `github_search_sapjava` as `registry_expansion`
