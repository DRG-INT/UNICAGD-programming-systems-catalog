...
<!-- canonical: https://github.com/christopherkarani/Wax -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/christopherkarani/Wax](https://github.com/christopherkarani/Wax) |
| Source record ids | github_search_databases-14ca72a713f4ef |

## System Engineer Summary

Shared Single-file memory layer for all your agents, sub mili-second RAG over text, photo and video
on Apple Silicon.. No Server. No API. One File. Pure Swift

## Operational Role

For a systems engineer, christopherkarani/Wax belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T00:18:30Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-14ca72a713f4ef` from `github_search_databases` as `registry_expansion`
