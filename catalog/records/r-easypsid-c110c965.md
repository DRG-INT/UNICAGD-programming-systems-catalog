...
<!-- canonical: https://cran.r-project.org/web/packages/easyPSID/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/easyPSID/index.html](https://cran.r-project.org/web/packages/easyPSID/index.html) |
| Source record ids | cran_packages_by_date-67ee7d64457a4b |
...
For a systems engineer, easyPSID belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-04 17:30:07 UTC | [https://cran.r-project.org/web/packages/easyPSID/DESCRIPTION](https://cran.r-project.org/web/packages/easyPSID/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/easyPSID/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-67ee7d64457a4b` from `cran_packages_by_date` as `registry_expansion`
