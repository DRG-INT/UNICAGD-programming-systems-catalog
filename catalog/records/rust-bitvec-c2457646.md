...
<!-- canonical: https://crates.io/crates/bitvec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bitvec](https://crates.io/crates/bitvec) |
| Source record ids | crates_io-78de4bf6e06a5a |
...
For a systems engineer, bitvec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-06-18T19:47:24.730968Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-78de4bf6e06a5a` from `crates_io` as `registry_expansion`
