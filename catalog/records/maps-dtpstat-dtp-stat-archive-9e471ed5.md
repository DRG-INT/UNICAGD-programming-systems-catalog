...
<!-- canonical: https://github.com/dtpstat/dtp-stat-archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dtpstat/dtp-stat-archive](https://github.com/dtpstat/dtp-stat-archive) |
| Source record ids | github_search_maps-3da48d65e4c6b6 |

## System Engineer Summary

Карта ДТП v1.0. 👉 База знаний о проекте:

## Operational Role

For a systems engineer, dtpstat/dtp-stat-archive belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-13T10:29:14Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License (>= 2); GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_maps-3da48d65e4c6b6` from `github_search_maps` as `registry_expansion`
