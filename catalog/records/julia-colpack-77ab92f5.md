...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ColPack](https://github.com/JuliaRegistries/General/tree/master/C/ColPack) |
| Source record ids | julia_general-f6912b7604fc99 |

## System Engineer Summary

Julia package registered in General at C/ColPack.

## Operational Role

For a systems engineer, ColPack belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ColPack", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-f6912b7604fc99` from `julia_general` as `registry_expansion`
