...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Databases](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/databases.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://help.libreoffice.org/latest/en-US/text/swriter/guide/table_insert.html](https://help.libreoffice.org/latest/en-US/text/swriter/guide/table_insert.html) |
| Source record ids | curated_database_systems-2994e8035601ca |

## System Engineer Summary

Document table model and editing surface used for structured data in word-processing documents.

## Operational Role

For a systems engineer, LibreOffice Writer tables belongs in the Databases inventory as part of
...
- `curated_database_systems-2994e8035601ca` from `curated_database_systems` as `registry_expansion`
