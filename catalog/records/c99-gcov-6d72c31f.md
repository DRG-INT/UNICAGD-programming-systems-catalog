...
[Catalog index](../index.md) · [Language: C99](../by-language/c99.md) · [Category: Coverage](../by-category/coverage.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | master-6206af6e022f |

## System Engineer Summary

gcov is tracked as a coverage record in the C99 branch. The source did not provide a long
...
For a systems engineer, gcov belongs in the C99 inventory as part of ecosystem capability mapping,
...
- `master-6206af6e022f` from `master_json` as `coverage`
...
| Name | Category | Page |
| --- | --- | --- |
| lcov | Coverage | [open](c99-lcov-4af7aaaf.md) |
