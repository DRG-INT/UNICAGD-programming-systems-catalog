...
| Canonical URL | [https://luarocks.org/modules/safeline/ingress-nginx-safeline](https://luarocks.org/modules/safeline/ingress-nginx-safeline) |
| Source record ids | luarocks_root_manifest-181893425c7a9c |

## System Engineer Summary

Ingress-Nginx plugin for Chaitin SafeLine Web Application Firewall

## Operational Role

For a systems engineer, ingress-nginx-safeline belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-181893425c7a9c` from `luarocks_root_manifest` as `registry_expansion`
