...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/ergebnis/json-printer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ergebnis/json-printer](https://packagist.org/packages/ergebnis/json-printer) |
| Source record ids | packagist_search-f458e623f97da7 |
...
For a systems engineer, ergebnis/json-printer belongs in the PHP inventory as part of ecosystem
...
| Evidence | {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-06 | `{"kind": "packagist_search_and_p2_api", "query": "json", "retrieved": "2026-09-06", "status": "registry-derived"}` |
...
- `packagist_search-f458e623f97da7` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alcaeus/mongo-php-adapter | Ide Editor Integration | [open](php-alcaeus-mongo-php-adapter-ad0d4c6d.md) |
| aura/sql | Ide Editor Integration | [open](php-aura-sql-a7b4840d.md) |
| aura/sqlschema | Ide Editor Integration | [open](php-aura-sqlschema-5e7e6c07.md) |
| berlindb/core | Ide Editor Integration | [open](php-berlindb-core-b69b9ce2.md) |
| betterapp/laravel-db-encrypter | Ide Editor Integration | [open](php-betterapp-laravel-db-encrypter-20e043c7.md) |
| desarrolla2/cache | Ide Editor Integration | [open](php-desarrolla2-cache-914991d8.md) |
| doctrine/mongodb | Ide Editor Integration | [open](php-doctrine-mongodb-e4fd450a.md) |
| doctrine/mongodb-odm | Ide Editor Integration | [open](php-doctrine-mongodb-odm-6070bed1.md) |
