...
| Canonical URL | [https://luarocks.org/modules/junaga/hyprmorph](https://luarocks.org/modules/junaga/hyprmorph) |
| Source record ids | luarocks_root_manifest-61ddb1e3f83479 |

## System Engineer Summary

Convert legacy Hyprland .conf files to Hyprland Lua

## Operational Role

For a systems engineer, hyprmorph belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-61ddb1e3f83479` from `luarocks_root_manifest` as `registry_expansion`
