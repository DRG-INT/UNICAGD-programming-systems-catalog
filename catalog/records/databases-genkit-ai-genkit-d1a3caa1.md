...
<!-- canonical: https://github.com/genkit-ai/genkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/genkit-ai/genkit](https://github.com/genkit-ai/genkit) |
| Source record ids | github_search_databases-ec3ce8c71b40e7 |

## System Engineer Summary

Open-source framework for building agentic apps in JavaScript, Go, Dart, and Python, built and used
in production by Google

## Operational Role

For a systems engineer, genkit-ai/genkit belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T09:36:48Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ec3ce8c71b40e7` from `github_search_databases` as `registry_expansion`
...
| neuron-core/neuron-ai | Build System | [open](databases-neuron-core-neuron-ai-5499172a.md) |
| Open-Source-Legal/OpenContracts | Build System | [open](databases-open-source-legal-opencontracts-4d09da5d.md) |
| PAF | Build System | [open](databases-paf-21357df7.md) |
| plastic-labs/honcho | Build System | [open](databases-plastic-labs-honcho-ddaa1a7f.md) |
