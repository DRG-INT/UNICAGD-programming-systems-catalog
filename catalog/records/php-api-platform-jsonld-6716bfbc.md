...
| Canonical URL | [https://packagist.org/packages/api-platform/jsonld](https://packagist.org/packages/api-platform/jsonld) |
| Source record ids | packagist_search-2dd78f140ae431 |

## System Engineer Summary

api-platform/jsonld is tracked as a serialization record in the PHP branch. The source did not
...
For a systems engineer, api-platform/jsonld belongs in the PHP inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v4.3.17 | 2026-07-12T06:11:49+00:00 | [https://repo.packagist.org/p2/api-platform/jsonld.json](https://repo.packagist.org/p2/api-platform/jsonld.json) |  |
| preview | known | v5.0.0-alpha.2 | 2026-07-12T13:20:26+00:00 | [https://repo.packagist.org/p2/api-platform/jsonld.json](https://repo.packagist.org/p2/api-platform/jsonld.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/api-platform/jsonld.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-2dd78f140ae431` from `packagist_search` as `registry_expansion`
