...
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Http.Abstractions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Http.Abstractions](https://www.nuget.org/packages/Volo.Abp.Http.Abstractions) |
| Source record ids | nuget_search-38bfc2848ce538 |

## System Engineer Summary

Volo.Abp.Http.Abstractions is tracked as a project scaffolding record in the C-Sharp branch. The
...
For a systems engineer, Volo.Abp.Http.Abstractions belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:00.447+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.abstractions/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:19.803+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.abstractions/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.abstractions/index.json) |  |
...
| Evidence | {"key": "", "name": "", "url": ""}; LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Http.Abstractions/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http.abstractions/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-38bfc2848ce538` from `nuget_search` as `registry_expansion`
