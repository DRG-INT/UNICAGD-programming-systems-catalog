...
<!-- canonical: https://github.com/ankitdhall/lidar_camera_calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ankitdhall/lidar_camera_calibration](https://github.com/ankitdhall/lidar_camera_calibration) |
| Source record ids | github_search_photography-1750f84506f9be |

## System Engineer Summary

ROS package to find a rigid-body transformation between a LiDAR and a camera for "LiDAR-Camera
Calibration using 3D-3D Point correspondences"

## Operational Role

For a systems engineer, ankitdhall/lidar_camera_calibration belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-16T18:17:31Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-1750f84506f9be` from `github_search_photography` as `registry_expansion`
