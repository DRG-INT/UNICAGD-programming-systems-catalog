...
<!-- canonical: https://pypi.org/project/abcd-divami-testing/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abcd-divami-testing/](https://pypi.org/project/abcd-divami-testing/) |
| Source record ids | pypi_simple-8df05a67c2d838 |
...
For a systems engineer, abcd-divami-testing belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2025-09-08T15:08:25.295094Z | [https://pypi.org/pypi/abcd-divami-testing/json](https://pypi.org/pypi/abcd-divami-testing/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abcd-divami-testing/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-8df05a67c2d838` from `pypi_simple` as `registry_expansion`
