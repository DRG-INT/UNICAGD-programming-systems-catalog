...
<!-- canonical: https://github.com/WebAssembly/threads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/threads](https://github.com/WebAssembly/threads) |
| Source record ids | github_search_webassembly-f4b359b64b163c |
...
For a systems engineer, WebAssembly/threads belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T18:56:32Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-f4b359b64b163c` from `github_search_webassembly` as `registry_expansion`
