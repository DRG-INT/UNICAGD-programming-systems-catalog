...
<!-- canonical: https://luarocks.org/modules/perkovec/colorise -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/perkovec/colorise](https://luarocks.org/modules/perkovec/colorise) |
| Source record ids | luarocks_root_manifest-35732b3baea1f3 |
...
For a systems engineer, Colorise belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-35732b3baea1f3` from `luarocks_root_manifest` as `registry_expansion`
