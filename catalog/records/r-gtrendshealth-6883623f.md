...
<!-- canonical: https://cran.r-project.org/web/packages/gtrendshealth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gtrendshealth/index.html](https://cran.r-project.org/web/packages/gtrendshealth/index.html) |
| Source record ids | cran_packages_by_date-7ba5bafd559119 |
...
For a systems engineer, gtrendshealth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-19 22:00:09 UTC | [https://cran.r-project.org/web/packages/gtrendshealth/DESCRIPTION](https://cran.r-project.org/web/packages/gtrendshealth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gtrendshealth/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7ba5bafd559119` from `cran_packages_by_date` as `registry_expansion`
