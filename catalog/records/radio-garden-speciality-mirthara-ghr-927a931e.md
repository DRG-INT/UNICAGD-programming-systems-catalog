...
<!-- canonical: https://github.com/MirThara/GHR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MirThara/GHR](https://github.com/MirThara/GHR) |
| Source record ids | github_search_radio_garden_speciality-2a01984d1b5544 |

## System Engineer Summary

Garden Heights Radio show English project MCG Dresden

## Operational Role

For a systems engineer, MirThara/GHR belongs in the Radio Garden Speciality inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-05T13:50:53Z | gh search repos "radio.garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-2a01984d1b5544` from `github_search_radio_garden_speciality` as `registry_expansion`
