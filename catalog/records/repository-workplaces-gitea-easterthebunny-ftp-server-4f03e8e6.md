# Gitea: EasterTheBunny/ftp_server
...
<!-- canonical: https://gitea.com/EasterTheBunny/ftp_server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/EasterTheBunny/ftp_server](https://gitea.com/EasterTheBunny/ftp_server) |
| Source record ids | gitea_repositories_api-42bcf4d07cd1be |
...
For a systems engineer, Gitea: EasterTheBunny/ftp_server belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-23T16:28:56Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-42bcf4d07cd1be` from `gitea_repositories_api` as `registry_expansion`
