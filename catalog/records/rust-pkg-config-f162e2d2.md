...
<!-- canonical: https://crates.io/crates/pkg-config -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pkg-config](https://crates.io/crates/pkg-config) |
| Source record ids | crates_io-afd2d6324b2a4f |

## System Engineer Summary

A library to run the pkg-config system tool at build time in order to be used in Cargo build
scripts.

## Operational Role

For a systems engineer, pkg-config belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-14T08:27:51.724149Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Connections.Client/10.0.11/license |
...
- `crates_io-afd2d6324b2a4f` from `crates_io` as `registry_expansion`
