...
<!-- canonical: https://luarocks.org/modules/lalawue/ffi-http1-session -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lalawue/ffi-http1-session](https://luarocks.org/modules/lalawue/ffi-http1-session) |
| Source record ids | luarocks_root_manifest-b64b62bae7228d |

## System Engineer Summary

ffi-http1-session is tracked as a ffi bindings record in the Lua family branch. The source did not
...
For a systems engineer, ffi-http1-session belongs in the Lua family inventory as part of cross-
