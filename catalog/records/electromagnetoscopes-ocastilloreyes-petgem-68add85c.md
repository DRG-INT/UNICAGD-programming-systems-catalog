...
<!-- canonical: https://github.com/ocastilloreyes/petgem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ocastilloreyes/petgem](https://github.com/ocastilloreyes/petgem) |
| Source record ids | github_search_electromagnetoscopes-b54553146ac9e3 |

## System Engineer Summary

petgem is a parallel and high-order code for active-source (e.g. CSEM) and passive-source (e.g. MT)
geophysics electromagnetic modeling in 3D arbitrary marine/land problems under anisotropic
conductivities.

## Operational Role

For a systems engineer, ocastilloreyes/petgem belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-30T08:00:28Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `github_search_electromagnetoscopes-b54553146ac9e3` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| pagermon/pagermon | Parser Lexer Ast | [open](electromagnetoscopes-pagermon-pagermon-283e38a1.md) |
