...
<!-- canonical: https://hackage.haskell.org/package/pipes-bytestring -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pipes-bytestring](https://hackage.haskell.org/package/pipes-bytestring) |
| Source record ids | hackage_top_downloads-8479a116d25672 |
...
For a systems engineer, pipes-bytestring belongs in the Haskell inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.7 | 2021-02-12T21:37:43Z | [https://hackage.haskell.org/package/pipes-bytestring](https://hackage.haskell.org/package/pipes-bytestring) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pipes-bytestring` at `2026-09-01T14:24:26+00:00`.
...
- `hackage_top_downloads-8479a116d25672` from `hackage_top_downloads` as `registry_expansion`
