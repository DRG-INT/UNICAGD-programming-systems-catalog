...
<!-- canonical: https://pub.dev/packages/adaptive_platform_ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/adaptive_platform_ui](https://pub.dev/packages/adaptive_platform_ui) |
| Source record ids | pub_dev-01df32d68738cc |

## System Engineer Summary

Adaptive platform-specific widgets for Flutter. Auto renders native iOS 26+ liquid glass designs,
traditional Cupertino widgets for older iOS versions, Material Design for Android.

## Operational Role

For a systems engineer, adaptive_platform_ui belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.111 | 2026-07-25T17:26:59.216252Z | [https://pub.dev/api/packages/adaptive_platform_ui](https://pub.dev/api/packages/adaptive_platform_ui) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/adaptive_platform_ui` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-01df32d68738cc` from `pub_dev` as `registry_expansion`
...
| audio_session | Filesystem Os | [open](dart-audio-session-d63e9aca.md) |
