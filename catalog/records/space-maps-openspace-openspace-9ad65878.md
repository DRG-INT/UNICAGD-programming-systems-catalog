...
<!-- canonical: https://github.com/OpenSpace/OpenSpace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenSpace/OpenSpace](https://github.com/OpenSpace/OpenSpace) |
| Source record ids | github_search_space_maps-228df4e9b99871 |

## System Engineer Summary

This is the official GitHub repository for OpenSpace: an open source astrovisualization project. For
instructions on how to build and run OpenSpace, see the Getting Started Guides on the wiki page at

## Operational Role

For a systems engineer, OpenSpace/OpenSpace belongs in the Space Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:25:47Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-228df4e9b99871` from `github_search_space_maps` as `registry_expansion`
