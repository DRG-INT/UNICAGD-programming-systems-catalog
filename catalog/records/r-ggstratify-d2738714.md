...
<!-- canonical: https://cran.r-project.org/web/packages/ggstratify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggstratify/index.html](https://cran.r-project.org/web/packages/ggstratify/index.html) |
| Source record ids | cran_packages_by_date-1ba34e2fd46681 |
...
For a systems engineer, ggstratify belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-09-02 11:40:02 UTC | [https://cran.r-project.org/web/packages/ggstratify/DESCRIPTION](https://cran.r-project.org/web/packages/ggstratify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggstratify/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-1ba34e2fd46681` from `cran_packages_by_date` as `registry_expansion`
