...
| Canonical URL | [https://luarocks.org/modules/jiladahe1997/kong-path-rewrite](https://luarocks.org/modules/jiladahe1997/kong-path-rewrite) |
| Source record ids | luarocks_root_manifest-9b3f08a96c8f47 |

## System Engineer Summary

Kong-Path-Rewrite is tracked as a filesystem os record in the Lua family branch. The source did not
...
For a systems engineer, Kong-Path-Rewrite belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-9b3f08a96c8f47` from `luarocks_root_manifest` as `registry_expansion`
