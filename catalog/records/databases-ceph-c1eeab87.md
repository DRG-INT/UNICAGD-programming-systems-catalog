...
<!-- canonical: https://github.com/ceph/ceph -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ceph/ceph](https://github.com/ceph/ceph) |
| Source record ids | curated_database_systems-ed763290a4cf8c |
...
For a systems engineer, Ceph belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-ed763290a4cf8c` from `curated_database_systems` as `registry_expansion`
