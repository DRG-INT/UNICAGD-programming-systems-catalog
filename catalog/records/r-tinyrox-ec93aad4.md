...
[Catalog index](../index.md) · [Language: R](../by-language/r.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://cran.r-project.org/web/packages/tinyrox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tinyrox/index.html](https://cran.r-project.org/web/packages/tinyrox/index.html) |
| Source record ids | cran_packages_by_date-badeee2f141267 |
...
For a systems engineer, tinyrox belongs in the R inventory as part of operator onboarding, API
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-04 22:50:02 UTC | [https://cran.r-project.org/web/packages/tinyrox/DESCRIPTION](https://cran.r-project.org/web/packages/tinyrox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tinyrox/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-badeee2f141267` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| roxygen2 | Documentation | [open](r-roxygen2-b14889a4.md) |
| tinyroxygen | Documentation | [open](r-tinyroxygen-f1b543dc.md) |
| xmpdf | Documentation | [open](r-xmpdf-9b9f2b98.md) |
