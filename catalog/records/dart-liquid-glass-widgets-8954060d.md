...
<!-- canonical: https://pub.dev/packages/liquid_glass_widgets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/liquid_glass_widgets](https://pub.dev/packages/liquid_glass_widgets) |
| Source record ids | pub_dev-95f109f1bd7138 |

## System Engineer Summary

iOS 26-style liquid glass widgets for Flutter. Built on a custom fragment shader for real blur,
liquid interactions, specular highlights, and chromatic aberration.

## Operational Role

For a systems engineer, liquid_glass_widgets belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-09-04T02:59:04.800603Z | [https://pub.dev/api/packages/liquid_glass_widgets](https://pub.dev/api/packages/liquid_glass_widgets) |  |
| preview | known | 0.4.1-dev.2 | 2026-03-27T06:11:43.935633Z | [https://pub.dev/api/packages/liquid_glass_widgets](https://pub.dev/api/packages/liquid_glass_widgets) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/liquid_glass_widgets` at `2026-09-04T03:19:46+00:00`.
...
- `pub_dev-95f109f1bd7138` from `pub_dev` as `registry_expansion`
