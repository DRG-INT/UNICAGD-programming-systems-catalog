...
<!-- canonical: https://forge.rust-lang.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://forge.rust-lang.org/](https://forge.rust-lang.org/) |
| Source record ids | curated_repository_workplace_routes-110662ee4f4e5c |

## System Engineer Summary

Official Rust project forge documentation for release, infrastructure, CI, team, and repository
workflows.

## Operational Role

For a systems engineer, Rust Forge belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-110662ee4f4e5c` from `curated_repository_workplace_routes` as `registry_expansion`
