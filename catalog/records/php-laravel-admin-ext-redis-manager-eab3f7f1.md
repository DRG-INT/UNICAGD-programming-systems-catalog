...
<!-- canonical: https://packagist.org/packages/laravel-admin-ext/redis-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laravel-admin-ext/redis-manager](https://packagist.org/packages/laravel-admin-ext/redis-manager) |
| Source record ids | packagist_search-1c91e4ace8d98e |
...
For a systems engineer, laravel-admin-ext/redis-manager belongs in the PHP inventory as part of
...
- `packagist_search-1c91e4ace8d98e` from `packagist_search` as `registry_expansion`
