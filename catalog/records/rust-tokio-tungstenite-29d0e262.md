...
<!-- canonical: https://crates.io/crates/tokio-tungstenite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tokio-tungstenite](https://crates.io/crates/tokio-tungstenite) |
| Source record ids | crates_io-a0075c1b06d4c3 |
...
For a systems engineer, tokio-tungstenite belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.30.0 | 2026-07-11T12:58:44.438987Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- `crates_io-a0075c1b06d4c3` from `crates_io` as `registry_expansion`
