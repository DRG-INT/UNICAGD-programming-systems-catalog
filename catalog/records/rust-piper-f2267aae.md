...
<!-- canonical: https://crates.io/crates/piper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/piper](https://crates.io/crates/piper) |
| Source record ids | crates_io-4e2a58946eaf90 |
...
For a systems engineer, piper belongs in the Rust inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-02-28T06:00:20.764458Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
| Evidence | Apache License (>= 2); GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1 |
...
- `crates_io-4e2a58946eaf90` from `crates_io` as `registry_expansion`
