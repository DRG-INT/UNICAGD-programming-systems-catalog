...
<!-- canonical: https://crates.io/crates/zstd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zstd](https://crates.io/crates/zstd) |
| Source record ids | crates_io-32448e14e74696 |
...
For a systems engineer, zstd belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-09-04T19:02:35.959541Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-32448e14e74696` from `crates_io` as `registry_expansion`
