...
| Canonical URL | [https://github.com/bytecodealliance/wasmtime](https://github.com/bytecodealliance/wasmtime) |
| Source record ids | curated_language_routes-976b120510784a |

## System Engineer Summary

WebAssembly engine and runtime for component-model workloads, WASI, embedding, and sandboxed
execution.

## Operational Role

For a systems engineer, Wasmtime belongs in the Engines inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v48.0.1 | 2026-08-24T20:03:55Z | [https://api.github.com/repos/bytecodealliance/wasmtime/releases/latest](https://api.github.com/repos/bytecodealliance/wasmtime/releases/latest) |  |
| preview | known | dev | 2022-09-28T20:31:51Z | [https://api.github.com/repos/bytecodealliance/wasmtime/releases?per_page=10](https://api.github.com/repos/bytecodealliance/wasmtime/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bytecodealliance/wasmtime/releases/latest` at `2026-09-01T07:24:40+00:00`.
...
- `curated_language_routes-976b120510784a` from `curated_language_routes` as `registry_expansion`
