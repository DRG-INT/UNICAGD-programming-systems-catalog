...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Community Reference](../by-category/community-reference.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://wiki.nixos.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://wiki.nixos.org/](https://wiki.nixos.org/) |
| Source record ids | curated_language_routes-f703f53abb6655 |

## System Engineer Summary

Community documentation route for Nix, NixOS, Nixpkgs, modules, packaging, deployment, and
operations.

## Operational Role

For a systems engineer, NixOS Wiki belongs in the nix inventory as part of ecosystem capability
...
- `curated_language_routes-f703f53abb6655` from `curated_language_routes` as `registry_expansion`
