...
<!-- canonical: https://hackage.haskell.org/package/concurrency -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/concurrency](https://hackage.haskell.org/package/concurrency) |
| Source record ids | hackage_top_downloads-1591ff2de2f79a |
...
For a systems engineer, concurrency belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11.0.3 | 2023-06-17T22:24:12Z | [https://hackage.haskell.org/package/concurrency](https://hackage.haskell.org/package/concurrency) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/concurrency` at `2026-09-01T14:24:10+00:00`.
...
- `hackage_top_downloads-1591ff2de2f79a` from `hackage_top_downloads` as `registry_expansion`
