...
<!-- canonical: https://www.npmjs.com/package/@jmondi/oauth2-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@jmondi/oauth2-server](https://www.npmjs.com/package/@jmondi/oauth2-server) |
| Source record ids | npm_registry-f9200c841b0df9 |

## System Engineer Summary

@jmondi/oauth2-server is tracked as a package manager record in the Node.js/JavaScript branch. The
...
For a systems engineer, @jmondi/oauth2-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2026-08-21T02:28:44.131Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-f9200c841b0df9` from `npm_registry` as `registry_expansion`
