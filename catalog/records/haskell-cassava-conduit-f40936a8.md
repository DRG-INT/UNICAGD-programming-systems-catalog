...
<!-- canonical: https://hackage.haskell.org/package/cassava-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cassava-conduit](https://hackage.haskell.org/package/cassava-conduit) |
| Source record ids | hackage_top_downloads-fce88400162a28 |
...
For a systems engineer, cassava-conduit belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.6 | 2024-01-02T04:58:28Z | [https://hackage.haskell.org/package/cassava-conduit](https://hackage.haskell.org/package/cassava-conduit) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cassava-conduit` at `2026-09-08T00:34:31+00:00`.
...
- `hackage_top_downloads-fce88400162a28` from `hackage_top_downloads` as `registry_expansion`
...
| conduit-algorithms | Visualization Gui | [open](haskell-conduit-algorithms-71dc27f9.md) |
