...
<!-- canonical: https://cran.r-project.org/web/packages/RivRetrieve/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RivRetrieve/index.html](https://cran.r-project.org/web/packages/RivRetrieve/index.html) |
| Source record ids | cran_packages_by_date-cb3ca16d9bb5f2 |
...
For a systems engineer, RivRetrieve belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 19:10:02 UTC | [https://cran.r-project.org/web/packages/RivRetrieve/DESCRIPTION](https://cran.r-project.org/web/packages/RivRetrieve/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RivRetrieve/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cb3ca16d9bb5f2` from `cran_packages_by_date` as `registry_expansion`
