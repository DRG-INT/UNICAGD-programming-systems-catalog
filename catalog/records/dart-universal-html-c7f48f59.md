...
<!-- canonical: https://pub.dev/packages/universal_html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/universal_html](https://pub.dev/packages/universal_html) |
| Source record ids | pub_dev-d233cc6a1eb1e9 |

## System Engineer Summary

A 'dart:html' that works in all platforms, including Flutter and server-side. Eases cross-platform
development and HTML / XML processing.

## Operational Role

For a systems engineer, universal_html belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2025-11-16T22:50:23.829282Z | [https://pub.dev/api/packages/universal_html](https://pub.dev/api/packages/universal_html) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/universal_html` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-d233cc6a1eb1e9` from `pub_dev` as `registry_expansion`
