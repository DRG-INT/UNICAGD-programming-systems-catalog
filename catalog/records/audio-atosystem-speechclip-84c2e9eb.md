...
<!-- canonical: https://github.com/atosystem/SpeechCLIP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atosystem/SpeechCLIP](https://github.com/atosystem/SpeechCLIP) |
| Source record ids | github_search_audio-3d08dba9b67083 |
...
For a systems engineer, atosystem/SpeechCLIP belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-25T01:12:24Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-3d08dba9b67083` from `github_search_audio` as `registry_expansion`
