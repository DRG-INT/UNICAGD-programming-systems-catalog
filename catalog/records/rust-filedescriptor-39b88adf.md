...
| Canonical URL | [https://crates.io/crates/filedescriptor](https://crates.io/crates/filedescriptor) |
| Source record ids | crates_io-ac6d3d5fdb4afe |
...
For a systems engineer, filedescriptor belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.3 | 2025-02-11T04:19:27.530332Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- `crates_io-ac6d3d5fdb4afe` from `crates_io` as `registry_expansion`
