...
<!-- canonical: https://cran.r-project.org/web/packages/vcdExtra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/vcdExtra/index.html](https://cran.r-project.org/web/packages/vcdExtra/index.html) |
| Source record ids | cran_packages_by_date-2405055b601749 |
...
For a systems engineer, vcdExtra belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.8 | 2026-08-21 22:00:03 UTC | [https://cran.r-project.org/web/packages/vcdExtra/DESCRIPTION](https://cran.r-project.org/web/packages/vcdExtra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/vcdExtra/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-2405055b601749` from `cran_packages_by_date` as `registry_expansion`
