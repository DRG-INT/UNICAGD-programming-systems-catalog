...
<!-- canonical: https://pub.dev/packages/google_mobile_ads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/google_mobile_ads](https://pub.dev/packages/google_mobile_ads) |
| Source record ids | pub_dev-0c215b908b7014 |

## System Engineer Summary

Flutter plugin for Google Mobile Ads, supporting banner, interstitial (full-screen), rewarded and
native ads

## Operational Role

For a systems engineer, google_mobile_ads belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.1.0 | 2026-08-11T21:00:29.493224Z | [https://pub.dev/api/packages/google_mobile_ads](https://pub.dev/api/packages/google_mobile_ads) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/google_mobile_ads` at `2026-09-01T15:35:54+00:00`.
...
- `pub_dev-0c215b908b7014` from `pub_dev` as `registry_expansion`
