...
<!-- canonical: https://github.com/spring-petclinic/spring-petclinic-rest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spring-petclinic/spring-petclinic-rest](https://github.com/spring-petclinic/spring-petclinic-rest) |
| Source record ids | github_search_databases-7e3e7257309498 |
...
For a systems engineer, spring-petclinic/spring-petclinic-rest belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:13:39Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7e3e7257309498` from `github_search_databases` as `registry_expansion`
