...
<!-- canonical: https://luarocks.org/modules/tieske/copas-async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tieske/copas-async](https://luarocks.org/modules/tieske/copas-async) |
| Source record ids | luarocks_root_manifest-7113a3ff0c7779 |
...
For a systems engineer, Copas-Async belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-7113a3ff0c7779` from `luarocks_root_manifest` as `registry_expansion`
