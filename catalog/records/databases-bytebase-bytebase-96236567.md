...
<!-- canonical: https://github.com/bytebase/bytebase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytebase/bytebase](https://github.com/bytebase/bytebase) |
| Source record ids | github_search_databases-ba3570033bb63c |

## System Engineer Summary

Database governance built for humans and agents — controlling changes and access across every major
database.

## Operational Role

For a systems engineer, bytebase/bytebase belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T07:19:18Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ba3570033bb63c` from `github_search_databases` as `registry_expansion`
