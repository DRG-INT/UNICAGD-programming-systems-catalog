...
<!-- canonical: https://github.com/shreyesss/HDRSplat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shreyesss/HDRSplat](https://github.com/shreyesss/HDRSplat) |
| Source record ids | github_search_photography-d3be5eab7b1b44 |

## System Engineer Summary

Official Implementation of BMVC 2024 paper titled "HDRSplat: Gaussian Splatting for High Dynamic
Range 3D Scene Reconstruction from Raw Images"

## Operational Role

For a systems engineer, shreyesss/HDRSplat belongs in the Photography inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-10-16T16:33:44Z | gh search repos topic:raw-image stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-d3be5eab7b1b44` from `github_search_photography` as `registry_expansion`
