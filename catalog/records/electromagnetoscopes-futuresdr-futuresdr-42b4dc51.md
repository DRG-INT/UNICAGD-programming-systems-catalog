...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/FutureSDR/FutureSDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FutureSDR/FutureSDR](https://github.com/FutureSDR/FutureSDR) |
| Source record ids | github_search_electromagnetoscopes-3fd5d387b37bf4 |
...
For a systems engineer, FutureSDR/FutureSDR belongs in the Electromagnetoscopes inventory as part of
runtime behavior, deployment packaging, embedding, upgrade cadence, and compatibility validation.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-07T12:09:08Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-3fd5d387b37bf4` from `github_search_electromagnetoscopes` as `registry_expansion`
