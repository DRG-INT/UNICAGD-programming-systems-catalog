...
<!-- canonical: https://github.com/computational-cell-analytics/peft-sam -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/computational-cell-analytics/peft-sam](https://github.com/computational-cell-analytics/peft-sam) |
| Source record ids | github_search_microscopy-32523c00e87706 |
...
For a systems engineer, computational-cell-analytics/peft-sam belongs in the Microscopy inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-06T13:06:19Z | gh search repos topic:microscopy stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-32523c00e87706` from `github_search_microscopy` as `registry_expansion`
