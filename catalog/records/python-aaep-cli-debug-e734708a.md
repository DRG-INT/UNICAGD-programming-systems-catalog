...
<!-- canonical: https://pypi.org/project/aaep-cli-debug/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aaep-cli-debug/](https://pypi.org/project/aaep-cli-debug/) |
| Source record ids | pypi_simple-1e7f56fdb45800 |
...
For a systems engineer, aaep-cli-debug belongs in the Python inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-06-04T19:11:03.576995Z | [https://pypi.org/pypi/aaep-cli-debug/json](https://pypi.org/pypi/aaep-cli-debug/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aaep-cli-debug/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-1e7f56fdb45800` from `pypi_simple` as `registry_expansion`
