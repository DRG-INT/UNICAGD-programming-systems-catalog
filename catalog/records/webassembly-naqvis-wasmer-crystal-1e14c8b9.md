...
<!-- canonical: https://github.com/naqvis/wasmer-crystal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/naqvis/wasmer-crystal](https://github.com/naqvis/wasmer-crystal) |
| Source record ids | github_search_webassembly-7d7bcda11102d2 |
...
For a systems engineer, naqvis/wasmer-crystal belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-18T10:05:09Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-7d7bcda11102d2` from `github_search_webassembly` as `registry_expansion`
