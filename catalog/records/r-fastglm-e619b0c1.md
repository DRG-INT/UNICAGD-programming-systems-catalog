...
<!-- canonical: https://cran.r-project.org/web/packages/fastglm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fastglm/index.html](https://cran.r-project.org/web/packages/fastglm/index.html) |
| Source record ids | cran_packages_by_date-b7c05e46ee04b0 |
...
For a systems engineer, fastglm belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-27 05:10:23 UTC | [https://cran.r-project.org/web/packages/fastglm/DESCRIPTION](https://cran.r-project.org/web/packages/fastglm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fastglm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b7c05e46ee04b0` from `cran_packages_by_date` as `registry_expansion`
