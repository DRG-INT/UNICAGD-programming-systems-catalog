...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Assertion Mocking](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/assertion-mocking.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Assertion Mocking |
| Source type |  |
| Verification | npm_registry |
| Canonical URL | [https://www.npmjs.com/package/mock-http](https://www.npmjs.com/package/mock-http) |
| Source record ids | npm_registry-b49f68ea04eb36 |
...
For a systems engineer, mock-http belongs in the Node.js/JavaScript inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2025-02-12T20:52:45.514Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @contract-case/case-core-plugin-http | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-contract-case-case-core-plugin-http-679f1bfb.md) |
| @mockoon/cli | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-mockoon-cli-cee122aa.md) |
| @mockoon/commons-server | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-mockoon-commons-server-ece091a0.md) |
| @redocly/mock-server | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-redocly-mock-server-e03ee3f4.md) |
| fetch-mock | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-fetch-mock-c964ec19.md) |
| mock-json-server | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-mock-json-server-79782aa3.md) |
| nock | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-nock-bcca8d66.md) |
| responselike | Assertion Mocking | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-responselike-e243aa26.md) |
