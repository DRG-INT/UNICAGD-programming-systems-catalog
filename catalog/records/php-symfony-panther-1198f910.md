...
<!-- canonical: https://packagist.org/packages/symfony/panther -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/panther](https://packagist.org/packages/symfony/panther) |
| Source record ids | packagist_search-aa36fa69fc59bd |
...
For a systems engineer, symfony/panther belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-aa36fa69fc59bd` from `packagist_search` as `registry_expansion`
