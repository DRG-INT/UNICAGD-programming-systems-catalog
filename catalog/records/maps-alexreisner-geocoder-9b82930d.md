...
<!-- canonical: https://github.com/alexreisner/geocoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alexreisner/geocoder](https://github.com/alexreisner/geocoder) |
| Source record ids | github_search_maps-d244244cfc3e0f |
...
For a systems engineer, alexreisner/geocoder belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-09T15:42:53Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d244244cfc3e0f` from `github_search_maps` as `registry_expansion`
