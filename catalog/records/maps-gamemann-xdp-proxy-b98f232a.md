...
<!-- canonical: https://github.com/gamemann/xdp-proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gamemann/xdp-proxy](https://github.com/gamemann/xdp-proxy) |
| Source record ids | github_search_maps-edc0cb58a41b69 |

## System Engineer Summary

A stateless, high-performance NAT-like proxy that attaches to the XDP hook in the Linux kernel using
(e)BPF for fast packet processing. This proxy forwards packets based on configurable rules and
performs source-port mapping, similar to IPTables and NFTables.

## Operational Role

For a systems engineer, gamemann/xdp-proxy belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-10T10:05:27Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-edc0cb58a41b69` from `github_search_maps` as `registry_expansion`
