...
<!-- canonical: https://github.com/rainorangelemon/gnn-motion-planning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rainorangelemon/gnn-motion-planning](https://github.com/rainorangelemon/gnn-motion-planning) |
| Source record ids | github_search_physics_engines-dbff2d707f2519 |

## System Engineer Summary

The official repo for NeurIPS 2021 paper 'Reducing Collision Checking for Sampling-Based Motion
Planning Using Graph Neural Networks'

## Operational Role

For a systems engineer, rainorangelemon/gnn-motion-planning belongs in the Physics Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-29T20:02:17Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-dbff2d707f2519` from `github_search_physics_engines` as `registry_expansion`
