...
<!-- canonical: https://pypi.org/project/adjango/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adjango/](https://pypi.org/project/adjango/) |
| Source record ids | pypi_simple-27d5bf77793caa |
...
For a systems engineer, adjango belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2026-02-20T04:26:01.999007Z | [https://pypi.org/pypi/adjango/json](https://pypi.org/pypi/adjango/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adjango/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-27d5bf77793caa` from `pypi_simple` as `registry_expansion`
