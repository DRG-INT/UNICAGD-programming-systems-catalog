...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Font Briefcase](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/font-briefcase.md) · [Category: Visualization Gui](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/visualization-gui.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/fontforge/fontforge](https://github.com/fontforge/fontforge) |
| Source record ids | curated_language_routes-df98b75c4a5a37 |

## System Engineer Summary

Font editor and scripting environment for designing, converting, inspecting, and repairing font
files.

## Operational Role

For a systems engineer, FontForge belongs in the Font Briefcase inventory as part of ecosystem
...
- `curated_language_routes-df98b75c4a5a37` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Apple Font Book | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/font-briefcase-apple-font-book-d4faa5da.md) |
| FreeType | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/font-briefcase-freetype-56ad1f3a.md) |
| HarfBuzz | Visualization Gui | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/font-briefcase-harfbuzz-bff23c07.md) |
