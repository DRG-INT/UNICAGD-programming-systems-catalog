...
<!-- canonical: https://github.com/ksomml/xsens_mtw_driver_ros2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ksomml/xsens_mtw_driver_ros2](https://github.com/ksomml/xsens_mtw_driver_ros2) |
| Source record ids | github_search_electromagnetoscopes-865ecf7e1907bc |

## System Engineer Summary

A feature-rich ROS 2 driver for the Xsens MTw Awinda wireless motion capture system, built on the
Xsens Device API (XDA) 2022.

## Operational Role

For a systems engineer, ksomml/xsens_mtw_driver_ros2 belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-05T12:22:05Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-865ecf7e1907bc` from `github_search_electromagnetoscopes` as `registry_expansion`
