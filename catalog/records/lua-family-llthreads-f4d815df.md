...
<!-- canonical: https://github.com/Neopallium/lua-llthreads -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Neopallium/lua-llthreads](https://github.com/Neopallium/lua-llthreads) |
| Source record ids | lua-source-188 |
...
For a systems engineer, llthreads belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 188}}` |
...
- `lua-source-188` from `master_json` as `source_list_item`
