...
<!-- canonical: https://luarocks.org/modules/tieske/copas-sse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tieske/copas-sse](https://luarocks.org/modules/tieske/copas-sse) |
| Source record ids | luarocks_root_manifest-54c7d89a2c7408 |
...
For a systems engineer, copas-sse belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-54c7d89a2c7408` from `luarocks_root_manifest` as `registry_expansion`
