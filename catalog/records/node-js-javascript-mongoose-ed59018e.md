...
| Source record ids | corpus-c6e34f32f36c5b |

## System Engineer Summary

Mongoose is tracked as a database datastore record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, Mongoose belongs in the Node.js/JavaScript inventory as part of state
...
- `corpus-c6e34f32f36c5b` from `master_json` as `database_datastore`
