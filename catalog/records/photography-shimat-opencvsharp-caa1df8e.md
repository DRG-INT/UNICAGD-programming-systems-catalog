...
<!-- canonical: https://github.com/shimat/opencvsharp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shimat/opencvsharp](https://github.com/shimat/opencvsharp) |
| Source record ids | github_search_photography-03aa99d556ea0e |

## System Engineer Summary

shimat/opencvsharp is tracked as an image audio dsp record in the Photography branch. The source did
...
For a systems engineer, shimat/opencvsharp belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T03:31:11Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-03aa99d556ea0e` from `github_search_photography` as `registry_expansion`
