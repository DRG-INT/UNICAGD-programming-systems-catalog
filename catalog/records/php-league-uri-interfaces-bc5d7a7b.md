...
<!-- canonical: https://packagist.org/packages/league/uri-interfaces -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/league/uri-interfaces](https://packagist.org/packages/league/uri-interfaces) |
| Source record ids | packagist_search-5443fafcdf8b8b |
...
For a systems engineer, league/uri-interfaces belongs in the PHP inventory as part of service
...
- `packagist_search-5443fafcdf8b8b` from `packagist_search` as `registry_expansion`
