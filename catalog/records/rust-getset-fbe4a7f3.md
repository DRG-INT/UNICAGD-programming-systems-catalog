...
<!-- canonical: https://crates.io/crates/getset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/getset](https://crates.io/crates/getset) |
| Source record ids | crates_io-17b9b15a6613ef |

## System Engineer Summary

Getset, we're ready to go! A procedural macro for generating the most basic getters and setters on
fields.

## Operational Role

For a systems engineer, getset belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7 | 2026-06-10T23:05:33.518121Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-17b9b15a6613ef` from `crates_io` as `registry_expansion`
