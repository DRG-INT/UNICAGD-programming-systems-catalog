...
<!-- canonical: https://cran.r-project.org/web/packages/RNetCDF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RNetCDF/index.html](https://cran.r-project.org/web/packages/RNetCDF/index.html) |
| Source record ids | cran_packages_by_date-e7d7a34e3f1a2c |
...
For a systems engineer, RNetCDF belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11-2 | 2026-08-04 10:40:02 UTC | [https://cran.r-project.org/web/packages/RNetCDF/DESCRIPTION](https://cran.r-project.org/web/packages/RNetCDF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RNetCDF/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e7d7a34e3f1a2c` from `cran_packages_by_date` as `registry_expansion`
