...
<!-- canonical: https://cran.r-project.org/web/packages/sreg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sreg/index.html](https://cran.r-project.org/web/packages/sreg/index.html) |
| Source record ids | cran_packages_by_date-8a479ca6b00a2e |
...
For a systems engineer, sreg belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-22 11:20:02 UTC | [https://cran.r-project.org/web/packages/sreg/DESCRIPTION](https://cran.r-project.org/web/packages/sreg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sreg/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8a479ca6b00a2e` from `cran_packages_by_date` as `registry_expansion`
