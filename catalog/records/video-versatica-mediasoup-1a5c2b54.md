...
<!-- canonical: https://github.com/versatica/mediasoup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/versatica/mediasoup](https://github.com/versatica/mediasoup) |
| Source record ids | github_search_video-062c14752fb862 |
...
For a systems engineer, versatica/mediasoup belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T19:14:12Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-062c14752fb862` from `github_search_video` as `registry_expansion`
