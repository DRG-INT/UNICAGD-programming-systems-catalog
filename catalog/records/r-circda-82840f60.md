...
<!-- canonical: https://cran.r-project.org/web/packages/circda/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/circda/index.html](https://cran.r-project.org/web/packages/circda/index.html) |
| Source record ids | cran_packages_by_date-ac348174848109 |

## System Engineer Summary

circda is tracked as a static analyzer record in the R branch. The source did not provide a long
...
For a systems engineer, circda belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-09-15 11:00:47 UTC | [https://cran.r-project.org/web/packages/circda/DESCRIPTION](https://cran.r-project.org/web/packages/circda/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/circda/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-ac348174848109` from `cran_packages_by_date` as `registry_expansion`
