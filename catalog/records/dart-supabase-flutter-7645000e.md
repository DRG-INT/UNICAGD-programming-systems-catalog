...
<!-- canonical: https://pub.dev/packages/supabase_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/supabase_flutter](https://pub.dev/packages/supabase_flutter) |
| Source record ids | pub_dev-0fda9895e01e50 |

## System Engineer Summary

Flutter integration for Supabase. This package makes it simple for developers to build secure and
scalable products.

## Operational Role

For a systems engineer, supabase_flutter belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.17.2 | 2026-08-14T15:49:49.614845Z | [https://pub.dev/api/packages/supabase_flutter](https://pub.dev/api/packages/supabase_flutter) |  |
| preview | known | 3.0.0-dev.2 | 2026-09-01T13:45:38.710691Z | [https://pub.dev/api/packages/supabase_flutter](https://pub.dev/api/packages/supabase_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/supabase_flutter` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-0fda9895e01e50` from `pub_dev` as `registry_expansion`
