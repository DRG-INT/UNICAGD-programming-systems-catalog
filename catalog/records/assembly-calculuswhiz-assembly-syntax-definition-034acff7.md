...
<!-- canonical: https://github.com/calculuswhiz/Assembly-Syntax-Definition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/calculuswhiz/Assembly-Syntax-Definition](https://github.com/calculuswhiz/Assembly-Syntax-Definition) |
| Source record ids | github_search_assembly-aee362d29add47 |

## System Engineer Summary

GNU AS x86-64 syntax highlighting for Sublime Text

## Operational Role

For a systems engineer, calculuswhiz/Assembly-Syntax-Definition belongs in the Assembly inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-17T20:50:20Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-aee362d29add47` from `github_search_assembly` as `registry_expansion`
