...
<!-- canonical: https://github.com/nv-tlabs/ASE -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nv-tlabs/ASE](https://github.com/nv-tlabs/ASE) |
| Source record ids | github_search_physics_engines-23ee1286b10533 |
...
For a systems engineer, nv-tlabs/ASE belongs in the Physics Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-07T09:02:20Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-23ee1286b10533` from `github_search_physics_engines` as `registry_expansion`
