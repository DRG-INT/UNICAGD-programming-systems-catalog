...
<!-- canonical: https://github.com/markeasting/THREE-XPBD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/markeasting/THREE-XPBD](https://github.com/markeasting/THREE-XPBD) |
| Source record ids | github_search_physics_engines-1fef53cca3f116 |
...
For a systems engineer, markeasting/THREE-XPBD belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-13T14:45:55Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-1fef53cca3f116` from `github_search_physics_engines` as `registry_expansion`
...
| yapstudios/YapAnimator | Parser Lexer Ast | [open](physics-engines-yapstudios-yapanimator-d2c821a2.md) |
