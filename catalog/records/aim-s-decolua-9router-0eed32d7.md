...
<!-- canonical: https://github.com/decolua/9router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/decolua/9router](https://github.com/decolua/9router) |
| Source record ids | github_search_aims-290ee92e71cab6 |

## System Engineer Summary

Unlimited FREE AI coding. Connect Claude Code, Codex, Cursor, Cline, Copilot, Antigravity to FREE
Claude/GPT/Gemini via 40+ providers. Auto-fallback, RTK -40% tokens, never hit limits.

## Operational Role

For a systems engineer, decolua/9router belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T04:03:18Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-290ee92e71cab6` from `github_search_aims` as `registry_expansion`
