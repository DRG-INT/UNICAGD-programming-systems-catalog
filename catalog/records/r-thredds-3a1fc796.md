...
<!-- canonical: https://cran.r-project.org/web/packages/thredds/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/thredds/index.html](https://cran.r-project.org/web/packages/thredds/index.html) |
| Source record ids | cran_packages_by_date-f8258e557ebddd |
...
For a systems engineer, thredds belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1-5 | 2026-09-05 05:10:02 UTC | [https://cran.r-project.org/web/packages/thredds/DESCRIPTION](https://cran.r-project.org/web/packages/thredds/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/thredds/DESCRIPTION` at `2026-09-05T06:22:48+00:00`.
...
- `cran_packages_by_date-f8258e557ebddd` from `cran_packages_by_date` as `registry_expansion`
