...
<!-- canonical: https://cran.r-project.org/web/packages/mcmcr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mcmcr/index.html](https://cran.r-project.org/web/packages/mcmcr/index.html) |
| Source record ids | cran_packages_by_date-4aea91986734e0 |

## System Engineer Summary

mcmcr is tracked as a library record in the R branch. The source did not provide a long description,
so this page keeps the identity, release state, provenance, and operational classification explicit
for later enrichment.

## Operational Role

For a systems engineer, mcmcr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-30 10:30:02 UTC | [https://cran.r-project.org/web/packages/mcmcr/DESCRIPTION](https://cran.r-project.org/web/packages/mcmcr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mcmcr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4aea91986734e0` from `cran_packages_by_date` as `registry_expansion`
