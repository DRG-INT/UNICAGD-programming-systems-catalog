...
<!-- canonical: https://gnu-octave.github.io/packages/pythonic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/pythonic](https://gnu-octave.github.io/packages/pythonic) |
| Source record ids | octave_packages_index-8a11c1818796ee |

## System Engineer Summary

The Pythonic package provides a Python language binding for Octave, to allow any Python package to
be loaded and used directly, with automatic translation from Octave to Python data types.

## Operational Role

For a systems engineer, pythonic belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2023-08-19 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-8a11c1818796ee` from `octave_packages_index` as `registry_expansion`
