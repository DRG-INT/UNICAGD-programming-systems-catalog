...
| Source record ids | corpus-826850ae7fa880 |

## System Engineer Summary

CivetWeb is tracked as a networking http record in the C99 branch. The source did not provide a long
...
For a systems engineer, CivetWeb belongs in the C99 inventory as part of service communication,
...
- `corpus-826850ae7fa880` from `master_json` as `networking_http`
