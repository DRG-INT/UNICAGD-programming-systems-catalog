...
<!-- canonical: https://cran.r-project.org/web/packages/TH/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TH/index.html](https://cran.r-project.org/web/packages/TH/index.html) |
| Source record ids | cran_packages_by_date-41d7bfdd04822d |

## System Engineer Summary

Educational Hypothesis Tests in R

## Operational Role

For a systems engineer, TH belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-06 13:50:20 UTC | [https://cran.r-project.org/web/packages/TH/DESCRIPTION](https://cran.r-project.org/web/packages/TH/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TH/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-41d7bfdd04822d` from `cran_packages_by_date` as `registry_expansion`
