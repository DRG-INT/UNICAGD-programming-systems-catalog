...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rwengine/openrw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rwengine/openrw](https://github.com/rwengine/openrw) |
| Source record ids | github_search_game_engines-11877b48c456ed |

## System Engineer Summary

OpenRW "Open ReWrite" is an un-official open source recreation of the classic Grand Theft Auto III
game executable

## Operational Role

For a systems engineer, rwengine/openrw belongs in the Game Engines inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-18T18:55:52Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-11877b48c456ed` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| a1studmuffin/SpaceshipGenerator | Ffi Bindings | [open](game-engines-a1studmuffin-spaceshipgenerator-d4598d34.md) |
| dotnet/Silk.NET | Ffi Bindings | [open](game-engines-dotnet-silk-net-24929d02.md) |
| godot-rust/gdext | Ffi Bindings | [open](game-engines-godot-rust-gdext-2fe313c5.md) |
| godot-rust/gdnative | Ffi Bindings | [open](game-engines-godot-rust-gdnative-567234f8.md) |
