...
<!-- canonical: https://luarocks.org/modules/freed-wu/bitset -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/bitset](https://luarocks.org/modules/freed-wu/bitset) |
| Source record ids | luarocks_root_manifest-471874906cb900 |
...
For a systems engineer, bitset belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-471874906cb900` from `luarocks_root_manifest` as `registry_expansion`
