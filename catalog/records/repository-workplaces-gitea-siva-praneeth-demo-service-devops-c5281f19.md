# Gitea: siva-praneeth/demo-service-devops
...
<!-- canonical: https://gitea.com/siva-praneeth/demo-service-devops -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/siva-praneeth/demo-service-devops](https://gitea.com/siva-praneeth/demo-service-devops) |
| Source record ids | gitea_repositories_api-ae92fccb3b2395 |

## System Engineer Summary

Gitea: siva-praneeth/demo-service-devops is tracked as a library record in the Repository Workplaces
...
For a systems engineer, Gitea: siva-praneeth/demo-service-devops belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T08:09:51Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-ae92fccb3b2395` from `gitea_repositories_api` as `registry_expansion`
