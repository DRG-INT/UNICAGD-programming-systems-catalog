...
<!-- canonical: https://github.com/jczic/MicroWebSrv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jczic/MicroWebSrv](https://github.com/jczic/MicroWebSrv) |
| Source record ids | github_search_maps-d186fb44f69f5b |

## System Engineer Summary

A micro HTTP Web server that supports WebSockets, html/python language templating and routing
handlers, for MicroPython (used on Pycom modules & ESP32)

## Operational Role

For a systems engineer, jczic/MicroWebSrv belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-17T12:18:00Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d186fb44f69f5b` from `github_search_maps` as `registry_expansion`
