...
<!-- canonical: https://github.com/lxgw/LxgwWenKai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) |
| Source record ids | github_search_font_briefcase-cd43c27f28eab2 |

## System Engineer Summary

An open-source Chinese font derived from Fontworks' Klee One. 一款开源中文字体，基于 FONTWORKS 出品字体 Klee One
衍生。

## Operational Role

For a systems engineer, lxgw/LxgwWenKai belongs in the Font Briefcase inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T07:42:01Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-cd43c27f28eab2` from `github_search_font_briefcase` as `registry_expansion`
