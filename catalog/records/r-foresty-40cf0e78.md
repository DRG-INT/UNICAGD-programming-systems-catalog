...
<!-- canonical: https://cran.r-project.org/web/packages/foresty/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/foresty/index.html](https://cran.r-project.org/web/packages/foresty/index.html) |
| Source record ids | cran_packages_by_date-3ef3dfbccf7342 |

## System Engineer Summary

Forest Plots and Subgroup Effects from Fitted Regression Models

## Operational Role

For a systems engineer, foresty belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-12 14:40:22 UTC | [https://cran.r-project.org/web/packages/foresty/DESCRIPTION](https://cran.r-project.org/web/packages/foresty/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/foresty/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-3ef3dfbccf7342` from `cran_packages_by_date` as `registry_expansion`
