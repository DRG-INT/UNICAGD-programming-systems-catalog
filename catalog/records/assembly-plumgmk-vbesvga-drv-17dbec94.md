...
| Canonical URL | [https://github.com/PluMGMK/vbesvga.drv](https://github.com/PluMGMK/vbesvga.drv) |
| Source record ids | github_search_assembly-cd8e99c9b254cb |
...
For a systems engineer, PluMGMK/vbesvga.drv belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0-beta4 | 2026-07-25T12:27:26Z | [https://api.github.com/repos/PluMGMK/vbesvga.drv/releases/latest](https://api.github.com/repos/PluMGMK/vbesvga.drv/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/PluMGMK/vbesvga.drv/releases/latest` at `2026-09-01T10:25:51+00:00`.
...
- `github_search_assembly-cd8e99c9b254cb` from `github_search_assembly` as `registry_expansion`
