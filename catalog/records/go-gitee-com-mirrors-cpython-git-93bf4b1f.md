...
| Canonical URL | [https://pkg.go.dev/gitee.com/mirrors/cpython.git](https://pkg.go.dev/gitee.com/mirrors/cpython.git) |
| Source record ids | go_module_index-1d6bf255561709 |
...
For a systems engineer, gitee.com/mirrors/cpython.git belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.7+incompatible | 2026-08-30T10:57:14.17359Z | [https://index.golang.org/index?since=2026-08-30T10%3A27%3A51.361401Z&limit=2000](https://index.golang.org/index?since=2026-08-30T10%3A27%3A51.361401Z&limit=2000) |  |
...
- `go_module_index-1d6bf255561709` from `go_module_index` as `registry_expansion`
...
| gitee.com/mirrors_sendgrid/sendgrid-java | Library | [open](go-gitee-com-mirrors-sendgrid-sendgrid-java-40cef1c3.md) |
| gitlab.com/umbrellazone/smartacme | Library | [open](go-gitlab-com-umbrellazone-smartacme-de305f20.md) |
| go.cozymore.dev/krkstops | Library | [open](go-go-cozymore-dev-krkstops-34ccbe5a.md) |
| go.gary.cool/go-stockutil | Library | [open](go-go-gary-cool-go-stockutil-dd0c06ad.md) |
| go.ytsaurus.tech/yt/admin/timbertruck | Library | [open](go-go-ytsaurus-tech-yt-admin-timbertruck-8ce375d8.md) |
| sigs.k8s.io/Controller-Tools | Library | [open](go-sigs-k8s-io-controller-tools-9f4a5e67.md) |
