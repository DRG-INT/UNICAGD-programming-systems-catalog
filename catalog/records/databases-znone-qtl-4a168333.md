...
<!-- canonical: https://github.com/znone/qtl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/znone/qtl](https://github.com/znone/qtl) |
| Source record ids | github_search_databases-56e66f4ce2eec1 |
...
For a systems engineer, znone/qtl belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T14:42:55Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-56e66f4ce2eec1` from `github_search_databases` as `registry_expansion`
