...
<!-- canonical: https://crates.io/crates/relative-path -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/relative-path](https://crates.io/crates/relative-path) |
| Source record ids | crates_io-8c4adfd979cb3d |
...
For a systems engineer, relative-path belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2025-05-10T17:06:18.350439Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-8c4adfd979cb3d` from `crates_io` as `registry_expansion`
