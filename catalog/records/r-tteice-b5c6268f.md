...
<!-- canonical: https://cran.r-project.org/web/packages/tteICE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tteICE/index.html](https://cran.r-project.org/web/packages/tteICE/index.html) |
| Source record ids | cran_packages_by_date-98d9292262c4e7 |
...
For a systems engineer, tteICE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.5 | 2026-08-20 09:50:02 UTC | [https://cran.r-project.org/web/packages/tteICE/DESCRIPTION](https://cran.r-project.org/web/packages/tteICE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tteICE/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-98d9292262c4e7` from `cran_packages_by_date` as `registry_expansion`
