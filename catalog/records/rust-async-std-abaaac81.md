...
<!-- canonical: https://crates.io/crates/async-std -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-2d8408bc7d05c4 |
...
For a systems engineer, async-std belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.2 | 2025-08-15T01:43:25.834384Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-2d8408bc7d05c4` from `crates_io` as `registry_expansion`
