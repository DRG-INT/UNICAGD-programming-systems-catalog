...
<!-- canonical: https://cran.r-project.org/web/packages/INLAtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/INLAtools/index.html](https://cran.r-project.org/web/packages/INLAtools/index.html) |
| Source record ids | cran_packages_by_date-e946fab2642c9c |
...
For a systems engineer, INLAtools belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2026-08-31 19:31:16 UTC | [https://cran.r-project.org/web/packages/INLAtools/DESCRIPTION](https://cran.r-project.org/web/packages/INLAtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/INLAtools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e946fab2642c9c` from `cran_packages_by_date` as `registry_expansion`
