...
<!-- canonical: https://cran.r-project.org/web/packages/UniLindleyApprox/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/UniLindleyApprox/index.html](https://cran.r-project.org/web/packages/UniLindleyApprox/index.html) |
| Source record ids | cran_packages_by_date-09190b28f5d2a0 |
...
For a systems engineer, UniLindleyApprox belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-06 13:50:13 UTC | [https://cran.r-project.org/web/packages/UniLindleyApprox/DESCRIPTION](https://cran.r-project.org/web/packages/UniLindleyApprox/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/UniLindleyApprox/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-09190b28f5d2a0` from `cran_packages_by_date` as `registry_expansion`
