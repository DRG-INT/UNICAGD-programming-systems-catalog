...
<!-- canonical: https://github.com/andriy-bilynskyy/sdr-trx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/andriy-bilynskyy/sdr-trx](https://github.com/andriy-bilynskyy/sdr-trx) |
| Source record ids | github_search_space_maps-b7e23adb93830f |

## System Engineer Summary

andriy-bilynskyy/sdr-trx is tracked as a library record in the Space Maps branch. The source did not
...
For a systems engineer, andriy-bilynskyy/sdr-trx belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-30T19:20:33Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-b7e23adb93830f` from `github_search_space_maps` as `registry_expansion`
