...
<!-- canonical: https://github.com/horde3d/Horde3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/horde3d/Horde3D](https://github.com/horde3d/Horde3D) |
| Source record ids | github_search_computer_graphics_software-74aff1ffa0a850 |

## System Engineer Summary

Horde3D is a small 3D rendering and animation engine. It is written in an effort to create an engine
being as lightweight and conceptually clean as possible.

## Operational Role

For a systems engineer, horde3d/Horde3D belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-74aff1ffa0a850` from `github_search_computer_graphics_software` as `registry_expansion`
