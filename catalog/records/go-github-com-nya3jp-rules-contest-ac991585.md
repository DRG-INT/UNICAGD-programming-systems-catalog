# github.com/nya3jp/rules_contest

## Navigation

[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pkg.go.dev/github.com/nya3jp/rules_contest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pkg.go.dev/github.com/nya3jp/rules_contest](https://pkg.go.dev/github.com/nya3jp/rules_contest) |
| Source record ids | go_module_index-53fea8d2dea8ac |
...
For a systems engineer, github.com/nya3jp/rules_contest belongs in the Go inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.8.1 | 2026-08-30T16:32:16.569994Z | [https://index.golang.org/index?since=2026-08-30T16%3A00%3A13.02635Z&limit=2000](https://index.golang.org/index?since=2026-08-30T16%3A00%3A13.02635Z&limit=2000) |  |
...
- `go_module_index-53fea8d2dea8ac` from `go_module_index` as `registry_expansion`
