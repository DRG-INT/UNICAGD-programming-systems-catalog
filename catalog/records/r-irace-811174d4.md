...
<!-- canonical: https://cran.r-project.org/web/packages/irace/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/irace/index.html](https://cran.r-project.org/web/packages/irace/index.html) |
| Source record ids | cran_packages_by_date-a8d65da9e8388d |
...
For a systems engineer, irace belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.4 | 2026-09-09 12:40:15 UTC | [https://cran.r-project.org/web/packages/irace/DESCRIPTION](https://cran.r-project.org/web/packages/irace/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/irace/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-a8d65da9e8388d` from `cran_packages_by_date` as `registry_expansion`
