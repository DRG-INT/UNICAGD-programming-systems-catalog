...
| Source record ids | github_search_swift-2e82e90abba839 |
...
For a systems engineer, sergdort/ModernCleanArchitectureSwiftUI belongs in the Swift inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-02-12T17:51:06Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-2e82e90abba839` from `github_search_swift` as `registry_expansion`
