...
<!-- canonical: https://pypi.org/project/adit-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adit-client/](https://pypi.org/project/adit-client/) |
| Source record ids | pypi_simple-d546436b853385 |
...
For a systems engineer, adit-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.51.0 | 2026-08-20T10:19:41.076895Z | [https://pypi.org/pypi/adit-client/json](https://pypi.org/pypi/adit-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adit-client/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-d546436b853385` from `pypi_simple` as `registry_expansion`
