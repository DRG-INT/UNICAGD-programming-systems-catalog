...
<!-- canonical: https://crates.io/crates/ignore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ignore](https://crates.io/crates/ignore) |
| Source record ids | crates_io-6f05743a039cdb |
...
For a systems engineer, ignore belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.33 | 2026-08-04T13:59:40.311767Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-6f05743a039cdb` from `crates_io` as `registry_expansion`
