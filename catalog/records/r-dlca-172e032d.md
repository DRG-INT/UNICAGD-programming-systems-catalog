...
<!-- canonical: https://cran.r-project.org/web/packages/DLCA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DLCA/index.html](https://cran.r-project.org/web/packages/DLCA/index.html) |
| Source record ids | cran_packages_by_date-faee8b5f22ba19 |
...
For a systems engineer, DLCA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-08-21 09:10:02 UTC | [https://cran.r-project.org/web/packages/DLCA/DESCRIPTION](https://cran.r-project.org/web/packages/DLCA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DLCA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-faee8b5f22ba19` from `cran_packages_by_date` as `registry_expansion`
