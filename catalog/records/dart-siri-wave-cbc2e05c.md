...
<!-- canonical: https://pub.dev/packages/siri_wave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/siri_wave](https://pub.dev/packages/siri_wave) |
| Source record ids | pub_dev-a89c3c0fde402d |
...
For a systems engineer, siri_wave belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-02-24T17:37:51.391877Z | [https://pub.dev/api/packages/siri_wave](https://pub.dev/api/packages/siri_wave) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/siri_wave` at `2026-09-01T16:41:10+00:00`.
...
- `pub_dev-a89c3c0fde402d` from `pub_dev` as `registry_expansion`
