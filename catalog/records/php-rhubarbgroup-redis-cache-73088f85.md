...
<!-- canonical: https://packagist.org/packages/rhubarbgroup/redis-cache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/rhubarbgroup/redis-cache](https://packagist.org/packages/rhubarbgroup/redis-cache) |
| Source record ids | packagist_search-8c4e69394ee705 |

## System Engineer Summary

A persistent object cache backend for WordPress powered by Redis. Supports Predis, PhpRedis, Relay,
replication, sentinels, clustering and WP-CLI.

## Operational Role

For a systems engineer, rhubarbgroup/redis-cache belongs in the PHP inventory as part of ecosystem
...
- `packagist_search-8c4e69394ee705` from `packagist_search` as `registry_expansion`
