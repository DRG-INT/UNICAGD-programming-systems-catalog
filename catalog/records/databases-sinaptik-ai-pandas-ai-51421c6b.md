...
<!-- canonical: https://github.com/sinaptik-ai/pandas-ai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sinaptik-ai/pandas-ai](https://github.com/sinaptik-ai/pandas-ai) |
| Source record ids | github_search_databases-a9081bdbc5d0bf |

## System Engineer Summary

Chat with your database or your datalake (SQL, CSV, parquet). PandasAI makes data analysis
conversational using LLMs and RAG.

## Operational Role

For a systems engineer, sinaptik-ai/pandas-ai belongs in the Databases inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-28T10:02:13Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a9081bdbc5d0bf` from `github_search_databases` as `registry_expansion`
