...
<!-- canonical: https://pypi.org/project/adata-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adata-cli/](https://pypi.org/project/adata-cli/) |
| Source record ids | pypi_simple-d743c05c708999 |

## System Engineer Summary

adata-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, adata-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-04-04T13:48:58.754943Z | [https://pypi.org/pypi/adata-cli/json](https://pypi.org/pypi/adata-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adata-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-d743c05c708999` from `pypi_simple` as `registry_expansion`
