...
<!-- canonical: https://github.com/PrismPipeline/QuiltiX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PrismPipeline/QuiltiX](https://github.com/PrismPipeline/QuiltiX) |
| Source record ids | github_search_effects-e0a1091a770bd2 |
...
For a systems engineer, PrismPipeline/QuiltiX belongs in the Effects inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-03T17:45:40Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-e0a1091a770bd2` from `github_search_effects` as `registry_expansion`
