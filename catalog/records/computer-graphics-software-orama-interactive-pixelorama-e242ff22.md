...
<!-- canonical: https://github.com/Orama-Interactive/Pixelorama -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Orama-Interactive/Pixelorama](https://github.com/Orama-Interactive/Pixelorama) |
| Source record ids | github_search_computer_graphics_software-bb7492f98cb451 |

## System Engineer Summary

Unleash your creativity with Pixelorama, a powerful and accessible open-source pixel art multitool.
Whether you want to create sprites, tiles, animations, or just express yourself in the language of
pixel art, this software will realize your pixel-perfect dreams with a vast toolbox of features.
Available on Windows, Linux, macOS and the Web!

## Operational Role

For a systems engineer, Orama-Interactive/Pixelorama belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-bb7492f98cb451` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Orillusion/orillusion | Language Specification | [open](computer-graphics-software-orillusion-orillusion-3aa8bb93.md) |
