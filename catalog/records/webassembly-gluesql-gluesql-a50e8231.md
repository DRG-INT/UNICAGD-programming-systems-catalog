...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/gluesql/gluesql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gluesql/gluesql](https://github.com/gluesql/gluesql) |
| Source record ids | github_search_webassembly-6abfb97b24c417 |
...
For a systems engineer, gluesql/gluesql belongs in the WebAssembly inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T13:20:52Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6abfb97b24c417` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kuzudb/kuzu | Database Datastore | [open](webassembly-kuzudb-kuzu-82a50b44.md) |
| liam-hq/liam | Database Datastore | [open](webassembly-liam-hq-liam-467de678.md) |
| obi1kenobi/trustfall | Database Datastore | [open](webassembly-obi1kenobi-trustfall-5aefd0ed.md) |
| sql-js/sql.js | Database Datastore | [open](webassembly-sql-js-sql-js-33b2be89.md) |
| tursodatabase/libsql | Database Datastore | [open](webassembly-tursodatabase-libsql-4c64b1cc.md) |
