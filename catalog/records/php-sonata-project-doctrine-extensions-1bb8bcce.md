...
<!-- canonical: https://packagist.org/packages/sonata-project/doctrine-extensions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sonata-project/doctrine-extensions](https://packagist.org/packages/sonata-project/doctrine-extensions) |
| Source record ids | packagist_search-3395b31d088efd |
...
For a systems engineer, sonata-project/doctrine-extensions belongs in the PHP inventory as part of
...
- `packagist_search-3395b31d088efd` from `packagist_search` as `registry_expansion`
