# Anupamchaudhary17/ln2-drop-evap

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Anupamchaudhary17/ln2-drop-evap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Anupamchaudhary17/ln2-drop-evap](https://github.com/Anupamchaudhary17/ln2-drop-evap) |
| Source record ids | github_search_basilisk-e197caf54f3bce |

## System Engineer Summary

0D simulation of single moving liquid nitrogen droplet evaporation using Basilisk C – validation of
Cen et al. (2022) model with implicit ODE solver and parametric study.

## Operational Role

For a systems engineer, Anupamchaudhary17/ln2-drop-evap belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T15:29:32Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-e197caf54f3bce` from `github_search_basilisk` as `registry_expansion`
