...
<!-- canonical: https://pub.dev/packages/flutter_overlay_window -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_overlay_window](https://pub.dev/packages/flutter_overlay_window) |
| Source record ids | pub_dev-6544b4d2fe25eb |
...
For a systems engineer, flutter_overlay_window belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2025-04-20T13:13:34.699693Z | [https://pub.dev/api/packages/flutter_overlay_window](https://pub.dev/api/packages/flutter_overlay_window) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_overlay_window` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-6544b4d2fe25eb` from `pub_dev` as `registry_expansion`
