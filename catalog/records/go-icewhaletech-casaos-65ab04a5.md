...
<!-- canonical: https://github.com/IceWhaleTech/CasaOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IceWhaleTech/CasaOS](https://github.com/IceWhaleTech/CasaOS) |
| Source record ids | github_search_go-cc29961d4508a6 |
...
For a systems engineer, IceWhaleTech/CasaOS belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-06T08:54:04Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-cc29961d4508a6` from `github_search_go` as `registry_expansion`
