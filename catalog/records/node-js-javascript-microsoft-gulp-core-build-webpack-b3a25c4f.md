...
<!-- canonical: https://www.npmjs.com/package/@microsoft/gulp-core-build-webpack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@microsoft/gulp-core-build-webpack](https://www.npmjs.com/package/@microsoft/gulp-core-build-webpack) |
| Source record ids | npm_registry-22d6ce45856b1a |

## System Engineer Summary

`gulp-core-build-webpack` is a `gulp-core-build` subtask which introduces the ability to bundle
various source files into a set of bundles, using webpack.

## Operational Role

For a systems engineer, @microsoft/gulp-core-build-webpack belongs in the Node.js/JavaScript
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.3 | 2024-09-16T02:02:12.910Z | [https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=build&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
