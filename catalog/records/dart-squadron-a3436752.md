...
<!-- canonical: https://pub.dev/packages/squadron -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/squadron](https://pub.dev/packages/squadron) |
| Source record ids | pub_dev-3e6933074ffc9e |

## System Engineer Summary

Multithreading and worker thread pool for Dart / Flutter, to offload CPU-bound and heavy I/O tasks
to Isolate or Web Worker threads.

## Operational Role

For a systems engineer, squadron belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.4.3 | 2026-04-04T16:37:36.775881Z | [https://pub.dev/api/packages/squadron](https://pub.dev/api/packages/squadron) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/squadron` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-3e6933074ffc9e` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bloc_concurrency | Concurrency Parallelism | [open](dart-bloc-concurrency-2cecb63d.md) |
