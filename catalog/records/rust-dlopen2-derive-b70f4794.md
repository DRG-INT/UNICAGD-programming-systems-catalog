...
| Canonical URL | [https://crates.io/crates/dlopen2_derive](https://crates.io/crates/dlopen2_derive) |
| Source record ids | crates_io-4dbb422f0f0d5f |
...
For a systems engineer, dlopen2_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-07-26T15:11:58.471551Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-4dbb422f0f0d5f` from `crates_io` as `registry_expansion`
