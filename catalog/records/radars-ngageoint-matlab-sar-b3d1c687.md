...
<!-- canonical: https://github.com/ngageoint/MATLAB_SAR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ngageoint/MATLAB_SAR](https://github.com/ngageoint/MATLAB_SAR) |
| Source record ids | github_search_radars-3643fe21a3a88a |

## System Engineer Summary

A basic MATLAB library to demonstrate reading, writing, display, and simple processing of complex
SAR data using the NGA SICD standard.

## Operational Role

For a systems engineer, ngageoint/MATLAB_SAR belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-22T21:55:56Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3643fe21a3a88a` from `github_search_radars` as `registry_expansion`
