...
| Canonical URL | [https://crates.io/crates/atk-sys](https://crates.io/crates/atk-sys) |
| Source record ids | crates_io-f4e97622758425 |
...
For a systems engineer, atk-sys belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.2 | 2024-12-09T11:45:59.322690Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-f4e97622758425` from `crates_io` as `registry_expansion`
