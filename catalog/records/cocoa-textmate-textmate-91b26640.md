...
<!-- canonical: https://github.com/textmate/textmate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/textmate/textmate](https://github.com/textmate/textmate) |
| Source record ids | github_search_cocoa-cce68ac8cfe81b |
...
For a systems engineer, textmate/textmate belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-18T11:00:21Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-cce68ac8cfe81b` from `github_search_cocoa` as `registry_expansion`
