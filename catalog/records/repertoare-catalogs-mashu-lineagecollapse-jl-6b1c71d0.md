...
<!-- canonical: https://github.com/mashu/LineageCollapse.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mashu/LineageCollapse.jl](https://github.com/mashu/LineageCollapse.jl) |
| Source record ids | github_search_repertoare_catalogs-6ac044f869a411 |

## System Engineer Summary

High-performance Julia package for performing lineage collapsing on immune repertoire sequencing
data.

## Operational Role

For a systems engineer, mashu/LineageCollapse.jl belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-19T05:17:07Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-6ac044f869a411` from `github_search_repertoare_catalogs` as `registry_expansion`
