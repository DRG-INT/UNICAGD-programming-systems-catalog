...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Beep6581/RawTherapee -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Beep6581/RawTherapee](https://github.com/Beep6581/RawTherapee) |
| Source record ids | curated_language_routes-6d6a379fd82402 |

## System Engineer Summary

RAW photo processing application for demosaicing, color, exposure, lens corrections, and exports.

## Operational Role

For a systems engineer, RawTherapee belongs in the Photography inventory as part of ecosystem
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
| --- | --- | --- | --- |
| official_language_route | curated-extension-derived | 2026-09-07 | `{"kind": "official_language_route", "retrieved": "2026-09-07", "status": "curated-extension-derived"}` |
...
- `curated_language_routes-6d6a379fd82402` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| addshore/facebook-data-image-exif | Visualization Gui | [open](photography-addshore-facebook-data-image-exif-fe746e72.md) |
| afgprogrammer/Flutter-Photography-Application | Visualization Gui | [open](photography-afgprogrammer-flutter-photography-application-d1b12714.md) |
| Automaticism/Promptvision | Visualization Gui | [open](photography-automaticism-promptvision-8cf055e0.md) |
| CarVac/filmulator-gui | Visualization Gui | [open](photography-carvac-filmulator-gui-7958689d.md) |
| darktable | Visualization Gui | [open](photography-darktable-643ff3aa.md) |
| deckerst/aves | Visualization Gui | [open](photography-deckerst-aves-abe42e9c.md) |
| ECarry/photography-website | Visualization Gui | [open](photography-ecarry-photography-website-36282ce9.md) |
| GuidoBartoli/sherloq | Visualization Gui | [open](photography-guidobartoli-sherloq-89dd76f4.md) |
