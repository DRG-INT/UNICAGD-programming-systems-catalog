...
<!-- canonical: https://github.com/WGDashboard/WGDashboard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WGDashboard/WGDashboard](https://github.com/WGDashboard/WGDashboard) |
| Source record ids | github_search_databases-b8ebdbe84b2ec9 |
...
For a systems engineer, WGDashboard/WGDashboard belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T20:34:53Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-b8ebdbe84b2ec9` from `github_search_databases` as `registry_expansion`
