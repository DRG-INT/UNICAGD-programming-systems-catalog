...
<!-- canonical: https://crates.io/crates/async-lock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-lock](https://crates.io/crates/async-lock) |
| Source record ids | crates_io-b31a0b56d607c1 |
...
For a systems engineer, async-lock belongs in the Rust inventory as part of concurrency scheduling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.2 | 2025-12-21T16:24:46.954239Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-b31a0b56d607c1` from `crates_io` as `registry_expansion`
