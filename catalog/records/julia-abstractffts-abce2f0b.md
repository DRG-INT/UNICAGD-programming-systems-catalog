...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AbstractFFTs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AbstractFFTs](https://github.com/JuliaRegistries/General/tree/master/A/AbstractFFTs) |
| Source record ids | julia_general-158e3b3a8a68ea |

## System Engineer Summary

Julia package registered in General at A/AbstractFFTs.

## Operational Role

For a systems engineer, AbstractFFTs belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AbstractFFTs", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-158e3b3a8a68ea` from `julia_general` as `registry_expansion`
