...
<!-- canonical: https://github.com/hotosm/osm-analytics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hotosm/osm-analytics](https://github.com/hotosm/osm-analytics) |
| Source record ids | github_search_maps-f02062a87d8ee1 |

## System Engineer Summary

OSM Analytics lets you interactively analyze how specific OpenStreetMap features are mapped in a
specific region.

## Operational Role

For a systems engineer, hotosm/osm-analytics belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-23T12:12:29Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-f02062a87d8ee1` from `github_search_maps` as `registry_expansion`
