...
<!-- canonical: https://github.com/muan/emojilib -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/muan/emojilib](https://github.com/muan/emojilib) |
| Source record ids | github_search_icons_and_logos-ca9b9b6a1a7f9c |

## System Engineer Summary

muan/emojilib is tracked as a library record in the Icons and Logos branch. The source did not
...
For a systems engineer, muan/emojilib belongs in the Icons and Logos inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-08T21:38:30Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-ca9b9b6a1a7f9c` from `github_search_icons_and_logos` as `registry_expansion`
