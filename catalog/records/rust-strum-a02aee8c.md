...
<!-- canonical: https://crates.io/crates/strum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/strum](https://crates.io/crates/strum) |
| Source record ids | crates_io-0499319e91eb46 |
...
For a systems engineer, strum belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.28.0 | 2026-02-22T15:46:16.247520Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-0499319e91eb46` from `crates_io` as `registry_expansion`
