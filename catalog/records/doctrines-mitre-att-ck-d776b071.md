...
<!-- canonical: https://attack.mitre.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://attack.mitre.org/](https://attack.mitre.org/) |
| Source record ids | curated_language_routes-920b6db8ca638b |

## System Engineer Summary

Adversary tactics and techniques knowledge base used for defensive engineering, detection, and
threat modeling.

## Operational Role

For a systems engineer, MITRE ATT&CK belongs in the Doctrines inventory as part of supply-chain
...
- `curated_language_routes-920b6db8ca638b` from `curated_language_routes` as `registry_expansion`
