...
<!-- canonical: https://cran.r-project.org/web/packages/nonnet/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nonnet/index.html](https://cran.r-project.org/web/packages/nonnet/index.html) |
| Source record ids | cran_packages_by_date-5bfb4a0a06e700 |

## System Engineer Summary

Generate and Analyze Nonlinear Networks

## Operational Role

For a systems engineer, nonnet belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-15 10:40:11 UTC | [https://cran.r-project.org/web/packages/nonnet/DESCRIPTION](https://cran.r-project.org/web/packages/nonnet/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nonnet/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-5bfb4a0a06e700` from `cran_packages_by_date` as `registry_expansion`
