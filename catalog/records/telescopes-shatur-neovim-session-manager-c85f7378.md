...
<!-- canonical: https://github.com/Shatur/neovim-session-manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Shatur/neovim-session-manager](https://github.com/Shatur/neovim-session-manager) |
| Source record ids | github_search_telescopes-21f2da38bc227c |
...
For a systems engineer, Shatur/neovim-session-manager belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-26T08:29:30Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-21f2da38bc227c` from `github_search_telescopes` as `registry_expansion`
