...
<!-- canonical: https://cran.r-project.org/web/packages/flexsynth/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flexsynth/index.html](https://cran.r-project.org/web/packages/flexsynth/index.html) |
| Source record ids | cran_packages_by_date-a46a15b63e0f9a |
...
For a systems engineer, flexsynth belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-02 12:00:02 UTC | [https://cran.r-project.org/web/packages/flexsynth/DESCRIPTION](https://cran.r-project.org/web/packages/flexsynth/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flexsynth/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-a46a15b63e0f9a` from `cran_packages_by_date` as `registry_expansion`
