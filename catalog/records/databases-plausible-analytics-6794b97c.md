...
<!-- canonical: https://github.com/plausible/analytics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/plausible/analytics](https://github.com/plausible/analytics) |
| Source record ids | github_search_databases-345daf2a8f4cc6 |
...
For a systems engineer, plausible/analytics belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T11:51:54Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-345daf2a8f4cc6` from `github_search_databases` as `registry_expansion`
