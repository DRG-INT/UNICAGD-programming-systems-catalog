# xavki/tutorials-raspberry-tips
...
<!-- canonical: https://gitlab.com/xavki/tutorials-raspberry-tips -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/xavki/tutorials-raspberry-tips](https://gitlab.com/xavki/tutorials-raspberry-tips) |
| Source record ids | gitlab_projects_api-96e279228efa0d |

## System Engineer Summary

Raspberry Pi automation and security: user management, iptables, Ansible playbooks, Prometheus +
Grafana + node-exporter, HAProxy, Let's Encrypt. Xavki tutorials —

## Operational Role

For a systems engineer, xavki/tutorials-raspberry-tips belongs in the Repository Workplaces
...
- `gitlab_projects_api-96e279228efa0d` from `gitlab_projects_api` as `registry_expansion`
