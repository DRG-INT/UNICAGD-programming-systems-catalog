...
<!-- canonical: https://luarocks.org/modules/olueiro/cards -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/olueiro/cards](https://luarocks.org/modules/olueiro/cards) |
| Source record ids | luarocks_root_manifest-9407388e149aa5 |

## System Engineer Summary

cards is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cards belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9407388e149aa5` from `luarocks_root_manifest` as `registry_expansion`
