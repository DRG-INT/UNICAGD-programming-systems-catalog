...
<!-- canonical: https://cran.r-project.org/web/packages/IGPFrailty/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/IGPFrailty/index.html](https://cran.r-project.org/web/packages/IGPFrailty/index.html) |
| Source record ids | cran_packages_by_date-b8e29ec8b928fc |
...
For a systems engineer, IGPFrailty belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-25 05:21:06 UTC | [https://cran.r-project.org/web/packages/IGPFrailty/DESCRIPTION](https://cran.r-project.org/web/packages/IGPFrailty/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/IGPFrailty/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b8e29ec8b928fc` from `cran_packages_by_date` as `registry_expansion`
