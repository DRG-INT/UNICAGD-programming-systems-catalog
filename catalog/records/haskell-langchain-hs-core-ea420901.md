...
<!-- canonical: https://hackage.haskell.org/package/langchain-hs-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/langchain-hs-core](https://hackage.haskell.org/package/langchain-hs-core) |
| Source record ids | hackage_recent-d2f0d3c8448ec9 |

## System Engineer Summary

Hackage package recently uploaded by tusharad.

## Operational Role

For a systems engineer, langchain-hs-core belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5.0 | 2026-09-12T13:13:40Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-12T14:18:45+00:00`.
...
- `hackage_recent-d2f0d3c8448ec9` from `hackage_recent` as `registry_expansion`
