...
| Canonical URL | [https://github.com/bluewaysw/pcgeos](https://github.com/bluewaysw/pcgeos) |
| Source record ids | github_search_assembly-a9020ab5740834 |

## System Engineer Summary

#FreeGEOS source codes. The offical home of the PC/GEOS operating system technology. For personal
computing fans. For all developers and assembly lovers. For YOU!

## Operational Role

For a systems engineer, bluewaysw/pcgeos belongs in the Assembly inventory as part of ecosystem
...
| preview | known | CI-latest | 2026-08-26T22:15:02Z | [https://api.github.com/repos/bluewaysw/pcgeos/releases?per_page=10](https://api.github.com/repos/bluewaysw/pcgeos/releases?per_page=10) |  |
...
- `github_search_assembly-a9020ab5740834` from `github_search_assembly` as `registry_expansion`
