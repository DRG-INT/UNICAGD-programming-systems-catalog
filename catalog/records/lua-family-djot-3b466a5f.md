...
<!-- canonical: https://luarocks.org/modules/jgm/djot -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jgm/djot](https://luarocks.org/modules/jgm/djot) |
| Source record ids | luarocks_root_manifest-bb094239bdbb01 |

## System Engineer Summary

Djot light markup parser

## Operational Role

For a systems engineer, djot belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-bb094239bdbb01` from `luarocks_root_manifest` as `registry_expansion`
