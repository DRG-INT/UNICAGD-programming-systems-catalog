...
<!-- canonical: https://pypi.org/project/access-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/access-client/](https://pypi.org/project/access-client/) |
| Source record ids | pypi_simple-cf01ed5b0bdb19 |

## System Engineer Summary

access-client is tracked as a networking http record in the Python branch. The source did not
...
For a systems engineer, access-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2019-07-18T13:22:52.160122Z | [https://pypi.org/pypi/access-client/json](https://pypi.org/pypi/access-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/access-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-cf01ed5b0bdb19` from `pypi_simple` as `registry_expansion`
