...
<!-- canonical: https://github.com/visionspacetec/sle-common -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/visionspacetec/sle-common](https://github.com/visionspacetec/sle-common) |
| Source record ids | github_search_satcom_satellites-66bd4f4d2129dd |

## System Engineer Summary

Common library for Space Link Extension user and provider development

## Operational Role

For a systems engineer, visionspacetec/sle-common belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-30T08:34:49Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-66bd4f4d2129dd` from `github_search_satcom_satellites` as `registry_expansion`
