...
<!-- canonical: https://cran.r-project.org/web/packages/colorr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/colorr/index.html](https://cran.r-project.org/web/packages/colorr/index.html) |
| Source record ids | cran_packages_by_date-57baaf89aafa30 |
...
For a systems engineer, colorr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-22 15:10:39 UTC | [https://cran.r-project.org/web/packages/colorr/DESCRIPTION](https://cran.r-project.org/web/packages/colorr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/colorr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57baaf89aafa30` from `cran_packages_by_date` as `registry_expansion`
