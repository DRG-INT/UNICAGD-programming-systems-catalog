...
<!-- canonical: https://cran.r-project.org/web/packages/ICEHmeasures/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ICEHmeasures/index.html](https://cran.r-project.org/web/packages/ICEHmeasures/index.html) |
| Source record ids | cran_packages_by_date-fc3edeb64b9324 |

## System Engineer Summary

The Equiplot Graph and Complex Inequality Measures

## Operational Role

For a systems engineer, ICEHmeasures belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2026-08-21 20:40:09 UTC | [https://cran.r-project.org/web/packages/ICEHmeasures/DESCRIPTION](https://cran.r-project.org/web/packages/ICEHmeasures/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ICEHmeasures/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-fc3edeb64b9324` from `cran_packages_by_date` as `registry_expansion`
