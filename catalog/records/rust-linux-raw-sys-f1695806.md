...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/linux-raw-sys -->
<!-- crawl-delay: 10 -->
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `crates_io-f79453628d904c` from `crates_io` as `registry_expansion`
