...
<!-- canonical: https://github.com/MrNeRF/LichtFeld-Studio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MrNeRF/LichtFeld-Studio](https://github.com/MrNeRF/LichtFeld-Studio) |
| Source record ids | github_search_computer_graphics_software-e44b0aeb5bb72c |

## System Engineer Summary

Train, inspect, edit, automate, and export 3D Gaussian Splatting scenes from a single native
application.

## Operational Role

For a systems engineer, MrNeRF/LichtFeld-Studio belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-e44b0aeb5bb72c` from `github_search_computer_graphics_software` as `registry_expansion`
