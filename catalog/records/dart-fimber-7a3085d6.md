...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/fimber -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fimber](https://pub.dev/packages/fimber) |
| Source record ids | pub_dev-7967cac117d38a |

## System Engineer Summary

Extensible logging for Flutter - based on Timber on Android, using similar (as far as Dart lang
allows) method API with same concepts for tree and planting logging tree.

## Operational Role

For a systems engineer, fimber belongs in the Dart inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2023-06-26T01:45:52.282969Z | [https://pub.dev/api/packages/fimber](https://pub.dev/api/packages/fimber) |  |
| preview | known | 0.5.0-nullsafety.1 | 2020-12-06T22:50:42.869967Z | [https://pub.dev/api/packages/fimber](https://pub.dev/api/packages/fimber) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fimber` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-7967cac117d38a` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| app_tracking_transparency | Logging Observability | [open](dart-app-tracking-transparency-f6c48d69.md) |
| bloc | Logging Observability | [open](dart-bloc-ed8789d6.md) |
| flutter_card_swiper | Logging Observability | [open](dart-flutter-card-swiper-b126e3d6.md) |
| flutter_file_dialog | Logging Observability | [open](dart-flutter-file-dialog-37afe2d6.md) |
| flutter_login | Logging Observability | [open](dart-flutter-login-508af4c2.md) |
| flutter_platform_alert | Logging Observability | [open](dart-flutter-platform-alert-41f9cc97.md) |
| keyboard_actions | Logging Observability | [open](dart-keyboard-actions-f64a5c69.md) |
| local_auth | Logging Observability | [open](dart-local-auth-dc3f9a4e.md) |
