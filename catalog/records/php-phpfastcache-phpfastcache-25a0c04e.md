...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/phpfastcache/phpfastcache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/phpfastcache/phpfastcache](https://packagist.org/packages/phpfastcache/phpfastcache) |
| Source record ids | packagist_search-1f6af1e1939123 |

## System Engineer Summary

PHP Abstract Cache Class - Reduce your database call using cache system. Phpfastcache handles a lot
of drivers such as Apc(u), Cassandra, CouchBase, Couchdb, Dynamodb, Firestore, Mongodb, Files,
(P)redis, Leveldb, Memcache(d), Ravendb, Ssdb, Sqlite, Wincache, Xcache, Zend Data Cache.

## Operational Role

For a systems engineer, phpfastcache/phpfastcache belongs in the PHP inventory as part of language
...
- `packagist_search-1f6af1e1939123` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| astrotomic/laravel-translatable | Parser Lexer Ast | [open](php-astrotomic-laravel-translatable-1fee3363.md) |
| clue/ndjson-react | Parser Lexer Ast | [open](php-clue-ndjson-react-33d3df36.md) |
| clue/redis-protocol | Parser Lexer Ast | [open](php-clue-redis-protocol-224f7bce.md) |
| colinodell/json5 | Parser Lexer Ast | [open](php-colinodell-json5-439a1c99.md) |
| ddmaster/postgre-search-bundle | Parser Lexer Ast | [open](php-ddmaster-postgre-search-bundle-bc9e1b20.md) |
| ecotone/pdo-event-sourcing | Parser Lexer Ast | [open](php-ecotone-pdo-event-sourcing-595186a1.md) |
| elcobvg/laravel-opcache | Parser Lexer Ast | [open](php-elcobvg-laravel-opcache-f858af5a.md) |
| greenlion/php-sql-parser | Parser Lexer Ast | [open](php-greenlion-php-sql-parser-ea960c02.md) |
