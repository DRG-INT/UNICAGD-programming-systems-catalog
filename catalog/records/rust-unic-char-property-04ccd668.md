...
<!-- canonical: https://crates.io/crates/unic-char-property -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unic-char-property](https://crates.io/crates/unic-char-property) |
| Source record ids | crates_io-adf65503aca43e |
...
For a systems engineer, unic-char-property belongs in the Rust inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2019-03-03T04:58:16.449988Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-adf65503aca43e` from `crates_io` as `registry_expansion`
