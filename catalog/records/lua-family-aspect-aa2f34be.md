...
<!-- canonical: https://luarocks.org/modules/unifire/aspect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/unifire/aspect](https://luarocks.org/modules/unifire/aspect) |
| Source record ids | luarocks_root_manifest-9db3e719ec49b5 |
...
For a systems engineer, aspect belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9db3e719ec49b5` from `luarocks_root_manifest` as `registry_expansion`
