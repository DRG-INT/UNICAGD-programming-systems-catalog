...
<!-- canonical: https://pub.dev/packages/map_launcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/map_launcher](https://pub.dev/packages/map_launcher) |
| Source record ids | pub_dev-74dcd58ef760bf |

## System Engineer Summary

Map Launcher is a flutter plugin to find available maps installed on a device and launch them with a
marker or show directions.

## Operational Role

For a systems engineer, map_launcher belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.0 | 2026-07-27T22:22:11.421116Z | [https://pub.dev/api/packages/map_launcher](https://pub.dev/api/packages/map_launcher) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-02-23T13:11:08.769764Z | [https://pub.dev/api/packages/map_launcher](https://pub.dev/api/packages/map_launcher) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/map_launcher` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-74dcd58ef760bf` from `pub_dev` as `registry_expansion`
