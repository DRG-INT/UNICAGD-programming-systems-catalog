...
<!-- canonical: https://github.com/risingwavelabs/risingwave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/risingwavelabs/risingwave](https://github.com/risingwavelabs/risingwave) |
| Source record ids | github_search_databases-f2a8fe9dda68c3 |

## System Engineer Summary

Event streaming platform for agentic AI. Continuously ingest, transform, and serve event streams in
real time, at scale.

## Operational Role

For a systems engineer, risingwavelabs/risingwave belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T12:14:43Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f2a8fe9dda68c3` from `github_search_databases` as `registry_expansion`
