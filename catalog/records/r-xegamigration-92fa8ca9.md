...
<!-- canonical: https://cran.r-project.org/web/packages/xegaMigration/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xegaMigration/index.html](https://cran.r-project.org/web/packages/xegaMigration/index.html) |
| Source record ids | cran_packages_by_date-24e3aff9189be9 |

## System Engineer Summary

xegaMigration is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, xegaMigration belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.4 | 2026-08-08 11:30:02 UTC | [https://cran.r-project.org/web/packages/xegaMigration/DESCRIPTION](https://cran.r-project.org/web/packages/xegaMigration/DESCRIPTION) |  |
...
| Evidence | Apache License (>= 2); GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xegaMigration/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-24e3aff9189be9` from `cran_packages_by_date` as `registry_expansion`
