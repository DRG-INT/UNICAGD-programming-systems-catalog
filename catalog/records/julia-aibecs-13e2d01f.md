...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/A/AIBECS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/A/AIBECS](https://github.com/JuliaRegistries/General/tree/master/A/AIBECS) |
| Source record ids | julia_general-1802c863b8efda |

## System Engineer Summary

Julia package registered in General at A/AIBECS.

## Operational Role

For a systems engineer, AIBECS belongs in the Julia inventory as part of model pipelines, numerical
...
| Evidence | Apache-2.0; https://www.nuget.org/packages/NATS.Client.Serializers.Json/3.2.0/license |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AIBECS", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-1802c863b8efda` from `julia_general` as `registry_expansion`
...
| AIFF | Machine Learning | [open](julia-aiff-3d94a654.md) |
