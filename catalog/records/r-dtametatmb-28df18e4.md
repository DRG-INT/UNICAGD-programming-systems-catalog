...
<!-- canonical: https://cran.r-project.org/web/packages/dtametaTMB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dtametaTMB/index.html](https://cran.r-project.org/web/packages/dtametaTMB/index.html) |
| Source record ids | cran_packages_by_date-480a2244f5c98d |
...
For a systems engineer, dtametaTMB belongs in the R inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2 | 2026-08-26 08:20:02 UTC | [https://cran.r-project.org/web/packages/dtametaTMB/DESCRIPTION](https://cran.r-project.org/web/packages/dtametaTMB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dtametaTMB/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-480a2244f5c98d` from `cran_packages_by_date` as `registry_expansion`
