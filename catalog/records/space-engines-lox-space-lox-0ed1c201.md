...
<!-- canonical: https://github.com/lox-space/lox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lox-space/lox](https://github.com/lox-space/lox) |
| Source record ids | github_search_space_engines-55dcfaacb23516 |

## System Engineer Summary

lox-space/lox is tracked as a static analyzer record in the Space Engines branch. The source did not
...
For a systems engineer, lox-space/lox belongs in the Space Engines inventory as part of defect
...
- `github_search_space_engines-55dcfaacb23516` from `github_search_space_engines` as `registry_expansion`
