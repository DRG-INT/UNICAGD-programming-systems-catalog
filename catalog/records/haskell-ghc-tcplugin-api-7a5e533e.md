...
<!-- canonical: https://hackage.haskell.org/package/ghc-tcplugin-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ghc-tcplugin-api](https://hackage.haskell.org/package/ghc-tcplugin-api) |
| Source record ids | hackage_top_downloads-d7916c7293d7b2 |
...
For a systems engineer, ghc-tcplugin-api belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.1.0 | 2026-09-01T15:55:42Z | [https://hackage.haskell.org/package/ghc-tcplugin-api](https://hackage.haskell.org/package/ghc-tcplugin-api) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ghc-tcplugin-api` at `2026-09-02T20:22:51+00:00`.
...
- `hackage_top_downloads-d7916c7293d7b2` from `hackage_top_downloads` as `registry_expansion`
