...
| Source record ids | hackage_recent-d7916c7293d7b2 |

## System Engineer Summary

Hackage package recently uploaded by sheaf.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20.1.0 | 2026-09-01T15:55:42Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-d7916c7293d7b2` from `hackage_recent` as `registry_expansion`
