...
<!-- canonical: https://luarocks.org/modules/marcoonroad/cuid -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/marcoonroad/cuid](https://luarocks.org/modules/marcoonroad/cuid) |
| Source record ids | luarocks_root_manifest-0e46f0620ddb8a |

## System Engineer Summary

cuid is tracked as a visualization gui record in the Lua family branch. The source did not provide a
...
For a systems engineer, cuid belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0e46f0620ddb8a` from `luarocks_root_manifest` as `registry_expansion`
