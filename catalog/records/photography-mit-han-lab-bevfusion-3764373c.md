...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mit-han-lab/bevfusion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mit-han-lab/bevfusion](https://github.com/mit-han-lab/bevfusion) |
| Source record ids | github_search_photography-bae6bf2e47dc65 |
...
For a systems engineer, mit-han-lab/bevfusion belongs in the Photography inventory as part of device
constraints, cross-compilation, driver behavior, and field upgrades.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-31T04:04:52Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
| Alert | Showcase candidate: permissive Apache-2.0 family; keep notices and patent/license obligations visible. |

## Engineering Notes

- Treat category as `embedded_hardware` unless a later verified source gives a better classification.
...
- `github_search_photography-bae6bf2e47dc65` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ceciliavision/zoom-learn-zoom | Embedded Hardware | [open](photography-ceciliavision-zoom-learn-zoom-503d7d27.md) |
| dorukkumkumoglu/optocamzero | Embedded Hardware | [open](photography-dorukkumkumoglu-optocamzero-fa33e18d.md) |
| IFL-CAMP/easy_handeye | Embedded Hardware | [open](photography-ifl-camp-easy-handeye-81e53bb4.md) |
| oleksiikutuzov/flipperzero-lightmeter | Embedded Hardware | [open](photography-oleksiikutuzov-flipperzero-lightmeter-74fb80aa.md) |
| Yutani140x/saturnix-camera | Embedded Hardware | [open](photography-yutani140x-saturnix-camera-7710cd32.md) |
