...
<!-- canonical: https://github.com/jOOQ/jOOQ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jOOQ/jOOQ](https://github.com/jOOQ/jOOQ) |
| Source record ids | github_search_databases-809c6d7bfbf522 |
...
For a systems engineer, jOOQ/jOOQ belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T11:35:03Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-809c6d7bfbf522` from `github_search_databases` as `registry_expansion`
