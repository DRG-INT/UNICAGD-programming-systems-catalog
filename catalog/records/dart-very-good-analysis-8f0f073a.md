...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Linter](../by-category/linter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/very_good_analysis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/very_good_analysis](https://pub.dev/packages/very_good_analysis) |
| Source record ids | pub_dev-4dc50dd7553194 |
...
For a systems engineer, very_good_analysis belongs in the Dart inventory as part of static feedback,
style policy, defect prevention, and local/CI quality gates.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-09-03T14:28:27.926923Z | [https://pub.dev/api/packages/very_good_analysis](https://pub.dev/api/packages/very_good_analysis) |  |
| preview | known | 11.0.0-rc.1 | 2026-08-17T13:00:49.353802Z | [https://pub.dev/api/packages/very_good_analysis](https://pub.dev/api/packages/very_good_analysis) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/very_good_analysis` at `2026-09-03T17:19:00+00:00`.
...
- `pub_dev-4dc50dd7553194` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| custom_lint | Linter | [open](dart-custom-lint-a4c140cd.md) |
| dart_code_linter | Linter | [open](dart-dart-code-linter-df03f02e.md) |
| flutter_lints | Linter | [open](dart-flutter-lints-e4a57b3e.md) |
| leancode_lint | Linter | [open](dart-leancode-lint-61fd34ed.md) |
| lint | Linter | [open](dart-lint-6875e6f7.md) |
| lints | Linter | [open](dart-lints-423e1c89.md) |
| pedantic_mono | Linter | [open](dart-pedantic-mono-d91c4612.md) |
