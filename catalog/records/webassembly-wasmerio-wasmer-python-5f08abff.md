...
<!-- canonical: https://github.com/wasmerio/wasmer-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wasmerio/wasmer-python](https://github.com/wasmerio/wasmer-python) |
| Source record ids | github_search_webassembly-4f582de129b786 |
...
For a systems engineer, wasmerio/wasmer-python belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-17T14:48:07Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-4f582de129b786` from `github_search_webassembly` as `registry_expansion`
