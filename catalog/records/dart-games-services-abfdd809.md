...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/games_services -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/games_services](https://pub.dev/packages/games_services) |
| Source record ids | pub_dev-7d973937e59017 |
...
For a systems engineer, games_services belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.0 | 2026-08-02T13:10:45.026697Z | [https://pub.dev/api/packages/games_services](https://pub.dev/api/packages/games_services) |  |
| preview | known | 2.0.0-nullsafety.3 | 2021-05-01T15:28:45.685446Z | [https://pub.dev/api/packages/games_services](https://pub.dev/api/packages/games_services) |  |
...
| Evidence | GPL (>= 2); The Unlicense; https://api.github.com/licenses/unlicense |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/games_services` at `2026-09-01T14:20:34+00:00`.
...
- `pub_dev-7d973937e59017` from `pub_dev` as `registry_expansion`
