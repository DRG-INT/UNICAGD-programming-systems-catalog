...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/zip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zip](https://hackage.haskell.org/package/zip) |
| Source record ids | hackage_top_downloads-9f85c3cad94f5b |
...
For a systems engineer, zip belongs in the Haskell inventory as part of ecosystem capability
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; MIT License; https://api.github.com/licenses/mit; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1 |
...
- `hackage_top_downloads-9f85c3cad94f5b` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| text-zipper | Compression | [open](haskell-text-zipper-6676f63d.md) |
| zip-archive | Compression | [open](haskell-zip-archive-3e16172e.md) |
| zstd | Compression | [open](haskell-zstd-01fb5311.md) |
