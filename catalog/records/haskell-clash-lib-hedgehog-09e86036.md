...
<!-- canonical: https://hackage.haskell.org/package/clash-lib-hedgehog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/clash-lib-hedgehog](https://hackage.haskell.org/package/clash-lib-hedgehog) |
| Source record ids | hackage_recent-4307de4136b7d8 |
...
For a systems engineer, clash-lib-hedgehog belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.2 | 2026-09-07T09:27:19Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-4307de4136b7d8` from `hackage_recent` as `registry_expansion`
