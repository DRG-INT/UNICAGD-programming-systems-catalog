...
<!-- canonical: https://crates.io/crates/neli-proc-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/neli-proc-macros](https://crates.io/crates/neli-proc-macros) |
| Source record ids | crates_io-b645973295b6e0 |
...
For a systems engineer, neli-proc-macros belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2025-12-08T18:26:17.419567Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
| Evidence | MIT; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
