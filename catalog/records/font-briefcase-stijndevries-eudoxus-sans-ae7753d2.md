# stijndevries/Eudoxus-Sans

## Navigation

[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/stijndevries/Eudoxus-Sans -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/stijndevries/Eudoxus-Sans](https://github.com/stijndevries/Eudoxus-Sans) |
| Source record ids | github_search_font_briefcase-3dce7fe8b208b6 |

## System Engineer Summary

This simple geometric font is named after the Greek mathematician Eudoxus of Cnidus. It is based on
+Jakarta Sans by tokotype.

## Operational Role

For a systems engineer, stijndevries/Eudoxus-Sans belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-01-07T21:50:48Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-3dce7fe8b208b6` from `github_search_font_briefcase` as `registry_expansion`
