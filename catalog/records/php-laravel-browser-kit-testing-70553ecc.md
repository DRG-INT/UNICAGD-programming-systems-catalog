...
<!-- canonical: https://packagist.org/packages/laravel/browser-kit-testing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/laravel/browser-kit-testing](https://packagist.org/packages/laravel/browser-kit-testing) |
| Source record ids | packagist_search-66087fce9f13de |
...
For a systems engineer, laravel/browser-kit-testing belongs in the PHP inventory as part of
...
- `packagist_search-66087fce9f13de` from `packagist_search` as `registry_expansion`
