...
<!-- canonical: https://github.com/kip-hart/AABBTree -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kip-hart/AABBTree](https://github.com/kip-hart/AABBTree) |
| Source record ids | github_search_physics_engines-cf8c544510f420 |
...
For a systems engineer, kip-hart/AABBTree belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-07T20:36:41Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-cf8c544510f420` from `github_search_physics_engines` as `registry_expansion`
