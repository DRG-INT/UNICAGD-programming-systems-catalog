...
<!-- canonical: https://gitlab.com/purelb/purelb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/purelb/purelb](https://gitlab.com/purelb/purelb) |
| Source record ids | gitlab_projects_api-7eca5faf106663 |

## System Engineer Summary

This is the Legacy version of PureLB. It is no longer in active development. New version
documentation at New version repo at You can still find us on the Slack channel. Slack channel:

## Operational Role

For a systems engineer, purelb/purelb belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-7eca5faf106663` from `gitlab_projects_api` as `registry_expansion`
