...
<!-- canonical: https://cran.r-project.org/web/packages/familiar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/familiar/index.html](https://cran.r-project.org/web/packages/familiar/index.html) |
| Source record ids | cran_packages_by_date-6fba14ae3079f9 |
...
For a systems engineer, familiar belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-08-21 21:00:39 UTC | [https://cran.r-project.org/web/packages/familiar/DESCRIPTION](https://cran.r-project.org/web/packages/familiar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/familiar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6fba14ae3079f9` from `cran_packages_by_date` as `registry_expansion`
