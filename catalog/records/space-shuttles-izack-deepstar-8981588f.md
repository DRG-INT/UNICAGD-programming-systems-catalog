...
<!-- canonical: https://github.com/Izack/Deepstar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Izack/Deepstar](https://github.com/Izack/Deepstar) |
| Source record ids | github_search_space_shuttles-6f22b773eb9564 |

## System Engineer Summary

Deep Space Vehicle for Orbiter Space Flight Simulator

## Operational Role

For a systems engineer, Izack/Deepstar belongs in the Space Shuttles inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-01-12T00:18:00Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-6f22b773eb9564` from `github_search_space_shuttles` as `registry_expansion`
