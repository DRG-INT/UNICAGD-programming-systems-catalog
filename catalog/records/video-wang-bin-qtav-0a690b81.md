...
| Canonical URL | [https://github.com/wang-bin/QtAV](https://github.com/wang-bin/QtAV) |
| Source record ids | github_search_video-5ca2696257d02a |

## System Engineer Summary

A cross-platform multimedia framework based on Qt and FFmpeg. 基于Qt和FFmpeg的跨平台高性能音视频播放框架. Recommand
to use new sdk

## Operational Role

For a systems engineer, wang-bin/QtAV belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.12.0 | 2017-06-21T01:58:55Z | [https://api.github.com/repos/wang-bin/QtAV/releases/latest](https://api.github.com/repos/wang-bin/QtAV/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wang-bin/QtAV/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-5ca2696257d02a` from `github_search_video` as `registry_expansion`
