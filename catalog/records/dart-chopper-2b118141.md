...
<!-- canonical: https://pub.dev/packages/chopper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/chopper](https://pub.dev/packages/chopper) |
| Source record ids | pub_dev-533c6b990c6b32 |
...
For a systems engineer, chopper belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.7.0 | 2026-07-15T17:05:31.557410Z | [https://pub.dev/api/packages/chopper](https://pub.dev/api/packages/chopper) |  |
| preview | known | 8.0.0-rc.2 | 2024-05-03T06:27:27.614371Z | [https://pub.dev/api/packages/chopper](https://pub.dev/api/packages/chopper) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/chopper` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-533c6b990c6b32` from `pub_dev` as `registry_expansion`
