...
<!-- canonical: https://github.com/homarr-labs/dashboard-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/homarr-labs/dashboard-icons](https://github.com/homarr-labs/dashboard-icons) |
| Source record ids | github_search_icons_and_logos-433d30f9f00bbd |
...
For a systems engineer, homarr-labs/dashboard-icons belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T12:24:27Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-433d30f9f00bbd` from `github_search_icons_and_logos` as `registry_expansion`
