...
<!-- canonical: https://cran.r-project.org/web/packages/washr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/washr/index.html](https://cran.r-project.org/web/packages/washr/index.html) |
| Source record ids | cran_packages_by_date-c71ec4dbfa24b0 |
...
For a systems engineer, washr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-02 11:10:02 UTC | [https://cran.r-project.org/web/packages/washr/DESCRIPTION](https://cran.r-project.org/web/packages/washr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/washr/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-c71ec4dbfa24b0` from `cran_packages_by_date` as `registry_expansion`
