...
| Canonical URL | [https://github.com/NeuroJSON/jsonlab](https://github.com/NeuroJSON/jsonlab) |
| Source record ids | github_search_matlab-d1586dda5e8bfa |
...
For a systems engineer, NeuroJSON/jsonlab belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.9.8 | 2024-03-28T20:19:31Z | [https://api.github.com/repos/NeuroJSON/jsonlab/releases/latest](https://api.github.com/repos/NeuroJSON/jsonlab/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/NeuroJSON/jsonlab/releases/latest` at `2026-09-01T07:24:12+00:00`.
...
- `github_search_matlab-d1586dda5e8bfa` from `github_search_matlab` as `registry_expansion`
