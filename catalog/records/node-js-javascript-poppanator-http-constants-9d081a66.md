...
<!-- canonical: https://www.npmjs.com/package/@poppanator/http-constants -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@poppanator/http-constants](https://www.npmjs.com/package/@poppanator/http-constants) |
| Source record ids | npm_registry-b4ac0a49ae4bc7 |

## System Engineer Summary

This package contains various HTTP constants: http status codes and texts, HTTP header names and
HTTP methods, and a few related utility function.

## Operational Role

For a systems engineer, @poppanator/http-constants belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-10-02T05:42:48.745Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-b4ac0a49ae4bc7` from `npm_registry` as `registry_expansion`
