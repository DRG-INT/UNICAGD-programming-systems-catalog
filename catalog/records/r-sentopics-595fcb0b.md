...
<!-- canonical: https://cran.r-project.org/web/packages/sentopics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sentopics/index.html](https://cran.r-project.org/web/packages/sentopics/index.html) |
| Source record ids | cran_packages_by_date-d19dd65e6c5f5c |
...
For a systems engineer, sentopics belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-21 13:20:02 UTC | [https://cran.r-project.org/web/packages/sentopics/DESCRIPTION](https://cran.r-project.org/web/packages/sentopics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sentopics/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-d19dd65e6c5f5c` from `cran_packages_by_date` as `registry_expansion`
