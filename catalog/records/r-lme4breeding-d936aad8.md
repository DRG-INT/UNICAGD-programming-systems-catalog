...
<!-- canonical: https://cran.r-project.org/web/packages/lme4breeding/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lme4breeding/index.html](https://cran.r-project.org/web/packages/lme4breeding/index.html) |
| Source record ids | cran_packages_by_date-8fe7e0d71327f7 |
...
For a systems engineer, lme4breeding belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-09-11 06:40:15 UTC | [https://cran.r-project.org/web/packages/lme4breeding/DESCRIPTION](https://cran.r-project.org/web/packages/lme4breeding/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lme4breeding/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-8fe7e0d71327f7` from `cran_packages_by_date` as `registry_expansion`
