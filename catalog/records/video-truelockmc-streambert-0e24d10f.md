...
<!-- canonical: https://github.com/truelockmc/streambert -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/truelockmc/streambert](https://github.com/truelockmc/streambert) |
| Source record ids | github_search_video-2fda46eb535e81 |

## System Engineer Summary

A cross-platform Electron Desktop App to stream and download any Movie, TV Series or Anime in the
World. Zero Ads and Tracking

## Operational Role

For a systems engineer, truelockmc/streambert belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-06T13:06:09Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-2fda46eb535e81` from `github_search_video` as `registry_expansion`
