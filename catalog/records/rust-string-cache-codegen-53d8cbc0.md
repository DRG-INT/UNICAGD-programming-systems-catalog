...
<!-- canonical: https://crates.io/crates/string_cache_codegen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/string_cache_codegen](https://crates.io/crates/string_cache_codegen) |
| Source record ids | crates_io-c86668f75df3a9 |
...
For a systems engineer, string_cache_codegen belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.2 | 2026-09-14T16:33:40.622431Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-14T18:22:57+00:00`.
...
- `crates_io-c86668f75df3a9` from `crates_io` as `registry_expansion`
