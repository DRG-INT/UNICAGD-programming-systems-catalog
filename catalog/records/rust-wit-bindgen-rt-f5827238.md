...
<!-- canonical: https://crates.io/crates/wit-bindgen-rt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wit-bindgen-rt](https://crates.io/crates/wit-bindgen-rt) |
| Source record ids | crates_io-5a6f832d8c5887 |
...
For a systems engineer, wit-bindgen-rt belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.44.0 | 2025-12-05T18:56:04.277517Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-5a6f832d8c5887` from `crates_io` as `registry_expansion`
