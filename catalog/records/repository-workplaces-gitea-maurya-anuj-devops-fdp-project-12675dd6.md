# Gitea: maurya.anuj/Devops_FDP_project
...
<!-- canonical: https://gitea.com/maurya.anuj/Devops_FDP_project -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/maurya.anuj/Devops_FDP_project](https://gitea.com/maurya.anuj/Devops_FDP_project) |
| Source record ids | gitea_repositories_api-29fd2faf0e681a |
...
For a systems engineer, Gitea: maurya.anuj/Devops_FDP_project belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T17:16:57Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-29fd2faf0e681a` from `gitea_repositories_api` as `registry_expansion`
