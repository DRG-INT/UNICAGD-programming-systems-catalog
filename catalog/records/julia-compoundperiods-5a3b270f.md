...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CompoundPeriods](https://github.com/JuliaRegistries/General/tree/master/C/CompoundPeriods) |
| Source record ids | julia_general-16aadd2632eb0c |

## System Engineer Summary

Julia package registered in General at C/CompoundPeriods.

## Operational Role

For a systems engineer, CompoundPeriods belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CompoundPeriods", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-16aadd2632eb0c` from `julia_general` as `registry_expansion`
