...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lcx366/STARQUERY -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lcx366/STARQUERY](https://github.com/lcx366/STARQUERY) |
| Source record ids | github_search_space_maps-2eed8e42075813 |

## System Engineer Summary

This package is an archive of scientific routines for establishing an offline star catalog query
database.

## Operational Role

For a systems engineer, lcx366/STARQUERY belongs in the Space Maps inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-14T07:23:00Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2eed8e42075813` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jonathansick/starplex | Database Datastore | [open](space-maps-jonathansick-starplex-44c11af0.md) |
| michaelaye/spice-kernel-db | Database Datastore | [open](space-maps-michaelaye-spice-kernel-db-8863efeb.md) |
| SPICE Kernels | Database Datastore | [open](space-maps-spice-kernels-d9cb0db7.md) |
