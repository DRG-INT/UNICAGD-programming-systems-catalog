...
<!-- canonical: https://cran.r-project.org/web/packages/oneway/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/oneway/index.html](https://cran.r-project.org/web/packages/oneway/index.html) |
| Source record ids | cran_packages_by_date-2a042152c1f5bc |
...
For a systems engineer, oneway belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-09-15 13:20:02 UTC | [https://cran.r-project.org/web/packages/oneway/DESCRIPTION](https://cran.r-project.org/web/packages/oneway/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/oneway/DESCRIPTION` at `2026-09-15T14:21:25+00:00`.
...
- `cran_packages_by_date-2a042152c1f5bc` from `cran_packages_by_date` as `registry_expansion`
