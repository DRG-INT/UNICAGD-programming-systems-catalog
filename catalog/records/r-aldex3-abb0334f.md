...
<!-- canonical: https://cran.r-project.org/web/packages/ALDEx3/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ALDEx3/index.html](https://cran.r-project.org/web/packages/ALDEx3/index.html) |
| Source record ids | cran_packages_by_date-5fc5fdf83c606b |
...
For a systems engineer, ALDEx3 belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.1 | 2026-08-26 15:40:02 UTC | [https://cran.r-project.org/web/packages/ALDEx3/DESCRIPTION](https://cran.r-project.org/web/packages/ALDEx3/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ALDEx3/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5fc5fdf83c606b` from `cran_packages_by_date` as `registry_expansion`
