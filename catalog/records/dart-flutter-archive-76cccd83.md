...
<!-- canonical: https://pub.dev/packages/flutter_archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_archive](https://pub.dev/packages/flutter_archive) |
| Source record ids | pub_dev-616d4dc7f9ec91 |

## System Engineer Summary

Create and extract ZIP archive files in Android, iOS and macOS. Zip all files in a directory
recursively or a given list of files.

## Operational Role

For a systems engineer, flutter_archive belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.3.1 | 2026-06-24T08:32:54.038713Z | [https://pub.dev/api/packages/flutter_archive](https://pub.dev/api/packages/flutter_archive) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_archive` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-616d4dc7f9ec91` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| flutter_image_compress | Compression | [open](dart-flutter-image-compress-1b3cabe6.md) |
