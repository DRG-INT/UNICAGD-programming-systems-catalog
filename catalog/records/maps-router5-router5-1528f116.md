...
<!-- canonical: https://github.com/router5/router5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/router5/router5](https://github.com/router5/router5) |
| Source record ids | github_search_maps-2a7fe0ea84b99b |
...
For a systems engineer, router5/router5 belongs in the Maps inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-07T05:57:10Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_maps-2a7fe0ea84b99b` from `github_search_maps` as `registry_expansion`
