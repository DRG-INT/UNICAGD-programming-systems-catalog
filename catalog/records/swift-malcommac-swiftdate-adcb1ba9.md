...
<!-- canonical: https://github.com/malcommac/SwiftDate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/malcommac/SwiftDate](https://github.com/malcommac/SwiftDate) |
| Source record ids | github_search_swift-82ccf1a3fb5f0c |
...
For a systems engineer, malcommac/SwiftDate belongs in the Swift inventory as part of low-noise code
...
- `github_search_swift-82ccf1a3fb5f0c` from `github_search_swift` as `registry_expansion`
