...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BilevelJuMP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BilevelJuMP](https://github.com/JuliaRegistries/General/tree/master/B/BilevelJuMP) |
| Source record ids | julia_general-db8df49cf502db |

## System Engineer Summary

Julia package registered in General at B/BilevelJuMP.

## Operational Role

For a systems engineer, BilevelJuMP belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BilevelJuMP", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-db8df49cf502db` from `julia_general` as `registry_expansion`
