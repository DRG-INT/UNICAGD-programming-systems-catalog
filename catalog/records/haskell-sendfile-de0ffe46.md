...
<!-- canonical: https://hackage.haskell.org/package/sendfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/sendfile](https://hackage.haskell.org/package/sendfile) |
| Source record ids | hackage_top_downloads-5c585076aca9bf |
...
For a systems engineer, sendfile belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.11.6 | 2024-05-23T16:49:12Z | [https://hackage.haskell.org/package/sendfile](https://hackage.haskell.org/package/sendfile) |  |
| candidate | partial | 0.7.10 |  | [https://hackage.haskell.org/package/sendfile](https://hackage.haskell.org/package/sendfile) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/sendfile` at `2026-09-06T00:34:56+00:00`.
...
- `hackage_top_downloads-5c585076aca9bf` from `hackage_top_downloads` as `registry_expansion`
