...
<!-- canonical: https://hackage.haskell.org/package/distributed-process-simplelocalnet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/distributed-process-simplelocalnet](https://hackage.haskell.org/package/distributed-process-simplelocalnet) |
| Source record ids | hackage_top_downloads-1ba5298f4dc99e |
...
For a systems engineer, distributed-process-simplelocalnet belongs in the Haskell inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.3 | 2025-02-05T01:53:45Z | [https://hackage.haskell.org/package/distributed-process-simplelocalnet](https://hackage.haskell.org/package/distributed-process-simplelocalnet) |  |
| candidate | partial | 0.2.1.0 |  | [https://hackage.haskell.org/package/distributed-process-simplelocalnet](https://hackage.haskell.org/package/distributed-process-simplelocalnet) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/distributed-process-simplelocalnet` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-1ba5298f4dc99e` from `hackage_top_downloads` as `registry_expansion`
