...
<!-- canonical: https://cran.r-project.org/web/packages/NGSToolKit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NGSToolKit/index.html](https://cran.r-project.org/web/packages/NGSToolKit/index.html) |
| Source record ids | cran_packages_by_date-e7a785471cf90e |

## System Engineer Summary

RNA-Seq Analysis and Genome Visualization 'Shiny' Platform

## Operational Role

For a systems engineer, NGSToolKit belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-12 13:40:22 UTC | [https://cran.r-project.org/web/packages/NGSToolKit/DESCRIPTION](https://cran.r-project.org/web/packages/NGSToolKit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NGSToolKit/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-e7a785471cf90e` from `cran_packages_by_date` as `registry_expansion`
