...
| Source record ids | github_search_effects-d9a94bd6746c54 |
...
For a systems engineer, josevcm/nfc-laboratory belongs in the Effects inventory as part of defect
...
| Evidence | GPL (>= 2); Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-d9a94bd6746c54` from `github_search_effects` as `registry_expansion`
