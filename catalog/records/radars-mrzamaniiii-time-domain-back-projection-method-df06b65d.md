# mrzamaniiii/Time-Domain-Back-Projection-Method
...
<!-- canonical: https://github.com/mrzamaniiii/Time-Domain-Back-Projection-Method -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mrzamaniiii/Time-Domain-Back-Projection-Method](https://github.com/mrzamaniiii/Time-Domain-Back-Projection-Method) |
| Source record ids | github_search_radars-3f9acdf7019d7e |

## System Engineer Summary

This project implements the Time-Domain Back-Projection (TDBP) algorithm for Synthetic Aperture
Radar (SAR) image reconstruction.

## Operational Role

For a systems engineer, mrzamaniiii/Time-Domain-Back-Projection-Method belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T08:24:37Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3f9acdf7019d7e` from `github_search_radars` as `registry_expansion`
