...
<!-- canonical: https://cran.r-project.org/web/packages/rmoriebricklayer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rmoriebricklayer/index.html](https://cran.r-project.org/web/packages/rmoriebricklayer/index.html) |
| Source record ids | cran_packages_by_date-c97af1f9ddace8 |
...
For a systems engineer, rmoriebricklayer belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7 | 2026-08-05 06:40:02 UTC | [https://cran.r-project.org/web/packages/rmoriebricklayer/DESCRIPTION](https://cran.r-project.org/web/packages/rmoriebricklayer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rmoriebricklayer/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c97af1f9ddace8` from `cran_packages_by_date` as `registry_expansion`
