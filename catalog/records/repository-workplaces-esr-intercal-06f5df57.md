...
<!-- canonical: https://gitlab.com/esr/intercal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/esr/intercal](https://gitlab.com/esr/intercal) |
| Source record ids | gitlab_projects_api-af9e557b12756c |

## System Engineer Summary

A compiler for the INTERCAL language. INTERCAL is the original esoteric language, a farrago of
features that will test the mettle of any programmer and bend the minds of most. Includesa compiler,
debugger, and sample code.

## Operational Role

For a systems engineer, esr/intercal belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-af9e557b12756c` from `gitlab_projects_api` as `registry_expansion`
