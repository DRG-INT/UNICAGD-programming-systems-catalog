...
<!-- canonical: https://github.com/KDE/filelight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KDE/filelight](https://github.com/KDE/filelight) |
| Source record ids | github_search_space_maps-55b4a75a0e90f8 |
...
For a systems engineer, KDE/filelight belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:07:58Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-55b4a75a0e90f8` from `github_search_space_maps` as `registry_expansion`
