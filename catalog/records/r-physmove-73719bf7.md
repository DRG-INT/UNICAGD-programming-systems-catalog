...
<!-- canonical: https://cran.r-project.org/web/packages/PhysMove/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PhysMove/index.html](https://cran.r-project.org/web/packages/PhysMove/index.html) |
| Source record ids | cran_packages_by_date-0c6860fa58a5f5 |
...
For a systems engineer, PhysMove belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.5 | 2026-08-21 07:50:08 UTC | [https://cran.r-project.org/web/packages/PhysMove/DESCRIPTION](https://cran.r-project.org/web/packages/PhysMove/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PhysMove/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0c6860fa58a5f5` from `cran_packages_by_date` as `registry_expansion`
