...
<!-- canonical: https://luarocks.org/modules/mah0x211/argexpected -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/argexpected](https://luarocks.org/modules/mah0x211/argexpected) |
| Source record ids | luarocks_root_manifest-a0002f1ddfeadd |
...
For a systems engineer, argexpected belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a0002f1ddfeadd` from `luarocks_root_manifest` as `registry_expansion`
