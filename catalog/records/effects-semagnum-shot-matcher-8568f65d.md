...
<!-- canonical: https://github.com/semagnum/shot_matcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/semagnum/shot_matcher](https://github.com/semagnum/shot_matcher) |
| Source record ids | github_search_effects-ac395c39367acd |
...
For a systems engineer, semagnum/shot_matcher belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-08-09T19:33:55Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-ac395c39367acd` from `github_search_effects` as `registry_expansion`
