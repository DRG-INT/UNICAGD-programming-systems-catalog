...
<!-- canonical: https://github.com/GregTJ/stable-fluids -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GregTJ/stable-fluids](https://github.com/GregTJ/stable-fluids) |
| Source record ids | github_search_physics_engines-bdd7a308dcbdd6 |
...
For a systems engineer, GregTJ/stable-fluids belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-01-11T04:06:25Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense |
...
- `github_search_physics_engines-bdd7a308dcbdd6` from `github_search_physics_engines` as `registry_expansion`
