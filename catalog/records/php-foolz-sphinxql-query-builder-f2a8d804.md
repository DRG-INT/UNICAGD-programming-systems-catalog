...
<!-- canonical: https://packagist.org/packages/foolz/sphinxql-query-builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/foolz/sphinxql-query-builder](https://packagist.org/packages/foolz/sphinxql-query-builder) |
| Source record ids | packagist_search-93a97794aa9c1d |
...
For a systems engineer, foolz/sphinxql-query-builder belongs in the PHP inventory as part of build
...
- `packagist_search-93a97794aa9c1d` from `packagist_search` as `registry_expansion`
