...
<!-- canonical: https://github.com/AhmadHassan-BTed/EQAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AhmadHassan-BTed/EQAI](https://github.com/AhmadHassan-BTed/EQAI) |
| Source record ids | github_search_assets-28c2054d9ee145 |

## System Engineer Summary

A highly specialized reverse-engineering pipeline designed to structurally transplant original
Vanilla character models into the EverQuest Online Adventures: Frontiers (PS2) game engine,
resolving complex Vector Unit 1 (VU1) shader bugs, Emotion Engine (EE) memory overflows, and PS2
CDVDman hardware faults.

## Operational Role

For a systems engineer, AhmadHassan-BTed/EQAI belongs in the Assets inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T07:34:53Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-28c2054d9ee145` from `github_search_assets` as `registry_expansion`
...
| jbrodriguez/hugulp | Package Manager | [open](assets-jbrodriguez-hugulp-9ef7796c.md) |
