...
<!-- canonical: https://github.com/THU-SI/Physics3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/THU-SI/Physics3D](https://github.com/THU-SI/Physics3D) |
| Source record ids | github_search_physics_engines-8c210d8b87cfef |

## System Engineer Summary

Official implementation of Physics3D: Learning Physical Properties of 3D Gaussians via Video
Diffusion

## Operational Role

For a systems engineer, THU-SI/Physics3D belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-12T10:28:25Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8c210d8b87cfef` from `github_search_physics_engines` as `registry_expansion`
