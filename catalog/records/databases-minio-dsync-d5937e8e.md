...
<!-- canonical: https://github.com/minio/dsync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/minio/dsync](https://github.com/minio/dsync) |
| Source record ids | github_search_databases-7fbc4936986079 |
...
For a systems engineer, minio/dsync belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-11-12T10:46:21Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; SIL Open Font License 1.1; https://api.github.com/licenses/ofl-1.1; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_databases-7fbc4936986079` from `github_search_databases` as `registry_expansion`
