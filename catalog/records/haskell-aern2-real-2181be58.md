...
<!-- canonical: https://hackage.haskell.org/package/aern2-real -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/aern2-real](https://hackage.haskell.org/package/aern2-real) |
| Source record ids | hackage_top_downloads-bfa19b08e952c8 |
...
For a systems engineer, aern2-real belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.16.1 | 2024-10-05T23:08:15Z | [https://hackage.haskell.org/package/aern2-real](https://hackage.haskell.org/package/aern2-real) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/aern2-real` at `2026-09-12T00:29:06+00:00`.
...
- `hackage_top_downloads-bfa19b08e952c8` from `hackage_top_downloads` as `registry_expansion`
