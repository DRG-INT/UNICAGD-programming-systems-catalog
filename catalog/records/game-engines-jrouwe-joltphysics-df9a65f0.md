...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jrouwe/JoltPhysics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jrouwe/JoltPhysics](https://github.com/jrouwe/JoltPhysics) |
| Source record ids | github_search_game_engines-aaae26b9b4c059 |

## System Engineer Summary

A multi core friendly rigid body physics and collision detection library. Written in C++. Suitable
for games and VR applications. Used by Horizon Forbidden West and Death Stranding 2.

## Operational Role

For a systems engineer, jrouwe/JoltPhysics belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T05:12:38Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-aaae26b9b4c059` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bevyengine/bevy | Visualization Gui | [open](game-engines-bevyengine-bevy-a5bfd46e.md) |
| emilk/egui | Visualization Gui | [open](game-engines-emilk-egui-3281d5d1.md) |
| liuhaopen/UnityMMO | Visualization Gui | [open](game-engines-liuhaopen-unitymmo-fdab29a9.md) |
