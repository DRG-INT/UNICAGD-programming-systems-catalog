...
<!-- canonical: https://luarocks.org/modules/neorocks/base16-nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/base16-nvim](https://luarocks.org/modules/neorocks/base16-nvim) |
| Source record ids | luarocks_root_manifest-9133c92c576b1a |

## System Engineer Summary

Neovim plugin for building a sync base16 colorscheme. Includes support for Treesitter and LSP
highlight groups.

## Operational Role

For a systems engineer, base16-nvim belongs in the Lua family inventory as part of build graph
...
- `luarocks_root_manifest-9133c92c576b1a` from `luarocks_root_manifest` as `registry_expansion`
