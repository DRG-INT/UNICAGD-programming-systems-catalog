# address-finder-data-p02

## Navigation

[Catalog index](../index.md) · [Language: Python](../by-language/python.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pypi.org/project/address-finder-data-p02/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-finder-data-p02/](https://pypi.org/project/address-finder-data-p02/) |
| Source record ids | pypi_simple-1f7690d8cf61fc |

## System Engineer Summary

address-finder data chunk p02 - contains address_parser_crf.dat part 3/5

## Operational Role

For a systems engineer, address-finder-data-p02 belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-03-20T17:36:02.321573Z | [https://pypi.org/pypi/address-finder-data-p02/json](https://pypi.org/pypi/address-finder-data-p02/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-finder-data-p02/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-1f7690d8cf61fc` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 41datastructure | Parser Lexer Ast | [open](python-41datastructure-0cd860a9.md) |
| 4lt7ab-grimoire-cli | Parser Lexer Ast | [open](python-4lt7ab-grimoire-cli-ca95aa16.md) |
| a3ddddocr-client | Parser Lexer Ast | [open](python-a3ddddocr-client-760e12f7.md) |
| aad-fastapi | Parser Lexer Ast | [open](python-aad-fastapi-92d291e1.md) |
| aad-fastapi-dl37 | Parser Lexer Ast | [open](python-aad-fastapi-dl37-f84f55d3.md) |
| aad-fastapi-dlg | Parser Lexer Ast | [open](python-aad-fastapi-dlg-6fbb8ff4.md) |
| aad-fastapi-dorlugasigal | Parser Lexer Ast | [open](python-aad-fastapi-dorlugasigal-ccf19501.md) |
| aamva-parser | Parser Lexer Ast | [open](python-aamva-parser-d80f34b1.md) |
