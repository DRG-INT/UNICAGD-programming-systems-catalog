...
<!-- canonical: https://crates.io/crates/windows_i686_gnu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows_i686_gnu](https://crates.io/crates/windows_i686_gnu) |
| Source record ids | crates_io-06c7ada9113bcc |

## System Engineer Summary

windows_i686_gnu is tracked as a library record in the Rust branch. The source did not provide a
...
For a systems engineer, windows_i686_gnu belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.53.1 | 2025-10-06T17:33:40.576678Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-06c7ada9113bcc` from `crates_io` as `registry_expansion`
