...
<!-- canonical: https://cran.r-project.org/web/packages/SpatMix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SpatMix/index.html](https://cran.r-project.org/web/packages/SpatMix/index.html) |
| Source record ids | cran_packages_by_date-1170e0f7abc1da |

## System Engineer Summary

Spatial Mixture Models for Clustering

## Operational Role

For a systems engineer, SpatMix belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-09 15:30:19 UTC | [https://cran.r-project.org/web/packages/SpatMix/DESCRIPTION](https://cran.r-project.org/web/packages/SpatMix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SpatMix/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-1170e0f7abc1da` from `cran_packages_by_date` as `registry_expansion`
