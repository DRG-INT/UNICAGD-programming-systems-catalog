...
<!-- canonical: https://github.com/labstack/echo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/labstack/echo](https://github.com/labstack/echo) |
| Source record ids | github_search_go-be73cbaff3e644 |
...
For a systems engineer, labstack/echo belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T05:43:10Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-be73cbaff3e644` from `github_search_go` as `registry_expansion`
