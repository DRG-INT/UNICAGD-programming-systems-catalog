...
[Catalog index](../index.md) · [Language: Video](../by-language/video.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aetaric/checkrr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aetaric/checkrr](https://github.com/aetaric/checkrr) |
| Source record ids | github_search_video-46fd027b6add5e |

## System Engineer Summary

Checkrr Scans your library files for corrupt media and optionally replaces the files via sonarr and
radarr

## Operational Role

For a systems engineer, aetaric/checkrr belongs in the Video inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-11T16:19:17Z | gh search repos topic:video-processing stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-46fd027b6add5e` from `github_search_video` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| byjlw/video-analyzer | Static Analyzer | [open](video-byjlw-video-analyzer-128898c4.md) |
| rosenbjerg/FFMpegCore | Static Analyzer | [open](video-rosenbjerg-ffmpegcore-abd0f842.md) |
| videoflow/videoflow | Static Analyzer | [open](video-videoflow-videoflow-5e9a03c8.md) |
