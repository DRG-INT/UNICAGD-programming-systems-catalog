...
<!-- canonical: https://cran.r-project.org/web/packages/LUCIDus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LUCIDus/index.html](https://cran.r-project.org/web/packages/LUCIDus/index.html) |
| Source record ids | cran_packages_by_date-ed2d347250e8ed |
...
For a systems engineer, LUCIDus belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.1 | 2026-09-02 17:10:14 UTC | [https://cran.r-project.org/web/packages/LUCIDus/DESCRIPTION](https://cran.r-project.org/web/packages/LUCIDus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LUCIDus/DESCRIPTION` at `2026-09-02T17:18:40+00:00`.
...
- `cran_packages_by_date-ed2d347250e8ed` from `cran_packages_by_date` as `registry_expansion`
