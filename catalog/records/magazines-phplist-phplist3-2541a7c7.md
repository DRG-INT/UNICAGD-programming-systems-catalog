...
<!-- canonical: https://github.com/phpList/phplist3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/phpList/phplist3](https://github.com/phpList/phplist3) |
| Source record ids | github_search_magazines-aa8aa2243b34f2 |

## System Engineer Summary

Fully functional Open Source email marketing manager for creating, sending, integrating, and
analysing email campaigns and newsletters.

## Operational Role

For a systems engineer, phpList/phplist3 belongs in the Magazines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T10:49:51Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-aa8aa2243b34f2` from `github_search_magazines` as `registry_expansion`
