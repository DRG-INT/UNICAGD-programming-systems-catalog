# NCherfaoui/Mini_Projects

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/NCherfaoui/Mini_Projects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NCherfaoui/Mini_Projects](https://github.com/NCherfaoui/Mini_Projects) |
| Source record ids | github_search_repertoare_catalogs-cf845096919a2d |

## System Engineer Summary

Une collection de mini projets démontrant mes compétences en développement web. Explorez les
différents répertoires pour découvrir des projets variés et créatifs.

## Operational Role

For a systems engineer, NCherfaoui/Mini_Projects belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-12-28T21:31:02Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-cf845096919a2d` from `github_search_repertoare_catalogs` as `registry_expansion`
