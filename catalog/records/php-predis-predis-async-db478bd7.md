...
<!-- canonical: https://packagist.org/packages/predis/predis-async -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/predis/predis-async](https://packagist.org/packages/predis/predis-async) |
| Source record ids | packagist_search-24ea37aaa5c485 |
...
For a systems engineer, predis/predis-async belongs in the PHP inventory as part of concurrency
...
- `packagist_search-24ea37aaa5c485` from `packagist_search` as `registry_expansion`
