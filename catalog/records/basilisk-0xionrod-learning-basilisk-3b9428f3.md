...
<!-- canonical: https://github.com/0xIonRod/learning-basilisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/0xIonRod/learning-basilisk](https://github.com/0xIonRod/learning-basilisk) |
| Source record ids | github_search_basilisk-1242441c11d619 |

## System Engineer Summary

Learning Basilisk by AVS - Astrodynamics Simulation Framework

## Operational Role

For a systems engineer, 0xIonRod/learning-basilisk belongs in the Basilisk inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-28T06:42:25Z | gh search repos basilisk astrodynamics | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | Other; zlib License; https://api.github.com/licenses/zlib; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_basilisk-1242441c11d619` from `github_search_basilisk` as `registry_expansion`
