...
<!-- canonical: https://cran.r-project.org/web/packages/phdid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/phdid/index.html](https://cran.r-project.org/web/packages/phdid/index.html) |
| Source record ids | cran_packages_by_date-b704cf62abca23 |
...
For a systems engineer, phdid belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-15 12:00:02 UTC | [https://cran.r-project.org/web/packages/phdid/DESCRIPTION](https://cran.r-project.org/web/packages/phdid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/phdid/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-b704cf62abca23` from `cran_packages_by_date` as `registry_expansion`
