...
| Canonical URL | [https://luarocks.org/modules/neorocks/git-blame.nvim](https://luarocks.org/modules/neorocks/git-blame.nvim) |
| Source record ids | luarocks_root_manifest-0e8a0e9fc04f9c |
...
For a systems engineer, git-blame.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-0e8a0e9fc04f9c` from `luarocks_root_manifest` as `registry_expansion`
