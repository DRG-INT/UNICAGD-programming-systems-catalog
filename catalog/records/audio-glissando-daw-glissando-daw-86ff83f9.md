...
<!-- canonical: https://github.com/glissando-daw/glissando-daw -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/glissando-daw/glissando-daw](https://github.com/glissando-daw/glissando-daw) |
| Source record ids | github_search_audio-cd78fd058b8d9a |

## System Engineer Summary

A web-based digital audio workstation using the web platform APIs (Web Audio, Web MIDI) and
WebAssembly

## Operational Role

For a systems engineer, glissando-daw/glissando-daw belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-20T23:12:06Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-cd78fd058b8d9a` from `github_search_audio` as `registry_expansion`
