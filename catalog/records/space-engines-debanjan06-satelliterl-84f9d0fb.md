...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/debanjan06/SatelliteRL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/debanjan06/SatelliteRL](https://github.com/debanjan06/SatelliteRL) |
| Source record ids | github_search_space_engines-4dc934ada60688 |

## System Engineer Summary

Reinforcement Learning for Autonomous Satellite Constellation Scheduling and Earth Observation
Optimization

## Operational Role

For a systems engineer, debanjan06/SatelliteRL belongs in the Space Engines inventory as part of
...
- `github_search_space_engines-4dc934ada60688` from `github_search_space_engines` as `registry_expansion`
