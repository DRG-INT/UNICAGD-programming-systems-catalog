...
<!-- canonical: https://github.com/electerm/electerm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/electerm/electerm](https://github.com/electerm/electerm) |
| Source record ids | github_search_space_maps-ce7f91a14659b8 |

## System Engineer Summary

📻Free and open-sourced terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client(Linux, Mac,
Windows, Android, HarmonyOS, iOS)

## Operational Role

For a systems engineer, electerm/electerm belongs in the Space Maps inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T13:02:13Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-ce7f91a14659b8` from `github_search_space_maps` as `registry_expansion`
