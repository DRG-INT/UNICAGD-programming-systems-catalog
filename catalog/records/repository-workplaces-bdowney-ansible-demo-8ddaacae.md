...
<!-- canonical: https://gitlab.com/bdowney/ansible-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/bdowney/ansible-demo](https://gitlab.com/bdowney/ansible-demo) |
| Source record ids | gitlab_projects_api-8416f5f720c9a7 |

## System Engineer Summary

Demo of Ansible CI/CD for #NetDevOps using RedHat Training Course for Ansible Network Automation
from

## Operational Role

For a systems engineer, bdowney/ansible-demo belongs in the Repository Workplaces inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-24T10:07:47.956Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-8416f5f720c9a7` from `gitlab_projects_api` as `registry_expansion`
