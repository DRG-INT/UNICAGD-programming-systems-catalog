...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/KrishAmal/NavAR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KrishAmal/NavAR](https://github.com/KrishAmal/NavAR) |
| Source record ids | github_search_maps-7c7508f3ead432 |

## System Engineer Summary

NavAR is a location based augmented reality navigation application for Android. It features AR
powered Point of Interest Browser and a real-time AR navigation system , assisting you while on a
drive.

## Operational Role

For a systems engineer, KrishAmal/NavAR belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-11-27T08:49:22Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7c7508f3ead432` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| alyssaxuu/mapus | Datetime | [open](maps-alyssaxuu-mapus-f3252e0c.md) |
| ipverse/country-ip-blocks | Datetime | [open](maps-ipverse-country-ip-blocks-ef00e53f.md) |
| mo7amedaliEbaid/islamic | Datetime | [open](maps-mo7amedaliebaid-islamic-e85cbd46.md) |
| spatie/google-time-zone | Datetime | [open](maps-spatie-google-time-zone-1eea03a7.md) |
