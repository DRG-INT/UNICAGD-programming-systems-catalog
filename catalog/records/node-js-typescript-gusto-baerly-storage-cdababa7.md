...
<!-- canonical: https://www.npmjs.com/package/@gusto/baerly-storage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@gusto/baerly-storage](https://www.npmjs.com/package/@gusto/baerly-storage) |
| Source record ids | npm_registry-8d24f423f183ee |

## System Engineer Summary

Document database for S3 and Cloudflare R2 that runs in your request handler — tiny, LLM-friendly
TypeScript API, no database server

## Operational Role

For a systems engineer, @gusto/baerly-storage belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-07-16T00:51:37.962Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-8d24f423f183ee` from `npm_registry` as `registry_expansion`
