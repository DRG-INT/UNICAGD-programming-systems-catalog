...
<!-- canonical: https://github.com/uber/marmaray -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/uber/marmaray](https://github.com/uber/marmaray) |
| Source record ids | github_search_databases-43fab5058a849c |
...
For a systems engineer, uber/marmaray belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-19T23:03:14Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-43fab5058a849c` from `github_search_databases` as `registry_expansion`
