...
<!-- canonical: https://github.com/leocavalcante/siler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leocavalcante/siler](https://github.com/leocavalcante/siler) |
| Source record ids | github_search_maps-1f7dc3058ac30d |

## System Engineer Summary

⚡ Flat-files and plain-old PHP functions rockin'on as a set of general purpose high-level
abstractions.

## Operational Role

For a systems engineer, leocavalcante/siler belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-13T14:04:09Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1f7dc3058ac30d` from `github_search_maps` as `registry_expansion`
