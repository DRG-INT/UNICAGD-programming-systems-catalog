...
<!-- canonical: https://www.npmjs.com/package/moo-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/moo-server](https://www.npmjs.com/package/moo-server) |
| Source record ids | npm_registry-57d7119a92c509 |

## System Engineer Summary

a server version of mootools

## Operational Role

For a systems engineer, moo-server belongs in the Node.js/JavaScript inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2011-12-17T18:47:56.332Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-57d7119a92c509` from `npm_registry` as `registry_expansion`
