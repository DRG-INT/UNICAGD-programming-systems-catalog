...
<!-- canonical: https://pypi.org/project/adi-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adi-parser/](https://pypi.org/project/adi-parser/) |
| Source record ids | pypi_simple-f65728ab8372ec |
...
For a systems engineer, adi-parser belongs in the Python inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2023-12-11T02:18:57.750844Z | [https://pypi.org/pypi/adi-parser/json](https://pypi.org/pypi/adi-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adi-parser/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-f65728ab8372ec` from `pypi_simple` as `registry_expansion`
