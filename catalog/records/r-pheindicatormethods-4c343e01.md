...
<!-- canonical: https://cran.r-project.org/web/packages/PHEindicatormethods/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PHEindicatormethods/index.html](https://cran.r-project.org/web/packages/PHEindicatormethods/index.html) |
| Source record ids | cran_packages_by_date-cb6e3b3800e4c2 |
...
For a systems engineer, PHEindicatormethods belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2026-09-14 23:10:02 UTC | [https://cran.r-project.org/web/packages/PHEindicatormethods/DESCRIPTION](https://cran.r-project.org/web/packages/PHEindicatormethods/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PHEindicatormethods/DESCRIPTION` at `2026-09-15T00:28:05+00:00`.
...
- `cran_packages_by_date-cb6e3b3800e4c2` from `cran_packages_by_date` as `registry_expansion`
