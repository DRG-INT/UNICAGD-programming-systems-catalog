...
<!-- canonical: https://github.com/rnissel/FBMC -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rnissel/FBMC](https://github.com/rnissel/FBMC) |
| Source record ids | github_search_matlab-1cb1def7d3c0d7 |

## System Engineer Summary

Compares FBMC to OFDM based schemes. Reproduces all figures from “Filter bank multicarrier
modulation schemes for future mobile communications”, IEEE Journal on Selected Areas in
Communications, 2017.

## Operational Role

For a systems engineer, rnissel/FBMC belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-08-09T11:54:19Z | gh search repos language:MATLAB topic:signal-processing | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-1cb1def7d3c0d7` from `github_search_matlab` as `registry_expansion`
