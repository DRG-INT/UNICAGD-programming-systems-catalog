...
[Catalog index](../index.md) · [Language: Node.js/JavaScript](../by-language/node-js-javascript.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.npmjs.com/package/mongodb-memory-server-global -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/mongodb-memory-server-global](https://www.npmjs.com/package/mongodb-memory-server-global) |
| Source record ids | npm_registry-36b4e1a307a277 |
...
For a systems engineer, mongodb-memory-server-global belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.2.0 | 2026-05-28T10:20:55.477Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-36b4e1a307a277` from `npm_registry` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| @modelcontextprotocol/server-memory | Memory Analyzer | [open](node-js-javascript-modelcontextprotocol-server-memory-654a2423.md) |
| @remnic/server | Memory Analyzer | [open](node-js-javascript-remnic-server-5847e0dc.md) |
| lokijs | Memory Analyzer | [open](node-js-javascript-lokijs-5a945d46.md) |
| memory-level | Memory Analyzer | [open](node-js-javascript-memory-level-91370d3d.md) |
| mongodb-memory-server | Memory Analyzer | [open](node-js-javascript-mongodb-memory-server-70d3b473.md) |
| mongodb-memory-server-core | Memory Analyzer | [open](node-js-javascript-mongodb-memory-server-core-f59f5dc9.md) |
| mysql-memory-server | Memory Analyzer | [open](node-js-javascript-mysql-memory-server-0530429f.md) |
| redis-memory-server | Memory Analyzer | [open](node-js-javascript-redis-memory-server-d38b0f97.md) |
