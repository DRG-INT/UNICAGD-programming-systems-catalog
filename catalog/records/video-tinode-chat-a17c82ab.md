...
<!-- canonical: https://github.com/tinode/chat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tinode/chat](https://github.com/tinode/chat) |
| Source record ids | github_search_video-8244016960069a |

## System Engineer Summary

Instant messaging platform. Backend in Go. Clients: Swift iOS, Java Android, JS webapp, scriptable
command line; chatbots

## Operational Role

For a systems engineer, tinode/chat belongs in the Video inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T06:49:16Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-8244016960069a` from `github_search_video` as `registry_expansion`
