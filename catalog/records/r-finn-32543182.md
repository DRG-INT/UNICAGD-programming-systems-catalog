...
<!-- canonical: https://cran.r-project.org/web/packages/FINN/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FINN/index.html](https://cran.r-project.org/web/packages/FINN/index.html) |
| Source record ids | cran_packages_by_date-0a600a8bd00af2 |
...
For a systems engineer, FINN belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:00:08 UTC | [https://cran.r-project.org/web/packages/FINN/DESCRIPTION](https://cran.r-project.org/web/packages/FINN/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FINN/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-0a600a8bd00af2` from `cran_packages_by_date` as `registry_expansion`
