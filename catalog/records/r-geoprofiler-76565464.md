...
<!-- canonical: https://cran.r-project.org/web/packages/geoprofiler/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geoprofiler/index.html](https://cran.r-project.org/web/packages/geoprofiler/index.html) |
| Source record ids | cran_packages_by_date-2666cce2010ae1 |
...
For a systems engineer, geoprofiler belongs in the R inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.4 | 2026-08-28 20:40:02 UTC | [https://cran.r-project.org/web/packages/geoprofiler/DESCRIPTION](https://cran.r-project.org/web/packages/geoprofiler/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geoprofiler/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2666cce2010ae1` from `cran_packages_by_date` as `registry_expansion`
