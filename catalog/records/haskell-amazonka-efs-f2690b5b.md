...
<!-- canonical: https://hackage.haskell.org/package/amazonka-efs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-efs](https://hackage.haskell.org/package/amazonka-efs) |
| Source record ids | hackage_top_downloads-7de0f48b36aec5 |
...
For a systems engineer, amazonka-efs belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:11:23Z | [https://hackage.haskell.org/package/amazonka-efs](https://hackage.haskell.org/package/amazonka-efs) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-efs` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-7de0f48b36aec5` from `hackage_top_downloads` as `registry_expansion`
