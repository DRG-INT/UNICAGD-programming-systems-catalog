...
<!-- canonical: https://crates.io/crates/anyhow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/anyhow](https://crates.io/crates/anyhow) |
| Source record ids | crates_io-17b38fd990f6c9 |
...
For a systems engineer, anyhow belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.104 | 2026-07-18T20:59:37.656167Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-17b38fd990f6c9` from `crates_io` as `registry_expansion`
