...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/T/Tables](https://github.com/JuliaRegistries/General/tree/master/T/Tables) |
| Source record ids | corpus-96e8e4d712c1ae |

## System Engineer Summary

Tables.jl is tracked as a data science record in the Julia branch. The source did not provide a long
...
For a systems engineer, Tables.jl belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 1.14.0 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/T/Tables/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/T/Tables/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-96e8e4d712c1ae` from `master_json` as `data_science`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| BanyanDataFrames | Data Science | [open](julia-banyandataframes-9458cb44.md) |
