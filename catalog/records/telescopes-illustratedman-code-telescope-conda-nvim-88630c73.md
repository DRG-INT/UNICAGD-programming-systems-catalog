...
<!-- canonical: https://github.com/IllustratedMan-code/telescope-conda.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IllustratedMan-code/telescope-conda.nvim](https://github.com/IllustratedMan-code/telescope-conda.nvim) |
| Source record ids | github_search_telescopes-467ce75244385f |

## System Engineer Summary

IllustratedMan-code/telescope-conda.nvim is tracked as an ide editor integration record in the
Telescopes branch. The source did not provide a long description, so this page keeps the identity,
release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, IllustratedMan-code/telescope-conda.nvim belongs in the Telescopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-09T16:02:40Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-467ce75244385f` from `github_search_telescopes` as `registry_expansion`
