...
<!-- canonical: https://github.com/ecmadao/Coding-Guide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ecmadao/Coding-Guide](https://github.com/ecmadao/Coding-Guide) |
| Source record ids | github_search_matlab-31b22f2a91616c |

## System Engineer Summary

ecmadao/Coding-Guide is tracked as a language specification record in the Matlab branch. The source
...
For a systems engineer, ecmadao/Coding-Guide belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-12T04:03:24Z | gh search repos language:MATLAB stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-31b22f2a91616c` from `github_search_matlab` as `registry_expansion`
