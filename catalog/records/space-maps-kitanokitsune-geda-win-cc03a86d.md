...
<!-- canonical: https://github.com/kitanokitsune/gEDA-WIN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kitanokitsune/gEDA-WIN](https://github.com/kitanokitsune/gEDA-WIN) |
| Source record ids | github_search_space_maps-d2fdca3251c808 |
...
For a systems engineer, kitanokitsune/gEDA-WIN belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-31T13:51:54Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d2fdca3251c808` from `github_search_space_maps` as `registry_expansion`
