...
<!-- canonical: https://crates.io/crates/objc2-core-foundation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2-core-foundation](https://crates.io/crates/objc2-core-foundation) |
| Source record ids | crates_io-bec9785d8c0f5c |
...
For a systems engineer, objc2-core-foundation belongs in the Rust inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2025-10-04T15:46:51.264986Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-bec9785d8c0f5c` from `crates_io` as `registry_expansion`
