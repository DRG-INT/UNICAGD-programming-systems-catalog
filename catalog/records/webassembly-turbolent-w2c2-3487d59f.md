...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/turbolent/w2c2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/turbolent/w2c2](https://github.com/turbolent/w2c2) |
| Source record ids | github_search_webassembly-304d2aeaa4ef98 |
...
For a systems engineer, turbolent/w2c2 belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T03:51:21Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_webassembly-304d2aeaa4ef98` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Adam-CAD/CADAM | Library | [open](webassembly-adam-cad-cadam-886038fc.md) |
| as2d/as2d | Library | [open](webassembly-as2d-as2d-3fc338a6.md) |
| AssemblyScript/examples | Library | [open](webassembly-assemblyscript-examples-7e243366.md) |
| athre0z/wasm | Library | [open](webassembly-athre0z-wasm-a5ff0f9e.md) |
| bytecodealliance/componentize-dotnet | Library | [open](webassembly-bytecodealliance-componentize-dotnet-bdf25eb5.md) |
| bytecodealliance/go-modules | Library | [open](webassembly-bytecodealliance-go-modules-8f0382d7.md) |
| caspervonb/deno-wasi | Library | [open](webassembly-caspervonb-deno-wasi-e546734f.md) |
| cloudflare/workers-rs | Library | [open](webassembly-cloudflare-workers-rs-938fd17c.md) |
