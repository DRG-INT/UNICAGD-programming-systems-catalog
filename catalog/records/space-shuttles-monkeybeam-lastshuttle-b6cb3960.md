...
<!-- canonical: https://github.com/monkeybeam/lastshuttle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/monkeybeam/lastshuttle](https://github.com/monkeybeam/lastshuttle) |
| Source record ids | github_search_space_shuttles-9ee92a0ec811c2 |

## System Engineer Summary

complete web app code for the last space shuttle launch... a simulation event of Atlantis mission
STS-135

## Operational Role

For a systems engineer, monkeybeam/lastshuttle belongs in the Space Shuttles inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-01-31T20:09:34Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-9ee92a0ec811c2` from `github_search_space_shuttles` as `registry_expansion`
