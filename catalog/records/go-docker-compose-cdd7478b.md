...
<!-- canonical: https://github.com/docker/compose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/docker/compose](https://github.com/docker/compose) |
| Source record ids | github_search_go-581c8e3914abb2 |
...
For a systems engineer, docker/compose belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T17:21:34Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
| Evidence | (UPL-1.0 OR Apache-2.0); Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_go-581c8e3914abb2` from `github_search_go` as `registry_expansion`
