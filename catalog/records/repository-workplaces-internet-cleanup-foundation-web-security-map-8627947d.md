# internet-cleanup-foundation/web-security-map
...
<!-- canonical: https://gitlab.com/internet-cleanup-foundation/web-security-map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/internet-cleanup-foundation/web-security-map](https://gitlab.com/internet-cleanup-foundation/web-security-map) |
| Source record ids | gitlab_projects_api-4663cdb0a08093 |

## System Engineer Summary

Web Security Map application and scanners

## Operational Role

For a systems engineer, internet-cleanup-foundation/web-security-map belongs in the Repository
...
- `gitlab_projects_api-4663cdb0a08093` from `gitlab_projects_api` as `registry_expansion`
