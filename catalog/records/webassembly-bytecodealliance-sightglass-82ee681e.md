...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/bytecodealliance/sightglass -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bytecodealliance/sightglass](https://github.com/bytecodealliance/sightglass) |
| Source record ids | github_search_webassembly-58e0d6fb38cb53 |
...
For a systems engineer, bytecodealliance/sightglass belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-58e0d6fb38cb53` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| How to get a performance boost using WebAssembly (2017) | Benchmarking | [open](webassembly-how-to-get-a-performance-boost-using-webassembly-2017-65666a86.md) |
| OGRECave/ogre | Benchmarking | [open](webassembly-ogrecave-ogre-e3987e47.md) |
