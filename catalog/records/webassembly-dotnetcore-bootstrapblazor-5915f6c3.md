...
| Canonical URL | [https://github.com/dotnetcore/BootstrapBlazor](https://github.com/dotnetcore/BootstrapBlazor) |
| Source record ids | github_search_webassembly-6c20119e425cad |
...
For a systems engineer, dotnetcore/BootstrapBlazor belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v10.10.0 | 2026-08-30T12:17:16Z | [https://api.github.com/repos/dotnetcore/BootstrapBlazor/releases/latest](https://api.github.com/repos/dotnetcore/BootstrapBlazor/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dotnetcore/BootstrapBlazor/releases/latest` at `2026-09-01T10:25:58+00:00`.
...
- `github_search_webassembly-6c20119e425cad` from `github_search_webassembly` as `registry_expansion`
