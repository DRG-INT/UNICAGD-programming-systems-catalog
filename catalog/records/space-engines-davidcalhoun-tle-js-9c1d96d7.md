...
| Canonical URL | [https://github.com/davidcalhoun/tle.js](https://github.com/davidcalhoun/tle.js) |
| Source record ids | github_search_space_engines-7c0a5e8299d169 |

## System Engineer Summary

🛰️ Satellite TLE tools in JavaScript: get lat/lon of satellites, get look angles, plot orbit lines,
extract individual TLE elements, etc

## Operational Role

For a systems engineer, davidcalhoun/tle.js belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.0.3 | 2026-07-21T22:01:41Z | [https://api.github.com/repos/davidcalhoun/tle.js/releases/latest](https://api.github.com/repos/davidcalhoun/tle.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/davidcalhoun/tle.js/releases/latest` at `2026-09-01T07:24:16+00:00`.
...
- `github_search_space_engines-7c0a5e8299d169` from `github_search_space_engines` as `registry_expansion`
