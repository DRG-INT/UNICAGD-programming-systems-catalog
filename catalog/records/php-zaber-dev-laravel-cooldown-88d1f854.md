...
<!-- canonical: https://packagist.org/packages/zaber-dev/laravel-cooldown -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zaber-dev/laravel-cooldown](https://packagist.org/packages/zaber-dev/laravel-cooldown) |
| Source record ids | packagist_search-c5a021631f1201 |

## System Engineer Summary

Application-level action cooldown management for Laravel with cache and database storage, Eloquent
integration, middleware, and a fluent API.

## Operational Role

For a systems engineer, zaber-dev/laravel-cooldown belongs in the PHP inventory as part of state
...
- `packagist_search-c5a021631f1201` from `packagist_search` as `registry_expansion`
