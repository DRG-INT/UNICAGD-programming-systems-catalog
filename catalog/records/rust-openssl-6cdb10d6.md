...
<!-- canonical: https://crates.io/crates/openssl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/openssl](https://crates.io/crates/openssl) |
| Source record ids | crates_io-030f6451e0a043 |

## System Engineer Summary

openssl is tracked as a ffi bindings record in the Rust branch. The source did not provide a long
...
For a systems engineer, openssl belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.81 | 2026-06-12T18:11:18.530903Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-030f6451e0a043` from `crates_io` as `registry_expansion`
