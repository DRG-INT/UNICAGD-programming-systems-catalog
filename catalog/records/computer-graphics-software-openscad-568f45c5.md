...
| Source record ids | curated_language_routes-58909660af40f5 |

## System Engineer Summary

Script-based solid modeling CAD system for constructive solid geometry and reproducible mechanical
models.

## Operational Role

For a systems engineer, OpenSCAD belongs in the Computer Graphics Software inventory as part of
...
- `curated_language_routes-58909660af40f5` from `curated_language_routes` as `registry_expansion`
