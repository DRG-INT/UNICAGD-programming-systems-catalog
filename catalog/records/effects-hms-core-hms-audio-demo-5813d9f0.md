...
<!-- canonical: https://github.com/HMS-Core/hms-audio-demo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HMS-Core/hms-audio-demo](https://github.com/HMS-Core/hms-audio-demo) |
| Source record ids | github_search_effects-be975f835c2759 |

## System Engineer Summary

HMS audio android sample code encapsulates APIs of the HUAWEI Audio Kit, which focuses on audio
playback, audio effects and audio data.

## Operational Role

For a systems engineer, HMS-Core/hms-audio-demo belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-26T02:23:07Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-be975f835c2759` from `github_search_effects` as `registry_expansion`
