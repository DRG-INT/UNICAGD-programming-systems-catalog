...
<!-- canonical: https://cran.r-project.org/web/packages/VanillaCalendar/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/VanillaCalendar/index.html](https://cran.r-project.org/web/packages/VanillaCalendar/index.html) |
| Source record ids | cran_packages_by_date-4f35400f42983a |

## System Engineer Summary

Interactive Calendar and Date Picker Widget

## Operational Role

For a systems engineer, VanillaCalendar belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-28 10:00:15 UTC | [https://cran.r-project.org/web/packages/VanillaCalendar/DESCRIPTION](https://cran.r-project.org/web/packages/VanillaCalendar/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/VanillaCalendar/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4f35400f42983a` from `cran_packages_by_date` as `registry_expansion`
