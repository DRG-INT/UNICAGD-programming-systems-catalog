...
<!-- canonical: https://luarocks.org/modules/mikejsavage/bcrypt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mikejsavage/bcrypt](https://luarocks.org/modules/mikejsavage/bcrypt) |
| Source record ids | luarocks_root_manifest-96aa4ec9fcb5d3 |
...
For a systems engineer, bcrypt belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-96aa4ec9fcb5d3` from `luarocks_root_manifest` as `registry_expansion`
