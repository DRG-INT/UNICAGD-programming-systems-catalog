...
<!-- canonical: https://github.com/Xastir/Xastir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Xastir/Xastir](https://github.com/Xastir/Xastir) |
| Source record ids | github_search_radars-54d5edd237da3b |
...
For a systems engineer, Xastir/Xastir belongs in the Radars inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T19:13:08Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-54d5edd237da3b` from `github_search_radars` as `registry_expansion`
