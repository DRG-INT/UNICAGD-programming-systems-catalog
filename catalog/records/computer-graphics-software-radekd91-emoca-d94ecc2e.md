...
<!-- canonical: https://github.com/radekd91/emoca -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/radekd91/emoca](https://github.com/radekd91/emoca) |
| Source record ids | github_search_computer_graphics_software-8e141f6cb6a065 |

## System Engineer Summary

Official repository accompanying a CVPR 2022 paper EMOCA: Emotion Driven Monocular Face Capture And
Animation. EMOCA takes a single image of a face as input and produces a 3D reconstruction. EMOCA
sets the new standard on reconstructing highly emotional images in-the-wild

## Operational Role

For a systems engineer, radekd91/emoca belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-8e141f6cb6a065` from `github_search_computer_graphics_software` as `registry_expansion`
