...
<!-- canonical: https://pub.dev/packages/powersync -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/powersync](https://pub.dev/packages/powersync) |
| Source record ids | pub_dev-caeb220a8666c5 |
...
For a systems engineer, powersync belongs in the Dart inventory as part of request routing,
...
- `pub_dev-caeb220a8666c5` from `pub_dev` as `registry_expansion`
...
| scrollview_observer | Web Framework | [open](dart-scrollview-observer-6ede0195.md) |
