...
<!-- canonical: https://cran.r-project.org/web/packages/libr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/libr/index.html](https://cran.r-project.org/web/packages/libr/index.html) |
| Source record ids | cran_packages_by_date-02bb864acf61d8 |
...
For a systems engineer, libr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2026-08-04 16:40:02 UTC | [https://cran.r-project.org/web/packages/libr/DESCRIPTION](https://cran.r-project.org/web/packages/libr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/libr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-02bb864acf61d8` from `cran_packages_by_date` as `registry_expansion`
