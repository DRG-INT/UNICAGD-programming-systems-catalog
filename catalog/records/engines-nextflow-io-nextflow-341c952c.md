...
[Catalog index](../index.md) · [Language: Engines](../by-language/engines.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/nextflow-io/nextflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nextflow-io/nextflow](https://github.com/nextflow-io/nextflow) |
| Source record ids | github_search_engines-79f2f78e77fe05 |
...
For a systems engineer, nextflow-io/nextflow belongs in the Engines inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T04:41:57Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:workflow-engine stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_engines-79f2f78e77fe05` from `github_search_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| couler-proj/couler | Package Manager | [open](engines-couler-proj-couler-86587bad.md) |
| durable-workflow/workflow | Package Manager | [open](engines-durable-workflow-workflow-da539e15.md) |
| scipipe/scipipe | Package Manager | [open](engines-scipipe-scipipe-012c3ea7.md) |
