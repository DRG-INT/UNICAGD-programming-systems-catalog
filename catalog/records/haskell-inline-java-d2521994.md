...
<!-- canonical: https://hackage.haskell.org/package/inline-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/inline-java](https://hackage.haskell.org/package/inline-java) |
| Source record ids | hackage_top_downloads-d16a71eb1e0f4b |
...
For a systems engineer, inline-java belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2020-11-30T14:51:25Z | [https://hackage.haskell.org/package/inline-java](https://hackage.haskell.org/package/inline-java) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/inline-java` at `2026-09-09T00:35:04+00:00`.
...
- `hackage_top_downloads-d16a71eb1e0f4b` from `hackage_top_downloads` as `registry_expansion`
