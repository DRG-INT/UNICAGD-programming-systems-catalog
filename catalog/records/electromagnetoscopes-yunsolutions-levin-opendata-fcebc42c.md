...
<!-- canonical: https://github.com/YunSolutions/levin-openData -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/YunSolutions/levin-openData](https://github.com/YunSolutions/levin-openData) |
| Source record ids | github_search_electromagnetoscopes-591ca66a4e1a17 |

## System Engineer Summary

At Yuñ Solutions, we are committed to democratize technology and make information accessible to all.
We are sharing the data collected from our proprietary OBD device (LEVIN) during beta testing. The
shared data has been collected for almost 4 months on 30 cars.

## Operational Role

For a systems engineer, YunSolutions/levin-openData belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-31T13:56:16Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-591ca66a4e1a17` from `github_search_electromagnetoscopes` as `registry_expansion`
