...
<!-- canonical: https://luarocks.org/modules/aire-one/busted-tl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aire-one/busted-tl](https://luarocks.org/modules/aire-one/busted-tl) |
| Source record ids | luarocks_root_manifest-e428126d4d8494 |
...
For a systems engineer, busted-tl belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-e428126d4d8494` from `luarocks_root_manifest` as `registry_expansion`
