...
<!-- canonical: https://cran.r-project.org/web/packages/lssdoc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lssdoc/index.html](https://cran.r-project.org/web/packages/lssdoc/index.html) |
| Source record ids | cran_packages_by_date-68eae1f08a7b30 |
...
For a systems engineer, lssdoc belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-13 21:20:02 UTC | [https://cran.r-project.org/web/packages/lssdoc/DESCRIPTION](https://cran.r-project.org/web/packages/lssdoc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lssdoc/DESCRIPTION` at `2026-09-13T22:19:02+00:00`.
...
- `cran_packages_by_date-68eae1f08a7b30` from `cran_packages_by_date` as `registry_expansion`
