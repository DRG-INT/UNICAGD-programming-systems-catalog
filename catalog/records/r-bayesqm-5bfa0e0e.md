...
<!-- canonical: https://cran.r-project.org/web/packages/bayesqm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayesqm/index.html](https://cran.r-project.org/web/packages/bayesqm/index.html) |
| Source record ids | cran_packages_by_date-eaf7cb4f41cfa2 |

## System Engineer Summary

Bayesian Q Methodology: Exact Rank-Order Likelihood for Forced Q Sorts

## Operational Role

For a systems engineer, bayesqm belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-20 10:52:15 UTC | [https://cran.r-project.org/web/packages/bayesqm/DESCRIPTION](https://cran.r-project.org/web/packages/bayesqm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayesqm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-eaf7cb4f41cfa2` from `cran_packages_by_date` as `registry_expansion`
