...
<!-- canonical: https://github.com/APIs-guru/openapi-directory -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/APIs-guru/openapi-directory](https://github.com/APIs-guru/openapi-directory) |
| Source record ids | curated_language_routes-1247a37220aea8 |

## System Engineer Summary

Public OpenAPI specification catalog for API discovery, examples, validation, and code generation.

## Operational Role

For a systems engineer, OpenAPI Directory belongs in the Catalogs inventory as part of ecosystem
...
- `curated_language_routes-1247a37220aea8` from `curated_language_routes` as `registry_expansion`
