...
<!-- canonical: https://github.com/codezero-be/laravel-localized-routes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/codezero-be/laravel-localized-routes](https://github.com/codezero-be/laravel-localized-routes) |
| Source record ids | github_search_maps-57d2ea32f5050a |
...
For a systems engineer, codezero-be/laravel-localized-routes belongs in the Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-17T22:44:54Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-57d2ea32f5050a` from `github_search_maps` as `registry_expansion`
