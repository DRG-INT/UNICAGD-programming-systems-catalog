...
<!-- canonical: https://cran.r-project.org/web/packages/hdf5lib/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hdf5lib/index.html](https://cran.r-project.org/web/packages/hdf5lib/index.html) |
| Source record ids | cran_packages_by_date-4fa4aa50725ee6 |

## System Engineer Summary

Headers and Static Libraries for 'HDF5'

## Operational Role

For a systems engineer, hdf5lib belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0.0 | 2026-09-10 00:20:02 UTC | [https://cran.r-project.org/web/packages/hdf5lib/DESCRIPTION](https://cran.r-project.org/web/packages/hdf5lib/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hdf5lib/DESCRIPTION` at `2026-09-10T00:26:07+00:00`.
...
- `cran_packages_by_date-4fa4aa50725ee6` from `cran_packages_by_date` as `registry_expansion`
