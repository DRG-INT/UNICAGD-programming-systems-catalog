...
| Canonical URL | [https://github.com/video-dev/hls.js](https://github.com/video-dev/hls.js) |
| Source record ids | github_search_video-513a27cdd6800e |
...
For a systems engineer, video-dev/hls.js belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.7.1 | 2026-08-19T15:13:07Z | [https://api.github.com/repos/video-dev/hls.js/releases/latest](https://api.github.com/repos/video-dev/hls.js/releases/latest) |  |
| preview | known | v1.7.0-rc.3 | 2026-08-06T03:07:16Z | [https://api.github.com/repos/video-dev/hls.js/releases?per_page=10](https://api.github.com/repos/video-dev/hls.js/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/video-dev/hls.js/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-513a27cdd6800e` from `github_search_video` as `registry_expansion`
