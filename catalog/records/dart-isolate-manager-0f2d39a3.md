...
<!-- canonical: https://pub.dev/packages/isolate_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/isolate_manager](https://pub.dev/packages/isolate_manager) |
| Source record ids | pub_dev-356f5e170fe10f |

## System Engineer Summary

Create long-lived isolates for single or multiple functions, with support for Web Workers (via an
efficient generator) and WASM compilation.

## Operational Role

For a systems engineer, isolate_manager belongs in the Dart inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.3.2 | 2026-04-12T05:48:35.930541Z | [https://pub.dev/api/packages/isolate_manager](https://pub.dev/api/packages/isolate_manager) |  |
| preview | known | 6.0.0-rc.25+1 | 2025-04-02T14:48:02.158636Z | [https://pub.dev/api/packages/isolate_manager](https://pub.dev/api/packages/isolate_manager) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/isolate_manager` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-356f5e170fe10f` from `pub_dev` as `registry_expansion`
