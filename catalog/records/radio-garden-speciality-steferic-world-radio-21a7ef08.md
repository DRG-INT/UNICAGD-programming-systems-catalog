...
<!-- canonical: https://github.com/steferic/world-radio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/steferic/world-radio](https://github.com/steferic/world-radio) |
| Source record ids | github_search_radio_garden_speciality-aa3775227ee307 |

## System Engineer Summary

Hardware e-ink world radio (Radio Garden in a box) — browser prototype of the 1-bit globe, en route
to ESP32-S3

## Operational Role

For a systems engineer, steferic/world-radio belongs in the Radio Garden Speciality inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:16:23Z | gh search repos "Radio Garden" | gh_search_reports_activity_not_release_version |
...
- `github_search_radio_garden_speciality-aa3775227ee307` from `github_search_radio_garden_speciality` as `registry_expansion`
