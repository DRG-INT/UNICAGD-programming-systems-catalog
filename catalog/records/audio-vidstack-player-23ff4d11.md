...
<!-- canonical: https://github.com/vidstack/player -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vidstack/player](https://github.com/vidstack/player) |
| Source record ids | github_search_audio-3aa7d0d36eec5b |

## System Engineer Summary

UI components and hooks for building video/audio players on the web. Robust, customizable, and
accessible. Modern alternative to JW Player and Video.js.

## Operational Role

For a systems engineer, vidstack/player belongs in the Audio inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-21T18:57:02Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-3aa7d0d36eec5b` from `github_search_audio` as `registry_expansion`
