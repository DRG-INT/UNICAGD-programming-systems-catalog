...
<!-- canonical: https://github.com/dlh01/monthly-magazine -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dlh01/monthly-magazine](https://github.com/dlh01/monthly-magazine) |
| Source record ids | github_search_magazines-8cb1646e1293ed |

## System Engineer Summary

Create a magazine in WordPress using out-of-the-box integration with Posts 2 Posts and Developers
Custom Fields.

## Operational Role

For a systems engineer, dlh01/monthly-magazine belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-11-08T01:55:08Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-8cb1646e1293ed` from `github_search_magazines` as `registry_expansion`
