...
<!-- canonical: https://hackage.haskell.org/package/vector-algorithms -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/vector-algorithms](https://hackage.haskell.org/package/vector-algorithms) |
| Source record ids | hackage_top_downloads-5d2da101a92aa8 |
...
For a systems engineer, vector-algorithms belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1.0 | 2025-02-05T02:55:54Z | [https://hackage.haskell.org/package/vector-algorithms](https://hackage.haskell.org/package/vector-algorithms) |  |
| candidate | partial | 0.6.0.1 |  | [https://hackage.haskell.org/package/vector-algorithms](https://hackage.haskell.org/package/vector-algorithms) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/vector-algorithms` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-5d2da101a92aa8` from `hackage_top_downloads` as `registry_expansion`
