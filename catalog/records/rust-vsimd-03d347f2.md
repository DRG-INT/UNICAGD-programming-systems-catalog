...
<!-- canonical: https://crates.io/crates/vsimd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/vsimd](https://crates.io/crates/vsimd) |
| Source record ids | crates_io-1bfff73f5346ab |

## System Engineer Summary

vsimd is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, vsimd belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2022-12-28T03:06:21.978295Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-1bfff73f5346ab` from `crates_io` as `registry_expansion`
