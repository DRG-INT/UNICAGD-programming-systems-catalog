...
[Catalog index](../index.md) · [Language: Lua family](../by-language/lua-family.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://luarocks.org/modules/candymi/cfadmin -->
<!-- crawl-delay: 10 -->
...
- `luarocks_root_manifest-fac87ab3310735` from `luarocks_root_manifest` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| benchmarker | Benchmarking | [open](lua-family-benchmarker-534f2130.md) |
| benchy | Benchmarking | [open](lua-family-benchy-498fc131.md) |
| chrono-clock | Benchmarking | [open](lua-family-chrono-clock-fb30ae45.md) |
| continuity | Benchmarking | [open](lua-family-continuity-dbdfc124.md) |
