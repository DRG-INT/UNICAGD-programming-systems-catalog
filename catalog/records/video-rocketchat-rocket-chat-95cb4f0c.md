...
<!-- canonical: https://github.com/RocketChat/Rocket.Chat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) |
| Source record ids | github_search_video-ed7336d89a955d |
...
For a systems engineer, RocketChat/Rocket.Chat belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T02:38:27Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-ed7336d89a955d` from `github_search_video` as `registry_expansion`
