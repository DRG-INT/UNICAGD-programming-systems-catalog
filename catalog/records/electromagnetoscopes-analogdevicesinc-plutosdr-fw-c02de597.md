...
| Source record ids | github_search_electromagnetoscopes-1e486c379e40ff |

## System Engineer Summary

analogdevicesinc/plutosdr-fw is tracked as a logging observability record in the
...
For a systems engineer, analogdevicesinc/plutosdr-fw belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.39 | 2024-10-15T08:45:31Z | [https://api.github.com/repos/analogdevicesinc/plutosdr-fw/releases/latest](https://api.github.com/repos/analogdevicesinc/plutosdr-fw/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/analogdevicesinc/plutosdr-fw/releases/latest` at `2026-09-01T08:26:39+00:00`.
...
- `github_search_electromagnetoscopes-1e486c379e40ff` from `github_search_electromagnetoscopes` as `registry_expansion`
