...
<!-- canonical: https://cran.r-project.org/web/packages/locuszoomr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/locuszoomr/index.html](https://cran.r-project.org/web/packages/locuszoomr/index.html) |
| Source record ids | cran_packages_by_date-3733e8b13b48d2 |
...
For a systems engineer, locuszoomr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-03 06:50:03 UTC | [https://cran.r-project.org/web/packages/locuszoomr/DESCRIPTION](https://cran.r-project.org/web/packages/locuszoomr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/locuszoomr/DESCRIPTION` at `2026-09-03T07:20:25+00:00`.
...
- `cran_packages_by_date-3733e8b13b48d2` from `cran_packages_by_date` as `registry_expansion`
