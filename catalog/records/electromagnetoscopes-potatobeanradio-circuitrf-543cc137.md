...
<!-- canonical: https://github.com/potatobeanradio/circuitRF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/potatobeanradio/circuitRF](https://github.com/potatobeanradio/circuitRF) |
| Source record ids | github_search_electromagnetoscopes-c186a366b3e42b |

## System Engineer Summary

Lightweight cross-platform RF circuit simulator — DC, S-parameters, harmonic balance, loadpull. Not
a SPICE simulator.

## Operational Role

For a systems engineer, potatobeanradio/circuitRF belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T04:21:51Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c186a366b3e42b` from `github_search_electromagnetoscopes` as `registry_expansion`
