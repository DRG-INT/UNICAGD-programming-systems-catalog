...
| Canonical URL | [https://luarocks.org/modules/aleclarson/emitter](https://luarocks.org/modules/aleclarson/emitter) |
| Source record ids | luarocks_root_manifest-5fb10292d78654 |

## System Engineer Summary

emitter is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, emitter belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-5fb10292d78654` from `luarocks_root_manifest` as `registry_expansion`
