...
<!-- canonical: https://github.com/coderaiser/nemesis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coderaiser/nemesis](https://github.com/coderaiser/nemesis) |
| Source record ids | github_search_assembly-0b9b9a511788cc |
...
For a systems engineer, coderaiser/nemesis belongs in the Assembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-08T13:40:01Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-0b9b9a511788cc` from `github_search_assembly` as `registry_expansion`
