...
<!-- canonical: https://www.npmjs.com/package/@atlantjs/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@atlantjs/database](https://www.npmjs.com/package/@atlantjs/database) |
| Source record ids | npm_registry-4486dce22b8cce |

## System Engineer Summary

@atlantjs/database is tracked as a database datastore record in the Node.js/JavaScript branch. The
...
For a systems engineer, @atlantjs/database belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.32 | 2026-08-22T23:53:01.736Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-4486dce22b8cce` from `npm_registry` as `registry_expansion`
...
| @cap-js/db-service | Database Datastore | [open](node-js-javascript-cap-js-db-service-68ae8043.md) |
