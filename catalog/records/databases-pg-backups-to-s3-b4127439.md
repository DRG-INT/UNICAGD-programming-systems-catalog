...
<!-- canonical: https://github.com/Saicheg/pg-backups-to-s3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Saicheg/pg-backups-to-s3](https://github.com/Saicheg/pg-backups-to-s3) |
| Source record ids | awesome_list-ebb991bf171d90 |

## System Engineer Summary

Docker-first solution on top of pg_dump with support for environment-based configuration for
scheduled PostgreSQL backups with optional compression, GPG encryption, webhooks, automatic upload
to Amazon S3.

## Operational Role

For a systems engineer, pg-backups-to-s3 belongs in the Databases inventory as part of state
...
- `awesome_list-ebb991bf171d90` from `awesome_list` as `registry_expansion`
