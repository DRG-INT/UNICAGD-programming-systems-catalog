...
<!-- canonical: https://www.npmjs.com/package/@web/dev-server-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@web/dev-server-core](https://www.npmjs.com/package/@web/dev-server-core) |
| Source record ids | npm_registry-08a24e164d9b43 |

## System Engineer Summary

@web/dev-server-core is tracked as a web framework record in the Node.js/JavaScript branch. The
...
For a systems engineer, @web/dev-server-core belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-07-27T16:01:05.955Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-08a24e164d9b43` from `npm_registry` as `registry_expansion`
