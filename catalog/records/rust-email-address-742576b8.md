...
<!-- canonical: https://crates.io/crates/email_address -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/email_address](https://crates.io/crates/email_address) |
| Source record ids | crates_io-09372f16e907ae |
...
For a systems engineer, email_address belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.9 | 2024-07-31T22:44:11.017703Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-09372f16e907ae` from `crates_io` as `registry_expansion`
