...
<!-- canonical: https://gitbox.apache.org/repos/asf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitbox.apache.org/repos/asf](https://gitbox.apache.org/repos/asf) |
| Source record ids | curated_repository_workplace_routes-6dd0787774434d |

## System Engineer Summary

Apache Software Foundation GitBox repository browser and source hosting route.

## Operational Role

For a systems engineer, Apache Source Repositories belongs in the Repository Workplaces inventory as
...
- `curated_repository_workplace_routes-6dd0787774434d` from `curated_repository_workplace_routes` as `registry_expansion`
