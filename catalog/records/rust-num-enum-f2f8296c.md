...
<!-- canonical: https://crates.io/crates/num_enum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num_enum](https://crates.io/crates/num_enum) |
| Source record ids | crates_io-398a01db8878c3 |
...
For a systems engineer, num_enum belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.6 | 2026-03-15T21:29:40.865699Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `crates_io-398a01db8878c3` from `crates_io` as `registry_expansion`
