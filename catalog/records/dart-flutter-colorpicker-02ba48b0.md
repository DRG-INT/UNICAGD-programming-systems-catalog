...
<!-- canonical: https://pub.dev/packages/flutter_colorpicker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_colorpicker](https://pub.dev/packages/flutter_colorpicker) |
| Source record ids | pub_dev-d9c246a83965e2 |

## System Engineer Summary

HSV(HSB)/HSL/RGB/Material color picker inspired by all the good design for your amazing flutter
apps.

## Operational Role

For a systems engineer, flutter_colorpicker belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2024-05-19T07:34:44.737745Z | [https://pub.dev/api/packages/flutter_colorpicker](https://pub.dev/api/packages/flutter_colorpicker) |  |
| preview | known | 1.0.0-dev.1 | 2021-11-12T16:54:37.436577Z | [https://pub.dev/api/packages/flutter_colorpicker](https://pub.dev/api/packages/flutter_colorpicker) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_colorpicker` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-d9c246a83965e2` from `pub_dev` as `registry_expansion`
