...
<!-- canonical: https://cran.r-project.org/web/packages/sommer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sommer/index.html](https://cran.r-project.org/web/packages/sommer/index.html) |
| Source record ids | cran_packages_by_date-6d067605e55a10 |
...
For a systems engineer, sommer belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.7 | 2026-09-11 06:50:02 UTC | [https://cran.r-project.org/web/packages/sommer/DESCRIPTION](https://cran.r-project.org/web/packages/sommer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sommer/DESCRIPTION` at `2026-09-11T08:21:50+00:00`.
...
- `cran_packages_by_date-6d067605e55a10` from `cran_packages_by_date` as `registry_expansion`
