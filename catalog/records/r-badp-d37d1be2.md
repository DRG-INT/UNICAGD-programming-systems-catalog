...
<!-- canonical: https://cran.r-project.org/web/packages/badp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/badp/index.html](https://cran.r-project.org/web/packages/badp/index.html) |
| Source record ids | cran_packages_by_date-d447e26b5c1083 |
...
For a systems engineer, badp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-31 22:00:32 UTC | [https://cran.r-project.org/web/packages/badp/DESCRIPTION](https://cran.r-project.org/web/packages/badp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/badp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d447e26b5c1083` from `cran_packages_by_date` as `registry_expansion`
