...
| Source record ids | github_search_video-2b2cc339f98ece |

## System Engineer Summary

Make stream processing easier! Easy-to-use streaming application development framework and operation
platform.

## Operational Role

For a systems engineer, apache/streampark belongs in the Video inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T02:30:45Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-2b2cc339f98ece` from `github_search_video` as `registry_expansion`
