...
<!-- canonical: https://luarocks.org/modules/0snilcy/cake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/0snilcy/cake](https://luarocks.org/modules/0snilcy/cake) |
| Source record ids | luarocks_root_manifest-d79f5fe62d37ff |

## System Engineer Summary

cake is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cake belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-d79f5fe62d37ff` from `luarocks_root_manifest` as `registry_expansion`
