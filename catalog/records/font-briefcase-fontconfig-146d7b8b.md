...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Configuration](../by-category/configuration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.freedesktop.org/fontconfig/fontconfig -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.freedesktop.org/fontconfig/fontconfig](https://gitlab.freedesktop.org/fontconfig/fontconfig) |
| Source record ids | curated_language_routes-22897b2dee90c1 |

## System Engineer Summary

Font discovery, matching, substitution, and configuration library used by Unix-like desktop and
server systems.

## Operational Role

For a systems engineer, Fontconfig belongs in the Font Briefcase inventory as part of ecosystem
...
- `curated_language_routes-22897b2dee90c1` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| adobe-fonts/source-code-pro | Configuration | [open](font-briefcase-adobe-fonts-source-code-pro-81ce7afb.md) |
| adobe-fonts/source-sans | Configuration | [open](font-briefcase-adobe-fonts-source-sans-48ad90f9.md) |
| ahatem/IoskeleyMono | Configuration | [open](font-briefcase-ahatem-ioskeleymono-31384029.md) |
| nuxt/fonts | Configuration | [open](font-briefcase-nuxt-fonts-5b0f0fdd.md) |
| owl4ce/dotfiles | Configuration | [open](font-briefcase-owl4ce-dotfiles-2e03ef38.md) |
| unawarepatien/Installed-Fonts-Backup-Tools | Configuration | [open](font-briefcase-unawarepatien-installed-fonts-backup-tools-c7184f6d.md) |
