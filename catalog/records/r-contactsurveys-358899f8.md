...
<!-- canonical: https://cran.r-project.org/web/packages/contactsurveys/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/contactsurveys/index.html](https://cran.r-project.org/web/packages/contactsurveys/index.html) |
| Source record ids | cran_packages_by_date-eca33821d3a8c2 |
...
For a systems engineer, contactsurveys belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 18:30:02 UTC | [https://cran.r-project.org/web/packages/contactsurveys/DESCRIPTION](https://cran.r-project.org/web/packages/contactsurveys/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/contactsurveys/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-eca33821d3a8c2` from `cran_packages_by_date` as `registry_expansion`
