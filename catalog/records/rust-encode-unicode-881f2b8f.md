...
<!-- canonical: https://crates.io/crates/encode_unicode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/encode_unicode](https://crates.io/crates/encode_unicode) |
| Source record ids | crates_io-17e237f181db7c |
...
For a systems engineer, encode_unicode belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2022-08-07T14:19:49.238999Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-17e237f181db7c` from `crates_io` as `registry_expansion`
