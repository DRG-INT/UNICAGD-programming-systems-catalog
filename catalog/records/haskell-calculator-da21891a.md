...
<!-- canonical: https://hackage.haskell.org/package/calculator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/calculator](https://hackage.haskell.org/package/calculator) |
| Source record ids | hackage_top_downloads-b3be28cc009539 |
...
For a systems engineer, calculator belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1.2 | 2016-10-10T20:31:33Z | [https://hackage.haskell.org/package/calculator](https://hackage.haskell.org/package/calculator) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/calculator` at `2026-09-09T00:34:54+00:00`.
...
- `hackage_top_downloads-b3be28cc009539` from `hackage_top_downloads` as `registry_expansion`
