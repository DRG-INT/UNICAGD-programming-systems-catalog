...
| Canonical URL | [https://crates.io/crates/wasmtime-environ](https://crates.io/crates/wasmtime-environ) |
| Source record ids | crates_io-5def8fc3d764c4 |
...
For a systems engineer, wasmtime-environ belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 48.0.1 | 2026-08-24T19:58:29.724494Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-5def8fc3d764c4` from `crates_io` as `registry_expansion`
