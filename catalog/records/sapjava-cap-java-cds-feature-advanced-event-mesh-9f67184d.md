# cap-java/cds-feature-advanced-event-mesh
...
<!-- canonical: https://github.com/cap-java/cds-feature-advanced-event-mesh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cap-java/cds-feature-advanced-event-mesh](https://github.com/cap-java/cds-feature-advanced-event-mesh) |
| Source record ids | github_search_sapjava-a6b4a345c4b9cb |
...
For a systems engineer, cap-java/cds-feature-advanced-event-mesh belongs in the SAPJava inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-06-12T11:57:11Z | [https://api.github.com/repos/cap-java/cds-feature-advanced-event-mesh/releases/latest](https://api.github.com/repos/cap-java/cds-feature-advanced-event-mesh/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/cap-java/cds-feature-advanced-event-mesh/releases/latest` at `2026-09-01T10:25:33+00:00`.
...
- `github_search_sapjava-a6b4a345c4b9cb` from `github_search_sapjava` as `registry_expansion`
