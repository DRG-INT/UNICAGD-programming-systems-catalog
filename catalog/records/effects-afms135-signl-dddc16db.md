...
<!-- canonical: https://github.com/afms135/signl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/afms135/signl](https://github.com/afms135/signl) |
| Source record ids | github_search_effects-252e32d8f175c0 |

## System Engineer Summary

An Open Source Real-Time Audio Effects Processor running on Raspberry Pi

## Operational Role

For a systems engineer, afms135/signl belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-04-19T20:32:17Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-252e32d8f175c0` from `github_search_effects` as `registry_expansion`
