...
<!-- canonical: https://packagist.org/packages/symfony/test-pack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/symfony/test-pack](https://packagist.org/packages/symfony/test-pack) |
| Source record ids | packagist_search-371a6d335204d2 |
...
For a systems engineer, symfony/test-pack belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-371a6d335204d2` from `packagist_search` as `registry_expansion`
