...
<!-- canonical: https://cran.r-project.org/web/packages/choicedata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/choicedata/index.html](https://cran.r-project.org/web/packages/choicedata/index.html) |
| Source record ids | cran_packages_by_date-29a72c96181459 |

## System Engineer Summary

Working with Choice Data

## Operational Role

For a systems engineer, choicedata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-15 12:20:02 UTC | [https://cran.r-project.org/web/packages/choicedata/DESCRIPTION](https://cran.r-project.org/web/packages/choicedata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/choicedata/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-29a72c96181459` from `cran_packages_by_date` as `registry_expansion`
