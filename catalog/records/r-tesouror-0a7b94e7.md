...
<!-- canonical: https://cran.r-project.org/web/packages/tesouror/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tesouror/index.html](https://cran.r-project.org/web/packages/tesouror/index.html) |
| Source record ids | cran_packages_by_date-da4b70ca4a5c8a |

## System Engineer Summary

Access Brazilian National Treasury Open Data APIs

## Operational Role

For a systems engineer, tesouror belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-19 15:50:02 UTC | [https://cran.r-project.org/web/packages/tesouror/DESCRIPTION](https://cran.r-project.org/web/packages/tesouror/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tesouror/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-da4b70ca4a5c8a` from `cran_packages_by_date` as `registry_expansion`
