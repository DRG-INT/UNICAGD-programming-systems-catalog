...
<!-- canonical: https://pub.dev/packages/dart_code_linter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dart_code_linter](https://pub.dev/packages/dart_code_linter) |
| Source record ids | pub_dev-2f9c4e2a733b0c |

## System Engineer Summary

Dart Code Linter is a software analytics tool that helps developers analyse and improve software
quality. Dart Code Linter is based on a fork of Dart Code Metrics.

## Operational Role

For a systems engineer, dart_code_linter belongs in the Dart inventory as part of static feedback,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.3.0 | 2026-08-26T13:28:28.501794Z | [https://pub.dev/api/packages/dart_code_linter](https://pub.dev/api/packages/dart_code_linter) |  |
| preview | known | 3.2.0-alpha.2 | 2025-10-21T15:05:52.519880Z | [https://pub.dev/api/packages/dart_code_linter](https://pub.dev/api/packages/dart_code_linter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dart_code_linter` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-2f9c4e2a733b0c` from `pub_dev` as `registry_expansion`
