...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rathena/rathena -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rathena/rathena](https://github.com/rathena/rathena) |
| Source record ids | github_search_game_engines-9759de45ad283a |
...
For a systems engineer, rathena/rathena belongs in the Game Engines inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:06:23Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-9759de45ad283a` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| feather-rs/feather | Web Framework | [open](game-engines-feather-rs-feather-5c48c819.md) |
| ferrumc-rs/ferrumc | Web Framework | [open](game-engines-ferrumc-rs-ferrumc-08575ab8.md) |
