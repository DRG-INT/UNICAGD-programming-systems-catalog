...
<!-- canonical: https://github.com/yechengxi/LightNet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yechengxi/LightNet](https://github.com/yechengxi/LightNet) |
| Source record ids | github_search_matlab-bc2306f1228d25 |
...
For a systems engineer, yechengxi/LightNet belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-04-25T14:54:07Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-bc2306f1228d25` from `github_search_matlab` as `registry_expansion`
