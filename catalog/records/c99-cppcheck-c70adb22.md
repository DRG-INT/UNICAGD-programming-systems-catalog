...
| Source record ids | master-d85f69195d96 |
...
For a systems engineer, Cppcheck belongs in the C99 inventory as part of defect discovery, security
...
- `master-d85f69195d96` from `master_json` as `static_analyzer`
