...
<!-- canonical: https://github.com/rtuszik/photon-docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rtuszik/photon-docker](https://github.com/rtuszik/photon-docker) |
| Source record ids | github_search_maps-efe0b3bf7cb62e |

## System Engineer Summary

Unofficial docker image for the Komoot/Photon geocoder

## Operational Role

For a systems engineer, rtuszik/photon-docker belongs in the Maps inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.4.0 | 2026-08-17T18:44:15Z | [https://api.github.com/repos/rtuszik/photon-docker/releases/latest](https://api.github.com/repos/rtuszik/photon-docker/releases/latest) |  |
| preview | known | 2.0.0-beta | 2026-02-11T23:51:18Z | [https://api.github.com/repos/rtuszik/photon-docker/releases?per_page=10](https://api.github.com/repos/rtuszik/photon-docker/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/rtuszik/photon-docker/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-efe0b3bf7cb62e` from `github_search_maps` as `registry_expansion`
