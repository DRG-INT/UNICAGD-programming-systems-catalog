...
<!-- canonical: https://github.com/containrrr/watchtower -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/containrrr/watchtower](https://github.com/containrrr/watchtower) |
| Source record ids | github_search_catalogs-580935e0c46229 |
...
For a systems engineer, containrrr/watchtower belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-17T14:44:11Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-580935e0c46229` from `github_search_catalogs` as `registry_expansion`
