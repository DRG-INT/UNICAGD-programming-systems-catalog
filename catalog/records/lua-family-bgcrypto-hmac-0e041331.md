...
<!-- canonical: https://luarocks.org/modules/moteus/bgcrypto-hmac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moteus/bgcrypto-hmac](https://luarocks.org/modules/moteus/bgcrypto-hmac) |
| Source record ids | luarocks_root_manifest-2146bbb5aa2ab1 |
...
For a systems engineer, bgcrypto-hmac belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-2146bbb5aa2ab1` from `luarocks_root_manifest` as `registry_expansion`
