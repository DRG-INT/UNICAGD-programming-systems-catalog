...
| Canonical URL | [https://crates.io/crates/console-subscriber](https://crates.io/crates/console-subscriber) |
| Source record ids | crates_io-1e235de3376aed |
...
For a systems engineer, console-subscriber belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2025-10-30T11:54:09.870369Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
| dlv-list | Undefined Behavior Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dlv-list-d6df10e8.md) |
