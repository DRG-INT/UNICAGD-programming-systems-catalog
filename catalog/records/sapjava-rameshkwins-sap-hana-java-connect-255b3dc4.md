# Rameshkwins/SAP_HANA_Java_Connect
...
<!-- canonical: https://github.com/Rameshkwins/SAP_HANA_Java_Connect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Rameshkwins/SAP_HANA_Java_Connect](https://github.com/Rameshkwins/SAP_HANA_Java_Connect) |
| Source record ids | github_search_sapjava-38f3560167bf88 |

## System Engineer Summary

Simple Java Application to connect ON Permise Hana via JDBC connection.

## Operational Role

For a systems engineer, Rameshkwins/SAP_HANA_Java_Connect belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-09-21T21:32:06Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-38f3560167bf88` from `github_search_sapjava` as `registry_expansion`
