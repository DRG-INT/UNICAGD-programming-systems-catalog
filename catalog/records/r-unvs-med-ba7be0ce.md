...
<!-- canonical: https://cran.r-project.org/web/packages/unvs.med/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/unvs.med/index.html](https://cran.r-project.org/web/packages/unvs.med/index.html) |
| Source record ids | cran_packages_by_date-0c83d0f6faa256 |

## System Engineer Summary

A Universal Approach for Causal Mediation Analysis

## Operational Role

For a systems engineer, unvs.med belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-23 06:30:02 UTC | [https://cran.r-project.org/web/packages/unvs.med/DESCRIPTION](https://cran.r-project.org/web/packages/unvs.med/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/unvs.med/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-0c83d0f6faa256` from `cran_packages_by_date` as `registry_expansion`
