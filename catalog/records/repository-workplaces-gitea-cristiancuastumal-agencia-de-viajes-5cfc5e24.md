# Gitea: cristiancuastumal/Agencia-de-viajes
...
<!-- canonical: https://gitea.com/cristiancuastumal/Agencia-de-viajes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/cristiancuastumal/Agencia-de-viajes](https://gitea.com/cristiancuastumal/Agencia-de-viajes) |
| Source record ids | gitea_repositories_api-b06feab9cc42fb |
...
For a systems engineer, Gitea: cristiancuastumal/Agencia-de-viajes belongs in the Repository
Workplaces inventory as part of language tooling, code generation, static analysis, and source
transformation.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-19T02:27:32Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-b06feab9cc42fb` from `gitea_repositories_api` as `registry_expansion`
...
| Gitea: dhruv_patel/express | Parser Lexer Ast | [open](repository-workplaces-gitea-dhruv-patel-express-37b47e60.md) |
