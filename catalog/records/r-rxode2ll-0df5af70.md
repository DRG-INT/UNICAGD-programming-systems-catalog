...
<!-- canonical: https://cran.r-project.org/web/packages/rxode2ll/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rxode2ll/index.html](https://cran.r-project.org/web/packages/rxode2ll/index.html) |
| Source record ids | cran_packages_by_date-fa34f2fe9e1951 |
...
For a systems engineer, rxode2ll belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.17 | 2026-09-09 05:20:11 UTC | [https://cran.r-project.org/web/packages/rxode2ll/DESCRIPTION](https://cran.r-project.org/web/packages/rxode2ll/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rxode2ll/DESCRIPTION` at `2026-09-09T06:26:10+00:00`.
...
- `cran_packages_by_date-fa34f2fe9e1951` from `cran_packages_by_date` as `registry_expansion`
