...
<!-- canonical: https://cran.r-project.org/web/packages/CRAFT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CRAFT/index.html](https://cran.r-project.org/web/packages/CRAFT/index.html) |
| Source record ids | cran_packages_by_date-a09f87a768ee9c |
...
For a systems engineer, CRAFT belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:50:20 UTC | [https://cran.r-project.org/web/packages/CRAFT/DESCRIPTION](https://cran.r-project.org/web/packages/CRAFT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CRAFT/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a09f87a768ee9c` from `cran_packages_by_date` as `registry_expansion`
