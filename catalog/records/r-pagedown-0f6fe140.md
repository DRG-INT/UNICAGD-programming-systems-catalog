...
<!-- canonical: https://cran.r-project.org/web/packages/pagedown/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pagedown/index.html](https://cran.r-project.org/web/packages/pagedown/index.html) |
| Source record ids | cran_packages_by_date-e6155a81157a95 |
...
For a systems engineer, pagedown belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25 | 2026-08-28 07:20:09 UTC | [https://cran.r-project.org/web/packages/pagedown/DESCRIPTION](https://cran.r-project.org/web/packages/pagedown/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pagedown/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e6155a81157a95` from `cran_packages_by_date` as `registry_expansion`
