# arm-education/Graphical-Micro-Architecture-Simulator

## Navigation

[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/arm-education/Graphical-Micro-Architecture-Simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arm-education/Graphical-Micro-Architecture-Simulator](https://github.com/arm-education/Graphical-Micro-Architecture-Simulator) |
| Source record ids | github_search_assembly-de9dbe9c1c3145 |

## System Engineer Summary

Browser-based Arm micro-architecture simulator with single-cycle and pipelined CPU visualization
(educational, simulator)

## Operational Role

For a systems engineer, arm-education/Graphical-Micro-Architecture-Simulator belongs in the Assembly
inventory as part of dependency acquisition, lockfile policy, provenance control, and supply-chain
monitoring.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-13T09:26:37Z | gh search repos topic:arm topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-de9dbe9c1c3145` from `github_search_assembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| celebi-pkg/riscv-assembler | Package Manager | [open](assembly-celebi-pkg-riscv-assembler-dfcf81bb.md) |
