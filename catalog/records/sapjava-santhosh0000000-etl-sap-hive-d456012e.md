...
<!-- canonical: https://github.com/santhosh0000000/ETL_sap_hive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/santhosh0000000/ETL_sap_hive](https://github.com/santhosh0000000/ETL_sap_hive) |
| Source record ids | github_search_sapjava-1a95ebd948a87f |

## System Engineer Summary

This Java program leverages the Apache Spark framework to read data from a SAP HANA database and
save it to a Hive table in ORC format

## Operational Role

For a systems engineer, santhosh0000000/ETL_sap_hive belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-09-09T13:45:15Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-1a95ebd948a87f` from `github_search_sapjava` as `registry_expansion`
