...
<!-- canonical: https://github.com/techninja/asili -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/techninja/asili](https://github.com/techninja/asili) |
| Source record ids | github_search_repertoare_catalogs-8ebcbec86193bc |

## System Engineer Summary

Privacy-first polygenic risk score analysis. Upload your DNA, get trait scores — all processing
happens on your device. Built on DuckDB WASM, Web Components, and the PGS Catalog. No accounts, no
servers, no data leaves your browser.

## Operational Role

For a systems engineer, techninja/asili belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T23:25:44Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-8ebcbec86193bc` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| Avdey7/chn.songs | Build System | [open](repertoare-catalogs-avdey7-chn-songs-6df0e343.md) |
