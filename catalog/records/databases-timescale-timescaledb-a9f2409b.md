...
<!-- canonical: https://github.com/timescale/timescaledb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/timescale/timescaledb](https://github.com/timescale/timescaledb) |
| Source record ids | github_search_databases-510f111ecbcc5b |
...
For a systems engineer, timescale/timescaledb belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T16:36:43Z | gh search repos topic:time-series-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-510f111ecbcc5b` from `github_search_databases` as `registry_expansion`
