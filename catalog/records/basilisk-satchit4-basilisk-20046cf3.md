...
<!-- canonical: https://github.com/Satchit4/Basilisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Satchit4/Basilisk](https://github.com/Satchit4/Basilisk) |
| Source record ids | github_search_basilisk-371c266e0f9906 |

## System Engineer Summary

Basilisk C simulations for 2D and axisymmetric bubble dynamics.

## Operational Role

For a systems engineer, Satchit4/Basilisk belongs in the Basilisk inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-25T06:23:12Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-371c266e0f9906` from `github_search_basilisk` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| rcsc-group/CoatedRotatingCylinder2D | Undefined Behavior Analyzer | [open](basilisk-rcsc-group-coatedrotatingcylinder2d-d2a76bbd.md) |
