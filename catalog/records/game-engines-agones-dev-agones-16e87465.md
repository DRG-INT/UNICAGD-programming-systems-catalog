...
<!-- canonical: https://github.com/agones-dev/agones -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/agones-dev/agones](https://github.com/agones-dev/agones) |
| Source record ids | github_search_game_engines-00fd5536e995dc |
...
For a systems engineer, agones-dev/agones belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T05:14:11Z | gh search repos topic:game-development stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-00fd5536e995dc` from `github_search_game_engines` as `registry_expansion`
