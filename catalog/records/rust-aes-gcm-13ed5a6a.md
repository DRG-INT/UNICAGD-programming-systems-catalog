...
<!-- canonical: https://crates.io/crates/aes-gcm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aes-gcm](https://crates.io/crates/aes-gcm) |
| Source record ids | crates_io-8c92f1fd36b301 |

## System Engineer Summary

Pure Rust implementation of the AES-GCM (Galois/Counter Mode) Authenticated Encryption with
Associated Data (AEAD) Cipher with optional architecture-specific hardware acceleration

## Operational Role

For a systems engineer, aes-gcm belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.1 | 2026-08-21T20:55:56.614710Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-8c92f1fd36b301` from `crates_io` as `registry_expansion`
