...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CGAL](https://github.com/JuliaRegistries/General/tree/master/C/CGAL) |
| Source record ids | julia_general-57eac738e236a9 |

## System Engineer Summary

Julia package registered in General at C/CGAL.

## Operational Role

For a systems engineer, CGAL belongs in the Julia inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CGAL", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-57eac738e236a9` from `julia_general` as `registry_expansion`
