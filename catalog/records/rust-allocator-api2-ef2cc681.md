...
<!-- canonical: https://crates.io/crates/allocator-api2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/allocator-api2](https://crates.io/crates/allocator-api2) |
| Source record ids | crates_io-38e2036c1de508 |
...
For a systems engineer, allocator-api2 belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2025-12-11T12:20:26.230443Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT; https://www.nuget.org/packages/Chr.Avro.Json/10.13.1/license |
...
- `crates_io-38e2036c1de508` from `crates_io` as `registry_expansion`
