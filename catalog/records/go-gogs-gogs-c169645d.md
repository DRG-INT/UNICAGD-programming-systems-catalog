...
<!-- canonical: https://github.com/gogs/gogs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gogs/gogs](https://github.com/gogs/gogs) |
| Source record ids | github_search_go-a0030be922d8aa |
...
For a systems engineer, gogs/gogs belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T20:28:48Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-a0030be922d8aa` from `github_search_go` as `registry_expansion`
