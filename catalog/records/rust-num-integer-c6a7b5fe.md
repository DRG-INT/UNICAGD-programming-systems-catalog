...
<!-- canonical: https://crates.io/crates/num-integer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-integer](https://crates.io/crates/num-integer) |
| Source record ids | crates_io-d395c6c07063e5 |
...
For a systems engineer, num-integer belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.47 | 2026-08-12T00:11:57.840357Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-d395c6c07063e5` from `crates_io` as `registry_expansion`
