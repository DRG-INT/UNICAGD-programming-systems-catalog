...
<!-- canonical: https://github.com/psyb0t/piraterf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psyb0t/piraterf](https://github.com/psyb0t/piraterf) |
| Source record ids | github_search_satcom_satellites-fd6d47738a61c0 |

## System Engineer Summary

PIrateRF transforms your Raspberry Pi Zero W into a portable RF signal generator that spawns its own
WiFi hotspot. Control everything from FM broadcasts to digital modes through your browser - hack the
airwaves from anywhere! 📡⚡

## Operational Role

For a systems engineer, psyb0t/piraterf belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T19:49:42Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-fd6d47738a61c0` from `github_search_satcom_satellites` as `registry_expansion`
