...
<!-- canonical: https://github.com/angular-ui/ui-router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/angular-ui/ui-router](https://github.com/angular-ui/ui-router) |
| Source record ids | github_search_maps-8ce0c83ee319fd |
...
For a systems engineer, angular-ui/ui-router belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2025-12-31T01:45:56Z | [https://api.github.com/repos/angular-ui/ui-router/releases/latest](https://api.github.com/repos/angular-ui/ui-router/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/angular-ui/ui-router/releases/latest` at `2026-09-01T12:29:58+00:00`.
...
- `github_search_maps-8ce0c83ee319fd` from `github_search_maps` as `registry_expansion`
