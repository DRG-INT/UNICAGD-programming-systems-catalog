...
<!-- canonical: https://crates.io/crates/bzip2-sys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bzip2-sys](https://crates.io/crates/bzip2-sys) |
| Source record ids | crates_io-f4faa0e4336077 |
...
For a systems engineer, bzip2-sys belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.13+1.0.8 | 2025-02-28T13:56:25.581313Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-f4faa0e4336077` from `crates_io` as `registry_expansion`
