...
<!-- canonical: https://pub.dev/packages/infinite_scroll_pagination -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/infinite_scroll_pagination](https://pub.dev/packages/infinite_scroll_pagination) |
| Source record ids | pub_dev-f19323cf0769bc |
...
For a systems engineer, infinite_scroll_pagination belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.1 | 2025-08-28T12:52:54.783870Z | [https://pub.dev/api/packages/infinite_scroll_pagination](https://pub.dev/api/packages/infinite_scroll_pagination) |  |
| preview | known | 4.0.0-dev.1 | 2022-09-15T13:48:18.116800Z | [https://pub.dev/api/packages/infinite_scroll_pagination](https://pub.dev/api/packages/infinite_scroll_pagination) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/infinite_scroll_pagination` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-f19323cf0769bc` from `pub_dev` as `registry_expansion`
