...
<!-- canonical: https://hackage.haskell.org/package/crux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/crux](https://hackage.haskell.org/package/crux) |
| Source record ids | hackage_recent-b65bcb495362b9 |
...
For a systems engineer, crux belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2026-09-11T16:16:56Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-b65bcb495362b9` from `hackage_recent` as `registry_expansion`
