# Gitea: portellam2/guest-machine-guide
...
<!-- canonical: https://gitea.com/portellam2/guest-machine-guide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/portellam2/guest-machine-guide](https://gitea.com/portellam2/guest-machine-guide) |
| Source record ids | gitea_repositories_api-1bdbba75a5668e |

## System Engineer Summary

Guide for setup of a Virtual Machine (VM) on the Linux desktop. Includes general overview,
optimizations for Windows VMs and hardware-passthrough (VFIO), and more.

## Operational Role

For a systems engineer, Gitea: portellam2/guest-machine-guide belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-08T02:15:44Z | [https://gitea.com/api/v1/repos/search?q=documentation&limit=50](https://gitea.com/api/v1/repos/search?q=documentation&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-03 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "documentation", "retrieved": "2026-09-03", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-1bdbba75a5668e` from `gitea_repositories_api` as `registry_expansion`
