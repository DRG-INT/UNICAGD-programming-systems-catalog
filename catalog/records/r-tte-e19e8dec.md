...
<!-- canonical: https://cran.r-project.org/web/packages/TTE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TTE/index.html](https://cran.r-project.org/web/packages/TTE/index.html) |
| Source record ids | cran_packages_by_date-654d24015e8b91 |
...
For a systems engineer, TTE belongs in the R inventory as part of defect discovery, security review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.2 | 2026-08-28 10:00:21 UTC | [https://cran.r-project.org/web/packages/TTE/DESCRIPTION](https://cran.r-project.org/web/packages/TTE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TTE/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-654d24015e8b91` from `cran_packages_by_date` as `registry_expansion`
