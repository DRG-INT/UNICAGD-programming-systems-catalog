...
<!-- canonical: https://github.com/JetBrains/skija -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JetBrains/skija](https://github.com/JetBrains/skija) |
| Source record ids | github_search_computer_graphics_software-ebaca8ec31e54f |

## System Engineer Summary

JetBrains/skija is tracked as a ffi bindings record in the Computer Graphics Software branch. The
...
For a systems engineer, JetBrains/skija belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-ebaca8ec31e54f` from `github_search_computer_graphics_software` as `registry_expansion`
