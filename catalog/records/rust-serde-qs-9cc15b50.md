...
<!-- canonical: https://crates.io/crates/serde_qs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_qs](https://crates.io/crates/serde_qs) |
| Source record ids | crates_io-e5b46fe07cb368 |

## System Engineer Summary

serde_qs is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, serde_qs belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.3 | 2026-08-07T18:59:57.888959Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-e5b46fe07cb368` from `crates_io` as `registry_expansion`
