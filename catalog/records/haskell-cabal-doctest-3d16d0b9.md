...
<!-- canonical: https://hackage.haskell.org/package/cabal-doctest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cabal-doctest](https://hackage.haskell.org/package/cabal-doctest) |
| Source record ids | hackage_top_downloads-a82a5dd0be8946 |
...
For a systems engineer, cabal-doctest belongs in the Haskell inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.12 | 2025-11-19T15:45:27Z | [https://hackage.haskell.org/package/cabal-doctest](https://hackage.haskell.org/package/cabal-doctest) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cabal-doctest` at `2026-09-05T00:31:43+00:00`.
...
- `hackage_top_downloads-a82a5dd0be8946` from `hackage_top_downloads` as `registry_expansion`
