...
<!-- canonical: https://github.com/mkang315/ASF-YOLO -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mkang315/ASF-YOLO](https://github.com/mkang315/ASF-YOLO) |
| Source record ids | github_search_microscopy-8044eeb1fe97e7 |

## System Engineer Summary

IMAVIS Official implementation of "ASF-YOLO: A Novel YOLO Model with Attentional Scale Sequence
Fusion for Cell Instance Segmentation".

## Operational Role

For a systems engineer, mkang315/ASF-YOLO belongs in the Microscopy inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-16T11:47:51Z | gh search repos topic:cell-segmentation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_microscopy-8044eeb1fe97e7` from `github_search_microscopy` as `registry_expansion`
