...
<!-- canonical: https://www.npmjs.com/package/@spawnco/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@spawnco/server](https://www.npmjs.com/package/@spawnco/server) |
| Source record ids | npm_registry-3215386bea14c5 |

## System Engineer Summary

@spawnco/server is tracked as a web framework record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @spawnco/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.62 | 2026-06-04T23:48:25.052Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-3215386bea14c5` from `npm_registry` as `registry_expansion`
