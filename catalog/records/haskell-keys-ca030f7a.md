...
<!-- canonical: https://hackage.haskell.org/package/keys -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keys](https://hackage.haskell.org/package/keys) |
| Source record ids | hackage_top_downloads-32f33c397c77f5 |
...
For a systems engineer, keys belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.12.5 | 2026-01-10T21:06:36Z | [https://hackage.haskell.org/package/keys](https://hackage.haskell.org/package/keys) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keys` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-32f33c397c77f5` from `hackage_top_downloads` as `registry_expansion`
