...
| Canonical URL | [https://luarocks.org/modules/freed-wu/graphics-cfg](https://luarocks.org/modules/freed-wu/graphics-cfg) |
| Source record ids | luarocks_root_manifest-bf8ef14d7a05ef |
...
For a systems engineer, graphics-cfg belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bf8ef14d7a05ef` from `luarocks_root_manifest` as `registry_expansion`
