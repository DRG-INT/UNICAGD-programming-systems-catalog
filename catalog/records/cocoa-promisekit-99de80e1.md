...
<!-- canonical: https://cocoapods.org/pods/PromiseKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/PromiseKit](https://cocoapods.org/pods/PromiseKit) |
| Source record ids | cocoapods_cdn-3b478aea5e737d |
...
For a systems engineer, PromiseKit belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.2.0 | 2025-01-16 22:06:42 UTC | [https://trunk.cocoapods.org/api/v1/pods/PromiseKit](https://trunk.cocoapods.org/api/v1/pods/PromiseKit) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/PromiseKit` at `2026-09-01T07:21:26+00:00`.
...
- `cocoapods_cdn-3b478aea5e737d` from `cocoapods_cdn` as `registry_expansion`
