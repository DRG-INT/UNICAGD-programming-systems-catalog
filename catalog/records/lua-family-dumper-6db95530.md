...
<!-- canonical: https://luarocks.org/modules/edubart/dumper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/edubart/dumper](https://luarocks.org/modules/edubart/dumper) |
| Source record ids | luarocks_root_manifest-a000a5cdc6e587 |
...
For a systems engineer, dumper belongs in the Lua family inventory as part of fault isolation, live
...
- `luarocks_root_manifest-a000a5cdc6e587` from `luarocks_root_manifest` as `registry_expansion`
