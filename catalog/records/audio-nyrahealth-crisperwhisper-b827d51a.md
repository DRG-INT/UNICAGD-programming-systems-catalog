...
<!-- canonical: https://github.com/nyrahealth/CrisperWhisper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nyrahealth/CrisperWhisper](https://github.com/nyrahealth/CrisperWhisper) |
| Source record ids | github_search_audio-fa8c4a7084f0ef |

## System Engineer Summary

Controllable Transcription. Verbatim ( every, filler, pause, stutter, vocal sound) , or intended (
what the speaker meant to say, optimized for readability) with word-level timestamps.

## Operational Role

For a systems engineer, nyrahealth/CrisperWhisper belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.1 | 2026-07-23T15:50:15Z | [https://api.github.com/repos/nyrahealth/CrisperWhisper/releases/latest](https://api.github.com/repos/nyrahealth/CrisperWhisper/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/nyrahealth/CrisperWhisper/releases/latest` at `2026-09-01T11:21:41+00:00`.
...
- `github_search_audio-fa8c4a7084f0ef` from `github_search_audio` as `registry_expansion`
