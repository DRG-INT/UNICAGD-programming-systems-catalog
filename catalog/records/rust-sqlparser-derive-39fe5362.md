...
| Canonical URL | [https://crates.io/crates/sqlparser_derive](https://crates.io/crates/sqlparser_derive) |
| Source record ids | crates_io-f9b1247a520da1 |
...
For a systems engineer, sqlparser_derive belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-02-10T15:54:47.574676Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-f9b1247a520da1` from `crates_io` as `registry_expansion`
