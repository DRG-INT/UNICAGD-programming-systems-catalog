...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Database Datastore](../by-category/database-datastore.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/metabrainz/picard -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/metabrainz/picard](https://github.com/metabrainz/picard) |
| Source record ids | github_search_audio-add8d90f1577dc |
...
For a systems engineer, metabrainz/picard belongs in the Audio inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T10:34:43Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-add8d90f1577dc` from `github_search_audio` as `registry_expansion`
