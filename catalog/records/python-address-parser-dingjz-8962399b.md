...
<!-- canonical: https://pypi.org/project/address-parser-dingjz/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/address-parser-dingjz/](https://pypi.org/project/address-parser-dingjz/) |
| Source record ids | pypi_simple-2662b0c269079b |

## System Engineer Summary

address-parser-dingjz is tracked as a parser lexer ast record in the Python branch. The source did
...
For a systems engineer, address-parser-dingjz belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2025-04-07T11:53:24.063523Z | [https://pypi.org/pypi/address-parser-dingjz/json](https://pypi.org/pypi/address-parser-dingjz/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/address-parser-dingjz/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-2662b0c269079b` from `pypi_simple` as `registry_expansion`
