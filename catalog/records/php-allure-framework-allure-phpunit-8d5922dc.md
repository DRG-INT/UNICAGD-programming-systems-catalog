...
<!-- canonical: https://packagist.org/packages/allure-framework/allure-phpunit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/allure-framework/allure-phpunit](https://packagist.org/packages/allure-framework/allure-phpunit) |
| Source record ids | packagist_search-eb27826f39150a |
...
For a systems engineer, allure-framework/allure-phpunit belongs in the PHP inventory as part of
...
- `packagist_search-eb27826f39150a` from `packagist_search` as `registry_expansion`
