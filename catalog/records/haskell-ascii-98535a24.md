...
<!-- canonical: https://hackage.haskell.org/package/ascii -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ascii](https://hackage.haskell.org/package/ascii) |
| Source record ids | hackage_top_downloads-60fb1e8b4d5a4a |
...
For a systems engineer, ascii belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.0.2 | 2025-01-21T07:12:36Z | [https://hackage.haskell.org/package/ascii](https://hackage.haskell.org/package/ascii) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ascii` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-60fb1e8b4d5a4a` from `hackage_top_downloads` as `registry_expansion`
