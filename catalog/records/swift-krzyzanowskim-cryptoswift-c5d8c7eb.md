...
| Canonical URL | [https://github.com/krzyzanowskim/CryptoSwift](https://github.com/krzyzanowskim/CryptoSwift) |
| Source record ids | github_search_swift-92c1bcb48332fb |

## System Engineer Summary

CryptoSwift is a growing collection of standard and secure cryptographic algorithms implemented in
Swift

## Operational Role

For a systems engineer, krzyzanowskim/CryptoSwift belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.0 | 2026-04-22T18:52:10Z | [https://api.github.com/repos/krzyzanowskim/CryptoSwift/releases/latest](https://api.github.com/repos/krzyzanowskim/CryptoSwift/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/krzyzanowskim/CryptoSwift/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-92c1bcb48332fb` from `github_search_swift` as `registry_expansion`
