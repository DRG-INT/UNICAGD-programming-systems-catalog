...
<!-- canonical: https://pub.dev/packages/fl_chart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fl_chart](https://pub.dev/packages/fl_chart) |
| Source record ids | pub_dev-5577be201201eb |

## System Engineer Summary

A highly customizable Flutter chart library that supports Line Chart, Bar Chart, Pie Chart, Scatter
Chart, and Radar Chart.

## Operational Role

For a systems engineer, fl_chart belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-03-13T20:46:03.369174Z | [https://pub.dev/api/packages/fl_chart](https://pub.dev/api/packages/fl_chart) |  |
| preview | known | 0.20.0-nullsafety1 | 2021-02-19T20:21:42.688080Z | [https://pub.dev/api/packages/fl_chart](https://pub.dev/api/packages/fl_chart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fl_chart` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-5577be201201eb` from `pub_dev` as `registry_expansion`
