...
<!-- canonical: https://github.com/hexops/vecty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hexops/vecty](https://github.com/hexops/vecty) |
| Source record ids | github_search_webassembly-a982bc741f51c2 |

## System Engineer Summary

Vecty lets you build responsive and dynamic web frontends in Go using WebAssembly, competing with
modern web frameworks like React & VueJS.

## Operational Role

For a systems engineer, hexops/vecty belongs in the WebAssembly inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-16T21:47:38Z | gh search repos topic:webassembly stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a982bc741f51c2` from `github_search_webassembly` as `registry_expansion`
