...
<!-- canonical: https://aws.amazon.com/s3/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://aws.amazon.com/s3/](https://aws.amazon.com/s3/) |
| Source record ids | curated_database_systems-e8b0625537608e |

## System Engineer Summary

Object storage service used for binary, audio, video, archives, data lakes, and application assets.

## Operational Role

For a systems engineer, Amazon S3 belongs in the Databases inventory as part of state persistence,
...
- `curated_database_systems-e8b0625537608e` from `curated_database_systems` as `registry_expansion`
