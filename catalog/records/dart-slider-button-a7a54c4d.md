...
<!-- canonical: https://pub.dev/packages/slider_button -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/slider_button](https://pub.dev/packages/slider_button) |
| Source record ids | pub_dev-971e5c02ca35d8 |
...
For a systems engineer, slider_button belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-01-28T13:19:21.814740Z | [https://pub.dev/api/packages/slider_button](https://pub.dev/api/packages/slider_button) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/slider_button` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-971e5c02ca35d8` from `pub_dev` as `registry_expansion`
