# TchassiDaniel/Gestionnaire-de-contacts
...
<!-- canonical: https://github.com/TchassiDaniel/Gestionnaire-de-contacts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TchassiDaniel/Gestionnaire-de-contacts](https://github.com/TchassiDaniel/Gestionnaire-de-contacts) |
| Source record ids | github_search_repertoare_catalogs-30fd12b7b822ef |

## System Engineer Summary

une application JAVA pour gérer le répertoire des contacts d'un établissement. Un Contact est un
Etudiant, un Enseignant ou un Agent administratif. Les contacts sont enregistrés dans le répertoire
sous forme d’une collection.

## Operational Role

For a systems engineer, TchassiDaniel/Gestionnaire-de-contacts belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-03-31T20:49:10Z | gh search repos collection repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-30fd12b7b822ef` from `github_search_repertoare_catalogs` as `registry_expansion`
...
| ouvroir/partage | Machine Learning | [open](repertoare-catalogs-ouvroir-partage-26dd1087.md) |
