...
<!-- canonical: https://github.com/DarielChen/iOSTips -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DarielChen/iOSTips](https://github.com/DarielChen/iOSTips) |
| Source record ids | github_search_cocoa-e6414686bcf757 |
...
For a systems engineer, DarielChen/iOSTips belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-19T07:14:11Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-e6414686bcf757` from `github_search_cocoa` as `registry_expansion`
