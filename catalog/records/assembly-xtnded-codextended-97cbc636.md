...
<!-- canonical: https://github.com/xtnded/codextended -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xtnded/codextended](https://github.com/xtnded/codextended) |
| Source record ids | github_search_assembly-bedfd5aff09e0a |

## System Engineer Summary

xtnded/codextended is tracked as a library record in the Assembly branch. The source did not provide
...
For a systems engineer, xtnded/codextended belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-07T10:43:51Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-bedfd5aff09e0a` from `github_search_assembly` as `registry_expansion`
