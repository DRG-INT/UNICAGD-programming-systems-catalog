...
<!-- canonical: https://hackage.haskell.org/package/zstd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zstd](https://hackage.haskell.org/package/zstd) |
| Source record ids | hackage_recent-1764fed6d2bbbd |

## System Engineer Summary

Hackage package recently uploaded by luispedro.

## Operational Role

For a systems engineer, zstd belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4.0 | 2026-09-06T03:09:59Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-1764fed6d2bbbd` from `hackage_recent` as `registry_expansion`
