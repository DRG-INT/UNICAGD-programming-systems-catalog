...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://apr.apache.org/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://apr.apache.org/](https://apr.apache.org/) |
| Source record ids | awesome_list-b669cedfb24ded |
...
For a systems engineer, APR belongs in the C++23 inventory as part of runtime behavior, deployment
...
- `awesome_list-b669cedfb24ded` from `awesome_list` as `registry_expansion`
