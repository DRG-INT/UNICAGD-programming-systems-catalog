...
<!-- canonical: https://hackage.haskell.org/package/keel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keel](https://hackage.haskell.org/package/keel) |
| Source record ids | hackage_recent-36b9648f0bd994 |
...
For a systems engineer, keel belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-03T12:55:28Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-36b9648f0bd994` from `hackage_recent` as `registry_expansion`
