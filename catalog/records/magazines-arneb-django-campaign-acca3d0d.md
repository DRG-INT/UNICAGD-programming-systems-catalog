...
<!-- canonical: https://github.com/arneb/django-campaign -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arneb/django-campaign](https://github.com/arneb/django-campaign) |
| Source record ids | github_search_magazines-055b51a6d9a144 |
...
For a systems engineer, arneb/django-campaign belongs in the Magazines inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-11-05T07:55:01Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-055b51a6d9a144` from `github_search_magazines` as `registry_expansion`
