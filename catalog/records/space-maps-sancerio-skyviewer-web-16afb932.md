...
<!-- canonical: https://github.com/Sancerio/skyviewer-web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Sancerio/skyviewer-web](https://github.com/Sancerio/skyviewer-web) |
| Source record ids | github_search_space_maps-9787083d5cc691 |

## System Engineer Summary

An open-source browser sky map: stars, constellations, planets, and observing time controls.

## Operational Role

For a systems engineer, Sancerio/skyviewer-web belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T13:11:29Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9787083d5cc691` from `github_search_space_maps` as `registry_expansion`
