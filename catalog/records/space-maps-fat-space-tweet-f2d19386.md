...
<!-- canonical: https://github.com/fat/space-tweet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fat/space-tweet](https://github.com/fat/space-tweet) |
| Source record ids | github_search_space_maps-0a5eb7ba24e7d5 |

## System Engineer Summary

Node + Socket.IO + MooTools + Twitter + Space Invaders = space-tweet (a visualization of good vs.
evil)

## Operational Role

For a systems engineer, fat/space-tweet belongs in the Space Maps inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-23T00:46:18Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0a5eb7ba24e7d5` from `github_search_space_maps` as `registry_expansion`
