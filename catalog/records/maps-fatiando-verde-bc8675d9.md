...
<!-- canonical: https://github.com/fatiando/verde -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fatiando/verde](https://github.com/fatiando/verde) |
| Source record ids | github_search_maps-2011364c84df5d |
...
For a systems engineer, fatiando/verde belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-04T17:47:38Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2011364c84df5d` from `github_search_maps` as `registry_expansion`
