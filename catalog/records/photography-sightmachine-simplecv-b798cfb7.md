...
<!-- canonical: https://github.com/sightmachine/SimpleCV -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sightmachine/SimpleCV](https://github.com/sightmachine/SimpleCV) |
| Source record ids | github_search_photography-fe6a8972aa1c63 |
...
For a systems engineer, sightmachine/SimpleCV belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-20T19:39:00Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-fe6a8972aa1c63` from `github_search_photography` as `registry_expansion`
