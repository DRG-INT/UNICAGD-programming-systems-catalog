...
<!-- canonical: https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Features -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Features](https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Features) |
| Source record ids | nuget_search-11998986b763fa |

## System Engineer Summary

ASP.NET Core HTTP feature interface definitions. This package was built from the source code at

## Operational Role

For a systems engineer, Microsoft.AspNetCore.Http.Features belongs in the C-Sharp inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.17 | 2022-05-10T14:15:45.693+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.features/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.features/index.json) |  |
| preview | known | 6.0.0-preview.4.21253.5 | 2021-05-24T21:46:59.61+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.features/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.features/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache-2.0; https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Features/5.0.17/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.aspnetcore.http.features/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-11998986b763fa` from `nuget_search` as `registry_expansion`
