...
<!-- canonical: https://cran.r-project.org/web/packages/smrlasso/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/smrlasso/index.html](https://cran.r-project.org/web/packages/smrlasso/index.html) |
| Source record ids | cran_packages_by_date-cdaa99c08b3803 |
...
For a systems engineer, smrlasso belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-09-12 08:00:02 UTC | [https://cran.r-project.org/web/packages/smrlasso/DESCRIPTION](https://cran.r-project.org/web/packages/smrlasso/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/smrlasso/DESCRIPTION` at `2026-09-12T08:19:48+00:00`.
...
- `cran_packages_by_date-cdaa99c08b3803` from `cran_packages_by_date` as `registry_expansion`
