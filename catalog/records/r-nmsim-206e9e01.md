...
<!-- canonical: https://cran.r-project.org/web/packages/NMsim/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NMsim/index.html](https://cran.r-project.org/web/packages/NMsim/index.html) |
| Source record ids | cran_packages_by_date-24a64c9eb58bea |
...
For a systems engineer, NMsim belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8 | 2026-09-08 18:20:02 UTC | [https://cran.r-project.org/web/packages/NMsim/DESCRIPTION](https://cran.r-project.org/web/packages/NMsim/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NMsim/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-24a64c9eb58bea` from `cran_packages_by_date` as `registry_expansion`
