...
| Source record ids | master-9d35806b31a1 |

## System Engineer Summary

Rust-based JS/TS compiler platform

## Operational Role

For a systems engineer, SWC belongs in the Node.js/JavaScript inventory as part of build graph
...
- `master-9d35806b31a1` from `master_json` as `build_system`
