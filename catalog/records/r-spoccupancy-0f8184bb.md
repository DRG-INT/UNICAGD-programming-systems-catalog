...
<!-- canonical: https://cran.r-project.org/web/packages/spOccupancy/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spOccupancy/index.html](https://cran.r-project.org/web/packages/spOccupancy/index.html) |
| Source record ids | cran_packages_by_date-588c40d8d5a9c3 |
...
For a systems engineer, spOccupancy belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-08-21 05:40:18 UTC | [https://cran.r-project.org/web/packages/spOccupancy/DESCRIPTION](https://cran.r-project.org/web/packages/spOccupancy/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spOccupancy/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-588c40d8d5a9c3` from `cran_packages_by_date` as `registry_expansion`
