...
<!-- canonical: https://github.com/keeferrourke/capitaine-cursors -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/keeferrourke/capitaine-cursors](https://github.com/keeferrourke/capitaine-cursors) |
| Source record ids | github_search_icons_and_logos-8dc41223538f6f |

## System Engineer Summary

An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to pair well with my icon
pack, La Capitaine.

## Operational Role

For a systems engineer, keeferrourke/capitaine-cursors belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-05T13:11:37Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-8dc41223538f6f` from `github_search_icons_and_logos` as `registry_expansion`
