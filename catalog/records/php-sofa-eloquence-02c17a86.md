...
<!-- canonical: https://packagist.org/packages/sofa/eloquence -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sofa/eloquence](https://packagist.org/packages/sofa/eloquence) |
| Source record ids | packagist_search-cad64cc192a06b |
...
For a systems engineer, sofa/eloquence belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-cad64cc192a06b` from `packagist_search` as `registry_expansion`
