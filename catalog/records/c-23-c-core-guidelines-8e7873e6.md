...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C++23](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c-23.md) · [Category: Tutorial Book Styleguide](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/tutorial-book-styleguide.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | tutorial_book_styleguide |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-572cb5732446 |
...
For a systems engineer, C++ Core Guidelines belongs in the C++23 inventory as part of ecosystem
...
- `master-572cb5732446` from `master_json` as `tutorial_book_styleguide`
