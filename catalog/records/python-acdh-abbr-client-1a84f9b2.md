...
<!-- canonical: https://pypi.org/project/acdh-abbr-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acdh-abbr-client/](https://pypi.org/project/acdh-abbr-client/) |
| Source record ids | pypi_simple-dbf4234d58a4e4 |
...
For a systems engineer, acdh-abbr-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2020-12-13T10:30:04.902816Z | [https://pypi.org/pypi/acdh-abbr-client/json](https://pypi.org/pypi/acdh-abbr-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acdh-abbr-client/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-dbf4234d58a4e4` from `pypi_simple` as `registry_expansion`
