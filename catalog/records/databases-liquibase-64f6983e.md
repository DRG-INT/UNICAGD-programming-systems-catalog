...
| Canonical URL | [https://github.com/liquibase/liquibase](https://github.com/liquibase/liquibase) |
| Source record ids | curated_database_systems-c1e038508d1ee3 |

## System Engineer Summary

Database schema change and migration management tool.

## Operational Role

For a systems engineer, Liquibase belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.0.4 | 2026-08-20T16:18:26Z | [https://api.github.com/repos/liquibase/liquibase/releases/latest](https://api.github.com/repos/liquibase/liquibase/releases/latest) |  |
| preview | known | nightly | 2026-08-31T13:55:00Z | [https://api.github.com/repos/liquibase/liquibase/releases?per_page=10](https://api.github.com/repos/liquibase/liquibase/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/liquibase/liquibase/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-c1e038508d1ee3` from `curated_database_systems` as `registry_expansion`
