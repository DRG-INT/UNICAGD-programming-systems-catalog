...
<!-- canonical: https://github.com/CopilotKit/CopilotKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) |
| Source record ids | github_search_aims-a9765788927b0b |

## System Engineer Summary

The Frontend Stack for Agents & Generative UI. React, Angular, Mobile, Slack, and more. Makers of
the AG-UI Protocol

## Operational Role

For a systems engineer, CopilotKit/CopilotKit belongs in the "aim's" inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-15T00:58:54Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""}; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_aims-a9765788927b0b` from `github_search_aims` as `registry_expansion`
