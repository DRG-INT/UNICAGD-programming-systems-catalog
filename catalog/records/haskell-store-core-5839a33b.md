...
<!-- canonical: https://hackage.haskell.org/package/store-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/store-core](https://hackage.haskell.org/package/store-core) |
| Source record ids | hackage_top_downloads-eee08399fce4e0 |
...
For a systems engineer, store-core belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.4.7 | 2024-02-16T06:32:02Z | [https://hackage.haskell.org/package/store-core](https://hackage.haskell.org/package/store-core) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/store-core` at `2026-09-09T00:35:14+00:00`.
...
- `hackage_top_downloads-eee08399fce4e0` from `hackage_top_downloads` as `registry_expansion`
