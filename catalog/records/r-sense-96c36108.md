...
<!-- canonical: https://cran.r-project.org/web/packages/sense/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sense/index.html](https://cran.r-project.org/web/packages/sense/index.html) |
| Source record ids | cran_packages_by_date-c430d009ce9e89 |
...
For a systems engineer, sense belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-08 05:20:02 UTC | [https://cran.r-project.org/web/packages/sense/DESCRIPTION](https://cran.r-project.org/web/packages/sense/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sense/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-c430d009ce9e89` from `cran_packages_by_date` as `registry_expansion`
