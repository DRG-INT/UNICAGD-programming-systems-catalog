...
<!-- canonical: https://packagist.org/packages/colinmollenhour/php-redis-session-abstract -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/colinmollenhour/php-redis-session-abstract](https://packagist.org/packages/colinmollenhour/php-redis-session-abstract) |
| Source record ids | packagist_search-5429d04217f899 |
...
For a systems engineer, colinmollenhour/php-redis-session-abstract belongs in the PHP inventory as
...
- `packagist_search-5429d04217f899` from `packagist_search` as `registry_expansion`
