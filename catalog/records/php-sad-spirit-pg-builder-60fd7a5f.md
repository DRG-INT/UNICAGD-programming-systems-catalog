...
<!-- canonical: https://packagist.org/packages/sad_spirit/pg_builder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sad_spirit/pg_builder](https://packagist.org/packages/sad_spirit/pg_builder) |
| Source record ids | packagist_search-c188468538a839 |
...
For a systems engineer, sad_spirit/pg_builder belongs in the PHP inventory as part of build graph
...
- `packagist_search-c188468538a839` from `packagist_search` as `registry_expansion`
