...
<!-- canonical: https://github.com/locationtech/jts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/locationtech/jts](https://github.com/locationtech/jts) |
| Source record ids | github_search_maps-7746d98a1e6715 |
...
For a systems engineer, locationtech/jts belongs in the Maps inventory as part of diagnostics,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-13T21:48:56Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-7746d98a1e6715` from `github_search_maps` as `registry_expansion`
