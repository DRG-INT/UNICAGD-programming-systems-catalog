...
<!-- canonical: https://luarocks.org/modules/sirzenith/async-utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/sirzenith/async-utils](https://luarocks.org/modules/sirzenith/async-utils) |
| Source record ids | luarocks_root_manifest-4ce325e827511a |

## System Engineer Summary

async-utils is tracked as an async runtime record in the Lua family branch. The source did not
...
For a systems engineer, async-utils belongs in the Lua family inventory as part of concurrency
...
- `luarocks_root_manifest-4ce325e827511a` from `luarocks_root_manifest` as `registry_expansion`
