...
[Catalog index](../index.md) · [Language: PHP](../by-language/php.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://packagist.org/packages/php-curl-class/php-curl-class -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-curl-class/php-curl-class](https://packagist.org/packages/php-curl-class/php-curl-class) |
| Source record ids | packagist_search-1587e8d997cc71 |
...
For a systems engineer, php-curl-class/php-curl-class belongs in the PHP inventory as part of build
...
- `packagist_search-1587e8d997cc71` from `packagist_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| api-platform/core | Build System | [open](php-api-platform-core-9c7ba182.md) |
| arvenil/ninja-mutex | Build System | [open](php-arvenil-ninja-mutex-ade0fdd0.md) |
| atlas/query | Build System | [open](php-atlas-query-bc40393d.md) |
| aura/sqlquery | Build System | [open](php-aura-sqlquery-18182d51.md) |
| cebe/php-openapi | Build System | [open](php-cebe-php-openapi-c412045f.md) |
| clancats/hydrahon | Build System | [open](php-clancats-hydrahon-6afcd625.md) |
| devtheorem/peachy-sql | Build System | [open](php-devtheorem-peachy-sql-ebe11428.md) |
| ergebnis/json-schema-validator | Build System | [open](php-ergebnis-json-schema-validator-b6b15096.md) |
