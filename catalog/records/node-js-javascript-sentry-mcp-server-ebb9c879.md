...
<!-- canonical: https://www.npmjs.com/package/@sentry/mcp-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@sentry/mcp-server](https://www.npmjs.com/package/@sentry/mcp-server) |
| Source record ids | npm_registry-911e6b181cd0d8 |

## System Engineer Summary

@sentry/mcp-server is tracked as a web framework record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @sentry/mcp-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.39.0 | 2026-08-27T06:47:36.921Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-911e6b181cd0d8` from `npm_registry` as `registry_expansion`
