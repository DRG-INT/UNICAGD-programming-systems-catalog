...
<!-- canonical: https://github.com/klein/klein.php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/klein/klein.php](https://github.com/klein/klein.php) |
| Source record ids | github_search_maps-31c3b006a86c6a |
...
For a systems engineer, klein/klein.php belongs in the Maps inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.2 | 2017-02-01T23:11:27Z | [https://api.github.com/repos/klein/klein.php/releases/latest](https://api.github.com/repos/klein/klein.php/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/klein/klein.php/releases/latest` at `2026-09-01T12:30:02+00:00`.
...
- `github_search_maps-31c3b006a86c6a` from `github_search_maps` as `registry_expansion`
