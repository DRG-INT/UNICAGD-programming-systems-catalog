...
| Canonical URL | [https://luarocks.org/modules/kitsunies/grid](https://luarocks.org/modules/kitsunies/grid) |
| Source record ids | luarocks_root_manifest-a5ea21edbd79a0 |

## System Engineer Summary

grid is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, grid belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a5ea21edbd79a0` from `luarocks_root_manifest` as `registry_expansion`
