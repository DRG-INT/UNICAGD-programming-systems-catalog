...
<!-- canonical: https://pypi.org/project/4logik-python-rest-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/4logik-python-rest-client/](https://pypi.org/project/4logik-python-rest-client/) |
| Source record ids | pypi_simple-e37215038333af |
...
For a systems engineer, 4logik-python-rest-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2022-03-16T21:12:24.927723Z | [https://pypi.org/pypi/4logik-python-rest-client/json](https://pypi.org/pypi/4logik-python-rest-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/4logik-python-rest-client/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-e37215038333af` from `pypi_simple` as `registry_expansion`
