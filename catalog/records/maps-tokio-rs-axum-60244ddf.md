...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tokio-rs/axum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tokio-rs/axum](https://github.com/tokio-rs/axum) |
| Source record ids | github_search_maps-e8f79ca8b1a8ad |
...
For a systems engineer, tokio-rs/axum belongs in the Maps inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | axum-v0.8.9 | 2026-04-14T09:39:51Z | [https://api.github.com/repos/tokio-rs/axum/releases/latest](https://api.github.com/repos/tokio-rs/axum/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/tokio-rs/axum/releases/latest` at `2026-09-01T12:30:05+00:00`.
...
- `github_search_maps-e8f79ca8b1a8ad` from `github_search_maps` as `registry_expansion`
