...
<!-- canonical: https://pub.dev/packages/flutter_box_transform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_box_transform](https://pub.dev/packages/flutter_box_transform) |
| Source record ids | pub_dev-ffbf6bfe1995ee |

## System Engineer Summary

A Flutter implementation of box_transform package that provides easy 2D box transform operations
with advanced resizing of rect in UI.

## Operational Role

For a systems engineer, flutter_box_transform belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.7 | 2025-03-26T10:53:15.777522Z | [https://pub.dev/api/packages/flutter_box_transform](https://pub.dev/api/packages/flutter_box_transform) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_box_transform` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-ffbf6bfe1995ee` from `pub_dev` as `registry_expansion`
