...
<!-- canonical: https://cran.r-project.org/web/packages/datasetjson/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datasetjson/index.html](https://cran.r-project.org/web/packages/datasetjson/index.html) |
| Source record ids | cran_packages_by_date-adddf255931af9 |
...
For a systems engineer, datasetjson belongs in the R inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-09-04 02:20:02 UTC | [https://cran.r-project.org/web/packages/datasetjson/DESCRIPTION](https://cran.r-project.org/web/packages/datasetjson/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datasetjson/DESCRIPTION` at `2026-09-04T03:19:43+00:00`.
...
- `cran_packages_by_date-adddf255931af9` from `cran_packages_by_date` as `registry_expansion`
