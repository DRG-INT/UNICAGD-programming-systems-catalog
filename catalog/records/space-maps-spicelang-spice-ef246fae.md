...
<!-- canonical: https://github.com/spicelang/spice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/spicelang/spice](https://github.com/spicelang/spice) |
| Source record ids | github_search_space_maps-660885b143044a |
...
For a systems engineer, spicelang/spice belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:06:10Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-660885b143044a` from `github_search_space_maps` as `registry_expansion`
