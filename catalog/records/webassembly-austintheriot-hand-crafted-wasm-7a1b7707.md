...
<!-- canonical: https://github.com/austintheriot/hand-crafted-wasm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/austintheriot/hand-crafted-wasm](https://github.com/austintheriot/hand-crafted-wasm) |
| Source record ids | github_search_webassembly-50f353cbad59c6 |

## System Engineer Summary

Creative coding and other mischief in handwritten WebAssembly, using the WebAssembly .wat text
format.

## Operational Role

For a systems engineer, austintheriot/hand-crafted-wasm belongs in the WebAssembly inventory as part
...
- `github_search_webassembly-50f353cbad59c6` from `github_search_webassembly` as `registry_expansion`
...
| skerkour/black-hat-rust | Formatter | [open](webassembly-skerkour-black-hat-rust-9da6bbfa.md) |
