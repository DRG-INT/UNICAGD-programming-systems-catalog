...
<!-- canonical: https://pypi.org/project/addressformatting/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/addressformatting/](https://pypi.org/project/addressformatting/) |
| Source record ids | pypi_simple-5d09b8586cb7c0 |
...
For a systems engineer, addressformatting belongs in the Python inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.2 | 2023-07-14T08:30:20.486264Z | [https://pypi.org/pypi/addressformatting/json](https://pypi.org/pypi/addressformatting/json) |  |
...
| Evidence | BSD; License :: OSI Approved :: BSD License |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/addressformatting/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-5d09b8586cb7c0` from `pypi_simple` as `registry_expansion`
