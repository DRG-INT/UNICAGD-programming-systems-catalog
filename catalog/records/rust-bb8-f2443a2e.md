...
| Canonical URL | [https://crates.io/crates/bb8](https://crates.io/crates/bb8) |
| Source record ids | crates_io-19d2fe59937cf3 |
...
For a systems engineer, bb8 belongs in the Rust inventory as part of concurrency scheduling, I/O
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2025-11-24T14:08:13.647357Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-19d2fe59937cf3` from `crates_io` as `registry_expansion`
