...
<!-- canonical: https://luarocks.org/modules/deltara3/cc-teal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/deltara3/cc-teal](https://luarocks.org/modules/deltara3/cc-teal) |
| Source record ids | luarocks_root_manifest-fc45760751c671 |
...
For a systems engineer, cc-teal belongs in the Lua family inventory as part of interface contracts,
...
- `luarocks_root_manifest-fc45760751c671` from `luarocks_root_manifest` as `registry_expansion`
