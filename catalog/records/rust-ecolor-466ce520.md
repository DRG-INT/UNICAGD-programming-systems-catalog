...
| Canonical URL | [https://crates.io/crates/ecolor](https://crates.io/crates/ecolor) |
| Source record ids | crates_io-2795f749227f7e |
...
For a systems engineer, ecolor belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.36.1 | 2026-08-07T13:09:15.135508Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-2795f749227f7e` from `crates_io` as `registry_expansion`
