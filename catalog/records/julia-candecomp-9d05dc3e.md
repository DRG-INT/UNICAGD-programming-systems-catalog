...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CanDecomp](https://github.com/JuliaRegistries/General/tree/master/C/CanDecomp) |
| Source record ids | julia_general-a60cd6f49b9a02 |

## System Engineer Summary

Julia package registered in General at C/CanDecomp.

## Operational Role

For a systems engineer, CanDecomp belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CanDecomp", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-a60cd6f49b9a02` from `julia_general` as `registry_expansion`
