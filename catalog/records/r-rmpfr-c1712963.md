...
<!-- canonical: https://cran.r-project.org/web/packages/Rmpfr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rmpfr/index.html](https://cran.r-project.org/web/packages/Rmpfr/index.html) |
| Source record ids | cran_packages_by_date-0dc20ca16c3b0c |
...
For a systems engineer, Rmpfr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1-3 | 2026-09-06 11:40:08 UTC | [https://cran.r-project.org/web/packages/Rmpfr/DESCRIPTION](https://cran.r-project.org/web/packages/Rmpfr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rmpfr/DESCRIPTION` at `2026-09-06T12:23:08+00:00`.
...
- `cran_packages_by_date-0dc20ca16c3b0c` from `cran_packages_by_date` as `registry_expansion`
