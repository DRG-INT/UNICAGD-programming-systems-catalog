...
<!-- canonical: https://cran.r-project.org/web/packages/gorica/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gorica/index.html](https://cran.r-project.org/web/packages/gorica/index.html) |
| Source record ids | cran_packages_by_date-3ff286ccbe4354 |
...
For a systems engineer, gorica belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.6 | 2026-08-22 14:30:02 UTC | [https://cran.r-project.org/web/packages/gorica/DESCRIPTION](https://cran.r-project.org/web/packages/gorica/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gorica/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-3ff286ccbe4354` from `cran_packages_by_date` as `registry_expansion`
