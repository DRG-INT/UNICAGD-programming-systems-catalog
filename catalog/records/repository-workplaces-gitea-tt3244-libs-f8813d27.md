...
<!-- canonical: https://gitea.com/tt3244/libs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/tt3244/libs](https://gitea.com/tt3244/libs) |
| Source record ids | gitea_repositories_api-544fe15180ff60 |

## System Engineer Summary

Gitea: tt3244/libs is tracked as a library record in the Repository Workplaces branch. The source
...
For a systems engineer, Gitea: tt3244/libs belongs in the Repository Workplaces inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-16T23:40:44Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-544fe15180ff60` from `gitea_repositories_api` as `registry_expansion`
