...
<!-- canonical: https://packagist.org/packages/sabre/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sabre/http](https://packagist.org/packages/sabre/http) |
| Source record ids | packagist_search-fa6984e6ac608c |
...
For a systems engineer, sabre/http belongs in the PHP inventory as part of ecosystem capability
...
- `packagist_search-fa6984e6ac608c` from `packagist_search` as `registry_expansion`
