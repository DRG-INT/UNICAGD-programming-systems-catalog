...
<!-- canonical: https://github.com/osmcode/osmium-tool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/osmcode/osmium-tool](https://github.com/osmcode/osmium-tool) |
| Source record ids | github_search_maps-5f1df22c5e358b |
...
For a systems engineer, osmcode/osmium-tool belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T20:40:43Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-5f1df22c5e358b` from `github_search_maps` as `registry_expansion`
