...
| Source record ids | github_search_effects-7a398ace1d0e3b |
...
For a systems engineer, michaelwillis/dragonfly-reverb belongs in the Effects inventory as part of
...
| Evidence | LGPL (>= 2); GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- `github_search_effects-7a398ace1d0e3b` from `github_search_effects` as `registry_expansion`
