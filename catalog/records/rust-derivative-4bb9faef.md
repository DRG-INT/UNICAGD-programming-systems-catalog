...
<!-- canonical: https://crates.io/crates/derivative -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/derivative](https://crates.io/crates/derivative) |
| Source record ids | crates_io-e3bcf4d2da4d7b |
...
For a systems engineer, derivative belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2021-01-23T17:05:39.339355Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-e3bcf4d2da4d7b` from `crates_io` as `registry_expansion`
