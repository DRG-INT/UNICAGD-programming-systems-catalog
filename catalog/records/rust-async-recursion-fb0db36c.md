...
<!-- canonical: https://crates.io/crates/async-recursion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-recursion](https://crates.io/crates/async-recursion) |
| Source record ids | crates_io-2db95b23daaf14 |
...
For a systems engineer, async-recursion belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2024-04-25T16:06:43.164603Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-2db95b23daaf14` from `crates_io` as `registry_expansion`
