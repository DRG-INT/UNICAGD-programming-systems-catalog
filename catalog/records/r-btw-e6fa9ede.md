...
<!-- canonical: https://cran.r-project.org/web/packages/btw/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/btw/index.html](https://cran.r-project.org/web/packages/btw/index.html) |
| Source record ids | cran_packages_by_date-4780a542e62591 |
...
For a systems engineer, btw belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-08-05 06:10:03 UTC | [https://cran.r-project.org/web/packages/btw/DESCRIPTION](https://cran.r-project.org/web/packages/btw/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/btw/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4780a542e62591` from `cran_packages_by_date` as `registry_expansion`
