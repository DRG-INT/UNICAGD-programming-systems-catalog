...
<!-- canonical: https://github.com/matthew-kissinger/kiln -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matthew-kissinger/kiln](https://github.com/matthew-kissinger/kiln) |
| Source record ids | github_search_assets-0f75c059e9fcc2 |

## System Engineer Summary

Text-to-3D as code: language models write JavaScript programs that build game-ready GLBs, look at
their own renders, and revise. Ships as an MCP server plus skills for any harness.

## Operational Role

For a systems engineer, matthew-kissinger/kiln belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T12:27:06Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-0f75c059e9fcc2` from `github_search_assets` as `registry_expansion`
