...
<!-- canonical: https://github.com/MillionSend/millionsend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MillionSend/millionsend](https://github.com/MillionSend/millionsend) |
| Source record ids | github_search_magazines-55009c76ea49e4 |

## System Engineer Summary

The open-source email platform — self-host on your own AWS SES, or use the cloud. Resend-compatible
API.

## Operational Role

For a systems engineer, MillionSend/millionsend belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T02:35:48Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-55009c76ea49e4` from `github_search_magazines` as `registry_expansion`
