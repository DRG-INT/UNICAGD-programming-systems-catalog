...
| Canonical URL | [https://luarocks.org/modules/zeroflag/equinox](https://luarocks.org/modules/zeroflag/equinox) |
| Source record ids | luarocks_root_manifest-586c53dca53f13 |

## System Engineer Summary

equinox is tracked as a visualization gui record in the Lua family branch. The source did not
...
For a systems engineer, equinox belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-586c53dca53f13` from `luarocks_root_manifest` as `registry_expansion`
