...
<!-- canonical: https://hackage.haskell.org/package/simple-pipe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/simple-pipe](https://hackage.haskell.org/package/simple-pipe) |
| Source record ids | hackage_top_downloads-9c22e46bf21ecf |
...
For a systems engineer, simple-pipe belongs in the Haskell inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.0.29 | 2015-09-29T03:12:41Z | [https://hackage.haskell.org/package/simple-pipe](https://hackage.haskell.org/package/simple-pipe) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/simple-pipe` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-9c22e46bf21ecf` from `hackage_top_downloads` as `registry_expansion`
