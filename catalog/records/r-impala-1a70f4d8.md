...
<!-- canonical: https://cran.r-project.org/web/packages/impala/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/impala/index.html](https://cran.r-project.org/web/packages/impala/index.html) |
| Source record ids | cran_packages_by_date-a1a9fc1c6383f7 |
...
For a systems engineer, impala belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-08-21 19:30:02 UTC | [https://cran.r-project.org/web/packages/impala/DESCRIPTION](https://cran.r-project.org/web/packages/impala/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/impala/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a1a9fc1c6383f7` from `cran_packages_by_date` as `registry_expansion`
