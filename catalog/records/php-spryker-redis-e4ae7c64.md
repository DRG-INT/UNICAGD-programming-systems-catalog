...
<!-- canonical: https://packagist.org/packages/spryker/redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/spryker/redis](https://packagist.org/packages/spryker/redis) |
| Source record ids | packagist_search-8fcb54822f32f9 |

## System Engineer Summary

spryker/redis is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, spryker/redis belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-8fcb54822f32f9` from `packagist_search` as `registry_expansion`
