...
| Canonical URL | [https://luarocks.org/modules/gonapps/gonapps-url-router](https://luarocks.org/modules/gonapps/gonapps-url-router) |
| Source record ids | luarocks_root_manifest-48833df3b51504 |

## System Engineer Summary

gonapps-url-router is tracked as a web framework record in the Lua family branch. The source did not
...
For a systems engineer, gonapps-url-router belongs in the Lua family inventory as part of request
...
- `luarocks_root_manifest-48833df3b51504` from `luarocks_root_manifest` as `registry_expansion`
