...
| Canonical URL | [https://luarocks.org/modules/leafo/heroku-openresty](https://luarocks.org/modules/leafo/heroku-openresty) |
| Source record ids | luarocks_root_manifest-36a36ee304f11f |
...
For a systems engineer, heroku-openresty belongs in the Lua family inventory as part of build graph
...
- `luarocks_root_manifest-36a36ee304f11f` from `luarocks_root_manifest` as `registry_expansion`
