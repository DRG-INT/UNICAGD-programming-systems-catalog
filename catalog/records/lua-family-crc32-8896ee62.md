...
<!-- canonical: https://luarocks.org/modules/hjelmeland/crc32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/hjelmeland/crc32](https://luarocks.org/modules/hjelmeland/crc32) |
| Source record ids | luarocks_root_manifest-7dd2e91be53a78 |
...
For a systems engineer, crc32 belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-7dd2e91be53a78` from `luarocks_root_manifest` as `registry_expansion`
