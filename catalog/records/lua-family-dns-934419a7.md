...
<!-- canonical: https://luarocks.org/modules/kong/dns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/kong/dns](https://luarocks.org/modules/kong/dns) |
| Source record ids | luarocks_root_manifest-237f3ef0823946 |
...
For a systems engineer, dns belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-237f3ef0823946` from `luarocks_root_manifest` as `registry_expansion`
