...
<!-- canonical: https://cran.r-project.org/web/packages/qgcomp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qgcomp/index.html](https://cran.r-project.org/web/packages/qgcomp/index.html) |
| Source record ids | cran_packages_by_date-5556d079dd73d9 |

## System Engineer Summary

qgcomp is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, qgcomp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.19.5 | 2026-09-03 05:20:11 UTC | [https://cran.r-project.org/web/packages/qgcomp/DESCRIPTION](https://cran.r-project.org/web/packages/qgcomp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qgcomp/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-5556d079dd73d9` from `cran_packages_by_date` as `registry_expansion`
