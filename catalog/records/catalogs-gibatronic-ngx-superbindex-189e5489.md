...
<!-- canonical: https://github.com/gibatronic/ngx-superbindex -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gibatronic/ngx-superbindex](https://github.com/gibatronic/ngx-superbindex) |
| Source record ids | github_search_catalogs-781228456b632b |
...
For a systems engineer, gibatronic/ngx-superbindex belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T01:02:49Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-781228456b632b` from `github_search_catalogs` as `registry_expansion`
