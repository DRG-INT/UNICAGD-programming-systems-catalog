...
<!-- canonical: https://cran.r-project.org/web/packages/BMIselect/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BMIselect/index.html](https://cran.r-project.org/web/packages/BMIselect/index.html) |
| Source record ids | cran_packages_by_date-a299f398b39bb6 |
...
For a systems engineer, BMIselect belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9 | 2026-08-21 22:02:04 UTC | [https://cran.r-project.org/web/packages/BMIselect/DESCRIPTION](https://cran.r-project.org/web/packages/BMIselect/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BMIselect/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a299f398b39bb6` from `cran_packages_by_date` as `registry_expansion`
