...
<!-- canonical: https://cran.r-project.org/web/packages/APD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/APD/index.html](https://cran.r-project.org/web/packages/APD/index.html) |
| Source record ids | cran_packages_by_date-7773a6e9d786db |
...
For a systems engineer, APD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-05 07:50:17 UTC | [https://cran.r-project.org/web/packages/APD/DESCRIPTION](https://cran.r-project.org/web/packages/APD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/APD/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7773a6e9d786db` from `cran_packages_by_date` as `registry_expansion`
