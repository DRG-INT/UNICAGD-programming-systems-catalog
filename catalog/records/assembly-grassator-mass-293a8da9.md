...
<!-- canonical: https://github.com/grassator/mass -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/grassator/mass](https://github.com/grassator/mass) |
| Source record ids | github_search_assembly-d2be7f4761d742 |
...
For a systems engineer, grassator/mass belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-03T22:05:30Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-d2be7f4761d742` from `github_search_assembly` as `registry_expansion`
