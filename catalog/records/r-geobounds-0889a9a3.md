...
<!-- canonical: https://cran.r-project.org/web/packages/geobounds/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geobounds/index.html](https://cran.r-project.org/web/packages/geobounds/index.html) |
| Source record ids | cran_packages_by_date-20e54daa3e5a5d |
...
For a systems engineer, geobounds belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-09-05 19:00:02 UTC | [https://cran.r-project.org/web/packages/geobounds/DESCRIPTION](https://cran.r-project.org/web/packages/geobounds/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geobounds/DESCRIPTION` at `2026-09-05T20:19:01+00:00`.
...
- `cran_packages_by_date-20e54daa3e5a5d` from `cran_packages_by_date` as `registry_expansion`
