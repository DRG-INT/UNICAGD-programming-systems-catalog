...
<!-- canonical: https://cran.r-project.org/web/packages/educabR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/educabR/index.html](https://cran.r-project.org/web/packages/educabR/index.html) |
| Source record ids | cran_packages_by_date-d3a4f6e4e681c0 |

## System Engineer Summary

Download and Process Brazilian Education Data from INEP

## Operational Role

For a systems engineer, educabR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-23 11:10:02 UTC | [https://cran.r-project.org/web/packages/educabR/DESCRIPTION](https://cran.r-project.org/web/packages/educabR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/educabR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d3a4f6e4e681c0` from `cran_packages_by_date` as `registry_expansion`
