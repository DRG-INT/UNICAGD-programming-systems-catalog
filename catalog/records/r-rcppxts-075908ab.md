...
<!-- canonical: https://cran.r-project.org/web/packages/RcppXts/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RcppXts/index.html](https://cran.r-project.org/web/packages/RcppXts/index.html) |
| Source record ids | cran_packages_by_date-0cf93ff344aea0 |
...
For a systems engineer, RcppXts belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7 | 2026-09-09 12:30:17 UTC | [https://cran.r-project.org/web/packages/RcppXts/DESCRIPTION](https://cran.r-project.org/web/packages/RcppXts/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RcppXts/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-0cf93ff344aea0` from `cran_packages_by_date` as `registry_expansion`
