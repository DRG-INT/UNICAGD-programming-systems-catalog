...
<!-- canonical: https://crates.io/crates/futures-sink -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-sink](https://crates.io/crates/futures-sink) |
| Source record ids | crates_io-c5a94e99526a4b |
...
For a systems engineer, futures-sink belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:06.160611Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-c5a94e99526a4b` from `crates_io` as `registry_expansion`
