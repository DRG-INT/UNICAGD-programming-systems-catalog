...
<!-- canonical: https://github.com/Alexgichamba/sat-rf-sim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Alexgichamba/sat-rf-sim](https://github.com/Alexgichamba/sat-rf-sim) |
| Source record ids | github_search_satcom_satellites-476f847adca5dc |

## System Engineer Summary

Models channels for RF propagation between a satellite and ground station

## Operational Role

For a systems engineer, Alexgichamba/sat-rf-sim belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-27T19:39:45Z | gh search repos topic:satellite-communications stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-476f847adca5dc` from `github_search_satcom_satellites` as `registry_expansion`
