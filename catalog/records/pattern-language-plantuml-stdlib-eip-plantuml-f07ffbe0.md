...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Standard Library](../by-category/standard-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/plantuml-stdlib/EIP-PlantUML](https://github.com/plantuml-stdlib/EIP-PlantUML) |
| Source record ids | github_search_pattern_language-3e110a45adef67 |

## System Engineer Summary

EIP-PlantUML adds Enterprise Integrations Patterns elements to PlantUML to provide easy support of
designing EIP architectures for both, up-front design as well as development-time automated
documentation generation.

## Operational Role

For a systems engineer, plantuml-stdlib/EIP-PlantUML belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2025-11-19T15:38:07Z | [https://api.github.com/repos/plantuml-stdlib/EIP-PlantUML/releases/latest](https://api.github.com/repos/plantuml-stdlib/EIP-PlantUML/releases/latest) |  |
| preview | known | v1.0.0-rc1 | 2019-07-09T20:25:34Z | [https://api.github.com/repos/plantuml-stdlib/EIP-PlantUML/releases?per_page=10](https://api.github.com/repos/plantuml-stdlib/EIP-PlantUML/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/plantuml-stdlib/EIP-PlantUML/releases/latest` at `2026-09-01T12:30:29+00:00`.
...
- `github_search_pattern_language-3e110a45adef67` from `github_search_pattern_language` as `registry_expansion`
