...
<!-- canonical: https://crates.io/crates/unicode-normalization-alignments -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-normalization-alignments](https://crates.io/crates/unicode-normalization-alignments) |
| Source record ids | crates_io-b9aa8810f680ef |

## System Engineer Summary

This crate provides functions for normalization of Unicode strings, including Canonical and
Compatible Decomposition and Recomposition, as described in Unicode Standard Annex #15.

## Operational Role

For a systems engineer, unicode-normalization-alignments belongs in the Rust inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.12 | 2019-12-30T17:10:56.165608Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
