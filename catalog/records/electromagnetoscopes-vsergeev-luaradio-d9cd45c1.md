...
| Source record ids | github_search_electromagnetoscopes-c611c544e8373b |
...
For a systems engineer, vsergeev/luaradio belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.11.0 | 2022-11-11T07:05:42Z | [https://api.github.com/repos/vsergeev/luaradio/releases/latest](https://api.github.com/repos/vsergeev/luaradio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/vsergeev/luaradio/releases/latest` at `2026-09-01T08:26:43+00:00`.
...
- `github_search_electromagnetoscopes-c611c544e8373b` from `github_search_electromagnetoscopes` as `registry_expansion`
