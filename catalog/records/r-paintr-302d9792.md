...
<!-- canonical: https://cran.r-project.org/web/packages/paintr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/paintr/index.html](https://cran.r-project.org/web/packages/paintr/index.html) |
| Source record ids | cran_packages_by_date-b33573850dfd96 |
...
For a systems engineer, paintr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-08-06 13:10:14 UTC | [https://cran.r-project.org/web/packages/paintr/DESCRIPTION](https://cran.r-project.org/web/packages/paintr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/paintr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b33573850dfd96` from `cran_packages_by_date` as `registry_expansion`
