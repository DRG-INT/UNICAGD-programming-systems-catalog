...
<!-- canonical: https://github.com/kmbzn/project-winemoji -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kmbzn/project-winemoji](https://github.com/kmbzn/project-winemoji) |
| Source record ids | github_search_font_briefcase-49e2f2084e479f |

## System Engineer Summary

리눅스 Wine 환경 카카오톡 PC버전의 이모지 깨짐(▯▯) 문제를 해결

## Operational Role

For a systems engineer, kmbzn/project-winemoji belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-09T09:34:02Z | gh search repos topic:fonttools stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-49e2f2084e479f` from `github_search_font_briefcase` as `registry_expansion`
