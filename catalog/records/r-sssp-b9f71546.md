...
<!-- canonical: https://cran.r-project.org/web/packages/sssp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sssp/index.html](https://cran.r-project.org/web/packages/sssp/index.html) |
| Source record ids | cran_packages_by_date-9d571b7dedceda |

## System Engineer Summary

Semi-Symmetric Sparse Projection

## Operational Role

For a systems engineer, sssp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-05 14:10:02 UTC | [https://cran.r-project.org/web/packages/sssp/DESCRIPTION](https://cran.r-project.org/web/packages/sssp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sssp/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-9d571b7dedceda` from `cran_packages_by_date` as `registry_expansion`
