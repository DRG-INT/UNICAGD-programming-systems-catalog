...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/thingsboard/thingsboard-gateway -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thingsboard/thingsboard-gateway](https://github.com/thingsboard/thingsboard-gateway) |
| Source record ids | github_search_databases-f5452770a3637c |

## System Engineer Summary

Open-source IoT Gateway - integrates devices connected to legacy and third-party systems with
ThingsBoard IoT Platform using Modbus, CAN bus, BACnet, BLE, OPC-UA, MQTT, ODBC and REST protocols.

## Operational Role

For a systems engineer, thingsboard/thingsboard-gateway belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:48:55Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f5452770a3637c` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| confluentinc/examples | Message Broker | [open](databases-confluentinc-examples-3b680d5c.md) |
| kaiwaehner/hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference | Message Broker | [open](databases-kaiwaehner-hivemq-mqtt-tensorflow-kafka-realtime-iot-machine-learning-training-inference-56011b79.md) |
