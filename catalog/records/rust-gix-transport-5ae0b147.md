...
<!-- canonical: https://crates.io/crates/gix-transport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gix-transport](https://crates.io/crates/gix-transport) |
| Source record ids | crates_io-47c48630bbf84f |
...
For a systems engineer, gix-transport belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.59.2 | 2026-09-01T03:14:14.064810Z | [https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=15&per_page=100&sort=downloads` at `2026-09-01T03:20:09+00:00`.
