...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/microsoft/computervision-recipes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/computervision-recipes](https://github.com/microsoft/computervision-recipes) |
| Source record ids | github_search_photography-11a165fe77f7a2 |
...
For a systems engineer, microsoft/computervision-recipes belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-16T23:55:05Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-11a165fe77f7a2` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| circuitvalley/USB_C_Industrial_Camera_FPGA_USB3 | Documentation | [open](photography-circuitvalley-usb-c-industrial-camera-fpga-usb3-d09d15ca.md) |
