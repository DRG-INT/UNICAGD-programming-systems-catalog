...
<!-- canonical: https://github.com/OSGeo/gdal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OSGeo/gdal](https://github.com/OSGeo/gdal) |
| Source record ids | github_search_radars-730906032cc592 |

## System Engineer Summary

GDAL is an open source MIT licensed translator library for raster and vector geospatial data
formats.

## Operational Role

For a systems engineer, OSGeo/gdal belongs in the Radars inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:04:22Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-730906032cc592` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AndrewPlayer3/sentinel1_decode | Formatter | [open](radars-andrewplayer3-sentinel1-decode-3aff839a.md) |
