...
<!-- canonical: https://github.com/gnuradio/gnuradio4 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gnuradio/gnuradio4](https://github.com/gnuradio/gnuradio4) |
| Source record ids | github_search_satcom_satellites-a2ff6e9849e786 |

## System Engineer Summary

GNU Radio 4 (GR4) — modern C++ software-defined radio (SDR) and digital signal processing (DSP)
framework with a high-performance flowgraph runtime

## Operational Role

For a systems engineer, gnuradio/gnuradio4 belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:52:29Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-a2ff6e9849e786` from `github_search_satcom_satellites` as `registry_expansion`
