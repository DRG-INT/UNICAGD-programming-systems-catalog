...
| Canonical URL | [https://luarocks.org/modules/mah0x211/exit](https://luarocks.org/modules/mah0x211/exit) |
| Source record ids | luarocks_root_manifest-efc4b044df7726 |
...
For a systems engineer, exit belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-efc4b044df7726` from `luarocks_root_manifest` as `registry_expansion`
