...
<!-- canonical: https://github.com/streamproc/MediaStreamRecorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/streamproc/MediaStreamRecorder](https://github.com/streamproc/MediaStreamRecorder) |
| Source record ids | github_search_video-bc5db014cfb3bd |

## System Engineer Summary

Cross browser audio/video/screen recording. It supports Chrome, Firefox, Opera and Microsoft Edge.
It even works on Android browsers. It follows latest MediaRecorder API standards and provides
similar APIs.

## Operational Role

For a systems engineer, streamproc/MediaStreamRecorder belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-04T13:42:21Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-bc5db014cfb3bd` from `github_search_video` as `registry_expansion`
