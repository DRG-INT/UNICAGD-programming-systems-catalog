...
<!-- canonical: https://github.com/Huancx/SAPBTP-CAP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Huancx/SAPBTP-CAP](https://github.com/Huancx/SAPBTP-CAP) |
| Source record ids | github_search_sapjava-162d5abd9aacd2 |

## System Engineer Summary

Huancx/SAPBTP-CAP is tracked as a library record in the SAPJava branch. The source did not provide a
...
For a systems engineer, Huancx/SAPBTP-CAP belongs in the SAPJava inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-06T09:12:48Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-162d5abd9aacd2` from `github_search_sapjava` as `registry_expansion`
