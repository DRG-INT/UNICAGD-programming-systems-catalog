...
<!-- canonical: https://cran.r-project.org/web/packages/toolmaRk/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/toolmaRk/index.html](https://cran.r-project.org/web/packages/toolmaRk/index.html) |
| Source record ids | cran_packages_by_date-cc44db4d010358 |
...
For a systems engineer, toolmaRk belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-09-14 21:00:02 UTC | [https://cran.r-project.org/web/packages/toolmaRk/DESCRIPTION](https://cran.r-project.org/web/packages/toolmaRk/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/toolmaRk/DESCRIPTION` at `2026-09-14T22:20:19+00:00`.
...
- `cran_packages_by_date-cc44db4d010358` from `cran_packages_by_date` as `registry_expansion`
