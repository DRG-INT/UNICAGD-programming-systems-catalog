...
| Source record ids | github_search_game_engines-572a152074112e |
...
For a systems engineer, mosra/magnum belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T10:24:48Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Other |
...
- `github_search_game_engines-572a152074112e` from `github_search_game_engines` as `registry_expansion`
