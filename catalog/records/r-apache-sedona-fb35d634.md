...
<!-- canonical: https://cran.r-project.org/web/packages/apache.sedona/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/apache.sedona/index.html](https://cran.r-project.org/web/packages/apache.sedona/index.html) |
| Source record ids | cran_packages_by_date-ed445b56f66c5b |
...
For a systems engineer, apache.sedona belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.1 | 2026-08-05 08:00:02 UTC | [https://cran.r-project.org/web/packages/apache.sedona/DESCRIPTION](https://cran.r-project.org/web/packages/apache.sedona/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/apache.sedona/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ed445b56f66c5b` from `cran_packages_by_date` as `registry_expansion`
