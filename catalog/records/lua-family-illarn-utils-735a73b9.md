...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Jit Vm](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/jit-vm.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/illarn/illarn-utils](https://luarocks.org/modules/illarn/illarn-utils) |
| Source record ids | luarocks_root_manifest-7686baadb4cea2 |
...
For a systems engineer, illarn-utils belongs in the Lua family inventory as part of ecosystem
...
- Treat category as `jit_vm` unless a later verified source gives a better classification.
...
| Name | Category | Page |
| --- | --- | --- |
| __gc | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-gc-f8e16a71.md) |
| api7-lua-resty-jwt | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-api7-lua-resty-jwt-5e67b3d7.md) |
| argon2-ffi | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-argon2-ffi-681d8e58.md) |
| aspect | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-aspect-aa2f34be.md) |
| bcrypt-ffi | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bcrypt-ffi-db081c63.md) |
| bitser | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-bitser-31d0e69f.md) |
| brightness | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-brightness-c111227f.md) |
| brotli-ffi | Jit Vm | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-brotli-ffi-acd8dfcd.md) |
