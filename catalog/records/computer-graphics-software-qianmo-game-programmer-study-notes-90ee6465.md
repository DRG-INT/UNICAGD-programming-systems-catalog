...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/QianMo/Game-Programmer-Study-Notes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/QianMo/Game-Programmer-Study-Notes](https://github.com/QianMo/Game-Programmer-Study-Notes) |
| Source record ids | github_search_computer_graphics_software-18a0a3f5b88568 |

## System Engineer Summary

:anchor: 我的游戏程序员生涯的读书笔记合辑。你可以把它看作一个加强版的Blog。涉及图形学、实时渲染、编程实践、GPU编程、设计模式、软件工程等内容。Keep Reading , Keep
Writing , Keep Coding.

## Operational Role

For a systems engineer, QianMo/Game-Programmer-Study-Notes belongs in the Computer Graphics Software
...
- `github_search_computer_graphics_software-18a0a3f5b88568` from `github_search_computer_graphics_software` as `registry_expansion`
