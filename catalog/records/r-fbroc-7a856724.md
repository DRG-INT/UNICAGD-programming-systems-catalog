...
<!-- canonical: https://cran.r-project.org/web/packages/fbroc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fbroc/index.html](https://cran.r-project.org/web/packages/fbroc/index.html) |
| Source record ids | cran_packages_by_date-edd36e9d8c30de |
...
For a systems engineer, fbroc belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-06 11:40:02 UTC | [https://cran.r-project.org/web/packages/fbroc/DESCRIPTION](https://cran.r-project.org/web/packages/fbroc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fbroc/DESCRIPTION` at `2026-09-06T12:23:08+00:00`.
...
- `cran_packages_by_date-edd36e9d8c30de` from `cran_packages_by_date` as `registry_expansion`
