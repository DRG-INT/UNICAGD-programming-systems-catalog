...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/unitaryfoundation/qrack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unitaryfoundation/qrack](https://github.com/unitaryfoundation/qrack) |
| Source record ids | github_search_physics_engines-7e716f2f7f1f48 |
...
For a systems engineer, unitaryfoundation/qrack belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T19:57:01Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7e716f2f7f1f48` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Healthcare-Robotics/assistive-gym | Framework | [open](physics-engines-healthcare-robotics-assistive-gym-81e16cab.md) |
