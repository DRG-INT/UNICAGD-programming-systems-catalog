...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rauversion/rauversion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rauversion/rauversion](https://github.com/rauversion/rauversion) |
| Source record ids | github_search_magazines-26019412a1c645 |
...
For a systems engineer, rauversion/rauversion belongs in the Magazines inventory as part of
...
- `github_search_magazines-26019412a1c645` from `github_search_magazines` as `registry_expansion`
