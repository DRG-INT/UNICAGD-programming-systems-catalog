...
<!-- canonical: https://github.com/jeremytrane/STS-30_Simulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jeremytrane/STS-30_Simulation](https://github.com/jeremytrane/STS-30_Simulation) |
| Source record ids | github_search_space_shuttles-b94902fbb10e37 |

## System Engineer Summary

​The STS-30_Simulation offers a collection of MATLAB scripts designed to simulate aspects of the
Space Shuttle Atlantis's STS-30 mission. This mission, notable for deploying the Magellan spacecraft
to Venus, is modeled here to analyze various flight dynamics and vehicle parameters.

## Operational Role

For a systems engineer, jeremytrane/STS-30_Simulation belongs in the Space Shuttles inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-30T19:25:10Z | gh search repos space shuttle simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-b94902fbb10e37` from `github_search_space_shuttles` as `registry_expansion`
