...
| Canonical URL | [https://crates.io/crates/fax_derive](https://crates.io/crates/fax_derive) |
| Source record ids | crates_io-ad62edea3edc6c |
...
For a systems engineer, fax_derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2025-08-31T17:59:23.654840Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-ad62edea3edc6c` from `crates_io` as `registry_expansion`
