...
<!-- canonical: https://pub.dev/packages/syncfusion_flutter_core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/syncfusion_flutter_core](https://pub.dev/packages/syncfusion_flutter_core) |
| Source record ids | pub_dev-d0a7c06da993bd |
...
For a systems engineer, syncfusion_flutter_core belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 34.2.6 | 2026-09-01T15:24:46.385832Z | [https://pub.dev/api/packages/syncfusion_flutter_core](https://pub.dev/api/packages/syncfusion_flutter_core) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/syncfusion_flutter_core` at `2026-09-02T00:28:57+00:00`.
...
- `pub_dev-d0a7c06da993bd` from `pub_dev` as `registry_expansion`
