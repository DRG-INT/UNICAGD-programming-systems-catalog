...
| Canonical URL | [https://crates.io/crates/tokio-metrics](https://crates.io/crates/tokio-metrics) |
| Source record ids | crates_io-3eea2abe99dfe3 |
...
For a systems engineer, tokio-metrics belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2 | 2026-08-28T18:36:37.477600Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-3eea2abe99dfe3` from `crates_io` as `registry_expansion`
