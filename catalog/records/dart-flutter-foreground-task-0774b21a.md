...
<!-- canonical: https://pub.dev/packages/flutter_foreground_task -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_foreground_task](https://pub.dev/packages/flutter_foreground_task) |
| Source record ids | pub_dev-48cafd03c829bb |
...
For a systems engineer, flutter_foreground_task belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.3 | 2026-09-07T00:30:23.171199Z | [https://pub.dev/api/packages/flutter_foreground_task](https://pub.dev/api/packages/flutter_foreground_task) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_foreground_task` at `2026-09-07T00:31:50+00:00`.
...
- `pub_dev-48cafd03c829bb` from `pub_dev` as `registry_expansion`
