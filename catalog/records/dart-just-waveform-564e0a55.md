...
<!-- canonical: https://pub.dev/packages/just_waveform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/just_waveform](https://pub.dev/packages/just_waveform) |
| Source record ids | pub_dev-d900171e402a9b |
...
For a systems engineer, just_waveform belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.7 | 2025-03-30T13:09:38.884961Z | [https://pub.dev/api/packages/just_waveform](https://pub.dev/api/packages/just_waveform) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/just_waveform` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-d900171e402a9b` from `pub_dev` as `registry_expansion`
