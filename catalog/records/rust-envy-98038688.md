...
| Canonical URL | [https://crates.io/crates/envy](https://crates.io/crates/envy) |
| Source record ids | crates_io-d99308a1645325 |
...
For a systems engineer, envy belongs in the Rust inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2021-01-04T00:17:01.205407Z | [https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=22&per_page=100&sort=downloads) |  |
...
- `crates_io-d99308a1645325` from `crates_io` as `registry_expansion`
