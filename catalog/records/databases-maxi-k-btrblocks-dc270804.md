...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/maxi-k/btrblocks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maxi-k/btrblocks](https://github.com/maxi-k/btrblocks) |
| Source record ids | github_search_databases-1fd6b96b9fa78e |
...
For a systems engineer, maxi-k/btrblocks belongs in the Databases inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-07T10:12:31Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1fd6b96b9fa78e` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| duckdb/duckdb-rs | Ffi Bindings | [open](databases-duckdb-duckdb-rs-3bc8e1ae.md) |
| electric-sql/pglite | Ffi Bindings | [open](databases-electric-sql-pglite-aaa8e71d.md) |
| geldata/gel-python | Ffi Bindings | [open](databases-geldata-gel-python-70c815ca.md) |
| Koka/odbc-rs | Ffi Bindings | [open](databases-koka-odbc-rs-22556c1f.md) |
| mongodb/mongo-csharp-driver | Ffi Bindings | [open](databases-mongodb-mongo-csharp-driver-9f56565d.md) |
| mongodb/node-mongodb-native | Ffi Bindings | [open](databases-mongodb-node-mongodb-native-de777c0a.md) |
| oracle/docker-images | Ffi Bindings | [open](databases-oracle-docker-images-69ec5f43.md) |
| parthsarthi03/raptor | Ffi Bindings | [open](databases-parthsarthi03-raptor-aabfb858.md) |
