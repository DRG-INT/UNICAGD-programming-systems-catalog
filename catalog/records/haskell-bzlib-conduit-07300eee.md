...
<!-- canonical: https://hackage.haskell.org/package/bzlib-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bzlib-conduit](https://hackage.haskell.org/package/bzlib-conduit) |
| Source record ids | hackage_top_downloads-90855a0fa4762a |
...
For a systems engineer, bzlib-conduit belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.4 | 2024-12-13T06:09:55Z | [https://hackage.haskell.org/package/bzlib-conduit](https://hackage.haskell.org/package/bzlib-conduit) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/bzlib-conduit` at `2026-09-02T00:32:24+00:00`.
...
- `hackage_top_downloads-90855a0fa4762a` from `hackage_top_downloads` as `registry_expansion`
