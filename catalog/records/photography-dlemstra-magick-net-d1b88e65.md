...
<!-- canonical: https://github.com/dlemstra/Magick.NET -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dlemstra/Magick.NET](https://github.com/dlemstra/Magick.NET) |
| Source record ids | github_search_photography-1d578864111114 |
...
For a systems engineer, dlemstra/Magick.NET belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:04:56Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-1d578864111114` from `github_search_photography` as `registry_expansion`
