...
<!-- canonical: https://github.com/NerdLang/nerd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NerdLang/nerd](https://github.com/NerdLang/nerd) |
| Source record ids | github_search_webassembly-0b75076f30b0fb |
...
For a systems engineer, NerdLang/nerd belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-25T06:57:26Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-0b75076f30b0fb` from `github_search_webassembly` as `registry_expansion`
