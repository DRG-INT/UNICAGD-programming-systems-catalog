...
<!-- canonical: https://github.com/libretime/libretime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libretime/libretime](https://github.com/libretime/libretime) |
| Source record ids | github_search_electromagnetoscopes-240696965df3cd |
...
For a systems engineer, libretime/libretime belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.0 | 2025-07-16T18:36:38Z | [https://api.github.com/repos/libretime/libretime/releases/latest](https://api.github.com/repos/libretime/libretime/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/libretime/libretime/releases/latest` at `2026-09-01T08:26:41+00:00`.
...
- `github_search_electromagnetoscopes-240696965df3cd` from `github_search_electromagnetoscopes` as `registry_expansion`
