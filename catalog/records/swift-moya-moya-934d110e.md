...
| Source record ids | github_search_swift-31c70ca34c82bd |
...
For a systems engineer, Moya/Moya belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-14T22:07:40Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-31c70ca34c82bd` from `github_search_swift` as `registry_expansion`
