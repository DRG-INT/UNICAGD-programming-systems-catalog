...
<!-- canonical: https://cran.r-project.org/web/packages/iC10/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/iC10/index.html](https://cran.r-project.org/web/packages/iC10/index.html) |
| Source record ids | cran_packages_by_date-6ec13a39a66aa4 |
...
For a systems engineer, iC10 belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-08-04 17:30:02 UTC | [https://cran.r-project.org/web/packages/iC10/DESCRIPTION](https://cran.r-project.org/web/packages/iC10/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/iC10/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6ec13a39a66aa4` from `cran_packages_by_date` as `registry_expansion`
