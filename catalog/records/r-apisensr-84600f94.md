...
<!-- canonical: https://cran.r-project.org/web/packages/apisensr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/apisensr/index.html](https://cran.r-project.org/web/packages/apisensr/index.html) |
| Source record ids | cran_packages_by_date-5c31f32178e363 |
...
For a systems engineer, apisensr belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.1 | 2026-08-28 15:40:24 UTC | [https://cran.r-project.org/web/packages/apisensr/DESCRIPTION](https://cran.r-project.org/web/packages/apisensr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/apisensr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5c31f32178e363` from `cran_packages_by_date` as `registry_expansion`
