...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BoxesWorld](https://github.com/JuliaRegistries/General/tree/master/B/BoxesWorld) |
| Source record ids | julia_general-88e2774ed077d2 |

## System Engineer Summary

Julia package registered in General at B/BoxesWorld.

## Operational Role

For a systems engineer, BoxesWorld belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BoxesWorld", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-88e2774ed077d2` from `julia_general` as `registry_expansion`
