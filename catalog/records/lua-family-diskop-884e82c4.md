...
<!-- canonical: https://luarocks.org/modules/aryajur/diskop -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aryajur/diskop](https://luarocks.org/modules/aryajur/diskop) |
| Source record ids | luarocks_root_manifest-2bf33c22dfc0ea |
...
For a systems engineer, diskOP belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2bf33c22dfc0ea` from `luarocks_root_manifest` as `registry_expansion`
