...
<!-- canonical: https://github.com/mqcomplab/NAMI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mqcomplab/NAMI](https://github.com/mqcomplab/NAMI) |
| Source record ids | github_search_space_maps-280244364564a5 |
...
For a systems engineer, mqcomplab/NAMI belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T16:31:15Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-280244364564a5` from `github_search_space_maps` as `registry_expansion`
