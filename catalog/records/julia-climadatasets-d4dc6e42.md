...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CliMADatasets](https://github.com/JuliaRegistries/General/tree/master/C/CliMADatasets) |
| Source record ids | julia_general-c84899a379bbd4 |

## System Engineer Summary

Julia package registered in General at C/CliMADatasets.

## Operational Role

For a systems engineer, CliMADatasets belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CliMADatasets", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-c84899a379bbd4` from `julia_general` as `registry_expansion`
