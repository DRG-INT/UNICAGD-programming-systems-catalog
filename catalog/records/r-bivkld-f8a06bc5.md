...
<!-- canonical: https://cran.r-project.org/web/packages/BivKLD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BivKLD/index.html](https://cran.r-project.org/web/packages/BivKLD/index.html) |
| Source record ids | cran_packages_by_date-0af300864897ee |

## System Engineer Summary

Bivariate Kullback-Leibler Divergence

## Operational Role

For a systems engineer, BivKLD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-02 21:30:09 UTC | [https://cran.r-project.org/web/packages/BivKLD/DESCRIPTION](https://cran.r-project.org/web/packages/BivKLD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BivKLD/DESCRIPTION` at `2026-09-02T22:19:13+00:00`.
...
- `cran_packages_by_date-0af300864897ee` from `cran_packages_by_date` as `registry_expansion`
