...
| Canonical URL | [https://packagist.org/packages/franzose/closure-table](https://packagist.org/packages/franzose/closure-table) |
| Source record ids | packagist_search-685ad47bdb6815 |
...
For a systems engineer, franzose/closure-table belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.2.2 | 2026-02-01T10:39:41+00:00 | [https://repo.packagist.org/p2/franzose/closure-table.json](https://repo.packagist.org/p2/franzose/closure-table.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/franzose/closure-table.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-685ad47bdb6815` from `packagist_search` as `registry_expansion`
