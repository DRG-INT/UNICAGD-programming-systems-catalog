...
<!-- canonical: https://hackage.haskell.org/package/dns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/dns](https://hackage.haskell.org/package/dns) |
| Source record ids | hackage_top_downloads-935806462eda0f |
...
For a systems engineer, dns belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2023-06-30T02:18:10Z | [https://hackage.haskell.org/package/dns](https://hackage.haskell.org/package/dns) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/dns` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-935806462eda0f` from `hackage_top_downloads` as `registry_expansion`
