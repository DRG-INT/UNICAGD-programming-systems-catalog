...
<!-- canonical: https://pub.dev/packages/provider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/provider](https://pub.dev/packages/provider) |
| Source record ids | pub_dev-499d2f41f97ddb |
...
For a systems engineer, provider belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.5+1 | 2025-08-19T12:50:56.438080Z | [https://pub.dev/api/packages/provider](https://pub.dev/api/packages/provider) |  |
| preview | known | 6.1.0-dev.1 | 2023-09-24T21:36:31.958600Z | [https://pub.dev/api/packages/provider](https://pub.dev/api/packages/provider) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/provider` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-499d2f41f97ddb` from `pub_dev` as `registry_expansion`
