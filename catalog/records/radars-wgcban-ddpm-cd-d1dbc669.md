...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/wgcban/ddpm-cd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wgcban/ddpm-cd](https://github.com/wgcban/ddpm-cd) |
| Source record ids | github_search_radars-ae3839703f8b06 |
...
For a systems engineer, wgcban/ddpm-cd belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-08T18:49:35Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-ae3839703f8b06` from `github_search_radars` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| earthaccess-dev/earthaccess | Api Abi Checker | [open](radars-earthaccess-dev-earthaccess-b40ecdd1.md) |
| ktuukkan/marine-api | Api Abi Checker | [open](radars-ktuukkan-marine-api-c4837662.md) |
| MapIV/eagleye | Api Abi Checker | [open](radars-mapiv-eagleye-c0a50797.md) |
