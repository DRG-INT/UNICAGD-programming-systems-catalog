...
<!-- canonical: https://pub.dev/packages/swipable_stack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/swipable_stack](https://pub.dev/packages/swipable_stack) |
| Source record ids | pub_dev-05c61266010e4f |

## System Engineer Summary

A widget for stacking cards, which users can swipe horizontally and vertically with beautiful
animations like Tinder.

## Operational Role

For a systems engineer, swipable_stack belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2022-05-30T12:17:18.472207Z | [https://pub.dev/api/packages/swipable_stack](https://pub.dev/api/packages/swipable_stack) |  |
| preview | known | 0.1.2-nullsafety.2 | 2021-02-25T16:31:52.944152Z | [https://pub.dev/api/packages/swipable_stack](https://pub.dev/api/packages/swipable_stack) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/swipable_stack` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-05c61266010e4f` from `pub_dev` as `registry_expansion`
