...
<!-- canonical: https://github.com/OpenVidu/openvidu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenVidu/openvidu](https://github.com/OpenVidu/openvidu) |
| Source record ids | github_search_video-676cd6fe1f05e0 |

## System Engineer Summary

OpenVidu Platform: self-hosted real-time video and audio for your apps, built on LiveKit and
mediasoup

## Operational Role

For a systems engineer, OpenVidu/openvidu belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T10:34:51Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-676cd6fe1f05e0` from `github_search_video` as `registry_expansion`
