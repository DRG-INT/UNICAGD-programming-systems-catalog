...
| Canonical URL | [https://github.com/Tyrrrz/YoutubeDownloader](https://github.com/Tyrrrz/YoutubeDownloader) |
| Source record ids | github_search_video-d8e9a9ca1a39bb |
...
For a systems engineer, Tyrrrz/YoutubeDownloader belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.16.6 | 2026-08-26T11:48:53Z | [https://api.github.com/repos/Tyrrrz/YoutubeDownloader/releases/latest](https://api.github.com/repos/Tyrrrz/YoutubeDownloader/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Tyrrrz/YoutubeDownloader/releases/latest` at `2026-09-01T09:23:27+00:00`.
...
- `github_search_video-d8e9a9ca1a39bb` from `github_search_video` as `registry_expansion`
