...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChunkCodecLibBlosc](https://github.com/JuliaRegistries/General/tree/master/C/ChunkCodecLibBlosc) |
| Source record ids | julia_general-be62f7e4ccb405 |

## System Engineer Summary

Julia package registered in General at C/ChunkCodecLibBlosc.

## Operational Role

For a systems engineer, ChunkCodecLibBlosc belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChunkCodecLibBlosc", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-be62f7e4ccb405` from `julia_general` as `registry_expansion`
