...
<!-- canonical: https://cran.r-project.org/web/packages/HIMA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/HIMA/index.html](https://cran.r-project.org/web/packages/HIMA/index.html) |
| Source record ids | cran_packages_by_date-c9f0ef121cc8b4 |
...
For a systems engineer, HIMA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.4 | 2026-08-30 15:20:15 UTC | [https://cran.r-project.org/web/packages/HIMA/DESCRIPTION](https://cran.r-project.org/web/packages/HIMA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/HIMA/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c9f0ef121cc8b4` from `cran_packages_by_date` as `registry_expansion`
