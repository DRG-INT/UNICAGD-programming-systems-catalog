...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/json_path -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/json_path](https://pub.dev/packages/json_path) |
| Source record ids | pub_dev-77b54237ed7ad2 |

## System Engineer Summary

Implementation of RFC 9535 - JSONPath: Query Expressions for JSON. Reads and writes values in parsed
JSON objects using queries like `$.store.book2.price`.

## Operational Role

For a systems engineer, json_path belongs in the Dart inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2025-12-11T03:40:14.304298Z | [https://pub.dev/api/packages/json_path](https://pub.dev/api/packages/json_path) |  |
| preview | known | 0.5.0-dev.3 | 2023-03-12T17:22:10.953676Z | [https://pub.dev/api/packages/json_path](https://pub.dev/api/packages/json_path) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/json_path` at `2026-09-01T15:35:57+00:00`.
...
- `pub_dev-77b54237ed7ad2` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| checked_yaml | Serialization | [open](dart-checked-yaml-6e42ad6b.md) |
| dart_jsonwebtoken | Serialization | [open](dart-dart-jsonwebtoken-62b58fdc.md) |
| dart_mappable | Serialization | [open](dart-dart-mappable-7baa0923.md) |
| flutter_json_view | Serialization | [open](dart-flutter-json-view-7a7c7542.md) |
| graphql_codegen | Serialization | [open](dart-graphql-codegen-5f770adb.md) |
| json_annotation | Serialization | [open](dart-json-annotation-596efc12.md) |
| json_serializable | Serialization | [open](dart-json-serializable-376b4f22.md) |
| jwt_decoder | Serialization | [open](dart-jwt-decoder-c7f7df96.md) |
