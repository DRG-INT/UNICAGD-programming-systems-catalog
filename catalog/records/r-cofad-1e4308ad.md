...
<!-- canonical: https://cran.r-project.org/web/packages/cofad/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cofad/index.html](https://cran.r-project.org/web/packages/cofad/index.html) |
| Source record ids | cran_packages_by_date-24ade7f074ac52 |
...
For a systems engineer, cofad belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-21 05:44:31 UTC | [https://cran.r-project.org/web/packages/cofad/DESCRIPTION](https://cran.r-project.org/web/packages/cofad/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cofad/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-24ade7f074ac52` from `cran_packages_by_date` as `registry_expansion`
