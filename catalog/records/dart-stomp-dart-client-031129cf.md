...
<!-- canonical: https://pub.dev/packages/stomp_dart_client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/stomp_dart_client](https://pub.dev/packages/stomp_dart_client) |
| Source record ids | pub_dev-6fd264ca3da662 |

## System Engineer Summary

Dart STOMP client for easy messaging interoperability. Build with flutter in mind, but should work
for every dart application.

## Operational Role

For a systems engineer, stomp_dart_client belongs in the Dart inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2025-10-30T12:27:48.442160Z | [https://pub.dev/api/packages/stomp_dart_client](https://pub.dev/api/packages/stomp_dart_client) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/stomp_dart_client` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-6fd264ca3da662` from `pub_dev` as `registry_expansion`
