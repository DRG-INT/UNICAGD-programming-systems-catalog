...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CIFTI](https://github.com/JuliaRegistries/General/tree/master/C/CIFTI) |
| Source record ids | julia_general-cc1d9104630011 |

## System Engineer Summary

Julia package registered in General at C/CIFTI.

## Operational Role

For a systems engineer, CIFTI belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CIFTI", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-cc1d9104630011` from `julia_general` as `registry_expansion`
