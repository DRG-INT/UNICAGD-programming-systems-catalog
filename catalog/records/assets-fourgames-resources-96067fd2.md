...
<!-- canonical: https://github.com/fourgames/resources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fourgames/resources](https://github.com/fourgames/resources) |
| Source record ids | github_search_assets-532851bf61b695 |

## System Engineer Summary

The Game Success Formula & curated resources for game development. Tools and strategies for making
better games, with a focus on Godot.

## Operational Role

For a systems engineer, fourgames/resources belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T20:45:54Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-532851bf61b695` from `github_search_assets` as `registry_expansion`
...
| sparklinlabs/superpowers-asset-packs | Game Engine Game Dev | [open](assets-sparklinlabs-superpowers-asset-packs-d172a84e.md) |
