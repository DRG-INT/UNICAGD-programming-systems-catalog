...
| Canonical URL | [https://github.com/bazelbuild/bazel](https://github.com/bazelbuild/bazel) |
| Source record ids | curated_language_routes-4a236924deda7d |

## System Engineer Summary

Build and test system that uses Starlark rules and macros for repository-scale build definitions.

## Operational Role

For a systems engineer, Bazel belongs in the Starlark inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.2.0 | 2026-07-13T20:39:01Z | [https://api.github.com/repos/bazelbuild/bazel/releases/latest](https://api.github.com/repos/bazelbuild/bazel/releases/latest) |  |
| preview | known | 8.8.0rc4 | 2026-08-27T22:41:09Z | [https://api.github.com/repos/bazelbuild/bazel/releases?per_page=10](https://api.github.com/repos/bazelbuild/bazel/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bazelbuild/bazel/releases/latest` at `2026-09-01T12:30:31+00:00`.
...
- `curated_language_routes-4a236924deda7d` from `curated_language_routes` as `registry_expansion`
...
| bazelbuild/bazel-skylib | Build System | [open](starlark-bazelbuild-bazel-skylib-6abae8f4.md) |
| dropbox/dbx_build_tools | Build System | [open](starlark-dropbox-dbx-build-tools-f48dff7c.md) |
| facebookincubator/reindeer | Build System | [open](starlark-facebookincubator-reindeer-e957d783.md) |
| maxmcd/bramble | Build System | [open](starlark-maxmcd-bramble-bcb99fb7.md) |
| tidbyt/pixlet | Build System | [open](starlark-tidbyt-pixlet-876fea90.md) |
| u-root/gobusybox | Build System | [open](starlark-u-root-gobusybox-136cf407.md) |
