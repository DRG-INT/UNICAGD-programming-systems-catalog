...
<!-- canonical: https://pub.dev/packages/linkify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/linkify](https://pub.dev/packages/linkify) |
| Source record ids | pub_dev-997f61a03701db |
...
For a systems engineer, linkify belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.0 | 2023-05-15T22:56:52.158001Z | [https://pub.dev/api/packages/linkify](https://pub.dev/api/packages/linkify) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/linkify` at `2026-09-05T04:19:17+00:00`.
...
- `pub_dev-997f61a03701db` from `pub_dev` as `registry_expansion`
