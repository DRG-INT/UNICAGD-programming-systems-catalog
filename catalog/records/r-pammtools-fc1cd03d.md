...
<!-- canonical: https://cran.r-project.org/web/packages/pammtools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pammtools/index.html](https://cran.r-project.org/web/packages/pammtools/index.html) |
| Source record ids | cran_packages_by_date-569a010d4a4d0f |
...
For a systems engineer, pammtools belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1 | 2026-08-25 11:20:09 UTC | [https://cran.r-project.org/web/packages/pammtools/DESCRIPTION](https://cran.r-project.org/web/packages/pammtools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pammtools/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-569a010d4a4d0f` from `cran_packages_by_date` as `registry_expansion`
