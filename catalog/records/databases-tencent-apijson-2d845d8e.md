...
<!-- canonical: https://github.com/Tencent/APIJSON -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tencent/APIJSON](https://github.com/Tencent/APIJSON) |
| Source record ids | github_search_databases-ab50f486013560 |

## System Engineer Summary

🏆 Real-Time no-code, powerful and secure ORM 🚀 providing APIs and Docs without coding by Backend,
and Frontend(Client) can customize response JSONs 🏆 实时 零代码、全功能、强安全 ORM 库 🚀 后端接口和文档零代码，前端(客户端) 定制返回
JSON 的数据和结构

## Operational Role

For a systems engineer, Tencent/APIJSON belongs in the Databases inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T16:28:45Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ab50f486013560` from `github_search_databases` as `registry_expansion`
