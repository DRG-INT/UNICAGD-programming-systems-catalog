# danlivings/oil-painting-effect-shader-unity
...
<!-- canonical: https://github.com/danlivings/oil-painting-effect-shader-unity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danlivings/oil-painting-effect-shader-unity](https://github.com/danlivings/oil-painting-effect-shader-unity) |
| Source record ids | github_search_effects-692c51158e19fa |

## System Engineer Summary

A demo Unity project to accompany my tutorial on implementing a post-processing effect that mimics
an oil painting:

## Operational Role

For a systems engineer, danlivings/oil-painting-effect-shader-unity belongs in the Effects inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-23T17:30:56Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-692c51158e19fa` from `github_search_effects` as `registry_expansion`
