...
<!-- canonical: https://hackage.haskell.org/package/ihaskell-hvega -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/ihaskell-hvega](https://hackage.haskell.org/package/ihaskell-hvega) |
| Source record ids | hackage_top_downloads-e94b88096271ee |
...
For a systems engineer, ihaskell-hvega belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0.7 | 2026-01-09T00:12:25Z | [https://hackage.haskell.org/package/ihaskell-hvega](https://hackage.haskell.org/package/ihaskell-hvega) |  |
| candidate | partial | 0.2.0.0 |  | [https://hackage.haskell.org/package/ihaskell-hvega](https://hackage.haskell.org/package/ihaskell-hvega) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/ihaskell-hvega` at `2026-09-02T00:32:43+00:00`.
...
- `hackage_top_downloads-e94b88096271ee` from `hackage_top_downloads` as `registry_expansion`
