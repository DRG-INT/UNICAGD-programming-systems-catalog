...
<!-- canonical: https://github.com/IO-Aerospace-software-engineering/Astrodynamics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IO-Aerospace-software-engineering/Astrodynamics](https://github.com/IO-Aerospace-software-engineering/Astrodynamics) |
| Source record ids | github_search_space_maps-5ebb2ae6947cbb |

## System Engineer Summary

IO-Aerospace-software-engineering/Astrodynamics is tracked as a parser lexer ast record in the Space
Maps branch. The source did not provide a long description, so this page keeps the identity, release
state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, IO-Aerospace-software-engineering/Astrodynamics belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T19:10:48Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5ebb2ae6947cbb` from `github_search_space_maps` as `registry_expansion`
