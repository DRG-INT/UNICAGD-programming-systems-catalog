...
<!-- canonical: https://luarocks.org/modules/jorj/bigint -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/jorj/bigint](https://luarocks.org/modules/jorj/bigint) |
| Source record ids | luarocks_root_manifest-9459e6b686bc11 |
...
For a systems engineer, bigint belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-9459e6b686bc11` from `luarocks_root_manifest` as `registry_expansion`
