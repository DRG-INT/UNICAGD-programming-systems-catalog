...
<!-- canonical: https://hackage.haskell.org/package/beam-sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/beam-sqlite](https://hackage.haskell.org/package/beam-sqlite) |
| Source record ids | hackage_top_downloads-56792c8b4a569e |
...
For a systems engineer, beam-sqlite belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0.0 | 2026-04-28T14:37:17Z | [https://hackage.haskell.org/package/beam-sqlite](https://hackage.haskell.org/package/beam-sqlite) |  |
| candidate | partial | 0.2.0.0 |  | [https://hackage.haskell.org/package/beam-sqlite](https://hackage.haskell.org/package/beam-sqlite) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/beam-sqlite` at `2026-09-01T14:24:07+00:00`.
...
- `hackage_top_downloads-56792c8b4a569e` from `hackage_top_downloads` as `registry_expansion`
