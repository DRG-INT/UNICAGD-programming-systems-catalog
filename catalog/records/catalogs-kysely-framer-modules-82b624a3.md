...
<!-- canonical: https://github.com/kysely/framer-modules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kysely/framer-modules](https://github.com/kysely/framer-modules) |
| Source record ids | github_search_catalogs-7782b9fd022271 |
...
For a systems engineer, kysely/framer-modules belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-04T20:16:09Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-7782b9fd022271` from `github_search_catalogs` as `registry_expansion`
