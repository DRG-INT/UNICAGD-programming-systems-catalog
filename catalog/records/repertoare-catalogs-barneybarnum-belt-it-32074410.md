...
<!-- canonical: https://github.com/BarneyBarnum/belt-it -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BarneyBarnum/belt-it](https://github.com/BarneyBarnum/belt-it) |
| Source record ids | github_search_repertoare_catalogs-1d48d8db30497a |

## System Engineer Summary

Karaoke night app: song catalog, singer queue that takes turns, setlists, and a YouTube-powered
stage.

## Operational Role

For a systems engineer, BarneyBarnum/belt-it belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T04:11:53Z | gh search repos setlist catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-1d48d8db30497a` from `github_search_repertoare_catalogs` as `registry_expansion`
