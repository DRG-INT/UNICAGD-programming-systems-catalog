...
<!-- canonical: https://cran.r-project.org/web/packages/bookdown/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bookdown/index.html](https://cran.r-project.org/web/packages/bookdown/index.html) |
| Source record ids | cran_packages_by_date-dcf6bb28358689 |
...
For a systems engineer, bookdown belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.48 | 2026-08-28 13:30:09 UTC | [https://cran.r-project.org/web/packages/bookdown/DESCRIPTION](https://cran.r-project.org/web/packages/bookdown/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bookdown/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dcf6bb28358689` from `cran_packages_by_date` as `registry_expansion`
