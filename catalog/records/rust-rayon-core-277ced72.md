...
<!-- canonical: https://crates.io/crates/rayon-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rayon-core](https://crates.io/crates/rayon-core) |
| Source record ids | crates_io-f356e45259146f |

## System Engineer Summary

rayon-core is tracked as an api abi checker record in the Rust branch. The source did not provide a
...
For a systems engineer, rayon-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.13.0 | 2025-08-12T23:21:51.666309Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-f356e45259146f` from `crates_io` as `registry_expansion`
