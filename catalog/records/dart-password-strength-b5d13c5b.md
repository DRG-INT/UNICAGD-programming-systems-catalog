...
<!-- canonical: https://pub.dev/packages/password_strength -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/password_strength](https://pub.dev/packages/password_strength) |
| Source record ids | pub_dev-9c36c07ec0d801 |

## System Engineer Summary

A password strength estimator. Can be used to show the user whether the password they chose is
strong against bruteforce or dictionary attacks.

## Operational Role

For a systems engineer, password_strength belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2021-03-31T11:27:37.048525Z | [https://pub.dev/api/packages/password_strength](https://pub.dev/api/packages/password_strength) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/password_strength` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-9c36c07ec0d801` from `pub_dev` as `registry_expansion`
