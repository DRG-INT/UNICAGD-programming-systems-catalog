...
[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/piyushbag/awesome-pcb-workflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/piyushbag/awesome-pcb-workflow](https://github.com/piyushbag/awesome-pcb-workflow) |
| Source record ids | github_search_space_maps-38574ef75660ab |

## System Engineer Summary

Open-source tools for the complete PCB design workflow: AI-assisted EDA, schematic capture, SPICE
simulation, signal integrity, layout automation, DFM & fabrication CI/CD, hardware testing agents.
OrCAD & KiCad compatible.

## Operational Role

For a systems engineer, piyushbag/awesome-pcb-workflow belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T23:17:25Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-38574ef75660ab` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| drbitboy/SPICE_prediCkt_test | Testing Framework | [open](space-maps-drbitboy-spice-predickt-test-c1f5abc9.md) |
| drbitboy/SpiceyPyTestKernels | Testing Framework | [open](space-maps-drbitboy-spiceypytestkernels-f95f8dff.md) |
| matthewholman/assist | Testing Framework | [open](space-maps-matthewholman-assist-a129a17a.md) |
| tmarhguy/alu | Testing Framework | [open](space-maps-tmarhguy-alu-f4e33402.md) |
