...
<!-- canonical: https://github.com/danirod/nativeos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danirod/nativeos](https://github.com/danirod/nativeos) |
| Source record ids | github_search_assembly-8c418576712f17 |

## System Engineer Summary

Hobby operating system kernel currently targetting the i386 processor. Doesn't do anything useful
yet. This is a read-only mirror, pull requests will be ignored.

## Operational Role

For a systems engineer, danirod/nativeos belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-10-21T20:22:08Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-8c418576712f17` from `github_search_assembly` as `registry_expansion`
