...
<!-- canonical: https://cran.r-project.org/web/packages/Rdrw/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rdrw/index.html](https://cran.r-project.org/web/packages/Rdrw/index.html) |
| Source record ids | cran_packages_by_date-e34b36ff7fc243 |
...
For a systems engineer, Rdrw belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-08-20 10:32:10 UTC | [https://cran.r-project.org/web/packages/Rdrw/DESCRIPTION](https://cran.r-project.org/web/packages/Rdrw/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rdrw/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e34b36ff7fc243` from `cran_packages_by_date` as `registry_expansion`
