...
<!-- canonical: https://hackage.haskell.org/package/haskoin-store -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/haskoin-store](https://hackage.haskell.org/package/haskoin-store) |
| Source record ids | hackage_top_downloads-d3c719bd54154b |

## System Engineer Summary

Hackage package with 413 recent downloads in the Hackage top-downloads listing.

## Operational Role

For a systems engineer, haskoin-store belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.3 | 2026-08-31T11:39:07Z | [https://hackage.haskell.org/package/haskoin-store](https://hackage.haskell.org/package/haskoin-store) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/haskoin-store` at `2026-09-01T07:24:07+00:00`.
...
- `hackage_top_downloads-d3c719bd54154b` from `hackage_top_downloads` as `registry_expansion`
