...
| Canonical URL | [https://crates.io/crates/sea-bae](https://crates.io/crates/sea-bae) |
| Source record ids | crates_io-de78ba39366e26 |
...
For a systems engineer, sea-bae belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-07-18T16:20:04.636277Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-de78ba39366e26` from `crates_io` as `registry_expansion`
