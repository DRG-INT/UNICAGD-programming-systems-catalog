...
<!-- canonical: https://cran.r-project.org/web/packages/socketR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/socketR/index.html](https://cran.r-project.org/web/packages/socketR/index.html) |
| Source record ids | cran_packages_by_date-964755c34cad8c |
...
For a systems engineer, socketR belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-09-10 08:30:02 UTC | [https://cran.r-project.org/web/packages/socketR/DESCRIPTION](https://cran.r-project.org/web/packages/socketR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/socketR/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-964755c34cad8c` from `cran_packages_by_date` as `registry_expansion`
