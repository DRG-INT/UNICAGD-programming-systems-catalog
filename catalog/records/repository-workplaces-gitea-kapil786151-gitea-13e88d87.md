...
<!-- canonical: https://gitea.com/kapil786151/gitea -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/kapil786151/gitea](https://gitea.com/kapil786151/gitea) |
| Source record ids | gitea_repositories_api-8be7467c7795b8 |
...
For a systems engineer, Gitea: kapil786151/gitea belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-02T14:20:51Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-8be7467c7795b8` from `gitea_repositories_api` as `registry_expansion`
