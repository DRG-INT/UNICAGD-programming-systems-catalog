...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CFITSIO](https://github.com/JuliaRegistries/General/tree/master/C/CFITSIO) |
| Source record ids | julia_general-031a857f991149 |

## System Engineer Summary

Julia package registered in General at C/CFITSIO.

## Operational Role

For a systems engineer, CFITSIO belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CFITSIO", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-031a857f991149` from `julia_general` as `registry_expansion`
