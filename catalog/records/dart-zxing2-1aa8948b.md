...
<!-- canonical: https://pub.dev/packages/zxing2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/zxing2](https://pub.dev/packages/zxing2) |
| Source record ids | pub_dev-1cf1087d274c96 |

## System Engineer Summary

A multi-format 1D/2D barcode image processing library implemented in Dart. This is a port of the
Android library.

## Operational Role

For a systems engineer, zxing2 belongs in the Dart inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2025-06-06T07:48:34.099891Z | [https://pub.dev/api/packages/zxing2](https://pub.dev/api/packages/zxing2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/zxing2` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-1cf1087d274c96` from `pub_dev` as `registry_expansion`
