...
| Canonical URL | [https://crates.io/crates/Salvo](https://crates.io/crates/Salvo) |
| Source record ids | corpus-83c666a4dd2b25 |
...
For a systems engineer, Salvo belongs in the Rust inventory as part of request routing, middleware
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.96.0 | 2026-08-27T01:10:25.881378Z | [https://crates.io/api/v1/crates/Salvo](https://crates.io/api/v1/crates/Salvo) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/Salvo` at `2026-09-01T02:12:59+00:00`.
...
- `corpus-83c666a4dd2b25` from `master_json` as `web_framework`
