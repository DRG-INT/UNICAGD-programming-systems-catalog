...
<!-- canonical: https://github.com/somesocks/lua-lockbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/somesocks/lua-lockbox](https://github.com/somesocks/lua-lockbox) |
| Source record ids | lua-source-284 |
...
For a systems engineer, lua-lockbox belongs in the Lua family inventory as part of ecosystem
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 284}}` |
...
- `lua-source-284` from `master_json` as `source_list_item`
