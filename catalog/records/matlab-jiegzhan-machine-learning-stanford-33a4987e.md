...
<!-- canonical: https://github.com/jiegzhan/machine-learning-stanford -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jiegzhan/machine-learning-stanford](https://github.com/jiegzhan/machine-learning-stanford) |
| Source record ids | github_search_matlab-eb1dcd629c81f5 |

## System Engineer Summary

Stanford machine learning class on Coursera. Taught by Andrew Ng. Implemented the assignments with
Matlab.

## Operational Role

For a systems engineer, jiegzhan/machine-learning-stanford belongs in the Matlab inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-02-10T03:23:07Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-eb1dcd629c81f5` from `github_search_matlab` as `registry_expansion`
