...
<!-- canonical: https://cran.r-project.org/web/packages/rasterpic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rasterpic/index.html](https://cran.r-project.org/web/packages/rasterpic/index.html) |
| Source record ids | cran_packages_by_date-05901f5ce8de1e |
...
For a systems engineer, rasterpic belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-24 16:30:03 UTC | [https://cran.r-project.org/web/packages/rasterpic/DESCRIPTION](https://cran.r-project.org/web/packages/rasterpic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rasterpic/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-05901f5ce8de1e` from `cran_packages_by_date` as `registry_expansion`
