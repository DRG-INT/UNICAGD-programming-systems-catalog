...
<!-- canonical: https://github.com/sonic-pi-net/sonic-pi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sonic-pi-net/sonic-pi](https://github.com/sonic-pi-net/sonic-pi) |
| Source record ids | github_search_audio-a4ada03fef7349 |

## System Engineer Summary

sonic-pi-net/sonic-pi is tracked as a library record in the Audio branch. The source did not provide
...
For a systems engineer, sonic-pi-net/sonic-pi belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.0.0 | 2026-08-07T06:51:55Z | [https://api.github.com/repos/sonic-pi-net/sonic-pi/releases/latest](https://api.github.com/repos/sonic-pi-net/sonic-pi/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/sonic-pi-net/sonic-pi/releases/latest` at `2026-09-01T11:21:42+00:00`.
...
- `github_search_audio-a4ada03fef7349` from `github_search_audio` as `registry_expansion`
