...
| Canonical URL | [https://github.com/ORB-HD/deface](https://github.com/ORB-HD/deface) |
| Source record ids | github_search_video-440929403dceb0 |
...
For a systems engineer, ORB-HD/deface belongs in the Video inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.5.0 | 2023-10-15T21:00:30Z | [https://api.github.com/repos/ORB-HD/deface/releases/latest](https://api.github.com/repos/ORB-HD/deface/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ORB-HD/deface/releases/latest` at `2026-09-01T09:23:26+00:00`.
...
- `github_search_video-440929403dceb0` from `github_search_video` as `registry_expansion`
