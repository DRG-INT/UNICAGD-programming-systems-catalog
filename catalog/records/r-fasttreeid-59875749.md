...
<!-- canonical: https://cran.r-project.org/web/packages/fasttreeid/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fasttreeid/index.html](https://cran.r-project.org/web/packages/fasttreeid/index.html) |
| Source record ids | cran_packages_by_date-9db8ef098cd6d5 |
...
For a systems engineer, fasttreeid belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-31 19:30:59 UTC | [https://cran.r-project.org/web/packages/fasttreeid/DESCRIPTION](https://cran.r-project.org/web/packages/fasttreeid/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fasttreeid/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-9db8ef098cd6d5` from `cran_packages_by_date` as `registry_expansion`
