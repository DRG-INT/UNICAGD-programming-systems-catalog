...
<!-- canonical: https://cran.r-project.org/web/packages/MobilityDataPT/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MobilityDataPT/index.html](https://cran.r-project.org/web/packages/MobilityDataPT/index.html) |
| Source record ids | cran_packages_by_date-e1ffacbdaada93 |

## System Engineer Summary

Get Mobility Related Data for Portugal

## Operational Role

For a systems engineer, MobilityDataPT belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2026-09-12 13:20:02 UTC | [https://cran.r-project.org/web/packages/MobilityDataPT/DESCRIPTION](https://cran.r-project.org/web/packages/MobilityDataPT/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MobilityDataPT/DESCRIPTION` at `2026-09-12T14:18:44+00:00`.
...
- `cran_packages_by_date-e1ffacbdaada93` from `cran_packages_by_date` as `registry_expansion`
