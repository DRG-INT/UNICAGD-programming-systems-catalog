...
<!-- canonical: https://github.com/odhondt/eo_tools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/odhondt/eo_tools](https://github.com/odhondt/eo_tools) |
| Source record ids | github_search_radars-bc95ca87be12b8 |
...
For a systems engineer, odhondt/eo_tools belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.6.0 | 2026-06-07T19:18:56Z | [https://api.github.com/repos/odhondt/eo_tools/releases/latest](https://api.github.com/repos/odhondt/eo_tools/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/odhondt/eo_tools/releases/latest` at `2026-09-01T08:26:31+00:00`.
...
- `github_search_radars-bc95ca87be12b8` from `github_search_radars` as `registry_expansion`
