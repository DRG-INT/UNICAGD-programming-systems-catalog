...
<!-- canonical: https://gnu-octave.github.io/packages/mboct-fem-pkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/mboct-fem-pkg](https://gnu-octave.github.io/packages/mboct-fem-pkg) |
| Source record ids | octave_packages_index-717f7de77016f1 |

## System Engineer Summary

This package belongs to a suite of packages which can be used for pre- and postprocessing of
flexible bodies in MBDyn (www.mbdyn.org) with GNU-Octave. It contains a general purpose structural
Finite Element toolkit for linear statics and dynamics, which can be used to generate flexible body
data for MBDyn's modal element and also hydrodynamic lubricated journal and slider plain bearings.

## Operational Role

For a systems engineer, mboct-fem-pkg belongs in the Octave inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-04-10 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-717f7de77016f1` from `octave_packages_index` as `registry_expansion`
