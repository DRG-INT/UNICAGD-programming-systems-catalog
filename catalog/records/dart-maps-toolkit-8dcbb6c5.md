...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/maps_toolkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/maps_toolkit](https://pub.dev/packages/maps_toolkit) |
| Source record ids | pub_dev-6ca328f244a3b1 |

## System Engineer Summary

Maps toolkit - geo-measurements utils - area of polygon, distance between point, heading and offset
between points (port of SphericalUtil, PolyUtil from `android-maps-utils`).

## Operational Role

For a systems engineer, maps_toolkit belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2025-01-29T10:15:39.106219Z | [https://pub.dev/api/packages/maps_toolkit](https://pub.dev/api/packages/maps_toolkit) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/maps_toolkit` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-6ca328f244a3b1` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| flutter_flavorizr | Utility Library | [open](dart-flutter-flavorizr-6e166bc8.md) |
| installed_apps | Utility Library | [open](dart-installed-apps-23c31879.md) |
| process_run | Utility Library | [open](dart-process-run-9a6122b1.md) |
