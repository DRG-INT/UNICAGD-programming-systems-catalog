...
<!-- canonical: https://github.com/nickurt/laravel-postcodeapi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nickurt/laravel-postcodeapi](https://github.com/nickurt/laravel-postcodeapi) |
| Source record ids | github_search_maps-d4b85af08c6438 |
...
For a systems engineer, nickurt/laravel-postcodeapi belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-19T19:53:26Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-d4b85af08c6438` from `github_search_maps` as `registry_expansion`
