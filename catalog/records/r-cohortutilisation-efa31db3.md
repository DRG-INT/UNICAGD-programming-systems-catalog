...
<!-- canonical: https://cran.r-project.org/web/packages/CohortUtilisation/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CohortUtilisation/index.html](https://cran.r-project.org/web/packages/CohortUtilisation/index.html) |
| Source record ids | cran_packages_by_date-7c1e4277cc44ad |

## System Engineer Summary

Healthcare Resource Utilization on OMOP CDM Cohorts

## Operational Role

For a systems engineer, CohortUtilisation belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.1 | 2026-08-30 09:00:02 UTC | [https://cran.r-project.org/web/packages/CohortUtilisation/DESCRIPTION](https://cran.r-project.org/web/packages/CohortUtilisation/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CohortUtilisation/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-7c1e4277cc44ad` from `cran_packages_by_date` as `registry_expansion`
