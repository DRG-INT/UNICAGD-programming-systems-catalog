...
<!-- canonical: https://cran.r-project.org/web/packages/AgriDataTools/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AgriDataTools/index.html](https://cran.r-project.org/web/packages/AgriDataTools/index.html) |
| Source record ids | cran_packages_by_date-6150062fdb25fd |

## System Engineer Summary

Automated Statistical Analysis and Tools for Agricultural Research

## Operational Role

For a systems engineer, AgriDataTools belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-02 12:20:33 UTC | [https://cran.r-project.org/web/packages/AgriDataTools/DESCRIPTION](https://cran.r-project.org/web/packages/AgriDataTools/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AgriDataTools/DESCRIPTION` at `2026-09-02T12:25:42+00:00`.
...
- `cran_packages_by_date-6150062fdb25fd` from `cran_packages_by_date` as `registry_expansion`
