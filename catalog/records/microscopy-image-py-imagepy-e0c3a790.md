...
<!-- canonical: https://github.com/Image-Py/imagepy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Image-Py/imagepy](https://github.com/Image-Py/imagepy) |
| Source record ids | github_search_microscopy-062c6e44e220c4 |

## System Engineer Summary

Image process framework based on plugin like imagej, it is esay to glue with scipy.ndimage, scikit-
image, opencv, simpleitk, mayavi...and any libraries based on numpy

## Operational Role

For a systems engineer, Image-Py/imagepy belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-21T16:32:43Z | gh search repos topic:imagej stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; BSD 4-Clause "Original" or "Old" License; https://api.github.com/licenses/bsd-4-clause |
...
- `github_search_microscopy-062c6e44e220c4` from `github_search_microscopy` as `registry_expansion`
