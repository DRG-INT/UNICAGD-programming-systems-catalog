...
<!-- canonical: https://crates.io/crates/heck -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/heck](https://crates.io/crates/heck) |
| Source record ids | crates_io-857abfe8c8e026 |
...
For a systems engineer, heck belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2024-03-12T22:42:23.303234Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-857abfe8c8e026` from `crates_io` as `registry_expansion`
