...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin](https://packagist.org/packages/pestphp/pest-plugin) |
| Source record ids | packagist_search-95241e39b83b27 |

## System Engineer Summary

pestphp/pest-plugin is tracked as a testing framework record in the PHP branch. The source did not
...
For a systems engineer, pestphp/pest-plugin belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-95241e39b83b27` from `packagist_search` as `registry_expansion`
