# iamtechnoana/product-matching-system
...
<!-- canonical: https://github.com/iamtechnoana/product-matching-system -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iamtechnoana/product-matching-system](https://github.com/iamtechnoana/product-matching-system) |
| Source record ids | github_search_repertoare_catalogs-1bef722be7a519 |

## System Engineer Summary

4-stage product matching pipeline (EAN → title parsing → attribute scoring → AI fallback) for
mapping supplier titles to a structured catalog. 237 tests, zero false positive auto-accepts.

## Operational Role

For a systems engineer, iamtechnoana/product-matching-system belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-02T17:35:43Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-1bef722be7a519` from `github_search_repertoare_catalogs` as `registry_expansion`
