...
<!-- canonical: https://gnu-octave.github.io/packages/sqlp-sedumi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/sqlp-sedumi](https://gnu-octave.github.io/packages/sqlp-sedumi) |
| Source record ids | octave_packages_index-1d730bf6b2cc6f |

## System Engineer Summary

SeDuMi (Self-Dual-Minimization) is solving convex optimization problems involving linear equations
and inequalities, second-order cone constraints, and semidefinite constraints (linear matrix
inequalities).

## Operational Role

For a systems engineer, sqlp-sedumi belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.5 | 2021-06-15 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-1d730bf6b2cc6f` from `octave_packages_index` as `registry_expansion`
