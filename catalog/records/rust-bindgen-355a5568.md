...
<!-- canonical: https://crates.io/crates/bindgen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bindgen](https://crates.io/crates/bindgen) |
| Source record ids | crates_io-43d3fb318be45d |
...
For a systems engineer, bindgen belongs in the Rust inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.73.2 | 2026-09-08T10:00:58.764024Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-08T10:21:31+00:00`.
...
- `crates_io-43d3fb318be45d` from `crates_io` as `registry_expansion`
