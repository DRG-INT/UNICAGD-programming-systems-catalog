...
<!-- canonical: https://gitea.com/martinliu/DevOpsChina -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/martinliu/DevOpsChina](https://gitea.com/martinliu/DevOpsChina) |
| Source record ids | gitea_repositories_api-f8364cbac80e0c |
...
For a systems engineer, Gitea: martinliu/DevOpsChina belongs in the Repository Workplaces inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-12-27T06:14:39Z | [https://gitea.com/api/v1/repos/search?q=devops&limit=50](https://gitea.com/api/v1/repos/search?q=devops&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-f8364cbac80e0c` from `gitea_repositories_api` as `registry_expansion`
