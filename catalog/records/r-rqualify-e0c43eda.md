...
<!-- canonical: https://cran.r-project.org/web/packages/rqualify/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rqualify/index.html](https://cran.r-project.org/web/packages/rqualify/index.html) |
| Source record ids | cran_packages_by_date-57dc55b241aa1f |

## System Engineer Summary

Qualification of R Software Installations

## Operational Role

For a systems engineer, rqualify belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-28 20:00:02 UTC | [https://cran.r-project.org/web/packages/rqualify/DESCRIPTION](https://cran.r-project.org/web/packages/rqualify/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rqualify/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-57dc55b241aa1f` from `cran_packages_by_date` as `registry_expansion`
