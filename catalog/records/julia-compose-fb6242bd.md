...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Compose](https://github.com/JuliaRegistries/General/tree/master/C/Compose) |
| Source record ids | julia_general-1165237b233042 |

## System Engineer Summary

Julia package registered in General at C/Compose.

## Operational Role

For a systems engineer, Compose belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Compose", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-1165237b233042` from `julia_general` as `registry_expansion`
