...
<!-- canonical: https://packagist.org/packages/geekcom/phpjasper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/geekcom/phpjasper](https://packagist.org/packages/geekcom/phpjasper) |
| Source record ids | packagist_search-10799ff6fc3296 |

## System Engineer Summary

geekcom/phpjasper is tracked as a serialization record in the PHP branch. The source did not provide
...
For a systems engineer, geekcom/phpjasper belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-10799ff6fc3296` from `packagist_search` as `registry_expansion`
