...
<!-- canonical: https://www.nuget.org/packages/NodaTime.Serialization.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/NodaTime.Serialization.SystemTextJson](https://www.nuget.org/packages/NodaTime.Serialization.SystemTextJson) |
| Source record ids | nuget_search-cc03abb1897026 |
...
For a systems engineer, NodaTime.Serialization.SystemTextJson belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.0 | 2026-06-06T07:20:48.673+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nodatime.serialization.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nodatime.serialization.systemtextjson/index.json) |  |
| preview | known | 1.0.0-beta02 | 2020-04-26T07:59:47.353+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/nodatime.serialization.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/nodatime.serialization.systemtextjson/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache-2.0; https://www.nuget.org/packages/NodaTime.Serialization.SystemTextJson/1.4.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/nodatime.serialization.systemtextjson/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-cc03abb1897026` from `nuget_search` as `registry_expansion`
