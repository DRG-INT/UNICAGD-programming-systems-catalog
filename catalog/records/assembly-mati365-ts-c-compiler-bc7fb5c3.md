...
<!-- canonical: https://github.com/Mati365/ts-c-compiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mati365/ts-c-compiler](https://github.com/Mati365/ts-c-compiler) |
| Source record ids | github_search_assembly-f2d3b1298973e9 |

## System Engineer Summary

⚙️ C99-compatible multipass compiler written in TypeScript with GCC extensions support. Features a
handcrafted left-recursive parser, custom IR, SSA-based optimizer, and a full frontend/backend
pipeline. Compiles to x86 machine code with integrated assembler and emulator.

## Operational Role

For a systems engineer, Mati365/ts-c-compiler belongs in the Assembly inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-11T06:13:10Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-f2d3b1298973e9` from `github_search_assembly` as `registry_expansion`
