...
<!-- canonical: https://github.com/Stratio/sparta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Stratio/sparta](https://github.com/Stratio/sparta) |
| Source record ids | github_search_databases-545a4c7b1dd4ba |
...
For a systems engineer, Stratio/sparta belongs in the Databases inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-10-24T06:32:21Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-545a4c7b1dd4ba` from `github_search_databases` as `registry_expansion`
