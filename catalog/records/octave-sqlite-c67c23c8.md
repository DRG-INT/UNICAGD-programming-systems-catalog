...
<!-- canonical: https://gnu-octave.github.io/packages/sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/sqlite](https://gnu-octave.github.io/packages/sqlite) |
| Source record ids | octave_packages_index-f0e2efc4c2642a |
...
For a systems engineer, sqlite belongs in the Octave inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-05-25 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-f0e2efc4c2642a` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| database | Database Datastore | [open](octave-database-4fb68cb0.md) |
