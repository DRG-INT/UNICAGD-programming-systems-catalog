...
<!-- canonical: https://github.com/huiwenzhang/ml-in-action -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/huiwenzhang/ml-in-action](https://github.com/huiwenzhang/ml-in-action) |
| Source record ids | github_search_matlab-6940996ac7fd4f |

## System Engineer Summary

出版书籍《机器学习入门到实践——MATLAB实践应用》一书中的实例程序。涉及监督学习，非监督学习和强化学习。(code for book "Machine Learning Introduction
& action in MATLAB")

## Operational Role

For a systems engineer, huiwenzhang/ml-in-action belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-05-20T03:59:17Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-6940996ac7fd4f` from `github_search_matlab` as `registry_expansion`
