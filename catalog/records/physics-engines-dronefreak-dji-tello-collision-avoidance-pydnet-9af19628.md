...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/dronefreak/dji-tello-collision-avoidance-pydnet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dronefreak/dji-tello-collision-avoidance-pydnet](https://github.com/dronefreak/dji-tello-collision-avoidance-pydnet) |
| Source record ids | github_search_physics_engines-7adf575cbb5b7d |

## System Engineer Summary

Real-time monocular depth estimation for DJI Tello drone collision avoidance. Modern TF2.x
implementation with webcam support, comprehensive tests, and autonomous navigation. PyDNet-based
with MiDaS support.

## Operational Role

For a systems engineer, dronefreak/dji-tello-collision-avoidance-pydnet belongs in the Physics
Engines inventory as part of unit/integration validation, regression protection, and release
confidence.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T15:10:44Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-7adf575cbb5b7d` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| noonat/intersect | Testing Framework | [open](physics-engines-noonat-intersect-10ed35e1.md) |
| ppgia-unifor/Broadmark | Testing Framework | [open](physics-engines-ppgia-unifor-broadmark-c3734a1e.md) |
