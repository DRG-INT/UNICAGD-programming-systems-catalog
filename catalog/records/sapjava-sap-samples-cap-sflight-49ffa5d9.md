...
<!-- canonical: https://github.com/SAP-samples/cap-sflight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SAP-samples/cap-sflight](https://github.com/SAP-samples/cap-sflight) |
| Source record ids | github_search_sapjava-3d4ead17fb91ab |

## System Engineer Summary

Using SAP Cloud Application Programming Model and SAP Fiori elements to build a simple travel
management app, both with Node.js and Java.

## Operational Role

For a systems engineer, SAP-samples/cap-sflight belongs in the SAPJava inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-19T13:06:57Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-3d4ead17fb91ab` from `github_search_sapjava` as `registry_expansion`
