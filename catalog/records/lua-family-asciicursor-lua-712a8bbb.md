...
<!-- canonical: https://luarocks.org/modules/mr-v01d/asciicursor-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mr-v01d/asciicursor-lua](https://luarocks.org/modules/mr-v01d/asciicursor-lua) |
| Source record ids | luarocks_root_manifest-46d86dce7f942a |

## System Engineer Summary

Small Lua library that provides funcitonality for using Ascii escape characters

## Operational Role

For a systems engineer, AsciiCursor-Lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-46d86dce7f942a` from `luarocks_root_manifest` as `registry_expansion`
