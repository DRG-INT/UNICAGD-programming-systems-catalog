...
| Source record ids | github_search_swift-99dc9298c1f2d6 |
...
For a systems engineer, mrkai77/Loop belongs in the Swift inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T00:13:04Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-99dc9298c1f2d6` from `github_search_swift` as `registry_expansion`
