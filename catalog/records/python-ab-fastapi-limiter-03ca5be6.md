...
<!-- canonical: https://pypi.org/project/ab-fastapi-limiter/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-fastapi-limiter/](https://pypi.org/project/ab-fastapi-limiter/) |
| Source record ids | pypi_simple-e9cd2d23925cea |
...
For a systems engineer, ab-fastapi-limiter belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3 | 2026-04-28T06:08:50.235935Z | [https://pypi.org/pypi/ab-fastapi-limiter/json](https://pypi.org/pypi/ab-fastapi-limiter/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-fastapi-limiter/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-e9cd2d23925cea` from `pypi_simple` as `registry_expansion`
