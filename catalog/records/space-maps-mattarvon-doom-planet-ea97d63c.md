# mattarvon/doom-planet

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/mattarvon/doom-planet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mattarvon/doom-planet](https://github.com/mattarvon/doom-planet) |
| Source record ids | github_search_space_maps-4959bca214bcc4 |

## System Engineer Summary

Doom Planet - a horror-themed live planetary telemetry dashboard: a dark satellite map layered with
real-time earthquakes, tornadoes, volcanoes, disasters, natural events, space weather, contagion,
tides, and prowling megalodons. All free public APIs, no backend.

## Operational Role

For a systems engineer, mattarvon/doom-planet belongs in the Space Maps inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T18:00:22Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-4959bca214bcc4` from `github_search_space_maps` as `registry_expansion`
