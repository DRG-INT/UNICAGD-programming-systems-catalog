...
<!-- canonical: https://cran.r-project.org/web/packages/AIGENIE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AIGENIE/index.html](https://cran.r-project.org/web/packages/AIGENIE/index.html) |
| Source record ids | cran_packages_by_date-99c1d4deb114e8 |
...
For a systems engineer, AIGENIE belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.2 | 2026-09-08 13:50:09 UTC | [https://cran.r-project.org/web/packages/AIGENIE/DESCRIPTION](https://cran.r-project.org/web/packages/AIGENIE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AIGENIE/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-99c1d4deb114e8` from `cran_packages_by_date` as `registry_expansion`
