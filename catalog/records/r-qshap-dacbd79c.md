...
<!-- canonical: https://cran.r-project.org/web/packages/qshap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/qshap/index.html](https://cran.r-project.org/web/packages/qshap/index.html) |
| Source record ids | cran_packages_by_date-f7506284b0722e |
...
For a systems engineer, qshap belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-23 09:10:02 UTC | [https://cran.r-project.org/web/packages/qshap/DESCRIPTION](https://cran.r-project.org/web/packages/qshap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/qshap/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f7506284b0722e` from `cran_packages_by_date` as `registry_expansion`
