...
<!-- canonical: https://github.com/pheralb/svgl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pheralb/svgl](https://github.com/pheralb/svgl) |
| Source record ids | github_search_icons_and_logos-07880e8df66dd5 |
...
For a systems engineer, pheralb/svgl belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T09:41:02Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-07880e8df66dd5` from `github_search_icons_and_logos` as `registry_expansion`
