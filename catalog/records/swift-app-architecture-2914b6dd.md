...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/objcio/app-architecture -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/objcio/app-architecture](https://github.com/objcio/app-architecture) |
| Source record ids | awesome_list-ca3bcff9eb99b6 |
...
For a systems engineer, App Architecture belongs in the Swift inventory as part of ecosystem
...
- `awesome_list-ca3bcff9eb99b6` from `awesome_list` as `registry_expansion`
