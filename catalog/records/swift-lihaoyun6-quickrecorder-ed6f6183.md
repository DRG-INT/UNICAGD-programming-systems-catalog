...
<!-- canonical: https://github.com/lihaoyun6/QuickRecorder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lihaoyun6/QuickRecorder](https://github.com/lihaoyun6/QuickRecorder) |
| Source record ids | github_search_swift-d3d953bc6b8cec |

## System Engineer Summary

A lightweight screen recorder based on ScreenCapture Kit for macOS / 基于 ScreenCapture Kit 的轻量化多功能
macOS 录屏工具

## Operational Role

For a systems engineer, lihaoyun6/QuickRecorder belongs in the Swift inventory as part of ecosystem
...
- `github_search_swift-d3d953bc6b8cec` from `github_search_swift` as `registry_expansion`
