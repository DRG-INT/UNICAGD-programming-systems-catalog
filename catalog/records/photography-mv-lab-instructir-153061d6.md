...
| Source record ids | github_search_photography-f25d437c9b6f02 |
...
For a systems engineer, mv-lab/InstructIR belongs in the Photography inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | instructir-results | 2024-02-23T21:51:41Z | [https://api.github.com/repos/mv-lab/InstructIR/releases/latest](https://api.github.com/repos/mv-lab/InstructIR/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mv-lab/InstructIR/releases/latest` at `2026-09-01T09:23:32+00:00`.
...
- `github_search_photography-f25d437c9b6f02` from `github_search_photography` as `registry_expansion`
