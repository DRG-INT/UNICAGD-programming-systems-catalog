...
| Canonical URL | [https://crates.io/crates/pear](https://crates.io/crates/pear) |
| Source record ids | crates_io-0348b23fc489e2 |

## System Engineer Summary

pear is tracked as a visualization gui record in the Rust branch. The source did not provide a long
...
For a systems engineer, pear belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.9 | 2024-03-20T07:17:25.727639Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-0348b23fc489e2` from `crates_io` as `registry_expansion`
