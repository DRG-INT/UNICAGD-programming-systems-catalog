...
<!-- canonical: https://packagist.org/packages/monicahq/laradb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/monicahq/laradb](https://packagist.org/packages/monicahq/laradb) |
| Source record ids | packagist_search-d8bd5304ddcb19 |

## System Engineer Summary

A read-only database browser for Laravel: browse your tables and their rows from a single page.
Supports MySQL, PostgreSQL and SQLite.

## Operational Role

For a systems engineer, monicahq/laradb belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | unknown |  |  | unknown | packagist_package_metadata_missing |
| preview/nightly | unknown |  |  | unknown | packagist_package_metadata_missing |
...
- Stable release is unknown because `packagist_package_metadata_missing`.
- Preview/nightly metadata is unknown because `packagist_package_metadata_missing`.
...
| --- | --- | --- | --- |
| packagist_search_and_p2_api | registry-derived | 2026-09-12 | `{"kind": "packagist_search_and_p2_api", "query": "postgres", "retrieved": "2026-09-12", "status": "registry-derived"}` |
...
- `packagist_search-d8bd5304ddcb19` from `packagist_search` as `registry_expansion`
...
| albertoarena/laravel-truss | Database Datastore | [open](php-albertoarena-laravel-truss-d4cfc94b.md) |
