...
<!-- canonical: https://sourceforge.net/projects/wtl/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://sourceforge.net/projects/wtl/](https://sourceforge.net/projects/wtl/) |
| Source record ids | awesome_list-f12706d1e9d8d5 |
...
For a systems engineer, Windows Template Library belongs in the C++23 inventory as part of ecosystem
...
- `awesome_list-f12706d1e9d8d5` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| btsk | Project Scaffolding | [open](c-23-btsk-45ab0904.md) |
