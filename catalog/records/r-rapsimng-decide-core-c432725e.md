...
<!-- canonical: https://cran.r-project.org/web/packages/rapsimng.decide.core/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rapsimng.decide.core/index.html](https://cran.r-project.org/web/packages/rapsimng.decide.core/index.html) |
| Source record ids | cran_packages_by_date-9b2611c7e47796 |

## System Engineer Summary

Decision-Oriented Analysis Core for APSIM Next Generation Outputs

## Operational Role

For a systems engineer, rapsimng.decide.core belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:40:08 UTC | [https://cran.r-project.org/web/packages/rapsimng.decide.core/DESCRIPTION](https://cran.r-project.org/web/packages/rapsimng.decide.core/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rapsimng.decide.core/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9b2611c7e47796` from `cran_packages_by_date` as `registry_expansion`
...
| apisensr | Static Analyzer | [open](r-apisensr-84600f94.md) |
| APRScenario | Static Analyzer | [open](r-aprscenario-8c302811.md) |
| artma | Static Analyzer | [open](r-artma-de642380.md) |
| BayesNSGP | Static Analyzer | [open](r-bayesnsgp-39f319c3.md) |
