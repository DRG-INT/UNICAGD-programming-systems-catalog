...
<!-- canonical: https://github.com/apache/gravitino -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/apache/gravitino](https://github.com/apache/gravitino) |
| Source record ids | github_search_catalogs-0623e490fec58b |

## System Engineer Summary

World's most powerful open data catalog for building a high-performance, geo-distributed and
federated metadata lake.

## Operational Role

For a systems engineer, apache/gravitino belongs in the Catalogs inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:41:36Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-0623e490fec58b` from `github_search_catalogs` as `registry_expansion`
...
| open-metadata/OpenMetadata | Build System | [open](catalogs-open-metadata-openmetadata-9b2636a5.md) |
