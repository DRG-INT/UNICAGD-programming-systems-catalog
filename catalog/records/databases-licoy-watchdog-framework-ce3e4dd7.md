...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Licoy/watchdog-framework -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Licoy/watchdog-framework](https://github.com/Licoy/watchdog-framework) |
| Source record ids | github_search_databases-526dfd851f1050 |
...
For a systems engineer, Licoy/watchdog-framework belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-14T03:15:49Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-526dfd851f1050` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| X1r0z/JNDIMap | Framework | [open](databases-x1r0z-jndimap-51139cd4.md) |
