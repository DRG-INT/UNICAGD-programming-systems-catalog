...
<!-- canonical: https://cran.r-project.org/web/packages/simglm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/simglm/index.html](https://cran.r-project.org/web/packages/simglm/index.html) |
| Source record ids | cran_packages_by_date-dc990b390294d4 |
...
For a systems engineer, simglm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-01 20:20:02 UTC | [https://cran.r-project.org/web/packages/simglm/DESCRIPTION](https://cran.r-project.org/web/packages/simglm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/simglm/DESCRIPTION` at `2026-09-01T22:17:57+00:00`.
...
- `cran_packages_by_date-dc990b390294d4` from `cran_packages_by_date` as `registry_expansion`
