...
<!-- canonical: https://cran.r-project.org/web/packages/LSJM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LSJM/index.html](https://cran.r-project.org/web/packages/LSJM/index.html) |
| Source record ids | cran_packages_by_date-553ba956f31059 |

## System Engineer Summary

Estimate Location-Scale Joint Models

## Operational Role

For a systems engineer, LSJM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 13:10:23 UTC | [https://cran.r-project.org/web/packages/LSJM/DESCRIPTION](https://cran.r-project.org/web/packages/LSJM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LSJM/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-553ba956f31059` from `cran_packages_by_date` as `registry_expansion`
