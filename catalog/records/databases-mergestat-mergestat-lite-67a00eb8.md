...
<!-- canonical: https://github.com/mergestat/mergestat-lite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mergestat/mergestat-lite](https://github.com/mergestat/mergestat-lite) |
| Source record ids | github_search_databases-e71208de11fac1 |
...
For a systems engineer, mergestat/mergestat-lite belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T05:26:30Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e71208de11fac1` from `github_search_databases` as `registry_expansion`
