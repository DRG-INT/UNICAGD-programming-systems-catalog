# sametsavgaman/suricata-rules-catalog

## Navigation

[Catalog index](../index.md) · [Language: Repertoare Catalogs](../by-language/repertoare-catalogs.md) · [Category: Lint Rule Pack](../by-category/lint-rule-pack.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/sametsavgaman/suricata-rules-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sametsavgaman/suricata-rules-catalog](https://github.com/sametsavgaman/suricata-rules-catalog) |
| Source record ids | github_search_repertoare_catalogs-715371471d9843 |

## System Engineer Summary

AI-powered Suricata rule classification and detection engineering platform that enriches network
detection rules with MITRE ATT&CK mappings, behavioral categories, threat entities, confidence
scores, and evidence-based explanations using local Qwen and optional Gemini models.

## Operational Role

For a systems engineer, sametsavgaman/suricata-rules-catalog belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T11:37:38Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-715371471d9843` from `github_search_repertoare_catalogs` as `registry_expansion`
