...
<!-- canonical: https://packagist.org/packages/namoshek/laravel-redis-sentinel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/namoshek/laravel-redis-sentinel](https://packagist.org/packages/namoshek/laravel-redis-sentinel) |
| Source record ids | packagist_search-95c87fa25800b2 |

## System Engineer Summary

An extension of Laravels Redis driver which supports connecting to a Redis master through Redis
Sentinel.

## Operational Role

For a systems engineer, namoshek/laravel-redis-sentinel belongs in the PHP inventory as part of
...
- `packagist_search-95c87fa25800b2` from `packagist_search` as `registry_expansion`
