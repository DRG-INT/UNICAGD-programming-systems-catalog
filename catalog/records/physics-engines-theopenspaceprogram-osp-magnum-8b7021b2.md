...
<!-- canonical: https://github.com/TheOpenSpaceProgram/osp-magnum -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TheOpenSpaceProgram/osp-magnum](https://github.com/TheOpenSpaceProgram/osp-magnum) |
| Source record ids | github_search_physics_engines-0cf6b92dbc8500 |

## System Engineer Summary

TheOpenSpaceProgram/osp-magnum is tracked as a filesystem os record in the Physics Engines branch.
...
For a systems engineer, TheOpenSpaceProgram/osp-magnum belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-27T06:20:40Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-0cf6b92dbc8500` from `github_search_physics_engines` as `registry_expansion`
