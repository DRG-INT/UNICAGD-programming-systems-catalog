...
<!-- canonical: https://crates.io/crates/proc-macro-hack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/proc-macro-hack](https://crates.io/crates/proc-macro-hack) |
| Source record ids | crates_io-547030553812cc |
...
For a systems engineer, proc-macro-hack belongs in the Rust inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.20+deprecated | 2022-12-19T18:23:34.874100Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-547030553812cc` from `crates_io` as `registry_expansion`
