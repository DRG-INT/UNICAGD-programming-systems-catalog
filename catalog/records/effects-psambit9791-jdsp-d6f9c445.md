...
<!-- canonical: https://github.com/psambit9791/jdsp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/psambit9791/jdsp](https://github.com/psambit9791/jdsp) |
| Source record ids | github_search_effects-854f096fb65d2f |
...
For a systems engineer, psambit9791/jdsp belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-16T01:00:10Z | gh search repos topic:dsp stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-854f096fb65d2f` from `github_search_effects` as `registry_expansion`
