...
| Source record ids | corpus-637403591e13b3 |

## System Engineer Summary

C23 unreachable macro is tracked as a standard library record in the C23 branch. The source did not
...
For a systems engineer, C23 unreachable macro belongs in the C23 inventory as part of ecosystem
...
- `corpus-637403591e13b3` from `master_json` as `standard_library`
