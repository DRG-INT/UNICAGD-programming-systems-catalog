...
<!-- canonical: https://packagist.org/packages/simplon/mysql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/simplon/mysql](https://packagist.org/packages/simplon/mysql) |
| Source record ids | packagist_search-5d9f0feb35c829 |

## System Engineer Summary

simplon/mysql is tracked as a database datastore record in the PHP branch. The source did not
...
For a systems engineer, simplon/mysql belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-5d9f0feb35c829` from `packagist_search` as `registry_expansion`
