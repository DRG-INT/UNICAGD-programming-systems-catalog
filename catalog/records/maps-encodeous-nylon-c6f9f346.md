...
<!-- canonical: https://github.com/encodeous/nylon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/encodeous/nylon](https://github.com/encodeous/nylon) |
| Source record ids | github_search_maps-a5b4e145415ef8 |

## System Engineer Summary

Self-healing WireGuard mesh. Reroutes around failures in seconds, no coordination server, fully
FOSS.

## Operational Role

For a systems engineer, encodeous/nylon belongs in the Maps inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T15:28:11Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-a5b4e145415ef8` from `github_search_maps` as `registry_expansion`
