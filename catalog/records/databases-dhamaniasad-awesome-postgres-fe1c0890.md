...
<!-- canonical: https://github.com/dhamaniasad/awesome-postgres -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) |
| Source record ids | github_search_databases-f395aaf6482bce |

## System Engineer Summary

A curated list of awesome PostgreSQL software, libraries, tools and resources, inspired by awesome-
mysql

## Operational Role

For a systems engineer, dhamaniasad/awesome-postgres belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T09:07:19Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f395aaf6482bce` from `github_search_databases` as `registry_expansion`
