...
<!-- canonical: https://pypi.org/project/aa-mcp-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aa-mcp-server/](https://pypi.org/project/aa-mcp-server/) |
| Source record ids | pypi_simple-77afa5359e5aa9 |

## System Engineer Summary

MCP server for read-only American Airlines AAdvantage account access — direct API calls via session
cookies extracted from a Chromium login

## Operational Role

For a systems engineer, aa-mcp-server belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-05-04T16:01:38.444473Z | [https://pypi.org/pypi/aa-mcp-server/json](https://pypi.org/pypi/aa-mcp-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aa-mcp-server/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-77afa5359e5aa9` from `pypi_simple` as `registry_expansion`
