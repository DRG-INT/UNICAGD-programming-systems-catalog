...
| Source record ids | corpus-54979ef2996394 |

## System Engineer Summary

LuaBridge is tracked as a ffi bindings record in the Lua family branch. The source did not provide a
...
For a systems engineer, LuaBridge belongs in the Lua family inventory as part of cross-language
...
- `corpus-54979ef2996394` from `master_json` as `ffi_bindings`
