...
| Canonical URL | [https://luarocks.org/modules/evandrolg/immutable](https://luarocks.org/modules/evandrolg/immutable) |
| Source record ids | luarocks_root_manifest-f91928f346c0e8 |
...
For a systems engineer, immutable belongs in the Lua family inventory as part of build graph
...
- `luarocks_root_manifest-f91928f346c0e8` from `luarocks_root_manifest` as `registry_expansion`
