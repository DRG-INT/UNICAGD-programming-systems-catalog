...
<!-- canonical: https://cran.r-project.org/web/packages/birdie/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/birdie/index.html](https://cran.r-project.org/web/packages/birdie/index.html) |
| Source record ids | cran_packages_by_date-e8df7e50e49698 |
...
For a systems engineer, birdie belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.0 | 2026-09-09 08:30:18 UTC | [https://cran.r-project.org/web/packages/birdie/DESCRIPTION](https://cran.r-project.org/web/packages/birdie/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/birdie/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-e8df7e50e49698` from `cran_packages_by_date` as `registry_expansion`
