...
| Source record ids | github_search_assets-18cc2b6a47eaf0 |
...
For a systems engineer, assimp/assimp belongs in the Assets inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T22:17:19Z | gh search repos topic:asset-pipeline stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-18cc2b6a47eaf0` from `github_search_assets` as `registry_expansion`
