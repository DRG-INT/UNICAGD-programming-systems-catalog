...
<!-- canonical: https://github.com/RedBlight/EFVIE-MoM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RedBlight/EFVIE-MoM](https://github.com/RedBlight/EFVIE-MoM) |
| Source record ids | github_search_electromagnetoscopes-8979b117dadd21 |

## System Engineer Summary

Electric field volume integral equation solver, incorporating method of moments and SWG basis
functions.

## Operational Role

For a systems engineer, RedBlight/EFVIE-MoM belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-23T21:41:27Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-8979b117dadd21` from `github_search_electromagnetoscopes` as `registry_expansion`
