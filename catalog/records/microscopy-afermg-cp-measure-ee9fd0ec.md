...
| Canonical URL | [https://github.com/afermg/cp_measure](https://github.com/afermg/cp_measure) |
| Source record ids | github_search_microscopy-01770fb9465da7 |
...
For a systems engineer, afermg/cp_measure belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.2.0 | 2026-08-13T23:39:39Z | [https://api.github.com/repos/afermg/cp_measure/releases/latest](https://api.github.com/repos/afermg/cp_measure/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/afermg/cp_measure/releases/latest` at `2026-09-01T08:26:16+00:00`.
...
- `github_search_microscopy-01770fb9465da7` from `github_search_microscopy` as `registry_expansion`
