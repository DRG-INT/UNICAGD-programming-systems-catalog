...
<!-- canonical: https://github.com/tektoncd/catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tektoncd/catalog](https://github.com/tektoncd/catalog) |
| Source record ids | github_search_catalogs-943655c3371d2f |
...
For a systems engineer, tektoncd/catalog belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-03T10:04:40Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-943655c3371d2f` from `github_search_catalogs` as `registry_expansion`
