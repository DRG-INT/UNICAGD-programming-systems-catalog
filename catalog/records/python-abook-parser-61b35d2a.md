...
<!-- canonical: https://pypi.org/project/abook-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abook-parser/](https://pypi.org/project/abook-parser/) |
| Source record ids | pypi_simple-f714a8586c7906 |
...
For a systems engineer, abook-parser belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2024-11-27T19:36:38.942899Z | [https://pypi.org/pypi/abook-parser/json](https://pypi.org/pypi/abook-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abook-parser/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-f714a8586c7906` from `pypi_simple` as `registry_expansion`
