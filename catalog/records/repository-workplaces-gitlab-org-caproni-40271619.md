...
<!-- canonical: https://gitlab.com/gitlab-org/caproni -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/caproni](https://gitlab.com/gitlab-org/caproni) |
| Source record ids | gitlab_projects_api-2f577c103f32fe |

## System Engineer Summary

Caproni is an alternative development toolkit for developing GitLab that uses Cloud Native GitLab
Charts and Kubernetes in the development process.

## Operational Role

For a systems engineer, gitlab-org/caproni belongs in the Repository Workplaces inventory as part of
...
- `gitlab_projects_api-2f577c103f32fe` from `gitlab_projects_api` as `registry_expansion`
