...
<!-- canonical: https://github.com/google-deepmind/dm_control -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/google-deepmind/dm_control](https://github.com/google-deepmind/dm_control) |
| Source record ids | github_search_physics_engines-e1f2f343afec12 |

## System Engineer Summary

Google DeepMind's software stack for physics-based simulation and Reinforcement Learning
environments, using MuJoCo.

## Operational Role

For a systems engineer, google-deepmind/dm_control belongs in the Physics Engines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T12:23:09Z | gh search repos topic:physics-simulation stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e1f2f343afec12` from `github_search_physics_engines` as `registry_expansion`
