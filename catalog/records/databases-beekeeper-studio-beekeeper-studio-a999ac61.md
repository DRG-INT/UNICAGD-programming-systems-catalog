...
<!-- canonical: https://github.com/beekeeper-studio/beekeeper-studio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/beekeeper-studio/beekeeper-studio](https://github.com/beekeeper-studio/beekeeper-studio) |
| Source record ids | github_search_databases-eb02e58c4e7101 |

## System Engineer Summary

Modern and easy to use SQL client for MySQL, Postgres, SQLite, SQL Server, and more. Linux, MacOS,
and Windows.

## Operational Role

For a systems engineer, beekeeper-studio/beekeeper-studio belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T08:46:45Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-eb02e58c4e7101` from `github_search_databases` as `registry_expansion`
