...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vladmandic/pigallery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vladmandic/pigallery](https://github.com/vladmandic/pigallery) |
| Source record ids | github_search_photography-ceac9196e97cb1 |

## System Engineer Summary

PiGallery: AI-powered Self-hosted Secure Multi-user Image Gallery and Detailed Image analysis using
Machine Learning, EXIF Parsing and Geo Tagging

## Operational Role

For a systems engineer, vladmandic/pigallery belongs in the Photography inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-02T00:36:18Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:exif stars:>50", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_photography-ceac9196e97cb1` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bluescan/tacentview | Static Analyzer | [open](photography-bluescan-tacentview-36115ac1.md) |
| dlazaro66/QRCodeReaderView | Static Analyzer | [open](photography-dlazaro66-qrcodereaderview-9c349462.md) |
| gee-community/geemap | Static Analyzer | [open](photography-gee-community-geemap-8f40e707.md) |
| GrapheneOS/Camera | Static Analyzer | [open](photography-grapheneos-camera-e6336699.md) |
| Haris87/photosint | Static Analyzer | [open](photography-haris87-photosint-5032ef4a.md) |
| hyperoslo/BarcodeScanner | Static Analyzer | [open](photography-hyperoslo-barcodescanner-b1f848d8.md) |
| jackw01/scanlight | Static Analyzer | [open](photography-jackw01-scanlight-ebc00536.md) |
| jorhelp/Ingram | Static Analyzer | [open](photography-jorhelp-ingram-4f54c30d.md) |
