...
<!-- canonical: https://cran.r-project.org/web/packages/mipfp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mipfp/index.html](https://cran.r-project.org/web/packages/mipfp/index.html) |
| Source record ids | cran_packages_by_date-fbba88976a73d3 |
...
For a systems engineer, mipfp belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.3 | 2026-08-22 06:30:02 UTC | [https://cran.r-project.org/web/packages/mipfp/DESCRIPTION](https://cran.r-project.org/web/packages/mipfp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mipfp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fbba88976a73d3` from `cran_packages_by_date` as `registry_expansion`
