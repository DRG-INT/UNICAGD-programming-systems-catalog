...
<!-- canonical: https://cran.r-project.org/web/packages/policytree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/policytree/index.html](https://cran.r-project.org/web/packages/policytree/index.html) |
| Source record ids | cran_packages_by_date-856bd54d0833fe |
...
For a systems engineer, policytree belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.5 | 2026-08-04 10:30:29 UTC | [https://cran.r-project.org/web/packages/policytree/DESCRIPTION](https://cran.r-project.org/web/packages/policytree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/policytree/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-856bd54d0833fe` from `cran_packages_by_date` as `registry_expansion`
