...
<!-- canonical: https://pypi.org/project/adapt-server/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adapt-server/](https://pypi.org/project/adapt-server/) |
| Source record ids | pypi_simple-1bfeb7562dc7ac |
...
For a systems engineer, adapt-server belongs in the Python inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-31T11:10:58.753268Z | [https://pypi.org/pypi/adapt-server/json](https://pypi.org/pypi/adapt-server/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adapt-server/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-1bfeb7562dc7ac` from `pypi_simple` as `registry_expansion`
