...
<!-- canonical: https://hackage.haskell.org/package/hevm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hevm](https://hackage.haskell.org/package/hevm) |
| Source record ids | hackage_top_downloads-324728c0d09ff5 |
...
For a systems engineer, hevm belongs in the Haskell inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.58.0 | 2026-06-29T14:06:24Z | [https://hackage.haskell.org/package/hevm](https://hackage.haskell.org/package/hevm) |  |
| candidate | partial | 0.16 |  | [https://hackage.haskell.org/package/hevm](https://hackage.haskell.org/package/hevm) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hevm` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-324728c0d09ff5` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| aws-lambda-haskell-runtime | Interpreter Runtime | [open](haskell-aws-lambda-haskell-runtime-33ac5842.md) |
