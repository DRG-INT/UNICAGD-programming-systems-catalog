...
| Canonical URL | [https://github.com/Cantera/cantera](https://github.com/Cantera/cantera) |
| Source record ids | curated_language_routes-44a573f9ece89a |

## System Engineer Summary

Thermodynamics, chemical kinetics, and transport toolkit used for propulsion, combustion, and
reacting-flow analysis.

## Operational Role

For a systems engineer, Cantera belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.2.0 | 2025-11-18T00:13:14Z | [https://api.github.com/repos/Cantera/cantera/releases/latest](https://api.github.com/repos/Cantera/cantera/releases/latest) |  |
| preview | known | v3.2.0b1 | 2025-11-01T17:31:49Z | [https://api.github.com/repos/Cantera/cantera/releases?per_page=10](https://api.github.com/repos/Cantera/cantera/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Cantera/cantera/releases/latest` at `2026-09-01T07:24:44+00:00`.
...
- `curated_language_routes-44a573f9ece89a` from `curated_language_routes` as `registry_expansion`
