...
<!-- canonical: https://cran.r-project.org/web/packages/GPTreeO/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/GPTreeO/index.html](https://cran.r-project.org/web/packages/GPTreeO/index.html) |
| Source record ids | cran_packages_by_date-32245b5ad32d62 |
...
For a systems engineer, GPTreeO belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-25 10:30:07 UTC | [https://cran.r-project.org/web/packages/GPTreeO/DESCRIPTION](https://cran.r-project.org/web/packages/GPTreeO/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/GPTreeO/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-32245b5ad32d62` from `cran_packages_by_date` as `registry_expansion`
