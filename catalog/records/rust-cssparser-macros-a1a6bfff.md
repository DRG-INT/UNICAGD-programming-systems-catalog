...
<!-- canonical: https://crates.io/crates/cssparser-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/cssparser-macros](https://crates.io/crates/cssparser-macros) |
| Source record ids | crates_io-66e33781fd2e87 |
...
For a systems engineer, cssparser-macros belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.1 | 2026-09-07T11:36:04.699064Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads` at `2026-09-07T12:26:32+00:00`.
...
- `crates_io-66e33781fd2e87` from `crates_io` as `registry_expansion`
