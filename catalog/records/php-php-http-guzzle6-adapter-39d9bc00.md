...
<!-- canonical: https://packagist.org/packages/php-http/guzzle6-adapter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/php-http/guzzle6-adapter](https://packagist.org/packages/php-http/guzzle6-adapter) |
| Source record ids | packagist_search-372aa80071406f |

## System Engineer Summary

php-http/guzzle6-adapter is tracked as a networking http record in the PHP branch. The source did
...
For a systems engineer, php-http/guzzle6-adapter belongs in the PHP inventory as part of service
...
- `packagist_search-372aa80071406f` from `packagist_search` as `registry_expansion`
