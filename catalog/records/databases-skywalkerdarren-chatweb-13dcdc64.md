...
<!-- canonical: https://github.com/SkywalkerDarren/chatWeb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SkywalkerDarren/chatWeb](https://github.com/SkywalkerDarren/chatWeb) |
| Source record ids | github_search_databases-cc31678649875a |

## System Engineer Summary

ChatWeb can crawl web pages, read PDF, DOCX, TXT, and extract the main content, then answer your
questions based on the content, or summarize the key points.

## Operational Role

For a systems engineer, SkywalkerDarren/chatWeb belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-25T16:56:25Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_databases-cc31678649875a` from `github_search_databases` as `registry_expansion`
