...
<!-- canonical: https://www.npmjs.com/package/@vue/server-renderer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@vue/server-renderer](https://www.npmjs.com/package/@vue/server-renderer) |
| Source record ids | npm_registry-0b92bc056ee6f8, npm_registry-04d6746ac6229c |

## System Engineer Summary

@vue/server-renderer is tracked as a web framework record in the Node.js/JavaScript branch. The
...
For a systems engineer, @vue/server-renderer belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.5.42 | 2026-08-27T05:48:31.009Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `npm_registry-0b92bc056ee6f8` from `npm_registry` as `registry_expansion`
- `npm_registry-04d6746ac6229c` from `npm_registry` as `registry_expansion`
