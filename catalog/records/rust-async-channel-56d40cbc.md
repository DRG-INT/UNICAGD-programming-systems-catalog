...
<!-- canonical: https://crates.io/crates/async-channel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-channel](https://crates.io/crates/async-channel) |
| Source record ids | crates_io-5caadae34332a6 |
...
For a systems engineer, async-channel belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2025-07-06T07:06:07.101546Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-5caadae34332a6` from `crates_io` as `registry_expansion`
