...
<!-- canonical: https://codeberg.org/explore/repos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://codeberg.org/explore/repos](https://codeberg.org/explore/repos) |
| Source record ids | curated_repository_workplace_routes-ff2bb58901aedc |

## System Engineer Summary

Forgejo-powered public software development workplace for open-source repositories and
organizations.

## Operational Role

For a systems engineer, Codeberg belongs in the Repository Workplaces inventory as part of ecosystem
...
- `curated_repository_workplace_routes-ff2bb58901aedc` from `curated_repository_workplace_routes` as `registry_expansion`
