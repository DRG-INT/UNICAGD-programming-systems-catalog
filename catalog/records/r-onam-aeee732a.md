...
<!-- canonical: https://cran.r-project.org/web/packages/ONAM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ONAM/index.html](https://cran.r-project.org/web/packages/ONAM/index.html) |
| Source record ids | cran_packages_by_date-aef6615484a772 |
...
For a systems engineer, ONAM belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-24 09:20:15 UTC | [https://cran.r-project.org/web/packages/ONAM/DESCRIPTION](https://cran.r-project.org/web/packages/ONAM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ONAM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-aef6615484a772` from `cran_packages_by_date` as `registry_expansion`
