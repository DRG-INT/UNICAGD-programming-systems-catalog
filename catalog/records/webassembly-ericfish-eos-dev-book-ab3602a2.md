...
| Source record ids | github_search_webassembly-beae5bab935126 |

## System Engineer Summary

ericfish/EOS-Dev-Book is tracked as a filesystem os record in the WebAssembly branch. The source did
...
- `github_search_webassembly-beae5bab935126` from `github_search_webassembly` as `registry_expansion`
...
| mbasso/awesome-wasm | Filesystem Os | [open](webassembly-mbasso-awesome-wasm-e5b53bed.md) |
