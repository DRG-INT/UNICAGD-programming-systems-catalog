...
<!-- canonical: https://luarocks.org/modules/neorocks/copilot.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/copilot.lua](https://luarocks.org/modules/neorocks/copilot.lua) |
| Source record ids | luarocks_root_manifest-27d44cb9d5c8c3 |

## System Engineer Summary

Fully featured & enhanced replacement for copilot.vim complete with API for interacting with Github
Copilot

## Operational Role

For a systems engineer, copilot.lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-27d44cb9d5c8c3` from `luarocks_root_manifest` as `registry_expansion`
