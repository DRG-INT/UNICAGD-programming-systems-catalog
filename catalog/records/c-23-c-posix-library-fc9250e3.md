...
<!-- canonical: https://en.wikipedia.org/wiki/C_POSIX_library -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://en.wikipedia.org/wiki/C_POSIX_library](https://en.wikipedia.org/wiki/C_POSIX_library) |
| Source record ids | awesome_list-facd2f102b4a45 |
...
For a systems engineer, C POSIX library belongs in the C++23 inventory as part of ecosystem
...
| Evidence | {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "Standard Libraries", "source_url": "https://raw.githubusercontent.com/fffaraz/awesome-cpp/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-facd2f102b4a45` from `awesome_list` as `registry_expansion`
...
| ISO/IEC 14882:2024 | Language Specification | [open](c-23-iso-iec-14882-2024-7fd5a245.md) |
