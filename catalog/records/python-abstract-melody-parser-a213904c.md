...
<!-- canonical: https://pypi.org/project/abstract-melody-parser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abstract-melody-parser/](https://pypi.org/project/abstract-melody-parser/) |
| Source record ids | pypi_simple-3497f2627d5637 |
...
For a systems engineer, abstract-melody-parser belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2021-05-07T14:30:40.823389Z | [https://pypi.org/pypi/abstract-melody-parser/json](https://pypi.org/pypi/abstract-melody-parser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abstract-melody-parser/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-3497f2627d5637` from `pypi_simple` as `registry_expansion`
