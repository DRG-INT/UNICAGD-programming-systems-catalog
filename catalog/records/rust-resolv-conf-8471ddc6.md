...
<!-- canonical: https://crates.io/crates/resolv-conf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/resolv-conf](https://crates.io/crates/resolv-conf) |
| Source record ids | crates_io-eeed7eac43f6ee |
...
For a systems engineer, resolv-conf belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.6 | 2025-11-18T08:33:47.255263Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-eeed7eac43f6ee` from `crates_io` as `registry_expansion`
