...
<!-- canonical: https://github.com/sidereal-io/sidereal -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sidereal-io/sidereal](https://github.com/sidereal-io/sidereal) |
| Source record ids | github_search_telescopes-4a1f6ef2db348e |

## System Engineer Summary

Sync astrophotography images from Immich, plate solve them with Astrometry.net, and enrich with
searchable celestial metadata.

## Operational Role

For a systems engineer, sidereal-io/sidereal belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T04:17:21Z | gh search repos topic:astrophotography stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-4a1f6ef2db348e` from `github_search_telescopes` as `registry_expansion`
