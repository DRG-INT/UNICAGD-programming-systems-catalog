...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Lint Rule Pack](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/lint-rule-pack.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Lint Rule Pack |
| Source type |  |
| Verification | npm_registry |
| Canonical URL | [https://www.npmjs.com/package/prettier-plugin-firestore-rules](https://www.npmjs.com/package/prettier-plugin-firestore-rules) |
| Source record ids | npm_registry-5f530f2983e3c1 |
...
For a systems engineer, prettier-plugin-firestore-rules belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2020-11-12T07:28:31.666Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Treat category as `lint_rule_pack` unless a later verified source gives a better classification.
...
| Name | Category | Page |
| --- | --- | --- |
| @einride/csp-evaluator-cli | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-einride-csp-evaluator-cli-e2b9843a.md) |
| @firebase/rules-unit-testing | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-firebase-rules-unit-testing-81dde538.md) |
| @muenchen/prettier-codeformat | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-muenchen-prettier-codeformat-4490df10.md) |
| @prisma/cli-security-rules | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-prisma-cli-security-rules-a67d6ecc.md) |
| @prisma/security-rules | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-prisma-security-rules-cb970935.md) |
| @salesforce/sfdx-scanner | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-salesforce-sfdx-scanner-e437f623.md) |
| firestore-security-tests | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-firestore-security-tests-b5496164.md) |
| opt-cli | Lint Rule Pack | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-opt-cli-112fd8c5.md) |
