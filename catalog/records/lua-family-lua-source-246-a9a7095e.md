...
| Source record ids | lua-source-246 |

## System Engineer Summary

lua-source-246 is tracked as a serialization record in the Lua family branch. The source did not
...
For a systems engineer, lua-source-246 belongs in the Lua family inventory as part of wire formats,
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 246}}` |
...
- `lua-source-246` from `master_json` as `source_list_item`
