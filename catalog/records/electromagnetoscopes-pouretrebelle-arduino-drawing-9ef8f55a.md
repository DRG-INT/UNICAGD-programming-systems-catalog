...
<!-- canonical: https://github.com/pouretrebelle/arduino-drawing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pouretrebelle/arduino-drawing](https://github.com/pouretrebelle/arduino-drawing) |
| Source record ids | github_search_electromagnetoscopes-8e59016295df16 |
...
For a systems engineer, pouretrebelle/arduino-drawing belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-14T20:14:03Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-8e59016295df16` from `github_search_electromagnetoscopes` as `registry_expansion`
