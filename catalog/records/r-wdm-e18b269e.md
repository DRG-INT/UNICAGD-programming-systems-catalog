...
<!-- canonical: https://cran.r-project.org/web/packages/wdm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/wdm/index.html](https://cran.r-project.org/web/packages/wdm/index.html) |
| Source record ids | cran_packages_by_date-e0c6c886ae2458 |
...
For a systems engineer, wdm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-31 22:10:02 UTC | [https://cran.r-project.org/web/packages/wdm/DESCRIPTION](https://cran.r-project.org/web/packages/wdm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/wdm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e0c6c886ae2458` from `cran_packages_by_date` as `registry_expansion`
