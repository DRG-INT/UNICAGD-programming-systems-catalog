...
<!-- canonical: https://github.com/fabiocaccamo/FCCurrentLocationGeocoder -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fabiocaccamo/FCCurrentLocationGeocoder](https://github.com/fabiocaccamo/FCCurrentLocationGeocoder) |
| Source record ids | github_search_maps-79064151c2d81a |

## System Engineer Summary

:iphone: :round_pushpin:  iOS geocoder for forward / reverse geocode user's current location using
a block-based syntax.

## Operational Role

For a systems engineer, fabiocaccamo/FCCurrentLocationGeocoder belongs in the Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.11 | 2020-08-05T12:53:20Z | [https://api.github.com/repos/fabiocaccamo/FCCurrentLocationGeocoder/releases/latest](https://api.github.com/repos/fabiocaccamo/FCCurrentLocationGeocoder/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/fabiocaccamo/FCCurrentLocationGeocoder/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-79064151c2d81a` from `github_search_maps` as `registry_expansion`
