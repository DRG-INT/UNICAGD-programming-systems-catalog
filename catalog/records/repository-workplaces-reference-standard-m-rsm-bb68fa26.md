...
[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/Reference-Standard-M/rsm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/Reference-Standard-M/rsm](https://gitlab.com/Reference-Standard-M/rsm) |
| Source record ids | gitlab_projects_api-8bc23c622c86a3 |

## System Engineer Summary

Implementation of ANSI/MDC Standard M X11.1-1995 (ISO/IEC 11756:1999) for Linux, FreeBSD, NetBSD,
OpenBSD, macOS, Solaris, AIX, HP-UX, Windows (in Cygwin and WSL 1 & 2), and Raspberry Pi. This is
the post-relational database.

## Operational Role

For a systems engineer, Reference-Standard-M/rsm belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- |
| gitlab_projects_api | forge-api-derived | 2026-09-04 | `{"kind": "gitlab_projects_api", "query": "database", "retrieved": "2026-09-04", "status": "forge-api-derived"}` |
...
- `gitlab_projects_api-8bc23c622c86a3` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| akkuscm/akku | Language Specification | [open](repository-workplaces-akkuscm-akku-7c79305d.md) |
| basile.b/dexed | Language Specification | [open](repository-workplaces-basile-b-dexed-aa92ba59.md) |
| camelot/kickc | Language Specification | [open](repository-workplaces-camelot-kickc-2feefccb.md) |
| esr/intercal | Language Specification | [open](repository-workplaces-esr-intercal-06f5df57.md) |
| Gitea: afzal/bangladesh-struggle-for-independence | Language Specification | [open](repository-workplaces-gitea-afzal-bangladesh-struggle-for-independence-bc17a5b9.md) |
| Gitea: BenjaminWeisz/Open-Source-Languages | Language Specification | [open](repository-workplaces-gitea-benjaminweisz-open-source-languages-383363ee.md) |
| Gitea: catnipteaparty/empirical-reasoning-language-model | Language Specification | [open](repository-workplaces-gitea-catnipteaparty-empirical-reasoning-language-model-1e621f6a.md) |
| Gitea: dasdas/codebase-memory-mcp | Language Specification | [open](repository-workplaces-gitea-dasdas-codebase-memory-mcp-083ad75c.md) |
