...
<!-- canonical: https://crates.io/crates/windows-threading -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/windows-threading](https://crates.io/crates/windows-threading) |
| Source record ids | crates_io-93d61938288219 |

## System Engineer Summary

windows-threading is tracked as a concurrency parallelism record in the Rust branch. The source did
...
For a systems engineer, windows-threading belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.100.0 | 2026-09-03T16:41:59.294207Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-93d61938288219` from `crates_io` as `registry_expansion`
