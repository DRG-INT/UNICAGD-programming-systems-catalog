...
| Canonical URL | [https://packagist.org/packages/bosnadev/database](https://packagist.org/packages/bosnadev/database) |
| Source record ids | packagist_search-85ad86e1b4ddbb |
...
For a systems engineer, bosnadev/database belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.21.1 | 2021-08-30T05:41:21+00:00 | [https://repo.packagist.org/p2/bosnadev/database.json](https://repo.packagist.org/p2/bosnadev/database.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/bosnadev/database.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-85ad86e1b4ddbb` from `packagist_search` as `registry_expansion`
