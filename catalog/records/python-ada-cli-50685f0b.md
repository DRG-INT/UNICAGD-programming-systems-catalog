...
<!-- canonical: https://pypi.org/project/ada-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ada-cli/](https://pypi.org/project/ada-cli/) |
| Source record ids | pypi_simple-a37c7db9fde964 |

## System Engineer Summary

ada-cli is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, ada-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2022-06-10T18:18:28.736989Z | [https://pypi.org/pypi/ada-cli/json](https://pypi.org/pypi/ada-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ada-cli/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-a37c7db9fde964` from `pypi_simple` as `registry_expansion`
