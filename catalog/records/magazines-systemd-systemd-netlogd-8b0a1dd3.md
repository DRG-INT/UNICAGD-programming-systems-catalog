...
<!-- canonical: https://github.com/systemd/systemd-netlogd -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/systemd/systemd-netlogd](https://github.com/systemd/systemd-netlogd) |
| Source record ids | github_search_magazines-569f960dc7774a |

## System Engineer Summary

Forwards messages from the journal to other hosts over the network using syslog format RFC 5424 and
RFC 3164

## Operational Role

For a systems engineer, systemd/systemd-netlogd belongs in the Magazines inventory as part of low-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-25T15:28:57Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v2.1; https://api.github.com/licenses/lgpl-2.1; MIT License; https://api.github.com/licenses/mit; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_magazines-569f960dc7774a` from `github_search_magazines` as `registry_expansion`
...
| vitogit/sorter | Formatter | [open](magazines-vitogit-sorter-2a724fef.md) |
