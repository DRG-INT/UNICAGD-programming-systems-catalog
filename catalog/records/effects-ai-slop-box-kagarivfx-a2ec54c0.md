...
<!-- canonical: https://github.com/AI-SLOP-BOX/kagarivfx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AI-SLOP-BOX/kagarivfx](https://github.com/AI-SLOP-BOX/kagarivfx) |
| Source record ids | github_search_effects-3833eb13e8bde2 |

## System Engineer Summary

Kagari Studio (篝) — High-Performance Motion Graphics & Visual Effects Compositor in Rust with 32bpc
HDR, GPU Shaders, and egui

## Operational Role

For a systems engineer, AI-SLOP-BOX/kagarivfx belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.1.0 | 2026-08-31T12:16:53Z | [https://api.github.com/repos/AI-SLOP-BOX/kagarivfx/releases/latest](https://api.github.com/repos/AI-SLOP-BOX/kagarivfx/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/AI-SLOP-BOX/kagarivfx/releases/latest` at `2026-09-01T09:23:08+00:00`.
...
- `github_search_effects-3833eb13e8bde2` from `github_search_effects` as `registry_expansion`
