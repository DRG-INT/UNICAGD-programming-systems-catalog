...
<!-- canonical: https://pypi.org/project/adblockparser/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/adblockparser/](https://pypi.org/project/adblockparser/) |
| Source record ids | pypi_simple-5843508b7f29fe |
...
For a systems engineer, adblockparser belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7 | 2016-10-17T08:34:17.574269Z | [https://pypi.org/pypi/adblockparser/json](https://pypi.org/pypi/adblockparser/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/adblockparser/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-5843508b7f29fe` from `pypi_simple` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| 2nd-opinion-cli | Lint Rule Pack | [open](python-2nd-opinion-cli-35bd7fe4.md) |
