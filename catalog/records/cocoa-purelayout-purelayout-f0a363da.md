...
<!-- canonical: https://github.com/PureLayout/PureLayout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/PureLayout/PureLayout](https://github.com/PureLayout/PureLayout) |
| Source record ids | github_search_cocoa-4e0f834d7bf281 |

## System Engineer Summary

The ultimate API for iOS & OS X Auto Layout — impressively simple, immensely powerful. Objective-C
and Swift compatible.

## Operational Role

For a systems engineer, PureLayout/PureLayout belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-16T21:45:11Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-4e0f834d7bf281` from `github_search_cocoa` as `registry_expansion`
