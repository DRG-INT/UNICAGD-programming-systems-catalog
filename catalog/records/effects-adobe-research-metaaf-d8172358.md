...
| Source record ids | github_search_effects-259491dc718bdf |
...
For a systems engineer, adobe-research/MetaAF belongs in the Effects inventory as part of service
...
- `github_search_effects-259491dc718bdf` from `github_search_effects` as `registry_expansion`
