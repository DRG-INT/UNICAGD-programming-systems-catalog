...
<!-- canonical: https://github.com/Teddy-van-Jerry/ngspice-cmos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Teddy-van-Jerry/ngspice-cmos](https://github.com/Teddy-van-Jerry/ngspice-cmos) |
| Source record ids | github_search_space_maps-796d41a28c1cd7 |
...
For a systems engineer, Teddy-van-Jerry/ngspice-cmos belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-06-06T15:32:11Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-796d41a28c1cd7` from `github_search_space_maps` as `registry_expansion`
