...
<!-- canonical: https://github.com/hendurhance/ui-ux -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hendurhance/ui-ux](https://github.com/hendurhance/ui-ux) |
| Source record ids | github_search_icons_and_logos-90fa2223171229 |

## System Engineer Summary

📚 This guide is designed to help you learn UI/UX design, and is divided into three levels: Beginner,
Intermediate, and Expert. It includes learning resource, guides and tools that cover all aspects of
designing user interfaces and user experiences.

## Operational Role

For a systems engineer, hendurhance/ui-ux belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-14T00:18:35Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT + file LICENSE; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- `github_search_icons_and_logos-90fa2223171229` from `github_search_icons_and_logos` as `registry_expansion`
