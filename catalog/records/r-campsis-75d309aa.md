...
<!-- canonical: https://cran.r-project.org/web/packages/campsis/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/campsis/index.html](https://cran.r-project.org/web/packages/campsis/index.html) |
| Source record ids | cran_packages_by_date-ee2d07e5d88563 |
...
For a systems engineer, campsis belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-08-05 07:50:02 UTC | [https://cran.r-project.org/web/packages/campsis/DESCRIPTION](https://cran.r-project.org/web/packages/campsis/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/campsis/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ee2d07e5d88563` from `cran_packages_by_date` as `registry_expansion`
