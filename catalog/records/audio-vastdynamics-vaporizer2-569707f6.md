...
<!-- canonical: https://github.com/VASTDynamics/Vaporizer2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VASTDynamics/Vaporizer2](https://github.com/VASTDynamics/Vaporizer2) |
| Source record ids | github_search_audio-d62c571bf5b69c |

## System Engineer Summary

Vaporizer2 hybrid wavetable additive / subtractive VST / AU / AAX synthesizer / sampler workstation
plugin

## Operational Role

For a systems engineer, VASTDynamics/Vaporizer2 belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.5.0 | 2024-03-02T09:54:25Z | [https://api.github.com/repos/VASTDynamics/Vaporizer2/releases/latest](https://api.github.com/repos/VASTDynamics/Vaporizer2/releases/latest) |  |
| preview | known | v3.4.8 | 2024-02-10T16:50:38Z | [https://api.github.com/repos/VASTDynamics/Vaporizer2/releases?per_page=10](https://api.github.com/repos/VASTDynamics/Vaporizer2/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/VASTDynamics/Vaporizer2/releases/latest` at `2026-09-01T11:21:43+00:00`.
...
- `github_search_audio-d62c571bf5b69c` from `github_search_audio` as `registry_expansion`
