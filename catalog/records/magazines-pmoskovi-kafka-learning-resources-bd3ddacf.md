# pmoskovi/kafka-learning-resources
...
<!-- canonical: https://github.com/pmoskovi/kafka-learning-resources -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pmoskovi/kafka-learning-resources](https://github.com/pmoskovi/kafka-learning-resources) |
| Source record ids | github_search_magazines-6f2b7de7fb1424 |
...
For a systems engineer, pmoskovi/kafka-learning-resources belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-28T23:33:26Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-6f2b7de7fb1424` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| evolution-gaming/kafka-journal | Message Broker | [open](magazines-evolution-gaming-kafka-journal-8b39d62d.md) |
