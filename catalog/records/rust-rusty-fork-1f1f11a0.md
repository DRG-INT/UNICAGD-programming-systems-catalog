...
<!-- canonical: https://crates.io/crates/rusty-fork -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rusty-fork](https://crates.io/crates/rusty-fork) |
| Source record ids | crates_io-d41603e500afbe |
...
For a systems engineer, rusty-fork belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2025-10-04T22:48:23.194025Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-d41603e500afbe` from `crates_io` as `registry_expansion`
