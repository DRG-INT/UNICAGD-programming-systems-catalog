...
<!-- canonical: https://github.com/mbloch/mapshaper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mbloch/mapshaper](https://github.com/mbloch/mapshaper) |
| Source record ids | github_search_maps-158703d6dceb10 |
...
For a systems engineer, mbloch/mapshaper belongs in the Maps inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T18:53:15Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | (Apache-2.0 OR MIT); Other |
...
- `github_search_maps-158703d6dceb10` from `github_search_maps` as `registry_expansion`
