...
<!-- canonical: https://github.com/goharbor/harbor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/goharbor/harbor](https://github.com/goharbor/harbor) |
| Source record ids | github_search_go-d7850838d0b7b2 |
...
For a systems engineer, goharbor/harbor belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T09:23:23Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-d7850838d0b7b2` from `github_search_go` as `registry_expansion`
