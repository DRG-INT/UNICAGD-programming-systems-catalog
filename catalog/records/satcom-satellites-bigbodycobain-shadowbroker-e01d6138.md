...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/BigBodyCobain/Shadowbroker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/BigBodyCobain/Shadowbroker](https://github.com/BigBodyCobain/Shadowbroker) |
| Source record ids | github_search_satcom_satellites-50a1180c408f70 |

## System Engineer Summary

Open-source intelligence for the global theater. Track everything from the corporate/private jets of
the wealthy, and spy satellites, to seismic events in one unified interface. Hook an AI agent up to
have it parse through data and find previously unseen correlations. The knowledge is available to
all but rarely aggregated in the open, until now.

## Operational Role

For a systems engineer, BigBodyCobain/Shadowbroker belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T13:47:39Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-50a1180c408f70` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| doersino/google-maps-at-88-mph | Machine Learning | [open](satcom-satellites-doersino-google-maps-at-88-mph-7a0794db.md) |
| Flowm/satvis | Machine Learning | [open](satcom-satellites-flowm-satvis-63649809.md) |
| maia-sdr/maia-sdr | Machine Learning | [open](satcom-satellites-maia-sdr-maia-sdr-69bb3f0a.md) |
| Soul-AILab/SoulX-Transcriber | Machine Learning | [open](satcom-satellites-soul-ailab-soulx-transcriber-80b73c2b.md) |
| SysSec-KAIST/LTESniffer | Machine Learning | [open](satcom-satellites-syssec-kaist-ltesniffer-4e2fb4dd.md) |
| thkruz/SignalRange | Machine Learning | [open](satcom-satellites-thkruz-signalrange-37edb7c7.md) |
