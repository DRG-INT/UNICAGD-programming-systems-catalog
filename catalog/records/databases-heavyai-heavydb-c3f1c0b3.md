...
<!-- canonical: https://github.com/heavyai/heavydb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/heavyai/heavydb](https://github.com/heavyai/heavydb) |
| Source record ids | github_search_databases-96f7b8705a9e5d |
...
For a systems engineer, heavyai/heavydb belongs in the Databases inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T00:10:33Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-96f7b8705a9e5d` from `github_search_databases` as `registry_expansion`
