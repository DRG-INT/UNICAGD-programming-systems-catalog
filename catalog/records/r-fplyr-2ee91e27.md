...
<!-- canonical: https://cran.r-project.org/web/packages/fplyr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fplyr/index.html](https://cran.r-project.org/web/packages/fplyr/index.html) |
| Source record ids | cran_packages_by_date-c83c805b077a56 |
...
For a systems engineer, fplyr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-09-08 09:30:10 UTC | [https://cran.r-project.org/web/packages/fplyr/DESCRIPTION](https://cran.r-project.org/web/packages/fplyr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fplyr/DESCRIPTION` at `2026-09-08T10:21:44+00:00`.
...
- `cran_packages_by_date-c83c805b077a56` from `cran_packages_by_date` as `registry_expansion`
