...
<!-- canonical: https://luarocks.org/modules/smi11/eansi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/smi11/eansi](https://luarocks.org/modules/smi11/eansi) |
| Source record ids | luarocks_root_manifest-43eea52bc73aed |

## System Engineer Summary

eansi is tracked as a build system record in the Lua family branch. The source did not provide a
...
For a systems engineer, eansi belongs in the Lua family inventory as part of build graph control,
...
- `luarocks_root_manifest-43eea52bc73aed` from `luarocks_root_manifest` as `registry_expansion`
