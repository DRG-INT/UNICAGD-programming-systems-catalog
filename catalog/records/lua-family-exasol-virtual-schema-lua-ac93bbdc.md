...
| Canonical URL | [https://luarocks.org/modules/exasol/exasol-virtual-schema-lua](https://luarocks.org/modules/exasol/exasol-virtual-schema-lua) |
| Source record ids | luarocks_root_manifest-37b5d52a628403 |

## System Engineer Summary

Lua-based Virtual Schema for Exasol databases

## Operational Role

For a systems engineer, exasol-virtual-schema-lua belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-37b5d52a628403` from `luarocks_root_manifest` as `registry_expansion`
