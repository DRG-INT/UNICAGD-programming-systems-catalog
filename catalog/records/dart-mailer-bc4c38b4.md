...
<!-- canonical: https://pub.dev/packages/mailer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mailer](https://pub.dev/packages/mailer) |
| Source record ids | pub_dev-bc3572bd0cc64b |
...
For a systems engineer, mailer belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0 | 2026-07-21T07:21:47.227015Z | [https://pub.dev/api/packages/mailer](https://pub.dev/api/packages/mailer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mailer` at `2026-09-01T15:36:00+00:00`.
...
- `pub_dev-bc3572bd0cc64b` from `pub_dev` as `registry_expansion`
