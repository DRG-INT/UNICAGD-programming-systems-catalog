...
<!-- canonical: https://github.com/TomSchimansky/TkinterMapView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TomSchimansky/TkinterMapView](https://github.com/TomSchimansky/TkinterMapView) |
| Source record ids | github_search_maps-437d757dfb6fb7 |
...
For a systems engineer, TomSchimansky/TkinterMapView belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-28T12:22:26Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-437d757dfb6fb7` from `github_search_maps` as `registry_expansion`
