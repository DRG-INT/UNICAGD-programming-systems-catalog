...
<!-- canonical: https://cran.r-project.org/web/packages/Rborist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rborist/index.html](https://cran.r-project.org/web/packages/Rborist/index.html) |
| Source record ids | cran_packages_by_date-8be77b9eb919f3 |
...
For a systems engineer, Rborist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3-12 | 2026-09-07 07:00:10 UTC | [https://cran.r-project.org/web/packages/Rborist/DESCRIPTION](https://cran.r-project.org/web/packages/Rborist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rborist/DESCRIPTION` at `2026-09-07T08:22:33+00:00`.
...
- `cran_packages_by_date-8be77b9eb919f3` from `cran_packages_by_date` as `registry_expansion`
