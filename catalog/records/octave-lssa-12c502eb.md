...
<!-- canonical: https://gnu-octave.github.io/packages/lssa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/lssa](https://gnu-octave.github.io/packages/lssa) |
| Source record ids | octave_packages_index-396dd8c17b7101 |

## System Engineer Summary

Tools to compute spectral decompositions of irregularly-spaced time series. Functions based on the
Lomb-Scargle periodogram and Adolf Mathias' implementation for R and C.

## Operational Role

For a systems engineer, lssa belongs in the Octave inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2020-10-18 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-396dd8c17b7101` from `octave_packages_index` as `registry_expansion`
