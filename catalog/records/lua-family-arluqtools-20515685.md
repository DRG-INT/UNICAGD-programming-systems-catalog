...
<!-- canonical: https://luarocks.org/modules/zt-freak/arluqtools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/zt-freak/arluqtools](https://luarocks.org/modules/zt-freak/arluqtools) |
| Source record ids | luarocks_root_manifest-56626b892d4ab8 |

## System Engineer Summary

Abstraction layer for Zoo Tycoon 2's Lua libraries

## Operational Role

For a systems engineer, ArluqTools belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-56626b892d4ab8` from `luarocks_root_manifest` as `registry_expansion`
