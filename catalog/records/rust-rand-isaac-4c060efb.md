...
<!-- canonical: https://crates.io/crates/rand_isaac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rand_isaac](https://crates.io/crates/rand_isaac) |
| Source record ids | crates_io-50a0f5797f6e78 |
...
For a systems engineer, rand_isaac belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2026-05-20T06:34:28.098743Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads` at `2026-09-16T06:26:07+00:00`.
...
- `crates_io-50a0f5797f6e78` from `crates_io` as `registry_expansion`
