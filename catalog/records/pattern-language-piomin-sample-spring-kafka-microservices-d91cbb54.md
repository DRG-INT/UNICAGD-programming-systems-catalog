...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Message Broker](../by-category/message-broker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/piomin/sample-spring-kafka-microservices -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/piomin/sample-spring-kafka-microservices](https://github.com/piomin/sample-spring-kafka-microservices) |
| Source record ids | github_search_pattern_language-977e05c4aef172 |

## System Engineer Summary

Example microservices showing how to use Kafka and Kafka Streams with Spring Boot on the example of
distributed transactions implementations with the SAGA pattern

## Operational Role

For a systems engineer, piomin/sample-spring-kafka-microservices belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T12:07:41Z | gh search repos microservices patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-977e05c4aef172` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| uuhnaut69/saga-pattern-microservices | Message Broker | [open](pattern-language-uuhnaut69-saga-pattern-microservices-96c7cae5.md) |
