...
| Source record ids | curated_language_routes-c4ea84921b56af |

## System Engineer Summary

SVG icon library for Bootstrap and general interface projects.

## Operational Role

For a systems engineer, Bootstrap Icons belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.13.1 | 2025-05-09T23:03:26Z | [https://api.github.com/repos/twbs/icons/releases/latest](https://api.github.com/repos/twbs/icons/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/twbs/icons/releases/latest` at `2026-09-01T12:30:34+00:00`.
...
- `curated_language_routes-c4ea84921b56af` from `curated_language_routes` as `registry_expansion`
