...
<!-- canonical: https://github.com/tatut/specql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tatut/specql](https://github.com/tatut/specql) |
| Source record ids | github_search_databases-e75a69eb8a6dcb |
...
For a systems engineer, tatut/specql belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-20T10:19:35Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e75a69eb8a6dcb` from `github_search_databases` as `registry_expansion`
