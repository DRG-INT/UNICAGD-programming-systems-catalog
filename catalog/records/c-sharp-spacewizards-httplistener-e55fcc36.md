...
<!-- canonical: https://www.nuget.org/packages/SpaceWizards.HttpListener -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/SpaceWizards.HttpListener](https://www.nuget.org/packages/SpaceWizards.HttpListener) |
| Source record ids | nuget_search-08a0571b75ecd1 |
...
For a systems engineer, SpaceWizards.HttpListener belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2024-07-14T16:31:10.86+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/spacewizards.httplistener/index.json](https://api.nuget.org/v3/registration5-gz-semver2/spacewizards.httplistener/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/SpaceWizards.HttpListener/0.2.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/spacewizards.httplistener/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-08a0571b75ecd1` from `nuget_search` as `registry_expansion`
