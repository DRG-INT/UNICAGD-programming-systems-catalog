...
<!-- canonical: https://pub.dev/packages/flutter_expandable_fab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_expandable_fab](https://pub.dev/packages/flutter_expandable_fab) |
| Source record ids | pub_dev-38130a83b27e99 |

## System Engineer Summary

The speed dial FAB (Floating Action Button) that can animate the display and hiding of multiple
action buttons.

## Operational Role

For a systems engineer, flutter_expandable_fab belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-25T00:03:17.460251Z | [https://pub.dev/api/packages/flutter_expandable_fab](https://pub.dev/api/packages/flutter_expandable_fab) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_expandable_fab` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-38130a83b27e99` from `pub_dev` as `registry_expansion`
