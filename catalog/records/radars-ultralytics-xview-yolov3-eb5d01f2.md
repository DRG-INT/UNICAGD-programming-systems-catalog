...
<!-- canonical: https://github.com/ultralytics/xview-yolov3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ultralytics/xview-yolov3](https://github.com/ultralytics/xview-yolov3) |
| Source record ids | github_search_radars-1d255726946639 |

## System Engineer Summary

YOLOv3 training, preprocessing, validation, and inference for object detection in xView satellite
imagery and the xView detection challenge.

## Operational Role

For a systems engineer, ultralytics/xview-yolov3 belongs in the Radars inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-28T10:56:50Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-1d255726946639` from `github_search_radars` as `registry_expansion`
