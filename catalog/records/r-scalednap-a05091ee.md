...
<!-- canonical: https://cran.r-project.org/web/packages/scalednap/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/scalednap/index.html](https://cran.r-project.org/web/packages/scalednap/index.html) |
| Source record ids | cran_packages_by_date-bafb74202cc10e |

## System Engineer Summary

Community Detection by Scaled Null-Adjusted Persistence

## Operational Role

For a systems engineer, scalednap belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-02 22:10:02 UTC | [https://cran.r-project.org/web/packages/scalednap/DESCRIPTION](https://cran.r-project.org/web/packages/scalednap/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/scalednap/DESCRIPTION` at `2026-09-02T22:19:13+00:00`.
...
- `cran_packages_by_date-bafb74202cc10e` from `cran_packages_by_date` as `registry_expansion`
...
| mrangr | Community Reference | [open](r-mrangr-c53ef604.md) |
