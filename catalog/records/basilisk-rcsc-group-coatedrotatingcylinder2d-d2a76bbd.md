# rcsc-group/CoatedRotatingCylinder2D

## Navigation

[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rcsc-group/CoatedRotatingCylinder2D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rcsc-group/CoatedRotatingCylinder2D](https://github.com/rcsc-group/CoatedRotatingCylinder2D) |
| Source record ids | github_search_basilisk-b54570b2baf7bf |

## System Engineer Summary

Open-source software repository (based on Basilisk C) for the simulation of liquid film flow
dynamics around rotating cylinders, supporting collaborative work with Dr. Alex Wray at the
University of Strathclyde. Complements the open access publication available at

## Operational Role

For a systems engineer, rcsc-group/CoatedRotatingCylinder2D belongs in the Basilisk inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-07T09:33:25Z | gh search repos basilisk c simulation | gh_search_reports_activity_not_release_version |
...
- `github_search_basilisk-b54570b2baf7bf` from `github_search_basilisk` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Satchit4/Basilisk | Undefined Behavior Analyzer | [open](basilisk-satchit4-basilisk-20046cf3.md) |
