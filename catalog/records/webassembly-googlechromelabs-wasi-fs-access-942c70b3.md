...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/GoogleChromeLabs/wasi-fs-access -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GoogleChromeLabs/wasi-fs-access](https://github.com/GoogleChromeLabs/wasi-fs-access) |
| Source record ids | github_search_webassembly-d3522564388958 |
...
For a systems engineer, GoogleChromeLabs/wasi-fs-access belongs in the WebAssembly inventory as part
of concurrency scheduling, I/O throughput, cancellation, and latency management.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T00:15:58Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-d3522564388958` from `github_search_webassembly` as `registry_expansion`
