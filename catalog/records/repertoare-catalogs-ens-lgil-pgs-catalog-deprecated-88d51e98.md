# ens-lgil/PGS_Catalog_deprecated
...
<!-- canonical: https://github.com/ens-lgil/PGS_Catalog_deprecated -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ens-lgil/PGS_Catalog_deprecated](https://github.com/ens-lgil/PGS_Catalog_deprecated) |
| Source record ids | github_search_repertoare_catalogs-b79f477142cd4b |
...
For a systems engineer, ens-lgil/PGS_Catalog_deprecated belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-18T16:51:23Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-b79f477142cd4b` from `github_search_repertoare_catalogs` as `registry_expansion`
