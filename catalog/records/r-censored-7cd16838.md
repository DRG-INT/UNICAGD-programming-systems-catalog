...
<!-- canonical: https://cran.r-project.org/web/packages/censored/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/censored/index.html](https://cran.r-project.org/web/packages/censored/index.html) |
| Source record ids | cran_packages_by_date-c962b4ef0214bc |
...
For a systems engineer, censored belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.5 | 2026-09-08 05:20:33 UTC | [https://cran.r-project.org/web/packages/censored/DESCRIPTION](https://cran.r-project.org/web/packages/censored/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/censored/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-c962b4ef0214bc` from `cran_packages_by_date` as `registry_expansion`
