...
| Canonical URL | [https://luarocks.org/modules/jogiwithjosh/kong-auth-request-trans](https://luarocks.org/modules/jogiwithjosh/kong-auth-request-trans) |
| Source record ids | luarocks_root_manifest-3ea1410b3bf9e5 |
...
For a systems engineer, kong-auth-request-trans belongs in the Lua family inventory as part of build
...
- `luarocks_root_manifest-3ea1410b3bf9e5` from `luarocks_root_manifest` as `registry_expansion`
