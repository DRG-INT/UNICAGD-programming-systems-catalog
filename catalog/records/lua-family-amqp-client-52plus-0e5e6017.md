...
<!-- canonical: https://luarocks.org/modules/koonix/amqp-client-52plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/koonix/amqp-client-52plus](https://luarocks.org/modules/koonix/amqp-client-52plus) |
| Source record ids | luarocks_root_manifest-a131454f1451d6 |

## System Engineer Summary

amqp-client + dependencies for Lua 5.2+

## Operational Role

For a systems engineer, amqp-client-52plus belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-a131454f1451d6` from `luarocks_root_manifest` as `registry_expansion`
...
| debugkit-extra | Dependency Manager | [open](lua-family-debugkit-extra-8386bd36.md) |
