...
<!-- canonical: https://github.com/iconoir-icons/iconoir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iconoir-icons/iconoir](https://github.com/iconoir-icons/iconoir) |
| Source record ids | github_search_icons_and_logos-7fc0ec54b811e0 |

## System Engineer Summary

An open source icons library with 1600+ icons, supporting React, React Native, Flutter, Vue, Figma,
and Framer.

## Operational Role

For a systems engineer, iconoir-icons/iconoir belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T04:18:42Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-7fc0ec54b811e0` from `github_search_icons_and_logos` as `registry_expansion`
