...
<!-- canonical: https://github.com/software-mansion/TypeGPU -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/software-mansion/TypeGPU](https://github.com/software-mansion/TypeGPU) |
| Source record ids | github_search_computer_graphics_software-7bf5c6045d7ded |

## System Engineer Summary

A modular and open-ended toolkit for WebGPU, with advanced type inference and the ability to write
shaders in TypeScript

## Operational Role

For a systems engineer, software-mansion/TypeGPU belongs in the Computer Graphics Software inventory
...
- `github_search_computer_graphics_software-7bf5c6045d7ded` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| galacean/engine | Type Checker | [open](computer-graphics-software-galacean-engine-1d8da374.md) |
