...
| Source record ids | corpus-5417dd149b6867 |

## System Engineer Summary

Tortoise ORM is tracked as a database datastore record in the Python branch. The source did not
...
For a systems engineer, Tortoise ORM belongs in the Python inventory as part of state persistence,
...
- `corpus-5417dd149b6867` from `master_json` as `database_datastore`
