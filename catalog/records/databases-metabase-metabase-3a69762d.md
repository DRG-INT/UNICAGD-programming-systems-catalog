...
<!-- canonical: https://github.com/metabase/metabase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/metabase/metabase](https://github.com/metabase/metabase) |
| Source record ids | github_search_databases-428577520fbd9e |

## System Engineer Summary

The easy-to-use open source Business Intelligence and Embedded Analytics tool that lets everyone
work with data :bar_chart:

## Operational Role

For a systems engineer, metabase/metabase belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T23:01:38Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-428577520fbd9e` from `github_search_databases` as `registry_expansion`
