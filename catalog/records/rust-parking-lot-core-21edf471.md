...
<!-- canonical: https://crates.io/crates/parking_lot_core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/parking_lot_core](https://crates.io/crates/parking_lot_core) |
| Source record ids | crates_io-f817b74c58e9a3 |
...
For a systems engineer, parking_lot_core belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.12 | 2025-10-03T23:33:43.164426Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-f817b74c58e9a3` from `crates_io` as `registry_expansion`
