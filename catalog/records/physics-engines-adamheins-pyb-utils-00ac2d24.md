...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Filesystem Os](../by-category/filesystem-os.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/adamheins/pyb_utils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/adamheins/pyb_utils](https://github.com/adamheins/pyb_utils) |
| Source record ids | github_search_physics_engines-aa5dc19f1070d4 |

## System Engineer Summary

Utilities for PyBullet, including collision detection, ghost (i.e. visual-only) objects, cameras,
and more.

## Operational Role

For a systems engineer, adamheins/pyb_utils belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T16:09:53Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:collision-detection stars:>20", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_physics_engines-aa5dc19f1070d4` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| andreipitis/FluidDynamicsMetal | Filesystem Os | [open](physics-engines-andreipitis-fluiddynamicsmetal-5a770a48.md) |
| avoroshilov/physics_playground | Filesystem Os | [open](physics-engines-avoroshilov-physics-playground-a0acc6b7.md) |
| cfddose/Splash | Filesystem Os | [open](physics-engines-cfddose-splash-d8bd64ef.md) |
| gazebosim/gz-physics | Filesystem Os | [open](physics-engines-gazebosim-gz-physics-2675e8d2.md) |
| gbionics/human-dynamics-estimation | Filesystem Os | [open](physics-engines-gbionics-human-dynamics-estimation-41f151d9.md) |
| InteractiveComputerGraphics/PositionBasedDynamics | Filesystem Os | [open](physics-engines-interactivecomputergraphics-positionbaseddynamics-275553da.md) |
| jdeokkim/ferox | Filesystem Os | [open](physics-engines-jdeokkim-ferox-55c8bbdc.md) |
| jinleili/simuverse | Filesystem Os | [open](physics-engines-jinleili-simuverse-55af6294.md) |
