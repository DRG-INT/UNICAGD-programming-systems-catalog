...
<!-- canonical: https://github.com/cgrindel/rules_swift_package_manager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cgrindel/rules_swift_package_manager](https://github.com/cgrindel/rules_swift_package_manager) |
| Source record ids | github_search_starlark-954065fd5733c6 |

## System Engineer Summary

Collection of utilities and Bazel rules to aid in the development and maintenance of Swift
repositories using Bazel.

## Operational Role

For a systems engineer, cgrindel/rules_swift_package_manager belongs in the Starlark inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T18:29:54Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-954065fd5733c6` from `github_search_starlark` as `registry_expansion`
