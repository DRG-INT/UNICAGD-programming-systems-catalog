...
<!-- canonical: https://github.com/Angelmmiguel/svgi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Angelmmiguel/svgi](https://github.com/Angelmmiguel/svgi) |
| Source record ids | github_search_icons_and_logos-a201e46f68feae |
...
For a systems engineer, Angelmmiguel/svgi belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-09T15:51:48Z | gh search repos topic:svg-icons stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-a201e46f68feae` from `github_search_icons_and_logos` as `registry_expansion`
