...
| Canonical URL | [https://packagist.org/packages/flagception/database-activator](https://packagist.org/packages/flagception/database-activator) |
| Source record ids | packagist_search-9703ca6cdee632 |
...
For a systems engineer, flagception/database-activator belongs in the PHP inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-02-27T13:33:22+00:00 | [https://repo.packagist.org/p2/flagception/database-activator.json](https://repo.packagist.org/p2/flagception/database-activator.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/flagception/database-activator.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-9703ca6cdee632` from `packagist_search` as `registry_expansion`
