...
<!-- canonical: https://cran.r-project.org/web/packages/STATassist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/STATassist/index.html](https://cran.r-project.org/web/packages/STATassist/index.html) |
| Source record ids | cran_packages_by_date-285324a4a34cdb |
...
For a systems engineer, STATassist belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-05 12:50:02 UTC | [https://cran.r-project.org/web/packages/STATassist/DESCRIPTION](https://cran.r-project.org/web/packages/STATassist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/STATassist/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-285324a4a34cdb` from `cran_packages_by_date` as `registry_expansion`
