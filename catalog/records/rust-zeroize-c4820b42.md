...
<!-- canonical: https://crates.io/crates/zeroize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/zeroize](https://crates.io/crates/zeroize) |
| Source record ids | crates_io-1c6c1e8625db32 |

## System Engineer Summary

Securely clear secrets from memory with a simple trait built on stable Rust primitives which
guarantee memory is zeroed using an operation will not be 'optimized away' by the compiler. Uses a
portable pure Rust implementation that works everywhere, even WASM!

## Operational Role

For a systems engineer, zeroize belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-06-12T18:42:35.275395Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-1c6c1e8625db32` from `crates_io` as `registry_expansion`
