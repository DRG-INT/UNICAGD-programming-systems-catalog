...
| Source record ids | github_search_databases-745174a9e9c06d |

## System Engineer Summary

neo4j/neo4j is tracked as a database datastore record in the Databases branch. The source did not
...
For a systems engineer, neo4j/neo4j belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T16:47:42Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-745174a9e9c06d` from `github_search_databases` as `registry_expansion`
