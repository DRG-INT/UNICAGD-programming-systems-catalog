...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/VoltAgent/awesome-design-md -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) |
| Source record ids | github_search_icons_and_logos-99bcf2a325ca57 |

## System Engineer Summary

A collection of DESIGN.md files analysis by popular brand design systems. Drop one into your project
and let coding agents generate a matching UI.

## Operational Role

For a systems engineer, VoltAgent/awesome-design-md belongs in the Icons and Logos inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T12:32:42Z | gh search repos topic:design-system stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-99bcf2a325ca57` from `github_search_icons_and_logos` as `registry_expansion`
