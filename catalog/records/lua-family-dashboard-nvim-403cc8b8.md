...
<!-- canonical: https://luarocks.org/modules/neorocks/dashboard-nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/neorocks/dashboard-nvim](https://luarocks.org/modules/neorocks/dashboard-nvim) |
| Source record ids | luarocks_root_manifest-3fd76d7ec27662 |

## System Engineer Summary

dashboard-nvim is tracked as an ide editor integration record in the Lua family branch. The source
...
For a systems engineer, dashboard-nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-3fd76d7ec27662` from `luarocks_root_manifest` as `registry_expansion`
