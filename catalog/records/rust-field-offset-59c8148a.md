...
| Canonical URL | [https://crates.io/crates/field-offset](https://crates.io/crates/field-offset) |
| Source record ids | crates_io-cc3234ae898066 |
...
For a systems engineer, field-offset belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.6 | 2023-06-02T12:38:31.935599Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-cc3234ae898066` from `crates_io` as `registry_expansion`
