...
<!-- canonical: https://github.com/frectonz/sql-studio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/frectonz/sql-studio](https://github.com/frectonz/sql-studio) |
| Source record ids | github_search_databases-db7efc9ed8eb0b |
...
For a systems engineer, frectonz/sql-studio belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-26T14:32:48Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-db7efc9ed8eb0b` from `github_search_databases` as `registry_expansion`
