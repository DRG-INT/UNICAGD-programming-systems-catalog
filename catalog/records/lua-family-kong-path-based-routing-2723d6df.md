...
| Canonical URL | [https://luarocks.org/modules/optum-ross/kong-path-based-routing](https://luarocks.org/modules/optum-ross/kong-path-based-routing) |
| Source record ids | luarocks_root_manifest-9ecb1f3bfad241 |
...
For a systems engineer, kong-path-based-routing belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-9ecb1f3bfad241` from `luarocks_root_manifest` as `registry_expansion`
