# proxygo/catalogo-de-filmes-star-wars
...
<!-- canonical: https://github.com/proxygo/catalogo-de-filmes-star-wars -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/proxygo/catalogo-de-filmes-star-wars](https://github.com/proxygo/catalogo-de-filmes-star-wars) |
| Source record ids | github_search_space_maps-f2062c47f9da46 |

## System Engineer Summary

Catalogo de Filmes do Star Wars, usando apenas HTML e CSS

## Operational Role

For a systems engineer, proxygo/catalogo-de-filmes-star-wars belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-12T19:15:06Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-f2062c47f9da46` from `github_search_space_maps` as `registry_expansion`
