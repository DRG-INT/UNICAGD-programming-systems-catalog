...
| Canonical URL | [https://crates.io/crates/xdg-home](https://crates.io/crates/xdg-home) |
| Source record ids | crates_io-66df0a4ec147cf |
...
For a systems engineer, xdg-home belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2024-08-09T16:07:03.131017Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-66df0a4ec147cf` from `crates_io` as `registry_expansion`
