...
<!-- canonical: https://luarocks.org/modules/lengbing/cbuf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lengbing/cbuf](https://luarocks.org/modules/lengbing/cbuf) |
| Source record ids | luarocks_root_manifest-0b6a24d3c7b222 |

## System Engineer Summary

cbuf is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cbuf belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-0b6a24d3c7b222` from `luarocks_root_manifest` as `registry_expansion`
