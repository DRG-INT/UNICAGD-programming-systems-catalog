...
<!-- canonical: https://github.com/pmndrs/postprocessing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pmndrs/postprocessing](https://github.com/pmndrs/postprocessing) |
| Source record ids | github_search_photography-9f0a6f823d7a25 |
...
For a systems engineer, pmndrs/postprocessing belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-09T22:53:47Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; zlib License; https://api.github.com/licenses/zlib |
...
- `github_search_photography-9f0a6f823d7a25` from `github_search_photography` as `registry_expansion`
