...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3/index.html](https://cran.r-project.org/web/packages/mlr3/index.html) |
| Source record ids | cran_packages_by_date-b7eeead99d3aa5 |
...
For a systems engineer, mlr3 belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-08-21 14:40:02 UTC | [https://cran.r-project.org/web/packages/mlr3/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b7eeead99d3aa5` from `cran_packages_by_date` as `registry_expansion`
