...
| Canonical URL | [https://crates.io/crates/path-clean](https://crates.io/crates/path-clean) |
| Source record ids | crates_io-80294a520ea9c8 |
...
For a systems engineer, path-clean belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2023-02-24T03:24:24.388366Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-80294a520ea9c8` from `crates_io` as `registry_expansion`
