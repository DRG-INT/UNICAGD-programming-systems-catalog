...
<!-- canonical: https://github.com/Bebe-dev/starwars-catalogue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Bebe-dev/starwars-catalogue](https://github.com/Bebe-dev/starwars-catalogue) |
| Source record ids | github_search_space_maps-1b0d09737868bc |

## System Engineer Summary

Bebe-dev/starwars-catalogue is tracked as a logging observability record in the Space Maps branch.
The source did not provide a long description, so this page keeps the identity, release state,
provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, Bebe-dev/starwars-catalogue belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-20T09:39:52Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-1b0d09737868bc` from `github_search_space_maps` as `registry_expansion`
