...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Colocalization](https://github.com/JuliaRegistries/General/tree/master/C/Colocalization) |
| Source record ids | julia_general-529594962ed5d4 |

## System Engineer Summary

Julia package registered in General at C/Colocalization.

## Operational Role

For a systems engineer, Colocalization belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Colocalization", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-529594962ed5d4` from `julia_general` as `registry_expansion`
