...
| Canonical URL | [https://github.com/hpgem/nanomesh](https://github.com/hpgem/nanomesh) |
| Source record ids | github_search_microscopy-32c4bfdda1001f |
...
For a systems engineer, hpgem/nanomesh belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.1 | 2022-10-07T12:35:35Z | [https://api.github.com/repos/hpgem/nanomesh/releases/latest](https://api.github.com/repos/hpgem/nanomesh/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/hpgem/nanomesh/releases/latest` at `2026-09-01T08:26:18+00:00`.
...
- `github_search_microscopy-32c4bfdda1001f` from `github_search_microscopy` as `registry_expansion`
