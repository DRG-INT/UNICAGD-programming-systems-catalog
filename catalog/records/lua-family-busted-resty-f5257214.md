...
<!-- canonical: https://luarocks.org/modules/triple-z/busted_resty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/triple-z/busted_resty](https://luarocks.org/modules/triple-z/busted_resty) |
| Source record ids | luarocks_root_manifest-9cb66468f861fb |
...
For a systems engineer, busted_resty belongs in the Lua family inventory as part of unit/integration
...
- `luarocks_root_manifest-9cb66468f861fb` from `luarocks_root_manifest` as `registry_expansion`
